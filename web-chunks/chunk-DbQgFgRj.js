...
function Wr(e) {
  e.registerExtension({
    ...
    beforeRegisterNodeDef(t, a) {
      if (!String(a?.name || a?.node_id || t?.comfyClass || t?.type || "").startsWith(Kr)) return;
      ...
      t.prototype.onDrawForeground = function(n) {
        ...
        if (n.save(), this.selected) {
          const m = Hr(), p = n.createRadialGradient(d, c, Y * 0.35, d, c, Y * 1.15);
...
function to(e, t, a = null) {
  ...
  return r.push({ camera_id: a || eo(e, s), start: o }), r.sort((i, l) => i.start - l.start), !0;
}
function ao(e, t) {
...
function oo(e) {
  ...
  return e.motion_layers = (Array.isArray(e.motion_layers) ? e.motion_layers : []).slice(0, 256).map((r, o) => {
    ...
    const s = Zt.includes(r?.source_kind) ? r.source_kind : "manual_2d", i = (Array.isArray(r?.keys) ? r.keys : []).slice(0, 1e4).map((l) => ro(l, t)).sort((l, d) => l.time_seconds - d.time_seconds);
    return {
      id: n,
...
const no = 32, so = 64, io = 128, lo = Object.freeze(["off", "selected", "all"]), co = Object.freeze(["annotation", "name", "tag"]), xt = Object.freeze({ mode: "selected", content: "annotation" }), mo = Object.freeze(["top", "center", "bottom"]), po = /^[a-z0-9][a-z0-9_-]*$/, fo = /^#(?:[0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/, uo = /[<>]|:\/\/|javascript:|expression\(|&#/i;
function Je(e) {
  ...
  for (const r of e) {
    ...
    if (!(!o || o.length > so || !po.test(o) || a.has(o)) && (a.add(o), t.push(o), t.length >= no))
      break;
  }
  return t;
}
...
function Mt(e) {
  ...
  if (!t || t.length > io || uo.test(t)) return null;
  const a = typeof e.color == "string" ? e.color.trim() : "", r = fo.test(a) ? a.toLowerCase() : "#8d7ee8", o = mo.includes(e.anchor) ? e.anchor : "top";
  return { text: t, visible: e.visible !== !1, color: r, anchor: o };
}
function Ks(e) {
  return {
    mode: lo.includes(e?.mode) ? e.mode : xt.mode,
    content: co.includes(e?.content) ? e.content : xt.content
  };
}
function ho(e) {
...
const go = /* @__PURE__ */ new Set(["camera", "null", "sun_light", "point_light", "spot_light"]);
function Hs(e, t) {
  const a = Array.isArray(e?.position) ? e.position : [0, 0, 0], r = Array.isArray(e?.size) ? e.size : [1, 1, 1], o = go.has(t) ? 0.35 : Math.max(0.2, (Number(r[1]) || 1) * 0.5 + 0.2);
  return [Number(a[0]) || 0, (Number(a[1]) || 0) + o, Number(a[2]) || 0];
}
const Ct = Object.freeze([0.05, 8]), yo = 80, Jt = (e, t, a) => Math.max(t, Math.min(a, e));
function ea(e) {
  if (!e || typeof e != "object") return null;
  const t = String(e.clip_id ?? "").trim();
  if (!t || t.length > yo) return null;
...
const $s = "omnicam_humanoid_v1", ct = Object.freeze([
  "root",
  "pelvis",
  "spine",
  "chest",
  ...
  "foot_r",
  "toe_r"
]), bo = Object.freeze(["eye_l", "eye_r", "hand_tip_l", "hand_tip_r"]);
Object.freeze([...ct, ...bo]);
new Map(ct.map((e, t) => [e, t]));
const _o = /^mixamorig[:_ ]?/i, vo = /[\s_\-.:|]+/g, So = {
...
function wo(e) {
  return String(e || "").trim().replace(_o, "").replace(vo, "").toLowerCase();
}
function xo(e) {
  const t = [e];
...
function Us(e) {
  const a = (e || []).map(String).filter((n) => n.trim()).map((n) => [n, xo(wo(n))]), r = /* @__PURE__ */ new Set(), o = {};
  for (const n of [!0, !1])
    for (const [s, i] of Object.entries(So))
      if (!o[s])
        for (const l of i) {
          const d = Mo(l, a, r, n);
          if (d != null) {
...
function ko(e) {
  return Co(e).length === 0;
}
function Xs(e) {
  const t = e?.bone_map || e?.rig?.bone_map || null;
  return !t || !Object.keys(t).length ? "none" : ko(t) ? "rigged" : "incomplete";
}
const Do = 128, kt = "omnicam_humanoid_v1", dt = /^[a-z0-9][a-z0-9_-]*$/, To = 1e-3, jo = (e) => Array.isArray(e) && e.length === 3 && e.every((t) => Number.isFinite(Number(t)));
function mt(e) {
  ...
  return a <= 1e-8 || Math.abs(a - 1) > To && !(a > 0.5 && a < 2) ? null : t.map((r) => r / a);
}
...
function Pe(e) {
  ...
  return {
    ...
    root_offset: jo(t.root_offset) ? t.root_offset.map(Number) : [0, 0, 0],
    joints: Ao(t.joints)
  };
}
function Ys({ preset: e, overrides: t } = {}) {
  const a = Pe(e), r = Pe(t);
  return {
...
function le(e, t, a = null) {
  ...
  const o = Po(e, r, t), n = z(r, t, "pos_x", (g) => (g.camera || g).position[0], !1, o), s = z(r, t, "pos_y", (g) => (g.camera || g).position[1], !1, o), i = z(r, t, "pos_z", (g) => (g.camera || g).position[2], !1, o);
...
const Dt = [
  ...
  "ease_expo",
  "ease_back"
], Ro = ["auto", "clamped", "vector", "free", "aligned", "flat"];
function Lo(e, t) {
  const a = e?.tangents;
  return !a || typeof a != "object" ? {} : a.channels && typeof a.channels == "object" && a.channels[t] ? a.channels[t] : a;
}
function Tt(e, t, a, r, o) {
  const n = Lo(e, t), s = Ro.includes(n.mode) ? n.mode : e?.tangents?.mode || "auto", i = o ? o(e) : 0, l = a && o ? o(a) : i, d = r && o ? o(r) : i, c = Math.max(1e-6, e.frame - (a?.frame ?? e.frame - 1)), m = Math.max(1e-6, (r?.frame ?? e.frame + 1) - e.frame), p = (v = !1) => {
...
function ai(e = "balanced", t = "all_views", a = null) {
  const r = {
    none: 0,
    0: 0,
    sparse: 300,
...
function ri(e) {
  ...
  }), a.active_camera_id = a.cameras.some((c) => c.id === a.active_camera_id) ? a.active_camera_id : a.cameras[0].id, a.sequence = Qr(a.sequence, a.cameras.map((c) => c.id)), a.playblast_camera_id = a.playblast_camera_id === Yr && a.sequence.cuts.length || a.cameras.some((c) => c.id === a.playblast_camera_id) ? a.playblast_camera_id : a.active_camera_id;
  ...
  a.camera = l.camera, a.keyframes = l.keyframes, a.target_object_id = l.target_object_id || null, a.target_offset = l.target_offset || [0, 0, 0], a.aim_bone = l.aim_bone || null, a.objects = (Array.isArray(a.objects) ? a.objects : t.objects).slice(0, Ce.maxObjects).map((c) => ({
    ...
    ...c?.character ? { character: Eo(c.character) } : {},
  ...
  const d = ze();
  return a.editor_views = Object.fromEntries(Object.entries(d).map(([c, m]) => [c, V(a.editor_views?.[c] || m)])), oo(a);
}
function xe(e, t) {
...
function na(e, t) {
  const a = t.quaternion || Ne(t.rotation), r = Bo(a, e.quaternion || Ne(e.rotation));
  return { position: C(oa(e.position.map((o, n) => o * t.size[n]), a), t.position), rotation: Vo(r), quaternion: r, size: e.size.map((o, n) => o * t.size[n]) };
}
function Ko(e, t) {
...
const jt = ["speed", "angular_speed", "acceleration", "jerk"], $e = ["ok", "warn", "over"], sa = 0.8, Go = [0, 1.5, 0];
function At(e, t) {
  const a = [0];
...
function Wo(e, t = null) {
  ...
  return Array.isArray(a?.position) ? a.position.slice(0, 3).map(Number) : [...Go];
}
function $o(e, t, a, r) {
  return e.map((o) => {
    const n = B(t, o, a, r);
...
function Xo(e, t) {
  ...
  for (let r = 0; r < e.length; r++) {
    ...
    if (n && n.grade === e[r] && Uo(n.metrics, o)) {
      n.end = r;
      continue;
    }
...
function ia(e, t = {}, a = null, r = "generic") {
  ...
  const d = qo(l, o), c = Ho(l, o), m = At(d, o), p = At(m, o), u = { speed: d, angular_speed: c, acceleration: m, jerk: p }, h = Wo(e, a), f = $o(l, h, s, i), _ = l.map((g) => g.fov), y = t.allow_framing_loss === !0, v = [], b = [];
  for (let g = 0; g < n; g++) {
    const M = [], A = [];
    for (const G of jt) {
...
function Qo(e, t) {
  ...
  if (!a) return;
  if (!a.engaged) {
    if (Math.hypot(t.clientX - (a.startClientX ?? t.clientX), t.clientY - (a.startClientY ?? t.clientY)) < Zo) return;
    a.engaged = !0;
  }
...
function mn(e) {
  ...
  if (a.className = `oc-health-badge ${o.grade}`, a.textContent = on(o.grade), r) {
    const { score: l, letter: d } = cn(o);
...
function Me(e, t, a, r) {
  ...
  o && (e.checkpoint(a), o.keyframes = t, e.state.keyframes = t, e.syncActiveCameraTrack(), e.refreshKeys(), e.setFrame(e.frame, !1, !1), e.setStatus(r), mn(e));
}
function mi(e) {
  const t = de(e);
  if (!t) return;
  ...
  const r = Math.max(1, e.state.duration_frames - 1), o = en(e.state.keyframes, r), n = ia({ ...e.state, keyframes: o }, t.limits, null, t.profile);
  if (n.max_speed <= a) {
...
function fi(e) {
  const t = de(e);
  if (!t) return;
  const a = an(t, "framing_loss");
  if (!a.length) {
    e.setStatus(S("The subject stays in frame on this shot."));
    return;
  }
  const r = tn(e.state.keyframes, a, t.subject);
  Me(
    e,
    r,
    "Recenter subject",
...
function hn({
  ...
  return [
    ...
    O(
      ...
      "Shows and validates the semantic diff before mutation.",
      !0
    ),
    R(
      xr,
...
function gi() {
  for (const e of Mr)
    e.defaultValue !== void 0 && (gn(e.id, e.defaultValue), e.onChange?.(e.defaultValue));
}
...
function Cr() {
  const e = String(F(ma, "auto")), t = String(F("Comfy.Locale", "en") || "en").slice(0, 2).toLowerCase(), a = e === "auto" ? t : e, r = a !== Xr();
  if (Ur(a), !!r) {
    for (const o of W)
      if (!o.disposed)
        try {
...
function Nt(e = kr()) {
  for (const t of W)
    t.disposed || (Dr(t), t.requestRender ? t.requestRender("quality") : t.render?.(), t.renderCameraView?.());
}
function bi() {
  return xn().enabled;
}
...
function xn() {
  return {
    ...
    previewBeforeApply: I(wr, !0),
    requestTimeoutSeconds: L(xr, 120, 15, 300, !0)
  };
}
function Mn() {
  return {
...
function Rt(e, t, a, r, o) {
  const { right: n, up: s, forward: i } = K(t), l = t.position, d = [a[0] - l[0], a[1] - l[1], a[2] - l[2]], c = Tn(d, i);
  let m, p;
  if (t.camera_type === "orthographic") {
...
function Tr(e, t, { includeCtrlFallback: a, includeSimpleLeft: r = a }) {
...
function An(e, t, a) {
  const r = ht(e), o = Tr(r, t, { includeCtrlFallback: !0 });
  return o === ye && a?.camera_type === "orthographic" ? be : o;
}
function Lt(e, t) {
  return e.isNavigatingFly ? !0 : Tr(ht(e), t, { includeCtrlFallback: !1 }) !== null;
}
const En = ["maya", "blender", "simple"];
function ht(e) {
  const t = e.state?.navigation_profile;
  return En.includes(t) ? t : "maya";
}
function On(e, t) {
...
function zn(e, { baseDrag: t, viewCamera: a, entityPosition: r }) {
  const o = e.activeCameraTrack?.();
...
function Nn(e, { pointer: t, deltaPixels: a, precision: r, snapping: o }) {
  ...
  s.keyframes = In(n.baseKeys, l), s.id === e.state.active_camera_id && (e.state.keyframes = s.keyframes), e.camera = le(s, e.frame, e.state.objects), s.camera = V(e.camera), e.refreshKeys(), e.refreshInspector(), e.render(), e.renderCameraView?.();
}
function Bt(e, t) {
  const a = [];
...
function Ln(e, t, a, r = {}) {
  const o = e.state.objects.filter((b) => b.enabled !== !1), n = r.all ? o : o.filter((b) => e.selectedObjectIds?.has(b.id)), i = (n.length ? n : [a]).flatMap((b) => Rn(e, b)), l = [0, 1, 2].map((b) => Math.min(...i.map((x) => x[b]))), d = [0, 1, 2].map((b) => Math.max(...i.map((x) => x[b]))), c = l.map((b, x) => (b + d[x]) / 2), { right: m, up: p, forward: u } = K(t), h = Math.max(1, e.canvas?.width || e.state.width || 1280) / Math.max(1, e.canvas?.height || e.state.height || 720), f = Math.tan((t.fov || 35) * Math.PI / 360), _ = f * h;
  let y = 2, v = 0.1;
  for (const b of i) {
...
function Mi(e, t = {}) {
  ...
  e.checkpoint(t.all ? "Frame all" : "Frame subject"), Ln(e, a, s, t), r ? (e.serialize(), e.render()) : (e.beginCameraEdit(), e.commitCameraEdit(), e.finishCameraEdit()), e.setStatus(t.all ? S("Framed: all objects") : S("Framed: {name}").replace("{name}", s.name || s.type || S("Subject")));
}
function Fn(e, t, a, { forceLocal: r = !1 } = {}) {
...
function Ar(e) {
  ...
  const n = Math.max(0.7, H(E(a.position, r)) * 0.12), s = e.state.gizmo_mode === "scale" || e.state.gizmo_mode === "rotate", i = t.type === "object" ? Fn(e, t.object, t, { forceLocal: s }) : [[1, 0, 0], [0, 1, 0], [0, 0, 1]];
...
function Ci(e) {
  ...
  for (const o of t.handles) {
    ...
    if (e.ctx.lineWidth = n ? 6.5 : 3.8, e.ctx.strokeStyle = n ? "#ffffff" : a[o.index] || "#ffffff", e.ctx.fillStyle = a[o.index] || "#ffffff", e.ctx.beginPath(), o.points.forEach((s, i) => {
      ...
      e.state.gizmo_mode === "scale" && t.entity?.type === "object" ? (e.ctx.fillRect(i[0] - 6, i[1] - 6, 12, 12), e.ctx.save(), e.ctx.strokeStyle = "rgba(15, 23, 42, 0.65)", e.ctx.lineWidth = 1, e.ctx.strokeRect(i[0] - 6, i[1] - 6, 12, 12), e.ctx.restore()) : Kn(e.ctx, s[0], i);
    }
  }
...
function Ae(e, t) {
  ...
  const n = o[0] - a.start[0], s = o[1] - a.start[1], i = t.shiftKey ? 0.1 : 1, l = qn(a), d = a.axis ? at[a.axis] : null, c = e.state.view_mode === "camera" ? e.camera : e.state.editor_views[e.state.view_mode], m = K(c), p = c.camera_type === "orthographic" ? 10 / (Math.max(0.01, c.zoom || 1) * Math.max(1, e.canvas.height)) : Math.hypot(...E(c.position, c.target)) * 25e-4;
  let u = a.snapshots.map((b) => [...b.transform.position]);
  if (a.mode === "translate") {
    const b = l ?? (n - s) * p * i, x = d ? k(d, b) : C(k(m.right, n * p * i), k(m.up, -s * p * i));
    u = u.map((w) => C(w, x)), u = Hn(e, a, u, o, t.ctrlKey || t.metaKey, d, a.snapshots.map((w) => w.transform.position));
  }
...
function Wn(e, t) {
  ...
  return r === "escape" ? Pr(e) : r === "enter" || r === " " ? Ir(e) : at[r] ? (a.axis = a.axis === r ? null : r, Ae(e, a.lastEvent), !0) : /^[0-9]$/.test(r) || r === "." || r === "," || r === "-" && !a.numeric ? (a.numeric += r === "," ? "." : r, Ae(e, a.lastEvent), !0) : (r === "backspace" && (a.numeric = a.numeric.slice(0, -1), Ae(e, a.lastEvent)), !0);
}
function ue(e, t, a) {
...
const re = (e, t) => Math.round(e / t) * t, Un = (e, t) => e.map((a) => re(a, t));
function Xn(e, t, a) {
...
function he(e, t, a, r = [], o = null) {
  ...
  if (s === "grid")
    return o ? t.map((l, d) => Math.abs(o.axis[d]) > 1e-6 ? re(l, i) : o.base[d]) : Un(t, i);
  if (s === "vertex" && a && !o) {
...
function ki(e, t) {
  if (e.modalTransform) {
    t.preventDefault?.(), t.stopPropagation?.(), t.button === 0 ? Ir(e) : t.button === 2 && Pr(e);
    return;
  }
  ...
  if (c) {
    ...
    if (c.entity.type === "camera_path" && zn(e, { baseDrag: b, viewCamera: n, entityPosition: c.entity.position })) return;
    if (c.entity.type === "object") {
      const x = c.entity.object;
      e.checkpoint("Transform object");
      const w = Or(e), D = (w.length ? w : [x]).map((M) => ({ object: M, transform: ce(M) }));
  ...
  const p = !!e.isNavigatingFly, u = An(e, t, n);
  if (!p && !u) return;
...
function Di(e, t) {
  ...
  if (e.gizmoDrag) {
    ...
    if (e.gizmoDrag.type === "camera_path") return void Nn(e, { pointer: i, deltaPixels: d, precision: l, snapping: c });
    if (e.state.gizmo_mode === "translate")
      if (e.gizmoDrag.free) {
  ...
  if (!e.drag) {
    const s = e.interactionElement.getBoundingClientRect(), i = Er(e, [
      (t.clientX - s.left) * e.canvas.width / Math.max(1, s.width),
      (t.clientY - s.top) * e.canvas.height / Math.max(1, s.height)
...
function ji(e, t) {
  ...
  const a = On(t, e.interactionElement.getBoundingClientRect().height);
  if (!a) return;
...
function Be(e, { sourceKind: t = "manual_2d", label: a, keys: r, source: o = {} }) {
  ...
  const n = Yn(e), s = { id: n, label: a || `Motion ${n.split("_").at(-1)}`, enabled: !0, semantic: "screen_point", source_kind: t, keys: r.map((i) => ({ visible: !0, interpolation: "linear", ...i })), source: { ...o } };
...
function es(e, t, a, r, o) {
  const n = le(e, a, e.objects);
  let s = t?.point;
  if (t?.object_id) {
    const c = e.objects.find((u) => u.id === t.object_id);
    if (!c) return null;
    const m = Ko(e.objects, c), p = Array.isArray(t.local_point) ? t.local_point : [0, 0, 0];
...
function Ye(e, t) {
  return Jn(t, e.interactionElement);
}
function rs(e, t) {
  const a = Rr(e.motion_layers, t);
  return a ? (Nr(e, a.id), a) : null;
}
const Ze = (e) => {
...
function Ai(e, t) {
  ...
  e.root.querySelector('[data-role="motion-interpolation"]')?.addEventListener("change", (o) => {
    const n = Xe(e.state);
    n && (e.checkpoint("Set motion interpolation"), Zn(n, o.target.value), ae(e, `Motion interpolation: ${o.target.value}`));
  ...
  for (const o of e.root.querySelectorAll("[data-motion-layer-action]"))
    o.addEventListener("click", () => {
      ...
      if (e.checkpoint(s === "delete" ? "Delete motion layer" : s === "retime" ? "Retime motion layer" : "Toggle motion layer"), s === "delete") Nr(e.state, n.id);
      else if (s === "retime") {
        const [i, l] = Kt(e);
        Qn(n, i, l);
  ...
  a.addEventListener("pointerdown", (o) => {
    ...
    e.checkpoint(n === "erase" ? "Erase motion track" : "Add motion anchor"), n === "anchor" ? Be(e.state, { sourceKind: "static_anchor", label: `Anchor ${(e.state.motion_layers || []).length + 1}`, keys: [{ time_seconds: e.frame / e.state.fps, ...s, interpolation: "hold" }] }) : n === "project" ? os(e, s) : n === "erase" && rs(e.state, s), ae(e, `Motion tool: ${n}`);
  ...
  const r = (o) => {
    ...
    const [s, i] = Kt(e), l = as(e.state, n.points, s, i);
  ...
  a.addEventListener("pointerup", r, { capture: !0, signal: t }), a.addEventListener("pointercancel", r, { capture: !0, signal: t }), a.addEventListener("click", (o) => {
    ...
    const n = Rr(e.state.motion_layers, Ye(e, o));
...
function Ei(e, t) {
  for (const a of e.root.querySelectorAll("[data-motion-create]"))
    a.addEventListener("click", () => ss(e, a.dataset.motionCreate), { signal: t });
  e.root.querySelector("[data-motion-create-cancel]")?.addEventListener("click", () => Lr(e), { signal: t });
}
...
const ge = { t: "translate", r: "rotate", s: "scale" }, ds = [
...
function hs(e, t) {
  return us(e) || t?.lastKeyZone || "viewport";
}
let qt = !1;
function gs() {
  qt || typeof window > "u" || (qt = !0, window.addEventListener("keydown", (e) => {
    if (!bn()) return;
    const t = e.composedPath?.()[0] || e.target, a = _n(t);
    !a || a.disposed || ys(a, e) && (e.preventDefault(), e.stopImmediatePropagation?.(), e.stopPropagation());
  }, { capture: !0 }));
}
function ys(e, t) {
  if (!Sn()) return !1;
  const a = t.composedPath?.()[0] || t.target;
  if (fs(a) || (t.code === "Space" || t.key === "Enter") && ps(a)) return !1;
...
function ws(e, t) {
  ...
  if (a === "s" || a === "a")
    return t.repeat || (!Ie(e.state).length || a === "a" ? (e.checkpoint("Auto-split shots"), e.state.sequence = { ...e.state.sequence || { recording_path: "" }, enabled: !0, cuts: Jr(e.state) }, Qe(e)) : (e.checkpoint("Split shot"), to(e.state, e.frame, null) ? Qe(e) : e.setStatus("Move the playhead inside a shot first"))), !0;
  if (t.key === "Delete" || t.key === "Backspace") {
    if (t.repeat) return !0;
    const r = Ie(e.state), o = Xt(e.state, e.frame), n = o ? r.findIndex((s) => s.start === o.start) : -1;
    return n >= 0 && (e.checkpoint("Remove shot"), ao(e.state, n) && Qe(e)), !0;
  }
  return !1;
}
function yt(e, t) {
...
function Cs([e, t], [a, r]) {
  ...
  const o = Math.round((window.innerWidth || e) * xs), n = Math.round((window.innerHeight || t) * Ms);
  return [
...
function ks(e, t) {
  const a = Fr[t];
  return !a || !e?.setSize ? !1 : (e.setSize(Cs(a.default, a.min)), !0);
}
function Ds(e, t, a) {
  const r = Fr[t];
...
const Ht = "oc-help-css", Te = "#8b7bd8", Br = /* @__PURE__ */ new Map();
function bt(e, t) {
  e && t && Br.set(e, t);
}
function st(e) {
  return e && Br.get(e) || null;
}
const Ts = `
...
function js() {
  ...
  e.id = Ht, e.textContent = Ts, document.head.appendChild(e);
}
function oe(e) {
...
const $t = "MajoorOmniCam.ShowHelp", it = "oc-help-toolbar-icon", Ut = "oc-help-toolbar-css", Os = "#8b7bd8";
function Is() {
  ...
  e.id = Ut, e.textContent = `
    .${it}{display:inline-flex;align-items:center;justify-content:center;
      width:16px;height:16px;border-radius:50%;background:${Os};color:#fff;
...
J.registerExtension({
  ...
  async nodeCreated(e) {
    ...
    await yt(e, async () => {
      ...
      const { attachDirector: o } = await import("./chunk-DQnND-ag.js").then((n) => n.g);
      return je("director:import:resolved", e), o;
    });
    const r = e.__majoorOmniCam;
    r && (je("director:attach:complete", e), kn(r), t && Dn(r), _t(e, rt, t, a?.()));
  }
});
J.registerExtension({
  ...
  async nodeCreated(e) {
    if (qe(e) !== ot) return;
    const t = !ie, a = t ? null : vt(e);
    await yt(e, async () => (await import("./chunk-DBEoBrta.js")).attachExtractor), e.__majoorOmniCamExtractor && _t(e, ot, t, a?.());
  }
});
J.registerExtension({
  ...
  async nodeCreated(e) {
    if (qe(e) !== nt) return;
    const t = !ie, a = t ? null : vt(e);
    await yt(e, async () => (await import("./chunk-CIdsBG0m.js")).attachMonitor), e.__majoorOmniCamMonitor && _t(e, nt, t, a?.());
  }
});
export {
  ga as $,
