...
const bo = () => import("./chunk-DA1dngSG.js");
function Wf(e, t) {
...
async function iu(e) {
  ...
  try {
    let n = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-CuGcD3hr.js");
...
function Cb(e, t, a, { prevKey: o = null, nextKey: r = null, breakCoupling: n = !1 } = {}) {
  if (!e || t !== "in" && t !== "out") return e;
  let i = Ut(e);
  if (i === "corner") return e;
  i === "auto" && (i = "aligned", e.tangents = e.tangents && typeof e.tangents == "object" ? e.tangents : {}, e.tangents.spatial_mode = "aligned", ti(e, o, r));
  const c = Ue(e), l = Ht([
    Ie(a?.[0]),
    Ie(a?.[1]),
    Ie(a?.[2])
  ], c);
  if (br(e), kt(e, t, l), i === "aligned" && !n) {
    const p = t === "out" ? "in" : "out", m = ur(e, p) || (p === "out" ? hr(e, o, r).out : hr(e, o, r).in), f = Ln(l), d = Ln(m) || f || 1, h = f > fr ? Po(l, -d / f) : Po(m, 1);
    kt(e, p, h);
  }
  return e;
}
...
class ii {
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-CuGcD3hr.js"));
    } catch (a) {
  ...
  try {
    t.assetBrowser = Rp(t, {
      ...
      onAgentFirstOpen: async () => {
        if (er())
          try {
            const { createDirectorAgentPanel: m } = await import("./chunk-BDc3FkDT.js");
            t.agentPanel = m(t);
          } catch (m) {
