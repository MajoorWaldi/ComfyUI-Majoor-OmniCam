...
J.registerExtension({
  ...
  async nodeCreated(e) {
    ...
    await wt(e, async () => {
      ...
      const { attachDirector: o } = await import("./chunk-COz2qRLf.js").then((n) => n.g);
...
J.registerExtension({
  ...
  async nodeCreated(e) {
    if (We(e) !== st) return;
    const t = !ie, a = t ? null : Ct(e);
    await wt(e, async () => (await import("./chunk-DUNZApz8.js")).attachExtractor), e.__majoorOmniCamExtractor && Mt(e, st, t, a?.());
  }
});
J.registerExtension({
  ...
  async nodeCreated(e) {
    if (We(e) !== it) return;
    const t = !ie, a = t ? null : Ct(e);
    await wt(e, async () => (await import("./chunk-BG4_nB1O.js")).attachMonitor), e.__majoorOmniCamMonitor && Mt(e, it, t, a?.());
  }
});
export {
  wa as $,
