import { a, V as j, bw as te, bx as J, by as w } from "./chunk-GPeX1UgR.js";
...
function he(e, n = {}) {
  ...
  function q(t) {
    x && (x.hidden = !t), t ? T?.focus?.() : T && (T.value = "");
  }
  async function Z() {
    const t = w(), r = T?.value || "";
    if (T && (T.value = ""), !r) {
