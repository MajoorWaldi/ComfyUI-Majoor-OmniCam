...
const ud = `
      ...
      .majoor-omnicam .oc-agent-describe{display:block;width:100%;min-height:52px;max-height:220px;resize:none;overflow-y:auto;font:inherit;line-height:1.4;color:var(--oc-text)}
...
const ho = () => import("./chunk-OK4YNgbb.js");
function vf(e, t) {
...
async function Lh(e) {
  ...
  try {
    let n = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-D7Um5RrB.js");
...
class Zs {
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-D7Um5RrB.js"));
    } catch (a) {
  ...
  try {
    t.assetBrowser = xp(t, {
      ...
      onAgentFirstOpen: async () => {
        try {
          const { createDirectorAgentPanel: m } = await import("./chunk-BjVc8gYy.js");
          t.agentPanel = m(t);
        } catch (m) {
