import { a, a4 as j, bN as te, bO as J, bP as w } from "./chunk-BVYXHcxN.js";
...
function he(e, n = {}) {
  const i = e.root, o = n.api || e.api || e.app?.api, s = (t) => i.querySelector(`[data-role="${t}"]`), f = s("agent-panel"), P = s("agent-hint"), C = s("agent-privacy-note"), d = s("agent-describe"), k = s("agent-plan"), y = s("agent-provider-select"), m = s("agent-model-select"), N = s("agent-provider-label"), O = s("agent-credential-status"), q = s("agent-credential-form"), T = s("agent-credential-input"), H = i.querySelector('[data-agent-act="preview"]'), M = i.querySelector('[data-agent-act="apply"]'), U = i.querySelector('[data-agent-act="cancel"]');
  ...
  function E() {
    ...
    if (N) {
      ...
      N.textContent = `${p} · ${t.model || a("(no model set)")}`;
    }
    C && (C.textContent = me(t));
    const r = g === "planning" || g === "applying";
    if (H && (H.disabled = r), M && (M.disabled = !c || r || c.truncated || g === "stale"), U && (U.disabled = !c), d && (d.disabled = r), k && (k.innerHTML = c ? ve(c.changes) : ""), g === "planning") u(a("Planning..."));
