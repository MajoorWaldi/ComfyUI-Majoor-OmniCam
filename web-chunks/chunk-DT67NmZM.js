...
import { u as h } from "./chunk-KSpmkRWt.js";
...
import { c as K, w as z, a as w, W as B } from "./chunk-B8M65iay.js";
...
async function ve(e, t) {
  return w.open({
    ...
    opener: t,
    createSession: async () => {
      const r = ++e.workbenchGeneration, { openExtractorWorkbench: n, closeExtractorWorkbench: s } = await import("./chunk-DEBE4PpR.js");
...
function _e(e) {
  ...
  return e.onRemoved = function(...o) {
    w.disposeForNode(e.id), a(), t.dispose(), u?.apply(this, o);
  }, t;
}
