...
const ho = () => import("./chunk-BzGKavpc.js");
function Ef(e, t) {
...
async function qh(e) {
  ...
  try {
    let n = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-Y4JL7Zmm.js");
...
class ai {
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-Y4JL7Zmm.js"));
    } catch (a) {
  ...
  try {
    t.assetBrowser = Ap(t, {
      ...
      onAgentFirstOpen: async () => {
        if (Zo())
          try {
            const { createDirectorAgentPanel: m } = await import("./chunk-c7vK16ul.js");
            t.agentPanel = m(t);
          } catch (m) {
