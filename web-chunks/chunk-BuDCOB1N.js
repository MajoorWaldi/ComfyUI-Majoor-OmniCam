import { app as An } from "../../scripts/app.js";
import { api as Ve } from "../../scripts/api.js";
import { s as Ce, c as X, t as ge, a as s, o as $n, b as cr, d as He, e as he, f as Ao, r as Hs, g as lr, h as Mn, i as Gs, j as Ys, k as Xs, l as Js, m as dr, n as mr, I as uo, p as pr, q as Zs, w as Qs, u as vo, v as Tn, x as ei, y as fr, z as Lr, A as In, B as Go, C as On, D as Pn, E as Ln, F as Fn, G as Yo, H as Fo, J as Fr, O as zr, R as zn, K as ti, L as ai, M as oi, N as hr, P as ri, Q as ni, S as si, T as ii, U as ci, V as ur, W as li, X as di, Y as mi, Z as pi, _ as fi, $ as hi, a0 as ui, a1 as bi, a2 as gi, a3 as yi, a4 as vi, a5 as xi, a6 as wi, a7 as ki, a8 as Si, a9 as ji, aa as _i, ab as Ci, ac as Ei, ad as Ai, ae as $i, af as Mi, ag as Ti, ah as Ii, ai as Oi, aj as Pi, ak as Li, al as Fi, am as zi, an as Ni, ao as Ri, ap as Ki, aq as Di, ar as Bi, as as qi, at as Ui, au as Wi, av as Vi, aw as Hi, ax as Gi, ay as Yi, az as Xi, aA as Ji, aB as Nn, aC as Rn, aD as Zi, aE as zo, aF as Qi, aG as ec, aH as tc, aI as ac, aJ as oc, aK as ze, aL as rc, aM as Kn, aN as br, aO as nc, aP as sc, aQ as ic, aR as Dn, aS as Ue, aT as Be, aU as cc, aV as Nr, aW as gr, aX as lc, aY as dc, aZ as mc, a_ as pc, a$ as fc, b0 as hc, b1 as uc, b2 as Bn, b3 as bc, b4 as gc, b5 as yc, b6 as vc, b7 as xc, b8 as wc, b9 as kc, ba as Sc, bb as jc, bc as _c, bd as Cc, be as Ec, bf as Ac, bg as $c, bh as Mc, bi as Tc, bj as Ic, bk as Oc, bl as Pc } from "./chunk-B2Nzrc8E.js";
import { L as Lc, a as Fc, p as zt, f as yr, b as zc, S as Nc, c as Rr, d as Rc, e as Kc, r as Dc, g as Bc, n as qc, C as Kr, h as Nt, o as Uc, i as Wc, s as Vc, j as Hc, k as qn, l as Gc, m as Xo, q as Jo, w as Yc, t as Un, u as Xc, v as Jc, x as Zc, y as Qc, z as el, A as tl, B as al, D as ol, E as rl, F as nl, G as sl, H as il, I as cl, J as ll, K as dl, M as ml } from "./chunk-BDEwlg2n.js";
import { S as pl, b as fl, p as hl, m as ul, l as bl, u as gl } from "./chunk-BOI_2OKd.js";
import { R as yl } from "./vendor-three-AeKB2-k3.js";
function Et(e, t = 0) {
  return Math.sin(e * 1.7 + t * 3.1) * 0.5 + Math.sin(e * 3.3 + t * 5.7) * 0.3 + Math.sin(e * 7.9 + t * 11.3) * 0.2;
}
function vl(e, { type: t = "handheld_subtle", intensity: a = 1, duration_frames: o = null, subdivide: r = !0 } = {}) {
...
function xl(e, { duration_frames: t = 120, target: a = [0, 1.5, 0], radius: o = 6, height: r = 3.5 } = {}) {
...
const Wn = 1e-4;
function wl(e, t) {
  return !Array.isArray(e) || !Array.isArray(t) ? e !== t : e.some((a, o) => Math.abs(Number(a) - Number(t[o])) > Wn);
}
function Dr(e, t) {
  return Math.abs(Number(e) - Number(t)) > Wn;
}
const Vn = [
  {
    id: "camera",
  ...
  },
  {
    ...
    label: "Look At",
    color: "#f0a742",
    changed: (e, t) => wl(e?.target, t?.target),
    read: (e) => e?.target
  },
  {
    id: "focal_length",
...
function Sl(e, t = null) {
  return Vn.filter((a) => !t || t.has(a.id)).map((a) => ({
    id: a.id,
    label: a.label,
    color: a.color,
    frames: kl(e, a)
...
function xo(e) {
  ...
  for (const a of [".oc-playhead-head", '[data-role="dope-playhead"]', ".oc-gdope-playhead", ".oc-sequence-playhead"])
    for (const o of e.root.querySelectorAll(a)) jl(o, t);
}
function _l(e, t, a) {
...
function Hn(e) {
  ...
  a.delete("camera");
  const o = e.timelineKeyframes() || [], r = Sl(o, a), n = El(e, r);
  if (t.dataset.signature !== n) {
    t.dataset.signature = n, t.replaceChildren();
    const i = (c) => ge(e, c);
    for (const c of r) {
      const l = document.createElement("div");
      l.className = "oc-dope-row", l.dataset.channel = c.id, l.style.setProperty("--channel-color", c.color), _l(l, c.frames, i), Cl(e, l, c, o, i), t.appendChild(l);
    }
  }
...
const No = [1, 2, 5, 10, 20, 25, 50, 100, 200, 250, 500, 1e3, 2e3, 5e3], Gn = 46, Br = 5, Yn = 640;
function Xn(e, t) {
  const a = t > 0 ? t : Yn, o = Math.max(2, Math.floor(a / Gn)), r = Math.max(1e-6, e / o);
  return No.find((n) => n >= r) ?? No[No.length - 1];
}
function Al(e, t) {
  const a = Math.max(1, e.state.duration_frames - 1), o = X(Number(e.timelineZoom) || 1, 0.1, 50), r = Number(e.timelinePan) || 0, n = a / o, i = Xn(n, t), l = (i >= Br ? i / Br : 0) || i, p = [], m = Math.max(0, Math.floor(r / l) * l);
...
function $l(e) {
  return e.clientWidth || e.parentElement?.clientWidth || Yn;
}
function Jn(e) {
  const t = e.root.querySelector('[data-role="ruler"]');
  if (!t) return;
  t.replaceChildren();
  for (const o of Al(e, $l(t))) {
...
function Ml(e, t) {
  ...
  a.addEventListener("pointerup", i, { signal: t }), a.addEventListener("pointercancel", i, { signal: t }), a.addEventListener("wheel", (c) => $n(e, c), { passive: !1, signal: t });
}
const Tl = [1, 2, 2.5, 5, 10];
function Il(e, t = 5) {
  const a = Math.abs(e) / Math.max(1, t);
  if (!(a > 0) || !Number.isFinite(a)) return 1;
  const o = 10 ** Math.floor(Math.log10(a)), r = a / o;
  return (Tl.find((n) => n >= r) ?? 10) * o;
}
function Ol(e, t) {
  const a = Math.max(0, Math.min(4, Math.ceil(-Math.log10(t))));
  return e.toFixed(a);
}
function Pl(e, { left: t, right: a, top: o, width: r, graphWidth: n, graphHeight: i, height: c, timeMin: l, timeMax: p, totalDuration: m, xFor: h, frame: d }) {
  const f = Xn(p - l, n);
...
function Ll(e, { left: t, right: a, top: o, width: r, graphHeight: n, minimum: i, maximum: c, yFor: l }) {
  const p = Il(c - i, 4);
  e.strokeStyle = "#222228", e.lineWidth = 1, e.fillStyle = "#6e727a";
  for (let m = Math.ceil(i / p) * p; m <= c; m += p) {
    const h = l(m);
    h < o - 1 || h > o + n + 1 || (e.beginPath(), e.moveTo(t, h), e.lineTo(r - a, h), e.stroke(), e.fillText(Ol(m, p), 4, h + 3));
  }
}
function vr(e, t) {
...
function zl(e, t) {
  const a = t.currentTarget, { x: o, y: r } = vr(a, t);
...
function Zn(e, { selectedOnly: t = !1 } = {}) {
  ...
  if (f.length > 0) {
    const b = Math.min(...f), v = Math.max(...f), g = Math.max(1e-4, v - b), y = (b + v) / 2, S = (H) => r ? Ao(r, H) : Ce(e.state, H), x = [], E = Math.max(1, Math.floor(a / 40));
    for (let H = 0; H <= a; H += E) {
      const ne = S(H);
      for (const j of n) {
        const F = j.get(ne);
...
function Hl(e) {
  ...
  const i = e.timelineObject(), c = e.timelineKeyframes(), l = Ze(e), p = 44, m = 14, h = 16, d = 22, f = Math.max(1, a - p - m), u = Math.max(1, o - h - d), b = Math.max(1, e.state.duration_frames - 1), v = X(Number(e.curveZoomX) || 1, 0.1, 50), g = Number(e.curvePanX) || 0, y = b / v, S = g, x = g + y, E = [], M = Math.max(1, Math.ceil(y / Math.max(80, f))), K = ($) => i ? Ao(i, $) : Ce(e.state, $);
  ...
  if (n.fillStyle = "#111114", n.fillRect(0, 0, a, o), n.strokeStyle = "#222228", n.lineWidth = 1, n.font = "9px system-ui, -apple-system, sans-serif", n.fillStyle = "#6e727a", Pl(n, {
    left: p,
    right: m,
    top: h,
    width: a,
    ...
    xFor: q,
    frame: e.frame
  }), Ll(n, { left: p, right: m, top: h, width: a, graphHeight: u, minimum: Y, maximum: U, yFor: G }), Y <= 0 && U >= 0) {
    const $ = G(0);
  ...
  for (const $ of l) {
    ...
    if (e.showCurveHandles)
      for (let P = 0; P < c.length; P++) {
        ...
        const me = i ? V.transform || i : V.camera || V, te = q(V.frame), pe = G($.get(me)), ye = c[P - 1], ue = c[P + 1], xe = Math.max(1, V.frame - (ye?.frame ?? V.frame - 1)), z = Math.max(1, (ue?.frame ?? V.frame + 1) - V.frame), R = Hs(
          V,
          $.id,
          ye,
          ue,
...
function Qn(e) {
  ...
  if (!t) return;
  const a = e.timelineObject(), o = a ? a.name || a.type : e.activeCameraTrack().name, r = Gl(e), n = `${o}\0${r.map((c) => `${c.id}:${c.color}`).join("|")}`;
  if (t.dataset.signature !== n) {
    t.dataset.signature = n, t.replaceChildren();
...
function Ur(e, t, a) {
  ...
  for (const n of [...e].sort((i, c) => i.frame - c.frame)) {
    ...
    (r === null || !(Math.abs(c - r) <= Yl)) && o.push(n.frame), r = c;
  }
  return o;
}
function xr(e) {
...
const Wr = ["#4aa3ef", "#f2a93b", "#48c774", "#b565d8", "#ec4899"];
function es(e, t) {
  const a = e.state.cameras.findIndex((r) => r.id === t), o = a >= 0 ? e.state.cameras[a] : null;
  return { camera: o, color: o?.color || Wr[Math.max(0, a) % Wr.length] };
}
function ct(e) {
...
function Jl(e, t) {
  ...
  if (a.appendChild(ao(
    ...
    () => {
      e.checkpoint("Split shot"), Mn(e.state, e.frame, null) ? ct(e) : e.setStatus(s("Move the playhead inside a shot first"));
    },
    { disabled: o }
  )), a.appendChild(ao(
    s("Clear edit"),
...
function Ql(e, t, a, o, r) {
  t.preventDefault(), t.stopPropagation();
  const { camera: n } = es(e, a.camera_id);
  e.contextMenu?.show(t, n?.name || s("Shot"), [
    ...
    null,
    {
      ...
      run: () => {
        e.checkpoint("Split shot"), Mn(e.state, e.frame, null) && ct(e);
      }
    },
    {
      label: s("Remove shot"),
      ...
      disabled: r === 1,
      run: () => {
        e.checkpoint("Remove shot"), Gs(e.state, o) && ct(e);
      }
    }
  ]);
}
function ed(e, t, a, o) {
  const { camera: r, color: n } = es(e, t.camera_id), i = document.createElement("div");
  ...
  if (c.className = "oc-sequence-name", c.textContent = r?.name || t.camera_id, i.appendChild(c), a > 0) {
    ...
    l.className = "oc-sequence-handle", l.title = s("Drag to trim the cut"), l.addEventListener("pointerdown", (p) => Zl(e, p, l, o, a)), i.appendChild(l);
  }
  return i.addEventListener("contextmenu", (l) => Ql(e, l, t, a, o.__cutCount)), i.addEventListener("pointerdown", () => {
...
function as(e, t) {
  ...
  if (n.className = "oc-sequence-lane", n.dataset.role = "sequence-lane", n.setAttribute("aria-label", s("Multi-camera edit")), o.length)
    for (const [c, l] of o.entries()) {
      ...
      ge(e, l.end + 1) < -5 || p > 105 || n.appendChild(ed(e, l, c, r));
    }
  else {
    const c = document.createElement("span");
  ...
  r.appendChild(n), r.appendChild(td(e));
  const i = document.createElement("span");
  i.className = "oc-sequence-playhead", i.style.left = `${ge(e, e.frame)}%`, r.appendChild(i), t.appendChild(r);
}
const ad = ['[data-act="curve-zoom-in"]', '[data-act="curve-zoom-out"]', '[data-act="curve-fit"]', '[data-act="curve-handles"]'], Vr = { curves: "Graph", dope: "Timeline", sequence: "Sequence" };
function Hr(e, t) {
  const a = t in Vr ? t : "curves";
  e.graphTab = a;
  ...
  a === "dope" ? xr(e) : a === "sequence" ? (as(e, n), n?.focus?.({ preventScroll: !0 })) : e.drawCurveEditor(), e.setStatus(s(Vr[a]));
}
function od(e) {
  e.graphTab === "sequence" && as(e, e.root.querySelector('[data-role="graph-sequence"]'));
}
function rd(e, t) {
  ...
  a && a.addEventListener("keydown", (o) => {
    if (o.key === "ArrowLeft" || o.key === "ArrowRight") {
      ...
      if (n >= 0 && r.length > 1) {
        ...
        r[i].focus(), Hr(e, r[i].dataset.graphTab);
      }
    }
  }, { signal: t });
  for (const o of e.root.querySelectorAll("[data-graph-tab]"))
    o.addEventListener("click", (r) => {
      r.preventDefault(), r.stopPropagation(), Hr(e, o.dataset.graphTab);
    }, { signal: t });
}
...
function id(e) {
  ...
  if (!t || !a) return;
  const o = os(e.state?.metadata, e.state?.duration_frames), r = o.some((c) => c.state !== "unknown");
  ...
  if (Gr.has(a)) return;
  Gr.add(a), a.addEventListener("pointerdown", (c) => {
...
function cd(e) {
  ...
  g && (g.textContent = m.name), Jn(e), Hn(e), Qn(e), xr(e), od(e), e.refreshCameraSelectors(), e.refreshKeyEditor(), e.updateEditState(), e.drawCurveEditor(), e.perf && (e.perf.timelineRefreshCount = (e.perf.timelineRefreshCount || 0) + 1), id(e);
}
class rs {
...
async function wr(e, { route: t, field: a = "file", file: o }) {
...
const bd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/><path d="M2 12h20"/></svg>', gd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m21 16-9 5-9-5V8l9-5 9 5v8z"/><path d="m3.27 6.96 8.73 4.84 8.73-4.84"/><path d="M12 22V12"/></svg>', yd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2L2 20h20L12 2z"/><path d="M12 2v18"/></svg>', vd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/><path d="m17.66 17.66 1.41 1.41"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="m6.34 17.66-1.41 1.41"/><path d="m19.07 4.93-1.41 1.41"/></svg>', xd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18h6"/><path d="M10 22h4"/><path d="M15.09 14c.18-.98.65-1.74 1.41-2.5A4.65 4.65 0 0 0 18 8 6 6 0 0 0 6 8c0 1 .23 2.23 1.5 3.5.76.76 1.23 1.52 1.41 2.5"/></svg>', wd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l8 8-4 4-8-8 4-4z"/><path d="M7 11L2 16l6 6 5-5"/><path d="M18 19l4 2"/><path d="M21 16l2 2"/></svg>', kd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m22 8-6 4 6 4V8z"/><rect width="14" height="12" x="2" y="6" rx="2"/></svg>', Sd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14h6v6H4z"/><circle cx="17" cy="7" r="3"/><path d="m6 3 4 7H2z"/></svg>';
function jd() {
  return `
...
function Ad() {
  const e = Fc.map((t) => `<button data-lens="${t}">${t}mm</button>`).join("");
  return `
  ...
  return `
    <div class="oc-dope">
      <div class="oc-dope-body">
        <div class="oc-dope-labels">${Vn.map((t) => `
...
const Je = 1, Yr = 50, D = Object.freeze({
...
}), is = Object.freeze(Object.values(D)), ve = Object.freeze({
  SCENE_GET: "scene.get",
...
}), Gd = Object.freeze(Object.values(ve));
...
const Yd = 25, Xr = 100;
function tt(e, t) {
  const a = e?.offset === void 0 ? 0 : Number(e.offset), o = e?.limit === void 0 ? Yd : Number(e.limit);
  if (!Number.isInteger(a) || a < 0)
    throw new I(
      "BAD_QUERY",
      "offset must be a non-negative integer"
    );
  if (!Number.isInteger(o) || o < 1 || o > Xr)
    throw new I(
      "BAD_QUERY",
      `limit must be between 1 and ${Xr}`
    );
  return {
    offset: a,
    limit: o,
  ...
  switch (t?.type) {
    ...
    case ve.HEALTH_GET:
      return we(e, {
        version: 1,
        type: t.type,
        frames: os(a.metadata, a.duration_frames)
      });
    case ve.ASSET_LIST: {
...
function em(e, t) {
  e.cameras ||= [];
  const a = new Set(e.cameras.map((i) => i.id)), o = $o(a, "camera", t.id), r = { ...mr(), ...t.camera || {} }, n = {
    id: o,
    name: t.name || o,
    color: "#4aa3ef",
    locked: !1,
...
function tm(e, t) {
  ...
  const o = new Set(e.cameras.map((i) => i.id)), r = $o(o, "camera", t.id), n = JSON.parse(JSON.stringify(a));
...
function nm(e, t) {
  ...
  e.objects ||= [];
  const a = new Set(e.objects.map((i) => i.id)), o = $o(a, t.objectType, t.id), r = Qd(t.objectType), n = {
    id: o,
    type: t.objectType,
    name: t.name || o,
    ...r,
...
function sm(e, t) {
  ...
  const o = new Set(e.objects.map((l) => l.id)), r = $o(o, a.type || "object", t.id), n = Array.isArray(t.offset) ? t.offset : [0.35, 0, 0.35], i = JSON.parse(JSON.stringify(a));
...
function fm(e, t) {
  ...
  switch (a) {
    ...
    case D.OBJECT_CREATE:
      if (ee(e.objectType, "objectType", t), !cs.has(e.objectType))
...
function hm(e, t) {
  ...
  if (t.operations.length > Yr)
    throw new I(
      "TOO_MANY_OPERATIONS",
      `transaction has ${t.operations.length} operations (max ${Yr})`
    );
  return t.operations.forEach((o, r) => fm(o, r)), {
    version: Je,
    id: t.id,
...
const bm = "omnicam/library", gm = "majoor_omnicam/blockout_library", ym = Object.freeze({
...
function ls(e) {
  return e.file ? `${e.source === "legacy" ? gm : bm}/${e.file} [input]` : "";
}
function Jr(e, t, a) {
  const o = e || "asset";
  let r = `${o}_${a}`, n = 2;
...
function wm(e, t = {}) {
  ...
  const a = vm(t.point, [0, 0, 0]), o = String(t.idSeed || Date.now().toString(36)), r = String(e.kind || "prop"), n = r === "character", i = ym[e.id];
  if (r === "helper" && !e.file && i && i !== "null")
    return {
      id: Jr(i, t.existingIds, o),
      type: i,
      name: e.name || i,
      position: a,
      rotation: [0, 0, 0],
  ...
  const c = {
    id: Jr(r === "character" ? "character" : r, t.existingIds, o),
    type: "glb",
...
const Sm = {
  [D.ASSET_INSTANTIATE](e, t) {
    ...
    let o;
    try {
      o = wm(t.asset, { point: t.point, idSeed: t.id, existingIds: a });
    } catch (r) {
  ...
  [D.CAMERA_SET_ACTIVE](e, t) {
    return Zo(e, t.cameraId), e.active_camera_id = t.cameraId, { dirtyMask: _.viewport | _.previews | _.inspector | _.outliner | _.timeline };
  },
  [D.CAMERA_SET_LOCKED](e, t) {
    return Zo(e, t.cameraId).locked = t.value, { dirtyMask: _.outliner | _.inspector | _.viewport };
  },
  [D.CAMERA_CREATE](e, t) {
    const a = em(e, t);
  ...
  [D.CAMERA_TRANSFORM](e, t) {
    const a = At(e, t.cameraId), o = Zr(a);
  ...
  [D.CAMERA_LOOK_AT](e, t) {
    ...
    if (t.objectId !== void 0 && (t.objectId === null || t.objectId === "" ? (a.target_object_id = null, a.id === e.active_camera_id && (e.target_object_id = null)) : (Qo(e, t.objectId), a.target_object_id = t.objectId, a.id === e.active_camera_id && (e.target_object_id = t.objectId))), t.point) {
      const o = Zr(a);
      o.target = [...t.point];
  ...
  [D.OBJECT_SET_LOCKED](e, t) {
    return Qo(e, t.objectId).locked = t.value, { dirtyMask: _.outliner | _.inspector };
  },
  [D.OBJECT_SET_TAGS](e, t) {
    const a = Mt(e, t.objectId), o = ei(t.tags), r = o.length !== t.tags.length ? "some tags were dropped or normalised" : void 0;
    return o.length ? a.tags = o : delete a.tags, { dirtyMask: _.outliner | _.inspector | _.viewport, warning: r };
  },
  [D.OBJECT_SET_ANNOTATION](e, t) {
    const a = Mt(e, t.objectId), o = t.annotation === null ? null : Tn(t.annotation);
    if (t.annotation && !o)
  ...
  [D.CHARACTER_SET_JOINT_ROTATION](e, t) {
    ...
    return a.character = {
      ...a.character || {},
      pose: Qs(a.character?.pose, t.joint, t.rotation)
    }, { dirtyMask: _.viewport | _.previews | _.inspector };
  },
  [D.CHARACTER_SET_MOTION](e, t) {
    const a = oo(e, t.objectId), o = pr(t.motion);
...
function jm({ state: e, operation: t }) {
  const a = Sm[t.type];
...
function $m(e, t) {
  ...
  try {
    ...
    if (p instanceof I) return Ko(e, t?.id, p);
    throw p;
  }
  const o = er(e);
  ...
  for (let p = 0; p < a.operations.length; p += 1)
    try {
      const m = jm({ ui: e, state: r, operation: a.operations[p] });
      n |= m?.dirtyMask || 0, m?.warning && i.push(m.warning), m?.outcome && c.push({ index: p, ...m.outcome });
    } catch (m) {
      if (m instanceof I)
        return (m.operationIndex === null || m.operationIndex === void 0) && (m.operationIndex = p), Ko(e, a.id, m);
      throw m;
    }
  if (a.validateOnly)
    return {
  ...
  e.checkpoint?.(a.description), e.state = fr(r);
  const l = Cm(e);
  return (e._directorApiTxIds ||= /* @__PURE__ */ new Set()).add(a.id), e.serialize?.(), Em(e, l), Am(e, n, `director-api:${a.id}`), {
    ok: !0,
    version: Je,
    baseRevision: o,
    revision: er(e),
...
function Tm(e) {
  return e.directorApi = Mm(e), e.directorApi;
}
const Qr = "omnicam-agent/1", en = "majoor.omnicam.agent.request", Im = 1, no = Object.freeze({
...
function Lm(e, t, a) {
  ...
  async function v(y) {
    const S = y?.detail;
    if (o || !S || S.protocol !== Qr || Number(S.schema_version) !== Im || S.session_id !== r || String(S.node_id) !== String(t.id)) return;
    let x;
    try {
      if (S.kind === "query")
        ...
        const E = S.payload;
        !Number.isInteger(E?.baseRevision) || E.baseRevision < 0 ? x = Do(
          e,
          "BASE_REVISION_REQUIRED",
          "External Agent transactions require baseRevision"
        ) : x = e.directorApi.execute(E);
      } else
        x = Do(e, "UNKNOWN_AGENT_REQUEST", `Unsupported Agent request kind: ${S.kind}`);
    } catch (E) {
      x = Do(e, E?.code || "INTERNAL", E?.message || "OmniCam Agent request failed");
    }
    try {
      await so(a, no.reply, {
        session_id: r,
  ...
  return a.addEventListener?.(en, v), a.addEventListener?.("status", g), d(), {
    get sessionId() {
      return r;
    },
    dispose() {
      if (o) return;
      o = !0, clearInterval(c), clearTimeout(l), a.removeEventListener?.(en, v), a.removeEventListener?.("status", g);
      const y = r, S = n;
...
function kr({ fetchApi: e = Fm } = {}) {
  const t = (a, o) => Promise.resolve(e(a, o)).then(zm);
  return {
    list(a = {}) {
      const { kind: o, tag: r, search: n, offset: i, limit: c } = a, l = { tag: r, search: n, offset: i, limit: c };
      return o && o !== "all" && (l.kind = o), t(`${$e}${tn(l)}`);
    },
    get(a) {
    ...
    importModel(a, o = {}) {
      const r = new FormData();
      return r.append("file", a, o.filename || a.name || "model.glb"), t(`${$e}/import${tn(o)}`, { method: "POST", body: r });
    },
...
const ds = Object.freeze(["all", "character", "prop", "environment", "vehicle"]);
function an(e = {}) {
  const t = String(e.kind || "all").toLowerCase();
  return {
    kind: ds.includes(t) ? t : "all",
...
function Rm(e) {
  ...
  return {
    ...
    setFilter(i) {
      return a.filter = an({ ...a.filter, ...i }), a.offset = 0, this.refresh();
    },
    refresh() {
      return n(async () => {
...
const Bm = 256;
function on(e = {}) {
  const { THREE: t, GLTFLoader: a, FBXLoader: o, size: r = Bm } = e;
  if (!t || !a)
...
function Gm(e, { selected: t = !1, thumbUrl: a = "" } = {}) {
  const o = Wm[e.kind] || "pi-box", r = e.kind === "character" && In(e.rig) === "rigged" ? `<span class="oc-asset-badge">${s("RIGGED")}</span>` : "", n = a ? `<img class="oc-asset-thumb" src="${it(a)}" alt="" loading="lazy">` : `<span class="oc-asset-thumb oc-asset-thumb--glyph"><i class="pi ${o}"></i></span>`;
...
function Ym(e, { selectedId: t = "", thumbUrls: a = {} } = {}) {
  return !e || !e.length ? `<p class="oc-asset-empty">${s("No assets match this filter.")}</p>` : e.map((o) => Gm(o, {
    selected: o.id === t,
    thumbUrl: a[o.id] || ""
  })).join("");
}
...
function Xm(e, t = {}) {
  const a = e.root, o = t.fetchApi || ((z, R) => (e.api || e.app?.api).fetchApi(z, R)), r = t.apiClient || kr({ fetchApi: o }), n = t.store || Rm(r), i = Km(), c = t.previewQueue || Dm(), l = e.api || e.app?.api || null;
  let p = t.thumbnailRenderer || null, m = null;
  const h = /* @__PURE__ */ new Set();
  function d() {
    return p ? Promise.resolve(p) : (m || (m = qm().then((z) => p = on(z)).catch(() => p = on({}))), m);
  }
  function f(z) {
    return Lr(l, ls(z));
  }
  function u(z) {
    return z.thumbnail ? Lr(l, `omnicam/library/${z.thumbnail} [input]`) : "";
  }
  function b() {
    for (const z of n.state.items) {
      ...
      R && c.enqueue(z.id, async () => {
        ...
        if (i.set(z.id, le), G(), !(z.source && z.source !== "user"))
          try {
            const be = await r.uploadThumbnail(z.id, Um(le));
  ...
  let q = !1;
  function G() {
    if (S && (S.innerHTML = Hm(n.state.filter.kind, n.state.kinds)), y) {
      const z = {};
      for (const R of n.state.items) {
        const ie = i.get(R.id) || u(R);
        ie && (z[R.id] = ie);
      }
      y.innerHTML = Ym(n.state.items, { selectedId: Y, thumbUrls: z });
    }
    if (!q) {
      q = !0;
      try {
...
function Jm(e, t = {}) {
  ...
  const r = [];
  let n = Go(e.state?.metadata?.viewport_labels);
  function i(m) {
    if (!r[m]) {
  ...
  function l() {
    ...
    let b = 0;
    for (const v of u) {
      if (!On(v, { mode: n.mode, selectedIds: d })) continue;
      const g = Pn(v, n.content);
      if (!g) continue;
      const y = Ln(u, v, f) || {
        position: v.position,
        size: v.size
      }, S = e.webgl.projectWorldToScreen(Fn(y, v.type));
  ...
  function p(m) {
    n = Go({ ...n, ...m }), e.state.metadata = { ...e.state.metadata || {}, viewport_labels: { ...n } }, e.serialize?.(), l();
  }
  return l(), {
    update: l,
    get settings() {
...
function Zm(e) {
  ...
  return {
    ...
    getRigInfo(a) {
      const o = e.state?.objects?.find((i) => i.id === a) || null, r = t(a), n = Yo(r);
      return {
        objectId: a,
...
function Qm(e, t) {
  const a = (o) => [`<option value="">${s("— unmapped —")}</option>`].concat(
    e.map(
      (r) => `<option value="${nn(r)}"${r === o ? " selected" : ""}>${nn(r)}</option>`
    )
  ).join("");
  return zn.map((o) => {
...
function ep(e, t = {}) {
  const a = e.root, o = t.apiClient || kr({
  ...
  function h() {
    if (!i) return;
    const g = Fr(l);
    Fo(l) ? (i.textContent = s("Humanoid v1 ✓ — all 22 joints mapped"), i.dataset.state = "ok") : (i.textContent = s("Incomplete — {n} joint(s) unmapped").replace("{n}", g.length), i.dataset.state = "warn");
  }
  function d() {
  ...
  function b(g) {
    ...
    y === "auto" ? (l = Yo(m()), d()) : y === "validate" ? (d(), e.setStatus?.(Fo(l) ? s("Rig is complete") : s("Rig still missing: {list}").replace("{list}", Fr(l).join(", ")))) : y === "save" && v();
  }
  async function v() {
    const g = p();
    if (!g?.asset_id) {
    ...
    try {
      const y = await o.patch(g.asset_id, {
        rig: { profile: zr, bone_map: l }
      });
      g.character = {
        ...g.character || {},
        rig_profile: Fo(l) ? zr : null
...
function op(e, t = {}) {
  ...
  function g(j) {
    ...
    return ai({ preset: F, overrides: j?.pose }).joints;
  }
  function y() {
    const j = f();
  ...
  function S() {
    ...
    l && (l.textContent = j);
    const q = f(), G = g(q?.character)[j] || [0, 0, 0, 1], oe = oi(G);
    p.forEach(($, W) => {
  ...
  function M() {
    const j = b();
    if (!j) return;
    const F = p.map((oe) => Number(oe?.value) || 0), q = ti(F), G = e.directorApi?.execute({
      version: 1,
  ...
  async function L() {
    ...
    const q = F.toLowerCase().replace(ap, "-").replace(/^-+|-+$/g, "").slice(0, 60) || "pose";
    try {
  ...
  function u() {
    ...
    if (o) {
      ...
      o.dataset.sig !== E && (o.dataset.sig = E, o.replaceChildren(
        sn("", y.length ? s("No motion (static)") : s("No clips in this model")),
        ...y.map((M) => sn(M, M))
      )), document.activeElement !== o && (o.value = S?.clip_id || ""), o.disabled = !y.length;
    }
    Bo(r, S?.start_frame ?? 0), Bo(n, S?.end_frame ?? 0), Bo(i, S?.speed ?? 1), c && document.activeElement !== c && (c.checked = S ? S.loop !== !1 : !0);
    const x = !!S;
...
function np(e, t) {
  ...
  const a = e.activeCameraTrack(), o = xl(t, {
...
function sp(e, t) {
  ...
  const o = vl(a, { type: t, intensity: 1, duration_frames: e.state.duration_frames });
...
const cn = ["#4aa3ef", "#f2a93b", "#48c774", "#b565d8", "#ec4899"], qe = [4, 8, 12, 20, 35, 60, 100];
function mt(e) {
...
function mp(e, t, a, o) {
  const r = Mo(e, a, o);
  if (!r) return;
  const { rx: n, ry: i, radarSize: c, cx: l, cy: p, innerRadius: m, range: h, scale: d, camPos: f, camTgt: u, cameras: b, activeTrack: v } = r, g = mt(e), y = e.state.active_camera_id || v?.id, S = (te, pe) => ps(r, te, pe);
  ...
  for (const te of e.state.objects || []) {
    ...
    const pe = hr(e.state.objects, te).position || [0, 0, 0], [ye, ue] = S(pe[0], pe[2]);
  ...
  for (let te = 0; te < b.length; te++) {
    const pe = b[te], ye = pe.keyframes || [], ue = pe.id === y, xe = pe.color || cn[te % cn.length];
  ...
  const [M, K] = S(f[0] || 0, f[2] || 0), [L, Y] = S(u[0] || 0, u[2] || 0), U = 8, H = X(M, n + U, n + c - U), ne = X(K, i + U, i + c - U), j = X(L, n + U, n + c - U), F = X(Y, i + U, i + c - U), q = f[1] || 0, G = lp(q), oe = dp(q);
...
function hs(e, t, a, o) {
  const { camPos: r, camTgt: n, cameras: i, rx: c, ry: l, radarSize: p } = t, m = (v, g) => ps(t, v, g), [h, d] = m(r[0] || 0, r[2] || 0);
  ...
  for (const v of e.state.objects || []) {
    ...
    const g = hr(e.state.objects, v).position || [0, 0, 0], [y, S] = m(g[0], g[2]);
...
function hp(e, t, a, o) {
  ...
  const r = Mo(e, e.canvas.width, e.canvas.height);
  if (!r) return !1;
  const { rx: n, ry: i, radarSize: c } = r;
  if (a < n || a > n + c || o < i || o > i + c)
    return !1;
  t.preventDefault?.(), t.stopPropagation?.();
  const l = mt(e), p = fs(r, a, o);
  if (p)
...
function up(e, t, a, o) {
  ...
  if (n.drag) {
    const [b, v] = tr(r, a, o), g = e.viewportCamera();
  ...
  const m = fs(r, a, o), h = hs(e, r, a, o), [d, f] = tr(r, a, o);
...
function gp(e, t, a) {
  ...
  const o = () => {
    ...
    const f = ni(t('[data-role="object-tags"]')?.value || "");
    f.length ? d.tags = f : delete d.tags;
    const u = String(t('[data-role="object-annotation"]')?.value || "").trim(), b = u ? Tn({
      text: u,
  ...
  }, { signal: a }), Ml(e, a), rd(e, a), t('[data-role="curve-group"]')?.addEventListener("change", () => {
    e.setChannelFilter("all"), Qn(e), e.drawCurveEditor(), xr(e);
  ...
  e.root.addEventListener("pointerdown", (d) => {
    ...
    const f = e.interactionElement.getBoundingClientRect(), u = (d.clientX - f.left) * e.canvas.width / Math.max(1, f.width), b = (d.clientY - f.top) * e.canvas.height / Math.max(1, f.height);
    bp(e, d, u, b) || e.onWheel(d);
  }, { passive: !1, signal: a }), e.root.addEventListener("wheel", hl(e.root), { signal: a }), window.addEventListener("pointermove", (d) => {
  ...
  l && (l.addEventListener("pointerdown", (d) => e.onTimelinePointerDown(d), { signal: a }), l.addEventListener("pointermove", (d) => e.onTimelinePointerMove(d), { signal: a }), l.addEventListener("pointerup", (d) => e.onTimelinePointerUp(d), { signal: a }), l.addEventListener("pointercancel", (d) => e.onTimelinePointerUp(d), { signal: a }), l.addEventListener("wheel", (d) => $n(e, d), { passive: !1, signal: a }));
  const p = (d) => {
    const f = si(d.composedPath?.()[0] || d.target);
    f && (e.lastKeyZone = f);
  };
  e.root.addEventListener("focusin", p, { signal: a }), e.root.addEventListener("pointerdown", p, { capture: !0, signal: a }), e.root.addEventListener("focusout", (d) => {
    e.modalTransform && !e.root.contains(d.relatedTarget) && (ri(e), e.render());
  }, { signal: a });
...
function vp(e, t) {
  ur.find((o) => o.id === e)?.onChange?.(t);
}
function xp(e) {
  const t = Ji(e.id, e.defaultValue), a = `pref_${e.id.replace(/[^a-zA-Z0-9]/g, "_")}`;
  if (e.type === "boolean")
    return `
...
function wp(e) {
  const t = new Map(ur.map((o) => [o.id, o]));
  return ({
    nav: [
      Bi,
      qi,
  ...
  a.className = "oc-modal-backdrop", a.setAttribute("role", "dialog"), a.setAttribute("aria-modal", "true"), a.setAttribute("aria-label", s("OmniCam Preferences")), a.innerHTML = `
    <div class="oc-modal-dialog oc-pref-dialog" tabindex="-1">
      <div class="oc-pref-header">
        <div class="oc-pref-title">${kp()}</div>
...
const _p = ["position", "target"], Cp = ["fov", "zoom"], Ep = ["roll"], Ap = ["position", "size"], $p = ["rotation"];
function ar(e) {
...
function mn(e, t, a, o) {
  const r = ar(Number(a || 0) - Number(e || 0)), n = Number(e || 0) + r * o;
  if (t == null) return n;
  const i = ar(Number(t || 0) - n);
  return n + i / 3;
}
function pn(e, t, a) {
  ...
  for (let r = 1; r < a.length - 1; r++) {
    ...
    if (Array.isArray(i.position) && Array.isArray(n.position) && Array.isArray(c.position)) {
      ...
      for (const m of $p) {
        const h = n[m], d = i[m], f = c[m];
        if (Array.isArray(h) && Array.isArray(f) && Array.isArray(d)) {
          const u = [0, 1, 2].map((b) => mn(h[b], d[b], f[b], p));
          a[r][m] = d.map((b, v) => fn(Number(b), u[v], o));
        }
      }
    }
  }
...
function zp(e, t) {
  ...
  const o = (r) => {
    ...
    const u = (v) => {
      ...
      let y = Pp;
      v.shiftKey ? y = Lp : (v.ctrlKey || v.metaKey) && (y = Fp);
      const S = p * y * 20;
      let x = l + g * S;
...
function Kp(e, t) {
  for (const o of e.root.querySelectorAll('[data-act="toggle-camera-lock"]'))
    o.addEventListener("click", (r) => {
      r.stopPropagation(), e.checkpoint?.("Toggle camera lock"), e.state.camera_lock = !e.state.camera_lock, e.serialize?.(), us(e), e.setStatus?.(e.state.camera_lock ? s("Camera View locked") : s("Camera View unlocked"));
    }, { signal: t });
...
function Dp(e, t) {
  ...
  !a || !o || (r && r.addEventListener("change", () => {
    ...
    document.activeElement !== a && (a.value = yr(o.value));
  }, { signal: t }));
}
function Bp(e, t) {
  ...
  }, n = (i) => (e.smoothingBaseline?.cameraId !== i.id && (e.smoothingBaseline = { cameraId: i.id, keys: Op(i.keyframes) }), e.smoothingBaseline.keys);
  a.addEventListener("input", r, { signal: t }), a.addEventListener("change", () => {
    const i = e.activeCameraTrack();
    if (!i) return;
    e.checkpoint("Path smoothing");
    const c = Number(a.value) / 100, l = Ip(n(i), c);
  ...
  if (a.length) {
    ...
    for (const o of a)
      o.addEventListener("change", () => {
        e.dopeChannels = new Set(a.filter((r) => r.checked).map((r) => r.dataset.dopeChannel)), Hn(e);
      }, { signal: t });
  }
}
function Vp(e, t) {
...
const co = () => import("./chunk-DMfefLgU.js");
function Gp(e, t) {
...
function Yp(e, t) {
  ...
  Zi().then((r) => {
    ...
    c === "health-slow" ? ec(e) : c === "health-smooth" ? tc(e) : c === "health-recenter" && ac(e);
  }, { signal: t });
  for (const r of e.root.querySelectorAll('[data-tab="health"]'))
    r.addEventListener("click", () => zo(e), { signal: t });
}
function Xp(e, t) {
...
function Qp(e, t) {
  Gp(e, t), Dp(e, t), Bp(e, t), qp(e, t), Up(e, t), Xp(e, t), Zp(e, t), Jp(e, t), zp(e, t), Np(e, t), Wp(e, t), Hp(e, t), Kp(e, t), Vp(e, t), Yp(e, t);
}
const hn = {
...
}, bs = "balanced", Uo = "#121212";
function Sr(e) {
  return hn[e] || hn[bs];
}
function ef(e, t = "#1b1f2b", a = "#151822", o = "#1e2330", r = "#161922", n = "#111319") {
...
function $b(e, t, a = bs) {
  ...
  const f = new e.FogExp2(1250588, 8e-3), u = ef(e), b = new e.PMREMGenerator(t);
  b.compileEquirectangularShader();
  const v = new yl(), g = b.fromScene(v, 0.04).texture;
  return v.traverse((y) => {
    y.geometry?.dispose?.();
...
function Tb(e, t, a, o, r) {
  o.group.visible = r, t.environment = r ? o.environment : null, t.background = r ? o.sky : new e.Color(1184274), t.fog = r ? o.fog : null, a.toneMapping = r ? e.ACESFilmicToneMapping : e.NoToneMapping, a.toneMappingExposure = r ? Sr(o.quality).toneExposure : 1, t.traverse((n) => {
...
function af(e) {
  ...
  const r = e.reconstruction, n = r.provider || "Reconstructed", i = Math.round(t * 100), c = Dc(e), l = c.length ? `
` + c.map(([m, h]) => `${m}: ${h}`).join(`
`) : "", p = `${n} • ${o} (${i}%)${l}`;
  return {
    label: o,
...
function Ib(e, t, a) {
  return e?.reconstruction ? a ? "neutral" : of(t) === "source_texture" ? "textured" : "neutral" : null;
}
function rf(e, t) {
...
function nf(e, t, a) {
  ...
  if (o) {
    const n = (i) => {
      const c = i.target.closest?.("[data-axis], [data-axis-center]") || i.target, l = c.getAttribute("data-axis"), p = oc(l?.toLowerCase(), e.state.view_mode);
  ...
  for (const n of e.root.querySelectorAll("[data-lens]"))
    n.addEventListener("click", () => {
      Bc(e, Number(n.dataset.lens));
    }, { signal: a });
  for (const n of e.root.querySelectorAll("[data-blocking-scene]"))
    n.addEventListener("click", () => {
      cp(e, n.dataset.blockingScene), e.closeMenus();
    }, { signal: a });
...
const sf = 32, cf = 0.025, lf = 0.05, wo = 1e-6, df = ["top", "bottom", "front", "back", "left", "right"], mf = {
  top: "y",
  bottom: "y",
  front: "z",
  back: "z",
...
function pf(e) {
  let t = 0;
  for (let a = 1; a < e.length; a++) t += _r(e[a - 1], e[a]);
  return t;
}
function un(e) {
  const t = Math.max(0, Math.round(Number(e?.duration_frames) || 1) - 1), a = Array.isArray(e?.playback_range) ? e.playback_range : [0, t], o = or(Math.round(Number(a[0]) || 0), 0, t), r = or(Math.round(Number(a[1]) || t), 0, t);
  return o <= r ? [o, r] : [r, o];
}
function ff(e, t) {
  ...
  for (let i = 0; i < t; i++) {
    ...
    const l = a[n - 1], p = a[n], m = or((c - l) / Math.max(wo, p - l), 0, 1), h = e[n - 1], d = e[n];
    r.push([
      h[0] + (d[0] - h[0]) * m,
      h[1] + (d[1] - h[1]) * m,
      h[2] + (d[2] - h[2]) * m
...
function gs(e, t = [0, 0, -1]) {
  ...
  return a < wo ? [...t] : [(e[0] || 0) / a, 0, (e[2] || 0) / a];
}
function ys(e, t) {
  const a = Math.hypot(e[0] || 0, e[1] || 0, e[2] || 0);
  return a < wo ? [...t] : [e[0] / a, e[1] / a, e[2] / a];
}
function hf(e, t, a, o) {
...
function bf(e) {
  ...
  const n = Math.min(sf, r.length, o + 1);
  if (n < 2) return [];
  const i = ff(r, n);
  ...
  ], p = e.planeAxis === "y" ? gs(l) : ys(l, [0, 0, -1]), m = e.seedPoint ? 1 : 0, h = [];
  for (let d = m; d < i.length; d++) {
    const f = i[d], u = hf(i, d, p, e.planeAxis), b = he(c);
    b.position = [...f], b.target = uf(f, u, l, e.planeAxis), h.push({
...
function vs(e, t = e.cameraPathDraw) {
  const a = t?.pointerId;
  if (a != null)
    try {
...
function bn(e, t = {}) {
  ...
  if (a === "extend") {
    ...
    const u = Math.max(0, Math.round(Number(e.state.duration_frames) || 1) - 1), [, b] = un(e.state), v = d.length > 1 ? d[d.length - 1].frame - d[0].frame : 24;
    let g = Math.max(b, f.frame + Math.max(6, Math.min(v, 240)));
    g <= f.frame && (g = f.frame + 24), g > u && (l = g + 1), g > b && (p = g), c = [f.frame, g];
  } else
    df.includes(e.state.view_mode) || e.setViewMode?.("top"), c = un(e.state);
  const m = mf[e.state.view_mode] ?? null, h = n ? [...n] : [...r.position];
...
function Cr(e, t) {
  ...
  a.planeAxis && (o[ko[a.planeAxis]] = a.anchor[ko[a.planeAxis]]);
  const r = a.points.at(-1);
  return r && _r(r, o) < cf ? !1 : (a.points.push(o), !0);
}
function Le(e) {
  const t = e.cameraPathDraw;
  return t?.active ? (vs(e, t), e.cameraPathDraw = null, Pt(e), e.setStatus?.(s("Draw Camera Path cancelled")), e.render?.(), !0) : !1;
}
function yf(e) {
  const t = e.cameraPathDraw;
  ...
  if (a.length < 2 || pf(a) < lf || t.range[1] <= t.range[0])
...
function Er(e, t) {
  ...
  return r?.every(Number.isFinite) ? (a.planeAxis && (r[ko[a.planeAxis]] = a.anchor[ko[a.planeAxis]]), r) : null;
}
function xf(e, t) {
  const a = e.cameraPathDraw;
  return a?.active ? t.button === 2 && !t.altKey ? (So(t), e.cameraPathSuppressContextMenuUntil = Date.now() + 1e3, Le(e), !0) : t.button !== 0 || t.altKey || t.ctrlKey || t.metaKey || t.shiftKey ? !1 : (So(t), e.closeMenus?.(), e.interactionElement.focus?.({ preventScroll: !0 }), e.interactionElement.setPointerCapture?.(t.pointerId), a.drawing = !0, a.pointerId = t.pointerId, a.points = [], Cr(e, Er(e, t)), Pt(e), e.requestRender?.("camera-path-draw"), !0) : !1;
}
function wf(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : (So(t), Cr(e, Er(e, t)) && e.requestRender?.("camera-path-draw"), !0);
}
function kf(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : (So(t), t.type === "pointercancel" || t.type === "lostpointercapture" ? (Le(e), !0) : (Cr(e, Er(e, t)), a.drawing = !1, yf(e), !0));
}
function Sf(e) {
  const t = e.cameraPathDraw;
...
function jf(e, t) {
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? Le(e) : bn(e);
    }, { signal: t });
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path-extend"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? Le(e) : bn(e, { mode: "extend" });
    }, { signal: t });
...
function Ar(e, t, { name: a = "", status: o } = {}) {
  const r = t && typeof t == "object" ? t : Kn(), n = { ...r, metadata: { ...r.metadata || {}, scene_name: a || "" } };
...
async function _f(e) {
  await Nt(e, s("New Scene"), s("Start a new scene? Unsaved changes will be lost.")) && Ar(e, Kn(), { name: "", status: s("New scene") });
}
async function Cf(e) {
  if (!e.sceneBaseline) {
  ...
  const o = a?.metadata?.scene_name || xs(e);
  Ar(e, a, { name: o, status: s("Scene reset to last save") });
}
async function Ef(e) {
  const t = xs(e) || s("Untitled"), a = await zt(e, s("Save Scene"), s("Scene name"), t);
  if (a == null) return;
...
function Mf(e, t) {
  mo(e, t, e.root.querySelectorAll('[data-act="scene-new"]'), () => _f(e)), mo(e, t, e.root.querySelectorAll('[data-act="scene-open"]'), () => Af(e)), mo(e, t, e.root.querySelectorAll('[data-act="scene-save"]'), () => Ef(e)), mo(e, t, e.root.querySelectorAll('[data-act="scene-reset"]'), () => Cf(e));
}
const Tf = ["world_point", "object_point", "camera_field"], gn = 40;
function If(e) {
  return (e.keys || []).map((t) => ({ x: t.x, y: t.y, t: t.time_seconds }));
}
function Of(e, t, a) {
  const o = Math.max(1, Number(e.fps) || 24), r = e.width || 1280, n = e.height || 720, i = [];
  for (let c = 0; c <= gn; c += 1) {
    const l = a * c / gn, p = br(e, t.source, l * o, r, n);
...
function Lf(e) {
  ...
  if (!c) return;
  const l = ws(t, e.state.width || 1280, e.state.height || 720), p = (v) => l.x + v * l.w, m = (v) => l.y + v * l.h;
  ...
  for (const v of e.state.motion_layers || []) {
    if (v.enabled === !1) continue;
    const g = Tf.includes(v.source_kind), y = g ? Of(e.state, v, d) : If(v);
...
function Ff(e, t) {
  ...
  a && a.addEventListener("click", (o) => {
    ...
    const n = ws(a, e.state.width || 1280, e.state.height || 720), i = a.width / r.width, c = {
      x: ((o.clientX - r.left) * i - n.x) / Math.max(1, n.w),
      y: ((o.clientY - r.top) * i - n.y) / Math.max(1, n.h)
    }, l = nc(e.state.motion_layers, c, 0.09);
...
function Rf(e, t) {
  ...
  return {
    ...
    motion_scene_fingerprint: ul(e.state)
  };
}
function Kf(e, t) {
  const a = Rf(e, t);
...
function yn(e, t, { frameCount: a = 0, fps: o = 0 } = {}) {
...
const Xe = 1024 * 1024, Df = Object.freeze({
  card: 128 * Xe,
  // MAX_CARD_BYTES
  model: 256 * Xe,
  // MAX_MODEL_BYTES
...
function Rt(e, t) {
  ...
  return !Number.isFinite(o) || o <= a ? null : `${e.name || "File"} is ${xn(o)}; the maximum is ${xn(a)}.`;
}
function Bf(e) {
  return Number(e) <= vn ? null : `${e} frames selected; a background sequence is limited to ${vn}.`;
}
function qf(e) {
...
function Uf(e) {
  ...
  e.audioElement && (Wo(e, r), Promise.resolve(e.audioElement.play()).catch(() => {
  }));
...
async function Wf(e, { load: t = () => import("./vendor-mediabunny-CZ5VNE-V.js") } = {}) {
...
async function Hf(e, t, { decode: a = Wf } = {}) {
  if (!t) return;
  const o = Rt(t, "audio");
  if (o) {
    e.setStatus(o);
  ...
  try {
    ...
    jo(e), e.setStatus(`Failed to load audio: ${r.message || r}`);
  }
}
let lt = null;
function Ss({ api: e }) {
...
const js = /* @__PURE__ */ new WeakSet(), Tt = /* @__PURE__ */ new WeakMap();
function _o(e) {
...
function Yf(e) {
  ...
  Tt.delete(e), js.has(e) && _o(e);
}
function Kt(e, t) {
  const a = e.cardMediaById.get(t);
  a && (e.cardMediaById.delete(t), e.cardMediaAssetById?.delete?.(t), t === "subject" && e.cardMedia === a && (e.cardMedia = null), Yf(a));
}
function Xf(e) {
...
function We(e, t, a, o = !1, r = "") {
  ...
  n && n !== a && Kt(e, t), o && js.add(a), Gf(a), e.cardMediaAssetById ||= /* @__PURE__ */ new Map(), e.cardMediaById.set(t, a), e.cardMediaAssetById.set(t, r || a?.__omnicamAsset || "");
  try {
    a.__omnicamAsset = r || a.__omnicamAsset || "";
  } catch {
  }
...
function _s(e, t, { signal: a, timeout: o = 15e3 } = {}) {
...
async function Cs(e, t, a, o = () => !0, r = null) {
  if (!t || !a) return;
  const n = () => !e.disposed && o(), i = String(t.asset || a).toLowerCase();
  if (r ?? /\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/.test(i)) {
    const l = document.createElement("video");
    if (l.src = a, l.loop = !0, l.muted = !0, l.playsInline = !0, await _s(l, ["loadeddata", "error"], { signal: e.abortController?.signal }).catch(() => {
    }), !n()) {
      _o(l);
      return;
    }
...
async function eh(e, t) {
  ...
  try {
    const c = await wr(lt, { route: "/majoor/omnicam/upload_model", field: "asset", file: t });
...
async function th(e, t) {
  ...
  if (o) {
    ...
    try {
      const r = await wr(lt, { route: "/majoor/omnicam/upload_asset", field: "asset", file: t });
...
async function rh(e) {
    ...
    if (f) {
      if (d === "image" || d === "video") {
        ...
        if (u && u.value) {
          ...
          if (S) {
            const x = await Cs(e, S, y, r, v);
            if (!r()) return;
            S.asset = ot(b, g);
            let E = null;
            if (v)
              try {
                E = await Jf(b, o.signal);
              } catch (M) {
          ...
          }), We(e, "subject", b, !1, b.currentSrc || b.src || ""), yn(e, b, { frameCount: b instanceof HTMLVideoElement ? 0 : 1 }), e.upstreamImageConnected = !0, n = !0, e.render(), e.setStatus(b instanceof HTMLVideoElement ? s("Upstream video preview synced") : s("Upstream image preview synced")));
        }
      }
      if (d === "audio") {
        l = !0;
  ...
  !l && e.upstreamAudioConnected && (jo(e), e.upstreamAudioConnected = !1, e.refreshKeys(), n = !0, e.setStatus(s("Upstream audio disconnected · audio track cleared")));
  ...
  Vc(e) && (n = !0), n && (e.serialize(), e.render());
}
const nh = ["video/mp4;codecs=avc1.42E01E", "video/webm;codecs=vp9", "video/webm;codecs=vp8", "video/webm"], wn = { low: 3e6, balanced: 6e6, high: 12e6 };
function sh(e) {
  return wn[e] || wn.balanced;
}
async function ih({
  canvas: e,
  fps: t,
  ...
  try {
    for (const S of nh)
      if (!(n.isTypeSupported && !n.isTypeSupported(S)))
        try {
          h = new n(m, { mimeType: S, videoBitsPerSecond: sh(r) });
          break;
        } catch {
        }
...
async function lh(e) {
  await Promise.all([...e].filter((t) => t instanceof HTMLVideoElement && t.seeking).map((t) => _s(t, ["seeked", "error"], { timeout: 5e3 }).catch(() => {
  })));
}
async function Es(e) {
  await lh(e.cardMediaById.values());
}
async function As(e) {
  return ih({
    canvas: e.canvas,
...
async function $s(e, t) {
  const a = await ch(Ve, t);
  if (Kf(e, t), e.state.playblast_camera_id === Dn)
...
async function mh(e) {
  ...
  try {
    let n = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-Dc3v2fS-.js");
    i !== "realtime" && await l(e.canvas.width, e.canvas.height) && (n = await c(e.canvas, e.state.duration_frames, e.state.fps, async (p) => {
      e.setFrame(p, !0), e.setStatus(s(`Encoding frame ${p + 1}/${e.state.duration_frames}…`)), await Es(e), await new Promise((m) => requestAnimationFrame(m));
    }, e.abortController?.signal, e.state.playblast_quality)), n || (e.setStatus(s("WebCodecs unavailable; recording realtime fallback…")), n = await As(e)), e.setFrame(t), await $s(e, n);
  } catch (n) {
...
async function Ms(e) {
  ...
  return wr(Lt, { route: "/majoor/omnicam/upload_asset", field: "asset", file: e });
}
async function Co(e) {
...
async function fh(e, t) {
  ...
  let r = null;
  try {
    if (e.setStatus(`Uploading background: ${t.name}`), r = await Ms(t), o !== e.backgroundRequestId || e.disposed) {
      await Co([r]);
      return;
    }
    const n = Ue(r.path);
    ...
    if (r && await Co([r]), o !== e.backgroundRequestId || e.disposed) return;
...
async function hh(e, t) {
  ...
  try {
    ...
    for (const c of t)
      if (n.push(await Ms(c)), r !== e.backgroundRequestId || e.disposed) {
        await Co(n);
        return;
      }
    ...
    if (await Co(n), r !== e.backgroundRequestId || e.disposed) return;
    e.setStatus(`Failed to load BG sequence: ${i.message || i}`);
  }
}
function uh(e) {
  $r(e), e.checkpoint?.("Clear background"), e.state.viewport_bg_image = "", e.state.viewport_bg_sequence = [], e.viewportBgImage = null, e.viewportBgSequenceImages = [], e.serialize(), e.render(), e.setStatus("Background cleared");
}
function bh(e) {
  const t = Go(e.state?.metadata?.viewport_labels);
  ...
  for (const m of a) {
    if (m.enabled === !1 || !On(m, { mode: t.mode, selectedIds: p })) continue;
    const h = Pn(m, t.content);
    if (!h) continue;
    const d = Ln(a, m, l) || { position: m.position, size: m.size }, f = ze(Fn(d, m.type), o, n, i);
    if (!f) continue;
    ...
    r.fillStyle = "rgba(16,17,22,0.82)", gh(r, M, K, x, E, 4 * c), r.fill(), v && (r.strokeStyle = v, r.lineWidth = Math.max(1, c), r.stroke()), r.fillStyle = v || "#e6e6ec", r.fillText(h, M + g, K + E - y - 2 * c);
  }
  r.restore();
}
...
function vh(e) {
  ...
  return e._pointFieldCache?.key !== r && (e._pointFieldCache = { key: r, ...cc(t, a, o) }), e._pointFieldCache;
}
const xh = 600;
function wh(e) {
  const { points: t, colors: a } = vh(e);
  if (!t.length) return;
  const o = e.viewportCamera(), r = e.canvas.width, n = e.canvas.height, i = t.length / 3, c = 3 * Math.max(1, Math.ceil(i / xh)), l = /* @__PURE__ */ new Map();
...
function Mh(e) {
  ...
  for (let o = 0; o < e.state.keyframes.length - 1; o++) {
    ...
    t.push(Nn(Rn(n.camera.position, r.camera.position)) * e.state.fps / Math.max(1, n.frame - r.frame));
  }
...
function Th(e) {
  ...
  e.recording && e.state.playblast_labels && bh(e);
}
async function Ih(e, { signal: t } = {}) {
...
async function Ph(e) {
  ...
  const r = o.diagnostic?.issues || [], n = Oh(r);
...
function Nh(e, { perFrame: t = !1 } = {}) {
  const a = e.activeCameraTrack(), o = Mr(e, a), r = Tr(e, a);
...
function Os(e) {
  ...
  const r = (d, f, u, b, v = "") => {
    ...
    `, v.addEventListener("click", () => {
      e.outlinerCollapsedSections ||= /* @__PURE__ */ new Set(), e.outlinerCollapsedSections.has(u) ? e.outlinerCollapsedSections.delete(u) : e.outlinerCollapsedSections.add(u), Os(e);
    ...
    if (t.appendChild(y), !S)
      for (const { object: x, level: E } of g) {
        ...
        F.style.cssText = H ? "color:#fca5a5" : U ? "" : "opacity:.5;text-decoration:line-through", F.textContent = x.name || x.type, F.title = s("Double-click to rename"), F.addEventListener("dblclick", ($) => {
          $.preventDefault(), $.stopPropagation(), Kh(e, x, F);
        }), j.appendChild(F);
        ...
        G.className = "scene-item-actions", G.appendChild(r(U ? "pi-eye" : "pi-eye-slash", U ? "Hide object (Alt+Click to Isolate)" : "Show object (Alt+Click to Isolate)", !U, ($) => {
          if ($?.altKey) {
            ...
            e.toggleObject(x.id);
        }, "color:#ef4444;opacity:.7")), G.appendChild(r(x.locked ? "pi-lock" : "pi-lock-open", "Lock object", x.locked, () => jr(e, x))), G.appendChild(r("pi-copy", "Duplicate object", !1, () => e.duplicateObject?.(x.id))), x.id !== "subject" && G.appendChild(r("pi-trash", "Delete object", !1, () => e.deleteObject?.(x.id))), G.appendChild(r("pi-ellipsis-v", "Object actions", !1, ($) => e.openObjectContext($, x.id))), M.append(ne, j, G), M.title = s("Click to select · Double-click to toggle visibility · Right-click for actions");
        const oe = ($ = {}) => {
...
function Vh(e) {
  ...
  if (n) {
    const j = r.target_object_id || e.state.target_object_id || "", F = `T${Nr()}${e.state.objects.map((q) => `${q.id}\0${q.name || q.type}`).join("|")}`;
    Vo(n, F, () => [
  ...
  Rh(e);
  const i = [...e.camera.position, ...e.camera.target, e.camera.fov, e.camera.roll || 0, e.camera.near, e.camera.far, ...gr(e.camera)];
  ...
  if (!t) {
    ...
    F && (F.textContent = `${r.name} · F${e.frame}`), kn(o, {
  ...
  m && (m.textContent = t.name || t.type), kn(o, {
  ...
  if (v) {
    ...
    const G = e.state.objects.filter(($) => !F.has($.id)), oe = `P${Nr()}${j}${G.map(($) => `${$.id} ${$.name || $.type}`).join("|")}`;
    Vo(v, oe, () => [
      $t("", s("No parent")),
  ...
  if (u && (u.hidden = !L?.animations), b) {
    ...
    Vo(b, `A${j.join("|")}`, () => j.map((F, q) => $t(String(q), F)), String(t.animation_index || 0));
  }
...
function Xh(e) {
  ...
  e.beginCameraEdit(), lc(e.camera, r), e.commitCameraEdit(), e.finishCameraEdit(), zs(e), Yh(e), e.render();
}
function Jh(e) {
  const t = globalThis.performance?.now?.() ?? Date.now();
  (!Number.isFinite(e.lastCameraHudEditAt) || t - e.lastCameraHudEditAt > 300) && e.checkpoint("Edit camera"), e.lastCameraHudEditAt = t;
  ...
  e.camera.position = [a("camera-px", e.camera.position[0]), a("camera-py", e.camera.position[1]), a("camera-pz", e.camera.position[2])], e.camera.target = [a("camera-tx", e.camera.target[0]), a("camera-ty", e.camera.target[1]), a("camera-tz", e.camera.target[2])], e.camera.fov = X(a("camera-fov", e.camera.fov), 5, 150), e.camera.roll = X(a("camera-roll", e.camera.roll || 0), -180, 180), e.camera.near = Math.max(1e-4, a("camera-near", e.camera.near)), e.camera.far = Math.max(e.camera.near + 1e-4, a("camera-far", e.camera.far)), e.beginCameraEdit(), e.commitCameraEdit(), e.finishCameraEdit(), zs(e), e.render();
}
function Zh(e, t) {
  const a = Dt(e);
  if (!a) return;
...
function tu(e) {
  ...
  if (!t.length) return [];
  if (t.length === 1)
    return Ps(e, t[0]), e.selectedObjectId ? [e.selectedObjectId] : [];
...
const vu = ["guides", "safe-areas", "resolution-gate", "aspect-ratio"];
function xu(e) {
...
const Ir = ["pos_x", "pos_y", "pos_z"], rr = 1e-9, To = ["auto", "aligned", "free", "corner"];
function Ae(e, t = 0) {
  const a = Number(e);
...
function nr(e, t, a) {
  const o = Fe(e), r = t ? Fe(t) : o, n = a ? Fe(a) : o, i = Math.max(rr, Ae(e?.frame) - Ae(t?.frame, Ae(e?.frame) - 1)), c = Math.max(rr, Ae(a?.frame, Ae(e?.frame) + 1) - Ae(e?.frame)), l = [0, 0, 0], p = [0, 0, 0];
  for (let m = 0; m < 3; m += 1) {
...
function Ot(e) {
  ...
  return To.includes(t) ? t : "auto";
}
function Au(e, t = null, a = null) {
  const o = Ot(e), r = Fe(e);
  if (o === "corner") {
    const l = Rs(e, t, a);
    return { in: po(r, l.in), out: po(r, l.out), mode: o };
  }
  const n = nr(e, t, a), i = (o === "free" || o === "aligned") && sr(e, "out") || n.out, c = (o === "free" || o === "aligned") && sr(e, "in") || n.in;
...
function dt(e, t, a) {
  const o = $u(e);
  for (let r = 0; r < 3; r += 1) {
    const n = Ir[r], i = o[n] && typeof o[n] == "object" ? o[n] : {};
...
function Ks(e, t, a) {
  const o = Fe(e), r = Au(e, t, a);
  dt(e, "out", Ft(r.out, o)), dt(e, "in", Ft(r.in, o));
}
function Mu(e, t, a, { prevKey: o = null, nextKey: r = null } = {}) {
  if (!e || t !== "in" && t !== "out") return e;
  let n = Ot(e);
  if (n === "corner") return e;
  n === "auto" && (n = "aligned", e.tangents = e.tangents && typeof e.tangents == "object" ? e.tangents : {}, e.tangents.spatial_mode = "aligned", Ks(e, o, r));
  const i = Fe(e), c = Ft([
    Ae(a?.[0]),
    Ae(a?.[1]),
    Ae(a?.[2])
  ], i);
  if (ir(e), dt(e, t, c), n === "aligned") {
    const l = t === "out" ? "in" : "out", p = sr(e, l) || (l === "out" ? nr(e, o, r).out : nr(e, o, r).in), m = Sn(c), h = Sn(p) || m || 1, d = m > rr ? Eo(c, -h / m) : Eo(p, 1);
    dt(e, l, d);
  }
  return e;
}
function Tu(e, t, { prevKey: a = null, nextKey: o = null } = {}) {
  if (!e || !To.includes(t)) return e;
  if (e.tangents = e.tangents && typeof e.tangents == "object" ? e.tangents : {}, e.tangents.spatial_mode = t, t === "auto") {
    if (e.tangents.channels) {
      for (const r of Ir) delete e.tangents.channels[r];
  ...
  if (t === "corner") {
    const r = Rs(e, a, o);
    return ir(e), dt(e, "out", r.out), dt(e, "in", r.in), e;
  }
  return ir(e), Ks(e, a, o), e;
}
function Iu(e) {
  switch (e) {
    case "auto":
...
function Pu(e) {
  ...
  return {
    ...
    restoreHistorySnapshot(O) {
      ...
      const k = jn(this.state), w = new Set(this.state.objects.map((se) => se.id));
    ...
    openObjectContext(O, A) {
      ...
      this.showContextMenu(O, k.name || k.type, [
        ...
        { label: k.locked ? s("Unlock object") : s("Lock object"), icon: k.locked ? "pi-lock" : "pi-lock-open", run: () => jr(this, k) },
        null,
        {
          label: s("Transform mode"),
          icon: "pi-arrows-alt",
    ...
    resizeCanvas() {
      ...
      for (const N of this.cameraPreviewCanvases.values()) {
        const Z = N.clientWidth || 220, B = N.clientHeight || 124, se = Math.max(A, Ou / Math.max(1, Z)), je = Math.max(1, Math.round(Z * se)), Ie = Math.max(1, Math.round(B * se));
...
function Lu(e, t) {
  ...
  const o = mr();
  o.position = [0, 0, 0], o.target = [0, 0, -1], a.camera = he(o), a.keyframes = [{ frame: 0, camera: he(o), interpolation: "ease" }], e.state.active_camera_id = a.id, e.state.camera = he(o), e.state.keyframes = a.keyframes, e.camera = he(o), e.frame = 0, e.selectedEntity = "camera", e.selectedObjectId = null, e.selectedKeyFrame = 0, e.editingKeyFrame = null, e.cameraEditKey = null, e.cameraEditActive = !1, e.cameraPreviewSignature = "", Ds(e), e.refreshCameraSelectors(), e.setStatus(s(`${a.name} animation reset`));
}
function Fu(e, t) {
  const a = e.state.objects.find((o) => o.id === t);
  a && (e.checkpoint("Reset object animation"), a.keyframes = [], a.position = [0, 0, 0], a.rotation = [0, 0, 0], e.frame = 0, e.selectedEntity = "object", e.selectedObjectId = a.id, e.selectedKeyFrame = null, e.editingKeyFrame = null, Ds(e), e.setStatus(s(`${a.name || a.type} animation reset`)));
}
const _n = { motion: "motion", shot: "display", health: "health" }, zu = {
  object: "Object",
  camera: "Camera",
  camera_target: "Look-At Target",
  camera_path: "Camera Path"
}, Nu = { motion: "Motion", shot: "Shot", health: "Health" }, Ru = ["entity", "motion", "shot", "health"];
function Bs(e) {
  return e.inspectorMode && e.inspectorMode !== "entity" ? e.inspectorMode : "entity";
}
function Ku(e) {
  const t = Bs(e);
  return _n[t] ? _n[t] : e.selectedEntity === "object" ? "scene" : "camera";
}
function Du(e) {
  return [
    e.selectedEntity || "",
...
function Uu(e) {
  ...
  return {
    ...
    setFrame(w, C = !1, T = !0) {
      ...
      for (const Q of N.cameraFocal) document.activeElement !== Q && (Q.value = yr(this.camera.fov));
    ...
    setSpatialHandleMode(w) {
      ...
      this.checkpoint(s("Camera path handle: {mode}").replace("{mode}", w)), Tu(T[N], w, {
        prevKey: T[N - 1] || null,
        nextKey: T[N + 1] || null
    ...
    transformCameraPath(w) {
      ...
      const T = dc(C.keyframes, { origin: mc(C.keyframes), ...w });
    ...
    refreshInspector() {
      this.perf && (this.perf.inspectorRefreshCount = (this.perf.inspectorRefreshCount || 0) + 1), Oa(this), Bu(this);
    },
    setInspectorMode(w) {
      qu(this, w);
    },
...
function Hu(e) {
  const { right: t, up: a, forward: o } = pc(e || {});
  return Vu.map((r) => {
...
const Xu = "http://www.w3.org/2000/svg", rt = 26, Cn = 17, Ju = 5.4;
function nt(e, t) {
  const a = document.createElementNS(Xu, e);
...
function Zu(e) {
  ...
  for (const n of Gu(Hu(a))) {
    const i = rt + n.x * Cn, c = rt + n.y * Cn, l = Yu(n.depth);
...
const tb = ["world_point", "object_point", "camera_field"], Us = {
  manual_2d: "DRAW",
  object_point: "OBJECT",
  world_point: "WORLD",
...
function ob(e, t) {
  if (tb.includes(t.source_kind)) {
    const a = br(e, t.source, 0, e.width || 1280, e.height || 720);
...
function sb(e) {
  ...
  n("motion-sel-name", a.label), n("motion-sel-type", Us[a.source_kind] || "TRACK"), n("motion-sel-binding", ab(e.state, a)), n("motion-sel-start", r.length ? Math.min(...r) : 0), n("motion-sel-end", r.length ? Math.max(...r) : 0);
...
function lb(e) {
  ...
  return {
    ...
    renderViewportOnly() {
      ...
      if (this.webgl)
        try {
          const ae = this.recording ? 1 : this.webgl.supersampleFactor?.() ?? 1, Ke = ae > 1 ? Math.min(ae, 4096 / Math.max(1, w, C)) : 1, to = Ke > 1 ? Math.round(w * Ke) : w, Lo = Ke > 1 ? Math.round(C * Ke) : C;
          this.webgl.render(Ye, N, this.cardMediaById, to, Lo, this.modelUrlsById, this.frame, this.recording, this.selectedEntity, this.selectedObjectId, this.subSelection, this.selectedKeyFrame ?? null), k.imageSmoothingEnabled = !0, k.imageSmoothingQuality = "high", to !== w || Lo !== C ? k.drawImage(this.webgl.canvas, 0, 0, to, Lo, 0, 0, w, C) : k.drawImage(this.webgl.canvas, 0, 0, w, C), Q = !0;
        } catch (ae) {
      ...
      !this.recording && this.state.speed_heatmap && this.drawSpeedHeatmap(), !this.recording && Sf(this), this.drawOverlays(), eb(this), this.state.show_gizmo && Zu(this), this.labelOverlay?.update(), this.rigOverlay?.update(), this.perf && (this.perf.viewportRenderCount = (this.perf.viewportRenderCount || 0) + 1);
    },
    ...
    requestUiUpdate(k = _.viewport, w = "unknown") {
      (this.renderReasons ||= /* @__PURE__ */ new Set()).add(w), this.uiDirtyMask = um(this.uiDirtyMask, k), this.renderInvalidations = (this.renderInvalidations || 0) + 1, !this.renderScheduled && (this.renderScheduled = !0, this.renderFrame = requestAnimationFrame(() => {
    ...
    dispose() {
      this.disposed || (this.disposed = !0, this.agentBridge?.dispose?.(), fc(this), hc(), Gc(this), this.backgroundRequestId = (this.backgroundRequestId || 0) + 1, this.upstreamSyncId = (this.upstreamSyncId || 0) + 1, this.stopPlay(), clearTimeout(this.previewClickTimer), clearTimeout(this.connectionTimer), cancelAnimationFrame(this.restoreFrame), cancelAnimationFrame(this.serializeFrame), cancelAnimationFrame(this.resizeFrame), cancelAnimationFrame(this.renderFrame), this.abortController?.abort(), this.upstreamFetchController?.abort(), this.resizeObserver?.disconnect(), this.contextMenu?.dispose(), this.webgl?.dispose(), this.cameraWebgl?.dispose(), W(this), Xf(this), this.objectUrls.clear(), this.cardMediaById.clear(), this.cardMediaAssetById?.clear?.(), this.modelUrlsById.clear(), this.modelInfoById.clear());
    }
  };
}
const Ws = 1e-9;
...
function Or(e, t) {
  const a = e.map((i) => db(i, t)), o = mb(a), r = e.map((i) => i.frame), n = Math.max(1, r[r.length - 1] - r[0]);
  return a.map((i, c) => [
    (r[c] - r[0]) / n,
...
function fb(e, t, { tolerance: a = 0.02, keepFrames: o = [] } = {}) {
  ...
  const n = Or(r, t), i = /* @__PURE__ */ new Set(), c = new Set(o);
  r.forEach((m, h) => {
...
function hb(e, t, { target: a = 2, keepFrames: o = [] } = {}) {
...
function ub(e, t, { mergeWithin: a = 1, epsilon: o = 1e-3, keepFrames: r = [] } = {}) {
...
function wb() {
  return {
    ...
    deleteSelectedKeyframes() {
      ...
      const t = this._activeTrack(), a = Se(this), o = t.kind === "camera" ? 1 : 0, { keys: r, removed: n } = bb(a, e, { minKeys: o });
    ...
    nudgeSelectedKeyframes(e) {
      ...
      const a = this._activeTrack(), o = Math.max(0, this.state.duration_frames - 1), r = gb(Se(this), t, e, { lastFrame: o });
    ...
    setSelectedKeysInterpolation(e) {
      ...
      this.checkpoint(s("Interpolation on {n} keys").replace("{n}", t.length)), a.write(yb(Se(this), t, e)), this.serialize(), this.refreshKeys(), this.refreshKeyEditor(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} interpolation on {n} keys").replace("{mode}", e.replace(/_/g, " ")).replace("{n}", t.length));
    },
    setSelectedKeysTangentMode(e) {
      const t = this.resolveSelectedFrames();
      if (t.length < 2) return this.setTangentMode(e);
      const a = this._activeTrack(), o = Ze(this).map((r) => r.id);
      this.checkpoint(s("Tangents on {n} keys").replace("{n}", t.length)), a.write(vb(Se(this), t, e, o)), this.serialize(), this.refreshKeys(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} tangents on {n} keys").replace("{mode}", e).replace("{n}", t.length));
    },
    /**
    ...
    simplifyActiveKeys({ mode: e = "simplify", tolerance: t = 0, target: a = 0, scope: o = "camera", fromKeys: r = null, silent: n = !1 } = {}) {
      ...
      const l = this.resolveSelectedFrames(), p = o !== "all_cameras" && l.length >= 2 ? [l[0], l.at(-1)] : null, m = p ? [] : l, h = (u) => {
        ...
        let E = S, M = 0;
        if (S.length > 2) {
          const K = e === "reduce" ? hb(S, i, { target: a || Math.ceil(S.length / 2), keepFrames: m }) : e === "clean" ? ub(S, i, { keepFrames: m }) : fb(S, i, { tolerance: t * xb, keepFrames: m });
      ...
      return Jo(this), this.selectedKeyFrame = null, this.selectedKeyFrames = /* @__PURE__ */ new Set(), this.camera = Ce(this.state, this.frame), this.applyObjectAnimationFrame(), this.serialize(), this.refreshKeys(), this.setFrame(this.frame, !1, !1), this.render(), n || this.setStatus(d ? s("Removed {n} keyframes").replace("{n}", d) : s("No keyframes to remove")), d;
    },
...
class Vs {
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-Dc3v2fS-.js"));
    } catch (a) {
    ...
    if (!this.disposed) {
      ...
      uc(this), this.resizeCanvas(), this.render(), this.renderCameraView();
    }
  }
}
const fo = { app: An, api: Ve, EditorHistory: rs, ContextMenuController: Un, initializeTooltips: Xc, promptText: zt, ObjectUrlRegistry: ns, buildRoot: ss, dispatchDirectorKey: bc, activeCameraTrack: Xo, bindWidgetCallbacks: Jc, playblastCameraTrack: qn, restoreFromWidgets: Zc, serializeEditorState: Qc, syncActiveCameraTrack: Jo, syncFromWidgets: el, bindEditorEvents: zf, activateCamera: tl, addCamera: al, deleteCamera: ol, drawPreviewOverlays: rl, duplicateCamera: nl, maximizeCameraPreview: sl, refreshCameraPreviews: il, refreshCameraSelectors: cl, renameCamera: ll, setPlayblastCamera: dl, toggleCameraView: ml, captureRealtime: As, makePlayblast: mh, uploadDirectorPlayblast: $s, waitForMediaFrame: Es, computeAudioPeaks: ks, loadAudioFile: Hf, releaseAudio: jo, stopPlay: yo, togglePlay: Uf, applyCameraPreset: np, applyCameraShake: sp, applyProxyPreset: ip, clearViewportBgImage: uh, loadViewportBgFile: fh, loadViewportBgSequence: hh, drawCameraPath: $h, drawCard: Ah, drawCube: kh, drawCylinder: _h, drawGrid: yh, drawHuman: jh, drawLine3D: ce, drawNull: Eh, drawOverlays: Th, drawPointField: wh, drawSpeedHeatmap: Mh, drawSphere: Sh, drawTorus: Ch, curveChannels: Ze, drawCurveEditor: Hl, fitCurveView: Zn, onCurveDoubleClick: Wl, onCurvePointerDown: Fl, onCurvePointerMove: zl, onCurvePointerUp: Nl, onTimelinePointerDown: gc, onTimelinePointerMove: yc, onTimelinePointerUp: vc, refreshKeys: cd, resetCurveZoom: Vl, resetTimelineZoom: xc, setChannelFilter: Kl, setCurveInterpolation: Rl, setTangentMode: Dl, timelineFrameFromEvent: cr, toggleCurveHandles: Bl, zoomCurve: Ul, drawTransformGizmo: wc, frameTarget: kc, gizmoAxes: Sc, gizmoGeometry: jc, onPointerDown: _c, onPointerMove: Cc, onPointerUp: Ec, onWheel: Ac, pickGizmo: $c, pickSceneObject: Mc, resetCamera: Tc, setTransformMode: Ic, setViewMode: Oc, viewportCamera: Pc, loadCardFile: th, loadExecutionPreview: ah, loadMediaUrl: Cs, loadModelFile: eh, loadSelectedReference: oh, onModelLoaded: Qf, restoreAssets: Zf, syncUpstreamInputs: rh, configureDomMedia: Ss, refreshSetupDiagnostic: Ph, addMediaCard: Wh, addPrimitive: Dh, applyObjectAnimationFrame: iu, beginCameraEdit: hu, beginObjectEdit: Fs, commitCameraEdit: uu, commitObjectEdit: Gh, copyKeyframe: mu, deleteKeyframe: du, deleteObject: Ls, deleteSelectedObjects: Uh, duplicateObject: Ps, exitKeyEdit: gu, finishCameraEdit: bu, goToAdjacentKey: Eu, insertKeyframe: cu, loadSelectedKeyView: Cu, pasteKeyframe: pu, playblastCameraAtFrame: su, refreshInspector: Vh, refreshKeyEditor: Su, refreshObjects: Os, removeObjectResources: eu, renameObject: Bh, retimeSelectedKey: ju, selectKeyframe: fu, selectedKeyframe: Ne, selectedObject: Dt, selectObjectAnimation: Qh, setKeyInterpolation: lu, setKeyTangentMode: ku, setObjectParent: Zh, timelineKeyframes: Se, timelineObject: Me, toggleAutoKey: yu, toggleObject: qh, updateCameraFromHud: Jh, updateCameraRotationFromHud: Xh, updateEditState: xu, updateKeyVisualState: wu, updateSelectedKey: _u, updateSelectedObject: Hh, clamp: X, cloneCamera: he, configureCore: Bn, defaultCamera: mr, sampleCamera: Ce, sampleObjectTransform: Ao, sanitizeState: fr, worldTransform: hr };
Object.assign(
  Vs.prototype,
  Pu(fo),
  Uu(fo),
...
function kb(e) {
  ...
  const t = new Vs(e);
  ho("director:constructor:complete", e), Tm(t);
  try {
    t.agentBridge = Lm(t, e, Ve);
  } catch (m) {
  ...
  try {
    t.characterRuntime = Zm(t), t.rigMapper = ep(t), t.poseEditor = op(t), t.motionEditor = rp(t);
  } catch (m) {
  ...
  }, t.unwatchGraphConnections = Yc(e, i);
  const l = e.onRemoved;
