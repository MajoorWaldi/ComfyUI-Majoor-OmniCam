import { e as S, a as A, bg as q, v as p, G as I, b6 as _, s as J, b7 as N, bM as X } from "./chunk-D3iZD33H.js";
import { a as Y } from "./chunk-CZ0GcHaY.js";
...
async function Fe(e, t) {
  ...
  e.pathSelection = q(e.pathSelection, e.activeCameraTrack()), e.serialize(), e.refreshCameraSelectors(), e.refreshObjects(), e.refreshKeys(), e.refreshInspector(), e.render(), e.setStatus(p(`${o.name} deleted`));
}
function De(e, t) {
