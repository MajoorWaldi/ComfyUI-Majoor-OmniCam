...
import { d as De, u as qe, l as je, S as Ue, b as Ve, p as Ge } from "./chunk-BdN35MEK.js";
import { M as We, E as Be } from "./chunk-CbqXtcpr.js";
import { v as h, x as be, T as _, y as He, z as Qe } from "./chunk-DVmalmrw.js";
import { c as ve, S as ye, F as xe, a as D, e as ze, r as Ke, b as Ye, m as J, d as Z, f as Xe, s as Je, p as Ze, n as et, L as tt, g as rt } from "./chunk-DHJB-1_T.js";
import { w as ot } from "./chunk-1ZMcjpqN.js";
function at(t) {
...
class ar {
  ...
  async ensurePreview() {
    return this.preview || this.disposed ? this.preview : (this.previewLoad ||= import("./chunk-DNbs9Idw.js").then(({ TrackViewer: e }) => {
...
function ho(t) {
  return import("./chunk-DNbs9Idw.js").then(({ TrackViewer: e }) => (t.viewerLoad = null, t.disposed || t.viewer || (t.viewer = new e(t.$("track-canvas")), t.pushTracksToViewer()), t.viewer)).catch((e) => (t.viewerLoad = null, console.warn("OmniCam track viewer unavailable", e), null));
}
function me(t) {
  const e = t.$("frame");
