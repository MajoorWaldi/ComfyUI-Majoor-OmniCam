...
import { api as et } from "../../scripts/api.js";
import { s as $e, c as Y, t as he, a as s, o as Nn, b as ur, d as tt, e as pe, f as Oo, r as oi, g as br, h as Fn, i as ri, j as ni, k as si, l as ii, m as gr, n as yr, I as xo, p as vr, q as ci, w as li, u as jo, v as Rn, x as di, y as xr, z as Zo, A as Br, B as Kn, C as Qo, D as Dn, E as Bn, F as qn, G as Un, H as er, J as Do, K as qr, O as Ur, R as Wn, L as mi, M as pi, N as fi, P as wr, Q as hi, S as ui, T as bi, U as gi, V as yi, W as kr, X as vi, Y as xi, Z as wi, _ as ki, $ as Si, a0 as ji, a1 as _i, a2 as Ci, a3 as Ei, a4 as Ai, a5 as $i, a6 as Ti, a7 as Mi, a8 as Ii, a9 as Oi, aa as Pi, ab as Li, ac as zi, ad as Ni, ae as Fi, af as Ri, ag as Ki, ah as Di, ai as Bi, aj as qi, ak as Ui, al as Wi, am as Vi, an as Hi, ao as Gi, ap as Yi, aq as Xi, ar as Ji, as as Zi, at as Qi, au as ec, av as tc, aw as ac, ax as oc, ay as rc, az as nc, aA as sc, aB as ic, aC as Vn, aD as Hn, aE as cc, aF as Bo, aG as lc, aH as dc, aI as mc, aJ as pc, aK as fc, aL as qe, aM as hc, aN as Gn, aO as Sr, aP as uc, aQ as bc, aR as gc, aS as Yn, aT as Xe, aU as Ge, aV as yc, aW as Wr, aX as jr, aY as vc, aZ as xc, a_ as wc, a$ as kc, b0 as Sc, b1 as jc, b2 as _c, b3 as Xn, b4 as Cc, b5 as Ec, b6 as Ac, b7 as $c, b8 as Tc, b9 as Mc, ba as Ic, bb as Oc, bc as Pc, bd as Lc, be as zc, bf as Nc, bg as Fc, bh as Rc, bi as Kc, bj as Dc, bk as Bc, bl as qc, bm as Uc } from "./chunk-DbQgFgRj.js";
import { L as Wc, a as Vc, p as Vt, f as _r, b as Hc, S as Gc, c as Vr, d as Yc, e as Xc, r as Jc, g as Zc, n as Qc, C as Hr, h as Ht, o as el, i as tl, s as al, j as ol, k as Jn, l as rl, m as tr, q as ar, w as nl, t as Zn, u as sl, v as il, x as cl, y as ll, z as dl, A as ml, B as pl, D as fl, E as hl, F as ul, G as bl, H as gl, I as yl, J as vl, K as xl, M as wl } from "./chunk-DaanTnls.js";
import { S as kl, b as Sl, p as jl, m as _l, l as Cl, u as El } from "./chunk-BOI_2OKd.js";
...
function $l(e, { type: t = "handheld_subtle", intensity: a = 1, duration_frames: o = null, subdivide: r = !0 } = {}) {
  ...
  return [...b].sort((y, x) => y - x).map((y) => {
    const x = $e(u, y), S = Pt(y * m, 1) * l, g = Pt(y * m, 2) * l, _ = Pt(y * m, 3) * l * 0.5, $ = Pt(y * m, 4) * p, F = Pt(y * m, 5) * (p * 0.35), z = [...x.position], X = [...x.target];
    return z[0] += S, z[1] += g, z[2] += _, X[0] += S * 0.35, X[1] += g * 0.35, {
      frame: y,
      camera: {
        ...x,
        position: z,
        target: X,
        roll: (x.roll || 0) + $,
        fov: Y((x.fov || 35) + F, 10, 140)
      },
      interpolation: "smooth"
    };
  });
}
function Tl(e, { duration_frames: t = 120, target: a = [0, 1.5, 0], radius: o = 6, height: r = 3.5 } = {}) {
...
const Qn = 1e-4;
function Ml(e, t) {
  return !Array.isArray(e) || !Array.isArray(t) ? e !== t : e.some((a, o) => Math.abs(Number(a) - Number(t[o])) > Qn);
}
function Gr(e, t) {
  return Math.abs(Number(e) - Number(t)) > Qn;
}
const es = [
  {
    id: "camera",
  ...
  },
  {
    ...
    label: "Look At",
    color: "#f0a742",
    changed: (e, t) => Ml(e?.target, t?.target),
    read: (e) => e?.target
  },
  {
    id: "focal_length",
...
function Ol(e, t = null) {
  return es.filter((a) => !t || t.has(a.id)).map((a) => ({
    id: a.id,
    label: a.label,
    color: a.color,
    frames: Il(e, a)
...
function _o(e) {
  ...
  for (const a of [".oc-playhead-head", '[data-role="dope-playhead"]', ".oc-gdope-playhead", ".oc-sequence-playhead"])
    for (const o of e.root.querySelectorAll(a)) Pl(o, t);
}
function Ll(e, t, a) {
...
function ts(e) {
  ...
  a.delete("camera");
  const o = e.timelineKeyframes() || [], r = Ol(o, a), n = Nl(e, r);
  if (t.dataset.signature !== n) {
    t.dataset.signature = n, t.replaceChildren();
    const i = (c) => he(e, c);
    for (const c of r) {
      const l = document.createElement("div");
      l.className = "oc-dope-row", l.dataset.channel = c.id, l.style.setProperty("--channel-color", c.color), Ll(l, c.frames, i), zl(e, l, c, o, i), t.appendChild(l);
    }
  }
...
const qo = [1, 2, 5, 10, 20, 25, 50, 100, 200, 250, 500, 1e3, 2e3, 5e3], as = 46, Yr = 5, os = 640;
function rs(e, t) {
  const a = t > 0 ? t : os, o = Math.max(2, Math.floor(a / as)), r = Math.max(1e-6, e / o);
  return qo.find((n) => n >= r) ?? qo[qo.length - 1];
}
function Fl(e, t) {
  const a = Math.max(1, e.state.duration_frames - 1), o = Y(Number(e.timelineZoom) || 1, 0.1, 50), r = Number(e.timelinePan) || 0, n = a / o, i = rs(n, t), l = (i >= Yr ? i / Yr : 0) || i, p = [], m = Math.max(0, Math.floor(r / l) * l);
...
function Kl(e, t) {
  ...
  a.addEventListener("pointerup", i, { signal: t }), a.addEventListener("pointercancel", i, { signal: t }), a.addEventListener("wheel", (c) => Nn(e, c), { passive: !1, signal: t });
}
const Dl = [1, 2, 2.5, 5, 10];
function Bl(e, t = 5) {
  const a = Math.abs(e) / Math.max(1, t);
  if (!(a > 0) || !Number.isFinite(a)) return 1;
  const o = 10 ** Math.floor(Math.log10(a)), r = a / o;
  return (Dl.find((n) => n >= r) ?? 10) * o;
}
function ql(e, t) {
  const a = Math.max(0, Math.min(4, Math.ceil(-Math.log10(t))));
  return e.toFixed(a);
}
function Ul(e, { left: t, right: a, top: o, width: r, graphWidth: n, graphHeight: i, height: c, timeMin: l, timeMax: p, totalDuration: m, xFor: f, frame: d }) {
  const h = rs(p - l, n);
...
function Wl(e, { left: t, right: a, top: o, width: r, graphHeight: n, minimum: i, maximum: c, yFor: l }) {
  const p = Bl(c - i, 4);
  e.strokeStyle = "#222228", e.lineWidth = 1, e.fillStyle = "#6e727a";
  for (let m = Math.ceil(i / p) * p; m <= c; m += p) {
    const f = l(m);
    f < o - 1 || f > o + n + 1 || (e.beginPath(), e.moveTo(t, f), e.lineTo(r - a, f), e.stroke(), e.fillText(ql(m, p), 4, f + 3));
  }
}
function Cr(e, t) {
...
function Hl(e, t) {
  const a = t.currentTarget, { x: o, y: r } = Cr(a, t);
  ...
  if (!e.curveDrag || t.pointerId !== e.curveDrag.pointerId) {
    const f = (e.curveHitPoints || []).map((x) => ({ point: x, distance: Math.hypot(o - x.x, r - x.y) })).sort((x, S) => x.distance - S.distance)[0], d = Math.max(1, e.state.duration_frames - 1), h = d / (Number(e.curveZoomX) || 1), u = Number(e.curvePanX) || 0, b = Math.max(1, a.clientWidth - 58), v = Y(Math.round(u + (o - 44) / b * h), 0, d);
    let y = null;
    if (f && f.distance <= 14) {
  ...
  if (e.curveHover = null, t.preventDefault(), t.stopPropagation(), e.curveDrag.historyCheckpointed || (e.checkpoint?.(e.curveDrag.handle ? "Edit curve tangent" : "Edit curve"), e.curveDrag.historyCheckpointed = !0), e.curveDrag.handle) {
    ...
    if (h === "in") {
      if (g.in_x = Y((o - v) / Math.max(1, u), -0.99, -0.01), g.in_y = (y - r) * b, S === "aligned") {
        const _ = Math.hypot(g.in_x, g.in_y) || 1e-6, $ = Math.hypot(e.curveDrag.startHandles.out_x, e.curveDrag.startHandles.out_y) || 1e-6;
        g.out_x = -g.in_x / _ * $, g.out_y = -g.in_y / _ * $;
      }
    } else if (g.out_x = Y((o - v) / Math.max(1, u), 0.01, 0.99), g.out_y = (y - r) * b, S === "aligned") {
      const _ = Math.hypot(g.out_x, g.out_y) || 1e-6, $ = Math.hypot(e.curveDrag.startHandles.in_x, e.curveDrag.startHandles.in_y) || 1e-6;
      g.in_x = -g.out_x / _ * $, g.in_y = -g.out_y / _ * $;
    }
...
function ss(e, { selectedOnly: t = !1 } = {}) {
  const a = Math.max(1, (e.state?.duration_frames ?? 120) - 1), o = e.timelineKeyframes() || [], r = e.timelineObject(), n = ct(e), i = e.selectedKeyFrames?.size ? [...e.selectedKeyFrames] : e.selectedKeyFrame != null ? [e.selectedKeyFrame] : [], c = i.length > 0, l = t || c && i.length < o.length ? o.filter((b) => i.includes(b.frame)) : o;
  if (!l.length) {
  ...
  if (l.length < o.length && d < a) {
    ...
    e.curveZoomX = Y(a / x, 0.2, 30), e.curvePanX = v;
  } else
  ...
  if (h.length > 0) {
    const b = Math.min(...h), v = Math.max(...h), y = Math.max(1e-4, v - b), x = (b + v) / 2, S = (V) => r ? Oo(r, V) : $e(e.state, V), g = [], _ = Math.max(1, Math.floor(a / 40));
    for (let V = 0; V <= a; V += _) {
      const re = S(V);
      for (const j of n) {
        const N = j.get(re);
        Number.isFinite(N) && g.push(N);
      }
    }
    let $ = Math.min(...g), F = Math.max(...g);
    (!Number.isFinite($) || !Number.isFinite(F)) && ($ = -1, F = 1), Math.abs(F - $) < 1e-6 && ($ -= 1, F += 1);
    const z = (F - $) * 0.1;
    $ -= z, F += z;
    const X = F - $, W = ($ + F) / 2;
    if (l.length < o.length && y < X * 0.75) {
      const V = y * 1.35;
      e.curveZoom = Y(X / V, 0.2, 30), e.curvePanY = x - W;
    } else
...
function od(e) {
  ...
  const i = e.timelineObject(), c = e.timelineKeyframes(), l = ct(e), p = 44, m = 14, f = 16, d = 22, h = Math.max(1, a - p - m), u = Math.max(1, o - f - d), b = Math.max(1, e.state.duration_frames - 1), v = Y(Number(e.curveZoomX) || 1, 0.1, 50), y = Number(e.curvePanX) || 0, x = b / v, S = y, g = y + x, _ = [], $ = Math.max(1, Math.ceil(x / Math.max(80, h))), F = (A) => i ? Oo(i, A) : $e(e.state, A);
  for (let A = 0; A <= b; A += $) _.push({ frame: A, value: F(A) });
  _[_.length - 1]?.frame !== b && _.push({ frame: b, value: F(b) });
  const z = _.flatMap((A) => l.map((G) => G.get(A.value)));
  let X = Math.min(...z), W = Math.max(...z);
  (!Number.isFinite(X) || !Number.isFinite(W)) && (X = -1, W = 1), Math.abs(W - X) < 1e-6 && (X -= 1, W += 1);
  const V = (W - X) * 0.1;
  X -= V, W += V;
  const re = Y(Number(e.curveZoom) || 1, 0.1, 50), j = (W + X) / 2 + (Number(e.curvePanY) || 0), N = (W - X) / re;
  X = j - N / 2, W = j + N / 2;
  const U = (A) => p + (A - S) / Math.max(1e-6, g - S) * h, H = (A) => f + u * (W - A) / Math.max(1e-6, W - X);
  if (n.fillStyle = "#111114", n.fillRect(0, 0, a, o), n.strokeStyle = "#222228", n.lineWidth = 1, n.font = "9px system-ui, -apple-system, sans-serif", n.fillStyle = "#6e727a", Ul(n, {
    left: p,
    right: m,
    top: f,
    width: a,
    ...
    xFor: U,
    frame: e.frame
  }), Wl(n, { left: p, right: m, top: f, width: a, graphHeight: u, minimum: X, maximum: W, yFor: H }), X <= 0 && W >= 0) {
    const A = H(0);
  ...
  for (const A of l) {
    ...
    let G = !1;
    _.forEach((L) => {
      const q = U(L.frame), J = H(A.get(L.value));
      q >= p - 50 && q <= a - m + 50 && (G ? n.lineTo(q, J) : (n.moveTo(q, J), G = !0));
    }), n.stroke();
    for (const L of c) {
      const q = i ? L.transform : L.camera, J = U(L.frame), ce = H(A.get(q)), se = L.frame === e.selectedKeyFrame || e.selectedKeyFrames?.has(L.frame);
      se && (n.fillStyle = "rgba(242, 208, 107, 0.35)", n.beginPath(), n.arc(J, ce, 8.5, 0, Math.PI * 2), n.fill()), n.fillStyle = se ? "#ffd75e" : A.color, n.strokeStyle = "#0d0d10", n.lineWidth = 1.6, n.beginPath(), n.arc(J, ce, se ? 5.2 : 3.8, 0, Math.PI * 2), n.fill(), n.stroke(), e.curveHitPoints.push({
        x: J,
        y: ce,
        key: L,
        channel: A,
    ...
    if (e.showCurveHandles)
      for (let L = 0; L < c.length; L++) {
        const q = c[L], J = q.frame === e.selectedKeyFrame || e.selectedKeyFrames?.has(q.frame);
        if (!(J || e.curveChannelFilter !== "all" || c.length <= 4) || q.interpolation !== "bezier") continue;
        const se = i ? q.transform || i : q.camera || q, ae = U(q.frame), le = H(A.get(se)), be = c[L - 1], fe = c[L + 1], ge = Math.max(1, q.frame - (be?.frame ?? q.frame - 1)), ye = Math.max(1, (fe?.frame ?? q.frame + 1) - q.frame), me = oi(
          q,
          A.id,
          be,
          fe,
          (O) => A.get(i ? O.transform || i : O.camera || q)
        ), Ae = (W - X) / Math.max(1, u), ve = h * ye / Math.max(1, x), xe = h * ge / Math.max(1, x), ue = [];
        (be || L > 0) && ue.push({ side: "in", x: ae + me.in_x * xe, y: le - me.in_y / Ae }), (fe || L < c.length - 1 || c.length === 1) && ue.push({ side: "out", x: ae + me.out_x * ve, y: le - me.out_y / Ae });
        for (const O of ue) {
          if (n.strokeStyle = A.color, n.lineWidth = J ? 1.5 : 1, n.beginPath(), n.moveTo(ae, le), n.lineTo(O.x, O.y), n.stroke(), n.fillStyle = J ? "#2a2233" : "#171720", n.strokeStyle = J ? "#ffd75e" : A.color, n.lineWidth = J ? 2 : 1.2, n.beginPath(), O.side === "in")
            n.arc(O.x, O.y, J ? 5 : 3.8, 0, Math.PI * 2);
          else {
            const D = J ? 4.5 : 3.2;
            n.rect(O.x - D, O.y - D, D * 2, D * 2);
          }
          n.fill(), n.stroke(), e.curveHitPoints.push({
            ...
            object: i,
            handle: O.side,
            pixelPerSegment: O.side === "in" ? xe : ve,
            valuePerPixel: Ae,
            startHandles: { ...me }
          });
        }
  ...
  if (e.curveBoxSelect) {
    const A = Math.min(e.curveBoxSelect.startX, e.curveBoxSelect.currentX), G = Math.min(e.curveBoxSelect.startY, e.curveBoxSelect.currentY), L = Math.abs(e.curveBoxSelect.currentX - e.curveBoxSelect.startX), q = Math.abs(e.curveBoxSelect.currentY - e.curveBoxSelect.startY);
    n.fillStyle = "rgba(56, 189, 248, 0.15)", n.fillRect(A, G, L, q), n.strokeStyle = "#38bdf8", n.lineWidth = 1, n.setLineDash([4, 4]), n.strokeRect(A, G, L, q), n.setLineDash([]);
  }
  const te = U(e.frame);
  if (te >= p && te <= a - m && (n.strokeStyle = "#a78bfa", n.lineWidth = 1.5, n.beginPath(), n.moveTo(te, f), n.lineTo(te, f + u), n.stroke(), n.fillStyle = "#a78bfa", n.beginPath(), n.moveTo(te - 4, f), n.lineTo(te + 4, f), n.lineTo(te, f + 6), n.closePath(), n.fill()), e.curveDrag || e.curveHover) {
    let A = "", G = "";
    if (e.curveDrag)
      if (e.curveDrag.handle) {
        const L = e.curveDrag.handle === "in" ? "In" : "Out";
        A = `F${e.curveDrag.key.frame} · ${e.curveDrag.channel.name} (${L})`, G = "Tangent edit";
      } else if (e.curveDrag.group && e.curveDrag.group.length > 1) {
        const L = e.curveDrag.key.frame - e.curveDrag.startFrame, q = e.curveDrag.channel.get(e.curveDrag.object ? e.curveDrag.key.transform : e.curveDrag.key.camera), J = q - e.curveDrag.startValue, ce = L >= 0 ? `+${L}` : `${L}`, se = J >= 0 ? `+${J.toFixed(2)}` : `${J.toFixed(2)}`;
        A = `${e.curveDrag.group.length} keys · ΔF: ${ce} · ΔVal: ${se}`, G = `${e.curveDrag.channel.name}: ${q.toFixed(2)}`;
      } else {
        const L = e.curveDrag.key.frame - e.curveDrag.startFrame, q = e.curveDrag.channel.get(e.curveDrag.object ? e.curveDrag.key.transform : e.curveDrag.key.camera), J = q - e.curveDrag.startValue, ce = L >= 0 ? `+${L}` : `${L}`, se = J >= 0 ? `+${J.toFixed(2)}` : `${J.toFixed(2)}`;
        A = `F${e.curveDrag.key.frame} (${ce}) · ${e.curveDrag.channel.name}: ${q.toFixed(2)} (${se})`;
      }
    else if (e.curveHover)
      if (e.curveHover.channelName) {
        const L = Number.isFinite(e.curveHover.value) ? e.curveHover.value.toFixed(2) : "";
        A = `F${e.curveHover.frame} · ${e.curveHover.channelName}: ${L}`, e.curveHover.isHandle && (G = `Handle ${e.curveHover.handleSide}`);
      } else
        A = `Frame ${e.curveHover.frame}`;
    if (A) {
      n.save(), n.font = "11px system-ui, -apple-system, sans-serif";
      const L = n.measureText(A), q = G ? n.measureText(G) : { width: 0 }, J = Math.max(L.width, q.width) + 16, ce = G ? 32 : 20, se = a - m - J - 6, ae = f + 6;
      n.fillStyle = "rgba(18, 18, 24, 0.88)", n.strokeStyle = "#38384a", n.lineWidth = 1, n.beginPath(), n.roundRect ? n.roundRect(se, ae, J, ce, 4) : n.rect(se, ae, J, ce), n.fill(), n.stroke(), n.fillStyle = "#e2e8f0", n.fillText(A, se + 8, ae + (G ? 13 : 14)), G && (n.fillStyle = "#94a3b8", n.font = "9.5px system-ui, -apple-system, sans-serif", n.fillText(G, se + 8, ae + 26)), n.restore();
    }
  }
  for (const A of e.root.querySelectorAll("[data-tangent-mode]")) {
    const G = e.selectedKeyframe(), L = G?.tangents?.channels?.[l[0]?.id]?.mode || G?.tangents?.mode || "auto";
    A.classList.toggle("active", A.dataset.tangentMode === L);
  }
  for (const A of e.root.querySelectorAll("[data-channel-filter]"))
...
function Xr(e, { filter: t, label: a, color: o, title: r }) {
...
function is(e) {
  ...
  if (!t) return;
  const a = e.timelineObject(), o = a ? a.name || a.type : e.activeCameraTrack().name, r = rd(e), n = `${o}\0${r.map((c) => `${c.id}:${c.color}`).join("|")}`;
  if (t.dataset.signature !== n) {
    t.dataset.signature = n, t.replaceChildren();
    const c = document.createElement("span");
    c.className = "oc-graph-legend-title", c.textContent = o, t.appendChild(c), t.appendChild(Xr(e, {
      filter: "all",
      label: s("All"),
      color: null,
...
function Jr(e, t, a) {
  ...
  for (const n of [...e].sort((i, c) => i.frame - c.frame)) {
    ...
    (r === null || !(Math.abs(c - r) <= nd)) && o.push(n.frame), r = c;
  }
  return o;
}
function Er(e) {
  ...
  const a = e.timelineKeyframes() || [], o = !!e.timelineObject(), r = e.selectedKeyFrames || (e.selectedKeyFrame === null ? /* @__PURE__ */ new Set() : /* @__PURE__ */ new Set([e.selectedKeyFrame])), n = ct(e), i = [
    e.state.duration_frames,
    Number(e.timelineZoom) || 1,
    Number(e.timelinePan) || 0,
    ...n.map((c) => `${c.id}:${Jr(a, c, o).join(",")}`)
  ].join("\0");
...
const Zr = ["#4aa3ef", "#f2a93b", "#48c774", "#b565d8", "#ec4899"];
function cs(e, t) {
  const a = e.state.cameras.findIndex((r) => r.id === t), o = a >= 0 ? e.state.cameras[a] : null;
  return { camera: o, color: o?.color || Zr[Math.max(0, a) % Zr.length] };
}
function vt(e) {
...
function sd(e) {
  e.checkpoint("Auto-split shots"), e.state.sequence = {
    ...
    enabled: !0,
    cuts: si(e.state)
  }, vt(e), e.setStatus(s("Split into {count} shots").replace("{count}", String(e.state.sequence.cuts.length)));
}
function lo(e, t, a, { disabled: o = !1 } = {}) {
...
function id(e, t) {
  ...
  if (a.appendChild(lo(
    ...
    () => sd(e),
    { disabled: o }
  )), t.length && (a.appendChild(lo(
    s("Split at playhead"),
    s("Cut the current shot in two at the playhead"),
    () => {
      e.checkpoint("Split shot"), Fn(e.state, e.frame, null) ? vt(e) : e.setStatus(s("Move the playhead inside a shot first"));
    },
    { disabled: o }
  )), a.appendChild(lo(
    s("Clear edit"),
    ...
    () => {
      e.checkpoint("Clear edit"), e.state.sequence = { ...e.state.sequence, enabled: !1, cuts: [] }, vt(e), e.setStatus(s("Multi-camera edit cleared"));
    }
  ))), a.appendChild(lo(
...
function ld(e, t, a, o, r) {
  t.preventDefault(), t.stopPropagation();
  const { camera: n } = cs(e, a.camera_id);
  e.contextMenu?.show(t, n?.name || s("Shot"), [
    ...e.state.cameras.map((i) => ({
      ...
      run: () => {
        e.checkpoint("Change shot camera"), e.state.sequence.cuts[o].camera_id = i.id, vt(e);
      }
    })),
    null,
    {
      ...
      run: () => {
        e.checkpoint("Split shot"), Fn(e.state, e.frame, null) && vt(e);
      }
    },
    {
      label: s("Remove shot"),
      ...
      disabled: r === 1,
      run: () => {
        e.checkpoint("Remove shot"), ri(e.state, o) && vt(e);
      }
    }
  ]);
}
function dd(e, t, a, o) {
  const { camera: r, color: n } = cs(e, t.camera_id), i = document.createElement("div");
  ...
  if (c.className = "oc-sequence-name", c.textContent = r?.name || t.camera_id, i.appendChild(c), a > 0) {
    ...
    l.className = "oc-sequence-handle", l.title = s("Drag to trim the cut"), l.addEventListener("pointerdown", (p) => cd(e, p, l, o, a)), i.appendChild(l);
  }
  return i.addEventListener("contextmenu", (l) => ld(e, l, t, a, o.__cutCount)), i.addEventListener("pointerdown", () => {
...
function ds(e, t) {
  ...
  if (n.className = "oc-sequence-lane", n.dataset.role = "sequence-lane", n.setAttribute("aria-label", s("Multi-camera edit")), o.length)
    for (const [c, l] of o.entries()) {
      ...
      he(e, l.end + 1) < -5 || p > 105 || n.appendChild(dd(e, l, c, r));
    }
  else {
    const c = document.createElement("span");
  ...
  r.appendChild(n), r.appendChild(md(e));
  const i = document.createElement("span");
  i.className = "oc-sequence-playhead", i.style.left = `${he(e, e.frame)}%`, r.appendChild(i), t.appendChild(r);
}
const pd = ['[data-act="curve-zoom-in"]', '[data-act="curve-zoom-out"]', '[data-act="curve-fit"]', '[data-act="curve-handles"]'], Qr = { curves: "Graph", dope: "Timeline", sequence: "Sequence" };
function en(e, t) {
  ...
  a === "dope" ? Er(e) : a === "sequence" ? (ds(e, n), n?.focus?.({ preventScroll: !0 })) : e.drawCurveEditor(), e.setStatus(s(Qr[a]));
}
function fd(e) {
  ...
  a && a.addEventListener("keydown", (o) => {
    if (o.key === "ArrowLeft" || o.key === "ArrowRight") {
      ...
      if (n >= 0 && r.length > 1) {
        ...
        r[i].focus(), en(e, r[i].dataset.graphTab);
      }
    }
  }, { signal: t });
  for (const o of e.root.querySelectorAll("[data-graph-tab]"))
    o.addEventListener("click", (r) => {
      r.preventDefault(), r.stopPropagation(), en(e, o.dataset.graphTab);
    }, { signal: t });
}
const ud = /* @__PURE__ */ new Set(["good", "warning", "bad", "unknown"]);
function ms(e, t) {
  ...
  for (const n of r.frames) {
    ...
    const c = ud.has(n?.state) ? n.state : "unknown", l = n?.score;
    let p = null;
    if (l != null) {
      const m = Number(l);
...
function gd(e) {
  ...
  if (!t || !a) return;
  const o = ms(e.state?.metadata, e.state?.duration_frames), r = o.some((c) => c.state !== "unknown");
  ...
  if (tn.has(a)) return;
  tn.add(a), a.addEventListener("pointerdown", (c) => {
...
function yd(e) {
  ...
  if (e.audioWaveformPeaks && e.audioWaveformPeaks.length) {
    ...
    const S = x.getContext("2d"), g = e.audioWaveformPeaks, _ = x.width, $ = x.height, F = $ / 2;
    S.fillStyle = "#f2d06b";
    for (let z = 0; z < g.length; z++) {
      const W = (z / (g.length - 1) * r - l) / Math.max(1e-6, c) * _;
      if (W >= -5 && W <= _ + 5) {
        const V = g[z] * ($ * 0.85);
        S.fillRect(W, F - V / 2, Math.max(1, _ / g.length * n - 0.5), V);
      }
    }
    t.appendChild(x);
  }
  ...
  for (const x of o) {
    ...
    _.className = "key-label", _.textContent = String(x.frame), g.appendChild(_), g.addEventListener("pointerdown", ($) => {
      if ($.preventDefault(), $.stopPropagation(), g.focus({ preventScroll: !0 }), $.altKey) {
        e.checkpoint("Duplicate keyframe");
        const z = a ? { frame: x.frame, transform: tt(x.transform), interpolation: x.interpolation } : { frame: x.frame, camera: pe(x.camera), interpolation: x.interpolation }, X = e.timelineKeyframes();
        X.push(z), X.sort((W, V) => W.frame - V.frame), e.selectedKeyFrame = z.frame, e.selectedKeyFrames = /* @__PURE__ */ new Set([z.frame]), e.keyDrag = { key: z, box: t, isDuplicate: !0, historyCheckpointed: !0, moving: [{ key: z, startFrame: z.frame }], startPointerFrame: x.frame, startClientX: $.clientX, startClientY: $.clientY }, e.setFrame(z.frame, !1, !1), e.setStatus(s(`Duplicating key from ${x.frame}...`));
        return;
      }
      if ($.shiftKey) {
      ...
      const F = e.timelineKeyframes().filter((z) => e.selectedKeyFrames.has(z.frame));
      e.keyDrag = { key: x, box: t, historyCheckpointed: !1, moving: F.map((z) => ({ key: z, startFrame: z.frame })), startPointerFrame: x.frame, startClientX: $.clientX, startClientY: $.clientY }, e.setFrame(x.frame, !1, !1);
    }), g.addEventListener("click", ($) => {
      $.preventDefault(), $.stopPropagation(), !$.shiftKey && ($.shiftKey || (e.selectedKeyFrames = /* @__PURE__ */ new Set([x.frame])), e.selectKeyframe(x));
    }), t.appendChild(g);
  }
  ...
  y && (y.textContent = m.name), ns(e), ts(e), is(e), Er(e), fd(e), e.refreshCameraSelectors(), e.refreshKeyEditor(), e.updateEditState(), e.drawCurveEditor(), e.perf && (e.perf.timelineRefreshCount = (e.perf.timelineRefreshCount || 0) + 1), gd(e);
}
class ps {
...
async function Ar(e, { route: t, field: a = "file", file: o }) {
    ...
    <div class="oc-left-body oc-assets" data-role="agent-tab" hidden>
      <div class="oc-asset-panel" data-role="agent-panel">
        ...
        <textarea class="oc-search oc-agent-describe" data-role="agent-describe" rows="2"
                  placeholder="${s("Describe the shot...")}" aria-label="${s("Describe the shot")}"></textarea>
...
function Rd() {
  const e = Vc.map((t) => `<button data-lens="${t}">${t}mm</button>`).join("");
  return `
  ...
  return `
    <div class="oc-dope">
      <div class="oc-dope-body">
        <div class="oc-dope-labels">${es.map((t) => `
...
const Je = 1, an = 50, Te = 120, mt = 160, nm = Object.freeze(["perspective", "orthographic"]), K = Object.freeze({
...
}), us = Object.freeze(Object.values(K)), we = Object.freeze({
  SCENE_GET: "scene.get",
...
}), sm = Object.freeze(Object.values(we));
...
const im = 25, on = 100;
function pt(e, t) {
  const a = e?.offset === void 0 ? 0 : Number(e.offset), o = e?.limit === void 0 ? im : Number(e.limit);
  if (!Number.isInteger(a) || a < 0)
    throw new I(
      "BAD_QUERY",
      "offset must be a non-negative integer"
    );
  if (!Number.isInteger(o) || o < 1 || o > on)
    throw new I(
      "BAD_QUERY",
      `limit must be between 1 and ${on}`
    );
  return {
    offset: a,
    limit: o,
...
function dm(e, t) {
  ...
  switch (t?.type) {
    ...
    case we.CAMERA_GET: {
      ...
      return ke(e, { version: 1, type: t.type, camera: He(r) });
    }
    case we.CAMERA_LIST: {
      const o = a.cameras || [], { offset: r, limit: n, end: i } = pt(t, o.length);
      return ke(e, {
        version: 1,
        type: t.type,
        items: o.slice(r, i).map(cm),
        total: o.length,
        offset: r,
        limit: n
      });
    ...
    case we.HEALTH_GET:
      return ke(e, {
        version: 1,
        type: t.type,
        frames: ms(a.metadata, a.duration_frames)
      });
    case we.ASSET_LIST: {
      ...
      return ke(e, { version: 1, type: t.type, items: He(r), total: r.length });
    }
    case we.ASSET_GET: {
    ...
    case we.OBJECT_LIST: {
      const o = a.objects || [], { offset: r, limit: n, end: i } = pt(t, o.length);
      return ke(e, {
        version: 1,
        type: t.type,
    ...
    case we.OBJECT_SEARCH: {
      ...
      }, p = (a.objects || []).filter(l), { offset: m, limit: f, end: d } = pt(t, p.length);
      return ke(e, {
        version: 1,
        type: t.type,
    ...
    case we.CHARACTER_LIST: {
      const o = (a.objects || []).filter((c) => c.asset_kind === "character"), { offset: r, limit: n, end: i } = pt(t, o.length);
      return ke(e, {
        version: 1,
        type: t.type,
    ...
    case we.SHOT_LIST: {
      ...
      })), { offset: i, limit: c, end: l } = pt(t, n.length);
      return ke(e, {
        version: 1,
        type: t.type,
        items: n.slice(i, l),
    ...
    case we.KEYFRAME_LIST: {
      ...
      if (!r) throw new I("UNKNOWN_CAMERA", `Unknown camera: ${o}`);
      const n = r.keyframes || [], { offset: i, limit: c, end: l } = pt(t, n.length);
      return ke(e, {
        version: 1,
        type: t.type,
        cameraId: r.id,
...
function pm(e, t) {
  e.cameras ||= [];
  const a = new Set(e.cameras.map((i) => i.id)), o = Po(a, "camera", t.id), r = { ...yr(), ...t.camera || {} }, n = {
    id: o,
    name: t.name || o,
    color: "#4aa3ef",
    locked: !1,
    ...
    solo: !1,
    camera: r,
    keyframes: [{ frame: 0, camera: pe(r), interpolation: t.interpolation || "ease" }]
  };
...
function gm(e, t) {
  if (!bs.has(t.objectType))
    throw new I("UNSUPPORTED_OBJECT_TYPE", `object.create does not support type: ${t.objectType}`);
  e.objects ||= [];
  const a = new Set(e.objects.map((i) => i.id)), o = Po(a, t.objectType, t.id), r = mm(t.objectType), n = {
    id: o,
    type: t.objectType,
    name: t.name || o,
    ...r,
...
function Cm(e, t) {
  ...
  for (a.has(t) && a.delete(t), a.add(t); a.size > _m; )
    a.delete(a.values().next().value);
}
function Em(e, t) {
  return !!e._directorApiTxIds?.has(t);
}
const st = (e) => typeof e == "number" && Number.isFinite(e);
function Ee(e, t, a) {
  if (!Array.isArray(e) || e.length !== 3 || !e.every(st))
...
function $m(e, t) {
  ...
  if (e.position !== void 0 && Ee(e.position, "camera.position", t), e.target !== void 0 && Ee(e.target, "camera.target", t), e.up !== void 0 && Ee(e.up, "camera.up", t), e.fov !== void 0 && (Lt(e.fov, "camera.fov", t), e.fov < 1 || e.fov > 179))
  ...
  if (e.camera_type !== void 0 && !nm.includes(e.camera_type))
...
function Tm(e, t) {
  ...
  switch (a) {
    ...
    case K.CAMERA_CREATE:
      if (e.id !== void 0 && ee(e.id, "id", t, Te), e.name !== void 0 && ee(e.name, "name", t, mt), e.camera !== void 0) {
    ...
    case K.CAMERA_DUPLICATE:
      ee(e.cameraId, "cameraId", t, Te), e.id !== void 0 && ee(e.id, "id", t, Te), e.name !== void 0 && ee(e.name, "name", t, mt);
      break;
    case K.CAMERA_DELETE:
    case K.CAMERA_SET_PLAYBLAST:
      ee(e.cameraId, "cameraId", t, Te);
      break;
    case K.CAMERA_RENAME:
      ee(e.cameraId, "cameraId", t, Te), ee(e.name, "name", t, mt);
      break;
    case K.OBJECT_CREATE:
      if (ee(e.objectType, "objectType", t), !bs.has(e.objectType))
      ...
      e.id !== void 0 && ee(e.id, "id", t, Te), e.name !== void 0 && ee(e.name, "name", t, mt), e.position !== void 0 && Ee(e.position, "position", t), e.rotation !== void 0 && Ee(e.rotation, "rotation", t);
      break;
    case K.OBJECT_DUPLICATE:
      ee(e.objectId, "objectId", t, Te), e.id !== void 0 && ee(e.id, "id", t, Te), e.name !== void 0 && ee(e.name, "name", t, mt), e.offset !== void 0 && Ee(e.offset, "offset", t);
      break;
    case K.OBJECT_DELETE:
      ee(e.objectId, "objectId", t, Te);
      break;
    case K.OBJECT_RENAME:
      ee(e.objectId, "objectId", t, Te), ee(e.name, "name", t, mt);
      break;
    case K.OBJECT_SET_PARENT:
      ee(e.objectId, "objectId", t, Te), e.parentId !== null && e.parentId !== void 0 && ee(e.parentId, "parentId", t, Te);
      break;
    case K.CAMERA_TRANSFORM:
      if (e.cameraId !== void 0 && ee(e.cameraId, "cameraId", t), e.position !== void 0 && Ee(e.position, "position", t), e.target !== void 0 && Ee(e.target, "target", t), e.frame !== void 0 && Re(e.frame, "frame", t), e.position === void 0 && e.target === void 0)
    ...
    case K.CHARACTER_SET_JOINT_ROTATION:
      if (ee(e.objectId, "objectId", t), ee(e.joint, "joint", t), !Array.isArray(e.rotation) || e.rotation.length !== 4 || !e.rotation.every(st))
    ...
    case K.CHARACTER_SET_MOTION: {
      ...
      for (const r of ["start_frame", "end_frame", "speed", "offset_seconds"])
        if (o[r] !== void 0 && !st(o[r]))
          throw new I("BAD_VALUE", `motion.${r} must be a finite number`, t);
      if (st(o.start_frame) && st(o.end_frame) && o.end_frame > 0 && o.end_frame <= o.start_frame)
    ...
    case K.KEYFRAME_UPSERT:
      if (e.cameraId !== void 0 && ee(e.cameraId, "cameraId", t), Re(e.frame, "frame", t), e.interpolation !== void 0 && !xo.includes(e.interpolation))
        throw new I("BAD_INTERPOLATION", `Unsupported interpolation: ${e.interpolation}`, t);
      if (e.camera !== void 0) {
        ...
        for (const o of ["fov", "roll", "zoom", "near", "far"])
          if (e.camera[o] !== void 0 && !st(e.camera[o]))
            throw new I("BAD_VALUE", `camera.${o} must be finite`, t);
      }
      break;
    case K.KEYFRAME_REMOVE:
      e.cameraId !== void 0 && ee(e.cameraId, "cameraId", t), Re(e.frame, "frame", t);
      break;
    case K.KEYFRAME_SET_INTERPOLATION:
      if (e.cameraId !== void 0 && ee(e.cameraId, "cameraId", t), Re(e.frame, "frame", t), !xo.includes(e.interpolation))
        throw new I("BAD_INTERPOLATION", `Unsupported interpolation: ${e.interpolation}`, t);
      break;
    case K.TIMELINE_SET_RANGE:
      if (Re(e.start, "start", t), Re(e.end, "end", t), e.end < e.start)
    ...
    case K.TIMELINE_SET_DURATION:
      ...
      break;
    case K.CUT_UPSERT:
      Re(e.start, "start", t), ee(e.cameraId, "cameraId", t);
      break;
    case K.CUT_REMOVE:
      Re(e.start, "start", t);
      break;
...
function Mm(e, t) {
  ...
  if (t.operations.length > an)
    throw new I(
      "TOO_MANY_OPERATIONS",
      `transaction has ${t.operations.length} operations (max ${an})`
    );
  return t.operations.forEach((a, o) => Tm(a, o)), {
    version: Je,
    id: t.id,
...
const Om = "omnicam/library", Pm = "majoor_omnicam/blockout_library", Lm = Object.freeze({
...
function gs(e) {
  return e.file ? `${e.source === "legacy" ? Pm : Om}/${e.file} [input]` : "";
}
function rn(e, t, a) {
  const o = e || "asset";
  let r = `${o}_${a}`, n = 2;
...
function Fm(e, t = {}) {
  ...
  const a = zm(t.point, [0, 0, 0]), o = String(t.idSeed || Date.now().toString(36)), r = String(e.kind || "prop"), n = r === "character", i = Lm[e.id];
  if (r === "helper" && !e.file && i && i !== "null")
    return {
      id: rn(i, t.existingIds, o),
      type: i,
      name: e.name || i,
      position: a,
      rotation: [0, 0, 0],
  ...
  const c = {
    id: rn(r === "character" ? "character" : r, t.existingIds, o),
    type: "glb",
  ...
  return n && (c.character = Nm(e)), c;
}
function Rm({ groundHit: e, orbitTarget: t } = {}) {
...
const Km = {
  [K.ASSET_INSTANTIATE](e, t) {
    ...
    let o;
    try {
      o = Fm(t.asset, { point: t.point, idSeed: t.id, existingIds: a });
    } catch (r) {
  ...
  [K.CAMERA_SET_ACTIVE](e, t) {
    return or(e, t.cameraId), e.active_camera_id = t.cameraId, { dirtyMask: C.viewport | C.previews | C.inspector | C.outliner | C.timeline };
  },
  [K.CAMERA_SET_LOCKED](e, t) {
    return or(e, t.cameraId).locked = t.value, { dirtyMask: C.outliner | C.inspector | C.viewport };
  },
  [K.CAMERA_CREATE](e, t) {
    const a = pm(e, t);
  ...
  [K.CAMERA_LOOK_AT](e, t) {
    const a = ht(e, t.cameraId);
    if (t.objectId !== void 0 && (t.objectId === null || t.objectId === "" ? (a.target_object_id = null, a.id === e.active_camera_id && (e.target_object_id = null)) : (rr(e, t.objectId), a.target_object_id = t.objectId, a.id === e.active_camera_id && (e.target_object_id = t.objectId))), t.point) {
      const o = nn(a);
      o.target = [...t.point];
  ...
  [K.OBJECT_SET_ENABLED](e, t) {
    return nt(e, t.objectId).enabled = t.value, { dirtyMask: C.viewport | C.previews | C.outliner | C.inspector };
  },
  [K.OBJECT_SET_LOCKED](e, t) {
    return rr(e, t.objectId).locked = t.value, { dirtyMask: C.outliner | C.inspector };
  },
  [K.OBJECT_SET_TAGS](e, t) {
    const a = nt(e, t.objectId), o = di(t.tags), r = o.length !== t.tags.length ? "some tags were dropped or normalised" : void 0;
    return o.length ? a.tags = o : delete a.tags, { dirtyMask: C.outliner | C.inspector | C.viewport, warning: r };
  },
  [K.OBJECT_SET_ANNOTATION](e, t) {
    const a = nt(e, t.objectId), o = t.annotation === null ? null : Rn(t.annotation);
    if (t.annotation && !o)
  ...
  [K.CHARACTER_SET_JOINT_ROTATION](e, t) {
    ...
    return a.character = {
      ...a.character || {},
      pose: li(a.character?.pose, t.joint, t.rotation)
    }, { dirtyMask: C.viewport | C.previews | C.inspector };
  },
  [K.CHARACTER_SET_MOTION](e, t) {
    const a = mo(e, t.objectId), o = vr(t.motion);
  ...
  [K.KEYFRAME_UPSERT](e, t) {
    ...
    let o = po(a, t.frame);
    if (!o) {
      const r = po(a, 0)?.camera || a.camera || {};
  ...
  [K.KEYFRAME_REMOVE](e, t) {
    const a = ht(e, t.cameraId), o = (a.keyframes || []).length;
  ...
  [K.KEYFRAME_SET_INTERPOLATION](e, t) {
    const a = ht(e, t.cameraId), o = po(a, t.frame);
...
function Dm({ state: e, operation: t }) {
  const a = Km[t.type];
...
function nr(e, t) {
  ...
  if (Array.isArray(e) || Array.isArray(t))
    return !Array.isArray(e) || !Array.isArray(t) || e.length !== t.length ? !1 : e.every((a, o) => nr(a, t[o]));
  if (e && t && typeof e == "object") {
    const a = /* @__PURE__ */ new Set([...Object.keys(e), ...Object.keys(t)]);
    for (const o of a) if (!nr(e[o], t[o])) return !1;
    return !0;
  }
  return !1;
}
...
function qm(e, t) {
  ...
  return Wm(e, t, r), Hm(e, t, r), Ym(e, t, r), Gm(e, t, r), Xm(e, t, r), Jm(e, t, r), { changes: a, truncated: o };
}
const Um = ["fov", "roll", "zoom", "near", "far", "camera_type"];
function Wm(e, t, a) {
  const o = Ze(e?.cameras), r = Ze(t?.cameras);
...
const Vm = ["position", "target", "fov", "roll", "zoom", "near", "far", "camera_type"];
function Hm(e, t, a) {
  const o = Ze(e?.cameras), r = Ze(t?.cameras);
  for (const [n, i] of r) {
...
function Gm(e, t, a) {
  const o = Ze(e?.objects), r = Ze(t?.objects);
  for (const [n, i] of r) {
...
function Qm(e) {
  ...
  return t ? (e.state.keyframes = t.keyframes, e.state.camera = pe(t.camera), e.camera = pe(t.camera), t) : null;
}
function ep(e, t) {
  t && (e.camera = $e(
    t,
...
function op(e, t) {
  ...
  for (let p = 0; p < a.operations.length; p += 1)
    try {
      const m = Dm({ ui: e, state: r, operation: a.operations[p] });
  ...
  if (a.validateOnly) {
    const { changes: p, truncated: m } = qm(e.state, r);
    return {
      ok: !0,
      version: Je,
      revision: o,
  ...
  e.checkpoint?.(a.description), e.state = xr(r);
  const l = Qm(e);
  return Cm(e, a.id), e.serialize?.(), ep(e, l), ap(e, n, `director-api:${a.id}`), tp(e, a, c).catch((p) => {
...
function np(e) {
  return e.directorApi = rp(e), e.directorApi;
}
const sn = "omnicam-agent/1", cn = "majoor.omnicam.agent.request", sp = 1, zt = Object.freeze({
...
}), ip = 1e4, cp = 5e3, ys = "asset.instantiate_by_id", vs = "asset.catalog_search", ln = Object.freeze([
  ...us.filter((e) => e !== K.ASSET_INSTANTIATE),
  ys
]);
function ir(e) {
...
async function mp(e, t) {
  ...
  const o = (a.state?.items || []).filter((r) => !ir(r)).slice(0, 20).map((r) => ({
    id: r.id,
    name: r.name,
    kind: r.kind,
    tags: [...r.tags || []],
...
function pp(e, t, a) {
  ...
  async function d() {
    ...
    try {
      const _ = await Nt(a, zt.register, {
        protocol: sn,
        client_id: g,
        node_id: String(t.id),
  ...
  async function v(S) {
    const g = S?.detail;
    if (o || !g || g.protocol !== sn || Number(g.schema_version) !== sp || g.session_id !== r || String(g.node_id) !== String(t.id)) return;
    let _;
    try {
      if (g.kind === "query")
        _ = g.payload?.type === vs ? await mp(e, g.payload) : e.directorApi.query(g.payload);
      else if (g.kind === "transaction") {
        const $ = g.payload, F = ($?.operations || []).find(
          (z) => !ln.includes(z?.type)
        );
        if (!Number.isInteger($?.baseRevision) || $.baseRevision < 0)
          ...
          _ = Ft(
            ...
            `External Agent transactions cannot use operation: ${F?.type}`
          );
        else {
          const z = await dp(e, $.operations);
          _ = z.ok ? e.directorApi.execute({ ...$, operations: z.operations }) : Ft(e, z.code, z.message);
        }
      } else
        _ = Ft(e, "UNKNOWN_AGENT_REQUEST", `Unsupported Agent request kind: ${g.kind}`);
    } catch ($) {
      _ = Ft(e, $?.code || "INTERNAL", $?.message || "OmniCam Agent request failed");
    }
    try {
      await Nt(a, zt.reply, {
        session_id: r,
  ...
  return a.addEventListener?.(cn, v), a.addEventListener?.("status", x), d(), {
    get sessionId() {
      return r;
    },
    dispose() {
      if (o) return;
      o = !0, clearInterval(c), clearTimeout(l), a.removeEventListener?.(cn, v), a.removeEventListener?.("status", x);
      const S = r, g = n;
      r = null, n = null, S && g && Nt(a, zt.close, {
        session_id: S,
        session_token: g
      }).catch(() => {
      });
...
const Pe = "/majoor/omnicam/library";
function fp(e, t) {
...
function $r({ fetchApi: e = fp } = {}) {
  ...
  return {
    list(a = {}) {
      ...
      return o && o !== "all" && (l.kind = o), t(`${Pe}${dn(l)}`);
    },
    get(a) {
      return t(`${Pe}/${encodeURIComponent(a)}`);
    },
    register(a) {
      return t(`${Pe}/register`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(a)
      });
    ...
    remove(a) {
      return t(`${Pe}/${encodeURIComponent(a)}`, { method: "DELETE" });
    },
    importModel(a, o = {}) {
      const r = new FormData();
      return r.append("file", a, o.filename || a.name || "model.glb"), t(`${Pe}/import${dn(o)}`, { method: "POST", body: r });
    },
    importLocalCharacters({ folder: a, licenseNote: o = "", idPrefix: r = "", dryRun: n = !1 } = {}) {
      return t(`${Pe}/import-local`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          folder: a,
    ...
    uploadThumbnail(a, o, r = "thumb.webp") {
      ...
      return n.append("file", o, r), t(`${Pe}/thumbnail/${encodeURIComponent(a)}`, {
        method: "POST",
        body: n
      });
    },
    ...
    deletePose(a) {
      return t(`${Pe}/poses/${encodeURIComponent(a)}`, { method: "DELETE" });
    }
  };
}
const xs = Object.freeze(["all", "character", "prop", "environment", "vehicle"]);
function mn(e = {}) {
  const t = String(e.kind || "all").toLowerCase();
  return {
    kind: xs.includes(t) ? t : "all",
...
function bp(e) {
  ...
  return {
    ...
    setFilter(i) {
      return a.filter = mn({ ...a.filter, ...i }), a.offset = 0, this.refresh();
    },
    refresh() {
      return n(async () => {
...
const vp = 256;
function pn(e = {}) {
  const { THREE: t, GLTFLoader: a, FBXLoader: o, size: r = vp } = e;
  if (!t || !a)
...
function jp(e, t = {}) {
  return xs.map((a) => {
    const o = s(Sp[a] || a), r = a === "all" ? "" : ` <span class="oc-asset-kind-n">${Number(t[a] || 0)}</span>`;
    return `<button type="button" class="oc-asset-kind${a === (e || "all") ? " active" : ""}" data-asset-kind="${a}">${yt(o)}${r}</button>`;
  }).join("");
}
function _p(e, { selected: t = !1, thumbUrl: a = "" } = {}) {
  const o = kp[e.kind] || "pi-box", r = e.kind === "character" && Kn(e.rig) === "rigged" ? `<span class="oc-asset-badge">${s("RIGGED")}</span>` : "", n = a ? `<img class="oc-asset-thumb" src="${yt(a)}" alt="" loading="lazy">` : `<span class="oc-asset-thumb oc-asset-thumb--glyph"><i class="pi ${o}"></i></span>`;
  return `<button type="button" class="oc-asset-card${t ? " selected" : ""}" data-asset-id="${yt(e.id)}" title="${yt(e.name)}">
    ${n}
    <span class="oc-asset-name">${yt(e.name)}</span>
    <span class="oc-asset-kind-tag">${yt((e.kind || "").toUpperCase())}</span>
    ${r}
  </button>`;
}
function Cp(e, { selectedId: t = "", thumbUrls: a = {} } = {}) {
  return !e || !e.length ? `<p class="oc-asset-empty">${s("No assets match this filter.")}</p>` : e.map((o) => _p(o, {
    selected: o.id === t,
    thumbUrl: a[o.id] || ""
  })).join("");
}
...
function Ep(e, t = {}) {
  const a = e.root, o = t.fetchApi || ((O, D) => (e.api || e.app?.api).fetchApi(O, D)), r = t.apiClient || $r({ fetchApi: o }), n = t.store || bp(r), i = gp(), c = t.previewQueue || yp(), l = e.api || e.app?.api || null;
  let p = t.thumbnailRenderer || null, m = null;
  const f = /* @__PURE__ */ new Set();
  function d() {
    return p ? Promise.resolve(p) : (m || (m = xp().then((O) => p = pn(O)).catch(() => p = pn({}))), m);
  }
  function h(O) {
    return Br(l, gs(O));
  }
  function u(O) {
    return O.thumbnail ? Br(l, `omnicam/library/${O.thumbnail} [input]`) : "";
  }
  function b() {
    for (const O of n.state.items) {
      if (O.kind === "helper" || !O.file || i.get(O.id) || O.thumbnail || f.has(O.id)) continue;
      const D = h(O);
      D && c.enqueue(O.id, async () => {
        const Se = await (await d()).render(D, O.format || "glb");
        if (!Se) {
          f.add(O.id);
          return;
        }
        if (i.set(O.id, Se), q(), !(O.source && O.source !== "user"))
          try {
            const Ie = await r.uploadThumbnail(O.id, wp(Se));
            Ie?.asset && n.upsert(Ie.asset);
          } catch {
          }
      });
    }
  }
  const v = (O) => a.querySelector(`[data-role="${O}"]`), y = v("assets-panel"), x = v("asset-grid"), S = v("asset-kinds"), g = v("asset-search"), _ = v("asset-status"), $ = v("asset-import-file"), F = v("scene-tab"), z = v("assets-tab"), X = v("agent-tab"), W = a.querySelector('[data-asset-view="agent"]'), V = { assets: z, agent: X };
  let re = "", j = null, N = !0, U = !0, H = "scene", te = 0;
  function A(O, { sticky: D = !1 } = {}) {
    _ && (!D && te > Date.now() || (_.textContent = O || "", te = D ? Date.now() + 9e3 : 0));
  }
  function G(O) {
    if (re = O, !!x)
      for (const D of x.querySelectorAll(".oc-asset-card"))
        D.classList.toggle("selected", D.dataset.assetId === O);
  }
  let L = !1;
  function q() {
    if (S && (S.innerHTML = jp(n.state.filter.kind, n.state.kinds)), x) {
      const O = {};
      for (const D of n.state.items) {
        const de = i.get(D.id) || u(D);
        de && (O[D.id] = de);
      }
      x.innerHTML = Cp(n.state.items, { selectedId: re, thumbUrls: O });
    }
    if (!L) {
      L = !0;
      try {
  ...
  function J(O) {
    ...
    }), de = e.directorApi?.execute({
      version: 1,
      id: `tx_instantiate_${Date.now().toString(36)}`,
      description: s("Add asset"),
      operations: [{ type: "asset.instantiate", asset: O, point: D }]
    });
    if (!de?.ok) {
      e.setStatus?.(de?.error?.message || s("Could not add the asset"));
      return;
    }
    const Se = de.outcomes?.[0]?.objectId;
    Se && (e.selectedEntity = "object", e.selectedObjectId = Se, e.selectedObjectIds = /* @__PURE__ */ new Set([Se]), e.selectedKeyFrame = null), e.restoreAssets?.(), e.refreshObjects?.(), e.refreshInspector?.(), e.render?.(), e.setStatus?.(s("{name} added").replace("{name}", O.name));
  }
  async function ce(O) {
    if (O) {
      A(s("Importing {name}...").replace("{name}", O.name));
      try {
        const D = await r.importModel(O, { kind: "prop", name: O.name.replace(/\.[^.]+$/, "") });
        D.asset && n.upsert(D.asset), A(s("Imported {name}").replace("{name}", D.asset?.name || O.name));
      } catch (D) {
        A(D.message || s("Import failed"));
      }
    }
  }
  const se = v("asset-local-form"), ae = v("asset-local-folder"), le = v("asset-local-note");
  function be() {
  ...
  async function fe(O) {
    ...
    te = 0, A(O ? s("Scanning {folder}...").replace("{folder}", D) : s("Installing characters from {folder}...").replace("{folder}", D));
    try {
      const de = await r.importLocalCharacters({
        folder: D,
        licenseNote: (le?.value || "").trim(),
        dryRun: O
      }), Se = (de.skipped || []).length;
      if (O) {
        const Oe = (de.candidates || []).map((at) => at.name).join(", ");
        A(
          (de.candidates || []).length ? s("{n} rig-complete character(s): {names}").replace("{n}", de.candidates.length).replace("{names}", Oe) : s("No rig-complete .glb/.fbx character found ({n} skipped)").replace("{n}", Se),
          { sticky: !0 }
        );
        return;
      }
      const Ie = (de.installed || []).filter((Oe) => Oe.status !== "conflict").length, Ne = (de.installed || []).filter((Oe) => Oe.status === "conflict").length;
      A(
        s("{n} character(s) installed{extra} — no restart needed").replace("{n}", Ie).replace("{extra}", Se || Ne ? ` (${Se} ${s("skipped")}${Ne ? `, ${Ne} ${s("unchanged")}` : ""})` : ""),
        { sticky: !0 }
      ), Ie && (n.refresh(), se && (se.hidden = !0));
    } catch (de) {
      A(de.message || s("Import failed"), { sticky: !0 });
    }
  }
  function ge(O) {
    O === "agent" && !Zo() && (O = "scene"), H = O, F && (F.hidden = O !== "scene");
    for (const [D, de] of Object.entries(V))
      de && (de.hidden = D !== O);
    for (const D of a.querySelectorAll("[data-asset-view]"))
      D.classList.toggle("active", D.dataset.assetView === O);
    O === "assets" && N && (N = !1, n.refresh()), O === "agent" && U && (U = !1, t.onAgentFirstOpen?.());
  }
  function ye() {
    const O = Zo();
    W && (W.hidden = !O), !O && H === "agent" && ge("scene");
  }
  function me(O) {
    const D = fn(O.target);
    if (D) {
      if (D.action === "switch-view") return ge(D.view);
      if (D.action === "filter-kind") return void n.setFilter({ kind: D.kind });
      if (D.action === "asset-add")
        return J(n.get(re));
      if (D.action === "asset-import")
        return $?.click();
      if (D.action === "local-toggle") return be();
      if (D.action === "local-scan") return void fe(!0);
      if (D.action === "local-install") return void fe(!1);
      D.action === "card" && G(D.assetId);
    }
  }
  function Ae(O) {
    const D = fn(O.target);
    D?.action === "card" && J(n.get(D.assetId));
  }
  function ve() {
  ...
  const ue = n.subscribe(q);
  return y?.addEventListener("click", me), y?.addEventListener("dblclick", Ae), a.querySelector('[data-role="left-tabs"]')?.addEventListener("click", me), g?.addEventListener("input", ve), $?.addEventListener("change", xe), q(), ye(), {
    store: n,
    switchView: ge,
    syncAgentAvailability: ye,
    refresh: () => n.refresh(),
    dispose() {
      ue(), clearTimeout(j), y?.removeEventListener("click", me), y?.removeEventListener("dblclick", Ae), a.querySelector('[data-role="left-tabs"]')?.removeEventListener("click", me), g?.removeEventListener("input", ve), $?.removeEventListener("change", xe), c.clear(), p?.dispose?.(), i.clear();
    }
  };
}
function Ap(e, t = {}) {
  ...
  const r = [];
  let n = Qo(e.state?.metadata?.viewport_labels);
  function i(m) {
    if (!r[m]) {
  ...
  function l() {
    ...
    let b = 0;
    for (const v of u) {
      if (!Dn(v, { mode: n.mode, selectedIds: d })) continue;
      const y = Bn(v, n.content);
      if (!y) continue;
      const x = qn(u, v, h) || {
        position: v.position,
        size: v.size
      }, S = e.webgl.projectWorldToScreen(Un(x, v.type));
  ...
  function p(m) {
    n = Qo({ ...n, ...m }), e.state.metadata = { ...e.state.metadata || {}, viewport_labels: { ...n } }, e.serialize?.(), l();
  }
  return l(), {
    update: l,
    get settings() {
...
function $p(e) {
  ...
  return {
    ...
    getRigInfo(a) {
      const o = e.state?.objects?.find((i) => i.id === a) || null, r = t(a), n = er(r);
      return {
        objectId: a,
...
function Tp(e, t) {
  const a = (o) => [`<option value="">${s("— unmapped —")}</option>`].concat(
    e.map(
      (r) => `<option value="${hn(r)}"${r === o ? " selected" : ""}>${hn(r)}</option>`
    )
  ).join("");
  return Wn.map((o) => {
...
function Mp(e, t = {}) {
  const a = e.root, o = t.apiClient || $r({
  ...
  function b(y) {
    ...
    x === "auto" ? (l = er(m()), d()) : x === "validate" ? (d(), e.setStatus?.(Do(l) ? s("Rig is complete") : s("Rig still missing: {list}").replace("{list}", qr(l).join(", ")))) : x === "save" && v();
  }
  async function v() {
    const y = p();
    if (!y?.asset_id) {
    ...
    try {
      const x = await o.patch(y.asset_id, {
        rig: { profile: Ur, bone_map: l }
      });
      y.character = {
        ...y.character || {},
        rig_profile: Do(l) ? Ur : null
...
function Pp(e, t = {}) {
  const a = e.root, o = t.apiClient || $r({
    fetchApi: (j, N) => (e.api || e.app?.api).fetchApi(j, N)
  ...
  function v(j) {
    const N = jo({ ...j, preset_id: j.id });
    return { id: j.id, name: j.name || j.id, root_offset: N.root_offset, joints: N.joints };
  }
  function y(j) {
    const N = d.get(j?.pose?.preset_id) || null;
    return pi({ preset: N, overrides: j?.pose }).joints;
  }
  function x() {
    const j = h();
  ...
  function S() {
    const j = b(), N = f && !!j;
    if (c && (c.hidden = !N), !N) return;
    l && (l.textContent = j);
    const U = h(), H = y(U?.character)[j] || [0, 0, 0, 1], te = fi(H);
    p.forEach((A, G) => {
      A && document.activeElement !== A && (A.value = String(Math.round(te[G] * 100) / 100));
    });
  }
  function g() {
    const j = h(), N = !!j?.character?.motion;
    if (i && (i.classList.toggle("active", f), i.disabled = N, i.title = N ? s("Clear the motion clip to edit the pose") : s("Toggle FK pose editing")), n) {
      const U = [["neutral", s("Standing Neutral")]].concat([...d.values()].filter((te) => te.id !== "neutral").map((te) => [te.id, te.name || te.id])), H = U.map((te) => te.join(":")).join("|");
      n.dataset.sig !== H && (n.dataset.sig = H, n.replaceChildren(...U.map(([te, A]) => {
        const G = document.createElement("option");
        return G.value = te, G.textContent = A, G;
  ...
  async function _() {
    try {
      ...
      d = new Map((j.poses || []).filter((N) => N?.id).map((N) => [N.id, v(N)]));
    } catch {
      d = /* @__PURE__ */ new Map();
    }
  ...
  function $() {
    const j = b();
    if (!j) return;
    const N = p.map((te) => Number(te?.value) || 0), U = mi(N), H = e.directorApi?.execute({
      version: 1,
    ...
    H && !H.ok && e.setStatus?.(H.error?.message || s("Could not set the joint")), g();
  }
  function F() {
    const j = n?.value || "neutral", N = d.get(j) || jo({ preset_id: j });
    e.directorApi?.execute({
      version: 1,
      id: `tx_preset_${Date.now().toString(36)}`,
      description: "Pose preset",
      operations: [{ type: "character.set_pose", objectId: m, pose: { preset_id: j, root_offset: N.root_offset, joints: {} } }]
    }), g();
  }
  async function z() {
    const j = h();
    if (!j?.character) return;
    const N = (await Vt(e, s("Save Pose"), s("Pose name"), ""))?.trim();
    if (!N || e.disposed) return;
    const U = N.toLowerCase().replace(Op, "-").replace(/^-+|-+$/g, "").slice(0, 60) || "pose";
    try {
      ...
      d.set(H.pose.id, v(H.pose)), e.setStatus?.(s("Pose saved: {name}").replace("{name}", N)), g();
    } catch (H) {
  ...
  e.rigOverlay = V;
  function re() {
    const j = e.selectedObject?.(), N = j?.asset_kind === "character";
    if (r.hidden = !N, !N) {
      f && (f = !1), m = null, V.update();
      return;
    }
    j.id !== m && (m = j.id, f = !1, e.subSelection?.type === "character_joint" && (e.subSelection = null), d.size || _()), g(), V.update();
  }
  n?.addEventListener("change", F), i?.addEventListener("click", X), r.querySelector('[data-pose-act="save"]')?.addEventListener("click", z);
  for (const j of p)
    j?.addEventListener("change", $), j?.addEventListener("input", $);
  return _(), {
    sync: re,
    update() {
      V.update(), x();
    ...
    dispose() {
      V.dispose(), n?.removeEventListener("change", F), i?.removeEventListener("click", X);
      for (const j of p)
        j?.removeEventListener("change", $), j?.removeEventListener("input", $);
    }
  };
}
function un(e, t) {
  ...
  function u() {
    ...
    if (o) {
      ...
      o.dataset.sig !== _ && (o.dataset.sig = _, o.replaceChildren(
        un("", x.length ? s("No motion (static)") : s("No clips in this model")),
        ...x.map(($) => un($, $))
...
function zp(e, t) {
  ...
  const a = e.activeCameraTrack(), o = Tl(t, {
...
function Np(e, t) {
  ...
  (!a.keyframes || a.keyframes.length === 0) && (a.keyframes = [
    { frame: 0, camera: pe(e.camera), interpolation: "smooth" },
    { frame: e.state.duration_frames - 1, camera: pe(e.camera), interpolation: "smooth" }
  ]);
  const o = $l(a, { type: t, intensity: 1, duration_frames: e.state.duration_frames });
...
const bn = ["#4aa3ef", "#f2a93b", "#48c774", "#b565d8", "#ec4899"], Ye = [4, 8, 12, 20, 35, 60, 100];
function kt(e) {
...
function Lo(e, t, a) {
  ...
  const o = kt(e), r = o.expanded ? 220 : 138, n = Math.min(r, Math.max(80, Math.min(t, a) - 20)), i = 10, c = Math.max(0, t - n - i), l = Math.max(0, a - n - i), p = e.viewportCamera(), m = p?.position || [0, 1.5, 5], f = p?.target || [0, 0, 0], d = e.activeCameraTrack?.(), h = e.state.cameras?.length ? e.state.cameras : d ? [d] : [], u = h.flatMap(
    (_) => (_.keyframes || []).map(($) => $.camera?.position).filter(Boolean)
  );
  let b = 12;
  if (o.rangeIndex >= 0 && o.rangeIndex < Ye.length)
    b = Ye[o.rangeIndex];
  else {
    const _ = Math.max(
      Math.abs(m[0] || 0),
      ...
      Math.abs(f[0] || 0),
      Math.abs(f[2] || 0),
      ...u.flatMap(($) => [Math.abs($[0] || 0), Math.abs($[2] || 0)]),
      4
    );
...
function Bp(e, t, a, o) {
  const r = Lo(e, a, o);
  if (!r) return;
  const { rx: n, ry: i, radarSize: c, cx: l, cy: p, innerRadius: m, range: f, scale: d, camPos: h, camTgt: u, cameras: b, activeTrack: v } = r, y = kt(e), x = e.state.active_camera_id || v?.id, S = (ae, le) => ks(r, ae, le);
  ...
  for (const ae of _) {
    const le = m * ae;
    t.beginPath(), t.arc(l, p, le, 0, Math.PI * 2), t.stroke(), c >= 120 && (t.font = "8px monospace", t.fillStyle = "rgba(0, 210, 211, 0.35)", t.textAlign = "left", t.fillText(`${Math.round(f * ae)}m`, l + le + 2, p - 2));
  }
  ...
  for (const ae of e.state.objects || []) {
    ...
    const le = wr(e.state.objects, ae).position || [0, 0, 0], [be, fe] = S(le[0], le[2]);
    ...
    if (t.save(), t.translate(be, fe), ae.type === "card") {
      ...
      for (let ye = 0; ye < 4; ye++) {
        const me = ye * Math.PI / 2;
        t.beginPath(), t.moveTo(Math.cos(me) * 4, Math.sin(me) * 4), t.lineTo(Math.cos(me) * 6, Math.sin(me) * 6), t.stroke();
      }
    } else
  ...
  for (let ae = 0; ae < b.length; ae++) {
    const le = b[ae], be = le.keyframes || [], fe = le.id === x, ge = le.color || bn[ae % bn.length];
    t.save(), t.strokeStyle = ge, t.globalAlpha = fe ? 0.95 : 0.4, t.lineWidth = fe ? 2 : 1, t.setLineDash(fe ? [] : [2, 2]), t.beginPath();
    let ye = !1;
    const me = be[0]?.frame, Ae = be[be.length - 1]?.frame;
    for (let ve = me; Number.isFinite(ve) && ve <= Ae; ve++) {
      const xe = $e(le, ve, e.state.objects)?.position;
      if (!Array.isArray(xe)) continue;
      const [ue, O] = S(xe[0], xe[2]);
      ye ? t.lineTo(ue, O) : (t.moveTo(ue, O), ye = !0);
    }
    ...
    for (const ve of be) {
      ...
      if (!xe) continue;
      const [ue, O] = S(xe[0], xe[2]);
      if (ue < n + 4 || ue > n + c - 4 || O < i + 4 || O > i + c - 4) continue;
      const D = ve.frame === e.frame && fe;
      t.fillStyle = D ? "#ffffff" : ge, t.globalAlpha = fe ? 0.95 : 0.6, t.beginPath(), t.moveTo(ue, O - 3), t.lineTo(ue + 3, O), t.lineTo(ue, O + 3), t.lineTo(ue - 3, O), t.closePath(), t.fill(), D && (t.strokeStyle = "#00d2d3", t.lineWidth = 1.2, t.stroke());
    }
    t.restore();
  }
  const [$, F] = S(h[0] || 0, h[2] || 0), [z, X] = S(u[0] || 0, u[2] || 0), W = 8, V = Y($, n + W, n + c - W), re = Y(F, i + W, i + c - W), j = Y(z, n + W, n + c - W), N = Y(X, i + W, i + c - W), U = h[1] || 0, H = Kp(U), te = Dp(U);
  t.strokeStyle = "rgba(255, 255, 255, 0.40)", t.lineWidth = 1, t.setLineDash([3, 3]), t.beginPath(), t.moveTo(V, re), t.lineTo(j, N), t.stroke(), t.setLineDash([]), t.fillStyle = "#ffffff", t.beginPath(), t.arc(j, N, 2.5, 0, Math.PI * 2), t.fill(), t.strokeStyle = "rgba(255, 255, 255, 0.7)", t.lineWidth = 1, t.beginPath(), t.arc(j, N, 4.5, 0, Math.PI * 2), t.stroke();
  const A = u[0] - h[0], G = u[2] - h[2], L = Math.atan2(G, A), J = (e.viewportCamera().fov || 35) * Math.PI / 360, ce = Y(24 * (d / (m / 8)), 16, 38), se = t.createRadialGradient(V, re, 2, V, re, ce);
  se.addColorStop(0, H + "55"), se.addColorStop(1, H + "08"), t.fillStyle = se, t.strokeStyle = H, t.lineWidth = 1.2, t.beginPath(), t.moveTo(V, re), t.lineTo(V + Math.cos(L - J) * ce, re + Math.sin(L - J) * ce), t.arc(V, re, ce, L - J, L + J), t.closePath(), t.fill(), t.stroke(), t.fillStyle = H + "44", t.beginPath(), t.arc(V, re, 6.5, 0, Math.PI * 2), t.fill(), t.fillStyle = H, t.beginPath(), t.arc(V, re, 3.5, 0, Math.PI * 2), t.fill(), t.strokeStyle = "#ffffff", t.lineWidth = 1.5, t.beginPath(), t.moveTo(V, re), t.lineTo(V + Math.cos(L) * 7, re + Math.sin(L) * 7), t.stroke(), qp(e, t, r, H, te, L, Math.hypot(A, G)), y.hover && Up(t, r, y.hover), t.restore();
}
function qp(e, t, a, o, r, n, i) {
  const { rx: c, ry: l, radarSize: p } = a, m = kt(e);
...
function js(e, t, a, o) {
  const { camPos: r, camTgt: n, cameras: i, rx: c, ry: l, radarSize: p } = t, m = (v, y) => ks(t, v, y), [f, d] = m(r[0] || 0, r[2] || 0);
  ...
  for (const v of e.state.objects || []) {
    ...
    const y = wr(e.state.objects, v).position || [0, 0, 0], [x, S] = m(y[0], y[2]);
...
function Wp(e, t, a, o) {
  ...
  if (a < n || a > n + c || o < i || o > i + c)
    return !1;
  t.preventDefault?.(), t.stopPropagation?.();
  const l = kt(e), p = Ss(r, a, o);
  if (p)
    return p === "zoom_in" ? (l.rangeIndex === -1 && (l.rangeIndex = Ye.findIndex((h) => h >= r.range), l.rangeIndex < 0 && (l.rangeIndex = Ye.length - 1)), l.rangeIndex = Math.max(0, (l.rangeIndex === -1 ? 2 : l.rangeIndex) - 1)) : p === "zoom_out" ? (l.rangeIndex === -1 && (l.rangeIndex = Ye.findIndex((h) => h >= r.range), l.rangeIndex < 0 && (l.rangeIndex = 0)), l.rangeIndex = Math.min(Ye.length - 1, l.rangeIndex + 1)) : p === "center" ? l.centerMode = l.centerMode === "camera" ? "origin" : "camera" : p === "size" && (l.expanded = !l.expanded), e.render?.(), !0;
  const m = js(e, r, a, o);
  if (m) {
    if (m.type === "camera")
...
function Vp(e, t, a, o) {
  ...
  const r = Lo(e, e.canvas.width, e.canvas.height);
  if (!r) return !1;
  const n = kt(e), { rx: i, ry: c, radarSize: l } = r, p = a >= i && a <= i + l && o >= c && o <= c + l;
  if (n.drag) {
    const [b, v] = cr(r, a, o), y = e.viewportCamera();
  ...
  const m = Ss(r, a, o), f = js(e, r, a, o), [d, h] = cr(r, a, o);
...
function Hp(e, t, a, o) {
  ...
  if (a < n || a > n + c || o < i || o > i + c)
    return !1;
  t.preventDefault?.(), t.stopPropagation?.();
  const l = kt(e), p = Math.sign(t.deltaY || 0);
  return l.rangeIndex === -1 && (l.rangeIndex = Ye.findIndex((m) => m >= r.range), l.rangeIndex < 0 && (l.rangeIndex = 2)), p > 0 ? l.rangeIndex = Math.min(Ye.length - 1, l.rangeIndex + 1) : p < 0 && (l.rangeIndex = Math.max(0, l.rangeIndex - 1)), e.render?.(), !0;
}
function Gp(e, t, a) {
  ...
  const o = () => {
    ...
    const h = ui(t('[data-role="object-tags"]')?.value || "");
    h.length ? d.tags = h : delete d.tags;
    const u = String(t('[data-role="object-annotation"]')?.value || "").trim(), b = u ? Rn({
      text: u,
  ...
  }, { signal: a }), Kl(e, a), hd(e, a), t('[data-role="curve-group"]')?.addEventListener("change", () => {
    e.setChannelFilter("all"), is(e), e.drawCurveEditor(), Er(e);
  ...
  e.root.addEventListener("pointerdown", (d) => {
    ...
    const h = e.interactionElement.getBoundingClientRect(), u = (d.clientX - h.left) * e.canvas.width / Math.max(1, h.width), b = (d.clientY - h.top) * e.canvas.height / Math.max(1, h.height);
    Hp(e, d, u, b) || e.onWheel(d);
  }, { passive: !1, signal: a }), e.root.addEventListener("wheel", jl(e.root), { signal: a }), window.addEventListener("pointermove", (d) => {
  ...
  l && (l.addEventListener("pointerdown", (d) => e.onTimelinePointerDown(d), { signal: a }), l.addEventListener("pointermove", (d) => e.onTimelinePointerMove(d), { signal: a }), l.addEventListener("pointerup", (d) => e.onTimelinePointerUp(d), { signal: a }), l.addEventListener("pointercancel", (d) => e.onTimelinePointerUp(d), { signal: a }), l.addEventListener("wheel", (d) => Nn(e, d), { passive: !1, signal: a }));
  const p = (d) => {
    const h = bi(d.composedPath?.()[0] || d.target);
    h && (e.lastKeyZone = h);
  };
  e.root.addEventListener("focusin", p, { signal: a }), e.root.addEventListener("pointerdown", p, { capture: !0, signal: a }), e.root.addEventListener("focusout", (d) => {
    e.modalTransform && !e.root.contains(d.relatedTarget) && (hi(e), e.render());
  }, { signal: a });
...
function Xp(e, t) {
  kr.find((o) => o.id === e)?.onChange?.(t);
}
function Jp(e) {
  const t = ic(e.id, e.defaultValue), a = `pref_${e.id.replace(/[^a-zA-Z0-9]/g, "_")}`;
  if (e.type === "boolean")
    return `
...
function Zp(e) {
  const t = new Map(kr.map((o) => [o.id, o]));
  return ({
    nav: [
      Zi,
      Qi,
...
function Qp() {
  return `<span class="oc-pref-emoji" aria-hidden="true">${Yp}</span> ${s("OmniCam Preferences")}`;
}
function ef(e) {
  ...
  a.className = "oc-modal-backdrop", a.setAttribute("role", "dialog"), a.setAttribute("aria-modal", "true"), a.setAttribute("aria-label", s("OmniCam Preferences")), a.innerHTML = `
    <div class="oc-modal-dialog oc-pref-dialog" tabindex="-1">
      <div class="oc-pref-header">
        <div class="oc-pref-title">${Qp()}</div>
...
const af = ["position", "target"], of = ["fov", "zoom"], rf = ["roll"], nf = ["position", "size"], sf = ["rotation"];
function lr(e) {
...
function vn(e, t, a, o) {
  const r = lr(Number(a || 0) - Number(e || 0)), n = Number(e || 0) + r * o;
  if (t == null) return n;
  const i = lr(Number(t || 0) - n);
  return n + i / 3;
}
function xn(e, t, a) {
  ...
  for (let r = 1; r < a.length - 1; r++) {
    ...
    if (i.camera) {
      for (const m of af) {
        ...
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const u = yn(f, d, h, p);
          a[r].camera[m] = xn(d.map(Number), u, o);
        }
      }
      for (const m of of) {
        const f = n.camera?.[m], d = i.camera?.[m], h = c.camera?.[m];
    ...
    if (Array.isArray(i.position) && Array.isArray(n.position) && Array.isArray(c.position)) {
      for (const m of nf) {
        ...
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const u = yn(f, d, h, p);
          a[r][m] = xn(d.map(Number), u, o);
        }
      }
      for (const m of sf) {
        const f = n[m], d = i[m], h = c[m];
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const u = [0, 1, 2].map((b) => vn(f[b], d[b], h[b], p));
          a[r][m] = d.map((b, v) => wn(Number(b), u[v], o));
        }
      }
    }
  }
...
function uf(e, t) {
  ...
  const o = (r) => {
    ...
    const u = (v) => {
      ...
      let x = pf;
      v.shiftKey ? x = ff : (v.ctrlKey || v.metaKey) && (x = hf);
      const S = p * x * 20;
      let g = l + y * S;
...
function yf(e, t) {
  for (const o of e.root.querySelectorAll('[data-act="toggle-camera-lock"]'))
    o.addEventListener("click", (r) => {
      r.stopPropagation(), e.checkpoint?.("Toggle camera lock"), e.state.camera_lock = !e.state.camera_lock, e.serialize?.(), _s(e), e.setStatus?.(e.state.camera_lock ? s("Camera View locked") : s("Camera View unlocked"));
    }, { signal: t });
  ...
  for (const o of e.root.querySelectorAll('[data-act="toggle-gizmo-space"]'))
    o.addEventListener("click", (r) => {
      ...
      e.serialize?.(), ze(e), e.requestRender?.(), e.setStatus?.(s("Transform space: {space}").replace("{space}", e.state.gizmo_space));
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-spatial-snap"]'))
    o.addEventListener("click", (r) => {
      ...
      e.serialize?.(), ze(e), e.setStatus?.(s("Snapping: {mode}").replace("{mode}", e.state.spatial_snap_mode));
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-grid-overlay"]'))
    o.addEventListener("click", (r) => {
      r.stopPropagation(), e.checkpoint?.("Toggle grid overlay"), e.state.show_grid = e.state.show_grid === !1, e.serialize?.(), ze(e), e.requestRender?.();
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-wireframe-overlay"]'))
    o.addEventListener("click", (r) => {
      ...
      e.serialize?.(), ze(e), e.requestRender?.(), e.setStatus?.(e.state.show_wireframe ? s("Wireframe overlay: On") : s("Wireframe overlay: Off"));
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-cull-overlay"]'))
    o.addEventListener("click", (r) => {
      ...
      e.serialize?.(), ze(e), e.webgl && (e.webgl.sceneKey = ""), e.requestRender?.(), e.setStatus?.(e.state.backface_culling ? s("Backface culling: On (Single-Sided)") : s("Backface culling: Off (Double-Sided)"));
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-gizmo-overlay"]'))
    o.addEventListener("click", (r) => {
      r.stopPropagation(), e.checkpoint?.("Toggle gizmo overlay"), e.state.show_gizmo = e.state.show_gizmo === !1, e.serialize?.(), ze(e), e.requestRender?.();
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-guides-overlay"]'))
    o.addEventListener("click", (r) => {
      r.stopPropagation(), e.checkpoint?.("Toggle guides overlay"), e.state.guides = e.state.guides === !1, e.serialize?.(), ze(e), e.requestRender?.();
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-safe-areas-overlay"]'))
    o.addEventListener("click", (r) => {
      r.stopPropagation(), e.checkpoint?.("Toggle safe areas overlay"), e.state.safe_areas = !e.state.safe_areas, e.serialize?.(), ze(e), e.requestRender?.();
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-radar-overlay"]'))
    o.addEventListener("click", (r) => {
      r.stopPropagation(), e.checkpoint?.("Toggle radar overlay"), e.state.show_radar = !e.state.show_radar, e.serialize?.(), ze(e), e.requestRender?.();
    }, { signal: t });
...
function vf(e, t) {
  ...
  !a || !o || (r && r.addEventListener("change", () => {
    ...
    document.activeElement !== a && (a.value = _r(o.value));
  }, { signal: t }));
}
function xf(e, t) {
  ...
  }, n = (i) => (e.smoothingBaseline?.cameraId !== i.id && (e.smoothingBaseline = { cameraId: i.id, keys: mf(i.keyframes) }), e.smoothingBaseline.keys);
  a.addEventListener("input", r, { signal: t }), a.addEventListener("change", () => {
    const i = e.activeCameraTrack();
    if (!i) return;
    e.checkpoint("Path smoothing");
    const c = Number(a.value) / 100, l = df(n(i), c);
...
function wf(e, t) {
  ...
  e.root.querySelector('[data-act="keys-reduce"]')?.addEventListener("click", async () => {
    const l = await Vt(e, s("Reduce keys"), s("Target number of keys"), "8"), p = Math.round(Number(l));
  ...
  if (a.length) {
    ...
    for (const o of a)
      o.addEventListener("change", () => {
        e.dopeChannels = new Set(a.filter((r) => r.checked).map((r) => r.dataset.dopeChannel)), ts(e);
      }, { signal: t });
  }
}
function jf(e, t) {
...
const ho = () => import("./chunk-CT-hhfpH.js");
function Cf(e, t) {
...
function Ef(e, t) {
  ...
  cc().then((r) => {
    ...
    c === "health-slow" ? dc(e) : c === "health-smooth" ? mc(e) : c === "health-recenter" && pc(e);
  }, { signal: t });
...
function Mf(e, t) {
  Cf(e, t), vf(e, t), xf(e, t), wf(e, t), kf(e, t), Af(e, t), Tf(e, t), $f(e, t), uf(e, t), bf(e, t), Sf(e, t), _f(e, t), yf(e, t), jf(e, t), Ef(e, t);
}
const kn = {
...
}, Cs = "balanced", Go = "#121212";
function Tr(e) {
  return kn[e] || kn[Cs];
}
function If(e, t = "#1b1f2b", a = "#151822", o = "#1e2330", r = "#161922", n = "#111319") {
...
function sg(e, t, a = Cs) {
  const o = Tr(a), r = new e.Group();
  ...
  const h = new e.FogExp2(1250588, 8e-3), u = If(e), b = new e.PMREMGenerator(t);
  b.compileEquirectangularShader();
  const v = new Al(), y = b.fromScene(v, 0.04).texture;
  return v.traverse((x) => {
    x.geometry?.dispose?.();
...
function cg(e, t, a, o, r) {
  o.group.visible = r, t.environment = r ? o.environment : null, t.background = r ? o.sky : new e.Color(1184274), t.fog = r ? o.fog : null, a.toneMapping = r ? e.ACESFilmicToneMapping : e.NoToneMapping, a.toneMappingExposure = r ? Tr(o.quality).toneExposure : 1, t.traverse((n) => {
...
function Pf(e) {
  ...
  const r = e.reconstruction, n = r.provider || "Reconstructed", i = Math.round(t * 100), c = Jc(e), l = c.length ? `
` + c.map(([m, f]) => `${m}: ${f}`).join(`
`) : "", p = `${n} • ${o} (${i}%)${l}`;
  return {
    label: o,
...
function lg(e, t, a) {
  return e?.reconstruction ? a ? "neutral" : Lf(t) === "source_texture" ? "textured" : "neutral" : null;
}
function zf(e, t) {
...
function Nf(e, t, a) {
  ...
  if (o) {
    const n = (i) => {
      const c = i.target.closest?.("[data-axis], [data-axis-center]") || i.target, l = c.getAttribute("data-axis"), p = fc(l?.toLowerCase(), e.state.view_mode);
  ...
  for (const n of e.root.querySelectorAll('[data-role="viewport-bg-color"]')) {
    const i = (c) => {
      e.state.viewport_bg_color !== c.target.value && uo(e, "viewport_bg_color", "Change background colour"), e.state.viewport_bg_color = c.target.value, je(e.root, "viewport-bg-color", c.target), e.scheduleSerialize(), e.render();
    };
    n.addEventListener("input", i, { signal: a }), n.addEventListener("change", i, { signal: a });
  }
  ...
  for (const n of e.root.querySelectorAll("[data-lens]"))
    n.addEventListener("click", () => {
      Zc(e, Number(n.dataset.lens));
    }, { signal: a });
  for (const n of e.root.querySelectorAll("[data-blocking-scene]"))
    n.addEventListener("click", () => {
      Rp(e, n.dataset.blockingScene), e.closeMenus();
    }, { signal: a });
...
const Ff = 32, Rf = 0.025, Kf = 0.05, Co = 1e-6, Df = ["top", "bottom", "front", "back", "left", "right"], Bf = {
  top: "y",
  bottom: "y",
  front: "z",
  back: "z",
...
function qf(e) {
  let t = 0;
  for (let a = 1; a < e.length; a++) t += Ir(e[a - 1], e[a]);
  return t;
}
function Sn(e) {
  const t = Math.max(0, Math.round(Number(e?.duration_frames) || 1) - 1), a = Array.isArray(e?.playback_range) ? e.playback_range : [0, t], o = dr(Math.round(Number(a[0]) || 0), 0, t), r = dr(Math.round(Number(a[1]) || t), 0, t);
  return o <= r ? [o, r] : [r, o];
}
function Uf(e, t) {
  ...
  for (let i = 0; i < t; i++) {
    ...
    const l = a[n - 1], p = a[n], m = dr((c - l) / Math.max(Co, p - l), 0, 1), f = e[n - 1], d = e[n];
    r.push([
      f[0] + (d[0] - f[0]) * m,
      f[1] + (d[1] - f[1]) * m,
      f[2] + (d[2] - f[2]) * m
...
function Hf(e) {
  ...
  const n = Math.min(Ff, r.length, o + 1);
  if (n < 2) return [];
  const i = Uf(r, n);
  ...
  ], p = e.planeAxis === "y" ? Es(l) : As(l, [0, 0, -1]), m = e.seedPoint ? 1 : 0, f = [];
  for (let d = m; d < i.length; d++) {
    const h = i[d], u = Wf(i, d, p, e.planeAxis), b = pe(c);
    b.position = [...h], b.target = Vf(h, u, l, e.planeAxis), f.push({
...
function $s(e, t = e.cameraPathDraw) {
  const a = t?.pointerId;
  if (a != null)
    try {
...
function jn(e, t = {}) {
  ...
  const a = t.mode === "extend" ? "extend" : "new", o = e.activeCameraTrack?.(), r = pe(e.camera || o?.camera);
  ...
  if (a === "extend") {
    ...
    const u = Math.max(0, Math.round(Number(e.state.duration_frames) || 1) - 1), [, b] = Sn(e.state), v = d.length > 1 ? d[d.length - 1].frame - d[0].frame : 24;
    let y = Math.max(b, h.frame + Math.max(6, Math.min(v, 240)));
    y <= h.frame && (y = h.frame + 24), y > u && (l = y + 1), y > b && (p = y), c = [h.frame, y];
  } else
    Df.includes(e.state.view_mode) || e.setViewMode?.("top"), c = Sn(e.state);
  const m = Bf[e.state.view_mode] ?? null, f = n ? [...n] : [...r.position];
  return e.cameraPathDraw = {
    ...
    sourceCamera: r,
    points: []
  }, qt(e), e.setStatus?.(a === "extend" ? s("Continue Camera Path: LMB draw from the last key · RMB or Esc cancel") : s("Draw Camera Path: LMB draw · RMB or Esc cancel")), e.render?.(), !0;
}
function Or(e, t) {
  ...
  return r && Ir(r, o) < Rf ? !1 : (a.points.push(o), !0);
}
function De(e) {
  const t = e.cameraPathDraw;
  return t?.active ? ($s(e, t), e.cameraPathDraw = null, qt(e), e.setStatus?.(s("Draw Camera Path cancelled")), e.render?.(), !0) : !1;
}
function Yf(e) {
  const t = e.cameraPathDraw;
  ...
  if (a.length < 2 || qf(a) < Kf || t.range[1] <= t.range[0])
    return De(e), e.setStatus?.(s("Camera path needs at least two distinct points")), null;
  const o = Hf(t);
  ...
  if (t.mode === "extend") {
    ...
    return c.keyframes = p, c.id === e.state.active_camera_id && (e.state.keyframes = p), e.cameraPreviewSignature = "", e.cameraPathDraw = null, qt(e), e.activateCamera?.(c.id), e.setFrame?.(o[0].frame), e.serialize?.(), e.refreshKeys?.(), e.render?.(), e.setStatus?.(s("Camera path extended")), c.id;
  }
  e.checkpoint?.("Draw camera path");
  const r = Qc(e.state), n = e.state.cameras.length, i = {
    id: r,
    name: Gf(e.state),
    color: Hr[n % Hr.length],
    camera: pe(o[0].camera),
    keyframes: o,
    target_object_id: null,
    target_offset: [0, 0, 0]
  };
  return e.state.cameras.push(i), e.cameraPreviewSignature = "", e.cameraPathDraw = null, qt(e), e.activateCamera?.(r), e.setFrame?.(t.range[0]), e.setStatus?.(s("Camera path created")), r;
}
function Ao(e) {
...
function Jf(e, t) {
  const a = e.cameraPathDraw;
  return a?.active ? t.button === 2 && !t.altKey ? (Ao(t), e.cameraPathSuppressContextMenuUntil = Date.now() + 1e3, De(e), !0) : t.button !== 0 || t.altKey || t.ctrlKey || t.metaKey || t.shiftKey ? !1 : (Ao(t), e.closeMenus?.(), e.interactionElement.focus?.({ preventScroll: !0 }), e.interactionElement.setPointerCapture?.(t.pointerId), a.drawing = !0, a.pointerId = t.pointerId, a.points = [], Or(e, Pr(e, t)), qt(e), e.requestRender?.("camera-path-draw"), !0) : !1;
}
function Zf(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : (Ao(t), Or(e, Pr(e, t)) && e.requestRender?.("camera-path-draw"), !0);
}
function Qf(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : (Ao(t), t.type === "pointercancel" || t.type === "lostpointercapture" ? (De(e), !0) : (Or(e, Pr(e, t)), a.drawing = !1, Yf(e), !0));
}
function eh(e) {
  const t = e.cameraPathDraw;
  ...
  if (!o.length) return;
  const r = o.map((c) => qe(c, a, e.canvas.width, e.canvas.height)).filter((c) => c && Number.isFinite(c[0]) && Number.isFinite(c[1]));
  if (!r.length) return;
...
function th(e, t) {
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? De(e) : jn(e);
    }, { signal: t });
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path-extend"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? De(e) : jn(e, { mode: "extend" });
    }, { signal: t });
  e.root.addEventListener("contextmenu", (a) => {
    !(Date.now() <= Number(e.cameraPathSuppressContextMenuUntil || 0)) && !e.cameraPathDraw?.active || (a.preventDefault(), a.stopPropagation(), a.stopImmediatePropagation?.(), e.cameraPathSuppressContextMenuUntil = 0, e.cameraPathDraw?.active && De(e));
  }, { capture: !0, signal: t });
}
...
function Lr(e, t, { name: a = "", status: o } = {}) {
  const r = t && typeof t == "object" ? t : Gn(), n = { ...r, metadata: { ...r.metadata || {}, scene_name: a || "" } };
...
async function ah(e) {
  await Ht(e, s("New Scene"), s("Start a new scene? Unsaved changes will be lost.")) && Lr(e, Gn(), { name: "", status: s("New scene") });
}
async function oh(e) {
  if (!e.sceneBaseline) {
  ...
  const o = a?.metadata?.scene_name || Ts(e);
  Lr(e, a, { name: o, status: s("Scene reset to last save") });
}
async function rh(e) {
  const t = Ts(e) || s("Untitled"), a = await Vt(e, s("Save Scene"), s("Scene name"), t);
  if (a == null) return;
...
function ih(e, t) {
  bo(e, t, e.root.querySelectorAll('[data-act="scene-new"]'), () => ah(e)), bo(e, t, e.root.querySelectorAll('[data-act="scene-open"]'), () => nh(e)), bo(e, t, e.root.querySelectorAll('[data-act="scene-save"]'), () => rh(e)), bo(e, t, e.root.querySelectorAll('[data-act="scene-reset"]'), () => oh(e));
}
const ch = ["world_point", "object_point", "camera_field"], _n = 40;
function lh(e) {
  return (e.keys || []).map((t) => ({ x: t.x, y: t.y, t: t.time_seconds }));
}
function dh(e, t, a) {
  const o = Math.max(1, Number(e.fps) || 24), r = e.width || 1280, n = e.height || 720, i = [];
  for (let c = 0; c <= _n; c += 1) {
    const l = a * c / _n, p = Sr(e, t.source, l * o, r, n);
...
function ph(e) {
  ...
  if (!c) return;
  const l = Ms(t, e.state.width || 1280, e.state.height || 720), p = (v) => l.x + v * l.w, m = (v) => l.y + v * l.h;
  ...
  for (const v of e.state.motion_layers || []) {
    if (v.enabled === !1) continue;
    const y = ch.includes(v.source_kind), x = y ? dh(e.state, v, d) : lh(v);
    if (!x.length) continue;
    u += 1;
    const S = v.id === e.state.selected_motion_layer_id;
    if (c.strokeStyle = S ? "#ffcc4d" : "rgba(65,217,197,0.6)", c.lineWidth = (S ? 2.4 : 1.5) * r, c.beginPath(), x.forEach((_, $) => {
      const F = p(_.x), z = m(_.y);
      $ ? c.lineTo(F, z) : c.moveTo(F, z);
    }), c.stroke(), !y) {
...
function fh(e, t) {
  ...
  a && a.addEventListener("click", (o) => {
    ...
    const n = Ms(a, e.state.width || 1280, e.state.height || 720), i = a.width / r.width, c = {
      x: ((o.clientX - r.left) * i - n.x) / Math.max(1, n.w),
      y: ((o.clientY - r.top) * i - n.y) / Math.max(1, n.h)
    }, l = uc(e.state.motion_layers, c, 0.09);
...
function bh(e, t) {
  ...
  return {
    ...
    motion_scene_fingerprint: _l(e.state)
  };
}
function gh(e, t) {
  const a = bh(e, t);
...
function Cn(e, t, { frameCount: a = 0, fps: o = 0 } = {}) {
...
const it = 1024 * 1024, yh = Object.freeze({
  card: 128 * it,
  // MAX_CARD_BYTES
  model: 256 * it,
  // MAX_MODEL_BYTES
...
function An(e) {
  return `${(e / it).toFixed(e >= 10 * it ? 0 : 1)} MB`;
}
function Gt(e, t) {
  const a = yh[t];
  if (!e || !a) return null;
  const o = Number(e.size);
  return !Number.isFinite(o) || o <= a ? null : `${e.name || "File"} is ${An(o)}; the maximum is ${An(a)}.`;
}
function vh(e) {
  return Number(e) <= En ? null : `${e} frames selected; a background sequence is limited to ${En}.`;
}
function xh(e) {
...
async function jh(e, t, { decode: a = kh } = {}) {
  if (!t) return;
  const o = Gt(t, "audio");
  if (o) {
    e.setStatus(o);
  ...
  try {
    ...
    n.preload = "auto", n.src = r, e.audioObjectUrl = r, e.audioElement = n, await Sh(n), e.audioDuration = Number.isFinite(n.duration) ? n.duration : 0;
    try {
      e.audioSamples = await a(t);
    } catch {
      e.audioSamples = null;
    }
    Is(e), e.setStatus(`Audio loaded: ${t.name || "track"}`);
  } catch (r) {
...
const Ps = /* @__PURE__ */ new WeakSet(), Kt = /* @__PURE__ */ new WeakMap();
function To(e) {
...
function _h(e) {
  e && typeof e == "object" && Kt.set(e, (Kt.get(e) || 0) + 1);
}
function Ch(e) {
  ...
  Kt.delete(e), Ps.has(e) && To(e);
}
function Yt(e, t) {
  const a = e.cardMediaById.get(t);
  a && (e.cardMediaById.delete(t), e.cardMediaAssetById?.delete?.(t), t === "subject" && e.cardMedia === a && (e.cardMedia = null), Ch(a));
}
function Eh(e) {
  for (const t of [...e.cardMediaById?.keys?.() || []]) Yt(e, t);
}
function Qe(e, t, a, o = !1, r = "") {
  ...
  n && n !== a && Yt(e, t), o && Ps.add(a), _h(a), e.cardMediaAssetById ||= /* @__PURE__ */ new Map(), e.cardMediaById.set(t, a), e.cardMediaAssetById.set(t, r || a?.__omnicamAsset || "");
  try {
    a.__omnicamAsset = r || a.__omnicamAsset || "";
  } catch {
  }
...
async function zs(e, t, a, o = () => !0, r = null) {
  if (!t || !a) return;
...
async function Ah(e, t) {
  if (!xt?.fetchApi || !/\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/i.test(e)) return null;
  const a = await xt.fetchApi("/majoor/omnicam/extractor/source", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
...
function $h(e) {
  ...
  if (e.state.viewport_bg_image) {
    const o = new Image();
    o.src = Xe(e.state.viewport_bg_image), o.decode().catch(() => {
    }), e.viewportBgImage = o;
  }
  e.viewportBgSequenceImages = (e.state.viewport_bg_sequence || []).map((o) => {
    const r = new Image();
    return r.src = Xe(o), r.decode().catch(() => {
    }), r;
  });
  for (const o of e.state.objects) {
    if (!o.asset) {
      (o.type === "model" || o.type === "glb") && (o.load_error = s("Not saved to the ComfyUI input folder: this model will be missing after a reload.")), o.type === "card" && Yt(e, o.id);
      continue;
    }
    const r = Xe(o.asset);
...
async function Mh(e, t) {
  ...
  try {
    const c = await Ar(xt, { route: "/majoor/omnicam/upload_model", field: "asset", file: t });
...
async function Ih(e, t) {
  ...
  if (o) {
    ...
    try {
      const r = await Ar(xt, { route: "/majoor/omnicam/upload_asset", field: "asset", file: t });
...
function Ph(e) {
  ...
  }, a.src = xt.apiURL(`/view?${new URLSearchParams(t).toString()}`);
}
async function Lh(e) {
  if (!e.node) return;
  ...
  for (const f of i) {
    ...
    if (h) {
      if (d === "image" || d === "video") {
        ...
        if (u && u.value) {
          const b = String(u.value), v = /\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/i.test(b), y = h.widgets?.find((g) => String(g.name).toLowerCase() === "subfolder")?.value || "", x = Xe(ut(b, y)), S = e.state.objects.find((g) => g.id === "subject");
          if (S) {
            const g = await zs(e, S, x, r, v);
            if (!r()) return;
            S.asset = ut(b, y);
            let _ = null;
            if (v)
              try {
                _ = await Ah(b, o.signal);
              } catch ($) {
                if ($?.name === "AbortError") return;
                console.warn("Failed to describe upstream video:", $);
              }
            r() && Cn(e, g, {
              fps: _?.fps,
          ...
          }), Qe(e, "subject", b, !1, b.currentSrc || b.src || ""), Cn(e, b, { frameCount: b instanceof HTMLVideoElement ? 0 : 1 }), e.upstreamImageConnected = !0, n = !0, e.render(), e.setStatus(b instanceof HTMLVideoElement ? s("Upstream video preview synced") : s("Upstream image preview synced")));
        }
      }
      if (d === "audio") {
        l = !0;
        ...
        if (u && u.value) {
          const b = String(u.value), v = h.widgets?.find((x) => String(x.name).toLowerCase() === "subfolder")?.value || "", y = Xe(ut(b, v));
          try {
      ...
      if (d === "scene_3d" || d === "model" || d === "mesh") {
        ...
        if (u && u.value) {
          ...
          if (["glb", "gltf", "obj", "fbx", "stl", "ply"].includes(v)) {
            const y = h.widgets?.find((_) => String(_.name).toLowerCase() === "subfolder")?.value || "", x = Xe(ut(b, y)), S = `upstream_scene_${h.id}`;
            p.add(S);
            let g = e.state.objects.find((_) => _.id === S);
            g ? (g.asset = ut(b, y), g.format = v === "gltf" ? "glb" : v) : (g = {
              id: S,
              type: "model",
              format: v === "gltf" ? "glb" : v,
  ...
  al(e) && (n = !0), n && (e.serialize(), e.render());
}
const zh = ["video/mp4;codecs=avc1.42E01E", "video/webm;codecs=vp9", "video/webm;codecs=vp8", "video/webm"], $n = { low: 3e6, balanced: 6e6, high: 12e6 };
function Nh(e) {
  return $n[e] || $n.balanced;
}
async function Fh({
  canvas: e,
  fps: t,
  ...
  try {
    for (const S of zh)
      if (!(n.isTypeSupported && !n.isTypeSupported(S)))
        try {
          f = new n(m, { mimeType: S, videoBitsPerSecond: Nh(r) });
          break;
        } catch {
        }
...
async function Ns(e) {
  await Kh(e.cardMediaById.values());
}
async function Fs(e) {
  return Fh({
    canvas: e.canvas,
...
async function Rs(e, t) {
  const a = await Rh(et, t);
  if (gh(e, t), e.state.playblast_camera_id === Yn)
...
async function Bh(e) {
  ...
  const t = e.frame, a = e.canvas.width, o = e.canvas.height, r = Dh(e);
  (r.width !== e.canvas.width || r.height !== e.canvas.height) && (e.canvas.width = r.width, e.canvas.height = r.height, e.render());
  try {
    let n = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-DYJNFJKU.js");
    i !== "realtime" && await l(e.canvas.width, e.canvas.height) && (n = await c(e.canvas, e.state.duration_frames, e.state.fps, async (p) => {
      e.setFrame(p, !0), e.setStatus(s(`Encoding frame ${p + 1}/${e.state.duration_frames}…`)), await Ns(e), await new Promise((m) => requestAnimationFrame(m));
    }, e.abortController?.signal, e.state.playblast_quality)), n || (e.setStatus(s("WebCodecs unavailable; recording realtime fallback…")), n = await Fs(e)), e.setFrame(t), await Rs(e, n);
  } catch (n) {
...
async function Ks(e) {
  if (!Ut) throw new Error("ComfyUI API is unavailable");
  return Ar(Ut, { route: "/majoor/omnicam/upload_asset", field: "asset", file: e });
}
async function Mo(e) {
  const t = e.map((a) => String(a.relative || "").replace(/^omnicam\//, "")).filter(Boolean);
  if (!(!t.length || !Ut))
    try {
      await Ut.fetchApi("/majoor/omnicam/cleanup", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
...
async function Uh(e, t) {
  ...
  let r = null;
  try {
    if (e.setStatus(`Uploading background: ${t.name}`), r = await Ks(t), o !== e.backgroundRequestId || e.disposed) {
      await Mo([r]);
      return;
    }
    const n = Xe(r.path);
...
async function Wh(e, t) {
  ...
  const o = Array.from(t).map((i) => Gt(i, "image")).find(Boolean);
  if (o) {
    e.setStatus(o);
    return;
  }
  ...
  try {
    ...
    for (const c of t)
      if (n.push(await Ks(c)), r !== e.backgroundRequestId || e.disposed) {
        await Mo(n);
        return;
      }
    ...
    e.checkpoint?.("Set background sequence"), e.state.viewport_bg_sequence = i, e.state.viewport_bg_image = "", e.viewportBgImage = null, e.viewportBgSequenceImages = i.map((c) => {
      const l = new Image();
      return l.src = Xe(c), l.decode().catch(() => {
      }), l;
...
function Vh(e) {
  zr(e), e.checkpoint?.("Clear background"), e.state.viewport_bg_image = "", e.state.viewport_bg_sequence = [], e.viewportBgImage = null, e.viewportBgSequenceImages = [], e.serialize(), e.render(), e.setStatus("Background cleared");
}
function Hh(e) {
  const t = Qo(e.state?.metadata?.viewport_labels);
  ...
  for (const m of a) {
    if (m.enabled === !1 || !Dn(m, { mode: t.mode, selectedIds: p })) continue;
    const f = Bn(m, t.content);
    if (!f) continue;
    const d = qn(a, m, l) || { position: m.position, size: m.size }, h = qe(Un(d, m.type), o, n, i);
    if (!h) continue;
    const [u, b] = h, v = t.content === "annotation" && m.annotation?.color || "", y = 6 * c, x = 4 * c, g = r.measureText(f).width + y * 2, _ = 12 * c + x * 2, $ = Math.round(u - g / 2), F = Math.round(b - _ - 6 * c);
    r.fillStyle = "rgba(16,17,22,0.82)", Gh(r, $, F, g, _, 4 * c), r.fill(), v && (r.strokeStyle = v, r.lineWidth = Math.max(1, c), r.stroke()), r.fillStyle = v || "#e6e6ec", r.fillText(f, $ + y, F + _ - x - 2 * c);
  }
  r.restore();
}
function Gh(e, t, a, o, r, n) {
...
function ie(e, t, a, o = "#5a5a5a", r = 1) {
  const n = e.viewportCamera(), i = qe(t, n, e.canvas.width, e.canvas.height), c = qe(a, n, e.canvas.width, e.canvas.height);
...
function Xh(e) {
  ...
  return e._pointFieldCache?.key !== r && (e._pointFieldCache = { key: r, ...yc(t, a, o) }), e._pointFieldCache;
}
const Jh = 600;
function Zh(e) {
  const { points: t, colors: a } = Xh(e);
  if (!t.length) return;
  const o = e.viewportCamera(), r = e.canvas.width, n = e.canvas.height, i = t.length / 3, c = 3 * Math.max(1, Math.ceil(i / Jh)), l = /* @__PURE__ */ new Map();
  for (let p = 0; p < t.length; p += c) {
    const m = qe([t[p], t[p + 1], t[p + 2]], o, r, n);
    if (!m) continue;
...
function tu(e, t) {
  ...
  ie(e, c, l, "#aaa", 2), ie(e, l, b, "#aaa", 2), ie(e, p, m, "#aaa", 2), ie(e, p, f, "#aaa", 2), ie(e, f, h, "#aaa", 2), ie(e, m, d, "#aaa", 2), ie(e, d, u, "#aaa", 2), ie(e, v, y, "#aaa", 2), ie(e, v, x, "#aaa", 2), ie(e, x, g, "#aaa", 2), ie(e, y, S, "#aaa", 2), ie(e, S, _, "#aaa", 2);
  const $ = qe(c, e.viewportCamera(), e.canvas.width, e.canvas.height);
  $ && (e.ctx.strokeStyle = "#aaa", e.ctx.beginPath(), e.ctx.arc($[0], $[1], Y(28 / $[2], 3, 12), 0, Math.PI * 2), e.ctx.stroke());
}
function au(e, t) {
...
function ru(e, t) {
  ...
  ie(e, Ge(a, [-o, 0, 0]), Ge(a, [o, 0, 0]), "#bbb", 2), ie(e, Ge(a, [0, -o, 0]), Ge(a, [0, o, 0]), "#bbb", 2), ie(e, Ge(a, [0, 0, -o]), Ge(a, [0, 0, o]), "#bbb", 2);
}
function nu(e, t) {
  const [a, o, r] = t.position || [0, 1.5, 0], [n, i] = t.size || [2, 3], c = e.viewportCamera(), l = [
    ...
    [a + n / 2, o + i / 2, r],
    [a - n / 2, o + i / 2, r]
  ].map((v) => qe(v, c, e.canvas.width, e.canvas.height));
  ...
  if (b)
    try {
      ...
      if (e.ctx.fillStyle = "#111", e.ctx.fillRect(f, h, v, y), g === "stretch" || !x || !S)
        ...
        const _ = Math.min(v / x, y / S), $ = x * _, F = S * _;
        e.ctx.drawImage(b, f + (v - $) / 2, h + (y - F) / 2, $, F);
      } else {
        const _ = Math.max(v / x, y / S), $ = v / _, F = y / _;
        e.ctx.drawImage(b, (x - $) / 2, (S - F) / 2, $, F, f, h, v, y);
      }
    } catch {
    }
  else
...
function su(e) {
  ...
  (e.state.cameras || []).forEach((a, o) => {
    ...
    if (!(i && e.state.view_mode === "camera")) {
      ...
      for (const c of r) {
        const l = qe(c.camera.position, e.viewportCamera(), e.canvas.width, e.canvas.height);
      ...
      if (e.state.view_mode !== "camera") {
        const c = $e(a, e.frame, e.state.objects), l = qe(c.position, e.viewportCamera(), e.canvas.width, e.canvas.height);
...
function iu(e) {
  ...
  for (let o = 0; o < e.state.keyframes.length - 1; o++) {
    ...
    t.push(Vn(Hn(n.camera.position, r.camera.position)) * e.state.fps / Math.max(1, n.frame - r.frame));
  }
...
function cu(e) {
  ...
  e.recording && e.state.playblast_labels && Hh(e);
}
async function lu(e, { signal: t } = {}) {
...
async function mu(e) {
  ...
  const r = o.diagnostic?.issues || [], n = du(r);
...
function uu(e, { perFrame: t = !1 } = {}) {
  const a = e.activeCameraTrack(), o = Nr(e, a), r = Fr(e, a);
    ...
    if (t.appendChild(h), !u)
      for (const b of d) {
        ...
        if (_.className = "scene-item-label", S || y) {
          ...
          z.style.cssText = `color:${S ? "#f59e0b" : "#58cc6b"};font-weight:700`, z.textContent = S ? "● " : "○ ", _.appendChild(z);
        }
        if (_.appendChild(document.createTextNode(b.name)), x) {
          const z = document.createElement("span");
          z.style.cssText = "color:#f2d06b;font-size:10px", z.title = "Playblast Output", z.textContent = " ★", _.appendChild(z);
        }
        if (b.muted) {
          const z = document.createElement("span");
          z.style.opacity = ".6", z.textContent = " (muted)", _.appendChild(z);
        }
        const $ = document.createElement("div");
        $.className = "scene-item-actions", $.appendChild(r("pi-star", "Solo track", b.solo, () => {
          e.checkpoint("Solo track"), b.solo = !b.solo, e.serialize(), e.refreshObjects(), e.renderCameraView();
        }, "color:#fbbf24;border-color:#78350f;background:rgba(245,158,11,0.2)")), $.appendChild(r("pi-volume-off", "Mute track", b.muted, () => {
          e.checkpoint("Mute track"), b.muted = !b.muted, e.serialize(), e.refreshObjects(), e.renderCameraView();
        }, "color:#f87171;border-color:#7f1d1d;background:rgba(239,68,68,0.15)")), $.appendChild(r("pi-lock", "Lock track", b.locked, () => {
          e.checkpoint("Lock track"), b.locked = !b.locked, e.serialize(), e.refreshObjects(), e.renderCameraView();
        })), (b.keyframes || []).length >= 1 && $.appendChild(r(
          "pi-arrows-alt",
        ...
        )), $.appendChild(r("pi-ellipsis-v", "Camera actions", !1, (z) => e.openCameraContext(z, b.id, !1))), v.append(g, _, $), v.title = S ? s("Currently selected for editing") : x ? s("Active playblast camera") : s("Click to select & activate this camera");
        const F = () => {
        ...
        v.addEventListener("contextmenu", (z) => {
          ...
          (z.key === "Enter" || z.key === " ") && (z.preventDefault(), F());
        }), t.appendChild(v);
      }
  }
  if (m) {
    ...
    if (t.appendChild(x), !S)
      for (const { object: g, level: _ } of y) {
        const $ = document.createElement("div");
        $.role = "button", $.tabIndex = 0, $.dataset.objectId = g.id;
        const F = e.selectedEntity === "object" && (g.id === e.selectedObjectId || e.selectedObjectIds?.has?.(g.id)), z = e.selectedEntity === "object" && g.id === e.selectedObjectId;
        $.setAttribute("aria-selected", String(F)), $.className = `scene-item${F ? " selected" : ""}${z ? " primary" : ""}${_ > 0 && !n ? " scene-item-child" : ""}`, _ > 0 && !n && ($.style.paddingLeft = `${_ * 16 + 6}px`);
        const X = g.type === "card" ? { icon: "pi-image", color: "#38bdf8" } : g.type === "model" || g.type === "glb" ? { icon: "pi-box", color: "#c084fc" } : g.type === "ground" ? { icon: "pi-minus", color: "#fbbf24" } : g.type === "cube" ? { icon: "pi-stop", color: "#fbbf24" } : g.type === "sphere" ? { icon: "pi-circle", color: "#fbbf24" } : g.type === "cylinder" ? { icon: "pi-database", color: "#fbbf24" } : g.type === "torus" ? { icon: "pi-circle", color: "#fbbf24" } : g.type === "pyramid" ? { icon: "pi-play", color: "#fbbf24" } : g.type === "sun_light" ? { icon: "pi-sun", color: "#f59e0b" } : g.type === "point_light" ? { icon: "pi-bolt", color: "#fbbf24" } : g.type === "spot_light" ? { icon: "pi-compass", color: "#38bdf8" } : g.type === "human" ? { icon: "pi-user", color: "#34d399" } : { icon: "pi-plus", color: "#94a3b8" }, W = g.enabled !== !1, V = !!g.load_error, re = document.createElement("i");
        re.className = `pi ${V ? "pi-exclamation-triangle" : X.icon}`, re.style.cssText = V ? "color:#f87171" : W ? `color:${X.color}` : "opacity:.4";
        const j = document.createElement("span");
        j.className = "scene-item-label";
        const N = document.createElement("span");
        N.style.cssText = V ? "color:#fca5a5" : W ? "" : "opacity:.5;text-decoration:line-through", N.textContent = g.name || g.type, N.title = s("Double-click to rename"), N.addEventListener("dblclick", (A) => {
          A.preventDefault(), A.stopPropagation(), gu(e, g, N);
        }), j.appendChild(N);
        ...
        if (U.length) {
          ...
          for (const G of U.slice(0, 2)) {
            const L = document.createElement("span");
            L.className = "scene-item-tag", L.textContent = G, A.appendChild(L);
          }
          if (U.length > 2) {
            const G = document.createElement("span");
            G.className = "scene-item-tag scene-item-tag-more", G.textContent = `+${U.length - 2}`, A.appendChild(G);
          }
          j.appendChild(A);
        }
        if (V) {
          const A = document.createElement("span");
          A.style.cssText = "color:#ef4444;font-size:9px;font-weight:700", A.textContent = " [Format!]", j.appendChild(A);
        }
        const H = document.createElement("div");
        H.className = "scene-item-actions", H.appendChild(r(W ? "pi-eye" : "pi-eye-slash", W ? "Hide object (Alt+Click to Isolate)" : "Show object (Alt+Click to Isolate)", !W, (A) => {
          if (A?.altKey) {
            if (e.checkpoint("Isolate object"), e._isolatedObjectId === g.id) {
              e._isolatedObjectId = null;
              const L = e._isolationSnapshot;
              for (const q of e.state.objects)
                q.enabled = L && Object.prototype.hasOwnProperty.call(L, q.id) ? L[q.id] : !0;
              e._isolationSnapshot = null, e.setStatus?.(s("Isolation cleared"));
            } else {
              e._isolationSnapshot || (e._isolationSnapshot = Object.fromEntries(e.state.objects.map((L) => [L.id, L.enabled !== !1]))), e._isolatedObjectId = g.id;
              for (const L of e.state.objects) L.enabled = L.id === g.id;
              e.setStatus?.(s("Isolated: {name}").replace("{name}", g.name || g.type));
            }
            e.serialize(), e.refreshObjects(), e.requestRender?.();
          } else
            e.toggleObject(g.id);
        }, "color:#ef4444;opacity:.7")), H.appendChild(r(g.locked ? "pi-lock" : "pi-lock-open", "Lock object", g.locked, () => Mr(e, g))), H.appendChild(r("pi-copy", "Duplicate object", !1, () => e.duplicateObject?.(g.id))), g.id !== "subject" && H.appendChild(r("pi-trash", "Delete object", !1, () => e.deleteObject?.(g.id))), H.appendChild(r("pi-ellipsis-v", "Object actions", !1, (A) => e.openObjectContext(A, g.id))), $.append(re, j, H), $.title = s("Click to select · Double-click to toggle visibility · Right-click for actions");
        const te = (A = {}) => {
          ...
          else if (A.shiftKey && e.outlinerAnchorId && e.state.objects.some((L) => L.id === e.outlinerAnchorId)) {
            const L = e.state.objects.map((ce) => ce.id), q = L.indexOf(e.outlinerAnchorId), J = L.indexOf(g.id);
            e.selectedObjectIds = new Set(L.slice(Math.min(q, J), Math.max(q, J) + 1));
          } else
            e.selectedObjectIds = /* @__PURE__ */ new Set([g.id]), e.outlinerAnchorId = g.id;
          e.selectedObjectId = e.selectedObjectIds.has(g.id) ? g.id : [...e.selectedObjectIds].at(-1) || null, e.selectedEntity = e.selectedObjectIds.size ? "object" : "camera", e.selectedKeyFrame = e.selectedObjectId ? g.keyframes?.find((L) => L.frame === e.frame)?.frame ?? null : null, e.editingKeyFrame = null;
          for (const L of t.querySelectorAll(".scene-item")) {
            const q = !!(L.dataset.objectId && e.selectedObjectIds.has(L.dataset.objectId)), J = !!(L.dataset.objectId && L.dataset.objectId === e.selectedObjectId);
            L.classList.toggle("selected", q), L.classList.toggle("primary", J), L.dataset.objectId && L.setAttribute("aria-selected", String(q));
          }
          const G = e.root.querySelector('[data-role="outliner-batch-bar"]');
          if (G) {
            const L = e.selectedObjectIds?.size || 0;
            G.hidden = L < 2;
            const q = G.querySelector('[data-role="batch-count"]');
            q && (q.textContent = `${L} ${s("selected")}`);
          }
          e.refreshKeys(), e.refreshInspector(), e.render(), e.setStatus(s(`Selected: ${g.name || g.type}`));
        };
        $.addEventListener("dblclick", () => e.toggleObject(g.id)), $.addEventListener("contextmenu", (A) => {
          A.preventDefault(), A.stopPropagation(), e.openObjectContext(A, g.id);
        }), $.addEventListener("keydown", (A) => {
          (A.key === "Enter" || A.key === " ") && (A.preventDefault(), te(A));
        }), t.appendChild($);
      }
  }
...
async function vu(e, t) {
  ...
  if (!a) return;
  const o = (await Vt(e, s("Rename object"), s("Object name"), a.name || a.type))?.trim();
...
async function Ws(e, t) {
  ...
  const a = e.state.objects.find((o) => o.id === t);
  if (a && await Ht(e, s("Delete object"), s(`Delete ${a.name || a.type} and its ${(a.keyframes || []).length} keyframe(s)?`)) && !(e.disposed || !e.state.objects.includes(a))) {
...
function Su(e) {
  const t = Xt(e), a = e.root.querySelector('[data-role="object-panel"]');
  a && (a.hidden = !t);
  const o = (j) => e.root.querySelector(j), r = e.activeCameraTrack(), n = o('[data-role="camera-target-object"]');
  if (n) {
    const j = r.target_object_id || e.state.target_object_id || "", N = `T${Wr()}${e.state.objects.map((U) => `${U.id}\0${U.name || U.type}`).join("|")}`;
    Xo(n, N, () => [
      Rt("", s("Manual Target (No Tracking)")),
      ...e.state.objects.map((U) => Rt(U.id, `${s("Track:")} ${U.name || U.type}`))
    ], j);
  }
  bu(e);
  const i = [...e.camera.position, ...e.camera.target, e.camera.fov, e.camera.roll || 0, e.camera.near, e.camera.far, ...jr(e.camera)];
  ["camera-px", "camera-py", "camera-pz", "camera-tx", "camera-ty", "camera-tz", "camera-fov", "camera-roll", "camera-near", "camera-far", "camera-rx", "camera-ry", "camera-rz"].forEach((j, N) => {
    for (const U of e.root.querySelectorAll(`[data-role="${j}"]`))
      document.activeElement !== U && (U.value = String(Math.round(i[N] * 1e4) / 1e4));
  });
  ...
  if (!t) {
    ...
    j && (j.hidden = !0);
    const N = o('[data-role="selected-name"]');
    N && (N.textContent = `${r.name} · F${e.frame}`), Tn(o, {
  ...
  if (c) {
    ...
    if (j) {
      c.hidden = !1;
      const N = j.semantic ? `${j.semantic} · ` : "";
      c.textContent = `${N}${j.label} (${Math.round(j.confidence * 100)}%)`, c.title = j.title, c.className = `oc-recon-badge oc-badge-${j.band}`;
    } else
      c.hidden = !0;
  }
  ...
  m && (m.textContent = t.name || t.type), Tn(o, {
  ...
  for (const [j, N] of Object.entries(h))
    for (const U of e.root.querySelectorAll(`[data-role="${j}"]`))
      document.activeElement !== U && (U.value = String(Math.round(N * 1e4) / 1e4));
  ...
  if (v) {
    const j = t.id, N = /* @__PURE__ */ new Set([j]);
    let U = !0;
    for (; U; ) {
      U = !1;
      for (const A of e.state.objects)
        !N.has(A.id) && A.parent_id && N.has(A.parent_id) && (N.add(A.id), U = !0);
    }
    const H = e.state.objects.filter((A) => !N.has(A.id)), te = `P${Wr()}${j}${H.map((A) => `${A.id} ${A.name || A.type}`).join("|")}`;
    Xo(v, te, () => [
      Rt("", s("No parent")),
      ...H.map((A) => Rt(A.id, A.name || A.type))
    ], t.parent_id || "");
  }
  ...
  _ && (_.hidden = y);
  const $ = o('[data-role="scale-row"]');
  $ && ($.hidden = y);
  const F = o('[data-role="rotation-row"]');
  if (F && (F.hidden = t.type === "point_light"), y) {
    ...
    const N = o('[data-role="object-cast-shadow"]');
    if (N && (N.checked = t.cast_shadow !== !1), x) {
  ...
  if (u && (u.hidden = !z?.animations), b) {
    const j = z?.animationNames || [];
    Xo(b, `A${j.join("|")}`, () => j.map((N, U) => Rt(String(U), N)), String(t.animation_index || 0));
  }
...
function Eu(e) {
  ...
  e.beginCameraEdit(), vc(e.camera, r), e.commitCameraEdit(), e.finishCameraEdit(), Hs(e), Cu(e), e.render();
}
function Au(e) {
  const t = globalThis.performance?.now?.() ?? Date.now();
  (!Number.isFinite(e.lastCameraHudEditAt) || t - e.lastCameraHudEditAt > 300) && e.checkpoint("Edit camera"), e.lastCameraHudEditAt = t;
  ...
  e.camera.position = [a("camera-px", e.camera.position[0]), a("camera-py", e.camera.position[1]), a("camera-pz", e.camera.position[2])], e.camera.target = [a("camera-tx", e.camera.target[0]), a("camera-ty", e.camera.target[1]), a("camera-tz", e.camera.target[2])], e.camera.fov = Y(a("camera-fov", e.camera.fov), 5, 150), e.camera.roll = Y(a("camera-roll", e.camera.roll || 0), -180, 180), e.camera.near = Math.max(1e-4, a("camera-near", e.camera.near)), e.camera.far = Math.max(e.camera.near + 1e-4, a("camera-far", e.camera.far)), e.beginCameraEdit(), e.commitCameraEdit(), e.finishCameraEdit(), Hs(e), e.render();
}
function $u(e, t) {
  const a = Xt(e);
  if (!a) return;
...
function Mu(e, t) {
  e.objectUrls.revoke(t), Yt(e, t), e.modelUrlsById.delete(t), e.modelInfoById.delete(t), e.webgl?.removeModel(t);
}
function Iu(e) {
  const t = [...e.selectedObjectIds?.size ? e.selectedObjectIds : [e.selectedObjectId]].filter((o) => o && e.state.objects.some((r) => r.id === o));
  if (!t.length) return [];
  if (t.length === 1)
    return Us(e, t[0]), e.selectedObjectId ? [e.selectedObjectId] : [];
  ...
  return t.forEach((o, r) => {
    ...
    const c = 0.35 + r * 0.15;
    i.position = Ge(i.position || [0, 0, 0], [c, 0, c]), (i.type === "model" || i.type === "glb") && e.modelUrlsById.has(n.id) ? e.modelUrlsById.set(i.id, e.modelUrlsById.get(n.id)) : i.type === "card" && e.cardMediaById.has(n.id) && Qe(e, i.id, e.cardMediaById.get(n.id), !1, i.asset || e.cardMediaAssetById?.get?.(n.id) || ""), e.state.objects.push(i), a.push(i.id);
...
function Nu(e, t) {
  return t(Jn(e), e.frame);
}
function Le(e) {
  return e.selectedEntity === "object" && e.state.objects.find((t) => t.id === e.selectedObjectId) || null;
}
function _e(e) {
  return Le(e)?.keyframes || e.state.keyframes;
}
function Fu(e, t) {
  for (const a of e.state.objects) {
...
function Ru(e) {
  ...
  const t = e.root.querySelector('[data-role="key-interp"]')?.value || e.root.querySelector('[data-role="interp"]')?.value || "ease", a = Le(e), o = _e(e), r = a ? { frame: e.frame, transform: tt(a), interpolation: t } : { frame: e.frame, camera: pe(e.camera), interpolation: t }, n = o.findIndex((i) => i.frame === e.frame);
...
function Du(e) {
  ...
  const o = Ue(e) || a.find((i) => i.frame === e.frame);
...
function Bu(e) {
  const t = Le(e), a = Ue(e) || _e(e).find((o) => o.frame === e.frame);
  e.copiedKeyframe = t ? { kind: "object", transform: tt(a?.transform || t), interpolation: a?.interpolation || e.root.querySelector('[data-role="interp"]')?.value || "ease" } : { kind: "camera", camera: pe(a?.camera || e.camera), interpolation: a?.interpolation || e.root.querySelector('[data-role="interp"]')?.value || "ease" }, e.setStatus(s(`Keyframe copied @ ${a?.frame ?? e.frame}`));
}
function qu(e) {
  if (!e.copiedKeyframe) return e.setStatus(s("Copy a keyframe first"));
  const t = Le(e), a = t ? "object" : "camera";
  if (e.copiedKeyframe.kind !== a) return e.setStatus(s(`Copy a ${a} keyframe first`));
  e.checkpoint("Paste keyframe");
  const o = t ? { frame: e.frame, transform: tt(e.copiedKeyframe.transform), interpolation: e.copiedKeyframe.interpolation } : { frame: e.frame, camera: pe(e.copiedKeyframe.camera), interpolation: e.copiedKeyframe.interpolation }, r = _e(e), n = r.findIndex((i) => i.frame === e.frame);
  n >= 0 ? r[n] = o : r.push(o), r.sort((i, c) => i.frame - c.frame), e.selectedKeyFrame = o.frame, e.editingKeyFrame = null, t ? (t.position = [...o.transform.position], t.rotation = [...o.transform.rotation], t.size = [...o.transform.size]) : e.camera = pe(o.camera), e.serialize(), e.refreshKeys(), e.render(), e.setStatus(s(`Keyframe pasted @ ${o.frame}`));
}
function Ue(e) {
  return _e(e).find((t) => t.frame === e.selectedKeyFrame) || null;
}
function Uu(e, t) {
...
const Xu = ["guides", "safe-areas", "resolution-gate", "aspect-ratio"];
function Ju(e) {
...
function eb(e) {
  const t = Le(e), a = Ue(e), o = e.root.querySelector('[data-role="key-editor"]');
...
function ab(e) {
  const t = Ue(e);
  if (!t) return;
  if (e.checkpoint("Edit keyframe"), e.editingKeyFrame = t.frame, Le(e)) {
    t.interpolation = e.root.querySelector('[data-role="key-interp"]').value, t.transform = tt(Le(e)), e.serialize(), e.setFrame(t.frame), e.setStatus(s(`Object keyframe updated @ ${t.frame}`));
    return;
  }
  const a = (o, r) => {
...
const Rr = ["pos_x", "pos_y", "pos_z"], mr = 1e-9, zo = ["auto", "aligned", "free", "corner"];
function Me(e, t = 0) {
  const a = Number(e);
...
function pr(e, t, a) {
  const o = Be(e), r = t ? Be(t) : o, n = a ? Be(a) : o, i = Math.max(mr, Me(e?.frame) - Me(t?.frame, Me(e?.frame) - 1)), c = Math.max(mr, Me(a?.frame, Me(e?.frame) + 1) - Me(e?.frame)), l = [0, 0, 0], p = [0, 0, 0];
  for (let m = 0; m < 3; m += 1) {
...
function nb(e, t = null, a = null) {
  const o = Bt(e), r = Be(e);
  if (o === "corner") {
    const l = Ys(e, t, a);
    return { in: go(r, l.in), out: go(r, l.out), mode: o };
  }
  const n = pr(e, t, a), i = (o === "free" || o === "aligned") && fr(e, "out") || n.out, c = (o === "free" || o === "aligned") && fr(e, "in") || n.in;
...
function wt(e, t, a) {
  const o = sb(e);
  for (let r = 0; r < 3; r += 1) {
    const n = Rr[r], i = o[n] && typeof o[n] == "object" ? o[n] : {};
...
function Xs(e, t, a) {
  const o = Be(e), r = nb(e, t, a);
  wt(e, "out", Wt(r.out, o)), wt(e, "in", Wt(r.in, o));
}
function ib(e, t, a, { prevKey: o = null, nextKey: r = null } = {}) {
  if (!e || t !== "in" && t !== "out") return e;
  let n = Bt(e);
  if (n === "corner") return e;
  n === "auto" && (n = "aligned", e.tangents = e.tangents && typeof e.tangents == "object" ? e.tangents : {}, e.tangents.spatial_mode = "aligned", Xs(e, o, r));
  const i = Be(e), c = Wt([
    Me(a?.[0]),
    Me(a?.[1]),
    Me(a?.[2])
  ], i);
  if (hr(e), wt(e, t, c), n === "aligned") {
    const l = t === "out" ? "in" : "out", p = fr(e, l) || (l === "out" ? pr(e, o, r).out : pr(e, o, r).in), m = Mn(c), f = Mn(p) || m || 1, d = m > mr ? Io(c, -f / m) : Io(p, 1);
    wt(e, l, d);
  }
  return e;
}
function cb(e, t, { prevKey: a = null, nextKey: o = null } = {}) {
  ...
  if (e.tangents = e.tangents && typeof e.tangents == "object" ? e.tangents : {}, e.tangents.spatial_mode = t, t === "auto") {
    if (e.tangents.channels) {
      for (const r of Rr) delete e.tangents.channels[r];
  ...
  if (t === "corner") {
    const r = Ys(e, a, o);
    return hr(e), wt(e, "out", r.out), wt(e, "in", r.in), e;
  }
  return hr(e), Xs(e, a, o), e;
}
function lb(e) {
  switch (e) {
    case "auto":
...
function mb(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: u, syncActiveCameraTrack: b, syncFromWidgets: v, bindEditorEvents: y, activateCamera: x, addCamera: S, deleteCamera: g, drawPreviewOverlays: _, duplicateCamera: $, maximizeCameraPreview: F, refreshCameraPreviews: z, refreshCameraSelectors: X, renameCamera: W, setPlayblastCamera: V, toggleCameraView: re, captureRealtime: j, makePlayblast: N, uploadDirectorPlayblast: U, waitForMediaFrame: H, computeAudioPeaks: te, loadAudioFile: A, releaseAudio: G, stopPlay: L, togglePlay: q, applyCameraPreset: J, applyCameraShake: ce, applyProxyPreset: se, clearViewportBgImage: ae, loadViewportBgFile: le, loadViewportBgSequence: be, drawCameraPath: fe, drawCard: ge, drawCube: ye, drawGrid: me, drawHuman: Ae, drawLine3D: ve, drawNull: xe, drawOverlays: ue, drawPointField: O, drawSpeedHeatmap: D, drawSphere: de, curveChannels: Se, drawCurveEditor: Ie, onCurvePointerDown: Ne, onCurvePointerMove: Oe, onCurvePointerUp: at, onTimelinePointerDown: Jt, onTimelinePointerMove: Zt, onTimelinePointerUp: Qt, refreshKeys: St, resetCurveZoom: jt, resetTimelineZoom: lt, setChannelFilter: _t, setCurveInterpolation: Ct, setTangentMode: Et, timelineFrameFromEvent: ea, toggleCurveHandles: At, zoomCurve: ta, drawTransformGizmo: aa, frameTarget: oa, gizmoAxes: ra, gizmoGeometry: na, onPointerDown: sa, onPointerMove: ia, onPointerUp: ca, onWheel: la, pickGizmo: da, pickSceneObject: ma, resetCamera: $t, setTransformMode: Tt, setViewMode: pa, viewportCamera: fa, loadCardFile: No, loadExecutionPreview: Fo, loadMediaUrl: ha, loadModelFile: ua, loadSelectedReference: ba, onModelLoaded: ga, restoreAssets: ya, syncUpstreamInputs: va, configureDomMedia: xa, refreshSetupDiagnostic: Mt, addMediaCard: wa, addPrimitive: ka, applyObjectAnimationFrame: Sa, beginCameraEdit: ja, beginObjectEdit: _a, commitCameraEdit: Ca, commitObjectEdit: Ea, copyKeyframe: Aa, deleteKeyframe: $a, deleteObject: Ta, duplicateObject: Ma, exitKeyEdit: Ia, finishCameraEdit: Oa, goToAdjacentKey: Pa, insertKeyframe: La, loadSelectedKeyView: za, pasteKeyframe: Na, playblastCameraAtFrame: Fa, refreshInspector: Ra, refreshKeyEditor: Ka, refreshObjects: Da, removeObjectResources: Ba, renameObject: qa, retimeSelectedKey: Ua, selectKeyframe: Wa, selectedKeyframe: Va, selectedObject: Ha, selectObjectAnimation: Ga, setKeyInterpolation: Ya, setObjectParent: Xa, timelineKeyframes: Ja, timelineObject: ot, toggleAutoKey: Za, toggleObject: Qa, updateCameraFromHud: eo, updateEditState: to, updateKeyVisualState: ao, updateSelectedKey: oo, updateSelectedObject: ro, clamp: It, cloneCamera: no, configureCore: so, defaultCamera: io, sampleCamera: Ot, sampleObjectTransform: Ro, sanitizeState: dt, worldTransform: We } = e;
  return {
    setSelectMode(P) {
      if (["object", "vertex", "edge", "face"].includes(P)) {
        this.state.select_mode = P, this.subSelection = null;
        for (const T of this.root.querySelectorAll("[data-select-mode]")) {
          const k = T.dataset.selectMode === P;
          T.classList.toggle("active", k), T.setAttribute("aria-pressed", String(k));
        }
        for (const T of this.root.querySelectorAll('[data-role="select-mode"]'))
          T.value = P;
        this.serialize(), this.syncFromWidgets(), this.render(), this.setStatus(`Select Mode: ${P.toUpperCase()}`);
      }
    },
    ...
    hideInternalWidgets() {
      for (const P of ["state_json", "recording_path", "card_asset"]) {
        const T = this.node.widgets?.find((k) => k.name === P);
    ...
    restoreHistorySnapshot(P) {
      ...
      const k = In(this.state), w = new Set(this.state.objects.map((ne) => ne.id));
      this.state = dt(T.state);
      const E = new Set(this.state.objects.map((ne) => ne.id));
      for (const ne of w) E.has(ne) || this.removeObjectResources(ne);
      this.frame = It(T.frame, 0, this.state.duration_frames - 1);
      const M = new Set(this.state.objects.map((ne) => ne.id)), R = Array.isArray(T.selectedObjectIds) ? T.selectedObjectIds : [T.selectedObjectId].filter(Boolean);
      this.selectedObjectIds = new Set(R.filter((ne) => M.has(ne))), this.selectedObjectId = this.selectedObjectIds.has(T.selectedObjectId) ? T.selectedObjectId : [...this.selectedObjectIds].at(-1) || null, this.selectedEntity = this.selectedObjectIds.size ? "object" : T.selectedEntity || "camera";
      const Z = new Set(this.timelineKeyframes().map((ne) => ne.frame)), B = Array.isArray(T.selectedKeyFrames) ? T.selectedKeyFrames : [T.selectedKeyFrame].filter((ne) => ne != null);
      this.selectedKeyFrames = new Set(B.filter((ne) => Z.has(ne))), this.selectedKeyFrame = this.selectedKeyFrames.has(T.selectedKeyFrame) ? T.selectedKeyFrame : [...this.selectedKeyFrames].at(-1) ?? null, this.subSelection = T.subSelection || null, this.camera = Ot(this.state, this.frame), Dt(this, this.activeCameraTrack(), this.camera, this.frame), this.cameraPreviewSignature = "", this.serialize(), k !== In(this.state) && this.restoreAssets(), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
    },
    checkpoint(P) {
      this.history.checkpoint(P);
    },
    undo() {
      const P = this.history.undo();
      P && this.setStatus(`Undo: ${P}`);
    },
    redo() {
      const P = this.history.redo();
      P && this.setStatus(`Redo: ${P}`);
    },
    bindEditorEvents() {
      y(this);
    },
    ...
    async renameCamera(P) {
      return W(this, P);
    },
    duplicateCamera(P) {
      $(this, P);
    },
    async deleteCamera(P) {
      return g(this, P);
    },
    activateCamera(P) {
      x(this, P);
    },
    setPlayblastCamera(P) {
      V(this, P);
    },
    closeMenus(P = null) {
      for (const T of this.root.querySelectorAll(".toolbar-menu")) T !== P && (T.open = !1);
    ...
    showContextMenu(P, T, k) {
      return this.contextMenu.show(P, T, k);
    },
    onContextMenu(P) {
      if (P.preventDefault(), P.stopPropagation(), P.stopImmediatePropagation?.(), P.altKey || this.state.navigation_profile === "simple" && P.target?.closest?.(".viewport-wrap")) return;
      const T = P.target, k = T.closest?.(".camera-preview-tile"), w = T.closest?.(".scene-item"), E = T.closest?.(".key");
      if (k) return this.openCameraContext(P, k.dataset.cameraId, !0);
      if (w?.dataset.cameraId) return this.openCameraContext(P, w.dataset.cameraId, !1);
      if (w?.dataset.objectId) return this.openObjectContext(P, w.dataset.objectId);
      if (E) {
        const M = this.timelineKeyframes().find((R) => R.frame === Number(E.dataset.keyFrame));
        return M && this.selectKeyframe(M), this.openTimelineContext(P, !0);
      }
      if (T.closest?.('[data-role="keys"]'))
        return this.setFrame(this.timelineFrameFromEvent(P, T.closest('[data-role="keys"]'))), this.openTimelineContext(P, !1);
      if (T.closest?.(".curve-editor")) return this.openCurveContext(P);
      if (T.closest?.(".viewport-wrap")) {
        const M = this.interactionElement.getBoundingClientRect(), R = (P.clientX - M.left) * this.canvas.width / Math.max(1, M.width), Z = (P.clientY - M.top) * this.canvas.height / Math.max(1, M.height), B = this.pickSceneObject([R, Z]);
        if (B) {
          if ((B.type === "object" || B.type === "object_keyframe") && B.object)
            return this.selectedEntity = "object", this.selectedObjectId = B.object.id, B.keyframe ? (this.setFrame(B.keyframe.frame), this.selectedKeyFrame = B.keyframe.frame) : this.selectedKeyFrame = B.object.keyframes?.find((ne) => ne.frame === this.frame)?.frame ?? null, this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), this.openObjectContext(P, B.object.id);
          if (["camera", "camera_target", "camera_keyframe"].includes(B.type) && B.camera)
            return this.selectedEntity = B.type === "camera_target" ? "camera_target" : "camera", this.selectedObjectId = null, this.activateCamera(B.camera.id), B.keyframe && (this.setFrame(B.keyframe.frame), this.selectedKeyFrame = B.keyframe.frame), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), B.type === "camera_keyframe" && B.keyframe ? this.openPathKeyContext(P, B.camera.id, B.keyframe.frame) : this.openCameraContext(P, B.camera.id, !1);
        }
        return this.openViewportContext(P);
      }
    },
    openViewportContext(P) {
      const T = this.selectedObject();
      this.showContextMenu(P, s("Viewport"), [
        {
          label: T ? `${s("Set key")} · ${T.name || T.type}` : `${s("Set key")} · ${this.activeCameraTrack().name}`,
          icon: "pi-key",
          shortcut: "I",
          run: () => this.insertKeyframe()
        },
        { label: s("Frame subject"), icon: "pi-search", shortcut: "F", run: () => this.frameTarget() },
        { label: s("Set camera target here"), icon: "pi-bullseye", help: s("Set camera Look-At target to this 3D point in the scene"), run: () => this.setTargetAtCursor(P) },
        null,
        {
          label: s("Add object"),
          icon: "pi-plus-circle",
    ...
    openObjectContext(P, T) {
      const k = this.state.objects.find((M) => M.id === T);
      if (!k) return;
      ...
      if (E >= 2 && this.selectedObjectIds.has(T)) {
        this.showContextMenu(P, `${E} ${s("objects selected")}`, [
      ...
      this.showContextMenu(P, k.name || k.type, [
        { label: s("Set key"), icon: "pi-key", shortcut: "I", run: () => this.insertKeyframe() },
        { label: s("Frame subject"), icon: "pi-search", shortcut: "F", run: () => this.frameTarget() },
        { label: s("Rename object…"), icon: "pi-pencil", run: () => this.renameObject(T) },
        { label: s("Duplicate object"), icon: "pi-copy", run: () => this.duplicateObject(T) },
        { label: k.enabled === !1 ? s("Show object") : s("Hide object"), icon: k.enabled === !1 ? "pi-eye" : "pi-eye-slash", run: () => this.toggleObject(T) },
        ...
        },
        {
          ...
          icon: "pi-bullseye",
          items: [
            { label: s("Camera tracks this object (Look-At)"), icon: "pi-bullseye", help: s("Lock camera live look-at tracking to this moving object"), run: () => this.aimAtSelectedObject(T) },
            ...
            null,
            { label: s("Select hierarchy"), icon: "pi-sitemap", shortcut: "Shift+G", help: s("Select this object and all descendants"), run: () => this.selectHierarchy(T) }
          ]
        },
        ...w ? [
          {
        ...
        null,
        { label: s("Reset entire animation"), icon: "pi-replay", danger: !0, help: s("Delete every animation key and return position/rotation to zero"), run: () => this.resetObjectAnimation(T) },
        null,
        { label: s("Delete object"), icon: "pi-trash", danger: !0, disabled: T === "subject", help: T === "subject" ? s("The canonical subject card cannot be deleted") : s("Delete this object and its animation keys"), run: () => this.deleteObject(T) }
      ]);
    },
    openCameraContext(P, T, k = !1) {
      const w = this.state.cameras.find((E) => E.id === T);
      w && (this.selectedEntity = "camera", this.selectedObjectId = null, this.activateCamera(T), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), this.showContextMenu(P, `${w.name}${k ? " preview" : ""}`, [
        { label: s("Edit this camera"), icon: "pi-video", run: () => this.activateCamera(T) },
        {
          label: s("Select whole path — move / scale / rotate"),
          icon: "pi-arrows-alt",
          disabled: (w.keyframes || []).length < 1,
          run: () => {
            this.activateCamera(T), this.selectCameraPath() && this.setStatus(`${w.name} · ${s("whole path selected — move / scale / rotate")}`);
          }
        },
        { label: s("Set as primary / playblast"), icon: "pi-star", disabled: T === this.state.playblast_camera_id, run: () => this.setPlayblastCamera(T) },
        ...
        { label: this.state.maximized_camera_id === T ? s("Restore preview size") : s("Maximize preview"), icon: "pi-window-maximize", run: () => this.maximizeCameraPreview(T) },
        null,
        {
          label: s("Shot order & handles"),
          icon: "pi-sliders-h",
          items: [
            { label: s("Shot: move earlier"), icon: "pi-arrow-up", disabled: this.state.cameras.findIndex((E) => E.id === T) <= 0, run: () => this.moveShot(T, -1) },
            { label: s("Shot: move later"), icon: "pi-arrow-down", disabled: this.state.cameras.findIndex((E) => E.id === T) >= this.state.cameras.length - 1, run: () => this.moveShot(T, 1) },
            null,
            { label: s("Shot handles…"), icon: "pi-sliders-h", run: () => this.editShotHandles(T) }
          ]
        },
        null,
        { label: s("Rename camera…"), icon: "pi-pencil", run: () => this.renameCamera(T) },
        { label: s("Duplicate camera"), icon: "pi-copy", run: () => this.duplicateCamera(T) },
        { label: s("Create camera from current view"), icon: "pi-plus", run: () => this.addCamera() },
        null,
        { label: s("Reset entire animation"), icon: "pi-replay", danger: !0, help: s("Delete every camera key and return to a static zero pose at frame 0"), run: () => this.resetCameraAnimation(T) },
        null,
        { label: s("Delete camera"), icon: "pi-trash", danger: !0, disabled: this.state.cameras.length <= 1, run: () => this.deleteCamera(T) }
      ]));
    },
    openPathKeyContext(P, T, k) {
      const w = this.state.cameras.find((Z) => Z.id === T);
      if (!w) return;
      ...
      const M = E ? Bt(E) : "auto", R = this.selectedKeyFrames?.size || 0;
      this.showContextMenu(P, `Path key F${k}`, [
    ...
    moveShot(P, T) {
      const k = this.state.cameras.findIndex((M) => M.id === P), w = k + T;
    ...
    async editShotHandles(P) {
      const T = this.state.cameras.find((M) => M.id === P);
      if (!T) return;
      const k = T.handles || { in: 0, out: 0 }, w = await i(t, s("Shot handles…"), "Handle frames: in,out", `${k.in},${k.out}`);
      if (w == null) return;
    ...
    openTimelineContext(P, T) {
      const k = this.selectedKeyFrames?.size || 0, w = this.selectedKeyframe(), E = w?.interpolation || "ease", M = w && Bt(w) || "auto", R = ["ease", "linear", "bezier", "smooth", "ease_in", "ease_out", "sine", "cubic", "quintic", "expo", "back"], Z = ["auto", "clamped", "vector", "free", "aligned", "flat"];
      this.showContextMenu(P, T ? `Keyframe F${this.selectedKeyFrame}` : `Timeline F${this.frame}`, [
        { label: s("Fit timeline view (F)"), icon: "pi-arrows-alt", shortcut: "F", run: () => lt(this) },
    ...
    addMarker() {
      ...
      this.checkpoint("Add marker"), this.state.markers = [...this.state.markers || [], { frame: this.frame, name: `Marker ${(this.state.markers || []).length + 1}`, color: "#f2d06b" }].sort((T, k) => T.frame - k.frame), this.serialize(), this.refreshKeys(), this.setStatus(`Marker @ F${this.frame}`);
    },
    removeNearestMarker() {
      const P = this.state.markers || [];
      if (!P.length) return;
      const T = P.reduce((k, w) => Math.abs(w.frame - this.frame) < Math.abs(k.frame - this.frame) ? w : k);
      this.checkpoint("Remove marker"), this.state.markers = P.filter((k) => k !== T), this.serialize(), this.refreshKeys(), this.setStatus(`Marker removed @ F${T.frame}`);
    },
    openCurveContext(P) {
      const T = this.selectedKeyFrames?.size || 0, k = T < 2 && !this.selectedKeyframe(), w = this.selectedKeyframe(), E = w?.interpolation || "ease", M = w && Bt(w) || "auto", R = ["bezier", "smooth", "linear", "ease_in", "ease_out", "ease", "sine", "cubic", "quintic", "expo", "back"], Z = ["auto", "clamped", "vector", "free", "aligned", "flat"];
      this.showContextMenu(P, s("Curve editor"), [
        ...
        null,
        { label: T >= 2 ? s("Delete {count} keys").replace("{count}", String(T)) : s("Delete selected key"), icon: "pi-trash", danger: !0, disabled: k, run: () => this.deleteSelectedKeyframes() }
      ]);
    },
    ...
    refitNode() {
      ...
      const P = this.node;
      try {
        if (P && typeof P.computeSize == "function" && typeof P.setSize == "function") {
          const T = P.computeSize();
          Array.isArray(T) && P.setSize([P.size?.[0] ?? T[0], T[1]]);
        }
    ...
    resizeCanvas() {
      const P = this.root.querySelector(".viewport-wrap");
      if (!P) return;
      const T = Math.min(2, window.devicePixelRatio || 1), k = P.clientWidth || 320, w = P.clientHeight || 180, E = Math.max(320, Math.round(k * T)), M = Math.max(180, Math.round(w * T));
      ...
      for (const R of this.cameraPreviewCanvases.values()) {
        const Z = R.clientWidth || 220, B = R.clientHeight || 124, ne = Math.max(T, db / Math.max(1, Z)), Ce = Math.max(1, Math.round(Z * ne)), Fe = Math.max(1, Math.round(B * ne));
        (R.width !== Ce || R.height !== Fe) && (R.width = Ce, R.height = Fe);
      }
...
function pb(e, t) {
  ...
  const o = yr();
  o.position = [0, 0, 0], o.target = [0, 0, -1], a.camera = pe(o), a.keyframes = [{ frame: 0, camera: pe(o), interpolation: "ease" }], e.state.active_camera_id = a.id, e.state.camera = pe(o), e.state.keyframes = a.keyframes, e.camera = pe(o), e.frame = 0, e.selectedEntity = "camera", e.selectedObjectId = null, e.selectedKeyFrame = 0, e.editingKeyFrame = null, e.cameraEditKey = null, e.cameraEditActive = !1, e.cameraPreviewSignature = "", Js(e), e.refreshCameraSelectors(), e.setStatus(s(`${a.name} animation reset`));
}
function fb(e, t) {
  const a = e.state.objects.find((o) => o.id === t);
  a && (e.checkpoint("Reset object animation"), a.keyframes = [], a.position = [0, 0, 0], a.rotation = [0, 0, 0], e.frame = 0, e.selectedEntity = "object", e.selectedObjectId = a.id, e.selectedKeyFrame = null, e.editingKeyFrame = null, Js(e), e.setStatus(s(`${a.name || a.type} animation reset`)));
}
const On = { motion: "motion", shot: "display", health: "health" }, hb = {
  object: "Object",
  camera: "Camera",
  camera_target: "Look-At Target",
  camera_path: "Camera Path"
}, ub = { motion: "Motion", shot: "Shot", health: "Health" }, bb = ["entity", "motion", "shot", "health"];
function Zs(e) {
  return e.inspectorMode && e.inspectorMode !== "entity" ? e.inspectorMode : "entity";
}
function gb(e) {
  const t = Zs(e);
  return On[t] ? On[t] : e.selectedEntity === "object" ? "scene" : "camera";
}
function yb(e) {
  return [
    e.selectedEntity || "",
...
function vb(e) {
  const t = yb(e);
  e._lastInspectorSelKey !== void 0 && e._lastInspectorSelKey !== t && (e.inspectorMode = "entity"), e._lastInspectorSelKey = t, Qs(e);
}
function Qs(e) {
  const t = gb(e);
  ...
  r && (r.textContent = o === "entity" ? s(hb[e.selectedEntity] || "Inspector") : s(ub[o] || "Inspector"));
}
function xb(e, t) {
  e.inspectorMode = bb.includes(t) ? t : "entity", Qs(e), e.render?.(), e.refitNode?.();
}
function wb(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: u, syncActiveCameraTrack: b, syncFromWidgets: v, bindEditorEvents: y, activateCamera: x, addCamera: S, deleteCamera: g, drawPreviewOverlays: _, duplicateCamera: $, maximizeCameraPreview: F, refreshCameraPreviews: z, refreshCameraSelectors: X, renameCamera: W, setPlayblastCamera: V, toggleCameraView: re, captureRealtime: j, makePlayblast: N, uploadDirectorPlayblast: U, waitForMediaFrame: H, computeAudioPeaks: te, loadAudioFile: A, releaseAudio: G, stopPlay: L, togglePlay: q, applyCameraPreset: J, applyCameraShake: ce, applyProxyPreset: se, clearViewportBgImage: ae, loadViewportBgFile: le, loadViewportBgSequence: be, drawCameraPath: fe, drawCard: ge, drawCube: ye, drawGrid: me, drawHuman: Ae, drawLine3D: ve, drawNull: xe, drawOverlays: ue, drawPointField: O, drawSpeedHeatmap: D, drawSphere: de, curveChannels: Se, drawCurveEditor: Ie, onCurvePointerDown: Ne, onCurvePointerMove: Oe, onCurvePointerUp: at, onTimelinePointerDown: Jt, onTimelinePointerMove: Zt, onTimelinePointerUp: Qt, refreshKeys: St, resetCurveZoom: jt, resetTimelineZoom: lt, setChannelFilter: _t, setCurveInterpolation: Ct, setTangentMode: Et, timelineFrameFromEvent: ea, toggleCurveHandles: At, zoomCurve: ta, drawTransformGizmo: aa, frameTarget: oa, gizmoAxes: ra, gizmoGeometry: na, onPointerDown: sa, onPointerMove: ia, onPointerUp: ca, onWheel: la, pickGizmo: da, pickSceneObject: ma, resetCamera: $t, setTransformMode: Tt, setViewMode: pa, viewportCamera: fa, loadCardFile: No, loadExecutionPreview: Fo, loadMediaUrl: ha, loadModelFile: ua, loadSelectedReference: ba, onModelLoaded: ga, restoreAssets: ya, syncUpstreamInputs: va, configureDomMedia: xa, refreshSetupDiagnostic: Mt, addMediaCard: wa, addPrimitive: ka, applyObjectAnimationFrame: Sa, beginCameraEdit: ja, beginObjectEdit: _a, commitCameraEdit: Ca, commitObjectEdit: Ea, copyKeyframe: Aa, deleteKeyframe: $a, deleteObject: Ta, deleteSelectedObjects: Ma, duplicateObject: Ia, exitKeyEdit: Oa, finishCameraEdit: Pa, goToAdjacentKey: La, insertKeyframe: za, loadSelectedKeyView: Na, pasteKeyframe: Fa, playblastCameraAtFrame: Ra, refreshInspector: Ka, refreshKeyEditor: Da, refreshObjects: Ba, removeObjectResources: qa, renameObject: Ua, retimeSelectedKey: Wa, selectKeyframe: Va, selectedKeyframe: Ha, selectedObject: Ga, selectObjectAnimation: Ya, setKeyInterpolation: Xa, setKeyTangentMode: Ja, setObjectParent: ot, timelineKeyframes: Za, timelineObject: Qa, toggleAutoKey: eo, toggleObject: to, updateCameraFromHud: ao, updateCameraRotationFromHud: oo, updateEditState: ro, updateKeyVisualState: It, updateSelectedKey: no, updateSelectedObject: so, clamp: io, cloneCamera: Ot, configureCore: Ro, defaultCamera: dt, sampleCamera: We, sampleObjectTransform: P, sanitizeState: T, worldTransform: k } = e;
  return {
    setChannelFilter(w) {
      _t(this, w);
    },
    setFrame(w, E = !1, M = !0) {
      this.frame = io(Math.round(w), 0, this.state.duration_frames - 1), this.editingKeyFrame !== this.frame && (this.editingKeyFrame = null), this.camera = We(this.activeCameraTrack(), this.frame, this.state.objects), Dt(this, this.activeCameraTrack(), this.camera, this.frame), this.applyObjectAnimationFrame();
      const R = this.dom ||= ws(this.root);
      ...
      for (const Q of R.cameraFocal) document.activeElement !== Q && (Q.value = _r(this.camera.fov));
      ...
      const B = Math.floor(Z / 60), ne = Math.floor(Z % 60), Ce = Math.floor(Z % 1 * 1e3), Fe = this.frame % Math.max(1, Math.round(this.state.fps)), rt = Math.floor(this.frame / this.state.fps);
      if ((R.time || this.root.querySelector('[data-role="time"]')).textContent = this.state.timecode_mode === "timecode" ? `${String(Math.floor(rt / 3600)).padStart(2, "0")}:${String(Math.floor(rt / 60) % 60).padStart(2, "0")}:${String(rt % 60).padStart(2, "0")}:${String(Fe).padStart(2, "0")}` : `${String(B).padStart(2, "0")}:${String(ne).padStart(2, "0")}.${String(Ce).padStart(3, "0")}`, M) this.refreshKeys();
      else {
        _o(this);
    ...
    setSpatialHandleMode(w) {
      ...
      this.checkpoint(s("Camera path handle: {mode}").replace("{mode}", w)), cb(M[R], w, {
        prevKey: M[R - 1] || null,
        nextKey: M[R + 1] || null
    ...
    transformCameraPath(w) {
      ...
      const M = xc(E.keyframes, { origin: wc(E.keyframes), ...w });
      return E.keyframes = M, E.id === this.state.active_camera_id && (this.state.keyframes = M), this.camera = We(E, this.frame, this.state.objects), E.camera = Ot(this.camera), this.serialize(), this.refreshKeys(), this.refreshInspector(), this.render(), this.renderCameraView?.(), !0;
    },
    toggleCurveHandles() {
      At(this);
    },
    ...
    playblastCameraAtFrame() {
      return Dt(this, d(this), Ra(this, We), this.frame);
    },
    viewportCamera() {
      return fa(this);
    },
    ...
    lookAtObject(w) {
      ...
      if (E) {
        ...
        this.camera = We(this.state, this.frame), this.serialize(), this.refreshKeys(), this.render(), this.setStatus(`Cameras look at ${E.name || E.type}`);
      }
    },
    setTransformMode(w) {
      Tt(this, w);
    ...
    refreshInspector() {
      this.perf && (this.perf.inspectorRefreshCount = (this.perf.inspectorRefreshCount || 0) + 1), Ka(this), vb(this);
    },
    setInspectorMode(w) {
      xb(this, w);
    },
    ...
    aimAtSelectedObject(w) {
      ...
      const Z = (M.type === "model" || M.type === "glb" ? this.webgl?.getObjectWorldCenter?.(M.id) : null) || (M.keyframes?.length ? P(M, this.frame).position : M.position || [0, 1.5, 0]);
    ...
    setCameraTrackingTarget(w) {
      ...
      const E = this.activeCameraTrack();
      E.target_object_id !== (w || null) && (E.aim_bone = null), E.target_object_id = w || null, E.id === this.state.active_camera_id && (this.state.target_object_id = w || null, this.state.aim_bone = E.aim_bone), this.camera = We(E, this.frame, this.state.objects), Dt(this, E, this.camera, this.frame), this.serialize(), this.refreshInspector(), this.render(), this.setStatus(w ? `Camera tracking: ${w}` : "Camera tracking disabled (manual target)");
    },
    bakeAimToKeyframes() {
      ...
      for (const Z of w.keyframes) {
        const B = (M.type === "model" || M.type === "glb") && R && !M.keyframes?.length ? R : M.keyframes?.length ? P(M, Z.frame).position : M.position || [0, 1.5, 0];
        Z.camera.target = [...B];
      }
...
function kb(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: u, syncActiveCameraTrack: b, syncFromWidgets: v, bindEditorEvents: y, activateCamera: x, addCamera: S, deleteCamera: g, drawPreviewOverlays: _, duplicateCamera: $, maximizeCameraPreview: F, refreshCameraPreviews: z, refreshCameraSelectors: X, renameCamera: W, setPlayblastCamera: V, toggleCameraView: re, captureRealtime: j, makePlayblast: N, uploadDirectorPlayblast: U, waitForMediaFrame: H, computeAudioPeaks: te, loadAudioFile: A, releaseAudio: G, stopPlay: L, togglePlay: q, applyCameraPreset: J, applyCameraShake: ce, applyProxyPreset: se, clearViewportBgImage: ae, loadViewportBgFile: le, loadViewportBgSequence: be, drawCameraPath: fe, drawCard: ge, drawCube: ye, drawGrid: me, drawHuman: Ae, drawLine3D: ve, drawNull: xe, drawOverlays: ue, drawPointField: O, drawSpeedHeatmap: D, drawSphere: de, curveChannels: Se, drawCurveEditor: Ie, fitCurveView: Ne, onCurveDoubleClick: Oe, onCurvePointerDown: at, onCurvePointerMove: Jt, onCurvePointerUp: Zt, onTimelinePointerDown: Qt, onTimelinePointerMove: St, onTimelinePointerUp: jt, refreshKeys: lt, resetCurveZoom: _t, resetTimelineZoom: Ct, setChannelFilter: Et, setCurveInterpolation: ea, setTangentMode: At, timelineFrameFromEvent: ta, toggleCurveHandles: aa, zoomCurve: oa, drawTransformGizmo: ra, frameTarget: na, gizmoAxes: sa, gizmoGeometry: ia, onPointerDown: ca, onPointerMove: la, onPointerUp: da, onWheel: ma, pickGizmo: $t, pickSceneObject: Tt, resetCamera: pa, setTransformMode: fa, setViewMode: No, viewportCamera: Fo, loadCardFile: ha, loadExecutionPreview: ua, loadMediaUrl: ba, loadModelFile: ga, loadSelectedReference: ya, onModelLoaded: va, restoreAssets: xa, syncUpstreamInputs: Mt, configureDomMedia: wa, refreshSetupDiagnostic: ka, addMediaCard: Sa, addPrimitive: ja, applyObjectAnimationFrame: _a, beginCameraEdit: Ca, beginObjectEdit: Ea, commitCameraEdit: Aa, commitObjectEdit: $a, copyKeyframe: Ta, deleteKeyframe: Ma, deleteObject: Ia, duplicateObject: Oa, exitKeyEdit: Pa, finishCameraEdit: La, goToAdjacentKey: za, insertKeyframe: Na, loadSelectedKeyView: Fa, pasteKeyframe: Ra, playblastCameraAtFrame: Ka, refreshInspector: Da, refreshKeyEditor: Ba, refreshObjects: qa, removeObjectResources: Ua, renameObject: Wa, retimeSelectedKey: Va, selectKeyframe: Ha, selectedKeyframe: Ga, selectedObject: Ya, selectObjectAnimation: Xa, setKeyInterpolation: Ja, setObjectParent: ot, timelineKeyframes: Za, timelineObject: Qa, toggleAutoKey: eo, toggleObject: to, updateCameraFromHud: ao, updateEditState: oo, updateKeyVisualState: ro, updateSelectedKey: It, updateSelectedObject: no, clamp: so, cloneCamera: io, configureCore: Ot, defaultCamera: Ro, sampleCamera: dt, sampleObjectTransform: We, sanitizeState: P, worldTransform: T } = e;
  return {
    setTargetAtCursor(k) {
      if (!k) return;
...
const Eb = "http://www.w3.org/2000/svg", bt = 26, Pn = 17, Ab = 5.4;
function gt(e, t) {
  const a = document.createElementNS(Eb, e);
...
function $b(e) {
  ...
  for (const n of _b(jb(a))) {
    const i = bt + n.x * Pn, c = bt + n.y * Pn, l = Cb(n.depth);
    t.appendChild(gt("line", {
      x1: bt,
      y1: bt,
      x2: i,
      y2: c,
...
function Mb(e) {
  ...
  for (const r of e.state.motion_layers || []) {
    ...
    const n = Tb(e.state, r, e.frame, a, o);
    if (n.length) {
...
const Ib = ["world_point", "object_point", "camera_field"], ei = {
  manual_2d: "DRAW",
  object_point: "OBJECT",
  world_point: "WORLD",
...
function Pb(e, t) {
  if (Ib.includes(t.source_kind)) {
    const a = Sr(e, t.source, 0, e.width || 1280, e.height || 720);
...
function Nb(e) {
  ...
  n("motion-sel-name", a.label), n("motion-sel-type", ei[a.source_kind] || "TRACK"), n("motion-sel-binding", Ob(e.state, a)), n("motion-sel-start", r.length ? Math.min(...r) : 0), n("motion-sel-end", r.length ? Math.max(...r) : 0);
...
function Kb(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: u, syncActiveCameraTrack: b, syncFromWidgets: v, bindEditorEvents: y, activateCamera: x, addCamera: S, deleteCamera: g, drawPreviewOverlays: _, duplicateCamera: $, maximizeCameraPreview: F, refreshCameraPreviews: z, refreshCameraSelectors: X, renameCamera: W, setPlayblastCamera: V, toggleCameraView: re, captureRealtime: j, makePlayblast: N, uploadDirectorPlayblast: U, waitForMediaFrame: H, computeAudioPeaks: te, loadAudioFile: A, releaseAudio: G, stopPlay: L, togglePlay: q, applyCameraPreset: J, applyCameraShake: ce, applyProxyPreset: se, clearViewportBgImage: ae, loadViewportBgFile: le, loadViewportBgSequence: be, drawCameraPath: fe, drawCard: ge, drawCube: ye, drawCylinder: me, drawGrid: Ae, drawHuman: ve, drawLine3D: xe, drawNull: ue, drawOverlays: O, drawPointField: D, drawSpeedHeatmap: de, drawSphere: Se, drawTorus: Ie, curveChannels: Ne, drawCurveEditor: Oe, onCurvePointerDown: at, onCurvePointerMove: Jt, onCurvePointerUp: Zt, onTimelinePointerDown: Qt, onTimelinePointerMove: St, onTimelinePointerUp: jt, refreshKeys: lt, resetCurveZoom: _t, resetTimelineZoom: Ct, setChannelFilter: Et, setCurveInterpolation: ea, setTangentMode: At, timelineFrameFromEvent: ta, toggleCurveHandles: aa, zoomCurve: oa, drawTransformGizmo: ra, frameTarget: na, gizmoAxes: sa, gizmoGeometry: ia, onPointerDown: ca, onPointerMove: la, onPointerUp: da, onWheel: ma, pickGizmo: $t, pickSceneObject: Tt, resetCamera: pa, setTransformMode: fa, setViewMode: No, viewportCamera: Fo, loadCardFile: ha, loadExecutionPreview: ua, loadMediaUrl: ba, loadModelFile: ga, loadSelectedReference: ya, onModelLoaded: va, restoreAssets: xa, syncUpstreamInputs: Mt, configureDomMedia: wa, refreshSetupDiagnostic: ka, addMediaCard: Sa, addPrimitive: ja, applyObjectAnimationFrame: _a, beginCameraEdit: Ca, beginObjectEdit: Ea, commitCameraEdit: Aa, commitObjectEdit: $a, copyKeyframe: Ta, deleteKeyframe: Ma, deleteObject: Ia, duplicateObject: Oa, exitKeyEdit: Pa, finishCameraEdit: La, goToAdjacentKey: za, insertKeyframe: Na, loadSelectedKeyView: Fa, pasteKeyframe: Ra, playblastCameraAtFrame: Ka, refreshInspector: Da, refreshKeyEditor: Ba, refreshObjects: qa, removeObjectResources: Ua, renameObject: Wa, retimeSelectedKey: Va, selectKeyframe: Ha, selectedKeyframe: Ga, selectedObject: Ya, selectObjectAnimation: Xa, setKeyInterpolation: Ja, setObjectParent: ot, timelineKeyframes: Za, timelineObject: Qa, toggleAutoKey: eo, toggleObject: to, updateCameraFromHud: ao, updateEditState: oo, updateKeyVisualState: ro, updateSelectedKey: It, updateSelectedObject: no, clamp: so, cloneCamera: io, configureCore: Ot, defaultCamera: Ro, sampleCamera: dt, sampleObjectTransform: We, sanitizeState: P, worldTransform: T } = e;
  return {
    ...
    renderViewportOnly() {
      ...
      if (k.fillStyle = this.state.viewport_bg_color || "#121212", k.fillRect(0, 0, w, E), this.viewportBgSequenceImages && this.viewportBgSequenceImages.length) {
        const oe = this.frame % this.viewportBgSequenceImages.length, Ve = this.viewportBgSequenceImages[oe];
        if (Ve?.complete && Ve.naturalWidth)
          try {
            k.drawImage(Ve, 0, 0, w, E);
          } catch {
          }
      ...
      const M = this.state.render_mode, R = this.viewportCamera(), Z = this.state.objects.some((oe) => oe.parent_id) ? this.state.objects.map((oe) => oe.parent_id ? { ...oe, ...T(this.state.objects, oe) } : oe) : this.state.objects, B = (this.viewportBgSequenceImages || []).map((oe) => oe.src), ne = this.viewportBgImage?.src || "", Ce = this.pendingExtractorImport, Fe = Ce ? [...this.state.cameras, {
        id: "__extractor_preview__",
        name: Ce.label,
        color: "#9ca3af",
        camera: Ce.track.keyframes[0]?.camera,
        keyframes: Ce.track.keyframes
      }] : this.state.cameras, rt = {
        ...this.state,
        cameras: Fe,
        objects: Z,
        ...
        __omnicamRevision: `${this.renderRevision || 0}:${Ce?.fingerprint || ""}`
      };
      let Q = !1;
      if (this.webgl)
        try {
          const oe = this.recording ? 1 : this.webgl.supersampleFactor?.() ?? 1, Ve = oe > 1 ? Math.min(oe, 4096 / Math.max(1, w, E)) : 1, co = Ve > 1 ? Math.round(w * Ve) : w, Ko = Ve > 1 ? Math.round(E * Ve) : E;
          this.webgl.render(rt, R, this.cardMediaById, co, Ko, this.modelUrlsById, this.frame, this.recording, this.selectedEntity, this.selectedObjectId, this.subSelection, this.selectedKeyFrame ?? null), k.imageSmoothingEnabled = !0, k.imageSmoothingQuality = "high", co !== w || Ko !== E ? k.drawImage(this.webgl.canvas, 0, 0, co, Ko, 0, 0, w, E) : k.drawImage(this.webgl.canvas, 0, 0, w, E), Q = !0;
        } catch (oe) {
      ...
      !this.recording && this.state.speed_heatmap && this.drawSpeedHeatmap(), !this.recording && eh(this), this.drawOverlays(), Mb(this), this.state.show_gizmo && $b(this), this.labelOverlay?.update(), this.rigOverlay?.update(), this.perf && (this.perf.viewportRenderCount = (this.perf.viewportRenderCount || 0) + 1);
    },
    ...
    requestUiUpdate(k = C.viewport, w = "unknown") {
      (this.renderReasons ||= /* @__PURE__ */ new Set()).add(w), this.uiDirtyMask = Im(this.uiDirtyMask, k), this.renderInvalidations = (this.renderInvalidations || 0) + 1, !this.renderScheduled && (this.renderScheduled = !0, this.renderFrame = requestAnimationFrame(() => {
        if (this.renderScheduled = !1, this.disposed) return;
        const E = this.uiDirtyMask || C.viewport;
        this.uiDirtyMask = 0, this.lastRenderReasons = [...this.renderReasons || []], this.renderReasons?.clear(), this.rendersCoalesced = (this.rendersCoalesced || 0) + 1, this.perf && (this.perf.renderCount = (this.perf.renderCount || 0) + 1), ft(E, C.outliner) && this.refreshObjects(), ft(E, C.timeline) && this.refreshKeys(), ft(E, C.inspector) && this.refreshInspector(), ft(E, C.viewport) && this.renderViewportOnly(), ft(E, C.previews) && this.renderCameraView(), ft(E, C.motion) && this.renderMotionUiOnly();
      }));
    },
    renderCameraView() {
      if (this.perf && (this.perf.previewRenderCount = (this.perf.previewRenderCount || 0) + 1), this.state.camera_view_visible) {
        ...
        for (const R of w) {
          ...
          const ne = Z.width, Ce = Z.height, Fe = this.root.querySelector(`[data-camera-frame="${R.id}"]`);
          if (Fe && (Fe.textContent = `F${this.frame}`), E && R.id !== this.state.active_camera_id && R !== M) continue;
          const rt = Dt(this, R, dt(R, this.frame, this.state.objects), this.frame);
          if (B.fillStyle = "#111", B.fillRect(0, 0, ne, Ce), this.cameraWebgl)
            try {
              this.cameraWebgl.render({ ...this.state, keyframes: [], playblast_grid: !1, viewport_bg_image: this.viewportBgImage?.src || "", viewport_bg_sequence: (this.viewportBgSequenceImages || []).map((Q) => Q.src), __omnicamRevision: this.renderRevision || 0 }, rt, this.cardMediaById, ne, Ce, this.modelUrlsById, this.frame, !0), B.drawImage(this.cameraWebgl.canvas, 0, 0, ne, Ce);
            } catch (Q) {
    ...
    dispose() {
      this.disposed || (this.disposed = !0, this.agentBridge?.dispose?.(), Sc(this), jc(), rl(this), this.backgroundRequestId = (this.backgroundRequestId || 0) + 1, this.upstreamSyncId = (this.upstreamSyncId || 0) + 1, this.stopPlay(), clearTimeout(this.previewClickTimer), clearTimeout(this.connectionTimer), cancelAnimationFrame(this.restoreFrame), cancelAnimationFrame(this.serializeFrame), cancelAnimationFrame(this.resizeFrame), cancelAnimationFrame(this.renderFrame), this.abortController?.abort(), this.upstreamFetchController?.abort(), this.resizeObserver?.disconnect(), this.contextMenu?.dispose(), this.webgl?.dispose(), this.cameraWebgl?.dispose(), G(this), Eh(this), this.objectUrls.clear(), this.cardMediaById.clear(), this.cardMediaAssetById?.clear?.(), this.modelUrlsById.clear(), this.modelInfoById.clear());
    }
  };
}
const ti = 1e-9;
...
function Kr(e, t) {
  const a = e.map((i) => Db(i, t)), o = Bb(a), r = e.map((i) => i.frame), n = Math.max(1, r[r.length - 1] - r[0]);
  return a.map((i, c) => [
    (r[c] - r[0]) / n,
...
function Ub(e, t, { tolerance: a = 0.02, keepFrames: o = [] } = {}) {
  ...
  const n = Kr(r, t), i = /* @__PURE__ */ new Set(), c = new Set(o);
  r.forEach((m, f) => {
...
function Zb() {
  return {
    ...
    resolveSelectedFrames() {
      const e = new Set(_e(this).map((a) => a.frame));
    ...
    _activeTrack() {
      ...
      return {
        kind: "camera",
        write: (a) => {
          t.keyframes = a, this.state.keyframes = a, ar(this);
        }
      };
    },
    deleteSelectedKeyframes() {
      ...
      if (!e.length) {
        const l = _e(this).find((p) => p.frame === this.frame);
        l && (e = [l.frame]);
      }
      if (!e.length) return this.setStatus(s("Select a keyframe to delete"));
      const t = this._activeTrack(), a = _e(this), o = t.kind === "camera" ? 1 : 0, { keys: r, removed: n } = Hb(a, e, { minKeys: o });
    ...
    nudgeSelectedKeyframes(e) {
      ...
      const a = this._activeTrack(), o = Math.max(0, this.state.duration_frames - 1), r = Gb(_e(this), t, e, { lastFrame: o });
    ...
    setSelectedKeysInterpolation(e) {
      ...
      this.checkpoint(s("Interpolation on {n} keys").replace("{n}", t.length)), a.write(Yb(_e(this), t, e)), this.serialize(), this.refreshKeys(), this.refreshKeyEditor(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} interpolation on {n} keys").replace("{mode}", e.replace(/_/g, " ")).replace("{n}", t.length));
    },
    setSelectedKeysTangentMode(e) {
      const t = this.resolveSelectedFrames();
      if (t.length < 2) return this.setTangentMode(e);
      const a = this._activeTrack(), o = ct(this).map((r) => r.id);
      this.checkpoint(s("Tangents on {n} keys").replace("{n}", t.length)), a.write(Xb(_e(this), t, e, o)), this.serialize(), this.refreshKeys(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} tangents on {n} keys").replace("{mode}", e).replace("{n}", t.length));
    },
    /**
    ...
    simplifyActiveKeys({ mode: e = "simplify", tolerance: t = 0, target: a = 0, scope: o = "camera", fromKeys: r = null, silent: n = !1 } = {}) {
      ...
      const l = this.resolveSelectedFrames(), p = o !== "all_cameras" && l.length >= 2 ? [l[0], l.at(-1)] : null, m = p ? [] : l, f = (u) => {
        const b = [...u].sort((F, z) => F.frame - z.frame), v = p ? p[0] : -1 / 0, y = p ? p[1] : 1 / 0, x = b.filter((F) => F.frame < v), S = b.filter((F) => F.frame >= v && F.frame <= y), g = b.filter((F) => F.frame > y);
        let _ = S, $ = 0;
        if (S.length > 2) {
          const F = e === "reduce" ? Wb(S, i, { target: a || Math.ceil(S.length / 2), keepFrames: m }) : e === "clean" ? Vb(S, i, { keepFrames: m }) : Ub(S, i, { tolerance: t * Jb, keepFrames: m });
          _ = F.keys, $ = F.removed;
        }
        return { keys: [...x, ..._, ...g].sort((F, z) => F.frame - z.frame), removed: $ };
      };
      let d = 0;
      const h = c.map((u) => {
      ...
      return ar(this), this.selectedKeyFrame = null, this.selectedKeyFrames = /* @__PURE__ */ new Set(), this.camera = $e(this.state, this.frame), this.applyObjectAnimationFrame(), this.serialize(), this.refreshKeys(), this.setFrame(this.frame, !1, !1), this.render(), n || this.setStatus(d ? s("Removed {n} keyframes").replace("{n}", d) : s("No keyframes to remove")), d;
    },
...
class ai {
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-DYJNFJKU.js"));
    } catch (a) {
    ...
    if (!this.disposed) {
      ...
      _c(this), this.resizeCanvas(), this.render(), this.renderCameraView();
    }
  }
}
const yo = { app: zn, api: et, EditorHistory: ps, ContextMenuController: Zn, initializeTooltips: sl, promptText: Vt, ObjectUrlRegistry: fs, buildRoot: hs, dispatchDirectorKey: Cc, activeCameraTrack: tr, bindWidgetCallbacks: il, playblastCameraTrack: Jn, restoreFromWidgets: cl, serializeEditorState: ll, syncActiveCameraTrack: ar, syncFromWidgets: dl, bindEditorEvents: hh, activateCamera: ml, addCamera: pl, deleteCamera: fl, drawPreviewOverlays: hl, duplicateCamera: ul, maximizeCameraPreview: bl, refreshCameraPreviews: gl, refreshCameraSelectors: yl, renameCamera: vl, setPlayblastCamera: xl, toggleCameraView: wl, captureRealtime: Fs, makePlayblast: Bh, uploadDirectorPlayblast: Rs, waitForMediaFrame: Ns, computeAudioPeaks: Is, loadAudioFile: jh, releaseAudio: $o, stopPlay: So, togglePlay: wh, applyCameraPreset: zp, applyCameraShake: Np, applyProxyPreset: Fp, clearViewportBgImage: Vh, loadViewportBgFile: Uh, loadViewportBgSequence: Wh, drawCameraPath: su, drawCard: nu, drawCube: Qh, drawCylinder: au, drawGrid: Yh, drawHuman: tu, drawLine3D: ie, drawNull: ru, drawOverlays: cu, drawPointField: Zh, drawSpeedHeatmap: iu, drawSphere: eu, drawTorus: ou, curveChannels: ct, drawCurveEditor: od, fitCurveView: ss, onCurveDoubleClick: td, onCurvePointerDown: Vl, onCurvePointerMove: Hl, onCurvePointerUp: Gl, onTimelinePointerDown: Ec, onTimelinePointerMove: Ac, onTimelinePointerUp: $c, refreshKeys: yd, resetCurveZoom: ad, resetTimelineZoom: Tc, setChannelFilter: Xl, setCurveInterpolation: Yl, setTangentMode: Jl, timelineFrameFromEvent: ur, toggleCurveHandles: Zl, zoomCurve: ed, drawTransformGizmo: Mc, frameTarget: Ic, gizmoAxes: Oc, gizmoGeometry: Pc, onPointerDown: Lc, onPointerMove: zc, onPointerUp: Nc, onWheel: Fc, pickGizmo: Rc, pickSceneObject: Kc, resetCamera: Dc, setTransformMode: Bc, setViewMode: qc, viewportCamera: Uc, loadCardFile: Ih, loadExecutionPreview: Oh, loadMediaUrl: zs, loadModelFile: Mh, loadSelectedReference: Ph, onModelLoaded: Th, restoreAssets: $h, syncUpstreamInputs: Lh, configureDomMedia: Os, refreshSetupDiagnostic: mu, addMediaCard: ku, addPrimitive: yu, applyObjectAnimationFrame: Fu, beginCameraEdit: Wu, beginObjectEdit: Vs, commitCameraEdit: Vu, commitObjectEdit: _u, copyKeyframe: Bu, deleteKeyframe: Du, deleteObject: Ws, deleteSelectedObjects: wu, duplicateObject: Us, exitKeyEdit: Gu, finishCameraEdit: Hu, goToAdjacentKey: rb, insertKeyframe: Ru, loadSelectedKeyView: ob, pasteKeyframe: qu, playblastCameraAtFrame: Nu, refreshInspector: Su, refreshKeyEditor: eb, refreshObjects: qs, removeObjectResources: Mu, renameObject: vu, retimeSelectedKey: tb, selectKeyframe: Uu, selectedKeyframe: Ue, selectedObject: Xt, selectObjectAnimation: Tu, setKeyInterpolation: Ku, setKeyTangentMode: Qu, setObjectParent: $u, timelineKeyframes: _e, timelineObject: Le, toggleAutoKey: Yu, toggleObject: xu, updateCameraFromHud: Au, updateCameraRotationFromHud: Eu, updateEditState: Ju, updateKeyVisualState: Zu, updateSelectedKey: ab, updateSelectedObject: ju, clamp: Y, cloneCamera: pe, configureCore: Xn, defaultCamera: yr, sampleCamera: $e, sampleObjectTransform: Oo, sanitizeState: xr, worldTransform: wr };
Object.assign(
  ai.prototype,
  mb(yo),
  wb(yo),
...
function Qb(e) {
  ...
  const t = new ai(e);
  vo("director:constructor:complete", e), np(t);
  try {
    t.agentBridge = pp(t, e, et);
  } catch (m) {
  ...
  try {
    t.assetBrowser = Ep(t, {
      ...
      onAgentFirstOpen: async () => {
        if (Zo())
          try {
            const { createDirectorAgentPanel: m } = await import("./chunk-Bl2nWFVL.js");
            t.agentPanel = m(t);
          } catch (m) {
  ...
  try {
    t.characterRuntime = $p(t), t.rigMapper = Mp(t), t.poseEditor = Pp(t), t.motionEditor = Lp(t);
  } catch (m) {
  ...
  }, t.unwatchGraphConnections = nl(e, i);
  const l = e.onRemoved;
