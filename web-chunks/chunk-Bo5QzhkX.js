...
import { u as p, v as rt, bI as Ct, x as Mt } from "./chunk-uqYr4LOd.js";
import { d as Tt } from "./chunk-eq1tqQ9i.js";
import { h as at, D as Rt, L as Nt, E as $t } from "./chunk-Cq34vFsW.js";
import { a as At, F as Ft, S as Pt, m as nt, c as it } from "./chunk-sVL03mTG.js";
import { c as Lt, q as It, a as st, r as Ot, s as Dt, b as qt, d as jt, e as Vt, p as Ut, f as Bt } from "./chunk-DKoMQt-J.js";
function Wt(e) {
...
class ue {
  ...
  async ensurePreview() {
    return this.preview || this.disposed ? this.preview : (this.previewLoad ||= import("./chunk-C2WHVpLg.js").then(({ TrackViewer: t }) => {
...
function xo(e) {
  return import("./chunk-C2WHVpLg.js").then(({ TrackViewer: t }) => (e.viewerLoad = null, e.disposed || e.viewer || (e.viewer = new t(e.$("track-canvas")), e.pushTracksToViewer()), e.viewer)).catch((t) => (e.viewerLoad = null, console.warn("OmniCam track viewer unavailable", t), null));
}
function et(e) {
  const t = e.$("frame");
