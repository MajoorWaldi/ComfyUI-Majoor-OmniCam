...
import { s as $e, c as Y, t as he, a as s, o as Nn, b as ur, d as tt, e as pe, f as Oo, r as oi, g as br, h as Fn, i as ri, j as ni, k as si, l as ii, m as gr, n as yr, I as xo, D as ci, p as vr, q as li, w as di, u as jo, v as Rn, x as mi, y as xr, z as Zo, A as Br, B as Kn, C as Qo, E as Dn, F as Bn, G as qn, H as Un, J as er, K as Do, L as qr, O as Ur, R as Wn, M as pi, N as fi, P as hi, Q as wr, S as ui, T as bi, U as gi, V as yi, W as vi, X as kr, Y as xi, Z as wi, _ as ki, $ as Si, a0 as ji, a1 as _i, a2 as Ci, a3 as Ei, a4 as Ai, a5 as $i, a6 as Ti, a7 as Mi, a8 as Ii, a9 as Oi, aa as Pi, ab as Li, ac as zi, ad as Ni, ae as Fi, af as Ri, ag as Ki, ah as Di, ai as Bi, aj as qi, ak as Ui, al as Wi, am as Vi, an as Hi, ao as Gi, ap as Yi, aq as Xi, ar as Ji, as as Zi, at as Qi, au as ec, av as tc, aw as ac, ax as oc, ay as rc, az as nc, aA as sc, aB as ic, aC as cc, aD as Vn, aE as Hn, aF as lc, aG as Bo, aH as dc, aI as mc, aJ as pc, aK as fc, aL as hc, aM as qe, aN as uc, aO as Gn, aP as Sr, aQ as bc, aR as gc, aS as yc, aT as Yn, aU as Xe, aV as Ge, aW as vc, aX as Wr, aY as jr, aZ as xc, a_ as wc, a$ as kc, b0 as Sc, b1 as jc, b2 as _c, b3 as Cc, b4 as Xn, b5 as Ec, b6 as Ac, b7 as $c, b8 as Tc, b9 as Mc, ba as Ic, bb as Oc, bc as Pc, bd as Lc, be as zc, bf as Nc, bg as Fc, bh as Rc, bi as Kc, bj as Dc, bk as Bc, bl as qc, bm as Uc, bn as Wc } from "./chunk-CK5vDFcl.js";
import { L as Vc, a as Hc, p as Vt, f as _r, b as Gc, S as Yc, c as Vr, d as Xc, e as Jc, r as Zc, g as Qc, n as el, C as Hr, h as Ht, o as tl, i as al, s as ol, j as rl, k as Jn, l as nl, m as tr, q as ar, w as sl, t as Zn, u as il, v as cl, x as ll, y as dl, z as ml, A as pl, B as fl, D as hl, E as ul, F as bl, G as gl, H as yl, I as vl, J as xl, K as wl, M as kl } from "./chunk-DapNKS9E.js";
import { S as Sl, b as jl, p as _l, m as Cl, l as El, u as Al } from "./chunk-BOI_2OKd.js";
import { R as $l } from "./vendor-three-ChNUWu3S.js";
function Pt(e, t = 0) {
  return Math.sin(e * 1.7 + t * 3.1) * 0.5 + Math.sin(e * 3.3 + t * 5.7) * 0.3 + Math.sin(e * 7.9 + t * 11.3) * 0.2;
}
function Tl(e, { type: t = "handheld_subtle", intensity: a = 1, duration_frames: o = null, subdivide: r = !0 } = {}) {
...
const es = [
  ...
  },
  {
    ...
    label: "Look At",
    color: "#f0a742",
    changed: (e, t) => Il(e?.target, t?.target),
    read: (e) => e?.target
  },
  {
    id: "focal_length",
...
function _o(e) {
  ...
  for (const a of [".oc-playhead-head", '[data-role="dope-playhead"]', ".oc-gdope-playhead", ".oc-sequence-playhead"])
    for (const o of e.root.querySelectorAll(a)) Ll(o, t);
}
function zl(e, t, a) {
...
function ts(e) {
  ...
  a.delete("camera");
  const o = e.timelineKeyframes() || [], r = Pl(o, a), n = Fl(e, r);
  if (t.dataset.signature !== n) {
    t.dataset.signature = n, t.replaceChildren();
    const i = (c) => he(e, c);
    for (const c of r) {
      const l = document.createElement("div");
      l.className = "oc-dope-row", l.dataset.channel = c.id, l.style.setProperty("--channel-color", c.color), zl(l, c.frames, i), Nl(e, l, c, o, i), t.appendChild(l);
    }
  }
...
function ql(e, t = 5) {
  ...
  return (Bl.find((n) => n >= r) ?? 10) * o;
}
function Ul(e, t) {
  const a = Math.max(0, Math.min(4, Math.ceil(-Math.log10(t))));
  return e.toFixed(a);
}
function Wl(e, { left: t, right: a, top: o, width: r, graphWidth: n, graphHeight: i, height: c, timeMin: l, timeMax: p, totalDuration: m, xFor: f, frame: d }) {
  const h = rs(p - l, n);
...
function Vl(e, { left: t, right: a, top: o, width: r, graphHeight: n, minimum: i, maximum: c, yFor: l }) {
  ...
  for (let m = Math.ceil(i / p) * p; m <= c; m += p) {
    const f = l(m);
    f < o - 1 || f > o + n + 1 || (e.beginPath(), e.moveTo(t, f), e.lineTo(r - a, f), e.stroke(), e.fillText(Ul(m, p), 4, f + 3));
  }
}
function Cr(e, t) {
...
function rd(e) {
  ...
  if (n.fillStyle = "#111114", n.fillRect(0, 0, a, o), n.strokeStyle = "#222228", n.lineWidth = 1, n.font = "9px system-ui, -apple-system, sans-serif", n.fillStyle = "#6e727a", Wl(n, {
    left: p,
    right: m,
    top: f,
    width: a,
    ...
    xFor: U,
    frame: e.frame
  }), Vl(n, { left: p, right: m, top: f, width: a, graphHeight: u, minimum: X, maximum: W, yFor: H }), X <= 0 && W >= 0) {
    const A = H(0);
...
function Jr(e, t, a) {
  ...
  for (const n of [...e].sort((i, c) => i.frame - c.frame)) {
    ...
    (r === null || !(Math.abs(c - r) <= sd)) && o.push(n.frame), r = c;
  }
  return o;
}
function Er(e) {
...
function md(e, t, a, o) {
  ...
  if (c.className = "oc-sequence-name", c.textContent = r?.name || t.camera_id, i.appendChild(c), a > 0) {
    ...
    l.className = "oc-sequence-handle", l.title = s("Drag to trim the cut"), l.addEventListener("pointerdown", (p) => ld(e, p, l, o, a)), i.appendChild(l);
  }
  return i.addEventListener("contextmenu", (l) => dd(e, l, t, a, o.__cutCount)), i.addEventListener("pointerdown", () => {
...
function ds(e, t) {
  ...
  if (n.className = "oc-sequence-lane", n.dataset.role = "sequence-lane", n.setAttribute("aria-label", s("Multi-camera edit")), o.length)
    for (const [c, l] of o.entries()) {
      ...
      he(e, l.end + 1) < -5 || p > 105 || n.appendChild(md(e, l, c, r));
    }
  else {
    const c = document.createElement("span");
  ...
  r.appendChild(n), r.appendChild(pd(e));
  const i = document.createElement("span");
  i.className = "oc-sequence-playhead", i.style.left = `${he(e, e.frame)}%`, r.appendChild(i), t.appendChild(r);
}
const fd = ['[data-act="curve-zoom-in"]', '[data-act="curve-zoom-out"]', '[data-act="curve-fit"]', '[data-act="curve-handles"]'], Qr = { curves: "Graph", dope: "Timeline", sequence: "Sequence" };
function en(e, t) {
...
const bd = /* @__PURE__ */ new Set(["good", "warning", "bad", "unknown"]);
function ms(e, t) {
  ...
  for (const n of r.frames) {
    ...
    const c = bd.has(n?.state) ? n.state : "unknown", l = n?.score;
    let p = null;
    if (l != null) {
      const m = Number(l);
...
function vd(e) {
  ...
  y && (y.textContent = m.name), ns(e), ts(e), is(e), Er(e), hd(e), e.refreshCameraSelectors(), e.refreshKeyEditor(), e.updateEditState(), e.drawCurveEditor(), e.perf && (e.perf.timelineRefreshCount = (e.perf.timelineRefreshCount || 0) + 1), yd(e);
}
class ps {
...
function Kd() {
  const e = Hc.map((t) => `<button data-lens="${t}">${t}mm</button>`).join("");
  return `
...
const Je = 1, an = 50, Te = 120, mt = 160, sm = Object.freeze(["perspective", "orthographic"]), K = Object.freeze({
...
}), im = Object.freeze(Object.values(we));
...
function ym(e, t) {
  ...
  e.objects ||= [];
  const a = new Set(e.objects.map((i) => i.id)), o = Po(a, t.objectType, t.id), r = pm(t.objectType), n = {
    id: o,
    type: t.objectType,
    name: t.name || o,
    ...r,
...
function Em(e, t) {
  ...
  for (a.has(t) && a.delete(t), a.add(t); a.size > Cm; )
...
function Tm(e, t) {
  ...
  if (e.far !== void 0) {
    Lt(e.far, "camera.far", t);
    const a = e.near === void 0 ? ci : e.near;
    if (e.far <= a)
      throw new I("BAD_VALUE", "camera.far must be greater than camera.near", t);
  }
  if (e.camera_type !== void 0 && !sm.includes(e.camera_type))
...
function Im(e, t) {
  ...
  return t.operations.forEach((a, o) => Mm(a, o)), {
    version: Je,
    id: t.id,
...
const Pm = "omnicam/library", Lm = "majoor_omnicam/blockout_library", zm = Object.freeze({
...
function gs(e) {
  return e.file ? `${e.source === "legacy" ? Lm : Pm}/${e.file} [input]` : "";
}
function rn(e, t, a) {
  const o = e || "asset";
  let r = `${o}_${a}`, n = 2;
...
function Rm(e, t = {}) {
  ...
  const a = Nm(t.point, [0, 0, 0]), o = String(t.idSeed || Date.now().toString(36)), r = String(e.kind || "prop"), n = r === "character", i = zm[e.id];
  ...
  return n && (c.character = Fm(e)), c;
}
function Km({ groundHit: e, orbitTarget: t } = {}) {
...
const Dm = {
  [K.ASSET_INSTANTIATE](e, t) {
    ...
    let o;
    try {
      o = Rm(t.asset, { point: t.point, idSeed: t.id, existingIds: a });
    } catch (r) {
  ...
  [K.OBJECT_SET_TAGS](e, t) {
    const a = nt(e, t.objectId), o = mi(t.tags), r = o.length !== t.tags.length ? "some tags were dropped or normalised" : void 0;
  ...
  [K.CHARACTER_SET_JOINT_ROTATION](e, t) {
    ...
    return a.character = {
      ...a.character || {},
      pose: di(a.character?.pose, t.joint, t.rotation)
    }, { dirtyMask: C.viewport | C.previews | C.inspector };
  },
  ...
  [K.KEYFRAME_UPSERT](e, t) {
    ...
    const r = !o;
    if (!o) {
      const i = po(a, 0)?.camera || a.camera || {};
    ...
    return { dirtyMask: C.viewport | C.previews | C.timeline | C.inspector, warning: n };
  },
...
function Bm({ state: e, operation: t }) {
  const a = Dm[t.type];
...
function Um(e, t) {
  ...
  return Vm(e, t, r), Gm(e, t, r), Xm(e, t, r), Ym(e, t, r), Jm(e, t, r), Zm(e, t, r), { changes: a, truncated: o };
}
const Wm = ["fov", "roll", "zoom", "near", "far", "camera_type"];
function Vm(e, t, a) {
...
const Hm = ["position", "target", "fov", "roll", "zoom", "near", "far", "camera_type"];
function Gm(e, t, a) {
  const o = Ze(e?.cameras), r = Ze(t?.cameras);
  for (const [n, i] of r) {
...
function rp(e, t) {
  ...
  try {
    ...
    if (f instanceof I) return Wo(e, t?.id, f);
    throw f;
  }
  const o = sr(e);
  ...
  for (let f = 0; f < a.operations.length; f += 1)
    try {
      const d = Bm({ ui: e, state: r, operation: a.operations[f] });
      n |= d?.dirtyMask || 0, d?.warning && i.push(d.warning), d?.outcome && c.push({ index: f, ...d.outcome });
    } catch (d) {
      if (d instanceof I)
        return (d.operationIndex === null || d.operationIndex === void 0) && (d.operationIndex = f), Wo(e, a.id, d);
      throw d;
    }
  if (a.validateOnly) {
    const { changes: f, truncated: d } = Um(e.state, r);
    return {
      ok: !0,
      version: Je,
      revision: o,
  ...
  const l = ep(e);
  Em(e, a.id), e.serialize?.(), tp(e, l), op(e, n, `director-api:${a.id}`);
  const p = {
    ok: !0,
    version: Je,
    baseRevision: o,
...
const sn = "omnicam-agent/1", cn = "majoor.omnicam.agent.request", ip = 1, zt = Object.freeze({
...
}), cp = 1e4, lp = 5e3, ys = "asset.instantiate_by_id", vs = "asset.catalog_search", ln = Object.freeze([
...
function fp(e, t, a) {
  ...
  async function v(S) {
    const g = S?.detail;
    if (o || !g || g.protocol !== sn || Number(g.schema_version) !== ip || g.session_id !== r || String(g.node_id) !== String(t.id)) return;
    let _;
    try {
      if (g.kind === "query")
        _ = g.payload?.type === vs ? await pp(e, g.payload) : e.directorApi.query(g.payload);
        ...
        if (!Number.isInteger($?.baseRevision) || $.baseRevision < 0)
          ...
          const z = await mp(e, $.operations);
          z.ok ? (_ = e.directorApi.execute({ ...$, operations: z.operations }), await _?._reconciliation) : _ = Ft(e, z.code, z.message);
        }
      } else
...
function $r({ fetchApi: e = hp } = {}) {
  const t = (a, o) => Promise.resolve(e(a, o)).then(up);
  return {
    list(a = {}) {
...
const xp = 256;
function pn(e = {}) {
  const { THREE: t, GLTFLoader: a, FBXLoader: o, size: r = xp } = e;
  if (!t || !a)
...
async function wp() {
  const [e, t, a] = await Promise.all([
    import("./chunk-Da3B-29S.js").then((o) => o.T),
    import("./vendor-three-ChNUWu3S.js").then((o) => o.al),
    import("./vendor-three-ChNUWu3S.js").then((o) => o.am)
  ]);
...
function _p(e, t = {}) {
  return xs.map((a) => {
    const o = s(jp[a] || a), r = a === "all" ? "" : ` <span class="oc-asset-kind-n">${Number(t[a] || 0)}</span>`;
    return `<button type="button" class="oc-asset-kind${a === (e || "all") ? " active" : ""}" data-asset-kind="${a}">${yt(o)}${r}</button>`;
  }).join("");
}
function Cp(e, { selected: t = !1, thumbUrl: a = "" } = {}) {
  const o = Sp[e.kind] || "pi-box", r = e.kind === "character" && Kn(e.rig) === "rigged" ? `<span class="oc-asset-badge">${s("RIGGED")}</span>` : "", n = a ? `<img class="oc-asset-thumb" src="${yt(a)}" alt="" loading="lazy">` : `<span class="oc-asset-thumb oc-asset-thumb--glyph"><i class="pi ${o}"></i></span>`;
...
function Ep(e, { selectedId: t = "", thumbUrls: a = {} } = {}) {
  return !e || !e.length ? `<p class="oc-asset-empty">${s("No assets match this filter.")}</p>` : e.map((o) => Cp(o, {
    selected: o.id === t,
    thumbUrl: a[o.id] || ""
  })).join("");
}
...
function Ap(e, t = {}) {
  const a = e.root, o = t.fetchApi || ((O, D) => (e.api || e.app?.api).fetchApi(O, D)), r = t.apiClient || $r({ fetchApi: o }), n = t.store || gp(r), i = yp(), c = t.previewQueue || vp(), l = e.api || e.app?.api || null;
  let p = t.thumbnailRenderer || null, m = null;
  const f = /* @__PURE__ */ new Set();
  function d() {
    return p ? Promise.resolve(p) : (m || (m = wp().then((O) => p = pn(O)).catch(() => p = pn({}))), m);
  }
  function h(O) {
    return Br(l, gs(O));
  }
    ...
    for (const O of n.state.items) {
      ...
      D && c.enqueue(O.id, async () => {
        ...
        if (i.set(O.id, Se), q(), !(O.source && O.source !== "user"))
          try {
            const Ie = await r.uploadThumbnail(O.id, kp(Se));
  ...
  let L = !1;
  function q() {
    if (S && (S.innerHTML = _p(n.state.filter.kind, n.state.kinds)), x) {
      const O = {};
      for (const D of n.state.items) {
        const de = i.get(D.id) || u(D);
        de && (O[D.id] = de);
      }
      x.innerHTML = Ep(n.state.items, { selectedId: re, thumbUrls: O });
    }
    if (!L) {
      L = !0;
      try {
...
function Lp(e, t = {}) {
  ...
  function y(j) {
    ...
    return fi({ preset: N, overrides: j?.pose }).joints;
  }
  function x() {
    const j = h();
  ...
  function S() {
    ...
    l && (l.textContent = j);
    const U = h(), H = y(U?.character)[j] || [0, 0, 0, 1], te = hi(H);
    p.forEach((A, G) => {
  ...
  function $() {
    const j = b();
    if (!j) return;
    const N = p.map((te) => Number(te?.value) || 0), U = pi(N), H = e.directorApi?.execute({
      version: 1,
  ...
  async function z() {
    ...
    const U = N.toLowerCase().replace(Pp, "-").replace(/^-+|-+$/g, "").slice(0, 60) || "pose";
    try {
...
function qp(e, t, a, o) {
  ...
  const [$, F] = S(h[0] || 0, h[2] || 0), [z, X] = S(u[0] || 0, u[2] || 0), W = 8, V = Y($, n + W, n + c - W), re = Y(F, i + W, i + c - W), j = Y(z, n + W, n + c - W), N = Y(X, i + W, i + c - W), U = h[1] || 0, H = Dp(U), te = Bp(U);
...
function Yp(e, t, a) {
  ...
  const o = () => {
    ...
    const h = bi(t('[data-role="object-tags"]')?.value || "");
  ...
  }, { signal: a }), Dl(e, a), ud(e, a), t('[data-role="curve-group"]')?.addEventListener("change", () => {
  ...
  e.root.addEventListener("pointerdown", (d) => {
    ...
    const h = e.interactionElement.getBoundingClientRect(), u = (d.clientX - h.left) * e.canvas.width / Math.max(1, h.width), b = (d.clientY - h.top) * e.canvas.height / Math.max(1, h.height);
    Gp(e, d, u, b) || e.onWheel(d);
  }, { passive: !1, signal: a }), e.root.addEventListener("wheel", _l(e.root), { signal: a }), window.addEventListener("pointermove", (d) => {
  ...
  const p = (d) => {
    const h = gi(d.composedPath?.()[0] || d.target);
    h && (e.lastKeyZone = h);
  };
...
function Zp(e) {
  const t = cc(e.id, e.defaultValue), a = `pref_${e.id.replace(/[^a-zA-Z0-9]/g, "_")}`;
  if (e.type === "boolean")
    return `
...
function ef() {
  return `<span class="oc-pref-emoji" aria-hidden="true">${Xp}</span> ${s("OmniCam Preferences")}`;
}
function tf(e) {
  ...
  a.className = "oc-modal-backdrop", a.setAttribute("role", "dialog"), a.setAttribute("aria-modal", "true"), a.setAttribute("aria-label", s("OmniCam Preferences")), a.innerHTML = `
    <div class="oc-modal-dialog oc-pref-dialog" tabindex="-1">
      <div class="oc-pref-header">
        <div class="oc-pref-title">${ef()}</div>
...
const of = ["position", "target"], rf = ["fov", "zoom"], nf = ["roll"], sf = ["position", "size"], cf = ["rotation"];
function lr(e) {
...
function bf(e, t) {
  ...
  const o = (r) => {
    ...
    const u = (v) => {
      ...
      let x = ff;
      v.shiftKey ? x = hf : (v.ctrlKey || v.metaKey) && (x = uf);
      const S = p * x * 20;
      let g = l + y * S;
...
function _s(e) {
  ...
  p && o?.fov != null && (p.textContent = Gc(o.fov));
...
function wf(e, t) {
  ...
  a.addEventListener("input", r, { signal: t }), a.addEventListener("change", () => {
    ...
    const c = Number(a.value) / 100, l = mf(n(i), c);
...
const ho = () => import("./chunk-CJ-lpeJB.js");
function Ef(e, t) {
...
function Af(e, t) {
  ...
  lc().then((r) => {
    ...
    c === "health-slow" ? mc(e) : c === "health-smooth" ? pc(e) : c === "health-recenter" && fc(e);
  }, { signal: t });
...
function If(e, t) {
  Ef(e, t), xf(e, t), wf(e, t), kf(e, t), Sf(e, t), $f(e, t), Mf(e, t), Tf(e, t), bf(e, t), gf(e, t), jf(e, t), Cf(e, t), vf(e, t), _f(e, t), Af(e, t);
}
const kn = {
...
function Of(e, t = "#1b1f2b", a = "#151822", o = "#1e2330", r = "#161922", n = "#111319") {
...
function ig(e, t, a = Cs) {
  ...
  const h = new e.FogExp2(1250588, 8e-3), u = Of(e), b = new e.PMREMGenerator(t);
  b.compileEquirectangularShader();
  const v = new $l(), y = b.fromScene(v, 0.04).texture;
  return v.traverse((x) => {
    x.geometry?.dispose?.();
...
function Lf(e) {
  ...
  const r = e.reconstruction, n = r.provider || "Reconstructed", i = Math.round(t * 100), c = Zc(e), l = c.length ? `
` + c.map(([m, f]) => `${m}: ${f}`).join(`
`) : "", p = `${n} • ${o} (${i}%)${l}`;
  return {
    label: o,
...
function dg(e, t, a) {
  return e?.reconstruction ? a ? "neutral" : zf(t) === "source_texture" ? "textured" : "neutral" : null;
}
function Nf(e, t) {
...
function Ff(e, t, a) {
  ...
  if (o) {
    const n = (i) => {
      const c = i.target.closest?.("[data-axis], [data-axis-center]") || i.target, l = c.getAttribute("data-axis"), p = hc(l?.toLowerCase(), e.state.view_mode);
  ...
  for (const n of e.root.querySelectorAll("[data-lens]"))
    n.addEventListener("click", () => {
      Qc(e, Number(n.dataset.lens));
    }, { signal: a });
  for (const n of e.root.querySelectorAll("[data-blocking-scene]"))
    n.addEventListener("click", () => {
      Kp(e, n.dataset.blockingScene), e.closeMenus();
    }, { signal: a });
...
const Rf = 32, Kf = 0.025, Df = 0.05, Co = 1e-6, Bf = ["top", "bottom", "front", "back", "left", "right"], qf = {
  top: "y",
  bottom: "y",
  front: "z",
  back: "z",
...
function Gf(e) {
  ...
  const n = Math.min(Rf, r.length, o + 1);
  if (n < 2) return [];
  const i = Wf(r, n);
  ...
  for (let d = m; d < i.length; d++) {
    const h = i[d], u = Vf(i, d, p, e.planeAxis), b = pe(c);
    b.position = [...h], b.target = Hf(h, u, l, e.planeAxis), f.push({
...
function jn(e, t = {}) {
  ...
  if (a === "extend") {
    ...
    Bf.includes(e.state.view_mode) || e.setViewMode?.("top"), c = Sn(e.state);
  const m = qf[e.state.view_mode] ?? null, f = n ? [...n] : [...r.position];
...
function Or(e, t) {
  ...
  return r && Ir(r, o) < Kf ? !1 : (a.points.push(o), !0);
}
function De(e) {
...
function Xf(e) {
  ...
  if (a.length < 2 || Uf(a) < Df || t.range[1] <= t.range[0])
  ...
  const r = el(e.state), n = e.state.cameras.length, i = {
    id: r,
    name: Yf(e.state),
...
function eh(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : (Ao(t), t.type === "pointercancel" || t.type === "lostpointercapture" ? (De(e), !0) : (Or(e, Pr(e, t)), a.drawing = !1, Xf(e), !0));
}
function th(e) {
  const t = e.cameraPathDraw;
...
function ch(e, t) {
  bo(e, t, e.root.querySelectorAll('[data-act="scene-new"]'), () => oh(e)), bo(e, t, e.root.querySelectorAll('[data-act="scene-open"]'), () => sh(e)), bo(e, t, e.root.querySelectorAll('[data-act="scene-save"]'), () => nh(e)), bo(e, t, e.root.querySelectorAll('[data-act="scene-reset"]'), () => rh(e));
}
const lh = ["world_point", "object_point", "camera_field"], _n = 40;
function dh(e) {
...
function fh(e) {
  ...
  for (const v of e.state.motion_layers || []) {
    if (v.enabled === !1) continue;
    const y = lh.includes(v.source_kind), x = y ? mh(e.state, v, d) : dh(v);
...
function hh(e, t) {
  ...
  a && a.addEventListener("click", (o) => {
    ...
    }, l = bc(e.state.motion_layers, c, 0.09);
...
function uh(e) {
  ...
  gc(e, t), yc(e, t), hh(e, t), af(e, a, t), Ff(e, a, t), al(e, t), ah(e, t), ch(e, t), Yp(e, a, t), If(e, t);
}
function bh(e, t) {
...
const it = 1024 * 1024, vh = Object.freeze({
  card: 128 * it,
  // MAX_CARD_BYTES
  model: 256 * it,
  // MAX_MODEL_BYTES
...
async function Sh(e, { load: t = () => import("./vendor-mediabunny-CZ5VNE-V.js") } = {}) {
...
async function _h(e, t, { decode: a = Sh } = {}) {
  if (!t) return;
  const o = Gt(t, "audio");
  if (o) {
    e.setStatus(o);
...
function Yt(e, t) {
  ...
  a && (e.cardMediaById.delete(t), e.cardMediaAssetById?.delete?.(t), t === "subject" && e.cardMedia === a && (e.cardMedia = null), Eh(a));
}
function Ah(e) {
...
function Qe(e, t, a, o = !1, r = "") {
  ...
  n && n !== a && Yt(e, t), o && Ps.add(a), Ch(a), e.cardMediaAssetById ||= /* @__PURE__ */ new Map(), e.cardMediaById.set(t, a), e.cardMediaAssetById.set(t, r || a?.__omnicamAsset || "");
  try {
    a.__omnicamAsset = r || a.__omnicamAsset || "";
  } catch {
  }
...
const Nh = ["video/mp4;codecs=avc1.42E01E", "video/webm;codecs=vp9", "video/webm;codecs=vp8", "video/webm"], $n = { low: 3e6, balanced: 6e6, high: 12e6 };
function Fh(e) {
  ...
  try {
    for (const S of Nh)
      if (!(n.isTypeSupported && !n.isTypeSupported(S)))
        try {
          f = new n(m, { mimeType: S, videoBitsPerSecond: Fh(r) });
          break;
        } catch {
        }
...
async function Ns(e) {
  await Dh(e.cardMediaById.values());
}
async function Fs(e) {
  return Rh({
    canvas: e.canvas,
...
async function Rs(e, t) {
  const a = await Kh(et, t);
  if (yh(e, t), e.state.playblast_camera_id === Yn)
...
async function qh(e) {
  ...
  const t = e.frame, a = e.canvas.width, o = e.canvas.height, r = Bh(e);
  (r.width !== e.canvas.width || r.height !== e.canvas.height) && (e.canvas.width = r.width, e.canvas.height = r.height, e.render());
  try {
    let n = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-BQHCjx-2.js");
...
function Gh(e) {
  ...
  for (const m of a) {
    ...
    r.fillStyle = "rgba(16,17,22,0.82)", Yh(r, $, F, g, _, 4 * c), r.fill(), v && (r.strokeStyle = v, r.lineWidth = Math.max(1, c), r.stroke()), r.fillStyle = v || "#e6e6ec", r.fillText(f, $ + y, F + _ - x - 2 * c);
  }
  r.restore();
}
function Yh(e, t, a, o, r, n) {
...
const Zh = 600;
function Qh(e) {
  const { points: t, colors: a } = Jh(e);
  if (!t.length) return;
  const o = e.viewportCamera(), r = e.canvas.width, n = e.canvas.height, i = t.length / 3, c = 3 * Math.max(1, Math.ceil(i / Zh)), l = /* @__PURE__ */ new Map();
...
function lu(e) {
  ...
  e.recording && e.state.playblast_labels && Gh(e);
}
async function du(e, { signal: t } = {}) {
...
async function pu(e) {
  ...
  const r = o.diagnostic?.issues || [], n = mu(r);
    ...
    if (t.appendChild(x), !S)
      for (const { object: g, level: _ } of y) {
        ...
        N.style.cssText = V ? "color:#fca5a5" : W ? "" : "opacity:.5;text-decoration:line-through", N.textContent = g.name || g.type, N.title = s("Double-click to rename"), N.addEventListener("dblclick", (A) => {
          A.preventDefault(), A.stopPropagation(), yu(e, g, N);
        }), j.appendChild(N);
...
function Au(e) {
  ...
  e.beginCameraEdit(), xc(e.camera, r), e.commitCameraEdit(), e.finishCameraEdit(), Hs(e), Eu(e), e.render();
}
function $u(e) {
  const t = globalThis.performance?.now?.() ?? Date.now();
  (!Number.isFinite(e.lastCameraHudEditAt) || t - e.lastCameraHudEditAt > 300) && e.checkpoint("Edit camera"), e.lastCameraHudEditAt = t;
...
const Ju = ["guides", "safe-areas", "resolution-gate", "aspect-ratio"];
function Zu(e) {
  ...
  return {
    ...
    resizeCanvas() {
      ...
      for (const R of this.cameraPreviewCanvases.values()) {
        const Z = R.clientWidth || 220, B = R.clientHeight || 124, ne = Math.max(T, mb / Math.max(1, Z)), Ce = Math.max(1, Math.round(Z * ne)), Fe = Math.max(1, Math.round(B * ne));
...
const On = { motion: "motion", shot: "display", health: "health" }, ub = {
  object: "Object",
  camera: "Camera",
  camera_target: "Look-At Target",
  camera_path: "Camera Path"
}, bb = { motion: "Motion", shot: "Shot", health: "Health" }, gb = ["entity", "motion", "shot", "health"];
function Zs(e) {
...
function Qs(e) {
  ...
  r && (r.textContent = o === "entity" ? s(ub[e.selectedEntity] || "Inspector") : s(bb[o] || "Inspector"));
}
function wb(e, t) {
  e.inspectorMode = gb.includes(t) ? t : "entity", Qs(e), e.render?.(), e.refitNode?.();
}
function kb(e) {
  ...
  return {
    ...
    setSpatialHandleMode(w) {
      ...
      this.checkpoint(s("Camera path handle: {mode}").replace("{mode}", w)), lb(M[R], w, {
        prevKey: M[R - 1] || null,
        nextKey: M[R + 1] || null
    ...
    transformCameraPath(w) {
      ...
      const M = wc(E.keyframes, { origin: kc(E.keyframes), ...w });
    ...
    refreshInspector() {
      this.perf && (this.perf.inspectorRefreshCount = (this.perf.inspectorRefreshCount || 0) + 1), Ka(this), xb(this);
    },
    setInspectorMode(w) {
      wb(this, w);
    },
...
const Ab = "http://www.w3.org/2000/svg", bt = 26, Pn = 17, $b = 5.4;
function gt(e, t) {
  const a = document.createElementNS(Ab, e);
...
function Tb(e) {
  ...
  for (const n of Cb(_b(a))) {
    const i = bt + n.x * Pn, c = bt + n.y * Pn, l = Eb(n.depth);
...
function Ib(e) {
  ...
  for (const r of e.state.motion_layers || []) {
    ...
    const n = Mb(e.state, r, e.frame, a, o);
    if (n.length) {
...
const Ob = ["world_point", "object_point", "camera_field"], ei = {
  manual_2d: "DRAW",
  object_point: "OBJECT",
  world_point: "WORLD",
...
function Fb(e) {
  ...
  n("motion-sel-name", a.label), n("motion-sel-type", ei[a.source_kind] || "TRACK"), n("motion-sel-binding", Pb(e.state, a)), n("motion-sel-start", r.length ? Math.min(...r) : 0), n("motion-sel-end", r.length ? Math.max(...r) : 0);
...
function Db(e) {
  ...
  return {
    ...
    renderViewportOnly() {
      ...
      !this.recording && this.state.speed_heatmap && this.drawSpeedHeatmap(), !this.recording && th(this), this.drawOverlays(), Ib(this), this.state.show_gizmo && Tb(this), this.labelOverlay?.update(), this.rigOverlay?.update(), this.perf && (this.perf.viewportRenderCount = (this.perf.viewportRenderCount || 0) + 1);
    },
    ...
    requestUiUpdate(k = C.viewport, w = "unknown") {
      (this.renderReasons ||= /* @__PURE__ */ new Set()).add(w), this.uiDirtyMask = Om(this.uiDirtyMask, k), this.renderInvalidations = (this.renderInvalidations || 0) + 1, !this.renderScheduled && (this.renderScheduled = !0, this.renderFrame = requestAnimationFrame(() => {
    ...
    dispose() {
      this.disposed || (this.disposed = !0, this.agentBridge?.dispose?.(), jc(this), _c(), nl(this), this.backgroundRequestId = (this.backgroundRequestId || 0) + 1, this.upstreamSyncId = (this.upstreamSyncId || 0) + 1, this.stopPlay(), clearTimeout(this.previewClickTimer), clearTimeout(this.connectionTimer), cancelAnimationFrame(this.restoreFrame), cancelAnimationFrame(this.serializeFrame), cancelAnimationFrame(this.resizeFrame), cancelAnimationFrame(this.renderFrame), this.abortController?.abort(), this.upstreamFetchController?.abort(), this.resizeObserver?.disconnect(), this.contextMenu?.dispose(), this.webgl?.dispose(), this.cameraWebgl?.dispose(), G(this), Ah(this), this.objectUrls.clear(), this.cardMediaById.clear(), this.cardMediaAssetById?.clear?.(), this.modelUrlsById.clear(), this.modelInfoById.clear());
    }
  };
}
const ti = 1e-9;
...
function Kr(e, t) {
  const a = e.map((i) => Bb(i, t)), o = qb(a), r = e.map((i) => i.frame), n = Math.max(1, r[r.length - 1] - r[0]);
  return a.map((i, c) => [
    (r[c] - r[0]) / n,
...
function Wb(e, t, { tolerance: a = 0.02, keepFrames: o = [] } = {}) {
...
function Vb(e, t, { target: a = 2, keepFrames: o = [] } = {}) {
...
function Hb(e, t, { mergeWithin: a = 1, epsilon: o = 1e-3, keepFrames: r = [] } = {}) {
...
function Yb(e, t, a, { lastFrame: o = 1 / 0 } = {}) {
...
function Qb() {
  return {
    ...
    deleteSelectedKeyframes() {
      ...
      const t = this._activeTrack(), a = _e(this), o = t.kind === "camera" ? 1 : 0, { keys: r, removed: n } = Gb(a, e, { minKeys: o });
    ...
    nudgeSelectedKeyframes(e) {
      ...
      const a = this._activeTrack(), o = Math.max(0, this.state.duration_frames - 1), r = Yb(_e(this), t, e, { lastFrame: o });
    ...
    setSelectedKeysInterpolation(e) {
      ...
      this.checkpoint(s("Interpolation on {n} keys").replace("{n}", t.length)), a.write(Xb(_e(this), t, e)), this.serialize(), this.refreshKeys(), this.refreshKeyEditor(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} interpolation on {n} keys").replace("{mode}", e.replace(/_/g, " ")).replace("{n}", t.length));
    },
    setSelectedKeysTangentMode(e) {
      const t = this.resolveSelectedFrames();
      if (t.length < 2) return this.setTangentMode(e);
      const a = this._activeTrack(), o = ct(this).map((r) => r.id);
      this.checkpoint(s("Tangents on {n} keys").replace("{n}", t.length)), a.write(Jb(_e(this), t, e, o)), this.serialize(), this.refreshKeys(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} tangents on {n} keys").replace("{mode}", e).replace("{n}", t.length));
    },
    /**
    ...
    simplifyActiveKeys({ mode: e = "simplify", tolerance: t = 0, target: a = 0, scope: o = "camera", fromKeys: r = null, silent: n = !1 } = {}) {
      ...
      const l = this.resolveSelectedFrames(), p = o !== "all_cameras" && l.length >= 2 ? [l[0], l.at(-1)] : null, m = p ? [] : l, f = (u) => {
        ...
        let _ = S, $ = 0;
        if (S.length > 2) {
          const F = e === "reduce" ? Vb(S, i, { target: a || Math.ceil(S.length / 2), keepFrames: m }) : e === "clean" ? Hb(S, i, { keepFrames: m }) : Wb(S, i, { tolerance: t * Zb, keepFrames: m });
          _ = F.keys, $ = F.removed;
        }
...
class ai {
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-BQHCjx-2.js"));
    } catch (a) {
    ...
    if (!this.disposed) {
      ...
      Cc(this), this.resizeCanvas(), this.render(), this.renderCameraView();
    }
  }
}
const yo = { app: zn, api: et, EditorHistory: ps, ContextMenuController: Zn, initializeTooltips: il, promptText: Vt, ObjectUrlRegistry: fs, buildRoot: hs, dispatchDirectorKey: Ec, activeCameraTrack: tr, bindWidgetCallbacks: cl, playblastCameraTrack: Jn, restoreFromWidgets: ll, serializeEditorState: dl, syncActiveCameraTrack: ar, syncFromWidgets: ml, bindEditorEvents: uh, activateCamera: pl, addCamera: fl, deleteCamera: hl, drawPreviewOverlays: ul, duplicateCamera: bl, maximizeCameraPreview: gl, refreshCameraPreviews: yl, refreshCameraSelectors: vl, renameCamera: xl, setPlayblastCamera: wl, toggleCameraView: kl, captureRealtime: Fs, makePlayblast: qh, uploadDirectorPlayblast: Rs, waitForMediaFrame: Ns, computeAudioPeaks: Is, loadAudioFile: _h, releaseAudio: $o, stopPlay: So, togglePlay: kh, applyCameraPreset: Np, applyCameraShake: Fp, applyProxyPreset: Rp, clearViewportBgImage: Hh, loadViewportBgFile: Wh, loadViewportBgSequence: Vh, drawCameraPath: iu, drawCard: su, drawCube: eu, drawCylinder: ou, drawGrid: Xh, drawHuman: au, drawLine3D: ie, drawNull: nu, drawOverlays: lu, drawPointField: Qh, drawSpeedHeatmap: cu, drawSphere: tu, drawTorus: ru, curveChannels: ct, drawCurveEditor: rd, fitCurveView: ss, onCurveDoubleClick: ad, onCurvePointerDown: Hl, onCurvePointerMove: Gl, onCurvePointerUp: Yl, onTimelinePointerDown: Ac, onTimelinePointerMove: $c, onTimelinePointerUp: Tc, refreshKeys: vd, resetCurveZoom: od, resetTimelineZoom: Mc, setChannelFilter: Jl, setCurveInterpolation: Xl, setTangentMode: Zl, timelineFrameFromEvent: ur, toggleCurveHandles: Ql, zoomCurve: td, drawTransformGizmo: Ic, frameTarget: Oc, gizmoAxes: Pc, gizmoGeometry: Lc, onPointerDown: zc, onPointerMove: Nc, onPointerUp: Fc, onWheel: Rc, pickGizmo: Kc, pickSceneObject: Dc, resetCamera: Bc, setTransformMode: qc, setViewMode: Uc, viewportCamera: Wc, loadCardFile: Oh, loadExecutionPreview: Ph, loadMediaUrl: zs, loadModelFile: Ih, loadSelectedReference: Lh, onModelLoaded: Mh, restoreAssets: Th, syncUpstreamInputs: zh, configureDomMedia: Os, refreshSetupDiagnostic: pu, addMediaCard: Su, addPrimitive: vu, applyObjectAnimationFrame: Ru, beginCameraEdit: Vu, beginObjectEdit: Vs, commitCameraEdit: Hu, commitObjectEdit: Cu, copyKeyframe: qu, deleteKeyframe: Bu, deleteObject: Ws, deleteSelectedObjects: ku, duplicateObject: Us, exitKeyEdit: Yu, finishCameraEdit: Gu, goToAdjacentKey: nb, insertKeyframe: Ku, loadSelectedKeyView: rb, pasteKeyframe: Uu, playblastCameraAtFrame: Fu, refreshInspector: ju, refreshKeyEditor: tb, refreshObjects: qs, removeObjectResources: Iu, renameObject: xu, retimeSelectedKey: ab, selectKeyframe: Wu, selectedKeyframe: Ue, selectedObject: Xt, selectObjectAnimation: Mu, setKeyInterpolation: Du, setKeyTangentMode: eb, setObjectParent: Tu, timelineKeyframes: _e, timelineObject: Le, toggleAutoKey: Xu, toggleObject: wu, updateCameraFromHud: $u, updateCameraRotationFromHud: Au, updateEditState: Zu, updateKeyVisualState: Qu, updateSelectedKey: ob, updateSelectedObject: _u, clamp: Y, cloneCamera: pe, configureCore: Xn, defaultCamera: yr, sampleCamera: $e, sampleObjectTransform: Oo, sanitizeState: xr, worldTransform: wr };
Object.assign(
  ai.prototype,
  pb(yo),
  kb(yo),
...
function eg(e) {
  ...
  const t = new ai(e);
  vo("director:constructor:complete", e), sp(t);
  try {
    t.agentBridge = fp(t, e, et);
  } catch (m) {
  ...
  try {
    t.assetBrowser = Ap(t, {
      ...
      onAgentFirstOpen: async () => {
        if (Zo())
          try {
            const { createDirectorAgentPanel: m } = await import("./chunk-CIZfaUjJ.js");
            t.agentPanel = m(t);
          } catch (m) {
  ...
  try {
    t.characterRuntime = Tp(t), t.rigMapper = Ip(t), t.poseEditor = Lp(t), t.motionEditor = zp(t);
  } catch (m) {
  ...
  }, t.unwatchGraphConnections = sl(e, i);
  const l = e.onRemoved;
