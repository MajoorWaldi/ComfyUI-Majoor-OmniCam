...
import { s as $e, c as Z, t as he, a as s, o as Un, b as xr, d as He, e as ce, f as Fo, r as fi, g as wr, h as Wn, i as hi, j as ui, k as bi, l as gi, m as kr, n as Sr, I as jo, D as yi, p as jr, q as vi, w as xi, u as Ao, v as Vn, x as wi, y as _r, z as or, A as Hr, B as Hn, C as rr, E as Gn, F as Yn, G as Xn, H as Jn, J as nr, K as Vo, L as Gr, O as Yr, R as Zn, M as ki, N as Si, P as ji, Q as _i, S as Ci, T as Ce, U as Qn, V as es, W as Xr, X as Ut, Y as Ei, Z as ts, _ as Ai, $ as Ti, a0 as Cr, a1 as $i, a2 as Mi, a3 as Ii, a4 as Oi, a5 as Pi, a6 as Er, a7 as Li, a8 as zi, a9 as Ni, aa as Fi, ab as Ri, ac as Di, ad as Ki, ae as Bi, af as qi, ag as Ui, ah as Wi, ai as Vi, aj as Hi, ak as Gi, al as Yi, am as Xi, an as Ji, ao as Zi, ap as Qi, aq as ec, ar as tc, as as ac, at as oc, au as rc, av as nc, aw as sc, ax as ic, ay as cc, az as lc, aA as dc, aB as mc, aC as pc, aD as fc, aE as hc, aF as uc, aG as bc, aH as gc, aI as yc, aJ as vc, aK as xc, aL as wc, aM as kc, aN as Sc, aO as as, aP as jc, aQ as Ho, aR as _c, aS as Cc, aT as Ec, aU as Ac, aV as Tc, aW as Ve, aX as $c, aY as os, aZ as Ar, a_ as Mc, a$ as Ic, b0 as Oc, b1 as rs, b2 as Ze, b3 as Pc, b4 as Jr, b5 as Tr, b6 as Lc, b7 as ns, b8 as zc, b9 as Nc, ba as Fc, bb as Rc, bc as Dc, bd as Kc, be as Bc, bf as qc, bg as Uc, bh as Wc, bi as ss, bj as Vc, bk as Hc, bl as Gc, bm as Yc, bn as Xc, bo as Jc, bp as Zc, bq as Qc, br as el, bs as tl, bt as al, bu as ol, bv as rl, bw as nl, bx as sl, by as il, bz as cl, bA as ll, bB as dl } from "./chunk-BQzFpTKV.js";
import { L as ml, a as pl, p as Yt, f as $r, b as fl, S as hl, c as Zr, d as ul, e as bl, r as gl, g as yl, n as vl, C as Qr, h as Xt, o as xl, i as wl, s as kl, j as Sl, k as is, l as jl, m as sr, q as ir, w as _l, t as cs, u as Cl, v as El, x as Al, y as Tl, z as $l, A as Ml, B as Il, D as Ol, E as Pl, F as Ll, G as zl, H as Nl, I as Fl, J as Rl, K as Dl, M as Kl } from "./chunk-xSWoILmT.js";
import { S as Bl, b as ql, p as Ul, m as Wl, l as Vl, u as Hl } from "./chunk-BOI_2OKd.js";
import { T as Gl } from "./chunk-__IQ4xkd.js";
import { T as Yl, R as Xl } from "./vendor-three-BQUrLQkn.js";
function Ft(e, t = 0) {
  return Math.sin(e * 1.7 + t * 3.1) * 0.5 + Math.sin(e * 3.3 + t * 5.7) * 0.3 + Math.sin(e * 7.9 + t * 11.3) * 0.2;
}
function Jl(e, { type: t = "handheld_subtle", intensity: a = 1, duration_frames: o = null, subdivide: r = !0 } = {}) {
...
function Zl(e, { duration_frames: t = 120, target: a = [0, 1.5, 0], radius: o = 6, height: r = 3.5 } = {}) {
...
const ls = 1e-4;
function Ql(e, t) {
  return !Array.isArray(e) || !Array.isArray(t) ? e !== t : e.some((a, o) => Math.abs(Number(a) - Number(t[o])) > ls);
}
function en(e, t) {
  return Math.abs(Number(e) - Number(t)) > ls;
}
const ds = [
  {
    id: "camera",
...
function td(e, t = null) {
  return ds.filter((a) => !t || t.has(a.id)).map((a) => ({
    id: a.id,
    label: a.label,
    color: a.color,
    frames: ed(e, a)
...
function To(e) {
  ...
  for (const a of [".oc-playhead-head", '[data-role="dope-playhead"]', ".oc-gdope-playhead", ".oc-sequence-playhead"])
    for (const o of e.root.querySelectorAll(a)) ad(o, t);
}
function od(e, t, a) {
...
function ms(e) {
  ...
  a.delete("camera");
  const o = e.timelineKeyframes() || [], r = td(o, a), n = nd(e, r);
  if (t.dataset.signature !== n) {
    t.dataset.signature = n, t.replaceChildren();
    const i = (c) => he(e, c);
    for (const c of r) {
      const l = document.createElement("div");
      l.className = "oc-dope-row", l.dataset.channel = c.id, l.style.setProperty("--channel-color", c.color), od(l, c.frames, i), rd(e, l, c, o, i), t.appendChild(l);
    }
  }
...
const Go = [1, 2, 5, 10, 20, 25, 50, 100, 200, 250, 500, 1e3, 2e3, 5e3], ps = 46, tn = 5, fs = 640;
function hs(e, t) {
  const a = t > 0 ? t : fs, o = Math.max(2, Math.floor(a / ps)), r = Math.max(1e-6, e / o);
  return Go.find((n) => n >= r) ?? Go[Go.length - 1];
}
function sd(e, t) {
  const a = Math.max(1, e.state.duration_frames - 1), o = Z(Number(e.timelineZoom) || 1, 0.1, 50), r = Number(e.timelinePan) || 0, n = a / o, i = hs(n, t), l = (i >= tn ? i / tn : 0) || i, p = [], m = Math.max(0, Math.floor(r / l) * l);
...
function id(e) {
  return e.clientWidth || e.parentElement?.clientWidth || fs;
}
function us(e) {
  const t = e.root.querySelector('[data-role="ruler"]');
  if (!t) return;
  t.replaceChildren();
  for (const o of sd(e, id(t))) {
...
function fd(e, { left: t, right: a, top: o, width: r, graphHeight: n, minimum: i, maximum: c, yFor: l }) {
  const p = dd(c - i, 4);
  e.strokeStyle = "#222228", e.lineWidth = 1, e.fillStyle = "#6e727a";
  for (let m = Math.ceil(i / p) * p; m <= c; m += p) {
    const f = l(m);
    f < o - 1 || f > o + n + 1 || (e.beginPath(), e.moveTo(t, f), e.lineTo(r - a, f), e.stroke(), e.fillText(md(m, p), 4, f + 3));
  }
}
function Mr(e, t) {
...
function bs(e, { selectedOnly: t = !1 } = {}) {
  const a = Math.max(1, (e.state?.duration_frames ?? 120) - 1), o = e.timelineKeyframes() || [], r = e.timelineObject(), n = pt(e), i = e.selectedKeyFrames?.size ? [...e.selectedKeyFrames] : e.selectedKeyFrame != null ? [e.selectedKeyFrame] : [], c = i.length > 0, l = t || c && i.length < o.length ? o.filter((b) => i.includes(b.frame)) : o;
  if (!l.length) {
...
function _d(e) {
  ...
  const i = e.timelineObject(), c = e.timelineKeyframes(), l = pt(e), p = 44, m = 14, f = 16, d = 22, h = Math.max(1, a - p - m), u = Math.max(1, o - f - d), b = Math.max(1, e.state.duration_frames - 1), v = Z(Number(e.curveZoomX) || 1, 0.1, 50), y = Number(e.curvePanX) || 0, x = b / v, S = y, g = y + x, k = [], _ = Math.max(1, Math.ceil(x / Math.max(80, h))), O = (A) => i ? Fo(i, A) : $e(e.state, A);
  for (let A = 0; A <= b; A += _) k.push({ frame: A, value: O(A) });
  ...
  K = C - R / 2, W = C + R / 2;
  const V = (A) => p + (A - S) / Math.max(1e-6, g - S) * h, X = (A) => f + u * (W - A) / Math.max(1e-6, W - K);
  if (n.fillStyle = "#111114", n.fillRect(0, 0, a, o), n.strokeStyle = "#222228", n.lineWidth = 1, n.font = "9px system-ui, -apple-system, sans-serif", n.fillStyle = "#6e727a", pd(n, {
    ...
    xFor: V,
    frame: e.frame
  }), fd(n, { left: p, right: m, top: f, width: a, graphHeight: u, minimum: K, maximum: W, yFor: X }), K <= 0 && W >= 0) {
    const A = X(0);
  ...
  for (const A of l) {
    ...
    if (e.showCurveHandles)
      for (let F = 0; F < c.length; F++) {
        ...
        const se = i ? Y.transform || i : Y.camera || Y, re = V(Y.frame), de = X(A.get(se)), be = c[F - 1], fe = c[F + 1], ge = Math.max(1, Y.frame - (be?.frame ?? Y.frame - 1)), ye = Math.max(1, (fe?.frame ?? Y.frame + 1) - Y.frame), pe = fi(
          Y,
          A.id,
          be,
          fe,
...
function gs(e) {
  ...
  if (!t) return;
  const a = e.timelineObject(), o = a ? a.name || a.type : e.activeCameraTrack().name, r = Cd(e), n = `${o}\0${r.map((c) => `${c.id}:${c.color}`).join("|")}`;
  if (t.dataset.signature !== n) {
    t.dataset.signature = n, t.replaceChildren();
...
function on(e, t, a) {
  ...
  for (const n of [...e].sort((i, c) => i.frame - c.frame)) {
    ...
    (r === null || !(Math.abs(c - r) <= Ed)) && o.push(n.frame), r = c;
  }
  return o;
}
function Ir(e) {
...
function Md(e, t, a, o, r) {
  t.preventDefault(), t.stopPropagation();
  const { camera: n } = ys(e, a.camera_id);
  e.contextMenu?.show(t, n?.name || s("Shot"), [
    ...
    },
    {
      ...
      disabled: r === 1,
      run: () => {
        e.checkpoint("Remove shot"), hi(e.state, o) && jt(e);
      }
    }
  ]);
}
function Id(e, t, a, o) {
  const { camera: r, color: n } = ys(e, t.camera_id), i = document.createElement("div");
  ...
  if (c.className = "oc-sequence-name", c.textContent = r?.name || t.camera_id, i.appendChild(c), a > 0) {
    ...
    l.className = "oc-sequence-handle", l.title = s("Drag to trim the cut"), l.addEventListener("pointerdown", (p) => $d(e, p, l, o, a)), i.appendChild(l);
  }
  return i.addEventListener("contextmenu", (l) => Md(e, l, t, a, o.__cutCount)), i.addEventListener("pointerdown", () => {
...
function xs(e, t) {
  ...
  if (n.className = "oc-sequence-lane", n.dataset.role = "sequence-lane", n.setAttribute("aria-label", s("Multi-camera edit")), o.length)
    for (const [c, l] of o.entries()) {
      ...
      he(e, l.end + 1) < -5 || p > 105 || n.appendChild(Id(e, l, c, r));
    }
  else {
    const c = document.createElement("span");
  ...
  r.appendChild(n), r.appendChild(Od(e));
  const i = document.createElement("span");
  i.className = "oc-sequence-playhead", i.style.left = `${he(e, e.frame)}%`, r.appendChild(i), t.appendChild(r);
}
const Pd = ['[data-act="curve-zoom-in"]', '[data-act="curve-zoom-out"]', '[data-act="curve-fit"]', '[data-act="curve-handles"]'], nn = { curves: "Graph", dope: "Timeline", sequence: "Sequence" };
function sn(e, t) {
  ...
  a === "dope" ? Ir(e) : a === "sequence" ? (xs(e, n), n?.focus?.({ preventScroll: !0 })) : e.drawCurveEditor(), e.setStatus(s(nn[a]));
}
function Ld(e) {
  e.graphTab === "sequence" && xs(e, e.root.querySelector('[data-role="graph-sequence"]'));
}
function zd(e, t) {
...
const Nd = /* @__PURE__ */ new Set(["good", "warning", "bad", "unknown"]);
function ws(e, t) {
  ...
  for (const n of r.frames) {
    ...
    const c = Nd.has(n?.state) ? n.state : "unknown", l = n?.score;
    let p = null;
    if (l != null) {
      const m = Number(l);
...
function Rd(e) {
  ...
  if (!t || !a) return;
  const o = ws(e.state?.metadata, e.state?.duration_frames), r = o.some((c) => c.state !== "unknown");
...
function Dd(e) {
  ...
  y && (y.textContent = m.name), us(e), ms(e), gs(e), Ir(e), Ld(e), e.refreshCameraSelectors(), e.refreshKeyEditor(), e.updateEditState(), e.drawCurveEditor(), e.perf && (e.perf.timelineRefreshCount = (e.perf.timelineRefreshCount || 0) + 1), Rd(e);
}
class ks {
...
const Gd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/><path d="M2 12h20"/></svg>', Yd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m21 16-9 5-9-5V8l9-5 9 5v8z"/><path d="m3.27 6.96 8.73 4.84 8.73-4.84"/><path d="M12 22V12"/></svg>', Xd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2L2 20h20L12 2z"/><path d="M12 2v18"/></svg>', Jd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/><path d="m17.66 17.66 1.41 1.41"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="m6.34 17.66-1.41 1.41"/><path d="m19.07 4.93-1.41 1.41"/></svg>', Zd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18h6"/><path d="M10 22h4"/><path d="M15.09 14c.18-.98.65-1.74 1.41-2.5A4.65 4.65 0 0 0 18 8 6 6 0 0 0 6 8c0 1 .23 2.23 1.5 3.5.76.76 1.23 1.52 1.41 2.5"/></svg>', Qd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l8 8-4 4-8-8 4-4z"/><path d="M7 11L2 16l6 6 5-5"/><path d="M18 19l4 2"/><path d="M21 16l2 2"/></svg>', em = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m22 8-6 4 6 4V8z"/><rect width="14" height="12" x="2" y="6" rx="2"/></svg>', tm = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14h6v6H4z"/><circle cx="17" cy="7" r="3"/><path d="m6 3 4 7H2z"/></svg>';
function am() {
  return `
...
function im() {
  const e = pl.map((t) => `<button data-lens="${t}">${t}mm</button>`).join("");
  return `
  ...
  return `
    <div class="oc-dope">
      <div class="oc-dope-body">
        <div class="oc-dope-labels">${ds.map((t) => `
...
const Qe = 1, ln = 50, Ie = 120, ut = 160, Em = Object.freeze(["perspective", "orthographic"]), q = Object.freeze({
...
}), _s = Object.freeze(Object.values(q)), we = Object.freeze({
  SCENE_GET: "scene.get",
...
}), Am = Object.freeze(Object.values(we));
...
const Tm = 25, dn = 100;
function bt(e, t) {
  const a = e?.offset === void 0 ? 0 : Number(e.offset), o = e?.limit === void 0 ? Tm : Number(e.limit);
  ...
  switch (t?.type) {
    ...
    case we.HEALTH_GET:
      return Se(e, {
        version: 1,
        type: t.type,
        frames: ws(a.metadata, a.duration_frames)
      });
    case we.ASSET_LIST: {
...
function Rm(e, t) {
  if (!Cs.has(t.objectType))
    throw new I("UNSUPPORTED_OBJECT_TYPE", `object.create does not support type: ${t.objectType}`);
  e.objects ||= [];
  const a = new Set(e.objects.map((i) => i.id)), o = Ro(a, t.objectType, t.id), r = Om(t.objectType), n = {
    id: o,
    type: t.objectType,
    name: t.name || o,
    ...r,
...
function Gm(e, t) {
  ...
  for (a.has(t) && a.delete(t), a.add(t); a.size > Hm; )
...
function Jm(e, t) {
  ...
  if (e.far !== void 0) {
    ...
    const a = e.near === void 0 ? yi : e.near;
    if (e.far <= a)
      throw new I("BAD_VALUE", "camera.far must be greater than camera.near", t);
  }
  if (e.camera_type !== void 0 && !Em.includes(e.camera_type))
...
function Zm(e, t) {
  ...
  switch (a) {
    ...
    case q.OBJECT_CREATE:
      if (ae(e.objectType, "objectType", t), !Cs.has(e.objectType))
...
function Qm(e, t) {
  ...
  return t.operations.forEach((a, o) => Zm(a, o)), {
    version: Qe,
    id: t.id,
...
const tp = "omnicam/library", ap = "majoor_omnicam/blockout_library", op = Object.freeze({
...
function Es(e) {
  return e.file ? `${e.source === "legacy" ? ap : tp}/${e.file} [input]` : "";
}
function mn(e, t, a) {
  const o = e || "asset";
  let r = `${o}_${a}`, n = 2;
...
function sp(e, t = {}) {
  ...
  const a = rp(t.point, [0, 0, 0]), o = String(t.idSeed || Date.now().toString(36)), r = String(e.kind || "prop"), n = r === "character", i = op[e.id];
  ...
  return n && (c.character = np(e)), c;
}
function ip({ groundHit: e, orbitTarget: t } = {}) {
...
const cp = {
  [q.ASSET_INSTANTIATE](e, t) {
    ...
    let o;
    try {
      o = sp(t.asset, { point: t.point, idSeed: t.id, existingIds: a });
    } catch (r) {
  ...
  [q.OBJECT_SET_TAGS](e, t) {
    const a = it(e, t.objectId), o = wi(t.tags), r = o.length !== t.tags.length ? "some tags were dropped or normalised" : void 0;
    return o.length ? a.tags = o : delete a.tags, { dirtyMask: T.outliner | T.inspector | T.viewport, warning: r };
  },
  [q.OBJECT_SET_ANNOTATION](e, t) {
    const a = it(e, t.objectId), o = t.annotation === null ? null : Vn(t.annotation);
    if (t.annotation && !o)
  ...
  [q.CHARACTER_SET_JOINT_ROTATION](e, t) {
    ...
    return a.character = {
      ...a.character || {},
      pose: xi(a.character?.pose, t.joint, t.rotation)
    }, { dirtyMask: T.viewport | T.previews | T.inspector };
  },
...
function lp({ state: e, operation: t }) {
  const a = cp[t.type];
...
function mp(e, t) {
  ...
  return fp(e, t, r), up(e, t, r), gp(e, t, r), bp(e, t, r), yp(e, t, r), vp(e, t, r), { changes: a, truncated: o };
}
const pp = ["fov", "roll", "zoom", "near", "far", "camera_type"];
function fp(e, t, a) {
...
const hp = ["position", "target", "fov", "roll", "zoom", "near", "far", "camera_type"];
function up(e, t, a) {
  const o = et(e?.cameras), r = et(t?.cameras);
  for (const [n, i] of r) {
...
function _p(e, t) {
  ...
  for (let f = 0; f < a.operations.length; f += 1)
    try {
      const d = lp({ ui: e, state: r, operation: a.operations[f] });
  ...
  if (a.validateOnly) {
    const { changes: f, truncated: d } = mp(e.state, r);
    return {
      ok: !0,
      version: Qe,
      revision: o,
  ...
  const l = wp(e);
  Gm(e, a.id), e.serialize?.(), kp(e, l), jp(e, n, `director-api:${a.id}`);
  const p = {
    ok: !0,
    version: Qe,
    baseRevision: o,
...
function Ep(e) {
  return e.directorApi = Cp(e), e.directorApi;
}
const fn = "omnicam-agent/1", hn = "majoor.omnicam.agent.request", Ap = 1, Dt = Object.freeze({
...
}), Tp = 1e4, $p = 5e3, As = "asset.instantiate_by_id", Ts = "asset.catalog_search", un = Object.freeze([
  ..._s.filter((e) => e !== q.ASSET_INSTANTIATE),
  As
]);
function pr(e) {
...
function Pp(e, t, a) {
  ...
  async function v(S) {
    const g = S?.detail;
    if (o || !g || g.protocol !== fn || Number(g.schema_version) !== Ap || g.session_id !== r || String(g.node_id) !== String(t.id)) return;
    let k;
    try {
      if (g.kind === "query")
        k = g.payload?.type === Ts ? await Op(e, g.payload) : e.directorApi.query(g.payload);
        ...
        if (!Number.isInteger(_?.baseRevision) || _.baseRevision < 0)
          ...
          const P = await Ip(e, _.operations);
...
function Pr({ fetchApi: e = Lp } = {}) {
  const t = (a, o) => Promise.resolve(e(a, o)).then(zp);
  return {
    list(a = {}) {
...
const $s = Object.freeze(["all", "character", "prop", "environment", "vehicle"]);
function gn(e = {}) {
  const t = String(e.kind || "all").toLowerCase();
  return {
    kind: $s.includes(t) ? t : "all",
...
const Kp = 256;
function yn(e = {}) {
  const { THREE: t, GLTFLoader: a, FBXLoader: o, size: r = Kp } = e;
  if (!t || !a)
...
function Vp(e, t = {}) {
  return $s.map((a) => {
    const o = s(Wp[a] || a), r = a === "all" ? "" : ` <span class="oc-asset-kind-n">${Number(t[a] || 0)}</span>`;
    return `<button type="button" class="oc-asset-kind${a === (e || "all") ? " active" : ""}" data-asset-kind="${a}">${St(o)}${r}</button>`;
  }).join("");
}
function Hp(e, { selected: t = !1, thumbUrl: a = "" } = {}) {
  const o = Up[e.kind] || "pi-box", r = e.kind === "character" && Hn(e.rig) === "rigged" ? `<span class="oc-asset-badge">${s("RIGGED")}</span>` : "", n = a ? `<img class="oc-asset-thumb" src="${St(a)}" alt="" loading="lazy">` : `<span class="oc-asset-thumb oc-asset-thumb--glyph"><i class="pi ${o}"></i></span>`;
...
function Gp(e, { selectedId: t = "", thumbUrls: a = {} } = {}) {
  return !e || !e.length ? `<p class="oc-asset-empty">${s("No assets match this filter.")}</p>` : e.map((o) => Hp(o, {
    selected: o.id === t,
    thumbUrl: a[o.id] || ""
  })).join("");
}
...
function Yp(e, t = {}) {
  const a = e.root, o = t.fetchApi || ((L, U) => (e.api || e.app?.api).fetchApi(L, U)), r = t.apiClient || Pr({ fetchApi: o }), n = t.store || Fp(r), i = Rp(), c = t.previewQueue || Dp(), l = e.api || e.app?.api || null;
  let p = t.thumbnailRenderer || null, m = null;
  const f = /* @__PURE__ */ new Set();
  function d() {
    return p ? Promise.resolve(p) : (m || (m = Bp().then((L) => p = yn(L)).catch(() => p = yn({}))), m);
  }
  function h(L) {
    return Hr(l, Es(L));
  }
    ...
    for (const L of n.state.items) {
      ...
      U && c.enqueue(L.id, async () => {
        ...
        if (i.set(L.id, je), Y(), !(L.source && L.source !== "user"))
          try {
            const Oe = await r.uploadThumbnail(L.id, qp(je));
  ...
  let F = !1;
  function Y() {
    if (S && (S.innerHTML = Vp(n.state.filter.kind, n.state.kinds)), x) {
      const L = {};
      for (const U of n.state.items) {
        const me = i.get(U.id) || u(U);
        me && (L[U.id] = me);
      }
      x.innerHTML = Gp(n.state.items, { selectedId: oe, thumbUrls: L });
    }
    if (!F) {
      F = !0;
      try {
  ...
  async function fe(L) {
    ...
    try {
      ...
      A(
        s("{n} character(s) installed{extra} — no restart needed").replace("{n}", Oe).replace("{extra}", je || De ? ` (${je} ${s("skipped")}${De ? `, ${De} ${s("unchanged")}` : ""})` : ""),
        { sticky: !0 }
...
function af(e, t = {}) {
  ...
  function y(C) {
    ...
    return Si({ preset: R, overrides: C?.pose }).joints;
  }
  function x() {
    const C = h();
  ...
  function S() {
    ...
    l && (l.textContent = C);
    const V = h(), X = y(V?.character)[C] || [0, 0, 0, 1], N = ji(X);
    p.forEach((A, G) => {
  ...
  function _() {
    const C = b();
    if (!C) return;
    const R = p.map((N) => Number(N?.value) || 0), V = ki(R), X = e.directorApi?.execute({
      version: 1,
  ...
  async function P() {
    ...
    const V = R.toLowerCase().replace(tf, "-").replace(/^-+|-+$/g, "").slice(0, 60) || "pose";
    try {
...
const rf = /* @__PURE__ */ new Set(["translate", "rotate", "scale"]), nf = /* @__PURE__ */ new Set(["world", "local"]), Ue = 180 / Math.PI;
function kn(e) {
  return [e.x, e.y, e.z];
}
function sf(e) {
...
function cf({
  ...
  const m = p ? p() : new e.Object3D(), f = l ? l(t, a) : new Yl(t, a);
  let d = null;
  ...
  function x(N) {
    return u ? {
      position: N.position.map((A, G) => A - u.position[G]),
      rotationDeg: N.rotationDeg.map((A, G) => A - u.rotationDeg[G]),
      scaleFactors: N.scale.map((A, G) => u.scale[G] === 0 ? 1 : A / u.scale[G])
  ...
  function W(N) {
    if (!rf.has(N)) throw new Error(`createTransformControlsAdapter: unknown mode "${N}"`);
    f.setMode ? f.setMode(N) : f.mode = N;
  }
  function H(N) {
    if (!nf.has(N)) throw new Error(`createTransformControlsAdapter: unknown space "${N}"`);
    f.space = N;
  }
  function oe(N) {
...
function df(e, { controlsFactory: t, anchorFactory: a } = {}) {
  let o = null, r = null;
  function n() {
    return o || (!e.webgl || !e.interactionElement ? null : (o = cf({
      THREE: Gl,
  ...
  function i({ targetSpec: k }) {
    if (k) {
      if (k.type === "object") {
        ...
        const _ = Ci(e), O = (_.length ? _ : [k.object]).map((K) => ({
          object: K,
          transform: He(K)
        }));
  ...
  function m(k) {
    ...
    _.keyframes = Ai(r.baseKeys, r.selectedFrames, O), l(_);
  }
  function f(k) {
    const _ = e.state.cameras.find((O) => O.id === r.trackId);
    _ && (_.keyframes = Ti(r.baseKeys, [r.frame], { delta: k.position }), l(_));
  }
  function d({ delta: k }) {
  ...
  function b(k) {
    ...
    r.tracking ? Ei(e, _) : e.camera.target = _, e.commitCameraEdit();
  }
  ...
  function y() {
    ...
    const k = e.recording ? null : _i(e), _ = e.state.gizmo_mode || "translate";
    if (!(!!k && !k.readOnly && lf.has(k.type) && k.allowedModes.includes(_))) {
      o?.detach();
      return;
    }
...
function mf(e, t) {
  ...
  const a = e.activeCameraTrack(), o = Zl(t, {
...
function pf(e, t) {
  ...
  const o = Jl(a, { type: t, intensity: 1, duration_frames: e.state.duration_frames });
...
function gf(e, t, a, o) {
  const r = Do(e, a, o);
  if (!r) return;
  const { rx: n, ry: i, radarSize: c, cx: l, cy: p, innerRadius: m, range: f, scale: d, camPos: h, camTgt: u, cameras: b, activeTrack: v } = r, y = Et(e), x = e.state.active_camera_id || v?.id, S = (re, de) => Is(r, re, de);
  ...
  const [_, O] = S(h[0] || 0, h[2] || 0), [P, K] = S(u[0] || 0, u[2] || 0), W = 8, H = Z(_, n + W, n + c - W), oe = Z(O, i + W, i + c - W), C = Z(P, n + W, n + c - W), R = Z(K, i + W, i + c - W), V = h[1] || 0, X = uf(V), N = bf(V);
...
function Ps(e, t, a, o) {
  const { camPos: r, camTgt: n, cameras: i, rx: c, ry: l, radarSize: p } = t, m = (v, y) => Is(t, v, y), [f, d] = m(r[0] || 0, r[2] || 0);
...
function wf(e, t, a, o) {
  ...
  const m = Os(r, a, o), f = Ps(e, r, a, o), [d, h] = fr(r, a, o);
...
function Sf(e, t, a) {
  ...
  }, { signal: a }), cd(e, a), zd(e, a), t('[data-role="curve-group"]')?.addEventListener("change", () => {
    e.setChannelFilter("all"), gs(e), e.drawCurveEditor(), Ir(e);
  ...
  e.root.addEventListener("pointerdown", (d) => {
    ...
    const h = e.interactionElement.getBoundingClientRect(), u = (d.clientX - h.left) * e.canvas.width / Math.max(1, h.width), b = (d.clientY - h.top) * e.canvas.height / Math.max(1, h.height);
    kf(e, d, u, b) || e.onWheel(d);
  }, { passive: !1, signal: a }), e.root.addEventListener("wheel", Ul(e.root), { signal: a }), window.addEventListener("pointermove", (d) => {
  ...
  const p = (d) => {
    const h = Ii(d.composedPath?.()[0] || d.target);
    h && (e.lastKeyZone = h);
  };
  e.root.addEventListener("focusin", p, { signal: a }), e.root.addEventListener("pointerdown", p, { capture: !0, signal: a }), e.root.addEventListener("focusout", (d) => {
    e.modalTransform && !e.root.contains(d.relatedTarget) && ($i(e), e.render());
  }, { signal: a });
...
function Cf(e) {
  const t = Sc(e.id, e.defaultValue), a = `pref_${e.id.replace(/[^a-zA-Z0-9]/g, "_")}`;
  if (e.type === "boolean")
    return `
...
function Af() {
  return `<span class="oc-pref-emoji" aria-hidden="true">${jf}</span> ${s("OmniCam Preferences")}`;
}
function Tf(e) {
  ...
  a.className = "oc-modal-backdrop", a.setAttribute("role", "dialog"), a.setAttribute("aria-modal", "true"), a.setAttribute("aria-label", s("OmniCam Preferences")), a.innerHTML = `
    <div class="oc-modal-dialog oc-pref-dialog" tabindex="-1">
      <div class="oc-pref-header">
        <div class="oc-pref-title">${Af()}</div>
...
const Mf = ["position", "target"], If = ["fov", "zoom"], Of = ["roll"], Pf = ["position", "size"], Lf = ["rotation"];
function hr(e) {
...
function qf(e, t) {
  ...
  const o = (r) => {
    ...
    const u = (v) => {
      ...
      let x = Df;
      v.shiftKey ? x = Kf : (v.ctrlKey || v.metaKey) && (x = Bf);
      const S = p * x * 20;
      let g = l + y * S;
...
function Ls(e) {
  ...
  p && o?.fov != null && (p.textContent = fl(o.fov));
...
function Gf(e, t) {
  ...
  }, n = (i) => (e.smoothingBaseline?.cameraId !== i.id && (e.smoothingBaseline = { cameraId: i.id, keys: Rf(i.keyframes) }), e.smoothingBaseline.keys);
  a.addEventListener("input", r, { signal: t }), a.addEventListener("change", () => {
    const i = e.activeCameraTrack();
    if (!i) return;
    e.checkpoint("Path smoothing");
    const c = Number(a.value) / 100, l = Ff(n(i), c);
  ...
  if (a.length) {
    ...
    for (const o of a)
      o.addEventListener("change", () => {
        e.dopeChannels = new Set(a.filter((r) => r.checked).map((r) => r.dataset.dopeChannel)), ms(e);
      }, { signal: t });
  }
}
function Zf(e, t) {
...
const go = () => import("./chunk-CUzcrIkj.js");
function eh(e, t) {
...
function th(e, t) {
  ...
  jc().then((r) => {
    ...
    c === "health-slow" ? Cc(e) : c === "health-smooth" ? Ec(e) : c === "health-recenter" && Ac(e);
  }, { signal: t });
...
function nh(e, t) {
  eh(e, t), Hf(e, t), Gf(e, t), Yf(e, t), Xf(e, t), ah(e, t), rh(e, t), oh(e, t), qf(e, t), Uf(e, t), Jf(e, t), Qf(e, t), Vf(e, t), Zf(e, t), th(e, t);
}
const Tn = {
...
}, zs = "balanced", Qo = "#121212";
function Lr(e) {
  return Tn[e] || Tn[zs];
}
function sh(e, t = "#1b1f2b", a = "#151822", o = "#1e2330", r = "#161922", n = "#111319") {
...
function Ng(e, t, a = zs) {
  ...
  const h = new e.FogExp2(1250588, 8e-3), u = sh(e), b = new e.PMREMGenerator(t);
  b.compileEquirectangularShader();
  const v = new Xl(), y = b.fromScene(v, 0.04).texture;
  return v.traverse((x) => {
    x.geometry?.dispose?.();
...
function ch(e) {
  ...
  const r = e.reconstruction, n = r.provider || "Reconstructed", i = Math.round(t * 100), c = gl(e), l = c.length ? `
` + c.map(([m, f]) => `${m}: ${f}`).join(`
`) : "", p = `${n} • ${o} (${i}%)${l}`;
  return {
    label: o,
...
function Dg(e, t, a) {
  return e?.reconstruction ? a ? "neutral" : lh(t) === "source_texture" ? "textured" : "neutral" : null;
}
function dh(e, t) {
...
function mh(e, t, a) {
  ...
  if (o) {
    const n = (i) => {
      const c = i.target.closest?.("[data-axis], [data-axis-center]") || i.target, l = c.getAttribute("data-axis"), p = Tc(l?.toLowerCase(), e.state.view_mode);
  ...
  for (const n of e.root.querySelectorAll("[data-lens]"))
    n.addEventListener("click", () => {
      yl(e, Number(n.dataset.lens));
    }, { signal: a });
  for (const n of e.root.querySelectorAll("[data-blocking-scene]"))
    n.addEventListener("click", () => {
      hf(e, n.dataset.blockingScene), e.closeMenus();
    }, { signal: a });
...
const ph = 32, fh = 0.025, hh = 0.05, $o = 1e-6, uh = ["top", "bottom", "front", "back", "left", "right"], bh = {
  top: "y",
  bottom: "y",
  front: "z",
  back: "z",
...
function wh(e) {
  ...
  const n = Math.min(ph, r.length, o + 1);
  if (n < 2) return [];
  const i = yh(r, n);
  ...
  ], p = e.planeAxis === "y" ? Ns(l) : Fs(l, [0, 0, -1]), m = e.seedPoint ? 1 : 0, f = [];
  for (let d = m; d < i.length; d++) {
    const h = i[d], u = vh(i, d, p, e.planeAxis), b = ce(c);
    b.position = [...h], b.target = xh(h, u, l, e.planeAxis), f.push({
...
function Rs(e, t = e.cameraPathDraw) {
  const a = t?.pointerId;
  if (a != null)
    try {
...
function Mn(e, t = {}) {
  ...
  if (a === "extend") {
    ...
    uh.includes(e.state.view_mode) || e.setViewMode?.("top"), c = $n(e.state);
  const m = bh[e.state.view_mode] ?? null, f = n ? [...n] : [...r.position];
...
function Fr(e, t) {
  ...
  return r && Nr(r, o) < fh ? !1 : (a.points.push(o), !0);
}
function We(e) {
  const t = e.cameraPathDraw;
  return t?.active ? (Rs(e, t), e.cameraPathDraw = null, Ht(e), e.setStatus?.(s("Draw Camera Path cancelled")), e.render?.(), !0) : !1;
}
function Sh(e) {
  const t = e.cameraPathDraw;
  ...
  if (a.length < 2 || gh(a) < hh || t.range[1] <= t.range[0])
  ...
  const r = vl(e.state), n = e.state.cameras.length, i = {
    id: r,
    name: kh(e.state),
...
function Eh(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : (Io(t), t.type === "pointercancel" || t.type === "lostpointercapture" ? (We(e), !0) : (Fr(e, Rr(e, t)), a.drawing = !1, Sh(e), !0));
}
function Ah(e) {
  const t = e.cameraPathDraw;
...
async function Mh(e) {
  ...
  const o = a?.metadata?.scene_name || Ds(e);
  Dr(e, a, { name: o, status: s("Scene reset to last save") });
}
async function Ih(e) {
  const t = Ds(e) || s("Untitled"), a = await Yt(e, s("Save Scene"), s("Scene name"), t);
  if (a == null) return;
...
function Lh(e, t) {
  vo(e, t, e.root.querySelectorAll('[data-act="scene-new"]'), () => $h(e)), vo(e, t, e.root.querySelectorAll('[data-act="scene-open"]'), () => Oh(e)), vo(e, t, e.root.querySelectorAll('[data-act="scene-save"]'), () => Ih(e)), vo(e, t, e.root.querySelectorAll('[data-act="scene-reset"]'), () => Mh(e));
}
const zh = ["world_point", "object_point", "camera_field"], In = 40;
function Nh(e) {
...
function Dh(e) {
  ...
  if (!c) return;
  const l = Ks(t, e.state.width || 1280, e.state.height || 720), p = (v) => l.x + v * l.w, m = (v) => l.y + v * l.h;
  ...
  for (const v of e.state.motion_layers || []) {
    if (v.enabled === !1) continue;
    const y = zh.includes(v.source_kind), x = y ? Fh(e.state, v, d) : Nh(v);
...
function Kh(e, t) {
  ...
  a && a.addEventListener("click", (o) => {
    ...
    const n = Ks(a, e.state.width || 1280, e.state.height || 720), i = a.width / r.width, c = {
...
function Bh(e) {
  ...
  Ic(e, t), Oc(e, t), Kh(e, t), $f(e, a, t), mh(e, a, t), wl(e, t), Th(e, t), Lh(e, t), Sf(e, a, t), nh(e, t);
}
function qh(e, t) {
...
const lt = 1024 * 1024, Vh = Object.freeze({
  card: 128 * lt,
  // MAX_CARD_BYTES
  model: 256 * lt,
  // MAX_MODEL_BYTES
...
async function Xh(e, { load: t = () => import("./vendor-mediabunny-CZ5VNE-V.js") } = {}) {
...
async function Zh(e, t, { decode: a = Xh } = {}) {
  if (!t) return;
  const o = Jt(t, "audio");
  if (o) {
    e.setStatus(o);
  ...
  try {
    ...
    n.preload = "auto", n.src = r, e.audioObjectUrl = r, e.audioElement = n, await Jh(n), e.audioDuration = Number.isFinite(n.duration) ? n.duration : 0;
    try {
...
const Us = /* @__PURE__ */ new WeakSet(), Wt = /* @__PURE__ */ new WeakMap();
function Po(e) {
...
function eu(e) {
  ...
  Wt.delete(e), Us.has(e) && Po(e);
}
function Zt(e, t) {
  const a = e.cardMediaById.get(t);
  a && (e.cardMediaById.delete(t), e.cardMediaAssetById?.delete?.(t), t === "subject" && e.cardMedia === a && (e.cardMedia = null), eu(a));
}
function tu(e) {
...
function tt(e, t, a, o = !1, r = "") {
  ...
  n && n !== a && Zt(e, t), o && Us.add(a), Qh(a), e.cardMediaAssetById ||= /* @__PURE__ */ new Map(), e.cardMediaById.set(t, a), e.cardMediaAssetById.set(t, r || a?.__omnicamAsset || "");
  try {
    a.__omnicamAsset = r || a.__omnicamAsset || "";
  } catch {
  }
...
function Ws(e, t, { signal: a, timeout: o = 15e3 } = {}) {
...
async function Vs(e, t, a, o = () => !0, r = null) {
  if (!t || !a) return;
  const n = () => !e.disposed && o(), i = String(t.asset || a).toLowerCase();
  if (r ?? /\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/.test(i)) {
    const l = document.createElement("video");
    if (l.src = a, l.loop = !0, l.muted = !0, l.playsInline = !0, await Ws(l, ["loadeddata", "error"], { signal: e.abortController?.signal }).catch(() => {
    }), !n()) {
      Po(l);
      return;
    }
...
async function lu(e) {
    ...
    if (h) {
      if (d === "image" || d === "video") {
        ...
        if (u && u.value) {
          ...
          if (S) {
            const g = await Vs(e, S, x, r, v);
            if (!r()) return;
            S.asset = vt(b, y);
            let k = null;
            if (v)
              try {
                k = await au(b, o.signal);
              } catch (_) {
  ...
  kl(e) && (n = !0), n && (e.serialize(), e.render());
}
const du = ["video/mp4;codecs=avc1.42E01E", "video/webm;codecs=vp9", "video/webm;codecs=vp8", "video/webm"], zn = { low: 3e6, balanced: 6e6, high: 12e6 };
function mu(e) {
  ...
  try {
    for (const S of du)
      if (!(n.isTypeSupported && !n.isTypeSupported(S)))
        try {
          f = new n(m, { mimeType: S, videoBitsPerSecond: mu(r) });
          break;
        } catch {
        }
...
async function hu(e) {
  await Promise.all([...e].filter((t) => t instanceof HTMLVideoElement && t.seeking).map((t) => Ws(t, ["seeked", "error"], { timeout: 5e3 }).catch(() => {
  })));
}
async function Hs(e) {
  await hu(e.cardMediaById.values());
}
async function Gs(e) {
  return pu({
    canvas: e.canvas,
...
async function Ys(e, t) {
  const a = await fu(at, t);
  if (Wh(e, t), e.state.playblast_camera_id === rs)
...
async function bu(e) {
  ...
  const t = e.frame, a = e.canvas.width, o = e.canvas.height, r = uu(e);
  (r.width !== e.canvas.width || r.height !== e.canvas.height) && (e.canvas.width = r.width, e.canvas.height = r.height, e.render());
  try {
    let n = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-CvIplLAW.js");
    i !== "realtime" && await l(e.canvas.width, e.canvas.height) && (n = await c(e.canvas, e.state.duration_frames, e.state.fps, async (p) => {
      e.setFrame(p, !0), e.setStatus(s(`Encoding frame ${p + 1}/${e.state.duration_frames}…`)), await Hs(e), await new Promise((m) => requestAnimationFrame(m));
    }, e.abortController?.signal, e.state.playblast_quality)), n || (e.setStatus(s("WebCodecs unavailable; recording realtime fallback…")), n = await Gs(e)), e.setFrame(t), await Ys(e, n);
  } catch (n) {
...
async function yu(e, t) {
  ...
  let r = null;
  try {
    if (e.setStatus(`Uploading background: ${t.name}`), r = await Xs(t), o !== e.backgroundRequestId || e.disposed) {
      await Lo([r]);
      return;
    }
    const n = Ze(r.path);
...
async function vu(e, t) {
  ...
  try {
    ...
    for (const c of t)
      if (n.push(await Xs(c)), r !== e.backgroundRequestId || e.disposed) {
        await Lo(n);
        return;
      }
...
function wu(e) {
  ...
  for (const m of a) {
    ...
    r.fillStyle = "rgba(16,17,22,0.82)", ku(r, _, O, g, k, 4 * c), r.fill(), v && (r.strokeStyle = v, r.lineWidth = Math.max(1, c), r.stroke()), r.fillStyle = v || "#e6e6ec", r.fillText(f, _ + y, O + k - x - 2 * c);
  }
  r.restore();
}
function ku(e, t, a, o, r, n) {
...
function ju(e) {
  ...
  return e._pointFieldCache?.key !== r && (e._pointFieldCache = { key: r, ...Pc(t, a, o) }), e._pointFieldCache;
}
const _u = 600;
function Cu(e) {
  const { points: t, colors: a } = ju(e);
  if (!t.length) return;
  const o = e.viewportCamera(), r = e.canvas.width, n = e.canvas.height, i = t.length / 3, c = 3 * Math.max(1, Math.ceil(i / _u)), l = /* @__PURE__ */ new Map();
...
function zu(e) {
  ...
  e.recording && e.state.playblast_labels && wu(e);
}
async function Nu(e, { signal: t } = {}) {
...
async function Ru(e) {
  ...
  const r = o.diagnostic?.issues || [], n = Fu(r);
...
function Qs(e) {
  ...
  const r = (d, h, u, b, v = "") => {
    ...
    `, v.addEventListener("click", () => {
      e.outlinerCollapsedSections ||= /* @__PURE__ */ new Set(), e.outlinerCollapsedSections.has(u) ? e.outlinerCollapsedSections.delete(u) : e.outlinerCollapsedSections.add(u), Qs(e);
  ...
  if (m) {
    ...
    if (t.appendChild(x), !S)
      for (const { object: g, level: k } of y) {
        ...
        const R = document.createElement("span");
        R.style.cssText = H ? "color:#fca5a5" : W ? "" : "opacity:.5;text-decoration:line-through", R.textContent = g.name || g.type, R.title = s("Double-click to rename"), R.addEventListener("dblclick", (A) => {
          A.preventDefault(), A.stopPropagation(), Wu(e, g, R);
        }), C.appendChild(R);
        ...
        if (H) {
          const A = document.createElement("span");
          A.style.cssText = "color:#ef4444;font-size:9px;font-weight:700", A.textContent = " [Format!]", C.appendChild(A);
        }
        const X = document.createElement("div");
        X.className = "scene-item-actions", X.appendChild(r(W ? "pi-eye" : "pi-eye-slash", W ? "Hide object (Alt+Click to Isolate)" : "Show object (Alt+Click to Isolate)", !W, (A) => {
          if (A?.altKey) {
            ...
            e.toggleObject(g.id);
        }, "color:#ef4444;opacity:.7")), X.appendChild(r(g.locked ? "pi-lock" : "pi-lock-open", "Lock object", g.locked, () => zr(e, g))), X.appendChild(r("pi-copy", "Duplicate object", !1, () => e.duplicateObject?.(g.id))), g.id !== "subject" && X.appendChild(r("pi-trash", "Delete object", !1, () => e.deleteObject?.(g.id))), X.appendChild(r("pi-ellipsis-v", "Object actions", !1, (A) => e.openObjectContext(A, g.id))), _.append(oe, C, X), _.title = s("Click to select · Double-click to toggle visibility · Right-click for actions");
        const N = (A = {}) => {
  ...
  if (v) {
    ...
    for (; V; ) {
      ...
      for (const A of e.state.objects)
        !R.has(A.id) && A.parent_id && R.has(A.parent_id) && (R.add(A.id), V = !0);
    }
    const X = e.state.objects.filter((A) => !R.has(A.id)), N = `P${Jr()}${C}${X.map((A) => `${A.id} ${A.name || A.type}`).join("|")}`;
    tr(v, N, () => [
      qt("", s("No parent")),
      ...X.map((A) => qt(A.id, A.name || A.type))
    ], t.parent_id || "");
  }
...
function tb(e) {
  ...
  e.beginCameraEdit(), Lc(e.camera, r), e.commitCameraEdit(), e.finishCameraEdit(), oi(e), eb(e), e.render();
}
function ab(e) {
  const t = globalThis.performance?.now?.() ?? Date.now();
  (!Number.isFinite(e.lastCameraHudEditAt) || t - e.lastCameraHudEditAt > 300) && e.checkpoint("Edit camera"), e.lastCameraHudEditAt = t;
  ...
  e.camera.position = [a("camera-px", e.camera.position[0]), a("camera-py", e.camera.position[1]), a("camera-pz", e.camera.position[2])], e.camera.target = [a("camera-tx", e.camera.target[0]), a("camera-ty", e.camera.target[1]), a("camera-tz", e.camera.target[2])], e.camera.fov = Z(a("camera-fov", e.camera.fov), 5, 150), e.camera.roll = Z(a("camera-roll", e.camera.roll || 0), -180, 180), e.camera.near = Math.max(1e-4, a("camera-near", e.camera.near)), e.camera.far = Math.max(e.camera.near + 1e-4, a("camera-far", e.camera.far)), e.beginCameraEdit(), e.commitCameraEdit(), e.finishCameraEdit(), oi(e), e.render();
}
function ob(e, t) {
  const a = Qt(e);
  if (!a) return;
...
const jb = ["guides", "safe-areas", "resolution-gate", "aspect-ratio"];
function _b(e) {
...
function Ab(e) {
  ...
  if (f) {
    const h = Math.max(1, e.state?.fps || 24), u = a ? a.frame : e.frame, b = Math.floor(u / h), v = u % Math.round(h), y = String(Math.floor(b / 3600)).padStart(2, "0"), x = String(Math.floor(b % 3600 / 60)).padStart(2, "0"), S = String(b % 60).padStart(2, "0"), g = String(v).padStart(2, "0");
    f.textContent = `${y}:${x}:${S}:${g} (${u}f)`;
  }
  if (!a) return;
  if (t) {
...
function $b(e) {
  ...
  if (t.interpolation = e.root.querySelector('[data-role="key-interp"]').value, t.camera.position = [a("key-px", t.camera.position[0]), a("key-py", t.camera.position[1]), a("key-pz", t.camera.position[2])], t.camera.target = [a("key-tx", t.camera.target[0]), a("key-ty", t.camera.target[1]), a("key-tz", t.camera.target[2])], t.camera.fov = Z(a("key-fov", t.camera.fov), 5, 150), t.camera.roll = Z(a("key-roll", t.camera.roll || 0), -180, 180), t.camera.zoom = Math.max(0.01, a("key-zoom", t.camera.zoom || 1)), t.camera.near = Math.max(1e-4, a("key-near", t.camera.near)), t.camera.far = Math.max(t.camera.near + 1e-4, a("key-far", t.camera.far)), t.camera.camera_type = e.root.querySelector('[data-role="key-camera-type"]').value, e.root.querySelector('[data-role="key-timing-weight"]')) {
    const r = zc(t, a("key-timing-weight", ns(t)));
...
function gr(e, t, a) {
  const o = Re(e), r = t ? Re(t) : o, n = a ? Re(a) : o, i = Math.max(br, Te(e?.frame) - Te(t?.frame, Te(e?.frame) - 1)), c = Math.max(br, Te(a?.frame, Te(e?.frame) + 1) - Te(e?.frame)), l = [0, 0, 0], p = [0, 0, 0];
  for (let m = 0; m < 3; m += 1) {
...
function si(e, t, a) {
  const o = Re(e), r = vr(e, t, a);
  mt(e, "out", Ct(r.out, o)), mt(e, "in", Ct(r.in, o));
}
function Pb(e, t, a, { prevKey: o = null, nextKey: r = null, breakCoupling: n = !1 } = {}) {
  if (!e || t !== "in" && t !== "out") return e;
  let i = dt(e);
  if (i === "corner") return e;
  i === "auto" && (i = "aligned", e.tangents = e.tangents && typeof e.tangents == "object" ? e.tangents : {}, e.tangents.spatial_mode = "aligned", si(e, o, r));
  const c = Re(e), l = Ct([
    Te(a?.[0]),
    Te(a?.[1]),
    Te(a?.[2])
  ], c);
  if (No(e), mt(e, t, l), i === "aligned" && !n) {
...
function wo(e, t, a) {
  if (!e || t !== "in" && t !== "out") return e;
  const o = Re(e);
  return No(e), mt(e, t, Ct([
    Te(a?.[0]),
    Te(a?.[1]),
    Te(a?.[2])
  ], o)), e;
}
function Lb(e, t, { prevKey: a = null, nextKey: o = null } = {}) {
  ...
  if (t === "corner") {
    const r = ni(e, a, o);
    return No(e), mt(e, "out", r.out), mt(e, "in", r.in), e;
  }
  return No(e), si(e, a, o), e;
}
function zb(e) {
  switch (e) {
    case "auto":
...
function Fb(e) {
  ...
  return {
    ...
    restoreHistorySnapshot(z) {
      ...
      this.state = ht($.state);
      const E = new Set(this.state.objects.map((J) => J.id));
      for (const J of w) E.has(J) || this.removeObjectResources(J);
      ...
      const Q = new Set(this.timelineKeyframes().map((J) => J.frame)), D = Array.isArray($.selectedKeyFrames) ? $.selectedKeyFrames : [$.selectedKeyFrame].filter((J) => J != null);
      this.selectedKeyFrames = new Set(D.filter((J) => Q.has(J))), this.selectedKeyFrame = this.selectedKeyFrames.has($.selectedKeyFrame) ? $.selectedKeyFrame : [...this.selectedKeyFrames].at(-1) ?? null, this.pathSelection = Nc(this.pathSelection, this.activeCameraTrack()), this.subSelection = $.subSelection || null, this.camera = nt(this.state, this.frame), Vt(this, this.activeCameraTrack(), this.camera, this.frame), this.cameraPreviewSignature = "", this.serialize(), j !== Rn(this.state) && this.restoreAssets(), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
    },
    checkpoint(z) {
    ...
    onContextMenu(z) {
      ...
      const $ = z.target, j = $.closest?.(".camera-preview-tile"), w = $.closest?.(".scene-item"), E = $.closest?.(".key");
      ...
      if (E) {
        const M = this.timelineKeyframes().find((B) => B.frame === Number(E.dataset.keyFrame));
      ...
      if ($.closest?.(".viewport-wrap")) {
        const M = this.interactionElement.getBoundingClientRect(), B = (z.clientX - M.left) * this.canvas.width / Math.max(1, M.width), Q = (z.clientY - M.top) * this.canvas.height / Math.max(1, M.height), D = this.pickSceneObject([B, Q]);
        if (D) {
    ...
    openObjectContext(z, $) {
      ...
      const w = ["sun_light", "point_light", "spot_light"].includes(j.type), E = this.selectedObjectIds?.size || 0;
      if (E >= 2 && this.selectedObjectIds.has($)) {
        this.showContextMenu(z, `${E} ${s("objects selected")}`, [
    ...
    openPathKeyContext(z, $, j) {
      ...
      const E = (w.keyframes || []).find((J) => J.frame === j) || null;
      E && this.selectKeyframe(E), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
      const M = E ? dt(E) : "auto", B = this.selectedKeyFrames?.size || 0, Q = this.pathSelection?.component === "target", D = es(w);
      this.showContextMenu(z, `Path key F${j}`, [
        ...
        null,
        {
          ...
          items: [
            { label: s("Position"), checked: !Q, run: () => this.setPathSelectionComponent("position") },
            {
              label: s("Target"),
              checked: Q,
              disabled: D,
    ...
    moveShot(z, $) {
      ...
      const [E] = this.state.cameras.splice(j, 1);
    ...
    openTimelineContext(z, $) {
      const j = this.selectedKeyFrames?.size || 0, w = this.selectedKeyframe(), E = w?.interpolation || "ease", M = w && dt(w) || "auto", B = ["ease", "linear", "bezier", "smooth", "ease_in", "ease_out", "sine", "cubic", "quintic", "expo", "back"], Q = ["auto", "clamped", "vector", "free", "aligned", "flat"];
    ...
    openCurveContext(z) {
      const $ = this.selectedKeyFrames?.size || 0, j = $ < 2 && !this.selectedKeyframe(), w = this.selectedKeyframe(), E = w?.interpolation || "ease", M = w && dt(w) || "auto", B = ["bezier", "smooth", "linear", "ease_in", "ease_out", "ease", "sine", "cubic", "quintic", "expo", "back"], Q = ["auto", "clamped", "vector", "free", "aligned", "flat"];
    ...
    resizeCanvas() {
      ...
      if (!z) return;
      const $ = Math.min(2, window.devicePixelRatio || 1), j = z.clientWidth || 320, w = z.clientHeight || 180, E = Math.max(320, Math.round(j * $)), M = Math.max(180, Math.round(w * $));
      ...
      for (const B of this.cameraPreviewCanvases.values()) {
        const Q = B.clientWidth || 220, D = B.clientHeight || 124, J = Math.max($, Nb / Math.max(1, Q)), ke = Math.max(1, Math.round(Q * J)), Ke = Math.max(1, Math.round(D * J));
...
function Wr(e, t) {
  const a = e.map((i) => Kb(i, t)), o = Bb(a), r = e.map((i) => i.frame), n = Math.max(1, r[r.length - 1] - r[0]);
  return a.map((i, c) => [
    (r[c] - r[0]) / n,
...
function Ub(e, t, { tolerance: a = 0.02, keepFrames: o = [] } = {}) {
...
function Wb(e, t, { target: a = 2, keepFrames: o = [] } = {}) {
...
function Vb(e, t, { mergeWithin: a = 1, epsilon: o = 1e-3, keepFrames: r = [] } = {}) {
...
function Gb(e, t, a, { lastFrame: o = 1 / 0 } = {}) {
...
function Qb(e, { leftFrame: t, rightFrame: a, t: o = 0.5 } = {}) {
  ...
  const c = Math.min(0.999, Math.max(1e-3, Number.isFinite(o) ? o : 0.5)), l = Math.round(t + c * (a - t)), p = Zb(r, t, a, l);
  ...
  if (b) {
    const S = [...f.camera.position], g = vr(f, h, d).out, k = vr(d, f, u).in, _ = [...d.camera.position], O = Jb(S, g, k, _, m);
...
const Kn = { motion: "motion", shot: "display", health: "health" }, eg = {
  object: "Object",
  camera: "Camera",
  camera_target: "Look-At Target",
  camera_path: "Camera Path"
}, tg = { motion: "Motion", shot: "Shot", health: "Health" }, ag = ["entity", "motion", "shot", "health"];
function li(e) {
...
function ng(e) {
  const t = rg(e);
  e._lastInspectorSelKey !== void 0 && e._lastInspectorSelKey !== t && (e.inspectorMode = "entity"), e._lastInspectorSelKey = t, di(e);
}
function di(e) {
  const t = og(e);
...
function ig(e) {
  ...
  return {
    ...
    setFrame(w, E = !1, M = !0) {
      ...
      for (const te of this.cardMediaById.values()) te instanceof HTMLVideoElement && Number.isFinite(te.duration) && te.duration > 0 && (te.currentTime = Q % te.duration);
      const D = Math.floor(Q / 60), J = Math.floor(Q % 60), ke = Math.floor(Q % 1 * 1e3), Ke = this.frame % Math.max(1, Math.round(this.state.fps)), st = Math.floor(this.frame / this.state.fps);
    ...
    setSpatialHandleMode(w) {
      ...
      const M = this.activeCameraTrack()?.keyframes || [], B = M.findIndex((Q) => Q.frame === this.selectedKeyFrame);
      if (B < 0) {
        this.setStatus(s("Select a camera keyframe first"));
        return;
      }
      this.checkpoint(s("Camera path handle: {mode}").replace("{mode}", w)), Lb(M[B], w, {
        prevKey: M[B - 1] || null,
        nextKey: M[B + 1] || null
    ...
    setPathSelectionComponent(w) {
      this.pathSelection = Dc(this.pathSelection, w), this.refreshInspector(), this.render();
    },
    ...
    insertPathKeyAtCursor(w) {
      ...
      const E = this.interactionElement.getBoundingClientRect(), M = (w.clientX - E.left) * this.canvas.width / Math.max(1, E.width), B = (w.clientY - E.top) * this.canvas.height / Math.max(1, E.height), Q = this.webgl.pickPathSegment([M, B]);
      if (!Q) return !1;
      const D = (this.state.cameras || []).find((ke) => ke.id === Q.cameraId);
      if (!D || D.locked) return !1;
      const J = Qb(D.keyframes || [], {
        leftFrame: Q.leftFrame,
        rightFrame: Q.rightFrame,
        t: Q.t
      });
      return J.ok ? (this.checkpoint(s("Insert camera path key")), D.id !== this.state.active_camera_id && this.activateCamera(D.id), D.keyframes = J.keys, this.state.keyframes = J.keys, this.camera = Ne(D, this.frame, this.state.objects), D.camera = nt(this.camera), Rc(this, { cameraId: D.id, frame: J.frame, additive: !1 }), this.serialize(), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), this.setStatus(s("Camera path key inserted at frame {frame}").replace("{frame}", String(J.frame))), !0) : (this.setStatus(J.reason === "no_free_frame" ? s("No free frame here to insert a key") : s("Could not insert a key here")), !0);
    },
    ...
    transformCameraPath(w) {
      ...
      const M = ts(E.keyframes, { origin: Qn(E.keyframes), ...w });
      return E.keyframes = M, E.id === this.state.active_camera_id && (this.state.keyframes = M), this.camera = Ne(E, this.frame, this.state.objects), E.camera = nt(this.camera), this.serialize(), this.refreshKeys(), this.refreshInspector(), this.render(), this.renderCameraView?.(), !0;
    },
    ...
    selectHierarchy(w = this.selectedObjectId) {
      ...
      for (; M; ) {
        ...
        for (const B of this.state.objects)
          B.parent_id && E.has(B.parent_id) && !E.has(B.id) && (E.add(B.id), M = !0);
      }
    ...
    playblastCameraAtFrame() {
      return Vt(this, d(this), Ba(this, Ne), this.frame);
    },
    viewportCamera() {
      return ba(this);
    },
    ...
    lookAtObject(w) {
      ...
      if (E) {
        ...
        for (const M of this.state.cameras)
          for (const B of M.keyframes) B.camera.target = [...E.position || [0, 1.5, 0]];
        this.camera = Ne(this.state, this.frame), this.serialize(), this.refreshKeys(), this.render(), this.setStatus(`Cameras look at ${E.name || E.type}`);
      }
    },
    setTransformMode(w) {
      Lt(this, w);
    ...
    refreshInspector() {
      this.perf && (this.perf.inspectorRefreshCount = (this.perf.inspectorRefreshCount || 0) + 1), qa(this), ng(this);
    },
    setInspectorMode(w) {
      sg(this, w);
    },
    ...
    aimAtSelectedObject(w) {
      ...
      const E = this.activeCameraTrack(), M = w && this.state.objects.find((D) => D.id === w) || this.selectedObject() || this.state.objects.find((D) => D.id === "subject") || this.state.objects[0];
      if (!M) return;
      ...
      const Q = (M.type === "model" || M.type === "glb" ? this.webgl?.getObjectWorldCenter?.(M.id) : null) || (M.keyframes?.length ? z(M, this.frame).position : M.position || [0, 1.5, 0]);
      this.camera.target = [...Q], this.beginCameraEdit(), this.commitCameraEdit(), this.finishCameraEdit(), this.serialize(), this.refreshInspector(), this.updateHudCamera(), this.render(), this.setStatus(`Camera tracking locked to ${M.name || M.id}`);
    },
    setAimBone(w) {
      Bu(this, w);
    },
    ...
    setCameraTrackingTarget(w) {
      ...
      const E = this.activeCameraTrack();
      E.target_object_id !== (w || null) && (E.aim_bone = null), E.target_object_id = w || null, E.id === this.state.active_camera_id && (this.state.target_object_id = w || null, this.state.aim_bone = E.aim_bone), this.camera = Ne(E, this.frame, this.state.objects), Vt(this, E, this.camera, this.frame), this.serialize(), this.refreshInspector(), this.render(), this.setStatus(w ? `Camera tracking: ${w}` : "Camera tracking disabled (manual target)");
    },
    bakeAimToKeyframes() {
      this.checkpoint("Bake aim to keyframes");
      const w = this.activeCameraTrack(), E = w.target_object_id || this.state.target_object_id || "subject", M = this.state.objects.find((Q) => Q.id === E) || this.state.objects[0];
      ...
      for (const Q of w.keyframes) {
        const D = (M.type === "model" || M.type === "glb") && B && !M.keyframes?.length ? B : M.keyframes?.length ? z(M, Q.frame).position : M.position || [0, 1.5, 0];
        Q.camera.target = [...D];
      }
...
function cg(e) {
  ...
  return {
    ...
    async loadMediaUrl(j, w, E, M) {
      return va(this, j, w, E, M);
    },
    restoreAssets() {
      Sa(this);
    },
...
function dg(e) {
  const { right: t, up: a, forward: o } = Kc(e || {});
  return lg.map((r) => {
...
const fg = "http://www.w3.org/2000/svg", wt = 26, Bn = 17, hg = 5.4;
function kt(e, t) {
  const a = document.createElementNS(fg, e);
...
function ug(e) {
  ...
  for (const n of mg(dg(a))) {
    const i = wt + n.x * Bn, c = wt + n.y * Bn, l = pg(n.depth);
...
function gg(e) {
  ...
  for (const r of e.state.motion_layers || []) {
    ...
    const n = bg(e.state, r, e.frame, a, o);
    if (n.length) {
...
const yg = ["world_point", "object_point", "camera_field"], mi = {
  manual_2d: "DRAW",
  object_point: "OBJECT",
  world_point: "WORLD",
...
function Sg(e) {
  ...
  n("motion-sel-name", a.label), n("motion-sel-type", mi[a.source_kind] || "TRACK"), n("motion-sel-binding", vg(e.state, a)), n("motion-sel-start", r.length ? Math.min(...r) : 0), n("motion-sel-end", r.length ? Math.max(...r) : 0);
...
function Cg(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: u, syncActiveCameraTrack: b, syncFromWidgets: v, bindEditorEvents: y, activateCamera: x, addCamera: S, deleteCamera: g, drawPreviewOverlays: k, duplicateCamera: _, maximizeCameraPreview: O, refreshCameraPreviews: P, refreshCameraSelectors: K, renameCamera: W, setPlayblastCamera: H, toggleCameraView: oe, captureRealtime: C, makePlayblast: R, uploadDirectorPlayblast: V, waitForMediaFrame: X, computeAudioPeaks: N, loadAudioFile: A, releaseAudio: G, stopPlay: F, togglePlay: Y, applyCameraPreset: ee, applyCameraShake: le, applyProxyPreset: se, clearViewportBgImage: re, loadViewportBgFile: de, loadViewportBgSequence: be, drawCameraPath: fe, drawCard: ge, drawCube: ye, drawCylinder: pe, drawGrid: Me, drawHuman: ve, drawLine3D: xe, drawNull: ue, drawOverlays: L, drawPointField: U, drawSpeedHeatmap: me, drawSphere: je, drawTorus: Oe, curveChannels: De, drawCurveEditor: Pe, onCurvePointerDown: ot, onCurvePointerMove: ea, onCurvePointerUp: ta, onTimelinePointerDown: aa, onTimelinePointerMove: At, onTimelinePointerUp: Tt, refreshKeys: ft, resetCurveZoom: $t, resetTimelineZoom: Mt, setChannelFilter: It, setCurveInterpolation: oa, setTangentMode: Ot, timelineFrameFromEvent: ra, toggleCurveHandles: na, zoomCurve: sa, drawTransformGizmo: ia, frameTarget: ca, gizmoAxes: la, gizmoGeometry: da, onPointerDown: ma, onPointerMove: pa, onPointerUp: fa, onWheel: ha, pickGizmo: Pt, pickSceneObject: Lt, resetCamera: ua, setTransformMode: ba, setViewMode: Bo, viewportCamera: qo, loadCardFile: ga, loadExecutionPreview: ya, loadMediaUrl: va, loadModelFile: xa, loadSelectedReference: wa, onModelLoaded: ka, restoreAssets: Sa, syncUpstreamInputs: zt, configureDomMedia: ja, refreshSetupDiagnostic: _a, addMediaCard: Ca, addPrimitive: Ea, applyObjectAnimationFrame: Aa, beginCameraEdit: Ta, beginObjectEdit: $a, commitCameraEdit: Ma, commitObjectEdit: Ia, copyKeyframe: Oa, deleteKeyframe: Pa, deleteObject: La, duplicateObject: za, exitKeyEdit: Na, finishCameraEdit: Fa, goToAdjacentKey: Ra, insertKeyframe: Da, loadSelectedKeyView: Ka, pasteKeyframe: Ba, playblastCameraAtFrame: qa, refreshInspector: Ua, refreshKeyEditor: Wa, refreshObjects: Va, removeObjectResources: Ha, renameObject: Ga, retimeSelectedKey: Ya, selectKeyframe: Xa, selectedKeyframe: Ja, selectedObject: Za, selectObjectAnimation: Qa, setKeyInterpolation: eo, setObjectParent: rt, timelineKeyframes: to, timelineObject: ao, toggleAutoKey: oo, toggleObject: ro, updateCameraFromHud: no, updateEditState: so, updateKeyVisualState: io, updateSelectedKey: Nt, updateSelectedObject: co, clamp: lo, cloneCamera: mo, configureCore: nt, defaultCamera: Uo, sampleCamera: ht, sampleObjectTransform: Ne, sanitizeState: z, worldTransform: $ } = e;
  return {
    ...
    renderViewportOnly() {
      const j = this.ctx, w = this.canvas.width, E = this.canvas.height;
      if (j.fillStyle = this.state.viewport_bg_color || "#121212", j.fillRect(0, 0, w, E), this.viewportBgSequenceImages && this.viewportBgSequenceImages.length) {
      ...
      if (this.webgl) {
        try {
          const ne = this.recording ? 1 : this.webgl.supersampleFactor?.() ?? 1, Ye = ne > 1 ? Math.min(ne, 4096 / Math.max(1, w, E)) : 1, po = Ye > 1 ? Math.round(w * Ye) : w, Wo = Ye > 1 ? Math.round(E * Ye) : E;
          this.webgl.render(st, B, this.cardMediaById, po, Wo, this.modelUrlsById, this.frame, this.recording, this.selectedEntity, this.selectedObjectId, this.subSelection, this.selectedKeyFrame ?? null, this.selectedKeyFrames ? [...this.selectedKeyFrames] : null), j.imageSmoothingEnabled = !0, j.imageSmoothingQuality = "high", po !== w || Wo !== E ? j.drawImage(this.webgl.canvas, 0, 0, po, Wo, 0, 0, w, E) : j.drawImage(this.webgl.canvas, 0, 0, w, E), te = !0;
        } catch (ne) {
      ...
      !this.recording && this.state.speed_heatmap && this.drawSpeedHeatmap(), !this.recording && Ah(this), this.drawOverlays(), gg(this), this.state.show_gizmo && ug(this), this.labelOverlay?.update(), this.rigOverlay?.update(), this.perf && (this.perf.viewportRenderCount = (this.perf.viewportRenderCount || 0) + 1);
    },
    ...
    requestUiUpdate(j = T.viewport, w = "unknown") {
      (this.renderReasons ||= /* @__PURE__ */ new Set()).add(w), this.uiDirtyMask = ep(this.uiDirtyMask, j), this.renderInvalidations = (this.renderInvalidations || 0) + 1, !this.renderScheduled && (this.renderScheduled = !0, this.renderFrame = requestAnimationFrame(() => {
        if (this.renderScheduled = !1, this.disposed) return;
        const E = this.uiDirtyMask || T.viewport;
        this.uiDirtyMask = 0, this.lastRenderReasons = [...this.renderReasons || []], this.renderReasons?.clear(), this.rendersCoalesced = (this.rendersCoalesced || 0) + 1, this.perf && (this.perf.renderCount = (this.perf.renderCount || 0) + 1), gt(E, T.outliner) && this.refreshObjects(), gt(E, T.timeline) && this.refreshKeys(), gt(E, T.inspector) && this.refreshInspector(), gt(E, T.viewport) && this.renderViewportOnly(), gt(E, T.previews) && this.renderCameraView(), gt(E, T.motion) && this.renderMotionUiOnly();
      }));
    },
    renderCameraView() {
      if (this.perf && (this.perf.previewRenderCount = (this.perf.previewRenderCount || 0) + 1), this.state.camera_view_visible) {
        ...
        let M = null;
        if (E) {
          const B = this.state.active_camera_id, Q = w.filter((D) => D.id !== B);
          M = Q.length ? Q[this.cameraPreviewTick % Q.length] : null;
        }
        for (const B of w) {
          const Q = this.cameraPreviewCanvases.get(B.id), D = this.cameraPreviewContexts.get(B.id);
          if (!Q?.width || !D) continue;
          const J = Q.width, ke = Q.height, Ke = this.root.querySelector(`[data-camera-frame="${B.id}"]`);
          if (Ke && (Ke.textContent = `F${this.frame}`), E && B.id !== this.state.active_camera_id && B !== M) continue;
          const st = Vt(this, B, ht(B, this.frame, this.state.objects), this.frame);
          if (D.fillStyle = "#111", D.fillRect(0, 0, J, ke), this.cameraWebgl)
            try {
              this.cameraWebgl.render({ ...this.state, keyframes: [], playblast_grid: !1, viewport_bg_image: this.viewportBgImage?.src || "", viewport_bg_sequence: (this.viewportBgSequenceImages || []).map((te) => te.src), __omnicamRevision: this.renderRevision || 0 }, st, this.cardMediaById, J, ke, this.modelUrlsById, this.frame, !0), D.drawImage(this.cameraWebgl.canvas, 0, 0, J, ke);
            } catch (te) {
    ...
    dispose() {
      this.disposed || (this.disposed = !0, this.agentBridge?.dispose?.(), this.transformControlsWiring?.dispose(), Bc(this), qc(), jl(this), this.backgroundRequestId = (this.backgroundRequestId || 0) + 1, this.upstreamSyncId = (this.upstreamSyncId || 0) + 1, this.stopPlay(), clearTimeout(this.previewClickTimer), clearTimeout(this.connectionTimer), cancelAnimationFrame(this.restoreFrame), cancelAnimationFrame(this.serializeFrame), cancelAnimationFrame(this.resizeFrame), cancelAnimationFrame(this.renderFrame), this.abortController?.abort(), this.upstreamFetchController?.abort(), this.resizeObserver?.disconnect(), this.contextMenu?.dispose(), this.webgl?.dispose(), this.cameraWebgl?.dispose(), G(this), tu(this), this.objectUrls.clear(), this.cardMediaById.clear(), this.cardMediaAssetById?.clear?.(), this.modelUrlsById.clear(), this.modelInfoById.clear());
    }
  };
}
const Eg = 0.12;
function Ag() {
  return {
    ...
    deleteSelectedKeyframes() {
      ...
      const t = this._activeTrack(), a = Ee(this), o = t.kind === "camera" ? 1 : 0, { keys: r, removed: n } = Hb(a, e, { minKeys: o });
    ...
    nudgeSelectedKeyframes(e) {
      ...
      const a = this._activeTrack(), o = Math.max(0, this.state.duration_frames - 1), r = Gb(Ee(this), t, e, { lastFrame: o });
    ...
    setSelectedKeysInterpolation(e) {
      ...
      this.checkpoint(s("Interpolation on {n} keys").replace("{n}", t.length)), a.write(Yb(Ee(this), t, e)), this.serialize(), this.refreshKeys(), this.refreshKeyEditor(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} interpolation on {n} keys").replace("{mode}", e.replace(/_/g, " ")).replace("{n}", t.length));
    },
    setSelectedKeysTangentMode(e) {
      const t = this.resolveSelectedFrames();
      if (t.length < 2) return this.setTangentMode(e);
      const a = this._activeTrack(), o = pt(this).map((r) => r.id);
      this.checkpoint(s("Tangents on {n} keys").replace("{n}", t.length)), a.write(Xb(Ee(this), t, e, o)), this.serialize(), this.refreshKeys(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} tangents on {n} keys").replace("{mode}", e).replace("{n}", t.length));
    },
    /**
    ...
    simplifyActiveKeys({ mode: e = "simplify", tolerance: t = 0, target: a = 0, scope: o = "camera", fromKeys: r = null, silent: n = !1 } = {}) {
      ...
      const l = this.resolveSelectedFrames(), p = o !== "all_cameras" && l.length >= 2 ? [l[0], l.at(-1)] : null, m = p ? [] : l, f = (u) => {
        ...
        let k = S, _ = 0;
        if (S.length > 2) {
          const O = e === "reduce" ? Wb(S, i, { target: a || Math.ceil(S.length / 2), keepFrames: m }) : e === "clean" ? Vb(S, i, { keepFrames: m }) : Ub(S, i, { tolerance: t * Eg, keepFrames: m });
...
class pi {
  constructor(t) {
    this.app = qn, this.api = at, this.node = t, this.root = js(), this.root.tabIndex = -1, this.dom = Ms(this.root), this.canvas = this.root.querySelector(".viewport-wrap > canvas"), this.cameraPreviewCanvases = /* @__PURE__ */ new Map(), this.cameraPreviewContexts = /* @__PURE__ */ new Map(), this.cameraPreviewSignature = "", this.interactionElement = this.canvas, this.interactionElement.tabIndex = 0, this.interactionElement.dataset.captureWheel = "true", this.ctx = this.canvas.getContext("2d", { alpha: !1 }), this.disposed = !1, this.renderRevision = 0, this.directorRevision = 0, this.webgl = null, this.cameraWebgl = null, this.webglReady = this.loadWebGLViewports(), this.transformControlsWiring = df(this), this.stateWidget = t.widgets?.find((o) => o.name === "state_json"), this.recordingWidget = t.widgets?.find((o) => o.name === "recording_path"), this.cardWidget = t.widgets?.find((o) => o.name === "card_asset"), this.widthWidget = t.widgets?.find((o) => o.name === "width"), this.heightWidget = t.widgets?.find((o) => o.name === "height"), this.fpsWidget = t.widgets?.find((o) => o.name === "fps"), this.durationWidget = t.widgets?.find((o) => o.name === "duration_seconds"), this.modeWidget = t.widgets?.find((o) => o.name === "render_mode");
    let a = null;
    try {
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-CvIplLAW.js"));
    } catch (a) {
...
const ko = { app: qn, api: at, EditorHistory: ks, ContextMenuController: cs, initializeTooltips: Cl, promptText: Yt, ObjectUrlRegistry: Ss, buildRoot: js, dispatchDirectorKey: Vc, activeCameraTrack: sr, bindWidgetCallbacks: El, playblastCameraTrack: is, restoreFromWidgets: Al, serializeEditorState: Tl, syncActiveCameraTrack: ir, syncFromWidgets: $l, bindEditorEvents: Bh, activateCamera: Ml, addCamera: Il, deleteCamera: Ol, drawPreviewOverlays: Pl, duplicateCamera: Ll, maximizeCameraPreview: zl, refreshCameraPreviews: Nl, refreshCameraSelectors: Fl, renameCamera: Rl, setPlayblastCamera: Dl, toggleCameraView: Kl, captureRealtime: Gs, makePlayblast: bu, uploadDirectorPlayblast: Ys, waitForMediaFrame: Hs, computeAudioPeaks: Bs, loadAudioFile: Zh, releaseAudio: Oo, stopPlay: Eo, togglePlay: Yh, applyCameraPreset: mf, applyCameraShake: pf, applyProxyPreset: ff, clearViewportBgImage: xu, loadViewportBgFile: yu, loadViewportBgSequence: vu, drawCameraPath: Pu, drawCard: Ou, drawCube: Eu, drawCylinder: $u, drawGrid: Su, drawHuman: Tu, drawLine3D: ie, drawNull: Iu, drawOverlays: zu, drawPointField: Cu, drawSpeedHeatmap: Lu, drawSphere: Au, drawTorus: Mu, curveChannels: pt, drawCurveEditor: _d, fitCurveView: bs, onCurveDoubleClick: Sd, onCurvePointerDown: hd, onCurvePointerMove: ud, onCurvePointerUp: bd, onTimelinePointerDown: Hc, onTimelinePointerMove: Gc, onTimelinePointerUp: Yc, refreshKeys: Dd, resetCurveZoom: jd, resetTimelineZoom: Xc, setChannelFilter: yd, setCurveInterpolation: gd, setTangentMode: vd, timelineFrameFromEvent: xr, toggleCurveHandles: xd, zoomCurve: kd, drawTransformGizmo: Jc, frameTarget: Zc, gizmoAxes: Qc, gizmoGeometry: el, onPointerDown: tl, onPointerMove: al, onPointerUp: ol, onWheel: rl, pickGizmo: nl, pickSceneObject: sl, resetCamera: il, setTransformMode: cl, setViewMode: ll, viewportCamera: dl, loadCardFile: su, loadExecutionPreview: iu, loadMediaUrl: Vs, loadModelFile: nu, loadSelectedReference: cu, onModelLoaded: ru, restoreAssets: ou, syncUpstreamInputs: lu, configureDomMedia: qs, refreshSetupDiagnostic: Ru, addMediaCard: Xu, addPrimitive: Vu, applyObjectAnimationFrame: pb, beginCameraEdit: vb, beginObjectEdit: ai, commitCameraEdit: xb, commitObjectEdit: Qu, copyKeyframe: bb, deleteKeyframe: ub, deleteObject: ti, deleteSelectedObjects: Yu, duplicateObject: ei, exitKeyEdit: kb, finishCameraEdit: wb, goToAdjacentKey: Ib, insertKeyframe: fb, loadSelectedKeyView: Mb, pasteKeyframe: gb, playblastCameraAtFrame: mb, refreshInspector: Ju, refreshKeyEditor: Ab, refreshObjects: Qs, removeObjectResources: nb, renameObject: Hu, retimeSelectedKey: Tb, selectKeyframe: yb, selectedKeyframe: Ge, selectedObject: Qt, selectObjectAnimation: rb, setKeyInterpolation: hb, setKeyTangentMode: Eb, setObjectParent: ob, timelineKeyframes: Ee, timelineObject: ze, toggleAutoKey: Sb, toggleObject: Gu, updateCameraFromHud: ab, updateCameraRotationFromHud: tb, updateEditState: _b, updateKeyVisualState: Cb, updateSelectedKey: $b, updateSelectedObject: Zu, clamp: Z, cloneCamera: ce, configureCore: ss, defaultCamera: Sr, sampleCamera: $e, sampleObjectTransform: Fo, sanitizeState: _r, worldTransform: Cr };
Object.assign(
  pi.prototype,
  Fb(ko),
  ig(ko),
...
function Tg(e) {
  ...
  const t = new pi(e);
  So("director:constructor:complete", e), Ep(t);
  try {
    t.agentBridge = Pp(t, e, at);
  } catch (m) {
  ...
  try {
    t.assetBrowser = Yp(t, {
      ...
      onAgentFirstOpen: async () => {
        if (or())
          try {
            const { createDirectorAgentPanel: m } = await import("./chunk-B4SZUQ2U.js");
            t.agentPanel = m(t);
          } catch (m) {
  ...
  try {
    t.characterRuntime = Jp(t), t.rigMapper = Qp(t), t.poseEditor = af(t), t.motionEditor = of(t);
  } catch (m) {
  ...
  }, t.unwatchGraphConnections = _l(e, i);
  const l = e.onRemoved;
