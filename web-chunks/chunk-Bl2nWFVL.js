import { a, U as Q, bv as W, bw as h } from "./chunk-DbQgFgRj.js";
...
function fe(e, t = {}) {
  ...
  function O() {
    ...
    if (U) {
      ...
      U.textContent = `${y} · ${n.model || a("(no model set)")}`;
    }
    w && (w.textContent = ue(n));
    const r = p === "planning" || p === "applying";
    k && (k.disabled = r), N && (N.disabled = !l || r || l.truncated || p === "stale"), j && (j.disabled = !l), c && (c.disabled = r), I && (I.innerHTML = l ? ce(l.changes) : ""), p === "planning" ? d(a("Planning...")) : p === "applying" ? d(a("Applying...")) : p === "stale" ? d(a("The Director changed after this preview. Generate a new preview.")) : p === "preview_ready" && d(l?.description || "");
  }
  function m(n) {
    p = n, O();
  }
