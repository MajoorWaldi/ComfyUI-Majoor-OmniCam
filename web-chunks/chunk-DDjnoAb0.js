...
import { a as xe, y as Z, z as pe, u as r, A as Rr, B as Ao, C as Ie, c as le, E as oo, F as os, G as To, H as qr, J as rs, K as ns, L as ss, M as is, N as wo, v as Zo, O as Br, P as ko, Q as Wr, R as Vr, S as Hr, T as Ur, i as Gr, U as So, V as lo, W as Jo, X as Qo, Y as Xr, k as er, Z as cs, _ as ls, $ as ds, a0 as ms, a1 as ps, g as ye, p as Yr, h as Zr, a2 as tr, e as _e, a3 as fs, a4 as Jr, t as hs, a5 as bs, a6 as Po, a7 as us, a8 as gs, o as ys, a9 as vs, aa as xs, ab as ws, ac as Io, ad as ks, ae as Ss, af as js, ag as Cs, ah as Es, ai as _s, aj as $s, ak as Ms, al as As, am as Ts, an as Ps, ao as Is, ap as zs, aq as Fs, ar as Ls, as as Os, at as Ks, au as Ds, av as Ns, aw as Rs, ax as qs, ay as Bs, az as Ws, aA as Vs, aB as Hs, aC as Us, aD as Gs, aE as Xs, aF as Ys, aG as Zs, aH as Js, aI as Qs, aJ as ei, aK as ti, aL as ai, aM as oi, aN as ri, aO as ni, aP as si, aQ as ii, aR as ci, aS as li, aT as di, l as Be, aU as mi, aV as mo, aW as pi, aX as fi, aY as hi, aZ as bi, a_ as ui, a$ as Pe, b0 as gi, b1 as Qr, b2 as zo, b3 as yi, b4 as vi, b5 as xi, b6 as en, b7 as Ke, b8 as wi, b9 as ki, ba as ar, bb as Fo, bc as Si, bd as tn, be as ji, bf as Ci, bg as Ei, b as an, r as _i, bh as $i, bi as Mi, bj as Ai, bk as Ti, x as Pi, bl as Ii, bm as zi, bn as Fi, bo as on, bp as Li, bq as Oi, br as Ki, bs as Di, bt as Ni, bu as Ri, bv as qi, bw as Bi, bx as Wi, by as Vi, bz as Hi, bA as Ui, bB as Gi, bC as Xi, bD as Yi, bE as Zi, bF as Ji, bG as Qi, bH as ec, s as tc } from "./chunk-CNyw3Ryk.js";
import { L as ac, a as oc, p as kt, f as Lo, b as rc, S as nc, c as or, d as sc, e as ic, r as cc, g as lc, n as dc, C as rr, h as St, o as rn, s as mc, i as pc, j as fc, k as nn, l as hc, m as bc, q as uc, t as gc, u as yc, v as vc, w as xc, x as wc, y as kc, z as Sc, A as jc, B as Cc } from "./chunk-DW__kKvY.js";
import { S as Ec, b as _c, p as $c } from "./chunk-DiX7WiXt.js";
import { n as Mc, p as Ac, a as Tc, s as po, S as sn, c as Pc, C as nr, b as Ic, i as zc, w as Fc, d as Lc, U as je, m as Oc, h as Ge, e as Kc, f as Dc, g as Nc, j as Rc, r as qc, k as Bc, l as Wc } from "./chunk-D_a6cG2W.js";
import { T as Vc } from "./chunk-__IQ4xkd.js";
import { T as Hc, R as Uc } from "./vendor-three-BQUrLQkn.js";
import { b as Gc, p as cn, a as jo, c as Co, d as Xc, r as Yc, s as Zc, e as Jc } from "./chunk-DiJho4LI.js";
...
function Jd(e, t = {}) {
  ...
  function Q() {
    ...
    k.id !== p && (p = k.id, f = !1, e.subSelection?.type === "character_joint" && (e.subSelection = null), d.size || A()), x(), V.update();
  }
...
function nm(e, { controlsFactory: t, anchorFactory: a } = {}) {
    ...
    if (k) {
      ...
      if (k.type === "path_point" || k.type === "path_group") {
        ...
        e.checkpoint(k.type === "path_point" ? "Transform path point" : "Transform path selection"), n = {
          ...
          lookAtActive: Zr(E, e.state.objects)
        };
        return;
      }
  ...
  function y(k) {
    ...
    E && (E.keyframes = Jr(n.baseKeys, b(k)), u(E));
  }
  function g(k) {
  ...
  function j({ delta: k }) {
    n && (n.type === "object" ? x(k) : n.type === "camera" ? A(k) : n.type === "camera_target" ? P(k) : n.type === "camera_path" ? y(k) : n.type === "path_point" || n.type === "path_group" ? g(k) : n.type === "path_point_target" && v(k), e.render());
  }
  function x(k) {
    ...
    for (const q of E)
      if (N === "translate")
        ...
        const M = _e(q.transform.position, z);
        q.object.position = ye(z, M.map((W, C) => W * k.scaleFactors[C])), q.object.size = q.transform.size.map((W, C) => Math.max(0.01, W * k.scaleFactors[C]));
      }
  ...
  function F() {
    ...
    const k = e.recording ? null : ms(e), E = e.state.gizmo_mode || "translate", z = !!k && !k.readOnly && rm.has(k.type) && k.allowedModes.includes(E);
...
function pm(e, t, a, o) {
  ...
  const [P, D] = j(h[0] || 0, h[2] || 0), [F, U] = j(b[0] || 0, b[2] || 0), B = 8, V = Z(P, s + B, s + c - B), Q = Z(D, i + B, i + c - B), k = Z(F, s + B, s + c - B), E = Z(U, i + B, i + c - B), z = h[1] || 0, N = dm(z), q = mm(z);
...
const Em = ["position", "target"], _m = ["fov", "zoom"], $m = ["roll"], Mm = ["position", "size"], Am = ["rotation"];
function _o(e) {
    ...
    if (Array.isArray(i.position) && Array.isArray(s.position) && Array.isArray(c.position)) {
      ...
      for (const p of Am) {
        ...
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          ...
          a[n][p] = d.map((u, y) => Er(Number(u), b[y], o));
        }
      }
    }
  }
...
const Ba = () => import("./chunk-C1PnmMYD.js");
function Xm(e, t) {
...
function Ap(e, t) {
  Va(e, t, e.root.querySelectorAll('[data-act="scene-new"]'), () => Cp(e)), Va(e, t, e.root.querySelectorAll('[data-act="scene-open"]'), () => $p(e)), Va(e, t, e.root.querySelectorAll('[data-act="scene-save"]'), () => _p(e)), Va(e, t, e.root.querySelectorAll('[data-act="scene-reset"]'), () => Ep(e));
}
...
async function pf(e) {
  ...
  try {
    let s = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-xJH_26-r.js");
  ...
  if (Array.isArray(a) && a.length)
    for (const c of o)
      for (const l of a) {
        ...
        Be(_e(c.camera.position, l.position)) < m + qf && n.push({
  ...
  if (p) {
    ...
    if (t.appendChild(v), !j)
      for (const { object: x, level: A } of g) {
        ...
        E.style.cssText = V ? "color:#fca5a5" : B ? "" : "opacity:.5;text-decoration:line-through", E.textContent = x.name || x.type, E.title = r("Double-click to rename"), E.addEventListener("dblclick", (M) => {
          M.preventDefault(), M.stopPropagation(), Jf(e, x, E);
        }), k.appendChild(E);
        ...
        if (V) {
          const M = document.createElement("span");
          M.style.cssText = "color:#ef4444;font-size:9px;font-weight:700", M.textContent = " [Format!]", k.appendChild(M);
        }
        const N = document.createElement("div");
        N.className = "scene-item-actions", N.appendChild(n(B ? "pi-eye" : "pi-eye-slash", B ? "Hide object (Alt+Click to Isolate)" : "Show object (Alt+Click to Isolate)", !B, (M) => {
          if (M?.altKey) {
            ...
            e.toggleObject(x.id);
        }, "color:#ef4444;opacity:.7")), N.appendChild(n(x.locked ? "pi-lock" : "pi-lock-open", "Lock object", x.locked, () => qo(e, x))), N.appendChild(n("pi-copy", "Duplicate object", !1, () => e.duplicateObject?.(x.id))), x.id !== "subject" && N.appendChild(n("pi-trash", "Delete object", !1, () => e.deleteObject?.(x.id))), N.appendChild(n("pi-ellipsis-v", "Object actions", !1, (M) => e.openObjectContext(M, x.id))), P.append(Q, k, N), P.title = r("Click to select · Double-click to toggle visibility · Right-click for actions");
        const q = (M = {}) => {
...
function rh(e) {
  ...
  if (!t) {
    ...
    E && (E.textContent = `${n.name} · F${e.frame}`), Lr(o, {
  ...
  if (y) {
    ...
    for (; z; ) {
      ...
      for (const M of e.state.objects)
        !E.has(M.id) && M.parent_id && E.has(M.parent_id) && (E.add(M.id), z = !0);
    }
    const N = e.state.objects.filter((M) => !E.has(M.id)), q = `P${ar()}${k}${N.map((M) => `${M.id} ${M.name || M.type}`).join("|")}`;
    yo(y, q, () => [
      gt("", r("No parent")),
...
function Bh(e) {
  ...
  return {
    ...
    restoreHistorySnapshot(I) {
      ...
      const S = Or(this.state), w = new Set(this.state.objects.map((Y) => Y.id));
    ...
    onContextMenu(I) {
      ...
      if (_) {
        const $ = this.timelineKeyframes().find((K) => K.frame === Number(_.dataset.keyFrame));
    ...
    openPathKeyContext(I, T, S) {
      ...
      const $ = _ ? po(_) : "auto", K = this.selectedKeyFrames?.size || 0, X = this.pathSelection?.component === "target", L = Zr(w, this.state.objects);
    ...
    moveShot(I, T) {
      const S = this.state.cameras.findIndex(($) => $.id === I), w = S + T;
    ...
    openTimelineContext(I, T) {
      const S = this.selectedKeyFrames?.size || 0, w = this.selectedKeyframe(), _ = w?.interpolation || "ease", $ = w && po(w) || "auto", K = ["ease", "linear", "bezier", "smooth", "ease_in", "ease_out", "sine", "cubic", "quintic", "expo", "back"], X = ["auto", "clamped", "vector", "free", "aligned", "flat"];
    ...
    openCurveContext(I) {
      const T = this.selectedKeyFrames?.size || 0, S = T < 2 && !this.selectedKeyframe(), w = this.selectedKeyframe(), _ = w?.interpolation || "ease", $ = w && po(w) || "auto", K = ["bezier", "smooth", "linear", "ease_in", "ease_out", "ease", "sine", "cubic", "quintic", "expo", "back"], X = ["auto", "clamped", "vector", "free", "aligned", "flat"];
    ...
    resizeCanvas() {
      ...
      if (!I) return;
      const T = Math.min(2, window.devicePixelRatio || 1), S = I.clientWidth || 320, w = I.clientHeight || 180, _ = Math.max(320, Math.round(S * T)), $ = Math.max(180, Math.round(w * T));
      (this.canvas.width !== _ || this.canvas.height !== $) && (this.canvas.width = _, this.canvas.height = $);
...
function Qh(e) {
  ...
  return {
    ...
    setSpatialHandleMode(w) {
      ...
      this.checkpoint(r("Camera path handle: {mode}").replace("{mode}", w)), Lc($[K], w, {
        prevKey: $[K - 1] || null,
        nextKey: $[K + 1] || null
    ...
    insertPathKeyAtCursor(w) {
      ...
      const _ = this.interactionElement.getBoundingClientRect(), $ = (w.clientX - _.left) * this.canvas.width / Math.max(1, _.width), K = (w.clientY - _.top) * this.canvas.height / Math.max(1, _.height), X = this.webgl.pickPathSegment([$, K]);
      if (!X) return !1;
    ...
    transformCameraPath(w) {
      ...
      const $ = Jr(_.keyframes, { origin: Yr(_.keyframes), ...w });
      return _.keyframes = $, _.id === this.state.active_camera_id && (this.state.keyframes = $), this.camera = Se(_, this.frame, this.state.objects), _.camera = Fe(this.camera), this.serialize(), this.refreshKeys(), this.refreshInspector(), this.render(), this.renderCameraView?.(), !0;
    },
    ...
    async openCameraPathPresetPicker() {
      ...
      const _ = Ic.map((K) => ({ id: K, label: r(nr[K] || K) })), $ = await rn({ title: r("Camera Path Preset"), items: _, owner: this });
    ...
    applyCameraPathPreset(w, _ = {}) {
      ...
      const [K, X] = Mo(this.state), L = Pc({ type: w, camera: this.camera, startFrame: K, endFrame: X, params: _ });
    ...
    toggleInspector(w) {
      ...
      if (!_) return;
      const $ = w !== void 0 ? w : _.dataset.collapsed !== "true";
      _.dataset.collapsed = String($);
    ...
    selectHierarchy(w = this.selectedObjectId) {
      ...
      for (; $; ) {
        ...
        for (const K of this.state.objects)
          K.parent_id && _.has(K.parent_id) && !_.has(K.id) && (_.add(K.id), $ = !0);
      }
    ...
    lookAtObject(w) {
      const _ = this.state.objects.find(($) => $.id === w);
      if (_) {
        this.checkpoint("Look-at constraint");
        for (const $ of this.state.cameras)
          for (const K of $.keyframes) K.camera.target = [..._.position || [0, 1.5, 0]];
    ...
    applyProxyPreset(w) {
      const _ = { balanced: { mode: "omni_ref", burn: !1 }, parallax: { mode: "point_field", burn: !1 }, subject: { mode: "card_grid", burn: !1 }, debug: { mode: "omni_ref", burn: !0 } }, $ = _[w] || _.balanced;
    ...
    aimAtSelectedObject(w) {
      ...
      const _ = this.activeCameraTrack(), $ = w && this.state.objects.find((L) => L.id === w) || this.selectedObject() || this.state.objects.find((L) => L.id === "subject") || this.state.objects[0];
      if (!$) return;
      _.target_object_id !== $.id && (_.aim_bone = null), _.target_object_id = $.id, _.id === this.state.active_camera_id && (this.state.target_object_id = $.id, this.state.aim_bone = _.aim_bone);
    ...
    bakeAimToKeyframes() {
      ...
      const w = this.activeCameraTrack(), _ = w.target_object_id || this.state.target_object_id || "subject", $ = this.state.objects.find((X) => X.id === _) || this.state.objects[0];
...
function eb(e) {
  ...
  return {
    setTargetAtCursor(S) {
      if (!S) return;
      const w = this.interactionElement.getBoundingClientRect(), _ = (S.clientX - w.left) * this.canvas.width / Math.max(1, w.width), $ = (S.clientY - w.top) * this.canvas.height / Math.max(1, w.height), K = this.webgl?.intersectScenePoint?.(_, $, this.canvas.width, this.canvas.height);
    ...
    async loadMediaUrl(S, w, _, $) {
      return Gt(this, S, w, _, $);
    },
    restoreAssets() {
      Jt(this);
    },
...
function yb(e) {
  ...
  return {
    ...
    requestUiUpdate(S = je.viewport, w = "unknown") {
      (this.renderReasons ||= /* @__PURE__ */ new Set()).add(w), this.uiDirtyMask = Oc(this.uiDirtyMask, S), this.renderInvalidations = (this.renderInvalidations || 0) + 1, !this.renderScheduled && (this.renderScheduled = !0, this.renderFrame = requestAnimationFrame(() => {
    ...
    renderCameraView() {
      if (this.perf && (this.perf.previewRenderCount = (this.perf.previewRenderCount || 0) + 1), this.state.camera_view_visible) {
        ...
        for (const K of w) {
          ...
          if ($e && ($e.textContent = `F${this.frame}`), _ && K.id !== this.state.active_camera_id && K !== $) continue;
...
class Yo {
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-xJH_26-r.js"));
    } catch (a) {
...
const Ha = { app: Nr, api: We, EditorHistory: wn, ContextMenuController: nn, initializeTooltips: hc, promptText: kt, ObjectUrlRegistry: kn, buildRoot: Sn, dispatchDirectorKey: Li, activeCameraTrack: jo, bindWidgetCallbacks: Xc, playblastCameraTrack: cn, restoreFromWidgets: Yc, serializeEditorState: Zc, syncActiveCameraTrack: Co, syncFromWidgets: Jc, bindEditorEvents: Op, activateCamera: bc, addCamera: uc, deleteCamera: gc, drawPreviewOverlays: yc, duplicateCamera: vc, maximizeCameraPreview: xc, refreshCameraPreviews: wc, refreshCameraSelectors: kc, renameCamera: Sc, setPlayblastCamera: jc, toggleCameraView: Cc, captureRealtime: qn, makePlayblast: pf, uploadDirectorPlayblast: Bn, waitForMediaFrame: Rn, computeAudioPeaks: Ln, loadAudioFile: Up, releaseAudio: eo, stopPlay: Xa, togglePlay: Wp, applyCameraPreset: sm, applyCameraShake: im, applyProxyPreset: cm, clearViewportBgImage: uf, loadViewportBgFile: hf, loadViewportBgSequence: bf, drawCameraPath: Af, drawCard: Mf, drawCube: Sf, drawCylinder: Ef, drawGrid: vf, drawHuman: Cf, drawLine3D: ne, drawNull: $f, drawOverlays: Pf, drawPointField: kf, drawSpeedHeatmap: Tf, drawSphere: jf, drawTorus: _f, curveChannels: Ve, drawCurveEditor: Al, fitCurveView: un, onCurveDoubleClick: $l, onCurvePointerDown: vl, onCurvePointerMove: xl, onCurvePointerUp: wl, onTimelinePointerDown: Oi, onTimelinePointerMove: Ki, onTimelinePointerUp: Di, refreshKeys: Wl, resetCurveZoom: Ml, resetTimelineZoom: Ni, setChannelFilter: Sl, setCurveInterpolation: kl, setTangentMode: jl, timelineFrameFromEvent: Ao, toggleCurveHandles: Cl, zoomCurve: _l, drawTransformGizmo: Ri, frameTarget: qi, gizmoAxes: Bi, gizmoGeometry: Wi, onPointerDown: Vi, onPointerMove: Hi, onPointerUp: Ui, onWheel: Gi, pickGizmo: Xi, pickSceneObject: Yi, resetCamera: Zi, setTransformMode: Ji, setViewMode: Qi, viewportCamera: ec, loadCardFile: tf, loadExecutionPreview: af, loadMediaUrl: Nn, loadModelFile: ef, loadSelectedReference: of, onModelLoaded: Qp, restoreAssets: Jp, syncUpstreamInputs: rf, configureDomMedia: On, refreshSetupDiagnostic: Ff, addMediaCard: oh, addPrimitive: Qf, applyObjectAnimationFrame: vh, beginCameraEdit: Eh, beginObjectEdit: Yn, commitCameraEdit: _h, commitObjectEdit: sh, copyKeyframe: Sh, deleteKeyframe: kh, deleteObject: Xn, deleteSelectedObjects: ah, duplicateObject: Gn, exitKeyEdit: Mh, finishCameraEdit: $h, goToAdjacentKey: Nh, insertKeyframe: xh, loadSelectedKeyView: Dh, pasteKeyframe: jh, playblastCameraAtFrame: yh, refreshInspector: rh, refreshKeyEditor: Lh, refreshObjects: Un, removeObjectResources: ph, renameObject: eh, retimeSelectedKey: Oh, selectKeyframe: Ch, selectedKeyframe: ze, selectedObject: Et, selectObjectAnimation: mh, setKeyInterpolation: wh, setKeyTangentMode: zh, setObjectParent: dh, timelineKeyframes: ve, timelineObject: ke, toggleAutoKey: Ah, toggleObject: th, updateCameraFromHud: lh, updateCameraRotationFromHud: ch, updateEditState: Ph, updateKeyVisualState: Ih, updateSelectedKey: Kh, updateSelectedObject: nh, clamp: Z, cloneCamera: le, configureCore: on, defaultCamera: an, sampleCamera: xe, sampleObjectTransform: oo, sanitizeState: tc, worldTransform: Po };
Object.assign(
  Yo.prototype,
  Bh(Ha),
  Qh(Ha),
  ...
  try {
    a.assetBrowser = Vd(a, {
      ...
      onAgentFirstOpen: async () => {
        if (wo())
          try {
            const { createDirectorAgentPanel: o } = await import("./chunk-RStW1HNV.js");
            a.agentPanel = o(a);
          } catch (o) {
