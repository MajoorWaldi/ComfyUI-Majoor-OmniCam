...
J.registerExtension({
  ...
  async nodeCreated(e) {
    ...
    await yt(e, async () => {
      ...
      const { attachDirector: o } = await import("./chunk-DHZA9AzY.js").then((n) => n.g);
...
J.registerExtension({
  ...
  async nodeCreated(e) {
    if (Ge(e) !== ot) return;
    const t = !ie, a = t ? null : vt(e);
    await yt(e, async () => (await import("./chunk-C-TaUYHw.js")).attachExtractor), e.__majoorOmniCamExtractor && _t(e, ot, t, a?.());
  }
});
J.registerExtension({
  ...
  async nodeCreated(e) {
    if (Ge(e) !== nt) return;
    const t = !ie, a = t ? null : vt(e);
    await yt(e, async () => (await import("./chunk-BfvtGU3S.js")).attachMonitor), e.__majoorOmniCamMonitor && _t(e, nt, t, a?.());
  }
});
export {
  ba as $,
