...
function ce(e, t, a = null) {
  ...
  const u = N(r, t, "fov", (g) => Number((g.camera || g).fov ?? 35), !1, o), w = N(r, t, "roll", (g) => Number((g.camera || g).roll ?? 0), !0, o), b = N(r, t, "zoom", (g) => Number((g.camera || g).zoom ?? 1), !1, o), S = N(r, t, "near", (g) => Number((g.camera || g).near ?? 0.01), !1, o), y = N(r, t, "far", (g) => Number((g.camera || g).far ?? 1e4), !1, o), M = r[0]?.camera || r[0] || ie();
  let v = r[0];
  for (const g of r)
    if ((g.frame ?? 0) <= t) v = g;
    else break;
...
function $e(e, t) {
  ...
  const r = me(e), o = (b, S) => (b.transform?.position || r.position)[S] ?? 0, n = (b, S) => (b.transform?.rotation || r.rotation)[S] ?? 0, s = (b, S) => (b.transform?.size || r.size)[S] ?? (S === 2 ? 0.01 : 1), i = _t(a, t), l = N(a, t, "pos_x", (b) => o(b, 0), !1, i), m = N(a, t, "pos_y", (b) => o(b, 1), !1, i), c = N(a, t, "pos_z", (b) => o(b, 2), !1, i), p = N(a, t, "rot_x", (b) => n(b, 0), !0, i), f = N(a, t, "rot_y", (b) => n(b, 1), !0, i), h = N(a, t, "rot_z", (b) => n(b, 2), !0, i), d = N(a, t, "scale_x", (b) => s(b, 0), !1, i), u = N(a, t, "scale_y", (b) => s(b, 1), !1, i), w = N(a, t, "scale_z", (b) => s(b, 2), !1, i);
  return {
...
function Fn() {
  ...
  return {
    ...
    requestTimeoutSeconds: K(zr, 120, 15, 300, !0)
  };
}
function Kn() {
  return {
...
const ye = { t: "translate", r: "rotate", s: "scale" }, Ns = [
...
te.registerExtension({
  ...
  async nodeCreated(e) {
    ...
    await Dt(e, async () => {
      ...
      const { attachDirectorShell: o } = await import("./chunk-CGARWOk9.js").then((n) => n.q);
...
te.registerExtension({
  ...
  async nodeCreated(e) {
    if (Xe(e) !== mt) return;
    const t = !le, a = t ? null : jt(e);
    await Dt(e, async () => (await import("./chunk-BrN0aq9c.js").then((r) => r.g)).attachExtractorShell), e.__majoorOmniCamExtractorRuntime && At(e, mt, t, a?.());
  }
});
te.registerExtension({
  ...
  async nodeCreated(e) {
    if (Xe(e) !== dt) return;
    const t = !le, a = t ? null : jt(e);
    await Dt(e, async () => (await import("./chunk-Dy63pjc4.js")).attachMonitor), e.__majoorOmniCamMonitor && At(e, dt, t, a?.());
  }
});
export {
  on as $,
