...
import { p as ac, a as oc, s as uo, S as sn, c as rc, C as cr, b as nc, i as sc, w as ic, d as cc, U as Ce, m as lc, h as Xe, e as dc, f as mc, g as pc, j as fc, r as hc, k as uc, l as bc, E as gc } from "./chunk-Cp6PWKYg.js";
import { L as vc, h as yc, i as Ct, j as Ro, k as xc, l as wc, o as lr, q as kc, t as Sc, u as jc, v as Cc, w as _c, C as dr, c as _t, x as cn, y as Ec, z as $c, A as Mc, B as ln, D as Ac, E as Tc, G as Pc, H as Ic, I as zc, J as Fc, K as Lc, M as Oc, N as Kc, O as Dc, P as Nc, Q as Rc } from "./chunk-bhLSJ7aw.js";
import { S as qc, b as Bc, p as Wc, l as Vc, u as Hc } from "./chunk-CubCqS-E.js";
import { T as Uc } from "./chunk-IMiHbUfz.js";
import { T as Gc, R as Xc } from "./vendor-three-B8JDtKPi.js";
import { b as Yc, p as dn, a as Eo, c as $o, d as Zc, r as Jc, s as Qc, e as el } from "./chunk-DVHX6-b8.js";
...
const Ha = () => import("./chunk-LSaM0N1v.js");
function tp(e, t) {
...
async function vf(e) {
  ...
  try {
    let s = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-DEreYD-W.js");
...
class tr {
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-DEreYD-W.js"));
    } catch (a) {
  ...
  try {
    a.assetBrowser = Dd(a, {
      ...
      onAgentFirstOpen: async () => {
        if (jo())
          try {
            const { createDirectorAgentPanel: o } = await import("./chunk-DDvnxKfu.js");
            a.agentPanel = o(a);
          } catch (o) {
