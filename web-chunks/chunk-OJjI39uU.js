...
const ho = () => import("./chunk-B5O2cle3.js");
function vf(e, t) {
...
async function Lh(e) {
  ...
  try {
    let n = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-39mDLN0v.js");
...
class Zs {
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-39mDLN0v.js"));
    } catch (a) {
  ...
  try {
    t.assetBrowser = xp(t, {
      ...
      onAgentFirstOpen: async () => {
        try {
          const { createDirectorAgentPanel: m } = await import("./chunk-BfUVpmrr.js");
          t.agentPanel = m(t);
        } catch (m) {
