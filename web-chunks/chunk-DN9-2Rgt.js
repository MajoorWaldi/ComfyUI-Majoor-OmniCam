...
import { api as st } from "../../scripts/api.js";
import { s as $e, c as te, t as ue, a as s, o as ds, b as Tr, d as Xe, e as le, f as qo, r as Ni, g as Mr, h as ms, i as Fi, j as zi, k as Ri, l as Di, m as $r, n as Ir, p as De, q as He, u as Zo, v as nn, w as fe, x as Uo, I as Ao, D as Ki, y as ps, z as Or, A as fs, B as Pr, C as Lr, E as Bi, F as qi, G as Io, H as hs, J as Ui, K as Nr, L as mr, M as sn, N as us, O as pr, P as bs, Q as gs, R as ys, S as vs, T as fr, U as Qo, V as cn, W as ln, X as xs, Y as Wi, Z as Vi, _ as Hi, $ as Gi, a0 as Yi, a1 as dn, a2 as Xi, a3 as ws, a4 as Ji, a5 as Fr, a6 as Zi, a7 as Qi, a8 as ec, a9 as tc, aa as ac, ab as zr, ac as oc, ad as rc, ae as nc, af as sc, ag as ic, ah as cc, ai as lc, aj as dc, ak as mc, al as pc, am as fc, an as hc, ao as uc, ap as bc, aq as gc, ar as yc, as as vc, at as xc, au as wc, av as kc, aw as Sc, ax as _c, ay as jc, az as Ec, aA as Cc, aB as Ac, aC as Tc, aD as Mc, aE as $c, aF as Ic, aG as Oc, aH as Pc, aI as Lc, aJ as Nc, aK as Fc, aL as zc, aM as Rc, aN as Dc, aO as Kc, aP as Bc, aQ as qc, aR as Uc, aS as Wc, aT as Vc, aU as er, aV as Hc, aW as Gc, aX as Yc, aY as Xc, aZ as Jc, a_ as Ye, a$ as Zc, b0 as ks, b1 as Rr, b2 as Qc, b3 as el, b4 as tl, b5 as Ss, b6 as at, b7 as al, b8 as ol, b9 as mn, ba as Dr, bb as rl, bc as _s, bd as nl, be as sl, bf as il, bg as cl, bh as ll, bi as dl, bj as ml, bk as pl, bl as fl, bm as hl, bn as js, bo as ul, bp as bl, bq as gl, br as yl, bs as vl, bt as xl, bu as wl, bv as kl, bw as Sl, bx as _l, by as jl, bz as El, bA as Cl, bB as Al, bC as Tl, bD as Ml, bE as $l, bF as Il, bG as Ol } from "./chunk-GKo9K4St.js";
import { L as Pl, a as Ll, p as Zt, f as Kr, b as Nl, S as Fl, c as pn, d as zl, e as Rl, r as Dl, g as Kl, n as Bl, C as fn, h as Qt, o as Es, i as ql, s as Ul, j as Wl, k as Cs, l as Vl, m as hr, q as ur, w as Hl, t as As, u as Gl, v as Yl, x as Xl, y as Jl, z as Zl, A as Ql, B as ed, D as td, E as ad, F as od, G as rd, H as nd, I as sd, J as id, K as cd, M as ld } from "./chunk-B--CmqWU.js";
import { S as dd, b as md, p as pd, m as fd, l as hd, u as ud } from "./chunk-DjvDVpt_.js";
import { T as bd } from "./chunk-__IQ4xkd.js";
import { T as gd, R as yd } from "./vendor-three-BQUrLQkn.js";
function Kt(e, t = 0) {
  return Math.sin(e * 1.7 + t * 3.1) * 0.5 + Math.sin(e * 3.3 + t * 5.7) * 0.3 + Math.sin(e * 7.9 + t * 11.3) * 0.2;
}
function vd(e, { type: t = "handheld_subtle", intensity: a = 1, duration_frames: o = null, subdivide: r = !0 } = {}) {
  const n = Array.isArray(e) ? e : e?.keyframes || [];
  if (!n || n.length === 0) return n;
  const i = t === "turbulence", c = t === "handheld_heavy", l = (i ? 0.12 : c ? 0.18 : 0.06) * a, p = (i ? 2 : c ? 2.8 : 0.9) * a, m = i ? 0.45 : c ? 0.22 : 0.12, f = n[n.length - 1]?.frame ?? 119, d = Math.max(f + 1, Number(o || (e?.duration_frames ?? f + 1))), h = i ? 4 : c ? 6 : 8, b = Array.isArray(e) ? { keyframes: n, duration_frames: d } : e, u = new Set(n.map((y) => y.frame));
  if (r && d > h) {
    for (let y = 0; y < d; y += h)
      u.add(y);
    u.add(d - 1);
  }
  return [...u].sort((y, x) => y - x).map((y) => {
    const x = $e(b, y), S = Kt(y * m, 1) * l, g = Kt(y * m, 2) * l, C = Kt(y * m, 3) * l * 0.5, M = Kt(y * m, 4) * p, R = Kt(y * m, 5) * (p * 0.35), F = [...x.position], Y = [...x.target];
    return F[0] += S, F[1] += g, F[2] += C, Y[0] += S * 0.35, Y[1] += g * 0.35, {
      frame: y,
      camera: {
        ...x,
        position: F,
        target: Y,
        roll: (x.roll || 0) + M,
        fov: te((x.fov || 35) + R, 10, 140)
      },
      interpolation: "smooth"
    };
  });
}
function xd(e, { duration_frames: t = 120, target: a = [0, 1.5, 0], radius: o = 6, height: r = 3.5 } = {}) {
...
const Ts = 1e-4;
function wd(e, t) {
  return !Array.isArray(e) || !Array.isArray(t) ? e !== t : e.some((a, o) => Math.abs(Number(a) - Number(t[o])) > Ts);
}
function hn(e, t) {
  return Math.abs(Number(e) - Number(t)) > Ts;
}
const Ms = [
  {
    id: "camera",
  ...
  },
  {
    ...
    label: "Look At",
    color: "#f0a742",
    changed: (e, t) => wd(e?.target, t?.target),
    read: (e) => e?.target
  },
  {
    id: "focal_length",
...
function Sd(e, t = null) {
  return Ms.filter((a) => !t || t.has(a.id)).map((a) => ({
    id: a.id,
    label: a.label,
    color: a.color,
    frames: kd(e, a)
...
function Oo(e) {
  ...
  for (const a of [".oc-playhead-head", '[data-role="dope-playhead"]', ".oc-gdope-playhead", ".oc-sequence-playhead"])
    for (const o of e.root.querySelectorAll(a)) _d(o, t);
}
function jd(e, t, a) {
...
function $s(e) {
  ...
  a.delete("camera");
  const o = e.timelineKeyframes() || [], r = Sd(o, a), n = Cd(e, r);
  if (t.dataset.signature !== n) {
    t.dataset.signature = n, t.replaceChildren();
    const i = (c) => ue(e, c);
    for (const c of r) {
      const l = document.createElement("div");
      l.className = "oc-dope-row", l.dataset.channel = c.id, l.style.setProperty("--channel-color", c.color), jd(l, c.frames, i), Ed(e, l, c, o, i), t.appendChild(l);
    }
  }
...
const tr = [1, 2, 5, 10, 20, 25, 50, 100, 200, 250, 500, 1e3, 2e3, 5e3], Is = 46, un = 5, Os = 640;
function Ps(e, t) {
  const a = t > 0 ? t : Os, o = Math.max(2, Math.floor(a / Is)), r = Math.max(1e-6, e / o);
  return tr.find((n) => n >= r) ?? tr[tr.length - 1];
}
function Ad(e, t) {
  const a = Math.max(1, e.state.duration_frames - 1), o = te(Number(e.timelineZoom) || 1, 0.1, 50), r = Number(e.timelinePan) || 0, n = a / o, i = Ps(n, t), l = (i >= un ? i / un : 0) || i, p = [], m = Math.max(0, Math.floor(r / l) * l);
  for (let d = m; d <= a + 1e-6; d += l) {
    const h = Math.round(d), b = ue(e, h);
    if (!(b < -1)) {
      if (b > 101) break;
...
function Td(e) {
  return e.clientWidth || e.parentElement?.clientWidth || Os;
}
function Ls(e) {
  const t = e.root.querySelector('[data-role="ruler"]');
  if (!t) return;
  t.replaceChildren();
  for (const o of Ad(e, Td(t))) {
...
function Md(e, t) {
  ...
  a.addEventListener("pointerup", i, { signal: t }), a.addEventListener("pointercancel", i, { signal: t }), a.addEventListener("wheel", (c) => ds(e, c), { passive: !1, signal: t });
}
const $d = [1, 2, 2.5, 5, 10];
function Id(e, t = 5) {
  const a = Math.abs(e) / Math.max(1, t);
  if (!(a > 0) || !Number.isFinite(a)) return 1;
  const o = 10 ** Math.floor(Math.log10(a)), r = a / o;
  return ($d.find((n) => n >= r) ?? 10) * o;
}
function Od(e, t) {
  const a = Math.max(0, Math.min(4, Math.ceil(-Math.log10(t))));
  return e.toFixed(a);
}
function Pd(e, { left: t, right: a, top: o, width: r, graphWidth: n, graphHeight: i, height: c, timeMin: l, timeMax: p, totalDuration: m, xFor: f, frame: d }) {
  const h = Ps(p - l, n);
  e.strokeStyle = "#222228", e.lineWidth = 1, e.fillStyle = "#6e727a", e.textAlign = "center";
  for (let u = Math.ceil(l / h) * h; u <= p; u += h) {
...
function Ld(e, { left: t, right: a, top: o, width: r, graphHeight: n, minimum: i, maximum: c, yFor: l }) {
  const p = Id(c - i, 4);
  e.strokeStyle = "#222228", e.lineWidth = 1, e.fillStyle = "#6e727a";
  for (let m = Math.ceil(i / p) * p; m <= c; m += p) {
    const f = l(m);
    f < o - 1 || f > o + n + 1 || (e.beginPath(), e.moveTo(t, f), e.lineTo(r - a, f), e.stroke(), e.fillText(Od(m, p), 4, f + 3));
  }
}
function Br(e, t) {
...
function Nd(e, t) {
  ...
  if (!n || n.distance > 12) {
    if (r < 20) {
      const c = Math.max(1, e.state.duration_frames - 1), l = c / (Number(e.curveZoomX) || 1), p = Number(e.curvePanX) || 0, m = Math.round(te(p + (o - 44) / Math.max(1, a.clientWidth - 58) * l, 0, c));
...
function Fd(e, t) {
  ...
  if (e.curvePanDrag && t.pointerId === e.curvePanDrag.pointerId) {
    t.preventDefault();
    const f = t.clientX - e.curvePanDrag.startX, d = t.clientY - e.curvePanDrag.startY, b = Math.max(1, e.state.duration_frames - 1) / (Number(e.curveZoomX) || 1), u = Math.max(1, a.clientWidth - 58), v = a.clientHeight || 180, y = Math.max(1, v - 38);
    e.curvePanX = e.curvePanDrag.origPanX - f / u * b, e.curvePanY = e.curvePanDrag.origPanY + d / y * 10 / (Number(e.curveZoom) || 1), e.drawCurveEditor();
    return;
  }
  if (e.curveScrub && t.pointerId === e.curveScrub.pointerId) {
    t.preventDefault();
    const f = Math.max(1, e.state.duration_frames - 1), d = f / (Number(e.curveZoomX) || 1), h = Number(e.curvePanX) || 0, b = Math.round(te(h + (o - 44) / Math.max(1, a.clientWidth - 58) * d, 0, f));
    e.setFrame(b);
    return;
  }
  if (e.curveBoxSelect && t.pointerId === e.curveBoxSelect.pointerId) {
    ...
    const f = Math.min(e.curveBoxSelect.startX, o), d = Math.max(e.curveBoxSelect.startX, o), h = Math.min(e.curveBoxSelect.startY, r), b = Math.max(e.curveBoxSelect.startY, r), u = (e.curveHitPoints || []).filter((y) => !y.handle && y.x >= f && y.x <= d && y.y >= h && y.y <= b).map((y) => y.key.frame), v = new Set(e.curveBoxSelect.additive ? e.curveBoxSelect.initial : []);
    for (const y of u) v.add(y);
  ...
  if (!e.curveDrag || t.pointerId !== e.curveDrag.pointerId) {
    const f = (e.curveHitPoints || []).map((x) => ({ point: x, distance: Math.hypot(o - x.x, r - x.y) })).sort((x, S) => x.distance - S.distance)[0], d = Math.max(1, e.state.duration_frames - 1), h = d / (Number(e.curveZoomX) || 1), b = Number(e.curvePanX) || 0, u = Math.max(1, a.clientWidth - 58), v = te(Math.round(b + (o - 44) / u * h), 0, d);
    let y = null;
    if (f && f.distance <= 14) {
  ...
  if (e.curveHover = null, t.preventDefault(), t.stopPropagation(), e.curveDrag.historyCheckpointed || (e.checkpoint?.(e.curveDrag.handle ? "Edit curve tangent" : "Edit curve"), e.curveDrag.historyCheckpointed = !0), e.curveDrag.handle) {
    const f = e.curveDrag.key, d = e.curveDrag.channel, h = e.curveDrag.handle, b = e.curveDrag.pixelPerSegment, u = e.curveDrag.valuePerPixel, v = e.curveDrag.keyX, y = e.curveDrag.keyY;
    ...
    if (h === "in") {
      if (g.in_x = te((o - v) / Math.max(1, b), -0.99, -0.01), g.in_y = (y - r) * u, S === "aligned") {
        const C = Math.hypot(g.in_x, g.in_y) || 1e-6, M = Math.hypot(e.curveDrag.startHandles.out_x, e.curveDrag.startHandles.out_y) || 1e-6;
        g.out_x = -g.in_x / C * M, g.out_y = -g.in_y / C * M;
      }
    } else if (g.out_x = te((o - v) / Math.max(1, b), 0.01, 0.99), g.out_y = (y - r) * u, S === "aligned") {
      const C = Math.hypot(g.out_x, g.out_y) || 1e-6, M = Math.hypot(e.curveDrag.startHandles.in_x, e.curveDrag.startHandles.in_y) || 1e-6;
      g.in_x = -g.out_x / C * M, g.in_y = -g.out_y / C * M;
    }
  ...
  if (e.curveDrag.group) {
    ...
    if (d) {
      const b = e.curveDrag.group.map((v) => te(Math.round(v.startFrame + d), 0, e.curveDrag.lastFrame));
  ...
  if (e.curveDrag.object) {
    const f = Xe(e.curveDrag.key.transform);
...
function qd(e, t) {
  ...
  if (t.shiftKey) {
    ...
    e.curvePanX = te((Number(e.curvePanX) || 0) + (t.deltaY > 0 ? 4 : -4), -o * 0.5, o);
  } else t.altKey ? e.curvePanY = (Number(e.curvePanY) || 0) + (t.deltaY > 0 ? -1 : 1) / (Number(e.curveZoom) || 1) : t.ctrlKey ? e.curveZoomX = te((Number(e.curveZoomX) || 1) * a, 0.2, 30) : (e.curveZoom = te((Number(e.curveZoom) || 1) * a, 0.2, 30), e.curveZoomX = te((Number(e.curveZoomX) || 1) * a, 0.2, 30));
  e.drawCurveEditor(), e.setStatus(s(`Curve zoom: ${(e.curveZoom * 100).toFixed(0)}%`));
}
function Ud(e, t) {
  e.curveZoom = te((Number(e.curveZoom) || 1) * t, 0.2, 30), e.curveZoomX = te((Number(e.curveZoomX) || 1) * t, 0.2, 30), e.drawCurveEditor(), e.setStatus(s(`Curve zoom: ${(e.curveZoom * 100).toFixed(0)}%`));
}
function Wd(e, t) {
  t.preventDefault(), t.stopPropagation();
  const a = t.currentTarget, { x: o, y: r } = Br(a, t);
  if (r < 20) return;
  const n = Math.max(1, e.state.duration_frames - 1), i = n / (Number(e.curveZoomX) || 1), c = Number(e.curvePanX) || 0, l = Math.max(1, a.clientWidth - 58), p = te(Math.round(c + (o - 44) / l * i), 0, n);
...
function Ns(e, { selectedOnly: t = !1 } = {}) {
  const a = Math.max(1, (e.state?.duration_frames ?? 120) - 1), o = e.timelineKeyframes() || [], r = e.timelineObject(), n = ut(e), i = e.selectedKeyFrames?.size ? [...e.selectedKeyFrames] : e.selectedKeyFrame != null ? [e.selectedKeyFrame] : [], c = i.length > 0, l = t || c && i.length < o.length ? o.filter((u) => i.includes(u.frame)) : o;
  if (!l.length) {
    e.curveZoom = 1, e.curveZoomX = 1, e.curvePanX = 0, e.curvePanY = 0, e.drawCurveEditor(), e.setStatus(s("Curve view fitted"));
    return;
  }
  const p = l.map((u) => u.frame), m = Math.min(...p), f = Math.max(...p), d = Math.max(1, f - m);
  if (l.length < o.length && d < a) {
    const u = Math.max(2, Math.round(d * 0.15)), v = Math.max(0, m - u), y = Math.min(a, f + u), x = Math.max(1, y - v);
    e.curveZoomX = te(a / x, 0.2, 30), e.curvePanX = v;
  } else
    e.curveZoomX = 1, e.curvePanX = 0;
  const h = [];
  for (const u of l) {
    const v = r ? u.transform || r : u.camera || u;
    for (const y of n) {
      const x = y.get(v);
  ...
  if (h.length > 0) {
    const u = Math.min(...h), v = Math.max(...h), y = Math.max(1e-4, v - u), x = (u + v) / 2, S = (X) => r ? qo(r, X) : $e(e.state, X), g = [], C = Math.max(1, Math.floor(a / 40));
    for (let X = 0; X <= a; X += C) {
      const oe = S(X);
      for (const k of n) {
        const E = k.get(oe);
        Number.isFinite(E) && g.push(E);
      }
    }
    let M = Math.min(...g), R = Math.max(...g);
    (!Number.isFinite(M) || !Number.isFinite(R)) && (M = -1, R = 1), Math.abs(R - M) < 1e-6 && (M -= 1, R += 1);
    const F = (R - M) * 0.1;
    M -= F, R += F;
    const Y = R - M, H = (M + R) / 2;
    if (l.length < o.length && y < Y * 0.75) {
      const X = y * 1.35;
      e.curveZoom = te(Y / X, 0.2, 30), e.curvePanY = x - H;
    } else
...
function Hd(e) {
  ...
  const i = e.timelineObject(), c = e.timelineKeyframes(), l = ut(e), p = 44, m = 14, f = 16, d = 22, h = Math.max(1, a - p - m), b = Math.max(1, o - f - d), u = Math.max(1, e.state.duration_frames - 1), v = te(Number(e.curveZoomX) || 1, 0.1, 50), y = Number(e.curvePanX) || 0, x = u / v, S = y, g = y + x, C = [], M = Math.max(1, Math.ceil(x / Math.max(80, h))), R = ($) => i ? qo(i, $) : $e(e.state, $);
  for (let $ = 0; $ <= u; $ += M) C.push({ frame: $, value: R($) });
  C[C.length - 1]?.frame !== u && C.push({ frame: u, value: R(u) });
  const F = C.flatMap(($) => l.map((G) => G.get($.value)));
  let Y = Math.min(...F), H = Math.max(...F);
  (!Number.isFinite(Y) || !Number.isFinite(H)) && (Y = -1, H = 1), Math.abs(H - Y) < 1e-6 && (Y -= 1, H += 1);
  const X = (H - Y) * 0.1;
  Y -= X, H += X;
  const oe = te(Number(e.curveZoom) || 1, 0.1, 50), k = (H + Y) / 2 + (Number(e.curvePanY) || 0), E = (H - Y) / oe;
  Y = k - E / 2, H = k + E / 2;
  const z = ($) => p + ($ - S) / Math.max(1e-6, g - S) * h, U = ($) => f + b * (H - $) / Math.max(1e-6, H - Y);
  if (n.fillStyle = "#111114", n.fillRect(0, 0, a, o), n.strokeStyle = "#222228", n.lineWidth = 1, n.font = "9px system-ui, -apple-system, sans-serif", n.fillStyle = "#6e727a", Pd(n, {
    left: p,
    right: m,
    top: f,
    width: a,
    ...
    xFor: z,
    frame: e.frame
  }), Ld(n, { left: p, right: m, top: f, width: a, graphHeight: b, minimum: Y, maximum: H, yFor: U }), Y <= 0 && H >= 0) {
    const $ = U(0);
  ...
  for (const $ of l) {
    ...
    let G = !1;
    C.forEach((j) => {
      const W = z(j.frame), J = U($.get(j.value));
      W >= p - 50 && W <= a - m + 50 && (G ? n.lineTo(W, J) : (n.moveTo(W, J), G = !0));
    }), n.stroke();
    for (const j of c) {
      const W = i ? j.transform : j.camera, J = z(j.frame), se = U($.get(W)), ie = j.frame === e.selectedKeyFrame || e.selectedKeyFrames?.has(j.frame);
      ie && (n.fillStyle = "rgba(242, 208, 107, 0.35)", n.beginPath(), n.arc(J, se, 8.5, 0, Math.PI * 2), n.fill()), n.fillStyle = ie ? "#ffd75e" : $.color, n.strokeStyle = "#0d0d10", n.lineWidth = 1.6, n.beginPath(), n.arc(J, se, ie ? 5.2 : 3.8, 0, Math.PI * 2), n.fill(), n.stroke(), e.curveHitPoints.push({
        x: J,
        y: se,
        key: j,
        channel: $,
    ...
    if (e.showCurveHandles)
      for (let j = 0; j < c.length; j++) {
        const W = c[j], J = W.frame === e.selectedKeyFrame || e.selectedKeyFrames?.has(W.frame);
        if (!(J || e.curveChannelFilter !== "all" || c.length <= 4) || W.interpolation !== "bezier") continue;
        const ie = i ? W.transform || i : W.camera || W, re = z(W.frame), de = U($.get(ie)), ye = c[j - 1], he = c[j + 1], ve = Math.max(1, W.frame - (ye?.frame ?? W.frame - 1)), xe = Math.max(1, (he?.frame ?? W.frame + 1) - W.frame), pe = Ni(
          W,
          $.id,
          ye,
          he,
          (L) => $.get(i ? L.transform || i : L.camera || W)
        ), Ie = (H - Y) / Math.max(1, b), we = h * xe / Math.max(1, x), ke = h * ve / Math.max(1, x), be = [];
        (ye || j > 0) && be.push({ side: "in", x: re + pe.in_x * ke, y: de - pe.in_y / Ie }), (he || j < c.length - 1 || c.length === 1) && be.push({ side: "out", x: re + pe.out_x * we, y: de - pe.out_y / Ie });
        for (const L of be) {
          if (n.strokeStyle = $.color, n.lineWidth = J ? 1.5 : 1, n.beginPath(), n.moveTo(re, de), n.lineTo(L.x, L.y), n.stroke(), n.fillStyle = J ? "#2a2233" : "#171720", n.strokeStyle = J ? "#ffd75e" : $.color, n.lineWidth = J ? 2 : 1.2, n.beginPath(), L.side === "in")
            n.arc(L.x, L.y, J ? 5 : 3.8, 0, Math.PI * 2);
          else {
            const q = J ? 4.5 : 3.2;
            n.rect(L.x - q, L.y - q, q * 2, q * 2);
          }
          n.fill(), n.stroke(), e.curveHitPoints.push({
            ...
            object: i,
            handle: L.side,
            pixelPerSegment: L.side === "in" ? ke : we,
            valuePerPixel: Ie,
            startHandles: { ...pe }
          });
        }
  ...
  if (e.curveBoxSelect) {
    const $ = Math.min(e.curveBoxSelect.startX, e.curveBoxSelect.currentX), G = Math.min(e.curveBoxSelect.startY, e.curveBoxSelect.currentY), j = Math.abs(e.curveBoxSelect.currentX - e.curveBoxSelect.startX), W = Math.abs(e.curveBoxSelect.currentY - e.curveBoxSelect.startY);
    n.fillStyle = "rgba(56, 189, 248, 0.15)", n.fillRect($, G, j, W), n.strokeStyle = "#38bdf8", n.lineWidth = 1, n.setLineDash([4, 4]), n.strokeRect($, G, j, W), n.setLineDash([]);
  }
  const V = z(e.frame);
  if (V >= p && V <= a - m && (n.strokeStyle = "#a78bfa", n.lineWidth = 1.5, n.beginPath(), n.moveTo(V, f), n.lineTo(V, f + b), n.stroke(), n.fillStyle = "#a78bfa", n.beginPath(), n.moveTo(V - 4, f), n.lineTo(V + 4, f), n.lineTo(V, f + 6), n.closePath(), n.fill()), e.curveDrag || e.curveHover) {
    let $ = "", G = "";
    if (e.curveDrag)
      if (e.curveDrag.handle) {
        const j = e.curveDrag.handle === "in" ? "In" : "Out";
        $ = `F${e.curveDrag.key.frame} · ${e.curveDrag.channel.name} (${j})`, G = "Tangent edit";
      } else if (e.curveDrag.group && e.curveDrag.group.length > 1) {
        const j = e.curveDrag.key.frame - e.curveDrag.startFrame, W = e.curveDrag.channel.get(e.curveDrag.object ? e.curveDrag.key.transform : e.curveDrag.key.camera), J = W - e.curveDrag.startValue, se = j >= 0 ? `+${j}` : `${j}`, ie = J >= 0 ? `+${J.toFixed(2)}` : `${J.toFixed(2)}`;
        $ = `${e.curveDrag.group.length} keys · ΔF: ${se} · ΔVal: ${ie}`, G = `${e.curveDrag.channel.name}: ${W.toFixed(2)}`;
      } else {
        const j = e.curveDrag.key.frame - e.curveDrag.startFrame, W = e.curveDrag.channel.get(e.curveDrag.object ? e.curveDrag.key.transform : e.curveDrag.key.camera), J = W - e.curveDrag.startValue, se = j >= 0 ? `+${j}` : `${j}`, ie = J >= 0 ? `+${J.toFixed(2)}` : `${J.toFixed(2)}`;
        $ = `F${e.curveDrag.key.frame} (${se}) · ${e.curveDrag.channel.name}: ${W.toFixed(2)} (${ie})`;
      }
    else if (e.curveHover)
      if (e.curveHover.channelName) {
        const j = Number.isFinite(e.curveHover.value) ? e.curveHover.value.toFixed(2) : "";
        $ = `F${e.curveHover.frame} · ${e.curveHover.channelName}: ${j}`, e.curveHover.isHandle && (G = `Handle ${e.curveHover.handleSide}`);
      } else
        $ = `Frame ${e.curveHover.frame}`;
    if ($) {
      n.save(), n.font = "11px system-ui, -apple-system, sans-serif";
      const j = n.measureText($), W = G ? n.measureText(G) : { width: 0 }, J = Math.max(j.width, W.width) + 16, se = G ? 32 : 20, ie = a - m - J - 6, re = f + 6;
      n.fillStyle = "rgba(18, 18, 24, 0.88)", n.strokeStyle = "#38384a", n.lineWidth = 1, n.beginPath(), n.roundRect ? n.roundRect(ie, re, J, se, 4) : n.rect(ie, re, J, se), n.fill(), n.stroke(), n.fillStyle = "#e2e8f0", n.fillText($, ie + 8, re + (G ? 13 : 14)), G && (n.fillStyle = "#94a3b8", n.font = "9.5px system-ui, -apple-system, sans-serif", n.fillText(G, ie + 8, re + 26)), n.restore();
    }
  }
  for (const $ of e.root.querySelectorAll("[data-tangent-mode]")) {
    const G = e.selectedKeyframe(), j = G?.tangents?.channels?.[l[0]?.id]?.mode || G?.tangents?.mode || "auto";
    $.classList.toggle("active", $.dataset.tangentMode === j);
  }
...
function bn(e, { filter: t, label: a, color: o, title: r }) {
...
function Fs(e) {
  ...
  if (!t) return;
  const a = e.timelineObject(), o = a ? a.name || a.type : e.activeCameraTrack().name, r = Gd(e), n = `${o}\0${r.map((c) => `${c.id}:${c.color}`).join("|")}`;
  if (t.dataset.signature !== n) {
    t.dataset.signature = n, t.replaceChildren();
    const c = document.createElement("span");
    c.className = "oc-graph-legend-title", c.textContent = o, t.appendChild(c), t.appendChild(bn(e, {
      filter: "all",
      label: s("All"),
      color: null,
...
function gn(e, t, a) {
  ...
  for (const n of [...e].sort((i, c) => i.frame - c.frame)) {
    ...
    (r === null || !(Math.abs(c - r) <= Yd)) && o.push(n.frame), r = c;
  }
  return o;
}
function qr(e) {
  ...
  const a = e.timelineKeyframes() || [], o = !!e.timelineObject(), r = e.selectedKeyFrames || (e.selectedKeyFrame === null ? /* @__PURE__ */ new Set() : /* @__PURE__ */ new Set([e.selectedKeyFrame])), n = ut(e), i = [
    e.state.duration_frames,
    Number(e.timelineZoom) || 1,
    Number(e.timelinePan) || 0,
    ...n.map((c) => `${c.id}:${gn(a, c, o).join(",")}`)
  ].join("\0");
  ...
  for (const c of n) {
    ...
    for (const d of gn(a, c, o)) {
      const h = ue(e, d);
      if (h < -5 || h > 105) continue;
      const b = document.createElement("button");
      b.type = "button", b.className = `oc-dope-key${d === e.frame ? " at-playhead" : ""}${r.has(d) ? " selected" : ""}`, b.style.left = `${h}%`, b.dataset.frame = String(d), b.title = s("{channel} changes at frame {frame}").replace("{channel}", s(c.name)).replace("{frame}", String(d)), b.addEventListener("click", (u) => {
...
const yn = ["#4aa3ef", "#f2a93b", "#48c774", "#b565d8", "#ec4899"];
function zs(e, t) {
  const a = e.state.cameras.findIndex((r) => r.id === t), o = a >= 0 ? e.state.cameras[a] : null;
  return { camera: o, color: o?.color || yn[Math.max(0, a) % yn.length] };
}
function Ct(e) {
...
function bo(e, t, a, { disabled: o = !1 } = {}) {
...
function Jd(e, t) {
  ...
  if (a.appendChild(bo(
    ...
    () => Xd(e),
    { disabled: o }
  )), t.length && (a.appendChild(bo(
    s("Split at playhead"),
    s("Cut the current shot in two at the playhead"),
    () => {
      e.checkpoint("Split shot"), ms(e.state, e.frame, null) ? Ct(e) : e.setStatus(s("Move the playhead inside a shot first"));
    },
    { disabled: o }
  )), a.appendChild(bo(
    s("Clear edit"),
...
function Qd(e, t, a, o, r) {
  t.preventDefault(), t.stopPropagation();
  const { camera: n } = zs(e, a.camera_id);
  e.contextMenu?.show(t, n?.name || s("Shot"), [
    ...
    null,
    {
      ...
      run: () => {
        e.checkpoint("Split shot"), ms(e.state, e.frame, null) && Ct(e);
      }
    },
    {
      label: s("Remove shot"),
      ...
      disabled: r === 1,
      run: () => {
        e.checkpoint("Remove shot"), Fi(e.state, o) && Ct(e);
      }
    }
  ]);
}
function em(e, t, a, o) {
  const { camera: r, color: n } = zs(e, t.camera_id), i = document.createElement("div");
  ...
  if (c.className = "oc-sequence-name", c.textContent = r?.name || t.camera_id, i.appendChild(c), a > 0) {
    ...
    l.className = "oc-sequence-handle", l.title = s("Drag to trim the cut"), l.addEventListener("pointerdown", (p) => Zd(e, p, l, o, a)), i.appendChild(l);
  }
  return i.addEventListener("contextmenu", (l) => Qd(e, l, t, a, o.__cutCount)), i.addEventListener("pointerdown", () => {
...
function Ds(e, t) {
  ...
  if (n.className = "oc-sequence-lane", n.dataset.role = "sequence-lane", n.setAttribute("aria-label", s("Multi-camera edit")), o.length)
    for (const [c, l] of o.entries()) {
      ...
      ue(e, l.end + 1) < -5 || p > 105 || n.appendChild(em(e, l, c, r));
    }
  else {
    const c = document.createElement("span");
  ...
  r.appendChild(n), r.appendChild(tm(e));
  const i = document.createElement("span");
  i.className = "oc-sequence-playhead", i.style.left = `${ue(e, e.frame)}%`, r.appendChild(i), t.appendChild(r);
}
const am = ['[data-act="curve-zoom-in"]', '[data-act="curve-zoom-out"]', '[data-act="curve-fit"]', '[data-act="curve-handles"]'], vn = { curves: "Graph", dope: "Timeline", sequence: "Sequence" };
function xn(e, t) {
  const a = t in vn ? t : "curves";
  e.graphTab = a;
  ...
  a === "dope" ? qr(e) : a === "sequence" ? (Ds(e, n), n?.focus?.({ preventScroll: !0 })) : e.drawCurveEditor(), e.setStatus(s(vn[a]));
}
function om(e) {
  e.graphTab === "sequence" && Ds(e, e.root.querySelector('[data-role="graph-sequence"]'));
}
function rm(e, t) {
  ...
  a && a.addEventListener("keydown", (o) => {
    if (o.key === "ArrowLeft" || o.key === "ArrowRight") {
      ...
      if (n >= 0 && r.length > 1) {
        ...
        r[i].focus(), xn(e, r[i].dataset.graphTab);
      }
    }
  }, { signal: t });
  for (const o of e.root.querySelectorAll("[data-graph-tab]"))
    o.addEventListener("click", (r) => {
      r.preventDefault(), r.stopPropagation(), xn(e, o.dataset.graphTab);
    }, { signal: t });
}
const nm = /* @__PURE__ */ new Set(["good", "warning", "bad", "unknown"]);
function Ks(e, t) {
  ...
  for (const n of r.frames) {
    ...
    const c = nm.has(n?.state) ? n.state : "unknown", l = n?.score;
    let p = null;
    if (l != null) {
      const m = Number(l);
...
function im(e) {
  ...
  if (!t || !a) return;
  const o = Ks(e.state?.metadata, e.state?.duration_frames), r = o.some((c) => c.state !== "unknown");
  ...
  if (wn.has(a)) return;
  wn.add(a), a.addEventListener("pointerdown", (c) => {
...
function cm(e) {
  ...
  if (!t) return;
  t.innerHTML = "";
  const a = e.timelineObject(), o = e.timelineKeyframes(), r = Math.max(1, e.state.duration_frames - 1), n = te(Number(e.timelineZoom) || 1, 0.1, 50), i = Number(e.timelinePan) || 0, c = r / n, l = i;
  if (e.audioWaveformPeaks && e.audioWaveformPeaks.length) {
    ...
    const S = x.getContext("2d"), g = e.audioWaveformPeaks, C = x.width, M = x.height, R = M / 2;
    S.fillStyle = "#f2d06b";
    for (let F = 0; F < g.length; F++) {
      const H = (F / (g.length - 1) * r - l) / Math.max(1e-6, c) * C;
      if (H >= -5 && H <= C + 5) {
        const X = g[F] * (M * 0.85);
        S.fillRect(H, R - X / 2, Math.max(1, C / g.length * n - 0.5), X);
      }
    }
    t.appendChild(x);
  }
  if (e.state.playback_range) {
    ...
    const S = ue(e, e.state.playback_range[0]), g = ue(e, e.state.playback_range[1]);
    x.style.left = `${S}%`, x.style.width = `${Math.max(0, g - S)}%`, t.appendChild(x);
  }
  Di(e, t);
  for (const x of e.state.markers || []) {
    const S = ue(e, x.frame);
  ...
  if (o.length > 1) {
    const x = ue(e, o[0].frame), S = ue(e, o[o.length - 1].frame), g = document.createElement("span");
  ...
  for (const x of o) {
    ...
    const C = document.createElement("span");
    C.className = "key-label", C.textContent = String(x.frame), g.appendChild(C), g.addEventListener("pointerdown", (M) => {
      if (M.preventDefault(), M.stopPropagation(), g.focus({ preventScroll: !0 }), M.altKey) {
        e.checkpoint("Duplicate keyframe");
        const F = a ? { frame: x.frame, transform: Xe(x.transform), interpolation: x.interpolation } : { frame: x.frame, camera: le(x.camera), interpolation: x.interpolation }, Y = e.timelineKeyframes();
        Y.push(F), Y.sort((H, X) => H.frame - X.frame), e.selectedKeyFrame = F.frame, e.selectedKeyFrames = /* @__PURE__ */ new Set([F.frame]), e.keyDrag = { key: F, box: t, isDuplicate: !0, historyCheckpointed: !0, moving: [{ key: F, startFrame: F.frame }], startPointerFrame: x.frame, startClientX: M.clientX, startClientY: M.clientY }, e.setFrame(F.frame, !1, !1), e.setStatus(s(`Duplicating key from ${x.frame}...`));
        return;
      }
      if (M.shiftKey) {
      ...
      const R = e.timelineKeyframes().filter((F) => e.selectedKeyFrames.has(F.frame));
      e.keyDrag = { key: x, box: t, historyCheckpointed: !1, moving: R.map((F) => ({ key: F, startFrame: F.frame })), startPointerFrame: x.frame, startClientX: M.clientX, startClientY: M.clientY }, e.setFrame(x.frame, !1, !1);
    }), g.addEventListener("click", (M) => {
      M.preventDefault(), M.stopPropagation(), !M.shiftKey && (M.shiftKey || (e.selectedKeyFrames = /* @__PURE__ */ new Set([x.frame])), e.selectKeyframe(x));
    }), t.appendChild(g);
  }
  ...
  if (f) {
    ...
    const g = o.filter((C) => C.frame > e.state.duration_frames - 1).length;
    if (g) {
      const C = document.createElement("span");
      C.className = "oc-dormant-keys", C.textContent = ` · ${g} beyond end`, C.title = s("Keys past the end of the timeline are kept. Lengthen the shot to reach them again."), f.append(C);
    }
  }
  ...
  if (b) {
    ...
    for (const x of e.state.cameras) {
      ...
      const C = document.createElement("span");
      C.textContent = `${x.name} · ${x.keyframes.length} key${x.keyframes.length === 1 ? "" : "s"}${x.id === e.state.playblast_camera_id ? " · PLAYBLAST" : ""}`, S.append(g, C), S.addEventListener("click", () => {
  ...
  y && (y.textContent = m.name), Ls(e), $s(e), Fs(e), qr(e), om(e), e.refreshCameraSelectors(), e.refreshKeyEditor(), e.updateEditState(), e.drawCurveEditor(), e.perf && (e.perf.timelineRefreshCount = (e.perf.timelineRefreshCount || 0) + 1), im(e);
}
class Bs {
...
const bm = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/><path d="M2 12h20"/></svg>', gm = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m21 16-9 5-9-5V8l9-5 9 5v8z"/><path d="m3.27 6.96 8.73 4.84 8.73-4.84"/><path d="M12 22V12"/></svg>', ym = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2L2 20h20L12 2z"/><path d="M12 2v18"/></svg>', vm = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/><path d="m17.66 17.66 1.41 1.41"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="m6.34 17.66-1.41 1.41"/><path d="m19.07 4.93-1.41 1.41"/></svg>', xm = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18h6"/><path d="M10 22h4"/><path d="M15.09 14c.18-.98.65-1.74 1.41-2.5A4.65 4.65 0 0 0 18 8 6 6 0 0 0 6 8c0 1 .23 2.23 1.5 3.5.76.76 1.23 1.52 1.41 2.5"/></svg>', wm = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l8 8-4 4-8-8 4-4z"/><path d="M7 11L2 16l6 6 5-5"/><path d="M18 19l4 2"/><path d="M21 16l2 2"/></svg>', km = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m22 8-6 4 6 4V8z"/><rect width="14" height="12" x="2" y="6" rx="2"/></svg>', Sm = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14h6v6H4z"/><circle cx="17" cy="7" r="3"/><path d="m6 3 4 7H2z"/></svg>';
function _m() {
  return `
...
function Tm() {
  const e = Ll.map((t) => `<button data-lens="${t}">${t}mm</button>`).join("");
  return `
  ...
  return `
    <div class="oc-dope">
      <div class="oc-dope-body">
        <div class="oc-dope-labels">${Ms.map((t) => `
...
const ot = 1, kn = 50, Oe = 120, yt = 160, Ym = Object.freeze(["perspective", "orthographic"]), B = Object.freeze({
...
}), Ws = Object.freeze(Object.values(B)), Se = Object.freeze({
  SCENE_GET: "scene.get",
...
}), Xm = Object.freeze(Object.values(Se));
...
const Jm = 25, Sn = 100;
function vt(e, t) {
  const a = e?.offset === void 0 ? 0 : Number(e.offset), o = e?.limit === void 0 ? Jm : Number(e.limit);
...
function ep(e, t) {
  ...
  switch (t?.type) {
    ...
    case Se.CAMERA_GET: {
      ...
      return je(e, { version: 1, type: t.type, camera: et(r) });
    }
    case Se.CAMERA_LIST: {
      const o = a.cameras || [], { offset: r, limit: n, end: i } = vt(t, o.length);
      return je(e, {
        version: 1,
        type: t.type,
        items: o.slice(r, i).map(Zm),
        total: o.length,
        offset: r,
        limit: n
      });
    }
    case Se.TIMELINE_GET:
      return je(e, {
        version: 1,
        type: t.type,
        timeline: et({
    ...
    case Se.HEALTH_GET:
      return je(e, {
        version: 1,
        type: t.type,
        frames: Ks(a.metadata, a.duration_frames)
      });
    case Se.ASSET_LIST: {
      ...
      return je(e, { version: 1, type: t.type, items: et(r), total: r.length });
    }
    case Se.ASSET_GET: {
    ...
    case Se.OBJECT_LIST: {
      const o = a.objects || [], { offset: r, limit: n, end: i } = vt(t, o.length);
      return je(e, {
        version: 1,
        type: t.type,
        items: o.slice(r, i).map(ar),
        total: o.length,
        offset: r,
        limit: n
      });
    ...
    case Se.OBJECT_SEARCH: {
      const o = String(t.text || "").trim().toLowerCase(), r = Array.isArray(t.tags) ? t.tags.map((h) => String(h).toLowerCase()) : [], n = t.asset_kind !== void 0 ? t.asset_kind : null, i = t.type_ !== void 0 ? t.type_ : t.objectType !== void 0 ? t.objectType : null, c = typeof t.enabled == "boolean" ? t.enabled : null, l = (h) => {
        if (o && ![h.id, h.name || "", ...Array.isArray(h.tags) ? h.tags : []].map((u) => String(u).toLowerCase()).some((u) => u.includes(o)))
          return !1;
        if (r.length) {
          const b = (Array.isArray(h.tags) ? h.tags : []).map((u) => String(u).toLowerCase());
          if (!r.every((u) => b.includes(u))) return !1;
        }
        return !(n !== null && h.asset_kind !== n || i !== null && h.type !== i || c !== null && h.enabled !== !1 !== c);
      }, p = (a.objects || []).filter(l), { offset: m, limit: f, end: d } = vt(t, p.length);
      return je(e, {
        version: 1,
        type: t.type,
        items: p.slice(m, d).map(ar),
        total: p.length,
        offset: m,
        limit: f
      });
    }
    case Se.CHARACTER_LIST: {
      const o = (a.objects || []).filter((c) => c.asset_kind === "character"), { offset: r, limit: n, end: i } = vt(t, o.length);
      return je(e, {
        version: 1,
        type: t.type,
    ...
    case Se.SHOT_LIST: {
      ...
      })), { offset: i, limit: c, end: l } = vt(t, n.length);
      return je(e, {
        version: 1,
        type: t.type,
        items: n.slice(i, l),
    ...
    case Se.KEYFRAME_LIST: {
      const o = t.cameraId || a.active_camera_id, r = (a.cameras || []).find((p) => p.id === o);
      if (!r) throw new O("UNKNOWN_CAMERA", `Unknown camera: ${o}`);
      const n = r.keyframes || [], { offset: i, limit: c, end: l } = vt(t, n.length);
      return je(e, {
        version: 1,
        type: t.type,
        cameraId: r.id,
...
function ap(e, t) {
  e.cameras ||= [];
  const a = new Set(e.cameras.map((i) => i.id)), o = Wo(a, "camera", t.id), r = { ...Ir(), ...t.camera || {} }, n = {
    id: o,
    name: t.name || o,
    color: "#4aa3ef",
    locked: !1,
...
function op(e, t) {
  ...
  const o = new Set(e.cameras.map((i) => i.id)), r = Wo(o, "camera", t.id), n = JSON.parse(JSON.stringify(a));
...
function ip(e, t) {
  if (!Vs.has(t.objectType))
    throw new O("UNSUPPORTED_OBJECT_TYPE", `object.create does not support type: ${t.objectType}`);
  e.objects ||= [];
  const a = new Set(e.objects.map((i) => i.id)), o = Wo(a, t.objectType, t.id), r = tp(t.objectType), n = {
    id: o,
    type: t.objectType,
    name: t.name || o,
    ...r,
...
function cp(e, t) {
  ...
  const o = new Set(e.objects.map((l) => l.id)), r = Wo(o, a.type || "object", t.id), n = Array.isArray(t.offset) ? t.offset : [0.35, 0, 0.35], i = JSON.parse(JSON.stringify(a));
...
function up(e, t) {
  const a = [...e.position], o = Array.isArray(t) ? [...t] : [...e.target], r = De(o, a), n = He(r) > 1e-9 ? Zo(r) : [0, 0, -1];
  let i = nn(n, Wr);
  He(i) < 1e-6 && (i = [1, 0, 0]), i = Zo(i);
  const c = Zo(nn(i, n));
...
function jn(e, t, a) {
  const o = a === "out" ? -1 : 1, r = fe(e.position, Uo(e.forward, o * t));
  return [
    { position: e.position, target: e.target },
...
function En(e, t, a) {
  const o = a === "right" ? 1 : -1, r = Uo(e.right, o * t);
  return [
    { position: e.position, target: e.target },
...
function An(e, t, a) {
  const o = a === "down" ? -1 : 1, r = fe(e.position, Uo(Wr, o * t));
  return [
    { position: e.position, target: e.target },
    { position: r, target: e.target }
  ];
}
function go(e, { degrees: t = 180, direction: a = "cw", radius: o, radiusEnd: r, heightOffset: n = 0, samples: i = 5, close: c = !1 } = {}) {
  const l = e.target, p = e.position[0] - l[0], m = e.position[2] - l[2], f = Math.hypot(p, m) || 1e-6, d = Math.atan2(m, p), h = Number.isFinite(o) ? o : f, b = Number.isFinite(r) ? r : h, u = a === "ccw" ? 1 : -1, v = Math.abs(t) * Math.PI / 180 * u, y = Math.max(2, Math.round(i)), x = e.position[1] + n, S = [];
  for (let g = 0; g < y; g += 1) {
    const C = c ? g / y : g / (y - 1), M = d + v * C, R = h + (b - h) * C;
    S.push({
      position: [l[0] + Math.cos(M) * R, x, l[2] + Math.sin(M) * R],
      target: [...l]
    });
  }
  return S;
}
function Hs({ type: e, camera: t, target: a, startFrame: o, endFrame: r, params: n = {} } = {}) {
  if (!Po.includes(e)) return { ok: !1, reason: "unknown_preset" };
  ...
  const l = up(t, a), p = Number(n.distance) > 0 ? Number(n.distance) : 1, m = (u, v, y) => ({
    degrees: Number(n.degrees) || u,
    direction: v,
  ...
  switch (e) {
    ...
    case "arc_right":
      ...
      break;
    case "orbit":
      f = go(l, { ...m(180, n.direction === "ccw" ? "ccw" : "cw", 5), close: !!n.close });
      break;
    case "spiral":
      f = go(l, {
  ...
  const d = f.map((u, v) => f.length <= 1 ? i : Math.round(i + (c - i) * v / (f.length - 1)));
  for (let u = 1; u < d.length; u += 1) d[u] <= d[u - 1] && (d[u] = d[u - 1] + 1);
  for (let u = d.length - 1; u > 0; u -= 1) d[u] > c - (d.length - 1 - u) && (d[u] = c - (d.length - 1 - u));
  d[0] = i, d[d.length - 1] = c;
  const h = bp(t);
  return { ok: !0, keyframes: f.map((u, v) => ({
    frame: d[v],
    interpolation: "smooth",
    camera: { position: u.position, target: u.target, ...h }
  })) };
}
const yp = 2048;
function vp(e, t) {
  const a = e._directorApiTxIds ||= /* @__PURE__ */ new Set();
  for (a.has(t) && a.delete(t), a.add(t); a.size > yp; )
    a.delete(a.values().next().value);
}
function xp(e, t) {
  return !!e._directorApiTxIds?.has(t);
}
const mt = (e) => typeof e == "number" && Number.isFinite(e);
function ge(e, t, a) {
  if (!Array.isArray(e) || e.length !== 3 || !e.every(mt))
...
function Tn(e, t, a) {
  if (!Array.isArray(e) || e.length === 0 || !e.every((o) => Number.isInteger(o) && o >= 0))
    throw new O("BAD_VALUE", `${t} must be a non-empty array of non-negative integer frames`, a);
}
const wp = /* @__PURE__ */ new Set(["translate", "rotate", "scale"]), kp = /* @__PURE__ */ new Set([
  "position",
  "target",
  "up",
  "fov",
...
function Sp(e, t) {
  ...
  if (e.position !== void 0 && ge(e.position, "camera.position", t), e.target !== void 0 && ge(e.target, "camera.target", t), e.up !== void 0 && ge(e.up, "camera.up", t), e.fov !== void 0 && (jt(e.fov, "camera.fov", t), e.fov < 1 || e.fov > 179))
    throw new O("BAD_VALUE", "camera.fov must be within 1..179", t);
  if (e.roll !== void 0 && jt(e.roll, "camera.roll", t), e.zoom !== void 0 && (jt(e.zoom, "camera.zoom", t), e.zoom <= 0))
    throw new O("BAD_VALUE", "camera.zoom must be > 0", t);
  if (e.near !== void 0 && (jt(e.near, "camera.near", t), e.near <= 0))
    throw new O("BAD_VALUE", "camera.near must be > 0", t);
  if (e.far !== void 0) {
    jt(e.far, "camera.far", t);
    const a = e.near === void 0 ? Ki : e.near;
    if (e.far <= a)
      throw new O("BAD_VALUE", "camera.far must be greater than camera.near", t);
  }
  if (e.camera_type !== void 0 && !Ym.includes(e.camera_type))
...
function _p(e, t) {
  ...
  switch (a) {
    case B.ASSET_INSTANTIATE: {
      ...
      e.point !== void 0 && ge(e.point, "point", t), e.id !== void 0 && ee(e.id, "id", t);
      break;
    }
    case B.CAMERA_SET_ACTIVE:
      ee(e.cameraId, "cameraId", t);
      break;
    case B.CAMERA_SET_LOCKED:
      if (ee(e.cameraId, "cameraId", t), typeof e.value != "boolean")
        throw new O("BAD_VALUE", "camera.set_locked needs a boolean value", t);
      break;
    case B.CAMERA_CREATE:
      if (e.id !== void 0 && ee(e.id, "id", t, Oe), e.name !== void 0 && ee(e.name, "name", t, yt), e.camera !== void 0) {
      ...
      if (e.interpolation !== void 0 && !Ao.includes(e.interpolation))
        throw new O("BAD_INTERPOLATION", `Unsupported interpolation: ${e.interpolation}`, t);
      break;
    case B.CAMERA_DUPLICATE:
      ee(e.cameraId, "cameraId", t, Oe), e.id !== void 0 && ee(e.id, "id", t, Oe), e.name !== void 0 && ee(e.name, "name", t, yt);
      break;
    case B.CAMERA_DELETE:
    case B.CAMERA_SET_PLAYBLAST:
      ee(e.cameraId, "cameraId", t, Oe);
      break;
    case B.CAMERA_RENAME:
      ee(e.cameraId, "cameraId", t, Oe), ee(e.name, "name", t, yt);
      break;
    case B.OBJECT_CREATE:
      if (ee(e.objectType, "objectType", t), !Vs.has(e.objectType))
      ...
      e.id !== void 0 && ee(e.id, "id", t, Oe), e.name !== void 0 && ee(e.name, "name", t, yt), e.position !== void 0 && ge(e.position, "position", t), e.rotation !== void 0 && ge(e.rotation, "rotation", t);
      break;
    case B.OBJECT_DUPLICATE:
      ee(e.objectId, "objectId", t, Oe), e.id !== void 0 && ee(e.id, "id", t, Oe), e.name !== void 0 && ee(e.name, "name", t, yt), e.offset !== void 0 && ge(e.offset, "offset", t);
      break;
    case B.OBJECT_DELETE:
      ee(e.objectId, "objectId", t, Oe);
      break;
    case B.OBJECT_RENAME:
      ee(e.objectId, "objectId", t, Oe), ee(e.name, "name", t, yt);
      break;
    case B.OBJECT_SET_PARENT:
      ee(e.objectId, "objectId", t, Oe), e.parentId !== null && e.parentId !== void 0 && ee(e.parentId, "parentId", t, Oe);
      break;
    case B.CAMERA_TRANSFORM:
      if (e.cameraId !== void 0 && ee(e.cameraId, "cameraId", t), e.position !== void 0 && ge(e.position, "position", t), e.target !== void 0 && ge(e.target, "target", t), e.frame !== void 0 && Te(e.frame, "frame", t), e.position === void 0 && e.target === void 0)
        throw new O("EMPTY_OPERATION", "camera.transform needs position and/or target", t);
      break;
    case B.CAMERA_LOOK_AT:
      if (e.cameraId !== void 0 && ee(e.cameraId, "cameraId", t), e.point !== void 0 && ge(e.point, "point", t), e.objectId !== void 0 && e.objectId !== null && ee(e.objectId, "objectId", t), e.point === void 0 && e.objectId === void 0)
        throw new O("EMPTY_OPERATION", "camera.look_at needs a point or an objectId", t);
      break;
    case B.OBJECT_TRANSFORM:
      if (ee(e.objectId, "objectId", t), e.position !== void 0 && ge(e.position, "position", t), e.rotation !== void 0 && ge(e.rotation, "rotation", t), e.scale !== void 0 && ge(e.scale, "scale", t), e.position === void 0 && e.rotation === void 0 && e.scale === void 0)
        throw new O("EMPTY_OPERATION", "object.transform needs position, rotation and/or scale", t);
      break;
    case B.OBJECT_SET_ENABLED:
    case B.OBJECT_SET_LOCKED:
      if (ee(e.objectId, "objectId", t), typeof e.value != "boolean")
        throw new O("BAD_VALUE", `${a} needs a boolean value`, t);
      break;
    case B.OBJECT_SET_TAGS:
    ...
    case B.CHARACTER_SET_POSE:
      ...
      break;
    case B.CHARACTER_SET_JOINT_ROTATION:
      if (ee(e.objectId, "objectId", t), ee(e.joint, "joint", t), !Array.isArray(e.rotation) || e.rotation.length !== 4 || !e.rotation.every(mt))
        throw new O("BAD_QUATERNION", "rotation must be [x,y,z,w] of finite numbers", t);
      break;
    case B.CHARACTER_SET_MOTION: {
      ...
      for (const r of ["start_frame", "end_frame", "speed", "offset_seconds"])
        if (o[r] !== void 0 && !mt(o[r]))
          throw new O("BAD_VALUE", `motion.${r} must be a finite number`, t);
      if (mt(o.start_frame) && mt(o.end_frame) && o.end_frame > 0 && o.end_frame <= o.start_frame)
        throw new O("BAD_MOTION_RANGE", "motion end_frame is not after start_frame", t);
      break;
    }
    case B.CHARACTER_CLEAR_MOTION:
      ee(e.objectId, "objectId", t);
      break;
    case B.KEYFRAME_UPSERT:
      if (e.cameraId !== void 0 && ee(e.cameraId, "cameraId", t), Te(e.frame, "frame", t), e.interpolation !== void 0 && !Ao.includes(e.interpolation))
        throw new O("BAD_INTERPOLATION", `Unsupported interpolation: ${e.interpolation}`, t);
      if (e.camera !== void 0) {
        if (!e.camera || typeof e.camera != "object")
          throw new O("BAD_VALUE", "keyframe.upsert camera must be an object", t);
        e.camera.position !== void 0 && ge(e.camera.position, "camera.position", t), e.camera.target !== void 0 && ge(e.camera.target, "camera.target", t);
        for (const o of ["fov", "roll", "zoom", "near", "far"])
          if (e.camera[o] !== void 0 && !mt(e.camera[o]))
            throw new O("BAD_VALUE", `camera.${o} must be finite`, t);
      }
      break;
    case B.KEYFRAME_REMOVE:
      e.cameraId !== void 0 && ee(e.cameraId, "cameraId", t), Te(e.frame, "frame", t);
      break;
    case B.KEYFRAME_SET_INTERPOLATION:
      if (e.cameraId !== void 0 && ee(e.cameraId, "cameraId", t), Te(e.frame, "frame", t), !Ao.includes(e.interpolation))
        throw new O("BAD_INTERPOLATION", `Unsupported interpolation: ${e.interpolation}`, t);
      break;
    case B.TIMELINE_SET_RANGE:
      if (Te(e.start, "start", t), Te(e.end, "end", t), e.end < e.start)
        throw new O("BAD_RANGE", "range end is before start", t);
      break;
    case B.TIMELINE_SET_DURATION:
      if (!Number.isInteger(e.frames) || e.frames < 1)
        throw new O("BAD_VALUE", "timeline.set_duration needs frames >= 1", t);
      break;
    case B.CUT_UPSERT:
      Te(e.start, "start", t), ee(e.cameraId, "cameraId", t);
      break;
    case B.CUT_REMOVE:
      Te(e.start, "start", t);
      break;
    case B.CUT_SET_CAMERA:
      Te(e.start, "start", t), ee(e.cameraId, "cameraId", t);
      break;
    case B.CAMERA_PATH_TRANSFORM_KEYS: {
      e.cameraId !== void 0 && ee(e.cameraId, "cameraId", t), Tn(e.frames, "frames", t);
      const o = e.transform;
      if (!o || typeof o != "object" || Array.isArray(o))
        throw new O("BAD_VALUE", "camera.path.transform_keys needs a transform object", t);
      if (!wp.has(o.mode))
        throw new O("BAD_VALUE", "transform.mode must be translate, rotate or scale", t);
      o.mode === "translate" ? ge(o.delta, "transform.delta", t) : o.mode === "scale" ? ge(o.factors, "transform.factors", t) : ge(o.rotationDeg, "transform.rotationDeg", t), o.origin !== void 0 && ge(o.origin, "transform.origin", t);
      break;
    }
    case B.CAMERA_PATH_INSERT_KEY:
      e.cameraId !== void 0 && ee(e.cameraId, "cameraId", t), Te(e.leftFrame, "leftFrame", t), Te(e.rightFrame, "rightFrame", t), e.t !== void 0 && jt(e.t, "t", t);
      break;
    case B.CAMERA_PATH_DELETE_KEYS:
      e.cameraId !== void 0 && ee(e.cameraId, "cameraId", t), Tn(e.frames, "frames", t);
      break;
    case B.CAMERA_PATH_REDISTRIBUTE_TIMING:
      e.cameraId !== void 0 && ee(e.cameraId, "cameraId", t), e.startFrame !== void 0 && Te(e.startFrame, "startFrame", t), e.endFrame !== void 0 && Te(e.endFrame, "endFrame", t);
      break;
    case B.CAMERA_PATH_APPLY_PRESET:
      if (e.cameraId !== void 0 && ee(e.cameraId, "cameraId", t), !Po.includes(e.presetType))
        throw new O("BAD_VALUE", `presetType must be one of: ${Po.join(", ")}`, t);
      if (Te(e.startFrame, "startFrame", t), Te(e.endFrame, "endFrame", t), e.endFrame <= e.startFrame)
        throw new O("BAD_RANGE", "camera.path.apply_preset endFrame must be after startFrame", t);
      if (e.target !== void 0 && ge(e.target, "target", t), e.params !== void 0 && (typeof e.params != "object" || Array.isArray(e.params)))
        throw new O("BAD_VALUE", "camera.path.apply_preset params must be an object", t);
      break;
    default:
      throw new O("UNKNOWN_OPERATION", `Unknown operation type: ${a}`, t);
  }
...
function jp(e, t) {
  ...
  if (t.operations.length > kn)
    throw new O(
      "TOO_MANY_OPERATIONS",
      `transaction has ${t.operations.length} operations (max ${kn})`
    );
  return t.operations.forEach((a, o) => _p(a, o)), {
    version: ot,
    id: t.id,
...
const Cp = "omnicam/library", Ap = "majoor_omnicam/blockout_library", Tp = Object.freeze({
...
function Gs(e) {
  return e.file ? `${e.source === "legacy" ? Ap : Cp}/${e.file} [input]` : "";
}
function Mn(e, t, a) {
  const o = e || "asset";
  let r = `${o}_${a}`, n = 2;
...
function Ip(e, t = {}) {
  ...
  const a = Mp(t.point, [0, 0, 0]), o = String(t.idSeed || Date.now().toString(36)), r = String(e.kind || "prop"), n = r === "character", i = Tp[e.id];
  if (r === "helper" && !e.file && i && i !== "null")
    return {
      id: Mn(i, t.existingIds, o),
      type: i,
      name: e.name || i,
      position: a,
      rotation: [0, 0, 0],
  ...
  const c = {
    id: Mn(r === "character" ? "character" : r, t.existingIds, o),
    type: "glb",
  ...
  return n && (c.character = $p(e)), c;
}
function Op({ groundHit: e, orbitTarget: t } = {}) {
...
const Vr = ["pos_x", "pos_y", "pos_z"], br = 1e-9, Vo = ["auto", "aligned", "free", "corner"];
function Me(e, t = 0) {
  const a = Number(e);
...
function gr(e, t, a) {
  const o = Be(e), r = t ? Be(t) : o, n = a ? Be(a) : o, i = Math.max(br, Me(e?.frame) - Me(t?.frame, Me(e?.frame) - 1)), c = Math.max(br, Me(a?.frame, Me(e?.frame) + 1) - Me(e?.frame)), l = [0, 0, 0], p = [0, 0, 0];
  for (let m = 0; m < 3; m += 1) {
...
function Ys(e, t, a) {
  const o = Be(e), r = t ? Be(t) : o, n = a ? Be(a) : o;
  return {
    out: Lo(At(n, o), 1 / 3),
    in: Lo(At(r, o), 1 / 3)
  };
...
function ft(e) {
  ...
  return Vo.includes(t) ? t : "auto";
}
function vr(e, t = null, a = null) {
  const o = ft(e), r = Be(e);
  if (o === "corner") {
    const l = Ys(e, t, a);
    return { in: yo(r, l.in), out: yo(r, l.out), mode: o };
  }
  const n = gr(e, t, a), i = (o === "free" || o === "aligned") && yr(e, "out") || n.out, c = (o === "free" || o === "aligned") && yr(e, "in") || n.in;
  return { in: yo(r, c), out: yo(r, i), mode: o };
}
function yo(e, t) {
  return [e[0] + t[0], e[1] + t[1], e[2] + t[2]];
}
...
function Xs(e, t, a) {
  const o = Be(e), r = vr(e, t, a);
  ht(e, "out", At(r.out, o)), ht(e, "in", At(r.in, o));
}
function Lp(e, t, a, { prevKey: o = null, nextKey: r = null, breakCoupling: n = !1 } = {}) {
  if (!e || t !== "in" && t !== "out") return e;
  let i = ft(e);
  if (i === "corner") return e;
  i === "auto" && (i = "aligned", e.tangents = e.tangents && typeof e.tangents == "object" ? e.tangents : {}, e.tangents.spatial_mode = "aligned", Xs(e, o, r));
  const c = Be(e), l = At([
    Me(a?.[0]),
    Me(a?.[1]),
    Me(a?.[2])
  ], c);
  if (No(e), ht(e, t, l), i === "aligned" && !n) {
    const p = t === "out" ? "in" : "out", m = yr(e, p) || (p === "out" ? gr(e, o, r).out : gr(e, o, r).in), f = $n(l), d = $n(m) || f || 1, h = f > br ? Lo(l, -d / f) : Lo(m, 1);
    ht(e, p, h);
  }
  return e;
}
function vo(e, t, a) {
  if (!e || t !== "in" && t !== "out") return e;
  const o = Be(e);
  return No(e), ht(e, t, At([
    Me(a?.[0]),
    Me(a?.[1]),
    Me(a?.[2])
  ], o)), e;
}
function Np(e, t, { prevKey: a = null, nextKey: o = null } = {}) {
  if (!e || !Vo.includes(t)) return e;
  ...
  if (t === "corner") {
    const r = Ys(e, a, o);
    return No(e), ht(e, "out", r.out), ht(e, "in", r.in), e;
  }
  return No(e), Xs(e, a, o), e;
}
const Js = 1e-9;
function Fp(e, t) {
  if (t === "object") {
...
function Hr(e, t) {
  const a = e.map((i) => Fp(i, t)), o = zp(a), r = e.map((i) => i.frame), n = Math.max(1, r[r.length - 1] - r[0]);
  return a.map((i, c) => [
    (r[c] - r[0]) / n,
...
function Dp(e, t, { tolerance: a = 0.02, keepFrames: o = [] } = {}) {
  const r = [...e].sort((m, f) => m.frame - f.frame);
  if (r.length <= 2 || a <= 0) return { keys: r, removed: 0 };
  const n = Hr(r, t), i = /* @__PURE__ */ new Set(), c = new Set(o);
  r.forEach((m, f) => {
...
function Kp(e, t, { target: a = 2, keepFrames: o = [] } = {}) {
...
function Bp(e, t, { mergeWithin: a = 1, epsilon: o = 1e-3, keepFrames: r = [] } = {}) {
...
function qp(e, t, a, { lastFrame: o = 1 / 0 } = {}) {
...
function Vp(e, t, a, o, r) {
  const n = wt(e, t, r), i = wt(t, a, r), c = wt(a, o, r), l = wt(n, i, r), p = wt(i, c, r), m = wt(l, p, r);
...
function Qs(e, { leftFrame: t, rightFrame: a, t: o = 0.5 } = {}) {
  const r = [...e].sort((S, g) => S.frame - g.frame), n = r.findIndex((S) => S.frame === t), i = n >= 0 ? n + 1 : -1;
  if (n < 0 || i < 0 || i >= r.length || r[i].frame !== a)
    return { ok: !1, reason: "segment_not_found" };
  if (a - t < 2)
    return { ok: !1, reason: "no_free_frame" };
  const c = Math.min(0.999, Math.max(1e-3, Number.isFinite(o) ? o : 0.5)), l = Math.round(t + c * (a - t)), p = Hp(r, t, a, l);
  if (p < 0) return { ok: !1, reason: "no_free_frame" };
  const m = (p - t) / (a - t), f = r[n], d = r[i], h = n > 0 ? r[n - 1] : null, b = i + 1 < r.length ? r[i + 1] : null, u = f.interpolation === "bezier" || d.interpolation === "bezier", v = $e({ keyframes: r }, p), y = { frame: p, interpolation: u ? "bezier" : f.interpolation, camera: v };
  if (u) {
    const S = [...f.camera.position], g = vr(f, h, d).out, C = vr(d, f, b).in, M = [...d.camera.position], R = Vp(S, g, C, M, m);
    y.camera = { ...le(v), position: [...R.point] };
    const F = ft(f);
    (F === "free" || F === "aligned") && vo(f, "out", R.left[1]);
    const Y = ft(d);
    (Y === "free" || Y === "aligned") && vo(d, "in", R.right[2]), vo(y, "in", R.left[2]), vo(y, "out", R.right[1]);
  }
  return { ok: !0, keys: [...r, y].sort((S, g) => S.frame - g.frame), frame: p };
}
function Gp(e, t) {
  const { keys: a, removed: o } = Zs(e, t, { minKeys: 1 });
  return { ok: o > 0, keys: a, removed: o };
}
function xr(e, t) {
...
function Bt(e, t, a) {
  t.keyframes = a, t.id === e.active_camera_id && (e.keyframes = a);
}
const qt = T.viewport | T.previews | T.timeline | T.inspector;
function On(e, t, a) {
  const o = new Set((e.keyframes || []).map((n) => n.frame)), r = t.find((n) => !o.has(n));
  if (r !== void 0)
    throw new O("UNKNOWN_KEYFRAME", `${a}: camera has no key at frame ${r}`);
}
const Yp = {
  [B.ASSET_INSTANTIATE](e, t) {
    const a = new Set((e.objects || []).map((r) => r.id));
    let o;
    try {
      o = Ip(t.asset, { point: t.point, idSeed: t.id, existingIds: a });
    } catch (r) {
  ...
  [B.CAMERA_SET_ACTIVE](e, t) {
    return xr(e, t.cameraId), e.active_camera_id = t.cameraId, { dirtyMask: T.viewport | T.previews | T.inspector | T.outliner | T.timeline };
  },
  [B.CAMERA_SET_LOCKED](e, t) {
    return xr(e, t.cameraId).locked = t.value, { dirtyMask: T.outliner | T.inspector | T.viewport };
  },
  [B.CAMERA_CREATE](e, t) {
    const a = ap(e, t);
    return { dirtyMask: T.outliner | T.inspector | T.viewport | T.previews | T.timeline, outcome: a };
  },
  [B.CAMERA_DUPLICATE](e, t) {
    const a = op(e, t);
    return { dirtyMask: T.outliner | T.inspector | T.viewport | T.previews | T.timeline, outcome: a };
  },
  [B.CAMERA_DELETE](e, t) {
  ...
  [B.CAMERA_LOOK_AT](e, t) {
    const a = ze(e, t.cameraId);
    if (t.objectId !== void 0 && (t.objectId === null || t.objectId === "" ? (a.target_object_id = null, a.id === e.active_camera_id && (e.target_object_id = null)) : (wr(e, t.objectId), a.target_object_id = t.objectId, a.id === e.active_camera_id && (e.target_object_id = t.objectId))), t.point) {
      const o = or(a);
      o.target = [...t.point];
  ...
  [B.OBJECT_SET_PARENT](e, t) {
    dt(e, t.objectId);
    const a = mp(e, t);
    return { dirtyMask: T.viewport | T.outliner | T.inspector, outcome: a };
  },
  [B.OBJECT_TRANSFORM](e, t) {
    const a = dt(e, t.objectId);
  ...
  [B.OBJECT_SET_ENABLED](e, t) {
    return dt(e, t.objectId).enabled = t.value, { dirtyMask: T.viewport | T.previews | T.outliner | T.inspector };
  },
  [B.OBJECT_SET_LOCKED](e, t) {
    return wr(e, t.objectId).locked = t.value, { dirtyMask: T.outliner | T.inspector };
  },
  [B.OBJECT_SET_TAGS](e, t) {
    const a = dt(e, t.objectId), o = Ui(t.tags), r = o.length !== t.tags.length ? "some tags were dropped or normalised" : void 0;
    return o.length ? a.tags = o : delete a.tags, { dirtyMask: T.outliner | T.inspector | T.viewport, warning: r };
  },
  [B.OBJECT_SET_ANNOTATION](e, t) {
    const a = dt(e, t.objectId), o = t.annotation === null ? null : hs(t.annotation);
    if (t.annotation && !o)
  ...
  [B.CHARACTER_SET_JOINT_ROTATION](e, t) {
    ...
    return a.character = {
      ...a.character || {},
      pose: qi(a.character?.pose, t.joint, t.rotation)
    }, { dirtyMask: T.viewport | T.previews | T.inspector };
  },
  [B.CHARACTER_SET_MOTION](e, t) {
    const a = xo(e, t.objectId), o = Lr(t.motion);
  ...
  [B.KEYFRAME_UPSERT](e, t) {
    ...
    const r = !o;
    if (!o) {
      const i = wo(a, 0)?.camera || a.camera || {};
  ...
  [B.KEYFRAME_REMOVE](e, t) {
    const a = ze(e, t.cameraId), o = (a.keyframes || []).length;
  ...
  [B.KEYFRAME_SET_INTERPOLATION](e, t) {
    const a = ze(e, t.cameraId), o = wo(a, t.frame);
    if (!o) throw new O("UNKNOWN_KEYFRAME", `camera has no key at frame ${t.frame}`);
    if (!Ao.includes(t.interpolation))
  ...
  [B.CAMERA_PATH_TRANSFORM_KEYS](e, t) {
    const a = ze(e, t.cameraId);
    On(a, t.frames, "camera.path.transform_keys");
    const o = (a.keyframes || []).filter((i) => t.frames.includes(i.frame)), r = Array.isArray(t.transform.origin) ? t.transform.origin : Or(o), n = fs(a.keyframes || [], t.frames, {
      mode: t.transform.mode,
      origin: r,
      delta: t.transform.delta,
      factors: t.transform.factors,
      rotationDeg: t.transform.rotationDeg,
      lookAtActive: Pr(a, e.objects)
    });
    return Bt(e, a, n), { dirtyMask: qt };
  },
  [B.CAMERA_PATH_INSERT_KEY](e, t) {
    const a = ze(e, t.cameraId), o = Qs(a.keyframes || [], {
    ...
    if (!o.ok)
      throw new O(
        o.reason === "no_free_frame" ? "NO_FREE_FRAME" : "SEGMENT_NOT_FOUND",
        `camera.path.insert_key: could not insert a key between frame ${t.leftFrame} and ${t.rightFrame}`
      );
    return Bt(e, a, o.keys), { dirtyMask: qt, outcome: { frame: o.frame } };
  },
  [B.CAMERA_PATH_DELETE_KEYS](e, t) {
    const a = ze(e, t.cameraId);
    On(a, t.frames, "camera.path.delete_keys");
    const o = Gp(a.keyframes || [], t.frames);
    if (!o.ok)
      throw new O("CANNOT_DELETE", "camera.path.delete_keys: a camera track needs at least one key");
    return Bt(e, a, o.keys), { dirtyMask: qt, outcome: { removed: o.removed } };
  },
  [B.CAMERA_PATH_REDISTRIBUTE_TIMING](e, t) {
    const a = ze(e, t.cameraId), o = [...a.keyframes || []].sort((c, l) => c.frame - l.frame), r = Number.isInteger(t.startFrame) ? t.startFrame : o[0]?.frame, n = Number.isInteger(t.endFrame) ? t.endFrame : o[o.length - 1]?.frame, i = ps(o, { startFrame: r, endFrame: n });
    if (!i.ok) {
      const c = { not_enough_keys: "NOT_ENOUGH_KEYS", invalid_range: "BAD_RANGE", insufficient_frame_slots: "INSUFFICIENT_FRAME_SLOTS" };
      throw new O(c[i.reason] || "BAD_RANGE", `camera.path.redistribute_timing: ${i.reason}`);
    }
    return Bt(e, a, i.keys), { dirtyMask: qt };
  },
  [B.CAMERA_PATH_APPLY_PRESET](e, t) {
    const a = ze(e, t.cameraId), o = or(a), r = Hs({
      type: t.presetType,
      camera: o,
      target: t.target,
    ...
    if (!r.ok) {
      const n = { unknown_preset: "UNKNOWN_PRESET", invalid_camera: "BAD_VALUE", invalid_range: "BAD_RANGE", insufficient_frame_slots: "INSUFFICIENT_FRAME_SLOTS" };
      throw new O(n[r.reason] || "BAD_VALUE", `camera.path.apply_preset: ${r.reason}`);
    }
    return Bt(e, a, r.keyframes), { dirtyMask: qt };
  }
};
function Xp({ state: e, operation: t }) {
  const a = Yp[t.type];
...
function kr(e, t) {
  ...
  if (Array.isArray(e) || Array.isArray(t))
    return !Array.isArray(e) || !Array.isArray(t) || e.length !== t.length ? !1 : e.every((a, o) => kr(a, t[o]));
  if (e && t && typeof e == "object") {
    const a = /* @__PURE__ */ new Set([...Object.keys(e), ...Object.keys(t)]);
    for (const o of a) if (!kr(e[o], t[o])) return !1;
    return !0;
  }
  return !1;
}
...
function Zp(e, t) {
  ...
  return ef(e, t, r), af(e, t, r), rf(e, t, r), of(e, t, r), nf(e, t, r), sf(e, t, r), { changes: a, truncated: o };
}
const Qp = ["fov", "roll", "zoom", "near", "far", "camera_type"];
function ef(e, t, a) {
  const o = rt(e?.cameras), r = rt(t?.cameras);
...
const tf = ["position", "target", "fov", "roll", "zoom", "near", "far", "camera_type"];
function af(e, t, a) {
  const o = rt(e?.cameras), r = rt(t?.cameras);
  for (const [n, i] of r) {
...
function of(e, t, a) {
  const o = rt(e?.objects), r = rt(t?.objects);
  for (const [n, i] of r) {
...
async function mf(e, t, a) {
  const o = a.some((i) => i.resourceRefresh === !0), r = t.operations.filter((i) => i.type === B.OBJECT_DELETE).map((i) => i.objectId);
  for (const i of r)
    e.removeObjectResources?.(i);
  const n = t.operations.some((i) => i.type === B.ASSET_INSTANTIATE);
...
function ff(e, t) {
  ...
  try {
    ...
    if (f instanceof O) return rr(e, t?.id, f);
    throw f;
  }
  const o = Sr(e);
  ...
  for (let f = 0; f < a.operations.length; f += 1)
    try {
      const d = Xp({ ui: e, state: r, operation: a.operations[f] });
      n |= d?.dirtyMask || 0, d?.warning && i.push(d.warning), d?.outcome && c.push({ index: f, ...d.outcome });
    } catch (d) {
      if (d instanceof O)
        return (d.operationIndex === null || d.operationIndex === void 0) && (d.operationIndex = f), rr(e, a.id, d);
      throw d;
    }
  if (a.validateOnly) {
    const { changes: f, truncated: d } = Zp(e.state, r);
    return {
      ok: !0,
      version: ot,
      revision: o,
  ...
  e.checkpoint?.(a.description), e.state = Nr(r);
  const l = lf(e);
  vp(e, a.id), e.serialize?.(), df(e, l), pf(e, n, `director-api:${a.id}`);
  const p = {
    ok: !0,
    version: ot,
    baseRevision: o,
...
function uf(e) {
  return e.directorApi = hf(e), e.directorApi;
}
const Pn = "omnicam-agent/1", Ln = "majoor.omnicam.agent.request", bf = 1, Ut = Object.freeze({
...
}), gf = 1e4, yf = 5e3, ei = "asset.instantiate_by_id", ti = "asset.catalog_search", Nn = Object.freeze([
  ...Ws.filter((e) => e !== B.ASSET_INSTANTIATE),
  ei
]);
function _r(e) {
...
async function wf(e, t) {
  ...
  const o = (a.state?.items || []).filter((r) => !_r(r)).slice(0, 20).map((r) => ({
    id: r.id,
    name: r.name,
    kind: r.kind,
    tags: [...r.tags || []],
...
function kf(e, t, a) {
  ...
  async function d() {
    ...
    try {
      const C = await Wt(a, Ut.register, {
        protocol: Pn,
        client_id: g,
        node_id: String(t.id),
      ...
      if (o || S !== p) return;
      r = C.session_id, n = C.session_token, i = g, b();
    } catch {
      if (o || S !== p) return;
      h();
    }
  ...
  async function v(S) {
    const g = S?.detail;
    if (o || !g || g.protocol !== Pn || Number(g.schema_version) !== bf || g.session_id !== r || String(g.node_id) !== String(t.id)) return;
    let C;
    try {
      if (g.kind === "query")
        C = g.payload?.type === ti ? await wf(e, g.payload) : e.directorApi.query(g.payload);
      else if (g.kind === "transaction") {
        const M = g.payload, R = (M?.operations || []).find(
          (F) => !Nn.includes(F?.type)
        );
        if (!Number.isInteger(M?.baseRevision) || M.baseRevision < 0)
          C = Vt(
            e,
          ...
          C = Vt(
            ...
            `External Agent transactions cannot use operation: ${R?.type}`
          );
        else {
          const F = await xf(e, M.operations);
          F.ok ? (C = e.directorApi.execute({ ...M, operations: F.operations }), await C?._reconciliation) : C = Vt(e, F.code, F.message);
        }
      } else
        C = Vt(e, "UNKNOWN_AGENT_REQUEST", `Unsupported Agent request kind: ${g.kind}`);
    } catch (M) {
      C = Vt(e, M?.code || "INTERNAL", M?.message || "OmniCam Agent request failed");
    }
    try {
      await Wt(a, Ut.reply, {
        session_id: r,
  ...
  return a.addEventListener?.(Ln, v), a.addEventListener?.("status", x), d(), {
    get sessionId() {
      return r;
    },
    dispose() {
      if (o) return;
      o = !0, clearInterval(c), clearTimeout(l), a.removeEventListener?.(Ln, v), a.removeEventListener?.("status", x);
      const S = r, g = n;
      r = null, n = null, S && g && Wt(a, Ut.close, {
        session_id: S,
        session_token: g
      }).catch(() => {
      });
...
const Re = "/majoor/omnicam/library";
function Sf(e, t) {
...
function Yr({ fetchApi: e = Sf } = {}) {
  const t = (a, o) => Promise.resolve(e(a, o)).then(_f);
  return {
    list(a = {}) {
      const { kind: o, tag: r, search: n, offset: i, limit: c } = a, l = { tag: r, search: n, offset: i, limit: c };
      return o && o !== "all" && (l.kind = o), t(`${Re}${Fn(l)}`);
    },
    get(a) {
      return t(`${Re}/${encodeURIComponent(a)}`);
    },
    register(a) {
      return t(`${Re}/register`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(a)
      });
    ...
    remove(a) {
      return t(`${Re}/${encodeURIComponent(a)}`, { method: "DELETE" });
    },
    importModel(a, o = {}) {
      const r = new FormData();
      return r.append("file", a, o.filename || a.name || "model.glb"), t(`${Re}/import${Fn(o)}`, { method: "POST", body: r });
    },
    importLocalCharacters({ folder: a, licenseNote: o = "", idPrefix: r = "", dryRun: n = !1 } = {}) {
      return t(`${Re}/import-local`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          folder: a,
    ...
    uploadThumbnail(a, o, r = "thumb.webp") {
      ...
      return n.append("file", o, r), t(`${Re}/thumbnail/${encodeURIComponent(a)}`, {
        method: "POST",
        body: n
      });
    },
    ...
    deletePose(a) {
      return t(`${Re}/poses/${encodeURIComponent(a)}`, { method: "DELETE" });
    }
  };
}
const ai = Object.freeze(["all", "character", "prop", "environment", "vehicle"]);
function zn(e = {}) {
  const t = String(e.kind || "all").toLowerCase();
  return {
    kind: ai.includes(t) ? t : "all",
...
function Ef(e) {
  ...
  return {
    ...
    setFilter(i) {
      return a.filter = zn({ ...a.filter, ...i }), a.offset = 0, this.refresh();
    },
    refresh() {
      return n(async () => {
...
const Tf = 256;
function Rn(e = {}) {
  const { THREE: t, GLTFLoader: a, FBXLoader: o, size: r = Tf } = e;
  if (!t || !a)
...
function Pf(e, t = {}) {
  return ai.map((a) => {
    const o = s(Of[a] || a), r = a === "all" ? "" : ` <span class="oc-asset-kind-n">${Number(t[a] || 0)}</span>`;
    return `<button type="button" class="oc-asset-kind${a === (e || "all") ? " active" : ""}" data-asset-kind="${a}">${Et(o)}${r}</button>`;
  }).join("");
}
function Lf(e, { selected: t = !1, thumbUrl: a = "" } = {}) {
  const o = If[e.kind] || "pi-box", r = e.kind === "character" && us(e.rig) === "rigged" ? `<span class="oc-asset-badge">${s("RIGGED")}</span>` : "", n = a ? `<img class="oc-asset-thumb" src="${Et(a)}" alt="" loading="lazy">` : `<span class="oc-asset-thumb oc-asset-thumb--glyph"><i class="pi ${o}"></i></span>`;
  return `<button type="button" class="oc-asset-card${t ? " selected" : ""}" data-asset-id="${Et(e.id)}" title="${Et(e.name)}">
    ${n}
    <span class="oc-asset-name">${Et(e.name)}</span>
    <span class="oc-asset-kind-tag">${Et((e.kind || "").toUpperCase())}</span>
    ${r}
  </button>`;
}
function Nf(e, { selectedId: t = "", thumbUrls: a = {} } = {}) {
...
function Ff(e, t = {}) {
  const a = e.root, o = t.fetchApi || ((L, q) => (e.api || e.app?.api).fetchApi(L, q)), r = t.apiClient || Yr({ fetchApi: o }), n = t.store || Ef(r), i = Cf(), c = t.previewQueue || Af(), l = e.api || e.app?.api || null;
  let p = t.thumbnailRenderer || null, m = null;
  const f = /* @__PURE__ */ new Set();
  function d() {
    return p ? Promise.resolve(p) : (m || (m = Mf().then((L) => p = Rn(L)).catch(() => p = Rn({}))), m);
  }
  function h(L) {
    return sn(l, Gs(L));
  }
  function b(L) {
    return L.thumbnail ? sn(l, `omnicam/library/${L.thumbnail} [input]`) : "";
  }
  function u() {
    for (const L of n.state.items) {
      if (L.kind === "helper" || !L.file || i.get(L.id) || L.thumbnail || f.has(L.id)) continue;
      const q = h(L);
      q && c.enqueue(L.id, async () => {
        const Ee = await (await d()).render(q, L.format || "glb");
        if (!Ee) {
          f.add(L.id);
          return;
        }
        if (i.set(L.id, Ee), W(), !(L.source && L.source !== "user"))
          try {
            const Le = await r.uploadThumbnail(L.id, $f(Ee));
            Le?.asset && n.upsert(Le.asset);
          } catch {
          }
      });
    }
  }
  const v = (L) => a.querySelector(`[data-role="${L}"]`), y = v("assets-panel"), x = v("asset-grid"), S = v("asset-kinds"), g = v("asset-search"), C = v("asset-status"), M = v("asset-import-file"), R = v("scene-tab"), F = v("assets-tab"), Y = v("agent-tab"), H = a.querySelector('[data-asset-view="agent"]'), X = { assets: F, agent: Y };
  let oe = "", k = null, E = !0, z = !0, U = "scene", V = 0;
  function $(L, { sticky: q = !1 } = {}) {
    C && (!q && V > Date.now() || (C.textContent = L || "", V = q ? Date.now() + 9e3 : 0));
  }
  function G(L) {
    if (oe = L, !!x)
      for (const q of x.querySelectorAll(".oc-asset-card"))
        q.classList.toggle("selected", q.dataset.assetId === L);
  }
  let j = !1;
  function W() {
    if (S && (S.innerHTML = Pf(n.state.filter.kind, n.state.kinds)), x) {
      const L = {};
      for (const q of n.state.items) {
        const me = i.get(q.id) || b(q);
        me && (L[q.id] = me);
      }
      x.innerHTML = Nf(n.state.items, { selectedId: oe, thumbUrls: L });
    }
    if (!j) {
      j = !0;
      try {
    ...
    n.state.error ? $(n.state.error.message) : n.state.loading ? $(s("Loading assets...")) : $(s("{n} of {total} assets").replace("{n}", n.state.items.length).replace("{total}", n.state.total));
  }
  function J(L) {
    if (!L) return;
    const q = Op({
      ...
      operations: [{ type: "asset.instantiate", asset: L, point: q }]
    });
    if (!me?.ok) {
      e.setStatus?.(me?.error?.message || s("Could not add the asset"));
      return;
    }
    const Ee = me.outcomes?.[0]?.objectId;
    Ee && (e.selectedEntity = "object", e.selectedObjectId = Ee, e.selectedObjectIds = /* @__PURE__ */ new Set([Ee]), e.selectedKeyFrame = null), e.restoreAssets?.(), e.refreshObjects?.(), e.refreshInspector?.(), e.render?.(), e.setStatus?.(s("{name} added").replace("{name}", L.name));
  }
  async function se(L) {
    if (L) {
      $(s("Importing {name}...").replace("{name}", L.name));
      try {
        const q = await r.importModel(L, { kind: "prop", name: L.name.replace(/\.[^.]+$/, "") });
        q.asset && n.upsert(q.asset), $(s("Imported {name}").replace("{name}", q.asset?.name || L.name));
      } catch (q) {
        $(q.message || s("Import failed"));
      }
    }
  }
  const ie = v("asset-local-form"), re = v("asset-local-folder"), de = v("asset-local-note");
  function ye() {
    ie && (ie.hidden = !ie.hidden, ie.hidden || re?.focus());
  }
  async function he(L) {
    const q = (re?.value || "").trim();
    if (!q) {
      $(s("Point to the folder you extracted the pack into."), { sticky: !0 });
      return;
    }
    V = 0, $(L ? s("Scanning {folder}...").replace("{folder}", q) : s("Installing characters from {folder}...").replace("{folder}", q));
    try {
      const me = await r.importLocalCharacters({
        folder: q,
        licenseNote: (de?.value || "").trim(),
        dryRun: L
      }), Ee = (me.skipped || []).length;
      if (L) {
        const Ne = (me.candidates || []).map((it) => it.name).join(", ");
        $(
          (me.candidates || []).length ? s("{n} rig-complete character(s): {names}").replace("{n}", me.candidates.length).replace("{names}", Ne) : s("No rig-complete .glb/.fbx character found ({n} skipped)").replace("{n}", Ee),
          { sticky: !0 }
        );
        return;
      }
      const Le = (me.installed || []).filter((Ne) => Ne.status !== "conflict").length, qe = (me.installed || []).filter((Ne) => Ne.status === "conflict").length;
      $(
        s("{n} character(s) installed{extra} — no restart needed").replace("{n}", Le).replace("{extra}", Ee || qe ? ` (${Ee} ${s("skipped")}${qe ? `, ${qe} ${s("unchanged")}` : ""})` : ""),
        { sticky: !0 }
      ), Le && (n.refresh(), ie && (ie.hidden = !0));
    } catch (me) {
      $(me.message || s("Import failed"), { sticky: !0 });
    }
  }
  function ve(L) {
    L === "agent" && !mr() && (L = "scene"), U = L, R && (R.hidden = L !== "scene");
    for (const [q, me] of Object.entries(X))
      me && (me.hidden = q !== L);
    for (const q of a.querySelectorAll("[data-asset-view]"))
      q.classList.toggle("active", q.dataset.assetView === L);
    L === "assets" && E && (E = !1, n.refresh()), L === "agent" && z && (z = !1, t.onAgentFirstOpen?.());
  }
  function xe() {
    const L = mr();
    H && (H.hidden = !L), !L && U === "agent" && ve("scene");
  }
  function pe(L) {
    const q = Dn(L.target);
    if (q) {
      if (q.action === "switch-view") return ve(q.view);
      if (q.action === "filter-kind") return void n.setFilter({ kind: q.kind });
      if (q.action === "asset-add")
        return J(n.get(oe));
      if (q.action === "asset-import")
        return M?.click();
      if (q.action === "local-toggle") return ye();
      if (q.action === "local-scan") return void he(!0);
      if (q.action === "local-install") return void he(!1);
      q.action === "card" && G(q.assetId);
    }
  }
  function Ie(L) {
    const q = Dn(L.target);
    q?.action === "card" && J(n.get(q.assetId));
  }
  function we() {
    clearTimeout(k), k = setTimeout(() => n.setFilter({ search: g.value }), 200);
  }
  function ke(L) {
    const q = L.target.files?.[0];
    L.target.value = "", se(q);
  }
  const be = n.subscribe(W);
  return y?.addEventListener("click", pe), y?.addEventListener("dblclick", Ie), a.querySelector('[data-role="left-tabs"]')?.addEventListener("click", pe), g?.addEventListener("input", we), M?.addEventListener("change", ke), W(), xe(), {
    store: n,
    switchView: ve,
    syncAgentAvailability: xe,
    refresh: () => n.refresh(),
    dispose() {
      be(), clearTimeout(k), y?.removeEventListener("click", pe), y?.removeEventListener("dblclick", Ie), a.querySelector('[data-role="left-tabs"]')?.removeEventListener("click", pe), g?.removeEventListener("input", we), M?.removeEventListener("change", ke), c.clear(), p?.dispose?.(), i.clear();
    }
  };
}
function zf(e, t = {}) {
  ...
  const r = [];
  let n = pr(e.state?.metadata?.viewport_labels);
  function i(m) {
    if (!r[m]) {
  ...
  function l() {
    ...
    let u = 0;
    for (const v of b) {
      if (!bs(v, { mode: n.mode, selectedIds: d })) continue;
      const y = gs(v, n.content);
      if (!y) continue;
      const x = ys(b, v, h) || {
        position: v.position,
        size: v.size
      }, S = e.webgl.projectWorldToScreen(vs(x, v.type));
      if (!S || S.behind) continue;
      const g = i(u);
      u += 1, g.hidden = !1, g.textContent = y, g.style.transform = `translate(-50%, -100%) translate(${Math.round(S.x)}px, ${Math.round(S.y)}px)`;
      const C = n.content === "annotation" ? v.annotation?.color : "";
      g.style.setProperty("--oc-label-accent", C || ""), g.classList.toggle("is-annotation", n.content === "annotation" && !!C);
    }
    for (let v = u; v < r.length; v += 1) r[v].hidden = !0;
  }
  function p(m) {
    n = pr({ ...n, ...m }), e.state.metadata = { ...e.state.metadata || {}, viewport_labels: { ...n } }, e.serialize?.(), l();
  }
  return l(), {
    update: l,
    get settings() {
...
function Rf(e) {
  ...
  return {
    ...
    getRigInfo(a) {
      const o = e.state?.objects?.find((i) => i.id === a) || null, r = t(a), n = fr(r);
      return {
        objectId: a,
...
function Df(e, t) {
  const a = (o) => [`<option value="">${s("— unmapped —")}</option>`].concat(
    e.map(
      (r) => `<option value="${Kn(r)}"${r === o ? " selected" : ""}>${Kn(r)}</option>`
    )
  ).join("");
  return xs.map((o) => {
...
function Kf(e, t = {}) {
  const a = e.root, o = t.apiClient || Yr({
  ...
  function u(y) {
    ...
    x === "auto" ? (l = fr(m()), d()) : x === "validate" ? (d(), e.setStatus?.(Qo(l) ? s("Rig is complete") : s("Rig still missing: {list}").replace("{list}", cn(l).join(", ")))) : x === "save" && v();
  }
  async function v() {
    const y = p();
    if (!y?.asset_id) {
    ...
    try {
      const x = await o.patch(y.asset_id, {
        rig: { profile: ln, bone_map: l }
      });
      y.character = {
        ...y.character || {},
        rig_profile: Qo(l) ? ln : null
  ...
  return n?.addEventListener("change", b), r.addEventListener("click", u), h(), {
    sync: h,
    get boneMap() {
      return { ...l };
    },
...
function Bf(e, t = {}) {
  ...
  function i() {
    ...
    for (const h of xs) {
      const b = p?.[h];
      if (!b) continue;
      const u = f?.getJointWorldTransform?.(l, h, p) || e.webgl.resolveModelBone?.(l, b);
      if (!u?.world) continue;
      const v = e.webgl.projectWorldToScreen(u.world);
...
function Uf(e, t = {}) {
  ...
  const n = r.querySelector('[data-role="pose-preset"]'), i = r.querySelector('[data-pose-act="edit"]'), c = r.querySelector('[data-role="pose-joint-row"]'), l = r.querySelector('[data-role="pose-joint-name"]'), p = ["x", "y", "z"].map((k) => r.querySelector(`[data-role="pose-rot-${k}"]`));
  let m = null, f = !1, d = /* @__PURE__ */ new Map();
  const h = () => e.state?.objects?.find((k) => k.id === m) || null, b = () => e.rigMapper?.boneMap && Object.keys(e.rigMapper.boneMap).length ? e.rigMapper.boneMap : null, u = () => e.subSelection?.type === "character_joint" && e.subSelection.objectId === m ? e.subSelection.jointId : null;
  function v(k) {
    const E = Io({ ...k, preset_id: k.id });
    return { id: k.id, name: k.name || k.id, root_offset: E.root_offset, joints: E.joints };
  }
  function y(k) {
    const E = d.get(k?.pose?.preset_id) || null;
    return Vi({ preset: E, overrides: k?.pose }).joints;
  }
  function x() {
    const k = h();
    !k?.character || !b() || e.webgl?.applyCharacterPose?.(m, b(), f || k.character.pose?.joints ? y(k.character) : {});
  }
  function S() {
    const k = u(), E = f && !!k;
    if (c && (c.hidden = !E), !E) return;
    l && (l.textContent = k);
    const z = h(), U = y(z?.character)[k] || [0, 0, 0, 1], V = Hi(U);
    p.forEach(($, G) => {
      $ && document.activeElement !== $ && ($.value = String(Math.round(V[G] * 100) / 100));
    });
  }
  function g() {
    const k = h(), E = !!k?.character?.motion;
    if (i && (i.classList.toggle("active", f), i.disabled = E, i.title = E ? s("Clear the motion clip to edit the pose") : s("Toggle FK pose editing")), n) {
      const z = [["neutral", s("Standing Neutral")]].concat([...d.values()].filter((V) => V.id !== "neutral").map((V) => [V.id, V.name || V.id])), U = z.map((V) => V.join(":")).join("|");
      n.dataset.sig !== U && (n.dataset.sig = U, n.replaceChildren(...z.map(([V, $]) => {
        const G = document.createElement("option");
        return G.value = V, G.textContent = $, G;
      }))), document.activeElement !== n && (n.value = k?.character?.pose?.preset_id || "neutral");
    }
    S(), x();
  }
  async function C() {
    try {
      ...
      d = new Map((k.poses || []).filter((E) => E?.id).map((E) => [E.id, v(E)]));
    } catch {
      d = /* @__PURE__ */ new Map();
    }
  ...
  function M() {
    const k = u();
    if (!k) return;
    const E = p.map((V) => Number(V?.value) || 0), z = Wi(E), U = e.directorApi?.execute({
      version: 1,
      id: `tx_pose_${Date.now().toString(36)}`,
      description: "Pose joint",
      operations: [{ type: "character.set_joint_rotation", objectId: m, joint: k, rotation: z }]
    });
    U && !U.ok && e.setStatus?.(U.error?.message || s("Could not set the joint")), g();
  }
  function R() {
    const k = n?.value || "neutral", E = d.get(k) || Io({ preset_id: k });
    e.directorApi?.execute({
      version: 1,
      id: `tx_preset_${Date.now().toString(36)}`,
      description: "Pose preset",
      operations: [{ type: "character.set_pose", objectId: m, pose: { preset_id: k, root_offset: E.root_offset, joints: {} } }]
    }), g();
  }
  async function F() {
    const k = h();
    if (!k?.character) return;
    const E = (await Zt(e, s("Save Pose"), s("Pose name"), ""))?.trim();
    if (!E || e.disposed) return;
    const z = E.toLowerCase().replace(qf, "-").replace(/^-+|-+$/g, "").slice(0, 60) || "pose";
    try {
      const U = await o.savePose({
        id: z,
        name: E,
      ...
      d.set(U.pose.id, v(U.pose)), e.setStatus?.(s("Pose saved: {name}").replace("{name}", E)), g();
    } catch (U) {
      e.setStatus?.(U.message || s("Could not save the pose"));
    }
  }
  function Y() {
    const k = h();
    !k?.character || k.character.motion || (f = !f, !f && e.subSelection?.type === "character_joint" && (e.subSelection = null), g(), e.rigOverlay?.update?.());
  }
  function H(k) {
    f && (e.subSelection = { type: "character_joint", objectId: m, jointId: k }, g(), e.rigOverlay?.update?.());
  }
  const X = Bf(e, {
    onPick: H,
    isActive: () => f && m && b() ? { objectId: m, boneMap: b(), selectedJoint: u() } : null
  });
  e.rigOverlay = X;
  function oe() {
    const k = e.selectedObject?.(), E = k?.asset_kind === "character";
    if (r.hidden = !E, !E) {
      f && (f = !1), m = null, X.update();
      return;
    }
    k.id !== m && (m = k.id, f = !1, e.subSelection?.type === "character_joint" && (e.subSelection = null), d.size || C()), g(), X.update();
  }
  n?.addEventListener("change", R), i?.addEventListener("click", Y), r.querySelector('[data-pose-act="save"]')?.addEventListener("click", F);
  for (const k of p)
    k?.addEventListener("change", M), k?.addEventListener("input", M);
  return C(), {
    sync: oe,
    update() {
      X.update(), x();
    ...
    dispose() {
      X.dispose(), n?.removeEventListener("change", R), i?.removeEventListener("click", Y);
      for (const k of p)
        k?.removeEventListener("change", M), k?.removeEventListener("input", M);
    }
  };
}
function Bn(e, t) {
...
function Wf(e) {
  ...
  function b() {
    ...
    if (o) {
      const C = x.join("|");
      o.dataset.sig !== C && (o.dataset.sig = C, o.replaceChildren(
        Bn("", x.length ? s("No motion (static)") : s("No clips in this model")),
        ...x.map((M) => Bn(M, M))
      )), document.activeElement !== o && (o.value = S?.clip_id || ""), o.disabled = !x.length;
    }
    nr(r, S?.start_frame ?? 0), nr(n, S?.end_frame ?? 0), nr(i, S?.speed ?? 1), c && document.activeElement !== c && (c.checked = S ? S.loop !== !1 : !0);
    const g = !!S;
    for (const C of [r, n, i, c]) C && (C.disabled = !g);
    l && (l.disabled = !g);
  }
  function u() {
...
function oi(e) {
  return {
    ...
    frames: We(e, "frame"),
    scrubs: We(e, "scrub"),
    cameraFov: We(e, "camera-fov"),
    cameraRoll: We(e, "camera-roll"),
    cameraFocal: We(e, "camera-focal"),
    viewportZoom: We(e, "viewport-zoom"),
    cameraType: We(e, "camera-type"),
    cameraNear: We(e, "camera-near"),
    cameraFar: We(e, "camera-far")
  };
}
const Vf = /* @__PURE__ */ new Set(["translate", "rotate", "scale"]), Hf = /* @__PURE__ */ new Set(["world", "local"]), Ve = 180 / Math.PI;
function qn(e) {
  return [e.x, e.y, e.z];
}
function Gf(e) {
  return [e.x * Ve, e.y * Ve, e.z * Ve];
}
function Yf({
  THREE: e,
  camera: t,
  ...
  const m = p ? p() : new e.Object3D(), f = l ? l(t, a) : new gd(t, a);
  let d = null;
  o?.add && (d = typeof f.getHelper == "function" ? f.getHelper() : f, o.add(d), o.add(m));
  let h = null, b = null, u = !1, v = null, y = [0, 0, 0];
  function x() {
    return {
      position: qn(m.position),
      rotationDeg: Gf(m.rotation),
      scale: qn(m.scale)
    };
  }
  function S(j) {
    m.position.set(...j.position), m.rotation.set(
      j.rotationDeg[0] / Ve,
      j.rotationDeg[1] / Ve,
      j.rotationDeg[2] / Ve
    ), m.scale.set(...j.scale);
  ...
  function g(j) {
    return ((j + 180) % 360 + 360) % 360 - 180;
  }
  function C(j) {
    if (!b) return { position: [0, 0, 0], rotationDeg: [0, 0, 0], scaleFactors: [1, 1, 1] };
    const W = j.rotationDeg.map((J, se) => {
      const ie = v ? v[se] : b.rotationDeg[se];
      return y[se] += g(J - ie), y[se];
    });
    return v = j.rotationDeg, {
      position: j.position.map((J, se) => J - b.position[se]),
      rotationDeg: W,
      scaleFactors: j.scale.map((J, se) => b.scale[se] === 0 ? 1 : J / b.scale[se])
    };
  }
  function M() {
    b = x(), v = null, y = [0, 0, 0], r?.({ targetSpec: h });
  }
  function R() {
    if (!b) return;
    const j = x();
  ...
  f.addEventListener?.("mouseDown", M), f.addEventListener?.("objectChange", R), f.addEventListener?.("mouseUp", F), f.addEventListener?.("dragging-changed", Y);
  function H(j) {
    h = j, m.position.set(...j.position || [0, 0, 0]);
    const W = j.rotation || [0, 0, 0];
    m.rotation.set(W[0] / Ve, W[1] / Ve, W[2] / Ve), m.scale.set(...j.scale || [1, 1, 1]), f.attach(m), f.visible = !0;
  }
  function X() {
    h = null, b = null, f.detach(), f.visible = !1;
  }
  function oe(j) {
    "camera" in f && (f.camera = j);
  }
  function k(j) {
    if (!Vf.has(j)) throw new Error(`createTransformControlsAdapter: unknown mode "${j}"`);
    f.setMode ? f.setMode(j) : f.mode = j;
  }
  function E(j) {
    if (!Hf.has(j)) throw new Error(`createTransformControlsAdapter: unknown space "${j}"`);
    f.space = j;
  }
  function z(j) {
    f.setTranslationSnap ? f.setTranslationSnap(j) : f.translationSnap = j;
  }
  function U(j) {
    f.setRotationSnap ? f.setRotationSnap(j) : f.rotationSnap = j;
  }
  function V(j) {
    f.setScaleSnap ? f.setScaleSnap(j) : f.scaleSnap = j;
  }
  function $() {
    if (!b) return;
    const j = b;
    b = null, v = null, y = [0, 0, 0], S(j), n?.({
      targetSpec: h,
      position: j.position,
      rotationDeg: j.rotationDeg,
      scale: j.scale,
  ...
  function G() {
    f.removeEventListener?.("mouseDown", M), f.removeEventListener?.("objectChange", R), f.removeEventListener?.("mouseUp", F), f.removeEventListener?.("dragging-changed", Y), o?.remove && d && o.remove(d), o?.remove && o.remove(m), f.dispose?.(), h = null, b = null;
  }
  return {
    attach: H,
    detach: X,
...
function Jf(e, { controlsFactory: t, anchorFactory: a } = {}) {
  let o = null, r = null, n = !1, i = null, c = !1;
  function l(k) {
    if (!o) return;
  ...
  function m() {
    n || typeof window > "u" || (n = !0, window.addEventListener("keydown", p, !0), window.addEventListener("keyup", p, !0));
  }
  function f() {
    n && (n = !1, window.removeEventListener("keydown", p, !0), window.removeEventListener("keyup", p, !0));
  }
  function d() {
    return o || (!e.webgl || !e.interactionElement ? null : (o = Yf({
      THREE: bd,
  ...
  function h({ targetSpec: k }) {
    if (k) {
      if (l(c), k.type === "object") {
        ...
        const E = Yi(e), z = (E.length ? E : [k.object]).map((V) => ({
          object: V,
          transform: Xe(V)
        }));
        for (const V of z) e.beginObjectEdit(V.object);
        const U = z.reduce((V, $) => fe(V, $.transform.position), [0, 0, 0]).map((V) => V / z.length);
        r = { type: "object", group: z, pivot: U };
        return;
      }
      if (k.type === "camera") {
      ...
      if (k.type === "path_point" || k.type === "path_group") {
        ...
        e.checkpoint(k.type === "path_point" ? "Transform path point" : "Transform path selection"), r = {
          type: k.type,
          trackId: E.id,
          origin: k.position,
          selectedFrames: new Set(z),
          baseKeys: E.keyframes.map((U) => ({ ...U, camera: le(U.camera) })),
          lookAtActive: Pr(E, e.state.objects)
        };
        return;
      }
  ...
  function b(k) {
    ...
    return E === "translate" ? { mode: E, delta: k.position } : E === "scale" ? { mode: E, origin: r.origin, factors: k.scaleFactors } : { mode: E, origin: r.origin, rotationDeg: k.rotationDeg };
  }
  function u(k) {
    k.id === e.state.active_camera_id && (e.state.keyframes = k.keyframes), e.camera = $e(k, e.frame, e.state.objects), k.camera = le(e.camera), e.refreshKeys();
  }
  function v(k) {
    const E = e.state.cameras.find((z) => z.id === r.trackId);
    E && (E.keyframes = ws(r.baseKeys, b(k)), u(E));
  }
  function y(k) {
    const E = e.state.cameras.find((U) => U.id === r.trackId);
    if (!E) return;
    const z = { ...b(k), lookAtActive: r.lookAtActive };
    E.keyframes = fs(r.baseKeys, r.selectedFrames, z), u(E);
  }
  function x(k) {
    const E = e.state.cameras.find((z) => z.id === r.trackId);
    E && (E.keyframes = Ji(r.baseKeys, [r.frame], { delta: k.position }), u(E));
  }
  function S({ delta: k }) {
    r && (r.type === "object" ? g(k) : r.type === "camera" ? C(k) : r.type === "camera_target" ? M(k) : r.type === "camera_path" ? v(k) : r.type === "path_point" || r.type === "path_group" ? y(k) : r.type === "path_point_target" && x(k), e.render());
  }
  function g(k) {
    const { group: E, pivot: z } = r, U = e.state.gizmo_mode;
    for (const V of E)
      if (U === "translate")
        V.object.position = fe(V.transform.position, k.position);
      else if (U === "rotate")
        V.object.position = fe(z, dn(De(V.transform.position, z), k.rotationDeg)), V.object.rotation = fe(V.transform.rotation, k.rotationDeg);
      else if (U === "scale") {
        const $ = De(V.transform.position, z);
        V.object.position = fe(z, $.map((G, j) => G * k.scaleFactors[j])), V.object.size = V.transform.size.map((G, j) => Math.max(0.01, G * k.scaleFactors[j]));
      }
    for (const V of E) e.commitObjectEdit(V.object);
  }
  function C(k) {
    if (e.state.gizmo_mode === "translate")
      e.camera.position = fe(r.position, k.position);
    else {
      const E = De(r.target, r.position);
      e.camera.target = fe(r.position, dn(E, k.rotationDeg));
    }
    e.commitCameraEdit();
  }
  function M(k) {
    const E = fe(r.base, k.position);
    r.tracking ? Xi(e, E) : e.camera.target = E, e.commitCameraEdit();
  }
  function R({ cancelled: k }) {
    if (!r) return;
    const E = r.type;
    k ? (e.undo(), (E === "camera" || E === "camera_target") && e.finishCameraEdit()) : E === "camera" || E === "camera_target" ? e.finishCameraEdit() : (e.editingKeyFrame = null, e.updateKeyVisualState?.(), e.drawCurveEditor?.()), r = null, e.refreshInspector(), e.render();
  }
  function F() {
    if (!e.webgl || !e.interactionElement) return;
    const k = e.recording ? null : Gi(e), E = e.state.gizmo_mode || "translate", z = !!k && !k.readOnly && Xf.has(k.type) && k.allowedModes.includes(E);
  ...
  function oe() {
    f(), o?.dispose(), o = null, r = null, i = null;
  }
  return { sync: F, isPointerOverHandle: Y, cancelDrag: H, currentLiveType: X, dispose: oe };
}
function Zf(e, t) {
  e.checkpoint(`Apply preset: ${t}`);
  const a = e.activeCameraTrack(), o = xd(t, {
...
function Qf(e, t) {
  ...
  const o = vd(a, { type: t, intensity: 1, duration_frames: e.state.duration_frames });
...
const Un = ["#4aa3ef", "#f2a93b", "#48c774", "#b565d8", "#ec4899"], tt = [4, 8, 12, 20, 35, 60, 100];
function Mt(e) {
...
function Ho(e, t, a) {
  ...
  const o = Mt(e), r = o.expanded ? 220 : 138, n = Math.min(r, Math.max(80, Math.min(t, a) - 20)), i = 10, c = Math.max(0, t - n - i), l = Math.max(0, a - n - i), p = e.viewportCamera(), m = p?.position || [0, 1.5, 5], f = p?.target || [0, 0, 0], d = e.activeCameraTrack?.(), h = e.state.cameras?.length ? e.state.cameras : d ? [d] : [], b = h.flatMap(
    (C) => (C.keyframes || []).map((M) => M.camera?.position).filter(Boolean)
  );
  let u = 12;
  if (o.rangeIndex >= 0 && o.rangeIndex < tt.length)
    u = tt[o.rangeIndex];
  else {
    const C = Math.max(
      Math.abs(m[0] || 0),
      ...
      Math.abs(f[0] || 0),
      Math.abs(f[2] || 0),
      ...b.flatMap((M) => [Math.abs(M[0] || 0), Math.abs(M[2] || 0)]),
      4
    );
    u = Math.max(6, Math.ceil((C + 1.5) / 4) * 4);
  }
  const v = c + n / 2, y = l + n / 2, x = n / 2 - 12, S = x / u, g = o.centerMode === "camera" ? [m[0] || 0, m[2] || 0] : [0, 0];
  return {
    rx: c,
    ry: l,
    radarSize: n,
...
function rh(e, t, a, o) {
  const r = Ho(e, a, o);
  if (!r) return;
  const { rx: n, ry: i, radarSize: c, cx: l, cy: p, innerRadius: m, range: f, scale: d, camPos: h, camTgt: b, cameras: u, activeTrack: v } = r, y = Mt(e), x = e.state.active_camera_id || v?.id, S = (re, de) => ri(r, re, de);
  ...
  for (const re of e.state.objects || []) {
    ...
    const de = Fr(e.state.objects, re).position || [0, 0, 0], [ye, he] = S(de[0], de[2]);
    if (ye < n + 3 || ye > n + c - 3 || he < i + 3 || he > i + c - 3) continue;
    const ve = e.selectedObjectId === re.id || e.selectedObjectIds?.has?.(re.id);
    if (t.save(), t.translate(ye, he), re.type === "card") {
      const xe = (re.rotation?.[1] || 0) * Math.PI / 180;
      t.rotate(-xe), t.fillStyle = ve ? "#a855f7" : "#38bdf8", t.fillRect(-4, -1.2, 8, 2.4), t.strokeStyle = ve ? "#ffffff" : "rgba(255,255,255,0.6)", t.lineWidth = 1, t.strokeRect(-4, -1.2, 8, 2.4);
      ...
      for (let xe = 0; xe < 4; xe++) {
        const pe = xe * Math.PI / 2;
        t.beginPath(), t.moveTo(Math.cos(pe) * 4, Math.sin(pe) * 4), t.lineTo(Math.cos(pe) * 6, Math.sin(pe) * 6), t.stroke();
      }
    } else
      t.fillStyle = ve ? "#a855f7" : re.type === "human" ? "#ec4899" : "#f59e0b", t.beginPath(), t.arc(0, 0, 2.8, 0, Math.PI * 2), t.fill();
  ...
  for (let re = 0; re < u.length; re++) {
    const de = u[re], ye = de.keyframes || [], he = de.id === x, ve = de.color || Un[re % Un.length];
    t.save(), t.strokeStyle = ve, t.globalAlpha = he ? 0.95 : 0.4, t.lineWidth = he ? 2 : 1, t.setLineDash(he ? [] : [2, 2]), t.beginPath();
    let xe = !1;
    const pe = ye[0]?.frame, Ie = ye[ye.length - 1]?.frame;
    for (let we = pe; Number.isFinite(we) && we <= Ie; we++) {
      const ke = $e(de, we, e.state.objects)?.position;
      if (!Array.isArray(ke)) continue;
      const [be, L] = S(ke[0], ke[2]);
      xe ? t.lineTo(be, L) : (t.moveTo(be, L), xe = !0);
    }
    xe && t.stroke(), t.restore(), t.save();
    for (const we of ye) {
      const ke = we.camera?.position;
      if (!ke) continue;
      const [be, L] = S(ke[0], ke[2]);
      if (be < n + 4 || be > n + c - 4 || L < i + 4 || L > i + c - 4) continue;
      const q = we.frame === e.frame && he;
      t.fillStyle = q ? "#ffffff" : ve, t.globalAlpha = he ? 0.95 : 0.6, t.beginPath(), t.moveTo(be, L - 3), t.lineTo(be + 3, L), t.lineTo(be, L + 3), t.lineTo(be - 3, L), t.closePath(), t.fill(), q && (t.strokeStyle = "#00d2d3", t.lineWidth = 1.2, t.stroke());
    }
    t.restore();
  }
  const [M, R] = S(h[0] || 0, h[2] || 0), [F, Y] = S(b[0] || 0, b[2] || 0), H = 8, X = te(M, n + H, n + c - H), oe = te(R, i + H, i + c - H), k = te(F, n + H, n + c - H), E = te(Y, i + H, i + c - H), z = h[1] || 0, U = ah(z), V = oh(z);
  t.strokeStyle = "rgba(255, 255, 255, 0.40)", t.lineWidth = 1, t.setLineDash([3, 3]), t.beginPath(), t.moveTo(X, oe), t.lineTo(k, E), t.stroke(), t.setLineDash([]), t.fillStyle = "#ffffff", t.beginPath(), t.arc(k, E, 2.5, 0, Math.PI * 2), t.fill(), t.strokeStyle = "rgba(255, 255, 255, 0.7)", t.lineWidth = 1, t.beginPath(), t.arc(k, E, 4.5, 0, Math.PI * 2), t.stroke();
  const $ = b[0] - h[0], G = b[2] - h[2], j = Math.atan2(G, $), J = (e.viewportCamera().fov || 35) * Math.PI / 360, se = te(24 * (d / (m / 8)), 16, 38), ie = t.createRadialGradient(X, oe, 2, X, oe, se);
  ie.addColorStop(0, U + "55"), ie.addColorStop(1, U + "08"), t.fillStyle = ie, t.strokeStyle = U, t.lineWidth = 1.2, t.beginPath(), t.moveTo(X, oe), t.lineTo(X + Math.cos(j - J) * se, oe + Math.sin(j - J) * se), t.arc(X, oe, se, j - J, j + J), t.closePath(), t.fill(), t.stroke(), t.fillStyle = U + "44", t.beginPath(), t.arc(X, oe, 6.5, 0, Math.PI * 2), t.fill(), t.fillStyle = U, t.beginPath(), t.arc(X, oe, 3.5, 0, Math.PI * 2), t.fill(), t.strokeStyle = "#ffffff", t.lineWidth = 1.5, t.beginPath(), t.moveTo(X, oe), t.lineTo(X + Math.cos(j) * 7, oe + Math.sin(j) * 7), t.stroke(), nh(e, t, r, U, V, j, Math.hypot($, G)), y.hover && sh(t, r, y.hover), t.restore();
}
function nh(e, t, a, o, r, n, i) {
  const { rx: c, ry: l, radarSize: p } = a, m = Mt(e);
  ...
  const f = l + 3, d = 12;
  ko(t, c + 44, f, 12, d, "−", m.hover?.button === "zoom_out"), ko(t, c + 58, f, 12, d, "+", m.hover?.button === "zoom_in");
  const h = m.centerMode === "camera" ? "CAM" : "CTR";
  ko(t, c + 72, f, 22, d, h, m.hover?.button === "center");
  const b = m.expanded ? "⤡" : "⤢";
  ko(t, c + 96, f, 14, d, b, m.hover?.button === "size"), t.font = "bold 8.5px monospace", t.fillStyle = o, t.textAlign = "right", t.fillText(`Y:${r}`, c + p - 5, l + 9), t.fillStyle = "rgba(15, 23, 42, 0.70)", t.fillRect(c, l + p - 15, p, 15), t.strokeStyle = "rgba(0, 210, 211, 0.15)", t.beginPath(), t.moveTo(c, l + p - 15), t.lineTo(c + p, l + p - 15), t.stroke();
...
function sh(e, t, a) {
  ...
  const i = e.measureText(a.text).width + 12, c = 16, l = te(a.px - i / 2, o + 4, o + n - i - 4), p = a.pz > t.cy ? a.pz - 22 : a.pz + 8;
...
function si(e, t, a, o) {
  const { camPos: r, camTgt: n, cameras: i, rx: c, ry: l, radarSize: p } = t, m = (v, y) => ri(t, v, y), [f, d] = m(r[0] || 0, r[2] || 0);
  ...
  for (const v of e.state.objects || []) {
    ...
    const y = Fr(e.state.objects, v).position || [0, 0, 0], [x, S] = m(y[0], y[2]);
...
function ih(e, t, a, o) {
  ...
  const r = Ho(e, e.canvas.width, e.canvas.height);
  if (!r) return !1;
  const { rx: n, ry: i, radarSize: c } = r;
  if (a < n || a > n + c || o < i || o > i + c)
    return !1;
  t.preventDefault?.(), t.stopPropagation?.();
  const l = Mt(e), p = ni(r, a, o);
  if (p)
    return p === "zoom_in" ? (l.rangeIndex === -1 && (l.rangeIndex = tt.findIndex((h) => h >= r.range), l.rangeIndex < 0 && (l.rangeIndex = tt.length - 1)), l.rangeIndex = Math.max(0, (l.rangeIndex === -1 ? 2 : l.rangeIndex) - 1)) : p === "zoom_out" ? (l.rangeIndex === -1 && (l.rangeIndex = tt.findIndex((h) => h >= r.range), l.rangeIndex < 0 && (l.rangeIndex = 0)), l.rangeIndex = Math.min(tt.length - 1, l.rangeIndex + 1)) : p === "center" ? l.centerMode = l.centerMode === "camera" ? "origin" : "camera" : p === "size" && (l.expanded = !l.expanded), e.render?.(), !0;
  const m = si(e, r, a, o);
  if (m) {
    if (m.type === "camera")
...
function ch(e, t, a, o) {
  ...
  const r = Ho(e, e.canvas.width, e.canvas.height);
  if (!r) return !1;
  const n = Mt(e), { rx: i, ry: c, radarSize: l } = r, p = a >= i && a <= i + l && o >= c && o <= c + l;
  if (n.drag) {
    const [u, v] = jr(r, a, o), y = e.viewportCamera();
    return n.drag.type === "camera" ? y.position = [u, y.position?.[1] || 1.5, v] : n.drag.type === "target" && (y.target = [u, y.target?.[1] || 0, v]), e.setFrame?.(e.frame, !1, !1), e.render?.(), !0;
  }
  if (!p)
    return n.hover && (n.hover = null, e.render?.()), !1;
  const m = ni(r, a, o), f = si(e, r, a, o), [d, h] = jr(r, a, o);
...
function lh(e, t, a, o) {
  ...
  if (a < n || a > n + c || o < i || o > i + c)
    return !1;
  t.preventDefault?.(), t.stopPropagation?.();
  const l = Mt(e), p = Math.sign(t.deltaY || 0);
  return l.rangeIndex === -1 && (l.rangeIndex = tt.findIndex((m) => m >= r.range), l.rangeIndex < 0 && (l.rangeIndex = 2)), p > 0 ? l.rangeIndex = Math.min(tt.length - 1, l.rangeIndex + 1) : p < 0 && (l.rangeIndex = Math.max(0, l.rangeIndex - 1)), e.render?.(), !0;
}
function dh(e, t, a) {
  ...
  const o = () => {
    ...
    const h = Qi(t('[data-role="object-tags"]')?.value || "");
    h.length ? d.tags = h : delete d.tags;
    const b = String(t('[data-role="object-annotation"]')?.value || "").trim(), u = b ? hs({
      text: b,
  ...
  }, { signal: a }), Md(e, a), rm(e, a), t('[data-role="curve-group"]')?.addEventListener("change", () => {
    e.setChannelFilter("all"), Fs(e), e.drawCurveEditor(), qr(e);
  ...
  const c = (d, h) => {
    ...
    if (!(!b || h.button === 2 || d.closest(".scene-action-btn")))
      if (b.dataset.objectId) {
        const u = e.state.objects.find((y) => y.id === b.dataset.objectId);
        if (!u) return;
        if (e.finishCameraEdit(), e.selectedObjectIds ||= /* @__PURE__ */ new Set(), h.ctrlKey || h.metaKey)
          ...
          const y = e.state.objects.map((g) => g.id), x = y.indexOf(e.outlinerAnchorId), S = y.indexOf(u.id);
        ...
        e.selectedObjectId = e.selectedObjectIds.has(u.id) ? u.id : [...e.selectedObjectIds].at(-1) || null, e.selectedEntity = e.selectedObjectIds.size ? "object" : "camera", e.selectedKeyFrame = e.selectedObjectId ? u.keyframes?.find((y) => y.frame === e.frame)?.frame ?? null : null, e.editingKeyFrame = null;
  ...
  e.root.addEventListener("pointerdown", (d) => {
    ...
    const h = e.interactionElement.getBoundingClientRect(), b = (d.clientX - h.left) * e.canvas.width / Math.max(1, h.width), u = (d.clientY - h.top) * e.canvas.height / Math.max(1, h.height);
    lh(e, d, b, u) || e.onWheel(d);
  }, { passive: !1, signal: a }), e.root.addEventListener("wheel", pd(e.root), { signal: a }), window.addEventListener("pointermove", (d) => {
  ...
  l && (l.addEventListener("pointerdown", (d) => e.onTimelinePointerDown(d), { signal: a }), l.addEventListener("pointermove", (d) => e.onTimelinePointerMove(d), { signal: a }), l.addEventListener("pointerup", (d) => e.onTimelinePointerUp(d), { signal: a }), l.addEventListener("pointercancel", (d) => e.onTimelinePointerUp(d), { signal: a }), l.addEventListener("wheel", (d) => ds(e, d), { passive: !1, signal: a }));
  const p = (d) => {
    const h = ec(d.composedPath?.()[0] || d.target);
    h && (e.lastKeyZone = h);
  };
  e.root.addEventListener("focusin", p, { signal: a }), e.root.addEventListener("pointerdown", p, { capture: !0, signal: a }), e.root.addEventListener("focusout", (d) => {
    e.modalTransform && !e.root.contains(d.relatedTarget) && (Zi(e), e.render());
  }, { signal: a });
...
function ph(e, t) {
  zr.find((o) => o.id === e)?.onChange?.(t);
}
function fh(e) {
  const t = Wc(e.id, e.defaultValue), a = `pref_${e.id.replace(/[^a-zA-Z0-9]/g, "_")}`;
  if (e.type === "boolean")
    return `
...
function hh(e) {
  const t = new Map(zr.map((o) => [o.id, o]));
  return ({
    nav: [
      Nc,
      Fc,
...
function uh() {
  return `<span class="oc-pref-emoji" aria-hidden="true">${mh}</span> ${s("OmniCam Preferences")}`;
}
function bh(e) {
  ...
  a.className = "oc-modal-backdrop", a.setAttribute("role", "dialog"), a.setAttribute("aria-modal", "true"), a.setAttribute("aria-label", s("OmniCam Preferences")), a.innerHTML = `
    <div class="oc-modal-dialog oc-pref-dialog" tabindex="-1">
      <div class="oc-pref-header">
        <div class="oc-pref-title">${uh()}</div>
...
const yh = ["position", "target"], vh = ["fov", "zoom"], xh = ["roll"], wh = ["position", "size"], kh = ["rotation"];
function Er(e) {
...
function Hn(e, t, a, o) {
  const r = Er(Number(a || 0) - Number(e || 0)), n = Number(e || 0) + r * o;
  if (t == null) return n;
  const i = Er(Number(t || 0) - n);
  return n + i / 3;
}
function Gn(e, t, a) {
  ...
  for (let r = 1; r < a.length - 1; r++) {
    ...
    if (i.camera) {
      for (const m of yh) {
        ...
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const b = Vn(f, d, h, p);
          a[r].camera[m] = Gn(d.map(Number), b, o);
        }
      }
      for (const m of vh) {
        const f = n.camera?.[m], d = i.camera?.[m], h = c.camera?.[m];
    ...
    if (Array.isArray(i.position) && Array.isArray(n.position) && Array.isArray(c.position)) {
      for (const m of wh) {
        ...
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const b = Vn(f, d, h, p);
          a[r][m] = Gn(d.map(Number), b, o);
        }
      }
      for (const m of kh) {
        const f = n[m], d = i[m], h = c[m];
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const b = [0, 1, 2].map((u) => Hn(f[u], d[u], h[u], p));
          a[r][m] = d.map((u, v) => Yn(Number(u), b[v], o));
        }
      }
    }
  }
...
function Mh(e, t) {
  ...
  const o = (r) => {
    ...
    const b = (v) => {
      ...
      let x = Ch;
      v.shiftKey ? x = Ah : (v.ctrlKey || v.metaKey) && (x = Th);
      const S = p * x * 20;
      let g = l + y * S;
      g = Math.max(m, Math.min(f, g));
      const C = p >= 1 ? 0 : p >= 0.1 ? 1 : 2;
      i.value = g.toFixed(C), i.dispatchEvent(new Event("input", { bubbles: !0 })), i.dispatchEvent(new Event("change", { bubbles: !0 }));
    }, u = (v) => {
...
function Oh(e, t) {
  for (const o of e.root.querySelectorAll('[data-act="toggle-camera-lock"]'))
    o.addEventListener("click", (r) => {
      r.stopPropagation(), e.checkpoint?.("Toggle camera lock"), e.state.camera_lock = !e.state.camera_lock, e.serialize?.(), ii(e), e.setStatus?.(e.state.camera_lock ? s("Camera View locked") : s("Camera View unlocked"));
    }, { signal: t });
  ...
  for (const o of e.root.querySelectorAll('[data-act="toggle-gizmo-space"]'))
    o.addEventListener("click", (r) => {
      ...
      e.serialize?.(), Ke(e), e.requestRender?.(), e.setStatus?.(s("Transform space: {space}").replace("{space}", e.state.gizmo_space));
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-spatial-snap"]'))
    o.addEventListener("click", (r) => {
      ...
      e.serialize?.(), Ke(e), e.setStatus?.(s("Snapping: {mode}").replace("{mode}", e.state.spatial_snap_mode));
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-grid-overlay"]'))
    o.addEventListener("click", (r) => {
      r.stopPropagation(), e.checkpoint?.("Toggle grid overlay"), e.state.show_grid = e.state.show_grid === !1, e.serialize?.(), Ke(e), e.requestRender?.();
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-wireframe-overlay"]'))
    o.addEventListener("click", (r) => {
      ...
      e.serialize?.(), Ke(e), e.requestRender?.(), e.setStatus?.(e.state.show_wireframe ? s("Wireframe overlay: On") : s("Wireframe overlay: Off"));
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-cull-overlay"]'))
    o.addEventListener("click", (r) => {
      ...
      e.serialize?.(), Ke(e), e.webgl && (e.webgl.sceneKey = ""), e.requestRender?.(), e.setStatus?.(e.state.backface_culling ? s("Backface culling: On (Single-Sided)") : s("Backface culling: Off (Double-Sided)"));
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-gizmo-overlay"]'))
    o.addEventListener("click", (r) => {
      r.stopPropagation(), e.checkpoint?.("Toggle gizmo overlay"), e.state.show_gizmo = e.state.show_gizmo === !1, e.serialize?.(), Ke(e), e.requestRender?.();
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-guides-overlay"]'))
    o.addEventListener("click", (r) => {
      r.stopPropagation(), e.checkpoint?.("Toggle guides overlay"), e.state.guides = e.state.guides === !1, e.serialize?.(), Ke(e), e.requestRender?.();
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-safe-areas-overlay"]'))
    o.addEventListener("click", (r) => {
      r.stopPropagation(), e.checkpoint?.("Toggle safe areas overlay"), e.state.safe_areas = !e.state.safe_areas, e.serialize?.(), Ke(e), e.requestRender?.();
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-radar-overlay"]'))
    o.addEventListener("click", (r) => {
      r.stopPropagation(), e.checkpoint?.("Toggle radar overlay"), e.state.show_radar = !e.state.show_radar, e.serialize?.(), Ke(e), e.requestRender?.();
    }, { signal: t });
...
function Ph(e, t) {
  ...
  !a || !o || (r && r.addEventListener("change", () => {
    ...
    document.activeElement !== a && (a.value = Kr(o.value));
  }, { signal: t }));
}
function Lh(e, t) {
  ...
  a.addEventListener("input", r, { signal: t }), a.addEventListener("change", () => {
    ...
    const c = Number(a.value) / 100, l = jh(n(i), c);
  ...
  if (a.length) {
    ...
    for (const o of a)
      o.addEventListener("change", () => {
        e.dopeChannels = new Set(a.filter((r) => r.checked).map((r) => r.dataset.dopeChannel)), $s(e);
      }, { signal: t });
  }
}
function Rh(e, t) {
...
const So = () => import("./chunk-LTxXhI7_.js");
function Kh(e, t) {
...
function Bh(e, t) {
  ...
  Vc().then((r) => {
    ...
    c === "health-slow" ? Gc(e) : c === "health-smooth" ? Yc(e) : c === "health-recenter" && Xc(e);
  }, { signal: t });
  for (const r of e.root.querySelectorAll('[data-tab="health"]'))
    r.addEventListener("click", () => er(e), { signal: t });
}
function qh(e, t) {
...
function Vh(e, t) {
  Kh(e, t), Ph(e, t), Lh(e, t), Nh(e, t), Fh(e, t), qh(e, t), Wh(e, t), Uh(e, t), Mh(e, t), $h(e, t), zh(e, t), Dh(e, t), Oh(e, t), Rh(e, t), Bh(e, t);
}
const Xn = {
...
}, ci = "balanced", ir = "#121212";
function Xr(e) {
  return Xn[e] || Xn[ci];
}
function Hh(e, t = "#1b1f2b", a = "#151822", o = "#1e2330", r = "#161922", n = "#111319") {
...
function xy(e, t, a = ci) {
  ...
  const h = new e.FogExp2(1250588, 8e-3), b = Hh(e), u = new e.PMREMGenerator(t);
  u.compileEquirectangularShader();
  const v = new yd(), y = u.fromScene(v, 0.04).texture;
  return v.traverse((x) => {
    x.geometry?.dispose?.();
    ...
    quality: a,
    dispose() {
      f.geometry.dispose(), f.material.dispose(), d.geometry.dispose(), d.material.dispose(), m.dispose(), b.dispose(), y.dispose(), u.dispose();
...
function Yh(e) {
  ...
  const r = e.reconstruction, n = r.provider || "Reconstructed", i = Math.round(t * 100), c = Dl(e), l = c.length ? `
` + c.map(([m, f]) => `${m}: ${f}`).join(`
`) : "", p = `${n} • ${o} (${i}%)${l}`;
  return {
    label: o,
...
function Zh(e, t, a) {
  ...
  if (o) {
    const n = (i) => {
      const c = i.target.closest?.("[data-axis], [data-axis-center]") || i.target, l = c.getAttribute("data-axis"), p = Jc(l?.toLowerCase(), e.state.view_mode);
  ...
  for (const n of e.root.querySelectorAll('[data-role="speed"]')) {
    const i = (c) => {
      const l = te(Number(c.target.value), 0.05, 5);
  ...
  for (const n of e.root.querySelectorAll('[data-role="point-color"]'))
    n.addEventListener("input", (i) => {
      e.state.point_color !== i.target.value && _o(e, "point_color", "Change point color"), e.state.point_color = i.target.value, e.scheduleSerialize(), e.render();
    }, { signal: a });
  ...
  for (const n of e.root.querySelectorAll('[data-act="reset-bg-color"]'))
    n.addEventListener("click", () => {
      e.state.viewport_bg_color !== ir && e.checkpoint("Reset background colour"), e.state.viewport_bg_color = ir;
      for (const i of e.root.querySelectorAll('[data-role="viewport-bg-color"]')) i.value = ir;
  ...
  for (const n of e.root.querySelectorAll('[data-role="viewport-bg-color"]')) {
    const i = (c) => {
      e.state.viewport_bg_color !== c.target.value && _o(e, "viewport_bg_color", "Change background colour"), e.state.viewport_bg_color = c.target.value, Ce(e.root, "viewport-bg-color", c.target), e.scheduleSerialize(), e.render();
    };
    n.addEventListener("input", i, { signal: a }), n.addEventListener("change", i, { signal: a });
  }
  ...
  for (const n of e.root.querySelectorAll('[data-role="object-color"]'))
    n.addEventListener("input", (i) => {
      const c = e.selectedObject();
      c && (c.color !== i.target.value && _o(e, `object_color:${c.id}`, "Change object color"), c.color = i.target.value, e.scheduleSerialize(), e.render());
    }, { signal: a });
  for (const n of e.root.querySelectorAll('[data-role="object-light-color"]'))
    n.addEventListener("input", (i) => {
      const c = e.selectedObject();
      c && (c.color !== i.target.value && _o(e, `object_color:${c.id}`, "Change light color"), c.color = i.target.value, e.scheduleSerialize(), e.render());
    }, { signal: a });
  ...
  for (const n of e.root.querySelectorAll("[data-lens]"))
    n.addEventListener("click", () => {
      Kl(e, Number(n.dataset.lens));
    }, { signal: a });
  for (const n of e.root.querySelectorAll("[data-blocking-scene]"))
    n.addEventListener("click", () => {
      th(e, n.dataset.blockingScene), e.closeMenus();
    }, { signal: a });
...
const Qh = 32, eu = 0.025, tu = 0.05, Fo = 1e-6, au = ["top", "bottom", "front", "back", "left", "right"], ou = {
  top: "y",
  bottom: "y",
  front: "z",
  back: "z",
...
function ru(e) {
  let t = 0;
  for (let a = 1; a < e.length; a++) t += Zr(e[a - 1], e[a]);
  return t;
}
function Ar(e) {
...
function nu(e, t) {
  ...
  for (let i = 0; i < t; i++) {
    ...
    const l = a[n - 1], p = a[n], m = Cr((c - l) / Math.max(Fo, p - l), 0, 1), f = e[n - 1], d = e[n];
    r.push([
      f[0] + (d[0] - f[0]) * m,
      f[1] + (d[1] - f[1]) * m,
      f[2] + (d[2] - f[2]) * m
...
function cu(e) {
  ...
  const n = Math.min(Qh, r.length, o + 1);
  if (n < 2) return [];
  const i = nu(r, n);
  ...
  ], p = e.planeAxis === "y" ? li(l) : di(l, [0, 0, -1]), m = e.seedPoint ? 1 : 0, f = [];
  for (let d = m; d < i.length; d++) {
    const h = i[d], b = su(i, d, p, e.planeAxis), u = le(c);
    u.position = [...h], u.target = iu(h, b, l, e.planeAxis), f.push({
...
function mi(e, t = e.cameraPathDraw) {
  const a = t?.pointerId;
  if (a != null)
    try {
...
function Jn(e, t = {}) {
  ...
  if (a === "extend") {
    ...
    const b = Math.max(0, Math.round(Number(e.state.duration_frames) || 1) - 1), [, u] = Ar(e.state), v = d.length > 1 ? d[d.length - 1].frame - d[0].frame : 24;
    let y = Math.max(u, h.frame + Math.max(6, Math.min(v, 240)));
    y <= h.frame && (y = h.frame + 24), y > b && (l = y + 1), y > u && (p = y), c = [h.frame, y];
  } else
    au.includes(e.state.view_mode) || e.setViewMode?.("top"), c = Ar(e.state);
  const m = ou[e.state.view_mode] ?? null, f = n ? [...n] : [...r.position];
  return e.cameraPathDraw = {
    ...
    sourceCamera: r,
    points: []
  }, Xt(e), e.setStatus?.(a === "extend" ? s("Continue Camera Path: LMB draw from the last key · RMB or Esc cancel") : s("Draw Camera Path: LMB draw · RMB or Esc cancel")), e.render?.(), !0;
}
function Qr(e, t) {
  ...
  a.planeAxis && (o[zo[a.planeAxis]] = a.anchor[zo[a.planeAxis]]);
  const r = a.points.at(-1);
  return r && Zr(r, o) < eu ? !1 : (a.points.push(o), !0);
}
function Ge(e) {
  const t = e.cameraPathDraw;
  return t?.active ? (mi(e, t), e.cameraPathDraw = null, Xt(e), e.setStatus?.(s("Draw Camera Path cancelled")), e.render?.(), !0) : !1;
}
function du(e) {
  const t = e.cameraPathDraw;
  ...
  if (a.length < 2 || ru(a) < tu || t.range[1] <= t.range[0])
    return Ge(e), e.setStatus?.(s("Camera path needs at least two distinct points")), null;
  const o = cu(t);
  ...
  if (t.mode === "extend") {
    ...
    return c.keyframes = p, c.id === e.state.active_camera_id && (e.state.keyframes = p), e.cameraPreviewSignature = "", e.cameraPathDraw = null, Xt(e), e.activateCamera?.(c.id), e.setFrame?.(o[0].frame), e.serialize?.(), e.refreshKeys?.(), e.render?.(), e.setStatus?.(s("Camera path extended")), c.id;
  }
  e.checkpoint?.("Draw camera path");
  const r = Bl(e.state), n = e.state.cameras.length, i = {
    id: r,
    name: lu(e.state),
    color: fn[n % fn.length],
    camera: le(o[0].camera),
    keyframes: o,
    target_object_id: null,
    target_offset: [0, 0, 0]
  };
  return e.state.cameras.push(i), e.cameraPreviewSignature = "", e.cameraPathDraw = null, Xt(e), e.activateCamera?.(r), e.setFrame?.(t.range[0]), e.setStatus?.(s("Camera path created")), r;
}
function Ro(e) {
...
function en(e, t) {
  ...
  return r?.every(Number.isFinite) ? (a.planeAxis && (r[zo[a.planeAxis]] = a.anchor[zo[a.planeAxis]]), r) : null;
}
function pu(e, t) {
  const a = e.cameraPathDraw;
  return a?.active ? t.button === 2 && !t.altKey ? (Ro(t), e.cameraPathSuppressContextMenuUntil = Date.now() + 1e3, Ge(e), !0) : t.button !== 0 || t.altKey || t.ctrlKey || t.metaKey || t.shiftKey ? !1 : (Ro(t), e.closeMenus?.(), e.interactionElement.focus?.({ preventScroll: !0 }), e.interactionElement.setPointerCapture?.(t.pointerId), a.drawing = !0, a.pointerId = t.pointerId, a.points = [], Qr(e, en(e, t)), Xt(e), e.requestRender?.("camera-path-draw"), !0) : !1;
}
function fu(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : (Ro(t), Qr(e, en(e, t)) && e.requestRender?.("camera-path-draw"), !0);
}
function hu(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : (Ro(t), t.type === "pointercancel" || t.type === "lostpointercapture" ? (Ge(e), !0) : (Qr(e, en(e, t)), a.drawing = !1, du(e), !0));
}
function uu(e) {
  const t = e.cameraPathDraw;
  ...
  if (!o.length) return;
  const r = o.map((c) => Ye(c, a, e.canvas.width, e.canvas.height)).filter((c) => c && Number.isFinite(c[0]) && Number.isFinite(c[1]));
  if (!r.length) return;
...
function bu(e, t) {
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? Ge(e) : Jn(e);
    }, { signal: t });
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path-extend"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? Ge(e) : Jn(e, { mode: "extend" });
    }, { signal: t });
  ...
  e.root.addEventListener("contextmenu", (a) => {
    !(Date.now() <= Number(e.cameraPathSuppressContextMenuUntil || 0)) && !e.cameraPathDraw?.active || (a.preventDefault(), a.stopPropagation(), a.stopImmediatePropagation?.(), e.cameraPathSuppressContextMenuUntil = 0, e.cameraPathDraw?.active && Ge(e));
  }, { capture: !0, signal: t });
}
const To = "/majoor/omnicam/scenes";
function pi(e) {
...
function tn(e, t, { name: a = "", status: o } = {}) {
  const r = t && typeof t == "object" ? t : ks(), n = { ...r, metadata: { ...r.metadata || {}, scene_name: a || "" } };
...
async function gu(e) {
  await Qt(e, s("New Scene"), s("Start a new scene? Unsaved changes will be lost.")) && tn(e, ks(), { name: "", status: s("New scene") });
}
async function yu(e) {
  if (!e.sceneBaseline) {
  ...
  const o = a?.metadata?.scene_name || pi(e);
  tn(e, a, { name: o, status: s("Scene reset to last save") });
}
async function vu(e) {
  const t = pi(e) || s("Untitled"), a = await Zt(e, s("Save Scene"), s("Scene name"), t);
  if (a == null) return;
...
async function xu(e) {
  ...
  const a = await Es({
    ...
    items: t.map((r) => ({
      id: r.slug,
      label: r.name || r.slug,
      sublabel: wu(r.modified)
    })),
    onDelete: (r) => Mo(e, `${To}/${encodeURIComponent(r)}`, { method: "DELETE" }).catch((n) => console.warn("[OmniCam] scene delete failed", n))
  });
  if (!(!a || !await Qt(e, s("Open Scene"), s("Open this scene? Unsaved changes will be lost."))))
    try {
      const r = await Mo(e, `${To}/${encodeURIComponent(a)}`);
      if (!r.ok) throw new Error(await r.text());
...
function ku(e, t) {
  jo(e, t, e.root.querySelectorAll('[data-act="scene-new"]'), () => gu(e)), jo(e, t, e.root.querySelectorAll('[data-act="scene-open"]'), () => xu(e)), jo(e, t, e.root.querySelectorAll('[data-act="scene-save"]'), () => vu(e)), jo(e, t, e.root.querySelectorAll('[data-act="scene-reset"]'), () => yu(e));
}
const Su = ["world_point", "object_point", "camera_field"], Zn = 40;
function _u(e) {
  return (e.keys || []).map((t) => ({ x: t.x, y: t.y, t: t.time_seconds }));
}
function ju(e, t, a) {
  const o = Math.max(1, Number(e.fps) || 24), r = e.width || 1280, n = e.height || 720, i = [];
  for (let c = 0; c <= Zn; c += 1) {
    const l = a * c / Zn, p = Rr(e, t.source, l * o, r, n);
...
function Cu(e) {
  ...
  if (!c) return;
  const l = fi(t, e.state.width || 1280, e.state.height || 720), p = (v) => l.x + v * l.w, m = (v) => l.y + v * l.h;
  ...
  for (const v of e.state.motion_layers || []) {
    if (v.enabled === !1) continue;
    const y = Su.includes(v.source_kind), x = y ? ju(e.state, v, d) : _u(v);
    if (!x.length) continue;
    b += 1;
    const S = v.id === e.state.selected_motion_layer_id;
    if (c.strokeStyle = S ? "#ffcc4d" : "rgba(65,217,197,0.6)", c.lineWidth = (S ? 2.4 : 1.5) * r, c.beginPath(), x.forEach((C, M) => {
      const R = p(C.x), F = m(C.y);
      M ? c.lineTo(R, F) : c.moveTo(R, F);
    }), c.stroke(), !y) {
      c.fillStyle = S ? "#ffcc4d" : "#41d9c5";
      for (const C of x)
        c.beginPath(), c.arc(p(C.x), m(C.y), (S ? 3.4 : 2.4) * r, 0, Math.PI * 2), c.fill();
    }
    const g = Eu(x, h);
...
function Au(e, t) {
  ...
  a && a.addEventListener("click", (o) => {
    ...
    const n = fi(a, e.state.width || 1280, e.state.height || 720), i = a.width / r.width, c = {
      x: ((o.clientX - r.left) * i - n.x) / Math.max(1, n.w),
      y: ((o.clientY - r.top) * i - n.y) / Math.max(1, n.h)
    }, l = Qc(e.state.motion_layers, c, 0.09);
...
function $u(e, t) {
  ...
  return {
    ...
    motion_scene_fingerprint: fd(e.state)
  };
}
function Iu(e, t) {
  const a = $u(e, t);
...
function Qn(e, t, { frameCount: a = 0, fps: o = 0 } = {}) {
...
const pt = 1024 * 1024, Ou = Object.freeze({
  card: 128 * pt,
  // MAX_CARD_BYTES
  model: 256 * pt,
  // MAX_MODEL_BYTES
...
function ts(e) {
  return `${(e / pt).toFixed(e >= 10 * pt ? 0 : 1)} MB`;
}
function ea(e, t) {
  const a = Ou[t];
  if (!e || !a) return null;
  const o = Number(e.size);
  return !Number.isFinite(o) || o <= a ? null : `${e.name || "File"} is ${ts(o)}; the maximum is ${ts(a)}.`;
}
function Pu(e) {
  return Number(e) <= es ? null : `${e} frames selected; a background sequence is limited to ${es}.`;
}
function Lu(e) {
...
function Nu(e) {
  ...
  e.audioElement && (cr(e, r), Promise.resolve(e.audioElement.play()).catch(() => {
  }));
  ...
  const p = (m) => {
    ...
    if (f === null) {
      for (l += m - c, c = m; l >= i; )
        if (l -= i, r += 1, r > o) {
          if (!e.state.loop_playback) return void $o(e);
          r = a;
        }
...
async function Fu(e, { load: t = () => import("./vendor-mediabunny-CZ5VNE-V.js") } = {}) {
  ...
  for await (const h of new o(c).samples())
    try {
      ...
      h.copyTo(u, b), l.push(u), p += u.length;
    } finally {
      h.close();
    }
  if (!p || !m) return null;
...
async function Ru(e, t, { decode: a = Fu } = {}) {
  if (!t) return;
  const o = ea(t, "audio");
  if (o) {
    e.setStatus(o);
  ...
  try {
    ...
    n.preload = "auto", n.src = r, e.audioObjectUrl = r, e.audioElement = n, await zu(n), e.audioDuration = Number.isFinite(n.duration) ? n.duration : 0;
    try {
      e.audioSamples = await a(t);
    } catch {
      e.audioSamples = null;
    }
    hi(e), e.setStatus(`Audio loaded: ${t.name || "track"}`);
  } catch (r) {
    Do(e), e.setStatus(`Failed to load audio: ${r.message || r}`);
  }
}
let Tt = null;
function ui({ api: e }) {
...
const bi = /* @__PURE__ */ new WeakSet(), Gt = /* @__PURE__ */ new WeakMap();
function Ko(e) {
...
function Du(e) {
  e && typeof e == "object" && Gt.set(e, (Gt.get(e) || 0) + 1);
}
function Ku(e) {
  ...
  Gt.delete(e), bi.has(e) && Ko(e);
}
function ta(e, t) {
  const a = e.cardMediaById.get(t);
  a && (e.cardMediaById.delete(t), e.cardMediaAssetById?.delete?.(t), t === "subject" && e.cardMedia === a && (e.cardMedia = null), Ku(a));
}
function Bu(e) {
  for (const t of [...e.cardMediaById?.keys?.() || []]) ta(e, t);
}
function nt(e, t, a, o = !1, r = "") {
  ...
  n && n !== a && ta(e, t), o && bi.add(a), Du(a), e.cardMediaAssetById ||= /* @__PURE__ */ new Map(), e.cardMediaById.set(t, a), e.cardMediaAssetById.set(t, r || a?.__omnicamAsset || "");
  try {
    a.__omnicamAsset = r || a.__omnicamAsset || "";
  } catch {
  }
...
function gi(e, t, { signal: a, timeout: o = 15e3 } = {}) {
...
async function yi(e, t, a, o = () => !0, r = null) {
  if (!t || !a) return;
  const n = () => !e.disposed && o(), i = String(t.asset || a).toLowerCase();
  if (r ?? /\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/.test(i)) {
    const l = document.createElement("video");
    if (l.src = a, l.loop = !0, l.muted = !0, l.playsInline = !0, await gi(l, ["loadeddata", "error"], { signal: e.abortController?.signal }).catch(() => {
    }), !n()) {
      Ko(l);
      return;
    }
...
function Uu(e) {
  ...
  if (e.state.viewport_bg_image) {
    const o = new Image();
    o.src = at(e.state.viewport_bg_image), o.decode().catch(() => {
    }), e.viewportBgImage = o;
  }
  e.viewportBgSequenceImages = (e.state.viewport_bg_sequence || []).map((o) => {
    const r = new Image();
    return r.src = at(o), r.decode().catch(() => {
    }), r;
  });
  for (const o of e.state.objects) {
    if (!o.asset) {
      (o.type === "model" || o.type === "glb") && (o.load_error = s("Not saved to the ComfyUI input folder: this model will be missing after a reload.")), o.type === "card" && ta(e, o.id);
      continue;
    }
    const r = at(o.asset);
...
async function Vu(e, t) {
  ...
  try {
    const c = await Ur(Tt, { route: "/majoor/omnicam/upload_model", field: "asset", file: t });
...
async function Hu(e, t) {
  ...
  if (o) {
    ...
    try {
      const r = await Ur(Tt, { route: "/majoor/omnicam/upload_asset", field: "asset", file: t });
...
function Gu(e, t) {
  ...
  e.state.reference_index = te(e.state.reference_index || 0, 0, e.executionReferences.length - 1), a.value = String(e.state.reference_index), e.serialize(), e.loadSelectedReference();
}
function Yu(e) {
  ...
  const a = new Image();
  a.onload = () => {
    e.disposed || (nt(e, "subject", a, !1, a.src), e.render(), e.setStatus(s("Upstream media refreshed")));
...
async function Xu(e) {
  ...
  for (const f of i) {
    ...
    if (h) {
      if (d === "image" || d === "video") {
        ...
        if (b && b.value) {
          const u = String(b.value), v = /\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/i.test(u), y = h.widgets?.find((g) => String(g.name).toLowerCase() === "subfolder")?.value || "", x = at(kt(u, y)), S = e.state.objects.find((g) => g.id === "subject");
          if (S) {
            const g = await yi(e, S, x, r, v);
            if (!r()) return;
            S.asset = kt(u, y);
            let C = null;
            if (v)
              try {
                C = await qu(u, o.signal);
              } catch (M) {
            ...
            r() && Qn(e, g, {
              fps: C?.fps,
              frameCount: v ? C?.frame_count : 1
            }), e.upstreamImageConnected = !0, n = !0, e.setStatus(s(`Upstream ${v ? "video" : "image"}: ${u}`));
          }
        } else {
          const u = ud(h);
          u && (u instanceof HTMLVideoElement && u.paused && u.play().catch(() => {
          }), nt(e, "subject", u, !1, u.currentSrc || u.src || ""), Qn(e, u, { frameCount: u instanceof HTMLVideoElement ? 0 : 1 }), e.upstreamImageConnected = !0, n = !0, e.render(), e.setStatus(u instanceof HTMLVideoElement ? s("Upstream video preview synced") : s("Upstream image preview synced")));
        }
      }
      if (d === "audio") {
        l = !0;
        ...
        if (b && b.value) {
          const u = String(b.value), v = h.widgets?.find((x) => String(x.name).toLowerCase() === "subfolder")?.value || "", y = at(kt(u, v));
          try {
            const x = await fetch(y, { signal: o.signal });
            if (x.ok) {
              const S = await x.blob();
              if (!r()) return;
              const g = new File([S], u, { type: S.type || "audio/wav" });
              await e.loadAudioFile(g), e.upstreamAudioConnected = !0, n = !0, e.setStatus(s(`Upstream audio: ${u}`));
            }
          } catch (x) {
      ...
      if (d === "scene_3d" || d === "model" || d === "mesh") {
        ...
        if (b && b.value) {
          const u = String(b.value), v = u.split(".").pop()?.toLowerCase();
          if (["glb", "gltf", "obj", "fbx", "stl", "ply"].includes(v)) {
            const y = h.widgets?.find((C) => String(C.name).toLowerCase() === "subfolder")?.value || "", x = at(kt(u, y)), S = `upstream_scene_${h.id}`;
            p.add(S);
            let g = e.state.objects.find((C) => C.id === S);
            g ? (g.asset = kt(u, y), g.format = v === "gltf" ? "glb" : v) : (g = {
              id: S,
              type: "model",
              format: v === "gltf" ? "glb" : v,
              ...
              enabled: !0,
              asset: kt(u, y)
            }, e.state.objects.push(g)), e.modelUrlsById.set(S, x), e.serialize(), e.refreshObjects(), e.render(), n = !0, e.setStatus(s(`Upstream 3D model: ${u}`));
          }
        }
      }
    }
  ...
  !l && e.upstreamAudioConnected && (Do(e), e.upstreamAudioConnected = !1, e.refreshKeys(), n = !0, e.setStatus(s("Upstream audio disconnected · audio track cleared")));
  ...
  Ul(e) && (n = !0), n && (e.serialize(), e.render());
}
const Ju = ["video/mp4;codecs=avc1.42E01E", "video/webm;codecs=vp9", "video/webm;codecs=vp8", "video/webm"], as = { low: 3e6, balanced: 6e6, high: 12e6 };
function Zu(e) {
  return as[e] || as.balanced;
}
async function Qu({
  canvas: e,
  fps: t,
  ...
  try {
    for (const S of Ju)
      if (!(n.isTypeSupported && !n.isTypeSupported(S)))
        try {
          f = new n(m, { mimeType: S, videoBitsPerSecond: Zu(r) });
          break;
        } catch {
        }
    ...
    f.stop(), await h;
    const u = Math.max(0, c() - b), v = a / t * 1e3, y = {
...
async function tb(e) {
  await Promise.all([...e].filter((t) => t instanceof HTMLVideoElement && t.seeking).map((t) => gi(t, ["seeked", "error"], { timeout: 5e3 }).catch(() => {
  })));
}
async function vi(e) {
  await tb(e.cardMediaById.values());
}
async function xi(e) {
  return Qu({
    canvas: e.canvas,
...
async function wi(e, t) {
  const a = await eb(st, t);
  if (Iu(e, t), e.state.playblast_camera_id === Ss)
...
async function ob(e) {
  ...
  const t = e.frame, a = e.canvas.width, o = e.canvas.height, r = ab(e);
  (r.width !== e.canvas.width || r.height !== e.canvas.height) && (e.canvas.width = r.width, e.canvas.height = r.height, e.render());
  try {
    let n = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-BsZm-kL6.js");
    i !== "realtime" && await l(e.canvas.width, e.canvas.height) && (n = await c(e.canvas, e.state.duration_frames, e.state.fps, async (p) => {
      e.setFrame(p, !0), e.setStatus(s(`Encoding frame ${p + 1}/${e.state.duration_frames}…`)), await vi(e), await new Promise((m) => requestAnimationFrame(m));
    }, e.abortController?.signal, e.state.playblast_quality)), n || (e.setStatus(s("WebCodecs unavailable; recording realtime fallback…")), n = await xi(e)), e.setFrame(t), await wi(e, n);
  } catch (n) {
...
async function ki(e) {
  ...
  return Ur(Jt, { route: "/majoor/omnicam/upload_asset", field: "asset", file: e });
}
async function Bo(e) {
...
async function nb(e, t) {
  ...
  let r = null;
  try {
    if (e.setStatus(`Uploading background: ${t.name}`), r = await ki(t), o !== e.backgroundRequestId || e.disposed) {
      await Bo([r]);
      return;
    }
    const n = at(r.path);
    ...
    if (r && await Bo([r]), o !== e.backgroundRequestId || e.disposed) return;
...
async function sb(e, t) {
  ...
  const o = Array.from(t).map((i) => ea(i, "image")).find(Boolean);
  if (o) {
    e.setStatus(o);
    return;
  }
  ...
  try {
    ...
    for (const c of t)
      if (n.push(await ki(c)), r !== e.backgroundRequestId || e.disposed) {
        await Bo(n);
        return;
      }
    ...
    e.checkpoint?.("Set background sequence"), e.state.viewport_bg_sequence = i, e.state.viewport_bg_image = "", e.viewportBgImage = null, e.viewportBgSequenceImages = i.map((c) => {
      const l = new Image();
      return l.src = at(c), l.decode().catch(() => {
      }), l;
    }), e.serialize(), e.render(), e.setStatus(`Background sequence loaded: ${t.length} frames`);
  } catch (i) {
    if (await Bo(n), r !== e.backgroundRequestId || e.disposed) return;
    e.setStatus(`Failed to load BG sequence: ${i.message || i}`);
  }
}
function ib(e) {
  an(e), e.checkpoint?.("Clear background"), e.state.viewport_bg_image = "", e.state.viewport_bg_sequence = [], e.viewportBgImage = null, e.viewportBgSequenceImages = [], e.serialize(), e.render(), e.setStatus("Background cleared");
}
function cb(e) {
  const t = pr(e.state?.metadata?.viewport_labels);
  if (t.mode === "off") return;
  const a = Array.isArray(e.state?.objects) ? e.state.objects : [], o = e.viewportCamera(), r = e.ctx, n = e.canvas.width, i = e.canvas.height, c = te(i / 720, 0.75, 4), l = Number(e.frame) || 0, p = e.selectedObjectIds instanceof Set ? e.selectedObjectIds : /* @__PURE__ */ new Set();
  r.save(), r.font = `${Math.round(12 * c)}px system-ui, -apple-system, "Segoe UI", Roboto, sans-serif`, r.textBaseline = "alphabetic";
  for (const m of a) {
    if (m.enabled === !1 || !bs(m, { mode: t.mode, selectedIds: p })) continue;
    const f = gs(m, t.content);
    if (!f) continue;
    const d = ys(a, m, l) || { position: m.position, size: m.size }, h = Ye(vs(d, m.type), o, n, i);
    if (!h) continue;
    const [b, u] = h, v = t.content === "annotation" && m.annotation?.color || "", y = 6 * c, x = 4 * c, g = r.measureText(f).width + y * 2, C = 12 * c + x * 2, M = Math.round(b - g / 2), R = Math.round(u - C - 6 * c);
    r.fillStyle = "rgba(16,17,22,0.82)", lb(r, M, R, g, C, 4 * c), r.fill(), v && (r.strokeStyle = v, r.lineWidth = Math.max(1, c), r.stroke()), r.fillStyle = v || "#e6e6ec", r.fillText(f, M + y, R + C - x - 2 * c);
  }
  r.restore();
}
function lb(e, t, a, o, r, n) {
...
function ce(e, t, a, o = "#5a5a5a", r = 1) {
  const n = e.viewportCamera(), i = Ye(t, n, e.canvas.width, e.canvas.height), c = Ye(a, n, e.canvas.width, e.canvas.height);
...
function mb(e) {
  ...
  return e._pointFieldCache?.key !== r && (e._pointFieldCache = { key: r, ...al(t, a, o) }), e._pointFieldCache;
}
const pb = 600;
function fb(e) {
  const { points: t, colors: a } = mb(e);
  if (!t.length) return;
  const o = e.viewportCamera(), r = e.canvas.width, n = e.canvas.height, i = t.length / 3, c = 3 * Math.max(1, Math.ceil(i / pb)), l = /* @__PURE__ */ new Map();
  for (let p = 0; p < t.length; p += c) {
    const m = Ye([t[p], t[p + 1], t[p + 2]], o, r, n);
    if (!m) continue;
    const f = te(Math.round(5 / Math.sqrt(m[2])), 1, 4), d = `${Math.round(a[p] * 255)},${Math.round(a[p + 1] * 255)},${Math.round(a[p + 2] * 255)}|${f}`;
    let h = l.get(d);
...
function bb(e, t) {
  const [a, o, r] = t.position || [0, 0, 0], n = t.size?.[1] || 1.8, i = (t.size?.[0] || 0.7) * 0.5, c = [a, o + n * 0.88, r], l = [a, o + n * 0.76, r], p = [a - i * 0.55, o + n * 0.73, r], m = [a + i * 0.55, o + n * 0.73, r], f = [a - i * 0.72, o + n * 0.52, r], d = [a + i * 0.72, o + n * 0.52, r], h = [a - i * 0.82, o + n * 0.34, r], b = [a + i * 0.82, o + n * 0.34, r], u = [a, o + n * 0.44, r], v = [a - i * 0.28, o + n * 0.44, r], y = [a + i * 0.28, o + n * 0.44, r], x = [a - i * 0.28, o + n * 0.22, r], S = [a + i * 0.28, o + n * 0.22, r], g = [a - i * 0.28, o, r + 0.05], C = [a + i * 0.28, o, r + 0.05];
  ce(e, c, l, "#aaa", 2), ce(e, l, u, "#aaa", 2), ce(e, p, m, "#aaa", 2), ce(e, p, f, "#aaa", 2), ce(e, f, h, "#aaa", 2), ce(e, m, d, "#aaa", 2), ce(e, d, b, "#aaa", 2), ce(e, v, y, "#aaa", 2), ce(e, v, x, "#aaa", 2), ce(e, x, g, "#aaa", 2), ce(e, y, S, "#aaa", 2), ce(e, S, C, "#aaa", 2);
  const M = Ye(c, e.viewportCamera(), e.canvas.width, e.canvas.height);
  M && (e.ctx.strokeStyle = "#aaa", e.ctx.beginPath(), e.ctx.arc(M[0], M[1], te(28 / M[2], 3, 12), 0, Math.PI * 2), e.ctx.stroke());
}
function gb(e, t) {
  const [a, o, r] = t.position || [0, 0, 0], [n, i, c] = t.size || [1.5, 1.5, 1.5], l = n * 0.5, p = (c || n) * 0.5, m = i * 0.5, f = 12, d = [], h = [];
  for (let b = 0; b < f; b++) {
    const u = b / f * Math.PI * 2, v = Math.cos(u) * l, y = Math.sin(u) * p;
    d.push([a + v, o + m, r + y]), h.push([a + v, o - m, r + y]);
  }
  for (let b = 0; b < f; b++) {
    const u = (b + 1) % f;
    ce(e, d[b], d[u], "#aaa", 1.5), ce(e, h[b], h[u], "#aaa", 1.5);
  }
  for (let b = 0; b < f; b += 3)
    ce(e, d[b], h[b], "#aaa", 1.5);
}
function yb(e, t) {
  const [a, o, r] = t.position || [0, 0, 0], [n, i, c] = t.size || [1.5, 1.5, 1.5], l = n * 0.5, p = n * 0.18, m = 16, f = [], d = [];
  for (let h = 0; h < m; h++) {
    const b = h / m * Math.PI * 2, u = Math.cos(b), v = Math.sin(b);
    f.push([a + u * (l + p), o, r + v * (l + p)]), d.push([a + u * (l - p), o, r + v * (l - p)]);
  }
  for (let h = 0; h < m; h++) {
    const b = (h + 1) % m;
    ce(e, f[h], f[b], "#aaa", 1.5), ce(e, d[h], d[b], "#aaa", 1.5), h % 4 === 0 && ce(e, f[h], d[h], "#888", 1);
  }
}
function vb(e, t) {
  const a = t.position || [0, 1, 0], o = 0.25;
  ce(e, fe(a, [-o, 0, 0]), fe(a, [o, 0, 0]), "#bbb", 2), ce(e, fe(a, [0, -o, 0]), fe(a, [0, o, 0]), "#bbb", 2), ce(e, fe(a, [0, 0, -o]), fe(a, [0, 0, o]), "#bbb", 2);
}
function xb(e, t) {
  const [a, o, r] = t.position || [0, 1.5, 0], [n, i] = t.size || [2, 3], c = e.viewportCamera(), l = [
    ...
    [a + n / 2, o + i / 2, r],
    [a - n / 2, o + i / 2, r]
  ].map((v) => Ye(v, c, e.canvas.width, e.canvas.height));
  ...
  if (u)
    try {
      const v = Math.max(1, d - f), y = Math.max(1, b - h), x = u.videoWidth || u.naturalWidth || u.width, S = u.videoHeight || u.naturalHeight || u.height, g = e.state.card_fit || "contain";
      if (e.ctx.fillStyle = "#111", e.ctx.fillRect(f, h, v, y), g === "stretch" || !x || !S)
        e.ctx.drawImage(u, f, h, v, y);
      else if (g === "contain") {
        const C = Math.min(v / x, y / S), M = x * C, R = S * C;
        e.ctx.drawImage(u, f + (v - M) / 2, h + (y - R) / 2, M, R);
      } else {
        const C = Math.max(v / x, y / S), M = v / C, R = y / C;
        e.ctx.drawImage(u, (x - M) / 2, (S - R) / 2, M, R, f, h, v, y);
      }
    } catch {
    }
  else
...
function wb(e) {
  ...
  (e.state.cameras || []).forEach((a, o) => {
    ...
    if (!(i && e.state.view_mode === "camera")) {
      ...
      for (const c of r) {
        const l = Ye(c.camera.position, e.viewportCamera(), e.canvas.width, e.canvas.height);
      ...
      if (e.state.view_mode !== "camera") {
        const c = $e(a, e.frame, e.state.objects), l = Ye(c.position, e.viewportCamera(), e.canvas.width, e.canvas.height);
...
function kb(e) {
  ...
  for (let o = 0; o < e.state.keyframes.length - 1; o++) {
    ...
    t.push(He(De(n.camera.position, r.camera.position)) * e.state.fps / Math.max(1, n.frame - r.frame));
  }
...
function Sb(e) {
  ...
  e.recording && e.state.playblast_labels && cb(e);
}
async function _b(e, { signal: t } = {}) {
...
async function Eb(e) {
  ...
  const r = o.diagnostic?.issues || [], n = jb(r);
...
const Cb = 1, os = 0.01, Ab = 0.4, Tb = 3, Mb = 120, $b = 20, Ib = 4, Ob = 0.25, Pb = 0.5;
function Lb(e, t, a) {
  const o = He(De(t.camera.position, e.camera.position)), r = t.frame - e.frame, n = r / a, i = n > 1e-9 ? o / n : 1 / 0;
...
function Fb({ keys: e, fps: t = 24, objects: a = [] } = {}) {
  ...
  for (const c of n)
    ...
    }), c.distance < os && c.duration >= Ab && r.push({
      code: "STATIC_SEGMENT",
      severity: "info",
      frameStart: c.frameStart,
      frameEnd: c.frameEnd,
  ...
  if (i.length) {
    ...
    if (c > 1e-6)
      for (const l of n)
        Number.isFinite(l.speed) && l.speed > c * Tb && r.push({
          code: "SPEED_SPIKE",
          severity: "warning",
  ...
  for (let c = 1; c < o.length - 1; c += 1) {
    const l = De(o[c].camera.position, o[c - 1].camera.position), p = De(o[c + 1].camera.position, o[c].camera.position), m = He(l), f = He(p);
    if (m < 1e-6 || f < 1e-6) continue;
    const d = Math.max(-1, Math.min(1, ol(l, p) / (m * f))), h = Math.acos(d) * 180 / Math.PI;
    h >= Mb && r.push({
  ...
  if (o.length >= Ib) {
    const c = o.reduce((h, b) => h + b.camera.position[0], 0) / o.length, l = o.reduce((h, b) => h + b.camera.position[2], 0) / o.length, p = o[0].camera.position, m = o[o.length - 1].camera.position;
    let f = Math.abs(rs(m, c, l) - rs(p, c, l)) % 360;
    f > 180 && (f = 360 - f);
    const d = He(De(m, p));
    f <= $b && d > os && r.push({
  ...
  if (Array.isArray(a) && a.length)
    for (const c of o)
      for (const l of a) {
        ...
        const p = Number.isFinite(Number(l.radius)) ? Number(l.radius) : Pb;
        He(De(c.camera.position, l.position)) < p + Ob && r.push({
...
function Rb(e, t, a) {
  ...
  return o || (t.keyframes?.length ? qo(t, a).position : t.position || [0, 1.5, 0]);
}
function Yt(e, t, a, o) {
  if (!a) return a;
  const r = _i(e, t, o);
...
function Kb(e, { perFrame: t = !1 } = {}) {
  const a = e.activeCameraTrack(), o = on(e, a), r = rn(e, a);
...
function ji(e) {
  ...
  const r = (d, h, b, u, v = "") => {
    ...
    return y.type = "button", y.className = "scene-action-btn", b && (y.style.cssText = v || "color:#f59e0b;border-color:#78350f;background:rgba(245,158,11,0.15)"), y.title = s(h), y.innerHTML = `<i class="pi ${d}" style="font-size:10px"></i>`, y.addEventListener("click", (x) => {
      x.stopPropagation(), u(x);
    }), y;
  }, n = (e.outlinerFilter || "").trim().toLowerCase(), i = (d) => !n || String(d || "").toLowerCase().includes(n), c = (d, h, b) => {
    const u = !!(e.outlinerCollapsedSections?.has(b) && !n), v = document.createElement("div");
    ...
    `, v.addEventListener("click", () => {
      e.outlinerCollapsedSections ||= /* @__PURE__ */ new Set(), e.outlinerCollapsedSections.has(b) ? e.outlinerCollapsedSections.delete(b) : e.outlinerCollapsedSections.add(b), ji(e);
    }), { header: v, isCollapsed: u };
  ...
  if (p) {
    const d = e.state.cameras.filter((u) => !(!i(u.name) || a === "hidden" && !u.muted)), { header: h, isCollapsed: b } = c(s("Cameras"), d.length, "cameras");
    if (t.appendChild(h), !b)
      for (const u of d) {
        const v = document.createElement("div");
        v.role = "button", v.tabIndex = 0, v.dataset.cameraId = u.id;
        const y = u.id === e.state.active_camera_id, x = u.id === e.state.playblast_camera_id, S = e.selectedEntity === "camera" && y;
        ...
        const C = document.createElement("span");
        if (C.className = "scene-item-label", S || y) {
          const F = document.createElement("span");
          F.style.cssText = `color:${S ? "#f59e0b" : "#58cc6b"};font-weight:700`, F.textContent = S ? "● " : "○ ", C.appendChild(F);
        }
        if (C.appendChild(document.createTextNode(u.name)), x) {
          const F = document.createElement("span");
        ...
        const M = document.createElement("div");
        M.className = "scene-item-actions", M.appendChild(r("pi-star", "Solo track", u.solo, () => {
          e.checkpoint("Solo track"), u.solo = !u.solo, e.serialize(), e.refreshObjects(), e.renderCameraView();
        }, "color:#fbbf24;border-color:#78350f;background:rgba(245,158,11,0.2)")), M.appendChild(r("pi-volume-off", "Mute track", u.muted, () => {
          e.checkpoint("Mute track"), u.muted = !u.muted, e.serialize(), e.refreshObjects(), e.renderCameraView();
        }, "color:#f87171;border-color:#7f1d1d;background:rgba(239,68,68,0.15)")), M.appendChild(r("pi-lock", "Lock track", u.locked, () => {
          e.checkpoint("Lock track"), u.locked = !u.locked, e.serialize(), e.refreshObjects(), e.renderCameraView();
        })), (u.keyframes || []).length >= 1 && M.appendChild(r(
          "pi-arrows-alt",
        ...
        )), M.appendChild(r("pi-ellipsis-v", "Camera actions", !1, (F) => e.openCameraContext(F, u.id, !1))), v.append(g, C, M), v.title = S ? s("Currently selected for editing") : x ? s("Active playblast camera") : s("Click to select & activate this camera");
        const R = () => {
  ...
  if (m) {
    const d = new Map(e.state.objects.map((g) => [g.id, g])), h = /* @__PURE__ */ new Map(), b = [];
    for (const g of e.state.objects)
      g.parent_id && d.has(g.parent_id) ? (h.has(g.parent_id) || h.set(g.parent_id, []), h.get(g.parent_id).push(g)) : b.push(g);
    const u = [], v = (g, C) => {
      u.push({ object: g, level: C });
      const M = h.get(g.id) || [];
      for (const R of M) v(R, C + 1);
    };
    for (const g of b) v(g, 0);
    const y = u.filter(({ object: g }) => {
      const C = [g.name, g.type, ...g.tags || [], g.asset_kind, g.asset_id].filter(Boolean).join(" ");
      return !(!i(C) || a === "lights" && !l(g.type) || a === "objects" && l(g.type) || a === "hidden" && g.enabled !== !1);
    }), { header: x, isCollapsed: S } = c(a === "lights" ? s("Lights") : s("Objects"), y.length, "objects");
    if (t.appendChild(x), !S)
      for (const { object: g, level: C } of y) {
        const M = document.createElement("div");
        M.role = "button", M.tabIndex = 0, M.dataset.objectId = g.id;
        const R = e.selectedEntity === "object" && (g.id === e.selectedObjectId || e.selectedObjectIds?.has?.(g.id)), F = e.selectedEntity === "object" && g.id === e.selectedObjectId;
        M.setAttribute("aria-selected", String(R)), M.className = `scene-item${R ? " selected" : ""}${F ? " primary" : ""}${C > 0 && !n ? " scene-item-child" : ""}`, C > 0 && !n && (M.style.paddingLeft = `${C * 16 + 6}px`);
        const Y = g.type === "card" ? { icon: "pi-image", color: "#38bdf8" } : g.type === "model" || g.type === "glb" ? { icon: "pi-box", color: "#c084fc" } : g.type === "ground" ? { icon: "pi-minus", color: "#fbbf24" } : g.type === "cube" ? { icon: "pi-stop", color: "#fbbf24" } : g.type === "sphere" ? { icon: "pi-circle", color: "#fbbf24" } : g.type === "cylinder" ? { icon: "pi-database", color: "#fbbf24" } : g.type === "torus" ? { icon: "pi-circle", color: "#fbbf24" } : g.type === "pyramid" ? { icon: "pi-play", color: "#fbbf24" } : g.type === "sun_light" ? { icon: "pi-sun", color: "#f59e0b" } : g.type === "point_light" ? { icon: "pi-bolt", color: "#fbbf24" } : g.type === "spot_light" ? { icon: "pi-compass", color: "#38bdf8" } : g.type === "human" ? { icon: "pi-user", color: "#34d399" } : { icon: "pi-plus", color: "#94a3b8" }, H = g.enabled !== !1, X = !!g.load_error, oe = document.createElement("i");
        oe.className = `pi ${X ? "pi-exclamation-triangle" : Y.icon}`, oe.style.cssText = X ? "color:#f87171" : H ? `color:${Y.color}` : "opacity:.4";
        const k = document.createElement("span");
        k.className = "scene-item-label";
        const E = document.createElement("span");
        E.style.cssText = X ? "color:#fca5a5" : H ? "" : "opacity:.5;text-decoration:line-through", E.textContent = g.name || g.type, E.title = s("Double-click to rename"), E.addEventListener("dblclick", ($) => {
          $.preventDefault(), $.stopPropagation(), qb(e, g, E);
        }), k.appendChild(E);
        const z = Array.isArray(g.tags) ? g.tags : [];
        if (z.length) {
          const $ = document.createElement("span");
          $.className = "scene-item-tags";
          for (const G of z.slice(0, 2)) {
            const j = document.createElement("span");
            j.className = "scene-item-tag", j.textContent = G, $.appendChild(j);
          }
          if (z.length > 2) {
            const G = document.createElement("span");
            G.className = "scene-item-tag scene-item-tag-more", G.textContent = `+${z.length - 2}`, $.appendChild(G);
          }
          k.appendChild($);
        }
        if (X) {
        ...
        U.className = "scene-item-actions", U.appendChild(r(H ? "pi-eye" : "pi-eye-slash", H ? "Hide object (Alt+Click to Isolate)" : "Show object (Alt+Click to Isolate)", !H, ($) => {
          if ($?.altKey) {
            if (e.checkpoint("Isolate object"), e._isolatedObjectId === g.id) {
              e._isolatedObjectId = null;
              const j = e._isolationSnapshot;
              for (const W of e.state.objects)
                W.enabled = j && Object.prototype.hasOwnProperty.call(j, W.id) ? j[W.id] : !0;
              e._isolationSnapshot = null, e.setStatus?.(s("Isolation cleared"));
            } else {
              e._isolationSnapshot || (e._isolationSnapshot = Object.fromEntries(e.state.objects.map((j) => [j.id, j.enabled !== !1]))), e._isolatedObjectId = g.id;
              for (const j of e.state.objects) j.enabled = j.id === g.id;
              e.setStatus?.(s("Isolated: {name}").replace("{name}", g.name || g.type));
            }
            e.serialize(), e.refreshObjects(), e.requestRender?.();
          } else
            e.toggleObject(g.id);
        }, "color:#ef4444;opacity:.7")), U.appendChild(r(g.locked ? "pi-lock" : "pi-lock-open", "Lock object", g.locked, () => Jr(e, g))), U.appendChild(r("pi-copy", "Duplicate object", !1, () => e.duplicateObject?.(g.id))), g.id !== "subject" && U.appendChild(r("pi-trash", "Delete object", !1, () => e.deleteObject?.(g.id))), U.appendChild(r("pi-ellipsis-v", "Object actions", !1, ($) => e.openObjectContext($, g.id))), M.append(oe, k, U), M.title = s("Click to select · Double-click to toggle visibility · Right-click for actions");
        const V = ($ = {}) => {
          if ($.altKey && g.id !== "subject") return void e.deleteObject(g.id);
          ...
          else if ($.shiftKey && e.outlinerAnchorId && e.state.objects.some((j) => j.id === e.outlinerAnchorId)) {
            const j = e.state.objects.map((se) => se.id), W = j.indexOf(e.outlinerAnchorId), J = j.indexOf(g.id);
            e.selectedObjectIds = new Set(j.slice(Math.min(W, J), Math.max(W, J) + 1));
          } else
            e.selectedObjectIds = /* @__PURE__ */ new Set([g.id]), e.outlinerAnchorId = g.id;
          e.selectedObjectId = e.selectedObjectIds.has(g.id) ? g.id : [...e.selectedObjectIds].at(-1) || null, e.selectedEntity = e.selectedObjectIds.size ? "object" : "camera", e.selectedKeyFrame = e.selectedObjectId ? g.keyframes?.find((j) => j.frame === e.frame)?.frame ?? null : null, e.editingKeyFrame = null;
          for (const j of t.querySelectorAll(".scene-item")) {
            const W = !!(j.dataset.objectId && e.selectedObjectIds.has(j.dataset.objectId)), J = !!(j.dataset.objectId && j.dataset.objectId === e.selectedObjectId);
            j.classList.toggle("selected", W), j.classList.toggle("primary", J), j.dataset.objectId && j.setAttribute("aria-selected", String(W));
          }
          const G = e.root.querySelector('[data-role="outliner-batch-bar"]');
          if (G) {
            const j = e.selectedObjectIds?.size || 0;
            G.hidden = j < 2;
            const W = G.querySelector('[data-role="batch-count"]');
            W && (W.textContent = `${j} ${s("selected")}`);
          }
          e.refreshKeys(), e.refreshInspector(), e.render(), e.setStatus(s(`Selected: ${g.name || g.type}`));
        };
        M.addEventListener("dblclick", () => e.toggleObject(g.id)), M.addEventListener("contextmenu", ($) => {
          $.preventDefault(), $.stopPropagation(), e.openObjectContext($, g.id);
...
function Ub(e, t) {
  ...
  let b = [0, 0, 0], u = [0, 0, 0], v = "#8c929b", y, x, S, g;
  p ? (b = [5, 8.5, 4], u = [-55, 35, 0], v = "#fff6ec", y = 2.2, x = !0) : m ? (b = [0, 3, 0], v = "#ffffff", y = 2, x = !1) : f && (b = [0, 4, 0], u = [-60, 0, 0], v = "#ffffff", y = 3, S = 45, g = 0.25, x = !0);
  const C = {
    id: a,
    type: t,
    name: d,
  ...
  e.state.objects.push(C), e.selectedEntity = "object", e.selectedObjectId = a, e.selectedObjectIds = /* @__PURE__ */ new Set([a]), e.selectedKeyFrame = null, e.serialize(), e.refreshObjects(), e.refreshKeys(), e.render();
}
...
async function Ci(e, t) {
  ...
  const a = e.state.objects.find((o) => o.id === t);
  if (a && await Qt(e, s("Delete object"), s(`Delete ${a.name || a.type} and its ${(a.keyframes || []).length} keyframe(s)?`)) && !(e.disposed || !e.state.objects.includes(a))) {
...
function Yb(e) {
  const t = aa(e), a = e.root.querySelector('[data-role="object-panel"]');
  a && (a.hidden = !t);
  const o = (k) => e.root.querySelector(k), r = e.activeCameraTrack(), n = o('[data-role="camera-target-object"]');
  if (n) {
    const k = r.target_object_id || e.state.target_object_id || "", E = `T${mn()}${e.state.objects.map((z) => `${z.id}\0${z.name || z.type}`).join("|")}`;
    lr(n, E, () => [
      Ht("", s("Manual Target (No Tracking)")),
      ...e.state.objects.map((z) => Ht(z.id, `${s("Track:")} ${z.name || z.type}`))
    ], k);
  }
  Bb(e);
  const i = [...e.camera.position, ...e.camera.target, e.camera.fov, e.camera.roll || 0, e.camera.near, e.camera.far, ...Dr(e.camera)];
  ...
  for (const k of e.root.querySelectorAll('[data-role="camera-color"]'))
    document.activeElement !== k && (k.value = r?.color || "#4aa3ef");
  if (!t) {
    const k = o('[data-role="object-recon-badge"]');
    k && (k.hidden = !0);
    const E = o('[data-role="selected-name"]');
    E && (E.textContent = `${r.name} · F${e.frame}`), ns(o, {
  ...
  m && (m.textContent = t.name || t.type), ns(o, {
  ...
  const b = o('[data-role="animation-row"]'), u = o('[data-role="animation-select"]'), v = o('[data-role="object-parent"]');
  if (v) {
    ...
    const U = e.state.objects.filter(($) => !E.has($.id)), V = `P${mn()}${k}${U.map(($) => `${$.id} ${$.name || $.type}`).join("|")}`;
    lr(v, V, () => [
      Ht("", s("No parent")),
      ...U.map(($) => Ht($.id, $.name || $.type))
    ], t.parent_id || "");
  }
  ...
  g && (g.hidden = !x);
  const C = o('[data-role="material-row"]');
  C && (C.hidden = y);
  const M = o('[data-role="scale-row"]');
  M && (M.hidden = y);
  const R = o('[data-role="rotation-row"]');
  if (R && (R.hidden = t.type === "point_light"), y) {
    ...
    if (E && (E.checked = t.cast_shadow !== !1), x) {
      const z = o('[data-role="object-cone-angle"]');
      z && document.activeElement !== z && (z.value = String(t.cone_angle ?? 45));
      const U = o('[data-role="object-penumbra"]');
      U && document.activeElement !== U && (U.value = String(t.penumbra ?? 0.25));
    }
  }
  const F = e.modelInfoById.get(t.id);
  if (b && (b.hidden = !F?.animations), u) {
    const k = F?.animationNames || [];
    lr(u, `A${k.join("|")}`, () => k.map((E, z) => Ht(String(z), E)), String(t.animation_index || 0));
  }
  ...
  const X = o('[data-role="object-annotation-color"]');
  X && document.activeElement !== X && (X.value = t.annotation?.color || "#8d7ee8");
  const oe = o('[data-role="object-annotation-anchor"]');
  oe && document.activeElement !== oe && (oe.value = t.annotation?.anchor || "top"), e.rigMapper?.sync(), e.poseEditor?.sync(), e.motionEditor?.sync();
}
function Xb(e) {
  const t = aa(e);
  if (!t) return;
  ...
  if ((e.lastObjectNumericEditId !== t.id || !Number.isFinite(e.lastObjectNumericEditAt) || i - e.lastObjectNumericEditAt > 300) && e.checkpoint?.("Edit object"), e.lastObjectNumericEditId = t.id, e.lastObjectNumericEditAt = i, t.position = [a("object-x", o[0]), a("object-y", o[1]), a("object-z", o[2])], t.rotation = [a("object-rx", r[0]), a("object-ry", r[1]), a("object-rz", r[2])], t.size = [Math.max(0.01, a("object-sx", n[0])), Math.max(0.01, a("object-sy", n[1])), Math.max(0.01, a("object-sz", n[2]))], ["sun_light", "point_light", "spot_light"].includes(t.type)) {
    ...
    if (l && (t.cast_shadow = l.checked), t.type === "spot_light") {
      ...
      p && p.value !== "" && (t.cone_angle = te(Number(p.value) || 45, 1, 90));
      const m = e.root.querySelector('[data-role="object-penumbra"]');
      m && m.value !== "" && (t.penumbra = te(Number(m.value) || 0.25, 0, 1));
    }
  }
...
function Qb(e) {
  ...
  const a = (n, i) => {
    ...
    te(a("camera-rx", o[0]), -90, 90),
    a("camera-ry", o[1]),
    te(a("camera-rz", o[2]), -180, 180)
  ];
  e.beginCameraEdit(), rl(e.camera, r), e.commitCameraEdit(), e.finishCameraEdit(), Ti(e), Zb(e), e.render();
}
function eg(e) {
  const t = globalThis.performance?.now?.() ?? Date.now();
  (!Number.isFinite(e.lastCameraHudEditAt) || t - e.lastCameraHudEditAt > 300) && e.checkpoint("Edit camera"), e.lastCameraHudEditAt = t;
  ...
  e.camera.position = [a("camera-px", e.camera.position[0]), a("camera-py", e.camera.position[1]), a("camera-pz", e.camera.position[2])], e.camera.target = [a("camera-tx", e.camera.target[0]), a("camera-ty", e.camera.target[1]), a("camera-tz", e.camera.target[2])], e.camera.fov = te(a("camera-fov", e.camera.fov), 5, 150), e.camera.roll = te(a("camera-roll", e.camera.roll || 0), -180, 180), e.camera.near = Math.max(1e-4, a("camera-near", e.camera.near)), e.camera.far = Math.max(e.camera.near + 1e-4, a("camera-far", e.camera.far)), e.beginCameraEdit(), e.commitCameraEdit(), e.finishCameraEdit(), Ti(e), e.render();
}
function tg(e, t) {
  const a = aa(e);
  if (!a) return;
...
function og(e, t) {
  e.objectUrls.revoke(t), ta(e, t), e.modelUrlsById.delete(t), e.modelInfoById.delete(t), e.webgl?.removeModel(t);
}
function rg(e) {
  const t = [...e.selectedObjectIds?.size ? e.selectedObjectIds : [e.selectedObjectId]].filter((o) => o && e.state.objects.some((r) => r.id === o));
  if (!t.length) return [];
  if (t.length === 1)
    return Ei(e, t[0]), e.selectedObjectId ? [e.selectedObjectId] : [];
  ...
  return t.forEach((o, r) => {
    ...
    const c = 0.35 + r * 0.15;
    i.position = fe(i.position || [0, 0, 0], [c, 0, c]), (i.type === "model" || i.type === "glb") && e.modelUrlsById.has(n.id) ? e.modelUrlsById.set(i.id, e.modelUrlsById.get(n.id)) : i.type === "card" && e.cardMediaById.has(n.id) && nt(e, i.id, e.cardMediaById.get(n.id), !1, i.asset || e.cardMediaAssetById?.get?.(n.id) || ""), e.state.objects.push(i), a.push(i.id);
...
function lg(e, t) {
  return t(Cs(e), e.frame);
}
function Pe(e) {
  return e.selectedEntity === "object" && e.state.objects.find((t) => t.id === e.selectedObjectId) || null;
}
function Ae(e) {
  return Pe(e)?.keyframes || e.state.keyframes;
}
function dg(e, t) {
...
function mg(e) {
  ...
  const t = e.root.querySelector('[data-role="key-interp"]')?.value || e.root.querySelector('[data-role="interp"]')?.value || "ease", a = Pe(e), o = Ae(e), r = a ? { frame: e.frame, transform: Xe(a), interpolation: t } : { frame: e.frame, camera: le(e.camera), interpolation: t }, n = o.findIndex((i) => i.frame === e.frame);
...
function fg(e) {
  ...
  const o = Je(e) || a.find((i) => i.frame === e.frame);
...
function hg(e) {
  const t = Pe(e), a = Je(e) || Ae(e).find((o) => o.frame === e.frame);
  e.copiedKeyframe = t ? { kind: "object", transform: Xe(a?.transform || t), interpolation: a?.interpolation || e.root.querySelector('[data-role="interp"]')?.value || "ease" } : { kind: "camera", camera: le(a?.camera || e.camera), interpolation: a?.interpolation || e.root.querySelector('[data-role="interp"]')?.value || "ease" }, e.setStatus(s(`Keyframe copied @ ${a?.frame ?? e.frame}`));
}
function ug(e) {
  if (!e.copiedKeyframe) return e.setStatus(s("Copy a keyframe first"));
  const t = Pe(e), a = t ? "object" : "camera";
  if (e.copiedKeyframe.kind !== a) return e.setStatus(s(`Copy a ${a} keyframe first`));
  e.checkpoint("Paste keyframe");
  const o = t ? { frame: e.frame, transform: Xe(e.copiedKeyframe.transform), interpolation: e.copiedKeyframe.interpolation } : { frame: e.frame, camera: le(e.copiedKeyframe.camera), interpolation: e.copiedKeyframe.interpolation }, r = Ae(e), n = r.findIndex((i) => i.frame === e.frame);
...
function Je(e) {
  return Ae(e).find((t) => t.frame === e.selectedKeyFrame) || null;
}
function bg(e, t) {
  t && (e.selectedKeyFrame = t.frame, e.selectedKeyFrames = /* @__PURE__ */ new Set([t.frame]), e.editingKeyFrame = null, Pe(e) || (e.pathSelection = nl(e.pathSelection, { cameraId: e.state.active_camera_id, frame: t.frame, additive: !1 })), e.setFrame(t.frame));
}
function gg(e) {
...
const kg = ["guides", "safe-areas", "resolution-gate", "aspect-ratio"];
function Sg(e) {
...
function Eg(e) {
  ...
  t.hidden = !1;
  const o = Fb({ keys: a, fps: e.state?.fps || 24, objects: e.state?.objects || [] });
  if (!o.length) {
    const r = document.createElement("div");
...
function Cg(e) {
  const t = Pe(e), a = Je(e), o = e.root.querySelector('[data-role="key-editor"]');
  ...
  if (f) {
    const h = Math.max(1, e.state?.fps || 24), b = a ? a.frame : e.frame, u = Math.floor(b / h), v = b % Math.round(h), y = String(Math.floor(u / 3600)).padStart(2, "0"), x = String(Math.floor(u % 3600 / 60)).padStart(2, "0"), S = String(u % 60).padStart(2, "0"), g = String(v).padStart(2, "0");
    f.textContent = `${y}:${x}:${S}:${g} (${b}f)`;
  }
  if (Eg(e), !a) return;
  if (t) {
...
function Ag(e, t, a = !1, o = {}) {
  ...
  if (!r) return;
  const n = Ae(e);
  let i = te(Math.round(t), 0, e.state.duration_frames - 1);
...
function Tg(e) {
  const t = Je(e);
  if (!t) return;
  if (e.checkpoint("Edit keyframe"), e.editingKeyFrame = t.frame, Pe(e)) {
    t.interpolation = e.root.querySelector('[data-role="key-interp"]').value, t.transform = Xe(Pe(e)), e.serialize(), e.setFrame(t.frame), e.setStatus(s(`Object keyframe updated @ ${t.frame}`));
    return;
  }
  const a = (r, n) => {
  ...
  if (t.interpolation = e.root.querySelector('[data-role="key-interp"]').value, t.camera.position = [a("key-px", t.camera.position[0]), a("key-py", t.camera.position[1]), a("key-pz", t.camera.position[2])], t.camera.target = [a("key-tx", t.camera.target[0]), a("key-ty", t.camera.target[1]), a("key-tz", t.camera.target[2])], t.camera.fov = te(a("key-fov", t.camera.fov), 5, 150), t.camera.roll = te(a("key-roll", t.camera.roll || 0), -180, 180), t.camera.zoom = Math.max(0.01, a("key-zoom", t.camera.zoom || 1)), t.camera.near = Math.max(1e-4, a("key-near", t.camera.near)), t.camera.far = Math.max(t.camera.near + 1e-4, a("key-far", t.camera.far)), t.camera.camera_type = e.root.querySelector('[data-role="key-camera-type"]').value, e.root.querySelector('[data-role="key-timing-weight"]')) {
    const r = sl(t, a("key-timing-weight", _s(t)));
    r.timing ? t.timing = r.timing : delete t.timing;
  }
  e.camera = le(t.camera), e.frame = t.frame, e.serialize(), e.setFrame(t.frame), e.setStatus(s(`Keyframe updated @ ${t.frame}`));
}
function Mg(e) {
  const t = Je(e);
...
function Pg(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: b, syncActiveCameraTrack: u, syncFromWidgets: v, bindEditorEvents: y, activateCamera: x, addCamera: S, deleteCamera: g, drawPreviewOverlays: C, duplicateCamera: M, maximizeCameraPreview: R, refreshCameraPreviews: F, refreshCameraSelectors: Y, renameCamera: H, setPlayblastCamera: X, toggleCameraView: oe, captureRealtime: k, makePlayblast: E, uploadDirectorPlayblast: z, waitForMediaFrame: U, computeAudioPeaks: V, loadAudioFile: $, releaseAudio: G, stopPlay: j, togglePlay: W, applyCameraPreset: J, applyCameraShake: se, applyProxyPreset: ie, clearViewportBgImage: re, loadViewportBgFile: de, loadViewportBgSequence: ye, drawCameraPath: he, drawCard: ve, drawCube: xe, drawGrid: pe, drawHuman: Ie, drawLine3D: we, drawNull: ke, drawOverlays: be, drawPointField: L, drawSpeedHeatmap: q, drawSphere: me, curveChannels: Ee, drawCurveEditor: Le, onCurvePointerDown: qe, onCurvePointerMove: Ne, onCurvePointerUp: it, onTimelinePointerDown: oa, onTimelinePointerMove: ra, onTimelinePointerUp: na, refreshKeys: $t, resetCurveZoom: It, resetTimelineZoom: bt, setChannelFilter: Ot, setCurveInterpolation: Pt, setTangentMode: Lt, timelineFrameFromEvent: sa, toggleCurveHandles: Nt, zoomCurve: ia, drawTransformGizmo: ca, frameTarget: la, gizmoAxes: da, gizmoGeometry: ma, onPointerDown: pa, onPointerMove: fa, onPointerUp: ha, onWheel: ua, pickGizmo: ba, pickSceneObject: ga, resetCamera: Ft, setTransformMode: zt, setViewMode: ya, viewportCamera: va, loadCardFile: Go, loadExecutionPreview: Yo, loadMediaUrl: xa, loadModelFile: wa, loadSelectedReference: ka, onModelLoaded: Sa, restoreAssets: _a, syncUpstreamInputs: ja, configureDomMedia: Ea, refreshSetupDiagnostic: Rt, addMediaCard: Ca, addPrimitive: Aa, applyObjectAnimationFrame: Ta, beginCameraEdit: Ma, beginObjectEdit: $a, commitCameraEdit: Ia, commitObjectEdit: Oa, copyKeyframe: Pa, deleteKeyframe: La, deleteObject: Na, duplicateObject: Fa, exitKeyEdit: za, finishCameraEdit: Ra, goToAdjacentKey: Da, insertKeyframe: Ka, loadSelectedKeyView: Ba, pasteKeyframe: qa, playblastCameraAtFrame: Ua, refreshInspector: Wa, refreshKeyEditor: Va, refreshObjects: Ha, removeObjectResources: Ga, renameObject: Ya, retimeSelectedKey: Xa, selectKeyframe: Ja, selectedKeyframe: Za, selectedObject: Qa, selectObjectAnimation: eo, setKeyInterpolation: to, setObjectParent: ao, timelineKeyframes: oo, timelineObject: ct, toggleAutoKey: ro, toggleObject: no, updateCameraFromHud: so, updateEditState: io, updateKeyVisualState: co, updateSelectedKey: lo, updateSelectedObject: mo, clamp: Dt, cloneCamera: po, configureCore: fo, defaultCamera: ho, sampleCamera: Ze, sampleObjectTransform: Xo, sanitizeState: gt, worldTransform: Fe } = e;
  return {
    setSelectMode(N) {
      if (["object", "vertex", "edge", "face"].includes(N)) {
        this.state.select_mode = N, this.subSelection = null;
        for (const P of this.root.querySelectorAll("[data-select-mode]")) {
          const _ = P.dataset.selectMode === N;
          P.classList.toggle("active", _), P.setAttribute("aria-pressed", String(_));
        }
        for (const P of this.root.querySelectorAll('[data-role="select-mode"]'))
          P.value = N;
        this.serialize(), this.syncFromWidgets(), this.render(), this.setStatus(`Select Mode: ${N.toUpperCase()}`);
      }
    },
    ...
    hideInternalWidgets() {
      for (const N of ["state_json", "recording_path", "card_asset"]) {
        const P = this.node.widgets?.find((_) => _.name === N);
        P && (P.computeSize = () => [0, -4], P.draw = () => {
        }, P.hidden = !0, P.options = { ...P.options || {}, hideInVueNodes: !0 });
      }
    },
    restoreFromWidgets() {
      h(this);
    },
    restoreHistorySnapshot(N) {
      ...
      const _ = ss(this.state), w = new Set(this.state.objects.map((Q) => Q.id));
      this.state = gt(P.state);
      const A = new Set(this.state.objects.map((Q) => Q.id));
      for (const Q of w) A.has(Q) || this.removeObjectResources(Q);
      this.frame = Dt(P.frame, 0, this.state.duration_frames - 1);
      const I = new Set(this.state.objects.map((Q) => Q.id)), K = Array.isArray(P.selectedObjectIds) ? P.selectedObjectIds : [P.selectedObjectId].filter(Boolean);
      this.selectedObjectIds = new Set(K.filter((Q) => I.has(Q))), this.selectedObjectId = this.selectedObjectIds.has(P.selectedObjectId) ? P.selectedObjectId : [...this.selectedObjectIds].at(-1) || null, this.selectedEntity = this.selectedObjectIds.size ? "object" : P.selectedEntity || "camera";
      const Z = new Set(this.timelineKeyframes().map((Q) => Q.frame)), D = Array.isArray(P.selectedKeyFrames) ? P.selectedKeyFrames : [P.selectedKeyFrame].filter((Q) => Q != null);
      this.selectedKeyFrames = new Set(D.filter((Q) => Z.has(Q))), this.selectedKeyFrame = this.selectedKeyFrames.has(P.selectedKeyFrame) ? P.selectedKeyFrame : [...this.selectedKeyFrames].at(-1) ?? null, this.pathSelection = il(this.pathSelection, this.activeCameraTrack()), this.subSelection = P.subSelection || null, this.camera = Ze(this.state, this.frame), Yt(this, this.activeCameraTrack(), this.camera, this.frame), this.cameraPreviewSignature = "", this.serialize(), _ !== ss(this.state) && this.restoreAssets(), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
    },
    checkpoint(N) {
      this.history.checkpoint(N);
    },
    undo() {
      const N = this.history.undo();
      N && this.setStatus(`Undo: ${N}`);
    },
    redo() {
      const N = this.history.redo();
      N && this.setStatus(`Redo: ${N}`);
    },
    bindEditorEvents() {
      y(this);
    },
    ...
    async renameCamera(N) {
      return H(this, N);
    },
    duplicateCamera(N) {
      M(this, N);
    },
    async deleteCamera(N) {
      return g(this, N);
    },
    activateCamera(N) {
      x(this, N);
    },
    setPlayblastCamera(N) {
      X(this, N);
    },
    closeMenus(N = null) {
      for (const P of this.root.querySelectorAll(".toolbar-menu")) P !== N && (P.open = !1);
    ...
    showContextMenu(N, P, _) {
      return this.contextMenu.show(N, P, _);
    },
    onContextMenu(N) {
      if (N.preventDefault(), N.stopPropagation(), N.stopImmediatePropagation?.(), N.altKey || this.state.navigation_profile === "simple" && N.target?.closest?.(".viewport-wrap")) return;
      const P = N.target, _ = P.closest?.(".camera-preview-tile"), w = P.closest?.(".scene-item"), A = P.closest?.(".key");
      if (_) return this.openCameraContext(N, _.dataset.cameraId, !0);
      if (w?.dataset.cameraId) return this.openCameraContext(N, w.dataset.cameraId, !1);
      if (w?.dataset.objectId) return this.openObjectContext(N, w.dataset.objectId);
      if (A) {
        const I = this.timelineKeyframes().find((K) => K.frame === Number(A.dataset.keyFrame));
        return I && this.selectKeyframe(I), this.openTimelineContext(N, !0);
      }
      if (P.closest?.('[data-role="keys"]'))
        return this.setFrame(this.timelineFrameFromEvent(N, P.closest('[data-role="keys"]'))), this.openTimelineContext(N, !1);
      if (P.closest?.(".curve-editor")) return this.openCurveContext(N);
      if (P.closest?.(".viewport-wrap")) {
        const I = this.interactionElement.getBoundingClientRect(), K = (N.clientX - I.left) * this.canvas.width / Math.max(1, I.width), Z = (N.clientY - I.top) * this.canvas.height / Math.max(1, I.height), D = this.pickSceneObject([K, Z]);
        if (D) {
          if ((D.type === "object" || D.type === "object_keyframe") && D.object)
            return this.selectedEntity = "object", this.selectedObjectId = D.object.id, D.keyframe ? (this.setFrame(D.keyframe.frame), this.selectedKeyFrame = D.keyframe.frame) : this.selectedKeyFrame = D.object.keyframes?.find((Q) => Q.frame === this.frame)?.frame ?? null, this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), this.openObjectContext(N, D.object.id);
          if (["camera", "camera_target", "camera_keyframe"].includes(D.type) && D.camera)
            return this.selectedEntity = D.type === "camera_target" ? "camera_target" : "camera", this.selectedObjectId = null, this.activateCamera(D.camera.id), D.keyframe && (this.setFrame(D.keyframe.frame), this.selectedKeyFrame = D.keyframe.frame), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), D.type === "camera_keyframe" && D.keyframe ? this.openPathKeyContext(N, D.camera.id, D.keyframe.frame) : this.openCameraContext(N, D.camera.id, !1);
        }
        return this.openViewportContext(N);
      }
    },
    openViewportContext(N) {
      const P = this.selectedObject();
      this.showContextMenu(N, s("Viewport"), [
        {
          label: P ? `${s("Set key")} · ${P.name || P.type}` : `${s("Set key")} · ${this.activeCameraTrack().name}`,
          icon: "pi-key",
          shortcut: "I",
          run: () => this.insertKeyframe()
        },
        { label: s("Frame subject"), icon: "pi-search", shortcut: "F", run: () => this.frameTarget() },
        { label: s("Set camera target here"), icon: "pi-bullseye", help: s("Set camera Look-At target to this 3D point in the scene"), run: () => this.setTargetAtCursor(N) },
        null,
        {
          label: s("Add object"),
          icon: "pi-plus-circle",
    ...
    openObjectContext(N, P) {
      const _ = this.state.objects.find((I) => I.id === P);
      if (!_) return;
      this.selectedEntity = "object", this.selectedObjectId = P, this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
      const w = ["sun_light", "point_light", "spot_light"].includes(_.type), A = this.selectedObjectIds?.size || 0;
      if (A >= 2 && this.selectedObjectIds.has(P)) {
        this.showContextMenu(N, `${A} ${s("objects selected")}`, [
          { label: s("Duplicate {count} objects").replace("{count}", String(A)), icon: "pi-copy", shortcut: "Shift+D", run: () => this.duplicateSelectedObjects() },
          ...
          { label: s("Delete {count} objects").replace("{count}", String(A)), icon: "pi-trash", danger: !0, shortcut: "Del", run: () => this.deleteSelectedObjects() },
          null,
          { label: s("Deselect all"), icon: "pi-times", shortcut: "Alt+A", run: () => this.deselectAll() }
        ]);
        return;
      }
      this.showContextMenu(N, _.name || _.type, [
        { label: s("Set key"), icon: "pi-key", shortcut: "I", run: () => this.insertKeyframe() },
        { label: s("Frame subject"), icon: "pi-search", shortcut: "F", run: () => this.frameTarget() },
        { label: s("Rename object…"), icon: "pi-pencil", run: () => this.renameObject(P) },
        { label: s("Duplicate object"), icon: "pi-copy", run: () => this.duplicateObject(P) },
        { label: _.enabled === !1 ? s("Show object") : s("Hide object"), icon: _.enabled === !1 ? "pi-eye" : "pi-eye-slash", run: () => this.toggleObject(P) },
        { label: _.locked ? s("Unlock object") : s("Lock object"), icon: _.locked ? "pi-lock" : "pi-lock-open", run: () => Jr(this, _) },
        null,
        {
          label: s("Transform mode"),
          icon: "pi-arrows-alt",
        ...
        },
        {
          ...
          icon: "pi-bullseye",
          items: [
            { label: s("Camera tracks this object (Look-At)"), icon: "pi-bullseye", help: s("Lock camera live look-at tracking to this moving object"), run: () => this.aimAtSelectedObject(P) },
            ...
            null,
            { label: s("Select hierarchy"), icon: "pi-sitemap", shortcut: "Shift+G", help: s("Select this object and all descendants"), run: () => this.selectHierarchy(P) }
          ]
        },
        ...w ? [
          {
            ...
            items: [
              {
                label: s("Shadow"),
                icon: "pi-circle-fill",
                checked: _.cast_shadow !== !1,
                run: () => {
                  this.checkpoint("Toggle light shadow"), _.cast_shadow = _.cast_shadow === !1, this.serialize(), this.refreshInspector(), this.render();
                }
              }
            ]
          }
        ...
        null,
        { label: s("Reset entire animation"), icon: "pi-replay", danger: !0, help: s("Delete every animation key and return position/rotation to zero"), run: () => this.resetObjectAnimation(P) },
        null,
        { label: s("Delete object"), icon: "pi-trash", danger: !0, disabled: P === "subject", help: P === "subject" ? s("The canonical subject card cannot be deleted") : s("Delete this object and its animation keys"), run: () => this.deleteObject(P) }
      ]);
    },
    openCameraContext(N, P, _ = !1) {
      const w = this.state.cameras.find((A) => A.id === P);
      w && (this.selectedEntity = "camera", this.selectedObjectId = null, this.activateCamera(P), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), this.showContextMenu(N, `${w.name}${_ ? " preview" : ""}`, [
        { label: s("Edit this camera"), icon: "pi-video", run: () => this.activateCamera(P) },
        {
          label: s("Select whole path — move / scale / rotate"),
          icon: "pi-arrows-alt",
          disabled: (w.keyframes || []).length < 1,
          run: () => {
            this.activateCamera(P), this.selectCameraPath() && this.setStatus(`${w.name} · ${s("whole path selected — move / scale / rotate")}`);
          }
        },
        { label: s("Set as primary / playblast"), icon: "pi-star", disabled: P === this.state.playblast_camera_id, run: () => this.setPlayblastCamera(P) },
        { label: s("Set key at playhead"), icon: "pi-key", shortcut: "I", run: () => {
          this.activateCamera(P), this.insertKeyframe();
        } },
        { label: s("Record this preview"), icon: "pi-circle-fill", run: () => {
          this.setPlayblastCamera(P), this.makePlayblast();
        } },
        { label: this.state.maximized_camera_id === P ? s("Restore preview size") : s("Maximize preview"), icon: "pi-window-maximize", run: () => this.maximizeCameraPreview(P) },
        null,
        {
          label: s("Shot order & handles"),
          icon: "pi-sliders-h",
          items: [
            { label: s("Shot: move earlier"), icon: "pi-arrow-up", disabled: this.state.cameras.findIndex((A) => A.id === P) <= 0, run: () => this.moveShot(P, -1) },
            { label: s("Shot: move later"), icon: "pi-arrow-down", disabled: this.state.cameras.findIndex((A) => A.id === P) >= this.state.cameras.length - 1, run: () => this.moveShot(P, 1) },
            null,
            { label: s("Shot handles…"), icon: "pi-sliders-h", run: () => this.editShotHandles(P) }
          ]
        },
        null,
        { label: s("Rename camera…"), icon: "pi-pencil", run: () => this.renameCamera(P) },
        { label: s("Duplicate camera"), icon: "pi-copy", run: () => this.duplicateCamera(P) },
        { label: s("Create camera from current view"), icon: "pi-plus", run: () => this.addCamera() },
        null,
        { label: s("Reset entire animation"), icon: "pi-replay", danger: !0, help: s("Delete every camera key and return to a static zero pose at frame 0"), run: () => this.resetCameraAnimation(P) },
        null,
        { label: s("Delete camera"), icon: "pi-trash", danger: !0, disabled: this.state.cameras.length <= 1, run: () => this.deleteCamera(P) }
      ]));
    },
    openPathKeyContext(N, P, _) {
      const w = this.state.cameras.find((Q) => Q.id === P);
      if (!w) return;
      this.selectedEntity = "camera", this.selectedObjectId = null, this.activateCamera(P);
      const A = (w.keyframes || []).find((Q) => Q.frame === _) || null;
      A && this.selectKeyframe(A), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
      const I = A ? ft(A) : "auto", K = this.selectedKeyFrames?.size || 0, Z = this.pathSelection?.component === "target", D = Pr(w, this.state.objects);
      this.showContextMenu(N, `Path key F${_}`, [
        ...
        null,
        {
          ...
          icon: "pi-bullseye",
          help: D ? s("Driven by Look At -- target editing is disabled") : void 0,
          items: [
        ...
        },
        {
          ...
          icon: "pi-sliders-v",
          items: dr(this, i, t, ct)
        },
        null,
        {
          label: K >= 2 ? s("Delete {count} keys").replace("{count}", String(K)) : s("Delete key"),
          icon: "pi-trash",
          danger: !0,
          disabled: (w.keyframes || []).length <= 1,
    ...
    moveShot(N, P) {
      const _ = this.state.cameras.findIndex((I) => I.id === N), w = _ + P;
      if (_ < 0 || w < 0 || w >= this.state.cameras.length) return;
      this.checkpoint("Reorder shot");
      const [A] = this.state.cameras.splice(_, 1);
      this.state.cameras.splice(w, 0, A), this.cameraPreviewSignature = "", this.serialize(), this.refreshObjects(), this.refreshKeys(), this.renderCameraView(), this.setStatus(`Shot order: ${A.name} → #${w + 1}`);
    },
    async editShotHandles(N) {
      const P = this.state.cameras.find((I) => I.id === N);
      if (!P) return;
      const _ = P.handles || { in: 0, out: 0 }, w = await i(t, s("Shot handles…"), "Handle frames: in,out", `${_.in},${_.out}`);
      if (w == null) return;
      const A = String(w).match(/^\s*(\d+)\s*[,;\s]\s*(\d+)\s*$/);
      if (!A) return this.setStatus("Handles must be two integers: in,out");
      this.checkpoint("Shot handles"), P.handles = { in: Math.min(600, Number(A[1])), out: Math.min(600, Number(A[2])) }, this.serialize(), this.setStatus(`${P.name} handles: ${P.handles.in} / ${P.handles.out}`);
    },
    openTimelineContext(N, P) {
      const _ = this.selectedKeyFrames?.size || 0, w = this.selectedKeyframe(), A = w?.interpolation || "ease", I = w && ft(w) || "auto", K = ["ease", "linear", "bezier", "smooth", "ease_in", "ease_out", "sine", "cubic", "quintic", "expo", "back"], Z = ["auto", "clamped", "vector", "free", "aligned", "flat"];
      this.showContextMenu(N, P ? `Keyframe F${this.selectedKeyFrame}` : `Timeline F${this.frame}`, [
        { label: s("Fit timeline view (F)"), icon: "pi-arrows-alt", shortcut: "F", run: () => bt(this) },
        ...
        null,
        {
          label: _ >= 2 ? s("Delete {count} keys").replace("{count}", String(_)) : s("Delete selected key"),
          icon: "pi-trash",
          shortcut: "Delete",
          danger: !0,
          disabled: _ < 2 && !w,
    ...
    addMarker() {
      if ((this.state.markers || []).find((P) => P.frame === this.frame)) return this.setStatus(`Marker already at F${this.frame}`);
      this.checkpoint("Add marker"), this.state.markers = [...this.state.markers || [], { frame: this.frame, name: `Marker ${(this.state.markers || []).length + 1}`, color: "#f2d06b" }].sort((P, _) => P.frame - _.frame), this.serialize(), this.refreshKeys(), this.setStatus(`Marker @ F${this.frame}`);
    },
    removeNearestMarker() {
      const N = this.state.markers || [];
      if (!N.length) return;
      const P = N.reduce((_, w) => Math.abs(w.frame - this.frame) < Math.abs(_.frame - this.frame) ? w : _);
      this.checkpoint("Remove marker"), this.state.markers = N.filter((_) => _ !== P), this.serialize(), this.refreshKeys(), this.setStatus(`Marker removed @ F${P.frame}`);
    },
    openCurveContext(N) {
      const P = this.selectedKeyFrames?.size || 0, _ = P < 2 && !this.selectedKeyframe(), w = this.selectedKeyframe(), A = w?.interpolation || "ease", I = w && ft(w) || "auto", K = ["bezier", "smooth", "linear", "ease_in", "ease_out", "ease", "sine", "cubic", "quintic", "expo", "back"], Z = ["auto", "clamped", "vector", "free", "aligned", "flat"];
      this.showContextMenu(N, s("Curve editor"), [
        { label: s("Fit all curves (Framing)"), icon: "pi-arrows-alt", shortcut: "F", run: () => It(this) },
        { label: s("Set key at playhead"), icon: "pi-key", shortcut: "I", run: () => this.insertKeyframe() },
        ...
        null,
        { label: P >= 2 ? s("Delete {count} keys").replace("{count}", String(P)) : s("Delete selected key"), icon: "pi-trash", danger: !0, disabled: _, run: () => this.deleteSelectedKeyframes() }
      ]);
    },
    ...
    refitNode() {
      ...
      const N = this.node;
      try {
        if (N && typeof N.computeSize == "function" && typeof N.setSize == "function") {
          const P = N.computeSize();
          Array.isArray(P) && N.setSize([N.size?.[0] ?? P[0], P[1]]);
        }
        N?.graph?.setDirtyCanvas?.(!0, !0);
      } catch {
      }
      this.scheduleResizeAndRender();
    },
    resizeCanvas() {
      const N = this.root.querySelector(".viewport-wrap");
      if (!N) return;
      const P = Math.min(2, window.devicePixelRatio || 1), _ = N.clientWidth || 320, w = N.clientHeight || 180, A = Math.max(320, Math.round(_ * P)), I = Math.max(180, Math.round(w * P));
      (this.canvas.width !== A || this.canvas.height !== I) && (this.canvas.width = A, this.canvas.height = I);
      for (const K of this.cameraPreviewCanvases.values()) {
        const Z = K.clientWidth || 220, D = K.clientHeight || 124, Q = Math.max(P, Og / Math.max(1, Z)), _e = Math.max(1, Math.round(Z * Q)), Ue = Math.max(1, Math.round(D * Q));
        (K.width !== _e || K.height !== Ue) && (K.width = _e, K.height = Ue);
      }
...
function Lg(e, t) {
  ...
  const o = Ir();
  o.position = [0, 0, 0], o.target = [0, 0, -1], a.camera = le(o), a.keyframes = [{ frame: 0, camera: le(o), interpolation: "ease" }], e.state.active_camera_id = a.id, e.state.camera = le(o), e.state.keyframes = a.keyframes, e.camera = le(o), e.frame = 0, e.selectedEntity = "camera", e.selectedObjectId = null, e.selectedKeyFrame = 0, e.editingKeyFrame = null, e.cameraEditKey = null, e.cameraEditActive = !1, e.cameraPreviewSignature = "", $i(e), e.refreshCameraSelectors(), e.setStatus(s(`${a.name} animation reset`));
}
function Ng(e, t) {
  const a = e.state.objects.find((o) => o.id === t);
  a && (e.checkpoint("Reset object animation"), a.keyframes = [], a.position = [0, 0, 0], a.rotation = [0, 0, 0], e.frame = 0, e.selectedEntity = "object", e.selectedObjectId = a.id, e.selectedKeyFrame = null, e.editingKeyFrame = null, $i(e), e.setStatus(s(`${a.name || a.type} animation reset`)));
}
const is = { motion: "motion", shot: "display", health: "health" }, Fg = {
  object: "Object",
  camera: "Camera",
  camera_target: "Look-At Target",
  camera_path: "Camera Path"
}, zg = { motion: "Motion", shot: "Shot", health: "Health" }, Rg = ["entity", "motion", "shot", "health"];
function Ii(e) {
  return e.inspectorMode && e.inspectorMode !== "entity" ? e.inspectorMode : "entity";
}
function Dg(e) {
  const t = Ii(e);
  return is[t] ? is[t] : e.selectedEntity === "object" ? "scene" : "camera";
}
function Kg(e) {
  return [
    e.selectedEntity || "",
...
function Bg(e) {
  const t = Kg(e);
  e._lastInspectorSelKey !== void 0 && e._lastInspectorSelKey !== t && (e.inspectorMode = "entity"), e._lastInspectorSelKey = t, Oi(e);
}
function Oi(e) {
  const t = Dg(e);
  ...
  r && (r.textContent = o === "entity" ? s(Fg[e.selectedEntity] || "Inspector") : s(zg[o] || "Inspector"));
}
function qg(e, t) {
  e.inspectorMode = Rg.includes(t) ? t : "entity", Oi(e), e.render?.(), e.refitNode?.();
}
function Ug(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: b, syncActiveCameraTrack: u, syncFromWidgets: v, bindEditorEvents: y, activateCamera: x, addCamera: S, deleteCamera: g, drawPreviewOverlays: C, duplicateCamera: M, maximizeCameraPreview: R, refreshCameraPreviews: F, refreshCameraSelectors: Y, renameCamera: H, setPlayblastCamera: X, toggleCameraView: oe, captureRealtime: k, makePlayblast: E, uploadDirectorPlayblast: z, waitForMediaFrame: U, computeAudioPeaks: V, loadAudioFile: $, releaseAudio: G, stopPlay: j, togglePlay: W, applyCameraPreset: J, applyCameraShake: se, applyProxyPreset: ie, clearViewportBgImage: re, loadViewportBgFile: de, loadViewportBgSequence: ye, drawCameraPath: he, drawCard: ve, drawCube: xe, drawGrid: pe, drawHuman: Ie, drawLine3D: we, drawNull: ke, drawOverlays: be, drawPointField: L, drawSpeedHeatmap: q, drawSphere: me, curveChannels: Ee, drawCurveEditor: Le, onCurvePointerDown: qe, onCurvePointerMove: Ne, onCurvePointerUp: it, onTimelinePointerDown: oa, onTimelinePointerMove: ra, onTimelinePointerUp: na, refreshKeys: $t, resetCurveZoom: It, resetTimelineZoom: bt, setChannelFilter: Ot, setCurveInterpolation: Pt, setTangentMode: Lt, timelineFrameFromEvent: sa, toggleCurveHandles: Nt, zoomCurve: ia, drawTransformGizmo: ca, frameTarget: la, gizmoAxes: da, gizmoGeometry: ma, onPointerDown: pa, onPointerMove: fa, onPointerUp: ha, onWheel: ua, pickGizmo: ba, pickSceneObject: ga, resetCamera: Ft, setTransformMode: zt, setViewMode: ya, viewportCamera: va, loadCardFile: Go, loadExecutionPreview: Yo, loadMediaUrl: xa, loadModelFile: wa, loadSelectedReference: ka, onModelLoaded: Sa, restoreAssets: _a, syncUpstreamInputs: ja, configureDomMedia: Ea, refreshSetupDiagnostic: Rt, addMediaCard: Ca, addPrimitive: Aa, applyObjectAnimationFrame: Ta, beginCameraEdit: Ma, beginObjectEdit: $a, commitCameraEdit: Ia, commitObjectEdit: Oa, copyKeyframe: Pa, deleteKeyframe: La, deleteObject: Na, deleteSelectedObjects: Fa, duplicateObject: za, exitKeyEdit: Ra, finishCameraEdit: Da, goToAdjacentKey: Ka, insertKeyframe: Ba, loadSelectedKeyView: qa, pasteKeyframe: Ua, playblastCameraAtFrame: Wa, refreshInspector: Va, refreshKeyEditor: Ha, refreshObjects: Ga, removeObjectResources: Ya, renameObject: Xa, retimeSelectedKey: Ja, selectKeyframe: Za, selectedKeyframe: Qa, selectedObject: eo, selectObjectAnimation: to, setKeyInterpolation: ao, setKeyTangentMode: oo, setObjectParent: ct, timelineKeyframes: ro, timelineObject: no, toggleAutoKey: so, toggleObject: io, updateCameraFromHud: co, updateCameraRotationFromHud: lo, updateEditState: mo, updateKeyVisualState: Dt, updateSelectedKey: po, updateSelectedObject: fo, clamp: ho, cloneCamera: Ze, configureCore: Xo, defaultCamera: gt, sampleCamera: Fe, sampleObjectTransform: N, sanitizeState: P, worldTransform: _ } = e;
  return {
    setChannelFilter(w) {
      Ot(this, w);
    },
    setFrame(w, A = !1, I = !0) {
      this.frame = ho(Math.round(w), 0, this.state.duration_frames - 1), this.editingKeyFrame !== this.frame && (this.editingKeyFrame = null), this.camera = Fe(this.activeCameraTrack(), this.frame, this.state.objects), Yt(this, this.activeCameraTrack(), this.camera, this.frame), this.applyObjectAnimationFrame();
      const K = this.dom ||= oi(this.root);
      for (const ae of K.frames) document.activeElement !== ae && (ae.value = String(this.frame));
      for (const ae of K.scrubs) ae.value = String(this.frame);
      for (const ae of K.cameraFov) document.activeElement !== ae && (ae.value = String(Math.round(this.camera.fov * 100) / 100));
      for (const ae of K.cameraRoll) document.activeElement !== ae && (ae.value = String(Math.round((this.camera.roll || 0) * 100) / 100));
      for (const ae of K.cameraFocal) document.activeElement !== ae && (ae.value = Kr(this.camera.fov));
      for (const ae of K.viewportZoom) ae.textContent = `${(Number(this.camera.zoom) || 1).toFixed(2)}x`;
      for (const ae of K.cameraType) document.activeElement !== ae && (ae.value = this.camera.camera_type || "perspective");
      for (const ae of K.cameraNear) document.activeElement !== ae && (ae.value = String(this.camera.near ?? 0.01));
      for (const ae of K.cameraFar) document.activeElement !== ae && (ae.value = String(this.camera.far ?? 1e4));
      ...
      const D = Math.floor(Z / 60), Q = Math.floor(Z % 60), _e = Math.floor(Z % 1 * 1e3), Ue = this.frame % Math.max(1, Math.round(this.state.fps)), lt = Math.floor(this.frame / this.state.fps);
      if ((K.time || this.root.querySelector('[data-role="time"]')).textContent = this.state.timecode_mode === "timecode" ? `${String(Math.floor(lt / 3600)).padStart(2, "0")}:${String(Math.floor(lt / 60) % 60).padStart(2, "0")}:${String(lt % 60).padStart(2, "0")}:${String(Ue).padStart(2, "0")}` : `${String(D).padStart(2, "0")}:${String(Q).padStart(2, "0")}.${String(_e).padStart(3, "0")}`, I) this.refreshKeys();
      else {
        Oo(this);
      ...
      A || this.serialize(), this.refreshInspector(), A && this.playing && !this.recording ? this.requestRender("frame") : this.render();
    },
    timelineObject() {
      return no(this);
    },
    ...
    activeKeyframe() {
      return (this.activeCameraTrack()?.keyframes || []).find((A) => A.frame === this.frame) || null;
    },
    ...
    setSpatialHandleMode(w) {
      if (!Vo.includes(w)) return;
      const I = this.activeCameraTrack()?.keyframes || [], K = I.findIndex((Z) => Z.frame === this.selectedKeyFrame);
      if (K < 0) {
        this.setStatus(s("Select a camera keyframe first"));
        return;
      }
      this.checkpoint(s("Camera path handle: {mode}").replace("{mode}", w)), Np(I[K], w, {
        prevKey: I[K - 1] || null,
        nextKey: I[K + 1] || null
    ...
    setPathSelectionComponent(w) {
      this.pathSelection = ll(this.pathSelection, w), this.refreshInspector(), this.render();
    },
    ...
    insertPathKeyAtCursor(w) {
      ...
      const A = this.interactionElement.getBoundingClientRect(), I = (w.clientX - A.left) * this.canvas.width / Math.max(1, A.width), K = (w.clientY - A.top) * this.canvas.height / Math.max(1, A.height), Z = this.webgl.pickPathSegment([I, K]);
      if (!Z) return !1;
      const D = (this.state.cameras || []).find((_e) => _e.id === Z.cameraId);
      if (!D || D.locked) return !1;
      const Q = Qs(D.keyframes || [], {
        leftFrame: Z.leftFrame,
        rightFrame: Z.rightFrame,
        t: Z.t
      });
      return Q.ok ? (this.checkpoint(s("Insert camera path key")), D.id !== this.state.active_camera_id && this.activateCamera(D.id), D.keyframes = Q.keys, this.state.keyframes = Q.keys, this.camera = Fe(D, this.frame, this.state.objects), D.camera = Ze(this.camera), cl(this, { cameraId: D.id, frame: Q.frame, additive: !1 }), this.serialize(), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), this.setStatus(s("Camera path key inserted at frame {frame}").replace("{frame}", String(Q.frame))), !0) : (this.setStatus(Q.reason === "no_free_frame" ? s("No free frame here to insert a key") : s("Could not insert a key here")), !0);
    },
    ...
    transformCameraPath(w) {
      ...
      if (!A || A.locked || !(A.keyframes?.length >= 1)) return !1;
      this.checkpoint("Transform camera path");
      const I = ws(A.keyframes, { origin: Or(A.keyframes), ...w });
      return A.keyframes = I, A.id === this.state.active_camera_id && (this.state.keyframes = I), this.camera = Fe(A, this.frame, this.state.objects), A.camera = Ze(this.camera), this.serialize(), this.refreshKeys(), this.refreshInspector(), this.render(), this.renderCameraView?.(), !0;
    },
    ...
    redistributeActiveCameraTiming() {
      ...
      const A = [...w.keyframes].sort((K, Z) => K.frame - Z.frame), I = ps(A, {
        startFrame: A[0].frame,
        endFrame: A[A.length - 1].frame
      });
      return I.ok ? (this.checkpoint(s("Redistribute camera path timing")), w.keyframes = I.keys, w.id === this.state.active_camera_id && (this.state.keyframes = I.keys), this.camera = Fe(w, this.frame, this.state.objects), w.camera = Ze(this.camera), this.serialize(), this.refreshKeys(), this.refreshKeyEditor(), this.refreshInspector(), this.render(), this.setStatus(s("Camera path timing redistributed")), !0) : (this.setStatus(I.reason === "insufficient_frame_slots" ? s("Not enough frame slots to redistribute this many keys") : s("Could not redistribute timing")), !1);
    },
    ...
    async openCameraPathPresetPicker() {
      ...
      const A = Po.map((K) => ({ id: K, label: s(_n[K] || K) })), I = await Es({ title: s("Camera Path Preset"), items: A, owner: this });
      return I ? this.applyCameraPathPreset(I) : !1;
    },
    applyCameraPathPreset(w, A = {}) {
      const I = this.activeCameraTrack();
      if (!I || I.locked)
        return this.setStatus(s("{name} is locked").replace("{name}", I?.name || s("Camera"))), !1;
      const [K, Z] = Ar(this.state), D = Hs({ type: w, camera: this.camera, startFrame: K, endFrame: Z, params: A });
      return D.ok ? (this.checkpoint(s("Apply camera path preset")), I.keyframes = D.keyframes, I.id === this.state.active_camera_id && (this.state.keyframes = D.keyframes), this.camera = Fe(I, this.frame, this.state.objects), I.camera = Ze(this.camera), this.serialize(), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), this.setStatus(s("{preset} camera path generated").replace("{preset}", s(_n[w] || w))), !0) : (this.setStatus(D.reason === "insufficient_frame_slots" ? s("Not enough frames in the playback range for this preset") : s("Could not generate that camera path preset")), !1);
    },
    toggleCurveHandles() {
      Nt(this);
    },
    ...
    toggleInspector(w) {
      const A = this.root.querySelector('[data-role="viewport-inspector"]');
      if (!A) return;
      const I = w !== void 0 ? w : A.dataset.collapsed !== "true";
      A.dataset.collapsed = String(I);
      for (const K of this.root.querySelectorAll('[data-act="toggle-inspector"]'))
        K.classList.toggle("active", !I), K.setAttribute("aria-pressed", String(!I));
    ...
    showAllObjects() {
      const w = this.state.objects.filter((A) => A.enabled === !1);
      if (w.length) {
        this.checkpoint("Show all objects");
        for (const A of w) A.enabled = !0;
    ...
    selectHierarchy(w = this.selectedObjectId) {
      ...
      for (; I; ) {
        ...
        for (const K of this.state.objects)
          K.parent_id && A.has(K.parent_id) && !A.has(K.id) && (A.add(K.id), I = !0);
      }
      this.selectedObjectIds = A, this.selectedObjectId = w, this.selectedEntity = "object", this.refreshObjects(), this.refreshInspector(), this.render(), this.setStatus(`Hierarchy selected: ${A.size} object(s)`);
    },
    ...
    playblastCameraAtFrame() {
      return Yt(this, d(this), Wa(this, Fe), this.frame);
    },
    viewportCamera() {
      return va(this);
    },
    ...
    setDensity(w) {
      ...
      const A = this.root.querySelector("[data-inspector-mode].active");
      A && getComputedStyle(A).display === "none" && this.setInspectorMode("entity"), this.serialize(), requestAnimationFrame(() => {
        this.resizeCanvas(), this.render();
      }), this.setStatus(`Interface: ${w}`);
    },
    lookAtObject(w) {
      const A = this.state.objects.find((I) => I.id === w);
      if (A) {
        this.checkpoint("Look-at constraint");
        for (const I of this.state.cameras)
          for (const K of I.keyframes) K.camera.target = [...A.position || [0, 1.5, 0]];
        this.camera = Fe(this.state, this.frame), this.serialize(), this.refreshKeys(), this.render(), this.setStatus(`Cameras look at ${A.name || A.type}`);
      }
    },
    setTransformMode(w) {
      zt(this, w);
    ...
    refreshInspector() {
      this.perf && (this.perf.inspectorRefreshCount = (this.perf.inspectorRefreshCount || 0) + 1), Va(this), Bg(this);
    },
    setInspectorMode(w) {
      qg(this, w);
    },
    ...
    applyProxyPreset(w) {
      const A = { balanced: { mode: "omni_ref", burn: !1 }, parallax: { mode: "point_field", burn: !1 }, subject: { mode: "card_grid", burn: !1 }, debug: { mode: "omni_ref", burn: !0 } }, I = A[w] || A.balanced;
    ...
    aimAtSelectedObject(w) {
      ...
      const A = this.activeCameraTrack(), I = w && this.state.objects.find((D) => D.id === w) || this.selectedObject() || this.state.objects.find((D) => D.id === "subject") || this.state.objects[0];
      if (!I) return;
      A.target_object_id !== I.id && (A.aim_bone = null), A.target_object_id = I.id, A.id === this.state.active_camera_id && (this.state.target_object_id = I.id, this.state.aim_bone = A.aim_bone);
      const Z = (I.type === "model" || I.type === "glb" ? this.webgl?.getObjectWorldCenter?.(I.id) : null) || (I.keyframes?.length ? N(I, this.frame).position : I.position || [0, 1.5, 0]);
      this.camera.target = [...Z], this.beginCameraEdit(), this.commitCameraEdit(), this.finishCameraEdit(), this.serialize(), this.refreshInspector(), this.updateHudCamera(), this.render(), this.setStatus(`Camera tracking locked to ${I.name || I.id}`);
    },
    setAimBone(w) {
      Db(this, w);
    },
    ...
    setCameraTrackingTarget(w) {
      ...
      const A = this.activeCameraTrack();
      A.target_object_id !== (w || null) && (A.aim_bone = null), A.target_object_id = w || null, A.id === this.state.active_camera_id && (this.state.target_object_id = w || null, this.state.aim_bone = A.aim_bone), this.camera = Fe(A, this.frame, this.state.objects), Yt(this, A, this.camera, this.frame), this.serialize(), this.refreshInspector(), this.render(), this.setStatus(w ? `Camera tracking: ${w}` : "Camera tracking disabled (manual target)");
    },
    bakeAimToKeyframes() {
      this.checkpoint("Bake aim to keyframes");
      const w = this.activeCameraTrack(), A = w.target_object_id || this.state.target_object_id || "subject", I = this.state.objects.find((Z) => Z.id === A) || this.state.objects[0];
      if (!I || !w.keyframes?.length) return;
      const K = I.type === "model" || I.type === "glb" ? this.webgl?.getObjectWorldCenter?.(I.id) : null;
      for (const Z of w.keyframes) {
        const D = (I.type === "model" || I.type === "glb") && K && !I.keyframes?.length ? K : I.keyframes?.length ? N(I, Z.frame).position : I.position || [0, 1.5, 0];
        Z.camera.target = [...D];
      }
...
function Wg(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: b, syncActiveCameraTrack: u, syncFromWidgets: v, bindEditorEvents: y, activateCamera: x, addCamera: S, deleteCamera: g, drawPreviewOverlays: C, duplicateCamera: M, maximizeCameraPreview: R, refreshCameraPreviews: F, refreshCameraSelectors: Y, renameCamera: H, setPlayblastCamera: X, toggleCameraView: oe, captureRealtime: k, makePlayblast: E, uploadDirectorPlayblast: z, waitForMediaFrame: U, computeAudioPeaks: V, loadAudioFile: $, releaseAudio: G, stopPlay: j, togglePlay: W, applyCameraPreset: J, applyCameraShake: se, applyProxyPreset: ie, clearViewportBgImage: re, loadViewportBgFile: de, loadViewportBgSequence: ye, drawCameraPath: he, drawCard: ve, drawCube: xe, drawGrid: pe, drawHuman: Ie, drawLine3D: we, drawNull: ke, drawOverlays: be, drawPointField: L, drawSpeedHeatmap: q, drawSphere: me, curveChannels: Ee, drawCurveEditor: Le, fitCurveView: qe, onCurveDoubleClick: Ne, onCurvePointerDown: it, onCurvePointerMove: oa, onCurvePointerUp: ra, onTimelinePointerDown: na, onTimelinePointerMove: $t, onTimelinePointerUp: It, refreshKeys: bt, resetCurveZoom: Ot, resetTimelineZoom: Pt, setChannelFilter: Lt, setCurveInterpolation: sa, setTangentMode: Nt, timelineFrameFromEvent: ia, toggleCurveHandles: ca, zoomCurve: la, drawTransformGizmo: da, frameTarget: ma, gizmoAxes: pa, gizmoGeometry: fa, onPointerDown: ha, onPointerMove: ua, onPointerUp: ba, onWheel: ga, pickGizmo: Ft, pickSceneObject: zt, resetCamera: ya, setTransformMode: va, setViewMode: Go, viewportCamera: Yo, loadCardFile: xa, loadExecutionPreview: wa, loadMediaUrl: ka, loadModelFile: Sa, loadSelectedReference: _a, onModelLoaded: ja, restoreAssets: Ea, syncUpstreamInputs: Rt, configureDomMedia: Ca, refreshSetupDiagnostic: Aa, addMediaCard: Ta, addPrimitive: Ma, applyObjectAnimationFrame: $a, beginCameraEdit: Ia, beginObjectEdit: Oa, commitCameraEdit: Pa, commitObjectEdit: La, copyKeyframe: Na, deleteKeyframe: Fa, deleteObject: za, duplicateObject: Ra, exitKeyEdit: Da, finishCameraEdit: Ka, goToAdjacentKey: Ba, insertKeyframe: qa, loadSelectedKeyView: Ua, pasteKeyframe: Wa, playblastCameraAtFrame: Va, refreshInspector: Ha, refreshKeyEditor: Ga, refreshObjects: Ya, removeObjectResources: Xa, renameObject: Ja, retimeSelectedKey: Za, selectKeyframe: Qa, selectedKeyframe: eo, selectedObject: to, selectObjectAnimation: ao, setKeyInterpolation: oo, setObjectParent: ct, timelineKeyframes: ro, timelineObject: no, toggleAutoKey: so, toggleObject: io, updateCameraFromHud: co, updateEditState: lo, updateKeyVisualState: mo, updateSelectedKey: Dt, updateSelectedObject: po, clamp: fo, cloneCamera: ho, configureCore: Ze, defaultCamera: Xo, sampleCamera: gt, sampleObjectTransform: Fe, sanitizeState: N, worldTransform: P } = e;
  return {
    setTargetAtCursor(_) {
      if (!_) return;
      const w = this.interactionElement.getBoundingClientRect(), A = (_.clientX - w.left) * this.canvas.width / Math.max(1, w.width), I = (_.clientY - w.top) * this.canvas.height / Math.max(1, w.height), K = this.webgl?.intersectScenePoint?.(A, I, this.canvas.width, this.canvas.height);
    ...
    clearCaches() {
      if (this.checkpoint("Clear caches"), this.objectUrls?.clear(), G(this), this.webgl) {
        for (const _ of this.webgl.models.values())
          try {
            _.scene && disposeObject(_.scene, !0);
          } catch {
          }
        ...
        for (const _ of new Set(this.webgl.bgTextureCache?.values() || []))
          try {
            _.dispose();
          } catch {
          }
      ...
      if (this.cameraWebgl) {
        for (const _ of this.cameraWebgl.models.values())
          try {
            _.scene && disposeObject(_.scene, !0);
          } catch {
          }
        ...
        for (const _ of new Set(this.cameraWebgl.bgTextureCache?.values() || []))
          try {
            _.dispose();
          } catch {
          }
    ...
    snapFrame(_) {
      return !this.state.snap_enabled || this.state.snap_frames <= 1 ? Math.round(_) : Math.round(Math.round(_) / this.state.snap_frames) * this.state.snap_frames;
    },
    toggleLoop() {
      this.state.loop_playback = !this.state.loop_playback, this.serialize();
      const _ = this.root.querySelector('[data-act="loop"]');
      _.classList.toggle("active", this.state.loop_playback), _.setAttribute("aria-pressed", String(this.state.loop_playback)), this.setStatus(`Loop ${this.state.loop_playback ? "on" : "off"}`);
    },
    setPlaybackRange(_) {
      const w = this.state.playback_range || [0, this.state.duration_frames - 1];
      _ === "start" ? w[0] = Math.min(this.frame, w[1]) : _ === "end" && (w[1] = Math.max(this.frame, w[0])), this.state.playback_range = w, this.serialize(), this.refreshKeys(), this.setStatus(`Range: F${w[0]}–F${w[1]}`);
    },
    clearPlaybackRange() {
    ...
    toggleSnap() {
      ...
      const _ = this.root.querySelector('[data-act="toggle-snap"]');
      _.classList.toggle("active", this.state.snap_enabled), _.setAttribute("aria-pressed", String(this.state.snap_enabled)), this.setStatus(`Snap ${this.state.snap_enabled ? "on" : "off"}`);
    },
    scheduleSerialize() {
    ...
    timelineFrameFromEvent(_, w) {
      return ia(this, _, w);
    },
    onTimelinePointerDown(_) {
      na(this, _);
    },
    onTimelinePointerMove(_) {
      $t(this, _);
    },
    onTimelinePointerUp(_) {
      It(this, _);
    },
    resetTimelineZoom() {
      Pt(this);
    ...
    onCurvePointerDown(_) {
      it(this, _);
    },
    onCurvePointerMove(_) {
      oa(this, _);
    },
    onCurvePointerUp(_) {
      ra(this, _);
    ...
    async loadMediaUrl(_, w, A, I) {
      return ka(this, _, w, A, I);
    },
    restoreAssets() {
      Ea(this);
    },
    ...
    async loadModelFile(_) {
      return Sa(this, _);
    },
    async loadCardFile(_) {
      return xa(this, _);
    },
    loadExecutionPreview(_) {
      wa(this, _);
    },
    loadSelectedReference() {
      _a(this);
    },
    drawLine3D(_, w, A = "#5a5a5a", I = 1) {
      we(this, _, w, A, I);
    },
    drawGrid() {
      pe(this);
    ...
    async loadViewportBgFile(_) {
      return de(this, _);
    },
    async loadViewportBgSequence(_) {
      return ye(this, _);
    },
...
function Hg(e) {
  const { right: t, up: a, forward: o } = dl(e || {});
  return Vg.map((r) => {
...
const Xg = "http://www.w3.org/2000/svg", St = 26, cs = 17, Jg = 5.4;
function _t(e, t) {
  const a = document.createElementNS(Xg, e);
...
function Zg(e) {
  ...
  for (const n of Gg(Hg(a))) {
    const i = St + n.x * cs, c = St + n.y * cs, l = Yg(n.depth);
    t.appendChild(_t("line", {
      x1: St,
      y1: St,
      x2: i,
      y2: c,
...
function ey(e) {
  ...
  for (const r of e.state.motion_layers || []) {
    ...
    const n = Qg(e.state, r, e.frame, a, o);
    if (n.length) {
...
const ty = ["world_point", "object_point", "camera_field"], Pi = {
  manual_2d: "DRAW",
  object_point: "OBJECT",
  world_point: "WORLD",
...
function oy(e, t) {
  if (ty.includes(t.source_kind)) {
    const a = Rr(e, t.source, 0, e.width || 1280, e.height || 720);
...
function sy(e) {
  ...
  n("motion-sel-name", a.label), n("motion-sel-type", Pi[a.source_kind] || "TRACK"), n("motion-sel-binding", ay(e.state, a)), n("motion-sel-start", r.length ? Math.min(...r) : 0), n("motion-sel-end", r.length ? Math.max(...r) : 0);
...
function ly(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: b, syncActiveCameraTrack: u, syncFromWidgets: v, bindEditorEvents: y, activateCamera: x, addCamera: S, deleteCamera: g, drawPreviewOverlays: C, duplicateCamera: M, maximizeCameraPreview: R, refreshCameraPreviews: F, refreshCameraSelectors: Y, renameCamera: H, setPlayblastCamera: X, toggleCameraView: oe, captureRealtime: k, makePlayblast: E, uploadDirectorPlayblast: z, waitForMediaFrame: U, computeAudioPeaks: V, loadAudioFile: $, releaseAudio: G, stopPlay: j, togglePlay: W, applyCameraPreset: J, applyCameraShake: se, applyProxyPreset: ie, clearViewportBgImage: re, loadViewportBgFile: de, loadViewportBgSequence: ye, drawCameraPath: he, drawCard: ve, drawCube: xe, drawCylinder: pe, drawGrid: Ie, drawHuman: we, drawLine3D: ke, drawNull: be, drawOverlays: L, drawPointField: q, drawSpeedHeatmap: me, drawSphere: Ee, drawTorus: Le, curveChannels: qe, drawCurveEditor: Ne, onCurvePointerDown: it, onCurvePointerMove: oa, onCurvePointerUp: ra, onTimelinePointerDown: na, onTimelinePointerMove: $t, onTimelinePointerUp: It, refreshKeys: bt, resetCurveZoom: Ot, resetTimelineZoom: Pt, setChannelFilter: Lt, setCurveInterpolation: sa, setTangentMode: Nt, timelineFrameFromEvent: ia, toggleCurveHandles: ca, zoomCurve: la, drawTransformGizmo: da, frameTarget: ma, gizmoAxes: pa, gizmoGeometry: fa, onPointerDown: ha, onPointerMove: ua, onPointerUp: ba, onWheel: ga, pickGizmo: Ft, pickSceneObject: zt, resetCamera: ya, setTransformMode: va, setViewMode: Go, viewportCamera: Yo, loadCardFile: xa, loadExecutionPreview: wa, loadMediaUrl: ka, loadModelFile: Sa, loadSelectedReference: _a, onModelLoaded: ja, restoreAssets: Ea, syncUpstreamInputs: Rt, configureDomMedia: Ca, refreshSetupDiagnostic: Aa, addMediaCard: Ta, addPrimitive: Ma, applyObjectAnimationFrame: $a, beginCameraEdit: Ia, beginObjectEdit: Oa, commitCameraEdit: Pa, commitObjectEdit: La, copyKeyframe: Na, deleteKeyframe: Fa, deleteObject: za, duplicateObject: Ra, exitKeyEdit: Da, finishCameraEdit: Ka, goToAdjacentKey: Ba, insertKeyframe: qa, loadSelectedKeyView: Ua, pasteKeyframe: Wa, playblastCameraAtFrame: Va, refreshInspector: Ha, refreshKeyEditor: Ga, refreshObjects: Ya, removeObjectResources: Xa, renameObject: Ja, retimeSelectedKey: Za, selectKeyframe: Qa, selectedKeyframe: eo, selectedObject: to, selectObjectAnimation: ao, setKeyInterpolation: oo, setObjectParent: ct, timelineKeyframes: ro, timelineObject: no, toggleAutoKey: so, toggleObject: io, updateCameraFromHud: co, updateEditState: lo, updateKeyVisualState: mo, updateSelectedKey: Dt, updateSelectedObject: po, clamp: fo, cloneCamera: ho, configureCore: Ze, defaultCamera: Xo, sampleCamera: gt, sampleObjectTransform: Fe, sanitizeState: N, worldTransform: P } = e;
  return {
    ...
    renderViewportOnly() {
      const _ = this.ctx, w = this.canvas.width, A = this.canvas.height;
      if (_.fillStyle = this.state.viewport_bg_color || "#121212", _.fillRect(0, 0, w, A), this.viewportBgSequenceImages && this.viewportBgSequenceImages.length) {
        const ne = this.frame % this.viewportBgSequenceImages.length, Qe = this.viewportBgSequenceImages[ne];
        if (Qe?.complete && Qe.naturalWidth)
          try {
            _.drawImage(Qe, 0, 0, w, A);
          } catch {
          }
      } else if (this.viewportBgImage)
        try {
          _.drawImage(this.viewportBgImage, 0, 0, w, A);
        } catch {
        }
      const I = this.state.render_mode, K = this.viewportCamera(), Z = this.state.objects.some((ne) => ne.parent_id) ? this.state.objects.map((ne) => ne.parent_id ? { ...ne, ...P(this.state.objects, ne) } : ne) : this.state.objects, D = (this.viewportBgSequenceImages || []).map((ne) => ne.src), Q = this.viewportBgImage?.src || "", _e = this.pendingExtractorImport, Ue = _e ? [...this.state.cameras, {
        id: "__extractor_preview__",
        name: _e.label,
        color: "#9ca3af",
        camera: _e.track.keyframes[0]?.camera,
        keyframes: _e.track.keyframes
      }] : this.state.cameras, lt = {
        ...this.state,
        cameras: Ue,
        objects: Z,
        viewport_bg_image: Q,
        ...
        __omnicamRevision: `${this.renderRevision || 0}:${_e?.fingerprint || ""}`
      };
      let ae = !1;
      if (this.webgl) {
        try {
          const ne = this.recording ? 1 : this.webgl.supersampleFactor?.() ?? 1, Qe = ne > 1 ? Math.min(ne, 4096 / Math.max(1, w, A)) : 1, uo = Qe > 1 ? Math.round(w * Qe) : w, Jo = Qe > 1 ? Math.round(A * Qe) : A;
          this.webgl.activeCamera && this.transformControlsWiring?.sync(), this.webgl.render(lt, K, this.cardMediaById, uo, Jo, this.modelUrlsById, this.frame, this.recording, this.selectedEntity, this.selectedObjectId, this.subSelection, this.selectedKeyFrame ?? null, this.selectedKeyFrames ? [...this.selectedKeyFrames] : null), _.imageSmoothingEnabled = !0, _.imageSmoothingQuality = "high", uo !== w || Jo !== A ? _.drawImage(this.webgl.canvas, 0, 0, uo, Jo, 0, 0, w, A) : _.drawImage(this.webgl.canvas, 0, 0, w, A), ae = !0;
        } catch (ne) {
      ...
      if (!ae) {
        ...
        for (const ne of Z)
          ne.enabled !== !1 && (ne.type === "card" && ["omni_ref", "card_grid", "graybox", "wireframe"].includes(I) ? this.drawCard(ne) : ["cube", "ground", "glb", "model"].includes(ne.type) && I !== "grid" && I !== "point_field" ? this.drawCube(ne) : ne.type === "sphere" && I !== "grid" && I !== "point_field" ? this.drawSphere(ne) : ne.type === "cylinder" && I !== "grid" && I !== "point_field" ? this.drawCylinder(ne) : ne.type === "torus" && I !== "grid" && I !== "point_field" ? this.drawTorus(ne) : ne.type === "human" && I !== "grid" && I !== "point_field" ? this.drawHuman(ne) : ne.type === "null" && this.drawNull(ne));
        !this.recording && this.state.show_camera_paths && this.drawCameraPath();
      }
      !this.recording && this.state.speed_heatmap && this.drawSpeedHeatmap(), !this.recording && uu(this), this.drawOverlays(), ey(this), this.state.show_gizmo && Zg(this), this.labelOverlay?.update(), this.rigOverlay?.update(), this.perf && (this.perf.viewportRenderCount = (this.perf.viewportRenderCount || 0) + 1);
    },
    ...
    requestRender(_ = "unknown") {
      return this.requestUiUpdate(T.viewport | T.previews | T.motion, _);
    },
    ...
    requestUiUpdate(_ = T.viewport, w = "unknown") {
      (this.renderReasons ||= /* @__PURE__ */ new Set()).add(w), this.uiDirtyMask = Ep(this.uiDirtyMask, _), this.renderInvalidations = (this.renderInvalidations || 0) + 1, !this.renderScheduled && (this.renderScheduled = !0, this.renderFrame = requestAnimationFrame(() => {
        if (this.renderScheduled = !1, this.disposed) return;
        const A = this.uiDirtyMask || T.viewport;
        this.uiDirtyMask = 0, this.lastRenderReasons = [...this.renderReasons || []], this.renderReasons?.clear(), this.rendersCoalesced = (this.rendersCoalesced || 0) + 1, this.perf && (this.perf.renderCount = (this.perf.renderCount || 0) + 1), xt(A, T.outliner) && this.refreshObjects(), xt(A, T.timeline) && this.refreshKeys(), xt(A, T.inspector) && this.refreshInspector(), xt(A, T.viewport) && this.renderViewportOnly(), xt(A, T.previews) && this.renderCameraView(), xt(A, T.motion) && this.renderMotionUiOnly();
      }));
    },
    renderCameraView() {
      if (this.perf && (this.perf.previewRenderCount = (this.perf.previewRenderCount || 0) + 1), this.state.camera_view_visible) {
        ...
        const w = this.state.cameras, A = !!this.playing && !this.recording && w.length > 2;
        let I = null;
        if (A) {
          const K = this.state.active_camera_id, Z = w.filter((D) => D.id !== K);
          I = Z.length ? Z[this.cameraPreviewTick % Z.length] : null;
        }
        for (const K of w) {
          const Z = this.cameraPreviewCanvases.get(K.id), D = this.cameraPreviewContexts.get(K.id);
          if (!Z?.width || !D) continue;
          const Q = Z.width, _e = Z.height, Ue = this.root.querySelector(`[data-camera-frame="${K.id}"]`);
          if (Ue && (Ue.textContent = `F${this.frame}`), A && K.id !== this.state.active_camera_id && K !== I) continue;
          const lt = Yt(this, K, gt(K, this.frame, this.state.objects), this.frame);
          if (D.fillStyle = "#111", D.fillRect(0, 0, Q, _e), this.cameraWebgl)
            try {
              this.cameraWebgl.render({ ...this.state, keyframes: [], playblast_grid: !1, viewport_bg_image: this.viewportBgImage?.src || "", viewport_bg_sequence: (this.viewportBgSequenceImages || []).map((ae) => ae.src), __omnicamRevision: this.renderRevision || 0 }, lt, this.cardMediaById, Q, _e, this.modelUrlsById, this.frame, !0), D.drawImage(this.cameraWebgl.canvas, 0, 0, Q, _e);
            } catch (ae) {
    ...
    drawPreviewOverlays(_, w, A) {
      C(this, _, w, A);
    },
    maximizeCameraPreview(_) {
      R(this, _);
    },
    setStatus(_) {
      (this.dom?.status || this.root.querySelector('[data-role="status"]')).textContent = _;
    },
    async makePlayblast() {
      return E(this);
    },
    ...
    dispose() {
      this.disposed || (this.disposed = !0, this.agentBridge?.dispose?.(), this.transformControlsWiring?.dispose(), ml(this), pl(), Vl(this), this.backgroundRequestId = (this.backgroundRequestId || 0) + 1, this.upstreamSyncId = (this.upstreamSyncId || 0) + 1, this.stopPlay(), clearTimeout(this.previewClickTimer), clearTimeout(this.connectionTimer), cancelAnimationFrame(this.restoreFrame), cancelAnimationFrame(this.serializeFrame), cancelAnimationFrame(this.resizeFrame), cancelAnimationFrame(this.renderFrame), this.abortController?.abort(), this.upstreamFetchController?.abort(), this.resizeObserver?.disconnect(), this.contextMenu?.dispose(), this.webgl?.dispose(), this.cameraWebgl?.dispose(), G(this), Bu(this), this.objectUrls.clear(), this.cardMediaById.clear(), this.cardMediaAssetById?.clear?.(), this.modelUrlsById.clear(), this.modelInfoById.clear());
    }
  };
}
const dy = 0.12;
function my() {
  return {
    ...
    resolveSelectedFrames() {
      const e = new Set(Ae(this).map((a) => a.frame));
    ...
    _activeTrack() {
      ...
      return {
        kind: "camera",
        write: (a) => {
          t.keyframes = a, this.state.keyframes = a, ur(this);
        }
      };
    },
    deleteSelectedKeyframes() {
      ...
      if (!e.length) {
        const l = Ae(this).find((p) => p.frame === this.frame);
        l && (e = [l.frame]);
      }
      if (!e.length) return this.setStatus(s("Select a keyframe to delete"));
      const t = this._activeTrack(), a = Ae(this), o = t.kind === "camera" ? 1 : 0, { keys: r, removed: n } = Zs(a, e, { minKeys: o });
    ...
    nudgeSelectedKeyframes(e) {
      ...
      const a = this._activeTrack(), o = Math.max(0, this.state.duration_frames - 1), r = qp(Ae(this), t, e, { lastFrame: o });
    ...
    setSelectedKeysInterpolation(e) {
      ...
      this.checkpoint(s("Interpolation on {n} keys").replace("{n}", t.length)), a.write(Up(Ae(this), t, e)), this.serialize(), this.refreshKeys(), this.refreshKeyEditor(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} interpolation on {n} keys").replace("{mode}", e.replace(/_/g, " ")).replace("{n}", t.length));
    },
    setSelectedKeysTangentMode(e) {
      const t = this.resolveSelectedFrames();
      if (t.length < 2) return this.setTangentMode(e);
      const a = this._activeTrack(), o = ut(this).map((r) => r.id);
      this.checkpoint(s("Tangents on {n} keys").replace("{n}", t.length)), a.write(Wp(Ae(this), t, e, o)), this.serialize(), this.refreshKeys(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} tangents on {n} keys").replace("{mode}", e).replace("{n}", t.length));
    },
    /**
    ...
    simplifyActiveKeys({ mode: e = "simplify", tolerance: t = 0, target: a = 0, scope: o = "camera", fromKeys: r = null, silent: n = !1 } = {}) {
      ...
      const l = this.resolveSelectedFrames(), p = o !== "all_cameras" && l.length >= 2 ? [l[0], l.at(-1)] : null, m = p ? [] : l, f = (b) => {
        const u = [...b].sort((R, F) => R.frame - F.frame), v = p ? p[0] : -1 / 0, y = p ? p[1] : 1 / 0, x = u.filter((R) => R.frame < v), S = u.filter((R) => R.frame >= v && R.frame <= y), g = u.filter((R) => R.frame > y);
        let C = S, M = 0;
        if (S.length > 2) {
          const R = e === "reduce" ? Kp(S, i, { target: a || Math.ceil(S.length / 2), keepFrames: m }) : e === "clean" ? Bp(S, i, { keepFrames: m }) : Dp(S, i, { tolerance: t * dy, keepFrames: m });
          C = R.keys, M = R.removed;
        }
        return { keys: [...x, ...C, ...g].sort((R, F) => R.frame - F.frame), removed: M };
      };
      let d = 0;
      const h = c.map((b) => {
        const u = r && b.primary ? r : b.get(), { keys: v, removed: y } = f(u);
        return d += y, { track: b, keys: v };
      });
      n || this.checkpoint(s("Simplify keyframes"));
      for (const { track: b, keys: u } of h) b.set(u);
      return ur(this), this.selectedKeyFrame = null, this.selectedKeyFrames = /* @__PURE__ */ new Set(), this.camera = $e(this.state, this.frame), this.applyObjectAnimationFrame(), this.serialize(), this.refreshKeys(), this.setFrame(this.frame, !1, !1), this.render(), n || this.setStatus(d ? s("Removed {n} keyframes").replace("{n}", d) : s("No keyframes to remove")), d;
    },
    keySimplifyToleranceFor(e) {
      return te(Number(e) || 0, 0, 100) / 100;
    }
  };
}
js({ api: st });
...
class Li {
  constructor(t) {
    this.app = ls, this.api = st, this.node = t, this.root = Us(), this.root.tabIndex = -1, this.dom = oi(this.root), this.canvas = this.root.querySelector(".viewport-wrap > canvas"), this.cameraPreviewCanvases = /* @__PURE__ */ new Map(), this.cameraPreviewContexts = /* @__PURE__ */ new Map(), this.cameraPreviewSignature = "", this.interactionElement = this.canvas, this.interactionElement.tabIndex = 0, this.interactionElement.dataset.captureWheel = "true", this.ctx = this.canvas.getContext("2d", { alpha: !1 }), this.disposed = !1, this.renderRevision = 0, this.directorRevision = 0, this.webgl = null, this.cameraWebgl = null, this.webglReady = this.loadWebGLViewports(), this.transformControlsWiring = Jf(this), this.stateWidget = t.widgets?.find((o) => o.name === "state_json"), this.recordingWidget = t.widgets?.find((o) => o.name === "recording_path"), this.cardWidget = t.widgets?.find((o) => o.name === "card_asset"), this.widthWidget = t.widgets?.find((o) => o.name === "width"), this.heightWidget = t.widgets?.find((o) => o.name === "height"), this.fpsWidget = t.widgets?.find((o) => o.name === "fps"), this.durationWidget = t.widgets?.find((o) => o.name === "duration_seconds"), this.modeWidget = t.widgets?.find((o) => o.name === "render_mode");
    let a = null;
    try {
      a = JSON.parse(this.stateWidget?.value || "{}");
    } catch {
    }
    this.state = Nr(a), // The scene "Reset" command reverts to whatever was last saved or opened;
    // the state the node mounts with is that baseline until then.
    this.sceneBaseline = this.stateWidget?.value || JSON.stringify(this.state), this.sceneName = this.state.metadata?.scene_name || "", this.frame = 0, this.camera = $e(this.state, 0), this.playing = !1, this.drag = null, this.cameraEditActive = !1, this.cameraEditKey = null, this.keyDrag = null, this.timelineDrag = null, this.curveDrag = null, this.selectedKeyFrame = this.state.keyframes[0]?.frame ?? null, this.pathSelection = fl(), this.editingKeyFrame = null, this.copiedKeyframe = null, this.cameraSpeed = 1, this.cardMedia = null, this.cardMediaById = /* @__PURE__ */ new Map(), this.cardMediaAssetById = /* @__PURE__ */ new Map(), this.objectUrls = new qs(), this.cardUrlsById = this.objectUrls.urls, this.modelUrlsById = /* @__PURE__ */ new Map(), this.modelInfoById = /* @__PURE__ */ new Map(), this.executionReferences = [], this.selectedObjectId = null, this.selectedEntity = "camera", this.subSelection = null, this.cardUrl = null, this.recording = !1, this.gizmoDrag = null, this.playTimer = null, this.previewClickTimer = null, this.showCurveHandles = !0, this.uiDirtyMask = 0, this.perf = globalThis.__omnicamPerf === !0 ? { renderCount: 0, viewportRenderCount: 0, previewRenderCount: 0, timelineRefreshCount: 0, inspectorRefreshCount: 0, lastFrameMs: 0 } : null, this.contextMenu = new As(this.root), this.history = new Bs({ capture: () => JSON.stringify({ state: this.state, frame: this.frame, selectedEntity: this.selectedEntity, selectedObjectId: this.selectedObjectId, selectedObjectIds: [...this.selectedObjectIds || []], selectedKeyFrame: this.selectedKeyFrame, selectedKeyFrames: [...this.selectedKeyFrames || []], subSelection: this.subSelection }), restore: (o) => this.restoreHistorySnapshot(o) }), this.refreshCameraPreviews(), this.initializeTooltips(), this.bindEditorEvents(), this.bindWidgetCallbacks(), this.syncFromWidgets(), this.resizeCanvas(), this.render(), this.refreshKeys(), this.refreshObjects(), this.restoreAssets(), this.syncUpstreamInputs(), this.refreshSetupDiagnostic(), // Seed every frame-derived readout (timecode, lens millimetres, viewport
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-BsZm-kL6.js"));
    } catch (a) {
    ...
    if (!this.disposed) {
      ...
      hl(this), this.resizeCanvas(), this.render(), this.renderCameraView();
    }
  }
}
const Eo = { app: ls, api: st, EditorHistory: Bs, ContextMenuController: As, initializeTooltips: Gl, promptText: Zt, ObjectUrlRegistry: qs, buildRoot: Us, dispatchDirectorKey: ul, activeCameraTrack: hr, bindWidgetCallbacks: Yl, playblastCameraTrack: Cs, restoreFromWidgets: Xl, serializeEditorState: Jl, syncActiveCameraTrack: ur, syncFromWidgets: Zl, bindEditorEvents: Tu, activateCamera: Ql, addCamera: ed, deleteCamera: td, drawPreviewOverlays: ad, duplicateCamera: od, maximizeCameraPreview: rd, refreshCameraPreviews: nd, refreshCameraSelectors: sd, renameCamera: id, setPlayblastCamera: cd, toggleCameraView: ld, captureRealtime: xi, makePlayblast: ob, uploadDirectorPlayblast: wi, waitForMediaFrame: vi, computeAudioPeaks: hi, loadAudioFile: Ru, releaseAudio: Do, stopPlay: $o, togglePlay: Nu, applyCameraPreset: Zf, applyCameraShake: Qf, applyProxyPreset: eh, clearViewportBgImage: ib, loadViewportBgFile: nb, loadViewportBgSequence: sb, drawCameraPath: wb, drawCard: xb, drawCube: hb, drawCylinder: gb, drawGrid: db, drawHuman: bb, drawLine3D: ce, drawNull: vb, drawOverlays: Sb, drawPointField: fb, drawSpeedHeatmap: kb, drawSphere: ub, drawTorus: yb, curveChannels: ut, drawCurveEditor: Hd, fitCurveView: Ns, onCurveDoubleClick: Wd, onCurvePointerDown: Nd, onCurvePointerMove: Fd, onCurvePointerUp: zd, onTimelinePointerDown: bl, onTimelinePointerMove: gl, onTimelinePointerUp: yl, refreshKeys: cm, resetCurveZoom: Vd, resetTimelineZoom: vl, setChannelFilter: Dd, setCurveInterpolation: Rd, setTangentMode: Kd, timelineFrameFromEvent: Tr, toggleCurveHandles: Bd, zoomCurve: Ud, drawTransformGizmo: xl, frameTarget: wl, gizmoAxes: kl, gizmoGeometry: Sl, onPointerDown: _l, onPointerMove: jl, onPointerUp: El, onWheel: Cl, pickGizmo: Al, pickSceneObject: Tl, resetCamera: Ml, setTransformMode: $l, setViewMode: Il, viewportCamera: Ol, loadCardFile: Hu, loadExecutionPreview: Gu, loadMediaUrl: yi, loadModelFile: Vu, loadSelectedReference: Yu, onModelLoaded: Wu, restoreAssets: Uu, syncUpstreamInputs: Xu, configureDomMedia: ui, refreshSetupDiagnostic: Eb, addMediaCard: Gb, addPrimitive: Ub, applyObjectAnimationFrame: dg, beginCameraEdit: gg, beginObjectEdit: Ai, commitCameraEdit: yg, commitObjectEdit: Jb, copyKeyframe: hg, deleteKeyframe: fg, deleteObject: Ci, deleteSelectedObjects: Hb, duplicateObject: Ei, exitKeyEdit: xg, finishCameraEdit: vg, goToAdjacentKey: $g, insertKeyframe: mg, loadSelectedKeyView: Mg, pasteKeyframe: ug, playblastCameraAtFrame: lg, refreshInspector: Yb, refreshKeyEditor: Cg, refreshObjects: ji, removeObjectResources: og, renameObject: Wb, retimeSelectedKey: Ag, selectKeyframe: bg, selectedKeyframe: Je, selectedObject: aa, selectObjectAnimation: ag, setKeyInterpolation: pg, setKeyTangentMode: jg, setObjectParent: tg, timelineKeyframes: Ae, timelineObject: Pe, toggleAutoKey: wg, toggleObject: Vb, updateCameraFromHud: eg, updateCameraRotationFromHud: Qb, updateEditState: Sg, updateKeyVisualState: _g, updateSelectedKey: Tg, updateSelectedObject: Xb, clamp: te, cloneCamera: le, configureCore: js, defaultCamera: Ir, sampleCamera: $e, sampleObjectTransform: qo, sanitizeState: Nr, worldTransform: Fr };
Object.assign(
  Li.prototype,
  Pg(Eo),
  Ug(Eo),
...
function py(e) {
  ...
  Co("director:attach:start", e), Co("director:constructor:start", e);
  const t = new Li(e);
  Co("director:constructor:complete", e), uf(t);
  try {
    t.agentBridge = kf(t, e, st);
  } catch (m) {
  ...
  try {
    t.assetBrowser = Ff(t, {
      ...
      onAgentFirstOpen: async () => {
        if (mr())
          try {
            const { createDirectorAgentPanel: m } = await import("./chunk-DDWyXoPa.js");
            t.agentPanel = m(t);
          } catch (m) {
  ...
  try {
    t.characterRuntime = Rf(t), t.rigMapper = Kf(t), t.poseEditor = Uf(t), t.motionEditor = Wf(t);
  } catch (m) {
    console.warn("[OmniCam] Character tools unavailable", m);
  }
  e.__majoorOmniCam = t, Co("director:marker:assigned", e), t.hideInternalWidgets();
  ...
  }, t.unwatchGraphConnections = Hl(e, i);
  const l = e.onRemoved;
