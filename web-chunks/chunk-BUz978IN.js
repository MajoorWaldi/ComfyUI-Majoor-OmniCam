import { a as N, l as P, S as $, b as I, p as L, u as R, d as A } from "./chunk-BOI_2OKd.js";
import "../../scripts/app.js";
import { api as u } from "../../scripts/api.js";
import { M as j, E as D } from "./chunk-CbqXtcpr.js";
import { x as q, a$ as F } from "./chunk-Rl7mD9y2.js";
function c(e) {
...
function w(e, t) {
  ...
  return o?.link == null || !e?.graph ? null : P(e.graph, o.link);
}
function ot(e) {
...
class bt {
  constructor(t) {
    this.node = t, this.root = ut(), this.events = new D(), this.source = null, this.player = new G(
  ...
  refreshPlayblastPreview() {
    ...
    this.player.setSource(""), A(a, t, 640).then((s) => {
  ...
  dispose() {
    this.disposed || (this.disposed = !0, clearInterval(this.liveTimer), clearTimeout(this.connectionRefreshTimer), F(), this.refreshController?.dispose(), this.watcher?.dispose(), this.player.dispose(), this.events.dispose());
  }
}
function St(e) {
