...
import { api as ot } from "../../scripts/api.js";
import { s as $e, c as Q, t as ue, a as s, o as ts, b as _r, d as He, e as ce, f as Do, r as _i, g as Cr, h as as, i as Ci, j as Ei, k as Ai, l as Ti, m as Er, n as Ar, I as _o, D as $i, p as Tr, q as Mi, w as Ii, u as To, v as os, x as Oi, y as $r, z as ir, A as Qr, B as rs, C as cr, E as ns, F as ss, G as is, H as cs, J as lr, K as Yo, L as en, O as tn, R as ls, M as Pi, N as Li, P as zi, Q as Ni, S as Fi, T as fe, U as ds, V as ms, W as an, X as jt, Y as Ri, Z as ps, _ as Di, $ as Ki, a0 as Mr, a1 as Bi, a2 as qi, a3 as Ui, a4 as Wi, a5 as Vi, a6 as Ir, a7 as Hi, a8 as Gi, a9 as Yi, aa as Xi, ab as Ji, ac as Zi, ad as Qi, ae as ec, af as tc, ag as ac, ah as oc, ai as rc, aj as nc, ak as sc, al as ic, am as cc, an as lc, ao as dc, ap as mc, aq as pc, ar as fc, as as hc, at as uc, au as bc, av as gc, aw as yc, ax as vc, ay as xc, az as wc, aA as kc, aB as Sc, aC as jc, aD as _c, aE as Cc, aF as Ec, aG as Ac, aH as Tc, aI as $c, aJ as Mc, aK as Ic, aL as Oc, aM as Pc, aN as Lc, aO as $o, aP as zc, aQ as Xo, aR as Nc, aS as Fc, aT as Rc, aU as Dc, aV as Kc, aW as Ve, aX as Bc, aY as fs, aZ as Or, a_ as qc, a$ as Uc, b0 as Wc, b1 as hs, b2 as Qe, b3 as Vc, b4 as on, b5 as Pr, b6 as Hc, b7 as us, b8 as Gc, b9 as Yc, ba as Jo, bb as rn, bc as Ko, bd as Xc, be as Jc, bf as Zc, bg as Qc, bh as el, bi as tl, bj as al, bk as ol, bl as bs, bm as rl, bn as nl, bo as sl, bp as il, bq as cl, br as ll, bs as dl, bt as ml, bu as pl, bv as fl, bw as hl, bx as ul, by as bl, bz as gl, bA as yl, bB as vl, bC as xl, bD as wl, bE as kl } from "./chunk-BVYXHcxN.js";
import { L as Sl, a as jl, p as Yt, f as Lr, b as _l, S as Cl, c as nn, d as El, e as Al, r as Tl, g as $l, n as Ml, C as sn, h as Xt, o as gs, i as Il, s as Ol, j as Pl, k as ys, l as Ll, m as dr, q as mr, w as zl, t as vs, u as Nl, v as Fl, x as Rl, y as Dl, z as Kl, A as Bl, B as ql, D as Ul, E as Wl, F as Vl, G as Hl, H as Gl, I as Yl, J as Xl, K as Jl, M as Zl } from "./chunk-DYKBLHaE.js";
import { S as Ql, b as ed, p as td, m as ad, l as od, u as rd } from "./chunk-BOI_2OKd.js";
import { T as nd } from "./chunk-__IQ4xkd.js";
import { T as sd, R as id } from "./vendor-three-BQUrLQkn.js";
function Rt(e, t = 0) {
  return Math.sin(e * 1.7 + t * 3.1) * 0.5 + Math.sin(e * 3.3 + t * 5.7) * 0.3 + Math.sin(e * 7.9 + t * 11.3) * 0.2;
}
function cd(e, { type: t = "handheld_subtle", intensity: a = 1, duration_frames: o = null, subdivide: r = !0 } = {}) {
  ...
  return [...u].sort((y, x) => y - x).map((y) => {
    const x = $e(b, y), S = Rt(y * m, 1) * l, g = Rt(y * m, 2) * l, k = Rt(y * m, 3) * l * 0.5, _ = Rt(y * m, 4) * p, I = Rt(y * m, 5) * (p * 0.35), P = [...x.position], B = [...x.target];
    return P[0] += S, P[1] += g, P[2] += k, B[0] += S * 0.35, B[1] += g * 0.35, {
      frame: y,
      camera: {
        ...x,
        position: P,
        target: B,
        roll: (x.roll || 0) + _,
        fov: Q((x.fov || 35) + I, 10, 140)
      },
      interpolation: "smooth"
    };
  });
}
function ld(e, { duration_frames: t = 120, target: a = [0, 1.5, 0], radius: o = 6, height: r = 3.5 } = {}) {
...
const xs = 1e-4;
function dd(e, t) {
  return !Array.isArray(e) || !Array.isArray(t) ? e !== t : e.some((a, o) => Math.abs(Number(a) - Number(t[o])) > xs);
}
function cn(e, t) {
  return Math.abs(Number(e) - Number(t)) > xs;
}
const ws = [
  {
    id: "camera",
  ...
  },
  {
    ...
    label: "Look At",
    color: "#f0a742",
    changed: (e, t) => dd(e?.target, t?.target),
    read: (e) => e?.target
  },
  {
    id: "focal_length",
...
function pd(e, t = null) {
  return ws.filter((a) => !t || t.has(a.id)).map((a) => ({
    id: a.id,
    label: a.label,
    color: a.color,
    frames: md(e, a)
...
function Mo(e) {
  ...
  for (const a of [".oc-playhead-head", '[data-role="dope-playhead"]', ".oc-gdope-playhead", ".oc-sequence-playhead"])
    for (const o of e.root.querySelectorAll(a)) fd(o, t);
}
function hd(e, t, a) {
...
function ks(e) {
  ...
  a.delete("camera");
  const o = e.timelineKeyframes() || [], r = pd(o, a), n = bd(e, r);
  if (t.dataset.signature !== n) {
    t.dataset.signature = n, t.replaceChildren();
    const i = (c) => ue(e, c);
    for (const c of r) {
      const l = document.createElement("div");
      l.className = "oc-dope-row", l.dataset.channel = c.id, l.style.setProperty("--channel-color", c.color), hd(l, c.frames, i), ud(e, l, c, o, i), t.appendChild(l);
    }
  }
...
const Zo = [1, 2, 5, 10, 20, 25, 50, 100, 200, 250, 500, 1e3, 2e3, 5e3], Ss = 46, ln = 5, js = 640;
function _s(e, t) {
  const a = t > 0 ? t : js, o = Math.max(2, Math.floor(a / Ss)), r = Math.max(1e-6, e / o);
  return Zo.find((n) => n >= r) ?? Zo[Zo.length - 1];
}
function gd(e, t) {
  const a = Math.max(1, e.state.duration_frames - 1), o = Q(Number(e.timelineZoom) || 1, 0.1, 50), r = Number(e.timelinePan) || 0, n = a / o, i = _s(n, t), l = (i >= ln ? i / ln : 0) || i, p = [], m = Math.max(0, Math.floor(r / l) * l);
...
function yd(e) {
  return e.clientWidth || e.parentElement?.clientWidth || js;
}
function Cs(e) {
  const t = e.root.querySelector('[data-role="ruler"]');
  if (!t) return;
  t.replaceChildren();
  for (const o of gd(e, yd(t))) {
...
function vd(e, t) {
  ...
  a.addEventListener("pointerup", i, { signal: t }), a.addEventListener("pointercancel", i, { signal: t }), a.addEventListener("wheel", (c) => ts(e, c), { passive: !1, signal: t });
}
const xd = [1, 2, 2.5, 5, 10];
function wd(e, t = 5) {
  const a = Math.abs(e) / Math.max(1, t);
  if (!(a > 0) || !Number.isFinite(a)) return 1;
  const o = 10 ** Math.floor(Math.log10(a)), r = a / o;
  return (xd.find((n) => n >= r) ?? 10) * o;
}
function kd(e, t) {
  const a = Math.max(0, Math.min(4, Math.ceil(-Math.log10(t))));
  return e.toFixed(a);
}
function Sd(e, { left: t, right: a, top: o, width: r, graphWidth: n, graphHeight: i, height: c, timeMin: l, timeMax: p, totalDuration: m, xFor: f, frame: d }) {
  const h = _s(p - l, n);
...
function jd(e, { left: t, right: a, top: o, width: r, graphHeight: n, minimum: i, maximum: c, yFor: l }) {
  const p = wd(c - i, 4);
  e.strokeStyle = "#222228", e.lineWidth = 1, e.fillStyle = "#6e727a";
  for (let m = Math.ceil(i / p) * p; m <= c; m += p) {
    const f = l(m);
    f < o - 1 || f > o + n + 1 || (e.beginPath(), e.moveTo(t, f), e.lineTo(r - a, f), e.stroke(), e.fillText(kd(m, p), 4, f + 3));
  }
}
function zr(e, t) {
...
function _d(e, t) {
  ...
  if (!n || n.distance > 12) {
    if (r < 20) {
      const c = Math.max(1, e.state.duration_frames - 1), l = c / (Number(e.curveZoomX) || 1), p = Number(e.curvePanX) || 0, m = Math.round(Q(p + (o - 44) / Math.max(1, a.clientWidth - 58) * l, 0, c));
...
function Cd(e, t) {
  const a = t.currentTarget, { x: o, y: r } = zr(a, t);
  ...
  if (e.curveScrub && t.pointerId === e.curveScrub.pointerId) {
    t.preventDefault();
    const f = Math.max(1, e.state.duration_frames - 1), d = f / (Number(e.curveZoomX) || 1), h = Number(e.curvePanX) || 0, b = Math.round(Q(h + (o - 44) / Math.max(1, a.clientWidth - 58) * d, 0, f));
    e.setFrame(b);
    return;
  }
  ...
  if (!e.curveDrag || t.pointerId !== e.curveDrag.pointerId) {
    const f = (e.curveHitPoints || []).map((x) => ({ point: x, distance: Math.hypot(o - x.x, r - x.y) })).sort((x, S) => x.distance - S.distance)[0], d = Math.max(1, e.state.duration_frames - 1), h = d / (Number(e.curveZoomX) || 1), b = Number(e.curvePanX) || 0, u = Math.max(1, a.clientWidth - 58), v = Q(Math.round(b + (o - 44) / u * h), 0, d);
    let y = null;
    if (f && f.distance <= 14) {
  ...
  if (e.curveHover = null, t.preventDefault(), t.stopPropagation(), e.curveDrag.historyCheckpointed || (e.checkpoint?.(e.curveDrag.handle ? "Edit curve tangent" : "Edit curve"), e.curveDrag.historyCheckpointed = !0), e.curveDrag.handle) {
    ...
    if (h === "in") {
      if (g.in_x = Q((o - v) / Math.max(1, b), -0.99, -0.01), g.in_y = (y - r) * u, S === "aligned") {
        const k = Math.hypot(g.in_x, g.in_y) || 1e-6, _ = Math.hypot(e.curveDrag.startHandles.out_x, e.curveDrag.startHandles.out_y) || 1e-6;
        g.out_x = -g.in_x / k * _, g.out_y = -g.in_y / k * _;
      }
    } else if (g.out_x = Q((o - v) / Math.max(1, b), 0.01, 0.99), g.out_y = (y - r) * u, S === "aligned") {
      const k = Math.hypot(g.out_x, g.out_y) || 1e-6, _ = Math.hypot(e.curveDrag.startHandles.in_x, e.curveDrag.startHandles.in_y) || 1e-6;
      g.in_x = -g.out_x / k * _, g.in_y = -g.out_y / k * _;
    }
  ...
  if (e.curveDrag.group) {
    ...
    if (d) {
      const b = e.curveDrag.group.map((v) => Q(Math.round(v.startFrame + d), 0, e.curveDrag.lastFrame));
  ...
  if (e.curveDrag.object) {
    const f = He(e.curveDrag.key.transform);
...
function Id(e, t) {
  ...
  if (t.shiftKey) {
    ...
    e.curvePanX = Q((Number(e.curvePanX) || 0) + (t.deltaY > 0 ? 4 : -4), -o * 0.5, o);
  } else t.altKey ? e.curvePanY = (Number(e.curvePanY) || 0) + (t.deltaY > 0 ? -1 : 1) / (Number(e.curveZoom) || 1) : t.ctrlKey ? e.curveZoomX = Q((Number(e.curveZoomX) || 1) * a, 0.2, 30) : (e.curveZoom = Q((Number(e.curveZoom) || 1) * a, 0.2, 30), e.curveZoomX = Q((Number(e.curveZoomX) || 1) * a, 0.2, 30));
  e.drawCurveEditor(), e.setStatus(s(`Curve zoom: ${(e.curveZoom * 100).toFixed(0)}%`));
}
function Od(e, t) {
  e.curveZoom = Q((Number(e.curveZoom) || 1) * t, 0.2, 30), e.curveZoomX = Q((Number(e.curveZoomX) || 1) * t, 0.2, 30), e.drawCurveEditor(), e.setStatus(s(`Curve zoom: ${(e.curveZoom * 100).toFixed(0)}%`));
}
function Pd(e, t) {
  t.preventDefault(), t.stopPropagation();
  const a = t.currentTarget, { x: o, y: r } = zr(a, t);
  if (r < 20) return;
  const n = Math.max(1, e.state.duration_frames - 1), i = n / (Number(e.curveZoomX) || 1), c = Number(e.curvePanX) || 0, l = Math.max(1, a.clientWidth - 58), p = Q(Math.round(c + (o - 44) / l * i), 0, n);
...
function Es(e, { selectedOnly: t = !1 } = {}) {
  const a = Math.max(1, (e.state?.duration_frames ?? 120) - 1), o = e.timelineKeyframes() || [], r = e.timelineObject(), n = pt(e), i = e.selectedKeyFrames?.size ? [...e.selectedKeyFrames] : e.selectedKeyFrame != null ? [e.selectedKeyFrame] : [], c = i.length > 0, l = t || c && i.length < o.length ? o.filter((u) => i.includes(u.frame)) : o;
  if (!l.length) {
  ...
  if (l.length < o.length && d < a) {
    ...
    e.curveZoomX = Q(a / x, 0.2, 30), e.curvePanX = v;
  } else
  ...
  if (h.length > 0) {
    const u = Math.min(...h), v = Math.max(...h), y = Math.max(1e-4, v - u), x = (u + v) / 2, S = (H) => r ? Do(r, H) : $e(e.state, H), g = [], k = Math.max(1, Math.floor(a / 40));
    for (let H = 0; H <= a; H += k) {
      const oe = S(H);
      for (const E of n) {
        const K = E.get(oe);
    ...
    let _ = Math.min(...g), I = Math.max(...g);
    (!Number.isFinite(_) || !Number.isFinite(I)) && (_ = -1, I = 1), Math.abs(I - _) < 1e-6 && (_ -= 1, I += 1);
    const P = (I - _) * 0.1;
    _ -= P, I += P;
    const B = I - _, W = (_ + I) / 2;
    if (l.length < o.length && y < B * 0.75) {
      const H = y * 1.35;
      e.curveZoom = Q(B / H, 0.2, 30), e.curvePanY = x - W;
    } else
...
function zd(e) {
  ...
  const i = e.timelineObject(), c = e.timelineKeyframes(), l = pt(e), p = 44, m = 14, f = 16, d = 22, h = Math.max(1, a - p - m), b = Math.max(1, o - f - d), u = Math.max(1, e.state.duration_frames - 1), v = Q(Number(e.curveZoomX) || 1, 0.1, 50), y = Number(e.curvePanX) || 0, x = u / v, S = y, g = y + x, k = [], _ = Math.max(1, Math.ceil(x / Math.max(80, h))), I = (A) => i ? Do(i, A) : $e(e.state, A);
  for (let A = 0; A <= u; A += _) k.push({ frame: A, value: I(A) });
  k[k.length - 1]?.frame !== u && k.push({ frame: u, value: I(u) });
  const P = k.flatMap((A) => l.map((G) => G.get(A.value)));
  let B = Math.min(...P), W = Math.max(...P);
  (!Number.isFinite(B) || !Number.isFinite(W)) && (B = -1, W = 1), Math.abs(W - B) < 1e-6 && (B -= 1, W += 1);
  const H = (W - B) * 0.1;
  B -= H, W += H;
  const oe = Q(Number(e.curveZoom) || 1, 0.1, 50), E = (W + B) / 2 + (Number(e.curvePanY) || 0), K = (W - B) / oe;
  B = E - K / 2, W = E + K / 2;
  const V = (A) => p + (A - S) / Math.max(1e-6, g - S) * h, X = (A) => f + b * (W - A) / Math.max(1e-6, W - B);
  if (n.fillStyle = "#111114", n.fillRect(0, 0, a, o), n.strokeStyle = "#222228", n.lineWidth = 1, n.font = "9px system-ui, -apple-system, sans-serif", n.fillStyle = "#6e727a", Sd(n, {
    left: p,
    right: m,
    top: f,
    width: a,
    ...
    xFor: V,
    frame: e.frame
  }), jd(n, { left: p, right: m, top: f, width: a, graphHeight: b, minimum: B, maximum: W, yFor: X }), B <= 0 && W >= 0) {
    const A = X(0);
    n.strokeStyle = "#383842", n.lineWidth = 1.2, n.beginPath(), n.moveTo(p, A), n.lineTo(a - m, A), n.stroke();
  }
  e.curveHitPoints = [];
  for (const A of l) {
    n.strokeStyle = A.color, n.lineWidth = 2, n.beginPath();
    let G = !1;
    k.forEach((F) => {
      const Y = V(F.frame), ee = X(A.get(F.value));
      Y >= p - 50 && Y <= a - m + 50 && (G ? n.lineTo(Y, ee) : (n.moveTo(Y, ee), G = !0));
    }), n.stroke();
    for (const F of c) {
      const Y = i ? F.transform : F.camera, ee = V(F.frame), le = X(A.get(Y)), se = F.frame === e.selectedKeyFrame || e.selectedKeyFrames?.has(F.frame);
      se && (n.fillStyle = "rgba(242, 208, 107, 0.35)", n.beginPath(), n.arc(ee, le, 8.5, 0, Math.PI * 2), n.fill()), n.fillStyle = se ? "#ffd75e" : A.color, n.strokeStyle = "#0d0d10", n.lineWidth = 1.6, n.beginPath(), n.arc(ee, le, se ? 5.2 : 3.8, 0, Math.PI * 2), n.fill(), n.stroke(), e.curveHitPoints.push({
        x: ee,
        y: le,
        key: F,
        channel: A,
    ...
    if (e.showCurveHandles)
      for (let F = 0; F < c.length; F++) {
        const Y = c[F], ee = Y.frame === e.selectedKeyFrame || e.selectedKeyFrames?.has(Y.frame);
        if (!(ee || e.curveChannelFilter !== "all" || c.length <= 4) || Y.interpolation !== "bezier") continue;
        const se = i ? Y.transform || i : Y.camera || Y, re = V(Y.frame), de = X(A.get(se)), ge = c[F - 1], he = c[F + 1], ye = Math.max(1, Y.frame - (ge?.frame ?? Y.frame - 1)), ve = Math.max(1, (he?.frame ?? Y.frame + 1) - Y.frame), pe = _i(
          Y,
          A.id,
          ge,
          he,
          (L) => A.get(i ? L.transform || i : L.camera || Y)
        ), Me = (W - B) / Math.max(1, b), xe = h * ve / Math.max(1, x), we = h * ye / Math.max(1, x), be = [];
        (ge || F > 0) && be.push({ side: "in", x: re + pe.in_x * we, y: de - pe.in_y / Me }), (he || F < c.length - 1 || c.length === 1) && be.push({ side: "out", x: re + pe.out_x * xe, y: de - pe.out_y / Me });
        for (const L of be) {
          if (n.strokeStyle = A.color, n.lineWidth = ee ? 1.5 : 1, n.beginPath(), n.moveTo(re, de), n.lineTo(L.x, L.y), n.stroke(), n.fillStyle = ee ? "#2a2233" : "#171720", n.strokeStyle = ee ? "#ffd75e" : A.color, n.lineWidth = ee ? 2 : 1.2, n.beginPath(), L.side === "in")
            n.arc(L.x, L.y, ee ? 5 : 3.8, 0, Math.PI * 2);
          else {
            const U = ee ? 4.5 : 3.2;
            n.rect(L.x - U, L.y - U, U * 2, U * 2);
          }
          n.fill(), n.stroke(), e.curveHitPoints.push({
            ...
            object: i,
            handle: L.side,
            pixelPerSegment: L.side === "in" ? we : xe,
            valuePerPixel: Me,
            startHandles: { ...pe }
          });
        }
  ...
  if (e.curveBoxSelect) {
    const A = Math.min(e.curveBoxSelect.startX, e.curveBoxSelect.currentX), G = Math.min(e.curveBoxSelect.startY, e.curveBoxSelect.currentY), F = Math.abs(e.curveBoxSelect.currentX - e.curveBoxSelect.startX), Y = Math.abs(e.curveBoxSelect.currentY - e.curveBoxSelect.startY);
    n.fillStyle = "rgba(56, 189, 248, 0.15)", n.fillRect(A, G, F, Y), n.strokeStyle = "#38bdf8", n.lineWidth = 1, n.setLineDash([4, 4]), n.strokeRect(A, G, F, Y), n.setLineDash([]);
  }
  const N = V(e.frame);
  if (N >= p && N <= a - m && (n.strokeStyle = "#a78bfa", n.lineWidth = 1.5, n.beginPath(), n.moveTo(N, f), n.lineTo(N, f + b), n.stroke(), n.fillStyle = "#a78bfa", n.beginPath(), n.moveTo(N - 4, f), n.lineTo(N + 4, f), n.lineTo(N, f + 6), n.closePath(), n.fill()), e.curveDrag || e.curveHover) {
    let A = "", G = "";
    if (e.curveDrag)
      if (e.curveDrag.handle) {
        const F = e.curveDrag.handle === "in" ? "In" : "Out";
        A = `F${e.curveDrag.key.frame} · ${e.curveDrag.channel.name} (${F})`, G = "Tangent edit";
      } else if (e.curveDrag.group && e.curveDrag.group.length > 1) {
        const F = e.curveDrag.key.frame - e.curveDrag.startFrame, Y = e.curveDrag.channel.get(e.curveDrag.object ? e.curveDrag.key.transform : e.curveDrag.key.camera), ee = Y - e.curveDrag.startValue, le = F >= 0 ? `+${F}` : `${F}`, se = ee >= 0 ? `+${ee.toFixed(2)}` : `${ee.toFixed(2)}`;
        A = `${e.curveDrag.group.length} keys · ΔF: ${le} · ΔVal: ${se}`, G = `${e.curveDrag.channel.name}: ${Y.toFixed(2)}`;
      } else {
        const F = e.curveDrag.key.frame - e.curveDrag.startFrame, Y = e.curveDrag.channel.get(e.curveDrag.object ? e.curveDrag.key.transform : e.curveDrag.key.camera), ee = Y - e.curveDrag.startValue, le = F >= 0 ? `+${F}` : `${F}`, se = ee >= 0 ? `+${ee.toFixed(2)}` : `${ee.toFixed(2)}`;
        A = `F${e.curveDrag.key.frame} (${le}) · ${e.curveDrag.channel.name}: ${Y.toFixed(2)} (${se})`;
      }
    else if (e.curveHover)
      if (e.curveHover.channelName) {
        const F = Number.isFinite(e.curveHover.value) ? e.curveHover.value.toFixed(2) : "";
        A = `F${e.curveHover.frame} · ${e.curveHover.channelName}: ${F}`, e.curveHover.isHandle && (G = `Handle ${e.curveHover.handleSide}`);
      } else
        A = `Frame ${e.curveHover.frame}`;
    if (A) {
      n.save(), n.font = "11px system-ui, -apple-system, sans-serif";
      const F = n.measureText(A), Y = G ? n.measureText(G) : { width: 0 }, ee = Math.max(F.width, Y.width) + 16, le = G ? 32 : 20, se = a - m - ee - 6, re = f + 6;
      n.fillStyle = "rgba(18, 18, 24, 0.88)", n.strokeStyle = "#38384a", n.lineWidth = 1, n.beginPath(), n.roundRect ? n.roundRect(se, re, ee, le, 4) : n.rect(se, re, ee, le), n.fill(), n.stroke(), n.fillStyle = "#e2e8f0", n.fillText(A, se + 8, re + (G ? 13 : 14)), G && (n.fillStyle = "#94a3b8", n.font = "9.5px system-ui, -apple-system, sans-serif", n.fillText(G, se + 8, re + 26)), n.restore();
    }
  }
  for (const A of e.root.querySelectorAll("[data-tangent-mode]")) {
    const G = e.selectedKeyframe(), F = G?.tangents?.channels?.[l[0]?.id]?.mode || G?.tangents?.mode || "auto";
    A.classList.toggle("active", A.dataset.tangentMode === F);
  }
  for (const A of e.root.querySelectorAll("[data-channel-filter]"))
    A.classList.toggle("active", A.dataset.channelFilter === (e.curveChannelFilter || "all"));
  for (const A of e.root.querySelectorAll("[data-curve-mode]"))
    A.classList.toggle("active", A.dataset.curveMode === e.selectedKeyframe()?.interpolation);
}
...
function As(e) {
  ...
  if (!t) return;
  const a = e.timelineObject(), o = a ? a.name || a.type : e.activeCameraTrack().name, r = Nd(e), n = `${o}\0${r.map((c) => `${c.id}:${c.color}`).join("|")}`;
  if (t.dataset.signature !== n) {
    t.dataset.signature = n, t.replaceChildren();
...
function mn(e, t, a) {
  ...
  for (const n of [...e].sort((i, c) => i.frame - c.frame)) {
    ...
    (r === null || !(Math.abs(c - r) <= Fd)) && o.push(n.frame), r = c;
  }
  return o;
}
function Nr(e) {
  ...
  const a = e.timelineKeyframes() || [], o = !!e.timelineObject(), r = e.selectedKeyFrames || (e.selectedKeyFrame === null ? /* @__PURE__ */ new Set() : /* @__PURE__ */ new Set([e.selectedKeyFrame])), n = pt(e), i = [
    e.state.duration_frames,
    Number(e.timelineZoom) || 1,
    Number(e.timelinePan) || 0,
...
function Rd(e) {
  e.checkpoint("Auto-split shots"), e.state.sequence = {
    ...
    enabled: !0,
    cuts: Ai(e.state)
  }, _t(e), e.setStatus(s("Split into {count} shots").replace("{count}", String(e.state.sequence.cuts.length)));
}
function fo(e, t, a, { disabled: o = !1 } = {}) {
...
function Dd(e, t) {
  ...
  if (a.appendChild(fo(
    ...
    () => Rd(e),
    { disabled: o }
  )), t.length && (a.appendChild(fo(
    s("Split at playhead"),
    s("Cut the current shot in two at the playhead"),
    () => {
      e.checkpoint("Split shot"), as(e.state, e.frame, null) ? _t(e) : e.setStatus(s("Move the playhead inside a shot first"));
    },
    { disabled: o }
  )), a.appendChild(fo(
    s("Clear edit"),
    ...
    () => {
      e.checkpoint("Clear edit"), e.state.sequence = { ...e.state.sequence, enabled: !1, cuts: [] }, _t(e), e.setStatus(s("Multi-camera edit cleared"));
    }
  ))), a.appendChild(fo(
...
function Bd(e, t, a, o, r) {
  t.preventDefault(), t.stopPropagation();
  const { camera: n } = Ts(e, a.camera_id);
  e.contextMenu?.show(t, n?.name || s("Shot"), [
    ...e.state.cameras.map((i) => ({
      ...
      run: () => {
        e.checkpoint("Change shot camera"), e.state.sequence.cuts[o].camera_id = i.id, _t(e);
      }
    })),
    null,
    {
      ...
      run: () => {
        e.checkpoint("Split shot"), as(e.state, e.frame, null) && _t(e);
      }
    },
    {
      label: s("Remove shot"),
      ...
      disabled: r === 1,
      run: () => {
        e.checkpoint("Remove shot"), Ci(e.state, o) && _t(e);
      }
    }
  ]);
}
function qd(e, t, a, o) {
  const { camera: r, color: n } = Ts(e, t.camera_id), i = document.createElement("div");
  ...
  if (c.className = "oc-sequence-name", c.textContent = r?.name || t.camera_id, i.appendChild(c), a > 0) {
    ...
    l.className = "oc-sequence-handle", l.title = s("Drag to trim the cut"), l.addEventListener("pointerdown", (p) => Kd(e, p, l, o, a)), i.appendChild(l);
  }
  return i.addEventListener("contextmenu", (l) => Bd(e, l, t, a, o.__cutCount)), i.addEventListener("pointerdown", () => {
...
function Ms(e, t) {
  ...
  if (n.className = "oc-sequence-lane", n.dataset.role = "sequence-lane", n.setAttribute("aria-label", s("Multi-camera edit")), o.length)
    for (const [c, l] of o.entries()) {
      ...
      ue(e, l.end + 1) < -5 || p > 105 || n.appendChild(qd(e, l, c, r));
    }
  else {
    const c = document.createElement("span");
  ...
  r.appendChild(n), r.appendChild(Ud(e));
  const i = document.createElement("span");
  i.className = "oc-sequence-playhead", i.style.left = `${ue(e, e.frame)}%`, r.appendChild(i), t.appendChild(r);
}
const Wd = ['[data-act="curve-zoom-in"]', '[data-act="curve-zoom-out"]', '[data-act="curve-fit"]', '[data-act="curve-handles"]'], fn = { curves: "Graph", dope: "Timeline", sequence: "Sequence" };
function hn(e, t) {
  ...
  a === "dope" ? Nr(e) : a === "sequence" ? (Ms(e, n), n?.focus?.({ preventScroll: !0 })) : e.drawCurveEditor(), e.setStatus(s(fn[a]));
}
function Vd(e) {
  e.graphTab === "sequence" && Ms(e, e.root.querySelector('[data-role="graph-sequence"]'));
}
function Hd(e, t) {
...
const Gd = /* @__PURE__ */ new Set(["good", "warning", "bad", "unknown"]);
function Is(e, t) {
  ...
  for (const n of r.frames) {
    ...
    const c = Gd.has(n?.state) ? n.state : "unknown", l = n?.score;
    let p = null;
    if (l != null) {
      const m = Number(l);
...
function Xd(e) {
  ...
  if (!t || !a) return;
  const o = Is(e.state?.metadata, e.state?.duration_frames), r = o.some((c) => c.state !== "unknown");
...
function Jd(e) {
  ...
  if (!t) return;
  t.innerHTML = "";
  const a = e.timelineObject(), o = e.timelineKeyframes(), r = Math.max(1, e.state.duration_frames - 1), n = Q(Number(e.timelineZoom) || 1, 0.1, 50), i = Number(e.timelinePan) || 0, c = r / n, l = i;
  if (e.audioWaveformPeaks && e.audioWaveformPeaks.length) {
    ...
    const S = x.getContext("2d"), g = e.audioWaveformPeaks, k = x.width, _ = x.height, I = _ / 2;
    S.fillStyle = "#f2d06b";
    for (let P = 0; P < g.length; P++) {
      const W = (P / (g.length - 1) * r - l) / Math.max(1e-6, c) * k;
      if (W >= -5 && W <= k + 5) {
        const H = g[P] * (_ * 0.85);
        S.fillRect(W, I - H / 2, Math.max(1, k / g.length * n - 0.5), H);
      }
    }
    t.appendChild(x);
  }
  ...
  for (const x of o) {
    ...
    k.className = "key-label", k.textContent = String(x.frame), g.appendChild(k), g.addEventListener("pointerdown", (_) => {
      if (_.preventDefault(), _.stopPropagation(), g.focus({ preventScroll: !0 }), _.altKey) {
        e.checkpoint("Duplicate keyframe");
        const P = a ? { frame: x.frame, transform: He(x.transform), interpolation: x.interpolation } : { frame: x.frame, camera: ce(x.camera), interpolation: x.interpolation }, B = e.timelineKeyframes();
        B.push(P), B.sort((W, H) => W.frame - H.frame), e.selectedKeyFrame = P.frame, e.selectedKeyFrames = /* @__PURE__ */ new Set([P.frame]), e.keyDrag = { key: P, box: t, isDuplicate: !0, historyCheckpointed: !0, moving: [{ key: P, startFrame: P.frame }], startPointerFrame: x.frame, startClientX: _.clientX, startClientY: _.clientY }, e.setFrame(P.frame, !1, !1), e.setStatus(s(`Duplicating key from ${x.frame}...`));
        return;
      }
      if (_.shiftKey) {
      ...
      const I = e.timelineKeyframes().filter((P) => e.selectedKeyFrames.has(P.frame));
      e.keyDrag = { key: x, box: t, historyCheckpointed: !1, moving: I.map((P) => ({ key: P, startFrame: P.frame })), startPointerFrame: x.frame, startClientX: _.clientX, startClientY: _.clientY }, e.setFrame(x.frame, !1, !1);
  ...
  if (f) {
    ...
    const g = o.filter((k) => k.frame > e.state.duration_frames - 1).length;
    if (g) {
      const k = document.createElement("span");
      k.className = "oc-dormant-keys", k.textContent = ` · ${g} beyond end`, k.title = s("Keys past the end of the timeline are kept. Lengthen the shot to reach them again."), f.append(k);
    }
  }
  ...
  if (b) {
    ...
    for (const x of e.state.cameras) {
      ...
      const k = document.createElement("span");
      k.textContent = `${x.name} · ${x.keyframes.length} key${x.keyframes.length === 1 ? "" : "s"}${x.id === e.state.playblast_camera_id ? " · PLAYBLAST" : ""}`, S.append(g, k), S.addEventListener("click", () => {
  ...
  y && (y.textContent = m.name), Cs(e), ks(e), As(e), Nr(e), Vd(e), e.refreshCameraSelectors(), e.refreshKeyEditor(), e.updateEditState(), e.drawCurveEditor(), e.perf && (e.perf.timelineRefreshCount = (e.perf.timelineRefreshCount || 0) + 1), Xd(e);
}
class Os {
...
const nm = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/><path d="M2 12h20"/></svg>', sm = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m21 16-9 5-9-5V8l9-5 9 5v8z"/><path d="m3.27 6.96 8.73 4.84 8.73-4.84"/><path d="M12 22V12"/></svg>', im = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2L2 20h20L12 2z"/><path d="M12 2v18"/></svg>', cm = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/><path d="m17.66 17.66 1.41 1.41"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="m6.34 17.66-1.41 1.41"/><path d="m19.07 4.93-1.41 1.41"/></svg>', lm = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18h6"/><path d="M10 22h4"/><path d="M15.09 14c.18-.98.65-1.74 1.41-2.5A4.65 4.65 0 0 0 18 8 6 6 0 0 0 6 8c0 1 .23 2.23 1.5 3.5.76.76 1.23 1.52 1.41 2.5"/></svg>', dm = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l8 8-4 4-8-8 4-4z"/><path d="M7 11L2 16l6 6 5-5"/><path d="M18 19l4 2"/><path d="M21 16l2 2"/></svg>', mm = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m22 8-6 4 6 4V8z"/><rect width="14" height="12" x="2" y="6" rx="2"/></svg>', pm = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14h6v6H4z"/><circle cx="17" cy="7" r="3"/><path d="m6 3 4 7H2z"/></svg>';
function fm() {
  return `
...
function ym() {
  const e = jl.map((t) => `<button data-lens="${t}">${t}mm</button>`).join("");
  return `
  ...
  return `
    <div class="oc-dope">
      <div class="oc-dope-body">
        <div class="oc-dope-labels">${ws.map((t) => `
...
const et = 1, bn = 50, Ie = 120, ut = 160, Fm = Object.freeze(["perspective", "orthographic"]), q = Object.freeze({
...
}), zs = Object.freeze(Object.values(q)), ke = Object.freeze({
  SCENE_GET: "scene.get",
...
}), Rm = Object.freeze(Object.values(ke));
...
const Dm = 25, gn = 100;
function bt(e, t) {
  const a = e?.offset === void 0 ? 0 : Number(e.offset), o = e?.limit === void 0 ? Dm : Number(e.limit);
...
function qm(e, t) {
  ...
  switch (t?.type) {
    ...
    case ke.CAMERA_GET: {
      ...
      return je(e, { version: 1, type: t.type, camera: Je(r) });
    }
    case ke.CAMERA_LIST: {
      const o = a.cameras || [], { offset: r, limit: n, end: i } = bt(t, o.length);
      return je(e, {
        version: 1,
        type: t.type,
        items: o.slice(r, i).map(Km),
        total: o.length,
        offset: r,
        limit: n
      });
    ...
    case ke.HEALTH_GET:
      return je(e, {
        version: 1,
        type: t.type,
        frames: Is(a.metadata, a.duration_frames)
      });
    case ke.ASSET_LIST: {
      ...
      return je(e, { version: 1, type: t.type, items: Je(r), total: r.length });
    }
    case ke.ASSET_GET: {
    ...
    case ke.OBJECT_LIST: {
      const o = a.objects || [], { offset: r, limit: n, end: i } = bt(t, o.length);
      return je(e, {
        version: 1,
        type: t.type,
    ...
    case ke.OBJECT_SEARCH: {
      ...
      }, p = (a.objects || []).filter(l), { offset: m, limit: f, end: d } = bt(t, p.length);
      return je(e, {
        version: 1,
        type: t.type,
    ...
    case ke.CHARACTER_LIST: {
      const o = (a.objects || []).filter((c) => c.asset_kind === "character"), { offset: r, limit: n, end: i } = bt(t, o.length);
      return je(e, {
        version: 1,
        type: t.type,
    ...
    case ke.SHOT_LIST: {
      ...
      })), { offset: i, limit: c, end: l } = bt(t, n.length);
      return je(e, {
        version: 1,
        type: t.type,
        items: n.slice(i, l),
    ...
    case ke.KEYFRAME_LIST: {
      ...
      if (!r) throw new O("UNKNOWN_CAMERA", `Unknown camera: ${o}`);
      const n = r.keyframes || [], { offset: i, limit: c, end: l } = bt(t, n.length);
      return je(e, {
        version: 1,
        type: t.type,
        cameraId: r.id,
...
function Xm(e, t) {
  if (!Ns.has(t.objectType))
    throw new O("UNSUPPORTED_OBJECT_TYPE", `object.create does not support type: ${t.objectType}`);
  e.objects ||= [];
  const a = new Set(e.objects.map((i) => i.id)), o = Bo(a, t.objectType, t.id), r = Um(t.objectType), n = {
    id: o,
    type: t.objectType,
    name: t.name || o,
    ...r,
...
function np(e, t) {
  ...
  for (a.has(t) && a.delete(t), a.add(t); a.size > rp; )
    a.delete(a.values().next().value);
}
function sp(e, t) {
  return !!e._directorApiTxIds?.has(t);
}
const ct = (e) => typeof e == "number" && Number.isFinite(e);
function Ae(e, t, a) {
  if (!Array.isArray(e) || e.length !== 3 || !e.every(ct))
...
function cp(e, t) {
  ...
  if (e.position !== void 0 && Ae(e.position, "camera.position", t), e.target !== void 0 && Ae(e.target, "camera.target", t), e.up !== void 0 && Ae(e.up, "camera.up", t), e.fov !== void 0 && (Dt(e.fov, "camera.fov", t), e.fov < 1 || e.fov > 179))
    throw new O("BAD_VALUE", "camera.fov must be within 1..179", t);
  if (e.roll !== void 0 && Dt(e.roll, "camera.roll", t), e.zoom !== void 0 && (Dt(e.zoom, "camera.zoom", t), e.zoom <= 0))
    throw new O("BAD_VALUE", "camera.zoom must be > 0", t);
  if (e.near !== void 0 && (Dt(e.near, "camera.near", t), e.near <= 0))
    throw new O("BAD_VALUE", "camera.near must be > 0", t);
  if (e.far !== void 0) {
    Dt(e.far, "camera.far", t);
    const a = e.near === void 0 ? $i : e.near;
    if (e.far <= a)
      throw new O("BAD_VALUE", "camera.far must be greater than camera.near", t);
  }
  if (e.camera_type !== void 0 && !Fm.includes(e.camera_type))
...
function lp(e, t) {
  ...
  switch (a) {
    case q.ASSET_INSTANTIATE: {
      ...
      if (ae(o.id, "asset.id", t), ae(o.kind, "asset.kind", t), String(o.id).length > 120 || String(o.kind).length > 32)
      ...
      e.point !== void 0 && Ae(e.point, "point", t), e.id !== void 0 && ae(e.id, "id", t);
      break;
    }
    case q.CAMERA_SET_ACTIVE:
      ae(e.cameraId, "cameraId", t);
      break;
    case q.CAMERA_SET_LOCKED:
      if (ae(e.cameraId, "cameraId", t), typeof e.value != "boolean")
        throw new O("BAD_VALUE", "camera.set_locked needs a boolean value", t);
      break;
    case q.CAMERA_CREATE:
      if (e.id !== void 0 && ae(e.id, "id", t, Ie), e.name !== void 0 && ae(e.name, "name", t, ut), e.camera !== void 0) {
      ...
      if (e.interpolation !== void 0 && !_o.includes(e.interpolation))
        throw new O("BAD_INTERPOLATION", `Unsupported interpolation: ${e.interpolation}`, t);
      break;
    case q.CAMERA_DUPLICATE:
      ae(e.cameraId, "cameraId", t, Ie), e.id !== void 0 && ae(e.id, "id", t, Ie), e.name !== void 0 && ae(e.name, "name", t, ut);
      break;
    case q.CAMERA_DELETE:
    case q.CAMERA_SET_PLAYBLAST:
      ae(e.cameraId, "cameraId", t, Ie);
      break;
    case q.CAMERA_RENAME:
      ae(e.cameraId, "cameraId", t, Ie), ae(e.name, "name", t, ut);
      break;
    case q.OBJECT_CREATE:
      if (ae(e.objectType, "objectType", t), !Ns.has(e.objectType))
      ...
      e.id !== void 0 && ae(e.id, "id", t, Ie), e.name !== void 0 && ae(e.name, "name", t, ut), e.position !== void 0 && Ae(e.position, "position", t), e.rotation !== void 0 && Ae(e.rotation, "rotation", t);
      break;
    case q.OBJECT_DUPLICATE:
      ae(e.objectId, "objectId", t, Ie), e.id !== void 0 && ae(e.id, "id", t, Ie), e.name !== void 0 && ae(e.name, "name", t, ut), e.offset !== void 0 && Ae(e.offset, "offset", t);
      break;
    case q.OBJECT_DELETE:
      ae(e.objectId, "objectId", t, Ie);
      break;
    case q.OBJECT_RENAME:
      ae(e.objectId, "objectId", t, Ie), ae(e.name, "name", t, ut);
      break;
    case q.OBJECT_SET_PARENT:
      ae(e.objectId, "objectId", t, Ie), e.parentId !== null && e.parentId !== void 0 && ae(e.parentId, "parentId", t, Ie);
      break;
    case q.CAMERA_TRANSFORM:
      if (e.cameraId !== void 0 && ae(e.cameraId, "cameraId", t), e.position !== void 0 && Ae(e.position, "position", t), e.target !== void 0 && Ae(e.target, "target", t), e.frame !== void 0 && Be(e.frame, "frame", t), e.position === void 0 && e.target === void 0)
        throw new O("EMPTY_OPERATION", "camera.transform needs position and/or target", t);
      break;
    case q.CAMERA_LOOK_AT:
      if (e.cameraId !== void 0 && ae(e.cameraId, "cameraId", t), e.point !== void 0 && Ae(e.point, "point", t), e.objectId !== void 0 && e.objectId !== null && ae(e.objectId, "objectId", t), e.point === void 0 && e.objectId === void 0)
        throw new O("EMPTY_OPERATION", "camera.look_at needs a point or an objectId", t);
      break;
    case q.OBJECT_TRANSFORM:
      if (ae(e.objectId, "objectId", t), e.position !== void 0 && Ae(e.position, "position", t), e.rotation !== void 0 && Ae(e.rotation, "rotation", t), e.scale !== void 0 && Ae(e.scale, "scale", t), e.position === void 0 && e.rotation === void 0 && e.scale === void 0)
    ...
    case q.OBJECT_SET_LOCKED:
      if (ae(e.objectId, "objectId", t), typeof e.value != "boolean")
        throw new O("BAD_VALUE", `${a} needs a boolean value`, t);
      break;
    case q.OBJECT_SET_TAGS:
      if (ae(e.objectId, "objectId", t), !Array.isArray(e.tags) || e.tags.some((o) => typeof o != "string"))
    ...
    case q.KEYFRAME_UPSERT:
      if (e.cameraId !== void 0 && ae(e.cameraId, "cameraId", t), Be(e.frame, "frame", t), e.interpolation !== void 0 && !_o.includes(e.interpolation))
        throw new O("BAD_INTERPOLATION", `Unsupported interpolation: ${e.interpolation}`, t);
      if (e.camera !== void 0) {
        ...
        for (const o of ["fov", "roll", "zoom", "near", "far"])
          if (e.camera[o] !== void 0 && !ct(e.camera[o]))
            throw new O("BAD_VALUE", `camera.${o} must be finite`, t);
      }
      break;
    case q.KEYFRAME_REMOVE:
      e.cameraId !== void 0 && ae(e.cameraId, "cameraId", t), Be(e.frame, "frame", t);
      break;
    case q.KEYFRAME_SET_INTERPOLATION:
      if (e.cameraId !== void 0 && ae(e.cameraId, "cameraId", t), Be(e.frame, "frame", t), !_o.includes(e.interpolation))
        throw new O("BAD_INTERPOLATION", `Unsupported interpolation: ${e.interpolation}`, t);
      break;
    case q.TIMELINE_SET_RANGE:
      if (Be(e.start, "start", t), Be(e.end, "end", t), e.end < e.start)
    ...
    case q.TIMELINE_SET_DURATION:
      ...
      break;
    case q.CUT_UPSERT:
      Be(e.start, "start", t), ae(e.cameraId, "cameraId", t);
      break;
    case q.CUT_REMOVE:
      Be(e.start, "start", t);
      break;
    case q.CUT_SET_CAMERA:
      Be(e.start, "start", t), ae(e.cameraId, "cameraId", t);
      break;
    default:
      throw new O("UNKNOWN_OPERATION", `Unknown operation type: ${a}`, t);
...
function dp(e, t) {
  ...
  return t.operations.forEach((a, o) => lp(a, o)), {
    version: et,
    id: t.id,
...
const pp = "omnicam/library", fp = "majoor_omnicam/blockout_library", hp = Object.freeze({
...
function Fs(e) {
  return e.file ? `${e.source === "legacy" ? fp : pp}/${e.file} [input]` : "";
}
function yn(e, t, a) {
  const o = e || "asset";
  let r = `${o}_${a}`, n = 2;
...
function gp(e, t = {}) {
  ...
  const a = up(t.point, [0, 0, 0]), o = String(t.idSeed || Date.now().toString(36)), r = String(e.kind || "prop"), n = r === "character", i = hp[e.id];
  ...
  return n && (c.character = bp(e)), c;
}
function yp({ groundHit: e, orbitTarget: t } = {}) {
...
const vp = {
  [q.ASSET_INSTANTIATE](e, t) {
    ...
    let o;
    try {
      o = gp(t.asset, { point: t.point, idSeed: t.id, existingIds: a });
    } catch (r) {
  ...
  [q.OBJECT_SET_ENABLED](e, t) {
    return it(e, t.objectId).enabled = t.value, { dirtyMask: T.viewport | T.previews | T.outliner | T.inspector };
  },
  [q.OBJECT_SET_LOCKED](e, t) {
    return fr(e, t.objectId).locked = t.value, { dirtyMask: T.outliner | T.inspector };
  },
  [q.OBJECT_SET_TAGS](e, t) {
    const a = it(e, t.objectId), o = Oi(t.tags), r = o.length !== t.tags.length ? "some tags were dropped or normalised" : void 0;
    return o.length ? a.tags = o : delete a.tags, { dirtyMask: T.outliner | T.inspector | T.viewport, warning: r };
  },
  [q.OBJECT_SET_ANNOTATION](e, t) {
    const a = it(e, t.objectId), o = t.annotation === null ? null : os(t.annotation);
    if (t.annotation && !o)
  ...
  [q.CHARACTER_SET_JOINT_ROTATION](e, t) {
    ...
    return a.character = {
      ...a.character || {},
      pose: Ii(a.character?.pose, t.joint, t.rotation)
    }, { dirtyMask: T.viewport | T.previews | T.inspector };
  },
  [q.CHARACTER_SET_MOTION](e, t) {
    const a = ho(e, t.objectId), o = Tr(t.motion);
  ...
  [q.KEYFRAME_UPSERT](e, t) {
    ...
    const r = !o;
    if (!o) {
      const i = uo(a, 0)?.camera || a.camera || {};
  ...
  [q.KEYFRAME_REMOVE](e, t) {
    const a = yt(e, t.cameraId), o = (a.keyframes || []).length;
  ...
  [q.KEYFRAME_SET_INTERPOLATION](e, t) {
    const a = yt(e, t.cameraId), o = uo(a, t.frame);
    if (!o) throw new O("UNKNOWN_KEYFRAME", `camera has no key at frame ${t.frame}`);
    if (!_o.includes(t.interpolation))
...
function kp(e, t) {
  ...
  return jp(e, t, r), Cp(e, t, r), Ap(e, t, r), Ep(e, t, r), Tp(e, t, r), $p(e, t, r), { changes: a, truncated: o };
}
const Sp = ["fov", "roll", "zoom", "near", "far", "camera_type"];
function jp(e, t, a) {
  const o = tt(e?.cameras), r = tt(t?.cameras);
...
const _p = ["position", "target", "fov", "roll", "zoom", "near", "far", "camera_type"];
function Cp(e, t, a) {
  const o = tt(e?.cameras), r = tt(t?.cameras);
  for (const [n, i] of r) {
...
function Ep(e, t, a) {
  const o = tt(e?.objects), r = tt(t?.objects);
  for (const [n, i] of r) {
...
async function Pp(e, t, a) {
  const o = a.some((i) => i.resourceRefresh === !0), r = t.operations.filter((i) => i.type === q.OBJECT_DELETE).map((i) => i.objectId);
  for (const i of r)
    e.removeObjectResources?.(i);
  const n = t.operations.some((i) => i.type === q.ASSET_INSTANTIATE);
...
function zp(e, t) {
  ...
  if (a.validateOnly) {
    const { changes: f, truncated: d } = kp(e.state, r);
    return {
      ok: !0,
      version: et,
      revision: o,
  ...
  const l = Ip(e);
  np(e, a.id), e.serialize?.(), Op(e, l), Lp(e, n, `director-api:${a.id}`);
  const p = {
    ok: !0,
    version: et,
    baseRevision: o,
...
function Fp(e) {
  return e.directorApi = Np(e), e.directorApi;
}
const xn = "omnicam-agent/1", wn = "majoor.omnicam.agent.request", Rp = 1, Kt = Object.freeze({
...
}), Dp = 1e4, Kp = 5e3, Rs = "asset.instantiate_by_id", Ds = "asset.catalog_search", kn = Object.freeze([
  ...zs.filter((e) => e !== q.ASSET_INSTANTIATE),
  Rs
]);
function br(e) {
...
function Wp(e, t, a) {
  ...
  async function d() {
    ...
    try {
      const k = await Bt(a, Kt.register, {
        protocol: xn,
        client_id: g,
        node_id: String(t.id),
      ...
      if (o || S !== p) return;
      r = k.session_id, n = k.session_token, i = g, b();
    } catch {
      if (o || S !== p) return;
      h();
    }
  ...
  async function v(S) {
    const g = S?.detail;
    if (o || !g || g.protocol !== xn || Number(g.schema_version) !== Rp || g.session_id !== r || String(g.node_id) !== String(t.id)) return;
    let k;
    try {
      if (g.kind === "query")
        k = g.payload?.type === Ds ? await Up(e, g.payload) : e.directorApi.query(g.payload);
      else if (g.kind === "transaction") {
        const _ = g.payload, I = (_?.operations || []).find(
          (P) => !kn.includes(P?.type)
        );
        if (!Number.isInteger(_?.baseRevision) || _.baseRevision < 0)
          ...
          k = qt(
            ...
            `External Agent transactions cannot use operation: ${I?.type}`
          );
        else {
          const P = await qp(e, _.operations);
          P.ok ? (k = e.directorApi.execute({ ..._, operations: P.operations }), await k?._reconciliation) : k = qt(e, P.code, P.message);
        }
      } else
        k = qt(e, "UNKNOWN_AGENT_REQUEST", `Unsupported Agent request kind: ${g.kind}`);
    } catch (_) {
      k = qt(e, _?.code || "INTERNAL", _?.message || "OmniCam Agent request failed");
    }
    try {
      await Bt(a, Kt.reply, {
        session_id: r,
  ...
  return a.addEventListener?.(wn, v), a.addEventListener?.("status", x), d(), {
    ...
    dispose() {
      ...
      const S = r, g = n;
      r = null, n = null, S && g && Bt(a, Kt.close, {
        session_id: S,
        session_token: g
      }).catch(() => {
      });
...
function Rr({ fetchApi: e = Vp } = {}) {
  const t = (a, o) => Promise.resolve(e(a, o)).then(Hp);
  return {
    list(a = {}) {
...
const Ks = Object.freeze(["all", "character", "prop", "environment", "vehicle"]);
function jn(e = {}) {
  const t = String(e.kind || "all").toLowerCase();
  return {
    kind: Ks.includes(t) ? t : "all",
...
const Zp = 256;
function _n(e = {}) {
  const { THREE: t, GLTFLoader: a, FBXLoader: o, size: r = Zp } = e;
  if (!t || !a)
...
function of(e, t = {}) {
  return Ks.map((a) => {
    const o = s(af[a] || a), r = a === "all" ? "" : ` <span class="oc-asset-kind-n">${Number(t[a] || 0)}</span>`;
    return `<button type="button" class="oc-asset-kind${a === (e || "all") ? " active" : ""}" data-asset-kind="${a}">${St(o)}${r}</button>`;
  }).join("");
}
function rf(e, { selected: t = !1, thumbUrl: a = "" } = {}) {
  const o = tf[e.kind] || "pi-box", r = e.kind === "character" && rs(e.rig) === "rigged" ? `<span class="oc-asset-badge">${s("RIGGED")}</span>` : "", n = a ? `<img class="oc-asset-thumb" src="${St(a)}" alt="" loading="lazy">` : `<span class="oc-asset-thumb oc-asset-thumb--glyph"><i class="pi ${o}"></i></span>`;
...
function nf(e, { selectedId: t = "", thumbUrls: a = {} } = {}) {
  return !e || !e.length ? `<p class="oc-asset-empty">${s("No assets match this filter.")}</p>` : e.map((o) => rf(o, {
    selected: o.id === t,
    thumbUrl: a[o.id] || ""
  })).join("");
}
...
function sf(e, t = {}) {
  const a = e.root, o = t.fetchApi || ((L, U) => (e.api || e.app?.api).fetchApi(L, U)), r = t.apiClient || Rr({ fetchApi: o }), n = t.store || Yp(r), i = Xp(), c = t.previewQueue || Jp(), l = e.api || e.app?.api || null;
  let p = t.thumbnailRenderer || null, m = null;
  const f = /* @__PURE__ */ new Set();
  function d() {
    return p ? Promise.resolve(p) : (m || (m = Qp().then((L) => p = _n(L)).catch(() => p = _n({}))), m);
  }
  function h(L) {
    return Qr(l, Fs(L));
  }
  function b(L) {
    return L.thumbnail ? Qr(l, `omnicam/library/${L.thumbnail} [input]`) : "";
  }
  function u() {
    for (const L of n.state.items) {
      if (L.kind === "helper" || !L.file || i.get(L.id) || L.thumbnail || f.has(L.id)) continue;
      const U = h(L);
      U && c.enqueue(L.id, async () => {
        const _e = await (await d()).render(U, L.format || "glb");
        if (!_e) {
          f.add(L.id);
          return;
        }
        if (i.set(L.id, _e), Y(), !(L.source && L.source !== "user"))
          try {
            const Oe = await r.uploadThumbnail(L.id, ef(_e));
  ...
  const v = (L) => a.querySelector(`[data-role="${L}"]`), y = v("assets-panel"), x = v("asset-grid"), S = v("asset-kinds"), g = v("asset-search"), k = v("asset-status"), _ = v("asset-import-file"), I = v("scene-tab"), P = v("assets-tab"), B = v("agent-tab"), W = a.querySelector('[data-asset-view="agent"]'), H = { assets: P, agent: B };
  let oe = "", E = null, K = !0, V = !0, X = "scene", N = 0;
  function A(L, { sticky: U = !1 } = {}) {
    k && (!U && N > Date.now() || (k.textContent = L || "", N = U ? Date.now() + 9e3 : 0));
  }
  function G(L) {
    if (oe = L, !!x)
      for (const U of x.querySelectorAll(".oc-asset-card"))
        U.classList.toggle("selected", U.dataset.assetId === L);
  }
  let F = !1;
  function Y() {
    if (S && (S.innerHTML = of(n.state.filter.kind, n.state.kinds)), x) {
      const L = {};
      for (const U of n.state.items) {
        const me = i.get(U.id) || b(U);
        me && (L[U.id] = me);
      }
    ...
    n.state.error ? A(n.state.error.message) : n.state.loading ? A(s("Loading assets...")) : A(s("{n} of {total} assets").replace("{n}", n.state.items.length).replace("{total}", n.state.total));
  }
  function ee(L) {
    if (!L) return;
    const U = yp({
      ...
      operations: [{ type: "asset.instantiate", asset: L, point: U }]
    });
    if (!me?.ok) {
    ...
    _e && (e.selectedEntity = "object", e.selectedObjectId = _e, e.selectedObjectIds = /* @__PURE__ */ new Set([_e]), e.selectedKeyFrame = null), e.restoreAssets?.(), e.refreshObjects?.(), e.refreshInspector?.(), e.render?.(), e.setStatus?.(s("{name} added").replace("{name}", L.name));
  }
  async function le(L) {
    if (L) {
      A(s("Importing {name}...").replace("{name}", L.name));
      try {
        const U = await r.importModel(L, { kind: "prop", name: L.name.replace(/\.[^.]+$/, "") });
        U.asset && n.upsert(U.asset), A(s("Imported {name}").replace("{name}", U.asset?.name || L.name));
      } catch (U) {
        A(U.message || s("Import failed"));
      }
    }
  }
  ...
  async function he(L) {
    ...
    if (!U) {
      A(s("Point to the folder you extracted the pack into."), { sticky: !0 });
      return;
    }
    N = 0, A(L ? s("Scanning {folder}...").replace("{folder}", U) : s("Installing characters from {folder}...").replace("{folder}", U));
    try {
      ...
      if (L) {
        const Pe = (me.candidates || []).map((rt) => rt.name).join(", ");
        A(
          (me.candidates || []).length ? s("{n} rig-complete character(s): {names}").replace("{n}", me.candidates.length).replace("{names}", Pe) : s("No rig-complete .glb/.fbx character found ({n} skipped)").replace("{n}", _e),
          { sticky: !0 }
        );
        return;
      }
      const Oe = (me.installed || []).filter((Pe) => Pe.status !== "conflict").length, De = (me.installed || []).filter((Pe) => Pe.status === "conflict").length;
      A(
        s("{n} character(s) installed{extra} — no restart needed").replace("{n}", Oe).replace("{extra}", _e || De ? ` (${_e} ${s("skipped")}${De ? `, ${De} ${s("unchanged")}` : ""})` : ""),
        { sticky: !0 }
      ), Oe && (n.refresh(), se && (se.hidden = !0));
    } catch (me) {
      A(me.message || s("Import failed"), { sticky: !0 });
    }
  }
  function ye(L) {
    L === "agent" && !ir() && (L = "scene"), X = L, I && (I.hidden = L !== "scene");
    for (const [U, me] of Object.entries(H))
      me && (me.hidden = U !== L);
    for (const U of a.querySelectorAll("[data-asset-view]"))
      U.classList.toggle("active", U.dataset.assetView === L);
    L === "assets" && K && (K = !1, n.refresh()), L === "agent" && V && (V = !1, t.onAgentFirstOpen?.());
  }
  function ve() {
    const L = ir();
    W && (W.hidden = !L), !L && X === "agent" && ye("scene");
  }
  function pe(L) {
    const U = Cn(L.target);
    if (U) {
      if (U.action === "switch-view") return ye(U.view);
      if (U.action === "filter-kind") return void n.setFilter({ kind: U.kind });
      if (U.action === "asset-add")
        return ee(n.get(oe));
      if (U.action === "asset-import")
        return _?.click();
      if (U.action === "local-toggle") return ge();
      if (U.action === "local-scan") return void he(!0);
      if (U.action === "local-install") return void he(!1);
      U.action === "card" && G(U.assetId);
    }
  }
  function Me(L) {
    const U = Cn(L.target);
    U?.action === "card" && ee(n.get(U.assetId));
  }
  function xe() {
    clearTimeout(E), E = setTimeout(() => n.setFilter({ search: g.value }), 200);
  }
  function we(L) {
    const U = L.target.files?.[0];
    L.target.value = "", le(U);
  }
  const be = n.subscribe(Y);
  return y?.addEventListener("click", pe), y?.addEventListener("dblclick", Me), a.querySelector('[data-role="left-tabs"]')?.addEventListener("click", pe), g?.addEventListener("input", xe), _?.addEventListener("change", we), Y(), ve(), {
    store: n,
    switchView: ye,
    syncAgentAvailability: ve,
    refresh: () => n.refresh(),
    dispose() {
      be(), clearTimeout(E), y?.removeEventListener("click", pe), y?.removeEventListener("dblclick", Me), a.querySelector('[data-role="left-tabs"]')?.removeEventListener("click", pe), g?.removeEventListener("input", xe), _?.removeEventListener("change", we), c.clear(), p?.dispose?.(), i.clear();
    }
  };
}
function cf(e, t = {}) {
  ...
  function l() {
    ...
    let u = 0;
    for (const v of b) {
      if (!ns(v, { mode: n.mode, selectedIds: d })) continue;
      const y = ss(v, n.content);
      if (!y) continue;
      const x = is(b, v, h) || {
        position: v.position,
        size: v.size
      }, S = e.webgl.projectWorldToScreen(cs(x, v.type));
      ...
      const k = n.content === "annotation" ? v.annotation?.color : "";
      g.style.setProperty("--oc-label-accent", k || ""), g.classList.toggle("is-annotation", n.content === "annotation" && !!k);
    }
...
function hf(e, t = {}) {
  const a = e.root, o = t.apiClient || Rr({
    fetchApi: (E, K) => (e.api || e.app?.api).fetchApi(E, K)
  }), r = a.querySelector('[data-role="pose-editor"]');
  if (!r) return { sync() {
  }, update() {
  }, dispose() {
  } };
  const n = r.querySelector('[data-role="pose-preset"]'), i = r.querySelector('[data-pose-act="edit"]'), c = r.querySelector('[data-role="pose-joint-row"]'), l = r.querySelector('[data-role="pose-joint-name"]'), p = ["x", "y", "z"].map((E) => r.querySelector(`[data-role="pose-rot-${E}"]`));
  let m = null, f = !1, d = /* @__PURE__ */ new Map();
  const h = () => e.state?.objects?.find((E) => E.id === m) || null, b = () => e.rigMapper?.boneMap && Object.keys(e.rigMapper.boneMap).length ? e.rigMapper.boneMap : null, u = () => e.subSelection?.type === "character_joint" && e.subSelection.objectId === m ? e.subSelection.jointId : null;
  function v(E) {
    const K = To({ ...E, preset_id: E.id });
    return { id: E.id, name: E.name || E.id, root_offset: K.root_offset, joints: K.joints };
  }
  function y(E) {
    const K = d.get(E?.pose?.preset_id) || null;
    return Li({ preset: K, overrides: E?.pose }).joints;
  }
  function x() {
    const E = h();
    !E?.character || !b() || e.webgl?.applyCharacterPose?.(m, b(), f || E.character.pose?.joints ? y(E.character) : {});
  }
  function S() {
    const E = u(), K = f && !!E;
    if (c && (c.hidden = !K), !K) return;
    l && (l.textContent = E);
    const V = h(), X = y(V?.character)[E] || [0, 0, 0, 1], N = zi(X);
    p.forEach((A, G) => {
      A && document.activeElement !== A && (A.value = String(Math.round(N[G] * 100) / 100));
    });
  }
  function g() {
    const E = h(), K = !!E?.character?.motion;
    if (i && (i.classList.toggle("active", f), i.disabled = K, i.title = K ? s("Clear the motion clip to edit the pose") : s("Toggle FK pose editing")), n) {
      const V = [["neutral", s("Standing Neutral")]].concat([...d.values()].filter((N) => N.id !== "neutral").map((N) => [N.id, N.name || N.id])), X = V.map((N) => N.join(":")).join("|");
      n.dataset.sig !== X && (n.dataset.sig = X, n.replaceChildren(...V.map(([N, A]) => {
        const G = document.createElement("option");
        return G.value = N, G.textContent = A, G;
      }))), document.activeElement !== n && (n.value = E?.character?.pose?.preset_id || "neutral");
    }
    S(), x();
  }
  async function k() {
    try {
      const E = await o.listPoses();
      d = new Map((E.poses || []).filter((K) => K?.id).map((K) => [K.id, v(K)]));
    } catch {
      d = /* @__PURE__ */ new Map();
    }
  ...
  function _() {
    const E = u();
    if (!E) return;
    const K = p.map((N) => Number(N?.value) || 0), V = Pi(K), X = e.directorApi?.execute({
      version: 1,
      id: `tx_pose_${Date.now().toString(36)}`,
      description: "Pose joint",
      operations: [{ type: "character.set_joint_rotation", objectId: m, joint: E, rotation: V }]
    });
    X && !X.ok && e.setStatus?.(X.error?.message || s("Could not set the joint")), g();
  }
  function I() {
    const E = n?.value || "neutral", K = d.get(E) || To({ preset_id: E });
    e.directorApi?.execute({
      version: 1,
      id: `tx_preset_${Date.now().toString(36)}`,
      description: "Pose preset",
      operations: [{ type: "character.set_pose", objectId: m, pose: { preset_id: E, root_offset: K.root_offset, joints: {} } }]
    }), g();
  }
  async function P() {
    const E = h();
    if (!E?.character) return;
    const K = (await Yt(e, s("Save Pose"), s("Pose name"), ""))?.trim();
    if (!K || e.disposed) return;
    const V = K.toLowerCase().replace(ff, "-").replace(/^-+|-+$/g, "").slice(0, 60) || "pose";
    try {
      const X = await o.savePose({
        id: V,
        name: K,
        profile: "omnicam_humanoid_v1",
        root_offset: E.character.pose?.root_offset || [0, 0, 0],
        joints: y(E.character)
      });
      d.set(X.pose.id, v(X.pose)), e.setStatus?.(s("Pose saved: {name}").replace("{name}", K)), g();
    } catch (X) {
  ...
  function B() {
    const E = h();
    !E?.character || E.character.motion || (f = !f, !f && e.subSelection?.type === "character_joint" && (e.subSelection = null), g(), e.rigOverlay?.update?.());
  }
  function W(E) {
    f && (e.subSelection = { type: "character_joint", objectId: m, jointId: E }, g(), e.rigOverlay?.update?.());
  }
  const H = pf(e, {
    onPick: W,
  ...
  e.rigOverlay = H;
  function oe() {
    const E = e.selectedObject?.(), K = E?.asset_kind === "character";
    if (r.hidden = !K, !K) {
      f && (f = !1), m = null, H.update();
      return;
    }
    E.id !== m && (m = E.id, f = !1, e.subSelection?.type === "character_joint" && (e.subSelection = null), d.size || k()), g(), H.update();
  }
  n?.addEventListener("change", I), i?.addEventListener("click", B), r.querySelector('[data-pose-act="save"]')?.addEventListener("click", P);
  for (const E of p)
    E?.addEventListener("change", _), E?.addEventListener("input", _);
  return k(), {
    sync: oe,
    update() {
      H.update(), x();
    ...
    dispose() {
      H.dispose(), n?.removeEventListener("change", I), i?.removeEventListener("click", B);
      for (const E of p)
        E?.removeEventListener("change", _), E?.removeEventListener("input", _);
    }
  };
}
function An(e, t) {
...
function uf(e) {
  ...
  function b() {
    ...
    if (o) {
      const k = x.join("|");
      o.dataset.sig !== k && (o.dataset.sig = k, o.replaceChildren(
        An("", x.length ? s("No motion (static)") : s("No clips in this model")),
        ...x.map((_) => An(_, _))
      )), document.activeElement !== o && (o.value = S?.clip_id || ""), o.disabled = !x.length;
    }
    tr(r, S?.start_frame ?? 0), tr(n, S?.end_frame ?? 0), tr(i, S?.speed ?? 1), c && document.activeElement !== c && (c.checked = S ? S.loop !== !1 : !0);
    const g = !!S;
    for (const k of [r, n, i, c]) k && (k.disabled = !g);
    l && (l.disabled = !g);
  }
  function u() {
...
function Bs(e) {
  return {
    ...
    frames: qe(e, "frame"),
    scrubs: qe(e, "scrub"),
    cameraFov: qe(e, "camera-fov"),
    cameraRoll: qe(e, "camera-roll"),
    cameraFocal: qe(e, "camera-focal"),
    viewportZoom: qe(e, "viewport-zoom"),
    cameraType: qe(e, "camera-type"),
    cameraNear: qe(e, "camera-near"),
    cameraFar: qe(e, "camera-far")
  };
}
const bf = /* @__PURE__ */ new Set(["translate", "rotate", "scale"]), gf = /* @__PURE__ */ new Set(["world", "local"]), Ue = 180 / Math.PI;
function Tn(e) {
  return [e.x, e.y, e.z];
}
function yf(e) {
  return [e.x * Ue, e.y * Ue, e.z * Ue];
}
function vf({
  THREE: e,
  camera: t,
  ...
  const m = p ? p() : new e.Object3D(), f = l ? l(t, a) : new sd(t, a);
  let d = null;
  o?.add && (d = typeof f.getHelper == "function" ? f.getHelper() : f, o.add(d), o.add(m));
  let h = null, b = null, u = !1;
  function v() {
    return {
      position: Tn(m.position),
      rotationDeg: yf(m.rotation),
      scale: Tn(m.scale)
    };
  }
  function y(N) {
    m.position.set(...N.position), m.rotation.set(
      N.rotationDeg[0] / Ue,
      N.rotationDeg[1] / Ue,
      N.rotationDeg[2] / Ue
    ), m.scale.set(...N.scale);
  ...
  function x(N) {
    return b ? {
      position: N.position.map((A, G) => A - b.position[G]),
      rotationDeg: N.rotationDeg.map((A, G) => A - b.rotationDeg[G]),
      scaleFactors: N.scale.map((A, G) => b.scale[G] === 0 ? 1 : A / b.scale[G])
  ...
  f.addEventListener?.("mouseDown", S), f.addEventListener?.("objectChange", g), f.addEventListener?.("mouseUp", k), f.addEventListener?.("dragging-changed", _);
  function I(N) {
    h = N, m.position.set(...N.position || [0, 0, 0]);
    const A = N.rotation || [0, 0, 0];
    m.rotation.set(A[0] / Ue, A[1] / Ue, A[2] / Ue), m.scale.set(...N.scale || [1, 1, 1]), f.attach(m), f.visible = !0;
  }
  function P() {
    h = null, b = null, f.detach(), f.visible = !1;
  }
  function B(N) {
    "camera" in f && (f.camera = N);
  }
  function W(N) {
    if (!bf.has(N)) throw new Error(`createTransformControlsAdapter: unknown mode "${N}"`);
    f.setMode ? f.setMode(N) : f.mode = N;
  }
  function H(N) {
    if (!gf.has(N)) throw new Error(`createTransformControlsAdapter: unknown space "${N}"`);
    f.space = N;
  }
  function oe(N) {
    f.setTranslationSnap ? f.setTranslationSnap(N) : f.translationSnap = N;
  }
  function E(N) {
    f.setRotationSnap ? f.setRotationSnap(N) : f.rotationSnap = N;
  }
  function K(N) {
    f.setScaleSnap ? f.setScaleSnap(N) : f.scaleSnap = N;
  }
  function V() {
    if (!b) return;
    const N = b;
  ...
  function X() {
    f.removeEventListener?.("mouseDown", S), f.removeEventListener?.("objectChange", g), f.removeEventListener?.("mouseUp", k), f.removeEventListener?.("dragging-changed", _), o?.remove && d && o.remove(d), o?.remove && o.remove(m), f.dispose?.(), h = null, b = null;
  }
  return {
    attach: I,
    detach: P,
...
function wf(e, { controlsFactory: t, anchorFactory: a } = {}) {
  let o = null, r = null;
  function n() {
    return o || (!e.webgl || !e.interactionElement ? null : (o = vf({
      THREE: nd,
  ...
  function i({ targetSpec: k }) {
    if (k) {
      if (k.type === "object") {
        e.checkpoint("Transform object");
        const _ = Fi(e), I = (_.length ? _ : [k.object]).map((B) => ({
          object: B,
          transform: He(B)
        }));
        for (const B of I) e.beginObjectEdit(B.object);
        const P = I.reduce((B, W) => fe(B, W.transform.position), [0, 0, 0]).map((B) => B / I.length);
        r = { type: "object", group: I, pivot: P };
        return;
      }
      if (k.type === "camera") {
      ...
      if (k.type === "camera_target") {
        ...
        const _ = e.activeCameraTrack?.(), I = !!_?.target_object_id;
        r = {
          type: "camera_target",
          tracking: I,
          base: I ? [..._.target_offset || [0, 0, 0]] : [...e.camera.target]
        };
        return;
      }
      if (k.type === "camera_path") {
        ...
        e.checkpoint("Transform camera path"), r = {
          type: "camera_path",
          trackId: _.id,
          origin: ds(_.keyframes),
          baseKeys: _.keyframes.map((I) => ({ ...I, camera: ce(I.camera) }))
        };
        return;
      }
      if (k.type === "path_point" || k.type === "path_group") {
        ...
        const I = k.type === "path_point" ? [k.frame] : k.frames;
        e.checkpoint(k.type === "path_point" ? "Transform path point" : "Transform path selection"), r = {
          type: k.type,
          trackId: _.id,
          origin: k.position,
          selectedFrames: new Set(I),
          baseKeys: _.keyframes.map((P) => ({ ...P, camera: ce(P.camera) })),
          lookAtActive: ms(_)
        };
        return;
      }
  ...
  function c(k) {
    ...
    return _ === "translate" ? { mode: _, delta: k.position } : _ === "scale" ? { mode: _, origin: r.origin, factors: k.scaleFactors } : { mode: _, origin: r.origin, rotationDeg: k.rotationDeg };
  }
  function l(k) {
    k.id === e.state.active_camera_id && (e.state.keyframes = k.keyframes), e.camera = $e(k, e.frame, e.state.objects), k.camera = ce(e.camera), e.refreshKeys();
  }
  function p(k) {
    const _ = e.state.cameras.find((I) => I.id === r.trackId);
    _ && (_.keyframes = ps(r.baseKeys, c(k)), l(_));
  }
  function m(k) {
    const _ = e.state.cameras.find((P) => P.id === r.trackId);
    if (!_) return;
    const I = { ...c(k), lookAtActive: r.lookAtActive };
    _.keyframes = Di(r.baseKeys, r.selectedFrames, I), l(_);
  }
  function f(k) {
    const _ = e.state.cameras.find((I) => I.id === r.trackId);
    _ && (_.keyframes = Ki(r.baseKeys, [r.frame], { delta: k.position }), l(_));
  }
  function d({ delta: k }) {
    r && (r.type === "object" ? h(k) : r.type === "camera" ? b(k) : r.type === "camera_target" ? u(k) : r.type === "camera_path" ? p(k) : r.type === "path_point" || r.type === "path_group" ? m(k) : r.type === "path_point_target" && f(k), e.render());
  }
  function h(k) {
    const { group: _, pivot: I } = r, P = e.state.gizmo_mode;
    for (const B of _)
      if (P === "translate")
        B.object.position = fe(B.transform.position, k.position);
      else if (P === "rotate")
        B.object.position = fe(I, an(jt(B.transform.position, I), k.rotationDeg)), B.object.rotation = fe(B.transform.rotation, k.rotationDeg);
      else if (P === "scale") {
        const W = jt(B.transform.position, I);
        B.object.position = fe(I, W.map((H, oe) => H * k.scaleFactors[oe])), B.object.size = B.transform.size.map((H, oe) => Math.max(0.01, H * k.scaleFactors[oe]));
      }
    for (const B of _) e.commitObjectEdit(B.object);
  }
  function b(k) {
    if (e.state.gizmo_mode === "translate")
      e.camera.position = fe(r.position, k.position);
    else {
      const _ = jt(r.target, r.position);
      e.camera.target = fe(r.position, an(_, k.rotationDeg));
    }
    e.commitCameraEdit();
  }
  function u(k) {
    const _ = fe(r.base, k.position);
    r.tracking ? Ri(e, _) : e.camera.target = _, e.commitCameraEdit();
  }
  function v({ cancelled: k }) {
    if (!r) return;
    const _ = r.type;
    k ? (e.undo(), (_ === "camera" || _ === "camera_target") && e.finishCameraEdit()) : _ === "camera" || _ === "camera_target" ? e.finishCameraEdit() : (e.editingKeyFrame = null, e.updateKeyVisualState?.(), e.drawCurveEditor?.()), r = null, e.refreshInspector(), e.render();
  }
  function y() {
    if (!e.webgl || !e.interactionElement) return;
    const k = e.recording ? null : Ni(e), _ = e.state.gizmo_mode || "translate";
    if (!(!!k && !k.readOnly && xf.has(k.type) && k.allowedModes.includes(_))) {
      o?.detach();
      return;
    }
    n() && (o.isDragging() || (o.setCamera(e.webgl.activeCamera), o.setMode(_), o.setSpace(e.state.gizmo_space === "local" ? "local" : "world"), o.attach(k)));
  }
  function x() {
  ...
  return { sync: y, isPointerOverHandle: x, cancelDrag: S, dispose: g };
}
function kf(e, t) {
  e.checkpoint(`Apply preset: ${t}`);
  const a = e.activeCameraTrack(), o = ld(t, {
...
function Sf(e, t) {
  ...
  const o = cd(a, { type: t, intensity: 1, duration_frames: e.state.duration_frames });
...
const $n = ["#4aa3ef", "#f2a93b", "#48c774", "#b565d8", "#ec4899"], Ze = [4, 8, 12, 20, 35, 60, 100];
function At(e) {
...
function qo(e, t, a) {
  ...
  const o = At(e), r = o.expanded ? 220 : 138, n = Math.min(r, Math.max(80, Math.min(t, a) - 20)), i = 10, c = Math.max(0, t - n - i), l = Math.max(0, a - n - i), p = e.viewportCamera(), m = p?.position || [0, 1.5, 5], f = p?.target || [0, 0, 0], d = e.activeCameraTrack?.(), h = e.state.cameras?.length ? e.state.cameras : d ? [d] : [], b = h.flatMap(
    (k) => (k.keyframes || []).map((_) => _.camera?.position).filter(Boolean)
  );
  let u = 12;
  if (o.rangeIndex >= 0 && o.rangeIndex < Ze.length)
    u = Ze[o.rangeIndex];
  else {
    const k = Math.max(
      Math.abs(m[0] || 0),
    ...
    u = Math.max(6, Math.ceil((k + 1.5) / 4) * 4);
  }
...
function Af(e, t, a, o) {
  const r = qo(e, a, o);
  if (!r) return;
  const { rx: n, ry: i, radarSize: c, cx: l, cy: p, innerRadius: m, range: f, scale: d, camPos: h, camTgt: b, cameras: u, activeTrack: v } = r, y = At(e), x = e.state.active_camera_id || v?.id, S = (re, de) => qs(r, re, de);
  ...
  for (const re of e.state.objects || []) {
    ...
    const de = Mr(e.state.objects, re).position || [0, 0, 0], [ge, he] = S(de[0], de[2]);
  ...
  for (let re = 0; re < u.length; re++) {
    const de = u[re], ge = de.keyframes || [], he = de.id === x, ye = de.color || $n[re % $n.length];
    ...
    for (let xe = pe; Number.isFinite(xe) && xe <= Me; xe++) {
      ...
      const [be, L] = S(we[0], we[2]);
      ve ? t.lineTo(be, L) : (t.moveTo(be, L), ve = !0);
    }
    ...
    for (const xe of ge) {
      ...
      const U = xe.frame === e.frame && he;
      t.fillStyle = U ? "#ffffff" : ye, t.globalAlpha = he ? 0.95 : 0.6, t.beginPath(), t.moveTo(be, L - 3), t.lineTo(be + 3, L), t.lineTo(be, L + 3), t.lineTo(be - 3, L), t.closePath(), t.fill(), U && (t.strokeStyle = "#00d2d3", t.lineWidth = 1.2, t.stroke());
    }
    t.restore();
  }
  const [_, I] = S(h[0] || 0, h[2] || 0), [P, B] = S(b[0] || 0, b[2] || 0), W = 8, H = Q(_, n + W, n + c - W), oe = Q(I, i + W, i + c - W), E = Q(P, n + W, n + c - W), K = Q(B, i + W, i + c - W), V = h[1] || 0, X = Cf(V), N = Ef(V);
  t.strokeStyle = "rgba(255, 255, 255, 0.40)", t.lineWidth = 1, t.setLineDash([3, 3]), t.beginPath(), t.moveTo(H, oe), t.lineTo(E, K), t.stroke(), t.setLineDash([]), t.fillStyle = "#ffffff", t.beginPath(), t.arc(E, K, 2.5, 0, Math.PI * 2), t.fill(), t.strokeStyle = "rgba(255, 255, 255, 0.7)", t.lineWidth = 1, t.beginPath(), t.arc(E, K, 4.5, 0, Math.PI * 2), t.stroke();
  const A = b[0] - h[0], G = b[2] - h[2], F = Math.atan2(G, A), ee = (e.viewportCamera().fov || 35) * Math.PI / 360, le = Q(24 * (d / (m / 8)), 16, 38), se = t.createRadialGradient(H, oe, 2, H, oe, le);
  se.addColorStop(0, X + "55"), se.addColorStop(1, X + "08"), t.fillStyle = se, t.strokeStyle = X, t.lineWidth = 1.2, t.beginPath(), t.moveTo(H, oe), t.lineTo(H + Math.cos(F - ee) * le, oe + Math.sin(F - ee) * le), t.arc(H, oe, le, F - ee, F + ee), t.closePath(), t.fill(), t.stroke(), t.fillStyle = X + "44", t.beginPath(), t.arc(H, oe, 6.5, 0, Math.PI * 2), t.fill(), t.fillStyle = X, t.beginPath(), t.arc(H, oe, 3.5, 0, Math.PI * 2), t.fill(), t.strokeStyle = "#ffffff", t.lineWidth = 1.5, t.beginPath(), t.moveTo(H, oe), t.lineTo(H + Math.cos(F) * 7, oe + Math.sin(F) * 7), t.stroke(), Tf(e, t, r, X, N, F, Math.hypot(A, G)), y.hover && $f(t, r, y.hover), t.restore();
}
function Tf(e, t, a, o, r, n, i) {
  const { rx: c, ry: l, radarSize: p } = a, m = At(e);
  ...
  const f = l + 3, d = 12;
  bo(t, c + 44, f, 12, d, "−", m.hover?.button === "zoom_out"), bo(t, c + 58, f, 12, d, "+", m.hover?.button === "zoom_in");
  const h = m.centerMode === "camera" ? "CAM" : "CTR";
  bo(t, c + 72, f, 22, d, h, m.hover?.button === "center");
  const b = m.expanded ? "⤡" : "⤢";
  bo(t, c + 96, f, 14, d, b, m.hover?.button === "size"), t.font = "bold 8.5px monospace", t.fillStyle = o, t.textAlign = "right", t.fillText(`Y:${r}`, c + p - 5, l + 9), t.fillStyle = "rgba(15, 23, 42, 0.70)", t.fillRect(c, l + p - 15, p, 15), t.strokeStyle = "rgba(0, 210, 211, 0.15)", t.beginPath(), t.moveTo(c, l + p - 15), t.lineTo(c + p, l + p - 15), t.stroke();
...
function $f(e, t, a) {
  ...
  const i = e.measureText(a.text).width + 12, c = 16, l = Q(a.px - i / 2, o + 4, o + n - i - 4), p = a.pz > t.cy ? a.pz - 22 : a.pz + 8;
...
function Ws(e, t, a, o) {
  const { camPos: r, camTgt: n, cameras: i, rx: c, ry: l, radarSize: p } = t, m = (v, y) => qs(t, v, y), [f, d] = m(r[0] || 0, r[2] || 0);
  ...
  for (const v of e.state.objects || []) {
    ...
    const y = Mr(e.state.objects, v).position || [0, 0, 0], [x, S] = m(y[0], y[2]);
...
function Mf(e, t, a, o) {
  ...
  if (a < n || a > n + c || o < i || o > i + c)
    return !1;
  t.preventDefault?.(), t.stopPropagation?.();
  const l = At(e), p = Us(r, a, o);
  if (p)
    return p === "zoom_in" ? (l.rangeIndex === -1 && (l.rangeIndex = Ze.findIndex((h) => h >= r.range), l.rangeIndex < 0 && (l.rangeIndex = Ze.length - 1)), l.rangeIndex = Math.max(0, (l.rangeIndex === -1 ? 2 : l.rangeIndex) - 1)) : p === "zoom_out" ? (l.rangeIndex === -1 && (l.rangeIndex = Ze.findIndex((h) => h >= r.range), l.rangeIndex < 0 && (l.rangeIndex = 0)), l.rangeIndex = Math.min(Ze.length - 1, l.rangeIndex + 1)) : p === "center" ? l.centerMode = l.centerMode === "camera" ? "origin" : "camera" : p === "size" && (l.expanded = !l.expanded), e.render?.(), !0;
  const m = Ws(e, r, a, o);
  if (m) {
    if (m.type === "camera")
...
function If(e, t, a, o) {
  ...
  const r = qo(e, e.canvas.width, e.canvas.height);
  if (!r) return !1;
  const n = At(e), { rx: i, ry: c, radarSize: l } = r, p = a >= i && a <= i + l && o >= c && o <= c + l;
  if (n.drag) {
    const [u, v] = gr(r, a, o), y = e.viewportCamera();
  ...
  const m = Us(r, a, o), f = Ws(e, r, a, o), [d, h] = gr(r, a, o);
...
function Of(e, t, a, o) {
  ...
  if (a < n || a > n + c || o < i || o > i + c)
    return !1;
  t.preventDefault?.(), t.stopPropagation?.();
  const l = At(e), p = Math.sign(t.deltaY || 0);
  return l.rangeIndex === -1 && (l.rangeIndex = Ze.findIndex((m) => m >= r.range), l.rangeIndex < 0 && (l.rangeIndex = 2)), p > 0 ? l.rangeIndex = Math.min(Ze.length - 1, l.rangeIndex + 1) : p < 0 && (l.rangeIndex = Math.max(0, l.rangeIndex - 1)), e.render?.(), !0;
}
function Pf(e, t, a) {
  ...
  const o = () => {
    ...
    const b = String(t('[data-role="object-annotation"]')?.value || "").trim(), u = b ? os({
      text: b,
  ...
  }, { signal: a }), vd(e, a), Hd(e, a), t('[data-role="curve-group"]')?.addEventListener("change", () => {
    e.setChannelFilter("all"), As(e), e.drawCurveEditor(), Nr(e);
  ...
  e.root.addEventListener("pointerdown", (d) => {
    ...
    const h = e.interactionElement.getBoundingClientRect(), b = (d.clientX - h.left) * e.canvas.width / Math.max(1, h.width), u = (d.clientY - h.top) * e.canvas.height / Math.max(1, h.height);
    Of(e, d, b, u) || e.onWheel(d);
  }, { passive: !1, signal: a }), e.root.addEventListener("wheel", td(e.root), { signal: a }), window.addEventListener("pointermove", (d) => {
  ...
  l && (l.addEventListener("pointerdown", (d) => e.onTimelinePointerDown(d), { signal: a }), l.addEventListener("pointermove", (d) => e.onTimelinePointerMove(d), { signal: a }), l.addEventListener("pointerup", (d) => e.onTimelinePointerUp(d), { signal: a }), l.addEventListener("pointercancel", (d) => e.onTimelinePointerUp(d), { signal: a }), l.addEventListener("wheel", (d) => ts(e, d), { passive: !1, signal: a }));
  const p = (d) => {
    const h = Ui(d.composedPath?.()[0] || d.target);
    h && (e.lastKeyZone = h);
  };
  e.root.addEventListener("focusin", p, { signal: a }), e.root.addEventListener("pointerdown", p, { capture: !0, signal: a }), e.root.addEventListener("focusout", (d) => {
    e.modalTransform && !e.root.contains(d.relatedTarget) && (Bi(e), e.render());
  }, { signal: a });
...
function Nf(e) {
  const t = Lc(e.id, e.defaultValue), a = `pref_${e.id.replace(/[^a-zA-Z0-9]/g, "_")}`;
  if (e.type === "boolean")
    return `
...
function Rf() {
  return `<span class="oc-pref-emoji" aria-hidden="true">${Lf}</span> ${s("OmniCam Preferences")}`;
}
function Df(e) {
  ...
  a.className = "oc-modal-backdrop", a.setAttribute("role", "dialog"), a.setAttribute("aria-modal", "true"), a.setAttribute("aria-label", s("OmniCam Preferences")), a.innerHTML = `
    <div class="oc-modal-dialog oc-pref-dialog" tabindex="-1">
      <div class="oc-pref-header">
        <div class="oc-pref-title">${Rf()}</div>
...
const Bf = ["position", "target"], qf = ["fov", "zoom"], Uf = ["roll"], Wf = ["position", "size"], Vf = ["rotation"];
function yr(e) {
  ...
  for (let r = 1; r < a.length - 1; r++) {
    ...
    if (i.camera) {
      for (const m of Bf) {
        ...
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const b = In(f, d, h, p);
          a[r].camera[m] = Pn(d.map(Number), b, o);
        }
      }
      for (const m of qf) {
        const f = n.camera?.[m], d = i.camera?.[m], h = c.camera?.[m];
    ...
    if (Array.isArray(i.position) && Array.isArray(n.position) && Array.isArray(c.position)) {
      for (const m of Wf) {
        ...
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const b = In(f, d, h, p);
          a[r][m] = Pn(d.map(Number), b, o);
        }
      }
      for (const m of Vf) {
        const f = n[m], d = i[m], h = c[m];
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const b = [0, 1, 2].map((u) => On(f[u], d[u], h[u], p));
          a[r][m] = d.map((u, v) => Ln(Number(u), b[v], o));
        }
      }
    }
  }
...
function eh(e, t) {
  ...
  const o = (r) => {
    ...
    const b = (v) => {
      ...
      let x = Jf;
      v.shiftKey ? x = Zf : (v.ctrlKey || v.metaKey) && (x = Qf);
      const S = p * x * 20;
      let g = l + y * S;
      g = Math.max(m, Math.min(f, g));
      const k = p >= 1 ? 0 : p >= 0.1 ? 1 : 2;
      i.value = g.toFixed(k), i.dispatchEvent(new Event("input", { bubbles: !0 })), i.dispatchEvent(new Event("change", { bubbles: !0 }));
    }, u = (v) => {
...
function oh(e, t) {
  for (const o of e.root.querySelectorAll('[data-act="toggle-camera-lock"]'))
    o.addEventListener("click", (r) => {
      r.stopPropagation(), e.checkpoint?.("Toggle camera lock"), e.state.camera_lock = !e.state.camera_lock, e.serialize?.(), Vs(e), e.setStatus?.(e.state.camera_lock ? s("Camera View locked") : s("Camera View unlocked"));
    }, { signal: t });
...
function nh(e, t) {
  ...
  }, n = (i) => (e.smoothingBaseline?.cameraId !== i.id && (e.smoothingBaseline = { cameraId: i.id, keys: Xf(i.keyframes) }), e.smoothingBaseline.keys);
  a.addEventListener("input", r, { signal: t }), a.addEventListener("change", () => {
    const i = e.activeCameraTrack();
    if (!i) return;
    e.checkpoint("Path smoothing");
    const c = Number(a.value) / 100, l = Yf(n(i), c);
...
function sh(e, t) {
  ...
  e.root.querySelector('[data-act="keys-reduce"]')?.addEventListener("click", async () => {
    const l = await Yt(e, s("Reduce keys"), s("Target number of keys"), "8"), p = Math.round(Number(l));
  ...
  if (a.length) {
    ...
    for (const o of a)
      o.addEventListener("change", () => {
        e.dopeChannels = new Set(a.filter((r) => r.checked).map((r) => r.dataset.dopeChannel)), ks(e);
      }, { signal: t });
  }
}
function lh(e, t) {
...
const go = () => import("./chunk-DtnsaxNW.js");
function mh(e, t) {
  go().then(({ loadExchangeFormats: o }) => o(e, t)), e.root.querySelector('[data-act="import-camera"]')?.addEventListener("click", async () => {
    (await go()).pickCameraFile(e);
  }, { signal: t }), e.root.querySelector('[data-act="export-camera"]')?.addEventListener("click", async () => {
    (await go()).exportCamera(e);
  }, { signal: t }), e.root.querySelector('[data-role="camera-file"]')?.addEventListener("change", async (o) => {
    const r = o.target.files?.[0];
    o.target.value = "", await (await go()).importCameraFile(e, r);
  }, { signal: t });
}
function ph(e, t) {
  ...
  zc().then((r) => {
    ...
    c === "health-slow" ? Fc(e) : c === "health-smooth" ? Rc(e) : c === "health-recenter" && Dc(e);
  }, { signal: t });
...
function bh(e, t) {
  mh(e, t), rh(e, t), nh(e, t), sh(e, t), ih(e, t), fh(e, t), uh(e, t), hh(e, t), eh(e, t), th(e, t), ch(e, t), dh(e, t), oh(e, t), lh(e, t), ph(e, t);
}
const zn = {
...
}, Hs = "balanced", or = "#121212";
function Dr(e) {
  return zn[e] || zn[Hs];
}
function gh(e, t = "#1b1f2b", a = "#151822", o = "#1e2330", r = "#161922", n = "#111319") {
...
function Zg(e, t, a = Hs) {
  ...
  const h = new e.FogExp2(1250588, 8e-3), b = gh(e), u = new e.PMREMGenerator(t);
  u.compileEquirectangularShader();
  const v = new id(), y = u.fromScene(v, 0.04).texture;
  return v.traverse((x) => {
    x.geometry?.dispose?.();
...
function vh(e) {
  ...
  const r = e.reconstruction, n = r.provider || "Reconstructed", i = Math.round(t * 100), c = Tl(e), l = c.length ? `
` + c.map(([m, f]) => `${m}: ${f}`).join(`
`) : "", p = `${n} • ${o} (${i}%)${l}`;
  return {
    label: o,
...
function kh(e, t, a) {
  ...
  if (o) {
    const n = (i) => {
      const c = i.target.closest?.("[data-axis], [data-axis-center]") || i.target, l = c.getAttribute("data-axis"), p = Kc(l?.toLowerCase(), e.state.view_mode);
  ...
  for (const n of e.root.querySelectorAll('[data-role="speed"]')) {
    const i = (c) => {
      const l = Q(Number(c.target.value), 0.05, 5);
  ...
  for (const n of e.root.querySelectorAll('[data-role="point-color"]'))
    n.addEventListener("input", (i) => {
      e.state.point_color !== i.target.value && yo(e, "point_color", "Change point color"), e.state.point_color = i.target.value, e.scheduleSerialize(), e.render();
    }, { signal: a });
  ...
  for (const n of e.root.querySelectorAll('[data-role="viewport-bg-color"]')) {
    const i = (c) => {
      e.state.viewport_bg_color !== c.target.value && yo(e, "viewport_bg_color", "Change background colour"), e.state.viewport_bg_color = c.target.value, Ce(e.root, "viewport-bg-color", c.target), e.scheduleSerialize(), e.render();
    };
    n.addEventListener("input", i, { signal: a }), n.addEventListener("change", i, { signal: a });
  }
  ...
  for (const n of e.root.querySelectorAll('[data-role="object-color"]'))
    n.addEventListener("input", (i) => {
      const c = e.selectedObject();
      c && (c.color !== i.target.value && yo(e, `object_color:${c.id}`, "Change object color"), c.color = i.target.value, e.scheduleSerialize(), e.render());
    }, { signal: a });
  for (const n of e.root.querySelectorAll('[data-role="object-light-color"]'))
    n.addEventListener("input", (i) => {
      const c = e.selectedObject();
      c && (c.color !== i.target.value && yo(e, `object_color:${c.id}`, "Change light color"), c.color = i.target.value, e.scheduleSerialize(), e.render());
    }, { signal: a });
  ...
  for (const n of e.root.querySelectorAll("[data-lens]"))
    n.addEventListener("click", () => {
      $l(e, Number(n.dataset.lens));
    }, { signal: a });
  for (const n of e.root.querySelectorAll("[data-blocking-scene]"))
    n.addEventListener("click", () => {
      _f(e, n.dataset.blockingScene), e.closeMenus();
    }, { signal: a });
...
const Sh = 32, jh = 0.025, _h = 0.05, Io = 1e-6, Ch = ["top", "bottom", "front", "back", "left", "right"], Eh = {
  top: "y",
  bottom: "y",
  front: "z",
  back: "z",
...
function Ih(e) {
  ...
  const n = Math.min(Sh, r.length, o + 1);
  if (n < 2) return [];
  const i = Th(r, n);
  ...
  ], p = e.planeAxis === "y" ? Gs(l) : Ys(l, [0, 0, -1]), m = e.seedPoint ? 1 : 0, f = [];
  for (let d = m; d < i.length; d++) {
    const h = i[d], b = $h(i, d, p, e.planeAxis), u = ce(c);
    u.position = [...h], u.target = Mh(h, b, l, e.planeAxis), f.push({
...
function Xs(e, t = e.cameraPathDraw) {
  const a = t?.pointerId;
  if (a != null)
    try {
...
function Nn(e, t = {}) {
  ...
  if (a === "extend") {
    ...
    const b = Math.max(0, Math.round(Number(e.state.duration_frames) || 1) - 1), [, u] = xr(e.state), v = d.length > 1 ? d[d.length - 1].frame - d[0].frame : 24;
    let y = Math.max(u, h.frame + Math.max(6, Math.min(v, 240)));
    y <= h.frame && (y = h.frame + 24), y > b && (l = y + 1), y > u && (p = y), c = [h.frame, y];
  } else
    Ch.includes(e.state.view_mode) || e.setViewMode?.("top"), c = xr(e.state);
  const m = Eh[e.state.view_mode] ?? null, f = n ? [...n] : [...r.position];
  return e.cameraPathDraw = {
    ...
    sourceCamera: r,
    points: []
  }, Ht(e), e.setStatus?.(a === "extend" ? s("Continue Camera Path: LMB draw from the last key · RMB or Esc cancel") : s("Draw Camera Path: LMB draw · RMB or Esc cancel")), e.render?.(), !0;
}
function qr(e, t) {
  ...
  return r && Br(r, o) < jh ? !1 : (a.points.push(o), !0);
}
function We(e) {
  const t = e.cameraPathDraw;
  return t?.active ? (Xs(e, t), e.cameraPathDraw = null, Ht(e), e.setStatus?.(s("Draw Camera Path cancelled")), e.render?.(), !0) : !1;
}
function Ph(e) {
  const t = e.cameraPathDraw;
  ...
  if (a.length < 2 || Ah(a) < _h || t.range[1] <= t.range[0])
    return We(e), e.setStatus?.(s("Camera path needs at least two distinct points")), null;
  const o = Ih(t);
  ...
  if (t.mode === "extend") {
    ...
    return c.keyframes = p, c.id === e.state.active_camera_id && (e.state.keyframes = p), e.cameraPreviewSignature = "", e.cameraPathDraw = null, Ht(e), e.activateCamera?.(c.id), e.setFrame?.(o[0].frame), e.serialize?.(), e.refreshKeys?.(), e.render?.(), e.setStatus?.(s("Camera path extended")), c.id;
  }
  e.checkpoint?.("Draw camera path");
  const r = Ml(e.state), n = e.state.cameras.length, i = {
    id: r,
    name: Oh(e.state),
  ...
  return e.state.cameras.push(i), e.cameraPreviewSignature = "", e.cameraPathDraw = null, Ht(e), e.activateCamera?.(r), e.setFrame?.(t.range[0]), e.setStatus?.(s("Camera path created")), r;
}
function Po(e) {
...
function zh(e, t) {
  const a = e.cameraPathDraw;
  return a?.active ? t.button === 2 && !t.altKey ? (Po(t), e.cameraPathSuppressContextMenuUntil = Date.now() + 1e3, We(e), !0) : t.button !== 0 || t.altKey || t.ctrlKey || t.metaKey || t.shiftKey ? !1 : (Po(t), e.closeMenus?.(), e.interactionElement.focus?.({ preventScroll: !0 }), e.interactionElement.setPointerCapture?.(t.pointerId), a.drawing = !0, a.pointerId = t.pointerId, a.points = [], qr(e, Ur(e, t)), Ht(e), e.requestRender?.("camera-path-draw"), !0) : !1;
}
function Nh(e, t) {
  const a = e.cameraPathDraw;
...
function Fh(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : (Po(t), t.type === "pointercancel" || t.type === "lostpointercapture" ? (We(e), !0) : (qr(e, Ur(e, t)), a.drawing = !1, Ph(e), !0));
}
function Rh(e) {
  const t = e.cameraPathDraw;
  ...
  if (!o.length) return;
  const r = o.map((c) => Ve(c, a, e.canvas.width, e.canvas.height)).filter((c) => c && Number.isFinite(c[0]) && Number.isFinite(c[1]));
  if (!r.length) return;
...
function Dh(e, t) {
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? We(e) : Nn(e);
    }, { signal: t });
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path-extend"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? We(e) : Nn(e, { mode: "extend" });
    }, { signal: t });
  ...
  e.root.addEventListener("contextmenu", (a) => {
    !(Date.now() <= Number(e.cameraPathSuppressContextMenuUntil || 0)) && !e.cameraPathDraw?.active || (a.preventDefault(), a.stopPropagation(), a.stopImmediatePropagation?.(), e.cameraPathSuppressContextMenuUntil = 0, e.cameraPathDraw?.active && We(e));
  }, { capture: !0, signal: t });
}
const Co = "/majoor/omnicam/scenes";
function Js(e) {
...
function Wr(e, t, { name: a = "", status: o } = {}) {
  const r = t && typeof t == "object" ? t : fs(), n = { ...r, metadata: { ...r.metadata || {}, scene_name: a || "" } };
...
async function Kh(e) {
  await Xt(e, s("New Scene"), s("Start a new scene? Unsaved changes will be lost.")) && Wr(e, fs(), { name: "", status: s("New scene") });
}
async function Bh(e) {
  if (!e.sceneBaseline) {
  ...
  const o = a?.metadata?.scene_name || Js(e);
  Wr(e, a, { name: o, status: s("Scene reset to last save") });
}
async function qh(e) {
  const t = Js(e) || s("Untitled"), a = await Yt(e, s("Save Scene"), s("Scene name"), t);
  if (a == null) return;
...
async function Uh(e) {
  ...
  const a = await gs({
    ...
    items: t.map((r) => ({
      id: r.slug,
      label: r.name || r.slug,
      sublabel: Wh(r.modified)
    })),
    onDelete: (r) => Eo(e, `${Co}/${encodeURIComponent(r)}`, { method: "DELETE" }).catch((n) => console.warn("[OmniCam] scene delete failed", n))
  });
  if (!(!a || !await Xt(e, s("Open Scene"), s("Open this scene? Unsaved changes will be lost."))))
    try {
      const r = await Eo(e, `${Co}/${encodeURIComponent(a)}`);
      if (!r.ok) throw new Error(await r.text());
...
function Vh(e, t) {
  vo(e, t, e.root.querySelectorAll('[data-act="scene-new"]'), () => Kh(e)), vo(e, t, e.root.querySelectorAll('[data-act="scene-open"]'), () => Uh(e)), vo(e, t, e.root.querySelectorAll('[data-act="scene-save"]'), () => qh(e)), vo(e, t, e.root.querySelectorAll('[data-act="scene-reset"]'), () => Bh(e));
}
const Hh = ["world_point", "object_point", "camera_field"], Fn = 40;
function Gh(e) {
...
function Jh(e) {
  ...
  for (const v of e.state.motion_layers || []) {
    if (v.enabled === !1) continue;
    const y = Hh.includes(v.source_kind), x = y ? Yh(e.state, v, d) : Gh(v);
    if (!x.length) continue;
    b += 1;
    const S = v.id === e.state.selected_motion_layer_id;
    if (c.strokeStyle = S ? "#ffcc4d" : "rgba(65,217,197,0.6)", c.lineWidth = (S ? 2.4 : 1.5) * r, c.beginPath(), x.forEach((k, _) => {
      const I = p(k.x), P = m(k.y);
      _ ? c.lineTo(I, P) : c.moveTo(I, P);
    }), c.stroke(), !y) {
      c.fillStyle = S ? "#ffcc4d" : "#41d9c5";
      for (const k of x)
        c.beginPath(), c.arc(p(k.x), m(k.y), (S ? 3.4 : 2.4) * r, 0, Math.PI * 2), c.fill();
    }
    const g = Xh(x, h);
...
function tu(e, t) {
  ...
  return {
    ...
    motion_scene_fingerprint: ad(e.state)
  };
}
function au(e, t) {
  const a = tu(e, t);
...
const lt = 1024 * 1024, ou = Object.freeze({
  card: 128 * lt,
  // MAX_CARD_BYTES
  model: 256 * lt,
  // MAX_MODEL_BYTES
...
function Kn(e) {
  return `${(e / lt).toFixed(e >= 10 * lt ? 0 : 1)} MB`;
}
function Jt(e, t) {
  const a = ou[t];
  if (!e || !a) return null;
...
function su(e) {
  ...
  const p = (m) => {
    ...
    if (f === null) {
      for (l += m - c, c = m; l >= i; )
        if (l -= i, r += 1, r > o) {
          if (!e.state.loop_playback) return void Ao(e);
          r = a;
        }
...
async function iu(e, { load: t = () => import("./vendor-mediabunny-CZ5VNE-V.js") } = {}) {
...
async function lu(e, t, { decode: a = iu } = {}) {
  if (!t) return;
  const o = Jt(t, "audio");
  if (o) {
    e.setStatus(o);
  ...
  try {
    ...
    n.preload = "auto", n.src = r, e.audioObjectUrl = r, e.audioElement = n, await cu(n), e.audioDuration = Number.isFinite(n.duration) ? n.duration : 0;
    try {
      e.audioSamples = await a(t);
    } catch {
      e.audioSamples = null;
    }
    Qs(e), e.setStatus(`Audio loaded: ${t.name || "track"}`);
  } catch (r) {
...
const ti = /* @__PURE__ */ new WeakSet(), Wt = /* @__PURE__ */ new WeakMap();
function zo(e) {
...
function mu(e) {
  ...
  Wt.delete(e), ti.has(e) && zo(e);
}
function Zt(e, t) {
  const a = e.cardMediaById.get(t);
  a && (e.cardMediaById.delete(t), e.cardMediaAssetById?.delete?.(t), t === "subject" && e.cardMedia === a && (e.cardMedia = null), mu(a));
}
function pu(e) {
  for (const t of [...e.cardMediaById?.keys?.() || []]) Zt(e, t);
}
function at(e, t, a, o = !1, r = "") {
  ...
  n && n !== a && Zt(e, t), o && ti.add(a), du(a), e.cardMediaAssetById ||= /* @__PURE__ */ new Map(), e.cardMediaById.set(t, a), e.cardMediaAssetById.set(t, r || a?.__omnicamAsset || "");
  try {
    a.__omnicamAsset = r || a.__omnicamAsset || "";
  } catch {
  }
...
function ai(e, t, { signal: a, timeout: o = 15e3 } = {}) {
...
async function oi(e, t, a, o = () => !0, r = null) {
  if (!t || !a) return;
  const n = () => !e.disposed && o(), i = String(t.asset || a).toLowerCase();
  if (r ?? /\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/.test(i)) {
    const l = document.createElement("video");
    if (l.src = a, l.loop = !0, l.muted = !0, l.playsInline = !0, await ai(l, ["loadeddata", "error"], { signal: e.abortController?.signal }).catch(() => {
    }), !n()) {
      zo(l);
      return;
    }
...
function hu(e) {
  ...
  for (const o of e.state.objects) {
    if (!o.asset) {
      (o.type === "model" || o.type === "glb") && (o.load_error = s("Not saved to the ComfyUI input folder: this model will be missing after a reload.")), o.type === "card" && Zt(e, o.id);
      continue;
    }
    const r = Qe(o.asset);
...
async function bu(e, t) {
  ...
  try {
    const c = await Fr(Ct, { route: "/majoor/omnicam/upload_model", field: "asset", file: t });
...
async function gu(e, t) {
  ...
  if (o) {
    ...
    try {
      const r = await Fr(Ct, { route: "/majoor/omnicam/upload_asset", field: "asset", file: t });
...
function yu(e, t) {
  ...
  e.state.reference_index = Q(e.state.reference_index || 0, 0, e.executionReferences.length - 1), a.value = String(e.state.reference_index), e.serialize(), e.loadSelectedReference();
}
function vu(e) {
  ...
  const a = new Image();
  a.onload = () => {
    e.disposed || (at(e, "subject", a, !1, a.src), e.render(), e.setStatus(s("Upstream media refreshed")));
...
async function xu(e) {
  ...
  for (const f of i) {
    ...
    if (h) {
      if (d === "image" || d === "video") {
        ...
        if (b && b.value) {
          const u = String(b.value), v = /\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/i.test(u), y = h.widgets?.find((g) => String(g.name).toLowerCase() === "subfolder")?.value || "", x = Qe(vt(u, y)), S = e.state.objects.find((g) => g.id === "subject");
          if (S) {
            const g = await oi(e, S, x, r, v);
            if (!r()) return;
            S.asset = vt(u, y);
            let k = null;
            if (v)
              try {
                k = await fu(u, o.signal);
              } catch (_) {
          ...
          }), at(e, "subject", u, !1, u.currentSrc || u.src || ""), Rn(e, u, { frameCount: u instanceof HTMLVideoElement ? 0 : 1 }), e.upstreamImageConnected = !0, n = !0, e.render(), e.setStatus(u instanceof HTMLVideoElement ? s("Upstream video preview synced") : s("Upstream image preview synced")));
        }
      }
      if (d === "audio") {
        l = !0;
        ...
        if (b && b.value) {
          const u = String(b.value), v = h.widgets?.find((x) => String(x.name).toLowerCase() === "subfolder")?.value || "", y = Qe(vt(u, v));
          try {
      ...
      if (d === "scene_3d" || d === "model" || d === "mesh") {
        ...
        if (b && b.value) {
          ...
          if (["glb", "gltf", "obj", "fbx", "stl", "ply"].includes(v)) {
            const y = h.widgets?.find((k) => String(k.name).toLowerCase() === "subfolder")?.value || "", x = Qe(vt(u, y)), S = `upstream_scene_${h.id}`;
            p.add(S);
            let g = e.state.objects.find((k) => k.id === S);
            g ? (g.asset = vt(u, y), g.format = v === "gltf" ? "glb" : v) : (g = {
              id: S,
              type: "model",
              format: v === "gltf" ? "glb" : v,
  ...
  Ol(e) && (n = !0), n && (e.serialize(), e.render());
}
const wu = ["video/mp4;codecs=avc1.42E01E", "video/webm;codecs=vp9", "video/webm;codecs=vp8", "video/webm"], Bn = { low: 3e6, balanced: 6e6, high: 12e6 };
function ku(e) {
  ...
  try {
    for (const S of wu)
      if (!(n.isTypeSupported && !n.isTypeSupported(S)))
        try {
          f = new n(m, { mimeType: S, videoBitsPerSecond: ku(r) });
          break;
        } catch {
        }
...
async function _u(e) {
  await Promise.all([...e].filter((t) => t instanceof HTMLVideoElement && t.seeking).map((t) => ai(t, ["seeked", "error"], { timeout: 5e3 }).catch(() => {
  })));
}
async function ri(e) {
  await _u(e.cardMediaById.values());
}
async function ni(e) {
  return Su({
    canvas: e.canvas,
...
async function si(e, t) {
  const a = await ju(ot, t);
  if (au(e, t), e.state.playblast_camera_id === hs)
...
async function Eu(e) {
  ...
  const t = e.frame, a = e.canvas.width, o = e.canvas.height, r = Cu(e);
  (r.width !== e.canvas.width || r.height !== e.canvas.height) && (e.canvas.width = r.width, e.canvas.height = r.height, e.render());
  try {
    let n = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-HQm150V4.js");
    i !== "realtime" && await l(e.canvas.width, e.canvas.height) && (n = await c(e.canvas, e.state.duration_frames, e.state.fps, async (p) => {
      e.setFrame(p, !0), e.setStatus(s(`Encoding frame ${p + 1}/${e.state.duration_frames}…`)), await ri(e), await new Promise((m) => requestAnimationFrame(m));
    }, e.abortController?.signal, e.state.playblast_quality)), n || (e.setStatus(s("WebCodecs unavailable; recording realtime fallback…")), n = await ni(e)), e.setFrame(t), await si(e, n);
  } catch (n) {
...
async function ii(e) {
  if (!Gt) throw new Error("ComfyUI API is unavailable");
  return Fr(Gt, { route: "/majoor/omnicam/upload_asset", field: "asset", file: e });
}
async function No(e) {
  const t = e.map((a) => String(a.relative || "").replace(/^omnicam\//, "")).filter(Boolean);
  if (!(!t.length || !Gt))
    try {
      await Gt.fetchApi("/majoor/omnicam/cleanup", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
...
async function Tu(e, t) {
  ...
  let r = null;
  try {
    if (e.setStatus(`Uploading background: ${t.name}`), r = await ii(t), o !== e.backgroundRequestId || e.disposed) {
      await No([r]);
      return;
    }
    const n = Qe(r.path);
    ...
    if (r && await No([r]), o !== e.backgroundRequestId || e.disposed) return;
...
async function $u(e, t) {
  ...
  try {
    ...
    for (const c of t)
      if (n.push(await ii(c)), r !== e.backgroundRequestId || e.disposed) {
        await No(n);
        return;
      }
    ...
    if (await No(n), r !== e.backgroundRequestId || e.disposed) return;
...
function Iu(e) {
  ...
  const a = Array.isArray(e.state?.objects) ? e.state.objects : [], o = e.viewportCamera(), r = e.ctx, n = e.canvas.width, i = e.canvas.height, c = Q(i / 720, 0.75, 4), l = Number(e.frame) || 0, p = e.selectedObjectIds instanceof Set ? e.selectedObjectIds : /* @__PURE__ */ new Set();
  r.save(), r.font = `${Math.round(12 * c)}px system-ui, -apple-system, "Segoe UI", Roboto, sans-serif`, r.textBaseline = "alphabetic";
  for (const m of a) {
    if (m.enabled === !1 || !ns(m, { mode: t.mode, selectedIds: p })) continue;
    const f = ss(m, t.content);
    if (!f) continue;
    const d = is(a, m, l) || { position: m.position, size: m.size }, h = Ve(cs(d, m.type), o, n, i);
    if (!h) continue;
    const [b, u] = h, v = t.content === "annotation" && m.annotation?.color || "", y = 6 * c, x = 4 * c, g = r.measureText(f).width + y * 2, k = 12 * c + x * 2, _ = Math.round(b - g / 2), I = Math.round(u - k - 6 * c);
    r.fillStyle = "rgba(16,17,22,0.82)", Ou(r, _, I, g, k, 4 * c), r.fill(), v && (r.strokeStyle = v, r.lineWidth = Math.max(1, c), r.stroke()), r.fillStyle = v || "#e6e6ec", r.fillText(f, _ + y, I + k - x - 2 * c);
  }
  r.restore();
}
function Ou(e, t, a, o, r, n) {
...
function ie(e, t, a, o = "#5a5a5a", r = 1) {
  const n = e.viewportCamera(), i = Ve(t, n, e.canvas.width, e.canvas.height), c = Ve(a, n, e.canvas.width, e.canvas.height);
...
function Lu(e) {
  ...
  return e._pointFieldCache?.key !== r && (e._pointFieldCache = { key: r, ...Vc(t, a, o) }), e._pointFieldCache;
}
const zu = 600;
function Nu(e) {
  const { points: t, colors: a } = Lu(e);
  if (!t.length) return;
  const o = e.viewportCamera(), r = e.canvas.width, n = e.canvas.height, i = t.length / 3, c = 3 * Math.max(1, Math.ceil(i / zu)), l = /* @__PURE__ */ new Map();
  for (let p = 0; p < t.length; p += c) {
    const m = Ve([t[p], t[p + 1], t[p + 2]], o, r, n);
    if (!m) continue;
    const f = Q(Math.round(5 / Math.sqrt(m[2])), 1, 4), d = `${Math.round(a[p] * 255)},${Math.round(a[p + 1] * 255)},${Math.round(a[p + 2] * 255)}|${f}`;
    let h = l.get(d);
...
function Du(e, t) {
  const [a, o, r] = t.position || [0, 0, 0], n = t.size?.[1] || 1.8, i = (t.size?.[0] || 0.7) * 0.5, c = [a, o + n * 0.88, r], l = [a, o + n * 0.76, r], p = [a - i * 0.55, o + n * 0.73, r], m = [a + i * 0.55, o + n * 0.73, r], f = [a - i * 0.72, o + n * 0.52, r], d = [a + i * 0.72, o + n * 0.52, r], h = [a - i * 0.82, o + n * 0.34, r], b = [a + i * 0.82, o + n * 0.34, r], u = [a, o + n * 0.44, r], v = [a - i * 0.28, o + n * 0.44, r], y = [a + i * 0.28, o + n * 0.44, r], x = [a - i * 0.28, o + n * 0.22, r], S = [a + i * 0.28, o + n * 0.22, r], g = [a - i * 0.28, o, r + 0.05], k = [a + i * 0.28, o, r + 0.05];
  ie(e, c, l, "#aaa", 2), ie(e, l, u, "#aaa", 2), ie(e, p, m, "#aaa", 2), ie(e, p, f, "#aaa", 2), ie(e, f, h, "#aaa", 2), ie(e, m, d, "#aaa", 2), ie(e, d, b, "#aaa", 2), ie(e, v, y, "#aaa", 2), ie(e, v, x, "#aaa", 2), ie(e, x, g, "#aaa", 2), ie(e, y, S, "#aaa", 2), ie(e, S, k, "#aaa", 2);
  const _ = Ve(c, e.viewportCamera(), e.canvas.width, e.canvas.height);
  _ && (e.ctx.strokeStyle = "#aaa", e.ctx.beginPath(), e.ctx.arc(_[0], _[1], Q(28 / _[2], 3, 12), 0, Math.PI * 2), e.ctx.stroke());
}
function Ku(e, t) {
  ...
  for (let b = 0; b < f; b++) {
    const u = (b + 1) % f;
    ie(e, d[b], d[u], "#aaa", 1.5), ie(e, h[b], h[u], "#aaa", 1.5);
  }
  for (let b = 0; b < f; b += 3)
...
function Uu(e, t) {
  const [a, o, r] = t.position || [0, 1.5, 0], [n, i] = t.size || [2, 3], c = e.viewportCamera(), l = [
    ...
    [a + n / 2, o + i / 2, r],
    [a - n / 2, o + i / 2, r]
  ].map((v) => Ve(v, c, e.canvas.width, e.canvas.height));
  ...
  if (u)
    try {
      ...
      if (e.ctx.fillStyle = "#111", e.ctx.fillRect(f, h, v, y), g === "stretch" || !x || !S)
        ...
        const k = Math.min(v / x, y / S), _ = x * k, I = S * k;
        e.ctx.drawImage(u, f + (v - _) / 2, h + (y - I) / 2, _, I);
      } else {
        const k = Math.max(v / x, y / S), _ = v / k, I = y / k;
        e.ctx.drawImage(u, (x - _) / 2, (S - I) / 2, _, I, f, h, v, y);
      }
    } catch {
    }
  else
...
function Wu(e) {
  ...
  (e.state.cameras || []).forEach((a, o) => {
    ...
    if (!(i && e.state.view_mode === "camera")) {
      ...
      for (const c of r) {
        const l = Ve(c.camera.position, e.viewportCamera(), e.canvas.width, e.canvas.height);
      ...
      if (e.state.view_mode !== "camera") {
        const c = $e(a, e.frame, e.state.objects), l = Ve(c.position, e.viewportCamera(), e.canvas.width, e.canvas.height);
...
function Vu(e) {
  ...
  for (let o = 0; o < e.state.keyframes.length - 1; o++) {
    ...
    t.push($o(jt(n.camera.position, r.camera.position)) * e.state.fps / Math.max(1, n.frame - r.frame));
  }
...
function Hu(e) {
  ...
  e.recording && e.state.playblast_labels && Iu(e);
}
async function Gu(e, { signal: t } = {}) {
...
async function Xu(e) {
  ...
  const r = o.diagnostic?.issues || [], n = Yu(r);
...
function di(e) {
  ...
  const r = (d, h, b, u, v = "") => {
    ...
    `, v.addEventListener("click", () => {
      e.outlinerCollapsedSections ||= /* @__PURE__ */ new Set(), e.outlinerCollapsedSections.has(b) ? e.outlinerCollapsedSections.delete(b) : e.outlinerCollapsedSections.add(b), di(e);
  ...
  if (p) {
    ...
    if (t.appendChild(h), !b)
      for (const u of d) {
        ...
        const k = document.createElement("span");
        if (k.className = "scene-item-label", S || y) {
          const P = document.createElement("span");
          P.style.cssText = `color:${S ? "#f59e0b" : "#58cc6b"};font-weight:700`, P.textContent = S ? "● " : "○ ", k.appendChild(P);
        }
        if (k.appendChild(document.createTextNode(u.name)), x) {
          const P = document.createElement("span");
          P.style.cssText = "color:#f2d06b;font-size:10px", P.title = "Playblast Output", P.textContent = " ★", k.appendChild(P);
        }
        if (u.muted) {
          const P = document.createElement("span");
          P.style.opacity = ".6", P.textContent = " (muted)", k.appendChild(P);
        }
        const _ = document.createElement("div");
        _.className = "scene-item-actions", _.appendChild(r("pi-star", "Solo track", u.solo, () => {
          e.checkpoint("Solo track"), u.solo = !u.solo, e.serialize(), e.refreshObjects(), e.renderCameraView();
        }, "color:#fbbf24;border-color:#78350f;background:rgba(245,158,11,0.2)")), _.appendChild(r("pi-volume-off", "Mute track", u.muted, () => {
          e.checkpoint("Mute track"), u.muted = !u.muted, e.serialize(), e.refreshObjects(), e.renderCameraView();
        }, "color:#f87171;border-color:#7f1d1d;background:rgba(239,68,68,0.15)")), _.appendChild(r("pi-lock", "Lock track", u.locked, () => {
          e.checkpoint("Lock track"), u.locked = !u.locked, e.serialize(), e.refreshObjects(), e.renderCameraView();
        })), (u.keyframes || []).length >= 1 && _.appendChild(r(
          "pi-arrows-alt",
        ...
        )), _.appendChild(r("pi-ellipsis-v", "Camera actions", !1, (P) => e.openCameraContext(P, u.id, !1))), v.append(g, k, _), v.title = S ? s("Currently selected for editing") : x ? s("Active playblast camera") : s("Click to select & activate this camera");
        const I = () => {
  ...
  if (m) {
    ...
    const u = [], v = (g, k) => {
      u.push({ object: g, level: k });
      const _ = h.get(g.id) || [];
      for (const I of _) v(I, k + 1);
    };
    for (const g of b) v(g, 0);
    const y = u.filter(({ object: g }) => {
      const k = [g.name, g.type, ...g.tags || [], g.asset_kind, g.asset_id].filter(Boolean).join(" ");
      return !(!i(k) || a === "lights" && !l(g.type) || a === "objects" && l(g.type) || a === "hidden" && g.enabled !== !1);
    }), { header: x, isCollapsed: S } = c(a === "lights" ? s("Lights") : s("Objects"), y.length, "objects");
    if (t.appendChild(x), !S)
      for (const { object: g, level: k } of y) {
        const _ = document.createElement("div");
        _.role = "button", _.tabIndex = 0, _.dataset.objectId = g.id;
        const I = e.selectedEntity === "object" && (g.id === e.selectedObjectId || e.selectedObjectIds?.has?.(g.id)), P = e.selectedEntity === "object" && g.id === e.selectedObjectId;
        _.setAttribute("aria-selected", String(I)), _.className = `scene-item${I ? " selected" : ""}${P ? " primary" : ""}${k > 0 && !n ? " scene-item-child" : ""}`, k > 0 && !n && (_.style.paddingLeft = `${k * 16 + 6}px`);
        const B = g.type === "card" ? { icon: "pi-image", color: "#38bdf8" } : g.type === "model" || g.type === "glb" ? { icon: "pi-box", color: "#c084fc" } : g.type === "ground" ? { icon: "pi-minus", color: "#fbbf24" } : g.type === "cube" ? { icon: "pi-stop", color: "#fbbf24" } : g.type === "sphere" ? { icon: "pi-circle", color: "#fbbf24" } : g.type === "cylinder" ? { icon: "pi-database", color: "#fbbf24" } : g.type === "torus" ? { icon: "pi-circle", color: "#fbbf24" } : g.type === "pyramid" ? { icon: "pi-play", color: "#fbbf24" } : g.type === "sun_light" ? { icon: "pi-sun", color: "#f59e0b" } : g.type === "point_light" ? { icon: "pi-bolt", color: "#fbbf24" } : g.type === "spot_light" ? { icon: "pi-compass", color: "#38bdf8" } : g.type === "human" ? { icon: "pi-user", color: "#34d399" } : { icon: "pi-plus", color: "#94a3b8" }, W = g.enabled !== !1, H = !!g.load_error, oe = document.createElement("i");
        oe.className = `pi ${H ? "pi-exclamation-triangle" : B.icon}`, oe.style.cssText = H ? "color:#f87171" : W ? `color:${B.color}` : "opacity:.4";
        const E = document.createElement("span");
        E.className = "scene-item-label";
        const K = document.createElement("span");
        K.style.cssText = H ? "color:#fca5a5" : W ? "" : "opacity:.5;text-decoration:line-through", K.textContent = g.name || g.type, K.title = s("Double-click to rename"), K.addEventListener("dblclick", (A) => {
          A.preventDefault(), A.stopPropagation(), ab(e, g, K);
        }), E.appendChild(K);
        const V = Array.isArray(g.tags) ? g.tags : [];
        if (V.length) {
          const A = document.createElement("span");
          A.className = "scene-item-tags";
          for (const G of V.slice(0, 2)) {
            const F = document.createElement("span");
            F.className = "scene-item-tag", F.textContent = G, A.appendChild(F);
          }
          if (V.length > 2) {
            const G = document.createElement("span");
            G.className = "scene-item-tag scene-item-tag-more", G.textContent = `+${V.length - 2}`, A.appendChild(G);
          }
          E.appendChild(A);
        }
        if (H) {
          const A = document.createElement("span");
          A.style.cssText = "color:#ef4444;font-size:9px;font-weight:700", A.textContent = " [Format!]", E.appendChild(A);
        }
        const X = document.createElement("div");
        X.className = "scene-item-actions", X.appendChild(r(W ? "pi-eye" : "pi-eye-slash", W ? "Hide object (Alt+Click to Isolate)" : "Show object (Alt+Click to Isolate)", !W, (A) => {
          if (A?.altKey) {
            if (e.checkpoint("Isolate object"), e._isolatedObjectId === g.id) {
              ...
              for (const Y of e.state.objects)
                Y.enabled = F && Object.prototype.hasOwnProperty.call(F, Y.id) ? F[Y.id] : !0;
              e._isolationSnapshot = null, e.setStatus?.(s("Isolation cleared"));
            } else {
              e._isolationSnapshot || (e._isolationSnapshot = Object.fromEntries(e.state.objects.map((F) => [F.id, F.enabled !== !1]))), e._isolatedObjectId = g.id;
              for (const F of e.state.objects) F.enabled = F.id === g.id;
              e.setStatus?.(s("Isolated: {name}").replace("{name}", g.name || g.type));
            }
            e.serialize(), e.refreshObjects(), e.requestRender?.();
          } else
            e.toggleObject(g.id);
        }, "color:#ef4444;opacity:.7")), X.appendChild(r(g.locked ? "pi-lock" : "pi-lock-open", "Lock object", g.locked, () => Kr(e, g))), X.appendChild(r("pi-copy", "Duplicate object", !1, () => e.duplicateObject?.(g.id))), g.id !== "subject" && X.appendChild(r("pi-trash", "Delete object", !1, () => e.deleteObject?.(g.id))), X.appendChild(r("pi-ellipsis-v", "Object actions", !1, (A) => e.openObjectContext(A, g.id))), _.append(oe, E, X), _.title = s("Click to select · Double-click to toggle visibility · Right-click for actions");
        const N = (A = {}) => {
          if (A.altKey && g.id !== "subject") return void e.deleteObject(g.id);
          if (e.finishCameraEdit(), e.selectedEntity = "object", e.selectedObjectIds ||= /* @__PURE__ */ new Set(), A.ctrlKey || A.metaKey)
            e.selectedObjectIds.has(g.id) ? e.selectedObjectIds.delete(g.id) : e.selectedObjectIds.add(g.id), e.outlinerAnchorId = g.id;
          else if (A.shiftKey && e.outlinerAnchorId && e.state.objects.some((F) => F.id === e.outlinerAnchorId)) {
            const F = e.state.objects.map((le) => le.id), Y = F.indexOf(e.outlinerAnchorId), ee = F.indexOf(g.id);
            e.selectedObjectIds = new Set(F.slice(Math.min(Y, ee), Math.max(Y, ee) + 1));
          } else
            e.selectedObjectIds = /* @__PURE__ */ new Set([g.id]), e.outlinerAnchorId = g.id;
          e.selectedObjectId = e.selectedObjectIds.has(g.id) ? g.id : [...e.selectedObjectIds].at(-1) || null, e.selectedEntity = e.selectedObjectIds.size ? "object" : "camera", e.selectedKeyFrame = e.selectedObjectId ? g.keyframes?.find((F) => F.frame === e.frame)?.frame ?? null : null, e.editingKeyFrame = null;
          for (const F of t.querySelectorAll(".scene-item")) {
            const Y = !!(F.dataset.objectId && e.selectedObjectIds.has(F.dataset.objectId)), ee = !!(F.dataset.objectId && F.dataset.objectId === e.selectedObjectId);
            F.classList.toggle("selected", Y), F.classList.toggle("primary", ee), F.dataset.objectId && F.setAttribute("aria-selected", String(Y));
          }
          const G = e.root.querySelector('[data-role="outliner-batch-bar"]');
          if (G) {
            const F = e.selectedObjectIds?.size || 0;
            G.hidden = F < 2;
            const Y = G.querySelector('[data-role="batch-count"]');
            Y && (Y.textContent = `${F} ${s("selected")}`);
          }
          e.refreshKeys(), e.refreshInspector(), e.render(), e.setStatus(s(`Selected: ${g.name || g.type}`));
        };
        _.addEventListener("dblclick", () => e.toggleObject(g.id)), _.addEventListener("contextmenu", (A) => {
          A.preventDefault(), A.stopPropagation(), e.openObjectContext(A, g.id);
        }), _.addEventListener("keydown", (A) => {
          (A.key === "Enter" || A.key === " ") && (A.preventDefault(), N(A));
        }), t.appendChild(_);
      }
  }
...
function ob(e, t) {
  ...
  e.state.objects.push(k), e.selectedEntity = "object", e.selectedObjectId = a, e.selectedObjectIds = /* @__PURE__ */ new Set([a]), e.selectedKeyFrame = null, e.serialize(), e.refreshObjects(), e.refreshKeys(), e.render();
}
async function rb(e, t) {
  const a = e.state.objects.find((r) => r.id === t);
  if (!a) return;
  const o = (await Yt(e, s("Rename object"), s("Object name"), a.name || a.type))?.trim();
...
async function pi(e, t) {
  ...
  const a = e.state.objects.find((o) => o.id === t);
  if (a && await Xt(e, s("Delete object"), s(`Delete ${a.name || a.type} and its ${(a.keyframes || []).length} keyframe(s)?`)) && !(e.disposed || !e.state.objects.includes(a))) {
...
function cb(e) {
  const t = Qt(e), a = e.root.querySelector('[data-role="object-panel"]');
  a && (a.hidden = !t);
  const o = (E) => e.root.querySelector(E), r = e.activeCameraTrack(), n = o('[data-role="camera-target-object"]');
  if (n) {
    const E = r.target_object_id || e.state.target_object_id || "", K = `T${on()}${e.state.objects.map((V) => `${V.id}\0${V.name || V.type}`).join("|")}`;
    nr(n, K, () => [
      Ut("", s("Manual Target (No Tracking)")),
      ...e.state.objects.map((V) => Ut(V.id, `${s("Track:")} ${V.name || V.type}`))
    ], E);
  }
  tb(e);
  const i = [...e.camera.position, ...e.camera.target, e.camera.fov, e.camera.roll || 0, e.camera.near, e.camera.far, ...Pr(e.camera)];
  ["camera-px", "camera-py", "camera-pz", "camera-tx", "camera-ty", "camera-tz", "camera-fov", "camera-roll", "camera-near", "camera-far", "camera-rx", "camera-ry", "camera-rz"].forEach((E, K) => {
    for (const V of e.root.querySelectorAll(`[data-role="${E}"]`))
      document.activeElement !== V && (V.value = String(Math.round(i[K] * 1e4) / 1e4));
  });
  for (const E of e.root.querySelectorAll('[data-role="camera-type"]'))
    document.activeElement !== E && (E.value = e.camera.camera_type || "perspective");
  for (const E of e.root.querySelectorAll('[data-role="speed"]'))
    document.activeElement !== E && (E.value = String(e.cameraSpeed || 1));
  for (const E of e.root.querySelectorAll('[data-role="active-camera-select"]'))
    document.activeElement !== E && (E.value = e.state.active_camera_id);
  for (const E of e.root.querySelectorAll('[data-role="camera-color"]'))
    document.activeElement !== E && (E.value = r?.color || "#4aa3ef");
  if (!t) {
    const E = o('[data-role="object-recon-badge"]');
    E && (E.hidden = !0);
    const K = o('[data-role="selected-name"]');
    K && (K.textContent = `${r.name} · F${e.frame}`), qn(o, {
  ...
  if (c) {
    ...
    if (E) {
      c.hidden = !1;
      const K = E.semantic ? `${E.semantic} · ` : "";
      c.textContent = `${K}${E.label} (${Math.round(E.confidence * 100)}%)`, c.title = E.title, c.className = `oc-recon-badge oc-badge-${E.band}`;
    } else
      c.hidden = !0;
  }
  ...
  if (l) {
    ...
    E && (E.className = `pi ${t.locked ? "pi-lock" : "pi-lock-open"}`);
  }
  const p = t.position || [0, 0, 0], m = o('[data-role="selected-name"]');
  m && (m.textContent = t.name || t.type), qn(o, {
  ...
  for (const [E, K] of Object.entries(h))
    for (const V of e.root.querySelectorAll(`[data-role="${E}"]`))
      document.activeElement !== V && (V.value = String(Math.round(K * 1e4) / 1e4));
  for (const E of e.root.querySelectorAll('[data-role="object-material"]'))
    document.activeElement !== E && (E.value = t.material_mode || "textured");
  for (const E of e.root.querySelectorAll('[data-role="object-color"]'))
    document.activeElement !== E && (E.value = t.color || "#8c929b");
  for (const E of e.root.querySelectorAll('[data-role="object-light-color"]'))
    document.activeElement !== E && (E.value = t.color || "#ffffff");
  for (const E of e.root.querySelectorAll("[data-transform-mode]")) E.classList.toggle("active", E.dataset.transformMode === (e.state.gizmo_mode || "translate"));
  const b = o('[data-role="animation-row"]'), u = o('[data-role="animation-select"]'), v = o('[data-role="object-parent"]');
  if (v) {
    const E = t.id, K = /* @__PURE__ */ new Set([E]);
    let V = !0;
    for (; V; ) {
      V = !1;
      for (const A of e.state.objects)
        !K.has(A.id) && A.parent_id && K.has(A.parent_id) && (K.add(A.id), V = !0);
    }
    const X = e.state.objects.filter((A) => !K.has(A.id)), N = `P${on()}${E}${X.map((A) => `${A.id} ${A.name || A.type}`).join("|")}`;
    nr(v, N, () => [
      Ut("", s("No parent")),
      ...X.map((A) => Ut(A.id, A.name || A.type))
    ], t.parent_id || "");
  }
  ...
  g && (g.hidden = !x);
  const k = o('[data-role="material-row"]');
  k && (k.hidden = y);
  const _ = o('[data-role="scale-row"]');
  _ && (_.hidden = y);
  const I = o('[data-role="rotation-row"]');
  if (I && (I.hidden = t.type === "point_light"), y) {
    const E = o('[data-role="object-intensity"]');
    E && document.activeElement !== E && (E.value = String(t.intensity ?? (t.type === "sun_light" ? 2.2 : t.type === "spot_light" ? 3 : 2)));
    const K = o('[data-role="object-cast-shadow"]');
    if (K && (K.checked = t.cast_shadow !== !1), x) {
      const V = o('[data-role="object-cone-angle"]');
      V && document.activeElement !== V && (V.value = String(t.cone_angle ?? 45));
  ...
  if (b && (b.hidden = !P?.animations), u) {
    const E = P?.animationNames || [];
    nr(u, `A${E.join("|")}`, () => E.map((K, V) => Ut(String(V), K)), String(t.animation_index || 0));
  }
  const B = o('[data-role="object-tags"]');
  B && document.activeElement !== B && (B.value = (t.tags || []).join(", "));
  const W = o('[data-role="object-annotation"]');
  W && document.activeElement !== W && (W.value = t.annotation?.text || "");
...
function lb(e) {
  ...
  if ((e.lastObjectNumericEditId !== t.id || !Number.isFinite(e.lastObjectNumericEditAt) || i - e.lastObjectNumericEditAt > 300) && e.checkpoint?.("Edit object"), e.lastObjectNumericEditId = t.id, e.lastObjectNumericEditAt = i, t.position = [a("object-x", o[0]), a("object-y", o[1]), a("object-z", o[2])], t.rotation = [a("object-rx", r[0]), a("object-ry", r[1]), a("object-rz", r[2])], t.size = [Math.max(0.01, a("object-sx", n[0])), Math.max(0.01, a("object-sy", n[1])), Math.max(0.01, a("object-sz", n[2]))], ["sun_light", "point_light", "spot_light"].includes(t.type)) {
    ...
    if (l && (t.cast_shadow = l.checked), t.type === "spot_light") {
      ...
      p && p.value !== "" && (t.cone_angle = Q(Number(p.value) || 45, 1, 90));
      const m = e.root.querySelector('[data-role="object-penumbra"]');
      m && m.value !== "" && (t.penumbra = Q(Number(m.value) || 0.25, 0, 1));
    }
  }
...
function pb(e) {
  ...
  const a = (n, i) => {
    ...
    Q(a("camera-rx", o[0]), -90, 90),
    a("camera-ry", o[1]),
    Q(a("camera-rz", o[2]), -180, 180)
  ];
  e.beginCameraEdit(), Hc(e.camera, r), e.commitCameraEdit(), e.finishCameraEdit(), hi(e), mb(e), e.render();
}
function fb(e) {
  const t = globalThis.performance?.now?.() ?? Date.now();
  (!Number.isFinite(e.lastCameraHudEditAt) || t - e.lastCameraHudEditAt > 300) && e.checkpoint("Edit camera"), e.lastCameraHudEditAt = t;
  ...
  e.camera.position = [a("camera-px", e.camera.position[0]), a("camera-py", e.camera.position[1]), a("camera-pz", e.camera.position[2])], e.camera.target = [a("camera-tx", e.camera.target[0]), a("camera-ty", e.camera.target[1]), a("camera-tz", e.camera.target[2])], e.camera.fov = Q(a("camera-fov", e.camera.fov), 5, 150), e.camera.roll = Q(a("camera-roll", e.camera.roll || 0), -180, 180), e.camera.near = Math.max(1e-4, a("camera-near", e.camera.near)), e.camera.far = Math.max(e.camera.near + 1e-4, a("camera-far", e.camera.far)), e.beginCameraEdit(), e.commitCameraEdit(), e.finishCameraEdit(), hi(e), e.render();
}
function hb(e, t) {
  const a = Qt(e);
  if (!a) return;
...
function bb(e, t) {
  e.objectUrls.revoke(t), Zt(e, t), e.modelUrlsById.delete(t), e.modelInfoById.delete(t), e.webgl?.removeModel(t);
}
function gb(e) {
  const t = [...e.selectedObjectIds?.size ? e.selectedObjectIds : [e.selectedObjectId]].filter((o) => o && e.state.objects.some((r) => r.id === o));
  if (!t.length) return [];
  if (t.length === 1)
    return mi(e, t[0]), e.selectedObjectId ? [e.selectedObjectId] : [];
  ...
  return t.forEach((o, r) => {
    ...
    const c = 0.35 + r * 0.15;
    i.position = fe(i.position || [0, 0, 0], [c, 0, c]), (i.type === "model" || i.type === "glb") && e.modelUrlsById.has(n.id) ? e.modelUrlsById.set(i.id, e.modelUrlsById.get(n.id)) : i.type === "card" && e.cardMediaById.has(n.id) && at(e, i.id, e.cardMediaById.get(n.id), !1, i.asset || e.cardMediaAssetById?.get?.(n.id) || ""), e.state.objects.push(i), a.push(i.id);
...
function kb(e, t) {
  return t(ys(e), e.frame);
}
function Ne(e) {
  return e.selectedEntity === "object" && e.state.objects.find((t) => t.id === e.selectedObjectId) || null;
}
function Ee(e) {
  return Ne(e)?.keyframes || e.state.keyframes;
}
function Sb(e, t) {
  for (const a of e.state.objects) {
...
function jb(e) {
  ...
  const t = e.root.querySelector('[data-role="key-interp"]')?.value || e.root.querySelector('[data-role="interp"]')?.value || "ease", a = Ne(e), o = Ee(e), r = a ? { frame: e.frame, transform: He(a), interpolation: t } : { frame: e.frame, camera: ce(e.camera), interpolation: t }, n = o.findIndex((i) => i.frame === e.frame);
...
function Cb(e) {
  ...
  const o = Ge(e) || a.find((i) => i.frame === e.frame);
...
function Eb(e) {
  const t = Ne(e), a = Ge(e) || Ee(e).find((o) => o.frame === e.frame);
  e.copiedKeyframe = t ? { kind: "object", transform: He(a?.transform || t), interpolation: a?.interpolation || e.root.querySelector('[data-role="interp"]')?.value || "ease" } : { kind: "camera", camera: ce(a?.camera || e.camera), interpolation: a?.interpolation || e.root.querySelector('[data-role="interp"]')?.value || "ease" }, e.setStatus(s(`Keyframe copied @ ${a?.frame ?? e.frame}`));
}
function Ab(e) {
  if (!e.copiedKeyframe) return e.setStatus(s("Copy a keyframe first"));
  const t = Ne(e), a = t ? "object" : "camera";
  if (e.copiedKeyframe.kind !== a) return e.setStatus(s(`Copy a ${a} keyframe first`));
  e.checkpoint("Paste keyframe");
  const o = t ? { frame: e.frame, transform: He(e.copiedKeyframe.transform), interpolation: e.copiedKeyframe.interpolation } : { frame: e.frame, camera: ce(e.copiedKeyframe.camera), interpolation: e.copiedKeyframe.interpolation }, r = Ee(e), n = r.findIndex((i) => i.frame === e.frame);
...
const Lb = ["guides", "safe-areas", "resolution-gate", "aspect-ratio"];
function zb(e) {
...
function Rb(e) {
  const t = Ne(e), a = Ge(e), o = e.root.querySelector('[data-role="key-editor"]');
  ...
  for (const h of e.root.querySelectorAll("[data-interp]"))
...
function Db(e, t, a = !1, o = {}) {
  const r = Ge(e);
  if (!r) return;
  const n = Ee(e);
  let i = Q(Math.round(t), 0, e.state.duration_frames - 1);
...
function Kb(e) {
  const t = Ge(e);
  if (!t) return;
  if (e.checkpoint("Edit keyframe"), e.editingKeyFrame = t.frame, Ne(e)) {
    t.interpolation = e.root.querySelector('[data-role="key-interp"]').value, t.transform = He(Ne(e)), e.serialize(), e.setFrame(t.frame), e.setStatus(s(`Object keyframe updated @ ${t.frame}`));
    return;
  }
  const a = (r, n) => {
  ...
  if (t.interpolation = e.root.querySelector('[data-role="key-interp"]').value, t.camera.position = [a("key-px", t.camera.position[0]), a("key-py", t.camera.position[1]), a("key-pz", t.camera.position[2])], t.camera.target = [a("key-tx", t.camera.target[0]), a("key-ty", t.camera.target[1]), a("key-tz", t.camera.target[2])], t.camera.fov = Q(a("key-fov", t.camera.fov), 5, 150), t.camera.roll = Q(a("key-roll", t.camera.roll || 0), -180, 180), t.camera.zoom = Math.max(0.01, a("key-zoom", t.camera.zoom || 1)), t.camera.near = Math.max(1e-4, a("key-near", t.camera.near)), t.camera.far = Math.max(t.camera.near + 1e-4, a("key-far", t.camera.far)), t.camera.camera_type = e.root.querySelector('[data-role="key-camera-type"]').value, e.root.querySelector('[data-role="key-timing-weight"]')) {
    const r = Gc(t, a("key-timing-weight", us(t)));
...
function kr(e, t, a) {
  const o = Re(e), r = t ? Re(t) : o, n = a ? Re(a) : o, i = Math.max(wr, Te(e?.frame) - Te(t?.frame, Te(e?.frame) - 1)), c = Math.max(wr, Te(a?.frame, Te(e?.frame) + 1) - Te(e?.frame)), l = [0, 0, 0], p = [0, 0, 0];
  for (let m = 0; m < 3; m += 1) {
...
function bi(e, t, a) {
  const o = Re(e), r = t ? Re(t) : o, n = a ? Re(a) : o;
  return {
    out: Fo(Et(n, o), 1 / 3),
    in: Fo(Et(r, o), 1 / 3)
  };
...
function gi(e, t, a) {
  const o = Re(e), r = jr(e, t, a);
  mt(e, "out", Et(r.out, o)), mt(e, "in", Et(r.in, o));
}
function Wb(e, t, a, { prevKey: o = null, nextKey: r = null, breakCoupling: n = !1 } = {}) {
  if (!e || t !== "in" && t !== "out") return e;
  let i = dt(e);
  if (i === "corner") return e;
  i === "auto" && (i = "aligned", e.tangents = e.tangents && typeof e.tangents == "object" ? e.tangents : {}, e.tangents.spatial_mode = "aligned", gi(e, o, r));
  const c = Re(e), l = Et([
    Te(a?.[0]),
    Te(a?.[1]),
    Te(a?.[2])
  ], c);
  if (Ro(e), mt(e, t, l), i === "aligned" && !n) {
    const p = t === "out" ? "in" : "out", m = Sr(e, p) || (p === "out" ? kr(e, o, r).out : kr(e, o, r).in), f = Un(l), d = Un(m) || f || 1, h = f > wr ? Fo(l, -d / f) : Fo(m, 1);
    mt(e, p, h);
  }
  return e;
}
function wo(e, t, a) {
  if (!e || t !== "in" && t !== "out") return e;
  const o = Re(e);
  return Ro(e), mt(e, t, Et([
    Te(a?.[0]),
    Te(a?.[1]),
    Te(a?.[2])
  ], o)), e;
}
function Vb(e, t, { prevKey: a = null, nextKey: o = null } = {}) {
  ...
  if (t === "corner") {
    const r = bi(e, a, o);
    return Ro(e), mt(e, "out", r.out), mt(e, "in", r.in), e;
  }
  return Ro(e), gi(e, a, o), e;
}
function Hb(e) {
  switch (e) {
    case "auto":
...
function Yb(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: b, syncActiveCameraTrack: u, syncFromWidgets: v, bindEditorEvents: y, activateCamera: x, addCamera: S, deleteCamera: g, drawPreviewOverlays: k, duplicateCamera: _, maximizeCameraPreview: I, refreshCameraPreviews: P, refreshCameraSelectors: B, renameCamera: W, setPlayblastCamera: H, toggleCameraView: oe, captureRealtime: E, makePlayblast: K, uploadDirectorPlayblast: V, waitForMediaFrame: X, computeAudioPeaks: N, loadAudioFile: A, releaseAudio: G, stopPlay: F, togglePlay: Y, applyCameraPreset: ee, applyCameraShake: le, applyProxyPreset: se, clearViewportBgImage: re, loadViewportBgFile: de, loadViewportBgSequence: ge, drawCameraPath: he, drawCard: ye, drawCube: ve, drawGrid: pe, drawHuman: Me, drawLine3D: xe, drawNull: we, drawOverlays: be, drawPointField: L, drawSpeedHeatmap: U, drawSphere: me, curveChannels: _e, drawCurveEditor: Oe, onCurvePointerDown: De, onCurvePointerMove: Pe, onCurvePointerUp: rt, onTimelinePointerDown: ea, onTimelinePointerMove: ta, onTimelinePointerUp: aa, refreshKeys: Tt, resetCurveZoom: $t, resetTimelineZoom: ft, setChannelFilter: Mt, setCurveInterpolation: It, setTangentMode: Ot, timelineFrameFromEvent: oa, toggleCurveHandles: Pt, zoomCurve: ra, drawTransformGizmo: na, frameTarget: sa, gizmoAxes: ia, gizmoGeometry: ca, onPointerDown: la, onPointerMove: da, onPointerUp: ma, onWheel: pa, pickGizmo: fa, pickSceneObject: ha, resetCamera: Lt, setTransformMode: zt, setViewMode: ua, viewportCamera: ba, loadCardFile: Wo, loadExecutionPreview: Vo, loadMediaUrl: ga, loadModelFile: ya, loadSelectedReference: va, onModelLoaded: xa, restoreAssets: wa, syncUpstreamInputs: ka, configureDomMedia: Sa, refreshSetupDiagnostic: Nt, addMediaCard: ja, addPrimitive: _a, applyObjectAnimationFrame: Ca, beginCameraEdit: Ea, beginObjectEdit: Aa, commitCameraEdit: Ta, commitObjectEdit: $a, copyKeyframe: Ma, deleteKeyframe: Ia, deleteObject: Oa, duplicateObject: Pa, exitKeyEdit: La, finishCameraEdit: za, goToAdjacentKey: Na, insertKeyframe: Fa, loadSelectedKeyView: Ra, pasteKeyframe: Da, playblastCameraAtFrame: Ka, refreshInspector: Ba, refreshKeyEditor: qa, refreshObjects: Ua, removeObjectResources: Wa, renameObject: Va, retimeSelectedKey: Ha, selectKeyframe: Ga, selectedKeyframe: Ya, selectedObject: Xa, selectObjectAnimation: Ja, setKeyInterpolation: Za, setObjectParent: Qa, timelineKeyframes: eo, timelineObject: nt, toggleAutoKey: to, toggleObject: ao, updateCameraFromHud: oo, updateEditState: ro, updateKeyVisualState: no, updateSelectedKey: so, updateSelectedObject: io, clamp: Ft, cloneCamera: co, configureCore: lo, defaultCamera: mo, sampleCamera: Ye, sampleObjectTransform: Ho, sanitizeState: ht, worldTransform: Le } = e;
  return {
    setSelectMode(z) {
      if (["object", "vertex", "edge", "face"].includes(z)) {
        this.state.select_mode = z, this.subSelection = null;
        for (const M of this.root.querySelectorAll("[data-select-mode]")) {
          const j = M.dataset.selectMode === z;
          M.classList.toggle("active", j), M.setAttribute("aria-pressed", String(j));
        }
        for (const M of this.root.querySelectorAll('[data-role="select-mode"]'))
          M.value = z;
    ...
    hideInternalWidgets() {
      for (const z of ["state_json", "recording_path", "card_asset"]) {
        const M = this.node.widgets?.find((j) => j.name === z);
        M && (M.computeSize = () => [0, -4], M.draw = () => {
        }, M.hidden = !0, M.options = { ...M.options || {}, hideInVueNodes: !0 });
      }
    },
    restoreFromWidgets() {
      h(this);
    ...
    restoreHistorySnapshot(z) {
      ...
      const j = Wn(this.state), w = new Set(this.state.objects.map((Z) => Z.id));
      this.state = ht(M.state);
      const C = new Set(this.state.objects.map((Z) => Z.id));
      for (const Z of w) C.has(Z) || this.removeObjectResources(Z);
      this.frame = Ft(M.frame, 0, this.state.duration_frames - 1);
      const $ = new Set(this.state.objects.map((Z) => Z.id)), D = Array.isArray(M.selectedObjectIds) ? M.selectedObjectIds : [M.selectedObjectId].filter(Boolean);
      this.selectedObjectIds = new Set(D.filter((Z) => $.has(Z))), this.selectedObjectId = this.selectedObjectIds.has(M.selectedObjectId) ? M.selectedObjectId : [...this.selectedObjectIds].at(-1) || null, this.selectedEntity = this.selectedObjectIds.size ? "object" : M.selectedEntity || "camera";
      const J = new Set(this.timelineKeyframes().map((Z) => Z.frame)), R = Array.isArray(M.selectedKeyFrames) ? M.selectedKeyFrames : [M.selectedKeyFrame].filter((Z) => Z != null);
      this.selectedKeyFrames = new Set(R.filter((Z) => J.has(Z))), this.selectedKeyFrame = this.selectedKeyFrames.has(M.selectedKeyFrame) ? M.selectedKeyFrame : [...this.selectedKeyFrames].at(-1) ?? null, this.pathSelection = Yc(this.pathSelection, this.activeCameraTrack()), this.subSelection = M.subSelection || null, this.camera = Ye(this.state, this.frame), Vt(this, this.activeCameraTrack(), this.camera, this.frame), this.cameraPreviewSignature = "", this.serialize(), j !== Wn(this.state) && this.restoreAssets(), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
    },
    checkpoint(z) {
    ...
    closeMenus(z = null) {
      for (const M of this.root.querySelectorAll(".toolbar-menu")) M !== z && (M.open = !1);
    ...
    showContextMenu(z, M, j) {
      return this.contextMenu.show(z, M, j);
    },
    onContextMenu(z) {
      ...
      const M = z.target, j = M.closest?.(".camera-preview-tile"), w = M.closest?.(".scene-item"), C = M.closest?.(".key");
      if (j) return this.openCameraContext(z, j.dataset.cameraId, !0);
      ...
      if (C) {
        const $ = this.timelineKeyframes().find((D) => D.frame === Number(C.dataset.keyFrame));
        return $ && this.selectKeyframe($), this.openTimelineContext(z, !0);
      }
      if (M.closest?.('[data-role="keys"]'))
        return this.setFrame(this.timelineFrameFromEvent(z, M.closest('[data-role="keys"]'))), this.openTimelineContext(z, !1);
      if (M.closest?.(".curve-editor")) return this.openCurveContext(z);
      if (M.closest?.(".viewport-wrap")) {
        const $ = this.interactionElement.getBoundingClientRect(), D = (z.clientX - $.left) * this.canvas.width / Math.max(1, $.width), J = (z.clientY - $.top) * this.canvas.height / Math.max(1, $.height), R = this.pickSceneObject([D, J]);
        if (R) {
          if ((R.type === "object" || R.type === "object_keyframe") && R.object)
            return this.selectedEntity = "object", this.selectedObjectId = R.object.id, R.keyframe ? (this.setFrame(R.keyframe.frame), this.selectedKeyFrame = R.keyframe.frame) : this.selectedKeyFrame = R.object.keyframes?.find((Z) => Z.frame === this.frame)?.frame ?? null, this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), this.openObjectContext(z, R.object.id);
          if (["camera", "camera_target", "camera_keyframe"].includes(R.type) && R.camera)
            return this.selectedEntity = R.type === "camera_target" ? "camera_target" : "camera", this.selectedObjectId = null, this.activateCamera(R.camera.id), R.keyframe && (this.setFrame(R.keyframe.frame), this.selectedKeyFrame = R.keyframe.frame), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), R.type === "camera_keyframe" && R.keyframe ? this.openPathKeyContext(z, R.camera.id, R.keyframe.frame) : this.openCameraContext(z, R.camera.id, !1);
        }
    ...
    openViewportContext(z) {
      ...
      this.showContextMenu(z, s("Viewport"), [
        {
          label: M ? `${s("Set key")} · ${M.name || M.type}` : `${s("Set key")} · ${this.activeCameraTrack().name}`,
          icon: "pi-key",
          shortcut: "I",
    ...
    openObjectContext(z, M) {
      const j = this.state.objects.find(($) => $.id === M);
      if (!j) return;
      this.selectedEntity = "object", this.selectedObjectId = M, this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
      const w = ["sun_light", "point_light", "spot_light"].includes(j.type), C = this.selectedObjectIds?.size || 0;
      if (C >= 2 && this.selectedObjectIds.has(M)) {
      ...
      this.showContextMenu(z, j.name || j.type, [
        { label: s("Set key"), icon: "pi-key", shortcut: "I", run: () => this.insertKeyframe() },
        { label: s("Frame subject"), icon: "pi-search", shortcut: "F", run: () => this.frameTarget() },
        { label: s("Rename object…"), icon: "pi-pencil", run: () => this.renameObject(M) },
        { label: s("Duplicate object"), icon: "pi-copy", run: () => this.duplicateObject(M) },
        { label: j.enabled === !1 ? s("Show object") : s("Hide object"), icon: j.enabled === !1 ? "pi-eye" : "pi-eye-slash", run: () => this.toggleObject(M) },
        { label: j.locked ? s("Unlock object") : s("Lock object"), icon: j.locked ? "pi-lock" : "pi-lock-open", run: () => Kr(this, j) },
        null,
        {
          label: s("Transform mode"),
          icon: "pi-arrows-alt",
        ...
        },
        {
          ...
          icon: "pi-bullseye",
          items: [
            { label: s("Camera tracks this object (Look-At)"), icon: "pi-bullseye", help: s("Lock camera live look-at tracking to this moving object"), run: () => this.aimAtSelectedObject(M) },
            ...
            null,
            { label: s("Select hierarchy"), icon: "pi-sitemap", shortcut: "Shift+G", help: s("Select this object and all descendants"), run: () => this.selectHierarchy(M) }
          ]
        },
        ...w ? [
          {
            ...
            items: [
              {
                label: s("Shadow"),
                icon: "pi-circle-fill",
                checked: j.cast_shadow !== !1,
                run: () => {
                  this.checkpoint("Toggle light shadow"), j.cast_shadow = j.cast_shadow === !1, this.serialize(), this.refreshInspector(), this.render();
                }
              }
            ]
          }
        ...
        null,
        { label: s("Reset entire animation"), icon: "pi-replay", danger: !0, help: s("Delete every animation key and return position/rotation to zero"), run: () => this.resetObjectAnimation(M) },
        null,
        { label: s("Delete object"), icon: "pi-trash", danger: !0, disabled: M === "subject", help: M === "subject" ? s("The canonical subject card cannot be deleted") : s("Delete this object and its animation keys"), run: () => this.deleteObject(M) }
      ]);
    },
    openCameraContext(z, M, j = !1) {
      const w = this.state.cameras.find((C) => C.id === M);
      w && (this.selectedEntity = "camera", this.selectedObjectId = null, this.activateCamera(M), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), this.showContextMenu(z, `${w.name}${j ? " preview" : ""}`, [
        { label: s("Edit this camera"), icon: "pi-video", run: () => this.activateCamera(M) },
        {
          label: s("Select whole path — move / scale / rotate"),
          icon: "pi-arrows-alt",
          disabled: (w.keyframes || []).length < 1,
          run: () => {
            this.activateCamera(M), this.selectCameraPath() && this.setStatus(`${w.name} · ${s("whole path selected — move / scale / rotate")}`);
          }
        },
        { label: s("Set as primary / playblast"), icon: "pi-star", disabled: M === this.state.playblast_camera_id, run: () => this.setPlayblastCamera(M) },
        { label: s("Set key at playhead"), icon: "pi-key", shortcut: "I", run: () => {
          this.activateCamera(M), this.insertKeyframe();
        } },
        { label: s("Record this preview"), icon: "pi-circle-fill", run: () => {
          this.setPlayblastCamera(M), this.makePlayblast();
        } },
        { label: this.state.maximized_camera_id === M ? s("Restore preview size") : s("Maximize preview"), icon: "pi-window-maximize", run: () => this.maximizeCameraPreview(M) },
        null,
        {
          label: s("Shot order & handles"),
          icon: "pi-sliders-h",
          items: [
            { label: s("Shot: move earlier"), icon: "pi-arrow-up", disabled: this.state.cameras.findIndex((C) => C.id === M) <= 0, run: () => this.moveShot(M, -1) },
            { label: s("Shot: move later"), icon: "pi-arrow-down", disabled: this.state.cameras.findIndex((C) => C.id === M) >= this.state.cameras.length - 1, run: () => this.moveShot(M, 1) },
            null,
            { label: s("Shot handles…"), icon: "pi-sliders-h", run: () => this.editShotHandles(M) }
          ]
        },
        null,
        { label: s("Rename camera…"), icon: "pi-pencil", run: () => this.renameCamera(M) },
        { label: s("Duplicate camera"), icon: "pi-copy", run: () => this.duplicateCamera(M) },
        { label: s("Create camera from current view"), icon: "pi-plus", run: () => this.addCamera() },
        null,
        { label: s("Reset entire animation"), icon: "pi-replay", danger: !0, help: s("Delete every camera key and return to a static zero pose at frame 0"), run: () => this.resetCameraAnimation(M) },
        null,
        { label: s("Delete camera"), icon: "pi-trash", danger: !0, disabled: this.state.cameras.length <= 1, run: () => this.deleteCamera(M) }
      ]));
    },
    openPathKeyContext(z, M, j) {
      const w = this.state.cameras.find((Z) => Z.id === M);
      if (!w) return;
      this.selectedEntity = "camera", this.selectedObjectId = null, this.activateCamera(M);
      const C = (w.keyframes || []).find((Z) => Z.frame === j) || null;
      C && this.selectKeyframe(C), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
      const $ = C ? dt(C) : "auto", D = this.selectedKeyFrames?.size || 0, J = this.pathSelection?.component === "target", R = ms(w);
      this.showContextMenu(z, `Path key F${j}`, [
        ...
        null,
        {
          ...
          items: [
            { label: s("Position"), checked: !J, run: () => this.setPathSelectionComponent("position") },
            {
              label: s("Target"),
              checked: J,
              disabled: R,
    ...
    moveShot(z, M) {
      const j = this.state.cameras.findIndex(($) => $.id === z), w = j + M;
      if (j < 0 || w < 0 || w >= this.state.cameras.length) return;
      this.checkpoint("Reorder shot");
      const [C] = this.state.cameras.splice(j, 1);
    ...
    async editShotHandles(z) {
      const M = this.state.cameras.find(($) => $.id === z);
      if (!M) return;
      const j = M.handles || { in: 0, out: 0 }, w = await i(t, s("Shot handles…"), "Handle frames: in,out", `${j.in},${j.out}`);
      if (w == null) return;
      const C = String(w).match(/^\s*(\d+)\s*[,;\s]\s*(\d+)\s*$/);
      if (!C) return this.setStatus("Handles must be two integers: in,out");
      this.checkpoint("Shot handles"), M.handles = { in: Math.min(600, Number(C[1])), out: Math.min(600, Number(C[2])) }, this.serialize(), this.setStatus(`${M.name} handles: ${M.handles.in} / ${M.handles.out}`);
    },
    openTimelineContext(z, M) {
      const j = this.selectedKeyFrames?.size || 0, w = this.selectedKeyframe(), C = w?.interpolation || "ease", $ = w && dt(w) || "auto", D = ["ease", "linear", "bezier", "smooth", "ease_in", "ease_out", "sine", "cubic", "quintic", "expo", "back"], J = ["auto", "clamped", "vector", "free", "aligned", "flat"];
      this.showContextMenu(z, M ? `Keyframe F${this.selectedKeyFrame}` : `Timeline F${this.frame}`, [
        { label: s("Fit timeline view (F)"), icon: "pi-arrows-alt", shortcut: "F", run: () => ft(this) },
        ...
        null,
        {
          label: j >= 2 ? s("Delete {count} keys").replace("{count}", String(j)) : s("Delete selected key"),
          icon: "pi-trash",
          shortcut: "Delete",
          danger: !0,
          disabled: j < 2 && !w,
    ...
    addMarker() {
      if ((this.state.markers || []).find((M) => M.frame === this.frame)) return this.setStatus(`Marker already at F${this.frame}`);
      this.checkpoint("Add marker"), this.state.markers = [...this.state.markers || [], { frame: this.frame, name: `Marker ${(this.state.markers || []).length + 1}`, color: "#f2d06b" }].sort((M, j) => M.frame - j.frame), this.serialize(), this.refreshKeys(), this.setStatus(`Marker @ F${this.frame}`);
    },
    removeNearestMarker() {
      const z = this.state.markers || [];
      if (!z.length) return;
      const M = z.reduce((j, w) => Math.abs(w.frame - this.frame) < Math.abs(j.frame - this.frame) ? w : j);
      this.checkpoint("Remove marker"), this.state.markers = z.filter((j) => j !== M), this.serialize(), this.refreshKeys(), this.setStatus(`Marker removed @ F${M.frame}`);
    },
    openCurveContext(z) {
      const M = this.selectedKeyFrames?.size || 0, j = M < 2 && !this.selectedKeyframe(), w = this.selectedKeyframe(), C = w?.interpolation || "ease", $ = w && dt(w) || "auto", D = ["bezier", "smooth", "linear", "ease_in", "ease_out", "ease", "sine", "cubic", "quintic", "expo", "back"], J = ["auto", "clamped", "vector", "free", "aligned", "flat"];
      this.showContextMenu(z, s("Curve editor"), [
        { label: s("Fit all curves (Framing)"), icon: "pi-arrows-alt", shortcut: "F", run: () => $t(this) },
        { label: s("Set key at playhead"), icon: "pi-key", shortcut: "I", run: () => this.insertKeyframe() },
        ...
        null,
        { label: M >= 2 ? s("Delete {count} keys").replace("{count}", String(M)) : s("Delete selected key"), icon: "pi-trash", danger: !0, disabled: j, run: () => this.deleteSelectedKeyframes() }
      ]);
    },
    ...
    refitNode() {
      ...
      try {
        if (z && typeof z.computeSize == "function" && typeof z.setSize == "function") {
          const M = z.computeSize();
          Array.isArray(M) && z.setSize([z.size?.[0] ?? M[0], M[1]]);
        }
    ...
    resizeCanvas() {
      ...
      if (!z) return;
      const M = Math.min(2, window.devicePixelRatio || 1), j = z.clientWidth || 320, w = z.clientHeight || 180, C = Math.max(320, Math.round(j * M)), $ = Math.max(180, Math.round(w * M));
      ...
      for (const D of this.cameraPreviewCanvases.values()) {
        const J = D.clientWidth || 220, R = D.clientHeight || 124, Z = Math.max(M, Gb / Math.max(1, J)), Se = Math.max(1, Math.round(J * Z)), Ke = Math.max(1, Math.round(R * Z));
        (D.width !== Se || D.height !== Ke) && (D.width = Se, D.height = Ke);
      }
...
function Xr(e, t) {
  const a = e.map((i) => Zb(i, t)), o = Qb(a), r = e.map((i) => i.frame), n = Math.max(1, r[r.length - 1] - r[0]);
  return a.map((i, c) => [
    (r[c] - r[0]) / n,
...
function tg(e, t, { tolerance: a = 0.02, keepFrames: o = [] } = {}) {
...
function ag(e, t, { target: a = 2, keepFrames: o = [] } = {}) {
...
function og(e, t, { mergeWithin: a = 1, epsilon: o = 1e-3, keepFrames: r = [] } = {}) {
...
function ng(e, t, a, { lastFrame: o = 1 / 0 } = {}) {
...
function cg(e, t, a, o, r) {
  const n = xt(e, t, r), i = xt(t, a, r), c = xt(a, o, r), l = xt(n, i, r), p = xt(i, c, r), m = xt(l, p, r);
...
function dg(e, { leftFrame: t, rightFrame: a, t: o = 0.5 } = {}) {
  ...
  const c = Math.min(0.999, Math.max(1e-3, Number.isFinite(o) ? o : 0.5)), l = Math.round(t + c * (a - t)), p = lg(r, t, a, l);
  ...
  if (u) {
    const S = [...f.camera.position], g = jr(f, h, d).out, k = jr(d, f, b).in, _ = [...d.camera.position], I = cg(S, g, k, _, m);
    y.camera = { ...ce(v), position: [...I.point] };
    const P = dt(f);
    (P === "free" || P === "aligned") && wo(f, "out", I.left[1]);
    const B = dt(d);
    (B === "free" || B === "aligned") && wo(d, "in", I.right[2]), wo(y, "in", I.left[2]), wo(y, "out", I.right[1]);
  }
...
function mg(e, t) {
  const a = [...e.position], o = Array.isArray(t) ? [...t] : [...e.target], r = jt(o, a), n = $o(r) > 1e-9 ? Jo(r) : [0, 0, -1];
  let i = rn(n, Zr);
  $o(i) < 1e-6 && (i = [1, 0, 0]), i = Jo(i);
  const c = Jo(rn(i, n));
...
function ko(e, { degrees: t = 180, direction: a = "cw", radius: o, radiusEnd: r, heightOffset: n = 0, samples: i = 5, close: c = !1 } = {}) {
  ...
  for (let g = 0; g < y; g += 1) {
    const k = c ? g / y : g / (y - 1), _ = d + v * k, I = h + (b - h) * k;
    S.push({
      position: [l[0] + Math.cos(_) * I, x, l[2] + Math.sin(_) * I],
      target: [...l]
    });
  }
  return S;
}
function hg({ type: e, camera: t, target: a, startFrame: o, endFrame: r, params: n = {} } = {}) {
  if (!xi.includes(e)) return { ok: !1, reason: "unknown_preset" };
  ...
  const l = mg(t, a), p = Number(n.distance) > 0 ? Number(n.distance) : 1, m = (u, v, y) => ({
  ...
  switch (e) {
    ...
    case "arc_right":
      ...
      break;
    case "orbit":
      f = ko(l, { ...m(180, n.direction === "ccw" ? "ccw" : "cw", 5), close: !!n.close });
      break;
    case "spiral":
      f = ko(l, {
...
const Zn = { motion: "motion", shot: "display", health: "health" }, ug = {
  object: "Object",
  camera: "Camera",
  camera_target: "Look-At Target",
  camera_path: "Camera Path"
}, bg = { motion: "Motion", shot: "Shot", health: "Health" }, gg = ["entity", "motion", "shot", "health"];
function wi(e) {
  return e.inspectorMode && e.inspectorMode !== "entity" ? e.inspectorMode : "entity";
}
function yg(e) {
  const t = wi(e);
  return Zn[t] ? Zn[t] : e.selectedEntity === "object" ? "scene" : "camera";
}
function vg(e) {
  return [
    e.selectedEntity || "",
...
function xg(e) {
  const t = vg(e);
  e._lastInspectorSelKey !== void 0 && e._lastInspectorSelKey !== t && (e.inspectorMode = "entity"), e._lastInspectorSelKey = t, ki(e);
}
function ki(e) {
  const t = yg(e);
  ...
  r && (r.textContent = o === "entity" ? s(ug[e.selectedEntity] || "Inspector") : s(bg[o] || "Inspector"));
}
function wg(e, t) {
  e.inspectorMode = gg.includes(t) ? t : "entity", ki(e), e.render?.(), e.refitNode?.();
}
function kg(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: b, syncActiveCameraTrack: u, syncFromWidgets: v, bindEditorEvents: y, activateCamera: x, addCamera: S, deleteCamera: g, drawPreviewOverlays: k, duplicateCamera: _, maximizeCameraPreview: I, refreshCameraPreviews: P, refreshCameraSelectors: B, renameCamera: W, setPlayblastCamera: H, toggleCameraView: oe, captureRealtime: E, makePlayblast: K, uploadDirectorPlayblast: V, waitForMediaFrame: X, computeAudioPeaks: N, loadAudioFile: A, releaseAudio: G, stopPlay: F, togglePlay: Y, applyCameraPreset: ee, applyCameraShake: le, applyProxyPreset: se, clearViewportBgImage: re, loadViewportBgFile: de, loadViewportBgSequence: ge, drawCameraPath: he, drawCard: ye, drawCube: ve, drawGrid: pe, drawHuman: Me, drawLine3D: xe, drawNull: we, drawOverlays: be, drawPointField: L, drawSpeedHeatmap: U, drawSphere: me, curveChannels: _e, drawCurveEditor: Oe, onCurvePointerDown: De, onCurvePointerMove: Pe, onCurvePointerUp: rt, onTimelinePointerDown: ea, onTimelinePointerMove: ta, onTimelinePointerUp: aa, refreshKeys: Tt, resetCurveZoom: $t, resetTimelineZoom: ft, setChannelFilter: Mt, setCurveInterpolation: It, setTangentMode: Ot, timelineFrameFromEvent: oa, toggleCurveHandles: Pt, zoomCurve: ra, drawTransformGizmo: na, frameTarget: sa, gizmoAxes: ia, gizmoGeometry: ca, onPointerDown: la, onPointerMove: da, onPointerUp: ma, onWheel: pa, pickGizmo: fa, pickSceneObject: ha, resetCamera: Lt, setTransformMode: zt, setViewMode: ua, viewportCamera: ba, loadCardFile: Wo, loadExecutionPreview: Vo, loadMediaUrl: ga, loadModelFile: ya, loadSelectedReference: va, onModelLoaded: xa, restoreAssets: wa, syncUpstreamInputs: ka, configureDomMedia: Sa, refreshSetupDiagnostic: Nt, addMediaCard: ja, addPrimitive: _a, applyObjectAnimationFrame: Ca, beginCameraEdit: Ea, beginObjectEdit: Aa, commitCameraEdit: Ta, commitObjectEdit: $a, copyKeyframe: Ma, deleteKeyframe: Ia, deleteObject: Oa, deleteSelectedObjects: Pa, duplicateObject: La, exitKeyEdit: za, finishCameraEdit: Na, goToAdjacentKey: Fa, insertKeyframe: Ra, loadSelectedKeyView: Da, pasteKeyframe: Ka, playblastCameraAtFrame: Ba, refreshInspector: qa, refreshKeyEditor: Ua, refreshObjects: Wa, removeObjectResources: Va, renameObject: Ha, retimeSelectedKey: Ga, selectKeyframe: Ya, selectedKeyframe: Xa, selectedObject: Ja, selectObjectAnimation: Za, setKeyInterpolation: Qa, setKeyTangentMode: eo, setObjectParent: nt, timelineKeyframes: to, timelineObject: ao, toggleAutoKey: oo, toggleObject: ro, updateCameraFromHud: no, updateCameraRotationFromHud: so, updateEditState: io, updateKeyVisualState: Ft, updateSelectedKey: co, updateSelectedObject: lo, clamp: mo, cloneCamera: Ye, configureCore: Ho, defaultCamera: ht, sampleCamera: Le, sampleObjectTransform: z, sanitizeState: M, worldTransform: j } = e;
  return {
    setChannelFilter(w) {
      Mt(this, w);
    },
    setFrame(w, C = !1, $ = !0) {
      this.frame = mo(Math.round(w), 0, this.state.duration_frames - 1), this.editingKeyFrame !== this.frame && (this.editingKeyFrame = null), this.camera = Le(this.activeCameraTrack(), this.frame, this.state.objects), Vt(this, this.activeCameraTrack(), this.camera, this.frame), this.applyObjectAnimationFrame();
      const D = this.dom ||= Bs(this.root);
      for (const te of D.frames) document.activeElement !== te && (te.value = String(this.frame));
      for (const te of D.scrubs) te.value = String(this.frame);
      for (const te of D.cameraFov) document.activeElement !== te && (te.value = String(Math.round(this.camera.fov * 100) / 100));
      for (const te of D.cameraRoll) document.activeElement !== te && (te.value = String(Math.round((this.camera.roll || 0) * 100) / 100));
      for (const te of D.cameraFocal) document.activeElement !== te && (te.value = Lr(this.camera.fov));
      for (const te of D.viewportZoom) te.textContent = `${(Number(this.camera.zoom) || 1).toFixed(2)}x`;
      for (const te of D.cameraType) document.activeElement !== te && (te.value = this.camera.camera_type || "perspective");
      for (const te of D.cameraNear) document.activeElement !== te && (te.value = String(this.camera.near ?? 0.01));
      for (const te of D.cameraFar) document.activeElement !== te && (te.value = String(this.camera.far ?? 1e4));
      const J = this.frame / this.state.fps;
      for (const te of this.cardMediaById.values()) te instanceof HTMLVideoElement && Number.isFinite(te.duration) && te.duration > 0 && (te.currentTime = J % te.duration);
      const R = Math.floor(J / 60), Z = Math.floor(J % 60), Se = Math.floor(J % 1 * 1e3), Ke = this.frame % Math.max(1, Math.round(this.state.fps)), st = Math.floor(this.frame / this.state.fps);
      if ((D.time || this.root.querySelector('[data-role="time"]')).textContent = this.state.timecode_mode === "timecode" ? `${String(Math.floor(st / 3600)).padStart(2, "0")}:${String(Math.floor(st / 60) % 60).padStart(2, "0")}:${String(st % 60).padStart(2, "0")}:${String(Ke).padStart(2, "0")}` : `${String(R).padStart(2, "0")}:${String(Z).padStart(2, "0")}.${String(Se).padStart(3, "0")}`, $) this.refreshKeys();
      else {
        Mo(this);
        for (const te of this.root.querySelectorAll("[data-key-frame]")) {
          const ne = Number(te.dataset.keyFrame);
          te.classList.toggle("at-playhead", ne === this.frame), te.classList.toggle("selected", ne === this.selectedKeyFrame), te.classList.toggle("editing", ne === this.editingKeyFrame);
        }
    ...
    setSpatialHandleMode(w) {
      ...
      const $ = this.activeCameraTrack()?.keyframes || [], D = $.findIndex((J) => J.frame === this.selectedKeyFrame);
      if (D < 0) {
        this.setStatus(s("Select a camera keyframe first"));
        return;
      }
      this.checkpoint(s("Camera path handle: {mode}").replace("{mode}", w)), Vb($[D], w, {
        prevKey: $[D - 1] || null,
        nextKey: $[D + 1] || null
    ...
    setPathSelectionComponent(w) {
      this.pathSelection = Zc(this.pathSelection, w), this.refreshInspector(), this.render();
    },
    ...
    insertPathKeyAtCursor(w) {
      ...
      const C = this.interactionElement.getBoundingClientRect(), $ = (w.clientX - C.left) * this.canvas.width / Math.max(1, C.width), D = (w.clientY - C.top) * this.canvas.height / Math.max(1, C.height), J = this.webgl.pickPathSegment([$, D]);
      if (!J) return !1;
      const R = (this.state.cameras || []).find((Se) => Se.id === J.cameraId);
      if (!R || R.locked) return !1;
      const Z = dg(R.keyframes || [], {
        leftFrame: J.leftFrame,
        rightFrame: J.rightFrame,
        t: J.t
      });
      return Z.ok ? (this.checkpoint(s("Insert camera path key")), R.id !== this.state.active_camera_id && this.activateCamera(R.id), R.keyframes = Z.keys, this.state.keyframes = Z.keys, this.camera = Le(R, this.frame, this.state.objects), R.camera = Ye(this.camera), Jc(this, { cameraId: R.id, frame: Z.frame, additive: !1 }), this.serialize(), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), this.setStatus(s("Camera path key inserted at frame {frame}").replace("{frame}", String(Z.frame))), !0) : (this.setStatus(Z.reason === "no_free_frame" ? s("No free frame here to insert a key") : s("Could not insert a key here")), !0);
    },
    ...
    transformCameraPath(w) {
      ...
      const $ = ps(C.keyframes, { origin: ds(C.keyframes), ...w });
      return C.keyframes = $, C.id === this.state.active_camera_id && (this.state.keyframes = $), this.camera = Le(C, this.frame, this.state.objects), C.camera = Ye(this.camera), this.serialize(), this.refreshKeys(), this.refreshInspector(), this.render(), this.renderCameraView?.(), !0;
    },
    ...
    async openCameraPathPresetPicker() {
      ...
      const C = xi.map((D) => ({ id: D, label: s(Hn[D] || D) })), $ = await gs({ title: s("Camera Path Preset"), items: C, owner: this });
    ...
    toggleInspector(w) {
      ...
      for (const D of this.root.querySelectorAll('[data-act="toggle-inspector"]'))
        D.classList.toggle("active", !$), D.setAttribute("aria-pressed", String(!$));
    ...
    selectHierarchy(w = this.selectedObjectId) {
      ...
      for (; $; ) {
        ...
        for (const D of this.state.objects)
          D.parent_id && C.has(D.parent_id) && !C.has(D.id) && (C.add(D.id), $ = !0);
      }
    ...
    playblastCameraAtFrame() {
      return Vt(this, d(this), Ba(this, Le), this.frame);
    },
    viewportCamera() {
      return ba(this);
    },
    ...
    lookAtObject(w) {
      ...
      if (C) {
        ...
        for (const $ of this.state.cameras)
          for (const D of $.keyframes) D.camera.target = [...C.position || [0, 1.5, 0]];
    ...
    refreshInspector() {
      this.perf && (this.perf.inspectorRefreshCount = (this.perf.inspectorRefreshCount || 0) + 1), qa(this), xg(this);
    },
    setInspectorMode(w) {
      wg(this, w);
    },
    ...
    aimAtSelectedObject(w) {
      ...
      const C = this.activeCameraTrack(), $ = w && this.state.objects.find((R) => R.id === w) || this.selectedObject() || this.state.objects.find((R) => R.id === "subject") || this.state.objects[0];
      if (!$) return;
      ...
      const J = ($.type === "model" || $.type === "glb" ? this.webgl?.getObjectWorldCenter?.($.id) : null) || ($.keyframes?.length ? z($, this.frame).position : $.position || [0, 1.5, 0]);
      this.camera.target = [...J], this.beginCameraEdit(), this.commitCameraEdit(), this.finishCameraEdit(), this.serialize(), this.refreshInspector(), this.updateHudCamera(), this.render(), this.setStatus(`Camera tracking locked to ${$.name || $.id}`);
    },
    setAimBone(w) {
      Qu(this, w);
    },
...
function Sg(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: b, syncActiveCameraTrack: u, syncFromWidgets: v, bindEditorEvents: y, activateCamera: x, addCamera: S, deleteCamera: g, drawPreviewOverlays: k, duplicateCamera: _, maximizeCameraPreview: I, refreshCameraPreviews: P, refreshCameraSelectors: B, renameCamera: W, setPlayblastCamera: H, toggleCameraView: oe, captureRealtime: E, makePlayblast: K, uploadDirectorPlayblast: V, waitForMediaFrame: X, computeAudioPeaks: N, loadAudioFile: A, releaseAudio: G, stopPlay: F, togglePlay: Y, applyCameraPreset: ee, applyCameraShake: le, applyProxyPreset: se, clearViewportBgImage: re, loadViewportBgFile: de, loadViewportBgSequence: ge, drawCameraPath: he, drawCard: ye, drawCube: ve, drawGrid: pe, drawHuman: Me, drawLine3D: xe, drawNull: we, drawOverlays: be, drawPointField: L, drawSpeedHeatmap: U, drawSphere: me, curveChannels: _e, drawCurveEditor: Oe, fitCurveView: De, onCurveDoubleClick: Pe, onCurvePointerDown: rt, onCurvePointerMove: ea, onCurvePointerUp: ta, onTimelinePointerDown: aa, onTimelinePointerMove: Tt, onTimelinePointerUp: $t, refreshKeys: ft, resetCurveZoom: Mt, resetTimelineZoom: It, setChannelFilter: Ot, setCurveInterpolation: oa, setTangentMode: Pt, timelineFrameFromEvent: ra, toggleCurveHandles: na, zoomCurve: sa, drawTransformGizmo: ia, frameTarget: ca, gizmoAxes: la, gizmoGeometry: da, onPointerDown: ma, onPointerMove: pa, onPointerUp: fa, onWheel: ha, pickGizmo: Lt, pickSceneObject: zt, resetCamera: ua, setTransformMode: ba, setViewMode: Wo, viewportCamera: Vo, loadCardFile: ga, loadExecutionPreview: ya, loadMediaUrl: va, loadModelFile: xa, loadSelectedReference: wa, onModelLoaded: ka, restoreAssets: Sa, syncUpstreamInputs: Nt, configureDomMedia: ja, refreshSetupDiagnostic: _a, addMediaCard: Ca, addPrimitive: Ea, applyObjectAnimationFrame: Aa, beginCameraEdit: Ta, beginObjectEdit: $a, commitCameraEdit: Ma, commitObjectEdit: Ia, copyKeyframe: Oa, deleteKeyframe: Pa, deleteObject: La, duplicateObject: za, exitKeyEdit: Na, finishCameraEdit: Fa, goToAdjacentKey: Ra, insertKeyframe: Da, loadSelectedKeyView: Ka, pasteKeyframe: Ba, playblastCameraAtFrame: qa, refreshInspector: Ua, refreshKeyEditor: Wa, refreshObjects: Va, removeObjectResources: Ha, renameObject: Ga, retimeSelectedKey: Ya, selectKeyframe: Xa, selectedKeyframe: Ja, selectedObject: Za, selectObjectAnimation: Qa, setKeyInterpolation: eo, setObjectParent: nt, timelineKeyframes: to, timelineObject: ao, toggleAutoKey: oo, toggleObject: ro, updateCameraFromHud: no, updateEditState: so, updateKeyVisualState: io, updateSelectedKey: Ft, updateSelectedObject: co, clamp: lo, cloneCamera: mo, configureCore: Ye, defaultCamera: Ho, sampleCamera: ht, sampleObjectTransform: Le, sanitizeState: z, worldTransform: M } = e;
  return {
    setTargetAtCursor(j) {
      if (!j) return;
      const w = this.interactionElement.getBoundingClientRect(), C = (j.clientX - w.left) * this.canvas.width / Math.max(1, w.width), $ = (j.clientY - w.top) * this.canvas.height / Math.max(1, w.height), D = this.webgl?.intersectScenePoint?.(C, $, this.canvas.width, this.canvas.height);
    ...
    setPlaybackRange(j) {
      ...
      j === "start" ? w[0] = Math.min(this.frame, w[1]) : j === "end" && (w[1] = Math.max(this.frame, w[0])), this.state.playback_range = w, this.serialize(), this.refreshKeys(), this.setStatus(`Range: F${w[0]}–F${w[1]}`);
    },
    clearPlaybackRange() {
    ...
    async loadMediaUrl(j, w, C, $) {
      return va(this, j, w, C, $);
    },
    restoreAssets() {
      Sa(this);
    },
...
function _g(e) {
  const { right: t, up: a, forward: o } = Qc(e || {});
  return jg.map((r) => {
...
const Ag = "http://www.w3.org/2000/svg", wt = 26, Qn = 17, Tg = 5.4;
function kt(e, t) {
  const a = document.createElementNS(Ag, e);
...
function $g(e) {
  ...
  for (const n of Cg(_g(a))) {
    const i = wt + n.x * Qn, c = wt + n.y * Qn, l = Eg(n.depth);
    t.appendChild(kt("line", {
      x1: wt,
      y1: wt,
      x2: i,
      y2: c,
...
function Ig(e) {
  ...
  for (const r of e.state.motion_layers || []) {
    ...
    const n = Mg(e.state, r, e.frame, a, o);
    if (n.length) {
...
const Og = ["world_point", "object_point", "camera_field"], Si = {
  manual_2d: "DRAW",
  object_point: "OBJECT",
  world_point: "WORLD",
...
function Fg(e) {
  ...
  n("motion-sel-name", a.label), n("motion-sel-type", Si[a.source_kind] || "TRACK"), n("motion-sel-binding", Pg(e.state, a)), n("motion-sel-start", r.length ? Math.min(...r) : 0), n("motion-sel-end", r.length ? Math.max(...r) : 0);
...
function Kg(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: b, syncActiveCameraTrack: u, syncFromWidgets: v, bindEditorEvents: y, activateCamera: x, addCamera: S, deleteCamera: g, drawPreviewOverlays: k, duplicateCamera: _, maximizeCameraPreview: I, refreshCameraPreviews: P, refreshCameraSelectors: B, renameCamera: W, setPlayblastCamera: H, toggleCameraView: oe, captureRealtime: E, makePlayblast: K, uploadDirectorPlayblast: V, waitForMediaFrame: X, computeAudioPeaks: N, loadAudioFile: A, releaseAudio: G, stopPlay: F, togglePlay: Y, applyCameraPreset: ee, applyCameraShake: le, applyProxyPreset: se, clearViewportBgImage: re, loadViewportBgFile: de, loadViewportBgSequence: ge, drawCameraPath: he, drawCard: ye, drawCube: ve, drawCylinder: pe, drawGrid: Me, drawHuman: xe, drawLine3D: we, drawNull: be, drawOverlays: L, drawPointField: U, drawSpeedHeatmap: me, drawSphere: _e, drawTorus: Oe, curveChannels: De, drawCurveEditor: Pe, onCurvePointerDown: rt, onCurvePointerMove: ea, onCurvePointerUp: ta, onTimelinePointerDown: aa, onTimelinePointerMove: Tt, onTimelinePointerUp: $t, refreshKeys: ft, resetCurveZoom: Mt, resetTimelineZoom: It, setChannelFilter: Ot, setCurveInterpolation: oa, setTangentMode: Pt, timelineFrameFromEvent: ra, toggleCurveHandles: na, zoomCurve: sa, drawTransformGizmo: ia, frameTarget: ca, gizmoAxes: la, gizmoGeometry: da, onPointerDown: ma, onPointerMove: pa, onPointerUp: fa, onWheel: ha, pickGizmo: Lt, pickSceneObject: zt, resetCamera: ua, setTransformMode: ba, setViewMode: Wo, viewportCamera: Vo, loadCardFile: ga, loadExecutionPreview: ya, loadMediaUrl: va, loadModelFile: xa, loadSelectedReference: wa, onModelLoaded: ka, restoreAssets: Sa, syncUpstreamInputs: Nt, configureDomMedia: ja, refreshSetupDiagnostic: _a, addMediaCard: Ca, addPrimitive: Ea, applyObjectAnimationFrame: Aa, beginCameraEdit: Ta, beginObjectEdit: $a, commitCameraEdit: Ma, commitObjectEdit: Ia, copyKeyframe: Oa, deleteKeyframe: Pa, deleteObject: La, duplicateObject: za, exitKeyEdit: Na, finishCameraEdit: Fa, goToAdjacentKey: Ra, insertKeyframe: Da, loadSelectedKeyView: Ka, pasteKeyframe: Ba, playblastCameraAtFrame: qa, refreshInspector: Ua, refreshKeyEditor: Wa, refreshObjects: Va, removeObjectResources: Ha, renameObject: Ga, retimeSelectedKey: Ya, selectKeyframe: Xa, selectedKeyframe: Ja, selectedObject: Za, selectObjectAnimation: Qa, setKeyInterpolation: eo, setObjectParent: nt, timelineKeyframes: to, timelineObject: ao, toggleAutoKey: oo, toggleObject: ro, updateCameraFromHud: no, updateEditState: so, updateKeyVisualState: io, updateSelectedKey: Ft, updateSelectedObject: co, clamp: lo, cloneCamera: mo, configureCore: Ye, defaultCamera: Ho, sampleCamera: ht, sampleObjectTransform: Le, sanitizeState: z, worldTransform: M } = e;
  return {
    ...
    renderViewportOnly() {
      const j = this.ctx, w = this.canvas.width, C = this.canvas.height;
      if (j.fillStyle = this.state.viewport_bg_color || "#121212", j.fillRect(0, 0, w, C), this.viewportBgSequenceImages && this.viewportBgSequenceImages.length) {
        const ne = this.frame % this.viewportBgSequenceImages.length, Xe = this.viewportBgSequenceImages[ne];
        if (Xe?.complete && Xe.naturalWidth)
          try {
            j.drawImage(Xe, 0, 0, w, C);
          } catch {
          }
      } else if (this.viewportBgImage)
        try {
          j.drawImage(this.viewportBgImage, 0, 0, w, C);
        } catch {
        }
      const $ = this.state.render_mode, D = this.viewportCamera(), J = this.state.objects.some((ne) => ne.parent_id) ? this.state.objects.map((ne) => ne.parent_id ? { ...ne, ...M(this.state.objects, ne) } : ne) : this.state.objects, R = (this.viewportBgSequenceImages || []).map((ne) => ne.src), Z = this.viewportBgImage?.src || "", Se = this.pendingExtractorImport, Ke = Se ? [...this.state.cameras, {
        id: "__extractor_preview__",
        name: Se.label,
        color: "#9ca3af",
        camera: Se.track.keyframes[0]?.camera,
        keyframes: Se.track.keyframes
      }] : this.state.cameras, st = {
        ...this.state,
        cameras: Ke,
        objects: J,
        viewport_bg_image: Z,
      ...
      if (this.webgl) {
        try {
          const ne = this.recording ? 1 : this.webgl.supersampleFactor?.() ?? 1, Xe = ne > 1 ? Math.min(ne, 4096 / Math.max(1, w, C)) : 1, po = Xe > 1 ? Math.round(w * Xe) : w, Go = Xe > 1 ? Math.round(C * Xe) : C;
          this.webgl.render(st, D, this.cardMediaById, po, Go, this.modelUrlsById, this.frame, this.recording, this.selectedEntity, this.selectedObjectId, this.subSelection, this.selectedKeyFrame ?? null, this.selectedKeyFrames ? [...this.selectedKeyFrames] : null), j.imageSmoothingEnabled = !0, j.imageSmoothingQuality = "high", po !== w || Go !== C ? j.drawImage(this.webgl.canvas, 0, 0, po, Go, 0, 0, w, C) : j.drawImage(this.webgl.canvas, 0, 0, w, C), te = !0;
        } catch (ne) {
      ...
      !this.recording && this.state.speed_heatmap && this.drawSpeedHeatmap(), !this.recording && Rh(this), this.drawOverlays(), Ig(this), this.state.show_gizmo && $g(this), this.labelOverlay?.update(), this.rigOverlay?.update(), this.perf && (this.perf.viewportRenderCount = (this.perf.viewportRenderCount || 0) + 1);
    },
    ...
    requestRender(j = "unknown") {
      return this.requestUiUpdate(T.viewport | T.previews | T.motion, j);
    },
    ...
    requestUiUpdate(j = T.viewport, w = "unknown") {
      (this.renderReasons ||= /* @__PURE__ */ new Set()).add(w), this.uiDirtyMask = mp(this.uiDirtyMask, j), this.renderInvalidations = (this.renderInvalidations || 0) + 1, !this.renderScheduled && (this.renderScheduled = !0, this.renderFrame = requestAnimationFrame(() => {
        if (this.renderScheduled = !1, this.disposed) return;
        const C = this.uiDirtyMask || T.viewport;
        this.uiDirtyMask = 0, this.lastRenderReasons = [...this.renderReasons || []], this.renderReasons?.clear(), this.rendersCoalesced = (this.rendersCoalesced || 0) + 1, this.perf && (this.perf.renderCount = (this.perf.renderCount || 0) + 1), gt(C, T.outliner) && this.refreshObjects(), gt(C, T.timeline) && this.refreshKeys(), gt(C, T.inspector) && this.refreshInspector(), gt(C, T.viewport) && this.renderViewportOnly(), gt(C, T.previews) && this.renderCameraView(), gt(C, T.motion) && this.renderMotionUiOnly();
      }));
    },
    renderCameraView() {
      if (this.perf && (this.perf.previewRenderCount = (this.perf.previewRenderCount || 0) + 1), this.state.camera_view_visible) {
        ...
        let $ = null;
        if (C) {
          const D = this.state.active_camera_id, J = w.filter((R) => R.id !== D);
          $ = J.length ? J[this.cameraPreviewTick % J.length] : null;
        }
        for (const D of w) {
          const J = this.cameraPreviewCanvases.get(D.id), R = this.cameraPreviewContexts.get(D.id);
          if (!J?.width || !R) continue;
          const Z = J.width, Se = J.height, Ke = this.root.querySelector(`[data-camera-frame="${D.id}"]`);
          if (Ke && (Ke.textContent = `F${this.frame}`), C && D.id !== this.state.active_camera_id && D !== $) continue;
          const st = Vt(this, D, ht(D, this.frame, this.state.objects), this.frame);
          if (R.fillStyle = "#111", R.fillRect(0, 0, Z, Se), this.cameraWebgl)
            try {
              this.cameraWebgl.render({ ...this.state, keyframes: [], playblast_grid: !1, viewport_bg_image: this.viewportBgImage?.src || "", viewport_bg_sequence: (this.viewportBgSequenceImages || []).map((te) => te.src), __omnicamRevision: this.renderRevision || 0 }, st, this.cardMediaById, Z, Se, this.modelUrlsById, this.frame, !0), R.drawImage(this.cameraWebgl.canvas, 0, 0, Z, Se);
            } catch (te) {
              console.error("[OmniCam Preview Render Error]", te);
            }
          k(this, R, Z, Se);
        }
      }
    },
    drawPreviewOverlays(j, w, C) {
      k(this, j, w, C);
    },
    ...
    dispose() {
      this.disposed || (this.disposed = !0, this.agentBridge?.dispose?.(), this.transformControlsWiring?.dispose(), el(this), tl(), Ll(this), this.backgroundRequestId = (this.backgroundRequestId || 0) + 1, this.upstreamSyncId = (this.upstreamSyncId || 0) + 1, this.stopPlay(), clearTimeout(this.previewClickTimer), clearTimeout(this.connectionTimer), cancelAnimationFrame(this.restoreFrame), cancelAnimationFrame(this.serializeFrame), cancelAnimationFrame(this.resizeFrame), cancelAnimationFrame(this.renderFrame), this.abortController?.abort(), this.upstreamFetchController?.abort(), this.resizeObserver?.disconnect(), this.contextMenu?.dispose(), this.webgl?.dispose(), this.cameraWebgl?.dispose(), G(this), pu(this), this.objectUrls.clear(), this.cardMediaById.clear(), this.cardMediaAssetById?.clear?.(), this.modelUrlsById.clear(), this.modelInfoById.clear());
    }
  };
}
const Bg = 0.12;
function qg() {
  return {
    ...
    deleteSelectedKeyframes() {
      ...
      const t = this._activeTrack(), a = Ee(this), o = t.kind === "camera" ? 1 : 0, { keys: r, removed: n } = rg(a, e, { minKeys: o });
    ...
    nudgeSelectedKeyframes(e) {
      ...
      const a = this._activeTrack(), o = Math.max(0, this.state.duration_frames - 1), r = ng(Ee(this), t, e, { lastFrame: o });
    ...
    setSelectedKeysInterpolation(e) {
      ...
      this.checkpoint(s("Interpolation on {n} keys").replace("{n}", t.length)), a.write(sg(Ee(this), t, e)), this.serialize(), this.refreshKeys(), this.refreshKeyEditor(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} interpolation on {n} keys").replace("{mode}", e.replace(/_/g, " ")).replace("{n}", t.length));
    },
    setSelectedKeysTangentMode(e) {
      const t = this.resolveSelectedFrames();
      if (t.length < 2) return this.setTangentMode(e);
      const a = this._activeTrack(), o = pt(this).map((r) => r.id);
      this.checkpoint(s("Tangents on {n} keys").replace("{n}", t.length)), a.write(ig(Ee(this), t, e, o)), this.serialize(), this.refreshKeys(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} tangents on {n} keys").replace("{mode}", e).replace("{n}", t.length));
    },
    /**
    ...
    simplifyActiveKeys({ mode: e = "simplify", tolerance: t = 0, target: a = 0, scope: o = "camera", fromKeys: r = null, silent: n = !1 } = {}) {
      ...
      const l = this.resolveSelectedFrames(), p = o !== "all_cameras" && l.length >= 2 ? [l[0], l.at(-1)] : null, m = p ? [] : l, f = (b) => {
        const u = [...b].sort((I, P) => I.frame - P.frame), v = p ? p[0] : -1 / 0, y = p ? p[1] : 1 / 0, x = u.filter((I) => I.frame < v), S = u.filter((I) => I.frame >= v && I.frame <= y), g = u.filter((I) => I.frame > y);
        let k = S, _ = 0;
        if (S.length > 2) {
          const I = e === "reduce" ? ag(S, i, { target: a || Math.ceil(S.length / 2), keepFrames: m }) : e === "clean" ? og(S, i, { keepFrames: m }) : tg(S, i, { tolerance: t * Bg, keepFrames: m });
          k = I.keys, _ = I.removed;
        }
        return { keys: [...x, ...k, ...g].sort((I, P) => I.frame - P.frame), removed: _ };
      };
      let d = 0;
      const h = c.map((b) => {
...
class ji {
  constructor(t) {
    this.app = es, this.api = ot, this.node = t, this.root = Ls(), this.root.tabIndex = -1, this.dom = Bs(this.root), this.canvas = this.root.querySelector(".viewport-wrap > canvas"), this.cameraPreviewCanvases = /* @__PURE__ */ new Map(), this.cameraPreviewContexts = /* @__PURE__ */ new Map(), this.cameraPreviewSignature = "", this.interactionElement = this.canvas, this.interactionElement.tabIndex = 0, this.interactionElement.dataset.captureWheel = "true", this.ctx = this.canvas.getContext("2d", { alpha: !1 }), this.disposed = !1, this.renderRevision = 0, this.directorRevision = 0, this.webgl = null, this.cameraWebgl = null, this.webglReady = this.loadWebGLViewports(), this.transformControlsWiring = wf(this), this.stateWidget = t.widgets?.find((o) => o.name === "state_json"), this.recordingWidget = t.widgets?.find((o) => o.name === "recording_path"), this.cardWidget = t.widgets?.find((o) => o.name === "card_asset"), this.widthWidget = t.widgets?.find((o) => o.name === "width"), this.heightWidget = t.widgets?.find((o) => o.name === "height"), this.fpsWidget = t.widgets?.find((o) => o.name === "fps"), this.durationWidget = t.widgets?.find((o) => o.name === "duration_seconds"), this.modeWidget = t.widgets?.find((o) => o.name === "render_mode");
    let a = null;
    try {
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-HQm150V4.js"));
    } catch (a) {
    ...
    if (!this.disposed) {
      ...
      ol(this), this.resizeCanvas(), this.render(), this.renderCameraView();
    }
  }
}
const So = { app: es, api: ot, EditorHistory: Os, ContextMenuController: vs, initializeTooltips: Nl, promptText: Yt, ObjectUrlRegistry: Ps, buildRoot: Ls, dispatchDirectorKey: rl, activeCameraTrack: dr, bindWidgetCallbacks: Fl, playblastCameraTrack: ys, restoreFromWidgets: Rl, serializeEditorState: Dl, syncActiveCameraTrack: mr, syncFromWidgets: Kl, bindEditorEvents: Qh, activateCamera: Bl, addCamera: ql, deleteCamera: Ul, drawPreviewOverlays: Wl, duplicateCamera: Vl, maximizeCameraPreview: Hl, refreshCameraPreviews: Gl, refreshCameraSelectors: Yl, renameCamera: Xl, setPlayblastCamera: Jl, toggleCameraView: Zl, captureRealtime: ni, makePlayblast: Eu, uploadDirectorPlayblast: si, waitForMediaFrame: ri, computeAudioPeaks: Qs, loadAudioFile: lu, releaseAudio: Lo, stopPlay: Ao, togglePlay: su, applyCameraPreset: kf, applyCameraShake: Sf, applyProxyPreset: jf, clearViewportBgImage: Mu, loadViewportBgFile: Tu, loadViewportBgSequence: $u, drawCameraPath: Wu, drawCard: Uu, drawCube: Fu, drawCylinder: Ku, drawGrid: Pu, drawHuman: Du, drawLine3D: ie, drawNull: qu, drawOverlays: Hu, drawPointField: Nu, drawSpeedHeatmap: Vu, drawSphere: Ru, drawTorus: Bu, curveChannels: pt, drawCurveEditor: zd, fitCurveView: Es, onCurveDoubleClick: Pd, onCurvePointerDown: _d, onCurvePointerMove: Cd, onCurvePointerUp: Ed, onTimelinePointerDown: nl, onTimelinePointerMove: sl, onTimelinePointerUp: il, refreshKeys: Jd, resetCurveZoom: Ld, resetTimelineZoom: cl, setChannelFilter: Td, setCurveInterpolation: Ad, setTangentMode: $d, timelineFrameFromEvent: _r, toggleCurveHandles: Md, zoomCurve: Od, drawTransformGizmo: ll, frameTarget: dl, gizmoAxes: ml, gizmoGeometry: pl, onPointerDown: fl, onPointerMove: hl, onPointerUp: ul, onWheel: bl, pickGizmo: gl, pickSceneObject: yl, resetCamera: vl, setTransformMode: xl, setViewMode: wl, viewportCamera: kl, loadCardFile: gu, loadExecutionPreview: yu, loadMediaUrl: oi, loadModelFile: bu, loadSelectedReference: vu, onModelLoaded: uu, restoreAssets: hu, syncUpstreamInputs: xu, configureDomMedia: ei, refreshSetupDiagnostic: Xu, addMediaCard: ib, addPrimitive: ob, applyObjectAnimationFrame: Sb, beginCameraEdit: $b, beginObjectEdit: fi, commitCameraEdit: Mb, commitObjectEdit: db, copyKeyframe: Eb, deleteKeyframe: Cb, deleteObject: pi, deleteSelectedObjects: sb, duplicateObject: mi, exitKeyEdit: Ob, finishCameraEdit: Ib, goToAdjacentKey: qb, insertKeyframe: jb, loadSelectedKeyView: Bb, pasteKeyframe: Ab, playblastCameraAtFrame: kb, refreshInspector: cb, refreshKeyEditor: Rb, refreshObjects: di, removeObjectResources: bb, renameObject: rb, retimeSelectedKey: Db, selectKeyframe: Tb, selectedKeyframe: Ge, selectedObject: Qt, selectObjectAnimation: ub, setKeyInterpolation: _b, setKeyTangentMode: Fb, setObjectParent: hb, timelineKeyframes: Ee, timelineObject: Ne, toggleAutoKey: Pb, toggleObject: nb, updateCameraFromHud: fb, updateCameraRotationFromHud: pb, updateEditState: zb, updateKeyVisualState: Nb, updateSelectedKey: Kb, updateSelectedObject: lb, clamp: Q, cloneCamera: ce, configureCore: bs, defaultCamera: Ar, sampleCamera: $e, sampleObjectTransform: Do, sanitizeState: $r, worldTransform: Mr };
Object.assign(
  ji.prototype,
  Yb(So),
  kg(So),
...
function Ug(e) {
  ...
  jo("director:attach:start", e), jo("director:constructor:start", e);
  const t = new ji(e);
  jo("director:constructor:complete", e), Fp(t);
  try {
    t.agentBridge = Wp(t, e, ot);
  } catch (m) {
  ...
  try {
    t.assetBrowser = sf(t, {
      ...
      onAgentFirstOpen: async () => {
        if (ir())
          try {
            const { createDirectorAgentPanel: m } = await import("./chunk-y6EO7RIX.js");
            t.agentPanel = m(t);
          } catch (m) {
  ...
  try {
    t.characterRuntime = lf(t), t.rigMapper = mf(t), t.poseEditor = hf(t), t.motionEditor = uf(t);
  } catch (m) {
    console.warn("[OmniCam] Character tools unavailable", m);
  }
  e.__majoorOmniCam = t, jo("director:marker:assigned", e), t.hideInternalWidgets();
  ...
  }, t.unwatchGraphConnections = zl(e, i);
  const l = e.onRemoved;
