import { F as g, A as C, p as y, Q as S } from "./vendor-three-BQUrLQkn.js";
import { api as l } from "../../scripts/api.js";
import { F as _ } from "./chunk-BJ59IIsk.js";
import { u as c } from "./chunk-BehqUNE0.js";
import { a as b } from "./chunk-Qfw4k8Ft.js";
import { f as k } from "./chunk-RgKSyXuE.js";
function v(e) {
  const t = b(e);
  return {
    schema_version: 1,
...
async function $(e, t) {
  ...
  try {
    const r = a === ".fbx" ? await j(e, t) : await F(t);
...
async function j(e, t) {
  ...
  const i = new y(), u = new S(), f = new y();
  for (let p = 0; p < h; p++)
    d && (d.setTime(p / m), o.updateMatrixWorld(!0)), n.getWorldPosition(i), n.getWorldQuaternion(u), f.set(0, 0, -1).applyQuaternion(u), x.push({
      frame: p,
