    ...
    beforeRegisterNodeDef(t, a) {
      ...
      t.prototype.onDrawForeground = function(n) {
        ...
        if (n.save(), this.selected) {
          const u = io(), p = n.createRadialGradient(d, c, J * 0.35, d, c, J * 1.15);
...
const ma = Object.freeze(["select", "track", "anchor", "project", "erase"]), ua = Object.freeze(["manual_2d", "static_anchor", "world_point", "object_point", "camera_field"]), pa = Object.freeze(["linear", "smooth", "hold"]), Ce = (e, t = 0) => Number.isFinite(Number(e)) ? Number(e) : t, It = (e) => Math.max(0, Math.min(1, Ce(e)));
function _o(e, t) {
  return {
...
function So(e) {
  ...
  return e.motion_layers = (Array.isArray(e.motion_layers) ? e.motion_layers : []).slice(0, 256).map((r, o) => {
    ...
    const s = ua.includes(r?.source_kind) ? r.source_kind : "manual_2d", i = (Array.isArray(r?.keys) ? r.keys : []).slice(0, 1e4).map((l) => _o(l, t)).sort((l, d) => l.time_seconds - d.time_seconds);
    return {
      id: n,
...
function ki(e, { mode: t, selectedIds: a } = {}) {
  return !e || e.enabled === !1 || t === "off" ? !1 : t === "all" ? !0 : (a instanceof Set ? a : new Set(a || [])).has(e.id);
}
const Oo = /* @__PURE__ */ new Set(["camera", "null", "sun_light", "point_light", "spot_light"]);
function Ai(e, t) {
  const a = Array.isArray(e?.position) ? e.position : [0, 0, 0], r = Array.isArray(e?.size) ? e.size : [1, 1, 1], o = Oo.has(t) ? 0.35 : Math.max(0.2, (Number(r[1]) || 1) * 0.5 + 0.2);
  return [Number(a[0]) || 0, (Number(a[1]) || 0) + o, Number(a[2]) || 0];
}
const Rt = Object.freeze([0.05, 8]), Io = 80, fa = (e, t, a) => Math.max(t, Math.min(a, e));
function ha(e) {
  if (!e || typeof e != "object") return null;
...
function Ni(e, { startFrame: t, endFrame: a } = {}) {
  ...
  const i = n.map((m) => Uo(m)), l = [];
  for (let m = 1; m < n.length; m += 1) {
    const f = Xo(Lt(n[m - 1]), Lt(n[m])), w = (i[m - 1] + i[m]) / 2;
    l.push(f * w);
  }
...
function H(e) {
  ...
  Math.sqrt(Z(o, o)) < 1e-6 && (r = Math.abs(a[1]) > 0.9 ? [0, 0, a[1] > 0 ? -1 : 1] : [0, 1, 0], o = xe(a, r)), o = ie(o);
  let n = ie(xe(o, a));
  if (Math.abs(e.roll || 0) > 1e-9) {
    const s = e.roll * Math.PI / 180, i = Math.cos(s), l = Math.sin(s), d = x(D(o, i), D(n, l));
    n = x(D(n, i), D(o, -l)), o = d;
  }
...
const T = (e, t, a) => Math.max(t, Math.min(a, e)), en = /^#(?:[0-9a-f]{3,4}|[0-9a-f]{6}|[0-9a-f]{8})$/i, fe = (e, t = null) => typeof e == "string" && en.test(e.trim()) ? e.trim() : t, x = (e, t) => [e[0] + t[0], e[1] + t[1], e[2] + t[2]], j = (e, t) => [e[0] - t[0], e[1] - t[1], e[2] - t[2]], D = (e, t) => [e[0] * t, e[1] * t, e[2] * t], Z = (e, t) => e[0] * t[0] + e[1] * t[1] + e[2] * t[2], xe = (e, t) => [e[1] * t[2] - e[2] * t[1], e[2] * t[0] - e[0] * t[2], e[0] * t[1] - e[1] * t[0]], W = (e) => Math.sqrt(Math.max(1e-12, Z(e, e))), ie = (e) => D(e, 1 / W(e));
function Sa(e, t, a) {
...
function Bt(e, t, a, r, o) {
  const n = rn(e, t), s = an.includes(n.mode) ? n.mode : e?.tangents?.mode || "auto", i = o ? o(e) : 0, l = a && o ? o(a) : i, d = r && o ? o(r) : i, c = Math.max(1e-6, e.frame - (a?.frame ?? e.frame - 1)), u = Math.max(1e-6, (r?.frame ?? e.frame + 1) - e.frame), p = (S = !1) => {
    const y = (i - l) / c, C = (d - i) / u;
    let _ = 0;
    if (!a && !r)
      _ = 0;
    else if (!a)
  ...
  return { out_x: m, out_y: f, in_x: w, in_y: b, mode: s };
}
function _t(e, t) {
...
function z(e, t, a, r, o = !1, n = null) {
  ...
  const s = n || _t(e, t), { leftIndex: i, left: l, right: d } = s, c = i > 0 ? e[i - 1] : null, u = i + 2 < e.length ? e[i + 2] : null, p = Math.max(1, d.frame - l.frame), h = T((t - l.frame) / p, 0, 1);
  let m = r(l), f = r(d);
  if (o) {
...
function Ue(e, t) {
  ...
  const r = me(e), o = (b, S) => (b.transform?.position || r.position)[S] ?? 0, n = (b, S) => (b.transform?.rotation || r.rotation)[S] ?? 0, s = (b, S) => (b.transform?.size || r.size)[S] ?? (S === 2 ? 0.01 : 1), i = _t(a, t), l = z(a, t, "pos_x", (b) => o(b, 0), !1, i), d = z(a, t, "pos_y", (b) => o(b, 1), !1, i), c = z(a, t, "pos_z", (b) => o(b, 2), !1, i), u = z(a, t, "rot_x", (b) => n(b, 0), !0, i), p = z(a, t, "rot_y", (b) => n(b, 1), !0, i), h = z(a, t, "rot_z", (b) => n(b, 2), !0, i), m = z(a, t, "scale_x", (b) => s(b, 0), !1, i), f = z(a, t, "scale_y", (b) => s(b, 1), !1, i), w = z(a, t, "scale_z", (b) => s(b, 2), !1, i);
  return {
...
function Bi(e = "balanced", t = "all_views", a = null) {
  const r = {
    none: 0,
    0: 0,
    sparse: 300,
  ...
  for (let p = 0; p < o; p++) {
    ...
    n.push(w, b, S), s.push(a ? y * i : y, a ? C * l : C, a ? _ * d : _);
  }
...
function sn() {
  ...
  return {
    ...
    resolution_gate: !1,
    aspect_ratio: "auto",
    outliner_height: O.outlinerHeight.default,
    preview_width: O.previewWidth.default,
    side_width: O.sideWidth.default,
    left_width: O.leftWidth.default,
    graph_height: O.graphHeight.default,
    assets_height: O.assetsHeight.default,
    agent_height: O.agentHeight.default,
...
function Ki(e) {
  ...
  a.cameras = s.slice(0, De.maxCameras).map((c, u) => {
...
function Ma(e, t = {}, a = null, r = "generic") {
  ...
  const d = un(l, o), c = pn(l, o), u = Vt(d, o), p = Vt(u, o), h = { speed: d, angular_speed: c, acceleration: u, jerk: p }, m = fn(e, a), f = hn(l, m, s, i), w = l.map((g) => g.fov), b = t.allow_framing_loss === !0, S = [], y = [];
  for (let g = 0; g < n; g++) {
    const M = [], E = [];
    for (const G of Kt) {
...
function Vi(e, t) {
  ...
  if (t.shiftKey)
    ...
    const n = t.currentTarget.getBoundingClientRect(), s = (t.clientX - n.left) / Math.max(1, n.width), i = T(Number(e.timelineZoom) || 1, 0.2, 30), l = T(i * r, 0.2, 30), d = a / i, c = a / l, u = (Number(e.timelinePan) || 0) + s * d;
    e.timelinePan = T(u - s * c, -a * 0.5, a), e.timelineZoom = l;
  }
...
function Wi(e, t) {
  ...
  if (e.boxSelect && t.pointerId === e.boxSelect.pointerId) {
    t.preventDefault(), t.stopPropagation();
    const a = e.boxSelect.box.getBoundingClientRect(), r = Math.max(1, e.state.duration_frames - 1), o = T(Number(e.timelineZoom) || 1, 0.1, 50), n = Number(e.timelinePan) || 0, s = r / o, i = (u) => T(n + u / Math.max(1, a.width) * s, 0, r), l = Math.min(i(e.boxSelect.startX), i(e.boxSelect.currentX)), d = Math.max(i(e.boxSelect.startX), i(e.boxSelect.currentX));
...
function Ae(e, t, a, r) {
  ...
  o && (e.checkpoint(a), o.keyframes = t, e.state.keyframes = t, e.syncActiveCameraTrack(), e.refreshKeys(), e.setFrame(e.frame, !1, !1), e.setStatus(r), On(e));
}
function Xi(e) {
  const t = ue(e);
  if (!t) return;
...
function $n() {
  return {
    ...
    width: K(Oa, 1280, 64, 4096, !0),
    height: K(Ia, 720, 64, 4096, !0),
    ...
    guideCaptureStyle: R(Ba, "auto", ["auto", "motion_proxy", "clay"]),
    ...
    undoLimit: K(Or, 100, 10, 500, !0),
    extractorBackend: R(Ir, "dpvo", ["dpvo", "pycolmap"]),
...
function Zt(e, t, a, r, o) {
  const { right: n, up: s, forward: i } = H(t), l = t.position, d = [a[0] - l[0], a[1] - l[1], a[2] - l[2]], c = Jn(d, i);
  let u, p;
  if (t.camera_type === "orthographic") {
...
function os(e, { pointerX: t, pointerY: a, overHandle: r, viewCamera: o, e: n }) {
  ...
  return !d || rs(s.position, d.camera.position, o, e.canvas.width, e.canvas.height) ? !1 : (r && n.stopImmediatePropagation?.(), e.curveHandleDrag = {
    cameraId: s.cameraId,
    frame: s.frame,
    side: s.side,
...
function qe(e, { mode: t, origin: a, delta: r, factors: o, rotationDeg: n }) {
  ...
  const s = j(e, a);
  return t === "scale" ? x(a, [s[0] * o[0], s[1] * o[1], s[2] * o[2]]) : x(a, ke(s, n));
}
function cs(e, t) {
...
function ys(e, t) {
  ...
  return ta(n.map((i) => -i), n).map((i) => x(o, wa(i, s)));
}
function bs(e, t, a, r = {}) {
  const o = e.state.objects.filter((y) => y.enabled !== !1), n = r.all ? o : o.filter((y) => e.selectedObjectIds?.has(y.id)), i = (n.length ? n : [a]).flatMap((y) => ys(e, y)), l = [0, 1, 2].map((y) => Math.min(...i.map((C) => C[y]))), d = [0, 1, 2].map((y) => Math.max(...i.map((C) => C[y]))), c = l.map((y, C) => (y + d[C]) / 2), { right: u, up: p, forward: h } = H(t), m = Math.max(1, e.canvas?.width || e.state.width || 1280) / Math.max(1, e.canvas?.height || e.state.height || 720), f = Math.tan((t.fov || 35) * Math.PI / 360), w = f * m;
  let b = 2, S = 0.1;
  for (const y of i) {
...
function hl(e, t = {}) {
  ...
  if (e.subSelection?.point && !t.all) {
    ...
    a.target = [...i], a.position = x(a.target, D(d, c)), r ? (e.serialize(), e.render()) : (e.beginCameraEdit(), e.commitCameraEdit(), e.finishCameraEdit());
...
function Wr(e) {
  ...
  if (e.state.gizmo_mode !== "rotate" || t.type === "camera_target")
    return {
      ...
      center: o,
      worldLength: n,
      handles: i.map((d, c) => ({ index: c, axis: d, points: [o, V(x(r, D(d, n)), a, e.canvas.width, e.canvas.height)] })).filter((d) => d.points[1] && Number.isFinite(d.points[1][0]) && Number.isFinite(d.points[1][1]))
    };
  const l = i.map((d, c) => {
    const u = Math.abs(d[1]) < 0.9 ? [0, 1, 0] : [1, 0, 0], p = ie(xe(d, u)), h = ie(xe(d, p)), m = [];
    for (let f = 0; f <= 48; f++) {
...
function gl(e) {
  ...
  for (const o of t.handles) {
    ...
    if (e.ctx.lineWidth = n ? 6.5 : 3.8, e.ctx.strokeStyle = n ? "#ffffff" : a[o.index] || "#ffffff", e.ctx.fillStyle = a[o.index] || "#ffffff", e.ctx.beginPath(), o.points.forEach((s, i) => {
      ...
      e.state.gizmo_mode === "scale" && t.entity?.type === "object" ? (e.ctx.fillRect(i[0] - 6, i[1] - 6, 12, 12), e.ctx.save(), e.ctx.strokeStyle = "rgba(15, 23, 42, 0.65)", e.ctx.lineWidth = 1, e.ctx.strokeRect(i[0] - 6, i[1] - 6, 12, 12), e.ctx.restore()) : xs(e.ctx, s[0], i);
    }
  }
...
function Ie(e, t) {
  ...
  const n = o[0] - a.start[0], s = o[1] - a.start[1], i = t.shiftKey ? 0.1 : 1, l = ks(a), d = a.axis ? ct[a.axis] : null, c = e.state.view_mode === "camera" ? e.camera : e.state.editor_views[e.state.view_mode], u = H(c), p = c.camera_type === "orthographic" ? 10 / (Math.max(0.01, c.zoom || 1) * Math.max(1, e.canvas.height)) : Math.hypot(...j(c.position, c.target)) * 25e-4;
  let h = a.snapshots.map((y) => [...y.transform.position]);
  if (a.mode === "translate") {
    const y = l ?? (n - s) * p * i, C = d ? D(d, y) : x(D(u.right, n * p * i), D(u.up, -s * p * i));
    h = h.map((_) => x(_, C)), h = As(e, a, h, o, t.ctrlKey || t.metaKey, d, a.snapshots.map((_) => _.transform.position));
  }
  const m = a.mode === "rotate" ? l ?? (n - s) * 0.5 * i : 0, f = a.mode === "scale" ? Math.max(0.01, l ?? 1 + (n - s) * 0.01 * i) : 1, w = d || ct.z, b = t.ctrlKey || t.metaKey || e.state.spatial_snap_mode === "grid";
...
function Ds(e, t) {
  ...
  return r === "escape" ? Yr(e) : r === "enter" || r === " " ? Xr(e) : ct[r] ? (a.axis = a.axis === r ? null : r, Ie(e, a.lastEvent), !0) : /^[0-9]$/.test(r) || r === "." || r === "," || r === "-" && !a.numeric ? (a.numeric += r === "," ? "." : r, Ie(e, a.lastEvent), !0) : (r === "backspace" && (a.numeric = a.numeric.slice(0, -1), Ie(e, a.lastEvent)), !0);
}
function ge(e, t, a) {
...
function ye(e, t, a, r = [], o = null) {
  ...
  if (s === "grid")
    return o ? t.map((l, d) => Math.abs(o.axis[d]) > 1e-6 ? ne(l, i) : o.base[d]) : js(t, i);
  if (s === "vertex" && a && !o) {
...
function yl(e, t) {
  ...
  if (d && (!c || u === "path_point" || u === "camera") && os(e, { pointerX: r, pointerY: o, overHandle: c, viewCamera: n, e: t }) || d && c || l && ts(e, { pointerX: r, pointerY: o, shiftKey: t.shiftKey, altKey: t.altKey })) return;
...
function bl(e, t) {
  ...
  if (e.pathDrag) {
    ...
    c && (c.camera.position = Zt(
      ...
      e.canvas.width,
      e.canvas.height
    ), c.interpolation = es(c.interpolation), e.webgl && (e.webgl.pathKey = ""), e.setFrame(e.frame, !1, !1), e.render());
    return;
  }
  ...
  if (e.targetFreeDrag) {
    ...
    const s = e.interactionElement.getBoundingClientRect(), i = (t.clientX - s.left) * e.canvas.width / Math.max(1, s.width), l = (t.clientY - s.top) * e.canvas.height / Math.max(1, s.height), d = i - e.targetFreeDrag.pointer[0], c = l - e.targetFreeDrag.pointer[1], u = t.shiftKey ? 0.1 : 1, p = x(D(e.targetFreeDrag.right, d * e.targetFreeDrag.scale * u), D(e.targetFreeDrag.up, -c * e.targetFreeDrag.scale * u)), h = ye(e, x(e.targetFreeDrag.target, p), [i, l]);
  ...
  if (e.gizmoDrag) {
    ...
    if (e.gizmoDrag.type === "camera_target") {
      const h = x(e.gizmoDrag.target, D(e.gizmoDrag.axis, d * e.gizmoDrag.worldLength / e.gizmoDrag.screenLength)), m = ye(e, h, i, [], { base: e.gizmoDrag.target, axis: e.gizmoDrag.axis });
    ...
    if (e.gizmoDrag.type === "camera_path") return void ps(e, { pointer: i, deltaPixels: d, precision: l, snapping: c });
    if (e.state.gizmo_mode === "translate")
      if (e.gizmoDrag.free) {
        const h = (i[0] - e.gizmoDrag.pointer[0]) * l, m = (i[1] - e.gizmoDrag.pointer[1]) * l, f = x(
      ...
      if (e.gizmoDrag.free) {
        const h = (i[0] - e.gizmoDrag.pointer[0]) * l, m = (i[1] - e.gizmoDrag.pointer[1]) * l, f = (h - m) * e.gizmoDrag.freeScale, w = e.gizmoDrag.size.map((b) => {
          const S = b + f;
  ...
  if (e.drag.dolly) {
    ...
    e.drag.target.position = x(n.target, D(i, s)), e.drag.target.camera_type === "orthographic" && (e.drag.target.zoom = Math.max(0.01, (n.zoom || 1) / s));
  } else if (e.drag.fly) {
    ...
    const { right: s, up: i } = H(n), l = Ge(n, e.interactionElement.getBoundingClientRect().height) * (e.panSensitivity ?? 1), d = x(D(s, -a * l), D(i, r * l));
...
function _l(e, t) {
  ...
  const o = Q(e);
  r || e.beginCameraEdit();
  const n = T(a * 1e-3, -0.4, 0.4), s = j(o.position, o.target);
  o.position = x(o.target, D(s, Math.exp(n))), o.camera_type === "orthographic" && (o.zoom = Math.max(0.01, (o.zoom || 1) * Math.exp(-n))), r ? (e.scheduleSerialize(), e.render()) : (e.commitCameraEdit(), e.finishCameraEdit());
}
const Os = (e) => {
...
function Sl(e, t) {
  ...
  a.addEventListener("pointerdown", (o) => {
    ...
    e.checkpoint(n === "erase" ? "Erase motion track" : "Add motion anchor"), n === "anchor" ? We(e.state, { sourceKind: "static_anchor", label: `Anchor ${(e.state.motion_layers || []).length + 1}`, keys: [{ time_seconds: e.frame / e.state.fps, ...s, interpolation: "hold" }] }) : n === "project" ? Bs(e, s) : n === "erase" && Fs(e.state, s), oe(e, `Motion tool: ${n}`);
  ...
  const r = (o) => {
    ...
    const [s, i] = ra(e), l = Ls(e.state, n.points, s, i);
...
function wl(e, t) {
  for (const a of e.root.querySelectorAll("[data-motion-create]"))
    a.addEventListener("click", () => Vs(e, a.dataset.motionCreate), { signal: t });
...
const be = { t: "translate", r: "rotate", s: "scale" }, Ws = [
...
], $s = 'button,summary,a[href],[role="button"],[role="menuitem"],[role="tab"],[role="option"],[role="checkbox"],[role="switch"]';
function Us(e) {
  return e instanceof HTMLElement || e instanceof SVGElement ? !!e.closest?.($s) : !1;
}
function Xs(e) {
...
function Zs(e, t) {
  return Ys(e) || t?.lastKeyZone || "viewport";
}
let na = !1;
function Qs() {
  na || typeof window > "u" || (na = !0, window.addEventListener("keydown", (e) => {
    ...
    !a || a.disposed || Js(a, e) && (e.preventDefault(), e.stopImmediatePropagation?.(), e.stopPropagation());
  }, { capture: !0 }));
}
function Js(e, t) {
  if (!qn()) return !1;
  const a = t.composedPath?.()[0] || t.target;
  if (Xs(a) || (t.code === "Space" || t.key === "Enter") && Us(a)) return !1;
...
function ai(e, t) {
  ...
  if (["w", "a", "s", "d", "q", "e"].includes(a) && e.isNavigatingFly) {
    const i = e.viewportCamera(), l = e.state.view_mode !== "camera", { right: d, up: c, forward: u } = H(i), p = (t.shiftKey ? 0.6 : 0.18) * e.cameraSpeed, h = { w: D(u, p), s: D(u, -p), d: D(d, p), a: D(d, -p), e: D(c, p), q: D(c, -p) }[a];
    return l || e.beginCameraEdit(), i.position = x(i.position, h), i.target = x(i.target, h), l ? (e.serialize(), e.render()) : (e.commitCameraEdit(), e.finishCameraEdit()), !0;
  }
  return !1;
}
function ri(e, t, a) {
...
function ii([e, t], [a, r]) {
  ...
  const o = Math.round((window.innerWidth || e) * ni), n = Math.round((window.innerHeight || t) * si);
  return [
...
function li(e, t) {
  const a = to[t];
  return !a || !e?.setSize ? !1 : (e.setSize(ii(a.default, a.min)), !0);
}
function ci(e, t, a) {
  const r = to[t];
...
function mi() {
  ...
  e.id = sa, e.textContent = di, document.head.appendChild(e);
}
function se(e) {
...
const la = "MajoorOmniCam.ShowHelp", ft = "oc-help-toolbar-icon", ca = "oc-help-toolbar-css", fi = "#8b7bd8";
function hi() {
  ...
  e.id = ca, e.textContent = `
    .${ft}{display:inline-flex;align-items:center;justify-content:center;
      width:16px;height:16px;border-radius:50%;background:${fi};color:#fff;
...
ae.registerExtension({
  ...
  async nodeCreated(e) {
    if (Ye(e) !== dt) return;
    Oe("director:nodeCreated", e);
    const t = !ce, a = t ? null : Et(e);
    await Dt(e, async () => {
      Oe("director:import:start", e);
      const { attachDirectorShell: o } = await import("./chunk-Bwz6xzPH.js").then((n) => n.o);
      return Oe("director:import:resolved", e), o;
    });
    const r = e.__majoorOmniCamDirectorRuntime;
    r && (Oe("director:attach:complete", e), t && Yn(r), jt(e, dt, t, a?.()));
  }
});
ae.registerExtension({
  ...
  async nodeCreated(e) {
    if (Ye(e) !== mt) return;
    const t = !ce, a = t ? null : Et(e);
    await Dt(e, async () => (await import("./chunk-CGQ05753.js").then((r) => r.g)).attachExtractorShell), e.__majoorOmniCamExtractorRuntime && jt(e, mt, t, a?.());
  }
});
ae.registerExtension({
  ...
  async nodeCreated(e) {
    if (Ye(e) !== ut) return;
    const t = !ce, a = t ? null : Et(e);
    await Dt(e, async () => (await import("./chunk-CqMc0pXz.js").then((r) => r.s)).attachMonitorShell), !(!e.__majoorOmniCamMonitorShell && !e.__majoorOmniCamMonitor) && jt(e, ut, t, a?.());
  }
});
export {
  Fe as $,
