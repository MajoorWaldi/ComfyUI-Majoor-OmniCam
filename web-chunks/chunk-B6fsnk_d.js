...
function rp(e, t) {
  ...
  for (let p = 0; p < a.operations.length; p += 1)
    try {
      const m = Bm({ ui: e, state: r, operation: a.operations[p] });
  ...
  if (a.validateOnly) {
    const { changes: p, truncated: m } = Um(e.state, r);
    return {
      ok: !0,
      version: Je,
      revision: o,
  ...
  const l = ep(e);
  return Em(e, a.id), e.serialize?.(), tp(e, l), op(e, n, `director-api:${a.id}`), ap(e, a, c).catch((p) => {
...
const ho = () => import("./chunk-BesGuXD2.js");
function Ef(e, t) {
...
async function qh(e) {
  ...
  try {
    let n = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-DQk2cu7F.js");
...
class ai {
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-DQk2cu7F.js"));
    } catch (a) {
  ...
  try {
    t.assetBrowser = Ap(t, {
      ...
      onAgentFirstOpen: async () => {
        if (Zo())
          try {
            const { createDirectorAgentPanel: m } = await import("./chunk-C-8tYyzu.js");
            t.agentPanel = m(t);
          } catch (m) {
