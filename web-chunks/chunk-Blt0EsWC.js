...
function Hr(e) {
  e.registerExtension({
    ...
    beforeRegisterNodeDef(t, a) {
      if (!String(a?.name || a?.node_id || t?.comfyClass || t?.type || "").startsWith(Vr)) return;
      ...
      t.prototype.onDrawForeground = function(n) {
        ...
        if (n.save(), this.selected) {
          const m = qr(), p = n.createRadialGradient(d, c, Y * 0.35, d, c, Y * 1.15);
...
function S(e) {
  return Oe === lt ? e : Ee.get(Oe)?.[e] || e;
}
const Xr = "__sequence__";
function Yr() {
...
function Ls(e) {
  return !!e?.sequence?.enabled && Ie(e).length > 0;
}
function Xt(e, t) {
  const a = Ie(e);
...
function eo(e, t, a = null) {
  const r = e?.sequence?.cuts || [], o = Math.max(0, Math.round(Number(t) || 0));
  if (!r.length || o <= 0 || r.some((i) => i.start === o)) return !1;
  const s = Xt(e, o)?.camera_id || r[0].camera_id;
  return r.push({ camera_id: a || Jr(e, s), start: o }), r.sort((i, l) => i.start - l.start), !0;
}
function to(e, t) {
  const a = e?.sequence?.cuts || [];
  return t < 0 || t >= a.length || a.length === 1 ? !1 : (a.splice(t, 1), a.length && (a[0].start = 0), !0);
}
const Yt = Object.freeze(["select", "track", "anchor", "project", "erase"]), Zt = Object.freeze(["manual_2d", "static_anchor", "world_point", "object_point", "camera_field"]), Qt = Object.freeze(["linear", "smooth", "hold"]), ve = (e, t = 0) => Number.isFinite(Number(e)) ? Number(e) : t, wt = (e) => Math.max(0, Math.min(1, ve(e)));
function ao(e, t) {
  return {
    ...
    y: wt(e?.y),
    visible: e?.visible !== !1,
    interpolation: Qt.includes(e?.interpolation) ? e.interpolation : "linear"
  };
}
function ro(e) {
  ...
  return e.motion_layers = (Array.isArray(e.motion_layers) ? e.motion_layers : []).slice(0, 256).map((r, o) => {
    ...
    const s = Zt.includes(r?.source_kind) ? r.source_kind : "manual_2d", i = (Array.isArray(r?.keys) ? r.keys : []).slice(0, 1e4).map((l) => ao(l, t)).sort((l, d) => l.time_seconds - d.time_seconds);
    return {
      id: n,
  ...
  }).filter((r) => r.keys.length), e.motion_tool = Yt.includes(e.motion_tool) ? e.motion_tool : "select", e.selected_motion_layer_id = e.motion_layers.some((r) => r.id === e.selected_motion_layer_id) ? e.selected_motion_layer_id : e.motion_layers[0]?.id || null, e;
}
const oo = 32, no = 64, so = 128, io = Object.freeze(["off", "selected", "all"]), lo = Object.freeze(["annotation", "name", "tag"]), xt = Object.freeze({ mode: "selected", content: "annotation" }), co = Object.freeze(["top", "center", "bottom"]), mo = /^[a-z0-9][a-z0-9_-]*$/, po = /^#(?:[0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/, fo = /[<>]|:\/\/|javascript:|expression\(|&#/i;
function Je(e) {
  ...
  for (const r of e) {
    ...
    if (!(!o || o.length > no || !mo.test(o) || a.has(o)) && (a.add(o), t.push(o), t.length >= oo))
      break;
  }
  return t;
}
...
function Mt(e) {
  ...
  if (!t || t.length > so || fo.test(t)) return null;
  const a = typeof e.color == "string" ? e.color.trim() : "", r = po.test(a) ? a.toLowerCase() : "#8d7ee8", o = co.includes(e.anchor) ? e.anchor : "top";
  return { text: t, visible: e.visible !== !1, color: r, anchor: o };
}
function Vs(e) {
  return {
    mode: io.includes(e?.mode) ? e.mode : xt.mode,
    content: lo.includes(e?.content) ? e.content : xt.content
  };
}
function uo(e) {
...
function Ks(e, t) {
  ...
  if (t === "tag") return uo(e);
  const a = e.annotation;
  return a && a.visible !== !1 ? String(a.text || "") : "";
}
function Gs(e, { mode: t, selectedIds: a } = {}) {
  return !e || e.enabled === !1 || t === "off" ? !1 : t === "all" ? !0 : (a instanceof Set ? a : new Set(a || [])).has(e.id);
}
const ho = /* @__PURE__ */ new Set(["camera", "null", "sun_light", "point_light", "spot_light"]);
function qs(e, t) {
  const a = Array.isArray(e?.position) ? e.position : [0, 0, 0], r = Array.isArray(e?.size) ? e.size : [1, 1, 1], o = ho.has(t) ? 0.35 : Math.max(0.2, (Number(r[1]) || 1) * 0.5 + 0.2);
  return [Number(a[0]) || 0, (Number(a[1]) || 0) + o, Number(a[2]) || 0];
}
const Ct = Object.freeze([0.05, 8]), go = 80, Jt = (e, t, a) => Math.max(t, Math.min(a, e));
function ea(e) {
  if (!e || typeof e != "object") return null;
  const t = String(e.clip_id ?? "").trim();
  if (!t || t.length > go) return null;
  const a = Math.max(0, Math.round(Number(e.start_frame) || 0)), r = Math.round(Number(e.end_frame) || 0), o = r > a ? r : 0, n = Number(e.speed), s = Jt(Number.isFinite(n) && n > 0 ? n : 1, Ct[0], Ct[1]), i = Number(e.offset_seconds);
  return {
    clip_id: t,
    start_frame: a,
    end_frame: o,
...
function Hs(e, t, a, r) {
  const o = ea(e), n = Number(r) || 0, s = Math.max(1, Number(a) || 24);
  if (!o || n <= 0) return 0;
  const i = (m) => o.loop ? (m % n + n) % n : Jt(m, 0, n);
...
const Ws = "omnicam_humanoid_v1", ct = Object.freeze([
  "root",
  "pelvis",
  "spine",
  "chest",
  ...
  "foot_r",
  "toe_r"
]), yo = Object.freeze(["eye_l", "eye_r", "hand_tip_l", "hand_tip_r"]);
Object.freeze([...ct, ...yo]);
new Map(ct.map((e, t) => [e, t]));
const bo = /^mixamorig[:_ ]?/i, _o = /[\s_\-.:|]+/g, vo = {
...
function So(e) {
  return String(e || "").trim().replace(bo, "").replace(_o, "").toLowerCase();
}
function wo(e) {
  const t = [e];
...
function $s(e) {
  const a = (e || []).map(String).filter((n) => n.trim()).map((n) => [n, wo(So(n))]), r = /* @__PURE__ */ new Set(), o = {};
  for (const n of [!0, !1])
    for (const [s, i] of Object.entries(vo))
      if (!o[s])
        for (const l of i) {
          const d = xo(l, a, r, n);
          if (d != null) {
...
function Us(e) {
  ...
  return !t || !Object.keys(t).length ? "none" : Co(t) ? "rigged" : "incomplete";
}
const ko = 128, kt = "omnicam_humanoid_v1", dt = /^[a-z0-9][a-z0-9_-]*$/, Do = 1e-3, To = (e) => Array.isArray(e) && e.length === 3 && e.every((t) => Number.isFinite(Number(t)));
function mt(e) {
  ...
  return a <= 1e-8 || Math.abs(a - 1) > Do && !(a > 0.5 && a < 2) ? null : t.map((r) => r / a);
}
function ta(e, t = 1e-4) {
  const a = mt(e);
...
function jo(e) {
  ...
  for (const [r, o] of Object.entries(e)) {
    ...
    if (!dt.test(n) || n.length > 64) continue;
    const s = mt(o);
    !s || ta(s) || (t[n] = s, a += 1);
  }
  return t;
...
function Pe(e) {
  ...
  return {
    preset_id: dt.test(a) && a.length <= 80 ? a : "neutral",
    root_offset: To(t.root_offset) ? t.root_offset.map(Number) : [0, 0, 0],
    joints: jo(t.joints)
  };
}
function Xs({ preset: e, overrides: t } = {}) {
  const a = Pe(e), r = Pe(t);
  return {
...
function Ys(e, t, a) {
  ...
  if (!dt.test(o)) return r;
  const n = mt(a);
  return !n || ta(n) ? delete r.joints[o] : r.joints[o] = n, r;
}
function Ao(e) {
...
function Zs(e) {
  return Oo({ apiURL: aa }, e);
}
let aa = (e) => e;
const We = /* @__PURE__ */ new WeakMap();
function Qs({ api: e }) {
  aa = (t) => e.apiURL ? e.apiURL(t) : t;
}
function Io(e, t, a) {
...
function B(e, t, a, r) {
  const { right: o, up: n, forward: s } = K(t), i = E(e, t.position), l = U(i, s);
...
function le(e, t, a = null) {
  const r = (e.keyframes || []).map((g) => ({
    ...g,
    camera: V(g.camera || g || e.camera || se())
  }));
  if (!r.length) return V(e.camera || se());
  const o = Io(e, r, t), n = z(r, t, "pos_x", (g) => (g.camera || g).position[0], !1, o), s = z(r, t, "pos_y", (g) => (g.camera || g).position[1], !1, o), i = z(r, t, "pos_z", (g) => (g.camera || g).position[2], !1, o);
  ...
  if (u && Array.isArray(h)) {
    ...
    if (g && g.enabled !== !1) {
      const M = ft(h, g, t), A = m?.offset || e.target_offset || e.camera?.target_offset || [0, 0, 0];
      l = (M.position?.[0] ?? 0) + (A[0] || 0), d = (M.position?.[1] ?? 1.5) + (A[1] || 0), c = (M.position?.[2] ?? 0) + (A[2] || 0);
    }
  }
  const f = z(r, t, "fov", (g) => Number((g.camera || g).fov ?? 35), !1, o), _ = z(r, t, "roll", (g) => Number((g.camera || g).roll ?? 0), !0, o), y = z(r, t, "zoom", (g) => Number((g.camera || g).zoom ?? 1), !1, o), v = z(r, t, "near", (g) => Number((g.camera || g).near ?? 0.01), !1, o), b = z(r, t, "far", (g) => Number((g.camera || g).far ?? 1e4), !1, o), x = r[0]?.camera || r[0] || se();
  let w = r[0];
  for (const g of r)
    if ((g.frame ?? 0) <= t) w = g;
    else break;
...
const T = (e, t, a) => Math.max(t, Math.min(a, e)), Po = /^#(?:[0-9a-f]{3,4}|[0-9a-f]{6}|[0-9a-f]{8})$/i, pe = (e, t = null) => typeof e == "string" && Po.test(e.trim()) ? e.trim() : t, C = (e, t) => [e[0] + t[0], e[1] + t[1], e[2] + t[2]], E = (e, t) => [e[0] - t[0], e[1] - t[1], e[2] - t[2]], k = (e, t) => [e[0] * t, e[1] * t, e[2] * t], U = (e, t) => e[0] * t[0] + e[1] * t[1] + e[2] * t[2], Se = (e, t) => [e[1] * t[2] - e[2] * t[1], e[2] * t[0] - e[0] * t[2], e[0] * t[1] - e[1] * t[0]], H = (e) => Math.sqrt(Math.max(1e-12, U(e, e))), ne = (e) => k(e, 1 / H(e));
function ra(e, t, a) {
...
const Dt = [
  ...
  "ease_expo",
  "ease_back"
], No = ["auto", "clamped", "vector", "free", "aligned", "flat"];
function Ro(e, t) {
  const a = e?.tangents;
  return !a || typeof a != "object" ? {} : a.channels && typeof a.channels == "object" && a.channels[t] ? a.channels[t] : a;
}
function Tt(e, t, a, r, o) {
  const n = Ro(e, t), s = No.includes(n.mode) ? n.mode : e?.tangents?.mode || "auto", i = o ? o(e) : 0, l = a && o ? o(a) : i, d = r && o ? o(r) : i, c = Math.max(1e-6, e.frame - (a?.frame ?? e.frame - 1)), m = Math.max(1e-6, (r?.frame ?? e.frame + 1) - e.frame), p = (v = !1) => {
...
function z(e, t, a, r, o = !1, n = null) {
  ...
  const s = n || pt(e, t), { leftIndex: i, left: l, right: d } = s, c = i > 0 ? e[i - 1] : null, m = i + 2 < e.length ? e[i + 2] : null, p = Math.max(1, d.frame - l.frame), u = T((t - l.frame) / p, 0, 1);
  let h = r(l), f = r(d);
  if (o) {
  ...
  if (l.interpolation === "bezier" || d.interpolation === "bezier") {
    const v = Tt(l, a, c, d, r), b = Tt(d, a, l, m, r), x = h, w = h + (v.out_y || 0), D = f + (b.in_y || 0), g = f, M = T(Number(v.out_x ?? 1 / 3), 0, 1), A = T(1 + Number(b.in_x ?? -1 / 3), 0, 1);
    let G = 0, ee = 1;
    for (let St = 0; St < 32; St++) {
      const $ = (G + ee) * 0.5, He = 1 - $;
      3 * He * He * $ * M + 3 * He * $ * $ * A + $ * $ * $ < u ? G = $ : ee = $;
    }
    const Q = (G + ee) * 0.5, te = 1 - Q;
    return te * te * te * x + 3 * te * te * Q * w + 3 * te * Q * Q * D + Q * Q * Q * g;
  }
  const y = zo(u, l.interpolation);
  return h + (f - h) * y;
}
function se() {
...
function Ke(e, t) {
  ...
  const r = ce(e), o = (y, v) => (y.transform?.position || r.position)[v] ?? 0, n = (y, v) => (y.transform?.rotation || r.rotation)[v] ?? 0, s = (y, v) => (y.transform?.size || r.size)[v] ?? (v === 2 ? 0.01 : 1), i = pt(a, t), l = z(a, t, "pos_x", (y) => o(y, 0), !1, i), d = z(a, t, "pos_y", (y) => o(y, 1), !1, i), c = z(a, t, "pos_z", (y) => o(y, 2), !1, i), m = z(a, t, "rot_x", (y) => n(y, 0), !0, i), p = z(a, t, "rot_y", (y) => n(y, 1), !0, i), u = z(a, t, "rot_z", (y) => n(y, 2), !0, i), h = z(a, t, "scale_x", (y) => s(y, 0), !1, i), f = z(a, t, "scale_y", (y) => s(y, 1), !1, i), _ = z(a, t, "scale_z", (y) => s(y, 2), !1, i);
  return {
...
function Lo() {
  const e = se(), t = [{ frame: 0, camera: V(e), interpolation: "ease" }];
  return {
    schema_version: 1,
    fps: 24,
    duration_frames: 120,
    ...
    camera: e,
    keyframes: t,
    cameras: [{ id: "camera_1", name: "Camera 1", color: "#4aa3ef", camera: V(e), keyframes: t }],
...
function ai(e) {
  ...
  if (!e || typeof e != "object") return t;
  const a = { ...t, ...e };
  a.fps = Math.round(q(a.fps, 24, 1, 120)), a.duration_frames = Math.round(q(a.duration_frames, 120, 1, Ce.maxDurationFrames)), a.width = Math.round(q(a.width, 1280, 64, 4096)), a.height = Math.round(q(a.height, 720, 64, 4096));
  const r = (c, m) => (Array.isArray(c) ? c : []).slice(0, Ce.maxKeysPerTrack).map((p) => ({
    frame: Math.max(0, Math.round(Number(p.frame || 0))),
    camera: V(p.camera || p || m),
  ...
  })), o = V(a.camera || t.camera);
  let n = r(a.keyframes, o);
  n = [...new Map(n.map((c) => [c.frame, c])).values()].sort((c, m) => c.frame - m.frame), n.length || (n = [{ frame: 0, camera: V(o), interpolation: "ease" }]);
  ...
  a.cameras = s.slice(0, Ce.maxCameras).map((c, m) => {
    let p = String(c?.id || `camera_${m + 1}`);
    i.has(p) && (p = `camera_${m + 1}`), i.add(p);
    const u = V(c?.camera || c?.keyframes?.[0]?.camera || o);
    let h = r(c?.keyframes, u);
    return h = [...new Map(h.map((f) => [f.frame, f])).values()].sort((f, _) => f.frame - _.frame), h.length || (h = [{ frame: 0, camera: V(u), interpolation: "ease" }]), {
      id: p,
  ...
  }), a.active_camera_id = a.cameras.some((c) => c.id === a.active_camera_id) ? a.active_camera_id : a.cameras[0].id, a.sequence = Zr(a.sequence, a.cameras.map((c) => c.id)), a.playblast_camera_id = a.playblast_camera_id === Xr && a.sequence.cuts.length || a.cameras.some((c) => c.id === a.playblast_camera_id) ? a.playblast_camera_id : a.active_camera_id;
  ...
  a.camera = l.camera, a.keyframes = l.keyframes, a.target_object_id = l.target_object_id || null, a.target_offset = l.target_offset || [0, 0, 0], a.aim_bone = l.aim_bone || null, a.objects = (Array.isArray(a.objects) ? a.objects : t.objects).slice(0, Ce.maxObjects).map((c) => ({
    ...
    ...c?.character ? { character: Ao(c.character) } : {},
    keyframes: (Array.isArray(c.keyframes) ? c.keyframes : []).map((m) => ({
      ...
      interpolation: Dt.includes(m.interpolation) ? m.interpolation : "ease",
  ...
  const d = ze();
  return a.editor_views = Object.fromEntries(Object.entries(d).map(([c, m]) => [c, V(a.editor_views?.[c] || m)])), ro(a);
}
function xe(e, t) {
...
function na(e, t) {
  const a = t.quaternion || Ne(t.rotation), r = Fo(a, e.quaternion || Ne(e.rotation));
  return { position: C(oa(e.position.map((o, n) => o * t.size[n]), a), t.position), rotation: Bo(r), quaternion: r, size: e.size.map((o, n) => o * t.size[n]) };
}
function Vo(e, t) {
...
const jt = ["speed", "angular_speed", "acceleration", "jerk"], $e = ["ok", "warn", "over"], sa = 0.8, Ko = [0, 1.5, 0];
function At(e, t) {
  const a = [0];
...
function qo(e, t) {
  const a = [0];
  for (let r = 1; r < e.length; r++) {
    const o = K(e[r - 1]), n = K(e[r]), s = ["right", "up", "forward"].reduce(
...
function Ho(e, t = null) {
  ...
  return Array.isArray(a?.position) ? a.position.slice(0, 3).map(Number) : [...Ko];
}
function Wo(e, t, a, r) {
  return e.map((o) => {
    const n = B(t, o, a, r);
...
function Et(e, t) {
  return t == null || t <= 0 ? "ok" : e > t ? "over" : e > t * sa ? "warn" : "ok";
}
function Ot(e) {
...
function Uo(e, t) {
  ...
  for (let r = 0; r < e.length; r++) {
    ...
    if (n && n.grade === e[r] && $o(n.metrics, o)) {
      n.end = r;
      continue;
    }
...
function ia(e, t = {}, a = null, r = "generic") {
  ...
  const d = Go(l, o), c = qo(l, o), m = At(d, o), p = At(m, o), u = { speed: d, angular_speed: c, acceleration: m, jerk: p }, h = Ho(e, a), f = Wo(l, h, s, i), _ = l.map((g) => g.fov), y = t.allow_framing_loss === !0, v = [], b = [];
  for (let g = 0; g < n; g++) {
    const M = [], A = [];
    for (const G of jt) {
      const ee = Et(u[G][g], t[`max_${G}`]);
      M.push(ee), ee !== "ok" && A.push(G);
    }
    !f[g] && !y && (M.push("over"), A.push("framing_loss")), v.push(Ot(M)), b.push(A);
  }
  ...
  return w.track_grades = { fov_drift: D }, w.grade = Ot([...v, D]), w.trajectory_valid = w.violations.length === 0, w.ok = w.trajectory_valid, w;
}
function Xo(e) {
...
function ni(e, t) {
  ...
  e.selectedKeyFrames = null, e.timelineDrag = { box: a, pointerId: t.pointerId }, e.setFrame(la(e, t, a));
}
function si(e, t) {
  ...
  !e.timelineDrag || t.pointerId !== e.timelineDrag.pointerId || (t.preventDefault(), t.stopPropagation(), e.setFrame(la(e, t, e.timelineDrag.box), !1, !1));
}
function ii(e, t) {
  if (e.timelinePanDrag && t.pointerId === e.timelinePanDrag.pointerId) {
...
function Zo(e, t) {
  ...
  if (!a) return;
  if (!a.engaged) {
    if (Math.hypot(t.clientX - (a.startClientX ?? t.clientX), t.clientY - (a.startClientY ?? t.clientY)) < Yo) return;
    a.engaged = !0;
  }
...
function de(e) {
  const t = nn(e), a = sn(e, t);
  return a ? ia(e.state, a, null, t) : null;
}
function It(e) {
...
function fe(e, t, a, r) {
  const o = a == null ? S("no limit") : `${It(t)} / ${It(a)}`, n = a != null && a > 0, s = n ? Math.min(100, Math.round(t / a * 100)) : 0, i = r === "over" ? "#ef4444" : r === "warn" ? "#f59e0b" : "#22c55e";
  return `
    <div class="oc-health-metric" data-grade="${r}">
      <div class="oc-health-metric-row">
        <span class="oc-health-dot"></span>
        <span class="oc-health-metric-name">${Ge(e)}</span>
...
function cn(e) {
  ...
  return t.length ? t.slice(0, 6).map((a) => {
    const r = a.metrics.map((n) => Ge(n)).join(", "), o = a.start === a.end ? S("Frame {frame}").replace("{frame}", String(a.start)) : S("Frames {start}-{end}").replace("{start}", String(a.start)).replace("{end}", String(a.end));
    return `
...
function dn(e) {
  ...
  if (a.className = `oc-health-badge ${o.grade}`, a.textContent = rn(o.grade), r) {
    const { score: l, letter: d } = ln(o);
  ...
  const s = [
    ...
    fe("fov_drift", o.max_fov_change, o.limits.max_fov_change, o.track_grades.fov_drift)
         ...
         <div class="oc-health-metric-row">
           <span class="oc-health-dot"></span>
           <span class="oc-health-metric-name">${Ge("framing_loss")}</span>
  ...
  t.innerHTML = `
    ...
    <div class="oc-health-zones" data-role="health-zones">${cn(o)}</div>
...
function ci(e, t) {
  ...
  if (a) {
    ...
    for (const r of a.segments) {
      ...
      s.className = "oc-health-band", s.dataset.grade = r.grade, s.style.left = `${o}%`, s.style.width = `${Math.max(0.4, n - o)}%`, s.title = r.metrics.map((i) => Ge(i)).join(", "), t.appendChild(s);
    }
  }
}
function Me(e, t, a, r) {
  const o = e.activeCameraTrack();
  o && (e.checkpoint(a), o.keyframes = t, e.state.keyframes = t, e.syncActiveCameraTrack(), e.refreshKeys(), e.setFrame(e.frame, !1, !1), e.setStatus(r), dn(e));
}
function di(e) {
  const t = de(e);
  if (!t) return;
  ...
  const r = Math.max(1, e.state.duration_frames - 1), o = Jo(e.state.keyframes, r), n = ia({ ...e.state, keyframes: o }, t.limits, null, t.profile);
  if (n.max_speed <= a) {
...
function pi(e) {
  const t = de(e);
  if (!t) return;
  const a = tn(t, "framing_loss");
  if (!a.length) {
    e.setStatus(S("The subject stays in frame on this shot."));
    return;
  }
  const r = en(e.state.keyframes, a, t.subject);
  Me(
    e,
    r,
    "Recenter subject",
...
const mn = {
  ...
  ...mn,
  ...pn
}, Z = ["OmniCam"], ma = "MajoorOmniCam.Locale", pa = "MajoorOmniCam.Defaults.Fps", fa = "MajoorOmniCam.Defaults.DurationSeconds", ua = "MajoorOmniCam.Defaults.Width", ha = "MajoorOmniCam.Defaults.Height", ga = "MajoorOmniCam.Defaults.RenderMode", ya = "MajoorOmniCam.Defaults.Encoder", ba = "MajoorOmniCam.Defaults.PlayblastResolution", _a = "MajoorOmniCam.Playblast.Quality", va = "MajoorOmniCam.Defaults.PlayblastGrid", Sa = "MajoorOmniCam.Defaults.PlayblastLabels", wa = "MajoorOmniCam.Proxy.PointDensity", xa = "MajoorOmniCam.Proxy.PointSpread", Ma = "MajoorOmniCam.Proxy.PointColor", Ca = "MajoorOmniCam.Proxy.CardFit", ka = "MajoorOmniCam.Viewport.Quality", Da = "MajoorOmniCam.Viewport.Adaptive", Ta = "MajoorOmniCam.Viewport.BackgroundColor", ja = "MajoorOmniCam.Display.Grid", Aa = "MajoorOmniCam.Display.Radar", Ea = "MajoorOmniCam.Display.CameraPaths", Oa = "MajoorOmniCam.Display.CameraGizmos", Ia = "MajoorOmniCam.Display.LookAt", Pa = "MajoorOmniCam.Display.HelperAxes", za = "MajoorOmniCam.Display.Gizmo", Na = "MajoorOmniCam.Display.Guides", Ra = "MajoorOmniCam.Display.SafeAreas", La = "MajoorOmniCam.Display.ResolutionGate", Fa = "MajoorOmniCam.Display.AspectRatio", Ba = "MajoorOmniCam.Display.BurnIn", Va = "MajoorOmniCam.Display.SpeedHeatmap", Ka = "MajoorOmniCam.Display.Wireframe", Ga = "MajoorOmniCam.Display.Vertices", qa = "MajoorOmniCam.Tools.SelectMode", Ha = "MajoorOmniCam.Tools.GizmoMode", Wa = "MajoorOmniCam.Tools.GizmoSpace", $a = "MajoorOmniCam.Tools.SpatialSnapMode", Ua = "MajoorOmniCam.Tools.SpatialGridSize", Xa = "MajoorOmniCam.Navigation.Profile", Ya = "MajoorOmniCam.Navigation.FlySpeed", Za = "MajoorOmniCam.Navigation.InvertOrbitY", Qa = "MajoorOmniCam.Navigation.ZoomSensitivity", Ja = "MajoorOmniCam.Navigation.OrbitSensitivity", er = "MajoorOmniCam.Navigation.PanSensitivity", tr = "MajoorOmniCam.Navigation.DollySensitivity", ar = "MajoorOmniCam.Navigation.ViewMode", rr = "MajoorOmniCam.Controls.EnableShortcuts", or = "MajoorOmniCam.Timeline.SnapEnabled", nr = "MajoorOmniCam.Timeline.SnapFrames", sr = "MajoorOmniCam.Timeline.AutoKey", ir = "MajoorOmniCam.Timeline.DefaultInterpolation", lr = "MajoorOmniCam.Timeline.TimecodeMode", cr = "MajoorOmniCam.Timeline.LoopPlayback", dr = "MajoorOmniCam.Interface.Density", mr = "MajoorOmniCam.Interface.PreviewLayout", pr = "MajoorOmniCam.Interface.CameraPreviews", fr = "MajoorOmniCam.History.Limit", ur = "MajoorOmniCam.Extractor.DefaultBackend", hr = "MajoorOmniCam.Monitor.DefaultProfile", gr = "MajoorOmniCam.Agent.Enabled", yr = "MajoorOmniCam.Agent.Provider", br = "MajoorOmniCam.Agent.Model", _r = "MajoorOmniCam.Agent.BaseUrl", vr = "MajoorOmniCam.Agent.MaxOutputTokens", Sr = "MajoorOmniCam.Agent.MaxPlannerSteps", wr = "MajoorOmniCam.Agent.RequestTimeoutSeconds";
...
function un({
  ...
  return [
    ...
    Pt(br, "Agent", "Model", "Model id used by the Agent planner."),
    Pt(_r, "Agent", "Base URL", "Optional provider endpoint override."),
    R(
      vr,
      "Agent",
      "Max output tokens",
...
const xr = un({
  onLocaleChange: () => Mr(),
  onQualityChange: (e) => Nt(e),
  onAdaptiveChange: () => Nt(),
  onAgentEnabledChange: () => Sn()
});
let ut = null;
function F(e, t) {
  try {
...
function hi() {
  for (const e of xr)
    e.defaultValue !== void 0 && (hn(e.id, e.defaultValue), e.onChange?.(e.defaultValue));
}
function L(e, t, a, r, o = !1) {
  const n = Number(F(e, t)), s = Number.isFinite(n) ? Math.min(r, Math.max(a, n)) : t;
...
function N(e, t, a) {
  const r = String(F(e, t));
  return a.includes(r) ? r : t;
}
function zt(e, t) {
  const a = String(F(e, t) || "").trim(), r = a.startsWith("#") ? a.slice(1) : a;
  return /^[0-9a-fA-F]{6}$/.test(r) ? `#${r.toLowerCase()}` : t;
}
function Mr() {
  const e = String(F(ma, "auto")), t = String(F("Comfy.Locale", "en") || "en").slice(0, 2).toLowerCase(), a = e === "auto" ? t : e, r = a !== Ur();
  if ($r(a), !!r) {
    for (const o of W)
      if (!o.disposed)
        try {
...
function wn() {
  return {
    enabled: I(gr, !0),
    provider: N(yr, "ollama", ["openai", "openai_compatible", "anthropic", "ollama"]),
    model: String(F(br, "") || "").trim(),
    baseUrl: String(F(_r, "") || "").trim(),
    maxOutputTokens: L(vr, 4096, 512, 32768, !0),
    maxPlannerSteps: L(Sr, 6, 1, 12, !0),
    requestTimeoutSeconds: L(wr, 120, 15, 300, !0)
  };
}
function xn() {
  return {
    fps: L(pa, 24, 1, 120, !0),
    durationSeconds: L(fa, 5, 1, 120, !0),
    width: L(ua, 1280, 64, 4096, !0),
    height: L(ha, 720, 64, 4096, !0),
    renderMode: String(F(ga, "omni_ref")),
    encoder: String(F(ya, "auto")),
    playblastResolution: N(ba, "output", ["viewport", "half", "output", "double"]),
    playblastQuality: N(_a, "balanced", ["low", "balanced", "high"]),
    playblastGrid: I(va, !1),
    playblastLabels: I(Sa, !1),
    pointDensity: N(wa, "balanced", ["none", "sparse", "balanced", "dense", "ultra"]),
    pointSpread: N(xa, "all_views", ["all_views", "ground_focus", "dome"]),
    pointColor: zt(Ma, "#cbd5e1"),
    cardFit: N(Ca, "contain", ["contain", "cover", "stretch"]),
    backgroundColor: zt(Ta, "#121212"),
    showGrid: I(ja, !0),
    showRadar: I(Aa, !0),
    showCameraPaths: I(Ea, !0),
    showCameraGizmos: I(Oa, !0),
    showLookAt: I(Ia, !0),
    showHelperAxes: I(Pa, !0),
    showGizmo: I(za, !0),
    guides: I(Na, !0),
    safeAreas: I(Ra, !1),
    resolutionGate: I(La, !1),
    aspectRatio: N(Fa, "auto", ["auto", "16:9", "4:3", "1:1", "9:16", "2.39:1"]),
    burnIn: I(Ba, !1),
    speedHeatmap: I(Va, !1),
    showWireframe: I(Ka, !1),
    showVertices: I(Ga, !1),
    selectMode: N(qa, "object", ["object", "vertex", "edge", "face"]),
    gizmoMode: N(Ha, "translate", ["translate", "rotate", "scale"]),
    gizmoSpace: N(Wa, "world", ["world", "local"]),
    spatialSnapMode: N($a, "none", ["none", "grid", "vertex"]),
    spatialGridSize: L(Ua, 0.5, 0.01, 100),
    navigationProfile: N(Xa, "simple", ["maya", "blender", "simple"]),
    flySpeed: L(Ya, 1, 0.05, 5),
    invertOrbitY: I(Za, !1),
    zoomSensitivity: L(Qa, 1, 0.2, 3),
    orbitSensitivity: L(Ja, 1, 0.2, 3),
    panSensitivity: L(er, 1, 0.2, 3),
    dollySensitivity: L(tr, 1, 0.2, 3),
    viewMode: N(ar, "perspective", ["camera", "perspective", "front", "back", "top", "bottom", "right", "left"]),
    snapEnabled: I(or, !0),
    snapFrames: L(nr, 1, 1, 24, !0),
    autoKey: I(sr, !1),
    defaultInterpolation: N(ir, "ease", ["ease", "smooth", "bezier", "linear", "ease_in", "ease_out", "hold"]),
    timecodeMode: N(lr, "time", ["time", "timecode"]),
    loopPlayback: I(cr, !1),
    uiDensity: N(dr, "animation", ["basic", "animation", "advanced"]),
    previewLayout: N(mr, "auto", ["auto", "1", "2", "4"]),
    cameraViewVisible: I(pr, !0),
    undoLimit: L(fr, 100, 10, 500, !0),
    extractorBackend: N(ur, "dpvo", ["dpvo", "pycolmap"]),
    monitorProfile: N(hr, "wan_camera_native", ["wan_camera_native", "minimax_h3", "ltx_motion", "generic_video"])
  };
}
function Mn(e) {
  ut = e, Wr("fr", fn), Mr();
...
function Rt(e, t, a, r, o) {
  const { right: n, up: s, forward: i } = K(t), l = t.position, d = [a[0] - l[0], a[1] - l[1], a[2] - l[2]], c = Dn(d, i);
  let m, p;
  if (t.camera_type === "orthographic") {
...
function Dr(e, t, { includeCtrlFallback: a, includeSimpleLeft: r = a }) {
...
function jn(e, t, a) {
  const r = ht(e), o = Dr(r, t, { includeCtrlFallback: !0 });
  return o === ye && a?.camera_type === "orthographic" ? be : o;
}
function Lt(e, t) {
  return e.isNavigatingFly ? !0 : Dr(ht(e), t, { includeCtrlFallback: !1 }) !== null;
}
const An = ["maya", "blender", "simple"];
function ht(e) {
  const t = e.state?.navigation_profile;
  return An.includes(t) ? t : "maya";
}
function En(e, t) {
...
function Ft(e, { mode: t, origin: a, delta: r, factors: o, rotationDeg: n }) {
...
function On(e, t) {
  return (Array.isArray(e) ? e : []).map((r) => {
    const o = { ...r.camera };
    return Array.isArray(o.position) && (o.position = Ft(o.position, t)), Array.isArray(o.target) && (o.target = Ft(o.target, t)), { ...r, camera: o };
  });
}
function In(e, t) {
...
function Pn(e, { baseDrag: t, viewCamera: a, entityPosition: r }) {
  const o = e.activeCameraTrack?.();
  return !o || o.locked || !(o.keyframes?.length >= 1) ? !1 : (e.checkpoint("Transform camera path"), e.gizmoDrag = {
    ...
    trackId: o.id,
    origin: Tr(o.keyframes),
    baseKeys: o.keyframes.map((n) => ({ ...n, camera: V(n.camera) })),
    viewRight: K(a).right,
    viewUp: K(a).up,
    freeScale: a.camera_type === "orthographic" ? Le(a, e.canvas.height) : H(E(a.position, r)) * (2 * Math.tan((a.fov || 35) * Math.PI / 360)) / e.canvas.height
  }, !0);
}
function zn(e, { pointer: t, deltaPixels: a, precision: r, snapping: o }) {
  ...
  s.keyframes = On(n.baseKeys, l), s.id === e.state.active_camera_id && (e.state.keyframes = s.keyframes), e.camera = le(s, e.frame, e.state.objects), s.camera = V(e.camera), e.refreshKeys(), e.refreshInspector(), e.render(), e.renderCameraView?.();
}
function Bt(e, t) {
  const a = [];
...
function Nn(e, t) {
  ...
  return Bt(n.map((i) => -i), n).map((i) => C(o, oa(i, s)));
}
function Rn(e, t, a, r = {}) {
  const o = e.state.objects.filter((b) => b.enabled !== !1), n = r.all ? o : o.filter((b) => e.selectedObjectIds?.has(b.id)), i = (n.length ? n : [a]).flatMap((b) => Nn(e, b)), l = [0, 1, 2].map((b) => Math.min(...i.map((x) => x[b]))), d = [0, 1, 2].map((b) => Math.max(...i.map((x) => x[b]))), c = l.map((b, x) => (b + d[x]) / 2), { right: m, up: p, forward: u } = K(t), h = Math.max(1, e.canvas?.width || e.state.width || 1280) / Math.max(1, e.canvas?.height || e.state.height || 720), f = Math.tan((t.fov || 35) * Math.PI / 360), _ = f * h;
  let y = 2, v = 0.1;
  for (const b of i) {
...
function xi(e, t = {}) {
  ...
  e.checkpoint(t.all ? "Frame all" : "Frame subject"), Rn(e, a, s, t), r ? (e.serialize(), e.render()) : (e.beginCameraEdit(), e.commitCameraEdit(), e.finishCameraEdit()), e.setStatus(t.all ? S("Framed: all objects") : S("Framed: {name}").replace("{name}", s.name || s.type || S("Subject")));
}
function Ln(e, t, a, { forceLocal: r = !1 } = {}) {
...
function jr(e) {
  ...
  const n = Math.max(0.7, H(E(a.position, r)) * 0.12), s = e.state.gizmo_mode === "scale" || e.state.gizmo_mode === "rotate", i = t.type === "object" ? Ln(e, t.object, t, { forceLocal: s }) : [[1, 0, 0], [0, 1, 0], [0, 0, 1]];
  ...
  const l = i.map((d, c) => {
    const m = Math.abs(d[1]) < 0.9 ? [0, 1, 0] : [1, 0, 0], p = ne(Se(d, m)), u = ne(Se(d, p)), h = [];
    for (let f = 0; f <= 48; f++) {
...
function Ar(e, t) {
  ...
  for (const i of a.handles)
    for (let l = 0; l < i.points.length - 1; l++) {
      const d = i.points[l], c = i.points[l + 1], m = ra(t, d, c);
...
function Bn(e, t) {
    ...
    if (e.state.show_camera_paths !== !1)
      for (const s of e.state.cameras) {
        ...
        for (let d = 0; d < l.length - 1; d += 1)
          if (ra(t, l[d], l[d + 1]) <= 8 * Math.min(2, window.devicePixelRatio || 1))
  ...
  for (const s of e.state.objects) {
    ...
    const i = s.keyframes?.length ? Ke(s, e.frame) : s, l = B(i.position || [0, 0, 0], r, e.canvas.width, e.canvas.height);
    if (!l) continue;
...
function Mi(e) {
  ...
  for (const o of t.handles) {
    ...
    if (e.ctx.lineWidth = n ? 6.5 : 3.8, e.ctx.strokeStyle = n ? "#ffffff" : a[o.index] || "#ffffff", e.ctx.fillStyle = a[o.index] || "#ffffff", e.ctx.beginPath(), o.points.forEach((s, i) => {
      ...
      e.state.gizmo_mode === "scale" && t.entity?.type === "object" ? (e.ctx.fillRect(i[0] - 6, i[1] - 6, 12, 12), e.ctx.save(), e.ctx.strokeStyle = "rgba(15, 23, 42, 0.65)", e.ctx.lineWidth = 1, e.ctx.strokeRect(i[0] - 6, i[1] - 6, 12, 12), e.ctx.restore()) : Vn(e.ctx, s[0], i);
    }
  }
...
function qn(e, t, a, r, o, n, s) {
  const i = o ? "grid" : e.state.spatial_snap_mode;
  if (i === "grid") {
    const l = e.state.spatial_grid_size || 0.5;
    return n ? a.map((d, c) => d.map((m, p) => Math.abs(n[p]) > 1e-6 ? Fe(m, l) : s[c][p])) : a.map((d) => d.map((c) => Fe(c, l)));
  }
  if (i === "vertex" && r && !n) {
...
function Ae(e, t) {
  ...
  const n = o[0] - a.start[0], s = o[1] - a.start[1], i = t.shiftKey ? 0.1 : 1, l = Gn(a), d = a.axis ? at[a.axis] : null, c = e.state.view_mode === "camera" ? e.camera : e.state.editor_views[e.state.view_mode], m = K(c), p = c.camera_type === "orthographic" ? 10 / (Math.max(0.01, c.zoom || 1) * Math.max(1, e.canvas.height)) : Math.hypot(...E(c.position, c.target)) * 25e-4;
  let u = a.snapshots.map((b) => [...b.transform.position]);
  if (a.mode === "translate") {
    const b = l ?? (n - s) * p * i, x = d ? k(d, b) : C(k(m.right, n * p * i), k(m.up, -s * p * i));
    u = u.map((w) => C(w, x)), u = qn(e, a, u, o, t.ctrlKey || t.metaKey, d, a.snapshots.map((w) => w.transform.position));
  }
  const h = a.mode === "rotate" ? l ?? (n - s) * 0.5 * i : 0, f = a.mode === "scale" ? Math.max(0.01, l ?? 1 + (n - s) * 0.01 * i) : 1, _ = d || at.z, y = t.ctrlKey || t.metaKey || e.state.spatial_snap_mode === "grid";
  a.snapshots.forEach((b, x) => {
    const w = b.object;
    if (a.mode === "translate" && (w.position = u[x]), a.mode === "rotate") {
      const D = y ? Fe(h, 15) : h, g = k(_, D);
      w.position = C(a.pivot, xe(E(b.transform.position, a.pivot), g)), w.rotation = C(b.transform.rotation, g);
    }
    if (a.mode === "scale") {
      const D = y ? Fe(f, 0.1) : f, g = d ? d.map((A) => A ? D : 1) : [D, D, D], M = E(b.transform.position, a.pivot);
...
function Hn(e, t) {
  ...
  return r === "escape" ? Ir(e) : r === "enter" || r === " " ? Or(e) : at[r] ? (a.axis = a.axis === r ? null : r, Ae(e, a.lastEvent), !0) : /^[0-9]$/.test(r) || r === "." || r === "," || r === "-" && !a.numeric ? (a.numeric += r === "," ? "." : r, Ae(e, a.lastEvent), !0) : (r === "backspace" && (a.numeric = a.numeric.slice(0, -1), Ae(e, a.lastEvent)), !0);
}
function ue(e, t, a) {
...
const re = (e, t) => Math.round(e / t) * t, $n = (e, t) => e.map((a) => re(a, t));
function Un(e, t, a) {
...
function he(e, t, a, r = [], o = null) {
  ...
  if (s === "grid")
    return o ? t.map((l, d) => Math.abs(o.axis[d]) > 1e-6 ? re(l, i) : o.base[d]) : $n(t, i);
  if (s === "vertex" && a && !o) {
...
function Ci(e, t) {
  if (e.modalTransform) {
    t.preventDefault?.(), t.stopPropagation?.(), t.button === 0 ? Or(e) : t.button === 2 && Ir(e);
    return;
  }
  if (t.target?.closest?.("button,input,select")) return;
  if (t.button === 2 && !Lt(e, t)) {
  ...
  const a = e.interactionElement.getBoundingClientRect(), r = (t.clientX - a.left) * e.canvas.width / Math.max(1, a.width), o = (t.clientY - a.top) * e.canvas.height / Math.max(1, a.height), n = X(e), s = e.state.view_mode !== "camera", i = Lt(e, t), l = t.button === 0 && !i, d = l && !t.altKey && !t.shiftKey;
  ...
  if (c) {
    ...
    if (c.entity.type === "camera_path" && Pn(e, { baseDrag: b, viewCamera: n, entityPosition: c.entity.position })) return;
    if (c.entity.type === "object") {
      const x = c.entity.object;
      e.checkpoint("Transform object");
      const w = Er(e), D = (w.length ? w : [x]).map((M) => ({ object: M, transform: ce(M) }));
      ...
      e.gizmoDrag = {
        ...
        viewRight: K(n).right,
        viewUp: K(n).up,
        freeScale: n.camera_type === "orthographic" ? Le(n, e.canvas.height) : H(E(n.position, c.entity.position)) * (2 * Math.tan((n.fov || 35) * Math.PI / 360)) / e.canvas.height
      };
      return;
    }
  }
  const m = l ? Bn(e, [r, o]) : null;
  if (e.pointerHit = !!(c || m), m) {
    ...
    if (m.type === "camera_target") {
      ...
      e.checkpoint("Move camera target"), e.beginCameraEdit();
      const { right: _, up: y } = K(n), v = [...e.camera.target], b = e.activeCameraTrack?.(), x = !!b?.target_object_id;
      e.targetFreeDrag = {
        pointer: [r, o],
  ...
  if (!m && l && !t.ctrlKey && !t.metaKey && ht(e) !== "simple") {
    e.boxSelection = {
      start: [r, o],
      current: [r, o],
      additive: t.shiftKey,
  ...
  const p = !!e.isNavigatingFly, u = jn(e, t, n);
  if (!p && !u) return;
...
function ki(e, t) {
  ...
  if (e.pathDrag) {
    ...
    c && (c.camera.position = Rt(
      [i, l],
      X(e),
      e.pathDrag.anchor,
      e.canvas.width,
      e.canvas.height
    ), c.interpolation = Tn(c.interpolation), e.webgl && (e.webgl.pathKey = ""), e.setFrame(e.frame, !1, !1), e.render());
    return;
  }
  ...
  if (e.gizmoDrag) {
    ...
    if (e.gizmoDrag.type === "camera_target") {
      ...
      e.gizmoDrag.tracking ? Vt(e, h) : e.camera.target = h, e.commitCameraEdit(), e.refreshInspector(), e.render();
      return;
    }
    ...
    if (e.gizmoDrag.type === "camera_path") return void zn(e, { pointer: i, deltaPixels: d, precision: l, snapping: c });
    if (e.state.gizmo_mode === "translate")
      if (e.gizmoDrag.free) {
  ...
  if (!e.drag) {
    const s = e.interactionElement.getBoundingClientRect(), i = Ar(e, [
      (t.clientX - s.left) * e.canvas.width / Math.max(1, s.width),
      (t.clientY - s.top) * e.canvas.height / Math.max(1, s.height)
  ...
  if (e.drag.dolly) {
    ...
    const { right: s, up: i } = K(n), l = Le(n, e.interactionElement.getBoundingClientRect().height) * (e.panSensitivity ?? 1), d = C(k(s, -a * l), k(i, r * l));
...
function Di(e, t) {
  if (t?.type === "pointercancel" || t?.type === "lostpointercapture") {
    t.pointerId === e.activePointerId && Pr(e);
    return;
  }
  if (e.pathDrag) {
...
function Ti(e, t) {
  ...
  const a = En(t, e.interactionElement.getBoundingClientRect().height);
  if (!a) return;
...
function Be(e, { sourceKind: t = "manual_2d", label: a, keys: r, source: o = {} }) {
  if (!Zt.includes(t)) throw new Error(`Unsupported motion source: ${t}`);
  const n = Xn(e), s = { id: n, label: a || `Motion ${n.split("_").at(-1)}`, enabled: !0, semantic: "screen_point", source_kind: t, keys: r.map((i) => ({ visible: !0, interpolation: "linear", ...i })), source: { ...o } };
...
function gt(e, t) {
  return e.motion_tool = Yt.includes(t) ? t : "select", e.motion_tool;
}
function Yn(e, t) {
  if (Qt.includes(t))
...
function Jn(e, t, a, r, o) {
  const n = le(e, a, e.objects);
  let s = t?.point;
  if (t?.object_id) {
    const c = e.objects.find((u) => u.id === t.object_id);
    if (!c) return null;
    const m = Vo(e.objects, c), p = Array.isArray(t.local_point) ? t.local_point : [0, 0, 0];
...
function Ye(e, t) {
  return Qn(t, e.interactionElement);
}
function as(e, t) {
  const a = Nr(e.motion_layers, t);
...
function rs(e, t) {
  const a = e.state.objects.find((d) => d.id === e.selectedObjectId), r = e.motionCreationKind, n = (r === "object" || r !== "world" && !!a) && a ? "object_point" : "world_point", s = n === "object_point" ? { object_id: a.id, local_point: [0, 0, 0] } : { point: e.webgl?.intersectScenePoint?.(t.x * e.canvas.width, t.y * e.canvas.height, e.canvas.width, e.canvas.height) || [...e.camera.target] }, i = Jn(e.state, s, e.frame, e.canvas.width, e.canvas.height) || t, l = n === "object_point" ? `${a.name || a.id} Track` : "World Anchor";
  return Be(e.state, { sourceKind: n, label: l, keys: [{ time_seconds: e.frame / e.state.fps, x: i.x, y: i.y, visible: i.visible !== !1 }], source: s });
}
function ji(e, t) {
  for (const o of e.root.querySelectorAll("[data-motion-tool]"))
    o.addEventListener("click", () => {
      e.motionCreationKind = "", gt(e.state, o.dataset.motionTool), Ve(e), e.render();
    }, { signal: t });
  for (const o of e.root.querySelectorAll("[data-motion-preset]"))
    o.addEventListener("click", () => {
      e.checkpoint("Add camera field"), Be(e.state, { sourceKind: "camera_field", label: `${o.dataset.motionPreset} Field`, keys: [{ time_seconds: 0, x: 0.5, y: 0.5 }], source: { preset: o.dataset.motionPreset, point: [...e.camera.target] } }), ae(e, `Camera field: ${o.dataset.motionPreset}`);
    }, { signal: t });
  e.root.querySelector('[data-role="motion-interpolation"]')?.addEventListener("change", (o) => {
    const n = Xe(e.state);
    n && (e.checkpoint("Set motion interpolation"), Yn(n, o.target.value), ae(e, `Motion interpolation: ${o.target.value}`));
  ...
  a.addEventListener("pointerdown", (o) => {
    ...
    e.checkpoint(n === "erase" ? "Erase motion track" : "Add motion anchor"), n === "anchor" ? Be(e.state, { sourceKind: "static_anchor", label: `Anchor ${(e.state.motion_layers || []).length + 1}`, keys: [{ time_seconds: e.frame / e.state.fps, ...s, interpolation: "hold" }] }) : n === "project" ? rs(e, s) : n === "erase" && as(e.state, s), ae(e, `Motion tool: ${n}`);
  ...
  const r = (o) => {
    ...
    const [s, i] = Kt(e), l = ts(e.state, n.points, s, i);
  ...
  a.addEventListener("pointerup", r, { capture: !0, signal: t }), a.addEventListener("pointercancel", r, { capture: !0, signal: t }), a.addEventListener("click", (o) => {
    ...
    const n = Nr(e.state.motion_layers, Ye(e, o));
...
function ns(e, t) {
  ...
  if (a) {
    ...
    e.checkpoint?.(`Motion: ${a.label}`), gt(e.state, a.tool), e.motionCreatingLabel = a.label, e.motionCreationKind = t, Ve(e), e.render(), e.setStatus(a.hint);
  }
}
function Rr(e) {
  return (e.state.motion_tool || "select") === "select" && !e.motionTrackDraft ? !1 : (gt(e.state, "select"), e.motionTrackDraft = null, e.motionCreatingLabel = "", e.motionCreationKind = "", Ve(e), e.render(), e.setStatus("Motion creation cancelled."), !0);
}
function Ai(e, t) {
  for (const a of e.root.querySelectorAll("[data-motion-create]"))
    a.addEventListener("click", () => ns(e, a.dataset.motionCreate), { signal: t });
  e.root.querySelector("[data-motion-create-cancel]")?.addEventListener("click", () => Rr(e), { signal: t });
}
...
const ge = { t: "translate", r: "rotate", s: "scale" }, cs = [
...
], ds = 'button,summary,a[href],[role="button"],[role="menuitem"],[role="tab"],[role="option"],[role="checkbox"],[role="switch"]';
function ms(e) {
  return e instanceof HTMLElement || e instanceof SVGElement ? !!e.closest?.(ds) : !1;
}
function ps(e) {
...
function us(e, t) {
  return fs(e) || t?.lastKeyZone || "viewport";
}
let qt = !1;
function hs() {
  qt || typeof window > "u" || (qt = !0, window.addEventListener("keydown", (e) => {
    if (!yn()) return;
    const t = e.composedPath?.()[0] || e.target, a = bn(t);
    !a || a.disposed || gs(a, e) && (e.preventDefault(), e.stopImmediatePropagation?.(), e.stopPropagation());
  }, { capture: !0 }));
}
function gs(e, t) {
  if (!vn()) return !1;
  const a = t.composedPath?.()[0] || t.target;
  if (ps(a) || (t.code === "Space" || t.key === "Enter") && ms(a)) return !1;
...
function _s(e, t) {
  ...
  if (r === "Numpad9") {
    const i = ls(e.state.view_mode);
    return i ? e.setViewMode(i) : Gt(e, Math.PI, 0), !0;
  }
  const n = Math.PI / 12, s = { Numpad4: [n, 0], Numpad6: [-n, 0], Numpad8: [0, n], Numpad2: [0, -n] };
  if (s[r])
    return Gt(e, s[r][0], s[r][1]), !0;
  if (r === "Numpad5")
  ...
  if (["w", "a", "s", "d", "q", "e"].includes(a) && e.isNavigatingFly) {
    const i = e.viewportCamera(), l = e.state.view_mode !== "camera", { right: d, up: c, forward: m } = K(i), p = (t.shiftKey ? 0.6 : 0.18) * e.cameraSpeed, u = { w: k(m, p), s: k(m, -p), d: k(d, p), a: k(d, -p), e: k(c, p), q: k(c, -p) }[a];
...
function Ss(e, t) {
  ...
  if (a === "s" || a === "a")
    return t.repeat || (!Ie(e.state).length || a === "a" ? (e.checkpoint("Auto-split shots"), e.state.sequence = { ...e.state.sequence || { recording_path: "" }, enabled: !0, cuts: Qr(e.state) }, Qe(e)) : (e.checkpoint("Split shot"), eo(e.state, e.frame, null) ? Qe(e) : e.setStatus("Move the playhead inside a shot first"))), !0;
  if (t.key === "Delete" || t.key === "Backspace") {
    if (t.repeat) return !0;
    const r = Ie(e.state), o = Xt(e.state, e.frame), n = o ? r.findIndex((s) => s.start === o.start) : -1;
    return n >= 0 && (e.checkpoint("Remove shot"), to(e.state, n) && Qe(e)), !0;
  }
  return !1;
}
function yt(e, t) {
...
function Ms([e, t], [a, r]) {
  ...
  const o = Math.round((window.innerWidth || e) * ws), n = Math.round((window.innerHeight || t) * xs);
  return [
...
function Cs(e, t) {
  const a = Lr[t];
  return !a || !e?.setSize ? !1 : (e.setSize(Ms(a.default, a.min)), !0);
}
function ks(e, t, a) {
  const r = Lr[t];
...
const Ht = "oc-help-css", Te = "#8b7bd8", Fr = /* @__PURE__ */ new Map();
function bt(e, t) {
  e && t && Fr.set(e, t);
}
function st(e) {
  return e && Fr.get(e) || null;
}
const Ds = `
...
.oc-help-h-icon{width:18px;height:18px;flex:none;border-radius:50%;background:${Te};
...
.oc-help-close:hover{background:${Te};color:#fff}
...
.oc-help-h{margin:0 0 6px;font-size:10px;font-weight:700;color:${Te};
...
.oc-help-tip{margin-top:2px;padding:8px 10px;background:rgba(139,123,216,.12);
  border-left:2px solid ${Te};border-radius:3px;color:#ddd;font-size:11.5px}
`;
function Ts() {
  if (document.getElementById(Ht)) return;
  const e = document.createElement("style");
  e.id = Ht, e.textContent = Ds, document.head.appendChild(e);
}
function oe(e) {
...
function Wt(e) {
  ...
  const m = document.activeElement instanceof HTMLElement ? document.activeElement : null, p = () => {
    document.removeEventListener("keydown", h, !0), t.remove(), we === p && (we = null), m && m.isConnected && typeof m.focus == "function" && m.focus({ preventScroll: !0 });
  };
  we = p;
  const u = () => Array.from(
...
const $t = "MajoorOmniCam.ShowHelp", it = "oc-help-toolbar-icon", Ut = "oc-help-toolbar-css", Es = "#8b7bd8";
function Os() {
  if (document.getElementById(Ut)) return;
  const e = document.createElement("style");
  e.id = Ut, e.textContent = `
    .${it}{display:inline-flex;align-items:center;justify-content:center;
      width:16px;height:16px;border-radius:50%;background:${Es};color:#fff;
...
J.registerExtension({
  ...
  getNodeMenuItems(e) {
    const t = st(e?.comfyClass);
    return t ? [null, { content: "? Help", callback: () => Wt(t) }] : [];
  },
  setup() {
    Os();
  }
...
function je(e, t) {
  ...
  Array.isArray(a) && a.push({ stage: e, nodeId: t?.id ?? null, nodeClass: qe(t), configuringGraph: ie });
}
hs();
Hr(J);
Mn(J);
J.registerExtension({
  ...
  async nodeCreated(e) {
    if (qe(e) !== rt) return;
    je("director:nodeCreated", e);
    const t = !ie, a = t ? null : vt(e);
    await yt(e, async () => {
      je("director:import:start", e);
      const { attachDirector: o } = await import("./chunk-BiRkdTiF.js").then((n) => n.g);
      return je("director:import:resolved", e), o;
    });
    const r = e.__majoorOmniCam;
    r && (je("director:attach:complete", e), Cn(r), t && kn(r), _t(e, rt, t, a?.()));
  }
});
J.registerExtension({
  ...
  async nodeCreated(e) {
    if (qe(e) !== ot) return;
    const t = !ie, a = t ? null : vt(e);
    await yt(e, async () => (await import("./chunk-FWCeT8K9.js")).attachExtractor), e.__majoorOmniCamExtractor && _t(e, ot, t, a?.());
  }
});
J.registerExtension({
  ...
  async nodeCreated(e) {
    if (qe(e) !== nt) return;
    const t = !ie, a = t ? null : vt(e);
    await yt(e, async () => (await import("./chunk-CvBc3khd.js")).attachMonitor), e.__majoorOmniCamMonitor && _t(e, nt, t, a?.());
  }
});
export {
  ga as $,
