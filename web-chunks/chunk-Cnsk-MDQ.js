...
const ho = () => import("./chunk-3SxmTkPZ.js");
function Ef(e, t) {
...
async function qh(e) {
  ...
  try {
    let n = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-CnZHokoe.js");
...
class ai {
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-CnZHokoe.js"));
    } catch (a) {
  ...
  try {
    t.assetBrowser = Ap(t, {
      ...
      onAgentFirstOpen: async () => {
        if (Zo())
          try {
            const { createDirectorAgentPanel: m } = await import("./chunk-C9vpcViN.js");
            t.agentPanel = m(t);
          } catch (m) {
