import { app as qn } from "../../scripts/app.js";
import { api as at } from "../../scripts/api.js";
import { s as $e, c as Z, t as he, a as s, o as Un, b as xr, d as He, e as ce, f as Fo, r as pi, g as wr, h as Wn, i as fi, j as hi, k as ui, l as bi, m as kr, n as Sr, I as jo, D as gi, p as jr, q as yi, w as vi, u as Ao, v as Vn, x as xi, y as _r, z as or, A as Hr, B as Hn, C as rr, E as Gn, F as Yn, G as Xn, H as Jn, J as nr, K as Vo, L as Gr, O as Yr, R as Zn, M as wi, N as ki, P as Si, Q as ji, S as _i, T as Ce, U as Qn, V as es, W as Xr, X as Ut, Y as Ci, Z as ts, _ as Ei, $ as Ai, a0 as Cr, a1 as Ti, a2 as $i, a3 as Mi, a4 as Ii, a5 as Oi, a6 as Er, a7 as Pi, a8 as Li, a9 as zi, aa as Ni, ab as Fi, ac as Ri, ad as Di, ae as Ki, af as Bi, ag as qi, ah as Ui, ai as Wi, aj as Vi, ak as Hi, al as Gi, am as Yi, an as Xi, ao as Ji, ap as Zi, aq as Qi, ar as ec, as as tc, at as ac, au as oc, av as rc, aw as nc, ax as sc, ay as ic, az as cc, aA as lc, aB as dc, aC as mc, aD as pc, aE as fc, aF as hc, aG as uc, aH as bc, aI as gc, aJ as yc, aK as vc, aL as xc, aM as wc, aN as kc, aO as as, aP as Sc, aQ as Ho, aR as jc, aS as _c, aT as Cc, aU as Ec, aV as Ac, aW as Ve, aX as Tc, aY as os, aZ as Ar, a_ as $c, a$ as Mc, b0 as Ic, b1 as rs, b2 as Ze, b3 as Oc, b4 as Jr, b5 as Tr, b6 as Pc, b7 as Lc, b8 as zc, b9 as Nc, ba as Fc, bb as Rc, bc as Dc, bd as Kc, be as Bc, bf as ns, bg as qc, bh as Uc, bi as Wc, bj as Vc, bk as Hc, bl as Gc, bm as Yc, bn as Xc, bo as Jc, bp as Zc, bq as Qc, br as el, bs as tl, bt as al, bu as ol, bv as rl, bw as nl, bx as sl, by as il } from "./chunk-Cs4ne4WO.js";
import { L as cl, a as ll, p as Yt, f as $r, b as dl, S as ml, c as Zr, d as pl, e as fl, r as hl, g as ul, n as bl, C as Qr, h as Xt, o as gl, i as yl, s as vl, j as xl, k as ss, l as wl, m as sr, q as ir, w as kl, t as is, u as Sl, v as jl, x as _l, y as Cl, z as El, A as Al, B as Tl, D as $l, E as Ml, F as Il, G as Ol, H as Pl, I as Ll, J as zl, K as Nl, M as Fl } from "./chunk-DyQuBF9u.js";
import { S as Rl, b as Dl, p as Kl, m as Bl, l as ql, u as Ul } from "./chunk-BOI_2OKd.js";
import { T as Wl } from "./chunk-__IQ4xkd.js";
import { T as Vl, R as Hl } from "./vendor-three-BQUrLQkn.js";
function Ft(e, t = 0) {
  return Math.sin(e * 1.7 + t * 3.1) * 0.5 + Math.sin(e * 3.3 + t * 5.7) * 0.3 + Math.sin(e * 7.9 + t * 11.3) * 0.2;
}
function Gl(e, { type: t = "handheld_subtle", intensity: a = 1, duration_frames: o = null, subdivide: r = !0 } = {}) {
  ...
  return [...b].sort((y, x) => y - x).map((y) => {
    const x = $e(u, y), S = Ft(y * m, 1) * l, g = Ft(y * m, 2) * l, k = Ft(y * m, 3) * l * 0.5, _ = Ft(y * m, 4) * p, O = Ft(y * m, 5) * (p * 0.35), P = [...x.position], K = [...x.target];
    return P[0] += S, P[1] += g, P[2] += k, K[0] += S * 0.35, K[1] += g * 0.35, {
      frame: y,
      camera: {
        ...x,
        position: P,
        target: K,
        roll: (x.roll || 0) + _,
        fov: Z((x.fov || 35) + O, 10, 140)
      },
      interpolation: "smooth"
    };
  });
}
function Yl(e, { duration_frames: t = 120, target: a = [0, 1.5, 0], radius: o = 6, height: r = 3.5 } = {}) {
...
const cs = 1e-4;
function Xl(e, t) {
  return !Array.isArray(e) || !Array.isArray(t) ? e !== t : e.some((a, o) => Math.abs(Number(a) - Number(t[o])) > cs);
}
function en(e, t) {
  return Math.abs(Number(e) - Number(t)) > cs;
}
const ls = [
  {
    id: "camera",
  ...
  },
  {
    ...
    label: "Look At",
    color: "#f0a742",
    changed: (e, t) => Xl(e?.target, t?.target),
    read: (e) => e?.target
  },
  {
    id: "focal_length",
...
function Zl(e, t = null) {
  return ls.filter((a) => !t || t.has(a.id)).map((a) => ({
    id: a.id,
    label: a.label,
    color: a.color,
    frames: Jl(e, a)
...
function To(e) {
  ...
  for (const a of [".oc-playhead-head", '[data-role="dope-playhead"]', ".oc-gdope-playhead", ".oc-sequence-playhead"])
    for (const o of e.root.querySelectorAll(a)) Ql(o, t);
}
function ed(e, t, a) {
...
function ds(e) {
  ...
  a.delete("camera");
  const o = e.timelineKeyframes() || [], r = Zl(o, a), n = ad(e, r);
  if (t.dataset.signature !== n) {
    t.dataset.signature = n, t.replaceChildren();
    const i = (c) => he(e, c);
    for (const c of r) {
      const l = document.createElement("div");
      l.className = "oc-dope-row", l.dataset.channel = c.id, l.style.setProperty("--channel-color", c.color), ed(l, c.frames, i), td(e, l, c, o, i), t.appendChild(l);
    }
  }
...
const Go = [1, 2, 5, 10, 20, 25, 50, 100, 200, 250, 500, 1e3, 2e3, 5e3], ms = 46, tn = 5, ps = 640;
function fs(e, t) {
  const a = t > 0 ? t : ps, o = Math.max(2, Math.floor(a / ms)), r = Math.max(1e-6, e / o);
  return Go.find((n) => n >= r) ?? Go[Go.length - 1];
}
function od(e, t) {
  const a = Math.max(1, e.state.duration_frames - 1), o = Z(Number(e.timelineZoom) || 1, 0.1, 50), r = Number(e.timelinePan) || 0, n = a / o, i = fs(n, t), l = (i >= tn ? i / tn : 0) || i, p = [], m = Math.max(0, Math.floor(r / l) * l);
...
function rd(e) {
  return e.clientWidth || e.parentElement?.clientWidth || ps;
}
function hs(e) {
  const t = e.root.querySelector('[data-role="ruler"]');
  if (!t) return;
  t.replaceChildren();
  for (const o of od(e, rd(t))) {
...
function nd(e, t) {
  ...
  a.addEventListener("pointerup", i, { signal: t }), a.addEventListener("pointercancel", i, { signal: t }), a.addEventListener("wheel", (c) => Un(e, c), { passive: !1, signal: t });
}
const sd = [1, 2, 2.5, 5, 10];
function id(e, t = 5) {
  const a = Math.abs(e) / Math.max(1, t);
  if (!(a > 0) || !Number.isFinite(a)) return 1;
  const o = 10 ** Math.floor(Math.log10(a)), r = a / o;
  return (sd.find((n) => n >= r) ?? 10) * o;
}
function cd(e, t) {
  const a = Math.max(0, Math.min(4, Math.ceil(-Math.log10(t))));
  return e.toFixed(a);
}
function ld(e, { left: t, right: a, top: o, width: r, graphWidth: n, graphHeight: i, height: c, timeMin: l, timeMax: p, totalDuration: m, xFor: f, frame: d }) {
  const h = fs(p - l, n);
...
function dd(e, { left: t, right: a, top: o, width: r, graphHeight: n, minimum: i, maximum: c, yFor: l }) {
  const p = id(c - i, 4);
...
function md(e, t) {
  ...
  if (!n || n.distance > 12) {
    if (r < 20) {
      const c = Math.max(1, e.state.duration_frames - 1), l = c / (Number(e.curveZoomX) || 1), p = Number(e.curvePanX) || 0, m = Math.round(Z(p + (o - 44) / Math.max(1, a.clientWidth - 58) * l, 0, c));
...
function pd(e, t) {
  const a = t.currentTarget, { x: o, y: r } = Mr(a, t);
  ...
  if (e.curveScrub && t.pointerId === e.curveScrub.pointerId) {
    t.preventDefault();
    const f = Math.max(1, e.state.duration_frames - 1), d = f / (Number(e.curveZoomX) || 1), h = Number(e.curvePanX) || 0, u = Math.round(Z(h + (o - 44) / Math.max(1, a.clientWidth - 58) * d, 0, f));
    e.setFrame(u);
    return;
  }
  ...
  if (!e.curveDrag || t.pointerId !== e.curveDrag.pointerId) {
    const f = (e.curveHitPoints || []).map((x) => ({ point: x, distance: Math.hypot(o - x.x, r - x.y) })).sort((x, S) => x.distance - S.distance)[0], d = Math.max(1, e.state.duration_frames - 1), h = d / (Number(e.curveZoomX) || 1), u = Number(e.curvePanX) || 0, b = Math.max(1, a.clientWidth - 58), v = Z(Math.round(u + (o - 44) / b * h), 0, d);
    let y = null;
    if (f && f.distance <= 14) {
  ...
  if (e.curveHover = null, t.preventDefault(), t.stopPropagation(), e.curveDrag.historyCheckpointed || (e.checkpoint?.(e.curveDrag.handle ? "Edit curve tangent" : "Edit curve"), e.curveDrag.historyCheckpointed = !0), e.curveDrag.handle) {
    ...
    if (h === "in") {
      if (g.in_x = Z((o - v) / Math.max(1, u), -0.99, -0.01), g.in_y = (y - r) * b, S === "aligned") {
    ...
    } else if (g.out_x = Z((o - v) / Math.max(1, u), 0.01, 0.99), g.out_y = (y - r) * b, S === "aligned") {
  ...
  if (e.curveDrag.group) {
    ...
    if (d) {
      const u = e.curveDrag.group.map((v) => Z(Math.round(v.startFrame + d), 0, e.curveDrag.lastFrame));
...
function vd(e, t) {
  e.curveZoom = Z((Number(e.curveZoom) || 1) * t, 0.2, 30), e.curveZoomX = Z((Number(e.curveZoomX) || 1) * t, 0.2, 30), e.drawCurveEditor(), e.setStatus(s(`Curve zoom: ${(e.curveZoom * 100).toFixed(0)}%`));
}
function xd(e, t) {
  t.preventDefault(), t.stopPropagation();
  const a = t.currentTarget, { x: o, y: r } = Mr(a, t);
  if (r < 20) return;
  const n = Math.max(1, e.state.duration_frames - 1), i = n / (Number(e.curveZoomX) || 1), c = Number(e.curvePanX) || 0, l = Math.max(1, a.clientWidth - 58), p = Z(Math.round(c + (o - 44) / l * i), 0, n);
...
function us(e, { selectedOnly: t = !1 } = {}) {
  const a = Math.max(1, (e.state?.duration_frames ?? 120) - 1), o = e.timelineKeyframes() || [], r = e.timelineObject(), n = mt(e), i = e.selectedKeyFrames?.size ? [...e.selectedKeyFrames] : e.selectedKeyFrame != null ? [e.selectedKeyFrame] : [], c = i.length > 0, l = t || c && i.length < o.length ? o.filter((b) => i.includes(b.frame)) : o;
  if (!l.length) {
  ...
  if (l.length < o.length && d < a) {
    ...
    e.curveZoomX = Z(a / x, 0.2, 30), e.curvePanX = v;
  } else
  ...
  if (h.length > 0) {
    const b = Math.min(...h), v = Math.max(...h), y = Math.max(1e-4, v - b), x = (b + v) / 2, S = (H) => r ? Fo(r, H) : $e(e.state, H), g = [], k = Math.max(1, Math.floor(a / 40));
    for (let H = 0; H <= a; H += k) {
      const oe = S(H);
      for (const C of n) {
        const R = C.get(oe);
    ...
    let _ = Math.min(...g), O = Math.max(...g);
    (!Number.isFinite(_) || !Number.isFinite(O)) && (_ = -1, O = 1), Math.abs(O - _) < 1e-6 && (_ -= 1, O += 1);
    const P = (O - _) * 0.1;
    _ -= P, O += P;
    const K = O - _, W = (_ + O) / 2;
    if (l.length < o.length && y < K * 0.75) {
      const H = y * 1.35;
      e.curveZoom = Z(K / H, 0.2, 30), e.curvePanY = x - W;
    } else
...
function kd(e) {
  ...
  const i = e.timelineObject(), c = e.timelineKeyframes(), l = mt(e), p = 44, m = 14, f = 16, d = 22, h = Math.max(1, a - p - m), u = Math.max(1, o - f - d), b = Math.max(1, e.state.duration_frames - 1), v = Z(Number(e.curveZoomX) || 1, 0.1, 50), y = Number(e.curvePanX) || 0, x = b / v, S = y, g = y + x, k = [], _ = Math.max(1, Math.ceil(x / Math.max(80, h))), O = (E) => i ? Fo(i, E) : $e(e.state, E);
  for (let E = 0; E <= b; E += _) k.push({ frame: E, value: O(E) });
  k[k.length - 1]?.frame !== b && k.push({ frame: b, value: O(b) });
  const P = k.flatMap((E) => l.map((G) => G.get(E.value)));
  let K = Math.min(...P), W = Math.max(...P);
  (!Number.isFinite(K) || !Number.isFinite(W)) && (K = -1, W = 1), Math.abs(W - K) < 1e-6 && (K -= 1, W += 1);
  const H = (W - K) * 0.1;
  K -= H, W += H;
  const oe = Z(Number(e.curveZoom) || 1, 0.1, 50), C = (W + K) / 2 + (Number(e.curvePanY) || 0), R = (W - K) / oe;
  K = C - R / 2, W = C + R / 2;
  const V = (E) => p + (E - S) / Math.max(1e-6, g - S) * h, X = (E) => f + u * (W - E) / Math.max(1e-6, W - K);
  if (n.fillStyle = "#111114", n.fillRect(0, 0, a, o), n.strokeStyle = "#222228", n.lineWidth = 1, n.font = "9px system-ui, -apple-system, sans-serif", n.fillStyle = "#6e727a", ld(n, {
    left: p,
    right: m,
    top: f,
    width: a,
    ...
    xFor: V,
    frame: e.frame
  }), dd(n, { left: p, right: m, top: f, width: a, graphHeight: u, minimum: K, maximum: W, yFor: X }), K <= 0 && W >= 0) {
    const E = X(0);
  ...
  for (const E of l) {
    ...
    let G = !1;
    k.forEach((F) => {
      const Y = V(F.frame), Q = X(E.get(F.value));
      Y >= p - 50 && Y <= a - m + 50 && (G ? n.lineTo(Y, Q) : (n.moveTo(Y, Q), G = !0));
    }), n.stroke();
    for (const F of c) {
      const Y = i ? F.transform : F.camera, Q = V(F.frame), le = X(E.get(Y)), se = F.frame === e.selectedKeyFrame || e.selectedKeyFrames?.has(F.frame);
      se && (n.fillStyle = "rgba(242, 208, 107, 0.35)", n.beginPath(), n.arc(Q, le, 8.5, 0, Math.PI * 2), n.fill()), n.fillStyle = se ? "#ffd75e" : E.color, n.strokeStyle = "#0d0d10", n.lineWidth = 1.6, n.beginPath(), n.arc(Q, le, se ? 5.2 : 3.8, 0, Math.PI * 2), n.fill(), n.stroke(), e.curveHitPoints.push({
        x: Q,
        y: le,
        key: F,
        channel: E,
    ...
    if (e.showCurveHandles)
      for (let F = 0; F < c.length; F++) {
        const Y = c[F], Q = Y.frame === e.selectedKeyFrame || e.selectedKeyFrames?.has(Y.frame);
        if (!(Q || e.curveChannelFilter !== "all" || c.length <= 4) || Y.interpolation !== "bezier") continue;
        const se = i ? Y.transform || i : Y.camera || Y, re = V(Y.frame), de = X(E.get(se)), be = c[F - 1], fe = c[F + 1], ge = Math.max(1, Y.frame - (be?.frame ?? Y.frame - 1)), ye = Math.max(1, (fe?.frame ?? Y.frame + 1) - Y.frame), pe = pi(
          Y,
          E.id,
          be,
          fe,
          (L) => E.get(i ? L.transform || i : L.camera || Y)
        ), Me = (W - K) / Math.max(1, u), ve = h * ye / Math.max(1, x), xe = h * ge / Math.max(1, x), ue = [];
        (be || F > 0) && ue.push({ side: "in", x: re + pe.in_x * xe, y: de - pe.in_y / Me }), (fe || F < c.length - 1 || c.length === 1) && ue.push({ side: "out", x: re + pe.out_x * ve, y: de - pe.out_y / Me });
        for (const L of ue) {
          if (n.strokeStyle = E.color, n.lineWidth = Q ? 1.5 : 1, n.beginPath(), n.moveTo(re, de), n.lineTo(L.x, L.y), n.stroke(), n.fillStyle = Q ? "#2a2233" : "#171720", n.strokeStyle = Q ? "#ffd75e" : E.color, n.lineWidth = Q ? 2 : 1.2, n.beginPath(), L.side === "in")
            n.arc(L.x, L.y, Q ? 5 : 3.8, 0, Math.PI * 2);
          else {
            const U = Q ? 4.5 : 3.2;
          ...
          n.fill(), n.stroke(), e.curveHitPoints.push({
            ...
            object: i,
            handle: L.side,
            pixelPerSegment: L.side === "in" ? xe : ve,
            valuePerPixel: Me,
            startHandles: { ...pe }
          });
        }
  ...
  if (e.curveBoxSelect) {
    const E = Math.min(e.curveBoxSelect.startX, e.curveBoxSelect.currentX), G = Math.min(e.curveBoxSelect.startY, e.curveBoxSelect.currentY), F = Math.abs(e.curveBoxSelect.currentX - e.curveBoxSelect.startX), Y = Math.abs(e.curveBoxSelect.currentY - e.curveBoxSelect.startY);
    n.fillStyle = "rgba(56, 189, 248, 0.15)", n.fillRect(E, G, F, Y), n.strokeStyle = "#38bdf8", n.lineWidth = 1, n.setLineDash([4, 4]), n.strokeRect(E, G, F, Y), n.setLineDash([]);
  }
  const N = V(e.frame);
  if (N >= p && N <= a - m && (n.strokeStyle = "#a78bfa", n.lineWidth = 1.5, n.beginPath(), n.moveTo(N, f), n.lineTo(N, f + u), n.stroke(), n.fillStyle = "#a78bfa", n.beginPath(), n.moveTo(N - 4, f), n.lineTo(N + 4, f), n.lineTo(N, f + 6), n.closePath(), n.fill()), e.curveDrag || e.curveHover) {
    let E = "", G = "";
    if (e.curveDrag)
      if (e.curveDrag.handle) {
        const F = e.curveDrag.handle === "in" ? "In" : "Out";
        E = `F${e.curveDrag.key.frame} · ${e.curveDrag.channel.name} (${F})`, G = "Tangent edit";
      } else if (e.curveDrag.group && e.curveDrag.group.length > 1) {
        const F = e.curveDrag.key.frame - e.curveDrag.startFrame, Y = e.curveDrag.channel.get(e.curveDrag.object ? e.curveDrag.key.transform : e.curveDrag.key.camera), Q = Y - e.curveDrag.startValue, le = F >= 0 ? `+${F}` : `${F}`, se = Q >= 0 ? `+${Q.toFixed(2)}` : `${Q.toFixed(2)}`;
        E = `${e.curveDrag.group.length} keys · ΔF: ${le} · ΔVal: ${se}`, G = `${e.curveDrag.channel.name}: ${Y.toFixed(2)}`;
      } else {
        const F = e.curveDrag.key.frame - e.curveDrag.startFrame, Y = e.curveDrag.channel.get(e.curveDrag.object ? e.curveDrag.key.transform : e.curveDrag.key.camera), Q = Y - e.curveDrag.startValue, le = F >= 0 ? `+${F}` : `${F}`, se = Q >= 0 ? `+${Q.toFixed(2)}` : `${Q.toFixed(2)}`;
        E = `F${e.curveDrag.key.frame} (${le}) · ${e.curveDrag.channel.name}: ${Y.toFixed(2)} (${se})`;
      }
    else if (e.curveHover)
      if (e.curveHover.channelName) {
        const F = Number.isFinite(e.curveHover.value) ? e.curveHover.value.toFixed(2) : "";
        E = `F${e.curveHover.frame} · ${e.curveHover.channelName}: ${F}`, e.curveHover.isHandle && (G = `Handle ${e.curveHover.handleSide}`);
      } else
        E = `Frame ${e.curveHover.frame}`;
    if (E) {
      n.save(), n.font = "11px system-ui, -apple-system, sans-serif";
      const F = n.measureText(E), Y = G ? n.measureText(G) : { width: 0 }, Q = Math.max(F.width, Y.width) + 16, le = G ? 32 : 20, se = a - m - Q - 6, re = f + 6;
      n.fillStyle = "rgba(18, 18, 24, 0.88)", n.strokeStyle = "#38384a", n.lineWidth = 1, n.beginPath(), n.roundRect ? n.roundRect(se, re, Q, le, 4) : n.rect(se, re, Q, le), n.fill(), n.stroke(), n.fillStyle = "#e2e8f0", n.fillText(E, se + 8, re + (G ? 13 : 14)), G && (n.fillStyle = "#94a3b8", n.font = "9.5px system-ui, -apple-system, sans-serif", n.fillText(G, se + 8, re + 26)), n.restore();
    }
  }
...
function an(e, { filter: t, label: a, color: o, title: r }) {
...
function bs(e) {
  ...
  if (!t) return;
  const a = e.timelineObject(), o = a ? a.name || a.type : e.activeCameraTrack().name, r = Sd(e), n = `${o}\0${r.map((c) => `${c.id}:${c.color}`).join("|")}`;
  if (t.dataset.signature !== n) {
    t.dataset.signature = n, t.replaceChildren();
    const c = document.createElement("span");
    c.className = "oc-graph-legend-title", c.textContent = o, t.appendChild(c), t.appendChild(an(e, {
      filter: "all",
      label: s("All"),
      color: null,
...
function on(e, t, a) {
  ...
  for (const n of [...e].sort((i, c) => i.frame - c.frame)) {
    ...
    (r === null || !(Math.abs(c - r) <= jd)) && o.push(n.frame), r = c;
  }
  return o;
}
function Ir(e) {
  ...
  const a = e.timelineKeyframes() || [], o = !!e.timelineObject(), r = e.selectedKeyFrames || (e.selectedKeyFrame === null ? /* @__PURE__ */ new Set() : /* @__PURE__ */ new Set([e.selectedKeyFrame])), n = mt(e), i = [
    e.state.duration_frames,
    Number(e.timelineZoom) || 1,
    Number(e.timelinePan) || 0,
    ...n.map((c) => `${c.id}:${on(a, c, o).join(",")}`)
  ].join("\0");
...
const rn = ["#4aa3ef", "#f2a93b", "#48c774", "#b565d8", "#ec4899"];
function gs(e, t) {
  const a = e.state.cameras.findIndex((r) => r.id === t), o = a >= 0 ? e.state.cameras[a] : null;
  return { camera: o, color: o?.color || rn[Math.max(0, a) % rn.length] };
}
function jt(e) {
...
function _d(e) {
  e.checkpoint("Auto-split shots"), e.state.sequence = {
    ...
    enabled: !0,
    cuts: ui(e.state)
  }, jt(e), e.setStatus(s("Split into {count} shots").replace("{count}", String(e.state.sequence.cuts.length)));
}
...
function Cd(e, t) {
  ...
  if (a.appendChild(fo(
    ...
    () => {
      e.checkpoint("Split shot"), Wn(e.state, e.frame, null) ? jt(e) : e.setStatus(s("Move the playhead inside a shot first"));
    },
    { disabled: o }
  )), a.appendChild(fo(
    s("Clear edit"),
    ...
    () => {
      e.checkpoint("Clear edit"), e.state.sequence = { ...e.state.sequence, enabled: !1, cuts: [] }, jt(e), e.setStatus(s("Multi-camera edit cleared"));
    }
  ))), a.appendChild(fo(
...
function Ad(e, t, a, o, r) {
  t.preventDefault(), t.stopPropagation();
  const { camera: n } = gs(e, a.camera_id);
  e.contextMenu?.show(t, n?.name || s("Shot"), [
    ...e.state.cameras.map((i) => ({
      ...
      run: () => {
        e.checkpoint("Change shot camera"), e.state.sequence.cuts[o].camera_id = i.id, jt(e);
      }
    })),
    null,
    {
      ...
      run: () => {
        e.checkpoint("Split shot"), Wn(e.state, e.frame, null) && jt(e);
      }
    },
    {
      label: s("Remove shot"),
      ...
      disabled: r === 1,
      run: () => {
        e.checkpoint("Remove shot"), fi(e.state, o) && jt(e);
      }
    }
  ]);
}
function Td(e, t, a, o) {
  const { camera: r, color: n } = gs(e, t.camera_id), i = document.createElement("div");
  ...
  if (c.className = "oc-sequence-name", c.textContent = r?.name || t.camera_id, i.appendChild(c), a > 0) {
    ...
    l.className = "oc-sequence-handle", l.title = s("Drag to trim the cut"), l.addEventListener("pointerdown", (p) => Ed(e, p, l, o, a)), i.appendChild(l);
  }
  return i.addEventListener("contextmenu", (l) => Ad(e, l, t, a, o.__cutCount)), i.addEventListener("pointerdown", () => {
...
function vs(e, t) {
  ...
  if (n.className = "oc-sequence-lane", n.dataset.role = "sequence-lane", n.setAttribute("aria-label", s("Multi-camera edit")), o.length)
    for (const [c, l] of o.entries()) {
      ...
      he(e, l.end + 1) < -5 || p > 105 || n.appendChild(Td(e, l, c, r));
    }
  else {
    const c = document.createElement("span");
  ...
  r.appendChild(n), r.appendChild($d(e));
  const i = document.createElement("span");
  i.className = "oc-sequence-playhead", i.style.left = `${he(e, e.frame)}%`, r.appendChild(i), t.appendChild(r);
}
const Md = ['[data-act="curve-zoom-in"]', '[data-act="curve-zoom-out"]', '[data-act="curve-fit"]', '[data-act="curve-handles"]'], nn = { curves: "Graph", dope: "Timeline", sequence: "Sequence" };
function sn(e, t) {
  const a = t in nn ? t : "curves";
  e.graphTab = a;
  ...
  a === "dope" ? Ir(e) : a === "sequence" ? (vs(e, n), n?.focus?.({ preventScroll: !0 })) : e.drawCurveEditor(), e.setStatus(s(nn[a]));
}
function Id(e) {
  e.graphTab === "sequence" && vs(e, e.root.querySelector('[data-role="graph-sequence"]'));
}
function Od(e, t) {
  ...
  a && a.addEventListener("keydown", (o) => {
    if (o.key === "ArrowLeft" || o.key === "ArrowRight") {
      ...
      if (n >= 0 && r.length > 1) {
        ...
        r[i].focus(), sn(e, r[i].dataset.graphTab);
      }
    }
  }, { signal: t });
  for (const o of e.root.querySelectorAll("[data-graph-tab]"))
    o.addEventListener("click", (r) => {
      r.preventDefault(), r.stopPropagation(), sn(e, o.dataset.graphTab);
    }, { signal: t });
}
const Pd = /* @__PURE__ */ new Set(["good", "warning", "bad", "unknown"]);
function xs(e, t) {
  ...
  for (const n of r.frames) {
    ...
    const c = Pd.has(n?.state) ? n.state : "unknown", l = n?.score;
    let p = null;
    if (l != null) {
      const m = Number(l);
...
function zd(e) {
  ...
  if (!t || !a) return;
  const o = xs(e.state?.metadata, e.state?.duration_frames), r = o.some((c) => c.state !== "unknown");
  ...
  if (cn.has(a)) return;
  cn.add(a), a.addEventListener("pointerdown", (c) => {
...
function Nd(e) {
  ...
  if (!t) return;
  t.innerHTML = "";
  const a = e.timelineObject(), o = e.timelineKeyframes(), r = Math.max(1, e.state.duration_frames - 1), n = Z(Number(e.timelineZoom) || 1, 0.1, 50), i = Number(e.timelinePan) || 0, c = r / n, l = i;
  if (e.audioWaveformPeaks && e.audioWaveformPeaks.length) {
    ...
    const S = x.getContext("2d"), g = e.audioWaveformPeaks, k = x.width, _ = x.height, O = _ / 2;
    S.fillStyle = "#f2d06b";
    for (let P = 0; P < g.length; P++) {
      const W = (P / (g.length - 1) * r - l) / Math.max(1e-6, c) * k;
      if (W >= -5 && W <= k + 5) {
        const H = g[P] * (_ * 0.85);
        S.fillRect(W, O - H / 2, Math.max(1, k / g.length * n - 0.5), H);
      }
    }
    t.appendChild(x);
  }
  ...
  for (const x of o) {
    ...
    k.className = "key-label", k.textContent = String(x.frame), g.appendChild(k), g.addEventListener("pointerdown", (_) => {
      ...
      e.keyDrag = { key: x, box: t, historyCheckpointed: !1, moving: O.map((P) => ({ key: P, startFrame: P.frame })), startPointerFrame: x.frame, startClientX: _.clientX, startClientY: _.clientY }, e.setFrame(x.frame, !1, !1);
  ...
  y && (y.textContent = m.name), hs(e), ds(e), bs(e), Ir(e), Id(e), e.refreshCameraSelectors(), e.refreshKeyEditor(), e.updateEditState(), e.drawCurveEditor(), e.perf && (e.perf.timelineRefreshCount = (e.perf.timelineRefreshCount || 0) + 1), zd(e);
}
class ws {
...
async function Or(e, { route: t, field: a = "file", file: o }) {
...
const Wd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/><path d="M2 12h20"/></svg>', Vd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m21 16-9 5-9-5V8l9-5 9 5v8z"/><path d="m3.27 6.96 8.73 4.84 8.73-4.84"/><path d="M12 22V12"/></svg>', Hd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2L2 20h20L12 2z"/><path d="M12 2v18"/></svg>', Gd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/><path d="m17.66 17.66 1.41 1.41"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="m6.34 17.66-1.41 1.41"/><path d="m19.07 4.93-1.41 1.41"/></svg>', Yd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18h6"/><path d="M10 22h4"/><path d="M15.09 14c.18-.98.65-1.74 1.41-2.5A4.65 4.65 0 0 0 18 8 6 6 0 0 0 6 8c0 1 .23 2.23 1.5 3.5.76.76 1.23 1.52 1.41 2.5"/></svg>', Xd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l8 8-4 4-8-8 4-4z"/><path d="M7 11L2 16l6 6 5-5"/><path d="M18 19l4 2"/><path d="M21 16l2 2"/></svg>', Jd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m22 8-6 4 6 4V8z"/><rect width="14" height="12" x="2" y="6" rx="2"/></svg>', Zd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14h6v6H4z"/><circle cx="17" cy="7" r="3"/><path d="m6 3 4 7H2z"/></svg>';
function Qd() {
  return `
...
const Qe = 1, ln = 50, Ie = 120, ut = 160, jm = Object.freeze(["perspective", "orthographic"]), q = Object.freeze({
...
}), js = Object.freeze(Object.values(q)), we = Object.freeze({
  SCENE_GET: "scene.get",
...
}), _m = Object.freeze(Object.values(we));
...
const Cm = 25, dn = 100;
function bt(e, t) {
  const a = e?.offset === void 0 ? 0 : Number(e.offset), o = e?.limit === void 0 ? Cm : Number(e.limit);
  if (!Number.isInteger(a) || a < 0)
    throw new I(
      "BAD_QUERY",
      "offset must be a non-negative integer"
    );
  if (!Number.isInteger(o) || o < 1 || o > dn)
    throw new I(
      "BAD_QUERY",
      `limit must be between 1 and ${dn}`
    );
  return {
    offset: a,
    limit: o,
...
function Tm(e, t) {
  ...
  switch (t?.type) {
    ...
    case we.CAMERA_GET: {
      ...
      return Se(e, { version: 1, type: t.type, camera: Xe(r) });
    }
    case we.CAMERA_LIST: {
    ...
    case we.HEALTH_GET:
      return Se(e, {
        version: 1,
        type: t.type,
        frames: xs(a.metadata, a.duration_frames)
      });
    case we.ASSET_LIST: {
      ...
      return Se(e, { version: 1, type: t.type, items: Xe(r), total: r.length });
    }
    case we.ASSET_GET: {
...
function Mm(e, t) {
  e.cameras ||= [];
  const a = new Set(e.cameras.map((i) => i.id)), o = Ro(a, "camera", t.id), r = { ...Sr(), ...t.camera || {} }, n = {
    id: o,
    name: t.name || o,
    color: "#4aa3ef",
    locked: !1,
...
function Im(e, t) {
  ...
  const o = new Set(e.cameras.map((i) => i.id)), r = Ro(o, "camera", t.id), n = JSON.parse(JSON.stringify(a));
...
function zm(e, t) {
  if (!_s.has(t.objectType))
    throw new I("UNSUPPORTED_OBJECT_TYPE", `object.create does not support type: ${t.objectType}`);
  e.objects ||= [];
  const a = new Set(e.objects.map((i) => i.id)), o = Ro(a, t.objectType, t.id), r = $m(t.objectType), n = {
    id: o,
    type: t.objectType,
    name: t.name || o,
    ...r,
...
function Nm(e, t) {
  ...
  const o = new Set(e.objects.map((l) => l.id)), r = Ro(o, a.type || "object", t.id), n = Array.isArray(t.offset) ? t.offset : [0.35, 0, 0.35], i = JSON.parse(JSON.stringify(a));
...
function Wm(e, t) {
  ...
  for (a.has(t) && a.delete(t), a.add(t); a.size > Um; )
...
function Gm(e, t) {
  ...
  if (e.position !== void 0 && Ae(e.position, "camera.position", t), e.target !== void 0 && Ae(e.target, "camera.target", t), e.up !== void 0 && Ae(e.up, "camera.up", t), e.fov !== void 0 && (Rt(e.fov, "camera.fov", t), e.fov < 1 || e.fov > 179))
    throw new I("BAD_VALUE", "camera.fov must be within 1..179", t);
  if (e.roll !== void 0 && Rt(e.roll, "camera.roll", t), e.zoom !== void 0 && (Rt(e.zoom, "camera.zoom", t), e.zoom <= 0))
    throw new I("BAD_VALUE", "camera.zoom must be > 0", t);
  if (e.near !== void 0 && (Rt(e.near, "camera.near", t), e.near <= 0))
    throw new I("BAD_VALUE", "camera.near must be > 0", t);
  if (e.far !== void 0) {
    Rt(e.far, "camera.far", t);
    const a = e.near === void 0 ? gi : e.near;
    if (e.far <= a)
      throw new I("BAD_VALUE", "camera.far must be greater than camera.near", t);
  }
  if (e.camera_type !== void 0 && !jm.includes(e.camera_type))
...
function Ym(e, t) {
  ...
  switch (a) {
    ...
    case q.CAMERA_CREATE:
      ...
      if (e.interpolation !== void 0 && !jo.includes(e.interpolation))
    ...
    case q.OBJECT_CREATE:
      if (ae(e.objectType, "objectType", t), !_s.has(e.objectType))
    ...
    case q.CHARACTER_SET_JOINT_ROTATION:
      if (ae(e.objectId, "objectId", t), ae(e.joint, "joint", t), !Array.isArray(e.rotation) || e.rotation.length !== 4 || !e.rotation.every(it))
    ...
    case q.KEYFRAME_UPSERT:
      if (e.cameraId !== void 0 && ae(e.cameraId, "cameraId", t), Be(e.frame, "frame", t), e.interpolation !== void 0 && !jo.includes(e.interpolation))
        throw new I("BAD_INTERPOLATION", `Unsupported interpolation: ${e.interpolation}`, t);
      if (e.camera !== void 0) {
    ...
    case q.KEYFRAME_SET_INTERPOLATION:
      if (e.cameraId !== void 0 && ae(e.cameraId, "cameraId", t), Be(e.frame, "frame", t), !jo.includes(e.interpolation))
        throw new I("BAD_INTERPOLATION", `Unsupported interpolation: ${e.interpolation}`, t);
      break;
...
function Xm(e, t) {
  ...
  if (t.operations.length > ln)
    throw new I(
      "TOO_MANY_OPERATIONS",
      `transaction has ${t.operations.length} operations (max ${ln})`
    );
  return t.operations.forEach((a, o) => Ym(a, o)), {
    version: Qe,
    id: t.id,
...
const Zm = "omnicam/library", Qm = "majoor_omnicam/blockout_library", ep = Object.freeze({
...
function Cs(e) {
  return e.file ? `${e.source === "legacy" ? Qm : Zm}/${e.file} [input]` : "";
}
function mn(e, t, a) {
  const o = e || "asset";
  let r = `${o}_${a}`, n = 2;
...
function op(e, t = {}) {
  ...
  const a = tp(t.point, [0, 0, 0]), o = String(t.idSeed || Date.now().toString(36)), r = String(e.kind || "prop"), n = r === "character", i = ep[e.id];
  ...
  return n && (c.character = ap(e)), c;
}
function rp({ groundHit: e, orbitTarget: t } = {}) {
...
const np = {
  [q.ASSET_INSTANTIATE](e, t) {
    ...
    let o;
    try {
      o = op(t.asset, { point: t.point, idSeed: t.id, existingIds: a });
    } catch (r) {
  ...
  [q.CAMERA_SET_ACTIVE](e, t) {
    return cr(e, t.cameraId), e.active_camera_id = t.cameraId, { dirtyMask: T.viewport | T.previews | T.inspector | T.outliner | T.timeline };
  },
  [q.CAMERA_SET_LOCKED](e, t) {
    return cr(e, t.cameraId).locked = t.value, { dirtyMask: T.outliner | T.inspector | T.viewport };
  },
  [q.CAMERA_CREATE](e, t) {
    const a = Mm(e, t);
  ...
  [q.CAMERA_TRANSFORM](e, t) {
    const a = yt(e, t.cameraId), o = pn(a);
  ...
  [q.CAMERA_LOOK_AT](e, t) {
    ...
    if (t.objectId !== void 0 && (t.objectId === null || t.objectId === "" ? (a.target_object_id = null, a.id === e.active_camera_id && (e.target_object_id = null)) : (lr(e, t.objectId), a.target_object_id = t.objectId, a.id === e.active_camera_id && (e.target_object_id = t.objectId))), t.point) {
      const o = pn(a);
      o.target = [...t.point];
  ...
  [q.OBJECT_SET_ENABLED](e, t) {
    return st(e, t.objectId).enabled = t.value, { dirtyMask: T.viewport | T.previews | T.outliner | T.inspector };
  },
  [q.OBJECT_SET_LOCKED](e, t) {
    return lr(e, t.objectId).locked = t.value, { dirtyMask: T.outliner | T.inspector };
  },
  [q.OBJECT_SET_TAGS](e, t) {
    const a = st(e, t.objectId), o = xi(t.tags), r = o.length !== t.tags.length ? "some tags were dropped or normalised" : void 0;
    return o.length ? a.tags = o : delete a.tags, { dirtyMask: T.outliner | T.inspector | T.viewport, warning: r };
  },
  [q.OBJECT_SET_ANNOTATION](e, t) {
    const a = st(e, t.objectId), o = t.annotation === null ? null : Vn(t.annotation);
    if (t.annotation && !o)
  ...
  [q.CHARACTER_SET_POSE](e, t) {
    ...
    return a.character = {
      ...a.character || {},
      pose: t.pose === null ? Ao(null) : Ao(t.pose)
  ...
  [q.CHARACTER_SET_JOINT_ROTATION](e, t) {
    ...
    return a.character = {
      ...a.character || {},
      pose: vi(a.character?.pose, t.joint, t.rotation)
    }, { dirtyMask: T.viewport | T.previews | T.inspector };
  },
  [q.CHARACTER_SET_MOTION](e, t) {
    const a = ho(e, t.objectId), o = jr(t.motion);
  ...
  [q.KEYFRAME_SET_INTERPOLATION](e, t) {
    ...
    if (!jo.includes(t.interpolation))
...
function sp({ state: e, operation: t }) {
  const a = np[t.type];
...
function dr(e, t) {
  ...
  if (Array.isArray(e) || Array.isArray(t))
    return !Array.isArray(e) || !Array.isArray(t) || e.length !== t.length ? !1 : e.every((a, o) => dr(a, t[o]));
  if (e && t && typeof e == "object") {
    const a = /* @__PURE__ */ new Set([...Object.keys(e), ...Object.keys(t)]);
    for (const o of a) if (!dr(e[o], t[o])) return !1;
    return !0;
  }
  return !1;
}
...
function cp(e, t) {
  ...
  return dp(e, t, r), pp(e, t, r), hp(e, t, r), fp(e, t, r), up(e, t, r), bp(e, t, r), { changes: a, truncated: o };
}
const lp = ["fov", "roll", "zoom", "near", "far", "camera_type"];
function dp(e, t, a) {
...
const mp = ["position", "target", "fov", "roll", "zoom", "near", "far", "camera_type"];
function pp(e, t, a) {
  const o = et(e?.cameras), r = et(t?.cameras);
  for (const [n, i] of r) {
...
function kp(e, t) {
  ...
  try {
    ...
    if (f instanceof I) return Xo(e, t?.id, f);
    throw f;
  }
  const o = mr(e);
  ...
  for (let f = 0; f < a.operations.length; f += 1)
    try {
      const d = sp({ ui: e, state: r, operation: a.operations[f] });
      n |= d?.dirtyMask || 0, d?.warning && i.push(d.warning), d?.outcome && c.push({ index: f, ...d.outcome });
    } catch (d) {
      if (d instanceof I)
        return (d.operationIndex === null || d.operationIndex === void 0) && (d.operationIndex = f), Xo(e, a.id, d);
      throw d;
    }
  if (a.validateOnly) {
  ...
  e.checkpoint?.(a.description), e.state = _r(r);
  const l = yp(e);
  Wm(e, a.id), e.serialize?.(), vp(e, l), wp(e, n, `director-api:${a.id}`);
  const p = {
    ok: !0,
    version: Qe,
    baseRevision: o,
...
function jp(e) {
  return e.directorApi = Sp(e), e.directorApi;
}
const fn = "omnicam-agent/1", hn = "majoor.omnicam.agent.request", _p = 1, Dt = Object.freeze({
...
}), Cp = 1e4, Ep = 5e3, Es = "asset.instantiate_by_id", As = "asset.catalog_search", un = Object.freeze([
  ...js.filter((e) => e !== q.ASSET_INSTANTIATE),
  Es
]);
function pr(e) {
...
async function $p(e, t) {
  ...
  const o = (a.state?.items || []).filter((r) => !pr(r)).slice(0, 20).map((r) => ({
    id: r.id,
    name: r.name,
    kind: r.kind,
    tags: [...r.tags || []],
...
function Mp(e, t, a) {
  ...
  async function d() {
    ...
    try {
      const k = await Kt(a, Dt.register, {
        protocol: fn,
        client_id: g,
        node_id: String(t.id),
      ...
      if (o || S !== p) return;
      r = k.session_id, n = k.session_token, i = g, u();
    } catch {
      if (o || S !== p) return;
      h();
    }
  ...
  async function v(S) {
    const g = S?.detail;
    if (o || !g || g.protocol !== fn || Number(g.schema_version) !== _p || g.session_id !== r || String(g.node_id) !== String(t.id)) return;
    let k;
    try {
      if (g.kind === "query")
        k = g.payload?.type === As ? await $p(e, g.payload) : e.directorApi.query(g.payload);
      else if (g.kind === "transaction") {
        const _ = g.payload, O = (_?.operations || []).find(
          (P) => !un.includes(P?.type)
        );
        if (!Number.isInteger(_?.baseRevision) || _.baseRevision < 0)
          ...
          k = Bt(
            ...
            `External Agent transactions cannot use operation: ${O?.type}`
          );
        else {
          const P = await Tp(e, _.operations);
          P.ok ? (k = e.directorApi.execute({ ..._, operations: P.operations }), await k?._reconciliation) : k = Bt(e, P.code, P.message);
        }
      } else
        k = Bt(e, "UNKNOWN_AGENT_REQUEST", `Unsupported Agent request kind: ${g.kind}`);
    } catch (_) {
      k = Bt(e, _?.code || "INTERNAL", _?.message || "OmniCam Agent request failed");
    }
    try {
      await Kt(a, Dt.reply, {
        session_id: r,
  ...
  return a.addEventListener?.(hn, v), a.addEventListener?.("status", x), d(), {
    get sessionId() {
      return r;
    },
    dispose() {
      if (o) return;
      o = !0, clearInterval(c), clearTimeout(l), a.removeEventListener?.(hn, v), a.removeEventListener?.("status", x);
      const S = r, g = n;
      r = null, n = null, S && g && Kt(a, Dt.close, {
        session_id: S,
        session_token: g
      }).catch(() => {
      });
...
function Pr({ fetchApi: e = Ip } = {}) {
  const t = (a, o) => Promise.resolve(e(a, o)).then(Op);
  return {
    list(a = {}) {
      const { kind: o, tag: r, search: n, offset: i, limit: c } = a, l = { tag: r, search: n, offset: i, limit: c };
      return o && o !== "all" && (l.kind = o), t(`${Le}${bn(l)}`);
    },
    get(a) {
    ...
    importModel(a, o = {}) {
      const r = new FormData();
      return r.append("file", a, o.filename || a.name || "model.glb"), t(`${Le}/import${bn(o)}`, { method: "POST", body: r });
    },
...
function Lp(e) {
  ...
  return {
    ...
    setFilter(i) {
      return a.filter = gn({ ...a.filter, ...i }), a.offset = 0, this.refresh();
    },
    refresh() {
      return n(async () => {
...
const Fp = 256;
function yn(e = {}) {
  const { THREE: t, GLTFLoader: a, FBXLoader: o, size: r = Fp } = e;
  if (!t || !a)
...
function Up(e, { selected: t = !1, thumbUrl: a = "" } = {}) {
  const o = Kp[e.kind] || "pi-box", r = e.kind === "character" && Hn(e.rig) === "rigged" ? `<span class="oc-asset-badge">${s("RIGGED")}</span>` : "", n = a ? `<img class="oc-asset-thumb" src="${St(a)}" alt="" loading="lazy">` : `<span class="oc-asset-thumb oc-asset-thumb--glyph"><i class="pi ${o}"></i></span>`;
...
function Wp(e, { selectedId: t = "", thumbUrls: a = {} } = {}) {
  return !e || !e.length ? `<p class="oc-asset-empty">${s("No assets match this filter.")}</p>` : e.map((o) => Up(o, {
    selected: o.id === t,
    thumbUrl: a[o.id] || ""
  })).join("");
}
...
function Vp(e, t = {}) {
  const a = e.root, o = t.fetchApi || ((L, U) => (e.api || e.app?.api).fetchApi(L, U)), r = t.apiClient || Pr({ fetchApi: o }), n = t.store || Lp(r), i = zp(), c = t.previewQueue || Np(), l = e.api || e.app?.api || null;
  let p = t.thumbnailRenderer || null, m = null;
  const f = /* @__PURE__ */ new Set();
  function d() {
    return p ? Promise.resolve(p) : (m || (m = Rp().then((L) => p = yn(L)).catch(() => p = yn({}))), m);
  }
  function h(L) {
    return Hr(l, Cs(L));
  }
  function u(L) {
    return L.thumbnail ? Hr(l, `omnicam/library/${L.thumbnail} [input]`) : "";
  }
  function b() {
    for (const L of n.state.items) {
      ...
      U && c.enqueue(L.id, async () => {
        const je = await (await d()).render(U, L.format || "glb");
        if (!je) {
          f.add(L.id);
          return;
        }
        if (i.set(L.id, je), Y(), !(L.source && L.source !== "user"))
          try {
            const Oe = await r.uploadThumbnail(L.id, Dp(je));
  ...
  const v = (L) => a.querySelector(`[data-role="${L}"]`), y = v("assets-panel"), x = v("asset-grid"), S = v("asset-kinds"), g = v("asset-search"), k = v("asset-status"), _ = v("asset-import-file"), O = v("scene-tab"), P = v("assets-tab"), K = v("agent-tab"), W = a.querySelector('[data-asset-view="agent"]'), H = { assets: P, agent: K };
  let oe = "", C = null, R = !0, V = !0, X = "scene", N = 0;
  function E(L, { sticky: U = !1 } = {}) {
  ...
  let F = !1;
  function Y() {
    if (S && (S.innerHTML = qp(n.state.filter.kind, n.state.kinds)), x) {
      const L = {};
      for (const U of n.state.items) {
        const me = i.get(U.id) || u(U);
        me && (L[U.id] = me);
      }
      x.innerHTML = Wp(n.state.items, { selectedId: oe, thumbUrls: L });
    }
    if (!F) {
      F = !0;
      try {
  ...
  function Q(L) {
    ...
    const je = me.outcomes?.[0]?.objectId;
    je && (e.selectedEntity = "object", e.selectedObjectId = je, e.selectedObjectIds = /* @__PURE__ */ new Set([je]), e.selectedKeyFrame = null), e.restoreAssets?.(), e.refreshObjects?.(), e.refreshInspector?.(), e.render?.(), e.setStatus?.(s("{name} added").replace("{name}", L.name));
  }
  async function le(L) {
    if (L) {
      E(s("Importing {name}...").replace("{name}", L.name));
      try {
        const U = await r.importModel(L, { kind: "prop", name: L.name.replace(/\.[^.]+$/, "") });
        U.asset && n.upsert(U.asset), E(s("Imported {name}").replace("{name}", U.asset?.name || L.name));
      } catch (U) {
        E(U.message || s("Import failed"));
      }
    }
  }
  ...
  async function fe(L) {
    ...
    N = 0, E(L ? s("Scanning {folder}...").replace("{folder}", U) : s("Installing characters from {folder}...").replace("{folder}", U));
    try {
      const me = await r.importLocalCharacters({
        folder: U,
        licenseNote: (de?.value || "").trim(),
        dryRun: L
      }), je = (me.skipped || []).length;
      if (L) {
        const Pe = (me.candidates || []).map((ot) => ot.name).join(", ");
        E(
          (me.candidates || []).length ? s("{n} rig-complete character(s): {names}").replace("{n}", me.candidates.length).replace("{names}", Pe) : s("No rig-complete .glb/.fbx character found ({n} skipped)").replace("{n}", je),
          { sticky: !0 }
        );
        return;
      }
      const Oe = (me.installed || []).filter((Pe) => Pe.status !== "conflict").length, Re = (me.installed || []).filter((Pe) => Pe.status === "conflict").length;
      E(
        s("{n} character(s) installed{extra} — no restart needed").replace("{n}", Oe).replace("{extra}", je || Re ? ` (${je} ${s("skipped")}${Re ? `, ${Re} ${s("unchanged")}` : ""})` : ""),
        { sticky: !0 }
  ...
  function ge(L) {
    L === "agent" && !or() && (L = "scene"), X = L, O && (O.hidden = L !== "scene");
    ...
    L === "assets" && R && (R = !1, n.refresh()), L === "agent" && V && (V = !1, t.onAgentFirstOpen?.());
  }
  function ye() {
    const L = or();
    W && (W.hidden = !L), !L && X === "agent" && ge("scene");
  }
  function pe(L) {
    const U = vn(L.target);
    if (U) {
      if (U.action === "switch-view") return ge(U.view);
      if (U.action === "filter-kind") return void n.setFilter({ kind: U.kind });
      if (U.action === "asset-add")
        return Q(n.get(oe));
      if (U.action === "asset-import")
        return _?.click();
      if (U.action === "local-toggle") return be();
      if (U.action === "local-scan") return void fe(!0);
      if (U.action === "local-install") return void fe(!1);
      U.action === "card" && G(U.assetId);
    }
  }
  function Me(L) {
    const U = vn(L.target);
    U?.action === "card" && Q(n.get(U.assetId));
  }
  function ve() {
    clearTimeout(C), C = setTimeout(() => n.setFilter({ search: g.value }), 200);
  }
  function xe(L) {
    const U = L.target.files?.[0];
    L.target.value = "", le(U);
  }
  const ue = n.subscribe(Y);
  return y?.addEventListener("click", pe), y?.addEventListener("dblclick", Me), a.querySelector('[data-role="left-tabs"]')?.addEventListener("click", pe), g?.addEventListener("input", ve), _?.addEventListener("change", xe), Y(), ye(), {
    store: n,
    switchView: ge,
    syncAgentAvailability: ye,
    refresh: () => n.refresh(),
    dispose() {
      ue(), clearTimeout(C), y?.removeEventListener("click", pe), y?.removeEventListener("dblclick", Me), a.querySelector('[data-role="left-tabs"]')?.removeEventListener("click", pe), g?.removeEventListener("input", ve), _?.removeEventListener("change", xe), c.clear(), p?.dispose?.(), i.clear();
    }
  };
}
function Hp(e, t = {}) {
  ...
  const r = [];
  let n = rr(e.state?.metadata?.viewport_labels);
  function i(m) {
    if (!r[m]) {
  ...
  function l() {
    ...
    let b = 0;
    for (const v of u) {
      if (!Gn(v, { mode: n.mode, selectedIds: d })) continue;
      const y = Yn(v, n.content);
      if (!y) continue;
      const x = Xn(u, v, h) || {
        position: v.position,
        size: v.size
      }, S = e.webgl.projectWorldToScreen(Jn(x, v.type));
  ...
  function p(m) {
    n = rr({ ...n, ...m }), e.state.metadata = { ...e.state.metadata || {}, viewport_labels: { ...n } }, e.serialize?.(), l();
  }
  return l(), {
    update: l,
    get settings() {
...
function Gp(e) {
  ...
  return {
    ...
    getRigInfo(a) {
      const o = e.state?.objects?.find((i) => i.id === a) || null, r = t(a), n = nr(r);
      return {
        objectId: a,
...
function Yp(e, t) {
  const a = (o) => [`<option value="">${s("— unmapped —")}</option>`].concat(
    e.map(
      (r) => `<option value="${xn(r)}"${r === o ? " selected" : ""}>${xn(r)}</option>`
    )
  ).join("");
  return Zn.map((o) => {
...
function Xp(e, t = {}) {
  const a = e.root, o = t.apiClient || Pr({
  ...
  function f() {
    if (!i) return;
    const y = Gr(l);
    Vo(l) ? (i.textContent = s("Humanoid v1 ✓ — all 22 joints mapped"), i.dataset.state = "ok") : (i.textContent = s("Incomplete — {n} joint(s) unmapped").replace("{n}", y.length), i.dataset.state = "warn");
  }
  function d() {
    n && (n.innerHTML = Yp(m(), l)), f();
  }
  function h() {
  ...
  function b(y) {
    ...
    x === "auto" ? (l = nr(m()), d()) : x === "validate" ? (d(), e.setStatus?.(Vo(l) ? s("Rig is complete") : s("Rig still missing: {list}").replace("{list}", Gr(l).join(", ")))) : x === "save" && v();
  }
  async function v() {
    const y = p();
    if (!y?.asset_id) {
    ...
    try {
      const x = await o.patch(y.asset_id, {
        rig: { profile: Yr, bone_map: l }
      });
      y.character = {
        ...y.character || {},
        rig_profile: Vo(l) ? Yr : null
...
function Qp(e, t = {}) {
  ...
  const h = () => e.state?.objects?.find((C) => C.id === m) || null, u = () => e.rigMapper?.boneMap && Object.keys(e.rigMapper.boneMap).length ? e.rigMapper.boneMap : null, b = () => e.subSelection?.type === "character_joint" && e.subSelection.objectId === m ? e.subSelection.jointId : null;
  function v(C) {
    const R = Ao({ ...C, preset_id: C.id });
    return { id: C.id, name: C.name || C.id, root_offset: R.root_offset, joints: R.joints };
  }
  function y(C) {
    const R = d.get(C?.pose?.preset_id) || null;
    return ki({ preset: R, overrides: C?.pose }).joints;
  }
  function x() {
    const C = h();
    !C?.character || !u() || e.webgl?.applyCharacterPose?.(m, u(), f || C.character.pose?.joints ? y(C.character) : {});
  }
  function S() {
    const C = b(), R = f && !!C;
    if (c && (c.hidden = !R), !R) return;
    l && (l.textContent = C);
    const V = h(), X = y(V?.character)[C] || [0, 0, 0, 1], N = Si(X);
    p.forEach((E, G) => {
      E && document.activeElement !== E && (E.value = String(Math.round(N[G] * 100) / 100));
    });
  }
  function g() {
    ...
    if (i && (i.classList.toggle("active", f), i.disabled = R, i.title = R ? s("Clear the motion clip to edit the pose") : s("Toggle FK pose editing")), n) {
      ...
      n.dataset.sig !== X && (n.dataset.sig = X, n.replaceChildren(...V.map(([N, E]) => {
        const G = document.createElement("option");
        return G.value = N, G.textContent = E, G;
  ...
  function _() {
    const C = b();
    if (!C) return;
    const R = p.map((N) => Number(N?.value) || 0), V = wi(R), X = e.directorApi?.execute({
      version: 1,
      id: `tx_pose_${Date.now().toString(36)}`,
      description: "Pose joint",
      operations: [{ type: "character.set_joint_rotation", objectId: m, joint: C, rotation: V }]
    });
    X && !X.ok && e.setStatus?.(X.error?.message || s("Could not set the joint")), g();
  }
  function O() {
    const C = n?.value || "neutral", R = d.get(C) || Ao({ preset_id: C });
  ...
  async function P() {
    ...
    const R = (await Yt(e, s("Save Pose"), s("Pose name"), ""))?.trim();
    if (!R || e.disposed) return;
    const V = R.toLowerCase().replace(Zp, "-").replace(/^-+|-+$/g, "").slice(0, 60) || "pose";
    try {
      ...
      d.set(X.pose.id, v(X.pose)), e.setStatus?.(s("Pose saved: {name}").replace("{name}", R)), g();
    } catch (X) {
  ...
  function K() {
    const C = h();
    !C?.character || C.character.motion || (f = !f, !f && e.subSelection?.type === "character_joint" && (e.subSelection = null), g(), e.rigOverlay?.update?.());
  }
  function W(C) {
    f && (e.subSelection = { type: "character_joint", objectId: m, jointId: C }, g(), e.rigOverlay?.update?.());
  }
  const H = Jp(e, {
    onPick: W,
  ...
  function oe() {
    ...
    C.id !== m && (m = C.id, f = !1, e.subSelection?.type === "character_joint" && (e.subSelection = null), d.size || k()), g(), H.update();
  }
  n?.addEventListener("change", O), i?.addEventListener("click", K), r.querySelector('[data-pose-act="save"]')?.addEventListener("click", P);
  for (const C of p)
  ...
  return k(), {
    ...
    dispose() {
      H.dispose(), n?.removeEventListener("change", O), i?.removeEventListener("click", K);
      for (const C of p)
  ...
  function u() {
    ...
    if (o) {
      ...
      o.dataset.sig !== k && (o.dataset.sig = k, o.replaceChildren(
        wn("", x.length ? s("No motion (static)") : s("No clips in this model")),
        ...x.map((_) => wn(_, _))
      )), document.activeElement !== o && (o.value = S?.clip_id || ""), o.disabled = !x.length;
    }
    Jo(r, S?.start_frame ?? 0), Jo(n, S?.end_frame ?? 0), Jo(i, S?.speed ?? 1), c && document.activeElement !== c && (c.checked = S ? S.loop !== !1 : !0);
    const g = !!S;
...
const tf = /* @__PURE__ */ new Set(["translate", "rotate", "scale"]), af = /* @__PURE__ */ new Set(["world", "local"]), Ue = 180 / Math.PI;
function kn(e) {
  return [e.x, e.y, e.z];
}
function of(e) {
...
function rf({
  ...
  const m = p ? p() : new e.Object3D(), f = l ? l(t, a) : new Vl(t, a);
  let d = null;
  o?.add && (d = typeof f.getHelper == "function" ? f.getHelper() : f, o.add(d), o.add(m));
  let h = null, u = null, b = !1;
  function v() {
    return {
      position: kn(m.position),
      rotationDeg: of(m.rotation),
      scale: kn(m.scale)
    };
  }
  function y(N) {
  ...
  function x(N) {
    return u ? {
      position: N.position.map((E, G) => E - u.position[G]),
      rotationDeg: N.rotationDeg.map((E, G) => E - u.rotationDeg[G]),
      scaleFactors: N.scale.map((E, G) => u.scale[G] === 0 ? 1 : E / u.scale[G])
  ...
  function O(N) {
    ...
    const E = N.rotation || [0, 0, 0];
    m.rotation.set(E[0] / Ue, E[1] / Ue, E[2] / Ue), m.scale.set(...N.scale || [1, 1, 1]), f.attach(m), f.visible = !0;
  }
  function P() {
  ...
  function W(N) {
    if (!tf.has(N)) throw new Error(`createTransformControlsAdapter: unknown mode "${N}"`);
    f.setMode ? f.setMode(N) : f.mode = N;
  }
  function H(N) {
    if (!af.has(N)) throw new Error(`createTransformControlsAdapter: unknown space "${N}"`);
    f.space = N;
  }
  function oe(N) {
  ...
  function X() {
    f.removeEventListener?.("mouseDown", S), f.removeEventListener?.("objectChange", g), f.removeEventListener?.("mouseUp", k), f.removeEventListener?.("dragging-changed", _), o?.remove && d && o.remove(d), o?.remove && o.remove(m), f.dispose?.(), h = null, u = null;
  }
  return {
    attach: O,
    detach: P,
...
function sf(e, { controlsFactory: t, anchorFactory: a } = {}) {
  let o = null, r = null;
  function n() {
    return o || (!e.webgl || !e.interactionElement ? null : (o = rf({
      THREE: Wl,
  ...
  function i({ targetSpec: k }) {
    if (k) {
      if (k.type === "object") {
        ...
        const _ = _i(e), O = (_.length ? _ : [k.object]).map((K) => ({
          object: K,
          transform: He(K)
        }));
        for (const K of O) e.beginObjectEdit(K.object);
        const P = O.reduce((K, W) => Ce(K, W.transform.position), [0, 0, 0]).map((K) => K / O.length);
        r = { type: "object", group: O, pivot: P };
        return;
      }
      if (k.type === "camera") {
      ...
      if (k.type === "camera_target") {
        ...
        const _ = e.activeCameraTrack?.(), O = !!_?.target_object_id;
        r = {
          type: "camera_target",
          tracking: O,
          base: O ? [..._.target_offset || [0, 0, 0]] : [...e.camera.target]
        };
        return;
      }
      if (k.type === "camera_path") {
        ...
        e.checkpoint("Transform camera path"), r = {
          type: "camera_path",
          trackId: _.id,
          origin: Qn(_.keyframes),
          baseKeys: _.keyframes.map((O) => ({ ...O, camera: ce(O.camera) }))
        };
        return;
      }
  ...
  function p(k) {
    const _ = e.state.cameras.find((O) => O.id === r.trackId);
    _ && (_.keyframes = ts(r.baseKeys, c(k)), l(_));
  }
  function m(k) {
    const _ = e.state.cameras.find((P) => P.id === r.trackId);
    if (!_) return;
    const O = { ...c(k), lookAtActive: r.lookAtActive };
    _.keyframes = Ei(r.baseKeys, r.selectedFrames, O), l(_);
  }
  function f(k) {
    const _ = e.state.cameras.find((O) => O.id === r.trackId);
    _ && (_.keyframes = Ai(r.baseKeys, [r.frame], { delta: k.position }), l(_));
  }
  function d({ delta: k }) {
    r && (r.type === "object" ? h(k) : r.type === "camera" ? u(k) : r.type === "camera_target" ? b(k) : r.type === "camera_path" ? p(k) : r.type === "path_point" || r.type === "path_group" ? m(k) : r.type === "path_point_target" && f(k), e.render());
  }
  function h(k) {
    const { group: _, pivot: O } = r, P = e.state.gizmo_mode;
    for (const K of _)
      if (P === "translate")
        K.object.position = Ce(K.transform.position, k.position);
      else if (P === "rotate")
        K.object.position = Ce(O, Xr(Ut(K.transform.position, O), k.rotationDeg)), K.object.rotation = Ce(K.transform.rotation, k.rotationDeg);
      else if (P === "scale") {
        const W = Ut(K.transform.position, O);
        K.object.position = Ce(O, W.map((H, oe) => H * k.scaleFactors[oe])), K.object.size = K.transform.size.map((H, oe) => Math.max(0.01, H * k.scaleFactors[oe]));
      }
    for (const K of _) e.commitObjectEdit(K.object);
  }
  function u(k) {
    if (e.state.gizmo_mode === "translate")
      e.camera.position = Ce(r.position, k.position);
    else {
      const _ = Ut(r.target, r.position);
      e.camera.target = Ce(r.position, Xr(_, k.rotationDeg));
    }
    e.commitCameraEdit();
  }
  function b(k) {
    const _ = Ce(r.base, k.position);
    r.tracking ? Ci(e, _) : e.camera.target = _, e.commitCameraEdit();
  }
  ...
  function y() {
    ...
    const k = e.recording ? null : ji(e), _ = e.state.gizmo_mode || "translate";
    if (!(!!k && !k.readOnly && nf.has(k.type) && k.allowedModes.includes(_))) {
      o?.detach();
      return;
    }
...
function cf(e, t) {
  ...
  const a = e.activeCameraTrack(), o = Yl(t, {
...
function lf(e, t) {
  ...
  const o = Gl(a, { type: t, intensity: 1, duration_frames: e.state.duration_frames });
...
const Sn = ["#4aa3ef", "#f2a93b", "#48c774", "#b565d8", "#ec4899"], Je = [4, 8, 12, 20, 35, 60, 100];
function Et(e) {
...
function Do(e, t, a) {
  ...
  const o = Et(e), r = o.expanded ? 220 : 138, n = Math.min(r, Math.max(80, Math.min(t, a) - 20)), i = 10, c = Math.max(0, t - n - i), l = Math.max(0, a - n - i), p = e.viewportCamera(), m = p?.position || [0, 1.5, 5], f = p?.target || [0, 0, 0], d = e.activeCameraTrack?.(), h = e.state.cameras?.length ? e.state.cameras : d ? [d] : [], u = h.flatMap(
  ...
  if (o.rangeIndex >= 0 && o.rangeIndex < Je.length)
    ...
    const k = Math.max(
      ...
      Math.abs(f[0] || 0),
      Math.abs(f[2] || 0),
      ...u.flatMap((_) => [Math.abs(_[0] || 0), Math.abs(_[2] || 0)]),
      4
    );
    b = Math.max(6, Math.ceil((k + 1.5) / 4) * 4);
  }
...
function hf(e, t, a, o) {
  const r = Do(e, a, o);
  if (!r) return;
  const { rx: n, ry: i, radarSize: c, cx: l, cy: p, innerRadius: m, range: f, scale: d, camPos: h, camTgt: u, cameras: b, activeTrack: v } = r, y = Et(e), x = e.state.active_camera_id || v?.id, S = (re, de) => Ms(r, re, de);
  ...
  for (const re of e.state.objects || []) {
    ...
    const de = Cr(e.state.objects, re).position || [0, 0, 0], [be, fe] = S(de[0], de[2]);
    if (be < n + 3 || be > n + c - 3 || fe < i + 3 || fe > i + c - 3) continue;
    const ge = e.selectedObjectId === re.id || e.selectedObjectIds?.has?.(re.id);
    if (t.save(), t.translate(be, fe), re.type === "card") {
      const ye = (re.rotation?.[1] || 0) * Math.PI / 180;
      ...
      t.fillStyle = ge ? "#a855f7" : re.type === "human" ? "#ec4899" : "#f59e0b", t.beginPath(), t.arc(0, 0, 2.8, 0, Math.PI * 2), t.fill();
  ...
  for (let re = 0; re < b.length; re++) {
    const de = b[re], be = de.keyframes || [], fe = de.id === x, ge = de.color || Sn[re % Sn.length];
    t.save(), t.strokeStyle = ge, t.globalAlpha = fe ? 0.95 : 0.4, t.lineWidth = fe ? 2 : 1, t.setLineDash(fe ? [] : [2, 2]), t.beginPath();
    let ye = !1;
    const pe = be[0]?.frame, Me = be[be.length - 1]?.frame;
    for (let ve = pe; Number.isFinite(ve) && ve <= Me; ve++) {
      const xe = $e(de, ve, e.state.objects)?.position;
      if (!Array.isArray(xe)) continue;
      const [ue, L] = S(xe[0], xe[2]);
      ye ? t.lineTo(ue, L) : (t.moveTo(ue, L), ye = !0);
    }
    ...
    for (const ve of be) {
      ...
      if (!xe) continue;
      const [ue, L] = S(xe[0], xe[2]);
      if (ue < n + 4 || ue > n + c - 4 || L < i + 4 || L > i + c - 4) continue;
      const U = ve.frame === e.frame && fe;
      t.fillStyle = U ? "#ffffff" : ge, t.globalAlpha = fe ? 0.95 : 0.6, t.beginPath(), t.moveTo(ue, L - 3), t.lineTo(ue + 3, L), t.lineTo(ue, L + 3), t.lineTo(ue - 3, L), t.closePath(), t.fill(), U && (t.strokeStyle = "#00d2d3", t.lineWidth = 1.2, t.stroke());
    }
    t.restore();
  }
  const [_, O] = S(h[0] || 0, h[2] || 0), [P, K] = S(u[0] || 0, u[2] || 0), W = 8, H = Z(_, n + W, n + c - W), oe = Z(O, i + W, i + c - W), C = Z(P, n + W, n + c - W), R = Z(K, i + W, i + c - W), V = h[1] || 0, X = pf(V), N = ff(V);
  t.strokeStyle = "rgba(255, 255, 255, 0.40)", t.lineWidth = 1, t.setLineDash([3, 3]), t.beginPath(), t.moveTo(H, oe), t.lineTo(C, R), t.stroke(), t.setLineDash([]), t.fillStyle = "#ffffff", t.beginPath(), t.arc(C, R, 2.5, 0, Math.PI * 2), t.fill(), t.strokeStyle = "rgba(255, 255, 255, 0.7)", t.lineWidth = 1, t.beginPath(), t.arc(C, R, 4.5, 0, Math.PI * 2), t.stroke();
  const E = u[0] - h[0], G = u[2] - h[2], F = Math.atan2(G, E), Q = (e.viewportCamera().fov || 35) * Math.PI / 360, le = Z(24 * (d / (m / 8)), 16, 38), se = t.createRadialGradient(H, oe, 2, H, oe, le);
  se.addColorStop(0, X + "55"), se.addColorStop(1, X + "08"), t.fillStyle = se, t.strokeStyle = X, t.lineWidth = 1.2, t.beginPath(), t.moveTo(H, oe), t.lineTo(H + Math.cos(F - Q) * le, oe + Math.sin(F - Q) * le), t.arc(H, oe, le, F - Q, F + Q), t.closePath(), t.fill(), t.stroke(), t.fillStyle = X + "44", t.beginPath(), t.arc(H, oe, 6.5, 0, Math.PI * 2), t.fill(), t.fillStyle = X, t.beginPath(), t.arc(H, oe, 3.5, 0, Math.PI * 2), t.fill(), t.strokeStyle = "#ffffff", t.lineWidth = 1.5, t.beginPath(), t.moveTo(H, oe), t.lineTo(H + Math.cos(F) * 7, oe + Math.sin(F) * 7), t.stroke(), uf(e, t, r, X, N, F, Math.hypot(E, G)), y.hover && bf(t, r, y.hover), t.restore();
}
function uf(e, t, a, o, r, n, i) {
  const { rx: c, ry: l, radarSize: p } = a, m = Et(e);
  ...
  const u = m.expanded ? "⤡" : "⤢";
  bo(t, c + 96, f, 14, d, u, m.hover?.button === "size"), t.font = "bold 8.5px monospace", t.fillStyle = o, t.textAlign = "right", t.fillText(`Y:${r}`, c + p - 5, l + 9), t.fillStyle = "rgba(15, 23, 42, 0.70)", t.fillRect(c, l + p - 15, p, 15), t.strokeStyle = "rgba(0, 210, 211, 0.15)", t.beginPath(), t.moveTo(c, l + p - 15), t.lineTo(c + p, l + p - 15), t.stroke();
...
function bf(e, t, a) {
  ...
  const i = e.measureText(a.text).width + 12, c = 16, l = Z(a.px - i / 2, o + 4, o + n - i - 4), p = a.pz > t.cy ? a.pz - 22 : a.pz + 8;
...
function Os(e, t, a, o) {
  const { camPos: r, camTgt: n, cameras: i, rx: c, ry: l, radarSize: p } = t, m = (v, y) => Ms(t, v, y), [f, d] = m(r[0] || 0, r[2] || 0);
  ...
  for (const v of e.state.objects || []) {
    ...
    const y = Cr(e.state.objects, v).position || [0, 0, 0], [x, S] = m(y[0], y[2]);
...
function gf(e, t, a, o) {
  ...
  const r = Do(e, e.canvas.width, e.canvas.height);
  if (!r) return !1;
  const { rx: n, ry: i, radarSize: c } = r;
  if (a < n || a > n + c || o < i || o > i + c)
    return !1;
  t.preventDefault?.(), t.stopPropagation?.();
  const l = Et(e), p = Is(r, a, o);
  if (p)
...
function yf(e, t, a, o) {
  ...
  const r = Do(e, e.canvas.width, e.canvas.height);
  if (!r) return !1;
  const n = Et(e), { rx: i, ry: c, radarSize: l } = r, p = a >= i && a <= i + l && o >= c && o <= c + l;
  if (n.drag) {
    const [b, v] = fr(r, a, o), y = e.viewportCamera();
  ...
  const m = Is(r, a, o), f = Os(e, r, a, o), [d, h] = fr(r, a, o);
...
function vf(e, t, a, o) {
  ...
  if (a < n || a > n + c || o < i || o > i + c)
    return !1;
  t.preventDefault?.(), t.stopPropagation?.();
  const l = Et(e), p = Math.sign(t.deltaY || 0);
...
function xf(e, t, a) {
  ...
  const o = () => {
    ...
    const h = $i(t('[data-role="object-tags"]')?.value || "");
    h.length ? d.tags = h : delete d.tags;
    const u = String(t('[data-role="object-annotation"]')?.value || "").trim(), b = u ? Vn({
      text: u,
  ...
  }, { signal: a }), nd(e, a), Od(e, a), t('[data-role="curve-group"]')?.addEventListener("change", () => {
    e.setChannelFilter("all"), bs(e), e.drawCurveEditor(), Ir(e);
  ...
  e.root.addEventListener("pointerdown", (d) => {
    ...
    const h = e.interactionElement.getBoundingClientRect(), u = (d.clientX - h.left) * e.canvas.width / Math.max(1, h.width), b = (d.clientY - h.top) * e.canvas.height / Math.max(1, h.height);
    vf(e, d, u, b) || e.onWheel(d);
  }, { passive: !1, signal: a }), e.root.addEventListener("wheel", Kl(e.root), { signal: a }), window.addEventListener("pointermove", (d) => {
  ...
  l && (l.addEventListener("pointerdown", (d) => e.onTimelinePointerDown(d), { signal: a }), l.addEventListener("pointermove", (d) => e.onTimelinePointerMove(d), { signal: a }), l.addEventListener("pointerup", (d) => e.onTimelinePointerUp(d), { signal: a }), l.addEventListener("pointercancel", (d) => e.onTimelinePointerUp(d), { signal: a }), l.addEventListener("wheel", (d) => Un(e, d), { passive: !1, signal: a }));
  const p = (d) => {
    const h = Mi(d.composedPath?.()[0] || d.target);
    h && (e.lastKeyZone = h);
  };
  e.root.addEventListener("focusin", p, { signal: a }), e.root.addEventListener("pointerdown", p, { capture: !0, signal: a }), e.root.addEventListener("focusout", (d) => {
    e.modalTransform && !e.root.contains(d.relatedTarget) && (Ti(e), e.render());
  }, { signal: a });
...
function kf(e, t) {
  Er.find((o) => o.id === e)?.onChange?.(t);
}
function Sf(e) {
  const t = kc(e.id, e.defaultValue), a = `pref_${e.id.replace(/[^a-zA-Z0-9]/g, "_")}`;
  if (e.type === "boolean")
    return `
...
function jf(e) {
  const t = new Map(Er.map((o) => [o.id, o]));
  return ({
    nav: [
      fc,
      hc,
...
function _f() {
  return `<span class="oc-pref-emoji" aria-hidden="true">${wf}</span> ${s("OmniCam Preferences")}`;
}
function Cf(e) {
  ...
  a.className = "oc-modal-backdrop", a.setAttribute("role", "dialog"), a.setAttribute("aria-modal", "true"), a.setAttribute("aria-label", s("OmniCam Preferences")), a.innerHTML = `
    <div class="oc-modal-dialog oc-pref-dialog" tabindex="-1">
      <div class="oc-pref-header">
        <div class="oc-pref-title">${_f()}</div>
...
const Af = ["position", "target"], Tf = ["fov", "zoom"], $f = ["roll"], Mf = ["position", "size"], If = ["rotation"];
function hr(e) {
...
function Cn(e, t, a, o) {
  const r = hr(Number(a || 0) - Number(e || 0)), n = Number(e || 0) + r * o;
  if (t == null) return n;
  const i = hr(Number(t || 0) - n);
  return n + i / 3;
}
function En(e, t, a) {
  ...
  for (let r = 1; r < a.length - 1; r++) {
    ...
    if (i.camera) {
      for (const m of Af) {
        ...
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const u = _n(f, d, h, p);
          a[r].camera[m] = En(d.map(Number), u, o);
        }
      }
      for (const m of Tf) {
        const f = n.camera?.[m], d = i.camera?.[m], h = c.camera?.[m];
    ...
    if (Array.isArray(i.position) && Array.isArray(n.position) && Array.isArray(c.position)) {
      for (const m of Mf) {
        ...
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const u = _n(f, d, h, p);
          a[r][m] = En(d.map(Number), u, o);
        }
      }
      for (const m of If) {
        const f = n[m], d = i[m], h = c[m];
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const u = [0, 1, 2].map((b) => Cn(f[b], d[b], h[b], p));
          a[r][m] = d.map((b, v) => An(Number(b), u[v], o));
        }
      }
    }
  }
...
function Df(e, t) {
  ...
  const o = (r) => {
    ...
    const u = (v) => {
      ...
      let x = Nf;
      v.shiftKey ? x = Ff : (v.ctrlKey || v.metaKey) && (x = Rf);
      const S = p * x * 20;
      let g = l + y * S;
...
function qf(e, t) {
  for (const o of e.root.querySelectorAll('[data-act="toggle-camera-lock"]'))
    o.addEventListener("click", (r) => {
      r.stopPropagation(), e.checkpoint?.("Toggle camera lock"), e.state.camera_lock = !e.state.camera_lock, e.serialize?.(), Ps(e), e.setStatus?.(e.state.camera_lock ? s("Camera View locked") : s("Camera View unlocked"));
    }, { signal: t });
  ...
  for (const o of e.root.querySelectorAll('[data-act="toggle-gizmo-space"]'))
    o.addEventListener("click", (r) => {
      ...
      e.serialize?.(), Ne(e), e.requestRender?.(), e.setStatus?.(s("Transform space: {space}").replace("{space}", e.state.gizmo_space));
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-spatial-snap"]'))
    o.addEventListener("click", (r) => {
      ...
      e.serialize?.(), Ne(e), e.setStatus?.(s("Snapping: {mode}").replace("{mode}", e.state.spatial_snap_mode));
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-grid-overlay"]'))
    o.addEventListener("click", (r) => {
      r.stopPropagation(), e.checkpoint?.("Toggle grid overlay"), e.state.show_grid = e.state.show_grid === !1, e.serialize?.(), Ne(e), e.requestRender?.();
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-wireframe-overlay"]'))
    o.addEventListener("click", (r) => {
      ...
      e.serialize?.(), Ne(e), e.requestRender?.(), e.setStatus?.(e.state.show_wireframe ? s("Wireframe overlay: On") : s("Wireframe overlay: Off"));
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-cull-overlay"]'))
    o.addEventListener("click", (r) => {
      ...
      e.serialize?.(), Ne(e), e.webgl && (e.webgl.sceneKey = ""), e.requestRender?.(), e.setStatus?.(e.state.backface_culling ? s("Backface culling: On (Single-Sided)") : s("Backface culling: Off (Double-Sided)"));
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-gizmo-overlay"]'))
    o.addEventListener("click", (r) => {
      r.stopPropagation(), e.checkpoint?.("Toggle gizmo overlay"), e.state.show_gizmo = e.state.show_gizmo === !1, e.serialize?.(), Ne(e), e.requestRender?.();
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-guides-overlay"]'))
    o.addEventListener("click", (r) => {
      r.stopPropagation(), e.checkpoint?.("Toggle guides overlay"), e.state.guides = e.state.guides === !1, e.serialize?.(), Ne(e), e.requestRender?.();
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-safe-areas-overlay"]'))
    o.addEventListener("click", (r) => {
      r.stopPropagation(), e.checkpoint?.("Toggle safe areas overlay"), e.state.safe_areas = !e.state.safe_areas, e.serialize?.(), Ne(e), e.requestRender?.();
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-radar-overlay"]'))
    o.addEventListener("click", (r) => {
      r.stopPropagation(), e.checkpoint?.("Toggle radar overlay"), e.state.show_radar = !e.state.show_radar, e.serialize?.(), Ne(e), e.requestRender?.();
    }, { signal: t });
...
function Uf(e, t) {
  ...
  !a || !o || (r && r.addEventListener("change", () => {
    ...
    document.activeElement !== a && (a.value = $r(o.value));
  }, { signal: t }));
}
function Wf(e, t) {
  ...
  }, n = (i) => (e.smoothingBaseline?.cameraId !== i.id && (e.smoothingBaseline = { cameraId: i.id, keys: zf(i.keyframes) }), e.smoothingBaseline.keys);
  a.addEventListener("input", r, { signal: t }), a.addEventListener("change", () => {
    const i = e.activeCameraTrack();
    if (!i) return;
    e.checkpoint("Path smoothing");
    const c = Number(a.value) / 100, l = Lf(n(i), c);
  ...
  if (a.length) {
    ...
    for (const o of a)
      o.addEventListener("change", () => {
        e.dopeChannels = new Set(a.filter((r) => r.checked).map((r) => r.dataset.dopeChannel)), ds(e);
      }, { signal: t });
  }
}
function Yf(e, t) {
...
const go = () => import("./chunk-B3T-mxe9.js");
function Jf(e, t) {
...
function Zf(e, t) {
  ...
  Sc().then((r) => {
    ...
    c === "health-slow" ? _c(e) : c === "health-smooth" ? Cc(e) : c === "health-recenter" && Ec(e);
  }, { signal: t });
  for (const r of e.root.querySelectorAll('[data-tab="health"]'))
    r.addEventListener("click", () => Ho(e), { signal: t });
}
function Qf(e, t) {
...
function ah(e, t) {
  Jf(e, t), Uf(e, t), Wf(e, t), Vf(e, t), Hf(e, t), Qf(e, t), th(e, t), eh(e, t), Df(e, t), Kf(e, t), Gf(e, t), Xf(e, t), qf(e, t), Yf(e, t), Zf(e, t);
}
const Tn = {
...
}, Ls = "balanced", Qo = "#121212";
function Lr(e) {
  return Tn[e] || Tn[Ls];
}
function oh(e, t = "#1b1f2b", a = "#151822", o = "#1e2330", r = "#161922", n = "#111319") {
...
function Pg(e, t, a = Ls) {
  const o = Lr(a), r = new e.Group();
  ...
  const h = new e.FogExp2(1250588, 8e-3), u = oh(e), b = new e.PMREMGenerator(t);
  b.compileEquirectangularShader();
  const v = new Hl(), y = b.fromScene(v, 0.04).texture;
  return v.traverse((x) => {
    x.geometry?.dispose?.();
...
function zg(e, t, a, o, r) {
  o.group.visible = r, t.environment = r ? o.environment : null, t.background = r ? o.sky : new e.Color(1184274), t.fog = r ? o.fog : null, a.toneMapping = r ? e.ACESFilmicToneMapping : e.NoToneMapping, a.toneMappingExposure = r ? Lr(o.quality).toneExposure : 1, t.traverse((n) => {
...
function nh(e) {
  ...
  const r = e.reconstruction, n = r.provider || "Reconstructed", i = Math.round(t * 100), c = hl(e), l = c.length ? `
` + c.map(([m, f]) => `${m}: ${f}`).join(`
`) : "", p = `${n} • ${o} (${i}%)${l}`;
  return {
    label: o,
...
function Ng(e, t, a) {
  return e?.reconstruction ? a ? "neutral" : sh(t) === "source_texture" ? "textured" : "neutral" : null;
}
function ih(e, t) {
...
function ch(e, t, a) {
  ...
  if (o) {
    const n = (i) => {
      const c = i.target.closest?.("[data-axis], [data-axis-center]") || i.target, l = c.getAttribute("data-axis"), p = Ac(l?.toLowerCase(), e.state.view_mode);
  ...
  for (const n of e.root.querySelectorAll('[data-role="camera-type"]'))
    n.addEventListener("change", (i) => {
      e.camera.camera_type !== i.target.value && e.checkpoint("Change camera type"), e.camera.camera_type = i.target.value, _e(e.root, "camera-type", i.target), e.beginCameraEdit(), e.commitCameraEdit(), e.finishCameraEdit(), e.render();
    }, { signal: a });
  ...
  for (const n of e.root.querySelectorAll('[data-role="speed-heatmap"]'))
    n.addEventListener("change", (i) => {
      e.state.speed_heatmap !== i.target.checked && e.checkpoint("Toggle speed heatmap"), e.state.speed_heatmap = i.target.checked, _e(e.root, "speed-heatmap", i.target, "checked"), e.scheduleSerialize(), e.render();
    }, { signal: a });
  for (const n of e.root.querySelectorAll('[data-role="playblast-grid"]'))
    n.addEventListener("change", (i) => {
      e.state.playblast_grid !== i.target.checked && e.checkpoint("Toggle playblast grid"), e.state.playblast_grid = i.target.checked, _e(e.root, "playblast-grid", i.target, "checked"), e.scheduleSerialize(), e.render();
    }, { signal: a });
  for (const n of e.root.querySelectorAll('[data-role="playblast-labels"]'))
    n.addEventListener("change", (i) => {
      e.state.playblast_labels !== i.target.checked && e.checkpoint("Toggle playblast labels"), e.state.playblast_labels = i.target.checked, _e(e.root, "playblast-labels", i.target, "checked"), e.scheduleSerialize(), e.render();
    }, { signal: a });
  for (const n of e.root.querySelectorAll('[data-role="playblast-resolution"]'))
    n.addEventListener("change", (i) => {
      e.state.playblast_resolution !== i.target.value && e.checkpoint("Change playblast resolution"), e.state.playblast_resolution = i.target.value, _e(e.root, "playblast-resolution", i.target), e.scheduleSerialize();
    }, { signal: a });
  for (const n of e.root.querySelectorAll('[data-act="reset-bg-color"]'))
    n.addEventListener("click", () => {
      e.state.viewport_bg_color !== Qo && e.checkpoint("Reset background colour"), e.state.viewport_bg_color = Qo;
      for (const i of e.root.querySelectorAll('[data-role="viewport-bg-color"]')) i.value = Qo;
  ...
  for (const n of e.root.querySelectorAll('[data-role="show-grid"]'))
    n.addEventListener("change", (i) => {
      e.state.show_grid = i.target.checked, _e(e.root, "show-grid", i.target, "checked"), e.scheduleSerialize(), e.render();
    }, { signal: a });
  for (const [n, i] of [
    ...
    for (const c of e.root.querySelectorAll(`[data-role="${n}"]`))
      c.addEventListener("change", (l) => {
        e.state[i] !== l.target.checked && e.checkpoint("Toggle viewport helper"), e.state[i] = l.target.checked, _e(e.root, n, l.target, "checked"), e.scheduleSerialize(), e.render();
      }, { signal: a });
  ...
  for (const n of e.root.querySelectorAll('[data-role="show-wireframe"]'))
    n.addEventListener("change", (i) => {
      e.state.show_wireframe !== i.target.checked && e.checkpoint("Toggle wireframe"), e.state.show_wireframe = i.target.checked, _e(e.root, "show-wireframe", i.target, "checked"), e.scheduleSerialize(), e.webgl && (e.webgl.sceneKey = ""), e.render();
    }, { signal: a });
  for (const n of e.root.querySelectorAll('[data-role="show-vertices"]'))
    n.addEventListener("change", (i) => {
      e.state.show_vertices !== i.target.checked && e.checkpoint("Toggle vertices"), e.state.show_vertices = i.target.checked, _e(e.root, "show-vertices", i.target, "checked"), e.scheduleSerialize(), e.webgl && (e.webgl.sceneKey = ""), e.render();
    }, { signal: a });
  for (const n of e.root.querySelectorAll('[data-role="backface-culling"]'))
    n.addEventListener("change", (i) => {
      !!e.state.backface_culling !== i.target.checked && e.checkpoint("Toggle backface culling"), e.state.backface_culling = i.target.checked, _e(e.root, "backface-culling", i.target, "checked"), e.scheduleSerialize(), e.webgl && (e.webgl.sceneKey = ""), e.render(), e.setStatus(e.state.backface_culling ? s("Backface culling: On (Single-Sided)") : s("Backface culling: Off (Double-Sided)"));
    }, { signal: a });
  ...
  for (const n of e.root.querySelectorAll('[data-role="burn-in"]'))
    n.addEventListener("change", (i) => {
      e.state.burn_in !== i.target.checked && e.checkpoint("Toggle burn-in"), e.state.burn_in = i.target.checked, _e(e.root, "burn-in", i.target, "checked"), e.scheduleSerialize(), e.render();
    }, { signal: a });
  for (const n of e.root.querySelectorAll('[data-role="guides"]'))
    n.addEventListener("change", (i) => {
      e.state.guides !== i.target.checked && e.checkpoint("Toggle guides"), e.state.guides = i.target.checked, _e(e.root, "guides", i.target, "checked"), e.scheduleSerialize(), e.render();
    }, { signal: a });
  for (const n of e.root.querySelectorAll('[data-role="safe-areas"]'))
    n.addEventListener("change", (i) => {
      e.state.safe_areas !== i.target.checked && e.checkpoint("Toggle safe areas"), e.state.safe_areas = i.target.checked, _e(e.root, "safe-areas", i.target, "checked"), e.scheduleSerialize(), e.renderCameraView(), e.render();
    }, { signal: a });
  for (const n of e.root.querySelectorAll('[data-role="resolution-gate"]'))
    n.addEventListener("change", (i) => {
      e.state.resolution_gate !== i.target.checked && e.checkpoint("Toggle resolution gate"), e.state.resolution_gate = i.target.checked, _e(e.root, "resolution-gate", i.target, "checked"), e.scheduleSerialize(), e.renderCameraView(), e.render();
    }, { signal: a });
  for (const n of e.root.querySelectorAll('[data-role="aspect-ratio"]'))
    n.addEventListener("change", (i) => {
      e.state.aspect_ratio !== i.target.value && e.checkpoint("Change aspect ratio"), e.state.aspect_ratio = i.target.value, _e(e.root, "aspect-ratio", i.target), e.scheduleSerialize(), e.renderCameraView(), e.render();
    }, { signal: a });
  for (const n of e.root.querySelectorAll('[data-role="viewport-bg-color"]')) {
    const i = (c) => {
      e.state.viewport_bg_color !== c.target.value && yo(e, "viewport_bg_color", "Change background colour"), e.state.viewport_bg_color = c.target.value, _e(e.root, "viewport-bg-color", c.target), e.scheduleSerialize(), e.render();
    };
    n.addEventListener("input", i, { signal: a }), n.addEventListener("change", i, { signal: a });
  }
  ...
  for (const n of e.root.querySelectorAll("[data-lens]"))
    n.addEventListener("click", () => {
      ul(e, Number(n.dataset.lens));
    }, { signal: a });
  for (const n of e.root.querySelectorAll("[data-blocking-scene]"))
    n.addEventListener("click", () => {
      mf(e, n.dataset.blockingScene), e.closeMenus();
    }, { signal: a });
...
const lh = 32, dh = 0.025, mh = 0.05, $o = 1e-6, ph = ["top", "bottom", "front", "back", "left", "right"], fh = {
  top: "y",
  bottom: "y",
  front: "z",
  back: "z",
...
function hh(e) {
  let t = 0;
  for (let a = 1; a < e.length; a++) t += Nr(e[a - 1], e[a]);
  return t;
}
function $n(e) {
  const t = Math.max(0, Math.round(Number(e?.duration_frames) || 1) - 1), a = Array.isArray(e?.playback_range) ? e.playback_range : [0, t], o = ur(Math.round(Number(a[0]) || 0), 0, t), r = ur(Math.round(Number(a[1]) || t), 0, t);
  return o <= r ? [o, r] : [r, o];
}
function uh(e, t) {
  ...
  for (let i = 0; i < t; i++) {
    ...
    const l = a[n - 1], p = a[n], m = ur((c - l) / Math.max($o, p - l), 0, 1), f = e[n - 1], d = e[n];
    r.push([
      f[0] + (d[0] - f[0]) * m,
      f[1] + (d[1] - f[1]) * m,
      f[2] + (d[2] - f[2]) * m
...
function yh(e) {
  ...
  const n = Math.min(lh, r.length, o + 1);
  if (n < 2) return [];
  const i = uh(r, n);
  ...
  ], p = e.planeAxis === "y" ? zs(l) : Ns(l, [0, 0, -1]), m = e.seedPoint ? 1 : 0, f = [];
  for (let d = m; d < i.length; d++) {
    const h = i[d], u = bh(i, d, p, e.planeAxis), b = ce(c);
    b.position = [...h], b.target = gh(h, u, l, e.planeAxis), f.push({
...
function Mn(e, t = {}) {
  ...
  if (a === "extend") {
    ...
    const u = Math.max(0, Math.round(Number(e.state.duration_frames) || 1) - 1), [, b] = $n(e.state), v = d.length > 1 ? d[d.length - 1].frame - d[0].frame : 24;
    let y = Math.max(b, h.frame + Math.max(6, Math.min(v, 240)));
    y <= h.frame && (y = h.frame + 24), y > u && (l = y + 1), y > b && (p = y), c = [h.frame, y];
  } else
    ph.includes(e.state.view_mode) || e.setViewMode?.("top"), c = $n(e.state);
  const m = fh[e.state.view_mode] ?? null, f = n ? [...n] : [...r.position];
...
function Fr(e, t) {
  ...
  a.planeAxis && (o[Mo[a.planeAxis]] = a.anchor[Mo[a.planeAxis]]);
  const r = a.points.at(-1);
  return r && Nr(r, o) < dh ? !1 : (a.points.push(o), !0);
}
function We(e) {
  const t = e.cameraPathDraw;
  return t?.active ? (Fs(e, t), e.cameraPathDraw = null, Ht(e), e.setStatus?.(s("Draw Camera Path cancelled")), e.render?.(), !0) : !1;
}
function xh(e) {
  const t = e.cameraPathDraw;
  ...
  if (a.length < 2 || hh(a) < mh || t.range[1] <= t.range[0])
...
function Rr(e, t) {
  ...
  return r?.every(Number.isFinite) ? (a.planeAxis && (r[Mo[a.planeAxis]] = a.anchor[Mo[a.planeAxis]]), r) : null;
}
function kh(e, t) {
  const a = e.cameraPathDraw;
  return a?.active ? t.button === 2 && !t.altKey ? (Io(t), e.cameraPathSuppressContextMenuUntil = Date.now() + 1e3, We(e), !0) : t.button !== 0 || t.altKey || t.ctrlKey || t.metaKey || t.shiftKey ? !1 : (Io(t), e.closeMenus?.(), e.interactionElement.focus?.({ preventScroll: !0 }), e.interactionElement.setPointerCapture?.(t.pointerId), a.drawing = !0, a.pointerId = t.pointerId, a.points = [], Fr(e, Rr(e, t)), Ht(e), e.requestRender?.("camera-path-draw"), !0) : !1;
}
function Sh(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : (Io(t), Fr(e, Rr(e, t)) && e.requestRender?.("camera-path-draw"), !0);
}
function jh(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : (Io(t), t.type === "pointercancel" || t.type === "lostpointercapture" ? (We(e), !0) : (Fr(e, Rr(e, t)), a.drawing = !1, xh(e), !0));
}
function _h(e) {
  const t = e.cameraPathDraw;
...
function Ch(e, t) {
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? We(e) : Mn(e);
    }, { signal: t });
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path-extend"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? We(e) : Mn(e, { mode: "extend" });
    }, { signal: t });
...
const _o = "/majoor/omnicam/scenes";
function Rs(e) {
...
function Dr(e, t, { name: a = "", status: o } = {}) {
  const r = t && typeof t == "object" ? t : os(), n = { ...r, metadata: { ...r.metadata || {}, scene_name: a || "" } };
...
async function Eh(e) {
  await Xt(e, s("New Scene"), s("Start a new scene? Unsaved changes will be lost.")) && Dr(e, os(), { name: "", status: s("New scene") });
}
async function Ah(e) {
  if (!e.sceneBaseline) {
  ...
  Dr(e, a, { name: o, status: s("Scene reset to last save") });
}
async function Th(e) {
  const t = Rs(e) || s("Untitled"), a = await Yt(e, s("Save Scene"), s("Scene name"), t);
  if (a == null) return;
...
async function $h(e) {
  ...
  const a = await gl({
    ...
    items: t.map((r) => ({
      id: r.slug,
      label: r.name || r.slug,
      sublabel: Mh(r.modified)
    })),
    onDelete: (r) => Co(e, `${_o}/${encodeURIComponent(r)}`, { method: "DELETE" }).catch((n) => console.warn("[OmniCam] scene delete failed", n))
  });
  if (!(!a || !await Xt(e, s("Open Scene"), s("Open this scene? Unsaved changes will be lost."))))
    try {
      const r = await Co(e, `${_o}/${encodeURIComponent(a)}`);
      if (!r.ok) throw new Error(await r.text());
...
function Ih(e, t) {
  vo(e, t, e.root.querySelectorAll('[data-act="scene-new"]'), () => Eh(e)), vo(e, t, e.root.querySelectorAll('[data-act="scene-open"]'), () => $h(e)), vo(e, t, e.root.querySelectorAll('[data-act="scene-save"]'), () => Th(e)), vo(e, t, e.root.querySelectorAll('[data-act="scene-reset"]'), () => Ah(e));
}
const Oh = ["world_point", "object_point", "camera_field"], In = 40;
function Ph(e) {
  return (e.keys || []).map((t) => ({ x: t.x, y: t.y, t: t.time_seconds }));
}
function Lh(e, t, a) {
  const o = Math.max(1, Number(e.fps) || 24), r = e.width || 1280, n = e.height || 720, i = [];
  for (let c = 0; c <= In; c += 1) {
    const l = a * c / In, p = Ar(e, t.source, l * o, r, n);
...
function Nh(e) {
  ...
  if (!c) return;
  const l = Ds(t, e.state.width || 1280, e.state.height || 720), p = (v) => l.x + v * l.w, m = (v) => l.y + v * l.h;
  ...
  for (const v of e.state.motion_layers || []) {
    if (v.enabled === !1) continue;
    const y = Oh.includes(v.source_kind), x = y ? Lh(e.state, v, d) : Ph(v);
    ...
    if (c.strokeStyle = S ? "#ffcc4d" : "rgba(65,217,197,0.6)", c.lineWidth = (S ? 2.4 : 1.5) * r, c.beginPath(), x.forEach((k, _) => {
      const O = p(k.x), P = m(k.y);
      _ ? c.lineTo(O, P) : c.moveTo(O, P);
    }), c.stroke(), !y) {
...
function Fh(e, t) {
  ...
  a && a.addEventListener("click", (o) => {
    ...
    const n = Ds(a, e.state.width || 1280, e.state.height || 720), i = a.width / r.width, c = {
      x: ((o.clientX - r.left) * i - n.x) / Math.max(1, n.w),
      y: ((o.clientY - r.top) * i - n.y) / Math.max(1, n.h)
    }, l = $c(e.state.motion_layers, c, 0.09);
    l && (e.state.selected_motion_layer_id = l.id, e.render());
  }, { signal: t });
}
function _e(e, t, a, o = "value") {
...
function Kh(e, t) {
  ...
  return {
    ...
    motion_scene_fingerprint: Bl(e.state)
  };
}
function Bh(e, t) {
  const a = Kh(e, t);
...
function On(e, t, { frameCount: a = 0, fps: o = 0 } = {}) {
...
const ct = 1024 * 1024, qh = Object.freeze({
  card: 128 * ct,
  // MAX_CARD_BYTES
  model: 256 * ct,
  // MAX_MODEL_BYTES
...
function Jt(e, t) {
  ...
  return !Number.isFinite(o) || o <= a ? null : `${e.name || "File"} is ${Ln(o)}; the maximum is ${Ln(a)}.`;
}
function Uh(e) {
  return Number(e) <= Pn ? null : `${e} frames selected; a background sequence is limited to ${Pn}.`;
}
function Wh(e) {
...
function Vh(e) {
  ...
  e.audioElement && (er(e, r), Promise.resolve(e.audioElement.play()).catch(() => {
  }));
  ...
  const p = (m) => {
    ...
    if (f === null) {
      for (l += m - c, c = m; l >= i; )
        if (l -= i, r += 1, r > o) {
          if (!e.state.loop_playback) return void Eo(e);
          r = a;
        }
...
async function Hh(e, { load: t = () => import("./vendor-mediabunny-CZ5VNE-V.js") } = {}) {
...
async function Yh(e, t, { decode: a = Hh } = {}) {
  if (!t) return;
  const o = Jt(t, "audio");
  if (o) {
    e.setStatus(o);
  ...
  try {
    ...
    n.preload = "auto", n.src = r, e.audioObjectUrl = r, e.audioElement = n, await Gh(n), e.audioDuration = Number.isFinite(n.duration) ? n.duration : 0;
    try {
      e.audioSamples = await a(t);
    } catch {
      e.audioSamples = null;
    }
    Ks(e), e.setStatus(`Audio loaded: ${t.name || "track"}`);
  } catch (r) {
    Oo(e), e.setStatus(`Failed to load audio: ${r.message || r}`);
  }
}
let _t = null;
function Bs({ api: e }) {
...
const qs = /* @__PURE__ */ new WeakSet(), Wt = /* @__PURE__ */ new WeakMap();
function Po(e) {
...
function Jh(e) {
  ...
  Wt.delete(e), qs.has(e) && Po(e);
}
function Zt(e, t) {
  const a = e.cardMediaById.get(t);
  a && (e.cardMediaById.delete(t), e.cardMediaAssetById?.delete?.(t), t === "subject" && e.cardMedia === a && (e.cardMedia = null), Jh(a));
}
function Zh(e) {
...
function tt(e, t, a, o = !1, r = "") {
  ...
  n && n !== a && Zt(e, t), o && qs.add(a), Xh(a), e.cardMediaAssetById ||= /* @__PURE__ */ new Map(), e.cardMediaById.set(t, a), e.cardMediaAssetById.set(t, r || a?.__omnicamAsset || "");
  try {
    a.__omnicamAsset = r || a.__omnicamAsset || "";
  } catch {
  }
...
function Us(e, t, { signal: a, timeout: o = 15e3 } = {}) {
...
async function Ws(e, t, a, o = () => !0, r = null) {
  if (!t || !a) return;
  const n = () => !e.disposed && o(), i = String(t.asset || a).toLowerCase();
  if (r ?? /\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/.test(i)) {
    const l = document.createElement("video");
    if (l.src = a, l.loop = !0, l.muted = !0, l.playsInline = !0, await Us(l, ["loadeddata", "error"], { signal: e.abortController?.signal }).catch(() => {
    }), !n()) {
      Po(l);
      return;
    }
...
async function Qh(e, t) {
  if (!_t?.fetchApi || !/\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/i.test(e)) return null;
  const a = await _t.fetchApi("/majoor/omnicam/extractor/source", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
...
async function au(e, t) {
  ...
  try {
    const c = await Or(_t, { route: "/majoor/omnicam/upload_model", field: "asset", file: t });
...
async function ou(e, t) {
  ...
  if (o) {
    ...
    try {
      const r = await Or(_t, { route: "/majoor/omnicam/upload_asset", field: "asset", file: t });
...
function nu(e) {
  ...
  }, a.src = _t.apiURL(`/view?${new URLSearchParams(t).toString()}`);
}
async function su(e) {
  if (!e.node) return;
  ...
  for (const f of i) {
    ...
    if (h) {
      if (d === "image" || d === "video") {
        ...
        if (u && u.value) {
          const b = String(u.value), v = /\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/i.test(b), y = h.widgets?.find((g) => String(g.name).toLowerCase() === "subfolder")?.value || "", x = Ze(vt(b, y)), S = e.state.objects.find((g) => g.id === "subject");
          if (S) {
            const g = await Ws(e, S, x, r, v);
            if (!r()) return;
            S.asset = vt(b, y);
            let k = null;
            if (v)
              try {
                k = await Qh(b, o.signal);
              } catch (_) {
          ...
          }), tt(e, "subject", b, !1, b.currentSrc || b.src || ""), On(e, b, { frameCount: b instanceof HTMLVideoElement ? 0 : 1 }), e.upstreamImageConnected = !0, n = !0, e.render(), e.setStatus(b instanceof HTMLVideoElement ? s("Upstream video preview synced") : s("Upstream image preview synced")));
        }
      }
      if (d === "audio") {
        l = !0;
        ...
        if (u && u.value) {
          const b = String(u.value), v = h.widgets?.find((x) => String(x.name).toLowerCase() === "subfolder")?.value || "", y = Ze(vt(b, v));
          try {
      ...
      if (d === "scene_3d" || d === "model" || d === "mesh") {
        ...
        if (u && u.value) {
          ...
          if (["glb", "gltf", "obj", "fbx", "stl", "ply"].includes(v)) {
            const y = h.widgets?.find((k) => String(k.name).toLowerCase() === "subfolder")?.value || "", x = Ze(vt(b, y)), S = `upstream_scene_${h.id}`;
            p.add(S);
            let g = e.state.objects.find((k) => k.id === S);
            g ? (g.asset = vt(b, y), g.format = v === "gltf" ? "glb" : v) : (g = {
              id: S,
              type: "model",
              format: v === "gltf" ? "glb" : v,
  ...
  !l && e.upstreamAudioConnected && (Oo(e), e.upstreamAudioConnected = !1, e.refreshKeys(), n = !0, e.setStatus(s("Upstream audio disconnected · audio track cleared")));
  ...
  vl(e) && (n = !0), n && (e.serialize(), e.render());
}
const iu = ["video/mp4;codecs=avc1.42E01E", "video/webm;codecs=vp9", "video/webm;codecs=vp8", "video/webm"], zn = { low: 3e6, balanced: 6e6, high: 12e6 };
function cu(e) {
  return zn[e] || zn.balanced;
}
async function lu({
  canvas: e,
  fps: t,
  ...
  try {
    for (const S of iu)
      if (!(n.isTypeSupported && !n.isTypeSupported(S)))
        try {
          f = new n(m, { mimeType: S, videoBitsPerSecond: cu(r) });
          break;
        } catch {
        }
...
async function mu(e) {
  await Promise.all([...e].filter((t) => t instanceof HTMLVideoElement && t.seeking).map((t) => Us(t, ["seeked", "error"], { timeout: 5e3 }).catch(() => {
  })));
}
async function Vs(e) {
  await mu(e.cardMediaById.values());
}
async function Hs(e) {
  return lu({
    canvas: e.canvas,
...
async function Gs(e, t) {
  const a = await du(at, t);
  if (Bh(e, t), e.state.playblast_camera_id === rs)
...
async function fu(e) {
  ...
  const t = e.frame, a = e.canvas.width, o = e.canvas.height, r = pu(e);
  (r.width !== e.canvas.width || r.height !== e.canvas.height) && (e.canvas.width = r.width, e.canvas.height = r.height, e.render());
  try {
    let n = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-Df-T0Gt1.js");
    i !== "realtime" && await l(e.canvas.width, e.canvas.height) && (n = await c(e.canvas, e.state.duration_frames, e.state.fps, async (p) => {
      e.setFrame(p, !0), e.setStatus(s(`Encoding frame ${p + 1}/${e.state.duration_frames}…`)), await Vs(e), await new Promise((m) => requestAnimationFrame(m));
    }, e.abortController?.signal, e.state.playblast_quality)), n || (e.setStatus(s("WebCodecs unavailable; recording realtime fallback…")), n = await Hs(e)), e.setFrame(t), await Gs(e, n);
  } catch (n) {
...
async function Ys(e) {
  ...
  return Or(Gt, { route: "/majoor/omnicam/upload_asset", field: "asset", file: e });
}
async function Lo(e) {
...
async function uu(e, t) {
  ...
  let r = null;
  try {
    if (e.setStatus(`Uploading background: ${t.name}`), r = await Ys(t), o !== e.backgroundRequestId || e.disposed) {
      await Lo([r]);
      return;
    }
    const n = Ze(r.path);
    ...
    if (r && await Lo([r]), o !== e.backgroundRequestId || e.disposed) return;
...
async function bu(e, t) {
  ...
  try {
    ...
    for (const c of t)
      if (n.push(await Ys(c)), r !== e.backgroundRequestId || e.disposed) {
        await Lo(n);
        return;
      }
    ...
    if (await Lo(n), r !== e.backgroundRequestId || e.disposed) return;
    e.setStatus(`Failed to load BG sequence: ${i.message || i}`);
  }
}
function gu(e) {
  Kr(e), e.checkpoint?.("Clear background"), e.state.viewport_bg_image = "", e.state.viewport_bg_sequence = [], e.viewportBgImage = null, e.viewportBgSequenceImages = [], e.serialize(), e.render(), e.setStatus("Background cleared");
}
function yu(e) {
  const t = rr(e.state?.metadata?.viewport_labels);
  if (t.mode === "off") return;
  const a = Array.isArray(e.state?.objects) ? e.state.objects : [], o = e.viewportCamera(), r = e.ctx, n = e.canvas.width, i = e.canvas.height, c = Z(i / 720, 0.75, 4), l = Number(e.frame) || 0, p = e.selectedObjectIds instanceof Set ? e.selectedObjectIds : /* @__PURE__ */ new Set();
  r.save(), r.font = `${Math.round(12 * c)}px system-ui, -apple-system, "Segoe UI", Roboto, sans-serif`, r.textBaseline = "alphabetic";
  for (const m of a) {
    if (m.enabled === !1 || !Gn(m, { mode: t.mode, selectedIds: p })) continue;
    const f = Yn(m, t.content);
    if (!f) continue;
    const d = Xn(a, m, l) || { position: m.position, size: m.size }, h = Ve(Jn(d, m.type), o, n, i);
    if (!h) continue;
    const [u, b] = h, v = t.content === "annotation" && m.annotation?.color || "", y = 6 * c, x = 4 * c, g = r.measureText(f).width + y * 2, k = 12 * c + x * 2, _ = Math.round(u - g / 2), O = Math.round(b - k - 6 * c);
    r.fillStyle = "rgba(16,17,22,0.82)", vu(r, _, O, g, k, 4 * c), r.fill(), v && (r.strokeStyle = v, r.lineWidth = Math.max(1, c), r.stroke()), r.fillStyle = v || "#e6e6ec", r.fillText(f, _ + y, O + k - x - 2 * c);
  }
  r.restore();
}
function vu(e, t, a, o, r, n) {
...
function wu(e) {
  ...
  return e._pointFieldCache?.key !== r && (e._pointFieldCache = { key: r, ...Oc(t, a, o) }), e._pointFieldCache;
}
const ku = 600;
function Su(e) {
  const { points: t, colors: a } = wu(e);
  if (!t.length) return;
  const o = e.viewportCamera(), r = e.canvas.width, n = e.canvas.height, i = t.length / 3, c = 3 * Math.max(1, Math.ceil(i / ku)), l = /* @__PURE__ */ new Map();
  for (let p = 0; p < t.length; p += c) {
    const m = Ve([t[p], t[p + 1], t[p + 2]], o, r, n);
    if (!m) continue;
    const f = Z(Math.round(5 / Math.sqrt(m[2])), 1, 4), d = `${Math.round(a[p] * 255)},${Math.round(a[p + 1] * 255)},${Math.round(a[p + 2] * 255)}|${f}`;
    let h = l.get(d);
...
function Cu(e, t) {
  const [a, o, r] = t.position || [0, 0, 0], n = t.size?.[1] || 1.8, i = (t.size?.[0] || 0.7) * 0.5, c = [a, o + n * 0.88, r], l = [a, o + n * 0.76, r], p = [a - i * 0.55, o + n * 0.73, r], m = [a + i * 0.55, o + n * 0.73, r], f = [a - i * 0.72, o + n * 0.52, r], d = [a + i * 0.72, o + n * 0.52, r], h = [a - i * 0.82, o + n * 0.34, r], u = [a + i * 0.82, o + n * 0.34, r], b = [a, o + n * 0.44, r], v = [a - i * 0.28, o + n * 0.44, r], y = [a + i * 0.28, o + n * 0.44, r], x = [a - i * 0.28, o + n * 0.22, r], S = [a + i * 0.28, o + n * 0.22, r], g = [a - i * 0.28, o, r + 0.05], k = [a + i * 0.28, o, r + 0.05];
  ie(e, c, l, "#aaa", 2), ie(e, l, b, "#aaa", 2), ie(e, p, m, "#aaa", 2), ie(e, p, f, "#aaa", 2), ie(e, f, h, "#aaa", 2), ie(e, m, d, "#aaa", 2), ie(e, d, u, "#aaa", 2), ie(e, v, y, "#aaa", 2), ie(e, v, x, "#aaa", 2), ie(e, x, g, "#aaa", 2), ie(e, y, S, "#aaa", 2), ie(e, S, k, "#aaa", 2);
  const _ = Ve(c, e.viewportCamera(), e.canvas.width, e.canvas.height);
  _ && (e.ctx.strokeStyle = "#aaa", e.ctx.beginPath(), e.ctx.arc(_[0], _[1], Z(28 / _[2], 3, 12), 0, Math.PI * 2), e.ctx.stroke());
}
function Eu(e, t) {
...
function Tu(e, t) {
  ...
  ie(e, Ce(a, [-o, 0, 0]), Ce(a, [o, 0, 0]), "#bbb", 2), ie(e, Ce(a, [0, -o, 0]), Ce(a, [0, o, 0]), "#bbb", 2), ie(e, Ce(a, [0, 0, -o]), Ce(a, [0, 0, o]), "#bbb", 2);
}
function $u(e, t) {
  ...
  if (b)
    try {
      ...
      if (e.ctx.fillStyle = "#111", e.ctx.fillRect(f, h, v, y), g === "stretch" || !x || !S)
        ...
        const k = Math.min(v / x, y / S), _ = x * k, O = S * k;
        e.ctx.drawImage(b, f + (v - _) / 2, h + (y - O) / 2, _, O);
      } else {
        const k = Math.max(v / x, y / S), _ = v / k, O = y / k;
        e.ctx.drawImage(b, (x - _) / 2, (S - O) / 2, _, O, f, h, v, y);
      }
    } catch {
    }
  else
...
function Iu(e) {
  ...
  for (let o = 0; o < e.state.keyframes.length - 1; o++) {
    ...
    t.push(as(Ut(n.camera.position, r.camera.position)) * e.state.fps / Math.max(1, n.frame - r.frame));
  }
...
function Ou(e) {
  ...
  e.recording && e.state.playblast_labels && yu(e);
}
async function Pu(e, { signal: t } = {}) {
...
async function zu(e) {
  ...
  const r = o.diagnostic?.issues || [], n = Lu(r);
...
function Fu(e, t, a) {
  ...
  return o || (t.keyframes?.length ? Fo(t, a).position : t.position || [0, 1.5, 0]);
}
function Vt(e, t, a, o) {
  if (!a) return a;
  const r = Js(e, t, o);
...
function Du(e, { perFrame: t = !1 } = {}) {
  const a = e.activeCameraTrack(), o = Br(e, a), r = qr(e, a);
...
function Zs(e) {
  ...
  const r = (d, h, u, b, v = "") => {
    ...
    `, v.addEventListener("click", () => {
      e.outlinerCollapsedSections ||= /* @__PURE__ */ new Set(), e.outlinerCollapsedSections.has(u) ? e.outlinerCollapsedSections.delete(u) : e.outlinerCollapsedSections.add(u), Zs(e);
  ...
  if (p) {
    ...
    if (t.appendChild(h), !u)
      for (const b of d) {
        ...
        if (k.appendChild(document.createTextNode(b.name)), x) {
          const P = document.createElement("span");
        ...
        _.className = "scene-item-actions", _.appendChild(r("pi-star", "Solo track", b.solo, () => {
          e.checkpoint("Solo track"), b.solo = !b.solo, e.serialize(), e.refreshObjects(), e.renderCameraView();
        }, "color:#fbbf24;border-color:#78350f;background:rgba(245,158,11,0.2)")), _.appendChild(r("pi-volume-off", "Mute track", b.muted, () => {
          e.checkpoint("Mute track"), b.muted = !b.muted, e.serialize(), e.refreshObjects(), e.renderCameraView();
        }, "color:#f87171;border-color:#7f1d1d;background:rgba(239,68,68,0.15)")), _.appendChild(r("pi-lock", "Lock track", b.locked, () => {
          e.checkpoint("Lock track"), b.locked = !b.locked, e.serialize(), e.refreshObjects(), e.renderCameraView();
        })), (b.keyframes || []).length >= 1 && _.appendChild(r(
          "pi-arrows-alt",
        ...
        )), _.appendChild(r("pi-ellipsis-v", "Camera actions", !1, (P) => e.openCameraContext(P, b.id, !1))), v.append(g, k, _), v.title = S ? s("Currently selected for editing") : x ? s("Active playblast camera") : s("Click to select & activate this camera");
        const O = () => {
  ...
  if (m) {
    ...
    const b = [], v = (g, k) => {
      b.push({ object: g, level: k });
      const _ = h.get(g.id) || [];
      for (const O of _) v(O, k + 1);
    };
    ...
    if (t.appendChild(x), !S)
      for (const { object: g, level: k } of y) {
        ...
        const O = e.selectedEntity === "object" && (g.id === e.selectedObjectId || e.selectedObjectIds?.has?.(g.id)), P = e.selectedEntity === "object" && g.id === e.selectedObjectId;
        _.setAttribute("aria-selected", String(O)), _.className = `scene-item${O ? " selected" : ""}${P ? " primary" : ""}${k > 0 && !n ? " scene-item-child" : ""}`, k > 0 && !n && (_.style.paddingLeft = `${k * 16 + 6}px`);
        const K = g.type === "card" ? { icon: "pi-image", color: "#38bdf8" } : g.type === "model" || g.type === "glb" ? { icon: "pi-box", color: "#c084fc" } : g.type === "ground" ? { icon: "pi-minus", color: "#fbbf24" } : g.type === "cube" ? { icon: "pi-stop", color: "#fbbf24" } : g.type === "sphere" ? { icon: "pi-circle", color: "#fbbf24" } : g.type === "cylinder" ? { icon: "pi-database", color: "#fbbf24" } : g.type === "torus" ? { icon: "pi-circle", color: "#fbbf24" } : g.type === "pyramid" ? { icon: "pi-play", color: "#fbbf24" } : g.type === "sun_light" ? { icon: "pi-sun", color: "#f59e0b" } : g.type === "point_light" ? { icon: "pi-bolt", color: "#fbbf24" } : g.type === "spot_light" ? { icon: "pi-compass", color: "#38bdf8" } : g.type === "human" ? { icon: "pi-user", color: "#34d399" } : { icon: "pi-plus", color: "#94a3b8" }, W = g.enabled !== !1, H = !!g.load_error, oe = document.createElement("i");
        oe.className = `pi ${H ? "pi-exclamation-triangle" : K.icon}`, oe.style.cssText = H ? "color:#f87171" : W ? `color:${K.color}` : "opacity:.4";
        const C = document.createElement("span");
        C.className = "scene-item-label";
        const R = document.createElement("span");
        R.style.cssText = H ? "color:#fca5a5" : W ? "" : "opacity:.5;text-decoration:line-through", R.textContent = g.name || g.type, R.title = s("Double-click to rename"), R.addEventListener("dblclick", (E) => {
          E.preventDefault(), E.stopPropagation(), Bu(e, g, R);
        }), C.appendChild(R);
        ...
        if (V.length) {
          ...
          for (const G of V.slice(0, 2)) {
            const F = document.createElement("span");
            F.className = "scene-item-tag", F.textContent = G, E.appendChild(F);
          }
          if (V.length > 2) {
            const G = document.createElement("span");
            G.className = "scene-item-tag scene-item-tag-more", G.textContent = `+${V.length - 2}`, E.appendChild(G);
          }
          C.appendChild(E);
        }
        if (H) {
        ...
        const X = document.createElement("div");
        X.className = "scene-item-actions", X.appendChild(r(W ? "pi-eye" : "pi-eye-slash", W ? "Hide object (Alt+Click to Isolate)" : "Show object (Alt+Click to Isolate)", !W, (E) => {
          if (E?.altKey) {
            ...
            e.toggleObject(g.id);
        }, "color:#ef4444;opacity:.7")), X.appendChild(r(g.locked ? "pi-lock" : "pi-lock-open", "Lock object", g.locked, () => zr(e, g))), X.appendChild(r("pi-copy", "Duplicate object", !1, () => e.duplicateObject?.(g.id))), g.id !== "subject" && X.appendChild(r("pi-trash", "Delete object", !1, () => e.deleteObject?.(g.id))), X.appendChild(r("pi-ellipsis-v", "Object actions", !1, (E) => e.openObjectContext(E, g.id))), _.append(oe, C, X), _.title = s("Click to select · Double-click to toggle visibility · Right-click for actions");
        const N = (E = {}) => {
          ...
          if (e.finishCameraEdit(), e.selectedEntity = "object", e.selectedObjectIds ||= /* @__PURE__ */ new Set(), E.ctrlKey || E.metaKey)
            ...
            const F = e.state.objects.map((le) => le.id), Y = F.indexOf(e.outlinerAnchorId), Q = F.indexOf(g.id);
            e.selectedObjectIds = new Set(F.slice(Math.min(Y, Q), Math.max(Y, Q) + 1));
          } else
          ...
          for (const F of t.querySelectorAll(".scene-item")) {
            const Y = !!(F.dataset.objectId && e.selectedObjectIds.has(F.dataset.objectId)), Q = !!(F.dataset.objectId && F.dataset.objectId === e.selectedObjectId);
            F.classList.toggle("selected", Y), F.classList.toggle("primary", Q), F.dataset.objectId && F.setAttribute("aria-selected", String(Y));
          }
        ...
        _.addEventListener("dblclick", () => e.toggleObject(g.id)), _.addEventListener("contextmenu", (E) => {
...
function Gu(e) {
  ...
  if (n) {
    const C = r.target_object_id || e.state.target_object_id || "", R = `T${Jr()}${e.state.objects.map((V) => `${V.id}\0${V.name || V.type}`).join("|")}`;
    tr(n, R, () => [
      qt("", s("Manual Target (No Tracking)")),
      ...e.state.objects.map((V) => qt(V.id, `${s("Track:")} ${V.name || V.type}`))
    ], C);
  }
  Ku(e);
  const i = [...e.camera.position, ...e.camera.target, e.camera.fov, e.camera.roll || 0, e.camera.near, e.camera.far, ...Tr(e.camera)];
  ["camera-px", "camera-py", "camera-pz", "camera-tx", "camera-ty", "camera-tz", "camera-fov", "camera-roll", "camera-near", "camera-far", "camera-rx", "camera-ry", "camera-rz"].forEach((C, R) => {
    for (const V of e.root.querySelectorAll(`[data-role="${C}"]`))
      document.activeElement !== V && (V.value = String(Math.round(i[R] * 1e4) / 1e4));
  });
  ...
  if (!t) {
    ...
    R && (R.textContent = `${r.name} · F${e.frame}`), Nn(o, {
  ...
  m && (m.textContent = t.name || t.type), Nn(o, {
  ...
  for (const [C, R] of Object.entries(h))
    for (const V of e.root.querySelectorAll(`[data-role="${C}"]`))
      document.activeElement !== V && (V.value = String(Math.round(R * 1e4) / 1e4));
  ...
  if (v) {
    ...
    for (; V; ) {
      ...
      for (const E of e.state.objects)
        !R.has(E.id) && E.parent_id && R.has(E.parent_id) && (R.add(E.id), V = !0);
    }
    const X = e.state.objects.filter((E) => !R.has(E.id)), N = `P${Jr()}${C}${X.map((E) => `${E.id} ${E.name || E.type}`).join("|")}`;
    tr(v, N, () => [
      qt("", s("No parent")),
      ...X.map((E) => qt(E.id, E.name || E.type))
    ], t.parent_id || "");
  }
  ...
  _ && (_.hidden = y);
  const O = o('[data-role="rotation-row"]');
  if (O && (O.hidden = t.type === "point_light"), y) {
  ...
  if (u && (u.hidden = !P?.animations), b) {
    const C = P?.animationNames || [];
    tr(b, `A${C.join("|")}`, () => C.map((R, V) => qt(String(V), R)), String(t.animation_index || 0));
  }
  const K = o('[data-role="object-tags"]');
  K && document.activeElement !== K && (K.value = (t.tags || []).join(", "));
...
function Yu(e) {
  ...
  if ((e.lastObjectNumericEditId !== t.id || !Number.isFinite(e.lastObjectNumericEditAt) || i - e.lastObjectNumericEditAt > 300) && e.checkpoint?.("Edit object"), e.lastObjectNumericEditId = t.id, e.lastObjectNumericEditAt = i, t.position = [a("object-x", o[0]), a("object-y", o[1]), a("object-z", o[2])], t.rotation = [a("object-rx", r[0]), a("object-ry", r[1]), a("object-rz", r[2])], t.size = [Math.max(0.01, a("object-sx", n[0])), Math.max(0.01, a("object-sy", n[1])), Math.max(0.01, a("object-sz", n[2]))], ["sun_light", "point_light", "spot_light"].includes(t.type)) {
    ...
    if (l && (t.cast_shadow = l.checked), t.type === "spot_light") {
      ...
      p && p.value !== "" && (t.cone_angle = Z(Number(p.value) || 45, 1, 90));
      const m = e.root.querySelector('[data-role="object-penumbra"]');
      m && m.value !== "" && (t.penumbra = Z(Number(m.value) || 0.25, 0, 1));
    }
  }
...
function Zu(e) {
  ...
  e.beginCameraEdit(), Pc(e.camera, r), e.commitCameraEdit(), e.finishCameraEdit(), ai(e), Ju(e), e.render();
}
function Qu(e) {
  const t = globalThis.performance?.now?.() ?? Date.now();
  (!Number.isFinite(e.lastCameraHudEditAt) || t - e.lastCameraHudEditAt > 300) && e.checkpoint("Edit camera"), e.lastCameraHudEditAt = t;
  ...
  e.camera.position = [a("camera-px", e.camera.position[0]), a("camera-py", e.camera.position[1]), a("camera-pz", e.camera.position[2])], e.camera.target = [a("camera-tx", e.camera.target[0]), a("camera-ty", e.camera.target[1]), a("camera-tz", e.camera.target[2])], e.camera.fov = Z(a("camera-fov", e.camera.fov), 5, 150), e.camera.roll = Z(a("camera-roll", e.camera.roll || 0), -180, 180), e.camera.near = Math.max(1e-4, a("camera-near", e.camera.near)), e.camera.far = Math.max(e.camera.near + 1e-4, a("camera-far", e.camera.far)), e.beginCameraEdit(), e.commitCameraEdit(), e.finishCameraEdit(), ai(e), e.render();
}
function eb(e, t) {
  const a = Qt(e);
  if (!a) return;
...
function ob(e) {
  ...
  if (!t.length) return [];
  if (t.length === 1)
    return Qs(e, t[0]), e.selectedObjectId ? [e.selectedObjectId] : [];
  ...
  return t.forEach((o, r) => {
    ...
    const c = 0.35 + r * 0.15;
    i.position = Ce(i.position || [0, 0, 0], [c, 0, c]), (i.type === "model" || i.type === "glb") && e.modelUrlsById.has(n.id) ? e.modelUrlsById.set(i.id, e.modelUrlsById.get(n.id)) : i.type === "card" && e.cardMediaById.has(n.id) && tt(e, i.id, e.cardMediaById.get(n.id), !1, i.asset || e.cardMediaAssetById?.get?.(n.id) || ""), e.state.objects.push(i), a.push(i.id);
...
function db(e) {
  ...
  const t = e.root.querySelector('[data-role="key-interp"]')?.value || e.root.querySelector('[data-role="interp"]')?.value || "ease", a = ze(e), o = Ee(e), r = a ? { frame: e.frame, transform: He(a), interpolation: t } : { frame: e.frame, camera: ce(e.camera), interpolation: t }, n = o.findIndex((i) => i.frame === e.frame);
...
function fb(e) {
  const t = ze(e), a = Ge(e) || Ee(e).find((o) => o.frame === e.frame);
...
const wb = ["guides", "safe-areas", "resolution-gate", "aspect-ratio"];
function kb(e) {
...
function _b(e) {
  const t = ze(e), a = Ge(e), o = e.root.querySelector('[data-role="key-editor"]');
...
function Eb(e) {
  ...
  if (e.checkpoint("Edit keyframe"), e.editingKeyFrame = t.frame, ze(e)) {
    t.interpolation = e.root.querySelector('[data-role="key-interp"]').value, t.transform = He(ze(e)), e.serialize(), e.setFrame(t.frame), e.setStatus(s(`Object keyframe updated @ ${t.frame}`));
    return;
  }
  const a = (o, r) => {
...
const Ur = ["pos_x", "pos_y", "pos_z"], br = 1e-9, Ko = ["auto", "aligned", "free", "corner"];
function Te(e, t = 0) {
  const a = Number(e);
...
function gr(e, t, a) {
  const o = Fe(e), r = t ? Fe(t) : o, n = a ? Fe(a) : o, i = Math.max(br, Te(e?.frame) - Te(t?.frame, Te(e?.frame) - 1)), c = Math.max(br, Te(a?.frame, Te(e?.frame) + 1) - Te(e?.frame)), l = [0, 0, 0], p = [0, 0, 0];
  for (let m = 0; m < 3; m += 1) {
...
function dt(e, t, a) {
  const o = $b(e);
  for (let r = 0; r < 3; r += 1) {
    const n = Ur[r], i = o[n] && typeof o[n] == "object" ? o[n] : {};
...
function ni(e, t, a) {
  const o = Fe(e), r = vr(e, t, a);
  dt(e, "out", Ct(r.out, o)), dt(e, "in", Ct(r.in, o));
}
function Mb(e, t, a, { prevKey: o = null, nextKey: r = null, breakCoupling: n = !1 } = {}) {
  if (!e || t !== "in" && t !== "out") return e;
  let i = lt(e);
  if (i === "corner") return e;
  i === "auto" && (i = "aligned", e.tangents = e.tangents && typeof e.tangents == "object" ? e.tangents : {}, e.tangents.spatial_mode = "aligned", ni(e, o, r));
  const c = Fe(e), l = Ct([
    Te(a?.[0]),
    Te(a?.[1]),
    Te(a?.[2])
  ], c);
  if (No(e), dt(e, t, l), i === "aligned" && !n) {
    const p = t === "out" ? "in" : "out", m = yr(e, p) || (p === "out" ? gr(e, o, r).out : gr(e, o, r).in), f = Fn(l), d = Fn(m) || f || 1, h = f > br ? zo(l, -d / f) : zo(m, 1);
    dt(e, p, h);
  }
  return e;
}
function wo(e, t, a) {
  if (!e || t !== "in" && t !== "out") return e;
  const o = Fe(e);
  return No(e), dt(e, t, Ct([
    Te(a?.[0]),
    Te(a?.[1]),
    Te(a?.[2])
  ], o)), e;
}
function Ib(e, t, { prevKey: a = null, nextKey: o = null } = {}) {
  if (!e || !Ko.includes(t)) return e;
  if (e.tangents = e.tangents && typeof e.tangents == "object" ? e.tangents : {}, e.tangents.spatial_mode = t, t === "auto") {
    if (e.tangents.channels) {
      for (const r of Ur) delete e.tangents.channels[r];
  ...
  if (t === "corner") {
    const r = ri(e, a, o);
    return No(e), dt(e, "out", r.out), dt(e, "in", r.in), e;
  }
  return No(e), ni(e, a, o), e;
}
function Ob(e) {
  switch (e) {
    case "auto":
...
function Lb(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: u, syncActiveCameraTrack: b, syncFromWidgets: v, bindEditorEvents: y, activateCamera: x, addCamera: S, deleteCamera: g, drawPreviewOverlays: k, duplicateCamera: _, maximizeCameraPreview: O, refreshCameraPreviews: P, refreshCameraSelectors: K, renameCamera: W, setPlayblastCamera: H, toggleCameraView: oe, captureRealtime: C, makePlayblast: R, uploadDirectorPlayblast: V, waitForMediaFrame: X, computeAudioPeaks: N, loadAudioFile: E, releaseAudio: G, stopPlay: F, togglePlay: Y, applyCameraPreset: Q, applyCameraShake: le, applyProxyPreset: se, clearViewportBgImage: re, loadViewportBgFile: de, loadViewportBgSequence: be, drawCameraPath: fe, drawCard: ge, drawCube: ye, drawGrid: pe, drawHuman: Me, drawLine3D: ve, drawNull: xe, drawOverlays: ue, drawPointField: L, drawSpeedHeatmap: U, drawSphere: me, curveChannels: je, drawCurveEditor: Oe, onCurvePointerDown: Re, onCurvePointerMove: Pe, onCurvePointerUp: ot, onTimelinePointerDown: ea, onTimelinePointerMove: ta, onTimelinePointerUp: aa, refreshKeys: At, resetCurveZoom: Tt, resetTimelineZoom: pt, setChannelFilter: $t, setCurveInterpolation: Mt, setTangentMode: It, timelineFrameFromEvent: oa, toggleCurveHandles: Ot, zoomCurve: ra, drawTransformGizmo: na, frameTarget: sa, gizmoAxes: ia, gizmoGeometry: ca, onPointerDown: la, onPointerMove: da, onPointerUp: ma, onWheel: pa, pickGizmo: fa, pickSceneObject: ha, resetCamera: Pt, setTransformMode: Lt, setViewMode: ua, viewportCamera: ba, loadCardFile: Bo, loadExecutionPreview: qo, loadMediaUrl: ga, loadModelFile: ya, loadSelectedReference: va, onModelLoaded: xa, restoreAssets: wa, syncUpstreamInputs: ka, configureDomMedia: Sa, refreshSetupDiagnostic: zt, addMediaCard: ja, addPrimitive: _a, applyObjectAnimationFrame: Ca, beginCameraEdit: Ea, beginObjectEdit: Aa, commitCameraEdit: Ta, commitObjectEdit: $a, copyKeyframe: Ma, deleteKeyframe: Ia, deleteObject: Oa, duplicateObject: Pa, exitKeyEdit: La, finishCameraEdit: za, goToAdjacentKey: Na, insertKeyframe: Fa, loadSelectedKeyView: Ra, pasteKeyframe: Da, playblastCameraAtFrame: Ka, refreshInspector: Ba, refreshKeyEditor: qa, refreshObjects: Ua, removeObjectResources: Wa, renameObject: Va, retimeSelectedKey: Ha, selectKeyframe: Ga, selectedKeyframe: Ya, selectedObject: Xa, selectObjectAnimation: Ja, setKeyInterpolation: Za, setObjectParent: Qa, timelineKeyframes: eo, timelineObject: rt, toggleAutoKey: to, toggleObject: ao, updateCameraFromHud: oo, updateEditState: ro, updateKeyVisualState: no, updateSelectedKey: so, updateSelectedObject: io, clamp: Nt, cloneCamera: co, configureCore: lo, defaultCamera: mo, sampleCamera: ft, sampleObjectTransform: Uo, sanitizeState: ht, worldTransform: De } = e;
  return {
    setSelectMode(z) {
      if (["object", "vertex", "edge", "face"].includes(z)) {
        ...
        for (const $ of this.root.querySelectorAll("[data-select-mode]")) {
          const j = $.dataset.selectMode === z;
          $.classList.toggle("active", j), $.setAttribute("aria-pressed", String(j));
        }
    ...
    hideInternalWidgets() {
      for (const z of ["state_json", "recording_path", "card_asset"]) {
        const $ = this.node.widgets?.find((j) => j.name === z);
    ...
    restoreHistorySnapshot(z) {
      ...
      const j = Rn(this.state), w = new Set(this.state.objects.map((J) => J.id));
      this.state = ht($.state);
      const A = new Set(this.state.objects.map((J) => J.id));
      for (const J of w) A.has(J) || this.removeObjectResources(J);
      this.frame = Nt($.frame, 0, this.state.duration_frames - 1);
      const M = new Set(this.state.objects.map((J) => J.id)), B = Array.isArray($.selectedObjectIds) ? $.selectedObjectIds : [$.selectedObjectId].filter(Boolean);
      this.selectedObjectIds = new Set(B.filter((J) => M.has(J))), this.selectedObjectId = this.selectedObjectIds.has($.selectedObjectId) ? $.selectedObjectId : [...this.selectedObjectIds].at(-1) || null, this.selectedEntity = this.selectedObjectIds.size ? "object" : $.selectedEntity || "camera";
      const ee = new Set(this.timelineKeyframes().map((J) => J.frame)), D = Array.isArray($.selectedKeyFrames) ? $.selectedKeyFrames : [$.selectedKeyFrame].filter((J) => J != null);
      this.selectedKeyFrames = new Set(D.filter((J) => ee.has(J))), this.selectedKeyFrame = this.selectedKeyFrames.has($.selectedKeyFrame) ? $.selectedKeyFrame : [...this.selectedKeyFrames].at(-1) ?? null, this.pathSelection = Lc(this.pathSelection, this.activeCameraTrack()), this.subSelection = $.subSelection || null, this.camera = ft(this.state, this.frame), Vt(this, this.activeCameraTrack(), this.camera, this.frame), this.cameraPreviewSignature = "", this.serialize(), j !== Rn(this.state) && this.restoreAssets(), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
    },
    checkpoint(z) {
    ...
    closeMenus(z = null) {
      for (const $ of this.root.querySelectorAll(".toolbar-menu")) $ !== z && ($.open = !1);
    ...
    showContextMenu(z, $, j) {
      return this.contextMenu.show(z, $, j);
    },
    onContextMenu(z) {
      ...
      const $ = z.target, j = $.closest?.(".camera-preview-tile"), w = $.closest?.(".scene-item"), A = $.closest?.(".key");
      ...
      if (A) {
        const M = this.timelineKeyframes().find((B) => B.frame === Number(A.dataset.keyFrame));
        return M && this.selectKeyframe(M), this.openTimelineContext(z, !0);
      }
      if ($.closest?.('[data-role="keys"]'))
        return this.setFrame(this.timelineFrameFromEvent(z, $.closest('[data-role="keys"]'))), this.openTimelineContext(z, !1);
      if ($.closest?.(".curve-editor")) return this.openCurveContext(z);
      if ($.closest?.(".viewport-wrap")) {
        const M = this.interactionElement.getBoundingClientRect(), B = (z.clientX - M.left) * this.canvas.width / Math.max(1, M.width), ee = (z.clientY - M.top) * this.canvas.height / Math.max(1, M.height), D = this.pickSceneObject([B, ee]);
        if (D) {
          if ((D.type === "object" || D.type === "object_keyframe") && D.object)
            return this.selectedEntity = "object", this.selectedObjectId = D.object.id, D.keyframe ? (this.setFrame(D.keyframe.frame), this.selectedKeyFrame = D.keyframe.frame) : this.selectedKeyFrame = D.object.keyframes?.find((J) => J.frame === this.frame)?.frame ?? null, this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), this.openObjectContext(z, D.object.id);
          if (["camera", "camera_target", "camera_keyframe"].includes(D.type) && D.camera)
            return this.selectedEntity = D.type === "camera_target" ? "camera_target" : "camera", this.selectedObjectId = null, this.activateCamera(D.camera.id), D.keyframe && (this.setFrame(D.keyframe.frame), this.selectedKeyFrame = D.keyframe.frame), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), D.type === "camera_keyframe" && D.keyframe ? this.openPathKeyContext(z, D.camera.id, D.keyframe.frame) : this.openCameraContext(z, D.camera.id, !1);
        }
    ...
    openObjectContext(z, $) {
      const j = this.state.objects.find((M) => M.id === $);
      if (!j) return;
      this.selectedEntity = "object", this.selectedObjectId = $, this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
      const w = ["sun_light", "point_light", "spot_light"].includes(j.type), A = this.selectedObjectIds?.size || 0;
      if (A >= 2 && this.selectedObjectIds.has($)) {
        this.showContextMenu(z, `${A} ${s("objects selected")}`, [
      ...
      this.showContextMenu(z, j.name || j.type, [
        ...
        { label: j.enabled === !1 ? s("Show object") : s("Hide object"), icon: j.enabled === !1 ? "pi-eye" : "pi-eye-slash", run: () => this.toggleObject($) },
        { label: j.locked ? s("Unlock object") : s("Lock object"), icon: j.locked ? "pi-lock" : "pi-lock-open", run: () => zr(this, j) },
        null,
        {
          label: s("Transform mode"),
          icon: "pi-arrows-alt",
    ...
    openCameraContext(z, $, j = !1) {
      const w = this.state.cameras.find((A) => A.id === $);
      w && (this.selectedEntity = "camera", this.selectedObjectId = null, this.activateCamera($), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), this.showContextMenu(z, `${w.name}${j ? " preview" : ""}`, [
        ...
        null,
        {
          ...
          icon: "pi-sliders-h",
          items: [
            { label: s("Shot: move earlier"), icon: "pi-arrow-up", disabled: this.state.cameras.findIndex((A) => A.id === $) <= 0, run: () => this.moveShot($, -1) },
            { label: s("Shot: move later"), icon: "pi-arrow-down", disabled: this.state.cameras.findIndex((A) => A.id === $) >= this.state.cameras.length - 1, run: () => this.moveShot($, 1) },
            null,
    ...
    openPathKeyContext(z, $, j) {
      const w = this.state.cameras.find((J) => J.id === $);
      if (!w) return;
      this.selectedEntity = "camera", this.selectedObjectId = null, this.activateCamera($);
      const A = (w.keyframes || []).find((J) => J.frame === j) || null;
      A && this.selectKeyframe(A), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
      const M = A ? lt(A) : "auto", B = this.selectedKeyFrames?.size || 0, ee = this.pathSelection?.component === "target", D = es(w);
      this.showContextMenu(z, `Path key F${j}`, [
        ...
        null,
        {
          ...
          items: [
            { label: s("Position"), checked: !ee, run: () => this.setPathSelectionComponent("position") },
            {
              label: s("Target"),
              checked: ee,
              disabled: D,
        ...
        },
        {
          ...
          icon: "pi-sliders-v",
          items: ar(this, i, t, rt)
        },
        null,
        {
          label: B >= 2 ? s("Delete {count} keys").replace("{count}", String(B)) : s("Delete key"),
          icon: "pi-trash",
          danger: !0,
          disabled: (w.keyframes || []).length <= 1,
    ...
    moveShot(z, $) {
      const j = this.state.cameras.findIndex((M) => M.id === z), w = j + $;
      if (j < 0 || w < 0 || w >= this.state.cameras.length) return;
      this.checkpoint("Reorder shot");
      const [A] = this.state.cameras.splice(j, 1);
    ...
    async editShotHandles(z) {
      const $ = this.state.cameras.find((M) => M.id === z);
      if (!$) return;
      const j = $.handles || { in: 0, out: 0 }, w = await i(t, s("Shot handles…"), "Handle frames: in,out", `${j.in},${j.out}`);
      if (w == null) return;
      const A = String(w).match(/^\s*(\d+)\s*[,;\s]\s*(\d+)\s*$/);
      if (!A) return this.setStatus("Handles must be two integers: in,out");
      this.checkpoint("Shot handles"), $.handles = { in: Math.min(600, Number(A[1])), out: Math.min(600, Number(A[2])) }, this.serialize(), this.setStatus(`${$.name} handles: ${$.handles.in} / ${$.handles.out}`);
    },
    openTimelineContext(z, $) {
      const j = this.selectedKeyFrames?.size || 0, w = this.selectedKeyframe(), A = w?.interpolation || "ease", M = w && lt(w) || "auto", B = ["ease", "linear", "bezier", "smooth", "ease_in", "ease_out", "sine", "cubic", "quintic", "expo", "back"], ee = ["auto", "clamped", "vector", "free", "aligned", "flat"];
      this.showContextMenu(z, $ ? `Keyframe F${this.selectedKeyFrame}` : `Timeline F${this.frame}`, [
        { label: s("Fit timeline view (F)"), icon: "pi-arrows-alt", shortcut: "F", run: () => pt(this) },
    ...
    addMarker() {
      ...
      this.checkpoint("Add marker"), this.state.markers = [...this.state.markers || [], { frame: this.frame, name: `Marker ${(this.state.markers || []).length + 1}`, color: "#f2d06b" }].sort(($, j) => $.frame - j.frame), this.serialize(), this.refreshKeys(), this.setStatus(`Marker @ F${this.frame}`);
    },
    removeNearestMarker() {
      const z = this.state.markers || [];
      if (!z.length) return;
      const $ = z.reduce((j, w) => Math.abs(w.frame - this.frame) < Math.abs(j.frame - this.frame) ? w : j);
      this.checkpoint("Remove marker"), this.state.markers = z.filter((j) => j !== $), this.serialize(), this.refreshKeys(), this.setStatus(`Marker removed @ F${$.frame}`);
    },
    openCurveContext(z) {
      const $ = this.selectedKeyFrames?.size || 0, j = $ < 2 && !this.selectedKeyframe(), w = this.selectedKeyframe(), A = w?.interpolation || "ease", M = w && lt(w) || "auto", B = ["bezier", "smooth", "linear", "ease_in", "ease_out", "ease", "sine", "cubic", "quintic", "expo", "back"], ee = ["auto", "clamped", "vector", "free", "aligned", "flat"];
      this.showContextMenu(z, s("Curve editor"), [
        { label: s("Fit all curves (Framing)"), icon: "pi-arrows-alt", shortcut: "F", run: () => Tt(this) },
        { label: s("Set key at playhead"), icon: "pi-key", shortcut: "I", run: () => this.insertKeyframe() },
        ...
        null,
        { label: $ >= 2 ? s("Delete {count} keys").replace("{count}", String($)) : s("Delete selected key"), icon: "pi-trash", danger: !0, disabled: j, run: () => this.deleteSelectedKeyframes() }
      ]);
    },
    ...
    refitNode() {
      ...
      try {
        if (z && typeof z.computeSize == "function" && typeof z.setSize == "function") {
          const $ = z.computeSize();
          Array.isArray($) && z.setSize([z.size?.[0] ?? $[0], $[1]]);
        }
    ...
    resizeCanvas() {
      ...
      if (!z) return;
      const $ = Math.min(2, window.devicePixelRatio || 1), j = z.clientWidth || 320, w = z.clientHeight || 180, A = Math.max(320, Math.round(j * $)), M = Math.max(180, Math.round(w * $));
      (this.canvas.width !== A || this.canvas.height !== M) && (this.canvas.width = A, this.canvas.height = M);
      for (const B of this.cameraPreviewCanvases.values()) {
        const ee = B.clientWidth || 220, D = B.clientHeight || 124, J = Math.max($, Pb / Math.max(1, ee)), ke = Math.max(1, Math.round(ee * J)), Ke = Math.max(1, Math.round(D * J));
        (B.width !== ke || B.height !== Ke) && (B.width = ke, B.height = Ke);
      }
...
function Wr(e, t) {
  const a = e.map((i) => Fb(i, t)), o = Rb(a), r = e.map((i) => i.frame), n = Math.max(1, r[r.length - 1] - r[0]);
  return a.map((i, c) => [
    (r[c] - r[0]) / n,
...
function Kb(e, t, { tolerance: a = 0.02, keepFrames: o = [] } = {}) {
  const r = [...e].sort((m, f) => m.frame - f.frame);
  if (r.length <= 2 || a <= 0) return { keys: r, removed: 0 };
  const n = Wr(r, t), i = /* @__PURE__ */ new Set(), c = new Set(o);
  r.forEach((m, f) => {
...
function Bb(e, t, { target: a = 2, keepFrames: o = [] } = {}) {
...
function qb(e, t, { mergeWithin: a = 1, epsilon: o = 1e-3, keepFrames: r = [] } = {}) {
...
function Wb(e, t, a, { lastFrame: o = 1 / 0 } = {}) {
...
function Xb(e, { leftFrame: t, rightFrame: a, t: o = 0.5 } = {}) {
  ...
  const c = Math.min(0.999, Math.max(1e-3, Number.isFinite(o) ? o : 0.5)), l = Math.round(t + c * (a - t)), p = Yb(r, t, a, l);
  ...
  if (b) {
    const S = [...f.camera.position], g = vr(f, h, d).out, k = vr(d, f, u).in, _ = [...d.camera.position], O = Gb(S, g, k, _, m);
    y.camera = { ...ce(v), position: [...O.point] };
    const P = lt(f);
    (P === "free" || P === "aligned") && wo(f, "out", O.left[1]);
    const K = lt(d);
    (K === "free" || K === "aligned") && wo(d, "in", O.right[2]), wo(y, "in", O.left[2]), wo(y, "out", O.right[1]);
  }
  return { ok: !0, keys: [...r, y].sort((S, g) => S.frame - g.frame), frame: p };
}
const Kn = { motion: "motion", shot: "display", health: "health" }, Jb = {
  object: "Object",
  camera: "Camera",
  camera_target: "Look-At Target",
  camera_path: "Camera Path"
}, Zb = { motion: "Motion", shot: "Shot", health: "Health" }, Qb = ["entity", "motion", "shot", "health"];
function ci(e) {
  return e.inspectorMode && e.inspectorMode !== "entity" ? e.inspectorMode : "entity";
}
function eg(e) {
  const t = ci(e);
  return Kn[t] ? Kn[t] : e.selectedEntity === "object" ? "scene" : "camera";
}
function tg(e) {
  return [
    e.selectedEntity || "",
...
function ag(e) {
  const t = tg(e);
  e._lastInspectorSelKey !== void 0 && e._lastInspectorSelKey !== t && (e.inspectorMode = "entity"), e._lastInspectorSelKey = t, li(e);
}
function li(e) {
  const t = eg(e);
  ...
  r && (r.textContent = o === "entity" ? s(Jb[e.selectedEntity] || "Inspector") : s(Zb[o] || "Inspector"));
}
function og(e, t) {
  e.inspectorMode = Qb.includes(t) ? t : "entity", li(e), e.render?.(), e.refitNode?.();
}
function rg(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: u, syncActiveCameraTrack: b, syncFromWidgets: v, bindEditorEvents: y, activateCamera: x, addCamera: S, deleteCamera: g, drawPreviewOverlays: k, duplicateCamera: _, maximizeCameraPreview: O, refreshCameraPreviews: P, refreshCameraSelectors: K, renameCamera: W, setPlayblastCamera: H, toggleCameraView: oe, captureRealtime: C, makePlayblast: R, uploadDirectorPlayblast: V, waitForMediaFrame: X, computeAudioPeaks: N, loadAudioFile: E, releaseAudio: G, stopPlay: F, togglePlay: Y, applyCameraPreset: Q, applyCameraShake: le, applyProxyPreset: se, clearViewportBgImage: re, loadViewportBgFile: de, loadViewportBgSequence: be, drawCameraPath: fe, drawCard: ge, drawCube: ye, drawGrid: pe, drawHuman: Me, drawLine3D: ve, drawNull: xe, drawOverlays: ue, drawPointField: L, drawSpeedHeatmap: U, drawSphere: me, curveChannels: je, drawCurveEditor: Oe, onCurvePointerDown: Re, onCurvePointerMove: Pe, onCurvePointerUp: ot, onTimelinePointerDown: ea, onTimelinePointerMove: ta, onTimelinePointerUp: aa, refreshKeys: At, resetCurveZoom: Tt, resetTimelineZoom: pt, setChannelFilter: $t, setCurveInterpolation: Mt, setTangentMode: It, timelineFrameFromEvent: oa, toggleCurveHandles: Ot, zoomCurve: ra, drawTransformGizmo: na, frameTarget: sa, gizmoAxes: ia, gizmoGeometry: ca, onPointerDown: la, onPointerMove: da, onPointerUp: ma, onWheel: pa, pickGizmo: fa, pickSceneObject: ha, resetCamera: Pt, setTransformMode: Lt, setViewMode: ua, viewportCamera: ba, loadCardFile: Bo, loadExecutionPreview: qo, loadMediaUrl: ga, loadModelFile: ya, loadSelectedReference: va, onModelLoaded: xa, restoreAssets: wa, syncUpstreamInputs: ka, configureDomMedia: Sa, refreshSetupDiagnostic: zt, addMediaCard: ja, addPrimitive: _a, applyObjectAnimationFrame: Ca, beginCameraEdit: Ea, beginObjectEdit: Aa, commitCameraEdit: Ta, commitObjectEdit: $a, copyKeyframe: Ma, deleteKeyframe: Ia, deleteObject: Oa, deleteSelectedObjects: Pa, duplicateObject: La, exitKeyEdit: za, finishCameraEdit: Na, goToAdjacentKey: Fa, insertKeyframe: Ra, loadSelectedKeyView: Da, pasteKeyframe: Ka, playblastCameraAtFrame: Ba, refreshInspector: qa, refreshKeyEditor: Ua, refreshObjects: Wa, removeObjectResources: Va, renameObject: Ha, retimeSelectedKey: Ga, selectKeyframe: Ya, selectedKeyframe: Xa, selectedObject: Ja, selectObjectAnimation: Za, setKeyInterpolation: Qa, setKeyTangentMode: eo, setObjectParent: rt, timelineKeyframes: to, timelineObject: ao, toggleAutoKey: oo, toggleObject: ro, updateCameraFromHud: no, updateCameraRotationFromHud: so, updateEditState: io, updateKeyVisualState: Nt, updateSelectedKey: co, updateSelectedObject: lo, clamp: mo, cloneCamera: ft, configureCore: Uo, defaultCamera: ht, sampleCamera: De, sampleObjectTransform: z, sanitizeState: $, worldTransform: j } = e;
  return {
    setChannelFilter(w) {
      $t(this, w);
    },
    setFrame(w, A = !1, M = !0) {
      this.frame = mo(Math.round(w), 0, this.state.duration_frames - 1), this.editingKeyFrame !== this.frame && (this.editingKeyFrame = null), this.camera = De(this.activeCameraTrack(), this.frame, this.state.objects), Vt(this, this.activeCameraTrack(), this.camera, this.frame), this.applyObjectAnimationFrame();
      const B = this.dom ||= $s(this.root);
      for (const te of B.frames) document.activeElement !== te && (te.value = String(this.frame));
      for (const te of B.scrubs) te.value = String(this.frame);
      for (const te of B.cameraFov) document.activeElement !== te && (te.value = String(Math.round(this.camera.fov * 100) / 100));
      for (const te of B.cameraRoll) document.activeElement !== te && (te.value = String(Math.round((this.camera.roll || 0) * 100) / 100));
      for (const te of B.cameraFocal) document.activeElement !== te && (te.value = $r(this.camera.fov));
      for (const te of B.viewportZoom) te.textContent = `${(Number(this.camera.zoom) || 1).toFixed(2)}x`;
      for (const te of B.cameraType) document.activeElement !== te && (te.value = this.camera.camera_type || "perspective");
      for (const te of B.cameraNear) document.activeElement !== te && (te.value = String(this.camera.near ?? 0.01));
      for (const te of B.cameraFar) document.activeElement !== te && (te.value = String(this.camera.far ?? 1e4));
      const ee = this.frame / this.state.fps;
      for (const te of this.cardMediaById.values()) te instanceof HTMLVideoElement && Number.isFinite(te.duration) && te.duration > 0 && (te.currentTime = ee % te.duration);
      const D = Math.floor(ee / 60), J = Math.floor(ee % 60), ke = Math.floor(ee % 1 * 1e3), Ke = this.frame % Math.max(1, Math.round(this.state.fps)), nt = Math.floor(this.frame / this.state.fps);
      if ((B.time || this.root.querySelector('[data-role="time"]')).textContent = this.state.timecode_mode === "timecode" ? `${String(Math.floor(nt / 3600)).padStart(2, "0")}:${String(Math.floor(nt / 60) % 60).padStart(2, "0")}:${String(nt % 60).padStart(2, "0")}:${String(Ke).padStart(2, "0")}` : `${String(D).padStart(2, "0")}:${String(J).padStart(2, "0")}.${String(ke).padStart(3, "0")}`, M) this.refreshKeys();
      else {
        To(this);
    ...
    setSpatialHandleMode(w) {
      if (!Ko.includes(w)) return;
      const M = this.activeCameraTrack()?.keyframes || [], B = M.findIndex((ee) => ee.frame === this.selectedKeyFrame);
      if (B < 0) {
        this.setStatus(s("Select a camera keyframe first"));
        return;
      }
      this.checkpoint(s("Camera path handle: {mode}").replace("{mode}", w)), Ib(M[B], w, {
        prevKey: M[B - 1] || null,
        nextKey: M[B + 1] || null
    ...
    setPathSelectionComponent(w) {
      this.pathSelection = Nc(this.pathSelection, w), this.refreshInspector(), this.render();
    },
    ...
    insertPathKeyAtCursor(w) {
      ...
      const A = this.interactionElement.getBoundingClientRect(), M = (w.clientX - A.left) * this.canvas.width / Math.max(1, A.width), B = (w.clientY - A.top) * this.canvas.height / Math.max(1, A.height), ee = this.webgl.pickPathSegment([M, B]);
      if (!ee) return !1;
      const D = (this.state.cameras || []).find((ke) => ke.id === ee.cameraId);
      if (!D || D.locked) return !1;
      const J = Xb(D.keyframes || [], {
        leftFrame: ee.leftFrame,
        rightFrame: ee.rightFrame,
        t: ee.t
      });
      return J.ok ? (this.checkpoint(s("Insert camera path key")), D.id !== this.state.active_camera_id && this.activateCamera(D.id), D.keyframes = J.keys, this.state.keyframes = J.keys, this.camera = De(D, this.frame, this.state.objects), D.camera = ft(this.camera), zc(this, { cameraId: D.id, frame: J.frame, additive: !1 }), this.serialize(), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), this.setStatus(s("Camera path key inserted at frame {frame}").replace("{frame}", String(J.frame))), !0) : (this.setStatus(J.reason === "no_free_frame" ? s("No free frame here to insert a key") : s("Could not insert a key here")), !0);
    },
    ...
    transformCameraPath(w) {
      ...
      const M = ts(A.keyframes, { origin: Qn(A.keyframes), ...w });
      return A.keyframes = M, A.id === this.state.active_camera_id && (this.state.keyframes = M), this.camera = De(A, this.frame, this.state.objects), A.camera = ft(this.camera), this.serialize(), this.refreshKeys(), this.refreshInspector(), this.render(), this.renderCameraView?.(), !0;
    },
    toggleCurveHandles() {
      Ot(this);
    },
    ...
    toggleInspector(w) {
      ...
      if (!A) return;
      const M = w !== void 0 ? w : A.dataset.collapsed !== "true";
      A.dataset.collapsed = String(M);
      for (const B of this.root.querySelectorAll('[data-act="toggle-inspector"]'))
        B.classList.toggle("active", !M), B.setAttribute("aria-pressed", String(!M));
    ...
    selectHierarchy(w = this.selectedObjectId) {
      ...
      for (; M; ) {
        M = !1;
        for (const B of this.state.objects)
          B.parent_id && A.has(B.parent_id) && !A.has(B.id) && (A.add(B.id), M = !0);
      }
    ...
    playblastCameraAtFrame() {
      return Vt(this, d(this), Ba(this, De), this.frame);
    },
    viewportCamera() {
      return ba(this);
    },
    ...
    lookAtObject(w) {
      const A = this.state.objects.find((M) => M.id === w);
      if (A) {
        this.checkpoint("Look-at constraint");
        for (const M of this.state.cameras)
          for (const B of M.keyframes) B.camera.target = [...A.position || [0, 1.5, 0]];
        this.camera = De(this.state, this.frame), this.serialize(), this.refreshKeys(), this.render(), this.setStatus(`Cameras look at ${A.name || A.type}`);
      }
    },
    setTransformMode(w) {
      Lt(this, w);
    ...
    refreshInspector() {
      this.perf && (this.perf.inspectorRefreshCount = (this.perf.inspectorRefreshCount || 0) + 1), qa(this), ag(this);
    },
    setInspectorMode(w) {
      og(this, w);
    },
    ...
    applyProxyPreset(w) {
      const A = { balanced: { mode: "omni_ref", burn: !1 }, parallax: { mode: "point_field", burn: !1 }, subject: { mode: "card_grid", burn: !1 }, debug: { mode: "omni_ref", burn: !0 } }, M = A[w] || A.balanced;
    ...
    aimAtSelectedObject(w) {
      ...
      const A = this.activeCameraTrack(), M = w && this.state.objects.find((D) => D.id === w) || this.selectedObject() || this.state.objects.find((D) => D.id === "subject") || this.state.objects[0];
      if (!M) return;
      A.target_object_id !== M.id && (A.aim_bone = null), A.target_object_id = M.id, A.id === this.state.active_camera_id && (this.state.target_object_id = M.id, this.state.aim_bone = A.aim_bone);
      const ee = (M.type === "model" || M.type === "glb" ? this.webgl?.getObjectWorldCenter?.(M.id) : null) || (M.keyframes?.length ? z(M, this.frame).position : M.position || [0, 1.5, 0]);
      this.camera.target = [...ee], this.beginCameraEdit(), this.commitCameraEdit(), this.finishCameraEdit(), this.serialize(), this.refreshInspector(), this.updateHudCamera(), this.render(), this.setStatus(`Camera tracking locked to ${M.name || M.id}`);
    },
    setAimBone(w) {
      Ru(this, w);
    },
    ...
    setCameraTrackingTarget(w) {
      ...
      const A = this.activeCameraTrack();
      A.target_object_id !== (w || null) && (A.aim_bone = null), A.target_object_id = w || null, A.id === this.state.active_camera_id && (this.state.target_object_id = w || null, this.state.aim_bone = A.aim_bone), this.camera = De(A, this.frame, this.state.objects), Vt(this, A, this.camera, this.frame), this.serialize(), this.refreshInspector(), this.render(), this.setStatus(w ? `Camera tracking: ${w}` : "Camera tracking disabled (manual target)");
    },
    bakeAimToKeyframes() {
      this.checkpoint("Bake aim to keyframes");
      const w = this.activeCameraTrack(), A = w.target_object_id || this.state.target_object_id || "subject", M = this.state.objects.find((ee) => ee.id === A) || this.state.objects[0];
      if (!M || !w.keyframes?.length) return;
      const B = M.type === "model" || M.type === "glb" ? this.webgl?.getObjectWorldCenter?.(M.id) : null;
      for (const ee of w.keyframes) {
        const D = (M.type === "model" || M.type === "glb") && B && !M.keyframes?.length ? B : M.keyframes?.length ? z(M, ee.frame).position : M.position || [0, 1.5, 0];
        ee.camera.target = [...D];
      }
...
function ng(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: u, syncActiveCameraTrack: b, syncFromWidgets: v, bindEditorEvents: y, activateCamera: x, addCamera: S, deleteCamera: g, drawPreviewOverlays: k, duplicateCamera: _, maximizeCameraPreview: O, refreshCameraPreviews: P, refreshCameraSelectors: K, renameCamera: W, setPlayblastCamera: H, toggleCameraView: oe, captureRealtime: C, makePlayblast: R, uploadDirectorPlayblast: V, waitForMediaFrame: X, computeAudioPeaks: N, loadAudioFile: E, releaseAudio: G, stopPlay: F, togglePlay: Y, applyCameraPreset: Q, applyCameraShake: le, applyProxyPreset: se, clearViewportBgImage: re, loadViewportBgFile: de, loadViewportBgSequence: be, drawCameraPath: fe, drawCard: ge, drawCube: ye, drawGrid: pe, drawHuman: Me, drawLine3D: ve, drawNull: xe, drawOverlays: ue, drawPointField: L, drawSpeedHeatmap: U, drawSphere: me, curveChannels: je, drawCurveEditor: Oe, fitCurveView: Re, onCurveDoubleClick: Pe, onCurvePointerDown: ot, onCurvePointerMove: ea, onCurvePointerUp: ta, onTimelinePointerDown: aa, onTimelinePointerMove: At, onTimelinePointerUp: Tt, refreshKeys: pt, resetCurveZoom: $t, resetTimelineZoom: Mt, setChannelFilter: It, setCurveInterpolation: oa, setTangentMode: Ot, timelineFrameFromEvent: ra, toggleCurveHandles: na, zoomCurve: sa, drawTransformGizmo: ia, frameTarget: ca, gizmoAxes: la, gizmoGeometry: da, onPointerDown: ma, onPointerMove: pa, onPointerUp: fa, onWheel: ha, pickGizmo: Pt, pickSceneObject: Lt, resetCamera: ua, setTransformMode: ba, setViewMode: Bo, viewportCamera: qo, loadCardFile: ga, loadExecutionPreview: ya, loadMediaUrl: va, loadModelFile: xa, loadSelectedReference: wa, onModelLoaded: ka, restoreAssets: Sa, syncUpstreamInputs: zt, configureDomMedia: ja, refreshSetupDiagnostic: _a, addMediaCard: Ca, addPrimitive: Ea, applyObjectAnimationFrame: Aa, beginCameraEdit: Ta, beginObjectEdit: $a, commitCameraEdit: Ma, commitObjectEdit: Ia, copyKeyframe: Oa, deleteKeyframe: Pa, deleteObject: La, duplicateObject: za, exitKeyEdit: Na, finishCameraEdit: Fa, goToAdjacentKey: Ra, insertKeyframe: Da, loadSelectedKeyView: Ka, pasteKeyframe: Ba, playblastCameraAtFrame: qa, refreshInspector: Ua, refreshKeyEditor: Wa, refreshObjects: Va, removeObjectResources: Ha, renameObject: Ga, retimeSelectedKey: Ya, selectKeyframe: Xa, selectedKeyframe: Ja, selectedObject: Za, selectObjectAnimation: Qa, setKeyInterpolation: eo, setObjectParent: rt, timelineKeyframes: to, timelineObject: ao, toggleAutoKey: oo, toggleObject: ro, updateCameraFromHud: no, updateEditState: so, updateKeyVisualState: io, updateSelectedKey: Nt, updateSelectedObject: co, clamp: lo, cloneCamera: mo, configureCore: ft, defaultCamera: Uo, sampleCamera: ht, sampleObjectTransform: De, sanitizeState: z, worldTransform: $ } = e;
  return {
    setTargetAtCursor(j) {
      if (!j) return;
      const w = this.interactionElement.getBoundingClientRect(), A = (j.clientX - w.left) * this.canvas.width / Math.max(1, w.width), M = (j.clientY - w.top) * this.canvas.height / Math.max(1, w.height), B = this.webgl?.intersectScenePoint?.(A, M, this.canvas.width, this.canvas.height);
      B && (this.checkpoint("Set camera target"), this.beginCameraEdit(), this.camera.target = [
        Math.round(B[0] * 1e3) / 1e3,
        Math.round(B[1] * 1e3) / 1e3,
        Math.round(B[2] * 1e3) / 1e3
    ...
    async loadMediaUrl(j, w, A, M) {
      return va(this, j, w, A, M);
    },
    restoreAssets() {
      Sa(this);
    },
...
function ig(e) {
  const { right: t, up: a, forward: o } = Fc(e || {});
  return sg.map((r) => {
...
const dg = "http://www.w3.org/2000/svg", wt = 26, Bn = 17, mg = 5.4;
function kt(e, t) {
  const a = document.createElementNS(dg, e);
...
function pg(e) {
  ...
  for (const n of cg(ig(a))) {
    const i = wt + n.x * Bn, c = wt + n.y * Bn, l = lg(n.depth);
...
function hg(e) {
  ...
  for (const r of e.state.motion_layers || []) {
    ...
    const n = fg(e.state, r, e.frame, a, o);
    if (n.length) {
...
const ug = ["world_point", "object_point", "camera_field"], di = {
  manual_2d: "DRAW",
  object_point: "OBJECT",
  world_point: "WORLD",
...
function gg(e, t) {
  if (ug.includes(t.source_kind)) {
    const a = Ar(e, t.source, 0, e.width || 1280, e.height || 720);
...
function xg(e) {
  ...
  n("motion-sel-name", a.label), n("motion-sel-type", di[a.source_kind] || "TRACK"), n("motion-sel-binding", bg(e.state, a)), n("motion-sel-start", r.length ? Math.min(...r) : 0), n("motion-sel-end", r.length ? Math.max(...r) : 0);
...
function Sg(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: u, syncActiveCameraTrack: b, syncFromWidgets: v, bindEditorEvents: y, activateCamera: x, addCamera: S, deleteCamera: g, drawPreviewOverlays: k, duplicateCamera: _, maximizeCameraPreview: O, refreshCameraPreviews: P, refreshCameraSelectors: K, renameCamera: W, setPlayblastCamera: H, toggleCameraView: oe, captureRealtime: C, makePlayblast: R, uploadDirectorPlayblast: V, waitForMediaFrame: X, computeAudioPeaks: N, loadAudioFile: E, releaseAudio: G, stopPlay: F, togglePlay: Y, applyCameraPreset: Q, applyCameraShake: le, applyProxyPreset: se, clearViewportBgImage: re, loadViewportBgFile: de, loadViewportBgSequence: be, drawCameraPath: fe, drawCard: ge, drawCube: ye, drawCylinder: pe, drawGrid: Me, drawHuman: ve, drawLine3D: xe, drawNull: ue, drawOverlays: L, drawPointField: U, drawSpeedHeatmap: me, drawSphere: je, drawTorus: Oe, curveChannels: Re, drawCurveEditor: Pe, onCurvePointerDown: ot, onCurvePointerMove: ea, onCurvePointerUp: ta, onTimelinePointerDown: aa, onTimelinePointerMove: At, onTimelinePointerUp: Tt, refreshKeys: pt, resetCurveZoom: $t, resetTimelineZoom: Mt, setChannelFilter: It, setCurveInterpolation: oa, setTangentMode: Ot, timelineFrameFromEvent: ra, toggleCurveHandles: na, zoomCurve: sa, drawTransformGizmo: ia, frameTarget: ca, gizmoAxes: la, gizmoGeometry: da, onPointerDown: ma, onPointerMove: pa, onPointerUp: fa, onWheel: ha, pickGizmo: Pt, pickSceneObject: Lt, resetCamera: ua, setTransformMode: ba, setViewMode: Bo, viewportCamera: qo, loadCardFile: ga, loadExecutionPreview: ya, loadMediaUrl: va, loadModelFile: xa, loadSelectedReference: wa, onModelLoaded: ka, restoreAssets: Sa, syncUpstreamInputs: zt, configureDomMedia: ja, refreshSetupDiagnostic: _a, addMediaCard: Ca, addPrimitive: Ea, applyObjectAnimationFrame: Aa, beginCameraEdit: Ta, beginObjectEdit: $a, commitCameraEdit: Ma, commitObjectEdit: Ia, copyKeyframe: Oa, deleteKeyframe: Pa, deleteObject: La, duplicateObject: za, exitKeyEdit: Na, finishCameraEdit: Fa, goToAdjacentKey: Ra, insertKeyframe: Da, loadSelectedKeyView: Ka, pasteKeyframe: Ba, playblastCameraAtFrame: qa, refreshInspector: Ua, refreshKeyEditor: Wa, refreshObjects: Va, removeObjectResources: Ha, renameObject: Ga, retimeSelectedKey: Ya, selectKeyframe: Xa, selectedKeyframe: Ja, selectedObject: Za, selectObjectAnimation: Qa, setKeyInterpolation: eo, setObjectParent: rt, timelineKeyframes: to, timelineObject: ao, toggleAutoKey: oo, toggleObject: ro, updateCameraFromHud: no, updateEditState: so, updateKeyVisualState: io, updateSelectedKey: Nt, updateSelectedObject: co, clamp: lo, cloneCamera: mo, configureCore: ft, defaultCamera: Uo, sampleCamera: ht, sampleObjectTransform: De, sanitizeState: z, worldTransform: $ } = e;
  return {
    ...
    renderViewportOnly() {
      const j = this.ctx, w = this.canvas.width, A = this.canvas.height;
      if (j.fillStyle = this.state.viewport_bg_color || "#121212", j.fillRect(0, 0, w, A), this.viewportBgSequenceImages && this.viewportBgSequenceImages.length) {
        const ne = this.frame % this.viewportBgSequenceImages.length, Ye = this.viewportBgSequenceImages[ne];
        if (Ye?.complete && Ye.naturalWidth)
          try {
            j.drawImage(Ye, 0, 0, w, A);
          } catch {
          }
      } else if (this.viewportBgImage)
        try {
          j.drawImage(this.viewportBgImage, 0, 0, w, A);
        } catch {
        }
      const M = this.state.render_mode, B = this.viewportCamera(), ee = this.state.objects.some((ne) => ne.parent_id) ? this.state.objects.map((ne) => ne.parent_id ? { ...ne, ...$(this.state.objects, ne) } : ne) : this.state.objects, D = (this.viewportBgSequenceImages || []).map((ne) => ne.src), J = this.viewportBgImage?.src || "", ke = this.pendingExtractorImport, Ke = ke ? [...this.state.cameras, {
      ...
      if (this.webgl) {
        try {
          const ne = this.recording ? 1 : this.webgl.supersampleFactor?.() ?? 1, Ye = ne > 1 ? Math.min(ne, 4096 / Math.max(1, w, A)) : 1, po = Ye > 1 ? Math.round(w * Ye) : w, Wo = Ye > 1 ? Math.round(A * Ye) : A;
          this.webgl.render(nt, B, this.cardMediaById, po, Wo, this.modelUrlsById, this.frame, this.recording, this.selectedEntity, this.selectedObjectId, this.subSelection, this.selectedKeyFrame ?? null, this.selectedKeyFrames ? [...this.selectedKeyFrames] : null), j.imageSmoothingEnabled = !0, j.imageSmoothingQuality = "high", po !== w || Wo !== A ? j.drawImage(this.webgl.canvas, 0, 0, po, Wo, 0, 0, w, A) : j.drawImage(this.webgl.canvas, 0, 0, w, A), te = !0;
        } catch (ne) {
      ...
      !this.recording && this.state.speed_heatmap && this.drawSpeedHeatmap(), !this.recording && _h(this), this.drawOverlays(), hg(this), this.state.show_gizmo && pg(this), this.labelOverlay?.update(), this.rigOverlay?.update(), this.perf && (this.perf.viewportRenderCount = (this.perf.viewportRenderCount || 0) + 1);
    },
    ...
    requestUiUpdate(j = T.viewport, w = "unknown") {
      (this.renderReasons ||= /* @__PURE__ */ new Set()).add(w), this.uiDirtyMask = Jm(this.uiDirtyMask, j), this.renderInvalidations = (this.renderInvalidations || 0) + 1, !this.renderScheduled && (this.renderScheduled = !0, this.renderFrame = requestAnimationFrame(() => {
        if (this.renderScheduled = !1, this.disposed) return;
        const A = this.uiDirtyMask || T.viewport;
        this.uiDirtyMask = 0, this.lastRenderReasons = [...this.renderReasons || []], this.renderReasons?.clear(), this.rendersCoalesced = (this.rendersCoalesced || 0) + 1, this.perf && (this.perf.renderCount = (this.perf.renderCount || 0) + 1), gt(A, T.outliner) && this.refreshObjects(), gt(A, T.timeline) && this.refreshKeys(), gt(A, T.inspector) && this.refreshInspector(), gt(A, T.viewport) && this.renderViewportOnly(), gt(A, T.previews) && this.renderCameraView(), gt(A, T.motion) && this.renderMotionUiOnly();
      }));
    },
    renderCameraView() {
      if (this.perf && (this.perf.previewRenderCount = (this.perf.previewRenderCount || 0) + 1), this.state.camera_view_visible) {
        ...
        let M = null;
        if (A) {
          const B = this.state.active_camera_id, ee = w.filter((D) => D.id !== B);
          M = ee.length ? ee[this.cameraPreviewTick % ee.length] : null;
        }
        for (const B of w) {
          const ee = this.cameraPreviewCanvases.get(B.id), D = this.cameraPreviewContexts.get(B.id);
          if (!ee?.width || !D) continue;
          const J = ee.width, ke = ee.height, Ke = this.root.querySelector(`[data-camera-frame="${B.id}"]`);
          if (Ke && (Ke.textContent = `F${this.frame}`), A && B.id !== this.state.active_camera_id && B !== M) continue;
          const nt = Vt(this, B, ht(B, this.frame, this.state.objects), this.frame);
          if (D.fillStyle = "#111", D.fillRect(0, 0, J, ke), this.cameraWebgl)
            try {
              this.cameraWebgl.render({ ...this.state, keyframes: [], playblast_grid: !1, viewport_bg_image: this.viewportBgImage?.src || "", viewport_bg_sequence: (this.viewportBgSequenceImages || []).map((te) => te.src), __omnicamRevision: this.renderRevision || 0 }, nt, this.cardMediaById, J, ke, this.modelUrlsById, this.frame, !0), D.drawImage(this.cameraWebgl.canvas, 0, 0, J, ke);
            } catch (te) {
    ...
    dispose() {
      this.disposed || (this.disposed = !0, this.agentBridge?.dispose?.(), this.transformControlsWiring?.dispose(), Rc(this), Dc(), wl(this), this.backgroundRequestId = (this.backgroundRequestId || 0) + 1, this.upstreamSyncId = (this.upstreamSyncId || 0) + 1, this.stopPlay(), clearTimeout(this.previewClickTimer), clearTimeout(this.connectionTimer), cancelAnimationFrame(this.restoreFrame), cancelAnimationFrame(this.serializeFrame), cancelAnimationFrame(this.resizeFrame), cancelAnimationFrame(this.renderFrame), this.abortController?.abort(), this.upstreamFetchController?.abort(), this.resizeObserver?.disconnect(), this.contextMenu?.dispose(), this.webgl?.dispose(), this.cameraWebgl?.dispose(), G(this), Zh(this), this.objectUrls.clear(), this.cardMediaById.clear(), this.cardMediaAssetById?.clear?.(), this.modelUrlsById.clear(), this.modelInfoById.clear());
    }
  };
}
const jg = 0.12;
  ...
  return {
    ...
    _activeTrack() {
      ...
      return {
        kind: "camera",
        write: (a) => {
          t.keyframes = a, this.state.keyframes = a, ir(this);
        }
      };
    },
    deleteSelectedKeyframes() {
      ...
      const t = this._activeTrack(), a = Ee(this), o = t.kind === "camera" ? 1 : 0, { keys: r, removed: n } = Ub(a, e, { minKeys: o });
    ...
    nudgeSelectedKeyframes(e) {
      ...
      const a = this._activeTrack(), o = Math.max(0, this.state.duration_frames - 1), r = Wb(Ee(this), t, e, { lastFrame: o });
    ...
    setSelectedKeysInterpolation(e) {
      ...
      this.checkpoint(s("Interpolation on {n} keys").replace("{n}", t.length)), a.write(Vb(Ee(this), t, e)), this.serialize(), this.refreshKeys(), this.refreshKeyEditor(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} interpolation on {n} keys").replace("{mode}", e.replace(/_/g, " ")).replace("{n}", t.length));
    },
    setSelectedKeysTangentMode(e) {
      const t = this.resolveSelectedFrames();
      if (t.length < 2) return this.setTangentMode(e);
      const a = this._activeTrack(), o = mt(this).map((r) => r.id);
      this.checkpoint(s("Tangents on {n} keys").replace("{n}", t.length)), a.write(Hb(Ee(this), t, e, o)), this.serialize(), this.refreshKeys(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} tangents on {n} keys").replace("{mode}", e).replace("{n}", t.length));
    },
    /**
    ...
    simplifyActiveKeys({ mode: e = "simplify", tolerance: t = 0, target: a = 0, scope: o = "camera", fromKeys: r = null, silent: n = !1 } = {}) {
      ...
      const l = this.resolveSelectedFrames(), p = o !== "all_cameras" && l.length >= 2 ? [l[0], l.at(-1)] : null, m = p ? [] : l, f = (u) => {
        const b = [...u].sort((O, P) => O.frame - P.frame), v = p ? p[0] : -1 / 0, y = p ? p[1] : 1 / 0, x = b.filter((O) => O.frame < v), S = b.filter((O) => O.frame >= v && O.frame <= y), g = b.filter((O) => O.frame > y);
        let k = S, _ = 0;
        if (S.length > 2) {
          const O = e === "reduce" ? Bb(S, i, { target: a || Math.ceil(S.length / 2), keepFrames: m }) : e === "clean" ? qb(S, i, { keepFrames: m }) : Kb(S, i, { tolerance: t * jg, keepFrames: m });
          k = O.keys, _ = O.removed;
        }
        return { keys: [...x, ...k, ...g].sort((O, P) => O.frame - P.frame), removed: _ };
      };
      let d = 0;
      const h = c.map((u) => {
      ...
      return ir(this), this.selectedKeyFrame = null, this.selectedKeyFrames = /* @__PURE__ */ new Set(), this.camera = $e(this.state, this.frame), this.applyObjectAnimationFrame(), this.serialize(), this.refreshKeys(), this.setFrame(this.frame, !1, !1), this.render(), n || this.setStatus(d ? s("Removed {n} keyframes").replace("{n}", d) : s("No keyframes to remove")), d;
    },
...
class mi {
  constructor(t) {
    this.app = qn, this.api = at, this.node = t, this.root = Ss(), this.root.tabIndex = -1, this.dom = $s(this.root), this.canvas = this.root.querySelector(".viewport-wrap > canvas"), this.cameraPreviewCanvases = /* @__PURE__ */ new Map(), this.cameraPreviewContexts = /* @__PURE__ */ new Map(), this.cameraPreviewSignature = "", this.interactionElement = this.canvas, this.interactionElement.tabIndex = 0, this.interactionElement.dataset.captureWheel = "true", this.ctx = this.canvas.getContext("2d", { alpha: !1 }), this.disposed = !1, this.renderRevision = 0, this.directorRevision = 0, this.webgl = null, this.cameraWebgl = null, this.webglReady = this.loadWebGLViewports(), this.transformControlsWiring = sf(this), this.stateWidget = t.widgets?.find((o) => o.name === "state_json"), this.recordingWidget = t.widgets?.find((o) => o.name === "recording_path"), this.cardWidget = t.widgets?.find((o) => o.name === "card_asset"), this.widthWidget = t.widgets?.find((o) => o.name === "width"), this.heightWidget = t.widgets?.find((o) => o.name === "height"), this.fpsWidget = t.widgets?.find((o) => o.name === "fps"), this.durationWidget = t.widgets?.find((o) => o.name === "duration_seconds"), this.modeWidget = t.widgets?.find((o) => o.name === "render_mode");
    let a = null;
    try {
      a = JSON.parse(this.stateWidget?.value || "{}");
    } catch {
    }
    this.state = _r(a), // The scene "Reset" command reverts to whatever was last saved or opened;
    // the state the node mounts with is that baseline until then.
    this.sceneBaseline = this.stateWidget?.value || JSON.stringify(this.state), this.sceneName = this.state.metadata?.scene_name || "", this.frame = 0, this.camera = $e(this.state, 0), this.playing = !1, this.drag = null, this.cameraEditActive = !1, this.cameraEditKey = null, this.keyDrag = null, this.timelineDrag = null, this.curveDrag = null, this.selectedKeyFrame = this.state.keyframes[0]?.frame ?? null, this.pathSelection = Kc(), this.editingKeyFrame = null, this.copiedKeyframe = null, this.cameraSpeed = 1, this.cardMedia = null, this.cardMediaById = /* @__PURE__ */ new Map(), this.cardMediaAssetById = /* @__PURE__ */ new Map(), this.objectUrls = new ks(), this.cardUrlsById = this.objectUrls.urls, this.modelUrlsById = /* @__PURE__ */ new Map(), this.modelInfoById = /* @__PURE__ */ new Map(), this.executionReferences = [], this.selectedObjectId = null, this.selectedEntity = "camera", this.subSelection = null, this.cardUrl = null, this.recording = !1, this.gizmoDrag = null, this.playTimer = null, this.previewClickTimer = null, this.showCurveHandles = !0, this.uiDirtyMask = 0, this.perf = globalThis.__omnicamPerf === !0 ? { renderCount: 0, viewportRenderCount: 0, previewRenderCount: 0, timelineRefreshCount: 0, inspectorRefreshCount: 0, lastFrameMs: 0 } : null, this.contextMenu = new is(this.root), this.history = new ws({ capture: () => JSON.stringify({ state: this.state, frame: this.frame, selectedEntity: this.selectedEntity, selectedObjectId: this.selectedObjectId, selectedObjectIds: [...this.selectedObjectIds || []], selectedKeyFrame: this.selectedKeyFrame, selectedKeyFrames: [...this.selectedKeyFrames || []], subSelection: this.subSelection }), restore: (o) => this.restoreHistorySnapshot(o) }), this.refreshCameraPreviews(), this.initializeTooltips(), this.bindEditorEvents(), this.bindWidgetCallbacks(), this.syncFromWidgets(), this.resizeCanvas(), this.render(), this.refreshKeys(), this.refreshObjects(), this.restoreAssets(), this.syncUpstreamInputs(), this.refreshSetupDiagnostic(), // Seed every frame-derived readout (timecode, lens millimetres, viewport
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-Df-T0Gt1.js"));
    } catch (a) {
    ...
    if (!this.disposed) {
      ...
      Bc(this), this.resizeCanvas(), this.render(), this.renderCameraView();
    }
  }
}
const ko = { app: qn, api: at, EditorHistory: ws, ContextMenuController: is, initializeTooltips: Sl, promptText: Yt, ObjectUrlRegistry: ks, buildRoot: Ss, dispatchDirectorKey: qc, activeCameraTrack: sr, bindWidgetCallbacks: jl, playblastCameraTrack: ss, restoreFromWidgets: _l, serializeEditorState: Cl, syncActiveCameraTrack: ir, syncFromWidgets: El, bindEditorEvents: Rh, activateCamera: Al, addCamera: Tl, deleteCamera: $l, drawPreviewOverlays: Ml, duplicateCamera: Il, maximizeCameraPreview: Ol, refreshCameraPreviews: Pl, refreshCameraSelectors: Ll, renameCamera: zl, setPlayblastCamera: Nl, toggleCameraView: Fl, captureRealtime: Hs, makePlayblast: fu, uploadDirectorPlayblast: Gs, waitForMediaFrame: Vs, computeAudioPeaks: Ks, loadAudioFile: Yh, releaseAudio: Oo, stopPlay: Eo, togglePlay: Vh, applyCameraPreset: cf, applyCameraShake: lf, applyProxyPreset: df, clearViewportBgImage: gu, loadViewportBgFile: uu, loadViewportBgSequence: bu, drawCameraPath: Mu, drawCard: $u, drawCube: ju, drawCylinder: Eu, drawGrid: xu, drawHuman: Cu, drawLine3D: ie, drawNull: Tu, drawOverlays: Ou, drawPointField: Su, drawSpeedHeatmap: Iu, drawSphere: _u, drawTorus: Au, curveChannels: mt, drawCurveEditor: kd, fitCurveView: us, onCurveDoubleClick: xd, onCurvePointerDown: md, onCurvePointerMove: pd, onCurvePointerUp: fd, onTimelinePointerDown: Uc, onTimelinePointerMove: Wc, onTimelinePointerUp: Vc, refreshKeys: Nd, resetCurveZoom: wd, resetTimelineZoom: Hc, setChannelFilter: ud, setCurveInterpolation: hd, setTangentMode: bd, timelineFrameFromEvent: xr, toggleCurveHandles: gd, zoomCurve: vd, drawTransformGizmo: Gc, frameTarget: Yc, gizmoAxes: Xc, gizmoGeometry: Jc, onPointerDown: Zc, onPointerMove: Qc, onPointerUp: el, onWheel: tl, pickGizmo: al, pickSceneObject: ol, resetCamera: rl, setTransformMode: nl, setViewMode: sl, viewportCamera: il, loadCardFile: ou, loadExecutionPreview: ru, loadMediaUrl: Ws, loadModelFile: au, loadSelectedReference: nu, onModelLoaded: tu, restoreAssets: eu, syncUpstreamInputs: su, configureDomMedia: Bs, refreshSetupDiagnostic: zu, addMediaCard: Hu, addPrimitive: qu, applyObjectAnimationFrame: lb, beginCameraEdit: bb, beginObjectEdit: ti, commitCameraEdit: gb, commitObjectEdit: Xu, copyKeyframe: fb, deleteKeyframe: pb, deleteObject: ei, deleteSelectedObjects: Vu, duplicateObject: Qs, exitKeyEdit: vb, finishCameraEdit: yb, goToAdjacentKey: Tb, insertKeyframe: db, loadSelectedKeyView: Ab, pasteKeyframe: hb, playblastCameraAtFrame: cb, refreshInspector: Gu, refreshKeyEditor: _b, refreshObjects: Zs, removeObjectResources: ab, renameObject: Uu, retimeSelectedKey: Cb, selectKeyframe: ub, selectedKeyframe: Ge, selectedObject: Qt, selectObjectAnimation: tb, setKeyInterpolation: mb, setKeyTangentMode: jb, setObjectParent: eb, timelineKeyframes: Ee, timelineObject: ze, toggleAutoKey: xb, toggleObject: Wu, updateCameraFromHud: Qu, updateCameraRotationFromHud: Zu, updateEditState: kb, updateKeyVisualState: Sb, updateSelectedKey: Eb, updateSelectedObject: Yu, clamp: Z, cloneCamera: ce, configureCore: ns, defaultCamera: Sr, sampleCamera: $e, sampleObjectTransform: Fo, sanitizeState: _r, worldTransform: Cr };
Object.assign(
  mi.prototype,
  Lb(ko),
  rg(ko),
...
function Cg(e) {
  ...
  So("director:attach:start", e), So("director:constructor:start", e);
  const t = new mi(e);
  So("director:constructor:complete", e), jp(t);
  try {
    t.agentBridge = Mp(t, e, at);
  } catch (m) {
  ...
  try {
    t.assetBrowser = Vp(t, {
      ...
      onAgentFirstOpen: async () => {
        if (or())
          try {
            const { createDirectorAgentPanel: m } = await import("./chunk-CANSQ1Tx.js");
            t.agentPanel = m(t);
          } catch (m) {
  ...
  try {
    t.characterRuntime = Gp(t), t.rigMapper = Xp(t), t.poseEditor = Qp(t), t.motionEditor = ef(t);
  } catch (m) {
    console.warn("[OmniCam] Character tools unavailable", m);
  }
  e.__majoorOmniCam = t, So("director:marker:assigned", e), t.hideInternalWidgets();
  ...
  }, t.unwatchGraphConnections = kl(e, i);
  const l = e.onRemoved;
