...
import { s as $e, c as Q, t as ue, a as s, o as os, b as _r, d as Ye, e as ce, f as Do, r as Ei, g as Cr, h as rs, i as Ai, j as Ti, k as $i, l as Mi, m as Er, n as Ar, I as Co, D as Ii, p as Tr, q as Oi, w as Pi, u as $o, v as ns, x as Li, y as $r, z as ir, A as Qr, B as ss, C as cr, E as is, F as cs, G as ls, H as ds, J as lr, K as Yo, L as en, O as tn, R as ms, M as Ni, N as Fi, P as zi, Q as Ri, S as Di, T as fe, U as ps, V as fs, W as an, X as Fe, Y as Ki, Z as hs, _ as Bi, $ as qi, a0 as Mr, a1 as Ui, a2 as Wi, a3 as Vi, a4 as Hi, a5 as Gi, a6 as Ir, a7 as Yi, a8 as Xi, a9 as Ji, aa as Zi, ab as Qi, ac as ec, ad as tc, ae as ac, af as oc, ag as rc, ah as nc, ai as sc, aj as ic, ak as cc, al as lc, am as dc, an as mc, ao as pc, ap as fc, aq as hc, ar as uc, as as bc, at as gc, au as yc, av as vc, aw as xc, ax as wc, ay as kc, az as Sc, aA as jc, aB as _c, aC as Cc, aD as Ec, aE as Ac, aF as Tc, aG as $c, aH as Mc, aI as Ic, aJ as Oc, aK as Pc, aL as Lc, aM as Nc, aN as Fc, aO as Ve, aP as zc, aQ as Xo, aR as Rc, aS as Dc, aT as Kc, aU as Bc, aV as qc, aW as Ge, aX as Uc, aY as us, aZ as Or, a_ as Wc, a$ as Vc, b0 as Hc, b1 as bs, b2 as tt, b3 as Gc, b4 as Yc, b5 as on, b6 as Pr, b7 as Xc, b8 as gs, b9 as Jc, ba as Zc, bb as Jo, bc as rn, bd as Ko, be as Qc, bf as el, bg as tl, bh as al, bi as ol, bj as rl, bk as nl, bl as sl, bm as ys, bn as il, bo as cl, bp as ll, bq as dl, br as ml, bs as pl, bt as fl, bu as hl, bv as ul, bw as bl, bx as gl, by as yl, bz as vl, bA as xl, bB as wl, bC as kl, bD as Sl, bE as jl, bF as _l } from "./chunk-CEInYxLm.js";
import { L as Cl, a as El, p as Xt, f as Lr, b as Al, S as Tl, c as nn, d as $l, e as Ml, r as Il, g as Ol, n as Pl, C as sn, h as Jt, o as vs, i as Ll, s as Nl, j as Fl, k as xs, l as zl, m as dr, q as mr, w as Rl, t as ws, u as Dl, v as Kl, x as Bl, y as ql, z as Ul, A as Wl, B as Vl, D as Hl, E as Gl, F as Yl, G as Xl, H as Jl, I as Zl, J as Ql, K as ed, M as td } from "./chunk-Sxo1EvMO.js";
import { S as ad, b as od, p as rd, m as nd, l as sd, u as id } from "./chunk-DjvDVpt_.js";
import { T as cd } from "./chunk-__IQ4xkd.js";
import { T as ld, R as dd } from "./vendor-three-BQUrLQkn.js";
function Dt(e, t = 0) {
  return Math.sin(e * 1.7 + t * 3.1) * 0.5 + Math.sin(e * 3.3 + t * 5.7) * 0.3 + Math.sin(e * 7.9 + t * 11.3) * 0.2;
}
function md(e, { type: t = "handheld_subtle", intensity: a = 1, duration_frames: o = null, subdivide: r = !0 } = {}) {
  ...
  return [...u].sort((y, x) => y - x).map((y) => {
    const x = $e(b, y), S = Dt(y * m, 1) * l, g = Dt(y * m, 2) * l, k = Dt(y * m, 3) * l * 0.5, _ = Dt(y * m, 4) * p, I = Dt(y * m, 5) * (p * 0.35), P = [...x.position], B = [...x.target];
...
function pd(e, { duration_frames: t = 120, target: a = [0, 1.5, 0], radius: o = 6, height: r = 3.5 } = {}) {
...
const Ss = [
  ...
  },
  {
    ...
    label: "Look At",
    color: "#f0a742",
    changed: (e, t) => fd(e?.target, t?.target),
    read: (e) => e?.target
  },
  {
    id: "focal_length",
...
function Mo(e) {
  ...
  for (const a of [".oc-playhead-head", '[data-role="dope-playhead"]', ".oc-gdope-playhead", ".oc-sequence-playhead"])
    for (const o of e.root.querySelectorAll(a)) bd(o, t);
}
function gd(e, t, a) {
...
function js(e) {
  ...
  a.delete("camera");
  const o = e.timelineKeyframes() || [], r = ud(o, a), n = vd(e, r);
  if (t.dataset.signature !== n) {
    t.dataset.signature = n, t.replaceChildren();
    const i = (c) => ue(e, c);
    for (const c of r) {
      const l = document.createElement("div");
      l.className = "oc-dope-row", l.dataset.channel = c.id, l.style.setProperty("--channel-color", c.color), gd(l, c.frames, i), yd(e, l, c, o, i), t.appendChild(l);
    }
  }
...
function xd(e, t) {
  const a = Math.max(1, e.state.duration_frames - 1), o = Q(Number(e.timelineZoom) || 1, 0.1, 50), r = Number(e.timelinePan) || 0, n = a / o, i = Es(n, t), l = (i >= ln ? i / ln : 0) || i, p = [], m = Math.max(0, Math.floor(r / l) * l);
...
function Cd(e, { left: t, right: a, top: o, width: r, graphWidth: n, graphHeight: i, height: c, timeMin: l, timeMax: p, totalDuration: m, xFor: f, frame: d }) {
  const h = Es(p - l, n);
...
function Ed(e, { left: t, right: a, top: o, width: r, graphHeight: n, minimum: i, maximum: c, yFor: l }) {
  const p = jd(c - i, 4);
  e.strokeStyle = "#222228", e.lineWidth = 1, e.fillStyle = "#6e727a";
  for (let m = Math.ceil(i / p) * p; m <= c; m += p) {
    const f = l(m);
    f < o - 1 || f > o + n + 1 || (e.beginPath(), e.moveTo(t, f), e.lineTo(r - a, f), e.stroke(), e.fillText(_d(m, p), 4, f + 3));
  }
}
function Nr(e, t) {
...
function Ts(e, { selectedOnly: t = !1 } = {}) {
  const a = Math.max(1, (e.state?.duration_frames ?? 120) - 1), o = e.timelineKeyframes() || [], r = e.timelineObject(), n = ht(e), i = e.selectedKeyFrames?.size ? [...e.selectedKeyFrames] : e.selectedKeyFrame != null ? [e.selectedKeyFrame] : [], c = i.length > 0, l = t || c && i.length < o.length ? o.filter((u) => i.includes(u.frame)) : o;
  if (!l.length) {
...
function Rd(e) {
  ...
  const i = e.timelineObject(), c = e.timelineKeyframes(), l = ht(e), p = 44, m = 14, f = 16, d = 22, h = Math.max(1, a - p - m), b = Math.max(1, o - f - d), u = Math.max(1, e.state.duration_frames - 1), v = Q(Number(e.curveZoomX) || 1, 0.1, 50), y = Number(e.curvePanX) || 0, x = u / v, S = y, g = y + x, k = [], _ = Math.max(1, Math.ceil(x / Math.max(80, h))), I = (A) => i ? Do(i, A) : $e(e.state, A);
  ...
  if (n.fillStyle = "#111114", n.fillRect(0, 0, a, o), n.strokeStyle = "#222228", n.lineWidth = 1, n.font = "9px system-ui, -apple-system, sans-serif", n.fillStyle = "#6e727a", Cd(n, {
    left: p,
    right: m,
    top: f,
    width: a,
    ...
    xFor: V,
    frame: e.frame
  }), Ed(n, { left: p, right: m, top: f, width: a, graphHeight: b, minimum: B, maximum: W, yFor: X }), B <= 0 && W >= 0) {
    const A = X(0);
  ...
  for (const A of l) {
    ...
    let G = !1;
    k.forEach((z) => {
      const Y = V(z.frame), ee = X(A.get(z.value));
      Y >= p - 50 && Y <= a - m + 50 && (G ? n.lineTo(Y, ee) : (n.moveTo(Y, ee), G = !0));
    }), n.stroke();
    for (const z of c) {
      const Y = i ? z.transform : z.camera, ee = V(z.frame), le = X(A.get(Y)), se = z.frame === e.selectedKeyFrame || e.selectedKeyFrames?.has(z.frame);
    ...
    if (e.showCurveHandles)
      for (let z = 0; z < c.length; z++) {
        const Y = c[z], ee = Y.frame === e.selectedKeyFrame || e.selectedKeyFrames?.has(Y.frame);
        if (!(ee || e.curveChannelFilter !== "all" || c.length <= 4) || Y.interpolation !== "bezier") continue;
        const se = i ? Y.transform || i : Y.camera || Y, re = V(Y.frame), de = X(A.get(se)), ge = c[z - 1], he = c[z + 1], ye = Math.max(1, Y.frame - (ge?.frame ?? Y.frame - 1)), ve = Math.max(1, (he?.frame ?? Y.frame + 1) - Y.frame), pe = Ei(
          Y,
          A.id,
          ge,
          he,
        ...
        (ge || z > 0) && be.push({ side: "in", x: re + pe.in_x * we, y: de - pe.in_y / Me }), (he || z < c.length - 1 || c.length === 1) && be.push({ side: "out", x: re + pe.out_x * xe, y: de - pe.out_y / Me });
        for (const L of be) {
  ...
  if (e.curveBoxSelect) {
    const A = Math.min(e.curveBoxSelect.startX, e.curveBoxSelect.currentX), G = Math.min(e.curveBoxSelect.startY, e.curveBoxSelect.currentY), z = Math.abs(e.curveBoxSelect.currentX - e.curveBoxSelect.startX), Y = Math.abs(e.curveBoxSelect.currentY - e.curveBoxSelect.startY);
    n.fillStyle = "rgba(56, 189, 248, 0.15)", n.fillRect(A, G, z, Y), n.strokeStyle = "#38bdf8", n.lineWidth = 1, n.setLineDash([4, 4]), n.strokeRect(A, G, z, Y), n.setLineDash([]);
  }
  const F = V(e.frame);
  if (F >= p && F <= a - m && (n.strokeStyle = "#a78bfa", n.lineWidth = 1.5, n.beginPath(), n.moveTo(F, f), n.lineTo(F, f + b), n.stroke(), n.fillStyle = "#a78bfa", n.beginPath(), n.moveTo(F - 4, f), n.lineTo(F + 4, f), n.lineTo(F, f + 6), n.closePath(), n.fill()), e.curveDrag || e.curveHover) {
    let A = "", G = "";
    if (e.curveDrag)
      if (e.curveDrag.handle) {
        const z = e.curveDrag.handle === "in" ? "In" : "Out";
        A = `F${e.curveDrag.key.frame} · ${e.curveDrag.channel.name} (${z})`, G = "Tangent edit";
      } else if (e.curveDrag.group && e.curveDrag.group.length > 1) {
        const z = e.curveDrag.key.frame - e.curveDrag.startFrame, Y = e.curveDrag.channel.get(e.curveDrag.object ? e.curveDrag.key.transform : e.curveDrag.key.camera), ee = Y - e.curveDrag.startValue, le = z >= 0 ? `+${z}` : `${z}`, se = ee >= 0 ? `+${ee.toFixed(2)}` : `${ee.toFixed(2)}`;
      ...
      if (e.curveHover.channelName) {
        const z = Number.isFinite(e.curveHover.value) ? e.curveHover.value.toFixed(2) : "";
        A = `F${e.curveHover.frame} · ${e.curveHover.channelName}: ${z}`, e.curveHover.isHandle && (G = `Handle ${e.curveHover.handleSide}`);
      } else
        A = `Frame ${e.curveHover.frame}`;
    if (A) {
      n.save(), n.font = "11px system-ui, -apple-system, sans-serif";
      const z = n.measureText(A), Y = G ? n.measureText(G) : { width: 0 }, ee = Math.max(z.width, Y.width) + 16, le = G ? 32 : 20, se = a - m - ee - 6, re = f + 6;
  ...
  for (const A of e.root.querySelectorAll("[data-tangent-mode]")) {
    const G = e.selectedKeyframe(), z = G?.tangents?.channels?.[l[0]?.id]?.mode || G?.tangents?.mode || "auto";
    A.classList.toggle("active", A.dataset.tangentMode === z);
  }
  for (const A of e.root.querySelectorAll("[data-channel-filter]"))
...
function $s(e) {
  ...
  if (!t) return;
  const a = e.timelineObject(), o = a ? a.name || a.type : e.activeCameraTrack().name, r = Dd(e), n = `${o}\0${r.map((c) => `${c.id}:${c.color}`).join("|")}`;
  if (t.dataset.signature !== n) {
    t.dataset.signature = n, t.replaceChildren();
...
function mn(e, t, a) {
  ...
  for (const n of [...e].sort((i, c) => i.frame - c.frame)) {
    ...
    (r === null || !(Math.abs(c - r) <= Kd)) && o.push(n.frame), r = c;
  }
  return o;
}
function Fr(e) {
...
function Vd(e, t, a, o) {
  ...
  if (c.className = "oc-sequence-name", c.textContent = r?.name || t.camera_id, i.appendChild(c), a > 0) {
    ...
    l.className = "oc-sequence-handle", l.title = s("Drag to trim the cut"), l.addEventListener("pointerdown", (p) => Ud(e, p, l, o, a)), i.appendChild(l);
  }
...
function Os(e, t) {
  ...
  if (n.className = "oc-sequence-lane", n.dataset.role = "sequence-lane", n.setAttribute("aria-label", s("Multi-camera edit")), o.length)
    for (const [c, l] of o.entries()) {
      ...
      ue(e, l.end + 1) < -5 || p > 105 || n.appendChild(Vd(e, l, c, r));
    }
  else {
    const c = document.createElement("span");
  ...
  r.appendChild(n), r.appendChild(Hd(e));
  const i = document.createElement("span");
  i.className = "oc-sequence-playhead", i.style.left = `${ue(e, e.frame)}%`, r.appendChild(i), t.appendChild(r);
}
const Gd = ['[data-act="curve-zoom-in"]', '[data-act="curve-zoom-out"]', '[data-act="curve-fit"]', '[data-act="curve-handles"]'], fn = { curves: "Graph", dope: "Timeline", sequence: "Sequence" };
function hn(e, t) {
  ...
  a === "dope" ? Fr(e) : a === "sequence" ? (Os(e, n), n?.focus?.({ preventScroll: !0 })) : e.drawCurveEditor(), e.setStatus(s(fn[a]));
}
function Yd(e) {
...
const Jd = /* @__PURE__ */ new Set(["good", "warning", "bad", "unknown"]);
function Ps(e, t) {
  ...
  for (const n of r.frames) {
    ...
    const c = Jd.has(n?.state) ? n.state : "unknown", l = n?.score;
    let p = null;
    if (l != null) {
      const m = Number(l);
...
function em(e) {
  ...
  for (const x of o) {
    ...
    k.className = "key-label", k.textContent = String(x.frame), g.appendChild(k), g.addEventListener("pointerdown", (_) => {
      if (_.preventDefault(), _.stopPropagation(), g.focus({ preventScroll: !0 }), _.altKey) {
        ...
        const P = a ? { frame: x.frame, transform: Ye(x.transform), interpolation: x.interpolation } : { frame: x.frame, camera: ce(x.camera), interpolation: x.interpolation }, B = e.timelineKeyframes();
  ...
  y && (y.textContent = m.name), As(e), js(e), $s(e), Fr(e), Yd(e), e.refreshCameraSelectors(), e.refreshKeyEditor(), e.updateEditState(), e.drawCurveEditor(), e.perf && (e.perf.timelineRefreshCount = (e.perf.timelineRefreshCount || 0) + 1), Qd(e);
}
class Ls {
...
async function zr(e, { route: t, field: a = "file", file: o }) {
...
const cm = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/><path d="M2 12h20"/></svg>', lm = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m21 16-9 5-9-5V8l9-5 9 5v8z"/><path d="m3.27 6.96 8.73 4.84 8.73-4.84"/><path d="M12 22V12"/></svg>', dm = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2L2 20h20L12 2z"/><path d="M12 2v18"/></svg>', mm = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/><path d="m17.66 17.66 1.41 1.41"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="m6.34 17.66-1.41 1.41"/><path d="m19.07 4.93-1.41 1.41"/></svg>', pm = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18h6"/><path d="M10 22h4"/><path d="M15.09 14c.18-.98.65-1.74 1.41-2.5A4.65 4.65 0 0 0 18 8 6 6 0 0 0 6 8c0 1 .23 2.23 1.5 3.5.76.76 1.23 1.52 1.41 2.5"/></svg>', fm = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l8 8-4 4-8-8 4-4z"/><path d="M7 11L2 16l6 6 5-5"/><path d="M18 19l4 2"/><path d="M21 16l2 2"/></svg>', hm = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m22 8-6 4 6 4V8z"/><rect width="14" height="12" x="2" y="6" rx="2"/></svg>', um = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14h6v6H4z"/><circle cx="17" cy="7" r="3"/><path d="m6 3 4 7H2z"/></svg>';
function bm() {
  return `
...
function wm() {
  const e = El.map((t) => `<button data-lens="${t}">${t}mm</button>`).join("");
  return `
...
const at = 1, bn = 50, Ie = 120, gt = 160, Km = Object.freeze(["perspective", "orthographic"]), q = Object.freeze({
...
}), Bm = Object.freeze(Object.values(ke));
...
const qm = 25, gn = 100;
function yt(e, t) {
  const a = e?.offset === void 0 ? 0 : Number(e.offset), o = e?.limit === void 0 ? qm : Number(e.limit);
...
function Qm(e, t) {
  ...
  e.objects ||= [];
  const a = new Set(e.objects.map((i) => i.id)), o = Bo(a, t.objectType, t.id), r = Hm(t.objectType), n = {
    id: o,
    type: t.objectType,
    name: t.name || o,
    ...r,
...
function cp(e, t) {
  ...
  for (a.has(t) && a.delete(t), a.add(t); a.size > ip; )
...
function mp(e, t) {
  ...
  if (e.camera_type !== void 0 && !Km.includes(e.camera_type))
...
function pp(e, t) {
  ...
  switch (a) {
    ...
    case q.CAMERA_CREATE:
      if (e.id !== void 0 && ae(e.id, "id", t, Ie), e.name !== void 0 && ae(e.name, "name", t, gt), e.camera !== void 0) {
    ...
    case q.CAMERA_DUPLICATE:
      ae(e.cameraId, "cameraId", t, Ie), e.id !== void 0 && ae(e.id, "id", t, Ie), e.name !== void 0 && ae(e.name, "name", t, gt);
      break;
    ...
    case q.CAMERA_RENAME:
      ae(e.cameraId, "cameraId", t, Ie), ae(e.name, "name", t, gt);
      break;
    case q.OBJECT_CREATE:
      if (ae(e.objectType, "objectType", t), !Rs.has(e.objectType))
      ...
      e.id !== void 0 && ae(e.id, "id", t, Ie), e.name !== void 0 && ae(e.name, "name", t, gt), e.position !== void 0 && Ae(e.position, "position", t), e.rotation !== void 0 && Ae(e.rotation, "rotation", t);
      break;
    case q.OBJECT_DUPLICATE:
      ae(e.objectId, "objectId", t, Ie), e.id !== void 0 && ae(e.id, "id", t, Ie), e.name !== void 0 && ae(e.name, "name", t, gt), e.offset !== void 0 && Ae(e.offset, "offset", t);
      break;
    case q.OBJECT_DELETE:
      ae(e.objectId, "objectId", t, Ie);
      break;
    case q.OBJECT_RENAME:
      ae(e.objectId, "objectId", t, Ie), ae(e.name, "name", t, gt);
      break;
    ...
    case q.CAMERA_TRANSFORM:
      if (e.cameraId !== void 0 && ae(e.cameraId, "cameraId", t), e.position !== void 0 && Ae(e.position, "position", t), e.target !== void 0 && Ae(e.target, "target", t), e.frame !== void 0 && qe(e.frame, "frame", t), e.position === void 0 && e.target === void 0)
    ...
    case q.CHARACTER_SET_JOINT_ROTATION:
      if (ae(e.objectId, "objectId", t), ae(e.joint, "joint", t), !Array.isArray(e.rotation) || e.rotation.length !== 4 || !e.rotation.every(dt))
    ...
    case q.KEYFRAME_UPSERT:
      if (e.cameraId !== void 0 && ae(e.cameraId, "cameraId", t), qe(e.frame, "frame", t), e.interpolation !== void 0 && !Co.includes(e.interpolation))
        throw new O("BAD_INTERPOLATION", `Unsupported interpolation: ${e.interpolation}`, t);
      if (e.camera !== void 0) {
    ...
    case q.KEYFRAME_REMOVE:
      e.cameraId !== void 0 && ae(e.cameraId, "cameraId", t), qe(e.frame, "frame", t);
      break;
    case q.KEYFRAME_SET_INTERPOLATION:
      if (e.cameraId !== void 0 && ae(e.cameraId, "cameraId", t), qe(e.frame, "frame", t), !Co.includes(e.interpolation))
        throw new O("BAD_INTERPOLATION", `Unsupported interpolation: ${e.interpolation}`, t);
      break;
    ...
    case q.TIMELINE_SET_DURATION:
      ...
      break;
    case q.CUT_UPSERT:
      qe(e.start, "start", t), ae(e.cameraId, "cameraId", t);
      break;
    case q.CUT_REMOVE:
      qe(e.start, "start", t);
      break;
...
function fp(e, t) {
  ...
  return t.operations.forEach((a, o) => pp(a, o)), {
    version: at,
    id: t.id,
...
const up = "omnicam/library", bp = "majoor_omnicam/blockout_library", gp = Object.freeze({
...
function Ds(e) {
  return e.file ? `${e.source === "legacy" ? bp : up}/${e.file} [input]` : "";
}
function yn(e, t, a) {
  const o = e || "asset";
  let r = `${o}_${a}`, n = 2;
...
function xp(e, t = {}) {
  ...
  const a = yp(t.point, [0, 0, 0]), o = String(t.idSeed || Date.now().toString(36)), r = String(e.kind || "prop"), n = r === "character", i = gp[e.id];
  ...
  return n && (c.character = vp(e)), c;
}
function wp({ groundHit: e, orbitTarget: t } = {}) {
...
const kp = {
  [q.ASSET_INSTANTIATE](e, t) {
    ...
    let o;
    try {
      o = xp(t.asset, { point: t.point, idSeed: t.id, existingIds: a });
    } catch (r) {
...
function _p(e, t) {
  ...
  return Ep(e, t, r), Tp(e, t, r), Mp(e, t, r), $p(e, t, r), Ip(e, t, r), Op(e, t, r), { changes: a, truncated: o };
}
const Cp = ["fov", "roll", "zoom", "near", "far", "camera_type"];
function Ep(e, t, a) {
...
const Ap = ["position", "target", "fov", "roll", "zoom", "near", "far", "camera_type"];
function Tp(e, t, a) {
  const o = ot(e?.cameras), r = ot(t?.cameras);
  for (const [n, i] of r) {
...
function Rp(e, t) {
  ...
  if (a.validateOnly) {
    const { changes: f, truncated: d } = _p(e.state, r);
    return {
      ok: !0,
      version: at,
      revision: o,
  ...
  const l = Lp(e);
  cp(e, a.id), e.serialize?.(), Np(e, l), zp(e, n, `director-api:${a.id}`);
  const p = {
    ok: !0,
    version: at,
    baseRevision: o,
...
function Kp(e) {
  return e.directorApi = Dp(e), e.directorApi;
}
const xn = "omnicam-agent/1", wn = "majoor.omnicam.agent.request", Bp = 1, Bt = Object.freeze({
...
}), qp = 1e4, Up = 5e3, Ks = "asset.instantiate_by_id", Bs = "asset.catalog_search", kn = Object.freeze([
...
function Gp(e, t, a) {
  ...
  async function d() {
    ...
    try {
      const k = await qt(a, Bt.register, {
        protocol: xn,
        client_id: g,
        node_id: String(t.id),
  ...
  async function v(S) {
    const g = S?.detail;
    if (o || !g || g.protocol !== xn || Number(g.schema_version) !== Bp || g.session_id !== r || String(g.node_id) !== String(t.id)) return;
    let k;
    try {
      if (g.kind === "query")
        k = g.payload?.type === Bs ? await Hp(e, g.payload) : e.directorApi.query(g.payload);
        ...
        if (!Number.isInteger(_?.baseRevision) || _.baseRevision < 0)
          ...
          const P = await Vp(e, _.operations);
          P.ok ? (k = e.directorApi.execute({ ..._, operations: P.operations }), await k?._reconciliation) : k = Ut(e, P.code, P.message);
        }
      } else
        k = Ut(e, "UNKNOWN_AGENT_REQUEST", `Unsupported Agent request kind: ${g.kind}`);
    } catch (_) {
      k = Ut(e, _?.code || "INTERNAL", _?.message || "OmniCam Agent request failed");
    }
    try {
      await qt(a, Bt.reply, {
        session_id: r,
...
function Rr({ fetchApi: e = Yp } = {}) {
  const t = (a, o) => Promise.resolve(e(a, o)).then(Xp);
  return {
    list(a = {}) {
      const { kind: o, tag: r, search: n, offset: i, limit: c } = a, l = { tag: r, search: n, offset: i, limit: c };
      return o && o !== "all" && (l.kind = o), t(`${Ne}${Sn(l)}`);
    },
    get(a) {
    ...
    importModel(a, o = {}) {
      const r = new FormData();
      return r.append("file", a, o.filename || a.name || "model.glb"), t(`${Ne}/import${Sn(o)}`, { method: "POST", body: r });
    },
    importLocalCharacters({ folder: a, licenseNote: o = "", idPrefix: r = "", dryRun: n = !1 } = {}) {
      return t(`${Ne}/import-local`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          folder: a,
...
function sf(e, t = {}) {
  return qs.map((a) => {
    const o = s(nf[a] || a), r = a === "all" ? "" : ` <span class="oc-asset-kind-n">${Number(t[a] || 0)}</span>`;
    return `<button type="button" class="oc-asset-kind${a === (e || "all") ? " active" : ""}" data-asset-kind="${a}">${_t(o)}${r}</button>`;
  }).join("");
}
function cf(e, { selected: t = !1, thumbUrl: a = "" } = {}) {
  const o = rf[e.kind] || "pi-box", r = e.kind === "character" && ss(e.rig) === "rigged" ? `<span class="oc-asset-badge">${s("RIGGED")}</span>` : "", n = a ? `<img class="oc-asset-thumb" src="${_t(a)}" alt="" loading="lazy">` : `<span class="oc-asset-thumb oc-asset-thumb--glyph"><i class="pi ${o}"></i></span>`;
...
function lf(e, { selectedId: t = "", thumbUrls: a = {} } = {}) {
  return !e || !e.length ? `<p class="oc-asset-empty">${s("No assets match this filter.")}</p>` : e.map((o) => cf(o, {
    selected: o.id === t,
    thumbUrl: a[o.id] || ""
  })).join("");
}
...
function df(e, t = {}) {
  const a = e.root, o = t.fetchApi || ((L, U) => (e.api || e.app?.api).fetchApi(L, U)), r = t.apiClient || Rr({ fetchApi: o }), n = t.store || Zp(r), i = Qp(), c = t.previewQueue || ef(), l = e.api || e.app?.api || null;
  let p = t.thumbnailRenderer || null, m = null;
  const f = /* @__PURE__ */ new Set();
  function d() {
    return p ? Promise.resolve(p) : (m || (m = af().then((L) => p = _n(L)).catch(() => p = _n({}))), m);
  }
  function h(L) {
    return Qr(l, Ds(L));
  }
    ...
    for (const L of n.state.items) {
      ...
      U && c.enqueue(L.id, async () => {
        ...
        if (i.set(L.id, _e), Y(), !(L.source && L.source !== "user"))
          try {
            const Oe = await r.uploadThumbnail(L.id, of(_e));
  ...
  let oe = "", E = null, K = !0, V = !0, X = "scene", F = 0;
  function A(L, { sticky: U = !1 } = {}) {
    k && (!U && F > Date.now() || (k.textContent = L || "", F = U ? Date.now() + 9e3 : 0));
  }
  function G(L) {
    if (oe = L, !!x)
  ...
  let z = !1;
  function Y() {
    if (S && (S.innerHTML = sf(n.state.filter.kind, n.state.kinds)), x) {
      const L = {};
      for (const U of n.state.items) {
        const me = i.get(U.id) || b(U);
        me && (L[U.id] = me);
      }
      x.innerHTML = lf(n.state.items, { selectedId: oe, thumbUrls: L });
    }
    if (!z) {
      z = !0;
      try {
  ...
  async function he(L) {
    ...
    F = 0, A(L ? s("Scanning {folder}...").replace("{folder}", U) : s("Installing characters from {folder}...").replace("{folder}", U));
    try {
      ...
      if (L) {
        const Pe = (me.candidates || []).map((st) => st.name).join(", ");
        A(
      ...
      const Oe = (me.installed || []).filter((Pe) => Pe.status !== "conflict").length, Ke = (me.installed || []).filter((Pe) => Pe.status === "conflict").length;
      A(
        s("{n} character(s) installed{extra} — no restart needed").replace("{n}", Oe).replace("{extra}", _e || Ke ? ` (${_e} ${s("skipped")}${Ke ? `, ${Ke} ${s("unchanged")}` : ""})` : ""),
        { sticky: !0 }
  ...
  function l() {
    ...
    for (const v of b) {
      ...
      const x = ls(b, v, h) || {
        position: v.position,
        size: v.size
      }, S = e.webgl.projectWorldToScreen(ds(x, v.type));
...
function gf(e, t = {}) {
  ...
  function S() {
    ...
    l && (l.textContent = E);
    const V = h(), X = y(V?.character)[E] || [0, 0, 0, 1], F = zi(X);
    p.forEach((A, G) => {
      A && document.activeElement !== A && (A.value = String(Math.round(F[G] * 100) / 100));
    });
  }
  function g() {
    ...
    if (i && (i.classList.toggle("active", f), i.disabled = K, i.title = K ? s("Clear the motion clip to edit the pose") : s("Toggle FK pose editing")), n) {
      const V = [["neutral", s("Standing Neutral")]].concat([...d.values()].filter((F) => F.id !== "neutral").map((F) => [F.id, F.name || F.id])), X = V.map((F) => F.join(":")).join("|");
      n.dataset.sig !== X && (n.dataset.sig = X, n.replaceChildren(...V.map(([F, A]) => {
        const G = document.createElement("option");
        return G.value = F, G.textContent = A, G;
  ...
  function _() {
    const E = u();
    if (!E) return;
    const K = p.map((F) => Number(F?.value) || 0), V = Ni(K), X = e.directorApi?.execute({
      version: 1,
  ...
  function I() {
    const E = n?.value || "neutral", K = d.get(E) || $o({ preset_id: E });
  ...
  async function P() {
    ...
    const K = (await Xt(e, s("Save Pose"), s("Pose name"), ""))?.trim();
    if (!K || e.disposed) return;
    const V = K.toLowerCase().replace(bf, "-").replace(/^-+|-+$/g, "").slice(0, 60) || "pose";
    try {
...
const vf = /* @__PURE__ */ new Set(["translate", "rotate", "scale"]), xf = /* @__PURE__ */ new Set(["world", "local"]), We = 180 / Math.PI;
function Tn(e) {
  return [e.x, e.y, e.z];
}
function wf(e) {
...
function kf({
  ...
  const m = p ? p() : new e.Object3D(), f = l ? l(t, a) : new ld(t, a);
  let d = null;
  ...
  function v() {
    return {
      ...
      rotationDeg: wf(m.rotation),
      scale: Tn(m.scale)
    };
  }
  function y(F) {
    m.position.set(...F.position), m.rotation.set(
      F.rotationDeg[0] / We,
      F.rotationDeg[1] / We,
      F.rotationDeg[2] / We
    ), m.scale.set(...F.scale);
  ...
  function x(F) {
    return b ? {
      position: F.position.map((A, G) => A - b.position[G]),
      rotationDeg: F.rotationDeg.map((A, G) => A - b.rotationDeg[G]),
      scaleFactors: F.scale.map((A, G) => b.scale[G] === 0 ? 1 : A / b.scale[G])
  ...
  function I(F) {
    h = F, m.position.set(...F.position || [0, 0, 0]);
    const A = F.rotation || [0, 0, 0];
    m.rotation.set(A[0] / We, A[1] / We, A[2] / We), m.scale.set(...F.scale || [1, 1, 1]), f.attach(m), f.visible = !0;
  }
  function P() {
    h = null, b = null, f.detach(), f.visible = !1;
  }
  function B(F) {
    "camera" in f && (f.camera = F);
  }
  function W(F) {
    if (!vf.has(F)) throw new Error(`createTransformControlsAdapter: unknown mode "${F}"`);
    f.setMode ? f.setMode(F) : f.mode = F;
  }
  function H(F) {
    if (!xf.has(F)) throw new Error(`createTransformControlsAdapter: unknown space "${F}"`);
    f.space = F;
  }
  function oe(F) {
    f.setTranslationSnap ? f.setTranslationSnap(F) : f.translationSnap = F;
  }
  function E(F) {
    f.setRotationSnap ? f.setRotationSnap(F) : f.rotationSnap = F;
  }
  function K(F) {
    f.setScaleSnap ? f.setScaleSnap(F) : f.scaleSnap = F;
  }
  function V() {
    if (!b) return;
    const F = b;
...
function jf(e, { controlsFactory: t, anchorFactory: a } = {}) {
  let o = null, r = null;
  function n() {
    return o || (!e.webgl || !e.interactionElement ? null : (o = kf({
      THREE: cd,
  ...
  function i({ targetSpec: k }) {
    if (k) {
      if (k.type === "object") {
        ...
        const _ = Di(e), I = (_.length ? _ : [k.object]).map((B) => ({
          object: B,
          transform: Ye(B)
        }));
  ...
  function p(k) {
    ...
    _ && (_.keyframes = hs(r.baseKeys, c(k)), l(_));
  }
  function m(k) {
    const _ = e.state.cameras.find((P) => P.id === r.trackId);
    if (!_) return;
    const I = { ...c(k), lookAtActive: r.lookAtActive };
    _.keyframes = Bi(r.baseKeys, r.selectedFrames, I), l(_);
  }
  function f(k) {
    const _ = e.state.cameras.find((I) => I.id === r.trackId);
    _ && (_.keyframes = qi(r.baseKeys, [r.frame], { delta: k.position }), l(_));
  }
  function d({ delta: k }) {
  ...
  function h(k) {
    ...
    for (const B of _)
      if (P === "translate")
        ...
        B.object.position = fe(I, an(Fe(B.transform.position, I), k.rotationDeg)), B.object.rotation = fe(B.transform.rotation, k.rotationDeg);
      else if (P === "scale") {
        const W = Fe(B.transform.position, I);
  ...
  function b(k) {
    if (e.state.gizmo_mode === "translate")
      ...
      const _ = Fe(r.target, r.position);
  ...
  function u(k) {
    ...
    r.tracking ? Ki(e, _) : e.camera.target = _, e.commitCameraEdit();
  }
  ...
  function y() {
    ...
    const k = e.recording ? null : Ri(e), _ = e.state.gizmo_mode || "translate";
    if (!(!!k && !k.readOnly && Sf.has(k.type) && k.allowedModes.includes(_))) {
      o?.detach();
      return;
    }
...
function _f(e, t) {
  ...
  const a = e.activeCameraTrack(), o = pd(t, {
...
function Cf(e, t) {
  ...
  const o = md(a, { type: t, intensity: 1, duration_frames: e.state.duration_frames });
...
function qo(e, t, a) {
  ...
  const o = Tt(e), r = o.expanded ? 220 : 138, n = Math.min(r, Math.max(80, Math.min(t, a) - 20)), i = 10, c = Math.max(0, t - n - i), l = Math.max(0, a - n - i), p = e.viewportCamera(), m = p?.position || [0, 1.5, 5], f = p?.target || [0, 0, 0], d = e.activeCameraTrack?.(), h = e.state.cameras?.length ? e.state.cameras : d ? [d] : [], b = h.flatMap(
...
function Mf(e, t, a, o) {
  const r = qo(e, a, o);
  if (!r) return;
  const { rx: n, ry: i, radarSize: c, cx: l, cy: p, innerRadius: m, range: f, scale: d, camPos: h, camTgt: b, cameras: u, activeTrack: v } = r, y = Tt(e), x = e.state.active_camera_id || v?.id, S = (re, de) => Ws(r, re, de);
  ...
  const [_, I] = S(h[0] || 0, h[2] || 0), [P, B] = S(b[0] || 0, b[2] || 0), W = 8, H = Q(_, n + W, n + c - W), oe = Q(I, i + W, i + c - W), E = Q(P, n + W, n + c - W), K = Q(B, i + W, i + c - W), V = h[1] || 0, X = Tf(V), F = $f(V);
  ...
  const A = b[0] - h[0], G = b[2] - h[2], z = Math.atan2(G, A), ee = (e.viewportCamera().fov || 35) * Math.PI / 360, le = Q(24 * (d / (m / 8)), 16, 38), se = t.createRadialGradient(H, oe, 2, H, oe, le);
  se.addColorStop(0, X + "55"), se.addColorStop(1, X + "08"), t.fillStyle = se, t.strokeStyle = X, t.lineWidth = 1.2, t.beginPath(), t.moveTo(H, oe), t.lineTo(H + Math.cos(z - ee) * le, oe + Math.sin(z - ee) * le), t.arc(H, oe, le, z - ee, z + ee), t.closePath(), t.fill(), t.stroke(), t.fillStyle = X + "44", t.beginPath(), t.arc(H, oe, 6.5, 0, Math.PI * 2), t.fill(), t.fillStyle = X, t.beginPath(), t.arc(H, oe, 3.5, 0, Math.PI * 2), t.fill(), t.strokeStyle = "#ffffff", t.lineWidth = 1.5, t.beginPath(), t.moveTo(H, oe), t.lineTo(H + Math.cos(z) * 7, oe + Math.sin(z) * 7), t.stroke(), If(e, t, r, X, F, z, Math.hypot(A, G)), y.hover && Of(t, r, y.hover), t.restore();
}
function If(e, t, a, o, r, n, i) {
  ...
  const b = m.expanded ? "⤡" : "⤢";
  go(t, c + 96, f, 14, d, b, m.hover?.button === "size"), t.font = "bold 8.5px monospace", t.fillStyle = o, t.textAlign = "right", t.fillText(`Y:${r}`, c + p - 5, l + 9), t.fillStyle = "rgba(15, 23, 42, 0.70)", t.fillRect(c, l + p - 15, p, 15), t.strokeStyle = "rgba(0, 210, 211, 0.15)", t.beginPath(), t.moveTo(c, l + p - 15), t.lineTo(c + p, l + p - 15), t.stroke();
...
function Ff(e, t, a) {
  ...
  const o = () => {
    ...
    const b = String(t('[data-role="object-annotation"]')?.value || "").trim(), u = b ? ns({
      text: b,
  ...
  }, { signal: a }), kd(e, a), Xd(e, a), t('[data-role="curve-group"]')?.addEventListener("change", () => {
    e.setChannelFilter("all"), $s(e), e.drawCurveEditor(), Fr(e);
  ...
  e.root.addEventListener("pointerdown", (d) => {
    ...
    const h = e.interactionElement.getBoundingClientRect(), b = (d.clientX - h.left) * e.canvas.width / Math.max(1, h.width), u = (d.clientY - h.top) * e.canvas.height / Math.max(1, h.height);
    Nf(e, d, b, u) || e.onWheel(d);
  }, { passive: !1, signal: a }), e.root.addEventListener("wheel", rd(e.root), { signal: a }), window.addEventListener("pointermove", (d) => {
...
function Df(e) {
  const t = Fc(e.id, e.defaultValue), a = `pref_${e.id.replace(/[^a-zA-Z0-9]/g, "_")}`;
  if (e.type === "boolean")
    return `
...
function Bf() {
  return `<span class="oc-pref-emoji" aria-hidden="true">${zf}</span> ${s("OmniCam Preferences")}`;
}
function qf(e) {
  ...
  a.className = "oc-modal-backdrop", a.setAttribute("role", "dialog"), a.setAttribute("aria-modal", "true"), a.setAttribute("aria-label", s("OmniCam Preferences")), a.innerHTML = `
    <div class="oc-modal-dialog oc-pref-dialog" tabindex="-1">
      <div class="oc-pref-header">
        <div class="oc-pref-title">${Bf()}</div>
...
const Wf = ["position", "target"], Vf = ["fov", "zoom"], Hf = ["roll"], Gf = ["position", "size"], Yf = ["rotation"];
function yr(e) {
...
function oh(e, t) {
  ...
  const o = (r) => {
    ...
    const b = (v) => {
      ...
      let x = eh;
      v.shiftKey ? x = th : (v.ctrlKey || v.metaKey) && (x = ah);
      const S = p * x * 20;
      let g = l + y * S;
...
function ch(e, t) {
  ...
  }, n = (i) => (e.smoothingBaseline?.cameraId !== i.id && (e.smoothingBaseline = { cameraId: i.id, keys: Qf(i.keyframes) }), e.smoothingBaseline.keys);
  a.addEventListener("input", r, { signal: t }), a.addEventListener("change", () => {
    const i = e.activeCameraTrack();
    if (!i) return;
    e.checkpoint("Path smoothing");
    const c = Number(a.value) / 100, l = Zf(n(i), c);
...
const yo = () => import("./chunk-CleWs9ot.js");
function hh(e, t) {
...
function vh(e, t) {
  hh(e, t), ih(e, t), ch(e, t), lh(e, t), dh(e, t), bh(e, t), yh(e, t), gh(e, t), oh(e, t), rh(e, t), mh(e, t), fh(e, t), sh(e, t), ph(e, t), uh(e, t);
}
const Nn = {
...
function xh(e, t = "#1b1f2b", a = "#151822", o = "#1e2330", r = "#161922", n = "#111319") {
...
function fy(e, t, a = Ys) {
  ...
  const h = new e.FogExp2(1250588, 8e-3), b = xh(e), u = new e.PMREMGenerator(t);
  u.compileEquirectangularShader();
  const v = new dd(), y = u.fromScene(v, 0.04).texture;
  return v.traverse((x) => {
    x.geometry?.dispose?.();
...
function _h(e, t, a) {
  ...
  for (const n of e.root.querySelectorAll("[data-lens]"))
    n.addEventListener("click", () => {
      Ol(e, Number(n.dataset.lens));
    }, { signal: a });
  for (const n of e.root.querySelectorAll("[data-blocking-scene]"))
    n.addEventListener("click", () => {
      Af(e, n.dataset.blockingScene), e.closeMenus();
    }, { signal: a });
...
const Ch = 32, Eh = 0.025, Ah = 0.05, Io = 1e-6, Th = ["top", "bottom", "front", "back", "left", "right"], $h = {
  top: "y",
  bottom: "y",
  front: "z",
  back: "z",
...
function Lh(e) {
  ...
  const n = Math.min(Ch, r.length, o + 1);
  if (n < 2) return [];
  const i = Ih(r, n);
  ...
  for (let d = m; d < i.length; d++) {
    const h = i[d], b = Oh(i, d, p, e.planeAxis), u = ce(c);
    u.position = [...h], u.target = Ph(h, b, l, e.planeAxis), f.push({
...
function Fn(e, t = {}) {
  ...
  if (a === "extend") {
    ...
    Th.includes(e.state.view_mode) || e.setViewMode?.("top"), c = xr(e.state);
  const m = $h[e.state.view_mode] ?? null, f = n ? [...n] : [...r.position];
...
function qr(e, t) {
  ...
  return r && Br(r, o) < Eh ? !1 : (a.points.push(o), !0);
}
function He(e) {
...
function Fh(e) {
  ...
  if (a.length < 2 || Mh(a) < Ah || t.range[1] <= t.range[0])
  ...
  const r = Pl(e.state), n = e.state.cameras.length, i = {
    id: r,
    name: Nh(e.state),
...
function qh(e, t) {
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? He(e) : Fn(e);
    }, { signal: t });
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path-extend"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? He(e) : Fn(e, { mode: "extend" });
    }, { signal: t });
...
function Yh(e, t) {
  xo(e, t, e.root.querySelectorAll('[data-act="scene-new"]'), () => Uh(e)), xo(e, t, e.root.querySelectorAll('[data-act="scene-open"]'), () => Hh(e)), xo(e, t, e.root.querySelectorAll('[data-act="scene-save"]'), () => Vh(e)), xo(e, t, e.root.querySelectorAll('[data-act="scene-reset"]'), () => Wh(e));
}
const Xh = ["world_point", "object_point", "camera_field"], zn = 40;
function Jh(e) {
...
function Zh(e, t, a) {
  ...
  for (let c = 0; c <= zn; c += 1) {
    const l = a * c / zn, p = Or(e, t.source, l * o, r, n);
...
function eu(e) {
  ...
  for (const v of e.state.motion_layers || []) {
    if (v.enabled === !1) continue;
    const y = Xh.includes(v.source_kind), x = y ? Zh(e.state, v, d) : Jh(v);
...
function au(e) {
  ...
  Vc(e, t), Hc(e, t), tu(e, t), Uf(e, a, t), _h(e, a, t), Ll(e, t), qh(e, t), Yh(e, t), Ff(e, a, t), vh(e, t);
}
function ou(e, t) {
...
function ru(e, t) {
  ...
  return {
    ...
    motion_scene_fingerprint: nd(e.state)
  };
}
function nu(e, t) {
  const a = ru(e, t);
...
const mt = 1024 * 1024, su = Object.freeze({
  card: 128 * mt,
  // MAX_CARD_BYTES
  model: 256 * mt,
  // MAX_MODEL_BYTES
...
async function du(e, { load: t = () => import("./vendor-mediabunny-CZ5VNE-V.js") } = {}) {
...
async function pu(e, t, { decode: a = du } = {}) {
  if (!t) return;
  const o = Zt(t, "audio");
  if (o) {
    e.setStatus(o);
  ...
  try {
    ...
    n.preload = "auto", n.src = r, e.audioObjectUrl = r, e.audioElement = n, await mu(n), e.audioDuration = Number.isFinite(n.duration) ? n.duration : 0;
    try {
...
function Qt(e, t) {
  ...
  a && (e.cardMediaById.delete(t), e.cardMediaAssetById?.delete?.(t), t === "subject" && e.cardMedia === a && (e.cardMedia = null), hu(a));
}
function uu(e) {
...
function rt(e, t, a, o = !1, r = "") {
  ...
  n && n !== a && Qt(e, t), o && oi.add(a), fu(a), e.cardMediaAssetById ||= /* @__PURE__ */ new Map(), e.cardMediaById.set(t, a), e.cardMediaAssetById.set(t, r || a?.__omnicamAsset || "");
  try {
    a.__omnicamAsset = r || a.__omnicamAsset || "";
  } catch {
  }
...
async function vu(e, t) {
  ...
  try {
    const c = await zr(Et, { route: "/majoor/omnicam/upload_model", field: "asset", file: t });
...
async function xu(e, t) {
  ...
  if (o) {
    ...
    try {
      const r = await zr(Et, { route: "/majoor/omnicam/upload_asset", field: "asset", file: t });
...
async function Su(e) {
  ...
  for (const f of i) {
    ...
    if (h) {
      if (d === "image" || d === "video") {
        ...
        if (b && b.value) {
          const u = String(b.value), v = /\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/i.test(u), y = h.widgets?.find((g) => String(g.name).toLowerCase() === "subfolder")?.value || "", x = tt(wt(u, y)), S = e.state.objects.find((g) => g.id === "subject");
          if (S) {
            const g = await ni(e, S, x, r, v);
            if (!r()) return;
            S.asset = wt(u, y);
            let k = null;
            if (v)
              try {
                k = await bu(u, o.signal);
              } catch (_) {
          ...
          }), rt(e, "subject", u, !1, u.currentSrc || u.src || ""), Rn(e, u, { frameCount: u instanceof HTMLVideoElement ? 0 : 1 }), e.upstreamImageConnected = !0, n = !0, e.render(), e.setStatus(u instanceof HTMLVideoElement ? s("Upstream video preview synced") : s("Upstream image preview synced")));
        }
      }
      if (d === "audio") {
        l = !0;
        ...
        if (b && b.value) {
          const u = String(b.value), v = h.widgets?.find((x) => String(x.name).toLowerCase() === "subfolder")?.value || "", y = tt(wt(u, v));
          try {
      ...
      if (d === "scene_3d" || d === "model" || d === "mesh") {
        ...
        if (b && b.value) {
          ...
          if (["glb", "gltf", "obj", "fbx", "stl", "ply"].includes(v)) {
            const y = h.widgets?.find((k) => String(k.name).toLowerCase() === "subfolder")?.value || "", x = tt(wt(u, y)), S = `upstream_scene_${h.id}`;
            p.add(S);
            let g = e.state.objects.find((k) => k.id === S);
            g ? (g.asset = wt(u, y), g.format = v === "gltf" ? "glb" : v) : (g = {
              id: S,
              type: "model",
              format: v === "gltf" ? "glb" : v,
  ...
  Nl(e) && (n = !0), n && (e.serialize(), e.render());
}
const ju = ["video/mp4;codecs=avc1.42E01E", "video/webm;codecs=vp9", "video/webm;codecs=vp8", "video/webm"], Bn = { low: 3e6, balanced: 6e6, high: 12e6 };
function _u(e) {
  ...
  try {
    for (const S of ju)
      if (!(n.isTypeSupported && !n.isTypeSupported(S)))
        try {
          f = new n(m, { mimeType: S, videoBitsPerSecond: _u(r) });
          break;
        } catch {
        }
...
async function si(e) {
  await Au(e.cardMediaById.values());
}
async function ii(e) {
  return Cu({
    canvas: e.canvas,
...
async function ci(e, t) {
  const a = await Eu(nt, t);
  if (nu(e, t), e.state.playblast_camera_id === bs)
...
async function $u(e) {
  ...
  const t = e.frame, a = e.canvas.width, o = e.canvas.height, r = Tu(e);
  (r.width !== e.canvas.width || r.height !== e.canvas.height) && (e.canvas.width = r.width, e.canvas.height = r.height, e.render());
  try {
    let n = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-C8FKAb56.js");
...
async function li(e) {
  ...
  return zr(Yt, { route: "/majoor/omnicam/upload_asset", field: "asset", file: e });
}
async function Fo(e) {
...
async function Iu(e, t) {
  ...
  try {
    ...
    if (r && await Fo([r]), o !== e.backgroundRequestId || e.disposed) return;
...
async function Ou(e, t) {
  ...
  try {
    ...
    if (await Fo(n), r !== e.backgroundRequestId || e.disposed) return;
...
function Lu(e) {
  ...
  for (const m of a) {
    ...
    r.fillStyle = "rgba(16,17,22,0.82)", Nu(r, _, I, g, k, 4 * c), r.fill(), v && (r.strokeStyle = v, r.lineWidth = Math.max(1, c), r.stroke()), r.fillStyle = v || "#e6e6ec", r.fillText(f, _ + y, I + k - x - 2 * c);
  }
  r.restore();
}
function Nu(e, t, a, o, r, n) {
...
const Ru = 600;
function Du(e) {
  const { points: t, colors: a } = zu(e);
  if (!t.length) return;
  const o = e.viewportCamera(), r = e.canvas.width, n = e.canvas.height, i = t.length / 3, c = 3 * Math.max(1, Math.ceil(i / Ru)), l = /* @__PURE__ */ new Map();
...
function qu(e, t) {
  ...
  const _ = Ge(c, e.viewportCamera(), e.canvas.width, e.canvas.height);
...
function Xu(e) {
  ...
  e.recording && e.state.playblast_labels && Lu(e);
}
async function Ju(e, { signal: t } = {}) {
...
async function Qu(e) {
  ...
  const r = o.diagnostic?.issues || [], n = Zu(r);
...
const eb = 1, qn = 0.01, tb = 0.4, ab = 3, ob = 120, rb = 20, nb = 4, sb = 0.25, ib = 0.5;
function cb(e, t, a) {
...
function db({ keys: e, fps: t = 24, objects: a = [] } = {}) {
  ...
  for (const c of n)
    ...
    }), c.distance < qn && c.duration >= tb && r.push({
      code: "STATIC_SEGMENT",
      severity: "info",
      frameStart: c.frameStart,
      frameEnd: c.frameEnd,
  ...
  if (i.length) {
    ...
    if (c > 1e-6)
      for (const l of n)
        Number.isFinite(l.speed) && l.speed > c * ab && r.push({
          code: "SPEED_SPIKE",
          severity: "warning",
  ...
  if (Array.isArray(a) && a.length)
    for (const c of o)
      for (const l of a) {
        ...
        const p = Number.isFinite(Number(l.radius)) ? Number(l.radius) : ib;
        Ve(Fe(c.camera.position, l.position)) < p + sb && r.push({
...
function pi(e) {
  ...
  const r = (d, h, b, u, v = "") => {
    ...
    `, v.addEventListener("click", () => {
      e.outlinerCollapsedSections ||= /* @__PURE__ */ new Set(), e.outlinerCollapsedSections.has(b) ? e.outlinerCollapsedSections.delete(b) : e.outlinerCollapsedSections.add(b), pi(e);
    ...
    if (t.appendChild(x), !S)
      for (const { object: g, level: k } of y) {
        ...
        K.style.cssText = H ? "color:#fca5a5" : W ? "" : "opacity:.5;text-decoration:line-through", K.textContent = g.name || g.type, K.title = s("Double-click to rename"), K.addEventListener("dblclick", (A) => {
          A.preventDefault(), A.stopPropagation(), bb(e, g, K);
        }), E.appendChild(K);
        ...
        if (V.length) {
          ...
          for (const G of V.slice(0, 2)) {
            ...
            z.className = "scene-item-tag", z.textContent = G, A.appendChild(z);
          }
          if (V.length > 2) {
            const G = document.createElement("span");
        ...
        X.className = "scene-item-actions", X.appendChild(r(W ? "pi-eye" : "pi-eye-slash", W ? "Hide object (Alt+Click to Isolate)" : "Show object (Alt+Click to Isolate)", !W, (A) => {
          if (A?.altKey) {
            if (e.checkpoint("Isolate object"), e._isolatedObjectId === g.id) {
              ...
              const z = e._isolationSnapshot;
              for (const Y of e.state.objects)
                Y.enabled = z && Object.prototype.hasOwnProperty.call(z, Y.id) ? z[Y.id] : !0;
              e._isolationSnapshot = null, e.setStatus?.(s("Isolation cleared"));
            } else {
              e._isolationSnapshot || (e._isolationSnapshot = Object.fromEntries(e.state.objects.map((z) => [z.id, z.enabled !== !1]))), e._isolatedObjectId = g.id;
              for (const z of e.state.objects) z.enabled = z.id === g.id;
        ...
        const F = (A = {}) => {
          ...
          else if (A.shiftKey && e.outlinerAnchorId && e.state.objects.some((z) => z.id === e.outlinerAnchorId)) {
            const z = e.state.objects.map((le) => le.id), Y = z.indexOf(e.outlinerAnchorId), ee = z.indexOf(g.id);
            e.selectedObjectIds = new Set(z.slice(Math.min(Y, ee), Math.max(Y, ee) + 1));
          } else
            e.selectedObjectIds = /* @__PURE__ */ new Set([g.id]), e.outlinerAnchorId = g.id;
          e.selectedObjectId = e.selectedObjectIds.has(g.id) ? g.id : [...e.selectedObjectIds].at(-1) || null, e.selectedEntity = e.selectedObjectIds.size ? "object" : "camera", e.selectedKeyFrame = e.selectedObjectId ? g.keyframes?.find((z) => z.frame === e.frame)?.frame ?? null : null, e.editingKeyFrame = null;
          for (const z of t.querySelectorAll(".scene-item")) {
            const Y = !!(z.dataset.objectId && e.selectedObjectIds.has(z.dataset.objectId)), ee = !!(z.dataset.objectId && z.dataset.objectId === e.selectedObjectId);
            z.classList.toggle("selected", Y), z.classList.toggle("primary", ee), z.dataset.objectId && z.setAttribute("aria-selected", String(Y));
          }
          const G = e.root.querySelector('[data-role="outliner-batch-bar"]');
          if (G) {
            const z = e.selectedObjectIds?.size || 0;
            G.hidden = z < 2;
            const Y = G.querySelector('[data-role="batch-count"]');
            Y && (Y.textContent = `${z} ${s("selected")}`);
          }
        ...
        _.addEventListener("dblclick", () => e.toggleObject(g.id)), _.addEventListener("contextmenu", (A) => {
          ...
          (A.key === "Enter" || A.key === " ") && (A.preventDefault(), F(A));
        }), t.appendChild(_);
      }
  }
...
function kb(e) {
  ...
  if (n) {
    ...
    nr(n, K, () => [
      ...
      ...e.state.objects.map((V) => Wt(V.id, `${s("Track:")} ${V.name || V.type}`))
    ], E);
  }
  ub(e);
  ...
  if (!t) {
    ...
    K && (K.textContent = `${r.name} · F${e.frame}`), Wn(o, {
  ...
  if (v) {
    ...
    const X = e.state.objects.filter((A) => !K.has(A.id)), F = `P${on()}${E}${X.map((A) => `${A.id} ${A.name || A.type}`).join("|")}`;
    nr(v, F, () => [
      Wt("", s("No parent")),
      ...X.map((A) => Wt(A.id, A.name || A.type))
    ], t.parent_id || "");
  }
  ...
  if (b && (b.hidden = !P?.animations), u) {
    ...
    nr(u, `A${E.join("|")}`, () => E.map((K, V) => Wt(String(V), K)), String(t.animation_index || 0));
  }
...
function Cb(e) {
  ...
  e.beginCameraEdit(), Xc(e.camera, r), e.commitCameraEdit(), e.finishCameraEdit(), bi(e), _b(e), e.render();
}
function Eb(e) {
  const t = globalThis.performance?.now?.() ?? Date.now();
  (!Number.isFinite(e.lastCameraHudEditAt) || t - e.lastCameraHudEditAt > 300) && e.checkpoint("Edit camera"), e.lastCameraHudEditAt = t;
  ...
  e.camera.position = [a("camera-px", e.camera.position[0]), a("camera-py", e.camera.position[1]), a("camera-pz", e.camera.position[2])], e.camera.target = [a("camera-tx", e.camera.target[0]), a("camera-ty", e.camera.target[1]), a("camera-tz", e.camera.target[2])], e.camera.fov = Q(a("camera-fov", e.camera.fov), 5, 150), e.camera.roll = Q(a("camera-roll", e.camera.roll || 0), -180, 180), e.camera.near = Math.max(1e-4, a("camera-near", e.camera.near)), e.camera.far = Math.max(e.camera.near + 1e-4, a("camera-far", e.camera.far)), e.beginCameraEdit(), e.commitCameraEdit(), e.finishCameraEdit(), bi(e), e.render();
}
function Ab(e, t) {
  const a = ea(e);
  if (!a) return;
...
function zb(e) {
  ...
  const t = e.root.querySelector('[data-role="key-interp"]')?.value || e.root.querySelector('[data-role="interp"]')?.value || "ease", a = ze(e), o = Ee(e), r = a ? { frame: e.frame, transform: Ye(a), interpolation: t } : { frame: e.frame, camera: ce(e.camera), interpolation: t }, n = o.findIndex((i) => i.frame === e.frame);
...
function Kb(e) {
  const t = ze(e), a = Xe(e) || Ee(e).find((o) => o.frame === e.frame);
...
const Yb = ["guides", "safe-areas", "resolution-gate", "aspect-ratio"];
function Xb(e) {
...
function Qb(e) {
  ...
  t.hidden = !1;
  const o = db({ keys: a, fps: e.state?.fps || 24, objects: e.state?.objects || [] });
  if (!o.length) {
    const r = document.createElement("div");
...
function eg(e) {
  const t = ze(e), a = Xe(e), o = e.root.querySelector('[data-role="key-editor"]');
...
function ag(e) {
  ...
  if (e.checkpoint("Edit keyframe"), e.editingKeyFrame = t.frame, ze(e)) {
    t.interpolation = e.root.querySelector('[data-role="key-interp"]').value, t.transform = Ye(ze(e)), e.serialize(), e.setFrame(t.frame), e.setStatus(s(`Object keyframe updated @ ${t.frame}`));
    return;
  }
  const a = (r, n) => {
  ...
  if (t.interpolation = e.root.querySelector('[data-role="key-interp"]').value, t.camera.position = [a("key-px", t.camera.position[0]), a("key-py", t.camera.position[1]), a("key-pz", t.camera.position[2])], t.camera.target = [a("key-tx", t.camera.target[0]), a("key-ty", t.camera.target[1]), a("key-tz", t.camera.target[2])], t.camera.fov = Q(a("key-fov", t.camera.fov), 5, 150), t.camera.roll = Q(a("key-roll", t.camera.roll || 0), -180, 180), t.camera.zoom = Math.max(0.01, a("key-zoom", t.camera.zoom || 1)), t.camera.near = Math.max(1e-4, a("key-near", t.camera.near)), t.camera.far = Math.max(t.camera.near + 1e-4, a("key-far", t.camera.far)), t.camera.camera_type = e.root.querySelector('[data-role="key-camera-type"]').value, e.root.querySelector('[data-role="key-timing-weight"]')) {
    const r = Jc(t, a("key-timing-weight", gs(t)));
...
function sg(e, t, a, { prevKey: o = null, nextKey: r = null, breakCoupling: n = !1 } = {}) {
  ...
  if (Ro(e), ft(e, t, l), i === "aligned" && !n) {
    const p = t === "out" ? "in" : "out", m = Sr(e, p) || (p === "out" ? kr(e, o, r).out : kr(e, o, r).in), f = Vn(l), d = Vn(m) || f || 1, h = f > wr ? zo(l, -d / f) : zo(m, 1);
    ft(e, p, h);
  }
  return e;
}
...
function ig(e, t, { prevKey: a = null, nextKey: o = null } = {}) {
  ...
  return {
    setSelectMode(N) {
      if (["object", "vertex", "edge", "face"].includes(N)) {
        ...
        for (const M of this.root.querySelectorAll("[data-select-mode]")) {
          const j = M.dataset.selectMode === N;
    ...
    hideInternalWidgets() {
      for (const N of ["state_json", "recording_path", "card_asset"]) {
        const M = this.node.widgets?.find((j) => j.name === N);
    ...
    restoreHistorySnapshot(N) {
      ...
      const j = Hn(this.state), w = new Set(this.state.objects.map((Z) => Z.id));
      this.state = bt(M.state);
      const C = new Set(this.state.objects.map((Z) => Z.id));
      for (const Z of w) C.has(Z) || this.removeObjectResources(Z);
      this.frame = Rt(M.frame, 0, this.state.duration_frames - 1);
      ...
      this.selectedKeyFrames = new Set(R.filter((Z) => J.has(Z))), this.selectedKeyFrame = this.selectedKeyFrames.has(M.selectedKeyFrame) ? M.selectedKeyFrame : [...this.selectedKeyFrames].at(-1) ?? null, this.pathSelection = Zc(this.pathSelection, this.activeCameraTrack()), this.subSelection = M.subSelection || null, this.camera = Je(this.state, this.frame), Ht(this, this.activeCameraTrack(), this.camera, this.frame), this.cameraPreviewSignature = "", this.serialize(), j !== Hn(this.state) && this.restoreAssets(), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
    },
    checkpoint(N) {
    ...
    closeMenus(N = null) {
      for (const M of this.root.querySelectorAll(".toolbar-menu")) M !== N && (M.open = !1);
    ...
    showContextMenu(N, M, j) {
      return this.contextMenu.show(N, M, j);
    },
    onContextMenu(N) {
      ...
      const M = N.target, j = M.closest?.(".camera-preview-tile"), w = M.closest?.(".scene-item"), C = M.closest?.(".key");
      if (j) return this.openCameraContext(N, j.dataset.cameraId, !0);
      ...
      if (C) {
        ...
        return $ && this.selectKeyframe($), this.openTimelineContext(N, !0);
      }
      if (M.closest?.('[data-role="keys"]'))
        return this.setFrame(this.timelineFrameFromEvent(N, M.closest('[data-role="keys"]'))), this.openTimelineContext(N, !1);
      if (M.closest?.(".curve-editor")) return this.openCurveContext(N);
      if (M.closest?.(".viewport-wrap")) {
        const $ = this.interactionElement.getBoundingClientRect(), D = (N.clientX - $.left) * this.canvas.width / Math.max(1, $.width), J = (N.clientY - $.top) * this.canvas.height / Math.max(1, $.height), R = this.pickSceneObject([D, J]);
        if (R) {
    ...
    openObjectContext(N, M) {
      ...
      if (C >= 2 && this.selectedObjectIds.has(M)) {
        this.showContextMenu(N, `${C} ${s("objects selected")}`, [
      ...
      this.showContextMenu(N, j.name || j.type, [
    ...
    openCameraContext(N, M, j = !1) {
      const w = this.state.cameras.find((C) => C.id === M);
      w && (this.selectedEntity = "camera", this.selectedObjectId = null, this.activateCamera(M), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), this.showContextMenu(N, `${w.name}${j ? " preview" : ""}`, [
    ...
    openPathKeyContext(N, M, j) {
      ...
      const $ = C ? pt(C) : "auto", D = this.selectedKeyFrames?.size || 0, J = this.pathSelection?.component === "target", R = fs(w);
      this.showContextMenu(N, `Path key F${j}`, [
    ...
    moveShot(N, M) {
      const j = this.state.cameras.findIndex(($) => $.id === N), w = j + M;
    ...
    async editShotHandles(N) {
      const M = this.state.cameras.find(($) => $.id === N);
      if (!M) return;
    ...
    openTimelineContext(N, M) {
      const j = this.selectedKeyFrames?.size || 0, w = this.selectedKeyframe(), C = w?.interpolation || "ease", $ = w && pt(w) || "auto", D = ["ease", "linear", "bezier", "smooth", "ease_in", "ease_out", "sine", "cubic", "quintic", "expo", "back"], J = ["auto", "clamped", "vector", "free", "aligned", "flat"];
      this.showContextMenu(N, M ? `Keyframe F${this.selectedKeyFrame}` : `Timeline F${this.frame}`, [
    ...
    removeNearestMarker() {
      ...
      if (!N.length) return;
      const M = N.reduce((j, w) => Math.abs(w.frame - this.frame) < Math.abs(j.frame - this.frame) ? w : j);
      this.checkpoint("Remove marker"), this.state.markers = N.filter((j) => j !== M), this.serialize(), this.refreshKeys(), this.setStatus(`Marker removed @ F${M.frame}`);
    },
    openCurveContext(N) {
      const M = this.selectedKeyFrames?.size || 0, j = M < 2 && !this.selectedKeyframe(), w = this.selectedKeyframe(), C = w?.interpolation || "ease", $ = w && pt(w) || "auto", D = ["bezier", "smooth", "linear", "ease_in", "ease_out", "ease", "sine", "cubic", "quintic", "expo", "back"], J = ["auto", "clamped", "vector", "free", "aligned", "flat"];
    ...
    refitNode() {
      ...
      try {
        if (N && typeof N.computeSize == "function" && typeof N.setSize == "function") {
          const M = N.computeSize();
          Array.isArray(M) && N.setSize([N.size?.[0] ?? M[0], M[1]]);
        }
    ...
    resizeCanvas() {
      ...
      if (!N) return;
      const M = Math.min(2, window.devicePixelRatio || 1), j = N.clientWidth || 320, w = N.clientHeight || 180, C = Math.max(320, Math.round(j * M)), $ = Math.max(180, Math.round(w * M));
      ...
      for (const D of this.cameraPreviewCanvases.values()) {
        const J = D.clientWidth || 220, R = D.clientHeight || 124, Z = Math.max(M, lg / Math.max(1, J)), Se = Math.max(1, Math.round(J * Z)), Be = Math.max(1, Math.round(R * Z));
        (D.width !== Se || D.height !== Be) && (D.width = Se, D.height = Be);
      }
...
function Xr(e, t) {
  const a = e.map((i) => fg(i, t)), o = hg(a), r = e.map((i) => i.frame), n = Math.max(1, r[r.length - 1] - r[0]);
  return a.map((i, c) => [
    (r[c] - r[0]) / n,
...
function bg(e, t, { tolerance: a = 0.02, keepFrames: o = [] } = {}) {
...
function gg(e, t, { target: a = 2, keepFrames: o = [] } = {}) {
...
function yg(e, t, { mergeWithin: a = 1, epsilon: o = 1e-3, keepFrames: r = [] } = {}) {
...
function xg(e, t, a, { lastFrame: o = 1 / 0 } = {}) {
...
function _g(e, { leftFrame: t, rightFrame: a, t: o = 0.5 } = {}) {
  ...
  const c = Math.min(0.999, Math.max(1e-3, Number.isFinite(o) ? o : 0.5)), l = Math.round(t + c * (a - t)), p = jg(r, t, a, l);
  ...
  if (u) {
    const S = [...f.camera.position], g = jr(f, h, d).out, k = jr(d, f, b).in, _ = [...d.camera.position], I = Sg(S, g, k, _, m);
    y.camera = { ...ce(v), position: [...I.point] };
    const P = pt(f);
    (P === "free" || P === "aligned") && ko(f, "out", I.left[1]);
    const B = pt(d);
    (B === "free" || B === "aligned") && ko(d, "in", I.right[2]), ko(y, "in", I.left[2]), ko(y, "out", I.right[1]);
  }
...
function Tg({ type: e, camera: t, target: a, startFrame: o, endFrame: r, params: n = {} } = {}) {
  ...
  const l = Cg(t, a), p = Number(n.distance) > 0 ? Number(n.distance) : 1, m = (u, v, y) => ({
...
const es = { motion: "motion", shot: "display", health: "health" }, $g = {
  object: "Object",
  camera: "Camera",
  camera_target: "Look-At Target",
  camera_path: "Camera Path"
}, Mg = { motion: "Motion", shot: "Shot", health: "Health" }, Ig = ["entity", "motion", "shot", "health"];
function Si(e) {
...
function ji(e) {
  ...
  r && (r.textContent = o === "entity" ? s($g[e.selectedEntity] || "Inspector") : s(Mg[o] || "Inspector"));
}
function Ng(e, t) {
  e.inspectorMode = Ig.includes(t) ? t : "entity", ji(e), e.render?.(), e.refitNode?.();
}
function Fg(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: b, syncActiveCameraTrack: u, syncFromWidgets: v, bindEditorEvents: y, activateCamera: x, addCamera: S, deleteCamera: g, drawPreviewOverlays: k, duplicateCamera: _, maximizeCameraPreview: I, refreshCameraPreviews: P, refreshCameraSelectors: B, renameCamera: W, setPlayblastCamera: H, toggleCameraView: oe, captureRealtime: E, makePlayblast: K, uploadDirectorPlayblast: V, waitForMediaFrame: X, computeAudioPeaks: F, loadAudioFile: A, releaseAudio: G, stopPlay: z, togglePlay: Y, applyCameraPreset: ee, applyCameraShake: le, applyProxyPreset: se, clearViewportBgImage: re, loadViewportBgFile: de, loadViewportBgSequence: ge, drawCameraPath: he, drawCard: ye, drawCube: ve, drawGrid: pe, drawHuman: Me, drawLine3D: xe, drawNull: we, drawOverlays: be, drawPointField: L, drawSpeedHeatmap: U, drawSphere: me, curveChannels: _e, drawCurveEditor: Oe, onCurvePointerDown: Ke, onCurvePointerMove: Pe, onCurvePointerUp: st, onTimelinePointerDown: ta, onTimelinePointerMove: aa, onTimelinePointerUp: oa, refreshKeys: $t, resetCurveZoom: Mt, resetTimelineZoom: ut, setChannelFilter: It, setCurveInterpolation: Ot, setTangentMode: Pt, timelineFrameFromEvent: ra, toggleCurveHandles: Lt, zoomCurve: na, drawTransformGizmo: sa, frameTarget: ia, gizmoAxes: ca, gizmoGeometry: la, onPointerDown: da, onPointerMove: ma, onPointerUp: pa, onWheel: fa, pickGizmo: ha, pickSceneObject: ua, resetCamera: Nt, setTransformMode: Ft, setViewMode: ba, viewportCamera: ga, loadCardFile: Wo, loadExecutionPreview: Vo, loadMediaUrl: ya, loadModelFile: va, loadSelectedReference: xa, onModelLoaded: wa, restoreAssets: ka, syncUpstreamInputs: Sa, configureDomMedia: ja, refreshSetupDiagnostic: zt, addMediaCard: _a, addPrimitive: Ca, applyObjectAnimationFrame: Ea, beginCameraEdit: Aa, beginObjectEdit: Ta, commitCameraEdit: $a, commitObjectEdit: Ma, copyKeyframe: Ia, deleteKeyframe: Oa, deleteObject: Pa, deleteSelectedObjects: La, duplicateObject: Na, exitKeyEdit: Fa, finishCameraEdit: za, goToAdjacentKey: Ra, insertKeyframe: Da, loadSelectedKeyView: Ka, pasteKeyframe: Ba, playblastCameraAtFrame: qa, refreshInspector: Ua, refreshKeyEditor: Wa, refreshObjects: Va, removeObjectResources: Ha, renameObject: Ga, retimeSelectedKey: Ya, selectKeyframe: Xa, selectedKeyframe: Ja, selectedObject: Za, selectObjectAnimation: Qa, setKeyInterpolation: eo, setKeyTangentMode: to, setObjectParent: it, timelineKeyframes: ao, timelineObject: oo, toggleAutoKey: ro, toggleObject: no, updateCameraFromHud: so, updateCameraRotationFromHud: io, updateEditState: co, updateKeyVisualState: Rt, updateSelectedKey: lo, updateSelectedObject: mo, clamp: po, cloneCamera: Je, configureCore: Ho, defaultCamera: bt, sampleCamera: Le, sampleObjectTransform: N, sanitizeState: M, worldTransform: j } = e;
  return {
    setChannelFilter(w) {
      It(this, w);
    },
    setFrame(w, C = !1, $ = !0) {
      this.frame = po(Math.round(w), 0, this.state.duration_frames - 1), this.editingKeyFrame !== this.frame && (this.editingKeyFrame = null), this.camera = Le(this.activeCameraTrack(), this.frame, this.state.objects), Ht(this, this.activeCameraTrack(), this.camera, this.frame), this.applyObjectAnimationFrame();
      const D = this.dom ||= Us(this.root);
      ...
      const R = Math.floor(J / 60), Z = Math.floor(J % 60), Se = Math.floor(J % 1 * 1e3), Be = this.frame % Math.max(1, Math.round(this.state.fps)), ct = Math.floor(this.frame / this.state.fps);
    ...
    setSpatialHandleMode(w) {
      ...
      this.checkpoint(s("Camera path handle: {mode}").replace("{mode}", w)), ig($[D], w, {
        prevKey: $[D - 1] || null,
        nextKey: $[D + 1] || null
    ...
    setPathSelectionComponent(w) {
      this.pathSelection = tl(this.pathSelection, w), this.refreshInspector(), this.render();
    },
    ...
    transformCameraPath(w) {
      ...
      return C.keyframes = $, C.id === this.state.active_camera_id && (this.state.keyframes = $), this.camera = Le(C, this.frame, this.state.objects), C.camera = Je(this.camera), this.serialize(), this.refreshKeys(), this.refreshInspector(), this.render(), this.renderCameraView?.(), !0;
    },
    ...
    redistributeActiveCameraTiming() {
      ...
      const C = [...w.keyframes].sort((D, J) => D.frame - J.frame), $ = Qc(C, {
    ...
    async openCameraPathPresetPicker() {
      ...
      const C = ki.map((D) => ({ id: D, label: s(Yn[D] || D) })), $ = await vs({ title: s("Camera Path Preset"), items: C, owner: this });
    ...
    applyCameraPathPreset(w, C = {}) {
      ...
      const [D, J] = xr(this.state), R = Tg({ type: w, camera: this.camera, startFrame: D, endFrame: J, params: C });
    ...
    playblastCameraAtFrame() {
      return Ht(this, d(this), qa(this, Le), this.frame);
    },
    viewportCamera() {
      return ga(this);
    },
    ...
    refreshInspector() {
      this.perf && (this.perf.inspectorRefreshCount = (this.perf.inspectorRefreshCount || 0) + 1), Ua(this), Lg(this);
    },
    setInspectorMode(w) {
      Ng(this, w);
    },
    ...
    aimAtSelectedObject(w) {
      ...
      const J = ($.type === "model" || $.type === "glb" ? this.webgl?.getObjectWorldCenter?.($.id) : null) || ($.keyframes?.length ? N($, this.frame).position : $.position || [0, 1.5, 0]);
    ...
    bakeAimToKeyframes() {
      ...
      for (const J of w.keyframes) {
        const R = ($.type === "model" || $.type === "glb") && D && !$.keyframes?.length ? D : $.keyframes?.length ? N($, J.frame).position : $.position || [0, 1.5, 0];
        J.camera.target = [...R];
      }
...
function zg(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: b, syncActiveCameraTrack: u, syncFromWidgets: v, bindEditorEvents: y, activateCamera: x, addCamera: S, deleteCamera: g, drawPreviewOverlays: k, duplicateCamera: _, maximizeCameraPreview: I, refreshCameraPreviews: P, refreshCameraSelectors: B, renameCamera: W, setPlayblastCamera: H, toggleCameraView: oe, captureRealtime: E, makePlayblast: K, uploadDirectorPlayblast: V, waitForMediaFrame: X, computeAudioPeaks: F, loadAudioFile: A, releaseAudio: G, stopPlay: z, togglePlay: Y, applyCameraPreset: ee, applyCameraShake: le, applyProxyPreset: se, clearViewportBgImage: re, loadViewportBgFile: de, loadViewportBgSequence: ge, drawCameraPath: he, drawCard: ye, drawCube: ve, drawGrid: pe, drawHuman: Me, drawLine3D: xe, drawNull: we, drawOverlays: be, drawPointField: L, drawSpeedHeatmap: U, drawSphere: me, curveChannels: _e, drawCurveEditor: Oe, fitCurveView: Ke, onCurveDoubleClick: Pe, onCurvePointerDown: st, onCurvePointerMove: ta, onCurvePointerUp: aa, onTimelinePointerDown: oa, onTimelinePointerMove: $t, onTimelinePointerUp: Mt, refreshKeys: ut, resetCurveZoom: It, resetTimelineZoom: Ot, setChannelFilter: Pt, setCurveInterpolation: ra, setTangentMode: Lt, timelineFrameFromEvent: na, toggleCurveHandles: sa, zoomCurve: ia, drawTransformGizmo: ca, frameTarget: la, gizmoAxes: da, gizmoGeometry: ma, onPointerDown: pa, onPointerMove: fa, onPointerUp: ha, onWheel: ua, pickGizmo: Nt, pickSceneObject: Ft, resetCamera: ba, setTransformMode: ga, setViewMode: Wo, viewportCamera: Vo, loadCardFile: ya, loadExecutionPreview: va, loadMediaUrl: xa, loadModelFile: wa, loadSelectedReference: ka, onModelLoaded: Sa, restoreAssets: ja, syncUpstreamInputs: zt, configureDomMedia: _a, refreshSetupDiagnostic: Ca, addMediaCard: Ea, addPrimitive: Aa, applyObjectAnimationFrame: Ta, beginCameraEdit: $a, beginObjectEdit: Ma, commitCameraEdit: Ia, commitObjectEdit: Oa, copyKeyframe: Pa, deleteKeyframe: La, deleteObject: Na, duplicateObject: Fa, exitKeyEdit: za, finishCameraEdit: Ra, goToAdjacentKey: Da, insertKeyframe: Ka, loadSelectedKeyView: Ba, pasteKeyframe: qa, playblastCameraAtFrame: Ua, refreshInspector: Wa, refreshKeyEditor: Va, refreshObjects: Ha, removeObjectResources: Ga, renameObject: Ya, retimeSelectedKey: Xa, selectKeyframe: Ja, selectedKeyframe: Za, selectedObject: Qa, selectObjectAnimation: eo, setKeyInterpolation: to, setObjectParent: it, timelineKeyframes: ao, timelineObject: oo, toggleAutoKey: ro, toggleObject: no, updateCameraFromHud: so, updateEditState: io, updateKeyVisualState: co, updateSelectedKey: Rt, updateSelectedObject: lo, clamp: mo, cloneCamera: po, configureCore: Je, defaultCamera: Ho, sampleCamera: bt, sampleObjectTransform: Le, sanitizeState: N, worldTransform: M } = e;
  return {
    setTargetAtCursor(j) {
      if (!j) return;
...
function Dg(e) {
  const { right: t, up: a, forward: o } = al(e || {});
  return Rg.map((r) => {
...
const qg = "http://www.w3.org/2000/svg", St = 26, ts = 17, Ug = 5.4;
function jt(e, t) {
  const a = document.createElementNS(qg, e);
...
function Wg(e) {
  ...
  for (const n of Kg(Dg(a))) {
    const i = St + n.x * ts, c = St + n.y * ts, l = Bg(n.depth);
...
function Hg(e) {
  ...
  for (const r of e.state.motion_layers || []) {
    ...
    const n = Vg(e.state, r, e.frame, a, o);
    if (n.length) {
...
const Gg = ["world_point", "object_point", "camera_field"], _i = {
  manual_2d: "DRAW",
  object_point: "OBJECT",
  world_point: "WORLD",
...
function Qg(e) {
  ...
  n("motion-sel-name", a.label), n("motion-sel-type", _i[a.source_kind] || "TRACK"), n("motion-sel-binding", Yg(e.state, a)), n("motion-sel-start", r.length ? Math.min(...r) : 0), n("motion-sel-end", r.length ? Math.max(...r) : 0);
...
function ay(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: b, syncActiveCameraTrack: u, syncFromWidgets: v, bindEditorEvents: y, activateCamera: x, addCamera: S, deleteCamera: g, drawPreviewOverlays: k, duplicateCamera: _, maximizeCameraPreview: I, refreshCameraPreviews: P, refreshCameraSelectors: B, renameCamera: W, setPlayblastCamera: H, toggleCameraView: oe, captureRealtime: E, makePlayblast: K, uploadDirectorPlayblast: V, waitForMediaFrame: X, computeAudioPeaks: F, loadAudioFile: A, releaseAudio: G, stopPlay: z, togglePlay: Y, applyCameraPreset: ee, applyCameraShake: le, applyProxyPreset: se, clearViewportBgImage: re, loadViewportBgFile: de, loadViewportBgSequence: ge, drawCameraPath: he, drawCard: ye, drawCube: ve, drawCylinder: pe, drawGrid: Me, drawHuman: xe, drawLine3D: we, drawNull: be, drawOverlays: L, drawPointField: U, drawSpeedHeatmap: me, drawSphere: _e, drawTorus: Oe, curveChannels: Ke, drawCurveEditor: Pe, onCurvePointerDown: st, onCurvePointerMove: ta, onCurvePointerUp: aa, onTimelinePointerDown: oa, onTimelinePointerMove: $t, onTimelinePointerUp: Mt, refreshKeys: ut, resetCurveZoom: It, resetTimelineZoom: Ot, setChannelFilter: Pt, setCurveInterpolation: ra, setTangentMode: Lt, timelineFrameFromEvent: na, toggleCurveHandles: sa, zoomCurve: ia, drawTransformGizmo: ca, frameTarget: la, gizmoAxes: da, gizmoGeometry: ma, onPointerDown: pa, onPointerMove: fa, onPointerUp: ha, onWheel: ua, pickGizmo: Nt, pickSceneObject: Ft, resetCamera: ba, setTransformMode: ga, setViewMode: Wo, viewportCamera: Vo, loadCardFile: ya, loadExecutionPreview: va, loadMediaUrl: xa, loadModelFile: wa, loadSelectedReference: ka, onModelLoaded: Sa, restoreAssets: ja, syncUpstreamInputs: zt, configureDomMedia: _a, refreshSetupDiagnostic: Ca, addMediaCard: Ea, addPrimitive: Aa, applyObjectAnimationFrame: Ta, beginCameraEdit: $a, beginObjectEdit: Ma, commitCameraEdit: Ia, commitObjectEdit: Oa, copyKeyframe: Pa, deleteKeyframe: La, deleteObject: Na, duplicateObject: Fa, exitKeyEdit: za, finishCameraEdit: Ra, goToAdjacentKey: Da, insertKeyframe: Ka, loadSelectedKeyView: Ba, pasteKeyframe: qa, playblastCameraAtFrame: Ua, refreshInspector: Wa, refreshKeyEditor: Va, refreshObjects: Ha, removeObjectResources: Ga, renameObject: Ya, retimeSelectedKey: Xa, selectKeyframe: Ja, selectedKeyframe: Za, selectedObject: Qa, selectObjectAnimation: eo, setKeyInterpolation: to, setObjectParent: it, timelineKeyframes: ao, timelineObject: oo, toggleAutoKey: ro, toggleObject: no, updateCameraFromHud: so, updateEditState: io, updateKeyVisualState: co, updateSelectedKey: Rt, updateSelectedObject: lo, clamp: mo, cloneCamera: po, configureCore: Je, defaultCamera: Ho, sampleCamera: bt, sampleObjectTransform: Le, sanitizeState: N, worldTransform: M } = e;
  return {
    ...
    renderViewportOnly() {
      ...
      if (this.webgl) {
        try {
          ...
          this.webgl.render(ct, D, this.cardMediaById, fo, Go, this.modelUrlsById, this.frame, this.recording, this.selectedEntity, this.selectedObjectId, this.subSelection, this.selectedKeyFrame ?? null, this.selectedKeyFrames ? [...this.selectedKeyFrames] : null), j.imageSmoothingEnabled = !0, j.imageSmoothingQuality = "high", fo !== w || Go !== C ? j.drawImage(this.webgl.canvas, 0, 0, fo, Go, 0, 0, w, C) : j.drawImage(this.webgl.canvas, 0, 0, w, C), te = !0;
        } catch (ne) {
      ...
      !this.recording && this.state.speed_heatmap && this.drawSpeedHeatmap(), !this.recording && Bh(this), this.drawOverlays(), Hg(this), this.state.show_gizmo && Wg(this), this.labelOverlay?.update(), this.rigOverlay?.update(), this.perf && (this.perf.viewportRenderCount = (this.perf.viewportRenderCount || 0) + 1);
    },
    ...
    requestUiUpdate(j = T.viewport, w = "unknown") {
      (this.renderReasons ||= /* @__PURE__ */ new Set()).add(w), this.uiDirtyMask = hp(this.uiDirtyMask, j), this.renderInvalidations = (this.renderInvalidations || 0) + 1, !this.renderScheduled && (this.renderScheduled = !0, this.renderFrame = requestAnimationFrame(() => {
    ...
    renderCameraView() {
      if (this.perf && (this.perf.previewRenderCount = (this.perf.previewRenderCount || 0) + 1), this.state.camera_view_visible) {
        ...
        for (const D of w) {
          ...
          const Z = J.width, Se = J.height, Be = this.root.querySelector(`[data-camera-frame="${D.id}"]`);
          if (Be && (Be.textContent = `F${this.frame}`), C && D.id !== this.state.active_camera_id && D !== $) continue;
          const ct = Ht(this, D, bt(D, this.frame, this.state.objects), this.frame);
          if (R.fillStyle = "#111", R.fillRect(0, 0, Z, Se), this.cameraWebgl)
            try {
              this.cameraWebgl.render({ ...this.state, keyframes: [], playblast_grid: !1, viewport_bg_image: this.viewportBgImage?.src || "", viewport_bg_sequence: (this.viewportBgSequenceImages || []).map((te) => te.src), __omnicamRevision: this.renderRevision || 0 }, ct, this.cardMediaById, Z, Se, this.modelUrlsById, this.frame, !0), R.drawImage(this.cameraWebgl.canvas, 0, 0, Z, Se);
            } catch (te) {
    ...
    dispose() {
      this.disposed || (this.disposed = !0, this.agentBridge?.dispose?.(), this.transformControlsWiring?.dispose(), ol(this), rl(), zl(this), this.backgroundRequestId = (this.backgroundRequestId || 0) + 1, this.upstreamSyncId = (this.upstreamSyncId || 0) + 1, this.stopPlay(), clearTimeout(this.previewClickTimer), clearTimeout(this.connectionTimer), cancelAnimationFrame(this.restoreFrame), cancelAnimationFrame(this.serializeFrame), cancelAnimationFrame(this.resizeFrame), cancelAnimationFrame(this.renderFrame), this.abortController?.abort(), this.upstreamFetchController?.abort(), this.resizeObserver?.disconnect(), this.contextMenu?.dispose(), this.webgl?.dispose(), this.cameraWebgl?.dispose(), G(this), uu(this), this.objectUrls.clear(), this.cardMediaById.clear(), this.cardMediaAssetById?.clear?.(), this.modelUrlsById.clear(), this.modelInfoById.clear());
    }
  };
}
const oy = 0.12;
function ry() {
  return {
    ...
    deleteSelectedKeyframes() {
      ...
      const t = this._activeTrack(), a = Ee(this), o = t.kind === "camera" ? 1 : 0, { keys: r, removed: n } = vg(a, e, { minKeys: o });
    ...
    nudgeSelectedKeyframes(e) {
      ...
      const a = this._activeTrack(), o = Math.max(0, this.state.duration_frames - 1), r = xg(Ee(this), t, e, { lastFrame: o });
    ...
    setSelectedKeysInterpolation(e) {
      ...
      this.checkpoint(s("Interpolation on {n} keys").replace("{n}", t.length)), a.write(wg(Ee(this), t, e)), this.serialize(), this.refreshKeys(), this.refreshKeyEditor(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} interpolation on {n} keys").replace("{mode}", e.replace(/_/g, " ")).replace("{n}", t.length));
    },
    setSelectedKeysTangentMode(e) {
      const t = this.resolveSelectedFrames();
      if (t.length < 2) return this.setTangentMode(e);
      const a = this._activeTrack(), o = ht(this).map((r) => r.id);
      this.checkpoint(s("Tangents on {n} keys").replace("{n}", t.length)), a.write(kg(Ee(this), t, e, o)), this.serialize(), this.refreshKeys(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} tangents on {n} keys").replace("{mode}", e).replace("{n}", t.length));
    },
    /**
    ...
    simplifyActiveKeys({ mode: e = "simplify", tolerance: t = 0, target: a = 0, scope: o = "camera", fromKeys: r = null, silent: n = !1 } = {}) {
      ...
      const l = this.resolveSelectedFrames(), p = o !== "all_cameras" && l.length >= 2 ? [l[0], l.at(-1)] : null, m = p ? [] : l, f = (b) => {
        ...
        let k = S, _ = 0;
        if (S.length > 2) {
          const I = e === "reduce" ? gg(S, i, { target: a || Math.ceil(S.length / 2), keepFrames: m }) : e === "clean" ? yg(S, i, { keepFrames: m }) : bg(S, i, { tolerance: t * oy, keepFrames: m });
...
class Ci {
  constructor(t) {
    this.app = as, this.api = nt, this.node = t, this.root = Fs(), this.root.tabIndex = -1, this.dom = Us(this.root), this.canvas = this.root.querySelector(".viewport-wrap > canvas"), this.cameraPreviewCanvases = /* @__PURE__ */ new Map(), this.cameraPreviewContexts = /* @__PURE__ */ new Map(), this.cameraPreviewSignature = "", this.interactionElement = this.canvas, this.interactionElement.tabIndex = 0, this.interactionElement.dataset.captureWheel = "true", this.ctx = this.canvas.getContext("2d", { alpha: !1 }), this.disposed = !1, this.renderRevision = 0, this.directorRevision = 0, this.webgl = null, this.cameraWebgl = null, this.webglReady = this.loadWebGLViewports(), this.transformControlsWiring = jf(this), this.stateWidget = t.widgets?.find((o) => o.name === "state_json"), this.recordingWidget = t.widgets?.find((o) => o.name === "recording_path"), this.cardWidget = t.widgets?.find((o) => o.name === "card_asset"), this.widthWidget = t.widgets?.find((o) => o.name === "width"), this.heightWidget = t.widgets?.find((o) => o.name === "height"), this.fpsWidget = t.widgets?.find((o) => o.name === "fps"), this.durationWidget = t.widgets?.find((o) => o.name === "duration_seconds"), this.modeWidget = t.widgets?.find((o) => o.name === "render_mode");
    let a = null;
    try {
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-C8FKAb56.js"));
    } catch (a) {
    ...
    if (!this.disposed) {
      ...
      sl(this), this.resizeCanvas(), this.render(), this.renderCameraView();
    }
  }
}
const jo = { app: as, api: nt, EditorHistory: Ls, ContextMenuController: ws, initializeTooltips: Dl, promptText: Xt, ObjectUrlRegistry: Ns, buildRoot: Fs, dispatchDirectorKey: il, activeCameraTrack: dr, bindWidgetCallbacks: Kl, playblastCameraTrack: xs, restoreFromWidgets: Bl, serializeEditorState: ql, syncActiveCameraTrack: mr, syncFromWidgets: Ul, bindEditorEvents: au, activateCamera: Wl, addCamera: Vl, deleteCamera: Hl, drawPreviewOverlays: Gl, duplicateCamera: Yl, maximizeCameraPreview: Xl, refreshCameraPreviews: Jl, refreshCameraSelectors: Zl, renameCamera: Ql, setPlayblastCamera: ed, toggleCameraView: td, captureRealtime: ii, makePlayblast: $u, uploadDirectorPlayblast: ci, waitForMediaFrame: si, computeAudioPeaks: ti, loadAudioFile: pu, releaseAudio: Lo, stopPlay: To, togglePlay: lu, applyCameraPreset: _f, applyCameraShake: Cf, applyProxyPreset: Ef, clearViewportBgImage: Pu, loadViewportBgFile: Iu, loadViewportBgSequence: Ou, drawCameraPath: Gu, drawCard: Hu, drawCube: Ku, drawCylinder: Uu, drawGrid: Fu, drawHuman: qu, drawLine3D: ie, drawNull: Vu, drawOverlays: Xu, drawPointField: Du, drawSpeedHeatmap: Yu, drawSphere: Bu, drawTorus: Wu, curveChannels: ht, drawCurveEditor: Rd, fitCurveView: Ts, onCurveDoubleClick: Fd, onCurvePointerDown: Ad, onCurvePointerMove: Td, onCurvePointerUp: $d, onTimelinePointerDown: cl, onTimelinePointerMove: ll, onTimelinePointerUp: dl, refreshKeys: em, resetCurveZoom: zd, resetTimelineZoom: ml, setChannelFilter: Id, setCurveInterpolation: Md, setTangentMode: Od, timelineFrameFromEvent: _r, toggleCurveHandles: Pd, zoomCurve: Nd, drawTransformGizmo: pl, frameTarget: fl, gizmoAxes: hl, gizmoGeometry: ul, onPointerDown: bl, onPointerMove: gl, onPointerUp: yl, onWheel: vl, pickGizmo: xl, pickSceneObject: wl, resetCamera: kl, setTransformMode: Sl, setViewMode: jl, viewportCamera: _l, loadCardFile: xu, loadExecutionPreview: wu, loadMediaUrl: ni, loadModelFile: vu, loadSelectedReference: ku, onModelLoaded: yu, restoreAssets: gu, syncUpstreamInputs: Su, configureDomMedia: ai, refreshSetupDiagnostic: Qu, addMediaCard: wb, addPrimitive: gb, applyObjectAnimationFrame: Fb, beginCameraEdit: Ub, beginObjectEdit: ui, commitCameraEdit: Wb, commitObjectEdit: jb, copyKeyframe: Kb, deleteKeyframe: Db, deleteObject: hi, deleteSelectedObjects: xb, duplicateObject: fi, exitKeyEdit: Hb, finishCameraEdit: Vb, goToAdjacentKey: rg, insertKeyframe: zb, loadSelectedKeyView: og, pasteKeyframe: Bb, playblastCameraAtFrame: Nb, refreshInspector: kb, refreshKeyEditor: eg, refreshObjects: pi, removeObjectResources: $b, renameObject: yb, retimeSelectedKey: tg, selectKeyframe: qb, selectedKeyframe: Xe, selectedObject: ea, selectObjectAnimation: Tb, setKeyInterpolation: Rb, setKeyTangentMode: Zb, setObjectParent: Ab, timelineKeyframes: Ee, timelineObject: ze, toggleAutoKey: Gb, toggleObject: vb, updateCameraFromHud: Eb, updateCameraRotationFromHud: Cb, updateEditState: Xb, updateKeyVisualState: Jb, updateSelectedKey: ag, updateSelectedObject: Sb, clamp: Q, cloneCamera: ce, configureCore: ys, defaultCamera: Ar, sampleCamera: $e, sampleObjectTransform: Do, sanitizeState: $r, worldTransform: Mr };
Object.assign(
  Ci.prototype,
  dg(jo),
  Fg(jo),
...
function ny(e) {
  ...
  const t = new Ci(e);
  _o("director:constructor:complete", e), Kp(t);
  try {
    t.agentBridge = Gp(t, e, nt);
  } catch (m) {
  ...
  try {
    t.assetBrowser = df(t, {
      ...
      onAgentFirstOpen: async () => {
        if (ir())
          try {
            const { createDirectorAgentPanel: m } = await import("./chunk-BoHDdfMn.js");
            t.agentPanel = m(t);
          } catch (m) {
  ...
  try {
    t.characterRuntime = pf(t), t.rigMapper = hf(t), t.poseEditor = gf(t), t.motionEditor = yf(t);
  } catch (m) {
  ...
  }, t.unwatchGraphConnections = Rl(e, i);
  const l = e.onRemoved;
