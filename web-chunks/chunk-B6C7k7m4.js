...
let pe = null;
function Zr() {
  return pe || typeof Image > "u" || (pe = new Image(), pe.src = Yr), pe;
}
function Qr() {
...
const ut = "en", Ie = /* @__PURE__ */ new Map([[ut, {}]]);
function eo(e, t) {
  Ie.set(e, { ...Ie.get(e) || {}, ...t || {} });
}
let Pe = ut;
...
function lo(e, t, a = null) {
  ...
  const s = sa(e, o)?.camera_id || r[0].camera_id;
...
const ia = Object.freeze(["select", "track", "anchor", "project", "erase"]), la = Object.freeze(["manual_2d", "static_anchor", "world_point", "object_point", "camera_field"]), ca = Object.freeze(["linear", "smooth", "hold"]), we = (e, t = 0) => Number.isFinite(Number(e)) ? Number(e) : t, Et = (e) => Math.max(0, Math.min(1, we(e)));
function mo(e, t) {
  return {
    ...
    y: Et(e?.y),
    visible: e?.visible !== !1,
    interpolation: ca.includes(e?.interpolation) ? e.interpolation : "linear"
  };
}
function po(e) {
  ...
  return e.motion_layers = (Array.isArray(e.motion_layers) ? e.motion_layers : []).slice(0, 256).map((r, o) => {
    ...
    const s = la.includes(r?.source_kind) ? r.source_kind : "manual_2d", i = (Array.isArray(r?.keys) ? r.keys : []).slice(0, 1e4).map((l) => mo(l, t)).sort((l, m) => l.time_seconds - m.time_seconds);
    return {
      id: n,
  ...
  }).filter((r) => r.keys.length), e.motion_tool = ia.includes(e.motion_tool) ? e.motion_tool : "select", e.selected_motion_layer_id = e.motion_layers.some((r) => r.id === e.selected_motion_layer_id) ? e.selected_motion_layer_id : e.motion_layers[0]?.id || null, e;
}
const fo = 32, uo = 64, ho = 128, go = Object.freeze(["off", "selected", "all"]), yo = Object.freeze(["annotation", "name", "tag"]), Ot = Object.freeze({ mode: "selected", content: "annotation" }), bo = Object.freeze(["top", "center", "bottom"]), _o = /^[a-z0-9][a-z0-9_-]*$/, vo = /^#(?:[0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/, So = /[<>]|:\/\/|javascript:|expression\(|&#/i;
function rt(e) {
...
function ai(e) {
  return Array.isArray(e) ? rt(e) : rt(String(e || "").split(/[,\n]/));
}
function It(e) {
...
function ri(e) {
  return {
    mode: go.includes(e?.mode) ? e.mode : Ot.mode,
    content: yo.includes(e?.content) ? e.content : Ot.content
  };
}
function wo(e) {
...
function ni(e, { mode: t, selectedIds: a } = {}) {
  return !e || e.enabled === !1 || t === "off" ? !1 : t === "all" ? !0 : (a instanceof Set ? a : new Set(a || [])).has(e.id);
}
const Mo = /* @__PURE__ */ new Set(["camera", "null", "sun_light", "point_light", "spot_light"]);
function si(e, t) {
  const a = Array.isArray(e?.position) ? e.position : [0, 0, 0], r = Array.isArray(e?.size) ? e.size : [1, 1, 1], o = Mo.has(t) ? 0.35 : Math.max(0.2, (Number(r[1]) || 1) * 0.5 + 0.2);
  return [Number(a[0]) || 0, (Number(a[1]) || 0) + o, Number(a[2]) || 0];
}
const Pt = Object.freeze([0.05, 8]), xo = 80, ma = (e, t, a) => Math.max(t, Math.min(a, e));
function da(e) {
  if (!e || typeof e != "object") return null;
  const t = String(e.clip_id ?? "").trim();
  if (!t || t.length > xo) return null;
  const a = Math.max(0, Math.round(Number(e.start_frame) || 0)), r = Math.round(Number(e.end_frame) || 0), o = r > a ? r : 0, n = Number(e.speed), s = ma(Number.isFinite(n) && n > 0 ? n : 1, Pt[0], Pt[1]), i = Number(e.offset_seconds);
  return {
    clip_id: t,
    start_frame: a,
    end_frame: o,
...
function ii(e, t, a, r) {
  const o = da(e), n = Number(r) || 0, s = Math.max(1, Number(a) || 24);
  if (!o || n <= 0) return 0;
  const i = (d) => o.loop ? (d % n + n) % n : ma(d, 0, n);
...
const li = "omnicam_humanoid_v1", ht = Object.freeze([
  "root",
  "pelvis",
  "spine",
  "chest",
...
function ci(e) {
  const a = (e || []).map(String).filter((n) => n.trim()).map((n) => [n, jo(Ao(n))]), r = /* @__PURE__ */ new Set(), o = {};
  for (const n of [!0, !1])
...
const Po = 128, zt = "omnicam_humanoid_v1", gt = /^[a-z0-9][a-z0-9_-]*$/, zo = 1e-3, No = (e) => Array.isArray(e) && e.length === 3 && e.every((t) => Number.isFinite(Number(t)));
function yt(e) {
...
function di({ preset: e, overrides: t } = {}) {
  const a = Ne(e), r = Ne(t);
  return {
...
function pi(e, t, a) {
  ...
  const n = yt(a);
  return !n || pa(n) ? delete r.joints[o] : r.joints[o] = n, r;
}
function Lo(e) {
...
function fi(e) {
  return Ko({ apiURL: fa }, e);
}
let fa = (e) => e;
const Ye = /* @__PURE__ */ new WeakMap();
function ui({ api: e }) {
  fa = (t) => e.apiURL ? e.apiURL(t) : t;
}
function Bo(e, t, a) {
  const r = e.keyframes, o = Ye.get(e);
  if (o?.source === r && a >= o.frame && o.index < t.length - 1) {
    let s = o.index;
    for (; s + 1 < t.length - 1 && a >= t[s + 1].frame; ) s += 1;
    if (t[s].frame < a && a < t[s + 1].frame)
      return Ye.set(e, { source: r, frame: a, index: s }), { leftIndex: s, left: t[s], right: t[s + 1] };
  }
  const n = bt(t, a);
  return Ye.set(e, { source: r, frame: a, index: n?.leftIndex ?? 0 }), n;
}
function V(e) {
...
function ce(e, t, a = null) {
  ...
  if (u && Array.isArray(h)) {
    ...
    if (g && g.enabled !== !1) {
      const x = _t(h, g, t), E = d?.offset || e.target_offset || e.camera?.target_offset || [0, 0, 0];
      l = (x.position?.[0] ?? 0) + (E[0] || 0), m = (x.position?.[1] ?? 1.5) + (E[1] || 0), c = (x.position?.[2] ?? 0) + (E[2] || 0);
    }
  }
  const f = N(r, t, "fov", (g) => Number((g.camera || g).fov ?? 35), !1, o), _ = N(r, t, "roll", (g) => Number((g.camera || g).roll ?? 0), !0, o), y = N(r, t, "zoom", (g) => Number((g.camera || g).zoom ?? 1), !1, o), S = N(r, t, "near", (g) => Number((g.camera || g).near ?? 0.01), !1, o), b = N(r, t, "far", (g) => Number((g.camera || g).far ?? 1e4), !1, o), M = r[0]?.camera || r[0] || ie();
  let w = r[0];
  for (const g of r)
    if ((g.frame ?? 0) <= t) w = g;
    else break;
...
function N(e, t, a, r, o = !1, n = null) {
  ...
  const s = n || bt(e, t), { leftIndex: i, left: l, right: m } = s, c = i > 0 ? e[i - 1] : null, d = i + 2 < e.length ? e[i + 2] : null, p = Math.max(1, m.frame - l.frame), u = T((t - l.frame) / p, 0, 1);
  let h = r(l), f = r(m);
  if (o) {
  ...
  if (l.interpolation === "bezier" || m.interpolation === "bezier") {
    const S = Rt(l, a, c, m, r), b = Rt(m, a, l, d, r), M = h, w = h + (S.out_y || 0), D = f + (b.in_y || 0), g = f, x = T(Number(S.out_x ?? 1 / 3), 0, 1), E = T(1 + Number(b.in_x ?? -1 / 3), 0, 1);
    let q = 0, ee = 1;
    for (let jt = 0; jt < 32; jt++) {
      const $ = (q + ee) * 0.5, Xe = 1 - $;
      3 * Xe * Xe * $ * x + 3 * Xe * $ * $ * E + $ * $ * $ < u ? q = $ : ee = $;
    }
    const Q = (q + ee) * 0.5, te = 1 - Q;
...
function We(e, t) {
  ...
  const r = me(e), o = (y, S) => (y.transform?.position || r.position)[S] ?? 0, n = (y, S) => (y.transform?.rotation || r.rotation)[S] ?? 0, s = (y, S) => (y.transform?.size || r.size)[S] ?? (S === 2 ? 0.01 : 1), i = bt(a, t), l = N(a, t, "pos_x", (y) => o(y, 0), !1, i), m = N(a, t, "pos_y", (y) => o(y, 1), !1, i), c = N(a, t, "pos_z", (y) => o(y, 2), !1, i), d = N(a, t, "rot_x", (y) => n(y, 0), !0, i), p = N(a, t, "rot_y", (y) => n(y, 1), !0, i), u = N(a, t, "rot_z", (y) => n(y, 2), !0, i), h = N(a, t, "scale_x", (y) => s(y, 0), !1, i), f = N(a, t, "scale_y", (y) => s(y, 1), !1, i), _ = N(a, t, "scale_z", (y) => s(y, 2), !1, i);
  return {
...
function yi(e = "balanced", t = "all_views", a = null) {
  const r = {
    none: 0,
    0: 0,
    sparse: 300,
  ...
  for (let p = 0; p < o; p++) {
    ...
    if (t === "ground_focus")
      if (u < 0.6) {
        ...
        _ = Math.cos(g) * D, S = Math.sin(g) * D, y = 0.01 + u * 0.75, b = 0.86, M = 0.9, w = 0.98;
      } else {
        const D = 1 + Math.sqrt(h) * 18, g = f * Math.PI * 2 + p * 2.399963229728653;
        _ = Math.cos(g) * D, S = Math.sin(g) * D, y = 0.75 + (u - 0.6) * 8.5, b = 0.62, M = 0.7, w = 0.82;
      }
    else if (t === "dome") {
      const D = u * Math.PI * 2, g = 1 - 2 * h, x = Math.sqrt(Math.max(0, 1 - g * g)), E = 1.5 + Math.cbrt(f) * 20;
      ...
      if (D === 0) {
        ...
        _ = Math.cos(x) * g, S = Math.sin(x) * g, y = 0.01 + f * 0.34, b = 0.9, M = 0.94, w = 1;
      } else if (D === 1) {
        const g = 0.6 + Math.sqrt(h) * 18, x = p * 2.399963229728653;
        _ = Math.cos(x) * g, S = Math.sin(x) * g, y = 0.35 + f * 3.15, b = 0.68, M = 0.76, w = 0.86;
      } else if (D === 2) {
        const g = 2 + Math.sqrt(h) * 24, x = p * 2.399963229728653;
        _ = Math.cos(x) * g, S = Math.sin(x) * g, y = 3.5 + f * 11.5, b = 0.55, M = 0.65, w = 0.78;
      } else {
        const g = 0.5 + h * 6.5, x = p * 2.399963229728653;
        _ = Math.cos(x) * g, S = Math.sin(x) * g, y = 0.05 + f * 4.95, b = 0.8, M = 0.86, w = 0.94;
      }
    }
...
function bi(e) {
  ...
  const r = (c, d) => (Array.isArray(c) ? c : []).slice(0, De.maxKeysPerTrack).map((p) => ({
    ...
    interpolation: Nt.includes(p.interpolation) ? p.interpolation : "ease",
  ...
  a.camera = l.camera, a.keyframes = l.keyframes, a.target_object_id = l.target_object_id || null, a.target_offset = l.target_offset || [0, 0, 0], a.aim_bone = l.aim_bone || null, a.objects = (Array.isArray(a.objects) ? a.objects : t.objects).slice(0, De.maxObjects).map((c) => ({
    ...
    ...c?.tags !== void 0 ? { tags: rt(c.tags) } : {},
    ...It(c?.annotation) ? { annotation: It(c.annotation) } : {},
    ...
    keyframes: (Array.isArray(c.keyframes) ? c.keyframes : []).map((d) => ({
      ...
      interpolation: Nt.includes(d.interpolation) ? d.interpolation : "ease",
...
function ga(e, t) {
  ...
  return { position: C(ha(e.position.map((o, n) => o * t.size[n]), a), t.position), rotation: Yo(r), quaternion: r, size: e.size.map((o, n) => o * t.size[n]) };
}
function Zo(e, t) {
  const a = new Map(e.map((o) => [o.id, o])), r = (o, n = /* @__PURE__ */ new Set()) => {
    ...
    if (!i) return s;
    const l = new Set(n);
    return l.add(o.id), ga(s, r(i, l));
  };
  return r(t);
}
function _t(e, t, a, r = /* @__PURE__ */ new Set()) {
  const o = We(t, a);
...
const Lt = ["speed", "angular_speed", "acceleration", "jerk"], Ze = ["ok", "warn", "over"], ya = 0.8, Qo = [0, 1.5, 0];
function Ft(e, t) {
  const a = [0];
...
function Kt(e, t) {
  return t == null || t <= 0 ? "ok" : e > t ? "over" : e > t * ya ? "warn" : "ok";
}
function Bt(e) {
  for (let t = Ze.length - 1; t >= 0; t--) if (e.includes(Ze[t])) return Ze[t];
  return "ok";
}
function rn(e, t) {
...
function ba(e, t = {}, a = null, r = "generic") {
  ...
  const m = Jo(l, o), c = en(l, o), d = Ft(m, o), p = Ft(d, o), u = { speed: m, angular_speed: c, acceleration: d, jerk: p }, h = tn(e, a), f = an(l, h, s, i), _ = l.map((g) => g.fov), y = t.allow_framing_loss === !0, S = [], b = [];
  for (let g = 0; g < n; g++) {
    const x = [], E = [];
    for (const q of Lt) {
      const ee = Kt(u[q][g], t[`max_${q}`]);
      x.push(ee), ee !== "ok" && E.push(q);
    }
    !f[g] && !y && (x.push("over"), E.push("framing_loss")), S.push(Bt(x)), b.push(E);
  }
  ...
  const D = Kt(w.max_fov_change, t.max_fov_change);
  return w.track_grades = { fov_drift: D }, w.grade = Bt([...S, D]), w.trajectory_valid = w.violations.length === 0, w.ok = w.trajectory_valid, w;
}
function nn(e) {
...
function Si(e, t) {
  ...
  e.selectedKeyFrames = null, e.timelineDrag = { box: a, pointerId: t.pointerId }, e.setFrame(_a(e, t, a));
}
function wi(e, t) {
  ...
  !e.timelineDrag || t.pointerId !== e.timelineDrag.pointerId || (t.preventDefault(), t.stopPropagation(), e.setFrame(_a(e, t, e.timelineDrag.box), !1, !1));
}
function Mi(e, t) {
  if (e.timelinePanDrag && t.pointerId === e.timelinePanDrag.pointerId) {
...
function dn(e, t, a) {
  ...
  for (const n of r)
    va(n.frame ?? 0, t) && (n.camera.target = [...o]);
  return r;
}
function pn(e, t) {
...
async function xi() {
  ...
  try {
    if (!nt) return null;
    const e = await nt.fetchApi("/majoor/omnicam/motion_profiles");
...
function de(e) {
  ...
  return a ? ba(e.state, a, null, t) : null;
}
function Vt(e) {
...
function ue(e, t, a, r) {
  const o = a == null ? v("no limit") : `${Vt(t)} / ${Vt(a)}`, n = a != null && a > 0, s = n ? Math.min(100, Math.round(t / a * 100)) : 0, i = r === "over" ? "#ef4444" : r === "warn" ? "#f59e0b" : "#22c55e";
  return `
    <div class="oc-health-metric" data-grade="${r}">
      <div class="oc-health-metric-row">
        <span class="oc-health-dot"></span>
        <span class="oc-health-metric-name">${$e(e)}</span>
...
function _n(e) {
  ...
  return t.length ? t.slice(0, 6).map((a) => {
    const r = a.metrics.map((n) => $e(n)).join(", "), o = a.start === a.end ? v("Frame {frame}").replace("{frame}", String(a.start)) : v("Frames {start}-{end}").replace("{start}", String(a.start)).replace("{end}", String(a.end));
    return `
...
function vn(e) {
  ...
  const s = [
    ...
    ue("fov_drift", o.max_fov_change, o.limits.max_fov_change, o.track_grades.fov_drift)
         ...
         <div class="oc-health-metric-row">
           <span class="oc-health-dot"></span>
           <span class="oc-health-metric-name">${$e("framing_loss")}</span>
...
function Ci(e, t) {
  ...
  if (a) {
    ...
    for (const r of a.segments) {
      ...
      const o = ot(e, r.start), n = ot(e, r.end + 1);
      if (n < -5 || o > 105) continue;
      const s = document.createElement("div");
      s.className = "oc-health-band", s.dataset.grade = r.grade, s.style.left = `${o}%`, s.style.width = `${Math.max(0.4, n - o)}%`, s.title = r.metrics.map((i) => $e(i)).join(", "), t.appendChild(s);
    }
  }
}
function ke(e, t, a, r) {
...
function ki(e) {
  ...
  const r = Math.max(1, e.state.duration_frames - 1), o = mn(e.state.keyframes, r), n = ba({ ...e.state, keyframes: o }, t.limits, null, t.profile);
  if (n.max_speed <= a) {
...
function Di(e) {
  ...
  const r = Sa(e.state.keyframes, a, 0.6);
  ke(
    e,
    r,
...
function Ai(e, t, a) {
  if (!de(e)) return;
  const o = Sa(e.state.keyframes, [{ start: t, end: a }], 0.6);
  ke(
    e,
    o,
    "Smooth zone",
...
const Sn = {
  ...
  ...Sn,
  ...wn
}, Z = ["OmniCam"], wa = "MajoorOmniCam.Locale", Ma = "MajoorOmniCam.Defaults.Fps", xa = "MajoorOmniCam.Defaults.DurationSeconds", Ca = "MajoorOmniCam.Defaults.Width", ka = "MajoorOmniCam.Defaults.Height", Da = "MajoorOmniCam.Defaults.RenderMode", Ta = "MajoorOmniCam.Defaults.Encoder", Aa = "MajoorOmniCam.Defaults.PlayblastResolution", ja = "MajoorOmniCam.Playblast.Quality", Ea = "MajoorOmniCam.Defaults.PlayblastGrid", Oa = "MajoorOmniCam.Defaults.PlayblastLabels", Ia = "MajoorOmniCam.Proxy.PointDensity", Pa = "MajoorOmniCam.Proxy.PointSpread", za = "MajoorOmniCam.Proxy.PointColor", Na = "MajoorOmniCam.Proxy.CardFit", Ra = "MajoorOmniCam.Viewport.Quality", La = "MajoorOmniCam.Viewport.Adaptive", Fa = "MajoorOmniCam.Viewport.BackgroundColor", Ka = "MajoorOmniCam.Display.Grid", Ba = "MajoorOmniCam.Display.Radar", Va = "MajoorOmniCam.Display.CameraPaths", Ga = "MajoorOmniCam.Display.CameraGizmos", qa = "MajoorOmniCam.Display.LookAt", Ha = "MajoorOmniCam.Display.HelperAxes", Wa = "MajoorOmniCam.Display.Gizmo", $a = "MajoorOmniCam.Display.Guides", Ua = "MajoorOmniCam.Display.SafeAreas", Xa = "MajoorOmniCam.Display.ResolutionGate", Ya = "MajoorOmniCam.Display.AspectRatio", Za = "MajoorOmniCam.Display.BurnIn", Qa = "MajoorOmniCam.Display.SpeedHeatmap", Ja = "MajoorOmniCam.Display.Wireframe", er = "MajoorOmniCam.Display.Vertices", tr = "MajoorOmniCam.Tools.SelectMode", ar = "MajoorOmniCam.Tools.GizmoMode", rr = "MajoorOmniCam.Tools.GizmoSpace", or = "MajoorOmniCam.Tools.SpatialSnapMode", nr = "MajoorOmniCam.Tools.SpatialGridSize", sr = "MajoorOmniCam.Navigation.Profile", ir = "MajoorOmniCam.Navigation.FlySpeed", lr = "MajoorOmniCam.Navigation.InvertOrbitY", cr = "MajoorOmniCam.Navigation.ZoomSensitivity", mr = "MajoorOmniCam.Navigation.OrbitSensitivity", dr = "MajoorOmniCam.Navigation.PanSensitivity", pr = "MajoorOmniCam.Navigation.DollySensitivity", fr = "MajoorOmniCam.Navigation.ViewMode", ur = "MajoorOmniCam.Controls.EnableShortcuts", hr = "MajoorOmniCam.Timeline.SnapEnabled", gr = "MajoorOmniCam.Timeline.SnapFrames", yr = "MajoorOmniCam.Timeline.AutoKey", br = "MajoorOmniCam.Timeline.DefaultInterpolation", _r = "MajoorOmniCam.Timeline.TimecodeMode", vr = "MajoorOmniCam.Timeline.LoopPlayback", Sr = "MajoorOmniCam.Interface.Density", wr = "MajoorOmniCam.Interface.PreviewLayout", Mr = "MajoorOmniCam.Interface.CameraPreviews", xr = "MajoorOmniCam.History.Limit", Cr = "MajoorOmniCam.Extractor.DefaultBackend", kr = "MajoorOmniCam.Monitor.DefaultProfile", Dr = "MajoorOmniCam.Agent.Enabled", vt = "MajoorOmniCam.Agent.Provider", Gt = "MajoorOmniCam.Agent.Model", qt = "MajoorOmniCam.Agent.BaseUrl", Tr = "MajoorOmniCam.Agent.MaxOutputTokens", Ar = "MajoorOmniCam.Agent.MaxPlannerSteps", jr = "MajoorOmniCam.Agent.RequestTimeoutSeconds", Ke = [
...
function St(e) {
  return `MajoorOmniCam.Agent.${Er(e).settingKey}.Model`;
}
function wt(e) {
  return `MajoorOmniCam.Agent.${Er(e).settingKey}.BaseUrl`;
}
...
const Or = xn({
  onLocaleChange: () => Ir(),
  onQualityChange: (e) => $t(e),
  onAdaptiveChange: () => $t(),
  onAgentEnabledChange: () => jn()
});
let Mt = null;
function R(e, t) {
  try {
...
function Ir() {
  const e = String(R(wa, "auto")), t = String(R("Comfy.Locale", "en") || "en").slice(0, 2).toLowerCase(), a = e === "auto" ? t : e, r = a !== ao();
  if (to(a), !!r) {
    for (const o of W)
      if (!o.disposed)
        try {
...
function $t(e = Pr()) {
  for (const t of W)
    t.disposed || (zr(t), t.requestRender ? t.requestRender("quality") : t.render?.(), t.renderCameraView?.());
}
function Ii() {
  return En().enabled;
}
...
function En() {
  const e = z(vt, "ollama", ["openai", "openai_compatible", "anthropic", "ollama"]);
  return {
    enabled: I(Dr, !0),
    provider: e,
    ...
    model: String(R(St(e), "") || "").trim(),
    baseUrl: String(R(wt(e), "") || "").trim(),
    maxOutputTokens: F(Tr, 4096, 512, 32768, !0),
    maxPlannerSteps: F(Ar, 6, 1, 12, !0),
...
function On() {
  return {
    ...
    width: F(Ca, 1280, 64, 4096, !0),
    height: F(ka, 720, 64, 4096, !0),
    renderMode: String(R(Da, "omni_ref")),
    encoder: String(R(Ta, "auto")),
    playblastResolution: z(Aa, "output", ["viewport", "half", "output", "double"]),
    playblastQuality: z(ja, "balanced", ["low", "balanced", "high"]),
    playblastGrid: I(Ea, !1),
    playblastLabels: I(Oa, !1),
    pointDensity: z(Ia, "balanced", ["none", "sparse", "balanced", "dense", "ultra"]),
    pointSpread: z(Pa, "all_views", ["all_views", "ground_focus", "dome"]),
    pointColor: Wt(za, "#cbd5e1"),
    cardFit: z(Na, "contain", ["contain", "cover", "stretch"]),
    backgroundColor: Wt(Fa, "#121212"),
    showGrid: I(Ka, !0),
    showRadar: I(Ba, !0),
    showCameraPaths: I(Va, !0),
    showCameraGizmos: I(Ga, !0),
    showLookAt: I(qa, !0),
    showHelperAxes: I(Ha, !0),
    showGizmo: I(Wa, !0),
    guides: I($a, !0),
    safeAreas: I(Ua, !1),
    resolutionGate: I(Xa, !1),
    aspectRatio: z(Ya, "auto", ["auto", "16:9", "4:3", "1:1", "9:16", "2.39:1"]),
    burnIn: I(Za, !1),
    speedHeatmap: I(Qa, !1),
    showWireframe: I(Ja, !1),
    showVertices: I(er, !1),
    selectMode: z(tr, "object", ["object", "vertex", "edge", "face"]),
    gizmoMode: z(ar, "translate", ["translate", "rotate", "scale"]),
    gizmoSpace: z(rr, "world", ["world", "local"]),
    spatialSnapMode: z(or, "none", ["none", "grid", "vertex"]),
    spatialGridSize: F(nr, 0.5, 0.01, 100),
    navigationProfile: z(sr, "simple", ["maya", "blender", "simple"]),
    flySpeed: F(ir, 1, 0.05, 5),
    invertOrbitY: I(lr, !1),
    zoomSensitivity: F(cr, 1, 0.2, 3),
    orbitSensitivity: F(mr, 1, 0.2, 3),
    panSensitivity: F(dr, 1, 0.2, 3),
    dollySensitivity: F(pr, 1, 0.2, 3),
    viewMode: z(fr, "perspective", ["camera", "perspective", "front", "back", "top", "bottom", "right", "left"]),
    snapEnabled: I(hr, !0),
    snapFrames: F(gr, 1, 1, 24, !0),
    autoKey: I(yr, !1),
    defaultInterpolation: z(br, "ease", ["ease", "smooth", "bezier", "linear", "ease_in", "ease_out", "hold"]),
    timecodeMode: z(_r, "time", ["time", "timecode"]),
    loopPlayback: I(vr, !1),
    uiDensity: z(Sr, "animation", ["basic", "animation", "advanced"]),
    previewLayout: z(wr, "auto", ["auto", "1", "2", "4"]),
    cameraViewVisible: I(Mr, !0),
    undoLimit: F(xr, 100, 10, 500, !0),
    extractorBackend: z(Cr, "dpvo", ["dpvo", "pycolmap"]),
    monitorProfile: z(kr, "wan_camera_native", ["wan_camera_native", "minimax_h3", "ltx_motion", "generic_video"])
  };
}
function In() {
  const e = String(R(Gt, "") || "").trim(), t = String(R(qt, "") || "").trim();
  if (!e && !t) return;
  const a = z(
    vt,
    "ollama",
  ...
  e && !String(R(r, "") || "").trim() && be(r, e), t && !String(R(o, "") || "").trim() && be(o, t), be(Gt, ""), be(qt, "");
}
function Pn(e) {
  Mt = e, eo("fr", Mn), Ir(), In();
}
...
function Pi(e, t) {
  if (!e || !t || e.cameraId !== t.id) return st();
...
function Ut(e, t, a, r, o) {
  const { right: n, up: s, forward: i } = V(t), l = t.position, m = [a[0] - l[0], a[1] - l[1], a[2] - l[2]], c = Fn(m, i);
  let d, p;
  if (t.camera_type === "orthographic") {
...
function Xt(e, { cameraId: t, frame: a, additive: r = !1 }) {
...
function Bn(e, { pointerX: t, pointerY: a, shiftKey: r, altKey: o }) {
  ...
  return i ? (s.id !== e.state.active_camera_id && e.activateCamera(s.id), r ? (Xt(e, { cameraId: s.id, frame: i.frame, additive: !0 }), e.render(), !0) : (e.pathDrag = { cameraId: n.cameraId, frame: n.frame, anchor: [...i.camera.position], startX: t, startY: a, moved: !1, historyCheckpointed: !1 }, e.interactionElement.style && (e.interactionElement.style.cursor = "grabbing"), Xt(e, { cameraId: s.id, frame: i.frame, additive: !1 }), e.render(), !0)) : !1;
}
const _e = "orbit", ve = "pan", Qe = "dolly";
function Nr(e, t, { includeCtrlFallback: a, includeSimpleLeft: r = a }) {
  const o = !!(t.ctrlKey || t.metaKey);
  if (e === "simple" && !t.altKey && !o && !t.shiftKey) {
    if (t.button === 2) return ve;
    if (t.button === 0) return r ? _e : null;
  }
  return t.button === 1 ? o ? Qe : t.shiftKey || t.altKey ? ve : _e : t.button === 2 ? t.altKey && e === "maya" ? Qe : null : t.button !== 0 ? null : t.altKey ? o ? Qe : t.shiftKey ? ve : _e : o && a ? t.shiftKey ? ve : _e : null;
}
function Vn(e, t, a) {
  const r = xt(e), o = Nr(r, t, { includeCtrlFallback: !0 });
  return o === _e && a?.camera_type === "orthographic" ? ve : o;
}
function Yt(e, t) {
  return e.isNavigatingFly ? !0 : Nr(xt(e), t, { includeCtrlFallback: !1 }) !== null;
}
const Gn = ["maya", "blender", "simple"];
function xt(e) {
  const t = e.state?.navigation_profile;
  return Gn.includes(t) ? t : "maya";
}
function qn(e, t) {
...
function Ve(e, { mode: t, origin: a, delta: r, factors: o, rotationDeg: n }) {
...
function Hn(e, t) {
  return (Array.isArray(e) ? e : []).map((r) => {
    const o = { ...r.camera };
    return Array.isArray(o.position) && (o.position = Ve(o.position, t)), Array.isArray(o.target) && (o.target = Ve(o.target, t)), { ...r, camera: o };
  });
}
function Wn(e, t) {
  let a;
...
function Ri(e, t, a) {
  const r = Array.isArray(e) ? e : [], o = t instanceof Set ? t : new Set(t || []), n = !!a?.lookAtActive, s = r.map((i) => {
    ...
    return Array.isArray(l) ? o.has(i.frame) ? Ve(l, a) : [...l] : l;
  });
  return r.map((i, l) => {
    const m = { ...i.camera };
    ...
    if (m.position = s[l], Array.isArray(d))
      if (n)
        ...
        const p = G(A(d, c)) || 5, u = Wn(s, l);
        m.target = C(m.position, k(u, p));
      }
    return { ...i, camera: m };
  });
}
...
function Un(e, { baseDrag: t, viewCamera: a, entityPosition: r }) {
  const o = e.activeCameraTrack?.();
  return !o || o.locked || !(o.keyframes?.length >= 1) ? !1 : (e.checkpoint("Transform camera path"), e.gizmoDrag = {
    ...
    viewRight: V(a).right,
    viewUp: V(a).up,
    freeScale: a.camera_type === "orthographic" ? Be(a, e.canvas.height) : G(A(a.position, r)) * (2 * Math.tan((a.fov || 35) * Math.PI / 360)) / e.canvas.height
  }, !0);
}
function Xn(e, { pointer: t, deltaPixels: a, precision: r, snapping: o }) {
  ...
  s.keyframes = Hn(n.baseKeys, l), s.id === e.state.active_camera_id && (e.state.keyframes = s.keyframes), e.camera = ce(s, e.frame, e.state.objects), s.camera = B(e.camera), e.refreshKeys(), e.refreshInspector(), e.render(), e.renderCameraView?.();
}
function Zt(e, t) {
  const a = [];
...
function Yn(e, t) {
  ...
  if (a) return Zt(a.min, a.max);
  const r = _t(e.state.objects, t, e.frame || 0), o = (t.type === "model" || t.type === "glb") && e.webgl?.getObjectWorldCenter?.(t.id) || r.position, n = r.size.map((i) => Math.max(0.01, Math.abs(i)) / 2), s = r.quaternion || Le(r.rotation);
  return Zt(n.map((i) => -i), n).map((i) => C(o, ha(i, s)));
}
function Zn(e, t, a, r = {}) {
  const o = e.state.objects.filter((b) => b.enabled !== !1), n = r.all ? o : o.filter((b) => e.selectedObjectIds?.has(b.id)), i = (n.length ? n : [a]).flatMap((b) => Yn(e, b)), l = [0, 1, 2].map((b) => Math.min(...i.map((M) => M[b]))), m = [0, 1, 2].map((b) => Math.max(...i.map((M) => M[b]))), c = l.map((b, M) => (b + m[M]) / 2), { right: d, up: p, forward: u } = V(t), h = Math.max(1, e.canvas?.width || e.state.width || 1280) / Math.max(1, e.canvas?.height || e.state.height || 720), f = Math.tan((t.fov || 35) * Math.PI / 360), _ = f * h;
  let y = 2, S = 0.1;
  for (const b of i) {
    const M = A(b, c), w = Math.abs(U(M, d)), D = Math.abs(U(M, p)), g = U(M, u);
    y = Math.max(y, 1.15 * w / _ - g, 1.15 * D / f - g, (t.near || 0.01) * 2 - g), S = Math.max(S, 1.15 * D, 1.15 * w / h);
  }
  t.target = c, t.position = A(c, k(u, y)), t.camera_type === "orthographic" && (t.zoom = Math.max(0.01, 5 / S));
}
const ae = {
...
function Qn(e) {
  if (e.selectedEntity === "object") {
    ...
    const a = t.keyframes?.length ? We(t, e.frame) : t, r = a.position || [0, 0, 0];
    return {
      id: `object:${t.id}`,
      type: "object",
      position: r,
...
function Bi(e, t = {}) {
  ...
  e.checkpoint(t.all ? "Frame all" : "Frame subject"), Zn(e, a, s, t), r ? (e.serialize(), e.render()) : (e.beginCameraEdit(), e.commitCameraEdit(), e.finishCameraEdit()), e.setStatus(t.all ? v("Framed: all objects") : v("Framed: {name}").replace("{name}", s.name || s.type || v("Subject")));
}
...
function Rr(e) {
  const t = es(e);
  if (!t || e.transformControlsWiring && ts.has(t.type)) return null;
  ...
  const l = i.map((m, c) => {
    const d = Math.abs(m[1]) < 0.9 ? [0, 1, 0] : [1, 0, 0], p = se(Me(m, d)), u = se(Me(m, p)), h = [];
    for (let f = 0; f <= 48; f++) {
...
function Lr(e, t) {
  ...
  for (const i of a.handles)
    for (let l = 0; l < i.points.length - 1; l++) {
      const m = i.points[l], c = i.points[l + 1], d = ua(t, m, c);
...
function as(e, t) {
    ...
    if (e.state.show_camera_paths !== !1)
      for (const s of e.state.cameras) {
        ...
        for (let m = 0; m < l.length - 1; m += 1)
          if (ua(t, l[m], l[m + 1]) <= 8 * Math.min(2, window.devicePixelRatio || 1))
  ...
  for (const s of e.state.objects) {
    ...
    const i = s.keyframes?.length ? We(s, e.frame) : s, l = K(i.position || [0, 0, 0], r, e.canvas.width, e.canvas.height);
    if (!l) continue;
...
function Vi(e) {
  ...
  for (const o of t.handles) {
    ...
    if (e.ctx.lineWidth = n ? 6.5 : 3.8, e.ctx.strokeStyle = n ? "#ffffff" : a[o.index] || "#ffffff", e.ctx.fillStyle = a[o.index] || "#ffffff", e.ctx.beginPath(), o.points.forEach((s, i) => {
      ...
      e.state.gizmo_mode === "scale" && t.entity?.type === "object" ? (e.ctx.fillRect(i[0] - 6, i[1] - 6, 12, 12), e.ctx.save(), e.ctx.strokeStyle = "rgba(15, 23, 42, 0.65)", e.ctx.lineWidth = 1, e.ctx.strokeRect(i[0] - 6, i[1] - 6, 12, 12), e.ctx.restore()) : rs(e.ctx, s[0], i);
    }
  }
...
const lt = { x: [1, 0, 0], y: [0, 1, 0], z: [0, 0, 1] }, Ge = (e, t) => Math.round(e / t) * t;
function Fr(e) {
...
function ss(e, t, a, r, o, n, s) {
  const i = o ? "grid" : e.state.spatial_snap_mode;
  if (i === "grid") {
    const l = e.state.spatial_grid_size || 0.5;
    return n ? a.map((m, c) => m.map((d, p) => Math.abs(n[p]) > 1e-6 ? Ge(d, l) : s[c][p])) : a.map((m) => m.map((c) => Ge(c, l)));
  }
  if (i === "vertex" && r && !n) {
...
function Oe(e, t) {
  ...
  const n = o[0] - a.start[0], s = o[1] - a.start[1], i = t.shiftKey ? 0.1 : 1, l = ns(a), m = a.axis ? lt[a.axis] : null, c = e.state.view_mode === "camera" ? e.camera : e.state.editor_views[e.state.view_mode], d = V(c), p = c.camera_type === "orthographic" ? 10 / (Math.max(0.01, c.zoom || 1) * Math.max(1, e.canvas.height)) : Math.hypot(...A(c.position, c.target)) * 25e-4;
  let u = a.snapshots.map((b) => [...b.transform.position]);
  if (a.mode === "translate") {
    const b = l ?? (n - s) * p * i, M = m ? k(m, b) : C(k(d.right, n * p * i), k(d.up, -s * p * i));
    u = u.map((w) => C(w, M)), u = ss(e, a, u, o, t.ctrlKey || t.metaKey, m, a.snapshots.map((w) => w.transform.position));
  }
  const h = a.mode === "rotate" ? l ?? (n - s) * 0.5 * i : 0, f = a.mode === "scale" ? Math.max(0.01, l ?? 1 + (n - s) * 0.01 * i) : 1, _ = m || lt.z, y = t.ctrlKey || t.metaKey || e.state.spatial_snap_mode === "grid";
  a.snapshots.forEach((b, M) => {
    const w = b.object;
    if (a.mode === "translate" && (w.position = u[M]), a.mode === "rotate") {
      const D = y ? Ge(h, 15) : h, g = k(_, D);
      w.position = C(a.pivot, Ce(A(b.transform.position, a.pivot), g)), w.rotation = C(b.transform.rotation, g);
    }
    if (a.mode === "scale") {
      const D = y ? Ge(f, 0.1) : f, g = m ? m.map((E) => E ? D : 1) : [D, D, D], x = A(b.transform.position, a.pivot);
...
function is(e, t) {
  ...
  return r === "escape" ? Br(e) : r === "enter" || r === " " ? Kr(e) : lt[r] ? (a.axis = a.axis === r ? null : r, Oe(e, a.lastEvent), !0) : /^[0-9]$/.test(r) || r === "." || r === "," || r === "-" && !a.numeric ? (a.numeric += r === "," ? "." : r, Oe(e, a.lastEvent), !0) : (r === "backspace" && (a.numeric = a.numeric.slice(0, -1), Oe(e, a.lastEvent)), !0);
}
function he(e, t, a) {
...
const oe = (e, t) => Math.round(e / t) * t, cs = (e, t) => e.map((a) => oe(a, t));
function ms(e, t, a) {
  const r = t.keyframes?.length ? We(t, e.frame) : t, o = r.position || [0, 0, 0], n = e.webgl?.getObjectWorldBounds?.(t.id);
  let s, i;
  if (n)
    ({ min: s, max: i } = n);
  else {
...
function ge(e, t, a, r = [], o = null) {
  ...
  if (s === "grid")
    return o ? t.map((l, m) => Math.abs(o.axis[m]) > 1e-6 ? oe(l, i) : o.base[m]) : cs(t, i);
  if (s === "vertex" && a && !o) {
...
function Gi(e, t) {
  ...
  const a = e.interactionElement.getBoundingClientRect(), r = (t.clientX - a.left) * e.canvas.width / Math.max(1, a.width), o = (t.clientY - a.top) * e.canvas.height / Math.max(1, a.height), n = X(e), s = e.state.view_mode !== "camera", i = Yt(e, t), l = t.button === 0 && !i, m = l && !t.altKey && !t.shiftKey;
  ...
  if (l && Bn(e, { pointerX: r, pointerY: o, shiftKey: t.shiftKey, altKey: t.altKey })) return;
  ...
  if (c) {
    ...
    if (c.entity.type === "camera_path" && Un(e, { baseDrag: b, viewCamera: n, entityPosition: c.entity.position })) return;
    if (c.entity.type === "object") {
      const M = c.entity.object;
      e.checkpoint("Transform object");
      const w = Fr(e), D = (w.length ? w : [M]).map((x) => ({ object: x, transform: me(x) }));
      ...
      e.gizmoDrag = {
        ...
        viewRight: V(n).right,
        viewUp: V(n).up,
        freeScale: n.camera_type === "orthographic" ? Be(n, e.canvas.height) : G(A(n.position, c.entity.position)) * (2 * Math.tan((n.fov || 35) * Math.PI / 360)) / e.canvas.height
      };
      return;
    }
  }
  const d = l ? as(e, [r, o]) : null;
  ...
  if (!d && l && !t.ctrlKey && !t.metaKey && xt(e) !== "simple") {
    e.boxSelection = {
      start: [r, o],
      current: [r, o],
      additive: t.shiftKey,
  ...
  const p = !!e.isNavigatingFly, u = Vn(e, t, n);
  if (!p && !u) return;
...
function qi(e, t) {
  ...
  if (e.pathDrag) {
    ...
    c && (c.camera.position = Ut(
      [i, l],
      X(e),
      e.pathDrag.anchor,
      e.canvas.width,
      e.canvas.height
    ), c.interpolation = Kn(c.interpolation), e.webgl && (e.webgl.pathKey = ""), e.setFrame(e.frame, !1, !1), e.render());
    return;
  }
  ...
  if (e.gizmoDrag) {
    ...
    if (e.gizmoDrag.type === "camera_target") {
      const u = C(e.gizmoDrag.target, k(e.gizmoDrag.axis, m * e.gizmoDrag.worldLength / e.gizmoDrag.screenLength)), h = ge(e, u, i, [], { base: e.gizmoDrag.target, axis: e.gizmoDrag.axis });
      e.gizmoDrag.tracking ? Qt(e, h) : e.camera.target = h, e.commitCameraEdit(), e.refreshInspector(), e.render();
      return;
    }
    if (e.gizmoDrag.type === "camera") {
      if (e.state.gizmo_mode === "translate") {
        ...
        e.camera.position = ge(e, u, i, [], { base: e.gizmoDrag.position, axis: e.gizmoDrag.axis });
      } else {
        const u = c ? oe(m * 0.015, Math.PI / 12) : m * 0.015, h = A(e.gizmoDrag.target, e.gizmoDrag.position), f = Ce(h, k(e.gizmoDrag.axis, u * (180 / Math.PI)));
        e.camera.target = C(e.gizmoDrag.position, f);
      }
      e.commitCameraEdit(), e.refreshInspector(), e.render();
      return;
    }
    if (e.gizmoDrag.type === "camera_path") return void Xn(e, { pointer: i, deltaPixels: m, precision: l, snapping: c });
    if (e.state.gizmo_mode === "translate")
      if (e.gizmoDrag.free) {
        ...
        e.gizmoDrag.object.position = ge(e, f, i, [e.gizmoDrag.object.id]);
      } else {
        const u = C(e.gizmoDrag.position, k(e.gizmoDrag.axis, m * e.gizmoDrag.worldLength / e.gizmoDrag.screenLength));
        e.gizmoDrag.object.position = ge(e, u, i, [e.gizmoDrag.object.id], { base: e.gizmoDrag.position, axis: e.gizmoDrag.axis });
      }
    else if (e.state.gizmo_mode === "scale")
      if (e.gizmoDrag.free) {
        ...
        u[e.gizmoDrag.axisIndex] = Math.max(0.01, c ? oe(h, 0.1) : h), e.gizmoDrag.object.size = u;
      }
    else {
      const u = [...e.gizmoDrag.rotation], h = u[e.gizmoDrag.axisIndex] + m * 0.75;
      u[e.gizmoDrag.axisIndex] = c ? oe(h, 15) : h, e.gizmoDrag.object.rotation = u;
    }
    ...
    if (d.length > 1 && p)
      if (e.state.gizmo_mode === "translate") {
        ...
        for (const h of d)
          h.object.position = C(e.gizmoDrag.groupPivot, Ce(A(h.transform.position, e.gizmoDrag.groupPivot), u)), h.object.rotation = C(h.transform.rotation, u);
      } else {
        const u = e.gizmoDrag.object.size.map((h, f) => h / Math.max(0.01, p.size[f]));
        for (const h of d) {
          const f = A(h.transform.position, e.gizmoDrag.groupPivot);
...
function qe(e, { sourceKind: t = "manual_2d", label: a, keys: r, source: o = {} }) {
  if (!la.includes(t)) throw new Error(`Unsupported motion source: ${t}`);
  const n = ds(e), s = { id: n, label: a || `Motion ${n.split("_").at(-1)}`, enabled: !0, semantic: "screen_point", source_kind: t, keys: r.map((i) => ({ visible: !0, interpolation: "linear", ...i })), source: { ...o } };
...
function Ct(e, t) {
  return e.motion_tool = ia.includes(t) ? t : "select", e.motion_tool;
}
function ps(e, t) {
  if (ca.includes(t))
...
function et(e, t) {
  return us(t, e.interactionElement);
}
function bs(e, t) {
...
function _s(e, t) {
  ...
  return qe(e.state, { sourceKind: n, label: l, keys: [{ time_seconds: e.frame / e.state.fps, x: i.x, y: i.y, visible: i.visible !== !1 }], source: s });
}
function $i(e, t) {
  for (const o of e.root.querySelectorAll("[data-motion-tool]"))
    o.addEventListener("click", () => {
      e.motionCreationKind = "", Ct(e.state, o.dataset.motionTool), He(e), e.render();
    }, { signal: t });
  for (const o of e.root.querySelectorAll("[data-motion-preset]"))
    o.addEventListener("click", () => {
      e.checkpoint("Add camera field"), qe(e.state, { sourceKind: "camera_field", label: `${o.dataset.motionPreset} Field`, keys: [{ time_seconds: 0, x: 0.5, y: 0.5 }], source: { preset: o.dataset.motionPreset, point: [...e.camera.target] } }), re(e, `Camera field: ${o.dataset.motionPreset}`);
    }, { signal: t });
  e.root.querySelector('[data-role="motion-interpolation"]')?.addEventListener("change", (o) => {
    const n = Je(e.state);
    n && (e.checkpoint("Set motion interpolation"), ps(n, o.target.value), re(e, `Motion interpolation: ${o.target.value}`));
  ...
  a.addEventListener("pointerdown", (o) => {
    ...
    tt(o), a.setPointerCapture?.(o.pointerId);
    const s = et(e, o);
    if (n === "track") {
      e.checkpoint("Draw motion track"), e.motionTrackDraft = { pointerId: o.pointerId, points: [s] };
      return;
    }
    e.checkpoint(n === "erase" ? "Erase motion track" : "Add motion anchor"), n === "anchor" ? qe(e.state, { sourceKind: "static_anchor", label: `Anchor ${(e.state.motion_layers || []).length + 1}`, keys: [{ time_seconds: e.frame / e.state.fps, ...s, interpolation: "hold" }] }) : n === "project" ? _s(e, s) : n === "erase" && bs(e.state, s), re(e, `Motion tool: ${n}`);
  }, { capture: !0, signal: t }), a.addEventListener("pointermove", (o) => {
    e.motionTrackDraft?.pointerId === o.pointerId && (tt(o), e.motionTrackDraft.points.push(et(e, o)), e.render());
  }, { capture: !0, signal: t });
  const r = (o) => {
    const n = e.motionTrackDraft;
    if (n?.pointerId !== o.pointerId) return;
    tt(o), e.motionTrackDraft = null;
    const [s, i] = Jt(e), l = ys(e.state, n.points, s, i);
  ...
  a.addEventListener("pointerup", r, { capture: !0, signal: t }), a.addEventListener("pointercancel", r, { capture: !0, signal: t }), a.addEventListener("click", (o) => {
    ...
    const n = qr(e.state.motion_layers, et(e, o));
...
function Ss(e, t) {
  ...
  if (a) {
    ...
    e.checkpoint?.(`Motion: ${a.label}`), Ct(e.state, a.tool), e.motionCreatingLabel = a.label, e.motionCreationKind = t, He(e), e.render(), e.setStatus(a.hint);
  }
}
function Hr(e) {
  return (e.state.motion_tool || "select") === "select" && !e.motionTrackDraft ? !1 : (Ct(e.state, "select"), e.motionTrackDraft = null, e.motionCreatingLabel = "", e.motionCreationKind = "", He(e), e.render(), e.setStatus("Motion creation cancelled."), !0);
}
function Ui(e, t) {
...
const ye = { t: "translate", r: "rotate", s: "scale" }, Cs = [
...
], ks = 'button,summary,a[href],[role="button"],[role="menuitem"],[role="tab"],[role="option"],[role="checkbox"],[role="switch"]';
function Ds(e) {
  return e instanceof HTMLElement || e instanceof SVGElement ? !!e.closest?.(ks) : !1;
}
function Ts(e) {
...
function js(e, t) {
  return As(e) || t?.lastKeyZone || "viewport";
}
let ta = !1;
function Es() {
  ta || typeof window > "u" || (ta = !0, window.addEventListener("keydown", (e) => {
    if (!kn()) return;
    const t = e.composedPath?.()[0] || e.target, a = Dn(t);
    !a || a.disposed || Os(a, e) && (e.preventDefault(), e.stopImmediatePropagation?.(), e.stopPropagation());
  }, { capture: !0 }));
}
function Os(e, t) {
  if (!An()) return !1;
  const a = t.composedPath?.()[0] || t.target;
  if (Ts(a) || (t.code === "Space" || t.key === "Enter") && Ds(a)) return !1;
...
function zs(e, t) {
  ...
  if (r === "Numpad9") {
    const i = xs(e.state.view_mode);
    return i ? e.setViewMode(i) : ea(e, Math.PI, 0), !0;
  }
  const n = Math.PI / 12, s = { Numpad4: [n, 0], Numpad6: [-n, 0], Numpad8: [0, n], Numpad2: [0, -n] };
  if (s[r])
    return ea(e, s[r][0], s[r][1]), !0;
  if (r === "Numpad5")
...
function Rs(e, t) {
  ...
  if (a === "s" || a === "a")
    return t.repeat || (!ze(e.state).length || a === "a" ? (e.checkpoint("Auto-split shots"), e.state.sequence = { ...e.state.sequence || { recording_path: "" }, enabled: !0, cuts: so(e.state) }, at(e)) : (e.checkpoint("Split shot"), lo(e.state, e.frame, null) ? at(e) : e.setStatus("Move the playhead inside a shot first"))), !0;
  if (t.key === "Delete" || t.key === "Backspace") {
    if (t.repeat) return !0;
    const r = ze(e.state), o = sa(e.state, e.frame), n = o ? r.findIndex((s) => s.start === o.start) : -1;
    return n >= 0 && (e.checkpoint("Remove shot"), co(e.state, n) && at(e)), !0;
  }
  return !1;
}
function kt(e, t) {
...
function Ks([e, t], [a, r]) {
  ...
  const o = Math.round((window.innerWidth || e) * Ls), n = Math.round((window.innerHeight || t) * Fs);
  return [
...
const aa = "oc-help-css", je = "#8b7bd8", $r = /* @__PURE__ */ new Map();
function Dt(e, t) {
  e && t && $r.set(e, t);
}
function pt(e) {
...
function qs() {
  ...
  e.id = aa, e.textContent = Gs, document.head.appendChild(e);
}
function ne(e) {
...
function ra(e) {
  ...
  if (l.className = "oc-help-body", e.tagline) {
    ...
    f.className = "oc-help-p", f.style.color = "#e6e6e6", f.innerHTML = ne(e.tagline), l.appendChild(f);
  }
  ...
  if (e.footer) {
    ...
    f.className = "oc-help-tip", f.innerHTML = ne(e.footer), l.appendChild(f);
  }
  a.appendChild(l);
  let c = !1;
...
const oa = "MajoorOmniCam.ShowHelp", ft = "oc-help-toolbar-icon", na = "oc-help-toolbar-css", $s = "#8b7bd8";
function Us() {
  if (document.getElementById(na)) return;
  const e = document.createElement("style");
  e.id = na, e.textContent = `
    .${ft}{display:inline-flex;align-items:center;justify-content:center;
      width:16px;height:16px;border-radius:50%;background:${$s};color:#fff;
...
J.registerExtension({
  ...
  getNodeMenuItems(e) {
    const t = pt(e?.comfyClass);
    return t ? [null, { content: "? Help", callback: () => ra(t) }] : [];
  },
  setup() {
    Us();
  }
...
function Ee(e, t) {
  ...
  Array.isArray(a) && a.push({ stage: e, nodeId: t?.id ?? null, nodeClass: Ue(t), configuringGraph: le });
}
Es();
Jr(J);
Pn(J);
J.registerExtension({
  ...
  async nodeCreated(e) {
    ...
    const t = !le, a = t ? null : At(e);
    await kt(e, async () => {
      Ee("director:import:start", e);
      const { attachDirector: o } = await import("./chunk-Dz8fe2o7.js").then((n) => n.g);
      return Ee("director:import:resolved", e), o;
    });
    const r = e.__majoorOmniCam;
    r && (Ee("director:attach:complete", e), zn(r), t && Nn(r), Tt(e, ct, t, a?.()));
  }
});
J.registerExtension({
  ...
  async nodeCreated(e) {
    if (Ue(e) !== mt) return;
    const t = !le, a = t ? null : At(e);
    await kt(e, async () => (await import("./chunk-Bqb7d5ue.js")).attachExtractor), e.__majoorOmniCamExtractor && Tt(e, mt, t, a?.());
  }
});
J.registerExtension({
  ...
  async nodeCreated(e) {
    if (Ue(e) !== dt) return;
    const t = !le, a = t ? null : At(e);
    await kt(e, async () => (await import("./chunk-P8IUI66f.js")).attachMonitor), e.__majoorOmniCamMonitor && Tt(e, dt, t, a?.());
  }
});
export {
  Br as $,
