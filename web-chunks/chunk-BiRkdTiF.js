...
const ho = () => import("./chunk-ZEJIfNtN.js");
function Cf(e, t) {
...
async function Bh(e) {
  ...
  try {
    let n = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-fds9cs39.js");
...
class ai {
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-fds9cs39.js"));
    } catch (a) {
  ...
  try {
    t.assetBrowser = Ep(t, {
      ...
      onAgentFirstOpen: async () => {
        if (Zo())
          try {
            const { createDirectorAgentPanel: m } = await import("./chunk-85ZSfbrq.js");
            t.agentPanel = m(t);
          } catch (m) {
