...
import { s as $e, c as J, t as he, a as s, o as Kn, b as gr, d as Ve, e as pe, f as Lo, r as si, g as yr, h as Bn, i as ii, j as ci, k as li, l as di, m as vr, n as xr, I as ko, D as mi, p as wr, q as pi, w as fi, u as Co, v as qn, x as hi, y as kr, z as er, A as Ur, B as Un, C as tr, E as Wn, F as Vn, G as Hn, H as Gn, J as ar, K as qo, L as Wr, O as Vr, R as Yn, M as ui, N as bi, P as gi, Q as yi, S as vi, T as _e, U as Hr, V as Kt, W as xi, X as Sr, Y as wi, Z as ki, _ as Si, $ as ji, a0 as _i, a1 as jr, a2 as Ci, a3 as Ei, a4 as Ai, a5 as Ti, a6 as $i, a7 as Mi, a8 as Ii, a9 as Oi, aa as Pi, ab as Li, ac as zi, ad as Fi, ae as Ni, af as Ri, ag as Di, ah as Ki, ai as Bi, aj as qi, ak as Ui, al as Wi, am as Vi, an as Hi, ao as Gi, ap as Yi, aq as Xi, ar as Ji, as as Zi, at as Qi, au as ec, av as tc, aw as ac, ax as oc, ay as rc, az as nc, aA as sc, aB as ic, aC as cc, aD as lc, aE as dc, aF as mc, aG as pc, aH as fc, aI as hc, aJ as Xn, aK as uc, aL as Uo, aM as bc, aN as gc, aO as yc, aP as vc, aQ as xc, aR as We, aS as wc, aT as Jn, aU as _r, aV as kc, aW as Sc, aX as jc, aY as Zn, aZ as Ze, a_ as _c, a$ as Gr, b0 as Cr, b1 as Cc, b2 as Ec, b3 as Ac, b4 as Tc, b5 as $c, b6 as Mc, b7 as Ic, b8 as Oc, b9 as Pc, ba as Qn, bb as Lc, bc as zc, bd as Fc, be as Nc, bf as Rc, bg as Dc, bh as Kc, bi as Bc, bj as qc, bk as Uc, bl as Wc, bm as Vc, bn as Hc, bo as Gc, bp as Yc, bq as Xc, br as Jc, bs as Zc, bt as Qc } from "./chunk-CxXyW-I9.js";
import { L as el, a as tl, p as Gt, f as Er, b as al, S as ol, c as Yr, d as rl, e as nl, r as sl, g as il, n as cl, C as Xr, h as Yt, o as ll, i as dl, s as ml, j as pl, k as es, l as fl, m as or, q as rr, w as hl, t as ts, u as ul, v as bl, x as gl, y as yl, z as vl, A as xl, B as wl, D as kl, E as Sl, F as jl, G as _l, H as Cl, I as El, J as Al, K as Tl, M as $l } from "./chunk-CyRUstHE.js";
import { S as Ml, b as Il, p as Ol, m as Pl, l as Ll, u as zl } from "./chunk-BOI_2OKd.js";
import { T as Fl } from "./chunk-__IQ4xkd.js";
import { T as Nl, R as Rl } from "./vendor-three-BQUrLQkn.js";
function Lt(e, t = 0) {
...
function Dl(e, { type: t = "handheld_subtle", intensity: a = 1, duration_frames: o = null, subdivide: r = !0 } = {}) {
  ...
  return [...b].sort((v, x) => v - x).map((v) => {
    const x = $e(u, v), k = Lt(v * m, 1) * l, y = Lt(v * m, 2) * l, j = Lt(v * m, 3) * l * 0.5, A = Lt(v * m, 4) * p, R = Lt(v * m, 5) * (p * 0.35), F = [...x.position], X = [...x.target];
    return F[0] += k, F[1] += y, F[2] += j, X[0] += k * 0.35, X[1] += y * 0.35, {
      frame: v,
      camera: {
        ...x,
        position: F,
...
const os = [
  ...
  },
  {
    ...
    label: "Look At",
    color: "#f0a742",
    changed: (e, t) => Bl(e?.target, t?.target),
    read: (e) => e?.target
  },
  {
    id: "focal_length",
...
function Eo(e) {
  ...
  for (const a of [".oc-playhead-head", '[data-role="dope-playhead"]', ".oc-gdope-playhead", ".oc-sequence-playhead"])
    for (const o of e.root.querySelectorAll(a)) Wl(o, t);
}
function Vl(e, t, a) {
...
function rs(e) {
  ...
  a.delete("camera");
  const o = e.timelineKeyframes() || [], r = Ul(o, a), n = Gl(e, r);
  if (t.dataset.signature !== n) {
    t.dataset.signature = n, t.replaceChildren();
    const i = (c) => he(e, c);
    for (const c of r) {
      const l = document.createElement("div");
      l.className = "oc-dope-row", l.dataset.channel = c.id, l.style.setProperty("--channel-color", c.color), Vl(l, c.frames, i), Hl(e, l, c, o, i), t.appendChild(l);
    }
  }
...
const Zl = [1, 2, 2.5, 5, 10];
function Ql(e, t = 5) {
  const a = Math.abs(e) / Math.max(1, t);
  if (!(a > 0) || !Number.isFinite(a)) return 1;
  const o = 10 ** Math.floor(Math.log10(a)), r = a / o;
  return (Zl.find((n) => n >= r) ?? 10) * o;
}
function ed(e, t) {
  const a = Math.max(0, Math.min(4, Math.ceil(-Math.log10(t))));
  return e.toFixed(a);
}
function td(e, { left: t, right: a, top: o, width: r, graphWidth: n, graphHeight: i, height: c, timeMin: l, timeMax: p, totalDuration: m, xFor: f, frame: d }) {
  const h = is(p - l, n);
...
function ad(e, { left: t, right: a, top: o, width: r, graphHeight: n, minimum: i, maximum: c, yFor: l }) {
  ...
  for (let m = Math.ceil(i / p) * p; m <= c; m += p) {
    const f = l(m);
    f < o - 1 || f > o + n + 1 || (e.beginPath(), e.moveTo(t, f), e.lineTo(r - a, f), e.stroke(), e.fillText(ed(m, p), 4, f + 3));
  }
}
function Ar(e, t) {
...
function hd(e) {
  ...
  const F = j.flatMap((C) => l.map((V) => V.get(C.value)));
  let X = Math.min(...F), W = Math.max(...F);
  (!Number.isFinite(X) || !Number.isFinite(W)) && (X = -1, W = 1), Math.abs(W - X) < 1e-6 && (X -= 1, W += 1);
  const G = (W - X) * 0.1;
  X -= G, W += G;
  const re = J(Number(e.curveZoom) || 1, 0.1, 50), _ = (W + X) / 2 + (Number(e.curvePanY) || 0), N = (W - X) / re;
  X = _ - N / 2, W = _ + N / 2;
  const U = (C) => p + (C - k) / Math.max(1e-6, y - k) * h, Y = (C) => f + u * (W - C) / Math.max(1e-6, W - X);
  if (n.fillStyle = "#111114", n.fillRect(0, 0, a, o), n.strokeStyle = "#222228", n.lineWidth = 1, n.font = "9px system-ui, -apple-system, sans-serif", n.fillStyle = "#6e727a", td(n, {
    left: p,
    right: m,
    top: f,
    width: a,
    ...
    xFor: U,
    frame: e.frame
  }), ad(n, { left: p, right: m, top: f, width: a, graphHeight: u, minimum: X, maximum: W, yFor: Y }), X <= 0 && W >= 0) {
    const C = Y(0);
...
function ds(e) {
  ...
  if (!t) return;
  const a = e.timelineObject(), o = a ? a.name || a.type : e.activeCameraTrack().name, r = ud(e), n = `${o}\0${r.map((c) => `${c.id}:${c.color}`).join("|")}`;
  if (t.dataset.signature !== n) {
    t.dataset.signature = n, t.replaceChildren();
...
function wd(e, t, a, o) {
  ...
  if (c.className = "oc-sequence-name", c.textContent = r?.name || t.camera_id, i.appendChild(c), a > 0) {
    ...
    l.className = "oc-sequence-handle", l.title = s("Drag to trim the cut"), l.addEventListener("pointerdown", (p) => vd(e, p, l, o, a)), i.appendChild(l);
  }
  return i.addEventListener("contextmenu", (l) => xd(e, l, t, a, o.__cutCount)), i.addEventListener("pointerdown", () => {
...
function fs(e, t) {
  ...
  if (n.className = "oc-sequence-lane", n.dataset.role = "sequence-lane", n.setAttribute("aria-label", s("Multi-camera edit")), o.length)
    for (const [c, l] of o.entries()) {
      ...
      he(e, l.end + 1) < -5 || p > 105 || n.appendChild(wd(e, l, c, r));
    }
  else {
    const c = document.createElement("span");
  ...
  r.appendChild(n), r.appendChild(kd(e));
  const i = document.createElement("span");
  i.className = "oc-sequence-playhead", i.style.left = `${he(e, e.frame)}%`, r.appendChild(i), t.appendChild(r);
}
const Sd = ['[data-act="curve-zoom-in"]', '[data-act="curve-zoom-out"]', '[data-act="curve-fit"]', '[data-act="curve-handles"]'], an = { curves: "Graph", dope: "Timeline", sequence: "Sequence" };
function on(e, t) {
...
const Cd = /* @__PURE__ */ new Set(["good", "warning", "bad", "unknown"]);
function hs(e, t) {
  ...
  for (const n of r.frames) {
    ...
    const c = Cd.has(n?.state) ? n.state : "unknown", l = n?.score;
    let p = null;
    if (l != null) {
      const m = Number(l);
...
function Td(e) {
  ...
  if (e.audioWaveformPeaks && e.audioWaveformPeaks.length) {
    ...
    for (let F = 0; F < y.length; F++) {
      const W = (F / (y.length - 1) * r - l) / Math.max(1e-6, c) * j;
      if (W >= -5 && W <= j + 5) {
        const G = y[F] * (A * 0.85);
  ...
  for (const x of o) {
    ...
    j.className = "key-label", j.textContent = String(x.frame), y.appendChild(j), y.addEventListener("pointerdown", (A) => {
      if (A.preventDefault(), A.stopPropagation(), y.focus({ preventScroll: !0 }), A.altKey) {
        ...
        const F = a ? { frame: x.frame, transform: Ve(x.transform), interpolation: x.interpolation } : { frame: x.frame, camera: pe(x.camera), interpolation: x.interpolation }, X = e.timelineKeyframes();
        X.push(F), X.sort((W, G) => W.frame - G.frame), e.selectedKeyFrame = F.frame, e.selectedKeyFrames = /* @__PURE__ */ new Set([F.frame]), e.keyDrag = { key: F, box: t, isDuplicate: !0, historyCheckpointed: !0, moving: [{ key: F, startFrame: F.frame }], startPointerFrame: x.frame, startClientX: A.clientX, startClientY: A.clientY }, e.setFrame(F.frame, !1, !1), e.setStatus(s(`Duplicating key from ${x.frame}...`));
        return;
      }
      if (A.shiftKey) {
      ...
      e.keyDrag = { key: x, box: t, historyCheckpointed: !1, moving: R.map((F) => ({ key: F, startFrame: F.frame })), startPointerFrame: x.frame, startClientX: A.clientX, startClientY: A.clientY }, e.setFrame(x.frame, !1, !1);
  ...
  v && (v.textContent = m.name), cs(e), rs(e), ds(e), Tr(e), jd(e), e.refreshCameraSelectors(), e.refreshKeyEditor(), e.updateEditState(), e.drawCurveEditor(), e.perf && (e.perf.timelineRefreshCount = (e.perf.timelineRefreshCount || 0) + 1), Ad(e);
}
class us {
...
function Xd() {
  const e = tl.map((t) => `<button data-lens="${t}">${t}mm</button>`).join("");
  return `
...
const Qe = 1, nn = 50, Me = 120, pt = 160, bm = Object.freeze(["perspective", "orthographic"]), K = Object.freeze({
...
}), gm = Object.freeze(Object.values(we));
...
const ym = 25, sn = 100;
function ft(e, t) {
  const a = e?.offset === void 0 ? 0 : Number(e.offset), o = e?.limit === void 0 ? ym : Number(e.limit);
...
function Am(e, t) {
  ...
  e.objects ||= [];
  const a = new Set(e.objects.map((i) => i.id)), o = zo(a, t.objectType, t.id), r = km(t.objectType), n = {
    id: o,
    type: t.objectType,
    name: t.name || o,
    ...r,
...
function Fm(e, t) {
  ...
  for (a.has(t) && a.delete(t), a.add(t); a.size > zm; )
...
function Bm(e, t) {
  ...
  return t.operations.forEach((a, o) => Km(a, o)), {
    version: Qe,
    id: t.id,
...
const Um = "omnicam/library", Wm = "majoor_omnicam/blockout_library", Vm = Object.freeze({
...
function xs(e) {
  return e.file ? `${e.source === "legacy" ? Wm : Um}/${e.file} [input]` : "";
}
function cn(e, t, a) {
  const o = e || "asset";
  let r = `${o}_${a}`, n = 2;
...
function Ym(e, t = {}) {
  ...
  const a = Hm(t.point, [0, 0, 0]), o = String(t.idSeed || Date.now().toString(36)), r = String(e.kind || "prop"), n = r === "character", i = Vm[e.id];
  ...
  return n && (c.character = Gm(e)), c;
}
function Xm({ groundHit: e, orbitTarget: t } = {}) {
...
const Jm = {
  [K.ASSET_INSTANTIATE](e, t) {
    ...
    let o;
    try {
      o = Ym(t.asset, { point: t.point, idSeed: t.id, existingIds: a });
    } catch (r) {
...
function Zm({ state: e, operation: t }) {
  const a = Jm[t.type];
...
function ep(e, t) {
  ...
  return ap(e, t, r), rp(e, t, r), sp(e, t, r), np(e, t, r), ip(e, t, r), cp(e, t, r), { changes: a, truncated: o };
}
const tp = ["fov", "roll", "zoom", "near", "far", "camera_type"];
function ap(e, t, a) {
...
const op = ["position", "target", "fov", "roll", "zoom", "near", "far", "camera_type"];
function rp(e, t, a) {
  const o = et(e?.cameras), r = et(t?.cameras);
  for (const [n, i] of r) {
...
function hp(e, t) {
  ...
  for (let f = 0; f < a.operations.length; f += 1)
    try {
      const d = Zm({ ui: e, state: r, operation: a.operations[f] });
  ...
  if (a.validateOnly) {
    const { changes: f, truncated: d } = ep(e.state, r);
    return {
      ok: !0,
      version: Qe,
      revision: o,
  ...
  const l = dp(e);
  Fm(e, a.id), e.serialize?.(), mp(e, l), fp(e, n, `director-api:${a.id}`);
  const p = {
    ok: !0,
    version: Qe,
    baseRevision: o,
...
function bp(e) {
  return e.directorApi = up(e), e.directorApi;
}
const dn = "omnicam-agent/1", mn = "majoor.omnicam.agent.request", gp = 1, Ft = Object.freeze({
...
}), yp = 1e4, vp = 5e3, ws = "asset.instantiate_by_id", ks = "asset.catalog_search", pn = Object.freeze([
...
function Sp(e, t, a) {
  ...
  async function g(k) {
    const y = k?.detail;
    if (o || !y || y.protocol !== dn || Number(y.schema_version) !== gp || y.session_id !== r || String(y.node_id) !== String(t.id)) return;
    let j;
    try {
      if (y.kind === "query")
        j = y.payload?.type === ks ? await kp(e, y.payload) : e.directorApi.query(y.payload);
      else if (y.kind === "transaction") {
        const A = y.payload, R = (A?.operations || []).find(
          (F) => !pn.includes(F?.type)
        );
        if (!Number.isInteger(A?.baseRevision) || A.baseRevision < 0)
          ...
          const F = await wp(e, A.operations);
          F.ok ? (j = e.directorApi.execute({ ...A, operations: F.operations }), await j?._reconciliation) : j = Rt(e, F.code, F.message);
        }
      } else
  ...
  return a.addEventListener?.(mn, g), a.addEventListener?.("status", x), d(), {
    ...
    dispose() {
      ...
      const k = r, y = n;
      r = null, n = null, k && y && Nt(a, Ft.close, {
        session_id: k,
        session_token: y
      }).catch(() => {
      });
...
function Mr({ fetchApi: e = jp } = {}) {
  const t = (a, o) => Promise.resolve(e(a, o)).then(_p);
  return {
    list(a = {}) {
...
const $p = 256;
function un(e = {}) {
  const { THREE: t, GLTFLoader: a, FBXLoader: o, size: r = $p } = e;
  if (!t || !a)
...
function Lp(e, t = {}) {
  return Ss.map((a) => {
    const o = s(Pp[a] || a), r = a === "all" ? "" : ` <span class="oc-asset-kind-n">${Number(t[a] || 0)}</span>`;
    return `<button type="button" class="oc-asset-kind${a === (e || "all") ? " active" : ""}" data-asset-kind="${a}">${vt(o)}${r}</button>`;
  }).join("");
}
function zp(e, { selected: t = !1, thumbUrl: a = "" } = {}) {
  const o = Op[e.kind] || "pi-box", r = e.kind === "character" && Un(e.rig) === "rigged" ? `<span class="oc-asset-badge">${s("RIGGED")}</span>` : "", n = a ? `<img class="oc-asset-thumb" src="${vt(a)}" alt="" loading="lazy">` : `<span class="oc-asset-thumb oc-asset-thumb--glyph"><i class="pi ${o}"></i></span>`;
...
function Fp(e, { selectedId: t = "", thumbUrls: a = {} } = {}) {
  return !e || !e.length ? `<p class="oc-asset-empty">${s("No assets match this filter.")}</p>` : e.map((o) => zp(o, {
    selected: o.id === t,
    thumbUrl: a[o.id] || ""
  })).join("");
}
...
function Np(e, t = {}) {
  const a = e.root, o = t.fetchApi || ((O, B) => (e.api || e.app?.api).fetchApi(O, B)), r = t.apiClient || Mr({ fetchApi: o }), n = t.store || Ep(r), i = Ap(), c = t.previewQueue || Tp(), l = e.api || e.app?.api || null;
  let p = t.thumbnailRenderer || null, m = null;
  const f = /* @__PURE__ */ new Set();
  function d() {
    return p ? Promise.resolve(p) : (m || (m = Mp().then((O) => p = un(O)).catch(() => p = un({}))), m);
  }
  function h(O) {
    return Ur(l, xs(O));
  }
    ...
    for (const O of n.state.items) {
      ...
      B && c.enqueue(O.id, async () => {
        ...
        if (i.set(O.id, Se), H(), !(O.source && O.source !== "user"))
          try {
            const Oe = await r.uploadThumbnail(O.id, Ip(Se));
  ...
  const g = (O) => a.querySelector(`[data-role="${O}"]`), v = g("assets-panel"), x = g("asset-grid"), k = g("asset-kinds"), y = g("asset-search"), j = g("asset-status"), A = g("asset-import-file"), R = g("scene-tab"), F = g("assets-tab"), X = g("agent-tab"), W = a.querySelector('[data-asset-view="agent"]'), G = { assets: F, agent: X };
  let re = "", _ = null, N = !0, U = !0, Y = "scene", L = 0;
  ...
  let z = !1;
  function H() {
    if (k && (k.innerHTML = Lp(n.state.filter.kind, n.state.kinds)), x) {
      const O = {};
      for (const B of n.state.items) {
        const de = i.get(B.id) || u(B);
        de && (O[B.id] = de);
      }
      x.innerHTML = Fp(n.state.items, { selectedId: re, thumbUrls: O });
    }
    if (!z) {
      z = !0;
      try {
  ...
  async function fe(O) {
    ...
    try {
      ...
      const Oe = (de.installed || []).filter((Pe) => Pe.status !== "conflict").length, Ne = (de.installed || []).filter((Pe) => Pe.status === "conflict").length;
      C(
...
function Wp(e, t = {}) {
  const a = e.root, o = t.apiClient || Mr({
    fetchApi: (_, N) => (e.api || e.app?.api).fetchApi(_, N)
  ...
  function g(_) {
    const N = Co({ ..._, preset_id: _.id });
    return { id: _.id, name: _.name || _.id, root_offset: N.root_offset, joints: N.joints };
  }
  function v(_) {
    const N = d.get(_?.pose?.preset_id) || null;
    return bi({ preset: N, overrides: _?.pose }).joints;
  }
  function x() {
    const _ = h();
  ...
  function y() {
    const _ = h(), N = !!_?.character?.motion;
  ...
  async function j() {
    try {
      ...
      d = new Map((_.poses || []).filter((N) => N?.id).map((N) => [N.id, g(N)]));
    } catch {
      d = /* @__PURE__ */ new Map();
    }
  ...
  function A() {
    const _ = b();
    if (!_) return;
    const N = p.map((L) => Number(L?.value) || 0), U = ui(N), Y = e.directorApi?.execute({
      version: 1,
  ...
  function R() {
    const _ = n?.value || "neutral", N = d.get(_) || Co({ preset_id: _ });
    e.directorApi?.execute({
      version: 1,
      id: `tx_preset_${Date.now().toString(36)}`,
      description: "Pose preset",
      operations: [{ type: "character.set_pose", objectId: m, pose: { preset_id: _, root_offset: N.root_offset, joints: {} } }]
    }), y();
  }
  async function F() {
    const _ = h();
    if (!_?.character) return;
    const N = (await Gt(e, s("Save Pose"), s("Pose name"), ""))?.trim();
    if (!N || e.disposed) return;
    const U = N.toLowerCase().replace(Up, "-").replace(/^-+|-+$/g, "").slice(0, 60) || "pose";
    try {
      ...
      d.set(Y.pose.id, g(Y.pose)), e.setStatus?.(s("Pose saved: {name}").replace("{name}", N)), y();
    } catch (Y) {
  ...
  e.rigOverlay = G;
  function re() {
    const _ = e.selectedObject?.(), N = _?.asset_kind === "character";
    if (r.hidden = !N, !N) {
  ...
  n?.addEventListener("change", R), i?.addEventListener("click", X), r.querySelector('[data-pose-act="save"]')?.addEventListener("click", F);
  for (const _ of p)
...
const Hp = /* @__PURE__ */ new Set(["translate", "rotate", "scale"]), Gp = /* @__PURE__ */ new Set(["world", "local"]), Be = 180 / Math.PI;
function vn(e) {
  return [e.x, e.y, e.z];
}
function Yp(e) {
...
function Xp({
  ...
  const m = p ? p() : new e.Object3D(), f = l ? l(t, a) : new Nl(t, a);
  let d = null;
  ...
  function W(L) {
    if (!Hp.has(L)) throw new Error(`createTransformControlsAdapter: unknown mode "${L}"`);
    f.setMode ? f.setMode(L) : f.mode = L;
  }
  function G(L) {
    if (!Gp.has(L)) throw new Error(`createTransformControlsAdapter: unknown space "${L}"`);
    f.space = L;
  }
  function re(L) {
...
const Jp = /* @__PURE__ */ new Set(["object", "camera", "camera_target"]);
function Zp(e, { controlsFactory: t, anchorFactory: a } = {}) {
  let o = null, r = null;
  function n() {
    return o || (!e.webgl || !e.interactionElement ? null : (o = Xp({
      THREE: Fl,
  ...
  function d() {
    ...
    if (!(!!g && Jp.has(g.type) && g.allowedModes.includes(v))) {
      o?.detach();
      return;
    }
...
function nf(e, t, a, o) {
  ...
  const [A, R] = k(h[0] || 0, h[2] || 0), [F, X] = k(u[0] || 0, u[2] || 0), W = 8, G = J(A, n + W, n + c - W), re = J(R, i + W, i + c - W), _ = J(F, n + W, n + c - W), N = J(X, i + W, i + c - W), U = h[1] || 0, Y = of(U), L = rf(U);
  t.strokeStyle = "rgba(255, 255, 255, 0.40)", t.lineWidth = 1, t.setLineDash([3, 3]), t.beginPath(), t.moveTo(G, re), t.lineTo(_, N), t.stroke(), t.setLineDash([]), t.fillStyle = "#ffffff", t.beginPath(), t.arc(_, N, 2.5, 0, Math.PI * 2), t.fill(), t.strokeStyle = "rgba(255, 255, 255, 0.7)", t.lineWidth = 1, t.beginPath(), t.arc(_, N, 4.5, 0, Math.PI * 2), t.stroke();
...
function pf(e, t, a) {
  ...
  }, { signal: a }), Jl(e, a), _d(e, a), t('[data-role="curve-group"]')?.addEventListener("change", () => {
  ...
  e.root.addEventListener("pointerdown", (d) => {
    ...
    const h = e.interactionElement.getBoundingClientRect(), u = (d.clientX - h.left) * e.canvas.width / Math.max(1, h.width), b = (d.clientY - h.top) * e.canvas.height / Math.max(1, h.height);
    mf(e, d, u, b) || e.onWheel(d);
  }, { passive: !1, signal: a }), e.root.addEventListener("wheel", Ol(e.root), { signal: a }), window.addEventListener("pointermove", (d) => {
...
function gf() {
  return `<span class="oc-pref-emoji" aria-hidden="true">${ff}</span> ${s("OmniCam Preferences")}`;
}
function yf(e) {
  ...
  a.className = "oc-modal-backdrop", a.setAttribute("role", "dialog"), a.setAttribute("aria-modal", "true"), a.setAttribute("aria-label", s("OmniCam Preferences")), a.innerHTML = `
    <div class="oc-modal-dialog oc-pref-dialog" tabindex="-1">
      <div class="oc-pref-header">
        <div class="oc-pref-title">${gf()}</div>
...
const xf = ["position", "target"], wf = ["fov", "zoom"], kf = ["roll"], Sf = ["position", "size"], jf = ["rotation"];
function mr(e) {
...
function If(e, t) {
  ...
  const o = (r) => {
    ...
    const u = (g) => {
      ...
      let x = Tf;
      g.shiftKey ? x = $f : (g.ctrlKey || g.metaKey) && (x = Mf);
      const k = p * x * 20;
      let y = l + v * k;
...
function Ff(e, t) {
  ...
  }, n = (i) => (e.smoothingBaseline?.cameraId !== i.id && (e.smoothingBaseline = { cameraId: i.id, keys: Af(i.keyframes) }), e.smoothingBaseline.keys);
  a.addEventListener("input", r, { signal: t }), a.addEventListener("change", () => {
    const i = e.activeCameraTrack();
    if (!i) return;
    e.checkpoint("Path smoothing");
    const c = Number(a.value) / 100, l = Ef(n(i), c);
...
const bo = () => import("./chunk-CJZHs7Fe.js");
function qf(e, t) {
...
function Gf(e, t) {
  qf(e, t), zf(e, t), Ff(e, t), Nf(e, t), Rf(e, t), Wf(e, t), Hf(e, t), Vf(e, t), If(e, t), Of(e, t), Df(e, t), Bf(e, t), Lf(e, t), Kf(e, t), Uf(e, t);
}
const Cn = {
...
function Yf(e, t = "#1b1f2b", a = "#151822", o = "#1e2330", r = "#161922", n = "#111319") {
...
function jg(e, t, a = Ts) {
  ...
  const h = new e.FogExp2(1250588, 8e-3), u = Yf(e), b = new e.PMREMGenerator(t);
  b.compileEquirectangularShader();
  const g = new Rl(), v = b.fromScene(g, 0.04).texture;
  return g.traverse((x) => {
    x.geometry?.dispose?.();
...
function Jf(e) {
  ...
  const r = e.reconstruction, n = r.provider || "Reconstructed", i = Math.round(t * 100), c = sl(e), l = c.length ? `
` + c.map(([m, f]) => `${m}: ${f}`).join(`
`) : "", p = `${n} • ${o} (${i}%)${l}`;
  return {
    label: o,
...
const th = 32, ah = 0.025, oh = 0.05, Ao = 1e-6, rh = ["top", "bottom", "front", "back", "left", "right"], nh = {
  top: "y",
  bottom: "y",
  front: "z",
  back: "z",
...
function dh(e) {
  ...
  const n = Math.min(th, r.length, o + 1);
  if (n < 2) return [];
  const i = ih(r, n);
  ...
  for (let d = m; d < i.length; d++) {
    const h = i[d], u = ch(i, d, p, e.planeAxis), b = pe(c);
...
function An(e, t = {}) {
  ...
  if (a === "extend") {
    ...
    rh.includes(e.state.view_mode) || e.setViewMode?.("top"), c = En(e.state);
  const m = nh[e.state.view_mode] ?? null, f = n ? [...n] : [...r.position];
...
function Lr(e, t) {
  ...
  return r && Pr(r, o) < ah ? !1 : (a.points.push(o), !0);
}
function qe(e) {
...
function ph(e) {
  ...
  if (a.length < 2 || sh(a) < oh || t.range[1] <= t.range[0])
  ...
  const r = cl(e.state), n = e.state.cameras.length, i = {
    id: r,
    name: mh(e.state),
...
function bh(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : ($o(t), t.type === "pointercancel" || t.type === "lostpointercapture" ? (qe(e), !0) : (Lr(e, zr(e, t)), a.drawing = !1, ph(e), !0));
}
function gh(e) {
  const t = e.cameraPathDraw;
...
async function vh(e) {
  await Yt(e, s("New Scene"), s("Start a new scene? Unsaved changes will be lost.")) && Fr(e, Jn(), { name: "", status: s("New scene") });
}
async function xh(e) {
  if (!e.sceneBaseline) {
...
function jh(e, t) {
  yo(e, t, e.root.querySelectorAll('[data-act="scene-new"]'), () => vh(e)), yo(e, t, e.root.querySelectorAll('[data-act="scene-open"]'), () => kh(e)), yo(e, t, e.root.querySelectorAll('[data-act="scene-save"]'), () => wh(e)), yo(e, t, e.root.querySelectorAll('[data-act="scene-reset"]'), () => xh(e));
}
const _h = ["world_point", "object_point", "camera_field"], Tn = 40;
function Ch(e) {
...
function Th(e) {
  ...
  for (const g of e.state.motion_layers || []) {
    if (g.enabled === !1) continue;
    const v = _h.includes(g.source_kind), x = v ? Eh(e.state, g, d) : Ch(g);
    ...
    if (c.strokeStyle = k ? "#ffcc4d" : "rgba(65,217,197,0.6)", c.lineWidth = (k ? 2.4 : 1.5) * r, c.beginPath(), x.forEach((j, A) => {
      const R = p(j.x), F = m(j.y);
      A ? c.lineTo(R, F) : c.moveTo(R, F);
    }), c.stroke(), !v) {
...
function Mh(e) {
  ...
  Sc(e, t), jc(e, t), $h(e, t), vf(e, a, t), eh(e, a, t), dl(e, t), yh(e, t), jh(e, t), pf(e, a, t), Gf(e, t);
}
function Ih(e, t) {
...
function Oh(e, t) {
  ...
  return {
    ...
    motion_scene_fingerprint: Pl(e.state)
  };
}
function Ph(e, t) {
  const a = Oh(e, t);
...
const ct = 1024 * 1024, Lh = Object.freeze({
  card: 128 * ct,
  // MAX_CARD_BYTES
  model: 256 * ct,
  // MAX_MODEL_BYTES
...
async function Rh(e, { load: t = () => import("./vendor-mediabunny-CZ5VNE-V.js") } = {}) {
...
async function Kh(e, t, { decode: a = Rh } = {}) {
  if (!t) return;
  const o = Xt(t, "audio");
  if (o) {
    e.setStatus(o);
  ...
  try {
    ...
    n.preload = "auto", n.src = r, e.audioObjectUrl = r, e.audioElement = n, await Dh(n), e.audioDuration = Number.isFinite(n.duration) ? n.duration : 0;
    try {
...
const Fs = /* @__PURE__ */ new WeakSet(), Bt = /* @__PURE__ */ new WeakMap();
function Io(e) {
...
function qh(e) {
  ...
  Bt.delete(e), Fs.has(e) && Io(e);
}
function Jt(e, t) {
  const a = e.cardMediaById.get(t);
  a && (e.cardMediaById.delete(t), e.cardMediaAssetById?.delete?.(t), t === "subject" && e.cardMedia === a && (e.cardMedia = null), qh(a));
}
function Uh(e) {
...
function tt(e, t, a, o = !1, r = "") {
  ...
  n && n !== a && Jt(e, t), o && Fs.add(a), Bh(a), e.cardMediaAssetById ||= /* @__PURE__ */ new Map(), e.cardMediaById.set(t, a), e.cardMediaAssetById.set(t, r || a?.__omnicamAsset || "");
  try {
    a.__omnicamAsset = r || a.__omnicamAsset || "";
  } catch {
  }
...
function Ns(e, t, { signal: a, timeout: o = 15e3 } = {}) {
...
async function Rs(e, t, a, o = () => !0, r = null) {
  ...
  if (r ?? /\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/.test(i)) {
    ...
    if (l.src = a, l.loop = !0, l.muted = !0, l.playsInline = !0, await Ns(l, ["loadeddata", "error"], { signal: e.abortController?.signal }).catch(() => {
    }), !n()) {
      Io(l);
      return;
    }
...
async function Zh(e) {
  ...
  ml(e) && (n = !0), n && (e.serialize(), e.render());
}
const Qh = ["video/mp4;codecs=avc1.42E01E", "video/webm;codecs=vp9", "video/webm;codecs=vp8", "video/webm"], On = { low: 3e6, balanced: 6e6, high: 12e6 };
function eu(e) {
  ...
  try {
    for (const k of Qh)
      if (!(n.isTypeSupported && !n.isTypeSupported(k)))
        try {
          f = new n(m, { mimeType: k, videoBitsPerSecond: eu(r) });
          break;
        } catch {
        }
...
async function ou(e) {
  await Promise.all([...e].filter((t) => t instanceof HTMLVideoElement && t.seeking).map((t) => Ns(t, ["seeked", "error"], { timeout: 5e3 }).catch(() => {
  })));
}
async function Ds(e) {
  await ou(e.cardMediaById.values());
}
async function Ks(e) {
  return tu({
    canvas: e.canvas,
...
async function Bs(e, t) {
  const a = await au(at, t);
  if (Ph(e, t), e.state.playblast_camera_id === Zn)
...
async function nu(e) {
  ...
  const t = e.frame, a = e.canvas.width, o = e.canvas.height, r = ru(e);
  (r.width !== e.canvas.width || r.height !== e.canvas.height) && (e.canvas.width = r.width, e.canvas.height = r.height, e.render());
  try {
    let n = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-C71llfBO.js");
...
function du(e) {
  ...
  for (const m of a) {
    ...
    r.fillStyle = "rgba(16,17,22,0.82)", mu(r, A, R, y, j, 4 * c), r.fill(), g && (r.strokeStyle = g, r.lineWidth = Math.max(1, c), r.stroke()), r.fillStyle = g || "#e6e6ec", r.fillText(f, A + v, R + j - x - 2 * c);
  }
  r.restore();
}
function mu(e, t, a, o, r, n) {
...
const hu = 600;
function uu(e) {
  const { points: t, colors: a } = fu(e);
  if (!t.length) return;
  const o = e.viewportCamera(), r = e.canvas.width, n = e.canvas.height, i = t.length / 3, c = 3 * Math.max(1, Math.ceil(i / hu)), l = /* @__PURE__ */ new Map();
...
function _u(e) {
  ...
  e.recording && e.state.playblast_labels && du(e);
}
async function Cu(e, { signal: t } = {}) {
...
async function Au(e) {
  ...
  const r = o.diagnostic?.issues || [], n = Eu(r);
    ...
    if (t.appendChild(h), !u)
      for (const b of d) {
        ...
        if (j.className = "scene-item-label", k || v) {
          const F = document.createElement("span");
          F.style.cssText = `color:${k ? "#f59e0b" : "#58cc6b"};font-weight:700`, F.textContent = k ? "● " : "○ ", j.appendChild(F);
        }
        if (j.appendChild(document.createTextNode(b.name)), x) {
          const F = document.createElement("span");
          F.style.cssText = "color:#f2d06b;font-size:10px", F.title = "Playblast Output", F.textContent = " ★", j.appendChild(F);
        }
        if (b.muted) {
          const F = document.createElement("span");
          F.style.opacity = ".6", F.textContent = " (muted)", j.appendChild(F);
        }
        const A = document.createElement("div");
        ...
        )), A.appendChild(r("pi-ellipsis-v", "Camera actions", !1, (F) => e.openCameraContext(F, b.id, !1))), g.append(y, j, A), g.title = k ? s("Currently selected for editing") : x ? s("Active playblast camera") : s("Click to select & activate this camera");
        const R = () => {
  ...
  if (m) {
    ...
    if (t.appendChild(x), !k)
      for (const { object: y, level: j } of v) {
        ...
        const R = e.selectedEntity === "object" && (y.id === e.selectedObjectId || e.selectedObjectIds?.has?.(y.id)), F = e.selectedEntity === "object" && y.id === e.selectedObjectId;
        A.setAttribute("aria-selected", String(R)), A.className = `scene-item${R ? " selected" : ""}${F ? " primary" : ""}${j > 0 && !n ? " scene-item-child" : ""}`, j > 0 && !n && (A.style.paddingLeft = `${j * 16 + 6}px`);
        ...
        const N = document.createElement("span");
        N.style.cssText = G ? "color:#fca5a5" : W ? "" : "opacity:.5;text-decoration:line-through", N.textContent = y.name || y.type, N.title = s("Double-click to rename"), N.addEventListener("dblclick", (C) => {
          C.preventDefault(), C.stopPropagation(), Pu(e, y, N);
        }), _.appendChild(N);
...
function Du(e) {
  ...
  if (n) {
    const _ = r.target_object_id || e.state.target_object_id || "", N = `T${Gr()}${e.state.objects.map((U) => `${U.id}\0${U.name || U.type}`).join("|")}`;
    Zo(n, N, () => [
  ...
  ["camera-px", "camera-py", "camera-pz", "camera-tx", "camera-ty", "camera-tz", "camera-fov", "camera-roll", "camera-near", "camera-far", "camera-rx", "camera-ry", "camera-rz"].forEach((_, N) => {
  ...
  if (!t) {
    ...
    N && (N.textContent = `${r.name} · F${e.frame}`), Pn(o, {
  ...
  if (c) {
    ...
    if (_) {
      c.hidden = !1;
      const N = _.semantic ? `${_.semantic} · ` : "";
      c.textContent = `${N}${_.label} (${Math.round(_.confidence * 100)}%)`, c.title = _.title, c.className = `oc-recon-badge oc-badge-${_.band}`;
    } else
      c.hidden = !0;
  }
  ...
  for (const [_, N] of Object.entries(h))
    for (const U of e.root.querySelectorAll(`[data-role="${_}"]`))
  ...
  if (g) {
    const _ = t.id, N = /* @__PURE__ */ new Set([_]);
    let U = !0;
    for (; U; ) {
      U = !1;
      for (const C of e.state.objects)
        !N.has(C.id) && C.parent_id && N.has(C.parent_id) && (N.add(C.id), U = !0);
    }
    const Y = e.state.objects.filter((C) => !N.has(C.id)), L = `P${Gr()}${_}${Y.map((C) => `${C.id} ${C.name || C.type}`).join("|")}`;
    Zo(g, L, () => [
      Dt("", s("No parent")),
  ...
  if (u && (u.hidden = !F?.animations), b) {
    const _ = F?.animationNames || [];
    Zo(b, `A${_.join("|")}`, () => _.map((N, U) => Dt(String(U), N)), String(t.animation_index || 0));
  }
...
function Uu(e) {
  ...
  e.beginCameraEdit(), Cc(e.camera, r), e.commitCameraEdit(), e.finishCameraEdit(), Xs(e), qu(e), e.render();
}
function Wu(e) {
  const t = globalThis.performance?.now?.() ?? Date.now();
  (!Number.isFinite(e.lastCameraHudEditAt) || t - e.lastCameraHudEditAt > 300) && e.checkpoint("Edit camera"), e.lastCameraHudEditAt = t;
...
const fb = ["guides", "safe-areas", "resolution-gate", "aspect-ratio"];
function hb(e) {
...
function Qs(e, t, a) {
  const o = Ue(e), r = kb(e, t, a);
  kt(e, "out", Ht(r.out, o)), kt(e, "in", Ht(r.in, o));
}
function jb(e, t, a, { prevKey: o = null, nextKey: r = null } = {}) {
...
function _b(e, t, { prevKey: a = null, nextKey: o = null } = {}) {
...
function Ab(e) {
  ...
  return {
    ...
    restoreHistorySnapshot(P) {
      ...
      this.selectedKeyFrames = new Set(q.filter((ne) => Q.has(ne))), this.selectedKeyFrame = this.selectedKeyFrames.has($.selectedKeyFrame) ? $.selectedKeyFrame : [...this.selectedKeyFrames].at(-1) ?? null, this.pathSelection = Ec(this.pathSelection, this.activeCameraTrack()), this.subSelection = $.subSelection || null, this.camera = Pt(this.state, this.frame), qt(this, this.activeCameraTrack(), this.camera, this.frame), this.cameraPreviewSignature = "", this.serialize(), S !== zn(this.state) && this.restoreAssets(), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
    },
    checkpoint(P) {
    ...
    resizeCanvas() {
      ...
      for (const D of this.cameraPreviewCanvases.values()) {
        const Q = D.clientWidth || 220, q = D.clientHeight || 124, ne = Math.max($, Eb / Math.max(1, Q)), Ee = Math.max(1, Math.round(Q * ne)), Re = Math.max(1, Math.round(q * ne));
...
const Fn = { motion: "motion", shot: "display", health: "health" }, Mb = {
  object: "Object",
  camera: "Camera",
  camera_target: "Look-At Target",
  camera_path: "Camera Path"
}, Ib = { motion: "Motion", shot: "Shot", health: "Health" }, Ob = ["entity", "motion", "shot", "health"];
function ti(e) {
...
function ai(e) {
  ...
  r && (r.textContent = o === "entity" ? s(Mb[e.selectedEntity] || "Inspector") : s(Ib[o] || "Inspector"));
}
function Fb(e, t) {
  e.inspectorMode = Ob.includes(t) ? t : "entity", ai(e), e.render?.(), e.refitNode?.();
}
function Nb(e) {
  ...
  return {
    ...
    setSpatialHandleMode(w) {
      ...
      this.checkpoint(s("Camera path handle: {mode}").replace("{mode}", w)), _b(M[D], w, {
        prevKey: M[D - 1] || null,
        nextKey: M[D + 1] || null
    ...
    transformCameraPath(w) {
      ...
      const M = Ac(T.keyframes, { origin: Tc(T.keyframes), ...w });
    ...
    refreshInspector() {
      this.perf && (this.perf.inspectorRefreshCount = (this.perf.inspectorRefreshCount || 0) + 1), Ba(this), zb(this);
    },
    setInspectorMode(w) {
      Fb(this, w);
    },
...
function Kb(e) {
  const { right: t, up: a, forward: o } = $c(e || {});
  return Db.map((r) => {
...
const Ub = "http://www.w3.org/2000/svg", gt = 26, Nn = 17, Wb = 5.4;
function yt(e, t) {
  const a = document.createElementNS(Ub, e);
...
function Vb(e) {
  ...
  for (const n of Bb(Kb(a))) {
    const i = gt + n.x * Nn, c = gt + n.y * Nn, l = qb(n.depth);
...
function Gb(e) {
  ...
  for (const r of e.state.motion_layers || []) {
    ...
    const n = Hb(e.state, r, e.frame, a, o);
    if (n.length) {
...
const Yb = ["world_point", "object_point", "camera_field"], oi = {
  manual_2d: "DRAW",
  object_point: "OBJECT",
  world_point: "WORLD",
...
function eg(e) {
  ...
  n("motion-sel-name", a.label), n("motion-sel-type", oi[a.source_kind] || "TRACK"), n("motion-sel-binding", Xb(e.state, a)), n("motion-sel-start", r.length ? Math.min(...r) : 0), n("motion-sel-end", r.length ? Math.max(...r) : 0);
...
function og(e) {
  ...
  return {
    ...
    renderViewportOnly() {
      ...
      !this.recording && this.state.speed_heatmap && this.drawSpeedHeatmap(), !this.recording && gh(this), this.drawOverlays(), Gb(this), this.state.show_gizmo && Vb(this), this.labelOverlay?.update(), this.rigOverlay?.update(), this.perf && (this.perf.viewportRenderCount = (this.perf.viewportRenderCount || 0) + 1);
    },
    ...
    requestUiUpdate(S = E.viewport, w = "unknown") {
      (this.renderReasons ||= /* @__PURE__ */ new Set()).add(w), this.uiDirtyMask = qm(this.uiDirtyMask, S), this.renderInvalidations = (this.renderInvalidations || 0) + 1, !this.renderScheduled && (this.renderScheduled = !0, this.renderFrame = requestAnimationFrame(() => {
    ...
    dispose() {
      this.disposed || (this.disposed = !0, this.agentBridge?.dispose?.(), this.transformControlsWiring?.dispose(), Mc(this), Ic(), fl(this), this.backgroundRequestId = (this.backgroundRequestId || 0) + 1, this.upstreamSyncId = (this.upstreamSyncId || 0) + 1, this.stopPlay(), clearTimeout(this.previewClickTimer), clearTimeout(this.connectionTimer), cancelAnimationFrame(this.restoreFrame), cancelAnimationFrame(this.serializeFrame), cancelAnimationFrame(this.resizeFrame), cancelAnimationFrame(this.renderFrame), this.abortController?.abort(), this.upstreamFetchController?.abort(), this.resizeObserver?.disconnect(), this.contextMenu?.dispose(), this.webgl?.dispose(), this.cameraWebgl?.dispose(), V(this), Uh(this), this.objectUrls.clear(), this.cardMediaById.clear(), this.cardMediaAssetById?.clear?.(), this.modelUrlsById.clear(), this.modelInfoById.clear());
    }
  };
}
const ri = 1e-9;
...
function Br(e, t) {
  const a = e.map((i) => rg(i, t)), o = ng(a), r = e.map((i) => i.frame), n = Math.max(1, r[r.length - 1] - r[0]);
  return a.map((i, c) => [
    (r[c] - r[0]) / n,
...
function ig(e, t, { tolerance: a = 0.02, keepFrames: o = [] } = {}) {
...
function cg(e, t, { target: a = 2, keepFrames: o = [] } = {}) {
...
function lg(e, t, { mergeWithin: a = 1, epsilon: o = 1e-3, keepFrames: r = [] } = {}) {
...
function mg(e, t, a, { lastFrame: o = 1 / 0 } = {}) {
...
function ug() {
  return {
    ...
    deleteSelectedKeyframes() {
      ...
      const t = this._activeTrack(), a = Ce(this), o = t.kind === "camera" ? 1 : 0, { keys: r, removed: n } = dg(a, e, { minKeys: o });
    ...
    nudgeSelectedKeyframes(e) {
      ...
      const a = this._activeTrack(), o = Math.max(0, this.state.duration_frames - 1), r = mg(Ce(this), t, e, { lastFrame: o });
    ...
    setSelectedKeysInterpolation(e) {
      ...
      this.checkpoint(s("Interpolation on {n} keys").replace("{n}", t.length)), a.write(pg(Ce(this), t, e)), this.serialize(), this.refreshKeys(), this.refreshKeyEditor(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} interpolation on {n} keys").replace("{mode}", e.replace(/_/g, " ")).replace("{n}", t.length));
    },
    setSelectedKeysTangentMode(e) {
      const t = this.resolveSelectedFrames();
      if (t.length < 2) return this.setTangentMode(e);
      const a = this._activeTrack(), o = lt(this).map((r) => r.id);
      this.checkpoint(s("Tangents on {n} keys").replace("{n}", t.length)), a.write(fg(Ce(this), t, e, o)), this.serialize(), this.refreshKeys(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} tangents on {n} keys").replace("{mode}", e).replace("{n}", t.length));
    },
    /**
    ...
    simplifyActiveKeys({ mode: e = "simplify", tolerance: t = 0, target: a = 0, scope: o = "camera", fromKeys: r = null, silent: n = !1 } = {}) {
      ...
      const l = this.resolveSelectedFrames(), p = o !== "all_cameras" && l.length >= 2 ? [l[0], l.at(-1)] : null, m = p ? [] : l, f = (u) => {
        const b = [...u].sort((R, F) => R.frame - F.frame), g = p ? p[0] : -1 / 0, v = p ? p[1] : 1 / 0, x = b.filter((R) => R.frame < g), k = b.filter((R) => R.frame >= g && R.frame <= v), y = b.filter((R) => R.frame > v);
        let j = k, A = 0;
        if (k.length > 2) {
          const R = e === "reduce" ? cg(k, i, { target: a || Math.ceil(k.length / 2), keepFrames: m }) : e === "clean" ? lg(k, i, { keepFrames: m }) : ig(k, i, { tolerance: t * hg, keepFrames: m });
          j = R.keys, A = R.removed;
        }
        return { keys: [...x, ...j, ...y].sort((R, F) => R.frame - F.frame), removed: A };
      };
      let d = 0;
      const h = c.map((u) => {
...
class ni {
  constructor(t) {
    this.app = Dn, this.api = at, this.node = t, this.root = gs(), this.root.tabIndex = -1, this.dom = js(this.root), this.canvas = this.root.querySelector(".viewport-wrap > canvas"), this.cameraPreviewCanvases = /* @__PURE__ */ new Map(), this.cameraPreviewContexts = /* @__PURE__ */ new Map(), this.cameraPreviewSignature = "", this.interactionElement = this.canvas, this.interactionElement.tabIndex = 0, this.interactionElement.dataset.captureWheel = "true", this.ctx = this.canvas.getContext("2d", { alpha: !1 }), this.disposed = !1, this.renderRevision = 0, this.directorRevision = 0, this.webgl = null, this.cameraWebgl = null, this.webglReady = this.loadWebGLViewports(), this.transformControlsWiring = Zp(this), this.stateWidget = t.widgets?.find((o) => o.name === "state_json"), this.recordingWidget = t.widgets?.find((o) => o.name === "recording_path"), this.cardWidget = t.widgets?.find((o) => o.name === "card_asset"), this.widthWidget = t.widgets?.find((o) => o.name === "width"), this.heightWidget = t.widgets?.find((o) => o.name === "height"), this.fpsWidget = t.widgets?.find((o) => o.name === "fps"), this.durationWidget = t.widgets?.find((o) => o.name === "duration_seconds"), this.modeWidget = t.widgets?.find((o) => o.name === "render_mode");
    let a = null;
    try {
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-C71llfBO.js"));
    } catch (a) {
    ...
    if (!this.disposed) {
      ...
      Pc(this), this.resizeCanvas(), this.render(), this.renderCameraView();
    }
  }
}
const xo = { app: Dn, api: at, EditorHistory: us, ContextMenuController: ts, initializeTooltips: ul, promptText: Gt, ObjectUrlRegistry: bs, buildRoot: gs, dispatchDirectorKey: Lc, activeCameraTrack: or, bindWidgetCallbacks: bl, playblastCameraTrack: es, restoreFromWidgets: gl, serializeEditorState: yl, syncActiveCameraTrack: rr, syncFromWidgets: vl, bindEditorEvents: Mh, activateCamera: xl, addCamera: wl, deleteCamera: kl, drawPreviewOverlays: Sl, duplicateCamera: jl, maximizeCameraPreview: _l, refreshCameraPreviews: Cl, refreshCameraSelectors: El, renameCamera: Al, setPlayblastCamera: Tl, toggleCameraView: $l, captureRealtime: Ks, makePlayblast: nu, uploadDirectorPlayblast: Bs, waitForMediaFrame: Ds, computeAudioPeaks: Ls, loadAudioFile: Kh, releaseAudio: Mo, stopPlay: _o, togglePlay: Nh, applyCameraPreset: Qp, applyCameraShake: ef, applyProxyPreset: tf, clearViewportBgImage: lu, loadViewportBgFile: iu, loadViewportBgSequence: cu, drawCameraPath: Su, drawCard: ku, drawCube: bu, drawCylinder: vu, drawGrid: pu, drawHuman: yu, drawLine3D: ie, drawNull: wu, drawOverlays: _u, drawPointField: uu, drawSpeedHeatmap: ju, drawSphere: gu, drawTorus: xu, curveChannels: lt, drawCurveEditor: hd, fitCurveView: ls, onCurveDoubleClick: pd, onCurvePointerDown: od, onCurvePointerMove: rd, onCurvePointerUp: nd, onTimelinePointerDown: zc, onTimelinePointerMove: Fc, onTimelinePointerUp: Nc, refreshKeys: Td, resetCurveZoom: fd, resetTimelineZoom: Rc, setChannelFilter: id, setCurveInterpolation: sd, setTangentMode: cd, timelineFrameFromEvent: gr, toggleCurveHandles: ld, zoomCurve: md, drawTransformGizmo: Dc, frameTarget: Kc, gizmoAxes: Bc, gizmoGeometry: qc, onPointerDown: Uc, onPointerMove: Wc, onPointerUp: Vc, onWheel: Hc, pickGizmo: Gc, pickSceneObject: Yc, resetCamera: Xc, setTransformMode: Jc, setViewMode: Zc, viewportCamera: Qc, loadCardFile: Yh, loadExecutionPreview: Xh, loadMediaUrl: Rs, loadModelFile: Gh, loadSelectedReference: Jh, onModelLoaded: Hh, restoreAssets: Vh, syncUpstreamInputs: Zh, configureDomMedia: zs, refreshSetupDiagnostic: Au, addMediaCard: Ru, addPrimitive: Lu, applyObjectAnimationFrame: tb, beginCameraEdit: cb, beginObjectEdit: Ys, commitCameraEdit: lb, commitObjectEdit: Bu, copyKeyframe: nb, deleteKeyframe: rb, deleteObject: Gs, deleteSelectedObjects: Nu, duplicateObject: Hs, exitKeyEdit: mb, finishCameraEdit: db, goToAdjacentKey: wb, insertKeyframe: ab, loadSelectedKeyView: xb, pasteKeyframe: sb, playblastCameraAtFrame: eb, refreshInspector: Du, refreshKeyEditor: gb, refreshObjects: Vs, removeObjectResources: Gu, renameObject: zu, retimeSelectedKey: yb, selectKeyframe: ib, selectedKeyframe: He, selectedObject: Zt, selectObjectAnimation: Hu, setKeyInterpolation: ob, setKeyTangentMode: bb, setObjectParent: Vu, timelineKeyframes: Ce, timelineObject: ze, toggleAutoKey: pb, toggleObject: Fu, updateCameraFromHud: Wu, updateCameraRotationFromHud: Uu, updateEditState: hb, updateKeyVisualState: ub, updateSelectedKey: vb, updateSelectedObject: Ku, clamp: J, cloneCamera: pe, configureCore: Qn, defaultCamera: xr, sampleCamera: $e, sampleObjectTransform: Lo, sanitizeState: kr, worldTransform: Sr };
Object.assign(
  ni.prototype,
  Ab(xo),
  Nb(xo),
...
function bg(e) {
  ...
  const t = new ni(e);
  wo("director:constructor:complete", e), bp(t);
  try {
    t.agentBridge = Sp(t, e, at);
  } catch (m) {
  ...
  try {
    t.assetBrowser = Np(t, {
      ...
      onAgentFirstOpen: async () => {
        if (er())
          try {
            const { createDirectorAgentPanel: m } = await import("./chunk-ofJ68v1j.js");
            t.agentPanel = m(t);
          } catch (m) {
  ...
  try {
    t.characterRuntime = Dp(t), t.rigMapper = Bp(t), t.poseEditor = Wp(t), t.motionEditor = Vp(t);
  } catch (m) {
