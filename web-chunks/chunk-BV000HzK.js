...
const So = () => import("./chunk-CmjiHJXh.js");
function Kh(e, t) {
...
async function xu(e) {
  ...
  const a = await Es({
    ...
    onDelete: async (r) => {
      const n = await Mo(e, `${To}/${encodeURIComponent(r)}`, { method: "DELETE" });
      if (!n.ok) throw new Error(await n.text());
    }
  });
...
async function ob(e) {
  ...
  try {
    let n = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-ToZlNgBQ.js");
...
class Li {
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-ToZlNgBQ.js"));
    } catch (a) {
  ...
  try {
    t.assetBrowser = Ff(t, {
      ...
      onAgentFirstOpen: async () => {
        if (mr())
          try {
            const { createDirectorAgentPanel: m } = await import("./chunk-BwukrLgD.js");
            t.agentPanel = m(t);
          } catch (m) {
