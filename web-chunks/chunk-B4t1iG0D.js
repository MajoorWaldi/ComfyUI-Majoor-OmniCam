...
ae.registerExtension({
  ...
  async nodeCreated(e) {
    ...
    await Dt(e, async () => {
      ...
      const { attachDirectorShell: o } = await import("./chunk-BUnXKuJv.js").then((n) => n.o);
...
ae.registerExtension({
  ...
  async nodeCreated(e) {
    if (Ye(e) !== mt) return;
    const t = !ce, a = t ? null : Et(e);
    await Dt(e, async () => (await import("./chunk-BMwN3z_-.js")).attachExtractor), e.__majoorOmniCamExtractorRuntime && jt(e, mt, t, a?.());
  }
});
ae.registerExtension({
  ...
  async nodeCreated(e) {
    if (Ye(e) !== ut) return;
    const t = !ce, a = t ? null : Et(e);
    await Dt(e, async () => (await import("./chunk-BlroDJvR.js")).attachMonitor), e.__majoorOmniCamMonitor && jt(e, ut, t, a?.());
  }
});
export {
  Ai as $,
