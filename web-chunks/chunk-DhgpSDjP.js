import { app as Or } from "../../scripts/app.js";
import { api as Ve } from "../../scripts/api.js";
import { a as we, c as Z, x as he, y as Jn, v as r, z as Kr, A as Ao, B as ze, e as de, C as oo, E as Qn, F as To, T as oe, G as Dr, H as es, J as ts, K as as, L as os, M as rs, N as wo, O as Yo, P as Rr, Q as ko, R as Nr, S as qr, U as Br, V as Wr, j as Vr, W as So, X as lo, Y as Zo, Z as Jo, _ as Hr, o as Qo, $ as ns, a0 as ss, a1 as is, a2 as cs, a3 as ls, h as ye, p as Ur, i as Gr, a4 as er, f as $e, a5 as ds, a6 as Xr, t as ms, a7 as ps, a8 as Po, a9 as fs, aa as hs, q as us, ab as bs, ac as gs, ad as vs, ae as Io, af as ys, ag as xs, ah as ws, ai as ks, aj as Ss, ak as js, al as Cs, am as Es, an as _s, ao as $s, ap as Ms, aq as As, ar as Ts, as as Ps, at as Is, au as zs, av as Fs, aw as Ls, ax as Os, ay as Ks, az as Ds, aA as Rs, aB as Ns, aC as qs, aD as Bs, aE as Ws, aF as Vs, aG as Hs, aH as Us, aI as Gs, aJ as Xs, aK as Ys, aL as Zs, aM as Js, aN as Qs, aO as ei, aP as ti, aQ as ai, aR as oi, aS as ri, aT as ni, aU as si, aV as ii, l as We, aW as ci, aX as mo, aY as li, aZ as di, a_ as mi, a$ as pi, b0 as fi, b1 as Ie, b2 as hi, b3 as Yr, b4 as zo, b5 as ui, b6 as bi, b7 as gi, b8 as Zr, b9 as De, ba as vi, bb as yi, bc as tr, bd as Fo, be as xi, bf as Jr, bg as wi, bh as ki, bi as Si, b as Qr, r as ji, bj as Ci, bk as Ei, bl as _i, bm as $i, bn as Mi, bo as Ai, bp as Ti, bq as Pi, br as en, bs as Ii, bt as zi, bu as Fi, bv as Li, bw as Oi, bx as Ki, by as Di, bz as Ri, bA as Ni, bB as qi, bC as Bi, bD as Wi, bE as Vi, bF as Hi, bG as Ui, bH as Gi, bI as Xi, bJ as Yi, bK as Zi, s as Ji } from "./chunk-1zyvhFxD.js";
import { p as Qi, a as ec, s as po, S as tn, c as tc, C as ar, b as ac, i as oc, w as rc, d as nc, U as Ce, m as sc, h as Ge, e as ic, f as cc, g as lc, j as dc, r as mc, k as pc, l as fc, E as hc } from "./chunk-Bwz6xzPH.js";
import { L as uc, a as bc, p as St, f as Lo, b as gc, S as vc, c as or, d as yc, e as xc, r as wc, g as kc, n as Sc, C as rr, h as jt, o as an, s as jc, i as Cc, j as Ec, k as on, l as _c, m as $c, q as Mc, t as Ac, u as Tc, v as Pc, w as Ic, x as zc, y as Fc, z as Lc, A as Oc, B as Kc } from "./chunk-BE1LS4Rv.js";
import { S as Dc, b as Rc, p as Nc } from "./chunk-CooaTp3H.js";
import { T as qc } from "./chunk-__IQ4xkd.js";
import { T as Bc, R as Wc } from "./vendor-three-BQUrLQkn.js";
import { b as Vc, p as rn, a as jo, c as Co, d as Hc, r as Uc, s as Gc, e as Xc } from "./chunk-30HVcRRc.js";
import { m as Yc } from "./chunk-QPu3m5tU.js";
import { l as Zc, u as Jc } from "./chunk-eq1tqQ9i.js";
function gt(e, t = 0) {
  return Math.sin(e * 1.7 + t * 3.1) * 0.5 + Math.sin(e * 3.3 + t * 5.7) * 0.3 + Math.sin(e * 7.9 + t * 11.3) * 0.2;
}
function Qc(e, { type: t = "handheld_subtle", intensity: a = 1, duration_frames: o = null, subdivide: n = !0 } = {}) {
  ...
  return [...b].sort((y, v) => y - v).map((y) => {
    const v = we(h, y), j = gt(y * p, 1) * l, x = gt(y * p, 2) * l, M = gt(y * p, 3) * l * 0.5, P = gt(y * p, 4) * m, D = gt(y * p, 5) * (m * 0.35), F = [...v.position], U = [...v.target];
...
function el(e, { duration_frames: t = 120, target: a = [0, 1.5, 0], radius: o = 6, height: n = 3.5 } = {}) {
...
function sn(e) {
  ...
  a.delete("camera");
  const o = e.timelineKeyframes() || [], n = Jn(o, a), s = rl(e, n);
  if (t.dataset.signature !== s) {
    t.dataset.signature = s, t.replaceChildren();
    const i = (c) => he(e, c);
    for (const c of n) {
      const l = document.createElement("div");
      l.className = "oc-dope-row", l.dataset.channel = c.id, l.style.setProperty("--channel-color", c.color), al(l, c.frames, i), ol(e, l, c, o, i), t.appendChild(l);
    }
  }
...
const fo = [1, 2, 5, 10, 20, 25, 50, 100, 200, 250, 500, 1e3, 2e3, 5e3], cn = 46, nr = 5, ln = 640;
function dn(e, t) {
  const a = t > 0 ? t : ln, o = Math.max(2, Math.floor(a / cn)), n = Math.max(1e-6, e / o);
  return fo.find((s) => s >= n) ?? fo[fo.length - 1];
}
function nl(e, t) {
  const a = Math.max(1, e.state.duration_frames - 1), o = Z(Number(e.timelineZoom) || 1, 0.1, 50), n = Number(e.timelinePan) || 0, s = a / o, i = dn(s, t), l = (i >= nr ? i / nr : 0) || i, m = [], p = Math.max(0, Math.floor(n / l) * l);
...
function sl(e) {
  return e.clientWidth || e.parentElement?.clientWidth || ln;
}
function mn(e) {
  const t = e.root.querySelector('[data-role="ruler"]');
  if (!t) return;
  t.replaceChildren();
  for (const o of nl(e, sl(t))) {
...
function il(e, t) {
  ...
  a.addEventListener("pointerup", i, { signal: t }), a.addEventListener("pointercancel", i, { signal: t }), a.addEventListener("wheel", (c) => Kr(e, c), { passive: !1, signal: t });
}
const cl = [1, 2, 2.5, 5, 10];
function ll(e, t = 5) {
  const a = Math.abs(e) / Math.max(1, t);
  if (!(a > 0) || !Number.isFinite(a)) return 1;
  const o = 10 ** Math.floor(Math.log10(a)), n = a / o;
  return (cl.find((s) => s >= n) ?? 10) * o;
}
function dl(e, t) {
  const a = Math.max(0, Math.min(4, Math.ceil(-Math.log10(t))));
  return e.toFixed(a);
}
function ml(e, { left: t, right: a, top: o, width: n, graphWidth: s, graphHeight: i, height: c, timeMin: l, timeMax: m, totalDuration: p, xFor: f, frame: u }) {
  const d = dn(m - l, s);
...
function pl(e, { left: t, right: a, top: o, width: n, graphHeight: s, minimum: i, maximum: c, yFor: l }) {
  const m = ll(c - i, 4);
  e.strokeStyle = "#222228", e.lineWidth = 1, e.fillStyle = "#6e727a";
  for (let p = Math.ceil(i / m) * m; p <= c; p += m) {
    const f = l(p);
    f < o - 1 || f > o + s + 1 || (e.beginPath(), e.moveTo(t, f), e.lineTo(n - a, f), e.stroke(), e.fillText(dl(p, m), 4, f + 3));
  }
}
function Oo(e, t) {
...
function pn(e, { selectedOnly: t = !1 } = {}) {
  const a = Math.max(1, (e.state?.duration_frames ?? 120) - 1), o = e.timelineKeyframes() || [], n = e.timelineObject(), s = tt(e), i = e.selectedKeyFrames?.size ? [...e.selectedKeyFrames] : e.selectedKeyFrame != null ? [e.selectedKeyFrame] : [], c = i.length > 0, l = t || c && i.length < o.length ? o.filter((b) => i.includes(b.frame)) : o;
  if (!l.length) {
  ...
  if (d.length > 0) {
    const b = Math.min(...d), g = Math.max(...d), y = Math.max(1e-4, g - b), v = (b + g) / 2, j = (V) => n ? oo(n, V) : we(e.state, V), x = [], M = Math.max(1, Math.floor(a / 40));
    for (let V = 0; V <= a; V += M) {
      const Q = j(V);
      for (const k of s) {
        const E = k.get(Q);
...
function jl(e) {
  ...
  const i = e.timelineObject(), c = e.timelineKeyframes(), l = tt(e), m = 44, p = 14, f = 16, u = 22, d = Math.max(1, a - m - p), h = Math.max(1, o - f - u), b = Math.max(1, e.state.duration_frames - 1), g = Z(Number(e.curveZoomX) || 1, 0.1, 50), y = Number(e.curvePanX) || 0, v = b / g, j = y, x = y + v, M = [], P = Math.max(1, Math.ceil(v / Math.max(80, d))), D = ($) => i ? oo(i, $) : we(e.state, $);
  ...
  U = k - E / 2, B = k + E / 2;
  const z = ($) => m + ($ - j) / Math.max(1e-6, x - j) * d, R = ($) => f + h * (B - $) / Math.max(1e-6, B - U);
  if (s.fillStyle = "#111114", s.fillRect(0, 0, a, o), s.strokeStyle = "#222228", s.lineWidth = 1, s.font = "9px system-ui, -apple-system, sans-serif", s.fillStyle = "#6e727a", ml(s, {
    left: m,
    right: p,
    top: f,
    width: a,
    ...
    xFor: z,
    frame: e.frame
  }), pl(s, { left: m, right: p, top: f, width: a, graphHeight: h, minimum: U, maximum: B, yFor: R }), U <= 0 && B >= 0) {
    const $ = R(0);
  ...
  for (const $ of l) {
    ...
    let W = !1;
    M.forEach((C) => {
      const N = z(C.frame), G = R($.get(C.value));
      N >= m - 50 && N <= a - p + 50 && (W ? s.lineTo(N, G) : (s.moveTo(N, G), W = !0));
    }), s.stroke();
    for (const C of c) {
      const N = i ? C.transform : C.camera, G = z(C.frame), ae = R($.get(N)), re = C.frame === e.selectedKeyFrame || e.selectedKeyFrames?.has(C.frame);
    ...
    if (e.showCurveHandles)
      for (let C = 0; C < c.length; C++) {
        const N = c[C], G = N.frame === e.selectedKeyFrame || e.selectedKeyFrames?.has(N.frame);
        if (!(G || e.curveChannelFilter !== "all" || c.length <= 4) || N.interpolation !== "bezier") continue;
        const re = i ? N.transform || i : N.camera || N, ee = z(N.frame), ie = R($.get(re)), fe = c[C - 1], me = c[C + 1], ue = Math.max(1, N.frame - (fe?.frame ?? N.frame - 1)), be = Math.max(1, (me?.frame ?? N.frame + 1) - N.frame), O = Qn(
          N,
          $.id,
          fe,
          me,
          (ne) => $.get(i ? ne.transform || i : ne.camera || N)
  ...
  if (e.curveBoxSelect) {
    const $ = Math.min(e.curveBoxSelect.startX, e.curveBoxSelect.currentX), W = Math.min(e.curveBoxSelect.startY, e.curveBoxSelect.currentY), C = Math.abs(e.curveBoxSelect.currentX - e.curveBoxSelect.startX), N = Math.abs(e.curveBoxSelect.currentY - e.curveBoxSelect.startY);
    s.fillStyle = "rgba(56, 189, 248, 0.15)", s.fillRect($, W, C, N), s.strokeStyle = "#38bdf8", s.lineWidth = 1, s.setLineDash([4, 4]), s.strokeRect($, W, C, N), s.setLineDash([]);
  }
  const q = z(e.frame);
  if (q >= m && q <= a - p && (s.strokeStyle = "#a78bfa", s.lineWidth = 1.5, s.beginPath(), s.moveTo(q, f), s.lineTo(q, f + h), s.stroke(), s.fillStyle = "#a78bfa", s.beginPath(), s.moveTo(q - 4, f), s.lineTo(q + 4, f), s.lineTo(q, f + 6), s.closePath(), s.fill()), e.curveDrag || e.curveHover) {
    ...
    if (e.curveDrag)
      if (e.curveDrag.handle) {
        ...
        const C = e.curveDrag.key.frame - e.curveDrag.startFrame, N = e.curveDrag.channel.get(e.curveDrag.object ? e.curveDrag.key.transform : e.curveDrag.key.camera), G = N - e.curveDrag.startValue, ae = C >= 0 ? `+${C}` : `${C}`, re = G >= 0 ? `+${G.toFixed(2)}` : `${G.toFixed(2)}`;
        $ = `${e.curveDrag.group.length} keys · ΔF: ${ae} · ΔVal: ${re}`, W = `${e.curveDrag.channel.name}: ${N.toFixed(2)}`;
      } else {
        const C = e.curveDrag.key.frame - e.curveDrag.startFrame, N = e.curveDrag.channel.get(e.curveDrag.object ? e.curveDrag.key.transform : e.curveDrag.key.camera), G = N - e.curveDrag.startValue, ae = C >= 0 ? `+${C}` : `${C}`, re = G >= 0 ? `+${G.toFixed(2)}` : `${G.toFixed(2)}`;
        $ = `F${e.curveDrag.key.frame} (${ae}) · ${e.curveDrag.channel.name}: ${N.toFixed(2)} (${re})`;
      }
    ...
    if ($) {
      ...
      const C = s.measureText($), N = W ? s.measureText(W) : { width: 0 }, G = Math.max(C.width, N.width) + 16, ae = W ? 32 : 20, re = a - p - G - 6, ee = f + 6;
...
function fn(e) {
  ...
  if (!t) return;
  const a = e.timelineObject(), o = a ? a.name || a.type : e.activeCameraTrack().name, n = Cl(e), s = `${o}\0${n.map((c) => `${c.id}:${c.color}`).join("|")}`;
  if (t.dataset.signature !== s) {
    t.dataset.signature = s, t.replaceChildren();
...
function qa(e, t, a, { disabled: o = !1 } = {}) {
...
function _l(e, t) {
  ...
  if (a.appendChild(qa(
    ...
    () => El(e),
    { disabled: o }
  )), t.length && (a.appendChild(qa(
    r("Split at playhead"),
    r("Cut the current shot in two at the playhead"),
    () => {
      e.checkpoint("Split shot"), Dr(e.state, e.frame, null) ? Qe(e) : e.setStatus(r("Move the playhead inside a shot first"));
    },
    { disabled: o }
  )), a.appendChild(qa(
    r("Clear edit"),
...
function Ml(e, t, a, o, n) {
  t.preventDefault(), t.stopPropagation();
  const { camera: s } = hn(e, a.camera_id);
  e.contextMenu?.show(t, s?.name || r("Shot"), [
    ...
    null,
    {
      ...
      run: () => {
        e.checkpoint("Split shot"), Dr(e.state, e.frame, null) && Qe(e);
      }
    },
    {
      label: r("Remove shot"),
      ...
      disabled: n === 1,
      run: () => {
        e.checkpoint("Remove shot"), es(e.state, o) && Qe(e);
      }
    }
  ]);
}
function Al(e, t, a, o) {
  const { camera: n, color: s } = hn(e, t.camera_id), i = document.createElement("div");
  ...
  if (c.className = "oc-sequence-name", c.textContent = n?.name || t.camera_id, i.appendChild(c), a > 0) {
    ...
    l.className = "oc-sequence-handle", l.title = r("Drag to trim the cut"), l.addEventListener("pointerdown", (m) => $l(e, m, l, o, a)), i.appendChild(l);
  }
  return i.addEventListener("contextmenu", (l) => Ml(e, l, t, a, o.__cutCount)), i.addEventListener("pointerdown", () => {
...
function bn(e, t) {
  ...
  if (s.className = "oc-sequence-lane", s.dataset.role = "sequence-lane", s.setAttribute("aria-label", r("Multi-camera edit")), o.length)
    for (const [c, l] of o.entries()) {
      ...
      he(e, l.end + 1) < -5 || m > 105 || s.appendChild(Al(e, l, c, n));
    }
  else {
    const c = document.createElement("span");
  ...
  n.appendChild(s), n.appendChild(Tl(e));
  const i = document.createElement("span");
  i.className = "oc-sequence-playhead", i.style.left = `${he(e, e.frame)}%`, n.appendChild(i), t.appendChild(n);
}
const Pl = ['[data-act="curve-zoom-in"]', '[data-act="curve-zoom-out"]', '[data-act="curve-fit"]', '[data-act="curve-handles"]'], cr = { curves: "Graph", dope: "Timeline", sequence: "Sequence" };
function lr(e, t) {
  ...
  a === "sequence" ? (bn(e, s), s?.focus?.({ preventScroll: !0 })) : a === "curves" && e.drawCurveEditor(), e.setStatus(r(cr[a]));
}
function Il(e) {
  e.graphTab === "sequence" && bn(e, e.root.querySelector('[data-role="graph-sequence"]'));
}
function zl(e, t) {
...
function Fl(e) {
  ...
  y && (y.textContent = p.name), mn(e), sn(e), fn(e), Il(e), e.refreshCameraSelectors(), e.refreshKeyEditor(), e.updateEditState(), e.drawCurveEditor(), e.perf && (e.perf.timelineRefreshCount = (e.perf.timelineRefreshCount || 0) + 1);
}
class gn {
  constructor(t = URL) {
...
async function Ko(e, { route: t, field: a = "file", file: o }) {
...
const Bl = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/><path d="M2 12h20"/></svg>', Wl = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m21 16-9 5-9-5V8l9-5 9 5v8z"/><path d="m3.27 6.96 8.73 4.84 8.73-4.84"/><path d="M12 22V12"/></svg>', Vl = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2L2 20h20L12 2z"/><path d="M12 2v18"/></svg>', Hl = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/><path d="m17.66 17.66 1.41 1.41"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="m6.34 17.66-1.41 1.41"/><path d="m19.07 4.93-1.41 1.41"/></svg>', Ul = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18h6"/><path d="M10 22h4"/><path d="M15.09 14c.18-.98.65-1.74 1.41-2.5A4.65 4.65 0 0 0 18 8 6 6 0 0 0 6 8c0 1 .23 2.23 1.5 3.5.76.76 1.23 1.52 1.41 2.5"/></svg>', Gl = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l8 8-4 4-8-8 4-4z"/><path d="M7 11L2 16l6 6 5-5"/><path d="M18 19l4 2"/><path d="M21 16l2 2"/></svg>', Xl = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m22 8-6 4 6 4V8z"/><rect width="14" height="12" x="2" y="6" rx="2"/></svg>', Yl = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14h6v6H4z"/><circle cx="17" cy="7" r="3"/><path d="m6 3 4 7H2z"/></svg>';
function Zl() {
  return `
  ...
  return `
    <div class="oc-dope">
      <div class="oc-dope-body">
        <div class="oc-dope-labels">${rs.map((t) => `
...
const Ee = "/majoor/omnicam/library";
function kd(e, t) {
...
function Do({ fetchApi: e = kd } = {}) {
  const t = (a, o) => Promise.resolve(e(a, o)).then(Sd);
  return {
    list(a = {}) {
      const { kind: o, tag: n, search: s, offset: i, limit: c } = a, l = { tag: n, search: s, offset: i, limit: c };
      return o && o !== "all" && (l.kind = o), t(`${Ee}${dr(l)}`);
    },
    get(a) {
      return t(`${Ee}/${encodeURIComponent(a)}`);
    },
    register(a) {
      return t(`${Ee}/register`, {
        method: "POST",
    ...
    remove(a) {
      return t(`${Ee}/${encodeURIComponent(a)}`, { method: "DELETE" });
    },
    importModel(a, o = {}) {
      const n = new FormData();
      return n.append("file", a, o.filename || a.name || "model.glb"), t(`${Ee}/import${dr(o)}`, { method: "POST", body: n });
    },
    uploadThumbnail(a, o, n = "thumb.webp") {
      const s = new FormData();
      return s.append("file", o, n), t(`${Ee}/thumbnail/${encodeURIComponent(a)}`, {
        method: "POST",
        body: s
      });
    },
    ...
    deletePose(a) {
      return t(`${Ee}/poses/${encodeURIComponent(a)}`, { method: "DELETE" });
    }
  };
}
const yn = Object.freeze(["all", "character", "prop", "environment", "vehicle"]);
function mr(e = {}) {
  const t = String(e.kind || "all").toLowerCase();
  return {
    kind: yn.includes(t) ? t : "all",
...
function Cd(e) {
  ...
  return {
    ...
    setFilter(i) {
      return a.filter = mr({ ...a.filter, ...i }), a.offset = 0, this.refresh();
    },
    refresh() {
      return s(async () => {
...
const $d = 256;
function pr(e = {}) {
  const { THREE: t, GLTFLoader: a, FBXLoader: o, size: n = $d } = e;
  if (!t || !a)
...
function Id(e, t = {}) {
  return yn.map((a) => {
    const o = r(Pd[a] || a), n = a === "all" ? "" : ` <span class="oc-asset-kind-n">${Number(t[a] || 0)}</span>`;
    return `<button type="button" class="oc-asset-kind${a === (e || "all") ? " active" : ""}" data-asset-kind="${a}">${Je(o)}${n}</button>`;
  }).join("");
}
function zd(e, { selected: t = !1, thumbUrl: a = "" } = {}) {
  const o = Td[e.kind] || "pi-box", n = e.kind === "character" && Rr(e.rig) === "rigged" ? `<span class="oc-asset-badge">${r("RIGGED")}</span>` : "", s = a ? `<img class="oc-asset-thumb" src="${Je(a)}" alt="" loading="lazy">` : `<span class="oc-asset-thumb oc-asset-thumb--glyph"><i class="pi ${o}"></i></span>`;
...
function Fd(e, { selectedId: t = "", thumbUrls: a = {} } = {}) {
  return !e || !e.length ? `<p class="oc-asset-empty">${r("No assets match this filter.")}</p>` : e.map((o) => zd(o, {
    selected: o.id === t,
    thumbUrl: a[o.id] || ""
  })).join("");
}
...
function Ld(e, t = {}) {
  const a = e.root, o = t.fetchApi || ((O, H) => (e.api || e.app?.api).fetchApi(O, H)), n = t.apiClient || Do({ fetchApi: o }), s = t.store || Cd(n), i = Ed(), c = t.previewQueue || _d(), l = e.api || e.app?.api || null;
  let m = t.thumbnailRenderer || null, p = null;
  const f = /* @__PURE__ */ new Set();
  function u() {
    return m ? Promise.resolve(m) : (p || (p = Md().then((O) => m = pr(O)).catch(() => m = pr({}))), p);
  }
  function d(O) {
    return Yo(l, ec(O));
  }
  function h(O) {
    return O.thumbnail ? Yo(l, `omnicam/library/${O.thumbnail} [input]`) : "";
  }
  function b() {
    for (const O of s.state.items) {
      ...
      H && c.enqueue(O.id, async () => {
        ...
        if (i.set(O.id, le), N(), !(O.source && O.source !== "user"))
          try {
            const pe = await n.uploadThumbnail(O.id, Ad(le));
  ...
  let Q = "", k = null, E = !0, z = !0, R = "scene", q = 0;
  ...
  let C = !1;
  function N() {
    if (j && (j.innerHTML = Id(s.state.filter.kind, s.state.kinds)), v) {
      const O = {};
      for (const H of s.state.items) {
        const ce = i.get(H.id) || h(H);
        ce && (O[H.id] = ce);
      }
      v.innerHTML = Fd(s.state.items, { selectedId: Q, thumbUrls: O });
    }
    if (!C) {
      C = !0;
      try {
  ...
  function re(O) {
    O === "agent" && !wo() && (O = "scene"), R = O, D && (D.hidden = O !== "scene");
  ...
  function ee() {
    const O = wo();
    B && (B.hidden = !O), !O && R === "agent" && re("scene");
  }
  function ie(O) {
    const H = fr(O.target);
    if (H) {
  ...
  const be = s.subscribe(N);
  return y?.addEventListener("click", ie), y?.addEventListener("dblclick", fe), a.querySelector('[data-role="left-tabs"]')?.addEventListener("click", ie), x?.addEventListener("input", me), P?.addEventListener("change", ue), N(), ee(), {
    store: s,
    switchView: re,
...
function Od(e, t = {}) {
  ...
  function l() {
    ...
    let b = 0;
    for (const g of h) {
      if (!Nr(g, { mode: s.mode, selectedIds: u })) continue;
      const y = qr(g, s.content);
      if (!y) continue;
      const v = Br(h, g, d) || {
        position: g.position,
        size: g.size
      }, j = e.webgl.projectWorldToScreen(Wr(v, g.type));
...
function Dd(e, t) {
  const a = (o) => [`<option value="">${r("— unmapped —")}</option>`].concat(
    e.map(
      (n) => `<option value="${hr(n)}"${n === o ? " selected" : ""}>${hr(n)}</option>`
    )
  ).join("");
  return Hr.map((o) => {
...
function Rd(e, t = {}) {
  const a = e.root, o = t.apiClient || Do({
  ...
  function f() {
    if (!i) return;
    const y = Zo(l);
    lo(l) ? (i.textContent = r("Humanoid v1 ✓ — all 22 joints mapped"), i.dataset.state = "ok") : (i.textContent = r("Incomplete — {n} joint(s) unmapped").replace("{n}", y.length), i.dataset.state = "warn");
  }
  function u() {
    s && (s.innerHTML = Dd(p(), l)), f();
  }
  function d() {
  ...
  function b(y) {
    ...
    v === "auto" ? (l = So(p()), u()) : v === "validate" ? (u(), e.setStatus?.(lo(l) ? r("Rig is complete") : r("Rig still missing: {list}").replace("{list}", Zo(l).join(", ")))) : v === "save" && g();
  }
  async function g() {
    const y = m();
    if (!y?.asset_id) {
    ...
    try {
      const v = await o.patch(y.asset_id, {
        rig: { profile: Jo, bone_map: l }
      });
      y.character = {
        ...y.character || {},
        rig_profile: lo(l) ? Jo : null
...
function Bd(e, t = {}) {
  ...
  function g(k) {
    const E = Qo({ ...k, preset_id: k.id });
    return { id: k.id, name: k.name || k.id, root_offset: E.root_offset, joints: E.joints };
  }
  function y(k) {
    const E = u.get(k?.pose?.preset_id) || null;
    return ss({ preset: E, overrides: k?.pose }).joints;
  }
  function v() {
    const k = d();
  ...
  function j() {
    ...
    l && (l.textContent = k);
    const z = d(), R = y(z?.character)[k] || [0, 0, 0, 1], q = is(R);
    m.forEach(($, W) => {
      $ && document.activeElement !== $ && ($.value = String(Math.round(q[W] * 100) / 100));
    });
  }
  function x() {
    const k = d(), E = !!k?.character?.motion;
    if (i && (i.classList.toggle("active", f), i.disabled = E, i.title = E ? r("Clear the motion clip to edit the pose") : r("Toggle FK pose editing")), s) {
      ...
      s.dataset.sig !== R && (s.dataset.sig = R, s.replaceChildren(...z.map(([q, $]) => {
  ...
  async function M() {
    try {
      ...
      u = new Map((k.poses || []).filter((E) => E?.id).map((E) => [E.id, g(E)]));
    } catch {
      u = /* @__PURE__ */ new Map();
    }
  ...
  function P() {
    const k = b();
    if (!k) return;
    const E = m.map((q) => Number(q?.value) || 0), z = ns(E), R = e.directorApi?.execute({
      version: 1,
    ...
    R && !R.ok && e.setStatus?.(R.error?.message || r("Could not set the joint")), x();
  }
  function D() {
    const k = s?.value || "neutral", E = u.get(k) || Qo({ preset_id: k });
  ...
  async function F() {
    ...
    const E = (await St(e, r("Save Pose"), r("Pose name"), ""))?.trim();
    if (!E || e.disposed) return;
    const z = E.toLowerCase().replace(qd, "-").replace(/^-+|-+$/g, "").slice(0, 60) || "pose";
    try {
      ...
      u.set(R.pose.id, g(R.pose)), e.setStatus?.(r("Pose saved: {name}").replace("{name}", E)), x();
    } catch (R) {
...
const Vd = /* @__PURE__ */ new Set(["translate", "rotate", "scale"]), Hd = /* @__PURE__ */ new Set(["world", "local"]), Te = 180 / Math.PI;
function br(e) {
  return [e.x, e.y, e.z];
}
function Ud(e) {
...
function Gd({
  ...
  function M(C) {
    ...
    const N = C.rotationDeg.map((G, ae) => {
  ...
  function B(C) {
    ...
    p.rotation.set(N[0] / Te, N[1] / Te, N[2] / Te), p.scale.set(...C.scale || [1, 1, 1]), f.attach(p), f.visible = !0;
  }
  function V() {
  ...
  function k(C) {
    if (!Vd.has(C)) throw new Error(`createTransformControlsAdapter: unknown mode "${C}"`);
    f.setMode ? f.setMode(C) : f.mode = C;
  }
  function E(C) {
    if (!Hd.has(C)) throw new Error(`createTransformControlsAdapter: unknown space "${C}"`);
    f.space = C;
  }
  function z(C) {
...
function Yd(e, { controlsFactory: t, anchorFactory: a } = {}) {
  ...
  function u() {
    return o || (!e.webgl || !e.interactionElement ? null : (o = Gd({
      THREE: qc,
  ...
  function d({ targetSpec: k }) {
    if (k) {
      if (l(c), k.type === "object") {
        ...
        const E = ls(e), z = (E.length ? E : [k.object]).map((q) => ({
          object: q,
          transform: ze(q)
        }));
        for (const q of z) e.beginObjectEdit(q.object);
        const R = z.reduce((q, $) => ye(q, $.transform.position), [0, 0, 0]).map((q) => q / z.length);
      ...
      if (k.type === "camera_path") {
        ...
        e.checkpoint("Transform camera path"), n = {
          type: "camera_path",
          trackId: E.id,
          origin: Ur(E.keyframes),
          baseKeys: E.keyframes.map((z) => ({ ...z, camera: de(z.camera) }))
        };
        return;
      }
      if (k.type === "path_point" || k.type === "path_group") {
        ...
        e.checkpoint(k.type === "path_point" ? "Transform path point" : "Transform path selection"), n = {
          ...
          baseKeys: E.keyframes.map((R) => ({ ...R, camera: de(R.camera) })),
          lookAtActive: Gr(E, e.state.objects)
        };
        return;
      }
  ...
  function g(k) {
    ...
    E && (E.keyframes = Xr(n.baseKeys, h(k)), b(E));
  }
  function y(k) {
    const E = e.state.cameras.find((R) => R.id === n.trackId);
    if (!E) return;
    const z = { ...h(k), lookAtActive: n.lookAtActive };
    E.keyframes = ms(n.baseKeys, n.selectedFrames, z), b(E);
  }
  function v(k) {
    const E = e.state.cameras.find((z) => z.id === n.trackId);
    E && (E.keyframes = ps(n.baseKeys, [n.frame], { delta: k.position }), b(E));
  }
  function j({ delta: k }) {
  ...
  function x(k) {
    ...
    for (const q of E)
      if (R === "translate")
        ...
        q.object.position = ye(z, er($e(q.transform.position, z), k.rotationDeg)), q.object.rotation = ye(q.transform.rotation, k.rotationDeg);
      else if (R === "scale") {
  ...
  function M(k) {
    if (e.state.gizmo_mode === "translate")
      ...
      e.camera.target = ye(n.position, er(E, k.rotationDeg));
    }
    e.commitCameraEdit();
  }
  function P(k) {
    const E = ye(n.base, k.position);
    n.tracking ? ds(e, E) : e.camera.target = E, e.commitCameraEdit();
  }
  ...
  function F() {
    ...
    const k = e.recording ? null : cs(e), E = e.state.gizmo_mode || "translate", z = !!k && !k.readOnly && Xd.has(k.type) && k.allowedModes.includes(E);
    if (i = z ? k.type : null, !z) {
      o?.detach();
      return;
    }
    u() && (o.isDragging() || (o.setCamera(e.webgl.activeCamera), o.setMode(E), o.setSpace(e.state.gizmo_space === "local" ? "local" : "world"), o.attach(k)));
  }
  function U() {
...
function Zd(e, t) {
  ...
  const a = e.activeCameraTrack(), o = el(t, {
...
function Jd(e, t) {
  ...
  const o = Qc(a, { type: t, intensity: 1, duration_frames: e.state.duration_frames });
...
const gr = ["#4aa3ef", "#f2a93b", "#48c774", "#b565d8", "#ec4899"], Ke = [4, 8, 12, 20, 35, 60, 100];
function at(e) {
...
function ro(e, t, a) {
  ...
  const o = at(e), n = o.expanded ? 220 : 138, s = Math.min(n, Math.max(80, Math.min(t, a) - 20)), i = 10, c = Math.max(0, t - s - i), l = Math.max(0, a - s - i), m = e.viewportCamera(), p = m?.position || [0, 1.5, 5], f = m?.target || [0, 0, 0], u = e.activeCameraTrack?.(), d = e.state.cameras?.length ? e.state.cameras : u ? [u] : [], h = d.flatMap(
    (M) => (M.keyframes || []).map((P) => P.camera?.position).filter(Boolean)
  );
  let b = 12;
  if (o.rangeIndex >= 0 && o.rangeIndex < Ke.length)
    b = Ke[o.rangeIndex];
  else {
    const M = Math.max(
      Math.abs(p[0] || 0),
...
function om(e, t, a, o) {
  const n = ro(e, a, o);
  if (!n) return;
  const { rx: s, ry: i, radarSize: c, cx: l, cy: m, innerRadius: p, range: f, scale: u, camPos: d, camTgt: h, cameras: b, activeTrack: g } = n, y = at(e), v = e.state.active_camera_id || g?.id, j = (ee, ie) => wn(n, ee, ie);
  ...
  for (const ee of e.state.objects || []) {
    ...
    const ie = Po(e.state.objects, ee).position || [0, 0, 0], [fe, me] = j(ie[0], ie[2]);
  ...
  for (let ee = 0; ee < b.length; ee++) {
    const ie = b[ee], fe = ie.keyframes || [], me = ie.id === v, ue = ie.color || gr[ee % gr.length];
  ...
  const [P, D] = j(d[0] || 0, d[2] || 0), [F, U] = j(h[0] || 0, h[2] || 0), B = 8, V = Z(P, s + B, s + c - B), Q = Z(D, i + B, i + c - B), k = Z(F, s + B, s + c - B), E = Z(U, i + B, i + c - B), z = d[1] || 0, R = tm(z), q = am(z);
  ...
  re.addColorStop(0, R + "55"), re.addColorStop(1, R + "08"), t.fillStyle = re, t.strokeStyle = R, t.lineWidth = 1.2, t.beginPath(), t.moveTo(V, Q), t.lineTo(V + Math.cos(C - G) * ae, Q + Math.sin(C - G) * ae), t.arc(V, Q, ae, C - G, C + G), t.closePath(), t.fill(), t.stroke(), t.fillStyle = R + "44", t.beginPath(), t.arc(V, Q, 6.5, 0, Math.PI * 2), t.fill(), t.fillStyle = R, t.beginPath(), t.arc(V, Q, 3.5, 0, Math.PI * 2), t.fill(), t.strokeStyle = "#ffffff", t.lineWidth = 1.5, t.beginPath(), t.moveTo(V, Q), t.lineTo(V + Math.cos(C) * 7, Q + Math.sin(C) * 7), t.stroke(), rm(e, t, n, R, q, C, Math.hypot($, W)), y.hover && nm(t, n, y.hover), t.restore();
}
function rm(e, t, a, o, n, s, i) {
  const { rx: c, ry: l, radarSize: m } = a, p = at(e);
  ...
  const f = l + 3, u = 12;
  Ba(t, c + 44, f, 12, u, "−", p.hover?.button === "zoom_out"), Ba(t, c + 58, f, 12, u, "+", p.hover?.button === "zoom_in");
  const d = p.centerMode === "camera" ? "CAM" : "CTR";
  Ba(t, c + 72, f, 22, u, d, p.hover?.button === "center");
  const h = p.expanded ? "⤡" : "⤢";
  Ba(t, c + 96, f, 14, u, h, p.hover?.button === "size"), t.font = "bold 8.5px monospace", t.fillStyle = o, t.textAlign = "right", t.fillText(`Y:${n}`, c + m - 5, l + 9), t.fillStyle = "rgba(15, 23, 42, 0.70)", t.fillRect(c, l + m - 15, m, 15), t.strokeStyle = "rgba(0, 210, 211, 0.15)", t.beginPath(), t.moveTo(c, l + m - 15), t.lineTo(c + m, l + m - 15), t.stroke();
...
function Sn(e, t, a, o) {
  const { camPos: n, camTgt: s, cameras: i, rx: c, ry: l, radarSize: m } = t, p = (g, y) => wn(t, g, y), [f, u] = p(n[0] || 0, n[2] || 0);
  ...
  for (const g of e.state.objects || []) {
    ...
    const y = Po(e.state.objects, g).position || [0, 0, 0], [v, j] = p(y[0], y[2]);
...
function sm(e, t, a, o) {
  ...
  if (a < s || a > s + c || o < i || o > i + c)
    return !1;
  t.preventDefault?.(), t.stopPropagation?.();
  const l = at(e), m = kn(n, a, o);
  if (m)
    return m === "zoom_in" ? (l.rangeIndex === -1 && (l.rangeIndex = Ke.findIndex((d) => d >= n.range), l.rangeIndex < 0 && (l.rangeIndex = Ke.length - 1)), l.rangeIndex = Math.max(0, (l.rangeIndex === -1 ? 2 : l.rangeIndex) - 1)) : m === "zoom_out" ? (l.rangeIndex === -1 && (l.rangeIndex = Ke.findIndex((d) => d >= n.range), l.rangeIndex < 0 && (l.rangeIndex = 0)), l.rangeIndex = Math.min(Ke.length - 1, l.rangeIndex + 1)) : m === "center" ? l.centerMode = l.centerMode === "camera" ? "origin" : "camera" : m === "size" && (l.expanded = !l.expanded), e.render?.(), !0;
  const p = Sn(e, n, a, o);
  if (p) {
    if (p.type === "camera")
...
function im(e, t, a, o) {
  ...
  const n = ro(e, e.canvas.width, e.canvas.height);
  if (!n) return !1;
  const s = at(e), { rx: i, ry: c, radarSize: l } = n, m = a >= i && a <= i + l && o >= c && o <= c + l;
  if (s.drag) {
    const [b, g] = Eo(n, a, o), y = e.viewportCamera();
  ...
  const p = kn(n, a, o), f = Sn(e, n, a, o), [u, d] = Eo(n, a, o);
...
function cm(e, t, a, o) {
  ...
  if (a < s || a > s + c || o < i || o > i + c)
    return !1;
  t.preventDefault?.(), t.stopPropagation?.();
  const l = at(e), m = Math.sign(t.deltaY || 0);
  return l.rangeIndex === -1 && (l.rangeIndex = Ke.findIndex((p) => p >= n.range), l.rangeIndex < 0 && (l.rangeIndex = 2)), m > 0 ? l.rangeIndex = Math.min(Ke.length - 1, l.rangeIndex + 1) : m < 0 && (l.rangeIndex = Math.max(0, l.rangeIndex - 1)), e.render?.(), !0;
}
function lm(e, t = {}) {
  if (!e) return () => {
  };
...
function pm(e, t, a) {
  ...
  const o = () => {
    ...
    const h = hs(t('[data-role="object-tags"]')?.value || "");
    h.length ? d.tags = h : delete d.tags;
    const b = String(t('[data-role="object-annotation"]')?.value || "").trim(), g = b ? us({
      text: b,
  ...
  }, { signal: a }), il(e, a), zl(e, a), t('[data-role="curve-group"]')?.addEventListener("change", () => {
    e.setChannelFilter("all"), fn(e), e.drawCurveEditor();
  ...
  for (const d of e.root.querySelectorAll(".toolbar-menu"))
    d.addEventListener("toggle", () => {
      d.open ? (e.closeMenus(d), vr(d)) : mm(d);
    }, { signal: a });
  ...
  e.root.addEventListener("pointerdown", (d) => {
    ...
    const h = e.interactionElement.getBoundingClientRect(), b = (d.clientX - h.left) * e.canvas.width / Math.max(1, h.width), g = (d.clientY - h.top) * e.canvas.height / Math.max(1, h.height);
    cm(e, d, b, g) || e.onWheel(d);
  }, { passive: !1, signal: a }), e.root.addEventListener("wheel", Nc(e.root), { signal: a }), window.addEventListener("pointermove", (d) => {
  ...
  l && (l.addEventListener("pointerdown", (d) => e.onTimelinePointerDown(d), { signal: a }), l.addEventListener("pointermove", (d) => e.onTimelinePointerMove(d), { signal: a }), l.addEventListener("pointerup", (d) => e.onTimelinePointerUp(d), { signal: a }), l.addEventListener("pointercancel", (d) => e.onTimelinePointerUp(d), { signal: a }), l.addEventListener("wheel", (d) => Kr(e, d), { passive: !1, signal: a }));
  const m = (d) => {
    const h = bs(d.composedPath?.()[0] || d.target);
    h && (e.lastKeyZone = h);
  };
  e.root.addEventListener("focusin", m, { signal: a }), e.root.addEventListener("pointerdown", m, { capture: !0, signal: a }), e.root.addEventListener("focusout", (d) => {
    e.modalTransform && !e.root.contains(d.relatedTarget) && (fs(e), e.render());
  }, { signal: a });
...
function um(e) {
  const t = ii(e.id, e.defaultValue), a = `pref_${e.id.replace(/[^a-zA-Z0-9]/g, "_")}`;
  if (e.type === "boolean")
    return `
...
function gm() {
  return `<span class="oc-pref-emoji" aria-hidden="true">${fm}</span> ${r("OmniCam Preferences")}`;
}
function vm(e) {
  ...
  a.className = "oc-modal-backdrop", a.setAttribute("role", "dialog"), a.setAttribute("aria-modal", "true"), a.setAttribute("aria-label", r("OmniCam Preferences")), a.innerHTML = `
    <div class="oc-modal-dialog oc-pref-dialog" tabindex="-1">
      <div class="oc-pref-header">
        <div class="oc-pref-title">${gm()}</div>
...
const xm = ["position", "target"], wm = ["fov", "zoom"], km = ["roll"], Sm = ["position", "size"], jm = ["rotation"];
function _o(e) {
  ...
  for (let n = 1; n < a.length - 1; n++) {
    ...
    if (i.camera) {
      for (const p of xm) {
        ...
        if (Array.isArray(f) && Array.isArray(d) && Array.isArray(u)) {
          const h = xr(f, u, d, m);
          a[n].camera[p] = kr(u.map(Number), h, o);
        }
      }
      for (const p of wm) {
        const f = s.camera?.[p], u = i.camera?.[p], d = c.camera?.[p];
    ...
    if (Array.isArray(i.position) && Array.isArray(s.position) && Array.isArray(c.position)) {
      for (const p of Sm) {
        ...
        if (Array.isArray(f) && Array.isArray(d) && Array.isArray(u)) {
          const h = xr(f, u, d, m);
          a[n][p] = kr(u.map(Number), h, o);
        }
      }
      for (const p of jm) {
        const f = s[p], u = i[p], d = c[p];
        if (Array.isArray(f) && Array.isArray(d) && Array.isArray(u)) {
          const h = [0, 1, 2].map((b) => wr(f[b], u[b], d[b], m));
          a[n][p] = u.map((b, g) => Sr(Number(b), h[g], o));
        }
      }
    }
  }
...
function Pm(e, t) {
  ...
  const o = (n) => {
    ...
    const h = (g) => {
      ...
      let v = Mm;
      g.shiftKey ? v = Am : (g.ctrlKey || g.metaKey) && (v = Tm);
      const j = m * v * 20;
      let x = l + y * j;
...
function jn(e) {
  ...
  m && o?.fov != null && (m.textContent = gc(o.fov));
...
function Fm(e, t) {
  for (const o of e.root.querySelectorAll('[data-act="toggle-camera-lock"]'))
    o.addEventListener("click", (n) => {
      n.stopPropagation(), e.checkpoint?.("Toggle camera lock"), e.state.camera_lock = !e.state.camera_lock, e.serialize?.(), jn(e), e.setStatus?.(e.state.camera_lock ? r("Camera View locked") : r("Camera View unlocked"));
    }, { signal: t });
...
function Om(e, t) {
  ...
  }, s = (i) => (e.smoothingBaseline?.cameraId !== i.id && (e.smoothingBaseline = { cameraId: i.id, keys: $m(i.keyframes) }), e.smoothingBaseline.keys);
  a.addEventListener("input", n, { signal: t }), a.addEventListener("change", () => {
    const i = e.activeCameraTrack();
    if (!i) return;
    e.checkpoint("Path smoothing");
    const c = Number(a.value) / 100, l = _m(s(i), c);
...
function Km(e, t) {
  ...
  e.root.querySelector('[data-act="keys-reduce"]')?.addEventListener("click", async () => {
    const l = await St(e, r("Reduce keys"), r("Target number of keys"), "8"), m = Math.round(Number(l));
  ...
  if (a.length) {
    ...
    for (const o of a)
      o.addEventListener("change", () => {
        e.dopeChannels = new Set(a.filter((n) => n.checked).map((n) => n.dataset.dopeChannel)), sn(e);
      }, { signal: t });
  }
}
function Nm(e, t) {
...
const Wa = () => import("./chunk-CBgucKQR.js");
function Bm(e, t) {
  Wa().then(({ loadExchangeFormats: o }) => o(e, t)), e.root.querySelector('[data-act="import-camera"]')?.addEventListener("click", async () => {
    (await Wa()).pickCameraFile(e);
  }, { signal: t }), e.root.querySelector('[data-act="export-camera"]')?.addEventListener("click", async () => {
    (await Wa()).exportCamera(e);
  }, { signal: t }), e.root.querySelector('[data-role="camera-file"]')?.addEventListener("change", async (o) => {
    const n = o.target.files?.[0];
    o.target.value = "", await (await Wa()).importCameraFile(e, n);
  }, { signal: t });
}
function Wm(e, t) {
  ...
  ci().then((n) => {
    ...
    c === "health-slow" ? di(e) : c === "health-smooth" ? mi(e) : c === "health-recenter" && pi(e);
  }, { signal: t });
...
function Gm(e, t) {
  Bm(e, t), Lm(e, t), Om(e, t), Km(e, t), Dm(e, t), Vm(e, t), Um(e, t), Hm(e, t), Pm(e, t), Im(e, t), Rm(e, t), qm(e, t), Fm(e, t), Nm(e, t), Wm(e, t);
}
const jr = {
...
}, Cn = "balanced", bo = "#121212";
function Ro(e) {
  return jr[e] || jr[Cn];
}
function Xm(e, t = "#1b1f2b", a = "#151822", o = "#1e2330", n = "#161922", s = "#111319") {
...
function Mu(e, t, a = Cn) {
  ...
  const d = new e.FogExp2(1250588, 8e-3), h = Xm(e), b = new e.PMREMGenerator(t);
  b.compileEquirectangularShader();
  const g = new Wc(), y = b.fromScene(g, 0.04).texture;
  return g.traverse((v) => {
    v.geometry?.dispose?.();
...
function Zm(e) {
  ...
  const n = e.reconstruction, s = n.provider || "Reconstructed", i = Math.round(t * 100), c = wc(e), l = c.length ? `
` + c.map(([p, f]) => `${p}: ${f}`).join(`
`) : "", m = `${s} • ${o} (${i}%)${l}`;
  return {
    label: o,
...
function ep(e, t, a) {
  ...
  if (o) {
    const s = (i) => {
      const c = i.target.closest?.("[data-axis], [data-axis-center]") || i.target, l = c.getAttribute("data-axis"), m = fi(l?.toLowerCase(), e.state.view_mode);
  ...
  for (const s of e.root.querySelectorAll('[data-role="point-color"]'))
    s.addEventListener("input", (i) => {
      e.state.point_color !== i.target.value && Va(e, "point_color", "Change point color"), e.state.point_color = i.target.value, e.scheduleSerialize(), e.render();
    }, { signal: a });
  ...
  for (const s of e.root.querySelectorAll('[data-role="viewport-bg-color"]')) {
    const i = (c) => {
      e.state.viewport_bg_color !== c.target.value && Va(e, "viewport_bg_color", "Change background colour"), e.state.viewport_bg_color = c.target.value, ve(e.root, "viewport-bg-color", c.target), e.scheduleSerialize(), e.render();
    };
    s.addEventListener("input", i, { signal: a }), s.addEventListener("change", i, { signal: a });
  }
  ...
  for (const s of e.root.querySelectorAll('[data-role="object-color"]'))
    s.addEventListener("input", (i) => {
      const c = e.selectedObject();
      c && (c.color !== i.target.value && Va(e, `object_color:${c.id}`, "Change object color"), c.color = i.target.value, e.scheduleSerialize(), e.render());
    }, { signal: a });
  for (const s of e.root.querySelectorAll('[data-role="object-light-color"]'))
    s.addEventListener("input", (i) => {
      const c = e.selectedObject();
      c && (c.color !== i.target.value && Va(e, `object_color:${c.id}`, "Change light color"), c.color = i.target.value, e.scheduleSerialize(), e.render());
    }, { signal: a });
  ...
  for (const s of e.root.querySelectorAll("[data-lens]"))
    s.addEventListener("click", () => {
      kc(e, Number(s.dataset.lens));
    }, { signal: a });
  for (const s of e.root.querySelectorAll("[data-blocking-scene]"))
    s.addEventListener("click", () => {
      em(e, s.dataset.blockingScene), e.closeMenus();
    }, { signal: a });
...
const tp = 32, ap = 0.025, op = 0.05, Za = 1e-6, rp = ["top", "bottom", "front", "back", "left", "right"], np = {
  top: "y",
  bottom: "y",
  front: "z",
  back: "z",
...
function sp(e) {
  let t = 0;
  for (let a = 1; a < e.length; a++) t += qo(e[a - 1], e[a]);
  return t;
}
function Mo(e) {
...
function ip(e, t) {
  ...
  for (let i = 0; i < t; i++) {
    ...
    const l = a[s - 1], m = a[s], p = $o((c - l) / Math.max(Za, m - l), 0, 1), f = e[s - 1], u = e[s];
    n.push([
      f[0] + (u[0] - f[0]) * p,
      f[1] + (u[1] - f[1]) * p,
      f[2] + (u[2] - f[2]) * p
...
function dp(e) {
  ...
  const s = Math.min(tp, n.length, o + 1);
  if (s < 2) return [];
  const i = ip(n, s);
  ...
  ], m = e.planeAxis === "y" ? En(l) : _n(l, [0, 0, -1]), p = e.seedPoint ? 1 : 0, f = [];
  for (let u = p; u < i.length; u++) {
    const d = i[u], h = cp(i, u, m, e.planeAxis), b = de(c);
    b.position = [...d], b.target = lp(d, h, l, e.planeAxis), f.push({
...
function $n(e, t = e.cameraPathDraw) {
  const a = t?.pointerId;
  if (a != null)
    try {
...
function Cr(e, t = {}) {
  ...
  if (a === "extend") {
    ...
    const h = Math.max(0, Math.round(Number(e.state.duration_frames) || 1) - 1), [, b] = Mo(e.state), g = u.length > 1 ? u[u.length - 1].frame - u[0].frame : 24;
    let y = Math.max(b, d.frame + Math.max(6, Math.min(g, 240)));
    y <= d.frame && (y = d.frame + 24), y > h && (l = y + 1), y > b && (m = y), c = [d.frame, y];
  } else
    rp.includes(e.state.view_mode) || e.setViewMode?.("top"), c = Mo(e.state);
  const p = np[e.state.view_mode] ?? null, f = s ? [...s] : [...n.position];
...
function Bo(e, t) {
  ...
  return n && qo(n, o) < ap ? !1 : (a.points.push(o), !0);
}
function Pe(e) {
  const t = e.cameraPathDraw;
  return t?.active ? ($n(e, t), e.cameraPathDraw = null, wt(e), e.setStatus?.(r("Draw Camera Path cancelled")), e.render?.(), !0) : !1;
}
function pp(e) {
  const t = e.cameraPathDraw;
  ...
  if (a.length < 2 || sp(a) < op || t.range[1] <= t.range[0])
  ...
  if (t.mode === "extend") {
    ...
    return c.keyframes = m, c.id === e.state.active_camera_id && (e.state.keyframes = m), e.cameraPreviewSignature = "", e.cameraPathDraw = null, wt(e), e.activateCamera?.(c.id), e.setFrame?.(o[0].frame), e.serialize?.(), e.refreshKeys?.(), e.render?.(), e.setStatus?.(r("Camera path extended")), c.id;
  }
  e.checkpoint?.("Draw camera path");
  const n = Sc(e.state), s = e.state.cameras.length, i = {
    id: n,
    name: mp(e.state),
...
function hp(e, t) {
  const a = e.cameraPathDraw;
  return a?.active ? t.button === 2 && !t.altKey ? (Qa(t), e.cameraPathSuppressContextMenuUntil = Date.now() + 1e3, Pe(e), !0) : t.button !== 0 || t.altKey || t.ctrlKey || t.metaKey || t.shiftKey ? !1 : (Qa(t), e.closeMenus?.(), e.interactionElement.focus?.({ preventScroll: !0 }), e.interactionElement.setPointerCapture?.(t.pointerId), a.drawing = !0, a.pointerId = t.pointerId, a.points = [], Bo(e, Wo(e, t)), wt(e), e.requestRender?.("camera-path-draw"), !0) : !1;
}
function up(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : (Qa(t), Bo(e, Wo(e, t)) && e.requestRender?.("camera-path-draw"), !0);
}
function bp(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : (Qa(t), t.type === "pointercancel" || t.type === "lostpointercapture" ? (Pe(e), !0) : (Bo(e, Wo(e, t)), a.drawing = !1, pp(e), !0));
}
function gp(e) {
  const t = e.cameraPathDraw;
...
function vp(e, t) {
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? Pe(e) : Cr(e);
    }, { signal: t });
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path-extend"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? Pe(e) : Cr(e, { mode: "extend" });
    }, { signal: t });
...
const Ga = "/majoor/omnicam/scenes";
function Mn(e) {
...
function Vo(e, t, { name: a = "", status: o } = {}) {
  const n = t && typeof t == "object" ? t : Yr(), s = { ...n, metadata: { ...n.metadata || {}, scene_name: a || "" } };
...
async function yp(e) {
  await jt(e, r("New Scene"), r("Start a new scene? Unsaved changes will be lost.")) && Vo(e, Yr(), { name: "", status: r("New scene") });
}
async function xp(e) {
  if (!e.sceneBaseline) {
  ...
  const o = a?.metadata?.scene_name || Mn(e);
  Vo(e, a, { name: o, status: r("Scene reset to last save") });
}
async function wp(e) {
  const t = Mn(e) || r("Untitled"), a = await St(e, r("Save Scene"), r("Scene name"), t);
  if (a == null) return;
...
async function kp(e) {
  ...
  const a = await an({
    ...
    items: t.map((n) => ({
      id: n.slug,
      label: n.name || n.slug,
      sublabel: Sp(n.modified)
    })),
    onDelete: async (n) => {
      const s = await Xa(e, `${Ga}/${encodeURIComponent(n)}`, { method: "DELETE" });
      if (!s.ok) throw new Error(await s.text());
    }
  });
  if (!(!a || !await jt(e, r("Open Scene"), r("Open this scene? Unsaved changes will be lost."))))
    try {
      const n = await Xa(e, `${Ga}/${encodeURIComponent(a)}`);
      if (!n.ok) throw new Error(await n.text());
...
function jp(e, t) {
  Ha(e, t, e.root.querySelectorAll('[data-act="scene-new"]'), () => yp(e)), Ha(e, t, e.root.querySelectorAll('[data-act="scene-open"]'), () => kp(e)), Ha(e, t, e.root.querySelectorAll('[data-act="scene-save"]'), () => wp(e)), Ha(e, t, e.root.querySelectorAll('[data-act="scene-reset"]'), () => xp(e));
}
const Cp = ["world_point", "object_point", "camera_field"], Er = 40;
function Ep(e) {
...
function _p(e, t, a) {
  ...
  for (let c = 0; c <= Er; c += 1) {
    const l = a * c / Er, m = zo(e, t.source, l * o, n, s);
...
function Mp(e) {
  ...
  if (!c) return;
  const l = An(t, e.state.width || 1280, e.state.height || 720), m = (g) => l.x + g * l.w, p = (g) => l.y + g * l.h;
  ...
  for (const g of e.state.motion_layers || []) {
    if (g.enabled === !1) continue;
    const y = Cp.includes(g.source_kind), v = y ? _p(e.state, g, u) : Ep(g);
...
function Ap(e, t) {
  ...
  a && a.addEventListener("click", (o) => {
    ...
    const s = An(a, e.state.width || 1280, e.state.height || 720), i = a.width / n.width, c = {
...
function Ip(e, t) {
  ...
  return {
    ...
    motion_scene_fingerprint: Yc(e.state),
...
function _r(e, t, { frameCount: a = 0, fps: o = 0 } = {}) {
...
const Be = 1024 * 1024, Fp = Object.freeze({
  card: 128 * Be,
  // MAX_CARD_BYTES
  model: 256 * Be,
  // MAX_MODEL_BYTES
...
function Ct(e, t) {
  ...
  return !Number.isFinite(o) || o <= a ? null : `${e.name || "File"} is ${Mr(o)}; the maximum is ${Mr(a)}.`;
}
function Lp(e) {
  return Number(e) <= $r ? null : `${e} frames selected; a background sequence is limited to ${$r}.`;
}
function Op(e) {
...
function Kp(e) {
  ...
  const m = (p) => {
    ...
    if (f === null) {
      for (l += p - c, c = p; l >= i; )
        if (l -= i, n += 1, n > o) {
          if (!e.state.loop_playback) return void Ya(e);
          n = a;
        }
...
async function Dp(e, { load: t = () => import("./vendor-mediabunny-CZ5VNE-V.js") } = {}) {
...
async function Np(e, t, { decode: a = Dp } = {}) {
  if (!t) return;
  const o = Ct(t, "audio");
  if (o) {
    e.setStatus(o);
  ...
  try {
    ...
    s.preload = "auto", s.src = n, e.audioObjectUrl = n, e.audioElement = s, await Rp(s), e.audioDuration = Number.isFinite(s.duration) ? s.duration : 0;
    try {
      e.audioSamples = await a(t);
    } catch {
      e.audioSamples = null;
    }
    Tn(e), e.setStatus(`Audio loaded: ${t.name || "track"}`);
  } catch (n) {
...
const In = /* @__PURE__ */ new WeakSet(), yt = /* @__PURE__ */ new WeakMap();
function to(e) {
...
function Bp(e) {
  ...
  yt.delete(e), In.has(e) && to(e);
}
function Et(e, t) {
  const a = e.cardMediaById.get(t);
  a && (e.cardMediaById.delete(t), e.cardMediaAssetById?.delete?.(t), t === "subject" && e.cardMedia === a && (e.cardMedia = null), Bp(a));
}
function Wp(e) {
...
function Re(e, t, a, o = !1, n = "") {
  ...
  s && s !== a && Et(e, t), o && In.add(a), qp(a), e.cardMediaAssetById ||= /* @__PURE__ */ new Map(), e.cardMediaById.set(t, a), e.cardMediaAssetById.set(t, n || a?.__omnicamAsset || "");
  try {
    a.__omnicamAsset = n || a.__omnicamAsset || "";
  } catch {
  }
...
function zn(e, t, { signal: a, timeout: o = 15e3 } = {}) {
...
async function Fn(e, t, a, o = () => !0, n = null) {
  if (!t || !a) return;
  const s = () => !e.disposed && o(), i = String(t.asset || a).toLowerCase();
  if (n ?? /\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/.test(i)) {
    const l = document.createElement("video");
    if (l.src = a, l.loop = !0, l.muted = !0, l.playsInline = !0, await zn(l, ["loadeddata", "error"], { signal: e.abortController?.signal }).catch(() => {
    }), !s()) {
      to(l);
      return;
    }
...
function Hp(e) {
  ...
  e.viewportBgSequenceImages = (e.state.viewport_bg_sequence || []).map((o) => {
    const n = new Image();
    return n.src = De(o), n.decode().catch(() => {
    }), n;
  });
...
async function Gp(e, t) {
  ...
  try {
    const c = await Ko(et, { route: "/majoor/omnicam/upload_model", field: "asset", file: t });
...
async function Xp(e, t) {
  ...
  if (o) {
    ...
    try {
      const n = await Ko(et, { route: "/majoor/omnicam/upload_asset", field: "asset", file: t });
...
async function Jp(e) {
  ...
  for (const f of i) {
    ...
    if (d) {
      if (u === "image" || u === "video") {
        ...
        if (h && h.value) {
          const b = String(h.value), g = /\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/i.test(b), y = d.widgets?.find((x) => String(x.name).toLowerCase() === "subfolder")?.value || "", v = De(Xe(b, y)), j = e.state.objects.find((x) => x.id === "subject");
          if (j) {
            const x = await Fn(e, j, v, n, g);
            if (!n()) return;
            j.asset = Xe(b, y);
            let M = null;
            if (g)
              try {
                M = await Vp(b, o.signal);
              } catch (P) {
          ...
          }), Re(e, "subject", b, !1, b.currentSrc || b.src || ""), _r(e, b, { frameCount: b instanceof HTMLVideoElement ? 0 : 1 }), e.upstreamImageConnected = !0, s = !0, e.render(), e.setStatus(b instanceof HTMLVideoElement ? r("Upstream video preview synced") : r("Upstream image preview synced")));
        }
      }
      if (u === "audio") {
        l = !0;
        ...
        if (h && h.value) {
          const b = String(h.value), g = d.widgets?.find((v) => String(v.name).toLowerCase() === "subfolder")?.value || "", y = De(Xe(b, g));
          try {
      ...
      if (u === "scene_3d" || u === "model" || u === "mesh") {
        ...
        if (h && h.value) {
          ...
          if (["glb", "gltf", "obj", "fbx", "stl", "ply"].includes(g)) {
            const y = d.widgets?.find((M) => String(M.name).toLowerCase() === "subfolder")?.value || "", v = De(Xe(b, y)), j = `upstream_scene_${d.id}`;
            m.add(j);
            let x = e.state.objects.find((M) => M.id === j);
            x ? (x.asset = Xe(b, y), x.format = g === "gltf" ? "glb" : g) : (x = {
              id: j,
              type: "model",
              format: g === "gltf" ? "glb" : g,
  ...
  jc(e) && (s = !0), s && (e.serialize(), e.render());
}
const Qp = ["video/mp4;codecs=avc1.42E01E", "video/webm;codecs=vp9", "video/webm;codecs=vp8", "video/webm"], Ar = { low: 3e6, balanced: 6e6, high: 12e6 };
function ef(e) {
  return Ar[e] || Ar.balanced;
}
async function tf({
  canvas: e,
  fps: t,
  ...
  try {
    for (const j of Qp)
      if (!(s.isTypeSupported && !s.isTypeSupported(j)))
        try {
          f = new s(p, { mimeType: j, videoBitsPerSecond: ef(n) });
          break;
        } catch {
        }
...
async function of(e) {
  await Promise.all([...e].filter((t) => t instanceof HTMLVideoElement && t.seeking).map((t) => zn(t, ["seeked", "error"], { timeout: 5e3 }).catch(() => {
  })));
}
async function Ln(e) {
  await of(e.cardMediaById.values());
}
async function On(e) {
  return tf({
    canvas: e.canvas,
...
async function Kn(e, t) {
  const a = await af(Ve, t);
  if (zp(e, t), e.state.playblast_camera_id === Zr)
...
async function nf(e) {
  ...
  const t = e.frame, a = e.canvas.width, o = e.canvas.height, n = rf(e);
  (n.width !== e.canvas.width || n.height !== e.canvas.height) && (e.canvas.width = n.width, e.canvas.height = n.height, e.render());
  try {
    let s = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-TG5fMMYR.js");
    i !== "realtime" && await l(e.canvas.width, e.canvas.height) && (s = await c(e.canvas, e.state.duration_frames, e.state.fps, async (m) => {
      e.setFrame(m, !0), e.setStatus(r("Encoding frame {value1}/{value2}…", { value1: m + 1, value2: e.state.duration_frames })), await Ln(e), await new Promise((p) => requestAnimationFrame(p));
    }, e.abortController?.signal, e.state.playblast_quality)), s || (e.setStatus(r("WebCodecs unavailable; recording realtime fallback…")), s = await On(e)), e.setFrame(t), await Kn(e, s);
  } catch (s) {
...
async function Dn(e) {
  ...
  return Ko(kt, { route: "/majoor/omnicam/upload_asset", field: "asset", file: e });
}
async function ao(e) {
...
async function cf(e, t) {
  ...
  let n = null;
  try {
    if (e.setStatus(`Uploading background: ${t.name}`), n = await Dn(t), o !== e.backgroundRequestId || e.disposed) {
      await ao([n]);
      return;
    }
    const s = De(n.path);
...
async function lf(e, t) {
  ...
  const o = Array.from(t).map((i) => Ct(i, "image")).find(Boolean);
  if (o) {
    e.setStatus(o);
    return;
  }
  ...
  try {
    ...
    for (const c of t)
      if (s.push(await Dn(c)), n !== e.backgroundRequestId || e.disposed) {
        await ao(s);
        return;
      }
...
function df(e) {
  Ho(e), e.checkpoint?.("Clear background"), e.state.viewport_bg_image = "", e.state.viewport_bg_sequence = [], e.viewportBgImage = null, e.viewportBgSequenceImages = [], e.serialize(), e.render(), e.setStatus("Background cleared");
}
function mf(e) {
  ...
  for (const p of a) {
    if (p.enabled === !1 || !Nr(p, { mode: t.mode, selectedIds: m })) continue;
    const f = qr(p, t.content);
    if (!f) continue;
    const u = Br(a, p, l) || { position: p.position, size: p.size }, d = Ie(Wr(u, p.type), o, s, i);
    if (!d) continue;
    ...
    n.fillStyle = "rgba(16,17,22,0.82)", pf(n, P, D, x, M, 4 * c), n.fill(), g && (n.strokeStyle = g, n.lineWidth = Math.max(1, c), n.stroke()), n.fillStyle = g || "#e6e6ec", n.fillText(f, P + y, D + M - v - 2 * c);
  }
  n.restore();
}
function pf(e, t, a, o, n, s) {
...
const uf = 600;
function bf(e) {
  const { points: t, colors: a } = hf(e);
  if (!t.length) return;
  const o = e.viewportCamera(), n = e.canvas.width, s = e.canvas.height, i = t.length / 3, c = 3 * Math.max(1, Math.ceil(i / uf)), l = /* @__PURE__ */ new Map();
...
function Ef(e) {
  ...
  e.recording && e.state.playblast_labels && mf(e);
}
async function _f(e, { signal: t } = {}) {
...
async function Mf(e) {
  ...
  const n = o.diagnostic?.issues || [], s = $f(n);
...
const Af = 1, Tr = 0.01, Tf = 0.4, Pf = 3, If = 120, zf = 20, Ff = 4, Lf = 0.25, Of = 0.5;
function Kf(e, t, a) {
...
function Rf({ keys: e, fps: t = 24, objects: a = [] } = {}) {
  ...
  for (const c of s)
    ...
    }), c.distance < Tr && c.duration >= Tf && n.push({
      code: "STATIC_SEGMENT",
      severity: "info",
      frameStart: c.frameStart,
      frameEnd: c.frameEnd,
  ...
  if (i.length) {
    ...
    if (c > 1e-6)
      for (const l of s)
        Number.isFinite(l.speed) && l.speed > c * Pf && n.push({
          code: "SPEED_SPIKE",
          severity: "warning",
  ...
  for (let c = 1; c < o.length - 1; c += 1) {
    const l = $e(o[c].camera.position, o[c - 1].camera.position), m = $e(o[c + 1].camera.position, o[c].camera.position), p = We(l), f = We(m);
    if (p < 1e-6 || f < 1e-6) continue;
    const u = Math.max(-1, Math.min(1, yi(l, m) / (p * f))), d = Math.acos(u) * 180 / Math.PI;
    d >= If && n.push({
  ...
  if (o.length >= Ff) {
    ...
    let f = Math.abs(Pr(p, c, l) - Pr(m, c, l)) % 360;
    f > 180 && (f = 360 - f);
    const u = We($e(p, m));
    f <= zf && u > Tr && n.push({
  ...
  if (Array.isArray(a) && a.length)
    for (const c of o)
      for (const l of a) {
        ...
        const m = Number.isFinite(Number(l.radius)) ? Number(l.radius) : Of;
        We($e(c.camera.position, l.position)) < m + Lf && n.push({
...
function Wf(e, { perFrame: t = !1 } = {}) {
  const a = e.activeCameraTrack(), o = Uo(e, a), n = Go(e, a);
  ...
  if (p) {
    ...
    if (t.appendChild(v), !j)
      for (const { object: x, level: M } of y) {
        ...
        E.style.cssText = V ? `color:${oe.error}` : B ? "" : "opacity:.5;text-decoration:line-through", E.textContent = x.name || x.type, E.title = r("Double-click to rename"), E.addEventListener("dblclick", ($) => {
          $.preventDefault(), $.stopPropagation(), Hf(e, x, E);
        }), k.appendChild(E);
        ...
        R.className = "scene-item-actions", R.appendChild(n(B ? "pi-eye" : "pi-eye-slash", B ? "Hide object (Alt+Click to Isolate)" : "Show object (Alt+Click to Isolate)", !B, ($) => {
          if ($?.altKey) {
            ...
            e.toggleObject(x.id);
        }, `color:${oe.error};opacity:.7`)), R.appendChild(n(x.locked ? "pi-lock" : "pi-lock-open", "Lock object", x.locked, () => No(e, x))), R.appendChild(n("pi-copy", "Duplicate object", !1, () => e.duplicateObject?.(x.id))), x.id !== "subject" && R.appendChild(n("pi-trash", "Delete object", !1, () => e.deleteObject?.(x.id))), R.appendChild(n("pi-ellipsis-v", "Object actions", !1, ($) => e.openObjectContext($, x.id))), P.append(Q, k, R), P.title = r("Click to select · Double-click to toggle visibility · Right-click for actions");
        const q = ($ = {}) => {
          ...
          if (e.finishCameraEdit(), e.selectedEntity = "object", e.selectedObjectIds ||= /* @__PURE__ */ new Set(), $.ctrlKey || $.metaKey)
            ...
            const C = e.state.objects.map((ae) => ae.id), N = C.indexOf(e.outlinerAnchorId), G = C.indexOf(x.id);
            e.selectedObjectIds = new Set(C.slice(Math.min(N, G), Math.max(N, G) + 1));
          } else
          ...
          for (const C of t.querySelectorAll(".scene-item")) {
            const N = !!(C.dataset.objectId && e.selectedObjectIds.has(C.dataset.objectId)), G = !!(C.dataset.objectId && C.dataset.objectId === e.selectedObjectId);
            C.classList.toggle("selected", N), C.classList.toggle("primary", G), C.dataset.objectId && C.setAttribute("aria-selected", String(N));
          }
...
async function Gf(e, t) {
  ...
  if (!a) return;
  const o = (await St(e, r("Rename object"), r("Object name"), a.name || a.type))?.trim();
...
async function Wn(e, t) {
  ...
  const a = e.state.objects.find((o) => o.id === t);
  if (a && await jt(e, r("Delete object"), r("Delete {value1} and its {value2} keyframe(s)?", { value1: a.name || a.type, value2: (a.keyframes || []).length })) && !(e.disposed || !e.state.objects.includes(a))) {
...
function Jf(e) {
  ...
  if (s) {
    const k = n.target_object_id || e.state.target_object_id || "", E = `T${tr()}${e.state.objects.map((z) => `${z.id}\0${z.name || z.type}`).join("|")}`;
    vo(s, E, () => [
      vt("", r("Manual Target (No Tracking)")),
      ...e.state.objects.map((z) => vt(z.id, `${r("Track:")} ${z.name || z.type}`))
    ], k);
  }
  Vf(e);
  ...
  if (!t) {
    ...
    E && (E.textContent = `${n.name} · F${e.frame}`), Ir(o, {
  ...
  p && (p.textContent = t.name || t.type), Ir(o, {
  ...
  if (g) {
    ...
    const R = e.state.objects.filter(($) => !E.has($.id)), q = `P${tr()}${k}${R.map(($) => `${$.id} ${$.name || $.type}`).join("|")}`;
    vo(g, q, () => [
      vt("", r("No parent")),
      ...R.map(($) => vt($.id, $.name || $.type))
    ], t.parent_id || "");
  }
  ...
  if (h && (h.hidden = !F?.animations), b) {
    ...
    vo(b, `A${k.join("|")}`, () => k.map((E, z) => vt(String(z), E)), String(t.animation_index || 0));
  }
...
function ah(e) {
  ...
  e.beginCameraEdit(), xi(e.camera, n), e.commitCameraEdit(), e.finishCameraEdit(), Hn(e), th(e), e.render();
}
function oh(e) {
  const t = globalThis.performance?.now?.() ?? Date.now();
  (!Number.isFinite(e.lastCameraHudEditAt) || t - e.lastCameraHudEditAt > 300) && e.checkpoint("Edit camera"), e.lastCameraHudEditAt = t;
  ...
  e.camera.position = [a("camera-px", e.camera.position[0]), a("camera-py", e.camera.position[1]), a("camera-pz", e.camera.position[2])], e.camera.target = [a("camera-tx", e.camera.target[0]), a("camera-ty", e.camera.target[1]), a("camera-tz", e.camera.target[2])], e.camera.fov = Z(a("camera-fov", e.camera.fov), 5, 150), e.camera.roll = Z(a("camera-roll", e.camera.roll || 0), -180, 180), e.camera.near = Math.max(1e-4, a("camera-near", e.camera.near)), e.camera.far = Math.max(e.camera.near + 1e-4, a("camera-far", e.camera.far)), e.beginCameraEdit(), e.commitCameraEdit(), e.finishCameraEdit(), Hn(e), e.render();
}
function rh(e, t) {
  const a = _t(e);
  if (!a) return;
...
function ih(e) {
  ...
  if (!t.length) return [];
  if (t.length === 1)
    return Bn(e, t[0]), e.selectedObjectId ? [e.selectedObjectId] : [];
...
function yh(e, t) {
  t && (e.selectedKeyFrame = t.frame, e.selectedKeyFrames = /* @__PURE__ */ new Set([t.frame]), e.editingKeyFrame = null, Se(e) || (e.pathSelection = wi(e.pathSelection, { cameraId: e.state.active_camera_id, frame: t.frame, additive: !1 })), e.setFrame(t.frame));
}
function xh(e) {
...
const Ch = ["guides", "safe-areas", "resolution-gate", "aspect-ratio"];
function Eh(e) {
...
function Mh(e) {
  ...
  t.hidden = !1;
  const o = Rf({ keys: a, fps: e.state?.fps || 24, objects: e.state?.objects || [] });
  if (!o.length) {
    const n = document.createElement("div");
...
function Ph(e) {
  ...
  if (t.interpolation = e.root.querySelector('[data-role="key-interp"]').value, t.camera.position = [a("key-px", t.camera.position[0]), a("key-py", t.camera.position[1]), a("key-pz", t.camera.position[2])], t.camera.target = [a("key-tx", t.camera.target[0]), a("key-ty", t.camera.target[1]), a("key-tz", t.camera.target[2])], t.camera.fov = Z(a("key-fov", t.camera.fov), 5, 150), t.camera.roll = Z(a("key-roll", t.camera.roll || 0), -180, 180), t.camera.zoom = Math.max(0.01, a("key-zoom", t.camera.zoom || 1)), t.camera.near = Math.max(1e-4, a("key-near", t.camera.near)), t.camera.far = Math.max(t.camera.near + 1e-4, a("key-far", t.camera.far)), t.camera.camera_type = e.root.querySelector('[data-role="key-camera-type"]').value, e.root.querySelector('[data-role="key-timing-weight"]')) {
    const n = ki(t, a("key-timing-weight", Jr(t)));
...
function Oh(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: n, initializeTooltips: s, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: m, activeCameraTrack: p, bindWidgetCallbacks: f, playblastCameraTrack: u, restoreFromWidgets: d, serializeEditorState: h, syncActiveCameraTrack: b, syncFromWidgets: g, bindEditorEvents: y, activateCamera: v, addCamera: j, deleteCamera: x, drawPreviewOverlays: M, duplicateCamera: P, maximizeCameraPreview: D, refreshCameraPreviews: F, refreshCameraSelectors: U, renameCamera: B, setPlayblastCamera: V, toggleCameraView: Q, captureRealtime: k, makePlayblast: E, uploadDirectorPlayblast: z, waitForMediaFrame: R, computeAudioPeaks: q, loadAudioFile: $, releaseAudio: W, stopPlay: C, togglePlay: N, applyCameraPreset: G, applyCameraShake: ae, applyProxyPreset: re, clearViewportBgImage: ee, loadViewportBgFile: ie, loadViewportBgSequence: fe, drawCameraPath: me, drawCard: ue, drawCube: be, drawGrid: O, drawHuman: H, drawLine3D: ce, drawNull: le, drawOverlays: pe, drawPointField: ne, drawSpeedHeatmap: ke, drawSphere: $t, curveChannels: Mt, drawCurveEditor: ot, onCurvePointerDown: rt, onCurvePointerMove: nt, onCurvePointerUp: st, onTimelinePointerDown: At, onTimelinePointerMove: Tt, onTimelinePointerUp: Pt, refreshKeys: it, resetCurveZoom: ct, resetTimelineZoom: He, setChannelFilter: lt, setCurveInterpolation: dt, setTangentMode: mt, timelineFrameFromEvent: It, toggleCurveHandles: pt, zoomCurve: zt, drawTransformGizmo: Ft, frameTarget: Lt, gizmoAxes: Ot, gizmoGeometry: Kt, onPointerDown: Dt, onPointerMove: Rt, onPointerUp: Nt, onWheel: qt, pickGizmo: Bt, pickSceneObject: Wt, resetCamera: ft, setTransformMode: ht, setViewMode: Vt, viewportCamera: Ht, loadCardFile: no, loadExecutionPreview: so, loadMediaUrl: Ut, loadModelFile: Gt, loadSelectedReference: Xt, onModelLoaded: Yt, restoreAssets: Zt, syncUpstreamInputs: Jt, configureDomMedia: Qt, refreshSetupDiagnostic: ut, addMediaCard: ea, addPrimitive: ta, applyObjectAnimationFrame: aa, beginCameraEdit: oa, beginObjectEdit: ra, commitCameraEdit: na, commitObjectEdit: sa, copyKeyframe: ia, deleteKeyframe: ca, deleteObject: la, duplicateObject: da, exitKeyEdit: ma, finishCameraEdit: pa, goToAdjacentKey: fa, insertKeyframe: ha, loadSelectedKeyView: ua, pasteKeyframe: ba, playblastCameraAtFrame: ga, refreshInspector: va, refreshKeyEditor: ya, refreshObjects: xa, removeObjectResources: wa, renameObject: ka, retimeSelectedKey: Sa, selectKeyframe: ja, selectedKeyframe: Ca, selectedObject: Ea, selectObjectAnimation: _a, setKeyInterpolation: $a, setObjectParent: Ma, timelineKeyframes: Aa, timelineObject: Ne, toggleAutoKey: Ta, toggleObject: Pa, updateCameraFromHud: Ia, updateEditState: za, updateKeyVisualState: Fa, updateSelectedKey: La, updateSelectedObject: Oa, clamp: bt, cloneCamera: Ka, configureCore: Da, defaultCamera: Ra, sampleCamera: Le, sampleObjectTransform: io, sanitizeState: Ue, worldTransform: je } = e;
  return {
    setSelectMode(I) {
    ...
    restoreHistorySnapshot(I) {
      ...
      const S = zr(this.state), w = new Set(this.state.objects.map((Y) => Y.id));
      ...
      this.selectedKeyFrames = new Set(L.filter((Y) => X.has(Y))), this.selectedKeyFrame = this.selectedKeyFrames.has(T.selectedKeyFrame) ? T.selectedKeyFrame : [...this.selectedKeyFrames].at(-1) ?? null, this.pathSelection = Si(this.pathSelection, this.activeCameraTrack()), this.subSelection = T.subSelection || null, this.camera = Le(this.state, this.frame), xt(this, this.activeCameraTrack(), this.camera, this.frame), this.cameraPreviewSignature = "", this.serialize(), S !== zr(this.state) && this.restoreAssets(), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
    },
    checkpoint(I) {
    ...
    openPathKeyContext(I, T, S) {
      ...
      const A = _ ? po(_) : "auto", K = this.selectedKeyFrames?.size || 0, X = this.pathSelection?.component === "target", L = Gr(w, this.state.objects);
    ...
    openCurveContext(I) {
      ...
      this.showContextMenu(I, r("Curve editor"), [
        { label: r("Fit all curves (Framing)"), icon: "pi-arrows-alt", shortcut: "F", run: () => ct(this) },
        { label: r("Set key at playhead"), icon: "pi-key", shortcut: "I", run: () => this.insertKeyframe() },
    ...
    resizeCanvas() {
      ...
      for (const K of this.cameraPreviewCanvases.values()) {
        const X = K.clientWidth || 220, L = K.clientHeight || 124, Y = Math.max(T, Lh / Math.max(1, X)), ge = Math.max(1, Math.round(X * Y)), Me = Math.max(1, Math.round(L * Y));
...
function Kh(e, t) {
  ...
  const o = Qr();
  o.position = [0, 0, 0], o.target = [0, 0, -1], a.camera = de(o), a.keyframes = [{ frame: 0, camera: de(o), interpolation: "ease" }], e.state.active_camera_id = a.id, e.state.camera = de(o), e.state.keyframes = a.keyframes, e.camera = de(o), e.frame = 0, e.selectedEntity = "camera", e.selectedObjectId = null, e.selectedKeyFrame = 0, e.editingKeyFrame = null, e.cameraEditKey = null, e.cameraEditActive = !1, e.cameraPreviewSignature = "", Gn(e), e.refreshCameraSelectors(), e.setStatus(r("{value1} animation reset", { value1: a.name }));
}
function Dh(e, t) {
  const a = e.state.objects.find((o) => o.id === t);
  a && (e.checkpoint("Reset object animation"), a.keyframes = [], a.position = [0, 0, 0], a.rotation = [0, 0, 0], e.frame = 0, e.selectedEntity = "object", e.selectedObjectId = a.id, e.selectedKeyFrame = null, e.editingKeyFrame = null, Gn(e), e.setStatus(r("{value1} animation reset", { value1: a.name || a.type })));
}
const Fr = { motion: "motion", shot: "display", health: "health" }, Rh = {
  object: "Object",
  camera: "Camera",
  camera_target: "Look-At Target",
  camera_path: "Camera Path"
}, Nh = { motion: "Motion", shot: "Shot", health: "Health" }, qh = ["entity", "motion", "shot", "health"];
function Xn(e) {
  return e.inspectorMode && e.inspectorMode !== "entity" ? e.inspectorMode : "entity";
}
function Bh(e) {
  const t = Xn(e);
  return Fr[t] ? Fr[t] : e.selectedEntity === "object" ? "scene" : "camera";
}
function Wh(e) {
  return [
    e.selectedEntity || "",
...
function Vh(e) {
  const t = Wh(e);
  e._lastInspectorSelKey !== void 0 && e._lastInspectorSelKey !== t && (e.inspectorMode = "entity"), e._lastInspectorSelKey = t, Yn(e);
}
function Yn(e) {
  const t = Bh(e);
  ...
  n && (n.textContent = o === "entity" ? r(Rh[e.selectedEntity] || "Inspector") : r(Nh[o] || "Inspector"));
}
function Hh(e, t) {
  e.inspectorMode = qh.includes(t) ? t : "entity", Yn(e), e.render?.(), e.refitNode?.();
}
function Uh(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: n, initializeTooltips: s, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: m, activeCameraTrack: p, bindWidgetCallbacks: f, playblastCameraTrack: u, restoreFromWidgets: d, serializeEditorState: h, syncActiveCameraTrack: b, syncFromWidgets: g, bindEditorEvents: y, activateCamera: v, addCamera: j, deleteCamera: x, drawPreviewOverlays: M, duplicateCamera: P, maximizeCameraPreview: D, refreshCameraPreviews: F, refreshCameraSelectors: U, renameCamera: B, setPlayblastCamera: V, toggleCameraView: Q, captureRealtime: k, makePlayblast: E, uploadDirectorPlayblast: z, waitForMediaFrame: R, computeAudioPeaks: q, loadAudioFile: $, releaseAudio: W, stopPlay: C, togglePlay: N, applyCameraPreset: G, applyCameraShake: ae, applyProxyPreset: re, clearViewportBgImage: ee, loadViewportBgFile: ie, loadViewportBgSequence: fe, drawCameraPath: me, drawCard: ue, drawCube: be, drawGrid: O, drawHuman: H, drawLine3D: ce, drawNull: le, drawOverlays: pe, drawPointField: ne, drawSpeedHeatmap: ke, drawSphere: $t, curveChannels: Mt, drawCurveEditor: ot, onCurvePointerDown: rt, onCurvePointerMove: nt, onCurvePointerUp: st, onTimelinePointerDown: At, onTimelinePointerMove: Tt, onTimelinePointerUp: Pt, refreshKeys: it, resetCurveZoom: ct, resetTimelineZoom: He, setChannelFilter: lt, setCurveInterpolation: dt, setTangentMode: mt, timelineFrameFromEvent: It, toggleCurveHandles: pt, zoomCurve: zt, drawTransformGizmo: Ft, frameTarget: Lt, gizmoAxes: Ot, gizmoGeometry: Kt, onPointerDown: Dt, onPointerMove: Rt, onPointerUp: Nt, onWheel: qt, pickGizmo: Bt, pickSceneObject: Wt, resetCamera: ft, setTransformMode: ht, setViewMode: Vt, viewportCamera: Ht, loadCardFile: no, loadExecutionPreview: so, loadMediaUrl: Ut, loadModelFile: Gt, loadSelectedReference: Xt, onModelLoaded: Yt, restoreAssets: Zt, syncUpstreamInputs: Jt, configureDomMedia: Qt, refreshSetupDiagnostic: ut, addMediaCard: ea, addPrimitive: ta, applyObjectAnimationFrame: aa, beginCameraEdit: oa, beginObjectEdit: ra, commitCameraEdit: na, commitObjectEdit: sa, copyKeyframe: ia, deleteKeyframe: ca, deleteObject: la, deleteSelectedObjects: da, duplicateObject: ma, exitKeyEdit: pa, finishCameraEdit: fa, goToAdjacentKey: ha, insertKeyframe: ua, loadSelectedKeyView: ba, pasteKeyframe: ga, playblastCameraAtFrame: va, refreshInspector: ya, refreshKeyEditor: xa, refreshObjects: wa, removeObjectResources: ka, renameObject: Sa, retimeSelectedKey: ja, selectKeyframe: Ca, selectedKeyframe: Ea, selectedObject: _a, selectObjectAnimation: $a, setKeyInterpolation: Ma, setKeyTangentMode: Aa, setObjectParent: Ne, timelineKeyframes: Ta, timelineObject: Pa, toggleAutoKey: Ia, toggleObject: za, updateCameraFromHud: Fa, updateCameraRotationFromHud: La, updateEditState: Oa, updateKeyVisualState: bt, updateSelectedKey: Ka, updateSelectedObject: Da, clamp: Ra, cloneCamera: Le, configureCore: io, defaultCamera: Ue, sampleCamera: je, sampleObjectTransform: I, sanitizeState: T, worldTransform: S } = e;
  return {
    setChannelFilter(w) {
      lt(this, w);
    },
    setFrame(w, _ = !1, A = !0) {
      this.frame = Ra(Math.round(w), 0, this.state.duration_frames - 1), this.editingKeyFrame !== this.frame && (this.editingKeyFrame = null), this.camera = je(this.activeCameraTrack(), this.frame, this.state.objects), xt(this, this.activeCameraTrack(), this.camera, this.frame), this.applyObjectAnimationFrame();
      const K = this.dom ||= xn(this.root);
      ...
      const L = Math.floor(X / 60), Y = Math.floor(X % 60), ge = Math.floor(X % 1 * 1e3), Me = this.frame % Math.max(1, Math.round(this.state.fps)), qe = Math.floor(this.frame / this.state.fps);
      if ((K.time || this.root.querySelector('[data-role="time"]')).textContent = this.state.timecode_mode === "timecode" ? `${String(Math.floor(qe / 3600)).padStart(2, "0")}:${String(Math.floor(qe / 60) % 60).padStart(2, "0")}:${String(qe % 60).padStart(2, "0")}:${String(Me).padStart(2, "0")}` : `${String(L).padStart(2, "0")}:${String(Y).padStart(2, "0")}.${String(ge).padStart(3, "0")}`, A) this.refreshKeys();
      else {
        nn(this);
    ...
    setSpatialHandleMode(w) {
      ...
      this.checkpoint(r("Camera path handle: {mode}").replace("{mode}", w)), nc(A[K], w, {
        prevKey: A[K - 1] || null,
        nextKey: A[K + 1] || null
    ...
    transformCameraPath(w) {
      ...
      const A = Xr(_.keyframes, { origin: Ur(_.keyframes), ...w });
      return _.keyframes = A, _.id === this.state.active_camera_id && (this.state.keyframes = A), this.camera = je(_, this.frame, this.state.objects), _.camera = Le(this.camera), this.serialize(), this.refreshKeys(), this.refreshInspector(), this.render(), this.renderCameraView?.(), !0;
    },
    ...
    redistributeActiveCameraTiming() {
      ...
      const _ = [...w.keyframes].sort((K, X) => K.frame - X.frame), A = ji(_, {
    ...
    async openCameraPathPresetPicker() {
      ...
      const _ = ac.map((K) => ({ id: K, label: r(ar[K] || K) })), A = await an({ title: r("Camera Path Preset"), items: _, owner: this });
    ...
    playblastCameraAtFrame() {
      return xt(this, u(this), va(this, je), this.frame);
    },
    viewportCamera() {
      return Ht(this);
    },
    ...
    lookAtObject(w) {
      ...
      if (_) {
        ...
        this.camera = je(this.state, this.frame), this.serialize(), this.refreshKeys(), this.render(), this.setStatus(`Cameras look at ${_.name || _.type}`);
      }
    },
    setTransformMode(w) {
      ht(this, w);
    ...
    refreshInspector() {
      this.perf && (this.perf.inspectorRefreshCount = (this.perf.inspectorRefreshCount || 0) + 1), ya(this), Vh(this);
    },
    setInspectorMode(w) {
      Hh(this, w);
    },
...
function Gh(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: n, initializeTooltips: s, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: m, activeCameraTrack: p, bindWidgetCallbacks: f, playblastCameraTrack: u, restoreFromWidgets: d, serializeEditorState: h, syncActiveCameraTrack: b, syncFromWidgets: g, bindEditorEvents: y, activateCamera: v, addCamera: j, deleteCamera: x, drawPreviewOverlays: M, duplicateCamera: P, maximizeCameraPreview: D, refreshCameraPreviews: F, refreshCameraSelectors: U, renameCamera: B, setPlayblastCamera: V, toggleCameraView: Q, captureRealtime: k, makePlayblast: E, uploadDirectorPlayblast: z, waitForMediaFrame: R, computeAudioPeaks: q, loadAudioFile: $, releaseAudio: W, stopPlay: C, togglePlay: N, applyCameraPreset: G, applyCameraShake: ae, applyProxyPreset: re, clearViewportBgImage: ee, loadViewportBgFile: ie, loadViewportBgSequence: fe, drawCameraPath: me, drawCard: ue, drawCube: be, drawGrid: O, drawHuman: H, drawLine3D: ce, drawNull: le, drawOverlays: pe, drawPointField: ne, drawSpeedHeatmap: ke, drawSphere: $t, curveChannels: Mt, drawCurveEditor: ot, fitCurveView: rt, onCurveDoubleClick: nt, onCurvePointerDown: st, onCurvePointerMove: At, onCurvePointerUp: Tt, onTimelinePointerDown: Pt, onTimelinePointerMove: it, onTimelinePointerUp: ct, refreshKeys: He, resetCurveZoom: lt, resetTimelineZoom: dt, setChannelFilter: mt, setCurveInterpolation: It, setTangentMode: pt, timelineFrameFromEvent: zt, toggleCurveHandles: Ft, zoomCurve: Lt, drawTransformGizmo: Ot, frameTarget: Kt, gizmoAxes: Dt, gizmoGeometry: Rt, onPointerDown: Nt, onPointerMove: qt, onPointerUp: Bt, onWheel: Wt, pickGizmo: ft, pickSceneObject: ht, resetCamera: Vt, setTransformMode: Ht, setViewMode: no, viewportCamera: so, loadCardFile: Ut, loadExecutionPreview: Gt, loadMediaUrl: Xt, loadModelFile: Yt, loadSelectedReference: Zt, onModelLoaded: Jt, restoreAssets: Qt, syncUpstreamInputs: ut, configureDomMedia: ea, refreshSetupDiagnostic: ta, addMediaCard: aa, addPrimitive: oa, applyObjectAnimationFrame: ra, beginCameraEdit: na, beginObjectEdit: sa, commitCameraEdit: ia, commitObjectEdit: ca, copyKeyframe: la, deleteKeyframe: da, deleteObject: ma, duplicateObject: pa, exitKeyEdit: fa, finishCameraEdit: ha, goToAdjacentKey: ua, insertKeyframe: ba, loadSelectedKeyView: ga, pasteKeyframe: va, playblastCameraAtFrame: ya, refreshInspector: xa, refreshKeyEditor: wa, refreshObjects: ka, removeObjectResources: Sa, renameObject: ja, retimeSelectedKey: Ca, selectKeyframe: Ea, selectedKeyframe: _a, selectedObject: $a, selectObjectAnimation: Ma, setKeyInterpolation: Aa, setObjectParent: Ne, timelineKeyframes: Ta, timelineObject: Pa, toggleAutoKey: Ia, toggleObject: za, updateCameraFromHud: Fa, updateEditState: La, updateKeyVisualState: Oa, updateSelectedKey: bt, updateSelectedObject: Ka, clamp: Da, cloneCamera: Ra, configureCore: Le, defaultCamera: io, sampleCamera: Ue, sampleObjectTransform: je, sanitizeState: I, worldTransform: T } = e;
  return {
    setTargetAtCursor(S) {
      if (!S) return;
...
function Yh(e) {
  const { right: t, up: a, forward: o } = _i(e || {});
  return Xh.map((n) => {
...
const Qh = "http://www.w3.org/2000/svg", Ye = 26, Lr = 17, eu = 5.4;
function Ze(e, t) {
  const a = document.createElementNS(Qh, e);
...
function tu(e) {
  ...
  for (const s of Zh(Yh(a))) {
    const i = Ye + s.x * Lr, c = Ye + s.y * Lr, l = Jh(s.depth);
...
function ou(e) {
  ...
  for (const n of e.state.motion_layers || []) {
    ...
    const s = au(e.state, n, e.frame, a, o);
    if (s.length) {
...
const ru = ["world_point", "object_point", "camera_field"], Zn = {
  manual_2d: "DRAW",
  object_point: "OBJECT",
  world_point: "WORLD",
...
function lu(e) {
  ...
  s("motion-sel-name", a.label), s("motion-sel-type", Zn[a.source_kind] || "TRACK"), s("motion-sel-binding", nu(e.state, a)), s("motion-sel-start", n.length ? Math.min(...n) : 0), s("motion-sel-end", n.length ? Math.max(...n) : 0);
...
function pu(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: n, initializeTooltips: s, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: m, activeCameraTrack: p, bindWidgetCallbacks: f, playblastCameraTrack: u, restoreFromWidgets: d, serializeEditorState: h, syncActiveCameraTrack: b, syncFromWidgets: g, bindEditorEvents: y, activateCamera: v, addCamera: j, deleteCamera: x, drawPreviewOverlays: M, duplicateCamera: P, maximizeCameraPreview: D, refreshCameraPreviews: F, refreshCameraSelectors: U, renameCamera: B, setPlayblastCamera: V, toggleCameraView: Q, captureRealtime: k, makePlayblast: E, uploadDirectorPlayblast: z, waitForMediaFrame: R, computeAudioPeaks: q, loadAudioFile: $, releaseAudio: W, stopPlay: C, togglePlay: N, applyCameraPreset: G, applyCameraShake: ae, applyProxyPreset: re, clearViewportBgImage: ee, loadViewportBgFile: ie, loadViewportBgSequence: fe, drawCameraPath: me, drawCard: ue, drawCube: be, drawCylinder: O, drawGrid: H, drawHuman: ce, drawLine3D: le, drawNull: pe, drawOverlays: ne, drawPointField: ke, drawSpeedHeatmap: $t, drawSphere: Mt, drawTorus: ot, curveChannels: rt, drawCurveEditor: nt, onCurvePointerDown: st, onCurvePointerMove: At, onCurvePointerUp: Tt, onTimelinePointerDown: Pt, onTimelinePointerMove: it, onTimelinePointerUp: ct, refreshKeys: He, resetCurveZoom: lt, resetTimelineZoom: dt, setChannelFilter: mt, setCurveInterpolation: It, setTangentMode: pt, timelineFrameFromEvent: zt, toggleCurveHandles: Ft, zoomCurve: Lt, drawTransformGizmo: Ot, frameTarget: Kt, gizmoAxes: Dt, gizmoGeometry: Rt, onPointerDown: Nt, onPointerMove: qt, onPointerUp: Bt, onWheel: Wt, pickGizmo: ft, pickSceneObject: ht, resetCamera: Vt, setTransformMode: Ht, setViewMode: no, viewportCamera: so, loadCardFile: Ut, loadExecutionPreview: Gt, loadMediaUrl: Xt, loadModelFile: Yt, loadSelectedReference: Zt, onModelLoaded: Jt, restoreAssets: Qt, syncUpstreamInputs: ut, configureDomMedia: ea, refreshSetupDiagnostic: ta, addMediaCard: aa, addPrimitive: oa, applyObjectAnimationFrame: ra, beginCameraEdit: na, beginObjectEdit: sa, commitCameraEdit: ia, commitObjectEdit: ca, copyKeyframe: la, deleteKeyframe: da, deleteObject: ma, duplicateObject: pa, exitKeyEdit: fa, finishCameraEdit: ha, goToAdjacentKey: ua, insertKeyframe: ba, loadSelectedKeyView: ga, pasteKeyframe: va, playblastCameraAtFrame: ya, refreshInspector: xa, refreshKeyEditor: wa, refreshObjects: ka, removeObjectResources: Sa, renameObject: ja, retimeSelectedKey: Ca, selectKeyframe: Ea, selectedKeyframe: _a, selectedObject: $a, selectObjectAnimation: Ma, setKeyInterpolation: Aa, setObjectParent: Ne, timelineKeyframes: Ta, timelineObject: Pa, toggleAutoKey: Ia, toggleObject: za, updateCameraFromHud: Fa, updateEditState: La, updateKeyVisualState: Oa, updateSelectedKey: bt, updateSelectedObject: Ka, clamp: Da, cloneCamera: Ra, configureCore: Le, defaultCamera: io, sampleCamera: Ue, sampleObjectTransform: je, sanitizeState: I, worldTransform: T } = e;
  return {
    ...
    renderViewportOnly() {
      ...
      if (this.webgl) {
        try {
          const te = this.recording ? 1 : this.webgl.supersampleFactor?.() ?? 1, Oe = te > 1 ? Math.min(te, 4096 / Math.max(1, w, _)) : 1, Na = Oe > 1 ? Math.round(w * Oe) : w, co = Oe > 1 ? Math.round(_ * Oe) : _;
          this.webgl.activeCamera && this.transformControlsWiring?.sync(), this.webgl.render(qe, K, this.cardMediaById, Na, co, this.modelUrlsById, this.frame, this.recording, this.selectedEntity, this.selectedObjectId, this.subSelection, this.selectedKeyFrame ?? null, this.selectedKeyFrames ? [...this.selectedKeyFrames] : null, this.recording && this.state.guide_capture_style || "auto"), S.imageSmoothingEnabled = !0, S.imageSmoothingQuality = "high", Na !== w || co !== _ ? S.drawImage(this.webgl.canvas, 0, 0, Na, co, 0, 0, w, _) : S.drawImage(this.webgl.canvas, 0, 0, w, _), J = !0;
        } catch (te) {
      ...
      !this.recording && this.state.speed_heatmap && this.drawSpeedHeatmap(), !this.recording && gp(this), this.drawOverlays(), ou(this), this.state.show_gizmo && tu(this), this.labelOverlay?.update(), this.rigOverlay?.update(), this.perf && (this.perf.viewportRenderCount = (this.perf.viewportRenderCount || 0) + 1);
    },
    ...
    requestUiUpdate(S = Ce.viewport, w = "unknown") {
      (this.renderReasons ||= /* @__PURE__ */ new Set()).add(w), this.uiDirtyMask = sc(this.uiDirtyMask, S), this.renderInvalidations = (this.renderInvalidations || 0) + 1, !this.renderScheduled && (this.renderScheduled = !0, this.renderFrame = requestAnimationFrame(() => {
        if (this.renderScheduled = !1, this.disposed) return;
        const _ = this.uiDirtyMask || Ce.viewport;
        this.uiDirtyMask = 0, this.lastRenderReasons = [...this.renderReasons || []], this.renderReasons?.clear(), this.rendersCoalesced = (this.rendersCoalesced || 0) + 1, this.perf && (this.perf.renderCount = (this.perf.renderCount || 0) + 1), Ge(_, Ce.outliner) && this.refreshObjects(), Ge(_, Ce.timeline) && this.refreshKeys(), Ge(_, Ce.inspector) && this.refreshInspector(), Ge(_, Ce.viewport) && this.renderViewportOnly(), Ge(_, Ce.previews) && this.renderCameraView(), Ge(_, Ce.motion) && this.renderMotionUiOnly();
      }));
    },
    renderCameraView() {
      if (this.perf && (this.perf.previewRenderCount = (this.perf.previewRenderCount || 0) + 1), this.state.camera_view_visible) {
        ...
        for (const K of w) {
          ...
          if (Me && (Me.textContent = `F${this.frame}`), _ && K.id !== this.state.active_camera_id && K !== A) continue;
          const qe = xt(this, K, Ue(K, this.frame, this.state.objects), this.frame);
          if (L.fillStyle = "#111", L.fillRect(0, 0, Y, ge), this.cameraWebgl)
            try {
              this.cameraWebgl.render({ ...this.state, keyframes: [], playblast_grid: !1, viewport_bg_image: this.viewportBgImage?.src || "", viewport_bg_sequence: (this.viewportBgSequenceImages || []).map((J) => J.src), __omnicamRevision: this.renderRevision || 0 }, qe, this.cardMediaById, Y, ge, this.modelUrlsById, this.frame, !0), L.drawImage(this.cameraWebgl.canvas, 0, 0, Y, ge);
            } catch (J) {
    ...
    dispose() {
      this.disposed || (this.disposed = !0, this.agentBridge?.dispose?.(), this.transformControlsWiring?.dispose(), $i(this), Mi(), Ec(this), this.backgroundRequestId = (this.backgroundRequestId || 0) + 1, this.upstreamSyncId = (this.upstreamSyncId || 0) + 1, this.stopPlay(), clearTimeout(this.previewClickTimer), clearTimeout(this.connectionTimer), cancelAnimationFrame(this.restoreFrame), cancelAnimationFrame(this.serializeFrame), cancelAnimationFrame(this.resizeFrame), cancelAnimationFrame(this.renderFrame), this.abortController?.abort(), this.upstreamFetchController?.abort(), this.resizeObserver?.disconnect(), this.contextMenu?.dispose(), this.webgl?.dispose(), this.cameraWebgl?.dispose(), W(this), Wp(this), this.objectUrls.clear(), this.cardMediaById.clear(), this.cardMediaAssetById?.clear?.(), this.modelUrlsById.clear(), this.modelInfoById.clear());
    }
  };
}
const fu = 0.12;
function hu() {
  return {
    ...
    deleteSelectedKeyframes() {
      ...
      const t = this._activeTrack(), a = xe(this), o = t.kind === "camera" ? 1 : 0, { keys: n, removed: s } = dc(a, e, { minKeys: o });
    ...
    nudgeSelectedKeyframes(e) {
      ...
      const a = this._activeTrack(), o = Math.max(0, this.state.duration_frames - 1), n = lc(xe(this), t, e, { lastFrame: o });
    ...
    setSelectedKeysInterpolation(e) {
      ...
      this.checkpoint(r("Interpolation on {n} keys").replace("{n}", t.length)), a.write(cc(xe(this), t, e)), this.serialize(), this.refreshKeys(), this.refreshKeyEditor(), this.render(), this.drawCurveEditor(), this.setStatus(r("{mode} interpolation on {n} keys").replace("{mode}", e.replace(/_/g, " ")).replace("{n}", t.length));
    },
    setSelectedKeysTangentMode(e) {
      const t = this.resolveSelectedFrames();
      if (t.length < 2) return this.setTangentMode(e);
      const a = this._activeTrack(), o = tt(this).map((n) => n.id);
      this.checkpoint(r("Tangents on {n} keys").replace("{n}", t.length)), a.write(ic(xe(this), t, e, o)), this.serialize(), this.refreshKeys(), this.render(), this.drawCurveEditor(), this.setStatus(r("{mode} tangents on {n} keys").replace("{mode}", e).replace("{n}", t.length));
    },
    /**
    ...
    simplifyActiveKeys({ mode: e = "simplify", tolerance: t = 0, target: a = 0, scope: o = "camera", fromKeys: n = null, silent: s = !1 } = {}) {
      ...
      const l = this.resolveSelectedFrames(), m = o !== "all_cameras" && l.length >= 2 ? [l[0], l.at(-1)] : null, p = m ? [] : l, f = (h) => {
        ...
        let M = j, P = 0;
        if (j.length > 2) {
          const D = e === "reduce" ? mc(j, i, { target: a || Math.ceil(j.length / 2), keepFrames: p }) : e === "clean" ? pc(j, i, { keepFrames: p }) : fc(j, i, { tolerance: t * fu, keepFrames: p });
      ...
      return Co(this), this.selectedKeyFrame = null, this.selectedKeyFrames = /* @__PURE__ */ new Set(), this.camera = we(this.state, this.frame), this.applyObjectAnimationFrame(), this.serialize(), this.refreshKeys(), this.setFrame(this.frame, !1, !1), this.render(), s || this.setStatus(u ? r("Removed {n} keyframes").replace("{n}", u) : r("No keyframes to remove")), u;
    },
...
class Xo {
  ...
  constructor(t) {
    this.runtime = t;
    const a = t.node;
    this.disposed = !1, this.app = Or, this.api = Ve, this.node = a, this.root = vn(), this.root.tabIndex = -1, this.dom = xn(this.root), this.canvas = this.root.querySelector(".viewport-wrap > canvas"), this.cameraPreviewCanvases = /* @__PURE__ */ new Map(), this.cameraPreviewContexts = /* @__PURE__ */ new Map(), this.cameraPreviewSignature = "", this.interactionElement = this.canvas, this.interactionElement.tabIndex = 0, this.interactionElement.dataset.captureWheel = "true", this.ctx = this.canvas.getContext("2d", { alpha: !1 }), this.webgl = null, this.cameraWebgl = null, this.webglReady = this.loadWebGLViewports(), this.transformControlsWiring = Yd(this), this.camera = we(this.state, this.frame), this.playing = !1, this.drag = null, this.cameraEditActive = !1, this.cameraEditKey = null, this.keyDrag = null, this.timelineDrag = null, this.curveDrag = null, this.selectedKeyFrame = this.state.keyframes[0]?.frame ?? null, this.pathSelection = Ti(), this.editingKeyFrame = null, this.copiedKeyframe = null, this.cameraSpeed = 1, this.cardMedia = null, this.cardMediaById = /* @__PURE__ */ new Map(), this.cardMediaAssetById = /* @__PURE__ */ new Map(), this.objectUrls = new gn(), this.cardUrlsById = this.objectUrls.urls, this.modelUrlsById = /* @__PURE__ */ new Map(), this.modelInfoById = /* @__PURE__ */ new Map(), this.executionReferences = [], this.selectedObjectId = null, this.selectedEntity = "camera", this.subSelection = null, this.cardUrl = null, this.recording = !1, this.gizmoDrag = null, this.playTimer = null, this.previewClickTimer = null, this.showCurveHandles = !0, this.uiDirtyMask = 0, this.perf = globalThis.__omnicamPerf === !0 ? { renderCount: 0, viewportRenderCount: 0, previewRenderCount: 0, timelineRefreshCount: 0, inspectorRefreshCount: 0, lastFrameMs: 0 } : null, this.contextMenu = new on(this.root), this.refreshCameraPreviews(), this.initializeTooltips(), this.bindEditorEvents(), this.bindWidgetCallbacks(), this.syncFromWidgets(), this.resizeCanvas(), this.render(), this.refreshKeys(), this.refreshObjects(), this.restoreAssets(), this.syncUpstreamInputs(), this.refreshSetupDiagnostic(), // Seed every frame-derived readout (timecode, lens millimetres, viewport
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-TG5fMMYR.js"));
    } catch (a) {
    ...
    if (!this.disposed) {
      ...
      Pi(this), this.resizeCanvas(), this.render(), this.renderCameraView();
    }
  }
}
const uu = [
...
for (const e of uu)
  Object.defineProperty(Xo.prototype, e, {
    configurable: !0,
    enumerable: !0,
    get() {
...
const Ua = { app: Or, api: Ve, EditorHistory: hc, ContextMenuController: on, initializeTooltips: _c, promptText: St, ObjectUrlRegistry: gn, buildRoot: vn, dispatchDirectorKey: Ii, activeCameraTrack: jo, bindWidgetCallbacks: Hc, playblastCameraTrack: rn, restoreFromWidgets: Uc, serializeEditorState: Gc, syncActiveCameraTrack: Co, syncFromWidgets: Xc, bindEditorEvents: Tp, activateCamera: $c, addCamera: Mc, deleteCamera: Ac, drawPreviewOverlays: Tc, duplicateCamera: Pc, maximizeCameraPreview: Ic, refreshCameraPreviews: zc, refreshCameraSelectors: Fc, renameCamera: Lc, setPlayblastCamera: Oc, toggleCameraView: Kc, captureRealtime: On, makePlayblast: nf, uploadDirectorPlayblast: Kn, waitForMediaFrame: Ln, computeAudioPeaks: Tn, loadAudioFile: Np, releaseAudio: eo, stopPlay: Ya, togglePlay: Kp, applyCameraPreset: Zd, applyCameraShake: Jd, applyProxyPreset: Qd, clearViewportBgImage: df, loadViewportBgFile: cf, loadViewportBgSequence: lf, drawCameraPath: jf, drawCard: Sf, drawCube: gf, drawCylinder: xf, drawGrid: ff, drawHuman: yf, drawLine3D: se, drawNull: kf, drawOverlays: Ef, drawPointField: bf, drawSpeedHeatmap: Cf, drawSphere: vf, drawTorus: wf, curveChannels: tt, drawCurveEditor: jl, fitCurveView: pn, onCurveDoubleClick: kl, onCurvePointerDown: fl, onCurvePointerMove: hl, onCurvePointerUp: ul, onTimelinePointerDown: zi, onTimelinePointerMove: Fi, onTimelinePointerUp: Li, refreshKeys: Fl, resetCurveZoom: Sl, resetTimelineZoom: Oi, setChannelFilter: gl, setCurveInterpolation: bl, setTangentMode: vl, timelineFrameFromEvent: Ao, toggleCurveHandles: yl, zoomCurve: wl, drawTransformGizmo: Ki, frameTarget: Di, gizmoAxes: Ri, gizmoGeometry: Ni, onPointerDown: qi, onPointerMove: Bi, onPointerUp: Wi, onWheel: Vi, pickGizmo: Hi, pickSceneObject: Ui, resetCamera: Gi, setTransformMode: Xi, setViewMode: Yi, viewportCamera: Zi, loadCardFile: Xp, loadExecutionPreview: Yp, loadMediaUrl: Fn, loadModelFile: Gp, loadSelectedReference: Zp, onModelLoaded: Up, restoreAssets: Hp, syncUpstreamInputs: Jp, configureDomMedia: Pn, refreshSetupDiagnostic: Mf, addMediaCard: Zf, addPrimitive: Uf, applyObjectAnimationFrame: fh, beginCameraEdit: xh, beginObjectEdit: Vn, commitCameraEdit: wh, commitObjectEdit: eh, copyKeyframe: gh, deleteKeyframe: bh, deleteObject: Wn, deleteSelectedObjects: Yf, duplicateObject: Bn, exitKeyEdit: Sh, finishCameraEdit: kh, goToAdjacentKey: zh, insertKeyframe: hh, loadSelectedKeyView: Ih, pasteKeyframe: vh, playblastCameraAtFrame: ph, refreshInspector: Jf, refreshKeyEditor: Ah, refreshObjects: qn, removeObjectResources: sh, renameObject: Gf, retimeSelectedKey: Th, selectKeyframe: yh, selectedKeyframe: Fe, selectedObject: _t, selectObjectAnimation: nh, setKeyInterpolation: uh, setKeyTangentMode: $h, setObjectParent: rh, timelineKeyframes: xe, timelineObject: Se, toggleAutoKey: jh, toggleObject: Xf, updateCameraFromHud: oh, updateCameraRotationFromHud: ah, updateEditState: Eh, updateKeyVisualState: _h, updateSelectedKey: Ph, updateSelectedObject: Qf, clamp: Z, cloneCamera: de, configureCore: en, defaultCamera: Qr, sampleCamera: we, sampleObjectTransform: oo, sanitizeState: Ji, worldTransform: Po };
Object.assign(
  Xo.prototype,
  Oh(Ua),
  Uh(Ua),
...
function bu(e) {
  ...
  const a = new Xo(e);
  xo("director:workbench:constructor:complete", t), e.attachWorkbench(a), t.__majoorOmniCam = a, Ai(a);
  try {
    a.assetBrowser = Ld(a, {
      ...
      onAgentFirstOpen: async () => {
        if (wo())
          try {
            const { createDirectorAgentPanel: o } = await import("./chunk-CDswgh9q.js");
            a.agentPanel = o(a);
          } catch (o) {
  ...
  try {
    a.characterRuntime = Kd(a), a.rigMapper = Rd(a), a.poseEditor = Bd(a), a.motionEditor = Wd(a);
  } catch (o) {
...
const Iu = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  closeDirectorWorkbench: gu,
  openDirectorWorkbench: bu
