...
ae.registerExtension({
  ...
  async nodeCreated(e) {
    ...
    await Dt(e, async () => {
      ...
      const { attachDirectorShell: o } = await import("./chunk-Buag80v-.js").then((n) => n.o);
...
ae.registerExtension({
  ...
  async nodeCreated(e) {
    if (Ye(e) !== mt) return;
    const t = !ce, a = t ? null : Et(e);
    await Dt(e, async () => (await import("./chunk-IFHqJi9m.js")).attachExtractor), e.__majoorOmniCamExtractorRuntime && jt(e, mt, t, a?.());
  }
});
ae.registerExtension({
  ...
  async nodeCreated(e) {
    if (Ye(e) !== ut) return;
    const t = !ce, a = t ? null : Et(e);
    await Dt(e, async () => (await import("./chunk--lUb2uCT.js")).attachMonitor), e.__majoorOmniCamMonitor && jt(e, ut, t, a?.());
  }
});
export {
  Ms as $,
