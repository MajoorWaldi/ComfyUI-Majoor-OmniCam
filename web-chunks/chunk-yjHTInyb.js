...
ae.registerExtension({
  ...
  async nodeCreated(e) {
    ...
    await Tt(e, async () => {
      ...
      const { attachDirectorShell: o } = await import("./chunk-CnsE-RVk.js").then((n) => n.o);
...
ae.registerExtension({
  ...
  async nodeCreated(e) {
    if (Ye(e) !== mt) return;
    const t = !ce, a = t ? null : Et(e);
    await Tt(e, async () => (await import("./chunk-BaylDYv6.js").then((r) => r.g)).attachExtractorShell), e.__majoorOmniCamExtractorRuntime && jt(e, mt, t, a?.());
  }
});
ae.registerExtension({
  ...
  async nodeCreated(e) {
    if (Ye(e) !== ut) return;
    const t = !ce, a = t ? null : Et(e);
    await Tt(e, async () => (await import("./chunk-AcjVXeSD.js").then((r) => r.s)).attachMonitorShell), !(!e.__majoorOmniCamMonitorShell && !e.__majoorOmniCamMonitor) && jt(e, ut, t, a?.());
  }
});
export {
  Fe as $,
