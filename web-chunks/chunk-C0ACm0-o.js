...
import { s as $e, c as Z, t as he, a as s, o as Un, b as xr, d as He, e as ce, f as Fo, r as mi, g as wr, h as Wn, i as pi, j as fi, k as hi, l as ui, m as kr, n as Sr, I as jo, D as bi, p as jr, q as gi, w as yi, u as Ao, v as Vn, x as vi, y as _r, z as or, A as Hr, B as Hn, C as rr, E as Gn, F as Yn, G as Xn, H as Jn, J as nr, K as Vo, L as Gr, O as Yr, R as Zn, M as xi, N as wi, P as ki, Q as Si, S as ji, T as Ce, U as Qn, V as Xr, W as Ut, X as _i, Y as es, Z as Ci, _ as Cr, $ as Ei, a0 as Ai, a1 as Ti, a2 as $i, a3 as Mi, a4 as Er, a5 as Ii, a6 as Oi, a7 as Pi, a8 as Li, a9 as zi, aa as Ni, ab as Fi, ac as Ri, ad as Di, ae as Ki, af as Bi, ag as qi, ah as Ui, ai as Wi, aj as Vi, ak as Hi, al as Gi, am as Yi, an as Xi, ao as Ji, ap as Zi, aq as Qi, ar as ec, as as tc, at as ac, au as oc, av as rc, aw as nc, ax as sc, ay as ic, az as cc, aA as lc, aB as dc, aC as mc, aD as pc, aE as fc, aF as hc, aG as uc, aH as bc, aI as gc, aJ as yc, aK as vc, aL as xc, aM as ts, aN as wc, aO as Ho, aP as kc, aQ as Sc, aR as jc, aS as _c, aT as Cc, aU as Ve, aV as Ec, aW as as, aX as Ar, aY as Ac, aZ as Tc, a_ as $c, a$ as os, b0 as Ze, b1 as Mc, b2 as Jr, b3 as Tr, b4 as Ic, b5 as Oc, b6 as Pc, b7 as Lc, b8 as zc, b9 as Nc, ba as Fc, bb as Rc, bc as rs, bd as Dc, be as Kc, bf as Bc, bg as qc, bh as Uc, bi as Wc, bj as Vc, bk as Hc, bl as Gc, bm as Yc, bn as Xc, bo as Jc, bp as Zc, bq as Qc, br as el, bs as tl, bt as al, bu as ol, bv as rl } from "./chunk-DbT8L9qU.js";
import { L as nl, a as sl, p as Yt, f as $r, b as il, S as cl, c as Zr, d as ll, e as dl, r as ml, g as pl, n as fl, C as Qr, h as Xt, o as hl, i as ul, s as bl, j as gl, k as ns, l as yl, m as sr, q as ir, w as vl, t as ss, u as xl, v as wl, x as kl, y as Sl, z as jl, A as _l, B as Cl, D as El, E as Al, F as Tl, G as $l, H as Ml, I as Il, J as Ol, K as Pl, M as Ll } from "./chunk-GSMs80i7.js";
import { S as zl, b as Nl, p as Fl, m as Rl, l as Dl, u as Kl } from "./chunk-BOI_2OKd.js";
import { T as Bl } from "./chunk-__IQ4xkd.js";
import { T as ql, R as Ul } from "./vendor-three-BQUrLQkn.js";
function Ft(e, t = 0) {
...
function Wl(e, { type: t = "handheld_subtle", intensity: a = 1, duration_frames: o = null, subdivide: r = !0 } = {}) {
  ...
  return [...g].sort((y, x) => y - x).map((y) => {
    const x = $e(b, y), k = Ft(y * m, 1) * l, u = Ft(y * m, 2) * l, j = Ft(y * m, 3) * l * 0.5, _ = Ft(y * m, 4) * p, N = Ft(y * m, 5) * (p * 0.35), M = [...x.position], Y = [...x.target];
    return M[0] += k, M[1] += u, M[2] += j, Y[0] += k * 0.35, Y[1] += u * 0.35, {
      ...
      camera: {
        ...
        target: Y,
        roll: (x.roll || 0) + _,
        fov: Z((x.fov || 35) + N, 10, 140)
      },
      interpolation: "smooth"
    };
  });
}
function Vl(e, { duration_frames: t = 120, target: a = [0, 1.5, 0], radius: o = 6, height: r = 3.5 } = {}) {
...
const is = 1e-4;
function Hl(e, t) {
  return !Array.isArray(e) || !Array.isArray(t) ? e !== t : e.some((a, o) => Math.abs(Number(a) - Number(t[o])) > is);
}
function en(e, t) {
  return Math.abs(Number(e) - Number(t)) > is;
}
const cs = [
  {
    id: "camera",
  ...
  },
  {
    ...
    label: "Look At",
    color: "#f0a742",
    changed: (e, t) => Hl(e?.target, t?.target),
    read: (e) => e?.target
  },
  {
    id: "focal_length",
...
function Yl(e, t = null) {
  return cs.filter((a) => !t || t.has(a.id)).map((a) => ({
    id: a.id,
    label: a.label,
    color: a.color,
    frames: Gl(e, a)
...
function To(e) {
  ...
  for (const a of [".oc-playhead-head", '[data-role="dope-playhead"]', ".oc-gdope-playhead", ".oc-sequence-playhead"])
    for (const o of e.root.querySelectorAll(a)) Xl(o, t);
}
function Jl(e, t, a) {
...
function ls(e) {
  ...
  a.delete("camera");
  const o = e.timelineKeyframes() || [], r = Yl(o, a), n = Ql(e, r);
  if (t.dataset.signature !== n) {
    t.dataset.signature = n, t.replaceChildren();
    const i = (c) => he(e, c);
    for (const c of r) {
      const l = document.createElement("div");
      l.className = "oc-dope-row", l.dataset.channel = c.id, l.style.setProperty("--channel-color", c.color), Jl(l, c.frames, i), Zl(e, l, c, o, i), t.appendChild(l);
    }
  }
...
const Go = [1, 2, 5, 10, 20, 25, 50, 100, 200, 250, 500, 1e3, 2e3, 5e3], ds = 46, tn = 5, ms = 640;
function ps(e, t) {
  const a = t > 0 ? t : ms, o = Math.max(2, Math.floor(a / ds)), r = Math.max(1e-6, e / o);
  return Go.find((n) => n >= r) ?? Go[Go.length - 1];
}
function ed(e, t) {
  const a = Math.max(1, e.state.duration_frames - 1), o = Z(Number(e.timelineZoom) || 1, 0.1, 50), r = Number(e.timelinePan) || 0, n = a / o, i = ps(n, t), l = (i >= tn ? i / tn : 0) || i, p = [], m = Math.max(0, Math.floor(r / l) * l);
...
function td(e) {
  return e.clientWidth || e.parentElement?.clientWidth || ms;
}
function fs(e) {
  const t = e.root.querySelector('[data-role="ruler"]');
  if (!t) return;
  t.replaceChildren();
  for (const o of ed(e, td(t))) {
...
function id(e, { left: t, right: a, top: o, width: r, graphHeight: n, minimum: i, maximum: c, yFor: l }) {
  const p = rd(c - i, 4);
  e.strokeStyle = "#222228", e.lineWidth = 1, e.fillStyle = "#6e727a";
  for (let m = Math.ceil(i / p) * p; m <= c; m += p) {
    const f = l(m);
    f < o - 1 || f > o + n + 1 || (e.beginPath(), e.moveTo(t, f), e.lineTo(r - a, f), e.stroke(), e.fillText(nd(m, p), 4, f + 3));
  }
}
function Mr(e, t) {
...
function ld(e, t) {
  ...
  if (!e.curveDrag || t.pointerId !== e.curveDrag.pointerId) {
    const f = (e.curveHitPoints || []).map((x) => ({ point: x, distance: Math.hypot(o - x.x, r - x.y) })).sort((x, k) => x.distance - k.distance)[0], d = Math.max(1, e.state.duration_frames - 1), h = d / (Number(e.curveZoomX) || 1), b = Number(e.curvePanX) || 0, g = Math.max(1, a.clientWidth - 58), v = Z(Math.round(b + (o - 44) / g * h), 0, d);
    let y = null;
    if (f && f.distance <= 14) {
  ...
  if (e.curveHover = null, t.preventDefault(), t.stopPropagation(), e.curveDrag.historyCheckpointed || (e.checkpoint?.(e.curveDrag.handle ? "Edit curve tangent" : "Edit curve"), e.curveDrag.historyCheckpointed = !0), e.curveDrag.handle) {
    ...
    if (h === "in") {
      if (u.in_x = Z((o - v) / Math.max(1, b), -0.99, -0.01), u.in_y = (y - r) * g, k === "aligned") {
    ...
    } else if (u.out_x = Z((o - v) / Math.max(1, b), 0.01, 0.99), u.out_y = (y - r) * g, k === "aligned") {
    ...
    f.tangents.channels[d.id] = u, e.scheduleSerialize(), e.camera = $e(e.state, e.frame), e.applyObjectAnimationFrame(), e.render(), e.drawCurveEditor();
    return;
  }
  ...
  if (e.curveDrag.group) {
    ...
    if (d) {
      const b = e.curveDrag.group.map((v) => Z(Math.round(v.startFrame + d), 0, e.curveDrag.lastFrame));
...
function hs(e, { selectedOnly: t = !1 } = {}) {
  const a = Math.max(1, (e.state?.duration_frames ?? 120) - 1), o = e.timelineKeyframes() || [], r = e.timelineObject(), n = mt(e), i = e.selectedKeyFrames?.size ? [...e.selectedKeyFrames] : e.selectedKeyFrame != null ? [e.selectedKeyFrame] : [], c = i.length > 0, l = t || c && i.length < o.length ? o.filter((g) => i.includes(g.frame)) : o;
  if (!l.length) {
  ...
  if (h.length > 0) {
    const g = Math.min(...h), v = Math.max(...h), y = Math.max(1e-4, v - g), x = (g + v) / 2, k = (V) => r ? Fo(r, V) : $e(e.state, V), u = [], j = Math.max(1, Math.floor(a / 40));
    for (let V = 0; V <= a; V += j) {
      const ne = k(V);
      for (const C of n) {
        const R = C.get(ne);
    ...
    if (l.length < o.length && y < Y * 0.75) {
      const V = y * 1.35;
      e.curveZoom = Z(Y / V, 0.2, 30), e.curvePanY = x - U;
    } else
...
function vd(e) {
  ...
  const i = e.timelineObject(), c = e.timelineKeyframes(), l = mt(e), p = 44, m = 14, f = 16, d = 22, h = Math.max(1, a - p - m), b = Math.max(1, o - f - d), g = Math.max(1, e.state.duration_frames - 1), v = Z(Number(e.curveZoomX) || 1, 0.1, 50), y = Number(e.curvePanX) || 0, x = g / v, k = y, u = y + x, j = [], _ = Math.max(1, Math.ceil(x / Math.max(80, h))), N = (E) => i ? Fo(i, E) : $e(e.state, E);
  ...
  const V = (U - Y) * 0.1;
  Y -= V, U += V;
  const ne = Z(Number(e.curveZoom) || 1, 0.1, 50), C = (U + Y) / 2 + (Number(e.curvePanY) || 0), R = (U - Y) / ne;
  Y = C - R / 2, U = C + R / 2;
  ...
  if (n.fillStyle = "#111114", n.fillRect(0, 0, a, o), n.strokeStyle = "#222228", n.lineWidth = 1, n.font = "9px system-ui, -apple-system, sans-serif", n.fillStyle = "#6e727a", sd(n, {
    ...
    xFor: W,
    frame: e.frame
  }), id(n, { left: p, right: m, top: f, width: a, graphHeight: b, minimum: Y, maximum: U, yFor: X }), Y <= 0 && U >= 0) {
    const E = X(0);
  ...
  for (const E of l) {
    ...
    let H = !1;
    j.forEach((F) => {
      const G = W(F.frame), Q = X(E.get(F.value));
      G >= p - 50 && G <= a - m + 50 && (H ? n.lineTo(G, Q) : (n.moveTo(G, Q), H = !0));
    }), n.stroke();
    for (const F of c) {
      const G = i ? F.transform : F.camera, Q = W(F.frame), le = X(E.get(G)), se = F.frame === e.selectedKeyFrame || e.selectedKeyFrames?.has(F.frame);
    ...
    if (e.showCurveHandles)
      for (let F = 0; F < c.length; F++) {
        const G = c[F], Q = G.frame === e.selectedKeyFrame || e.selectedKeyFrames?.has(G.frame);
        if (!(Q || e.curveChannelFilter !== "all" || c.length <= 4) || G.interpolation !== "bezier") continue;
        const se = i ? G.transform || i : G.camera || G, oe = W(G.frame), de = X(E.get(se)), be = c[F - 1], fe = c[F + 1], ge = Math.max(1, G.frame - (be?.frame ?? G.frame - 1)), ye = Math.max(1, (fe?.frame ?? G.frame + 1) - G.frame), pe = mi(
          G,
          E.id,
          be,
          fe,
          (P) => E.get(i ? P.transform || i : P.camera || G)
        ), Me = (U - Y) / Math.max(1, b), ve = h * ye / Math.max(1, x), xe = h * ge / Math.max(1, x), ue = [];
        (be || F > 0) && ue.push({ side: "in", x: oe + pe.in_x * xe, y: de - pe.in_y / Me }), (fe || F < c.length - 1 || c.length === 1) && ue.push({ side: "out", x: oe + pe.out_x * ve, y: de - pe.out_y / Me });
        for (const P of ue) {
          if (n.strokeStyle = E.color, n.lineWidth = Q ? 1.5 : 1, n.beginPath(), n.moveTo(oe, de), n.lineTo(P.x, P.y), n.stroke(), n.fillStyle = Q ? "#2a2233" : "#171720", n.strokeStyle = Q ? "#ffd75e" : E.color, n.lineWidth = Q ? 2 : 1.2, n.beginPath(), P.side === "in")
            n.arc(P.x, P.y, Q ? 5 : 3.8, 0, Math.PI * 2);
          else {
            const q = Q ? 4.5 : 3.2;
            n.rect(P.x - q, P.y - q, q * 2, q * 2);
          }
  ...
  if (z >= p && z <= a - m && (n.strokeStyle = "#a78bfa", n.lineWidth = 1.5, n.beginPath(), n.moveTo(z, f), n.lineTo(z, f + b), n.stroke(), n.fillStyle = "#a78bfa", n.beginPath(), n.moveTo(z - 4, f), n.lineTo(z + 4, f), n.lineTo(z, f + 6), n.closePath(), n.fill()), e.curveDrag || e.curveHover) {
    ...
    if (e.curveDrag)
      if (e.curveDrag.handle) {
        ...
        const F = e.curveDrag.key.frame - e.curveDrag.startFrame, G = e.curveDrag.channel.get(e.curveDrag.object ? e.curveDrag.key.transform : e.curveDrag.key.camera), Q = G - e.curveDrag.startValue, le = F >= 0 ? `+${F}` : `${F}`, se = Q >= 0 ? `+${Q.toFixed(2)}` : `${Q.toFixed(2)}`;
        E = `${e.curveDrag.group.length} keys · ΔF: ${le} · ΔVal: ${se}`, H = `${e.curveDrag.channel.name}: ${G.toFixed(2)}`;
      } else {
        const F = e.curveDrag.key.frame - e.curveDrag.startFrame, G = e.curveDrag.channel.get(e.curveDrag.object ? e.curveDrag.key.transform : e.curveDrag.key.camera), Q = G - e.curveDrag.startValue, le = F >= 0 ? `+${F}` : `${F}`, se = Q >= 0 ? `+${Q.toFixed(2)}` : `${Q.toFixed(2)}`;
        E = `F${e.curveDrag.key.frame} (${le}) · ${e.curveDrag.channel.name}: ${G.toFixed(2)} (${se})`;
      }
    ...
    if (E) {
      ...
      const F = n.measureText(E), G = H ? n.measureText(H) : { width: 0 }, Q = Math.max(F.width, G.width) + 16, le = H ? 32 : 20, se = a - m - Q - 6, oe = f + 6;
      n.fillStyle = "rgba(18, 18, 24, 0.88)", n.strokeStyle = "#38384a", n.lineWidth = 1, n.beginPath(), n.roundRect ? n.roundRect(se, oe, Q, le, 4) : n.rect(se, oe, Q, le), n.fill(), n.stroke(), n.fillStyle = "#e2e8f0", n.fillText(E, se + 8, oe + (H ? 13 : 14)), H && (n.fillStyle = "#94a3b8", n.font = "9.5px system-ui, -apple-system, sans-serif", n.fillText(H, se + 8, oe + 26)), n.restore();
    }
  }
...
function us(e) {
  ...
  if (!t) return;
  const a = e.timelineObject(), o = a ? a.name || a.type : e.activeCameraTrack().name, r = xd(e), n = `${o}\0${r.map((c) => `${c.id}:${c.color}`).join("|")}`;
  if (t.dataset.signature !== n) {
    t.dataset.signature = n, t.replaceChildren();
...
function on(e, t, a) {
  ...
  for (const n of [...e].sort((i, c) => i.frame - c.frame)) {
    ...
    (r === null || !(Math.abs(c - r) <= wd)) && o.push(n.frame), r = c;
  }
  return o;
}
function Ir(e) {
...
function _d(e, t, a, o, r) {
  t.preventDefault(), t.stopPropagation();
  const { camera: n } = bs(e, a.camera_id);
  e.contextMenu?.show(t, n?.name || s("Shot"), [
    ...
    },
    {
      ...
      disabled: r === 1,
      run: () => {
        e.checkpoint("Remove shot"), pi(e.state, o) && jt(e);
      }
    }
  ]);
}
function Cd(e, t, a, o) {
  const { camera: r, color: n } = bs(e, t.camera_id), i = document.createElement("div");
  ...
  if (c.className = "oc-sequence-name", c.textContent = r?.name || t.camera_id, i.appendChild(c), a > 0) {
    ...
    l.className = "oc-sequence-handle", l.title = s("Drag to trim the cut"), l.addEventListener("pointerdown", (p) => jd(e, p, l, o, a)), i.appendChild(l);
  }
  return i.addEventListener("contextmenu", (l) => _d(e, l, t, a, o.__cutCount)), i.addEventListener("pointerdown", () => {
...
function ys(e, t) {
  ...
  if (n.className = "oc-sequence-lane", n.dataset.role = "sequence-lane", n.setAttribute("aria-label", s("Multi-camera edit")), o.length)
    for (const [c, l] of o.entries()) {
      ...
      he(e, l.end + 1) < -5 || p > 105 || n.appendChild(Cd(e, l, c, r));
    }
  else {
    const c = document.createElement("span");
  ...
  r.appendChild(n), r.appendChild(Ed(e));
  const i = document.createElement("span");
  i.className = "oc-sequence-playhead", i.style.left = `${he(e, e.frame)}%`, r.appendChild(i), t.appendChild(r);
}
const Ad = ['[data-act="curve-zoom-in"]', '[data-act="curve-zoom-out"]', '[data-act="curve-fit"]', '[data-act="curve-handles"]'], nn = { curves: "Graph", dope: "Timeline", sequence: "Sequence" };
function sn(e, t) {
  ...
  a === "dope" ? Ir(e) : a === "sequence" ? (ys(e, n), n?.focus?.({ preventScroll: !0 })) : e.drawCurveEditor(), e.setStatus(s(nn[a]));
}
function Td(e) {
  e.graphTab === "sequence" && ys(e, e.root.querySelector('[data-role="graph-sequence"]'));
}
function $d(e, t) {
...
function Od(e) {
  ...
  if (!t || !a) return;
  const o = vs(e.state?.metadata, e.state?.duration_frames), r = o.some((c) => c.state !== "unknown");
...
function Pd(e) {
  ...
  for (const x of o) {
    ...
    j.className = "key-label", j.textContent = String(x.frame), u.appendChild(j), u.addEventListener("pointerdown", (_) => {
      if (_.preventDefault(), _.stopPropagation(), u.focus({ preventScroll: !0 }), _.altKey) {
        ...
        const M = a ? { frame: x.frame, transform: He(x.transform), interpolation: x.interpolation } : { frame: x.frame, camera: ce(x.camera), interpolation: x.interpolation }, Y = e.timelineKeyframes();
  ...
  y && (y.textContent = m.name), fs(e), ls(e), us(e), Ir(e), Td(e), e.refreshCameraSelectors(), e.refreshKeyEditor(), e.updateEditState(), e.drawCurveEditor(), e.perf && (e.perf.timelineRefreshCount = (e.perf.timelineRefreshCount || 0) + 1), Od(e);
}
class xs {
...
const Bd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/><path d="M2 12h20"/></svg>', qd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m21 16-9 5-9-5V8l9-5 9 5v8z"/><path d="m3.27 6.96 8.73 4.84 8.73-4.84"/><path d="M12 22V12"/></svg>', Ud = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2L2 20h20L12 2z"/><path d="M12 2v18"/></svg>', Wd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/><path d="m17.66 17.66 1.41 1.41"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="m6.34 17.66-1.41 1.41"/><path d="m19.07 4.93-1.41 1.41"/></svg>', Vd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18h6"/><path d="M10 22h4"/><path d="M15.09 14c.18-.98.65-1.74 1.41-2.5A4.65 4.65 0 0 0 18 8 6 6 0 0 0 6 8c0 1 .23 2.23 1.5 3.5.76.76 1.23 1.52 1.41 2.5"/></svg>', Hd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l8 8-4 4-8-8 4-4z"/><path d="M7 11L2 16l6 6 5-5"/><path d="M18 19l4 2"/><path d="M21 16l2 2"/></svg>', Gd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m22 8-6 4 6 4V8z"/><rect width="14" height="12" x="2" y="6" rx="2"/></svg>', Yd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14h6v6H4z"/><circle cx="17" cy="7" r="3"/><path d="m6 3 4 7H2z"/></svg>';
function Xd() {
  return `
...
function tm() {
  const e = sl.map((t) => `<button data-lens="${t}">${t}mm</button>`).join("");
  return `
  ...
  return `
    <div class="oc-dope">
      <div class="oc-dope-body">
        <div class="oc-dope-labels">${cs.map((t) => `
...
const Qe = 1, ln = 50, Ie = 120, ut = 160, wm = Object.freeze(["perspective", "orthographic"]), B = Object.freeze({
...
}), Ss = Object.freeze(Object.values(B)), we = Object.freeze({
  SCENE_GET: "scene.get",
...
}), km = Object.freeze(Object.values(we));
...
const Sm = 25, dn = 100;
function bt(e, t) {
  const a = e?.offset === void 0 ? 0 : Number(e.offset), o = e?.limit === void 0 ? Sm : Number(e.limit);
  ...
  switch (t?.type) {
    ...
    case we.HEALTH_GET:
      return Se(e, {
        version: 1,
        type: t.type,
        frames: vs(a.metadata, a.duration_frames)
      });
    case we.ASSET_LIST: {
...
function Om(e, t) {
  if (!js.has(t.objectType))
    throw new O("UNSUPPORTED_OBJECT_TYPE", `object.create does not support type: ${t.objectType}`);
  e.objects ||= [];
  const a = new Set(e.objects.map((i) => i.id)), o = Ro(a, t.objectType, t.id), r = Em(t.objectType), n = {
    id: o,
    type: t.objectType,
    name: t.name || o,
    ...r,
...
function Bm(e, t) {
  ...
  for (a.has(t) && a.delete(t), a.add(t); a.size > Km; )
...
function Wm(e, t) {
  ...
  if (e.far !== void 0) {
    ...
    const a = e.near === void 0 ? bi : e.near;
    if (e.far <= a)
      throw new O("BAD_VALUE", "camera.far must be greater than camera.near", t);
  }
  if (e.camera_type !== void 0 && !wm.includes(e.camera_type))
...
function Vm(e, t) {
  ...
  switch (a) {
    ...
    case B.CAMERA_CREATE:
      if (e.id !== void 0 && te(e.id, "id", t, Ie), e.name !== void 0 && te(e.name, "name", t, ut), e.camera !== void 0) {
    ...
    case B.CAMERA_DUPLICATE:
      te(e.cameraId, "cameraId", t, Ie), e.id !== void 0 && te(e.id, "id", t, Ie), e.name !== void 0 && te(e.name, "name", t, ut);
      break;
    case B.CAMERA_DELETE:
    case B.CAMERA_SET_PLAYBLAST:
      te(e.cameraId, "cameraId", t, Ie);
      break;
    case B.CAMERA_RENAME:
      te(e.cameraId, "cameraId", t, Ie), te(e.name, "name", t, ut);
      break;
    case B.OBJECT_CREATE:
      if (te(e.objectType, "objectType", t), !js.has(e.objectType))
      ...
      e.id !== void 0 && te(e.id, "id", t, Ie), e.name !== void 0 && te(e.name, "name", t, ut), e.position !== void 0 && Ae(e.position, "position", t), e.rotation !== void 0 && Ae(e.rotation, "rotation", t);
      break;
    case B.OBJECT_DUPLICATE:
      te(e.objectId, "objectId", t, Ie), e.id !== void 0 && te(e.id, "id", t, Ie), e.name !== void 0 && te(e.name, "name", t, ut), e.offset !== void 0 && Ae(e.offset, "offset", t);
      break;
    case B.OBJECT_DELETE:
      te(e.objectId, "objectId", t, Ie);
      break;
    case B.OBJECT_RENAME:
      te(e.objectId, "objectId", t, Ie), te(e.name, "name", t, ut);
      break;
    case B.OBJECT_SET_PARENT:
      te(e.objectId, "objectId", t, Ie), e.parentId !== null && e.parentId !== void 0 && te(e.parentId, "parentId", t, Ie);
      break;
    case B.CAMERA_TRANSFORM:
      if (e.cameraId !== void 0 && te(e.cameraId, "cameraId", t), e.position !== void 0 && Ae(e.position, "position", t), e.target !== void 0 && Ae(e.target, "target", t), e.frame !== void 0 && Be(e.frame, "frame", t), e.position === void 0 && e.target === void 0)
    ...
    case B.KEYFRAME_UPSERT:
      if (e.cameraId !== void 0 && te(e.cameraId, "cameraId", t), Be(e.frame, "frame", t), e.interpolation !== void 0 && !jo.includes(e.interpolation))
        throw new O("BAD_INTERPOLATION", `Unsupported interpolation: ${e.interpolation}`, t);
      if (e.camera !== void 0) {
    ...
    case B.KEYFRAME_REMOVE:
      e.cameraId !== void 0 && te(e.cameraId, "cameraId", t), Be(e.frame, "frame", t);
      break;
    case B.KEYFRAME_SET_INTERPOLATION:
      if (e.cameraId !== void 0 && te(e.cameraId, "cameraId", t), Be(e.frame, "frame", t), !jo.includes(e.interpolation))
        throw new O("BAD_INTERPOLATION", `Unsupported interpolation: ${e.interpolation}`, t);
      break;
    ...
    case B.TIMELINE_SET_DURATION:
      ...
      break;
    case B.CUT_UPSERT:
      Be(e.start, "start", t), te(e.cameraId, "cameraId", t);
      break;
    case B.CUT_REMOVE:
      Be(e.start, "start", t);
      break;
...
function Hm(e, t) {
  ...
  return t.operations.forEach((a, o) => Vm(a, o)), {
    version: Qe,
    id: t.id,
...
const Ym = "omnicam/library", Xm = "majoor_omnicam/blockout_library", Jm = Object.freeze({
...
function _s(e) {
  return e.file ? `${e.source === "legacy" ? Xm : Ym}/${e.file} [input]` : "";
}
function mn(e, t, a) {
  const o = e || "asset";
  let r = `${o}_${a}`, n = 2;
...
function ep(e, t = {}) {
  ...
  const a = Zm(t.point, [0, 0, 0]), o = String(t.idSeed || Date.now().toString(36)), r = String(e.kind || "prop"), n = r === "character", i = Jm[e.id];
  ...
  return n && (c.character = Qm(e)), c;
}
function tp({ groundHit: e, orbitTarget: t } = {}) {
...
const ap = {
  [B.ASSET_INSTANTIATE](e, t) {
    ...
    let o;
    try {
      o = ep(t.asset, { point: t.point, idSeed: t.id, existingIds: a });
    } catch (r) {
  ...
  [B.OBJECT_SET_TAGS](e, t) {
    const a = st(e, t.objectId), o = vi(t.tags), r = o.length !== t.tags.length ? "some tags were dropped or normalised" : void 0;
  ...
  [B.CHARACTER_SET_JOINT_ROTATION](e, t) {
    ...
    return a.character = {
      ...a.character || {},
      pose: yi(a.character?.pose, t.joint, t.rotation)
    }, { dirtyMask: T.viewport | T.previews | T.inspector };
  },
...
function op({ state: e, operation: t }) {
  const a = ap[t.type];
...
function np(e, t) {
  ...
  return ip(e, t, r), lp(e, t, r), mp(e, t, r), dp(e, t, r), pp(e, t, r), fp(e, t, r), { changes: a, truncated: o };
}
...
const cp = ["position", "target", "fov", "roll", "zoom", "near", "far", "camera_type"];
function lp(e, t, a) {
  const o = et(e?.cameras), r = et(t?.cameras);
  for (const [n, i] of r) {
...
function vp(e, t) {
  ...
  try {
    ...
    if (f instanceof O) return Xo(e, t?.id, f);
    throw f;
  }
  const o = mr(e);
  ...
  for (let f = 0; f < a.operations.length; f += 1)
    try {
      const d = op({ ui: e, state: r, operation: a.operations[f] });
  ...
  if (a.validateOnly) {
    const { changes: f, truncated: d } = np(e.state, r);
    return {
      ok: !0,
      version: Qe,
      revision: o,
  ...
  const l = up(e);
  Bm(e, a.id), e.serialize?.(), bp(e, l), yp(e, n, `director-api:${a.id}`);
  const p = {
    ok: !0,
    version: Qe,
    baseRevision: o,
...
function wp(e) {
  return e.directorApi = xp(e), e.directorApi;
}
const fn = "omnicam-agent/1", hn = "majoor.omnicam.agent.request", kp = 1, Dt = Object.freeze({
...
}), Sp = 1e4, jp = 5e3, Cs = "asset.instantiate_by_id", Es = "asset.catalog_search", un = Object.freeze([
  ...Ss.filter((e) => e !== B.ASSET_INSTANTIATE),
  Cs
]);
function pr(e) {
...
function Ap(e, t, a) {
  ...
  async function d() {
    ...
    try {
      const j = await Kt(a, Dt.register, {
        protocol: fn,
        client_id: u,
        node_id: String(t.id),
  ...
  async function v(k) {
    const u = k?.detail;
    if (o || !u || u.protocol !== fn || Number(u.schema_version) !== kp || u.session_id !== r || String(u.node_id) !== String(t.id)) return;
    let j;
    try {
      if (u.kind === "query")
        j = u.payload?.type === Es ? await Ep(e, u.payload) : e.directorApi.query(u.payload);
      else if (u.kind === "transaction") {
        const _ = u.payload, N = (_?.operations || []).find(
          (M) => !un.includes(M?.type)
        );
        if (!Number.isInteger(_?.baseRevision) || _.baseRevision < 0)
          ...
          const M = await Cp(e, _.operations);
          M.ok ? (j = e.directorApi.execute({ ..._, operations: M.operations }), await j?._reconciliation) : j = Bt(e, M.code, M.message);
        }
      } else
        j = Bt(e, "UNKNOWN_AGENT_REQUEST", `Unsupported Agent request kind: ${u.kind}`);
    } catch (_) {
      j = Bt(e, _?.code || "INTERNAL", _?.message || "OmniCam Agent request failed");
    }
    try {
      await Kt(a, Dt.reply, {
        session_id: r,
  ...
  return a.addEventListener?.(hn, v), a.addEventListener?.("status", x), d(), {
    ...
    dispose() {
      ...
      const k = r, u = n;
      r = null, n = null, k && u && Kt(a, Dt.close, {
        session_id: k,
        session_token: u
      }).catch(() => {
      });
...
function Pr({ fetchApi: e = Tp } = {}) {
  const t = (a, o) => Promise.resolve(e(a, o)).then($p);
  return {
    list(a = {}) {
...
const As = Object.freeze(["all", "character", "prop", "environment", "vehicle"]);
function gn(e = {}) {
  const t = String(e.kind || "all").toLowerCase();
  return {
    kind: As.includes(t) ? t : "all",
...
const Lp = 256;
function yn(e = {}) {
  const { THREE: t, GLTFLoader: a, FBXLoader: o, size: r = Lp } = e;
  if (!t || !a)
...
function Dp(e, t = {}) {
  return As.map((a) => {
    const o = s(Rp[a] || a), r = a === "all" ? "" : ` <span class="oc-asset-kind-n">${Number(t[a] || 0)}</span>`;
    return `<button type="button" class="oc-asset-kind${a === (e || "all") ? " active" : ""}" data-asset-kind="${a}">${St(o)}${r}</button>`;
  }).join("");
}
function Kp(e, { selected: t = !1, thumbUrl: a = "" } = {}) {
  const o = Fp[e.kind] || "pi-box", r = e.kind === "character" && Hn(e.rig) === "rigged" ? `<span class="oc-asset-badge">${s("RIGGED")}</span>` : "", n = a ? `<img class="oc-asset-thumb" src="${St(a)}" alt="" loading="lazy">` : `<span class="oc-asset-thumb oc-asset-thumb--glyph"><i class="pi ${o}"></i></span>`;
...
function Bp(e, { selectedId: t = "", thumbUrls: a = {} } = {}) {
  return !e || !e.length ? `<p class="oc-asset-empty">${s("No assets match this filter.")}</p>` : e.map((o) => Kp(o, {
    selected: o.id === t,
    thumbUrl: a[o.id] || ""
  })).join("");
}
...
function qp(e, t = {}) {
  const a = e.root, o = t.fetchApi || ((P, q) => (e.api || e.app?.api).fetchApi(P, q)), r = t.apiClient || Pr({ fetchApi: o }), n = t.store || Ip(r), i = Op(), c = t.previewQueue || Pp(), l = e.api || e.app?.api || null;
  let p = t.thumbnailRenderer || null, m = null;
  const f = /* @__PURE__ */ new Set();
  function d() {
    return p ? Promise.resolve(p) : (m || (m = zp().then((P) => p = yn(P)).catch(() => p = yn({}))), m);
  }
  function h(P) {
    return Hr(l, _s(P));
  }
  function b(P) {
    return P.thumbnail ? Hr(l, `omnicam/library/${P.thumbnail} [input]`) : "";
  }
  function g() {
    for (const P of n.state.items) {
      if (P.kind === "helper" || !P.file || i.get(P.id) || P.thumbnail || f.has(P.id)) continue;
      const q = h(P);
      q && c.enqueue(P.id, async () => {
        const je = await (await d()).render(q, P.format || "glb");
        if (!je) {
          f.add(P.id);
          return;
        }
        if (i.set(P.id, je), G(), !(P.source && P.source !== "user"))
          try {
            const Oe = await r.uploadThumbnail(P.id, Np(je));
  ...
  let ne = "", C = null, R = !0, W = !0, X = "scene", z = 0;
  function E(P, { sticky: q = !1 } = {}) {
    j && (!q && z > Date.now() || (j.textContent = P || "", z = q ? Date.now() + 9e3 : 0));
  }
  function H(P) {
    if (ne = P, !!x)
      for (const q of x.querySelectorAll(".oc-asset-card"))
        q.classList.toggle("selected", q.dataset.assetId === P);
  }
  let F = !1;
  function G() {
    if (k && (k.innerHTML = Dp(n.state.filter.kind, n.state.kinds)), x) {
      const P = {};
      for (const q of n.state.items) {
        const me = i.get(q.id) || b(q);
        me && (P[q.id] = me);
      }
      x.innerHTML = Bp(n.state.items, { selectedId: ne, thumbUrls: P });
    }
    if (!F) {
      F = !0;
      try {
  ...
  function Q(P) {
    ...
    const q = tp({
      ...
      operations: [{ type: "asset.instantiate", asset: P, point: q }]
    });
    if (!me?.ok) {
    ...
    je && (e.selectedEntity = "object", e.selectedObjectId = je, e.selectedObjectIds = /* @__PURE__ */ new Set([je]), e.selectedKeyFrame = null), e.restoreAssets?.(), e.refreshObjects?.(), e.refreshInspector?.(), e.render?.(), e.setStatus?.(s("{name} added").replace("{name}", P.name));
  }
  async function le(P) {
    if (P) {
      E(s("Importing {name}...").replace("{name}", P.name));
      try {
        const q = await r.importModel(P, { kind: "prop", name: P.name.replace(/\.[^.]+$/, "") });
        q.asset && n.upsert(q.asset), E(s("Imported {name}").replace("{name}", q.asset?.name || P.name));
      } catch (q) {
        E(q.message || s("Import failed"));
      }
    }
  }
  const se = v("asset-local-form"), oe = v("asset-local-folder"), de = v("asset-local-note");
  function be() {
    se && (se.hidden = !se.hidden, se.hidden || oe?.focus());
  }
  async function fe(P) {
    const q = (oe?.value || "").trim();
    if (!q) {
      E(s("Point to the folder you extracted the pack into."), { sticky: !0 });
      return;
    }
    z = 0, E(P ? s("Scanning {folder}...").replace("{folder}", q) : s("Installing characters from {folder}...").replace("{folder}", q));
    try {
  ...
  function ge(P) {
    P === "agent" && !or() && (P = "scene"), X = P, N && (N.hidden = P !== "scene");
    for (const [q, me] of Object.entries(V))
      me && (me.hidden = q !== P);
    for (const q of a.querySelectorAll("[data-asset-view]"))
      q.classList.toggle("active", q.dataset.assetView === P);
  ...
  function pe(P) {
    const q = vn(P.target);
    if (q) {
      if (q.action === "switch-view") return ge(q.view);
      if (q.action === "filter-kind") return void n.setFilter({ kind: q.kind });
      if (q.action === "asset-add")
        return Q(n.get(ne));
      if (q.action === "asset-import")
        return _?.click();
      if (q.action === "local-toggle") return be();
      if (q.action === "local-scan") return void fe(!0);
      if (q.action === "local-install") return void fe(!1);
      q.action === "card" && H(q.assetId);
    }
  }
  function Me(P) {
    const q = vn(P.target);
    q?.action === "card" && Q(n.get(q.assetId));
  }
  function ve() {
    clearTimeout(C), C = setTimeout(() => n.setFilter({ search: u.value }), 200);
  }
  function xe(P) {
    const q = P.target.files?.[0];
    P.target.value = "", le(q);
  }
  const ue = n.subscribe(G);
  return y?.addEventListener("click", pe), y?.addEventListener("dblclick", Me), a.querySelector('[data-role="left-tabs"]')?.addEventListener("click", pe), u?.addEventListener("input", ve), _?.addEventListener("change", xe), G(), ye(), {
    store: n,
    switchView: ge,
    syncAgentAvailability: ye,
    refresh: () => n.refresh(),
    dispose() {
      ue(), clearTimeout(C), y?.removeEventListener("click", pe), y?.removeEventListener("dblclick", Me), a.querySelector('[data-role="left-tabs"]')?.removeEventListener("click", pe), u?.removeEventListener("input", ve), _?.removeEventListener("change", xe), c.clear(), p?.dispose?.(), i.clear();
    }
  };
}
function Up(e, t = {}) {
  ...
  function l() {
    ...
    for (const v of b) {
      ...
      const x = Xn(b, v, h) || {
        position: v.position,
        size: v.size
      }, k = e.webgl.projectWorldToScreen(Jn(x, v.type));
...
function Xp(e, t = {}) {
  ...
  function y(C) {
    ...
    return wi({ preset: R, overrides: C?.pose }).joints;
  }
  function x() {
    const C = h();
  ...
  function k() {
    ...
    l && (l.textContent = C);
    const W = h(), X = y(W?.character)[C] || [0, 0, 0, 1], z = ki(X);
    p.forEach((E, H) => {
  ...
  function _() {
    const C = g();
    if (!C) return;
    const R = p.map((z) => Number(z?.value) || 0), W = xi(R), X = e.directorApi?.execute({
      version: 1,
  ...
  async function M() {
    ...
    const W = R.toLowerCase().replace(Yp, "-").replace(/^-+|-+$/g, "").slice(0, 60) || "pose";
    try {
...
function Jp(e) {
  ...
  function b() {
    ...
    Jo(r, k?.start_frame ?? 0), Jo(n, k?.end_frame ?? 0), Jo(i, k?.speed ?? 1), c && document.activeElement !== c && (c.checked = k ? k.loop !== !1 : !0);
    const u = !!k;
...
const Zp = /* @__PURE__ */ new Set(["translate", "rotate", "scale"]), Qp = /* @__PURE__ */ new Set(["world", "local"]), Ue = 180 / Math.PI;
function kn(e) {
  return [e.x, e.y, e.z];
}
function ef(e) {
...
function tf({
  ...
  const m = p ? p() : new e.Object3D(), f = l ? l(t, a) : new ql(t, a);
  let d = null;
  ...
  function N(z) {
    ...
    m.rotation.set(E[0] / Ue, E[1] / Ue, E[2] / Ue), m.scale.set(...z.scale || [1, 1, 1]), f.attach(m), f.visible = !0;
  }
  function M() {
  ...
  function U(z) {
    if (!Zp.has(z)) throw new Error(`createTransformControlsAdapter: unknown mode "${z}"`);
    f.setMode ? f.setMode(z) : f.mode = z;
  }
  function V(z) {
    if (!Qp.has(z)) throw new Error(`createTransformControlsAdapter: unknown space "${z}"`);
    f.space = z;
  }
  function ne(z) {
...
const af = /* @__PURE__ */ new Set(["object", "camera", "camera_target", "path_point", "path_group", "camera_path"]);
function of(e) {
  const t = e?.constraints?.look_at;
  return !!((t?.status === void 0 || t?.status === "active") && (t?.object_id || e?.target_object_id));
}
function rf(e, { controlsFactory: t, anchorFactory: a } = {}) {
  let o = null, r = null;
  function n() {
    return o || (!e.webgl || !e.interactionElement ? null : (o = tf({
      THREE: Bl,
  ...
  function i({ targetSpec: u }) {
    if (u) {
      if (u.type === "object") {
        ...
        const j = ji(e), _ = (j.length ? j : [u.object]).map((M) => ({
          object: M,
          transform: He(M)
        }));
        for (const M of _) e.beginObjectEdit(M.object);
        const N = _.reduce((M, Y) => Ce(M, Y.transform.position), [0, 0, 0]).map((M) => M / _.length);
      ...
      if (u.type === "camera_path") {
        ...
        e.checkpoint("Transform camera path"), r = {
          type: "camera_path",
          trackId: j.id,
          origin: Qn(j.keyframes),
          baseKeys: j.keyframes.map((_) => ({ ..._, camera: ce(_.camera) }))
        };
        return;
      }
      if (u.type === "path_point" || u.type === "path_group") {
        ...
        e.checkpoint(u.type === "path_point" ? "Transform path point" : "Transform path selection"), r = {
          ...
          baseKeys: j.keyframes.map((N) => ({ ...N, camera: ce(N.camera) })),
          lookAtActive: of(j)
        };
      }
    }
  ...
  function l(u) {
    u.id === e.state.active_camera_id && (e.state.keyframes = u.keyframes), e.camera = $e(u, e.frame, e.state.objects), u.camera = ce(e.camera), e.refreshKeys();
  }
  function p(u) {
    const j = e.state.cameras.find((_) => _.id === r.trackId);
    j && (j.keyframes = es(r.baseKeys, c(u)), l(j));
  }
  function m(u) {
    const j = e.state.cameras.find((N) => N.id === r.trackId);
    if (!j) return;
    const _ = { ...c(u), lookAtActive: r.lookAtActive };
    j.keyframes = Ci(r.baseKeys, r.selectedFrames, _), l(j);
  }
  function f({ delta: u }) {
  ...
  function d(u) {
    ...
    for (const M of j)
      if (N === "translate")
        M.object.position = Ce(M.transform.position, u.position);
      else if (N === "rotate")
        M.object.position = Ce(_, Xr(Ut(M.transform.position, _), u.rotationDeg)), M.object.rotation = Ce(M.transform.rotation, u.rotationDeg);
      else if (N === "scale") {
        const Y = Ut(M.transform.position, _);
        M.object.position = Ce(_, Y.map((U, V) => U * u.scaleFactors[V])), M.object.size = M.transform.size.map((U, V) => Math.max(0.01, U * u.scaleFactors[V]));
      }
    for (const M of j) e.commitObjectEdit(M.object);
  }
  function h(u) {
    if (e.state.gizmo_mode === "translate")
      e.camera.position = Ce(r.position, u.position);
    else {
      const j = Ut(r.target, r.position);
      e.camera.target = Ce(r.position, Xr(j, u.rotationDeg));
    }
    e.commitCameraEdit();
  }
  function b(u) {
    const j = Ce(r.base, u.position);
    r.tracking ? _i(e, j) : e.camera.target = j, e.commitCameraEdit();
  }
  ...
  function v() {
    ...
    const u = e.recording ? null : Si(e), j = e.state.gizmo_mode || "translate";
    if (!(!!u && af.has(u.type) && u.allowedModes.includes(j))) {
      o?.detach();
      return;
    }
...
function nf(e, t) {
  ...
  const a = e.activeCameraTrack(), o = Vl(t, {
...
function Do(e, t, a) {
  ...
  const o = Et(e), r = o.expanded ? 220 : 138, n = Math.min(r, Math.max(80, Math.min(t, a) - 20)), i = 10, c = Math.max(0, t - n - i), l = Math.max(0, a - n - i), p = e.viewportCamera(), m = p?.position || [0, 1.5, 5], f = p?.target || [0, 0, 0], d = e.activeCameraTrack?.(), h = e.state.cameras?.length ? e.state.cameras : d ? [d] : [], b = h.flatMap(
...
function pf(e, t, a, o) {
  const r = Do(e, a, o);
  if (!r) return;
  const { rx: n, ry: i, radarSize: c, cx: l, cy: p, innerRadius: m, range: f, scale: d, camPos: h, camTgt: b, cameras: g, activeTrack: v } = r, y = Et(e), x = e.state.active_camera_id || v?.id, k = (oe, de) => $s(r, oe, de);
  ...
  for (const oe of j) {
    const de = m * oe;
    t.beginPath(), t.arc(l, p, de, 0, Math.PI * 2), t.stroke(), c >= 120 && (t.font = "8px monospace", t.fillStyle = "rgba(0, 210, 211, 0.35)", t.textAlign = "left", t.fillText(`${Math.round(f * oe)}m`, l + de + 2, p - 2));
  }
  ...
  for (const oe of e.state.objects || []) {
    if (oe.enabled === !1) continue;
    const de = Cr(e.state.objects, oe).position || [0, 0, 0], [be, fe] = k(de[0], de[2]);
    if (be < n + 3 || be > n + c - 3 || fe < i + 3 || fe > i + c - 3) continue;
    const ge = e.selectedObjectId === oe.id || e.selectedObjectIds?.has?.(oe.id);
    if (t.save(), t.translate(be, fe), oe.type === "card") {
      const ye = (oe.rotation?.[1] || 0) * Math.PI / 180;
      ...
      t.fillStyle = ge ? "#a855f7" : oe.type === "human" ? "#ec4899" : "#f59e0b", t.beginPath(), t.arc(0, 0, 2.8, 0, Math.PI * 2), t.fill();
  ...
  for (let oe = 0; oe < g.length; oe++) {
    const de = g[oe], be = de.keyframes || [], fe = de.id === x, ge = de.color || Sn[oe % Sn.length];
    ...
    for (const ve of be) {
      ...
      const q = ve.frame === e.frame && fe;
      t.fillStyle = q ? "#ffffff" : ge, t.globalAlpha = fe ? 0.95 : 0.6, t.beginPath(), t.moveTo(ue, P - 3), t.lineTo(ue + 3, P), t.lineTo(ue, P + 3), t.lineTo(ue - 3, P), t.closePath(), t.fill(), q && (t.strokeStyle = "#00d2d3", t.lineWidth = 1.2, t.stroke());
    }
    t.restore();
  }
  const [_, N] = k(h[0] || 0, h[2] || 0), [M, Y] = k(b[0] || 0, b[2] || 0), U = 8, V = Z(_, n + U, n + c - U), ne = Z(N, i + U, i + c - U), C = Z(M, n + U, n + c - U), R = Z(Y, i + U, i + c - U), W = h[1] || 0, X = df(W), z = mf(W);
  t.strokeStyle = "rgba(255, 255, 255, 0.40)", t.lineWidth = 1, t.setLineDash([3, 3]), t.beginPath(), t.moveTo(V, ne), t.lineTo(C, R), t.stroke(), t.setLineDash([]), t.fillStyle = "#ffffff", t.beginPath(), t.arc(C, R, 2.5, 0, Math.PI * 2), t.fill(), t.strokeStyle = "rgba(255, 255, 255, 0.7)", t.lineWidth = 1, t.beginPath(), t.arc(C, R, 4.5, 0, Math.PI * 2), t.stroke();
  const E = b[0] - h[0], H = b[2] - h[2], F = Math.atan2(H, E), Q = (e.viewportCamera().fov || 35) * Math.PI / 360, le = Z(24 * (d / (m / 8)), 16, 38), se = t.createRadialGradient(V, ne, 2, V, ne, le);
  se.addColorStop(0, X + "55"), se.addColorStop(1, X + "08"), t.fillStyle = se, t.strokeStyle = X, t.lineWidth = 1.2, t.beginPath(), t.moveTo(V, ne), t.lineTo(V + Math.cos(F - Q) * le, ne + Math.sin(F - Q) * le), t.arc(V, ne, le, F - Q, F + Q), t.closePath(), t.fill(), t.stroke(), t.fillStyle = X + "44", t.beginPath(), t.arc(V, ne, 6.5, 0, Math.PI * 2), t.fill(), t.fillStyle = X, t.beginPath(), t.arc(V, ne, 3.5, 0, Math.PI * 2), t.fill(), t.strokeStyle = "#ffffff", t.lineWidth = 1.5, t.beginPath(), t.moveTo(V, ne), t.lineTo(V + Math.cos(F) * 7, ne + Math.sin(F) * 7), t.stroke(), ff(e, t, r, X, z, F, Math.hypot(E, H)), y.hover && hf(t, r, y.hover), t.restore();
}
function ff(e, t, a, o, r, n, i) {
...
function Is(e, t, a, o) {
  const { camPos: r, camTgt: n, cameras: i, rx: c, ry: l, radarSize: p } = t, m = (v, y) => $s(t, v, y), [f, d] = m(r[0] || 0, r[2] || 0);
  ...
  for (const v of e.state.objects || []) {
    ...
    const y = Cr(e.state.objects, v).position || [0, 0, 0], [x, k] = m(y[0], y[2]);
...
function bf(e, t, a, o) {
  ...
  if (n.drag) {
    const [g, v] = fr(r, a, o), y = e.viewportCamera();
  ...
  const m = Ms(r, a, o), f = Is(e, r, a, o), [d, h] = fr(r, a, o);
...
function yf(e, t, a) {
  ...
  const o = () => {
    ...
    const h = Ai(t('[data-role="object-tags"]')?.value || "");
    h.length ? d.tags = h : delete d.tags;
    const b = String(t('[data-role="object-annotation"]')?.value || "").trim(), g = b ? Vn({
      text: b,
  ...
  }, { signal: a }), ad(e, a), $d(e, a), t('[data-role="curve-group"]')?.addEventListener("change", () => {
    e.setChannelFilter("all"), us(e), e.drawCurveEditor(), Ir(e);
  ...
  e.root.addEventListener("pointerdown", (d) => {
    ...
    const h = e.interactionElement.getBoundingClientRect(), b = (d.clientX - h.left) * e.canvas.width / Math.max(1, h.width), g = (d.clientY - h.top) * e.canvas.height / Math.max(1, h.height);
    gf(e, d, b, g) || e.onWheel(d);
  }, { passive: !1, signal: a }), e.root.addEventListener("wheel", Fl(e.root), { signal: a }), window.addEventListener("pointermove", (d) => {
  ...
  const p = (d) => {
    const h = Ti(d.composedPath?.()[0] || d.target);
    h && (e.lastKeyZone = h);
  };
  e.root.addEventListener("focusin", p, { signal: a }), e.root.addEventListener("pointerdown", p, { capture: !0, signal: a }), e.root.addEventListener("focusout", (d) => {
    e.modalTransform && !e.root.contains(d.relatedTarget) && (Ei(e), e.render());
  }, { signal: a });
...
function wf(e) {
  const t = xc(e.id, e.defaultValue), a = `pref_${e.id.replace(/[^a-zA-Z0-9]/g, "_")}`;
  if (e.type === "boolean")
    return `
...
function Sf() {
  return `<span class="oc-pref-emoji" aria-hidden="true">${vf}</span> ${s("OmniCam Preferences")}`;
}
function jf(e) {
  ...
  a.className = "oc-modal-backdrop", a.setAttribute("role", "dialog"), a.setAttribute("aria-modal", "true"), a.setAttribute("aria-label", s("OmniCam Preferences")), a.innerHTML = `
    <div class="oc-modal-dialog oc-pref-dialog" tabindex="-1">
      <div class="oc-pref-header">
        <div class="oc-pref-title">${Sf()}</div>
...
const Cf = ["position", "target"], Ef = ["fov", "zoom"], Af = ["roll"], Tf = ["position", "size"], $f = ["rotation"];
function hr(e) {
  ...
  for (let r = 1; r < a.length - 1; r++) {
    ...
    if (i.camera) {
      for (const m of Cf) {
        ...
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const b = _n(f, d, h, p);
          a[r].camera[m] = En(d.map(Number), b, o);
        }
      }
      for (const m of Ef) {
        const f = n.camera?.[m], d = i.camera?.[m], h = c.camera?.[m];
    ...
    if (Array.isArray(i.position) && Array.isArray(n.position) && Array.isArray(c.position)) {
      for (const m of Tf) {
        ...
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const b = _n(f, d, h, p);
          a[r][m] = En(d.map(Number), b, o);
        }
      }
      for (const m of $f) {
        const f = n[m], d = i[m], h = c[m];
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const b = [0, 1, 2].map((g) => Cn(f[g], d[g], h[g], p));
          a[r][m] = d.map((g, v) => An(Number(g), b[v], o));
        }
      }
    }
  }
...
function Ff(e, t) {
  ...
  const o = (r) => {
    ...
    const b = (v) => {
      ...
      let x = Lf;
      v.shiftKey ? x = zf : (v.ctrlKey || v.metaKey) && (x = Nf);
      const k = p * x * 20;
      let u = l + y * k;
...
function Kf(e, t) {
  for (const o of e.root.querySelectorAll('[data-act="toggle-camera-lock"]'))
    o.addEventListener("click", (r) => {
      r.stopPropagation(), e.checkpoint?.("Toggle camera lock"), e.state.camera_lock = !e.state.camera_lock, e.serialize?.(), Os(e), e.setStatus?.(e.state.camera_lock ? s("Camera View locked") : s("Camera View unlocked"));
    }, { signal: t });
...
function qf(e, t) {
  ...
  }, n = (i) => (e.smoothingBaseline?.cameraId !== i.id && (e.smoothingBaseline = { cameraId: i.id, keys: Pf(i.keyframes) }), e.smoothingBaseline.keys);
  a.addEventListener("input", r, { signal: t }), a.addEventListener("change", () => {
    const i = e.activeCameraTrack();
    if (!i) return;
    e.checkpoint("Path smoothing");
    const c = Number(a.value) / 100, l = Of(n(i), c);
  ...
  if (a.length) {
    ...
    for (const o of a)
      o.addEventListener("change", () => {
        e.dopeChannels = new Set(a.filter((r) => r.checked).map((r) => r.dataset.dopeChannel)), ls(e);
      }, { signal: t });
  }
}
function Hf(e, t) {
...
const go = () => import("./chunk-B9CHyKfH.js");
function Yf(e, t) {
...
function Xf(e, t) {
  ...
  wc().then((r) => {
    ...
    c === "health-slow" ? Sc(e) : c === "health-smooth" ? jc(e) : c === "health-recenter" && _c(e);
  }, { signal: t });
...
function eh(e, t) {
  Yf(e, t), Bf(e, t), qf(e, t), Uf(e, t), Wf(e, t), Jf(e, t), Qf(e, t), Zf(e, t), Ff(e, t), Rf(e, t), Vf(e, t), Gf(e, t), Kf(e, t), Hf(e, t), Xf(e, t);
}
const Tn = {
...
}, Ps = "balanced", Qo = "#121212";
function Lr(e) {
  return Tn[e] || Tn[Ps];
}
function th(e, t = "#1b1f2b", a = "#151822", o = "#1e2330", r = "#161922", n = "#111319") {
...
function Ig(e, t, a = Ps) {
  ...
  const h = new e.FogExp2(1250588, 8e-3), b = th(e), g = new e.PMREMGenerator(t);
  g.compileEquirectangularShader();
  const v = new Ul(), y = g.fromScene(v, 0.04).texture;
  return v.traverse((x) => {
    x.geometry?.dispose?.();
...
function oh(e) {
  ...
  const r = e.reconstruction, n = r.provider || "Reconstructed", i = Math.round(t * 100), c = ml(e), l = c.length ? `
` + c.map(([m, f]) => `${m}: ${f}`).join(`
`) : "", p = `${n} • ${o} (${i}%)${l}`;
  return {
    label: o,
...
function Lg(e, t, a) {
  return e?.reconstruction ? a ? "neutral" : rh(t) === "source_texture" ? "textured" : "neutral" : null;
}
function nh(e, t) {
...
function sh(e, t, a) {
  ...
  if (o) {
    const n = (i) => {
      const c = i.target.closest?.("[data-axis], [data-axis-center]") || i.target, l = c.getAttribute("data-axis"), p = Cc(l?.toLowerCase(), e.state.view_mode);
  ...
  for (const n of e.root.querySelectorAll("[data-blocking-scene]"))
    n.addEventListener("click", () => {
      lf(e, n.dataset.blockingScene), e.closeMenus();
    }, { signal: a });
...
const ih = 32, ch = 0.025, lh = 0.05, $o = 1e-6, dh = ["top", "bottom", "front", "back", "left", "right"], mh = {
  top: "y",
  bottom: "y",
  front: "z",
  back: "z",
...
function bh(e) {
  ...
  const n = Math.min(ih, r.length, o + 1);
  if (n < 2) return [];
  const i = fh(r, n);
  ...
  ], p = e.planeAxis === "y" ? Ls(l) : zs(l, [0, 0, -1]), m = e.seedPoint ? 1 : 0, f = [];
  for (let d = m; d < i.length; d++) {
    const h = i[d], b = hh(i, d, p, e.planeAxis), g = ce(c);
    g.position = [...h], g.target = uh(h, b, l, e.planeAxis), f.push({
...
function Ns(e, t = e.cameraPathDraw) {
  const a = t?.pointerId;
  if (a != null)
    try {
...
function Mn(e, t = {}) {
  ...
  if (a === "extend") {
    ...
    const b = Math.max(0, Math.round(Number(e.state.duration_frames) || 1) - 1), [, g] = $n(e.state), v = d.length > 1 ? d[d.length - 1].frame - d[0].frame : 24;
    let y = Math.max(g, h.frame + Math.max(6, Math.min(v, 240)));
    y <= h.frame && (y = h.frame + 24), y > b && (l = y + 1), y > g && (p = y), c = [h.frame, y];
  } else
    dh.includes(e.state.view_mode) || e.setViewMode?.("top"), c = $n(e.state);
...
function Fr(e, t) {
  ...
  return r && Nr(r, o) < ch ? !1 : (a.points.push(o), !0);
}
function We(e) {
  const t = e.cameraPathDraw;
  return t?.active ? (Ns(e, t), e.cameraPathDraw = null, Ht(e), e.setStatus?.(s("Draw Camera Path cancelled")), e.render?.(), !0) : !1;
}
function yh(e) {
  const t = e.cameraPathDraw;
  ...
  if (a.length < 2 || ph(a) < lh || t.range[1] <= t.range[0])
  ...
  const r = fl(e.state), n = e.state.cameras.length, i = {
    id: r,
    name: gh(e.state),
...
function kh(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : (Io(t), t.type === "pointercancel" || t.type === "lostpointercapture" ? (We(e), !0) : (Fr(e, Rr(e, t)), a.drawing = !1, yh(e), !0));
}
function Sh(e) {
  const t = e.cameraPathDraw;
...
function Dr(e, t, { name: a = "", status: o } = {}) {
  const r = t && typeof t == "object" ? t : as(), n = { ...r, metadata: { ...r.metadata || {}, scene_name: a || "" } };
...
async function _h(e) {
  await Xt(e, s("New Scene"), s("Start a new scene? Unsaved changes will be lost.")) && Dr(e, as(), { name: "", status: s("New scene") });
}
async function Ch(e) {
  if (!e.sceneBaseline) {
  ...
  const o = a?.metadata?.scene_name || Fs(e);
  Dr(e, a, { name: o, status: s("Scene reset to last save") });
}
async function Eh(e) {
  const t = Fs(e) || s("Untitled"), a = await Yt(e, s("Save Scene"), s("Scene name"), t);
  if (a == null) return;
...
function $h(e, t) {
  vo(e, t, e.root.querySelectorAll('[data-act="scene-new"]'), () => _h(e)), vo(e, t, e.root.querySelectorAll('[data-act="scene-open"]'), () => Ah(e)), vo(e, t, e.root.querySelectorAll('[data-act="scene-save"]'), () => Eh(e)), vo(e, t, e.root.querySelectorAll('[data-act="scene-reset"]'), () => Ch(e));
}
const Mh = ["world_point", "object_point", "camera_field"], In = 40;
function Ih(e) {
...
function Lh(e) {
  ...
  if (!c) return;
  const l = Rs(t, e.state.width || 1280, e.state.height || 720), p = (v) => l.x + v * l.w, m = (v) => l.y + v * l.h;
  ...
  for (const v of e.state.motion_layers || []) {
    if (v.enabled === !1) continue;
    const y = Mh.includes(v.source_kind), x = y ? Oh(e.state, v, d) : Ih(v);
...
function zh(e, t) {
  ...
  a && a.addEventListener("click", (o) => {
    ...
    const n = Rs(a, e.state.width || 1280, e.state.height || 720), i = a.width / r.width, c = {
      x: ((o.clientX - r.left) * i - n.x) / Math.max(1, n.w),
      y: ((o.clientY - r.top) * i - n.y) / Math.max(1, n.h)
    }, l = Ac(e.state.motion_layers, c, 0.09);
...
function Rh(e, t) {
  ...
  return {
    ...
    motion_scene_fingerprint: Rl(e.state)
  };
}
function Dh(e, t) {
  const a = Rh(e, t);
...
const ct = 1024 * 1024, Kh = Object.freeze({
  card: 128 * ct,
  // MAX_CARD_BYTES
  model: 256 * ct,
  // MAX_MODEL_BYTES
...
async function Wh(e, { load: t = () => import("./vendor-mediabunny-CZ5VNE-V.js") } = {}) {
...
async function Hh(e, t, { decode: a = Wh } = {}) {
  if (!t) return;
  const o = Jt(t, "audio");
  if (o) {
    e.setStatus(o);
  ...
  try {
    ...
    n.preload = "auto", n.src = r, e.audioObjectUrl = r, e.audioElement = n, await Vh(n), e.audioDuration = Number.isFinite(n.duration) ? n.duration : 0;
    try {
      e.audioSamples = await a(t);
    } catch {
      e.audioSamples = null;
    }
    Ds(e), e.setStatus(`Audio loaded: ${t.name || "track"}`);
  } catch (r) {
...
const Bs = /* @__PURE__ */ new WeakSet(), Wt = /* @__PURE__ */ new WeakMap();
function Po(e) {
...
function Yh(e) {
  ...
  Wt.delete(e), Bs.has(e) && Po(e);
}
function Zt(e, t) {
  const a = e.cardMediaById.get(t);
  a && (e.cardMediaById.delete(t), e.cardMediaAssetById?.delete?.(t), t === "subject" && e.cardMedia === a && (e.cardMedia = null), Yh(a));
}
function Xh(e) {
...
function tt(e, t, a, o = !1, r = "") {
  ...
  n && n !== a && Zt(e, t), o && Bs.add(a), Gh(a), e.cardMediaAssetById ||= /* @__PURE__ */ new Map(), e.cardMediaById.set(t, a), e.cardMediaAssetById.set(t, r || a?.__omnicamAsset || "");
  try {
    a.__omnicamAsset = r || a.__omnicamAsset || "";
  } catch {
  }
...
function qs(e, t, { signal: a, timeout: o = 15e3 } = {}) {
...
async function Us(e, t, a, o = () => !0, r = null) {
  if (!t || !a) return;
  const n = () => !e.disposed && o(), i = String(t.asset || a).toLowerCase();
  if (r ?? /\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/.test(i)) {
    const l = document.createElement("video");
    if (l.src = a, l.loop = !0, l.muted = !0, l.playsInline = !0, await qs(l, ["loadeddata", "error"], { signal: e.abortController?.signal }).catch(() => {
    }), !n()) {
      Po(l);
      return;
    }
...
async function ru(e) {
  ...
  for (const f of i) {
    ...
    if (h) {
      if (d === "image" || d === "video") {
        ...
        if (b && b.value) {
          const g = String(b.value), v = /\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/i.test(g), y = h.widgets?.find((u) => String(u.name).toLowerCase() === "subfolder")?.value || "", x = Ze(vt(g, y)), k = e.state.objects.find((u) => u.id === "subject");
          if (k) {
            const u = await Us(e, k, x, r, v);
            if (!r()) return;
            k.asset = vt(g, y);
            let j = null;
            if (v)
              try {
                j = await Jh(g, o.signal);
              } catch (_) {
          ...
          }), tt(e, "subject", g, !1, g.currentSrc || g.src || ""), On(e, g, { frameCount: g instanceof HTMLVideoElement ? 0 : 1 }), e.upstreamImageConnected = !0, n = !0, e.render(), e.setStatus(g instanceof HTMLVideoElement ? s("Upstream video preview synced") : s("Upstream image preview synced")));
        }
      }
      if (d === "audio") {
        l = !0;
        ...
        if (b && b.value) {
          const g = String(b.value), v = h.widgets?.find((x) => String(x.name).toLowerCase() === "subfolder")?.value || "", y = Ze(vt(g, v));
          try {
      ...
      if (d === "scene_3d" || d === "model" || d === "mesh") {
        ...
        if (b && b.value) {
          ...
          if (["glb", "gltf", "obj", "fbx", "stl", "ply"].includes(v)) {
            const y = h.widgets?.find((j) => String(j.name).toLowerCase() === "subfolder")?.value || "", x = Ze(vt(g, y)), k = `upstream_scene_${h.id}`;
            p.add(k);
            let u = e.state.objects.find((j) => j.id === k);
            u ? (u.asset = vt(g, y), u.format = v === "gltf" ? "glb" : v) : (u = {
              id: k,
              type: "model",
              format: v === "gltf" ? "glb" : v,
  ...
  bl(e) && (n = !0), n && (e.serialize(), e.render());
}
const nu = ["video/mp4;codecs=avc1.42E01E", "video/webm;codecs=vp9", "video/webm;codecs=vp8", "video/webm"], zn = { low: 3e6, balanced: 6e6, high: 12e6 };
function su(e) {
  ...
  try {
    for (const k of nu)
      if (!(n.isTypeSupported && !n.isTypeSupported(k)))
        try {
          f = new n(m, { mimeType: k, videoBitsPerSecond: su(r) });
          break;
        } catch {
        }
...
async function lu(e) {
  await Promise.all([...e].filter((t) => t instanceof HTMLVideoElement && t.seeking).map((t) => qs(t, ["seeked", "error"], { timeout: 5e3 }).catch(() => {
  })));
}
async function Ws(e) {
  await lu(e.cardMediaById.values());
}
async function Vs(e) {
  return iu({
    canvas: e.canvas,
...
async function Hs(e, t) {
  const a = await cu(at, t);
  if (Dh(e, t), e.state.playblast_camera_id === os)
...
async function mu(e) {
  ...
  const t = e.frame, a = e.canvas.width, o = e.canvas.height, r = du(e);
  (r.width !== e.canvas.width || r.height !== e.canvas.height) && (e.canvas.width = r.width, e.canvas.height = r.height, e.render());
  try {
    let n = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-CHLQYZ5A.js");
    ...
    }, e.abortController?.signal, e.state.playblast_quality)), n || (e.setStatus(s("WebCodecs unavailable; recording realtime fallback…")), n = await Vs(e)), e.setFrame(t), await Hs(e, n);
  } catch (n) {
...
async function fu(e, t) {
  ...
  let r = null;
  try {
    if (e.setStatus(`Uploading background: ${t.name}`), r = await Gs(t), o !== e.backgroundRequestId || e.disposed) {
      await Lo([r]);
      return;
    }
    const n = Ze(r.path);
...
async function hu(e, t) {
  ...
  try {
    ...
    for (const c of t)
      if (n.push(await Gs(c)), r !== e.backgroundRequestId || e.disposed) {
        await Lo(n);
        return;
      }
...
function bu(e) {
  ...
  for (const m of a) {
    ...
    r.fillStyle = "rgba(16,17,22,0.82)", gu(r, _, N, u, j, 4 * c), r.fill(), v && (r.strokeStyle = v, r.lineWidth = Math.max(1, c), r.stroke()), r.fillStyle = v || "#e6e6ec", r.fillText(f, _ + y, N + j - x - 2 * c);
  }
  r.restore();
}
function gu(e, t, a, o, r, n) {
...
function vu(e) {
  ...
  return e._pointFieldCache?.key !== r && (e._pointFieldCache = { key: r, ...Mc(t, a, o) }), e._pointFieldCache;
}
const xu = 600;
function wu(e) {
  const { points: t, colors: a } = vu(e);
  if (!t.length) return;
  const o = e.viewportCamera(), r = e.canvas.width, n = e.canvas.height, i = t.length / 3, c = 3 * Math.max(1, Math.ceil(i / xu)), l = /* @__PURE__ */ new Map();
...
function $u(e) {
  ...
  for (let o = 0; o < e.state.keyframes.length - 1; o++) {
    ...
    t.push(ts(Ut(n.camera.position, r.camera.position)) * e.state.fps / Math.max(1, n.frame - r.frame));
  }
...
function Mu(e) {
  ...
  e.recording && e.state.playblast_labels && bu(e);
}
async function Iu(e, { signal: t } = {}) {
    ...
    if (t.appendChild(x), !k)
      for (const { object: u, level: j } of y) {
        ...
        R.style.cssText = V ? "color:#fca5a5" : U ? "" : "opacity:.5;text-decoration:line-through", R.textContent = u.name || u.type, R.title = s("Double-click to rename"), R.addEventListener("dblclick", (E) => {
          E.preventDefault(), E.stopPropagation(), Du(e, u, R);
        }), C.appendChild(R);
        ...
        X.className = "scene-item-actions", X.appendChild(r(U ? "pi-eye" : "pi-eye-slash", U ? "Hide object (Alt+Click to Isolate)" : "Show object (Alt+Click to Isolate)", !U, (E) => {
          if (E?.altKey) {
            ...
            e.toggleObject(u.id);
        }, "color:#ef4444;opacity:.7")), X.appendChild(r(u.locked ? "pi-lock" : "pi-lock-open", "Lock object", u.locked, () => zr(e, u))), X.appendChild(r("pi-copy", "Duplicate object", !1, () => e.duplicateObject?.(u.id))), u.id !== "subject" && X.appendChild(r("pi-trash", "Delete object", !1, () => e.deleteObject?.(u.id))), X.appendChild(r("pi-ellipsis-v", "Object actions", !1, (E) => e.openObjectContext(E, u.id))), _.append(ne, C, X), _.title = s("Click to select · Double-click to toggle visibility · Right-click for actions");
        const z = (E = {}) => {
          ...
          if (e.finishCameraEdit(), e.selectedEntity = "object", e.selectedObjectIds ||= /* @__PURE__ */ new Set(), E.ctrlKey || E.metaKey)
            ...
            const F = e.state.objects.map((le) => le.id), G = F.indexOf(e.outlinerAnchorId), Q = F.indexOf(u.id);
            e.selectedObjectIds = new Set(F.slice(Math.min(G, Q), Math.max(G, Q) + 1));
          } else
          ...
          for (const F of t.querySelectorAll(".scene-item")) {
            const G = !!(F.dataset.objectId && e.selectedObjectIds.has(F.dataset.objectId)), Q = !!(F.dataset.objectId && F.dataset.objectId === e.selectedObjectId);
            F.classList.toggle("selected", G), F.classList.toggle("primary", Q), F.dataset.objectId && F.setAttribute("aria-selected", String(G));
          }
...
function Vu(e) {
  ...
  if (n) {
    const C = r.target_object_id || e.state.target_object_id || "", R = `T${Jr()}${e.state.objects.map((W) => `${W.id}\0${W.name || W.type}`).join("|")}`;
    tr(n, R, () => [
      qt("", s("Manual Target (No Tracking)")),
      ...e.state.objects.map((W) => qt(W.id, `${s("Track:")} ${W.name || W.type}`))
    ], C);
  }
  Ru(e);
  ...
  if (v) {
    ...
    const X = e.state.objects.filter((E) => !R.has(E.id)), z = `P${Jr()}${C}${X.map((E) => `${E.id} ${E.name || E.type}`).join("|")}`;
    tr(v, z, () => [
      qt("", s("No parent")),
  ...
  if (b && (b.hidden = !M?.animations), g) {
    ...
    tr(g, `A${C.join("|")}`, () => C.map((R, W) => qt(String(W), R)), String(t.animation_index || 0));
  }
...
function Xu(e) {
  ...
  e.beginCameraEdit(), Ic(e.camera, r), e.commitCameraEdit(), e.finishCameraEdit(), ti(e), Yu(e), e.render();
}
function Ju(e) {
  const t = globalThis.performance?.now?.() ?? Date.now();
  (!Number.isFinite(e.lastCameraHudEditAt) || t - e.lastCameraHudEditAt > 300) && e.checkpoint("Edit camera"), e.lastCameraHudEditAt = t;
  ...
  e.camera.position = [a("camera-px", e.camera.position[0]), a("camera-py", e.camera.position[1]), a("camera-pz", e.camera.position[2])], e.camera.target = [a("camera-tx", e.camera.target[0]), a("camera-ty", e.camera.target[1]), a("camera-tz", e.camera.target[2])], e.camera.fov = Z(a("camera-fov", e.camera.fov), 5, 150), e.camera.roll = Z(a("camera-roll", e.camera.roll || 0), -180, 180), e.camera.near = Math.max(1e-4, a("camera-near", e.camera.near)), e.camera.far = Math.max(e.camera.near + 1e-4, a("camera-far", e.camera.far)), e.beginCameraEdit(), e.commitCameraEdit(), e.finishCameraEdit(), ti(e), e.render();
}
function Zu(e, t) {
  const a = Qt(e);
  if (!a) return;
...
function tb(e) {
  ...
  if (!t.length) return [];
  if (t.length === 1)
    return Zs(e, t[0]), e.selectedObjectId ? [e.selectedObjectId] : [];
...
const vb = ["guides", "safe-areas", "resolution-gate", "aspect-ratio"];
function xb(e) {
...
function Tb(e, t, a, { prevKey: o = null, nextKey: r = null, breakCoupling: n = !1 } = {}) {
  if (!e || t !== "in" && t !== "out") return e;
  let i = lt(e);
  if (i === "corner") return e;
  i === "auto" && (i = "aligned", e.tangents = e.tangents && typeof e.tangents == "object" ? e.tangents : {}, e.tangents.spatial_mode = "aligned", ri(e, o, r));
  const c = Fe(e), l = Ct([
    Te(a?.[0]),
    Te(a?.[1]),
    Te(a?.[2])
...
function $b(e, t, { prevKey: a = null, nextKey: o = null } = {}) {
...
function Ob(e) {
  ...
  return {
    ...
    restoreHistorySnapshot(L) {
      ...
      const S = Rn(this.state), w = new Set(this.state.objects.map((ae) => ae.id));
      this.state = ht($.state);
      const A = new Set(this.state.objects.map((ae) => ae.id));
      for (const ae of w) A.has(ae) || this.removeObjectResources(ae);
      this.frame = Nt($.frame, 0, this.state.duration_frames - 1);
      const I = new Set(this.state.objects.map((ae) => ae.id)), K = Array.isArray($.selectedObjectIds) ? $.selectedObjectIds : [$.selectedObjectId].filter(Boolean);
      this.selectedObjectIds = new Set(K.filter((ae) => I.has(ae))), this.selectedObjectId = this.selectedObjectIds.has($.selectedObjectId) ? $.selectedObjectId : [...this.selectedObjectIds].at(-1) || null, this.selectedEntity = this.selectedObjectIds.size ? "object" : $.selectedEntity || "camera";
      const J = new Set(this.timelineKeyframes().map((ae) => ae.frame)), D = Array.isArray($.selectedKeyFrames) ? $.selectedKeyFrames : [$.selectedKeyFrame].filter((ae) => ae != null);
      this.selectedKeyFrames = new Set(D.filter((ae) => J.has(ae))), this.selectedKeyFrame = this.selectedKeyFrames.has($.selectedKeyFrame) ? $.selectedKeyFrame : [...this.selectedKeyFrames].at(-1) ?? null, this.pathSelection = Oc(this.pathSelection, this.activeCameraTrack()), this.subSelection = $.subSelection || null, this.camera = ft(this.state, this.frame), Vt(this, this.activeCameraTrack(), this.camera, this.frame), this.cameraPreviewSignature = "", this.serialize(), S !== Rn(this.state) && this.restoreAssets(), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
    },
    checkpoint(L) {
    ...
    onContextMenu(L) {
      ...
      const $ = L.target, S = $.closest?.(".camera-preview-tile"), w = $.closest?.(".scene-item"), A = $.closest?.(".key");
    ...
    openObjectContext(L, $) {
      ...
      const w = ["sun_light", "point_light", "spot_light"].includes(S.type), A = this.selectedObjectIds?.size || 0;
      ...
      this.showContextMenu(L, S.name || S.type, [
        ...
        { label: S.locked ? s("Unlock object") : s("Lock object"), icon: S.locked ? "pi-lock" : "pi-lock-open", run: () => zr(this, S) },
        null,
        {
          label: s("Transform mode"),
          icon: "pi-arrows-alt",
    ...
    moveShot(L, $) {
      ...
      const [A] = this.state.cameras.splice(S, 1);
    ...
    openTimelineContext(L, $) {
      const S = this.selectedKeyFrames?.size || 0, w = this.selectedKeyframe(), A = w?.interpolation || "ease", I = w && lt(w) || "auto", K = ["ease", "linear", "bezier", "smooth", "ease_in", "ease_out", "sine", "cubic", "quintic", "expo", "back"], J = ["auto", "clamped", "vector", "free", "aligned", "flat"];
    ...
    openCurveContext(L) {
      const $ = this.selectedKeyFrames?.size || 0, S = $ < 2 && !this.selectedKeyframe(), w = this.selectedKeyframe(), A = w?.interpolation || "ease", I = w && lt(w) || "auto", K = ["bezier", "smooth", "linear", "ease_in", "ease_out", "ease", "sine", "cubic", "quintic", "expo", "back"], J = ["auto", "clamped", "vector", "free", "aligned", "flat"];
    ...
    resizeCanvas() {
      ...
      if (!L) return;
      const $ = Math.min(2, window.devicePixelRatio || 1), S = L.clientWidth || 320, w = L.clientHeight || 180, A = Math.max(320, Math.round(S * $)), I = Math.max(180, Math.round(w * $));
      ...
      for (const K of this.cameraPreviewCanvases.values()) {
        const J = K.clientWidth || 220, D = K.clientHeight || 124, ae = Math.max($, Ib / Math.max(1, J)), ke = Math.max(1, Math.round(J * ae)), Ke = Math.max(1, Math.round(D * ae));
        (K.width !== ke || K.height !== Ke) && (K.width = ke, K.height = Ke);
      }
...
function Wr(e, t) {
  const a = e.map((i) => zb(i, t)), o = Nb(a), r = e.map((i) => i.frame), n = Math.max(1, r[r.length - 1] - r[0]);
  return a.map((i, c) => [
    (r[c] - r[0]) / n,
...
function Rb(e, t, { tolerance: a = 0.02, keepFrames: o = [] } = {}) {
...
function Db(e, t, { target: a = 2, keepFrames: o = [] } = {}) {
...
function Kb(e, t, { mergeWithin: a = 1, epsilon: o = 1e-3, keepFrames: r = [] } = {}) {
...
function qb(e, t, a, { lastFrame: o = 1 / 0 } = {}) {
...
function Gb(e, { leftFrame: t, rightFrame: a, t: o = 0.5 } = {}) {
  const r = [...e].sort((k, u) => k.frame - u.frame), n = r.findIndex((k) => k.frame === t), i = n >= 0 ? n + 1 : -1;
  if (n < 0 || i < 0 || i >= r.length || r[i].frame !== a)
    return { ok: !1, reason: "segment_not_found" };
  if (a - t < 2)
    return { ok: !1, reason: "no_free_frame" };
  const c = Math.min(0.999, Math.max(1e-3, Number.isFinite(o) ? o : 0.5)), l = Math.round(t + c * (a - t)), p = Hb(r, t, a, l);
  if (p < 0) return { ok: !1, reason: "no_free_frame" };
  const m = (p - t) / (a - t), f = r[n], d = r[i], h = n > 0 ? r[n - 1] : null, b = i + 1 < r.length ? r[i + 1] : null, g = f.interpolation === "bezier" || d.interpolation === "bezier", v = $e({ keyframes: r }, p), y = { frame: p, interpolation: g ? "bezier" : f.interpolation, camera: v };
  if (g) {
    const k = [...f.camera.position], u = vr(f, h, d).out, j = vr(d, f, b).in, _ = [...d.camera.position], N = Vb(k, u, j, _, m);
    y.camera = { ...ce(v), position: [...N.point] };
    const M = lt(f);
    (M === "free" || M === "aligned") && wo(f, "out", N.left[1]);
    const Y = lt(d);
    (Y === "free" || Y === "aligned") && wo(d, "in", N.right[2]), wo(y, "in", N.left[2]), wo(y, "out", N.right[1]);
  }
  return { ok: !0, keys: [...r, y].sort((k, u) => k.frame - u.frame), frame: p };
}
const Kn = { motion: "motion", shot: "display", health: "health" }, Yb = {
  object: "Object",
  camera: "Camera",
  camera_target: "Look-At Target",
  camera_path: "Camera Path"
}, Xb = { motion: "Motion", shot: "Shot", health: "Health" }, Jb = ["entity", "motion", "shot", "health"];
function ii(e) {
...
function eg(e) {
  const t = Qb(e);
  e._lastInspectorSelKey !== void 0 && e._lastInspectorSelKey !== t && (e.inspectorMode = "entity"), e._lastInspectorSelKey = t, ci(e);
}
function ci(e) {
  const t = Zb(e);
...
function ag(e) {
  ...
  return {
    ...
    setFrame(w, A = !1, I = !0) {
      ...
      const K = this.dom ||= Ts(this.root);
      for (const ee of K.frames) document.activeElement !== ee && (ee.value = String(this.frame));
      for (const ee of K.scrubs) ee.value = String(this.frame);
      for (const ee of K.cameraFov) document.activeElement !== ee && (ee.value = String(Math.round(this.camera.fov * 100) / 100));
      for (const ee of K.cameraRoll) document.activeElement !== ee && (ee.value = String(Math.round((this.camera.roll || 0) * 100) / 100));
      for (const ee of K.cameraFocal) document.activeElement !== ee && (ee.value = $r(this.camera.fov));
      for (const ee of K.viewportZoom) ee.textContent = `${(Number(this.camera.zoom) || 1).toFixed(2)}x`;
      for (const ee of K.cameraType) document.activeElement !== ee && (ee.value = this.camera.camera_type || "perspective");
      for (const ee of K.cameraNear) document.activeElement !== ee && (ee.value = String(this.camera.near ?? 0.01));
      for (const ee of K.cameraFar) document.activeElement !== ee && (ee.value = String(this.camera.far ?? 1e4));
      const J = this.frame / this.state.fps;
      for (const ee of this.cardMediaById.values()) ee instanceof HTMLVideoElement && Number.isFinite(ee.duration) && ee.duration > 0 && (ee.currentTime = J % ee.duration);
      const D = Math.floor(J / 60), ae = Math.floor(J % 60), ke = Math.floor(J % 1 * 1e3), Ke = this.frame % Math.max(1, Math.round(this.state.fps)), nt = Math.floor(this.frame / this.state.fps);
      if ((K.time || this.root.querySelector('[data-role="time"]')).textContent = this.state.timecode_mode === "timecode" ? `${String(Math.floor(nt / 3600)).padStart(2, "0")}:${String(Math.floor(nt / 60) % 60).padStart(2, "0")}:${String(nt % 60).padStart(2, "0")}:${String(Ke).padStart(2, "0")}` : `${String(D).padStart(2, "0")}:${String(ae).padStart(2, "0")}.${String(ke).padStart(3, "0")}`, I) this.refreshKeys();
      else {
        To(this);
        for (const ee of this.root.querySelectorAll("[data-key-frame]")) {
          const re = Number(ee.dataset.keyFrame);
          ee.classList.toggle("at-playhead", re === this.frame), ee.classList.toggle("selected", re === this.selectedKeyFrame), ee.classList.toggle("editing", re === this.editingKeyFrame);
        }
    ...
    setSpatialHandleMode(w) {
      ...
      const I = this.activeCameraTrack()?.keyframes || [], K = I.findIndex((J) => J.frame === this.selectedKeyFrame);
      if (K < 0) {
        this.setStatus(s("Select a camera keyframe first"));
        return;
      }
      this.checkpoint(s("Camera path handle: {mode}").replace("{mode}", w)), $b(I[K], w, {
        prevKey: I[K - 1] || null,
        nextKey: I[K + 1] || null
    ...
    insertPathKeyAtCursor(w) {
      ...
      const A = this.interactionElement.getBoundingClientRect(), I = (w.clientX - A.left) * this.canvas.width / Math.max(1, A.width), K = (w.clientY - A.top) * this.canvas.height / Math.max(1, A.height), J = this.webgl.pickPathSegment([I, K]);
      if (!J) return !1;
      const D = (this.state.cameras || []).find((ke) => ke.id === J.cameraId);
      if (!D || D.locked) return !1;
      const ae = Gb(D.keyframes || [], {
        leftFrame: J.leftFrame,
        rightFrame: J.rightFrame,
        t: J.t
      });
      return ae.ok ? (this.checkpoint(s("Insert camera path key")), D.id !== this.state.active_camera_id && this.activateCamera(D.id), D.keyframes = ae.keys, this.state.keyframes = ae.keys, this.camera = De(D, this.frame, this.state.objects), D.camera = ft(this.camera), Pc(this, { cameraId: D.id, frame: ae.frame, additive: !1 }), this.serialize(), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), this.setStatus(s("Camera path key inserted at frame {frame}").replace("{frame}", String(ae.frame))), !0) : (this.setStatus(ae.reason === "no_free_frame" ? s("No free frame here to insert a key") : s("Could not insert a key here")), !0);
    },
    ...
    transformCameraPath(w) {
      ...
      const I = es(A.keyframes, { origin: Qn(A.keyframes), ...w });
      return A.keyframes = I, A.id === this.state.active_camera_id && (this.state.keyframes = I), this.camera = De(A, this.frame, this.state.objects), A.camera = ft(this.camera), this.serialize(), this.refreshKeys(), this.refreshInspector(), this.render(), this.renderCameraView?.(), !0;
    },
    toggleCurveHandles() {
      Ot(this);
    },
    ...
    refreshInspector() {
      this.perf && (this.perf.inspectorRefreshCount = (this.perf.inspectorRefreshCount || 0) + 1), qa(this), eg(this);
    },
    setInspectorMode(w) {
      tg(this, w);
    },
    ...
    aimAtSelectedObject(w) {
      ...
      const J = (I.type === "model" || I.type === "glb" ? this.webgl?.getObjectWorldCenter?.(I.id) : null) || (I.keyframes?.length ? L(I, this.frame).position : I.position || [0, 1.5, 0]);
      this.camera.target = [...J], this.beginCameraEdit(), this.commitCameraEdit(), this.finishCameraEdit(), this.serialize(), this.refreshInspector(), this.updateHudCamera(), this.render(), this.setStatus(`Camera tracking locked to ${I.name || I.id}`);
    },
    setAimBone(w) {
      Nu(this, w);
    },
    ...
    bakeAimToKeyframes() {
      ...
      const w = this.activeCameraTrack(), A = w.target_object_id || this.state.target_object_id || "subject", I = this.state.objects.find((J) => J.id === A) || this.state.objects[0];
      ...
      for (const J of w.keyframes) {
        const D = (I.type === "model" || I.type === "glb") && K && !I.keyframes?.length ? K : I.keyframes?.length ? L(I, J.frame).position : I.position || [0, 1.5, 0];
        J.camera.target = [...D];
      }
...
function og(e) {
  ...
  return {
    ...
    async loadMediaUrl(S, w, A, I) {
      return va(this, S, w, A, I);
    },
    restoreAssets() {
      Sa(this);
    },
...
function ng(e) {
  const { right: t, up: a, forward: o } = Lc(e || {});
  return rg.map((r) => {
...
const cg = "http://www.w3.org/2000/svg", wt = 26, Bn = 17, lg = 5.4;
function kt(e, t) {
  const a = document.createElementNS(cg, e);
...
function dg(e) {
  ...
  for (const n of sg(ng(a))) {
    const i = wt + n.x * Bn, c = wt + n.y * Bn, l = ig(n.depth);
...
const fg = ["world_point", "object_point", "camera_field"], li = {
  manual_2d: "DRAW",
  object_point: "OBJECT",
  world_point: "WORLD",
...
function yg(e) {
  ...
  n("motion-sel-name", a.label), n("motion-sel-type", li[a.source_kind] || "TRACK"), n("motion-sel-binding", hg(e.state, a)), n("motion-sel-start", r.length ? Math.min(...r) : 0), n("motion-sel-end", r.length ? Math.max(...r) : 0);
...
function wg(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: b, syncActiveCameraTrack: g, syncFromWidgets: v, bindEditorEvents: y, activateCamera: x, addCamera: k, deleteCamera: u, drawPreviewOverlays: j, duplicateCamera: _, maximizeCameraPreview: N, refreshCameraPreviews: M, refreshCameraSelectors: Y, renameCamera: U, setPlayblastCamera: V, toggleCameraView: ne, captureRealtime: C, makePlayblast: R, uploadDirectorPlayblast: W, waitForMediaFrame: X, computeAudioPeaks: z, loadAudioFile: E, releaseAudio: H, stopPlay: F, togglePlay: G, applyCameraPreset: Q, applyCameraShake: le, applyProxyPreset: se, clearViewportBgImage: oe, loadViewportBgFile: de, loadViewportBgSequence: be, drawCameraPath: fe, drawCard: ge, drawCube: ye, drawCylinder: pe, drawGrid: Me, drawHuman: ve, drawLine3D: xe, drawNull: ue, drawOverlays: P, drawPointField: q, drawSpeedHeatmap: me, drawSphere: je, drawTorus: Oe, curveChannels: Re, drawCurveEditor: Pe, onCurvePointerDown: ot, onCurvePointerMove: ea, onCurvePointerUp: ta, onTimelinePointerDown: aa, onTimelinePointerMove: At, onTimelinePointerUp: Tt, refreshKeys: pt, resetCurveZoom: $t, resetTimelineZoom: Mt, setChannelFilter: It, setCurveInterpolation: oa, setTangentMode: Ot, timelineFrameFromEvent: ra, toggleCurveHandles: na, zoomCurve: sa, drawTransformGizmo: ia, frameTarget: ca, gizmoAxes: la, gizmoGeometry: da, onPointerDown: ma, onPointerMove: pa, onPointerUp: fa, onWheel: ha, pickGizmo: Pt, pickSceneObject: Lt, resetCamera: ua, setTransformMode: ba, setViewMode: Bo, viewportCamera: qo, loadCardFile: ga, loadExecutionPreview: ya, loadMediaUrl: va, loadModelFile: xa, loadSelectedReference: wa, onModelLoaded: ka, restoreAssets: Sa, syncUpstreamInputs: zt, configureDomMedia: ja, refreshSetupDiagnostic: _a, addMediaCard: Ca, addPrimitive: Ea, applyObjectAnimationFrame: Aa, beginCameraEdit: Ta, beginObjectEdit: $a, commitCameraEdit: Ma, commitObjectEdit: Ia, copyKeyframe: Oa, deleteKeyframe: Pa, deleteObject: La, duplicateObject: za, exitKeyEdit: Na, finishCameraEdit: Fa, goToAdjacentKey: Ra, insertKeyframe: Da, loadSelectedKeyView: Ka, pasteKeyframe: Ba, playblastCameraAtFrame: qa, refreshInspector: Ua, refreshKeyEditor: Wa, refreshObjects: Va, removeObjectResources: Ha, renameObject: Ga, retimeSelectedKey: Ya, selectKeyframe: Xa, selectedKeyframe: Ja, selectedObject: Za, selectObjectAnimation: Qa, setKeyInterpolation: eo, setObjectParent: rt, timelineKeyframes: to, timelineObject: ao, toggleAutoKey: oo, toggleObject: ro, updateCameraFromHud: no, updateEditState: so, updateKeyVisualState: io, updateSelectedKey: Nt, updateSelectedObject: co, clamp: lo, cloneCamera: mo, configureCore: ft, defaultCamera: Uo, sampleCamera: ht, sampleObjectTransform: De, sanitizeState: L, worldTransform: $ } = e;
  return {
    ...
    renderViewportOnly() {
      const S = this.ctx, w = this.canvas.width, A = this.canvas.height;
      if (S.fillStyle = this.state.viewport_bg_color || "#121212", S.fillRect(0, 0, w, A), this.viewportBgSequenceImages && this.viewportBgSequenceImages.length) {
        const re = this.frame % this.viewportBgSequenceImages.length, Ye = this.viewportBgSequenceImages[re];
        if (Ye?.complete && Ye.naturalWidth)
          try {
            S.drawImage(Ye, 0, 0, w, A);
          } catch {
          }
      } else if (this.viewportBgImage)
        try {
          S.drawImage(this.viewportBgImage, 0, 0, w, A);
        } catch {
        }
      const I = this.state.render_mode, K = this.viewportCamera(), J = this.state.objects.some((re) => re.parent_id) ? this.state.objects.map((re) => re.parent_id ? { ...re, ...$(this.state.objects, re) } : re) : this.state.objects, D = (this.viewportBgSequenceImages || []).map((re) => re.src), ae = this.viewportBgImage?.src || "", ke = this.pendingExtractorImport, Ke = ke ? [...this.state.cameras, {
      ...
      if (this.webgl) {
        try {
          const re = this.recording ? 1 : this.webgl.supersampleFactor?.() ?? 1, Ye = re > 1 ? Math.min(re, 4096 / Math.max(1, w, A)) : 1, po = Ye > 1 ? Math.round(w * Ye) : w, Wo = Ye > 1 ? Math.round(A * Ye) : A;
          this.webgl.render(nt, K, this.cardMediaById, po, Wo, this.modelUrlsById, this.frame, this.recording, this.selectedEntity, this.selectedObjectId, this.subSelection, this.selectedKeyFrame ?? null, this.selectedKeyFrames ? [...this.selectedKeyFrames] : null), S.imageSmoothingEnabled = !0, S.imageSmoothingQuality = "high", po !== w || Wo !== A ? S.drawImage(this.webgl.canvas, 0, 0, po, Wo, 0, 0, w, A) : S.drawImage(this.webgl.canvas, 0, 0, w, A), ee = !0;
        } catch (re) {
          console.error("[OmniCam WebGL Render Error]", re);
        }
      ...
      if (!ee) {
        ...
        for (const re of J)
          re.enabled !== !1 && (re.type === "card" && ["omni_ref", "card_grid", "graybox", "wireframe"].includes(I) ? this.drawCard(re) : ["cube", "ground", "glb", "model"].includes(re.type) && I !== "grid" && I !== "point_field" ? this.drawCube(re) : re.type === "sphere" && I !== "grid" && I !== "point_field" ? this.drawSphere(re) : re.type === "cylinder" && I !== "grid" && I !== "point_field" ? this.drawCylinder(re) : re.type === "torus" && I !== "grid" && I !== "point_field" ? this.drawTorus(re) : re.type === "human" && I !== "grid" && I !== "point_field" ? this.drawHuman(re) : re.type === "null" && this.drawNull(re));
        !this.recording && this.state.show_camera_paths && this.drawCameraPath();
      }
      !this.recording && this.state.speed_heatmap && this.drawSpeedHeatmap(), !this.recording && Sh(this), this.drawOverlays(), pg(this), this.state.show_gizmo && dg(this), this.labelOverlay?.update(), this.rigOverlay?.update(), this.perf && (this.perf.viewportRenderCount = (this.perf.viewportRenderCount || 0) + 1);
    },
    ...
    requestUiUpdate(S = T.viewport, w = "unknown") {
      (this.renderReasons ||= /* @__PURE__ */ new Set()).add(w), this.uiDirtyMask = Gm(this.uiDirtyMask, S), this.renderInvalidations = (this.renderInvalidations || 0) + 1, !this.renderScheduled && (this.renderScheduled = !0, this.renderFrame = requestAnimationFrame(() => {
    ...
    renderCameraView() {
      if (this.perf && (this.perf.previewRenderCount = (this.perf.previewRenderCount || 0) + 1), this.state.camera_view_visible) {
        ...
        let I = null;
        if (A) {
          const K = this.state.active_camera_id, J = w.filter((D) => D.id !== K);
          I = J.length ? J[this.cameraPreviewTick % J.length] : null;
        }
        for (const K of w) {
          const J = this.cameraPreviewCanvases.get(K.id), D = this.cameraPreviewContexts.get(K.id);
          if (!J?.width || !D) continue;
          const ae = J.width, ke = J.height, Ke = this.root.querySelector(`[data-camera-frame="${K.id}"]`);
          if (Ke && (Ke.textContent = `F${this.frame}`), A && K.id !== this.state.active_camera_id && K !== I) continue;
          const nt = Vt(this, K, ht(K, this.frame, this.state.objects), this.frame);
          if (D.fillStyle = "#111", D.fillRect(0, 0, ae, ke), this.cameraWebgl)
            try {
              this.cameraWebgl.render({ ...this.state, keyframes: [], playblast_grid: !1, viewport_bg_image: this.viewportBgImage?.src || "", viewport_bg_sequence: (this.viewportBgSequenceImages || []).map((ee) => ee.src), __omnicamRevision: this.renderRevision || 0 }, nt, this.cardMediaById, ae, ke, this.modelUrlsById, this.frame, !0), D.drawImage(this.cameraWebgl.canvas, 0, 0, ae, ke);
            } catch (ee) {
    ...
    dispose() {
      this.disposed || (this.disposed = !0, this.agentBridge?.dispose?.(), this.transformControlsWiring?.dispose(), zc(this), Nc(), yl(this), this.backgroundRequestId = (this.backgroundRequestId || 0) + 1, this.upstreamSyncId = (this.upstreamSyncId || 0) + 1, this.stopPlay(), clearTimeout(this.previewClickTimer), clearTimeout(this.connectionTimer), cancelAnimationFrame(this.restoreFrame), cancelAnimationFrame(this.serializeFrame), cancelAnimationFrame(this.resizeFrame), cancelAnimationFrame(this.renderFrame), this.abortController?.abort(), this.upstreamFetchController?.abort(), this.resizeObserver?.disconnect(), this.contextMenu?.dispose(), this.webgl?.dispose(), this.cameraWebgl?.dispose(), H(this), Xh(this), this.objectUrls.clear(), this.cardMediaById.clear(), this.cardMediaAssetById?.clear?.(), this.modelUrlsById.clear(), this.modelInfoById.clear());
    }
  };
}
const kg = 0.12;
function Sg() {
  return {
    ...
    deleteSelectedKeyframes() {
      ...
      const t = this._activeTrack(), a = Ee(this), o = t.kind === "camera" ? 1 : 0, { keys: r, removed: n } = Bb(a, e, { minKeys: o });
    ...
    nudgeSelectedKeyframes(e) {
      ...
      const a = this._activeTrack(), o = Math.max(0, this.state.duration_frames - 1), r = qb(Ee(this), t, e, { lastFrame: o });
    ...
    setSelectedKeysInterpolation(e) {
      ...
      this.checkpoint(s("Interpolation on {n} keys").replace("{n}", t.length)), a.write(Ub(Ee(this), t, e)), this.serialize(), this.refreshKeys(), this.refreshKeyEditor(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} interpolation on {n} keys").replace("{mode}", e.replace(/_/g, " ")).replace("{n}", t.length));
    },
    setSelectedKeysTangentMode(e) {
      const t = this.resolveSelectedFrames();
      if (t.length < 2) return this.setTangentMode(e);
      const a = this._activeTrack(), o = mt(this).map((r) => r.id);
      this.checkpoint(s("Tangents on {n} keys").replace("{n}", t.length)), a.write(Wb(Ee(this), t, e, o)), this.serialize(), this.refreshKeys(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} tangents on {n} keys").replace("{mode}", e).replace("{n}", t.length));
    },
    /**
    ...
    simplifyActiveKeys({ mode: e = "simplify", tolerance: t = 0, target: a = 0, scope: o = "camera", fromKeys: r = null, silent: n = !1 } = {}) {
      ...
      const l = this.resolveSelectedFrames(), p = o !== "all_cameras" && l.length >= 2 ? [l[0], l.at(-1)] : null, m = p ? [] : l, f = (b) => {
        ...
        let j = k, _ = 0;
        if (k.length > 2) {
          const N = e === "reduce" ? Db(k, i, { target: a || Math.ceil(k.length / 2), keepFrames: m }) : e === "clean" ? Kb(k, i, { keepFrames: m }) : Rb(k, i, { tolerance: t * kg, keepFrames: m });
...
class di {
  constructor(t) {
    this.app = qn, this.api = at, this.node = t, this.root = ks(), this.root.tabIndex = -1, this.dom = Ts(this.root), this.canvas = this.root.querySelector(".viewport-wrap > canvas"), this.cameraPreviewCanvases = /* @__PURE__ */ new Map(), this.cameraPreviewContexts = /* @__PURE__ */ new Map(), this.cameraPreviewSignature = "", this.interactionElement = this.canvas, this.interactionElement.tabIndex = 0, this.interactionElement.dataset.captureWheel = "true", this.ctx = this.canvas.getContext("2d", { alpha: !1 }), this.disposed = !1, this.renderRevision = 0, this.directorRevision = 0, this.webgl = null, this.cameraWebgl = null, this.webglReady = this.loadWebGLViewports(), this.transformControlsWiring = rf(this), this.stateWidget = t.widgets?.find((o) => o.name === "state_json"), this.recordingWidget = t.widgets?.find((o) => o.name === "recording_path"), this.cardWidget = t.widgets?.find((o) => o.name === "card_asset"), this.widthWidget = t.widgets?.find((o) => o.name === "width"), this.heightWidget = t.widgets?.find((o) => o.name === "height"), this.fpsWidget = t.widgets?.find((o) => o.name === "fps"), this.durationWidget = t.widgets?.find((o) => o.name === "duration_seconds"), this.modeWidget = t.widgets?.find((o) => o.name === "render_mode");
    let a = null;
    try {
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-CHLQYZ5A.js"));
    } catch (a) {
    ...
    if (!this.disposed) {
      ...
      Rc(this), this.resizeCanvas(), this.render(), this.renderCameraView();
    }
  }
}
const ko = { app: qn, api: at, EditorHistory: xs, ContextMenuController: ss, initializeTooltips: xl, promptText: Yt, ObjectUrlRegistry: ws, buildRoot: ks, dispatchDirectorKey: Dc, activeCameraTrack: sr, bindWidgetCallbacks: wl, playblastCameraTrack: ns, restoreFromWidgets: kl, serializeEditorState: Sl, syncActiveCameraTrack: ir, syncFromWidgets: jl, bindEditorEvents: Nh, activateCamera: _l, addCamera: Cl, deleteCamera: El, drawPreviewOverlays: Al, duplicateCamera: Tl, maximizeCameraPreview: $l, refreshCameraPreviews: Ml, refreshCameraSelectors: Il, renameCamera: Ol, setPlayblastCamera: Pl, toggleCameraView: Ll, captureRealtime: Vs, makePlayblast: mu, uploadDirectorPlayblast: Hs, waitForMediaFrame: Ws, computeAudioPeaks: Ds, loadAudioFile: Hh, releaseAudio: Oo, stopPlay: Eo, togglePlay: Uh, applyCameraPreset: nf, applyCameraShake: sf, applyProxyPreset: cf, clearViewportBgImage: uu, loadViewportBgFile: fu, loadViewportBgSequence: hu, drawCameraPath: Tu, drawCard: Au, drawCube: ku, drawCylinder: _u, drawGrid: yu, drawHuman: ju, drawLine3D: ie, drawNull: Eu, drawOverlays: Mu, drawPointField: wu, drawSpeedHeatmap: $u, drawSphere: Su, drawTorus: Cu, curveChannels: mt, drawCurveEditor: vd, fitCurveView: hs, onCurveDoubleClick: gd, onCurvePointerDown: cd, onCurvePointerMove: ld, onCurvePointerUp: dd, onTimelinePointerDown: Kc, onTimelinePointerMove: Bc, onTimelinePointerUp: qc, refreshKeys: Pd, resetCurveZoom: yd, resetTimelineZoom: Uc, setChannelFilter: pd, setCurveInterpolation: md, setTangentMode: fd, timelineFrameFromEvent: xr, toggleCurveHandles: hd, zoomCurve: bd, drawTransformGizmo: Wc, frameTarget: Vc, gizmoAxes: Hc, gizmoGeometry: Gc, onPointerDown: Yc, onPointerMove: Xc, onPointerUp: Jc, onWheel: Zc, pickGizmo: Qc, pickSceneObject: el, resetCamera: tl, setTransformMode: al, setViewMode: ol, viewportCamera: rl, loadCardFile: tu, loadExecutionPreview: au, loadMediaUrl: Us, loadModelFile: eu, loadSelectedReference: ou, onModelLoaded: Qh, restoreAssets: Zh, syncUpstreamInputs: ru, configureDomMedia: Ks, refreshSetupDiagnostic: Pu, addMediaCard: Wu, addPrimitive: Ku, applyObjectAnimationFrame: ib, beginCameraEdit: hb, beginObjectEdit: ei, commitCameraEdit: ub, commitObjectEdit: Gu, copyKeyframe: mb, deleteKeyframe: db, deleteObject: Qs, deleteSelectedObjects: Uu, duplicateObject: Zs, exitKeyEdit: gb, finishCameraEdit: bb, goToAdjacentKey: Eb, insertKeyframe: cb, loadSelectedKeyView: Cb, pasteKeyframe: pb, playblastCameraAtFrame: sb, refreshInspector: Vu, refreshKeyEditor: Sb, refreshObjects: Js, removeObjectResources: eb, renameObject: Bu, retimeSelectedKey: jb, selectKeyframe: fb, selectedKeyframe: Ge, selectedObject: Qt, selectObjectAnimation: Qu, setKeyInterpolation: lb, setKeyTangentMode: kb, setObjectParent: Zu, timelineKeyframes: Ee, timelineObject: ze, toggleAutoKey: yb, toggleObject: qu, updateCameraFromHud: Ju, updateCameraRotationFromHud: Xu, updateEditState: xb, updateKeyVisualState: wb, updateSelectedKey: _b, updateSelectedObject: Hu, clamp: Z, cloneCamera: ce, configureCore: rs, defaultCamera: Sr, sampleCamera: $e, sampleObjectTransform: Fo, sanitizeState: _r, worldTransform: Cr };
Object.assign(
  di.prototype,
  Ob(ko),
  ag(ko),
...
function jg(e) {
  ...
  const t = new di(e);
  So("director:constructor:complete", e), wp(t);
  try {
    t.agentBridge = Ap(t, e, at);
  } catch (m) {
  ...
  try {
    t.assetBrowser = qp(t, {
      ...
      onAgentFirstOpen: async () => {
        if (or())
          try {
            const { createDirectorAgentPanel: m } = await import("./chunk-2LBq6k2F.js");
            t.agentPanel = m(t);
          } catch (m) {
  ...
  try {
    t.characterRuntime = Wp(t), t.rigMapper = Hp(t), t.poseEditor = Xp(t), t.motionEditor = Jp(t);
  } catch (m) {
  ...
  }, t.unwatchGraphConnections = vl(e, i);
  const l = e.onRemoved;
