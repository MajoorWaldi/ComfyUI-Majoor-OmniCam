import { c as w, bD as g, e as k, b1 as A, bE as oe, y as $, s as M, bF as re, b9 as O, a as v, g as H, b2 as W, bG as ne } from "./chunk-BQzFpTKV.js";
...
`, V = 24, G = 5, J = 150, Y = Math.PI / 180;
function X(e, t, a) {
  return Math.min(a, Math.max(t, e));
}
function de(e, t = V) {
  const a = X(Number(e) || 0, G, J);
