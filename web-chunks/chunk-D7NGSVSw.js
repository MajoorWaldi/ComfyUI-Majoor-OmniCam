...
import { a3 as vt, a4 as yt, T as xt } from "./chunk-BZZ_o2vU.js";
import { m as wt, g as it, n as kt, L as St, h as Et, S as W, r as Ct, i as Mt, j as Tt, k as Nt, p as _t, l as At, F as Rt } from "./chunk-DUVJmuta.js";
...
function ar(r) {
  return import("./chunk-CcucaRIo.js").then(({ TrackViewer: t }) => (r.viewerLoad = null, r.disposed || r.viewer || (r.viewer = new t(r.$("track-canvas")), r.pushTracksToViewer()), r.viewer)).catch((t) => (r.viewerLoad = null, console.warn("OmniCam track viewer unavailable", t), null));
}
function rt(r) {
  const t = r.$("frame");
