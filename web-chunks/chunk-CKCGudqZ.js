...
import { a as xe, z as Z, C as pe, u as r, E as Rr, F as Ao, G as Ie, c as le, H as oo, J as os, K as To, L as qr, M as rs, N as ns, O as ss, Q as is, R as ko, v as Zo, T as Br, U as wo, V as Wr, W as Vr, X as Hr, Y as Ur, i as Gr, Z as So, _ as lo, $ as Jo, a0 as Qo, a1 as Xr, k as er, a2 as cs, a3 as ls, a4 as ds, a5 as ms, a6 as ps, g as ye, p as Yr, h as Zr, a7 as tr, e as _e, a8 as fs, a9 as Jr, t as hs, aa as bs, ab as Po, ac as us, ad as gs, o as ys, ae as vs, af as xs, ag as ks, ah as Io, ai as ws, aj as Ss, ak as js, al as Cs, am as Es, an as _s, ao as $s, ap as Ms, aq as As, ar as Ts, as as Ps, at as Is, au as zs, av as Fs, aw as Ls, ax as Os, ay as Ks, az as Ds, aA as Ns, aB as Rs, aC as qs, aD as Bs, aE as Ws, aF as Vs, aG as Hs, aH as Us, aI as Gs, aJ as Xs, aK as Ys, aL as Zs, aM as Js, aN as Qs, aO as ei, aP as ti, aQ as ai, aR as oi, aS as ri, aT as ni, aU as si, aV as ii, aW as ci, aX as li, aY as di, l as Be, aZ as mi, a_ as mo, a$ as pi, b0 as fi, b1 as hi, b2 as bi, b3 as ui, b4 as Pe, b5 as gi, b6 as Qr, b7 as zo, b8 as yi, b9 as vi, ba as xi, S as en, bb as Ke, bc as ki, bd as wi, be as ar, bf as Fo, bg as Si, bh as tn, bi as ji, bj as Ci, bk as Ei, b as an, r as _i, bl as $i, bm as Mi, bn as Ai, bo as Ti, y as Pi, bp as Ii, bq as zi, br as Fi, bs as on, bt as Li, bu as Oi, bv as Ki, bw as Di, bx as Ni, by as Ri, bz as qi, bA as Bi, bB as Wi, bC as Vi, bD as Hi, bE as Ui, bF as Gi, bG as Xi, bH as Yi, bI as Zi, bJ as Ji, bK as Qi, bL as ec, s as tc } from "./chunk-Cgt_u7Uc.js";
import { L as ac, h as oc, i as wt, j as Lo, k as rc, l as nc, o as or, q as sc, t as ic, u as cc, v as lc, w as dc, C as rr, c as St, x as rn, y as mc, z as pc, A as fc, B as nn, D as hc, E as bc, G as uc, H as gc, I as yc, J as vc, K as xc, M as kc, N as wc, O as Sc, P as jc, Q as Cc } from "./chunk-CghSef64.js";
import { S as Ec, b as _c, p as $c, l as Mc, u as Ac } from "./chunk-CUiAG3lm.js";
import { n as Tc, p as Pc, a as Ic, s as po, S as sn, c as zc, C as nr, b as Fc, i as Lc, w as Oc, d as Kc, U as je, m as Dc, h as Ge, e as Nc, f as Rc, g as qc, j as Bc, r as Wc, k as Vc, l as Hc } from "./chunk-DHEns4tR.js";
import { T as Uc } from "./chunk-IMiHbUfz.js";
import { T as Gc, R as Xc } from "./vendor-three-B8JDtKPi.js";
import { b as Yc, p as cn, a as jo, c as Co, d as Zc, r as Jc, s as Qc, e as el } from "./chunk-BvpYpyx-.js";
import { m as tl } from "./chunk-QPu3m5tU.js";
function ut(e, t = 0) {
...
function Al(e) {
  ...
  const V = (B - U) * 0.1;
  U -= V, B += V;
  const Q = Z(Number(e.curveZoom) || 1, 0.1, 50), w = (B + U) / 2 + (Number(e.curvePanY) || 0), E = (B - U) / Q;
  U = w - E / 2, B = w + E / 2;
...
function Bl(e) {
  ...
  if (!t || !a) return;
  const o = Tc(e.state?.metadata, e.state?.duration_frames), n = o.some((c) => c.state !== "unknown");
...
function Vd(e, t = {}) {
  ...
  let Q = "", w = null, E = !0, z = !0, N = "scene", q = 0;
...
function Jd(e, t = {}) {
  ...
  function y(w) {
    const E = er({ ...w, preset_id: w.id });
    return { id: w.id, name: w.name || w.id, root_offset: E.root_offset, joints: E.joints };
  }
  function g(w) {
    const E = d.get(w?.pose?.preset_id) || null;
    return ls({ preset: E, overrides: w?.pose }).joints;
  }
  function v() {
    const w = h();
  ...
  function x() {
    const w = h(), E = !!w?.character?.motion;
  ...
  async function A() {
    try {
      ...
      d = new Map((w.poses || []).filter((E) => E?.id).map((E) => [E.id, y(E)]));
    } catch {
      d = /* @__PURE__ */ new Map();
    }
  ...
  function D() {
    const w = s?.value || "neutral", E = d.get(w) || er({ preset_id: w });
  ...
  async function F() {
    ...
    const E = (await wt(e, r("Save Pose"), r("Pose name"), ""))?.trim();
...
function nm(e, { controlsFactory: t, anchorFactory: a } = {}) {
  ...
  function h({ targetSpec: w }) {
    if (w) {
      if (l(c), w.type === "object") {
        ...
        const E = ps(e), z = (E.length ? E : [w.object]).map((q) => ({
          object: q,
          transform: Ie(q)
        }));
  ...
  function y(w) {
    ...
    E && (E.keyframes = Jr(n.baseKeys, b(w)), u(E));
  }
  function g(w) {
  ...
  function v(w) {
    const E = e.state.cameras.find((z) => z.id === n.trackId);
    E && (E.keyframes = bs(n.baseKeys, [n.frame], { delta: w.position }), u(E));
  }
  function j({ delta: w }) {
  ...
  function x(w) {
    ...
    for (const q of E)
      if (N === "translate")
        ...
        q.object.position = ye(z, tr(_e(q.transform.position, z), w.rotationDeg)), q.object.rotation = ye(q.transform.rotation, w.rotationDeg);
      else if (N === "scale") {
  ...
  function A(w) {
    if (e.state.gizmo_mode === "translate")
      ...
      e.camera.target = ye(n.position, tr(E, w.rotationDeg));
    }
    e.commitCameraEdit();
  }
  function P(w) {
    const E = ye(n.base, w.position);
  ...
  function F() {
    ...
    const w = e.recording ? null : ms(e), E = e.state.gizmo_mode || "translate", z = !!w && !w.readOnly && rm.has(w.type) && w.allowedModes.includes(E);
    if (i = z ? w.type : null, !z) {
      o?.detach();
      return;
    }
    d() && (o.isDragging() || (o.setCamera(e.webgl.activeCamera), o.setMode(E), o.setSpace(e.state.gizmo_space === "local" ? "local" : "world"), o.attach(w)));
  }
  function U() {
...
function pm(e, t, a, o) {
  ...
  const [P, D] = j(h[0] || 0, h[2] || 0), [F, U] = j(b[0] || 0, b[2] || 0), B = 8, V = Z(P, s + B, s + c - B), Q = Z(D, i + B, i + c - B), w = Z(F, s + B, s + c - B), E = Z(U, i + B, i + c - B), z = h[1] || 0, N = dm(z), q = mm(z);
  t.strokeStyle = "rgba(255, 255, 255, 0.40)", t.lineWidth = 1, t.setLineDash([3, 3]), t.beginPath(), t.moveTo(V, Q), t.lineTo(w, E), t.stroke(), t.setLineDash([]), t.fillStyle = "#ffffff", t.beginPath(), t.arc(w, E, 2.5, 0, Math.PI * 2), t.fill(), t.strokeStyle = "rgba(255, 255, 255, 0.7)", t.lineWidth = 1, t.beginPath(), t.arc(w, E, 4.5, 0, Math.PI * 2), t.stroke();
...
const Ba = () => import("./chunk-DprRbgNG.js");
function Xm(e, t) {
...
function zb(e, t, a = An) {
  ...
  const y = new Xc(), g = u.fromScene(y, 0.04).texture;
  return y.traverse((v) => {
    v.geometry?.dispose?.();
...
function Op(e) {
  ...
  vi(e, t), xi(e, t), Lp(e, t), Cm(e, a, t), sp(e, a, t), Yc(e, t), jp(e, t), Ap(e, t), ym(e, a, t), ep(e, t);
}
function Kp(e, t) {
...
async function pf(e) {
  ...
  try {
    let s = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-BWRV8khQ.js");
...
function rh(e) {
  ...
  if (s) {
    const w = n.target_object_id || e.state.target_object_id || "", E = `T${ar()}${e.state.objects.map((z) => `${z.id}\0${z.name || z.type}`).join("|")}`;
    yo(s, E, () => [
  ...
  for (const [w, E] of Object.entries(h))
    for (const z of e.root.querySelectorAll(`[data-role="${w}"]`))
  ...
  if (y) {
    ...
    const N = e.state.objects.filter((M) => !E.has(M.id)), q = `P${ar()}${w}${N.map((M) => `${M.id} ${M.name || M.type}`).join("|")}`;
    yo(y, q, () => [
      gt("", r("No parent")),
  ...
  if (b && (b.hidden = !F?.animations), u) {
    ...
    yo(u, `A${w.join("|")}`, () => w.map((E, z) => gt(String(z), E)), String(t.animation_index || 0));
  }
...
function Bh(e) {
  ...
  return {
    ...
    restoreHistorySnapshot(I) {
      ...
      for (const Y of k) _.has(Y) || this.removeObjectResources(Y);
    ...
    onContextMenu(I) {
      ...
      const T = I.target, S = T.closest?.(".camera-preview-tile"), k = T.closest?.(".scene-item"), _ = T.closest?.(".key");
    ...
    openObjectContext(I, T) {
      ...
      const k = ["sun_light", "point_light", "spot_light"].includes(S.type), _ = this.selectedObjectIds?.size || 0;
    ...
    openCameraContext(I, T, S = !1) {
      const k = this.state.cameras.find((_) => _.id === T);
    ...
    openPathKeyContext(I, T, S) {
      ...
      const _ = (k.keyframes || []).find((Y) => Y.frame === S) || null;
      _ && this.selectKeyframe(_), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
      const $ = _ ? po(_) : "auto", K = this.selectedKeyFrames?.size || 0, X = this.pathSelection?.component === "target", L = Zr(k, this.state.objects);
    ...
    moveShot(I, T) {
      ...
      this.state.cameras.splice(k, 0, _), this.cameraPreviewSignature = "", this.serialize(), this.refreshObjects(), this.refreshKeys(), this.renderCameraView(), this.setStatus(`Shot order: ${_.name} → #${k + 1}`);
    },
    async editShotHandles(I) {
      ...
      if (k == null) return;
      const _ = String(k).match(/^\s*(\d+)\s*[,;\s]\s*(\d+)\s*$/);
    ...
    openTimelineContext(I, T) {
      const S = this.selectedKeyFrames?.size || 0, k = this.selectedKeyframe(), _ = k?.interpolation || "ease", $ = k && po(k) || "auto", K = ["ease", "linear", "bezier", "smooth", "ease_in", "ease_out", "sine", "cubic", "quintic", "expo", "back"], X = ["auto", "clamped", "vector", "free", "aligned", "flat"];
    ...
    openCurveContext(I) {
      const T = this.selectedKeyFrames?.size || 0, S = T < 2 && !this.selectedKeyframe(), k = this.selectedKeyframe(), _ = k?.interpolation || "ease", $ = k && po(k) || "auto", K = ["bezier", "smooth", "linear", "ease_in", "ease_out", "ease", "sine", "cubic", "quintic", "expo", "back"], X = ["auto", "clamped", "vector", "free", "aligned", "flat"];
    ...
    resizeCanvas() {
      ...
      if (!I) return;
      const T = Math.min(2, window.devicePixelRatio || 1), S = I.clientWidth || 320, k = I.clientHeight || 180, _ = Math.max(320, Math.round(S * T)), $ = Math.max(180, Math.round(k * T));
...
function Qh(e) {
  ...
  return {
    ...
    setSpatialHandleMode(k) {
      ...
      this.checkpoint(r("Camera path handle: {mode}").replace("{mode}", k)), Kc($[K], k, {
        prevKey: $[K - 1] || null,
        nextKey: $[K + 1] || null
    ...
    insertPathKeyAtCursor(k) {
      ...
      const _ = this.interactionElement.getBoundingClientRect(), $ = (k.clientX - _.left) * this.canvas.width / Math.max(1, _.width), K = (k.clientY - _.top) * this.canvas.height / Math.max(1, _.height), X = this.webgl.pickPathSegment([$, K]);
      if (!X) return !1;
      const L = (this.state.cameras || []).find((ue) => ue.id === X.cameraId);
      if (!L || L.locked) return !1;
      const Y = Lc(L.keyframes || [], {
    ...
    transformCameraPath(k) {
      ...
      const $ = Jr(_.keyframes, { origin: Yr(_.keyframes), ...k });
    ...
    redistributeActiveCameraTiming() {
      ...
      const _ = [...k.keyframes].sort((K, X) => K.frame - X.frame), $ = _i(_, {
    ...
    async openCameraPathPresetPicker() {
      ...
      const _ = Fc.map((K) => ({ id: K, label: r(nr[K] || K) })), $ = await rn({ title: r("Camera Path Preset"), items: _, owner: this });
      return $ ? this.applyCameraPathPreset($) : !1;
    },
    applyCameraPathPreset(k, _ = {}) {
      const $ = this.activeCameraTrack();
      if (!$ || $.locked)
        return this.setStatus(r("{name} is locked").replace("{name}", $?.name || r("Camera"))), !1;
      const [K, X] = Mo(this.state), L = zc({ type: k, camera: this.camera, startFrame: K, endFrame: X, params: _ });
    ...
    toggleInspector(k) {
      ...
      if (!_) return;
      const $ = k !== void 0 ? k : _.dataset.collapsed !== "true";
    ...
    showAllObjects() {
      const k = this.state.objects.filter((_) => _.enabled === !1);
      if (k.length) {
        this.checkpoint("Show all objects");
        for (const _ of k) _.enabled = !0;
    ...
    selectHierarchy(k = this.selectedObjectId) {
      ...
      this.selectedObjectIds = _, this.selectedObjectId = k, this.selectedEntity = "object", this.refreshObjects(), this.refreshInspector(), this.render(), this.setStatus(`Hierarchy selected: ${_.size} object(s)`);
    },
    ...
    lookAtObject(k) {
      const _ = this.state.objects.find(($) => $.id === k);
      if (_) {
    ...
    applyProxyPreset(k) {
      const _ = { balanced: { mode: "omni_ref", burn: !1 }, parallax: { mode: "point_field", burn: !1 }, subject: { mode: "card_grid", burn: !1 }, debug: { mode: "omni_ref", burn: !0 } }, $ = _[k] || _.balanced;
    ...
    aimAtSelectedObject(k) {
      ...
      const _ = this.activeCameraTrack(), $ = k && this.state.objects.find((L) => L.id === k) || this.selectedObject() || this.state.objects.find((L) => L.id === "subject") || this.state.objects[0];
      if (!$) return;
    ...
    setCameraTrackingTarget(k) {
      ...
      const _ = this.activeCameraTrack();
      _.target_object_id !== (k || null) && (_.aim_bone = null), _.target_object_id = k || null, _.id === this.state.active_camera_id && (this.state.target_object_id = k || null, this.state.aim_bone = _.aim_bone), this.camera = Se(_, this.frame, this.state.objects), vt(this, _, this.camera, this.frame), this.serialize(), this.refreshInspector(), this.render(), this.setStatus(k ? `Camera tracking: ${k}` : "Camera tracking disabled (manual target)");
    },
    bakeAimToKeyframes() {
      this.checkpoint("Bake aim to keyframes");
      const k = this.activeCameraTrack(), _ = k.target_object_id || this.state.target_object_id || "subject", $ = this.state.objects.find((X) => X.id === _) || this.state.objects[0];
...
function eb(e) {
  ...
  return {
    ...
    async loadMediaUrl(S, k, _, $) {
      return Gt(this, S, k, _, $);
    },
    restoreAssets() {
      Jt(this);
    },
...
function yb(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: n, initializeTooltips: s, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: m, activeCameraTrack: p, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: b, syncActiveCameraTrack: u, syncFromWidgets: y, bindEditorEvents: g, activateCamera: v, addCamera: j, deleteCamera: x, drawPreviewOverlays: A, duplicateCamera: P, maximizeCameraPreview: D, refreshCameraPreviews: F, refreshCameraSelectors: U, renameCamera: B, setPlayblastCamera: V, toggleCameraView: Q, captureRealtime: w, makePlayblast: E, uploadDirectorPlayblast: z, waitForMediaFrame: N, computeAudioPeaks: q, loadAudioFile: M, releaseAudio: W, stopPlay: C, togglePlay: R, applyCameraPreset: G, applyCameraShake: ae, applyProxyPreset: oe, clearViewportBgImage: ee, loadViewportBgFile: se, loadViewportBgSequence: fe, drawCameraPath: de, drawCard: he, drawCube: be, drawCylinder: O, drawGrid: H, drawHuman: ie, drawLine3D: ce, drawNull: me, drawOverlays: re, drawPointField: ke, drawSpeedHeatmap: _t, drawSphere: $t, drawTorus: at, curveChannels: ot, drawCurveEditor: rt, onCurvePointerDown: nt, onCurvePointerMove: Mt, onCurvePointerUp: At, onTimelinePointerDown: Tt, onTimelinePointerMove: st, onTimelinePointerUp: it, refreshKeys: He, resetCurveZoom: ct, resetTimelineZoom: lt, setChannelFilter: dt, setCurveInterpolation: Pt, setTangentMode: mt, timelineFrameFromEvent: It, toggleCurveHandles: zt, zoomCurve: Ft, drawTransformGizmo: Lt, frameTarget: Ot, gizmoAxes: Kt, gizmoGeometry: Dt, onPointerDown: Nt, onPointerMove: Rt, onPointerUp: qt, onWheel: Bt, pickGizmo: pt, pickSceneObject: ft, resetCamera: Wt, setTransformMode: Vt, setViewMode: no, viewportCamera: so, loadCardFile: Ht, loadExecutionPreview: Ut, loadMediaUrl: Gt, loadModelFile: Xt, loadSelectedReference: Yt, onModelLoaded: Zt, restoreAssets: Jt, syncUpstreamInputs: ht, configureDomMedia: Qt, refreshSetupDiagnostic: ea, addMediaCard: ta, addPrimitive: aa, applyObjectAnimationFrame: oa, beginCameraEdit: ra, beginObjectEdit: na, commitCameraEdit: sa, commitObjectEdit: ia, copyKeyframe: ca, deleteKeyframe: la, deleteObject: da, duplicateObject: ma, exitKeyEdit: pa, finishCameraEdit: fa, goToAdjacentKey: ha, insertKeyframe: ba, loadSelectedKeyView: ua, pasteKeyframe: ga, playblastCameraAtFrame: ya, refreshInspector: va, refreshKeyEditor: xa, refreshObjects: ka, removeObjectResources: wa, renameObject: Sa, retimeSelectedKey: ja, selectKeyframe: Ca, selectedKeyframe: Ea, selectedObject: _a, selectObjectAnimation: $a, setKeyInterpolation: Ma, setObjectParent: Ne, timelineKeyframes: Aa, timelineObject: Ta, toggleAutoKey: Pa, toggleObject: Ia, updateCameraFromHud: za, updateEditState: Fa, updateKeyVisualState: La, updateSelectedKey: bt, updateSelectedObject: Oa, clamp: Ka, cloneCamera: Da, configureCore: Fe, defaultCamera: io, sampleCamera: Ue, sampleObjectTransform: Se, sanitizeState: I, worldTransform: T } = e;
  return {
    ...
    renderViewportOnly() {
      const S = this.ctx, k = this.canvas.width, _ = this.canvas.height;
      if (S.fillStyle = this.state.viewport_bg_color || "#121212", S.fillRect(0, 0, k, _), this.viewportBgSequenceImages && this.viewportBgSequenceImages.length) {
        ...
        if (Le?.complete && Le.naturalWidth)
          try {
            S.drawImage(Le, 0, 0, k, _);
          } catch {
          }
      } else if (this.viewportBgImage)
        try {
          S.drawImage(this.viewportBgImage, 0, 0, k, _);
        } catch {
        }
      ...
      if (this.webgl) {
        try {
          const te = this.recording ? 1 : this.webgl.supersampleFactor?.() ?? 1, Le = te > 1 ? Math.min(te, 4096 / Math.max(1, k, _)) : 1, Na = Le > 1 ? Math.round(k * Le) : k, co = Le > 1 ? Math.round(_ * Le) : _;
          this.webgl.activeCamera && this.transformControlsWiring?.sync(), this.webgl.render(Re, K, this.cardMediaById, Na, co, this.modelUrlsById, this.frame, this.recording, this.selectedEntity, this.selectedObjectId, this.subSelection, this.selectedKeyFrame ?? null, this.selectedKeyFrames ? [...this.selectedKeyFrames] : null), S.imageSmoothingEnabled = !0, S.imageSmoothingQuality = "high", Na !== k || co !== _ ? S.drawImage(this.webgl.canvas, 0, 0, Na, co, 0, 0, k, _) : S.drawImage(this.webgl.canvas, 0, 0, k, _), J = !0;
        } catch (te) {
    ...
    requestUiUpdate(S = je.viewport, k = "unknown") {
      (this.renderReasons ||= /* @__PURE__ */ new Set()).add(k), this.uiDirtyMask = Dc(this.uiDirtyMask, S), this.renderInvalidations = (this.renderInvalidations || 0) + 1, !this.renderScheduled && (this.renderScheduled = !0, this.renderFrame = requestAnimationFrame(() => {
    ...
    renderCameraView() {
      if (this.perf && (this.perf.previewRenderCount = (this.perf.previewRenderCount || 0) + 1), this.state.camera_view_visible) {
        ...
        const k = this.state.cameras, _ = !!this.playing && !this.recording && k.length > 2;
        let $ = null;
        if (_) {
...
function xb() {
  return {
    ...
    deleteSelectedKeyframes() {
      ...
      const t = this._activeTrack(), a = ve(this), o = t.kind === "camera" ? 1 : 0, { keys: n, removed: s } = Bc(a, e, { minKeys: o });
    ...
    nudgeSelectedKeyframes(e) {
      ...
      const a = this._activeTrack(), o = Math.max(0, this.state.duration_frames - 1), n = qc(ve(this), t, e, { lastFrame: o });
    ...
    setSelectedKeysInterpolation(e) {
      ...
      this.checkpoint(r("Interpolation on {n} keys").replace("{n}", t.length)), a.write(Rc(ve(this), t, e)), this.serialize(), this.refreshKeys(), this.refreshKeyEditor(), this.render(), this.drawCurveEditor(), this.setStatus(r("{mode} interpolation on {n} keys").replace("{mode}", e.replace(/_/g, " ")).replace("{n}", t.length));
    },
    setSelectedKeysTangentMode(e) {
      const t = this.resolveSelectedFrames();
      if (t.length < 2) return this.setTangentMode(e);
      const a = this._activeTrack(), o = Ve(this).map((n) => n.id);
      this.checkpoint(r("Tangents on {n} keys").replace("{n}", t.length)), a.write(Nc(ve(this), t, e, o)), this.serialize(), this.refreshKeys(), this.render(), this.drawCurveEditor(), this.setStatus(r("{mode} tangents on {n} keys").replace("{mode}", e).replace("{n}", t.length));
    },
    /**
    ...
    simplifyActiveKeys({ mode: e = "simplify", tolerance: t = 0, target: a = 0, scope: o = "camera", fromKeys: n = null, silent: s = !1 } = {}) {
      ...
      const l = this.resolveSelectedFrames(), m = o !== "all_cameras" && l.length >= 2 ? [l[0], l.at(-1)] : null, p = m ? [] : l, f = (b) => {
        ...
        let A = j, P = 0;
        if (j.length > 2) {
          const D = e === "reduce" ? Wc(j, i, { target: a || Math.ceil(j.length / 2), keepFrames: p }) : e === "clean" ? Vc(j, i, { keepFrames: p }) : Hc(j, i, { tolerance: t * vb, keepFrames: p });
...
class Yo {
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-BWRV8khQ.js"));
    } catch (a) {
...
const Ha = { app: Nr, api: We, EditorHistory: kn, ContextMenuController: nn, initializeTooltips: hc, promptText: wt, ObjectUrlRegistry: wn, buildRoot: Sn, dispatchDirectorKey: Li, activeCameraTrack: jo, bindWidgetCallbacks: Zc, playblastCameraTrack: cn, restoreFromWidgets: Jc, serializeEditorState: Qc, syncActiveCameraTrack: Co, syncFromWidgets: el, bindEditorEvents: Op, activateCamera: bc, addCamera: uc, deleteCamera: gc, drawPreviewOverlays: yc, duplicateCamera: vc, maximizeCameraPreview: xc, refreshCameraPreviews: kc, refreshCameraSelectors: wc, renameCamera: Sc, setPlayblastCamera: jc, toggleCameraView: Cc, captureRealtime: qn, makePlayblast: pf, uploadDirectorPlayblast: Bn, waitForMediaFrame: Rn, computeAudioPeaks: Ln, loadAudioFile: Up, releaseAudio: eo, stopPlay: Xa, togglePlay: Wp, applyCameraPreset: sm, applyCameraShake: im, applyProxyPreset: cm, clearViewportBgImage: uf, loadViewportBgFile: hf, loadViewportBgSequence: bf, drawCameraPath: Af, drawCard: Mf, drawCube: Sf, drawCylinder: Ef, drawGrid: vf, drawHuman: Cf, drawLine3D: ne, drawNull: $f, drawOverlays: Pf, drawPointField: wf, drawSpeedHeatmap: Tf, drawSphere: jf, drawTorus: _f, curveChannels: Ve, drawCurveEditor: Al, fitCurveView: un, onCurveDoubleClick: $l, onCurvePointerDown: vl, onCurvePointerMove: xl, onCurvePointerUp: kl, onTimelinePointerDown: Oi, onTimelinePointerMove: Ki, onTimelinePointerUp: Di, refreshKeys: Wl, resetCurveZoom: Ml, resetTimelineZoom: Ni, setChannelFilter: Sl, setCurveInterpolation: wl, setTangentMode: jl, timelineFrameFromEvent: Ao, toggleCurveHandles: Cl, zoomCurve: _l, drawTransformGizmo: Ri, frameTarget: qi, gizmoAxes: Bi, gizmoGeometry: Wi, onPointerDown: Vi, onPointerMove: Hi, onPointerUp: Ui, onWheel: Gi, pickGizmo: Xi, pickSceneObject: Yi, resetCamera: Zi, setTransformMode: Ji, setViewMode: Qi, viewportCamera: ec, loadCardFile: tf, loadExecutionPreview: af, loadMediaUrl: Nn, loadModelFile: ef, loadSelectedReference: of, onModelLoaded: Qp, restoreAssets: Jp, syncUpstreamInputs: rf, configureDomMedia: On, refreshSetupDiagnostic: Ff, addMediaCard: oh, addPrimitive: Qf, applyObjectAnimationFrame: vh, beginCameraEdit: Eh, beginObjectEdit: Yn, commitCameraEdit: _h, commitObjectEdit: sh, copyKeyframe: Sh, deleteKeyframe: wh, deleteObject: Xn, deleteSelectedObjects: ah, duplicateObject: Gn, exitKeyEdit: Mh, finishCameraEdit: $h, goToAdjacentKey: Nh, insertKeyframe: xh, loadSelectedKeyView: Dh, pasteKeyframe: jh, playblastCameraAtFrame: yh, refreshInspector: rh, refreshKeyEditor: Lh, refreshObjects: Un, removeObjectResources: ph, renameObject: eh, retimeSelectedKey: Oh, selectKeyframe: Ch, selectedKeyframe: ze, selectedObject: Et, selectObjectAnimation: mh, setKeyInterpolation: kh, setKeyTangentMode: zh, setObjectParent: dh, timelineKeyframes: ve, timelineObject: we, toggleAutoKey: Ah, toggleObject: th, updateCameraFromHud: lh, updateCameraRotationFromHud: ch, updateEditState: Ph, updateKeyVisualState: Ih, updateSelectedKey: Kh, updateSelectedObject: nh, clamp: Z, cloneCamera: le, configureCore: on, defaultCamera: an, sampleCamera: xe, sampleObjectTransform: oo, sanitizeState: tc, worldTransform: Po };
Object.assign(
  Yo.prototype,
  Bh(Ha),
  Qh(Ha),
  ...
  try {
    a.assetBrowser = Vd(a, {
      ...
      onAgentFirstOpen: async () => {
        if (ko())
          try {
            const { createDirectorAgentPanel: o } = await import("./chunk-DzZzd7fS.js");
            a.agentPanel = o(a);
          } catch (o) {
