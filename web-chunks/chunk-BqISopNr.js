...
import { s as ne, a as re, c as mt, d as je, b as ut, e as fe, f as ht, l as Fe, n as Ae, g as $e, h as Y, m as _e, I as de, D as _t, r as Et, p as At, t as gt, i as pt, j as bt, k as Tt, w as wt, o as ze, q as yt, u as It, v as K } from "./chunk-CP16H5xA.js";
import { s as Nt } from "./chunk-tXB5k9Zz.js";
import { c as St, w as Rt, a as Te, W as Ot } from "./chunk-C7qk9Qm9.js";
const kt = /* @__PURE__ */ new Set(["good", "warning", "bad", "unknown"]);
function Ct(e, t) {
  ...
  for (const s of a.frames) {
    ...
    const o = kt.has(s?.state) ? s.state : "unknown", c = s?.score;
    let h = null;
    if (c != null) {
      const u = Number(c);
...
class jt extends EventTarget {
  constructor(t, { app: n, api: r } = {}) {
    ...
    this.state = ne(a), this.sceneBaseline = this.stateWidget?.value || JSON.stringify(this.state), this.sceneName = this.state.metadata?.scene_name || "", this.frame = 0, this.camera = re(this.state, 0), this.directorRevision = 0, this.renderRevision = 0, this.history = new vt({
...
const P = 1, Ke = 50, v = 120, J = 160, Mt = Object.freeze(["perspective", "orthographic"]), _ = Object.freeze({
...
}), Dt = Object.freeze(Object.values(I));
...
function ln(e, t) {
  ...
  if (e.camera_type !== void 0 && !Mt.includes(e.camera_type))
...
function mr({ groundHit: e, orbitTarget: t } = {}) {
...
function ur(e, t, n, { prevKey: r = null, nextKey: a = null, breakCoupling: s = !1 } = {}) {
...
function hr(e, t, { prevKey: n = null, nextKey: r = null } = {}) {
...
function _r(e, t, { tolerance: n = 0.02, keepFrames: r = [] } = {}) {
...
function Er(e, t, { target: n = 2, keepFrames: r = [] } = {}) {
...
function Ar(e, t, { mergeWithin: n = 1, epsilon: r = 1e-3, keepFrames: a = [] } = {}) {
...
function gr(e, t, n, { lastFrame: r = 1 / 0 } = {}) {
    ...
    try {
      if (g.kind === "query")
        ...
        if (!Number.isInteger(k?.baseRevision) || k.baseRevision < 0)
          ...
          const U = await Zn(e, k.operations);
...
async function nr(e, t) {
  return Te.open({
    ...
    opener: t,
    createSession: async () => {
      const n = ++e.workbenchGeneration, { openDirectorWorkbench: r, closeDirectorWorkbench: a } = await import("./chunk-COLJNbZq.js").then((c) => c.e);
...
function rr(e) {
  ...
  const t = new jt(e, { app: ft, api: Pe });
  Wn(t);
  try {
