import { a, a2 as j, bD as te, bE as F, bF as w } from "./chunk-D0IZkDZJ.js";
...
function he(e, n = {}) {
  ...
  return f?.addEventListener("click", G), y?.addEventListener("change", R), m?.addEventListener("change", B), d?.addEventListener("input", D), E(), z(), I(), _(), {
    get state() {
      return g;
    },
    dispose() {
