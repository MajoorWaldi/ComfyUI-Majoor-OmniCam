...
import { s as $e, c as J, t as he, a as s, o as Kn, b as gr, d as Ve, e as pe, f as Lo, r as si, g as yr, h as Bn, i as ii, j as ci, k as li, l as di, m as vr, n as xr, I as ko, D as mi, p as wr, q as pi, w as fi, u as Co, v as qn, x as hi, y as kr, z as er, A as Ur, B as Un, C as tr, E as Wn, F as Vn, G as Hn, H as Gn, J as ar, K as qo, L as Wr, O as Vr, R as Yn, M as ui, N as bi, P as gi, Q as yi, S as vi, T as _e, U as Hr, V as Kt, W as xi, X as Sr, Y as wi, Z as ki, _ as Si, $ as ji, a0 as _i, a1 as jr, a2 as Ci, a3 as Ei, a4 as Ai, a5 as Ti, a6 as $i, a7 as Mi, a8 as Ii, a9 as Oi, aa as Pi, ab as Li, ac as zi, ad as Ni, ae as Fi, af as Ri, ag as Di, ah as Ki, ai as Bi, aj as qi, ak as Ui, al as Wi, am as Vi, an as Hi, ao as Gi, ap as Yi, aq as Xi, ar as Ji, as as Zi, at as Qi, au as ec, av as tc, aw as ac, ax as oc, ay as rc, az as nc, aA as sc, aB as ic, aC as cc, aD as lc, aE as dc, aF as mc, aG as pc, aH as fc, aI as hc, aJ as Xn, aK as uc, aL as Uo, aM as bc, aN as gc, aO as yc, aP as vc, aQ as xc, aR as We, aS as wc, aT as Jn, aU as _r, aV as kc, aW as Sc, aX as jc, aY as Zn, aZ as Ze, a_ as _c, a$ as Gr, b0 as Cr, b1 as Cc, b2 as Ec, b3 as Ac, b4 as Tc, b5 as $c, b6 as Mc, b7 as Ic, b8 as Qn, b9 as Oc, ba as Pc, bb as Lc, bc as zc, bd as Nc, be as Fc, bf as Rc, bg as Dc, bh as Kc, bi as Bc, bj as qc, bk as Uc, bl as Wc, bm as Vc, bn as Hc, bo as Gc, bp as Yc, bq as Xc, br as Jc } from "./chunk-1FIr5kKM.js";
import { L as Zc, a as Qc, p as Gt, f as Er, b as el, S as tl, c as Yr, d as al, e as ol, r as rl, g as nl, n as sl, C as Xr, h as Yt, o as il, i as cl, s as ll, j as dl, k as es, l as ml, m as or, q as rr, w as pl, t as ts, u as fl, v as hl, x as ul, y as bl, z as gl, A as yl, B as vl, D as xl, E as wl, F as kl, G as Sl, H as jl, I as _l, J as Cl, K as El, M as Al } from "./chunk-hDrc7ul-.js";
import { S as Tl, b as $l, p as Ml, m as Il, l as Ol, u as Pl } from "./chunk-BOI_2OKd.js";
import { T as Ll } from "./chunk-__IQ4xkd.js";
import { T as zl, R as Nl } from "./vendor-three-BQUrLQkn.js";
function Lt(e, t = 0) {
...
function Fl(e, { type: t = "handheld_subtle", intensity: a = 1, duration_frames: o = null, subdivide: r = !0 } = {}) {
  ...
  const i = t === "turbulence", c = t === "handheld_heavy", l = (i ? 0.12 : c ? 0.18 : 0.06) * a, p = (i ? 2 : c ? 2.8 : 0.9) * a, m = i ? 0.45 : c ? 0.22 : 0.12, f = n[n.length - 1]?.frame ?? 119, d = Math.max(f + 1, Number(o || (e?.duration_frames ?? f + 1))), h = i ? 4 : c ? 6 : 8, u = Array.isArray(e) ? { keyframes: n, duration_frames: d } : e, b = new Set(n.map((v) => v.frame));
  if (r && d > h) {
    for (let v = 0; v < d; v += h)
      b.add(v);
    b.add(d - 1);
  }
  return [...b].sort((v, x) => v - x).map((v) => {
    const x = $e(u, v), k = Lt(v * m, 1) * l, y = Lt(v * m, 2) * l, j = Lt(v * m, 3) * l * 0.5, A = Lt(v * m, 4) * p, R = Lt(v * m, 5) * (p * 0.35), N = [...x.position], X = [...x.target];
    return N[0] += k, N[1] += y, N[2] += j, X[0] += k * 0.35, X[1] += y * 0.35, {
      frame: v,
      camera: {
        ...x,
        position: N,
...
const as = 1e-4;
function Dl(e, t) {
  return !Array.isArray(e) || !Array.isArray(t) ? e !== t : e.some((a, o) => Math.abs(Number(a) - Number(t[o])) > as);
}
function Jr(e, t) {
  return Math.abs(Number(e) - Number(t)) > as;
}
const os = [
  {
    id: "camera",
  ...
  },
  {
    ...
    label: "Look At",
    color: "#f0a742",
    changed: (e, t) => Dl(e?.target, t?.target),
    read: (e) => e?.target
  },
  {
    id: "focal_length",
...
function Bl(e, t = null) {
  return os.filter((a) => !t || t.has(a.id)).map((a) => ({
    id: a.id,
    label: a.label,
    color: a.color,
    frames: Kl(e, a)
...
function rs(e) {
  ...
  a.delete("camera");
  const o = e.timelineKeyframes() || [], r = Bl(o, a), n = Vl(e, r);
  if (t.dataset.signature !== n) {
    t.dataset.signature = n, t.replaceChildren();
    const i = (c) => he(e, c);
    for (const c of r) {
      const l = document.createElement("div");
      l.className = "oc-dope-row", l.dataset.channel = c.id, l.style.setProperty("--channel-color", c.color), Ul(l, c.frames, i), Wl(e, l, c, o, i), t.appendChild(l);
    }
  }
...
const Wo = [1, 2, 5, 10, 20, 25, 50, 100, 200, 250, 500, 1e3, 2e3, 5e3], ns = 46, Zr = 5, ss = 640;
function is(e, t) {
  const a = t > 0 ? t : ss, o = Math.max(2, Math.floor(a / ns)), r = Math.max(1e-6, e / o);
  return Wo.find((n) => n >= r) ?? Wo[Wo.length - 1];
}
function Hl(e, t) {
  const a = Math.max(1, e.state.duration_frames - 1), o = J(Number(e.timelineZoom) || 1, 0.1, 50), r = Number(e.timelinePan) || 0, n = a / o, i = is(n, t), l = (i >= Zr ? i / Zr : 0) || i, p = [], m = Math.max(0, Math.floor(r / l) * l);
...
function Gl(e) {
  return e.clientWidth || e.parentElement?.clientWidth || ss;
}
function cs(e) {
  const t = e.root.querySelector('[data-role="ruler"]');
  if (!t) return;
  t.replaceChildren();
  for (const o of Hl(e, Gl(t))) {
...
const Xl = [1, 2, 2.5, 5, 10];
function Jl(e, t = 5) {
  const a = Math.abs(e) / Math.max(1, t);
  if (!(a > 0) || !Number.isFinite(a)) return 1;
  const o = 10 ** Math.floor(Math.log10(a)), r = a / o;
  return (Xl.find((n) => n >= r) ?? 10) * o;
}
function Zl(e, t) {
  const a = Math.max(0, Math.min(4, Math.ceil(-Math.log10(t))));
  return e.toFixed(a);
}
function Ql(e, { left: t, right: a, top: o, width: r, graphWidth: n, graphHeight: i, height: c, timeMin: l, timeMax: p, totalDuration: m, xFor: f, frame: d }) {
  const h = is(p - l, n);
  ...
  for (let b = Math.ceil(l / h) * h; b <= p; b += h) {
    ...
    if (g < 0 || g > m) continue;
    const v = f(g);
    v < t || v > r - a || (e.beginPath(), e.moveTo(v, o), e.lineTo(v, o + i), e.stroke(), e.fillText(String(g), v, c - 6));
  }
  const u = f(d);
...
function ed(e, { left: t, right: a, top: o, width: r, graphHeight: n, minimum: i, maximum: c, yFor: l }) {
  ...
  for (let m = Math.ceil(i / p) * p; m <= c; m += p) {
    const f = l(m);
    f < o - 1 || f > o + n + 1 || (e.beginPath(), e.moveTo(t, f), e.lineTo(r - a, f), e.stroke(), e.fillText(Zl(m, p), 4, f + 3));
  }
}
function Ar(e, t) {
...
function ad(e, t) {
  ...
  if (e.curvePanDrag && t.pointerId === e.curvePanDrag.pointerId) {
    t.preventDefault();
    const f = t.clientX - e.curvePanDrag.startX, d = t.clientY - e.curvePanDrag.startY, u = Math.max(1, e.state.duration_frames - 1) / (Number(e.curveZoomX) || 1), b = Math.max(1, a.clientWidth - 58), g = a.clientHeight || 180, v = Math.max(1, g - 38);
    e.curvePanX = e.curvePanDrag.origPanX - f / b * u, e.curvePanY = e.curvePanDrag.origPanY + d / v * 10 / (Number(e.curveZoom) || 1), e.drawCurveEditor();
    return;
  }
  if (e.curveScrub && t.pointerId === e.curveScrub.pointerId) {
    t.preventDefault();
    const f = Math.max(1, e.state.duration_frames - 1), d = f / (Number(e.curveZoomX) || 1), h = Number(e.curvePanX) || 0, u = Math.round(J(h + (o - 44) / Math.max(1, a.clientWidth - 58) * d, 0, f));
    e.setFrame(u);
    return;
  }
  if (e.curveBoxSelect && t.pointerId === e.curveBoxSelect.pointerId) {
    ...
    const f = Math.min(e.curveBoxSelect.startX, o), d = Math.max(e.curveBoxSelect.startX, o), h = Math.min(e.curveBoxSelect.startY, r), u = Math.max(e.curveBoxSelect.startY, r), b = (e.curveHitPoints || []).filter((v) => !v.handle && v.x >= f && v.x <= d && v.y >= h && v.y <= u).map((v) => v.key.frame), g = new Set(e.curveBoxSelect.additive ? e.curveBoxSelect.initial : []);
    for (const v of b) g.add(v);
  ...
  if (!e.curveDrag || t.pointerId !== e.curveDrag.pointerId) {
    const f = (e.curveHitPoints || []).map((x) => ({ point: x, distance: Math.hypot(o - x.x, r - x.y) })).sort((x, k) => x.distance - k.distance)[0], d = Math.max(1, e.state.duration_frames - 1), h = d / (Number(e.curveZoomX) || 1), u = Number(e.curvePanX) || 0, b = Math.max(1, a.clientWidth - 58), g = J(Math.round(u + (o - 44) / b * h), 0, d);
    let v = null;
    if (f && f.distance <= 14) {
    ...
    } else r >= 20 && r <= 165 && o >= 44 && o <= a.clientWidth - 14 && (v = { x: o, y: r, frame: g });
    (!!e.curveHover != !!v || v && (e.curveHover?.frame !== v.frame || e.curveHover?.channelName !== v.channelName)) && (e.curveHover = v, e.drawCurveEditor());
    return;
  }
  if (e.curveHover = null, t.preventDefault(), t.stopPropagation(), e.curveDrag.historyCheckpointed || (e.checkpoint?.(e.curveDrag.handle ? "Edit curve tangent" : "Edit curve"), e.curveDrag.historyCheckpointed = !0), e.curveDrag.handle) {
    const f = e.curveDrag.key, d = e.curveDrag.channel, h = e.curveDrag.handle, u = e.curveDrag.pixelPerSegment, b = e.curveDrag.valuePerPixel, g = e.curveDrag.keyX, v = e.curveDrag.keyY;
    ...
    const x = f.tangents.channels[d.id] || {}, k = x.mode || (f.tangents.mode === "aligned" ? "aligned" : "free"), y = {
    ...
    if (h === "in") {
      if (y.in_x = J((o - g) / Math.max(1, u), -0.99, -0.01), y.in_y = (v - r) * b, k === "aligned") {
        const j = Math.hypot(y.in_x, y.in_y) || 1e-6, A = Math.hypot(e.curveDrag.startHandles.out_x, e.curveDrag.startHandles.out_y) || 1e-6;
        y.out_x = -y.in_x / j * A, y.out_y = -y.in_y / j * A;
      }
    } else if (y.out_x = J((o - g) / Math.max(1, u), 0.01, 0.99), y.out_y = (v - r) * b, k === "aligned") {
      const j = Math.hypot(y.out_x, y.out_y) || 1e-6, A = Math.hypot(e.curveDrag.startHandles.in_x, e.curveDrag.startHandles.in_y) || 1e-6;
      y.in_x = -y.out_x / j * A, y.in_y = -y.out_y / j * A;
    }
    f.tangents.channels[d.id] = y, e.scheduleSerialize(), e.camera = $e(e.state, e.frame), e.applyObjectAnimationFrame(), e.render(), e.drawCurveEditor();
    return;
  }
  ...
  if (e.curveDrag.group) {
    ...
    if (d) {
      const u = e.curveDrag.group.map((g) => J(Math.round(g.startFrame + d), 0, e.curveDrag.lastFrame));
      u.some((g) => h.has(g)) || new Set(u).size !== u.length ? d = 0 : e.curveDrag.group.forEach((g, v) => {
        g.key.frame = u[v];
      });
    }
...
function ls(e, { selectedOnly: t = !1 } = {}) {
  const a = Math.max(1, (e.state?.duration_frames ?? 120) - 1), o = e.timelineKeyframes() || [], r = e.timelineObject(), n = lt(e), i = e.selectedKeyFrames?.size ? [...e.selectedKeyFrames] : e.selectedKeyFrame != null ? [e.selectedKeyFrame] : [], c = i.length > 0, l = t || c && i.length < o.length ? o.filter((b) => i.includes(b.frame)) : o;
  if (!l.length) {
  ...
  if (l.length < o.length && d < a) {
    const b = Math.max(2, Math.round(d * 0.15)), g = Math.max(0, m - b), v = Math.min(a, f + b), x = Math.max(1, v - g);
    e.curveZoomX = J(a / x, 0.2, 30), e.curvePanX = g;
  } else
    e.curveZoomX = 1, e.curvePanX = 0;
  const h = [];
  for (const b of l) {
    const g = r ? b.transform || r : b.camera || b;
    for (const v of n) {
      const x = v.get(g);
  ...
  if (h.length > 0) {
    const b = Math.min(...h), g = Math.max(...h), v = Math.max(1e-4, g - b), x = (b + g) / 2, k = (G) => r ? Lo(r, G) : $e(e.state, G), y = [], j = Math.max(1, Math.floor(a / 40));
    for (let G = 0; G <= a; G += j) {
      const re = k(G);
      for (const _ of n) {
        const F = _.get(re);
        Number.isFinite(F) && y.push(F);
      }
    }
    let A = Math.min(...y), R = Math.max(...y);
    (!Number.isFinite(A) || !Number.isFinite(R)) && (A = -1, R = 1), Math.abs(R - A) < 1e-6 && (A -= 1, R += 1);
    const N = (R - A) * 0.1;
    A -= N, R += N;
    const X = R - A, W = (A + R) / 2;
    if (l.length < o.length && v < X * 0.75) {
      const G = v * 1.35;
      e.curveZoom = J(X / G, 0.2, 30), e.curvePanY = x - W;
    } else
...
function pd(e) {
  ...
  const i = e.timelineObject(), c = e.timelineKeyframes(), l = lt(e), p = 44, m = 14, f = 16, d = 22, h = Math.max(1, a - p - m), u = Math.max(1, o - f - d), b = Math.max(1, e.state.duration_frames - 1), g = J(Number(e.curveZoomX) || 1, 0.1, 50), v = Number(e.curvePanX) || 0, x = b / g, k = v, y = v + x, j = [], A = Math.max(1, Math.ceil(x / Math.max(80, h))), R = (C) => i ? Lo(i, C) : $e(e.state, C);
  for (let C = 0; C <= b; C += A) j.push({ frame: C, value: R(C) });
  j[j.length - 1]?.frame !== b && j.push({ frame: b, value: R(b) });
  const N = j.flatMap((C) => l.map((V) => V.get(C.value)));
  let X = Math.min(...N), W = Math.max(...N);
  (!Number.isFinite(X) || !Number.isFinite(W)) && (X = -1, W = 1), Math.abs(W - X) < 1e-6 && (X -= 1, W += 1);
  const G = (W - X) * 0.1;
  X -= G, W += G;
  const re = J(Number(e.curveZoom) || 1, 0.1, 50), _ = (W + X) / 2 + (Number(e.curvePanY) || 0), F = (W - X) / re;
  X = _ - F / 2, W = _ + F / 2;
  const U = (C) => p + (C - k) / Math.max(1e-6, y - k) * h, Y = (C) => f + u * (W - C) / Math.max(1e-6, W - X);
  if (n.fillStyle = "#111114", n.fillRect(0, 0, a, o), n.strokeStyle = "#222228", n.lineWidth = 1, n.font = "9px system-ui, -apple-system, sans-serif", n.fillStyle = "#6e727a", Ql(n, {
    left: p,
    right: m,
    top: f,
    width: a,
    ...
    xFor: U,
    frame: e.frame
  }), ed(n, { left: p, right: m, top: f, width: a, graphHeight: u, minimum: X, maximum: W, yFor: Y }), X <= 0 && W >= 0) {
    const C = Y(0);
  ...
  for (const C of l) {
    ...
    let V = !1;
    j.forEach((z) => {
      const H = U(z.frame), Z = Y(C.get(z.value));
      H >= p - 50 && H <= a - m + 50 && (V ? n.lineTo(H, Z) : (n.moveTo(H, Z), V = !0));
    }), n.stroke();
    for (const z of c) {
      const H = i ? z.transform : z.camera, Z = U(z.frame), ce = Y(C.get(H)), se = z.frame === e.selectedKeyFrame || e.selectedKeyFrames?.has(z.frame);
      se && (n.fillStyle = "rgba(242, 208, 107, 0.35)", n.beginPath(), n.arc(Z, ce, 8.5, 0, Math.PI * 2), n.fill()), n.fillStyle = se ? "#ffd75e" : C.color, n.strokeStyle = "#0d0d10", n.lineWidth = 1.6, n.beginPath(), n.arc(Z, ce, se ? 5.2 : 3.8, 0, Math.PI * 2), n.fill(), n.stroke(), e.curveHitPoints.push({
        x: Z,
        y: ce,
        key: z,
        channel: C,
    ...
    if (e.showCurveHandles)
      for (let z = 0; z < c.length; z++) {
        const H = c[z], Z = H.frame === e.selectedKeyFrame || e.selectedKeyFrames?.has(H.frame);
        if (!(Z || e.curveChannelFilter !== "all" || c.length <= 4) || H.interpolation !== "bezier") continue;
        const se = i ? H.transform || i : H.camera || H, ae = U(H.frame), le = Y(C.get(se)), be = c[z - 1], fe = c[z + 1], ge = Math.max(1, H.frame - (be?.frame ?? H.frame - 1)), ye = Math.max(1, (fe?.frame ?? H.frame + 1) - H.frame), me = si(
          H,
          C.id,
          be,
          fe,
          (O) => C.get(i ? O.transform || i : O.camera || H)
        ), Te = (W - X) / Math.max(1, u), ve = h * ye / Math.max(1, x), xe = h * ge / Math.max(1, x), ue = [];
        (be || z > 0) && ue.push({ side: "in", x: ae + me.in_x * xe, y: le - me.in_y / Te }), (fe || z < c.length - 1 || c.length === 1) && ue.push({ side: "out", x: ae + me.out_x * ve, y: le - me.out_y / Te });
        for (const O of ue) {
          if (n.strokeStyle = C.color, n.lineWidth = Z ? 1.5 : 1, n.beginPath(), n.moveTo(ae, le), n.lineTo(O.x, O.y), n.stroke(), n.fillStyle = Z ? "#2a2233" : "#171720", n.strokeStyle = Z ? "#ffd75e" : C.color, n.lineWidth = Z ? 2 : 1.2, n.beginPath(), O.side === "in")
            n.arc(O.x, O.y, Z ? 5 : 3.8, 0, Math.PI * 2);
          else {
            const B = Z ? 4.5 : 3.2;
            n.rect(O.x - B, O.y - B, B * 2, B * 2);
          }
  ...
  if (e.curveBoxSelect) {
    const C = Math.min(e.curveBoxSelect.startX, e.curveBoxSelect.currentX), V = Math.min(e.curveBoxSelect.startY, e.curveBoxSelect.currentY), z = Math.abs(e.curveBoxSelect.currentX - e.curveBoxSelect.startX), H = Math.abs(e.curveBoxSelect.currentY - e.curveBoxSelect.startY);
    n.fillStyle = "rgba(56, 189, 248, 0.15)", n.fillRect(C, V, z, H), n.strokeStyle = "#38bdf8", n.lineWidth = 1, n.setLineDash([4, 4]), n.strokeRect(C, V, z, H), n.setLineDash([]);
  }
  const L = U(e.frame);
  if (L >= p && L <= a - m && (n.strokeStyle = "#a78bfa", n.lineWidth = 1.5, n.beginPath(), n.moveTo(L, f), n.lineTo(L, f + u), n.stroke(), n.fillStyle = "#a78bfa", n.beginPath(), n.moveTo(L - 4, f), n.lineTo(L + 4, f), n.lineTo(L, f + 6), n.closePath(), n.fill()), e.curveDrag || e.curveHover) {
    ...
    if (e.curveDrag)
      if (e.curveDrag.handle) {
        ...
        C = `F${e.curveDrag.key.frame} · ${e.curveDrag.channel.name} (${z})`, V = "Tangent edit";
      } else if (e.curveDrag.group && e.curveDrag.group.length > 1) {
        const z = e.curveDrag.key.frame - e.curveDrag.startFrame, H = e.curveDrag.channel.get(e.curveDrag.object ? e.curveDrag.key.transform : e.curveDrag.key.camera), Z = H - e.curveDrag.startValue, ce = z >= 0 ? `+${z}` : `${z}`, se = Z >= 0 ? `+${Z.toFixed(2)}` : `${Z.toFixed(2)}`;
        C = `${e.curveDrag.group.length} keys · ΔF: ${ce} · ΔVal: ${se}`, V = `${e.curveDrag.channel.name}: ${H.toFixed(2)}`;
      } else {
        const z = e.curveDrag.key.frame - e.curveDrag.startFrame, H = e.curveDrag.channel.get(e.curveDrag.object ? e.curveDrag.key.transform : e.curveDrag.key.camera), Z = H - e.curveDrag.startValue, ce = z >= 0 ? `+${z}` : `${z}`, se = Z >= 0 ? `+${Z.toFixed(2)}` : `${Z.toFixed(2)}`;
        C = `F${e.curveDrag.key.frame} (${ce}) · ${e.curveDrag.channel.name}: ${H.toFixed(2)} (${se})`;
      }
    else if (e.curveHover)
      if (e.curveHover.channelName) {
        const z = Number.isFinite(e.curveHover.value) ? e.curveHover.value.toFixed(2) : "";
        C = `F${e.curveHover.frame} · ${e.curveHover.channelName}: ${z}`, e.curveHover.isHandle && (V = `Handle ${e.curveHover.handleSide}`);
      } else
        C = `Frame ${e.curveHover.frame}`;
    if (C) {
      n.save(), n.font = "11px system-ui, -apple-system, sans-serif";
      const z = n.measureText(C), H = V ? n.measureText(V) : { width: 0 }, Z = Math.max(z.width, H.width) + 16, ce = V ? 32 : 20, se = a - m - Z - 6, ae = f + 6;
      n.fillStyle = "rgba(18, 18, 24, 0.88)", n.strokeStyle = "#38384a", n.lineWidth = 1, n.beginPath(), n.roundRect ? n.roundRect(se, ae, Z, ce, 4) : n.rect(se, ae, Z, ce), n.fill(), n.stroke(), n.fillStyle = "#e2e8f0", n.fillText(C, se + 8, ae + (V ? 13 : 14)), V && (n.fillStyle = "#94a3b8", n.font = "9.5px system-ui, -apple-system, sans-serif", n.fillText(V, se + 8, ae + 26)), n.restore();
    }
  }
  for (const C of e.root.querySelectorAll("[data-tangent-mode]")) {
    const V = e.selectedKeyframe(), z = V?.tangents?.channels?.[l[0]?.id]?.mode || V?.tangents?.mode || "auto";
    C.classList.toggle("active", C.dataset.tangentMode === z);
  }
...
function ds(e) {
  ...
  if (!t) return;
  const a = e.timelineObject(), o = a ? a.name || a.type : e.activeCameraTrack().name, r = fd(e), n = `${o}\0${r.map((c) => `${c.id}:${c.color}`).join("|")}`;
  if (t.dataset.signature !== n) {
    t.dataset.signature = n, t.replaceChildren();
...
function en(e, t, a) {
  ...
  for (const n of [...e].sort((i, c) => i.frame - c.frame)) {
    ...
    (r === null || !(Math.abs(c - r) <= hd)) && o.push(n.frame), r = c;
  }
  return o;
}
function Tr(e) {
...
function yd(e, t, a, o, r) {
  ...
  e.contextMenu?.show(t, n?.name || s("Shot"), [
    ...
    },
    {
      ...
      disabled: r === 1,
      run: () => {
        e.checkpoint("Remove shot"), ii(e.state, o) && xt(e);
      }
    }
  ]);
}
function vd(e, t, a, o) {
  ...
  if (c.className = "oc-sequence-name", c.textContent = r?.name || t.camera_id, i.appendChild(c), a > 0) {
    ...
    l.className = "oc-sequence-handle", l.title = s("Drag to trim the cut"), l.addEventListener("pointerdown", (p) => gd(e, p, l, o, a)), i.appendChild(l);
  }
  return i.addEventListener("contextmenu", (l) => yd(e, l, t, a, o.__cutCount)), i.addEventListener("pointerdown", () => {
...
function fs(e, t) {
  ...
  if (n.className = "oc-sequence-lane", n.dataset.role = "sequence-lane", n.setAttribute("aria-label", s("Multi-camera edit")), o.length)
    for (const [c, l] of o.entries()) {
      ...
      he(e, l.end + 1) < -5 || p > 105 || n.appendChild(vd(e, l, c, r));
    }
  else {
    const c = document.createElement("span");
  ...
  r.appendChild(n), r.appendChild(xd(e));
  const i = document.createElement("span");
  i.className = "oc-sequence-playhead", i.style.left = `${he(e, e.frame)}%`, r.appendChild(i), t.appendChild(r);
}
const wd = ['[data-act="curve-zoom-in"]', '[data-act="curve-zoom-out"]', '[data-act="curve-fit"]', '[data-act="curve-handles"]'], an = { curves: "Graph", dope: "Timeline", sequence: "Sequence" };
function on(e, t) {
  ...
  a === "dope" ? Tr(e) : a === "sequence" ? (fs(e, n), n?.focus?.({ preventScroll: !0 })) : e.drawCurveEditor(), e.setStatus(s(an[a]));
}
function kd(e) {
  e.graphTab === "sequence" && fs(e, e.root.querySelector('[data-role="graph-sequence"]'));
}
function Sd(e, t) {
...
function Cd(e) {
  ...
  if (!t || !a) return;
  const o = hs(e.state?.metadata, e.state?.duration_frames), r = o.some((c) => c.state !== "unknown");
...
function Ed(e) {
  ...
  if (e.audioWaveformPeaks && e.audioWaveformPeaks.length) {
    ...
    const k = x.getContext("2d"), y = e.audioWaveformPeaks, j = x.width, A = x.height, R = A / 2;
    k.fillStyle = "#f2d06b";
    for (let N = 0; N < y.length; N++) {
      const W = (N / (y.length - 1) * r - l) / Math.max(1e-6, c) * j;
      if (W >= -5 && W <= j + 5) {
        const G = y[N] * (A * 0.85);
        k.fillRect(W, R - G / 2, Math.max(1, j / y.length * n - 0.5), G);
      }
    }
    t.appendChild(x);
  }
  if (e.state.playback_range) {
    ...
    const k = he(e, e.state.playback_range[0]), y = he(e, e.state.playback_range[1]);
    x.style.left = `${k}%`, x.style.width = `${Math.max(0, y - k)}%`, t.appendChild(x);
  }
  di(e, t);
  for (const x of e.state.markers || []) {
    ...
    y.className = "timeline-marker", y.style.left = `${k}%`, y.style.setProperty("--marker-color", x.color), y.title = x.name, t.appendChild(y);
  }
  if (o.length > 1) {
    const x = he(e, o[0].frame), k = he(e, o[o.length - 1].frame), y = document.createElement("span");
    y.className = "oc-dope-rail", y.style.left = `${Math.min(x, k)}%`, y.style.width = `${Math.abs(k - x)}%`, y.style.setProperty("--channel-color", "#a78bfa"), t.appendChild(y);
  }
  ...
  for (const x of o) {
    ...
    y.type = "button", y.className = `key${x.frame === e.frame ? " at-playhead" : ""}${p.has(x.frame) ? " selected" : ""}${x.frame === e.editingKeyFrame ? " editing" : ""}`, y.dataset.keyFrame = String(x.frame), y.dataset.interp = x.interpolation || "ease", y.setAttribute("aria-label", s(`${a?.name || "Camera"} keyframe at frame ${x.frame}`)), y.title = s(`Frame ${x.frame} · ${x.interpolation} · Drag: Retime · Alt+Drag: Duplicate`), y.style.left = `${k}%`;
    const j = document.createElement("span");
    j.className = "key-label", j.textContent = String(x.frame), y.appendChild(j), y.addEventListener("pointerdown", (A) => {
      if (A.preventDefault(), A.stopPropagation(), y.focus({ preventScroll: !0 }), A.altKey) {
        e.checkpoint("Duplicate keyframe");
        const N = a ? { frame: x.frame, transform: Ve(x.transform), interpolation: x.interpolation } : { frame: x.frame, camera: pe(x.camera), interpolation: x.interpolation }, X = e.timelineKeyframes();
        X.push(N), X.sort((W, G) => W.frame - G.frame), e.selectedKeyFrame = N.frame, e.selectedKeyFrames = /* @__PURE__ */ new Set([N.frame]), e.keyDrag = { key: N, box: t, isDuplicate: !0, historyCheckpointed: !0, moving: [{ key: N, startFrame: N.frame }], startPointerFrame: x.frame, startClientX: A.clientX, startClientY: A.clientY }, e.setFrame(N.frame, !1, !1), e.setStatus(s(`Duplicating key from ${x.frame}...`));
        return;
      }
      if (A.shiftKey) {
      ...
      const R = e.timelineKeyframes().filter((N) => e.selectedKeyFrames.has(N.frame));
      e.keyDrag = { key: x, box: t, historyCheckpointed: !1, moving: R.map((N) => ({ key: N, startFrame: N.frame })), startPointerFrame: x.frame, startClientX: A.clientX, startClientY: A.clientY }, e.setFrame(x.frame, !1, !1);
  ...
  if (f) {
    ...
    const y = o.filter((j) => j.frame > e.state.duration_frames - 1).length;
    if (y) {
      const j = document.createElement("span");
      j.className = "oc-dormant-keys", j.textContent = ` · ${y} beyond end`, j.title = s("Keys past the end of the timeline are kept. Lengthen the shot to reach them again."), f.append(j);
    }
  }
  ...
  if (u) {
    ...
    for (const x of e.state.cameras) {
      ...
      const j = document.createElement("span");
      j.textContent = `${x.name} · ${x.keyframes.length} key${x.keyframes.length === 1 ? "" : "s"}${x.id === e.state.playblast_camera_id ? " · PLAYBLAST" : ""}`, k.append(y, j), k.addEventListener("click", () => {
  ...
  g && (g.textContent = `${m.name} · ${s("Frame")} ${e.frame}`);
  const v = e.root.querySelector('[data-role="inspector-camera-name"]');
  v && (v.textContent = m.name), cs(e), rs(e), ds(e), Tr(e), kd(e), e.refreshCameraSelectors(), e.refreshKeyEditor(), e.updateEditState(), e.drawCurveEditor(), e.perf && (e.perf.timelineRefreshCount = (e.perf.timelineRefreshCount || 0) + 1), Cd(e);
}
class us {
...
function Gd() {
  const e = Qc.map((t) => `<button data-lens="${t}">${t}mm</button>`).join("");
  return `
  ...
  return `
    <div class="oc-dope">
      <div class="oc-dope-body">
        <div class="oc-dope-labels">${os.map((t) => `
...
const Qe = 1, nn = 50, Me = 120, pt = 160, hm = Object.freeze(["perspective", "orthographic"]), K = Object.freeze({
...
}), ys = Object.freeze(Object.values(K)), we = Object.freeze({
  SCENE_GET: "scene.get",
...
}), um = Object.freeze(Object.values(we));
...
const bm = 25, sn = 100;
function ft(e, t) {
  const a = e?.offset === void 0 ? 0 : Number(e.offset), o = e?.limit === void 0 ? bm : Number(e.limit);
  ...
  switch (t?.type) {
    ...
    case we.HEALTH_GET:
      return ke(e, {
        version: 1,
        type: t.type,
        frames: hs(a.metadata, a.duration_frames)
      });
    case we.ASSET_LIST: {
...
function Cm(e, t) {
  ...
  e.objects ||= [];
  const a = new Set(e.objects.map((i) => i.id)), o = zo(a, t.objectType, t.id), r = xm(t.objectType), n = {
    id: o,
    type: t.objectType,
    name: t.name || o,
    ...r,
...
function Lm(e, t) {
  ...
  for (a.has(t) && a.delete(t), a.add(t); a.size > Pm; )
...
function Fm(e, t) {
  ...
  if (e.far !== void 0) {
    ...
    const a = e.near === void 0 ? mi : e.near;
    if (e.far <= a)
      throw new I("BAD_VALUE", "camera.far must be greater than camera.near", t);
  }
  if (e.camera_type !== void 0 && !hm.includes(e.camera_type))
...
function Rm(e, t) {
  ...
  switch (a) {
    ...
    case K.OBJECT_CREATE:
      if (te(e.objectType, "objectType", t), !vs.has(e.objectType))
...
function Dm(e, t) {
  ...
  return t.operations.forEach((a, o) => Rm(a, o)), {
    version: Qe,
    id: t.id,
...
const Bm = "omnicam/library", qm = "majoor_omnicam/blockout_library", Um = Object.freeze({
...
function xs(e) {
  return e.file ? `${e.source === "legacy" ? qm : Bm}/${e.file} [input]` : "";
}
function cn(e, t, a) {
  const o = e || "asset";
  let r = `${o}_${a}`, n = 2;
...
function Hm(e, t = {}) {
  ...
  const a = Wm(t.point, [0, 0, 0]), o = String(t.idSeed || Date.now().toString(36)), r = String(e.kind || "prop"), n = r === "character", i = Um[e.id];
  ...
  return n && (c.character = Vm(e)), c;
}
function Gm({ groundHit: e, orbitTarget: t } = {}) {
...
const Ym = {
  [K.ASSET_INSTANTIATE](e, t) {
    ...
    let o;
    try {
      o = Hm(t.asset, { point: t.point, idSeed: t.id, existingIds: a });
    } catch (r) {
      throw new I("BAD_ASSET", `asset.instantiate could not compile: ${r.message}`);
    }
    return (e.objects ||= []).push(o), {
      dirtyMask: E.viewport | E.previews | E.outliner | E.inspector,
      outcome: { objectId: o.id, assetId: o.asset_id || null }
    };
  },
  [K.CAMERA_SET_ACTIVE](e, t) {
    return nr(e, t.cameraId), e.active_camera_id = t.cameraId, { dirtyMask: E.viewport | E.previews | E.inspector | E.outliner | E.timeline };
  },
  [K.CAMERA_SET_LOCKED](e, t) {
    return nr(e, t.cameraId).locked = t.value, { dirtyMask: E.outliner | E.inspector | E.viewport };
  },
  [K.CAMERA_CREATE](e, t) {
    const a = wm(e, t);
    return { dirtyMask: E.outliner | E.inspector | E.viewport | E.previews | E.timeline, outcome: a };
  },
  ...
  [K.CAMERA_RENAME](e, t) {
    ut(e, t.cameraId);
    const a = jm(e, t);
    return { dirtyMask: E.outliner | E.inspector, outcome: a };
  },
  [K.CAMERA_SET_PLAYBLAST](e, t) {
    const a = _m(e, t);
    return { dirtyMask: E.outliner | E.inspector | E.status, outcome: a };
  },
  [K.CAMERA_TRANSFORM](e, t) {
    ...
    return { dirtyMask: E.viewport | E.previews | E.inspector | E.timeline };
  },
  ...
  [K.OBJECT_CREATE](e, t) {
    const a = Cm(e, t);
    return { dirtyMask: E.viewport | E.previews | E.outliner | E.inspector, outcome: a };
  },
  ...
  [K.OBJECT_SET_PARENT](e, t) {
    st(e, t.objectId);
    const a = $m(e, t);
    return { dirtyMask: E.viewport | E.outliner | E.inspector, outcome: a };
  },
  [K.OBJECT_TRANSFORM](e, t) {
    const a = st(e, t.objectId);
    return t.position && (a.position = [...t.position]), t.rotation && (a.rotation = [...t.rotation]), t.scale && (a.size = [...t.scale]), { dirtyMask: E.viewport | E.previews | E.inspector };
  },
  [K.OBJECT_SET_ENABLED](e, t) {
    return st(e, t.objectId).enabled = t.value, { dirtyMask: E.viewport | E.previews | E.outliner | E.inspector };
  },
  [K.OBJECT_SET_LOCKED](e, t) {
    return sr(e, t.objectId).locked = t.value, { dirtyMask: E.outliner | E.inspector };
  },
  [K.OBJECT_SET_TAGS](e, t) {
    const a = st(e, t.objectId), o = hi(t.tags), r = o.length !== t.tags.length ? "some tags were dropped or normalised" : void 0;
    return o.length ? a.tags = o : delete a.tags, { dirtyMask: E.outliner | E.inspector | E.viewport, warning: r };
  },
  [K.OBJECT_SET_ANNOTATION](e, t) {
    ...
    return o ? a.annotation = o : delete a.annotation, { dirtyMask: E.viewport | E.outliner | E.inspector };
  },
  [K.CHARACTER_SET_POSE](e, t) {
    ...
    }, { dirtyMask: E.viewport | E.previews | E.inspector };
  },
  [K.CHARACTER_SET_JOINT_ROTATION](e, t) {
    ...
    return a.character = {
      ...a.character || {},
      pose: fi(a.character?.pose, t.joint, t.rotation)
    }, { dirtyMask: E.viewport | E.previews | E.inspector };
  },
  [K.CHARACTER_SET_MOTION](e, t) {
    ...
    return a.character = {
      ...
      motion: o
    }, { dirtyMask: E.viewport | E.previews | E.timeline | E.inspector };
  },
  [K.CHARACTER_CLEAR_MOTION](e, t) {
    const a = fo(e, t.objectId);
    return a.character ? (a.character = { ...a.character, motion: null }, { dirtyMask: E.viewport | E.previews | E.timeline | E.inspector }) : { dirtyMask: 0 };
  },
  [K.KEYFRAME_UPSERT](e, t) {
    ...
    return { dirtyMask: E.viewport | E.previews | E.timeline | E.inspector, warning: n };
  },
  [K.KEYFRAME_REMOVE](e, t) {
    ...
    return { dirtyMask: E.viewport | E.previews | E.timeline | E.inspector, warning: r };
  },
  [K.KEYFRAME_SET_INTERPOLATION](e, t) {
    ...
    return o.interpolation = t.interpolation, { dirtyMask: E.timeline | E.viewport | E.previews };
  },
  [K.TIMELINE_SET_RANGE](e, t) {
    ...
    return e.playback_range = [t.start, t.end], { dirtyMask: E.timeline | E.status };
  },
  [K.TIMELINE_SET_DURATION](e, t) {
    ...
    return { dirtyMask: E.timeline | E.viewport | E.previews | E.status };
  },
  [K.CUT_UPSERT](e, t) {
    const a = Mm(e, t);
    return { dirtyMask: E.timeline | E.viewport | E.previews | E.status, outcome: a };
  },
  [K.CUT_REMOVE](e, t) {
    const a = Im(e, t);
    return { dirtyMask: E.timeline | E.viewport | E.previews | E.status, outcome: a };
...
function Xm({ state: e, operation: t }) {
  const a = Ym[t.type];
...
function Zm(e, t) {
  ...
  return ep(e, t, r), ap(e, t, r), rp(e, t, r), op(e, t, r), np(e, t, r), sp(e, t, r), { changes: a, truncated: o };
}
const Qm = ["fov", "roll", "zoom", "near", "far", "camera_type"];
function ep(e, t, a) {
...
function pp(e, t) {
  ...
  try {
    ...
    if (f instanceof I) return Ho(e, t?.id, f);
    throw f;
  }
  const o = cr(e);
  ...
  for (let f = 0; f < a.operations.length; f += 1)
    try {
      const d = Xm({ ui: e, state: r, operation: a.operations[f] });
  ...
  if (a.validateOnly) {
    const { changes: f, truncated: d } = Zm(e.state, r);
    return {
      ok: !0,
      version: Qe,
      revision: o,
  ...
  const l = cp(e);
  Lm(e, a.id), e.serialize?.(), lp(e, l), mp(e, n, `director-api:${a.id}`);
  const p = {
    ok: !0,
    version: Qe,
    baseRevision: o,
...
function hp(e) {
  return e.directorApi = fp(e), e.directorApi;
}
const dn = "omnicam-agent/1", mn = "majoor.omnicam.agent.request", up = 1, Nt = Object.freeze({
...
}), bp = 1e4, gp = 5e3, ws = "asset.instantiate_by_id", ks = "asset.catalog_search", pn = Object.freeze([
  ...ys.filter((e) => e !== K.ASSET_INSTANTIATE),
  ws
]);
function lr(e) {
...
function wp(e, t, a) {
  ...
  async function d() {
    ...
    try {
      const j = await Ft(a, Nt.register, {
        protocol: dn,
        client_id: y,
        node_id: String(t.id),
      ...
      if (o || k !== p) return;
      r = j.session_id, n = j.session_token, i = y, u();
    } catch {
      if (o || k !== p) return;
      h();
    }
  ...
  async function g(k) {
    const y = k?.detail;
    if (o || !y || y.protocol !== dn || Number(y.schema_version) !== up || y.session_id !== r || String(y.node_id) !== String(t.id)) return;
    let j;
    try {
      if (y.kind === "query")
        j = y.payload?.type === ks ? await xp(e, y.payload) : e.directorApi.query(y.payload);
      else if (y.kind === "transaction") {
        const A = y.payload, R = (A?.operations || []).find(
          (N) => !pn.includes(N?.type)
        );
        if (!Number.isInteger(A?.baseRevision) || A.baseRevision < 0)
          ...
          const N = await vp(e, A.operations);
          N.ok ? (j = e.directorApi.execute({ ...A, operations: N.operations }), await j?._reconciliation) : j = Rt(e, N.code, N.message);
        }
      } else
        j = Rt(e, "UNKNOWN_AGENT_REQUEST", `Unsupported Agent request kind: ${y.kind}`);
    } catch (A) {
      j = Rt(e, A?.code || "INTERNAL", A?.message || "OmniCam Agent request failed");
    }
    try {
      await Ft(a, Nt.reply, {
        session_id: r,
  ...
  return a.addEventListener?.(mn, g), a.addEventListener?.("status", x), d(), {
    get sessionId() {
      return r;
    },
    dispose() {
      if (o) return;
      o = !0, clearInterval(c), clearTimeout(l), a.removeEventListener?.(mn, g), a.removeEventListener?.("status", x);
      const k = r, y = n;
      r = null, n = null, k && y && Ft(a, Nt.close, {
        session_id: k,
        session_token: y
      }).catch(() => {
      });
...
function Mr({ fetchApi: e = kp } = {}) {
  const t = (a, o) => Promise.resolve(e(a, o)).then(Sp);
  return {
    list(a = {}) {
...
const Ss = Object.freeze(["all", "character", "prop", "environment", "vehicle"]);
function hn(e = {}) {
  const t = String(e.kind || "all").toLowerCase();
  return {
    kind: Ss.includes(t) ? t : "all",
...
const Ap = 256;
function un(e = {}) {
  const { THREE: t, GLTFLoader: a, FBXLoader: o, size: r = Ap } = e;
  if (!t || !a)
  ...
  const l = () => {
    ...
    if (d.isEmpty()) return;
    const h = d.getCenter(new t.Vector3()), u = d.getSize(new t.Vector3()), g = Math.max(u.length() / 2, 1e-3) / Math.sin(c.fov * Math.PI / 360);
    c.position.set(h.x + g * 0.7, h.y + g * 0.55, h.z + g), c.near = g / 100, c.far = g * 10, c.updateProjectionMatrix(), c.lookAt(h);
    ...
    async render(f, d = "glb") {
      ...
      try {
        ...
        return i.remove(h), h.traverse?.((b) => {
          b.geometry?.dispose?.();
          const g = b.material;
          Array.isArray(g) ? g.forEach((v) => v.dispose?.()) : g?.dispose?.();
        }), u;
      } catch {
        return null;
      }
...
function Op(e, t = {}) {
  return Ss.map((a) => {
    const o = s(Ip[a] || a), r = a === "all" ? "" : ` <span class="oc-asset-kind-n">${Number(t[a] || 0)}</span>`;
    return `<button type="button" class="oc-asset-kind${a === (e || "all") ? " active" : ""}" data-asset-kind="${a}">${vt(o)}${r}</button>`;
  }).join("");
}
function Pp(e, { selected: t = !1, thumbUrl: a = "" } = {}) {
  const o = Mp[e.kind] || "pi-box", r = e.kind === "character" && Un(e.rig) === "rigged" ? `<span class="oc-asset-badge">${s("RIGGED")}</span>` : "", n = a ? `<img class="oc-asset-thumb" src="${vt(a)}" alt="" loading="lazy">` : `<span class="oc-asset-thumb oc-asset-thumb--glyph"><i class="pi ${o}"></i></span>`;
...
function Lp(e, { selectedId: t = "", thumbUrls: a = {} } = {}) {
  return !e || !e.length ? `<p class="oc-asset-empty">${s("No assets match this filter.")}</p>` : e.map((o) => Pp(o, {
    selected: o.id === t,
    thumbUrl: a[o.id] || ""
  })).join("");
}
...
function zp(e, t = {}) {
  const a = e.root, o = t.fetchApi || ((O, B) => (e.api || e.app?.api).fetchApi(O, B)), r = t.apiClient || Mr({ fetchApi: o }), n = t.store || _p(r), i = Cp(), c = t.previewQueue || Ep(), l = e.api || e.app?.api || null;
  let p = t.thumbnailRenderer || null, m = null;
  const f = /* @__PURE__ */ new Set();
  function d() {
    return p ? Promise.resolve(p) : (m || (m = Tp().then((O) => p = un(O)).catch(() => p = un({}))), m);
  }
  function h(O) {
    return Ur(l, xs(O));
  }
  function u(O) {
    return O.thumbnail ? Ur(l, `omnicam/library/${O.thumbnail} [input]`) : "";
  }
  function b() {
    for (const O of n.state.items) {
      if (O.kind === "helper" || !O.file || i.get(O.id) || O.thumbnail || f.has(O.id)) continue;
      const B = h(O);
      B && c.enqueue(O.id, async () => {
        const Se = await (await d()).render(B, O.format || "glb");
        if (!Se) {
          f.add(O.id);
          return;
        }
        if (i.set(O.id, Se), H(), !(O.source && O.source !== "user"))
          try {
            const Oe = await r.uploadThumbnail(O.id, $p(Se));
  ...
  const g = (O) => a.querySelector(`[data-role="${O}"]`), v = g("assets-panel"), x = g("asset-grid"), k = g("asset-kinds"), y = g("asset-search"), j = g("asset-status"), A = g("asset-import-file"), R = g("scene-tab"), N = g("assets-tab"), X = g("agent-tab"), W = a.querySelector('[data-asset-view="agent"]'), G = { assets: N, agent: X };
  let re = "", _ = null, F = !0, U = !0, Y = "scene", L = 0;
  function C(O, { sticky: B = !1 } = {}) {
    j && (!B && L > Date.now() || (j.textContent = O || "", L = B ? Date.now() + 9e3 : 0));
  }
  function V(O) {
    if (re = O, !!x)
      for (const B of x.querySelectorAll(".oc-asset-card"))
        B.classList.toggle("selected", B.dataset.assetId === O);
  }
  let z = !1;
  function H() {
    if (k && (k.innerHTML = Op(n.state.filter.kind, n.state.kinds)), x) {
      const O = {};
      for (const B of n.state.items) {
        const de = i.get(B.id) || u(B);
        de && (O[B.id] = de);
      }
      x.innerHTML = Lp(n.state.items, { selectedId: re, thumbUrls: O });
    }
    if (!z) {
      z = !0;
      try {
  ...
  function Z(O) {
    ...
    const B = Gm({
      ...
      operations: [{ type: "asset.instantiate", asset: O, point: B }]
    });
    if (!de?.ok) {
  ...
  async function ce(O) {
    if (O) {
      C(s("Importing {name}...").replace("{name}", O.name));
      try {
        const B = await r.importModel(O, { kind: "prop", name: O.name.replace(/\.[^.]+$/, "") });
        B.asset && n.upsert(B.asset), C(s("Imported {name}").replace("{name}", B.asset?.name || O.name));
      } catch (B) {
        C(B.message || s("Import failed"));
      }
    }
  }
  const se = g("asset-local-form"), ae = g("asset-local-folder"), le = g("asset-local-note");
  function be() {
  ...
  async function fe(O) {
    ...
    L = 0, C(O ? s("Scanning {folder}...").replace("{folder}", B) : s("Installing characters from {folder}...").replace("{folder}", B));
    try {
      ...
      if (O) {
        const Pe = (de.candidates || []).map((ot) => ot.name).join(", ");
        C(
          (de.candidates || []).length ? s("{n} rig-complete character(s): {names}").replace("{n}", de.candidates.length).replace("{names}", Pe) : s("No rig-complete .glb/.fbx character found ({n} skipped)").replace("{n}", Se),
          { sticky: !0 }
        );
        return;
      }
      const Oe = (de.installed || []).filter((Pe) => Pe.status !== "conflict").length, Fe = (de.installed || []).filter((Pe) => Pe.status === "conflict").length;
      C(
        s("{n} character(s) installed{extra} — no restart needed").replace("{n}", Oe).replace("{extra}", Se || Fe ? ` (${Se} ${s("skipped")}${Fe ? `, ${Fe} ${s("unchanged")}` : ""})` : ""),
        { sticky: !0 }
      ), Oe && (n.refresh(), se && (se.hidden = !0));
    } catch (de) {
      C(de.message || s("Import failed"), { sticky: !0 });
    }
  }
  function ge(O) {
    O === "agent" && !er() && (O = "scene"), Y = O, R && (R.hidden = O !== "scene");
    for (const [B, de] of Object.entries(G))
      de && (de.hidden = B !== O);
    for (const B of a.querySelectorAll("[data-asset-view]"))
      B.classList.toggle("active", B.dataset.assetView === O);
    O === "assets" && F && (F = !1, n.refresh()), O === "agent" && U && (U = !1, t.onAgentFirstOpen?.());
  }
  function ye() {
    const O = er();
    W && (W.hidden = !O), !O && Y === "agent" && ge("scene");
  }
  function me(O) {
    const B = bn(O.target);
    if (B) {
  ...
  function ve() {
    clearTimeout(_), _ = setTimeout(() => n.setFilter({ search: y.value }), 200);
  }
  function xe(O) {
    const B = O.target.files?.[0];
    O.target.value = "", ce(B);
  }
  const ue = n.subscribe(H);
  return v?.addEventListener("click", me), v?.addEventListener("dblclick", Te), a.querySelector('[data-role="left-tabs"]')?.addEventListener("click", me), y?.addEventListener("input", ve), A?.addEventListener("change", xe), H(), ye(), {
    store: n,
    switchView: ge,
    syncAgentAvailability: ye,
    refresh: () => n.refresh(),
    dispose() {
      ue(), clearTimeout(_), v?.removeEventListener("click", me), v?.removeEventListener("dblclick", Te), a.querySelector('[data-role="left-tabs"]')?.removeEventListener("click", me), y?.removeEventListener("input", ve), A?.removeEventListener("change", xe), c.clear(), p?.dispose?.(), i.clear();
    }
  };
}
function Np(e, t = {}) {
  ...
  function l() {
    ...
    let b = 0;
    for (const g of u) {
      if (!Wn(g, { mode: n.mode, selectedIds: d })) continue;
      const v = Vn(g, n.content);
      if (!v) continue;
      const x = Hn(u, g, h) || {
        position: g.position,
        size: g.size
      }, k = e.webgl.projectWorldToScreen(Gn(x, g.type));
      if (!k || k.behind) continue;
      const y = i(b);
      b += 1, y.hidden = !1, y.textContent = v, y.style.transform = `translate(-50%, -100%) translate(${Math.round(k.x)}px, ${Math.round(k.y)}px)`;
      const j = n.content === "annotation" ? g.annotation?.color : "";
      y.style.setProperty("--oc-label-accent", j || ""), y.classList.toggle("is-annotation", n.content === "annotation" && !!j);
    }
    for (let g = b; g < r.length; g += 1) r[g].hidden = !0;
  }
  function p(m) {
...
function Dp(e, t = {}) {
  const a = e.root, o = t.apiClient || Mr({
    fetchApi: (v, x) => (e.api || e.app?.api).fetchApi(v, x)
  ...
  let c = null, l = {};
  const p = () => e.state?.objects?.find((v) => v.id === c) || null, m = () => e.webgl?.getModelBoneNames?.(c) || [];
  function f() {
    if (!i) return;
    const v = Wr(l);
    qo(l) ? (i.textContent = s("Humanoid v1 ✓ — all 22 joints mapped"), i.dataset.state = "ok") : (i.textContent = s("Incomplete — {n} joint(s) unmapped").replace("{n}", v.length), i.dataset.state = "warn");
  }
  function d() {
    n && (n.innerHTML = Rp(m(), l)), f();
  }
  function h() {
    const v = e.selectedObject?.(), x = v?.asset_kind === "character";
    if (r.hidden = !x, !x) {
      c = null;
      return;
    }
    v.id !== c && (c = v.id, r.open = !0, l = {}, v.asset_id ? o.get(v.asset_id).then((k) => {
      c === v.id && (l = { ...k?.asset?.rig?.bone_map || {} }, d());
    }).catch(() => d()) : d());
  }
  function u(v) {
    const x = v.target.closest("[data-rig-joint]");
    if (!x) return;
    const k = x.dataset.rigJoint;
    x.value ? l[k] = x.value : delete l[k], d();
  }
  function b(v) {
    const x = v.target.closest("[data-rig-act]")?.dataset.rigAct;
    x === "auto" ? (l = ar(m()), d()) : x === "validate" ? (d(), e.setStatus?.(qo(l) ? s("Rig is complete") : s("Rig still missing: {list}").replace("{list}", Wr(l).join(", ")))) : x === "save" && g();
  }
  async function g() {
    const v = p();
    if (!v?.asset_id) {
    ...
    try {
      const x = await o.patch(v.asset_id, {
...
function Kp(e, t = {}) {
  ...
  function i() {
    ...
    for (const h of Yn) {
      ...
      const v = n(h);
      v.hidden = !1, v.classList.toggle("selected", h === m), v.style.transform = `translate(-50%, -50%) translate(${Math.round(g.x)}px, ${Math.round(g.y)}px)`, d.add(h);
    }
...
function qp(e, t = {}) {
  const a = e.root, o = t.apiClient || Mr({
    fetchApi: (_, F) => (e.api || e.app?.api).fetchApi(_, F)
  ...
  function g(_) {
    const F = Co({ ..._, preset_id: _.id });
    return { id: _.id, name: _.name || _.id, root_offset: F.root_offset, joints: F.joints };
  }
  function v(_) {
    const F = d.get(_?.pose?.preset_id) || null;
    return bi({ preset: F, overrides: _?.pose }).joints;
  }
  function x() {
    const _ = h();
    !_?.character || !u() || e.webgl?.applyCharacterPose?.(m, u(), f || _.character.pose?.joints ? v(_.character) : {});
  }
  function k() {
    const _ = b(), F = f && !!_;
    if (c && (c.hidden = !F), !F) return;
    l && (l.textContent = _);
    const U = h(), Y = v(U?.character)[_] || [0, 0, 0, 1], L = gi(Y);
    p.forEach((C, V) => {
      C && document.activeElement !== C && (C.value = String(Math.round(L[V] * 100) / 100));
    });
  }
  function y() {
    const _ = h(), F = !!_?.character?.motion;
    if (i && (i.classList.toggle("active", f), i.disabled = F, i.title = F ? s("Clear the motion clip to edit the pose") : s("Toggle FK pose editing")), n) {
      const U = [["neutral", s("Standing Neutral")]].concat([...d.values()].filter((L) => L.id !== "neutral").map((L) => [L.id, L.name || L.id])), Y = U.map((L) => L.join(":")).join("|");
      n.dataset.sig !== Y && (n.dataset.sig = Y, n.replaceChildren(...U.map(([L, C]) => {
        const V = document.createElement("option");
        return V.value = L, V.textContent = C, V;
  ...
  async function j() {
    try {
      ...
      d = new Map((_.poses || []).filter((F) => F?.id).map((F) => [F.id, g(F)]));
    } catch {
      d = /* @__PURE__ */ new Map();
    }
    d.has("neutral") || d.set("neutral", g({ id: "neutral", name: "Standing Neutral" })), y();
  }
  function A() {
    const _ = b();
    if (!_) return;
    const F = p.map((L) => Number(L?.value) || 0), U = ui(F), Y = e.directorApi?.execute({
      version: 1,
      id: `tx_pose_${Date.now().toString(36)}`,
      description: "Pose joint",
      operations: [{ type: "character.set_joint_rotation", objectId: m, joint: _, rotation: U }]
    });
    Y && !Y.ok && e.setStatus?.(Y.error?.message || s("Could not set the joint")), y();
  }
  function R() {
    const _ = n?.value || "neutral", F = d.get(_) || Co({ preset_id: _ });
    e.directorApi?.execute({
      version: 1,
      id: `tx_preset_${Date.now().toString(36)}`,
      description: "Pose preset",
      operations: [{ type: "character.set_pose", objectId: m, pose: { preset_id: _, root_offset: F.root_offset, joints: {} } }]
    }), y();
  }
  async function N() {
    const _ = h();
    if (!_?.character) return;
    const F = (await Gt(e, s("Save Pose"), s("Pose name"), ""))?.trim();
    if (!F || e.disposed) return;
    const U = F.toLowerCase().replace(Bp, "-").replace(/^-+|-+$/g, "").slice(0, 60) || "pose";
    try {
      const Y = await o.savePose({
        id: U,
        name: F,
        profile: "omnicam_humanoid_v1",
        root_offset: _.character.pose?.root_offset || [0, 0, 0],
        joints: v(_.character)
      });
      d.set(Y.pose.id, g(Y.pose)), e.setStatus?.(s("Pose saved: {name}").replace("{name}", F)), y();
    } catch (Y) {
      e.setStatus?.(Y.message || s("Could not save the pose"));
    }
  }
  function X() {
    const _ = h();
    !_?.character || _.character.motion || (f = !f, !f && e.subSelection?.type === "character_joint" && (e.subSelection = null), y(), e.rigOverlay?.update?.());
  }
  function W(_) {
    f && (e.subSelection = { type: "character_joint", objectId: m, jointId: _ }, y(), e.rigOverlay?.update?.());
  }
  const G = Kp(e, {
    onPick: W,
  ...
  e.rigOverlay = G;
  function re() {
    const _ = e.selectedObject?.(), F = _?.asset_kind === "character";
    if (r.hidden = !F, !F) {
      f && (f = !1), m = null, G.update();
      return;
    }
    _.id !== m && (m = _.id, f = !1, e.subSelection?.type === "character_joint" && (e.subSelection = null), d.size || j()), y(), G.update();
  }
  n?.addEventListener("change", R), i?.addEventListener("click", X), r.querySelector('[data-pose-act="save"]')?.addEventListener("click", N);
  for (const _ of p)
    _?.addEventListener("change", A), _?.addEventListener("input", A);
  return j(), {
    sync: re,
    update() {
      G.update(), x();
    ...
    dispose() {
      G.dispose(), n?.removeEventListener("change", R), i?.removeEventListener("click", X);
      for (const _ of p)
        _?.removeEventListener("change", A), _?.removeEventListener("input", A);
    }
  };
}
function yn(e, t) {
...
function Up(e) {
  ...
  const a = (v) => t.querySelector(`[data-role="${v}"]`), o = a("motion-clip"), r = a("motion-start"), n = a("motion-end"), i = a("motion-speed"), c = a("motion-loop"), l = t.querySelector('[data-motion-act="bake"]');
  let p = null;
  const m = () => e.state?.objects?.find((v) => v.id === p) || null, f = () => e.modelInfoById?.get(p)?.animationNames || [];
  function d() {
    const v = o?.value || "";
    return v ? wr({
      clip_id: v,
  ...
  function h() {
    const v = d(), x = v ? { type: "character.set_motion", objectId: p, motion: v } : { type: "character.clear_motion", objectId: p }, k = e.directorApi?.execute({
      version: 1,
  ...
  function u() {
    const v = m(), x = f(), k = v?.character?.motion || null;
    if (o) {
      const j = x.join("|");
    ...
    const y = !!k;
    for (const j of [r, n, i, c]) j && (j.disabled = !y);
    l && (l.disabled = !y);
  }
  function b() {
    const v = m(), x = e.rigMapper?.boneMap;
    if (!v?.character || !x || !Object.keys(x).length) {
    ...
    e.directorApi?.execute({
      ...
      operations: [
        { type: "character.clear_motion", objectId: p },
        {
          ...
          objectId: p,
          pose: { preset_id: "neutral", root_offset: v.character.pose?.root_offset || [0, 0, 0], joints: k }
        }
      ]
  ...
  for (const v of [r, n, i, c]) v?.addEventListener("change", h);
  return l?.addEventListener("click", b), {
    sync: g,
    dispose() {
      o?.removeEventListener("change", h);
      for (const v of [r, n, i, c]) v?.removeEventListener("change", h);
...
const Wp = /* @__PURE__ */ new Set(["translate", "rotate", "scale"]), Vp = /* @__PURE__ */ new Set(["world", "local"]), Be = 180 / Math.PI;
function vn(e) {
  return [e.x, e.y, e.z];
}
function Hp(e) {
...
function Gp({
  ...
  const m = p ? p() : new e.Object3D(), f = l ? l(t, a) : new zl(t, a);
  let d = null;
  ...
  function x(L) {
    return u ? {
      position: L.position.map((C, V) => C - u.position[V]),
      rotationDeg: L.rotationDeg.map((C, V) => C - u.rotationDeg[V]),
      scaleFactors: L.scale.map((C, V) => u.scale[V] === 0 ? 1 : C / u.scale[V])
  ...
  f.addEventListener?.("mouseDown", k), f.addEventListener?.("objectChange", y), f.addEventListener?.("mouseUp", j), f.addEventListener?.("dragging-changed", A);
  function R(L) {
    h = L, m.position.set(...L.position || [0, 0, 0]);
    const C = L.rotation || [0, 0, 0];
    m.rotation.set(C[0] / Be, C[1] / Be, C[2] / Be), m.scale.set(...L.scale || [1, 1, 1]), f.attach(m), f.visible = !0;
  }
  function N() {
  ...
  function W(L) {
    if (!Wp.has(L)) throw new Error(`createTransformControlsAdapter: unknown mode "${L}"`);
    f.setMode ? f.setMode(L) : f.mode = L;
  }
  function G(L) {
    if (!Vp.has(L)) throw new Error(`createTransformControlsAdapter: unknown space "${L}"`);
    f.space = L;
  }
  function re(L) {
  ...
  function Y() {
    f.removeEventListener?.("mouseDown", k), f.removeEventListener?.("objectChange", y), f.removeEventListener?.("mouseUp", j), f.removeEventListener?.("dragging-changed", A), o?.remove && d && o.remove(d), o?.remove && o.remove(m), f.dispose?.(), h = null, u = null;
  }
  return {
    attach: R,
    detach: N,
...
const Yp = /* @__PURE__ */ new Set(["object", "camera", "camera_target"]);
function Xp(e, { controlsFactory: t, anchorFactory: a } = {}) {
  let o = null, r = null;
  function n() {
    return o || (!e.webgl || !e.interactionElement ? null : (o = Gp({
      THREE: Ll,
      ...
      onDragEnd: f,
      onDraggingChanged: (g) => {
        e.transformControlsDragging = g;
      }
    }), o));
  }
  function i({ targetSpec: g }) {
    if (g) {
      if (g.type === "object") {
        e.checkpoint("Transform object");
        const v = vi(e), x = (v.length ? v : [g.object]).map((y) => ({
          object: y,
          transform: Ve(y)
        }));
        for (const y of x) e.beginObjectEdit(y.object);
        const k = x.reduce((y, j) => _e(y, j.transform.position), [0, 0, 0]).map((y) => y / x.length);
        r = { type: "object", group: x, pivot: k };
        return;
      }
      if (g.type === "camera") {
      ...
      if (g.type === "camera_target") {
        e.checkpoint("Move camera target"), e.beginCameraEdit();
        const v = e.activeCameraTrack?.(), x = !!v?.target_object_id;
        r = {
          type: "camera_target",
          tracking: x,
          base: x ? [...v.target_offset || [0, 0, 0]] : [...e.camera.target]
        };
      }
    }
  }
  function c({ delta: g }) {
    r && (r.type === "object" ? l(g) : r.type === "camera" ? p(g) : r.type === "camera_target" && m(g), e.render());
  }
  function l(g) {
    const { group: v, pivot: x } = r, k = e.state.gizmo_mode;
    for (const y of v)
      if (k === "translate")
        y.object.position = _e(y.transform.position, g.position);
      else if (k === "rotate")
        y.object.position = _e(x, Hr(Kt(y.transform.position, x), g.rotationDeg)), y.object.rotation = _e(y.transform.rotation, g.rotationDeg);
      else if (k === "scale") {
        const j = Kt(y.transform.position, x);
        y.object.position = _e(x, j.map((A, R) => A * g.scaleFactors[R])), y.object.size = y.transform.size.map((A, R) => Math.max(0.01, A * g.scaleFactors[R]));
      }
    for (const y of v) e.commitObjectEdit(y.object);
  }
  function p(g) {
    if (e.state.gizmo_mode === "translate")
      e.camera.position = _e(r.position, g.position);
    else {
      const v = Kt(r.target, r.position);
      e.camera.target = _e(r.position, Hr(v, g.rotationDeg));
    }
    e.commitCameraEdit();
  }
  function m(g) {
    const v = _e(r.base, g.position);
    r.tracking ? xi(e, v) : e.camera.target = v, e.commitCameraEdit();
  }
  function f({ cancelled: g }) {
    if (!r) return;
    const v = r.type;
    g ? (e.undo(), (v === "camera" || v === "camera_target") && e.finishCameraEdit()) : v === "camera" || v === "camera_target" ? e.finishCameraEdit() : (e.editingKeyFrame = null, e.updateKeyVisualState?.(), e.drawCurveEditor?.()), r = null, e.refreshInspector(), e.render();
  }
  function d() {
    if (!e.webgl || !e.interactionElement) return;
    const g = e.recording ? null : yi(e), v = e.state.gizmo_mode || "translate";
    if (!(!!g && Yp.has(g.type) && g.allowedModes.includes(v))) {
      o?.detach();
      return;
    }
    n() && (o.isDragging() || (o.setCamera(e.webgl.activeCamera), o.setMode(v), o.setSpace(e.state.gizmo_space === "local" ? "local" : "world"), o.attach(g)));
  }
  function h() {
  ...
  return { sync: d, isPointerOverHandle: h, cancelDrag: u, dispose: b };
}
function Jp(e, t) {
...
function No(e, t, a) {
  ...
  const o = St(e), r = o.expanded ? 220 : 138, n = Math.min(r, Math.max(80, Math.min(t, a) - 20)), i = 10, c = Math.max(0, t - n - i), l = Math.max(0, a - n - i), p = e.viewportCamera(), m = p?.position || [0, 1.5, 5], f = p?.target || [0, 0, 0], d = e.activeCameraTrack?.(), h = e.state.cameras?.length ? e.state.cameras : d ? [d] : [], u = h.flatMap(
    (j) => (j.keyframes || []).map((A) => A.camera?.position).filter(Boolean)
  );
  let b = 12;
  ...
  const g = c + n / 2, v = l + n / 2, x = n / 2 - 12, k = x / b, y = o.centerMode === "camera" ? [m[0] || 0, m[2] || 0] : [0, 0];
  return {
    rx: c,
    ry: l,
    radarSize: n,
...
function of(e, t, a, o) {
  const r = No(e, a, o);
  if (!r) return;
  const { rx: n, ry: i, radarSize: c, cx: l, cy: p, innerRadius: m, range: f, scale: d, camPos: h, camTgt: u, cameras: b, activeTrack: g } = r, v = St(e), x = e.state.active_camera_id || g?.id, k = (ae, le) => _s(r, ae, le);
  ...
  const y = t.createRadialGradient(l, p, 2, l, p, m);
  y.addColorStop(0, "rgba(0, 210, 211, 0.06)"), y.addColorStop(1, "rgba(0, 0, 0, 0)"), t.fillStyle = y, t.fillRect(n, i, c, c), t.strokeStyle = "rgba(0, 210, 211, 0.38)", t.lineWidth = 1.2, t.strokeRect(n, i, c, c);
  const j = [0.33, 0.66, 1];
  ...
  for (const ae of e.state.objects || []) {
    ...
    const le = Sr(e.state.objects, ae).position || [0, 0, 0], [be, fe] = k(le[0], le[2]);
  ...
  for (let ae = 0; ae < b.length; ae++) {
    const le = b[ae], be = le.keyframes || [], fe = le.id === x, ge = le.color || xn[ae % xn.length];
    t.save(), t.strokeStyle = ge, t.globalAlpha = fe ? 0.95 : 0.4, t.lineWidth = fe ? 2 : 1, t.setLineDash(fe ? [] : [2, 2]), t.beginPath();
    let ye = !1;
    const me = be[0]?.frame, Te = be[be.length - 1]?.frame;
    for (let ve = me; Number.isFinite(ve) && ve <= Te; ve++) {
      const xe = $e(le, ve, e.state.objects)?.position;
      if (!Array.isArray(xe)) continue;
      const [ue, O] = k(xe[0], xe[2]);
    ...
    for (const ve of be) {
      ...
      t.fillStyle = B ? "#ffffff" : ge, t.globalAlpha = fe ? 0.95 : 0.6, t.beginPath(), t.moveTo(ue, O - 3), t.lineTo(ue + 3, O), t.lineTo(ue, O + 3), t.lineTo(ue - 3, O), t.closePath(), t.fill(), B && (t.strokeStyle = "#00d2d3", t.lineWidth = 1.2, t.stroke());
    }
    t.restore();
  }
  const [A, R] = k(h[0] || 0, h[2] || 0), [N, X] = k(u[0] || 0, u[2] || 0), W = 8, G = J(A, n + W, n + c - W), re = J(R, i + W, i + c - W), _ = J(N, n + W, n + c - W), F = J(X, i + W, i + c - W), U = h[1] || 0, Y = tf(U), L = af(U);
  t.strokeStyle = "rgba(255, 255, 255, 0.40)", t.lineWidth = 1, t.setLineDash([3, 3]), t.beginPath(), t.moveTo(G, re), t.lineTo(_, F), t.stroke(), t.setLineDash([]), t.fillStyle = "#ffffff", t.beginPath(), t.arc(_, F, 2.5, 0, Math.PI * 2), t.fill(), t.strokeStyle = "rgba(255, 255, 255, 0.7)", t.lineWidth = 1, t.beginPath(), t.arc(_, F, 4.5, 0, Math.PI * 2), t.stroke();
  const C = u[0] - h[0], V = u[2] - h[2], z = Math.atan2(V, C), Z = (e.viewportCamera().fov || 35) * Math.PI / 360, ce = J(24 * (d / (m / 8)), 16, 38), se = t.createRadialGradient(G, re, 2, G, re, ce);
  se.addColorStop(0, Y + "55"), se.addColorStop(1, Y + "08"), t.fillStyle = se, t.strokeStyle = Y, t.lineWidth = 1.2, t.beginPath(), t.moveTo(G, re), t.lineTo(G + Math.cos(z - Z) * ce, re + Math.sin(z - Z) * ce), t.arc(G, re, ce, z - Z, z + Z), t.closePath(), t.fill(), t.stroke(), t.fillStyle = Y + "44", t.beginPath(), t.arc(G, re, 6.5, 0, Math.PI * 2), t.fill(), t.fillStyle = Y, t.beginPath(), t.arc(G, re, 3.5, 0, Math.PI * 2), t.fill(), t.strokeStyle = "#ffffff", t.lineWidth = 1.5, t.beginPath(), t.moveTo(G, re), t.lineTo(G + Math.cos(z) * 7, re + Math.sin(z) * 7), t.stroke(), rf(e, t, r, Y, L, z, Math.hypot(C, V)), v.hover && nf(t, r, v.hover), t.restore();
}
function rf(e, t, a, o, r, n, i) {
  ...
  const u = m.expanded ? "⤡" : "⤢";
  uo(t, c + 96, f, 14, d, u, m.hover?.button === "size"), t.font = "bold 8.5px monospace", t.fillStyle = o, t.textAlign = "right", t.fillText(`Y:${r}`, c + p - 5, l + 9), t.fillStyle = "rgba(15, 23, 42, 0.70)", t.fillRect(c, l + p - 15, p, 15), t.strokeStyle = "rgba(0, 210, 211, 0.15)", t.beginPath(), t.moveTo(c, l + p - 15), t.lineTo(c + p, l + p - 15), t.stroke();
...
function Es(e, t, a, o) {
  const { camPos: r, camTgt: n, cameras: i, rx: c, ry: l, radarSize: p } = t, m = (g, v) => _s(t, g, v), [f, d] = m(r[0] || 0, r[2] || 0);
  ...
  for (const g of e.state.objects || []) {
    ...
    const v = Sr(e.state.objects, g).position || [0, 0, 0], [x, k] = m(v[0], v[2]);
...
function sf(e, t, a, o) {
  ...
  const r = No(e, e.canvas.width, e.canvas.height);
  if (!r) return !1;
  const { rx: n, ry: i, radarSize: c } = r;
  if (a < n || a > n + c || o < i || o > i + c)
    return !1;
  t.preventDefault?.(), t.stopPropagation?.();
  const l = St(e), p = Cs(r, a, o);
  if (p)
...
function cf(e, t, a, o) {
  ...
  if (n.drag) {
    const [b, g] = dr(r, a, o), v = e.viewportCamera();
    return n.drag.type === "camera" ? v.position = [b, v.position?.[1] || 1.5, g] : n.drag.type === "target" && (v.target = [b, v.target?.[1] || 0, g]), e.setFrame?.(e.frame, !1, !1), e.render?.(), !0;
  }
  if (!p)
    return n.hover && (n.hover = null, e.render?.()), !1;
  const m = Cs(r, a, o), f = Es(e, r, a, o), [d, h] = dr(r, a, o);
...
function df(e, t, a) {
  ...
  const o = () => {
    ...
    const h = ki(t('[data-role="object-tags"]')?.value || "");
    h.length ? d.tags = h : delete d.tags;
    const u = String(t('[data-role="object-annotation"]')?.value || "").trim(), b = u ? qn({
      text: u,
  ...
  }, { signal: a }), Yl(e, a), Sd(e, a), t('[data-role="curve-group"]')?.addEventListener("change", () => {
    e.setChannelFilter("all"), ds(e), e.drawCurveEditor(), Tr(e);
  ...
  const c = (d, h) => {
    ...
    if (!(!u || h.button === 2 || d.closest(".scene-action-btn")))
      if (u.dataset.objectId) {
        const b = e.state.objects.find((v) => v.id === u.dataset.objectId);
        if (!b) return;
        if (e.finishCameraEdit(), e.selectedObjectIds ||= /* @__PURE__ */ new Set(), h.ctrlKey || h.metaKey)
          ...
          const v = e.state.objects.map((y) => y.id), x = v.indexOf(e.outlinerAnchorId), k = v.indexOf(b.id);
          e.selectedObjectIds = new Set(v.slice(Math.min(x, k), Math.max(x, k) + 1));
        } else
          e.selectedObjectIds = /* @__PURE__ */ new Set([b.id]), e.outlinerAnchorId = b.id;
        e.selectedObjectId = e.selectedObjectIds.has(b.id) ? b.id : [...e.selectedObjectIds].at(-1) || null, e.selectedEntity = e.selectedObjectIds.size ? "object" : "camera", e.selectedKeyFrame = e.selectedObjectId ? b.keyframes?.find((v) => v.frame === e.frame)?.frame ?? null : null, e.editingKeyFrame = null;
        for (const v of e.root.querySelectorAll(".scene-item")) {
          const x = !!(v.dataset.objectId && e.selectedObjectIds.has(v.dataset.objectId)), k = !!(v.dataset.objectId && v.dataset.objectId === e.selectedObjectId);
          v.classList.toggle("selected", x), v.classList.toggle("primary", k), v.setAttribute("aria-selected", String(x));
        }
        const g = e.root.querySelector('[data-role="outliner-batch-bar"]');
        if (g) {
          const v = e.selectedObjectIds?.size || 0;
          g.hidden = v < 2;
          const x = g.querySelector('[data-role="batch-count"]');
          x && (x.textContent = `${v} ${s("selected")}`);
        }
  ...
  e.root.addEventListener("pointerdown", (d) => {
    ...
    const h = e.interactionElement.getBoundingClientRect(), u = (d.clientX - h.left) * e.canvas.width / Math.max(1, h.width), b = (d.clientY - h.top) * e.canvas.height / Math.max(1, h.height);
    lf(e, d, u, b) || e.onWheel(d);
  }, { passive: !1, signal: a }), e.root.addEventListener("wheel", Ml(e.root), { signal: a }), window.addEventListener("pointermove", (d) => {
  ...
  const p = (d) => {
    const h = Si(d.composedPath?.()[0] || d.target);
    h && (e.lastKeyZone = h);
  };
  e.root.addEventListener("focusin", p, { signal: a }), e.root.addEventListener("pointerdown", p, { capture: !0, signal: a }), e.root.addEventListener("focusout", (d) => {
    e.modalTransform && !e.root.contains(d.relatedTarget) && (wi(e), e.render());
  }, { signal: a });
...
function ff(e) {
  const t = hc(e.id, e.defaultValue), a = `pref_${e.id.replace(/[^a-zA-Z0-9]/g, "_")}`;
  if (e.type === "boolean")
    return `
...
function uf() {
  return `<span class="oc-pref-emoji" aria-hidden="true">${mf}</span> ${s("OmniCam Preferences")}`;
}
function bf(e) {
  ...
  a.className = "oc-modal-backdrop", a.setAttribute("role", "dialog"), a.setAttribute("aria-modal", "true"), a.setAttribute("aria-label", s("OmniCam Preferences")), a.innerHTML = `
    <div class="oc-modal-dialog oc-pref-dialog" tabindex="-1">
      <div class="oc-pref-header">
        <div class="oc-pref-title">${uf()}</div>
...
const yf = ["position", "target"], vf = ["fov", "zoom"], xf = ["roll"], wf = ["position", "size"], kf = ["rotation"];
function mr(e) {
  ...
  for (let r = 1; r < a.length - 1; r++) {
    ...
    if (i.camera) {
      for (const m of yf) {
        ...
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const u = kn(f, d, h, p);
          a[r].camera[m] = jn(d.map(Number), u, o);
        }
      }
      for (const m of vf) {
        const f = n.camera?.[m], d = i.camera?.[m], h = c.camera?.[m];
    ...
    if (Array.isArray(i.position) && Array.isArray(n.position) && Array.isArray(c.position)) {
      for (const m of wf) {
        ...
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const u = kn(f, d, h, p);
          a[r][m] = jn(d.map(Number), u, o);
        }
      }
      for (const m of kf) {
        const f = n[m], d = i[m], h = c[m];
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const u = [0, 1, 2].map((b) => Sn(f[b], d[b], h[b], p));
          a[r][m] = d.map((b, g) => _n(Number(b), u[g], o));
        }
      }
    }
  }
...
function $f(e, t) {
  ...
  const o = (r) => {
    ...
    const u = (g) => {
      const v = g.clientX - c;
      if (Math.abs(v) > 2 && (d = !0), !d) return;
      h || (e.checkpoint?.("Scrub axis"), h = !0);
      let x = Ef;
      g.shiftKey ? x = Af : (g.ctrlKey || g.metaKey) && (x = Tf);
      const k = p * x * 20;
      let y = l + v * k;
      y = Math.max(m, Math.min(f, y));
      const j = p >= 1 ? 0 : p >= 0.1 ? 1 : 2;
      i.value = y.toFixed(j), i.dispatchEvent(new Event("input", { bubbles: !0 })), i.dispatchEvent(new Event("change", { bubbles: !0 }));
    }, b = (g) => {
      if (n.classList.remove("scrubbing"), document.body.style.cursor = "", n.removeEventListener("pointermove", u), n.removeEventListener("pointerup", b), n.removeEventListener("pointercancel", b), n.releasePointerCapture)
        try {
          n.releasePointerCapture(g.pointerId);
        } catch {
        }
...
function Of(e, t) {
  for (const o of e.root.querySelectorAll('[data-act="toggle-camera-lock"]'))
    o.addEventListener("click", (r) => {
      r.stopPropagation(), e.checkpoint?.("Toggle camera lock"), e.state.camera_lock = !e.state.camera_lock, e.serialize?.(), As(e), e.setStatus?.(e.state.camera_lock ? s("Camera View locked") : s("Camera View unlocked"));
    }, { signal: t });
...
function Lf(e, t) {
  ...
  }, n = (i) => (e.smoothingBaseline?.cameraId !== i.id && (e.smoothingBaseline = { cameraId: i.id, keys: Cf(i.keyframes) }), e.smoothingBaseline.keys);
  a.addEventListener("input", r, { signal: t }), a.addEventListener("change", () => {
    const i = e.activeCameraTrack();
    if (!i) return;
    e.checkpoint("Path smoothing");
    const c = Number(a.value) / 100, l = _f(n(i), c);
  ...
  if (a.length) {
    ...
    for (const o of a)
      o.addEventListener("change", () => {
        e.dopeChannels = new Set(a.filter((r) => r.checked).map((r) => r.dataset.dopeChannel)), rs(e);
      }, { signal: t });
  }
}
function Rf(e, t) {
...
const bo = () => import("./chunk-Dfkqo1Ff.js");
function Kf(e, t) {
...
function Bf(e, t) {
  ...
  uc().then((r) => {
    ...
    c === "health-slow" ? gc(e) : c === "health-smooth" ? yc(e) : c === "health-recenter" && vc(e);
  }, { signal: t });
...
function Vf(e, t) {
  Kf(e, t), Pf(e, t), Lf(e, t), zf(e, t), Nf(e, t), qf(e, t), Wf(e, t), Uf(e, t), $f(e, t), Mf(e, t), Ff(e, t), Df(e, t), Of(e, t), Rf(e, t), Bf(e, t);
}
const Cn = {
...
}, Ts = "balanced", Xo = "#121212";
function Ir(e) {
  return Cn[e] || Cn[Ts];
}
function Hf(e, t = "#1b1f2b", a = "#151822", o = "#1e2330", r = "#161922", n = "#111319") {
...
function kg(e, t, a = Ts) {
  ...
  const h = new e.FogExp2(1250588, 8e-3), u = Hf(e), b = new e.PMREMGenerator(t);
  b.compileEquirectangularShader();
  const g = new Nl(), v = b.fromScene(g, 0.04).texture;
  return g.traverse((x) => {
    x.geometry?.dispose?.();
    ...
    quality: a,
    dispose() {
      f.geometry.dispose(), f.material.dispose(), d.geometry.dispose(), d.material.dispose(), m.dispose(), u.dispose(), v.dispose(), b.dispose();
...
function Yf(e) {
  ...
  const r = e.reconstruction, n = r.provider || "Reconstructed", i = Math.round(t * 100), c = rl(e), l = c.length ? `
` + c.map(([m, f]) => `${m}: ${f}`).join(`
`) : "", p = `${n} • ${o} (${i}%)${l}`;
  return {
    label: o,
...
function _g(e, t, a) {
  return e?.reconstruction ? a ? "neutral" : Xf(t) === "source_texture" ? "textured" : "neutral" : null;
}
function Jf(e, t) {
...
function Zf(e, t, a) {
  ...
  if (o) {
    const n = (i) => {
      const c = i.target.closest?.("[data-axis], [data-axis-center]") || i.target, l = c.getAttribute("data-axis"), p = xc(l?.toLowerCase(), e.state.view_mode);
  ...
  for (const n of e.root.querySelectorAll("[data-lens]"))
    n.addEventListener("click", () => {
      nl(e, Number(n.dataset.lens));
    }, { signal: a });
  for (const n of e.root.querySelectorAll("[data-blocking-scene]"))
    n.addEventListener("click", () => {
      ef(e, n.dataset.blockingScene), e.closeMenus();
    }, { signal: a });
...
const Qf = 32, eh = 0.025, th = 0.05, Ao = 1e-6, ah = ["top", "bottom", "front", "back", "left", "right"], oh = {
  top: "y",
  bottom: "y",
  front: "z",
  back: "z",
...
function ch(e) {
  ...
  const n = Math.min(Qf, r.length, o + 1);
  if (n < 2) return [];
  const i = nh(r, n);
  ...
  ], p = e.planeAxis === "y" ? $s(l) : Ms(l, [0, 0, -1]), m = e.seedPoint ? 1 : 0, f = [];
  for (let d = m; d < i.length; d++) {
    const h = i[d], u = sh(i, d, p, e.planeAxis), b = pe(c);
    b.position = [...h], b.target = ih(h, u, l, e.planeAxis), f.push({
...
function Is(e, t = e.cameraPathDraw) {
  const a = t?.pointerId;
  if (a != null)
    try {
...
function An(e, t = {}) {
  ...
  if (a === "extend") {
    ...
    const u = Math.max(0, Math.round(Number(e.state.duration_frames) || 1) - 1), [, b] = En(e.state), g = d.length > 1 ? d[d.length - 1].frame - d[0].frame : 24;
    let v = Math.max(b, h.frame + Math.max(6, Math.min(g, 240)));
    v <= h.frame && (v = h.frame + 24), v > u && (l = v + 1), v > b && (p = v), c = [h.frame, v];
  } else
    ah.includes(e.state.view_mode) || e.setViewMode?.("top"), c = En(e.state);
  const m = oh[e.state.view_mode] ?? null, f = n ? [...n] : [...r.position];
...
function Lr(e, t) {
  ...
  return r && Pr(r, o) < eh ? !1 : (a.points.push(o), !0);
}
function qe(e) {
  const t = e.cameraPathDraw;
  return t?.active ? (Is(e, t), e.cameraPathDraw = null, Wt(e), e.setStatus?.(s("Draw Camera Path cancelled")), e.render?.(), !0) : !1;
}
function dh(e) {
  const t = e.cameraPathDraw;
  ...
  if (a.length < 2 || rh(a) < th || t.range[1] <= t.range[0])
  ...
  const r = sl(e.state), n = e.state.cameras.length, i = {
    id: r,
    name: lh(e.state),
...
function hh(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : ($o(t), t.type === "pointercancel" || t.type === "lostpointercapture" ? (qe(e), !0) : (Lr(e, zr(e, t)), a.drawing = !1, dh(e), !0));
}
function uh(e) {
  const t = e.cameraPathDraw;
...
function Nr(e, t, { name: a = "", status: o } = {}) {
  const r = t && typeof t == "object" ? t : Jn(), n = { ...r, metadata: { ...r.metadata || {}, scene_name: a || "" } };
...
async function gh(e) {
  await Yt(e, s("New Scene"), s("Start a new scene? Unsaved changes will be lost.")) && Nr(e, Jn(), { name: "", status: s("New scene") });
}
async function yh(e) {
  if (!e.sceneBaseline) {
  ...
  const o = a?.metadata?.scene_name || Os(e);
  Nr(e, a, { name: o, status: s("Scene reset to last save") });
}
async function vh(e) {
  const t = Os(e) || s("Untitled"), a = await Gt(e, s("Save Scene"), s("Scene name"), t);
  if (a == null) return;
...
function kh(e, t) {
  yo(e, t, e.root.querySelectorAll('[data-act="scene-new"]'), () => gh(e)), yo(e, t, e.root.querySelectorAll('[data-act="scene-open"]'), () => xh(e)), yo(e, t, e.root.querySelectorAll('[data-act="scene-save"]'), () => vh(e)), yo(e, t, e.root.querySelectorAll('[data-act="scene-reset"]'), () => yh(e));
}
const Sh = ["world_point", "object_point", "camera_field"], Tn = 40;
function jh(e) {
...
function Eh(e) {
  ...
  if (!c) return;
  const l = Ps(t, e.state.width || 1280, e.state.height || 720), p = (g) => l.x + g * l.w, m = (g) => l.y + g * l.h;
  ...
  for (let g = 1; g < 3; g += 1)
    c.beginPath(), c.moveTo(p(g / 3), l.y), c.lineTo(p(g / 3), l.y + l.h), c.stroke(), c.beginPath(), c.moveTo(l.x, m(g / 3)), c.lineTo(l.x + l.w, m(g / 3)), c.stroke();
  ...
  for (const g of e.state.motion_layers || []) {
    if (g.enabled === !1) continue;
    const v = Sh.includes(g.source_kind), x = v ? _h(e.state, g, d) : jh(g);
    if (!x.length) continue;
    u += 1;
    const k = g.id === e.state.selected_motion_layer_id;
    if (c.strokeStyle = k ? "#ffcc4d" : "rgba(65,217,197,0.6)", c.lineWidth = (k ? 2.4 : 1.5) * r, c.beginPath(), x.forEach((j, A) => {
      const R = p(j.x), N = m(j.y);
      A ? c.lineTo(R, N) : c.moveTo(R, N);
    }), c.stroke(), !v) {
    ...
    const y = Ch(x, h);
    y && (c.fillStyle = k ? "#ffcc4d" : "#41d9c5", c.strokeStyle = "#fff", c.lineWidth = 1.4 * r, c.beginPath(), c.arc(p(y.x), m(y.y), 4.4 * r, 0, Math.PI * 2), c.fill(), c.stroke());
  }
...
function Ah(e, t) {
  ...
  a && a.addEventListener("click", (o) => {
    ...
    }, l = kc(e.state.motion_layers, c, 0.09);
...
function Mh(e, t) {
  ...
  return {
    ...
    motion_scene_fingerprint: Il(e.state)
  };
}
function Ih(e, t) {
  const a = Mh(e, t);
...
const ct = 1024 * 1024, Oh = Object.freeze({
  card: 128 * ct,
  // MAX_CARD_BYTES
  model: 256 * ct,
  // MAX_MODEL_BYTES
...
async function Nh(e, { load: t = () => import("./vendor-mediabunny-CZ5VNE-V.js") } = {}) {
...
async function Rh(e, t, { decode: a = Nh } = {}) {
  if (!t) return;
  const o = Xt(t, "audio");
  if (o) {
    e.setStatus(o);
  ...
  try {
    ...
    n.preload = "auto", n.src = r, e.audioObjectUrl = r, e.audioElement = n, await Fh(n), e.audioDuration = Number.isFinite(n.duration) ? n.duration : 0;
    try {
      e.audioSamples = await a(t);
    } catch {
      e.audioSamples = null;
    }
    Ls(e), e.setStatus(`Audio loaded: ${t.name || "track"}`);
  } catch (r) {
...
const Ns = /* @__PURE__ */ new WeakSet(), Bt = /* @__PURE__ */ new WeakMap();
function Io(e) {
...
function Kh(e) {
  ...
  Bt.delete(e), Ns.has(e) && Io(e);
}
function Jt(e, t) {
  const a = e.cardMediaById.get(t);
  a && (e.cardMediaById.delete(t), e.cardMediaAssetById?.delete?.(t), t === "subject" && e.cardMedia === a && (e.cardMedia = null), Kh(a));
}
function Bh(e) {
...
function tt(e, t, a, o = !1, r = "") {
  ...
  n && n !== a && Jt(e, t), o && Ns.add(a), Dh(a), e.cardMediaAssetById ||= /* @__PURE__ */ new Map(), e.cardMediaById.set(t, a), e.cardMediaAssetById.set(t, r || a?.__omnicamAsset || "");
  try {
    a.__omnicamAsset = r || a.__omnicamAsset || "";
  } catch {
  }
...
function Fs(e, t, { signal: a, timeout: o = 15e3 } = {}) {
...
async function Rs(e, t, a, o = () => !0, r = null) {
  if (!t || !a) return;
  const n = () => !e.disposed && o(), i = String(t.asset || a).toLowerCase();
  if (r ?? /\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/.test(i)) {
    const l = document.createElement("video");
    if (l.src = a, l.loop = !0, l.muted = !0, l.playsInline = !0, await Fs(l, ["loadeddata", "error"], { signal: e.abortController?.signal }).catch(() => {
    }), !n()) {
      Io(l);
      return;
    }
...
async function Xh(e) {
  ...
  for (const f of i) {
    ...
    if (h) {
      if (d === "image" || d === "video") {
        ...
        if (u && u.value) {
          const b = String(u.value), g = /\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/i.test(b), v = h.widgets?.find((y) => String(y.name).toLowerCase() === "subfolder")?.value || "", x = Ze(bt(b, v)), k = e.state.objects.find((y) => y.id === "subject");
          if (k) {
            const y = await Rs(e, k, x, r, g);
            if (!r()) return;
            k.asset = bt(b, v);
            let j = null;
            if (g)
              try {
                j = await qh(b, o.signal);
              } catch (A) {
            ...
            r() && $n(e, y, {
              fps: j?.fps,
              frameCount: g ? j?.frame_count : 1
            }), e.upstreamImageConnected = !0, n = !0, e.setStatus(s(`Upstream ${g ? "video" : "image"}: ${b}`));
          }
        } else {
          const b = Pl(h);
          b && (b instanceof HTMLVideoElement && b.paused && b.play().catch(() => {
          }), tt(e, "subject", b, !1, b.currentSrc || b.src || ""), $n(e, b, { frameCount: b instanceof HTMLVideoElement ? 0 : 1 }), e.upstreamImageConnected = !0, n = !0, e.render(), e.setStatus(b instanceof HTMLVideoElement ? s("Upstream video preview synced") : s("Upstream image preview synced")));
        }
      }
      if (d === "audio") {
        l = !0;
        ...
        if (u && u.value) {
          const b = String(u.value), g = h.widgets?.find((x) => String(x.name).toLowerCase() === "subfolder")?.value || "", v = Ze(bt(b, g));
          try {
            const x = await fetch(v, { signal: o.signal });
            if (x.ok) {
              const k = await x.blob();
              if (!r()) return;
              const y = new File([k], b, { type: k.type || "audio/wav" });
              await e.loadAudioFile(y), e.upstreamAudioConnected = !0, n = !0, e.setStatus(s(`Upstream audio: ${b}`));
            }
          } catch (x) {
      ...
      if (d === "scene_3d" || d === "model" || d === "mesh") {
        ...
        if (u && u.value) {
          const b = String(u.value), g = b.split(".").pop()?.toLowerCase();
          if (["glb", "gltf", "obj", "fbx", "stl", "ply"].includes(g)) {
            const v = h.widgets?.find((j) => String(j.name).toLowerCase() === "subfolder")?.value || "", x = Ze(bt(b, v)), k = `upstream_scene_${h.id}`;
            p.add(k);
            let y = e.state.objects.find((j) => j.id === k);
            y ? (y.asset = bt(b, v), y.format = g === "gltf" ? "glb" : g) : (y = {
              id: k,
              type: "model",
              format: g === "gltf" ? "glb" : g,
              ...
              enabled: !0,
              asset: bt(b, v)
            }, e.state.objects.push(y)), e.modelUrlsById.set(k, x), e.serialize(), e.refreshObjects(), e.render(), n = !0, e.setStatus(s(`Upstream 3D model: ${b}`));
          }
        }
      }
    }
  ...
  ll(e) && (n = !0), n && (e.serialize(), e.render());
}
const Jh = ["video/mp4;codecs=avc1.42E01E", "video/webm;codecs=vp9", "video/webm;codecs=vp8", "video/webm"], On = { low: 3e6, balanced: 6e6, high: 12e6 };
function Zh(e) {
  ...
  try {
    for (const k of Jh)
      if (!(n.isTypeSupported && !n.isTypeSupported(k)))
        try {
          f = new n(m, { mimeType: k, videoBitsPerSecond: Zh(r) });
          break;
        } catch {
        }
    ...
    const h = new Promise((k, y) => {
      f.addEventListener("stop", k, { once: !0 }), f.addEventListener("error", () => y(f.error || new Error("MediaRecorder failed")), { once: !0 });
    });
    f.start(100);
    const u = c();
    for (let k = 0; k < a; k++) {
    ...
    f.stop(), await h;
    const b = Math.max(0, c() - u), g = a / t * 1e3, v = {
...
async function tu(e) {
  await Promise.all([...e].filter((t) => t instanceof HTMLVideoElement && t.seeking).map((t) => Fs(t, ["seeked", "error"], { timeout: 5e3 }).catch(() => {
  })));
}
async function Ds(e) {
...
async function Bs(e, t) {
  const a = await eu(at, t);
  if (Ih(e, t), e.state.playblast_camera_id === Zn)
...
async function ou(e) {
  ...
  const t = e.frame, a = e.canvas.width, o = e.canvas.height, r = au(e);
  (r.width !== e.canvas.width || r.height !== e.canvas.height) && (e.canvas.width = r.width, e.canvas.height = r.height, e.render());
  try {
    let n = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-CJAo58oq.js");
    i !== "realtime" && await l(e.canvas.width, e.canvas.height) && (n = await c(e.canvas, e.state.duration_frames, e.state.fps, async (p) => {
      e.setFrame(p, !0), e.setStatus(s(`Encoding frame ${p + 1}/${e.state.duration_frames}…`)), await Ds(e), await new Promise((m) => requestAnimationFrame(m));
    }, e.abortController?.signal, e.state.playblast_quality)), n || (e.setStatus(s("WebCodecs unavailable; recording realtime fallback…")), n = await Ks(e)), e.setFrame(t), await Bs(e, n);
  } catch (n) {
...
async function nu(e, t) {
  ...
  let r = null;
  try {
    if (e.setStatus(`Uploading background: ${t.name}`), r = await qs(t), o !== e.backgroundRequestId || e.disposed) {
      await Oo([r]);
      return;
    }
    const n = Ze(r.path);
...
async function su(e, t) {
  ...
  try {
    ...
    for (const c of t)
      if (n.push(await qs(c)), r !== e.backgroundRequestId || e.disposed) {
        await Oo(n);
        return;
      }
...
function iu(e) {
  Fr(e), e.checkpoint?.("Clear background"), e.state.viewport_bg_image = "", e.state.viewport_bg_sequence = [], e.viewportBgImage = null, e.viewportBgSequenceImages = [], e.serialize(), e.render(), e.setStatus("Background cleared");
}
function cu(e) {
  ...
  for (const m of a) {
    ...
    if (!h) continue;
    const [u, b] = h, g = t.content === "annotation" && m.annotation?.color || "", v = 6 * c, x = 4 * c, y = r.measureText(f).width + v * 2, j = 12 * c + x * 2, A = Math.round(u - y / 2), R = Math.round(b - j - 6 * c);
    r.fillStyle = "rgba(16,17,22,0.82)", lu(r, A, R, y, j, 4 * c), r.fill(), g && (r.strokeStyle = g, r.lineWidth = Math.max(1, c), r.stroke()), r.fillStyle = g || "#e6e6ec", r.fillText(f, A + v, R + j - x - 2 * c);
  }
  r.restore();
}
function lu(e, t, a, o, r, n) {
...
function mu(e) {
  ...
  return e._pointFieldCache?.key !== r && (e._pointFieldCache = { key: r, ..._c(t, a, o) }), e._pointFieldCache;
}
const pu = 600;
function fu(e) {
  const { points: t, colors: a } = mu(e);
  if (!t.length) return;
  const o = e.viewportCamera(), r = e.canvas.width, n = e.canvas.height, i = t.length / 3, c = 3 * Math.max(1, Math.ceil(i / pu)), l = /* @__PURE__ */ new Map();
...
function bu(e, t) {
  const [a, o, r] = t.position || [0, 0, 0], n = t.size?.[1] || 1.8, i = (t.size?.[0] || 0.7) * 0.5, c = [a, o + n * 0.88, r], l = [a, o + n * 0.76, r], p = [a - i * 0.55, o + n * 0.73, r], m = [a + i * 0.55, o + n * 0.73, r], f = [a - i * 0.72, o + n * 0.52, r], d = [a + i * 0.72, o + n * 0.52, r], h = [a - i * 0.82, o + n * 0.34, r], u = [a + i * 0.82, o + n * 0.34, r], b = [a, o + n * 0.44, r], g = [a - i * 0.28, o + n * 0.44, r], v = [a + i * 0.28, o + n * 0.44, r], x = [a - i * 0.28, o + n * 0.22, r], k = [a + i * 0.28, o + n * 0.22, r], y = [a - i * 0.28, o, r + 0.05], j = [a + i * 0.28, o, r + 0.05];
  ie(e, c, l, "#aaa", 2), ie(e, l, b, "#aaa", 2), ie(e, p, m, "#aaa", 2), ie(e, p, f, "#aaa", 2), ie(e, f, h, "#aaa", 2), ie(e, m, d, "#aaa", 2), ie(e, d, u, "#aaa", 2), ie(e, g, v, "#aaa", 2), ie(e, g, x, "#aaa", 2), ie(e, x, y, "#aaa", 2), ie(e, v, k, "#aaa", 2), ie(e, k, j, "#aaa", 2);
  const A = We(c, e.viewportCamera(), e.canvas.width, e.canvas.height);
  A && (e.ctx.strokeStyle = "#aaa", e.ctx.beginPath(), e.ctx.arc(A[0], A[1], J(28 / A[2], 3, 12), 0, Math.PI * 2), e.ctx.stroke());
}
function gu(e, t) {
  const [a, o, r] = t.position || [0, 0, 0], [n, i, c] = t.size || [1.5, 1.5, 1.5], l = n * 0.5, p = (c || n) * 0.5, m = i * 0.5, f = 12, d = [], h = [];
  for (let u = 0; u < f; u++) {
    const b = u / f * Math.PI * 2, g = Math.cos(b) * l, v = Math.sin(b) * p;
    d.push([a + g, o + m, r + v]), h.push([a + g, o - m, r + v]);
  }
  for (let u = 0; u < f; u++) {
    const b = (u + 1) % f;
...
function yu(e, t) {
  ...
  for (let h = 0; h < m; h++) {
    const u = h / m * Math.PI * 2, b = Math.cos(u), g = Math.sin(u);
    f.push([a + b * (l + p), o, r + g * (l + p)]), d.push([a + b * (l - p), o, r + g * (l - p)]);
  }
  for (let h = 0; h < m; h++) {
    const u = (h + 1) % m;
...
function xu(e, t) {
  const [a, o, r] = t.position || [0, 1.5, 0], [n, i] = t.size || [2, 3], c = e.viewportCamera(), l = [
    ...
    [a + n / 2, o + i / 2, r],
    [a - n / 2, o + i / 2, r]
  ].map((g) => We(g, c, e.canvas.width, e.canvas.height));
  if (l.some((g) => !g)) return;
  const p = l.map((g) => g[0]), m = l.map((g) => g[1]), f = Math.min(...p), d = Math.max(...p), h = Math.min(...m), u = Math.max(...m);
  ...
  if (b)
    try {
      const g = Math.max(1, d - f), v = Math.max(1, u - h), x = b.videoWidth || b.naturalWidth || b.width, k = b.videoHeight || b.naturalHeight || b.height, y = e.state.card_fit || "contain";
      if (e.ctx.fillStyle = "#111", e.ctx.fillRect(f, h, g, v), y === "stretch" || !x || !k)
        e.ctx.drawImage(b, f, h, g, v);
      else if (y === "contain") {
        const j = Math.min(g / x, v / k), A = x * j, R = k * j;
        e.ctx.drawImage(b, f + (g - A) / 2, h + (v - R) / 2, A, R);
      } else {
        const j = Math.max(g / x, v / k), A = g / j, R = v / j;
        e.ctx.drawImage(b, (x - A) / 2, (k - R) / 2, A, R, f, h, g, v);
      }
    } catch {
    }
  else
  ...
  (e.state.cameras || []).forEach((a, o) => {
    ...
    if (!(i && e.state.view_mode === "camera")) {
      ...
      if (e.state.view_mode !== "camera") {
        const c = $e(a, e.frame, e.state.objects), l = We(c.position, e.viewportCamera(), e.canvas.width, e.canvas.height);
...
function ku(e) {
  ...
  for (let o = 0; o < e.state.keyframes.length - 1; o++) {
    ...
    t.push(Xn(Kt(n.camera.position, r.camera.position)) * e.state.fps / Math.max(1, n.frame - r.frame));
  }
...
function Su(e) {
  ...
  e.recording && e.state.playblast_labels && cu(e);
}
...
async function Cu(e) {
  ...
  const r = o.diagnostic?.issues || [], n = _u(r);
...
function Vs(e) {
  ...
  const r = (d, h, u, b, g = "") => {
    ...
    return v.type = "button", v.className = "scene-action-btn", u && (v.style.cssText = g || "color:#f59e0b;border-color:#78350f;background:rgba(245,158,11,0.15)"), v.title = s(h), v.innerHTML = `<i class="pi ${d}" style="font-size:10px"></i>`, v.addEventListener("click", (x) => {
      x.stopPropagation(), b(x);
    }), v;
  }, n = (e.outlinerFilter || "").trim().toLowerCase(), i = (d) => !n || String(d || "").toLowerCase().includes(n), c = (d, h, u) => {
    const b = !!(e.outlinerCollapsedSections?.has(u) && !n), g = document.createElement("div");
    return g.className = "scene-section-header", g.dataset.section = u, g.innerHTML = `
    ...
    `, g.addEventListener("click", () => {
      e.outlinerCollapsedSections ||= /* @__PURE__ */ new Set(), e.outlinerCollapsedSections.has(u) ? e.outlinerCollapsedSections.delete(u) : e.outlinerCollapsedSections.add(u), Vs(e);
  ...
  if (p) {
    ...
    if (t.appendChild(h), !u)
      for (const b of d) {
        ...
        const v = b.id === e.state.active_camera_id, x = b.id === e.state.playblast_camera_id, k = e.selectedEntity === "camera" && v;
        g.setAttribute("aria-selected", String(k)), g.className = `scene-item${k ? " selected" : ""}${v && !k ? " active-view" : ""}`;
        const y = document.createElement("i");
        y.className = "pi pi-video", y.style.cssText = "color:#60a5fa";
        const j = document.createElement("span");
        if (j.className = "scene-item-label", k || v) {
          const N = document.createElement("span");
          N.style.cssText = `color:${k ? "#f59e0b" : "#58cc6b"};font-weight:700`, N.textContent = k ? "● " : "○ ", j.appendChild(N);
        }
        if (j.appendChild(document.createTextNode(b.name)), x) {
          const N = document.createElement("span");
          N.style.cssText = "color:#f2d06b;font-size:10px", N.title = "Playblast Output", N.textContent = " ★", j.appendChild(N);
        }
        if (b.muted) {
          const N = document.createElement("span");
          N.style.opacity = ".6", N.textContent = " (muted)", j.appendChild(N);
        }
        const A = document.createElement("div");
        A.className = "scene-item-actions", A.appendChild(r("pi-star", "Solo track", b.solo, () => {
          ...
          e.selectedEntity === "camera_path" && v,
          () => {
            e.activateCamera(b.id), e.selectCameraPath();
          }
        )), A.appendChild(r("pi-ellipsis-v", "Camera actions", !1, (N) => e.openCameraContext(N, b.id, !1))), g.append(y, j, A), g.title = k ? s("Currently selected for editing") : x ? s("Active playblast camera") : s("Click to select & activate this camera");
        const R = () => {
        ...
        g.addEventListener("contextmenu", (N) => {
          N.preventDefault(), N.stopPropagation(), e.openCameraContext(N, b.id, !1);
        }), g.addEventListener("keydown", (N) => {
          (N.key === "Enter" || N.key === " ") && (N.preventDefault(), R());
        }), t.appendChild(g);
      }
  }
  if (m) {
    const d = new Map(e.state.objects.map((y) => [y.id, y])), h = /* @__PURE__ */ new Map(), u = [];
    for (const y of e.state.objects)
      y.parent_id && d.has(y.parent_id) ? (h.has(y.parent_id) || h.set(y.parent_id, []), h.get(y.parent_id).push(y)) : u.push(y);
    const b = [], g = (y, j) => {
      b.push({ object: y, level: j });
      const A = h.get(y.id) || [];
      for (const R of A) g(R, j + 1);
    };
    for (const y of u) g(y, 0);
    const v = b.filter(({ object: y }) => {
      const j = [y.name, y.type, ...y.tags || [], y.asset_kind, y.asset_id].filter(Boolean).join(" ");
      return !(!i(j) || a === "lights" && !l(y.type) || a === "objects" && l(y.type) || a === "hidden" && y.enabled !== !1);
    }), { header: x, isCollapsed: k } = c(a === "lights" ? s("Lights") : s("Objects"), v.length, "objects");
    if (t.appendChild(x), !k)
      for (const { object: y, level: j } of v) {
        const A = document.createElement("div");
        A.role = "button", A.tabIndex = 0, A.dataset.objectId = y.id;
        const R = e.selectedEntity === "object" && (y.id === e.selectedObjectId || e.selectedObjectIds?.has?.(y.id)), N = e.selectedEntity === "object" && y.id === e.selectedObjectId;
        A.setAttribute("aria-selected", String(R)), A.className = `scene-item${R ? " selected" : ""}${N ? " primary" : ""}${j > 0 && !n ? " scene-item-child" : ""}`, j > 0 && !n && (A.style.paddingLeft = `${j * 16 + 6}px`);
        const X = y.type === "card" ? { icon: "pi-image", color: "#38bdf8" } : y.type === "model" || y.type === "glb" ? { icon: "pi-box", color: "#c084fc" } : y.type === "ground" ? { icon: "pi-minus", color: "#fbbf24" } : y.type === "cube" ? { icon: "pi-stop", color: "#fbbf24" } : y.type === "sphere" ? { icon: "pi-circle", color: "#fbbf24" } : y.type === "cylinder" ? { icon: "pi-database", color: "#fbbf24" } : y.type === "torus" ? { icon: "pi-circle", color: "#fbbf24" } : y.type === "pyramid" ? { icon: "pi-play", color: "#fbbf24" } : y.type === "sun_light" ? { icon: "pi-sun", color: "#f59e0b" } : y.type === "point_light" ? { icon: "pi-bolt", color: "#fbbf24" } : y.type === "spot_light" ? { icon: "pi-compass", color: "#38bdf8" } : y.type === "human" ? { icon: "pi-user", color: "#34d399" } : { icon: "pi-plus", color: "#94a3b8" }, W = y.enabled !== !1, G = !!y.load_error, re = document.createElement("i");
        re.className = `pi ${G ? "pi-exclamation-triangle" : X.icon}`, re.style.cssText = G ? "color:#f87171" : W ? `color:${X.color}` : "opacity:.4";
        const _ = document.createElement("span");
        _.className = "scene-item-label";
        const F = document.createElement("span");
        F.style.cssText = G ? "color:#fca5a5" : W ? "" : "opacity:.5;text-decoration:line-through", F.textContent = y.name || y.type, F.title = s("Double-click to rename"), F.addEventListener("dblclick", (C) => {
          C.preventDefault(), C.stopPropagation(), Iu(e, y, F);
        }), _.appendChild(F);
        const U = Array.isArray(y.tags) ? y.tags : [];
        if (U.length) {
          const C = document.createElement("span");
          C.className = "scene-item-tags";
          for (const V of U.slice(0, 2)) {
            const z = document.createElement("span");
            z.className = "scene-item-tag", z.textContent = V, C.appendChild(z);
          }
          if (U.length > 2) {
            const V = document.createElement("span");
            V.className = "scene-item-tag scene-item-tag-more", V.textContent = `+${U.length - 2}`, C.appendChild(V);
          }
          _.appendChild(C);
        }
        if (G) {
        ...
        Y.className = "scene-item-actions", Y.appendChild(r(W ? "pi-eye" : "pi-eye-slash", W ? "Hide object (Alt+Click to Isolate)" : "Show object (Alt+Click to Isolate)", !W, (C) => {
          if (C?.altKey) {
            if (e.checkpoint("Isolate object"), e._isolatedObjectId === y.id) {
              e._isolatedObjectId = null;
              const z = e._isolationSnapshot;
              for (const H of e.state.objects)
                H.enabled = z && Object.prototype.hasOwnProperty.call(z, H.id) ? z[H.id] : !0;
              e._isolationSnapshot = null, e.setStatus?.(s("Isolation cleared"));
            } else {
              e._isolationSnapshot || (e._isolationSnapshot = Object.fromEntries(e.state.objects.map((z) => [z.id, z.enabled !== !1]))), e._isolatedObjectId = y.id;
              for (const z of e.state.objects) z.enabled = z.id === y.id;
              e.setStatus?.(s("Isolated: {name}").replace("{name}", y.name || y.type));
            }
            e.serialize(), e.refreshObjects(), e.requestRender?.();
          } else
            e.toggleObject(y.id);
        }, "color:#ef4444;opacity:.7")), Y.appendChild(r(y.locked ? "pi-lock" : "pi-lock-open", "Lock object", y.locked, () => Or(e, y))), Y.appendChild(r("pi-copy", "Duplicate object", !1, () => e.duplicateObject?.(y.id))), y.id !== "subject" && Y.appendChild(r("pi-trash", "Delete object", !1, () => e.deleteObject?.(y.id))), Y.appendChild(r("pi-ellipsis-v", "Object actions", !1, (C) => e.openObjectContext(C, y.id))), A.append(re, _, Y), A.title = s("Click to select · Double-click to toggle visibility · Right-click for actions");
        const L = (C = {}) => {
          if (C.altKey && y.id !== "subject") return void e.deleteObject(y.id);
          if (e.finishCameraEdit(), e.selectedEntity = "object", e.selectedObjectIds ||= /* @__PURE__ */ new Set(), C.ctrlKey || C.metaKey)
            e.selectedObjectIds.has(y.id) ? e.selectedObjectIds.delete(y.id) : e.selectedObjectIds.add(y.id), e.outlinerAnchorId = y.id;
          else if (C.shiftKey && e.outlinerAnchorId && e.state.objects.some((z) => z.id === e.outlinerAnchorId)) {
            const z = e.state.objects.map((ce) => ce.id), H = z.indexOf(e.outlinerAnchorId), Z = z.indexOf(y.id);
            e.selectedObjectIds = new Set(z.slice(Math.min(H, Z), Math.max(H, Z) + 1));
          } else
            e.selectedObjectIds = /* @__PURE__ */ new Set([y.id]), e.outlinerAnchorId = y.id;
          e.selectedObjectId = e.selectedObjectIds.has(y.id) ? y.id : [...e.selectedObjectIds].at(-1) || null, e.selectedEntity = e.selectedObjectIds.size ? "object" : "camera", e.selectedKeyFrame = e.selectedObjectId ? y.keyframes?.find((z) => z.frame === e.frame)?.frame ?? null : null, e.editingKeyFrame = null;
          for (const z of t.querySelectorAll(".scene-item")) {
            const H = !!(z.dataset.objectId && e.selectedObjectIds.has(z.dataset.objectId)), Z = !!(z.dataset.objectId && z.dataset.objectId === e.selectedObjectId);
            z.classList.toggle("selected", H), z.classList.toggle("primary", Z), z.dataset.objectId && z.setAttribute("aria-selected", String(H));
          }
          const V = e.root.querySelector('[data-role="outliner-batch-bar"]');
          if (V) {
            const z = e.selectedObjectIds?.size || 0;
            V.hidden = z < 2;
            const H = V.querySelector('[data-role="batch-count"]');
            H && (H.textContent = `${z} ${s("selected")}`);
          }
          e.refreshKeys(), e.refreshInspector(), e.render(), e.setStatus(s(`Selected: ${y.name || y.type}`));
        };
        A.addEventListener("dblclick", () => e.toggleObject(y.id)), A.addEventListener("contextmenu", (C) => {
          C.preventDefault(), C.stopPropagation(), e.openObjectContext(C, y.id);
...
function Ou(e, t) {
  ...
  let u = [0, 0, 0], b = [0, 0, 0], g = "#8c929b", v, x, k, y;
  p ? (u = [5, 8.5, 4], b = [-55, 35, 0], g = "#fff6ec", v = 2.2, x = !0) : m ? (u = [0, 3, 0], g = "#ffffff", v = 2, x = !1) : f && (u = [0, 4, 0], b = [-60, 0, 0], g = "#ffffff", v = 3, k = 45, y = 0.25, x = !0);
  const j = {
    id: a,
    type: t,
    name: d,
...
function Fu(e) {
  ...
  if (n) {
    const _ = r.target_object_id || e.state.target_object_id || "", F = `T${Gr()}${e.state.objects.map((U) => `${U.id}\0${U.name || U.type}`).join("|")}`;
    Zo(n, F, () => [
      Dt("", s("Manual Target (No Tracking)")),
      ...e.state.objects.map((U) => Dt(U.id, `${s("Track:")} ${U.name || U.type}`))
    ], _);
  }
  Mu(e);
  const i = [...e.camera.position, ...e.camera.target, e.camera.fov, e.camera.roll || 0, e.camera.near, e.camera.far, ...Cr(e.camera)];
  ["camera-px", "camera-py", "camera-pz", "camera-tx", "camera-ty", "camera-tz", "camera-fov", "camera-roll", "camera-near", "camera-far", "camera-rx", "camera-ry", "camera-rz"].forEach((_, F) => {
    for (const U of e.root.querySelectorAll(`[data-role="${_}"]`))
      document.activeElement !== U && (U.value = String(Math.round(i[F] * 1e4) / 1e4));
  });
  ...
  if (!t) {
    ...
    F && (F.textContent = `${r.name} · F${e.frame}`), Pn(o, {
  ...
  if (c) {
    ...
    if (_) {
      c.hidden = !1;
      const F = _.semantic ? `${_.semantic} · ` : "";
      c.textContent = `${F}${_.label} (${Math.round(_.confidence * 100)}%)`, c.title = _.title, c.className = `oc-recon-badge oc-badge-${_.band}`;
    } else
      c.hidden = !0;
  }
  ...
  for (const [_, F] of Object.entries(h))
    for (const U of e.root.querySelectorAll(`[data-role="${_}"]`))
      document.activeElement !== U && (U.value = String(Math.round(F * 1e4) / 1e4));
  ...
  const u = o('[data-role="animation-row"]'), b = o('[data-role="animation-select"]'), g = o('[data-role="object-parent"]');
  if (g) {
    const _ = t.id, F = /* @__PURE__ */ new Set([_]);
    let U = !0;
    for (; U; ) {
      U = !1;
      for (const C of e.state.objects)
        !F.has(C.id) && C.parent_id && F.has(C.parent_id) && (F.add(C.id), U = !0);
    }
    const Y = e.state.objects.filter((C) => !F.has(C.id)), L = `P${Gr()}${_}${Y.map((C) => `${C.id} ${C.name || C.type}`).join("|")}`;
    Zo(g, L, () => [
      Dt("", s("No parent")),
      ...Y.map((C) => Dt(C.id, C.name || C.type))
    ], t.parent_id || "");
  }
  const v = ["sun_light", "point_light", "spot_light"].includes(t.type), x = t.type === "spot_light", k = o('[data-role="light-props-row"]');
  k && (k.hidden = !v);
  const y = o('[data-role="spot-props-row"]');
  y && (y.hidden = !x);
  ...
  if (R && (R.hidden = t.type === "point_light"), v) {
    ...
    if (F && (F.checked = t.cast_shadow !== !1), x) {
      const U = o('[data-role="object-cone-angle"]');
      U && document.activeElement !== U && (U.value = String(t.cone_angle ?? 45));
      const Y = o('[data-role="object-penumbra"]');
      Y && document.activeElement !== Y && (Y.value = String(t.penumbra ?? 0.25));
    }
  }
  const N = e.modelInfoById.get(t.id);
  if (u && (u.hidden = !N?.animations), b) {
    const _ = N?.animationNames || [];
    Zo(b, `A${_.join("|")}`, () => _.map((F, U) => Dt(String(U), F)), String(t.animation_index || 0));
  }
  ...
  const G = o('[data-role="object-annotation-color"]');
  G && document.activeElement !== G && (G.value = t.annotation?.color || "#8d7ee8");
...
function Bu(e) {
  ...
  e.beginCameraEdit(), Cc(e.camera, r), e.commitCameraEdit(), e.finishCameraEdit(), Xs(e), Ku(e), e.render();
}
function qu(e) {
  const t = globalThis.performance?.now?.() ?? Date.now();
  (!Number.isFinite(e.lastCameraHudEditAt) || t - e.lastCameraHudEditAt > 300) && e.checkpoint("Edit camera"), e.lastCameraHudEditAt = t;
  ...
  e.camera.position = [a("camera-px", e.camera.position[0]), a("camera-py", e.camera.position[1]), a("camera-pz", e.camera.position[2])], e.camera.target = [a("camera-tx", e.camera.target[0]), a("camera-ty", e.camera.target[1]), a("camera-tz", e.camera.target[2])], e.camera.fov = J(a("camera-fov", e.camera.fov), 5, 150), e.camera.roll = J(a("camera-roll", e.camera.roll || 0), -180, 180), e.camera.near = Math.max(1e-4, a("camera-near", e.camera.near)), e.camera.far = Math.max(e.camera.near + 1e-4, a("camera-far", e.camera.far)), e.beginCameraEdit(), e.commitCameraEdit(), e.finishCameraEdit(), Xs(e), e.render();
}
function Uu(e, t) {
  const a = Zt(e);
  if (!a) return;
...
function Hu(e) {
  ...
  if (!t.length) return [];
  if (t.length === 1)
    return Hs(e, t[0]), e.selectedObjectId ? [e.selectedObjectId] : [];
...
function eb(e) {
  ...
  const t = e.root.querySelector('[data-role="key-interp"]')?.value || e.root.querySelector('[data-role="interp"]')?.value || "ease", a = ze(e), o = Ce(e), r = a ? { frame: e.frame, transform: Ve(a), interpolation: t } : { frame: e.frame, camera: pe(e.camera), interpolation: t }, n = o.findIndex((i) => i.frame === e.frame);
...
function rb(e) {
  ...
  const o = t ? { frame: e.frame, transform: Ve(e.copiedKeyframe.transform), interpolation: e.copiedKeyframe.interpolation } : { frame: e.frame, camera: pe(e.copiedKeyframe.camera), interpolation: e.copiedKeyframe.interpolation }, r = Ce(e), n = r.findIndex((i) => i.frame === e.frame);
...
const mb = ["guides", "safe-areas", "resolution-gate", "aspect-ratio"];
function pb(e) {
...
function ub(e) {
  ...
  if (m) {
    const d = Math.max(1, e.state?.fps || 24), h = a ? a.frame : e.frame, u = Math.floor(h / d), b = h % Math.round(d), g = String(Math.floor(u / 3600)).padStart(2, "0"), v = String(Math.floor(u % 3600 / 60)).padStart(2, "0"), x = String(u % 60).padStart(2, "0"), k = String(b).padStart(2, "0");
    m.textContent = `${g}:${v}:${x}:${k} (${h}f)`;
  }
  if (!a) return;
  if (t) {
...
const Kr = ["pos_x", "pos_y", "pos_z"], fr = 1e-9, Fo = ["auto", "aligned", "free", "corner"];
function Ie(e, t = 0) {
  const a = Number(e);
...
function Ut(e) {
  ...
  return Fo.includes(t) ? t : "auto";
}
function xb(e, t = null, a = null) {
  const o = Ut(e), r = Ue(e);
  if (o === "corner") {
    const l = Zs(e, t, a);
...
function Qs(e, t, a) {
  const o = Ue(e), r = xb(e, t, a);
  kt(e, "out", Ht(r.out, o)), kt(e, "in", Ht(r.in, o));
}
function kb(e, t, a, { prevKey: o = null, nextKey: r = null } = {}) {
  if (!e || t !== "in" && t !== "out") return e;
  let n = Ut(e);
  if (n === "corner") return e;
  n === "auto" && (n = "aligned", e.tangents = e.tangents && typeof e.tangents == "object" ? e.tangents : {}, e.tangents.spatial_mode = "aligned", Qs(e, o, r));
  const i = Ue(e), c = Ht([
    Ie(a?.[0]),
    Ie(a?.[1]),
    Ie(a?.[2])
...
function Sb(e, t, { prevKey: a = null, nextKey: o = null } = {}) {
  if (!e || !Fo.includes(t)) return e;
...
function Cb(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: u, syncActiveCameraTrack: b, syncFromWidgets: g, bindEditorEvents: v, activateCamera: x, addCamera: k, deleteCamera: y, drawPreviewOverlays: j, duplicateCamera: A, maximizeCameraPreview: R, refreshCameraPreviews: N, refreshCameraSelectors: X, renameCamera: W, setPlayblastCamera: G, toggleCameraView: re, captureRealtime: _, makePlayblast: F, uploadDirectorPlayblast: U, waitForMediaFrame: Y, computeAudioPeaks: L, loadAudioFile: C, releaseAudio: V, stopPlay: z, togglePlay: H, applyCameraPreset: Z, applyCameraShake: ce, applyProxyPreset: se, clearViewportBgImage: ae, loadViewportBgFile: le, loadViewportBgSequence: be, drawCameraPath: fe, drawCard: ge, drawCube: ye, drawGrid: me, drawHuman: Te, drawLine3D: ve, drawNull: xe, drawOverlays: ue, drawPointField: O, drawSpeedHeatmap: B, drawSphere: de, curveChannels: Se, drawCurveEditor: Oe, onCurvePointerDown: Fe, onCurvePointerMove: Pe, onCurvePointerUp: ot, onTimelinePointerDown: Qt, onTimelinePointerMove: ea, onTimelinePointerUp: ta, refreshKeys: jt, resetCurveZoom: _t, resetTimelineZoom: dt, setChannelFilter: Ct, setCurveInterpolation: Et, setTangentMode: At, timelineFrameFromEvent: aa, toggleCurveHandles: Tt, zoomCurve: oa, drawTransformGizmo: ra, frameTarget: na, gizmoAxes: sa, gizmoGeometry: ia, onPointerDown: ca, onPointerMove: la, onPointerUp: da, onWheel: ma, pickGizmo: pa, pickSceneObject: fa, resetCamera: $t, setTransformMode: Mt, setViewMode: ha, viewportCamera: ua, loadCardFile: Ro, loadExecutionPreview: Do, loadMediaUrl: ba, loadModelFile: ga, loadSelectedReference: ya, onModelLoaded: va, restoreAssets: xa, syncUpstreamInputs: wa, configureDomMedia: ka, refreshSetupDiagnostic: It, addMediaCard: Sa, addPrimitive: ja, applyObjectAnimationFrame: _a, beginCameraEdit: Ca, beginObjectEdit: Ea, commitCameraEdit: Aa, commitObjectEdit: Ta, copyKeyframe: $a, deleteKeyframe: Ma, deleteObject: Ia, duplicateObject: Oa, exitKeyEdit: Pa, finishCameraEdit: La, goToAdjacentKey: za, insertKeyframe: Na, loadSelectedKeyView: Fa, pasteKeyframe: Ra, playblastCameraAtFrame: Da, refreshInspector: Ka, refreshKeyEditor: Ba, refreshObjects: qa, removeObjectResources: Ua, renameObject: Wa, retimeSelectedKey: Va, selectKeyframe: Ha, selectedKeyframe: Ga, selectedObject: Ya, selectObjectAnimation: Xa, setKeyInterpolation: Ja, setObjectParent: Za, timelineKeyframes: Qa, timelineObject: rt, toggleAutoKey: eo, toggleObject: to, updateCameraFromHud: ao, updateEditState: oo, updateKeyVisualState: ro, updateSelectedKey: no, updateSelectedObject: so, clamp: Ot, cloneCamera: io, configureCore: co, defaultCamera: lo, sampleCamera: Pt, sampleObjectTransform: Ko, sanitizeState: mt, worldTransform: Ge } = e;
  return {
    setSelectMode(P) {
    ...
    hideInternalWidgets() {
      for (const P of ["state_json", "recording_path", "card_asset"]) {
        const $ = this.node.widgets?.find((S) => S.name === P);
    ...
    restoreHistorySnapshot(P) {
      ...
      const M = new Set(this.state.objects.map((ne) => ne.id)), D = Array.isArray($.selectedObjectIds) ? $.selectedObjectIds : [$.selectedObjectId].filter(Boolean);
      this.selectedObjectIds = new Set(D.filter((ne) => M.has(ne))), this.selectedObjectId = this.selectedObjectIds.has($.selectedObjectId) ? $.selectedObjectId : [...this.selectedObjectIds].at(-1) || null, this.selectedEntity = this.selectedObjectIds.size ? "object" : $.selectedEntity || "camera";
      ...
      this.selectedKeyFrames = new Set(q.filter((ne) => Q.has(ne))), this.selectedKeyFrame = this.selectedKeyFrames.has($.selectedKeyFrame) ? $.selectedKeyFrame : [...this.selectedKeyFrames].at(-1) ?? null, this.subSelection = $.subSelection || null, this.camera = Pt(this.state, this.frame), qt(this, this.activeCameraTrack(), this.camera, this.frame), this.cameraPreviewSignature = "", this.serialize(), S !== zn(this.state) && this.restoreAssets(), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
    },
    checkpoint(P) {
    ...
    closeMenus(P = null) {
      for (const $ of this.root.querySelectorAll(".toolbar-menu")) $ !== P && ($.open = !1);
    ...
    showContextMenu(P, $, S) {
      return this.contextMenu.show(P, $, S);
    },
    onContextMenu(P) {
      ...
      const $ = P.target, S = $.closest?.(".camera-preview-tile"), w = $.closest?.(".scene-item"), T = $.closest?.(".key");
      if (S) return this.openCameraContext(P, S.dataset.cameraId, !0);
      ...
      if (T) {
        const M = this.timelineKeyframes().find((D) => D.frame === Number(T.dataset.keyFrame));
        return M && this.selectKeyframe(M), this.openTimelineContext(P, !0);
      }
      if ($.closest?.('[data-role="keys"]'))
        return this.setFrame(this.timelineFrameFromEvent(P, $.closest('[data-role="keys"]'))), this.openTimelineContext(P, !1);
      if ($.closest?.(".curve-editor")) return this.openCurveContext(P);
      if ($.closest?.(".viewport-wrap")) {
        const M = this.interactionElement.getBoundingClientRect(), D = (P.clientX - M.left) * this.canvas.width / Math.max(1, M.width), Q = (P.clientY - M.top) * this.canvas.height / Math.max(1, M.height), q = this.pickSceneObject([D, Q]);
        if (q) {
    ...
    openObjectContext(P, $) {
      const S = this.state.objects.find((M) => M.id === $);
      if (!S) return;
      ...
      if (T >= 2 && this.selectedObjectIds.has($)) {
        this.showContextMenu(P, `${T} ${s("objects selected")}`, [
      ...
      this.showContextMenu(P, S.name || S.type, [
    ...
    openCameraContext(P, $, S = !1) {
      const w = this.state.cameras.find((T) => T.id === $);
      w && (this.selectedEntity = "camera", this.selectedObjectId = null, this.activateCamera($), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), this.showContextMenu(P, `${w.name}${S ? " preview" : ""}`, [
    ...
    openPathKeyContext(P, $, S) {
      ...
      const M = T ? Ut(T) : "auto", D = this.selectedKeyFrames?.size || 0;
      this.showContextMenu(P, `Path key F${S}`, [
    ...
    moveShot(P, $) {
      const S = this.state.cameras.findIndex((M) => M.id === P), w = S + $;
    ...
    async editShotHandles(P) {
      const $ = this.state.cameras.find((M) => M.id === P);
      if (!$) return;
    ...
    openTimelineContext(P, $) {
      const S = this.selectedKeyFrames?.size || 0, w = this.selectedKeyframe(), T = w?.interpolation || "ease", M = w && Ut(w) || "auto", D = ["ease", "linear", "bezier", "smooth", "ease_in", "ease_out", "sine", "cubic", "quintic", "expo", "back"], Q = ["auto", "clamped", "vector", "free", "aligned", "flat"];
      this.showContextMenu(P, $ ? `Keyframe F${this.selectedKeyFrame}` : `Timeline F${this.frame}`, [
    ...
    removeNearestMarker() {
      ...
      if (!P.length) return;
      const $ = P.reduce((S, w) => Math.abs(w.frame - this.frame) < Math.abs(S.frame - this.frame) ? w : S);
      this.checkpoint("Remove marker"), this.state.markers = P.filter((S) => S !== $), this.serialize(), this.refreshKeys(), this.setStatus(`Marker removed @ F${$.frame}`);
    },
    openCurveContext(P) {
      const $ = this.selectedKeyFrames?.size || 0, S = $ < 2 && !this.selectedKeyframe(), w = this.selectedKeyframe(), T = w?.interpolation || "ease", M = w && Ut(w) || "auto", D = ["bezier", "smooth", "linear", "ease_in", "ease_out", "ease", "sine", "cubic", "quintic", "expo", "back"], Q = ["auto", "clamped", "vector", "free", "aligned", "flat"];
    ...
    refitNode() {
      ...
      try {
        if (P && typeof P.computeSize == "function" && typeof P.setSize == "function") {
          const $ = P.computeSize();
          Array.isArray($) && P.setSize([P.size?.[0] ?? $[0], $[1]]);
        }
    ...
    resizeCanvas() {
      ...
      if (!P) return;
      const $ = Math.min(2, window.devicePixelRatio || 1), S = P.clientWidth || 320, w = P.clientHeight || 180, T = Math.max(320, Math.round(S * $)), M = Math.max(180, Math.round(w * $));
      (this.canvas.width !== T || this.canvas.height !== M) && (this.canvas.width = T, this.canvas.height = M);
      for (const D of this.cameraPreviewCanvases.values()) {
        const Q = D.clientWidth || 220, q = D.clientHeight || 124, ne = Math.max($, _b / Math.max(1, Q)), Ee = Math.max(1, Math.round(Q * ne)), Re = Math.max(1, Math.round(q * ne));
...
function Eb(e, t) {
  ...
  const o = xr();
  o.position = [0, 0, 0], o.target = [0, 0, -1], a.camera = pe(o), a.keyframes = [{ frame: 0, camera: pe(o), interpolation: "ease" }], e.state.active_camera_id = a.id, e.state.camera = pe(o), e.state.keyframes = a.keyframes, e.camera = pe(o), e.frame = 0, e.selectedEntity = "camera", e.selectedObjectId = null, e.selectedKeyFrame = 0, e.editingKeyFrame = null, e.cameraEditKey = null, e.cameraEditActive = !1, e.cameraPreviewSignature = "", ei(e), e.refreshCameraSelectors(), e.setStatus(s(`${a.name} animation reset`));
}
function Ab(e, t) {
  const a = e.state.objects.find((o) => o.id === t);
  a && (e.checkpoint("Reset object animation"), a.keyframes = [], a.position = [0, 0, 0], a.rotation = [0, 0, 0], e.frame = 0, e.selectedEntity = "object", e.selectedObjectId = a.id, e.selectedKeyFrame = null, e.editingKeyFrame = null, ei(e), e.setStatus(s(`${a.name || a.type} animation reset`)));
}
const Nn = { motion: "motion", shot: "display", health: "health" }, Tb = {
  object: "Object",
  camera: "Camera",
  camera_target: "Look-At Target",
  camera_path: "Camera Path"
}, $b = { motion: "Motion", shot: "Shot", health: "Health" }, Mb = ["entity", "motion", "shot", "health"];
function ti(e) {
  return e.inspectorMode && e.inspectorMode !== "entity" ? e.inspectorMode : "entity";
}
function Ib(e) {
  const t = ti(e);
  return Nn[t] ? Nn[t] : e.selectedEntity === "object" ? "scene" : "camera";
}
function Ob(e) {
  return [
    e.selectedEntity || "",
...
function Pb(e) {
  const t = Ob(e);
  e._lastInspectorSelKey !== void 0 && e._lastInspectorSelKey !== t && (e.inspectorMode = "entity"), e._lastInspectorSelKey = t, ai(e);
}
function ai(e) {
  const t = Ib(e);
...
function zb(e) {
  ...
  return {
    ...
    setSpatialHandleMode(w) {
      if (!Fo.includes(w)) return;
      const M = this.activeCameraTrack()?.keyframes || [], D = M.findIndex((Q) => Q.frame === this.selectedKeyFrame);
      if (D < 0) {
        this.setStatus(s("Select a camera keyframe first"));
        return;
      }
      this.checkpoint(s("Camera path handle: {mode}").replace("{mode}", w)), Sb(M[D], w, {
        prevKey: M[D - 1] || null,
        nextKey: M[D + 1] || null
    ...
    transformCameraPath(w) {
      ...
      const M = Ec(T.keyframes, { origin: Ac(T.keyframes), ...w });
      return T.keyframes = M, T.id === this.state.active_camera_id && (this.state.keyframes = M), this.camera = Ge(T, this.frame, this.state.objects), T.camera = Pt(this.camera), this.serialize(), this.refreshKeys(), this.refreshInspector(), this.render(), this.renderCameraView?.(), !0;
    },
    toggleCurveHandles() {
      Tt(this);
    },
    ...
    toggleInspector(w) {
      ...
      if (!T) return;
      const M = w !== void 0 ? w : T.dataset.collapsed !== "true";
      T.dataset.collapsed = String(M);
      for (const D of this.root.querySelectorAll('[data-act="toggle-inspector"]'))
        D.classList.toggle("active", !M), D.setAttribute("aria-pressed", String(!M));
    ...
    selectHierarchy(w = this.selectedObjectId) {
      ...
      for (; M; ) {
        ...
        for (const D of this.state.objects)
          D.parent_id && T.has(D.parent_id) && !T.has(D.id) && (T.add(D.id), M = !0);
      }
    ...
    lookAtObject(w) {
      const T = this.state.objects.find((M) => M.id === w);
      if (T) {
        this.checkpoint("Look-at constraint");
        for (const M of this.state.cameras)
          for (const D of M.keyframes) D.camera.target = [...T.position || [0, 1.5, 0]];
    ...
    refreshInspector() {
      this.perf && (this.perf.inspectorRefreshCount = (this.perf.inspectorRefreshCount || 0) + 1), Ba(this), Pb(this);
    },
    setInspectorMode(w) {
      Lb(this, w);
    },
    ...
    applyProxyPreset(w) {
      const T = { balanced: { mode: "omni_ref", burn: !1 }, parallax: { mode: "point_field", burn: !1 }, subject: { mode: "card_grid", burn: !1 }, debug: { mode: "omni_ref", burn: !0 } }, M = T[w] || T.balanced;
    ...
    aimAtSelectedObject(w) {
      ...
      const T = this.activeCameraTrack(), M = w && this.state.objects.find((q) => q.id === w) || this.selectedObject() || this.state.objects.find((q) => q.id === "subject") || this.state.objects[0];
      if (!M) return;
      T.target_object_id !== M.id && (T.aim_bone = null), T.target_object_id = M.id, T.id === this.state.active_camera_id && (this.state.target_object_id = M.id, this.state.aim_bone = T.aim_bone);
      const Q = (M.type === "model" || M.type === "glb" ? this.webgl?.getObjectWorldCenter?.(M.id) : null) || (M.keyframes?.length ? P(M, this.frame).position : M.position || [0, 1.5, 0]);
    ...
    bakeAimToKeyframes() {
      ...
      const w = this.activeCameraTrack(), T = w.target_object_id || this.state.target_object_id || "subject", M = this.state.objects.find((Q) => Q.id === T) || this.state.objects[0];
      if (!M || !w.keyframes?.length) return;
      const D = M.type === "model" || M.type === "glb" ? this.webgl?.getObjectWorldCenter?.(M.id) : null;
      for (const Q of w.keyframes) {
        const q = (M.type === "model" || M.type === "glb") && D && !M.keyframes?.length ? D : M.keyframes?.length ? P(M, Q.frame).position : M.position || [0, 1.5, 0];
        Q.camera.target = [...q];
      }
...
function Nb(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: u, syncActiveCameraTrack: b, syncFromWidgets: g, bindEditorEvents: v, activateCamera: x, addCamera: k, deleteCamera: y, drawPreviewOverlays: j, duplicateCamera: A, maximizeCameraPreview: R, refreshCameraPreviews: N, refreshCameraSelectors: X, renameCamera: W, setPlayblastCamera: G, toggleCameraView: re, captureRealtime: _, makePlayblast: F, uploadDirectorPlayblast: U, waitForMediaFrame: Y, computeAudioPeaks: L, loadAudioFile: C, releaseAudio: V, stopPlay: z, togglePlay: H, applyCameraPreset: Z, applyCameraShake: ce, applyProxyPreset: se, clearViewportBgImage: ae, loadViewportBgFile: le, loadViewportBgSequence: be, drawCameraPath: fe, drawCard: ge, drawCube: ye, drawGrid: me, drawHuman: Te, drawLine3D: ve, drawNull: xe, drawOverlays: ue, drawPointField: O, drawSpeedHeatmap: B, drawSphere: de, curveChannels: Se, drawCurveEditor: Oe, fitCurveView: Fe, onCurveDoubleClick: Pe, onCurvePointerDown: ot, onCurvePointerMove: Qt, onCurvePointerUp: ea, onTimelinePointerDown: ta, onTimelinePointerMove: jt, onTimelinePointerUp: _t, refreshKeys: dt, resetCurveZoom: Ct, resetTimelineZoom: Et, setChannelFilter: At, setCurveInterpolation: aa, setTangentMode: Tt, timelineFrameFromEvent: oa, toggleCurveHandles: ra, zoomCurve: na, drawTransformGizmo: sa, frameTarget: ia, gizmoAxes: ca, gizmoGeometry: la, onPointerDown: da, onPointerMove: ma, onPointerUp: pa, onWheel: fa, pickGizmo: $t, pickSceneObject: Mt, resetCamera: ha, setTransformMode: ua, setViewMode: Ro, viewportCamera: Do, loadCardFile: ba, loadExecutionPreview: ga, loadMediaUrl: ya, loadModelFile: va, loadSelectedReference: xa, onModelLoaded: wa, restoreAssets: ka, syncUpstreamInputs: It, configureDomMedia: Sa, refreshSetupDiagnostic: ja, addMediaCard: _a, addPrimitive: Ca, applyObjectAnimationFrame: Ea, beginCameraEdit: Aa, beginObjectEdit: Ta, commitCameraEdit: $a, commitObjectEdit: Ma, copyKeyframe: Ia, deleteKeyframe: Oa, deleteObject: Pa, duplicateObject: La, exitKeyEdit: za, finishCameraEdit: Na, goToAdjacentKey: Fa, insertKeyframe: Ra, loadSelectedKeyView: Da, pasteKeyframe: Ka, playblastCameraAtFrame: Ba, refreshInspector: qa, refreshKeyEditor: Ua, refreshObjects: Wa, removeObjectResources: Va, renameObject: Ha, retimeSelectedKey: Ga, selectKeyframe: Ya, selectedKeyframe: Xa, selectedObject: Ja, selectObjectAnimation: Za, setKeyInterpolation: Qa, setObjectParent: rt, timelineKeyframes: eo, timelineObject: to, toggleAutoKey: ao, toggleObject: oo, updateCameraFromHud: ro, updateEditState: no, updateKeyVisualState: so, updateSelectedKey: Ot, updateSelectedObject: io, clamp: co, cloneCamera: lo, configureCore: Pt, defaultCamera: Ko, sampleCamera: mt, sampleObjectTransform: Ge, sanitizeState: P, worldTransform: $ } = e;
  return {
    setTargetAtCursor(S) {
      if (!S) return;
      const w = this.interactionElement.getBoundingClientRect(), T = (S.clientX - w.left) * this.canvas.width / Math.max(1, w.width), M = (S.clientY - w.top) * this.canvas.height / Math.max(1, w.height), D = this.webgl?.intersectScenePoint?.(T, M, this.canvas.width, this.canvas.height);
    ...
    clearCaches() {
      if (this.checkpoint("Clear caches"), this.objectUrls?.clear(), V(this), this.webgl) {
    ...
    async loadMediaUrl(S, w, T, M) {
      return ya(this, S, w, T, M);
    },
    restoreAssets() {
      ka(this);
    },
...
function Rb(e) {
  const { right: t, up: a, forward: o } = Tc(e || {});
  return Fb.map((r) => {
...
const Bb = "http://www.w3.org/2000/svg", gt = 26, Fn = 17, qb = 5.4;
function yt(e, t) {
  const a = document.createElementNS(Bb, e);
...
function Ub(e) {
  ...
  for (const n of Db(Rb(a))) {
    const i = gt + n.x * Fn, c = gt + n.y * Fn, l = Kb(n.depth);
...
function Vb(e) {
  ...
  for (const r of e.state.motion_layers || []) {
    ...
    const n = Wb(e.state, r, e.frame, a, o);
    if (n.length) {
...
const Hb = ["world_point", "object_point", "camera_field"], oi = {
  manual_2d: "DRAW",
  object_point: "OBJECT",
  world_point: "WORLD",
...
function Zb(e) {
  ...
  n("motion-sel-name", a.label), n("motion-sel-type", oi[a.source_kind] || "TRACK"), n("motion-sel-binding", Gb(e.state, a)), n("motion-sel-start", r.length ? Math.min(...r) : 0), n("motion-sel-end", r.length ? Math.max(...r) : 0);
...
function tg(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: u, syncActiveCameraTrack: b, syncFromWidgets: g, bindEditorEvents: v, activateCamera: x, addCamera: k, deleteCamera: y, drawPreviewOverlays: j, duplicateCamera: A, maximizeCameraPreview: R, refreshCameraPreviews: N, refreshCameraSelectors: X, renameCamera: W, setPlayblastCamera: G, toggleCameraView: re, captureRealtime: _, makePlayblast: F, uploadDirectorPlayblast: U, waitForMediaFrame: Y, computeAudioPeaks: L, loadAudioFile: C, releaseAudio: V, stopPlay: z, togglePlay: H, applyCameraPreset: Z, applyCameraShake: ce, applyProxyPreset: se, clearViewportBgImage: ae, loadViewportBgFile: le, loadViewportBgSequence: be, drawCameraPath: fe, drawCard: ge, drawCube: ye, drawCylinder: me, drawGrid: Te, drawHuman: ve, drawLine3D: xe, drawNull: ue, drawOverlays: O, drawPointField: B, drawSpeedHeatmap: de, drawSphere: Se, drawTorus: Oe, curveChannels: Fe, drawCurveEditor: Pe, onCurvePointerDown: ot, onCurvePointerMove: Qt, onCurvePointerUp: ea, onTimelinePointerDown: ta, onTimelinePointerMove: jt, onTimelinePointerUp: _t, refreshKeys: dt, resetCurveZoom: Ct, resetTimelineZoom: Et, setChannelFilter: At, setCurveInterpolation: aa, setTangentMode: Tt, timelineFrameFromEvent: oa, toggleCurveHandles: ra, zoomCurve: na, drawTransformGizmo: sa, frameTarget: ia, gizmoAxes: ca, gizmoGeometry: la, onPointerDown: da, onPointerMove: ma, onPointerUp: pa, onWheel: fa, pickGizmo: $t, pickSceneObject: Mt, resetCamera: ha, setTransformMode: ua, setViewMode: Ro, viewportCamera: Do, loadCardFile: ba, loadExecutionPreview: ga, loadMediaUrl: ya, loadModelFile: va, loadSelectedReference: xa, onModelLoaded: wa, restoreAssets: ka, syncUpstreamInputs: It, configureDomMedia: Sa, refreshSetupDiagnostic: ja, addMediaCard: _a, addPrimitive: Ca, applyObjectAnimationFrame: Ea, beginCameraEdit: Aa, beginObjectEdit: Ta, commitCameraEdit: $a, commitObjectEdit: Ma, copyKeyframe: Ia, deleteKeyframe: Oa, deleteObject: Pa, duplicateObject: La, exitKeyEdit: za, finishCameraEdit: Na, goToAdjacentKey: Fa, insertKeyframe: Ra, loadSelectedKeyView: Da, pasteKeyframe: Ka, playblastCameraAtFrame: Ba, refreshInspector: qa, refreshKeyEditor: Ua, refreshObjects: Wa, removeObjectResources: Va, renameObject: Ha, retimeSelectedKey: Ga, selectKeyframe: Ya, selectedKeyframe: Xa, selectedObject: Ja, selectObjectAnimation: Za, setKeyInterpolation: Qa, setObjectParent: rt, timelineKeyframes: eo, timelineObject: to, toggleAutoKey: ao, toggleObject: oo, updateCameraFromHud: ro, updateEditState: no, updateKeyVisualState: so, updateSelectedKey: Ot, updateSelectedObject: io, clamp: co, cloneCamera: lo, configureCore: Pt, defaultCamera: Ko, sampleCamera: mt, sampleObjectTransform: Ge, sanitizeState: P, worldTransform: $ } = e;
  return {
    ...
    renderViewportOnly() {
      ...
      if (this.webgl) {
        try {
          ...
          this.webgl.render(nt, D, this.cardMediaById, mo, Bo, this.modelUrlsById, this.frame, this.recording, this.selectedEntity, this.selectedObjectId, this.subSelection, this.selectedKeyFrame ?? null), S.imageSmoothingEnabled = !0, S.imageSmoothingQuality = "high", mo !== w || Bo !== T ? S.drawImage(this.webgl.canvas, 0, 0, mo, Bo, 0, 0, w, T) : S.drawImage(this.webgl.canvas, 0, 0, w, T), ee = !0;
        } catch (oe) {
      ...
      !this.recording && this.state.speed_heatmap && this.drawSpeedHeatmap(), !this.recording && uh(this), this.drawOverlays(), Vb(this), this.state.show_gizmo && Ub(this), this.labelOverlay?.update(), this.rigOverlay?.update(), this.perf && (this.perf.viewportRenderCount = (this.perf.viewportRenderCount || 0) + 1);
    },
    ...
    requestRender(S = "unknown") {
      return this.requestUiUpdate(E.viewport | E.previews | E.motion, S);
    },
    ...
    requestUiUpdate(S = E.viewport, w = "unknown") {
      (this.renderReasons ||= /* @__PURE__ */ new Set()).add(w), this.uiDirtyMask = Km(this.uiDirtyMask, S), this.renderInvalidations = (this.renderInvalidations || 0) + 1, !this.renderScheduled && (this.renderScheduled = !0, this.renderFrame = requestAnimationFrame(() => {
        if (this.renderScheduled = !1, this.disposed) return;
        const T = this.uiDirtyMask || E.viewport;
        this.uiDirtyMask = 0, this.lastRenderReasons = [...this.renderReasons || []], this.renderReasons?.clear(), this.rendersCoalesced = (this.rendersCoalesced || 0) + 1, this.perf && (this.perf.renderCount = (this.perf.renderCount || 0) + 1), ht(T, E.outliner) && this.refreshObjects(), ht(T, E.timeline) && this.refreshKeys(), ht(T, E.inspector) && this.refreshInspector(), ht(T, E.viewport) && this.renderViewportOnly(), ht(T, E.previews) && this.renderCameraView(), ht(T, E.motion) && this.renderMotionUiOnly();
      }));
    },
    renderCameraView() {
      if (this.perf && (this.perf.previewRenderCount = (this.perf.previewRenderCount || 0) + 1), this.state.camera_view_visible) {
        ...
        for (const D of w) {
          ...
          if (Re && (Re.textContent = `F${this.frame}`), T && D.id !== this.state.active_camera_id && D !== M) continue;
    ...
    dispose() {
      this.disposed || (this.disposed = !0, this.agentBridge?.dispose?.(), this.transformControlsWiring?.dispose(), $c(this), Mc(), ml(this), this.backgroundRequestId = (this.backgroundRequestId || 0) + 1, this.upstreamSyncId = (this.upstreamSyncId || 0) + 1, this.stopPlay(), clearTimeout(this.previewClickTimer), clearTimeout(this.connectionTimer), cancelAnimationFrame(this.restoreFrame), cancelAnimationFrame(this.serializeFrame), cancelAnimationFrame(this.resizeFrame), cancelAnimationFrame(this.renderFrame), this.abortController?.abort(), this.upstreamFetchController?.abort(), this.resizeObserver?.disconnect(), this.contextMenu?.dispose(), this.webgl?.dispose(), this.cameraWebgl?.dispose(), V(this), Bh(this), this.objectUrls.clear(), this.cardMediaById.clear(), this.cardMediaAssetById?.clear?.(), this.modelUrlsById.clear(), this.modelInfoById.clear());
    }
  };
}
const ri = 1e-9;
...
function Br(e, t) {
  const a = e.map((i) => ag(i, t)), o = og(a), r = e.map((i) => i.frame), n = Math.max(1, r[r.length - 1] - r[0]);
  return a.map((i, c) => [
    (r[c] - r[0]) / n,
...
function ng(e, t, { tolerance: a = 0.02, keepFrames: o = [] } = {}) {
...
function sg(e, t, { target: a = 2, keepFrames: o = [] } = {}) {
...
function ig(e, t, { mergeWithin: a = 1, epsilon: o = 1e-3, keepFrames: r = [] } = {}) {
...
function lg(e, t, a, { lastFrame: o = 1 / 0 } = {}) {
...
function fg() {
  return {
    ...
    deleteSelectedKeyframes() {
      ...
      const t = this._activeTrack(), a = Ce(this), o = t.kind === "camera" ? 1 : 0, { keys: r, removed: n } = cg(a, e, { minKeys: o });
    ...
    nudgeSelectedKeyframes(e) {
      ...
      const a = this._activeTrack(), o = Math.max(0, this.state.duration_frames - 1), r = lg(Ce(this), t, e, { lastFrame: o });
    ...
    setSelectedKeysInterpolation(e) {
      ...
      this.checkpoint(s("Interpolation on {n} keys").replace("{n}", t.length)), a.write(dg(Ce(this), t, e)), this.serialize(), this.refreshKeys(), this.refreshKeyEditor(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} interpolation on {n} keys").replace("{mode}", e.replace(/_/g, " ")).replace("{n}", t.length));
    },
    setSelectedKeysTangentMode(e) {
      const t = this.resolveSelectedFrames();
      if (t.length < 2) return this.setTangentMode(e);
      const a = this._activeTrack(), o = lt(this).map((r) => r.id);
      this.checkpoint(s("Tangents on {n} keys").replace("{n}", t.length)), a.write(mg(Ce(this), t, e, o)), this.serialize(), this.refreshKeys(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} tangents on {n} keys").replace("{mode}", e).replace("{n}", t.length));
    },
    /**
    ...
    simplifyActiveKeys({ mode: e = "simplify", tolerance: t = 0, target: a = 0, scope: o = "camera", fromKeys: r = null, silent: n = !1 } = {}) {
      ...
      const l = this.resolveSelectedFrames(), p = o !== "all_cameras" && l.length >= 2 ? [l[0], l.at(-1)] : null, m = p ? [] : l, f = (u) => {
        const b = [...u].sort((R, N) => R.frame - N.frame), g = p ? p[0] : -1 / 0, v = p ? p[1] : 1 / 0, x = b.filter((R) => R.frame < g), k = b.filter((R) => R.frame >= g && R.frame <= v), y = b.filter((R) => R.frame > v);
        let j = k, A = 0;
        if (k.length > 2) {
          const R = e === "reduce" ? sg(k, i, { target: a || Math.ceil(k.length / 2), keepFrames: m }) : e === "clean" ? ig(k, i, { keepFrames: m }) : ng(k, i, { tolerance: t * pg, keepFrames: m });
          j = R.keys, A = R.removed;
        }
        return { keys: [...x, ...j, ...y].sort((R, N) => R.frame - N.frame), removed: A };
      };
      let d = 0;
      const h = c.map((u) => {
        const b = r && u.primary ? r : u.get(), { keys: g, removed: v } = f(b);
        return d += v, { track: u, keys: g };
      });
      n || this.checkpoint(s("Simplify keyframes"));
      for (const { track: u, keys: b } of h) u.set(b);
      return rr(this), this.selectedKeyFrame = null, this.selectedKeyFrames = /* @__PURE__ */ new Set(), this.camera = $e(this.state, this.frame), this.applyObjectAnimationFrame(), this.serialize(), this.refreshKeys(), this.setFrame(this.frame, !1, !1), this.render(), n || this.setStatus(d ? s("Removed {n} keyframes").replace("{n}", d) : s("No keyframes to remove")), d;
    },
...
class ni {
  constructor(t) {
    this.app = Dn, this.api = at, this.node = t, this.root = gs(), this.root.tabIndex = -1, this.dom = js(this.root), this.canvas = this.root.querySelector(".viewport-wrap > canvas"), this.cameraPreviewCanvases = /* @__PURE__ */ new Map(), this.cameraPreviewContexts = /* @__PURE__ */ new Map(), this.cameraPreviewSignature = "", this.interactionElement = this.canvas, this.interactionElement.tabIndex = 0, this.interactionElement.dataset.captureWheel = "true", this.ctx = this.canvas.getContext("2d", { alpha: !1 }), this.disposed = !1, this.renderRevision = 0, this.directorRevision = 0, this.webgl = null, this.cameraWebgl = null, this.webglReady = this.loadWebGLViewports(), this.transformControlsWiring = Xp(this), this.stateWidget = t.widgets?.find((o) => o.name === "state_json"), this.recordingWidget = t.widgets?.find((o) => o.name === "recording_path"), this.cardWidget = t.widgets?.find((o) => o.name === "card_asset"), this.widthWidget = t.widgets?.find((o) => o.name === "width"), this.heightWidget = t.widgets?.find((o) => o.name === "height"), this.fpsWidget = t.widgets?.find((o) => o.name === "fps"), this.durationWidget = t.widgets?.find((o) => o.name === "duration_seconds"), this.modeWidget = t.widgets?.find((o) => o.name === "render_mode");
    let a = null;
    try {
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-CJAo58oq.js"));
    } catch (a) {
    ...
    if (!this.disposed) {
      ...
      Ic(this), this.resizeCanvas(), this.render(), this.renderCameraView();
    }
  }
}
const xo = { app: Dn, api: at, EditorHistory: us, ContextMenuController: ts, initializeTooltips: fl, promptText: Gt, ObjectUrlRegistry: bs, buildRoot: gs, dispatchDirectorKey: Oc, activeCameraTrack: or, bindWidgetCallbacks: hl, playblastCameraTrack: es, restoreFromWidgets: ul, serializeEditorState: bl, syncActiveCameraTrack: rr, syncFromWidgets: gl, bindEditorEvents: Th, activateCamera: yl, addCamera: vl, deleteCamera: xl, drawPreviewOverlays: wl, duplicateCamera: kl, maximizeCameraPreview: Sl, refreshCameraPreviews: jl, refreshCameraSelectors: _l, renameCamera: Cl, setPlayblastCamera: El, toggleCameraView: Al, captureRealtime: Ks, makePlayblast: ou, uploadDirectorPlayblast: Bs, waitForMediaFrame: Ds, computeAudioPeaks: Ls, loadAudioFile: Rh, releaseAudio: Mo, stopPlay: _o, togglePlay: zh, applyCameraPreset: Jp, applyCameraShake: Zp, applyProxyPreset: Qp, clearViewportBgImage: iu, loadViewportBgFile: nu, loadViewportBgSequence: su, drawCameraPath: wu, drawCard: xu, drawCube: hu, drawCylinder: gu, drawGrid: du, drawHuman: bu, drawLine3D: ie, drawNull: vu, drawOverlays: Su, drawPointField: fu, drawSpeedHeatmap: ku, drawSphere: uu, drawTorus: yu, curveChannels: lt, drawCurveEditor: pd, fitCurveView: ls, onCurveDoubleClick: dd, onCurvePointerDown: td, onCurvePointerMove: ad, onCurvePointerUp: od, onTimelinePointerDown: Pc, onTimelinePointerMove: Lc, onTimelinePointerUp: zc, refreshKeys: Ed, resetCurveZoom: md, resetTimelineZoom: Nc, setChannelFilter: nd, setCurveInterpolation: rd, setTangentMode: sd, timelineFrameFromEvent: gr, toggleCurveHandles: id, zoomCurve: ld, drawTransformGizmo: Fc, frameTarget: Rc, gizmoAxes: Dc, gizmoGeometry: Kc, onPointerDown: Bc, onPointerMove: qc, onPointerUp: Uc, onWheel: Wc, pickGizmo: Vc, pickSceneObject: Hc, resetCamera: Gc, setTransformMode: Yc, setViewMode: Xc, viewportCamera: Jc, loadCardFile: Hh, loadExecutionPreview: Gh, loadMediaUrl: Rs, loadModelFile: Vh, loadSelectedReference: Yh, onModelLoaded: Wh, restoreAssets: Uh, syncUpstreamInputs: Xh, configureDomMedia: zs, refreshSetupDiagnostic: Cu, addMediaCard: Nu, addPrimitive: Ou, applyObjectAnimationFrame: Qu, beginCameraEdit: sb, beginObjectEdit: Ys, commitCameraEdit: ib, commitObjectEdit: Du, copyKeyframe: ob, deleteKeyframe: ab, deleteObject: Gs, deleteSelectedObjects: zu, duplicateObject: Hs, exitKeyEdit: lb, finishCameraEdit: cb, goToAdjacentKey: vb, insertKeyframe: eb, loadSelectedKeyView: yb, pasteKeyframe: rb, playblastCameraAtFrame: Zu, refreshInspector: Fu, refreshKeyEditor: ub, refreshObjects: Vs, removeObjectResources: Vu, renameObject: Pu, retimeSelectedKey: bb, selectKeyframe: nb, selectedKeyframe: He, selectedObject: Zt, selectObjectAnimation: Wu, setKeyInterpolation: tb, setKeyTangentMode: hb, setObjectParent: Uu, timelineKeyframes: Ce, timelineObject: ze, toggleAutoKey: db, toggleObject: Lu, updateCameraFromHud: qu, updateCameraRotationFromHud: Bu, updateEditState: pb, updateKeyVisualState: fb, updateSelectedKey: gb, updateSelectedObject: Ru, clamp: J, cloneCamera: pe, configureCore: Qn, defaultCamera: xr, sampleCamera: $e, sampleObjectTransform: Lo, sanitizeState: kr, worldTransform: Sr };
Object.assign(
  ni.prototype,
  Cb(xo),
  zb(xo),
...
function hg(e) {
  ...
  const t = new ni(e);
  wo("director:constructor:complete", e), hp(t);
  try {
    t.agentBridge = wp(t, e, at);
  } catch (m) {
  ...
  try {
    t.assetBrowser = zp(t, {
      ...
      onAgentFirstOpen: async () => {
        if (er())
          try {
            const { createDirectorAgentPanel: m } = await import("./chunk-Dmnk2uOR.js");
            t.agentPanel = m(t);
          } catch (m) {
  ...
  try {
    t.characterRuntime = Fp(t), t.rigMapper = Dp(t), t.poseEditor = qp(t), t.motionEditor = Up(t);
  } catch (m) {
  ...
  }, t.unwatchGraphConnections = pl(e, i);
  const l = e.onRemoved;
