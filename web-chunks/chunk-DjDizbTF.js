import { bQ as m } from "./chunk-DwC7ND4U.js";
import { H as d } from "./chunk-_f2VoZbc.js";
function b(o) {
  return (t) => {
    if (!t.ctrlKey)
...
function y(o, t) {
  const r = f(o, t), e = r?.origin_id ?? r?.originId;
  if (e == null) return null;
  const n = o?.getNodeById?.(e);
  return n || ((o?._nodes || o?.nodes || []).find((i) => String(i?.id) === String(e)) ?? null);
}
const g = '<svg class="oc-mark" viewBox="0 0 32 32" aria-hidden="true" focusable="false"><circle class="oc-mark-disc" cx="16" cy="16" r="16"/><circle class="oc-mark-ring" cx="16" cy="16" r="7.6"/><circle class="oc-mark-core" cx="16" cy="16" r="5.8"/></svg>';
function v(o) {
  return `<div class="oc-heading"><span class="oc-brand">${g}</span><span class="oc-title">${o}</span></div>`;
}
const k = `
  .majoor-omnicam{
    ${m}
