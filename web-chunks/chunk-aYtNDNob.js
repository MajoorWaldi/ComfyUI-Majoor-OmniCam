import { app as Mn } from "../../scripts/app.js";
import { api as He } from "../../scripts/api.js";
import { s as Ce, c as Y, t as be, a as s, o as Tn, b as dr, d as Ge, e as he, f as $o, r as Ys, g as mr, h as In, i as Xs, j as Js, k as Zs, l as Qs, m as pr, n as fr, I as uo, p as hr, q as ei, w as ti, u as vo, v as On, x as ai, y as ur, z as zr, A as Pn, B as Yo, C as Ln, D as Fn, E as zn, F as Nn, G as Xo, H as zo, J as Nr, O as Rr, R as Rn, K as oi, L as ri, M as ni, N as br, P as si, Q as ii, S as ci, T as li, U as di, V as gr, W as mi, X as pi, Y as fi, Z as hi, _ as ui, $ as bi, a0 as gi, a1 as yi, a2 as vi, a3 as xi, a4 as wi, a5 as ki, a6 as Si, a7 as ji, a8 as _i, a9 as Ci, aa as Ei, ab as Ai, ac as $i, ad as Mi, ae as Ti, af as Ii, ag as Oi, ah as Pi, ai as Li, aj as Fi, ak as zi, al as Ni, am as Ri, an as Ki, ao as Di, ap as Bi, aq as qi, ar as Ui, as as Wi, at as Vi, au as Hi, av as Gi, aw as Yi, ax as Xi, ay as Ji, az as Zi, aA as Qi, aB as Kn, aC as Dn, aD as ec, aE as No, aF as tc, aG as ac, aH as oc, aI as rc, aJ as nc, aK as Ne, aL as sc, aM as Bn, aN as yr, aO as ic, aP as cc, aQ as lc, aR as qn, aS as We, aT as qe, aU as dc, aV as Kr, aW as vr, aX as mc, aY as pc, aZ as fc, a_ as hc, a$ as uc, b0 as bc, b1 as gc, b2 as Un, b3 as yc, b4 as vc, b5 as xc, b6 as wc, b7 as kc, b8 as Sc, b9 as jc, ba as _c, bb as Cc, bc as Ec, bd as Ac, be as $c, bf as Mc, bg as Tc, bh as Ic, bi as Oc, bj as Pc, bk as Lc, bl as Fc } from "./chunk-DQ3hR7Bx.js";
import { L as zc, a as Nc, p as Rt, f as xr, b as Rc, S as Kc, c as Dr, d as Dc, e as Bc, r as qc, g as Uc, n as Wc, C as Br, h as Kt, o as Vc, i as Hc, s as Gc, j as Yc, k as Wn, l as Xc, m as Jo, q as Zo, w as Jc, t as Vn, u as Zc, v as Qc, x as el, y as tl, z as al, A as ol, B as rl, D as nl, E as sl, F as il, G as cl, H as ll, I as dl, J as ml, K as pl, M as fl } from "./chunk-DsKJJ52u.js";
import { S as hl, b as ul, p as bl, m as gl, l as yl, u as vl } from "./chunk-BOI_2OKd.js";
import { R as xl } from "./vendor-three-AeKB2-k3.js";
function $t(e, t = 0) {
  return Math.sin(e * 1.7 + t * 3.1) * 0.5 + Math.sin(e * 3.3 + t * 5.7) * 0.3 + Math.sin(e * 7.9 + t * 11.3) * 0.2;
}
function wl(e, { type: t = "handheld_subtle", intensity: a = 1, duration_frames: o = null, subdivide: r = !0 } = {}) {
  ...
  return [...b].sort((g, y) => g - y).map((g) => {
    const y = Ce(u, g), S = $t(g * m, 1) * l, x = $t(g * m, 2) * l, E = $t(g * m, 3) * l * 0.5, M = $t(g * m, 4) * p, R = $t(g * m, 5) * (p * 0.35), L = [...y.position], X = [...y.target];
    return L[0] += S, L[1] += x, L[2] += E, X[0] += S * 0.35, X[1] += x * 0.35, {
      frame: g,
      camera: {
        ...y,
        position: L,
        target: X,
        roll: (y.roll || 0) + M,
        fov: Y((y.fov || 35) + R, 10, 140)
      },
      interpolation: "smooth"
    };
  });
}
function kl(e, { duration_frames: t = 120, target: a = [0, 1.5, 0], radius: o = 6, height: r = 3.5 } = {}) {
...
const Hn = 1e-4;
function Sl(e, t) {
  return !Array.isArray(e) || !Array.isArray(t) ? e !== t : e.some((a, o) => Math.abs(Number(a) - Number(t[o])) > Hn);
}
function qr(e, t) {
  return Math.abs(Number(e) - Number(t)) > Hn;
}
const Gn = [
  {
    id: "camera",
  ...
  },
  {
    ...
    label: "Look At",
    color: "#f0a742",
    changed: (e, t) => Sl(e?.target, t?.target),
    read: (e) => e?.target
  },
  {
    id: "focal_length",
...
function _l(e, t = null) {
  return Gn.filter((a) => !t || t.has(a.id)).map((a) => ({
    id: a.id,
    label: a.label,
    color: a.color,
    frames: jl(e, a)
...
function Yn(e) {
  ...
  a.delete("camera");
  const o = e.timelineKeyframes() || [], r = _l(o, a), n = $l(e, r);
  if (t.dataset.signature !== n) {
    t.dataset.signature = n, t.replaceChildren();
    const i = (c) => be(e, c);
    for (const c of r) {
      const l = document.createElement("div");
      l.className = "oc-dope-row", l.dataset.channel = c.id, l.style.setProperty("--channel-color", c.color), El(l, c.frames, i), Al(e, l, c, o, i), t.appendChild(l);
    }
  }
...
const Ro = [1, 2, 5, 10, 20, 25, 50, 100, 200, 250, 500, 1e3, 2e3, 5e3], Xn = 46, Ur = 5, Jn = 640;
function Zn(e, t) {
  const a = t > 0 ? t : Jn, o = Math.max(2, Math.floor(a / Xn)), r = Math.max(1e-6, e / o);
  return Ro.find((n) => n >= r) ?? Ro[Ro.length - 1];
}
function Ml(e, t) {
  const a = Math.max(1, e.state.duration_frames - 1), o = Y(Number(e.timelineZoom) || 1, 0.1, 50), r = Number(e.timelinePan) || 0, n = a / o, i = Zn(n, t), l = (i >= Ur ? i / Ur : 0) || i, p = [], m = Math.max(0, Math.floor(r / l) * l);
  for (let d = m; d <= a + 1e-6; d += l) {
    const f = Math.round(d), u = be(e, f);
    if (!(u < -1)) {
      if (u > 101) break;
...
function Tl(e) {
  return e.clientWidth || e.parentElement?.clientWidth || Jn;
}
function Qn(e) {
  const t = e.root.querySelector('[data-role="ruler"]');
  if (!t) return;
  t.replaceChildren();
  for (const o of Ml(e, Tl(t))) {
...
function Il(e, t) {
  ...
  a.addEventListener("pointerup", i, { signal: t }), a.addEventListener("pointercancel", i, { signal: t }), a.addEventListener("wheel", (c) => Tn(e, c), { passive: !1, signal: t });
}
const Ol = [1, 2, 2.5, 5, 10];
function Pl(e, t = 5) {
  const a = Math.abs(e) / Math.max(1, t);
  if (!(a > 0) || !Number.isFinite(a)) return 1;
  const o = 10 ** Math.floor(Math.log10(a)), r = a / o;
  return (Ol.find((n) => n >= r) ?? 10) * o;
}
function Ll(e, t) {
  const a = Math.max(0, Math.min(4, Math.ceil(-Math.log10(t))));
  return e.toFixed(a);
}
function Fl(e, { left: t, right: a, top: o, width: r, graphWidth: n, graphHeight: i, height: c, timeMin: l, timeMax: p, totalDuration: m, xFor: h, frame: d }) {
  const f = Zn(p - l, n);
...
function zl(e, { left: t, right: a, top: o, width: r, graphHeight: n, minimum: i, maximum: c, yFor: l }) {
  const p = Pl(c - i, 4);
  e.strokeStyle = "#222228", e.lineWidth = 1, e.fillStyle = "#6e727a";
  for (let m = Math.ceil(i / p) * p; m <= c; m += p) {
    const h = l(m);
    h < o - 1 || h > o + n + 1 || (e.beginPath(), e.moveTo(t, h), e.lineTo(r - a, h), e.stroke(), e.fillText(Ll(m, p), 4, h + 3));
  }
}
function wr(e, t) {
...
function Rl(e, t) {
  const a = t.currentTarget, { x: o, y: r } = wr(a, t);
  if (e.curvePanDrag && t.pointerId === e.curvePanDrag.pointerId) {
    t.preventDefault();
    const h = t.clientX - e.curvePanDrag.startX, d = t.clientY - e.curvePanDrag.startY, u = Math.max(1, e.state.duration_frames - 1) / (Number(e.curveZoomX) || 1), b = Math.max(1, a.clientWidth - 58), v = a.clientHeight || 180, g = Math.max(1, v - 38);
  ...
  if (e.curveScrub && t.pointerId === e.curveScrub.pointerId) {
    t.preventDefault();
    const h = Math.max(1, e.state.duration_frames - 1), d = h / (Number(e.curveZoomX) || 1), f = Number(e.curvePanX) || 0, u = Math.round(Y(f + (o - 44) / Math.max(1, a.clientWidth - 58) * d, 0, h));
    e.setFrame(u);
    return;
  }
  if (e.curveBoxSelect && t.pointerId === e.curveBoxSelect.pointerId) {
    ...
    const h = Math.min(e.curveBoxSelect.startX, o), d = Math.max(e.curveBoxSelect.startX, o), f = Math.min(e.curveBoxSelect.startY, r), u = Math.max(e.curveBoxSelect.startY, r), b = (e.curveHitPoints || []).filter((g) => !g.handle && g.x >= h && g.x <= d && g.y >= f && g.y <= u).map((g) => g.key.frame), v = new Set(e.curveBoxSelect.additive ? e.curveBoxSelect.initial : []);
    for (const g of b) v.add(g);
  ...
  if (!e.curveDrag || t.pointerId !== e.curveDrag.pointerId) {
    const h = (e.curveHitPoints || []).map((y) => ({ point: y, distance: Math.hypot(o - y.x, r - y.y) })).sort((y, S) => y.distance - S.distance)[0], d = Math.max(1, e.state.duration_frames - 1), f = d / (Number(e.curveZoomX) || 1), u = Number(e.curvePanX) || 0, b = Math.max(1, a.clientWidth - 58), v = Y(Math.round(u + (o - 44) / b * f), 0, d);
    let g = null;
    if (h && h.distance <= 14) {
      const y = h.point, S = y.object ? y.key.transform || y.object : y.key.camera || y.key;
      g = {
        x: o,
        y: r,
        frame: y.key.frame,
        channelName: y.channel.name,
        value: y.channel.get(S),
        isHandle: !!y.handle,
        handleSide: y.handle
      };
    } else r >= 20 && r <= 165 && o >= 44 && o <= a.clientWidth - 14 && (g = { x: o, y: r, frame: v });
  ...
  if (e.curveHover = null, t.preventDefault(), t.stopPropagation(), e.curveDrag.historyCheckpointed || (e.checkpoint?.(e.curveDrag.handle ? "Edit curve tangent" : "Edit curve"), e.curveDrag.historyCheckpointed = !0), e.curveDrag.handle) {
    const h = e.curveDrag.key, d = e.curveDrag.channel, f = e.curveDrag.handle, u = e.curveDrag.pixelPerSegment, b = e.curveDrag.valuePerPixel, v = e.curveDrag.keyX, g = e.curveDrag.keyY;
    ...
    const y = h.tangents.channels[d.id] || {}, S = y.mode || (h.tangents.mode === "aligned" ? "aligned" : "free"), x = {
    ...
    if (f === "in") {
      if (x.in_x = Y((o - v) / Math.max(1, u), -0.99, -0.01), x.in_y = (g - r) * b, S === "aligned") {
    ...
    } else if (x.out_x = Y((o - v) / Math.max(1, u), 0.01, 0.99), x.out_y = (g - r) * b, S === "aligned") {
  ...
  if (e.curveDrag.group) {
    ...
    if (d) {
      const u = e.curveDrag.group.map((v) => Y(Math.round(v.startFrame + d), 0, e.curveDrag.lastFrame));
      u.some((v) => f.has(v)) || new Set(u).size !== u.length ? d = 0 : e.curveDrag.group.forEach((v, g) => {
        v.key.frame = u[g];
      });
    }
  ...
  if (e.curveDrag.object) {
    const h = Ge(e.curveDrag.key.transform);
...
function es(e, { selectedOnly: t = !1 } = {}) {
  const a = Math.max(1, (e.state?.duration_frames ?? 120) - 1), o = e.timelineKeyframes() || [], r = e.timelineObject(), n = Qe(e), i = e.selectedKeyFrames?.size ? [...e.selectedKeyFrames] : e.selectedKeyFrame != null ? [e.selectedKeyFrame] : [], c = i.length > 0, l = t || c && i.length < o.length ? o.filter((b) => i.includes(b.frame)) : o;
  if (!l.length) {
  ...
  if (l.length < o.length && d < a) {
    const b = Math.max(2, Math.round(d * 0.15)), v = Math.max(0, m - b), g = Math.min(a, h + b), y = Math.max(1, g - v);
    e.curveZoomX = Y(a / y, 0.2, 30), e.curvePanX = v;
  } else
  ...
  for (const b of l) {
    ...
    for (const g of n) {
      const y = g.get(v);
      Number.isFinite(y) && f.push(y);
    }
  }
  if (f.length > 0) {
    const b = Math.min(...f), v = Math.max(...f), g = Math.max(1e-4, v - b), y = (b + v) / 2, S = (V) => r ? $o(r, V) : Ce(e.state, V), x = [], E = Math.max(1, Math.floor(a / 40));
    for (let V = 0; V <= a; V += E) {
      const se = S(V);
      for (const j of n) {
        const F = j.get(se);
    ...
    let M = Math.min(...x), R = Math.max(...x);
    (!Number.isFinite(M) || !Number.isFinite(R)) && (M = -1, R = 1), Math.abs(R - M) < 1e-6 && (M -= 1, R += 1);
    const L = (R - M) * 0.1;
    M -= L, R += L;
    const X = R - M, W = (M + R) / 2;
    if (l.length < o.length && g < X * 0.75) {
      const V = g * 1.35;
      e.curveZoom = Y(X / V, 0.2, 30), e.curvePanY = y - W;
    } else
...
function Yl(e) {
  ...
  const i = e.timelineObject(), c = e.timelineKeyframes(), l = Qe(e), p = 44, m = 14, h = 16, d = 22, f = Math.max(1, a - p - m), u = Math.max(1, o - h - d), b = Math.max(1, e.state.duration_frames - 1), v = Y(Number(e.curveZoomX) || 1, 0.1, 50), g = Number(e.curvePanX) || 0, y = b / v, S = g, x = g + y, E = [], M = Math.max(1, Math.ceil(y / Math.max(80, f))), R = ($) => i ? $o(i, $) : Ce(e.state, $);
  for (let $ = 0; $ <= b; $ += M) E.push({ frame: $, value: R($) });
  E[E.length - 1]?.frame !== b && E.push({ frame: b, value: R(b) });
  const L = E.flatMap(($) => l.map((H) => H.get($.value)));
  let X = Math.min(...L), W = Math.max(...L);
  (!Number.isFinite(X) || !Number.isFinite(W)) && (X = -1, W = 1), Math.abs(W - X) < 1e-6 && (X -= 1, W += 1);
  const V = (W - X) * 0.1;
  X -= V, W += V;
  const se = Y(Number(e.curveZoom) || 1, 0.1, 50), j = (W + X) / 2 + (Number(e.curvePanY) || 0), F = (W - X) / se;
  X = j - F / 2, W = j + F / 2;
  const B = ($) => p + ($ - S) / Math.max(1e-6, x - S) * f, G = ($) => h + u * (W - $) / Math.max(1e-6, W - X);
  if (n.fillStyle = "#111114", n.fillRect(0, 0, a, o), n.strokeStyle = "#222228", n.lineWidth = 1, n.font = "9px system-ui, -apple-system, sans-serif", n.fillStyle = "#6e727a", Fl(n, {
    left: p,
    right: m,
    top: h,
    width: a,
    ...
    xFor: B,
    frame: e.frame
  }), zl(n, { left: p, right: m, top: h, width: a, graphHeight: u, minimum: X, maximum: W, yFor: G }), X <= 0 && W >= 0) {
    const $ = G(0);
  ...
  for (const $ of l) {
    ...
    let H = !1;
    E.forEach((P) => {
      const U = B(P.frame), J = G($.get(P.value));
      U >= p - 50 && U <= a - m + 50 && (H ? n.lineTo(U, J) : (n.moveTo(U, J), H = !0));
    }), n.stroke();
    for (const P of c) {
      const U = i ? P.transform : P.camera, J = B(P.frame), de = G($.get(U)), me = P.frame === e.selectedKeyFrame || e.selectedKeyFrames?.has(P.frame);
      me && (n.fillStyle = "rgba(242, 208, 107, 0.35)", n.beginPath(), n.arc(J, de, 8.5, 0, Math.PI * 2), n.fill()), n.fillStyle = me ? "#ffd75e" : $.color, n.strokeStyle = "#0d0d10", n.lineWidth = 1.6, n.beginPath(), n.arc(J, de, me ? 5.2 : 3.8, 0, Math.PI * 2), n.fill(), n.stroke(), e.curveHitPoints.push({
        x: J,
        y: de,
        key: P,
        channel: $,
    ...
    if (e.showCurveHandles)
      for (let P = 0; P < c.length; P++) {
        const U = c[P], J = U.frame === e.selectedKeyFrame || e.selectedKeyFrames?.has(U.frame);
        if (!(J || e.curveChannelFilter !== "all" || c.length <= 4) || U.interpolation !== "bezier") continue;
        const me = i ? U.transform || i : U.camera || U, ae = B(U.frame), pe = G($.get(me)), fe = c[P - 1], ue = c[P + 1], ve = Math.max(1, U.frame - (fe?.frame ?? U.frame - 1)), ge = Math.max(1, (ue?.frame ?? U.frame + 1) - U.frame), ye = Ys(
          U,
          $.id,
          fe,
          ue,
          (ne) => $.get(i ? ne.transform || i : ne.camera || U)
        ), z = (W - X) / Math.max(1, u), K = f * ge / Math.max(1, y), re = f * ve / Math.max(1, y), ce = [];
        (fe || P > 0) && ce.push({ side: "in", x: ae + ye.in_x * re, y: pe - ye.in_y / z }), (ue || P < c.length - 1 || c.length === 1) && ce.push({ side: "out", x: ae + ye.out_x * K, y: pe - ye.out_y / z });
        for (const ne of ce) {
          if (n.strokeStyle = $.color, n.lineWidth = J ? 1.5 : 1, n.beginPath(), n.moveTo(ae, pe), n.lineTo(ne.x, ne.y), n.stroke(), n.fillStyle = J ? "#2a2233" : "#171720", n.strokeStyle = J ? "#ffd75e" : $.color, n.lineWidth = J ? 2 : 1.2, n.beginPath(), ne.side === "in")
            n.arc(ne.x, ne.y, J ? 5 : 3.8, 0, Math.PI * 2);
          else {
            const ke = J ? 4.5 : 3.2;
            n.rect(ne.x - ke, ne.y - ke, ke * 2, ke * 2);
          }
          n.fill(), n.stroke(), e.curveHitPoints.push({
            ...
            object: i,
            handle: ne.side,
            pixelPerSegment: ne.side === "in" ? re : K,
            valuePerPixel: z,
            startHandles: { ...ye }
          });
        }
  ...
  if (e.curveBoxSelect) {
    const $ = Math.min(e.curveBoxSelect.startX, e.curveBoxSelect.currentX), H = Math.min(e.curveBoxSelect.startY, e.curveBoxSelect.currentY), P = Math.abs(e.curveBoxSelect.currentX - e.curveBoxSelect.startX), U = Math.abs(e.curveBoxSelect.currentY - e.curveBoxSelect.startY);
    n.fillStyle = "rgba(56, 189, 248, 0.15)", n.fillRect($, H, P, U), n.strokeStyle = "#38bdf8", n.lineWidth = 1, n.setLineDash([4, 4]), n.strokeRect($, H, P, U), n.setLineDash([]);
  }
  const te = B(e.frame);
  if (te >= p && te <= a - m && (n.strokeStyle = "#a78bfa", n.lineWidth = 1.5, n.beginPath(), n.moveTo(te, h), n.lineTo(te, h + u), n.stroke(), n.fillStyle = "#a78bfa", n.beginPath(), n.moveTo(te - 4, h), n.lineTo(te + 4, h), n.lineTo(te, h + 6), n.closePath(), n.fill()), e.curveDrag || e.curveHover) {
    let $ = "", H = "";
    if (e.curveDrag)
      if (e.curveDrag.handle) {
        const P = e.curveDrag.handle === "in" ? "In" : "Out";
        $ = `F${e.curveDrag.key.frame} · ${e.curveDrag.channel.name} (${P})`, H = "Tangent edit";
      } else if (e.curveDrag.group && e.curveDrag.group.length > 1) {
        const P = e.curveDrag.key.frame - e.curveDrag.startFrame, U = e.curveDrag.channel.get(e.curveDrag.object ? e.curveDrag.key.transform : e.curveDrag.key.camera), J = U - e.curveDrag.startValue, de = P >= 0 ? `+${P}` : `${P}`, me = J >= 0 ? `+${J.toFixed(2)}` : `${J.toFixed(2)}`;
        $ = `${e.curveDrag.group.length} keys · ΔF: ${de} · ΔVal: ${me}`, H = `${e.curveDrag.channel.name}: ${U.toFixed(2)}`;
      } else {
        const P = e.curveDrag.key.frame - e.curveDrag.startFrame, U = e.curveDrag.channel.get(e.curveDrag.object ? e.curveDrag.key.transform : e.curveDrag.key.camera), J = U - e.curveDrag.startValue, de = P >= 0 ? `+${P}` : `${P}`, me = J >= 0 ? `+${J.toFixed(2)}` : `${J.toFixed(2)}`;
        $ = `F${e.curveDrag.key.frame} (${de}) · ${e.curveDrag.channel.name}: ${U.toFixed(2)} (${me})`;
      }
    else if (e.curveHover)
      if (e.curveHover.channelName) {
        const P = Number.isFinite(e.curveHover.value) ? e.curveHover.value.toFixed(2) : "";
        $ = `F${e.curveHover.frame} · ${e.curveHover.channelName}: ${P}`, e.curveHover.isHandle && (H = `Handle ${e.curveHover.handleSide}`);
      } else
        $ = `Frame ${e.curveHover.frame}`;
    if ($) {
      n.save(), n.font = "11px system-ui, -apple-system, sans-serif";
      const P = n.measureText($), U = H ? n.measureText(H) : { width: 0 }, J = Math.max(P.width, U.width) + 16, de = H ? 32 : 20, me = a - m - J - 6, ae = h + 6;
      n.fillStyle = "rgba(18, 18, 24, 0.88)", n.strokeStyle = "#38384a", n.lineWidth = 1, n.beginPath(), n.roundRect ? n.roundRect(me, ae, J, de, 4) : n.rect(me, ae, J, de), n.fill(), n.stroke(), n.fillStyle = "#e2e8f0", n.fillText($, me + 8, ae + (H ? 13 : 14)), H && (n.fillStyle = "#94a3b8", n.font = "9.5px system-ui, -apple-system, sans-serif", n.fillText(H, me + 8, ae + 26)), n.restore();
    }
  }
  for (const $ of e.root.querySelectorAll("[data-tangent-mode]")) {
    const H = e.selectedKeyframe(), P = H?.tangents?.channels?.[l[0]?.id]?.mode || H?.tangents?.mode || "auto";
...
function Wr(e, { filter: t, label: a, color: o, title: r }) {
...
function ts(e) {
  ...
  if (!t) return;
  const a = e.timelineObject(), o = a ? a.name || a.type : e.activeCameraTrack().name, r = Xl(e), n = `${o}\0${r.map((c) => `${c.id}:${c.color}`).join("|")}`;
  if (t.dataset.signature !== n) {
    t.dataset.signature = n, t.replaceChildren();
    const c = document.createElement("span");
    c.className = "oc-graph-legend-title", c.textContent = o, t.appendChild(c), t.appendChild(Wr(e, {
      filter: "all",
      label: s("All"),
      color: null,
...
function Vr(e, t, a) {
  ...
  for (const n of [...e].sort((i, c) => i.frame - c.frame)) {
    ...
    (r === null || !(Math.abs(c - r) <= Jl)) && o.push(n.frame), r = c;
  }
  return o;
}
function kr(e) {
  ...
  const a = e.timelineKeyframes() || [], o = !!e.timelineObject(), r = e.selectedKeyFrames || (e.selectedKeyFrame === null ? /* @__PURE__ */ new Set() : /* @__PURE__ */ new Set([e.selectedKeyFrame])), n = Qe(e), i = [
    e.state.duration_frames,
    Number(e.timelineZoom) || 1,
    Number(e.timelinePan) || 0,
    ...n.map((c) => `${c.id}:${Vr(a, c, o).join(",")}`)
  ].join("\0");
...
const Hr = ["#4aa3ef", "#f2a93b", "#48c774", "#b565d8", "#ec4899"];
function as(e, t) {
  const a = e.state.cameras.findIndex((r) => r.id === t), o = a >= 0 ? e.state.cameras[a] : null;
  return { camera: o, color: o?.color || Hr[Math.max(0, a) % Hr.length] };
}
function dt(e) {
...
function Zl(e) {
  e.checkpoint("Auto-split shots"), e.state.sequence = {
    ...
    enabled: !0,
    cuts: Zs(e.state)
  }, dt(e), e.setStatus(s("Split into {count} shots").replace("{count}", String(e.state.sequence.cuts.length)));
}
...
function Ql(e, t) {
  ...
  if (a.appendChild(ao(
    ...
    () => {
      e.checkpoint("Split shot"), In(e.state, e.frame, null) ? dt(e) : e.setStatus(s("Move the playhead inside a shot first"));
    },
    { disabled: o }
  )), a.appendChild(ao(
    s("Clear edit"),
    ...
    () => {
      e.checkpoint("Clear edit"), e.state.sequence = { ...e.state.sequence, enabled: !1, cuts: [] }, dt(e), e.setStatus(s("Multi-camera edit cleared"));
    }
  ))), a.appendChild(ao(
...
function td(e, t, a, o, r) {
  t.preventDefault(), t.stopPropagation();
  const { camera: n } = as(e, a.camera_id);
  e.contextMenu?.show(t, n?.name || s("Shot"), [
    ...e.state.cameras.map((i) => ({
      ...
      run: () => {
        e.checkpoint("Change shot camera"), e.state.sequence.cuts[o].camera_id = i.id, dt(e);
      }
    })),
    null,
    {
      ...
      run: () => {
        e.checkpoint("Split shot"), In(e.state, e.frame, null) && dt(e);
      }
    },
    {
      label: s("Remove shot"),
      ...
      disabled: r === 1,
      run: () => {
        e.checkpoint("Remove shot"), Xs(e.state, o) && dt(e);
      }
    }
  ]);
}
function ad(e, t, a, o) {
  const { camera: r, color: n } = as(e, t.camera_id), i = document.createElement("div");
  ...
  return i.addEventListener("contextmenu", (l) => td(e, l, t, a, o.__cutCount)), i.addEventListener("pointerdown", () => {
...
function rs(e, t) {
  ...
  if (n.className = "oc-sequence-lane", n.dataset.role = "sequence-lane", n.setAttribute("aria-label", s("Multi-camera edit")), o.length)
    for (const [c, l] of o.entries()) {
      ...
      be(e, l.end + 1) < -5 || p > 105 || n.appendChild(ad(e, l, c, r));
    }
  else {
    const c = document.createElement("span");
...
const rd = ['[data-act="curve-zoom-in"]', '[data-act="curve-zoom-out"]', '[data-act="curve-fit"]', '[data-act="curve-handles"]'], Gr = { curves: "Graph", dope: "Timeline", sequence: "Sequence" };
function Yr(e, t) {
  const a = t in Gr ? t : "curves";
  e.graphTab = a;
  ...
  a === "dope" ? kr(e) : a === "sequence" ? (rs(e, n), n?.focus?.({ preventScroll: !0 })) : e.drawCurveEditor(), e.setStatus(s(Gr[a]));
}
function nd(e) {
  e.graphTab === "sequence" && rs(e, e.root.querySelector('[data-role="graph-sequence"]'));
}
function sd(e, t) {
  ...
  a && a.addEventListener("keydown", (o) => {
    if (o.key === "ArrowLeft" || o.key === "ArrowRight") {
      ...
      if (n >= 0 && r.length > 1) {
        ...
        r[i].focus(), Yr(e, r[i].dataset.graphTab);
      }
    }
  }, { signal: t });
  for (const o of e.root.querySelectorAll("[data-graph-tab]"))
    o.addEventListener("click", (r) => {
      r.preventDefault(), r.stopPropagation(), Yr(e, o.dataset.graphTab);
    }, { signal: t });
}
const id = /* @__PURE__ */ new Set(["good", "warning", "bad", "unknown"]);
function ns(e, t) {
  ...
  for (const n of r.frames) {
    ...
    const c = id.has(n?.state) ? n.state : "unknown", l = n?.score;
    let p = null;
    if (l != null) {
      const m = Number(l);
...
function ld(e) {
  ...
  if (!t || !a) return;
  const o = ns(e.state?.metadata, e.state?.duration_frames), r = o.some((c) => c.state !== "unknown");
  ...
  if (Xr.has(a)) return;
  Xr.add(a), a.addEventListener("pointerdown", (c) => {
...
function dd(e) {
  ...
  if (e.audioWaveformPeaks && e.audioWaveformPeaks.length) {
    ...
    const S = y.getContext("2d"), x = e.audioWaveformPeaks, E = y.width, M = y.height, R = M / 2;
    S.fillStyle = "#f2d06b";
    for (let L = 0; L < x.length; L++) {
      const W = (L / (x.length - 1) * r - l) / Math.max(1e-6, c) * E;
      if (W >= -5 && W <= E + 5) {
        const V = x[L] * (M * 0.85);
        S.fillRect(W, R - V / 2, Math.max(1, E / x.length * n - 0.5), V);
      }
    }
    t.appendChild(y);
  }
  if (e.state.playback_range) {
    ...
    y.style.left = `${S}%`, y.style.width = `${Math.max(0, x - S)}%`, t.appendChild(y);
  }
  Qs(e, t);
  for (const y of e.state.markers || []) {
    const S = be(e, y.frame);
    if (S < -5 || S > 105) continue;
    const x = document.createElement("span");
    x.className = "timeline-marker", x.style.left = `${S}%`, x.style.setProperty("--marker-color", y.color), x.title = y.name, t.appendChild(x);
  }
  if (o.length > 1) {
    const y = be(e, o[0].frame), S = be(e, o[o.length - 1].frame), x = document.createElement("span");
    x.className = "oc-dope-rail", x.style.left = `${Math.min(y, S)}%`, x.style.width = `${Math.abs(S - y)}%`, x.style.setProperty("--channel-color", "#a78bfa"), t.appendChild(x);
  }
  ...
  for (const y of o) {
    ...
    x.type = "button", x.className = `key${y.frame === e.frame ? " at-playhead" : ""}${p.has(y.frame) ? " selected" : ""}${y.frame === e.editingKeyFrame ? " editing" : ""}`, x.dataset.keyFrame = String(y.frame), x.dataset.interp = y.interpolation || "ease", x.setAttribute("aria-label", s(`${a?.name || "Camera"} keyframe at frame ${y.frame}`)), x.title = s(`Frame ${y.frame} · ${y.interpolation} · Drag: Retime · Alt+Drag: Duplicate`), x.style.left = `${S}%`;
    const E = document.createElement("span");
    E.className = "key-label", E.textContent = String(y.frame), x.appendChild(E), x.addEventListener("pointerdown", (M) => {
      if (M.preventDefault(), M.stopPropagation(), x.focus({ preventScroll: !0 }), M.altKey) {
        e.checkpoint("Duplicate keyframe");
        const L = a ? { frame: y.frame, transform: Ge(y.transform), interpolation: y.interpolation } : { frame: y.frame, camera: he(y.camera), interpolation: y.interpolation }, X = e.timelineKeyframes();
        X.push(L), X.sort((W, V) => W.frame - V.frame), e.selectedKeyFrame = L.frame, e.selectedKeyFrames = /* @__PURE__ */ new Set([L.frame]), e.keyDrag = { key: L, box: t, isDuplicate: !0, historyCheckpointed: !0, moving: [{ key: L, startFrame: L.frame }], startPointerFrame: y.frame, startClientX: M.clientX, startClientY: M.clientY }, e.setFrame(L.frame, !1, !1), e.setStatus(s(`Duplicating key from ${y.frame}...`));
        return;
      }
      if (M.shiftKey) {
        e.selectedKeyFrames = new Set(e.selectedKeyFrames || [e.selectedKeyFrame].filter((L) => L !== null)), e.selectedKeyFrames.has(y.frame) ? e.selectedKeyFrames.delete(y.frame) : e.selectedKeyFrames.add(y.frame), e.selectedKeyFrame = e.selectedKeyFrames.has(y.frame) ? y.frame : [...e.selectedKeyFrames].at(-1) ?? null, e.setFrame(y.frame, !1, !1), e.updateKeyVisualState(), e.refreshKeyEditor();
        return;
      }
      e.selectedKeyFrames?.has(y.frame) || (e.selectedKeyFrames = /* @__PURE__ */ new Set([y.frame])), e.selectedKeyFrame = y.frame;
      const R = e.timelineKeyframes().filter((L) => e.selectedKeyFrames.has(L.frame));
      e.keyDrag = { key: y, box: t, historyCheckpointed: !1, moving: R.map((L) => ({ key: L, startFrame: L.frame })), startPointerFrame: y.frame, startClientX: M.clientX, startClientY: M.clientY }, e.setFrame(y.frame, !1, !1);
    }), x.addEventListener("click", (M) => {
      M.preventDefault(), M.stopPropagation(), !M.shiftKey && (M.shiftKey || (e.selectedKeyFrames = /* @__PURE__ */ new Set([y.frame])), e.selectKeyframe(y));
    }), t.appendChild(x);
  }
  ...
  if (h) {
    ...
    y.style.fontWeight = "700", e.selectedEntity === "object" && a ? (y.style.color = "#38bdf8", y.textContent = `📦 ${a.name || a.type}`, h.title = s(`Currently animating object: ${a.name || a.type}`)) : (y.style.color = "#f59e0b", y.textContent = `🎥 ${m.name}`, h.title = s(`Currently animating camera: ${m.name}`)), h.append(y, document.createTextNode(` · ${o.length} key${o.length === 1 ? "" : "s"}`));
  ...
  if (u) {
    ...
    for (const y of e.state.cameras) {
      ...
      S.type = "button", S.className = y.id === e.state.active_camera_id ? "selected" : "";
      const x = document.createElement("i");
      x.className = "pi pi-video";
      const E = document.createElement("span");
      E.textContent = `${y.name} · ${y.keyframes.length} key${y.keyframes.length === 1 ? "" : "s"}${y.id === e.state.playblast_camera_id ? " · PLAYBLAST" : ""}`, S.append(x, E), S.addEventListener("click", () => {
  ...
  g && (g.textContent = m.name), Qn(e), Yn(e), ts(e), kr(e), nd(e), e.refreshCameraSelectors(), e.refreshKeyEditor(), e.updateEditState(), e.drawCurveEditor(), e.perf && (e.perf.timelineRefreshCount = (e.perf.timelineRefreshCount || 0) + 1), ld(e);
}
class ss {
...
async function Sr(e, { route: t, field: a = "file", file: o }) {
    ...
    <div class="oc-left-body oc-assets" data-role="agent-tab" hidden>
      <div class="oc-asset-panel" data-role="agent-panel">
        <p class="oc-asset-status hint" data-role="agent-hint">
          ${s("No planner is configured yet — provider wiring is a separate plan.")}
        </p>
        ...
        <div class="oc-asset-foot">
          <button type="button" class="oc-btn" data-agent-act="preview" disabled>${s("Preview")}</button>
...
function Td() {
  const e = Nc.map((t) => `<button data-lens="${t}">${t}mm</button>`).join("");
  return `
  ...
  return `
    <div class="oc-dope">
      <div class="oc-dope-body">
        <div class="oc-dope-labels">${Gn.map((t) => `
...
const Ze = 1, Jr = 50, D = Object.freeze({
...
}), ls = Object.freeze(Object.values(D)), xe = Object.freeze({
  SCENE_GET: "scene.get",
...
}), Jd = Object.freeze(Object.values(xe));
...
const Zd = 25, Zr = 100;
function ot(e, t) {
  const a = e?.offset === void 0 ? 0 : Number(e.offset), o = e?.limit === void 0 ? Zd : Number(e.limit);
  if (!Number.isInteger(a) || a < 0)
    throw new I(
      "BAD_QUERY",
      "offset must be a non-negative integer"
    );
  if (!Number.isInteger(o) || o < 1 || o > Zr)
    throw new I(
      "BAD_QUERY",
      `limit must be between 1 and ${Zr}`
    );
  return {
    offset: a,
    limit: o,
...
function tm(e, t) {
  ...
  switch (t?.type) {
    ...
    case xe.CAMERA_GET: {
      ...
      return we(e, { version: 1, type: t.type, camera: Be(r) });
    }
    case xe.CAMERA_LIST: {
      const o = a.cameras || [], { offset: r, limit: n, end: i } = ot(t, o.length);
      return we(e, {
        version: 1,
        type: t.type,
        items: o.slice(r, i).map(Qd),
        total: o.length,
        offset: r,
        limit: n
      });
    ...
    case xe.HEALTH_GET:
      return we(e, {
        version: 1,
        type: t.type,
        frames: ns(a.metadata, a.duration_frames)
      });
    case xe.ASSET_LIST: {
      ...
      return we(e, { version: 1, type: t.type, items: Be(r), total: r.length });
    }
    case xe.ASSET_GET: {
    ...
    case xe.OBJECT_LIST: {
      const o = a.objects || [], { offset: r, limit: n, end: i } = ot(t, o.length);
      return we(e, {
        version: 1,
        type: t.type,
        items: o.slice(r, i).map(Ko),
        total: o.length,
        offset: r,
        limit: n
      });
    ...
    case xe.OBJECT_SEARCH: {
      ...
      }, p = (a.objects || []).filter(l), { offset: m, limit: h, end: d } = ot(t, p.length);
      return we(e, {
        version: 1,
        type: t.type,
        items: p.slice(m, d).map(Ko),
        total: p.length,
        offset: m,
        limit: h
      });
    ...
    case xe.CHARACTER_LIST: {
      const o = (a.objects || []).filter((c) => c.asset_kind === "character"), { offset: r, limit: n, end: i } = ot(t, o.length);
      return we(e, {
        version: 1,
        type: t.type,
    ...
    case xe.SHOT_LIST: {
      ...
      })), { offset: i, limit: c, end: l } = ot(t, n.length);
      return we(e, {
        version: 1,
        type: t.type,
        items: n.slice(i, l),
    ...
    case xe.KEYFRAME_LIST: {
      ...
      if (!r) throw new I("UNKNOWN_CAMERA", `Unknown camera: ${o}`);
      const n = r.keyframes || [], { offset: i, limit: c, end: l } = ot(t, n.length);
      return we(e, {
        version: 1,
        type: t.type,
        cameraId: r.id,
...
function om(e, t) {
  e.cameras ||= [];
  const a = new Set(e.cameras.map((i) => i.id)), o = Mo(a, "camera", t.id), r = { ...fr(), ...t.camera || {} }, n = {
    id: o,
    name: t.name || o,
    color: "#4aa3ef",
    locked: !1,
...
function rm(e, t) {
  ...
  const o = new Set(e.cameras.map((i) => i.id)), r = Mo(o, "camera", t.id), n = JSON.parse(JSON.stringify(a));
...
function cm(e, t) {
  if (!ds.has(t.objectType))
    throw new I("UNSUPPORTED_OBJECT_TYPE", `object.create does not support type: ${t.objectType}`);
  e.objects ||= [];
  const a = new Set(e.objects.map((i) => i.id)), o = Mo(a, t.objectType, t.id), r = am(t.objectType), n = {
    id: o,
    type: t.objectType,
    name: t.name || o,
    ...r,
...
function lm(e, t) {
  ...
  const o = new Set(e.objects.map((l) => l.id)), r = Mo(o, a.type || "object", t.id), n = Array.isArray(t.offset) ? t.offset : [0.35, 0, 0.35], i = JSON.parse(JSON.stringify(a));
...
function bm(e, t) {
  ...
  switch (a) {
    ...
    case D.CAMERA_CREATE:
      ...
      if (e.interpolation !== void 0 && !uo.includes(e.interpolation))
    ...
    case D.OBJECT_CREATE:
      if (ee(e.objectType, "objectType", t), !ds.has(e.objectType))
    ...
    case D.CAMERA_TRANSFORM:
      if (e.cameraId !== void 0 && ee(e.cameraId, "cameraId", t), e.position !== void 0 && Ee(e.position, "position", t), e.target !== void 0 && Ee(e.target, "target", t), e.frame !== void 0 && Pe(e.frame, "frame", t), e.position === void 0 && e.target === void 0)
    ...
    case D.CHARACTER_SET_JOINT_ROTATION:
      if (ee(e.objectId, "objectId", t), ee(e.joint, "joint", t), !Array.isArray(e.rotation) || e.rotation.length !== 4 || !e.rotation.every(ct))
    ...
    case D.KEYFRAME_UPSERT:
      if (e.cameraId !== void 0 && ee(e.cameraId, "cameraId", t), Pe(e.frame, "frame", t), e.interpolation !== void 0 && !uo.includes(e.interpolation))
        throw new I("BAD_INTERPOLATION", `Unsupported interpolation: ${e.interpolation}`, t);
      if (e.camera !== void 0) {
    ...
    case D.KEYFRAME_REMOVE:
      e.cameraId !== void 0 && ee(e.cameraId, "cameraId", t), Pe(e.frame, "frame", t);
      break;
    case D.KEYFRAME_SET_INTERPOLATION:
      if (e.cameraId !== void 0 && ee(e.cameraId, "cameraId", t), Pe(e.frame, "frame", t), !uo.includes(e.interpolation))
        throw new I("BAD_INTERPOLATION", `Unsupported interpolation: ${e.interpolation}`, t);
      break;
    case D.TIMELINE_SET_RANGE:
      if (Pe(e.start, "start", t), Pe(e.end, "end", t), e.end < e.start)
    ...
    case D.TIMELINE_SET_DURATION:
      ...
      break;
    case D.CUT_UPSERT:
      Pe(e.start, "start", t), ee(e.cameraId, "cameraId", t);
      break;
    case D.CUT_REMOVE:
      Pe(e.start, "start", t);
      break;
...
function gm(e, t) {
  ...
  if (t.operations.length > Jr)
    throw new I(
      "TOO_MANY_OPERATIONS",
      `transaction has ${t.operations.length} operations (max ${Jr})`
    );
  return t.operations.forEach((o, r) => bm(o, r)), {
    version: Ze,
    id: t.id,
...
const vm = "omnicam/library", xm = "majoor_omnicam/blockout_library", wm = Object.freeze({
...
function ms(e) {
  return e.file ? `${e.source === "legacy" ? xm : vm}/${e.file} [input]` : "";
}
function Qr(e, t, a) {
  const o = e || "asset";
  let r = `${o}_${a}`, n = 2;
...
function jm(e, t = {}) {
  ...
  const a = km(t.point, [0, 0, 0]), o = String(t.idSeed || Date.now().toString(36)), r = String(e.kind || "prop"), n = r === "character", i = wm[e.id];
  if (r === "helper" && !e.file && i && i !== "null")
    return {
      id: Qr(i, t.existingIds, o),
      type: i,
      name: e.name || i,
      position: a,
      rotation: [0, 0, 0],
  ...
  const c = {
    id: Qr(r === "character" ? "character" : r, t.existingIds, o),
    type: "glb",
  ...
  return n && (c.character = Sm(e)), c;
}
function _m({ groundHit: e, orbitTarget: t } = {}) {
...
const Cm = {
  [D.ASSET_INSTANTIATE](e, t) {
    ...
    let o;
    try {
      o = jm(t.asset, { point: t.point, idSeed: t.id, existingIds: a });
    } catch (r) {
  ...
  [D.CAMERA_SET_ACTIVE](e, t) {
    return Qo(e, t.cameraId), e.active_camera_id = t.cameraId, { dirtyMask: _.viewport | _.previews | _.inspector | _.outliner | _.timeline };
  },
  [D.CAMERA_SET_LOCKED](e, t) {
    return Qo(e, t.cameraId).locked = t.value, { dirtyMask: _.outliner | _.inspector | _.viewport };
  },
  [D.CAMERA_CREATE](e, t) {
    const a = om(e, t);
  ...
  [D.CAMERA_TRANSFORM](e, t) {
    const a = Mt(e, t.cameraId), o = en(a);
  ...
  [D.CAMERA_LOOK_AT](e, t) {
    ...
    if (t.objectId !== void 0 && (t.objectId === null || t.objectId === "" ? (a.target_object_id = null, a.id === e.active_camera_id && (e.target_object_id = null)) : (er(e, t.objectId), a.target_object_id = t.objectId, a.id === e.active_camera_id && (e.target_object_id = t.objectId))), t.point) {
      const o = en(a);
      o.target = [...t.point];
  ...
  [D.OBJECT_SET_ENABLED](e, t) {
    return It(e, t.objectId).enabled = t.value, { dirtyMask: _.viewport | _.previews | _.outliner | _.inspector };
  },
  [D.OBJECT_SET_LOCKED](e, t) {
    return er(e, t.objectId).locked = t.value, { dirtyMask: _.outliner | _.inspector };
  },
  [D.OBJECT_SET_TAGS](e, t) {
    const a = It(e, t.objectId), o = ai(t.tags), r = o.length !== t.tags.length ? "some tags were dropped or normalised" : void 0;
    return o.length ? a.tags = o : delete a.tags, { dirtyMask: _.outliner | _.inspector | _.viewport, warning: r };
  },
  [D.OBJECT_SET_ANNOTATION](e, t) {
    const a = It(e, t.objectId), o = t.annotation === null ? null : On(t.annotation);
    if (t.annotation && !o)
  ...
  [D.CHARACTER_SET_POSE](e, t) {
    ...
    return a.character = {
      ...a.character || {},
      pose: t.pose === null ? vo(null) : vo(t.pose)
  ...
  [D.CHARACTER_SET_JOINT_ROTATION](e, t) {
    ...
    return a.character = {
      ...a.character || {},
      pose: ti(a.character?.pose, t.joint, t.rotation)
    }, { dirtyMask: _.viewport | _.previews | _.inspector };
  },
  [D.CHARACTER_SET_MOTION](e, t) {
    const a = oo(e, t.objectId), o = hr(t.motion);
  ...
  [D.KEYFRAME_SET_INTERPOLATION](e, t) {
    const a = Mt(e, t.cameraId), o = ro(a, t.frame);
    if (!o) throw new I("UNKNOWN_KEYFRAME", `camera has no key at frame ${t.frame}`);
    if (!uo.includes(t.interpolation))
...
function Em({ state: e, operation: t }) {
  const a = Cm[t.type];
...
function tr(e, t) {
  ...
  if (Array.isArray(e) || Array.isArray(t))
    return !Array.isArray(e) || !Array.isArray(t) || e.length !== t.length ? !1 : e.every((a, o) => tr(a, t[o]));
  if (e && t && typeof e == "object") {
    const a = /* @__PURE__ */ new Set([...Object.keys(e), ...Object.keys(t)]);
    for (const o of a) if (!tr(e[o], t[o])) return !1;
    return !0;
  }
  return !1;
}
...
function $m(e, t) {
  ...
  return Tm(e, t, r), Im(e, t, r), Om(e, t, r), Pm(e, t, r), { changes: a, truncated: o };
}
const Mm = ["fov", "roll", "zoom", "near", "far", "camera_type"];
function Tm(e, t, a) {
  const o = wo(e?.cameras), r = wo(t?.cameras);
...
function Im(e, t, a) {
  const o = wo(e?.objects), r = wo(t?.objects);
  for (const [n] of o)
  ...
  for (const [n, i] of r) {
    ...
    a(n, "pose_preset", l, p);
    const m = c.character?.motion?.clip_id ?? null, h = i.character?.motion?.clip_id ?? null;
    a(n, "motion_clip_id", m, h);
  }
}
function Om(e, t, a) {
...
function Rm(e, t) {
  ...
  try {
    ...
    if (p instanceof I) return Do(e, t?.id, p);
    throw p;
  }
  const o = ar(e);
  ...
  for (let p = 0; p < a.operations.length; p += 1)
    try {
      const m = Em({ ui: e, state: r, operation: a.operations[p] });
      n |= m?.dirtyMask || 0, m?.warning && i.push(m.warning), m?.outcome && c.push({ index: p, ...m.outcome });
    } catch (m) {
      if (m instanceof I)
        return (m.operationIndex === null || m.operationIndex === void 0) && (m.operationIndex = p), Do(e, a.id, m);
      throw m;
    }
  if (a.validateOnly) {
    const { changes: p, truncated: m } = $m(e.state, r);
    return {
      ok: !0,
      version: Ze,
      revision: o,
  ...
  e.checkpoint?.(a.description), e.state = ur(r);
  const l = Fm(e);
  return (e._directorApiTxIds ||= /* @__PURE__ */ new Set()).add(a.id), e.serialize?.(), zm(e, l), Nm(e, n, `director-api:${a.id}`), {
    ok: !0,
    version: Ze,
    baseRevision: o,
    revision: ar(e),
...
function Dm(e) {
  return e.directorApi = Km(e), e.directorApi;
}
const tn = "omnicam-agent/1", an = "majoor.omnicam.agent.request", Bm = 1, no = Object.freeze({
...
function Wm(e, t, a) {
  ...
  async function d() {
    ...
    try {
      const x = await so(a, no.register, {
        protocol: tn,
        client_id: S,
        node_id: String(t.id),
      ...
      if (o || y !== p) return;
      r = x.session_id, n = x.session_token, i = S, u();
    } catch {
      if (o || y !== p) return;
      f();
    }
  ...
  async function b() {
    if (!(o || !r))
      try {
        ...
        if (o) return;
        (y?.code === "UNKNOWN_SESSION" || y?.code === "BAD_SESSION_TOKEN") && (h(), d());
      }
  }
  async function v(y) {
    const S = y?.detail;
    if (o || !S || S.protocol !== tn || Number(S.schema_version) !== Bm || S.session_id !== r || String(S.node_id) !== String(t.id)) return;
    let x;
    try {
      if (S.kind === "query")
        x = e.directorApi.query(S.payload);
      else if (S.kind === "transaction") {
        const E = S.payload;
        !Number.isInteger(E?.baseRevision) || E.baseRevision < 0 ? x = Bo(
          e,
          "BASE_REVISION_REQUIRED",
          "External Agent transactions require baseRevision"
        ) : x = e.directorApi.execute(E);
      } else
        x = Bo(e, "UNKNOWN_AGENT_REQUEST", `Unsupported Agent request kind: ${S.kind}`);
    } catch (E) {
      x = Bo(e, E?.code || "INTERNAL", E?.message || "OmniCam Agent request failed");
    }
    try {
      await so(a, no.reply, {
        session_id: r,
  ...
  return a.addEventListener?.(an, v), a.addEventListener?.("status", g), d(), {
    get sessionId() {
      return r;
    },
    dispose() {
      if (o) return;
      o = !0, clearInterval(c), clearTimeout(l), a.removeEventListener?.(an, v), a.removeEventListener?.("status", g);
      const y = r, S = n;
      r = null, n = null, y && S && so(a, no.close, {
        session_id: y,
        session_token: S
      }).catch(() => {
      });
...
function jr({ fetchApi: e = Vm } = {}) {
  const t = (a, o) => Promise.resolve(e(a, o)).then(Hm);
  return {
    list(a = {}) {
      const { kind: o, tag: r, search: n, offset: i, limit: c } = a, l = { tag: r, search: n, offset: i, limit: c };
      return o && o !== "all" && (l.kind = o), t(`${$e}${on(l)}`);
    },
    get(a) {
    ...
    importModel(a, o = {}) {
      const r = new FormData();
      return r.append("file", a, o.filename || a.name || "model.glb"), t(`${$e}/import${on(o)}`, { method: "POST", body: r });
    },
...
const ps = Object.freeze(["all", "character", "prop", "environment", "vehicle"]);
function rn(e = {}) {
  const t = String(e.kind || "all").toLowerCase();
  return {
    kind: ps.includes(t) ? t : "all",
...
function Ym(e) {
  ...
  return {
    ...
    setFilter(i) {
      return a.filter = rn({ ...a.filter, ...i }), a.offset = 0, this.refresh();
    },
    refresh() {
      return n(async () => {
...
const Zm = 256;
function nn(e = {}) {
  const { THREE: t, GLTFLoader: a, FBXLoader: o, size: r = Zm } = e;
  if (!t || !a)
  ...
  const l = () => {
    ...
    if (d.isEmpty()) return;
    const f = d.getCenter(new t.Vector3()), u = d.getSize(new t.Vector3()), v = Math.max(u.length() / 2, 1e-3) / Math.sin(c.fov * Math.PI / 360);
    c.position.set(f.x + v * 0.7, f.y + v * 0.55, f.z + v), c.near = v / 100, c.far = v * 10, c.updateProjectionMatrix(), c.lookAt(f);
    ...
    async render(h, d = "glb") {
      ...
      try {
        ...
        return i.remove(f), f.traverse?.((b) => {
          b.geometry?.dispose?.();
          const v = b.material;
          Array.isArray(v) ? v.forEach((g) => g.dispose?.()) : v?.dispose?.();
        }), u;
      } catch {
        return null;
      }
...
function op(e, t = {}) {
  return ps.map((a) => {
    const o = s(ap[a] || a), r = a === "all" ? "" : ` <span class="oc-asset-kind-n">${Number(t[a] || 0)}</span>`;
    return `<button type="button" class="oc-asset-kind${a === (e || "all") ? " active" : ""}" data-asset-kind="${a}">${lt(o)}${r}</button>`;
  }).join("");
}
function rp(e, { selected: t = !1, thumbUrl: a = "" } = {}) {
  const o = tp[e.kind] || "pi-box", r = e.kind === "character" && Pn(e.rig) === "rigged" ? `<span class="oc-asset-badge">${s("RIGGED")}</span>` : "", n = a ? `<img class="oc-asset-thumb" src="${lt(a)}" alt="" loading="lazy">` : `<span class="oc-asset-thumb oc-asset-thumb--glyph"><i class="pi ${o}"></i></span>`;
  return `<button type="button" class="oc-asset-card${t ? " selected" : ""}" data-asset-id="${lt(e.id)}" title="${lt(e.name)}">
    ${n}
    <span class="oc-asset-name">${lt(e.name)}</span>
    <span class="oc-asset-kind-tag">${lt((e.kind || "").toUpperCase())}</span>
    ${r}
  </button>`;
}
function np(e, { selectedId: t = "", thumbUrls: a = {} } = {}) {
  return !e || !e.length ? `<p class="oc-asset-empty">${s("No assets match this filter.")}</p>` : e.map((o) => rp(o, {
    selected: o.id === t,
    thumbUrl: a[o.id] || ""
  })).join("");
}
...
function sp(e, t = {}) {
  const a = e.root, o = t.fetchApi || ((z, K) => (e.api || e.app?.api).fetchApi(z, K)), r = t.apiClient || jr({ fetchApi: o }), n = t.store || Ym(r), i = Xm(), c = t.previewQueue || Jm(), l = e.api || e.app?.api || null;
  let p = t.thumbnailRenderer || null, m = null;
  const h = /* @__PURE__ */ new Set();
  function d() {
    return p ? Promise.resolve(p) : (m || (m = Qm().then((z) => p = nn(z)).catch(() => p = nn({}))), m);
  }
  function f(z) {
    return zr(l, ms(z));
  }
  function u(z) {
    return z.thumbnail ? zr(l, `omnicam/library/${z.thumbnail} [input]`) : "";
  }
  function b() {
    for (const z of n.state.items) {
      if (z.kind === "helper" || !z.file || i.get(z.id) || z.thumbnail || h.has(z.id)) continue;
      const K = f(z);
      K && c.enqueue(z.id, async () => {
        const ce = await (await d()).render(K, z.format || "glb");
        if (!ce) {
          h.add(z.id);
          return;
        }
        if (i.set(z.id, ce), $(), !(z.source && z.source !== "user"))
          try {
            const ne = await r.uploadThumbnail(z.id, ep(ce));
            ne?.asset && n.upsert(ne.asset);
          } catch {
          }
      });
    }
  }
  const v = (z) => a.querySelector(`[data-role="${z}"]`), g = v("assets-panel"), y = v("asset-grid"), S = v("asset-kinds"), x = v("asset-search"), E = v("asset-status"), M = v("asset-import-file"), R = v("scene-tab"), L = v("assets-tab"), X = v("agent-tab"), W = { assets: L, agent: X };
  let V = "", se = null, j = !0, F = 0;
  function B(z, { sticky: K = !1 } = {}) {
    E && (!K && F > Date.now() || (E.textContent = z || "", F = K ? Date.now() + 9e3 : 0));
  }
  function G(z) {
    if (V = z, !!y)
      for (const K of y.querySelectorAll(".oc-asset-card"))
        K.classList.toggle("selected", K.dataset.assetId === z);
  }
  let te = !1;
  function $() {
    if (S && (S.innerHTML = op(n.state.filter.kind, n.state.kinds)), y) {
      const z = {};
      for (const K of n.state.items) {
        const re = i.get(K.id) || u(K);
        re && (z[K.id] = re);
      }
      y.innerHTML = np(n.state.items, { selectedId: V, thumbUrls: z });
    }
    if (!te) {
      te = !0;
      try {
    ...
    n.state.error ? B(n.state.error.message) : n.state.loading ? B(s("Loading assets...")) : B(s("{n} of {total} assets").replace("{n}", n.state.items.length).replace("{total}", n.state.total));
  }
  function H(z) {
    if (!z) return;
    const K = _m({
    ...
    }), re = e.directorApi?.execute({
      version: 1,
      id: `tx_instantiate_${Date.now().toString(36)}`,
      description: s("Add asset"),
      operations: [{ type: "asset.instantiate", asset: z, point: K }]
    });
    if (!re?.ok) {
      e.setStatus?.(re?.error?.message || s("Could not add the asset"));
      return;
    }
    const ce = re.outcomes?.[0]?.objectId;
    ce && (e.selectedEntity = "object", e.selectedObjectId = ce, e.selectedObjectIds = /* @__PURE__ */ new Set([ce]), e.selectedKeyFrame = null), e.restoreAssets?.(), e.refreshObjects?.(), e.refreshInspector?.(), e.render?.(), e.setStatus?.(s("{name} added").replace("{name}", z.name));
  }
  async function P(z) {
    if (z) {
      B(s("Importing {name}...").replace("{name}", z.name));
      try {
        const K = await r.importModel(z, { kind: "prop", name: z.name.replace(/\.[^.]+$/, "") });
        K.asset && n.upsert(K.asset), B(s("Imported {name}").replace("{name}", K.asset?.name || z.name));
      } catch (K) {
        B(K.message || s("Import failed"));
      }
    }
  }
  const U = v("asset-local-form"), J = v("asset-local-folder"), de = v("asset-local-note");
  function me() {
    U && (U.hidden = !U.hidden, U.hidden || J?.focus());
  }
  async function ae(z) {
    const K = (J?.value || "").trim();
    if (!K) {
      B(s("Point to the folder you extracted the pack into."), { sticky: !0 });
      return;
    }
    F = 0, B(z ? s("Scanning {folder}...").replace("{folder}", K) : s("Installing characters from {folder}...").replace("{folder}", K));
    try {
      const re = await r.importLocalCharacters({
        folder: K,
        licenseNote: (de?.value || "").trim(),
        dryRun: z
      }), ce = (re.skipped || []).length;
      if (z) {
        const Te = (re.candidates || []).map((et) => et.name).join(", ");
        B(
          (re.candidates || []).length ? s("{n} rig-complete character(s): {names}").replace("{n}", re.candidates.length).replace("{names}", Te) : s("No rig-complete .glb/.fbx character found ({n} skipped)").replace("{n}", ce),
          { sticky: !0 }
        );
        return;
      }
      const ne = (re.installed || []).filter((Te) => Te.status !== "conflict").length, ke = (re.installed || []).filter((Te) => Te.status === "conflict").length;
      B(
        s("{n} character(s) installed{extra} — no restart needed").replace("{n}", ne).replace("{extra}", ce || ke ? ` (${ce} ${s("skipped")}${ke ? `, ${ke} ${s("unchanged")}` : ""})` : ""),
        { sticky: !0 }
      ), ne && (n.refresh(), U && (U.hidden = !0));
    } catch (re) {
      B(re.message || s("Import failed"), { sticky: !0 });
    }
  }
  function pe(z) {
    R && (R.hidden = z !== "scene");
    for (const [K, re] of Object.entries(W))
      re && (re.hidden = K !== z);
    for (const K of a.querySelectorAll("[data-asset-view]"))
      K.classList.toggle("active", K.dataset.assetView === z);
    z === "assets" && j && (j = !1, n.refresh());
  }
  function fe(z) {
    const K = sn(z.target);
    if (K) {
      if (K.action === "switch-view") return pe(K.view);
      if (K.action === "filter-kind") return void n.setFilter({ kind: K.kind });
      if (K.action === "asset-add")
        return H(n.get(V));
      if (K.action === "asset-import")
        return M?.click();
      if (K.action === "local-toggle") return me();
      if (K.action === "local-scan") return void ae(!0);
      if (K.action === "local-install") return void ae(!1);
      K.action === "card" && G(K.assetId);
    }
  }
  function ue(z) {
    const K = sn(z.target);
    K?.action === "card" && H(n.get(K.assetId));
  }
  function ve() {
    clearTimeout(se), se = setTimeout(() => n.setFilter({ search: x.value }), 200);
  }
  function ge(z) {
    const K = z.target.files?.[0];
    z.target.value = "", P(K);
  }
  const ye = n.subscribe($);
  return g?.addEventListener("click", fe), g?.addEventListener("dblclick", ue), a.querySelector('[data-role="left-tabs"]')?.addEventListener("click", fe), x?.addEventListener("input", ve), M?.addEventListener("change", ge), $(), {
    store: n,
    switchView: pe,
    refresh: () => n.refresh(),
    dispose() {
      ye(), clearTimeout(se), g?.removeEventListener("click", fe), g?.removeEventListener("dblclick", ue), a.querySelector('[data-role="left-tabs"]')?.removeEventListener("click", fe), x?.removeEventListener("input", ve), M?.removeEventListener("change", ge), c.clear(), p?.dispose?.(), i.clear();
    }
  };
}
function ip(e, t = {}) {
  ...
  const r = [];
  let n = Yo(e.state?.metadata?.viewport_labels);
  function i(m) {
    if (!r[m]) {
  ...
  function l() {
    ...
    let b = 0;
    for (const v of u) {
      if (!Ln(v, { mode: n.mode, selectedIds: d })) continue;
      const g = Fn(v, n.content);
      if (!g) continue;
      const y = zn(u, v, f) || {
        position: v.position,
        size: v.size
      }, S = e.webgl.projectWorldToScreen(Nn(y, v.type));
      ...
      const E = n.content === "annotation" ? v.annotation?.color : "";
  ...
  function p(m) {
    n = Yo({ ...n, ...m }), e.state.metadata = { ...e.state.metadata || {}, viewport_labels: { ...n } }, e.serialize?.(), l();
  }
  return l(), {
    update: l,
    get settings() {
...
function cp(e) {
  ...
  return {
    ...
    getRigInfo(a) {
      const o = e.state?.objects?.find((i) => i.id === a) || null, r = t(a), n = Xo(r);
      return {
        objectId: a,
...
function lp(e, t) {
  const a = (o) => [`<option value="">${s("— unmapped —")}</option>`].concat(
    e.map(
      (r) => `<option value="${cn(r)}"${r === o ? " selected" : ""}>${cn(r)}</option>`
    )
  ).join("");
  return Rn.map((o) => {
...
function dp(e, t = {}) {
  const a = e.root, o = t.apiClient || jr({
    fetchApi: (g, y) => (e.api || e.app?.api).fetchApi(g, y)
  ...
  function h() {
    if (!i) return;
    const g = Nr(l);
    zo(l) ? (i.textContent = s("Humanoid v1 ✓ — all 22 joints mapped"), i.dataset.state = "ok") : (i.textContent = s("Incomplete — {n} joint(s) unmapped").replace("{n}", g.length), i.dataset.state = "warn");
  }
  function d() {
    n && (n.innerHTML = lp(m(), l)), h();
  }
  function f() {
    const g = e.selectedObject?.(), y = g?.asset_kind === "character";
    if (r.hidden = !y, !y) {
      c = null;
      return;
    }
  ...
  function u(g) {
    const y = g.target.closest("[data-rig-joint]");
    if (!y) return;
    const S = y.dataset.rigJoint;
    y.value ? l[S] = y.value : delete l[S], d();
  }
  function b(g) {
    const y = g.target.closest("[data-rig-act]")?.dataset.rigAct;
    y === "auto" ? (l = Xo(m()), d()) : y === "validate" ? (d(), e.setStatus?.(zo(l) ? s("Rig is complete") : s("Rig still missing: {list}").replace("{list}", Nr(l).join(", ")))) : y === "save" && v();
  }
  async function v() {
    const g = p();
    if (!g?.asset_id) {
    ...
    try {
      const y = await o.patch(g.asset_id, {
        rig: { profile: Rr, bone_map: l }
      });
      g.character = {
        ...g.character || {},
        rig_profile: zo(l) ? Rr : null
      }, e.assetBrowser?.store?.upsert?.(y.asset), e.checkpoint?.("Save rig mapping"), e.serialize?.(), e.refreshObjects?.(), e.refreshInspector?.(), e.setStatus?.(s("Rig mapping saved"));
    } catch (y) {
      e.setStatus?.(y.message || s("Could not save the rig mapping"));
    }
  }
...
function mp(e, t = {}) {
  ...
  function i() {
    ...
    for (const f of Rn) {
      ...
      const g = n(f);
      g.hidden = !1, g.classList.toggle("selected", f === m), g.style.transform = `translate(-50%, -50%) translate(${Math.round(v.x)}px, ${Math.round(v.y)}px)`, d.add(f);
    }
...
function fp(e, t = {}) {
  ...
  function S() {
    ...
    l && (l.textContent = j);
    const B = f(), G = g(B?.character)[j] || [0, 0, 0, 1], te = ni(G);
    p.forEach(($, H) => {
      $ && document.activeElement !== $ && ($.value = String(Math.round(te[H] * 100) / 100));
    });
  }
  function x() {
    ...
    if (i && (i.classList.toggle("active", h), i.disabled = F, i.title = F ? s("Clear the motion clip to edit the pose") : s("Toggle FK pose editing")), n) {
      const B = [["neutral", s("Standing Neutral")]].concat([...d.values()].filter((te) => te.id !== "neutral").map((te) => [te.id, te.name || te.id])), G = B.map((te) => te.join(":")).join("|");
      n.dataset.sig !== G && (n.dataset.sig = G, n.replaceChildren(...B.map(([te, $]) => {
        const H = document.createElement("option");
        return H.value = te, H.textContent = $, H;
  ...
  async function E() {
    try {
      ...
      d = new Map((j.poses || []).filter((F) => F?.id).map((F) => [F.id, v(F)]));
    } catch {
      d = /* @__PURE__ */ new Map();
    }
    d.has("neutral") || d.set("neutral", v({ id: "neutral", name: "Standing Neutral" })), x();
  }
  function M() {
    const j = b();
    if (!j) return;
    const F = p.map((te) => Number(te?.value) || 0), B = oi(F), G = e.directorApi?.execute({
      version: 1,
  ...
  function R() {
    const j = n?.value || "neutral", F = d.get(j) || vo({ preset_id: j });
  ...
  async function L() {
    ...
    const F = (await Rt(e, s("Save Pose"), s("Pose name"), ""))?.trim();
    if (!F || e.disposed) return;
    const B = F.toLowerCase().replace(pp, "-").replace(/^-+|-+$/g, "").slice(0, 60) || "pose";
    try {
      ...
      d.set(G.pose.id, v(G.pose)), e.setStatus?.(s("Pose saved: {name}").replace("{name}", F)), x();
    } catch (G) {
  ...
  n?.addEventListener("change", R), i?.addEventListener("click", X), r.querySelector('[data-pose-act="save"]')?.addEventListener("click", L);
  for (const j of p)
  ...
  return E(), {
    ...
    dispose() {
      V.dispose(), n?.removeEventListener("change", R), i?.removeEventListener("click", X);
      for (const j of p)
...
function hp(e) {
  ...
  function f() {
    const g = d(), y = g ? { type: "character.set_motion", objectId: p, motion: g } : { type: "character.clear_motion", objectId: p }, S = e.directorApi?.execute({
      version: 1,
  ...
  function u() {
    const g = m(), y = h(), S = g?.character?.motion || null;
    if (o) {
      const E = y.join("|");
      o.dataset.sig !== E && (o.dataset.sig = E, o.replaceChildren(
        ln("", y.length ? s("No motion (static)") : s("No clips in this model")),
        ...y.map((M) => ln(M, M))
      )), document.activeElement !== o && (o.value = S?.clip_id || ""), o.disabled = !y.length;
    }
    qo(r, S?.start_frame ?? 0), qo(n, S?.end_frame ?? 0), qo(i, S?.speed ?? 1), c && document.activeElement !== c && (c.checked = S ? S.loop !== !1 : !0);
    const x = !!S;
    for (const E of [r, n, i, c]) E && (E.disabled = !x);
    l && (l.disabled = !x);
  }
  function b() {
    const g = m(), y = e.rigMapper?.boneMap;
    if (!g?.character || !y || !Object.keys(y).length) {
      e.setStatus?.(s("Map the rig before baking a pose"));
      return;
    }
    const S = e.characterRuntime?.sampleCanonicalPose?.(p, y) || {};
    e.directorApi?.execute({
      version: 1,
...
function fs(e) {
  return {
    ...
    frames: Le(e, "frame"),
    scrubs: Le(e, "scrub"),
    cameraFov: Le(e, "camera-fov"),
    cameraRoll: Le(e, "camera-roll"),
    cameraFocal: Le(e, "camera-focal"),
    viewportZoom: Le(e, "viewport-zoom"),
    cameraType: Le(e, "camera-type"),
    cameraNear: Le(e, "camera-near"),
    cameraFar: Le(e, "camera-far")
  };
}
function up(e, t) {
  e.checkpoint(`Apply preset: ${t}`);
  const a = e.activeCameraTrack(), o = kl(t, {
...
function bp(e, t) {
  ...
  const o = wl(a, { type: t, intensity: 1, duration_frames: e.state.duration_frames });
...
const dn = ["#4aa3ef", "#f2a93b", "#48c774", "#b565d8", "#ec4899"], Ue = [4, 8, 12, 20, 35, 60, 100];
function ft(e) {
...
function To(e, t, a) {
  ...
  const o = ft(e), r = o.expanded ? 220 : 138, n = Math.min(r, Math.max(80, Math.min(t, a) - 20)), i = 10, c = Math.max(0, t - n - i), l = Math.max(0, a - n - i), p = e.viewportCamera(), m = p?.position || [0, 1.5, 5], h = p?.target || [0, 0, 0], d = e.activeCameraTrack?.(), f = e.state.cameras?.length ? e.state.cameras : d ? [d] : [], u = f.flatMap(
    (E) => (E.keyframes || []).map((M) => M.camera?.position).filter(Boolean)
  );
  let b = 12;
  if (o.rangeIndex >= 0 && o.rangeIndex < Ue.length)
    b = Ue[o.rangeIndex];
  else {
    const E = Math.max(
      Math.abs(m[0] || 0),
  ...
  const v = c + n / 2, g = l + n / 2, y = n / 2 - 12, S = y / b, x = o.centerMode === "camera" ? [m[0] || 0, m[2] || 0] : [0, 0];
  return {
    rx: c,
    ry: l,
    radarSize: n,
...
function wp(e, t, a, o) {
  const r = To(e, a, o);
  if (!r) return;
  const { rx: n, ry: i, radarSize: c, cx: l, cy: p, innerRadius: m, range: h, scale: d, camPos: f, camTgt: u, cameras: b, activeTrack: v } = r, g = ft(e), y = e.state.active_camera_id || v?.id, S = (ae, pe) => hs(r, ae, pe);
  ...
  for (const ae of E) {
    const pe = m * ae;
    t.beginPath(), t.arc(l, p, pe, 0, Math.PI * 2), t.stroke(), c >= 120 && (t.font = "8px monospace", t.fillStyle = "rgba(0, 210, 211, 0.35)", t.textAlign = "left", t.fillText(`${Math.round(h * ae)}m`, l + pe + 2, p - 2));
  }
  ...
  for (const ae of e.state.objects || []) {
    ...
    const pe = br(e.state.objects, ae).position || [0, 0, 0], [fe, ue] = S(pe[0], pe[2]);
    if (fe < n + 3 || fe > n + c - 3 || ue < i + 3 || ue > i + c - 3) continue;
    const ve = e.selectedObjectId === ae.id || e.selectedObjectIds?.has?.(ae.id);
    if (t.save(), t.translate(fe, ue), ae.type === "card") {
      const ge = (ae.rotation?.[1] || 0) * Math.PI / 180;
      t.rotate(-ge), t.fillStyle = ve ? "#a855f7" : "#38bdf8", t.fillRect(-4, -1.2, 8, 2.4), t.strokeStyle = ve ? "#ffffff" : "rgba(255,255,255,0.6)", t.lineWidth = 1, t.strokeRect(-4, -1.2, 8, 2.4);
      ...
      for (let ge = 0; ge < 4; ge++) {
        const ye = ge * Math.PI / 2;
        t.beginPath(), t.moveTo(Math.cos(ye) * 4, Math.sin(ye) * 4), t.lineTo(Math.cos(ye) * 6, Math.sin(ye) * 6), t.stroke();
      }
    } else
      t.fillStyle = ve ? "#a855f7" : ae.type === "human" ? "#ec4899" : "#f59e0b", t.beginPath(), t.arc(0, 0, 2.8, 0, Math.PI * 2), t.fill();
  ...
  for (let ae = 0; ae < b.length; ae++) {
    const pe = b[ae], fe = pe.keyframes || [], ue = pe.id === y, ve = pe.color || dn[ae % dn.length];
    t.save(), t.strokeStyle = ve, t.globalAlpha = ue ? 0.95 : 0.4, t.lineWidth = ue ? 2 : 1, t.setLineDash(ue ? [] : [2, 2]), t.beginPath();
    let ge = !1;
    const ye = fe[0]?.frame, z = fe[fe.length - 1]?.frame;
    for (let K = ye; Number.isFinite(K) && K <= z; K++) {
      const re = Ce(pe, K, e.state.objects)?.position;
      if (!Array.isArray(re)) continue;
      const [ce, ne] = S(re[0], re[2]);
      ge ? t.lineTo(ce, ne) : (t.moveTo(ce, ne), ge = !0);
    }
    ge && t.stroke(), t.restore(), t.save();
    for (const K of fe) {
      const re = K.camera?.position;
      if (!re) continue;
      const [ce, ne] = S(re[0], re[2]);
      if (ce < n + 4 || ce > n + c - 4 || ne < i + 4 || ne > i + c - 4) continue;
      const ke = K.frame === e.frame && ue;
      t.fillStyle = ke ? "#ffffff" : ve, t.globalAlpha = ue ? 0.95 : 0.6, t.beginPath(), t.moveTo(ce, ne - 3), t.lineTo(ce + 3, ne), t.lineTo(ce, ne + 3), t.lineTo(ce - 3, ne), t.closePath(), t.fill(), ke && (t.strokeStyle = "#00d2d3", t.lineWidth = 1.2, t.stroke());
    }
    t.restore();
  }
  const [M, R] = S(f[0] || 0, f[2] || 0), [L, X] = S(u[0] || 0, u[2] || 0), W = 8, V = Y(M, n + W, n + c - W), se = Y(R, i + W, i + c - W), j = Y(L, n + W, n + c - W), F = Y(X, i + W, i + c - W), B = f[1] || 0, G = vp(B), te = xp(B);
  t.strokeStyle = "rgba(255, 255, 255, 0.40)", t.lineWidth = 1, t.setLineDash([3, 3]), t.beginPath(), t.moveTo(V, se), t.lineTo(j, F), t.stroke(), t.setLineDash([]), t.fillStyle = "#ffffff", t.beginPath(), t.arc(j, F, 2.5, 0, Math.PI * 2), t.fill(), t.strokeStyle = "rgba(255, 255, 255, 0.7)", t.lineWidth = 1, t.beginPath(), t.arc(j, F, 4.5, 0, Math.PI * 2), t.stroke();
  const $ = u[0] - f[0], H = u[2] - f[2], P = Math.atan2(H, $), J = (e.viewportCamera().fov || 35) * Math.PI / 360, de = Y(24 * (d / (m / 8)), 16, 38), me = t.createRadialGradient(V, se, 2, V, se, de);
  me.addColorStop(0, G + "55"), me.addColorStop(1, G + "08"), t.fillStyle = me, t.strokeStyle = G, t.lineWidth = 1.2, t.beginPath(), t.moveTo(V, se), t.lineTo(V + Math.cos(P - J) * de, se + Math.sin(P - J) * de), t.arc(V, se, de, P - J, P + J), t.closePath(), t.fill(), t.stroke(), t.fillStyle = G + "44", t.beginPath(), t.arc(V, se, 6.5, 0, Math.PI * 2), t.fill(), t.fillStyle = G, t.beginPath(), t.arc(V, se, 3.5, 0, Math.PI * 2), t.fill(), t.strokeStyle = "#ffffff", t.lineWidth = 1.5, t.beginPath(), t.moveTo(V, se), t.lineTo(V + Math.cos(P) * 7, se + Math.sin(P) * 7), t.stroke(), kp(e, t, r, G, te, P, Math.hypot($, H)), g.hover && Sp(t, r, g.hover), t.restore();
}
function kp(e, t, a, o, r, n, i) {
  const { rx: c, ry: l, radarSize: p } = a, m = ft(e);
  ...
  const h = l + 3, d = 12;
  io(t, c + 44, h, 12, d, "−", m.hover?.button === "zoom_out"), io(t, c + 58, h, 12, d, "+", m.hover?.button === "zoom_in");
  const f = m.centerMode === "camera" ? "CAM" : "CTR";
  io(t, c + 72, h, 22, d, f, m.hover?.button === "center");
  const u = m.expanded ? "⤡" : "⤢";
  io(t, c + 96, h, 14, d, u, m.hover?.button === "size"), t.font = "bold 8.5px monospace", t.fillStyle = o, t.textAlign = "right", t.fillText(`Y:${r}`, c + p - 5, l + 9), t.fillStyle = "rgba(15, 23, 42, 0.70)", t.fillRect(c, l + p - 15, p, 15), t.strokeStyle = "rgba(0, 210, 211, 0.15)", t.beginPath(), t.moveTo(c, l + p - 15), t.lineTo(c + p, l + p - 15), t.stroke();
...
function bs(e, t, a, o) {
  const { camPos: r, camTgt: n, cameras: i, rx: c, ry: l, radarSize: p } = t, m = (v, g) => hs(t, v, g), [h, d] = m(r[0] || 0, r[2] || 0);
  ...
  if (b)
    for (const v of b.keyframes || []) {
      const g = v.camera?.position;
      if (!g) continue;
      const [y, S] = m(g[0], g[2]);
      if (Math.hypot(a - y, o - S) <= 6)
        return { type: "keyframe", key: v, frame: v.frame };
    }
  for (const v of e.state.objects || []) {
    if (v.enabled === !1) continue;
    const g = br(e.state.objects, v).position || [0, 0, 0], [y, S] = m(g[0], g[2]);
    if (Math.hypot(a - y, o - S) <= 7)
...
function jp(e, t, a, o) {
  ...
  const r = To(e, e.canvas.width, e.canvas.height);
  if (!r) return !1;
  const { rx: n, ry: i, radarSize: c } = r;
  if (a < n || a > n + c || o < i || o > i + c)
    return !1;
  t.preventDefault?.(), t.stopPropagation?.();
  const l = ft(e), p = us(r, a, o);
  if (p)
    return p === "zoom_in" ? (l.rangeIndex === -1 && (l.rangeIndex = Ue.findIndex((f) => f >= r.range), l.rangeIndex < 0 && (l.rangeIndex = Ue.length - 1)), l.rangeIndex = Math.max(0, (l.rangeIndex === -1 ? 2 : l.rangeIndex) - 1)) : p === "zoom_out" ? (l.rangeIndex === -1 && (l.rangeIndex = Ue.findIndex((f) => f >= r.range), l.rangeIndex < 0 && (l.rangeIndex = 0)), l.rangeIndex = Math.min(Ue.length - 1, l.rangeIndex + 1)) : p === "center" ? l.centerMode = l.centerMode === "camera" ? "origin" : "camera" : p === "size" && (l.expanded = !l.expanded), e.render?.(), !0;
  const m = bs(e, r, a, o);
  if (m) {
    if (m.type === "camera")
...
function _p(e, t, a, o) {
  ...
  const r = To(e, e.canvas.width, e.canvas.height);
  if (!r) return !1;
  const n = ft(e), { rx: i, ry: c, radarSize: l } = r, p = a >= i && a <= i + l && o >= c && o <= c + l;
  if (n.drag) {
    const [b, v] = or(r, a, o), g = e.viewportCamera();
    return n.drag.type === "camera" ? g.position = [b, g.position?.[1] || 1.5, v] : n.drag.type === "target" && (g.target = [b, g.target?.[1] || 0, v]), e.setFrame?.(e.frame, !1, !1), e.render?.(), !0;
  }
  if (!p)
    return n.hover && (n.hover = null, e.render?.()), !1;
  const m = us(r, a, o), h = bs(e, r, a, o), [d, f] = or(r, a, o);
...
function Cp(e, t, a, o) {
  ...
  if (a < n || a > n + c || o < i || o > i + c)
    return !1;
  t.preventDefault?.(), t.stopPropagation?.();
  const l = ft(e), p = Math.sign(t.deltaY || 0);
  return l.rangeIndex === -1 && (l.rangeIndex = Ue.findIndex((m) => m >= r.range), l.rangeIndex < 0 && (l.rangeIndex = 2)), p > 0 ? l.rangeIndex = Math.min(Ue.length - 1, l.rangeIndex + 1) : p < 0 && (l.rangeIndex = Math.max(0, l.rangeIndex - 1)), e.render?.(), !0;
}
function Ep(e, t, a) {
  ...
  const o = () => {
    ...
    const f = ii(t('[data-role="object-tags"]')?.value || "");
    f.length ? d.tags = f : delete d.tags;
    const u = String(t('[data-role="object-annotation"]')?.value || "").trim(), b = u ? On({
      text: u,
  ...
  }, { signal: a }), Il(e, a), sd(e, a), t('[data-role="curve-group"]')?.addEventListener("change", () => {
    e.setChannelFilter("all"), ts(e), e.drawCurveEditor(), kr(e);
    ...
    if (!(!u || f.button === 2 || d.closest(".scene-action-btn")))
      if (u.dataset.objectId) {
        ...
        if (e.finishCameraEdit(), e.selectedObjectIds ||= /* @__PURE__ */ new Set(), f.ctrlKey || f.metaKey)
          ...
          const g = e.state.objects.map((x) => x.id), y = g.indexOf(e.outlinerAnchorId), S = g.indexOf(b.id);
          e.selectedObjectIds = new Set(g.slice(Math.min(y, S), Math.max(y, S) + 1));
        } else
        ...
        for (const g of e.root.querySelectorAll(".scene-item")) {
          const y = !!(g.dataset.objectId && e.selectedObjectIds.has(g.dataset.objectId)), S = !!(g.dataset.objectId && g.dataset.objectId === e.selectedObjectId);
          g.classList.toggle("selected", y), g.classList.toggle("primary", S), g.setAttribute("aria-selected", String(y));
        }
        const v = e.root.querySelector('[data-role="outliner-batch-bar"]');
        if (v) {
          const g = e.selectedObjectIds?.size || 0;
          v.hidden = g < 2;
          const y = v.querySelector('[data-role="batch-count"]');
          y && (y.textContent = `${g} ${s("selected")}`);
        }
  ...
  e.root.addEventListener("pointerdown", (d) => {
    ...
    const f = e.interactionElement.getBoundingClientRect(), u = (d.clientX - f.left) * e.canvas.width / Math.max(1, f.width), b = (d.clientY - f.top) * e.canvas.height / Math.max(1, f.height);
    Cp(e, d, u, b) || e.onWheel(d);
  }, { passive: !1, signal: a }), e.root.addEventListener("wheel", bl(e.root), { signal: a }), window.addEventListener("pointermove", (d) => {
  ...
  l && (l.addEventListener("pointerdown", (d) => e.onTimelinePointerDown(d), { signal: a }), l.addEventListener("pointermove", (d) => e.onTimelinePointerMove(d), { signal: a }), l.addEventListener("pointerup", (d) => e.onTimelinePointerUp(d), { signal: a }), l.addEventListener("pointercancel", (d) => e.onTimelinePointerUp(d), { signal: a }), l.addEventListener("wheel", (d) => Tn(e, d), { passive: !1, signal: a }));
  const p = (d) => {
    const f = ci(d.composedPath?.()[0] || d.target);
    f && (e.lastKeyZone = f);
  };
  e.root.addEventListener("focusin", p, { signal: a }), e.root.addEventListener("pointerdown", p, { capture: !0, signal: a }), e.root.addEventListener("focusout", (d) => {
    e.modalTransform && !e.root.contains(d.relatedTarget) && (si(e), e.render());
  }, { signal: a });
...
function $p(e, t) {
  gr.find((o) => o.id === e)?.onChange?.(t);
}
function Mp(e) {
  const t = Qi(e.id, e.defaultValue), a = `pref_${e.id.replace(/[^a-zA-Z0-9]/g, "_")}`;
  if (e.type === "boolean")
    return `
...
function Tp(e) {
  const t = new Map(gr.map((o) => [o.id, o]));
  return ({
    nav: [
      Ui,
      Wi,
...
function Ip() {
  return `<span class="oc-pref-emoji" aria-hidden="true">${Ap}</span> ${s("OmniCam Preferences")}`;
}
function Op(e) {
  ...
  a.className = "oc-modal-backdrop", a.setAttribute("role", "dialog"), a.setAttribute("aria-modal", "true"), a.setAttribute("aria-label", s("OmniCam Preferences")), a.innerHTML = `
    <div class="oc-modal-dialog oc-pref-dialog" tabindex="-1">
      <div class="oc-pref-header">
        <div class="oc-pref-title">${Ip()}</div>
...
const Lp = ["position", "target"], Fp = ["fov", "zoom"], zp = ["roll"], Np = ["position", "size"], Rp = ["rotation"];
function rr(e) {
...
function fn(e, t, a, o) {
  const r = rr(Number(a || 0) - Number(e || 0)), n = Number(e || 0) + r * o;
  if (t == null) return n;
  const i = rr(Number(t || 0) - n);
  return n + i / 3;
}
function hn(e, t, a) {
  ...
  for (let r = 1; r < a.length - 1; r++) {
    ...
    if (i.camera) {
      for (const m of Lp) {
        ...
        if (Array.isArray(h) && Array.isArray(f) && Array.isArray(d)) {
          const u = pn(h, d, f, p);
          a[r].camera[m] = hn(d.map(Number), u, o);
        }
      }
      for (const m of Fp) {
        const h = n.camera?.[m], d = i.camera?.[m], f = c.camera?.[m];
    ...
    if (Array.isArray(i.position) && Array.isArray(n.position) && Array.isArray(c.position)) {
      for (const m of Np) {
        ...
        if (Array.isArray(h) && Array.isArray(f) && Array.isArray(d)) {
          const u = pn(h, d, f, p);
          a[r][m] = hn(d.map(Number), u, o);
        }
      }
      for (const m of Rp) {
        const h = n[m], d = i[m], f = c[m];
        if (Array.isArray(h) && Array.isArray(f) && Array.isArray(d)) {
          const u = [0, 1, 2].map((b) => fn(h[b], d[b], f[b], p));
          a[r][m] = d.map((b, v) => un(Number(b), u[v], o));
        }
      }
    }
  }
...
function Hp(e, t) {
  ...
  const o = (r) => {
    ...
    const u = (v) => {
      ...
      let y = Up;
      v.shiftKey ? y = Wp : (v.ctrlKey || v.metaKey) && (y = Vp);
      const S = p * y * 20;
      let x = l + g * S;
...
function Xp(e, t) {
  ...
  for (const o of e.root.querySelectorAll('[data-act="toggle-gizmo-space"]'))
    o.addEventListener("click", (r) => {
      ...
      e.serialize?.(), Ie(e), e.requestRender?.(), e.setStatus?.(s("Transform space: {space}").replace("{space}", e.state.gizmo_space));
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-spatial-snap"]'))
    o.addEventListener("click", (r) => {
      ...
      e.serialize?.(), Ie(e), e.setStatus?.(s("Snapping: {mode}").replace("{mode}", e.state.spatial_snap_mode));
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-grid-overlay"]'))
    o.addEventListener("click", (r) => {
      r.stopPropagation(), e.checkpoint?.("Toggle grid overlay"), e.state.show_grid = e.state.show_grid === !1, e.serialize?.(), Ie(e), e.requestRender?.();
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-wireframe-overlay"]'))
    o.addEventListener("click", (r) => {
      ...
      e.serialize?.(), Ie(e), e.requestRender?.(), e.setStatus?.(e.state.show_wireframe ? s("Wireframe overlay: On") : s("Wireframe overlay: Off"));
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-cull-overlay"]'))
    o.addEventListener("click", (r) => {
      ...
      e.serialize?.(), Ie(e), e.webgl && (e.webgl.sceneKey = ""), e.requestRender?.(), e.setStatus?.(e.state.backface_culling ? s("Backface culling: On (Single-Sided)") : s("Backface culling: Off (Double-Sided)"));
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-gizmo-overlay"]'))
    o.addEventListener("click", (r) => {
      r.stopPropagation(), e.checkpoint?.("Toggle gizmo overlay"), e.state.show_gizmo = e.state.show_gizmo === !1, e.serialize?.(), Ie(e), e.requestRender?.();
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-guides-overlay"]'))
    o.addEventListener("click", (r) => {
      r.stopPropagation(), e.checkpoint?.("Toggle guides overlay"), e.state.guides = e.state.guides === !1, e.serialize?.(), Ie(e), e.requestRender?.();
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-safe-areas-overlay"]'))
    o.addEventListener("click", (r) => {
      r.stopPropagation(), e.checkpoint?.("Toggle safe areas overlay"), e.state.safe_areas = !e.state.safe_areas, e.serialize?.(), Ie(e), e.requestRender?.();
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-radar-overlay"]'))
    o.addEventListener("click", (r) => {
      r.stopPropagation(), e.checkpoint?.("Toggle radar overlay"), e.state.show_radar = !e.state.show_radar, e.serialize?.(), Ie(e), e.requestRender?.();
    }, { signal: t });
...
function Jp(e, t) {
  ...
  !a || !o || (r && r.addEventListener("change", () => {
    ...
    document.activeElement !== a && (a.value = xr(o.value));
  }, { signal: t }));
}
function Zp(e, t) {
  ...
  }, n = (i) => (e.smoothingBaseline?.cameraId !== i.id && (e.smoothingBaseline = { cameraId: i.id, keys: qp(i.keyframes) }), e.smoothingBaseline.keys);
  a.addEventListener("input", r, { signal: t }), a.addEventListener("change", () => {
    const i = e.activeCameraTrack();
    if (!i) return;
    e.checkpoint("Path smoothing");
    const c = Number(a.value) / 100, l = Bp(n(i), c);
...
function Qp(e, t) {
  ...
  e.root.querySelector('[data-act="keys-reduce"]')?.addEventListener("click", async () => {
    const l = await Rt(e, s("Reduce keys"), s("Target number of keys"), "8"), p = Math.round(Number(l));
  ...
  if (a.length) {
    ...
    for (const o of a)
      o.addEventListener("change", () => {
        e.dopeChannels = new Set(a.filter((r) => r.checked).map((r) => r.dataset.dopeChannel)), Yn(e);
      }, { signal: t });
  }
}
function af(e, t) {
...
const co = () => import("./chunk-DHchEJ20.js");
function rf(e, t) {
  co().then(({ loadExchangeFormats: o }) => o(e, t)), e.root.querySelector('[data-act="import-camera"]')?.addEventListener("click", async () => {
    (await co()).pickCameraFile(e);
  }, { signal: t }), e.root.querySelector('[data-act="export-camera"]')?.addEventListener("click", async () => {
    (await co()).exportCamera(e);
  }, { signal: t }), e.root.querySelector('[data-role="camera-file"]')?.addEventListener("change", async (o) => {
    const r = o.target.files?.[0];
    o.target.value = "", await (await co()).importCameraFile(e, r);
  }, { signal: t });
}
function nf(e, t) {
  ...
  ec().then((r) => {
    ...
    c === "health-slow" ? ac(e) : c === "health-smooth" ? oc(e) : c === "health-recenter" && rc(e);
  }, { signal: t });
  for (const r of e.root.querySelectorAll('[data-tab="health"]'))
    r.addEventListener("click", () => No(e), { signal: t });
}
function sf(e, t) {
...
function df(e, t) {
  rf(e, t), Jp(e, t), Zp(e, t), Qp(e, t), ef(e, t), sf(e, t), lf(e, t), cf(e, t), Hp(e, t), Gp(e, t), tf(e, t), of(e, t), Xp(e, t), af(e, t), nf(e, t);
}
const bn = {
...
}, ys = "balanced", Wo = "#121212";
function _r(e) {
  return bn[e] || bn[ys];
}
function mf(e, t = "#1b1f2b", a = "#151822", o = "#1e2330", r = "#161922", n = "#111319") {
...
function Rb(e, t, a = ys) {
  const o = _r(a), r = new e.Group();
  ...
  const f = new e.FogExp2(1250588, 8e-3), u = mf(e), b = new e.PMREMGenerator(t);
  b.compileEquirectangularShader();
  const v = new xl(), g = b.fromScene(v, 0.04).texture;
  return v.traverse((y) => {
    y.geometry?.dispose?.();
    const S = Array.isArray(y.material) ? y.material : [y.material];
    ...
    dispose() {
      ...
      for (const y of [n, c, l, p]) y.dispose?.();
    }
  };
}
function Kb(e, t, a) {
...
function Db(e, t, a, o, r) {
  o.group.visible = r, t.environment = r ? o.environment : null, t.background = r ? o.sky : new e.Color(1184274), t.fog = r ? o.fog : null, a.toneMapping = r ? e.ACESFilmicToneMapping : e.NoToneMapping, a.toneMappingExposure = r ? _r(o.quality).toneExposure : 1, t.traverse((n) => {
...
function ff(e) {
  ...
  const r = e.reconstruction, n = r.provider || "Reconstructed", i = Math.round(t * 100), c = qc(e), l = c.length ? `
` + c.map(([m, h]) => `${m}: ${h}`).join(`
`) : "", p = `${n} • ${o} (${i}%)${l}`;
  return {
    label: o,
...
function bf(e, t, a) {
  ...
  if (o) {
    const n = (i) => {
      const c = i.target.closest?.("[data-axis], [data-axis-center]") || i.target, l = c.getAttribute("data-axis"), p = nc(l?.toLowerCase(), e.state.view_mode);
  ...
  for (const n of e.root.querySelectorAll('[data-role="camera-type"]'))
    n.addEventListener("change", (i) => {
      e.camera.camera_type !== i.target.value && e.checkpoint("Change camera type"), e.camera.camera_type = i.target.value, Se(e.root, "camera-type", i.target), e.beginCameraEdit(), e.commitCameraEdit(), e.finishCameraEdit(), e.render();
    }, { signal: a });
  ...
  for (const n of e.root.querySelectorAll('[data-role="point-color"]'))
    n.addEventListener("input", (i) => {
      e.state.point_color !== i.target.value && lo(e, "point_color", "Change point color"), e.state.point_color = i.target.value, e.scheduleSerialize(), e.render();
    }, { signal: a });
  ...
  for (const n of e.root.querySelectorAll('[data-role="speed-heatmap"]'))
    n.addEventListener("change", (i) => {
      e.state.speed_heatmap !== i.target.checked && e.checkpoint("Toggle speed heatmap"), e.state.speed_heatmap = i.target.checked, Se(e.root, "speed-heatmap", i.target, "checked"), e.scheduleSerialize(), e.render();
    }, { signal: a });
  for (const n of e.root.querySelectorAll('[data-role="playblast-grid"]'))
    n.addEventListener("change", (i) => {
      e.state.playblast_grid !== i.target.checked && e.checkpoint("Toggle playblast grid"), e.state.playblast_grid = i.target.checked, Se(e.root, "playblast-grid", i.target, "checked"), e.scheduleSerialize(), e.render();
    }, { signal: a });
  for (const n of e.root.querySelectorAll('[data-role="playblast-labels"]'))
    n.addEventListener("change", (i) => {
      e.state.playblast_labels !== i.target.checked && e.checkpoint("Toggle playblast labels"), e.state.playblast_labels = i.target.checked, Se(e.root, "playblast-labels", i.target, "checked"), e.scheduleSerialize(), e.render();
    }, { signal: a });
  for (const n of e.root.querySelectorAll('[data-role="playblast-resolution"]'))
    n.addEventListener("change", (i) => {
      e.state.playblast_resolution !== i.target.value && e.checkpoint("Change playblast resolution"), e.state.playblast_resolution = i.target.value, Se(e.root, "playblast-resolution", i.target), e.scheduleSerialize();
    }, { signal: a });
  for (const n of e.root.querySelectorAll('[data-act="reset-bg-color"]'))
    n.addEventListener("click", () => {
      e.state.viewport_bg_color !== Wo && e.checkpoint("Reset background colour"), e.state.viewport_bg_color = Wo;
      for (const i of e.root.querySelectorAll('[data-role="viewport-bg-color"]')) i.value = Wo;
  ...
  for (const n of e.root.querySelectorAll('[data-role="show-grid"]'))
    n.addEventListener("change", (i) => {
      e.state.show_grid = i.target.checked, Se(e.root, "show-grid", i.target, "checked"), e.scheduleSerialize(), e.render();
    }, { signal: a });
  for (const [n, i] of [
    ...
    for (const c of e.root.querySelectorAll(`[data-role="${n}"]`))
      c.addEventListener("change", (l) => {
        e.state[i] !== l.target.checked && e.checkpoint("Toggle viewport helper"), e.state[i] = l.target.checked, Se(e.root, n, l.target, "checked"), e.scheduleSerialize(), e.render();
      }, { signal: a });
  ...
  for (const n of e.root.querySelectorAll('[data-role="show-wireframe"]'))
    n.addEventListener("change", (i) => {
      e.state.show_wireframe !== i.target.checked && e.checkpoint("Toggle wireframe"), e.state.show_wireframe = i.target.checked, Se(e.root, "show-wireframe", i.target, "checked"), e.scheduleSerialize(), e.webgl && (e.webgl.sceneKey = ""), e.render();
    }, { signal: a });
  for (const n of e.root.querySelectorAll('[data-role="show-vertices"]'))
    n.addEventListener("change", (i) => {
      e.state.show_vertices !== i.target.checked && e.checkpoint("Toggle vertices"), e.state.show_vertices = i.target.checked, Se(e.root, "show-vertices", i.target, "checked"), e.scheduleSerialize(), e.webgl && (e.webgl.sceneKey = ""), e.render();
    }, { signal: a });
  for (const n of e.root.querySelectorAll('[data-role="backface-culling"]'))
    n.addEventListener("change", (i) => {
      !!e.state.backface_culling !== i.target.checked && e.checkpoint("Toggle backface culling"), e.state.backface_culling = i.target.checked, Se(e.root, "backface-culling", i.target, "checked"), e.scheduleSerialize(), e.webgl && (e.webgl.sceneKey = ""), e.render(), e.setStatus(e.state.backface_culling ? s("Backface culling: On (Single-Sided)") : s("Backface culling: Off (Double-Sided)"));
    }, { signal: a });
  ...
  for (const n of e.root.querySelectorAll('[data-role="burn-in"]'))
    n.addEventListener("change", (i) => {
      e.state.burn_in !== i.target.checked && e.checkpoint("Toggle burn-in"), e.state.burn_in = i.target.checked, Se(e.root, "burn-in", i.target, "checked"), e.scheduleSerialize(), e.render();
    }, { signal: a });
  for (const n of e.root.querySelectorAll('[data-role="guides"]'))
    n.addEventListener("change", (i) => {
      e.state.guides !== i.target.checked && e.checkpoint("Toggle guides"), e.state.guides = i.target.checked, Se(e.root, "guides", i.target, "checked"), e.scheduleSerialize(), e.render();
    }, { signal: a });
  for (const n of e.root.querySelectorAll('[data-role="safe-areas"]'))
    n.addEventListener("change", (i) => {
      e.state.safe_areas !== i.target.checked && e.checkpoint("Toggle safe areas"), e.state.safe_areas = i.target.checked, Se(e.root, "safe-areas", i.target, "checked"), e.scheduleSerialize(), e.renderCameraView(), e.render();
    }, { signal: a });
  for (const n of e.root.querySelectorAll('[data-role="resolution-gate"]'))
    n.addEventListener("change", (i) => {
      e.state.resolution_gate !== i.target.checked && e.checkpoint("Toggle resolution gate"), e.state.resolution_gate = i.target.checked, Se(e.root, "resolution-gate", i.target, "checked"), e.scheduleSerialize(), e.renderCameraView(), e.render();
    }, { signal: a });
  for (const n of e.root.querySelectorAll('[data-role="aspect-ratio"]'))
    n.addEventListener("change", (i) => {
      e.state.aspect_ratio !== i.target.value && e.checkpoint("Change aspect ratio"), e.state.aspect_ratio = i.target.value, Se(e.root, "aspect-ratio", i.target), e.scheduleSerialize(), e.renderCameraView(), e.render();
    }, { signal: a });
  for (const n of e.root.querySelectorAll('[data-role="viewport-bg-color"]')) {
    const i = (c) => {
      e.state.viewport_bg_color !== c.target.value && lo(e, "viewport_bg_color", "Change background colour"), e.state.viewport_bg_color = c.target.value, Se(e.root, "viewport-bg-color", c.target), e.scheduleSerialize(), e.render();
    };
    n.addEventListener("input", i, { signal: a }), n.addEventListener("change", i, { signal: a });
  }
  ...
  for (const n of e.root.querySelectorAll('[data-role="object-color"]'))
    n.addEventListener("input", (i) => {
      const c = e.selectedObject();
      c && (c.color !== i.target.value && lo(e, `object_color:${c.id}`, "Change object color"), c.color = i.target.value, e.scheduleSerialize(), e.render());
    }, { signal: a });
  for (const n of e.root.querySelectorAll('[data-role="object-light-color"]'))
    n.addEventListener("input", (i) => {
      const c = e.selectedObject();
      c && (c.color !== i.target.value && lo(e, `object_color:${c.id}`, "Change light color"), c.color = i.target.value, e.scheduleSerialize(), e.render());
    }, { signal: a });
  ...
  for (const n of e.root.querySelectorAll("[data-lens]"))
    n.addEventListener("click", () => {
      Uc(e, Number(n.dataset.lens));
    }, { signal: a });
  for (const n of e.root.querySelectorAll("[data-blocking-scene]"))
    n.addEventListener("click", () => {
      yp(e, n.dataset.blockingScene), e.closeMenus();
    }, { signal: a });
...
const gf = 32, yf = 0.025, vf = 0.05, ko = 1e-6, xf = ["top", "bottom", "front", "back", "left", "right"], wf = {
  top: "y",
  bottom: "y",
  front: "z",
  back: "z",
...
function kf(e) {
  let t = 0;
  for (let a = 1; a < e.length; a++) t += Er(e[a - 1], e[a]);
  return t;
}
function gn(e) {
  const t = Math.max(0, Math.round(Number(e?.duration_frames) || 1) - 1), a = Array.isArray(e?.playback_range) ? e.playback_range : [0, t], o = nr(Math.round(Number(a[0]) || 0), 0, t), r = nr(Math.round(Number(a[1]) || t), 0, t);
  return o <= r ? [o, r] : [r, o];
}
function Sf(e, t) {
  ...
  for (let i = 0; i < t; i++) {
    ...
    const l = a[n - 1], p = a[n], m = nr((c - l) / Math.max(ko, p - l), 0, 1), h = e[n - 1], d = e[n];
    r.push([
      h[0] + (d[0] - h[0]) * m,
      h[1] + (d[1] - h[1]) * m,
      h[2] + (d[2] - h[2]) * m
...
function Cf(e) {
  ...
  const n = Math.min(gf, r.length, o + 1);
  if (n < 2) return [];
  const i = Sf(r, n);
  ...
  ], p = e.planeAxis === "y" ? vs(l) : xs(l, [0, 0, -1]), m = e.seedPoint ? 1 : 0, h = [];
  for (let d = m; d < i.length; d++) {
    const f = i[d], u = jf(i, d, p, e.planeAxis), b = he(c);
    b.position = [...f], b.target = _f(f, u, l, e.planeAxis), h.push({
...
function ws(e, t = e.cameraPathDraw) {
  const a = t?.pointerId;
  if (a != null)
    try {
...
function yn(e, t = {}) {
  ...
  if (a === "extend") {
    ...
    const u = Math.max(0, Math.round(Number(e.state.duration_frames) || 1) - 1), [, b] = gn(e.state), v = d.length > 1 ? d[d.length - 1].frame - d[0].frame : 24;
    let g = Math.max(b, f.frame + Math.max(6, Math.min(v, 240)));
    g <= f.frame && (g = f.frame + 24), g > u && (l = g + 1), g > b && (p = g), c = [f.frame, g];
  } else
    xf.includes(e.state.view_mode) || e.setViewMode?.("top"), c = gn(e.state);
  const m = wf[e.state.view_mode] ?? null, h = n ? [...n] : [...r.position];
  return e.cameraPathDraw = {
    ...
    sourceCamera: r,
    points: []
  }, Ft(e), e.setStatus?.(a === "extend" ? s("Continue Camera Path: LMB draw from the last key · RMB or Esc cancel") : s("Draw Camera Path: LMB draw · RMB or Esc cancel")), e.render?.(), !0;
}
function Ar(e, t) {
  ...
  a.planeAxis && (o[So[a.planeAxis]] = a.anchor[So[a.planeAxis]]);
  const r = a.points.at(-1);
  return r && Er(r, o) < yf ? !1 : (a.points.push(o), !0);
}
function Fe(e) {
  const t = e.cameraPathDraw;
  return t?.active ? (ws(e, t), e.cameraPathDraw = null, Ft(e), e.setStatus?.(s("Draw Camera Path cancelled")), e.render?.(), !0) : !1;
}
function Af(e) {
  const t = e.cameraPathDraw;
  ...
  if (a.length < 2 || kf(a) < vf || t.range[1] <= t.range[0])
  ...
  if (t.mode === "extend") {
    ...
    return c.keyframes = p, c.id === e.state.active_camera_id && (e.state.keyframes = p), e.cameraPreviewSignature = "", e.cameraPathDraw = null, Ft(e), e.activateCamera?.(c.id), e.setFrame?.(o[0].frame), e.serialize?.(), e.refreshKeys?.(), e.render?.(), e.setStatus?.(s("Camera path extended")), c.id;
  }
  e.checkpoint?.("Draw camera path");
  const r = Wc(e.state), n = e.state.cameras.length, i = {
    id: r,
    name: Ef(e.state),
  ...
  return e.state.cameras.push(i), e.cameraPreviewSignature = "", e.cameraPathDraw = null, Ft(e), e.activateCamera?.(r), e.setFrame?.(t.range[0]), e.setStatus?.(s("Camera path created")), r;
}
function jo(e) {
...
function $r(e, t) {
  ...
  return r?.every(Number.isFinite) ? (a.planeAxis && (r[So[a.planeAxis]] = a.anchor[So[a.planeAxis]]), r) : null;
}
function Mf(e, t) {
  const a = e.cameraPathDraw;
  return a?.active ? t.button === 2 && !t.altKey ? (jo(t), e.cameraPathSuppressContextMenuUntil = Date.now() + 1e3, Fe(e), !0) : t.button !== 0 || t.altKey || t.ctrlKey || t.metaKey || t.shiftKey ? !1 : (jo(t), e.closeMenus?.(), e.interactionElement.focus?.({ preventScroll: !0 }), e.interactionElement.setPointerCapture?.(t.pointerId), a.drawing = !0, a.pointerId = t.pointerId, a.points = [], Ar(e, $r(e, t)), Ft(e), e.requestRender?.("camera-path-draw"), !0) : !1;
}
function Tf(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : (jo(t), Ar(e, $r(e, t)) && e.requestRender?.("camera-path-draw"), !0);
}
function If(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : (jo(t), t.type === "pointercancel" || t.type === "lostpointercapture" ? (Fe(e), !0) : (Ar(e, $r(e, t)), a.drawing = !1, Af(e), !0));
}
function Of(e) {
  const t = e.cameraPathDraw;
  ...
  if (!o.length) return;
  const r = o.map((c) => Ne(c, a, e.canvas.width, e.canvas.height)).filter((c) => c && Number.isFinite(c[0]) && Number.isFinite(c[1]));
  if (!r.length) return;
...
function Pf(e, t) {
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? Fe(e) : yn(e);
    }, { signal: t });
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path-extend"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? Fe(e) : yn(e, { mode: "extend" });
    }, { signal: t });
...
const bo = "/majoor/omnicam/scenes";
function ks(e) {
...
function Mr(e, t, { name: a = "", status: o } = {}) {
  const r = t && typeof t == "object" ? t : Bn(), n = { ...r, metadata: { ...r.metadata || {}, scene_name: a || "" } };
...
async function Lf(e) {
  await Kt(e, s("New Scene"), s("Start a new scene? Unsaved changes will be lost.")) && Mr(e, Bn(), { name: "", status: s("New scene") });
}
async function Ff(e) {
  if (!e.sceneBaseline) {
  ...
  const o = a?.metadata?.scene_name || ks(e);
  Mr(e, a, { name: o, status: s("Scene reset to last save") });
}
async function zf(e) {
  const t = ks(e) || s("Untitled"), a = await Rt(e, s("Save Scene"), s("Scene name"), t);
  if (a == null) return;
...
async function Nf(e) {
  ...
  const a = await Vc({
    ...
    items: t.map((r) => ({
      id: r.slug,
      label: r.name || r.slug,
      sublabel: Rf(r.modified)
    })),
    onDelete: (r) => go(e, `${bo}/${encodeURIComponent(r)}`, { method: "DELETE" }).catch((n) => console.warn("[OmniCam] scene delete failed", n))
  });
  if (!(!a || !await Kt(e, s("Open Scene"), s("Open this scene? Unsaved changes will be lost."))))
    try {
      const r = await go(e, `${bo}/${encodeURIComponent(a)}`);
      if (!r.ok) throw new Error(await r.text());
...
function Kf(e, t) {
  mo(e, t, e.root.querySelectorAll('[data-act="scene-new"]'), () => Lf(e)), mo(e, t, e.root.querySelectorAll('[data-act="scene-open"]'), () => Nf(e)), mo(e, t, e.root.querySelectorAll('[data-act="scene-save"]'), () => zf(e)), mo(e, t, e.root.querySelectorAll('[data-act="scene-reset"]'), () => Ff(e));
}
const Df = ["world_point", "object_point", "camera_field"], vn = 40;
function Bf(e) {
  return (e.keys || []).map((t) => ({ x: t.x, y: t.y, t: t.time_seconds }));
}
function qf(e, t, a) {
  const o = Math.max(1, Number(e.fps) || 24), r = e.width || 1280, n = e.height || 720, i = [];
  for (let c = 0; c <= vn; c += 1) {
    const l = a * c / vn, p = yr(e, t.source, l * o, r, n);
...
function Wf(e) {
  ...
  if (!c) return;
  const l = Ss(t, e.state.width || 1280, e.state.height || 720), p = (v) => l.x + v * l.w, m = (v) => l.y + v * l.h;
  ...
  for (const v of e.state.motion_layers || []) {
    if (v.enabled === !1) continue;
    const g = Df.includes(v.source_kind), y = g ? qf(e.state, v, d) : Bf(v);
    if (!y.length) continue;
    u += 1;
    const S = v.id === e.state.selected_motion_layer_id;
    if (c.strokeStyle = S ? "#ffcc4d" : "rgba(65,217,197,0.6)", c.lineWidth = (S ? 2.4 : 1.5) * r, c.beginPath(), y.forEach((E, M) => {
      const R = p(E.x), L = m(E.y);
      M ? c.lineTo(R, L) : c.moveTo(R, L);
    }), c.stroke(), !g) {
...
function Vf(e, t) {
  ...
  a && a.addEventListener("click", (o) => {
    ...
    const n = Ss(a, e.state.width || 1280, e.state.height || 720), i = a.width / r.width, c = {
      x: ((o.clientX - r.left) * i - n.x) / Math.max(1, n.w),
      y: ((o.clientY - r.top) * i - n.y) / Math.max(1, n.h)
    }, l = ic(e.state.motion_layers, c, 0.09);
    l && (e.state.selected_motion_layer_id = l.id, e.render());
  }, { signal: t });
}
function Se(e, t, a, o = "value") {
...
function Yf(e, t) {
  ...
  return {
    ...
    motion_scene_fingerprint: gl(e.state)
  };
}
function Xf(e, t) {
  const a = Yf(e, t);
...
function xn(e, t, { frameCount: a = 0, fps: o = 0 } = {}) {
...
const Je = 1024 * 1024, Jf = Object.freeze({
  card: 128 * Je,
  // MAX_CARD_BYTES
  model: 256 * Je,
  // MAX_MODEL_BYTES
...
function kn(e) {
  return `${(e / Je).toFixed(e >= 10 * Je ? 0 : 1)} MB`;
}
function Dt(e, t) {
  const a = Jf[t];
  if (!e || !a) return null;
...
function Zf(e) {
  return Number(e) <= wn ? null : `${e} frames selected; a background sequence is limited to ${wn}.`;
}
function Qf(e) {
...
function eh(e) {
  ...
  e.audioElement && (Vo(e, r), Promise.resolve(e.audioElement.play()).catch(() => {
  }));
  ...
  const p = (m) => {
    ...
    if (h === null) {
      for (l += m - c, c = m; l >= i; )
        if (l -= i, r += 1, r > o) {
          if (!e.state.loop_playback) return void yo(e);
          r = a;
        }
...
async function th(e, { load: t = () => import("./vendor-mediabunny-CZ5VNE-V.js") } = {}) {
...
async function oh(e, t, { decode: a = th } = {}) {
  if (!t) return;
  const o = Dt(t, "audio");
  if (o) {
    e.setStatus(o);
  ...
  try {
    ...
    n.preload = "auto", n.src = r, e.audioObjectUrl = r, e.audioElement = n, await ah(n), e.audioDuration = Number.isFinite(n.duration) ? n.duration : 0;
    try {
      e.audioSamples = await a(t);
    } catch {
      e.audioSamples = null;
    }
    js(e), e.setStatus(`Audio loaded: ${t.name || "track"}`);
  } catch (r) {
    _o(e), e.setStatus(`Failed to load audio: ${r.message || r}`);
  }
}
let mt = null;
function _s({ api: e }) {
...
const Cs = /* @__PURE__ */ new WeakSet(), Ot = /* @__PURE__ */ new WeakMap();
function Co(e) {
...
function rh(e) {
  e && typeof e == "object" && Ot.set(e, (Ot.get(e) || 0) + 1);
}
function nh(e) {
  ...
  Ot.delete(e), Cs.has(e) && Co(e);
}
function Bt(e, t) {
  const a = e.cardMediaById.get(t);
  a && (e.cardMediaById.delete(t), e.cardMediaAssetById?.delete?.(t), t === "subject" && e.cardMedia === a && (e.cardMedia = null), nh(a));
}
function sh(e) {
  for (const t of [...e.cardMediaById?.keys?.() || []]) Bt(e, t);
}
function Ve(e, t, a, o = !1, r = "") {
  ...
  n && n !== a && Bt(e, t), o && Cs.add(a), rh(a), e.cardMediaAssetById ||= /* @__PURE__ */ new Map(), e.cardMediaById.set(t, a), e.cardMediaAssetById.set(t, r || a?.__omnicamAsset || "");
  try {
    a.__omnicamAsset = r || a.__omnicamAsset || "";
  } catch {
  }
...
function Es(e, t, { signal: a, timeout: o = 15e3 } = {}) {
...
async function As(e, t, a, o = () => !0, r = null) {
  if (!t || !a) return;
  const n = () => !e.disposed && o(), i = String(t.asset || a).toLowerCase();
  if (r ?? /\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/.test(i)) {
    const l = document.createElement("video");
    if (l.src = a, l.loop = !0, l.muted = !0, l.playsInline = !0, await Es(l, ["loadeddata", "error"], { signal: e.abortController?.signal }).catch(() => {
    }), !n()) {
      Co(l);
      return;
    }
...
async function ih(e, t) {
  if (!mt?.fetchApi || !/\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/i.test(e)) return null;
  const a = await mt.fetchApi("/majoor/omnicam/extractor/source", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
...
function ch(e) {
  ...
  if (e.state.viewport_bg_image) {
    const o = new Image();
    o.src = We(e.state.viewport_bg_image), o.decode().catch(() => {
    }), e.viewportBgImage = o;
  }
  e.viewportBgSequenceImages = (e.state.viewport_bg_sequence || []).map((o) => {
    const r = new Image();
    return r.src = We(o), r.decode().catch(() => {
    }), r;
  });
  for (const o of e.state.objects) {
    if (!o.asset) {
      (o.type === "model" || o.type === "glb") && (o.load_error = s("Not saved to the ComfyUI input folder: this model will be missing after a reload.")), o.type === "card" && Bt(e, o.id);
      continue;
    }
    const r = We(o.asset);
...
async function dh(e, t) {
  ...
  try {
    const c = await Sr(mt, { route: "/majoor/omnicam/upload_model", field: "asset", file: t });
...
async function mh(e, t) {
  ...
  if (o) {
    ...
    try {
      const r = await Sr(mt, { route: "/majoor/omnicam/upload_asset", field: "asset", file: t });
...
function fh(e) {
  ...
  const a = new Image();
  a.onload = () => {
    e.disposed || (Ve(e, "subject", a, !1, a.src), e.render(), e.setStatus(s("Upstream media refreshed")));
  }, a.src = mt.apiURL(`/view?${new URLSearchParams(t).toString()}`);
}
async function hh(e) {
  if (!e.node) return;
  ...
  for (const h of i) {
    ...
    if (f) {
      if (d === "image" || d === "video") {
        ...
        if (u && u.value) {
          const b = String(u.value), v = /\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/i.test(b), g = f.widgets?.find((x) => String(x.name).toLowerCase() === "subfolder")?.value || "", y = We(nt(b, g)), S = e.state.objects.find((x) => x.id === "subject");
          if (S) {
            const x = await As(e, S, y, r, v);
            if (!r()) return;
            S.asset = nt(b, g);
            let E = null;
            if (v)
              try {
                E = await ih(b, o.signal);
              } catch (M) {
          ...
          }), Ve(e, "subject", b, !1, b.currentSrc || b.src || ""), xn(e, b, { frameCount: b instanceof HTMLVideoElement ? 0 : 1 }), e.upstreamImageConnected = !0, n = !0, e.render(), e.setStatus(b instanceof HTMLVideoElement ? s("Upstream video preview synced") : s("Upstream image preview synced")));
        }
      }
      if (d === "audio") {
        l = !0;
        ...
        if (u && u.value) {
          const b = String(u.value), v = f.widgets?.find((y) => String(y.name).toLowerCase() === "subfolder")?.value || "", g = We(nt(b, v));
          try {
            const y = await fetch(g, { signal: o.signal });
            if (y.ok) {
              const S = await y.blob();
              if (!r()) return;
            ...
            console.warn("Failed to fetch upstream audio:", y);
          }
        }
      }
      if (d === "scene_3d" || d === "model" || d === "mesh") {
        ...
        if (u && u.value) {
          ...
          if (["glb", "gltf", "obj", "fbx", "stl", "ply"].includes(v)) {
            const g = f.widgets?.find((E) => String(E.name).toLowerCase() === "subfolder")?.value || "", y = We(nt(b, g)), S = `upstream_scene_${f.id}`;
            p.add(S);
            let x = e.state.objects.find((E) => E.id === S);
            x ? (x.asset = nt(b, g), x.format = v === "gltf" ? "glb" : v) : (x = {
              id: S,
              type: "model",
              format: v === "gltf" ? "glb" : v,
              ...
              enabled: !0,
              asset: nt(b, g)
            }, e.state.objects.push(x)), e.modelUrlsById.set(S, y), e.serialize(), e.refreshObjects(), e.render(), n = !0, e.setStatus(s(`Upstream 3D model: ${b}`));
          }
        }
      }
    }
  ...
  !l && e.upstreamAudioConnected && (_o(e), e.upstreamAudioConnected = !1, e.refreshKeys(), n = !0, e.setStatus(s("Upstream audio disconnected · audio track cleared")));
  ...
  Gc(e) && (n = !0), n && (e.serialize(), e.render());
}
const uh = ["video/mp4;codecs=avc1.42E01E", "video/webm;codecs=vp9", "video/webm;codecs=vp8", "video/webm"], Sn = { low: 3e6, balanced: 6e6, high: 12e6 };
function bh(e) {
  return Sn[e] || Sn.balanced;
}
async function gh({
  canvas: e,
  fps: t,
  ...
  try {
    for (const S of uh)
      if (!(n.isTypeSupported && !n.isTypeSupported(S)))
        try {
          h = new n(m, { mimeType: S, videoBitsPerSecond: bh(r) });
          break;
        } catch {
        }
    ...
    h.stop(), await f;
    const b = Math.max(0, c() - u), v = a / t * 1e3, g = {
    ...
    p?.(g);
    const y = new Blob(d, { type: h.mimeType || "video/webm" });
    return Gf(y, g);
  } finally {
...
async function vh(e) {
  await Promise.all([...e].filter((t) => t instanceof HTMLVideoElement && t.seeking).map((t) => Es(t, ["seeked", "error"], { timeout: 5e3 }).catch(() => {
  })));
}
async function $s(e) {
  await vh(e.cardMediaById.values());
}
async function Ms(e) {
  return gh({
    canvas: e.canvas,
...
async function Ts(e, t) {
  const a = await yh(He, t);
  if (Xf(e, t), e.state.playblast_camera_id === qn)
...
async function wh(e) {
  ...
  const t = e.frame, a = e.canvas.width, o = e.canvas.height, r = xh(e);
  (r.width !== e.canvas.width || r.height !== e.canvas.height) && (e.canvas.width = r.width, e.canvas.height = r.height, e.render());
  try {
    let n = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-DxBWOkWK.js");
    i !== "realtime" && await l(e.canvas.width, e.canvas.height) && (n = await c(e.canvas, e.state.duration_frames, e.state.fps, async (p) => {
      e.setFrame(p, !0), e.setStatus(s(`Encoding frame ${p + 1}/${e.state.duration_frames}…`)), await $s(e), await new Promise((m) => requestAnimationFrame(m));
    }, e.abortController?.signal, e.state.playblast_quality)), n || (e.setStatus(s("WebCodecs unavailable; recording realtime fallback…")), n = await Ms(e)), e.setFrame(t), await Ts(e, n);
  } catch (n) {
...
async function Is(e) {
  if (!zt) throw new Error("ComfyUI API is unavailable");
  return Sr(zt, { route: "/majoor/omnicam/upload_asset", field: "asset", file: e });
}
async function Eo(e) {
  const t = e.map((a) => String(a.relative || "").replace(/^omnicam\//, "")).filter(Boolean);
  if (!(!t.length || !zt))
    try {
      await zt.fetchApi("/majoor/omnicam/cleanup", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
...
async function Sh(e, t) {
  ...
  let r = null;
  try {
    if (e.setStatus(`Uploading background: ${t.name}`), r = await Is(t), o !== e.backgroundRequestId || e.disposed) {
      await Eo([r]);
      return;
    }
    const n = We(r.path);
    ...
    if (r && await Eo([r]), o !== e.backgroundRequestId || e.disposed) return;
...
async function jh(e, t) {
  ...
  const o = Array.from(t).map((i) => Dt(i, "image")).find(Boolean);
  if (o) {
    e.setStatus(o);
    return;
  }
  ...
  try {
    ...
    for (const c of t)
      if (n.push(await Is(c)), r !== e.backgroundRequestId || e.disposed) {
        await Eo(n);
        return;
      }
    ...
    e.checkpoint?.("Set background sequence"), e.state.viewport_bg_sequence = i, e.state.viewport_bg_image = "", e.viewportBgImage = null, e.viewportBgSequenceImages = i.map((c) => {
      const l = new Image();
      return l.src = We(c), l.decode().catch(() => {
      }), l;
    }), e.serialize(), e.render(), e.setStatus(`Background sequence loaded: ${t.length} frames`);
  } catch (i) {
    if (await Eo(n), r !== e.backgroundRequestId || e.disposed) return;
    e.setStatus(`Failed to load BG sequence: ${i.message || i}`);
  }
}
function _h(e) {
  Tr(e), e.checkpoint?.("Clear background"), e.state.viewport_bg_image = "", e.state.viewport_bg_sequence = [], e.viewportBgImage = null, e.viewportBgSequenceImages = [], e.serialize(), e.render(), e.setStatus("Background cleared");
}
function Ch(e) {
  const t = Yo(e.state?.metadata?.viewport_labels);
  ...
  for (const m of a) {
    if (m.enabled === !1 || !Ln(m, { mode: t.mode, selectedIds: p })) continue;
    const h = Fn(m, t.content);
    if (!h) continue;
    const d = zn(a, m, l) || { position: m.position, size: m.size }, f = Ne(Nn(d, m.type), o, n, i);
    if (!f) continue;
    const [u, b] = f, v = t.content === "annotation" && m.annotation?.color || "", g = 6 * c, y = 4 * c, x = r.measureText(h).width + g * 2, E = 12 * c + y * 2, M = Math.round(u - x / 2), R = Math.round(b - E - 6 * c);
    r.fillStyle = "rgba(16,17,22,0.82)", Eh(r, M, R, x, E, 4 * c), r.fill(), v && (r.strokeStyle = v, r.lineWidth = Math.max(1, c), r.stroke()), r.fillStyle = v || "#e6e6ec", r.fillText(h, M + g, R + E - y - 2 * c);
  }
  r.restore();
}
function Eh(e, t, a, o, r, n) {
...
function le(e, t, a, o = "#5a5a5a", r = 1) {
  const n = e.viewportCamera(), i = Ne(t, n, e.canvas.width, e.canvas.height), c = Ne(a, n, e.canvas.width, e.canvas.height);
...
function $h(e) {
  ...
  return e._pointFieldCache?.key !== r && (e._pointFieldCache = { key: r, ...dc(t, a, o) }), e._pointFieldCache;
}
const Mh = 600;
function Th(e) {
  const { points: t, colors: a } = $h(e);
  if (!t.length) return;
  const o = e.viewportCamera(), r = e.canvas.width, n = e.canvas.height, i = t.length / 3, c = 3 * Math.max(1, Math.ceil(i / Mh)), l = /* @__PURE__ */ new Map();
  for (let p = 0; p < t.length; p += c) {
    const m = Ne([t[p], t[p + 1], t[p + 2]], o, r, n);
    if (!m) continue;
...
function Ih(e, t) {
  ...
  for (const [m, h] of p) le(e, l[m], l[h], "#a0a0a0", 1.4);
}
function Oh(e, t) {
  ...
  for (let c = 0; c < 3; c++) {
    ...
    for (let p = 0; p <= 32; p++) {
      ...
      let h;
      c === 0 ? h = [o + Math.cos(m) * i, r + Math.sin(m) * i, n] : c === 1 ? h = [o + Math.cos(m) * i, r, n + Math.sin(m) * i] : h = [o, r + Math.cos(m) * i, n + Math.sin(m) * i], l && le(e, l, h, "#999", 1), l = h;
    }
  }
}
function Ph(e, t) {
  const [a, o, r] = t.position || [0, 0, 0], n = t.size?.[1] || 1.8, i = (t.size?.[0] || 0.7) * 0.5, c = [a, o + n * 0.88, r], l = [a, o + n * 0.76, r], p = [a - i * 0.55, o + n * 0.73, r], m = [a + i * 0.55, o + n * 0.73, r], h = [a - i * 0.72, o + n * 0.52, r], d = [a + i * 0.72, o + n * 0.52, r], f = [a - i * 0.82, o + n * 0.34, r], u = [a + i * 0.82, o + n * 0.34, r], b = [a, o + n * 0.44, r], v = [a - i * 0.28, o + n * 0.44, r], g = [a + i * 0.28, o + n * 0.44, r], y = [a - i * 0.28, o + n * 0.22, r], S = [a + i * 0.28, o + n * 0.22, r], x = [a - i * 0.28, o, r + 0.05], E = [a + i * 0.28, o, r + 0.05];
  le(e, c, l, "#aaa", 2), le(e, l, b, "#aaa", 2), le(e, p, m, "#aaa", 2), le(e, p, h, "#aaa", 2), le(e, h, f, "#aaa", 2), le(e, m, d, "#aaa", 2), le(e, d, u, "#aaa", 2), le(e, v, g, "#aaa", 2), le(e, v, y, "#aaa", 2), le(e, y, x, "#aaa", 2), le(e, g, S, "#aaa", 2), le(e, S, E, "#aaa", 2);
  const M = Ne(c, e.viewportCamera(), e.canvas.width, e.canvas.height);
...
function Lh(e, t) {
  ...
  for (let u = 0; u < h; u++) {
    const b = u / h * Math.PI * 2, v = Math.cos(b) * l, g = Math.sin(b) * p;
    d.push([a + v, o + m, r + g]), f.push([a + v, o - m, r + g]);
  }
  for (let u = 0; u < h; u++) {
    const b = (u + 1) % h;
    le(e, d[u], d[b], "#aaa", 1.5), le(e, f[u], f[b], "#aaa", 1.5);
  }
  for (let u = 0; u < h; u += 3)
    le(e, d[u], f[u], "#aaa", 1.5);
}
function Fh(e, t) {
  const [a, o, r] = t.position || [0, 0, 0], [n, i, c] = t.size || [1.5, 1.5, 1.5], l = n * 0.5, p = n * 0.18, m = 16, h = [], d = [];
  for (let f = 0; f < m; f++) {
    const u = f / m * Math.PI * 2, b = Math.cos(u), v = Math.sin(u);
    h.push([a + b * (l + p), o, r + v * (l + p)]), d.push([a + b * (l - p), o, r + v * (l - p)]);
  }
  for (let f = 0; f < m; f++) {
    const u = (f + 1) % m;
    le(e, h[f], h[u], "#aaa", 1.5), le(e, d[f], d[u], "#aaa", 1.5), f % 4 === 0 && le(e, h[f], d[f], "#888", 1);
  }
}
function zh(e, t) {
  const a = t.position || [0, 1, 0], o = 0.25;
  le(e, qe(a, [-o, 0, 0]), qe(a, [o, 0, 0]), "#bbb", 2), le(e, qe(a, [0, -o, 0]), qe(a, [0, o, 0]), "#bbb", 2), le(e, qe(a, [0, 0, -o]), qe(a, [0, 0, o]), "#bbb", 2);
}
function Nh(e, t) {
  const [a, o, r] = t.position || [0, 1.5, 0], [n, i] = t.size || [2, 3], c = e.viewportCamera(), l = [
    ...
    [a + n / 2, o + i / 2, r],
    [a - n / 2, o + i / 2, r]
  ].map((v) => Ne(v, c, e.canvas.width, e.canvas.height));
  if (l.some((v) => !v)) return;
  const p = l.map((v) => v[0]), m = l.map((v) => v[1]), h = Math.min(...p), d = Math.max(...p), f = Math.min(...m), u = Math.max(...m);
  ...
  if (b)
    try {
      const v = Math.max(1, d - h), g = Math.max(1, u - f), y = b.videoWidth || b.naturalWidth || b.width, S = b.videoHeight || b.naturalHeight || b.height, x = e.state.card_fit || "contain";
      if (e.ctx.fillStyle = "#111", e.ctx.fillRect(h, f, v, g), x === "stretch" || !y || !S)
        e.ctx.drawImage(b, h, f, v, g);
      else if (x === "contain") {
        const E = Math.min(v / y, g / S), M = y * E, R = S * E;
        e.ctx.drawImage(b, h + (v - M) / 2, f + (g - R) / 2, M, R);
      } else {
        const E = Math.max(v / y, g / S), M = v / E, R = g / E;
        e.ctx.drawImage(b, (y - M) / 2, (S - R) / 2, M, R, h, f, v, g);
      }
    } catch {
    }
  else
...
function Rh(e) {
  ...
  (e.state.cameras || []).forEach((a, o) => {
    ...
    if (!(i && e.state.view_mode === "camera")) {
      ...
      for (const c of r) {
        const l = Ne(c.camera.position, e.viewportCamera(), e.canvas.width, e.canvas.height);
      ...
      if (e.state.view_mode !== "camera") {
        const c = Ce(a, e.frame, e.state.objects), l = Ne(c.position, e.viewportCamera(), e.canvas.width, e.canvas.height);
...
function Kh(e) {
  ...
  for (let o = 0; o < e.state.keyframes.length - 1; o++) {
    ...
    t.push(Kn(Dn(n.camera.position, r.camera.position)) * e.state.fps / Math.max(1, n.frame - r.frame));
  }
...
function Dh(e) {
  ...
  e.recording && e.state.playblast_labels && Ch(e);
}
async function Bh(e, { signal: t } = {}) {
...
async function Uh(e) {
  ...
  const r = o.diagnostic?.issues || [], n = qh(r);
...
function Vh(e, t, a) {
  ...
  return o || (t.keyframes?.length ? $o(t, a).position : t.position || [0, 1.5, 0]);
}
function Pt(e, t, a, o) {
  if (!a) return a;
  const r = Ps(e, t, o);
...
function Gh(e, { perFrame: t = !1 } = {}) {
  const a = e.activeCameraTrack(), o = Ir(e, a), r = Or(e, a);
...
function Ls(e) {
  ...
  const r = (d, f, u, b, v = "") => {
    ...
    return g.type = "button", g.className = "scene-action-btn", u && (g.style.cssText = v || "color:#f59e0b;border-color:#78350f;background:rgba(245,158,11,0.15)"), g.title = s(f), g.innerHTML = `<i class="pi ${d}" style="font-size:10px"></i>`, g.addEventListener("click", (y) => {
      y.stopPropagation(), b(y);
    }), g;
    ...
    `, v.addEventListener("click", () => {
      e.outlinerCollapsedSections ||= /* @__PURE__ */ new Set(), e.outlinerCollapsedSections.has(u) ? e.outlinerCollapsedSections.delete(u) : e.outlinerCollapsedSections.add(u), Ls(e);
  ...
  if (p) {
    ...
    if (t.appendChild(f), !u)
      for (const b of d) {
        ...
        const g = b.id === e.state.active_camera_id, y = b.id === e.state.playblast_camera_id, S = e.selectedEntity === "camera" && g;
        v.setAttribute("aria-selected", String(S)), v.className = `scene-item${S ? " selected" : ""}${g && !S ? " active-view" : ""}`;
        const x = document.createElement("i");
        x.className = "pi pi-video", x.style.cssText = "color:#60a5fa";
        const E = document.createElement("span");
        if (E.className = "scene-item-label", S || g) {
          const L = document.createElement("span");
          L.style.cssText = `color:${S ? "#f59e0b" : "#58cc6b"};font-weight:700`, L.textContent = S ? "● " : "○ ", E.appendChild(L);
        }
        if (E.appendChild(document.createTextNode(b.name)), y) {
          const L = document.createElement("span");
          L.style.cssText = "color:#f2d06b;font-size:10px", L.title = "Playblast Output", L.textContent = " ★", E.appendChild(L);
        }
        if (b.muted) {
          const L = document.createElement("span");
          L.style.opacity = ".6", L.textContent = " (muted)", E.appendChild(L);
        }
        const M = document.createElement("div");
        ...
        )), M.appendChild(r("pi-ellipsis-v", "Camera actions", !1, (L) => e.openCameraContext(L, b.id, !1))), v.append(x, E, M), v.title = S ? s("Currently selected for editing") : y ? s("Active playblast camera") : s("Click to select & activate this camera");
        const R = () => {
  ...
  if (m) {
    ...
    const b = [], v = (x, E) => {
      ...
      const M = f.get(x.id) || [];
      for (const R of M) v(R, E + 1);
    };
    for (const x of u) v(x, 0);
    ...
    }), { header: y, isCollapsed: S } = c(a === "lights" ? s("Lights") : s("Objects"), g.length, "objects");
    if (t.appendChild(y), !S)
      for (const { object: x, level: E } of g) {
        const M = document.createElement("div");
        M.role = "button", M.tabIndex = 0, M.dataset.objectId = x.id;
        const R = e.selectedEntity === "object" && (x.id === e.selectedObjectId || e.selectedObjectIds?.has?.(x.id)), L = e.selectedEntity === "object" && x.id === e.selectedObjectId;
        M.setAttribute("aria-selected", String(R)), M.className = `scene-item${R ? " selected" : ""}${L ? " primary" : ""}${E > 0 && !n ? " scene-item-child" : ""}`, E > 0 && !n && (M.style.paddingLeft = `${E * 16 + 6}px`);
        const X = x.type === "card" ? { icon: "pi-image", color: "#38bdf8" } : x.type === "model" || x.type === "glb" ? { icon: "pi-box", color: "#c084fc" } : x.type === "ground" ? { icon: "pi-minus", color: "#fbbf24" } : x.type === "cube" ? { icon: "pi-stop", color: "#fbbf24" } : x.type === "sphere" ? { icon: "pi-circle", color: "#fbbf24" } : x.type === "cylinder" ? { icon: "pi-database", color: "#fbbf24" } : x.type === "torus" ? { icon: "pi-circle", color: "#fbbf24" } : x.type === "pyramid" ? { icon: "pi-play", color: "#fbbf24" } : x.type === "sun_light" ? { icon: "pi-sun", color: "#f59e0b" } : x.type === "point_light" ? { icon: "pi-bolt", color: "#fbbf24" } : x.type === "spot_light" ? { icon: "pi-compass", color: "#38bdf8" } : x.type === "human" ? { icon: "pi-user", color: "#34d399" } : { icon: "pi-plus", color: "#94a3b8" }, W = x.enabled !== !1, V = !!x.load_error, se = document.createElement("i");
        se.className = `pi ${V ? "pi-exclamation-triangle" : X.icon}`, se.style.cssText = V ? "color:#f87171" : W ? `color:${X.color}` : "opacity:.4";
        const j = document.createElement("span");
        j.className = "scene-item-label";
        const F = document.createElement("span");
        F.style.cssText = V ? "color:#fca5a5" : W ? "" : "opacity:.5;text-decoration:line-through", F.textContent = x.name || x.type, F.title = s("Double-click to rename"), F.addEventListener("dblclick", ($) => {
          $.preventDefault(), $.stopPropagation(), Xh(e, x, F);
        }), j.appendChild(F);
        const B = Array.isArray(x.tags) ? x.tags : [];
        if (B.length) {
          const $ = document.createElement("span");
          $.className = "scene-item-tags";
          for (const H of B.slice(0, 2)) {
            const P = document.createElement("span");
            P.className = "scene-item-tag", P.textContent = H, $.appendChild(P);
          }
          if (B.length > 2) {
            const H = document.createElement("span");
            H.className = "scene-item-tag scene-item-tag-more", H.textContent = `+${B.length - 2}`, $.appendChild(H);
          }
          j.appendChild($);
        }
        if (V) {
        ...
        G.className = "scene-item-actions", G.appendChild(r(W ? "pi-eye" : "pi-eye-slash", W ? "Hide object (Alt+Click to Isolate)" : "Show object (Alt+Click to Isolate)", !W, ($) => {
          if ($?.altKey) {
            if (e.checkpoint("Isolate object"), e._isolatedObjectId === x.id) {
              ...
              for (const U of e.state.objects)
                U.enabled = P && Object.prototype.hasOwnProperty.call(P, U.id) ? P[U.id] : !0;
            ...
            e.toggleObject(x.id);
        }, "color:#ef4444;opacity:.7")), G.appendChild(r(x.locked ? "pi-lock" : "pi-lock-open", "Lock object", x.locked, () => Cr(e, x))), G.appendChild(r("pi-copy", "Duplicate object", !1, () => e.duplicateObject?.(x.id))), x.id !== "subject" && G.appendChild(r("pi-trash", "Delete object", !1, () => e.deleteObject?.(x.id))), G.appendChild(r("pi-ellipsis-v", "Object actions", !1, ($) => e.openObjectContext($, x.id))), M.append(se, j, G), M.title = s("Click to select · Double-click to toggle visibility · Right-click for actions");
        const te = ($ = {}) => {
          ...
          if (e.finishCameraEdit(), e.selectedEntity = "object", e.selectedObjectIds ||= /* @__PURE__ */ new Set(), $.ctrlKey || $.metaKey)
            ...
            const P = e.state.objects.map((de) => de.id), U = P.indexOf(e.outlinerAnchorId), J = P.indexOf(x.id);
            e.selectedObjectIds = new Set(P.slice(Math.min(U, J), Math.max(U, J) + 1));
          } else
          ...
          for (const P of t.querySelectorAll(".scene-item")) {
            const U = !!(P.dataset.objectId && e.selectedObjectIds.has(P.dataset.objectId)), J = !!(P.dataset.objectId && P.dataset.objectId === e.selectedObjectId);
            P.classList.toggle("selected", U), P.classList.toggle("primary", J), P.dataset.objectId && P.setAttribute("aria-selected", String(U));
          }
        ...
        M.addEventListener("dblclick", () => e.toggleObject(x.id)), M.addEventListener("contextmenu", ($) => {
          ...
          ($.key === "Enter" || $.key === " ") && ($.preventDefault(), te($));
        }), t.appendChild(M);
      }
  }
  const h = e.root.querySelector('[data-role="outliner-batch-bar"]');
...
function Jh(e, t) {
  ...
  let u = [0, 0, 0], b = [0, 0, 0], v = "#8c929b", g, y, S, x;
  p ? (u = [5, 8.5, 4], b = [-55, 35, 0], v = "#fff6ec", g = 2.2, y = !0) : m ? (u = [0, 3, 0], v = "#ffffff", g = 2, y = !1) : h && (u = [0, 4, 0], b = [-60, 0, 0], v = "#ffffff", g = 3, S = 45, x = 0.25, y = !0);
  const E = {
    id: a,
    type: t,
    name: d,
...
async function Zh(e, t) {
  ...
  if (!a) return;
  const o = (await Rt(e, s("Rename object"), s("Object name"), a.name || a.type))?.trim();
...
function Fs(e, t) {
  ...
  o.id = `${a.type}_${Date.now().toString(36)}_${Math.random().toString(36).slice(2, 6)}`, o.name = `${a.name || a.type} Copy`, o.position = qe(o.position || [0, 0, 0], [0.35, 0, 0.35]), (o.type === "model" || o.type === "glb") && e.modelUrlsById.has(a.id) ? e.modelUrlsById.set(o.id, e.modelUrlsById.get(a.id)) : o.type === "card" && e.cardMediaById.has(a.id) && Ve(e, o.id, e.cardMediaById.get(a.id), !1, o.asset || e.cardMediaAssetById?.get?.(a.id) || ""), e.state.objects.push(o), e.selectedEntity = "object", e.selectedObjectId = o.id, e.selectedObjectIds = /* @__PURE__ */ new Set([o.id]), e.serialize(), e.refreshObjects(), e.refreshKeys(), e.render(), e.setStatus(s(`${o.name} added`));
}
function Qh(e, t) {
  const a = e.state.objects.find((o) => o.id === t);
...
async function zs(e, t) {
  ...
  const a = e.state.objects.find((o) => o.id === t);
  if (a && await Kt(e, s("Delete object"), s(`Delete ${a.name || a.type} and its ${(a.keyframes || []).length} keyframe(s)?`)) && !(e.disposed || !e.state.objects.includes(a))) {
...
function au(e) {
  ...
  if (n) {
    const j = r.target_object_id || e.state.target_object_id || "", F = `T${Kr()}${e.state.objects.map((B) => `${B.id}\0${B.name || B.type}`).join("|")}`;
    Ho(n, F, () => [
      Tt("", s("Manual Target (No Tracking)")),
      ...e.state.objects.map((B) => Tt(B.id, `${s("Track:")} ${B.name || B.type}`))
    ], j);
  }
  Yh(e);
  const i = [...e.camera.position, ...e.camera.target, e.camera.fov, e.camera.roll || 0, e.camera.near, e.camera.far, ...vr(e.camera)];
  ["camera-px", "camera-py", "camera-pz", "camera-tx", "camera-ty", "camera-tz", "camera-fov", "camera-roll", "camera-near", "camera-far", "camera-rx", "camera-ry", "camera-rz"].forEach((j, F) => {
    for (const B of e.root.querySelectorAll(`[data-role="${j}"]`))
      document.activeElement !== B && (B.value = String(Math.round(i[F] * 1e4) / 1e4));
  });
  ...
  if (!t) {
    ...
    F && (F.textContent = `${r.name} · F${e.frame}`), jn(o, {
  ...
  m && (m.textContent = t.name || t.type), jn(o, {
  ...
  for (const [j, F] of Object.entries(f))
    for (const B of e.root.querySelectorAll(`[data-role="${j}"]`))
      document.activeElement !== B && (B.value = String(Math.round(F * 1e4) / 1e4));
  ...
  if (v) {
    ...
    for (; B; ) {
      ...
      for (const $ of e.state.objects)
        !F.has($.id) && $.parent_id && F.has($.parent_id) && (F.add($.id), B = !0);
    }
    const G = e.state.objects.filter(($) => !F.has($.id)), te = `P${Kr()}${j}${G.map(($) => `${$.id} ${$.name || $.type}`).join("|")}`;
    Ho(v, te, () => [
      Tt("", s("No parent")),
      ...G.map(($) => Tt($.id, $.name || $.type))
    ], t.parent_id || "");
  }
  const g = ["sun_light", "point_light", "spot_light"].includes(t.type), y = t.type === "spot_light", S = o('[data-role="light-props-row"]');
  S && (S.hidden = !g);
  ...
  if (R && (R.hidden = t.type === "point_light"), g) {
    ...
    if (F && (F.checked = t.cast_shadow !== !1), y) {
  ...
  if (u && (u.hidden = !L?.animations), b) {
    ...
    Ho(b, `A${j.join("|")}`, () => j.map((F, B) => Tt(String(B), F)), String(t.animation_index || 0));
  }
  const X = o('[data-role="object-tags"]');
  X && document.activeElement !== X && (X.value = (t.tags || []).join(", "));
...
function su(e) {
  ...
  e.beginCameraEdit(), mc(e.camera, r), e.commitCameraEdit(), e.finishCameraEdit(), Rs(e), nu(e), e.render();
}
function iu(e) {
  const t = globalThis.performance?.now?.() ?? Date.now();
  (!Number.isFinite(e.lastCameraHudEditAt) || t - e.lastCameraHudEditAt > 300) && e.checkpoint("Edit camera"), e.lastCameraHudEditAt = t;
  ...
  e.camera.position = [a("camera-px", e.camera.position[0]), a("camera-py", e.camera.position[1]), a("camera-pz", e.camera.position[2])], e.camera.target = [a("camera-tx", e.camera.target[0]), a("camera-ty", e.camera.target[1]), a("camera-tz", e.camera.target[2])], e.camera.fov = Y(a("camera-fov", e.camera.fov), 5, 150), e.camera.roll = Y(a("camera-roll", e.camera.roll || 0), -180, 180), e.camera.near = Math.max(1e-4, a("camera-near", e.camera.near)), e.camera.far = Math.max(e.camera.near + 1e-4, a("camera-far", e.camera.far)), e.beginCameraEdit(), e.commitCameraEdit(), e.finishCameraEdit(), Rs(e), e.render();
}
function cu(e, t) {
  const a = qt(e);
  if (!a) return;
...
function du(e, t) {
  e.objectUrls.revoke(t), Bt(e, t), e.modelUrlsById.delete(t), e.modelInfoById.delete(t), e.webgl?.removeModel(t);
}
function mu(e) {
  const t = [...e.selectedObjectIds?.size ? e.selectedObjectIds : [e.selectedObjectId]].filter((o) => o && e.state.objects.some((r) => r.id === o));
  if (!t.length) return [];
  if (t.length === 1)
    return Fs(e, t[0]), e.selectedObjectId ? [e.selectedObjectId] : [];
  ...
  return t.forEach((o, r) => {
    ...
    const c = 0.35 + r * 0.15;
    i.position = qe(i.position || [0, 0, 0], [c, 0, c]), (i.type === "model" || i.type === "glb") && e.modelUrlsById.has(n.id) ? e.modelUrlsById.set(i.id, e.modelUrlsById.get(n.id)) : i.type === "card" && e.cardMediaById.has(n.id) && Ve(e, i.id, e.cardMediaById.get(n.id), !1, i.asset || e.cardMediaAssetById?.get?.(n.id) || ""), e.state.objects.push(i), a.push(i.id);
...
function yu(e) {
  ...
  const t = e.root.querySelector('[data-role="key-interp"]')?.value || e.root.querySelector('[data-role="interp"]')?.value || "ease", a = Me(e), o = je(e), r = a ? { frame: e.frame, transform: Ge(a), interpolation: t } : { frame: e.frame, camera: he(e.camera), interpolation: t }, n = o.findIndex((i) => i.frame === e.frame);
...
function xu(e) {
  ...
  const o = Re(e) || a.find((i) => i.frame === e.frame);
...
function ku(e) {
  ...
  const o = t ? { frame: e.frame, transform: Ge(e.copiedKeyframe.transform), interpolation: e.copiedKeyframe.interpolation } : { frame: e.frame, camera: he(e.copiedKeyframe.camera), interpolation: e.copiedKeyframe.interpolation }, r = je(e), n = r.findIndex((i) => i.frame === e.frame);
...
function Re(e) {
  return je(e).find((t) => t.frame === e.selectedKeyFrame) || null;
}
function Su(e, t) {
...
const $u = ["guides", "safe-areas", "resolution-gate", "aspect-ratio"];
function Mu(e) {
...
function Ou(e) {
  const t = Me(e), a = Re(e), o = e.root.querySelector('[data-role="key-editor"]');
  ...
  if (m) {
    const d = Math.max(1, e.state?.fps || 24), f = a ? a.frame : e.frame, u = Math.floor(f / d), b = f % Math.round(d), v = String(Math.floor(u / 3600)).padStart(2, "0"), g = String(Math.floor(u % 3600 / 60)).padStart(2, "0"), y = String(u % 60).padStart(2, "0"), S = String(b).padStart(2, "0");
    m.textContent = `${v}:${g}:${y}:${S} (${f}f)`;
  }
  if (!a) return;
  if (t) {
...
function Lu(e) {
  ...
  if (e.checkpoint("Edit keyframe"), e.editingKeyFrame = t.frame, Me(e)) {
    t.interpolation = e.root.querySelector('[data-role="key-interp"]').value, t.transform = Ge(Me(e)), e.serialize(), e.setFrame(t.frame), e.setStatus(s(`Object keyframe updated @ ${t.frame}`));
    return;
  }
  const a = (o, r) => {
...
const Pr = ["pos_x", "pos_y", "pos_z"], sr = 1e-9, Io = ["auto", "aligned", "free", "corner"];
function Ae(e, t = 0) {
  const a = Number(e);
...
function ir(e, t, a) {
  const o = ze(e), r = t ? ze(t) : o, n = a ? ze(a) : o, i = Math.max(sr, Ae(e?.frame) - Ae(t?.frame, Ae(e?.frame) - 1)), c = Math.max(sr, Ae(a?.frame, Ae(e?.frame) + 1) - Ae(e?.frame)), l = [0, 0, 0], p = [0, 0, 0];
  for (let m = 0; m < 3; m += 1) {
...
function Lt(e) {
  ...
  return Io.includes(t) ? t : "auto";
}
function Nu(e, t = null, a = null) {
  const o = Lt(e), r = ze(e);
  if (o === "corner") {
    const l = Ds(e, t, a);
    return { in: po(r, l.in), out: po(r, l.out), mode: o };
  }
  const n = ir(e, t, a), i = (o === "free" || o === "aligned") && cr(e, "out") || n.out, c = (o === "free" || o === "aligned") && cr(e, "in") || n.in;
  return { in: po(r, c), out: po(r, i), mode: o };
}
function po(e, t) {
  return [e[0] + t[0], e[1] + t[1], e[2] + t[2]];
}
...
function pt(e, t, a) {
  const o = Ru(e);
  for (let r = 0; r < 3; r += 1) {
    const n = Pr[r], i = o[n] && typeof o[n] == "object" ? o[n] : {};
...
function Bs(e, t, a) {
  const o = ze(e), r = Nu(e, t, a);
  pt(e, "out", Nt(r.out, o)), pt(e, "in", Nt(r.in, o));
}
function Ku(e, t, a, { prevKey: o = null, nextKey: r = null } = {}) {
  if (!e || t !== "in" && t !== "out") return e;
  let n = Lt(e);
  if (n === "corner") return e;
  n === "auto" && (n = "aligned", e.tangents = e.tangents && typeof e.tangents == "object" ? e.tangents : {}, e.tangents.spatial_mode = "aligned", Bs(e, o, r));
  const i = ze(e), c = Nt([
    Ae(a?.[0]),
    Ae(a?.[1]),
    Ae(a?.[2])
  ], i);
  if (lr(e), pt(e, t, c), n === "aligned") {
    const l = t === "out" ? "in" : "out", p = cr(e, l) || (l === "out" ? ir(e, o, r).out : ir(e, o, r).in), m = _n(c), h = _n(p) || m || 1, d = m > sr ? Ao(c, -h / m) : Ao(p, 1);
    pt(e, l, d);
  }
  return e;
}
function Du(e, t, { prevKey: a = null, nextKey: o = null } = {}) {
  if (!e || !Io.includes(t)) return e;
  if (e.tangents = e.tangents && typeof e.tangents == "object" ? e.tangents : {}, e.tangents.spatial_mode = t, t === "auto") {
    if (e.tangents.channels) {
      for (const r of Pr) delete e.tangents.channels[r];
  ...
  if (t === "corner") {
    const r = Ds(e, a, o);
    return lr(e), pt(e, "out", r.out), pt(e, "in", r.in), e;
  }
  return lr(e), Bs(e, a, o), e;
}
function Bu(e) {
  switch (e) {
    case "auto":
...
function Uu(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: h, playblastCameraTrack: d, restoreFromWidgets: f, serializeEditorState: u, syncActiveCameraTrack: b, syncFromWidgets: v, bindEditorEvents: g, activateCamera: y, addCamera: S, deleteCamera: x, drawPreviewOverlays: E, duplicateCamera: M, maximizeCameraPreview: R, refreshCameraPreviews: L, refreshCameraSelectors: X, renameCamera: W, setPlayblastCamera: V, toggleCameraView: se, captureRealtime: j, makePlayblast: F, uploadDirectorPlayblast: B, waitForMediaFrame: G, computeAudioPeaks: te, loadAudioFile: $, releaseAudio: H, stopPlay: P, togglePlay: U, applyCameraPreset: J, applyCameraShake: de, applyProxyPreset: me, clearViewportBgImage: ae, loadViewportBgFile: pe, loadViewportBgSequence: fe, drawCameraPath: ue, drawCard: ve, drawCube: ge, drawGrid: ye, drawHuman: z, drawLine3D: K, drawNull: re, drawOverlays: ce, drawPointField: ne, drawSpeedHeatmap: ke, drawSphere: Te, curveChannels: et, drawCurveEditor: ht, onCurvePointerDown: ut, onCurvePointerMove: bt, onCurvePointerUp: gt, onTimelinePointerDown: Ut, onTimelinePointerMove: Wt, onTimelinePointerUp: Vt, refreshKeys: yt, resetCurveZoom: vt, resetTimelineZoom: tt, setChannelFilter: xt, setCurveInterpolation: wt, setTangentMode: kt, timelineFrameFromEvent: Ht, toggleCurveHandles: St, zoomCurve: Gt, drawTransformGizmo: Yt, frameTarget: Xt, gizmoAxes: Jt, gizmoGeometry: Zt, onPointerDown: Qt, onPointerMove: ea, onPointerUp: ta, onWheel: aa, pickGizmo: oa, pickSceneObject: ra, resetCamera: jt, setTransformMode: _t, setViewMode: na, viewportCamera: sa, loadCardFile: Oo, loadExecutionPreview: Po, loadMediaUrl: ia, loadModelFile: ca, loadSelectedReference: la, onModelLoaded: da, restoreAssets: ma, syncUpstreamInputs: pa, configureDomMedia: fa, refreshSetupDiagnostic: Ct, addMediaCard: ha, addPrimitive: ua, applyObjectAnimationFrame: ba, beginCameraEdit: ga, beginObjectEdit: ya, commitCameraEdit: va, commitObjectEdit: xa, copyKeyframe: wa, deleteKeyframe: ka, deleteObject: Sa, duplicateObject: ja, exitKeyEdit: _a, finishCameraEdit: Ca, goToAdjacentKey: Ea, insertKeyframe: Aa, loadSelectedKeyView: $a, pasteKeyframe: Ma, playblastCameraAtFrame: Ta, refreshInspector: Ia, refreshKeyEditor: Oa, refreshObjects: Pa, removeObjectResources: La, renameObject: Fa, retimeSelectedKey: za, selectKeyframe: Na, selectedKeyframe: Ra, selectedObject: Ka, selectObjectAnimation: Da, setKeyInterpolation: Ba, setObjectParent: qa, timelineKeyframes: Ua, timelineObject: Ye, toggleAutoKey: Wa, toggleObject: Va, updateCameraFromHud: Ha, updateEditState: Ga, updateKeyVisualState: Ya, updateSelectedKey: Xa, updateSelectedObject: Ja, clamp: Et, cloneCamera: Za, configureCore: Qa, defaultCamera: eo, sampleCamera: At, sampleObjectTransform: Lo, sanitizeState: at, worldTransform: Ke } = e;
  return {
    setSelectMode(O) {
      if (["object", "vertex", "edge", "face"].includes(O)) {
        this.state.select_mode = O, this.subSelection = null;
        for (const A of this.root.querySelectorAll("[data-select-mode]")) {
          const k = A.dataset.selectMode === O;
          A.classList.toggle("active", k), A.setAttribute("aria-pressed", String(k));
        }
        for (const A of this.root.querySelectorAll('[data-role="select-mode"]'))
          A.value = O;
    ...
    hideInternalWidgets() {
      for (const O of ["state_json", "recording_path", "card_asset"]) {
        const A = this.node.widgets?.find((k) => k.name === O);
        A && (A.computeSize = () => [0, -4], A.draw = () => {
        }, A.hidden = !0, A.options = { ...A.options || {}, hideInVueNodes: !0 });
      }
    },
    restoreFromWidgets() {
      f(this);
    ...
    restoreHistorySnapshot(O) {
      ...
      const k = Cn(this.state), w = new Set(this.state.objects.map((ie) => ie.id));
      this.state = at(A.state);
      const C = new Set(this.state.objects.map((ie) => ie.id));
      for (const ie of w) C.has(ie) || this.removeObjectResources(ie);
      this.frame = Et(A.frame, 0, this.state.duration_frames - 1);
      const T = new Set(this.state.objects.map((ie) => ie.id)), N = Array.isArray(A.selectedObjectIds) ? A.selectedObjectIds : [A.selectedObjectId].filter(Boolean);
      this.selectedObjectIds = new Set(N.filter((ie) => T.has(ie))), this.selectedObjectId = this.selectedObjectIds.has(A.selectedObjectId) ? A.selectedObjectId : [...this.selectedObjectIds].at(-1) || null, this.selectedEntity = this.selectedObjectIds.size ? "object" : A.selectedEntity || "camera";
      const Z = new Set(this.timelineKeyframes().map((ie) => ie.frame)), q = Array.isArray(A.selectedKeyFrames) ? A.selectedKeyFrames : [A.selectedKeyFrame].filter((ie) => ie != null);
      this.selectedKeyFrames = new Set(q.filter((ie) => Z.has(ie))), this.selectedKeyFrame = this.selectedKeyFrames.has(A.selectedKeyFrame) ? A.selectedKeyFrame : [...this.selectedKeyFrames].at(-1) ?? null, this.subSelection = A.subSelection || null, this.camera = At(this.state, this.frame), Pt(this, this.activeCameraTrack(), this.camera, this.frame), this.cameraPreviewSignature = "", this.serialize(), k !== Cn(this.state) && this.restoreAssets(), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
    },
    checkpoint(O) {
    ...
    closeMenus(O = null) {
      for (const A of this.root.querySelectorAll(".toolbar-menu")) A !== O && (A.open = !1);
    ...
    showContextMenu(O, A, k) {
      return this.contextMenu.show(O, A, k);
    },
    onContextMenu(O) {
      ...
      const A = O.target, k = A.closest?.(".camera-preview-tile"), w = A.closest?.(".scene-item"), C = A.closest?.(".key");
      ...
      if (A.closest?.('[data-role="keys"]'))
        return this.setFrame(this.timelineFrameFromEvent(O, A.closest('[data-role="keys"]'))), this.openTimelineContext(O, !1);
      if (A.closest?.(".curve-editor")) return this.openCurveContext(O);
      if (A.closest?.(".viewport-wrap")) {
        const T = this.interactionElement.getBoundingClientRect(), N = (O.clientX - T.left) * this.canvas.width / Math.max(1, T.width), Z = (O.clientY - T.top) * this.canvas.height / Math.max(1, T.height), q = this.pickSceneObject([N, Z]);
        if (q) {
          if ((q.type === "object" || q.type === "object_keyframe") && q.object)
            return this.selectedEntity = "object", this.selectedObjectId = q.object.id, q.keyframe ? (this.setFrame(q.keyframe.frame), this.selectedKeyFrame = q.keyframe.frame) : this.selectedKeyFrame = q.object.keyframes?.find((ie) => ie.frame === this.frame)?.frame ?? null, this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), this.openObjectContext(O, q.object.id);
          if (["camera", "camera_target", "camera_keyframe"].includes(q.type) && q.camera)
            return this.selectedEntity = q.type === "camera_target" ? "camera_target" : "camera", this.selectedObjectId = null, this.activateCamera(q.camera.id), q.keyframe && (this.setFrame(q.keyframe.frame), this.selectedKeyFrame = q.keyframe.frame), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), q.type === "camera_keyframe" && q.keyframe ? this.openPathKeyContext(O, q.camera.id, q.keyframe.frame) : this.openCameraContext(O, q.camera.id, !1);
        }
    ...
    openViewportContext(O) {
      ...
      this.showContextMenu(O, s("Viewport"), [
        {
          label: A ? `${s("Set key")} · ${A.name || A.type}` : `${s("Set key")} · ${this.activeCameraTrack().name}`,
          icon: "pi-key",
          shortcut: "I",
    ...
    openObjectContext(O, A) {
      const k = this.state.objects.find((T) => T.id === A);
      if (!k) return;
      this.selectedEntity = "object", this.selectedObjectId = A, this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
      const w = ["sun_light", "point_light", "spot_light"].includes(k.type), C = this.selectedObjectIds?.size || 0;
      if (C >= 2 && this.selectedObjectIds.has(A)) {
      ...
      this.showContextMenu(O, k.name || k.type, [
        ...
        { label: s("Frame subject"), icon: "pi-search", shortcut: "F", run: () => this.frameTarget() },
        { label: s("Rename object…"), icon: "pi-pencil", run: () => this.renameObject(A) },
        { label: s("Duplicate object"), icon: "pi-copy", run: () => this.duplicateObject(A) },
        { label: k.enabled === !1 ? s("Show object") : s("Hide object"), icon: k.enabled === !1 ? "pi-eye" : "pi-eye-slash", run: () => this.toggleObject(A) },
        { label: k.locked ? s("Unlock object") : s("Lock object"), icon: k.locked ? "pi-lock" : "pi-lock-open", run: () => Cr(this, k) },
        null,
        {
          label: s("Transform mode"),
          icon: "pi-arrows-alt",
        ...
        },
        {
          ...
          icon: "pi-bullseye",
          items: [
            { label: s("Camera tracks this object (Look-At)"), icon: "pi-bullseye", help: s("Lock camera live look-at tracking to this moving object"), run: () => this.aimAtSelectedObject(A) },
            ...
            null,
            { label: s("Select hierarchy"), icon: "pi-sitemap", shortcut: "Shift+G", help: s("Select this object and all descendants"), run: () => this.selectHierarchy(A) }
          ]
        },
        ...w ? [
          {
        ...
        null,
        { label: s("Reset entire animation"), icon: "pi-replay", danger: !0, help: s("Delete every animation key and return position/rotation to zero"), run: () => this.resetObjectAnimation(A) },
        null,
        { label: s("Delete object"), icon: "pi-trash", danger: !0, disabled: A === "subject", help: A === "subject" ? s("The canonical subject card cannot be deleted") : s("Delete this object and its animation keys"), run: () => this.deleteObject(A) }
      ]);
    },
    openCameraContext(O, A, k = !1) {
      const w = this.state.cameras.find((C) => C.id === A);
      w && (this.selectedEntity = "camera", this.selectedObjectId = null, this.activateCamera(A), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), this.showContextMenu(O, `${w.name}${k ? " preview" : ""}`, [
        { label: s("Edit this camera"), icon: "pi-video", run: () => this.activateCamera(A) },
        {
          label: s("Select whole path — move / scale / rotate"),
          icon: "pi-arrows-alt",
          disabled: (w.keyframes || []).length < 1,
          run: () => {
            this.activateCamera(A), this.selectCameraPath() && this.setStatus(`${w.name} · ${s("whole path selected — move / scale / rotate")}`);
          }
        },
        { label: s("Set as primary / playblast"), icon: "pi-star", disabled: A === this.state.playblast_camera_id, run: () => this.setPlayblastCamera(A) },
        { label: s("Set key at playhead"), icon: "pi-key", shortcut: "I", run: () => {
          this.activateCamera(A), this.insertKeyframe();
        } },
        { label: s("Record this preview"), icon: "pi-circle-fill", run: () => {
          this.setPlayblastCamera(A), this.makePlayblast();
        } },
        { label: this.state.maximized_camera_id === A ? s("Restore preview size") : s("Maximize preview"), icon: "pi-window-maximize", run: () => this.maximizeCameraPreview(A) },
        null,
        {
          label: s("Shot order & handles"),
          icon: "pi-sliders-h",
          items: [
            { label: s("Shot: move earlier"), icon: "pi-arrow-up", disabled: this.state.cameras.findIndex((C) => C.id === A) <= 0, run: () => this.moveShot(A, -1) },
            { label: s("Shot: move later"), icon: "pi-arrow-down", disabled: this.state.cameras.findIndex((C) => C.id === A) >= this.state.cameras.length - 1, run: () => this.moveShot(A, 1) },
            null,
            { label: s("Shot handles…"), icon: "pi-sliders-h", run: () => this.editShotHandles(A) }
          ]
        },
        null,
        { label: s("Rename camera…"), icon: "pi-pencil", run: () => this.renameCamera(A) },
        { label: s("Duplicate camera"), icon: "pi-copy", run: () => this.duplicateCamera(A) },
        { label: s("Create camera from current view"), icon: "pi-plus", run: () => this.addCamera() },
        null,
        { label: s("Reset entire animation"), icon: "pi-replay", danger: !0, help: s("Delete every camera key and return to a static zero pose at frame 0"), run: () => this.resetCameraAnimation(A) },
        null,
        { label: s("Delete camera"), icon: "pi-trash", danger: !0, disabled: this.state.cameras.length <= 1, run: () => this.deleteCamera(A) }
      ]));
    },
    openPathKeyContext(O, A, k) {
      const w = this.state.cameras.find((Z) => Z.id === A);
      if (!w) return;
      this.selectedEntity = "camera", this.selectedObjectId = null, this.activateCamera(A);
      ...
      const T = C ? Lt(C) : "auto", N = this.selectedKeyFrames?.size || 0;
    ...
    moveShot(O, A) {
      const k = this.state.cameras.findIndex((T) => T.id === O), w = k + A;
    ...
    async editShotHandles(O) {
      const A = this.state.cameras.find((T) => T.id === O);
      if (!A) return;
      const k = A.handles || { in: 0, out: 0 }, w = await i(t, s("Shot handles…"), "Handle frames: in,out", `${k.in},${k.out}`);
      if (w == null) return;
      const C = String(w).match(/^\s*(\d+)\s*[,;\s]\s*(\d+)\s*$/);
      if (!C) return this.setStatus("Handles must be two integers: in,out");
      this.checkpoint("Shot handles"), A.handles = { in: Math.min(600, Number(C[1])), out: Math.min(600, Number(C[2])) }, this.serialize(), this.setStatus(`${A.name} handles: ${A.handles.in} / ${A.handles.out}`);
    },
    openTimelineContext(O, A) {
      const k = this.selectedKeyFrames?.size || 0, w = this.selectedKeyframe(), C = w?.interpolation || "ease", T = w && Lt(w) || "auto", N = ["ease", "linear", "bezier", "smooth", "ease_in", "ease_out", "sine", "cubic", "quintic", "expo", "back"], Z = ["auto", "clamped", "vector", "free", "aligned", "flat"];
      this.showContextMenu(O, A ? `Keyframe F${this.selectedKeyFrame}` : `Timeline F${this.frame}`, [
        { label: s("Fit timeline view (F)"), icon: "pi-arrows-alt", shortcut: "F", run: () => tt(this) },
    ...
    addMarker() {
      if ((this.state.markers || []).find((A) => A.frame === this.frame)) return this.setStatus(`Marker already at F${this.frame}`);
      this.checkpoint("Add marker"), this.state.markers = [...this.state.markers || [], { frame: this.frame, name: `Marker ${(this.state.markers || []).length + 1}`, color: "#f2d06b" }].sort((A, k) => A.frame - k.frame), this.serialize(), this.refreshKeys(), this.setStatus(`Marker @ F${this.frame}`);
    },
    removeNearestMarker() {
      const O = this.state.markers || [];
      if (!O.length) return;
      const A = O.reduce((k, w) => Math.abs(w.frame - this.frame) < Math.abs(k.frame - this.frame) ? w : k);
      this.checkpoint("Remove marker"), this.state.markers = O.filter((k) => k !== A), this.serialize(), this.refreshKeys(), this.setStatus(`Marker removed @ F${A.frame}`);
    },
    openCurveContext(O) {
      const A = this.selectedKeyFrames?.size || 0, k = A < 2 && !this.selectedKeyframe(), w = this.selectedKeyframe(), C = w?.interpolation || "ease", T = w && Lt(w) || "auto", N = ["bezier", "smooth", "linear", "ease_in", "ease_out", "ease", "sine", "cubic", "quintic", "expo", "back"], Z = ["auto", "clamped", "vector", "free", "aligned", "flat"];
      this.showContextMenu(O, s("Curve editor"), [
        { label: s("Fit all curves (Framing)"), icon: "pi-arrows-alt", shortcut: "F", run: () => vt(this) },
        { label: s("Set key at playhead"), icon: "pi-key", shortcut: "I", run: () => this.insertKeyframe() },
        ...
        null,
        { label: A >= 2 ? s("Delete {count} keys").replace("{count}", String(A)) : s("Delete selected key"), icon: "pi-trash", danger: !0, disabled: k, run: () => this.deleteSelectedKeyframes() }
      ]);
    },
    ...
    refitNode() {
      ...
      try {
        if (O && typeof O.computeSize == "function" && typeof O.setSize == "function") {
          const A = O.computeSize();
          Array.isArray(A) && O.setSize([O.size?.[0] ?? A[0], A[1]]);
        }
    ...
    resizeCanvas() {
      ...
      if (!O) return;
      const A = Math.min(2, window.devicePixelRatio || 1), k = O.clientWidth || 320, w = O.clientHeight || 180, C = Math.max(320, Math.round(k * A)), T = Math.max(180, Math.round(w * A));
      ...
      for (const N of this.cameraPreviewCanvases.values()) {
        const Z = N.clientWidth || 220, q = N.clientHeight || 124, ie = Math.max(A, qu / Math.max(1, Z)), _e = Math.max(1, Math.round(Z * ie)), Oe = Math.max(1, Math.round(q * ie));
        (N.width !== _e || N.height !== Oe) && (N.width = _e, N.height = Oe);
      }
...
function Wu(e, t) {
  ...
  const o = fr();
  o.position = [0, 0, 0], o.target = [0, 0, -1], a.camera = he(o), a.keyframes = [{ frame: 0, camera: he(o), interpolation: "ease" }], e.state.active_camera_id = a.id, e.state.camera = he(o), e.state.keyframes = a.keyframes, e.camera = he(o), e.frame = 0, e.selectedEntity = "camera", e.selectedObjectId = null, e.selectedKeyFrame = 0, e.editingKeyFrame = null, e.cameraEditKey = null, e.cameraEditActive = !1, e.cameraPreviewSignature = "", qs(e), e.refreshCameraSelectors(), e.setStatus(s(`${a.name} animation reset`));
}
function Vu(e, t) {
  const a = e.state.objects.find((o) => o.id === t);
  a && (e.checkpoint("Reset object animation"), a.keyframes = [], a.position = [0, 0, 0], a.rotation = [0, 0, 0], e.frame = 0, e.selectedEntity = "object", e.selectedObjectId = a.id, e.selectedKeyFrame = null, e.editingKeyFrame = null, qs(e), e.setStatus(s(`${a.name || a.type} animation reset`)));
}
const En = { motion: "motion", shot: "display", health: "health" }, Hu = {
  object: "Object",
  camera: "Camera",
  camera_target: "Look-At Target",
  camera_path: "Camera Path"
}, Gu = { motion: "Motion", shot: "Shot", health: "Health" }, Yu = ["entity", "motion", "shot", "health"];
function Us(e) {
  return e.inspectorMode && e.inspectorMode !== "entity" ? e.inspectorMode : "entity";
}
function Xu(e) {
  const t = Us(e);
  return En[t] ? En[t] : e.selectedEntity === "object" ? "scene" : "camera";
}
function Ju(e) {
  return [
    e.selectedEntity || "",
...
function Zu(e) {
  const t = Ju(e);
  e._lastInspectorSelKey !== void 0 && e._lastInspectorSelKey !== t && (e.inspectorMode = "entity"), e._lastInspectorSelKey = t, Ws(e);
}
function Ws(e) {
  const t = Xu(e);
  ...
  r && (r.textContent = o === "entity" ? s(Hu[e.selectedEntity] || "Inspector") : s(Gu[o] || "Inspector"));
}
function Qu(e, t) {
  e.inspectorMode = Yu.includes(t) ? t : "entity", Ws(e), e.render?.(), e.refitNode?.();
}
function eb(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: h, playblastCameraTrack: d, restoreFromWidgets: f, serializeEditorState: u, syncActiveCameraTrack: b, syncFromWidgets: v, bindEditorEvents: g, activateCamera: y, addCamera: S, deleteCamera: x, drawPreviewOverlays: E, duplicateCamera: M, maximizeCameraPreview: R, refreshCameraPreviews: L, refreshCameraSelectors: X, renameCamera: W, setPlayblastCamera: V, toggleCameraView: se, captureRealtime: j, makePlayblast: F, uploadDirectorPlayblast: B, waitForMediaFrame: G, computeAudioPeaks: te, loadAudioFile: $, releaseAudio: H, stopPlay: P, togglePlay: U, applyCameraPreset: J, applyCameraShake: de, applyProxyPreset: me, clearViewportBgImage: ae, loadViewportBgFile: pe, loadViewportBgSequence: fe, drawCameraPath: ue, drawCard: ve, drawCube: ge, drawGrid: ye, drawHuman: z, drawLine3D: K, drawNull: re, drawOverlays: ce, drawPointField: ne, drawSpeedHeatmap: ke, drawSphere: Te, curveChannels: et, drawCurveEditor: ht, onCurvePointerDown: ut, onCurvePointerMove: bt, onCurvePointerUp: gt, onTimelinePointerDown: Ut, onTimelinePointerMove: Wt, onTimelinePointerUp: Vt, refreshKeys: yt, resetCurveZoom: vt, resetTimelineZoom: tt, setChannelFilter: xt, setCurveInterpolation: wt, setTangentMode: kt, timelineFrameFromEvent: Ht, toggleCurveHandles: St, zoomCurve: Gt, drawTransformGizmo: Yt, frameTarget: Xt, gizmoAxes: Jt, gizmoGeometry: Zt, onPointerDown: Qt, onPointerMove: ea, onPointerUp: ta, onWheel: aa, pickGizmo: oa, pickSceneObject: ra, resetCamera: jt, setTransformMode: _t, setViewMode: na, viewportCamera: sa, loadCardFile: Oo, loadExecutionPreview: Po, loadMediaUrl: ia, loadModelFile: ca, loadSelectedReference: la, onModelLoaded: da, restoreAssets: ma, syncUpstreamInputs: pa, configureDomMedia: fa, refreshSetupDiagnostic: Ct, addMediaCard: ha, addPrimitive: ua, applyObjectAnimationFrame: ba, beginCameraEdit: ga, beginObjectEdit: ya, commitCameraEdit: va, commitObjectEdit: xa, copyKeyframe: wa, deleteKeyframe: ka, deleteObject: Sa, deleteSelectedObjects: ja, duplicateObject: _a, exitKeyEdit: Ca, finishCameraEdit: Ea, goToAdjacentKey: Aa, insertKeyframe: $a, loadSelectedKeyView: Ma, pasteKeyframe: Ta, playblastCameraAtFrame: Ia, refreshInspector: Oa, refreshKeyEditor: Pa, refreshObjects: La, removeObjectResources: Fa, renameObject: za, retimeSelectedKey: Na, selectKeyframe: Ra, selectedKeyframe: Ka, selectedObject: Da, selectObjectAnimation: Ba, setKeyInterpolation: qa, setKeyTangentMode: Ua, setObjectParent: Ye, timelineKeyframes: Wa, timelineObject: Va, toggleAutoKey: Ha, toggleObject: Ga, updateCameraFromHud: Ya, updateCameraRotationFromHud: Xa, updateEditState: Ja, updateKeyVisualState: Et, updateSelectedKey: Za, updateSelectedObject: Qa, clamp: eo, cloneCamera: At, configureCore: Lo, defaultCamera: at, sampleCamera: Ke, sampleObjectTransform: O, sanitizeState: A, worldTransform: k } = e;
  return {
    setChannelFilter(w) {
      xt(this, w);
    },
    setFrame(w, C = !1, T = !0) {
      this.frame = eo(Math.round(w), 0, this.state.duration_frames - 1), this.editingKeyFrame !== this.frame && (this.editingKeyFrame = null), this.camera = Ke(this.activeCameraTrack(), this.frame, this.state.objects), Pt(this, this.activeCameraTrack(), this.camera, this.frame), this.applyObjectAnimationFrame();
      const N = this.dom ||= fs(this.root);
      ...
      for (const Q of N.cameraFocal) document.activeElement !== Q && (Q.value = xr(this.camera.fov));
      ...
      const q = Math.floor(Z / 60), ie = Math.floor(Z % 60), _e = Math.floor(Z % 1 * 1e3), Oe = this.frame % Math.max(1, Math.round(this.state.fps)), Xe = Math.floor(this.frame / this.state.fps);
      if ((N.time || this.root.querySelector('[data-role="time"]')).textContent = this.state.timecode_mode === "timecode" ? `${String(Math.floor(Xe / 3600)).padStart(2, "0")}:${String(Math.floor(Xe / 60) % 60).padStart(2, "0")}:${String(Xe % 60).padStart(2, "0")}:${String(Oe).padStart(2, "0")}` : `${String(q).padStart(2, "0")}:${String(ie).padStart(2, "0")}.${String(_e).padStart(3, "0")}`, T) this.refreshKeys();
      else {
        xo(this);
    ...
    setSpatialHandleMode(w) {
      if (!Io.includes(w)) return;
      const T = this.activeCameraTrack()?.keyframes || [], N = T.findIndex((Z) => Z.frame === this.selectedKeyFrame);
      if (N < 0) {
        this.setStatus(s("Select a camera keyframe first"));
        return;
      }
      this.checkpoint(s("Camera path handle: {mode}").replace("{mode}", w)), Du(T[N], w, {
        prevKey: T[N - 1] || null,
        nextKey: T[N + 1] || null
    ...
    transformCameraPath(w) {
      ...
      const T = pc(C.keyframes, { origin: fc(C.keyframes), ...w });
      return C.keyframes = T, C.id === this.state.active_camera_id && (this.state.keyframes = T), this.camera = Ke(C, this.frame, this.state.objects), C.camera = At(this.camera), this.serialize(), this.refreshKeys(), this.refreshInspector(), this.render(), this.renderCameraView?.(), !0;
    },
    toggleCurveHandles() {
      St(this);
    },
    ...
    playblastCameraAtFrame() {
      return Pt(this, d(this), Ia(this, Ke), this.frame);
    },
    viewportCamera() {
      return sa(this);
    },
    ...
    lookAtObject(w) {
      ...
      if (C) {
        ...
        this.camera = Ke(this.state, this.frame), this.serialize(), this.refreshKeys(), this.render(), this.setStatus(`Cameras look at ${C.name || C.type}`);
      }
    },
    setTransformMode(w) {
      _t(this, w);
    ...
    refreshInspector() {
      this.perf && (this.perf.inspectorRefreshCount = (this.perf.inspectorRefreshCount || 0) + 1), Oa(this), Zu(this);
    },
    setInspectorMode(w) {
      Qu(this, w);
    },
    ...
    aimAtSelectedObject(w) {
      ...
      const C = this.activeCameraTrack(), T = w && this.state.objects.find((q) => q.id === w) || this.selectedObject() || this.state.objects.find((q) => q.id === "subject") || this.state.objects[0];
      if (!T) return;
      ...
      const Z = (T.type === "model" || T.type === "glb" ? this.webgl?.getObjectWorldCenter?.(T.id) : null) || (T.keyframes?.length ? O(T, this.frame).position : T.position || [0, 1.5, 0]);
      this.camera.target = [...Z], this.beginCameraEdit(), this.commitCameraEdit(), this.finishCameraEdit(), this.serialize(), this.refreshInspector(), this.updateHudCamera(), this.render(), this.setStatus(`Camera tracking locked to ${T.name || T.id}`);
    },
    setAimBone(w) {
      Hh(this, w);
    },
    ...
    setCameraTrackingTarget(w) {
      ...
      const C = this.activeCameraTrack();
      C.target_object_id !== (w || null) && (C.aim_bone = null), C.target_object_id = w || null, C.id === this.state.active_camera_id && (this.state.target_object_id = w || null, this.state.aim_bone = C.aim_bone), this.camera = Ke(C, this.frame, this.state.objects), Pt(this, C, this.camera, this.frame), this.serialize(), this.refreshInspector(), this.render(), this.setStatus(w ? `Camera tracking: ${w}` : "Camera tracking disabled (manual target)");
    },
    bakeAimToKeyframes() {
      this.checkpoint("Bake aim to keyframes");
      const w = this.activeCameraTrack(), C = w.target_object_id || this.state.target_object_id || "subject", T = this.state.objects.find((Z) => Z.id === C) || this.state.objects[0];
      ...
      for (const Z of w.keyframes) {
        const q = (T.type === "model" || T.type === "glb") && N && !T.keyframes?.length ? N : T.keyframes?.length ? O(T, Z.frame).position : T.position || [0, 1.5, 0];
        Z.camera.target = [...q];
      }
...
function tb(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: h, playblastCameraTrack: d, restoreFromWidgets: f, serializeEditorState: u, syncActiveCameraTrack: b, syncFromWidgets: v, bindEditorEvents: g, activateCamera: y, addCamera: S, deleteCamera: x, drawPreviewOverlays: E, duplicateCamera: M, maximizeCameraPreview: R, refreshCameraPreviews: L, refreshCameraSelectors: X, renameCamera: W, setPlayblastCamera: V, toggleCameraView: se, captureRealtime: j, makePlayblast: F, uploadDirectorPlayblast: B, waitForMediaFrame: G, computeAudioPeaks: te, loadAudioFile: $, releaseAudio: H, stopPlay: P, togglePlay: U, applyCameraPreset: J, applyCameraShake: de, applyProxyPreset: me, clearViewportBgImage: ae, loadViewportBgFile: pe, loadViewportBgSequence: fe, drawCameraPath: ue, drawCard: ve, drawCube: ge, drawGrid: ye, drawHuman: z, drawLine3D: K, drawNull: re, drawOverlays: ce, drawPointField: ne, drawSpeedHeatmap: ke, drawSphere: Te, curveChannels: et, drawCurveEditor: ht, fitCurveView: ut, onCurveDoubleClick: bt, onCurvePointerDown: gt, onCurvePointerMove: Ut, onCurvePointerUp: Wt, onTimelinePointerDown: Vt, onTimelinePointerMove: yt, onTimelinePointerUp: vt, refreshKeys: tt, resetCurveZoom: xt, resetTimelineZoom: wt, setChannelFilter: kt, setCurveInterpolation: Ht, setTangentMode: St, timelineFrameFromEvent: Gt, toggleCurveHandles: Yt, zoomCurve: Xt, drawTransformGizmo: Jt, frameTarget: Zt, gizmoAxes: Qt, gizmoGeometry: ea, onPointerDown: ta, onPointerMove: aa, onPointerUp: oa, onWheel: ra, pickGizmo: jt, pickSceneObject: _t, resetCamera: na, setTransformMode: sa, setViewMode: Oo, viewportCamera: Po, loadCardFile: ia, loadExecutionPreview: ca, loadMediaUrl: la, loadModelFile: da, loadSelectedReference: ma, onModelLoaded: pa, restoreAssets: fa, syncUpstreamInputs: Ct, configureDomMedia: ha, refreshSetupDiagnostic: ua, addMediaCard: ba, addPrimitive: ga, applyObjectAnimationFrame: ya, beginCameraEdit: va, beginObjectEdit: xa, commitCameraEdit: wa, commitObjectEdit: ka, copyKeyframe: Sa, deleteKeyframe: ja, deleteObject: _a, duplicateObject: Ca, exitKeyEdit: Ea, finishCameraEdit: Aa, goToAdjacentKey: $a, insertKeyframe: Ma, loadSelectedKeyView: Ta, pasteKeyframe: Ia, playblastCameraAtFrame: Oa, refreshInspector: Pa, refreshKeyEditor: La, refreshObjects: Fa, removeObjectResources: za, renameObject: Na, retimeSelectedKey: Ra, selectKeyframe: Ka, selectedKeyframe: Da, selectedObject: Ba, selectObjectAnimation: qa, setKeyInterpolation: Ua, setObjectParent: Ye, timelineKeyframes: Wa, timelineObject: Va, toggleAutoKey: Ha, toggleObject: Ga, updateCameraFromHud: Ya, updateEditState: Xa, updateKeyVisualState: Ja, updateSelectedKey: Et, updateSelectedObject: Za, clamp: Qa, cloneCamera: eo, configureCore: At, defaultCamera: Lo, sampleCamera: at, sampleObjectTransform: Ke, sanitizeState: O, worldTransform: A } = e;
  return {
    setTargetAtCursor(k) {
      if (!k) return;
...
function ob(e) {
  const { right: t, up: a, forward: o } = hc(e || {});
  return ab.map((r) => {
...
const sb = "http://www.w3.org/2000/svg", st = 26, An = 17, ib = 5.4;
function it(e, t) {
  const a = document.createElementNS(sb, e);
...
function cb(e) {
  ...
  for (const n of rb(ob(a))) {
    const i = st + n.x * An, c = st + n.y * An, l = nb(n.depth);
    t.appendChild(it("line", {
      x1: st,
      y1: st,
      x2: i,
      y2: c,
...
function db(e) {
  ...
  for (const r of e.state.motion_layers || []) {
    ...
    const n = lb(e.state, r, e.frame, a, o);
    if (n.length) {
...
const mb = ["world_point", "object_point", "camera_field"], Vs = {
  manual_2d: "DRAW",
  object_point: "OBJECT",
  world_point: "WORLD",
...
function fb(e, t) {
  if (mb.includes(t.source_kind)) {
    const a = yr(e, t.source, 0, e.width || 1280, e.height || 720);
...
function bb(e) {
  ...
  n("motion-sel-name", a.label), n("motion-sel-type", Vs[a.source_kind] || "TRACK"), n("motion-sel-binding", pb(e.state, a)), n("motion-sel-start", r.length ? Math.min(...r) : 0), n("motion-sel-end", r.length ? Math.max(...r) : 0);
...
function vb(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: h, playblastCameraTrack: d, restoreFromWidgets: f, serializeEditorState: u, syncActiveCameraTrack: b, syncFromWidgets: v, bindEditorEvents: g, activateCamera: y, addCamera: S, deleteCamera: x, drawPreviewOverlays: E, duplicateCamera: M, maximizeCameraPreview: R, refreshCameraPreviews: L, refreshCameraSelectors: X, renameCamera: W, setPlayblastCamera: V, toggleCameraView: se, captureRealtime: j, makePlayblast: F, uploadDirectorPlayblast: B, waitForMediaFrame: G, computeAudioPeaks: te, loadAudioFile: $, releaseAudio: H, stopPlay: P, togglePlay: U, applyCameraPreset: J, applyCameraShake: de, applyProxyPreset: me, clearViewportBgImage: ae, loadViewportBgFile: pe, loadViewportBgSequence: fe, drawCameraPath: ue, drawCard: ve, drawCube: ge, drawCylinder: ye, drawGrid: z, drawHuman: K, drawLine3D: re, drawNull: ce, drawOverlays: ne, drawPointField: ke, drawSpeedHeatmap: Te, drawSphere: et, drawTorus: ht, curveChannels: ut, drawCurveEditor: bt, onCurvePointerDown: gt, onCurvePointerMove: Ut, onCurvePointerUp: Wt, onTimelinePointerDown: Vt, onTimelinePointerMove: yt, onTimelinePointerUp: vt, refreshKeys: tt, resetCurveZoom: xt, resetTimelineZoom: wt, setChannelFilter: kt, setCurveInterpolation: Ht, setTangentMode: St, timelineFrameFromEvent: Gt, toggleCurveHandles: Yt, zoomCurve: Xt, drawTransformGizmo: Jt, frameTarget: Zt, gizmoAxes: Qt, gizmoGeometry: ea, onPointerDown: ta, onPointerMove: aa, onPointerUp: oa, onWheel: ra, pickGizmo: jt, pickSceneObject: _t, resetCamera: na, setTransformMode: sa, setViewMode: Oo, viewportCamera: Po, loadCardFile: ia, loadExecutionPreview: ca, loadMediaUrl: la, loadModelFile: da, loadSelectedReference: ma, onModelLoaded: pa, restoreAssets: fa, syncUpstreamInputs: Ct, configureDomMedia: ha, refreshSetupDiagnostic: ua, addMediaCard: ba, addPrimitive: ga, applyObjectAnimationFrame: ya, beginCameraEdit: va, beginObjectEdit: xa, commitCameraEdit: wa, commitObjectEdit: ka, copyKeyframe: Sa, deleteKeyframe: ja, deleteObject: _a, duplicateObject: Ca, exitKeyEdit: Ea, finishCameraEdit: Aa, goToAdjacentKey: $a, insertKeyframe: Ma, loadSelectedKeyView: Ta, pasteKeyframe: Ia, playblastCameraAtFrame: Oa, refreshInspector: Pa, refreshKeyEditor: La, refreshObjects: Fa, removeObjectResources: za, renameObject: Na, retimeSelectedKey: Ra, selectKeyframe: Ka, selectedKeyframe: Da, selectedObject: Ba, selectObjectAnimation: qa, setKeyInterpolation: Ua, setObjectParent: Ye, timelineKeyframes: Wa, timelineObject: Va, toggleAutoKey: Ha, toggleObject: Ga, updateCameraFromHud: Ya, updateEditState: Xa, updateKeyVisualState: Ja, updateSelectedKey: Et, updateSelectedObject: Za, clamp: Qa, cloneCamera: eo, configureCore: At, defaultCamera: Lo, sampleCamera: at, sampleObjectTransform: Ke, sanitizeState: O, worldTransform: A } = e;
  return {
    ...
    renderViewportOnly() {
      ...
      if (k.fillStyle = this.state.viewport_bg_color || "#121212", k.fillRect(0, 0, w, C), this.viewportBgSequenceImages && this.viewportBgSequenceImages.length) {
        const oe = this.frame % this.viewportBgSequenceImages.length, De = this.viewportBgSequenceImages[oe];
        if (De?.complete && De.naturalWidth)
          try {
            k.drawImage(De, 0, 0, w, C);
          } catch {
          }
      ...
      const T = this.state.render_mode, N = this.viewportCamera(), Z = this.state.objects.some((oe) => oe.parent_id) ? this.state.objects.map((oe) => oe.parent_id ? { ...oe, ...A(this.state.objects, oe) } : oe) : this.state.objects, q = (this.viewportBgSequenceImages || []).map((oe) => oe.src), ie = this.viewportBgImage?.src || "", _e = this.pendingExtractorImport, Oe = _e ? [...this.state.cameras, {
        id: "__extractor_preview__",
        name: _e.label,
        color: "#9ca3af",
        camera: _e.track.keyframes[0]?.camera,
        keyframes: _e.track.keyframes
      }] : this.state.cameras, Xe = {
        ...this.state,
        cameras: Oe,
        objects: Z,
      ...
      if (this.webgl)
        try {
          const oe = this.recording ? 1 : this.webgl.supersampleFactor?.() ?? 1, De = oe > 1 ? Math.min(oe, 4096 / Math.max(1, w, C)) : 1, to = De > 1 ? Math.round(w * De) : w, Fo = De > 1 ? Math.round(C * De) : C;
          this.webgl.render(Xe, N, this.cardMediaById, to, Fo, this.modelUrlsById, this.frame, this.recording, this.selectedEntity, this.selectedObjectId, this.subSelection, this.selectedKeyFrame ?? null), k.imageSmoothingEnabled = !0, k.imageSmoothingQuality = "high", to !== w || Fo !== C ? k.drawImage(this.webgl.canvas, 0, 0, to, Fo, 0, 0, w, C) : k.drawImage(this.webgl.canvas, 0, 0, w, C), Q = !0;
        } catch (oe) {
      ...
      if (!Q) {
        ...
        for (const oe of Z)
          oe.enabled !== !1 && (oe.type === "card" && ["omni_ref", "card_grid", "graybox", "wireframe"].includes(T) ? this.drawCard(oe) : ["cube", "ground", "glb", "model"].includes(oe.type) && T !== "grid" && T !== "point_field" ? this.drawCube(oe) : oe.type === "sphere" && T !== "grid" && T !== "point_field" ? this.drawSphere(oe) : oe.type === "cylinder" && T !== "grid" && T !== "point_field" ? this.drawCylinder(oe) : oe.type === "torus" && T !== "grid" && T !== "point_field" ? this.drawTorus(oe) : oe.type === "human" && T !== "grid" && T !== "point_field" ? this.drawHuman(oe) : oe.type === "null" && this.drawNull(oe));
        !this.recording && this.state.show_camera_paths && this.drawCameraPath();
      }
      !this.recording && this.state.speed_heatmap && this.drawSpeedHeatmap(), !this.recording && Of(this), this.drawOverlays(), db(this), this.state.show_gizmo && cb(this), this.labelOverlay?.update(), this.rigOverlay?.update(), this.perf && (this.perf.viewportRenderCount = (this.perf.viewportRenderCount || 0) + 1);
    },
    ...
    requestUiUpdate(k = _.viewport, w = "unknown") {
      (this.renderReasons ||= /* @__PURE__ */ new Set()).add(w), this.uiDirtyMask = ym(this.uiDirtyMask, k), this.renderInvalidations = (this.renderInvalidations || 0) + 1, !this.renderScheduled && (this.renderScheduled = !0, this.renderFrame = requestAnimationFrame(() => {
        if (this.renderScheduled = !1, this.disposed) return;
        const C = this.uiDirtyMask || _.viewport;
        this.uiDirtyMask = 0, this.lastRenderReasons = [...this.renderReasons || []], this.renderReasons?.clear(), this.rendersCoalesced = (this.rendersCoalesced || 0) + 1, this.perf && (this.perf.renderCount = (this.perf.renderCount || 0) + 1), rt(C, _.outliner) && this.refreshObjects(), rt(C, _.timeline) && this.refreshKeys(), rt(C, _.inspector) && this.refreshInspector(), rt(C, _.viewport) && this.renderViewportOnly(), rt(C, _.previews) && this.renderCameraView(), rt(C, _.motion) && this.renderMotionUiOnly();
      }));
    },
    renderCameraView() {
      if (this.perf && (this.perf.previewRenderCount = (this.perf.previewRenderCount || 0) + 1), this.state.camera_view_visible) {
        ...
        let T = null;
        if (C) {
          const N = this.state.active_camera_id, Z = w.filter((q) => q.id !== N);
          T = Z.length ? Z[this.cameraPreviewTick % Z.length] : null;
        }
        for (const N of w) {
          const Z = this.cameraPreviewCanvases.get(N.id), q = this.cameraPreviewContexts.get(N.id);
          if (!Z?.width || !q) continue;
          const ie = Z.width, _e = Z.height, Oe = this.root.querySelector(`[data-camera-frame="${N.id}"]`);
          if (Oe && (Oe.textContent = `F${this.frame}`), C && N.id !== this.state.active_camera_id && N !== T) continue;
          const Xe = Pt(this, N, at(N, this.frame, this.state.objects), this.frame);
          if (q.fillStyle = "#111", q.fillRect(0, 0, ie, _e), this.cameraWebgl)
            try {
              this.cameraWebgl.render({ ...this.state, keyframes: [], playblast_grid: !1, viewport_bg_image: this.viewportBgImage?.src || "", viewport_bg_sequence: (this.viewportBgSequenceImages || []).map((Q) => Q.src), __omnicamRevision: this.renderRevision || 0 }, Xe, this.cardMediaById, ie, _e, this.modelUrlsById, this.frame, !0), q.drawImage(this.cameraWebgl.canvas, 0, 0, ie, _e);
            } catch (Q) {
    ...
    dispose() {
      this.disposed || (this.disposed = !0, this.agentBridge?.dispose?.(), uc(this), bc(), Xc(this), this.backgroundRequestId = (this.backgroundRequestId || 0) + 1, this.upstreamSyncId = (this.upstreamSyncId || 0) + 1, this.stopPlay(), clearTimeout(this.previewClickTimer), clearTimeout(this.connectionTimer), cancelAnimationFrame(this.restoreFrame), cancelAnimationFrame(this.serializeFrame), cancelAnimationFrame(this.resizeFrame), cancelAnimationFrame(this.renderFrame), this.abortController?.abort(), this.upstreamFetchController?.abort(), this.resizeObserver?.disconnect(), this.contextMenu?.dispose(), this.webgl?.dispose(), this.cameraWebgl?.dispose(), H(this), sh(this), this.objectUrls.clear(), this.cardMediaById.clear(), this.cardMediaAssetById?.clear?.(), this.modelUrlsById.clear(), this.modelInfoById.clear());
    }
  };
}
const Hs = 1e-9;
...
function Lr(e, t) {
  const a = e.map((i) => xb(i, t)), o = wb(a), r = e.map((i) => i.frame), n = Math.max(1, r[r.length - 1] - r[0]);
  return a.map((i, c) => [
    (r[c] - r[0]) / n,
...
function Sb(e, t, { tolerance: a = 0.02, keepFrames: o = [] } = {}) {
  const r = [...e].sort((m, h) => m.frame - h.frame);
  if (r.length <= 2 || a <= 0) return { keys: r, removed: 0 };
  const n = Lr(r, t), i = /* @__PURE__ */ new Set(), c = new Set(o);
  r.forEach((m, h) => {
...
function jb(e, t, { target: a = 2, keepFrames: o = [] } = {}) {
...
function _b(e, t, { mergeWithin: a = 1, epsilon: o = 1e-3, keepFrames: r = [] } = {}) {
...
function Eb(e, t, a, { lastFrame: o = 1 / 0 } = {}) {
...
function Tb() {
  return {
    ...
    resolveSelectedFrames() {
      const e = new Set(je(this).map((a) => a.frame));
    ...
    _activeTrack() {
      ...
      return {
        kind: "camera",
        write: (a) => {
          t.keyframes = a, this.state.keyframes = a, Zo(this);
        }
      };
    },
    deleteSelectedKeyframes() {
      ...
      if (!e.length) {
        const l = je(this).find((p) => p.frame === this.frame);
        l && (e = [l.frame]);
      }
      if (!e.length) return this.setStatus(s("Select a keyframe to delete"));
      const t = this._activeTrack(), a = je(this), o = t.kind === "camera" ? 1 : 0, { keys: r, removed: n } = Cb(a, e, { minKeys: o });
    ...
    nudgeSelectedKeyframes(e) {
      ...
      const a = this._activeTrack(), o = Math.max(0, this.state.duration_frames - 1), r = Eb(je(this), t, e, { lastFrame: o });
    ...
    setSelectedKeysInterpolation(e) {
      ...
      this.checkpoint(s("Interpolation on {n} keys").replace("{n}", t.length)), a.write(Ab(je(this), t, e)), this.serialize(), this.refreshKeys(), this.refreshKeyEditor(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} interpolation on {n} keys").replace("{mode}", e.replace(/_/g, " ")).replace("{n}", t.length));
    },
    setSelectedKeysTangentMode(e) {
      const t = this.resolveSelectedFrames();
      if (t.length < 2) return this.setTangentMode(e);
      const a = this._activeTrack(), o = Qe(this).map((r) => r.id);
      this.checkpoint(s("Tangents on {n} keys").replace("{n}", t.length)), a.write($b(je(this), t, e, o)), this.serialize(), this.refreshKeys(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} tangents on {n} keys").replace("{mode}", e).replace("{n}", t.length));
    },
    /**
    ...
    simplifyActiveKeys({ mode: e = "simplify", tolerance: t = 0, target: a = 0, scope: o = "camera", fromKeys: r = null, silent: n = !1 } = {}) {
      ...
      const l = this.resolveSelectedFrames(), p = o !== "all_cameras" && l.length >= 2 ? [l[0], l.at(-1)] : null, m = p ? [] : l, h = (u) => {
        const b = [...u].sort((R, L) => R.frame - L.frame), v = p ? p[0] : -1 / 0, g = p ? p[1] : 1 / 0, y = b.filter((R) => R.frame < v), S = b.filter((R) => R.frame >= v && R.frame <= g), x = b.filter((R) => R.frame > g);
        let E = S, M = 0;
        if (S.length > 2) {
          const R = e === "reduce" ? jb(S, i, { target: a || Math.ceil(S.length / 2), keepFrames: m }) : e === "clean" ? _b(S, i, { keepFrames: m }) : Sb(S, i, { tolerance: t * Mb, keepFrames: m });
          E = R.keys, M = R.removed;
        }
        return { keys: [...y, ...E, ...x].sort((R, L) => R.frame - L.frame), removed: M };
      };
      let d = 0;
      const f = c.map((u) => {
        const b = r && u.primary ? r : u.get(), { keys: v, removed: g } = h(b);
        return d += g, { track: u, keys: v };
      });
      n || this.checkpoint(s("Simplify keyframes"));
      for (const { track: u, keys: b } of f) u.set(b);
      return Zo(this), this.selectedKeyFrame = null, this.selectedKeyFrames = /* @__PURE__ */ new Set(), this.camera = Ce(this.state, this.frame), this.applyObjectAnimationFrame(), this.serialize(), this.refreshKeys(), this.setFrame(this.frame, !1, !1), this.render(), n || this.setStatus(d ? s("Removed {n} keyframes").replace("{n}", d) : s("No keyframes to remove")), d;
    },
...
class Gs {
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-DxBWOkWK.js"));
    } catch (a) {
    ...
    if (!this.disposed) {
      ...
      gc(this), this.resizeCanvas(), this.render(), this.renderCameraView();
    }
  }
}
const fo = { app: Mn, api: He, EditorHistory: ss, ContextMenuController: Vn, initializeTooltips: Zc, promptText: Rt, ObjectUrlRegistry: is, buildRoot: cs, dispatchDirectorKey: yc, activeCameraTrack: Jo, bindWidgetCallbacks: Qc, playblastCameraTrack: Wn, restoreFromWidgets: el, serializeEditorState: tl, syncActiveCameraTrack: Zo, syncFromWidgets: al, bindEditorEvents: Hf, activateCamera: ol, addCamera: rl, deleteCamera: nl, drawPreviewOverlays: sl, duplicateCamera: il, maximizeCameraPreview: cl, refreshCameraPreviews: ll, refreshCameraSelectors: dl, renameCamera: ml, setPlayblastCamera: pl, toggleCameraView: fl, captureRealtime: Ms, makePlayblast: wh, uploadDirectorPlayblast: Ts, waitForMediaFrame: $s, computeAudioPeaks: js, loadAudioFile: oh, releaseAudio: _o, stopPlay: yo, togglePlay: eh, applyCameraPreset: up, applyCameraShake: bp, applyProxyPreset: gp, clearViewportBgImage: _h, loadViewportBgFile: Sh, loadViewportBgSequence: jh, drawCameraPath: Rh, drawCard: Nh, drawCube: Ih, drawCylinder: Lh, drawGrid: Ah, drawHuman: Ph, drawLine3D: le, drawNull: zh, drawOverlays: Dh, drawPointField: Th, drawSpeedHeatmap: Kh, drawSphere: Oh, drawTorus: Fh, curveChannels: Qe, drawCurveEditor: Yl, fitCurveView: es, onCurveDoubleClick: Hl, onCurvePointerDown: Nl, onCurvePointerMove: Rl, onCurvePointerUp: Kl, onTimelinePointerDown: vc, onTimelinePointerMove: xc, onTimelinePointerUp: wc, refreshKeys: dd, resetCurveZoom: Gl, resetTimelineZoom: kc, setChannelFilter: Bl, setCurveInterpolation: Dl, setTangentMode: ql, timelineFrameFromEvent: dr, toggleCurveHandles: Ul, zoomCurve: Vl, drawTransformGizmo: Sc, frameTarget: jc, gizmoAxes: _c, gizmoGeometry: Cc, onPointerDown: Ec, onPointerMove: Ac, onPointerUp: $c, onWheel: Mc, pickGizmo: Tc, pickSceneObject: Ic, resetCamera: Oc, setTransformMode: Pc, setViewMode: Lc, viewportCamera: Fc, loadCardFile: mh, loadExecutionPreview: ph, loadMediaUrl: As, loadModelFile: dh, loadSelectedReference: fh, onModelLoaded: lh, restoreAssets: ch, syncUpstreamInputs: hh, configureDomMedia: _s, refreshSetupDiagnostic: Uh, addMediaCard: tu, addPrimitive: Jh, applyObjectAnimationFrame: gu, beginCameraEdit: ju, beginObjectEdit: Ns, commitCameraEdit: _u, commitObjectEdit: ru, copyKeyframe: wu, deleteKeyframe: xu, deleteObject: zs, deleteSelectedObjects: eu, duplicateObject: Fs, exitKeyEdit: Eu, finishCameraEdit: Cu, goToAdjacentKey: zu, insertKeyframe: yu, loadSelectedKeyView: Fu, pasteKeyframe: ku, playblastCameraAtFrame: bu, refreshInspector: au, refreshKeyEditor: Ou, refreshObjects: Ls, removeObjectResources: du, renameObject: Zh, retimeSelectedKey: Pu, selectKeyframe: Su, selectedKeyframe: Re, selectedObject: qt, selectObjectAnimation: lu, setKeyInterpolation: vu, setKeyTangentMode: Iu, setObjectParent: cu, timelineKeyframes: je, timelineObject: Me, toggleAutoKey: Au, toggleObject: Qh, updateCameraFromHud: iu, updateCameraRotationFromHud: su, updateEditState: Mu, updateKeyVisualState: Tu, updateSelectedKey: Lu, updateSelectedObject: ou, clamp: Y, cloneCamera: he, configureCore: Un, defaultCamera: fr, sampleCamera: Ce, sampleObjectTransform: $o, sanitizeState: ur, worldTransform: br };
Object.assign(
  Gs.prototype,
  Uu(fo),
  eb(fo),
...
function Ib(e) {
  ...
  ho("director:attach:start", e), ho("director:constructor:start", e);
  const t = new Gs(e);
  ho("director:constructor:complete", e), Dm(t);
  try {
    t.agentBridge = Wm(t, e, He);
  } catch (m) {
  ...
  try {
    t.characterRuntime = cp(t), t.rigMapper = dp(t), t.poseEditor = fp(t), t.motionEditor = hp(t);
  } catch (m) {
    console.warn("[OmniCam] Character tools unavailable", m);
  }
  e.__majoorOmniCam = t, ho("director:marker:assigned", e), t.hideInternalWidgets();
  ...
  }, t.unwatchGraphConnections = Jc(e, i);
  const l = e.onRemoved;
