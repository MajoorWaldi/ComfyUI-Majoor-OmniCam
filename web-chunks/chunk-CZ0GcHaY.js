import { bJ as d, c as _, v as k, b6 as A, bK as W, e as b, bL as x, s as u, a as K } from "./chunk-D3iZD33H.js";
import { a as M } from "./chunk-CTXwjaoT.js";
const L = 360;
function C({ containerWidth: e, otherColumnWidth: a = 0, resizeGutterWidth: s = 18, staticMax: r }) {
...
function w(e, a) {
  if (a.neighborStateKey) {
    ...
    return Math.max(a.bounds.min, C({ containerWidth: s, otherColumnWidth: r, staticMax: a.bounds.max }));
  }
  if (a.panelSelector) {
