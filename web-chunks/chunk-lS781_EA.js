...
import { a as xe, y as Z, z as pe, u as r, A as qr, B as Ao, C as Ie, c as le, E as oo, F as rs, G as To, H as Br, J as ns, K as ss, L as is, M as cs, N as wo, v as Zo, O as Wr, P as ko, Q as Vr, R as Hr, S as Ur, T as Gr, i as Xr, U as So, V as lo, W as Jo, X as Qo, Y as Yr, k as er, Z as ls, _ as ds, $ as ms, a0 as ps, a1 as fs, g as ye, p as Zr, h as Jr, a2 as tr, e as _e, a3 as hs, a4 as Qr, t as bs, a5 as us, a6 as Po, a7 as gs, a8 as ys, o as vs, a9 as xs, aa as ws, ab as ks, ac as Io, ad as Ss, ae as js, af as Cs, ag as Es, ah as _s, ai as $s, aj as Ms, ak as As, al as Ts, am as Ps, an as Is, ao as zs, ap as Fs, aq as Ls, ar as Os, as as Ks, at as Ds, au as Ns, av as Rs, aw as qs, ax as Bs, ay as Ws, az as Vs, aA as Hs, aB as Us, aC as Gs, aD as Xs, aE as Ys, aF as Zs, aG as Js, aH as Qs, aI as ei, aJ as ti, aK as ai, aL as oi, aM as ri, aN as ni, aO as si, aP as ii, aQ as ci, aR as li, aS as di, aT as mi, l as Be, aU as pi, aV as mo, aW as fi, aX as hi, aY as bi, aZ as ui, a_ as gi, a$ as Pe, b0 as yi, b1 as en, b2 as zo, b3 as vi, b4 as xi, b5 as wi, b6 as tn, b7 as Ke, b8 as ki, b9 as Si, ba as ar, bb as Fo, bc as ji, bd as an, be as Ci, bf as Ei, bg as _i, b as on, r as $i, bh as Mi, bi as Ai, bj as Ti, bk as Pi, x as Ii, bl as zi, bm as Fi, bn as Li, bo as rn, bp as Oi, bq as Ki, br as Di, bs as Ni, bt as Ri, bu as qi, bv as Bi, bw as Wi, bx as Vi, by as Hi, bz as Ui, bA as Gi, bB as Xi, bC as Yi, bD as Zi, bE as Ji, bF as Qi, bG as ec, bH as tc, s as ac } from "./chunk-uqYr4LOd.js";
import { L as oc, a as rc, p as kt, f as Lo, b as nc, S as sc, c as or, d as ic, e as cc, r as lc, g as dc, n as mc, C as rr, h as St, o as nn, s as pc, i as fc, j as hc, k as sn, l as bc, m as uc, q as gc, t as yc, u as vc, v as xc, w as wc, x as kc, y as Sc, z as jc, A as Cc, B as Ec } from "./chunk-Cq34vFsW.js";
import { S as _c, b as $c, p as Mc } from "./chunk-DiX7WiXt.js";
import { n as Ac, p as Tc, a as Pc, s as po, S as cn, c as Ic, C as nr, b as zc, i as Fc, w as Lc, d as Oc, U as je, m as Kc, h as Ge, e as Dc, f as Nc, g as Rc, j as qc, r as Bc, k as Wc, l as Vc } from "./chunk-Lwtsj3M-.js";
import { T as Hc } from "./chunk-__IQ4xkd.js";
import { T as Uc, R as Gc } from "./vendor-three-BQUrLQkn.js";
import { b as Xc, p as ln, a as jo, c as Co, d as Yc, r as Zc, s as Jc, e as Qc } from "./chunk-CrB6zFwD.js";
  ...
  for (const $ of l) {
    ...
    if (e.showCurveHandles)
      for (let C = 0; C < c.length; C++) {
        ...
        const oe = i ? R.transform || i : R.camera || R, ee = z(R.frame), se = N($.get(oe)), fe = c[C - 1], de = c[C + 1], he = Math.max(1, R.frame - (fe?.frame ?? R.frame - 1)), be = Math.max(1, (de?.frame ?? R.frame + 1) - R.frame), O = rs(
          R,
          $.id,
          fe,
          de,
...
function Ol(e, t, a, o, n) {
  ...
  e.contextMenu?.show(t, s?.name || r("Shot"), [
    ...
    },
    {
      ...
      disabled: n === 1,
      run: () => {
        e.checkpoint("Remove shot"), ns(e.state, o) && Qe(e);
      }
    }
  ]);
}
...
function pd() {
  const e = rc.map((t) => `<button data-lens="${t}">${t}mm</button>`).join("");
  return `
...
const Cn = Object.freeze(["all", "character", "prop", "environment", "vehicle"]);
function br(e = {}) {
  const t = String(e.kind || "all").toLowerCase();
  return {
    kind: Cn.includes(t) ? t : "all",
...
function Qd(e, t = {}) {
  ...
  function g(k) {
    ...
    return ds({ preset: E, overrides: k?.pose }).joints;
  }
  function v() {
    const k = h();
  ...
  function j() {
    ...
    l && (l.textContent = k);
    const z = h(), N = g(z?.character)[k] || [0, 0, 0, 1], q = ms(N);
    m.forEach(($, W) => {
  ...
  function P() {
    const k = u();
    if (!k) return;
    const E = m.map((q) => Number(q?.value) || 0), z = ls(E), N = e.directorApi?.execute({
      version: 1,
...
function sm(e, { controlsFactory: t, anchorFactory: a } = {}) {
  ...
  function h({ targetSpec: k }) {
    if (k) {
      if (l(c), k.type === "object") {
        ...
        const E = fs(e), z = (E.length ? E : [k.object]).map((q) => ({
          object: q,
          transform: Ie(q)
        }));
  ...
  function g(k) {
    ...
    E.keyframes = bs(n.baseKeys, n.selectedFrames, z), u(E);
  }
  function v(k) {
    const E = e.state.cameras.find((z) => z.id === n.trackId);
    E && (E.keyframes = us(n.baseKeys, [n.frame], { delta: k.position }), u(E));
  }
  function j({ delta: k }) {
  ...
  function P(k) {
    ...
    n.tracking ? hs(e, E) : e.camera.target = E, e.commitCameraEdit();
  }
  ...
  function F() {
    ...
    const k = e.recording ? null : ps(e), E = e.state.gizmo_mode || "translate", z = !!k && !k.readOnly && nm.has(k.type) && k.allowedModes.includes(E);
...
function gm(e, t, a, o) {
  ...
  const p = $n(n, a, o), f = Mn(e, n, a, o), [d, h] = Eo(n, a, o);
...
function xm(e, t, a) {
  ...
  const o = () => {
    ...
    const h = ys(t('[data-role="object-tags"]')?.value || "");
    h.length ? d.tags = h : delete d.tags;
    const b = String(t('[data-role="object-annotation"]')?.value || "").trim(), u = b ? vs({
      text: b,
  ...
  }, { passive: !1, signal: a }), e.root.addEventListener("wheel", Mc(e.root), { signal: a }), window.addEventListener("pointermove", (d) => {
  ...
  const m = (d) => {
    const h = xs(d.composedPath?.()[0] || d.target);
    h && (e.lastKeyZone = h);
  };
  e.root.addEventListener("focusin", m, { signal: a }), e.root.addEventListener("pointerdown", m, { capture: !0, signal: a }), e.root.addEventListener("focusout", (d) => {
    e.modalTransform && !e.root.contains(d.relatedTarget) && (gs(e), e.render());
  }, { signal: a });
...
function Sm(e) {
  const t = mi(e.id, e.defaultValue), a = `pref_${e.id.replace(/[^a-zA-Z0-9]/g, "_")}`;
  if (e.type === "boolean")
    return `
...
function An(e) {
  ...
  m && o?.fov != null && (m.textContent = nc(o.fov));
...
function Bm(e, t) {
  for (const o of e.root.querySelectorAll('[data-act="toggle-camera-lock"]'))
    o.addEventListener("click", (n) => {
      n.stopPropagation(), e.checkpoint?.("Toggle camera lock"), e.state.camera_lock = !e.state.camera_lock, e.serialize?.(), An(e), e.setStatus?.(e.state.camera_lock ? r("Camera View locked") : r("Camera View unlocked"));
    }, { signal: t });
...
const Ba = () => import("./chunk-22DB8GS4.js");
function Zm(e, t) {
...
function Jm(e, t) {
  ...
  pi().then((n) => {
    ...
    c === "health-slow" ? hi(e) : c === "health-smooth" ? bi(e) : c === "health-recenter" && ui(e);
  }, { signal: t });
...
function np(e) {
  ...
  const n = e.reconstruction, s = n.provider || "Reconstructed", i = Math.round(t * 100), c = lc(e), l = c.length ? `
` + c.map(([p, f]) => `${p}: ${f}`).join(`
`) : "", m = `${s} • ${o} (${i}%)${l}`;
  return {
    label: o,
...
function cp(e, t, a) {
  ...
  if (o) {
    const s = (i) => {
      const c = i.target.closest?.("[data-axis], [data-axis-center]") || i.target, l = c.getAttribute("data-axis"), m = gi(l?.toLowerCase(), e.state.view_mode);
...
function yp(e) {
  ...
  ], m = e.planeAxis === "y" ? Pn(l) : In(l, [0, 0, -1]), p = e.seedPoint ? 1 : 0, f = [];
...
function zn(e, t = e.cameraPathDraw) {
  const a = t?.pointerId;
  if (a != null)
    try {
...
function Te(e) {
  ...
  return t?.active ? (zn(e, t), e.cameraPathDraw = null, xt(e), e.setStatus?.(r("Draw Camera Path cancelled")), e.render?.(), !0) : !1;
}
function xp(e) {
  const t = e.cameraPathDraw;
  ...
  const n = mc(e.state), s = e.state.cameras.length, i = {
    id: n,
    name: vp(e.state),
...
async function $p(e) {
  ...
  const o = a?.metadata?.scene_name || Fn(e);
  Ho(e, a, { name: o, status: r("Scene reset to last save") });
}
async function Mp(e) {
  const t = Fn(e) || r("Untitled"), a = await kt(e, r("Save Scene"), r("Scene name"), t);
  if (a == null) return;
...
function Op(e) {
  ...
  if (!c) return;
  const l = Ln(t, e.state.width || 1280, e.state.height || 720), m = (y) => l.x + y * l.w, p = (y) => l.y + y * l.h;
...
function Kp(e, t) {
  ...
  a && a.addEventListener("click", (o) => {
    ...
    const s = Ln(a, e.state.width || 1280, e.state.height || 720), i = a.width / n.width, c = {
      x: ((o.clientX - n.left) * i - s.x) / Math.max(1, s.w),
      y: ((o.clientY - n.top) * i - s.y) / Math.max(1, s.h)
    }, l = vi(e.state.motion_layers, c, 0.09);
...
function Dp(e) {
  ...
  xi(e, t), wi(e, t), Kp(e, t), _m(e, a, t), cp(e, a, t), Xc(e, t), Ep(e, t), Pp(e, t), xm(e, a, t), ap(e, t);
}
function Np(e, t) {
...
async function Xp(e, t, { decode: a = Up } = {}) {
  ...
  try {
    ...
    On(e), e.setStatus(`Audio loaded: ${t.name || "track"}`);
  } catch (n) {
...
const Dn = /* @__PURE__ */ new WeakSet(), yt = /* @__PURE__ */ new WeakMap();
function to(e) {
...
function De(e, t, a, o = !1, n = "") {
  ...
  s && s !== a && Ct(e, t), o && Dn.add(a), Yp(a), e.cardMediaAssetById ||= /* @__PURE__ */ new Map(), e.cardMediaById.set(t, a), e.cardMediaAssetById.set(t, n || a?.__omnicamAsset || "");
  try {
    a.__omnicamAsset = n || a.__omnicamAsset || "";
  } catch {
  }
...
function Nn(e, t, { signal: a, timeout: o = 15e3 } = {}) {
...
async function Rn(e, t, a, o = () => !0, n = null) {
  if (!t || !a) return;
  const s = () => !e.disposed && o(), i = String(t.asset || a).toLowerCase();
  if (n ?? /\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/.test(i)) {
    const l = document.createElement("video");
    if (l.src = a, l.loop = !0, l.muted = !0, l.playsInline = !0, await Nn(l, ["loadeddata", "error"], { signal: e.abortController?.signal }).catch(() => {
    }), !s()) {
      to(l);
      return;
    }
...
async function sf(e) {
  ...
  pc(e) && (s = !0), s && (e.serialize(), e.render());
}
...
async function pf(e) {
  await Promise.all([...e].filter((t) => t instanceof HTMLVideoElement && t.seeking).map((t) => Nn(t, ["seeked", "error"], { timeout: 5e3 }).catch(() => {
  })));
}
async function qn(e) {
...
async function hf(e) {
  ...
  try {
    let s = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-CcmBOy0t.js");
    i !== "realtime" && await l(e.canvas.width, e.canvas.height) && (s = await c(e.canvas, e.state.duration_frames, e.state.fps, async (m) => {
      e.setFrame(m, !0), e.setStatus(r(`Encoding frame ${m + 1}/${e.state.duration_frames}…`)), await qn(e), await new Promise((p) => requestAnimationFrame(p));
    }, e.abortController?.signal, e.state.playblast_quality)), s || (e.setStatus(r("WebCodecs unavailable; recording realtime fallback…")), s = await Bn(e)), e.setFrame(t), await Wn(e, s);
  } catch (s) {
...
async function uf(e, t) {
  ...
  let n = null;
  try {
    if (e.setStatus(`Uploading background: ${t.name}`), n = await Vn(t), o !== e.backgroundRequestId || e.disposed) {
      await ao([n]);
      return;
    }
    const s = Ke(n.path);
...
async function gf(e, t) {
  ...
  try {
    ...
    for (const c of t)
      if (s.push(await Vn(c)), n !== e.backgroundRequestId || e.disposed) {
        await ao(s);
        return;
      }
...
function Gf({ keys: e, fps: t = 24, objects: a = [] } = {}) {
  ...
  for (let c = 1; c < o.length - 1; c += 1) {
    ...
    const d = Math.max(-1, Math.min(1, Si(l, m) / (p * f))), h = Math.acos(d) * 180 / Math.PI;
    h >= Rf && n.push({
...
function Gn(e) {
  ...
  const n = (d, h, b, u, y = "") => {
    ...
    `, y.addEventListener("click", () => {
      e.outlinerCollapsedSections ||= /* @__PURE__ */ new Set(), e.outlinerCollapsedSections.has(b) ? e.outlinerCollapsedSections.delete(b) : e.outlinerCollapsedSections.add(b), Gn(e);
...
function dh(e) {
  ...
  e.beginCameraEdit(), ji(e.camera, n), e.commitCameraEdit(), e.finishCameraEdit(), Jn(e), lh(e), e.render();
}
function mh(e) {
  const t = globalThis.performance?.now?.() ?? Date.now();
  (!Number.isFinite(e.lastCameraHudEditAt) || t - e.lastCameraHudEditAt > 300) && e.checkpoint("Edit camera"), e.lastCameraHudEditAt = t;
  ...
  e.camera.position = [a("camera-px", e.camera.position[0]), a("camera-py", e.camera.position[1]), a("camera-pz", e.camera.position[2])], e.camera.target = [a("camera-tx", e.camera.target[0]), a("camera-ty", e.camera.target[1]), a("camera-tz", e.camera.target[2])], e.camera.fov = Z(a("camera-fov", e.camera.fov), 5, 150), e.camera.roll = Z(a("camera-roll", e.camera.roll || 0), -180, 180), e.camera.near = Math.max(1e-4, a("camera-near", e.camera.near)), e.camera.far = Math.max(e.camera.near + 1e-4, a("camera-far", e.camera.far)), e.beginCameraEdit(), e.commitCameraEdit(), e.finishCameraEdit(), Jn(e), e.render();
}
function ph(e, t) {
  const a = Et(e);
  if (!a) return;
...
function bh(e) {
  ...
  if (!t.length) return [];
  if (t.length === 1)
    return Xn(e, t[0]), e.selectedObjectId ? [e.selectedObjectId] : [];
...
function _h(e, t) {
  t && (e.selectedKeyFrame = t.frame, e.selectedKeyFrames = /* @__PURE__ */ new Set([t.frame]), e.editingKeyFrame = null, ke(e) || (e.pathSelection = Ci(e.pathSelection, { cameraId: e.state.active_camera_id, frame: t.frame, additive: !1 })), e.setFrame(t.frame));
}
function $h(e) {
...
function Nh(e) {
  ...
  if (t.interpolation = e.root.querySelector('[data-role="key-interp"]').value, t.camera.position = [a("key-px", t.camera.position[0]), a("key-py", t.camera.position[1]), a("key-pz", t.camera.position[2])], t.camera.target = [a("key-tx", t.camera.target[0]), a("key-ty", t.camera.target[1]), a("key-tz", t.camera.target[2])], t.camera.fov = Z(a("key-fov", t.camera.fov), 5, 150), t.camera.roll = Z(a("key-roll", t.camera.roll || 0), -180, 180), t.camera.zoom = Math.max(0.01, a("key-zoom", t.camera.zoom || 1)), t.camera.near = Math.max(1e-4, a("key-near", t.camera.near)), t.camera.far = Math.max(t.camera.near + 1e-4, a("key-far", t.camera.far)), t.camera.camera_type = e.root.querySelector('[data-role="key-camera-type"]').value, e.root.querySelector('[data-role="key-timing-weight"]')) {
    const n = Ei(t, a("key-timing-weight", an(t)));
...
function Qh(e) {
  const t = Jh(e);
  e._lastInspectorSelKey !== void 0 && e._lastInspectorSelKey !== t && (e.inspectorMode = "entity"), e._lastInspectorSelKey = t, as(e);
}
function as(e) {
  const t = Zh(e);
...
function eb(e, t) {
  e.inspectorMode = Yh.includes(t) ? t : "entity", as(e), e.render?.(), e.refitNode?.();
}
function tb(e) {
  ...
  return {
    ...
    setSpatialHandleMode(w) {
      ...
      this.checkpoint(r("Camera path handle: {mode}").replace("{mode}", w)), Oc(A[K], w, {
        prevKey: A[K - 1] || null,
        nextKey: A[K + 1] || null
    ...
    setPathSelectionComponent(w) {
      this.pathSelection = Ai(this.pathSelection, w), this.refreshInspector(), this.render();
    },
    ...
    redistributeActiveCameraTiming() {
      ...
      const _ = [...w.keyframes].sort((K, X) => K.frame - X.frame), A = $i(_, {
    ...
    async openCameraPathPresetPicker() {
      ...
      const _ = zc.map((K) => ({ id: K, label: r(nr[K] || K) })), A = await nn({ title: r("Camera Path Preset"), items: _, owner: this });
...
function rb(e) {
  const { right: t, up: a, forward: o } = Ti(e || {});
  return ob.map((n) => {
...
const pb = ["world_point", "object_point", "camera_field"], os = {
  manual_2d: "DRAW",
  object_point: "OBJECT",
  world_point: "WORLD",
...
function gb(e) {
  ...
  s("motion-sel-name", a.label), s("motion-sel-type", os[a.source_kind] || "TRACK"), s("motion-sel-binding", fb(e.state, a)), s("motion-sel-start", n.length ? Math.min(...n) : 0), s("motion-sel-end", n.length ? Math.max(...n) : 0);
...
function xb(e) {
  ...
  return {
    ...
    requestUiUpdate(S = je.viewport, w = "unknown") {
      (this.renderReasons ||= /* @__PURE__ */ new Set()).add(w), this.uiDirtyMask = Kc(this.uiDirtyMask, S), this.renderInvalidations = (this.renderInvalidations || 0) + 1, !this.renderScheduled && (this.renderScheduled = !0, this.renderFrame = requestAnimationFrame(() => {
...
function kb() {
  return {
    ...
    deleteSelectedKeyframes() {
      ...
      const t = this._activeTrack(), a = ve(this), o = t.kind === "camera" ? 1 : 0, { keys: n, removed: s } = qc(a, e, { minKeys: o });
    ...
    nudgeSelectedKeyframes(e) {
      ...
      const a = this._activeTrack(), o = Math.max(0, this.state.duration_frames - 1), n = Rc(ve(this), t, e, { lastFrame: o });
    ...
    setSelectedKeysInterpolation(e) {
      ...
      this.checkpoint(r("Interpolation on {n} keys").replace("{n}", t.length)), a.write(Nc(ve(this), t, e)), this.serialize(), this.refreshKeys(), this.refreshKeyEditor(), this.render(), this.drawCurveEditor(), this.setStatus(r("{mode} interpolation on {n} keys").replace("{mode}", e.replace(/_/g, " ")).replace("{n}", t.length));
    },
    setSelectedKeysTangentMode(e) {
      const t = this.resolveSelectedFrames();
      if (t.length < 2) return this.setTangentMode(e);
      const a = this._activeTrack(), o = Ve(this).map((n) => n.id);
      this.checkpoint(r("Tangents on {n} keys").replace("{n}", t.length)), a.write(Dc(ve(this), t, e, o)), this.serialize(), this.refreshKeys(), this.render(), this.drawCurveEditor(), this.setStatus(r("{mode} tangents on {n} keys").replace("{mode}", e).replace("{n}", t.length));
    },
    /**
    ...
    simplifyActiveKeys({ mode: e = "simplify", tolerance: t = 0, target: a = 0, scope: o = "camera", fromKeys: n = null, silent: s = !1 } = {}) {
      ...
      const l = this.resolveSelectedFrames(), m = o !== "all_cameras" && l.length >= 2 ? [l[0], l.at(-1)] : null, p = m ? [] : l, f = (b) => {
        ...
        let M = j, P = 0;
        if (j.length > 2) {
          const D = e === "reduce" ? Bc(j, i, { target: a || Math.ceil(j.length / 2), keepFrames: p }) : e === "clean" ? Wc(j, i, { keepFrames: p }) : Vc(j, i, { tolerance: t * wb, keepFrames: p });
...
class Yo {
  ...
  constructor(t) {
    this.runtime = t;
    const a = t.node;
    this.disposed = !1, this.app = Rr, this.api = We, this.node = a, this.root = jn(), this.root.tabIndex = -1, this.dom = En(this.root), this.canvas = this.root.querySelector(".viewport-wrap > canvas"), this.cameraPreviewCanvases = /* @__PURE__ */ new Map(), this.cameraPreviewContexts = /* @__PURE__ */ new Map(), this.cameraPreviewSignature = "", this.interactionElement = this.canvas, this.interactionElement.tabIndex = 0, this.interactionElement.dataset.captureWheel = "true", this.ctx = this.canvas.getContext("2d", { alpha: !1 }), this.webgl = null, this.cameraWebgl = null, this.webglReady = this.loadWebGLViewports(), this.transformControlsWiring = sm(this), this.camera = xe(this.state, this.frame), this.playing = !1, this.drag = null, this.cameraEditActive = !1, this.cameraEditKey = null, this.keyDrag = null, this.timelineDrag = null, this.curveDrag = null, this.selectedKeyFrame = this.state.keyframes[0]?.frame ?? null, this.pathSelection = Fi(), this.editingKeyFrame = null, this.copiedKeyframe = null, this.cameraSpeed = 1, this.cardMedia = null, this.cardMediaById = /* @__PURE__ */ new Map(), this.cardMediaAssetById = /* @__PURE__ */ new Map(), this.objectUrls = new Sn(), this.cardUrlsById = this.objectUrls.urls, this.modelUrlsById = /* @__PURE__ */ new Map(), this.modelInfoById = /* @__PURE__ */ new Map(), this.executionReferences = [], this.selectedObjectId = null, this.selectedEntity = "camera", this.subSelection = null, this.cardUrl = null, this.recording = !1, this.gizmoDrag = null, this.playTimer = null, this.previewClickTimer = null, this.showCurveHandles = !0, this.uiDirtyMask = 0, this.perf = globalThis.__omnicamPerf === !0 ? { renderCount: 0, viewportRenderCount: 0, previewRenderCount: 0, timelineRefreshCount: 0, inspectorRefreshCount: 0, lastFrameMs: 0 } : null, this.contextMenu = new sn(this.root), this.history = new kn({ capture: () => JSON.stringify({ state: this.state, frame: this.frame, selectedEntity: this.selectedEntity, selectedObjectId: this.selectedObjectId, selectedObjectIds: [...this.selectedObjectIds || []], selectedKeyFrame: this.selectedKeyFrame, selectedKeyFrames: [...this.selectedKeyFrames || []], subSelection: this.subSelection }), restore: (o) => this.restoreHistorySnapshot(o) }), this.refreshCameraPreviews(), this.initializeTooltips(), this.bindEditorEvents(), this.bindWidgetCallbacks(), this.syncFromWidgets(), this.resizeCanvas(), this.render(), this.refreshKeys(), this.refreshObjects(), this.restoreAssets(), this.syncUpstreamInputs(), this.refreshSetupDiagnostic(), // Seed every frame-derived readout (timecode, lens millimetres, viewport
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-CcmBOy0t.js"));
    } catch (a) {
    ...
    if (!this.disposed) {
      ...
      Li(this), this.resizeCanvas(), this.render(), this.renderCameraView();
    }
  }
}
const Sb = [
...
const Ha = { app: Rr, api: We, EditorHistory: kn, ContextMenuController: sn, initializeTooltips: bc, promptText: kt, ObjectUrlRegistry: Sn, buildRoot: jn, dispatchDirectorKey: Oi, activeCameraTrack: jo, bindWidgetCallbacks: Yc, playblastCameraTrack: ln, restoreFromWidgets: Zc, serializeEditorState: Jc, syncActiveCameraTrack: Co, syncFromWidgets: Qc, bindEditorEvents: Dp, activateCamera: uc, addCamera: gc, deleteCamera: yc, drawPreviewOverlays: vc, duplicateCamera: xc, maximizeCameraPreview: wc, refreshCameraPreviews: kc, refreshCameraSelectors: Sc, renameCamera: jc, setPlayblastCamera: Cc, toggleCameraView: Ec, captureRealtime: Bn, makePlayblast: hf, uploadDirectorPlayblast: Wn, waitForMediaFrame: qn, computeAudioPeaks: On, loadAudioFile: Xp, releaseAudio: eo, stopPlay: Xa, togglePlay: Hp, applyCameraPreset: im, applyCameraShake: cm, applyProxyPreset: lm, clearViewportBgImage: yf, loadViewportBgFile: uf, loadViewportBgSequence: gf, drawCameraPath: Pf, drawCard: Tf, drawCube: Cf, drawCylinder: $f, drawGrid: wf, drawHuman: _f, drawLine3D: ne, drawNull: Af, drawOverlays: zf, drawPointField: jf, drawSpeedHeatmap: If, drawSphere: Ef, drawTorus: Mf, curveChannels: Ve, drawCurveEditor: Tl, fitCurveView: gn, onCurveDoubleClick: Ml, onCurvePointerDown: xl, onCurvePointerMove: wl, onCurvePointerUp: kl, onTimelinePointerDown: Ki, onTimelinePointerMove: Di, onTimelinePointerUp: Ni, refreshKeys: Vl, resetCurveZoom: Al, resetTimelineZoom: Ri, setChannelFilter: jl, setCurveInterpolation: Sl, setTangentMode: Cl, timelineFrameFromEvent: Ao, toggleCurveHandles: El, zoomCurve: $l, drawTransformGizmo: qi, frameTarget: Bi, gizmoAxes: Wi, gizmoGeometry: Vi, onPointerDown: Hi, onPointerMove: Ui, onPointerUp: Gi, onWheel: Xi, pickGizmo: Yi, pickSceneObject: Zi, resetCamera: Ji, setTransformMode: Qi, setViewMode: ec, viewportCamera: tc, loadCardFile: of, loadExecutionPreview: rf, loadMediaUrl: Rn, loadModelFile: af, loadSelectedReference: nf, onModelLoaded: tf, restoreAssets: ef, syncUpstreamInputs: sf, configureDomMedia: Kn, refreshSetupDiagnostic: Of, addMediaCard: nh, addPrimitive: th, applyObjectAnimationFrame: wh, beginCameraEdit: $h, beginObjectEdit: Zn, commitCameraEdit: Mh, commitObjectEdit: ch, copyKeyframe: Ch, deleteKeyframe: jh, deleteObject: Yn, deleteSelectedObjects: rh, duplicateObject: Xn, exitKeyEdit: Th, finishCameraEdit: Ah, goToAdjacentKey: qh, insertKeyframe: kh, loadSelectedKeyView: Rh, pasteKeyframe: Eh, playblastCameraAtFrame: xh, refreshInspector: sh, refreshKeyEditor: Kh, refreshObjects: Gn, removeObjectResources: hh, renameObject: ah, retimeSelectedKey: Dh, selectKeyframe: _h, selectedKeyframe: ze, selectedObject: Et, selectObjectAnimation: fh, setKeyInterpolation: Sh, setKeyTangentMode: Lh, setObjectParent: ph, timelineKeyframes: ve, timelineObject: ke, toggleAutoKey: Ph, toggleObject: oh, updateCameraFromHud: mh, updateCameraRotationFromHud: dh, updateEditState: zh, updateKeyVisualState: Fh, updateSelectedKey: Nh, updateSelectedObject: ih, clamp: Z, cloneCamera: le, configureCore: rn, defaultCamera: on, sampleCamera: xe, sampleObjectTransform: oo, sanitizeState: ac, worldTransform: Po };
Object.assign(
  Yo.prototype,
  Vh(Ha),
  tb(Ha),
...
function jb(e) {
  ...
  const a = new Yo(e);
  xo("director:workbench:constructor:complete", t), e.attachWorkbench(a), t.__majoorOmniCam = a, zi(a);
  try {
    a.assetBrowser = Hd(a, {
      ...
      onAgentFirstOpen: async () => {
        if (wo())
          try {
            const { createDirectorAgentPanel: o } = await import("./chunk-D2MlLdbd.js");
            a.agentPanel = o(a);
          } catch (o) {
