...
const ho = () => import("./chunk-ChFyp6ui.js");
function _f(e, t) {
...
async function Dh(e) {
  ...
  try {
    let n = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-DE1fGbs-.js");
...
class ti {
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-DE1fGbs-.js"));
    } catch (a) {
  ...
  try {
    t.assetBrowser = Cp(t, {
      ...
      onAgentFirstOpen: async () => {
        try {
          const { createDirectorAgentPanel: m } = await import("./chunk-CLAgyuz_.js");
          t.agentPanel = m(t);
        } catch (m) {
