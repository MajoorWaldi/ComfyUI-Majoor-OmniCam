...
function br(e, { type: t = "handheld_subtle", intensity: a = 1, duration_frames: o = null, subdivide: n = !0 } = {}) {
...
function yn(e) {
  ...
  a.delete("camera");
  const o = e.timelineKeyframes() || [], n = ds(o, a), s = fl(e, n);
...
const go = [1, 2, 5, 10, 20, 25, 50, 100, 200, 250, 500, 1e3, 2e3, 5e3], vn = 46, gr = 5, xn = 640;
function kn(e, t) {
  const a = t > 0 ? t : xn, o = Math.max(2, Math.floor(a / vn)), n = Math.max(1e-6, e / o);
  return go.find((s) => s >= n) ?? go[go.length - 1];
}
function hl(e, t) {
  const a = Math.max(1, e.state.duration_frames - 1), o = U(Number(e.timelineZoom) || 1, 0.1, 50), n = Number(e.timelinePan) || 0, s = a / o, i = kn(s, t), l = (i >= gr ? i / gr : 0) || i, d = [], p = Math.max(0, Math.floor(n / l) * l);
...
function ul(e) {
  return e.clientWidth || e.parentElement?.clientWidth || xn;
}
function wn(e) {
...
function bl(e, t) {
  ...
  a.addEventListener("pointerup", i, { signal: t }), a.addEventListener("pointercancel", i, { signal: t }), a.addEventListener("wheel", (c) => Xr(e, c), { passive: !1, signal: t });
}
...
function Sl(e, t) {
  const a = t.currentTarget, { x: o, y: n } = Uo(a, t);
...
function Sn(e, { selectedOnly: t = !1 } = {}) {
  ...
  for (const T of l) {
    ...
    if (e.showCurveHandles && !T.keyBased)
      for (let C = 0; C < c.length; C++) {
        ...
        const oe = i ? N.transform || i : N.camera || N, J = z(N.frame), se = R(T.get(oe)), pe = c[C - 1], de = c[C + 1], be = Math.max(1, N.frame - (pe?.frame ?? N.frame - 1)), ge = Math.max(1, (de?.frame ?? N.frame + 1) - N.frame), K = ms(
          N,
          T.id,
          pe,
          de,
...
function yr(e, { filter: t, label: a, color: o, title: n }) {
...
const vr = ["#4aa3ef", "#f2a93b", "#48c774", "#b565d8", "#ec4899"];
function jn(e, t) {
  const a = e.state.cameras.findIndex((n) => n.id === t), o = a >= 0 ? e.state.cameras[a] : null;
  return { camera: o, color: o?.color || vr[Math.max(0, a) % vr.length] };
}
function Qe(e) {
...
function Ll(e, t) {
  ...
  if (a.appendChild(Va(
    ...
    () => {
      e.checkpoint("Split shot"), Yr(e.state, e.frame, null) ? Qe(e) : e.setStatus(r("Move the playhead inside a shot first"));
    },
    { disabled: o }
  )), a.appendChild(Va(
    r("Clear edit"),
...
function Kl(e, t, a, o, n) {
  t.preventDefault(), t.stopPropagation();
  const { camera: s } = jn(e, a.camera_id);
  e.contextMenu?.show(t, s?.name || r("Shot"), [
    ...
    null,
    {
      ...
      run: () => {
        e.checkpoint("Split shot"), Yr(e.state, e.frame, null) && Qe(e);
      }
    },
    {
      label: r("Remove shot"),
      ...
      disabled: n === 1,
      run: () => {
        e.checkpoint("Remove shot"), ps(e.state, o) && Qe(e);
      }
    }
  ]);
}
function Dl(e, t, a, o) {
  const { camera: n, color: s } = jn(e, t.camera_id), i = document.createElement("div");
...
const Nl = ['[data-act="curve-zoom-in"]', '[data-act="curve-zoom-out"]', '[data-act="curve-fit"]', '[data-act="curve-handles"]'], xr = { curves: "Graph", dope: "Timeline", sequence: "Sequence" };
function Io(e, t) {
  const a = t in xr ? t : "dope";
  e.graphTab = a;
  ...
  a === "sequence" ? (_n(e, s), s?.focus?.({ preventScroll: !0 })) : a === "curves" && e.drawCurveEditor(), e.setStatus(r(xr[a]));
}
function ql(e) {
  e.graphTab === "sequence" && _n(e, e.root.querySelector('[data-role="graph-sequence"]'));
}
function Bl(e, t) {
...
function Wl(e) {
  ...
  x && (x.textContent = p.name), wn(e), yn(e), Go(e), ql(e), e.refreshCameraSelectors(), e.refreshKeyEditor(), e.updateEditState(), e.drawCurveEditor(), e.perf && (e.perf.timelineRefreshCount = (e.perf.timelineRefreshCount || 0) + 1);
}
class En {
  constructor(t = URL) {
...
async function Xo(e, { route: t, field: a = "file", file: o }) {
  ...
  return `
    <div class="oc-dope">
      <div class="oc-dope-body">
        <div class="oc-dope-labels">${bs.map((t) => `
...
function Yo({ fetchApi: e = Ad } = {}) {
  ...
  return {
    list(a = {}) {
      ...
      return o && o !== "all" && (l.kind = o), t(`${_e}${kr(l)}`);
    },
    get(a) {
    ...
    importModel(a, o = {}) {
      const n = new FormData();
      return n.append("file", a, o.filename || a.name || "model.glb"), t(`${_e}/import${kr(o)}`, { method: "POST", body: n });
    },
...
const Mn = Object.freeze(["all", "character", "prop", "environment", "vehicle"]);
function wr(e = {}) {
  const t = String(e.kind || "all").toLowerCase();
  return {
    kind: Mn.includes(t) ? t : "all",
...
function zd(e) {
  ...
  return {
    ...
    setFilter(i) {
      return a.filter = wr({ ...a.filter, ...i }), a.offset = 0, this.refresh();
    },
    refresh() {
      return s(async () => {
...
function Bd(e, { selected: t = !1, thumbUrl: a = "" } = {}) {
  const o = Rd[e.kind] || "pi-box", n = e.kind === "character" && Zr(e.rig) === "rigged" ? `<span class="oc-asset-badge">${r("RIGGED")}</span>` : "", s = a ? `<img class="oc-asset-thumb" src="${Je(a)}" alt="" loading="lazy">` : `<span class="oc-asset-thumb oc-asset-thumb--glyph"><i class="pi ${o}"></i></span>`;
...
function Vd(e, t = {}) {
  const a = e.root, o = t.fetchApi || ((K, V) => (e.api || e.app?.api).fetchApi(K, V)), n = t.apiClient || Yo({ fetchApi: o }), s = t.store || zd(n), i = Fd(), c = t.previewQueue || Ld(), l = e.api || e.app?.api || null;
  let d = t.thumbnailRenderer || null, p = null;
  const f = /* @__PURE__ */ new Set();
  function u() {
    return d ? Promise.resolve(d) : (p || (p = Kd().then((K) => d = Sr(K)).catch(() => d = Sr({}))), p);
  }
  function m(K) {
    return ir(l, dc(K));
  }
  function h(K) {
    return K.thumbnail ? ir(l, `omnicam/library/${K.thumbnail} [input]`) : "";
  }
  function y() {
...
function Hd(e, t = {}) {
  ...
  function l() {
    ...
    let g = 0;
    for (const k of x) {
      if (!Jr(k, { mode: s.mode, selectedIds: y })) continue;
      const v = Qr(k, s.content);
      if (!v) continue;
      const $ = en(x, k, b) || {
        position: k.position,
        size: k.size
      }, _ = e.webgl.projectWorldToScreen(
        tn($, k.type, k.annotation?.anchor),
        m,
        h
      );
...
function Gd(e, t) {
  const a = (o) => [`<option value="">${r("— unmapped —")}</option>`].concat(
    e.map(
      (n) => `<option value="${Cr(n)}"${n === o ? " selected" : ""}>${Cr(n)}</option>`
    )
  ).join("");
  return on.map((o) => {
...
function Xd(e, t = {}) {
  const a = e.root, o = t.apiClient || Yo({
  ...
  function y(x) {
    ...
    g === "auto" ? (l = To(p()), u()) : g === "validate" ? (u(), e.setStatus?.(ho(l) ? r("Rig is complete") : r("Rig still missing: {list}").replace("{list}", cr(l).join(", ")))) : g === "save" && b();
  }
  async function b() {
    const x = d();
    if (!x?.asset_id) {
    ...
    try {
      const g = await o.patch(x.asset_id, {
        rig: { profile: lr, bone_map: l }
      });
      x.character = {
        ...x.character || {},
        rig_profile: ho(l) ? lr : null
...
function Jd(e, t = {}) {
  ...
  function k() {
    ...
    l && (l.textContent = w);
    const z = m(), R = x(z?.character)[w] || [0, 0, 0, 1], q = vs(R);
    d.forEach((T, W) => {
  ...
  function _() {
    const w = y();
    if (!w) return;
    const E = d.map((q) => Number(q?.value) || 0), z = gs(E), R = e.directorApi?.execute({
      version: 1,
  ...
  function I() {
    const w = s?.value || "neutral", E = u.get(w) || dr({ preset_id: w });
  ...
  function h() {
    ...
    if (o) {
      ...
      o.dataset.sig !== $ && (o.dataset.sig = $, o.replaceChildren(
        _r("", g.length ? r("No motion (static)") : r("No clips in this model")),
        ...g.map((_) => _r(_, _))
...
function nm(e, { controlsFactory: t, anchorFactory: a } = {}) {
  ...
  function m({ targetSpec: w }) {
    if (w) {
      if (l(c), w.type === "object") {
        ...
        const E = ks(e), z = (E.length ? E : [w.object]).map((q) => ({
          object: q,
          transform: ze(q)
        }));
      ...
      if (w.type === "path_point" || w.type === "path_group") {
        ...
        e.checkpoint(w.type === "path_point" ? "Transform path point" : "Transform path selection"), n = {
          ...
          lookAtActive: nn(E, e.state.objects)
        };
        return;
      }
  ...
  function b(w) {
    ...
    E && (E.keyframes = sn(n.baseKeys, h(w)), y(E));
  }
  function x(w) {
    const E = e.state.cameras.find((R) => R.id === n.trackId);
    if (!E) return;
    const z = { ...h(w), lookAtActive: n.lookAtActive };
    E.keyframes = Ss(n.baseKeys, n.selectedFrames, z), y(E);
  }
  function g(w) {
    const E = e.state.cameras.find((z) => z.id === n.trackId);
    E && (E.keyframes = js(n.baseKeys, [n.frame], { delta: w.position }), y(E));
  }
  function k({ delta: w }) {
  ...
  function v(w) {
    ...
    for (const q of E)
      if (R === "translate")
        ...
        q.object.position = ve(z, mr($e(q.transform.position, z), w.rotationDeg)), q.object.rotation = ve(q.transform.rotation, w.rotationDeg);
      else if (R === "scale") {
  ...
  function $(w) {
    if (e.state.gizmo_mode === "translate")
      ...
      e.camera.target = ve(n.position, mr(E, w.rotationDeg));
    }
    e.commitCameraEdit();
  }
  function _(w) {
    const E = ve(n.base, w.position);
    n.tracking ? ws(e, E) : e.camera.target = E, e.commitCameraEdit();
  }
  ...
  function M() {
    ...
    const w = e.recording ? null : xs(e), E = e.state.gizmo_mode || "translate", z = !!w && !w.readOnly && rm.has(w.type) && w.allowedModes.includes(E);
...
function im(e, t) {
  ...
  let n;
  if (o.length >= 2) {
    const s = o[0], i = o.at(-1), c = (a.keyframes || []).filter((f) => f.frame < s), l = (a.keyframes || []).filter((f) => f.frame > i), d = (a.keyframes || []).filter((f) => f.frame >= s && f.frame <= i), p = br({ keyframes: d, duration_frames: i + 1 }, { type: t, intensity: 1, duration_frames: i + 1 });
    n = [...c, ...p, ...l].sort((f, u) => f.frame - u.frame);
  } else
    n = br(a, { type: t, intensity: 1, duration_frames: e.state.duration_frames });
...
function hm(e, { preset: t = "constant", strength: a = 1 } = {}) {
  const o = An(e).sort((i, c) => i.frame - c.frame);
...
function um(e, {
  ...
  const s = An(e).sort((f, u) => f.frame - u.frame);
  ...
  const c = t === "custom" ? s : hm(s, { preset: t, strength: i }), l = o == null ? c[0].frame : Number(o), d = n == null ? c.at(-1).frame : Number(n), p = cn(c, { startFrame: l, endFrame: d });
...
function ym(e) {
  const t = io(e);
  return t.group ? e.timelineObject?.() ? (e.setStatus?.(r("Timing remap is camera-only.")), !1) : (Io(e, "curves"), t.group.value = "timing", t.group.dispatchEvent(new Event("change", { bubbles: !0 })), Go(e), vt(e), e.drawCurveEditor?.(), e.setStatus?.(r("Inspecting camera timing.")), !0) : !1;
}
const $r = ["#4aa3ef", "#f2a93b", "#48c774", "#b565d8", "#ec4899"], De = [4, 8, 12, 20, 35, 60, 100];
function at(e) {
...
function km(e, t, a, o) {
  const n = co(e, a, o);
  if (!n) return;
  const { rx: s, ry: i, radarSize: c, cx: l, cy: d, innerRadius: p, range: f, scale: u, camPos: m, camTgt: h, cameras: y, activeTrack: b } = n, x = at(e), g = e.state.active_camera_id || b?.id, k = (J, se) => Pn(n, J, se);
  ...
  for (let J = 0; J < y.length; J++) {
    const se = y[J], pe = se.keyframes || [], de = se.id === g, be = se.color || $r[J % $r.length];
...
function zn(e, t, a, o) {
  const { camPos: n, camTgt: s, cameras: i, rx: c, ry: l, radarSize: d } = t, p = (b, x) => Pn(t, b, x), [f, u] = p(n[0] || 0, n[2] || 0);
...
function Cm(e, t, a, o) {
  ...
  const p = In(n, a, o), f = zn(e, n, a, o), [u, m] = zo(n, a, o);
...
function Tm(e, t, a) {
  ...
  const o = () => {
    ...
    const h = _s(t('[data-role="object-tags"]')?.value || "");
    h.length ? m.tags = h : delete m.tags;
    const y = String(t('[data-role="object-annotation"]')?.value || "").trim(), b = y ? Es({
      text: y,
  ...
  t('[data-role="duration-seconds"]')?.addEventListener("change", (m) => {
    ...
    e.setChannelFilter("all"), Go(e), vt(e), e.drawCurveEditor();
  ...
  for (const m of e.root.querySelectorAll(".toolbar-menu"))
    m.addEventListener("toggle", () => {
      m.open ? (e.closeMenus(m), Mr(m)) : Mm(m);
    }, { signal: a });
  document.addEventListener("scroll", () => {
    for (const m of e.root.querySelectorAll(".toolbar-menu[open]")) Mr(m);
  }, { capture: !0, signal: a });
  const c = (m, h) => {
  ...
  e.root.addEventListener("focusin", d, { signal: a }), e.root.addEventListener("pointerdown", d, { capture: !0, signal: a }), e.root.addEventListener("focusout", (m) => {
    e.modalTransform && !e.root.contains(m.relatedTarget) && (Cs(e), e.render());
  }, { signal: a });
...
function Im(e) {
  const t = vi(e.id, e.defaultValue), a = `pref_${e.id.replace(/[^a-zA-Z0-9]/g, "_")}`;
  if (e.type === "boolean")
    return `
  ...
  for (let n = 1; n < a.length - 1; n++) {
    ...
    if (i.camera) {
      for (const p of Km) {
        ...
        if (Array.isArray(f) && Array.isArray(m) && Array.isArray(u)) {
          const h = Ar(f, u, m, d);
          a[n].camera[p] = Ir(u.map(Number), h, o);
        }
      }
      for (const p of Dm) {
        const f = s.camera?.[p], u = i.camera?.[p], m = c.camera?.[p];
    ...
    if (Array.isArray(i.position) && Array.isArray(s.position) && Array.isArray(c.position)) {
      for (const p of Nm) {
        ...
        if (Array.isArray(f) && Array.isArray(m) && Array.isArray(u)) {
          const h = Ar(f, u, m, d);
          a[n][p] = Ir(u.map(Number), h, o);
        }
      }
      for (const p of qm) {
        const f = s[p], u = i[p], m = c[p];
        if (Array.isArray(f) && Array.isArray(m) && Array.isArray(u)) {
          const h = [0, 1, 2].map((y) => Pr(f[y], u[y], m[y], d));
          a[n][p] = u.map((y, b) => zr(Number(y), h[b], o));
        }
      }
    }
  }
...
function Fn(e) {
  ...
  l && o?.fov != null && (l.textContent = `${Ho(o.fov)}mm`);
...
function Qm(e, t) {
  for (const o of e.root.querySelectorAll('[data-act="toggle-camera-lock"]'))
    o.addEventListener("click", (n) => {
      n.stopPropagation(), e.checkpoint?.("Toggle camera lock"), e.state.camera_lock = !e.state.camera_lock, e.serialize?.(), Fn(e), e.setStatus?.(e.state.camera_lock ? r("Camera View locked") : r("Camera View unlocked"));
    }, { signal: t });
...
function ep(e, t) {
  ...
  !a || !o || (n && n.addEventListener("change", () => {
    ...
    document.activeElement !== a && (a.value = Ho(o.value));
  }, { signal: t }));
}
function tp(e, t) {
  ...
  if (a.length) {
    ...
    for (const o of a)
      o.addEventListener("change", () => {
        e.dopeChannels = new Set(a.filter((n) => n.checked).map((n) => n.dataset.dopeChannel)), yn(e);
      }, { signal: t });
  }
}
function np(e, t) {
...
function cp(e, t) {
  ...
  xi().then((n) => {
    ...
    c === "health-slow" ? wi(e) : c === "health-smooth" ? Si(e) : c === "health-recenter" ? ji(e) : c === "health-timing" && ym(e);
  }, { signal: t });
...
function Gu(e, t, a = Ln) {
  const o = Zo(a), n = new e.Group();
...
function Yu(e, t, a, o, n) {
  o.group.visible = n, t.environment = n ? o.environment : null, t.background = n ? o.sky : new e.Color(1184274), t.fog = n ? o.fog : null, a.toneMapping = n ? e.ACESFilmicToneMapping : e.NoToneMapping, a.toneMappingExposure = n ? Zo(o.quality).toneExposure : 1, t.traverse((s) => {
...
function yp(e, t, a) {
  ...
  if (o) {
    const s = (i) => {
      const c = i.target.closest?.("[data-axis], [data-axis-center]") || i.target, l = c.getAttribute("data-axis"), d = Ci(l?.toLowerCase(), e.state.view_mode);
...
function $p(e) {
  ...
  ], d = e.planeAxis === "y" ? On(l) : Kn(l, [0, 0, -1]), p = e.seedPoint ? 1 : 0, f = [];
  for (let m = p; m < i.length; m++) {
    const h = i[m], y = _p(i, m, d, e.planeAxis), b = le(c);
    b.position = [...h], b.target = Ep(h, y, l, e.planeAxis), f.push({
      frame: Math.round(t + o * m / (i.length - 1)),
      camera: b,
      interpolation: "smooth"
    });
  }
  const u = f.filter((m, h, y) => h === 0 || m.frame > y[h - 1].frame);
  return u.length < 3 ? u : Vo(u, u.map((m) => m.frame), "camera");
}
function Mp(e) {
...
function Dn(e, t = e.cameraPathDraw) {
  const a = t?.pointerId;
  if (a != null)
    try {
...
function er(e, t) {
  ...
  return n && Qo(n, o) < xp ? !1 : (a.points.push(o), !0);
}
function Pe(e) {
  const t = e.cameraPathDraw;
  return t?.active ? (Dn(e, t), e.cameraPathDraw = null, wt(e), e.setStatus?.(r("Draw Camera Path cancelled")), e.render?.(), !0) : !1;
}
function Tp(e) {
  const t = e.cameraPathDraw;
...
function Pp(e, t) {
  const a = e.cameraPathDraw;
  return a?.active ? t.button === 2 && !t.altKey ? (ao(t), e.cameraPathSuppressContextMenuUntil = Date.now() + 1e3, Pe(e), !0) : t.button !== 0 || t.altKey || t.ctrlKey || t.metaKey || t.shiftKey ? !1 : (ao(t), e.closeMenus?.(), e.interactionElement.focus?.({ preventScroll: !0 }), e.interactionElement.setPointerCapture?.(t.pointerId), a.drawing = !0, a.pointerId = t.pointerId, a.points = [], er(e, tr(e, t)), wt(e), e.requestRender?.("camera-path-draw"), !0) : !1;
}
function Ip(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : (ao(t), er(e, tr(e, t)) && e.requestRender?.("camera-path-draw"), !0);
}
function zp(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : (ao(t), t.type === "pointercancel" || t.type === "lostpointercapture" ? (Pe(e), !0) : (er(e, tr(e, t)), a.drawing = !1, Tp(e), !0));
}
function Fp(e) {
  const t = e.cameraPathDraw;
...
function Lp(e, t) {
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? Pe(e) : Lr(e);
    }, { signal: t });
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path-extend"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? Pe(e) : Lr(e, { mode: "extend" });
    }, { signal: t });
...
function ar(e, t, { name: a = "", status: o } = {}) {
  const n = t && typeof t == "object" ? t : ln(), s = { ...n, metadata: { ...n.metadata || {}, scene_name: a || "" } };
...
async function Op(e) {
  await Ct(e, r("New Scene"), r("Start a new scene? Unsaved changes will be lost.")) && ar(e, ln(), { name: "", status: r("New scene") });
}
async function Kp(e) {
  if (!e.sceneBaseline) {
  ...
  const o = a?.metadata?.scene_name || Rn(e);
  ar(e, a, { name: o, status: r("Scene reset to last save") });
}
async function Dp(e) {
  const t = Rn(e) || r("Untitled"), a = await jt(e, r("Save Scene"), r("Scene name"), t);
  if (a == null) return;
...
function Up(e) {
  ...
  if (!c) return;
  const l = Nn(t, e.state.width || 1280, e.state.height || 720), d = (b) => l.x + b * l.w, p = (b) => l.y + b * l.h;
...
function Gp(e, t) {
  ...
  a && a.addEventListener("click", (o) => {
    ...
    const s = Nn(a, e.state.width || 1280, e.state.height || 720), i = a.width / n.width, c = {
      x: ((o.clientX - n.left) * i - s.x) / Math.max(1, s.w),
      y: ((o.clientY - n.top) * i - s.y) / Math.max(1, s.h)
    }, l = Ei(e.state.motion_layers, c, 0.09);
...
function Kr(e, t, { frameCount: a = 0, fps: o = 0 } = {}) {
...
function _t(e, t) {
  ...
  return !Number.isFinite(o) || o <= a ? null : `${e.name || "File"} is ${Rr(o)}; the maximum is ${Rr(a)}.`;
}
function tf(e) {
  return Number(e) <= Dr ? null : `${e} frames selected; a background sequence is limited to ${Dr}.`;
}
function af(e) {
...
async function sf(e, t, { decode: a = rf } = {}) {
  ...
  try {
    ...
    Bn(e), e.setStatus(`Audio loaded: ${t.name || "track"}`);
  } catch (n) {
...
const Vn = /* @__PURE__ */ new WeakSet(), xt = /* @__PURE__ */ new WeakMap();
function ro(e) {
...
function qe(e, t, a, o = !1, n = "") {
  ...
  s && s !== a && Et(e, t), o && Vn.add(a), cf(a), e.cardMediaAssetById ||= /* @__PURE__ */ new Map(), e.cardMediaById.set(t, a), e.cardMediaAssetById.set(t, n || a?.__omnicamAsset || "");
  try {
    a.__omnicamAsset = n || a.__omnicamAsset || "";
  } catch {
  }
...
function Hn(e, t, { signal: a, timeout: o = 15e3 } = {}) {
...
async function Un(e, t, a, o = () => !0, n = null) {
  if (!t || !a) return;
  const s = () => !e.disposed && o(), i = String(t.asset || a).toLowerCase();
  if (n ?? /\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/.test(i)) {
    const l = document.createElement("video");
    if (l.src = a, l.loop = !0, l.muted = !0, l.playsInline = !0, await Hn(l, ["loadeddata", "error"], { signal: e.abortController?.signal }).catch(() => {
    }), !s()) {
      ro(l);
      return;
    }
...
async function hf(e, t) {
  ...
  try {
    const c = await Xo(et, { route: "/majoor/omnicam/upload_model", field: "asset", file: t });
...
async function uf(e, t) {
  ...
  if (o) {
    ...
    try {
      const n = await Xo(et, { route: "/majoor/omnicam/upload_asset", field: "asset", file: t });
      ...
      if (u === "image" || u === "video") {
        ...
        if (h && h.value) {
          ...
          if (y) {
            ...
            }), qe(e, "subject", y, !1, y.currentSrc || y.src || ""), Kr(e, y, { frameCount: y instanceof HTMLVideoElement ? 0 : 1 });
...
const vf = ["video/mp4;codecs=avc1.42E01E", "video/webm;codecs=vp9", "video/webm;codecs=vp8", "video/webm"], Nr = { low: 3e6, balanced: 6e6, high: 12e6 };
function xf(e) {
  return Nr[e] || Nr.balanced;
}
async function kf({
  canvas: e,
  fps: t,
...
async function Sf(e) {
  await Promise.all([...e].filter((t) => t instanceof HTMLVideoElement && t.seeking).map((t) => Hn(t, ["seeked", "error"], { timeout: 5e3 }).catch(() => {
  })));
}
async function Gn(e) {
...
async function Yn(e, t) {
  ...
  if (Jp(e, t), e.state.playblast_camera_id === dn)
...
async function Zn(e) {
  ...
  return Xo(St, { route: "/majoor/omnicam/upload_asset", field: "asset", file: e });
}
async function no(e) {
...
async function Ef(e, t) {
  ...
  let n = null;
  try {
    if (e.setStatus(`Uploading background: ${t.name}`), n = await Zn(t), o !== e.backgroundRequestId || e.disposed) {
      await no([n]);
      return;
    }
    const s = Re(n.path);
...
async function $f(e, t) {
  ...
  try {
    ...
    for (const c of t)
      if (s.push(await Zn(c)), n !== e.backgroundRequestId || e.disposed) {
        await no(s);
        return;
      }
...
function Mf(e) {
  or(e), e.checkpoint?.("Clear background"), e.state.viewport_bg_image = "", e.state.viewport_bg_sequence = [], e.viewportBgImage = null, e.viewportBgSequenceImages = [], e.serialize(), e.render(), e.setStatus("Background cleared");
}
function Tf(e) {
  ...
  for (const p of a) {
    if (p.enabled === !1 || !Jr(p, { mode: t.mode, selectedIds: d })) continue;
    const f = Qr(p, t.content);
    if (!f) continue;
    const u = en(a, p, l) || { position: p.position, size: p.size }, m = p.annotation?.anchor || "top", h = tn(u, p.type, m);
    let y, b;
...
function If(e) {
  ...
  return e._pointFieldCache?.key !== n && (e._pointFieldCache = { key: n, ...Ti(t, a, o) }), e._pointFieldCache;
}
const zf = 600;
function Ff(e) {
...
const Xf = 1, qr = 0.01, Yf = 0.4, Zf = 3, Jf = 120, Qf = 20, eh = 4, th = 0.25, ah = 0.5;
function oh(e, t, a) {
...
function nh({ keys: e, fps: t = 24, objects: a = [] } = {}) {
  ...
  for (const c of s)
    ...
    }), c.distance < qr && c.duration >= Yf && n.push({
      code: "STATIC_SEGMENT",
      severity: "info",
      frameStart: c.frameStart,
      frameEnd: c.frameEnd,
  ...
  for (let c = 1; c < o.length - 1; c += 1) {
    ...
    const u = Math.max(-1, Math.min(1, Ai(l, d) / (p * f))), m = Math.acos(u) * 180 / Math.PI;
    m >= Jf && n.push({
  ...
  if (o.length >= eh) {
    ...
    let f = Math.abs(Br(p, c, l) - Br(d, c, l)) % 360;
    f > 180 && (f = 360 - f);
    const u = We($e(p, d));
    f <= Qf && u > qr && n.push({
...
function lh(e, { perFrame: t = !1 } = {}) {
  const a = e.activeCameraTrack(), o = rr(e, a), n = nr(e, a);
...
function es(e) {
  ...
  const n = (u, m, h, y, b = "") => {
    ...
    `, b.addEventListener("click", () => {
      e.outlinerCollapsedSections ||= /* @__PURE__ */ new Set(), e.outlinerCollapsedSections.has(h) ? e.outlinerCollapsedSections.delete(h) : e.outlinerCollapsedSections.add(h), es(e);
...
function gh(e) {
  ...
  if (s) {
    const w = n.target_object_id || e.state.target_object_id || "", E = `T${pr()}${e.state.objects.map((z) => `${z.id}\0${z.name || z.type}`).join("|")}`;
    jo(s, E, () => [
  ...
  if (!t) {
    ...
    E && (E.textContent = `${n.name} · F${e.frame}`), Wr(o, {
  ...
  p && (p.textContent = t.name || t.type), Wr(o, {
  ...
  if (b) {
    ...
    const R = e.state.objects.filter((T) => !E.has(T.id)), q = `P${pr()}${w}${R.map((T) => `${T.id} ${T.name || T.type}`).join("|")}`;
    jo(b, q, () => [
      yt("", r("No parent")),
...
function kh(e) {
  ...
  e.beginCameraEdit(), Pi(e.camera, n), e.commitCameraEdit(), e.finishCameraEdit(), rs(e), xh(e), e.render();
}
function wh(e) {
  const t = globalThis.performance?.now?.() ?? Date.now();
  (!Number.isFinite(e.lastCameraHudEditAt) || t - e.lastCameraHudEditAt > 300) && e.checkpoint("Edit camera"), e.lastCameraHudEditAt = t;
  ...
  e.camera.position = [a("camera-px", e.camera.position[0]), a("camera-py", e.camera.position[1]), a("camera-pz", e.camera.position[2])], e.camera.target = [a("camera-tx", e.camera.target[0]), a("camera-ty", e.camera.target[1]), a("camera-tz", e.camera.target[2])], e.camera.fov = U(a("camera-fov", e.camera.fov), 5, 150), e.camera.roll = U(a("camera-roll", e.camera.roll || 0), -180, 180), e.camera.near = Math.max(1e-4, a("camera-near", e.camera.near)), e.camera.far = Math.max(e.camera.near + 1e-4, a("camera-far", e.camera.far)), e.beginCameraEdit(), e.commitCameraEdit(), e.finishCameraEdit(), rs(e), e.render();
}
function Sh(e, t) {
  const a = $t(e);
  if (!a) return;
...
function _h(e) {
  ...
  if (!t.length) return [];
  if (t.length === 1)
    return ts(e, t[0]), e.selectedObjectId ? [e.selectedObjectId] : [];
...
function Ih(e) {
  ...
  const o = ue(e), n = a ? { frame: e.frame, transform: ze(a), interpolation: t } : { frame: e.frame, camera: le(e.camera), interpolation: t }, s = o.findIndex((l) => l.frame === e.frame);
  s >= 0 ? o[s] = n : o.push(n), o.sort((l, d) => l.frame - d.frame);
  const i = o.findIndex((l) => l.frame === e.frame), c = [o[i - 1]?.frame, e.frame, o[i + 1]?.frame].filter((l) => l != null);
  if (c.length >= 2) {
    const l = Vo(o, c, a ? "object" : "camera");
    o.length = 0, o.push(...l);
  }
  !a && e.syncActiveCameraTrack && e.syncActiveCameraTrack(), e.selectedKeyFrame = e.frame, e.selectedKeyFrames = /* @__PURE__ */ new Set([e.frame]), e.editingKeyFrame = null, e.serialize(), e.refreshKeys(), e.refreshKeyEditor(), e.updateKeyVisualState(), e.drawCurveEditor(), e.setStatus(r("{value1} {value2} @ {value3}", { value1: a?.name || "Camera", value2: s >= 0 ? "key updated" : "key inserted", value3: e.frame }));
}
function zh(e, t) {
...
function Kh(e, t) {
  t && (e.selectedKeyFrame = t.frame, e.selectedKeyFrames = /* @__PURE__ */ new Set([t.frame]), e.editingKeyFrame = null, we(e) || (e.pathSelection = Ii(e.pathSelection, { cameraId: e.state.active_camera_id, frame: t.frame, additive: !1 })), e.setFrame(t.frame));
}
function Dh(e) {
  ...
  return {
    ...
    openObjectContext(c, l) {
      ...
      this.showContextMenu(c, d.name || d.type, [
        ...
        { label: d.locked ? r("Unlock object") : r("Lock object"), icon: d.locked ? "pi-lock" : "pi-lock-open", run: () => Jo(this, d) },
        null,
        {
          label: r("Transform mode"),
          icon: "pi-arrows-alt",
    ...
    openPathKeyContext(c, l, d) {
      ...
      const m = f ? bo(f) : "auto", h = this.selectedKeyFrames?.size || 0, y = this.pathSelection?.component === "target", b = nn(p, this.state.objects), x = h >= 2 ? `${r("Path key")} (${r("{count} keys selected").replace("{count}", String(h))})` : `Path key F${d}`;
...
function ou(e) {
  ...
  return {
    ...
    restoreHistorySnapshot(G) {
      ...
      const S = Vr(this.state), P = new Set(this.state.objects.map((Q) => Q.id));
      ...
      this.selectedKeyFrames = new Set(he.filter((Q) => Z.has(Q))), this.selectedKeyFrame = this.selectedKeyFrames.has(j.selectedKeyFrame) ? j.selectedKeyFrame : [...this.selectedKeyFrames].at(-1) ?? null, this.pathSelection = zi(this.pathSelection, this.activeCameraTrack()), this.subSelection = j.subSelection || null, this.camera = Le(this.state, this.frame), kt(this, this.activeCameraTrack(), this.camera, this.frame), this.cameraPreviewSignature = "", this.serialize(), S !== Vr(this.state) && this.restoreAssets(), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
    },
    checkpoint(G) {
...
function ru(e, t) {
  ...
  const o = mn();
  o.position = [0, 0, 0], o.target = [0, 0, -1], a.camera = le(o), a.keyframes = [{ frame: 0, camera: le(o), interpolation: "ease" }], e.state.active_camera_id = a.id, e.state.camera = le(o), e.state.keyframes = a.keyframes, e.camera = le(o), e.frame = 0, e.selectedEntity = "camera", e.selectedObjectId = null, e.selectedKeyFrame = 0, e.editingKeyFrame = null, e.cameraEditKey = null, e.cameraEditActive = !1, e.cameraPreviewSignature = "", ss(e), e.refreshCameraSelectors(), e.setStatus(r("{value1} animation reset", { value1: a.name }));
}
function nu(e, t) {
  const a = e.state.objects.find((o) => o.id === t);
  a && (e.checkpoint("Reset object animation"), a.keyframes = [], a.position = [0, 0, 0], a.rotation = [0, 0, 0], e.frame = 0, e.selectedEntity = "object", e.selectedObjectId = a.id, e.selectedKeyFrame = null, e.editingKeyFrame = null, ss(e), e.setStatus(r("{value1} animation reset", { value1: a.name || a.type })));
}
const Hr = { motion: "motion", shot: "display", health: "health" }, su = {
  object: "Object",
  camera: "Camera",
...
function lu(e) {
  const t = is(e);
  return Hr[t] ? Hr[t] : e.selectedEntity === "object" ? "scene" : "camera";
}
function du(e) {
  return [
    e.selectedEntity || "",
...
function mu(e) {
  const t = du(e);
  e._lastInspectorSelKey !== void 0 && e._lastInspectorSelKey !== t && (e.inspectorMode = "entity"), e._lastInspectorSelKey = t, cs(e);
}
function cs(e) {
  const t = lu(e);
...
function pu(e, t) {
  e.inspectorMode = cu.includes(t) ? t : "entity", cs(e), e.render?.(), e.refitNode?.();
}
function fu(e) {
  ...
  return {
    ...
    setFrame(S, P = !1, F = !0) {
      ...
      for (const Y of D.cameraFocal) document.activeElement !== Y && (Y.value = Ho(this.camera.fov));
    ...
    setSpatialHandleMode(S) {
      ...
      this.checkpoint(r("Camera path handle: {mode}").replace("{mode}", S)), uc(F[D], S, {
        prevKey: F[D - 1] || null,
        nextKey: F[D + 1] || null
    ...
    setPathSelectionComponent(S) {
      this.pathSelection = Li(this.pathSelection, S), this.refreshInspector(), this.render();
    },
    ...
    transformCameraPath(S) {
      ...
      const F = sn(P.keyframes, { origin: rn(P.keyframes), ...S });
    ...
    redistributeActiveCameraTiming() {
      ...
      const P = [...S.keyframes].sort((D, X) => D.frame - X.frame), F = cn(P, {
    ...
    async openCameraPathPresetPicker() {
      ...
      const P = pc.map((D) => ({ id: D, label: r(fr[D] || D) })), F = await hn({ title: r("Camera Path Preset"), items: P, owner: this });
...
function bu(e) {
  const { right: t, up: a, forward: o } = Oi(e || {});
  return uu.map((n) => {
...
const vu = "http://www.w3.org/2000/svg", Ye = 26, Ur = 17, xu = 5.4;
function Ze(e, t) {
...
function ku(e) {
  ...
  for (const s of gu(bu(a))) {
    const i = Ye + s.x * Ur, c = Ye + s.y * Ur, l = yu(s.depth);
...
const ju = ["world_point", "object_point", "camera_field"], ls = {
  manual_2d: "DRAW",
  object_point: "OBJECT",
  world_point: "WORLD",
...
function Mu(e) {
  ...
  s("motion-sel-name", a.label), s("motion-sel-type", ls[a.source_kind] || "TRACK"), s("motion-sel-binding", Cu(e.state, a)), s("motion-sel-start", n.length ? Math.min(...n) : 0), s("motion-sel-end", n.length ? Math.max(...n) : 0);
...
function Pu(e) {
  ...
  return {
    ...
    requestUiUpdate(j = je.viewport, S = "unknown") {
      (this.renderReasons ||= /* @__PURE__ */ new Set()).add(S), this.uiDirtyMask = bc(this.uiDirtyMask, j), this.renderInvalidations = (this.renderInvalidations || 0) + 1, !this.renderScheduled && (this.renderScheduled = !0, this.renderFrame = requestAnimationFrame(() => {
...
function zu() {
  return {
    ...
    smoothSelectedKeyframes() {
      ...
      this.checkpoint(r("Smooth {n} keys").replace("{n}", e.length)), t.write(Vo(ue(this), e, t.kind)), this.serialize(), this.refreshKeys(), this.refreshKeyEditor(), this.render(), this.drawCurveEditor(), this.setStatus(r("Smoothed {n} keyframes").replace("{n}", e.length));
    },
    /**
...
class sr {
  ...
  constructor(t) {
    this.runtime = t;
    const a = t.node;
    this.disposed = !1, this.app = Gr, this.api = Ve, this.node = a, this.root = $n(), this.root.tabIndex = -1, this.dom = Tn(this.root), this.canvas = this.root.querySelector(".viewport-wrap > canvas"), this.cameraPreviewCanvases = /* @__PURE__ */ new Map(), this.cameraPreviewContexts = /* @__PURE__ */ new Map(), this.cameraPreviewSignature = "", this.interactionElement = this.canvas, this.interactionElement.tabIndex = 0, this.interactionElement.dataset.captureWheel = "true", this.ctx = this.canvas.getContext("2d", { alpha: !1 }), this.webgl = null, this.cameraWebgl = null, this.webglReady = this.loadWebGLViewports(), this.transformControlsWiring = nm(this), this.camera = xe(this.state, this.frame), this.playing = !1, this.drag = null, this.cameraEditActive = !1, this.cameraEditKey = null, this.keyDrag = null, this.timelineDrag = null, this.curveDrag = null, this.selectedKeyFrame = this.state.keyframes[0]?.frame ?? null, this.pathSelection = Ni(), this.editingKeyFrame = null, this.copiedKeyframe = null, this.cameraSpeed = 1, this.cardMedia = null, this.cardMediaById = /* @__PURE__ */ new Map(), this.cardMediaAssetById = /* @__PURE__ */ new Map(), this.objectUrls = new En(), this.cardUrlsById = this.objectUrls.urls, this.modelUrlsById = /* @__PURE__ */ new Map(), this.modelInfoById = /* @__PURE__ */ new Map(), this.executionReferences = [], this.selectedObjectId = null, this.selectedEntity = "camera", this.subSelection = null, this.cardUrl = null, this.recording = !1, this.gizmoDrag = null, this.playTimer = null, this.previewClickTimer = null, this.showCurveHandles = !0, this.uiDirtyMask = 0, this.perf = globalThis.__omnicamPerf === !0 ? { renderCount: 0, viewportRenderCount: 0, previewRenderCount: 0, timelineRefreshCount: 0, inspectorRefreshCount: 0, lastFrameMs: 0 } : null, this.contextMenu = new un(this.root), this.refreshCameraPreviews(), this.initializeTooltips(), this.bindEditorEvents(), this.bindWidgetCallbacks(), this.syncFromWidgets(), this.resizeCanvas(), this.render(), this.refreshKeys(), this.refreshObjects(), this.restoreAssets(), this.syncUpstreamInputs(), this.refreshSetupDiagnostic(), // Seed every frame-derived readout (timecode, lens millimetres, viewport
...
for (const e of Fu)
  Object.defineProperty(sr.prototype, e, {
    configurable: !0,
    enumerable: !0,
    get() {
...
const Ya = { app: Gr, api: Ve, EditorHistory: jc, ContextMenuController: un, initializeTooltips: Oc, promptText: jt, ObjectUrlRegistry: En, buildRoot: $n, dispatchDirectorKey: Bi, activeCameraTrack: Ao, bindWidgetCallbacks: rl, playblastCameraTrack: bn, restoreFromWidgets: nl, serializeEditorState: sl, syncActiveCameraTrack: Po, syncFromWidgets: il, bindEditorEvents: Xp, activateCamera: Kc, addCamera: Dc, deleteCamera: Rc, drawPreviewOverlays: Nc, duplicateCamera: qc, maximizeCameraPreview: Bc, refreshCameraPreviews: Wc, refreshCameraSelectors: Vc, renameCamera: Hc, setPlayblastCamera: Uc, toggleCameraView: Gc, captureRealtime: Xn, makePlayblast: Cf, uploadDirectorPlayblast: Yn, waitForMediaFrame: Gn, computeAudioPeaks: Bn, loadAudioFile: sf, releaseAudio: oo, stopPlay: Qa, togglePlay: of, applyCameraPreset: sm, applyCameraShake: im, applyProxyPreset: cm, clearViewportBgImage: Mf, loadViewportBgFile: Ef, loadViewportBgSequence: $f, drawCameraPath: Bf, drawCard: qf, drawCube: Lf, drawCylinder: Df, drawGrid: Pf, drawHuman: Kf, drawLine3D: ne, drawNull: Nf, drawOverlays: Vf, drawPointField: Ff, drawSpeedHeatmap: Wf, drawSphere: Of, drawTorus: Rf, curveChannels: tt, drawCurveEditor: Il, fitCurveView: Sn, onCurveDoubleClick: Al, onCurvePointerDown: wl, onCurvePointerMove: Sl, onCurvePointerUp: jl, onTimelinePointerDown: Wi, onTimelinePointerMove: Vi, onTimelinePointerUp: Hi, refreshKeys: Wl, resetCurveZoom: Pl, resetTimelineZoom: Ui, setChannelFilter: _l, setCurveInterpolation: Cl, setTangentMode: El, timelineFrameFromEvent: Ko, toggleCurveHandles: $l, zoomCurve: Tl, drawTransformGizmo: Gi, frameTarget: Xi, gizmoAxes: Yi, gizmoGeometry: Zi, onPointerDown: Ji, onPointerMove: Qi, onPointerUp: ec, onWheel: tc, pickGizmo: ac, pickSceneObject: oc, resetCamera: rc, setTransformMode: nc, setViewMode: sc, viewportCamera: ic, loadCardFile: uf, loadExecutionPreview: bf, loadMediaUrl: Un, loadModelFile: hf, loadSelectedReference: gf, onModelLoaded: ff, restoreAssets: pf, syncUpstreamInputs: yf, configureDomMedia: Wn, refreshSetupDiagnostic: Gf, addMediaCard: bh, addPrimitive: ph, applyObjectAnimationFrame: Ph, beginCameraEdit: Dh, beginObjectEdit: os, commitCameraEdit: Rh, commitObjectEdit: vh, copyKeyframe: Lh, deleteKeyframe: Fh, deleteObject: as, deleteSelectedObjects: uh, duplicateObject: ts, exitKeyEdit: qh, finishCameraEdit: Nh, goToAdjacentKey: Qh, insertKeyframe: Ih, loadSelectedKeyView: Jh, pasteKeyframe: Oh, playblastCameraAtFrame: Ah, refreshInspector: gh, refreshKeyEditor: Xh, refreshObjects: es, removeObjectResources: Ch, renameObject: fh, retimeSelectedKey: Yh, selectKeyframe: Kh, selectedKeyframe: Fe, selectedObject: $t, selectObjectAnimation: jh, setKeyInterpolation: zh, setKeyTangentMode: Uh, setObjectParent: Sh, timelineKeyframes: ue, timelineObject: we, toggleAutoKey: Bh, toggleObject: hh, updateCameraFromHud: wh, updateCameraRotationFromHud: kh, updateEditState: Vh, updateKeyVisualState: Hh, updateSelectedKey: Zh, updateSelectedObject: yh, clamp: U, cloneCamera: le, configureCore: pn, defaultCamera: mn, sampleCamera: xe, sampleObjectTransform: so, sanitizeState: cc, worldTransform: No };
Object.assign(
  sr.prototype,
  ou(Ya),
  fu(Ya),
...
function Lu(e) {
  ...
  const a = new sr(e);
  Eo("director:workbench:constructor:complete", t), e.attachWorkbench(a), t.__majoorOmniCam = a, Ri(a);
  try {
    a.assetBrowser = Vd(a, {
