...
import { s as Ce, c as X, t as ge, a as s, o as Tn, b as dr, d as He, e as he, f as $o, r as Ys, g as mr, h as In, i as Xs, j as Js, k as Zs, l as Qs, m as pr, n as fr, I as uo, p as hr, q as ei, w as ti, u as vo, v as On, x as ai, y as ur, z as zr, A as Pn, B as Yo, C as Ln, D as Fn, E as zn, F as Nn, G as Xo, H as zo, J as Nr, O as Rr, R as Rn, K as oi, L as ri, M as ni, N as br, P as si, Q as ii, S as ci, T as li, U as di, V as gr, W as mi, X as pi, Y as fi, Z as hi, _ as ui, $ as bi, a0 as gi, a1 as yi, a2 as vi, a3 as xi, a4 as wi, a5 as ki, a6 as Si, a7 as ji, a8 as _i, a9 as Ci, aa as Ei, ab as Ai, ac as $i, ad as Mi, ae as Ti, af as Ii, ag as Oi, ah as Pi, ai as Li, aj as Fi, ak as zi, al as Ni, am as Ri, an as Ki, ao as Di, ap as Bi, aq as qi, ar as Ui, as as Wi, at as Vi, au as Hi, av as Gi, aw as Yi, ax as Xi, ay as Ji, az as Zi, aA as Qi, aB as Kn, aC as Dn, aD as ec, aE as No, aF as tc, aG as ac, aH as oc, aI as rc, aJ as nc, aK as ze, aL as sc, aM as Bn, aN as yr, aO as ic, aP as cc, aQ as lc, aR as qn, aS as Ue, aT as Be, aU as dc, aV as Kr, aW as vr, aX as mc, aY as pc, aZ as fc, a_ as hc, a$ as uc, b0 as bc, b1 as gc, b2 as Un, b3 as yc, b4 as vc, b5 as xc, b6 as wc, b7 as kc, b8 as Sc, b9 as jc, ba as _c, bb as Cc, bc as Ec, bd as Ac, be as $c, bf as Mc, bg as Tc, bh as Ic, bi as Oc, bj as Pc, bk as Lc, bl as Fc } from "./chunk-CJ-Hefyx.js";
import { L as zc, a as Nc, p as zt, f as xr, b as Rc, S as Kc, c as Dr, d as Dc, e as Bc, r as qc, g as Uc, n as Wc, C as Br, h as Nt, o as Vc, i as Hc, s as Gc, j as Yc, k as Wn, l as Xc, m as Jo, q as Zo, w as Jc, t as Vn, u as Zc, v as Qc, x as el, y as tl, z as al, A as ol, B as rl, D as nl, E as sl, F as il, G as cl, H as ll, I as dl, J as ml, K as pl, M as fl } from "./chunk-c7DutHms.js";
...
function wl(e, { type: t = "handheld_subtle", intensity: a = 1, duration_frames: o = null, subdivide: r = !0 } = {}) {
  ...
  return [...b].sort((g, y) => g - y).map((g) => {
    const y = Ce(u, g), S = Et(g * m, 1) * l, x = Et(g * m, 2) * l, E = Et(g * m, 3) * l * 0.5, M = Et(g * m, 4) * p, K = Et(g * m, 5) * (p * 0.35), L = [...y.position], Y = [...y.target];
    return L[0] += S, L[1] += x, L[2] += E, Y[0] += S * 0.35, Y[1] += x * 0.35, {
      frame: g,
      camera: {
        ...y,
        position: L,
...
function Ml(e, t) {
  const a = Math.max(1, e.state.duration_frames - 1), o = X(Number(e.timelineZoom) || 1, 0.1, 50), r = Number(e.timelinePan) || 0, n = a / o, i = Zn(n, t), l = (i >= Ur ? i / Ur : 0) || i, p = [], m = Math.max(0, Math.floor(r / l) * l);
...
function Rl(e, t) {
  ...
  if (!e.curveDrag || t.pointerId !== e.curveDrag.pointerId) {
    const h = (e.curveHitPoints || []).map((y) => ({ point: y, distance: Math.hypot(o - y.x, r - y.y) })).sort((y, S) => y.distance - S.distance)[0], d = Math.max(1, e.state.duration_frames - 1), f = d / (Number(e.curveZoomX) || 1), u = Number(e.curvePanX) || 0, b = Math.max(1, a.clientWidth - 58), v = X(Math.round(u + (o - 44) / b * f), 0, d);
    let g = null;
    if (h && h.distance <= 14) {
  ...
  if (e.curveHover = null, t.preventDefault(), t.stopPropagation(), e.curveDrag.historyCheckpointed || (e.checkpoint?.(e.curveDrag.handle ? "Edit curve tangent" : "Edit curve"), e.curveDrag.historyCheckpointed = !0), e.curveDrag.handle) {
    ...
    if (f === "in") {
      if (x.in_x = X((o - v) / Math.max(1, u), -0.99, -0.01), x.in_y = (g - r) * b, S === "aligned") {
    ...
    } else if (x.out_x = X((o - v) / Math.max(1, u), 0.01, 0.99), x.out_y = (g - r) * b, S === "aligned") {
  ...
  if (e.curveDrag.object) {
    const h = He(e.curveDrag.key.transform);
...
function es(e, { selectedOnly: t = !1 } = {}) {
  ...
  if (l.length < o.length && d < a) {
    ...
    e.curveZoomX = X(a / y, 0.2, 30), e.curvePanX = v;
  } else
  ...
  if (f.length > 0) {
    const b = Math.min(...f), v = Math.max(...f), g = Math.max(1e-4, v - b), y = (b + v) / 2, S = (H) => r ? $o(r, H) : Ce(e.state, H), x = [], E = Math.max(1, Math.floor(a / 40));
    for (let H = 0; H <= a; H += E) {
      const ne = S(H);
      for (const j of n) {
        const F = j.get(ne);
    ...
    if (l.length < o.length && g < Y * 0.75) {
      const H = g * 1.35;
      e.curveZoom = X(Y / H, 0.2, 30), e.curvePanY = y - U;
    } else
...
function Yl(e) {
  ...
  const i = e.timelineObject(), c = e.timelineKeyframes(), l = Ze(e), p = 44, m = 14, h = 16, d = 22, f = Math.max(1, a - p - m), u = Math.max(1, o - h - d), b = Math.max(1, e.state.duration_frames - 1), v = X(Number(e.curveZoomX) || 1, 0.1, 50), g = Number(e.curvePanX) || 0, y = b / v, S = g, x = g + y, E = [], M = Math.max(1, Math.ceil(y / Math.max(80, f))), K = ($) => i ? $o(i, $) : Ce(e.state, $);
  for (let $ = 0; $ <= b; $ += M) E.push({ frame: $, value: K($) });
  E[E.length - 1]?.frame !== b && E.push({ frame: b, value: K(b) });
  const L = E.flatMap(($) => l.map((W) => W.get($.value)));
  ...
  if (n.fillStyle = "#111114", n.fillRect(0, 0, a, o), n.strokeStyle = "#222228", n.lineWidth = 1, n.font = "9px system-ui, -apple-system, sans-serif", n.fillStyle = "#6e727a", Fl(n, {
    ...
    xFor: q,
    frame: e.frame
  }), zl(n, { left: p, right: m, top: h, width: a, graphHeight: u, minimum: Y, maximum: U, yFor: G }), Y <= 0 && U >= 0) {
    const $ = G(0);
  ...
  for (const $ of l) {
    ...
    let W = !1;
    E.forEach((P) => {
      const V = q(P.frame), J = G($.get(P.value));
      V >= p - 50 && V <= a - m + 50 && (W ? n.lineTo(V, J) : (n.moveTo(V, J), W = !0));
    }), n.stroke();
    for (const P of c) {
      const V = i ? P.transform : P.camera, J = q(P.frame), de = G($.get(V)), me = P.frame === e.selectedKeyFrame || e.selectedKeyFrames?.has(P.frame);
    ...
    if (e.showCurveHandles)
      for (let P = 0; P < c.length; P++) {
        const V = c[P], J = V.frame === e.selectedKeyFrame || e.selectedKeyFrames?.has(V.frame);
        if (!(J || e.curveChannelFilter !== "all" || c.length <= 4) || V.interpolation !== "bezier") continue;
        const me = i ? V.transform || i : V.camera || V, te = q(V.frame), pe = G($.get(me)), ye = c[P - 1], ue = c[P + 1], xe = Math.max(1, V.frame - (ye?.frame ?? V.frame - 1)), z = Math.max(1, (ue?.frame ?? V.frame + 1) - V.frame), R = Ys(
          V,
          $.id,
          ye,
          ue,
          (re) => $.get(i ? re.transform || i : re.camera || V)
        ), ie = (U - Y) / Math.max(1, u), le = f * z / Math.max(1, y), be = f * xe / Math.max(1, y), fe = [];
        ...
        for (const re of fe) {
          if (n.strokeStyle = $.color, n.lineWidth = J ? 1.5 : 1, n.beginPath(), n.moveTo(te, pe), n.lineTo(re.x, re.y), n.stroke(), n.fillStyle = J ? "#2a2233" : "#171720", n.strokeStyle = J ? "#ffd75e" : $.color, n.lineWidth = J ? 2 : 1.2, n.beginPath(), re.side === "in")
            n.arc(re.x, re.y, J ? 5 : 3.8, 0, Math.PI * 2);
          else {
            const _e = J ? 4.5 : 3.2;
  ...
  if (oe >= p && oe <= a - m && (n.strokeStyle = "#a78bfa", n.lineWidth = 1.5, n.beginPath(), n.moveTo(oe, h), n.lineTo(oe, h + u), n.stroke(), n.fillStyle = "#a78bfa", n.beginPath(), n.moveTo(oe - 4, h), n.lineTo(oe + 4, h), n.lineTo(oe, h + 6), n.closePath(), n.fill()), e.curveDrag || e.curveHover) {
    ...
    if (e.curveDrag)
      if (e.curveDrag.handle) {
        ...
        const P = e.curveDrag.key.frame - e.curveDrag.startFrame, V = e.curveDrag.channel.get(e.curveDrag.object ? e.curveDrag.key.transform : e.curveDrag.key.camera), J = V - e.curveDrag.startValue, de = P >= 0 ? `+${P}` : `${P}`, me = J >= 0 ? `+${J.toFixed(2)}` : `${J.toFixed(2)}`;
    ...
    if ($) {
      ...
      const P = n.measureText($), V = W ? n.measureText(W) : { width: 0 }, J = Math.max(P.width, V.width) + 16, de = W ? 32 : 20, me = a - m - J - 6, te = h + 6;
      n.fillStyle = "rgba(18, 18, 24, 0.88)", n.strokeStyle = "#38384a", n.lineWidth = 1, n.beginPath(), n.roundRect ? n.roundRect(me, te, J, de, 4) : n.rect(me, te, J, de), n.fill(), n.stroke(), n.fillStyle = "#e2e8f0", n.fillText($, me + 8, te + (W ? 13 : 14)), W && (n.fillStyle = "#94a3b8", n.font = "9.5px system-ui, -apple-system, sans-serif", n.fillText(W, me + 8, te + 26)), n.restore();
    }
  }
...
function Ql(e, t) {
  ...
  if (a.appendChild(ao(
    ...
    () => {
      e.checkpoint("Split shot"), In(e.state, e.frame, null) ? ct(e) : e.setStatus(s("Move the playhead inside a shot first"));
    },
    { disabled: o }
  )), a.appendChild(ao(
    s("Clear edit"),
...
function td(e, t, a, o, r) {
  ...
  e.contextMenu?.show(t, n?.name || s("Shot"), [
    ...
    null,
    {
      ...
      run: () => {
        e.checkpoint("Split shot"), In(e.state, e.frame, null) && ct(e);
      }
    },
    {
      label: s("Remove shot"),
      ...
      disabled: r === 1,
      run: () => {
        e.checkpoint("Remove shot"), Xs(e.state, o) && ct(e);
      }
    }
  ]);
}
...
function rs(e, t) {
  ...
  if (n.className = "oc-sequence-lane", n.dataset.role = "sequence-lane", n.setAttribute("aria-label", s("Multi-camera edit")), o.length)
    for (const [c, l] of o.entries()) {
      ...
      ge(e, l.end + 1) < -5 || p > 105 || n.appendChild(ad(e, l, c, r));
    }
  else {
    const c = document.createElement("span");
...
function dd(e) {
  ...
  if (e.audioWaveformPeaks && e.audioWaveformPeaks.length) {
    ...
    const S = y.getContext("2d"), x = e.audioWaveformPeaks, E = y.width, M = y.height, K = M / 2;
    S.fillStyle = "#f2d06b";
    for (let L = 0; L < x.length; L++) {
      const U = (L / (x.length - 1) * r - l) / Math.max(1e-6, c) * E;
      if (U >= -5 && U <= E + 5) {
        const H = x[L] * (M * 0.85);
        S.fillRect(U, K - H / 2, Math.max(1, E / x.length * n - 0.5), H);
      }
    }
    t.appendChild(y);
  }
  ...
  if (o.length > 1) {
    const y = ge(e, o[0].frame), S = ge(e, o[o.length - 1].frame), x = document.createElement("span");
  ...
  for (const y of o) {
    ...
    E.className = "key-label", E.textContent = String(y.frame), x.appendChild(E), x.addEventListener("pointerdown", (M) => {
      if (M.preventDefault(), M.stopPropagation(), x.focus({ preventScroll: !0 }), M.altKey) {
        ...
        const L = a ? { frame: y.frame, transform: He(y.transform), interpolation: y.interpolation } : { frame: y.frame, camera: he(y.camera), interpolation: y.interpolation }, Y = e.timelineKeyframes();
      ...
      e.keyDrag = { key: y, box: t, historyCheckpointed: !1, moving: K.map((L) => ({ key: L, startFrame: L.frame })), startPointerFrame: y.frame, startClientX: M.clientX, startClientY: M.clientY }, e.setFrame(y.frame, !1, !1);
...
const Je = 1, Jr = 50, D = Object.freeze({
...
}), ls = Object.freeze(Object.values(D)), ve = Object.freeze({
  SCENE_GET: "scene.get",
...
}), Xd = Object.freeze(Object.values(ve));
...
const Jd = 25, Zr = 100;
function tt(e, t) {
  const a = e?.offset === void 0 ? 0 : Number(e.offset), o = e?.limit === void 0 ? Jd : Number(e.limit);
...
function em(e, t) {
  ...
  switch (t?.type) {
    ...
    case ve.CAMERA_LIST: {
      const o = a.cameras || [], { offset: r, limit: n, end: i } = tt(t, o.length);
      return we(e, {
        version: 1,
        type: t.type,
        items: o.slice(r, i).map(Zd),
        total: o.length,
        offset: r,
        limit: n
      });
    ...
    case ve.OBJECT_LIST: {
      const o = a.objects || [], { offset: r, limit: n, end: i } = tt(t, o.length);
      return we(e, {
        version: 1,
        type: t.type,
    ...
    case ve.OBJECT_SEARCH: {
      ...
      }, p = (a.objects || []).filter(l), { offset: m, limit: h, end: d } = tt(t, p.length);
      return we(e, {
        version: 1,
        type: t.type,
    ...
    case ve.CHARACTER_LIST: {
      const o = (a.objects || []).filter((c) => c.asset_kind === "character"), { offset: r, limit: n, end: i } = tt(t, o.length);
      return we(e, {
        version: 1,
        type: t.type,
    ...
    case ve.SHOT_LIST: {
      ...
      })), { offset: i, limit: c, end: l } = tt(t, n.length);
      return we(e, {
        version: 1,
        type: t.type,
        items: n.slice(i, l),
    ...
    case ve.KEYFRAME_LIST: {
      ...
      if (!r) throw new I("UNKNOWN_CAMERA", `Unknown camera: ${o}`);
      const n = r.keyframes || [], { offset: i, limit: c, end: l } = tt(t, n.length);
      return we(e, {
        version: 1,
        type: t.type,
        cameraId: r.id,
...
function im(e, t) {
  ...
  e.objects ||= [];
  const a = new Set(e.objects.map((i) => i.id)), o = Mo(a, t.objectType, t.id), r = tm(t.objectType), n = {
    id: o,
    type: t.objectType,
    name: t.name || o,
    ...r,
...
function um(e, t) {
  ...
  switch (a) {
    ...
    case D.KEYFRAME_UPSERT:
      if (e.cameraId !== void 0 && ee(e.cameraId, "cameraId", t), Oe(e.frame, "frame", t), e.interpolation !== void 0 && !uo.includes(e.interpolation))
        throw new I("BAD_INTERPOLATION", `Unsupported interpolation: ${e.interpolation}`, t);
      if (e.camera !== void 0) {
    ...
    case D.KEYFRAME_SET_INTERPOLATION:
      if (e.cameraId !== void 0 && ee(e.cameraId, "cameraId", t), Oe(e.frame, "frame", t), !uo.includes(e.interpolation))
        throw new I("BAD_INTERPOLATION", `Unsupported interpolation: ${e.interpolation}`, t);
      break;
...
function bm(e, t) {
  ...
  return t.operations.forEach((o, r) => um(o, r)), {
    version: Je,
    id: t.id,
...
const ym = "omnicam/library", vm = "majoor_omnicam/blockout_library", xm = Object.freeze({
...
function ms(e) {
  return e.file ? `${e.source === "legacy" ? vm : ym}/${e.file} [input]` : "";
}
function Qr(e, t, a) {
  const o = e || "asset";
  let r = `${o}_${a}`, n = 2;
...
function Sm(e, t = {}) {
  ...
  const a = wm(t.point, [0, 0, 0]), o = String(t.idSeed || Date.now().toString(36)), r = String(e.kind || "prop"), n = r === "character", i = xm[e.id];
...
const _m = {
  [D.ASSET_INSTANTIATE](e, t) {
    ...
    let o;
    try {
      o = Sm(t.asset, { point: t.point, idSeed: t.id, existingIds: a });
    } catch (r) {
  ...
  [D.CAMERA_TRANSFORM](e, t) {
    const a = At(e, t.cameraId), o = en(a);
  ...
  [D.OBJECT_SET_ENABLED](e, t) {
    return Mt(e, t.objectId).enabled = t.value, { dirtyMask: _.viewport | _.previews | _.outliner | _.inspector };
  },
  [D.OBJECT_SET_LOCKED](e, t) {
    return er(e, t.objectId).locked = t.value, { dirtyMask: _.outliner | _.inspector };
  },
  [D.OBJECT_SET_TAGS](e, t) {
    const a = Mt(e, t.objectId), o = ai(t.tags), r = o.length !== t.tags.length ? "some tags were dropped or normalised" : void 0;
    return o.length ? a.tags = o : delete a.tags, { dirtyMask: _.outliner | _.inspector | _.viewport, warning: r };
  },
  [D.OBJECT_SET_ANNOTATION](e, t) {
    const a = Mt(e, t.objectId), o = t.annotation === null ? null : On(t.annotation);
    if (t.annotation && !o)
  ...
  [D.KEYFRAME_REMOVE](e, t) {
    const a = At(e, t.cameraId), o = (a.keyframes || []).length;
  ...
  [D.KEYFRAME_SET_INTERPOLATION](e, t) {
    const a = At(e, t.cameraId), o = ro(a, t.frame);
...
function Cm({ state: e, operation: t }) {
  const a = _m[t.type];
...
function Am(e, t) {
  ...
  return Mm(e, t, r), Tm(e, t, r), Im(e, t, r), Om(e, t, r), { changes: a, truncated: o };
}
const $m = ["fov", "roll", "zoom", "near", "far", "camera_type"];
function Mm(e, t, a) {
...
function Nm(e, t) {
  ...
  for (let p = 0; p < a.operations.length; p += 1)
    try {
      const m = Cm({ ui: e, state: r, operation: a.operations[p] });
  ...
  if (a.validateOnly) {
    const { changes: p, truncated: m } = Am(e.state, r);
    return {
      ok: !0,
      version: Je,
      revision: o,
  ...
  const l = Lm(e);
  return (e._directorApiTxIds ||= /* @__PURE__ */ new Set()).add(a.id), e.serialize?.(), Fm(e, l), zm(e, n, `director-api:${a.id}`), {
    ok: !0,
    version: Je,
    baseRevision: o,
    revision: ar(e),
...
function Km(e) {
  return e.directorApi = Rm(e), e.directorApi;
}
const tn = "omnicam-agent/1", an = "majoor.omnicam.agent.request", Dm = 1, no = Object.freeze({
...
function Um(e, t, a) {
  ...
  async function v(y) {
    const S = y?.detail;
    if (o || !S || S.protocol !== tn || Number(S.schema_version) !== Dm || S.session_id !== r || String(S.node_id) !== String(t.id)) return;
    let x;
    try {
      if (S.kind === "query")
...
function jr({ fetchApi: e = Wm } = {}) {
  const t = (a, o) => Promise.resolve(e(a, o)).then(Vm);
  return {
    list(a = {}) {
...
const Jm = 256;
function nn(e = {}) {
  const { THREE: t, GLTFLoader: a, FBXLoader: o, size: r = Jm } = e;
  if (!t || !a)
...
function ap(e, t = {}) {
  return ps.map((a) => {
    const o = s(tp[a] || a), r = a === "all" ? "" : ` <span class="oc-asset-kind-n">${Number(t[a] || 0)}</span>`;
    return `<button type="button" class="oc-asset-kind${a === (e || "all") ? " active" : ""}" data-asset-kind="${a}">${it(o)}${r}</button>`;
  }).join("");
}
function op(e, { selected: t = !1, thumbUrl: a = "" } = {}) {
  const o = ep[e.kind] || "pi-box", r = e.kind === "character" && Pn(e.rig) === "rigged" ? `<span class="oc-asset-badge">${s("RIGGED")}</span>` : "", n = a ? `<img class="oc-asset-thumb" src="${it(a)}" alt="" loading="lazy">` : `<span class="oc-asset-thumb oc-asset-thumb--glyph"><i class="pi ${o}"></i></span>`;
  return `<button type="button" class="oc-asset-card${t ? " selected" : ""}" data-asset-id="${it(e.id)}" title="${it(e.name)}">
    ${n}
    <span class="oc-asset-name">${it(e.name)}</span>
    <span class="oc-asset-kind-tag">${it((e.kind || "").toUpperCase())}</span>
    ${r}
  </button>`;
}
function rp(e, { selectedId: t = "", thumbUrls: a = {} } = {}) {
  return !e || !e.length ? `<p class="oc-asset-empty">${s("No assets match this filter.")}</p>` : e.map((o) => op(o, {
    selected: o.id === t,
    thumbUrl: a[o.id] || ""
  })).join("");
}
...
function np(e, t = {}) {
  const a = e.root, o = t.fetchApi || ((z, R) => (e.api || e.app?.api).fetchApi(z, R)), r = t.apiClient || jr({ fetchApi: o }), n = t.store || Gm(r), i = Ym(), c = t.previewQueue || Xm(), l = e.api || e.app?.api || null;
  let p = t.thumbnailRenderer || null, m = null;
  const h = /* @__PURE__ */ new Set();
  function d() {
    return p ? Promise.resolve(p) : (m || (m = Zm().then((z) => p = nn(z)).catch(() => p = nn({}))), m);
  }
  function f(z) {
    return zr(l, ms(z));
  }
    ...
    for (const z of n.state.items) {
      ...
      R && c.enqueue(z.id, async () => {
        ...
        if (i.set(z.id, le), G(), !(z.source && z.source !== "user"))
          try {
            const be = await r.uploadThumbnail(z.id, Qm(le));
  ...
  const v = (z) => a.querySelector(`[data-role="${z}"]`), g = v("assets-panel"), y = v("asset-grid"), S = v("asset-kinds"), x = v("asset-search"), E = v("asset-status"), M = v("asset-import-file"), K = v("scene-tab"), L = v("assets-tab");
  let Y = "", U = null, H = !0, ne = 0;
  function j(z, { sticky: R = !1 } = {}) {
    E && (!R && ne > Date.now() || (E.textContent = z || "", ne = R ? Date.now() + 9e3 : 0));
  }
  function F(z) {
    if (Y = z, !!y)
      for (const R of y.querySelectorAll(".oc-asset-card"))
        R.classList.toggle("selected", R.dataset.assetId === z);
  }
  let q = !1;
  function G() {
    if (S && (S.innerHTML = ap(n.state.filter.kind, n.state.kinds)), y) {
      const z = {};
      for (const R of n.state.items) {
        const ie = i.get(R.id) || u(R);
        ie && (z[R.id] = ie);
      }
      y.innerHTML = rp(n.state.items, { selectedId: Y, thumbUrls: z });
    }
    if (!q) {
      q = !0;
      try {
  ...
  const W = v("asset-local-form"), P = v("asset-local-folder"), V = v("asset-local-note");
  function J() {
  ...
  function te(z) {
    ...
    if (R) {
      ...
      if (R.action === "asset-import")
        return M?.click();
      if (R.action === "local-toggle") return J();
...
function pp(e, t = {}) {
  ...
  function S() {
    ...
    l && (l.textContent = j);
    const q = f(), G = g(q?.character)[j] || [0, 0, 0, 1], oe = ni(G);
    p.forEach(($, W) => {
  ...
  function M() {
    const j = b();
    if (!j) return;
    const F = p.map((oe) => Number(oe?.value) || 0), q = oi(F), G = e.directorApi?.execute({
      version: 1,
  ...
  async function L() {
    ...
    const q = F.toLowerCase().replace(mp, "-").replace(/^-+|-+$/g, "").slice(0, 60) || "pose";
    try {
  ...
  function ne() {
    ...
    j.id !== m && (m = j.id, h = !1, e.subSelection?.type === "character_joint" && (e.subSelection = null), d.size || E()), x(), H.update();
  }
...
const dn = ["#4aa3ef", "#f2a93b", "#48c774", "#b565d8", "#ec4899"], qe = [4, 8, 12, 20, 35, 60, 100];
function mt(e) {
...
function To(e, t, a) {
  ...
  const o = mt(e), r = o.expanded ? 220 : 138, n = Math.min(r, Math.max(80, Math.min(t, a) - 20)), i = 10, c = Math.max(0, t - n - i), l = Math.max(0, a - n - i), p = e.viewportCamera(), m = p?.position || [0, 1.5, 5], h = p?.target || [0, 0, 0], d = e.activeCameraTrack?.(), f = e.state.cameras?.length ? e.state.cameras : d ? [d] : [], u = f.flatMap(
...
function xp(e, t, a, o) {
  const r = To(e, a, o);
  if (!r) return;
  const { rx: n, ry: i, radarSize: c, cx: l, cy: p, innerRadius: m, range: h, scale: d, camPos: f, camTgt: u, cameras: b, activeTrack: v } = r, g = mt(e), y = e.state.active_camera_id || v?.id, S = (te, pe) => hs(r, te, pe);
  ...
  for (const te of e.state.objects || []) {
    ...
    const pe = br(e.state.objects, te).position || [0, 0, 0], [ye, ue] = S(pe[0], pe[2]);
  ...
  for (let te = 0; te < b.length; te++) {
    const pe = b[te], ye = pe.keyframes || [], ue = pe.id === y, xe = pe.color || dn[te % dn.length];
  ...
  const [M, K] = S(f[0] || 0, f[2] || 0), [L, Y] = S(u[0] || 0, u[2] || 0), U = 8, H = X(M, n + U, n + c - U), ne = X(K, i + U, i + c - U), j = X(L, n + U, n + c - U), F = X(Y, i + U, i + c - U), q = f[1] || 0, G = yp(q), oe = vp(q);
...
function Tp() {
  return `<span class="oc-pref-emoji" aria-hidden="true">${Ep}</span> ${s("OmniCam Preferences")}`;
}
function Ip(e) {
  ...
  a.className = "oc-modal-backdrop", a.setAttribute("role", "dialog"), a.setAttribute("aria-modal", "true"), a.setAttribute("aria-label", s("OmniCam Preferences")), a.innerHTML = `
    <div class="oc-modal-dialog oc-pref-dialog" tabindex="-1">
      <div class="oc-pref-header">
        <div class="oc-pref-title">${Tp()}</div>
...
const Pp = ["position", "target"], Lp = ["fov", "zoom"], Fp = ["roll"], zp = ["position", "size"], Np = ["rotation"];
function rr(e) {
...
function Vp(e, t) {
  ...
  const o = (r) => {
    ...
    const u = (v) => {
      ...
      let y = qp;
      v.shiftKey ? y = Up : (v.ctrlKey || v.metaKey) && (y = Wp);
      const S = p * y * 20;
      let x = l + g * S;
...
function Jp(e, t) {
  ...
  }, n = (i) => (e.smoothingBaseline?.cameraId !== i.id && (e.smoothingBaseline = { cameraId: i.id, keys: Bp(i.keyframes) }), e.smoothingBaseline.keys);
  a.addEventListener("input", r, { signal: t }), a.addEventListener("change", () => {
    const i = e.activeCameraTrack();
    if (!i) return;
    e.checkpoint("Path smoothing");
    const c = Number(a.value) / 100, l = Dp(n(i), c);
...
const co = () => import("./chunk-Cc9RVC2G.js");
function of(e, t) {
...
function lf(e, t) {
  of(e, t), Xp(e, t), Jp(e, t), Zp(e, t), Qp(e, t), nf(e, t), cf(e, t), sf(e, t), Vp(e, t), Hp(e, t), ef(e, t), af(e, t), Yp(e, t), tf(e, t), rf(e, t);
}
const bn = {
...
function df(e, t = "#1b1f2b", a = "#151822", o = "#1e2330", r = "#161922", n = "#111319") {
...
function Nb(e, t, a = ys) {
  ...
  const f = new e.FogExp2(1250588, 8e-3), u = df(e), b = new e.PMREMGenerator(t);
...
function Db(e, t, a) {
  return e?.reconstruction ? a ? "neutral" : ff(t) === "source_texture" ? "textured" : "neutral" : null;
}
function hf(e, t) {
...
function uf(e, t, a) {
  ...
  for (const n of e.root.querySelectorAll('[data-role="viewport-bg-color"]')) {
    const i = (c) => {
      e.state.viewport_bg_color !== c.target.value && lo(e, "viewport_bg_color", "Change background colour"), e.state.viewport_bg_color = c.target.value, ke(e.root, "viewport-bg-color", c.target), e.scheduleSerialize(), e.render();
    };
    n.addEventListener("input", i, { signal: a }), n.addEventListener("change", i, { signal: a });
  }
  ...
  for (const n of e.root.querySelectorAll("[data-blocking-scene]"))
    n.addEventListener("click", () => {
      gp(e, n.dataset.blockingScene), e.closeMenus();
    }, { signal: a });
...
const bf = 32, gf = 0.025, yf = 0.05, ko = 1e-6, vf = ["top", "bottom", "front", "back", "left", "right"], xf = {
  top: "y",
  bottom: "y",
  front: "z",
  back: "z",
...
function _f(e) {
  ...
  const n = Math.min(bf, r.length, o + 1);
  if (n < 2) return [];
  const i = kf(r, n);
  ...
  for (let d = m; d < i.length; d++) {
    const f = i[d], u = Sf(i, d, p, e.planeAxis), b = he(c);
    b.position = [...f], b.target = jf(f, u, l, e.planeAxis), h.push({
...
function yn(e, t = {}) {
  ...
  if (a === "extend") {
    ...
    vf.includes(e.state.view_mode) || e.setViewMode?.("top"), c = gn(e.state);
  const m = xf[e.state.view_mode] ?? null, h = n ? [...n] : [...r.position];
...
function Ar(e, t) {
  ...
  return r && Er(r, o) < gf ? !1 : (a.points.push(o), !0);
}
function Le(e) {
  const t = e.cameraPathDraw;
  return t?.active ? (ws(e, t), e.cameraPathDraw = null, Pt(e), e.setStatus?.(s("Draw Camera Path cancelled")), e.render?.(), !0) : !1;
}
function Ef(e) {
  const t = e.cameraPathDraw;
  ...
  if (a.length < 2 || wf(a) < yf || t.range[1] <= t.range[0])
...
function $f(e, t) {
  const a = e.cameraPathDraw;
  return a?.active ? t.button === 2 && !t.altKey ? (jo(t), e.cameraPathSuppressContextMenuUntil = Date.now() + 1e3, Le(e), !0) : t.button !== 0 || t.altKey || t.ctrlKey || t.metaKey || t.shiftKey ? !1 : (jo(t), e.closeMenus?.(), e.interactionElement.focus?.({ preventScroll: !0 }), e.interactionElement.setPointerCapture?.(t.pointerId), a.drawing = !0, a.pointerId = t.pointerId, a.points = [], Ar(e, $r(e, t)), Pt(e), e.requestRender?.("camera-path-draw"), !0) : !1;
}
function Mf(e, t) {
  const a = e.cameraPathDraw;
...
function Tf(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : (jo(t), t.type === "pointercancel" || t.type === "lostpointercapture" ? (Le(e), !0) : (Ar(e, $r(e, t)), a.drawing = !1, Ef(e), !0));
}
function If(e) {
  const t = e.cameraPathDraw;
...
function Of(e, t) {
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? Le(e) : yn(e);
    }, { signal: t });
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path-extend"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? Le(e) : yn(e, { mode: "extend" });
    }, { signal: t });
...
async function Pf(e) {
  await Nt(e, s("New Scene"), s("Start a new scene? Unsaved changes will be lost.")) && Mr(e, Bn(), { name: "", status: s("New scene") });
}
async function Lf(e) {
  if (!e.sceneBaseline) {
...
async function Ff(e) {
  const t = ks(e) || s("Untitled"), a = await zt(e, s("Save Scene"), s("Scene name"), t);
  if (a == null) return;
...
function Rf(e, t) {
  mo(e, t, e.root.querySelectorAll('[data-act="scene-new"]'), () => Pf(e)), mo(e, t, e.root.querySelectorAll('[data-act="scene-open"]'), () => zf(e)), mo(e, t, e.root.querySelectorAll('[data-act="scene-save"]'), () => Ff(e)), mo(e, t, e.root.querySelectorAll('[data-act="scene-reset"]'), () => Lf(e));
}
const Kf = ["world_point", "object_point", "camera_field"], vn = 40;
function Df(e) {
...
function Uf(e) {
  ...
  for (const v of e.state.motion_layers || []) {
    if (v.enabled === !1) continue;
    const g = Kf.includes(v.source_kind), y = g ? Bf(e.state, v, d) : Df(v);
...
function Vf(e) {
  ...
  cc(e, t), lc(e, t), Wf(e, t), Op(e, a, t), uf(e, a, t), Hc(e, t), Of(e, t), Rf(e, t), Cp(e, a, t), lf(e, t);
}
function Hf(e, t) {
...
const Xe = 1024 * 1024, Xf = Object.freeze({
  card: 128 * Xe,
  // MAX_CARD_BYTES
  model: 256 * Xe,
  // MAX_MODEL_BYTES
...
function kn(e) {
  return `${(e / Xe).toFixed(e >= 10 * Xe ? 0 : 1)} MB`;
}
function Rt(e, t) {
  const a = Xf[t];
  if (!e || !a) return null;
...
async function eh(e, { load: t = () => import("./vendor-mediabunny-CZ5VNE-V.js") } = {}) {
...
async function ah(e, t, { decode: a = eh } = {}) {
  if (!t) return;
  const o = Rt(t, "audio");
  if (o) {
    e.setStatus(o);
  ...
  try {
    ...
    n.preload = "auto", n.src = r, e.audioObjectUrl = r, e.audioElement = n, await th(n), e.audioDuration = Number.isFinite(n.duration) ? n.duration : 0;
    try {
...
const Cs = /* @__PURE__ */ new WeakSet(), Tt = /* @__PURE__ */ new WeakMap();
function Co(e) {
...
function oh(e) {
  e && typeof e == "object" && Tt.set(e, (Tt.get(e) || 0) + 1);
}
function rh(e) {
  ...
  Tt.delete(e), Cs.has(e) && Co(e);
}
function Kt(e, t) {
  const a = e.cardMediaById.get(t);
  a && (e.cardMediaById.delete(t), e.cardMediaAssetById?.delete?.(t), t === "subject" && e.cardMedia === a && (e.cardMedia = null), rh(a));
}
function nh(e) {
...
function We(e, t, a, o = !1, r = "") {
  ...
  n && n !== a && Kt(e, t), o && Cs.add(a), oh(a), e.cardMediaAssetById ||= /* @__PURE__ */ new Map(), e.cardMediaById.set(t, a), e.cardMediaAssetById.set(t, r || a?.__omnicamAsset || "");
  try {
    a.__omnicamAsset = r || a.__omnicamAsset || "";
  } catch {
  }
...
async function sh(e, t) {
  if (!lt?.fetchApi || !/\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/i.test(e)) return null;
  const a = await lt.fetchApi("/majoor/omnicam/extractor/source", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
...
async function lh(e, t) {
  ...
  try {
    const c = await Sr(lt, { route: "/majoor/omnicam/upload_model", field: "asset", file: t });
...
async function dh(e, t) {
  ...
  if (o) {
    ...
    try {
      const r = await Sr(lt, { route: "/majoor/omnicam/upload_asset", field: "asset", file: t });
...
function ph(e) {
  ...
  }, a.src = lt.apiURL(`/view?${new URLSearchParams(t).toString()}`);
}
async function fh(e) {
  if (!e.node) return;
  ...
  for (const h of i) {
    ...
    if (f) {
      if (d === "image" || d === "video") {
        ...
        if (u && u.value) {
          const b = String(u.value), v = /\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/i.test(b), g = f.widgets?.find((x) => String(x.name).toLowerCase() === "subfolder")?.value || "", y = Ue(ot(b, g)), S = e.state.objects.find((x) => x.id === "subject");
          if (S) {
          ...
          }), We(e, "subject", b, !1, b.currentSrc || b.src || ""), xn(e, b, { frameCount: b instanceof HTMLVideoElement ? 0 : 1 }), e.upstreamImageConnected = !0, n = !0, e.render(), e.setStatus(b instanceof HTMLVideoElement ? s("Upstream video preview synced") : s("Upstream image preview synced")));
        }
      }
      if (d === "audio") {
        l = !0;
        ...
        if (u && u.value) {
          const b = String(u.value), v = f.widgets?.find((y) => String(y.name).toLowerCase() === "subfolder")?.value || "", g = Ue(ot(b, v));
          try {
      ...
      if (d === "scene_3d" || d === "model" || d === "mesh") {
        ...
        if (u && u.value) {
          ...
          if (["glb", "gltf", "obj", "fbx", "stl", "ply"].includes(v)) {
            const g = f.widgets?.find((E) => String(E.name).toLowerCase() === "subfolder")?.value || "", y = Ue(ot(b, g)), S = `upstream_scene_${f.id}`;
            p.add(S);
            let x = e.state.objects.find((E) => E.id === S);
            x ? (x.asset = ot(b, g), x.format = v === "gltf" ? "glb" : v) : (x = {
              id: S,
              type: "model",
              format: v === "gltf" ? "glb" : v,
...
const hh = ["video/mp4;codecs=avc1.42E01E", "video/webm;codecs=vp9", "video/webm;codecs=vp8", "video/webm"], Sn = { low: 3e6, balanced: 6e6, high: 12e6 };
function uh(e) {
  ...
  try {
    for (const S of hh)
      if (!(n.isTypeSupported && !n.isTypeSupported(S)))
        try {
          h = new n(m, { mimeType: S, videoBitsPerSecond: uh(r) });
          break;
        } catch {
        }
...
async function $s(e) {
  await yh(e.cardMediaById.values());
}
async function Ms(e) {
  return bh({
    canvas: e.canvas,
...
async function Ts(e, t) {
  const a = await gh(Ve, t);
  if (Yf(e, t), e.state.playblast_camera_id === qn)
...
async function xh(e) {
  ...
  const t = e.frame, a = e.canvas.width, o = e.canvas.height, r = vh(e);
  (r.width !== e.canvas.width || r.height !== e.canvas.height) && (e.canvas.width = r.width, e.canvas.height = r.height, e.render());
  try {
    let n = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-DchJB13x.js");
...
async function Is(e) {
  ...
  return Sr(Lt, { route: "/majoor/omnicam/upload_asset", field: "asset", file: e });
}
async function Eo(e) {
...
function _h(e) {
  ...
  for (const m of a) {
    ...
    if (!h) continue;
    const d = zn(a, m, l) || { position: m.position, size: m.size }, f = ze(Nn(d, m.type), o, n, i);
    if (!f) continue;
    const [u, b] = f, v = t.content === "annotation" && m.annotation?.color || "", g = 6 * c, y = 4 * c, x = r.measureText(h).width + g * 2, E = 12 * c + y * 2, M = Math.round(u - x / 2), K = Math.round(b - E - 6 * c);
    r.fillStyle = "rgba(16,17,22,0.82)", Ch(r, M, K, x, E, 4 * c), r.fill(), v && (r.strokeStyle = v, r.lineWidth = Math.max(1, c), r.stroke()), r.fillStyle = v || "#e6e6ec", r.fillText(h, M + g, K + E - y - 2 * c);
  }
  r.restore();
}
function Ch(e, t, a, o, r, n) {
...
const $h = 600;
function Mh(e) {
  const { points: t, colors: a } = Ah(e);
  if (!t.length) return;
  const o = e.viewportCamera(), r = e.canvas.width, n = e.canvas.height, i = t.length / 3, c = 3 * Math.max(1, Math.ceil(i / $h)), l = /* @__PURE__ */ new Map();
...
function Oh(e, t) {
  ...
  ce(e, c, l, "#aaa", 2), ce(e, l, b, "#aaa", 2), ce(e, p, m, "#aaa", 2), ce(e, p, h, "#aaa", 2), ce(e, h, f, "#aaa", 2), ce(e, m, d, "#aaa", 2), ce(e, d, u, "#aaa", 2), ce(e, v, g, "#aaa", 2), ce(e, v, y, "#aaa", 2), ce(e, y, x, "#aaa", 2), ce(e, g, S, "#aaa", 2), ce(e, S, E, "#aaa", 2);
...
function zh(e, t) {
  const [a, o, r] = t.position || [0, 1.5, 0], [n, i] = t.size || [2, 3], c = e.viewportCamera(), l = [
    ...
    [a + n / 2, o + i / 2, r],
    [a - n / 2, o + i / 2, r]
  ].map((v) => ze(v, c, e.canvas.width, e.canvas.height));
  ...
  if (b)
    try {
      ...
      if (e.ctx.fillStyle = "#111", e.ctx.fillRect(h, f, v, g), x === "stretch" || !y || !S)
        ...
        const E = Math.min(v / y, g / S), M = y * E, K = S * E;
        e.ctx.drawImage(b, h + (v - M) / 2, f + (g - K) / 2, M, K);
      } else {
        const E = Math.max(v / y, g / S), M = v / E, K = g / E;
        e.ctx.drawImage(b, (y - M) / 2, (S - K) / 2, M, K, h, f, v, g);
      }
    } catch {
    }
  else
...
function Kh(e) {
  ...
  e.recording && e.state.playblast_labels && _h(e);
}
async function Dh(e, { signal: t } = {}) {
...
async function qh(e) {
  ...
  const r = o.diagnostic?.issues || [], n = Bh(r);
  ...
  if (m) {
    ...
    if (t.appendChild(y), !S)
      for (const { object: x, level: E } of g) {
        ...
        M.setAttribute("aria-selected", String(K)), M.className = `scene-item${K ? " selected" : ""}${L ? " primary" : ""}${E > 0 && !n ? " scene-item-child" : ""}`, E > 0 && !n && (M.style.paddingLeft = `${E * 16 + 6}px`);
        ...
        F.style.cssText = H ? "color:#fca5a5" : U ? "" : "opacity:.5;text-decoration:line-through", F.textContent = x.name || x.type, F.title = s("Double-click to rename"), F.addEventListener("dblclick", ($) => {
          $.preventDefault(), $.stopPropagation(), Yh(e, x, F);
        }), j.appendChild(F);
        ...
        G.className = "scene-item-actions", G.appendChild(r(U ? "pi-eye" : "pi-eye-slash", U ? "Hide object (Alt+Click to Isolate)" : "Show object (Alt+Click to Isolate)", !U, ($) => {
          if ($?.altKey) {
            ...
            e.toggleObject(x.id);
        }, "color:#ef4444;opacity:.7")), G.appendChild(r(x.locked ? "pi-lock" : "pi-lock-open", "Lock object", x.locked, () => Cr(e, x))), G.appendChild(r("pi-copy", "Duplicate object", !1, () => e.duplicateObject?.(x.id))), x.id !== "subject" && G.appendChild(r("pi-trash", "Delete object", !1, () => e.deleteObject?.(x.id))), G.appendChild(r("pi-ellipsis-v", "Object actions", !1, ($) => e.openObjectContext($, x.id))), M.append(ne, j, G), M.title = s("Click to select · Double-click to toggle visibility · Right-click for actions");
        const oe = ($ = {}) => {
          ...
          if (e.finishCameraEdit(), e.selectedEntity = "object", e.selectedObjectIds ||= /* @__PURE__ */ new Set(), $.ctrlKey || $.metaKey)
            ...
            const P = e.state.objects.map((de) => de.id), V = P.indexOf(e.outlinerAnchorId), J = P.indexOf(x.id);
            e.selectedObjectIds = new Set(P.slice(Math.min(V, J), Math.max(V, J) + 1));
          } else
          ...
          for (const P of t.querySelectorAll(".scene-item")) {
            const V = !!(P.dataset.objectId && e.selectedObjectIds.has(P.dataset.objectId)), J = !!(P.dataset.objectId && P.dataset.objectId === e.selectedObjectId);
            P.classList.toggle("selected", V), P.classList.toggle("primary", J), P.dataset.objectId && P.setAttribute("aria-selected", String(V));
          }
...
function tu(e) {
  ...
  if (n) {
    const j = r.target_object_id || e.state.target_object_id || "", F = `T${Kr()}${e.state.objects.map((q) => `${q.id}\0${q.name || q.type}`).join("|")}`;
    Ho(n, F, () => [
      $t("", s("Manual Target (No Tracking)")),
      ...e.state.objects.map((q) => $t(q.id, `${s("Track:")} ${q.name || q.type}`))
    ], j);
  }
  Gh(e);
  ...
  if (v) {
    ...
    const G = e.state.objects.filter(($) => !F.has($.id)), oe = `P${Kr()}${j}${G.map(($) => `${$.id} ${$.name || $.type}`).join("|")}`;
    Ho(v, oe, () => [
      $t("", s("No parent")),
      ...G.map(($) => $t($.id, $.name || $.type))
    ], t.parent_id || "");
  }
  ...
  if (u && (u.hidden = !L?.animations), b) {
    ...
    Ho(b, `A${j.join("|")}`, () => j.map((F, q) => $t(String(q), F)), String(t.animation_index || 0));
  }
...
function nu(e) {
  ...
  e.beginCameraEdit(), mc(e.camera, r), e.commitCameraEdit(), e.finishCameraEdit(), Rs(e), ru(e), e.render();
}
function su(e) {
  const t = globalThis.performance?.now?.() ?? Date.now();
  (!Number.isFinite(e.lastCameraHudEditAt) || t - e.lastCameraHudEditAt > 300) && e.checkpoint("Edit camera"), e.lastCameraHudEditAt = t;
  ...
  e.camera.position = [a("camera-px", e.camera.position[0]), a("camera-py", e.camera.position[1]), a("camera-pz", e.camera.position[2])], e.camera.target = [a("camera-tx", e.camera.target[0]), a("camera-ty", e.camera.target[1]), a("camera-tz", e.camera.target[2])], e.camera.fov = X(a("camera-fov", e.camera.fov), 5, 150), e.camera.roll = X(a("camera-roll", e.camera.roll || 0), -180, 180), e.camera.near = Math.max(1e-4, a("camera-near", e.camera.near)), e.camera.far = Math.max(e.camera.near + 1e-4, a("camera-far", e.camera.far)), e.beginCameraEdit(), e.commitCameraEdit(), e.finishCameraEdit(), Rs(e), e.render();
}
function iu(e, t) {
  const a = Dt(e);
  if (!a) return;
...
function gu(e) {
  ...
  const t = e.root.querySelector('[data-role="key-interp"]')?.value || e.root.querySelector('[data-role="interp"]')?.value || "ease", a = Me(e), o = Se(e), r = a ? { frame: e.frame, transform: He(a), interpolation: t } : { frame: e.frame, camera: he(e.camera), interpolation: t }, n = o.findIndex((i) => i.frame === e.frame);
...
function wu(e) {
  ...
  const o = t ? { frame: e.frame, transform: He(e.copiedKeyframe.transform), interpolation: e.copiedKeyframe.interpolation } : { frame: e.frame, camera: he(e.copiedKeyframe.camera), interpolation: e.copiedKeyframe.interpolation }, r = Se(e), n = r.findIndex((i) => i.frame === e.frame);
...
const Au = ["guides", "safe-areas", "resolution-gate", "aspect-ratio"];
function $u(e) {
...
function Pu(e) {
  ...
  if (e.checkpoint("Edit keyframe"), e.editingKeyFrame = t.frame, Me(e)) {
    t.interpolation = e.root.querySelector('[data-role="key-interp"]').value, t.transform = He(Me(e)), e.serialize(), e.setFrame(t.frame), e.setStatus(s(`Object keyframe updated @ ${t.frame}`));
    return;
  }
  const a = (o, r) => {
...
function ir(e, t, a) {
  const o = Fe(e), r = t ? Fe(t) : o, n = a ? Fe(a) : o, i = Math.max(sr, Ae(e?.frame) - Ae(t?.frame, Ae(e?.frame) - 1)), c = Math.max(sr, Ae(a?.frame, Ae(e?.frame) + 1) - Ae(e?.frame)), l = [0, 0, 0], p = [0, 0, 0];
  for (let m = 0; m < 3; m += 1) {
...
function Bs(e, t, a) {
  const o = Fe(e), r = zu(e, t, a);
  dt(e, "out", Ft(r.out, o)), dt(e, "in", Ft(r.in, o));
}
function Ru(e, t, a, { prevKey: o = null, nextKey: r = null } = {}) {
...
function Ku(e, t, { prevKey: a = null, nextKey: o = null } = {}) {
  ...
  if (t === "corner") {
    const r = Ds(e, a, o);
    return lr(e), dt(e, "out", r.out), dt(e, "in", r.in), e;
  }
...
function qu(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: h, playblastCameraTrack: d, restoreFromWidgets: f, serializeEditorState: u, syncActiveCameraTrack: b, syncFromWidgets: v, bindEditorEvents: g, activateCamera: y, addCamera: S, deleteCamera: x, drawPreviewOverlays: E, duplicateCamera: M, maximizeCameraPreview: K, refreshCameraPreviews: L, refreshCameraSelectors: Y, renameCamera: U, setPlayblastCamera: H, toggleCameraView: ne, captureRealtime: j, makePlayblast: F, uploadDirectorPlayblast: q, waitForMediaFrame: G, computeAudioPeaks: oe, loadAudioFile: $, releaseAudio: W, stopPlay: P, togglePlay: V, applyCameraPreset: J, applyCameraShake: de, applyProxyPreset: me, clearViewportBgImage: te, loadViewportBgFile: pe, loadViewportBgSequence: ye, drawCameraPath: ue, drawCard: xe, drawCube: z, drawGrid: R, drawHuman: ie, drawLine3D: le, drawNull: be, drawOverlays: fe, drawPointField: re, drawSpeedHeatmap: _e, drawSphere: Bt, curveChannels: qt, drawCurveEditor: pt, onCurvePointerDown: ft, onCurvePointerMove: ht, onCurvePointerUp: ut, onTimelinePointerDown: Ut, onTimelinePointerMove: Wt, onTimelinePointerUp: Vt, refreshKeys: bt, resetCurveZoom: gt, resetTimelineZoom: Qe, setChannelFilter: yt, setCurveInterpolation: vt, setTangentMode: xt, timelineFrameFromEvent: Ht, toggleCurveHandles: wt, zoomCurve: Gt, drawTransformGizmo: Yt, frameTarget: Xt, gizmoAxes: Jt, gizmoGeometry: Zt, onPointerDown: Qt, onPointerMove: ea, onPointerUp: ta, onWheel: aa, pickGizmo: oa, pickSceneObject: ra, resetCamera: kt, setTransformMode: St, setViewMode: na, viewportCamera: sa, loadCardFile: Oo, loadExecutionPreview: Po, loadMediaUrl: ia, loadModelFile: ca, loadSelectedReference: la, onModelLoaded: da, restoreAssets: ma, syncUpstreamInputs: pa, configureDomMedia: fa, refreshSetupDiagnostic: jt, addMediaCard: ha, addPrimitive: ua, applyObjectAnimationFrame: ba, beginCameraEdit: ga, beginObjectEdit: ya, commitCameraEdit: va, commitObjectEdit: xa, copyKeyframe: wa, deleteKeyframe: ka, deleteObject: Sa, duplicateObject: ja, exitKeyEdit: _a, finishCameraEdit: Ca, goToAdjacentKey: Ea, insertKeyframe: Aa, loadSelectedKeyView: $a, pasteKeyframe: Ma, playblastCameraAtFrame: Ta, refreshInspector: Ia, refreshKeyEditor: Oa, refreshObjects: Pa, removeObjectResources: La, renameObject: Fa, retimeSelectedKey: za, selectKeyframe: Na, selectedKeyframe: Ra, selectedObject: Ka, selectObjectAnimation: Da, setKeyInterpolation: Ba, setObjectParent: qa, timelineKeyframes: Ua, timelineObject: Ge, toggleAutoKey: Wa, toggleObject: Va, updateCameraFromHud: Ha, updateEditState: Ga, updateKeyVisualState: Ya, updateSelectedKey: Xa, updateSelectedObject: Ja, clamp: _t, cloneCamera: Za, configureCore: Qa, defaultCamera: eo, sampleCamera: Ct, sampleObjectTransform: Lo, sanitizeState: et, worldTransform: Re } = e;
  return {
    setSelectMode(O) {
    ...
    restoreHistorySnapshot(O) {
      ...
      const k = Cn(this.state), w = new Set(this.state.objects.map((se) => se.id));
      this.state = et(A.state);
      const C = new Set(this.state.objects.map((se) => se.id));
      for (const se of w) C.has(se) || this.removeObjectResources(se);
      this.frame = _t(A.frame, 0, this.state.duration_frames - 1);
      const T = new Set(this.state.objects.map((se) => se.id)), N = Array.isArray(A.selectedObjectIds) ? A.selectedObjectIds : [A.selectedObjectId].filter(Boolean);
      this.selectedObjectIds = new Set(N.filter((se) => T.has(se))), this.selectedObjectId = this.selectedObjectIds.has(A.selectedObjectId) ? A.selectedObjectId : [...this.selectedObjectIds].at(-1) || null, this.selectedEntity = this.selectedObjectIds.size ? "object" : A.selectedEntity || "camera";
      const Z = new Set(this.timelineKeyframes().map((se) => se.frame)), B = Array.isArray(A.selectedKeyFrames) ? A.selectedKeyFrames : [A.selectedKeyFrame].filter((se) => se != null);
      this.selectedKeyFrames = new Set(B.filter((se) => Z.has(se))), this.selectedKeyFrame = this.selectedKeyFrames.has(A.selectedKeyFrame) ? A.selectedKeyFrame : [...this.selectedKeyFrames].at(-1) ?? null, this.subSelection = A.subSelection || null, this.camera = Ct(this.state, this.frame), It(this, this.activeCameraTrack(), this.camera, this.frame), this.cameraPreviewSignature = "", this.serialize(), k !== Cn(this.state) && this.restoreAssets(), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
    },
    checkpoint(O) {
    ...
    onContextMenu(O) {
      ...
      if (A.closest?.(".viewport-wrap")) {
        const T = this.interactionElement.getBoundingClientRect(), N = (O.clientX - T.left) * this.canvas.width / Math.max(1, T.width), Z = (O.clientY - T.top) * this.canvas.height / Math.max(1, T.height), B = this.pickSceneObject([N, Z]);
        if (B) {
    ...
    openPathKeyContext(O, A, k) {
      ...
      const T = C ? Ot(C) : "auto", N = this.selectedKeyFrames?.size || 0;
    ...
    openTimelineContext(O, A) {
      const k = this.selectedKeyFrames?.size || 0, w = this.selectedKeyframe(), C = w?.interpolation || "ease", T = w && Ot(w) || "auto", N = ["ease", "linear", "bezier", "smooth", "ease_in", "ease_out", "sine", "cubic", "quintic", "expo", "back"], Z = ["auto", "clamped", "vector", "free", "aligned", "flat"];
      this.showContextMenu(O, A ? `Keyframe F${this.selectedKeyFrame}` : `Timeline F${this.frame}`, [
        { label: s("Fit timeline view (F)"), icon: "pi-arrows-alt", shortcut: "F", run: () => Qe(this) },
    ...
    openCurveContext(O) {
      const A = this.selectedKeyFrames?.size || 0, k = A < 2 && !this.selectedKeyframe(), w = this.selectedKeyframe(), C = w?.interpolation || "ease", T = w && Ot(w) || "auto", N = ["bezier", "smooth", "linear", "ease_in", "ease_out", "ease", "sine", "cubic", "quintic", "expo", "back"], Z = ["auto", "clamped", "vector", "free", "aligned", "flat"];
      this.showContextMenu(O, s("Curve editor"), [
        { label: s("Fit all curves (Framing)"), icon: "pi-arrows-alt", shortcut: "F", run: () => gt(this) },
        { label: s("Set key at playhead"), icon: "pi-key", shortcut: "I", run: () => this.insertKeyframe() },
    ...
    resizeCanvas() {
      ...
      for (const N of this.cameraPreviewCanvases.values()) {
        const Z = N.clientWidth || 220, B = N.clientHeight || 124, se = Math.max(A, Bu / Math.max(1, Z)), je = Math.max(1, Math.round(Z * se)), Ie = Math.max(1, Math.round(B * se));
...
const En = { motion: "motion", shot: "display", health: "health" }, Vu = {
  object: "Object",
  camera: "Camera",
  camera_target: "Look-At Target",
  camera_path: "Camera Path"
}, Hu = { motion: "Motion", shot: "Shot", health: "Health" }, Gu = ["entity", "motion", "shot", "health"];
function Us(e) {
...
function Ws(e) {
  ...
  r && (r.textContent = o === "entity" ? s(Vu[e.selectedEntity] || "Inspector") : s(Hu[o] || "Inspector"));
}
function Zu(e, t) {
  e.inspectorMode = Gu.includes(t) ? t : "entity", Ws(e), e.render?.(), e.refitNode?.();
}
function Qu(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: h, playblastCameraTrack: d, restoreFromWidgets: f, serializeEditorState: u, syncActiveCameraTrack: b, syncFromWidgets: v, bindEditorEvents: g, activateCamera: y, addCamera: S, deleteCamera: x, drawPreviewOverlays: E, duplicateCamera: M, maximizeCameraPreview: K, refreshCameraPreviews: L, refreshCameraSelectors: Y, renameCamera: U, setPlayblastCamera: H, toggleCameraView: ne, captureRealtime: j, makePlayblast: F, uploadDirectorPlayblast: q, waitForMediaFrame: G, computeAudioPeaks: oe, loadAudioFile: $, releaseAudio: W, stopPlay: P, togglePlay: V, applyCameraPreset: J, applyCameraShake: de, applyProxyPreset: me, clearViewportBgImage: te, loadViewportBgFile: pe, loadViewportBgSequence: ye, drawCameraPath: ue, drawCard: xe, drawCube: z, drawGrid: R, drawHuman: ie, drawLine3D: le, drawNull: be, drawOverlays: fe, drawPointField: re, drawSpeedHeatmap: _e, drawSphere: Bt, curveChannels: qt, drawCurveEditor: pt, onCurvePointerDown: ft, onCurvePointerMove: ht, onCurvePointerUp: ut, onTimelinePointerDown: Ut, onTimelinePointerMove: Wt, onTimelinePointerUp: Vt, refreshKeys: bt, resetCurveZoom: gt, resetTimelineZoom: Qe, setChannelFilter: yt, setCurveInterpolation: vt, setTangentMode: xt, timelineFrameFromEvent: Ht, toggleCurveHandles: wt, zoomCurve: Gt, drawTransformGizmo: Yt, frameTarget: Xt, gizmoAxes: Jt, gizmoGeometry: Zt, onPointerDown: Qt, onPointerMove: ea, onPointerUp: ta, onWheel: aa, pickGizmo: oa, pickSceneObject: ra, resetCamera: kt, setTransformMode: St, setViewMode: na, viewportCamera: sa, loadCardFile: Oo, loadExecutionPreview: Po, loadMediaUrl: ia, loadModelFile: ca, loadSelectedReference: la, onModelLoaded: da, restoreAssets: ma, syncUpstreamInputs: pa, configureDomMedia: fa, refreshSetupDiagnostic: jt, addMediaCard: ha, addPrimitive: ua, applyObjectAnimationFrame: ba, beginCameraEdit: ga, beginObjectEdit: ya, commitCameraEdit: va, commitObjectEdit: xa, copyKeyframe: wa, deleteKeyframe: ka, deleteObject: Sa, deleteSelectedObjects: ja, duplicateObject: _a, exitKeyEdit: Ca, finishCameraEdit: Ea, goToAdjacentKey: Aa, insertKeyframe: $a, loadSelectedKeyView: Ma, pasteKeyframe: Ta, playblastCameraAtFrame: Ia, refreshInspector: Oa, refreshKeyEditor: Pa, refreshObjects: La, removeObjectResources: Fa, renameObject: za, retimeSelectedKey: Na, selectKeyframe: Ra, selectedKeyframe: Ka, selectedObject: Da, selectObjectAnimation: Ba, setKeyInterpolation: qa, setKeyTangentMode: Ua, setObjectParent: Ge, timelineKeyframes: Wa, timelineObject: Va, toggleAutoKey: Ha, toggleObject: Ga, updateCameraFromHud: Ya, updateCameraRotationFromHud: Xa, updateEditState: Ja, updateKeyVisualState: _t, updateSelectedKey: Za, updateSelectedObject: Qa, clamp: eo, cloneCamera: Ct, configureCore: Lo, defaultCamera: et, sampleCamera: Re, sampleObjectTransform: O, sanitizeState: A, worldTransform: k } = e;
  return {
    setChannelFilter(w) {
      yt(this, w);
    },
    setFrame(w, C = !1, T = !0) {
      this.frame = eo(Math.round(w), 0, this.state.duration_frames - 1), this.editingKeyFrame !== this.frame && (this.editingKeyFrame = null), this.camera = Re(this.activeCameraTrack(), this.frame, this.state.objects), It(this, this.activeCameraTrack(), this.camera, this.frame), this.applyObjectAnimationFrame();
      ...
      const B = Math.floor(Z / 60), se = Math.floor(Z % 60), je = Math.floor(Z % 1 * 1e3), Ie = this.frame % Math.max(1, Math.round(this.state.fps)), Ye = Math.floor(this.frame / this.state.fps);
      if ((N.time || this.root.querySelector('[data-role="time"]')).textContent = this.state.timecode_mode === "timecode" ? `${String(Math.floor(Ye / 3600)).padStart(2, "0")}:${String(Math.floor(Ye / 60) % 60).padStart(2, "0")}:${String(Ye % 60).padStart(2, "0")}:${String(Ie).padStart(2, "0")}` : `${String(B).padStart(2, "0")}:${String(se).padStart(2, "0")}.${String(je).padStart(3, "0")}`, T) this.refreshKeys();
      else {
        xo(this);
    ...
    setSpatialHandleMode(w) {
      ...
      this.checkpoint(s("Camera path handle: {mode}").replace("{mode}", w)), Ku(T[N], w, {
        prevKey: T[N - 1] || null,
        nextKey: T[N + 1] || null
    ...
    transformCameraPath(w) {
      ...
      return C.keyframes = T, C.id === this.state.active_camera_id && (this.state.keyframes = T), this.camera = Re(C, this.frame, this.state.objects), C.camera = Ct(this.camera), this.serialize(), this.refreshKeys(), this.refreshInspector(), this.render(), this.renderCameraView?.(), !0;
    },
    toggleCurveHandles() {
      wt(this);
    },
    ...
    playblastCameraAtFrame() {
      return It(this, d(this), Ia(this, Re), this.frame);
    },
    viewportCamera() {
      return sa(this);
    },
    ...
    refreshInspector() {
      this.perf && (this.perf.inspectorRefreshCount = (this.perf.inspectorRefreshCount || 0) + 1), Oa(this), Ju(this);
    },
    setInspectorMode(w) {
      Zu(this, w);
    },
    ...
    bakeAimToKeyframes() {
      ...
      for (const Z of w.keyframes) {
        const B = (T.type === "model" || T.type === "glb") && N && !T.keyframes?.length ? N : T.keyframes?.length ? O(T, Z.frame).position : T.position || [0, 1.5, 0];
        Z.camera.target = [...B];
      }
...
function eb(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: h, playblastCameraTrack: d, restoreFromWidgets: f, serializeEditorState: u, syncActiveCameraTrack: b, syncFromWidgets: v, bindEditorEvents: g, activateCamera: y, addCamera: S, deleteCamera: x, drawPreviewOverlays: E, duplicateCamera: M, maximizeCameraPreview: K, refreshCameraPreviews: L, refreshCameraSelectors: Y, renameCamera: U, setPlayblastCamera: H, toggleCameraView: ne, captureRealtime: j, makePlayblast: F, uploadDirectorPlayblast: q, waitForMediaFrame: G, computeAudioPeaks: oe, loadAudioFile: $, releaseAudio: W, stopPlay: P, togglePlay: V, applyCameraPreset: J, applyCameraShake: de, applyProxyPreset: me, clearViewportBgImage: te, loadViewportBgFile: pe, loadViewportBgSequence: ye, drawCameraPath: ue, drawCard: xe, drawCube: z, drawGrid: R, drawHuman: ie, drawLine3D: le, drawNull: be, drawOverlays: fe, drawPointField: re, drawSpeedHeatmap: _e, drawSphere: Bt, curveChannels: qt, drawCurveEditor: pt, fitCurveView: ft, onCurveDoubleClick: ht, onCurvePointerDown: ut, onCurvePointerMove: Ut, onCurvePointerUp: Wt, onTimelinePointerDown: Vt, onTimelinePointerMove: bt, onTimelinePointerUp: gt, refreshKeys: Qe, resetCurveZoom: yt, resetTimelineZoom: vt, setChannelFilter: xt, setCurveInterpolation: Ht, setTangentMode: wt, timelineFrameFromEvent: Gt, toggleCurveHandles: Yt, zoomCurve: Xt, drawTransformGizmo: Jt, frameTarget: Zt, gizmoAxes: Qt, gizmoGeometry: ea, onPointerDown: ta, onPointerMove: aa, onPointerUp: oa, onWheel: ra, pickGizmo: kt, pickSceneObject: St, resetCamera: na, setTransformMode: sa, setViewMode: Oo, viewportCamera: Po, loadCardFile: ia, loadExecutionPreview: ca, loadMediaUrl: la, loadModelFile: da, loadSelectedReference: ma, onModelLoaded: pa, restoreAssets: fa, syncUpstreamInputs: jt, configureDomMedia: ha, refreshSetupDiagnostic: ua, addMediaCard: ba, addPrimitive: ga, applyObjectAnimationFrame: ya, beginCameraEdit: va, beginObjectEdit: xa, commitCameraEdit: wa, commitObjectEdit: ka, copyKeyframe: Sa, deleteKeyframe: ja, deleteObject: _a, duplicateObject: Ca, exitKeyEdit: Ea, finishCameraEdit: Aa, goToAdjacentKey: $a, insertKeyframe: Ma, loadSelectedKeyView: Ta, pasteKeyframe: Ia, playblastCameraAtFrame: Oa, refreshInspector: Pa, refreshKeyEditor: La, refreshObjects: Fa, removeObjectResources: za, renameObject: Na, retimeSelectedKey: Ra, selectKeyframe: Ka, selectedKeyframe: Da, selectedObject: Ba, selectObjectAnimation: qa, setKeyInterpolation: Ua, setObjectParent: Ge, timelineKeyframes: Wa, timelineObject: Va, toggleAutoKey: Ha, toggleObject: Ga, updateCameraFromHud: Ya, updateEditState: Xa, updateKeyVisualState: Ja, updateSelectedKey: _t, updateSelectedObject: Za, clamp: Qa, cloneCamera: eo, configureCore: Ct, defaultCamera: Lo, sampleCamera: et, sampleObjectTransform: Re, sanitizeState: O, worldTransform: A } = e;
  return {
    setTargetAtCursor(k) {
      if (!k) return;
...
const nb = "http://www.w3.org/2000/svg", rt = 26, An = 17, sb = 5.4;
function nt(e, t) {
...
function ib(e) {
  ...
  for (const n of ob(ab(a))) {
    const i = rt + n.x * An, c = rt + n.y * An, l = rb(n.depth);
    t.appendChild(nt("line", {
      x1: rt,
      y1: rt,
      x2: i,
      y2: c,
...
function lb(e) {
  ...
  for (const r of e.state.motion_layers || []) {
    ...
    const n = cb(e.state, r, e.frame, a, o);
    if (n.length) {
...
const db = ["world_point", "object_point", "camera_field"], Vs = {
  manual_2d: "DRAW",
  object_point: "OBJECT",
  world_point: "WORLD",
...
function ub(e) {
  ...
  n("motion-sel-name", a.label), n("motion-sel-type", Vs[a.source_kind] || "TRACK"), n("motion-sel-binding", mb(e.state, a)), n("motion-sel-start", r.length ? Math.min(...r) : 0), n("motion-sel-end", r.length ? Math.max(...r) : 0);
...
function yb(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: h, playblastCameraTrack: d, restoreFromWidgets: f, serializeEditorState: u, syncActiveCameraTrack: b, syncFromWidgets: v, bindEditorEvents: g, activateCamera: y, addCamera: S, deleteCamera: x, drawPreviewOverlays: E, duplicateCamera: M, maximizeCameraPreview: K, refreshCameraPreviews: L, refreshCameraSelectors: Y, renameCamera: U, setPlayblastCamera: H, toggleCameraView: ne, captureRealtime: j, makePlayblast: F, uploadDirectorPlayblast: q, waitForMediaFrame: G, computeAudioPeaks: oe, loadAudioFile: $, releaseAudio: W, stopPlay: P, togglePlay: V, applyCameraPreset: J, applyCameraShake: de, applyProxyPreset: me, clearViewportBgImage: te, loadViewportBgFile: pe, loadViewportBgSequence: ye, drawCameraPath: ue, drawCard: xe, drawCube: z, drawCylinder: R, drawGrid: ie, drawHuman: le, drawLine3D: be, drawNull: fe, drawOverlays: re, drawPointField: _e, drawSpeedHeatmap: Bt, drawSphere: qt, drawTorus: pt, curveChannels: ft, drawCurveEditor: ht, onCurvePointerDown: ut, onCurvePointerMove: Ut, onCurvePointerUp: Wt, onTimelinePointerDown: Vt, onTimelinePointerMove: bt, onTimelinePointerUp: gt, refreshKeys: Qe, resetCurveZoom: yt, resetTimelineZoom: vt, setChannelFilter: xt, setCurveInterpolation: Ht, setTangentMode: wt, timelineFrameFromEvent: Gt, toggleCurveHandles: Yt, zoomCurve: Xt, drawTransformGizmo: Jt, frameTarget: Zt, gizmoAxes: Qt, gizmoGeometry: ea, onPointerDown: ta, onPointerMove: aa, onPointerUp: oa, onWheel: ra, pickGizmo: kt, pickSceneObject: St, resetCamera: na, setTransformMode: sa, setViewMode: Oo, viewportCamera: Po, loadCardFile: ia, loadExecutionPreview: ca, loadMediaUrl: la, loadModelFile: da, loadSelectedReference: ma, onModelLoaded: pa, restoreAssets: fa, syncUpstreamInputs: jt, configureDomMedia: ha, refreshSetupDiagnostic: ua, addMediaCard: ba, addPrimitive: ga, applyObjectAnimationFrame: ya, beginCameraEdit: va, beginObjectEdit: xa, commitCameraEdit: wa, commitObjectEdit: ka, copyKeyframe: Sa, deleteKeyframe: ja, deleteObject: _a, duplicateObject: Ca, exitKeyEdit: Ea, finishCameraEdit: Aa, goToAdjacentKey: $a, insertKeyframe: Ma, loadSelectedKeyView: Ta, pasteKeyframe: Ia, playblastCameraAtFrame: Oa, refreshInspector: Pa, refreshKeyEditor: La, refreshObjects: Fa, removeObjectResources: za, renameObject: Na, retimeSelectedKey: Ra, selectKeyframe: Ka, selectedKeyframe: Da, selectedObject: Ba, selectObjectAnimation: qa, setKeyInterpolation: Ua, setObjectParent: Ge, timelineKeyframes: Wa, timelineObject: Va, toggleAutoKey: Ha, toggleObject: Ga, updateCameraFromHud: Ya, updateEditState: Xa, updateKeyVisualState: Ja, updateSelectedKey: _t, updateSelectedObject: Za, clamp: Qa, cloneCamera: eo, configureCore: Ct, defaultCamera: Lo, sampleCamera: et, sampleObjectTransform: Re, sanitizeState: O, worldTransform: A } = e;
  return {
    ...
    renderViewportOnly() {
      ...
      if (this.webgl)
        try {
          const ae = this.recording ? 1 : this.webgl.supersampleFactor?.() ?? 1, Ke = ae > 1 ? Math.min(ae, 4096 / Math.max(1, w, C)) : 1, to = Ke > 1 ? Math.round(w * Ke) : w, Fo = Ke > 1 ? Math.round(C * Ke) : C;
          this.webgl.render(Ye, N, this.cardMediaById, to, Fo, this.modelUrlsById, this.frame, this.recording, this.selectedEntity, this.selectedObjectId, this.subSelection, this.selectedKeyFrame ?? null), k.imageSmoothingEnabled = !0, k.imageSmoothingQuality = "high", to !== w || Fo !== C ? k.drawImage(this.webgl.canvas, 0, 0, to, Fo, 0, 0, w, C) : k.drawImage(this.webgl.canvas, 0, 0, w, C), Q = !0;
        } catch (ae) {
      ...
      !this.recording && this.state.speed_heatmap && this.drawSpeedHeatmap(), !this.recording && If(this), this.drawOverlays(), lb(this), this.state.show_gizmo && ib(this), this.labelOverlay?.update(), this.rigOverlay?.update(), this.perf && (this.perf.viewportRenderCount = (this.perf.viewportRenderCount || 0) + 1);
    },
    ...
    requestUiUpdate(k = _.viewport, w = "unknown") {
      (this.renderReasons ||= /* @__PURE__ */ new Set()).add(w), this.uiDirtyMask = gm(this.uiDirtyMask, k), this.renderInvalidations = (this.renderInvalidations || 0) + 1, !this.renderScheduled && (this.renderScheduled = !0, this.renderFrame = requestAnimationFrame(() => {
        if (this.renderScheduled = !1, this.disposed) return;
        const C = this.uiDirtyMask || _.viewport;
        this.uiDirtyMask = 0, this.lastRenderReasons = [...this.renderReasons || []], this.renderReasons?.clear(), this.rendersCoalesced = (this.rendersCoalesced || 0) + 1, this.perf && (this.perf.renderCount = (this.perf.renderCount || 0) + 1), at(C, _.outliner) && this.refreshObjects(), at(C, _.timeline) && this.refreshKeys(), at(C, _.inspector) && this.refreshInspector(), at(C, _.viewport) && this.renderViewportOnly(), at(C, _.previews) && this.renderCameraView(), at(C, _.motion) && this.renderMotionUiOnly();
      }));
    },
    renderCameraView() {
      if (this.perf && (this.perf.previewRenderCount = (this.perf.previewRenderCount || 0) + 1), this.state.camera_view_visible) {
        ...
        let T = null;
        if (C) {
          const N = this.state.active_camera_id, Z = w.filter((B) => B.id !== N);
          T = Z.length ? Z[this.cameraPreviewTick % Z.length] : null;
        }
        for (const N of w) {
          const Z = this.cameraPreviewCanvases.get(N.id), B = this.cameraPreviewContexts.get(N.id);
          if (!Z?.width || !B) continue;
          const se = Z.width, je = Z.height, Ie = this.root.querySelector(`[data-camera-frame="${N.id}"]`);
          if (Ie && (Ie.textContent = `F${this.frame}`), C && N.id !== this.state.active_camera_id && N !== T) continue;
          const Ye = It(this, N, et(N, this.frame, this.state.objects), this.frame);
          if (B.fillStyle = "#111", B.fillRect(0, 0, se, je), this.cameraWebgl)
            try {
              this.cameraWebgl.render({ ...this.state, keyframes: [], playblast_grid: !1, viewport_bg_image: this.viewportBgImage?.src || "", viewport_bg_sequence: (this.viewportBgSequenceImages || []).map((Q) => Q.src), __omnicamRevision: this.renderRevision || 0 }, Ye, this.cardMediaById, se, je, this.modelUrlsById, this.frame, !0), B.drawImage(this.cameraWebgl.canvas, 0, 0, se, je);
            } catch (Q) {
    ...
    dispose() {
      this.disposed || (this.disposed = !0, this.agentBridge?.dispose?.(), uc(this), bc(), Xc(this), this.backgroundRequestId = (this.backgroundRequestId || 0) + 1, this.upstreamSyncId = (this.upstreamSyncId || 0) + 1, this.stopPlay(), clearTimeout(this.previewClickTimer), clearTimeout(this.connectionTimer), cancelAnimationFrame(this.restoreFrame), cancelAnimationFrame(this.serializeFrame), cancelAnimationFrame(this.resizeFrame), cancelAnimationFrame(this.renderFrame), this.abortController?.abort(), this.upstreamFetchController?.abort(), this.resizeObserver?.disconnect(), this.contextMenu?.dispose(), this.webgl?.dispose(), this.cameraWebgl?.dispose(), W(this), nh(this), this.objectUrls.clear(), this.cardMediaById.clear(), this.cardMediaAssetById?.clear?.(), this.modelUrlsById.clear(), this.modelInfoById.clear());
    }
  };
}
const Hs = 1e-9;
...
function Lr(e, t) {
  const a = e.map((i) => vb(i, t)), o = xb(a), r = e.map((i) => i.frame), n = Math.max(1, r[r.length - 1] - r[0]);
  return a.map((i, c) => [
    (r[c] - r[0]) / n,
...
function Sb(e, t, { target: a = 2, keepFrames: o = [] } = {}) {
...
function jb(e, t, { mergeWithin: a = 1, epsilon: o = 1e-3, keepFrames: r = [] } = {}) {
...
function Cb(e, t, a, { lastFrame: o = 1 / 0 } = {}) {
...
function Mb() {
  return {
    ...
    deleteSelectedKeyframes() {
      ...
      const t = this._activeTrack(), a = Se(this), o = t.kind === "camera" ? 1 : 0, { keys: r, removed: n } = _b(a, e, { minKeys: o });
    ...
    nudgeSelectedKeyframes(e) {
      ...
      const a = this._activeTrack(), o = Math.max(0, this.state.duration_frames - 1), r = Cb(Se(this), t, e, { lastFrame: o });
    ...
    setSelectedKeysInterpolation(e) {
      ...
      this.checkpoint(s("Interpolation on {n} keys").replace("{n}", t.length)), a.write(Eb(Se(this), t, e)), this.serialize(), this.refreshKeys(), this.refreshKeyEditor(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} interpolation on {n} keys").replace("{mode}", e.replace(/_/g, " ")).replace("{n}", t.length));
    },
    setSelectedKeysTangentMode(e) {
      const t = this.resolveSelectedFrames();
      if (t.length < 2) return this.setTangentMode(e);
      const a = this._activeTrack(), o = Ze(this).map((r) => r.id);
      this.checkpoint(s("Tangents on {n} keys").replace("{n}", t.length)), a.write(Ab(Se(this), t, e, o)), this.serialize(), this.refreshKeys(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} tangents on {n} keys").replace("{mode}", e).replace("{n}", t.length));
    },
    /**
    ...
    simplifyActiveKeys({ mode: e = "simplify", tolerance: t = 0, target: a = 0, scope: o = "camera", fromKeys: r = null, silent: n = !1 } = {}) {
      ...
      const l = this.resolveSelectedFrames(), p = o !== "all_cameras" && l.length >= 2 ? [l[0], l.at(-1)] : null, m = p ? [] : l, h = (u) => {
        const b = [...u].sort((K, L) => K.frame - L.frame), v = p ? p[0] : -1 / 0, g = p ? p[1] : 1 / 0, y = b.filter((K) => K.frame < v), S = b.filter((K) => K.frame >= v && K.frame <= g), x = b.filter((K) => K.frame > g);
        let E = S, M = 0;
        if (S.length > 2) {
          const K = e === "reduce" ? Sb(S, i, { target: a || Math.ceil(S.length / 2), keepFrames: m }) : e === "clean" ? jb(S, i, { keepFrames: m }) : kb(S, i, { tolerance: t * $b, keepFrames: m });
          E = K.keys, M = K.removed;
        }
        return { keys: [...y, ...E, ...x].sort((K, L) => K.frame - L.frame), removed: M };
      };
      let d = 0;
      const f = c.map((u) => {
...
class Gs {
  constructor(t) {
    this.app = Mn, this.api = Ve, this.node = t, this.root = cs(), this.root.tabIndex = -1, this.dom = fs(this.root), this.canvas = this.root.querySelector(".viewport-wrap > canvas"), this.cameraPreviewCanvases = /* @__PURE__ */ new Map(), this.cameraPreviewContexts = /* @__PURE__ */ new Map(), this.cameraPreviewSignature = "", this.interactionElement = this.canvas, this.interactionElement.tabIndex = 0, this.interactionElement.dataset.captureWheel = "true", this.ctx = this.canvas.getContext("2d", { alpha: !1 }), this.disposed = !1, this.renderRevision = 0, this.directorRevision = 0, this.webgl = null, this.cameraWebgl = null, this.webglReady = this.loadWebGLViewports(), this.stateWidget = t.widgets?.find((o) => o.name === "state_json"), this.recordingWidget = t.widgets?.find((o) => o.name === "recording_path"), this.cardWidget = t.widgets?.find((o) => o.name === "card_asset"), this.widthWidget = t.widgets?.find((o) => o.name === "width"), this.heightWidget = t.widgets?.find((o) => o.name === "height"), this.fpsWidget = t.widgets?.find((o) => o.name === "fps"), this.durationWidget = t.widgets?.find((o) => o.name === "duration_seconds"), this.modeWidget = t.widgets?.find((o) => o.name === "render_mode");
    let a = null;
    try {
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-DchJB13x.js"));
    } catch (a) {
...
const fo = { app: Mn, api: Ve, EditorHistory: ss, ContextMenuController: Vn, initializeTooltips: Zc, promptText: zt, ObjectUrlRegistry: is, buildRoot: cs, dispatchDirectorKey: yc, activeCameraTrack: Jo, bindWidgetCallbacks: Qc, playblastCameraTrack: Wn, restoreFromWidgets: el, serializeEditorState: tl, syncActiveCameraTrack: Zo, syncFromWidgets: al, bindEditorEvents: Vf, activateCamera: ol, addCamera: rl, deleteCamera: nl, drawPreviewOverlays: sl, duplicateCamera: il, maximizeCameraPreview: cl, refreshCameraPreviews: ll, refreshCameraSelectors: dl, renameCamera: ml, setPlayblastCamera: pl, toggleCameraView: fl, captureRealtime: Ms, makePlayblast: xh, uploadDirectorPlayblast: Ts, waitForMediaFrame: $s, computeAudioPeaks: js, loadAudioFile: ah, releaseAudio: _o, stopPlay: yo, togglePlay: Qf, applyCameraPreset: hp, applyCameraShake: up, applyProxyPreset: bp, clearViewportBgImage: jh, loadViewportBgFile: kh, loadViewportBgSequence: Sh, drawCameraPath: Nh, drawCard: zh, drawCube: Th, drawCylinder: Ph, drawGrid: Eh, drawHuman: Oh, drawLine3D: ce, drawNull: Fh, drawOverlays: Kh, drawPointField: Mh, drawSpeedHeatmap: Rh, drawSphere: Ih, drawTorus: Lh, curveChannels: Ze, drawCurveEditor: Yl, fitCurveView: es, onCurveDoubleClick: Hl, onCurvePointerDown: Nl, onCurvePointerMove: Rl, onCurvePointerUp: Kl, onTimelinePointerDown: vc, onTimelinePointerMove: xc, onTimelinePointerUp: wc, refreshKeys: dd, resetCurveZoom: Gl, resetTimelineZoom: kc, setChannelFilter: Bl, setCurveInterpolation: Dl, setTangentMode: ql, timelineFrameFromEvent: dr, toggleCurveHandles: Ul, zoomCurve: Vl, drawTransformGizmo: Sc, frameTarget: jc, gizmoAxes: _c, gizmoGeometry: Cc, onPointerDown: Ec, onPointerMove: Ac, onPointerUp: $c, onWheel: Mc, pickGizmo: Tc, pickSceneObject: Ic, resetCamera: Oc, setTransformMode: Pc, setViewMode: Lc, viewportCamera: Fc, loadCardFile: dh, loadExecutionPreview: mh, loadMediaUrl: As, loadModelFile: lh, loadSelectedReference: ph, onModelLoaded: ch, restoreAssets: ih, syncUpstreamInputs: fh, configureDomMedia: _s, refreshSetupDiagnostic: qh, addMediaCard: eu, addPrimitive: Xh, applyObjectAnimationFrame: bu, beginCameraEdit: Su, beginObjectEdit: Ns, commitCameraEdit: ju, commitObjectEdit: ou, copyKeyframe: xu, deleteKeyframe: vu, deleteObject: zs, deleteSelectedObjects: Qh, duplicateObject: Fs, exitKeyEdit: Cu, finishCameraEdit: _u, goToAdjacentKey: Fu, insertKeyframe: gu, loadSelectedKeyView: Lu, pasteKeyframe: wu, playblastCameraAtFrame: uu, refreshInspector: tu, refreshKeyEditor: Iu, refreshObjects: Ls, removeObjectResources: lu, renameObject: Jh, retimeSelectedKey: Ou, selectKeyframe: ku, selectedKeyframe: Ne, selectedObject: Dt, selectObjectAnimation: cu, setKeyInterpolation: yu, setKeyTangentMode: Tu, setObjectParent: iu, timelineKeyframes: Se, timelineObject: Me, toggleAutoKey: Eu, toggleObject: Zh, updateCameraFromHud: su, updateCameraRotationFromHud: nu, updateEditState: $u, updateKeyVisualState: Mu, updateSelectedKey: Pu, updateSelectedObject: au, clamp: X, cloneCamera: he, configureCore: Un, defaultCamera: fr, sampleCamera: Ce, sampleObjectTransform: $o, sanitizeState: ur, worldTransform: br };
Object.assign(
  Gs.prototype,
  qu(fo),
  Qu(fo),
...
function Tb(e) {
  ...
  const t = new Gs(e);
  ho("director:constructor:complete", e), Km(t);
  try {
    t.agentBridge = Um(t, e, Ve);
  } catch (m) {
  ...
  try {
    t.characterRuntime = ip(t), t.rigMapper = lp(t), t.poseEditor = pp(t), t.motionEditor = fp(t);
  } catch (m) {
