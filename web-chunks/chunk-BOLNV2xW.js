...
import { s as Ce, c as X, t as he, a as s, o as zn, b as hr, d as Ze, e as fe, f as Oo, r as ai, g as ur, h as Nn, i as oi, j as ri, k as ni, l as si, m as br, n as gr, I as xo, p as yr, q as ii, w as ci, u as jo, v as Fn, x as li, y as vr, z as Dr, A as Rn, B as Zo, C as Kn, D as Dn, E as Bn, F as qn, G as Qo, H as Do, J as Br, O as qr, R as Un, K as di, L as mi, M as pi, N as xr, P as fi, Q as hi, S as ui, T as bi, U as gi, V as wr, W as yi, X as vi, Y as xi, Z as wi, _ as ki, $ as Si, a0 as ji, a1 as _i, a2 as Ci, a3 as Ei, a4 as Ai, a5 as $i, a6 as Ti, a7 as Mi, a8 as Ii, a9 as Oi, aa as Pi, ab as Li, ac as zi, ad as Ni, ae as Fi, af as Ri, ag as Ki, ah as Di, ai as Bi, aj as qi, ak as Ui, al as Wi, am as Vi, an as Hi, ao as Gi, ap as Yi, aq as Xi, ar as Ji, as as Zi, at as Qi, au as ec, av as tc, aw as ac, ax as oc, ay as rc, az as nc, aA as sc, aB as Wn, aC as Vn, aD as ic, aE as Bo, aF as cc, aG as lc, aH as dc, aI as mc, aJ as pc, aK as Re, aL as fc, aM as Hn, aN as kr, aO as hc, aP as uc, aQ as bc, aR as Gn, aS as He, aT as We, aU as gc, aV as Ur, aW as Sr, aX as yc, aY as vc, aZ as xc, a_ as wc, a$ as kc, b0 as Sc, b1 as jc, b2 as Yn, b3 as _c, b4 as Cc, b5 as Ec, b6 as Ac, b7 as $c, b8 as Tc, b9 as Mc, ba as Ic, bb as Oc, bc as Pc, bd as Lc, be as zc, bf as Nc, bg as Fc, bh as Rc, bi as Kc, bj as Dc, bk as Bc, bl as qc } from "./chunk-CHo3q0Ea.js";
import { L as Uc, a as Wc, p as Vt, f as jr, b as Vc, S as Hc, c as Wr, d as Gc, e as Yc, r as Xc, g as Jc, n as Zc, C as Vr, h as Ht, o as Qc, i as el, s as tl, j as al, k as Xn, l as ol, m as er, q as tr, w as rl, t as Jn, u as nl, v as sl, x as il, y as cl, z as ll, A as dl, B as ml, D as pl, E as fl, F as hl, G as ul, H as bl, I as gl, J as yl, K as vl, M as xl } from "./chunk-D5BO6cFr.js";
import { S as wl, b as kl, p as Sl, m as jl, l as _l, u as Cl } from "./chunk-BOI_2OKd.js";
import { R as El } from "./vendor-three-AeKB2-k3.js";
function Pt(e, t = 0) {
  return Math.sin(e * 1.7 + t * 3.1) * 0.5 + Math.sin(e * 3.3 + t * 5.7) * 0.3 + Math.sin(e * 7.9 + t * 11.3) * 0.2;
}
function Al(e, { type: t = "handheld_subtle", intensity: a = 1, duration_frames: o = null, subdivide: r = !0 } = {}) {
  ...
  return [...b].sort((y, x) => y - x).map((y) => {
    const x = Ce(u, y), S = Pt(y * m, 1) * l, g = Pt(y * m, 2) * l, _ = Pt(y * m, 3) * l * 0.5, A = Pt(y * m, 4) * p, F = Pt(y * m, 5) * (p * 0.35), L = [...x.position], J = [...x.target];
    return L[0] += S, L[1] += g, L[2] += _, J[0] += S * 0.35, J[1] += g * 0.35, {
      ...
      camera: {
        ...
        target: J,
        roll: (x.roll || 0) + A,
        fov: X((x.fov || 35) + F, 10, 140)
      },
      interpolation: "smooth"
    };
  });
}
function $l(e, { duration_frames: t = 120, target: a = [0, 1.5, 0], radius: o = 6, height: r = 3.5 } = {}) {
...
const Zn = 1e-4;
function Tl(e, t) {
  return !Array.isArray(e) || !Array.isArray(t) ? e !== t : e.some((a, o) => Math.abs(Number(a) - Number(t[o])) > Zn);
}
function Hr(e, t) {
  return Math.abs(Number(e) - Number(t)) > Zn;
}
const Qn = [
  {
    id: "camera",
  ...
  },
  {
    ...
    label: "Look At",
    color: "#f0a742",
    changed: (e, t) => Tl(e?.target, t?.target),
    read: (e) => e?.target
  },
  {
    id: "focal_length",
...
function Il(e, t = null) {
  return Qn.filter((a) => !t || t.has(a.id)).map((a) => ({
    id: a.id,
    label: a.label,
    color: a.color,
    frames: Ml(e, a)
...
function _o(e) {
  ...
  for (const a of [".oc-playhead-head", '[data-role="dope-playhead"]', ".oc-gdope-playhead", ".oc-sequence-playhead"])
    for (const o of e.root.querySelectorAll(a)) Ol(o, t);
}
function Pl(e, t, a) {
...
function es(e) {
  ...
  a.delete("camera");
  const o = e.timelineKeyframes() || [], r = Il(o, a), n = zl(e, r);
  if (t.dataset.signature !== n) {
    t.dataset.signature = n, t.replaceChildren();
    const i = (c) => he(e, c);
    for (const c of r) {
      const l = document.createElement("div");
      l.className = "oc-dope-row", l.dataset.channel = c.id, l.style.setProperty("--channel-color", c.color), Pl(l, c.frames, i), Ll(e, l, c, o, i), t.appendChild(l);
    }
  }
...
const qo = [1, 2, 5, 10, 20, 25, 50, 100, 200, 250, 500, 1e3, 2e3, 5e3], ts = 46, Gr = 5, as = 640;
function os(e, t) {
  const a = t > 0 ? t : as, o = Math.max(2, Math.floor(a / ts)), r = Math.max(1e-6, e / o);
  return qo.find((n) => n >= r) ?? qo[qo.length - 1];
}
function Nl(e, t) {
  const a = Math.max(1, e.state.duration_frames - 1), o = X(Number(e.timelineZoom) || 1, 0.1, 50), r = Number(e.timelinePan) || 0, n = a / o, i = os(n, t), l = (i >= Gr ? i / Gr : 0) || i, p = [], m = Math.max(0, Math.floor(r / l) * l);
...
function Fl(e) {
  return e.clientWidth || e.parentElement?.clientWidth || as;
}
function rs(e) {
  const t = e.root.querySelector('[data-role="ruler"]');
  if (!t) return;
  t.replaceChildren();
  for (const o of Nl(e, Fl(t))) {
...
function Rl(e, t) {
  ...
  a.addEventListener("pointerup", i, { signal: t }), a.addEventListener("pointercancel", i, { signal: t }), a.addEventListener("wheel", (c) => zn(e, c), { passive: !1, signal: t });
}
...
function Ul(e, { left: t, right: a, top: o, width: r, graphHeight: n, minimum: i, maximum: c, yFor: l }) {
  const p = Dl(c - i, 4);
  e.strokeStyle = "#222228", e.lineWidth = 1, e.fillStyle = "#6e727a";
  for (let m = Math.ceil(i / p) * p; m <= c; m += p) {
    const f = l(m);
    f < o - 1 || f > o + n + 1 || (e.beginPath(), e.moveTo(t, f), e.lineTo(r - a, f), e.stroke(), e.fillText(Bl(m, p), 4, f + 3));
  }
}
function _r(e, t) {
...
function Vl(e, t) {
  const a = t.currentTarget, { x: o, y: r } = _r(a, t);
...
function ns(e, { selectedOnly: t = !1 } = {}) {
  ...
  if (h.length > 0) {
    ...
    let A = Math.min(...g), F = Math.max(...g);
    (!Number.isFinite(A) || !Number.isFinite(F)) && (A = -1, F = 1), Math.abs(F - A) < 1e-6 && (A -= 1, F += 1);
    const L = (F - A) * 0.1;
    A -= L, F += L;
    const J = F - A, V = (A + F) / 2;
...
function ad(e) {
  ...
  const i = e.timelineObject(), c = e.timelineKeyframes(), l = nt(e), p = 44, m = 14, f = 16, d = 22, h = Math.max(1, a - p - m), u = Math.max(1, o - f - d), b = Math.max(1, e.state.duration_frames - 1), v = X(Number(e.curveZoomX) || 1, 0.1, 50), y = Number(e.curvePanX) || 0, x = b / v, S = y, g = y + x, _ = [], A = Math.max(1, Math.ceil(x / Math.max(80, h))), F = (T) => i ? Oo(i, T) : Ce(e.state, T);
  for (let T = 0; T <= b; T += A) _.push({ frame: T, value: F(T) });
  ...
  if (n.fillStyle = "#111114", n.fillRect(0, 0, a, o), n.strokeStyle = "#222228", n.lineWidth = 1, n.font = "9px system-ui, -apple-system, sans-serif", n.fillStyle = "#6e727a", ql(n, {
    ...
    xFor: U,
    frame: e.frame
  }), Ul(n, { left: p, right: m, top: f, width: a, graphHeight: u, minimum: J, maximum: V, yFor: q }), J <= 0 && V >= 0) {
    const T = q(0);
  ...
  for (const T of l) {
    ...
    if (e.showCurveHandles)
      for (let P = 0; P < c.length; P++) {
        ...
        const de = i ? W.transform || i : W.camera || W, re = U(W.frame), me = q(T.get(de)), ue = c[P - 1], pe = c[P + 1], ye = Math.max(1, W.frame - (ue?.frame ?? W.frame - 1)), ge = Math.max(1, (pe?.frame ?? W.frame + 1) - W.frame), be = ai(
          W,
          T.id,
          ue,
          pe,
          (te) => T.get(i ? te.transform || i : te.camera || W)
        ), Ee = (V - J) / Math.max(1, u), N = h * ge / Math.max(1, x), D = h * ye / Math.max(1, x), ae = [];
        (ue || P > 0) && ae.push({ side: "in", x: re + be.in_x * D, y: me - be.in_y / Ee }), (pe || P < c.length - 1 || c.length === 1) && ae.push({ side: "out", x: re + be.out_x * N, y: me - be.out_y / Ee });
        for (const te of ae) {
          ...
          n.fill(), n.stroke(), e.curveHitPoints.push({
            ...
            object: i,
            handle: te.side,
            pixelPerSegment: te.side === "in" ? D : N,
            valuePerPixel: Ee,
            startHandles: { ...be }
          });
        }
...
function Yr(e, { filter: t, label: a, color: o, title: r }) {
...
function ss(e) {
  ...
  if (!t) return;
  const a = e.timelineObject(), o = a ? a.name || a.type : e.activeCameraTrack().name, r = od(e), n = `${o}\0${r.map((c) => `${c.id}:${c.color}`).join("|")}`;
  if (t.dataset.signature !== n) {
    t.dataset.signature = n, t.replaceChildren();
    const c = document.createElement("span");
    c.className = "oc-graph-legend-title", c.textContent = o, t.appendChild(c), t.appendChild(Yr(e, {
      filter: "all",
      label: s("All"),
      color: null,
...
function Xr(e, t, a) {
  ...
  for (const n of [...e].sort((i, c) => i.frame - c.frame)) {
    ...
    (r === null || !(Math.abs(c - r) <= rd)) && o.push(n.frame), r = c;
  }
  return o;
}
function Cr(e) {
...
const Jr = ["#4aa3ef", "#f2a93b", "#48c774", "#b565d8", "#ec4899"];
function is(e, t) {
  const a = e.state.cameras.findIndex((r) => r.id === t), o = a >= 0 ? e.state.cameras[a] : null;
  return { camera: o, color: o?.color || Jr[Math.max(0, a) % Jr.length] };
}
function bt(e) {
...
function sd(e, t) {
  ...
  if (a.appendChild(lo(
    ...
    () => {
      e.checkpoint("Split shot"), Nn(e.state, e.frame, null) ? bt(e) : e.setStatus(s("Move the playhead inside a shot first"));
    },
    { disabled: o }
  )), a.appendChild(lo(
    s("Clear edit"),
...
function cd(e, t, a, o, r) {
  t.preventDefault(), t.stopPropagation();
  const { camera: n } = is(e, a.camera_id);
  e.contextMenu?.show(t, n?.name || s("Shot"), [
    ...
    null,
    {
      ...
      run: () => {
        e.checkpoint("Split shot"), Nn(e.state, e.frame, null) && bt(e);
      }
    },
    {
      label: s("Remove shot"),
      ...
      disabled: r === 1,
      run: () => {
        e.checkpoint("Remove shot"), oi(e.state, o) && bt(e);
      }
    }
  ]);
}
function ld(e, t, a, o) {
  const { camera: r, color: n } = is(e, t.camera_id), i = document.createElement("div");
  ...
  if (c.className = "oc-sequence-name", c.textContent = r?.name || t.camera_id, i.appendChild(c), a > 0) {
    ...
    l.className = "oc-sequence-handle", l.title = s("Drag to trim the cut"), l.addEventListener("pointerdown", (p) => id(e, p, l, o, a)), i.appendChild(l);
  }
  return i.addEventListener("contextmenu", (l) => cd(e, l, t, a, o.__cutCount)), i.addEventListener("pointerdown", () => {
...
function ls(e, t) {
  ...
  if (n.className = "oc-sequence-lane", n.dataset.role = "sequence-lane", n.setAttribute("aria-label", s("Multi-camera edit")), o.length)
    for (const [c, l] of o.entries()) {
      ...
      he(e, l.end + 1) < -5 || p > 105 || n.appendChild(ld(e, l, c, r));
    }
  else {
    const c = document.createElement("span");
  ...
  r.appendChild(n), r.appendChild(dd(e));
  const i = document.createElement("span");
  i.className = "oc-sequence-playhead", i.style.left = `${he(e, e.frame)}%`, r.appendChild(i), t.appendChild(r);
}
const md = ['[data-act="curve-zoom-in"]', '[data-act="curve-zoom-out"]', '[data-act="curve-fit"]', '[data-act="curve-handles"]'], Zr = { curves: "Graph", dope: "Timeline", sequence: "Sequence" };
function Qr(e, t) {
  const a = t in Zr ? t : "curves";
  e.graphTab = a;
  ...
  a === "dope" ? Cr(e) : a === "sequence" ? (ls(e, n), n?.focus?.({ preventScroll: !0 })) : e.drawCurveEditor(), e.setStatus(s(Zr[a]));
}
function pd(e) {
  e.graphTab === "sequence" && ls(e, e.root.querySelector('[data-role="graph-sequence"]'));
}
function fd(e, t) {
  ...
  a && a.addEventListener("keydown", (o) => {
    if (o.key === "ArrowLeft" || o.key === "ArrowRight") {
      ...
      if (n >= 0 && r.length > 1) {
        ...
        r[i].focus(), Qr(e, r[i].dataset.graphTab);
      }
    }
  }, { signal: t });
  for (const o of e.root.querySelectorAll("[data-graph-tab]"))
    o.addEventListener("click", (r) => {
      r.preventDefault(), r.stopPropagation(), Qr(e, o.dataset.graphTab);
    }, { signal: t });
}
const hd = /* @__PURE__ */ new Set(["good", "warning", "bad", "unknown"]);
function ds(e, t) {
  ...
  for (const n of r.frames) {
    ...
    const c = hd.has(n?.state) ? n.state : "unknown", l = n?.score;
    let p = null;
    if (l != null) {
      const m = Number(l);
...
function bd(e) {
  ...
  if (!t || !a) return;
  const o = ds(e.state?.metadata, e.state?.duration_frames), r = o.some((c) => c.state !== "unknown");
  ...
  if (en.has(a)) return;
  en.add(a), a.addEventListener("pointerdown", (c) => {
...
function gd(e) {
  ...
  if (e.audioWaveformPeaks && e.audioWaveformPeaks.length) {
    ...
    const S = x.getContext("2d"), g = e.audioWaveformPeaks, _ = x.width, A = x.height, F = A / 2;
    S.fillStyle = "#f2d06b";
    for (let L = 0; L < g.length; L++) {
      const V = (L / (g.length - 1) * r - l) / Math.max(1e-6, c) * _;
      if (V >= -5 && V <= _ + 5) {
        const H = g[L] * (A * 0.85);
        S.fillRect(V, F - H / 2, Math.max(1, _ / g.length * n - 0.5), H);
      }
    }
    t.appendChild(x);
  }
  ...
  for (const x of o) {
    ...
    _.className = "key-label", _.textContent = String(x.frame), g.appendChild(_), g.addEventListener("pointerdown", (A) => {
      if (A.preventDefault(), A.stopPropagation(), g.focus({ preventScroll: !0 }), A.altKey) {
        ...
        const L = a ? { frame: x.frame, transform: Ze(x.transform), interpolation: x.interpolation } : { frame: x.frame, camera: fe(x.camera), interpolation: x.interpolation }, J = e.timelineKeyframes();
      ...
      const F = e.timelineKeyframes().filter((L) => e.selectedKeyFrames.has(L.frame));
      e.keyDrag = { key: x, box: t, historyCheckpointed: !1, moving: F.map((L) => ({ key: L, startFrame: L.frame })), startPointerFrame: x.frame, startClientX: A.clientX, startClientY: A.clientY }, e.setFrame(x.frame, !1, !1);
  ...
  y && (y.textContent = m.name), rs(e), es(e), ss(e), Cr(e), pd(e), e.refreshCameraSelectors(), e.refreshKeyEditor(), e.updateEditState(), e.drawCurveEditor(), e.perf && (e.perf.timelineRefreshCount = (e.perf.timelineRefreshCount || 0) + 1), bd(e);
}
class ms {
...
async function Er(e, { route: t, field: a = "file", file: o }) {
...
function Fd() {
  const e = Wc.map((t) => `<button data-lens="${t}">${t}mm</button>`).join("");
  return `
  ...
  return `
    <div class="oc-dope">
      <div class="oc-dope-body">
        <div class="oc-dope-labels">${Qn.map((t) => `
...
const Ge = 1, tn = 50, Ae = 120, ct = 160, rm = Object.freeze(["perspective", "orthographic"]), K = Object.freeze({
...
}), hs = Object.freeze(Object.values(K)), xe = Object.freeze({
  SCENE_GET: "scene.get",
...
}), nm = Object.freeze(Object.values(xe));
...
function lt(e, t) {
  ...
  if (!Number.isInteger(o) || o < 1 || o > an)
    throw new I(
      "BAD_QUERY",
      `limit must be between 1 and ${an}`
    );
  return {
    offset: a,
    limit: o,
  ...
  switch (t?.type) {
    ...
    case xe.HEALTH_GET:
      return we(e, {
        version: 1,
        type: t.type,
        frames: ds(a.metadata, a.duration_frames)
      });
    case xe.ASSET_LIST: {
...
function mm(e, t) {
  e.cameras ||= [];
  const a = new Set(e.cameras.map((i) => i.id)), o = Po(a, "camera", t.id), r = { ...gr(), ...t.camera || {} }, n = {
    id: o,
    name: t.name || o,
    color: "#4aa3ef",
    locked: !1,
...
function bm(e, t) {
  if (!us.has(t.objectType))
    throw new I("UNSUPPORTED_OBJECT_TYPE", `object.create does not support type: ${t.objectType}`);
  e.objects ||= [];
  const a = new Set(e.objects.map((i) => i.id)), o = Po(a, t.objectType, t.id), r = dm(t.objectType), n = {
    id: o,
    type: t.objectType,
    name: t.name || o,
    ...r,
...
function _m(e, t) {
  ...
  for (a.has(t) && a.delete(t), a.add(t); a.size > jm; )
    a.delete(a.values().next().value);
}
function Cm(e, t) {
  return !!e._directorApiTxIds?.has(t);
}
const ot = (e) => typeof e == "number" && Number.isFinite(e);
function _e(e, t, a) {
  if (!Array.isArray(e) || e.length !== 3 || !e.every(ot))
...
function Am(e, t) {
  ...
  if (e.camera_type !== void 0 && !rm.includes(e.camera_type))
...
function $m(e, t) {
  ...
  switch (a) {
    ...
    case K.OBJECT_CREATE:
      if (ee(e.objectType, "objectType", t), !us.has(e.objectType))
    ...
    case K.CHARACTER_SET_JOINT_ROTATION:
      if (ee(e.objectId, "objectId", t), ee(e.joint, "joint", t), !Array.isArray(e.rotation) || e.rotation.length !== 4 || !e.rotation.every(ot))
    ...
    case K.CHARACTER_SET_MOTION: {
      ...
      for (const r of ["start_frame", "end_frame", "speed", "offset_seconds"])
        if (o[r] !== void 0 && !ot(o[r]))
          throw new I("BAD_VALUE", `motion.${r} must be a finite number`, t);
      if (ot(o.start_frame) && ot(o.end_frame) && o.end_frame > 0 && o.end_frame <= o.start_frame)
    ...
    case K.KEYFRAME_UPSERT:
      ...
      if (e.camera !== void 0) {
        ...
        for (const o of ["fov", "roll", "zoom", "near", "far"])
          if (e.camera[o] !== void 0 && !ot(e.camera[o]))
...
function Tm(e, t) {
  ...
  if (t.operations.length > tn)
    throw new I(
      "TOO_MANY_OPERATIONS",
      `transaction has ${t.operations.length} operations (max ${tn})`
    );
  return t.operations.forEach((a, o) => $m(a, o)), {
    version: Ge,
    id: t.id,
...
const Im = "omnicam/library", Om = "majoor_omnicam/blockout_library", Pm = Object.freeze({
...
function bs(e) {
  return e.file ? `${e.source === "legacy" ? Om : Im}/${e.file} [input]` : "";
}
function on(e, t, a) {
  const o = e || "asset";
  let r = `${o}_${a}`, n = 2;
...
function Nm(e, t = {}) {
  ...
  const a = Lm(t.point, [0, 0, 0]), o = String(t.idSeed || Date.now().toString(36)), r = String(e.kind || "prop"), n = r === "character", i = Pm[e.id];
  if (r === "helper" && !e.file && i && i !== "null")
    return {
      id: on(i, t.existingIds, o),
      type: i,
      name: e.name || i,
      position: a,
      rotation: [0, 0, 0],
  ...
  const c = {
    id: on(r === "character" ? "character" : r, t.existingIds, o),
    type: "glb",
  ...
  return n && (c.character = zm(e)), c;
}
function Fm({ groundHit: e, orbitTarget: t } = {}) {
...
const Rm = {
  [K.ASSET_INSTANTIATE](e, t) {
    ...
    let o;
    try {
      o = Nm(t.asset, { point: t.point, idSeed: t.id, existingIds: a });
    } catch (r) {
  ...
  [K.CAMERA_TRANSFORM](e, t) {
    const a = mt(e, t.cameraId), o = rn(a);
  ...
  [K.OBJECT_SET_ENABLED](e, t) {
    return at(e, t.objectId).enabled = t.value, { dirtyMask: C.viewport | C.previews | C.outliner | C.inspector };
  },
  [K.OBJECT_SET_LOCKED](e, t) {
    return or(e, t.objectId).locked = t.value, { dirtyMask: C.outliner | C.inspector };
  },
  [K.OBJECT_SET_TAGS](e, t) {
    const a = at(e, t.objectId), o = li(t.tags), r = o.length !== t.tags.length ? "some tags were dropped or normalised" : void 0;
    return o.length ? a.tags = o : delete a.tags, { dirtyMask: C.outliner | C.inspector | C.viewport, warning: r };
  },
  [K.OBJECT_SET_ANNOTATION](e, t) {
    const a = at(e, t.objectId), o = t.annotation === null ? null : Fn(t.annotation);
    if (t.annotation && !o)
  ...
  [K.CHARACTER_SET_JOINT_ROTATION](e, t) {
    ...
    return a.character = {
      ...a.character || {},
      pose: ci(a.character?.pose, t.joint, t.rotation)
    }, { dirtyMask: C.viewport | C.previews | C.inspector };
  },
  [K.CHARACTER_SET_MOTION](e, t) {
    const a = mo(e, t.objectId), o = yr(t.motion);
  ...
  [K.KEYFRAME_SET_INTERPOLATION](e, t) {
    const a = mt(e, t.cameraId), o = po(a, t.frame);
...
function Km({ state: e, operation: t }) {
  const a = Rm[t.type];
...
function Bm(e, t) {
  ...
  return Um(e, t, r), Vm(e, t, r), Gm(e, t, r), Hm(e, t, r), Ym(e, t, r), Xm(e, t, r), { changes: a, truncated: o };
}
const qm = ["fov", "roll", "zoom", "near", "far", "camera_type"];
function Um(e, t, a) {
  const o = Ye(e?.cameras), r = Ye(t?.cameras);
...
const Wm = ["position", "target", "fov", "roll", "zoom", "near", "far", "camera_type"];
function Vm(e, t, a) {
  const o = Ye(e?.cameras), r = Ye(t?.cameras);
  for (const [n, i] of r) {
...
function Hm(e, t, a) {
  const o = Ye(e?.objects), r = Ye(t?.objects);
  for (const [n, i] of r) {
...
function ap(e, t) {
  ...
  for (let p = 0; p < a.operations.length; p += 1)
    try {
      const m = Km({ ui: e, state: r, operation: a.operations[p] });
  ...
  if (a.validateOnly) {
    const { changes: p, truncated: m } = Bm(e.state, r);
    return {
      ok: !0,
      version: Ge,
      revision: o,
  ...
  e.checkpoint?.(a.description), e.state = vr(r);
  const l = Zm(e);
  return _m(e, a.id), e.serialize?.(), Qm(e, l), tp(e, n, `director-api:${a.id}`), ep(e, a, c).catch((p) => {
...
function rp(e) {
  return e.directorApi = op(e), e.directorApi;
}
const nn = "omnicam-agent/1", sn = "majoor.omnicam.agent.request", np = 1, zt = Object.freeze({
...
}), sp = 1e4, ip = 5e3, gs = "asset.instantiate_by_id", ys = "asset.catalog_search", cn = Object.freeze([
  ...hs.filter((e) => e !== K.ASSET_INSTANTIATE),
  gs
]);
function sr(e) {
...
async function dp(e, t) {
  ...
  const o = (a.state?.items || []).filter((r) => !sr(r)).slice(0, 20).map((r) => ({
    id: r.id,
    name: r.name,
    kind: r.kind,
    tags: [...r.tags || []],
...
function mp(e, t, a) {
  ...
  async function v(S) {
    const g = S?.detail;
    if (o || !g || g.protocol !== nn || Number(g.schema_version) !== np || g.session_id !== r || String(g.node_id) !== String(t.id)) return;
    let _;
    try {
      if (g.kind === "query")
        _ = g.payload?.type === ys ? await dp(e, g.payload) : e.directorApi.query(g.payload);
      else if (g.kind === "transaction") {
        const A = g.payload, F = (A?.operations || []).find(
          (L) => !cn.includes(L?.type)
        );
        if (!Number.isInteger(A?.baseRevision) || A.baseRevision < 0)
          ...
          const L = await lp(e, A.operations);
          _ = L.ok ? e.directorApi.execute({ ...A, operations: L.operations }) : Ft(e, L.code, L.message);
        }
      } else
        _ = Ft(e, "UNKNOWN_AGENT_REQUEST", `Unsupported Agent request kind: ${g.kind}`);
    } catch (A) {
      _ = Ft(e, A?.code || "INTERNAL", A?.message || "OmniCam Agent request failed");
    }
    try {
      await Nt(a, zt.reply, {
        session_id: r,
  ...
  return a.addEventListener?.(sn, v), a.addEventListener?.("status", x), d(), {
    get sessionId() {
      return r;
    },
    dispose() {
      if (o) return;
      o = !0, clearInterval(c), clearTimeout(l), a.removeEventListener?.(sn, v), a.removeEventListener?.("status", x);
      const S = r, g = n;
...
function Ar({ fetchApi: e = pp } = {}) {
  const t = (a, o) => Promise.resolve(e(a, o)).then(fp);
  return {
    list(a = {}) {
      const { kind: o, tag: r, search: n, offset: i, limit: c } = a, l = { tag: r, search: n, offset: i, limit: c };
      return o && o !== "all" && (l.kind = o), t(`${Te}${ln(l)}`);
    },
    get(a) {
    ...
    importModel(a, o = {}) {
      const r = new FormData();
      return r.append("file", a, o.filename || a.name || "model.glb"), t(`${Te}/import${ln(o)}`, { method: "POST", body: r });
    },
...
const vs = Object.freeze(["all", "character", "prop", "environment", "vehicle"]);
function dn(e = {}) {
  const t = String(e.kind || "all").toLowerCase();
  return {
    kind: vs.includes(t) ? t : "all",
...
function up(e) {
  ...
  return {
    ...
    setFilter(i) {
      return a.filter = dn({ ...a.filter, ...i }), a.offset = 0, this.refresh();
    },
    refresh() {
      return n(async () => {
...
const yp = 256;
function mn(e = {}) {
  const { THREE: t, GLTFLoader: a, FBXLoader: o, size: r = yp } = e;
  if (!t || !a)
...
function Sp(e, t = {}) {
  return vs.map((a) => {
    const o = s(kp[a] || a), r = a === "all" ? "" : ` <span class="oc-asset-kind-n">${Number(t[a] || 0)}</span>`;
    return `<button type="button" class="oc-asset-kind${a === (e || "all") ? " active" : ""}" data-asset-kind="${a}">${ut(o)}${r}</button>`;
  }).join("");
}
function jp(e, { selected: t = !1, thumbUrl: a = "" } = {}) {
  const o = wp[e.kind] || "pi-box", r = e.kind === "character" && Rn(e.rig) === "rigged" ? `<span class="oc-asset-badge">${s("RIGGED")}</span>` : "", n = a ? `<img class="oc-asset-thumb" src="${ut(a)}" alt="" loading="lazy">` : `<span class="oc-asset-thumb oc-asset-thumb--glyph"><i class="pi ${o}"></i></span>`;
...
function _p(e, { selectedId: t = "", thumbUrls: a = {} } = {}) {
  return !e || !e.length ? `<p class="oc-asset-empty">${s("No assets match this filter.")}</p>` : e.map((o) => jp(o, {
    selected: o.id === t,
    thumbUrl: a[o.id] || ""
  })).join("");
}
...
function Cp(e, t = {}) {
  const a = e.root, o = t.fetchApi || ((N, D) => (e.api || e.app?.api).fetchApi(N, D)), r = t.apiClient || Ar({ fetchApi: o }), n = t.store || up(r), i = bp(), c = t.previewQueue || gp(), l = e.api || e.app?.api || null;
  let p = t.thumbnailRenderer || null, m = null;
  const f = /* @__PURE__ */ new Set();
  function d() {
    return p ? Promise.resolve(p) : (m || (m = vp().then((N) => p = mn(N)).catch(() => p = mn({}))), m);
  }
  function h(N) {
    return Dr(l, bs(N));
  }
  function u(N) {
    return N.thumbnail ? Dr(l, `omnicam/library/${N.thumbnail} [input]`) : "";
  }
  function b() {
    for (const N of n.state.items) {
      if (N.kind === "helper" || !N.file || i.get(N.id) || N.thumbnail || f.has(N.id)) continue;
      const D = h(N);
      D && c.enqueue(N.id, async () => {
        const te = await (await d()).render(D, N.format || "glb");
        if (!te) {
          f.add(N.id);
          return;
        }
        if (i.set(N.id, te), G(), !(N.source && N.source !== "user"))
          try {
            const ve = await r.uploadThumbnail(N.id, xp(te));
  ...
  const v = (N) => a.querySelector(`[data-role="${N}"]`), y = v("assets-panel"), x = v("asset-grid"), S = v("asset-kinds"), g = v("asset-search"), _ = v("asset-status"), A = v("asset-import-file"), F = v("scene-tab"), L = v("assets-tab"), J = v("agent-tab"), V = { assets: L, agent: J };
  let H = "", se = null, j = !0, z = !0, U = 0;
  function q(N, { sticky: D = !1 } = {}) {
    _ && (!D && U > Date.now() || (_.textContent = N || "", U = D ? Date.now() + 9e3 : 0));
  }
  function ne(N) {
    if (H = N, !!x)
      for (const D of x.querySelectorAll(".oc-asset-card"))
        D.classList.toggle("selected", D.dataset.assetId === N);
  }
  let T = !1;
  function G() {
    if (S && (S.innerHTML = Sp(n.state.filter.kind, n.state.kinds)), x) {
      const N = {};
      for (const D of n.state.items) {
        const ae = i.get(D.id) || u(D);
        ae && (N[D.id] = ae);
      }
      x.innerHTML = _p(n.state.items, { selectedId: H, thumbUrls: N });
    }
    if (!T) {
      T = !0;
      try {
  ...
  function P(N) {
    ...
    const D = Fm({
      ...
      operations: [{ type: "asset.instantiate", asset: N, point: D }]
    });
    if (!ae?.ok) {
    ...
    te && (e.selectedEntity = "object", e.selectedObjectId = te, e.selectedObjectIds = /* @__PURE__ */ new Set([te]), e.selectedKeyFrame = null), e.restoreAssets?.(), e.refreshObjects?.(), e.refreshInspector?.(), e.render?.(), e.setStatus?.(s("{name} added").replace("{name}", N.name));
  }
  async function W(N) {
    if (N) {
      q(s("Importing {name}...").replace("{name}", N.name));
      try {
        const D = await r.importModel(N, { kind: "prop", name: N.name.replace(/\.[^.]+$/, "") });
        D.asset && n.upsert(D.asset), q(s("Imported {name}").replace("{name}", D.asset?.name || N.name));
      } catch (D) {
  ...
  async function me(N) {
    ...
    U = 0, q(N ? s("Scanning {folder}...").replace("{folder}", D) : s("Installing characters from {folder}...").replace("{folder}", D));
    try {
      ...
      if (N) {
        const Ie = (ae.candidates || []).map((Qe) => Qe.name).join(", ");
        q(
  ...
  function ue(N) {
    ...
    for (const D of a.querySelectorAll("[data-asset-view]"))
      D.classList.toggle("active", D.dataset.assetView === N);
    N === "assets" && j && (j = !1, n.refresh()), N === "agent" && z && (z = !1, t.onAgentFirstOpen?.());
  }
  function pe(N) {
    const D = pn(N.target);
    if (D) {
...
function Ep(e, t = {}) {
  ...
  function l() {
    ...
    let b = 0;
    for (const v of u) {
      if (!Kn(v, { mode: n.mode, selectedIds: d })) continue;
      const y = Dn(v, n.content);
      if (!y) continue;
      const x = Bn(u, v, h) || {
        position: v.position,
        size: v.size
      }, S = e.webgl.projectWorldToScreen(qn(x, v.type));
...
function $p(e, t) {
  const a = (o) => [`<option value="">${s("— unmapped —")}</option>`].concat(
    e.map(
      (r) => `<option value="${fn(r)}"${r === o ? " selected" : ""}>${fn(r)}</option>`
    )
  ).join("");
  return Un.map((o) => {
...
function Tp(e, t = {}) {
  const a = e.root, o = t.apiClient || Ar({
  ...
  function b(y) {
    ...
    x === "auto" ? (l = Qo(m()), d()) : x === "validate" ? (d(), e.setStatus?.(Do(l) ? s("Rig is complete") : s("Rig still missing: {list}").replace("{list}", Br(l).join(", ")))) : x === "save" && v();
  }
  async function v() {
    const y = p();
    if (!y?.asset_id) {
    ...
    try {
      const x = await o.patch(y.asset_id, {
        rig: { profile: qr, bone_map: l }
      });
      y.character = {
        ...y.character || {},
        rig_profile: Do(l) ? qr : null
...
function Op(e, t = {}) {
  ...
  function y(j) {
    ...
    return mi({ preset: z, overrides: j?.pose }).joints;
  }
  function x() {
    const j = h();
  ...
  function S() {
    ...
    l && (l.textContent = j);
    const U = h(), q = y(U?.character)[j] || [0, 0, 0, 1], ne = pi(q);
    p.forEach((T, G) => {
  ...
  function A() {
    const j = b();
    if (!j) return;
    const z = p.map((ne) => Number(ne?.value) || 0), U = di(z), q = e.directorApi?.execute({
      version: 1,
  ...
  async function L() {
    ...
    const z = (await Vt(e, s("Save Pose"), s("Pose name"), ""))?.trim();
    if (!z || e.disposed) return;
    const U = z.toLowerCase().replace(Ip, "-").replace(/^-+|-+$/g, "").slice(0, 60) || "pose";
    try {
  ...
  n?.addEventListener("change", F), i?.addEventListener("click", J), r.querySelector('[data-pose-act="save"]')?.addEventListener("click", L);
  for (const j of p)
  ...
  return _(), {
    ...
    dispose() {
      H.dispose(), n?.removeEventListener("change", F), i?.removeEventListener("click", J);
      for (const j of p)
  ...
  function u() {
    ...
    if (o) {
      ...
      o.dataset.sig !== _ && (o.dataset.sig = _, o.replaceChildren(
        hn("", x.length ? s("No motion (static)") : s("No clips in this model")),
        ...x.map((A) => hn(A, A))
...
function Lp(e, t) {
  ...
  const a = e.activeCameraTrack(), o = $l(t, {
...
const un = ["#4aa3ef", "#f2a93b", "#48c774", "#b565d8", "#ec4899"], Ve = [4, 8, 12, 20, 35, 60, 100];
function vt(e) {
...
function Dp(e, t, a, o) {
  const r = Lo(e, a, o);
  if (!r) return;
  const { rx: n, ry: i, radarSize: c, cx: l, cy: p, innerRadius: m, range: f, scale: d, camPos: h, camTgt: u, cameras: b, activeTrack: v } = r, y = vt(e), x = e.state.active_camera_id || v?.id, S = (re, me) => ws(r, re, me);
  ...
  for (const re of e.state.objects || []) {
    ...
    const me = xr(e.state.objects, re).position || [0, 0, 0], [ue, pe] = S(me[0], me[2]);
  ...
  for (let re = 0; re < b.length; re++) {
    const me = b[re], ue = me.keyframes || [], pe = me.id === x, ye = me.color || un[re % un.length];
    ...
    for (let N = be; Number.isFinite(N) && N <= Ee; N++) {
      const D = Ce(me, N, e.state.objects)?.position;
    ...
    for (const N of ue) {
      const D = N.camera?.position;
      if (!D) continue;
      const [ae, te] = S(D[0], D[2]);
      if (ae < n + 4 || ae > n + c - 4 || te < i + 4 || te > i + c - 4) continue;
      const ve = N.frame === e.frame && pe;
  ...
  const [A, F] = S(h[0] || 0, h[2] || 0), [L, J] = S(u[0] || 0, u[2] || 0), V = 8, H = X(A, n + V, n + c - V), se = X(F, i + V, i + c - V), j = X(L, n + V, n + c - V), z = X(J, i + V, i + c - V), U = h[1] || 0, q = Rp(U), ne = Kp(U);
...
function Ss(e, t, a, o) {
  ...
  for (const v of e.state.objects || []) {
    ...
    const y = xr(e.state.objects, v).position || [0, 0, 0], [x, S] = m(y[0], y[2]);
...
function Wp(e, t, a, o) {
  ...
  if (n.drag) {
    const [b, v] = ir(r, a, o), y = e.viewportCamera();
  ...
  const m = ks(r, a, o), f = Ss(e, r, a, o), [d, h] = ir(r, a, o);
...
function Hp(e, t, a) {
  ...
  const o = () => {
    ...
    const h = hi(t('[data-role="object-tags"]')?.value || "");
  ...
  }, { signal: a }), Rl(e, a), fd(e, a), t('[data-role="curve-group"]')?.addEventListener("change", () => {
    e.setChannelFilter("all"), ss(e), e.drawCurveEditor(), Cr(e);
  ...
  e.root.addEventListener("pointerdown", (d) => {
    ...
    const h = e.interactionElement.getBoundingClientRect(), u = (d.clientX - h.left) * e.canvas.width / Math.max(1, h.width), b = (d.clientY - h.top) * e.canvas.height / Math.max(1, h.height);
    Vp(e, d, u, b) || e.onWheel(d);
  }, { passive: !1, signal: a }), e.root.addEventListener("wheel", Sl(e.root), { signal: a }), window.addEventListener("pointermove", (d) => {
  ...
  l && (l.addEventListener("pointerdown", (d) => e.onTimelinePointerDown(d), { signal: a }), l.addEventListener("pointermove", (d) => e.onTimelinePointerMove(d), { signal: a }), l.addEventListener("pointerup", (d) => e.onTimelinePointerUp(d), { signal: a }), l.addEventListener("pointercancel", (d) => e.onTimelinePointerUp(d), { signal: a }), l.addEventListener("wheel", (d) => zn(e, d), { passive: !1, signal: a }));
  const p = (d) => {
  ...
  e.root.addEventListener("focusin", p, { signal: a }), e.root.addEventListener("pointerdown", p, { capture: !0, signal: a }), e.root.addEventListener("focusout", (d) => {
    e.modalTransform && !e.root.contains(d.relatedTarget) && (fi(e), e.render());
  }, { signal: a });
...
function Jp(e) {
  const t = new Map(wr.map((o) => [o.id, o]));
  return ({
    nav: [
      Ji,
      Zi,
...
function Zp() {
  return `<span class="oc-pref-emoji" aria-hidden="true">${Gp}</span> ${s("OmniCam Preferences")}`;
}
function Qp(e) {
  ...
  a.className = "oc-modal-backdrop", a.setAttribute("role", "dialog"), a.setAttribute("aria-modal", "true"), a.setAttribute("aria-label", s("OmniCam Preferences")), a.innerHTML = `
    <div class="oc-modal-dialog oc-pref-dialog" tabindex="-1">
      <div class="oc-pref-header">
        <div class="oc-pref-title">${Zp()}</div>
...
const tf = ["position", "target"], af = ["fov", "zoom"], of = ["roll"], rf = ["position", "size"], nf = ["rotation"];
function cr(e) {
...
function yn(e, t, a, o) {
  const r = cr(Number(a || 0) - Number(e || 0)), n = Number(e || 0) + r * o;
  if (t == null) return n;
  const i = cr(Number(t || 0) - n);
  return n + i / 3;
}
function vn(e, t, a) {
  ...
  for (let r = 1; r < a.length - 1; r++) {
    ...
    if (i.camera) {
      for (const m of tf) {
        ...
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const u = gn(f, d, h, p);
          a[r].camera[m] = vn(d.map(Number), u, o);
        }
      }
      for (const m of af) {
        const f = n.camera?.[m], d = i.camera?.[m], h = c.camera?.[m];
    ...
    if (Array.isArray(i.position) && Array.isArray(n.position) && Array.isArray(c.position)) {
      for (const m of rf) {
        ...
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const u = gn(f, d, h, p);
          a[r][m] = vn(d.map(Number), u, o);
        }
      }
      for (const m of nf) {
        const f = n[m], d = i[m], h = c[m];
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const u = [0, 1, 2].map((b) => yn(f[b], d[b], h[b], p));
          a[r][m] = d.map((b, v) => xn(Number(b), u[v], o));
        }
      }
    }
  }
...
function hf(e, t) {
  ...
  const o = (r) => {
    ...
    const u = (v) => {
      ...
      let x = mf;
      v.shiftKey ? x = pf : (v.ctrlKey || v.metaKey) && (x = ff);
      const S = p * x * 20;
      let g = l + y * S;
...
function gf(e, t) {
  for (const o of e.root.querySelectorAll('[data-act="toggle-camera-lock"]'))
    o.addEventListener("click", (r) => {
      r.stopPropagation(), e.checkpoint?.("Toggle camera lock"), e.state.camera_lock = !e.state.camera_lock, e.serialize?.(), js(e), e.setStatus?.(e.state.camera_lock ? s("Camera View locked") : s("Camera View unlocked"));
    }, { signal: t });
...
function yf(e, t) {
  ...
  !a || !o || (r && r.addEventListener("change", () => {
    ...
    document.activeElement !== a && (a.value = jr(o.value));
  }, { signal: t }));
}
function vf(e, t) {
  ...
  }, n = (i) => (e.smoothingBaseline?.cameraId !== i.id && (e.smoothingBaseline = { cameraId: i.id, keys: df(i.keyframes) }), e.smoothingBaseline.keys);
  ...
  if (a.length) {
    ...
    for (const o of a)
      o.addEventListener("change", () => {
        e.dopeChannels = new Set(a.filter((r) => r.checked).map((r) => r.dataset.dopeChannel)), es(e);
      }, { signal: t });
  }
}
function Sf(e, t) {
...
const ho = () => import("./chunk-C5Sk8j19.js");
function _f(e, t) {
...
function Cf(e, t) {
  ...
  ic().then((r) => {
    ...
    c === "health-slow" ? lc(e) : c === "health-smooth" ? dc(e) : c === "health-recenter" && mc(e);
  }, { signal: t });
...
function Tf(e, t) {
  _f(e, t), yf(e, t), vf(e, t), xf(e, t), wf(e, t), Ef(e, t), $f(e, t), Af(e, t), hf(e, t), uf(e, t), kf(e, t), jf(e, t), gf(e, t), Sf(e, t), Cf(e, t);
}
const wn = {
...
function ng(e, t, a = _s) {
  const o = $r(a), r = new e.Group();
  ...
  const h = new e.FogExp2(1250588, 8e-3), u = Mf(e), b = new e.PMREMGenerator(t);
  b.compileEquirectangularShader();
  const v = new El(), y = b.fromScene(v, 0.04).texture;
  return v.traverse((x) => {
    x.geometry?.dispose?.();
...
function ig(e, t, a, o, r) {
  o.group.visible = r, t.environment = r ? o.environment : null, t.background = r ? o.sky : new e.Color(1184274), t.fog = r ? o.fog : null, a.toneMapping = r ? e.ACESFilmicToneMapping : e.NoToneMapping, a.toneMappingExposure = r ? $r(o.quality).toneExposure : 1, t.traverse((n) => {
...
function Of(e) {
  ...
  const r = e.reconstruction, n = r.provider || "Reconstructed", i = Math.round(t * 100), c = Xc(e), l = c.length ? `
` + c.map(([m, f]) => `${m}: ${f}`).join(`
`) : "", p = `${n} • ${o} (${i}%)${l}`;
  return {
    label: o,
...
function cg(e, t, a) {
  return e?.reconstruction ? a ? "neutral" : Pf(t) === "source_texture" ? "textured" : "neutral" : null;
}
function Lf(e, t) {
...
function zf(e, t, a) {
  ...
  if (o) {
    const n = (i) => {
      const c = i.target.closest?.("[data-axis], [data-axis-center]") || i.target, l = c.getAttribute("data-axis"), p = pc(l?.toLowerCase(), e.state.view_mode);
  ...
  for (const n of e.root.querySelectorAll("[data-lens]"))
    n.addEventListener("click", () => {
      Jc(e, Number(n.dataset.lens));
    }, { signal: a });
  for (const n of e.root.querySelectorAll("[data-blocking-scene]"))
    n.addEventListener("click", () => {
      Fp(e, n.dataset.blockingScene), e.closeMenus();
    }, { signal: a });
...
const Nf = 32, Ff = 0.025, Rf = 0.05, Co = 1e-6, Kf = ["top", "bottom", "front", "back", "left", "right"], Df = {
  top: "y",
  bottom: "y",
  front: "z",
  back: "z",
...
function Bf(e) {
  let t = 0;
  for (let a = 1; a < e.length; a++) t += Mr(e[a - 1], e[a]);
  return t;
}
function kn(e) {
  const t = Math.max(0, Math.round(Number(e?.duration_frames) || 1) - 1), a = Array.isArray(e?.playback_range) ? e.playback_range : [0, t], o = lr(Math.round(Number(a[0]) || 0), 0, t), r = lr(Math.round(Number(a[1]) || t), 0, t);
  return o <= r ? [o, r] : [r, o];
}
function qf(e, t) {
  ...
  for (let i = 0; i < t; i++) {
    ...
    const l = a[n - 1], p = a[n], m = lr((c - l) / Math.max(Co, p - l), 0, 1), f = e[n - 1], d = e[n];
    r.push([
      f[0] + (d[0] - f[0]) * m,
      f[1] + (d[1] - f[1]) * m,
      f[2] + (d[2] - f[2]) * m
...
function Vf(e) {
  ...
  const n = Math.min(Nf, r.length, o + 1);
  if (n < 2) return [];
  const i = qf(r, n);
  ...
  ], p = e.planeAxis === "y" ? Cs(l) : Es(l, [0, 0, -1]), m = e.seedPoint ? 1 : 0, f = [];
  for (let d = m; d < i.length; d++) {
    const h = i[d], u = Uf(i, d, p, e.planeAxis), b = fe(c);
    b.position = [...h], b.target = Wf(h, u, l, e.planeAxis), f.push({
...
function As(e, t = e.cameraPathDraw) {
  const a = t?.pointerId;
  if (a != null)
    try {
...
function Sn(e, t = {}) {
  ...
  if (a === "extend") {
    ...
    const u = Math.max(0, Math.round(Number(e.state.duration_frames) || 1) - 1), [, b] = kn(e.state), v = d.length > 1 ? d[d.length - 1].frame - d[0].frame : 24;
    let y = Math.max(b, h.frame + Math.max(6, Math.min(v, 240)));
    y <= h.frame && (y = h.frame + 24), y > u && (l = y + 1), y > b && (p = y), c = [h.frame, y];
  } else
    Kf.includes(e.state.view_mode) || e.setViewMode?.("top"), c = kn(e.state);
  const m = Df[e.state.view_mode] ?? null, f = n ? [...n] : [...r.position];
...
function Ir(e, t) {
  ...
  return r && Mr(r, o) < Ff ? !1 : (a.points.push(o), !0);
}
function Ne(e) {
  const t = e.cameraPathDraw;
  return t?.active ? (As(e, t), e.cameraPathDraw = null, qt(e), e.setStatus?.(s("Draw Camera Path cancelled")), e.render?.(), !0) : !1;
}
function Gf(e) {
  const t = e.cameraPathDraw;
  ...
  if (a.length < 2 || Bf(a) < Rf || t.range[1] <= t.range[0])
    return Ne(e), e.setStatus?.(s("Camera path needs at least two distinct points")), null;
  const o = Vf(t);
...
function Xf(e, t) {
  const a = e.cameraPathDraw;
  return a?.active ? t.button === 2 && !t.altKey ? (Ao(t), e.cameraPathSuppressContextMenuUntil = Date.now() + 1e3, Ne(e), !0) : t.button !== 0 || t.altKey || t.ctrlKey || t.metaKey || t.shiftKey ? !1 : (Ao(t), e.closeMenus?.(), e.interactionElement.focus?.({ preventScroll: !0 }), e.interactionElement.setPointerCapture?.(t.pointerId), a.drawing = !0, a.pointerId = t.pointerId, a.points = [], Ir(e, Or(e, t)), qt(e), e.requestRender?.("camera-path-draw"), !0) : !1;
}
function Jf(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : (Ao(t), Ir(e, Or(e, t)) && e.requestRender?.("camera-path-draw"), !0);
}
function Zf(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : (Ao(t), t.type === "pointercancel" || t.type === "lostpointercapture" ? (Ne(e), !0) : (Ir(e, Or(e, t)), a.drawing = !1, Gf(e), !0));
}
function Qf(e) {
  const t = e.cameraPathDraw;
...
function eh(e, t) {
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? Ne(e) : Sn(e);
    }, { signal: t });
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path-extend"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? Ne(e) : Sn(e, { mode: "extend" });
    }, { signal: t });
  e.root.addEventListener("contextmenu", (a) => {
    !(Date.now() <= Number(e.cameraPathSuppressContextMenuUntil || 0)) && !e.cameraPathDraw?.active || (a.preventDefault(), a.stopPropagation(), a.stopImmediatePropagation?.(), e.cameraPathSuppressContextMenuUntil = 0, e.cameraPathDraw?.active && Ne(e));
  }, { capture: !0, signal: t });
}
...
function Pr(e, t, { name: a = "", status: o } = {}) {
  const r = t && typeof t == "object" ? t : Hn(), n = { ...r, metadata: { ...r.metadata || {}, scene_name: a || "" } };
...
async function th(e) {
  await Ht(e, s("New Scene"), s("Start a new scene? Unsaved changes will be lost.")) && Pr(e, Hn(), { name: "", status: s("New scene") });
}
async function ah(e) {
  if (!e.sceneBaseline) {
  ...
  const o = a?.metadata?.scene_name || $s(e);
  Pr(e, a, { name: o, status: s("Scene reset to last save") });
}
async function oh(e) {
  const t = $s(e) || s("Untitled"), a = await Vt(e, s("Save Scene"), s("Scene name"), t);
  if (a == null) return;
...
function sh(e, t) {
  bo(e, t, e.root.querySelectorAll('[data-act="scene-new"]'), () => th(e)), bo(e, t, e.root.querySelectorAll('[data-act="scene-open"]'), () => rh(e)), bo(e, t, e.root.querySelectorAll('[data-act="scene-save"]'), () => oh(e)), bo(e, t, e.root.querySelectorAll('[data-act="scene-reset"]'), () => ah(e));
}
const ih = ["world_point", "object_point", "camera_field"], jn = 40;
function ch(e) {
  return (e.keys || []).map((t) => ({ x: t.x, y: t.y, t: t.time_seconds }));
}
function lh(e, t, a) {
  const o = Math.max(1, Number(e.fps) || 24), r = e.width || 1280, n = e.height || 720, i = [];
  for (let c = 0; c <= jn; c += 1) {
    const l = a * c / jn, p = kr(e, t.source, l * o, r, n);
...
function mh(e) {
  ...
  if (!c) return;
  const l = Ts(t, e.state.width || 1280, e.state.height || 720), p = (v) => l.x + v * l.w, m = (v) => l.y + v * l.h;
  ...
  for (const v of e.state.motion_layers || []) {
    if (v.enabled === !1) continue;
    const y = ih.includes(v.source_kind), x = y ? lh(e.state, v, d) : ch(v);
    ...
    if (c.strokeStyle = S ? "#ffcc4d" : "rgba(65,217,197,0.6)", c.lineWidth = (S ? 2.4 : 1.5) * r, c.beginPath(), x.forEach((_, A) => {
      const F = p(_.x), L = m(_.y);
      A ? c.lineTo(F, L) : c.moveTo(F, L);
    }), c.stroke(), !y) {
...
function ph(e, t) {
  ...
  a && a.addEventListener("click", (o) => {
    ...
    const n = Ts(a, e.state.width || 1280, e.state.height || 720), i = a.width / r.width, c = {
      x: ((o.clientX - r.left) * i - n.x) / Math.max(1, n.w),
      y: ((o.clientY - r.top) * i - n.y) / Math.max(1, n.h)
    }, l = hc(e.state.motion_layers, c, 0.09);
...
function uh(e, t) {
  ...
  return {
    ...
    motion_scene_fingerprint: jl(e.state)
  };
}
function bh(e, t) {
  const a = uh(e, t);
...
function _n(e, t, { frameCount: a = 0, fps: o = 0 } = {}) {
...
const rt = 1024 * 1024, gh = Object.freeze({
  card: 128 * rt,
  // MAX_CARD_BYTES
  model: 256 * rt,
  // MAX_MODEL_BYTES
...
function En(e) {
  return `${(e / rt).toFixed(e >= 10 * rt ? 0 : 1)} MB`;
}
function Gt(e, t) {
  const a = gh[t];
  if (!e || !a) return null;
  const o = Number(e.size);
  return !Number.isFinite(o) || o <= a ? null : `${e.name || "File"} is ${En(o)}; the maximum is ${En(a)}.`;
}
function yh(e) {
  return Number(e) <= Cn ? null : `${e} frames selected; a background sequence is limited to ${Cn}.`;
}
function vh(e) {
...
async function Sh(e, t, { decode: a = wh } = {}) {
  if (!t) return;
  const o = Gt(t, "audio");
  if (o) {
    e.setStatus(o);
  ...
  try {
    ...
    n.preload = "auto", n.src = r, e.audioObjectUrl = r, e.audioElement = n, await kh(n), e.audioDuration = Number.isFinite(n.duration) ? n.duration : 0;
    try {
      e.audioSamples = await a(t);
    } catch {
      e.audioSamples = null;
    }
    Ms(e), e.setStatus(`Audio loaded: ${t.name || "track"}`);
  } catch (r) {
...
const Os = /* @__PURE__ */ new WeakSet(), Kt = /* @__PURE__ */ new WeakMap();
function To(e) {
...
function _h(e) {
  ...
  Kt.delete(e), Os.has(e) && To(e);
}
function Yt(e, t) {
  const a = e.cardMediaById.get(t);
  a && (e.cardMediaById.delete(t), e.cardMediaAssetById?.delete?.(t), t === "subject" && e.cardMedia === a && (e.cardMedia = null), _h(a));
}
function Ch(e) {
  for (const t of [...e.cardMediaById?.keys?.() || []]) Yt(e, t);
}
function Xe(e, t, a, o = !1, r = "") {
  ...
  n && n !== a && Yt(e, t), o && Os.add(a), jh(a), e.cardMediaAssetById ||= /* @__PURE__ */ new Map(), e.cardMediaById.set(t, a), e.cardMediaAssetById.set(t, r || a?.__omnicamAsset || "");
  try {
    a.__omnicamAsset = r || a.__omnicamAsset || "";
  } catch {
  }
...
function Ps(e, t, { signal: a, timeout: o = 15e3 } = {}) {
...
async function Ls(e, t, a, o = () => !0, r = null) {
  if (!t || !a) return;
  const n = () => !e.disposed && o(), i = String(t.asset || a).toLowerCase();
  if (r ?? /\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/.test(i)) {
    const l = document.createElement("video");
    if (l.src = a, l.loop = !0, l.muted = !0, l.playsInline = !0, await Ps(l, ["loadeddata", "error"], { signal: e.abortController?.signal }).catch(() => {
    }), !n()) {
      To(l);
      return;
    }
...
async function Th(e, t) {
  ...
  try {
    const c = await Er(gt, { route: "/majoor/omnicam/upload_model", field: "asset", file: t });
...
async function Mh(e, t) {
  ...
  if (o) {
    ...
    try {
      const r = await Er(gt, { route: "/majoor/omnicam/upload_asset", field: "asset", file: t });
...
function Oh(e) {
  ...
  const a = new Image();
  a.onload = () => {
    e.disposed || (Xe(e, "subject", a, !1, a.src), e.render(), e.setStatus(s("Upstream media refreshed")));
...
async function Ph(e) {
    ...
    if (h) {
      if (d === "image" || d === "video") {
        ...
        if (u && u.value) {
          ...
          if (S) {
            const g = await Ls(e, S, x, r, v);
            if (!r()) return;
            S.asset = pt(b, y);
            let _ = null;
            if (v)
              try {
                _ = await Eh(b, o.signal);
              } catch (A) {
          ...
          }), Xe(e, "subject", b, !1, b.currentSrc || b.src || ""), _n(e, b, { frameCount: b instanceof HTMLVideoElement ? 0 : 1 }), e.upstreamImageConnected = !0, n = !0, e.render(), e.setStatus(b instanceof HTMLVideoElement ? s("Upstream video preview synced") : s("Upstream image preview synced")));
        }
      }
      if (d === "audio") {
        l = !0;
  ...
  tl(e) && (n = !0), n && (e.serialize(), e.render());
}
const Lh = ["video/mp4;codecs=avc1.42E01E", "video/webm;codecs=vp9", "video/webm;codecs=vp8", "video/webm"], An = { low: 3e6, balanced: 6e6, high: 12e6 };
function zh(e) {
  return An[e] || An.balanced;
}
async function Nh({
  canvas: e,
  fps: t,
  ...
  try {
    for (const S of Lh)
      if (!(n.isTypeSupported && !n.isTypeSupported(S)))
        try {
          f = new n(m, { mimeType: S, videoBitsPerSecond: zh(r) });
          break;
        } catch {
        }
...
async function Rh(e) {
  await Promise.all([...e].filter((t) => t instanceof HTMLVideoElement && t.seeking).map((t) => Ps(t, ["seeked", "error"], { timeout: 5e3 }).catch(() => {
  })));
}
async function zs(e) {
  await Rh(e.cardMediaById.values());
}
async function Ns(e) {
  return Nh({
    canvas: e.canvas,
...
async function Fs(e, t) {
  const a = await Fh(Je, t);
  if (bh(e, t), e.state.playblast_camera_id === Gn)
...
async function Dh(e) {
  ...
  const t = e.frame, a = e.canvas.width, o = e.canvas.height, r = Kh(e);
  (r.width !== e.canvas.width || r.height !== e.canvas.height) && (e.canvas.width = r.width, e.canvas.height = r.height, e.render());
  try {
    let n = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-DKN0rCLe.js");
    i !== "realtime" && await l(e.canvas.width, e.canvas.height) && (n = await c(e.canvas, e.state.duration_frames, e.state.fps, async (p) => {
      e.setFrame(p, !0), e.setStatus(s(`Encoding frame ${p + 1}/${e.state.duration_frames}…`)), await zs(e), await new Promise((m) => requestAnimationFrame(m));
    }, e.abortController?.signal, e.state.playblast_quality)), n || (e.setStatus(s("WebCodecs unavailable; recording realtime fallback…")), n = await Ns(e)), e.setFrame(t), await Fs(e, n);
  } catch (n) {
...
async function Rs(e) {
  ...
  return Er(Ut, { route: "/majoor/omnicam/upload_asset", field: "asset", file: e });
}
async function Mo(e) {
...
async function qh(e, t) {
  ...
  let r = null;
  try {
    if (e.setStatus(`Uploading background: ${t.name}`), r = await Rs(t), o !== e.backgroundRequestId || e.disposed) {
      await Mo([r]);
      return;
    }
    const n = He(r.path);
...
async function Uh(e, t) {
  ...
  try {
    ...
    for (const c of t)
      if (n.push(await Rs(c)), r !== e.backgroundRequestId || e.disposed) {
        await Mo(n);
        return;
      }
...
function Wh(e) {
  Lr(e), e.checkpoint?.("Clear background"), e.state.viewport_bg_image = "", e.state.viewport_bg_sequence = [], e.viewportBgImage = null, e.viewportBgSequenceImages = [], e.serialize(), e.render(), e.setStatus("Background cleared");
}
function Vh(e) {
  ...
  for (const m of a) {
    if (m.enabled === !1 || !Kn(m, { mode: t.mode, selectedIds: p })) continue;
    const f = Dn(m, t.content);
    if (!f) continue;
    const d = Bn(a, m, l) || { position: m.position, size: m.size }, h = Re(qn(d, m.type), o, n, i);
    if (!h) continue;
    const [u, b] = h, v = t.content === "annotation" && m.annotation?.color || "", y = 6 * c, x = 4 * c, g = r.measureText(f).width + y * 2, _ = 12 * c + x * 2, A = Math.round(u - g / 2), F = Math.round(b - _ - 6 * c);
    r.fillStyle = "rgba(16,17,22,0.82)", Hh(r, A, F, g, _, 4 * c), r.fill(), v && (r.strokeStyle = v, r.lineWidth = Math.max(1, c), r.stroke()), r.fillStyle = v || "#e6e6ec", r.fillText(f, A + y, F + _ - x - 2 * c);
  }
  r.restore();
}
function Hh(e, t, a, o, r, n) {
  ...
  if (b)
    try {
      ...
      if (e.ctx.fillStyle = "#111", e.ctx.fillRect(f, h, v, y), g === "stretch" || !x || !S)
        ...
        const _ = Math.min(v / x, y / S), A = x * _, F = S * _;
        e.ctx.drawImage(b, f + (v - A) / 2, h + (y - F) / 2, A, F);
      } else {
        const _ = Math.max(v / x, y / S), A = v / _, F = y / _;
        e.ctx.drawImage(b, (x - A) / 2, (S - F) / 2, A, F, f, h, v, y);
      }
    } catch {
    }
  else
...
function su(e) {
  ...
  for (let o = 0; o < e.state.keyframes.length - 1; o++) {
    ...
    t.push(Wn(Vn(n.camera.position, r.camera.position)) * e.state.fps / Math.max(1, n.frame - r.frame));
  }
...
function iu(e) {
  ...
  e.recording && e.state.playblast_labels && Vh(e);
}
...
function hu(e, { perFrame: t = !1 } = {}) {
  const a = e.activeCameraTrack(), o = zr(e, a), r = Nr(e, a);
...
function Bs(e) {
  ...
  const r = (d, h, u, b, v = "") => {
    ...
    `, v.addEventListener("click", () => {
      e.outlinerCollapsedSections ||= /* @__PURE__ */ new Set(), e.outlinerCollapsedSections.has(u) ? e.outlinerCollapsedSections.delete(u) : e.outlinerCollapsedSections.add(u), Bs(e);
  ...
  if (m) {
    ...
    if (t.appendChild(x), !S)
      for (const { object: g, level: _ } of y) {
        ...
        const F = e.selectedEntity === "object" && (g.id === e.selectedObjectId || e.selectedObjectIds?.has?.(g.id)), L = e.selectedEntity === "object" && g.id === e.selectedObjectId;
        A.setAttribute("aria-selected", String(F)), A.className = `scene-item${F ? " selected" : ""}${L ? " primary" : ""}${_ > 0 && !n ? " scene-item-child" : ""}`, _ > 0 && !n && (A.style.paddingLeft = `${_ * 16 + 6}px`);
        ...
        z.style.cssText = H ? "color:#fca5a5" : V ? "" : "opacity:.5;text-decoration:line-through", z.textContent = g.name || g.type, z.title = s("Double-click to rename"), z.addEventListener("dblclick", (T) => {
          T.preventDefault(), T.stopPropagation(), bu(e, g, z);
        }), j.appendChild(z);
        ...
        q.className = "scene-item-actions", q.appendChild(r(V ? "pi-eye" : "pi-eye-slash", V ? "Hide object (Alt+Click to Isolate)" : "Show object (Alt+Click to Isolate)", !V, (T) => {
          if (T?.altKey) {
            ...
            e.toggleObject(g.id);
        }, "color:#ef4444;opacity:.7")), q.appendChild(r(g.locked ? "pi-lock" : "pi-lock-open", "Lock object", g.locked, () => Tr(e, g))), q.appendChild(r("pi-copy", "Duplicate object", !1, () => e.duplicateObject?.(g.id))), g.id !== "subject" && q.appendChild(r("pi-trash", "Delete object", !1, () => e.deleteObject?.(g.id))), q.appendChild(r("pi-ellipsis-v", "Object actions", !1, (T) => e.openObjectContext(T, g.id))), A.append(se, j, q), A.title = s("Click to select · Double-click to toggle visibility · Right-click for actions");
        const ne = (T = {}) => {
...
function ku(e) {
  ...
  if (n) {
    const j = r.target_object_id || e.state.target_object_id || "", z = `T${Ur()}${e.state.objects.map((U) => `${U.id}\0${U.name || U.type}`).join("|")}`;
    Xo(n, z, () => [
  ...
  uu(e);
  const i = [...e.camera.position, ...e.camera.target, e.camera.fov, e.camera.roll || 0, e.camera.near, e.camera.far, ...Sr(e.camera)];
  ...
  if (!t) {
    ...
    z && (z.textContent = `${r.name} · F${e.frame}`), $n(o, {
  ...
  m && (m.textContent = t.name || t.type), $n(o, {
  ...
  if (v) {
    ...
    const q = e.state.objects.filter((T) => !z.has(T.id)), ne = `P${Ur()}${j}${q.map((T) => `${T.id} ${T.name || T.type}`).join("|")}`;
    Xo(v, ne, () => [
      Rt("", s("No parent")),
      ...q.map((T) => Rt(T.id, T.name || T.type))
    ], t.parent_id || "");
  }
  ...
  if (u && (u.hidden = !L?.animations), b) {
    ...
    Xo(b, `A${j.join("|")}`, () => j.map((z, U) => Rt(String(U), z)), String(t.animation_index || 0));
  }
...
function Cu(e) {
  ...
  e.beginCameraEdit(), yc(e.camera, r), e.commitCameraEdit(), e.finishCameraEdit(), Vs(e), _u(e), e.render();
}
function Eu(e) {
  const t = globalThis.performance?.now?.() ?? Date.now();
  (!Number.isFinite(e.lastCameraHudEditAt) || t - e.lastCameraHudEditAt > 300) && e.checkpoint("Edit camera"), e.lastCameraHudEditAt = t;
  ...
  e.camera.position = [a("camera-px", e.camera.position[0]), a("camera-py", e.camera.position[1]), a("camera-pz", e.camera.position[2])], e.camera.target = [a("camera-tx", e.camera.target[0]), a("camera-ty", e.camera.target[1]), a("camera-tz", e.camera.target[2])], e.camera.fov = X(a("camera-fov", e.camera.fov), 5, 150), e.camera.roll = X(a("camera-roll", e.camera.roll || 0), -180, 180), e.camera.near = Math.max(1e-4, a("camera-near", e.camera.near)), e.camera.far = Math.max(e.camera.near + 1e-4, a("camera-far", e.camera.far)), e.beginCameraEdit(), e.commitCameraEdit(), e.finishCameraEdit(), Vs(e), e.render();
}
function Au(e, t) {
  const a = Xt(e);
  if (!a) return;
...
function Mu(e) {
  ...
  return t.forEach((o, r) => {
    ...
    const c = 0.35 + r * 0.15;
    i.position = We(i.position || [0, 0, 0], [c, 0, c]), (i.type === "model" || i.type === "glb") && e.modelUrlsById.has(n.id) ? e.modelUrlsById.set(i.id, e.modelUrlsById.get(n.id)) : i.type === "card" && e.cardMediaById.has(n.id) && Xe(e, i.id, e.cardMediaById.get(n.id), !1, i.asset || e.cardMediaAssetById?.get?.(n.id) || ""), e.state.objects.push(i), a.push(i.id);
...
function Fu(e) {
  ...
  const t = e.root.querySelector('[data-role="key-interp"]')?.value || e.root.querySelector('[data-role="interp"]')?.value || "ease", a = Me(e), o = Se(e), r = a ? { frame: e.frame, transform: Ze(a), interpolation: t } : { frame: e.frame, camera: fe(e.camera), interpolation: t }, n = o.findIndex((i) => i.frame === e.frame);
...
function Bu(e) {
  ...
  const o = t ? { frame: e.frame, transform: Ze(e.copiedKeyframe.transform), interpolation: e.copiedKeyframe.interpolation } : { frame: e.frame, camera: fe(e.copiedKeyframe.camera), interpolation: e.copiedKeyframe.interpolation }, r = Se(e), n = r.findIndex((i) => i.frame === e.frame);
...
const Yu = ["guides", "safe-areas", "resolution-gate", "aspect-ratio"];
function Xu(e) {
...
function tb(e) {
  ...
  if (e.checkpoint("Edit keyframe"), e.editingKeyFrame = t.frame, Me(e)) {
    t.interpolation = e.root.querySelector('[data-role="key-interp"]').value, t.transform = Ze(Me(e)), e.serialize(), e.setFrame(t.frame), e.setStatus(s(`Object keyframe updated @ ${t.frame}`));
    return;
  }
  const a = (o, r) => {
...
const Fr = ["pos_x", "pos_y", "pos_z"], dr = 1e-9, zo = ["auto", "aligned", "free", "corner"];
function $e(e, t = 0) {
  const a = Number(e);
...
function mr(e, t, a) {
  const o = Fe(e), r = t ? Fe(t) : o, n = a ? Fe(a) : o, i = Math.max(dr, $e(e?.frame) - $e(t?.frame, $e(e?.frame) - 1)), c = Math.max(dr, $e(a?.frame, $e(e?.frame) + 1) - $e(e?.frame)), l = [0, 0, 0], p = [0, 0, 0];
  for (let m = 0; m < 3; m += 1) {
...
function rb(e, t = null, a = null) {
  const o = Bt(e), r = Fe(e);
  if (o === "corner") {
    const l = Gs(e, t, a);
    return { in: go(r, l.in), out: go(r, l.out), mode: o };
  }
  const n = mr(e, t, a), i = (o === "free" || o === "aligned") && pr(e, "out") || n.out, c = (o === "free" || o === "aligned") && pr(e, "in") || n.in;
...
function Ys(e, t, a) {
  const o = Fe(e), r = rb(e, t, a);
  yt(e, "out", Wt(r.out, o)), yt(e, "in", Wt(r.in, o));
}
function sb(e, t, a, { prevKey: o = null, nextKey: r = null } = {}) {
  if (!e || t !== "in" && t !== "out") return e;
  let n = Bt(e);
  if (n === "corner") return e;
  n === "auto" && (n = "aligned", e.tangents = e.tangents && typeof e.tangents == "object" ? e.tangents : {}, e.tangents.spatial_mode = "aligned", Ys(e, o, r));
  const i = Fe(e), c = Wt([
    $e(a?.[0]),
    $e(a?.[1]),
    $e(a?.[2])
  ], i);
  if (fr(e), yt(e, t, c), n === "aligned") {
    const l = t === "out" ? "in" : "out", p = pr(e, l) || (l === "out" ? mr(e, o, r).out : mr(e, o, r).in), m = Tn(c), f = Tn(p) || m || 1, d = m > dr ? Io(c, -f / m) : Io(p, 1);
    yt(e, l, d);
  }
  return e;
}
function ib(e, t, { prevKey: a = null, nextKey: o = null } = {}) {
  ...
  if (t === "corner") {
    const r = Gs(e, a, o);
    return fr(e), yt(e, "out", r.out), yt(e, "in", r.in), e;
  }
  return fr(e), Ys(e, a, o), e;
}
function cb(e) {
  switch (e) {
    case "auto":
...
function db(e) {
  ...
  return {
    ...
    restoreHistorySnapshot(O) {
      ...
      const k = Mn(this.state), w = new Set(this.state.objects.map((ie) => ie.id));
      this.state = it($.state);
    ...
    openObjectContext(O, $) {
      ...
      this.showContextMenu(O, k.name || k.type, [
        ...
        { label: k.locked ? s("Unlock object") : s("Lock object"), icon: k.locked ? "pi-lock" : "pi-lock-open", run: () => Tr(this, k) },
        null,
        {
          label: s("Transform mode"),
          icon: "pi-arrows-alt",
    ...
    openCurveContext(O) {
      const $ = this.selectedKeyFrames?.size || 0, k = $ < 2 && !this.selectedKeyframe(), w = this.selectedKeyframe(), E = w?.interpolation || "ease", M = w && Bt(w) || "auto", R = ["bezier", "smooth", "linear", "ease_in", "ease_out", "ease", "sine", "cubic", "quintic", "expo", "back"], Z = ["auto", "clamped", "vector", "free", "aligned", "flat"];
    ...
    resizeCanvas() {
      ...
      for (const R of this.cameraPreviewCanvases.values()) {
        const Z = R.clientWidth || 220, B = R.clientHeight || 124, ie = Math.max($, lb / Math.max(1, Z)), je = Math.max(1, Math.round(Z * ie)), Pe = Math.max(1, Math.round(B * ie));
...
function mb(e, t) {
  ...
  const o = gr();
  o.position = [0, 0, 0], o.target = [0, 0, -1], a.camera = fe(o), a.keyframes = [{ frame: 0, camera: fe(o), interpolation: "ease" }], e.state.active_camera_id = a.id, e.state.camera = fe(o), e.state.keyframes = a.keyframes, e.camera = fe(o), e.frame = 0, e.selectedEntity = "camera", e.selectedObjectId = null, e.selectedKeyFrame = 0, e.editingKeyFrame = null, e.cameraEditKey = null, e.cameraEditActive = !1, e.cameraPreviewSignature = "", Xs(e), e.refreshCameraSelectors(), e.setStatus(s(`${a.name} animation reset`));
}
function pb(e, t) {
  const a = e.state.objects.find((o) => o.id === t);
  a && (e.checkpoint("Reset object animation"), a.keyframes = [], a.position = [0, 0, 0], a.rotation = [0, 0, 0], e.frame = 0, e.selectedEntity = "object", e.selectedObjectId = a.id, e.selectedKeyFrame = null, e.editingKeyFrame = null, Xs(e), e.setStatus(s(`${a.name || a.type} animation reset`)));
}
const In = { motion: "motion", shot: "display", health: "health" }, fb = {
  object: "Object",
  camera: "Camera",
  camera_target: "Look-At Target",
  camera_path: "Camera Path"
}, hb = { motion: "Motion", shot: "Shot", health: "Health" }, ub = ["entity", "motion", "shot", "health"];
function Js(e) {
  return e.inspectorMode && e.inspectorMode !== "entity" ? e.inspectorMode : "entity";
}
function bb(e) {
  const t = Js(e);
  return In[t] ? In[t] : e.selectedEntity === "object" ? "scene" : "camera";
}
function gb(e) {
  return [
    e.selectedEntity || "",
...
function Zs(e) {
  ...
  r && (r.textContent = o === "entity" ? s(fb[e.selectedEntity] || "Inspector") : s(hb[o] || "Inspector"));
}
function vb(e, t) {
  e.inspectorMode = ub.includes(t) ? t : "entity", Zs(e), e.render?.(), e.refitNode?.();
}
function xb(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: u, syncActiveCameraTrack: b, syncFromWidgets: v, bindEditorEvents: y, activateCamera: x, addCamera: S, deleteCamera: g, drawPreviewOverlays: _, duplicateCamera: A, maximizeCameraPreview: F, refreshCameraPreviews: L, refreshCameraSelectors: J, renameCamera: V, setPlayblastCamera: H, toggleCameraView: se, captureRealtime: j, makePlayblast: z, uploadDirectorPlayblast: U, waitForMediaFrame: q, computeAudioPeaks: ne, loadAudioFile: T, releaseAudio: G, stopPlay: P, togglePlay: W, applyCameraPreset: Y, applyCameraShake: le, applyProxyPreset: de, clearViewportBgImage: re, loadViewportBgFile: me, loadViewportBgSequence: ue, drawCameraPath: pe, drawCard: ye, drawCube: ge, drawGrid: be, drawHuman: Ee, drawLine3D: N, drawNull: D, drawOverlays: ae, drawPointField: te, drawSpeedHeatmap: ve, drawSphere: De, curveChannels: Ie, drawCurveEditor: Qe, onCurvePointerDown: xt, onCurvePointerMove: wt, onCurvePointerUp: kt, onTimelinePointerDown: Jt, onTimelinePointerMove: Zt, onTimelinePointerUp: Qt, refreshKeys: St, resetCurveZoom: jt, resetTimelineZoom: st, setChannelFilter: _t, setCurveInterpolation: Ct, setTangentMode: Et, timelineFrameFromEvent: ea, toggleCurveHandles: At, zoomCurve: ta, drawTransformGizmo: aa, frameTarget: oa, gizmoAxes: ra, gizmoGeometry: na, onPointerDown: sa, onPointerMove: ia, onPointerUp: ca, onWheel: la, pickGizmo: da, pickSceneObject: ma, resetCamera: $t, setTransformMode: Tt, setViewMode: pa, viewportCamera: fa, loadCardFile: No, loadExecutionPreview: Fo, loadMediaUrl: ha, loadModelFile: ua, loadSelectedReference: ba, onModelLoaded: ga, restoreAssets: ya, syncUpstreamInputs: va, configureDomMedia: xa, refreshSetupDiagnostic: Mt, addMediaCard: wa, addPrimitive: ka, applyObjectAnimationFrame: Sa, beginCameraEdit: ja, beginObjectEdit: _a, commitCameraEdit: Ca, commitObjectEdit: Ea, copyKeyframe: Aa, deleteKeyframe: $a, deleteObject: Ta, deleteSelectedObjects: Ma, duplicateObject: Ia, exitKeyEdit: Oa, finishCameraEdit: Pa, goToAdjacentKey: La, insertKeyframe: za, loadSelectedKeyView: Na, pasteKeyframe: Fa, playblastCameraAtFrame: Ra, refreshInspector: Ka, refreshKeyEditor: Da, refreshObjects: Ba, removeObjectResources: qa, renameObject: Ua, retimeSelectedKey: Wa, selectKeyframe: Va, selectedKeyframe: Ha, selectedObject: Ga, selectObjectAnimation: Ya, setKeyInterpolation: Xa, setKeyTangentMode: Ja, setObjectParent: et, timelineKeyframes: Za, timelineObject: Qa, toggleAutoKey: eo, toggleObject: to, updateCameraFromHud: ao, updateCameraRotationFromHud: oo, updateEditState: ro, updateKeyVisualState: It, updateSelectedKey: no, updateSelectedObject: so, clamp: io, cloneCamera: Ot, configureCore: Ro, defaultCamera: it, sampleCamera: Be, sampleObjectTransform: O, sanitizeState: $, worldTransform: k } = e;
  return {
    setChannelFilter(w) {
      _t(this, w);
    },
    setFrame(w, E = !1, M = !0) {
      this.frame = io(Math.round(w), 0, this.state.duration_frames - 1), this.editingKeyFrame !== this.frame && (this.editingKeyFrame = null), this.camera = Be(this.activeCameraTrack(), this.frame, this.state.objects), Dt(this, this.activeCameraTrack(), this.camera, this.frame), this.applyObjectAnimationFrame();
      const R = this.dom ||= xs(this.root);
      ...
      for (const Q of R.cameraFocal) document.activeElement !== Q && (Q.value = jr(this.camera.fov));
      ...
      const B = Math.floor(Z / 60), ie = Math.floor(Z % 60), je = Math.floor(Z % 1 * 1e3), Pe = this.frame % Math.max(1, Math.round(this.state.fps)), tt = Math.floor(this.frame / this.state.fps);
      if ((R.time || this.root.querySelector('[data-role="time"]')).textContent = this.state.timecode_mode === "timecode" ? `${String(Math.floor(tt / 3600)).padStart(2, "0")}:${String(Math.floor(tt / 60) % 60).padStart(2, "0")}:${String(tt % 60).padStart(2, "0")}:${String(Pe).padStart(2, "0")}` : `${String(B).padStart(2, "0")}:${String(ie).padStart(2, "0")}.${String(je).padStart(3, "0")}`, M) this.refreshKeys();
      else {
        _o(this);
    ...
    setSpatialHandleMode(w) {
      ...
      this.checkpoint(s("Camera path handle: {mode}").replace("{mode}", w)), ib(M[R], w, {
        prevKey: M[R - 1] || null,
        nextKey: M[R + 1] || null
    ...
    transformCameraPath(w) {
      ...
      const M = vc(E.keyframes, { origin: xc(E.keyframes), ...w });
    ...
    playblastCameraAtFrame() {
      return Dt(this, d(this), Ra(this, Be), this.frame);
    },
    viewportCamera() {
      return fa(this);
    },
    ...
    refreshInspector() {
      this.perf && (this.perf.inspectorRefreshCount = (this.perf.inspectorRefreshCount || 0) + 1), Ka(this), yb(this);
    },
    setInspectorMode(w) {
      vb(this, w);
    },
...
function Sb(e) {
  const { right: t, up: a, forward: o } = wc(e || {});
  return kb.map((r) => {
...
const Cb = "http://www.w3.org/2000/svg", ft = 26, On = 17, Eb = 5.4;
function ht(e, t) {
  const a = document.createElementNS(Cb, e);
...
function Ab(e) {
  ...
  for (const n of jb(Sb(a))) {
    const i = ft + n.x * On, c = ft + n.y * On, l = _b(n.depth);
...
function Tb(e) {
  ...
  for (const r of e.state.motion_layers || []) {
    ...
    const n = $b(e.state, r, e.frame, a, o);
    if (n.length) {
...
const Mb = ["world_point", "object_point", "camera_field"], Qs = {
  manual_2d: "DRAW",
  object_point: "OBJECT",
  world_point: "WORLD",
...
function Ob(e, t) {
  if (Mb.includes(t.source_kind)) {
    const a = kr(e, t.source, 0, e.width || 1280, e.height || 720);
...
function zb(e) {
  ...
  n("motion-sel-name", a.label), n("motion-sel-type", Qs[a.source_kind] || "TRACK"), n("motion-sel-binding", Ib(e.state, a)), n("motion-sel-start", r.length ? Math.min(...r) : 0), n("motion-sel-end", r.length ? Math.max(...r) : 0);
...
function Rb(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: u, syncActiveCameraTrack: b, syncFromWidgets: v, bindEditorEvents: y, activateCamera: x, addCamera: S, deleteCamera: g, drawPreviewOverlays: _, duplicateCamera: A, maximizeCameraPreview: F, refreshCameraPreviews: L, refreshCameraSelectors: J, renameCamera: V, setPlayblastCamera: H, toggleCameraView: se, captureRealtime: j, makePlayblast: z, uploadDirectorPlayblast: U, waitForMediaFrame: q, computeAudioPeaks: ne, loadAudioFile: T, releaseAudio: G, stopPlay: P, togglePlay: W, applyCameraPreset: Y, applyCameraShake: le, applyProxyPreset: de, clearViewportBgImage: re, loadViewportBgFile: me, loadViewportBgSequence: ue, drawCameraPath: pe, drawCard: ye, drawCube: ge, drawCylinder: be, drawGrid: Ee, drawHuman: N, drawLine3D: D, drawNull: ae, drawOverlays: te, drawPointField: ve, drawSpeedHeatmap: De, drawSphere: Ie, drawTorus: Qe, curveChannels: xt, drawCurveEditor: wt, onCurvePointerDown: kt, onCurvePointerMove: Jt, onCurvePointerUp: Zt, onTimelinePointerDown: Qt, onTimelinePointerMove: St, onTimelinePointerUp: jt, refreshKeys: st, resetCurveZoom: _t, resetTimelineZoom: Ct, setChannelFilter: Et, setCurveInterpolation: ea, setTangentMode: At, timelineFrameFromEvent: ta, toggleCurveHandles: aa, zoomCurve: oa, drawTransformGizmo: ra, frameTarget: na, gizmoAxes: sa, gizmoGeometry: ia, onPointerDown: ca, onPointerMove: la, onPointerUp: da, onWheel: ma, pickGizmo: $t, pickSceneObject: Tt, resetCamera: pa, setTransformMode: fa, setViewMode: No, viewportCamera: Fo, loadCardFile: ha, loadExecutionPreview: ua, loadMediaUrl: ba, loadModelFile: ga, loadSelectedReference: ya, onModelLoaded: va, restoreAssets: xa, syncUpstreamInputs: Mt, configureDomMedia: wa, refreshSetupDiagnostic: ka, addMediaCard: Sa, addPrimitive: ja, applyObjectAnimationFrame: _a, beginCameraEdit: Ca, beginObjectEdit: Ea, commitCameraEdit: Aa, commitObjectEdit: $a, copyKeyframe: Ta, deleteKeyframe: Ma, deleteObject: Ia, duplicateObject: Oa, exitKeyEdit: Pa, finishCameraEdit: La, goToAdjacentKey: za, insertKeyframe: Na, loadSelectedKeyView: Fa, pasteKeyframe: Ra, playblastCameraAtFrame: Ka, refreshInspector: Da, refreshKeyEditor: Ba, refreshObjects: qa, removeObjectResources: Ua, renameObject: Wa, retimeSelectedKey: Va, selectKeyframe: Ha, selectedKeyframe: Ga, selectedObject: Ya, selectObjectAnimation: Xa, setKeyInterpolation: Ja, setObjectParent: et, timelineKeyframes: Za, timelineObject: Qa, toggleAutoKey: eo, toggleObject: to, updateCameraFromHud: ao, updateEditState: oo, updateKeyVisualState: ro, updateSelectedKey: It, updateSelectedObject: no, clamp: so, cloneCamera: io, configureCore: Ot, defaultCamera: Ro, sampleCamera: it, sampleObjectTransform: Be, sanitizeState: O, worldTransform: $ } = e;
  return {
    ...
    renderViewportOnly() {
      ...
      if (this.webgl)
        try {
          const oe = this.recording ? 1 : this.webgl.supersampleFactor?.() ?? 1, qe = oe > 1 ? Math.min(oe, 4096 / Math.max(1, w, E)) : 1, co = qe > 1 ? Math.round(w * qe) : w, Ko = qe > 1 ? Math.round(E * qe) : E;
          this.webgl.render(tt, R, this.cardMediaById, co, Ko, this.modelUrlsById, this.frame, this.recording, this.selectedEntity, this.selectedObjectId, this.subSelection, this.selectedKeyFrame ?? null), k.imageSmoothingEnabled = !0, k.imageSmoothingQuality = "high", co !== w || Ko !== E ? k.drawImage(this.webgl.canvas, 0, 0, co, Ko, 0, 0, w, E) : k.drawImage(this.webgl.canvas, 0, 0, w, E), Q = !0;
        } catch (oe) {
      ...
      !this.recording && this.state.speed_heatmap && this.drawSpeedHeatmap(), !this.recording && Qf(this), this.drawOverlays(), Tb(this), this.state.show_gizmo && Ab(this), this.labelOverlay?.update(), this.rigOverlay?.update(), this.perf && (this.perf.viewportRenderCount = (this.perf.viewportRenderCount || 0) + 1);
    },
    ...
    requestUiUpdate(k = C.viewport, w = "unknown") {
      (this.renderReasons ||= /* @__PURE__ */ new Set()).add(w), this.uiDirtyMask = Mm(this.uiDirtyMask, k), this.renderInvalidations = (this.renderInvalidations || 0) + 1, !this.renderScheduled && (this.renderScheduled = !0, this.renderFrame = requestAnimationFrame(() => {
    ...
    renderCameraView() {
      if (this.perf && (this.perf.previewRenderCount = (this.perf.previewRenderCount || 0) + 1), this.state.camera_view_visible) {
        ...
        for (const R of w) {
          ...
          const tt = Dt(this, R, it(R, this.frame, this.state.objects), this.frame);
          if (B.fillStyle = "#111", B.fillRect(0, 0, ie, je), this.cameraWebgl)
            try {
              this.cameraWebgl.render({ ...this.state, keyframes: [], playblast_grid: !1, viewport_bg_image: this.viewportBgImage?.src || "", viewport_bg_sequence: (this.viewportBgSequenceImages || []).map((Q) => Q.src), __omnicamRevision: this.renderRevision || 0 }, tt, this.cardMediaById, ie, je, this.modelUrlsById, this.frame, !0), B.drawImage(this.cameraWebgl.canvas, 0, 0, ie, je);
            } catch (Q) {
    ...
    dispose() {
      this.disposed || (this.disposed = !0, this.agentBridge?.dispose?.(), kc(this), Sc(), ol(this), this.backgroundRequestId = (this.backgroundRequestId || 0) + 1, this.upstreamSyncId = (this.upstreamSyncId || 0) + 1, this.stopPlay(), clearTimeout(this.previewClickTimer), clearTimeout(this.connectionTimer), cancelAnimationFrame(this.restoreFrame), cancelAnimationFrame(this.serializeFrame), cancelAnimationFrame(this.resizeFrame), cancelAnimationFrame(this.renderFrame), this.abortController?.abort(), this.upstreamFetchController?.abort(), this.resizeObserver?.disconnect(), this.contextMenu?.dispose(), this.webgl?.dispose(), this.cameraWebgl?.dispose(), G(this), Ch(this), this.objectUrls.clear(), this.cardMediaById.clear(), this.cardMediaAssetById?.clear?.(), this.modelUrlsById.clear(), this.modelInfoById.clear());
    }
  };
}
const ei = 1e-9;
...
function Rr(e, t) {
  const a = e.map((i) => Kb(i, t)), o = Db(a), r = e.map((i) => i.frame), n = Math.max(1, r[r.length - 1] - r[0]);
  return a.map((i, c) => [
    (r[c] - r[0]) / n,
...
function qb(e, t, { tolerance: a = 0.02, keepFrames: o = [] } = {}) {
  const r = [...e].sort((m, f) => m.frame - f.frame);
  if (r.length <= 2 || a <= 0) return { keys: r, removed: 0 };
  const n = Rr(r, t), i = /* @__PURE__ */ new Set(), c = new Set(o);
  r.forEach((m, f) => {
...
function Ub(e, t, { target: a = 2, keepFrames: o = [] } = {}) {
...
function Wb(e, t, { mergeWithin: a = 1, epsilon: o = 1e-3, keepFrames: r = [] } = {}) {
...
function Hb(e, t, a, { lastFrame: o = 1 / 0 } = {}) {
...
function Jb() {
  return {
    ...
    deleteSelectedKeyframes() {
      ...
      const t = this._activeTrack(), a = Se(this), o = t.kind === "camera" ? 1 : 0, { keys: r, removed: n } = Vb(a, e, { minKeys: o });
    ...
    nudgeSelectedKeyframes(e) {
      ...
      const a = this._activeTrack(), o = Math.max(0, this.state.duration_frames - 1), r = Hb(Se(this), t, e, { lastFrame: o });
    ...
    setSelectedKeysInterpolation(e) {
      ...
      this.checkpoint(s("Interpolation on {n} keys").replace("{n}", t.length)), a.write(Gb(Se(this), t, e)), this.serialize(), this.refreshKeys(), this.refreshKeyEditor(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} interpolation on {n} keys").replace("{mode}", e.replace(/_/g, " ")).replace("{n}", t.length));
    },
    setSelectedKeysTangentMode(e) {
      const t = this.resolveSelectedFrames();
      if (t.length < 2) return this.setTangentMode(e);
      const a = this._activeTrack(), o = nt(this).map((r) => r.id);
      this.checkpoint(s("Tangents on {n} keys").replace("{n}", t.length)), a.write(Yb(Se(this), t, e, o)), this.serialize(), this.refreshKeys(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} tangents on {n} keys").replace("{mode}", e).replace("{n}", t.length));
    },
    /**
    ...
    simplifyActiveKeys({ mode: e = "simplify", tolerance: t = 0, target: a = 0, scope: o = "camera", fromKeys: r = null, silent: n = !1 } = {}) {
      ...
      const l = this.resolveSelectedFrames(), p = o !== "all_cameras" && l.length >= 2 ? [l[0], l.at(-1)] : null, m = p ? [] : l, f = (u) => {
        const b = [...u].sort((F, L) => F.frame - L.frame), v = p ? p[0] : -1 / 0, y = p ? p[1] : 1 / 0, x = b.filter((F) => F.frame < v), S = b.filter((F) => F.frame >= v && F.frame <= y), g = b.filter((F) => F.frame > y);
        let _ = S, A = 0;
        if (S.length > 2) {
          const F = e === "reduce" ? Ub(S, i, { target: a || Math.ceil(S.length / 2), keepFrames: m }) : e === "clean" ? Wb(S, i, { keepFrames: m }) : qb(S, i, { tolerance: t * Xb, keepFrames: m });
          _ = F.keys, A = F.removed;
        }
        return { keys: [...x, ..._, ...g].sort((F, L) => F.frame - L.frame), removed: A };
      };
      let d = 0;
      const h = c.map((u) => {
...
class ti {
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-DKN0rCLe.js"));
    } catch (a) {
    ...
    if (!this.disposed) {
      ...
      jc(this), this.resizeCanvas(), this.render(), this.renderCameraView();
    }
  }
}
const yo = { app: Ln, api: Je, EditorHistory: ms, ContextMenuController: Jn, initializeTooltips: nl, promptText: Vt, ObjectUrlRegistry: ps, buildRoot: fs, dispatchDirectorKey: _c, activeCameraTrack: er, bindWidgetCallbacks: sl, playblastCameraTrack: Xn, restoreFromWidgets: il, serializeEditorState: cl, syncActiveCameraTrack: tr, syncFromWidgets: ll, bindEditorEvents: fh, activateCamera: dl, addCamera: ml, deleteCamera: pl, drawPreviewOverlays: fl, duplicateCamera: hl, maximizeCameraPreview: ul, refreshCameraPreviews: bl, refreshCameraSelectors: gl, renameCamera: yl, setPlayblastCamera: vl, toggleCameraView: xl, captureRealtime: Ns, makePlayblast: Dh, uploadDirectorPlayblast: Fs, waitForMediaFrame: zs, computeAudioPeaks: Ms, loadAudioFile: Sh, releaseAudio: $o, stopPlay: So, togglePlay: xh, applyCameraPreset: Lp, applyCameraShake: zp, applyProxyPreset: Np, clearViewportBgImage: Wh, loadViewportBgFile: qh, loadViewportBgSequence: Uh, drawCameraPath: nu, drawCard: ru, drawCube: Zh, drawCylinder: tu, drawGrid: Gh, drawHuman: eu, drawLine3D: ce, drawNull: ou, drawOverlays: iu, drawPointField: Jh, drawSpeedHeatmap: su, drawSphere: Qh, drawTorus: au, curveChannels: nt, drawCurveEditor: ad, fitCurveView: ns, onCurveDoubleClick: ed, onCurvePointerDown: Wl, onCurvePointerMove: Vl, onCurvePointerUp: Hl, onTimelinePointerDown: Cc, onTimelinePointerMove: Ec, onTimelinePointerUp: Ac, refreshKeys: gd, resetCurveZoom: td, resetTimelineZoom: $c, setChannelFilter: Yl, setCurveInterpolation: Gl, setTangentMode: Xl, timelineFrameFromEvent: hr, toggleCurveHandles: Jl, zoomCurve: Ql, drawTransformGizmo: Tc, frameTarget: Mc, gizmoAxes: Ic, gizmoGeometry: Oc, onPointerDown: Pc, onPointerMove: Lc, onPointerUp: zc, onWheel: Nc, pickGizmo: Fc, pickSceneObject: Rc, resetCamera: Kc, setTransformMode: Dc, setViewMode: Bc, viewportCamera: qc, loadCardFile: Mh, loadExecutionPreview: Ih, loadMediaUrl: Ls, loadModelFile: Th, loadSelectedReference: Oh, onModelLoaded: $h, restoreAssets: Ah, syncUpstreamInputs: Ph, configureDomMedia: Is, refreshSetupDiagnostic: du, addMediaCard: wu, addPrimitive: gu, applyObjectAnimationFrame: Nu, beginCameraEdit: Uu, beginObjectEdit: Ws, commitCameraEdit: Wu, commitObjectEdit: ju, copyKeyframe: Du, deleteKeyframe: Ku, deleteObject: Us, deleteSelectedObjects: xu, duplicateObject: qs, exitKeyEdit: Hu, finishCameraEdit: Vu, goToAdjacentKey: ob, insertKeyframe: Fu, loadSelectedKeyView: ab, pasteKeyframe: Bu, playblastCameraAtFrame: zu, refreshInspector: ku, refreshKeyEditor: Qu, refreshObjects: Bs, removeObjectResources: Tu, renameObject: yu, retimeSelectedKey: eb, selectKeyframe: qu, selectedKeyframe: Ke, selectedObject: Xt, selectObjectAnimation: $u, setKeyInterpolation: Ru, setKeyTangentMode: Zu, setObjectParent: Au, timelineKeyframes: Se, timelineObject: Me, toggleAutoKey: Gu, toggleObject: vu, updateCameraFromHud: Eu, updateCameraRotationFromHud: Cu, updateEditState: Xu, updateKeyVisualState: Ju, updateSelectedKey: tb, updateSelectedObject: Su, clamp: X, cloneCamera: fe, configureCore: Yn, defaultCamera: gr, sampleCamera: Ce, sampleObjectTransform: Oo, sanitizeState: vr, worldTransform: xr };
Object.assign(
  ti.prototype,
  db(yo),
  xb(yo),
...
function Zb(e) {
  ...
  const t = new ti(e);
  vo("director:constructor:complete", e), rp(t);
  try {
    t.agentBridge = mp(t, e, Je);
  } catch (m) {
  ...
  try {
    t.assetBrowser = Cp(t, {
      ...
      onAgentFirstOpen: async () => {
        try {
          const { createDirectorAgentPanel: m } = await import("./chunk-CTSNXC7T.js");
          t.agentPanel = m(t);
        } catch (m) {
  ...
  try {
    t.characterRuntime = Ap(t), t.rigMapper = Tp(t), t.poseEditor = Op(t), t.motionEditor = Pp(t);
  } catch (m) {
