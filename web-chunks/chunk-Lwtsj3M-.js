...
import { s as ce, a as de, d as ve, b as mt, c as fe, e as ut, l as Fe, n as Ae, f as $e, g as Y, m as he, I as le, D as _t, r as ht, p as Et, t as At, h as gt, i as pt, j as bt, w as Tt, k as ze, o as wt, q as yt, u as K } from "./chunk-uqYr4LOd.js";
import { s as It } from "./chunk-CrB6zFwD.js";
import { c as Nt, w as Rt, a as Te, W as Ot } from "./chunk-C7qk9Qm9.js";
...
const P = 1, Ke = 50, j = 120, H = 160, jt = Object.freeze(["perspective", "orthographic"]), h = Object.freeze({
...
function Lt(e, t) {
  ...
  switch (t?.type) {
    ...
    case I.OBJECT_SEARCH: {
      ...
      }, _ = (n.objects || []).filter(c), { offset: u, limit: f, end: m } = G(t, _.length);
      return N(e, {
        version: 1,
        type: t.type,
...
function cn(e, t) {
  ...
  switch (n) {
    ...
    case h.CAMERA_CREATE:
      if (e.id !== void 0 && A(e.id, "id", t, j), e.name !== void 0 && A(e.name, "name", t, H), e.camera !== void 0) {
    ...
    case h.CAMERA_DUPLICATE:
      A(e.cameraId, "cameraId", t, j), e.id !== void 0 && A(e.id, "id", t, j), e.name !== void 0 && A(e.name, "name", t, H);
      break;
    ...
    case h.CAMERA_RENAME:
      A(e.cameraId, "cameraId", t, j), A(e.name, "name", t, H);
      break;
    case h.OBJECT_CREATE:
      ...
      e.id !== void 0 && A(e.id, "id", t, j), e.name !== void 0 && A(e.name, "name", t, H), e.position !== void 0 && T(e.position, "position", t), e.rotation !== void 0 && T(e.rotation, "rotation", t);
      break;
    case h.OBJECT_DUPLICATE:
      A(e.objectId, "objectId", t, j), e.id !== void 0 && A(e.id, "id", t, j), e.name !== void 0 && A(e.name, "name", t, H), e.offset !== void 0 && T(e.offset, "offset", t);
      break;
    case h.OBJECT_DELETE:
      A(e.objectId, "objectId", t, j);
      break;
    case h.OBJECT_RENAME:
      A(e.objectId, "objectId", t, j), A(e.name, "name", t, H);
      break;
    ...
    case h.CAMERA_PATH_INSERT_KEY:
      e.cameraId !== void 0 && A(e.cameraId, "cameraId", t), R(e.leftFrame, "leftFrame", t), R(e.rightFrame, "rightFrame", t), e.t !== void 0 && W(e.t, "t", t);
      break;
...
function ot(e, t, n) {
  ...
  J(e, "out", Q(a.out, r)), J(e, "in", Q(a.in, r));
}
...
function mr(e, t, { prevKey: n = null, nextKey: r = null } = {}) {
  ...
  if (t === "corner") {
    const a = it(e, n, r);
    return _e(e), J(e, "out", a.out), J(e, "in", a.in), e;
  }
...
function wn(e, t, n, r, a) {
  const s = V(e, t, a), i = V(t, n, a), o = V(n, r, a), c = V(s, i, a), _ = V(i, o, a), u = V(c, _, a);
...
async function er(e, t) {
  return Te.open({
    ...
    opener: t,
    createSession: async () => {
      const n = ++e.workbenchGeneration, { openDirectorWorkbench: r, closeDirectorWorkbench: a } = await import("./chunk-lS781_EA.js").then((c) => c.e);
