...
const ho = () => import("./chunk-_Sx5xFra.js");
function vf(e, t) {
...
async function Lh(e) {
  ...
  try {
    let n = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-BO2jtdAf.js");
...
class Zs {
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-BO2jtdAf.js"));
    } catch (a) {
  ...
  try {
    t.assetBrowser = xp(t, {
      ...
      onAgentFirstOpen: async () => {
        try {
          const { createDirectorAgentPanel: m } = await import("./chunk-MYx0aT4y.js");
          t.agentPanel = m(t);
        } catch (m) {
