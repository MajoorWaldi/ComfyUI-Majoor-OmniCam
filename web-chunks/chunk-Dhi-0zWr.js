...
import { d as De, u as qe, l as je, S as Ue, b as Ve, p as Ge } from "./chunk-CGAuv3Kp.js";
import { M as We, E as Be } from "./chunk-CbqXtcpr.js";
import { v as h, x as be, T as _, y as He, z as Qe } from "./chunk-CUzpmyH7.js";
import { c as ve, S as ye, F as xe, a as D, e as ze, r as Ke, b as Ye, m as J, d as Z, f as Xe, s as Je, p as Ze, n as et, L as tt, g as rt } from "./chunk-BNfPhZWP.js";
import { w as ot } from "./chunk-D6j0koKF.js";
function at(t) {
...
class Wt extends EventTarget {
  constructor(e, { api: r, app: o } = {}) {
    super(), this.node = e, this.api = r, this.app = o, this.disposed = !1, this.workbench = null, this.shell = null, ze(e), Gt(e), Ke(e), this.extractMode = String(se(e, "extract_mode")?.value || "camera_track"), this.state = we(), this.result = { raw: null, refined: null }, this.rawSolve = null, this.landmarks = [], this.sourceKey = "", this.queuePromptId = "", this.pendingSourceResync = !1, this.reconstructionResult = null, this.previewDataUrl = null;
    const a = Ye(e);
...
async function Ht(t, { selectElement: e = null, statusElement: r = null, checkpointSelectElement: o = null } = {}) {
...
function ie(t, e) {
  if (!t) return;
  const r = t.querySelector('[data-role="reconstruction-triangle-budget"]'), o = t.querySelector('[data-role="reconstruction-edge-threshold"]'), a = Qt[e];
  r && (r.disabled = !!a, a && (r.value = String(a.triangle_budget))), o && (o.disabled = !!a, a && (o.value = String(a.discontinuity_threshold)));
}
const zt = { geometry: "depth_mesh", layout: "depth_mesh" }, Ce = /* @__PURE__ */ new Set(["blockout", "hybrid", "scan"]), Kt = /* @__PURE__ */ new Set(["vggt", "vggt_omega_research"]);
function _e(t) {
  if (!t) return {};
...
class ar {
  ...
  async ensurePreview() {
    return this.preview || this.disposed ? this.preview : (this.previewLoad ||= import("./chunk-ZrgL-nLn.js").then(({ TrackViewer: e }) => {
...
class fr {
  constructor({ onRefine: e, delay: r = hr, setTimer: o, clearTimer: a } = {}) {
    this.settings = { ...ue }, this.alignment = H(), this.onRefine = e || (() => {
  ...
  requestEstimatedUp() {
    return this.alignment = H(), this.update({ global_rotation_xyzw: null, estimate_up: !0 });
  }
  setSpikeAction(e, r) {
  ...
  reset() {
    return this.settings = { ...ue }, this.alignment = H(), this.schedule(), this.settings;
  }
  payload() {
...
`;
function N(t, e, { min: r = 0, max: o = 1, step: a = 0.01, value: n = 0 } = {}) {
      ...
      <div class="oc-columns">
        <div class="oc-card">
          ...
          <div class="oc-sliders">
            ${N("position-smoothing", "Position smooth", { value: 0.15 })}
            ${N("motion-scale", "Motion scale", { min: 0.01, max: 10, step: 0.01, value: 1 })}
          </div>
          <div class="oc-inline">
          ...
          <details class="oc-details"><summary>Advanced cleanup</summary>
            <div class="oc-sliders">
              ${N("rotation-smoothing", "Rotation smooth", { value: 0.1 })}
              ${N("position-tolerance", "Key reduction", { min: 0, max: 0.5, step: 1e-3, value: 0.01 })}
              ${N("align-pitch", "Pitch", { min: -180, max: 180, step: 0.5, value: 0 })}
              ${N("align-yaw", "Yaw", { min: -180, max: 180, step: 0.5, value: 0 })}
              ${N("align-roll", "Roll", { min: -180, max: 180, step: 0.5, value: 0 })}
            </div>
            <div class="oc-inline">
...
function Hr(t, { y: e, height: r, width: o, frameCount: a, colorAt: n, style: s }) {
...
function ro(t, e) {
  const r = Q(t?.anomalies), o = Q(Object.values(Pe(e)).flat()), a = o.length ? o : Q(e?.keyframes);
  return { anomalies: r, solved: a };
}
function z(t, e, { anomalies: r, solved: o }) {
...
function ao(t, {
  ...
  const n = (u) => t?.querySelector?.(to[u]) || null, s = () => r() || {}, i = () => ro(s(), o()), c = (u) => K(s()) < 1 ? !1 : (e?.seek?.(u, "transport"), !0), l = (u) => {
    const m = z(Number(s().frame) || 0, u, i());
    return m === null ? !1 : c(m);
  }, d = {
    "first-frame": () => c(0),
    "previous-key": () => l(-1),
  ...
  function f() {
    ...
    p && (p.disabled = z(u, -1, m) === null);
    const g = n("next-key");
    g && (g.disabled = z(u, 1, m) === null);
...
function ho(t) {
  return import("./chunk-ZrgL-nLn.js").then(({ TrackViewer: e }) => (t.viewerLoad = null, t.disposed || t.viewer || (t.viewer = new e(t.$("track-canvas")), t.pushTracksToViewer()), t.viewer)).catch((e) => (t.viewerLoad = null, console.warn("OmniCam track viewer unavailable", e), null));
}
function me(t) {
  const e = t.$("frame");
  ...
  const a = Lr(t.state.quality, t.state.frame), n = zr(t.state.quality, t.currentHealth, t.state.frame);
...
class Oe {
  ...
  render() {
    ...
    if (i && c && l && d && f) {
      ...
      const E = this.state.solveState === "TRACKING", w = this.state.solveState === "SOLVING", C = this.state.solveState === "FAILED", T = this.state.solveState === "COMPLETED";
      c.dataset.state = E ? "active" : T || w || this.rawSolve ? "completed" : C && !this.rawSolve ? "error" : "pending", l.dataset.state = w ? "active" : T ? "completed" : C && this.rawSolve ? "error" : "pending";
      const re = n === "APPLIED";
      d.dataset.state = re ? "completed" : T ? "active" : "pending", f.dataset.state = re ? "completed" : "pending";
    }
    ...
    b && (b.textContent = String(this.sourceViewer.fps || 24)), uo(this.$("anomalies"), this.state.anomalies, {
      ...
      onAction: (v, E) => {
        ...
        for (let T = w; T <= C; T += 1) this.refine.setSpikeAction(T, E);
        this.render();
      }
  ...
  setExtractMode(e) {
    ...
    const i = fo(this.node, "extract_mode");
  ...
  dispose() {
    this.reconstruction?.dispose(), this.disposed = !0, Qe(), this.requests.dispose(), this.refine.dispose(), this.coordinator.dispose(), this.sourceViewer.dispose(), this.overlay.dispose(), this.diagnostics.dispose(), this.viewer?.dispose(), this.viewer = null, this.viewerLoad = null, this.events.dispose();
  }
}
for (const t of mo)
...
function Co(t) {
  ...
  return t.onRemoved = function(...l) {
    s(), bo(r), e.dispose(), c?.apply(this, l);
  }, e;
}
export {
  Oe as ExtractorUI,
  Co as attachExtractor,
  bo as closeExtractorWorkbench,
  go as openExtractorWorkbench
};
