import { c as E, a as A, bg as P, u as h, G as q, b6 as _, s as J, b7 as N, bM as G } from "./chunk-CNyw3Ryk.js";
import { a as X } from "./chunk-DiJho4LI.js";
...
`, D = 24, O = 5, $ = 150, B = Math.PI / 180;
function H(e, t, o) {
  return Math.min(o, Math.max(t, e));
}
function ee(e, t = D) {
  const o = H(Number(e) || 0, O, $);
  return t / (2 * Math.tan(o * B / 2));
}
function te(e, t = D) {
  const o = Math.max(1e-6, Number(e) || 0), a = 2 * Math.atan(t / (2 * o)) / B;
  return H(a, O, $);
}
function oe(e) {
  const t = ee(e);
...
function se(e, t, { label: o = "Extracted Camera" } = {}) {
  ...
  if (e.state.cameras.push({ id: l, name: s, color: m, camera: E(d[0].camera), keyframes: d }), Number.isFinite(Number(t.duration_frames))) {
...
function ze(e) {
  ...
  e.state.cameras.push({
    ...
    color: l,
    camera: r,
    keyframes: [{ frame: 0, camera: E(r), interpolation: i }]
