...
ee.registerExtension({
  ...
  async nodeCreated(e) {
    ...
    await Dt(e, async () => {
      ...
      const { attachDirector: o } = await import("./chunk-Cdi2y5Pm.js").then((n) => n.g);
...
ee.registerExtension({
  ...
  async nodeCreated(e) {
    if (Xe(e) !== mt) return;
    const t = !le, a = t ? null : jt(e);
    await Dt(e, async () => (await import("./chunk-BzJlop5B.js")).attachExtractor), e.__majoorOmniCamExtractor && At(e, mt, t, a?.());
  }
});
ee.registerExtension({
  ...
  async nodeCreated(e) {
    if (Xe(e) !== dt) return;
    const t = !le, a = t ? null : jt(e);
    await Dt(e, async () => (await import("./chunk-DxU-UlBa.js")).attachMonitor), e.__majoorOmniCamMonitor && At(e, dt, t, a?.());
  }
});
export {
  Yi as $,
