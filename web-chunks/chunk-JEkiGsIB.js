...
import { d as $e, u as Pe, l as Le, S as Fe, b as Oe, p as De } from "./chunk-DjvDVpt_.js";
import { M as qe, E as je } from "./chunk-CbqXtcpr.js";
import { a as f, A as fe, bG as Ve, bj as Ue } from "./chunk-CEInYxLm.js";
import { h as me, N as ge, O as be, P as L, Q as z, R as K, T as Ge, L as Be, U as We, V as He, w as Qe, W as ze, X as Ke, Y as Ye, Z as Xe, _ as Je } from "./chunk-Sxo1EvMO.js";
function Ze(t) {
...
async function At(t, { selectElement: e = null, statusElement: r = null, checkpointSelectElement: o = null } = {}) {
...
function te(t, e) {
  if (!t) return;
  const r = t.querySelector('[data-role="reconstruction-triangle-budget"]'), o = t.querySelector('[data-role="reconstruction-edge-threshold"]'), a = Mt[e];
...
class Vt {
  ...
  async ensurePreview() {
    return this.preview || this.disposed ? this.preview : (this.previewLoad ||= import("./chunk-D7m0K-5a.js").then(({ TrackViewer: e }) => {
...
const Nr = {
  ...
  { key: "roll", label: "Roll" }
], Tr = 18, Ar = 9, ce = 2, Te = 78, Mr = { solve: "SOLVE HEALTH" }, O = {
  bands: ["solve"],
  labels: !0,
  labelWidth: Te,
  bandHeight: Ar,
...
function Ae(t = D, e = O) {
  ...
  for (const n of r.bands || [])
    o.length && (a += r.bandGap), o.push({
      kind: "band",
      key: n,
      label: Mr[n] || String(n).toUpperCase(),
      top: a,
      height: r.bandHeight
    }), a += r.bandHeight;
  for (const n of t)
...
function Br(t, {
  ...
  const l = Math.max(1, Number(i) || Number(e?.duration_frames) || 1), d = Me(e, s), { rows: p, style: u } = Ae(s, c), m = {
    total: l,
...
function zr(t, e) {
  const r = G(t?.anomalies), o = G(Object.values(Me(e)).flat()), a = o.length ? o : G(e?.keyframes);
...
function ao(t) {
  return import("./chunk-D7m0K-5a.js").then(({ TrackViewer: e }) => (t.viewerLoad = null, t.disposed || t.viewer || (t.viewer = new e(t.$("track-canvas")), t.pushTracksToViewer()), t.viewer)).catch((e) => (t.viewerLoad = null, console.warn("OmniCam track viewer unavailable", e), null));
}
function de(t) {
  const e = t.$("frame");
...
class so {
  ...
  applyRefined() {
    try {
      ...
      const r = e instanceof A ? e.message : String(e?.message || e);
