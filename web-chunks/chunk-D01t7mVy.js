...
const So = () => import("./chunk-BDwvGFLq.js");
function Kh(e, t) {
...
async function ob(e) {
  ...
  try {
    let n = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-CjsNZbC-.js");
...
class Li {
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-CjsNZbC-.js"));
    } catch (a) {
  ...
  try {
    t.assetBrowser = Ff(t, {
      ...
      onAgentFirstOpen: async () => {
        if (mr())
          try {
            const { createDirectorAgentPanel: m } = await import("./chunk-Bo02C2Xb.js");
            t.agentPanel = m(t);
          } catch (m) {
