import { a, V as Q, bw as W, bx as h } from "./chunk-BjmIgymG.js";
...
function fe(e, t = {}) {
  ...
  function M(n) {
    ...
    if (r) {
      ...
      if (r.action === "credential-save") return void Y();
      if (r.action === "model-refresh") return void L();
    }
  }
  return f?.addEventListener("click", M), g?.addEventListener("change", H), c?.addEventListener("input", B), O(), x(), L(), {
    get state() {
      return p;
    },
    dispose() {
