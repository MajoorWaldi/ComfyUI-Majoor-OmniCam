import { app as Kr } from "../../scripts/app.js";
import { api as We } from "../../scripts/api.js";
import { a as xe, c as Z, z as fe, v as r, A as Dr, B as Mo, C as Ie, e as le, E as ao, F as ts, G as Ao, H as Nr, J as as, K as os, L as rs, M as ns, N as xo, x as Xo, O as Rr, P as wo, Q as qr, R as Br, S as Wr, T as Vr, j as Hr, U as ko, V as co, W as Yo, X as Zo, Y as Ur, o as Jo, Z as ss, _ as is, $ as cs, a0 as ls, a1 as ds, h as ye, p as Gr, i as Xr, a2 as Qo, f as Ee, a3 as ms, a4 as Yr, t as ps, a5 as fs, a6 as To, a7 as hs, a8 as bs, q as us, a9 as gs, aa as ys, ab as vs, ac as Po, ad as xs, ae as ws, af as ks, ag as Ss, ah as js, ai as Cs, aj as _s, ak as Es, al as $s, am as Ms, an as As, ao as Ts, ap as Ps, aq as Is, ar as zs, as as Fs, at as Ls, au as Os, av as Ks, aw as Ds, ax as Ns, ay as Rs, az as qs, aA as Bs, aB as Ws, aC as Vs, aD as Hs, aE as Us, aF as Gs, aG as Xs, aH as Ys, aI as Zs, aJ as Js, aK as Qs, aL as ei, aM as ti, aN as ai, aO as oi, aP as ri, aQ as ni, aR as si, aS as ii, aT as ci, l as Be, aU as li, aV as lo, aW as di, aX as mi, aY as pi, aZ as fi, a_ as hi, a$ as Pe, b0 as bi, b1 as Zr, b2 as Io, b3 as ui, b4 as gi, b5 as yi, b6 as Jr, b7 as Ke, b8 as vi, b9 as xi, ba as er, bb as zo, bc as wi, bd as Qr, be as ki, bf as Si, bg as ji, b as en, r as Ci, bh as _i, bi as Ei, bj as $i, bk as Mi, y as Ai, bl as Ti, bm as Pi, bn as Ii, bo as tn, bp as zi, bq as Fi, br as Li, bs as Oi, bt as Ki, bu as Di, bv as Ni, bw as Ri, bx as qi, by as Bi, bz as Wi, bA as Vi, bB as Hi, bC as Ui, bD as Gi, bE as Xi, bF as Yi, bG as Zi, bH as Ji, s as Qi } from "./chunk-D3iZD33H.js";
import { n as ec, p as tc, a as ac, s as mo, S as an, c as oc, C as tr, b as rc, i as nc, w as sc, d as ic, U as je, m as cc, h as Ue, e as lc, f as dc, g as mc, j as pc, r as fc, k as hc, l as bc, E as uc } from "./chunk-CGARWOk9.js";
import { L as gc, a as yc, p as kt, f as Fo, b as vc, S as xc, c as ar, d as wc, e as kc, r as Sc, g as jc, n as Cc, C as or, h as St, o as on, s as _c, i as Ec, j as $c, k as rn, l as Mc, m as Ac, q as Tc, t as Pc, u as Ic, v as zc, w as Fc, x as Lc, y as Oc, z as Kc, A as Dc, B as Nc } from "./chunk-CsmXo7DB.js";
import { S as Rc, b as qc, p as Bc } from "./chunk-DiX7WiXt.js";
import { T as Wc } from "./chunk-__IQ4xkd.js";
import { T as Vc, R as Hc } from "./vendor-three-BQUrLQkn.js";
import { b as Uc, p as nn, a as So, c as jo, d as Gc, r as Xc, s as Yc, e as Zc } from "./chunk-CZ0GcHaY.js";
import { a as Jc } from "./chunk-CTXwjaoT.js";
import { l as Qc, u as el } from "./chunk-eq1tqQ9i.js";
function ut(e, t = 0) {
  return Math.sin(e * 1.7 + t * 3.1) * 0.5 + Math.sin(e * 3.3 + t * 5.7) * 0.3 + Math.sin(e * 7.9 + t * 11.3) * 0.2;
}
function tl(e, { type: t = "handheld_subtle", intensity: a = 1, duration_frames: o = null, subdivide: n = !0 } = {}) {
  ...
  return [...u].sort((g, v) => g - v).map((g) => {
    const v = xe(b, g), j = ut(g * p, 1) * l, x = ut(g * p, 2) * l, M = ut(g * p, 3) * l * 0.5, P = ut(g * p, 4) * m, D = ut(g * p, 5) * (m * 0.35), F = [...v.position], U = [...v.target];
    return F[0] += j, F[1] += x, F[2] += M, U[0] += j * 0.35, U[1] += x * 0.35, {
      frame: g,
      camera: {
        ...v,
        position: F,
...
function al(e, { duration_frames: t = 120, target: a = [0, 1.5, 0], radius: o = 6, height: n = 3.5 } = {}) {
...
const sn = 1e-4;
function ol(e, t) {
  return !Array.isArray(e) || !Array.isArray(t) ? e !== t : e.some((a, o) => Math.abs(Number(a) - Number(t[o])) > sn);
}
function rr(e, t) {
  return Math.abs(Number(e) - Number(t)) > sn;
}
const cn = [
  {
    id: "camera",
  ...
  },
  {
    ...
    label: "Look At",
    color: "#f0a742",
    changed: (e, t) => ol(e?.target, t?.target),
    read: (e) => e?.target
  },
  {
    id: "focal_length",
...
function nl(e, t = null) {
  return cn.filter((a) => !t || t.has(a.id)).map((a) => ({
    id: a.id,
    label: a.label,
    color: a.color,
    frames: rl(e, a)
...
function ln(e) {
  ...
  for (const a of [".oc-playhead-head", '[data-role="dope-playhead"]', ".oc-gdope-playhead", ".oc-sequence-playhead"])
    for (const o of e.root.querySelectorAll(a)) sl(o, t);
}
function il(e, t, a) {
...
function dn(e) {
  ...
  a.delete("camera");
  const o = e.timelineKeyframes() || [], n = nl(o, a), s = ll(e, n);
  if (t.dataset.signature !== s) {
    t.dataset.signature = s, t.replaceChildren();
    const i = (c) => fe(e, c);
    for (const c of n) {
      const l = document.createElement("div");
      l.className = "oc-dope-row", l.dataset.channel = c.id, l.style.setProperty("--channel-color", c.color), il(l, c.frames, i), cl(e, l, c, o, i), t.appendChild(l);
    }
  }
...
const po = [1, 2, 5, 10, 20, 25, 50, 100, 200, 250, 500, 1e3, 2e3, 5e3], mn = 46, nr = 5, pn = 640;
function fn(e, t) {
  const a = t > 0 ? t : pn, o = Math.max(2, Math.floor(a / mn)), n = Math.max(1e-6, e / o);
  return po.find((s) => s >= n) ?? po[po.length - 1];
}
function dl(e, t) {
  const a = Math.max(1, e.state.duration_frames - 1), o = Z(Number(e.timelineZoom) || 1, 0.1, 50), n = Number(e.timelinePan) || 0, s = a / o, i = fn(s, t), l = (i >= nr ? i / nr : 0) || i, m = [], p = Math.max(0, Math.floor(n / l) * l);
  for (let d = p; d <= a + 1e-6; d += l) {
    const h = Math.round(d), b = fe(e, h);
    if (!(b < -1)) {
      if (b > 101) break;
...
function ml(e) {
  return e.clientWidth || e.parentElement?.clientWidth || pn;
}
function hn(e) {
  const t = e.root.querySelector('[data-role="ruler"]');
  if (!t) return;
  t.replaceChildren();
  for (const o of dl(e, ml(t))) {
...
function pl(e, t) {
  ...
  a.addEventListener("pointerup", i, { signal: t }), a.addEventListener("pointercancel", i, { signal: t }), a.addEventListener("wheel", (c) => Dr(e, c), { passive: !1, signal: t });
}
...
function hl(e, t = 5) {
  ...
  return (fl.find((s) => s >= n) ?? 10) * o;
}
function bl(e, t) {
  const a = Math.max(0, Math.min(4, Math.ceil(-Math.log10(t))));
  return e.toFixed(a);
}
function ul(e, { left: t, right: a, top: o, width: n, graphWidth: s, graphHeight: i, height: c, timeMin: l, timeMax: m, totalDuration: p, xFor: f, frame: d }) {
  const h = fn(m - l, s);
...
function gl(e, { left: t, right: a, top: o, width: n, graphHeight: s, minimum: i, maximum: c, yFor: l }) {
  const m = hl(c - i, 4);
  e.strokeStyle = "#222228", e.lineWidth = 1, e.fillStyle = "#6e727a";
  for (let p = Math.ceil(i / m) * m; p <= c; p += m) {
    const f = l(p);
    f < o - 1 || f > o + s + 1 || (e.beginPath(), e.moveTo(t, f), e.lineTo(n - a, f), e.stroke(), e.fillText(bl(p, m), 4, f + 3));
  }
}
function Lo(e, t) {
...
function vl(e, t) {
  const a = t.currentTarget, { x: o, y: n } = Lo(a, t);
  ...
  if (e.curveHover = null, t.preventDefault(), t.stopPropagation(), e.curveDrag.historyCheckpointed || (e.checkpoint?.(e.curveDrag.handle ? "Edit curve tangent" : "Edit curve"), e.curveDrag.historyCheckpointed = !0), e.curveDrag.handle) {
    ...
    if (h === "in") {
      if (x.in_x = Z((o - y) / Math.max(1, b), -0.99, -0.01), x.in_y = (g - n) * u, j === "aligned") {
        const M = Math.hypot(x.in_x, x.in_y) || 1e-6, P = Math.hypot(e.curveDrag.startHandles.out_x, e.curveDrag.startHandles.out_y) || 1e-6;
        x.out_x = -x.in_x / M * P, x.out_y = -x.in_y / M * P;
      }
    } else if (x.out_x = Z((o - y) / Math.max(1, b), 0.01, 0.99), x.out_y = (g - n) * u, j === "aligned") {
      const M = Math.hypot(x.out_x, x.out_y) || 1e-6, P = Math.hypot(e.curveDrag.startHandles.in_x, e.curveDrag.startHandles.in_y) || 1e-6;
      x.in_x = -x.out_x / M * P, x.in_y = -x.out_y / M * P;
    }
...
function bn(e, { selectedOnly: t = !1 } = {}) {
  const a = Math.max(1, (e.state?.duration_frames ?? 120) - 1), o = e.timelineKeyframes() || [], n = e.timelineObject(), s = et(e), i = e.selectedKeyFrames?.size ? [...e.selectedKeyFrames] : e.selectedKeyFrame != null ? [e.selectedKeyFrame] : [], c = i.length > 0, l = t || c && i.length < o.length ? o.filter((u) => i.includes(u.frame)) : o;
  if (!l.length) {
  ...
  if (h.length > 0) {
    const u = Math.min(...h), y = Math.max(...h), g = Math.max(1e-4, y - u), v = (u + y) / 2, j = (V) => n ? ao(n, V) : xe(e.state, V), x = [], M = Math.max(1, Math.floor(a / 40));
    for (let V = 0; V <= a; V += M) {
      const Q = j(V);
      for (const k of s) {
        const _ = k.get(Q);
...
function Ml(e) {
  ...
  const i = e.timelineObject(), c = e.timelineKeyframes(), l = et(e), m = 44, p = 14, f = 16, d = 22, h = Math.max(1, a - m - p), b = Math.max(1, o - f - d), u = Math.max(1, e.state.duration_frames - 1), y = Z(Number(e.curveZoomX) || 1, 0.1, 50), g = Number(e.curvePanX) || 0, v = u / y, j = g, x = g + v, M = [], P = Math.max(1, Math.ceil(v / Math.max(80, h))), D = ($) => i ? ao(i, $) : xe(e.state, $);
  for (let $ = 0; $ <= u; $ += P) M.push({ frame: $, value: D($) });
  M[M.length - 1]?.frame !== u && M.push({ frame: u, value: D(u) });
  const F = M.flatMap(($) => l.map((W) => W.get($.value)));
  let U = Math.min(...F), B = Math.max(...F);
  (!Number.isFinite(U) || !Number.isFinite(B)) && (U = -1, B = 1), Math.abs(B - U) < 1e-6 && (U -= 1, B += 1);
  const V = (B - U) * 0.1;
  U -= V, B += V;
  const Q = Z(Number(e.curveZoom) || 1, 0.1, 50), k = (B + U) / 2 + (Number(e.curvePanY) || 0), _ = (B - U) / Q;
  U = k - _ / 2, B = k + _ / 2;
  const z = ($) => m + ($ - j) / Math.max(1e-6, x - j) * h, N = ($) => f + b * (B - $) / Math.max(1e-6, B - U);
  if (s.fillStyle = "#111114", s.fillRect(0, 0, a, o), s.strokeStyle = "#222228", s.lineWidth = 1, s.font = "9px system-ui, -apple-system, sans-serif", s.fillStyle = "#6e727a", ul(s, {
    left: m,
    right: p,
    top: f,
    width: a,
    ...
    xFor: z,
    frame: e.frame
  }), gl(s, { left: m, right: p, top: f, width: a, graphHeight: b, minimum: U, maximum: B, yFor: N }), U <= 0 && B >= 0) {
    const $ = N(0);
    s.strokeStyle = "#383842", s.lineWidth = 1.2, s.beginPath(), s.moveTo(m, $), s.lineTo(a - p, $), s.stroke();
  }
  e.curveHitPoints = [];
  for (const $ of l) {
    s.strokeStyle = $.color, s.lineWidth = 2, s.beginPath();
    let W = !1;
    M.forEach((C) => {
      const R = z(C.frame), G = N($.get(C.value));
      R >= m - 50 && R <= a - p + 50 && (W ? s.lineTo(R, G) : (s.moveTo(R, G), W = !0));
    }), s.stroke();
    for (const C of c) {
      const R = i ? C.transform : C.camera, G = z(C.frame), ae = N($.get(R)), oe = C.frame === e.selectedKeyFrame || e.selectedKeyFrames?.has(C.frame);
      oe && (s.fillStyle = "rgba(242, 208, 107, 0.35)", s.beginPath(), s.arc(G, ae, 8.5, 0, Math.PI * 2), s.fill()), s.fillStyle = oe ? "#ffd75e" : $.color, s.strokeStyle = "#0d0d10", s.lineWidth = 1.6, s.beginPath(), s.arc(G, ae, oe ? 5.2 : 3.8, 0, Math.PI * 2), s.fill(), s.stroke(), e.curveHitPoints.push({
        x: G,
        y: ae,
        key: C,
        channel: $,
    ...
    if (e.showCurveHandles)
      for (let C = 0; C < c.length; C++) {
        ...
        const oe = i ? R.transform || i : R.camera || R, ee = z(R.frame), se = N($.get(oe)), pe = c[C - 1], de = c[C + 1], he = Math.max(1, R.frame - (pe?.frame ?? R.frame - 1)), be = Math.max(1, (de?.frame ?? R.frame + 1) - R.frame), O = ts(
          R,
          $.id,
          pe,
          de,
          (re) => $.get(i ? re.transform || i : re.camera || R)
        ), H = (B - U) / Math.max(1, b), ie = h * be / Math.max(1, v), ce = h * he / Math.max(1, v), me = [];
        (pe || C > 0) && me.push({ side: "in", x: ee + O.in_x * ce, y: se - O.in_y / H }), (de || C < c.length - 1 || c.length === 1) && me.push({ side: "out", x: ee + O.out_x * ie, y: se - O.out_y / H });
        for (const re of me) {
          if (s.strokeStyle = $.color, s.lineWidth = G ? 1.5 : 1, s.beginPath(), s.moveTo(ee, se), s.lineTo(re.x, re.y), s.stroke(), s.fillStyle = G ? "#2a2233" : "#171720", s.strokeStyle = G ? "#ffd75e" : $.color, s.lineWidth = G ? 2 : 1.2, s.beginPath(), re.side === "in")
            s.arc(re.x, re.y, G ? 5 : 3.8, 0, Math.PI * 2);
          else {
            const we = G ? 4.5 : 3.2;
            s.rect(re.x - we, re.y - we, we * 2, we * 2);
          }
  ...
  if (e.curveBoxSelect) {
    const $ = Math.min(e.curveBoxSelect.startX, e.curveBoxSelect.currentX), W = Math.min(e.curveBoxSelect.startY, e.curveBoxSelect.currentY), C = Math.abs(e.curveBoxSelect.currentX - e.curveBoxSelect.startX), R = Math.abs(e.curveBoxSelect.currentY - e.curveBoxSelect.startY);
    s.fillStyle = "rgba(56, 189, 248, 0.15)", s.fillRect($, W, C, R), s.strokeStyle = "#38bdf8", s.lineWidth = 1, s.setLineDash([4, 4]), s.strokeRect($, W, C, R), s.setLineDash([]);
  }
  const q = z(e.frame);
  if (q >= m && q <= a - p && (s.strokeStyle = "#a78bfa", s.lineWidth = 1.5, s.beginPath(), s.moveTo(q, f), s.lineTo(q, f + b), s.stroke(), s.fillStyle = "#a78bfa", s.beginPath(), s.moveTo(q - 4, f), s.lineTo(q + 4, f), s.lineTo(q, f + 6), s.closePath(), s.fill()), e.curveDrag || e.curveHover) {
    ...
    if (e.curveDrag)
      if (e.curveDrag.handle) {
        ...
        $ = `F${e.curveDrag.key.frame} · ${e.curveDrag.channel.name} (${C})`, W = "Tangent edit";
        ...
        $ = `${e.curveDrag.group.length} keys · ΔF: ${ae} · ΔVal: ${oe}`, W = `${e.curveDrag.channel.name}: ${R.toFixed(2)}`;
      } else {
        const C = e.curveDrag.key.frame - e.curveDrag.startFrame, R = e.curveDrag.channel.get(e.curveDrag.object ? e.curveDrag.key.transform : e.curveDrag.key.camera), G = R - e.curveDrag.startValue, ae = C >= 0 ? `+${C}` : `${C}`, oe = G >= 0 ? `+${G.toFixed(2)}` : `${G.toFixed(2)}`;
        $ = `F${e.curveDrag.key.frame} (${ae}) · ${e.curveDrag.channel.name}: ${R.toFixed(2)} (${oe})`;
      }
    else if (e.curveHover)
      if (e.curveHover.channelName) {
        const C = Number.isFinite(e.curveHover.value) ? e.curveHover.value.toFixed(2) : "";
        $ = `F${e.curveHover.frame} · ${e.curveHover.channelName}: ${C}`, e.curveHover.isHandle && (W = `Handle ${e.curveHover.handleSide}`);
      } else
        $ = `Frame ${e.curveHover.frame}`;
    if ($) {
      s.save(), s.font = "11px system-ui, -apple-system, sans-serif";
      const C = s.measureText($), R = W ? s.measureText(W) : { width: 0 }, G = Math.max(C.width, R.width) + 16, ae = W ? 32 : 20, oe = a - p - G - 6, ee = f + 6;
      s.fillStyle = "rgba(18, 18, 24, 0.88)", s.strokeStyle = "#38384a", s.lineWidth = 1, s.beginPath(), s.roundRect ? s.roundRect(oe, ee, G, ae, 4) : s.rect(oe, ee, G, ae), s.fill(), s.stroke(), s.fillStyle = "#e2e8f0", s.fillText($, oe + 8, ee + (W ? 13 : 14)), W && (s.fillStyle = "#94a3b8", s.font = "9.5px system-ui, -apple-system, sans-serif", s.fillText(W, oe + 8, ee + 26)), s.restore();
    }
  }
  for (const $ of e.root.querySelectorAll("[data-tangent-mode]")) {
    ...
    $.classList.toggle("active", $.dataset.tangentMode === C);
  }
...
function sr(e, { filter: t, label: a, color: o, title: n }) {
...
function un(e) {
  ...
  if (!t) return;
  const a = e.timelineObject(), o = a ? a.name || a.type : e.activeCameraTrack().name, n = Al(e), s = `${o}\0${n.map((c) => `${c.id}:${c.color}`).join("|")}`;
  if (t.dataset.signature !== s) {
    t.dataset.signature = s, t.replaceChildren();
    const c = document.createElement("span");
    c.className = "oc-graph-legend-title", c.textContent = o, t.appendChild(c), t.appendChild(sr(e, {
      filter: "all",
      label: r("All"),
      color: null,
...
function Tl(e) {
  e.checkpoint("Auto-split shots"), e.state.sequence = {
    ...
    enabled: !0,
    cuts: rs(e.state)
  }, Je(e), e.setStatus(r("Split into {count} shots").replace("{count}", String(e.state.sequence.cuts.length)));
}
...
function Pl(e, t) {
  ...
  if (a.appendChild(Ra(
    ...
    () => {
      e.checkpoint("Split shot"), Nr(e.state, e.frame, null) ? Je(e) : e.setStatus(r("Move the playhead inside a shot first"));
    },
    { disabled: o }
  )), a.appendChild(Ra(
    r("Clear edit"),
    ...
    () => {
      e.checkpoint("Clear edit"), e.state.sequence = { ...e.state.sequence, enabled: !1, cuts: [] }, Je(e), e.setStatus(r("Multi-camera edit cleared"));
    }
  ))), a.appendChild(Ra(
...
function zl(e, t, a, o, n) {
  t.preventDefault(), t.stopPropagation();
  const { camera: s } = gn(e, a.camera_id);
  e.contextMenu?.show(t, s?.name || r("Shot"), [
    ...e.state.cameras.map((i) => ({
      ...
      run: () => {
        e.checkpoint("Change shot camera"), e.state.sequence.cuts[o].camera_id = i.id, Je(e);
      }
    })),
    null,
    {
      ...
      run: () => {
        e.checkpoint("Split shot"), Nr(e.state, e.frame, null) && Je(e);
      }
    },
    {
      label: r("Remove shot"),
      ...
      disabled: n === 1,
      run: () => {
        e.checkpoint("Remove shot"), as(e.state, o) && Je(e);
      }
    }
  ]);
}
function Fl(e, t, a, o) {
  const { camera: n, color: s } = gn(e, t.camera_id), i = document.createElement("div");
  ...
  if (c.className = "oc-sequence-name", c.textContent = n?.name || t.camera_id, i.appendChild(c), a > 0) {
    ...
    l.className = "oc-sequence-handle", l.title = r("Drag to trim the cut"), l.addEventListener("pointerdown", (m) => Il(e, m, l, o, a)), i.appendChild(l);
  }
  return i.addEventListener("contextmenu", (l) => zl(e, l, t, a, o.__cutCount)), i.addEventListener("pointerdown", () => {
...
function vn(e, t) {
  ...
  if (s.className = "oc-sequence-lane", s.dataset.role = "sequence-lane", s.setAttribute("aria-label", r("Multi-camera edit")), o.length)
    for (const [c, l] of o.entries()) {
      const m = fe(e, l.start);
      fe(e, l.end + 1) < -5 || m > 105 || s.appendChild(Fl(e, l, c, n));
    }
  else {
    const c = document.createElement("span");
  ...
  n.appendChild(s), n.appendChild(Ll(e));
  const i = document.createElement("span");
  i.className = "oc-sequence-playhead", i.style.left = `${fe(e, e.frame)}%`, n.appendChild(i), t.appendChild(n);
}
const Ol = ['[data-act="curve-zoom-in"]', '[data-act="curve-zoom-out"]', '[data-act="curve-fit"]', '[data-act="curve-handles"]'], cr = { curves: "Graph", dope: "Timeline", sequence: "Sequence" };
function lr(e, t) {
  const a = t in cr ? t : "dope";
  e.graphTab = a;
  for (const l of e.root.querySelectorAll("[data-graph-tab]")) {
    const m = l.dataset.graphTab === a;
    l.classList.toggle("active", m), l.setAttribute("aria-pressed", String(m));
  }
  ...
  for (const l of Ol) {
    const m = e.root.querySelector(l);
    m && (m.disabled = a !== "curves");
  }
  a === "sequence" ? (vn(e, s), s?.focus?.({ preventScroll: !0 })) : a === "curves" && e.drawCurveEditor(), e.setStatus(r(cr[a]));
}
function Kl(e) {
  e.graphTab === "sequence" && vn(e, e.root.querySelector('[data-role="graph-sequence"]'));
}
function Dl(e, t) {
  ...
  a && a.addEventListener("keydown", (o) => {
    if (o.key === "ArrowLeft" || o.key === "ArrowRight") {
      ...
      if (s >= 0 && n.length > 1) {
        ...
        n[i].focus(), lr(e, n[i].dataset.graphTab);
      }
    }
  }, { signal: t });
  for (const o of e.root.querySelectorAll("[data-graph-tab]"))
    o.addEventListener("click", (n) => {
      n.preventDefault(), n.stopPropagation(), lr(e, o.dataset.graphTab);
    }, { signal: t });
}
let dr = /* @__PURE__ */ new WeakSet();
function Nl(e) {
  if (!e) return "";
...
function Rl(e) {
  ...
  if (!t || !a) return;
  const o = ec(e.state?.metadata, e.state?.duration_frames), n = o.some((c) => c.state !== "unknown");
  ...
  if (dr.has(a)) return;
  dr.add(a), a.addEventListener("pointerdown", (c) => {
...
function ql(e) {
  ...
  if (e.audioWaveformPeaks && e.audioWaveformPeaks.length) {
    ...
    const j = v.getContext("2d"), x = e.audioWaveformPeaks, M = v.width, P = v.height, D = P / 2;
    j.fillStyle = "#f2d06b";
    for (let F = 0; F < x.length; F++) {
      const B = (F / (x.length - 1) * n - l) / Math.max(1e-6, c) * M;
      if (B >= -5 && B <= M + 5) {
        const V = x[F] * (P * 0.85);
        j.fillRect(B, D - V / 2, Math.max(1, M / x.length * s - 0.5), V);
      }
    }
    t.appendChild(v);
  }
  if (e.state.playback_range) {
    ...
    const j = fe(e, e.state.playback_range[0]), x = fe(e, e.state.playback_range[1]);
    v.style.left = `${j}%`, v.style.width = `${Math.max(0, x - j)}%`, t.appendChild(v);
  }
  ns(e, t);
  for (const v of e.state.markers || []) {
    const j = fe(e, v.frame);
  ...
  if (o.length > 1) {
    const v = fe(e, o[0].frame), j = fe(e, o[o.length - 1].frame), x = document.createElement("span");
  ...
  for (const v of o) {
    ...
    M.className = "key-label", M.textContent = String(v.frame), x.appendChild(M), x.addEventListener("pointerdown", (P) => {
  ...
  if (f) {
    ...
    const x = o.filter((M) => M.frame > e.state.duration_frames - 1).length;
    if (x) {
      const M = document.createElement("span");
      M.className = "oc-dormant-keys", M.textContent = ` · ${x} beyond end`, M.title = r("Keys past the end of the timeline are kept. Lengthen the shot to reach them again."), f.append(M);
    }
  }
  ...
  if (b) {
    ...
    for (const v of e.state.cameras) {
      ...
      const M = document.createElement("span");
      M.textContent = `${v.name} · ${v.keyframes.length} key${v.keyframes.length === 1 ? "" : "s"}${v.id === e.state.playblast_camera_id ? " · PLAYBLAST" : ""}`, j.append(x, M), j.addEventListener("click", () => {
  ...
  g && (g.textContent = p.name), hn(e), dn(e), un(e), Kl(e), e.refreshCameraSelectors(), e.refreshKeyEditor(), e.updateEditState(), e.drawCurveEditor(), e.perf && (e.perf.timelineRefreshCount = (e.perf.timelineRefreshCount || 0) + 1), Rl(e);
}
class xn {
  constructor(t = URL) {
...
async function Oo(e, { route: t, field: a = "file", file: o }) {
...
`, Hl = `
      ...
      .majoor-omnicam .viewport-wrap{position:relative;width:100%;height:100%;min-height:280px;background:#0d0d10;touch-action:none;overscroll-behavior:contain;pointer-events:auto;outline:none;box-shadow:inset 0 0 0 1px rgba(255,255,255,0.06);transition:box-shadow .15s ease}
...
const Yl = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/><path d="M2 12h20"/></svg>', Zl = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m21 16-9 5-9-5V8l9-5 9 5v8z"/><path d="m3.27 6.96 8.73 4.84 8.73-4.84"/><path d="M12 22V12"/></svg>', Jl = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2L2 20h20L12 2z"/><path d="M12 2v18"/></svg>', Ql = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/><path d="m17.66 17.66 1.41 1.41"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="m6.34 17.66-1.41 1.41"/><path d="m19.07 4.93-1.41 1.41"/></svg>', ed = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18h6"/><path d="M10 22h4"/><path d="M15.09 14c.18-.98.65-1.74 1.41-2.5A4.65 4.65 0 0 0 18 8 6 6 0 0 0 6 8c0 1 .23 2.23 1.5 3.5.76.76 1.23 1.52 1.41 2.5"/></svg>', td = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l8 8-4 4-8-8 4-4z"/><path d="M7 11L2 16l6 6 5-5"/><path d="M18 19l4 2"/><path d="M21 16l2 2"/></svg>', ad = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m22 8-6 4 6 4V8z"/><rect width="14" height="12" x="2" y="6" rx="2"/></svg>', od = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14h6v6H4z"/><circle cx="17" cy="7" r="3"/><path d="m6 3 4 7H2z"/></svg>';
function rd() {
  return `
...
function ld() {
  const e = yc.map((t) => `<button data-lens="${t}">${t}mm</button>`).join("");
  return `
  ...
  return `
    <div class="oc-dope">
      <div class="oc-dope-body">
        <div class="oc-dope-labels">${cn.map((t) => `
...
function Ko({ fetchApi: e = Ad } = {}) {
  const t = (a, o) => Promise.resolve(e(a, o)).then(Td);
  return {
    list(a = {}) {
      const { kind: o, tag: n, search: s, offset: i, limit: c } = a, l = { tag: n, search: s, offset: i, limit: c };
      return o && o !== "all" && (l.kind = o), t(`${Ce}${mr(l)}`);
    },
    get(a) {
    ...
    importModel(a, o = {}) {
      const n = new FormData();
      return n.append("file", a, o.filename || a.name || "model.glb"), t(`${Ce}/import${mr(o)}`, { method: "POST", body: n });
    },
...
const kn = Object.freeze(["all", "character", "prop", "environment", "vehicle"]);
function pr(e = {}) {
  const t = String(e.kind || "all").toLowerCase();
  return {
    kind: kn.includes(t) ? t : "all",
...
function Id(e) {
  ...
  return {
    ...
    setFilter(i) {
      return a.filter = pr({ ...a.filter, ...i }), a.offset = 0, this.refresh();
    },
    refresh() {
      return s(async () => {
...
const Ld = 256;
function fr(e = {}) {
  const { THREE: t, GLTFLoader: a, FBXLoader: o, size: n = Ld } = e;
  if (!t || !a)
...
function Rd(e, t = {}) {
  return kn.map((a) => {
    ...
    return `<button type="button" class="oc-asset-kind${a === (e || "all") ? " active" : ""}" data-asset-kind="${a}">${Ze(o)}${n}</button>`;
  }).join("");
}
function qd(e, { selected: t = !1, thumbUrl: a = "" } = {}) {
  const o = Dd[e.kind] || "pi-box", n = e.kind === "character" && Rr(e.rig) === "rigged" ? `<span class="oc-asset-badge">${r("RIGGED")}</span>` : "", s = a ? `<img class="oc-asset-thumb" src="${Ze(a)}" alt="" loading="lazy">` : `<span class="oc-asset-thumb oc-asset-thumb--glyph"><i class="pi ${o}"></i></span>`;
  return `<button type="button" class="oc-asset-card${t ? " selected" : ""}" data-asset-id="${Ze(e.id)}" title="${Ze(e.name)}">
    ${s}
    <span class="oc-asset-name">${Ze(e.name)}</span>
    <span class="oc-asset-kind-tag">${Ze((e.kind || "").toUpperCase())}</span>
    ${n}
  </button>`;
}
function Bd(e, { selectedId: t = "", thumbUrls: a = {} } = {}) {
  return !e || !e.length ? `<p class="oc-asset-empty">${r("No assets match this filter.")}</p>` : e.map((o) => qd(o, {
    selected: o.id === t,
    thumbUrl: a[o.id] || ""
  })).join("");
}
...
function Wd(e, t = {}) {
  const a = e.root, o = t.fetchApi || ((O, H) => (e.api || e.app?.api).fetchApi(O, H)), n = t.apiClient || Ko({ fetchApi: o }), s = t.store || Id(n), i = zd(), c = t.previewQueue || Fd(), l = e.api || e.app?.api || null;
  let m = t.thumbnailRenderer || null, p = null;
  const f = /* @__PURE__ */ new Set();
  function d() {
    return m ? Promise.resolve(m) : (p || (p = Od().then((O) => m = fr(O)).catch(() => m = fr({}))), p);
  }
  function h(O) {
    return Xo(l, ac(O));
  }
  function b(O) {
    return O.thumbnail ? Xo(l, `omnicam/library/${O.thumbnail} [input]`) : "";
  }
  function u() {
    for (const O of s.state.items) {
      ...
      H && c.enqueue(O.id, async () => {
        ...
        if (i.set(O.id, ce), R(), !(O.source && O.source !== "user"))
          try {
            const me = await n.uploadThumbnail(O.id, Kd(ce));
  ...
  const y = (O) => a.querySelector(`[data-role="${O}"]`), g = y("assets-panel"), v = y("asset-grid"), j = y("asset-kinds"), x = y("asset-search"), M = y("asset-status"), P = y("asset-import-file"), D = y("scene-tab"), F = y("assets-tab"), U = y("agent-tab"), B = a.querySelector('[data-asset-view="agent"]'), V = { assets: F, agent: U };
  let Q = "", k = null, _ = !0, z = !0, N = "scene", q = 0;
  function $(O, { sticky: H = !1 } = {}) {
    M && (!H && q > Date.now() || (M.textContent = O || "", q = H ? Date.now() + 9e3 : 0));
  }
  function W(O) {
    if (Q = O, !!v)
  ...
  let C = !1;
  function R() {
    if (j && (j.innerHTML = Rd(s.state.filter.kind, s.state.kinds)), v) {
      const O = {};
      for (const H of s.state.items) {
        const ie = i.get(H.id) || b(H);
        ie && (O[H.id] = ie);
      }
      v.innerHTML = Bd(s.state.items, { selectedId: Q, thumbUrls: O });
    }
    if (!C) {
      C = !0;
      try {
    ...
    s.state.error ? $(s.state.error.message) : s.state.loading ? $(r("Loading assets...")) : $(r("{n} of {total} assets").replace("{n}", s.state.items.length).replace("{total}", s.state.total));
  }
  function G(O) {
    if (!O) return;
    const H = tc({
  ...
  async function ae(O) {
    if (O) {
      $(r("Importing {name}...").replace("{name}", O.name));
      try {
        const H = await n.importModel(O, { kind: "prop", name: O.name.replace(/\.[^.]+$/, "") });
        H.asset && s.upsert(H.asset), $(r("Imported {name}").replace("{name}", H.asset?.name || O.name));
      } catch (H) {
        $(H.message || r("Import failed"));
      }
    }
  }
  function oe(O) {
    O === "agent" && !xo() && (O = "scene"), N = O, D && (D.hidden = O !== "scene");
  ...
  function de() {
    clearTimeout(k), k = setTimeout(() => s.setFilter({ search: x.value }), 200);
  }
  function he(O) {
  ...
  return g?.addEventListener("click", se), g?.addEventListener("dblclick", pe), a.querySelector('[data-role="left-tabs"]')?.addEventListener("click", se), x?.addEventListener("input", de), P?.addEventListener("change", he), R(), ee(), {
    store: s,
    switchView: oe,
    syncAgentAvailability: ee,
    refresh: () => s.refresh(),
    dispose() {
      be(), clearTimeout(k), g?.removeEventListener("click", se), g?.removeEventListener("dblclick", pe), a.querySelector('[data-role="left-tabs"]')?.removeEventListener("click", se), x?.removeEventListener("input", de), P?.removeEventListener("change", he), c.clear(), m?.dispose?.(), i.clear();
    }
  };
}
function Vd(e, t = {}) {
  ...
  function l() {
    ...
    let u = 0;
    for (const y of b) {
      if (!qr(y, { mode: s.mode, selectedIds: d })) continue;
      const g = Br(y, s.content);
      if (!g) continue;
      const v = Wr(b, y, h) || {
        position: y.position,
        size: y.size
      }, j = e.webgl.projectWorldToScreen(Vr(v, y.type));
      ...
      const M = s.content === "annotation" ? y.annotation?.color : "";
      x.style.setProperty("--oc-label-accent", M || ""), x.classList.toggle("is-annotation", s.content === "annotation" && !!M);
    }
...
function Hd(e) {
  ...
  return {
    ...
    getRigInfo(a) {
      const o = e.state?.objects?.find((i) => i.id === a) || null, n = t(a), s = ko(n);
      return {
        objectId: a,
...
function Ud(e, t) {
  const a = (o) => [`<option value="">${r("— unmapped —")}</option>`].concat(
    e.map(
      (n) => `<option value="${br(n)}"${n === o ? " selected" : ""}>${br(n)}</option>`
    )
  ).join("");
  return Ur.map((o) => {
...
function Gd(e, t = {}) {
  const a = e.root, o = t.apiClient || Ko({
  ...
  function f() {
    if (!i) return;
    const g = Yo(l);
    co(l) ? (i.textContent = r("Humanoid v1 ✓ — all 22 joints mapped"), i.dataset.state = "ok") : (i.textContent = r("Incomplete — {n} joint(s) unmapped").replace("{n}", g.length), i.dataset.state = "warn");
  }
  function d() {
    s && (s.innerHTML = Ud(p(), l)), f();
  }
  function h() {
  ...
  function u(g) {
    ...
    v === "auto" ? (l = ko(p()), d()) : v === "validate" ? (d(), e.setStatus?.(co(l) ? r("Rig is complete") : r("Rig still missing: {list}").replace("{list}", Yo(l).join(", ")))) : v === "save" && y();
  }
  async function y() {
    const g = m();
    if (!g?.asset_id) {
    ...
    try {
      const v = await o.patch(g.asset_id, {
        rig: { profile: Zo, bone_map: l }
      });
      g.character = {
        ...g.character || {},
        rig_profile: co(l) ? Zo : null
...
function Zd(e, t = {}) {
  const a = e.root, o = t.apiClient || Ko({
    fetchApi: (k, _) => (e.api || e.app?.api).fetchApi(k, _)
  }), n = a.querySelector('[data-role="pose-editor"]');
  if (!n) return { sync() {
  }, update() {
  }, dispose() {
  } };
  const s = n.querySelector('[data-role="pose-preset"]'), i = n.querySelector('[data-pose-act="edit"]'), c = n.querySelector('[data-role="pose-joint-row"]'), l = n.querySelector('[data-role="pose-joint-name"]'), m = ["x", "y", "z"].map((k) => n.querySelector(`[data-role="pose-rot-${k}"]`));
  let p = null, f = !1, d = /* @__PURE__ */ new Map();
  const h = () => e.state?.objects?.find((k) => k.id === p) || null, b = () => e.rigMapper?.boneMap && Object.keys(e.rigMapper.boneMap).length ? e.rigMapper.boneMap : null, u = () => e.subSelection?.type === "character_joint" && e.subSelection.objectId === p ? e.subSelection.jointId : null;
  function y(k) {
    const _ = Jo({ ...k, preset_id: k.id });
    return { id: k.id, name: k.name || k.id, root_offset: _.root_offset, joints: _.joints };
  }
  function g(k) {
    const _ = d.get(k?.pose?.preset_id) || null;
    return is({ preset: _, overrides: k?.pose }).joints;
  }
  function v() {
    const k = h();
    !k?.character || !b() || e.webgl?.applyCharacterPose?.(p, b(), f || k.character.pose?.joints ? g(k.character) : {});
  }
  function j() {
    const k = u(), _ = f && !!k;
    if (c && (c.hidden = !_), !_) return;
    l && (l.textContent = k);
    const z = h(), N = g(z?.character)[k] || [0, 0, 0, 1], q = cs(N);
    m.forEach(($, W) => {
      $ && document.activeElement !== $ && ($.value = String(Math.round(q[W] * 100) / 100));
    });
  }
  function x() {
    const k = h(), _ = !!k?.character?.motion;
    if (i && (i.classList.toggle("active", f), i.disabled = _, i.title = _ ? r("Clear the motion clip to edit the pose") : r("Toggle FK pose editing")), s) {
      ...
      s.dataset.sig !== N && (s.dataset.sig = N, s.replaceChildren(...z.map(([q, $]) => {
        const W = document.createElement("option");
        return W.value = q, W.textContent = $, W;
      }))), document.activeElement !== s && (s.value = k?.character?.pose?.preset_id || "neutral");
    }
    j(), v();
  }
  async function M() {
    try {
      const k = await o.listPoses();
      d = new Map((k.poses || []).filter((_) => _?.id).map((_) => [_.id, y(_)]));
    } catch {
      d = /* @__PURE__ */ new Map();
    }
  ...
  function P() {
    const k = u();
    if (!k) return;
    const _ = m.map((q) => Number(q?.value) || 0), z = ss(_), N = e.directorApi?.execute({
      version: 1,
      id: `tx_pose_${Date.now().toString(36)}`,
      description: "Pose joint",
      operations: [{ type: "character.set_joint_rotation", objectId: p, joint: k, rotation: z }]
    });
    N && !N.ok && e.setStatus?.(N.error?.message || r("Could not set the joint")), x();
  }
  function D() {
    const k = s?.value || "neutral", _ = d.get(k) || Jo({ preset_id: k });
    e.directorApi?.execute({
      version: 1,
      id: `tx_preset_${Date.now().toString(36)}`,
      description: "Pose preset",
      operations: [{ type: "character.set_pose", objectId: p, pose: { preset_id: k, root_offset: _.root_offset, joints: {} } }]
    }), x();
  }
  async function F() {
    const k = h();
    if (!k?.character) return;
    const _ = (await kt(e, r("Save Pose"), r("Pose name"), ""))?.trim();
    if (!_ || e.disposed) return;
    const z = _.toLowerCase().replace(Yd, "-").replace(/^-+|-+$/g, "").slice(0, 60) || "pose";
    try {
      const N = await o.savePose({
        id: z,
        name: _,
        profile: "omnicam_humanoid_v1",
        root_offset: k.character.pose?.root_offset || [0, 0, 0],
        joints: g(k.character)
      });
  ...
  function U() {
    const k = h();
    !k?.character || k.character.motion || (f = !f, !f && e.subSelection?.type === "character_joint" && (e.subSelection = null), x(), e.rigOverlay?.update?.());
  }
  function B(k) {
    f && (e.subSelection = { type: "character_joint", objectId: p, jointId: k }, x(), e.rigOverlay?.update?.());
  }
  const V = Xd(e, {
    onPick: B,
  ...
  e.rigOverlay = V;
  function Q() {
    const k = e.selectedObject?.(), _ = k?.asset_kind === "character";
    if (n.hidden = !_, !_) {
      f && (f = !1), p = null, V.update();
      return;
    }
    k.id !== p && (p = k.id, f = !1, e.subSelection?.type === "character_joint" && (e.subSelection = null), d.size || M()), x(), V.update();
  }
  s?.addEventListener("change", D), i?.addEventListener("click", U), n.querySelector('[data-pose-act="save"]')?.addEventListener("click", F);
  for (const k of m)
    k?.addEventListener("change", P), k?.addEventListener("input", P);
  return M(), {
    sync: Q,
    update() {
      V.update(), v();
    ...
    dispose() {
      ...
      for (const k of m)
        k?.removeEventListener("change", P), k?.removeEventListener("input", P);
    }
  };
}
function ur(e, t) {
...
function Jd(e) {
  ...
  function b() {
    ...
    if (o) {
      const M = v.join("|");
      o.dataset.sig !== M && (o.dataset.sig = M, o.replaceChildren(
        ur("", v.length ? r("No motion (static)") : r("No clips in this model")),
        ...v.map((P) => ur(P, P))
      )), document.activeElement !== o && (o.value = j?.clip_id || ""), o.disabled = !v.length;
    }
    fo(n, j?.start_frame ?? 0), fo(s, j?.end_frame ?? 0), fo(i, j?.speed ?? 1), c && document.activeElement !== c && (c.checked = j ? j.loop !== !1 : !0);
    const x = !!j;
    for (const M of [n, s, i, c]) M && (M.disabled = !x);
    l && (l.disabled = !x);
  }
  function u() {
...
const Qd = /* @__PURE__ */ new Set(["translate", "rotate", "scale"]), em = /* @__PURE__ */ new Set(["world", "local"]), Ae = 180 / Math.PI;
function gr(e) {
  return [e.x, e.y, e.z];
}
function tm(e) {
...
function am({
  ...
  function k(C) {
    if (!Qd.has(C)) throw new Error(`createTransformControlsAdapter: unknown mode "${C}"`);
    f.setMode ? f.setMode(C) : f.mode = C;
  }
  function _(C) {
    if (!em.has(C)) throw new Error(`createTransformControlsAdapter: unknown space "${C}"`);
    f.space = C;
  }
  function z(C) {
...
function rm(e, { controlsFactory: t, anchorFactory: a } = {}) {
  let o = null, n = null, s = !1, i = null, c = !1;
  function l(k) {
    if (!o) return;
    const _ = k || e.state.spatial_snap_mode === "grid";
  ...
  function m(k) {
    c = !!(k.ctrlKey || k.metaKey), o?.isDragging?.() && l(c);
  }
  function p() {
  ...
  function d() {
    return o || (!e.webgl || !e.interactionElement ? null : (o = am({
      THREE: Wc,
      ...
      onDragEnd: D,
      onDraggingChanged: (k) => {
        e.transformControlsDragging = k;
      }
    }), p(), o));
  }
  function h({ targetSpec: k }) {
    if (k) {
      if (l(c), k.type === "object") {
        e.checkpoint("Transform object");
        const _ = ds(e), z = (_.length ? _ : [k.object]).map((q) => ({
          object: q,
          transform: Ie(q)
        }));
        for (const q of z) e.beginObjectEdit(q.object);
        const N = z.reduce((q, $) => ye(q, $.transform.position), [0, 0, 0]).map((q) => q / z.length);
      ...
      if (k.type === "camera_path") {
        const _ = k.track;
        if (!_ || _.locked || !(_.keyframes?.length >= 1)) return;
        e.checkpoint("Transform camera path"), n = {
          type: "camera_path",
          trackId: _.id,
          origin: Gr(_.keyframes),
          baseKeys: _.keyframes.map((z) => ({ ...z, camera: le(z.camera) }))
        };
        return;
      }
      if (k.type === "path_point" || k.type === "path_group") {
        const _ = k.track;
        if (!_ || _.locked) return;
        const z = k.type === "path_point" ? [k.frame] : k.frames;
        e.checkpoint(k.type === "path_point" ? "Transform path point" : "Transform path selection"), n = {
          type: k.type,
          trackId: _.id,
          origin: k.position,
          selectedFrames: new Set(z),
          baseKeys: _.keyframes.map((N) => ({ ...N, camera: le(N.camera) })),
          lookAtActive: Xr(_, e.state.objects)
        };
        return;
      }
      if (k.type === "path_point_target") {
        const _ = k.track;
        if (!_ || _.locked || k.readOnly) return;
  ...
  function b(k) {
    ...
    return _ === "translate" ? { mode: _, delta: k.position } : _ === "scale" ? { mode: _, origin: n.origin, factors: k.scaleFactors } : { mode: _, origin: n.origin, rotationDeg: k.rotationDeg };
  }
  function u(k) {
    k.id === e.state.active_camera_id && (e.state.keyframes = k.keyframes), e.camera = xe(k, e.frame, e.state.objects), k.camera = le(e.camera), e.refreshKeys();
  }
  function y(k) {
    const _ = e.state.cameras.find((z) => z.id === n.trackId);
    _ && (_.keyframes = Yr(n.baseKeys, b(k)), u(_));
  }
  function g(k) {
    const _ = e.state.cameras.find((N) => N.id === n.trackId);
    if (!_) return;
    const z = { ...b(k), lookAtActive: n.lookAtActive };
    _.keyframes = ps(n.baseKeys, n.selectedFrames, z), u(_);
  }
  function v(k) {
    const _ = e.state.cameras.find((z) => z.id === n.trackId);
    _ && (_.keyframes = fs(n.baseKeys, [n.frame], { delta: k.position }), u(_));
  }
  function j({ delta: k }) {
    n && (n.type === "object" ? x(k) : n.type === "camera" ? M(k) : n.type === "camera_target" ? P(k) : n.type === "camera_path" ? y(k) : n.type === "path_point" || n.type === "path_group" ? g(k) : n.type === "path_point_target" && v(k), e.render());
  }
  function x(k) {
    const { group: _, pivot: z } = n, N = e.state.gizmo_mode;
    for (const q of _)
      if (N === "translate")
        q.object.position = ye(q.transform.position, k.position);
      else if (N === "rotate")
        q.object.position = ye(z, Qo(Ee(q.transform.position, z), k.rotationDeg)), q.object.rotation = ye(q.transform.rotation, k.rotationDeg);
      else if (N === "scale") {
        const $ = Ee(q.transform.position, z);
        q.object.position = ye(z, $.map((W, C) => W * k.scaleFactors[C])), q.object.size = q.transform.size.map((W, C) => Math.max(0.01, W * k.scaleFactors[C]));
      }
    for (const q of _) e.commitObjectEdit(q.object);
  }
  function M(k) {
    if (e.state.gizmo_mode === "translate")
      e.camera.position = ye(n.position, k.position);
    else {
      const _ = Ee(n.target, n.position);
      e.camera.target = ye(n.position, Qo(_, k.rotationDeg));
    }
    e.commitCameraEdit();
  }
  function P(k) {
    const _ = ye(n.base, k.position);
    n.tracking ? ms(e, _) : e.camera.target = _, e.commitCameraEdit();
  }
  function D({ cancelled: k }) {
    if (!n) return;
    const _ = n.type;
    k ? (e.undo(), (_ === "camera" || _ === "camera_target") && e.finishCameraEdit()) : _ === "camera" || _ === "camera_target" ? e.finishCameraEdit() : (e.editingKeyFrame = null, e.updateKeyVisualState?.(), e.drawCurveEditor?.()), n = null, e.refreshInspector(), e.render();
  }
  function F() {
    if (!e.webgl || !e.interactionElement) return;
    const k = e.recording ? null : ls(e), _ = e.state.gizmo_mode || "translate", z = !!k && !k.readOnly && om.has(k.type) && k.allowedModes.includes(_);
    if (i = z ? k.type : null, !z) {
      o?.detach();
      return;
    }
    d() && (o.isDragging() || (o.setCamera(e.webgl.activeCamera), o.setMode(_), o.setSpace(e.state.gizmo_space === "local" ? "local" : "world"), o.attach(k)));
  }
  function U() {
...
function nm(e, t) {
  ...
  const a = e.activeCameraTrack(), o = al(t, {
...
function sm(e, t) {
  ...
  const o = tl(a, { type: t, intensity: 1, duration_frames: e.state.duration_frames });
...
const yr = ["#4aa3ef", "#f2a93b", "#48c774", "#b565d8", "#ec4899"], Oe = [4, 8, 12, 20, 35, 60, 100];
function tt(e) {
...
function oo(e, t, a) {
  ...
  const o = tt(e), n = o.expanded ? 220 : 138, s = Math.min(n, Math.max(80, Math.min(t, a) - 20)), i = 10, c = Math.max(0, t - s - i), l = Math.max(0, a - s - i), m = e.viewportCamera(), p = m?.position || [0, 1.5, 5], f = m?.target || [0, 0, 0], d = e.activeCameraTrack?.(), h = e.state.cameras?.length ? e.state.cameras : d ? [d] : [], b = h.flatMap(
    (M) => (M.keyframes || []).map((P) => P.camera?.position).filter(Boolean)
  );
  let u = 12;
  if (o.rangeIndex >= 0 && o.rangeIndex < Oe.length)
    ...
    u = Math.max(6, Math.ceil((M + 1.5) / 4) * 4);
  }
...
function mm(e, t, a, o) {
  const n = oo(e, a, o);
  if (!n) return;
  const { rx: s, ry: i, radarSize: c, cx: l, cy: m, innerRadius: p, range: f, scale: d, camPos: h, camTgt: b, cameras: u, activeTrack: y } = n, g = tt(e), v = e.state.active_camera_id || y?.id, j = (ee, se) => jn(n, ee, se);
  ...
  for (let ee = 0; ee < u.length; ee++) {
    const se = u[ee], pe = se.keyframes || [], de = se.id === v, he = se.color || yr[ee % yr.length];
    t.save(), t.strokeStyle = he, t.globalAlpha = de ? 0.95 : 0.4, t.lineWidth = de ? 2 : 1, t.setLineDash(de ? [] : [2, 2]), t.beginPath();
    let be = !1;
    const O = pe[0]?.frame, H = pe[pe.length - 1]?.frame;
    ...
    for (const ie of pe) {
      ...
      const we = ie.frame === e.frame && de;
      t.fillStyle = we ? "#ffffff" : he, t.globalAlpha = de ? 0.95 : 0.6, t.beginPath(), t.moveTo(me, re - 3), t.lineTo(me + 3, re), t.lineTo(me, re + 3), t.lineTo(me - 3, re), t.closePath(), t.fill(), we && (t.strokeStyle = "#00d2d3", t.lineWidth = 1.2, t.stroke());
    }
    t.restore();
  }
  const [P, D] = j(h[0] || 0, h[2] || 0), [F, U] = j(b[0] || 0, b[2] || 0), B = 8, V = Z(P, s + B, s + c - B), Q = Z(D, i + B, i + c - B), k = Z(F, s + B, s + c - B), _ = Z(U, i + B, i + c - B), z = h[1] || 0, N = lm(z), q = dm(z);
  t.strokeStyle = "rgba(255, 255, 255, 0.40)", t.lineWidth = 1, t.setLineDash([3, 3]), t.beginPath(), t.moveTo(V, Q), t.lineTo(k, _), t.stroke(), t.setLineDash([]), t.fillStyle = "#ffffff", t.beginPath(), t.arc(k, _, 2.5, 0, Math.PI * 2), t.fill(), t.strokeStyle = "rgba(255, 255, 255, 0.7)", t.lineWidth = 1, t.beginPath(), t.arc(k, _, 4.5, 0, Math.PI * 2), t.stroke();
  const $ = b[0] - h[0], W = b[2] - h[2], C = Math.atan2(W, $), G = (e.viewportCamera().fov || 35) * Math.PI / 360, ae = Z(24 * (d / (p / 8)), 16, 38), oe = t.createRadialGradient(V, Q, 2, V, Q, ae);
  oe.addColorStop(0, N + "55"), oe.addColorStop(1, N + "08"), t.fillStyle = oe, t.strokeStyle = N, t.lineWidth = 1.2, t.beginPath(), t.moveTo(V, Q), t.lineTo(V + Math.cos(C - G) * ae, Q + Math.sin(C - G) * ae), t.arc(V, Q, ae, C - G, C + G), t.closePath(), t.fill(), t.stroke(), t.fillStyle = N + "44", t.beginPath(), t.arc(V, Q, 6.5, 0, Math.PI * 2), t.fill(), t.fillStyle = N, t.beginPath(), t.arc(V, Q, 3.5, 0, Math.PI * 2), t.fill(), t.strokeStyle = "#ffffff", t.lineWidth = 1.5, t.beginPath(), t.moveTo(V, Q), t.lineTo(V + Math.cos(C) * 7, Q + Math.sin(C) * 7), t.stroke(), pm(e, t, n, N, q, C, Math.hypot($, W)), g.hover && fm(t, n, g.hover), t.restore();
}
function pm(e, t, a, o, n, s, i) {
...
function _n(e, t, a, o) {
  const { camPos: n, camTgt: s, cameras: i, rx: c, ry: l, radarSize: m } = t, p = (y, g) => jn(t, y, g), [f, d] = p(n[0] || 0, n[2] || 0);
  ...
  for (const y of e.state.objects || []) {
    ...
    const g = To(e.state.objects, y).position || [0, 0, 0], [v, j] = p(g[0], g[2]);
...
function hm(e, t, a, o) {
  ...
  const n = oo(e, e.canvas.width, e.canvas.height);
  if (!n) return !1;
  const { rx: s, ry: i, radarSize: c } = n;
  if (a < s || a > s + c || o < i || o > i + c)
    return !1;
  t.preventDefault?.(), t.stopPropagation?.();
  const l = tt(e), m = Cn(n, a, o);
  if (m)
...
function bm(e, t, a, o) {
  ...
  if (s.drag) {
    const [u, y] = Co(n, a, o), g = e.viewportCamera();
  ...
  const p = Cn(n, a, o), f = _n(e, n, a, o), [d, h] = Co(n, a, o);
...
function ym(e, t, a) {
  ...
  const o = () => {
    ...
    const b = String(t('[data-role="object-annotation"]')?.value || "").trim(), u = b ? us({
      text: b,
  ...
  }, { signal: a }), pl(e, a), Dl(e, a), t('[data-role="curve-group"]')?.addEventListener("change", () => {
    e.setChannelFilter("all"), un(e), e.drawCurveEditor();
  ...
  for (const d of e.root.querySelectorAll(".toolbar-menu"))
    d.addEventListener("toggle", () => {
      d.open ? (e.closeMenus(d), vr(d)) : gm(d);
    }, { signal: a });
  document.addEventListener("scroll", () => {
    for (const d of e.root.querySelectorAll(".toolbar-menu[open]")) vr(d);
  }, { capture: !0, signal: a });
  const c = (d, h) => {
  ...
  e.root.addEventListener("pointerdown", (d) => {
    ...
    const h = e.interactionElement.getBoundingClientRect(), b = (d.clientX - h.left) * e.canvas.width / Math.max(1, h.width), u = (d.clientY - h.top) * e.canvas.height / Math.max(1, h.height);
    um(e, d, b, u) || e.onWheel(d);
  }, { passive: !1, signal: a }), e.root.addEventListener("wheel", Bc(e.root), { signal: a }), window.addEventListener("pointermove", (d) => {
  ...
  l && (l.addEventListener("pointerdown", (d) => e.onTimelinePointerDown(d), { signal: a }), l.addEventListener("pointermove", (d) => e.onTimelinePointerMove(d), { signal: a }), l.addEventListener("pointerup", (d) => e.onTimelinePointerUp(d), { signal: a }), l.addEventListener("pointercancel", (d) => e.onTimelinePointerUp(d), { signal: a }), l.addEventListener("wheel", (d) => Dr(e, d), { passive: !1, signal: a }));
  const m = (d) => {
    const h = gs(d.composedPath?.()[0] || d.target);
    h && (e.lastKeyZone = h);
  };
  e.root.addEventListener("focusin", m, { signal: a }), e.root.addEventListener("pointerdown", m, { capture: !0, signal: a }), e.root.addEventListener("focusout", (d) => {
    e.modalTransform && !e.root.contains(d.relatedTarget) && (hs(e), e.render());
  }, { signal: a });
...
function xm(e, t) {
  Po.find((o) => o.id === e)?.onChange?.(t);
}
function wm(e) {
  const t = ci(e.id, e.defaultValue), a = `pref_${e.id.replace(/[^a-zA-Z0-9]/g, "_")}`;
  if (e.type === "boolean")
    return `
...
function km(e) {
  const t = new Map(Po.map((o) => [o.id, o]));
  return ({
    nav: [
      Qs,
      ei,
...
function kr(e, t, a, o) {
  const n = _o(Number(a || 0) - Number(e || 0)), s = Number(e || 0) + n * o;
  if (t == null) return s;
  const i = _o(Number(t || 0) - s);
  return s + i / 3;
}
function Sr(e, t, a) {
  ...
  for (let n = 1; n < a.length - 1; n++) {
    ...
    if (i.camera) {
      for (const p of _m) {
        ...
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const b = wr(f, d, h, m);
          a[n].camera[p] = Sr(d.map(Number), b, o);
        }
      }
      for (const p of Em) {
        const f = s.camera?.[p], d = i.camera?.[p], h = c.camera?.[p];
    ...
    if (Array.isArray(i.position) && Array.isArray(s.position) && Array.isArray(c.position)) {
      for (const p of Mm) {
        ...
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const b = wr(f, d, h, m);
          a[n][p] = Sr(d.map(Number), b, o);
        }
      }
      for (const p of Am) {
        const f = s[p], d = i[p], h = c[p];
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const b = [0, 1, 2].map((u) => kr(f[u], d[u], h[u], m));
          a[n][p] = d.map((u, y) => jr(Number(u), b[y], o));
        }
      }
    }
  }
...
function Km(e, t) {
  ...
  const o = (n) => {
    ...
    const b = (y) => {
      ...
      const M = m >= 1 ? 0 : m >= 0.1 ? 1 : 2;
      i.value = x.toFixed(M), i.dispatchEvent(new Event("input", { bubbles: !0 })), i.dispatchEvent(new Event("change", { bubbles: !0 }));
    }, u = (y) => {
...
function En(e) {
  ...
  l && o?.fov != null && (l.textContent = `${Fo(o.fov)}mm`);
  const m = t.querySelector('[data-role="hud-cam-fov"]');
  m && o?.fov != null && (m.textContent = vc(o.fov));
...
function Rm(e, t) {
  for (const o of e.root.querySelectorAll('[data-act="toggle-camera-lock"]'))
    o.addEventListener("click", (n) => {
      n.stopPropagation(), e.checkpoint?.("Toggle camera lock"), e.state.camera_lock = !e.state.camera_lock, e.serialize?.(), En(e), e.setStatus?.(e.state.camera_lock ? r("Camera View locked") : r("Camera View unlocked"));
    }, { signal: t });
...
function qm(e, t) {
  ...
  !a || !o || (n && n.addEventListener("change", () => {
    ...
    document.activeElement !== a && (a.value = Fo(o.value));
  }, { signal: t }));
}
function Bm(e, t) {
...
function Wm(e, t) {
  ...
  e.root.querySelector('[data-act="keys-reduce"]')?.addEventListener("click", async () => {
    const l = await kt(e, r("Reduce keys"), r("Target number of keys"), "8"), m = Math.round(Number(l));
  ...
  if (a.length) {
    ...
    for (const o of a)
      o.addEventListener("change", () => {
        e.dopeChannels = new Set(a.filter((n) => n.checked).map((n) => n.dataset.dopeChannel)), dn(e);
      }, { signal: t });
  }
}
function Um(e, t) {
...
const Ba = () => import("./chunk-iQ5N8I4c.js");
function Xm(e, t) {
...
function Ym(e, t) {
  ...
  li().then((n) => {
    ...
    c === "health-slow" ? mi(e) : c === "health-smooth" ? pi(e) : c === "health-recenter" && fi(e);
  }, { signal: t });
  for (const n of e.root.querySelectorAll('[data-tab="health"]'))
    n.addEventListener("click", () => lo(e), { signal: t });
}
function Zm(e, t) {
...
function Fb(e, t, a = $n) {
  ...
  const y = new Hc(), g = u.fromScene(y, 0.04).texture;
  return y.traverse((v) => {
    v.geometry?.dispose?.();
...
function Ob(e, t, a, o, n) {
  o.group.visible = n, t.environment = n ? o.environment : null, t.background = n ? o.sky : new e.Color(1184274), t.fog = n ? o.fog : null, a.toneMapping = n ? e.ACESFilmicToneMapping : e.NoToneMapping, a.toneMappingExposure = n ? Do(o.quality).toneExposure : 1, t.traverse((s) => {
...
function op(e) {
  ...
  const n = e.reconstruction, s = n.provider || "Reconstructed", i = Math.round(t * 100), c = Sc(e), l = c.length ? `
` + c.map(([p, f]) => `${p}: ${f}`).join(`
`) : "", m = `${s} • ${o} (${i}%)${l}`;
  return {
    label: o,
...
function sp(e, t, a) {
  ...
  if (o) {
    const s = (i) => {
      const c = i.target.closest?.("[data-axis], [data-axis-center]") || i.target, l = c.getAttribute("data-axis"), m = hi(l?.toLowerCase(), e.state.view_mode);
  ...
  for (const s of e.root.querySelectorAll('[data-act="reset-bg-color"]'))
    s.addEventListener("click", () => {
      e.state.viewport_bg_color !== bo && e.checkpoint("Reset background colour"), e.state.viewport_bg_color = bo;
      for (const i of e.root.querySelectorAll('[data-role="viewport-bg-color"]')) i.value = bo;
  ...
  for (const s of e.root.querySelectorAll("[data-lens]"))
    s.addEventListener("click", () => {
      jc(e, Number(s.dataset.lens));
    }, { signal: a });
  for (const s of e.root.querySelectorAll("[data-blocking-scene]"))
    s.addEventListener("click", () => {
      cm(e, s.dataset.blockingScene), e.closeMenus();
    }, { signal: a });
...
const ip = 32, cp = 0.025, lp = 0.05, Ya = 1e-6, dp = ["top", "bottom", "front", "back", "left", "right"], mp = {
  top: "y",
  bottom: "y",
  front: "z",
  back: "z",
...
function pp(e) {
  let t = 0;
  for (let a = 1; a < e.length; a++) t += Ro(e[a - 1], e[a]);
  return t;
}
function $o(e) {
  const t = Math.max(0, Math.round(Number(e?.duration_frames) || 1) - 1), a = Array.isArray(e?.playback_range) ? e.playback_range : [0, t], o = Eo(Math.round(Number(a[0]) || 0), 0, t), n = Eo(Math.round(Number(a[1]) || t), 0, t);
  return o <= n ? [o, n] : [n, o];
}
function fp(e, t) {
  ...
  for (let i = 0; i < t; i++) {
    ...
    const l = a[s - 1], m = a[s], p = Eo((c - l) / Math.max(Ya, m - l), 0, 1), f = e[s - 1], d = e[s];
    n.push([
      f[0] + (d[0] - f[0]) * p,
      f[1] + (d[1] - f[1]) * p,
      f[2] + (d[2] - f[2]) * p
...
function up(e) {
  ...
  ], m = e.planeAxis === "y" ? Mn(l) : An(l, [0, 0, -1]), p = e.seedPoint ? 1 : 0, f = [];
...
function Tn(e, t = e.cameraPathDraw) {
  const a = t?.pointerId;
  if (a != null)
    try {
...
function _r(e, t = {}) {
  ...
  if (a === "extend") {
    ...
    const b = Math.max(0, Math.round(Number(e.state.duration_frames) || 1) - 1), [, u] = $o(e.state), y = d.length > 1 ? d[d.length - 1].frame - d[0].frame : 24;
    let g = Math.max(u, h.frame + Math.max(6, Math.min(y, 240)));
    g <= h.frame && (g = h.frame + 24), g > b && (l = g + 1), g > u && (m = g), c = [h.frame, g];
  } else
    dp.includes(e.state.view_mode) || e.setViewMode?.("top"), c = $o(e.state);
...
function qo(e, t) {
  ...
  a.planeAxis && (o[Za[a.planeAxis]] = a.anchor[Za[a.planeAxis]]);
  const n = a.points.at(-1);
  return n && Ro(n, o) < cp ? !1 : (a.points.push(o), !0);
}
function Te(e) {
  const t = e.cameraPathDraw;
  return t?.active ? (Tn(e, t), e.cameraPathDraw = null, xt(e), e.setStatus?.(r("Draw Camera Path cancelled")), e.render?.(), !0) : !1;
}
function yp(e) {
  const t = e.cameraPathDraw;
  ...
  const n = Cc(e.state), s = e.state.cameras.length, i = {
    id: n,
    name: gp(e.state),
    color: or[s % or.length],
...
function Bo(e, t) {
  ...
  return n?.every(Number.isFinite) ? (a.planeAxis && (n[Za[a.planeAxis]] = a.anchor[Za[a.planeAxis]]), n) : null;
}
function xp(e, t) {
  const a = e.cameraPathDraw;
  return a?.active ? t.button === 2 && !t.altKey ? (Ja(t), e.cameraPathSuppressContextMenuUntil = Date.now() + 1e3, Te(e), !0) : t.button !== 0 || t.altKey || t.ctrlKey || t.metaKey || t.shiftKey ? !1 : (Ja(t), e.closeMenus?.(), e.interactionElement.focus?.({ preventScroll: !0 }), e.interactionElement.setPointerCapture?.(t.pointerId), a.drawing = !0, a.pointerId = t.pointerId, a.points = [], qo(e, Bo(e, t)), xt(e), e.requestRender?.("camera-path-draw"), !0) : !1;
}
function wp(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : (Ja(t), qo(e, Bo(e, t)) && e.requestRender?.("camera-path-draw"), !0);
}
function kp(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : (Ja(t), t.type === "pointercancel" || t.type === "lostpointercapture" ? (Te(e), !0) : (qo(e, Bo(e, t)), a.drawing = !1, yp(e), !0));
}
function Sp(e) {
  const t = e.cameraPathDraw;
...
function jp(e, t) {
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? Te(e) : _r(e);
    }, { signal: t });
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path-extend"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? Te(e) : _r(e, { mode: "extend" });
    }, { signal: t });
...
function Wo(e, t, { name: a = "", status: o } = {}) {
  const n = t && typeof t == "object" ? t : Zr(), s = { ...n, metadata: { ...n.metadata || {}, scene_name: a || "" } };
...
async function Cp(e) {
  await St(e, r("New Scene"), r("Start a new scene? Unsaved changes will be lost.")) && Wo(e, Zr(), { name: "", status: r("New scene") });
}
async function _p(e) {
  if (!e.sceneBaseline) {
  ...
  const o = a?.metadata?.scene_name || Pn(e);
  Wo(e, a, { name: o, status: r("Scene reset to last save") });
}
async function Ep(e) {
  const t = Pn(e) || r("Untitled"), a = await kt(e, r("Save Scene"), r("Scene name"), t);
  if (a == null) return;
...
function Fp(e) {
  ...
  if (!c) return;
  const l = In(t, e.state.width || 1280, e.state.height || 720), m = (y) => l.x + y * l.w, p = (y) => l.y + y * l.h;
  ...
  for (const y of e.state.motion_layers || []) {
    ...
    if (c.strokeStyle = j ? "#ffcc4d" : "rgba(65,217,197,0.6)", c.lineWidth = (j ? 2.4 : 1.5) * n, c.beginPath(), v.forEach((M, P) => {
      const D = m(M.x), F = p(M.y);
      P ? c.lineTo(D, F) : c.moveTo(D, F);
    }), c.stroke(), !g) {
      c.fillStyle = j ? "#ffcc4d" : "#41d9c5";
      for (const M of v)
        c.beginPath(), c.arc(m(M.x), p(M.y), (j ? 3.4 : 2.4) * n, 0, Math.PI * 2), c.fill();
    }
    const x = zp(v, h);
...
function Lp(e, t) {
  ...
  a && a.addEventListener("click", (o) => {
    ...
    const s = In(a, e.state.width || 1280, e.state.height || 720), i = a.width / n.width, c = {
      x: ((o.clientX - n.left) * i - s.x) / Math.max(1, s.w),
      y: ((o.clientY - n.top) * i - s.y) / Math.max(1, s.h)
    }, l = ui(e.state.motion_layers, c, 0.09);
...
function Dp(e, t) {
  ...
  return {
    ...
    motion_scene_fingerprint: Jc(e.state)
  };
}
function Np(e, t) {
  const a = Dp(e, t);
...
function $r(e, t, { frameCount: a = 0, fps: o = 0 } = {}) {
...
function jt(e, t) {
  ...
  return !Number.isFinite(o) || o <= a ? null : `${e.name || "File"} is ${Ar(o)}; the maximum is ${Ar(a)}.`;
}
function qp(e) {
  return Number(e) <= Mr ? null : `${e} frames selected; a background sequence is limited to ${Mr}.`;
}
function Bp(e) {
...
function Wp(e) {
  ...
  e.audioElement && (uo(e, n), Promise.resolve(e.audioElement.play()).catch(() => {
  }));
...
async function Up(e, t, { decode: a = Vp } = {}) {
  ...
  try {
    ...
    zn(e), e.setStatus(`Audio loaded: ${t.name || "track"}`);
  } catch (n) {
    Qa(e), e.setStatus(`Failed to load audio: ${n.message || n}`);
  }
}
let Qe = null;
function Fn({ api: e }) {
...
const Ln = /* @__PURE__ */ new WeakSet(), yt = /* @__PURE__ */ new WeakMap();
function eo(e) {
...
function De(e, t, a, o = !1, n = "") {
  ...
  s && s !== a && Ct(e, t), o && Ln.add(a), Gp(a), e.cardMediaAssetById ||= /* @__PURE__ */ new Map(), e.cardMediaById.set(t, a), e.cardMediaAssetById.set(t, n || a?.__omnicamAsset || "");
  try {
    a.__omnicamAsset = n || a.__omnicamAsset || "";
  } catch {
  }
...
function On(e, t, { signal: a, timeout: o = 15e3 } = {}) {
...
async function Kn(e, t, a, o = () => !0, n = null) {
  if (!t || !a) return;
  const s = () => !e.disposed && o(), i = String(t.asset || a).toLowerCase();
  if (n ?? /\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/.test(i)) {
    const l = document.createElement("video");
    if (l.src = a, l.loop = !0, l.muted = !0, l.playsInline = !0, await On(l, ["loadeddata", "error"], { signal: e.abortController?.signal }).catch(() => {
    }), !s()) {
      eo(l);
      return;
    }
...
async function ef(e, t) {
  ...
  try {
    const c = await Oo(Qe, { route: "/majoor/omnicam/upload_model", field: "asset", file: t });
...
async function tf(e, t) {
  ...
  if (o) {
    ...
    try {
      const n = await Oo(Qe, { route: "/majoor/omnicam/upload_asset", field: "asset", file: t });
...
async function rf(e) {
  ...
  for (const f of i) {
    ...
    if (h) {
      if (d === "image" || d === "video") {
        ...
        if (b && b.value) {
          const u = String(b.value), y = /\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/i.test(u), g = h.widgets?.find((x) => String(x.name).toLowerCase() === "subfolder")?.value || "", v = Ke(Ge(u, g)), j = e.state.objects.find((x) => x.id === "subject");
          if (j) {
            const x = await Kn(e, j, v, n, y);
            if (!n()) return;
            j.asset = Ge(u, g);
            let M = null;
            if (y)
              try {
                M = await Zp(u, o.signal);
              } catch (P) {
          ...
          }), De(e, "subject", u, !1, u.currentSrc || u.src || ""), $r(e, u, { frameCount: u instanceof HTMLVideoElement ? 0 : 1 }), e.upstreamImageConnected = !0, s = !0, e.render(), e.setStatus(u instanceof HTMLVideoElement ? r("Upstream video preview synced") : r("Upstream image preview synced")));
        }
      }
      if (d === "audio") {
        l = !0;
        ...
        if (b && b.value) {
          const u = String(b.value), y = h.widgets?.find((v) => String(v.name).toLowerCase() === "subfolder")?.value || "", g = Ke(Ge(u, y));
          try {
      ...
      if (d === "scene_3d" || d === "model" || d === "mesh") {
        ...
        if (b && b.value) {
          ...
          if (["glb", "gltf", "obj", "fbx", "stl", "ply"].includes(y)) {
            const g = h.widgets?.find((M) => String(M.name).toLowerCase() === "subfolder")?.value || "", v = Ke(Ge(u, g)), j = `upstream_scene_${h.id}`;
            m.add(j);
            let x = e.state.objects.find((M) => M.id === j);
            x ? (x.asset = Ge(u, g), x.format = y === "gltf" ? "glb" : y) : (x = {
              id: j,
              type: "model",
              format: y === "gltf" ? "glb" : y,
  ...
  !l && e.upstreamAudioConnected && (Qa(e), e.upstreamAudioConnected = !1, e.refreshKeys(), s = !0, e.setStatus(r("Upstream audio disconnected · audio track cleared")));
  ...
  _c(e) && (s = !0), s && (e.serialize(), e.render());
}
const nf = ["video/mp4;codecs=avc1.42E01E", "video/webm;codecs=vp9", "video/webm;codecs=vp8", "video/webm"], Tr = { low: 3e6, balanced: 6e6, high: 12e6 };
function sf(e) {
  return Tr[e] || Tr.balanced;
}
async function cf({
  canvas: e,
  fps: t,
...
async function df(e) {
  await Promise.all([...e].filter((t) => t instanceof HTMLVideoElement && t.seeking).map((t) => On(t, ["seeked", "error"], { timeout: 5e3 }).catch(() => {
  })));
}
async function Dn(e) {
...
async function Rn(e, t) {
  ...
  if (Np(e, t), e.state.playblast_camera_id === Jr)
...
async function pf(e) {
  ...
  try {
    let s = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-DMceYn3n.js");
    i !== "realtime" && await l(e.canvas.width, e.canvas.height) && (s = await c(e.canvas, e.state.duration_frames, e.state.fps, async (m) => {
      e.setFrame(m, !0), e.setStatus(r(`Encoding frame ${m + 1}/${e.state.duration_frames}…`)), await Dn(e), await new Promise((p) => requestAnimationFrame(p));
    }, e.abortController?.signal, e.state.playblast_quality)), s || (e.setStatus(r("WebCodecs unavailable; recording realtime fallback…")), s = await Nn(e)), e.setFrame(t), await Rn(e, s);
  } catch (s) {
...
async function qn(e) {
  if (!wt) throw new Error("ComfyUI API is unavailable");
  return Oo(wt, { route: "/majoor/omnicam/upload_asset", field: "asset", file: e });
}
async function to(e) {
  const t = e.map((a) => String(a.relative || "").replace(/^omnicam\//, "")).filter(Boolean);
  if (!(!t.length || !wt))
    try {
      await wt.fetchApi("/majoor/omnicam/cleanup", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
...
async function hf(e, t) {
  ...
  let n = null;
  try {
    if (e.setStatus(`Uploading background: ${t.name}`), n = await qn(t), o !== e.backgroundRequestId || e.disposed) {
      await to([n]);
      return;
    }
    const s = Ke(n.path);
    ...
    if (n && await to([n]), o !== e.backgroundRequestId || e.disposed) return;
...
async function bf(e, t) {
  ...
  try {
    ...
    for (const c of t)
      if (s.push(await qn(c)), n !== e.backgroundRequestId || e.disposed) {
        await to(s);
        return;
      }
    ...
    if (await to(s), n !== e.backgroundRequestId || e.disposed) return;
    e.setStatus(`Failed to load BG sequence: ${i.message || i}`);
  }
}
function uf(e) {
  Vo(e), e.checkpoint?.("Clear background"), e.state.viewport_bg_image = "", e.state.viewport_bg_sequence = [], e.viewportBgImage = null, e.viewportBgSequenceImages = [], e.serialize(), e.render(), e.setStatus("Background cleared");
}
function gf(e) {
  ...
  for (const p of a) {
    if (p.enabled === !1 || !qr(p, { mode: t.mode, selectedIds: m })) continue;
    const f = Br(p, t.content);
    if (!f) continue;
    const d = Wr(a, p, l) || { position: p.position, size: p.size }, h = Pe(Vr(d, p.type), o, s, i);
    if (!h) continue;
    const [b, u] = h, y = t.content === "annotation" && p.annotation?.color || "", g = 6 * c, v = 4 * c, x = n.measureText(f).width + g * 2, M = 12 * c + v * 2, P = Math.round(b - x / 2), D = Math.round(u - M - 6 * c);
    n.fillStyle = "rgba(16,17,22,0.82)", yf(n, P, D, x, M, 4 * c), n.fill(), y && (n.strokeStyle = y, n.lineWidth = Math.max(1, c), n.stroke()), n.fillStyle = y || "#e6e6ec", n.fillText(f, P + g, D + M - v - 2 * c);
  }
  n.restore();
}
...
function xf(e) {
  ...
  return e._pointFieldCache?.key !== n && (e._pointFieldCache = { key: n, ...vi(t, a, o) }), e._pointFieldCache;
}
const wf = 600;
function kf(e) {
  const { points: t, colors: a } = xf(e);
  if (!t.length) return;
  const o = e.viewportCamera(), n = e.canvas.width, s = e.canvas.height, i = t.length / 3, c = 3 * Math.max(1, Math.ceil(i / wf)), l = /* @__PURE__ */ new Map();
...
function Cf(e, t) {
  const [a, o, n] = t.position || [0, 0, 0], s = t.size?.[1] || 1.8, i = (t.size?.[0] || 0.7) * 0.5, c = [a, o + s * 0.88, n], l = [a, o + s * 0.76, n], m = [a - i * 0.55, o + s * 0.73, n], p = [a + i * 0.55, o + s * 0.73, n], f = [a - i * 0.72, o + s * 0.52, n], d = [a + i * 0.72, o + s * 0.52, n], h = [a - i * 0.82, o + s * 0.34, n], b = [a + i * 0.82, o + s * 0.34, n], u = [a, o + s * 0.44, n], y = [a - i * 0.28, o + s * 0.44, n], g = [a + i * 0.28, o + s * 0.44, n], v = [a - i * 0.28, o + s * 0.22, n], j = [a + i * 0.28, o + s * 0.22, n], x = [a - i * 0.28, o, n + 0.05], M = [a + i * 0.28, o, n + 0.05];
  ne(e, c, l, "#aaa", 2), ne(e, l, u, "#aaa", 2), ne(e, m, p, "#aaa", 2), ne(e, m, f, "#aaa", 2), ne(e, f, h, "#aaa", 2), ne(e, p, d, "#aaa", 2), ne(e, d, b, "#aaa", 2), ne(e, y, g, "#aaa", 2), ne(e, y, v, "#aaa", 2), ne(e, v, x, "#aaa", 2), ne(e, g, j, "#aaa", 2), ne(e, j, M, "#aaa", 2);
  ...
  if (u)
    try {
      ...
      if (e.ctx.fillStyle = "#111", e.ctx.fillRect(f, h, y, g), x === "stretch" || !v || !j)
        ...
        const M = Math.min(y / v, g / j), P = v * M, D = j * M;
        e.ctx.drawImage(u, f + (y - P) / 2, h + (g - D) / 2, P, D);
      } else {
        const M = Math.max(y / v, g / j), P = y / M, D = g / M;
...
const Lf = 1, Pr = 0.01, Of = 0.4, Kf = 3, Df = 120, Nf = 20, Rf = 4, qf = 0.25, Bf = 0.5;
function Wf(e, t, a) {
...
function Hf({ keys: e, fps: t = 24, objects: a = [] } = {}) {
  ...
  for (const c of s)
    ...
    }), c.distance < Pr && c.duration >= Of && n.push({
      code: "STATIC_SEGMENT",
      severity: "info",
      frameStart: c.frameStart,
      frameEnd: c.frameEnd,
  ...
  for (let c = 1; c < o.length - 1; c += 1) {
    ...
    const d = Math.max(-1, Math.min(1, xi(l, m) / (p * f))), h = Math.acos(d) * 180 / Math.PI;
    h >= Df && n.push({
  ...
  if (o.length >= Rf) {
    ...
    let f = Math.abs(Ir(p, c, l) - Ir(m, c, l)) % 360;
    f > 180 && (f = 360 - f);
    const d = Be(Ee(p, m));
    f <= Nf && d > Pr && n.push({
...
function Gf(e, t, a) {
  ...
  return o || (t.keyframes?.length ? ao(t, a).position : t.position || [0, 1.5, 0]);
}
function vt(e, t, a, o) {
  if (!a) return a;
  const n = Wn(e, t, o);
...
function Yf(e, { perFrame: t = !1 } = {}) {
  const a = e.activeCameraTrack(), o = Ho(e, a), n = Uo(e, a);
...
function Vn(e) {
  ...
  const n = (d, h, b, u, y = "") => {
    ...
    `, y.addEventListener("click", () => {
      e.outlinerCollapsedSections ||= /* @__PURE__ */ new Set(), e.outlinerCollapsedSections.has(b) ? e.outlinerCollapsedSections.delete(b) : e.outlinerCollapsedSections.add(b), Vn(e);
  ...
  if (m) {
    ...
    if (t.appendChild(h), !b)
      for (const u of d) {
        ...
        const M = document.createElement("span");
        if (M.className = "scene-item-label", j || g) {
          const F = document.createElement("span");
          F.style.cssText = `color:${j ? "#f59e0b" : "#58cc6b"};font-weight:700`, F.textContent = j ? "● " : "○ ", M.appendChild(F);
        }
        if (M.appendChild(document.createTextNode(u.name)), v) {
          const F = document.createElement("span");
          F.style.cssText = "color:#f2d06b;font-size:10px", F.title = "Playblast Output", F.textContent = " ★", M.appendChild(F);
        }
        if (u.muted) {
          const F = document.createElement("span");
          F.style.opacity = ".6", F.textContent = " (muted)", M.appendChild(F);
        }
        ...
        )), P.appendChild(n("pi-ellipsis-v", "Camera actions", !1, (F) => e.openCameraContext(F, u.id, !1))), y.append(x, M, P), y.title = j ? r("Currently selected for editing") : v ? r("Active playblast camera") : r("Click to select & activate this camera");
        const D = () => {
  ...
  if (p) {
    ...
    const u = [], y = (x, M) => {
      u.push({ object: x, level: M });
      const P = h.get(x.id) || [];
      for (const D of P) y(D, M + 1);
    };
    for (const x of b) y(x, 0);
    const g = u.filter(({ object: x }) => {
      const M = [x.name, x.type, ...x.tags || [], x.asset_kind, x.asset_id].filter(Boolean).join(" ");
      return !(!i(M) || a === "lights" && !l(x.type) || a === "objects" && l(x.type) || a === "hidden" && x.enabled !== !1);
    }), { header: v, isCollapsed: j } = c(a === "lights" ? r("Lights") : r("Objects"), g.length, "objects");
    if (t.appendChild(v), !j)
      for (const { object: x, level: M } of g) {
        const P = document.createElement("div");
        ...
        P.setAttribute("aria-selected", String(D)), P.className = `scene-item${D ? " selected" : ""}${F ? " primary" : ""}${M > 0 && !s ? " scene-item-child" : ""}`, M > 0 && !s && (P.style.paddingLeft = `${M * 16 + 6}px`);
        ...
        k.className = "scene-item-label";
        const _ = document.createElement("span");
        _.style.cssText = V ? "color:#fca5a5" : B ? "" : "opacity:.5;text-decoration:line-through", _.textContent = x.name || x.type, _.title = r("Double-click to rename"), _.addEventListener("dblclick", ($) => {
          $.preventDefault(), $.stopPropagation(), Jf(e, x, _);
        }), k.appendChild(_);
        ...
        if (z.length) {
          ...
          for (const W of z.slice(0, 2)) {
            const C = document.createElement("span");
            C.className = "scene-item-tag", C.textContent = W, $.appendChild(C);
          }
          if (z.length > 2) {
            const W = document.createElement("span");
            W.className = "scene-item-tag scene-item-tag-more", W.textContent = `+${z.length - 2}`, $.appendChild(W);
          }
          k.appendChild($);
        }
        if (V) {
          const $ = document.createElement("span");
          $.style.cssText = "color:#ef4444;font-size:9px;font-weight:700", $.textContent = " [Format!]", k.appendChild($);
        }
        const N = document.createElement("div");
        N.className = "scene-item-actions", N.appendChild(n(B ? "pi-eye" : "pi-eye-slash", B ? "Hide object (Alt+Click to Isolate)" : "Show object (Alt+Click to Isolate)", !B, ($) => {
          if ($?.altKey) {
            ...
            e.toggleObject(x.id);
        }, "color:#ef4444;opacity:.7")), N.appendChild(n(x.locked ? "pi-lock" : "pi-lock-open", "Lock object", x.locked, () => No(e, x))), N.appendChild(n("pi-copy", "Duplicate object", !1, () => e.duplicateObject?.(x.id))), x.id !== "subject" && N.appendChild(n("pi-trash", "Delete object", !1, () => e.deleteObject?.(x.id))), N.appendChild(n("pi-ellipsis-v", "Object actions", !1, ($) => e.openObjectContext($, x.id))), P.append(Q, k, N), P.title = r("Click to select · Double-click to toggle visibility · Right-click for actions");
        const q = ($ = {}) => {
          ...
          else if ($.shiftKey && e.outlinerAnchorId && e.state.objects.some((C) => C.id === e.outlinerAnchorId)) {
        ...
        P.addEventListener("dblclick", () => e.toggleObject(x.id)), P.addEventListener("contextmenu", ($) => {
          $.preventDefault(), $.stopPropagation(), e.openObjectContext($, x.id);
        }), P.addEventListener("keydown", ($) => {
          ($.key === "Enter" || $.key === " ") && ($.preventDefault(), q($));
        }), t.appendChild(P);
      }
  }
...
function Qf(e, t) {
  ...
  e.state.objects.push(M), e.selectedEntity = "object", e.selectedObjectId = a, e.selectedObjectIds = /* @__PURE__ */ new Set([a]), e.selectedKeyFrame = null, e.serialize(), e.refreshObjects(), e.refreshKeys(), e.render();
}
async function eh(e, t) {
  const a = e.state.objects.find((n) => n.id === t);
  if (!a) return;
  const o = (await kt(e, r("Rename object"), r("Object name"), a.name || a.type))?.trim();
...
function rh(e) {
  ...
  a && (a.hidden = !t);
  const o = (k) => e.root.querySelector(k), n = e.activeCameraTrack(), s = o('[data-role="camera-target-object"]');
  if (s) {
    const k = n.target_object_id || e.state.target_object_id || "", _ = `T${er()}${e.state.objects.map((z) => `${z.id}\0${z.name || z.type}`).join("|")}`;
    go(s, _, () => [
  ...
  Zf(e);
  const i = [...e.camera.position, ...e.camera.target, e.camera.fov, e.camera.roll || 0, e.camera.near, e.camera.far, ...zo(e.camera)];
  ["camera-px", "camera-py", "camera-pz", "camera-tx", "camera-ty", "camera-tz", "camera-fov", "camera-roll", "camera-near", "camera-far", "camera-rx", "camera-ry", "camera-rz"].forEach((k, _) => {
    for (const z of e.root.querySelectorAll(`[data-role="${k}"]`))
      document.activeElement !== z && (z.value = String(Math.round(i[_] * 1e4) / 1e4));
  });
  for (const k of e.root.querySelectorAll('[data-role="camera-type"]'))
    document.activeElement !== k && (k.value = e.camera.camera_type || "perspective");
  for (const k of e.root.querySelectorAll('[data-role="speed"]'))
    document.activeElement !== k && (k.value = String(e.cameraSpeed || 1));
  for (const k of e.root.querySelectorAll('[data-role="active-camera-select"]'))
    document.activeElement !== k && (k.value = e.state.active_camera_id);
  for (const k of e.root.querySelectorAll('[data-role="camera-color"]'))
    document.activeElement !== k && (k.value = n?.color || "#4aa3ef");
  if (!t) {
    const k = o('[data-role="object-recon-badge"]');
    k && (k.hidden = !0);
    const _ = o('[data-role="selected-name"]');
    _ && (_.textContent = `${n.name} · F${e.frame}`), zr(o, {
  ...
  if (c) {
    ...
    if (k) {
      c.hidden = !1;
      const _ = k.semantic ? `${k.semantic} · ` : "";
      c.textContent = `${_}${k.label} (${Math.round(k.confidence * 100)}%)`, c.title = k.title, c.className = `oc-recon-badge oc-badge-${k.band}`;
    } else
      c.hidden = !0;
  }
  ...
  if (l) {
    ...
    const k = l.querySelector("i");
    k && (k.className = `pi ${t.locked ? "pi-lock" : "pi-lock-open"}`);
  }
  const m = t.position || [0, 0, 0], p = o('[data-role="selected-name"]');
  p && (p.textContent = t.name || t.type), zr(o, {
  ...
  for (const [k, _] of Object.entries(h))
    for (const z of e.root.querySelectorAll(`[data-role="${k}"]`))
      document.activeElement !== z && (z.value = String(Math.round(_ * 1e4) / 1e4));
  for (const k of e.root.querySelectorAll('[data-role="object-material"]'))
    document.activeElement !== k && (k.value = t.material_mode || "textured");
  for (const k of e.root.querySelectorAll('[data-role="object-color"]'))
    document.activeElement !== k && (k.value = t.color || "#8c929b");
  for (const k of e.root.querySelectorAll('[data-role="object-light-color"]'))
    document.activeElement !== k && (k.value = t.color || "#ffffff");
  for (const k of e.root.querySelectorAll("[data-transform-mode]")) k.classList.toggle("active", k.dataset.transformMode === (e.state.gizmo_mode || "translate"));
  const b = o('[data-role="animation-row"]'), u = o('[data-role="animation-select"]'), y = o('[data-role="object-parent"]');
  if (y) {
    const k = t.id, _ = /* @__PURE__ */ new Set([k]);
    let z = !0;
    for (; z; ) {
      z = !1;
      for (const $ of e.state.objects)
        !_.has($.id) && $.parent_id && _.has($.parent_id) && (_.add($.id), z = !0);
    }
    const N = e.state.objects.filter(($) => !_.has($.id)), q = `P${er()}${k}${N.map(($) => `${$.id} ${$.name || $.type}`).join("|")}`;
    go(y, q, () => [
      gt("", r("No parent")),
      ...N.map(($) => gt($.id, $.name || $.type))
    ], t.parent_id || "");
  }
  ...
  x && (x.hidden = !v);
  const M = o('[data-role="material-row"]');
  M && (M.hidden = g);
  const P = o('[data-role="scale-row"]');
  P && (P.hidden = g);
  const D = o('[data-role="rotation-row"]');
  if (D && (D.hidden = t.type === "point_light"), g) {
    const k = o('[data-role="object-intensity"]');
    k && document.activeElement !== k && (k.value = String(t.intensity ?? (t.type === "sun_light" ? 2.2 : t.type === "spot_light" ? 3 : 2)));
  ...
  if (b && (b.hidden = !F?.animations), u) {
    const k = F?.animationNames || [];
    go(u, `A${k.join("|")}`, () => k.map((_, z) => gt(String(z), _)), String(t.animation_index || 0));
  }
...
function ch(e) {
  ...
  e.beginCameraEdit(), wi(e.camera, n), e.commitCameraEdit(), e.finishCameraEdit(), Xn(e), ih(e), e.render();
}
function lh(e) {
  const t = globalThis.performance?.now?.() ?? Date.now();
  (!Number.isFinite(e.lastCameraHudEditAt) || t - e.lastCameraHudEditAt > 300) && e.checkpoint("Edit camera"), e.lastCameraHudEditAt = t;
  ...
  e.camera.position = [a("camera-px", e.camera.position[0]), a("camera-py", e.camera.position[1]), a("camera-pz", e.camera.position[2])], e.camera.target = [a("camera-tx", e.camera.target[0]), a("camera-ty", e.camera.target[1]), a("camera-tz", e.camera.target[2])], e.camera.fov = Z(a("camera-fov", e.camera.fov), 5, 150), e.camera.roll = Z(a("camera-roll", e.camera.roll || 0), -180, 180), e.camera.near = Math.max(1e-4, a("camera-near", e.camera.near)), e.camera.far = Math.max(e.camera.near + 1e-4, a("camera-far", e.camera.far)), e.beginCameraEdit(), e.commitCameraEdit(), e.finishCameraEdit(), Xn(e), e.render();
}
function dh(e, t) {
  const a = _t(e);
  if (!a) return;
...
function fh(e) {
  ...
  if (!t.length) return [];
  if (t.length === 1)
    return Hn(e, t[0]), e.selectedObjectId ? [e.selectedObjectId] : [];
...
function ve(e) {
  return ke(e)?.keyframes || e.state.keyframes;
}
function vh(e, t) {
...
function xh(e) {
  ...
  const t = e.root.querySelector('[data-role="key-interp"]')?.value || e.root.querySelector('[data-role="interp"]')?.value || "ease", a = ke(e), o = ve(e), n = a ? { frame: e.frame, transform: Ie(a), interpolation: t } : { frame: e.frame, camera: le(e.camera), interpolation: t }, s = o.findIndex((i) => i.frame === e.frame);
...
function Sh(e) {
  const t = ke(e), a = ze(e) || ve(e).find((o) => o.frame === e.frame);
...
function jh(e) {
  ...
  const t = ke(e), a = t ? "object" : "camera";
...
function Lh(e) {
  const t = ke(e), a = ze(e), o = e.root.querySelector('[data-role="key-editor"]');
...
function Kh(e) {
  const t = ze(e);
  if (!t) return;
  if (e.checkpoint("Edit keyframe"), e.editingKeyFrame = t.frame, ke(e)) {
    t.interpolation = e.root.querySelector('[data-role="key-interp"]').value, t.transform = Ie(ke(e)), e.serialize(), e.setFrame(t.frame), e.setStatus(r(`Object keyframe updated @ ${t.frame}`));
    return;
  }
  const a = (n, s) => {
  ...
  if (t.interpolation = e.root.querySelector('[data-role="key-interp"]').value, t.camera.position = [a("key-px", t.camera.position[0]), a("key-py", t.camera.position[1]), a("key-pz", t.camera.position[2])], t.camera.target = [a("key-tx", t.camera.target[0]), a("key-ty", t.camera.target[1]), a("key-tz", t.camera.target[2])], t.camera.fov = Z(a("key-fov", t.camera.fov), 5, 150), t.camera.roll = Z(a("key-roll", t.camera.roll || 0), -180, 180), t.camera.zoom = Math.max(0.01, a("key-zoom", t.camera.zoom || 1)), t.camera.near = Math.max(1e-4, a("key-near", t.camera.near)), t.camera.far = Math.max(t.camera.near + 1e-4, a("key-far", t.camera.far)), t.camera.camera_type = e.root.querySelector('[data-role="key-camera-type"]').value, e.root.querySelector('[data-role="key-timing-weight"]')) {
    const n = Si(t, a("key-timing-weight", Qr(t)));
...
function Bh(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: n, initializeTooltips: s, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: m, activeCameraTrack: p, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: b, syncActiveCameraTrack: u, syncFromWidgets: y, bindEditorEvents: g, activateCamera: v, addCamera: j, deleteCamera: x, drawPreviewOverlays: M, duplicateCamera: P, maximizeCameraPreview: D, refreshCameraPreviews: F, refreshCameraSelectors: U, renameCamera: B, setPlayblastCamera: V, toggleCameraView: Q, captureRealtime: k, makePlayblast: _, uploadDirectorPlayblast: z, waitForMediaFrame: N, computeAudioPeaks: q, loadAudioFile: $, releaseAudio: W, stopPlay: C, togglePlay: R, applyCameraPreset: G, applyCameraShake: ae, applyProxyPreset: oe, clearViewportBgImage: ee, loadViewportBgFile: se, loadViewportBgSequence: pe, drawCameraPath: de, drawCard: he, drawCube: be, drawGrid: O, drawHuman: H, drawLine3D: ie, drawNull: ce, drawOverlays: me, drawPointField: re, drawSpeedHeatmap: we, drawSphere: Et, curveChannels: $t, drawCurveEditor: at, onCurvePointerDown: ot, onCurvePointerMove: rt, onCurvePointerUp: nt, onTimelinePointerDown: Mt, onTimelinePointerMove: At, onTimelinePointerUp: Tt, refreshKeys: st, resetCurveZoom: it, resetTimelineZoom: Ve, setChannelFilter: ct, setCurveInterpolation: lt, setTangentMode: dt, timelineFrameFromEvent: Pt, toggleCurveHandles: mt, zoomCurve: It, drawTransformGizmo: zt, frameTarget: Ft, gizmoAxes: Lt, gizmoGeometry: Ot, onPointerDown: Kt, onPointerMove: Dt, onPointerUp: Nt, onWheel: Rt, pickGizmo: qt, pickSceneObject: Bt, resetCamera: pt, setTransformMode: ft, setViewMode: Wt, viewportCamera: Vt, loadCardFile: ro, loadExecutionPreview: no, loadMediaUrl: Ht, loadModelFile: Ut, loadSelectedReference: Gt, onModelLoaded: Xt, restoreAssets: Yt, syncUpstreamInputs: Zt, configureDomMedia: Jt, refreshSetupDiagnostic: ht, addMediaCard: Qt, addPrimitive: ea, applyObjectAnimationFrame: ta, beginCameraEdit: aa, beginObjectEdit: oa, commitCameraEdit: ra, commitObjectEdit: na, copyKeyframe: sa, deleteKeyframe: ia, deleteObject: ca, duplicateObject: la, exitKeyEdit: da, finishCameraEdit: ma, goToAdjacentKey: pa, insertKeyframe: fa, loadSelectedKeyView: ha, pasteKeyframe: ba, playblastCameraAtFrame: ua, refreshInspector: ga, refreshKeyEditor: ya, refreshObjects: va, removeObjectResources: xa, renameObject: wa, retimeSelectedKey: ka, selectKeyframe: Sa, selectedKeyframe: ja, selectedObject: Ca, selectObjectAnimation: _a, setKeyInterpolation: Ea, setObjectParent: $a, timelineKeyframes: Ma, timelineObject: Ne, toggleAutoKey: Aa, toggleObject: Ta, updateCameraFromHud: Pa, updateEditState: Ia, updateKeyVisualState: za, updateSelectedKey: Fa, updateSelectedObject: La, clamp: bt, cloneCamera: Oa, configureCore: Ka, defaultCamera: Da, sampleCamera: Fe, sampleObjectTransform: so, sanitizeState: He, worldTransform: Se } = e;
  return {
    setSelectMode(I) {
    ...
    restoreHistorySnapshot(I) {
      ...
      const S = Fr(this.state), w = new Set(this.state.objects.map((Y) => Y.id));
      this.state = He(T.state);
      const E = new Set(this.state.objects.map((Y) => Y.id));
      for (const Y of w) E.has(Y) || this.removeObjectResources(Y);
      this.frame = bt(T.frame, 0, this.state.duration_frames - 1);
      const A = new Set(this.state.objects.map((Y) => Y.id)), K = Array.isArray(T.selectedObjectIds) ? T.selectedObjectIds : [T.selectedObjectId].filter(Boolean);
      this.selectedObjectIds = new Set(K.filter((Y) => A.has(Y))), this.selectedObjectId = this.selectedObjectIds.has(T.selectedObjectId) ? T.selectedObjectId : [...this.selectedObjectIds].at(-1) || null, this.selectedEntity = this.selectedObjectIds.size ? "object" : T.selectedEntity || "camera";
      ...
      this.selectedKeyFrames = new Set(L.filter((Y) => X.has(Y))), this.selectedKeyFrame = this.selectedKeyFrames.has(T.selectedKeyFrame) ? T.selectedKeyFrame : [...this.selectedKeyFrames].at(-1) ?? null, this.pathSelection = ji(this.pathSelection, this.activeCameraTrack()), this.subSelection = T.subSelection || null, this.camera = Fe(this.state, this.frame), vt(this, this.activeCameraTrack(), this.camera, this.frame), this.cameraPreviewSignature = "", this.serialize(), S !== Fr(this.state) && this.restoreAssets(), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
    },
    checkpoint(I) {
    ...
    onContextMenu(I) {
      ...
      const T = I.target, S = T.closest?.(".camera-preview-tile"), w = T.closest?.(".scene-item"), E = T.closest?.(".key");
      if (S) return this.openCameraContext(I, S.dataset.cameraId, !0);
      if (w?.dataset.cameraId) return this.openCameraContext(I, w.dataset.cameraId, !1);
      if (w?.dataset.objectId) return this.openObjectContext(I, w.dataset.objectId);
      if (E) {
        const A = this.timelineKeyframes().find((K) => K.frame === Number(E.dataset.keyFrame));
        return A && this.selectKeyframe(A), this.openTimelineContext(I, !0);
      }
      ...
      if (T.closest?.('[data-role="dope-stage"]')) return this.openTimelineContext(I, !1);
      if (T.closest?.(".curve-editor")) return this.openCurveContext(I);
      if (T.closest?.(".viewport-wrap")) {
        const A = this.interactionElement.getBoundingClientRect(), K = (I.clientX - A.left) * this.canvas.width / Math.max(1, A.width), X = (I.clientY - A.top) * this.canvas.height / Math.max(1, A.height), L = this.pickSceneObject([K, X]);
        if (L) {
    ...
    openObjectContext(I, T) {
      const S = this.state.objects.find((A) => A.id === T);
      if (!S) return;
      ...
      const w = ["sun_light", "point_light", "spot_light"].includes(S.type), E = this.selectedObjectIds?.size || 0;
      ...
      this.showContextMenu(I, S.name || S.type, [
        ...
        { label: S.locked ? r("Unlock object") : r("Lock object"), icon: S.locked ? "pi-lock" : "pi-lock-open", run: () => No(this, S) },
        null,
        {
          label: r("Transform mode"),
          icon: "pi-arrows-alt",
          items: [
            { label: r("Translate"), icon: "pi-arrows-alt", shortcut: "W", checked: (this.state.gizmo_mode || "translate") === "translate", run: () => this.setTransformMode("translate") },
            { label: r("Rotate"), icon: "pi-refresh", shortcut: "E", checked: this.state.gizmo_mode === "rotate", run: () => this.setTransformMode("rotate") },
            { label: r("Scale"), icon: "pi-expand", shortcut: "R", disabled: w, checked: this.state.gizmo_mode === "scale", run: () => this.setTransformMode("scale") }
          ]
        },
        {
    ...
    openCameraContext(I, T, S = !1) {
      const w = this.state.cameras.find((E) => E.id === T);
      w && (this.selectedEntity = "camera", this.selectedObjectId = null, this.activateCamera(T), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), this.showContextMenu(I, `${w.name}${S ? " preview" : ""}`, [
        { label: r("Edit this camera"), icon: "pi-video", run: () => this.activateCamera(T) },
        {
          ...
          run: () => {
            this.activateCamera(T), this.selectCameraPath() && this.setStatus(`${w.name} · ${r("whole path selected — move / scale / rotate")}`);
          }
        },
    ...
    openPathKeyContext(I, T, S) {
      const w = this.state.cameras.find((Y) => Y.id === T);
      if (!w) return;
      this.selectedEntity = "camera", this.selectedObjectId = null, this.activateCamera(T);
      const E = (w.keyframes || []).find((Y) => Y.frame === S) || null;
      E && this.selectKeyframe(E), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
      const A = E ? mo(E) : "auto", K = this.selectedKeyFrames?.size || 0, X = this.pathSelection?.component === "target", L = Xr(w, this.state.objects);
    ...
    moveShot(I, T) {
      const S = this.state.cameras.findIndex((A) => A.id === I), w = S + T;
    ...
    async editShotHandles(I) {
      const T = this.state.cameras.find((A) => A.id === I);
      if (!T) return;
      const S = T.handles || { in: 0, out: 0 }, w = await i(t, r("Shot handles…"), "Handle frames: in,out", `${S.in},${S.out}`);
      if (w == null) return;
    ...
    openTimelineContext(I, T) {
      const S = this.selectedKeyFrames?.size || 0, w = this.selectedKeyframe(), E = w?.interpolation || "ease", A = w && mo(w) || "auto", K = ["ease", "linear", "bezier", "smooth", "ease_in", "ease_out", "sine", "cubic", "quintic", "expo", "back"], X = ["auto", "clamped", "vector", "free", "aligned", "flat"];
      this.showContextMenu(I, T ? `Keyframe F${this.selectedKeyFrame}` : `Timeline F${this.frame}`, [
        { label: r("Fit timeline view (F)"), icon: "pi-arrows-alt", shortcut: "F", run: () => Ve(this) },
        { label: r("Set / replace key"), icon: "pi-key", shortcut: "I", run: () => this.insertKeyframe() },
        { label: r("Copy selected key"), icon: "pi-copy", shortcut: "Ctrl+C", disabled: !w, run: () => this.copyKeyframe() },
    ...
    removeNearestMarker() {
      ...
      if (!I.length) return;
      const T = I.reduce((S, w) => Math.abs(w.frame - this.frame) < Math.abs(S.frame - this.frame) ? w : S);
    ...
    openCurveContext(I) {
      const T = this.selectedKeyFrames?.size || 0, S = T < 2 && !this.selectedKeyframe(), w = this.selectedKeyframe(), E = w?.interpolation || "ease", A = w && mo(w) || "auto", K = ["bezier", "smooth", "linear", "ease_in", "ease_out", "ease", "sine", "cubic", "quintic", "expo", "back"], X = ["auto", "clamped", "vector", "free", "aligned", "flat"];
    ...
    resizeCanvas() {
      ...
      if (!I) return;
      const T = Math.min(2, window.devicePixelRatio || 1), S = I.clientWidth || 320, w = I.clientHeight || 180, E = Math.max(320, Math.round(S * T)), A = Math.max(180, Math.round(w * T));
      (this.canvas.width !== E || this.canvas.height !== A) && (this.canvas.width = E, this.canvas.height = A);
...
function Xh(e) {
  const t = Jn(e);
  return Lr[t] ? Lr[t] : e.selectedEntity === "object" ? "scene" : "camera";
}
function Yh(e) {
  return [
    e.selectedEntity || "",
...
function Zh(e) {
  const t = Yh(e);
  e._lastInspectorSelKey !== void 0 && e._lastInspectorSelKey !== t && (e.inspectorMode = "entity"), e._lastInspectorSelKey = t, Qn(e);
}
function Qn(e) {
  const t = Xh(e);
...
function Jh(e, t) {
  e.inspectorMode = Gh.includes(t) ? t : "entity", Qn(e), e.render?.(), e.refitNode?.();
}
function Qh(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: n, initializeTooltips: s, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: m, activeCameraTrack: p, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: b, syncActiveCameraTrack: u, syncFromWidgets: y, bindEditorEvents: g, activateCamera: v, addCamera: j, deleteCamera: x, drawPreviewOverlays: M, duplicateCamera: P, maximizeCameraPreview: D, refreshCameraPreviews: F, refreshCameraSelectors: U, renameCamera: B, setPlayblastCamera: V, toggleCameraView: Q, captureRealtime: k, makePlayblast: _, uploadDirectorPlayblast: z, waitForMediaFrame: N, computeAudioPeaks: q, loadAudioFile: $, releaseAudio: W, stopPlay: C, togglePlay: R, applyCameraPreset: G, applyCameraShake: ae, applyProxyPreset: oe, clearViewportBgImage: ee, loadViewportBgFile: se, loadViewportBgSequence: pe, drawCameraPath: de, drawCard: he, drawCube: be, drawGrid: O, drawHuman: H, drawLine3D: ie, drawNull: ce, drawOverlays: me, drawPointField: re, drawSpeedHeatmap: we, drawSphere: Et, curveChannels: $t, drawCurveEditor: at, onCurvePointerDown: ot, onCurvePointerMove: rt, onCurvePointerUp: nt, onTimelinePointerDown: Mt, onTimelinePointerMove: At, onTimelinePointerUp: Tt, refreshKeys: st, resetCurveZoom: it, resetTimelineZoom: Ve, setChannelFilter: ct, setCurveInterpolation: lt, setTangentMode: dt, timelineFrameFromEvent: Pt, toggleCurveHandles: mt, zoomCurve: It, drawTransformGizmo: zt, frameTarget: Ft, gizmoAxes: Lt, gizmoGeometry: Ot, onPointerDown: Kt, onPointerMove: Dt, onPointerUp: Nt, onWheel: Rt, pickGizmo: qt, pickSceneObject: Bt, resetCamera: pt, setTransformMode: ft, setViewMode: Wt, viewportCamera: Vt, loadCardFile: ro, loadExecutionPreview: no, loadMediaUrl: Ht, loadModelFile: Ut, loadSelectedReference: Gt, onModelLoaded: Xt, restoreAssets: Yt, syncUpstreamInputs: Zt, configureDomMedia: Jt, refreshSetupDiagnostic: ht, addMediaCard: Qt, addPrimitive: ea, applyObjectAnimationFrame: ta, beginCameraEdit: aa, beginObjectEdit: oa, commitCameraEdit: ra, commitObjectEdit: na, copyKeyframe: sa, deleteKeyframe: ia, deleteObject: ca, deleteSelectedObjects: la, duplicateObject: da, exitKeyEdit: ma, finishCameraEdit: pa, goToAdjacentKey: fa, insertKeyframe: ha, loadSelectedKeyView: ba, pasteKeyframe: ua, playblastCameraAtFrame: ga, refreshInspector: ya, refreshKeyEditor: va, refreshObjects: xa, removeObjectResources: wa, renameObject: ka, retimeSelectedKey: Sa, selectKeyframe: ja, selectedKeyframe: Ca, selectedObject: _a, selectObjectAnimation: Ea, setKeyInterpolation: $a, setKeyTangentMode: Ma, setObjectParent: Ne, timelineKeyframes: Aa, timelineObject: Ta, toggleAutoKey: Pa, toggleObject: Ia, updateCameraFromHud: za, updateCameraRotationFromHud: Fa, updateEditState: La, updateKeyVisualState: bt, updateSelectedKey: Oa, updateSelectedObject: Ka, clamp: Da, cloneCamera: Fe, configureCore: so, defaultCamera: He, sampleCamera: Se, sampleObjectTransform: I, sanitizeState: T, worldTransform: S } = e;
  return {
    setChannelFilter(w) {
      ct(this, w);
    },
    setFrame(w, E = !1, A = !0) {
      this.frame = Da(Math.round(w), 0, this.state.duration_frames - 1), this.editingKeyFrame !== this.frame && (this.editingKeyFrame = null), this.camera = Se(this.activeCameraTrack(), this.frame, this.state.objects), vt(this, this.activeCameraTrack(), this.camera, this.frame), this.applyObjectAnimationFrame();
      const K = this.dom ||= Sn(this.root);
      ...
      for (const J of K.cameraFocal) document.activeElement !== J && (J.value = Fo(this.camera.fov));
    ...
    setSpatialHandleMode(w) {
      if (!an.includes(w)) return;
      const A = this.activeCameraTrack()?.keyframes || [], K = A.findIndex((X) => X.frame === this.selectedKeyFrame);
      if (K < 0) {
        this.setStatus(r("Select a camera keyframe first"));
        return;
      }
      this.checkpoint(r("Camera path handle: {mode}").replace("{mode}", w)), ic(A[K], w, {
        prevKey: A[K - 1] || null,
        nextKey: A[K + 1] || null
    ...
    setPathSelectionComponent(w) {
      this.pathSelection = Ei(this.pathSelection, w), this.refreshInspector(), this.render();
    },
    ...
    transformCameraPath(w) {
      ...
      const A = Yr(E.keyframes, { origin: Gr(E.keyframes), ...w });
      return E.keyframes = A, E.id === this.state.active_camera_id && (this.state.keyframes = A), this.camera = Se(E, this.frame, this.state.objects), E.camera = Fe(this.camera), this.serialize(), this.refreshKeys(), this.refreshInspector(), this.render(), this.renderCameraView?.(), !0;
    },
    ...
    redistributeActiveCameraTiming() {
      ...
      if (!w || w.locked || !(w.keyframes?.length >= 2))
        return w?.keyframes?.length < 2 && this.setStatus(r("Need at least two keys to redistribute timing")), !1;
      const E = [...w.keyframes].sort((K, X) => K.frame - X.frame), A = Ci(E, {
        startFrame: E[0].frame,
        endFrame: E[E.length - 1].frame
      });
      return A.ok ? (this.checkpoint(r("Redistribute camera path timing")), w.keyframes = A.keys, w.id === this.state.active_camera_id && (this.state.keyframes = A.keys), this.camera = Se(w, this.frame, this.state.objects), w.camera = Fe(this.camera), this.serialize(), this.refreshKeys(), this.refreshKeyEditor(), this.refreshInspector(), this.render(), this.setStatus(r("Camera path timing redistributed")), !0) : (this.setStatus(A.reason === "insufficient_frame_slots" ? r("Not enough frame slots to redistribute this many keys") : r("Could not redistribute timing")), !1);
    },
    ...
    async openCameraPathPresetPicker() {
      const w = this.activeCameraTrack();
      if (!w || w.locked)
        return this.setStatus(r("{name} is locked").replace("{name}", w?.name || r("Camera"))), !1;
      const E = rc.map((K) => ({ id: K, label: r(tr[K] || K) })), A = await on({ title: r("Camera Path Preset"), items: E, owner: this });
      return A ? this.applyCameraPathPreset(A) : !1;
    },
    applyCameraPathPreset(w, E = {}) {
      const A = this.activeCameraTrack();
      if (!A || A.locked)
        return this.setStatus(r("{name} is locked").replace("{name}", A?.name || r("Camera"))), !1;
      const [K, X] = $o(this.state), L = oc({ type: w, camera: this.camera, startFrame: K, endFrame: X, params: E });
      return L.ok ? (this.checkpoint(r("Apply camera path preset")), A.keyframes = L.keyframes, A.id === this.state.active_camera_id && (this.state.keyframes = L.keyframes), this.camera = Se(A, this.frame, this.state.objects), A.camera = Fe(this.camera), this.serialize(), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), this.setStatus(r("{preset} camera path generated").replace("{preset}", r(tr[w] || w))), !0) : (this.setStatus(L.reason === "insufficient_frame_slots" ? r("Not enough frames in the playback range for this preset") : r("Could not generate that camera path preset")), !1);
    },
    toggleCurveHandles() {
      mt(this);
    },
    ...
    toggleInspector(w) {
      ...
      if (!E) return;
      const A = w !== void 0 ? w : E.dataset.collapsed !== "true";
      E.dataset.collapsed = String(A);
      for (const K of this.root.querySelectorAll('[data-act="toggle-inspector"]'))
        K.classList.toggle("active", !A), K.setAttribute("aria-pressed", String(!A));
    ...
    selectHierarchy(w = this.selectedObjectId) {
      ...
      for (; A; ) {
        ...
        for (const K of this.state.objects)
          K.parent_id && E.has(K.parent_id) && !E.has(K.id) && (E.add(K.id), A = !0);
      }
    ...
    lookAtObject(w) {
      const E = this.state.objects.find((A) => A.id === w);
      if (E) {
        this.checkpoint("Look-at constraint");
        for (const A of this.state.cameras)
          for (const K of A.keyframes) K.camera.target = [...E.position || [0, 1.5, 0]];
    ...
    aimAtSelectedObject(w) {
      ...
      const E = this.activeCameraTrack(), A = w && this.state.objects.find((L) => L.id === w) || this.selectedObject() || this.state.objects.find((L) => L.id === "subject") || this.state.objects[0];
      if (!A) return;
      E.target_object_id !== A.id && (E.aim_bone = null), E.target_object_id = A.id, E.id === this.state.active_camera_id && (this.state.target_object_id = A.id, this.state.aim_bone = E.aim_bone);
      const X = (A.type === "model" || A.type === "glb" ? this.webgl?.getObjectWorldCenter?.(A.id) : null) || (A.keyframes?.length ? I(A, this.frame).position : A.position || [0, 1.5, 0]);
      this.camera.target = [...X], this.beginCameraEdit(), this.commitCameraEdit(), this.finishCameraEdit(), this.serialize(), this.refreshInspector(), this.updateHudCamera(), this.render(), this.setStatus(`Camera tracking locked to ${A.name || A.id}`);
    },
    setAimBone(w) {
      Xf(this, w);
    },
    ...
    setCameraTrackingTarget(w) {
      ...
      const E = this.activeCameraTrack();
      E.target_object_id !== (w || null) && (E.aim_bone = null), E.target_object_id = w || null, E.id === this.state.active_camera_id && (this.state.target_object_id = w || null, this.state.aim_bone = E.aim_bone), this.camera = Se(E, this.frame, this.state.objects), vt(this, E, this.camera, this.frame), this.serialize(), this.refreshInspector(), this.render(), this.setStatus(w ? `Camera tracking: ${w}` : "Camera tracking disabled (manual target)");
    },
    bakeAimToKeyframes() {
      this.checkpoint("Bake aim to keyframes");
      const w = this.activeCameraTrack(), E = w.target_object_id || this.state.target_object_id || "subject", A = this.state.objects.find((X) => X.id === E) || this.state.objects[0];
      if (!A || !w.keyframes?.length) return;
      const K = A.type === "model" || A.type === "glb" ? this.webgl?.getObjectWorldCenter?.(A.id) : null;
      for (const X of w.keyframes) {
        const L = (A.type === "model" || A.type === "glb") && K && !A.keyframes?.length ? K : A.keyframes?.length ? I(A, X.frame).position : A.position || [0, 1.5, 0];
        X.camera.target = [...L];
      }
...
function eb(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: n, initializeTooltips: s, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: m, activeCameraTrack: p, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: b, syncActiveCameraTrack: u, syncFromWidgets: y, bindEditorEvents: g, activateCamera: v, addCamera: j, deleteCamera: x, drawPreviewOverlays: M, duplicateCamera: P, maximizeCameraPreview: D, refreshCameraPreviews: F, refreshCameraSelectors: U, renameCamera: B, setPlayblastCamera: V, toggleCameraView: Q, captureRealtime: k, makePlayblast: _, uploadDirectorPlayblast: z, waitForMediaFrame: N, computeAudioPeaks: q, loadAudioFile: $, releaseAudio: W, stopPlay: C, togglePlay: R, applyCameraPreset: G, applyCameraShake: ae, applyProxyPreset: oe, clearViewportBgImage: ee, loadViewportBgFile: se, loadViewportBgSequence: pe, drawCameraPath: de, drawCard: he, drawCube: be, drawGrid: O, drawHuman: H, drawLine3D: ie, drawNull: ce, drawOverlays: me, drawPointField: re, drawSpeedHeatmap: we, drawSphere: Et, curveChannels: $t, drawCurveEditor: at, fitCurveView: ot, onCurveDoubleClick: rt, onCurvePointerDown: nt, onCurvePointerMove: Mt, onCurvePointerUp: At, onTimelinePointerDown: Tt, onTimelinePointerMove: st, onTimelinePointerUp: it, refreshKeys: Ve, resetCurveZoom: ct, resetTimelineZoom: lt, setChannelFilter: dt, setCurveInterpolation: Pt, setTangentMode: mt, timelineFrameFromEvent: It, toggleCurveHandles: zt, zoomCurve: Ft, drawTransformGizmo: Lt, frameTarget: Ot, gizmoAxes: Kt, gizmoGeometry: Dt, onPointerDown: Nt, onPointerMove: Rt, onPointerUp: qt, onWheel: Bt, pickGizmo: pt, pickSceneObject: ft, resetCamera: Wt, setTransformMode: Vt, setViewMode: ro, viewportCamera: no, loadCardFile: Ht, loadExecutionPreview: Ut, loadMediaUrl: Gt, loadModelFile: Xt, loadSelectedReference: Yt, onModelLoaded: Zt, restoreAssets: Jt, syncUpstreamInputs: ht, configureDomMedia: Qt, refreshSetupDiagnostic: ea, addMediaCard: ta, addPrimitive: aa, applyObjectAnimationFrame: oa, beginCameraEdit: ra, beginObjectEdit: na, commitCameraEdit: sa, commitObjectEdit: ia, copyKeyframe: ca, deleteKeyframe: la, deleteObject: da, duplicateObject: ma, exitKeyEdit: pa, finishCameraEdit: fa, goToAdjacentKey: ha, insertKeyframe: ba, loadSelectedKeyView: ua, pasteKeyframe: ga, playblastCameraAtFrame: ya, refreshInspector: va, refreshKeyEditor: xa, refreshObjects: wa, removeObjectResources: ka, renameObject: Sa, retimeSelectedKey: ja, selectKeyframe: Ca, selectedKeyframe: _a, selectedObject: Ea, selectObjectAnimation: $a, setKeyInterpolation: Ma, setObjectParent: Ne, timelineKeyframes: Aa, timelineObject: Ta, toggleAutoKey: Pa, toggleObject: Ia, updateCameraFromHud: za, updateEditState: Fa, updateKeyVisualState: La, updateSelectedKey: bt, updateSelectedObject: Oa, clamp: Ka, cloneCamera: Da, configureCore: Fe, defaultCamera: so, sampleCamera: He, sampleObjectTransform: Se, sanitizeState: I, worldTransform: T } = e;
  return {
    setTargetAtCursor(S) {
      if (!S) return;
      const w = this.interactionElement.getBoundingClientRect(), E = (S.clientX - w.left) * this.canvas.width / Math.max(1, w.width), A = (S.clientY - w.top) * this.canvas.height / Math.max(1, w.height), K = this.webgl?.intersectScenePoint?.(E, A, this.canvas.width, this.canvas.height);
    ...
    async loadMediaUrl(S, w, E, A) {
      return Gt(this, S, w, E, A);
    },
    restoreAssets() {
      Jt(this);
    },
...
function ab(e) {
  const { right: t, up: a, forward: o } = $i(e || {});
  return tb.map((n) => {
...
const nb = "http://www.w3.org/2000/svg", Xe = 26, Or = 17, sb = 5.4;
function Ye(e, t) {
...
function ib(e) {
  ...
  for (const s of ob(ab(a))) {
    const i = Xe + s.x * Or, c = Xe + s.y * Or, l = rb(s.depth);
    t.appendChild(Ye("line", {
      x1: Xe,
      y1: Xe,
      x2: i,
      y2: c,
...
const db = ["world_point", "object_point", "camera_field"], es = {
  manual_2d: "DRAW",
  object_point: "OBJECT",
  world_point: "WORLD",
...
function pb(e, t) {
  if (db.includes(t.source_kind)) {
    const a = Io(e, t.source, 0, e.width || 1280, e.height || 720);
...
function bb(e) {
  ...
  s("motion-sel-name", a.label), s("motion-sel-type", es[a.source_kind] || "TRACK"), s("motion-sel-binding", mb(e.state, a)), s("motion-sel-start", n.length ? Math.min(...n) : 0), s("motion-sel-end", n.length ? Math.max(...n) : 0);
...
function yb(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: n, initializeTooltips: s, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: m, activeCameraTrack: p, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: b, syncActiveCameraTrack: u, syncFromWidgets: y, bindEditorEvents: g, activateCamera: v, addCamera: j, deleteCamera: x, drawPreviewOverlays: M, duplicateCamera: P, maximizeCameraPreview: D, refreshCameraPreviews: F, refreshCameraSelectors: U, renameCamera: B, setPlayblastCamera: V, toggleCameraView: Q, captureRealtime: k, makePlayblast: _, uploadDirectorPlayblast: z, waitForMediaFrame: N, computeAudioPeaks: q, loadAudioFile: $, releaseAudio: W, stopPlay: C, togglePlay: R, applyCameraPreset: G, applyCameraShake: ae, applyProxyPreset: oe, clearViewportBgImage: ee, loadViewportBgFile: se, loadViewportBgSequence: pe, drawCameraPath: de, drawCard: he, drawCube: be, drawCylinder: O, drawGrid: H, drawHuman: ie, drawLine3D: ce, drawNull: me, drawOverlays: re, drawPointField: we, drawSpeedHeatmap: Et, drawSphere: $t, drawTorus: at, curveChannels: ot, drawCurveEditor: rt, onCurvePointerDown: nt, onCurvePointerMove: Mt, onCurvePointerUp: At, onTimelinePointerDown: Tt, onTimelinePointerMove: st, onTimelinePointerUp: it, refreshKeys: Ve, resetCurveZoom: ct, resetTimelineZoom: lt, setChannelFilter: dt, setCurveInterpolation: Pt, setTangentMode: mt, timelineFrameFromEvent: It, toggleCurveHandles: zt, zoomCurve: Ft, drawTransformGizmo: Lt, frameTarget: Ot, gizmoAxes: Kt, gizmoGeometry: Dt, onPointerDown: Nt, onPointerMove: Rt, onPointerUp: qt, onWheel: Bt, pickGizmo: pt, pickSceneObject: ft, resetCamera: Wt, setTransformMode: Vt, setViewMode: ro, viewportCamera: no, loadCardFile: Ht, loadExecutionPreview: Ut, loadMediaUrl: Gt, loadModelFile: Xt, loadSelectedReference: Yt, onModelLoaded: Zt, restoreAssets: Jt, syncUpstreamInputs: ht, configureDomMedia: Qt, refreshSetupDiagnostic: ea, addMediaCard: ta, addPrimitive: aa, applyObjectAnimationFrame: oa, beginCameraEdit: ra, beginObjectEdit: na, commitCameraEdit: sa, commitObjectEdit: ia, copyKeyframe: ca, deleteKeyframe: la, deleteObject: da, duplicateObject: ma, exitKeyEdit: pa, finishCameraEdit: fa, goToAdjacentKey: ha, insertKeyframe: ba, loadSelectedKeyView: ua, pasteKeyframe: ga, playblastCameraAtFrame: ya, refreshInspector: va, refreshKeyEditor: xa, refreshObjects: wa, removeObjectResources: ka, renameObject: Sa, retimeSelectedKey: ja, selectKeyframe: Ca, selectedKeyframe: _a, selectedObject: Ea, selectObjectAnimation: $a, setKeyInterpolation: Ma, setObjectParent: Ne, timelineKeyframes: Aa, timelineObject: Ta, toggleAutoKey: Pa, toggleObject: Ia, updateCameraFromHud: za, updateEditState: Fa, updateKeyVisualState: La, updateSelectedKey: bt, updateSelectedObject: Oa, clamp: Ka, cloneCamera: Da, configureCore: Fe, defaultCamera: so, sampleCamera: He, sampleObjectTransform: Se, sanitizeState: I, worldTransform: T } = e;
  return {
    ...
    renderViewportOnly() {
      const S = this.ctx, w = this.canvas.width, E = this.canvas.height;
      if (S.fillStyle = this.state.viewport_bg_color || "#121212", S.fillRect(0, 0, w, E), this.viewportBgSequenceImages && this.viewportBgSequenceImages.length) {
      ...
      if (this.webgl) {
        try {
          const te = this.recording ? 1 : this.webgl.supersampleFactor?.() ?? 1, Le = te > 1 ? Math.min(te, 4096 / Math.max(1, w, E)) : 1, Na = Le > 1 ? Math.round(w * Le) : w, io = Le > 1 ? Math.round(E * Le) : E;
          this.webgl.activeCamera && this.transformControlsWiring?.sync(), this.webgl.render(Re, K, this.cardMediaById, Na, io, this.modelUrlsById, this.frame, this.recording, this.selectedEntity, this.selectedObjectId, this.subSelection, this.selectedKeyFrame ?? null, this.selectedKeyFrames ? [...this.selectedKeyFrames] : null), S.imageSmoothingEnabled = !0, S.imageSmoothingQuality = "high", Na !== w || io !== E ? S.drawImage(this.webgl.canvas, 0, 0, Na, io, 0, 0, w, E) : S.drawImage(this.webgl.canvas, 0, 0, w, E), J = !0;
        } catch (te) {
    ...
    requestUiUpdate(S = je.viewport, w = "unknown") {
      (this.renderReasons ||= /* @__PURE__ */ new Set()).add(w), this.uiDirtyMask = cc(this.uiDirtyMask, S), this.renderInvalidations = (this.renderInvalidations || 0) + 1, !this.renderScheduled && (this.renderScheduled = !0, this.renderFrame = requestAnimationFrame(() => {
        if (this.renderScheduled = !1, this.disposed) return;
        const E = this.uiDirtyMask || je.viewport;
        this.uiDirtyMask = 0, this.lastRenderReasons = [...this.renderReasons || []], this.renderReasons?.clear(), this.rendersCoalesced = (this.rendersCoalesced || 0) + 1, this.perf && (this.perf.renderCount = (this.perf.renderCount || 0) + 1), Ue(E, je.outliner) && this.refreshObjects(), Ue(E, je.timeline) && this.refreshKeys(), Ue(E, je.inspector) && this.refreshInspector(), Ue(E, je.viewport) && this.renderViewportOnly(), Ue(E, je.previews) && this.renderCameraView(), Ue(E, je.motion) && this.renderMotionUiOnly();
      }));
    },
    renderCameraView() {
      if (this.perf && (this.perf.previewRenderCount = (this.perf.previewRenderCount || 0) + 1), this.state.camera_view_visible) {
        ...
        let A = null;
        if (E) {
          const K = this.state.active_camera_id, X = w.filter((L) => L.id !== K);
          A = X.length ? X[this.cameraPreviewTick % X.length] : null;
        }
        for (const K of w) {
          ...
          if ($e && ($e.textContent = `F${this.frame}`), E && K.id !== this.state.active_camera_id && K !== A) continue;
          const Re = vt(this, K, He(K, this.frame, this.state.objects), this.frame);
  ...
  return {
    ...
    _activeTrack() {
      ...
      return {
        kind: "camera",
        write: (a) => {
          t.keyframes = a, this.state.keyframes = a, jo(this);
        }
      };
    },
    deleteSelectedKeyframes() {
      ...
      const t = this._activeTrack(), a = ve(this), o = t.kind === "camera" ? 1 : 0, { keys: n, removed: s } = pc(a, e, { minKeys: o });
    ...
    nudgeSelectedKeyframes(e) {
      ...
      const a = this._activeTrack(), o = Math.max(0, this.state.duration_frames - 1), n = mc(ve(this), t, e, { lastFrame: o });
    ...
    setSelectedKeysTangentMode(e) {
      ...
      const a = this._activeTrack(), o = et(this).map((n) => n.id);
      this.checkpoint(r("Tangents on {n} keys").replace("{n}", t.length)), a.write(lc(ve(this), t, e, o)), this.serialize(), this.refreshKeys(), this.render(), this.drawCurveEditor(), this.setStatus(r("{mode} tangents on {n} keys").replace("{mode}", e).replace("{n}", t.length));
    },
    /**
    ...
    simplifyActiveKeys({ mode: e = "simplify", tolerance: t = 0, target: a = 0, scope: o = "camera", fromKeys: n = null, silent: s = !1 } = {}) {
      ...
      const l = this.resolveSelectedFrames(), m = o !== "all_cameras" && l.length >= 2 ? [l[0], l.at(-1)] : null, p = m ? [] : l, f = (b) => {
        ...
        let M = j, P = 0;
        if (j.length > 2) {
          const D = e === "reduce" ? fc(j, i, { target: a || Math.ceil(j.length / 2), keepFrames: p }) : e === "clean" ? hc(j, i, { keepFrames: p }) : bc(j, i, { tolerance: t * vb, keepFrames: p });
          M = D.keys, P = D.removed;
        }
        return { keys: [...v, ...M, ...x].sort((D, F) => D.frame - F.frame), removed: P };
      };
      let d = 0;
      const h = c.map((b) => {
      ...
      return jo(this), this.selectedKeyFrame = null, this.selectedKeyFrames = /* @__PURE__ */ new Set(), this.camera = xe(this.state, this.frame), this.applyObjectAnimationFrame(), this.serialize(), this.refreshKeys(), this.setFrame(this.frame, !1, !1), this.render(), s || this.setStatus(d ? r("Removed {n} keyframes").replace("{n}", d) : r("No keyframes to remove")), d;
    },
...
class Go {
  ...
  constructor(t) {
    this.runtime = t;
    const a = t.node;
    this.disposed = !1, this.app = Kr, this.api = We, this.node = a, this.root = wn(), this.root.tabIndex = -1, this.dom = Sn(this.root), this.canvas = this.root.querySelector(".viewport-wrap > canvas"), this.cameraPreviewCanvases = /* @__PURE__ */ new Map(), this.cameraPreviewContexts = /* @__PURE__ */ new Map(), this.cameraPreviewSignature = "", this.interactionElement = this.canvas, this.interactionElement.tabIndex = 0, this.interactionElement.dataset.captureWheel = "true", this.ctx = this.canvas.getContext("2d", { alpha: !1 }), this.webgl = null, this.cameraWebgl = null, this.webglReady = this.loadWebGLViewports(), this.transformControlsWiring = rm(this), this.camera = xe(this.state, this.frame), this.playing = !1, this.drag = null, this.cameraEditActive = !1, this.cameraEditKey = null, this.keyDrag = null, this.timelineDrag = null, this.curveDrag = null, this.selectedKeyFrame = this.state.keyframes[0]?.frame ?? null, this.pathSelection = Pi(), this.editingKeyFrame = null, this.copiedKeyframe = null, this.cameraSpeed = 1, this.cardMedia = null, this.cardMediaById = /* @__PURE__ */ new Map(), this.cardMediaAssetById = /* @__PURE__ */ new Map(), this.objectUrls = new xn(), this.cardUrlsById = this.objectUrls.urls, this.modelUrlsById = /* @__PURE__ */ new Map(), this.modelInfoById = /* @__PURE__ */ new Map(), this.executionReferences = [], this.selectedObjectId = null, this.selectedEntity = "camera", this.subSelection = null, this.cardUrl = null, this.recording = !1, this.gizmoDrag = null, this.playTimer = null, this.previewClickTimer = null, this.showCurveHandles = !0, this.uiDirtyMask = 0, this.perf = globalThis.__omnicamPerf === !0 ? { renderCount: 0, viewportRenderCount: 0, previewRenderCount: 0, timelineRefreshCount: 0, inspectorRefreshCount: 0, lastFrameMs: 0 } : null, this.contextMenu = new rn(this.root), this.refreshCameraPreviews(), this.initializeTooltips(), this.bindEditorEvents(), this.bindWidgetCallbacks(), this.syncFromWidgets(), this.resizeCanvas(), this.render(), this.refreshKeys(), this.refreshObjects(), this.restoreAssets(), this.syncUpstreamInputs(), this.refreshSetupDiagnostic(), // Seed every frame-derived readout (timecode, lens millimetres, viewport
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-DMceYn3n.js"));
    } catch (a) {
    ...
    if (!this.disposed) {
      ...
      Ii(this), this.resizeCanvas(), this.render(), this.renderCameraView();
    }
  }
}
const wb = [
...
for (const e of wb)
  Object.defineProperty(Go.prototype, e, {
    configurable: !0,
    enumerable: !0,
    get() {
...
const Ha = { app: Kr, api: We, EditorHistory: uc, ContextMenuController: rn, initializeTooltips: Mc, promptText: kt, ObjectUrlRegistry: xn, buildRoot: wn, dispatchDirectorKey: zi, activeCameraTrack: So, bindWidgetCallbacks: Gc, playblastCameraTrack: nn, restoreFromWidgets: Xc, serializeEditorState: Yc, syncActiveCameraTrack: jo, syncFromWidgets: Zc, bindEditorEvents: Op, activateCamera: Ac, addCamera: Tc, deleteCamera: Pc, drawPreviewOverlays: Ic, duplicateCamera: zc, maximizeCameraPreview: Fc, refreshCameraPreviews: Lc, refreshCameraSelectors: Oc, renameCamera: Kc, setPlayblastCamera: Dc, toggleCameraView: Nc, captureRealtime: Nn, makePlayblast: pf, uploadDirectorPlayblast: Rn, waitForMediaFrame: Dn, computeAudioPeaks: zn, loadAudioFile: Up, releaseAudio: Qa, stopPlay: Xa, togglePlay: Wp, applyCameraPreset: nm, applyCameraShake: sm, applyProxyPreset: im, clearViewportBgImage: uf, loadViewportBgFile: hf, loadViewportBgSequence: bf, drawCameraPath: Af, drawCard: Mf, drawCube: Sf, drawCylinder: _f, drawGrid: vf, drawHuman: Cf, drawLine3D: ne, drawNull: $f, drawOverlays: Pf, drawPointField: kf, drawSpeedHeatmap: Tf, drawSphere: jf, drawTorus: Ef, curveChannels: et, drawCurveEditor: Ml, fitCurveView: bn, onCurveDoubleClick: El, onCurvePointerDown: yl, onCurvePointerMove: vl, onCurvePointerUp: xl, onTimelinePointerDown: Fi, onTimelinePointerMove: Li, onTimelinePointerUp: Oi, refreshKeys: ql, resetCurveZoom: $l, resetTimelineZoom: Ki, setChannelFilter: kl, setCurveInterpolation: wl, setTangentMode: Sl, timelineFrameFromEvent: Mo, toggleCurveHandles: jl, zoomCurve: _l, drawTransformGizmo: Di, frameTarget: Ni, gizmoAxes: Ri, gizmoGeometry: qi, onPointerDown: Bi, onPointerMove: Wi, onPointerUp: Vi, onWheel: Hi, pickGizmo: Ui, pickSceneObject: Gi, resetCamera: Xi, setTransformMode: Yi, setViewMode: Zi, viewportCamera: Ji, loadCardFile: tf, loadExecutionPreview: af, loadMediaUrl: Kn, loadModelFile: ef, loadSelectedReference: of, onModelLoaded: Qp, restoreAssets: Jp, syncUpstreamInputs: rf, configureDomMedia: Fn, refreshSetupDiagnostic: Ff, addMediaCard: oh, addPrimitive: Qf, applyObjectAnimationFrame: vh, beginCameraEdit: _h, beginObjectEdit: Gn, commitCameraEdit: Eh, commitObjectEdit: sh, copyKeyframe: Sh, deleteKeyframe: kh, deleteObject: Un, deleteSelectedObjects: ah, duplicateObject: Hn, exitKeyEdit: Mh, finishCameraEdit: $h, goToAdjacentKey: Nh, insertKeyframe: xh, loadSelectedKeyView: Dh, pasteKeyframe: jh, playblastCameraAtFrame: yh, refreshInspector: rh, refreshKeyEditor: Lh, refreshObjects: Vn, removeObjectResources: ph, renameObject: eh, retimeSelectedKey: Oh, selectKeyframe: Ch, selectedKeyframe: ze, selectedObject: _t, selectObjectAnimation: mh, setKeyInterpolation: wh, setKeyTangentMode: zh, setObjectParent: dh, timelineKeyframes: ve, timelineObject: ke, toggleAutoKey: Ah, toggleObject: th, updateCameraFromHud: lh, updateCameraRotationFromHud: ch, updateEditState: Ph, updateKeyVisualState: Ih, updateSelectedKey: Kh, updateSelectedObject: nh, clamp: Z, cloneCamera: le, configureCore: tn, defaultCamera: en, sampleCamera: xe, sampleObjectTransform: ao, sanitizeState: Qi, worldTransform: To };
Object.assign(
  Go.prototype,
  Bh(Ha),
  Qh(Ha),
...
function kb(e) {
  const t = e.node;
  vo("director:workbench:constructor:start", t);
  const a = new Go(e);
  vo("director:workbench:constructor:complete", t), e.attachWorkbench(a), t.__majoorOmniCam = a, Ti(a);
  try {
    a.assetBrowser = Wd(a, {
      ...
      onAgentFirstOpen: async () => {
        if (xo())
          try {
            const { createDirectorAgentPanel: o } = await import("./chunk-CyAYWxKz.js");
            a.agentPanel = o(a);
          } catch (o) {
  ...
  try {
    a.characterRuntime = Hd(a), a.rigMapper = Gd(a), a.poseEditor = Zd(a), a.motionEditor = Jd(a);
  } catch (o) {
    console.warn("[OmniCam] Character tools unavailable", o);
  }
  return vo("director:workbench:ready", t), a;
}
function Sb(e) {
