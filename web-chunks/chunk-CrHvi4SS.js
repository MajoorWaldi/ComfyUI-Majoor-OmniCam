...
function Qs(e, { mode: t, selectedIds: a } = {}) {
...
const ti = "omnicam_humanoid_v1", pt = Object.freeze([
  "root",
  "pelvis",
  "spine",
  "chest",
  ...
  "foot_r",
  "toe_r"
]), xo = Object.freeze(["eye_l", "eye_r", "hand_tip_l", "hand_tip_r"]);
Object.freeze([...pt, ...xo]);
new Map(pt.map((e, t) => [e, t]));
const Mo = /^mixamorig[:_ ]?/i, Co = /[\s_\-.:|]+/g, ko = {
...
function Do(e) {
  return String(e || "").trim().replace(Mo, "").replace(Co, "").toLowerCase();
}
function To(e) {
  const t = [e];
...
function oi({ preset: e, overrides: t } = {}) {
  const a = Ne(e), r = Ne(t);
  return {
...
function le(e, t, a = null) {
  ...
  if (u && Array.isArray(h)) {
    ...
    if (g && g.enabled !== !1) {
      const M = gt(h, g, t), A = m?.offset || e.target_offset || e.camera?.target_offset || [0, 0, 0];
...
function N(e, t, a, r, o = !1, n = null) {
  ...
  if (l.interpolation === "bezier" || d.interpolation === "bezier") {
    const v = Pt(l, a, c, d, r), b = Pt(d, a, l, m, r), x = h, w = h + (v.out_y || 0), D = f + (b.in_y || 0), g = f, M = T(Number(v.out_x ?? 1 / 3), 0, 1), A = T(1 + Number(b.in_x ?? -1 / 3), 0, 1);
    let G = 0, ee = 1;
...
function di(e = "balanced", t = "all_views", a = null) {
  const r = {
    none: 0,
    0: 0,
    sparse: 300,
...
function ha(e, t = {}, a = null, r = "generic") {
  ...
  for (let g = 0; g < n; g++) {
    ...
    !f[g] && !y && (M.push("over"), A.push("framing_loss")), v.push(Lt(M)), b.push(A);
  }
...
const _n = {
  ...
  ..._n,
  ...vn
}, Z = ["OmniCam"], _a = "MajoorOmniCam.Locale", va = "MajoorOmniCam.Defaults.Fps", Sa = "MajoorOmniCam.Defaults.DurationSeconds", wa = "MajoorOmniCam.Defaults.Width", xa = "MajoorOmniCam.Defaults.Height", Ma = "MajoorOmniCam.Defaults.RenderMode", Ca = "MajoorOmniCam.Defaults.Encoder", ka = "MajoorOmniCam.Defaults.PlayblastResolution", Da = "MajoorOmniCam.Playblast.Quality", Ta = "MajoorOmniCam.Defaults.PlayblastGrid", ja = "MajoorOmniCam.Defaults.PlayblastLabels", Aa = "MajoorOmniCam.Proxy.PointDensity", Ea = "MajoorOmniCam.Proxy.PointSpread", Oa = "MajoorOmniCam.Proxy.PointColor", Ia = "MajoorOmniCam.Proxy.CardFit", Pa = "MajoorOmniCam.Viewport.Quality", za = "MajoorOmniCam.Viewport.Adaptive", Na = "MajoorOmniCam.Viewport.BackgroundColor", Ra = "MajoorOmniCam.Display.Grid", La = "MajoorOmniCam.Display.Radar", Fa = "MajoorOmniCam.Display.CameraPaths", Ba = "MajoorOmniCam.Display.CameraGizmos", Ka = "MajoorOmniCam.Display.LookAt", Va = "MajoorOmniCam.Display.HelperAxes", Ga = "MajoorOmniCam.Display.Gizmo", qa = "MajoorOmniCam.Display.Guides", Ha = "MajoorOmniCam.Display.SafeAreas", Wa = "MajoorOmniCam.Display.ResolutionGate", $a = "MajoorOmniCam.Display.AspectRatio", Ua = "MajoorOmniCam.Display.BurnIn", Xa = "MajoorOmniCam.Display.SpeedHeatmap", Ya = "MajoorOmniCam.Display.Wireframe", Za = "MajoorOmniCam.Display.Vertices", Qa = "MajoorOmniCam.Tools.SelectMode", Ja = "MajoorOmniCam.Tools.GizmoMode", er = "MajoorOmniCam.Tools.GizmoSpace", tr = "MajoorOmniCam.Tools.SpatialSnapMode", ar = "MajoorOmniCam.Tools.SpatialGridSize", rr = "MajoorOmniCam.Navigation.Profile", or = "MajoorOmniCam.Navigation.FlySpeed", nr = "MajoorOmniCam.Navigation.InvertOrbitY", sr = "MajoorOmniCam.Navigation.ZoomSensitivity", ir = "MajoorOmniCam.Navigation.OrbitSensitivity", lr = "MajoorOmniCam.Navigation.PanSensitivity", cr = "MajoorOmniCam.Navigation.DollySensitivity", dr = "MajoorOmniCam.Navigation.ViewMode", mr = "MajoorOmniCam.Controls.EnableShortcuts", pr = "MajoorOmniCam.Timeline.SnapEnabled", fr = "MajoorOmniCam.Timeline.SnapFrames", ur = "MajoorOmniCam.Timeline.AutoKey", hr = "MajoorOmniCam.Timeline.DefaultInterpolation", gr = "MajoorOmniCam.Timeline.TimecodeMode", yr = "MajoorOmniCam.Timeline.LoopPlayback", br = "MajoorOmniCam.Interface.Density", _r = "MajoorOmniCam.Interface.PreviewLayout", vr = "MajoorOmniCam.Interface.CameraPreviews", Sr = "MajoorOmniCam.History.Limit", wr = "MajoorOmniCam.Extractor.DefaultBackend", xr = "MajoorOmniCam.Monitor.DefaultProfile", Mr = "MajoorOmniCam.Agent.Enabled", yt = "MajoorOmniCam.Agent.Provider", Bt = "MajoorOmniCam.Agent.Model", Kt = "MajoorOmniCam.Agent.BaseUrl", Cr = "MajoorOmniCam.Agent.MaxOutputTokens", kr = "MajoorOmniCam.Agent.MaxPlannerSteps", Dr = "MajoorOmniCam.Agent.RequestTimeoutSeconds", Be = [
...
function An() {
  return {
    ...
    height: F(xa, 720, 64, 4096, !0),
    renderMode: String(R(Ma, "omni_ref")),
    ...
    monitorProfile: z(xr, "wan_camera_native", ["wan_camera_native", "minimax_h3", "ltx_motion", "generic_video"])
  };
}
function En() {
...
function Hn(e, t, a, r = {}) {
  const o = e.state.objects.filter((b) => b.enabled !== !1), n = r.all ? o : o.filter((b) => e.selectedObjectIds?.has(b.id)), i = (n.length ? n : [a]).flatMap((b) => qn(e, b)), l = [0, 1, 2].map((b) => Math.min(...i.map((x) => x[b]))), d = [0, 1, 2].map((b) => Math.max(...i.map((x) => x[b]))), c = l.map((b, x) => (b + d[x]) / 2), { right: m, up: p, forward: u } = V(t), h = Math.max(1, e.canvas?.width || e.state.width || 1280) / Math.max(1, e.canvas?.height || e.state.height || 720), f = Math.tan((t.fov || 35) * Math.PI / 360), _ = f * h;
  let y = 2, v = 0.1;
  for (const b of i) {
...
function Ii(e) {
  ...
  for (const o of t.handles) {
    ...
    if (e.ctx.lineWidth = n ? 6.5 : 3.8, e.ctx.strokeStyle = n ? "#ffffff" : a[o.index] || "#ffffff", e.ctx.fillStyle = a[o.index] || "#ffffff", e.ctx.beginPath(), o.points.forEach((s, i) => {
      ...
      e.state.gizmo_mode === "scale" && t.entity?.type === "object" ? (e.ctx.fillRect(i[0] - 6, i[1] - 6, 12, 12), e.ctx.save(), e.ctx.strokeStyle = "rgba(15, 23, 42, 0.65)", e.ctx.lineWidth = 1, e.ctx.strokeRect(i[0] - 6, i[1] - 6, 12, 12), e.ctx.restore()) : Yn(e.ctx, s[0], i);
    }
  }
...
function Oe(e, t) {
  ...
  const n = o[0] - a.start[0], s = o[1] - a.start[1], i = t.shiftKey ? 0.1 : 1, l = Qn(a), d = a.axis ? nt[a.axis] : null, c = e.state.view_mode === "camera" ? e.camera : e.state.editor_views[e.state.view_mode], m = V(c), p = c.camera_type === "orthographic" ? 10 / (Math.max(0.01, c.zoom || 1) * Math.max(1, e.canvas.height)) : Math.hypot(...E(c.position, c.target)) * 25e-4;
  let u = a.snapshots.map((b) => [...b.transform.position]);
  if (a.mode === "translate") {
    const b = l ?? (n - s) * p * i, x = d ? k(d, b) : C(k(m.right, n * p * i), k(m.up, -s * p * i));
    u = u.map((w) => C(w, x)), u = Jn(e, a, u, o, t.ctrlKey || t.metaKey, d, a.snapshots.map((w) => w.transform.position));
  }
  ...
  a.snapshots.forEach((b, x) => {
    ...
    if (a.mode === "scale") {
      const D = y ? Ve(f, 0.1) : f, g = d ? d.map((A) => A ? D : 1) : [D, D, D], M = E(b.transform.position, a.pivot);
...
const re = (e, t) => Math.round(e / t) * t, as = (e, t) => e.map((a) => re(a, t));
function rs(e, t, a) {
...
function he(e, t, a, r = [], o = null) {
  ...
  if (s === "grid")
    return o ? t.map((l, d) => Math.abs(o.axis[d]) > 1e-6 ? re(l, i) : o.base[d]) : as(t, i);
  if (s === "vertex" && a && !o) {
...
function Pi(e, t) {
  ...
  if (c) {
    ...
    if (c.entity.type === "object") {
      ...
      const w = Rr(e), D = (w.length ? w : [x]).map((M) => ({ object: M, transform: ce(M) }));
...
function Ge(e, { sourceKind: t = "manual_2d", label: a, keys: r, source: o = {} }) {
  ...
  const n = os(e), s = { id: n, label: a || `Motion ${n.split("_").at(-1)}`, enabled: !0, semantic: "screen_point", source_kind: t, keys: r.map((i) => ({ visible: !0, interpolation: "linear", ...i })), source: { ...o } };
...
function Je(e, t) {
  return is(t, e.interactionElement);
}
function ms(e, t) {
...
function Li(e, t) {
  ...
  e.root.querySelector('[data-role="motion-interpolation"]')?.addEventListener("change", (o) => {
    const n = Qe(e.state);
    n && (e.checkpoint("Set motion interpolation"), ns(n, o.target.value), ae(e, `Motion interpolation: ${o.target.value}`));
  ...
  a.addEventListener("pointerdown", (o) => {
    ...
    e.checkpoint(n === "erase" ? "Erase motion track" : "Add motion anchor"), n === "anchor" ? Ge(e.state, { sourceKind: "static_anchor", label: `Anchor ${(e.state.motion_layers || []).length + 1}`, keys: [{ time_seconds: e.frame / e.state.fps, ...s, interpolation: "hold" }] }) : n === "project" ? ps(e, s) : n === "erase" && ms(e.state, s), ae(e, `Motion tool: ${n}`);
  ...
  const r = (o) => {
    ...
    const [s, i] = Yt(e), l = ds(e.state, n.points, s, i);
...
function Fi(e, t) {
  for (const a of e.root.querySelectorAll("[data-motion-create]"))
    a.addEventListener("click", () => us(e, a.dataset.motionCreate), { signal: t });
...
const ge = { t: "translate", r: "rotate", s: "scale" }, bs = [
...
], _s = 'button,summary,a[href],[role="button"],[role="menuitem"],[role="tab"],[role="option"],[role="checkbox"],[role="switch"]';
function vs(e) {
  return e instanceof HTMLElement || e instanceof SVGElement ? !!e.closest?.(_s) : !1;
}
function Ss(e) {
...
function xs(e, t) {
  return ws(e) || t?.lastKeyZone || "viewport";
}
let Qt = !1;
function Ms() {
  Qt || typeof window > "u" || (Qt = !0, window.addEventListener("keydown", (e) => {
    ...
    !a || a.disposed || Cs(a, e) && (e.preventDefault(), e.stopImmediatePropagation?.(), e.stopPropagation());
  }, { capture: !0 }));
}
function Cs(e, t) {
  if (!Dn()) return !1;
  const a = t.composedPath?.()[0] || t.target;
  if (Ss(a) || (t.code === "Space" || t.key === "Enter") && vs(a)) return !1;
...
function Is([e, t], [a, r]) {
  ...
  const o = Math.round((window.innerWidth || e) * Es), n = Math.round((window.innerHeight || t) * Os);
  return [
...
function Ps(e, t) {
  const a = qr[t];
  return !a || !e?.setSize ? !1 : (e.setSize(Is(a.default, a.min)), !0);
}
function zs(e, t, a) {
  const r = qr[t];
...
function Rs() {
  ...
  e.id = Jt, e.textContent = Ns, document.head.appendChild(e);
}
function oe(e) {
...
const ta = "MajoorOmniCam.ShowHelp", dt = "oc-help-toolbar-icon", aa = "oc-help-toolbar-css", Bs = "#8b7bd8";
function Ks() {
  ...
  e.id = aa, e.textContent = `
    .${dt}{display:inline-flex;align-items:center;justify-content:center;
      width:16px;height:16px;border-radius:50%;background:${Bs};color:#fff;
...
J.registerExtension({
  ...
  async nodeCreated(e) {
    ...
    await xt(e, async () => {
      ...
      const { attachDirector: o } = await import("./chunk-QuwX68_1.js").then((n) => n.g);
...
J.registerExtension({
  ...
  async nodeCreated(e) {
    if ($e(e) !== it) return;
    const t = !ie, a = t ? null : kt(e);
    await xt(e, async () => (await import("./chunk-BdWawdfv.js")).attachExtractor), e.__majoorOmniCamExtractor && Ct(e, it, t, a?.());
  }
});
J.registerExtension({
  ...
  async nodeCreated(e) {
    if ($e(e) !== lt) return;
    const t = !ie, a = t ? null : kt(e);
    await xt(e, async () => (await import("./chunk-BkDEy9LU.js")).attachMonitor), e.__majoorOmniCamMonitor && Ct(e, lt, t, a?.());
  }
});
export {
  xa as $,
