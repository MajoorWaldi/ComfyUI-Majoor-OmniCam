...
import { a as f, A as fe, bC as Ve, bf as Ue } from "./chunk-BQzFpTKV.js";
import { h as me, N as ge, O as be, P as L, Q as z, R as K, T as Ge, L as Be, U as We, V as He, w as Qe, W as ze, X as Ke, Y as Ye, Z as Xe, _ as Je } from "./chunk-xSWoILmT.js";
function Ze(t) {
...
class Vt {
  ...
  async ensurePreview() {
    return this.preview || this.disposed ? this.preview : (this.previewLoad ||= import("./chunk-CKAdT6IK.js").then(({ TrackViewer: e }) => {
...
function ao(t) {
  return import("./chunk-CKAdT6IK.js").then(({ TrackViewer: e }) => (t.viewerLoad = null, t.disposed || t.viewer || (t.viewer = new e(t.$("track-canvas")), t.pushTracksToViewer()), t.viewer)).catch((e) => (t.viewerLoad = null, console.warn("OmniCam track viewer unavailable", e), null));
}
function de(t) {
  const e = t.$("frame");
