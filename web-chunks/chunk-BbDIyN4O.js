...
function Lr(e) {
  e.registerExtension({
    ...
    beforeRegisterNodeDef(t, a) {
      if (!String(a?.name || a?.node_id || t?.comfyClass || t?.type || "").startsWith(Pr)) return;
      ...
      t.prototype.onDrawForeground = function(n) {
        ...
        if (n.save(), this.selected) {
          const d = Rr(), p = n.createRadialGradient(m, c, Y * 0.35, m, c, Y * 1.15);
...
function $r(e, t, a = null) {
  ...
  return r.push({ camera_id: a || Wr(e, s), start: o }), r.sort((i, l) => i.start - l.start), !0;
}
function Ur(e, t) {
...
function Yr(e) {
  ...
  return e.motion_layers = (Array.isArray(e.motion_layers) ? e.motion_layers : []).slice(0, 256).map((r, o) => {
    ...
    const s = Zt.includes(r?.source_kind) ? r.source_kind : "manual_2d", i = (Array.isArray(r?.keys) ? r.keys : []).slice(0, 1e4).map((l) => Xr(l, t)).sort((l, m) => l.time_seconds - m.time_seconds);
    return {
      id: n,
...
const Zr = 32, Qr = 64, Jr = 128, eo = Object.freeze(["off", "selected", "all"]), to = Object.freeze(["annotation", "name", "tag"]), xt = Object.freeze({ mode: "selected", content: "annotation" }), ao = Object.freeze(["top", "center", "bottom"]), ro = /^[a-z0-9][a-z0-9_-]*$/, oo = /^#(?:[0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/, no = /[<>]|:\/\/|javascript:|expression\(|&#/i;
function Je(e) {
  ...
  for (const r of e) {
    ...
    if (!(!o || o.length > Qr || !ro.test(o) || a.has(o)) && (a.add(o), t.push(o), t.length >= Zr))
      break;
  }
  return t;
}
...
function Mt(e) {
  ...
  if (!t || t.length > Jr || no.test(t)) return null;
  const a = typeof e.color == "string" ? e.color.trim() : "", r = oo.test(a) ? a.toLowerCase() : "#8d7ee8", o = ao.includes(e.anchor) ? e.anchor : "top";
  return { text: t, visible: e.visible !== !1, color: r, anchor: o };
}
function Bs(e) {
  return {
    mode: eo.includes(e?.mode) ? e.mode : xt.mode,
    content: to.includes(e?.content) ? e.content : xt.content
  };
}
function so(e) {
...
const Ct = Object.freeze([0.05, 8]), lo = 80, Jt = (e, t, a) => Math.max(t, Math.min(a, e));
function ea(e) {
  if (!e || typeof e != "object") return null;
  const t = String(e.clip_id ?? "").trim();
  if (!t || t.length > lo) return null;
...
const mo = /^mixamorig[:_ ]?/i, po = /[\s_\-.:|]+/g, fo = {
...
function uo(e) {
  return String(e || "").trim().replace(mo, "").replace(po, "").toLowerCase();
}
function ho(e) {
  const t = [e];
...
function Ws(e) {
  const a = (e || []).map(String).filter((n) => n.trim()).map((n) => [n, ho(uo(n))]), r = /* @__PURE__ */ new Set(), o = {};
  for (const n of [!0, !1])
    for (const [s, i] of Object.entries(fo))
      if (!o[s])
        for (const l of i) {
          const m = go(l, a, r, n);
          if (m != null) {
...
function $s(e) {
  ...
  return !t || !Object.keys(t).length ? "none" : bo(t) ? "rigged" : "incomplete";
}
const _o = 128, kt = "omnicam_humanoid_v1", mt = /^[a-z0-9][a-z0-9_-]*$/, vo = 1e-3, So = (e) => Array.isArray(e) && e.length === 3 && e.every((t) => Number.isFinite(Number(t)));
function dt(e) {
  ...
  return a <= 1e-8 || Math.abs(a - 1) > vo && !(a > 0.5 && a < 2) ? null : t.map((r) => r / a);
}
...
function Pe(e) {
  ...
  return {
    ...
    root_offset: So(t.root_offset) ? t.root_offset.map(Number) : [0, 0, 0],
    joints: wo(t.joints)
  };
}
...
function L(e, t, a, r) {
  const { right: o, up: n, forward: s } = B(t), i = A(e, t.position), l = U(i, s);
...
function le(e, t, a = null) {
  const r = (e.keyframes || []).map((g) => ({
    ...g,
    camera: F(g.camera || g || e.camera || se())
  }));
  if (!r.length) return F(e.camera || se());
  const o = ko(e, r, t), n = z(r, t, "pos_x", (g) => (g.camera || g).position[0], !1, o), s = z(r, t, "pos_y", (g) => (g.camera || g).position[1], !1, o), i = z(r, t, "pos_z", (g) => (g.camera || g).position[2], !1, o);
...
function Tt(e, t, a, r, o) {
  const n = Ao(e, t), s = jo.includes(n.mode) ? n.mode : e?.tangents?.mode || "auto", i = o ? o(e) : 0, l = a && o ? o(a) : i, m = r && o ? o(r) : i, c = Math.max(1e-6, e.frame - (a?.frame ?? e.frame - 1)), d = Math.max(1e-6, (r?.frame ?? e.frame + 1) - e.frame), p = (v = !1) => {
...
function Eo() {
  const e = se(), t = [{ frame: 0, camera: F(e), interpolation: "ease" }];
  return {
    schema_version: 1,
    fps: 24,
    duration_frames: 120,
...
function ti(e) {
  ...
  })), o = F(a.camera || t.camera);
  let n = r(a.keyframes, o);
  n = [...new Map(n.map((c) => [c.frame, c])).values()].sort((c, d) => c.frame - d.frame), n.length || (n = [{ frame: 0, camera: F(o), interpolation: "ease" }]);
  ...
  a.cameras = s.slice(0, Ce.maxCameras).map((c, d) => {
    ...
    const u = F(c?.camera || c?.keyframes?.[0]?.camera || o);
    let f = r(c?.keyframes, u);
    return f = [...new Map(f.map((h) => [h.frame, h])).values()].sort((h, _) => h.frame - _.frame), f.length || (f = [{ frame: 0, camera: F(u), interpolation: "ease" }]), {
      id: p,
  ...
  }), a.active_camera_id = a.cameras.some((c) => c.id === a.active_camera_id) ? a.active_camera_id : a.cameras[0].id, a.sequence = qr(a.sequence, a.cameras.map((c) => c.id)), a.playblast_camera_id = a.playblast_camera_id === Kr && a.sequence.cuts.length || a.cameras.some((c) => c.id === a.playblast_camera_id) ? a.playblast_camera_id : a.active_camera_id;
  ...
  a.camera = l.camera, a.keyframes = l.keyframes, a.target_object_id = l.target_object_id || null, a.target_offset = l.target_offset || [0, 0, 0], a.aim_bone = l.aim_bone || null, a.objects = (Array.isArray(a.objects) ? a.objects : t.objects).slice(0, Ce.maxObjects).map((c) => ({
    ...
    ...c?.character ? { character: xo(c.character) } : {},
  ...
  const m = ze();
  return a.editor_views = Object.fromEntries(Object.entries(m).map(([c, d]) => [c, F(a.editor_views?.[c] || d)])), Yr(a);
}
function xe(e, t) {
...
function na(e, t) {
  const a = t.quaternion || Ne(t.rotation), r = Oo(a, e.quaternion || Ne(e.rotation));
  return { position: C(oa(e.position.map((o, n) => o * t.size[n]), a), t.position), rotation: Io(r), quaternion: r, size: e.size.map((o, n) => o * t.size[n]) };
}
function Po(e, t) {
...
const jt = ["speed", "angular_speed", "acceleration", "jerk"], $e = ["ok", "warn", "over"], sa = 0.8, zo = [0, 1.5, 0];
function At(e, t) {
  const a = [0];
...
function Ro(e, t) {
  const a = [0];
  for (let r = 1; r < e.length; r++) {
    const o = B(e[r - 1]), n = B(e[r]), s = ["right", "up", "forward"].reduce(
...
function Lo(e, t = null) {
  ...
  return Array.isArray(a?.position) ? a.position.slice(0, 3).map(Number) : [...zo];
}
function Fo(e, t, a, r) {
  return e.map((o) => {
    const n = L(t, o, a, r);
...
function Vo(e, t) {
  ...
  for (let r = 0; r < e.length; r++) {
    ...
    if (n && n.grade === e[r] && Bo(n.metrics, o)) {
      n.end = r;
      continue;
    }
...
function ia(e, t = {}, a = null, r = "generic") {
  ...
  const m = No(l, o), c = Ro(l, o), d = At(m, o), p = At(d, o), u = { speed: m, angular_speed: c, acceleration: d, jerk: p }, f = Lo(e, a), h = Fo(l, f, s, i), _ = l.map((g) => g.fov), y = t.allow_framing_loss === !0, v = [], b = [];
  for (let g = 0; g < n; g++) {
    const M = [], j = [];
    for (const G of jt) {
...
function qo(e, t) {
  ...
  if (!a) return;
  if (!a.engaged) {
    if (Math.hypot(t.clientX - (a.startClientX ?? t.clientX), t.clientY - (a.startClientY ?? t.clientY)) < Go) return;
    a.engaged = !0;
  }
...
function an(e) {
  ...
  if (a.className = `oc-health-badge ${o.grade}`, a.textContent = Yo(o.grade), r) {
    const { score: l, letter: m } = en(o);
  ...
  t.innerHTML = `
    ...
    <div class="oc-health-zones" data-role="health-zones">${tn(o)}</div>
...
function Me(e, t, a, r) {
  ...
  o && (e.checkpoint(a), o.keyframes = t, e.state.keyframes = t, e.syncActiveCameraTrack(), e.refreshKeys(), e.setFrame(e.frame, !1, !1), e.setStatus(r), an(e));
}
function ci(e) {
  const t = me(e);
  if (!t) return;
  ...
  const r = Math.max(1, e.state.duration_frames - 1), o = Wo(e.state.keyframes, r), n = ia({ ...e.state, keyframes: o }, t.limits, null, t.profile);
  if (n.max_speed <= a) {
...
function di(e) {
  const t = me(e);
  if (!t) return;
  const a = Uo(t, "framing_loss");
  if (!a.length) {
    e.setStatus(S("The subject stays in frame on this shot."));
    return;
  }
  const r = $o(e.state.keyframes, a, t.subject);
  Me(
    e,
    r,
    "Recenter subject",
...
function hn({
  ...
  return [
    ...
    Pt(cn, "Agent", "Model", "Model id used by the Agent planner."),
    Pt(mn, "Agent", "Base URL", "Optional provider endpoint override."),
    R(
      dn,
      "Agent",
      "Max output tokens",
...
function yr() {
  const e = String(K(da, "auto")), t = String(K("Comfy.Locale", "en") || "en").slice(0, 2).toLowerCase(), a = e === "auto" ? t : e, r = a !== Vr();
  if (Br(a), !!r) {
    for (const o of $)
      if (!o.disposed)
        try {
...
function Nt(e = br()) {
  for (const t of $)
    t.disposed || (_r(t), t.requestRender ? t.requestRender("quality") : t.render?.(), t.renderCameraView?.());
}
function wn() {
  return {
    fps: V(pa, 24, 1, 120, !0),
    durationSeconds: V(fa, 5, 1, 120, !0),
    width: V(ua, 1280, 64, 4096, !0),
    height: V(ha, 720, 64, 4096, !0),
    renderMode: String(K(ga, "omni_ref")),
    encoder: String(K(ya, "auto")),
    ...
    spatialGridSize: V(Ua, 0.5, 0.01, 100),
    navigationProfile: N(Xa, "simple", ["maya", "blender", "simple"]),
    flySpeed: V(Ya, 1, 0.05, 5),
    invertOrbitY: I(Za, !1),
    zoomSensitivity: V(Qa, 1, 0.2, 3),
    orbitSensitivity: V(Ja, 1, 0.2, 3),
    panSensitivity: V(er, 1, 0.2, 3),
    dollySensitivity: V(tr, 1, 0.2, 3),
    viewMode: N(ar, "perspective", ["camera", "perspective", "front", "back", "top", "bottom", "right", "left"]),
    snapEnabled: I(or, !0),
    snapFrames: V(nr, 1, 1, 24, !0),
    autoKey: I(sr, !1),
...
function Rt(e, t, a, r, o) {
  const { right: n, up: s, forward: i } = B(t), l = t.position, m = [a[0] - l[0], a[1] - l[1], a[2] - l[2]], c = kn(m, i);
  let d, p;
  if (t.camera_type === "orthographic") {
...
function vr(e, t, { includeCtrlFallback: a, includeSimpleLeft: r = a }) {
...
function Tn(e, t, a) {
  const r = ht(e), o = vr(r, t, { includeCtrlFallback: !0 });
  return o === ye && a?.camera_type === "orthographic" ? be : o;
}
function Lt(e, t) {
  return e.isNavigatingFly ? !0 : vr(ht(e), t, { includeCtrlFallback: !1 }) !== null;
}
...
function In(e, { baseDrag: t, viewCamera: a, entityPosition: r }) {
  ...
  return !o || o.locked || !(o.keyframes?.length >= 1) ? !1 : (e.checkpoint("Transform camera path"), e.gizmoDrag = {
    ...
    trackId: o.id,
    origin: Sr(o.keyframes),
    baseKeys: o.keyframes.map((n) => ({ ...n, camera: F(n.camera) })),
    viewRight: B(a).right,
    viewUp: B(a).up,
...
function Pn(e, { pointer: t, deltaPixels: a, precision: r, snapping: o }) {
  ...
  s.keyframes = En(n.baseKeys, l), s.id === e.state.active_camera_id && (e.state.keyframes = s.keyframes), e.camera = le(s, e.frame, e.state.objects), s.camera = F(e.camera), e.refreshKeys(), e.refreshInspector(), e.render(), e.renderCameraView?.();
}
function Bt(e, t) {
  const a = [];
...
function Nn(e, t, a, r = {}) {
  const o = e.state.objects.filter((b) => b.enabled !== !1), n = r.all ? o : o.filter((b) => e.selectedObjectIds?.has(b.id)), i = (n.length ? n : [a]).flatMap((b) => zn(e, b)), l = [0, 1, 2].map((b) => Math.min(...i.map((x) => x[b]))), m = [0, 1, 2].map((b) => Math.max(...i.map((x) => x[b]))), c = l.map((b, x) => (b + m[x]) / 2), { right: d, up: p, forward: u } = B(t), f = Math.max(1, e.canvas?.width || e.state.width || 1280) / Math.max(1, e.canvas?.height || e.state.height || 720), h = Math.tan((t.fov || 35) * Math.PI / 360), _ = h * f;
  let y = 2, v = 0.1;
  for (const b of i) {
...
function wr(e) {
  ...
  const o = L(r, a, e.canvas.width, e.canvas.height);
  ...
  if (e.state.gizmo_mode !== "rotate" || t.type === "camera_target")
    return {
      ...
      center: o,
      worldLength: n,
      handles: i.map((m, c) => ({ index: c, axis: m, points: [o, L(C(r, k(m, n)), a, e.canvas.width, e.canvas.height)] })).filter((m) => m.points[1] && Number.isFinite(m.points[1][0]) && Number.isFinite(m.points[1][1]))
    };
  const l = i.map((m, c) => {
    const d = Math.abs(m[1]) < 0.9 ? [0, 1, 0] : [1, 0, 0], p = ne(Se(m, d)), u = ne(Se(m, p)), f = [];
    for (let h = 0; h <= 48; h++) {
      const _ = h / 48 * Math.PI * 2, y = L(C(r, C(k(p, Math.cos(_) * n), k(u, Math.sin(_) * n))), a, e.canvas.width, e.canvas.height);
...
function Fn(e, t) {
  ...
  if (e.state.view_mode !== "camera") {
    ...
    if (e.state.show_camera_paths !== !1)
      for (const s of e.state.cameras) {
        ...
        const l = i.map((m) => L(m.camera?.position, r, e.canvas.width, e.canvas.height)).filter((m) => m && Number.isFinite(m[0]) && Number.isFinite(m[1]));
    ...
    for (const s of e.state.objects)
      if (s.enabled !== !1)
        for (const i of s.keyframes || []) {
          ...
          if (!l) continue;
          const m = L(l, r, e.canvas.width, e.canvas.height);
  ...
  for (const s of e.state.objects) {
    ...
    const i = s.keyframes?.length ? Ke(s, e.frame) : s, l = L(i.position || [0, 0, 0], r, e.canvas.width, e.canvas.height);
    if (!l) continue;
...
function wi(e) {
  ...
  if (t.entity?.type === "camera_path") {
    const o = X(e), n = (t.entity.track?.keyframes || []).map((s) => L(s.camera?.position, o, e.canvas.width, e.canvas.height)).filter((s) => s && Number.isFinite(s[0]) && Number.isFinite(s[1]));
...
function Ae(e, t) {
  ...
  const n = o[0] - a.start[0], s = o[1] - a.start[1], i = t.shiftKey ? 0.1 : 1, l = Kn(a), m = a.axis ? at[a.axis] : null, c = e.state.view_mode === "camera" ? e.camera : e.state.editor_views[e.state.view_mode], d = B(c), p = c.camera_type === "orthographic" ? 10 / (Math.max(0.01, c.zoom || 1) * Math.max(1, e.canvas.height)) : Math.hypot(...A(c.position, c.target)) * 25e-4;
...
function qn(e, t) {
  ...
  return r === "escape" ? kr(e) : r === "enter" || r === " " ? Cr(e) : at[r] ? (a.axis = a.axis === r ? null : r, Ae(e, a.lastEvent), !0) : /^[0-9]$/.test(r) || r === "." || r === "," || r === "-" && !a.numeric ? (a.numeric += r === "," ? "." : r, Ae(e, a.lastEvent), !0) : (r === "backspace" && (a.numeric = a.numeric.slice(0, -1), Ae(e, a.lastEvent)), !0);
}
function ue(e, t, a) {
...
function $n(e, t, a) {
  ...
  for (const p of [s[0], i[0]]) for (const u of [s[1], i[1]]) for (const f of [s[2], i[2]]) {
    const h = L([p, u, f], a, e.canvas.width, e.canvas.height);
...
function xi(e, t) {
  if (e.modalTransform) {
    t.preventDefault?.(), t.stopPropagation?.(), t.button === 0 ? Cr(e) : t.button === 2 && kr(e);
    return;
  }
  ...
  if (c) {
    ...
    if (c.entity.type === "object") {
      ...
      const w = Mr(e), D = (w.length ? w : [x]).map((M) => ({ object: M, transform: ce(M) }));
  ...
  if (e.pointerHit = !!(c || d), d) {
    ...
    if (d.type === "camera_target") {
      ...
      e.checkpoint("Move camera target"), e.beginCameraEdit();
      const { right: _, up: y } = B(n), v = [...e.camera.target], b = e.activeCameraTrack?.(), x = !!b?.target_object_id;
      e.targetFreeDrag = {
        pointer: [r, o],
...
function Mi(e, t) {
  ...
  if (!e.drag) {
    const s = e.interactionElement.getBoundingClientRect(), i = xr(e, [
      (t.clientX - s.left) * e.canvas.width / Math.max(1, s.width),
      (t.clientY - s.top) * e.canvas.height / Math.max(1, s.height)
  ...
  if (e.drag.dolly) {
    ...
    const { right: s, up: i } = B(n), l = Le(n, e.interactionElement.getBoundingClientRect().height) * (e.panSensitivity ?? 1), m = C(k(s, -a * l), k(i, r * l));
...
function Ci(e, t) {
  if (t?.type === "pointercancel" || t?.type === "lostpointercapture") {
    t.pointerId === e.activePointerId && Dr(e);
    return;
  }
  if (e.pathDrag) {
...
function Qn(e, t, a, r, o) {
  ...
  if (t?.object_id) {
    ...
    if (!c) return null;
    const d = Po(e.objects, c), p = Array.isArray(t.local_point) ? t.local_point : [0, 0, 0];
...
function Di(e, t) {
  ...
  for (const o of e.root.querySelectorAll("[data-motion-layer-action]"))
    o.addEventListener("click", () => {
      ...
      if (e.checkpoint(s === "delete" ? "Delete motion layer" : s === "retime" ? "Retime motion layer" : "Toggle motion layer"), s === "delete") Tr(e.state, n.id);
      else if (s === "retime") {
        const [i, l] = Kt(e);
        Yn(n, i, l);
...
function Ti(e, t) {
  ...
  e.root.querySelector("[data-motion-create-cancel]")?.addEventListener("click", () => Ar(e), { signal: t });
}
...
function bs(e, t) {
  ...
  if (["w", "a", "s", "d", "q", "e"].includes(a) && e.isNavigatingFly) {
    const i = e.viewportCamera(), l = e.state.view_mode !== "camera", { right: m, up: c, forward: d } = B(i), p = (t.shiftKey ? 0.6 : 0.18) * e.cameraSpeed, u = { w: k(d, p), s: k(d, -p), d: k(m, p), a: k(m, -p), e: k(c, p), q: k(c, -p) }[a];
...
function vs(e, t) {
  ...
  if (a === "s" || a === "a")
    return t.repeat || (!Ie(e.state).length || a === "a" ? (e.checkpoint("Auto-split shots"), e.state.sequence = { ...e.state.sequence || { recording_path: "" }, enabled: !0, cuts: Hr(e.state) }, Qe(e)) : (e.checkpoint("Split shot"), $r(e.state, e.frame, null) ? Qe(e) : e.setStatus("Move the playhead inside a shot first"))), !0;
  if (t.key === "Delete" || t.key === "Backspace") {
    if (t.repeat) return !0;
    const r = Ie(e.state), o = Xt(e.state, e.frame), n = o ? r.findIndex((s) => s.start === o.start) : -1;
    return n >= 0 && (e.checkpoint("Remove shot"), Ur(e.state, n) && Qe(e)), !0;
  }
  return !1;
}
function yt(e, t) {
...
const Ht = "oc-help-css", Te = "#8b7bd8", Or = /* @__PURE__ */ new Map();
function bt(e, t) {
  e && t && Or.set(e, t);
}
function st(e) {
  return e && Or.get(e) || null;
}
const ks = `
...
J.registerExtension({
  ...
  async nodeCreated(e) {
    ...
    await yt(e, async () => {
      ...
      const { attachDirector: o } = await import("./chunk-B0ojiOse.js").then((n) => n.g);
...
J.registerExtension({
  ...
  async nodeCreated(e) {
    if (qe(e) !== ot) return;
    const t = !ie, a = t ? null : vt(e);
    await yt(e, async () => (await import("./chunk-DpR00Wuy.js")).attachExtractor), e.__majoorOmniCamExtractor && _t(e, ot, t, a?.());
  }
});
J.registerExtension({
  ...
  async nodeCreated(e) {
    if (qe(e) !== nt) return;
    const t = !ie, a = t ? null : vt(e);
    await yt(e, async () => (await import("./chunk-DoCCrIcm.js")).attachMonitor), e.__majoorOmniCamMonitor && _t(e, nt, t, a?.());
  }
});
export {
  ya as $,
