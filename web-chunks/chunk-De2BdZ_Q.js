import { l as N, S as P, b as I, p as $, u as L, d as R } from "./chunk-CUiAG3lm.js";
import "../../scripts/app.js";
import { api as u } from "../../scripts/api.js";
import { M as A, E as j } from "./chunk-CbqXtcpr.js";
import { v as D, y as q } from "./chunk-Cgt_u7Uc.js";
import { a as F } from "./chunk-QPu3m5tU.js";
function c(e) {
...
function v(e, t, { live: o = !1 } = {}) {
  const r = U(t), i = e.querySelector('[data-role="profile-preflight"]');
  i.innerHTML = r.preflight.length ? r.preflight.map(W).join("") : '<div class="oc-empty">No preflight checks returned.</div>';
  ...
  return s.dataset.state = l ? "BLOCKED" : "READY", s.lastChild.textContent = l ? " BLOCKED" : " READY", e.querySelector('[data-role="output-status"]').textContent = H(l, r.targetProfile, o), r;
}
...
function k(e) {
  return T(e) === E && !f(e, "recording_path");
}
function Z(e, t) {
  if (e) {
...
function pt() {
  return `<div class="majoor-omnicam oc-monitor">
    <style>${ct}</style>
    <header class="oc-header">${I("OmniCam Monitor")}
...
const mt = 250, ft = /* @__PURE__ */ new Set(["duration_seconds", "target_fps"]);
function gt(e) {
...
class bt {
  constructor(t) {
    this.node = t, this.root = ut(), this.events = new j(), this.source = null, this.player = new G(
    ...
    }), this.bindControls(), this.syncControlsFromWidgets(), this.loadProfileInfo(), this.watcher = new rt(t, (o) => this.sourceChanged(o)), this.liveTimer = setInterval(() => this.liveTick(), mt);
  }
  ...
  syncControlsFromWidgets() {
    ...
    for (const r of g) {
      ...
      !i || t[r] == null || (ft.has(r) && Number(t[r]) <= 0 ? i.value = "" : i.value = t[r]);
    }
  ...
  refreshPlayblastPreview() {
    ...
    this.player.setSource(""), R(a, t, 640).then((s) => {
  ...
  dispose() {
    this.disposed || (this.disposed = !0, clearInterval(this.liveTimer), clearTimeout(this.connectionRefreshTimer), q(), this.refreshController?.dispose(), this.watcher?.dispose(), this.player.dispose(), this.events.dispose());
  }
}
function Ct(e) {
  if (e.__majoorOmniCamMonitor) return;
  gt(e);
  const t = new bt(e), o = st(u, e, t);
