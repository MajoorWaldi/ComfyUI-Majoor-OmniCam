...
function xe(e, t) {
  ...
  if (a.mode === "translate") {
    ...
    u = u.map((w) => x(w, D)), u = ir(e, a, u, r, t.ctrlKey || t.metaKey);
  }
  ...
  a.snapshots.forEach((S, D) => {
    ...
    if (a.mode === "translate" && (w.position = u[D]), a.mode === "rotate") {
      ...
      w.position = x(a.pivot, je(O(S.transform.position, a.pivot), f)), w.rotation = x(S.transform.rotation, f);
    }
    if (a.mode === "scale") {
...
function cr(e, t) {
  ...
  return o === "escape" ? Pa(e) : o === "enter" || o === " " ? Oa(e) : We[o] ? (a.axis = a.axis === o ? null : o, xe(e, a.lastEvent), !0) : /^[0-9]$/.test(o) || o === "." || o === "," || o === "-" && !a.numeric ? (a.numeric += o === "," ? "." : o, xe(e, a.lastEvent), !0) : (o === "backspace" && (a.numeric = a.numeric.slice(0, -1), xe(e, a.lastEvent)), !0);
}
function ve(e, t, a) {
  ...
  if (e.gizmoDrag) {
    ...
    if (c.length > 1 && p)
      if (e.state.gizmo_mode === "translate") {
        ...
        for (const u of c)
          u.object.position = x(e.gizmoDrag.groupPivot, je(O(u.transform.position, e.gizmoDrag.groupPivot), d)), u.object.rotation = x(u.transform.rotation, d);
      } else {
...
const yt = { t: "translate", r: "rotate", s: "scale" }, xr = [
...
function Pr(e, t) {
  ...
  if (t.key === "Delete" || t.key === "Backspace") {
    ...
    const o = Ce(e.state), r = xt(e.state, e.frame), n = r ? o.findIndex((s) => s.start === r.start) : -1;
...
U.registerExtension({
  ...
  async nodeCreated(e) {
    ...
    await ot(e, async () => {
      ...
      const { attachDirector: r } = await import("./chunk-BjvSH5sh.js").then((n) => n.f);
...
U.registerExtension({
  ...
  async nodeCreated(e) {
    if (Pe(e) !== Ye) return;
    const t = !ae, a = t ? null : st(e);
    await ot(e, async () => (await import("./chunk-CQwazknD.js")).attachExtractor), e.__majoorOmniCamExtractor && nt(e, Ye, t, a?.());
  }
});
U.registerExtension({
  ...
  async nodeCreated(e) {
    if (Pe(e) !== Ze) return;
    const t = !ae, a = t ? null : st(e);
    await ot(e, async () => (await import("./chunk-BifZkIVW.js")).attachMonitor), e.__majoorOmniCamMonitor && nt(e, Ze, t, a?.());
  }
});
export {
  yn as $,
