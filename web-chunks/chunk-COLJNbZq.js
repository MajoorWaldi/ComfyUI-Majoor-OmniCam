...
import { a as xe, c as Z, z as pe, v as r, A as qr, B as Ao, C as Ie, e as le, E as oo, F as os, G as To, H as Br, J as rs, K as ns, L as ss, M as is, N as wo, x as Zo, O as Wr, P as ko, Q as Vr, R as Hr, S as Ur, T as Gr, j as Xr, U as So, V as lo, W as Jo, X as Qo, Y as Yr, o as er, Z as cs, _ as ls, $ as ds, a0 as ms, a1 as ps, h as ye, p as Zr, i as Jr, a2 as tr, f as _e, a3 as fs, a4 as Qr, t as hs, a5 as bs, a6 as Po, a7 as us, a8 as gs, q as ys, a9 as vs, aa as xs, ab as ws, ac as Io, ad as ks, ae as Ss, af as js, ag as Cs, ah as Es, ai as _s, aj as $s, ak as Ms, al as As, am as Ts, an as Ps, ao as Is, ap as zs, aq as Fs, ar as Ls, as as Os, at as Ks, au as Ds, av as Ns, aw as Rs, ax as qs, ay as Bs, az as Ws, aA as Vs, aB as Hs, aC as Us, aD as Gs, aE as Xs, aF as Ys, aG as Zs, aH as Js, aI as Qs, aJ as ei, aK as ti, aL as ai, aM as oi, aN as ri, aO as ni, aP as si, aQ as ii, aR as ci, aS as li, aT as di, l as Be, aU as mi, aV as mo, aW as pi, aX as fi, aY as hi, aZ as bi, a_ as ui, a$ as Pe, b0 as gi, b1 as en, b2 as zo, b3 as yi, b4 as vi, b5 as xi, b6 as tn, b7 as Ke, b8 as wi, b9 as ki, ba as ar, bb as Fo, bc as Si, bd as an, be as ji, bf as Ci, bg as Ei, b as on, r as _i, bh as $i, bi as Mi, bj as Ai, bk as Ti, y as Pi, bl as Ii, bm as zi, bn as Fi, bo as rn, bp as Li, bq as Oi, br as Ki, bs as Di, bt as Ni, bu as Ri, bv as qi, bw as Bi, bx as Wi, by as Vi, bz as Hi, bA as Ui, bB as Gi, bC as Xi, bD as Yi, bE as Zi, bF as Ji, bG as Qi, bH as ec, s as tc } from "./chunk-CP16H5xA.js";
import { n as ac, p as oc, a as rc, s as po, S as nn, c as nc, C as or, b as sc, i as ic, w as cc, d as lc, U as je, m as dc, h as Ge, e as mc, f as pc, g as fc, j as hc, r as bc, k as uc, l as gc, E as yc } from "./chunk-BqISopNr.js";
import { L as vc, a as xc, p as kt, f as Lo, b as wc, S as kc, c as rr, d as Sc, e as jc, r as Cc, g as Ec, n as _c, C as nr, h as St, o as sn, s as $c, i as Mc, j as Ac, k as cn, l as Tc, m as Pc, q as Ic, t as zc, u as Fc, v as Lc, w as Oc, x as Kc, y as Dc, z as Nc, A as Rc, B as qc } from "./chunk-BBeOKp5S.js";
import { S as Bc, b as Wc, p as Vc } from "./chunk-DiX7WiXt.js";
import { T as Hc } from "./chunk-__IQ4xkd.js";
import { T as Uc, R as Gc } from "./vendor-three-BQUrLQkn.js";
import { b as Xc, p as ln, a as jo, c as Co, d as Yc, r as Zc, s as Jc, e as Qc } from "./chunk-tXB5k9Zz.js";
import { a as el } from "./chunk-CTXwjaoT.js";
import { l as tl, u as al } from "./chunk-eq1tqQ9i.js";
function ut(e, t = 0) {
  return Math.sin(e * 1.7 + t * 3.1) * 0.5 + Math.sin(e * 3.3 + t * 5.7) * 0.3 + Math.sin(e * 7.9 + t * 11.3) * 0.2;
}
function ol(e, { type: t = "handheld_subtle", intensity: a = 1, duration_frames: o = null, subdivide: n = !0 } = {}) {
...
function rl(e, { duration_frames: t = 120, target: a = [0, 1.5, 0], radius: o = 6, height: n = 3.5 } = {}) {
...
const dn = 1e-4;
function nl(e, t) {
  return !Array.isArray(e) || !Array.isArray(t) ? e !== t : e.some((a, o) => Math.abs(Number(a) - Number(t[o])) > dn);
}
function sr(e, t) {
  return Math.abs(Number(e) - Number(t)) > dn;
}
const mn = [
  {
    id: "camera",
...
function il(e, t = null) {
  return mn.filter((a) => !t || t.has(a.id)).map((a) => ({
    id: a.id,
    label: a.label,
    color: a.color,
    frames: sl(e, a)
...
function pn(e) {
  ...
  a.delete("camera");
  const o = e.timelineKeyframes() || [], n = il(o, a), s = ml(e, n);
...
const fo = [1, 2, 5, 10, 20, 25, 50, 100, 200, 250, 500, 1e3, 2e3, 5e3], fn = 46, ir = 5, hn = 640;
function bn(e, t) {
  const a = t > 0 ? t : hn, o = Math.max(2, Math.floor(a / fn)), n = Math.max(1e-6, e / o);
  return fo.find((s) => s >= n) ?? fo[fo.length - 1];
}
function pl(e, t) {
  const a = Math.max(1, e.state.duration_frames - 1), o = Z(Number(e.timelineZoom) || 1, 0.1, 50), n = Number(e.timelinePan) || 0, s = a / o, i = bn(s, t), l = (i >= ir ? i / ir : 0) || i, m = [], p = Math.max(0, Math.floor(n / l) * l);
...
function fl(e) {
  return e.clientWidth || e.parentElement?.clientWidth || hn;
}
function un(e) {
...
function hl(e, t) {
  ...
  a.addEventListener("pointerup", i, { signal: t }), a.addEventListener("pointercancel", i, { signal: t }), a.addEventListener("wheel", (c) => qr(e, c), { passive: !1, signal: t });
}
const bl = [1, 2, 2.5, 5, 10];
function ul(e, t = 5) {
  const a = Math.abs(e) / Math.max(1, t);
  if (!(a > 0) || !Number.isFinite(a)) return 1;
  const o = 10 ** Math.floor(Math.log10(a)), n = a / o;
  return (bl.find((s) => s >= n) ?? 10) * o;
}
function gl(e, t) {
  const a = Math.max(0, Math.min(4, Math.ceil(-Math.log10(t))));
  return e.toFixed(a);
}
function yl(e, { left: t, right: a, top: o, width: n, graphWidth: s, graphHeight: i, height: c, timeMin: l, timeMax: m, totalDuration: p, xFor: f, frame: d }) {
  const h = bn(m - l, s);
...
function vl(e, { left: t, right: a, top: o, width: n, graphHeight: s, minimum: i, maximum: c, yFor: l }) {
  const m = ul(c - i, 4);
  e.strokeStyle = "#222228", e.lineWidth = 1, e.fillStyle = "#6e727a";
  for (let p = Math.ceil(i / m) * m; p <= c; p += m) {
    const f = l(p);
    f < o - 1 || f > o + s + 1 || (e.beginPath(), e.moveTo(t, f), e.lineTo(n - a, f), e.stroke(), e.fillText(gl(p, m), 4, f + 3));
  }
}
function Oo(e, t) {
...
function gn(e, { selectedOnly: t = !1 } = {}) {
  ...
  if (h.length > 0) {
    const u = Math.min(...h), y = Math.max(...h), g = Math.max(1e-4, y - u), v = (u + y) / 2, j = (V) => n ? oo(n, V) : xe(e.state, V), x = [], M = Math.max(1, Math.floor(a / 40));
    for (let V = 0; V <= a; V += M) {
      const Q = j(V);
      for (const k of s) {
        const E = k.get(Q);
        Number.isFinite(E) && x.push(E);
      }
    }
...
function Tl(e) {
  ...
  const i = e.timelineObject(), c = e.timelineKeyframes(), l = Ve(e), m = 44, p = 14, f = 16, d = 22, h = Math.max(1, a - m - p), b = Math.max(1, o - f - d), u = Math.max(1, e.state.duration_frames - 1), y = Z(Number(e.curveZoomX) || 1, 0.1, 50), g = Number(e.curvePanX) || 0, v = u / y, j = g, x = g + v, M = [], P = Math.max(1, Math.ceil(v / Math.max(80, h))), D = ($) => i ? oo(i, $) : xe(e.state, $);
  ...
  const V = (B - U) * 0.1;
  U -= V, B += V;
  const Q = Z(Number(e.curveZoom) || 1, 0.1, 50), k = (B + U) / 2 + (Number(e.curvePanY) || 0), E = (B - U) / Q;
  U = k - E / 2, B = k + E / 2;
  const z = ($) => m + ($ - j) / Math.max(1e-6, x - j) * h, N = ($) => f + b * (B - $) / Math.max(1e-6, B - U);
  if (s.fillStyle = "#111114", s.fillRect(0, 0, a, o), s.strokeStyle = "#222228", s.lineWidth = 1, s.font = "9px system-ui, -apple-system, sans-serif", s.fillStyle = "#6e727a", yl(s, {
    left: m,
    right: p,
    top: f,
    width: a,
    ...
    xFor: z,
    frame: e.frame
  }), vl(s, { left: m, right: p, top: f, width: a, graphHeight: b, minimum: U, maximum: B, yFor: N }), U <= 0 && B >= 0) {
    const $ = N(0);
  ...
  for (const $ of l) {
    ...
    if (e.showCurveHandles)
      for (let C = 0; C < c.length; C++) {
        ...
        const oe = i ? R.transform || i : R.camera || R, ee = z(R.frame), se = N($.get(oe)), fe = c[C - 1], de = c[C + 1], he = Math.max(1, R.frame - (fe?.frame ?? R.frame - 1)), be = Math.max(1, (de?.frame ?? R.frame + 1) - R.frame), O = os(
          R,
          $.id,
          fe,
          de,
...
function yn(e) {
  ...
  if (!t) return;
  const a = e.timelineObject(), o = a ? a.name || a.type : e.activeCameraTrack().name, n = Pl(e), s = `${o}\0${n.map((c) => `${c.id}:${c.color}`).join("|")}`;
  if (t.dataset.signature !== s) {
    t.dataset.signature = s, t.replaceChildren();
...
function lr(e, t, a) {
  ...
  for (const s of [...e].sort((i, c) => i.frame - c.frame)) {
    ...
    (n === null || !(Math.abs(c - n) <= Il)) && o.push(s.frame), n = c;
  }
  return o;
}
function Ko(e) {
...
function Fl(e, t) {
  ...
  if (a.appendChild(Ra(
    ...
    () => {
      e.checkpoint("Split shot"), Br(e.state, e.frame, null) ? Qe(e) : e.setStatus(r("Move the playhead inside a shot first"));
    },
    { disabled: o }
  )), a.appendChild(Ra(
    r("Clear edit"),
...
function Ol(e, t, a, o, n) {
  t.preventDefault(), t.stopPropagation();
  const { camera: s } = vn(e, a.camera_id);
  e.contextMenu?.show(t, s?.name || r("Shot"), [
    ...
    null,
    {
      ...
      run: () => {
        e.checkpoint("Split shot"), Br(e.state, e.frame, null) && Qe(e);
      }
    },
    {
      label: r("Remove shot"),
...
function Kl(e, t, a, o) {
  const { camera: n, color: s } = vn(e, t.camera_id), i = document.createElement("div");
  ...
  if (c.className = "oc-sequence-name", c.textContent = n?.name || t.camera_id, i.appendChild(c), a > 0) {
    ...
    l.className = "oc-sequence-handle", l.title = r("Drag to trim the cut"), l.addEventListener("pointerdown", (m) => Ll(e, m, l, o, a)), i.appendChild(l);
  }
  return i.addEventListener("contextmenu", (l) => Ol(e, l, t, a, o.__cutCount)), i.addEventListener("pointerdown", () => {
...
function wn(e, t) {
  ...
  if (s.className = "oc-sequence-lane", s.dataset.role = "sequence-lane", s.setAttribute("aria-label", r("Multi-camera edit")), o.length)
    for (const [c, l] of o.entries()) {
      ...
      pe(e, l.end + 1) < -5 || m > 105 || s.appendChild(Kl(e, l, c, n));
    }
  else {
    const c = document.createElement("span");
  ...
  n.appendChild(s), n.appendChild(Dl(e));
  const i = document.createElement("span");
  i.className = "oc-sequence-playhead", i.style.left = `${pe(e, e.frame)}%`, n.appendChild(i), t.appendChild(n);
}
const Nl = ['[data-act="curve-zoom-in"]', '[data-act="curve-zoom-out"]', '[data-act="curve-fit"]', '[data-act="curve-handles"]'], mr = { curves: "Graph", dope: "Timeline", sequence: "Sequence" };
function pr(e, t) {
  ...
  a === "dope" ? Ko(e) : a === "sequence" ? (wn(e, s), s?.focus?.({ preventScroll: !0 })) : e.drawCurveEditor(), e.setStatus(r(mr[a]));
}
function Rl(e) {
  e.graphTab === "sequence" && wn(e, e.root.querySelector('[data-role="graph-sequence"]'));
}
function ql(e, t) {
...
function Wl(e) {
  ...
  if (!t || !a) return;
  const o = ac(e.state?.metadata, e.state?.duration_frames), n = o.some((c) => c.state !== "unknown");
...
function Vl(e) {
  ...
  g && (g.textContent = p.name), un(e), pn(e), yn(e), Ko(e), Rl(e), e.refreshCameraSelectors(), e.refreshKeyEditor(), e.updateEditState(), e.drawCurveEditor(), e.perf && (e.perf.timelineRefreshCount = (e.perf.timelineRefreshCount || 0) + 1), Wl(e);
}
class kn {
  constructor(t = URL) {
...
const Ql = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/><path d="M2 12h20"/></svg>', ed = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m21 16-9 5-9-5V8l9-5 9 5v8z"/><path d="m3.27 6.96 8.73 4.84 8.73-4.84"/><path d="M12 22V12"/></svg>', td = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2L2 20h20L12 2z"/><path d="M12 2v18"/></svg>', ad = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/><path d="m17.66 17.66 1.41 1.41"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="m6.34 17.66-1.41 1.41"/><path d="m19.07 4.93-1.41 1.41"/></svg>', od = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18h6"/><path d="M10 22h4"/><path d="M15.09 14c.18-.98.65-1.74 1.41-2.5A4.65 4.65 0 0 0 18 8 6 6 0 0 0 6 8c0 1 .23 2.23 1.5 3.5.76.76 1.23 1.52 1.41 2.5"/></svg>', rd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l8 8-4 4-8-8 4-4z"/><path d="M7 11L2 16l6 6 5-5"/><path d="M18 19l4 2"/><path d="M21 16l2 2"/></svg>', nd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m22 8-6 4 6 4V8z"/><rect width="14" height="12" x="2" y="6" rx="2"/></svg>', sd = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14h6v6H4z"/><circle cx="17" cy="7" r="3"/><path d="m6 3 4 7H2z"/></svg>';
function id() {
  return `
  ...
  return `
    <div class="oc-dope">
      <div class="oc-dope-body">
        <div class="oc-dope-labels">${mn.map((t) => `
...
function No({ fetchApi: e = Pd } = {}) {
  const t = (a, o) => Promise.resolve(e(a, o)).then(Id);
  return {
    list(a = {}) {
...
const Kd = 256;
function ur(e = {}) {
  const { THREE: t, GLTFLoader: a, FBXLoader: o, size: n = Kd } = e;
  if (!t || !a)
...
function Bd(e, t = {}) {
  return jn.map((a) => {
    const o = r(qd[a] || a), n = a === "all" ? "" : ` <span class="oc-asset-kind-n">${Number(t[a] || 0)}</span>`;
    return `<button type="button" class="oc-asset-kind${a === (e || "all") ? " active" : ""}" data-asset-kind="${a}">${Je(o)}${n}</button>`;
  }).join("");
}
function Wd(e, { selected: t = !1, thumbUrl: a = "" } = {}) {
  const o = Rd[e.kind] || "pi-box", n = e.kind === "character" && Wr(e.rig) === "rigged" ? `<span class="oc-asset-badge">${r("RIGGED")}</span>` : "", s = a ? `<img class="oc-asset-thumb" src="${Je(a)}" alt="" loading="lazy">` : `<span class="oc-asset-thumb oc-asset-thumb--glyph"><i class="pi ${o}"></i></span>`;
...
function Vd(e, { selectedId: t = "", thumbUrls: a = {} } = {}) {
  return !e || !e.length ? `<p class="oc-asset-empty">${r("No assets match this filter.")}</p>` : e.map((o) => Wd(o, {
    selected: o.id === t,
    thumbUrl: a[o.id] || ""
  })).join("");
}
...
function Hd(e, t = {}) {
  const a = e.root, o = t.fetchApi || ((O, H) => (e.api || e.app?.api).fetchApi(O, H)), n = t.apiClient || No({ fetchApi: o }), s = t.store || Fd(n), i = Ld(), c = t.previewQueue || Od(), l = e.api || e.app?.api || null;
  let m = t.thumbnailRenderer || null, p = null;
  const f = /* @__PURE__ */ new Set();
  function d() {
    return m ? Promise.resolve(m) : (p || (p = Dd().then((O) => m = ur(O)).catch(() => m = ur({}))), p);
  }
  function h(O) {
    return Zo(l, rc(O));
  }
    ...
    for (const O of s.state.items) {
      ...
      H && c.enqueue(O.id, async () => {
        ...
        if (i.set(O.id, ce), R(), !(O.source && O.source !== "user"))
          try {
            const me = await n.uploadThumbnail(O.id, Nd(ce));
  ...
  let Q = "", k = null, E = !0, z = !0, N = "scene", q = 0;
  ...
  let C = !1;
  function R() {
    if (j && (j.innerHTML = Bd(s.state.filter.kind, s.state.kinds)), v) {
      const O = {};
      for (const H of s.state.items) {
        const ie = i.get(H.id) || b(H);
        ie && (O[H.id] = ie);
      }
      v.innerHTML = Vd(s.state.items, { selectedId: Q, thumbUrls: O });
    }
    if (!C) {
      C = !0;
      try {
  ...
  function oe(O) {
    O === "agent" && !wo() && (O = "scene"), N = O, D && (D.hidden = O !== "scene");
    ...
    O === "assets" && E && (E = !1, s.refresh()), O === "agent" && z && (z = !1, t.onAgentFirstOpen?.());
  }
  function ee() {
    const O = wo();
  ...
  return g?.addEventListener("click", se), g?.addEventListener("dblclick", fe), a.querySelector('[data-role="left-tabs"]')?.addEventListener("click", se), x?.addEventListener("input", de), P?.addEventListener("change", he), R(), ee(), {
    ...
    refresh: () => s.refresh(),
    dispose() {
      be(), clearTimeout(k), g?.removeEventListener("click", se), g?.removeEventListener("dblclick", fe), a.querySelector('[data-role="left-tabs"]')?.removeEventListener("click", se), x?.removeEventListener("input", de), P?.removeEventListener("change", he), c.clear(), m?.dispose?.(), i.clear();
    }
  };
}
function Ud(e, t = {}) {
  ...
  const n = [];
  let s = ko(e.state?.metadata?.viewport_labels);
  function i(p) {
    if (!n[p]) {
  ...
  function l() {
    ...
    let u = 0;
    for (const y of b) {
      if (!Vr(y, { mode: s.mode, selectedIds: d })) continue;
      const g = Hr(y, s.content);
      if (!g) continue;
      const v = Ur(b, y, h) || {
        position: y.position,
        size: y.size
      }, j = e.webgl.projectWorldToScreen(Gr(v, y.type));
  ...
  function m(p) {
    s = ko({ ...s, ...p }), e.state.metadata = { ...e.state.metadata || {}, viewport_labels: { ...s } }, e.serialize?.(), l();
  }
  return l(), {
    update: l,
    get settings() {
...
function Qd(e, t = {}) {
  const a = e.root, o = t.apiClient || No({
    fetchApi: (k, E) => (e.api || e.app?.api).fetchApi(k, E)
  ...
  function y(k) {
    const E = er({ ...k, preset_id: k.id });
    return { id: k.id, name: k.name || k.id, root_offset: E.root_offset, joints: E.joints };
  }
  function g(k) {
    const E = d.get(k?.pose?.preset_id) || null;
    return ls({ preset: E, overrides: k?.pose }).joints;
  }
  function v() {
    const k = h();
  ...
  function j() {
    ...
    l && (l.textContent = k);
    const z = h(), N = g(z?.character)[k] || [0, 0, 0, 1], q = ds(N);
    m.forEach(($, W) => {
      $ && document.activeElement !== $ && ($.value = String(Math.round(q[W] * 100) / 100));
    });
  }
  function x() {
    const k = h(), E = !!k?.character?.motion;
  ...
  async function M() {
    try {
      ...
      d = new Map((k.poses || []).filter((E) => E?.id).map((E) => [E.id, y(E)]));
    } catch {
      d = /* @__PURE__ */ new Map();
    }
  ...
  function P() {
    const k = u();
    if (!k) return;
    const E = m.map((q) => Number(q?.value) || 0), z = cs(E), N = e.directorApi?.execute({
      version: 1,
  ...
  function D() {
    const k = s?.value || "neutral", E = d.get(k) || er({ preset_id: k });
    e.directorApi?.execute({
      version: 1,
      id: `tx_preset_${Date.now().toString(36)}`,
      description: "Pose preset",
      operations: [{ type: "character.set_pose", objectId: p, pose: { preset_id: k, root_offset: E.root_offset, joints: {} } }]
    }), x();
  }
  async function F() {
    const k = h();
    if (!k?.character) return;
    const E = (await kt(e, r("Save Pose"), r("Pose name"), ""))?.trim();
    if (!E || e.disposed) return;
    const z = E.toLowerCase().replace(Jd, "-").replace(/^-+|-+$/g, "").slice(0, 60) || "pose";
    try {
      ...
      d.set(N.pose.id, y(N.pose)), e.setStatus?.(r("Pose saved: {name}").replace("{name}", E)), x();
    } catch (N) {
  ...
  e.rigOverlay = V;
  function Q() {
    const k = e.selectedObject?.(), E = k?.asset_kind === "character";
    if (n.hidden = !E, !E) {
...
const tm = /* @__PURE__ */ new Set(["translate", "rotate", "scale"]), am = /* @__PURE__ */ new Set(["world", "local"]), Ae = 180 / Math.PI;
function xr(e) {
  return [e.x, e.y, e.z];
}
function om(e) {
...
function rm({
  ...
  const p = m ? m() : new e.Object3D(), f = l ? l(t, a) : new Uc(t, a);
  let d = null;
  ...
  function k(C) {
    if (!tm.has(C)) throw new Error(`createTransformControlsAdapter: unknown mode "${C}"`);
    f.setMode ? f.setMode(C) : f.mode = C;
  }
  function E(C) {
    if (!am.has(C)) throw new Error(`createTransformControlsAdapter: unknown space "${C}"`);
    f.space = C;
  }
  function z(C) {
...
function sm(e, { controlsFactory: t, anchorFactory: a } = {}) {
  let o = null, n = null, s = !1, i = null, c = !1;
  function l(k) {
    if (!o) return;
    const E = k || e.state.spatial_snap_mode === "grid";
  ...
  function d() {
    return o || (!e.webgl || !e.interactionElement ? null : (o = rm({
      THREE: Hc,
  ...
  function h({ targetSpec: k }) {
    if (k) {
      if (l(c), k.type === "object") {
        ...
        const E = ps(e), z = (E.length ? E : [k.object]).map((q) => ({
          object: q,
          transform: Ie(q)
        }));
      ...
      if (k.type === "path_point" || k.type === "path_group") {
        ...
        e.checkpoint(k.type === "path_point" ? "Transform path point" : "Transform path selection"), n = {
          ...
          baseKeys: E.keyframes.map((N) => ({ ...N, camera: le(N.camera) })),
          lookAtActive: Jr(E, e.state.objects)
        };
        return;
      }
      if (k.type === "path_point_target") {
        const E = k.track;
        if (!E || E.locked || k.readOnly) return;
  ...
  function b(k) {
    ...
    return E === "translate" ? { mode: E, delta: k.position } : E === "scale" ? { mode: E, origin: n.origin, factors: k.scaleFactors } : { mode: E, origin: n.origin, rotationDeg: k.rotationDeg };
  }
  function u(k) {
  ...
  function y(k) {
    ...
    E && (E.keyframes = Qr(n.baseKeys, b(k)), u(E));
  }
  function g(k) {
    const E = e.state.cameras.find((N) => N.id === n.trackId);
    if (!E) return;
    const z = { ...b(k), lookAtActive: n.lookAtActive };
    E.keyframes = hs(n.baseKeys, n.selectedFrames, z), u(E);
  }
  function v(k) {
    const E = e.state.cameras.find((z) => z.id === n.trackId);
    E && (E.keyframes = bs(n.baseKeys, [n.frame], { delta: k.position }), u(E));
  }
  function j({ delta: k }) {
  ...
  function x(k) {
    const { group: E, pivot: z } = n, N = e.state.gizmo_mode;
    for (const q of E)
      if (N === "translate")
        q.object.position = ye(q.transform.position, k.position);
      else if (N === "rotate")
        q.object.position = ye(z, tr(_e(q.transform.position, z), k.rotationDeg)), q.object.rotation = ye(q.transform.rotation, k.rotationDeg);
      else if (N === "scale") {
        const $ = _e(q.transform.position, z);
  ...
  function M(k) {
    if (e.state.gizmo_mode === "translate")
      ...
      const E = _e(n.target, n.position);
      e.camera.target = ye(n.position, tr(E, k.rotationDeg));
    }
    e.commitCameraEdit();
  }
  function P(k) {
    const E = ye(n.base, k.position);
    n.tracking ? fs(e, E) : e.camera.target = E, e.commitCameraEdit();
  }
  function D({ cancelled: k }) {
    if (!n) return;
    const E = n.type;
    k ? (e.undo(), (E === "camera" || E === "camera_target") && e.finishCameraEdit()) : E === "camera" || E === "camera_target" ? e.finishCameraEdit() : (e.editingKeyFrame = null, e.updateKeyVisualState?.(), e.drawCurveEditor?.()), n = null, e.refreshInspector(), e.render();
  }
  function F() {
    if (!e.webgl || !e.interactionElement) return;
    const k = e.recording ? null : ms(e), E = e.state.gizmo_mode || "translate", z = !!k && !k.readOnly && nm.has(k.type) && k.allowedModes.includes(E);
    if (i = z ? k.type : null, !z) {
      o?.detach();
      return;
    }
    d() && (o.isDragging() || (o.setCamera(e.webgl.activeCamera), o.setMode(E), o.setSpace(e.state.gizmo_space === "local" ? "local" : "world"), o.attach(k)));
  }
  function U() {
...
const wr = ["#4aa3ef", "#f2a93b", "#48c774", "#b565d8", "#ec4899"], Oe = [4, 8, 12, 20, 35, 60, 100];
function tt(e) {
...
function fm(e, t, a, o) {
  const n = ro(e, a, o);
  if (!n) return;
  const { rx: s, ry: i, radarSize: c, cx: l, cy: m, innerRadius: p, range: f, scale: d, camPos: h, camTgt: b, cameras: u, activeTrack: y } = n, g = tt(e), v = e.state.active_camera_id || y?.id, j = (ee, se) => En(n, ee, se);
  ...
  for (let ee = 0; ee < u.length; ee++) {
    const se = u[ee], fe = se.keyframes || [], de = se.id === v, he = se.color || wr[ee % wr.length];
  ...
  const [P, D] = j(h[0] || 0, h[2] || 0), [F, U] = j(b[0] || 0, b[2] || 0), B = 8, V = Z(P, s + B, s + c - B), Q = Z(D, i + B, i + c - B), k = Z(F, s + B, s + c - B), E = Z(U, i + B, i + c - B), z = h[1] || 0, N = mm(z), q = pm(z);
  t.strokeStyle = "rgba(255, 255, 255, 0.40)", t.lineWidth = 1, t.setLineDash([3, 3]), t.beginPath(), t.moveTo(V, Q), t.lineTo(k, E), t.stroke(), t.setLineDash([]), t.fillStyle = "#ffffff", t.beginPath(), t.arc(k, E, 2.5, 0, Math.PI * 2), t.fill(), t.strokeStyle = "rgba(255, 255, 255, 0.7)", t.lineWidth = 1, t.beginPath(), t.arc(k, E, 4.5, 0, Math.PI * 2), t.stroke();
...
function $n(e, t, a, o) {
  const { camPos: n, camTgt: s, cameras: i, rx: c, ry: l, radarSize: m } = t, p = (y, g) => En(t, y, g), [f, d] = p(n[0] || 0, n[2] || 0);
...
function gm(e, t, a, o) {
  ...
  if (s.drag) {
    const [u, y] = Eo(n, a, o), g = e.viewportCamera();
  ...
  const p = _n(n, a, o), f = $n(e, n, a, o), [d, h] = Eo(n, a, o);
...
function xm(e, t, a) {
  ...
  t('[data-role="duration-seconds"]')?.addEventListener("change", (d) => {
    ...
    e.setChannelFilter("all"), yn(e), e.drawCurveEditor(), Ko(e);
  ...
  for (const d of e.root.querySelectorAll(".toolbar-menu"))
    d.addEventListener("toggle", () => {
      d.open ? (e.closeMenus(d), kr(d)) : vm(d);
    }, { signal: a });
  document.addEventListener("scroll", () => {
    for (const d of e.root.querySelectorAll(".toolbar-menu[open]")) kr(d);
  }, { capture: !0, signal: a });
  const c = (d, h) => {
  ...
  e.root.addEventListener("pointerdown", (d) => {
    ...
    const h = e.interactionElement.getBoundingClientRect(), b = (d.clientX - h.left) * e.canvas.width / Math.max(1, h.width), u = (d.clientY - h.top) * e.canvas.height / Math.max(1, h.height);
    ym(e, d, b, u) || e.onWheel(d);
  }, { passive: !1, signal: a }), e.root.addEventListener("wheel", Vc(e.root), { signal: a }), window.addEventListener("pointermove", (d) => {
  ...
  l && (l.addEventListener("pointerdown", (d) => e.onTimelinePointerDown(d), { signal: a }), l.addEventListener("pointermove", (d) => e.onTimelinePointerMove(d), { signal: a }), l.addEventListener("pointerup", (d) => e.onTimelinePointerUp(d), { signal: a }), l.addEventListener("pointercancel", (d) => e.onTimelinePointerUp(d), { signal: a }), l.addEventListener("wheel", (d) => qr(e, d), { passive: !1, signal: a }));
  const m = (d) => {
...
function Cm() {
  return `<span class="oc-pref-emoji" aria-hidden="true">${wm}</span> ${r("OmniCam Preferences")}`;
}
function Em(e) {
  ...
  a.className = "oc-modal-backdrop", a.setAttribute("role", "dialog"), a.setAttribute("aria-modal", "true"), a.setAttribute("aria-label", r("OmniCam Preferences")), a.innerHTML = `
    <div class="oc-modal-dialog oc-pref-dialog" tabindex="-1">
      <div class="oc-pref-header">
        <div class="oc-pref-title">${Cm()}</div>
...
const $m = ["position", "target"], Mm = ["fov", "zoom"], Am = ["roll"], Tm = ["position", "size"], Pm = ["rotation"];
function _o(e) {
  ...
  for (let n = 1; n < a.length - 1; n++) {
    ...
    if (i.camera) {
      for (const p of $m) {
        ...
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const b = jr(f, d, h, m);
          a[n].camera[p] = Er(d.map(Number), b, o);
        }
      }
      for (const p of Mm) {
        const f = s.camera?.[p], d = i.camera?.[p], h = c.camera?.[p];
    ...
    if (Array.isArray(i.position) && Array.isArray(s.position) && Array.isArray(c.position)) {
      for (const p of Tm) {
        ...
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const b = jr(f, d, h, m);
          a[n][p] = Er(d.map(Number), b, o);
        }
      }
      for (const p of Pm) {
        const f = s[p], d = i[p], h = c[p];
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const b = [0, 1, 2].map((u) => Cr(f[u], d[u], h[u], m));
...
function Nm(e, t) {
  ...
  const o = (n) => {
    ...
    const b = (y) => {
      ...
      let v = Om;
      y.shiftKey ? v = Km : (y.ctrlKey || y.metaKey) && (v = Dm);
      const j = m * v * 20;
      let x = l + g * j;
...
function Vm(e, t) {
  ...
  }, s = (i) => (e.smoothingBaseline?.cameraId !== i.id && (e.smoothingBaseline = { cameraId: i.id, keys: Lm(i.keyframes) }), e.smoothingBaseline.keys);
  a.addEventListener("input", n, { signal: t }), a.addEventListener("change", () => {
    const i = e.activeCameraTrack();
    if (!i) return;
    e.checkpoint("Path smoothing");
    const c = Number(a.value) / 100, l = Fm(s(i), c);
  ...
  if (a.length) {
    ...
    for (const o of a)
      o.addEventListener("change", () => {
        e.dopeChannels = new Set(a.filter((n) => n.checked).map((n) => n.dataset.dopeChannel)), pn(e);
      }, { signal: t });
  }
}
function Xm(e, t) {
...
const Ba = () => import("./chunk-CCWBbSI4.js");
function Zm(e, t) {
...
function ap(e, t) {
  Zm(e, t), Wm(e, t), Vm(e, t), Hm(e, t), Um(e, t), Qm(e, t), tp(e, t), ep(e, t), Nm(e, t), Rm(e, t), Gm(e, t), Ym(e, t), Bm(e, t), Xm(e, t), Jm(e, t);
}
const $r = {
...
function op(e, t = "#1b1f2b", a = "#151822", o = "#1e2330", n = "#161922", s = "#111319") {
...
function Ob(e, t, a = An) {
  ...
  const h = new e.FogExp2(1250588, 8e-3), b = op(e), u = new e.PMREMGenerator(t);
  u.compileEquirectangularShader();
  const y = new Gc(), g = u.fromScene(y, 0.04).texture;
  return y.traverse((v) => {
    v.geometry?.dispose?.();
...
function Nb(e, t, a) {
  return e?.reconstruction ? a ? "neutral" : sp(t) === "source_texture" ? "textured" : "neutral" : null;
}
function ip(e, t) {
...
function cp(e, t, a) {
  ...
  for (const s of e.root.querySelectorAll("[data-lens]"))
    s.addEventListener("click", () => {
      Ec(e, Number(s.dataset.lens));
    }, { signal: a });
  for (const s of e.root.querySelectorAll("[data-blocking-scene]"))
    s.addEventListener("click", () => {
      dm(e, s.dataset.blockingScene), e.closeMenus();
    }, { signal: a });
...
const lp = 32, dp = 0.025, mp = 0.05, Za = 1e-6, pp = ["top", "bottom", "front", "back", "left", "right"], fp = {
  top: "y",
  bottom: "y",
  front: "z",
  back: "z",
...
function yp(e) {
  ...
  const s = Math.min(lp, n.length, o + 1);
  if (s < 2) return [];
  const i = bp(n, s);
  ...
  for (let d = p; d < i.length; d++) {
    const h = i[d], b = up(i, d, m, e.planeAxis), u = le(c);
    u.position = [...h], u.target = gp(h, b, l, e.planeAxis), f.push({
...
function Mr(e, t = {}) {
  ...
  if (a === "extend") {
    ...
    pp.includes(e.state.view_mode) || e.setViewMode?.("top"), c = Mo(e.state);
  const p = fp[e.state.view_mode] ?? null, f = s ? [...s] : [...n.position];
...
function Wo(e, t) {
  ...
  return n && Bo(n, o) < dp ? !1 : (a.points.push(o), !0);
}
function Te(e) {
...
function xp(e) {
  ...
  if (a.length < 2 || hp(a) < mp || t.range[1] <= t.range[0])
  ...
  const n = _c(e.state), s = e.state.cameras.length, i = {
    id: n,
    name: vp(e.state),
    color: nr[s % nr.length],
...
function jp(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : (Qa(t), t.type === "pointercancel" || t.type === "lostpointercapture" ? (Te(e), !0) : (Wo(e, Vo(e, t)), a.drawing = !1, xp(e), !0));
}
function Cp(e) {
  const t = e.cameraPathDraw;
...
function Ep(e, t) {
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? Te(e) : Mr(e);
    }, { signal: t });
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path-extend"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? Te(e) : Mr(e, { mode: "extend" });
    }, { signal: t });
...
function Ho(e, t, { name: a = "", status: o } = {}) {
  const n = t && typeof t == "object" ? t : en(), s = { ...n, metadata: { ...n.metadata || {}, scene_name: a || "" } };
...
async function _p(e) {
  await St(e, r("New Scene"), r("Start a new scene? Unsaved changes will be lost.")) && Ho(e, en(), { name: "", status: r("New scene") });
}
async function $p(e) {
  if (!e.sceneBaseline) {
...
async function Mp(e) {
  const t = zn(e) || r("Untitled"), a = await kt(e, r("Save Scene"), r("Scene name"), t);
  if (a == null) return;
...
function Pp(e, t) {
  Va(e, t, e.root.querySelectorAll('[data-act="scene-new"]'), () => _p(e)), Va(e, t, e.root.querySelectorAll('[data-act="scene-open"]'), () => Ap(e)), Va(e, t, e.root.querySelectorAll('[data-act="scene-save"]'), () => Mp(e)), Va(e, t, e.root.querySelectorAll('[data-act="scene-reset"]'), () => $p(e));
}
const Ip = ["world_point", "object_point", "camera_field"], Ar = 40;
function zp(e) {
  return (e.keys || []).map((t) => ({ x: t.x, y: t.y, t: t.time_seconds }));
}
function Fp(e, t, a) {
  const o = Math.max(1, Number(e.fps) || 24), n = e.width || 1280, s = e.height || 720, i = [];
  for (let c = 0; c <= Ar; c += 1) {
    const l = a * c / Ar, m = zo(e, t.source, l * o, n, s);
...
function Op(e) {
  ...
  for (const y of e.state.motion_layers || []) {
    if (y.enabled === !1) continue;
    const g = Ip.includes(y.source_kind), v = g ? Fp(e.state, y, d) : zp(y);
...
function Rp(e, t) {
  ...
  return {
    ...
    motion_scene_fingerprint: el(e.state)
  };
}
function qp(e, t) {
  const a = Rp(e, t);
...
function Tr(e, t, { frameCount: a = 0, fps: o = 0 } = {}) {
...
const qe = 1024 * 1024, Bp = Object.freeze({
  card: 128 * qe,
  // MAX_CARD_BYTES
  model: 256 * qe,
  // MAX_MODEL_BYTES
...
function jt(e, t) {
  ...
  return !Number.isFinite(o) || o <= a ? null : `${e.name || "File"} is ${Ir(o)}; the maximum is ${Ir(a)}.`;
}
function Wp(e) {
  return Number(e) <= Pr ? null : `${e} frames selected; a background sequence is limited to ${Pr}.`;
}
function Vp(e) {
...
async function Up(e, { load: t = () => import("./vendor-mediabunny-CZ5VNE-V.js") } = {}) {
...
async function Xp(e, t, { decode: a = Up } = {}) {
  if (!t) return;
  const o = jt(t, "audio");
  if (o) {
    e.setStatus(o);
  ...
  try {
    ...
    s.preload = "auto", s.src = n, e.audioObjectUrl = n, e.audioElement = s, await Gp(s), e.audioDuration = Number.isFinite(s.duration) ? s.duration : 0;
    try {
...
function Ct(e, t) {
  ...
  a && (e.cardMediaById.delete(t), e.cardMediaAssetById?.delete?.(t), t === "subject" && e.cardMedia === a && (e.cardMedia = null), Zp(a));
}
function Jp(e) {
...
function De(e, t, a, o = !1, n = "") {
  ...
  s && s !== a && Ct(e, t), o && Kn.add(a), Yp(a), e.cardMediaAssetById ||= /* @__PURE__ */ new Map(), e.cardMediaById.set(t, a), e.cardMediaAssetById.set(t, n || a?.__omnicamAsset || "");
  try {
    a.__omnicamAsset = n || a.__omnicamAsset || "";
  } catch {
  }
...
async function sf(e) {
    ...
    if (h) {
      if (d === "image" || d === "video") {
        ...
        if (b && b.value) {
          ...
          }), De(e, "subject", u, !1, u.currentSrc || u.src || ""), Tr(e, u, { frameCount: u instanceof HTMLVideoElement ? 0 : 1 }), e.upstreamImageConnected = !0, s = !0, e.render(), e.setStatus(u instanceof HTMLVideoElement ? r("Upstream video preview synced") : r("Upstream image preview synced")));
        }
      }
      if (d === "audio") {
        l = !0;
      ...
      if (d === "scene_3d" || d === "model" || d === "mesh") {
        ...
        if (b && b.value) {
          ...
          if (["glb", "gltf", "obj", "fbx", "stl", "ply"].includes(y)) {
            const g = h.widgets?.find((M) => String(M.name).toLowerCase() === "subfolder")?.value || "", v = Ke(Xe(u, g)), j = `upstream_scene_${h.id}`;
            m.add(j);
  ...
  $c(e) && (s = !0), s && (e.serialize(), e.render());
}
const cf = ["video/mp4;codecs=avc1.42E01E", "video/webm;codecs=vp9", "video/webm;codecs=vp8", "video/webm"], zr = { low: 3e6, balanced: 6e6, high: 12e6 };
function lf(e) {
  return zr[e] || zr.balanced;
}
async function df({
  canvas: e,
  fps: t,
  ...
  try {
    for (const j of cf)
      if (!(s.isTypeSupported && !s.isTypeSupported(j)))
        try {
          f = new s(p, { mimeType: j, videoBitsPerSecond: lf(n) });
          break;
        } catch {
        }
...
async function Rn(e) {
  await pf(e.cardMediaById.values());
}
async function qn(e) {
  return df({
    canvas: e.canvas,
...
async function Bn(e, t) {
  const a = await mf(We, t);
  if (qp(e, t), e.state.playblast_camera_id === tn)
...
async function hf(e) {
  ...
  const t = e.frame, a = e.canvas.width, o = e.canvas.height, n = ff(e);
  (n.width !== e.canvas.width || n.height !== e.canvas.height) && (e.canvas.width = n.width, e.canvas.height = n.height, e.render());
  try {
    let s = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-B2vn5RQn.js");
...
async function Wn(e) {
  ...
  return Do(wt, { route: "/majoor/omnicam/upload_asset", field: "asset", file: e });
}
async function ao(e) {
...
function vf(e) {
  const t = ko(e.state?.metadata?.viewport_labels);
  ...
  for (const p of a) {
    if (p.enabled === !1 || !Vr(p, { mode: t.mode, selectedIds: m })) continue;
    const f = Hr(p, t.content);
    if (!f) continue;
    const d = Ur(a, p, l) || { position: p.position, size: p.size }, h = Pe(Gr(d, p.type), o, s, i);
    if (!h) continue;
    ...
    n.fillStyle = "rgba(16,17,22,0.82)", xf(n, P, D, x, M, 4 * c), n.fill(), y && (n.strokeStyle = y, n.lineWidth = Math.max(1, c), n.stroke()), n.fillStyle = y || "#e6e6ec", n.fillText(f, P + g, D + M - v - 2 * c);
  }
  n.restore();
}
function xf(e, t, a, o, n, s) {
...
function kf(e) {
  ...
  return e._pointFieldCache?.key !== n && (e._pointFieldCache = { key: n, ...wi(t, a, o) }), e._pointFieldCache;
}
const Sf = 600;
function jf(e) {
  const { points: t, colors: a } = kf(e);
  if (!t.length) return;
  const o = e.viewportCamera(), n = e.canvas.width, s = e.canvas.height, i = t.length / 3, c = 3 * Math.max(1, Math.ceil(i / Sf)), l = /* @__PURE__ */ new Map();
...
function If(e) {
  ...
  for (let o = 0; o < e.state.keyframes.length - 1; o++) {
    ...
    t.push(Be(_e(s.camera.position, n.camera.position)) * e.state.fps / Math.max(1, s.frame - n.frame));
  }
...
function zf(e) {
  ...
  e.recording && e.state.playblast_labels && vf(e);
}
async function Ff(e, { signal: t } = {}) {
...
async function Of(e) {
  ...
  const n = o.diagnostic?.issues || [], s = Lf(n);
...
const Kf = 1, Fr = 0.01, Df = 0.4, Nf = 3, Rf = 120, qf = 20, Bf = 4, Wf = 0.25, Vf = 0.5;
function Hf(e, t, a) {
  const o = Be(_e(t.camera.position, e.camera.position)), n = t.frame - e.frame, s = n / a, i = s > 1e-9 ? o / s : 1 / 0;
...
function Gf({ keys: e, fps: t = 24, objects: a = [] } = {}) {
  ...
  for (const c of s)
    ...
    }), c.distance < Fr && c.duration >= Df && n.push({
      code: "STATIC_SEGMENT",
      severity: "info",
      frameStart: c.frameStart,
      frameEnd: c.frameEnd,
  ...
  if (i.length) {
    ...
    if (c > 1e-6)
      for (const l of s)
        Number.isFinite(l.speed) && l.speed > c * Nf && n.push({
          code: "SPEED_SPIKE",
          severity: "warning",
  ...
  for (let c = 1; c < o.length - 1; c += 1) {
    const l = _e(o[c].camera.position, o[c - 1].camera.position), m = _e(o[c + 1].camera.position, o[c].camera.position), p = Be(l), f = Be(m);
    if (p < 1e-6 || f < 1e-6) continue;
    const d = Math.max(-1, Math.min(1, ki(l, m) / (p * f))), h = Math.acos(d) * 180 / Math.PI;
    h >= Rf && n.push({
  ...
  if (o.length >= Bf) {
    ...
    let f = Math.abs(Lr(p, c, l) - Lr(m, c, l)) % 360;
    f > 180 && (f = 360 - f);
    const d = Be(_e(p, m));
    f <= qf && d > Fr && n.push({
  ...
  if (Array.isArray(a) && a.length)
    for (const c of o)
      for (const l of a) {
        ...
        const m = Number.isFinite(Number(l.radius)) ? Number(l.radius) : Vf;
        Be(_e(c.camera.position, l.position)) < m + Wf && n.push({
  ...
  if (p) {
    ...
    if (t.appendChild(v), !j)
      for (const { object: x, level: M } of g) {
        ...
        E.style.cssText = V ? "color:#fca5a5" : B ? "" : "opacity:.5;text-decoration:line-through", E.textContent = x.name || x.type, E.title = r("Double-click to rename"), E.addEventListener("dblclick", ($) => {
          $.preventDefault(), $.stopPropagation(), eh(e, x, E);
        }), k.appendChild(E);
        ...
        N.className = "scene-item-actions", N.appendChild(n(B ? "pi-eye" : "pi-eye-slash", B ? "Hide object (Alt+Click to Isolate)" : "Show object (Alt+Click to Isolate)", !B, ($) => {
          if ($?.altKey) {
            ...
            e.toggleObject(x.id);
        }, "color:#ef4444;opacity:.7")), N.appendChild(n(x.locked ? "pi-lock" : "pi-lock-open", "Lock object", x.locked, () => qo(e, x))), N.appendChild(n("pi-copy", "Duplicate object", !1, () => e.duplicateObject?.(x.id))), x.id !== "subject" && N.appendChild(n("pi-trash", "Delete object", !1, () => e.deleteObject?.(x.id))), N.appendChild(n("pi-ellipsis-v", "Object actions", !1, ($) => e.openObjectContext($, x.id))), P.append(Q, k, N), P.title = r("Click to select · Double-click to toggle visibility · Right-click for actions");
        const q = ($ = {}) => {
...
function sh(e) {
  const t = Et(e), a = e.root.querySelector('[data-role="object-panel"]');
  a && (a.hidden = !t);
  const o = (k) => e.root.querySelector(k), n = e.activeCameraTrack(), s = o('[data-role="camera-target-object"]');
  if (s) {
    const k = n.target_object_id || e.state.target_object_id || "", E = `T${ar()}${e.state.objects.map((z) => `${z.id}\0${z.name || z.type}`).join("|")}`;
    yo(s, E, () => [
  ...
  ["camera-px", "camera-py", "camera-pz", "camera-tx", "camera-ty", "camera-tz", "camera-fov", "camera-roll", "camera-near", "camera-far", "camera-rx", "camera-ry", "camera-rz"].forEach((k, E) => {
  ...
  if (!t) {
    ...
    E && (E.textContent = `${n.name} · F${e.frame}`), Or(o, {
  ...
  if (c) {
    ...
    if (k) {
      c.hidden = !1;
      const E = k.semantic ? `${k.semantic} · ` : "";
      c.textContent = `${E}${k.label} (${Math.round(k.confidence * 100)}%)`, c.title = k.title, c.className = `oc-recon-badge oc-badge-${k.band}`;
    } else
      c.hidden = !0;
  }
  ...
  p && (p.textContent = t.name || t.type), Or(o, {
  ...
  if (y) {
    const k = t.id, E = /* @__PURE__ */ new Set([k]);
    let z = !0;
    for (; z; ) {
      z = !1;
      for (const $ of e.state.objects)
        !E.has($.id) && $.parent_id && E.has($.parent_id) && (E.add($.id), z = !0);
    }
    const N = e.state.objects.filter(($) => !E.has($.id)), q = `P${ar()}${k}${N.map(($) => `${$.id} ${$.name || $.type}`).join("|")}`;
    yo(y, q, () => [
      gt("", r("No parent")),
  ...
  if (D && (D.hidden = t.type === "point_light"), g) {
    ...
    if (E && (E.checked = t.cast_shadow !== !1), v) {
  ...
  if (b && (b.hidden = !F?.animations), u) {
    ...
    yo(u, `A${k.join("|")}`, () => k.map((E, z) => gt(String(z), E)), String(t.animation_index || 0));
  }
...
function dh(e) {
  ...
  e.beginCameraEdit(), Si(e.camera, n), e.commitCameraEdit(), e.finishCameraEdit(), Zn(e), lh(e), e.render();
}
function mh(e) {
  const t = globalThis.performance?.now?.() ?? Date.now();
  (!Number.isFinite(e.lastCameraHudEditAt) || t - e.lastCameraHudEditAt > 300) && e.checkpoint("Edit camera"), e.lastCameraHudEditAt = t;
...
function _h(e, t) {
  t && (e.selectedKeyFrame = t.frame, e.selectedKeyFrames = /* @__PURE__ */ new Set([t.frame]), e.editingKeyFrame = null, ke(e) || (e.pathSelection = ji(e.pathSelection, { cameraId: e.state.active_camera_id, frame: t.frame, additive: !1 })), e.setFrame(t.frame));
}
function $h(e) {
...
const Ih = ["guides", "safe-areas", "resolution-gate", "aspect-ratio"];
function zh(e) {
...
function Oh(e) {
  ...
  t.hidden = !1;
  const o = Gf({ keys: a, fps: e.state?.fps || 24, objects: e.state?.objects || [] });
  if (!o.length) {
    const n = document.createElement("div");
...
function Nh(e) {
  ...
  if (t.interpolation = e.root.querySelector('[data-role="key-interp"]').value, t.camera.position = [a("key-px", t.camera.position[0]), a("key-py", t.camera.position[1]), a("key-pz", t.camera.position[2])], t.camera.target = [a("key-tx", t.camera.target[0]), a("key-ty", t.camera.target[1]), a("key-tz", t.camera.target[2])], t.camera.fov = Z(a("key-fov", t.camera.fov), 5, 150), t.camera.roll = Z(a("key-roll", t.camera.roll || 0), -180, 180), t.camera.zoom = Math.max(0.01, a("key-zoom", t.camera.zoom || 1)), t.camera.near = Math.max(1e-4, a("key-near", t.camera.near)), t.camera.far = Math.max(t.camera.near + 1e-4, a("key-far", t.camera.far)), t.camera.camera_type = e.root.querySelector('[data-role="key-camera-type"]').value, e.root.querySelector('[data-role="key-timing-weight"]')) {
    const n = Ci(t, a("key-timing-weight", an(t)));
...
function Vh(e) {
  ...
  return {
    ...
    restoreHistorySnapshot(I) {
      ...
      const S = Kr(this.state), w = new Set(this.state.objects.map((Y) => Y.id));
      this.state = Ue(T.state);
      const _ = new Set(this.state.objects.map((Y) => Y.id));
      for (const Y of w) _.has(Y) || this.removeObjectResources(Y);
      ...
      this.selectedKeyFrames = new Set(L.filter((Y) => X.has(Y))), this.selectedKeyFrame = this.selectedKeyFrames.has(T.selectedKeyFrame) ? T.selectedKeyFrame : [...this.selectedKeyFrames].at(-1) ?? null, this.pathSelection = Ei(this.pathSelection, this.activeCameraTrack()), this.subSelection = T.subSelection || null, this.camera = Fe(this.state, this.frame), vt(this, this.activeCameraTrack(), this.camera, this.frame), this.cameraPreviewSignature = "", this.serialize(), S !== Kr(this.state) && this.restoreAssets(), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
    },
    checkpoint(I) {
    ...
    onContextMenu(I) {
      ...
      const T = I.target, S = T.closest?.(".camera-preview-tile"), w = T.closest?.(".scene-item"), _ = T.closest?.(".key");
      ...
      if (_) {
        const A = this.timelineKeyframes().find((K) => K.frame === Number(_.dataset.keyFrame));
    ...
    openObjectContext(I, T) {
      ...
      const w = ["sun_light", "point_light", "spot_light"].includes(S.type), _ = this.selectedObjectIds?.size || 0;
      if (_ >= 2 && this.selectedObjectIds.has(T)) {
        this.showContextMenu(I, `${_} ${r("objects selected")}`, [
          { label: r("Duplicate {count} objects").replace("{count}", String(_)), icon: "pi-copy", shortcut: "Shift+D", run: () => this.duplicateSelectedObjects() },
          ...
          { label: r("Delete {count} objects").replace("{count}", String(_)), icon: "pi-trash", danger: !0, shortcut: "Del", run: () => this.deleteSelectedObjects() },
          null,
          { label: r("Deselect all"), icon: "pi-times", shortcut: "Alt+A", run: () => this.deselectAll() }
        ]);
        return;
    ...
    openCameraContext(I, T, S = !1) {
      const w = this.state.cameras.find((_) => _.id === T);
      w && (this.selectedEntity = "camera", this.selectedObjectId = null, this.activateCamera(T), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), this.showContextMenu(I, `${w.name}${S ? " preview" : ""}`, [
        ...
        null,
        {
          ...
          icon: "pi-sliders-h",
          items: [
            { label: r("Shot: move earlier"), icon: "pi-arrow-up", disabled: this.state.cameras.findIndex((_) => _.id === T) <= 0, run: () => this.moveShot(T, -1) },
            { label: r("Shot: move later"), icon: "pi-arrow-down", disabled: this.state.cameras.findIndex((_) => _.id === T) >= this.state.cameras.length - 1, run: () => this.moveShot(T, 1) },
            null,
    ...
    openPathKeyContext(I, T, S) {
      ...
      const _ = (w.keyframes || []).find((Y) => Y.frame === S) || null;
      _ && this.selectKeyframe(_), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
      const A = _ ? po(_) : "auto", K = this.selectedKeyFrames?.size || 0, X = this.pathSelection?.component === "target", L = Jr(w, this.state.objects);
    ...
    moveShot(I, T) {
      ...
      const [_] = this.state.cameras.splice(S, 1);
    ...
    async editShotHandles(I) {
      ...
      this.checkpoint("Shot handles"), T.handles = { in: Math.min(600, Number(_[1])), out: Math.min(600, Number(_[2])) }, this.serialize(), this.setStatus(`${T.name} handles: ${T.handles.in} / ${T.handles.out}`);
    },
    openTimelineContext(I, T) {
      const S = this.selectedKeyFrames?.size || 0, w = this.selectedKeyframe(), _ = w?.interpolation || "ease", A = w && po(w) || "auto", K = ["ease", "linear", "bezier", "smooth", "ease_in", "ease_out", "sine", "cubic", "quintic", "expo", "back"], X = ["auto", "clamped", "vector", "free", "aligned", "flat"];
    ...
    openCurveContext(I) {
      const T = this.selectedKeyFrames?.size || 0, S = T < 2 && !this.selectedKeyframe(), w = this.selectedKeyframe(), _ = w?.interpolation || "ease", A = w && po(w) || "auto", K = ["bezier", "smooth", "linear", "ease_in", "ease_out", "ease", "sine", "cubic", "quintic", "expo", "back"], X = ["auto", "clamped", "vector", "free", "aligned", "flat"];
    ...
    resizeCanvas() {
      ...
      if (!I) return;
      const T = Math.min(2, window.devicePixelRatio || 1), S = I.clientWidth || 320, w = I.clientHeight || 180, _ = Math.max(320, Math.round(S * T)), A = Math.max(180, Math.round(w * T));
      (this.canvas.width !== _ || this.canvas.height !== A) && (this.canvas.width = _, this.canvas.height = A);
      for (const K of this.cameraPreviewCanvases.values()) {
        const X = K.clientWidth || 220, L = K.clientHeight || 124, Y = Math.max(T, Wh / Math.max(1, X)), ue = Math.max(1, Math.round(X * Y)), $e = Math.max(1, Math.round(L * Y));
...
const Dr = { motion: "motion", shot: "display", health: "health" }, Gh = {
  object: "Object",
  camera: "Camera",
  camera_target: "Look-At Target",
  camera_path: "Camera Path"
}, Xh = { motion: "Motion", shot: "Shot", health: "Health" }, Yh = ["entity", "motion", "shot", "health"];
function es(e) {
  return e.inspectorMode && e.inspectorMode !== "entity" ? e.inspectorMode : "entity";
}
function Zh(e) {
  const t = es(e);
  return Dr[t] ? Dr[t] : e.selectedEntity === "object" ? "scene" : "camera";
}
function Jh(e) {
  return [
    e.selectedEntity || "",
...
function tb(e) {
  ...
  return {
    ...
    setSpatialHandleMode(w) {
      ...
      this.checkpoint(r("Camera path handle: {mode}").replace("{mode}", w)), lc(A[K], w, {
        prevKey: A[K - 1] || null,
        nextKey: A[K + 1] || null
    ...
    setPathSelectionComponent(w) {
      this.pathSelection = Mi(this.pathSelection, w), this.refreshInspector(), this.render();
    },
    ...
    insertPathKeyAtCursor(w) {
      ...
      const _ = this.interactionElement.getBoundingClientRect(), A = (w.clientX - _.left) * this.canvas.width / Math.max(1, _.width), K = (w.clientY - _.top) * this.canvas.height / Math.max(1, _.height), X = this.webgl.pickPathSegment([A, K]);
      if (!X) return !1;
      const L = (this.state.cameras || []).find((ue) => ue.id === X.cameraId);
      if (!L || L.locked) return !1;
      const Y = ic(L.keyframes || [], {
    ...
    transformCameraPath(w) {
      ...
      const A = Qr(_.keyframes, { origin: Zr(_.keyframes), ...w });
      return _.keyframes = A, _.id === this.state.active_camera_id && (this.state.keyframes = A), this.camera = Se(_, this.frame, this.state.objects), _.camera = Fe(this.camera), this.serialize(), this.refreshKeys(), this.refreshInspector(), this.render(), this.renderCameraView?.(), !0;
    },
    ...
    redistributeActiveCameraTiming() {
      ...
      const _ = [...w.keyframes].sort((K, X) => K.frame - X.frame), A = _i(_, {
        startFrame: _[0].frame,
        endFrame: _[_.length - 1].frame
      });
    ...
    toggleInspector(w) {
      ...
      if (!_) return;
      const A = w !== void 0 ? w : _.dataset.collapsed !== "true";
      _.dataset.collapsed = String(A);
    ...
    selectHierarchy(w = this.selectedObjectId) {
      ...
      for (; A; ) {
        ...
        for (const K of this.state.objects)
          K.parent_id && _.has(K.parent_id) && !_.has(K.id) && (_.add(K.id), A = !0);
      }
    ...
    lookAtObject(w) {
      const _ = this.state.objects.find((A) => A.id === w);
      if (_) {
        this.checkpoint("Look-at constraint");
        for (const A of this.state.cameras)
          for (const K of A.keyframes) K.camera.target = [..._.position || [0, 1.5, 0]];
        this.camera = Se(this.state, this.frame), this.serialize(), this.refreshKeys(), this.render(), this.setStatus(`Cameras look at ${_.name || _.type}`);
      }
    },
    setTransformMode(w) {
      ft(this, w);
    ...
    refreshInspector() {
      this.perf && (this.perf.inspectorRefreshCount = (this.perf.inspectorRefreshCount || 0) + 1), ya(this), Qh(this);
    },
    setInspectorMode(w) {
      eb(this, w);
    },
    ...
    aimAtSelectedObject(w) {
      ...
      const _ = this.activeCameraTrack(), A = w && this.state.objects.find((L) => L.id === w) || this.selectedObject() || this.state.objects.find((L) => L.id === "subject") || this.state.objects[0];
      if (!A) return;
      _.target_object_id !== A.id && (_.aim_bone = null), _.target_object_id = A.id, _.id === this.state.active_camera_id && (this.state.target_object_id = A.id, this.state.aim_bone = _.aim_bone);
...
function ab(e) {
  ...
  return {
    ...
    async loadMediaUrl(S, w, _, A) {
      return Gt(this, S, w, _, A);
    },
    restoreAssets() {
      Jt(this);
    },
...
const ib = "http://www.w3.org/2000/svg", Ye = 26, Nr = 17, cb = 5.4;
function Ze(e, t) {
  const a = document.createElementNS(ib, e);
...
function lb(e) {
  ...
  for (const s of nb(rb(a))) {
    const i = Ye + s.x * Nr, c = Ye + s.y * Nr, l = sb(s.depth);
...
function mb(e) {
  ...
  for (const n of e.state.motion_layers || []) {
    ...
    const s = db(e.state, n, e.frame, a, o);
    if (s.length) {
...
const pb = ["world_point", "object_point", "camera_field"], as = {
  manual_2d: "DRAW",
  object_point: "OBJECT",
  world_point: "WORLD",
...
function gb(e) {
  ...
  s("motion-sel-name", a.label), s("motion-sel-type", as[a.source_kind] || "TRACK"), s("motion-sel-binding", fb(e.state, a)), s("motion-sel-start", n.length ? Math.min(...n) : 0), s("motion-sel-end", n.length ? Math.max(...n) : 0);
...
function xb(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: n, initializeTooltips: s, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: m, activeCameraTrack: p, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: b, syncActiveCameraTrack: u, syncFromWidgets: y, bindEditorEvents: g, activateCamera: v, addCamera: j, deleteCamera: x, drawPreviewOverlays: M, duplicateCamera: P, maximizeCameraPreview: D, refreshCameraPreviews: F, refreshCameraSelectors: U, renameCamera: B, setPlayblastCamera: V, toggleCameraView: Q, captureRealtime: k, makePlayblast: E, uploadDirectorPlayblast: z, waitForMediaFrame: N, computeAudioPeaks: q, loadAudioFile: $, releaseAudio: W, stopPlay: C, togglePlay: R, applyCameraPreset: G, applyCameraShake: ae, applyProxyPreset: oe, clearViewportBgImage: ee, loadViewportBgFile: se, loadViewportBgSequence: fe, drawCameraPath: de, drawCard: he, drawCube: be, drawCylinder: O, drawGrid: H, drawHuman: ie, drawLine3D: ce, drawNull: me, drawOverlays: re, drawPointField: we, drawSpeedHeatmap: _t, drawSphere: $t, drawTorus: at, curveChannels: ot, drawCurveEditor: rt, onCurvePointerDown: nt, onCurvePointerMove: Mt, onCurvePointerUp: At, onTimelinePointerDown: Tt, onTimelinePointerMove: st, onTimelinePointerUp: it, refreshKeys: He, resetCurveZoom: ct, resetTimelineZoom: lt, setChannelFilter: dt, setCurveInterpolation: Pt, setTangentMode: mt, timelineFrameFromEvent: It, toggleCurveHandles: zt, zoomCurve: Ft, drawTransformGizmo: Lt, frameTarget: Ot, gizmoAxes: Kt, gizmoGeometry: Dt, onPointerDown: Nt, onPointerMove: Rt, onPointerUp: qt, onWheel: Bt, pickGizmo: pt, pickSceneObject: ft, resetCamera: Wt, setTransformMode: Vt, setViewMode: no, viewportCamera: so, loadCardFile: Ht, loadExecutionPreview: Ut, loadMediaUrl: Gt, loadModelFile: Xt, loadSelectedReference: Yt, onModelLoaded: Zt, restoreAssets: Jt, syncUpstreamInputs: ht, configureDomMedia: Qt, refreshSetupDiagnostic: ea, addMediaCard: ta, addPrimitive: aa, applyObjectAnimationFrame: oa, beginCameraEdit: ra, beginObjectEdit: na, commitCameraEdit: sa, commitObjectEdit: ia, copyKeyframe: ca, deleteKeyframe: la, deleteObject: da, duplicateObject: ma, exitKeyEdit: pa, finishCameraEdit: fa, goToAdjacentKey: ha, insertKeyframe: ba, loadSelectedKeyView: ua, pasteKeyframe: ga, playblastCameraAtFrame: ya, refreshInspector: va, refreshKeyEditor: xa, refreshObjects: wa, removeObjectResources: ka, renameObject: Sa, retimeSelectedKey: ja, selectKeyframe: Ca, selectedKeyframe: Ea, selectedObject: _a, selectObjectAnimation: $a, setKeyInterpolation: Ma, setObjectParent: Ne, timelineKeyframes: Aa, timelineObject: Ta, toggleAutoKey: Pa, toggleObject: Ia, updateCameraFromHud: za, updateEditState: Fa, updateKeyVisualState: La, updateSelectedKey: bt, updateSelectedObject: Oa, clamp: Ka, cloneCamera: Da, configureCore: Fe, defaultCamera: io, sampleCamera: Ue, sampleObjectTransform: Se, sanitizeState: I, worldTransform: T } = e;
  return {
    ...
    renderViewportOnly() {
      const S = this.ctx, w = this.canvas.width, _ = this.canvas.height;
      if (S.fillStyle = this.state.viewport_bg_color || "#121212", S.fillRect(0, 0, w, _), this.viewportBgSequenceImages && this.viewportBgSequenceImages.length) {
        ...
        if (Le?.complete && Le.naturalWidth)
          try {
            S.drawImage(Le, 0, 0, w, _);
          } catch {
          }
      } else if (this.viewportBgImage)
        try {
          S.drawImage(this.viewportBgImage, 0, 0, w, _);
        } catch {
        }
      ...
      if (this.webgl) {
        try {
          const te = this.recording ? 1 : this.webgl.supersampleFactor?.() ?? 1, Le = te > 1 ? Math.min(te, 4096 / Math.max(1, w, _)) : 1, Na = Le > 1 ? Math.round(w * Le) : w, co = Le > 1 ? Math.round(_ * Le) : _;
          this.webgl.activeCamera && this.transformControlsWiring?.sync(), this.webgl.render(Re, K, this.cardMediaById, Na, co, this.modelUrlsById, this.frame, this.recording, this.selectedEntity, this.selectedObjectId, this.subSelection, this.selectedKeyFrame ?? null, this.selectedKeyFrames ? [...this.selectedKeyFrames] : null), S.imageSmoothingEnabled = !0, S.imageSmoothingQuality = "high", Na !== w || co !== _ ? S.drawImage(this.webgl.canvas, 0, 0, Na, co, 0, 0, w, _) : S.drawImage(this.webgl.canvas, 0, 0, w, _), J = !0;
        } catch (te) {
      ...
      !this.recording && this.state.speed_heatmap && this.drawSpeedHeatmap(), !this.recording && Cp(this), this.drawOverlays(), mb(this), this.state.show_gizmo && lb(this), this.labelOverlay?.update(), this.rigOverlay?.update(), this.perf && (this.perf.viewportRenderCount = (this.perf.viewportRenderCount || 0) + 1);
    },
    ...
    requestUiUpdate(S = je.viewport, w = "unknown") {
      (this.renderReasons ||= /* @__PURE__ */ new Set()).add(w), this.uiDirtyMask = dc(this.uiDirtyMask, S), this.renderInvalidations = (this.renderInvalidations || 0) + 1, !this.renderScheduled && (this.renderScheduled = !0, this.renderFrame = requestAnimationFrame(() => {
        if (this.renderScheduled = !1, this.disposed) return;
        const _ = this.uiDirtyMask || je.viewport;
        this.uiDirtyMask = 0, this.lastRenderReasons = [...this.renderReasons || []], this.renderReasons?.clear(), this.rendersCoalesced = (this.rendersCoalesced || 0) + 1, this.perf && (this.perf.renderCount = (this.perf.renderCount || 0) + 1), Ge(_, je.outliner) && this.refreshObjects(), Ge(_, je.timeline) && this.refreshKeys(), Ge(_, je.inspector) && this.refreshInspector(), Ge(_, je.viewport) && this.renderViewportOnly(), Ge(_, je.previews) && this.renderCameraView(), Ge(_, je.motion) && this.renderMotionUiOnly();
      }));
    },
    renderCameraView() {
      if (this.perf && (this.perf.previewRenderCount = (this.perf.previewRenderCount || 0) + 1), this.state.camera_view_visible) {
        ...
        for (const K of w) {
          ...
          if ($e && ($e.textContent = `F${this.frame}`), _ && K.id !== this.state.active_camera_id && K !== A) continue;
    ...
    dispose() {
      this.disposed || (this.disposed = !0, this.agentBridge?.dispose?.(), this.transformControlsWiring?.dispose(), Ti(this), Pi(), Ac(this), this.backgroundRequestId = (this.backgroundRequestId || 0) + 1, this.upstreamSyncId = (this.upstreamSyncId || 0) + 1, this.stopPlay(), clearTimeout(this.previewClickTimer), clearTimeout(this.connectionTimer), cancelAnimationFrame(this.restoreFrame), cancelAnimationFrame(this.serializeFrame), cancelAnimationFrame(this.resizeFrame), cancelAnimationFrame(this.renderFrame), this.abortController?.abort(), this.upstreamFetchController?.abort(), this.resizeObserver?.disconnect(), this.contextMenu?.dispose(), this.webgl?.dispose(), this.cameraWebgl?.dispose(), W(this), Jp(this), this.objectUrls.clear(), this.cardMediaById.clear(), this.cardMediaAssetById?.clear?.(), this.modelUrlsById.clear(), this.modelInfoById.clear());
    }
  };
}
const wb = 0.12;
function kb() {
  return {
    ...
    deleteSelectedKeyframes() {
      ...
      const t = this._activeTrack(), a = ve(this), o = t.kind === "camera" ? 1 : 0, { keys: n, removed: s } = hc(a, e, { minKeys: o });
    ...
    nudgeSelectedKeyframes(e) {
      ...
      const a = this._activeTrack(), o = Math.max(0, this.state.duration_frames - 1), n = fc(ve(this), t, e, { lastFrame: o });
    ...
    setSelectedKeysInterpolation(e) {
      ...
      this.checkpoint(r("Interpolation on {n} keys").replace("{n}", t.length)), a.write(pc(ve(this), t, e)), this.serialize(), this.refreshKeys(), this.refreshKeyEditor(), this.render(), this.drawCurveEditor(), this.setStatus(r("{mode} interpolation on {n} keys").replace("{mode}", e.replace(/_/g, " ")).replace("{n}", t.length));
    },
    setSelectedKeysTangentMode(e) {
      const t = this.resolveSelectedFrames();
      if (t.length < 2) return this.setTangentMode(e);
      const a = this._activeTrack(), o = Ve(this).map((n) => n.id);
      this.checkpoint(r("Tangents on {n} keys").replace("{n}", t.length)), a.write(mc(ve(this), t, e, o)), this.serialize(), this.refreshKeys(), this.render(), this.drawCurveEditor(), this.setStatus(r("{mode} tangents on {n} keys").replace("{mode}", e).replace("{n}", t.length));
    },
    /**
    ...
    simplifyActiveKeys({ mode: e = "simplify", tolerance: t = 0, target: a = 0, scope: o = "camera", fromKeys: n = null, silent: s = !1 } = {}) {
      ...
      const l = this.resolveSelectedFrames(), m = o !== "all_cameras" && l.length >= 2 ? [l[0], l.at(-1)] : null, p = m ? [] : l, f = (b) => {
        ...
        let M = j, P = 0;
        if (j.length > 2) {
          const D = e === "reduce" ? bc(j, i, { target: a || Math.ceil(j.length / 2), keepFrames: p }) : e === "clean" ? uc(j, i, { keepFrames: p }) : gc(j, i, { tolerance: t * wb, keepFrames: p });
...
class Yo {
  ...
  constructor(t) {
    this.runtime = t;
    const a = t.node;
    this.disposed = !1, this.app = Rr, this.api = We, this.node = a, this.root = Sn(), this.root.tabIndex = -1, this.dom = Cn(this.root), this.canvas = this.root.querySelector(".viewport-wrap > canvas"), this.cameraPreviewCanvases = /* @__PURE__ */ new Map(), this.cameraPreviewContexts = /* @__PURE__ */ new Map(), this.cameraPreviewSignature = "", this.interactionElement = this.canvas, this.interactionElement.tabIndex = 0, this.interactionElement.dataset.captureWheel = "true", this.ctx = this.canvas.getContext("2d", { alpha: !1 }), this.webgl = null, this.cameraWebgl = null, this.webglReady = this.loadWebGLViewports(), this.transformControlsWiring = sm(this), this.camera = xe(this.state, this.frame), this.playing = !1, this.drag = null, this.cameraEditActive = !1, this.cameraEditKey = null, this.keyDrag = null, this.timelineDrag = null, this.curveDrag = null, this.selectedKeyFrame = this.state.keyframes[0]?.frame ?? null, this.pathSelection = zi(), this.editingKeyFrame = null, this.copiedKeyframe = null, this.cameraSpeed = 1, this.cardMedia = null, this.cardMediaById = /* @__PURE__ */ new Map(), this.cardMediaAssetById = /* @__PURE__ */ new Map(), this.objectUrls = new kn(), this.cardUrlsById = this.objectUrls.urls, this.modelUrlsById = /* @__PURE__ */ new Map(), this.modelInfoById = /* @__PURE__ */ new Map(), this.executionReferences = [], this.selectedObjectId = null, this.selectedEntity = "camera", this.subSelection = null, this.cardUrl = null, this.recording = !1, this.gizmoDrag = null, this.playTimer = null, this.previewClickTimer = null, this.showCurveHandles = !0, this.uiDirtyMask = 0, this.perf = globalThis.__omnicamPerf === !0 ? { renderCount: 0, viewportRenderCount: 0, previewRenderCount: 0, timelineRefreshCount: 0, inspectorRefreshCount: 0, lastFrameMs: 0 } : null, this.contextMenu = new cn(this.root), this.refreshCameraPreviews(), this.initializeTooltips(), this.bindEditorEvents(), this.bindWidgetCallbacks(), this.syncFromWidgets(), this.resizeCanvas(), this.render(), this.refreshKeys(), this.refreshObjects(), this.restoreAssets(), this.syncUpstreamInputs(), this.refreshSetupDiagnostic(), // Seed every frame-derived readout (timecode, lens millimetres, viewport
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-B2vn5RQn.js"));
    } catch (a) {
...
const Ha = { app: Rr, api: We, EditorHistory: yc, ContextMenuController: cn, initializeTooltips: Tc, promptText: kt, ObjectUrlRegistry: kn, buildRoot: Sn, dispatchDirectorKey: Li, activeCameraTrack: jo, bindWidgetCallbacks: Yc, playblastCameraTrack: ln, restoreFromWidgets: Zc, serializeEditorState: Jc, syncActiveCameraTrack: Co, syncFromWidgets: Qc, bindEditorEvents: Dp, activateCamera: Pc, addCamera: Ic, deleteCamera: zc, drawPreviewOverlays: Fc, duplicateCamera: Lc, maximizeCameraPreview: Oc, refreshCameraPreviews: Kc, refreshCameraSelectors: Dc, renameCamera: Nc, setPlayblastCamera: Rc, toggleCameraView: qc, captureRealtime: qn, makePlayblast: hf, uploadDirectorPlayblast: Bn, waitForMediaFrame: Rn, computeAudioPeaks: Ln, loadAudioFile: Xp, releaseAudio: eo, stopPlay: Xa, togglePlay: Hp, applyCameraPreset: im, applyCameraShake: cm, applyProxyPreset: lm, clearViewportBgImage: yf, loadViewportBgFile: uf, loadViewportBgSequence: gf, drawCameraPath: Pf, drawCard: Tf, drawCube: Cf, drawCylinder: $f, drawGrid: wf, drawHuman: _f, drawLine3D: ne, drawNull: Af, drawOverlays: zf, drawPointField: jf, drawSpeedHeatmap: If, drawSphere: Ef, drawTorus: Mf, curveChannels: Ve, drawCurveEditor: Tl, fitCurveView: gn, onCurveDoubleClick: Ml, onCurvePointerDown: xl, onCurvePointerMove: wl, onCurvePointerUp: kl, onTimelinePointerDown: Oi, onTimelinePointerMove: Ki, onTimelinePointerUp: Di, refreshKeys: Vl, resetCurveZoom: Al, resetTimelineZoom: Ni, setChannelFilter: jl, setCurveInterpolation: Sl, setTangentMode: Cl, timelineFrameFromEvent: Ao, toggleCurveHandles: El, zoomCurve: $l, drawTransformGizmo: Ri, frameTarget: qi, gizmoAxes: Bi, gizmoGeometry: Wi, onPointerDown: Vi, onPointerMove: Hi, onPointerUp: Ui, onWheel: Gi, pickGizmo: Xi, pickSceneObject: Yi, resetCamera: Zi, setTransformMode: Ji, setViewMode: Qi, viewportCamera: ec, loadCardFile: of, loadExecutionPreview: rf, loadMediaUrl: Nn, loadModelFile: af, loadSelectedReference: nf, onModelLoaded: tf, restoreAssets: ef, syncUpstreamInputs: sf, configureDomMedia: On, refreshSetupDiagnostic: Of, addMediaCard: nh, addPrimitive: th, applyObjectAnimationFrame: wh, beginCameraEdit: $h, beginObjectEdit: Yn, commitCameraEdit: Mh, commitObjectEdit: ch, copyKeyframe: Ch, deleteKeyframe: jh, deleteObject: Xn, deleteSelectedObjects: rh, duplicateObject: Gn, exitKeyEdit: Th, finishCameraEdit: Ah, goToAdjacentKey: qh, insertKeyframe: kh, loadSelectedKeyView: Rh, pasteKeyframe: Eh, playblastCameraAtFrame: xh, refreshInspector: sh, refreshKeyEditor: Kh, refreshObjects: Un, removeObjectResources: hh, renameObject: ah, retimeSelectedKey: Dh, selectKeyframe: _h, selectedKeyframe: ze, selectedObject: Et, selectObjectAnimation: fh, setKeyInterpolation: Sh, setKeyTangentMode: Lh, setObjectParent: ph, timelineKeyframes: ve, timelineObject: ke, toggleAutoKey: Ph, toggleObject: oh, updateCameraFromHud: mh, updateCameraRotationFromHud: dh, updateEditState: zh, updateKeyVisualState: Fh, updateSelectedKey: Nh, updateSelectedObject: ih, clamp: Z, cloneCamera: le, configureCore: rn, defaultCamera: on, sampleCamera: xe, sampleObjectTransform: oo, sanitizeState: tc, worldTransform: Po };
Object.assign(
  Yo.prototype,
  Vh(Ha),
  tb(Ha),
...
function jb(e) {
  ...
  try {
    a.assetBrowser = Hd(a, {
      ...
      onAgentFirstOpen: async () => {
        if (wo())
          try {
            const { createDirectorAgentPanel: o } = await import("./chunk-rV7Pbvrb.js");
            a.agentPanel = o(a);
          } catch (o) {
  ...
  try {
    a.characterRuntime = Gd(a), a.rigMapper = Yd(a), a.poseEditor = Qd(a), a.motionEditor = em(a);
  } catch (o) {
...
const Rb = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  closeDirectorWorkbench: Cb,
  openDirectorWorkbench: jb
