...
import { S as Ct, b as _t, p as Mt } from "./chunk-D-oV5MeS.js";
import { M as Tt, E as Rt } from "./chunk-CbqXtcpr.js";
import { v as h, O as it, T as _, bL as $t, bn as Nt } from "./chunk-yjHTInyb.js";
import { d as H } from "./chunk-eq1tqQ9i.js";
import { h as ct, D as At, L as Ft, E as Pt } from "./chunk-BxMhWkWu.js";
import { a as Lt, F as Ot, S as It, m as lt, c as dt } from "./chunk-sVL03mTG.js";
import { c as Dt, q as qt, a as ut, r as jt, s as Vt, b as Ut, d as Bt, e as Wt, p as Gt, f as Ht } from "./chunk-BaylDYv6.js";
function zt(e) {
...
async function Jt(e, t) {
  ...
  e.upstreamPreviewActive = r ? await H(r, o, 960) : !1, e.disposed || e.render();
}
function Zt(e, t) {
...
const ae = { geometry: "depth_mesh", layout: "depth_mesh" }, pt = /* @__PURE__ */ new Set(["blockout", "hybrid", "scan"]), ne = /* @__PURE__ */ new Set(["vggt", "vggt_omega_research"]);
function ht(e) {
  if (!e) return {};
...
function L(e, t) {
  ...
  const r = bt(e, "recon_completion_policy", "off");
...
class me {
  constructor({
    ...
    this.root = t, this.node = o, this.api = r, this.app = a, this.getSource = n, this.onAdopt = s, this.onQueue = i, this.onCancel = l, this.on = c, this.client = new ce(r), this.runGeneration = 0, this.state = mt();
  ...
  async ensurePreview() {
    return this.preview || this.disposed ? this.preview : (this.previewLoad ||= import("./chunk-CsssZCqx.js").then(({ TrackViewer: t }) => {
  ...
  pushSceneToPreview() {
    ...
    !this.preview || !t || (this.preview.setReconstructedScene(t, {
      resolveAssetUrl: (o) => it(this.api, o)
  ...
  syncFromWidgets() {
    J(this.node, this.root), O(this.root), this.render();
  }
...
function ge({ node: e, root: t, mode: o, refineSettings: r }) {
  let a = Z(e, "extract_mode", o);
  if (o === "scene_reconstruct")
    return L(e, t) || a;
  for (const n of fe)
    r?.[n] !== void 0 && (a = Z(e, n, r[n]) || a);
  return a;
}
const ve = {
...
class Ee {
  constructor({ onRefine: t, delay: o = Se, setTimer: r, clearTimer: a } = {}) {
    this.settings = { ...tt }, this.alignment = V(), this.onRefine = t || (() => {
  ...
  reset() {
    return this.settings = { ...tt }, this.alignment = V(), this.schedule(), this.settings;
  }
  payload() {
...
function Ie(e, t, o = t?.width, r = t?.height) {
...
class De {
  ...
  async load(t, o, { maxDimension: r = 960 } = {}) {
    ...
    try {
      ...
      if (a !== this.generation || n.signal.aborted || Oe(i)) return !1;
...
async function qe(e) {
  const t = await N.fetchApi("/majoor/omnicam/extractor/source", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
...
function je(e) {
  ...
  a && (e.sourceKey = r, e.describing = "", e.queuePromptId && ut(e.api, e.queuePromptId).catch(() => {
  ...
  const n = e.sourceViewer.setSource(
    o.available && o.ref ? it(N, o.ref.value) : "",
    { source: o.available ? o.ref : null }
  );
  return a && e.coordinator.seek(0, "source"), e.dispatch({ type: "SOURCE", source: n ? { ...o, playbackError: "" } : o }), t !== "scene_reconstruct" && (o.available && o.ref ? vt(e, o) : z(e, 0)), Jt(e, o), o;
}
async function vt(e, t) {
  ...
  try {
    ...
    const r = o?.info || null;
    return e.dispatch({ type: "SOURCE", source: { info: r } }), r && (e.coordinator.setRate(Number(r.fps) || e.sourceViewer.fps), z(e, Number(r.frame_count) || 0), Xt(e, r)), r;
  } catch (o) {
...
function We(e, t) {
  ...
  return o ? (r.push(["Tracking state", K(o).toUpperCase()]), Number.isFinite(Number(o.coverage)) && r.push(["Coverage", `${Math.round(Number(o.coverage) * 100)}%`]), o.inliers != null && r.push(["Inliers", String(o.inliers)]), r) : (r.push(["Tracking state", "UNKNOWN"]), r);
}
...
const Ge = {
  ...
  { key: "roll", label: "Roll" }
], He = 18, ze = 9, ot = 2, xt = 78, Ke = { solve: "SOLVE HEALTH" }, I = {
  bands: ["solve"],
  labels: !0,
  labelWidth: xt,
  bandHeight: ze,
...
function R(e, t, o, r) {
  const a = Math.max(1, (Number(o) || 1) - 1), n = St(t, r);
...
function oo(e, { y: t, height: o, width: r, frameCount: a, colorAt: n, style: s }) {
  const i = Math.max(1, Number(a) || 0), l = St(r, s), c = Math.max(1, Math.ceil(i / l)), u = Math.max(1, l / Math.ceil(i / c));
  for (let m = 0; m < i; m += c) {
...
function ro(e, t, o, r) {
  ...
  for (let s = Math.max(0, Number(o) || 0); s < Math.max(0, Number(r) || 0); s += 1) {
    const i = K(a.get(s)), l = String((t || [])[s] || "").toLowerCase(), c = l === "over" ? "bad" : l === "warn" ? "weak" : l === "ok" ? "good" : "unknown";
    P(i) > P(n) && (n = i), P(c) > P(n) && (n = c);
  }
  return n;
}
function ao(e, t, o) {
  const r = Number(o) || 0, a = (e || []).find((i) => Number(i.frame) === r), n = String(t?.frame_grades?.[r] || "unknown").toUpperCase(), s = [["Solve state", K(a).toUpperCase()], ["Motion grade", n]];
...
function co(e, {
  ...
  const c = Math.max(1, Number(s) || Number(t?.duration_frames) || 1), u = kt(t, i), { rows: m, style: d } = wt(i, l), b = {
    total: c,
...
function ho(e, t) {
  const o = U(e?.anomalies), r = U(Object.values(kt(t)).flat()), a = r.length ? r : U(t?.keyframes);
...
class vo {
  ...
  setDiagnostics({ points: t = [], vectors: o = [], frame: r = 0, state: a = "unknown" } = {}) {
    this.points = at(t, bo), this.vectors = at(o, go), this.frame = Number(r) || 0, this.state = String(a || "unknown"), this.draw();
  }
  clear() {
  ...
  draw({ sourceWidth: t = 0, sourceHeight: o = 0 } = {}) {
    ...
    for (const i of this.vectors) {
      ...
      r.strokeStyle = $[i.state] || $.accepted, r.beginPath(), r.moveTo(l, c), r.lineTo(u, m), r.stroke();
    }
    for (const i of this.points) {
      const [l, c] = G(i, s);
      r.fillStyle = $[i.state] || $.accepted, r.fillRect(l - 1.5, c - 1.5, 3, 3);
    }
    return (this.state === "weak" || this.state === "bad") && (r.strokeStyle = this.state === "bad" ? $.rejected : $.weak, r.lineWidth = 2, r.strokeRect(1, 1, a - 2, n - 2)), { points: this.points.length, vectors: this.vectors.length };
  }
  dispose() {
...
function So(e) {
  return import("./chunk-CsssZCqx.js").then(({ TrackViewer: t }) => (e.viewerLoad = null, e.disposed || e.viewer || (e.viewer = new t(e.$("track-canvas")), e.pushTracksToViewer()), e.viewer)).catch((t) => (e.viewerLoad = null, console.warn("OmniCam track viewer unavailable", t), null));
}
function nt(e) {
  const t = e.$("frame");
  t && (t.value = String(e.state.frame));
  const o = e.$("time");
  o && (o.textContent = et(e.state.frame, e.sourceViewer.fps));
  const r = e.$("frame-readout");
  r && (r.textContent = `${e.state.frame} / ${Math.max(0, e.state.frameCount - 1)} · ${et(e.state.frame, e.sourceViewer.fps)}`);
...
class Et {
  ...
  constructor(t) {
    this.runtime = t;
    const o = t.node;
    this.node = o, this.app = Y, this.api = N, this.root = Be(), this.disposed = !1, this.events = new Rt(), this.requests = new Kt(), this.diagnostics = new _e(), this.upstreamPreviewActive = !1, this.motionLimits = null, this.refine = new Ee({ onRefine: (s) => this.requestRefine(s) }), this.fallbackViewer = new De(this.$("fallback-preview"), { api: N }), this.sourceViewer = new Ae(this.$("source-video"), {
  ...
  async loadMotionLimits() {
    try {
      const t = await this.requests.run(async (o) => {
        const r = await N.fetchApi?.("/majoor/omnicam/motion_profiles", { signal: o });
  ...
  bindControls() {
    this.events.on(this.root, "wheel", Mt(this.root));
  ...
  async requestRefine(t) {
    ...
    try {
      ...
      return this.dispatch({ type: "REFINED", fingerprint: a }), this.pushTracksToViewer(), dt(this.node, { motionScene: lt(r), fingerprint: a }), o;
    } catch (o) {
  ...
  applyRefined() {
    try {
      const { fingerprint: t } = $e(this.node, {
  ...
  async capturePreviewDataUrl() {
    ...
    if (this.viewer?.canvas && this.viewer.renderer)
      try {
        if (await H(this.viewer.canvas, t, 240))
          return t.toDataURL("image/webp", 0.7);
      } catch (a) {
        console.warn("[OmniCam] Extractor solve-result preview capture failed", a);
      }
    const o = ["source-video", "fallback-preview", "upstream-preview"].map((a) => this.$(a)).find((a) => a && !a.hidden);
    return o && await H(o, t, 240) ? t.toDataURL("image/webp", 0.7) : null;
  }
  ...
  render() {
    ...
    if (i && l && c && u && m) {
      ...
      const Q = n === "APPLIED";
      u.dataset.state = Q ? "completed" : M ? "active" : "pending", m.dataset.state = Q ? "completed" : "pending";
    }
    ...
    }), this.renderTimeline(), this.transport.render(), nt(this), st(this);
