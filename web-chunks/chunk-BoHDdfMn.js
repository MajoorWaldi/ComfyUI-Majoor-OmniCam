import { a, a4 as j, bO as te, bP as J, bQ as w } from "./chunk-CEInYxLm.js";
...
function he(e, n = {}) {
  ...
  return f?.addEventListener("click", G), y?.addEventListener("change", R), m?.addEventListener("change", B), d?.addEventListener("input", D), E(), Q(), I(), _(), {
    get state() {
      return g;
    },
    dispose() {
