...
function Zr(e) {
  e.registerExtension({
    ...
    beforeRegisterNodeDef(t, a) {
      if (!String(a?.name || a?.node_id || t?.comfyClass || t?.type || "").startsWith($r)) return;
      ...
      t.prototype.onDrawForeground = function(n) {
        ...
        if (n.save(), this.selected) {
          const m = Yr(), p = n.createRadialGradient(d, c, Y * 0.35, d, c, Y * 1.15);
...
const mt = "en", Ie = /* @__PURE__ */ new Map([[mt, {}]]);
function Qr(e, t) {
  Ie.set(e, { ...Ie.get(e) || {}, ...t || {} });
}
let Pe = mt;
...
function S(e) {
  return Pe === mt ? e : Ie.get(Pe)?.[e] || e;
}
const to = "__sequence__";
function ao() {
...
function so(e, t, a = null) {
  const r = e?.sequence?.cuts || [], o = Math.max(0, Math.round(Number(t) || 0));
  if (!r.length || o <= 0 || r.some((i) => i.start === o)) return !1;
  const s = ra(e, o)?.camera_id || r[0].camera_id;
  return r.push({ camera_id: a || no(e, s), start: o }), r.sort((i, l) => i.start - l.start), !0;
}
function io(e, t) {
  const a = e?.sequence?.cuts || [];
  return t < 0 || t >= a.length || a.length === 1 ? !1 : (a.splice(t, 1), a.length && (a[0].start = 0), !0);
}
const oa = Object.freeze(["select", "track", "anchor", "project", "erase"]), na = Object.freeze(["manual_2d", "static_anchor", "world_point", "object_point", "camera_field"]), sa = Object.freeze(["linear", "smooth", "hold"]), Se = (e, t = 0) => Number.isFinite(Number(e)) ? Number(e) : t, Tt = (e) => Math.max(0, Math.min(1, Se(e)));
function lo(e, t) {
  return {
    ...
    y: Tt(e?.y),
    visible: e?.visible !== !1,
    interpolation: sa.includes(e?.interpolation) ? e.interpolation : "linear"
  };
}
function co(e) {
  ...
  return e.motion_layers = (Array.isArray(e.motion_layers) ? e.motion_layers : []).slice(0, 256).map((r, o) => {
    ...
    const s = na.includes(r?.source_kind) ? r.source_kind : "manual_2d", i = (Array.isArray(r?.keys) ? r.keys : []).slice(0, 1e4).map((l) => lo(l, t)).sort((l, d) => l.time_seconds - d.time_seconds);
    return {
      id: n,
  ...
  }).filter((r) => r.keys.length), e.motion_tool = oa.includes(e.motion_tool) ? e.motion_tool : "select", e.selected_motion_layer_id = e.motion_layers.some((r) => r.id === e.selected_motion_layer_id) ? e.selected_motion_layer_id : e.motion_layers[0]?.id || null, e;
}
const mo = 32, po = 64, fo = 128, uo = Object.freeze(["off", "selected", "all"]), ho = Object.freeze(["annotation", "name", "tag"]), jt = Object.freeze({ mode: "selected", content: "annotation" }), go = Object.freeze(["top", "center", "bottom"]), yo = /^[a-z0-9][a-z0-9_-]*$/, bo = /^#(?:[0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/, _o = /[<>]|:\/\/|javascript:|expression\(|&#/i;
function at(e) {
  ...
  for (const r of e) {
    ...
    if (!(!o || o.length > po || !yo.test(o) || a.has(o)) && (a.add(o), t.push(o), t.length >= mo))
      break;
  }
  return t;
}
...
function At(e) {
  ...
  if (!t || t.length > fo || _o.test(t)) return null;
  const a = typeof e.color == "string" ? e.color.trim() : "", r = bo.test(a) ? a.toLowerCase() : "#8d7ee8", o = go.includes(e.anchor) ? e.anchor : "top";
  return { text: t, visible: e.visible !== !1, color: r, anchor: o };
}
function Zs(e) {
  return {
    mode: uo.includes(e?.mode) ? e.mode : jt.mode,
    content: ho.includes(e?.content) ? e.content : jt.content
  };
}
function vo(e) {
...
function Qs(e, t) {
  ...
  if (t === "tag") return vo(e);
  const a = e.annotation;
  return a && a.visible !== !1 ? String(a.text || "") : "";
}
function Js(e, { mode: t, selectedIds: a } = {}) {
...
const Et = Object.freeze([0.05, 8]), wo = 80, ia = (e, t, a) => Math.max(t, Math.min(a, e));
function la(e) {
  if (!e || typeof e != "object") return null;
  const t = String(e.clip_id ?? "").trim();
  if (!t || t.length > wo) return null;
  const a = Math.max(0, Math.round(Number(e.start_frame) || 0)), r = Math.round(Number(e.end_frame) || 0), o = r > a ? r : 0, n = Number(e.speed), s = ia(Number.isFinite(n) && n > 0 ? n : 1, Et[0], Et[1]), i = Number(e.offset_seconds);
  return {
    clip_id: t,
    start_frame: a,
    end_frame: o,
...
function ti(e, t, a, r) {
  const o = la(e), n = Number(r) || 0, s = Math.max(1, Number(a) || 24);
  if (!o || n <= 0) return 0;
  const i = (m) => o.loop ? (m % n + n) % n : ia(m, 0, n);
...
const ai = "omnicam_humanoid_v1", pt = Object.freeze([
  "root",
  "pelvis",
  "spine",
  "chest",
  ...
  "foot_r",
  "toe_r"
]), Mo = Object.freeze(["eye_l", "eye_r", "hand_tip_l", "hand_tip_r"]);
Object.freeze([...pt, ...Mo]);
new Map(pt.map((e, t) => [e, t]));
const xo = /^mixamorig[:_ ]?/i, Co = /[\s_\-.:|]+/g, ko = {
...
function Do(e) {
  return String(e || "").trim().replace(xo, "").replace(Co, "").toLowerCase();
}
function To(e) {
  const t = [e];
...
function ri(e) {
  const a = (e || []).map(String).filter((n) => n.trim()).map((n) => [n, To(Do(n))]), r = /* @__PURE__ */ new Set(), o = {};
  for (const n of [!0, !1])
    for (const [s, i] of Object.entries(ko))
      if (!o[s])
        for (const l of i) {
          const d = jo(l, a, r, n);
          if (d != null) {
...
function Ao(e) {
  ...
  return pt.filter((a) => !t.has(a));
}
function Eo(e) {
  return Ao(e).length === 0;
}
function oi(e) {
  const t = e?.bone_map || e?.rig?.bone_map || null;
  return !t || !Object.keys(t).length ? "none" : Eo(t) ? "rigged" : "incomplete";
}
const Oo = 128, Ot = "omnicam_humanoid_v1", ft = /^[a-z0-9][a-z0-9_-]*$/, Io = 1e-3, Po = (e) => Array.isArray(e) && e.length === 3 && e.every((t) => Number.isFinite(Number(t)));
function ut(e) {
  ...
  return a <= 1e-8 || Math.abs(a - 1) > Io && !(a > 0.5 && a < 2) ? null : t.map((r) => r / a);
}
function ca(e, t = 1e-4) {
  const a = ut(e);
...
function zo(e) {
  ...
  for (const [r, o] of Object.entries(e)) {
    ...
    if (!ft.test(n) || n.length > 64) continue;
    const s = ut(o);
    !s || ca(s) || (t[n] = s, a += 1);
  }
  return t;
...
function Ne(e) {
  ...
  return {
    preset_id: ft.test(a) && a.length <= 80 ? a : "neutral",
    root_offset: Po(t.root_offset) ? t.root_offset.map(Number) : [0, 0, 0],
    joints: zo(t.joints)
  };
}
...
function si(e, t, a) {
  ...
  if (!ft.test(o)) return r;
  const n = ut(a);
  return !n || ca(n) ? delete r.joints[o] : r.joints[o] = n, r;
}
function No(e) {
  return !e || typeof e != "object" ? null : {
    rig_profile: e.rig_profile === Ot ? Ot : null,
    pose: Ne(e.pose),
    motion: la(e.motion)
  };
}
...
function ii(e) {
  return Lo({ apiURL: da }, e);
}
let da = (e) => e;
const Xe = /* @__PURE__ */ new WeakMap();
function li({ api: e }) {
  da = (t) => e.apiURL ? e.apiURL(t) : t;
}
function Fo(e, t, a) {
...
function le(e, t, a = null) {
  ...
  const o = Fo(e, r, t), n = N(r, t, "pos_x", (g) => (g.camera || g).position[0], !1, o), s = N(r, t, "pos_y", (g) => (g.camera || g).position[1], !1, o), i = N(r, t, "pos_z", (g) => (g.camera || g).position[2], !1, o);
  ...
  if (u && Array.isArray(h)) {
    const g = h.find((x) => x.id === u);
    if (g && g.enabled !== !1) {
      const x = gt(h, g, t), A = m?.offset || e.target_offset || e.camera?.target_offset || [0, 0, 0];
      l = (x.position?.[0] ?? 0) + (A[0] || 0), d = (x.position?.[1] ?? 1.5) + (A[1] || 0), c = (x.position?.[2] ?? 0) + (A[2] || 0);
    }
  }
  const f = N(r, t, "fov", (g) => Number((g.camera || g).fov ?? 35), !1, o), _ = N(r, t, "roll", (g) => Number((g.camera || g).roll ?? 0), !0, o), y = N(r, t, "zoom", (g) => Number((g.camera || g).zoom ?? 1), !1, o), v = N(r, t, "near", (g) => Number((g.camera || g).near ?? 0.01), !1, o), b = N(r, t, "far", (g) => Number((g.camera || g).far ?? 1e4), !1, o), M = r[0]?.camera || r[0] || se();
  let w = r[0];
  for (const g of r)
    if ((g.frame ?? 0) <= t) w = g;
    else break;
...
const It = [
  ...
  "ease_expo",
  "ease_back"
], Vo = ["auto", "clamped", "vector", "free", "aligned", "flat"];
function Go(e, t) {
  const a = e?.tangents;
  return !a || typeof a != "object" ? {} : a.channels && typeof a.channels == "object" && a.channels[t] ? a.channels[t] : a;
}
function Pt(e, t, a, r, o) {
  const n = Go(e, t), s = Vo.includes(n.mode) ? n.mode : e?.tangents?.mode || "auto", i = o ? o(e) : 0, l = a && o ? o(a) : i, d = r && o ? o(r) : i, c = Math.max(1e-6, e.frame - (a?.frame ?? e.frame - 1)), m = Math.max(1e-6, (r?.frame ?? e.frame + 1) - e.frame), p = (v = !1) => {
    const b = (i - l) / c, M = (d - i) / m;
    let w = 0;
    if (!a && !r)
      w = 0;
    else if (!a)
...
function N(e, t, a, r, o = !1, n = null) {
  ...
  const s = n || ht(e, t), { leftIndex: i, left: l, right: d } = s, c = i > 0 ? e[i - 1] : null, m = i + 2 < e.length ? e[i + 2] : null, p = Math.max(1, d.frame - l.frame), u = T((t - l.frame) / p, 0, 1);
  let h = r(l), f = r(d);
  if (o) {
  ...
  if (l.interpolation === "bezier" || d.interpolation === "bezier") {
    const v = Pt(l, a, c, d, r), b = Pt(d, a, l, m, r), M = h, w = h + (v.out_y || 0), D = f + (b.in_y || 0), g = f, x = T(Number(v.out_x ?? 1 / 3), 0, 1), A = T(1 + Number(b.in_x ?? -1 / 3), 0, 1);
    let G = 0, ee = 1;
    for (let Dt = 0; Dt < 32; Dt++) {
      const $ = (G + ee) * 0.5, Ue = 1 - $;
      3 * Ue * Ue * $ * x + 3 * Ue * $ * $ * A + $ * $ * $ < u ? G = $ : ee = $;
    }
    const Q = (G + ee) * 0.5, te = 1 - Q;
    return te * te * te * M + 3 * te * te * Q * w + 3 * te * Q * Q * D + Q * Q * Q * g;
  }
  const y = Ko(u, l.interpolation);
  return h + (f - h) * y;
}
const qo = 0.01, Ho = 1e4;
function se() {
  return {
    position: [6, 4, 6],
    target: [0, 1.5, 0],
...
function He(e, t) {
  ...
  const r = ce(e), o = (y, v) => (y.transform?.position || r.position)[v] ?? 0, n = (y, v) => (y.transform?.rotation || r.rotation)[v] ?? 0, s = (y, v) => (y.transform?.size || r.size)[v] ?? (v === 2 ? 0.01 : 1), i = ht(a, t), l = N(a, t, "pos_x", (y) => o(y, 0), !1, i), d = N(a, t, "pos_y", (y) => o(y, 1), !1, i), c = N(a, t, "pos_z", (y) => o(y, 2), !1, i), m = N(a, t, "rot_x", (y) => n(y, 0), !0, i), p = N(a, t, "rot_y", (y) => n(y, 1), !0, i), u = N(a, t, "rot_z", (y) => n(y, 2), !0, i), h = N(a, t, "scale_x", (y) => s(y, 0), !1, i), f = N(a, t, "scale_y", (y) => s(y, 1), !1, i), _ = N(a, t, "scale_z", (y) => s(y, 2), !1, i);
  return {
...
function mi(e = "balanced", t = "all_views", a = null) {
  const r = {
    none: 0,
    0: 0,
    sparse: 300,
  ...
  for (let p = 0; p < o; p++) {
    ...
    let _ = 0, y = 0, v = 0, b = 0.65, M = 0.72, w = 0.82;
    if (t === "ground_focus")
      if (u < 0.6) {
        const D = 0.4 + Math.sqrt(h) * 24, g = f * Math.PI * 2 + p * 2.399963229728653;
        _ = Math.cos(g) * D, v = Math.sin(g) * D, y = 0.01 + u * 0.75, b = 0.86, M = 0.9, w = 0.98;
      } else {
        const D = 1 + Math.sqrt(h) * 18, g = f * Math.PI * 2 + p * 2.399963229728653;
        _ = Math.cos(g) * D, v = Math.sin(g) * D, y = 0.75 + (u - 0.6) * 8.5, b = 0.62, M = 0.7, w = 0.82;
      }
    else if (t === "dome") {
      const D = u * Math.PI * 2, g = 1 - 2 * h, x = Math.sqrt(Math.max(0, 1 - g * g)), A = 1.5 + Math.cbrt(f) * 20;
      _ = Math.cos(D) * x * A, v = Math.sin(D) * x * A, y = Math.max(0.01, g * A * 0.75 + 2.5), b = 0.72, M = 0.78, w = 0.88;
    } else {
      const D = p % 4;
      if (D === 0) {
        const g = 0.3 + Math.sqrt(h) * 28, x = p * 2.399963229728653;
        _ = Math.cos(x) * g, v = Math.sin(x) * g, y = 0.01 + f * 0.34, b = 0.9, M = 0.94, w = 1;
      } else if (D === 1) {
        const g = 0.6 + Math.sqrt(h) * 18, x = p * 2.399963229728653;
        _ = Math.cos(x) * g, v = Math.sin(x) * g, y = 0.35 + f * 3.15, b = 0.68, M = 0.76, w = 0.86;
      } else if (D === 2) {
        const g = 2 + Math.sqrt(h) * 24, x = p * 2.399963229728653;
        _ = Math.cos(x) * g, v = Math.sin(x) * g, y = 3.5 + f * 11.5, b = 0.55, M = 0.65, w = 0.78;
      } else {
        const g = 0.5 + h * 6.5, x = p * 2.399963229728653;
        _ = Math.cos(x) * g, v = Math.sin(x) * g, y = 0.05 + f * 4.95, b = 0.8, M = 0.86, w = 0.94;
      }
    }
    n.push(_, y, v), s.push(a ? b * i : b, a ? M * l : M, a ? w * d : w);
  }
...
function pi(e) {
  ...
  const r = (c, m) => (Array.isArray(c) ? c : []).slice(0, ke.maxKeysPerTrack).map((p) => ({
    ...
    interpolation: It.includes(p.interpolation) ? p.interpolation : "ease",
  ...
  }), a.active_camera_id = a.cameras.some((c) => c.id === a.active_camera_id) ? a.active_camera_id : a.cameras[0].id, a.sequence = ro(a.sequence, a.cameras.map((c) => c.id)), a.playblast_camera_id = a.playblast_camera_id === to && a.sequence.cuts.length || a.cameras.some((c) => c.id === a.playblast_camera_id) ? a.playblast_camera_id : a.active_camera_id;
  ...
  a.camera = l.camera, a.keyframes = l.keyframes, a.target_object_id = l.target_object_id || null, a.target_offset = l.target_offset || [0, 0, 0], a.aim_bone = l.aim_bone || null, a.objects = (Array.isArray(a.objects) ? a.objects : t.objects).slice(0, ke.maxObjects).map((c) => ({
    ...
    ...At(c?.annotation) ? { annotation: At(c.annotation) } : {},
    ...
    ...c?.character ? { character: No(c.character) } : {},
    keyframes: (Array.isArray(c.keyframes) ? c.keyframes : []).map((m) => ({
      ...
      interpolation: It.includes(m.interpolation) ? m.interpolation : "ease",
  ...
  const d = Re();
  return a.editor_views = Object.fromEntries(Object.entries(d).map(([c, m]) => [c, K(a.editor_views?.[c] || m)])), co(a);
}
function xe(e, t) {
...
function fa(e, t) {
  const a = t.quaternion || Le(t.rotation), r = $o(a, e.quaternion || Le(e.rotation));
  return { position: C(pa(e.position.map((o, n) => o * t.size[n]), a), t.position), rotation: Uo(r), quaternion: r, size: e.size.map((o, n) => o * t.size[n]) };
}
function Xo(e, t) {
  const a = new Map(e.map((o) => [o.id, o])), r = (o, n = /* @__PURE__ */ new Set()) => {
    ...
    if (!i) return s;
    const l = new Set(n);
    return l.add(o.id), fa(s, r(i, l));
  };
  return r(t);
}
function gt(e, t, a, r = /* @__PURE__ */ new Set()) {
  const o = He(t, a);
...
const zt = ["speed", "angular_speed", "acceleration", "jerk"], Ye = ["ok", "warn", "over"], ua = 0.8, Yo = [0, 1.5, 0];
function Nt(e, t) {
  const a = [0];
...
function Rt(e, t) {
  return t == null || t <= 0 ? "ok" : e > t ? "over" : e > t * ua ? "warn" : "ok";
}
function Lt(e) {
...
function an(e, t) {
  ...
  for (let r = 0; r < e.length; r++) {
    ...
    if (n && n.grade === e[r] && tn(n.metrics, o)) {
      n.end = r;
      continue;
    }
...
function ha(e, t = {}, a = null, r = "generic") {
  ...
  const d = Zo(l, o), c = Qo(l, o), m = Nt(d, o), p = Nt(m, o), u = { speed: d, angular_speed: c, acceleration: m, jerk: p }, h = Jo(e, a), f = en(l, h, s, i), _ = l.map((g) => g.fov), y = t.allow_framing_loss === !0, v = [], b = [];
  for (let g = 0; g < n; g++) {
    const x = [], A = [];
    for (const G of zt) {
      const ee = Rt(u[G][g], t[`max_${G}`]);
      x.push(ee), ee !== "ok" && A.push(G);
    }
    !f[g] && !y && (x.push("over"), A.push("framing_loss")), v.push(Lt(x)), b.push(A);
  }
  const M = f.filter((g) => !g).length, w = {
    profile: r,
    warn_ratio: ua,
    limits: t,
    subject: h,
  ...
  for (const g of [...zt, "fov_drift"]) {
    const x = g === "fov_drift" ? "max_fov_change" : `max_${g}`, A = t[x];
    A != null && w[x] > Number(A) && w.violations.push({ metric: x, value: w[x], recommended_max: Number(A) });
  }
  M && !y && w.violations.push({ metric: "framing_loss_frames", value: M, recommended_max: 0 });
  const D = Rt(w.max_fov_change, t.max_fov_change);
  return w.track_grades = { fov_drift: D }, w.grade = Lt([...v, D]), w.trajectory_valid = w.violations.length === 0, w.ok = w.trajectory_valid, w;
}
function rn(e) {
...
function hi(e, t) {
  ...
  e.selectedKeyFrames = null, e.timelineDrag = { box: a, pointerId: t.pointerId }, e.setFrame(ga(e, t, a));
}
function gi(e, t) {
  ...
  !e.timelineDrag || t.pointerId !== e.timelineDrag.pointerId || (t.preventDefault(), t.stopPropagation(), e.setFrame(ga(e, t, e.timelineDrag.box), !1, !1));
}
function yi(e, t) {
  if (e.timelinePanDrag && t.pointerId === e.timelinePanDrag.pointerId) {
...
function nn(e, t) {
  ...
  if (!a) return;
  if (!a.engaged) {
    if (Math.hypot(t.clientX - (a.startClientX ?? t.clientX), t.clientY - (a.startClientY ?? t.clientY)) < on) return;
    a.engaged = !0;
  }
...
function cn(e, t, a) {
  ...
  for (const n of r)
    ya(n.frame ?? 0, t) && (n.camera.target = [...o]);
  return r;
}
function dn(e, t) {
...
function de(e) {
  const t = un(e), a = hn(e, t);
  return a ? ha(e.state, a, null, t) : null;
}
function Ft(e) {
...
function fe(e, t, a, r) {
  const o = a == null ? S("no limit") : `${Ft(t)} / ${Ft(a)}`, n = a != null && a > 0, s = n ? Math.min(100, Math.round(t / a * 100)) : 0, i = r === "over" ? "#ef4444" : r === "warn" ? "#f59e0b" : "#22c55e";
  return `
...
function yn(e) {
  ...
  return t.length ? t.slice(0, 6).map((a) => {
    const r = a.metrics.map((n) => We(n)).join(", "), o = a.start === a.end ? S("Frame {frame}").replace("{frame}", String(a.start)) : S("Frames {start}-{end}").replace("{start}", String(a.start)).replace("{end}", String(a.end));
    return `
...
function bn(e) {
  ...
  if (a.className = `oc-health-badge ${o.grade}`, a.textContent = pn(o.grade), r) {
    const { score: l, letter: d } = gn(o);
  ...
  t.innerHTML = `
    ...
    <div class="oc-health-zones" data-role="health-zones">${yn(o)}</div>
...
function Ce(e, t, a, r) {
  ...
  o && (e.checkpoint(a), o.keyframes = t, e.state.keyframes = t, e.syncActiveCameraTrack(), e.refreshKeys(), e.setFrame(e.frame, !1, !1), e.setStatus(r), bn(e));
}
function vi(e) {
  const t = de(e);
  if (!t) return;
  ...
  const r = Math.max(1, e.state.duration_frames - 1), o = ln(e.state.keyframes, r), n = ha({ ...e.state, keyframes: o }, t.limits, null, t.profile);
  if (n.max_speed <= a) {
...
function Si(e) {
  ...
  const r = ba(e.state.keyframes, a, 0.6);
  Ce(
    e,
    r,
...
function Mi(e, t, a) {
  if (!de(e)) return;
  const o = ba(e.state.keyframes, [{ start: t, end: a }], 0.6);
  Ce(
    e,
    o,
    "Smooth zone",
...
const _n = {
  ...
  ..._n,
  ...vn
}, Z = ["OmniCam"], _a = "MajoorOmniCam.Locale", va = "MajoorOmniCam.Defaults.Fps", Sa = "MajoorOmniCam.Defaults.DurationSeconds", wa = "MajoorOmniCam.Defaults.Width", Ma = "MajoorOmniCam.Defaults.Height", xa = "MajoorOmniCam.Defaults.RenderMode", Ca = "MajoorOmniCam.Defaults.Encoder", ka = "MajoorOmniCam.Defaults.PlayblastResolution", Da = "MajoorOmniCam.Playblast.Quality", Ta = "MajoorOmniCam.Defaults.PlayblastGrid", ja = "MajoorOmniCam.Defaults.PlayblastLabels", Aa = "MajoorOmniCam.Proxy.PointDensity", Ea = "MajoorOmniCam.Proxy.PointSpread", Oa = "MajoorOmniCam.Proxy.PointColor", Ia = "MajoorOmniCam.Proxy.CardFit", Pa = "MajoorOmniCam.Viewport.Quality", za = "MajoorOmniCam.Viewport.Adaptive", Na = "MajoorOmniCam.Viewport.BackgroundColor", Ra = "MajoorOmniCam.Display.Grid", La = "MajoorOmniCam.Display.Radar", Fa = "MajoorOmniCam.Display.CameraPaths", Ba = "MajoorOmniCam.Display.CameraGizmos", Ka = "MajoorOmniCam.Display.LookAt", Va = "MajoorOmniCam.Display.HelperAxes", Ga = "MajoorOmniCam.Display.Gizmo", qa = "MajoorOmniCam.Display.Guides", Ha = "MajoorOmniCam.Display.SafeAreas", Wa = "MajoorOmniCam.Display.ResolutionGate", $a = "MajoorOmniCam.Display.AspectRatio", Ua = "MajoorOmniCam.Display.BurnIn", Xa = "MajoorOmniCam.Display.SpeedHeatmap", Ya = "MajoorOmniCam.Display.Wireframe", Za = "MajoorOmniCam.Display.Vertices", Qa = "MajoorOmniCam.Tools.SelectMode", Ja = "MajoorOmniCam.Tools.GizmoMode", er = "MajoorOmniCam.Tools.GizmoSpace", tr = "MajoorOmniCam.Tools.SpatialSnapMode", ar = "MajoorOmniCam.Tools.SpatialGridSize", rr = "MajoorOmniCam.Navigation.Profile", or = "MajoorOmniCam.Navigation.FlySpeed", nr = "MajoorOmniCam.Navigation.InvertOrbitY", sr = "MajoorOmniCam.Navigation.ZoomSensitivity", ir = "MajoorOmniCam.Navigation.OrbitSensitivity", lr = "MajoorOmniCam.Navigation.PanSensitivity", cr = "MajoorOmniCam.Navigation.DollySensitivity", dr = "MajoorOmniCam.Navigation.ViewMode", mr = "MajoorOmniCam.Controls.EnableShortcuts", pr = "MajoorOmniCam.Timeline.SnapEnabled", fr = "MajoorOmniCam.Timeline.SnapFrames", ur = "MajoorOmniCam.Timeline.AutoKey", hr = "MajoorOmniCam.Timeline.DefaultInterpolation", gr = "MajoorOmniCam.Timeline.TimecodeMode", yr = "MajoorOmniCam.Timeline.LoopPlayback", br = "MajoorOmniCam.Interface.Density", _r = "MajoorOmniCam.Interface.PreviewLayout", vr = "MajoorOmniCam.Interface.CameraPreviews", Sr = "MajoorOmniCam.History.Limit", wr = "MajoorOmniCam.Extractor.DefaultBackend", Mr = "MajoorOmniCam.Monitor.DefaultProfile", xr = "MajoorOmniCam.Agent.Enabled", yt = "MajoorOmniCam.Agent.Provider", Bt = "MajoorOmniCam.Agent.Model", Kt = "MajoorOmniCam.Agent.BaseUrl", Cr = "MajoorOmniCam.Agent.MaxOutputTokens", kr = "MajoorOmniCam.Agent.MaxPlannerSteps", Dr = "MajoorOmniCam.Agent.RequestTimeoutSeconds", Be = [
...
function Tr(e) {
  return Be.find((t) => t.id === e) || Be[0];
}
function bt(e) {
  return `MajoorOmniCam.Agent.${Tr(e).settingKey}.Model`;
}
function _t(e) {
  return `MajoorOmniCam.Agent.${Tr(e).settingKey}.BaseUrl`;
}
...
const jr = wn({
  onLocaleChange: () => Ar(),
  onQualityChange: (e) => qt(e),
  onAdaptiveChange: () => qt(),
  onAgentEnabledChange: () => Tn()
});
let vt = null;
function R(e, t) {
  try {
    const a = vt?.extensionManager?.setting?.get(e);
    return a ?? t;
  } catch {
    return t;
  }
...
function ye(e, t) {
  try {
    vt?.extensionManager?.setting?.set?.(e, t);
  } catch (a) {
...
function Ar() {
  const e = String(R(_a, "auto")), t = String(R("Comfy.Locale", "en") || "en").slice(0, 2).toLowerCase(), a = e === "auto" ? t : e, r = a !== eo();
  if (Jr(a), !!r) {
    for (const o of W)
      if (!o.disposed)
        try {
...
function qt(e = Er()) {
  for (const t of W)
    t.disposed || (Or(t), t.requestRender ? t.requestRender("quality") : t.render?.(), t.renderCameraView?.());
}
function Di() {
  return jn().enabled;
}
...
function jn() {
  const e = z(yt, "ollama", ["openai", "openai_compatible", "anthropic", "ollama"]);
  return {
    enabled: I(xr, !0),
    provider: e,
    ...
    model: String(R(bt(e), "") || "").trim(),
    baseUrl: String(R(_t(e), "") || "").trim(),
    maxOutputTokens: F(Cr, 4096, 512, 32768, !0),
    maxPlannerSteps: F(kr, 6, 1, 12, !0),
    requestTimeoutSeconds: F(Dr, 120, 15, 300, !0)
  };
}
function An() {
  return {
    fps: F(va, 24, 1, 120, !0),
    durationSeconds: F(Sa, 5, 1, 120, !0),
    width: F(wa, 1280, 64, 4096, !0),
    height: F(Ma, 720, 64, 4096, !0),
    renderMode: String(R(xa, "omni_ref")),
    encoder: String(R(Ca, "auto")),
    playblastResolution: z(ka, "output", ["viewport", "half", "output", "double"]),
    playblastQuality: z(Da, "balanced", ["low", "balanced", "high"]),
    playblastGrid: I(Ta, !1),
    playblastLabels: I(ja, !1),
    pointDensity: z(Aa, "balanced", ["none", "sparse", "balanced", "dense", "ultra"]),
    pointSpread: z(Ea, "all_views", ["all_views", "ground_focus", "dome"]),
    pointColor: Gt(Oa, "#cbd5e1"),
    cardFit: z(Ia, "contain", ["contain", "cover", "stretch"]),
    backgroundColor: Gt(Na, "#121212"),
    showGrid: I(Ra, !0),
    showRadar: I(La, !0),
    showCameraPaths: I(Fa, !0),
    showCameraGizmos: I(Ba, !0),
    showLookAt: I(Ka, !0),
    showHelperAxes: I(Va, !0),
    showGizmo: I(Ga, !0),
    guides: I(qa, !0),
    safeAreas: I(Ha, !1),
    resolutionGate: I(Wa, !1),
    aspectRatio: z($a, "auto", ["auto", "16:9", "4:3", "1:1", "9:16", "2.39:1"]),
    burnIn: I(Ua, !1),
    speedHeatmap: I(Xa, !1),
    showWireframe: I(Ya, !1),
    showVertices: I(Za, !1),
    selectMode: z(Qa, "object", ["object", "vertex", "edge", "face"]),
    gizmoMode: z(Ja, "translate", ["translate", "rotate", "scale"]),
    gizmoSpace: z(er, "world", ["world", "local"]),
    spatialSnapMode: z(tr, "none", ["none", "grid", "vertex"]),
    spatialGridSize: F(ar, 0.5, 0.01, 100),
    navigationProfile: z(rr, "simple", ["maya", "blender", "simple"]),
    flySpeed: F(or, 1, 0.05, 5),
    invertOrbitY: I(nr, !1),
    zoomSensitivity: F(sr, 1, 0.2, 3),
    orbitSensitivity: F(ir, 1, 0.2, 3),
    panSensitivity: F(lr, 1, 0.2, 3),
    dollySensitivity: F(cr, 1, 0.2, 3),
    viewMode: z(dr, "perspective", ["camera", "perspective", "front", "back", "top", "bottom", "right", "left"]),
    snapEnabled: I(pr, !0),
    snapFrames: F(fr, 1, 1, 24, !0),
    autoKey: I(ur, !1),
    defaultInterpolation: z(hr, "ease", ["ease", "smooth", "bezier", "linear", "ease_in", "ease_out", "hold"]),
    timecodeMode: z(gr, "time", ["time", "timecode"]),
    loopPlayback: I(yr, !1),
    uiDensity: z(br, "animation", ["basic", "animation", "advanced"]),
    previewLayout: z(_r, "auto", ["auto", "1", "2", "4"]),
    cameraViewVisible: I(vr, !0),
    undoLimit: F(Sr, 100, 10, 500, !0),
    extractorBackend: z(wr, "dpvo", ["dpvo", "pycolmap"]),
    monitorProfile: z(Mr, "wan_camera_native", ["wan_camera_native", "minimax_h3", "ltx_motion", "generic_video"])
  };
}
function En() {
  const e = String(R(Bt, "") || "").trim(), t = String(R(Kt, "") || "").trim();
  if (!e && !t) return;
  const a = z(
    yt,
    "ollama",
  ...
  e && !String(R(r, "") || "").trim() && ye(r, e), t && !String(R(o, "") || "").trim() && ye(o, t), ye(Bt, ""), ye(Kt, "");
}
function On(e) {
  vt = e, Qr("fr", Sn), Ar(), En();
}
...
function Ht(e, t, a, r, o) {
  const { right: n, up: s, forward: i } = V(t), l = t.position, d = [a[0] - l[0], a[1] - l[1], a[2] - l[2]], c = zn(d, i);
  let m, p;
  if (t.camera_type === "orthographic") {
...
function Ir(e, t, { includeCtrlFallback: a, includeSimpleLeft: r = a }) {
...
function Rn(e, t, a) {
  const r = St(e), o = Ir(r, t, { includeCtrlFallback: !0 });
  return o === be && a?.camera_type === "orthographic" ? _e : o;
}
function Wt(e, t) {
  return e.isNavigatingFly ? !0 : Ir(St(e), t, { includeCtrlFallback: !1 }) !== null;
}
const Ln = ["maya", "blender", "simple"];
function St(e) {
  const t = e.state?.navigation_profile;
  return Ln.includes(t) ? t : "maya";
}
function Fn(e, t) {
...
function $t(e, { mode: t, origin: a, delta: r, factors: o, rotationDeg: n }) {
...
function Bn(e, t) {
  return (Array.isArray(e) ? e : []).map((r) => {
    const o = { ...r.camera };
    return Array.isArray(o.position) && (o.position = $t(o.position, t)), Array.isArray(o.target) && (o.target = $t(o.target, t)), { ...r, camera: o };
  });
}
function Kn(e, t) {
...
function Vn(e, { baseDrag: t, viewCamera: a, entityPosition: r }) {
  const o = e.activeCameraTrack?.();
  return !o || o.locked || !(o.keyframes?.length >= 1) ? !1 : (e.checkpoint("Transform camera path"), e.gizmoDrag = {
    ...
    trackId: o.id,
    origin: Pr(o.keyframes),
    baseKeys: o.keyframes.map((n) => ({ ...n, camera: K(n.camera) })),
    viewRight: V(a).right,
    viewUp: V(a).up,
    freeScale: a.camera_type === "orthographic" ? Ke(a, e.canvas.height) : H(E(a.position, r)) * (2 * Math.tan((a.fov || 35) * Math.PI / 360)) / e.canvas.height
  }, !0);
}
function Gn(e, { pointer: t, deltaPixels: a, precision: r, snapping: o }) {
  ...
  s.keyframes = Bn(n.baseKeys, l), s.id === e.state.active_camera_id && (e.state.keyframes = s.keyframes), e.camera = le(s, e.frame, e.state.objects), s.camera = K(e.camera), e.refreshKeys(), e.refreshInspector(), e.render(), e.renderCameraView?.();
}
function Ut(e, t) {
  const a = [];
...
function qn(e, t) {
  ...
  if (a) return Ut(a.min, a.max);
  const r = gt(e.state.objects, t, e.frame || 0), o = (t.type === "model" || t.type === "glb") && e.webgl?.getObjectWorldCenter?.(t.id) || r.position, n = r.size.map((i) => Math.max(0.01, Math.abs(i)) / 2), s = r.quaternion || Le(r.rotation);
  return Ut(n.map((i) => -i), n).map((i) => C(o, pa(i, s)));
}
function Hn(e, t, a, r = {}) {
  const o = e.state.objects.filter((b) => b.enabled !== !1), n = r.all ? o : o.filter((b) => e.selectedObjectIds?.has(b.id)), i = (n.length ? n : [a]).flatMap((b) => qn(e, b)), l = [0, 1, 2].map((b) => Math.min(...i.map((M) => M[b]))), d = [0, 1, 2].map((b) => Math.max(...i.map((M) => M[b]))), c = l.map((b, M) => (b + d[M]) / 2), { right: m, up: p, forward: u } = V(t), h = Math.max(1, e.canvas?.width || e.state.width || 1280) / Math.max(1, e.canvas?.height || e.state.height || 720), f = Math.tan((t.fov || 35) * Math.PI / 360), _ = f * h;
  let y = 2, v = 0.1;
  for (const b of i) {
    const M = E(b, c), w = Math.abs(U(M, m)), D = Math.abs(U(M, p)), g = U(M, u);
...
function Ii(e, t = {}) {
  ...
  e.checkpoint(t.all ? "Frame all" : "Frame subject"), Hn(e, a, s, t), r ? (e.serialize(), e.render()) : (e.beginCameraEdit(), e.commitCameraEdit(), e.finishCameraEdit()), e.setStatus(t.all ? S("Framed: all objects") : S("Framed: {name}").replace("{name}", s.name || s.type || S("Subject")));
}
function $n(e, t, a, { forceLocal: r = !1 } = {}) {
...
const Xn = /* @__PURE__ */ new Set(["object", "camera", "camera_target"]);
function zr(e) {
  const t = Un(e);
  if (!t || e.transformControlsWiring && Xn.has(t.type)) return null;
  ...
  const n = Math.max(0.7, H(E(a.position, r)) * 0.12), s = e.state.gizmo_mode === "scale" || e.state.gizmo_mode === "rotate", i = t.type === "object" ? $n(e, t.object, t, { forceLocal: s }) : [[1, 0, 0], [0, 1, 0], [0, 0, 1]];
...
function Nr(e, t) {
  ...
  for (const i of a.handles)
    for (let l = 0; l < i.points.length - 1; l++) {
      const d = i.points[l], c = i.points[l + 1], m = ma(t, d, c);
...
function Yn(e, t) {
    ...
    if (e.state.show_camera_paths !== !1)
      for (const s of e.state.cameras) {
        ...
        for (let d = 0; d < l.length - 1; d += 1)
          if (ma(t, l[d], l[d + 1]) <= 8 * Math.min(2, window.devicePixelRatio || 1))
  ...
  for (const s of e.state.objects) {
    ...
    const i = s.keyframes?.length ? He(s, e.frame) : s, l = B(i.position || [0, 0, 0], r, e.canvas.width, e.canvas.height);
    if (!l) continue;
...
function Pi(e) {
  ...
  for (const o of t.handles) {
    ...
    if (e.ctx.lineWidth = n ? 6.5 : 3.8, e.ctx.strokeStyle = n ? "#ffffff" : a[o.index] || "#ffffff", e.ctx.fillStyle = a[o.index] || "#ffffff", e.ctx.beginPath(), o.points.forEach((s, i) => {
      ...
      e.state.gizmo_mode === "scale" && t.entity?.type === "object" ? (e.ctx.fillRect(i[0] - 6, i[1] - 6, 12, 12), e.ctx.save(), e.ctx.strokeStyle = "rgba(15, 23, 42, 0.65)", e.ctx.lineWidth = 1, e.ctx.strokeRect(i[0] - 6, i[1] - 6, 12, 12), e.ctx.restore()) : Zn(e.ctx, s[0], i);
    }
  }
...
const nt = { x: [1, 0, 0], y: [0, 1, 0], z: [0, 0, 1] }, Ve = (e, t) => Math.round(e / t) * t;
function Rr(e) {
...
function es(e, t, a, r, o, n, s) {
  const i = o ? "grid" : e.state.spatial_snap_mode;
  if (i === "grid") {
    const l = e.state.spatial_grid_size || 0.5;
    return n ? a.map((d, c) => d.map((m, p) => Math.abs(n[p]) > 1e-6 ? Ve(m, l) : s[c][p])) : a.map((d) => d.map((c) => Ve(c, l)));
  }
  if (i === "vertex" && r && !n) {
...
function Oe(e, t) {
  ...
  const n = o[0] - a.start[0], s = o[1] - a.start[1], i = t.shiftKey ? 0.1 : 1, l = Jn(a), d = a.axis ? nt[a.axis] : null, c = e.state.view_mode === "camera" ? e.camera : e.state.editor_views[e.state.view_mode], m = V(c), p = c.camera_type === "orthographic" ? 10 / (Math.max(0.01, c.zoom || 1) * Math.max(1, e.canvas.height)) : Math.hypot(...E(c.position, c.target)) * 25e-4;
  let u = a.snapshots.map((b) => [...b.transform.position]);
  if (a.mode === "translate") {
    const b = l ?? (n - s) * p * i, M = d ? k(d, b) : C(k(m.right, n * p * i), k(m.up, -s * p * i));
    u = u.map((w) => C(w, M)), u = es(e, a, u, o, t.ctrlKey || t.metaKey, d, a.snapshots.map((w) => w.transform.position));
  }
  const h = a.mode === "rotate" ? l ?? (n - s) * 0.5 * i : 0, f = a.mode === "scale" ? Math.max(0.01, l ?? 1 + (n - s) * 0.01 * i) : 1, _ = d || nt.z, y = t.ctrlKey || t.metaKey || e.state.spatial_snap_mode === "grid";
  a.snapshots.forEach((b, M) => {
    const w = b.object;
    if (a.mode === "translate" && (w.position = u[M]), a.mode === "rotate") {
      const D = y ? Ve(h, 15) : h, g = k(_, D);
      w.position = C(a.pivot, xe(E(b.transform.position, a.pivot), g)), w.rotation = C(b.transform.rotation, g);
    }
    if (a.mode === "scale") {
      const D = y ? Ve(f, 0.1) : f, g = d ? d.map((A) => A ? D : 1) : [D, D, D], x = E(b.transform.position, a.pivot);
      w.position = C(a.pivot, x.map((A, G) => A * g[G])), w.size = b.transform.size.map((A, G) => Math.max(0.01, A * g[G]));
    }
...
function ts(e, t) {
  ...
  return r === "escape" ? Fr(e) : r === "enter" || r === " " ? Lr(e) : nt[r] ? (a.axis = a.axis === r ? null : r, Oe(e, a.lastEvent), !0) : /^[0-9]$/.test(r) || r === "." || r === "," || r === "-" && !a.numeric ? (a.numeric += r === "," ? "." : r, Oe(e, a.lastEvent), !0) : (r === "backspace" && (a.numeric = a.numeric.slice(0, -1), Oe(e, a.lastEvent)), !0);
}
function ue(e, t, a) {
...
const re = (e, t) => Math.round(e / t) * t, rs = (e, t) => e.map((a) => re(a, t));
function os(e, t, a) {
...
function he(e, t, a, r = [], o = null) {
  ...
  if (s === "grid")
    return o ? t.map((l, d) => Math.abs(o.axis[d]) > 1e-6 ? re(l, i) : o.base[d]) : rs(t, i);
  if (s === "vertex" && a && !o) {
...
function zi(e, t) {
  if (e.modalTransform) {
    t.preventDefault?.(), t.stopPropagation?.(), t.button === 0 ? Lr(e) : t.button === 2 && Fr(e);
    return;
  }
  if (t.target?.closest?.("button,input,select")) return;
  if (t.button === 2 && !Wt(e, t)) {
  ...
  const a = e.interactionElement.getBoundingClientRect(), r = (t.clientX - a.left) * e.canvas.width / Math.max(1, a.width), o = (t.clientY - a.top) * e.canvas.height / Math.max(1, a.height), n = X(e), s = e.state.view_mode !== "camera", i = Wt(e, t), l = t.button === 0 && !i, d = l && !t.altKey && !t.shiftKey;
  if (d && e.transformControlsWiring?.isPointerOverHandle?.()) return;
  if (d && e.webgl?.pickCurveHandle) {
    const _ = e.webgl.pickCurveHandle([r, o]);
    if (_) {
      const y = (e.state.cameras || []).find((M) => M.id === _.cameraId), v = (y?.keyframes || []).findIndex((M) => M.frame === _.frame), b = v >= 0 ? y.keyframes[v] : null;
      if (b) {
        e.curveHandleDrag = {
          cameraId: _.cameraId,
          frame: _.frame,
  ...
  if (c) {
    ...
    if (c.entity.type === "camera_path" && Vn(e, { baseDrag: b, viewCamera: n, entityPosition: c.entity.position })) return;
    if (c.entity.type === "object") {
      const M = c.entity.object;
      e.checkpoint("Transform object");
      const w = Rr(e), D = (w.length ? w : [M]).map((x) => ({ object: x, transform: ce(x) }));
      for (const x of D) e.beginObjectEdit(x.object);
      const g = D.reduce((x, A) => C(x, A.transform.position), [0, 0, 0]).map((x) => x / D.length);
      e.gizmoDrag = {
        ...b,
        type: "object",
        historyCheckpointed: !0,
        ...
        viewRight: V(n).right,
        viewUp: V(n).up,
        freeScale: n.camera_type === "orthographic" ? Ke(n, e.canvas.height) : H(E(n.position, c.entity.position)) * (2 * Math.tan((n.fov || 35) * Math.PI / 360)) / e.canvas.height
      };
      return;
    }
  }
  const m = l ? Yn(e, [r, o]) : null;
  if (e.pointerHit = !!(c || m), m) {
    ...
    if (m.type === "camera_target") {
      ...
      e.checkpoint("Move camera target"), e.beginCameraEdit();
      const { right: _, up: y } = V(n), v = [...e.camera.target], b = e.activeCameraTrack?.(), M = !!b?.target_object_id;
      e.targetFreeDrag = {
        pointer: [r, o],
        target: M ? [...b.target_offset || [0, 0, 0]] : v,
        tracking: M,
        right: _,
        up: y,
  ...
  if (!m && l && !t.ctrlKey && !t.metaKey && St(e) !== "simple") {
    e.boxSelection = {
      start: [r, o],
      current: [r, o],
      additive: t.shiftKey,
  ...
  const p = !!e.isNavigatingFly, u = Rn(e, t, n);
  if (!p && !u) return;
...
function Ni(e, t) {
  ...
  if (e.pathDrag) {
    ...
    c && (c.camera.position = Ht(
      [i, l],
      X(e),
      e.pathDrag.anchor,
      e.canvas.width,
      e.canvas.height
    ), c.interpolation = Nn(c.interpolation), e.webgl && (e.webgl.pathKey = ""), e.setFrame(e.frame, !1, !1), e.render());
    return;
  }
  ...
  if (e.targetFreeDrag) {
    ...
    e.targetFreeDrag.tracking ? Xt(e, u) : e.camera.target = u, e.commitCameraEdit(), e.refreshInspector(), e.render();
    return;
  }
  if (e.gizmoDrag) {
    ...
    if (e.gizmoDrag.type === "camera_target") {
      ...
      e.gizmoDrag.tracking ? Xt(e, h) : e.camera.target = h, e.commitCameraEdit(), e.refreshInspector(), e.render();
      return;
    }
    if (e.gizmoDrag.type === "camera") {
      if (e.state.gizmo_mode === "translate") {
        ...
        const u = c ? re(d * 0.015, Math.PI / 12) : d * 0.015, h = E(e.gizmoDrag.target, e.gizmoDrag.position), f = xe(h, k(e.gizmoDrag.axis, u * (180 / Math.PI)));
        e.camera.target = C(e.gizmoDrag.position, f);
      }
      e.commitCameraEdit(), e.refreshInspector(), e.render();
      return;
    }
    if (e.gizmoDrag.type === "camera_path") return void Gn(e, { pointer: i, deltaPixels: d, precision: l, snapping: c });
    if (e.state.gizmo_mode === "translate")
      if (e.gizmoDrag.free) {
    ...
    if (m.length > 1 && p)
      if (e.state.gizmo_mode === "translate") {
        ...
        for (const h of m)
          h.object.position = C(e.gizmoDrag.groupPivot, xe(E(h.transform.position, e.gizmoDrag.groupPivot), u)), h.object.rotation = C(h.transform.rotation, u);
      } else {
  ...
  if (!e.drag) {
    const s = e.interactionElement.getBoundingClientRect(), i = Nr(e, [
      (t.clientX - s.left) * e.canvas.width / Math.max(1, s.width),
      (t.clientY - s.top) * e.canvas.height / Math.max(1, s.height)
  ...
  if (e.drag.dolly) {
    ...
    const { right: s, up: i } = V(n), l = Ke(n, e.interactionElement.getBoundingClientRect().height) * (e.panSensitivity ?? 1), d = C(k(s, -a * l), k(i, r * l));
...
function Ri(e, t) {
  if (t?.type === "pointercancel" || t?.type === "lostpointercapture") {
    t.pointerId === e.activePointerId && Br(e);
    return;
  }
  if (e.pathDrag) {
...
function Li(e, t) {
  ...
  const a = Fn(t, e.interactionElement.getBoundingClientRect().height);
  if (!a) return;
...
function Ge(e, { sourceKind: t = "manual_2d", label: a, keys: r, source: o = {} }) {
  if (!na.includes(t)) throw new Error(`Unsupported motion source: ${t}`);
...
function wt(e, t) {
  return e.motion_tool = oa.includes(t) ? t : "select", e.motion_tool;
}
function ss(e, t) {
  if (sa.includes(t))
...
function cs(e, t, a, r, o) {
  ...
  if (t?.object_id) {
    ...
    if (!c) return null;
    const m = Xo(e.objects, c), p = Array.isArray(t.local_point) ? t.local_point : [0, 0, 0];
...
function ps(e, t) {
  const a = Vr(e.motion_layers, t);
  return a ? (Kr(e, a.id), a) : null;
}
const et = (e) => {
...
function Fi(e, t) {
  for (const o of e.root.querySelectorAll("[data-motion-tool]"))
    o.addEventListener("click", () => {
      e.motionCreationKind = "", wt(e.state, o.dataset.motionTool), qe(e), e.render();
    }, { signal: t });
  ...
  e.root.querySelector('[data-role="motion-interpolation"]')?.addEventListener("change", (o) => {
    const n = Qe(e.state);
    n && (e.checkpoint("Set motion interpolation"), ss(n, o.target.value), ae(e, `Motion interpolation: ${o.target.value}`));
  ...
  for (const o of e.root.querySelectorAll("[data-motion-layer-action]"))
    o.addEventListener("click", () => {
      ...
      if (e.checkpoint(s === "delete" ? "Delete motion layer" : s === "retime" ? "Retime motion layer" : "Toggle motion layer"), s === "delete") Kr(e.state, n.id);
      else if (s === "retime") {
        const [i, l] = Yt(e);
        is(n, i, l);
  ...
  a.addEventListener("pointerdown", (o) => {
    ...
    e.checkpoint(n === "erase" ? "Erase motion track" : "Add motion anchor"), n === "anchor" ? Ge(e.state, { sourceKind: "static_anchor", label: `Anchor ${(e.state.motion_layers || []).length + 1}`, keys: [{ time_seconds: e.frame / e.state.fps, ...s, interpolation: "hold" }] }) : n === "project" ? fs(e, s) : n === "erase" && ps(e.state, s), ae(e, `Motion tool: ${n}`);
  ...
  const r = (o) => {
    ...
    const [s, i] = Yt(e), l = ms(e.state, n.points, s, i);
  ...
  a.addEventListener("pointerup", r, { capture: !0, signal: t }), a.addEventListener("pointercancel", r, { capture: !0, signal: t }), a.addEventListener("click", (o) => {
    ...
    const n = Vr(e.state.motion_layers, Je(e, o));
...
function hs(e, t) {
  ...
  if (a) {
    ...
    e.checkpoint?.(`Motion: ${a.label}`), wt(e.state, a.tool), e.motionCreatingLabel = a.label, e.motionCreationKind = t, qe(e), e.render(), e.setStatus(a.hint);
  }
}
function Gr(e) {
  return (e.state.motion_tool || "select") === "select" && !e.motionTrackDraft ? !1 : (wt(e.state, "select"), e.motionTrackDraft = null, e.motionCreatingLabel = "", e.motionCreationKind = "", qe(e), e.render(), e.setStatus("Motion creation cancelled."), !0);
}
function Bi(e, t) {
  for (const a of e.root.querySelectorAll("[data-motion-create]"))
    a.addEventListener("click", () => hs(e, a.dataset.motionCreate), { signal: t });
  e.root.querySelector("[data-motion-create-cancel]")?.addEventListener("click", () => Gr(e), { signal: t });
}
...
const ge = { t: "translate", r: "rotate", s: "scale" }, _s = [
...
], vs = 'button,summary,a[href],[role="button"],[role="menuitem"],[role="tab"],[role="option"],[role="checkbox"],[role="switch"]';
function Ss(e) {
  return e instanceof HTMLElement || e instanceof SVGElement ? !!e.closest?.(vs) : !1;
}
function ws(e) {
...
function xs(e, t) {
  return Ms(e) || t?.lastKeyZone || "viewport";
}
let Qt = !1;
function Cs() {
  Qt || typeof window > "u" || (Qt = !0, window.addEventListener("keydown", (e) => {
    if (!xn()) return;
    const t = e.composedPath?.()[0] || e.target, a = Cn(t);
    !a || a.disposed || ks(a, e) && (e.preventDefault(), e.stopImmediatePropagation?.(), e.stopPropagation());
  }, { capture: !0 }));
}
function ks(e, t) {
  if (!Dn()) return !1;
  const a = t.composedPath?.()[0] || t.target;
  if (ws(a) || (t.code === "Space" || t.key === "Enter") && Ss(a)) return !1;
...
function js(e, t) {
  ...
  if (r === "Numpad9") {
    const i = bs(e.state.view_mode);
    return i ? e.setViewMode(i) : Zt(e, Math.PI, 0), !0;
  }
  const n = Math.PI / 12, s = { Numpad4: [n, 0], Numpad6: [-n, 0], Numpad8: [0, n], Numpad2: [0, -n] };
  if (s[r])
    return Zt(e, s[r][0], s[r][1]), !0;
  if (r === "Numpad5")
...
function Es(e, t) {
  ...
  if (a === "s" || a === "a")
    return t.repeat || (!ze(e.state).length || a === "a" ? (e.checkpoint("Auto-split shots"), e.state.sequence = { ...e.state.sequence || { recording_path: "" }, enabled: !0, cuts: oo(e.state) }, tt(e)) : (e.checkpoint("Split shot"), so(e.state, e.frame, null) ? tt(e) : e.setStatus("Move the playhead inside a shot first"))), !0;
  if (t.key === "Delete" || t.key === "Backspace") {
    if (t.repeat) return !0;
    const r = ze(e.state), o = ra(e.state, e.frame), n = o ? r.findIndex((s) => s.start === o.start) : -1;
    return n >= 0 && (e.checkpoint("Remove shot"), io(e.state, n) && tt(e)), !0;
  }
  return !1;
}
function Mt(e, t) {
...
const st = "MajoorOmniCamDirector", it = "MajoorOmniCamExtractor", lt = "MajoorOmniCamMonitor";
function $e(e) {
  return String(e?.comfyClass || e?.type || e?.constructor?.comfyClass || e?.constructor?.type || "");
}
const qr = {
  [st]: { default: [1313, 1633], min: [760, 760] },
  [it]: { default: [761, 1458], min: [700, 760] },
  [lt]: { default: [798, 1634], min: [640, 680] }
}, Os = 0.92, Is = 0.88;
function Ps([e, t], [a, r]) {
  if (typeof window > "u") return [e, t];
  const o = Math.round((window.innerWidth || e) * Os), n = Math.round((window.innerHeight || t) * Is);
  return [
...
function zs(e, t) {
  const a = qr[t];
  return !a || !e?.setSize ? !1 : (e.setSize(Ps(a.default, a.min)), !0);
}
function Ns(e, t, a) {
  const r = qr[t];
...
const Jt = "oc-help-css", Ae = "#8b7bd8", Hr = /* @__PURE__ */ new Map();
function xt(e, t) {
  e && t && Hr.set(e, t);
}
function ct(e) {
  return e && Hr.get(e) || null;
}
const Rs = `
...
function Ls() {
  ...
  e.id = Jt, e.textContent = Rs, document.head.appendChild(e);
}
function oe(e) {
...
function ea(e) {
  ...
  const m = document.activeElement instanceof HTMLElement ? document.activeElement : null, p = () => {
    document.removeEventListener("keydown", h, !0), t.remove(), Me === p && (Me = null), m && m.isConnected && typeof m.focus == "function" && m.focus({ preventScroll: !0 });
  };
  Me = p;
  const u = () => Array.from(
...
const ta = "MajoorOmniCam.ShowHelp", dt = "oc-help-toolbar-icon", aa = "oc-help-toolbar-css", Ks = "#8b7bd8";
function Vs() {
  if (document.getElementById(aa)) return;
  const e = document.createElement("style");
  e.id = aa, e.textContent = `
    .${dt}{display:inline-flex;align-items:center;justify-content:center;
      width:16px;height:16px;border-radius:50%;background:${Ks};color:#fff;
...
J.registerExtension({
  ...
  getNodeMenuItems(e) {
    const t = ct(e?.comfyClass);
    return t ? [null, { content: "? Help", callback: () => ea(t) }] : [];
  },
  setup() {
    Vs();
  }
...
J.registerExtension({
  ...
  async nodeCreated(e) {
    ...
    const t = !ie, a = t ? null : kt(e);
    await Mt(e, async () => {
      Ee("director:import:start", e);
      const { attachDirector: o } = await import("./chunk-PMGjr8DA.js").then((n) => n.g);
      return Ee("director:import:resolved", e), o;
    });
    const r = e.__majoorOmniCam;
    r && (Ee("director:attach:complete", e), In(r), t && Pn(r), Ct(e, st, t, a?.()));
  }
});
J.registerExtension({
  ...
  async nodeCreated(e) {
    if ($e(e) !== it) return;
    const t = !ie, a = t ? null : kt(e);
    await Mt(e, async () => (await import("./chunk-Dak2tJoH.js")).attachExtractor), e.__majoorOmniCamExtractor && Ct(e, it, t, a?.());
  }
});
J.registerExtension({
  ...
  async nodeCreated(e) {
    if ($e(e) !== lt) return;
    const t = !ie, a = t ? null : kt(e);
    await Mt(e, async () => (await import("./chunk-Sf13t6Lb.js")).attachMonitor), e.__majoorOmniCamMonitor && Ct(e, lt, t, a?.());
  }
});
export {
  ye as $,
