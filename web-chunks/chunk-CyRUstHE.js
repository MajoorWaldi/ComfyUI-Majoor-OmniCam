import { c as w, bv as g, e as k, aY as A, bw as oe, y as $, s as M, bx as re, b2 as O, a as v, g as H, aZ as W, by as ne } from "./chunk-CxXyW-I9.js";
import { m as se, g as K, l as ie } from "./chunk-BOI_2OKd.js";
function De(e, t) {
...
function B({ title: e, message: t, withInput: a = !1, defaultValue: o = "", owner: r = null }) {
  return typeof document > "u" || !document.body ? Promise.resolve(a ? null : !1) : new Promise((s) => {
    ...
    let p = !1;
    const b = (u) => {
      p || (p = !0, document.removeEventListener("keydown", x, !0), r && typeof r == "object" && _.get(r)?.delete(h), l.remove(), s(u));
    }, h = () => b(a ? null : !1);
...
function He({ title: e, items: t = [], onDelete: a = null, owner: o = null }) {
  return typeof document > "u" || !document.body ? Promise.resolve(null) : new Promise((r) => {
    ...
    let c = !1;
    const m = (h) => {
      c || (c = !0, document.removeEventListener("keydown", b, !0), o && typeof o == "object" && _.get(o)?.delete(f), s.remove(), r(h));
    }, f = () => m(null), y = (h) => {
      ...
      const C = document.createElement("div");
      if (C.textContent = h.sublabel || "", Object.assign(C.style, { opacity: "0.6", fontSize: "11px" }), u.append(j, C), u.addEventListener("click", () => m(h.id)), x.appendChild(u), a) {
        ...
        E.type = "button", E.title = "Delete", E.textContent = "✕", Object.assign(E.style, {
          ...
          ae.stopPropagation(), x.remove(), i.children.length || m(null);
          try {
            a(h.id);
          } catch {
          }
...
async function ce(e, t, a, o) {
  ...
  return c?.prompt ? c.prompt({ title: l, message: d, defaultValue: i }) : B({ title: l, message: d, withInput: !0, defaultValue: i, owner: s });
}
async function le(e, t, a) {
  ...
  return d?.confirm ? d.confirm({ title: s, message: l }) : B({ title: s, message: l, withInput: !1, owner: r });
}
const Ke = `
...
`, V = 24, J = 5, G = 150, Y = Math.PI / 180;
function X(e, t, a) {
  return Math.min(a, Math.max(t, e));
}
function de(e, t = V) {
  const a = X(Number(e) || 0, J, G);
  return t / (2 * Math.tan(a * Y / 2));
}
function me(e, t = V) {
  const a = Math.max(1e-6, Number(e) || 0), o = 2 * Math.atan(t / (2 * a)) / Y;
  return X(o, J, G);
}
function pe(e) {
  const t = de(e);
...
const Ve = [14, 18, 24, 35, 50, 85, 135], Je = {
...
function Ye(e, t) {
  Q(e);
  for (const [a, o] of Object.entries(he)) {
...
function ue(e) {
  ...
  if (e.state.playblast_camera_id === A) {
    const t = oe(e.state, e.frame), a = t && e.state.cameras.find((o) => o.id === t.camera_id);
    if (a) return a;
  }
...
function Xe(e) {
  ...
  e.directorRevision = (Number.isInteger(e.directorRevision) ? Math.max(0, e.directorRevision) : 0) + 1, e.renderRevision = (e.renderRevision || 0) + 1, ge(e);
  const t = e.state.playblast_camera_id === A && re(e.state), a = ue(e);
  ...
  o.metadata = { ...o.metadata, motion_scene_fingerprint_live: se(e.state) }, e.stateWidget && (e.stateWidget.value = JSON.stringify(o)), e.widthWidget && (e.widthWidget.value = e.state.width), e.heightWidget && (e.heightWidget.value = e.state.height), e.fpsWidget && (e.fpsWidget.value = e.state.fps), e.durationWidget && (e.durationWidget.value = e.state.duration_frames / e.state.fps), e.modeWidget && (e.modeWidget.value = e.state.render_mode), e.cardWidget && (e.cardWidget.value = e.state.card_asset || ""), e.node.graph?.setDirtyCanvas?.(!0, !0);
}
function Qe(e) {
...
function Ze(e, t = !0) {
  ...
  e.root.dataset.density = e.state.ui_density || "animation", Q(e);
...
function Ue(e) {
  ...
  e.timelineKeyframes().some((r) => r.frame === e.selectedKeyFrame) || (e.selectedKeyFrame = e.timelineKeyframes()[0]?.frame ?? null), e.camera = M(e.state, Math.min(e.frame, e.state.duration_frames - 1)), e.syncFromWidgets(!1), e.root.querySelector('[data-role="gizmo-space"]').value = e.state.gizmo_space, e.restoreAssets(), e.refreshKeys(), e.refreshObjects(), e.render(), e.history?.clear(), e.sceneBaseline = e.stateWidget?.value ?? e.sceneBaseline, e.sceneName = e.state.metadata?.scene_name || "";
}
const be = { "16:9": 16 / 9, "4:3": 4 / 3, "1:1": 1, "9:16": 9 / 16, "2.39:1": 2.39 };
function ve(e) {
  if (!e) return null;
  const t = be[e.aspect_ratio];
  if (t) return t;
...
function we(e, t, { label: a = "Extracted Camera" } = {}) {
  const o = Array.isArray(t?.keyframes) ? t.keyframes : [];
  if (!o.length) throw new Error(v("no camera keys in this solve"));
  const r = Number(e.state.fps) || 24, s = Number(t.fps) || r, l = s > 0 ? r / s : 1, d = T(e.state), i = e.state.cameras.length, c = xe(e.state, a || "Extracted Camera"), m = S[i % S.length], f = o.map((y) => ({
    ...y,
...
function Z(e) {
  ...
  const l = ke(e), d = l.map((c) => `${c.id}:${c.name}:${c.muted ? 1 : 0}:${c.solo ? 1 : 0}:${c.color || ""}`).join("|");
  let i = !1;
  d !== e.cameraPreviewSignature && (i = !0, e.cameraPreviewSignature = d, t.innerHTML = "", e.cameraPreviewCanvases.clear(), e.cameraPreviewContexts.clear(), l.forEach((c, m) => {
    ...
    j.className = "camera-view-badge", j.textContent = v("CAMERA PREVIEW"), n.append(p, b, h, x), f.append(u, n, j), t.appendChild(f), f.addEventListener("click", () => {
      ...
      C.button === 1 && (C.preventDefault(), _e(e, c.id));
...
function tt(e) {
  ...
  const t = T(e.state), a = e.state.cameras.length, o = `Camera ${a + 1}`, r = k(e.camera), s = [
...
async function at(e, t) {
  ...
  if (!a) return;
  const o = (await ce(e.app, v("Rename camera"), v("Camera name"), a.name))?.trim();
...
async function rt(e, t) {
  ...
  const a = e.state.cameras.find((r) => r.id === t);
  if (!a || !await le(e.app, v("Delete camera"), v(`Delete ${a.name} and its ${a.keyframes.length} keyframe(s)?`))) return;
  ...
  if (e.state.cameras = e.state.cameras.filter((r) => r.id !== t), t === e.state.playblast_camera_id && (e.state.playblast_camera_id = e.state.cameras[0].id), e.cameraPreviewSignature = "", o) {
    ...
    e.state.active_camera_id = r.id, e.state.keyframes = r.keyframes, e.state.camera = k(r.camera), e.camera = M(r, e.frame, e.state.objects), e.selectedEntity = "camera", e.selectedObjectId = null, e.selectedObjectIds = /* @__PURE__ */ new Set(), e.selectedKeyFrame = r.keyframes.find((s) => s.frame === e.frame)?.frame ?? null, e.selectedKeyFrames = e.selectedKeyFrame != null ? /* @__PURE__ */ new Set([e.selectedKeyFrame]) : /* @__PURE__ */ new Set(), e.editingKeyFrame = null;
  }
  e.pathSelection = O(e.pathSelection, e.activeCameraTrack()), e.serialize(), e.refreshCameraSelectors(), e.refreshObjects(), e.refreshKeys(), e.refreshInspector(), e.render(), e.setStatus(v(`${a.name} deleted`));
}
function nt(e, t) {
  const a = e.state.cameras.find((o) => o.id === t);
  a && (e.finishCameraEdit(), e.syncActiveCameraTrack(), e.state.active_camera_id = a.id, e.state.keyframes = a.keyframes, e.state.camera = k(a.camera), e.camera = M(a, e.frame, e.state.objects), e.selectedEntity = "camera", e.selectedObjectId = null, e.selectedObjectIds = /* @__PURE__ */ new Set(), e.selectedKeyFrame = a.keyframes.find((o) => o.frame === e.frame)?.frame ?? null, e.selectedKeyFrames = e.selectedKeyFrame != null ? /* @__PURE__ */ new Set([e.selectedKeyFrame]) : /* @__PURE__ */ new Set(), e.pathSelection = O(e.pathSelection, a), e.editingKeyFrame = null, e.serialize(), e.refreshCameraSelectors(), e.refreshObjects(), e.refreshKeys(), e.refreshInspector(), e.render(), e.setStatus(v(`Camera: ${a.name}`)));
}
function st(e, t) {
  const a = H(e.state), o = t === A && a.length > 0, r = o ? null : e.state.cameras.find((s) => s.id === t);
...
function _e(e, t) {
  e.state.maximized_camera_id = e.state.maximized_camera_id === t ? null : t, e.serialize(), Z(e), requestAnimationFrame(() => {
    e.resizeCanvas(), e.renderCameraView();
...
const Se = "omnicam_extractor_result_v2", L = "omnicam_extracted_motion_scene_json", z = "omnicam_extracted_track_fingerprint", U = "omnicam_extractor_source";
function ee(e) {
...
function ht(e, t) {
  Ce(e);
  const a = q(e, L), o = q(e, z), r = String(o?.value || "") !== t.fingerprint;
...
function Ee(e) {
  const t = String(q(e, z)?.value || ""), a = String(q(e, L)?.value || "");
  if (!t || !a) return null;
  let o;
  try {
    o = JSON.parse(a);
...
function Le(e, t, a = {}) {
  ...
  const r = a.mode || (Me(e) ? "replace" : "merge"), s = a.reconMode || qe(t);
  if (r === "replace") {
    ...
    for (const l of e.state.objects || [])
      F(l, s), (l.type === "glb" || l.type === "model") && l.asset && e.modelUrlsById?.set(l.id, W(l.asset));
  } else {
    ...
    for (const m of c)
      m.parent_id && i.has(m.parent_id) && (m.parent_id = i.get(m.parent_id)), F(m, s), e.state.objects.push(m), (m.type === "glb" || m.type === "model") && m.asset && e.modelUrlsById?.set(m.id, W(m.asset));
    for (const m of te(o)) {
      const f = D(d, m.id);
...
function Re(e) {
  ...
  for (const o of t.inputs || []) {
    if (String(o?.name || "").toLowerCase() !== ze || o.link == null) continue;
    const r = ie(a, o.link);
    if (r && Te(r) === ne) return r;
  }
  return null;
}
function Pe(e) {
  return String(e?.state?.metadata?.[R]?.fingerprint || "");
}
function We(e, t, a) {
  e.state.metadata = {
    ...e.state.metadata,
...
function vt(e) {
  const t = Re(e), a = t ? Ee(t) : null;
  let o = !1;
  return a ? a.fingerprint !== Pe(e) && e.pendingExtractorImport?.fingerprint !== a.fingerprint && (e.pendingExtractorImport = {
    track: a.track,
    fingerprint: a.fingerprint,
    originNodeId: t.id,
    label: String(t.title || v("OmniCam Extractor")),
    keyCount: a.track.keyframes?.length || 0
  }, We(e, a.fingerprint, t), o = !0) : e.pendingExtractorImport && (e.pendingExtractorImport = null, o = !0), P(e), o;
}
function yt(e) {
  const t = e.pendingExtractorImport;
  return t ? (e.checkpoint("Import extracted camera"), we(e, t.track, { label: t.label }), e.pendingExtractorImport = null, P(e), e.setStatus?.(v("Imported {count} camera keys from {name}").replace("{count}", String(t.keyCount)).replace("{name}", t.label)), e.scheduleSerialize(), e.render(), !0) : !1;
}
function xt(e) {
  return e.pendingExtractorImport ? (e.pendingExtractorImport = null, P(e), e.render(), e.setStatus?.(v("Extracted camera preview dismissed")), !0) : !1;
}
function wt(e) {
  const t = e?.graph;
  if (!t) return 0;
  ...
  for (const s of a)
    for (const l of s?.links || []) {
      const d = K(t, l), i = d?.target_id ?? d?.targetId;
...
function kt(e, t) {
  ...
  for (const l of o)
    for (const d of l?.links || []) {
      const i = K(a, d), c = i?.target_id ?? i?.targetId;
