...
import { a as xe, y as Z, z as pe, u as r, A as Rr, B as Ao, C as Ie, c as le, E as oo, F as os, G as To, H as qr, J as rs, K as ns, L as ss, M as is, N as ko, v as Zo, O as Br, P as wo, Q as Wr, R as Vr, S as Hr, T as Ur, i as Gr, U as So, V as lo, W as Jo, X as Qo, Y as Xr, k as er, Z as cs, _ as ls, $ as ds, a0 as ms, a1 as ps, g as ye, p as Yr, h as Zr, a2 as tr, e as Ee, a3 as fs, a4 as Jr, t as hs, a5 as bs, a6 as Po, a7 as us, a8 as gs, o as ys, a9 as vs, aa as xs, ab as ks, ac as Io, ad as ws, ae as Ss, af as js, ag as Cs, ah as _s, ai as Es, aj as $s, ak as Ms, al as As, am as Ts, an as Ps, ao as Is, ap as zs, aq as Fs, ar as Ls, as as Os, at as Ks, au as Ds, av as Ns, aw as Rs, ax as qs, ay as Bs, az as Ws, aA as Vs, aB as Hs, aC as Us, aD as Gs, aE as Xs, aF as Ys, aG as Zs, aH as Js, aI as Qs, aJ as ei, aK as ti, aL as ai, aM as oi, aN as ri, aO as ni, aP as si, aQ as ii, aR as ci, aS as li, aT as di, l as Be, aU as mi, aV as mo, aW as pi, aX as fi, aY as hi, aZ as bi, a_ as ui, a$ as Pe, b0 as gi, b1 as Qr, b2 as zo, b3 as yi, b4 as vi, b5 as xi, b6 as en, b7 as Ke, b8 as ki, b9 as wi, ba as ar, bb as Fo, bc as Si, bd as tn, be as ji, bf as Ci, bg as _i, b as an, r as Ei, bh as $i, bi as Mi, bj as Ai, bk as Ti, x as Pi, bl as Ii, bm as zi, bn as Fi, bo as on, bp as Li, bq as Oi, br as Ki, bs as Di, bt as Ni, bu as Ri, bv as qi, bw as Bi, bx as Wi, by as Vi, bz as Hi, bA as Ui, bB as Gi, bC as Xi, bD as Yi, bE as Zi, bF as Ji, bG as Qi, bH as ec, s as tc } from "./chunk-KSpmkRWt.js";
import { L as ac, a as oc, p as wt, f as Lo, b as rc, S as nc, c as or, d as sc, e as ic, r as cc, g as lc, n as dc, C as rr, h as St, o as rn, s as mc, i as pc, j as fc, k as nn, l as hc, m as bc, q as uc, t as gc, u as yc, v as vc, w as xc, x as kc, y as wc, z as Sc, A as jc, B as Cc } from "./chunk-DwSnp0oD.js";
import { S as _c, b as Ec, p as $c } from "./chunk-DiX7WiXt.js";
import { n as Mc, p as Ac, a as Tc, s as po, S as sn, c as Pc, C as nr, b as Ic, i as zc, w as Fc, d as Lc, U as je, m as Oc, h as Ge, e as Kc, f as Dc, g as Nc, j as Rc, r as qc, k as Bc, l as Wc } from "./chunk-1DX5-9zk.js";
import { T as Vc } from "./chunk-__IQ4xkd.js";
import { T as Hc, R as Uc } from "./vendor-three-BQUrLQkn.js";
import { b as Gc, p as cn, a as jo, c as Co, d as Xc, r as Yc, s as Zc, e as Jc } from "./chunk-CvXZlhDp.js";
import { a as Qc } from "./chunk-CTXwjaoT.js";
import { l as el, u as tl } from "./chunk-eq1tqQ9i.js";
function ut(e, t = 0) {
  return Math.sin(e * 1.7 + t * 3.1) * 0.5 + Math.sin(e * 3.3 + t * 5.7) * 0.3 + Math.sin(e * 7.9 + t * 11.3) * 0.2;
}
function al(e, { type: t = "handheld_subtle", intensity: a = 1, duration_frames: o = null, subdivide: n = !0 } = {}) {
  const s = Array.isArray(e) ? e : e?.keyframes || [];
  if (!s || s.length === 0) return s;
  const i = t === "turbulence", c = t === "handheld_heavy", l = (i ? 0.12 : c ? 0.18 : 0.06) * a, m = (i ? 2 : c ? 2.8 : 0.9) * a, p = i ? 0.45 : c ? 0.22 : 0.12, f = s[s.length - 1]?.frame ?? 119, d = Math.max(f + 1, Number(o || (e?.duration_frames ?? f + 1))), h = i ? 4 : c ? 6 : 8, b = Array.isArray(e) ? { keyframes: s, duration_frames: d } : e, u = new Set(s.map((g) => g.frame));
  if (n && d > h) {
    for (let g = 0; g < d; g += h)
      u.add(g);
    u.add(d - 1);
  ...
  return [...u].sort((g, v) => g - v).map((g) => {
    const v = xe(b, g), j = ut(g * p, 1) * l, x = ut(g * p, 2) * l, A = ut(g * p, 3) * l * 0.5, P = ut(g * p, 4) * m, D = ut(g * p, 5) * (m * 0.35), F = [...v.position], U = [...v.target];
    return F[0] += j, F[1] += x, F[2] += A, U[0] += j * 0.35, U[1] += x * 0.35, {
      frame: g,
      camera: {
        ...v,
        position: F,
        target: U,
        roll: (v.roll || 0) + P,
        fov: Z((v.fov || 35) + D, 10, 140)
      },
      interpolation: "smooth"
    };
  });
}
function ol(e, { duration_frames: t = 120, target: a = [0, 1.5, 0], radius: o = 6, height: n = 3.5 } = {}) {
  const s = [], i = Math.max(2, t), [c, l, m] = a;
  if (e === "orbit_360") {
    const p = Math.max(17, Math.min(65, Math.ceil(i / 4) + 1));
    for (let f = 0; f < p; f++) {
      const d = Math.round(f / (p - 1) * (i - 1)), h = f / (p - 1) * Math.PI * 2, b = f === p - 1 ? [c, l + n, m + o] : [c + Math.sin(h) * o, l + n, m + Math.cos(h) * o];
      s.push({
        frame: d,
        camera: {
          position: b,
    ...
    {
      frame: 0,
      camera: { position: [c, l + n, m + o * 1.6], target: [c, l, m], fov: 42, roll: 0, camera_type: "perspective", zoom: 1, near: 0.01, far: 1e4 },
      interpolation: "ease"
    },
    {
      frame: i - 1,
      camera: { position: [c, l + n * 0.5, m + o * 0.6], target: [c, l, m], fov: 32, roll: 0, camera_type: "perspective", zoom: 1, near: 0.01, far: 1e4 },
      interpolation: "ease"
    }
  ) : e === "pull_out" ? s.push(
    {
      frame: 0,
      camera: { position: [c, l + n * 0.4, m + o * 0.6], target: [c, l, m], fov: 30, roll: 0, camera_type: "perspective", zoom: 1, near: 0.01, far: 1e4 },
      interpolation: "ease"
    },
    {
      frame: i - 1,
      camera: { position: [c, l + n * 1.2, m + o * 1.8], target: [c, l, m], fov: 45, roll: 0, camera_type: "perspective", zoom: 1, near: 0.01, far: 1e4 },
      interpolation: "ease"
    }
  ) : e === "dolly_zoom" && s.push(
    {
      frame: 0,
      camera: { position: [c, l + n * 0.7, m + o * 1.8], target: [c, l, m], fov: 24, roll: 0, camera_type: "perspective", zoom: 1, near: 0.01, far: 1e4 },
      interpolation: "bezier"
    },
    {
      frame: i - 1,
      camera: { position: [c, l + n * 0.5, m + o * 0.6], target: [c, l, m], fov: 65, roll: 0, camera_type: "perspective", zoom: 1, near: 0.01, far: 1e4 },
      interpolation: "bezier"
    }
  );
  return s;
...
const ln = 1e-4;
function rl(e, t) {
  return !Array.isArray(e) || !Array.isArray(t) ? e !== t : e.some((a, o) => Math.abs(Number(a) - Number(t[o])) > ln);
}
function sr(e, t) {
  return Math.abs(Number(e) - Number(t)) > ln;
}
const dn = [
  {
    id: "camera",
  ...
  },
  {
    ...
    label: "Look At",
    color: "#f0a742",
    changed: (e, t) => rl(e?.target, t?.target),
    read: (e) => e?.target
  },
  {
    id: "focal_length",
  ...
  },
  {
    ...
    label: "Roll",
    color: "#ec4899",
    changed: (e, t) => sr(e?.roll, t?.roll),
    read: (e) => e?.roll
  }
];
function nl(e, t) {
  const a = [...e || []].sort((s, i) => s.frame - i.frame), o = [];
  let n = null;
  for (const s of a) {
    const i = s.camera || s.transform || {};
    (n === null || t.changed(n, i)) && o.push(s.frame), n = i;
  }
  return o;
}
...
function mn(e) {
  ...
  a.delete("camera");
  const o = e.timelineKeyframes() || [], n = sl(o, a), s = dl(e, n);
  if (t.dataset.signature !== s) {
    t.dataset.signature = s, t.replaceChildren();
    const i = (c) => pe(e, c);
    for (const c of n) {
      const l = document.createElement("div");
      l.className = "oc-dope-row", l.dataset.channel = c.id, l.style.setProperty("--channel-color", c.color), cl(l, c.frames, i), ll(e, l, c, o, i), t.appendChild(l);
    }
  }
...
const fo = [1, 2, 5, 10, 20, 25, 50, 100, 200, 250, 500, 1e3, 2e3, 5e3], pn = 46, ir = 5, fn = 640;
function hn(e, t) {
  const a = t > 0 ? t : fn, o = Math.max(2, Math.floor(a / pn)), n = Math.max(1e-6, e / o);
  return fo.find((s) => s >= n) ?? fo[fo.length - 1];
}
function ml(e, t) {
  const a = Math.max(1, e.state.duration_frames - 1), o = Z(Number(e.timelineZoom) || 1, 0.1, 50), n = Number(e.timelinePan) || 0, s = a / o, i = hn(s, t), l = (i >= ir ? i / ir : 0) || i, m = [], p = Math.max(0, Math.floor(n / l) * l);
  for (let d = p; d <= a + 1e-6; d += l) {
    const h = Math.round(d), b = pe(e, h);
    if (!(b < -1)) {
      if (b > 101) break;
      m.push({ frame: h, percent: b, major: Math.abs(h % i) < 1e-6 });
    }
  }
  const f = pe(e, a);
  if (f <= 101 && !m.some((d) => d.major && d.frame === a)) {
    const d = pn / Math.max(1, t) * 100;
    for (let h = m.length - 1; h >= 0; h -= 1)
      if (m[h].major) {
        if (f - m[h].percent >= d) break;
        m[h].major = !1;
      }
    m.push({ frame: a, percent: f, major: !0 });
  }
  return m;
}
function pl(e) {
  return e.clientWidth || e.parentElement?.clientWidth || fn;
}
function bn(e) {
  const t = e.root.querySelector('[data-role="ruler"]');
  if (!t) return;
  t.replaceChildren();
  for (const o of ml(e, pl(t))) {
...
function fl(e, t) {
  ...
  a.addEventListener("pointerup", i, { signal: t }), a.addEventListener("pointercancel", i, { signal: t }), a.addEventListener("wheel", (c) => Rr(e, c), { passive: !1, signal: t });
}
const hl = [1, 2, 2.5, 5, 10];
function bl(e, t = 5) {
  const a = Math.abs(e) / Math.max(1, t);
  if (!(a > 0) || !Number.isFinite(a)) return 1;
  const o = 10 ** Math.floor(Math.log10(a)), n = a / o;
  return (hl.find((s) => s >= n) ?? 10) * o;
}
function ul(e, t) {
  const a = Math.max(0, Math.min(4, Math.ceil(-Math.log10(t))));
  return e.toFixed(a);
}
function gl(e, { left: t, right: a, top: o, width: n, graphWidth: s, graphHeight: i, height: c, timeMin: l, timeMax: m, totalDuration: p, xFor: f, frame: d }) {
  const h = hn(m - l, s);
  e.strokeStyle = "#222228", e.lineWidth = 1, e.fillStyle = "#6e727a", e.textAlign = "center";
  for (let u = Math.ceil(l / h) * h; u <= m; u += h) {
    const y = Math.round(u);
    if (y < 0 || y > p) continue;
    const g = f(y);
    g < t || g > n - a || (e.beginPath(), e.moveTo(g, o), e.lineTo(g, o + i), e.stroke(), e.fillText(String(y), g, c - 6));
  }
  const b = f(d);
  b >= t && b <= n - a && (e.fillStyle = "#a78bfa", e.fillText(String(d), b, c - 6)), e.textAlign = "left";
}
function yl(e, { left: t, right: a, top: o, width: n, graphHeight: s, minimum: i, maximum: c, yFor: l }) {
  const m = bl(c - i, 4);
  e.strokeStyle = "#222228", e.lineWidth = 1, e.fillStyle = "#6e727a";
  for (let p = Math.ceil(i / m) * m; p <= c; p += m) {
    const f = l(p);
    f < o - 1 || f > o + s + 1 || (e.beginPath(), e.moveTo(t, f), e.lineTo(n - a, f), e.stroke(), e.fillText(ul(p, m), 4, f + 3));
  }
}
function Oo(e, t) {
...
function vl(e, t) {
  ...
  const { x: o, y: n } = Oo(a, t);
  if (t.button === 1 || t.altKey || t.button === 2 && !e.curveHitPoints?.some((c) => Math.hypot(o - c.x, n - c.y) <= 12)) {
    e.curvePanDrag = {
      startX: t.clientX,
      startY: t.clientY,
  ...
  const s = (e.curveHitPoints || []).map((c) => ({ point: c, distance: Math.hypot(o - c.x, n - c.y) })).sort((c, l) => c.distance - l.distance)[0];
  if (!s || s.distance > 12) {
    if (n < 20) {
      const c = Math.max(1, e.state.duration_frames - 1), l = c / (Number(e.curveZoomX) || 1), m = Number(e.curvePanX) || 0, p = Math.round(Z(m + (o - 44) / Math.max(1, a.clientWidth - 58) * l, 0, c));
  ...
  if (s.point.handle)
    ...
    e.selectedKeyFrames = new Set(e.selectedKeyFrames || [e.selectedKeyFrame].filter((c) => c !== null)), e.selectedKeyFrames.has(s.point.key.frame) ? e.selectedKeyFrames.delete(s.point.key.frame) : e.selectedKeyFrames.add(s.point.key.frame), e.selectedKeyFrame = e.selectedKeyFrames.has(s.point.key.frame) ? s.point.key.frame : [...e.selectedKeyFrames].at(-1) ?? null, e.setFrame(s.point.key.frame), e.updateKeyVisualState(), e.refreshKeyEditor();
    return;
  } else
    e.selectKeyframe(s.point.key), e.setFrame(s.point.key.frame);
  const i = s.point.object ? s.point.key.transform : s.point.key.camera;
  e.curveDrag = {
    ...s.point,
    startY: n,
    startX: o,
    startFrame: s.point.key.frame,
    startValue: s.point.channel.get(i),
    pointerId: t.pointerId,
    historyCheckpointed: !1
  }, !s.point.handle && e.selectedKeyFrames?.size >= 2 && e.selectedKeyFrames.has(s.point.key.frame) && (e.curveDrag.group = e.timelineKeyframes().filter((c) => e.selectedKeyFrames.has(c.frame)).map((c) => {
    const l = s.point.object ? c.transform || s.point.object : c.camera || c;
    return { key: c, backing: l, startFrame: c.frame, startValue: s.point.channel.get(l) };
  })), a.setPointerCapture?.(t.pointerId);
}
function xl(e, t) {
  const a = t.currentTarget, { x: o, y: n } = Oo(a, t);
  if (e.curvePanDrag && t.pointerId === e.curvePanDrag.pointerId) {
    t.preventDefault();
    const f = t.clientX - e.curvePanDrag.startX, d = t.clientY - e.curvePanDrag.startY, b = Math.max(1, e.state.duration_frames - 1) / (Number(e.curveZoomX) || 1), u = Math.max(1, a.clientWidth - 58), y = a.clientHeight || 180, g = Math.max(1, y - 38);
    e.curvePanX = e.curvePanDrag.origPanX - f / u * b, e.curvePanY = e.curvePanDrag.origPanY + d / g * 10 / (Number(e.curveZoom) || 1), e.drawCurveEditor();
    return;
  }
  if (e.curveScrub && t.pointerId === e.curveScrub.pointerId) {
    t.preventDefault();
    const f = Math.max(1, e.state.duration_frames - 1), d = f / (Number(e.curveZoomX) || 1), h = Number(e.curvePanX) || 0, b = Math.round(Z(h + (o - 44) / Math.max(1, a.clientWidth - 58) * d, 0, f));
    e.setFrame(b);
    return;
  }
  if (e.curveBoxSelect && t.pointerId === e.curveBoxSelect.pointerId) {
    ...
    const f = Math.min(e.curveBoxSelect.startX, o), d = Math.max(e.curveBoxSelect.startX, o), h = Math.min(e.curveBoxSelect.startY, n), b = Math.max(e.curveBoxSelect.startY, n), u = (e.curveHitPoints || []).filter((g) => !g.handle && g.x >= f && g.x <= d && g.y >= h && g.y <= b).map((g) => g.key.frame), y = new Set(e.curveBoxSelect.additive ? e.curveBoxSelect.initial : []);
  ...
  if (!e.curveDrag || t.pointerId !== e.curveDrag.pointerId) {
    const f = (e.curveHitPoints || []).map((v) => ({ point: v, distance: Math.hypot(o - v.x, n - v.y) })).sort((v, j) => v.distance - j.distance)[0], d = Math.max(1, e.state.duration_frames - 1), h = d / (Number(e.curveZoomX) || 1), b = Number(e.curvePanX) || 0, u = Math.max(1, a.clientWidth - 58), y = Z(Math.round(b + (o - 44) / u * h), 0, d);
    let g = null;
    if (f && f.distance <= 14) {
      const v = f.point, j = v.object ? v.key.transform || v.object : v.key.camera || v.key;
      g = {
        x: o,
        y: n,
        frame: v.key.frame,
        channelName: v.channel.name,
        value: v.channel.get(j),
        isHandle: !!v.handle,
        handleSide: v.handle
      };
    } else n >= 20 && n <= 165 && o >= 44 && o <= a.clientWidth - 14 && (g = { x: o, y: n, frame: y });
  ...
  if (e.curveHover = null, t.preventDefault(), t.stopPropagation(), e.curveDrag.historyCheckpointed || (e.checkpoint?.(e.curveDrag.handle ? "Edit curve tangent" : "Edit curve"), e.curveDrag.historyCheckpointed = !0), e.curveDrag.handle) {
    const f = e.curveDrag.key, d = e.curveDrag.channel, h = e.curveDrag.handle, b = e.curveDrag.pixelPerSegment, u = e.curveDrag.valuePerPixel, y = e.curveDrag.keyX, g = e.curveDrag.keyY;
    ...
    const v = f.tangents.channels[d.id] || {}, j = v.mode || (f.tangents.mode === "aligned" ? "aligned" : "free"), x = {
    ...
    if (h === "in") {
      if (x.in_x = Z((o - y) / Math.max(1, b), -0.99, -0.01), x.in_y = (g - n) * u, j === "aligned") {
        const A = Math.hypot(x.in_x, x.in_y) || 1e-6, P = Math.hypot(e.curveDrag.startHandles.out_x, e.curveDrag.startHandles.out_y) || 1e-6;
        x.out_x = -x.in_x / A * P, x.out_y = -x.in_y / A * P;
      }
    } else if (x.out_x = Z((o - y) / Math.max(1, b), 0.01, 0.99), x.out_y = (g - n) * u, j === "aligned") {
      const A = Math.hypot(x.out_x, x.out_y) || 1e-6, P = Math.hypot(e.curveDrag.startHandles.in_x, e.curveDrag.startHandles.in_y) || 1e-6;
      x.in_x = -x.out_x / A * P, x.in_y = -x.out_y / A * P;
    }
    f.tangents.channels[d.id] = x, e.scheduleSerialize(), e.camera = xe(e.state, e.frame), e.applyObjectAnimationFrame(), e.render(), e.drawCurveEditor();
    return;
  }
  const s = e.curveDrag.maximum - (n - e.curveDrag.top) * (e.curveDrag.maximum - e.curveDrag.minimum) / Math.max(1, e.curveDrag.graphHeight), i = e.curveDrag.object ? e.curveDrag.key.transform : e.curveDrag.key.camera, c = e.curveDrag.lastFrame / (Number(e.curveZoomX) || 1), l = Number(e.curvePanX) || 0, m = Z(Math.round(l + (o - e.curveDrag.left) / Math.max(1, e.curveDrag.graphWidth) * c), 0, e.curveDrag.lastFrame), p = !t.shiftKey && Math.abs(o - e.curveDrag.startX) > 8;
  if (e.curveDrag.group) {
    const f = s - e.curveDrag.startValue;
    let d = p ? m - e.curveDrag.startFrame : 0;
    const h = new Set(e.timelineKeyframes().filter((b) => !e.selectedKeyFrames.has(b.frame)).map((b) => b.frame));
    if (d) {
      const b = e.curveDrag.group.map((y) => Z(Math.round(y.startFrame + d), 0, e.curveDrag.lastFrame));
      b.some((y) => h.has(y)) || new Set(b).size !== b.length ? d = 0 : e.curveDrag.group.forEach((y, g) => {
        y.key.frame = b[g];
      });
    }
    for (const b of e.curveDrag.group)
      e.curveDrag.channel.set(b.backing, b.startValue + f);
    e.timelineKeyframes().sort((b, u) => b.frame - u.frame), e.selectedKeyFrames = new Set(e.curveDrag.group.map((b) => b.key.frame)), e.selectedKeyFrame = e.curveDrag.key.frame, e.editingKeyFrame = p ? null : e.curveDrag.key.frame, e.frame = e.curveDrag.key.frame;
  } else
    e.curveDrag.channel.set(i, s), p && m !== e.curveDrag.key.frame ? (e.curveDrag.key.frame = m, e.selectedKeyFrame = m, e.frame = m) : (e.editingKeyFrame = e.curveDrag.key.frame, e.frame = e.curveDrag.key.frame);
  if (e.curveDrag.object) {
    const f = Ie(e.curveDrag.key.transform);
...
function kl(e, t) {
  if (t.currentTarget.hasPointerCapture?.(t.pointerId) && t.currentTarget.releasePointerCapture(t.pointerId), e.curvePanDrag = null, e.curveScrub = null, e.curveBoxSelect = null, e.curveDrag) {
    ...
    e.timelineKeyframes().sort((s, i) => s.frame - i.frame), e.editingKeyFrame = null, e.curveDrag = null, a && o && e.undo?.(), e.serialize(), e.refreshKeys(), e.updateKeyVisualState(), e.drawCurveEditor();
  }
}
function wl(e, t) {
  const a = e.selectedKeyframe() || e.timelineKeyframes().find((o) => o.frame === e.frame);
  if (!a) return e.setStatus(r("Select a keyframe first"));
  e.checkpoint("Change interpolation"), a.interpolation = t;
  for (const o of e.root.querySelectorAll("[data-curve-mode]")) {
    const n = o.dataset.curveMode === t;
    o.classList.toggle("active", n), o.setAttribute("aria-pressed", String(n));
  }
  e.selectedKeyFrame = a.frame, e.serialize(), e.refreshKeys(), e.refreshKeyEditor(), e.render(), e.drawCurveEditor(), e.setStatus(r(`${t.replace("_", " ")} interpolation @ ${a.frame}`));
}
function Sl(e, t) {
  ...
  e.drawCurveEditor(), e.setStatus(t === "all" ? r("Showing all channels") : r(`Solo channel ${t}`));
}
function jl(e, t) {
  const a = e.selectedKeyframe();
  if (!a || !["auto", "vector", "free", "aligned", "flat"].includes(t)) return e.setStatus(r("Select a keyframe first"));
  ...
  const o = Ve(e);
  for (const n of o)
    a.tangents.channels[n.id] ? a.tangents.channels[n.id].mode = t : a.tangents.channels[n.id] = { mode: t };
  for (const n of e.root.querySelectorAll("[data-tangent-mode]")) {
    const s = n.dataset.tangentMode === t;
    n.classList.toggle("active", s), n.setAttribute("aria-pressed", String(s));
  }
  e.selectedKeyFrame = a.frame, e.serialize(), e.refreshKeys(), e.render(), e.drawCurveEditor(), e.setStatus(r(`Tangent mode: ${t} @ ${a.frame}`));
}
function Cl(e) {
  e.showCurveHandles = !e.showCurveHandles;
  for (const t of e.root.querySelectorAll('[data-act="curve-handles"]'))
    t.classList.toggle("active", e.showCurveHandles), t.setAttribute("aria-pressed", String(e.showCurveHandles)), t.title = r(`${e.showCurveHandles ? "Hide" : "Show"} Bézier tangent handles`);
  e.drawCurveEditor(), e.setStatus(r(`Bézier handles ${e.showCurveHandles ? "shown" : "hidden"}`));
}
function _l(e, t) {
  t.preventDefault(), t.stopPropagation();
  ...
  if (t.shiftKey) {
    ...
    e.curvePanX = Z((Number(e.curvePanX) || 0) + (t.deltaY > 0 ? 4 : -4), -o * 0.5, o);
  } else t.altKey ? e.curvePanY = (Number(e.curvePanY) || 0) + (t.deltaY > 0 ? -1 : 1) / (Number(e.curveZoom) || 1) : t.ctrlKey ? e.curveZoomX = Z((Number(e.curveZoomX) || 1) * a, 0.2, 30) : (e.curveZoom = Z((Number(e.curveZoom) || 1) * a, 0.2, 30), e.curveZoomX = Z((Number(e.curveZoomX) || 1) * a, 0.2, 30));
  e.drawCurveEditor(), e.setStatus(r(`Curve zoom: ${(e.curveZoom * 100).toFixed(0)}%`));
}
function El(e, t) {
  e.curveZoom = Z((Number(e.curveZoom) || 1) * t, 0.2, 30), e.curveZoomX = Z((Number(e.curveZoomX) || 1) * t, 0.2, 30), e.drawCurveEditor(), e.setStatus(r(`Curve zoom: ${(e.curveZoom * 100).toFixed(0)}%`));
}
function $l(e, t) {
  t.preventDefault(), t.stopPropagation();
  const a = t.currentTarget, { x: o, y: n } = Oo(a, t);
  if (n < 20) return;
  const s = Math.max(1, e.state.duration_frames - 1), i = s / (Number(e.curveZoomX) || 1), c = Number(e.curvePanX) || 0, l = Math.max(1, a.clientWidth - 58), m = Z(Math.round(c + (o - 44) / l * i), 0, s);
  e.checkpoint?.("Insert keyframe"), e.setFrame(m), e.insertKeyframe(), e.selectedKeyFrame = m, e.selectedKeyFrames = /* @__PURE__ */ new Set([m]), e.updateKeyVisualState(), e.refreshKeys(), e.drawCurveEditor(), e.setStatus(r("Keyframe inserted @ F{frame}").replace("{frame}", m));
}
function un(e, { selectedOnly: t = !1 } = {}) {
  const a = Math.max(1, (e.state?.duration_frames ?? 120) - 1), o = e.timelineKeyframes() || [], n = e.timelineObject(), s = Ve(e), i = e.selectedKeyFrames?.size ? [...e.selectedKeyFrames] : e.selectedKeyFrame != null ? [e.selectedKeyFrame] : [], c = i.length > 0, l = t || c && i.length < o.length ? o.filter((u) => i.includes(u.frame)) : o;
  if (!l.length) {
    e.curveZoom = 1, e.curveZoomX = 1, e.curvePanX = 0, e.curvePanY = 0, e.drawCurveEditor(), e.setStatus(r("Curve view fitted"));
    return;
  }
  const m = l.map((u) => u.frame), p = Math.min(...m), f = Math.max(...m), d = Math.max(1, f - p);
  if (l.length < o.length && d < a) {
    const u = Math.max(2, Math.round(d * 0.15)), y = Math.max(0, p - u), g = Math.min(a, f + u), v = Math.max(1, g - y);
    e.curveZoomX = Z(a / v, 0.2, 30), e.curvePanX = y;
  } else
    e.curveZoomX = 1, e.curvePanX = 0;
  const h = [];
  for (const u of l) {
    const y = n ? u.transform || n : u.camera || u;
    for (const g of s) {
      const v = g.get(y);
  ...
  if (h.length > 0) {
    const u = Math.min(...h), y = Math.max(...h), g = Math.max(1e-4, y - u), v = (u + y) / 2, j = (V) => n ? oo(n, V) : xe(e.state, V), x = [], A = Math.max(1, Math.floor(a / 40));
    for (let V = 0; V <= a; V += A) {
      const Q = j(V);
      for (const w of s) {
        const _ = w.get(Q);
        Number.isFinite(_) && x.push(_);
      }
    }
    let P = Math.min(...x), D = Math.max(...x);
    (!Number.isFinite(P) || !Number.isFinite(D)) && (P = -1, D = 1), Math.abs(D - P) < 1e-6 && (P -= 1, D += 1);
    const F = (D - P) * 0.1;
    P -= F, D += F;
    const U = D - P, B = (P + D) / 2;
    if (l.length < o.length && g < U * 0.75) {
      const V = g * 1.35;
      e.curveZoom = Z(U / V, 0.2, 30), e.curvePanY = v - B;
    } else
      e.curveZoom = 1, e.curvePanY = 0;
  } else
    e.curveZoom = 1, e.curvePanY = 0;
  e.drawCurveEditor();
  const b = l.length < o.length ? r("Fitted to {n} selected keys").replace("{n}", l.length) : r("Curve view fitted");
  e.setStatus(b);
}
function Ml(e) {
  un(e);
...
function Ve(e) {
  ...
  if (e.timelineObject()) {
    ...
    a = [0, 1, 2].map((c) => ({
      ...
      get: (l) => (l[n] || [0, 0, 0])[c],
      set: (l, m) => {
        l[n] || (l[n] = [0, 0, 0]), l[n][c] = n === "size" ? Math.max(0.01, m) : m;
      }
    }));
    ...
    get: (s) => (s.target || [0, 0, 0])[n],
    set: (s, i) => {
      s.target || (s.target = [0, 0, 0]), s.target[n] = i;
    }
  })) : t === "camera" ? a = [
    ...[0, 1, 2].map((n) => ({
      id: `pos_${"xyz"[n]}`,
      name: `Position ${"XYZ"[n]}`,
      color: ["#ef5350", "#53d86a", "#4aa3ef"][n],
      get: (s) => (s.position || [0, 0, 0])[n],
      set: (s, i) => {
        s.position || (s.position = [0, 0, 0]), s.position[n] = i;
      }
    })),
...
function Al(e) {
  ...
  const i = e.timelineObject(), c = e.timelineKeyframes(), l = Ve(e), m = 44, p = 14, f = 16, d = 22, h = Math.max(1, a - m - p), b = Math.max(1, o - f - d), u = Math.max(1, e.state.duration_frames - 1), y = Z(Number(e.curveZoomX) || 1, 0.1, 50), g = Number(e.curvePanX) || 0, v = u / y, j = g, x = g + v, A = [], P = Math.max(1, Math.ceil(v / Math.max(80, h))), D = (M) => i ? oo(i, M) : xe(e.state, M);
  for (let M = 0; M <= u; M += P) A.push({ frame: M, value: D(M) });
  A[A.length - 1]?.frame !== u && A.push({ frame: u, value: D(u) });
  const F = A.flatMap((M) => l.map((W) => W.get(M.value)));
  let U = Math.min(...F), B = Math.max(...F);
  (!Number.isFinite(U) || !Number.isFinite(B)) && (U = -1, B = 1), Math.abs(B - U) < 1e-6 && (U -= 1, B += 1);
  const V = (B - U) * 0.1;
  U -= V, B += V;
  const Q = Z(Number(e.curveZoom) || 1, 0.1, 50), w = (B + U) / 2 + (Number(e.curvePanY) || 0), _ = (B - U) / Q;
  U = w - _ / 2, B = w + _ / 2;
  const z = (M) => m + (M - j) / Math.max(1e-6, x - j) * h, N = (M) => f + b * (B - M) / Math.max(1e-6, B - U);
  if (s.fillStyle = "#111114", s.fillRect(0, 0, a, o), s.strokeStyle = "#222228", s.lineWidth = 1, s.font = "9px system-ui, -apple-system, sans-serif", s.fillStyle = "#6e727a", gl(s, {
    left: m,
    right: p,
    top: f,
    width: a,
    ...
    xFor: z,
    frame: e.frame
  }), yl(s, { left: m, right: p, top: f, width: a, graphHeight: b, minimum: U, maximum: B, yFor: N }), U <= 0 && B >= 0) {
    const M = N(0);
    s.strokeStyle = "#383842", s.lineWidth = 1.2, s.beginPath(), s.moveTo(m, M), s.lineTo(a - p, M), s.stroke();
  }
  e.curveHitPoints = [];
  for (const M of l) {
    s.strokeStyle = M.color, s.lineWidth = 2, s.beginPath();
    let W = !1;
    A.forEach((C) => {
      const R = z(C.frame), G = N(M.get(C.value));
      R >= m - 50 && R <= a - p + 50 && (W ? s.lineTo(R, G) : (s.moveTo(R, G), W = !0));
    }), s.stroke();
    for (const C of c) {
      const R = i ? C.transform : C.camera, G = z(C.frame), ae = N(M.get(R)), oe = C.frame === e.selectedKeyFrame || e.selectedKeyFrames?.has(C.frame);
      oe && (s.fillStyle = "rgba(242, 208, 107, 0.35)", s.beginPath(), s.arc(G, ae, 8.5, 0, Math.PI * 2), s.fill()), s.fillStyle = oe ? "#ffd75e" : M.color, s.strokeStyle = "#0d0d10", s.lineWidth = 1.6, s.beginPath(), s.arc(G, ae, oe ? 5.2 : 3.8, 0, Math.PI * 2), s.fill(), s.stroke(), e.curveHitPoints.push({
        x: G,
        y: ae,
        key: C,
        channel: M,
    ...
    if (e.showCurveHandles)
      for (let C = 0; C < c.length; C++) {
        const R = c[C], G = R.frame === e.selectedKeyFrame || e.selectedKeyFrames?.has(R.frame);
        if (!(G || e.curveChannelFilter !== "all" || c.length <= 4) || R.interpolation !== "bezier") continue;
        const oe = i ? R.transform || i : R.camera || R, ee = z(R.frame), se = N(M.get(oe)), fe = c[C - 1], de = c[C + 1], he = Math.max(1, R.frame - (fe?.frame ?? R.frame - 1)), be = Math.max(1, (de?.frame ?? R.frame + 1) - R.frame), O = os(
          R,
          M.id,
          fe,
          de,
          (re) => M.get(i ? re.transform || i : re.camera || R)
        ), H = (B - U) / Math.max(1, b), ie = h * be / Math.max(1, v), ce = h * he / Math.max(1, v), me = [];
        (fe || C > 0) && me.push({ side: "in", x: ee + O.in_x * ce, y: se - O.in_y / H }), (de || C < c.length - 1 || c.length === 1) && me.push({ side: "out", x: ee + O.out_x * ie, y: se - O.out_y / H });
        for (const re of me) {
          if (s.strokeStyle = M.color, s.lineWidth = G ? 1.5 : 1, s.beginPath(), s.moveTo(ee, se), s.lineTo(re.x, re.y), s.stroke(), s.fillStyle = G ? "#2a2233" : "#171720", s.strokeStyle = G ? "#ffd75e" : M.color, s.lineWidth = G ? 2 : 1.2, s.beginPath(), re.side === "in")
            s.arc(re.x, re.y, G ? 5 : 3.8, 0, Math.PI * 2);
          else {
            const ke = G ? 4.5 : 3.2;
  ...
  if (e.curveBoxSelect) {
    const M = Math.min(e.curveBoxSelect.startX, e.curveBoxSelect.currentX), W = Math.min(e.curveBoxSelect.startY, e.curveBoxSelect.currentY), C = Math.abs(e.curveBoxSelect.currentX - e.curveBoxSelect.startX), R = Math.abs(e.curveBoxSelect.currentY - e.curveBoxSelect.startY);
    s.fillStyle = "rgba(56, 189, 248, 0.15)", s.fillRect(M, W, C, R), s.strokeStyle = "#38bdf8", s.lineWidth = 1, s.setLineDash([4, 4]), s.strokeRect(M, W, C, R), s.setLineDash([]);
  }
  const q = z(e.frame);
  if (q >= m && q <= a - p && (s.strokeStyle = "#a78bfa", s.lineWidth = 1.5, s.beginPath(), s.moveTo(q, f), s.lineTo(q, f + b), s.stroke(), s.fillStyle = "#a78bfa", s.beginPath(), s.moveTo(q - 4, f), s.lineTo(q + 4, f), s.lineTo(q, f + 6), s.closePath(), s.fill()), e.curveDrag || e.curveHover) {
    let M = "", W = "";
    if (e.curveDrag)
      if (e.curveDrag.handle) {
        const C = e.curveDrag.handle === "in" ? "In" : "Out";
        M = `F${e.curveDrag.key.frame} · ${e.curveDrag.channel.name} (${C})`, W = "Tangent edit";
      } else if (e.curveDrag.group && e.curveDrag.group.length > 1) {
        const C = e.curveDrag.key.frame - e.curveDrag.startFrame, R = e.curveDrag.channel.get(e.curveDrag.object ? e.curveDrag.key.transform : e.curveDrag.key.camera), G = R - e.curveDrag.startValue, ae = C >= 0 ? `+${C}` : `${C}`, oe = G >= 0 ? `+${G.toFixed(2)}` : `${G.toFixed(2)}`;
        M = `${e.curveDrag.group.length} keys · ΔF: ${ae} · ΔVal: ${oe}`, W = `${e.curveDrag.channel.name}: ${R.toFixed(2)}`;
      } else {
        const C = e.curveDrag.key.frame - e.curveDrag.startFrame, R = e.curveDrag.channel.get(e.curveDrag.object ? e.curveDrag.key.transform : e.curveDrag.key.camera), G = R - e.curveDrag.startValue, ae = C >= 0 ? `+${C}` : `${C}`, oe = G >= 0 ? `+${G.toFixed(2)}` : `${G.toFixed(2)}`;
        M = `F${e.curveDrag.key.frame} (${ae}) · ${e.curveDrag.channel.name}: ${R.toFixed(2)} (${oe})`;
      }
    else if (e.curveHover)
      if (e.curveHover.channelName) {
        const C = Number.isFinite(e.curveHover.value) ? e.curveHover.value.toFixed(2) : "";
        M = `F${e.curveHover.frame} · ${e.curveHover.channelName}: ${C}`, e.curveHover.isHandle && (W = `Handle ${e.curveHover.handleSide}`);
      } else
        M = `Frame ${e.curveHover.frame}`;
    if (M) {
      s.save(), s.font = "11px system-ui, -apple-system, sans-serif";
      const C = s.measureText(M), R = W ? s.measureText(W) : { width: 0 }, G = Math.max(C.width, R.width) + 16, ae = W ? 32 : 20, oe = a - p - G - 6, ee = f + 6;
      s.fillStyle = "rgba(18, 18, 24, 0.88)", s.strokeStyle = "#38384a", s.lineWidth = 1, s.beginPath(), s.roundRect ? s.roundRect(oe, ee, G, ae, 4) : s.rect(oe, ee, G, ae), s.fill(), s.stroke(), s.fillStyle = "#e2e8f0", s.fillText(M, oe + 8, ee + (W ? 13 : 14)), W && (s.fillStyle = "#94a3b8", s.font = "9.5px system-ui, -apple-system, sans-serif", s.fillText(W, oe + 8, ee + 26)), s.restore();
    }
  }
  for (const M of e.root.querySelectorAll("[data-tangent-mode]")) {
    ...
    M.classList.toggle("active", M.dataset.tangentMode === C);
  }
...
function cr(e, { filter: t, label: a, color: o, title: n }) {
...
function gn(e) {
  ...
  if (!t) return;
  const a = e.timelineObject(), o = a ? a.name || a.type : e.activeCameraTrack().name, n = Tl(e), s = `${o}\0${n.map((c) => `${c.id}:${c.color}`).join("|")}`;
  if (t.dataset.signature !== s) {
    t.dataset.signature = s, t.replaceChildren();
    const c = document.createElement("span");
    c.className = "oc-graph-legend-title", c.textContent = o, t.appendChild(c), t.appendChild(cr(e, {
      filter: "all",
      label: r("All"),
      color: null,
...
function lr(e, t, a) {
  const o = [];
  let n = null;
  for (const s of [...e].sort((i, c) => i.frame - c.frame)) {
    const i = (a ? s.transform : s.camera) || {};
    let c;
    try {
      c = Number(t.get(i));
    } catch {
    ...
    (n === null || !(Math.abs(c - n) <= Pl)) && o.push(s.frame), n = c;
  }
  return o;
}
function Ko(e) {
  ...
  const a = e.timelineKeyframes() || [], o = !!e.timelineObject(), n = e.selectedKeyFrames || (e.selectedKeyFrame === null ? /* @__PURE__ */ new Set() : /* @__PURE__ */ new Set([e.selectedKeyFrame])), s = Ve(e), i = [
    e.state.duration_frames,
    Number(e.timelineZoom) || 1,
    Number(e.timelinePan) || 0,
    ...s.map((c) => `${c.id}:${lr(a, c, o).join(",")}`)
  ].join("\0");
  if (t.dataset.signature === i) {
    for (const c of t.querySelectorAll(".oc-dope-key")) {
      const l = Number(c.dataset.frame);
      c.classList.toggle("at-playhead", l === e.frame), c.classList.toggle("selected", n.has(l));
    }
    Ya(e);
    return;
  }
  ...
  for (const c of s) {
    ...
    m.className = "oc-gdope-label", m.textContent = r(c.name), l.appendChild(m);
    const p = document.createElement("div");
    p.className = "oc-gdope-track";
    for (const d of lr(a, c, o)) {
      const h = pe(e, d);
      if (h < -5 || h > 105) continue;
      const b = document.createElement("button");
      b.type = "button", b.className = `oc-dope-key${d === e.frame ? " at-playhead" : ""}${n.has(d) ? " selected" : ""}`, b.style.left = `${h}%`, b.dataset.frame = String(d), b.title = r("{channel} changes at frame {frame}").replace("{channel}", r(c.name)).replace("{frame}", String(d)), b.addEventListener("click", (u) => {
    ...
    f.className = "oc-gdope-playhead", p.appendChild(f), l.appendChild(p), t.appendChild(l);
  }
  Ya(e);
}
const dr = ["#4aa3ef", "#f2a93b", "#48c774", "#b565d8", "#ec4899"];
function yn(e, t) {
  const a = e.state.cameras.findIndex((n) => n.id === t), o = a >= 0 ? e.state.cameras[a] : null;
  return { camera: o, color: o?.color || dr[Math.max(0, a) % dr.length] };
}
function Qe(e) {
...
function Ra(e, t, a, { disabled: o = !1 } = {}) {
...
function zl(e, t) {
  ...
  if (a.appendChild(Ra(
    ...
    () => Il(e),
    { disabled: o }
  )), t.length && (a.appendChild(Ra(
    r("Split at playhead"),
    r("Cut the current shot in two at the playhead"),
    () => {
      e.checkpoint("Split shot"), qr(e.state, e.frame, null) ? Qe(e) : e.setStatus(r("Move the playhead inside a shot first"));
    },
    { disabled: o }
  )), a.appendChild(Ra(
    r("Clear edit"),
...
function Ll(e, t, a, o, n) {
  t.preventDefault(), t.stopPropagation();
  const { camera: s } = yn(e, a.camera_id);
  e.contextMenu?.show(t, s?.name || r("Shot"), [
    ...
    null,
    {
      ...
      run: () => {
        e.checkpoint("Split shot"), qr(e.state, e.frame, null) && Qe(e);
      }
    },
    {
      label: r("Remove shot"),
      ...
      disabled: n === 1,
      run: () => {
        e.checkpoint("Remove shot"), rs(e.state, o) && Qe(e);
      }
    }
  ]);
}
function Ol(e, t, a, o) {
  const { camera: n, color: s } = yn(e, t.camera_id), i = document.createElement("div");
  i.className = "oc-sequence-shot", i.dataset.cutIndex = String(a), i.style.left = `${pe(e, t.start)}%`, i.style.width = `${Math.max(0.4, pe(e, t.end + 1) - pe(e, t.start))}%`, i.style.setProperty("--shot-color", s), n?.recording_path || i.classList.add("no-proxy"), i.title = r("{name} · F{start}-{end}").replace("{name}", n?.name || t.camera_id).replace("{start}", String(t.start)).replace("{end}", String(t.end));
  const c = document.createElement("span");
  if (c.className = "oc-sequence-name", c.textContent = n?.name || t.camera_id, i.appendChild(c), a > 0) {
    const l = document.createElement("span");
    l.className = "oc-sequence-handle", l.title = r("Drag to trim the cut"), l.addEventListener("pointerdown", (m) => Fl(e, m, l, o, a)), i.appendChild(l);
  }
...
function Kl(e) {
  ...
  return o.className = "oc-sequence-waveform", t.appendChild(o), requestAnimationFrame(() => {
    ...
    if (!i) return;
    const c = Math.max(1, e.state.duration_frames - 1), l = Math.min(50, Math.max(0.1, Number(e.timelineZoom) || 1)), m = Number(e.timelinePan) || 0, p = c / l;
    i.fillStyle = "#f2d06b";
    for (let f = 0; f < a.length; f++) {
      const h = (f / (a.length - 1) * c - m) / Math.max(1e-6, p) * n;
      if (h < -4 || h > n + 4) continue;
      const b = a[f] * s * 0.9;
      i.fillRect(h, (s - b) / 2, Math.max(1, n / a.length * l - 0.5), b);
    }
  }), t;
}
function xn(e, t) {
  ...
  if (s.className = "oc-sequence-lane", s.dataset.role = "sequence-lane", s.setAttribute("aria-label", r("Multi-camera edit")), o.length)
    for (const [c, l] of o.entries()) {
      const m = pe(e, l.start);
      pe(e, l.end + 1) < -5 || m > 105 || s.appendChild(Ol(e, l, c, n));
    }
  else {
    const c = document.createElement("span");
  ...
  n.appendChild(s), n.appendChild(Kl(e));
  const i = document.createElement("span");
  i.className = "oc-sequence-playhead", i.style.left = `${pe(e, e.frame)}%`, n.appendChild(i), t.appendChild(n);
}
const Dl = ['[data-act="curve-zoom-in"]', '[data-act="curve-zoom-out"]', '[data-act="curve-fit"]', '[data-act="curve-handles"]'], mr = { curves: "Graph", dope: "Timeline", sequence: "Sequence" };
function pr(e, t) {
  const a = t in mr ? t : "curves";
  e.graphTab = a;
  ...
  const o = e.root.querySelector('[data-role="curve-canvas"]'), n = e.root.querySelector('[data-role="graph-dope"]'), s = e.root.querySelector('[data-role="graph-sequence"]');
  o && (o.hidden = a !== "curves"), n && (n.hidden = a !== "dope"), s && (s.hidden = a !== "sequence");
  for (const i of Dl) {
    const c = e.root.querySelector(i);
    c && (c.disabled = a !== "curves");
  }
  a === "dope" ? Ko(e) : a === "sequence" ? (xn(e, s), s?.focus?.({ preventScroll: !0 })) : e.drawCurveEditor(), e.setStatus(r(mr[a]));
}
function Nl(e) {
  e.graphTab === "sequence" && xn(e, e.root.querySelector('[data-role="graph-sequence"]'));
}
function Rl(e, t) {
  ...
  a && a.addEventListener("keydown", (o) => {
    if (o.key === "ArrowLeft" || o.key === "ArrowRight") {
      ...
      if (s >= 0 && n.length > 1) {
        ...
        n[i].focus(), pr(e, n[i].dataset.graphTab);
      }
    }
  }, { signal: t });
  for (const o of e.root.querySelectorAll("[data-graph-tab]"))
    o.addEventListener("click", (n) => {
      n.preventDefault(), n.stopPropagation(), pr(e, o.dataset.graphTab);
    }, { signal: t });
}
let fr = /* @__PURE__ */ new WeakSet();
function ql(e) {
  if (!e) return "";
...
function Bl(e) {
  ...
  if (!t || !a) return;
  const o = Mc(e.state?.metadata, e.state?.duration_frames), n = o.some((c) => c.state !== "unknown");
  t.classList.toggle("oc-health-strip-empty", !n), a.childElementCount !== o.length && a.replaceChildren(...o.map(() => {
    const c = document.createElement("span");
  ...
  for (let c = 0; c < o.length; c += 1) {
    const l = s[c], m = o[c];
    l.dataset.frame = String(m.frame), l.dataset.state = m.state, l.dataset.score = m.score === null ? "" : String(m.score), l.classList.toggle("at-playhead", m.frame === e.frame);
  }
  if (fr.has(a)) return;
  fr.add(a), a.addEventListener("pointerdown", (c) => {
    const l = c.target.closest?.(".oc-health-cell");
    if (!l) return;
    const m = Number(l.dataset.frame);
    Number.isInteger(m) && e.setFrame(m);
  });
...
function Wl(e) {
  ...
  if (!t) return;
  t.innerHTML = "";
  const a = e.timelineObject(), o = e.timelineKeyframes(), n = Math.max(1, e.state.duration_frames - 1), s = Z(Number(e.timelineZoom) || 1, 0.1, 50), i = Number(e.timelinePan) || 0, c = n / s, l = i;
  if (e.audioWaveformPeaks && e.audioWaveformPeaks.length) {
    ...
    const j = v.getContext("2d"), x = e.audioWaveformPeaks, A = v.width, P = v.height, D = P / 2;
    j.fillStyle = "#f2d06b";
    for (let F = 0; F < x.length; F++) {
      const B = (F / (x.length - 1) * n - l) / Math.max(1e-6, c) * A;
      if (B >= -5 && B <= A + 5) {
        const V = x[F] * (P * 0.85);
        j.fillRect(B, D - V / 2, Math.max(1, A / x.length * s - 0.5), V);
      }
    }
    t.appendChild(v);
  }
  if (e.state.playback_range) {
    ...
    const j = pe(e, e.state.playback_range[0]), x = pe(e, e.state.playback_range[1]);
    v.style.left = `${j}%`, v.style.width = `${Math.max(0, x - j)}%`, t.appendChild(v);
  }
  is(e, t);
  for (const v of e.state.markers || []) {
    const j = pe(e, v.frame);
    if (j < -5 || j > 105) continue;
    const x = document.createElement("span");
    x.className = "timeline-marker", x.style.left = `${j}%`, x.style.setProperty("--marker-color", v.color), x.title = v.name, t.appendChild(x);
  }
  if (o.length > 1) {
    const v = pe(e, o[0].frame), j = pe(e, o[o.length - 1].frame), x = document.createElement("span");
    x.className = "oc-dope-rail", x.style.left = `${Math.min(v, j)}%`, x.style.width = `${Math.abs(j - v)}%`, x.style.setProperty("--channel-color", "#a78bfa"), t.appendChild(x);
  }
  const m = e.selectedKeyFrames || (e.selectedKeyFrame === null ? /* @__PURE__ */ new Set() : /* @__PURE__ */ new Set([e.selectedKeyFrame]));
  for (const v of o) {
    const j = pe(e, v.frame);
    if (j < -5 || j > 105) continue;
    const x = document.createElement("button");
    x.type = "button", x.className = `key${v.frame === e.frame ? " at-playhead" : ""}${m.has(v.frame) ? " selected" : ""}${v.frame === e.editingKeyFrame ? " editing" : ""}`, x.dataset.keyFrame = String(v.frame), x.dataset.interp = v.interpolation || "ease", x.setAttribute("aria-label", r(`${a?.name || "Camera"} keyframe at frame ${v.frame}`)), x.title = r(`Frame ${v.frame} · ${v.interpolation} · Drag: Retime · Alt+Drag: Duplicate`), x.style.left = `${j}%`;
    const A = document.createElement("span");
    A.className = "key-label", A.textContent = String(v.frame), x.appendChild(A), x.addEventListener("pointerdown", (P) => {
      if (P.preventDefault(), P.stopPropagation(), x.focus({ preventScroll: !0 }), P.altKey) {
        e.checkpoint("Duplicate keyframe");
        const F = a ? { frame: v.frame, transform: Ie(v.transform), interpolation: v.interpolation } : { frame: v.frame, camera: le(v.camera), interpolation: v.interpolation }, U = e.timelineKeyframes();
        U.push(F), U.sort((B, V) => B.frame - V.frame), e.selectedKeyFrame = F.frame, e.selectedKeyFrames = /* @__PURE__ */ new Set([F.frame]), e.keyDrag = { key: F, box: t, isDuplicate: !0, historyCheckpointed: !0, moving: [{ key: F, startFrame: F.frame }], startPointerFrame: v.frame, startClientX: P.clientX, startClientY: P.clientY }, e.setFrame(F.frame, !1, !1), e.setStatus(r(`Duplicating key from ${v.frame}...`));
        return;
      }
      if (P.shiftKey) {
      ...
      const D = e.timelineKeyframes().filter((F) => e.selectedKeyFrames.has(F.frame));
      e.keyDrag = { key: v, box: t, historyCheckpointed: !1, moving: D.map((F) => ({ key: F, startFrame: F.frame })), startPointerFrame: v.frame, startClientX: P.clientX, startClientY: P.clientY }, e.setFrame(v.frame, !1, !1);
    }), x.addEventListener("click", (P) => {
      P.preventDefault(), P.stopPropagation(), !P.shiftKey && (P.shiftKey || (e.selectedKeyFrames = /* @__PURE__ */ new Set([v.frame])), e.selectKeyframe(v));
    }), t.appendChild(x);
  }
  ...
  if (f) {
    ...
    v.style.fontWeight = "700", e.selectedEntity === "object" && a ? (v.style.color = "#38bdf8", v.textContent = `📦 ${a.name || a.type}`, f.title = r(`Currently animating object: ${a.name || a.type}`)) : (v.style.color = "#f59e0b", v.textContent = `🎥 ${p.name}`, f.title = r(`Currently animating camera: ${p.name}`)), f.append(v, document.createTextNode(` · ${o.length} key${o.length === 1 ? "" : "s"}`));
    const j = e.selectedKeyFrames?.size || 0;
    j > 1 && f.append(document.createTextNode(` · ${j} selected`));
    const x = o.filter((A) => A.frame > e.state.duration_frames - 1).length;
    if (x) {
      const A = document.createElement("span");
      A.className = "oc-dormant-keys", A.textContent = ` · ${x} beyond end`, A.title = r("Keys past the end of the timeline are kept. Lengthen the shot to reach them again."), f.append(A);
    }
  }
  ...
  h && (h.textContent = `${p.name} · Key F${e.selectedKeyFrame ?? e.frame}`);
  const b = e.root.querySelector('[data-role="camera-menu-list"]');
  if (b) {
    b.innerHTML = "";
    for (const v of e.state.cameras) {
      const j = document.createElement("button");
      j.type = "button", j.className = v.id === e.state.active_camera_id ? "selected" : "";
      const x = document.createElement("i");
      x.className = "pi pi-video";
      const A = document.createElement("span");
      A.textContent = `${v.name} · ${v.keyframes.length} key${v.keyframes.length === 1 ? "" : "s"}${v.id === e.state.playblast_camera_id ? " · PLAYBLAST" : ""}`, j.append(x, A), j.addEventListener("click", () => {
  ...
  y && (y.textContent = `${p.name} · ${r("Frame")} ${e.frame}`);
  const g = e.root.querySelector('[data-role="inspector-camera-name"]');
  g && (g.textContent = p.name), bn(e), mn(e), gn(e), Ko(e), Nl(e), e.refreshCameraSelectors(), e.refreshKeyEditor(), e.updateEditState(), e.drawCurveEditor(), e.perf && (e.perf.timelineRefreshCount = (e.perf.timelineRefreshCount || 0) + 1), Bl(e);
}
class kn {
...
async function Do(e, { route: t, field: a = "file", file: o }) {
      ...
      <details class="toolbar-menu oc-overflow" data-menu="output">
        ...
        <div class="menu-panel right">
          ...
          <div class="menu-section" data-density-min="animation">
            <label>${r("H3 preset")} <select data-role="proxy-preset">
              <option value="balanced">${r("Balanced")}</option>
              <option value="parallax">${r("Parallax")}</option>
              <option value="subject">${r("Subject")}</option>
              <option value="debug">${r("Debug")}</option>
            </select></label>
            ...
            <button data-act="h3-setup" class="primary" title="${r("Create the H3 reference nodes")}"><i class="pi pi-bolt"></i> ${r("H3 Setup")}</button>
          </div>
    ...
    <div class="oc-footer">
      <details class="help oc-help">
        ...
        <div class="oc-help-body">
          ...
          <p>${r("The proxy communicates camera motion, not final appearance. Use H3 Setup for Omni Reference, Wan Native Camera for core Plücker conditioning, or the pinned ATI/LTX adapters for their supported workflows.")}</p>
        </div>
      </details>
  ...
  return `
    <aside class="oc-left" data-role="scene-panel" aria-label="${r("Scene")}">
      <div class="oc-left-tabs" data-role="left-tabs" role="tablist">
        <button type="button" class="oc-left-tab active" data-asset-view="scene" role="tab">${r("Scene")}</button>
        <button type="button" class="oc-left-tab" data-asset-view="assets" role="tab">${r("Assets")}</button>
        <button type="button" class="oc-left-tab" data-asset-view="agent" role="tab">${r("Agent")}</button>
      </div>
  ...
  return `
    <div class="inspector-tab-content oc-side-body" data-tab-panel="scene">
      <div class="oc-card" data-role="object-panel">
        ...
        <div class="oc-vec-row" data-role="rotation-row"><span class="oc-field-label">${r("Rotation")}</span>
        ...
        <div class="oc-vec-row" data-role="scale-row"><span class="oc-field-label">${r("Scale")}</span>
...
function md() {
  const e = oc.map((t) => `<button data-lens="${t}">${t}mm</button>`).join("");
  return `
    <div class="inspector-tab-content oc-side-body" data-tab-panel="camera" hidden>
      <div class="oc-card">
        ...
        <div class="oc-field-row"><span class="oc-field-label">${r("Focal Length")}</span>
          <input data-role="camera-focal" type="number" min="4" max="800" step="0.5"><span class="oc-unit">mm</span>
        </div>
        <div class="oc-field-row"><span class="oc-field-label">${r("FOV")}</span>
        ...
        <div class="oc-field-row"><span class="oc-field-label">${r("Roll")}</span>
...
function bd() {
  return `
    <div class="oc-health-strip" data-role="solve-health-strip" data-density-min="animation">
      <span class="oc-health-strip-label">${r("Solve Health")}</span>
      <div class="oc-health-cells" data-role="solve-health-cells"
           role="group" aria-label="${r("Per-frame solve health")}"></div>
...
function gd() {
  return `
    <div class="row timeline-toolbar oc-transport">
      ...
      <button class="icon-button" data-act="toggle-graph" data-density-min="animation" title="${r("Open or close the animation curve editor")}"><i class="pi pi-chart-line"></i></button>
    ...
    <section class="curve-editor oc-graph" data-density-min="animation">
      <div class="oc-graph-head">
        <span class="oc-graph-tabs" data-role="graph-tabs">
          <button class="oc-graph-tab" data-graph-tab="dope" aria-pressed="false" title="${r("Per-channel keyframe sheet")}">${r("Timeline")}</button>
          <button class="oc-graph-tab active" data-graph-tab="curves" aria-pressed="true" title="${r("Edit animation curves")}"><strong>${r("Graph")}</strong></button>
          <button class="oc-graph-tab" data-graph-tab="sequence" aria-pressed="false" title="${r("Cut the timeline into shots, one camera per range")}">${r("Sequence")}</button>
        </span>
      ...
      <div class="curve-toolbar oc-graph-toolbar">
        ...
        <button class="curve-mode" data-act="curve-zoom-in" title="${r("Zoom in curve editor (Mouse wheel)")}"><i class="pi pi-search-plus"></i></button>
        <button class="curve-mode" data-act="curve-zoom-out" title="${r("Zoom out curve editor")}"><i class="pi pi-search-minus"></i></button>
        <button class="curve-mode" data-act="curve-fit" title="${r("Fit curves to view")}"><i class="pi pi-arrows-alt"></i></button>
        <button class="curve-mode active" data-act="curve-handles" title="${r("Show or hide Bézier tangent handles")}" aria-pressed="true"><i class="pi pi-share-alt"></i></button>
      ...
      <div class="oc-graph-body">
        ...
        <div class="oc-graph-stage">
          <canvas class="curve-canvas" data-role="curve-canvas" tabindex="-1" title="${r("Drag a key point vertically or drag tangent handles on either side. Scroll to zoom. Right-click for curve actions.")}"></canvas>
      ...
      <div class="oc-resize-v oc-graph-resize" data-role="graph-resize" role="separator" aria-orientation="horizontal" tabindex="0"
           title="${r("Drag to resize graph editor — double-click to reset")}" aria-label="${r("Resize graph editor")}"></div>
    </section>`;
}
function xd() {
  return `
...
function wd() {
  return `
    <details class="toolbar-menu" data-menu="scene"><summary><i class="pi pi-box"></i> ${r("Viewport")} <i class="pi pi-chevron-down"></i></summary><div class="menu-panel">
      ...
      <div class="menu-divider"></div><div class="menu-title">${r("Objects & Primitives")}</div>
      ...
      <button data-object-type="null"><i class="pi pi-plus"></i> ${r("Null Locator")}</button>
      <div class="menu-section" data-density-min="animation">
      ...
      <div class="menu-section" data-density-min="advanced">
        <div class="menu-divider"></div><div class="menu-title">${r("Blocking Scene Sets (Parallax / Occlusion)")}</div>
        <div class="menu-grid">
...
function Sd() {
  return `
    <details class="toolbar-menu" data-menu="camera"><summary><i class="pi pi-video"></i> <span data-role="camera-summary">${r("Cameras")}</span> <i class="pi pi-chevron-down"></i></summary><div class="menu-panel">
      ...
      <div class="menu-divider"></div><div class="menu-title">${r("Motion Presets & Shake")}</div>
      <div class="menu-grid">
        ...
        <button data-shake="crash">${r("Crash")}</button>
      </div>
      <div class="menu-divider"></div>
...
function _d() {
  return `
    <div class="top">
      <button class="icon-button oc-drawer-toggle" data-act="toggle-scene-panel" title="${r("Scene")}" aria-pressed="false"><i class="pi pi-list"></i></button>
      ${kd()}
      ${wd()}
      ${Sd()}
      ${jd()}
      ...
      <select class="oc-render-mode" data-role="mode" title="${r("Proxy mode")}">
        <option value="omni_ref">${r("Omni Ref")}</option>
        <option value="card_grid">${r("Card + Grid")}</option>
        <option value="graybox">${r("Graybox")}</option>
        <option value="grid">${r("Grid")}</option>
        <option value="point_field">${r("Point Field")}</option>
        <option value="wireframe">${r("Wireframe")}</option>
        <option value="beauty">${r("Beauty (lit)")}</option>
      </select>
    </div>`;
}
function Ed() {
...
const Ce = "/majoor/omnicam/library";
function Td(e, t) {
...
function No({ fetchApi: e = Td } = {}) {
  ...
  return {
    list(a = {}) {
      ...
      return o && o !== "all" && (l.kind = o), t(`${Ce}${hr(l)}`);
    },
    get(a) {
      return t(`${Ce}/${encodeURIComponent(a)}`);
    },
    register(a) {
      return t(`${Ce}/register`, {
        method: "POST",
    ...
    remove(a) {
      return t(`${Ce}/${encodeURIComponent(a)}`, { method: "DELETE" });
    },
    importModel(a, o = {}) {
      const n = new FormData();
      return n.append("file", a, o.filename || a.name || "model.glb"), t(`${Ce}/import${hr(o)}`, { method: "POST", body: n });
    },
    uploadThumbnail(a, o, n = "thumb.webp") {
      const s = new FormData();
      return s.append("file", o, n), t(`${Ce}/thumbnail/${encodeURIComponent(a)}`, {
        method: "POST",
        body: s
      });
    },
    ...
    deletePose(a) {
      return t(`${Ce}/poses/${encodeURIComponent(a)}`, { method: "DELETE" });
    }
  };
}
const jn = Object.freeze(["all", "character", "prop", "environment", "vehicle"]);
function br(e = {}) {
  const t = String(e.kind || "all").toLowerCase();
  return {
    kind: jn.includes(t) ? t : "all",
...
function zd(e) {
  ...
  return {
    ...
    setFilter(i) {
      return a.filter = br({ ...a.filter, ...i }), a.offset = 0, this.refresh();
    },
    refresh() {
      return s(async () => {
...
function ur(e = {}) {
  ...
  const l = () => {
    ...
    if (d.isEmpty()) return;
    const h = d.getCenter(new t.Vector3()), b = d.getSize(new t.Vector3()), y = Math.max(b.length() / 2, 1e-3) / Math.sin(c.fov * Math.PI / 360);
    c.position.set(h.x + y * 0.7, h.y + y * 0.55, h.z + y), c.near = y / 100, c.far = y * 10, c.updateProjectionMatrix(), c.lookAt(h);
  }, p = (f, d) => new Promise((h, b) => {
    const u = d === "fbx" && o ? o : a;
    new u().load(
      f,
      (y) => h(y.scene || y),
  ...
  return {
    async render(f, d = "glb") {
      ...
      try {
        l();
        const h = await p(f, d);
        i.add(h), m(h), s.render(i, c);
        const b = s.domElement.toDataURL("image/webp", 0.82);
        return i.remove(h), h.traverse?.((u) => {
          u.geometry?.dispose?.();
          const y = u.material;
...
function qd(e, t = {}) {
  return jn.map((a) => {
    const o = r(Rd[a] || a), n = a === "all" ? "" : ` <span class="oc-asset-kind-n">${Number(t[a] || 0)}</span>`;
...
function Bd(e, { selected: t = !1, thumbUrl: a = "" } = {}) {
  const o = Nd[e.kind] || "pi-box", n = e.kind === "character" && Br(e.rig) === "rigged" ? `<span class="oc-asset-badge">${r("RIGGED")}</span>` : "", s = a ? `<img class="oc-asset-thumb" src="${Je(a)}" alt="" loading="lazy">` : `<span class="oc-asset-thumb oc-asset-thumb--glyph"><i class="pi ${o}"></i></span>`;
...
function Vd(e, t = {}) {
  const a = e.root, o = t.fetchApi || ((O, H) => (e.api || e.app?.api).fetchApi(O, H)), n = t.apiClient || No({ fetchApi: o }), s = t.store || zd(n), i = Fd(), c = t.previewQueue || Ld(), l = e.api || e.app?.api || null;
  let m = t.thumbnailRenderer || null, p = null;
  const f = /* @__PURE__ */ new Set();
  function d() {
    return m ? Promise.resolve(m) : (p || (p = Kd().then((O) => m = ur(O)).catch(() => m = ur({}))), p);
  }
  function h(O) {
    return Zo(l, Tc(O));
  }
  function b(O) {
    return O.thumbnail ? Zo(l, `omnicam/library/${O.thumbnail} [input]`) : "";
  }
  function u() {
    for (const O of s.state.items) {
      if (O.kind === "helper" || !O.file || i.get(O.id) || O.thumbnail || f.has(O.id)) continue;
      const H = h(O);
      H && c.enqueue(O.id, async () => {
        const ce = await (await d()).render(H, O.format || "glb");
        if (!ce) {
          f.add(O.id);
          return;
        }
        if (i.set(O.id, ce), R(), !(O.source && O.source !== "user"))
          try {
            const me = await n.uploadThumbnail(O.id, Dd(ce));
  ...
  const y = (O) => a.querySelector(`[data-role="${O}"]`), g = y("assets-panel"), v = y("asset-grid"), j = y("asset-kinds"), x = y("asset-search"), A = y("asset-status"), P = y("asset-import-file"), D = y("scene-tab"), F = y("assets-tab"), U = y("agent-tab"), B = a.querySelector('[data-asset-view="agent"]'), V = { assets: F, agent: U };
  let Q = "", w = null, _ = !0, z = !0, N = "scene", q = 0;
  function M(O, { sticky: H = !1 } = {}) {
    A && (!H && q > Date.now() || (A.textContent = O || "", q = H ? Date.now() + 9e3 : 0));
  }
  function W(O) {
    if (Q = O, !!v)
      for (const H of v.querySelectorAll(".oc-asset-card"))
        H.classList.toggle("selected", H.dataset.assetId === O);
  }
  let C = !1;
  function R() {
    if (j && (j.innerHTML = qd(s.state.filter.kind, s.state.kinds)), v) {
      const O = {};
      for (const H of s.state.items) {
        const ie = i.get(H.id) || b(H);
        ie && (O[H.id] = ie);
      }
      v.innerHTML = Wd(s.state.items, { selectedId: Q, thumbUrls: O });
    }
    if (!C) {
      C = !0;
      try {
    ...
    s.state.error ? M(s.state.error.message) : s.state.loading ? M(r("Loading assets...")) : M(r("{n} of {total} assets").replace("{n}", s.state.items.length).replace("{total}", s.state.total));
  }
  function G(O) {
    if (!O) return;
    const H = Ac({
      ...
      operations: [{ type: "asset.instantiate", asset: O, point: H }]
    });
    if (!ie?.ok) {
    ...
    ce && (e.selectedEntity = "object", e.selectedObjectId = ce, e.selectedObjectIds = /* @__PURE__ */ new Set([ce]), e.selectedKeyFrame = null), e.restoreAssets?.(), e.refreshObjects?.(), e.refreshInspector?.(), e.render?.(), e.setStatus?.(r("{name} added").replace("{name}", O.name));
  }
  async function ae(O) {
    if (O) {
      M(r("Importing {name}...").replace("{name}", O.name));
      try {
        const H = await n.importModel(O, { kind: "prop", name: O.name.replace(/\.[^.]+$/, "") });
        H.asset && s.upsert(H.asset), M(r("Imported {name}").replace("{name}", H.asset?.name || O.name));
      } catch (H) {
        M(H.message || r("Import failed"));
      }
    }
  }
  function oe(O) {
    O === "agent" && !ko() && (O = "scene"), N = O, D && (D.hidden = O !== "scene");
    for (const [H, ie] of Object.entries(V))
      ie && (ie.hidden = H !== O);
    for (const H of a.querySelectorAll("[data-asset-view]"))
      H.classList.toggle("active", H.dataset.assetView === O);
    O === "assets" && _ && (_ = !1, s.refresh()), O === "agent" && z && (z = !1, t.onAgentFirstOpen?.());
  }
  function ee() {
    const O = ko();
    B && (B.hidden = !O), !O && N === "agent" && oe("scene");
  }
  function se(O) {
    const H = gr(O.target);
    if (H) {
      if (H.action === "switch-view") return oe(H.view);
      if (H.action === "filter-kind") return void s.setFilter({ kind: H.kind });
      if (H.action === "asset-add")
        return G(s.get(Q));
      if (H.action === "asset-import")
        return P?.click();
      H.action === "card" && W(H.assetId);
    }
  }
  function fe(O) {
    const H = gr(O.target);
    H?.action === "card" && G(s.get(H.assetId));
  }
  function de() {
    clearTimeout(w), w = setTimeout(() => s.setFilter({ search: x.value }), 200);
  }
  function he(O) {
    const H = O.target.files?.[0];
    O.target.value = "", ae(H);
  }
  const be = s.subscribe(R);
  return g?.addEventListener("click", se), g?.addEventListener("dblclick", fe), a.querySelector('[data-role="left-tabs"]')?.addEventListener("click", se), x?.addEventListener("input", de), P?.addEventListener("change", he), R(), ee(), {
    store: s,
    switchView: oe,
    syncAgentAvailability: ee,
    refresh: () => s.refresh(),
    dispose() {
      be(), clearTimeout(w), g?.removeEventListener("click", se), g?.removeEventListener("dblclick", fe), a.querySelector('[data-role="left-tabs"]')?.removeEventListener("click", se), x?.removeEventListener("input", de), P?.removeEventListener("change", he), c.clear(), m?.dispose?.(), i.clear();
    }
  };
}
function Hd(e, t = {}) {
  ...
  const n = [];
  let s = wo(e.state?.metadata?.viewport_labels);
  function i(p) {
    if (!n[p]) {
  ...
  function l() {
    ...
    let u = 0;
    for (const y of b) {
      if (!Wr(y, { mode: s.mode, selectedIds: d })) continue;
      const g = Vr(y, s.content);
      if (!g) continue;
      const v = Hr(b, y, h) || {
        position: y.position,
        size: y.size
      }, j = e.webgl.projectWorldToScreen(Ur(v, y.type));
      if (!j || j.behind) continue;
      const x = i(u);
      u += 1, x.hidden = !1, x.textContent = g, x.style.transform = `translate(-50%, -100%) translate(${Math.round(j.x)}px, ${Math.round(j.y)}px)`;
      const A = s.content === "annotation" ? y.annotation?.color : "";
      x.style.setProperty("--oc-label-accent", A || ""), x.classList.toggle("is-annotation", s.content === "annotation" && !!A);
    }
    for (let y = u; y < n.length; y += 1) n[y].hidden = !0;
  }
  function m(p) {
    s = wo({ ...s, ...p }), e.state.metadata = { ...e.state.metadata || {}, viewport_labels: { ...s } }, e.serialize?.(), l();
  }
  return l(), {
    update: l,
    get settings() {
...
function Ud(e) {
  ...
  return {
    ...
    getRigInfo(a) {
      const o = e.state?.objects?.find((i) => i.id === a) || null, n = t(a), s = So(n);
      return {
        objectId: a,
...
function Gd(e, t) {
  const a = (o) => [`<option value="">${r("— unmapped —")}</option>`].concat(
    e.map(
      (n) => `<option value="${yr(n)}"${n === o ? " selected" : ""}>${yr(n)}</option>`
    )
  ).join("");
  return Xr.map((o) => {
...
function Xd(e, t = {}) {
  const a = e.root, o = t.apiClient || No({
  ...
  let c = null, l = {};
  const m = () => e.state?.objects?.find((g) => g.id === c) || null, p = () => e.webgl?.getModelBoneNames?.(c) || [];
  function f() {
    if (!i) return;
    const g = Jo(l);
    lo(l) ? (i.textContent = r("Humanoid v1 ✓ — all 22 joints mapped"), i.dataset.state = "ok") : (i.textContent = r("Incomplete — {n} joint(s) unmapped").replace("{n}", g.length), i.dataset.state = "warn");
  }
  function d() {
  ...
  function h() {
    ...
    g.id !== c && (c = g.id, n.open = !0, l = {}, g.asset_id ? o.get(g.asset_id).then((j) => {
      c === g.id && (l = { ...j?.asset?.rig?.bone_map || {} }, d());
    }).catch(() => d()) : d());
  }
  function b(g) {
    const v = g.target.closest("[data-rig-joint]");
    if (!v) return;
    const j = v.dataset.rigJoint;
    v.value ? l[j] = v.value : delete l[j], d();
  }
  function u(g) {
    const v = g.target.closest("[data-rig-act]")?.dataset.rigAct;
    v === "auto" ? (l = So(p()), d()) : v === "validate" ? (d(), e.setStatus?.(lo(l) ? r("Rig is complete") : r("Rig still missing: {list}").replace("{list}", Jo(l).join(", ")))) : v === "save" && y();
  }
  async function y() {
    const g = m();
    if (!g?.asset_id) {
    ...
    try {
      const v = await o.patch(g.asset_id, {
        rig: { profile: Qo, bone_map: l }
      });
      g.character = {
        ...g.character || {},
        rig_profile: lo(l) ? Qo : null
      }, e.assetBrowser?.store?.upsert?.(v.asset), e.checkpoint?.("Save rig mapping"), e.serialize?.(), e.refreshObjects?.(), e.refreshInspector?.(), e.setStatus?.(r("Rig mapping saved"));
    } catch (v) {
      e.setStatus?.(v.message || r("Could not save the rig mapping"));
    }
  }
  return s?.addEventListener("change", b), n.addEventListener("click", u), h(), {
    sync: h,
    get boneMap() {
      return { ...l };
    },
    dispose() {
      s?.removeEventListener("change", b), n.removeEventListener("click", u);
    }
  };
}
function Yd(e, t = {}) {
  ...
  function s(c) {
    let l = n.get(c);
    return l || (l = document.createElement("button"), l.type = "button", l.className = "oc-rig-dot", l.dataset.joint = c, l.title = c, l.addEventListener("click", (m) => {
      m.stopPropagation(), t.onPick?.(c);
  ...
  function i() {
    ...
    o.hidden = !1;
    const { objectId: l, boneMap: m, selectedJoint: p } = c, f = e.characterRuntime, d = /* @__PURE__ */ new Set();
    for (const h of Xr) {
      const b = m?.[h];
      if (!b) continue;
      const u = f?.getJointWorldTransform?.(l, h, m) || e.webgl.resolveModelBone?.(l, b);
      if (!u?.world) continue;
      const y = e.webgl.projectWorldToScreen(u.world);
      if (!y || y.behind) continue;
      const g = s(h);
      g.hidden = !1, g.classList.toggle("selected", h === p), g.style.transform = `translate(-50%, -50%) translate(${Math.round(y.x)}px, ${Math.round(y.y)}px)`, d.add(h);
    }
    for (const [h, b] of n) d.has(h) || (b.hidden = !0);
  }
  return i(), {
    update: i,
    dispose() {
...
function Jd(e, t = {}) {
  const a = e.root, o = t.apiClient || No({
    fetchApi: (w, _) => (e.api || e.app?.api).fetchApi(w, _)
  }), n = a.querySelector('[data-role="pose-editor"]');
  if (!n) return { sync() {
  }, update() {
  }, dispose() {
  } };
  const s = n.querySelector('[data-role="pose-preset"]'), i = n.querySelector('[data-pose-act="edit"]'), c = n.querySelector('[data-role="pose-joint-row"]'), l = n.querySelector('[data-role="pose-joint-name"]'), m = ["x", "y", "z"].map((w) => n.querySelector(`[data-role="pose-rot-${w}"]`));
  let p = null, f = !1, d = /* @__PURE__ */ new Map();
  const h = () => e.state?.objects?.find((w) => w.id === p) || null, b = () => e.rigMapper?.boneMap && Object.keys(e.rigMapper.boneMap).length ? e.rigMapper.boneMap : null, u = () => e.subSelection?.type === "character_joint" && e.subSelection.objectId === p ? e.subSelection.jointId : null;
  function y(w) {
    const _ = er({ ...w, preset_id: w.id });
    return { id: w.id, name: w.name || w.id, root_offset: _.root_offset, joints: _.joints };
  }
  function g(w) {
    const _ = d.get(w?.pose?.preset_id) || null;
    return ls({ preset: _, overrides: w?.pose }).joints;
  }
  function v() {
    const w = h();
    !w?.character || !b() || e.webgl?.applyCharacterPose?.(p, b(), f || w.character.pose?.joints ? g(w.character) : {});
  }
  function j() {
    const w = u(), _ = f && !!w;
    if (c && (c.hidden = !_), !_) return;
    l && (l.textContent = w);
    const z = h(), N = g(z?.character)[w] || [0, 0, 0, 1], q = ds(N);
    m.forEach((M, W) => {
      M && document.activeElement !== M && (M.value = String(Math.round(q[W] * 100) / 100));
    });
  }
  function x() {
    const w = h(), _ = !!w?.character?.motion;
    if (i && (i.classList.toggle("active", f), i.disabled = _, i.title = _ ? r("Clear the motion clip to edit the pose") : r("Toggle FK pose editing")), s) {
      const z = [["neutral", r("Standing Neutral")]].concat([...d.values()].filter((q) => q.id !== "neutral").map((q) => [q.id, q.name || q.id])), N = z.map((q) => q.join(":")).join("|");
      s.dataset.sig !== N && (s.dataset.sig = N, s.replaceChildren(...z.map(([q, M]) => {
        const W = document.createElement("option");
        return W.value = q, W.textContent = M, W;
  ...
  async function A() {
    try {
      ...
      d = new Map((w.poses || []).filter((_) => _?.id).map((_) => [_.id, y(_)]));
    } catch {
      d = /* @__PURE__ */ new Map();
    }
  ...
  function P() {
    const w = u();
    if (!w) return;
    const _ = m.map((q) => Number(q?.value) || 0), z = cs(_), N = e.directorApi?.execute({
      version: 1,
    ...
    N && !N.ok && e.setStatus?.(N.error?.message || r("Could not set the joint")), x();
  }
  function D() {
    const w = s?.value || "neutral", _ = d.get(w) || er({ preset_id: w });
    e.directorApi?.execute({
      version: 1,
      id: `tx_preset_${Date.now().toString(36)}`,
      description: "Pose preset",
      operations: [{ type: "character.set_pose", objectId: p, pose: { preset_id: w, root_offset: _.root_offset, joints: {} } }]
    }), x();
  }
  async function F() {
    const w = h();
    if (!w?.character) return;
    const _ = (await wt(e, r("Save Pose"), r("Pose name"), ""))?.trim();
    if (!_ || e.disposed) return;
    const z = _.toLowerCase().replace(Zd, "-").replace(/^-+|-+$/g, "").slice(0, 60) || "pose";
    try {
      const N = await o.savePose({
        id: z,
        name: _,
        profile: "omnicam_humanoid_v1",
        root_offset: w.character.pose?.root_offset || [0, 0, 0],
        joints: g(w.character)
      });
      d.set(N.pose.id, y(N.pose)), e.setStatus?.(r("Pose saved: {name}").replace("{name}", _)), x();
    } catch (N) {
      e.setStatus?.(N.message || r("Could not save the pose"));
    }
  }
  function U() {
    const w = h();
    !w?.character || w.character.motion || (f = !f, !f && e.subSelection?.type === "character_joint" && (e.subSelection = null), x(), e.rigOverlay?.update?.());
  }
  function B(w) {
    f && (e.subSelection = { type: "character_joint", objectId: p, jointId: w }, x(), e.rigOverlay?.update?.());
  }
  const V = Yd(e, {
    onPick: B,
    isActive: () => f && p && b() ? { objectId: p, boneMap: b(), selectedJoint: u() } : null
  });
  e.rigOverlay = V;
  function Q() {
    const w = e.selectedObject?.(), _ = w?.asset_kind === "character";
    if (n.hidden = !_, !_) {
      f && (f = !1), p = null, V.update();
      return;
    }
    w.id !== p && (p = w.id, f = !1, e.subSelection?.type === "character_joint" && (e.subSelection = null), d.size || A()), x(), V.update();
  }
  s?.addEventListener("change", D), i?.addEventListener("click", U), n.querySelector('[data-pose-act="save"]')?.addEventListener("click", F);
  for (const w of m)
    w?.addEventListener("change", P), w?.addEventListener("input", P);
  return A(), {
    sync: Q,
    update() {
      V.update(), v();
    ...
    dispose() {
      V.dispose(), s?.removeEventListener("change", D), i?.removeEventListener("click", U);
      for (const w of m)
        w?.removeEventListener("change", P), w?.removeEventListener("input", P);
    }
  };
}
function vr(e, t) {
...
function Qd(e) {
  ...
  const a = (g) => t.querySelector(`[data-role="${g}"]`), o = a("motion-clip"), n = a("motion-start"), s = a("motion-end"), i = a("motion-speed"), c = a("motion-loop"), l = t.querySelector('[data-motion-act="bake"]');
  let m = null;
  const p = () => e.state?.objects?.find((g) => g.id === m) || null, f = () => e.modelInfoById?.get(m)?.animationNames || [];
  function d() {
    const g = o?.value || "";
    return g ? Gr({
      clip_id: g,
  ...
  function h() {
    const g = d(), v = g ? { type: "character.set_motion", objectId: m, motion: g } : { type: "character.clear_motion", objectId: m }, j = e.directorApi?.execute({
      version: 1,
      id: `tx_motion_${Date.now().toString(36)}`,
      description: "Character motion",
      operations: [v]
    });
    j && !j.ok && e.setStatus?.(j.error?.message || r("Could not set the motion")), e.poseEditor?.sync?.(), b();
  }
  function b() {
    const g = p(), v = f(), j = g?.character?.motion || null;
    if (o) {
      const A = v.join("|");
      o.dataset.sig !== A && (o.dataset.sig = A, o.replaceChildren(
        vr("", v.length ? r("No motion (static)") : r("No clips in this model")),
        ...v.map((P) => vr(P, P))
      )), document.activeElement !== o && (o.value = j?.clip_id || ""), o.disabled = !v.length;
    }
    ho(n, j?.start_frame ?? 0), ho(s, j?.end_frame ?? 0), ho(i, j?.speed ?? 1), c && document.activeElement !== c && (c.checked = j ? j.loop !== !1 : !0);
    const x = !!j;
    for (const A of [n, s, i, c]) A && (A.disabled = !x);
    l && (l.disabled = !x);
  }
  function u() {
    const g = p(), v = e.rigMapper?.boneMap;
    if (!g?.character || !v || !Object.keys(v).length) {
      e.setStatus?.(r("Map the rig before baking a pose"));
      return;
    }
    const j = e.characterRuntime?.sampleCanonicalPose?.(m, v) || {};
    e.directorApi?.execute({
      version: 1,
      id: `tx_bake_${Date.now().toString(36)}`,
      description: "Bake frame to pose",
      operations: [
        { type: "character.clear_motion", objectId: m },
        {
          type: "character.set_pose",
          objectId: m,
          pose: { preset_id: "neutral", root_offset: g.character.pose?.root_offset || [0, 0, 0], joints: j }
        }
      ]
    }), e.setStatus?.(r("Baked current frame to pose")), b(), e.poseEditor?.sync?.();
  }
  function y() {
    const g = e.selectedObject?.(), v = g?.asset_kind === "character";
    if (t.hidden = !v, !v) {
  ...
  for (const g of [n, s, i, c]) g?.addEventListener("change", h);
  return l?.addEventListener("click", u), {
    sync: y,
    dispose() {
      o?.removeEventListener("change", h);
      for (const g of [n, s, i, c]) g?.removeEventListener("change", h);
...
function Cn(e) {
  return {
    ...
    frames: Me(e, "frame"),
    scrubs: Me(e, "scrub"),
    cameraFov: Me(e, "camera-fov"),
    cameraRoll: Me(e, "camera-roll"),
    cameraFocal: Me(e, "camera-focal"),
    viewportZoom: Me(e, "viewport-zoom"),
    cameraType: Me(e, "camera-type"),
    cameraNear: Me(e, "camera-near"),
    cameraFar: Me(e, "camera-far")
  };
}
...
function om({
  ...
  const p = m ? m() : new e.Object3D(), f = l ? l(t, a) : new Hc(t, a);
  let d = null;
  o?.add && (d = typeof f.getHelper == "function" ? f.getHelper() : f, o.add(d), o.add(p));
  let h = null, b = null, u = !1, y = null, g = [0, 0, 0];
  function v() {
    return {
      position: xr(p.position),
  ...
  function A(C) {
    if (!b) return { position: [0, 0, 0], rotationDeg: [0, 0, 0], scaleFactors: [1, 1, 1] };
    const R = C.rotationDeg.map((G, ae) => {
      const oe = y ? y[ae] : b.rotationDeg[ae];
      return g[ae] += x(G - oe), g[ae];
    });
    return y = C.rotationDeg, {
      position: C.position.map((G, ae) => G - b.position[ae]),
      rotationDeg: R,
      scaleFactors: C.scale.map((G, ae) => b.scale[ae] === 0 ? 1 : G / b.scale[ae])
    };
  }
  function P() {
    b = v(), y = null, g = [0, 0, 0], n?.({ targetSpec: h });
  }
  function D() {
    if (!b) return;
    const C = v();
  ...
  f.addEventListener?.("mouseDown", P), f.addEventListener?.("objectChange", D), f.addEventListener?.("mouseUp", F), f.addEventListener?.("dragging-changed", U);
  function B(C) {
    h = C, p.position.set(...C.position || [0, 0, 0]);
    const R = C.rotation || [0, 0, 0];
    p.rotation.set(R[0] / Ae, R[1] / Ae, R[2] / Ae), p.scale.set(...C.scale || [1, 1, 1]), f.attach(p), f.visible = !0;
  }
  function V() {
  ...
  function W() {
    f.removeEventListener?.("mouseDown", P), f.removeEventListener?.("objectChange", D), f.removeEventListener?.("mouseUp", F), f.removeEventListener?.("dragging-changed", U), o?.remove && d && o.remove(d), o?.remove && o.remove(p), f.dispose?.(), h = null, b = null;
  }
  return {
    attach: B,
    detach: V,
...
function nm(e, { controlsFactory: t, anchorFactory: a } = {}) {
  ...
  function l(w) {
    if (!o) return;
    const _ = w || e.state.spatial_snap_mode === "grid";
    o.setTranslationSnap(_ ? Math.max(0.01, Number(e.state.spatial_grid_size) || 0.5) : null), o.setRotationSnap(_ ? Math.PI / 12 : null), o.setScaleSnap(_ ? 0.1 : null);
  }
  function m(w) {
    c = !!(w.ctrlKey || w.metaKey), o?.isDragging?.() && l(c);
  }
  function p() {
    s || typeof window > "u" || (s = !0, window.addEventListener("keydown", m, !0), window.addEventListener("keyup", m, !0));
  }
  function f() {
    s && (s = !1, window.removeEventListener("keydown", m, !0), window.removeEventListener("keyup", m, !0));
  }
  function d() {
  ...
  function h({ targetSpec: w }) {
    if (w) {
      if (l(c), w.type === "object") {
        e.checkpoint("Transform object");
        const _ = ps(e), z = (_.length ? _ : [w.object]).map((q) => ({
          object: q,
          transform: Ie(q)
        }));
        for (const q of z) e.beginObjectEdit(q.object);
        const N = z.reduce((q, M) => ye(q, M.transform.position), [0, 0, 0]).map((q) => q / z.length);
        n = { type: "object", group: z, pivot: N };
        return;
      }
      if (w.type === "camera") {
      ...
      if (w.type === "camera_target") {
        ...
        const _ = e.activeCameraTrack?.(), z = !!_?.target_object_id;
        n = {
          type: "camera_target",
          tracking: z,
          base: z ? [..._.target_offset || [0, 0, 0]] : [...e.camera.target]
        };
        return;
      }
      if (w.type === "camera_path") {
        const _ = w.track;
        if (!_ || _.locked || !(_.keyframes?.length >= 1)) return;
        e.checkpoint("Transform camera path"), n = {
          type: "camera_path",
          trackId: _.id,
          origin: Yr(_.keyframes),
          baseKeys: _.keyframes.map((z) => ({ ...z, camera: le(z.camera) }))
        };
        return;
      }
      if (w.type === "path_point" || w.type === "path_group") {
        const _ = w.track;
        if (!_ || _.locked) return;
        ...
        e.checkpoint(w.type === "path_point" ? "Transform path point" : "Transform path selection"), n = {
          ...
          baseKeys: _.keyframes.map((N) => ({ ...N, camera: le(N.camera) })),
          lookAtActive: Zr(_, e.state.objects)
        };
        return;
      }
      if (w.type === "path_point_target") {
        const _ = w.track;
        if (!_ || _.locked || w.readOnly) return;
  ...
  function b(w) {
    const _ = e.state.gizmo_mode;
    return _ === "translate" ? { mode: _, delta: w.position } : _ === "scale" ? { mode: _, origin: n.origin, factors: w.scaleFactors } : { mode: _, origin: n.origin, rotationDeg: w.rotationDeg };
  }
  function u(w) {
  ...
  function y(w) {
    const _ = e.state.cameras.find((z) => z.id === n.trackId);
    _ && (_.keyframes = Jr(n.baseKeys, b(w)), u(_));
  }
  function g(w) {
    const _ = e.state.cameras.find((N) => N.id === n.trackId);
    if (!_) return;
    const z = { ...b(w), lookAtActive: n.lookAtActive };
    _.keyframes = hs(n.baseKeys, n.selectedFrames, z), u(_);
  }
  function v(w) {
    const _ = e.state.cameras.find((z) => z.id === n.trackId);
    _ && (_.keyframes = bs(n.baseKeys, [n.frame], { delta: w.position }), u(_));
  }
  function j({ delta: w }) {
    n && (n.type === "object" ? x(w) : n.type === "camera" ? A(w) : n.type === "camera_target" ? P(w) : n.type === "camera_path" ? y(w) : n.type === "path_point" || n.type === "path_group" ? g(w) : n.type === "path_point_target" && v(w), e.render());
  }
  function x(w) {
    const { group: _, pivot: z } = n, N = e.state.gizmo_mode;
    for (const q of _)
      if (N === "translate")
        q.object.position = ye(q.transform.position, w.position);
      else if (N === "rotate")
        q.object.position = ye(z, tr(Ee(q.transform.position, z), w.rotationDeg)), q.object.rotation = ye(q.transform.rotation, w.rotationDeg);
      else if (N === "scale") {
        const M = Ee(q.transform.position, z);
        q.object.position = ye(z, M.map((W, C) => W * w.scaleFactors[C])), q.object.size = q.transform.size.map((W, C) => Math.max(0.01, W * w.scaleFactors[C]));
      }
    for (const q of _) e.commitObjectEdit(q.object);
  }
  function A(w) {
    if (e.state.gizmo_mode === "translate")
      e.camera.position = ye(n.position, w.position);
    else {
      const _ = Ee(n.target, n.position);
      e.camera.target = ye(n.position, tr(_, w.rotationDeg));
    }
    e.commitCameraEdit();
  }
  function P(w) {
    const _ = ye(n.base, w.position);
    n.tracking ? fs(e, _) : e.camera.target = _, e.commitCameraEdit();
  }
  function D({ cancelled: w }) {
    if (!n) return;
    const _ = n.type;
    w ? (e.undo(), (_ === "camera" || _ === "camera_target") && e.finishCameraEdit()) : _ === "camera" || _ === "camera_target" ? e.finishCameraEdit() : (e.editingKeyFrame = null, e.updateKeyVisualState?.(), e.drawCurveEditor?.()), n = null, e.refreshInspector(), e.render();
  }
  function F() {
    if (!e.webgl || !e.interactionElement) return;
    const w = e.recording ? null : ms(e), _ = e.state.gizmo_mode || "translate", z = !!w && !w.readOnly && rm.has(w.type) && w.allowedModes.includes(_);
    if (i = z ? w.type : null, !z) {
      o?.detach();
      return;
    }
    d() && (o.isDragging() || (o.setCamera(e.webgl.activeCamera), o.setMode(_), o.setSpace(e.state.gizmo_space === "local" ? "local" : "world"), o.attach(w)));
  }
  function U() {
  ...
  return { sync: F, isPointerOverHandle: U, cancelDrag: B, currentLiveType: V, dispose: Q };
}
function sm(e, t) {
  e.checkpoint(`Apply preset: ${t}`);
  const a = e.activeCameraTrack(), o = ol(t, {
...
function im(e, t) {
  ...
  const o = al(a, { type: t, intensity: 1, duration_frames: e.state.duration_frames });
...
const kr = ["#4aa3ef", "#f2a93b", "#48c774", "#b565d8", "#ec4899"], Oe = [4, 8, 12, 20, 35, 60, 100];
function tt(e) {
...
function ro(e, t, a) {
  ...
  const o = tt(e), n = o.expanded ? 220 : 138, s = Math.min(n, Math.max(80, Math.min(t, a) - 20)), i = 10, c = Math.max(0, t - s - i), l = Math.max(0, a - s - i), m = e.viewportCamera(), p = m?.position || [0, 1.5, 5], f = m?.target || [0, 0, 0], d = e.activeCameraTrack?.(), h = e.state.cameras?.length ? e.state.cameras : d ? [d] : [], b = h.flatMap(
    (A) => (A.keyframes || []).map((P) => P.camera?.position).filter(Boolean)
  );
  let u = 12;
  if (o.rangeIndex >= 0 && o.rangeIndex < Oe.length)
    u = Oe[o.rangeIndex];
  else {
    const A = Math.max(
      Math.abs(p[0] || 0),
      ...
      Math.abs(f[0] || 0),
      Math.abs(f[2] || 0),
      ...b.flatMap((P) => [Math.abs(P[0] || 0), Math.abs(P[2] || 0)]),
      4
    );
    u = Math.max(6, Math.ceil((A + 1.5) / 4) * 4);
  }
  const y = c + s / 2, g = l + s / 2, v = s / 2 - 12, j = v / u, x = o.centerMode === "camera" ? [p[0] || 0, p[2] || 0] : [0, 0];
  return {
    rx: c,
    ry: l,
    radarSize: s,
...
function pm(e, t, a, o) {
  const n = ro(e, a, o);
  if (!n) return;
  const { rx: s, ry: i, radarSize: c, cx: l, cy: m, innerRadius: p, range: f, scale: d, camPos: h, camTgt: b, cameras: u, activeTrack: y } = n, g = tt(e), v = e.state.active_camera_id || y?.id, j = (ee, se) => _n(n, ee, se);
  ...
  const x = t.createRadialGradient(l, m, 2, l, m, p);
  x.addColorStop(0, "rgba(0, 210, 211, 0.06)"), x.addColorStop(1, "rgba(0, 0, 0, 0)"), t.fillStyle = x, t.fillRect(s, i, c, c), t.strokeStyle = "rgba(0, 210, 211, 0.38)", t.lineWidth = 1.2, t.strokeRect(s, i, c, c);
  const A = [0.33, 0.66, 1];
  t.strokeStyle = "rgba(0, 210, 211, 0.12)", t.lineWidth = 1;
  for (const ee of A) {
    const se = p * ee;
    t.beginPath(), t.arc(l, m, se, 0, Math.PI * 2), t.stroke(), c >= 120 && (t.font = "8px monospace", t.fillStyle = "rgba(0, 210, 211, 0.35)", t.textAlign = "left", t.fillText(`${Math.round(f * ee)}m`, l + se + 2, m - 2));
  }
  t.strokeStyle = "rgba(255, 255, 255, 0.10)", t.beginPath(), t.moveTo(s + 6, m), t.lineTo(s + c - 6, m), t.moveTo(l, i + 6), t.lineTo(l, i + c - 6), t.stroke(), t.font = "bold 9px sans-serif", t.textAlign = "center", t.textBaseline = "middle", t.fillStyle = "#f43f5e", t.fillText("N", l, i + 9), t.fillStyle = "rgba(255, 255, 255, 0.4)", t.fillText("S", l, i + c - 9), t.fillText("W", s + 9, m), t.fillText("E", s + c - 9, m);
  for (const ee of e.state.objects || []) {
    if (ee.enabled === !1) continue;
    const se = Po(e.state.objects, ee).position || [0, 0, 0], [fe, de] = j(se[0], se[2]);
    if (fe < s + 3 || fe > s + c - 3 || de < i + 3 || de > i + c - 3) continue;
    const he = e.selectedObjectId === ee.id || e.selectedObjectIds?.has?.(ee.id);
    if (t.save(), t.translate(fe, de), ee.type === "card") {
      const be = (ee.rotation?.[1] || 0) * Math.PI / 180;
      t.rotate(-be), t.fillStyle = he ? "#a855f7" : "#38bdf8", t.fillRect(-4, -1.2, 8, 2.4), t.strokeStyle = he ? "#ffffff" : "rgba(255,255,255,0.6)", t.lineWidth = 1, t.strokeRect(-4, -1.2, 8, 2.4);
    } else if (ee.type === "light") {
      t.fillStyle = he ? "#a855f7" : "#fbbf24", t.beginPath(), t.arc(0, 0, 3, 0, Math.PI * 2), t.fill(), t.strokeStyle = "#fbbf24", t.lineWidth = 1;
      for (let be = 0; be < 4; be++) {
        const O = be * Math.PI / 2;
        t.beginPath(), t.moveTo(Math.cos(O) * 4, Math.sin(O) * 4), t.lineTo(Math.cos(O) * 6, Math.sin(O) * 6), t.stroke();
      }
    } else
      t.fillStyle = he ? "#a855f7" : ee.type === "human" ? "#ec4899" : "#f59e0b", t.beginPath(), t.arc(0, 0, 2.8, 0, Math.PI * 2), t.fill();
    he && (t.strokeStyle = "#a855f7", t.lineWidth = 1.2, t.beginPath(), t.arc(0, 0, 6, 0, Math.PI * 2), t.stroke()), t.restore();
  }
  for (let ee = 0; ee < u.length; ee++) {
    const se = u[ee], fe = se.keyframes || [], de = se.id === v, he = se.color || kr[ee % kr.length];
    t.save(), t.strokeStyle = he, t.globalAlpha = de ? 0.95 : 0.4, t.lineWidth = de ? 2 : 1, t.setLineDash(de ? [] : [2, 2]), t.beginPath();
    let be = !1;
    const O = fe[0]?.frame, H = fe[fe.length - 1]?.frame;
    for (let ie = O; Number.isFinite(ie) && ie <= H; ie++) {
      const ce = xe(se, ie, e.state.objects)?.position;
      if (!Array.isArray(ce)) continue;
      const [me, re] = j(ce[0], ce[2]);
      be ? t.lineTo(me, re) : (t.moveTo(me, re), be = !0);
    }
    be && t.stroke(), t.restore(), t.save();
    for (const ie of fe) {
      ...
      t.fillStyle = ke ? "#ffffff" : he, t.globalAlpha = de ? 0.95 : 0.6, t.beginPath(), t.moveTo(me, re - 3), t.lineTo(me + 3, re), t.lineTo(me, re + 3), t.lineTo(me - 3, re), t.closePath(), t.fill(), ke && (t.strokeStyle = "#00d2d3", t.lineWidth = 1.2, t.stroke());
    }
    t.restore();
  }
  const [P, D] = j(h[0] || 0, h[2] || 0), [F, U] = j(b[0] || 0, b[2] || 0), B = 8, V = Z(P, s + B, s + c - B), Q = Z(D, i + B, i + c - B), w = Z(F, s + B, s + c - B), _ = Z(U, i + B, i + c - B), z = h[1] || 0, N = dm(z), q = mm(z);
  t.strokeStyle = "rgba(255, 255, 255, 0.40)", t.lineWidth = 1, t.setLineDash([3, 3]), t.beginPath(), t.moveTo(V, Q), t.lineTo(w, _), t.stroke(), t.setLineDash([]), t.fillStyle = "#ffffff", t.beginPath(), t.arc(w, _, 2.5, 0, Math.PI * 2), t.fill(), t.strokeStyle = "rgba(255, 255, 255, 0.7)", t.lineWidth = 1, t.beginPath(), t.arc(w, _, 4.5, 0, Math.PI * 2), t.stroke();
  const M = b[0] - h[0], W = b[2] - h[2], C = Math.atan2(W, M), G = (e.viewportCamera().fov || 35) * Math.PI / 360, ae = Z(24 * (d / (p / 8)), 16, 38), oe = t.createRadialGradient(V, Q, 2, V, Q, ae);
  oe.addColorStop(0, N + "55"), oe.addColorStop(1, N + "08"), t.fillStyle = oe, t.strokeStyle = N, t.lineWidth = 1.2, t.beginPath(), t.moveTo(V, Q), t.lineTo(V + Math.cos(C - G) * ae, Q + Math.sin(C - G) * ae), t.arc(V, Q, ae, C - G, C + G), t.closePath(), t.fill(), t.stroke(), t.fillStyle = N + "44", t.beginPath(), t.arc(V, Q, 6.5, 0, Math.PI * 2), t.fill(), t.fillStyle = N, t.beginPath(), t.arc(V, Q, 3.5, 0, Math.PI * 2), t.fill(), t.strokeStyle = "#ffffff", t.lineWidth = 1.5, t.beginPath(), t.moveTo(V, Q), t.lineTo(V + Math.cos(C) * 7, Q + Math.sin(C) * 7), t.stroke(), fm(e, t, n, N, q, C, Math.hypot(M, W)), g.hover && hm(t, n, g.hover), t.restore();
}
function fm(e, t, a, o, n, s, i) {
  const { rx: c, ry: l, radarSize: m } = a, p = tt(e);
  t.fillStyle = "rgba(15, 23, 42, 0.75)", t.fillRect(c, l, m, 18), t.strokeStyle = "rgba(0, 210, 211, 0.2)", t.lineWidth = 1, t.beginPath(), t.moveTo(c, l + 18), t.lineTo(c + m, l + 18), t.stroke(), t.font = "bold 9px sans-serif", t.fillStyle = "#00d2d3", t.textAlign = "left", t.textBaseline = "middle", t.fillText("RADAR", c + 6, l + 9);
  const f = l + 3, d = 12;
  qa(t, c + 44, f, 12, d, "−", p.hover?.button === "zoom_out"), qa(t, c + 58, f, 12, d, "+", p.hover?.button === "zoom_in");
  const h = p.centerMode === "camera" ? "CAM" : "CTR";
  qa(t, c + 72, f, 22, d, h, p.hover?.button === "center");
  const b = p.expanded ? "⤡" : "⤢";
  qa(t, c + 96, f, 14, d, b, p.hover?.button === "size"), t.font = "bold 8.5px monospace", t.fillStyle = o, t.textAlign = "right", t.fillText(`Y:${n}`, c + m - 5, l + 9), t.fillStyle = "rgba(15, 23, 42, 0.70)", t.fillRect(c, l + m - 15, m, 15), t.strokeStyle = "rgba(0, 210, 211, 0.15)", t.beginPath(), t.moveTo(c, l + m - 15), t.lineTo(c + m, l + m - 15), t.stroke();
  const u = Math.round((s * 180 / Math.PI + 360) % 360);
  t.font = "8px monospace", t.fillStyle = "rgba(255, 255, 255, 0.55)", t.textAlign = "left", t.fillText(`HDG:${u}°`, c + 5, l + m - 7), t.textAlign = "right", t.fillText(`DIST:${i.toFixed(1)}m`, c + m - 5, l + m - 7);
}
function qa(e, t, a, o, n, s, i) {
...
function hm(e, t, a) {
  ...
  const i = e.measureText(a.text).width + 12, c = 16, l = Z(a.px - i / 2, o + 4, o + s - i - 4), m = a.pz > t.cy ? a.pz - 22 : a.pz + 8;
  e.fillStyle = "rgba(15, 23, 42, 0.94)", e.fillRect(l, m, i, c), e.strokeStyle = "#00d2d3", e.lineWidth = 1, e.strokeRect(l, m, i, c), e.fillStyle = "#ffffff", e.textAlign = "center", e.textBaseline = "middle", e.fillText(a.text, l + i / 2, m + c / 2);
}
function En(e, t, a) {
...
function $n(e, t, a, o) {
  const { camPos: n, camTgt: s, cameras: i, rx: c, ry: l, radarSize: m } = t, p = (y, g) => _n(t, y, g), [f, d] = p(n[0] || 0, n[2] || 0);
  if (Math.hypot(a - f, o - d) <= 8)
    return { type: "camera", pos: n };
  const [h, b] = p(s[0] || 0, s[2] || 0);
  ...
  if (u)
    for (const y of u.keyframes || []) {
      ...
      if (!g) continue;
      const [v, j] = p(g[0], g[2]);
      if (Math.hypot(a - v, o - j) <= 6)
        return { type: "keyframe", key: y, frame: y.frame };
    }
  for (const y of e.state.objects || []) {
    if (y.enabled === !1) continue;
    const g = Po(e.state.objects, y).position || [0, 0, 0], [v, j] = p(g[0], g[2]);
    if (Math.hypot(a - v, o - j) <= 7)
...
function bm(e, t, a, o) {
  ...
  const n = ro(e, e.canvas.width, e.canvas.height);
  if (!n) return !1;
  const { rx: s, ry: i, radarSize: c } = n;
  if (a < s || a > s + c || o < i || o > i + c)
    return !1;
  t.preventDefault?.(), t.stopPropagation?.();
  const l = tt(e), m = En(n, a, o);
  if (m)
    return m === "zoom_in" ? (l.rangeIndex === -1 && (l.rangeIndex = Oe.findIndex((h) => h >= n.range), l.rangeIndex < 0 && (l.rangeIndex = Oe.length - 1)), l.rangeIndex = Math.max(0, (l.rangeIndex === -1 ? 2 : l.rangeIndex) - 1)) : m === "zoom_out" ? (l.rangeIndex === -1 && (l.rangeIndex = Oe.findIndex((h) => h >= n.range), l.rangeIndex < 0 && (l.rangeIndex = 0)), l.rangeIndex = Math.min(Oe.length - 1, l.rangeIndex + 1)) : m === "center" ? l.centerMode = l.centerMode === "camera" ? "origin" : "camera" : m === "size" && (l.expanded = !l.expanded), e.render?.(), !0;
  const p = $n(e, n, a, o);
  if (p) {
    if (p.type === "camera")
...
function um(e, t, a, o) {
  ...
  const n = ro(e, e.canvas.width, e.canvas.height);
  if (!n) return !1;
  const s = tt(e), { rx: i, ry: c, radarSize: l } = n, m = a >= i && a <= i + l && o >= c && o <= c + l;
  if (s.drag) {
    const [u, y] = _o(n, a, o), g = e.viewportCamera();
    return s.drag.type === "camera" ? g.position = [u, g.position?.[1] || 1.5, y] : s.drag.type === "target" && (g.target = [u, g.target?.[1] || 0, y]), e.setFrame?.(e.frame, !1, !1), e.render?.(), !0;
  }
  if (!m)
    return s.hover && (s.hover = null, e.render?.()), !1;
  const p = En(n, a, o), f = $n(e, n, a, o), [d, h] = _o(n, a, o);
  let b = `[${d.toFixed(1)}m, ${h.toFixed(1)}m]`;
  return p === "zoom_in" ? b = r("Zoom in (+)") : p === "zoom_out" ? b = r("Zoom out (−)") : p === "center" ? b = s.centerMode === "camera" ? r("Center: Cam") : r("Center: World") : p === "size" ? b = s.expanded ? r("Compact mode") : r("Expand radar") : f?.type === "camera" ? b = r("Camera (drag to move)") : f?.type === "target" ? b = r("Look-At Target (drag to move)") : f?.type === "keyframe" ? b = `${r("Keyframe")} F${f.frame}` : f?.type === "object" && (b = f.object.name || f.object.type || r("Object")), s.hover = {
    button: p,
    hit: f,
    px: a,
    pz: o,
...
function gm(e, t, a, o) {
  ...
  if (a < s || a > s + c || o < i || o > i + c)
    return !1;
  t.preventDefault?.(), t.stopPropagation?.();
  const l = tt(e), m = Math.sign(t.deltaY || 0);
  return l.rangeIndex === -1 && (l.rangeIndex = Oe.findIndex((p) => p >= n.range), l.rangeIndex < 0 && (l.rangeIndex = 2)), m > 0 ? l.rangeIndex = Math.min(Oe.length - 1, l.rangeIndex + 1) : m < 0 && (l.rangeIndex = Math.max(0, l.rangeIndex - 1)), e.render?.(), !0;
}
function ym(e, t, a) {
  ...
  const o = () => {
    ...
    const h = gs(t('[data-role="object-tags"]')?.value || "");
    h.length ? d.tags = h : delete d.tags;
    const b = String(t('[data-role="object-annotation"]')?.value || "").trim(), u = b ? ys({
      text: b,
  ...
  }, { signal: a }), fl(e, a), Rl(e, a), t('[data-role="curve-group"]')?.addEventListener("change", () => {
    e.setChannelFilter("all"), gn(e), e.drawCurveEditor(), Ko(e);
  ...
  n && (n.addEventListener("pointerdown", (d) => e.onCurvePointerDown(d), { signal: a }), n.addEventListener("pointermove", (d) => e.onCurvePointerMove(d), { signal: a }), n.addEventListener("pointerup", (d) => e.onCurvePointerUp(d), { signal: a }), n.addEventListener("pointercancel", (d) => e.onCurvePointerUp(d), { signal: a }), n.addEventListener("pointerleave", () => {
    e.curveHover = null, e.drawCurveEditor();
  }, { signal: a }), n.addEventListener("dblclick", (d) => e.onCurveDoubleClick?.(d), { signal: a }), n.addEventListener("wheel", (d) => _l(e, d), { passive: !1, signal: a })), t('[data-act="curve-zoom-in"]')?.addEventListener("click", () => e.zoomCurve(1.25), { signal: a }), t('[data-act="curve-zoom-out"]')?.addEventListener("click", () => e.zoomCurve(0.8), { signal: a }), t('[data-act="curve-fit"]')?.addEventListener("click", () => e.resetCurveZoom(), { signal: a }), t('[data-role="key-frame"]')?.addEventListener("change", (d) => e.retimeSelectedKey(Number(d.target.value)), { signal: a });
  ...
  s && (s.value = e.labelOverlay?.settings?.mode || "selected", s.addEventListener("change", (d) => e.labelOverlay?.setMode(d.target.value), { signal: a })), i && (i.value = e.labelOverlay?.settings?.content || "annotation", i.addEventListener("change", (d) => e.labelOverlay?.setContent(d.target.value), { signal: a }));
  ...
  for (const d of e.root.querySelectorAll('[data-role="timeline-summary"]'))
    d.addEventListener("click", () => {
      e.selectedEntity === "object" && (e.selectedEntity = "camera", e.selectedObjectId = null, e.refreshObjects(), e.refreshKeys(), e.refreshInspector(), e.render(), e.setStatus(r(`Editing: ${e.activeCameraTrack().name}`)));
    }, { signal: a });
    ...
    if (!(!b || h.button === 2 || d.closest(".scene-action-btn")))
      if (b.dataset.objectId) {
        ...
        if (e.finishCameraEdit(), e.selectedObjectIds ||= /* @__PURE__ */ new Set(), h.ctrlKey || h.metaKey)
          ...
          const g = e.state.objects.map((x) => x.id), v = g.indexOf(e.outlinerAnchorId), j = g.indexOf(u.id);
          e.selectedObjectIds = new Set(g.slice(Math.min(v, j), Math.max(v, j) + 1));
        } else
        ...
        for (const g of e.root.querySelectorAll(".scene-item")) {
          const v = !!(g.dataset.objectId && e.selectedObjectIds.has(g.dataset.objectId)), j = !!(g.dataset.objectId && g.dataset.objectId === e.selectedObjectId);
          g.classList.toggle("selected", v), g.classList.toggle("primary", j), g.setAttribute("aria-selected", String(v));
        }
        ...
        if (y) {
          ...
          v && (v.textContent = `${g} ${r("selected")}`);
        }
        e.refreshKeys(), e.refreshInspector(), e.render(), e.setStatus(r(`Selected: ${u.name || u.type}`));
  ...
  e.root.addEventListener("pointerdown", (d) => {
    ...
    const h = e.interactionElement.getBoundingClientRect(), b = (d.clientX - h.left) * e.canvas.width / Math.max(1, h.width), u = (d.clientY - h.top) * e.canvas.height / Math.max(1, h.height);
    bm(e, d, b, u) || e.onPointerDown(d);
  }, { signal: a }), e.interactionElement?.addEventListener("pointermove", (d) => {
    const h = e.interactionElement.getBoundingClientRect(), b = (d.clientX - h.left) * e.canvas.width / Math.max(1, h.width), u = (d.clientY - h.top) * e.canvas.height / Math.max(1, h.height);
    um(e, d, b, u) || e.onPointerMove(d);
  }, { signal: a }), e.interactionElement?.addEventListener("pointerup", (d) => {
    bo(e) || e.onPointerUp(d);
    ...
    const h = e.interactionElement.getBoundingClientRect(), b = (d.clientX - h.left) * e.canvas.width / Math.max(1, h.width), u = (d.clientY - h.top) * e.canvas.height / Math.max(1, h.height);
    gm(e, d, b, u) || e.onWheel(d);
  }, { passive: !1, signal: a }), e.root.addEventListener("wheel", $c(e.root), { signal: a }), window.addEventListener("pointermove", (d) => {
  ...
  l && (l.addEventListener("pointerdown", (d) => e.onTimelinePointerDown(d), { signal: a }), l.addEventListener("pointermove", (d) => e.onTimelinePointerMove(d), { signal: a }), l.addEventListener("pointerup", (d) => e.onTimelinePointerUp(d), { signal: a }), l.addEventListener("pointercancel", (d) => e.onTimelinePointerUp(d), { signal: a }), l.addEventListener("wheel", (d) => Rr(e, d), { passive: !1, signal: a }));
  const m = (d) => {
    const h = vs(d.composedPath?.()[0] || d.target);
    h && (e.lastKeyZone = h);
  };
  e.root.addEventListener("focusin", m, { signal: a }), e.root.addEventListener("pointerdown", m, { capture: !0, signal: a }), e.root.addEventListener("focusout", (d) => {
    e.modalTransform && !e.root.contains(d.relatedTarget) && (us(e), e.render());
  }, { signal: a });
  const p = new ResizeObserver(() => {
    e.scheduleResizeAndRender();
  }), f = e.root.querySelector(".viewport-wrap");
  f && p.observe(f), e.resizeObserver = p, e.updateEditState();
}
const vm = "🔘", wr = [
...
function xm(e, t) {
  Io.find((o) => o.id === e)?.onChange?.(t);
}
function km(e) {
  const t = di(e.id, e.defaultValue), a = `pref_${e.id.replace(/[^a-zA-Z0-9]/g, "_")}`;
  if (e.type === "boolean")
    return `
...
function wm(e) {
  const t = new Map(Io.map((o) => [o.id, o]));
  return ({
    nav: [
      ti,
      ai,
...
function Sm() {
  return `<span class="oc-pref-emoji" aria-hidden="true">${vm}</span> ${r("OmniCam Preferences")}`;
}
function jm(e) {
  ...
  a.className = "oc-modal-backdrop", a.setAttribute("role", "dialog"), a.setAttribute("aria-modal", "true"), a.setAttribute("aria-label", r("OmniCam Preferences")), a.innerHTML = `
    <div class="oc-modal-dialog oc-pref-dialog" tabindex="-1">
      <div class="oc-pref-header">
        <div class="oc-pref-title">${Sm()}</div>
...
const _m = ["position", "target"], Em = ["fov", "zoom"], $m = ["roll"], Mm = ["position", "size"], Am = ["rotation"];
function Eo(e) {
...
function jr(e, t, a, o) {
  const n = Eo(Number(a || 0) - Number(e || 0)), s = Number(e || 0) + n * o;
  if (t == null) return s;
  const i = Eo(Number(t || 0) - s);
  return s + i / 3;
}
function Cr(e, t, a) {
...
function Im(e, t) {
  ...
  for (let n = 1; n < a.length - 1; n++) {
    const s = e[n - 1], i = e[n], c = e[n + 1], l = c.frame - s.frame, m = l !== 0 ? (i.frame - s.frame) / l : 0.5;
    if (i.camera) {
      for (const p of _m) {
        const f = s.camera?.[p], d = i.camera?.[p], h = c.camera?.[p];
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const b = Sr(f, d, h, m);
          a[n].camera[p] = Cr(d.map(Number), b, o);
        }
      }
      for (const p of Em) {
        const f = s.camera?.[p], d = i.camera?.[p], h = c.camera?.[p];
      ...
      for (const p of $m) {
        ...
        if (f != null && h != null && d != null) {
          const b = jr(f, d, h, m);
          a[n].camera[p] = _r(Number(d), b, o);
        }
      }
    }
    if (Array.isArray(i.position) && Array.isArray(s.position) && Array.isArray(c.position)) {
      for (const p of Mm) {
        const f = s[p], d = i[p], h = c[p];
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const b = Sr(f, d, h, m);
          a[n][p] = Cr(d.map(Number), b, o);
        }
      }
      for (const p of Am) {
        const f = s[p], d = i[p], h = c[p];
        if (Array.isArray(f) && Array.isArray(h) && Array.isArray(d)) {
          const b = [0, 1, 2].map((u) => jr(f[u], d[u], h[u], m));
          a[n][p] = d.map((u, y) => _r(Number(u), b[y], o));
        }
      }
    }
  }
...
function Km(e, t) {
  ...
  const o = (n) => {
    ...
    const c = n.clientX, l = parseFloat(i.value) || 0, m = parseFloat(i.getAttribute("step")) || 0.1, p = i.hasAttribute("min") ? parseFloat(i.getAttribute("min")) : -1 / 0, f = i.hasAttribute("max") ? parseFloat(i.getAttribute("max")) : 1 / 0;
    let d = !1, h = !1;
    ...
    const b = (y) => {
      ...
      let v = Fm;
      y.shiftKey ? v = Lm : (y.ctrlKey || y.metaKey) && (v = Om);
      const j = m * v * 20;
      let x = l + g * j;
      x = Math.max(p, Math.min(f, x));
      const A = m >= 1 ? 0 : m >= 0.1 ? 1 : 2;
      i.value = x.toFixed(A), i.dispatchEvent(new Event("input", { bubbles: !0 })), i.dispatchEvent(new Event("change", { bubbles: !0 }));
    }, u = (y) => {
      if (s.classList.remove("scrubbing"), document.body.style.cursor = "", s.removeEventListener("pointermove", b), s.removeEventListener("pointerup", u), s.removeEventListener("pointercancel", u), s.releasePointerCapture)
        try {
    ...
    s.addEventListener("pointermove", b), s.addEventListener("pointerup", u), s.addEventListener("pointercancel", u);
  };
...
function Dm(e, t) {
  ...
  a && a.addEventListener("click", (o) => {
    ...
    let l = [0, 0, 0];
    s === "position" || s === "pos" ? l = [0, 1.5, 0] : s === "camera-pos" ? l = [6, 4, 6] : s === "camera-target" || s === "target" ? l = [0, 1.5, 0] : s === "scale" ? l = [1, 1, 1] : (s === "rotation" || s === "rot") && (l = [0, 0, 0]), c.forEach((m, p) => {
      const f = l[p] !== void 0 ? l[p] : 0;
      m.value = String(f), m.dispatchEvent(new Event("input", { bubbles: !0 })), m.dispatchEvent(new Event("change", { bubbles: !0 }));
...
function Mn(e) {
  ...
  if (i) {
    ...
    b && (b.classList.toggle("locked", c), b.title = c ? r("Camera View is locked (click to unlock)") : r("Lock Camera View (prevent accidental navigation)"));
  }
  const l = t.querySelector('[data-role="hud-cam-lens"]');
  l && o?.fov != null && (l.textContent = `${Lo(o.fov)}mm`);
  const m = t.querySelector('[data-role="hud-cam-fov"]');
  m && o?.fov != null && (m.textContent = rc(o.fov));
  const p = t.querySelector('[data-role="hud-cam-dist"]');
  if (p)
    if (o?.target && Array.isArray(o.target) && Array.isArray(o.position)) {
      const b = Be(Ee(o.position, o.target));
      p.textContent = `Tgt: ${b.toFixed(2)}m`;
    } else
      p.textContent = "Free";
...
function _e(e) {
  ...
  if (t) {
    ...
    h && (h.classList.toggle("active", d), h.title = d ? r("Transform Space: Local (click for World)") : r("Transform Space: World (click for Local)"));
  }
  ...
  if (a) {
    ...
    a.classList.toggle("active", d), a.setAttribute?.("aria-pressed", String(d)), a.title = d ? r("Snapping: {mode} (click to disable)").replace("{mode}", e.state.spatial_snap_mode) : r("Toggle Snapping (Grid / None)");
  }
  ...
  const m = e.root.querySelector('[data-role="overlay-radar-btn"]');
  m && m.classList.toggle("active", !!e.state.show_radar);
...
function Rm(e, t) {
  for (const o of e.root.querySelectorAll('[data-act="toggle-camera-lock"]'))
    o.addEventListener("click", (n) => {
      n.stopPropagation(), e.checkpoint?.("Toggle camera lock"), e.state.camera_lock = !e.state.camera_lock, e.serialize?.(), Mn(e), e.setStatus?.(e.state.camera_lock ? r("Camera View locked") : r("Camera View unlocked"));
    }, { signal: t });
  ...
  for (const o of e.root.querySelectorAll('[data-act="toggle-gizmo-space"]'))
    o.addEventListener("click", (n) => {
      ...
      e.serialize?.(), _e(e), e.requestRender?.(), e.setStatus?.(r("Transform space: {space}").replace("{space}", e.state.gizmo_space));
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-spatial-snap"]'))
    o.addEventListener("click", (n) => {
      ...
      e.serialize?.(), _e(e), e.setStatus?.(r("Snapping: {mode}").replace("{mode}", e.state.spatial_snap_mode));
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-grid-overlay"]'))
    o.addEventListener("click", (n) => {
      n.stopPropagation(), e.checkpoint?.("Toggle grid overlay"), e.state.show_grid = e.state.show_grid === !1, e.serialize?.(), _e(e), e.requestRender?.();
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-wireframe-overlay"]'))
    o.addEventListener("click", (n) => {
      ...
      e.serialize?.(), _e(e), e.requestRender?.(), e.setStatus?.(e.state.show_wireframe ? r("Wireframe overlay: On") : r("Wireframe overlay: Off"));
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-cull-overlay"]'))
    o.addEventListener("click", (n) => {
      ...
      e.serialize?.(), _e(e), e.webgl && (e.webgl.sceneKey = ""), e.requestRender?.(), e.setStatus?.(e.state.backface_culling ? r("Backface culling: On (Single-Sided)") : r("Backface culling: Off (Double-Sided)"));
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-gizmo-overlay"]'))
    o.addEventListener("click", (n) => {
      n.stopPropagation(), e.checkpoint?.("Toggle gizmo overlay"), e.state.show_gizmo = e.state.show_gizmo === !1, e.serialize?.(), _e(e), e.requestRender?.();
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-guides-overlay"]'))
    o.addEventListener("click", (n) => {
      n.stopPropagation(), e.checkpoint?.("Toggle guides overlay"), e.state.guides = e.state.guides === !1, e.serialize?.(), _e(e), e.requestRender?.();
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-safe-areas-overlay"]'))
    o.addEventListener("click", (n) => {
      n.stopPropagation(), e.checkpoint?.("Toggle safe areas overlay"), e.state.safe_areas = !e.state.safe_areas, e.serialize?.(), _e(e), e.requestRender?.();
    }, { signal: t });
  for (const o of e.root.querySelectorAll('[data-act="toggle-radar-overlay"]'))
    o.addEventListener("click", (n) => {
      n.stopPropagation(), e.checkpoint?.("Toggle radar overlay"), e.state.show_radar = !e.state.show_radar, e.serialize?.(), _e(e), e.requestRender?.();
    }, { signal: t });
...
function qm(e, t) {
  ...
  !a || !o || (n && n.addEventListener("change", () => {
    ...
    document.activeElement !== a && (a.value = Lo(o.value));
  }, { signal: t }));
}
function Bm(e, t) {
  ...
  }, s = (i) => (e.smoothingBaseline?.cameraId !== i.id && (e.smoothingBaseline = { cameraId: i.id, keys: zm(i.keyframes) }), e.smoothingBaseline.keys);
  a.addEventListener("input", n, { signal: t }), a.addEventListener("change", () => {
    const i = e.activeCameraTrack();
    if (!i) return;
    e.checkpoint("Path smoothing");
    const c = Number(a.value) / 100, l = Im(s(i), c);
  ...
  if (a) {
    ...
    a.addEventListener("input", l, { signal: t }), a.addEventListener("change", () => {
      ...
      e.simplifyActiveKeys({
        ...
        scope: p,
        fromKeys: m().map((f) => JSON.parse(JSON.stringify(f)))
      }), Number(a.value) === 0 && (e.keySimplifyBaseline = null);
    }, { signal: t }), l();
  }
  e.root.querySelector('[data-act="keys-reduce"]')?.addEventListener("click", async () => {
    const l = await wt(e, r("Reduce keys"), r("Target number of keys"), "8"), m = Math.round(Number(l));
    Number.isFinite(m) && m >= 2 && (e.simplifyActiveKeys({ mode: "reduce", target: m, scope: n?.value || "camera" }), e.keySimplifyBaseline = null);
  ...
  if (a.length) {
    ...
    for (const o of a)
      o.addEventListener("change", () => {
        e.dopeChannels = new Set(a.filter((n) => n.checked).map((n) => n.dataset.dopeChannel)), mn(e);
      }, { signal: t });
  }
}
function Um(e, t) {
...
function Gm(e, t) {
  e.root.querySelector('[data-act="toggle-fullscreen"]')?.addEventListener("click", () => {
    ...
    if (!o) return;
    const n = o.classList.toggle("oc-graph-collapsed");
    a.currentTarget.classList.toggle("active", !n), n || e.drawCurveEditor();
  }, { signal: t });
  for (const [a, o] of [
...
const Ba = () => import("./chunk-DtgT6Ss9.js");
function Xm(e, t) {
  Ba().then(({ loadExchangeFormats: o }) => o(e, t)), e.root.querySelector('[data-act="import-camera"]')?.addEventListener("click", async () => {
    (await Ba()).pickCameraFile(e);
  }, { signal: t }), e.root.querySelector('[data-act="export-camera"]')?.addEventListener("click", async () => {
    (await Ba()).exportCamera(e);
  }, { signal: t }), e.root.querySelector('[data-role="camera-file"]')?.addEventListener("change", async (o) => {
    const n = o.target.files?.[0];
    o.target.value = "", await (await Ba()).importCameraFile(e, n);
  }, { signal: t });
}
function Ym(e, t) {
  ...
  mi().then((n) => {
    ...
    if (s) {
      const l = Number(s.dataset.zoneStart), m = Number(s.dataset.zoneEnd);
      pi(e, l, m);
      return;
    }
    ...
    c === "health-slow" ? fi(e) : c === "health-smooth" ? hi(e) : c === "health-recenter" && bi(e);
  }, { signal: t });
  for (const n of e.root.querySelectorAll('[data-tab="health"]'))
    n.addEventListener("click", () => mo(e), { signal: t });
}
function Zm(e, t) {
...
function ep(e, t) {
  Xm(e, t), qm(e, t), Bm(e, t), Wm(e, t), Vm(e, t), Zm(e, t), Qm(e, t), Jm(e, t), Km(e, t), Dm(e, t), Hm(e, t), Gm(e, t), Rm(e, t), Um(e, t), Ym(e, t);
}
const Er = {
...
}, An = "balanced", uo = "#121212";
function Ro(e) {
  return Er[e] || Er[An];
}
function tp(e, t = "#1b1f2b", a = "#151822", o = "#1e2330", n = "#161922", s = "#111319") {
  ...
  const m = new e.CanvasTexture(i);
  return m.mapping = e.EquirectangularReflectionMapping, m.colorSpace = e.SRGBColorSpace, m.needsUpdate = !0, m;
}
function ap(e) {
...
function Fb(e, t, a = An) {
  const o = Ro(a), n = new e.Group();
  ...
  const m = new e.HemisphereLight(2633792, 1184794, 0.55);
  n.add(m);
  const p = ap(e), f = new e.Mesh(
  ...
  d.rotation.x = -Math.PI / 2, d.position.y = -1e-3, d.receiveShadow = !0, d.name = "omnicam-shadow-catcher", n.add(d);
  const h = new e.FogExp2(1250588, 8e-3), b = tp(e), u = new e.PMREMGenerator(t);
  u.compileEquirectangularShader();
  const y = new Uc(), g = u.fromScene(y, 0.04).texture;
  return y.traverse((v) => {
    v.geometry?.dispose?.();
    const j = Array.isArray(v.material) ? v.material : [v.material];
    for (const x of j) x?.dispose?.();
  }), {
    group: n,
    key: s,
    fill: c,
    ...
    quality: a,
    dispose() {
      f.geometry.dispose(), f.material.dispose(), d.geometry.dispose(), d.material.dispose(), p.dispose(), b.dispose(), g.dispose(), u.dispose();
      for (const v of [s, c, l, m]) v.dispose?.();
    }
  };
}
function Lb(e, t, a) {
...
function Ob(e, t, a, o, n) {
  o.group.visible = n, t.environment = n ? o.environment : null, t.background = n ? o.sky : new e.Color(1184274), t.fog = n ? o.fog : null, a.toneMapping = n ? e.ACESFilmicToneMapping : e.NoToneMapping, a.toneMappingExposure = n ? Ro(o.quality).toneExposure : 1, t.traverse((s) => {
...
function op(e) {
  ...
  const n = e.reconstruction, s = n.provider || "Reconstructed", i = Math.round(t * 100), c = cc(e), l = c.length ? `
` + c.map(([p, f]) => `${p}: ${f}`).join(`
`) : "", m = `${s} • ${o} (${i}%)${l}`;
  return {
    label: o,
...
function sp(e, t, a) {
  ...
  if (o) {
    const s = (i) => {
      const c = i.target.closest?.("[data-axis], [data-axis-center]") || i.target, l = c.getAttribute("data-axis"), m = ui(l?.toLowerCase(), e.state.view_mode);
      m ? (i.preventDefault(), e.setViewMode(m)) : c.hasAttribute("data-axis-center") && (i.preventDefault(), e.frameTarget());
    };
  ...
  for (const s of e.root.querySelectorAll('[data-role="camera-type"]'))
    s.addEventListener("change", (i) => {
      e.camera.camera_type !== i.target.value && e.checkpoint("Change camera type"), e.camera.camera_type = i.target.value, ge(e.root, "camera-type", i.target), e.beginCameraEdit(), e.commitCameraEdit(), e.finishCameraEdit(), e.render();
    }, { signal: a });
  for (const s of e.root.querySelectorAll('[data-role="speed"]')) {
    const i = (c) => {
      const l = Z(Number(c.target.value), 0.05, 5);
      if (Number.isFinite(l)) {
        e.cameraSpeed = l;
        for (const m of e.root.querySelectorAll('[data-role="speed"]'))
          m !== c.target && (m.value = String(l));
      }
    };
  ...
  for (const s of e.root.querySelectorAll('[data-role="point-color"]'))
    s.addEventListener("input", (i) => {
      e.state.point_color !== i.target.value && Wa(e, "point_color", "Change point color"), e.state.point_color = i.target.value, e.scheduleSerialize(), e.render();
    }, { signal: a });
  ...
  for (const s of e.root.querySelectorAll('[data-role="speed-heatmap"]'))
    s.addEventListener("change", (i) => {
      e.state.speed_heatmap !== i.target.checked && e.checkpoint("Toggle speed heatmap"), e.state.speed_heatmap = i.target.checked, ge(e.root, "speed-heatmap", i.target, "checked"), e.scheduleSerialize(), e.render();
    }, { signal: a });
  for (const s of e.root.querySelectorAll('[data-role="playblast-grid"]'))
    s.addEventListener("change", (i) => {
      e.state.playblast_grid !== i.target.checked && e.checkpoint("Toggle playblast grid"), e.state.playblast_grid = i.target.checked, ge(e.root, "playblast-grid", i.target, "checked"), e.scheduleSerialize(), e.render();
    }, { signal: a });
  for (const s of e.root.querySelectorAll('[data-role="playblast-labels"]'))
    s.addEventListener("change", (i) => {
      e.state.playblast_labels !== i.target.checked && e.checkpoint("Toggle playblast labels"), e.state.playblast_labels = i.target.checked, ge(e.root, "playblast-labels", i.target, "checked"), e.scheduleSerialize(), e.render();
    }, { signal: a });
  for (const s of e.root.querySelectorAll('[data-role="playblast-resolution"]'))
    s.addEventListener("change", (i) => {
      e.state.playblast_resolution !== i.target.value && e.checkpoint("Change playblast resolution"), e.state.playblast_resolution = i.target.value, ge(e.root, "playblast-resolution", i.target), e.scheduleSerialize();
    }, { signal: a });
  for (const s of e.root.querySelectorAll('[data-act="reset-bg-color"]'))
    s.addEventListener("click", () => {
      e.state.viewport_bg_color !== uo && e.checkpoint("Reset background colour"), e.state.viewport_bg_color = uo;
      for (const i of e.root.querySelectorAll('[data-role="viewport-bg-color"]')) i.value = uo;
  ...
  for (const s of e.root.querySelectorAll('[data-role="show-grid"]'))
    s.addEventListener("change", (i) => {
      e.state.show_grid = i.target.checked, ge(e.root, "show-grid", i.target, "checked"), e.scheduleSerialize(), e.render();
    }, { signal: a });
  for (const [s, i] of [
    ...
    for (const c of e.root.querySelectorAll(`[data-role="${s}"]`))
      c.addEventListener("change", (l) => {
        e.state[i] !== l.target.checked && e.checkpoint("Toggle viewport helper"), e.state[i] = l.target.checked, ge(e.root, s, l.target, "checked"), e.scheduleSerialize(), e.render();
      }, { signal: a });
  ...
  for (const s of e.root.querySelectorAll('[data-role="show-wireframe"]'))
    s.addEventListener("change", (i) => {
      e.state.show_wireframe !== i.target.checked && e.checkpoint("Toggle wireframe"), e.state.show_wireframe = i.target.checked, ge(e.root, "show-wireframe", i.target, "checked"), e.scheduleSerialize(), e.webgl && (e.webgl.sceneKey = ""), e.render();
    }, { signal: a });
  for (const s of e.root.querySelectorAll('[data-role="show-vertices"]'))
    s.addEventListener("change", (i) => {
      e.state.show_vertices !== i.target.checked && e.checkpoint("Toggle vertices"), e.state.show_vertices = i.target.checked, ge(e.root, "show-vertices", i.target, "checked"), e.scheduleSerialize(), e.webgl && (e.webgl.sceneKey = ""), e.render();
    }, { signal: a });
  for (const s of e.root.querySelectorAll('[data-role="backface-culling"]'))
    s.addEventListener("change", (i) => {
      !!e.state.backface_culling !== i.target.checked && e.checkpoint("Toggle backface culling"), e.state.backface_culling = i.target.checked, ge(e.root, "backface-culling", i.target, "checked"), e.scheduleSerialize(), e.webgl && (e.webgl.sceneKey = ""), e.render(), e.setStatus(e.state.backface_culling ? r("Backface culling: On (Single-Sided)") : r("Backface culling: Off (Double-Sided)"));
    }, { signal: a });
  for (const s of e.root.querySelectorAll('[data-act="set-near-preset"]'))
    s.addEventListener("click", (i) => {
      ...
      if (l) {
        l.camera.near = c;
        const m = l.keyframes?.find((p) => p.frame === e.frame);
        m && m.camera && (m.camera.near = c);
      }
      for (const m of e.root.querySelectorAll('[data-role="camera-near"]')) m.value = String(c);
  ...
  for (const s of e.root.querySelectorAll('[data-role="burn-in"]'))
    s.addEventListener("change", (i) => {
      e.state.burn_in !== i.target.checked && e.checkpoint("Toggle burn-in"), e.state.burn_in = i.target.checked, ge(e.root, "burn-in", i.target, "checked"), e.scheduleSerialize(), e.render();
    }, { signal: a });
  for (const s of e.root.querySelectorAll('[data-role="guides"]'))
    s.addEventListener("change", (i) => {
      e.state.guides !== i.target.checked && e.checkpoint("Toggle guides"), e.state.guides = i.target.checked, ge(e.root, "guides", i.target, "checked"), e.scheduleSerialize(), e.render();
    }, { signal: a });
  for (const s of e.root.querySelectorAll('[data-role="safe-areas"]'))
    s.addEventListener("change", (i) => {
      e.state.safe_areas !== i.target.checked && e.checkpoint("Toggle safe areas"), e.state.safe_areas = i.target.checked, ge(e.root, "safe-areas", i.target, "checked"), e.scheduleSerialize(), e.renderCameraView(), e.render();
    }, { signal: a });
  for (const s of e.root.querySelectorAll('[data-role="resolution-gate"]'))
    s.addEventListener("change", (i) => {
      e.state.resolution_gate !== i.target.checked && e.checkpoint("Toggle resolution gate"), e.state.resolution_gate = i.target.checked, ge(e.root, "resolution-gate", i.target, "checked"), e.scheduleSerialize(), e.renderCameraView(), e.render();
    }, { signal: a });
  for (const s of e.root.querySelectorAll('[data-role="aspect-ratio"]'))
    s.addEventListener("change", (i) => {
      e.state.aspect_ratio !== i.target.value && e.checkpoint("Change aspect ratio"), e.state.aspect_ratio = i.target.value, ge(e.root, "aspect-ratio", i.target), e.scheduleSerialize(), e.renderCameraView(), e.render();
    }, { signal: a });
  for (const s of e.root.querySelectorAll('[data-role="viewport-bg-color"]')) {
    const i = (c) => {
      e.state.viewport_bg_color !== c.target.value && Wa(e, "viewport_bg_color", "Change background colour"), e.state.viewport_bg_color = c.target.value, ge(e.root, "viewport-bg-color", c.target), e.scheduleSerialize(), e.render();
    };
    s.addEventListener("input", i, { signal: a }), s.addEventListener("change", i, { signal: a });
  }
  ...
  for (const s of e.root.querySelectorAll('[data-role="object-color"]'))
    s.addEventListener("input", (i) => {
      const c = e.selectedObject();
      c && (c.color !== i.target.value && Wa(e, `object_color:${c.id}`, "Change object color"), c.color = i.target.value, e.scheduleSerialize(), e.render());
    }, { signal: a });
  for (const s of e.root.querySelectorAll('[data-role="object-light-color"]'))
    s.addEventListener("input", (i) => {
      const c = e.selectedObject();
      c && (c.color !== i.target.value && Wa(e, `object_color:${c.id}`, "Change light color"), c.color = i.target.value, e.scheduleSerialize(), e.render());
    }, { signal: a });
...
const ip = 32, cp = 0.025, lp = 0.05, Za = 1e-6, dp = ["top", "bottom", "front", "back", "left", "right"], mp = {
  top: "y",
  bottom: "y",
  front: "z",
  back: "z",
...
function pp(e) {
  let t = 0;
  for (let a = 1; a < e.length; a++) t += Bo(e[a - 1], e[a]);
  return t;
}
function Mo(e) {
  const t = Math.max(0, Math.round(Number(e?.duration_frames) || 1) - 1), a = Array.isArray(e?.playback_range) ? e.playback_range : [0, t], o = $o(Math.round(Number(a[0]) || 0), 0, t), n = $o(Math.round(Number(a[1]) || t), 0, t);
  return o <= n ? [o, n] : [n, o];
}
function fp(e, t) {
  ...
  for (let i = 0; i < t; i++) {
    ...
    const l = a[s - 1], m = a[s], p = $o((c - l) / Math.max(Za, m - l), 0, 1), f = e[s - 1], d = e[s];
    n.push([
      f[0] + (d[0] - f[0]) * p,
      f[1] + (d[1] - f[1]) * p,
      f[2] + (d[2] - f[2]) * p
...
function up(e) {
  ...
  const s = Math.min(ip, n.length, o + 1);
  if (s < 2) return [];
  const i = fp(n, s);
  ...
  ], m = e.planeAxis === "y" ? Tn(l) : Pn(l, [0, 0, -1]), p = e.seedPoint ? 1 : 0, f = [];
  for (let d = p; d < i.length; d++) {
    const h = i[d], b = hp(i, d, m, e.planeAxis), u = le(c);
    u.position = [...h], u.target = bp(h, b, l, e.planeAxis), f.push({
...
function In(e, t = e.cameraPathDraw) {
  const a = t?.pointerId;
  if (a != null)
    try {
...
function $r(e, t = {}) {
  ...
  let s = null, i = null, c, l = null, m = null;
  if (a === "extend") {
    const d = o?.keyframes;
    ...
    s = [...h.camera.position], i = o.id;
    const b = Math.max(0, Math.round(Number(e.state.duration_frames) || 1) - 1), [, u] = Mo(e.state), y = d.length > 1 ? d[d.length - 1].frame - d[0].frame : 24;
    let g = Math.max(u, h.frame + Math.max(6, Math.min(y, 240)));
    g <= h.frame && (g = h.frame + 24), g > b && (l = g + 1), g > u && (m = g), c = [h.frame, g];
  } else
    dp.includes(e.state.view_mode) || e.setViewMode?.("top"), c = Mo(e.state);
  const p = mp[e.state.view_mode] ?? null, f = s ? [...s] : [...n.position];
  return e.cameraPathDraw = {
    ...
    sourceCamera: n,
    points: []
  }, xt(e), e.setStatus?.(a === "extend" ? r("Continue Camera Path: LMB draw from the last key · RMB or Esc cancel") : r("Draw Camera Path: LMB draw · RMB or Esc cancel")), e.render?.(), !0;
}
function Wo(e, t) {
  ...
  a.planeAxis && (o[Ja[a.planeAxis]] = a.anchor[Ja[a.planeAxis]]);
  const n = a.points.at(-1);
  return n && Bo(n, o) < cp ? !1 : (a.points.push(o), !0);
}
function Te(e) {
  const t = e.cameraPathDraw;
  return t?.active ? (In(e, t), e.cameraPathDraw = null, xt(e), e.setStatus?.(r("Draw Camera Path cancelled")), e.render?.(), !0) : !1;
}
function yp(e) {
  const t = e.cameraPathDraw;
  ...
  if (a.length < 2 || pp(a) < lp || t.range[1] <= t.range[0])
    return Te(e), e.setStatus?.(r("Camera path needs at least two distinct points")), null;
  const o = up(t);
  ...
  if (t.mode === "extend") {
    ...
    const m = [...l.values()].sort((p, f) => p.frame - f.frame);
    return c.keyframes = m, c.id === e.state.active_camera_id && (e.state.keyframes = m), e.cameraPreviewSignature = "", e.cameraPathDraw = null, xt(e), e.activateCamera?.(c.id), e.setFrame?.(o[0].frame), e.serialize?.(), e.refreshKeys?.(), e.render?.(), e.setStatus?.(r("Camera path extended")), c.id;
  }
  e.checkpoint?.("Draw camera path");
  const n = dc(e.state), s = e.state.cameras.length, i = {
    id: n,
    name: gp(e.state),
    color: rr[s % rr.length],
    camera: le(o[0].camera),
    keyframes: o,
    target_object_id: null,
    target_offset: [0, 0, 0]
  };
  return e.state.cameras.push(i), e.cameraPreviewSignature = "", e.cameraPathDraw = null, xt(e), e.activateCamera?.(n), e.setFrame?.(t.range[0]), e.setStatus?.(r("Camera path created")), n;
}
function Qa(e) {
...
function Vo(e, t) {
  ...
  return n?.every(Number.isFinite) ? (a.planeAxis && (n[Ja[a.planeAxis]] = a.anchor[Ja[a.planeAxis]]), n) : null;
}
function xp(e, t) {
  const a = e.cameraPathDraw;
  return a?.active ? t.button === 2 && !t.altKey ? (Qa(t), e.cameraPathSuppressContextMenuUntil = Date.now() + 1e3, Te(e), !0) : t.button !== 0 || t.altKey || t.ctrlKey || t.metaKey || t.shiftKey ? !1 : (Qa(t), e.closeMenus?.(), e.interactionElement.focus?.({ preventScroll: !0 }), e.interactionElement.setPointerCapture?.(t.pointerId), a.drawing = !0, a.pointerId = t.pointerId, a.points = [], Wo(e, Vo(e, t)), xt(e), e.requestRender?.("camera-path-draw"), !0) : !1;
}
function kp(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : (Qa(t), Wo(e, Vo(e, t)) && e.requestRender?.("camera-path-draw"), !0);
}
function wp(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : (Qa(t), t.type === "pointercancel" || t.type === "lostpointercapture" ? (Te(e), !0) : (Wo(e, Vo(e, t)), a.drawing = !1, yp(e), !0));
}
function Sp(e) {
  const t = e.cameraPathDraw;
  ...
  if (!o.length) return;
  const n = o.map((c) => Pe(c, a, e.canvas.width, e.canvas.height)).filter((c) => c && Number.isFinite(c[0]) && Number.isFinite(c[1]));
  if (!n.length) return;
...
function jp(e, t) {
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? Te(e) : $r(e);
    }, { signal: t });
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path-extend"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? Te(e) : $r(e, { mode: "extend" });
    }, { signal: t });
  ...
  e.root.addEventListener("contextmenu", (a) => {
    !(Date.now() <= Number(e.cameraPathSuppressContextMenuUntil || 0)) && !e.cameraPathDraw?.active || (a.preventDefault(), a.stopPropagation(), a.stopImmediatePropagation?.(), e.cameraPathSuppressContextMenuUntil = 0, e.cameraPathDraw?.active && Te(e));
  }, { capture: !0, signal: t });
}
const Ua = "/majoor/omnicam/scenes";
function zn(e) {
...
function Ho(e, t, { name: a = "", status: o } = {}) {
  const n = t && typeof t == "object" ? t : Qr(), s = { ...n, metadata: { ...n.metadata || {}, scene_name: a || "" } };
...
async function Cp(e) {
  await St(e, r("New Scene"), r("Start a new scene? Unsaved changes will be lost.")) && Ho(e, Qr(), { name: "", status: r("New scene") });
}
async function _p(e) {
  if (!e.sceneBaseline) {
  ...
  const o = a?.metadata?.scene_name || zn(e);
  Ho(e, a, { name: o, status: r("Scene reset to last save") });
}
async function Ep(e) {
  const t = zn(e) || r("Untitled"), a = await wt(e, r("Save Scene"), r("Scene name"), t);
  if (a == null) return;
...
async function $p(e) {
  ...
  const a = await rn({
    ...
    items: t.map((n) => ({
      id: n.slug,
      label: n.name || n.slug,
      sublabel: Mp(n.modified)
    })),
    onDelete: async (n) => {
      const s = await Ga(e, `${Ua}/${encodeURIComponent(n)}`, { method: "DELETE" });
      if (!s.ok) throw new Error(await s.text());
    }
  });
  if (!(!a || !await St(e, r("Open Scene"), r("Open this scene? Unsaved changes will be lost."))))
    try {
      const n = await Ga(e, `${Ua}/${encodeURIComponent(a)}`);
      if (!n.ok) throw new Error(await n.text());
...
function Ap(e, t) {
  Va(e, t, e.root.querySelectorAll('[data-act="scene-new"]'), () => Cp(e)), Va(e, t, e.root.querySelectorAll('[data-act="scene-open"]'), () => $p(e)), Va(e, t, e.root.querySelectorAll('[data-act="scene-save"]'), () => Ep(e)), Va(e, t, e.root.querySelectorAll('[data-act="scene-reset"]'), () => _p(e));
}
const Tp = ["world_point", "object_point", "camera_field"], Mr = 40;
function Pp(e) {
  return (e.keys || []).map((t) => ({ x: t.x, y: t.y, t: t.time_seconds }));
}
function Ip(e, t, a) {
  const o = Math.max(1, Number(e.fps) || 24), n = e.width || 1280, s = e.height || 720, i = [];
  for (let c = 0; c <= Mr; c += 1) {
    const l = a * c / Mr, m = zo(e, t.source, l * o, n, s);
    m && i.push({ x: m.x, y: m.y, t: l });
  }
  return i;
}
function zp(e, t) {
...
function Fp(e) {
  ...
  if (!c) return;
  const l = Fn(t, e.state.width || 1280, e.state.height || 720), m = (y) => l.x + y * l.w, p = (y) => l.y + y * l.h;
  ...
  for (let y = 1; y < 3; y += 1)
    c.beginPath(), c.moveTo(m(y / 3), l.y), c.lineTo(m(y / 3), l.y + l.h), c.stroke(), c.beginPath(), c.moveTo(l.x, p(y / 3)), c.lineTo(l.x + l.w, p(y / 3)), c.stroke();
  ...
  for (const y of e.state.motion_layers || []) {
    if (y.enabled === !1) continue;
    const g = Tp.includes(y.source_kind), v = g ? Ip(e.state, y, d) : Pp(y);
    if (!v.length) continue;
    b += 1;
    const j = y.id === e.state.selected_motion_layer_id;
    if (c.strokeStyle = j ? "#ffcc4d" : "rgba(65,217,197,0.6)", c.lineWidth = (j ? 2.4 : 1.5) * n, c.beginPath(), v.forEach((A, P) => {
      const D = m(A.x), F = p(A.y);
      P ? c.lineTo(D, F) : c.moveTo(D, F);
    }), c.stroke(), !g) {
      c.fillStyle = j ? "#ffcc4d" : "#41d9c5";
      for (const A of v)
        c.beginPath(), c.arc(m(A.x), p(A.y), (j ? 3.4 : 2.4) * n, 0, Math.PI * 2), c.fill();
    }
    const x = zp(v, h);
    x && (c.fillStyle = j ? "#ffcc4d" : "#41d9c5", c.strokeStyle = "#fff", c.lineWidth = 1.4 * n, c.beginPath(), c.arc(m(x.x), p(x.y), 4.4 * n, 0, Math.PI * 2), c.fill(), c.stroke());
  }
...
function Lp(e, t) {
  ...
  a && a.addEventListener("click", (o) => {
    ...
    const s = Fn(a, e.state.width || 1280, e.state.height || 720), i = a.width / n.width, c = {
      x: ((o.clientX - n.left) * i - s.x) / Math.max(1, s.w),
      y: ((o.clientY - n.top) * i - s.y) / Math.max(1, s.h)
    }, l = yi(e.state.motion_layers, c, 0.09);
    l && (e.state.selected_motion_layer_id = l.id, e.render());
  }, { signal: t });
}
function ge(e, t, a, o = "value") {
...
function Ar(e, t, { frameCount: a = 0, fps: o = 0 } = {}) {
  ...
  return !n || !s ? !1 : (e.widthWidget && (e.widthWidget.value = n), e.heightWidget && (e.heightWidget.value = s), i && e.fpsWidget && (e.fpsWidget.value = i), l && i && e.durationWidget && (e.durationWidget.value = Math.max(0.25, l / i)), e.syncFromWidgets(), !0);
}
const qe = 1024 * 1024, Rp = Object.freeze({
  card: 128 * qe,
  // MAX_CARD_BYTES
  model: 256 * qe,
  // MAX_MODEL_BYTES
...
function Pr(e) {
  return `${(e / qe).toFixed(e >= 10 * qe ? 0 : 1)} MB`;
}
function jt(e, t) {
  const a = Rp[t];
  if (!e || !a) return null;
  const o = Number(e.size);
  return !Number.isFinite(o) || o <= a ? null : `${e.name || "File"} is ${Pr(o)}; the maximum is ${Pr(a)}.`;
}
function qp(e) {
  return Number(e) <= Tr ? null : `${e} frames selected; a background sequence is limited to ${Tr}.`;
}
function Bp(e) {
...
function Wp(e) {
  ...
  e.audioElement && (go(e, n), Promise.resolve(e.audioElement.play()).catch(() => {
  }));
  ...
  const m = (p) => {
    ...
    if (f === null) {
      for (l += p - c, c = p; l >= i; )
        if (l -= i, n += 1, n > o) {
          if (!e.state.loop_playback) return void Xa(e);
          n = a;
        }
    ...
    n !== s && (s = n, e.setFrame(n, !0, !1)), e.playTimer = requestAnimationFrame(m);
  };
...
async function Vp(e, { load: t = () => import("./vendor-mediabunny-CZ5VNE-V.js") } = {}) {
  ...
  for await (const h of new o(c).samples())
    try {
      p = p || h.sampleRate;
      const b = { planeIndex: 0, format: "f32-planar" }, u = new Float32Array(h.allocationSize(b) / Float32Array.BYTES_PER_ELEMENT);
      h.copyTo(u, b), l.push(u), m += u.length;
    } finally {
      h.close();
    }
  if (!m || !p) return null;
...
async function Up(e, t, { decode: a = Vp } = {}) {
  if (!t) return;
  const o = jt(t, "audio");
  if (o) {
    e.setStatus(o);
  ...
  try {
    ...
    s.preload = "auto", s.src = n, e.audioObjectUrl = n, e.audioElement = s, await Hp(s), e.audioDuration = Number.isFinite(s.duration) ? s.duration : 0;
    try {
      e.audioSamples = await a(t);
    } catch {
      e.audioSamples = null;
    }
    Ln(e), e.setStatus(`Audio loaded: ${t.name || "track"}`);
  } catch (n) {
    eo(e), e.setStatus(`Failed to load audio: ${n.message || n}`);
  }
}
let et = null;
function On({ api: e }) {
...
const Kn = /* @__PURE__ */ new WeakSet(), yt = /* @__PURE__ */ new WeakMap();
function to(e) {
...
function Gp(e) {
  e && typeof e == "object" && yt.set(e, (yt.get(e) || 0) + 1);
}
function Xp(e) {
  ...
  yt.delete(e), Kn.has(e) && to(e);
}
function Ct(e, t) {
  const a = e.cardMediaById.get(t);
  a && (e.cardMediaById.delete(t), e.cardMediaAssetById?.delete?.(t), t === "subject" && e.cardMedia === a && (e.cardMedia = null), Xp(a));
}
function Yp(e) {
  for (const t of [...e.cardMediaById?.keys?.() || []]) Ct(e, t);
}
function De(e, t, a, o = !1, n = "") {
  ...
  s && s !== a && Ct(e, t), o && Kn.add(a), Gp(a), e.cardMediaAssetById ||= /* @__PURE__ */ new Map(), e.cardMediaById.set(t, a), e.cardMediaAssetById.set(t, n || a?.__omnicamAsset || "");
  try {
    a.__omnicamAsset = n || a.__omnicamAsset || "";
  } catch {
  }
...
function Dn(e, t, { signal: a, timeout: o = 15e3 } = {}) {
...
function Jp(e) {
  ...
  if (e.state.viewport_bg_image) {
    const o = new Image();
    o.src = Ke(e.state.viewport_bg_image), o.decode().catch(() => {
    }), e.viewportBgImage = o;
  }
  e.viewportBgSequenceImages = (e.state.viewport_bg_sequence || []).map((o) => {
    const n = new Image();
    return n.src = Ke(o), n.decode().catch(() => {
    }), n;
  });
  for (const o of e.state.objects) {
    if (!o.asset) {
      (o.type === "model" || o.type === "glb") && (o.load_error = r("Not saved to the ComfyUI input folder: this model will be missing after a reload.")), o.type === "card" && Ct(e, o.id);
      continue;
    }
    const n = Ke(o.asset);
...
function Qp(e, t) {
  ...
  a && (a.load_error = null), a?.animation_index && e.webgl?.selectAnimation(t.id, a.animation_index), t.id === e.selectedObjectId && e.refreshInspector(), !t.meshes && !t.points && t.bones ? e.setStatus(r(`${t.format.toUpperCase()} animation only: ${t.bones} bones, no mesh · skeleton preview`)) : e.setStatus(r(`${t.format.toUpperCase()} loaded: ${t.meshes} mesh${t.meshes === 1 ? "" : "es"}, ${t.vertices} vertices`));
}
async function ef(e, t) {
  ...
  try {
    const c = await Do(et, { route: "/majoor/omnicam/upload_model", field: "asset", file: t });
...
async function tf(e, t) {
  ...
  if (o) {
    ...
    try {
      const n = await Do(et, { route: "/majoor/omnicam/upload_asset", field: "asset", file: t });
      if (e.disposed || !e.state.objects.includes(o)) return;
      o.asset = n.path, e.cardMediaAssetById?.set?.(o.id, n.path), o.id === "subject" && (e.state.card_asset = n.path, e.cardWidget && (e.cardWidget.value = n.path)), e.serialize(), e.setStatus(r(`Card: ${n.name}`));
    } catch (n) {
      if (e.disposed || !e.state.objects.includes(o)) return;
...
function af(e, t) {
  ...
  if (a.innerHTML = "", e.executionReferences.forEach((o, n) => {
    ...
    s.value = String(n), s.textContent = o.filename || r(`Upstream ${n + 1}`), a.appendChild(s);
  }), !e.executionReferences.length) {
    const o = document.createElement("option");
    o.value = "0", o.textContent = r("No upstream reference"), a.appendChild(o);
    return;
  }
  e.state.reference_index = Z(e.state.reference_index || 0, 0, e.executionReferences.length - 1), a.value = String(e.state.reference_index), e.serialize(), e.loadSelectedReference();
}
function of(e) {
  ...
  const a = new Image();
  a.onload = () => {
    e.disposed || (De(e, "subject", a, !1, a.src), e.render(), e.setStatus(r("Upstream media refreshed")));
...
async function rf(e) {
  ...
  for (const f of i) {
    ...
    if (h) {
      if (d === "image" || d === "video") {
        ...
        if (b && b.value) {
          const u = String(b.value), y = /\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/i.test(u), g = h.widgets?.find((x) => String(x.name).toLowerCase() === "subfolder")?.value || "", v = Ke(Xe(u, g)), j = e.state.objects.find((x) => x.id === "subject");
          if (j) {
            const x = await Nn(e, j, v, n, y);
            if (!n()) return;
            j.asset = Xe(u, g);
            let A = null;
            if (y)
              try {
                A = await Zp(u, o.signal);
              } catch (P) {
                if (P?.name === "AbortError") return;
                console.warn("Failed to describe upstream video:", P);
              }
            n() && Ar(e, x, {
              fps: A?.fps,
              frameCount: y ? A?.frame_count : 1
            }), e.upstreamImageConnected = !0, s = !0, e.setStatus(r(`Upstream ${y ? "video" : "image"}: ${u}`));
          }
        } else {
          const u = tl(h);
          u && (u instanceof HTMLVideoElement && u.paused && u.play().catch(() => {
          }), De(e, "subject", u, !1, u.currentSrc || u.src || ""), Ar(e, u, { frameCount: u instanceof HTMLVideoElement ? 0 : 1 }), e.upstreamImageConnected = !0, s = !0, e.render(), e.setStatus(u instanceof HTMLVideoElement ? r("Upstream video preview synced") : r("Upstream image preview synced")));
        }
      }
      if (d === "audio") {
        l = !0;
        ...
        if (b && b.value) {
          const u = String(b.value), y = h.widgets?.find((v) => String(v.name).toLowerCase() === "subfolder")?.value || "", g = Ke(Xe(u, y));
          try {
            const v = await fetch(g, { signal: o.signal });
            if (v.ok) {
              const j = await v.blob();
              if (!n()) return;
              const x = new File([j], u, { type: j.type || "audio/wav" });
              await e.loadAudioFile(x), e.upstreamAudioConnected = !0, s = !0, e.setStatus(r(`Upstream audio: ${u}`));
            }
          } catch (v) {
      ...
      if (d === "scene_3d" || d === "model" || d === "mesh") {
        ...
        if (b && b.value) {
          ...
          if (["glb", "gltf", "obj", "fbx", "stl", "ply"].includes(y)) {
            const g = h.widgets?.find((A) => String(A.name).toLowerCase() === "subfolder")?.value || "", v = Ke(Xe(u, g)), j = `upstream_scene_${h.id}`;
            m.add(j);
            let x = e.state.objects.find((A) => A.id === j);
            x ? (x.asset = Xe(u, g), x.format = y === "gltf" ? "glb" : y) : (x = {
              id: j,
              type: "model",
              format: y === "gltf" ? "glb" : y,
              ...
              enabled: !0,
              asset: Xe(u, g)
            }, e.state.objects.push(x)), e.modelUrlsById.set(j, v), e.serialize(), e.refreshObjects(), e.render(), s = !0, e.setStatus(r(`Upstream 3D model: ${u}`));
          }
        }
      }
    }
  ...
  if (!c && e.upstreamImageConnected) {
    ...
    f && (f.asset = ""), e.upstreamImageConnected = !1, s = !0, e.setStatus(r("Upstream image disconnected · card reset"));
  }
  !l && e.upstreamAudioConnected && (eo(e), e.upstreamAudioConnected = !1, e.refreshKeys(), s = !0, e.setStatus(r("Upstream audio disconnected · audio track cleared")));
  const p = e.state.objects.filter(
    (f) => f.id.startsWith("upstream_scene_") && !m.has(f.id)
  );
  if (p.length > 0) {
    for (const f of p)
      e.modelUrlsById.delete(f.id), e.modelInfoById.delete(f.id), e.webgl?.removeModel(f.id);
    e.state.objects = e.state.objects.filter(
      (f) => !p.some((d) => d.id === f.id)
    ), e.refreshObjects(), s = !0, e.setStatus(r("Upstream 3D scene disconnected · model removed"));
  }
  mc(e) && (s = !0), s && (e.serialize(), e.render());
}
const nf = ["video/mp4;codecs=avc1.42E01E", "video/webm;codecs=vp9", "video/webm;codecs=vp8", "video/webm"], Ir = { low: 3e6, balanced: 6e6, high: 12e6 };
function sf(e) {
  return Ir[e] || Ir.balanced;
}
async function cf({
  canvas: e,
  fps: t,
  ...
  try {
    for (const j of nf)
      if (!(s.isTypeSupported && !s.isTypeSupported(j)))
        try {
          f = new s(p, { mimeType: j, videoBitsPerSecond: sf(n) });
          break;
        } catch {
        }
    ...
    const d = [];
    f.ondataavailable = (j) => {
      j.data.size && d.push(j.data);
    };
    const h = new Promise((j, x) => {
      f.addEventListener("stop", j, { once: !0 }), f.addEventListener("error", () => x(f.error || new Error("MediaRecorder failed")), { once: !0 });
    });
    f.start(100);
    const b = c();
    for (let j = 0; j < a; j++) {
      if (i?.aborted) throw new DOMException("Playblast cancelled", "AbortError");
      await o(j), await l(1e3 / t);
    }
    f.stop(), await h;
    ...
    f?.state === "recording" && f.stop(), p.getTracks().forEach((d) => d.stop());
  }
}
...
async function df(e) {
  await Promise.all([...e].filter((t) => t instanceof HTMLVideoElement && t.seeking).map((t) => Dn(t, ["seeked", "error"], { timeout: 5e3 }).catch(() => {
  })));
}
async function Rn(e) {
  await df(e.cardMediaById.values());
}
async function qn(e) {
  return cf({
    canvas: e.canvas,
...
async function Bn(e, t) {
  const a = await lf(We, t);
  if (Np(e, t), e.state.playblast_camera_id === en)
  ...
  e.recordingWidget && (e.recordingWidget.value = a.path), e.serialize(), e.setStatus(r(`Playblast ready: ${a.name}`));
}
function mf(e) {
  const t = { width: e.canvas.width, height: e.canvas.height }, a = e.state.playblast_resolution || "output";
  if (a === "viewport") return t;
  const o = a === "half" ? 0.5 : a === "double" ? 2 : 1, n = Math.max(16, Math.round(Number(e.state.width) || t.width)), s = Math.max(16, Math.round(Number(e.state.height) || t.height)), c = Math.min(o, 3840 / Math.max(n * o, s * o)), l = (m) => Math.max(2, Math.round(m * c / 2) * 2);
...
async function pf(e) {
  ...
  const t = e.frame, a = e.canvas.width, o = e.canvas.height, n = mf(e);
  (n.width !== e.canvas.width || n.height !== e.canvas.height) && (e.canvas.width = n.width, e.canvas.height = n.height, e.render());
  try {
    let s = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-DkoCYcDU.js");
    i !== "realtime" && await l(e.canvas.width, e.canvas.height) && (s = await c(e.canvas, e.state.duration_frames, e.state.fps, async (m) => {
      e.setFrame(m, !0), e.setStatus(r(`Encoding frame ${m + 1}/${e.state.duration_frames}…`)), await Rn(e), await new Promise((p) => requestAnimationFrame(p));
    }, e.abortController?.signal, e.state.playblast_quality)), s || (e.setStatus(r("WebCodecs unavailable; recording realtime fallback…")), s = await qn(e)), e.setFrame(t), await Bn(e, s);
  } catch (s) {
    console.error(s), e.setStatus(r(`Playblast failed: ${s.message || s}`));
  } finally {
...
async function Wn(e) {
  if (!kt) throw new Error("ComfyUI API is unavailable");
  return Do(kt, { route: "/majoor/omnicam/upload_asset", field: "asset", file: e });
}
async function ao(e) {
  const t = e.map((a) => String(a.relative || "").replace(/^omnicam\//, "")).filter(Boolean);
  if (!(!t.length || !kt))
    try {
      await kt.fetchApi("/majoor/omnicam/cleanup", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
...
async function hf(e, t) {
  ...
  let n = null;
  try {
    if (e.setStatus(`Uploading background: ${t.name}`), n = await Wn(t), o !== e.backgroundRequestId || e.disposed) {
      await ao([n]);
      return;
    }
    const s = Ke(n.path);
    ...
    if (n && await ao([n]), o !== e.backgroundRequestId || e.disposed) return;
...
async function bf(e, t) {
  ...
  const o = Array.from(t).map((i) => jt(i, "image")).find(Boolean);
  if (o) {
    e.setStatus(o);
    return;
  }
  ...
  try {
    ...
    for (const c of t)
      if (s.push(await Wn(c)), n !== e.backgroundRequestId || e.disposed) {
        await ao(s);
        return;
      }
    ...
    e.checkpoint?.("Set background sequence"), e.state.viewport_bg_sequence = i, e.state.viewport_bg_image = "", e.viewportBgImage = null, e.viewportBgSequenceImages = i.map((c) => {
      const l = new Image();
      return l.src = Ke(c), l.decode().catch(() => {
      }), l;
    }), e.serialize(), e.render(), e.setStatus(`Background sequence loaded: ${t.length} frames`);
  } catch (i) {
    if (await ao(s), n !== e.backgroundRequestId || e.disposed) return;
    e.setStatus(`Failed to load BG sequence: ${i.message || i}`);
  }
}
function uf(e) {
  Uo(e), e.checkpoint?.("Clear background"), e.state.viewport_bg_image = "", e.state.viewport_bg_sequence = [], e.viewportBgImage = null, e.viewportBgSequenceImages = [], e.serialize(), e.render(), e.setStatus("Background cleared");
}
function gf(e) {
  const t = wo(e.state?.metadata?.viewport_labels);
  if (t.mode === "off") return;
  const a = Array.isArray(e.state?.objects) ? e.state.objects : [], o = e.viewportCamera(), n = e.ctx, s = e.canvas.width, i = e.canvas.height, c = Z(i / 720, 0.75, 4), l = Number(e.frame) || 0, m = e.selectedObjectIds instanceof Set ? e.selectedObjectIds : /* @__PURE__ */ new Set();
  n.save(), n.font = `${Math.round(12 * c)}px system-ui, -apple-system, "Segoe UI", Roboto, sans-serif`, n.textBaseline = "alphabetic";
  for (const p of a) {
    if (p.enabled === !1 || !Wr(p, { mode: t.mode, selectedIds: m })) continue;
    const f = Vr(p, t.content);
    if (!f) continue;
    const d = Hr(a, p, l) || { position: p.position, size: p.size }, h = Pe(Ur(d, p.type), o, s, i);
    if (!h) continue;
    const [b, u] = h, y = t.content === "annotation" && p.annotation?.color || "", g = 6 * c, v = 4 * c, x = n.measureText(f).width + g * 2, A = 12 * c + v * 2, P = Math.round(b - x / 2), D = Math.round(u - A - 6 * c);
    n.fillStyle = "rgba(16,17,22,0.82)", yf(n, P, D, x, A, 4 * c), n.fill(), y && (n.strokeStyle = y, n.lineWidth = Math.max(1, c), n.stroke()), n.fillStyle = y || "#e6e6ec", n.fillText(f, P + g, D + A - v - 2 * c);
  }
  n.restore();
}
function yf(e, t, a, o, n, s) {
...
function ne(e, t, a, o = "#5a5a5a", n = 1) {
  const s = e.viewportCamera(), i = Pe(t, s, e.canvas.width, e.canvas.height), c = Pe(a, s, e.canvas.width, e.canvas.height);
...
function xf(e) {
  ...
  return e._pointFieldCache?.key !== n && (e._pointFieldCache = { key: n, ...ki(t, a, o) }), e._pointFieldCache;
}
const kf = 600;
function wf(e) {
  const { points: t, colors: a } = xf(e);
  if (!t.length) return;
  const o = e.viewportCamera(), n = e.canvas.width, s = e.canvas.height, i = t.length / 3, c = 3 * Math.max(1, Math.ceil(i / kf)), l = /* @__PURE__ */ new Map();
  for (let m = 0; m < t.length; m += c) {
    const p = Pe([t[m], t[m + 1], t[m + 2]], o, n, s);
    if (!p) continue;
    const f = Z(Math.round(5 / Math.sqrt(p[2])), 1, 4), d = `${Math.round(a[m] * 255)},${Math.round(a[m + 1] * 255)},${Math.round(a[m + 2] * 255)}|${f}`;
    let h = l.get(d);
    h || (h = { fill: `rgb(${d.slice(0, d.indexOf("|"))})`, radius: f, xs: [], ys: [] }, l.set(d, h)), h.xs.push(p[0]), h.ys.push(p[1]);
  }
  for (const m of l.values()) {
    e.ctx.fillStyle = m.fill, e.ctx.beginPath();
    for (let p = 0; p < m.xs.length; p += 1)
      e.ctx.moveTo(m.xs[p] + m.radius, m.ys[p]), e.ctx.arc(m.xs[p], m.ys[p], m.radius, 0, Math.PI * 2);
    e.ctx.fill();
  }
}
function Sf(e, t) {
  const [a, o, n] = t.size || [1, 1, 1], [s, i, c] = t.position || [0, 0, 0], l = [
    ...
    [1, 1, 1],
    [-1, 1, 1]
  ].map((p) => [s + p[0] * a / 2, i + p[1] * o / 2, c + p[2] * n / 2]), m = [
    [0, 1],
    [1, 2],
    [2, 3],
    [3, 0],
  ...
  for (const [p, f] of m) ne(e, l[p], l[f], "#a0a0a0", 1.4);
}
function jf(e, t) {
...
function Cf(e, t) {
  const [a, o, n] = t.position || [0, 0, 0], s = t.size?.[1] || 1.8, i = (t.size?.[0] || 0.7) * 0.5, c = [a, o + s * 0.88, n], l = [a, o + s * 0.76, n], m = [a - i * 0.55, o + s * 0.73, n], p = [a + i * 0.55, o + s * 0.73, n], f = [a - i * 0.72, o + s * 0.52, n], d = [a + i * 0.72, o + s * 0.52, n], h = [a - i * 0.82, o + s * 0.34, n], b = [a + i * 0.82, o + s * 0.34, n], u = [a, o + s * 0.44, n], y = [a - i * 0.28, o + s * 0.44, n], g = [a + i * 0.28, o + s * 0.44, n], v = [a - i * 0.28, o + s * 0.22, n], j = [a + i * 0.28, o + s * 0.22, n], x = [a - i * 0.28, o, n + 0.05], A = [a + i * 0.28, o, n + 0.05];
  ne(e, c, l, "#aaa", 2), ne(e, l, u, "#aaa", 2), ne(e, m, p, "#aaa", 2), ne(e, m, f, "#aaa", 2), ne(e, f, h, "#aaa", 2), ne(e, p, d, "#aaa", 2), ne(e, d, b, "#aaa", 2), ne(e, y, g, "#aaa", 2), ne(e, y, v, "#aaa", 2), ne(e, v, x, "#aaa", 2), ne(e, g, j, "#aaa", 2), ne(e, j, A, "#aaa", 2);
  const P = Pe(c, e.viewportCamera(), e.canvas.width, e.canvas.height);
  P && (e.ctx.strokeStyle = "#aaa", e.ctx.beginPath(), e.ctx.arc(P[0], P[1], Z(28 / P[2], 3, 12), 0, Math.PI * 2), e.ctx.stroke());
}
function _f(e, t) {
  const [a, o, n] = t.position || [0, 0, 0], [s, i, c] = t.size || [1.5, 1.5, 1.5], l = s * 0.5, m = (c || s) * 0.5, p = i * 0.5, f = 12, d = [], h = [];
  for (let b = 0; b < f; b++) {
    const u = b / f * Math.PI * 2, y = Math.cos(u) * l, g = Math.sin(u) * m;
    d.push([a + y, o + p, n + g]), h.push([a + y, o - p, n + g]);
  }
  for (let b = 0; b < f; b++) {
    const u = (b + 1) % f;
    ne(e, d[b], d[u], "#aaa", 1.5), ne(e, h[b], h[u], "#aaa", 1.5);
  }
  for (let b = 0; b < f; b += 3)
    ne(e, d[b], h[b], "#aaa", 1.5);
}
function Ef(e, t) {
  const [a, o, n] = t.position || [0, 0, 0], [s, i, c] = t.size || [1.5, 1.5, 1.5], l = s * 0.5, m = s * 0.18, p = 16, f = [], d = [];
  for (let h = 0; h < p; h++) {
    const b = h / p * Math.PI * 2, u = Math.cos(b), y = Math.sin(b);
    f.push([a + u * (l + m), o, n + y * (l + m)]), d.push([a + u * (l - m), o, n + y * (l - m)]);
  }
  for (let h = 0; h < p; h++) {
    const b = (h + 1) % p;
    ne(e, f[h], f[b], "#aaa", 1.5), ne(e, d[h], d[b], "#aaa", 1.5), h % 4 === 0 && ne(e, f[h], d[h], "#888", 1);
  }
}
function $f(e, t) {
  const a = t.position || [0, 1, 0], o = 0.25;
  ne(e, ye(a, [-o, 0, 0]), ye(a, [o, 0, 0]), "#bbb", 2), ne(e, ye(a, [0, -o, 0]), ye(a, [0, o, 0]), "#bbb", 2), ne(e, ye(a, [0, 0, -o]), ye(a, [0, 0, o]), "#bbb", 2);
}
function Mf(e, t) {
  const [a, o, n] = t.position || [0, 1.5, 0], [s, i] = t.size || [2, 3], c = e.viewportCamera(), l = [
    [a - s / 2, o - i / 2, n],
    [a + s / 2, o - i / 2, n],
    [a + s / 2, o + i / 2, n],
    [a - s / 2, o + i / 2, n]
  ].map((y) => Pe(y, c, e.canvas.width, e.canvas.height));
  if (l.some((y) => !y)) return;
  const m = l.map((y) => y[0]), p = l.map((y) => y[1]), f = Math.min(...m), d = Math.max(...m), h = Math.min(...p), b = Math.max(...p);
  ...
  if (u)
    try {
      const y = Math.max(1, d - f), g = Math.max(1, b - h), v = u.videoWidth || u.naturalWidth || u.width, j = u.videoHeight || u.naturalHeight || u.height, x = e.state.card_fit || "contain";
      if (e.ctx.fillStyle = "#111", e.ctx.fillRect(f, h, y, g), x === "stretch" || !v || !j)
        e.ctx.drawImage(u, f, h, y, g);
      else if (x === "contain") {
        const A = Math.min(y / v, g / j), P = v * A, D = j * A;
        e.ctx.drawImage(u, f + (y - P) / 2, h + (g - D) / 2, P, D);
      } else {
        const A = Math.max(y / v, g / j), P = y / A, D = g / A;
        e.ctx.drawImage(u, (v - P) / 2, (j - D) / 2, P, D, f, h, y, g);
      }
    } catch {
    }
  else
...
function Af(e) {
  ...
  (e.state.cameras || []).forEach((a, o) => {
    ...
    if (!(i && e.state.view_mode === "camera")) {
      ...
      for (const c of n) {
        const l = Pe(c.camera.position, e.viewportCamera(), e.canvas.width, e.canvas.height);
      ...
      if (e.state.view_mode !== "camera") {
        const c = xe(a, e.frame, e.state.objects), l = Pe(c.position, e.viewportCamera(), e.canvas.width, e.canvas.height);
...
function Tf(e) {
  ...
  for (let o = 0; o < e.state.keyframes.length - 1; o++) {
    ...
    t.push(Be(Ee(s.camera.position, n.camera.position)) * e.state.fps / Math.max(1, s.frame - n.frame));
  }
...
function Pf(e) {
  ...
  if (!e.recording && e.state.view_mode === "camera" && e.state.guides !== !1) {
    ...
    for (const n of [a / 3, 2 * a / 3])
      t.moveTo(n, 0), t.lineTo(n, o);
    for (const n of [o / 3, 2 * o / 3])
      t.moveTo(0, n), t.lineTo(a, n);
    t.moveTo(a / 2 - 14, o / 2), t.lineTo(a / 2 + 14, o / 2), t.moveTo(a / 2, o / 2 - 14), t.lineTo(a / 2, o / 2 + 14), t.stroke(), t.restore();
  }
  if (!e.recording && e.state.view_mode === "camera" && e.state.safe_areas && (t.save(), t.strokeStyle = "#00d2d388", t.lineWidth = 1, t.setLineDash([4, 4]), t.strokeRect(a * 0.05, o * 0.05, a * 0.9, o * 0.9), t.strokeStyle = "#feca5788", t.strokeRect(a * 0.1, o * 0.1, a * 0.8, o * 0.8), t.restore()), !e.recording && e.state.view_mode === "camera" && pc(t, e.state, a, o), !e.recording && e.state.show_gizmo)
    try {
      e.drawTransformGizmo();
    } catch (n) {
      console.warn("[OmniCam Gizmo Error]", n);
    }
  if (!e.recording && e.boxSelection) {
    const { start: n, current: s } = e.boxSelection;
    t.save(), t.fillStyle = "rgba(74,163,239,.14)", t.strokeStyle = "#4aa3ef", t.lineWidth = 1.5, t.setLineDash([6, 4]), t.fillRect(n[0], n[1], s[0] - n[0], s[1] - n[1]), t.strokeRect(n[0], n[1], s[0] - n[0], s[1] - n[1]), t.restore();
  }
  if (!e.recording && e.state.show_radar)
    try {
      pm(e, t, a, o);
    } catch (n) {
      console.error("[OmniCam] radar overlay failed", n), e.radarError = String(n?.message || n);
    }
  if (!e.recording && e.state.view_mode !== "camera" && a > 1 && o > 1) {
    const n = Math.hypot(a, o) / 2, s = t.createRadialGradient(a / 2, o / 2, n * 0.62, a / 2, o / 2, n);
    s.addColorStop(0, "rgba(0,0,0,0)"), s.addColorStop(1, "rgba(0,0,0,0.28)"), t.save(), t.fillStyle = s, t.fillRect(0, 0, a, o), t.restore();
  }
  if (e.state.burn_in) {
    const n = e.viewportCamera();
    t.save(), t.fillStyle = "#000b", t.fillRect(0, o - 34, a, 34), t.fillStyle = "#fff", t.font = `${Math.max(12, Math.round(o * 0.025))}px monospace`, t.fillText(`F ${e.frame}/${e.state.duration_frames - 1}  ${e.state.fps}fps  FOV ${n.fov.toFixed(1)}  ${e.state.render_mode}`, 12, o - 12), t.restore();
  }
  e.recording && e.state.playblast_labels && gf(e);
}
async function If(e, { signal: t } = {}) {
...
async function Ff(e) {
  ...
  const n = o.diagnostic?.issues || [], s = zf(n);
  ...
  for (const i of n) {
    ...
    if (l.textContent = `• ${i.message} `, c.appendChild(l), i.docs) {
      ...
      m.href = i.docs, m.target = "_blank", m.rel = "noopener noreferrer", m.textContent = r("Setup docs"), c.appendChild(m);
    }
    a.appendChild(c);
  }
}
const Lf = 1, zr = 0.01, Of = 0.4, Kf = 3, Df = 120, Nf = 20, Rf = 4, qf = 0.25, Bf = 0.5;
function Wf(e, t, a) {
  const o = Be(Ee(t.camera.position, e.camera.position)), n = t.frame - e.frame, s = n / a, i = s > 1e-9 ? o / s : 1 / 0;
...
function Hf({ keys: e, fps: t = 24, objects: a = [] } = {}) {
  ...
  for (const c of s)
    ...
    }), c.distance < zr && c.duration >= Of && n.push({
      code: "STATIC_SEGMENT",
      severity: "info",
      frameStart: c.frameStart,
      frameEnd: c.frameEnd,
  ...
  if (i.length) {
    const c = i.reduce((l, m) => l + m, 0) / i.length;
    if (c > 1e-6)
      for (const l of s)
        Number.isFinite(l.speed) && l.speed > c * Kf && n.push({
          code: "SPEED_SPIKE",
          severity: "warning",
  ...
  for (let c = 1; c < o.length - 1; c += 1) {
    const l = Ee(o[c].camera.position, o[c - 1].camera.position), m = Ee(o[c + 1].camera.position, o[c].camera.position), p = Be(l), f = Be(m);
    if (p < 1e-6 || f < 1e-6) continue;
    const d = Math.max(-1, Math.min(1, wi(l, m) / (p * f))), h = Math.acos(d) * 180 / Math.PI;
    h >= Df && n.push({
  ...
  if (o.length >= Rf) {
    const c = o.reduce((h, b) => h + b.camera.position[0], 0) / o.length, l = o.reduce((h, b) => h + b.camera.position[2], 0) / o.length, m = o[0].camera.position, p = o[o.length - 1].camera.position;
    let f = Math.abs(Fr(p, c, l) - Fr(m, c, l)) % 360;
    f > 180 && (f = 360 - f);
    const d = Be(Ee(p, m));
    f <= Nf && d > zr && n.push({
  ...
  if (Array.isArray(a) && a.length)
    for (const c of o)
      for (const l of a) {
        ...
        const m = Number.isFinite(Number(l.radius)) ? Number(l.radius) : Bf;
        Be(Ee(c.camera.position, l.position)) < m + qf && n.push({
...
function Yf(e, { perFrame: t = !1 } = {}) {
  const a = e.activeCameraTrack(), o = Go(e, a), n = Xo(e, a);
  ...
  const i = (c) => Hn(e, a, c) || Gf(e, s, c);
  if (t) {
    const c = a.keyframes[0].frame, l = a.keyframes[a.keyframes.length - 1].frame, m = new Map(a.keyframes.map((p) => [p.frame, p]));
    for (let p = c; p <= l; p++) {
      const d = m.get(p) || { frame: p, camera: xe(a, p, e.state.objects), interpolation: "linear" };
      d.camera.target = [...i(p)], m.set(p, d);
    }
    a.keyframes = [...m.values()].sort((p, f) => p.frame - f.frame);
  } else
...
function Jf(e, t, a) {
  ...
  const i = (l) => {
    ...
    const m = o.value.trim().slice(0, 80);
    l && m && m !== t.name ? (e.checkpoint("Rename object"), t.name = m, e.serialize(), e.refreshObjects(), e.refreshKeys?.(), e.setStatus(r("Object renamed: {name}").replace("{name}", t.name))) : a.textContent = n;
  }, c = () => i(!0);
...
function Un(e) {
  ...
  t.innerHTML = "", t.onkeydown = (d) => {
    if (d.key === "ArrowUp" || d.key === "ArrowDown") {
      ...
      if (b >= 0) {
        d.preventDefault();
        const u = d.key === "ArrowDown" ? Math.min(h.length - 1, b + 1) : Math.max(0, b - 1);
        u !== b && (h[u].focus(), h[u].click(), h[u].scrollIntoView?.({ block: "nearest", behavior: "smooth" }));
      }
    }
  };
  ...
  const n = (d, h, b, u, y = "") => {
    ...
    return g.type = "button", g.className = "scene-action-btn", b && (g.style.cssText = y || "color:#f59e0b;border-color:#78350f;background:rgba(245,158,11,0.15)"), g.title = r(h), g.innerHTML = `<i class="pi ${d}" style="font-size:10px"></i>`, g.addEventListener("click", (v) => {
      v.stopPropagation(), u(v);
    }), g;
  }, s = (e.outlinerFilter || "").trim().toLowerCase(), i = (d) => !s || String(d || "").toLowerCase().includes(s), c = (d, h, b) => {
    const u = !!(e.outlinerCollapsedSections?.has(b) && !s), y = document.createElement("div");
    ...
    `, y.addEventListener("click", () => {
      e.outlinerCollapsedSections ||= /* @__PURE__ */ new Set(), e.outlinerCollapsedSections.has(b) ? e.outlinerCollapsedSections.delete(b) : e.outlinerCollapsedSections.add(b), Un(e);
    }), { header: y, isCollapsed: u };
  }, l = (d) => ["sun_light", "point_light", "spot_light"].includes(d), m = a === "all" || a === "cameras" || a === "hidden" && e.state.cameras.some((d) => d.muted), p = a === "all" || a === "objects" || a === "lights" || a === "hidden" && e.state.objects.some((d) => d.enabled === !1);
  if (m) {
    const d = e.state.cameras.filter((u) => !(!i(u.name) || a === "hidden" && !u.muted)), { header: h, isCollapsed: b } = c(r("Cameras"), d.length, "cameras");
    if (t.appendChild(h), !b)
      for (const u of d) {
        const y = document.createElement("div");
        y.role = "button", y.tabIndex = 0, y.dataset.cameraId = u.id;
        const g = u.id === e.state.active_camera_id, v = u.id === e.state.playblast_camera_id, j = e.selectedEntity === "camera" && g;
        y.setAttribute("aria-selected", String(j)), y.className = `scene-item${j ? " selected" : ""}${g && !j ? " active-view" : ""}`;
        const x = document.createElement("i");
        x.className = "pi pi-video", x.style.cssText = "color:#60a5fa";
        const A = document.createElement("span");
        if (A.className = "scene-item-label", j || g) {
          const F = document.createElement("span");
          F.style.cssText = `color:${j ? "#f59e0b" : "#58cc6b"};font-weight:700`, F.textContent = j ? "● " : "○ ", A.appendChild(F);
        }
        if (A.appendChild(document.createTextNode(u.name)), v) {
          const F = document.createElement("span");
          F.style.cssText = "color:#f2d06b;font-size:10px", F.title = "Playblast Output", F.textContent = " ★", A.appendChild(F);
        }
        if (u.muted) {
          const F = document.createElement("span");
          F.style.opacity = ".6", F.textContent = " (muted)", A.appendChild(F);
        }
        const P = document.createElement("div");
        P.className = "scene-item-actions", P.appendChild(n("pi-star", "Solo track", u.solo, () => {
          e.checkpoint("Solo track"), u.solo = !u.solo, e.serialize(), e.refreshObjects(), e.renderCameraView();
        }, "color:#fbbf24;border-color:#78350f;background:rgba(245,158,11,0.2)")), P.appendChild(n("pi-volume-off", "Mute track", u.muted, () => {
          e.checkpoint("Mute track"), u.muted = !u.muted, e.serialize(), e.refreshObjects(), e.renderCameraView();
        }, "color:#f87171;border-color:#7f1d1d;background:rgba(239,68,68,0.15)")), P.appendChild(n("pi-lock", "Lock track", u.locked, () => {
          e.checkpoint("Lock track"), u.locked = !u.locked, e.serialize(), e.refreshObjects(), e.renderCameraView();
        })), (u.keyframes || []).length >= 1 && P.appendChild(n(
          "pi-arrows-alt",
        ...
        )), P.appendChild(n("pi-ellipsis-v", "Camera actions", !1, (F) => e.openCameraContext(F, u.id, !1))), y.append(x, A, P), y.title = j ? r("Currently selected for editing") : v ? r("Active playblast camera") : r("Click to select & activate this camera");
        const D = () => {
          e.finishCameraEdit(), e.selectedEntity = "camera", e.selectedObjectId = null, e.editingKeyFrame = null, e.activateCamera(u.id), e.refreshObjects(), e.refreshKeys(), e.refreshInspector(), e.render(), e.setStatus(r(`Camera: ${u.name}`));
        };
        y.addEventListener("contextmenu", (F) => {
          F.preventDefault(), F.stopPropagation(), e.openCameraContext(F, u.id, !1);
  ...
  if (p) {
    const d = new Map(e.state.objects.map((x) => [x.id, x])), h = /* @__PURE__ */ new Map(), b = [];
    for (const x of e.state.objects)
      x.parent_id && d.has(x.parent_id) ? (h.has(x.parent_id) || h.set(x.parent_id, []), h.get(x.parent_id).push(x)) : b.push(x);
    const u = [], y = (x, A) => {
      u.push({ object: x, level: A });
      const P = h.get(x.id) || [];
      for (const D of P) y(D, A + 1);
    };
    ...
    }), { header: v, isCollapsed: j } = c(a === "lights" ? r("Lights") : r("Objects"), g.length, "objects");
    if (t.appendChild(v), !j)
      for (const { object: x, level: A } of g) {
        const P = document.createElement("div");
        P.role = "button", P.tabIndex = 0, P.dataset.objectId = x.id;
        const D = e.selectedEntity === "object" && (x.id === e.selectedObjectId || e.selectedObjectIds?.has?.(x.id)), F = e.selectedEntity === "object" && x.id === e.selectedObjectId;
        P.setAttribute("aria-selected", String(D)), P.className = `scene-item${D ? " selected" : ""}${F ? " primary" : ""}${A > 0 && !s ? " scene-item-child" : ""}`, A > 0 && !s && (P.style.paddingLeft = `${A * 16 + 6}px`);
        const U = x.type === "card" ? { icon: "pi-image", color: "#38bdf8" } : x.type === "model" || x.type === "glb" ? { icon: "pi-box", color: "#c084fc" } : x.type === "ground" ? { icon: "pi-minus", color: "#fbbf24" } : x.type === "cube" ? { icon: "pi-stop", color: "#fbbf24" } : x.type === "sphere" ? { icon: "pi-circle", color: "#fbbf24" } : x.type === "cylinder" ? { icon: "pi-database", color: "#fbbf24" } : x.type === "torus" ? { icon: "pi-circle", color: "#fbbf24" } : x.type === "pyramid" ? { icon: "pi-play", color: "#fbbf24" } : x.type === "sun_light" ? { icon: "pi-sun", color: "#f59e0b" } : x.type === "point_light" ? { icon: "pi-bolt", color: "#fbbf24" } : x.type === "spot_light" ? { icon: "pi-compass", color: "#38bdf8" } : x.type === "human" ? { icon: "pi-user", color: "#34d399" } : { icon: "pi-plus", color: "#94a3b8" }, B = x.enabled !== !1, V = !!x.load_error, Q = document.createElement("i");
        Q.className = `pi ${V ? "pi-exclamation-triangle" : U.icon}`, Q.style.cssText = V ? "color:#f87171" : B ? `color:${U.color}` : "opacity:.4";
        const w = document.createElement("span");
        w.className = "scene-item-label";
        const _ = document.createElement("span");
        _.style.cssText = V ? "color:#fca5a5" : B ? "" : "opacity:.5;text-decoration:line-through", _.textContent = x.name || x.type, _.title = r("Double-click to rename"), _.addEventListener("dblclick", (M) => {
          M.preventDefault(), M.stopPropagation(), Jf(e, x, _);
        }), w.appendChild(_);
        const z = Array.isArray(x.tags) ? x.tags : [];
        if (z.length) {
          const M = document.createElement("span");
          M.className = "scene-item-tags";
          for (const W of z.slice(0, 2)) {
            const C = document.createElement("span");
            C.className = "scene-item-tag", C.textContent = W, M.appendChild(C);
          }
          if (z.length > 2) {
            const W = document.createElement("span");
            W.className = "scene-item-tag scene-item-tag-more", W.textContent = `+${z.length - 2}`, M.appendChild(W);
          }
          w.appendChild(M);
        }
        if (V) {
          const M = document.createElement("span");
          M.style.cssText = "color:#ef4444;font-size:9px;font-weight:700", M.textContent = " [Format!]", w.appendChild(M);
        }
        const N = document.createElement("div");
        N.className = "scene-item-actions", N.appendChild(n(B ? "pi-eye" : "pi-eye-slash", B ? "Hide object (Alt+Click to Isolate)" : "Show object (Alt+Click to Isolate)", !B, (M) => {
          if (M?.altKey) {
            if (e.checkpoint("Isolate object"), e._isolatedObjectId === x.id) {
              ...
              for (const R of e.state.objects)
                R.enabled = C && Object.prototype.hasOwnProperty.call(C, R.id) ? C[R.id] : !0;
              e._isolationSnapshot = null, e.setStatus?.(r("Isolation cleared"));
            } else {
              e._isolationSnapshot || (e._isolationSnapshot = Object.fromEntries(e.state.objects.map((C) => [C.id, C.enabled !== !1]))), e._isolatedObjectId = x.id;
              for (const C of e.state.objects) C.enabled = C.id === x.id;
              e.setStatus?.(r("Isolated: {name}").replace("{name}", x.name || x.type));
            }
            e.serialize(), e.refreshObjects(), e.requestRender?.();
          } else
            e.toggleObject(x.id);
        }, "color:#ef4444;opacity:.7")), N.appendChild(n(x.locked ? "pi-lock" : "pi-lock-open", "Lock object", x.locked, () => qo(e, x))), N.appendChild(n("pi-copy", "Duplicate object", !1, () => e.duplicateObject?.(x.id))), x.id !== "subject" && N.appendChild(n("pi-trash", "Delete object", !1, () => e.deleteObject?.(x.id))), N.appendChild(n("pi-ellipsis-v", "Object actions", !1, (M) => e.openObjectContext(M, x.id))), P.append(Q, w, N), P.title = r("Click to select · Double-click to toggle visibility · Right-click for actions");
        const q = (M = {}) => {
          if (M.altKey && x.id !== "subject") return void e.deleteObject(x.id);
          if (e.finishCameraEdit(), e.selectedEntity = "object", e.selectedObjectIds ||= /* @__PURE__ */ new Set(), M.ctrlKey || M.metaKey)
            e.selectedObjectIds.has(x.id) ? e.selectedObjectIds.delete(x.id) : e.selectedObjectIds.add(x.id), e.outlinerAnchorId = x.id;
          else if (M.shiftKey && e.outlinerAnchorId && e.state.objects.some((C) => C.id === e.outlinerAnchorId)) {
            const C = e.state.objects.map((ae) => ae.id), R = C.indexOf(e.outlinerAnchorId), G = C.indexOf(x.id);
            e.selectedObjectIds = new Set(C.slice(Math.min(R, G), Math.max(R, G) + 1));
          } else
            e.selectedObjectIds = /* @__PURE__ */ new Set([x.id]), e.outlinerAnchorId = x.id;
          e.selectedObjectId = e.selectedObjectIds.has(x.id) ? x.id : [...e.selectedObjectIds].at(-1) || null, e.selectedEntity = e.selectedObjectIds.size ? "object" : "camera", e.selectedKeyFrame = e.selectedObjectId ? x.keyframes?.find((C) => C.frame === e.frame)?.frame ?? null : null, e.editingKeyFrame = null;
          for (const C of t.querySelectorAll(".scene-item")) {
            const R = !!(C.dataset.objectId && e.selectedObjectIds.has(C.dataset.objectId)), G = !!(C.dataset.objectId && C.dataset.objectId === e.selectedObjectId);
            C.classList.toggle("selected", R), C.classList.toggle("primary", G), C.dataset.objectId && C.setAttribute("aria-selected", String(R));
          }
          const W = e.root.querySelector('[data-role="outliner-batch-bar"]');
          if (W) {
            const C = e.selectedObjectIds?.size || 0;
            W.hidden = C < 2;
            const R = W.querySelector('[data-role="batch-count"]');
            R && (R.textContent = `${C} ${r("selected")}`);
          }
          e.refreshKeys(), e.refreshInspector(), e.render(), e.setStatus(r(`Selected: ${x.name || x.type}`));
        };
        P.addEventListener("dblclick", () => e.toggleObject(x.id)), P.addEventListener("contextmenu", (M) => {
          M.preventDefault(), M.stopPropagation(), e.openObjectContext(M, x.id);
        }), P.addEventListener("keydown", (M) => {
          (M.key === "Enter" || M.key === " ") && (M.preventDefault(), q(M));
        }), t.appendChild(P);
      }
  }
...
function Qf(e, t) {
  ...
  const a = `${t}_${Date.now().toString(36)}`, o = t === "ground", n = t === "human", s = t === "card", i = t === "cylinder", c = t === "torus", l = t === "pyramid", m = t === "sun_light", p = t === "point_light", f = t === "spot_light";
  let d;
  n ? d = r("Human Proxy") : s ? d = r("Card") : i ? d = r("Cylinder") : c ? d = r("Torus") : l ? d = r("Pyramide") : m ? d = r("Sun light") : p ? d = r("Point light") : f ? d = r("Spot light") : d = t[0].toUpperCase() + t.slice(1);
  let h;
  o ? h = [12, 0.1, 12] : n ? h = [0.7, 1.8, 0.4] : s ? h = [2, 3] : h = [1.5, 1.5, 1.5];
  let b = [0, 0, 0], u = [0, 0, 0], y = "#8c929b", g, v, j, x;
  m ? (b = [5, 8.5, 4], u = [-55, 35, 0], y = "#fff6ec", g = 2.2, v = !0) : p ? (b = [0, 3, 0], y = "#ffffff", g = 2, v = !1) : f && (b = [0, 4, 0], u = [-60, 0, 0], y = "#ffffff", g = 3, j = 45, x = 0.25, v = !0);
  const A = {
    id: a,
    type: t,
    name: d,
...
async function eh(e, t) {
  ...
  if (!a) return;
  const o = (await wt(e, r("Rename object"), r("Object name"), a.name || a.type))?.trim();
  e.disposed || !e.state.objects.includes(a) || !o || o === a.name || (e.checkpoint("Rename object"), a.name = o.slice(0, 80), e.serialize(), e.refreshObjects(), e.refreshKeys(), e.setStatus(r(`Object renamed: ${a.name}`)));
}
function Gn(e, t) {
  const a = e.state.objects.find((n) => n.id === t);
  if (!a) return;
  ...
  o.id = `${a.type}_${Date.now().toString(36)}_${Math.random().toString(36).slice(2, 6)}`, o.name = `${a.name || a.type} Copy`, o.position = ye(o.position || [0, 0, 0], [0.35, 0, 0.35]), (o.type === "model" || o.type === "glb") && e.modelUrlsById.has(a.id) ? e.modelUrlsById.set(o.id, e.modelUrlsById.get(a.id)) : o.type === "card" && e.cardMediaById.has(a.id) && De(e, o.id, e.cardMediaById.get(a.id), !1, o.asset || e.cardMediaAssetById?.get?.(a.id) || ""), e.state.objects.push(o), e.selectedEntity = "object", e.selectedObjectId = o.id, e.selectedObjectIds = /* @__PURE__ */ new Set([o.id]), e.serialize(), e.refreshObjects(), e.refreshKeys(), e.render(), e.setStatus(r(`${o.name} added`));
}
function th(e, t) {
  const a = e.state.objects.find((o) => o.id === t);
  a && (e.checkpoint(a.enabled === !1 ? "Show object" : "Hide object"), a.enabled = a.enabled === !1, e.serialize(), e.refreshObjects(), e.render(), e.setStatus(r(`${a.name || a.type} ${a.enabled ? "shown" : "hidden"}`)));
}
async function Xn(e, t) {
  if (t === "subject") return e.setStatus(r("The subject card cannot be deleted"));
  const a = e.state.objects.find((o) => o.id === t);
  if (a && await St(e, r("Delete object"), r(`Delete ${a.name || a.type} and its ${(a.keyframes || []).length} keyframe(s)?`)) && !(e.disposed || !e.state.objects.includes(a))) {
    e.checkpoint("Delete object");
    for (const o of e.state.objects) o.parent_id === t && (o.parent_id = null);
    e.state.objects = e.state.objects.filter((o) => o.id !== t), e.selectedObjectIds?.delete(t), e.removeObjectResources(t), e.selectedObjectId === t && (e.selectedEntity = "camera", e.selectedObjectId = null, e.selectedKeyFrame = e.state.keyframes.find((o) => o.frame === e.frame)?.frame ?? null), e.serialize(), e.refreshObjects(), e.refreshKeys(), e.render(), e.setStatus(r(`${a.name || a.type} deleted`));
  }
}
async function ah(e) {
...
function rh(e) {
  const t = _t(e), a = e.root.querySelector('[data-role="object-panel"]');
  a && (a.hidden = !t);
  const o = (w) => e.root.querySelector(w), n = e.activeCameraTrack(), s = o('[data-role="camera-target-object"]');
  if (s) {
    const w = n.target_object_id || e.state.target_object_id || "", _ = `T${ar()}${e.state.objects.map((z) => `${z.id}\0${z.name || z.type}`).join("|")}`;
    yo(s, _, () => [
      gt("", r("Manual Target (No Tracking)")),
      ...e.state.objects.map((z) => gt(z.id, `${r("Track:")} ${z.name || z.type}`))
    ], w);
  }
  Zf(e);
  const i = [...e.camera.position, ...e.camera.target, e.camera.fov, e.camera.roll || 0, e.camera.near, e.camera.far, ...Fo(e.camera)];
  ["camera-px", "camera-py", "camera-pz", "camera-tx", "camera-ty", "camera-tz", "camera-fov", "camera-roll", "camera-near", "camera-far", "camera-rx", "camera-ry", "camera-rz"].forEach((w, _) => {
    for (const z of e.root.querySelectorAll(`[data-role="${w}"]`))
      document.activeElement !== z && (z.value = String(Math.round(i[_] * 1e4) / 1e4));
  });
  ...
  if (!t) {
    ...
    w && (w.hidden = !0);
    const _ = o('[data-role="selected-name"]');
    _ && (_.textContent = `${n.name} · F${e.frame}`), Lr(o, {
  ...
  if (c) {
    ...
    if (w) {
      c.hidden = !1;
      const _ = w.semantic ? `${w.semantic} · ` : "";
      c.textContent = `${_}${w.label} (${Math.round(w.confidence * 100)}%)`, c.title = w.title, c.className = `oc-recon-badge oc-badge-${w.band}`;
    } else
      c.hidden = !0;
  }
  ...
  const m = t.position || [0, 0, 0], p = o('[data-role="selected-name"]');
  p && (p.textContent = t.name || t.type), Lr(o, {
  ...
  for (const [w, _] of Object.entries(h))
    for (const z of e.root.querySelectorAll(`[data-role="${w}"]`))
      document.activeElement !== z && (z.value = String(Math.round(_ * 1e4) / 1e4));
  ...
  if (y) {
    const w = t.id, _ = /* @__PURE__ */ new Set([w]);
    let z = !0;
    for (; z; ) {
      z = !1;
      for (const M of e.state.objects)
        !_.has(M.id) && M.parent_id && _.has(M.parent_id) && (_.add(M.id), z = !0);
    }
    const N = e.state.objects.filter((M) => !_.has(M.id)), q = `P${ar()}${w}${N.map((M) => `${M.id} ${M.name || M.type}`).join("|")}`;
    yo(y, q, () => [
      gt("", r("No parent")),
      ...N.map((M) => gt(M.id, M.name || M.type))
    ], t.parent_id || "");
  }
  const g = ["sun_light", "point_light", "spot_light"].includes(t.type), v = t.type === "spot_light", j = o('[data-role="light-props-row"]');
  j && (j.hidden = !g);
  const x = o('[data-role="spot-props-row"]');
  x && (x.hidden = !v);
  const A = o('[data-role="material-row"]');
  A && (A.hidden = g);
  const P = o('[data-role="scale-row"]');
  P && (P.hidden = g);
  const D = o('[data-role="rotation-row"]');
  if (D && (D.hidden = t.type === "point_light"), g) {
    ...
    const _ = o('[data-role="object-cast-shadow"]');
    if (_ && (_.checked = t.cast_shadow !== !1), v) {
      const z = o('[data-role="object-cone-angle"]');
      z && document.activeElement !== z && (z.value = String(t.cone_angle ?? 45));
      const N = o('[data-role="object-penumbra"]');
      N && document.activeElement !== N && (N.value = String(t.penumbra ?? 0.25));
    }
  }
  const F = e.modelInfoById.get(t.id);
  if (b && (b.hidden = !F?.animations), u) {
    const w = F?.animationNames || [];
    yo(u, `A${w.join("|")}`, () => w.map((_, z) => gt(String(z), _)), String(t.animation_index || 0));
  }
  const U = o('[data-role="object-tags"]');
  U && document.activeElement !== U && (U.value = (t.tags || []).join(", "));
  ...
  const Q = o('[data-role="object-annotation-anchor"]');
  Q && document.activeElement !== Q && (Q.value = t.annotation?.anchor || "top"), e.rigMapper?.sync(), e.poseEditor?.sync(), e.motionEditor?.sync();
}
function nh(e) {
  const t = _t(e);
  if (!t) return;
  ...
  const a = (c, l) => {
    const m = e.root.querySelector(`[data-role="${c}"]`);
    if (!m || m.value === "") return l;
  ...
  if ((e.lastObjectNumericEditId !== t.id || !Number.isFinite(e.lastObjectNumericEditAt) || i - e.lastObjectNumericEditAt > 300) && e.checkpoint?.("Edit object"), e.lastObjectNumericEditId = t.id, e.lastObjectNumericEditAt = i, t.position = [a("object-x", o[0]), a("object-y", o[1]), a("object-z", o[2])], t.rotation = [a("object-rx", n[0]), a("object-ry", n[1]), a("object-rz", n[2])], t.size = [Math.max(0.01, a("object-sx", s[0])), Math.max(0.01, a("object-sy", s[1])), Math.max(0.01, a("object-sz", s[2]))], ["sun_light", "point_light", "spot_light"].includes(t.type)) {
    ...
    if (l && (t.cast_shadow = l.checked), t.type === "spot_light") {
      const m = e.root.querySelector('[data-role="object-cone-angle"]');
      m && m.value !== "" && (t.cone_angle = Z(Number(m.value) || 45, 1, 90));
      const p = e.root.querySelector('[data-role="object-penumbra"]');
      p && p.value !== "" && (t.penumbra = Z(Number(p.value) || 0.25, 0, 1));
    }
  }
...
function Yn(e, t) {
  if (!t) return null;
  if (t.locked)
    return e.setStatus(r(`${t.name || t.type} is locked`)), null;
  t.keyframes ||= [];
  let a = Vn(
    t.keyframes,
    e.frame,
...
function ch(e) {
  ...
  const a = (s, i) => {
    ...
    Z(a("camera-rx", o[0]), -90, 90),
    a("camera-ry", o[1]),
    Z(a("camera-rz", o[2]), -180, 180)
  ];
  e.beginCameraEdit(), Si(e.camera, n), e.commitCameraEdit(), e.finishCameraEdit(), Zn(e), ih(e), e.render();
}
function lh(e) {
  const t = globalThis.performance?.now?.() ?? Date.now();
  (!Number.isFinite(e.lastCameraHudEditAt) || t - e.lastCameraHudEditAt > 300) && e.checkpoint("Edit camera"), e.lastCameraHudEditAt = t;
  ...
  e.camera.position = [a("camera-px", e.camera.position[0]), a("camera-py", e.camera.position[1]), a("camera-pz", e.camera.position[2])], e.camera.target = [a("camera-tx", e.camera.target[0]), a("camera-ty", e.camera.target[1]), a("camera-tz", e.camera.target[2])], e.camera.fov = Z(a("camera-fov", e.camera.fov), 5, 150), e.camera.roll = Z(a("camera-roll", e.camera.roll || 0), -180, 180), e.camera.near = Math.max(1e-4, a("camera-near", e.camera.near)), e.camera.far = Math.max(e.camera.near + 1e-4, a("camera-far", e.camera.far)), e.beginCameraEdit(), e.commitCameraEdit(), e.finishCameraEdit(), Zn(e), e.render();
}
function dh(e, t) {
  const a = _t(e);
  if (!a) return;
  ...
  e.setStatus(o ? r(`${a.name || a.type} parented to ${o.name || o.type}`) : r(`${a.name || a.type} unparented`));
}
function mh(e, t) {
  const a = _t(e);
  a && (e.checkpoint("Select animation"), a.animation_index = Math.max(0, t || 0), e.serialize(), e.webgl?.selectAnimation(a.id, t), e.setStatus(r(`Animation: ${e.modelInfoById.get(a.id)?.animationNames?.[t] || t + 1}`)));
}
function ph(e, t) {
  e.objectUrls.revoke(t), Ct(e, t), e.modelUrlsById.delete(t), e.modelInfoById.delete(t), e.webgl?.removeModel(t);
}
function fh(e) {
  const t = [...e.selectedObjectIds?.size ? e.selectedObjectIds : [e.selectedObjectId]].filter((o) => o && e.state.objects.some((n) => n.id === o));
  if (!t.length) return [];
  if (t.length === 1)
    return Gn(e, t[0]), e.selectedObjectId ? [e.selectedObjectId] : [];
  ...
  return t.forEach((o, n) => {
    ...
    const c = 0.35 + n * 0.15;
    i.position = ye(i.position || [0, 0, 0], [c, 0, c]), (i.type === "model" || i.type === "glb") && e.modelUrlsById.has(s.id) ? e.modelUrlsById.set(i.id, e.modelUrlsById.get(s.id)) : i.type === "card" && e.cardMediaById.has(s.id) && De(e, i.id, e.cardMediaById.get(s.id), !1, i.asset || e.cardMediaAssetById?.get?.(s.id) || ""), e.state.objects.push(i), a.push(i.id);
...
function xh(e) {
  ...
  const t = e.root.querySelector('[data-role="key-interp"]')?.value || e.root.querySelector('[data-role="interp"]')?.value || "ease", a = we(e), o = ve(e), n = a ? { frame: e.frame, transform: Ie(a), interpolation: t } : { frame: e.frame, camera: le(e.camera), interpolation: t }, s = o.findIndex((i) => i.frame === e.frame);
  s >= 0 ? o[s] = n : o.push(n), o.sort((i, c) => i.frame - c.frame), e.selectedKeyFrame = e.frame, e.selectedKeyFrames = /* @__PURE__ */ new Set([e.frame]), e.editingKeyFrame = null, e.serialize(), e.refreshKeys(), e.refreshKeyEditor(), e.updateKeyVisualState(), e.drawCurveEditor(), e.setStatus(r(`${a?.name || "Camera"} ${s >= 0 ? "key updated" : "key inserted"} @ ${e.frame}`));
}
function kh(e, t) {
  const a = ze(e);
  if (!a) return;
  ...
  o && (o.value = t);
  for (const n of e.root.querySelectorAll(".key-interp-buttons [data-interp]"))
    n.classList.toggle("active", n.dataset.interp === t);
  e.serialize(), e.refreshKeys(), e.refreshKeyEditor(), e.drawCurveEditor(), e.setStatus(r(`Key @ ${a.frame} interpolation set to ${t}`));
}
function wh(e) {
  const t = we(e), a = ve(e);
  ...
  const n = ve(e), s = o.frame;
  e.editingKeyFrame === s && (e.editingKeyFrame = null), e.selectedKeyFrame = n.length ? n.reduce((i, c) => Math.abs(c.frame - s) < Math.abs(i.frame - s) ? c : i).frame : null, e.camera = xe(e.state, e.frame), e.applyObjectAnimationFrame(), e.serialize(), e.refreshKeys(), e.render(), e.setStatus(r(`${t?.name || "Camera"} key deleted @ ${s}`));
}
function Sh(e) {
  const t = we(e), a = ze(e) || ve(e).find((o) => o.frame === e.frame);
  e.copiedKeyframe = t ? { kind: "object", transform: Ie(a?.transform || t), interpolation: a?.interpolation || e.root.querySelector('[data-role="interp"]')?.value || "ease" } : { kind: "camera", camera: le(a?.camera || e.camera), interpolation: a?.interpolation || e.root.querySelector('[data-role="interp"]')?.value || "ease" }, e.setStatus(r(`Keyframe copied @ ${a?.frame ?? e.frame}`));
}
function jh(e) {
  if (!e.copiedKeyframe) return e.setStatus(r("Copy a keyframe first"));
  const t = we(e), a = t ? "object" : "camera";
  if (e.copiedKeyframe.kind !== a) return e.setStatus(r(`Copy a ${a} keyframe first`));
  e.checkpoint("Paste keyframe");
  const o = t ? { frame: e.frame, transform: Ie(e.copiedKeyframe.transform), interpolation: e.copiedKeyframe.interpolation } : { frame: e.frame, camera: le(e.copiedKeyframe.camera), interpolation: e.copiedKeyframe.interpolation }, n = ve(e), s = n.findIndex((i) => i.frame === e.frame);
  s >= 0 ? n[s] = o : n.push(o), n.sort((i, c) => i.frame - c.frame), e.selectedKeyFrame = o.frame, e.editingKeyFrame = null, t ? (t.position = [...o.transform.position], t.rotation = [...o.transform.rotation], t.size = [...o.transform.size]) : e.camera = le(o.camera), e.serialize(), e.refreshKeys(), e.render(), e.setStatus(r(`Keyframe pasted @ ${o.frame}`));
}
function ze(e) {
  return ve(e).find((t) => t.frame === e.selectedKeyFrame) || null;
}
function Ch(e, t) {
  t && (e.selectedKeyFrame = t.frame, e.selectedKeyFrames = /* @__PURE__ */ new Set([t.frame]), e.editingKeyFrame = null, we(e) || (e.pathSelection = ji(e.pathSelection, { cameraId: e.state.active_camera_id, frame: t.frame, additive: !1 })), e.setFrame(t.frame));
}
function _h(e) {
  const t = e.activeCameraTrack();
  if (t?.locked)
    return e.setStatus(r(`${t.name} is locked`)), null;
  let a = Vn(
    e.state.keyframes,
    e.frame,
...
function Ah(e) {
  e.state.auto_key = !e.state.auto_key, e.state.auto_key || e.exitKeyEdit(!1), e.serialize(), e.updateEditState(), e.setStatus(r(`Auto Key ${e.state.auto_key ? "on" : "off"}`));
}
const Th = ["guides", "safe-areas", "resolution-gate", "aspect-ratio"];
function Ph(e) {
  ...
  for (const p of e.root.querySelectorAll('[data-act="auto-key"]'))
    p.classList.toggle("active", o), p.setAttribute("aria-pressed", String(o)), p.title = r(`Auto Key ${o ? "on" : "off"}`);
  const n = e.state.view_mode === "camera";
  for (const p of Th)
    for (const f of e.root.querySelectorAll(`[data-role="${p}"]`)) {
      f.disabled = !n;
      const d = f.closest("label");
      d && d.classList.toggle("oc-disabled", !n), f.title = n ? "" : r("Available in Camera View only");
    }
  ...
  const m = e.root.querySelector('[data-role="viewport-state"]');
  m && (a ? m.textContent = i ? `● EDITING ${i.name || i.type} @ F${e.editingKeyFrame}${o ? " · AUTO KEY" : ""}` : `● EDITING ${s.name} @ F${e.editingKeyFrame}${o ? " · AUTO KEY" : ""}` : o ? m.textContent = i ? `● AUTO KEY · ${i.name || i.type}` : `● AUTO KEY · ${s.name}` : i ? m.textContent = `SELECTED: ${i.name || i.type}` : m.textContent = e.state.view_mode === "camera" ? `CAMERA: ${s.name}` : `VIEW: ${e.state.view_mode.toUpperCase()}`), Mn(e), Nm(e), _e(e);
}
function Ih(e) {
...
function zh(e, t) {
  ...
  o && (o.value = t);
  for (const n of e.root.querySelectorAll("[data-tangent]"))
    n.classList.toggle("active", n.dataset.tangent === t);
  e.serialize(), e.refreshKeys(), e.refreshKeyEditor(), e.drawCurveEditor(), e.setStatus(r("Key @ {frame} tangent mode set to {mode}").replace("{frame}", String(a.frame)).replace("{mode}", t));
}
function Fh(e) {
  ...
  t.hidden = !1;
  const o = Hf({ keys: a, fps: e.state?.fps || 24, objects: e.state?.objects || [] });
  if (!o.length) {
    const n = document.createElement("div");
...
function Lh(e) {
  const t = we(e), a = ze(e), o = e.root.querySelector('[data-role="key-editor"]');
  o && (o.dataset.empty = String(!a));
  const n = e.root.querySelector('[data-role="selected-key-label"]');
  n && (n.textContent = a ? r(`${t?.name || "Camera"} Key @ ${a.frame}`) : r(`No ${t ? "object" : "camera"} key selected`));
  ...
  for (const h of s) {
    ...
    b && (b.disabled = !a || !!(t && !["key-frame", "key-interp", "key-tangent-mode"].includes(h)));
  }
  ...
  const m = a?.tangents?.mode || a?.tangent_mode || "auto", p = e.root.querySelector('[data-role="key-tangent-mode"]');
  p && document.activeElement !== p && (p.value = m);
  for (const h of e.root.querySelectorAll("[data-tangent]"))
    h.classList.toggle("active", !!(a && h.dataset.tangent === m)), h.disabled = !a;
  const f = e.root.querySelector('[data-role="key-timecode"]');
  if (f) {
    const h = Math.max(1, e.state?.fps || 24), b = a ? a.frame : e.frame, u = Math.floor(b / h), y = b % Math.round(h), g = String(Math.floor(u / 3600)).padStart(2, "0"), v = String(Math.floor(u % 3600 / 60)).padStart(2, "0"), j = String(u % 60).padStart(2, "0"), x = String(y).padStart(2, "0");
    f.textContent = `${g}:${v}:${j}:${x} (${b}f)`;
  }
  if (Fh(e), !a) return;
  if (t) {
    const h = e.root.querySelector('[data-role="key-frame"]');
    h && document.activeElement !== h && (h.value = String(a.frame));
    const b = e.root.querySelector('[data-role="key-interp"]');
    b && document.activeElement !== b && (b.value = a.interpolation);
    return;
  }
  const d = {
    "key-frame": a.frame,
    ...
    "key-timing-weight": tn(a)
  };
  for (const [h, b] of Object.entries(d)) {
    const u = e.root.querySelector(`[data-role="${h}"]`);
    u && document.activeElement !== u && (u.value = String(b));
  }
}
function Oh(e, t, a = !1, o = {}) {
  const n = ze(e);
  if (!n) return;
  const s = ve(e);
  let i = Z(Math.round(t), 0, e.state.duration_frames - 1);
  const c = (m) => s.some((p) => p !== n && p.frame === m);
  if (c(i) && a)
    for (let m = 1; m < e.state.duration_frames; m++) {
      const p = [i - m, i + m].filter((f) => f >= 0 && f < e.state.duration_frames).find((f) => !c(f));
      if (p !== void 0) {
        i = p;
        break;
      }
  ...
  if (c(i))
    return e.refreshKeyEditor(), e.setStatus(r(`Frame ${i} already has a keyframe`));
  if (i === n.frame) return;
  o.checkpoint !== !1 && e.checkpoint("Move keyframe");
  const l = e.editingKeyFrame === n.frame;
  n.frame = i, e.selectedKeyFrame = i, e.editingKeyFrame = l ? i : null, e.frame = i, s.sort((m, p) => m.frame - p.frame), e.serialize(), e.setFrame(i), e.setStatus(r(`Keyframe moved to ${i}`));
}
function Kh(e) {
  const t = ze(e);
  if (!t) return;
  if (e.checkpoint("Edit keyframe"), e.editingKeyFrame = t.frame, we(e)) {
    t.interpolation = e.root.querySelector('[data-role="key-interp"]').value, t.transform = Ie(we(e)), e.serialize(), e.setFrame(t.frame), e.setStatus(r(`Object keyframe updated @ ${t.frame}`));
    return;
  }
  const a = (n, s) => {
  ...
  if (t.interpolation = e.root.querySelector('[data-role="key-interp"]').value, t.camera.position = [a("key-px", t.camera.position[0]), a("key-py", t.camera.position[1]), a("key-pz", t.camera.position[2])], t.camera.target = [a("key-tx", t.camera.target[0]), a("key-ty", t.camera.target[1]), a("key-tz", t.camera.target[2])], t.camera.fov = Z(a("key-fov", t.camera.fov), 5, 150), t.camera.roll = Z(a("key-roll", t.camera.roll || 0), -180, 180), t.camera.zoom = Math.max(0.01, a("key-zoom", t.camera.zoom || 1)), t.camera.near = Math.max(1e-4, a("key-near", t.camera.near)), t.camera.far = Math.max(t.camera.near + 1e-4, a("key-far", t.camera.far)), t.camera.camera_type = e.root.querySelector('[data-role="key-camera-type"]').value, e.root.querySelector('[data-role="key-timing-weight"]')) {
    const n = Ci(t, a("key-timing-weight", tn(t)));
    n.timing ? t.timing = n.timing : delete t.timing;
  }
  e.camera = le(t.camera), e.frame = t.frame, e.serialize(), e.setFrame(t.frame), e.setStatus(r(`Keyframe updated @ ${t.frame}`));
}
function Dh(e) {
  const t = ze(e);
  t && (e.setFrame(t.frame), e.setStatus(r(`Loaded keyframe @ ${t.frame}`)));
}
function Nh(e, t) {
  const a = ve(e);
  if (!a.length) return;
...
function Bh(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: n, initializeTooltips: s, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: m, activeCameraTrack: p, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: b, syncActiveCameraTrack: u, syncFromWidgets: y, bindEditorEvents: g, activateCamera: v, addCamera: j, deleteCamera: x, drawPreviewOverlays: A, duplicateCamera: P, maximizeCameraPreview: D, refreshCameraPreviews: F, refreshCameraSelectors: U, renameCamera: B, setPlayblastCamera: V, toggleCameraView: Q, captureRealtime: w, makePlayblast: _, uploadDirectorPlayblast: z, waitForMediaFrame: N, computeAudioPeaks: q, loadAudioFile: M, releaseAudio: W, stopPlay: C, togglePlay: R, applyCameraPreset: G, applyCameraShake: ae, applyProxyPreset: oe, clearViewportBgImage: ee, loadViewportBgFile: se, loadViewportBgSequence: fe, drawCameraPath: de, drawCard: he, drawCube: be, drawGrid: O, drawHuman: H, drawLine3D: ie, drawNull: ce, drawOverlays: me, drawPointField: re, drawSpeedHeatmap: ke, drawSphere: Et, curveChannels: $t, drawCurveEditor: at, onCurvePointerDown: ot, onCurvePointerMove: rt, onCurvePointerUp: nt, onTimelinePointerDown: Mt, onTimelinePointerMove: At, onTimelinePointerUp: Tt, refreshKeys: st, resetCurveZoom: it, resetTimelineZoom: He, setChannelFilter: ct, setCurveInterpolation: lt, setTangentMode: dt, timelineFrameFromEvent: Pt, toggleCurveHandles: mt, zoomCurve: It, drawTransformGizmo: zt, frameTarget: Ft, gizmoAxes: Lt, gizmoGeometry: Ot, onPointerDown: Kt, onPointerMove: Dt, onPointerUp: Nt, onWheel: Rt, pickGizmo: qt, pickSceneObject: Bt, resetCamera: pt, setTransformMode: ft, setViewMode: Wt, viewportCamera: Vt, loadCardFile: no, loadExecutionPreview: so, loadMediaUrl: Ht, loadModelFile: Ut, loadSelectedReference: Gt, onModelLoaded: Xt, restoreAssets: Yt, syncUpstreamInputs: Zt, configureDomMedia: Jt, refreshSetupDiagnostic: ht, addMediaCard: Qt, addPrimitive: ea, applyObjectAnimationFrame: ta, beginCameraEdit: aa, beginObjectEdit: oa, commitCameraEdit: ra, commitObjectEdit: na, copyKeyframe: sa, deleteKeyframe: ia, deleteObject: ca, duplicateObject: la, exitKeyEdit: da, finishCameraEdit: ma, goToAdjacentKey: pa, insertKeyframe: fa, loadSelectedKeyView: ha, pasteKeyframe: ba, playblastCameraAtFrame: ua, refreshInspector: ga, refreshKeyEditor: ya, refreshObjects: va, removeObjectResources: xa, renameObject: ka, retimeSelectedKey: wa, selectKeyframe: Sa, selectedKeyframe: ja, selectedObject: Ca, selectObjectAnimation: _a, setKeyInterpolation: Ea, setObjectParent: $a, timelineKeyframes: Ma, timelineObject: Ne, toggleAutoKey: Aa, toggleObject: Ta, updateCameraFromHud: Pa, updateEditState: Ia, updateKeyVisualState: za, updateSelectedKey: Fa, updateSelectedObject: La, clamp: bt, cloneCamera: Oa, configureCore: Ka, defaultCamera: Da, sampleCamera: Fe, sampleObjectTransform: io, sanitizeState: Ue, worldTransform: Se } = e;
  return {
    setSelectMode(I) {
      if (["object", "vertex", "edge", "face"].includes(I)) {
        this.state.select_mode = I, this.subSelection = null;
        for (const T of this.root.querySelectorAll("[data-select-mode]")) {
          const S = T.dataset.selectMode === I;
        ...
        for (const T of this.root.querySelectorAll('[data-role="select-mode"]'))
          T.value = I;
        this.serialize(), this.syncFromWidgets(), this.render(), this.setStatus(`Select Mode: ${I.toUpperCase()}`);
      }
    },
    ...
    hideInternalWidgets() {
      for (const I of ["state_json", "recording_path", "card_asset"]) {
        const T = this.node.widgets?.find((S) => S.name === I);
    ...
    restoreHistorySnapshot(I) {
      ...
      const S = Or(this.state), k = new Set(this.state.objects.map((Y) => Y.id));
      this.state = Ue(T.state);
      const E = new Set(this.state.objects.map((Y) => Y.id));
      for (const Y of k) E.has(Y) || this.removeObjectResources(Y);
      this.frame = bt(T.frame, 0, this.state.duration_frames - 1);
      const $ = new Set(this.state.objects.map((Y) => Y.id)), K = Array.isArray(T.selectedObjectIds) ? T.selectedObjectIds : [T.selectedObjectId].filter(Boolean);
      this.selectedObjectIds = new Set(K.filter((Y) => $.has(Y))), this.selectedObjectId = this.selectedObjectIds.has(T.selectedObjectId) ? T.selectedObjectId : [...this.selectedObjectIds].at(-1) || null, this.selectedEntity = this.selectedObjectIds.size ? "object" : T.selectedEntity || "camera";
      const X = new Set(this.timelineKeyframes().map((Y) => Y.frame)), L = Array.isArray(T.selectedKeyFrames) ? T.selectedKeyFrames : [T.selectedKeyFrame].filter((Y) => Y != null);
      this.selectedKeyFrames = new Set(L.filter((Y) => X.has(Y))), this.selectedKeyFrame = this.selectedKeyFrames.has(T.selectedKeyFrame) ? T.selectedKeyFrame : [...this.selectedKeyFrames].at(-1) ?? null, this.pathSelection = _i(this.pathSelection, this.activeCameraTrack()), this.subSelection = T.subSelection || null, this.camera = Fe(this.state, this.frame), vt(this, this.activeCameraTrack(), this.camera, this.frame), this.cameraPreviewSignature = "", this.serialize(), S !== Or(this.state) && this.restoreAssets(), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
    },
    checkpoint(I) {
      this.history.checkpoint(I);
    },
    undo() {
      const I = this.history.undo();
      I && this.setStatus(`Undo: ${I}`);
    },
    redo() {
      const I = this.history.redo();
      I && this.setStatus(`Redo: ${I}`);
    },
    bindEditorEvents() {
      g(this);
    },
    ...
    async renameCamera(I) {
      return B(this, I);
    },
    duplicateCamera(I) {
      P(this, I);
    },
    async deleteCamera(I) {
      return x(this, I);
    },
    activateCamera(I) {
      v(this, I);
    },
    setPlayblastCamera(I) {
      V(this, I);
    },
    closeMenus(I = null) {
      for (const T of this.root.querySelectorAll(".toolbar-menu")) T !== I && (T.open = !1);
      this.hideContextMenu();
    },
    initializeTooltips() {
      s(this.root, this.interactionElement);
    },
    hideContextMenu() {
      this.contextMenu?.hide();
    },
    showContextMenu(I, T, S) {
      return this.contextMenu.show(I, T, S);
    },
    onContextMenu(I) {
      if (I.preventDefault(), I.stopPropagation(), I.stopImmediatePropagation?.(), I.altKey || this.state.navigation_profile === "simple" && I.target?.closest?.(".viewport-wrap")) return;
      const T = I.target, S = T.closest?.(".camera-preview-tile"), k = T.closest?.(".scene-item"), E = T.closest?.(".key");
      if (S) return this.openCameraContext(I, S.dataset.cameraId, !0);
      if (k?.dataset.cameraId) return this.openCameraContext(I, k.dataset.cameraId, !1);
      if (k?.dataset.objectId) return this.openObjectContext(I, k.dataset.objectId);
      if (E) {
        const $ = this.timelineKeyframes().find((K) => K.frame === Number(E.dataset.keyFrame));
        return $ && this.selectKeyframe($), this.openTimelineContext(I, !0);
      }
      if (T.closest?.('[data-role="keys"]'))
        return this.setFrame(this.timelineFrameFromEvent(I, T.closest('[data-role="keys"]'))), this.openTimelineContext(I, !1);
      if (T.closest?.(".curve-editor")) return this.openCurveContext(I);
      if (T.closest?.(".viewport-wrap")) {
        const $ = this.interactionElement.getBoundingClientRect(), K = (I.clientX - $.left) * this.canvas.width / Math.max(1, $.width), X = (I.clientY - $.top) * this.canvas.height / Math.max(1, $.height), L = this.pickSceneObject([K, X]);
        if (L) {
          if ((L.type === "object" || L.type === "object_keyframe") && L.object)
            return this.selectedEntity = "object", this.selectedObjectId = L.object.id, L.keyframe ? (this.setFrame(L.keyframe.frame), this.selectedKeyFrame = L.keyframe.frame) : this.selectedKeyFrame = L.object.keyframes?.find((Y) => Y.frame === this.frame)?.frame ?? null, this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), this.openObjectContext(I, L.object.id);
          if (["camera", "camera_target", "camera_keyframe"].includes(L.type) && L.camera)
            return this.selectedEntity = L.type === "camera_target" ? "camera_target" : "camera", this.selectedObjectId = null, this.activateCamera(L.camera.id), L.keyframe && (this.setFrame(L.keyframe.frame), this.selectedKeyFrame = L.keyframe.frame), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), L.type === "camera_keyframe" && L.keyframe ? this.openPathKeyContext(I, L.camera.id, L.keyframe.frame) : this.openCameraContext(I, L.camera.id, !1);
        }
        return this.openViewportContext(I);
      }
    },
    openViewportContext(I) {
      const T = this.selectedObject();
      this.showContextMenu(I, r("Viewport"), [
        {
          label: T ? `${r("Set key")} · ${T.name || T.type}` : `${r("Set key")} · ${this.activeCameraTrack().name}`,
          icon: "pi-key",
          shortcut: "I",
          run: () => this.insertKeyframe()
        },
        { label: r("Frame subject"), icon: "pi-search", shortcut: "F", run: () => this.frameTarget() },
        { label: r("Set camera target here"), icon: "pi-bullseye", help: r("Set camera Look-At target to this 3D point in the scene"), run: () => this.setTargetAtCursor(I) },
        null,
        {
          label: r("Add object"),
          icon: "pi-plus-circle",
    ...
    openObjectContext(I, T) {
      const S = this.state.objects.find(($) => $.id === T);
      if (!S) return;
      this.selectedEntity = "object", this.selectedObjectId = T, this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
      const k = ["sun_light", "point_light", "spot_light"].includes(S.type), E = this.selectedObjectIds?.size || 0;
      if (E >= 2 && this.selectedObjectIds.has(T)) {
        this.showContextMenu(I, `${E} ${r("objects selected")}`, [
          { label: r("Duplicate {count} objects").replace("{count}", String(E)), icon: "pi-copy", shortcut: "Shift+D", run: () => this.duplicateSelectedObjects() },
          ...
          { label: r("Delete {count} objects").replace("{count}", String(E)), icon: "pi-trash", danger: !0, shortcut: "Del", run: () => this.deleteSelectedObjects() },
          null,
          { label: r("Deselect all"), icon: "pi-times", shortcut: "Alt+A", run: () => this.deselectAll() }
        ]);
        return;
      }
      this.showContextMenu(I, S.name || S.type, [
        { label: r("Set key"), icon: "pi-key", shortcut: "I", run: () => this.insertKeyframe() },
        { label: r("Frame subject"), icon: "pi-search", shortcut: "F", run: () => this.frameTarget() },
        { label: r("Rename object…"), icon: "pi-pencil", run: () => this.renameObject(T) },
        { label: r("Duplicate object"), icon: "pi-copy", run: () => this.duplicateObject(T) },
        { label: S.enabled === !1 ? r("Show object") : r("Hide object"), icon: S.enabled === !1 ? "pi-eye" : "pi-eye-slash", run: () => this.toggleObject(T) },
        { label: S.locked ? r("Unlock object") : r("Lock object"), icon: S.locked ? "pi-lock" : "pi-lock-open", run: () => qo(this, S) },
        null,
        {
          label: r("Transform mode"),
          icon: "pi-arrows-alt",
          items: [
            { label: r("Translate"), icon: "pi-arrows-alt", shortcut: "W", checked: (this.state.gizmo_mode || "translate") === "translate", run: () => this.setTransformMode("translate") },
            { label: r("Rotate"), icon: "pi-refresh", shortcut: "E", checked: this.state.gizmo_mode === "rotate", run: () => this.setTransformMode("rotate") },
            { label: r("Scale"), icon: "pi-expand", shortcut: "R", disabled: k, checked: this.state.gizmo_mode === "scale", run: () => this.setTransformMode("scale") }
          ]
        },
        {
          ...
          icon: "pi-bullseye",
          items: [
            { label: r("Camera tracks this object (Look-At)"), icon: "pi-bullseye", help: r("Lock camera live look-at tracking to this moving object"), run: () => this.aimAtSelectedObject(T) },
            ...
            null,
            { label: r("Select hierarchy"), icon: "pi-sitemap", shortcut: "Shift+G", help: r("Select this object and all descendants"), run: () => this.selectHierarchy(T) }
          ]
        },
        ...k ? [
          {
        ...
        null,
        { label: r("Reset entire animation"), icon: "pi-replay", danger: !0, help: r("Delete every animation key and return position/rotation to zero"), run: () => this.resetObjectAnimation(T) },
        null,
        { label: r("Delete object"), icon: "pi-trash", danger: !0, disabled: T === "subject", help: T === "subject" ? r("The canonical subject card cannot be deleted") : r("Delete this object and its animation keys"), run: () => this.deleteObject(T) }
      ]);
    },
    openCameraContext(I, T, S = !1) {
      const k = this.state.cameras.find((E) => E.id === T);
      k && (this.selectedEntity = "camera", this.selectedObjectId = null, this.activateCamera(T), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), this.showContextMenu(I, `${k.name}${S ? " preview" : ""}`, [
        { label: r("Edit this camera"), icon: "pi-video", run: () => this.activateCamera(T) },
        {
          label: r("Select whole path — move / scale / rotate"),
          icon: "pi-arrows-alt",
          disabled: (k.keyframes || []).length < 1,
          run: () => {
            this.activateCamera(T), this.selectCameraPath() && this.setStatus(`${k.name} · ${r("whole path selected — move / scale / rotate")}`);
          }
        },
        { label: r("Set as primary / playblast"), icon: "pi-star", disabled: T === this.state.playblast_camera_id, run: () => this.setPlayblastCamera(T) },
        ...
        { label: this.state.maximized_camera_id === T ? r("Restore preview size") : r("Maximize preview"), icon: "pi-window-maximize", run: () => this.maximizeCameraPreview(T) },
        null,
        {
          label: r("Shot order & handles"),
          icon: "pi-sliders-h",
          items: [
            { label: r("Shot: move earlier"), icon: "pi-arrow-up", disabled: this.state.cameras.findIndex((E) => E.id === T) <= 0, run: () => this.moveShot(T, -1) },
            { label: r("Shot: move later"), icon: "pi-arrow-down", disabled: this.state.cameras.findIndex((E) => E.id === T) >= this.state.cameras.length - 1, run: () => this.moveShot(T, 1) },
            null,
            { label: r("Shot handles…"), icon: "pi-sliders-h", run: () => this.editShotHandles(T) }
          ]
        },
        null,
        { label: r("Rename camera…"), icon: "pi-pencil", run: () => this.renameCamera(T) },
        { label: r("Duplicate camera"), icon: "pi-copy", run: () => this.duplicateCamera(T) },
        { label: r("Create camera from current view"), icon: "pi-plus", run: () => this.addCamera() },
        null,
        { label: r("Reset entire animation"), icon: "pi-replay", danger: !0, help: r("Delete every camera key and return to a static zero pose at frame 0"), run: () => this.resetCameraAnimation(T) },
        null,
        { label: r("Delete camera"), icon: "pi-trash", danger: !0, disabled: this.state.cameras.length <= 1, run: () => this.deleteCamera(T) }
      ]));
    },
    openPathKeyContext(I, T, S) {
      const k = this.state.cameras.find((Y) => Y.id === T);
      if (!k) return;
      this.selectedEntity = "camera", this.selectedObjectId = null, this.activateCamera(T);
      const E = (k.keyframes || []).find((Y) => Y.frame === S) || null;
      E && this.selectKeyframe(E), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
      const $ = E ? po(E) : "auto", K = this.selectedKeyFrames?.size || 0, X = this.pathSelection?.component === "target", L = Zr(k, this.state.objects);
      this.showContextMenu(I, `Path key F${S}`, [
        ...
        null,
        {
          ...
          icon: "pi-bullseye",
          help: L ? r("Driven by Look At -- target editing is disabled") : void 0,
          items: [
            { label: r("Position"), checked: !X, run: () => this.setPathSelectionComponent("position") },
            {
              label: r("Target"),
              checked: X,
              disabled: L,
        ...
        },
        {
          ...
          items: sn.map((Y) => ({
            label: Rh(Y),
            checked: $ === Y,
            run: () => this.setSpatialHandleMode(Y)
          }))
        },
        {
          label: r("Keyframe operations"),
          icon: "pi-sliders-v",
          items: vo(this, i, t, Ne)
        },
        null,
        {
          label: K >= 2 ? r("Delete {count} keys").replace("{count}", String(K)) : r("Delete key"),
          icon: "pi-trash",
          danger: !0,
          disabled: (k.keyframes || []).length <= 1,
    ...
    moveShot(I, T) {
      const S = this.state.cameras.findIndex(($) => $.id === I), k = S + T;
      if (S < 0 || k < 0 || k >= this.state.cameras.length) return;
      this.checkpoint("Reorder shot");
      const [E] = this.state.cameras.splice(S, 1);
      this.state.cameras.splice(k, 0, E), this.cameraPreviewSignature = "", this.serialize(), this.refreshObjects(), this.refreshKeys(), this.renderCameraView(), this.setStatus(`Shot order: ${E.name} → #${k + 1}`);
    },
    async editShotHandles(I) {
      const T = this.state.cameras.find(($) => $.id === I);
      if (!T) return;
      const S = T.handles || { in: 0, out: 0 }, k = await i(t, r("Shot handles…"), "Handle frames: in,out", `${S.in},${S.out}`);
      if (k == null) return;
      const E = String(k).match(/^\s*(\d+)\s*[,;\s]\s*(\d+)\s*$/);
      if (!E) return this.setStatus("Handles must be two integers: in,out");
      this.checkpoint("Shot handles"), T.handles = { in: Math.min(600, Number(E[1])), out: Math.min(600, Number(E[2])) }, this.serialize(), this.setStatus(`${T.name} handles: ${T.handles.in} / ${T.handles.out}`);
    },
    openTimelineContext(I, T) {
      const S = this.selectedKeyFrames?.size || 0, k = this.selectedKeyframe(), E = k?.interpolation || "ease", $ = k && po(k) || "auto", K = ["ease", "linear", "bezier", "smooth", "ease_in", "ease_out", "sine", "cubic", "quintic", "expo", "back"], X = ["auto", "clamped", "vector", "free", "aligned", "flat"];
      this.showContextMenu(I, T ? `Keyframe F${this.selectedKeyFrame}` : `Timeline F${this.frame}`, [
        { label: r("Fit timeline view (F)"), icon: "pi-arrows-alt", shortcut: "F", run: () => He(this) },
        { label: r("Set / replace key"), icon: "pi-key", shortcut: "I", run: () => this.insertKeyframe() },
        { label: r("Copy selected key"), icon: "pi-copy", shortcut: "Ctrl+C", disabled: !k, run: () => this.copyKeyframe() },
        ...
        null,
        {
          ...
          items: K.map((L) => ({
            ...
            checked: E === L,
            run: () => this.setSelectedKeysInterpolation(L)
          }))
        },
        {
          label: r("Tangents"),
          ...
          items: X.map((L) => ({
            ...
            checked: $ === L,
            run: () => this.setSelectedKeysTangentMode(L)
          }))
        },
        {
          label: r("Markers"),
        ...
        null,
        {
          label: S >= 2 ? r("Delete {count} keys").replace("{count}", String(S)) : r("Delete selected key"),
          icon: "pi-trash",
          shortcut: "Delete",
          danger: !0,
          disabled: S < 2 && !k,
    ...
    addMarker() {
      ...
      this.checkpoint("Add marker"), this.state.markers = [...this.state.markers || [], { frame: this.frame, name: `Marker ${(this.state.markers || []).length + 1}`, color: "#f2d06b" }].sort((T, S) => T.frame - S.frame), this.serialize(), this.refreshKeys(), this.setStatus(`Marker @ F${this.frame}`);
    },
    removeNearestMarker() {
      const I = this.state.markers || [];
      if (!I.length) return;
      const T = I.reduce((S, k) => Math.abs(k.frame - this.frame) < Math.abs(S.frame - this.frame) ? k : S);
      this.checkpoint("Remove marker"), this.state.markers = I.filter((S) => S !== T), this.serialize(), this.refreshKeys(), this.setStatus(`Marker removed @ F${T.frame}`);
    },
    openCurveContext(I) {
      const T = this.selectedKeyFrames?.size || 0, S = T < 2 && !this.selectedKeyframe(), k = this.selectedKeyframe(), E = k?.interpolation || "ease", $ = k && po(k) || "auto", K = ["bezier", "smooth", "linear", "ease_in", "ease_out", "ease", "sine", "cubic", "quintic", "expo", "back"], X = ["auto", "clamped", "vector", "free", "aligned", "flat"];
      this.showContextMenu(I, r("Curve editor"), [
        { label: r("Fit all curves (Framing)"), icon: "pi-arrows-alt", shortcut: "F", run: () => it(this) },
        { label: r("Set key at playhead"), icon: "pi-key", shortcut: "I", run: () => this.insertKeyframe() },
        ...
        null,
        { label: T >= 2 ? r("Delete {count} keys").replace("{count}", String(T)) : r("Delete selected key"), icon: "pi-trash", danger: !0, disabled: S, run: () => this.deleteSelectedKeyframes() }
      ]);
    },
    ...
    refitNode() {
      ...
      const I = this.node;
      try {
        if (I && typeof I.computeSize == "function" && typeof I.setSize == "function") {
          const T = I.computeSize();
          Array.isArray(T) && I.setSize([I.size?.[0] ?? T[0], T[1]]);
        }
    ...
    resizeCanvas() {
      const I = this.root.querySelector(".viewport-wrap");
      if (!I) return;
      const T = Math.min(2, window.devicePixelRatio || 1), S = I.clientWidth || 320, k = I.clientHeight || 180, E = Math.max(320, Math.round(S * T)), $ = Math.max(180, Math.round(k * T));
      (this.canvas.width !== E || this.canvas.height !== $) && (this.canvas.width = E, this.canvas.height = $);
      for (const K of this.cameraPreviewCanvases.values()) {
        const X = K.clientWidth || 220, L = K.clientHeight || 124, Y = Math.max(T, qh / Math.max(1, X)), ue = Math.max(1, Math.round(X * Y)), $e = Math.max(1, Math.round(L * Y));
        (K.width !== ue || K.height !== $e) && (K.width = ue, K.height = $e);
      }
...
function Wh(e, t) {
  ...
  const o = an();
  o.position = [0, 0, 0], o.target = [0, 0, -1], a.camera = le(o), a.keyframes = [{ frame: 0, camera: le(o), interpolation: "ease" }], e.state.active_camera_id = a.id, e.state.camera = le(o), e.state.keyframes = a.keyframes, e.camera = le(o), e.frame = 0, e.selectedEntity = "camera", e.selectedObjectId = null, e.selectedKeyFrame = 0, e.editingKeyFrame = null, e.cameraEditKey = null, e.cameraEditActive = !1, e.cameraPreviewSignature = "", Qn(e), e.refreshCameraSelectors(), e.setStatus(r(`${a.name} animation reset`));
}
function Vh(e, t) {
  const a = e.state.objects.find((o) => o.id === t);
  a && (e.checkpoint("Reset object animation"), a.keyframes = [], a.position = [0, 0, 0], a.rotation = [0, 0, 0], e.frame = 0, e.selectedEntity = "object", e.selectedObjectId = a.id, e.selectedKeyFrame = null, e.editingKeyFrame = null, Qn(e), e.setStatus(r(`${a.name || a.type} animation reset`)));
}
const Kr = { motion: "motion", shot: "display", health: "health" }, Hh = {
  object: "Object",
  camera: "Camera",
  camera_target: "Look-At Target",
  camera_path: "Camera Path"
}, Uh = { motion: "Motion", shot: "Shot", health: "Health" }, Gh = ["entity", "motion", "shot", "health"];
function es(e) {
  return e.inspectorMode && e.inspectorMode !== "entity" ? e.inspectorMode : "entity";
}
function Xh(e) {
  const t = es(e);
  return Kr[t] ? Kr[t] : e.selectedEntity === "object" ? "scene" : "camera";
}
function Yh(e) {
  return [
    e.selectedEntity || "",
...
function Zh(e) {
  const t = Yh(e);
  e._lastInspectorSelKey !== void 0 && e._lastInspectorSelKey !== t && (e.inspectorMode = "entity"), e._lastInspectorSelKey = t, ts(e);
}
function ts(e) {
  const t = Xh(e);
  ...
  n && (n.textContent = o === "entity" ? r(Hh[e.selectedEntity] || "Inspector") : r(Uh[o] || "Inspector"));
}
function Jh(e, t) {
  e.inspectorMode = Gh.includes(t) ? t : "entity", ts(e), e.render?.(), e.refitNode?.();
}
function Qh(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: n, initializeTooltips: s, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: m, activeCameraTrack: p, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: b, syncActiveCameraTrack: u, syncFromWidgets: y, bindEditorEvents: g, activateCamera: v, addCamera: j, deleteCamera: x, drawPreviewOverlays: A, duplicateCamera: P, maximizeCameraPreview: D, refreshCameraPreviews: F, refreshCameraSelectors: U, renameCamera: B, setPlayblastCamera: V, toggleCameraView: Q, captureRealtime: w, makePlayblast: _, uploadDirectorPlayblast: z, waitForMediaFrame: N, computeAudioPeaks: q, loadAudioFile: M, releaseAudio: W, stopPlay: C, togglePlay: R, applyCameraPreset: G, applyCameraShake: ae, applyProxyPreset: oe, clearViewportBgImage: ee, loadViewportBgFile: se, loadViewportBgSequence: fe, drawCameraPath: de, drawCard: he, drawCube: be, drawGrid: O, drawHuman: H, drawLine3D: ie, drawNull: ce, drawOverlays: me, drawPointField: re, drawSpeedHeatmap: ke, drawSphere: Et, curveChannels: $t, drawCurveEditor: at, onCurvePointerDown: ot, onCurvePointerMove: rt, onCurvePointerUp: nt, onTimelinePointerDown: Mt, onTimelinePointerMove: At, onTimelinePointerUp: Tt, refreshKeys: st, resetCurveZoom: it, resetTimelineZoom: He, setChannelFilter: ct, setCurveInterpolation: lt, setTangentMode: dt, timelineFrameFromEvent: Pt, toggleCurveHandles: mt, zoomCurve: It, drawTransformGizmo: zt, frameTarget: Ft, gizmoAxes: Lt, gizmoGeometry: Ot, onPointerDown: Kt, onPointerMove: Dt, onPointerUp: Nt, onWheel: Rt, pickGizmo: qt, pickSceneObject: Bt, resetCamera: pt, setTransformMode: ft, setViewMode: Wt, viewportCamera: Vt, loadCardFile: no, loadExecutionPreview: so, loadMediaUrl: Ht, loadModelFile: Ut, loadSelectedReference: Gt, onModelLoaded: Xt, restoreAssets: Yt, syncUpstreamInputs: Zt, configureDomMedia: Jt, refreshSetupDiagnostic: ht, addMediaCard: Qt, addPrimitive: ea, applyObjectAnimationFrame: ta, beginCameraEdit: aa, beginObjectEdit: oa, commitCameraEdit: ra, commitObjectEdit: na, copyKeyframe: sa, deleteKeyframe: ia, deleteObject: ca, deleteSelectedObjects: la, duplicateObject: da, exitKeyEdit: ma, finishCameraEdit: pa, goToAdjacentKey: fa, insertKeyframe: ha, loadSelectedKeyView: ba, pasteKeyframe: ua, playblastCameraAtFrame: ga, refreshInspector: ya, refreshKeyEditor: va, refreshObjects: xa, removeObjectResources: ka, renameObject: wa, retimeSelectedKey: Sa, selectKeyframe: ja, selectedKeyframe: Ca, selectedObject: _a, selectObjectAnimation: Ea, setKeyInterpolation: $a, setKeyTangentMode: Ma, setObjectParent: Ne, timelineKeyframes: Aa, timelineObject: Ta, toggleAutoKey: Pa, toggleObject: Ia, updateCameraFromHud: za, updateCameraRotationFromHud: Fa, updateEditState: La, updateKeyVisualState: bt, updateSelectedKey: Oa, updateSelectedObject: Ka, clamp: Da, cloneCamera: Fe, configureCore: io, defaultCamera: Ue, sampleCamera: Se, sampleObjectTransform: I, sanitizeState: T, worldTransform: S } = e;
  return {
    setChannelFilter(k) {
      ct(this, k);
    },
    setFrame(k, E = !1, $ = !0) {
      this.frame = Da(Math.round(k), 0, this.state.duration_frames - 1), this.editingKeyFrame !== this.frame && (this.editingKeyFrame = null), this.camera = Se(this.activeCameraTrack(), this.frame, this.state.objects), vt(this, this.activeCameraTrack(), this.camera, this.frame), this.applyObjectAnimationFrame();
      const K = this.dom ||= Cn(this.root);
      for (const J of K.frames) document.activeElement !== J && (J.value = String(this.frame));
      for (const J of K.scrubs) J.value = String(this.frame);
      for (const J of K.cameraFov) document.activeElement !== J && (J.value = String(Math.round(this.camera.fov * 100) / 100));
      for (const J of K.cameraRoll) document.activeElement !== J && (J.value = String(Math.round((this.camera.roll || 0) * 100) / 100));
      for (const J of K.cameraFocal) document.activeElement !== J && (J.value = Lo(this.camera.fov));
      for (const J of K.viewportZoom) J.textContent = `${(Number(this.camera.zoom) || 1).toFixed(2)}x`;
      for (const J of K.cameraType) document.activeElement !== J && (J.value = this.camera.camera_type || "perspective");
      for (const J of K.cameraNear) document.activeElement !== J && (J.value = String(this.camera.near ?? 0.01));
      for (const J of K.cameraFar) document.activeElement !== J && (J.value = String(this.camera.far ?? 1e4));
      const X = this.frame / this.state.fps;
      for (const J of this.cardMediaById.values()) J instanceof HTMLVideoElement && Number.isFinite(J.duration) && J.duration > 0 && (J.currentTime = X % J.duration);
      const L = Math.floor(X / 60), Y = Math.floor(X % 60), ue = Math.floor(X % 1 * 1e3), $e = this.frame % Math.max(1, Math.round(this.state.fps)), Re = Math.floor(this.frame / this.state.fps);
      if ((K.time || this.root.querySelector('[data-role="time"]')).textContent = this.state.timecode_mode === "timecode" ? `${String(Math.floor(Re / 3600)).padStart(2, "0")}:${String(Math.floor(Re / 60) % 60).padStart(2, "0")}:${String(Re % 60).padStart(2, "0")}:${String($e).padStart(2, "0")}` : `${String(L).padStart(2, "0")}:${String(Y).padStart(2, "0")}.${String(ue).padStart(3, "0")}`, $) this.refreshKeys();
      else {
        Ya(this);
    ...
    insertKeyframe() {
      for (const k of this.root.querySelectorAll('[data-act="key"]'))
        k.classList.remove("key-pulse"), k.offsetWidth, k.classList.add("key-pulse");
      ha(this);
    },
    setKeyInterpolation(k) {
      $a(this, k);
    },
    setKeyTangentMode(k) {
      Ma(this, k);
    ...
    resetCameraAnimation(k) {
      Wh(this, k);
    },
    resetObjectAnimation(k) {
      Vh(this, k);
    },
    selectedKeyframe() {
      return Ca(this);
    ...
    setSpatialHandleMode(k) {
      if (!sn.includes(k)) return;
      const $ = this.activeCameraTrack()?.keyframes || [], K = $.findIndex((X) => X.frame === this.selectedKeyFrame);
      if (K < 0) {
        this.setStatus(r("Select a camera keyframe first"));
        return;
      }
      this.checkpoint(r("Camera path handle: {mode}").replace("{mode}", k)), Lc($[K], k, {
        prevKey: $[K - 1] || null,
        nextKey: $[K + 1] || null
    ...
    setPathSelectionComponent(k) {
      this.pathSelection = Mi(this.pathSelection, k), this.refreshInspector(), this.render();
    },
    ...
    insertPathKeyAtCursor(k) {
      if (!k || !this.webgl?.pickPathSegment) return !1;
      const E = this.interactionElement.getBoundingClientRect(), $ = (k.clientX - E.left) * this.canvas.width / Math.max(1, E.width), K = (k.clientY - E.top) * this.canvas.height / Math.max(1, E.height), X = this.webgl.pickPathSegment([$, K]);
      if (!X) return !1;
      const L = (this.state.cameras || []).find((ue) => ue.id === X.cameraId);
      if (!L || L.locked) return !1;
      const Y = zc(L.keyframes || [], {
        leftFrame: X.leftFrame,
        rightFrame: X.rightFrame,
        t: X.t
      });
      return Y.ok ? (this.checkpoint(r("Insert camera path key")), L.id !== this.state.active_camera_id && this.activateCamera(L.id), L.keyframes = Y.keys, this.state.keyframes = Y.keys, this.camera = Se(L, this.frame, this.state.objects), L.camera = Fe(this.camera), $i(this, { cameraId: L.id, frame: Y.frame, additive: !1 }), this.serialize(), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), this.setStatus(r("Camera path key inserted at frame {frame}").replace("{frame}", String(Y.frame))), !0) : (this.setStatus(Y.reason === "no_free_frame" ? r("No free frame here to insert a key") : r("Could not insert a key here")), !0);
    },
    ...
    transformCameraPath(k) {
      const E = this.activeCameraTrack();
      if (!E || E.locked || !(E.keyframes?.length >= 1)) return !1;
      this.checkpoint("Transform camera path");
      const $ = Jr(E.keyframes, { origin: Yr(E.keyframes), ...k });
      return E.keyframes = $, E.id === this.state.active_camera_id && (this.state.keyframes = $), this.camera = Se(E, this.frame, this.state.objects), E.camera = Fe(this.camera), this.serialize(), this.refreshKeys(), this.refreshInspector(), this.render(), this.renderCameraView?.(), !0;
    },
    ...
    redistributeActiveCameraTiming() {
      const k = this.activeCameraTrack();
      if (!k || k.locked || !(k.keyframes?.length >= 2))
        return k?.keyframes?.length < 2 && this.setStatus(r("Need at least two keys to redistribute timing")), !1;
      const E = [...k.keyframes].sort((K, X) => K.frame - X.frame), $ = Ei(E, {
        startFrame: E[0].frame,
        endFrame: E[E.length - 1].frame
      });
      return $.ok ? (this.checkpoint(r("Redistribute camera path timing")), k.keyframes = $.keys, k.id === this.state.active_camera_id && (this.state.keyframes = $.keys), this.camera = Se(k, this.frame, this.state.objects), k.camera = Fe(this.camera), this.serialize(), this.refreshKeys(), this.refreshKeyEditor(), this.refreshInspector(), this.render(), this.setStatus(r("Camera path timing redistributed")), !0) : (this.setStatus($.reason === "insufficient_frame_slots" ? r("Not enough frame slots to redistribute this many keys") : r("Could not redistribute timing")), !1);
    },
    ...
    async openCameraPathPresetPicker() {
      const k = this.activeCameraTrack();
      if (!k || k.locked)
        return this.setStatus(r("{name} is locked").replace("{name}", k?.name || r("Camera"))), !1;
      const E = Ic.map((K) => ({ id: K, label: r(nr[K] || K) })), $ = await rn({ title: r("Camera Path Preset"), items: E, owner: this });
      return $ ? this.applyCameraPathPreset($) : !1;
    },
    applyCameraPathPreset(k, E = {}) {
      const $ = this.activeCameraTrack();
      if (!$ || $.locked)
        return this.setStatus(r("{name} is locked").replace("{name}", $?.name || r("Camera"))), !1;
      const [K, X] = Mo(this.state), L = Pc({ type: k, camera: this.camera, startFrame: K, endFrame: X, params: E });
      return L.ok ? (this.checkpoint(r("Apply camera path preset")), $.keyframes = L.keyframes, $.id === this.state.active_camera_id && (this.state.keyframes = L.keyframes), this.camera = Se($, this.frame, this.state.objects), $.camera = Fe(this.camera), this.serialize(), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), this.setStatus(r("{preset} camera path generated").replace("{preset}", r(nr[k] || k))), !0) : (this.setStatus(L.reason === "insufficient_frame_slots" ? r("Not enough frames in the playback range for this preset") : r("Could not generate that camera path preset")), !1);
    },
    toggleCurveHandles() {
      mt(this);
    },
    onTimelineWheel(k) {
      onTimelineWheel(this, k);
    },
    resetTimelineZoom() {
      He(this);
    },
    toggleInspector(k) {
      ...
      if (!E) return;
      const $ = k !== void 0 ? k : E.dataset.collapsed !== "true";
      E.dataset.collapsed = String($);
      for (const K of this.root.querySelectorAll('[data-act="toggle-inspector"]'))
        K.classList.toggle("active", !$), K.setAttribute("aria-pressed", String(!$));
    ...
    showAllObjects() {
      const k = this.state.objects.filter((E) => E.enabled === !1);
      if (k.length) {
        this.checkpoint("Show all objects");
        for (const E of k) E.enabled = !0;
        this.serialize(), this.refreshObjects(), this.render(), this.setStatus("All objects shown");
      }
    },
    selectHierarchy(k = this.selectedObjectId) {
      if (!k) return;
      const E = /* @__PURE__ */ new Set([k]);
      let $ = !0;
      for (; $; ) {
        $ = !1;
        for (const K of this.state.objects)
          K.parent_id && E.has(K.parent_id) && !E.has(K.id) && (E.add(K.id), $ = !0);
      }
      this.selectedObjectIds = E, this.selectedObjectId = k, this.selectedEntity = "object", this.refreshObjects(), this.refreshInspector(), this.render(), this.setStatus(`Hierarchy selected: ${E.size} object(s)`);
    },
    ...
    toggleSelectedObjects(k = null) {
      return hh(this, k);
    },
    lockSelectedObjects(k = null) {
      return bh(this, k);
    },
    selectAllObjects() {
      return uh(this);
    ...
    playblastCameraAtFrame() {
      return vt(this, d(this), ga(this, Se), this.frame);
    },
    viewportCamera() {
      return Vt(this);
    },
    ...
    setDensity(k) {
      ["basic", "animation", "advanced"].includes(k) || (k = "advanced"), this.state.ui_density = k, this.root.dataset.density = k, this.root.querySelector('[data-role="ui-density"]').value = k;
      ...
      }), this.setStatus(`Interface: ${k}`);
    },
    lookAtObject(k) {
      const E = this.state.objects.find(($) => $.id === k);
      if (E) {
        this.checkpoint("Look-at constraint");
        for (const $ of this.state.cameras)
          for (const K of $.keyframes) K.camera.target = [...E.position || [0, 1.5, 0]];
        this.camera = Se(this.state, this.frame), this.serialize(), this.refreshKeys(), this.render(), this.setStatus(`Cameras look at ${E.name || E.type}`);
      }
    },
    setTransformMode(k) {
      ft(this, k);
    ...
    refreshInspector() {
      this.perf && (this.perf.inspectorRefreshCount = (this.perf.inspectorRefreshCount || 0) + 1), ya(this), Zh(this);
    },
    setInspectorMode(k) {
      Jh(this, k);
    },
    ...
    applyProxyPreset(k) {
      const E = { balanced: { mode: "omni_ref", burn: !1 }, parallax: { mode: "point_field", burn: !1 }, subject: { mode: "card_grid", burn: !1 }, debug: { mode: "omni_ref", burn: !0 } }, $ = E[k] || E.balanced;
      this.state.render_mode = $.mode, this.state.burn_in = $.burn, this.root.querySelector('[data-role="mode"]').value = $.mode, this.root.querySelector('[data-role="burn-in"]').checked = $.burn, this.modeWidget && (this.modeWidget.value = $.mode), this.serialize(), this.render(), this.setStatus(`Proxy preset: ${k}`);
    },
    createH3Setup() {
    ...
    removeObjectResources(k) {
      ka(this, k);
    },
    aimAtSelectedObject(k) {
      this.checkpoint("Aim & track subject");
      const E = this.activeCameraTrack(), $ = k && this.state.objects.find((L) => L.id === k) || this.selectedObject() || this.state.objects.find((L) => L.id === "subject") || this.state.objects[0];
      if (!$) return;
      E.target_object_id !== $.id && (E.aim_bone = null), E.target_object_id = $.id, E.id === this.state.active_camera_id && (this.state.target_object_id = $.id, this.state.aim_bone = E.aim_bone);
      const X = ($.type === "model" || $.type === "glb" ? this.webgl?.getObjectWorldCenter?.($.id) : null) || ($.keyframes?.length ? I($, this.frame).position : $.position || [0, 1.5, 0]);
      this.camera.target = [...X], this.beginCameraEdit(), this.commitCameraEdit(), this.finishCameraEdit(), this.serialize(), this.refreshInspector(), this.updateHudCamera(), this.render(), this.setStatus(`Camera tracking locked to ${$.name || $.id}`);
    },
    setAimBone(k) {
      Xf(this, k);
    },
    ...
    setCameraTrackingTarget(k) {
      this.checkpoint("Change camera tracking target");
      const E = this.activeCameraTrack();
      E.target_object_id !== (k || null) && (E.aim_bone = null), E.target_object_id = k || null, E.id === this.state.active_camera_id && (this.state.target_object_id = k || null, this.state.aim_bone = E.aim_bone), this.camera = Se(E, this.frame, this.state.objects), vt(this, E, this.camera, this.frame), this.serialize(), this.refreshInspector(), this.render(), this.setStatus(k ? `Camera tracking: ${k}` : "Camera tracking disabled (manual target)");
    },
    bakeAimToKeyframes() {
      this.checkpoint("Bake aim to keyframes");
      const k = this.activeCameraTrack(), E = k.target_object_id || this.state.target_object_id || "subject", $ = this.state.objects.find((X) => X.id === E) || this.state.objects[0];
      if (!$ || !k.keyframes?.length) return;
      const K = $.type === "model" || $.type === "glb" ? this.webgl?.getObjectWorldCenter?.($.id) : null;
      for (const X of k.keyframes) {
        const L = ($.type === "model" || $.type === "glb") && K && !$.keyframes?.length ? K : $.keyframes?.length ? I($, X.frame).position : $.position || [0, 1.5, 0];
        X.camera.target = [...L];
      }
      k.id === this.state.active_camera_id && (this.state.keyframes = k.keyframes), this.serialize(), this.refreshKeys(), this.refreshInspector(), this.render(), this.setStatus(`Aim baked across all keyframes following ${$.name || $.id}`);
    }
  };
}
function eb(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: n, initializeTooltips: s, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: m, activeCameraTrack: p, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: b, syncActiveCameraTrack: u, syncFromWidgets: y, bindEditorEvents: g, activateCamera: v, addCamera: j, deleteCamera: x, drawPreviewOverlays: A, duplicateCamera: P, maximizeCameraPreview: D, refreshCameraPreviews: F, refreshCameraSelectors: U, renameCamera: B, setPlayblastCamera: V, toggleCameraView: Q, captureRealtime: w, makePlayblast: _, uploadDirectorPlayblast: z, waitForMediaFrame: N, computeAudioPeaks: q, loadAudioFile: M, releaseAudio: W, stopPlay: C, togglePlay: R, applyCameraPreset: G, applyCameraShake: ae, applyProxyPreset: oe, clearViewportBgImage: ee, loadViewportBgFile: se, loadViewportBgSequence: fe, drawCameraPath: de, drawCard: he, drawCube: be, drawGrid: O, drawHuman: H, drawLine3D: ie, drawNull: ce, drawOverlays: me, drawPointField: re, drawSpeedHeatmap: ke, drawSphere: Et, curveChannels: $t, drawCurveEditor: at, fitCurveView: ot, onCurveDoubleClick: rt, onCurvePointerDown: nt, onCurvePointerMove: Mt, onCurvePointerUp: At, onTimelinePointerDown: Tt, onTimelinePointerMove: st, onTimelinePointerUp: it, refreshKeys: He, resetCurveZoom: ct, resetTimelineZoom: lt, setChannelFilter: dt, setCurveInterpolation: Pt, setTangentMode: mt, timelineFrameFromEvent: It, toggleCurveHandles: zt, zoomCurve: Ft, drawTransformGizmo: Lt, frameTarget: Ot, gizmoAxes: Kt, gizmoGeometry: Dt, onPointerDown: Nt, onPointerMove: Rt, onPointerUp: qt, onWheel: Bt, pickGizmo: pt, pickSceneObject: ft, resetCamera: Wt, setTransformMode: Vt, setViewMode: no, viewportCamera: so, loadCardFile: Ht, loadExecutionPreview: Ut, loadMediaUrl: Gt, loadModelFile: Xt, loadSelectedReference: Yt, onModelLoaded: Zt, restoreAssets: Jt, syncUpstreamInputs: ht, configureDomMedia: Qt, refreshSetupDiagnostic: ea, addMediaCard: ta, addPrimitive: aa, applyObjectAnimationFrame: oa, beginCameraEdit: ra, beginObjectEdit: na, commitCameraEdit: sa, commitObjectEdit: ia, copyKeyframe: ca, deleteKeyframe: la, deleteObject: da, duplicateObject: ma, exitKeyEdit: pa, finishCameraEdit: fa, goToAdjacentKey: ha, insertKeyframe: ba, loadSelectedKeyView: ua, pasteKeyframe: ga, playblastCameraAtFrame: ya, refreshInspector: va, refreshKeyEditor: xa, refreshObjects: ka, removeObjectResources: wa, renameObject: Sa, retimeSelectedKey: ja, selectKeyframe: Ca, selectedKeyframe: _a, selectedObject: Ea, selectObjectAnimation: $a, setKeyInterpolation: Ma, setObjectParent: Ne, timelineKeyframes: Aa, timelineObject: Ta, toggleAutoKey: Pa, toggleObject: Ia, updateCameraFromHud: za, updateEditState: Fa, updateKeyVisualState: La, updateSelectedKey: bt, updateSelectedObject: Oa, clamp: Ka, cloneCamera: Da, configureCore: Fe, defaultCamera: io, sampleCamera: Ue, sampleObjectTransform: Se, sanitizeState: I, worldTransform: T } = e;
  return {
    setTargetAtCursor(S) {
      if (!S) return;
      const k = this.interactionElement.getBoundingClientRect(), E = (S.clientX - k.left) * this.canvas.width / Math.max(1, k.width), $ = (S.clientY - k.top) * this.canvas.height / Math.max(1, k.height), K = this.webgl?.intersectScenePoint?.(E, $, this.canvas.width, this.canvas.height);
      K && (this.checkpoint("Set camera target"), this.beginCameraEdit(), this.camera.target = [
        Math.round(K[0] * 1e3) / 1e3,
        Math.round(K[1] * 1e3) / 1e3,
        Math.round(K[2] * 1e3) / 1e3
    ...
    setPlaybackRange(S) {
      const k = this.state.playback_range || [0, this.state.duration_frames - 1];
      S === "start" ? k[0] = Math.min(this.frame, k[1]) : S === "end" && (k[1] = Math.max(this.frame, k[0])), this.state.playback_range = k, this.serialize(), this.refreshKeys(), this.setStatus(`Range: F${k[0]}–F${k[1]}`);
    },
    clearPlaybackRange() {
    ...
    async loadMediaUrl(S, k, E, $) {
      return Gt(this, S, k, E, $);
    },
    restoreAssets() {
      Jt(this);
    },
...
function ab(e) {
  const { right: t, up: a, forward: o } = Ai(e || {});
  return tb.map((n) => {
    const [s, i, c] = n.vector, l = s * t[0] + i * t[1] + c * t[2], m = s * a[0] + i * a[1] + c * a[2], p = -(s * o[0] + i * o[1] + c * o[2]);
    return { id: n.id, label: n.label, color: n.color, x: l, y: -m, depth: p };
  });
}
function ob(e) {
...
const nb = "http://www.w3.org/2000/svg", Ye = 26, Dr = 17, sb = 5.4;
function Ze(e, t) {
  const a = document.createElementNS(nb, e);
...
function ib(e) {
  ...
  for (const s of ob(ab(a))) {
    const i = Ye + s.x * Dr, c = Ye + s.y * Dr, l = rb(s.depth);
    ...
    const m = s.depth >= 0, p = Ze("circle", {
      cx: i,
      cy: c,
      r: sb,
      fill: m ? s.color : "transparent",
      stroke: s.color,
      "stroke-width": 1.4,
      opacity: l,
    ...
    if (f.textContent = r("View: {axis} axis").replace("{axis}", s.label), p.appendChild(f), t.appendChild(p), m) {
      const d = Ze("text", {
        x: i,
        y: c,
        "text-anchor": "middle",
      ...
      d.textContent = s.label, t.appendChild(d);
    }
  }
}
function cb(e, t, a, o, n) {
  if (["world_point", "object_point", "camera_field"].includes(t.source_kind)) {
    const s = zo(e, t.source, a, o, n);
    return s ? [s] : [];
  }
...
function lb(e) {
  ...
  for (const n of e.state.motion_layers || []) {
    ...
    const s = cb(e.state, n, e.frame, a, o);
    if (s.length) {
      t.strokeStyle = n.id === e.state.selected_motion_layer_id ? "#ffcc4d" : "#41d9c5", t.fillStyle = t.strokeStyle, t.lineWidth = n.id === e.state.selected_motion_layer_id ? 3 : 2, t.beginPath(), s.forEach((i, c) => {
        const l = i.x * a, m = i.y * o;
        c ? t.lineTo(l, m) : t.moveTo(l, m);
      }), t.stroke();
      for (const i of s)
...
const db = ["world_point", "object_point", "camera_field"], as = {
  manual_2d: "DRAW",
  object_point: "OBJECT",
  world_point: "WORLD",
...
function pb(e, t) {
  if (db.includes(t.source_kind)) {
    const a = zo(e, t.source, 0, e.width || 1280, e.height || 720);
...
function bb(e) {
  ...
  if (t.hidden = !a, !a) return;
  const o = Math.max(1, Number(e.state.fps) || 24), n = (a.keys || []).map((d) => Math.round(d.time_seconds * o)), s = (d, h) => {
    const b = t.querySelector(`[data-role="${d}"]`);
    b && (b.textContent = h);
  };
  s("motion-sel-name", a.label), s("motion-sel-type", as[a.source_kind] || "TRACK"), s("motion-sel-binding", mb(e.state, a)), s("motion-sel-start", n.length ? Math.min(...n) : 0), s("motion-sel-end", n.length ? Math.max(...n) : 0);
  ...
  const m = t.querySelector('[data-role="motion-interpolation"]');
  m && (m.value = a.keys?.[0]?.interpolation || "linear");
  const p = t.querySelector('[data-role="motion-key-visible"]');
  if (p) {
    const d = fb(a, (e.frame || 0) / o);
    p.checked = d ? d.visible !== !1 : !0;
  }
...
function yb(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: n, initializeTooltips: s, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: m, activeCameraTrack: p, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: b, syncActiveCameraTrack: u, syncFromWidgets: y, bindEditorEvents: g, activateCamera: v, addCamera: j, deleteCamera: x, drawPreviewOverlays: A, duplicateCamera: P, maximizeCameraPreview: D, refreshCameraPreviews: F, refreshCameraSelectors: U, renameCamera: B, setPlayblastCamera: V, toggleCameraView: Q, captureRealtime: w, makePlayblast: _, uploadDirectorPlayblast: z, waitForMediaFrame: N, computeAudioPeaks: q, loadAudioFile: M, releaseAudio: W, stopPlay: C, togglePlay: R, applyCameraPreset: G, applyCameraShake: ae, applyProxyPreset: oe, clearViewportBgImage: ee, loadViewportBgFile: se, loadViewportBgSequence: fe, drawCameraPath: de, drawCard: he, drawCube: be, drawCylinder: O, drawGrid: H, drawHuman: ie, drawLine3D: ce, drawNull: me, drawOverlays: re, drawPointField: ke, drawSpeedHeatmap: Et, drawSphere: $t, drawTorus: at, curveChannels: ot, drawCurveEditor: rt, onCurvePointerDown: nt, onCurvePointerMove: Mt, onCurvePointerUp: At, onTimelinePointerDown: Tt, onTimelinePointerMove: st, onTimelinePointerUp: it, refreshKeys: He, resetCurveZoom: ct, resetTimelineZoom: lt, setChannelFilter: dt, setCurveInterpolation: Pt, setTangentMode: mt, timelineFrameFromEvent: It, toggleCurveHandles: zt, zoomCurve: Ft, drawTransformGizmo: Lt, frameTarget: Ot, gizmoAxes: Kt, gizmoGeometry: Dt, onPointerDown: Nt, onPointerMove: Rt, onPointerUp: qt, onWheel: Bt, pickGizmo: pt, pickSceneObject: ft, resetCamera: Wt, setTransformMode: Vt, setViewMode: no, viewportCamera: so, loadCardFile: Ht, loadExecutionPreview: Ut, loadMediaUrl: Gt, loadModelFile: Xt, loadSelectedReference: Yt, onModelLoaded: Zt, restoreAssets: Jt, syncUpstreamInputs: ht, configureDomMedia: Qt, refreshSetupDiagnostic: ea, addMediaCard: ta, addPrimitive: aa, applyObjectAnimationFrame: oa, beginCameraEdit: ra, beginObjectEdit: na, commitCameraEdit: sa, commitObjectEdit: ia, copyKeyframe: ca, deleteKeyframe: la, deleteObject: da, duplicateObject: ma, exitKeyEdit: pa, finishCameraEdit: fa, goToAdjacentKey: ha, insertKeyframe: ba, loadSelectedKeyView: ua, pasteKeyframe: ga, playblastCameraAtFrame: ya, refreshInspector: va, refreshKeyEditor: xa, refreshObjects: ka, removeObjectResources: wa, renameObject: Sa, retimeSelectedKey: ja, selectKeyframe: Ca, selectedKeyframe: _a, selectedObject: Ea, selectObjectAnimation: $a, setKeyInterpolation: Ma, setObjectParent: Ne, timelineKeyframes: Aa, timelineObject: Ta, toggleAutoKey: Pa, toggleObject: Ia, updateCameraFromHud: za, updateEditState: Fa, updateKeyVisualState: La, updateSelectedKey: bt, updateSelectedObject: Oa, clamp: Ka, cloneCamera: Da, configureCore: Fe, defaultCamera: io, sampleCamera: Ue, sampleObjectTransform: Se, sanitizeState: I, worldTransform: T } = e;
  return {
    ...
    renderViewportOnly() {
      const S = this.ctx, k = this.canvas.width, E = this.canvas.height;
      if (S.fillStyle = this.state.viewport_bg_color || "#121212", S.fillRect(0, 0, k, E), this.viewportBgSequenceImages && this.viewportBgSequenceImages.length) {
        const te = this.frame % this.viewportBgSequenceImages.length, Le = this.viewportBgSequenceImages[te];
        if (Le?.complete && Le.naturalWidth)
          try {
            S.drawImage(Le, 0, 0, k, E);
          } catch {
          }
      } else if (this.viewportBgImage)
        try {
          S.drawImage(this.viewportBgImage, 0, 0, k, E);
        } catch {
        }
      const $ = this.state.render_mode, K = this.viewportCamera(), X = this.state.objects.some((te) => te.parent_id) ? this.state.objects.map((te) => te.parent_id ? { ...te, ...T(this.state.objects, te) } : te) : this.state.objects, L = (this.viewportBgSequenceImages || []).map((te) => te.src), Y = this.viewportBgImage?.src || "", ue = this.pendingExtractorImport, $e = ue ? [...this.state.cameras, {
        id: "__extractor_preview__",
        name: ue.label,
        color: "#9ca3af",
        camera: ue.track.keyframes[0]?.camera,
        keyframes: ue.track.keyframes
      }] : this.state.cameras, Re = {
        ...this.state,
        cameras: $e,
        objects: X,
        viewport_bg_image: Y,
        viewport_bg_sequence: L,
        __selectedObjectIds: [...this.selectedObjectIds || []],
        __omnicamRevision: `${this.renderRevision || 0}:${ue?.fingerprint || ""}`
      };
      let J = !1;
      if (this.webgl) {
        try {
          const te = this.recording ? 1 : this.webgl.supersampleFactor?.() ?? 1, Le = te > 1 ? Math.min(te, 4096 / Math.max(1, k, E)) : 1, Na = Le > 1 ? Math.round(k * Le) : k, co = Le > 1 ? Math.round(E * Le) : E;
          this.webgl.activeCamera && this.transformControlsWiring?.sync(), this.webgl.render(Re, K, this.cardMediaById, Na, co, this.modelUrlsById, this.frame, this.recording, this.selectedEntity, this.selectedObjectId, this.subSelection, this.selectedKeyFrame ?? null, this.selectedKeyFrames ? [...this.selectedKeyFrames] : null), S.imageSmoothingEnabled = !0, S.imageSmoothingQuality = "high", Na !== k || co !== E ? S.drawImage(this.webgl.canvas, 0, 0, Na, co, 0, 0, k, E) : S.drawImage(this.webgl.canvas, 0, 0, k, E), J = !0;
        } catch (te) {
      ...
      if (!J) {
        ...
        for (const te of X)
          te.enabled !== !1 && (te.type === "card" && ["omni_ref", "card_grid", "graybox", "wireframe"].includes($) ? this.drawCard(te) : ["cube", "ground", "glb", "model"].includes(te.type) && $ !== "grid" && $ !== "point_field" ? this.drawCube(te) : te.type === "sphere" && $ !== "grid" && $ !== "point_field" ? this.drawSphere(te) : te.type === "cylinder" && $ !== "grid" && $ !== "point_field" ? this.drawCylinder(te) : te.type === "torus" && $ !== "grid" && $ !== "point_field" ? this.drawTorus(te) : te.type === "human" && $ !== "grid" && $ !== "point_field" ? this.drawHuman(te) : te.type === "null" && this.drawNull(te));
        !this.recording && this.state.show_camera_paths && this.drawCameraPath();
      }
      !this.recording && this.state.speed_heatmap && this.drawSpeedHeatmap(), !this.recording && Sp(this), this.drawOverlays(), lb(this), this.state.show_gizmo && ib(this), this.labelOverlay?.update(), this.rigOverlay?.update(), this.perf && (this.perf.viewportRenderCount = (this.perf.viewportRenderCount || 0) + 1);
    },
    ...
    requestRender(S = "unknown") {
      return this.requestUiUpdate(je.viewport | je.previews | je.motion, S);
    },
    ...
    requestUiUpdate(S = je.viewport, k = "unknown") {
      (this.renderReasons ||= /* @__PURE__ */ new Set()).add(k), this.uiDirtyMask = Oc(this.uiDirtyMask, S), this.renderInvalidations = (this.renderInvalidations || 0) + 1, !this.renderScheduled && (this.renderScheduled = !0, this.renderFrame = requestAnimationFrame(() => {
        if (this.renderScheduled = !1, this.disposed) return;
        const E = this.uiDirtyMask || je.viewport;
        this.uiDirtyMask = 0, this.lastRenderReasons = [...this.renderReasons || []], this.renderReasons?.clear(), this.rendersCoalesced = (this.rendersCoalesced || 0) + 1, this.perf && (this.perf.renderCount = (this.perf.renderCount || 0) + 1), Ge(E, je.outliner) && this.refreshObjects(), Ge(E, je.timeline) && this.refreshKeys(), Ge(E, je.inspector) && this.refreshInspector(), Ge(E, je.viewport) && this.renderViewportOnly(), Ge(E, je.previews) && this.renderCameraView(), Ge(E, je.motion) && this.renderMotionUiOnly();
      }));
    },
    renderCameraView() {
      if (this.perf && (this.perf.previewRenderCount = (this.perf.previewRenderCount || 0) + 1), this.state.camera_view_visible) {
        ...
        const k = this.state.cameras, E = !!this.playing && !this.recording && k.length > 2;
        let $ = null;
        if (E) {
          const K = this.state.active_camera_id, X = k.filter((L) => L.id !== K);
          $ = X.length ? X[this.cameraPreviewTick % X.length] : null;
        }
        for (const K of k) {
          const X = this.cameraPreviewCanvases.get(K.id), L = this.cameraPreviewContexts.get(K.id);
          if (!X?.width || !L) continue;
          const Y = X.width, ue = X.height, $e = this.root.querySelector(`[data-camera-frame="${K.id}"]`);
          if ($e && ($e.textContent = `F${this.frame}`), E && K.id !== this.state.active_camera_id && K !== $) continue;
          const Re = vt(this, K, Ue(K, this.frame, this.state.objects), this.frame);
          if (L.fillStyle = "#111", L.fillRect(0, 0, Y, ue), this.cameraWebgl)
            try {
              this.cameraWebgl.render({ ...this.state, keyframes: [], playblast_grid: !1, viewport_bg_image: this.viewportBgImage?.src || "", viewport_bg_sequence: (this.viewportBgSequenceImages || []).map((J) => J.src), __omnicamRevision: this.renderRevision || 0 }, Re, this.cardMediaById, Y, ue, this.modelUrlsById, this.frame, !0), L.drawImage(this.cameraWebgl.canvas, 0, 0, Y, ue);
            } catch (J) {
    ...
    dispose() {
      this.disposed || (this.disposed = !0, this.agentBridge?.dispose?.(), this.transformControlsWiring?.dispose(), Ti(this), Pi(), fc(this), this.backgroundRequestId = (this.backgroundRequestId || 0) + 1, this.upstreamSyncId = (this.upstreamSyncId || 0) + 1, this.stopPlay(), clearTimeout(this.previewClickTimer), clearTimeout(this.connectionTimer), cancelAnimationFrame(this.restoreFrame), cancelAnimationFrame(this.serializeFrame), cancelAnimationFrame(this.resizeFrame), cancelAnimationFrame(this.renderFrame), this.abortController?.abort(), this.upstreamFetchController?.abort(), this.resizeObserver?.disconnect(), this.contextMenu?.dispose(), this.webgl?.dispose(), this.cameraWebgl?.dispose(), W(this), Yp(this), this.objectUrls.clear(), this.cardMediaById.clear(), this.cardMediaAssetById?.clear?.(), this.modelUrlsById.clear(), this.modelInfoById.clear());
    }
  };
}
const vb = 0.12;
function xb() {
  return {
    ...
    resolveSelectedFrames() {
      const e = new Set(ve(this).map((a) => a.frame));
    ...
    _activeTrack() {
      ...
      return {
        kind: "camera",
        write: (a) => {
          t.keyframes = a, this.state.keyframes = a, Co(this);
        }
      };
    },
    deleteSelectedKeyframes() {
      ...
      if (!e.length) {
        const l = ve(this).find((m) => m.frame === this.frame);
        l && (e = [l.frame]);
      }
      if (!e.length) return this.setStatus(r("Select a keyframe to delete"));
      const t = this._activeTrack(), a = ve(this), o = t.kind === "camera" ? 1 : 0, { keys: n, removed: s } = Rc(a, e, { minKeys: o });
      ...
      const i = ve(this), c = e[0];
      this.selectedKeyFrame = i.length ? i.reduce((l, m) => Math.abs(m.frame - c) < Math.abs(l.frame - c) ? m : l).frame : null, this.selectedKeyFrames = this.selectedKeyFrame != null ? /* @__PURE__ */ new Set([this.selectedKeyFrame]) : /* @__PURE__ */ new Set(), e.includes(this.editingKeyFrame) && (this.editingKeyFrame = null), this.camera = xe(this.state, this.frame), this.applyObjectAnimationFrame(), this.serialize(), this.refreshKeys(), this.render(), this.setStatus(s > 1 ? r("{n} keyframes deleted").replace("{n}", s) : r("Keyframe deleted"));
    },
    ...
    nudgeSelectedKeyframes(e) {
      ...
      const a = this._activeTrack(), o = Math.max(0, this.state.duration_frames - 1), n = Nc(ve(this), t, e, { lastFrame: o });
    ...
    setSelectedKeysInterpolation(e) {
      ...
      this.checkpoint(r("Interpolation on {n} keys").replace("{n}", t.length)), a.write(Dc(ve(this), t, e)), this.serialize(), this.refreshKeys(), this.refreshKeyEditor(), this.render(), this.drawCurveEditor(), this.setStatus(r("{mode} interpolation on {n} keys").replace("{mode}", e.replace(/_/g, " ")).replace("{n}", t.length));
    },
    setSelectedKeysTangentMode(e) {
      const t = this.resolveSelectedFrames();
      if (t.length < 2) return this.setTangentMode(e);
      const a = this._activeTrack(), o = Ve(this).map((n) => n.id);
      this.checkpoint(r("Tangents on {n} keys").replace("{n}", t.length)), a.write(Kc(ve(this), t, e, o)), this.serialize(), this.refreshKeys(), this.render(), this.drawCurveEditor(), this.setStatus(r("{mode} tangents on {n} keys").replace("{mode}", e).replace("{n}", t.length));
    },
    /**
    ...
    simplifyActiveKeys({ mode: e = "simplify", tolerance: t = 0, target: a = 0, scope: o = "camera", fromKeys: n = null, silent: s = !1 } = {}) {
      ...
      if (o === "object") {
        const b = we(this);
        if (!b) return this.setStatus(r("Select an animated object first"));
      ...
      const l = this.resolveSelectedFrames(), m = o !== "all_cameras" && l.length >= 2 ? [l[0], l.at(-1)] : null, p = m ? [] : l, f = (b) => {
        const u = [...b].sort((D, F) => D.frame - F.frame), y = m ? m[0] : -1 / 0, g = m ? m[1] : 1 / 0, v = u.filter((D) => D.frame < y), j = u.filter((D) => D.frame >= y && D.frame <= g), x = u.filter((D) => D.frame > g);
        let A = j, P = 0;
        if (j.length > 2) {
          const D = e === "reduce" ? qc(j, i, { target: a || Math.ceil(j.length / 2), keepFrames: p }) : e === "clean" ? Bc(j, i, { keepFrames: p }) : Wc(j, i, { tolerance: t * vb, keepFrames: p });
          A = D.keys, P = D.removed;
        }
        return { keys: [...v, ...A, ...x].sort((D, F) => D.frame - F.frame), removed: P };
      };
      let d = 0;
      const h = c.map((b) => {
        const u = n && b.primary ? n : b.get(), { keys: y, removed: g } = f(u);
        return d += g, { track: b, keys: y };
      });
      s || this.checkpoint(r("Simplify keyframes"));
      for (const { track: b, keys: u } of h) b.set(u);
      return Co(this), this.selectedKeyFrame = null, this.selectedKeyFrames = /* @__PURE__ */ new Set(), this.camera = xe(this.state, this.frame), this.applyObjectAnimationFrame(), this.serialize(), this.refreshKeys(), this.setFrame(this.frame, !1, !1), this.render(), s || this.setStatus(d ? r("Removed {n} keyframes").replace("{n}", d) : r("No keyframes to remove")), d;
    },
    keySimplifyToleranceFor(e) {
      return Z(Number(e) || 0, 0, 100) / 100;
    }
  };
}
on({ api: We });
...
class Yo {
  ...
  constructor(t) {
    this.runtime = t;
    const a = t.node;
    this.disposed = !1, this.app = Nr, this.api = We, this.node = a, this.root = Sn(), this.root.tabIndex = -1, this.dom = Cn(this.root), this.canvas = this.root.querySelector(".viewport-wrap > canvas"), this.cameraPreviewCanvases = /* @__PURE__ */ new Map(), this.cameraPreviewContexts = /* @__PURE__ */ new Map(), this.cameraPreviewSignature = "", this.interactionElement = this.canvas, this.interactionElement.tabIndex = 0, this.interactionElement.dataset.captureWheel = "true", this.ctx = this.canvas.getContext("2d", { alpha: !1 }), this.webgl = null, this.cameraWebgl = null, this.webglReady = this.loadWebGLViewports(), this.transformControlsWiring = nm(this), this.camera = xe(this.state, this.frame), this.playing = !1, this.drag = null, this.cameraEditActive = !1, this.cameraEditKey = null, this.keyDrag = null, this.timelineDrag = null, this.curveDrag = null, this.selectedKeyFrame = this.state.keyframes[0]?.frame ?? null, this.pathSelection = zi(), this.editingKeyFrame = null, this.copiedKeyframe = null, this.cameraSpeed = 1, this.cardMedia = null, this.cardMediaById = /* @__PURE__ */ new Map(), this.cardMediaAssetById = /* @__PURE__ */ new Map(), this.objectUrls = new wn(), this.cardUrlsById = this.objectUrls.urls, this.modelUrlsById = /* @__PURE__ */ new Map(), this.modelInfoById = /* @__PURE__ */ new Map(), this.executionReferences = [], this.selectedObjectId = null, this.selectedEntity = "camera", this.subSelection = null, this.cardUrl = null, this.recording = !1, this.gizmoDrag = null, this.playTimer = null, this.previewClickTimer = null, this.showCurveHandles = !0, this.uiDirtyMask = 0, this.perf = globalThis.__omnicamPerf === !0 ? { renderCount: 0, viewportRenderCount: 0, previewRenderCount: 0, timelineRefreshCount: 0, inspectorRefreshCount: 0, lastFrameMs: 0 } : null, this.contextMenu = new nn(this.root), this.history = new kn({ capture: () => JSON.stringify({ state: this.state, frame: this.frame, selectedEntity: this.selectedEntity, selectedObjectId: this.selectedObjectId, selectedObjectIds: [...this.selectedObjectIds || []], selectedKeyFrame: this.selectedKeyFrame, selectedKeyFrames: [...this.selectedKeyFrames || []], subSelection: this.subSelection }), restore: (o) => this.restoreHistorySnapshot(o) }), this.refreshCameraPreviews(), this.initializeTooltips(), this.bindEditorEvents(), this.bindWidgetCallbacks(), this.syncFromWidgets(), this.resizeCanvas(), this.render(), this.refreshKeys(), this.refreshObjects(), this.restoreAssets(), this.syncUpstreamInputs(), this.refreshSetupDiagnostic(), // Seed every frame-derived readout (timecode, lens millimetres, viewport
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-DkoCYcDU.js"));
    } catch (a) {
    ...
    if (!this.disposed) {
      ...
      Fi(this), this.resizeCanvas(), this.render(), this.renderCameraView();
    }
  }
}
const kb = [
...
for (const e of kb)
  Object.defineProperty(Yo.prototype, e, {
    configurable: !0,
    enumerable: !0,
    get() {
...
const Ha = { app: Nr, api: We, EditorHistory: kn, ContextMenuController: nn, initializeTooltips: hc, promptText: wt, ObjectUrlRegistry: wn, buildRoot: Sn, dispatchDirectorKey: Li, activeCameraTrack: jo, bindWidgetCallbacks: Xc, playblastCameraTrack: cn, restoreFromWidgets: Yc, serializeEditorState: Zc, syncActiveCameraTrack: Co, syncFromWidgets: Jc, bindEditorEvents: Op, activateCamera: bc, addCamera: uc, deleteCamera: gc, drawPreviewOverlays: yc, duplicateCamera: vc, maximizeCameraPreview: xc, refreshCameraPreviews: kc, refreshCameraSelectors: wc, renameCamera: Sc, setPlayblastCamera: jc, toggleCameraView: Cc, captureRealtime: qn, makePlayblast: pf, uploadDirectorPlayblast: Bn, waitForMediaFrame: Rn, computeAudioPeaks: Ln, loadAudioFile: Up, releaseAudio: eo, stopPlay: Xa, togglePlay: Wp, applyCameraPreset: sm, applyCameraShake: im, applyProxyPreset: cm, clearViewportBgImage: uf, loadViewportBgFile: hf, loadViewportBgSequence: bf, drawCameraPath: Af, drawCard: Mf, drawCube: Sf, drawCylinder: _f, drawGrid: vf, drawHuman: Cf, drawLine3D: ne, drawNull: $f, drawOverlays: Pf, drawPointField: wf, drawSpeedHeatmap: Tf, drawSphere: jf, drawTorus: Ef, curveChannels: Ve, drawCurveEditor: Al, fitCurveView: un, onCurveDoubleClick: $l, onCurvePointerDown: vl, onCurvePointerMove: xl, onCurvePointerUp: kl, onTimelinePointerDown: Oi, onTimelinePointerMove: Ki, onTimelinePointerUp: Di, refreshKeys: Wl, resetCurveZoom: Ml, resetTimelineZoom: Ni, setChannelFilter: Sl, setCurveInterpolation: wl, setTangentMode: jl, timelineFrameFromEvent: Ao, toggleCurveHandles: Cl, zoomCurve: El, drawTransformGizmo: Ri, frameTarget: qi, gizmoAxes: Bi, gizmoGeometry: Wi, onPointerDown: Vi, onPointerMove: Hi, onPointerUp: Ui, onWheel: Gi, pickGizmo: Xi, pickSceneObject: Yi, resetCamera: Zi, setTransformMode: Ji, setViewMode: Qi, viewportCamera: ec, loadCardFile: tf, loadExecutionPreview: af, loadMediaUrl: Nn, loadModelFile: ef, loadSelectedReference: of, onModelLoaded: Qp, restoreAssets: Jp, syncUpstreamInputs: rf, configureDomMedia: On, refreshSetupDiagnostic: Ff, addMediaCard: oh, addPrimitive: Qf, applyObjectAnimationFrame: vh, beginCameraEdit: _h, beginObjectEdit: Yn, commitCameraEdit: Eh, commitObjectEdit: sh, copyKeyframe: Sh, deleteKeyframe: wh, deleteObject: Xn, deleteSelectedObjects: ah, duplicateObject: Gn, exitKeyEdit: Mh, finishCameraEdit: $h, goToAdjacentKey: Nh, insertKeyframe: xh, loadSelectedKeyView: Dh, pasteKeyframe: jh, playblastCameraAtFrame: yh, refreshInspector: rh, refreshKeyEditor: Lh, refreshObjects: Un, removeObjectResources: ph, renameObject: eh, retimeSelectedKey: Oh, selectKeyframe: Ch, selectedKeyframe: ze, selectedObject: _t, selectObjectAnimation: mh, setKeyInterpolation: kh, setKeyTangentMode: zh, setObjectParent: dh, timelineKeyframes: ve, timelineObject: we, toggleAutoKey: Ah, toggleObject: th, updateCameraFromHud: lh, updateCameraRotationFromHud: ch, updateEditState: Ph, updateKeyVisualState: Ih, updateSelectedKey: Kh, updateSelectedObject: nh, clamp: Z, cloneCamera: le, configureCore: on, defaultCamera: an, sampleCamera: xe, sampleObjectTransform: oo, sanitizeState: tc, worldTransform: Po };
Object.assign(
  Yo.prototype,
  Bh(Ha),
  Qh(Ha),
...
function wb(e) {
  const t = e.node;
  xo("director:workbench:constructor:start", t);
  const a = new Yo(e);
  xo("director:workbench:constructor:complete", t), e.attachWorkbench(a), t.__majoorOmniCam = a, Ii(a);
  try {
    a.assetBrowser = Vd(a, {
      ...
      onAgentFirstOpen: async () => {
        if (ko())
          try {
            const { createDirectorAgentPanel: o } = await import("./chunk-h9_fYFYG.js");
            a.agentPanel = o(a);
          } catch (o) {
  ...
  return xo("director:workbench:ready", t), a;
}
function Sb(e) {
...
const Db = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  closeDirectorWorkbench: Sb,
  openDirectorWorkbench: wb
