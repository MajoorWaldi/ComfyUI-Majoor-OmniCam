...
J.registerExtension({
  ...
  async nodeCreated(e) {
    ...
    await kt(e, async () => {
      ...
      const { attachDirector: o } = await import("./chunk-DVTdtNI9.js").then((n) => n.g);
...
J.registerExtension({
  ...
  async nodeCreated(e) {
    if (Ue(e) !== mt) return;
    const t = !le, a = t ? null : At(e);
    await kt(e, async () => (await import("./chunk-D7XvIBUD.js")).attachExtractor), e.__majoorOmniCamExtractor && Tt(e, mt, t, a?.());
  }
});
J.registerExtension({
  ...
  async nodeCreated(e) {
    if (Ue(e) !== dt) return;
    const t = !le, a = t ? null : At(e);
    await kt(e, async () => (await import("./chunk-7gHn-rld.js")).attachMonitor), e.__majoorOmniCamMonitor && Tt(e, dt, t, a?.());
  }
});
export {
  Br as $,
