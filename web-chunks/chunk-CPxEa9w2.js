...
import { s as ne, a as re, c as mt, d as je, b as ut, e as fe, f as ht, l as Fe, n as Ae, g as $e, h as Y, m as _e, I as de, D as _t, r as Et, p as At, t as gt, i as pt, j as bt, k as Tt, w as wt, o as ze, q as yt, u as It, v as K } from "./chunk-d8qZJB0s.js";
import { s as Nt } from "./chunk-g2TpLNz1.js";
import { w as St } from "./chunk-CKLKPyqB.js";
import { c as Rt, w as Te, W as Ot } from "./chunk-DsoefGi0.js";
class kt {
...
class Ct extends EventTarget {
  constructor(t, { app: n, api: r } = {}) {
    ...
    this.state = ne(a), this.sceneBaseline = this.stateWidget?.value || JSON.stringify(this.state), this.sceneName = this.state.metadata?.scene_name || "", this.frame = 0, this.camera = re(this.state, 0), this.directorRevision = 0, this.renderRevision = 0, this.history = new kt({
      ...
      restore: (s) => {
        ...
        this.state = ne(i.state), this.frame = mt(i.frame, 0, this.state.duration_frames - 1), this.camera = re(this.state, this.frame);
      }
    });
  }
  ...
  flushToWidgets({ immediate: t = !1 } = {}) {
    t && (cancelAnimationFrame(this.serializeFrame), this.serializeScheduled = !1), Nt(this);
  }
  ...
  restoreFromWidgetsHeadless() {
    ...
    this.state = ne(t), this.camera = re(this.state, Math.min(this.frame, this.state.duration_frames - 1)), this.sceneBaseline = this.stateWidget?.value ?? this.sceneBaseline, this.sceneName = this.state.metadata?.scene_name || "", this.dispatchEvent(new CustomEvent("upstreamchange", { detail: { reason: "restore" } }));
  }
  ...
  replaceState(t, { reason: n = "replace" } = {}) {
    this.state = ne(t), this.sceneName = this.state.metadata?.scene_name || "", this.scheduleSerialize(n), this.dispatchEvent(new CustomEvent("upstreamchange", { detail: { reason: n } }));
  }
  attachWorkbench(t) {
...
const P = 1, Ke = 50, v = 120, J = 160, vt = Object.freeze(["perspective", "orthographic"]), _ = Object.freeze({
...
}), rt = Object.freeze(Object.values(_)), I = Object.freeze({
  SCENE_GET: "scene.get",
...
const Mt = /* @__PURE__ */ new Set(["good", "warning", "bad", "unknown"]);
function Dt(e, t) {
  ...
  for (const s of a.frames) {
    ...
    const o = Mt.has(s?.state) ? s.state : "unknown", c = s?.score;
    let h = null;
    if (c != null) {
      const u = Number(c);
...
const Ut = 25, He = 100;
function G(e, t) {
  const n = e?.offset === void 0 ? 0 : Number(e.offset), r = e?.limit === void 0 ? Ut : Number(e.limit);
...
function Pt(e, t) {
  ...
  switch (t?.type) {
    ...
    case I.CAMERA_LIST: {
      const r = n.cameras || [], { offset: a, limit: s, end: i } = G(t, r.length);
      return N(e, {
        version: 1,
        type: t.type,
        items: r.slice(a, i).map(Lt),
        total: r.length,
        offset: a,
        limit: s
      });
    ...
    case I.HEALTH_GET:
      return N(e, {
        version: 1,
        type: t.type,
        frames: Dt(n.metadata, n.duration_frames)
      });
    case I.ASSET_LIST: {
    ...
    case I.OBJECT_LIST: {
      const r = n.objects || [], { offset: a, limit: s, end: i } = G(t, r.length);
      return N(e, {
        version: 1,
        type: t.type,
    ...
    case I.OBJECT_SEARCH: {
      ...
      }, h = (n.objects || []).filter(c), { offset: u, limit: f, end: m } = G(t, h.length);
      return N(e, {
        version: 1,
        type: t.type,
    ...
    case I.CHARACTER_LIST: {
      const r = (n.objects || []).filter((o) => o.asset_kind === "character"), { offset: a, limit: s, end: i } = G(t, r.length);
      return N(e, {
        version: 1,
        type: t.type,
    ...
    case I.SHOT_LIST: {
      ...
      })), { offset: i, limit: o, end: c } = G(t, s.length);
      return N(e, {
        version: 1,
        type: t.type,
        items: s.slice(i, c),
    ...
    case I.KEYFRAME_LIST: {
      ...
      if (!a) throw new d("UNKNOWN_CAMERA", `Unknown camera: ${r}`);
      const s = a.keyframes || [], { offset: i, limit: o, end: c } = G(t, s.length);
      return N(e, {
        version: 1,
        type: t.type,
        cameraId: a.id,
...
function $t(e, t) {
  e.cameras ||= [];
  const n = new Set(e.cameras.map((i) => i.id)), r = Ee(n, "camera", t.id), a = { ...ut(), ...t.camera || {} }, s = {
    id: r,
    name: t.name || r,
    color: "#4aa3ef",
    locked: !1,
...
function Gt(e, t) {
  ...
  e.objects ||= [];
  const n = new Set(e.objects.map((i) => i.id)), r = Ee(n, t.objectType, t.id), a = Ft(t.objectType), s = {
    id: r,
    type: t.objectType,
    name: t.name || r,
    ...a,
...
function xt(e, t) {
  const n = [...e.position], r = Array.isArray(t) ? [...t] : [...e.target], a = ht(r, n), s = Fe(a) > 1e-9 ? Ae(a) : [0, 0, -1];
  let i = $e(s, Me);
...
function Je(e, t, n) {
  const r = n === "out" ? -1 : 1, a = Y(e.position, _e(e.forward, r * t));
  return [
    { position: e.position, target: e.target },
...
function We(e, t, n) {
  const r = n === "down" ? -1 : 1, a = Y(e.position, _e(Me, r * t));
  return [
    { position: e.position, target: e.target },
    { position: a, target: e.target }
  ];
}
function ae(e, { degrees: t = 180, direction: n = "cw", radius: r, radiusEnd: a, heightOffset: s = 0, samples: i = 5, close: o = !1 } = {}) {
  const c = e.target, h = e.position[0] - c[0], u = e.position[2] - c[2], f = Math.hypot(h, u) || 1e-6, m = Math.atan2(u, h), E = Number.isFinite(r) ? r : f, y = Number.isFinite(a) ? a : E, p = n === "ccw" ? 1 : -1, O = Math.abs(t) * Math.PI / 180 * p, C = Math.max(2, Math.round(i)), X = e.position[1] + s, b = [];
  for (let g = 0; g < C; g += 1) {
    const w = o ? g / C : g / (C - 1), k = m + O * w, j = E + (y - E) * w;
    b.push({
      position: [c[0] + Math.cos(k) * j, X, c[2] + Math.sin(k) * j],
      target: [...c]
    });
  }
  return b;
}
function nn({ type: e, camera: t, target: n, startFrame: r, endFrame: a, params: s = {} } = {}) {
  ...
  const c = xt(t, n), h = Number(s.distance) > 0 ? Number(s.distance) : 1, u = (p, O, C) => ({
  ...
  switch (e) {
    ...
    case "arc_right":
      ...
      break;
    case "orbit":
      f = ae(c, { ...u(180, s.direction === "ccw" ? "ccw" : "cw", 5), close: !!s.close });
      break;
    case "spiral":
      f = ae(c, {
...
function an(e, t) {
  ...
  for (n.has(t) && n.delete(t), n.add(t); n.size > rn; )
...
const on = /* @__PURE__ */ new Set(["translate", "rotate", "scale"]), cn = /* @__PURE__ */ new Set([
  "position",
  "target",
  "up",
  "fov",
...
function ln(e, t) {
  ...
  if (e.position !== void 0 && T(e.position, "camera.position", t), e.target !== void 0 && T(e.target, "camera.target", t), e.up !== void 0 && T(e.up, "camera.up", t), e.fov !== void 0 && (W(e.fov, "camera.fov", t), e.fov < 1 || e.fov > 179))
    throw new d("BAD_VALUE", "camera.fov must be within 1..179", t);
  if (e.roll !== void 0 && W(e.roll, "camera.roll", t), e.zoom !== void 0 && (W(e.zoom, "camera.zoom", t), e.zoom <= 0))
    throw new d("BAD_VALUE", "camera.zoom must be > 0", t);
  if (e.near !== void 0 && (W(e.near, "camera.near", t), e.near <= 0))
    throw new d("BAD_VALUE", "camera.near must be > 0", t);
  if (e.far !== void 0) {
    W(e.far, "camera.far", t);
...
function dn(e, t) {
  ...
  switch (n) {
    ...
    case _.CAMERA_PATH_INSERT_KEY:
      e.cameraId !== void 0 && A(e.cameraId, "cameraId", t), S(e.leftFrame, "leftFrame", t), S(e.rightFrame, "rightFrame", t), e.t !== void 0 && W(e.t, "t", t);
      break;
...
function fn(e, t) {
  ...
  return t.operations.forEach((n, r) => dn(n, r)), {
    version: P,
    id: t.id,
...
const mn = "omnicam/library", un = "majoor_omnicam/blockout_library", hn = Object.freeze({
...
function En(e) {
  return e.file ? `${e.source === "legacy" ? un : mn}/${e.file} [input]` : "";
}
function Qe(e, t, n) {
  const r = e || "asset";
  let a = `${r}_${n}`, s = 2;
...
function gn(e, t = {}) {
  ...
  const n = _n(t.point, [0, 0, 0]), r = String(t.idSeed || Date.now().toString(36)), a = String(e.kind || "prop"), s = a === "character", i = hn[e.id];
  ...
  return s && (o.character = An(e)), o;
}
function ur({ groundHit: e, orbitTarget: t } = {}) {
...
function Ie(e, t, n) {
  const r = D(e), a = t ? D(t) : r, s = n ? D(n) : r, i = Math.max(ye, R(e?.frame) - R(t?.frame, R(e?.frame) - 1)), o = Math.max(ye, R(n?.frame, R(e?.frame) + 1) - R(e?.frame)), c = [0, 0, 0], h = [0, 0, 0];
  for (let u = 0; u < 3; u += 1) {
...
function Se(e, t = null, n = null) {
  const r = ue(e), a = D(e);
  if (r === "corner") {
    const c = it(e, t, n);
    return { in: se(a, c.in), out: se(a, c.out), mode: r };
  }
  const s = Ie(e, t, n), i = (r === "free" || r === "aligned") && Ne(e, "out") || s.out, o = (r === "free" || r === "aligned") && Ne(e, "in") || s.in;
  return { in: se(a, o), out: se(a, i), mode: r };
}
function se(e, t) {
  return [e[0] + t[0], e[1] + t[1], e[2] + t[2]];
}
...
function ot(e, t, n) {
  const r = D(e), a = Se(e, t, n);
  H(e, "out", Q(a.out, r)), H(e, "in", Q(a.in, r));
}
function hr(e, t, n, { prevKey: r = null, nextKey: a = null, breakCoupling: s = !1 } = {}) {
  ...
  if (he(e), H(e, t, c), i === "aligned" && !s) {
    const h = t === "out" ? "in" : "out", u = Ne(e, h) || (h === "out" ? Ie(e, r, a).out : Ie(e, r, a).in), f = Xe(c), m = Xe(u) || f || 1, E = f > ye ? me(c, -m / f) : me(u, 1);
    H(e, h, E);
  }
  return e;
}
...
function _r(e, t, { prevKey: n = null, nextKey: r = null } = {}) {
...
function Ue(e, t) {
  const n = e.map((i) => bn(i, t)), r = Tn(n), a = e.map((i) => i.frame), s = Math.max(1, a[a.length - 1] - a[0]);
  return n.map((i, o) => [
    (a[o] - a[0]) / s,
...
function Er(e, t, { tolerance: n = 0.02, keepFrames: r = [] } = {}) {
...
function Ar(e, t, { target: n = 2, keepFrames: r = [] } = {}) {
...
function gr(e, t, { mergeWithin: n = 1, epsilon: r = 1e-3, keepFrames: a = [] } = {}) {
...
function pr(e, t, n, { lastFrame: r = 1 / 0 } = {}) {
...
function In(e, t, n, r, a) {
  const s = V(e, t, a), i = V(t, n, a), o = V(n, r, a), c = V(s, i, a), h = V(i, o, a), u = V(c, h, a);
...
function Sn(e, { leftFrame: t, rightFrame: n, t: r = 0.5 } = {}) {
  ...
  const o = Math.min(0.999, Math.max(1e-3, Number.isFinite(r) ? r : 0.5)), c = Math.round(t + o * (n - t)), h = Nn(a, t, n, c);
  if (h < 0) return { ok: !1, reason: "no_free_frame" };
  const u = (h - t) / (n - t), f = a[s], m = a[i], E = s > 0 ? a[s - 1] : null, y = i + 1 < a.length ? a[i + 1] : null, p = f.interpolation === "bezier" || m.interpolation === "bezier", O = re({ keyframes: a }, h), C = { frame: h, interpolation: p ? "bezier" : f.interpolation, camera: O };
  if (p) {
    const b = [...f.camera.position], g = Se(f, E, m).out, w = Se(m, f, y).in, k = [...m.camera.position], j = In(b, g, w, k, u);
    C.camera = { ...fe(O), position: [...j.point] };
    const U = ue(f);
    (U === "free" || U === "aligned") && ie(f, "out", j.left[1]);
    const Be = ue(m);
    (Be === "free" || Be === "aligned") && ie(m, "in", j.right[2]), ie(C, "in", j.left[2]), ie(C, "out", j.right[1]);
  }
  return { ok: !0, keys: [...a, C].sort((b, g) => b.frame - g.frame), frame: h };
}
function Rn(e, t) {
  const { keys: n, removed: r } = yn(e, t, { minKeys: 1 });
...
const q = l.viewport | l.previews | l.timeline | l.inspector;
function qe(e, t, n) {
...
const On = {
  [_.ASSET_INSTANTIATE](e, t) {
    ...
    let r;
    try {
      r = gn(t.asset, { point: t.point, idSeed: t.id, existingIds: n });
    } catch (a) {
  ...
  [_.CAMERA_LOOK_AT](e, t) {
    ...
    if (t.objectId !== void 0 && (t.objectId === null || t.objectId === "" ? (n.target_object_id = null, n.id === e.active_camera_id && (e.target_object_id = null)) : (Oe(e, t.objectId), n.target_object_id = t.objectId, n.id === e.active_camera_id && (e.target_object_id = t.objectId))), t.point) {
      const r = pe(n);
      r.target = [...t.point];
  ...
  [_.OBJECT_SET_LOCKED](e, t) {
    return Oe(e, t.objectId).locked = t.value, { dirtyMask: l.outliner | l.inspector };
  },
  [_.OBJECT_SET_TAGS](e, t) {
    const n = $(e, t.objectId), r = It(t.tags), a = r.length !== t.tags.length ? "some tags were dropped or normalised" : void 0;
    return r.length ? n.tags = r : delete n.tags, { dirtyMask: l.outliner | l.inspector | l.viewport, warning: a };
  },
  [_.OBJECT_SET_ANNOTATION](e, t) {
    const n = $(e, t.objectId), r = t.annotation === null ? null : yt(t.annotation);
    if (t.annotation && !r)
  ...
  [_.CHARACTER_SET_JOINT_ROTATION](e, t) {
    ...
    return n.character = {
      ...n.character || {},
      pose: wt(n.character?.pose, t.joint, t.rotation)
    }, { dirtyMask: l.viewport | l.previews | l.inspector };
  },
  [_.CHARACTER_SET_MOTION](e, t) {
    const n = oe(e, t.objectId), r = bt(t.motion);
  ...
  [_.KEYFRAME_UPSERT](e, t) {
    ...
    const a = !r;
    if (!r) {
      const i = ce(n, 0)?.camera || n.camera || {};
  ...
  [_.KEYFRAME_SET_INTERPOLATION](e, t) {
    const n = M(e, t.cameraId), r = ce(n, t.frame);
  ...
  [_.CAMERA_PATH_TRANSFORM_KEYS](e, t) {
    ...
    const r = (n.keyframes || []).filter((i) => t.frames.includes(i.frame)), a = Array.isArray(t.transform.origin) ? t.transform.origin : At(r), s = gt(n.keyframes || [], t.frames, {
      mode: t.transform.mode,
      origin: a,
      delta: t.transform.delta,
      factors: t.transform.factors,
      rotationDeg: t.transform.rotationDeg,
      lookAtActive: pt(n, e.objects)
    });
    return Z(e, n, s), { dirtyMask: q };
  },
  [_.CAMERA_PATH_INSERT_KEY](e, t) {
    const n = M(e, t.cameraId), r = Sn(n.keyframes || [], {
    ...
    return Z(e, n, r.keys), { dirtyMask: q, outcome: { frame: r.frame } };
  },
  [_.CAMERA_PATH_DELETE_KEYS](e, t) {
    const n = M(e, t.cameraId);
    qe(n, t.frames, "camera.path.delete_keys");
    const r = Rn(n.keyframes || [], t.frames);
    if (!r.ok)
      throw new d("CANNOT_DELETE", "camera.path.delete_keys: a camera track needs at least one key");
    return Z(e, n, r.keys), { dirtyMask: q, outcome: { removed: r.removed } };
  },
  [_.CAMERA_PATH_REDISTRIBUTE_TIMING](e, t) {
    const n = M(e, t.cameraId), r = [...n.keyframes || []].sort((o, c) => o.frame - c.frame), a = Number.isInteger(t.startFrame) ? t.startFrame : r[0]?.frame, s = Number.isInteger(t.endFrame) ? t.endFrame : r[r.length - 1]?.frame, i = Et(r, { startFrame: a, endFrame: s });
    if (!i.ok) {
    ...
    return Z(e, n, i.keys), { dirtyMask: q };
  },
  [_.CAMERA_PATH_APPLY_PRESET](e, t) {
    const n = M(e, t.cameraId), r = pe(n), a = nn({
      type: t.presetType,
      camera: r,
      target: t.target,
    ...
    return Z(e, n, a.keyframes), { dirtyMask: q };
  }
};
...
function ke(e, t) {
  ...
  if (Array.isArray(e) || Array.isArray(t))
    return !Array.isArray(e) || !Array.isArray(t) || e.length !== t.length ? !1 : e.every((n, r) => ke(n, t[r]));
  if (e && t && typeof e == "object") {
    const n = /* @__PURE__ */ new Set([...Object.keys(e), ...Object.keys(t)]);
    for (const r of n) if (!ke(e[r], t[r])) return !1;
    return !0;
  }
  return !1;
}
...
function vn(e, t) {
  ...
  return Mn(e, t, a), Un(e, t, a), Bn(e, t, a), Ln(e, t, a), Pn(e, t, a), Fn(e, t, a), { changes: n, truncated: r };
}
const jn = ["fov", "roll", "zoom", "near", "far", "camera_type"];
function Mn(e, t, n) {
...
const Dn = ["position", "target", "fov", "roll", "zoom", "near", "far", "camera_type"];
function Un(e, t, n) {
  const r = F(e?.cameras), a = F(t?.cameras);
  for (const [s, i] of a) {
...
function Gn(e, t) {
  ...
  for (let f = 0; f < n.operations.length; f += 1)
    try {
      const m = kn({ ui: e, state: a, operation: n.operations[f] });
  ...
  if (n.validateOnly) {
    const { changes: f, truncated: m } = vn(e.state, a);
    return {
      ok: !0,
      version: P,
      revision: r,
  ...
  e.checkpoint?.(n.description), e.state = ne(a);
  const c = zn(e);
  an(e, n.id), e.serialize?.(), Kn(e, c), Jn(e, s, `director-api:${n.id}`);
  const h = {
    ok: !0,
    version: P,
    baseRevision: r,
...
function Wn(e) {
  return e.directorApi = Vn(e), e.directorApi;
}
const xe = "omnicam-agent/1", et = "majoor.omnicam.agent.request", Yn = 1, x = Object.freeze({
...
}), Qn = 1e4, Xn = 5e3, lt = "asset.instantiate_by_id", dt = "asset.catalog_search", tt = Object.freeze([
  ...rt.filter((e) => e !== _.ASSET_INSTANTIATE),
  lt
]);
function ve(e) {
...
async function xn(e, t) {
  ...
  const r = (n.state?.items || []).filter((a) => !ve(a)).slice(0, 20).map((a) => ({
    id: a.id,
    name: a.name,
    kind: a.kind,
    tags: [...a.tags || []],
...
function er(e, t, n) {
  ...
  async function O(b) {
    const g = b?.detail;
    if (r || !g || g.protocol !== xe || Number(g.schema_version) !== Yn || g.session_id !== a || String(g.node_id) !== String(t.id)) return;
    let w;
    try {
      if (g.kind === "query")
        w = g.payload?.type === dt ? await xn(e, g.payload) : e.directorApi.query(g.payload);
        ...
        if (!Number.isInteger(k?.baseRevision) || k.baseRevision < 0)
          ...
          const U = await qn(e, k.operations);
          U.ok ? (w = e.directorApi.execute({ ...k, operations: U.operations }), await w?._reconciliation) : w = te(e, U.code, U.message);
        }
      } else
        w = te(e, "UNKNOWN_AGENT_REQUEST", `Unsupported Agent request kind: ${g.kind}`);
    } catch (k) {
      w = te(e, k?.code || "INTERNAL", k?.message || "OmniCam Agent request failed");
    }
    try {
      await ee(n, x.reply, {
        session_id: a,
  ...
  return n.addEventListener?.(et, O), n.addEventListener?.("status", X), m(), {
    get sessionId() {
      return a;
    },
    dispose() {
      if (r) return;
      r = !0, clearInterval(o), clearTimeout(c), n.removeEventListener?.(et, O), n.removeEventListener?.("status", X);
      const b = a, g = s;
...
async function nr(e, t) {
  return Te.open({
    ...
    opener: t,
    createSession: async () => {
      const n = ++e.workbenchGeneration, { openDirectorWorkbench: r, closeDirectorWorkbench: a } = await import("./chunk-CJIFnvaC.js").then((c) => c.e);
      ...
      return o.mount(s.root), {
        ...
        nodeId: e.node.id,
        host: o,
        close: async () => s.recording ? (s.setStatus?.(K("Cannot close Director while a playblast is recording")), !1) : (s.serialize?.(), a(s), o.dispose(), !0),
        dispose: () => {
          a(s), o.dispose();
        }
      };
...
function rr(e) {
  ...
  const t = new Ct(e, { app: ft, api: Pe });
  Wn(t);
  try {
    t.agentBridge = er(t, e, Pe);
  } catch (m) {
  ...
  const n = Rt({
    ...
    onOpen: (m) => {
      nr(t, m.currentTarget);
    }
  });
  t.shell = n, le(t), t.addEventListener("statechange", () => le(t)), t.addEventListener("statuschange", () => le(t)), t.addEventListener("upstreamchange", () => le(t)), e.__majoorOmniCamDirectorRuntime = t, e.addDOMWidget("majoor_omnicam_director_shell", "omnicam", n.root, {
    serialize: !1,
    hideOnZoom: !1,
    getMinHeight: () => 124,
    getHeight: () => 124,
