...
const ho = () => import("./chunk-DopIK3J1.js");
function Ef(e, t) {
...
async function qh(e) {
  ...
  try {
    let n = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-B2VAWwo5.js");
...
class ai {
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-B2VAWwo5.js"));
    } catch (a) {
  ...
  try {
    t.assetBrowser = Ap(t, {
      ...
      onAgentFirstOpen: async () => {
        if (Zo())
          try {
            const { createDirectorAgentPanel: m } = await import("./chunk-XJpigbwu.js");
            t.agentPanel = m(t);
          } catch (m) {
