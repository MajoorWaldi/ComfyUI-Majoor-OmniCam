import { a, $ as j, bC as te, bD as J, bE as w } from "./chunk-CxXyW-I9.js";
...
async function le(e, n) {
  return S(e, "GET", _(n, "/status"));
}
async function ce(e, n, i) {
  try {
    return await S(e, "PUT", _(n, "/credential"), { secret: i });
  } finally {
    i = null;
  }
}
async function de(e, n) {
  return S(e, "DELETE", _(n, "/credential"));
}
async function ue(e, n, i) {
  return S(e, "POST", _(n, "/test"), i || {});
}
async function pe(e, n, i) {
  return (await S(e, "POST", _(n, "/models"), i || {})).models || [];
}
const fe = {
  ollama: "Ollama",
  openai: "OpenAI",
...
function he(e, n = {}) {
  ...
  function G(t) {
    ...
    if (r) {
      ...
      if (r.action === "model-refresh") return void $();
    }
  }
  return f?.addEventListener("click", G), y?.addEventListener("change", R), m?.addEventListener("change", B), d?.addEventListener("input", D), E(), z(), I(), $(), {
    get state() {
      return g;
    },
    dispose() {
