...
import { api as He } from "../../scripts/api.js";
import { a as we, c as Z, C as he, E as os, v as r, F as Br, G as zo, H as ze, e as de, J as no, K as Fo, L as Ke, M as rs, N as Lo, T as oe, O as Wr, Q as ns, R as ss, U as is, V as cs, W as ls, X as jo, x as ar, Y as Vr, Z as Co, _ as Hr, $ as Ur, a0 as Gr, a1 as Xr, j as Yr, a2 as _o, a3 as fo, a4 as or, a5 as rr, a6 as Zr, o as nr, a7 as ds, a8 as ms, a9 as ps, aa as fs, ab as hs, h as ye, p as Jr, i as Qr, ac as sr, f as $e, ad as us, ae as en, t as bs, af as gs, r as tn, ag as Oo, ah as vs, ai as ys, q as xs, aj as ws, ak as ks, al as Ss, am as Ko, an as js, ao as Cs, ap as _s, aq as Es, ar as $s, as as Ms, at as As, au as Ts, av as Ps, aw as Is, ax as zs, ay as Fs, az as Ls, aA as Os, aB as Ks, aC as Ds, aD as Ns, aE as Rs, aF as qs, aG as Bs, aH as Ws, aI as Vs, aJ as Hs, aK as Us, aL as Gs, aM as Xs, aN as Ys, aO as Zs, aP as Js, aQ as Qs, aR as ei, aS as ti, aT as ai, aU as oi, aV as ri, aW as ni, aX as si, aY as ii, aZ as ci, a_ as li, a$ as di, b0 as mi, b1 as pi, l as Ve, b2 as fi, b3 as ho, b4 as hi, b5 as ui, b6 as bi, b7 as gi, b8 as vi, b9 as Ie, ba as yi, bb as an, bc as Do, bd as xi, be as wi, bf as ki, S as on, bg as Ne, bh as Si, bi as ji, bj as ir, bk as No, bl as Ci, bm as _i, bn as Ei, b as rn, bo as $i, bp as Mi, bq as Ai, br as Ti, z as Pi, bs as Ii, bt as zi, bu as Fi, bv as nn, bw as Li, bx as Oi, by as Ki, bz as Di, bA as Ni, bB as Ri, bC as qi, bD as Bi, bE as Wi, bF as Vi, bG as Hi, bH as Ui, bI as Gi, bJ as Xi, bK as Yi, bL as Zi, bM as Ji, bN as Qi, bO as ec, s as tc } from "./chunk-D9faitIi.js";
import { p as ac, a as oc, s as uo, S as sn, c as rc, C as cr, b as nc, i as sc, w as ic, d as cc, U as Ce, m as lc, h as Xe, e as dc, f as mc, g as pc, j as fc, r as hc, k as uc, l as bc, E as gc } from "./chunk-Dwz96PRD.js";
import { L as vc, h as yc, i as Ct, j as Ro, k as xc, l as wc, o as lr, q as kc, t as Sc, u as jc, v as Cc, w as _c, C as dr, c as _t, x as cn, y as Ec, z as $c, A as Mc, B as ln, D as Ac, E as Tc, G as Pc, H as Ic, I as zc, J as Fc, K as Lc, M as Oc, N as Kc, O as Dc, P as Nc, Q as Rc } from "./chunk-ChnAK97b.js";
import { S as qc, b as Bc, p as Wc, l as Vc, u as Hc } from "./chunk-BBK8MgH8.js";
import { T as Uc } from "./chunk-IMiHbUfz.js";
import { T as Gc, R as Xc } from "./vendor-three-B8JDtKPi.js";
import { b as Yc, p as dn, a as Eo, c as $o, d as Zc, r as Jc, s as Qc, e as el } from "./chunk-Dk3qBM44.js";
import { m as tl } from "./chunk-_f2VoZbc.js";
function vt(e, t = 0) {
...
function al(e, { type: t = "handheld_subtle", intensity: a = 1, duration_frames: o = null, subdivide: n = !0 } = {}) {
  ...
  const i = t === "turbulence", c = t === "handheld_heavy", l = (i ? 0.12 : c ? 0.18 : 0.06) * a, m = (i ? 2 : c ? 2.8 : 0.9) * a, p = i ? 0.45 : c ? 0.22 : 0.12, f = s[s.length - 1]?.frame ?? 119, u = Math.max(f + 1, Number(o || (e?.duration_frames ?? f + 1))), d = i ? 4 : c ? 6 : 8, h = Array.isArray(e) ? { keyframes: s, duration_frames: u } : e, b = new Set(s.map((y) => y.frame));
  if (n && u > d) {
    for (let y = 0; y < u; y += d)
      b.add(y);
    b.add(u - 1);
  }
  return [...b].sort((y, v) => y - v).map((y) => {
    const v = we(h, y), j = vt(y * p, 1) * l, x = vt(y * p, 2) * l, M = vt(y * p, 3) * l * 0.5, P = vt(y * p, 4) * m, D = vt(y * p, 5) * (m * 0.35), F = [...v.position], U = [...v.target];
...
function ol(e, { duration_frames: t = 120, target: a = [0, 1.5, 0], radius: o = 6, height: n = 3.5 } = {}) {
  ...
  if (e === "orbit_360") {
    ...
    for (let f = 0; f < p; f++) {
      const u = Math.round(f / (p - 1) * (i - 1)), d = f / (p - 1) * Math.PI * 2, h = f === p - 1 ? [c, l + n, m + o] : [c + Math.sin(d) * o, l + n, m + Math.cos(d) * o];
      s.push({
        frame: u,
        camera: {
          position: h,
...
function mn(e) {
  ...
  for (const a of [".oc-playhead-head", '[data-role="dope-playhead"]', ".oc-gdope-playhead", ".oc-sequence-playhead"])
    for (const o of e.root.querySelectorAll(a)) rl(o, t);
}
function nl(e, t, a) {
...
function pn(e) {
  ...
  a.delete("camera");
  const o = e.timelineKeyframes() || [], n = os(o, a), s = il(e, n);
  if (t.dataset.signature !== s) {
    t.dataset.signature = s, t.replaceChildren();
    const i = (c) => he(e, c);
    for (const c of n) {
      const l = document.createElement("div");
      l.className = "oc-dope-row", l.dataset.channel = c.id, l.style.setProperty("--channel-color", c.color), nl(l, c.frames, i), sl(e, l, c, o, i), t.appendChild(l);
    }
  }
...
const bo = [1, 2, 5, 10, 20, 25, 50, 100, 200, 250, 500, 1e3, 2e3, 5e3], fn = 46, mr = 5, hn = 640;
function un(e, t) {
  const a = t > 0 ? t : hn, o = Math.max(2, Math.floor(a / fn)), n = Math.max(1e-6, e / o);
  return bo.find((s) => s >= n) ?? bo[bo.length - 1];
}
function cl(e, t) {
  const a = Math.max(1, e.state.duration_frames - 1), o = Z(Number(e.timelineZoom) || 1, 0.1, 50), n = Number(e.timelinePan) || 0, s = a / o, i = un(s, t), l = (i >= mr ? i / mr : 0) || i, m = [], p = Math.max(0, Math.floor(n / l) * l);
  for (let u = p; u <= a + 1e-6; u += l) {
    const d = Math.round(u), h = he(e, d);
    if (!(h < -1)) {
      if (h > 101) break;
      m.push({ frame: d, percent: h, major: Math.abs(d % i) < 1e-6 });
    }
  }
  const f = he(e, a);
  if (f <= 101 && !m.some((u) => u.major && u.frame === a)) {
    const u = fn / Math.max(1, t) * 100;
    for (let d = m.length - 1; d >= 0; d -= 1)
      if (m[d].major) {
        if (f - m[d].percent >= u) break;
        m[d].major = !1;
      }
...
function dl(e, t) {
  ...
  a.addEventListener("pointerup", i, { signal: t }), a.addEventListener("pointercancel", i, { signal: t }), a.addEventListener("wheel", (c) => Br(e, c), { passive: !1, signal: t });
}
const ml = [1, 2, 2.5, 5, 10];
function pl(e, t = 5) {
  const a = Math.abs(e) / Math.max(1, t);
  if (!(a > 0) || !Number.isFinite(a)) return 1;
  const o = 10 ** Math.floor(Math.log10(a)), n = a / o;
  return (ml.find((s) => s >= n) ?? 10) * o;
}
function fl(e, t) {
  const a = Math.max(0, Math.min(4, Math.ceil(-Math.log10(t))));
  return e.toFixed(a);
}
function hl(e, { left: t, right: a, top: o, width: n, graphWidth: s, graphHeight: i, height: c, timeMin: l, timeMax: m, totalDuration: p, xFor: f, frame: u }) {
  const d = un(m - l, s);
  e.strokeStyle = "#222228", e.lineWidth = 1, e.fillStyle = "#6e727a", e.textAlign = "center";
  for (let b = Math.ceil(l / d) * d; b <= m; b += d) {
    const g = Math.round(b);
    if (g < 0 || g > p) continue;
    const y = f(g);
    y < t || y > n - a || (e.beginPath(), e.moveTo(y, o), e.lineTo(y, o + i), e.stroke(), e.fillText(String(g), y, c - 6));
  }
  const h = f(u);
  h >= t && h <= n - a && (e.fillStyle = "#a78bfa", e.fillText(String(u), h, c - 6)), e.textAlign = "left";
}
function ul(e, { left: t, right: a, top: o, width: n, graphHeight: s, minimum: i, maximum: c, yFor: l }) {
  const m = pl(c - i, 4);
  e.strokeStyle = "#222228", e.lineWidth = 1, e.fillStyle = "#6e727a";
  for (let p = Math.ceil(i / m) * m; p <= c; p += m) {
    const f = l(p);
    f < o - 1 || f > o + s + 1 || (e.beginPath(), e.moveTo(t, f), e.lineTo(n - a, f), e.stroke(), e.fillText(fl(p, m), 4, f + 3));
  }
}
function qo(e, t) {
...
function gl(e, t) {
  const a = t.currentTarget, { x: o, y: n } = qo(a, t);
  if (e.curvePanDrag && t.pointerId === e.curvePanDrag.pointerId) {
    t.preventDefault();
    const f = t.clientX - e.curvePanDrag.startX, u = t.clientY - e.curvePanDrag.startY, h = Math.max(1, e.state.duration_frames - 1) / (Number(e.curveZoomX) || 1), b = Math.max(1, a.clientWidth - 58), g = a.clientHeight || 180, y = Math.max(1, g - 38);
    e.curvePanX = e.curvePanDrag.origPanX - f / b * h, e.curvePanY = e.curvePanDrag.origPanY + u / y * 10 / (Number(e.curveZoom) || 1), e.drawCurveEditor();
    return;
  }
  if (e.curveScrub && t.pointerId === e.curveScrub.pointerId) {
    t.preventDefault();
    const f = Math.max(1, e.state.duration_frames - 1), u = f / (Number(e.curveZoomX) || 1), d = Number(e.curvePanX) || 0, h = Math.round(Z(d + (o - 44) / Math.max(1, a.clientWidth - 58) * u, 0, f));
    e.setFrame(h);
    return;
  }
  if (e.curveBoxSelect && t.pointerId === e.curveBoxSelect.pointerId) {
    ...
    const f = Math.min(e.curveBoxSelect.startX, o), u = Math.max(e.curveBoxSelect.startX, o), d = Math.min(e.curveBoxSelect.startY, n), h = Math.max(e.curveBoxSelect.startY, n), b = (e.curveHitPoints || []).filter((y) => !y.handle && y.x >= f && y.x <= u && y.y >= d && y.y <= h).map((y) => y.key.frame), g = new Set(e.curveBoxSelect.additive ? e.curveBoxSelect.initial : []);
    for (const y of b) g.add(y);
    e.selectedKeyFrames = g, g.size && (e.selectedKeyFrame = [...g].at(-1)), e.updateKeyVisualState(), e.drawCurveEditor();
    return;
  }
  if (!e.curveDrag || t.pointerId !== e.curveDrag.pointerId) {
    const f = (e.curveHitPoints || []).map((v) => ({ point: v, distance: Math.hypot(o - v.x, n - v.y) })).sort((v, j) => v.distance - j.distance)[0], u = Math.max(1, e.state.duration_frames - 1), d = u / (Number(e.curveZoomX) || 1), h = Number(e.curvePanX) || 0, b = Math.max(1, a.clientWidth - 58), g = Z(Math.round(h + (o - 44) / b * d), 0, u);
    let y = null;
    if (f && f.distance <= 14) {
    ...
    } else n >= 20 && n <= 165 && o >= 44 && o <= a.clientWidth - 14 && (y = { x: o, y: n, frame: g });
  ...
  if (e.curveHover = null, t.preventDefault(), t.stopPropagation(), e.curveDrag.historyCheckpointed || (e.checkpoint?.(e.curveDrag.handle ? "Edit curve tangent" : "Edit curve"), e.curveDrag.historyCheckpointed = !0), e.curveDrag.handle) {
    const f = e.curveDrag.key, u = e.curveDrag.channel, d = e.curveDrag.handle, h = e.curveDrag.pixelPerSegment, b = e.curveDrag.valuePerPixel, g = e.curveDrag.keyX, y = e.curveDrag.keyY;
    ...
    const v = f.tangents.channels[u.id] || {}, j = v.mode || (f.tangents.mode === "aligned" ? "aligned" : "free"), x = {
    ...
    if (d === "in") {
      if (x.in_x = Z((o - g) / Math.max(1, h), -0.99, -0.01), x.in_y = (y - n) * b, j === "aligned") {
    ...
    } else if (x.out_x = Z((o - g) / Math.max(1, h), 0.01, 0.99), x.out_y = (y - n) * b, j === "aligned") {
    ...
    f.tangents.channels[u.id] = x, e.scheduleSerialize(), e.camera = we(e.state, e.frame), e.applyObjectAnimationFrame(), e.render(), e.drawCurveEditor();
    return;
  }
  ...
  if (e.curveDrag.group) {
    ...
    let u = p ? m - e.curveDrag.startFrame : 0;
    const d = new Set(e.timelineKeyframes().filter((h) => !e.selectedKeyFrames.has(h.frame)).map((h) => h.frame));
    if (u) {
      const h = e.curveDrag.group.map((g) => Z(Math.round(g.startFrame + u), 0, e.curveDrag.lastFrame));
      h.some((g) => d.has(g)) || new Set(h).size !== h.length ? u = 0 : e.curveDrag.group.forEach((g, y) => {
        g.key.frame = h[y];
      });
    }
    for (const h of e.curveDrag.group)
      e.curveDrag.channel.set(h.backing, h.startValue + f);
    e.timelineKeyframes().sort((h, b) => h.frame - b.frame), e.selectedKeyFrames = new Set(e.curveDrag.group.map((h) => h.key.frame)), e.selectedKeyFrame = e.curveDrag.key.frame, e.editingKeyFrame = p ? null : e.curveDrag.key.frame, e.frame = e.curveDrag.key.frame;
  } else
...
function yl(e, t) {
  ...
  e.selectedKeyFrame = a.frame, e.serialize(), e.refreshKeys(), e.refreshKeyEditor(), e.render(), e.drawCurveEditor(), e.setStatus(r("{value1} interpolation @ {value2}", { value1: t.replace("_", " "), value2: a.frame }));
}
function xl(e, t) {
...
function wl(e, t) {
  ...
  e.selectedKeyFrame = a.frame, e.serialize(), e.refreshKeys(), e.render(), e.drawCurveEditor(), e.setStatus(r("Tangent mode: {value1} @ {value2}", { value1: t, value2: a.frame }));
}
function kl(e) {
...
function jl(e, t) {
  e.curveZoom = Z((Number(e.curveZoom) || 1) * t, 0.2, 30), e.curveZoomX = Z((Number(e.curveZoomX) || 1) * t, 0.2, 30), e.drawCurveEditor(), e.setStatus(r("Curve zoom: {value1}%", { value1: (e.curveZoom * 100).toFixed(0) }));
}
function Cl(e, t) {
  t.preventDefault(), t.stopPropagation();
  const a = t.currentTarget, { x: o, y: n } = qo(a, t);
...
function gn(e, { selectedOnly: t = !1 } = {}) {
  const a = Math.max(1, (e.state?.duration_frames ?? 120) - 1), o = e.timelineKeyframes() || [], n = e.timelineObject(), s = at(e), i = e.selectedKeyFrames?.size ? [...e.selectedKeyFrames] : e.selectedKeyFrame != null ? [e.selectedKeyFrame] : [], c = i.length > 0, l = t || c && i.length < o.length ? o.filter((b) => i.includes(b.frame)) : o;
  if (!l.length) {
    e.curveZoom = 1, e.curveZoomX = 1, e.curvePanX = 0, e.curvePanY = 0, e.drawCurveEditor(), e.setStatus(r("Curve view fitted"));
    return;
  }
  const m = l.map((b) => b.frame), p = Math.min(...m), f = Math.max(...m), u = Math.max(1, f - p);
  if (l.length < o.length && u < a) {
    const b = Math.max(2, Math.round(u * 0.15)), g = Math.max(0, p - b), y = Math.min(a, f + b), v = Math.max(1, y - g);
    e.curveZoomX = Z(a / v, 0.2, 30), e.curvePanX = g;
  } else
    e.curveZoomX = 1, e.curvePanX = 0;
  const d = [];
  for (const b of l) {
    const g = n ? b.transform || n : b.camera || b;
    for (const y of s) {
      const v = y.get(g);
      Number.isFinite(v) && d.push(v);
    }
  }
  if (d.length > 0) {
    const b = Math.min(...d), g = Math.max(...d), y = Math.max(1e-4, g - b), v = (b + g) / 2, j = (V) => n ? no(n, V) : we(e.state, V), x = [], M = Math.max(1, Math.floor(a / 40));
    for (let V = 0; V <= a; V += M) {
      const Q = j(V);
      for (const k of s) {
        const _ = k.sample ? k.sample(V) : k.get(Q);
...
function at(e) {
  ...
  if (!e.timelineObject() && t === "timing") {
    const n = e.timelineKeyframes().slice().sort((c, l) => c.frame - l.frame), s = new Map(n.map((c) => [c.camera, c])), i = (c) => {
      ...
      const m = n[l], p = n[l + 1], f = Math.max(1, p.frame - m.frame), u = (c - m.frame) / f, d = Ke(m), h = Ke(p);
      return d + (h - d) * u;
    };
    a = [{
      id: "timing_weight",
      ...
      set: (c, l) => {
        const m = s.get(c);
        if (!m) return;
        const p = Math.max(0.1, Math.min(10, Number(l) || 1)), f = Fo(m, p);
        f.timing ? m.timing = f.timing : delete m.timing;
      },
      sample: i
    }];
...
function El(e) {
  ...
  const i = e.timelineObject(), c = e.timelineKeyframes(), l = at(e), m = 44, p = 14, f = 16, u = 22, d = Math.max(1, a - m - p), h = Math.max(1, o - f - u), b = Math.max(1, e.state.duration_frames - 1), g = Z(Number(e.curveZoomX) || 1, 0.1, 50), y = Number(e.curvePanX) || 0, v = b / g, j = y, x = y + v, M = [], P = Math.max(1, Math.ceil(v / Math.max(80, d))), D = ($) => i ? no(i, $) : we(e.state, $);
  for (let $ = 0; $ <= b; $ += P) M.push({ frame: $, value: D($) });
  M[M.length - 1]?.frame !== b && M.push({ frame: b, value: D(b) });
  const F = M.flatMap(($) => l.map((W) => W.sample ? W.sample($.frame) : W.get($.value)));
  ...
  U = k - _ / 2, B = k + _ / 2;
  const z = ($) => m + ($ - j) / Math.max(1e-6, x - j) * d, N = ($) => f + h * (B - $) / Math.max(1e-6, B - U);
  if (s.fillStyle = "#111114", s.fillRect(0, 0, a, o), s.strokeStyle = "#222228", s.lineWidth = 1, s.font = "9px system-ui, -apple-system, sans-serif", s.fillStyle = "#6e727a", hl(s, {
    left: m,
    right: p,
    top: f,
    width: a,
    ...
    xFor: z,
    frame: e.frame
  }), ul(s, { left: m, right: p, top: f, width: a, graphHeight: h, minimum: U, maximum: B, yFor: N }), U <= 0 && B >= 0) {
    const $ = N(0);
  ...
  for (const $ of l) {
    ...
    let W = !1;
    M.forEach((C) => {
      const R = z(C.frame), G = N($.sample ? $.sample(C.frame) : $.get(C.value));
      R >= m - 50 && R <= a - p + 50 && (W ? s.lineTo(R, G) : (s.moveTo(R, G), W = !0));
    }), s.stroke();
    for (const C of c) {
      const R = i ? C.transform : C.camera, G = z(C.frame), ae = N($.get(R)), re = C.frame === e.selectedKeyFrame || e.selectedKeyFrames?.has(C.frame);
      re && (s.fillStyle = "rgba(242, 208, 107, 0.35)", s.beginPath(), s.arc(G, ae, 8.5, 0, Math.PI * 2), s.fill()), s.fillStyle = re ? "#ffd75e" : $.color, s.strokeStyle = "#0d0d10", s.lineWidth = 1.6, s.beginPath(), s.arc(G, ae, re ? 5.2 : 3.8, 0, Math.PI * 2), s.fill(), s.stroke(), e.curveHitPoints.push({
        x: G,
        y: ae,
        key: C,
        channel: $,
    ...
    if (e.showCurveHandles && !$.keyBased)
      for (let C = 0; C < c.length; C++) {
        ...
        const re = i ? R.transform || i : R.camera || R, ee = z(R.frame), ie = N($.get(re)), fe = c[C - 1], me = c[C + 1], ue = Math.max(1, R.frame - (fe?.frame ?? R.frame - 1)), be = Math.max(1, (me?.frame ?? R.frame + 1) - R.frame), O = rs(
          R,
          $.id,
          fe,
          me,
          (ne) => $.get(i ? ne.transform || i : ne.camera || R)
        ), H = (B - U) / Math.max(1, h), ce = d * be / Math.max(1, v), le = d * ue / Math.max(1, v), pe = [];
        (fe || C > 0) && pe.push({ side: "in", x: ee + O.in_x * le, y: ie - O.in_y / H }), (me || C < c.length - 1 || c.length === 1) && pe.push({ side: "out", x: ee + O.out_x * ce, y: ie - O.out_y / H });
        for (const ne of pe) {
          if (s.strokeStyle = $.color, s.lineWidth = G ? 1.5 : 1, s.beginPath(), s.moveTo(ee, ie), s.lineTo(ne.x, ne.y), s.stroke(), s.fillStyle = G ? "#2a2233" : "#171720", s.strokeStyle = G ? "#ffd75e" : $.color, s.lineWidth = G ? 2 : 1.2, s.beginPath(), ne.side === "in")
            s.arc(ne.x, ne.y, G ? 5 : 3.8, 0, Math.PI * 2);
          else {
            const ke = G ? 4.5 : 3.2;
            s.rect(ne.x - ke, ne.y - ke, ke * 2, ke * 2);
          }
          s.fill(), s.stroke(), e.curveHitPoints.push({
            ...
            object: i,
            handle: ne.side,
            pixelPerSegment: ne.side === "in" ? le : ce,
            valuePerPixel: H,
            startHandles: { ...O }
          });
        }
  ...
  const q = z(e.frame);
  if (q >= m && q <= a - p && (s.strokeStyle = "#a78bfa", s.lineWidth = 1.5, s.beginPath(), s.moveTo(q, f), s.lineTo(q, f + h), s.stroke(), s.fillStyle = "#a78bfa", s.beginPath(), s.moveTo(q - 4, f), s.lineTo(q + 4, f), s.lineTo(q, f + 6), s.closePath(), s.fill()), e.curveDrag || e.curveHover) {
    let $ = "", W = "";
    if (e.curveDrag)
      if (e.curveDrag.handle) {
        ...
        const C = e.curveDrag.key.frame - e.curveDrag.startFrame, R = e.curveDrag.channel.get(e.curveDrag.object ? e.curveDrag.key.transform : e.curveDrag.key.camera), G = R - e.curveDrag.startValue, ae = C >= 0 ? `+${C}` : `${C}`, re = G >= 0 ? `+${G.toFixed(2)}` : `${G.toFixed(2)}`;
        $ = `${e.curveDrag.group.length} keys · ΔF: ${ae} · ΔVal: ${re}`, W = `${e.curveDrag.channel.name}: ${R.toFixed(2)}`;
      } else {
        const C = e.curveDrag.key.frame - e.curveDrag.startFrame, R = e.curveDrag.channel.get(e.curveDrag.object ? e.curveDrag.key.transform : e.curveDrag.key.camera), G = R - e.curveDrag.startValue, ae = C >= 0 ? `+${C}` : `${C}`, re = G >= 0 ? `+${G.toFixed(2)}` : `${G.toFixed(2)}`;
        $ = `F${e.curveDrag.key.frame} (${ae}) · ${e.curveDrag.channel.name}: ${R.toFixed(2)} (${re})`;
      }
    ...
    if ($) {
      ...
      const C = s.measureText($), R = W ? s.measureText(W) : { width: 0 }, G = Math.max(C.width, R.width) + 16, ae = W ? 32 : 20, re = a - p - G - 6, ee = f + 6;
      s.fillStyle = "rgba(18, 18, 24, 0.88)", s.strokeStyle = "#38384a", s.lineWidth = 1, s.beginPath(), s.roundRect ? s.roundRect(re, ee, G, ae, 4) : s.rect(re, ee, G, ae), s.fill(), s.stroke(), s.fillStyle = "#e2e8f0", s.fillText($, re + 8, ee + (W ? 13 : 14)), W && (s.fillStyle = "#94a3b8", s.font = "9.5px system-ui, -apple-system, sans-serif", s.fillText(W, re + 8, ee + 26)), s.restore();
    }
  }
...
function pr(e, { filter: t, label: a, color: o, title: n }) {
...
function Bo(e) {
  ...
  if (!t) return;
  const a = e.timelineObject(), o = a ? a.name || a.type : e.activeCameraTrack().name, n = $l(e), s = `${o}\0${n.map((c) => `${c.id}:${c.color}`).join("|")}`;
  if (t.dataset.signature !== s) {
    t.dataset.signature = s, t.replaceChildren();
    const c = document.createElement("span");
    c.className = "oc-graph-legend-title", c.textContent = o, t.appendChild(c), t.appendChild(pr(e, {
      filter: "all",
      label: r("All"),
      color: null,
...
const fr = ["#4aa3ef", "#f2a93b", "#48c774", "#b565d8", "#ec4899"];
function vn(e, t) {
  const a = e.state.cameras.findIndex((n) => n.id === t), o = a >= 0 ? e.state.cameras[a] : null;
  return { camera: o, color: o?.color || fr[Math.max(0, a) % fr.length] };
}
function et(e) {
...
function yn(e, t) {
  ...
  for (const n of t.querySelectorAll(".oc-sequence-shot")) {
    ...
    if (!s) continue;
    const i = he(e, s.start), c = he(e, s.end + 1);
...
function Ml(e) {
  e.checkpoint("Auto-split shots"), e.state.sequence = {
    ...
    enabled: !0,
    cuts: is(e.state)
  }, et(e), e.setStatus(r("Split into {count} shots").replace("{count}", String(e.state.sequence.cuts.length)));
}
function Wa(e, t, a, { disabled: o = !1 } = {}) {
...
function Al(e, t) {
  ...
  if (a.appendChild(Wa(
    ...
    () => Ml(e),
    { disabled: o }
  )), t.length && (a.appendChild(Wa(
    r("Split at playhead"),
    r("Cut the current shot in two at the playhead"),
    () => {
      e.checkpoint("Split shot"), Wr(e.state, e.frame, null) ? et(e) : e.setStatus(r("Move the playhead inside a shot first"));
    },
    { disabled: o }
  )), a.appendChild(Wa(
    r("Clear edit"),
    ...
    () => {
      e.checkpoint("Clear edit"), e.state.sequence = { ...e.state.sequence, enabled: !1, cuts: [] }, et(e), e.setStatus(r("Multi-camera edit cleared"));
    }
  ))), a.appendChild(Wa(
...
function Pl(e, t, a, o, n) {
  ...
  e.contextMenu?.show(t, s?.name || r("Shot"), [
    ...e.state.cameras.map((i) => ({
      ...
      run: () => {
        e.checkpoint("Change shot camera"), e.state.sequence.cuts[o].camera_id = i.id, et(e);
      }
    })),
    null,
    {
      ...
      run: () => {
        e.checkpoint("Split shot"), Wr(e.state, e.frame, null) && et(e);
      }
    },
    {
      label: r("Remove shot"),
      ...
      disabled: n === 1,
      run: () => {
        e.checkpoint("Remove shot"), ns(e.state, o) && et(e);
      }
    }
  ]);
}
function Il(e, t, a, o) {
  ...
  i.className = "oc-sequence-shot", i.dataset.cutIndex = String(a), i.style.left = `${he(e, t.start)}%`, i.style.width = `${Math.max(0.4, he(e, t.end + 1) - he(e, t.start))}%`, i.style.setProperty("--shot-color", s), n?.recording_path || i.classList.add("no-proxy"), i.title = r("{name} · F{start}-{end}").replace("{name}", n?.name || t.camera_id).replace("{start}", String(t.start)).replace("{end}", String(t.end));
  const c = document.createElement("span");
  if (c.className = "oc-sequence-name", c.textContent = n?.name || t.camera_id, i.appendChild(c), a > 0) {
    const l = document.createElement("span");
    l.className = "oc-sequence-handle", l.title = r("Drag to trim the cut"), l.addEventListener("pointerdown", (m) => Tl(e, m, l, o, a)), i.appendChild(l);
  }
  return i.addEventListener("contextmenu", (l) => Pl(e, l, t, a, o.__cutCount)), i.addEventListener("pointerdown", () => {
...
function zl(e) {
  ...
  return o.className = "oc-sequence-waveform", t.appendChild(o), requestAnimationFrame(() => {
    ...
    i.fillStyle = oe.warning;
    for (let f = 0; f < a.length; f++) {
      const d = (f / (a.length - 1) * c - m) / Math.max(1e-6, p) * n;
      if (d < -4 || d > n + 4) continue;
      const h = a[f] * s * 0.9;
      i.fillRect(d, (s - h) / 2, Math.max(1, n / a.length * l - 0.5), h);
    }
  }), t;
}
function xn(e, t) {
  ...
  if (s.className = "oc-sequence-lane", s.dataset.role = "sequence-lane", s.setAttribute("aria-label", r("Multi-camera edit")), o.length)
    for (const [c, l] of o.entries()) {
      const m = he(e, l.start);
      he(e, l.end + 1) < -5 || m > 105 || s.appendChild(Il(e, l, c, n));
    }
  else {
    const c = document.createElement("span");
  ...
  n.appendChild(s), n.appendChild(zl(e));
  const i = document.createElement("span");
  i.className = "oc-sequence-playhead", i.style.left = `${he(e, e.frame)}%`, n.appendChild(i), t.appendChild(n);
}
const Fl = ['[data-act="curve-zoom-in"]', '[data-act="curve-zoom-out"]', '[data-act="curve-fit"]', '[data-act="curve-handles"]'], hr = { curves: "Graph", dope: "Timeline", sequence: "Sequence" };
function Mo(e, t) {
  const a = t in hr ? t : "dope";
  e.graphTab = a;
  ...
  a === "sequence" ? (xn(e, s), s?.focus?.({ preventScroll: !0 })) : a === "curves" && e.drawCurveEditor(), e.setStatus(r(hr[a]));
}
function Ll(e) {
  ...
  a && a.addEventListener("keydown", (o) => {
    if (o.key === "ArrowLeft" || o.key === "ArrowRight") {
      ...
      if (s >= 0 && n.length > 1) {
        ...
        n[i].focus(), Mo(e, n[i].dataset.graphTab);
      }
    }
  }, { signal: t });
  for (const o of e.root.querySelectorAll("[data-graph-tab]"))
    o.addEventListener("click", (n) => {
      n.preventDefault(), n.stopPropagation(), Mo(e, o.dataset.graphTab);
    }, { signal: t });
}
function Kl(e) {
  ...
  if (e.state.playback_range) {
    ...
    const j = he(e, e.state.playback_range[0]), x = he(e, e.state.playback_range[1]);
    v.style.left = `${j}%`, v.style.width = `${Math.max(0, x - j)}%`, t.appendChild(v);
  }
  cs(e, t);
  for (const v of e.state.markers || []) {
    const j = he(e, v.frame);
  ...
  if (o.length > 1) {
    const v = he(e, o[0].frame), j = he(e, o[o.length - 1].frame), x = document.createElement("span");
    x.className = "oc-dope-rail", x.style.left = `${Math.min(v, j)}%`, x.style.width = `${Math.abs(j - v)}%`, x.style.setProperty("--channel-color", oe.typeCamera), t.appendChild(x);
  }
  ...
  for (const v of o) {
    ...
    x.type = "button", x.className = `key${v.frame === e.frame ? " at-playhead" : ""}${m.has(v.frame) ? " selected" : ""}${v.frame === e.editingKeyFrame ? " editing" : ""}`, x.dataset.keyFrame = String(v.frame), x.dataset.interp = v.interpolation || "ease", x.setAttribute("aria-label", r("{value1} keyframe at frame {value2}", { value1: a?.name || "Camera", value2: v.frame })), x.title = r("Frame {value1} · {value2} · Drag: Retime · Alt+Drag: Duplicate", { value1: v.frame, value2: v.interpolation }), x.style.left = `${j}%`;
    ...
    M.className = "key-label", M.textContent = String(v.frame), x.appendChild(M), x.addEventListener("pointerdown", (P) => {
      if (P.preventDefault(), P.stopPropagation(), x.focus({ preventScroll: !0 }), P.altKey) {
        ...
        const F = a ? { frame: v.frame, transform: ze(v.transform), interpolation: v.interpolation } : { frame: v.frame, camera: de(v.camera), interpolation: v.interpolation }, U = e.timelineKeyframes();
        U.push(F), U.sort((B, V) => B.frame - V.frame), e.selectedKeyFrame = F.frame, e.selectedKeyFrames = /* @__PURE__ */ new Set([F.frame]), e.keyDrag = { key: F, box: t, isDuplicate: !0, historyCheckpointed: !0, moving: [{ key: F, startFrame: F.frame }], startPointerFrame: v.frame, startClientX: P.clientX, startClientY: P.clientY }, e.setFrame(F.frame, !1, !1), e.setStatus(r("Duplicating key from {value1}...", { value1: v.frame }));
        return;
      }
      if (P.shiftKey) {
  ...
  if (f) {
    ...
    v.style.fontWeight = "700", e.selectedEntity === "object" && a ? (v.style.color = oe.typeReferenceCard, v.textContent = `📦 ${a.name || a.type}`, f.title = r("Currently animating object: {value1}", { value1: a.name || a.type })) : (v.style.color = oe.typeCamera, v.textContent = `🎥 ${p.name}`, f.title = r("Currently animating camera: {value1}", { value1: p.name })), f.append(v, document.createTextNode(` · ${o.length} key${o.length === 1 ? "" : "s"}`));
  ...
  const d = e.root.querySelector('[data-role="camera-summary"]');
  d && (d.textContent = `${p.name} · Key F${e.selectedKeyFrame ?? e.frame}`);
  ...
  const g = e.root.querySelector('[data-role="preview-title"]');
  g && (g.textContent = `${p.name} · ${r("Frame")} ${e.frame}`);
  const y = e.root.querySelector('[data-role="inspector-camera-name"]');
  y && (y.textContent = p.name), bn(e), pn(e), Bo(e), Ll(e), e.refreshCameraSelectors(), e.refreshKeyEditor(), e.updateEditState(), e.drawCurveEditor(), e.perf && (e.perf.timelineRefreshCount = (e.perf.timelineRefreshCount || 0) + 1);
}
class wn {
  constructor(t = URL) {
...
async function Wo(e, { route: t, field: a = "file", file: o }) {
...
const Hl = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/><path d="M2 12h20"/></svg>', Ul = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m21 16-9 5-9-5V8l9-5 9 5v8z"/><path d="m3.27 6.96 8.73 4.84 8.73-4.84"/><path d="M12 22V12"/></svg>', Gl = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2L2 20h20L12 2z"/><path d="M12 2v18"/></svg>', Xl = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/><path d="m17.66 17.66 1.41 1.41"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="m6.34 17.66-1.41 1.41"/><path d="m19.07 4.93-1.41 1.41"/></svg>', Yl = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18h6"/><path d="M10 22h4"/><path d="M15.09 14c.18-.98.65-1.74 1.41-2.5A4.65 4.65 0 0 0 18 8 6 6 0 0 0 6 8c0 1 .23 2.23 1.5 3.5.76.76 1.23 1.52 1.41 2.5"/></svg>', Zl = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l8 8-4 4-8-8 4-4z"/><path d="M7 11L2 16l6 6 5-5"/><path d="M18 19l4 2"/><path d="M21 16l2 2"/></svg>', Jl = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m22 8-6 4 6 4V8z"/><rect width="14" height="12" x="2" y="6" rx="2"/></svg>', Ql = '<svg class="oc-add-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14h6v6H4z"/><circle cx="17" cy="7" r="3"/><path d="m6 3 4 7H2z"/></svg>';
function ed() {
  return `
  ...
  return `
    <div class="oc-dope">
      <div class="oc-dope-body">
        <div class="oc-dope-labels">${ls.map((t) => `
...
function Vo({ fetchApi: e = Cd } = {}) {
  const t = (a, o) => Promise.resolve(e(a, o)).then(_d);
  return {
    list(a = {}) {
      const { kind: o, tag: n, search: s, offset: i, limit: c } = a, l = { tag: n, search: s, offset: i, limit: c };
      return o && o !== "all" && (l.kind = o), t(`${_e}${ur(l)}`);
    },
    get(a) {
    ...
    importModel(a, o = {}) {
      const n = new FormData();
      return n.append("file", a, o.filename || a.name || "model.glb"), t(`${_e}/import${ur(o)}`, { method: "POST", body: n });
    },
...
const Sn = Object.freeze(["all", "character", "prop", "environment", "vehicle"]);
function br(e = {}) {
  const t = String(e.kind || "all").toLowerCase();
  return {
    kind: Sn.includes(t) ? t : "all",
...
const Td = 256;
function gr(e = {}) {
  const { THREE: t, GLTFLoader: a, FBXLoader: o, size: n = Td } = e;
  if (!t || !a)
  ...
  const l = () => {
    ...
    if (u.isEmpty()) return;
    const d = u.getCenter(new t.Vector3()), h = u.getSize(new t.Vector3()), g = Math.max(h.length() / 2, 1e-3) / Math.sin(c.fov * Math.PI / 360);
    c.position.set(d.x + g * 0.7, d.y + g * 0.55, d.z + g), c.near = g / 100, c.far = g * 10, c.updateProjectionMatrix(), c.lookAt(d);
  }, p = (f, u) => new Promise((d, h) => {
    const b = u === "fbx" && o ? o : a;
    new b().load(
      f,
      (g) => d(g.scene || g),
  ...
  return {
    async render(f, u = "glb") {
      ...
      try {
        l();
        const d = await p(f, u);
        i.add(d), m(d), s.render(i, c);
        const h = s.domElement.toDataURL("image/webp", 0.82);
        return i.remove(d), d.traverse?.((b) => {
          b.geometry?.dispose?.();
          const g = b.material;
          Array.isArray(g) ? g.forEach((y) => y.dispose?.()) : g?.dispose?.();
        }), h;
      } catch {
        return null;
      }
...
async function Pd() {
  const [e, t, a] = await Promise.all([
    import("./chunk-IMiHbUfz.js").then((o) => o.T),
...
function Ld(e, t = {}) {
  return Sn.map((a) => {
    const o = r(Fd[a] || a), n = a === "all" ? "" : ` <span class="oc-asset-kind-n">${Number(t[a] || 0)}</span>`;
    return `<button type="button" class="oc-asset-kind${a === (e || "all") ? " active" : ""}" data-asset-kind="${a}">${Qe(o)}${n}</button>`;
  }).join("");
}
function Od(e, { selected: t = !1, thumbUrl: a = "" } = {}) {
  const o = zd[e.kind] || "pi-box", n = e.kind === "character" && Vr(e.rig) === "rigged" ? `<span class="oc-asset-badge">${r("RIGGED")}</span>` : "", s = a ? `<img class="oc-asset-thumb" src="${Qe(a)}" alt="" loading="lazy">` : `<span class="oc-asset-thumb oc-asset-thumb--glyph"><i class="pi ${o}"></i></span>`;
  return `<button type="button" class="oc-asset-card${t ? " selected" : ""}" data-asset-id="${Qe(e.id)}" title="${Qe(e.name)}">
    ${s}
    <span class="oc-asset-name">${Qe(e.name)}</span>
    <span class="oc-asset-kind-tag">${Qe((e.kind || "").toUpperCase())}</span>
    ${n}
  </button>`;
}
function Kd(e, { selectedId: t = "", thumbUrls: a = {} } = {}) {
  return !e || !e.length ? `<p class="oc-asset-empty">${r("No assets match this filter.")}</p>` : e.map((o) => Od(o, {
    selected: o.id === t,
    thumbUrl: a[o.id] || ""
  })).join("");
}
...
function Dd(e, t = {}) {
  const a = e.root, o = t.fetchApi || ((O, H) => (e.api || e.app?.api).fetchApi(O, H)), n = t.apiClient || Vo({ fetchApi: o }), s = t.store || $d(n), i = Md(), c = t.previewQueue || Ad(), l = e.api || e.app?.api || null;
  let m = t.thumbnailRenderer || null, p = null;
  const f = /* @__PURE__ */ new Set();
  function u() {
    return m ? Promise.resolve(m) : (p || (p = Pd().then((O) => m = gr(O)).catch(() => m = gr({}))), p);
  }
  function d(O) {
    return ar(l, oc(O));
  }
  function h(O) {
    return O.thumbnail ? ar(l, `omnicam/library/${O.thumbnail} [input]`) : "";
  }
  function b() {
    for (const O of s.state.items) {
      ...
      H && c.enqueue(O.id, async () => {
        const le = await (await u()).render(H, O.format || "glb");
        if (!le) {
          f.add(O.id);
          return;
        }
        if (i.set(O.id, le), R(), !(O.source && O.source !== "user"))
          try {
            const pe = await n.uploadThumbnail(O.id, Id(le));
            pe?.asset && s.upsert(pe.asset);
          } catch {
          }
      });
    }
  }
  const g = (O) => a.querySelector(`[data-role="${O}"]`), y = g("assets-panel"), v = g("asset-grid"), j = g("asset-kinds"), x = g("asset-search"), M = g("asset-status"), P = g("asset-import-file"), D = g("scene-tab"), F = g("assets-tab"), U = g("agent-tab"), B = a.querySelector('[data-asset-view="agent"]'), V = { assets: F, agent: U };
  ...
  let C = !1;
  function R() {
    if (j && (j.innerHTML = Ld(s.state.filter.kind, s.state.kinds)), v) {
      const O = {};
      for (const H of s.state.items) {
        const ce = i.get(H.id) || h(H);
        ce && (O[H.id] = ce);
      }
      v.innerHTML = Kd(s.state.items, { selectedId: Q, thumbUrls: O });
    }
    if (!C) {
      C = !0;
      try {
  ...
  function G(O) {
    ...
    if (!ce?.ok) {
      e.setStatus?.(ce?.error?.message || r("Could not add the asset"));
      return;
    }
    const le = ce.outcomes?.[0]?.objectId;
    le && (e.selectedEntity = "object", e.selectedObjectId = le, e.selectedObjectIds = /* @__PURE__ */ new Set([le]), e.selectedKeyFrame = null), e.restoreAssets?.(), e.refreshObjects?.(), e.refreshInspector?.(), e.render?.(), e.setStatus?.(r("{name} added").replace("{name}", O.name));
  }
  async function ae(O) {
    if (O) {
  ...
  function re(O) {
    O === "agent" && !jo() && (O = "scene"), N = O, D && (D.hidden = O !== "scene");
    for (const [H, ce] of Object.entries(V))
      ce && (ce.hidden = H !== O);
  ...
  function ee() {
    const O = jo();
    B && (B.hidden = !O), !O && N === "agent" && re("scene");
  }
  function ie(O) {
    const H = vr(O.target);
    if (H) {
      if (H.action === "switch-view") return re(H.view);
  ...
  return y?.addEventListener("click", ie), y?.addEventListener("dblclick", fe), a.querySelector('[data-role="left-tabs"]')?.addEventListener("click", ie), x?.addEventListener("input", me), P?.addEventListener("change", ue), R(), ee(), {
    store: s,
    switchView: re,
    syncAgentAvailability: ee,
    refresh: () => s.refresh(),
    dispose() {
      be(), clearTimeout(k), y?.removeEventListener("click", ie), y?.removeEventListener("dblclick", fe), a.querySelector('[data-role="left-tabs"]')?.removeEventListener("click", ie), x?.removeEventListener("input", me), P?.removeEventListener("change", ue), c.clear(), m?.dispose?.(), i.clear();
    }
  };
}
function Nd(e, t = {}) {
  ...
  const n = [];
  let s = Co(e.state?.metadata?.viewport_labels);
  function i(p) {
    if (!n[p]) {
  ...
  function l() {
    ...
    o.hidden = !1;
    const u = c(), d = Number(e.frame) || 0, h = Array.isArray(e.state?.objects) ? e.state.objects : [];
    let b = 0;
    for (const g of h) {
      if (!Hr(g, { mode: s.mode, selectedIds: u })) continue;
      const y = Ur(g, s.content);
      if (!y) continue;
      const v = Gr(h, g, d) || {
        position: g.position,
        size: g.size
      }, j = e.webgl.projectWorldToScreen(Xr(v, g.type));
      if (!j || j.behind) continue;
      const x = i(b);
      b += 1, x.hidden = !1, x.textContent = y, x.style.transform = `translate(-50%, -100%) translate(${Math.round(j.x)}px, ${Math.round(j.y)}px)`;
      const M = s.content === "annotation" ? g.annotation?.color : "";
      x.style.setProperty("--oc-label-accent", M || ""), x.classList.toggle("is-annotation", s.content === "annotation" && !!M);
    }
    for (let g = b; g < n.length; g += 1) n[g].hidden = !0;
  }
  function m(p) {
    s = Co({ ...s, ...p }), e.state.metadata = { ...e.state.metadata || {}, viewport_labels: { ...s } }, e.serialize?.(), l();
  }
  return l(), {
    update: l,
    get settings() {
...
function Rd(e) {
  ...
  return {
    ...
    getRigInfo(a) {
      const o = e.state?.objects?.find((i) => i.id === a) || null, n = t(a), s = _o(n);
      return {
        objectId: a,
...
function Bd(e, t = {}) {
  const a = e.root, o = t.apiClient || Vo({
    fetchApi: (y, v) => (e.api || e.app?.api).fetchApi(y, v)
  ...
  let c = null, l = {};
  const m = () => e.state?.objects?.find((y) => y.id === c) || null, p = () => e.webgl?.getModelBoneNames?.(c) || [];
  function f() {
    if (!i) return;
    const y = or(l);
    fo(l) ? (i.textContent = r("Humanoid v1 ✓ — all 22 joints mapped"), i.dataset.state = "ok") : (i.textContent = r("Incomplete — {n} joint(s) unmapped").replace("{n}", y.length), i.dataset.state = "warn");
  }
  function u() {
    s && (s.innerHTML = qd(p(), l)), f();
  }
  function d() {
    const y = e.selectedObject?.(), v = y?.asset_kind === "character";
    if (n.hidden = !v, !v) {
      c = null;
      return;
    }
    y.id !== c && (c = y.id, n.open = !0, l = {}, y.asset_id ? o.get(y.asset_id).then((j) => {
      c === y.id && (l = { ...j?.asset?.rig?.bone_map || {} }, u());
    }).catch(() => u()) : u());
  }
  function h(y) {
    const v = y.target.closest("[data-rig-joint]");
    if (!v) return;
    const j = v.dataset.rigJoint;
    v.value ? l[j] = v.value : delete l[j], u();
  }
  function b(y) {
    const v = y.target.closest("[data-rig-act]")?.dataset.rigAct;
    v === "auto" ? (l = _o(p()), u()) : v === "validate" ? (u(), e.setStatus?.(fo(l) ? r("Rig is complete") : r("Rig still missing: {list}").replace("{list}", or(l).join(", ")))) : v === "save" && g();
  }
  async function g() {
    const y = m();
    if (!y?.asset_id) {
    ...
    try {
      const v = await o.patch(y.asset_id, {
        rig: { profile: rr, bone_map: l }
      });
      y.character = {
        ...y.character || {},
        rig_profile: fo(l) ? rr : null
  ...
  return s?.addEventListener("change", h), n.addEventListener("click", b), d(), {
    sync: d,
    get boneMap() {
      return { ...l };
    },
    dispose() {
      s?.removeEventListener("change", h), n.removeEventListener("click", b);
    }
  };
}
function Wd(e, t = {}) {
  ...
  function i() {
    ...
    o.hidden = !1;
    const { objectId: l, boneMap: m, selectedJoint: p } = c, f = e.characterRuntime, u = /* @__PURE__ */ new Set();
    for (const d of Zr) {
      const h = m?.[d];
      if (!h) continue;
      const b = f?.getJointWorldTransform?.(l, d, m) || e.webgl.resolveModelBone?.(l, h);
      if (!b?.world) continue;
      const g = e.webgl.projectWorldToScreen(b.world);
      if (!g || g.behind) continue;
      const y = s(d);
      y.hidden = !1, y.classList.toggle("selected", d === p), y.style.transform = `translate(-50%, -50%) translate(${Math.round(g.x)}px, ${Math.round(g.y)}px)`, u.add(d);
    }
    for (const [d, h] of n) u.has(d) || (h.hidden = !0);
  }
  return i(), {
    update: i,
    dispose() {
...
function Hd(e, t = {}) {
  ...
  const d = () => e.state?.objects?.find((k) => k.id === p) || null, h = () => e.rigMapper?.boneMap && Object.keys(e.rigMapper.boneMap).length ? e.rigMapper.boneMap : null, b = () => e.subSelection?.type === "character_joint" && e.subSelection.objectId === p ? e.subSelection.jointId : null;
  function g(k) {
    const _ = nr({ ...k, preset_id: k.id });
    return { id: k.id, name: k.name || k.id, root_offset: _.root_offset, joints: _.joints };
  }
  function y(k) {
    const _ = u.get(k?.pose?.preset_id) || null;
    return ms({ preset: _, overrides: k?.pose }).joints;
  }
  function v() {
    const k = d();
    !k?.character || !h() || e.webgl?.applyCharacterPose?.(p, h(), f || k.character.pose?.joints ? y(k.character) : {});
  }
  function j() {
    const k = b(), _ = f && !!k;
    if (c && (c.hidden = !_), !_) return;
    l && (l.textContent = k);
    const z = d(), N = y(z?.character)[k] || [0, 0, 0, 1], q = ps(N);
    m.forEach(($, W) => {
      $ && document.activeElement !== $ && ($.value = String(Math.round(q[W] * 100) / 100));
    });
  }
  function x() {
    const k = d(), _ = !!k?.character?.motion;
    if (i && (i.classList.toggle("active", f), i.disabled = _, i.title = _ ? r("Clear the motion clip to edit the pose") : r("Toggle FK pose editing")), s) {
      const z = [["neutral", r("Standing Neutral")]].concat([...u.values()].filter((q) => q.id !== "neutral").map((q) => [q.id, q.name || q.id])), N = z.map((q) => q.join(":")).join("|");
  ...
  async function M() {
    try {
      ...
      u = new Map((k.poses || []).filter((_) => _?.id).map((_) => [_.id, g(_)]));
    } catch {
      u = /* @__PURE__ */ new Map();
    }
    u.has("neutral") || u.set("neutral", g({ id: "neutral", name: "Standing Neutral" })), x();
  }
  function P() {
    const k = b();
    if (!k) return;
    const _ = m.map((q) => Number(q?.value) || 0), z = ds(_), N = e.directorApi?.execute({
      version: 1,
  ...
  function D() {
    const k = s?.value || "neutral", _ = u.get(k) || nr({ preset_id: k });
  ...
  async function F() {
    ...
    const _ = (await Ct(e, r("Save Pose"), r("Pose name"), ""))?.trim();
    if (!_ || e.disposed) return;
    const z = _.toLowerCase().replace(Vd, "-").replace(/^-+|-+$/g, "").slice(0, 60) || "pose";
    try {
      const N = await o.savePose({
        ...
        joints: y(k.character)
      });
      u.set(N.pose.id, g(N.pose)), e.setStatus?.(r("Pose saved: {name}").replace("{name}", _)), x();
    } catch (N) {
  ...
  const V = Wd(e, {
    onPick: B,
    isActive: () => f && p && h() ? { objectId: p, boneMap: h(), selectedJoint: b() } : null
  });
  e.rigOverlay = V;
  function Q() {
    ...
    k.id !== p && (p = k.id, f = !1, e.subSelection?.type === "character_joint" && (e.subSelection = null), u.size || M()), x(), V.update();
  }
...
function Ud(e) {
  ...
  const a = (y) => t.querySelector(`[data-role="${y}"]`), o = a("motion-clip"), n = a("motion-start"), s = a("motion-end"), i = a("motion-speed"), c = a("motion-loop"), l = t.querySelector('[data-motion-act="bake"]');
  let m = null;
  const p = () => e.state?.objects?.find((y) => y.id === m) || null, f = () => e.modelInfoById?.get(m)?.animationNames || [];
  function u() {
    const y = o?.value || "";
    return y ? Yr({
      clip_id: y,
  ...
  function d() {
    const y = u(), v = y ? { type: "character.set_motion", objectId: m, motion: y } : { type: "character.clear_motion", objectId: m }, j = e.directorApi?.execute({
      version: 1,
      id: `tx_motion_${Date.now().toString(36)}`,
      description: "Character motion",
      operations: [v]
    });
    j && !j.ok && e.setStatus?.(j.error?.message || r("Could not set the motion")), e.poseEditor?.sync?.(), h();
  }
  function h() {
    const y = p(), v = f(), j = y?.character?.motion || null;
    if (o) {
      const M = v.join("|");
      o.dataset.sig !== M && (o.dataset.sig = M, o.replaceChildren(
        xr("", v.length ? r("No motion (static)") : r("No clips in this model")),
        ...v.map((P) => xr(P, P))
      )), document.activeElement !== o && (o.value = j?.clip_id || ""), o.disabled = !v.length;
    }
    go(n, j?.start_frame ?? 0), go(s, j?.end_frame ?? 0), go(i, j?.speed ?? 1), c && document.activeElement !== c && (c.checked = j ? j.loop !== !1 : !0);
    const x = !!j;
    for (const M of [n, s, i, c]) M && (M.disabled = !x);
    l && (l.disabled = !x);
  }
  function b() {
    const y = p(), v = e.rigMapper?.boneMap;
    if (!y?.character || !v || !Object.keys(v).length) {
    ...
    e.directorApi?.execute({
      ...
      operations: [
        { type: "character.clear_motion", objectId: m },
        {
          ...
          objectId: m,
          pose: { preset_id: "neutral", root_offset: y.character.pose?.root_offset || [0, 0, 0], joints: j }
        }
      ]
  ...
  for (const y of [n, s, i, c]) y?.addEventListener("change", d);
  return l?.addEventListener("click", b), {
    sync: g,
    dispose() {
      o?.removeEventListener("change", d);
      for (const y of [n, s, i, c]) y?.removeEventListener("change", d);
...
function jn(e) {
  return {
    ...
    frames: Ae(e, "frame"),
    scrubs: Ae(e, "scrub"),
    cameraFov: Ae(e, "camera-fov"),
    cameraRoll: Ae(e, "camera-roll"),
    cameraFocal: Ae(e, "camera-focal"),
    viewportZoom: Ae(e, "viewport-zoom"),
    cameraType: Ae(e, "camera-type"),
    cameraNear: Ae(e, "camera-near"),
    cameraFar: Ae(e, "camera-far")
  };
}
const Gd = /* @__PURE__ */ new Set(["translate", "rotate", "scale"]), Xd = /* @__PURE__ */ new Set(["world", "local"]), Te = 180 / Math.PI;
function wr(e) {
  return [e.x, e.y, e.z];
}
function Yd(e) {
  return [e.x * Te, e.y * Te, e.z * Te];
}
function Zd({
  THREE: e,
  camera: t,
  ...
  const p = m ? m() : new e.Object3D(), f = l ? l(t, a) : new Gc(t, a);
  let u = null;
  o?.add && (u = typeof f.getHelper == "function" ? f.getHelper() : f, o.add(u), o.add(p));
  let d = null, h = null, b = !1, g = null, y = [0, 0, 0];
  function v() {
    return {
      position: wr(p.position),
      rotationDeg: Yd(p.rotation),
      scale: wr(p.scale)
    };
  }
  function j(C) {
  ...
  function M(C) {
    ...
    const R = C.rotationDeg.map((G, ae) => {
      const re = g ? g[ae] : h.rotationDeg[ae];
      return y[ae] += x(G - re), y[ae];
    });
    return g = C.rotationDeg, {
      position: C.position.map((G, ae) => G - h.position[ae]),
      rotationDeg: R,
      scaleFactors: C.scale.map((G, ae) => h.scale[ae] === 0 ? 1 : G / h.scale[ae])
    };
  }
  function P() {
    h = v(), g = null, y = [0, 0, 0], n?.({ targetSpec: d });
  }
  function D() {
    if (!h) return;
    const C = v();
  ...
  function B(C) {
    d = C, p.position.set(...C.position || [0, 0, 0]);
    const R = C.rotation || [0, 0, 0];
    p.rotation.set(R[0] / Te, R[1] / Te, R[2] / Te), p.scale.set(...C.scale || [1, 1, 1]), f.attach(p), f.visible = !0;
  }
  function V() {
    d = null, h = null, f.detach(), f.visible = !1;
  }
  function Q(C) {
    "camera" in f && (f.camera = C);
  }
  function k(C) {
    if (!Gd.has(C)) throw new Error(`createTransformControlsAdapter: unknown mode "${C}"`);
    f.setMode ? f.setMode(C) : f.mode = C;
  }
  function _(C) {
    if (!Xd.has(C)) throw new Error(`createTransformControlsAdapter: unknown space "${C}"`);
    f.space = C;
  }
  function z(C) {
  ...
  function W() {
    f.removeEventListener?.("mouseDown", P), f.removeEventListener?.("objectChange", D), f.removeEventListener?.("mouseUp", F), f.removeEventListener?.("dragging-changed", U), o?.remove && u && o.remove(u), o?.remove && o.remove(p), f.dispose?.(), d = null, h = null;
  }
  return {
    attach: B,
    detach: V,
...
function Qd(e, { controlsFactory: t, anchorFactory: a } = {}) {
  ...
  function u() {
    return o || (!e.webgl || !e.interactionElement ? null : (o = Zd({
      THREE: Uc,
  ...
  function d({ targetSpec: k }) {
    if (k) {
      if (l(c), k.type === "object") {
        e.checkpoint("Transform object");
        const _ = hs(e), z = (_.length ? _ : [k.object]).map((q) => ({
          object: q,
          transform: ze(q)
        }));
      ...
      if (k.type === "camera_path") {
        ...
        e.checkpoint("Transform camera path"), n = {
          type: "camera_path",
          trackId: _.id,
          origin: Jr(_.keyframes),
          baseKeys: _.keyframes.map((z) => ({ ...z, camera: de(z.camera) }))
        };
        return;
      }
      if (k.type === "path_point" || k.type === "path_group") {
        ...
        e.checkpoint(k.type === "path_point" ? "Transform path point" : "Transform path selection"), n = {
          ...
          baseKeys: _.keyframes.map((N) => ({ ...N, camera: de(N.camera) })),
          lookAtActive: Qr(_, e.state.objects)
        };
        return;
      }
  ...
  function b(k) {
    k.id === e.state.active_camera_id && (e.state.keyframes = k.keyframes), e.camera = we(k, e.frame, e.state.objects), k.camera = de(e.camera), e.refreshKeys();
  }
  function g(k) {
    const _ = e.state.cameras.find((z) => z.id === n.trackId);
    _ && (_.keyframes = en(n.baseKeys, h(k)), b(_));
  }
  function y(k) {
    const _ = e.state.cameras.find((N) => N.id === n.trackId);
    if (!_) return;
    const z = { ...h(k), lookAtActive: n.lookAtActive };
    _.keyframes = bs(n.baseKeys, n.selectedFrames, z), b(_);
  }
  function v(k) {
    const _ = e.state.cameras.find((z) => z.id === n.trackId);
    _ && (_.keyframes = gs(n.baseKeys, [n.frame], { delta: k.position }), b(_));
  }
  function j({ delta: k }) {
    n && (n.type === "object" ? x(k) : n.type === "camera" ? M(k) : n.type === "camera_target" ? P(k) : n.type === "camera_path" ? g(k) : n.type === "path_point" || n.type === "path_group" ? y(k) : n.type === "path_point_target" && v(k), e.render());
  }
  function x(k) {
    ...
    for (const q of _)
      if (N === "translate")
        ...
        q.object.position = ye(z, sr($e(q.transform.position, z), k.rotationDeg)), q.object.rotation = ye(q.transform.rotation, k.rotationDeg);
      else if (N === "scale") {
        const $ = $e(q.transform.position, z);
  ...
  function M(k) {
    if (e.state.gizmo_mode === "translate")
      ...
      const _ = $e(n.target, n.position);
      e.camera.target = ye(n.position, sr(_, k.rotationDeg));
    }
    e.commitCameraEdit();
  }
  function P(k) {
    const _ = ye(n.base, k.position);
    n.tracking ? us(e, _) : e.camera.target = _, e.commitCameraEdit();
  }
  ...
  function F() {
    ...
    const k = e.recording ? null : fs(e), _ = e.state.gizmo_mode || "translate", z = !!k && !k.readOnly && Jd.has(k.type) && k.allowedModes.includes(_);
    if (i = z ? k.type : null, !z) {
      o?.detach();
      return;
    }
    u() && (o.isDragging() || (o.setCamera(e.webgl.activeCamera), o.setMode(_), o.setSpace(e.state.gizmo_space === "local" ? "local" : "world"), o.attach(k)));
  }
  function U() {
...
function tm(e, t) {
  ...
  (!a.keyframes || a.keyframes.length === 0) && (a.keyframes = [
    { frame: 0, camera: de(e.camera), interpolation: "smooth" },
    { frame: e.state.duration_frames - 1, camera: de(e.camera), interpolation: "smooth" }
  ]);
...
function cm(e, { preset: t = "constant", strength: a = 1 } = {}) {
  const o = Cn(e).sort((i, c) => i.frame - c.frame);
  if (t === "custom" || !rm.includes(t)) return o;
  const n = Math.max(0, Math.min(1, Number(a) || 0)), s = sm(o);
  return o.map((i, c) => {
    const l = Ke(i), m = im(s[c], t), p = l + (m - l) * n;
    return Fo(i, p);
  });
}
function lm(e, {
  ...
  const s = Cn(e).sort((f, u) => f.frame - u.frame);
  ...
  const c = t === "custom" ? s : cm(s, { preset: t, strength: i }), l = o == null ? c[0].frame : Number(o), m = n == null ? c.at(-1).frame : Number(n), p = tn(c, { startFrame: l, endFrame: m });
...
function mm(e, t) {
  const a = so(e);
  a.wrap && (a.preset?.addEventListener("change", () => xt(e), { signal: t }), a.strength?.addEventListener("input", () => xt(e), { signal: t }), a.apply?.addEventListener("click", () => dm(e), { signal: t }), xt(e));
}
function pm(e) {
  const t = so(e);
  return t.group ? e.timelineObject?.() ? (e.setStatus?.(r("Timing remap is camera-only.")), !1) : (Mo(e, "curves"), t.group.value = "timing", t.group.dispatchEvent(new Event("change", { bubbles: !0 })), Bo(e), xt(e), e.drawCurveEditor?.(), e.setStatus?.(r("Inspecting camera timing.")), !0) : !1;
}
const kr = ["#4aa3ef", "#f2a93b", "#48c774", "#b565d8", "#ec4899"], De = [4, 8, 12, 20, 35, 60, 100];
function ot(e) {
...
function io(e, t, a) {
  ...
  const o = ot(e), n = o.expanded ? 220 : 138, s = Math.min(n, Math.max(80, Math.min(t, a) - 20)), i = 10, c = Math.max(0, t - s - i), l = Math.max(0, a - s - i), m = e.viewportCamera(), p = m?.position || [0, 1.5, 5], f = m?.target || [0, 0, 0], u = e.activeCameraTrack?.(), d = e.state.cameras?.length ? e.state.cameras : u ? [u] : [], h = d.flatMap(
  ...
  if (o.rangeIndex >= 0 && o.rangeIndex < De.length)
    ...
    const M = Math.max(
      ...
      Math.abs(f[0] || 0),
      Math.abs(f[2] || 0),
      ...h.flatMap((P) => [Math.abs(P[0] || 0), Math.abs(P[2] || 0)]),
      4
    );
    b = Math.max(6, Math.ceil((M + 1.5) / 4) * 4);
  }
  const g = c + s / 2, y = l + s / 2, v = s / 2 - 12, j = v / b, x = o.centerMode === "camera" ? [p[0] || 0, p[2] || 0] : [0, 0];
  return {
    rx: c,
    ry: l,
    radarSize: s,
...
function um(e, t, a, o) {
  const n = io(e, a, o);
  if (!n) return;
  const { rx: s, ry: i, radarSize: c, cx: l, cy: m, innerRadius: p, range: f, scale: u, camPos: d, camTgt: h, cameras: b, activeTrack: g } = n, y = ot(e), v = e.state.active_camera_id || g?.id, j = (ee, ie) => _n(n, ee, ie);
  ...
  for (const ee of M) {
    const ie = p * ee;
    t.beginPath(), t.arc(l, m, ie, 0, Math.PI * 2), t.stroke(), c >= 120 && (t.font = "8px monospace", t.fillStyle = "rgba(0, 210, 211, 0.35)", t.textAlign = "left", t.fillText(`${Math.round(f * ee)}m`, l + ie + 2, m - 2));
  }
  ...
  for (const ee of e.state.objects || []) {
    ...
    const ie = Oo(e.state.objects, ee).position || [0, 0, 0], [fe, me] = j(ie[0], ie[2]);
    if (fe < s + 3 || fe > s + c - 3 || me < i + 3 || me > i + c - 3) continue;
    const ue = e.selectedObjectId === ee.id || e.selectedObjectIds?.has?.(ee.id);
    if (t.save(), t.translate(fe, me), ee.type === "card") {
      const be = (ee.rotation?.[1] || 0) * Math.PI / 180;
      t.rotate(-be), t.fillStyle = ue ? "#a855f7" : "#38bdf8", t.fillRect(-4, -1.2, 8, 2.4), t.strokeStyle = ue ? "#ffffff" : "rgba(255,255,255,0.6)", t.lineWidth = 1, t.strokeRect(-4, -1.2, 8, 2.4);
    } else if (ee.type === "light") {
      t.fillStyle = ue ? "#a855f7" : "#fbbf24", t.beginPath(), t.arc(0, 0, 3, 0, Math.PI * 2), t.fill(), t.strokeStyle = "#fbbf24", t.lineWidth = 1;
      ...
      t.fillStyle = ue ? "#a855f7" : ee.type === "human" ? "#ec4899" : "#f59e0b", t.beginPath(), t.arc(0, 0, 2.8, 0, Math.PI * 2), t.fill();
    ue && (t.strokeStyle = "#a855f7", t.lineWidth = 1.2, t.beginPath(), t.arc(0, 0, 6, 0, Math.PI * 2), t.stroke()), t.restore();
  }
  for (let ee = 0; ee < b.length; ee++) {
    const ie = b[ee], fe = ie.keyframes || [], me = ie.id === v, ue = ie.color || kr[ee % kr.length];
    t.save(), t.strokeStyle = ue, t.globalAlpha = me ? 0.95 : 0.4, t.lineWidth = me ? 2 : 1, t.setLineDash(me ? [] : [2, 2]), t.beginPath();
    let be = !1;
    const O = fe[0]?.frame, H = fe[fe.length - 1]?.frame;
    for (let ce = O; Number.isFinite(ce) && ce <= H; ce++) {
      const le = we(ie, ce, e.state.objects)?.position;
      if (!Array.isArray(le)) continue;
      const [pe, ne] = j(le[0], le[2]);
      be ? t.lineTo(pe, ne) : (t.moveTo(pe, ne), be = !0);
    }
    be && t.stroke(), t.restore(), t.save();
    for (const ce of fe) {
      const le = ce.camera?.position;
      if (!le) continue;
      const [pe, ne] = j(le[0], le[2]);
      if (pe < s + 4 || pe > s + c - 4 || ne < i + 4 || ne > i + c - 4) continue;
      const ke = ce.frame === e.frame && me;
      t.fillStyle = ke ? "#ffffff" : ue, t.globalAlpha = me ? 0.95 : 0.6, t.beginPath(), t.moveTo(pe, ne - 3), t.lineTo(pe + 3, ne), t.lineTo(pe, ne + 3), t.lineTo(pe - 3, ne), t.closePath(), t.fill(), ke && (t.strokeStyle = "#00d2d3", t.lineWidth = 1.2, t.stroke());
    }
    t.restore();
  }
  const [P, D] = j(d[0] || 0, d[2] || 0), [F, U] = j(h[0] || 0, h[2] || 0), B = 8, V = Z(P, s + B, s + c - B), Q = Z(D, i + B, i + c - B), k = Z(F, s + B, s + c - B), _ = Z(U, i + B, i + c - B), z = d[1] || 0, N = fm(z), q = hm(z);
...
function bm(e, t, a, o, n, s, i) {
  ...
  const f = l + 3, u = 12;
  Va(t, c + 44, f, 12, u, "−", p.hover?.button === "zoom_out"), Va(t, c + 58, f, 12, u, "+", p.hover?.button === "zoom_in");
  const d = p.centerMode === "camera" ? "CAM" : "CTR";
  Va(t, c + 72, f, 22, u, d, p.hover?.button === "center");
  const h = p.expanded ? "⤡" : "⤢";
  Va(t, c + 96, f, 14, u, h, p.hover?.button === "size"), t.font = "bold 8.5px monospace", t.fillStyle = o, t.textAlign = "right", t.fillText(`Y:${n}`, c + m - 5, l + 9), t.fillStyle = "rgba(15, 23, 42, 0.70)", t.fillRect(c, l + m - 15, m, 15), t.strokeStyle = "rgba(0, 210, 211, 0.15)", t.beginPath(), t.moveTo(c, l + m - 15), t.lineTo(c + m, l + m - 15), t.stroke();
  const b = Math.round((s * 180 / Math.PI + 360) % 360);
  t.font = "8px monospace", t.fillStyle = "rgba(255, 255, 255, 0.55)", t.textAlign = "left", t.fillText(`HDG:${b}°`, c + 5, l + m - 7), t.textAlign = "right", t.fillText(`DIST:${i.toFixed(1)}m`, c + m - 5, l + m - 7);
}
function Va(e, t, a, o, n, s, i) {
...
function $n(e, t, a, o) {
  const { camPos: n, camTgt: s, cameras: i, rx: c, ry: l, radarSize: m } = t, p = (g, y) => _n(t, g, y), [f, u] = p(n[0] || 0, n[2] || 0);
  if (Math.hypot(a - f, o - u) <= 8)
    return { type: "camera", pos: n };
  const [d, h] = p(s[0] || 0, s[2] || 0);
  if (Math.hypot(a - d, o - h) <= 8)
    return { type: "target", pos: s };
  const b = e.activeCameraTrack?.();
  if (b)
    for (const g of b.keyframes || []) {
      const y = g.camera?.position;
      if (!y) continue;
      const [v, j] = p(y[0], y[2]);
      if (Math.hypot(a - v, o - j) <= 6)
        return { type: "keyframe", key: g, frame: g.frame };
    }
  for (const g of e.state.objects || []) {
    if (g.enabled === !1) continue;
    const y = Oo(e.state.objects, g).position || [0, 0, 0], [v, j] = p(y[0], y[2]);
    if (Math.hypot(a - v, o - j) <= 7)
      return { type: "object", object: g, id: g.id };
  }
  return null;
}
function vm(e, t, a, o) {
  if (!e.state.show_radar || t.button != null && t.button !== 0 || t.altKey || t.ctrlKey || t.metaKey || e.isNavigatingFly || e.cameraPathDraw) return !1;
  const n = io(e, e.canvas.width, e.canvas.height);
  if (!n) return !1;
  const { rx: s, ry: i, radarSize: c } = n;
  if (a < s || a > s + c || o < i || o > i + c)
    return !1;
  t.preventDefault?.(), t.stopPropagation?.();
  const l = ot(e), m = En(n, a, o);
  if (m)
    return m === "zoom_in" ? (l.rangeIndex === -1 && (l.rangeIndex = De.findIndex((d) => d >= n.range), l.rangeIndex < 0 && (l.rangeIndex = De.length - 1)), l.rangeIndex = Math.max(0, (l.rangeIndex === -1 ? 2 : l.rangeIndex) - 1)) : m === "zoom_out" ? (l.rangeIndex === -1 && (l.rangeIndex = De.findIndex((d) => d >= n.range), l.rangeIndex < 0 && (l.rangeIndex = 0)), l.rangeIndex = Math.min(De.length - 1, l.rangeIndex + 1)) : m === "center" ? l.centerMode = l.centerMode === "camera" ? "origin" : "camera" : m === "size" && (l.expanded = !l.expanded), e.render?.(), !0;
  const p = $n(e, n, a, o);
  if (p) {
    if (p.type === "camera")
  ...
  if (t.shiftKey) {
    ...
    const d = e.viewportCamera();
    d.target = [f, d.target?.[1] || 0, u], e.commitCameraEdit?.();
  } else {
    e.checkpoint?.("Set camera via radar"), e.beginCameraEdit?.();
    const d = e.viewportCamera();
    d.position = [f, d.position?.[1] || 1.5, u], e.commitCameraEdit?.();
  }
...
function ym(e, t, a, o) {
  ...
  const n = io(e, e.canvas.width, e.canvas.height);
  if (!n) return !1;
  const s = ot(e), { rx: i, ry: c, radarSize: l } = n, m = a >= i && a <= i + l && o >= c && o <= c + l;
  if (s.drag) {
    const [b, g] = Ao(n, a, o), y = e.viewportCamera();
    return s.drag.type === "camera" ? y.position = [b, y.position?.[1] || 1.5, g] : s.drag.type === "target" && (y.target = [b, y.target?.[1] || 0, g]), e.setFrame?.(e.frame, !1, !1), e.render?.(), !0;
  }
  if (!m)
    return s.hover && (s.hover = null, e.render?.()), !1;
  const p = En(n, a, o), f = $n(e, n, a, o), [u, d] = Ao(n, a, o);
  let h = `[${u.toFixed(1)}m, ${d.toFixed(1)}m]`;
...
function xm(e, t, a, o) {
  ...
  if (a < s || a > s + c || o < i || o > i + c)
    return !1;
  t.preventDefault?.(), t.stopPropagation?.();
  const l = ot(e), m = Math.sign(t.deltaY || 0);
  return l.rangeIndex === -1 && (l.rangeIndex = De.findIndex((p) => p >= n.range), l.rangeIndex < 0 && (l.rangeIndex = 2)), m > 0 ? l.rangeIndex = Math.min(De.length - 1, l.rangeIndex + 1) : m < 0 && (l.rangeIndex = Math.max(0, l.rangeIndex - 1)), e.render?.(), !0;
}
function wm(e, t = {}) {
  if (!e) return () => {
  };
  ...
  let i = !1, c = 0, l = 0, m = !1;
  const p = (d) => {
    d.button === 0 && (d.target === a && document.activeElement === a || (c = d.clientX, l = parseFloat(a.value) || 0, m = !1, window.addEventListener("mousemove", f), window.addEventListener("mouseup", u)));
  }, f = (d) => {
    const h = d.clientX - c;
    if (!m && Math.abs(h) < 3)
      return;
    m || (m = !0, i = !0, document.body.style.cursor = "ew-resize", a.blur()), d.preventDefault();
    let b = 1;
    d.shiftKey ? b = n : (d.ctrlKey || d.metaKey) && (b = s);
    const g = h * o * b;
    let y = l + g;
    const v = Math.max(1, (o * b).toString().split(".")[1]?.length || 1);
    y = parseFloat(y.toFixed(v));
    const j = parseFloat(a.min), x = parseFloat(a.max);
    isNaN(j) || (y = Math.max(j, y)), isNaN(x) || (y = Math.min(x, y)), parseFloat(a.value) !== y && (a.value = y, a.dispatchEvent(new Event("input", { bubbles: !0 })));
  }, u = () => {
...
function jm(e, t, a) {
  ...
  const o = () => {
    ...
    const b = String(t('[data-role="object-annotation"]')?.value || "").trim(), g = b ? xs({
      text: b,
  ...
  }, { signal: a }), dl(e, a), Ol(e, a), mm(e, a), t('[data-role="curve-group"]')?.addEventListener("change", () => {
    e.setChannelFilter("all"), Bo(e), xt(e), e.drawCurveEditor();
  ...
  for (const d of e.root.querySelectorAll(".toolbar-menu"))
    d.addEventListener("toggle", () => {
      d.open ? (e.closeMenus(d), Sr(d)) : Sm(d);
    }, { signal: a });
  document.addEventListener("scroll", () => {
    for (const d of e.root.querySelectorAll(".toolbar-menu[open]")) Sr(d);
  }, { capture: !0, signal: a });
  const c = (d, h) => {
    ...
    if (!(!b || h.button === 2 || d.closest(".scene-action-btn")))
      if (b.dataset.objectId) {
        const g = e.state.objects.find((v) => v.id === b.dataset.objectId);
        if (!g) return;
        ...
        else if (h.shiftKey && e.outlinerAnchorId && e.state.objects.some((v) => v.id === e.outlinerAnchorId)) {
          const v = e.state.objects.map((M) => M.id), j = v.indexOf(e.outlinerAnchorId), x = v.indexOf(g.id);
          e.selectedObjectIds = new Set(v.slice(Math.min(j, x), Math.max(j, x) + 1));
        } else
          e.selectedObjectIds = /* @__PURE__ */ new Set([g.id]), e.outlinerAnchorId = g.id;
        e.selectedObjectId = e.selectedObjectIds.has(g.id) ? g.id : [...e.selectedObjectIds].at(-1) || null, e.selectedEntity = e.selectedObjectIds.size ? "object" : "camera", e.selectedKeyFrame = e.selectedObjectId ? g.keyframes?.find((v) => v.frame === e.frame)?.frame ?? null : null, e.editingKeyFrame = null;
        for (const v of e.root.querySelectorAll(".scene-item")) {
          const j = !!(v.dataset.objectId && e.selectedObjectIds.has(v.dataset.objectId)), x = !!(v.dataset.objectId && v.dataset.objectId === e.selectedObjectId);
          v.classList.toggle("selected", j), v.classList.toggle("primary", x), v.setAttribute("aria-selected", String(j));
        }
        const y = e.root.querySelector('[data-role="outliner-batch-bar"]');
        if (y) {
          const v = e.selectedObjectIds?.size || 0;
          y.hidden = v < 2;
          const j = y.querySelector('[data-role="batch-count"]');
          j && (j.textContent = `${v} ${r("selected")}`);
        }
        e.refreshKeys(), e.refreshInspector(), e.render(), e.setStatus(r("Selected: {value1}", { value1: g.name || g.type }));
  ...
  e.root.addEventListener("pointerdown", (d) => {
    ...
    const h = e.interactionElement.getBoundingClientRect(), b = (d.clientX - h.left) * e.canvas.width / Math.max(1, h.width), g = (d.clientY - h.top) * e.canvas.height / Math.max(1, h.height);
    xm(e, d, b, g) || e.onWheel(d);
  }, { passive: !1, signal: a }), e.root.addEventListener("wheel", Wc(e.root), { signal: a }), window.addEventListener("pointermove", (d) => {
  ...
  l && (l.addEventListener("pointerdown", (d) => e.onTimelinePointerDown(d), { signal: a }), l.addEventListener("pointermove", (d) => e.onTimelinePointerMove(d), { signal: a }), l.addEventListener("pointerup", (d) => e.onTimelinePointerUp(d), { signal: a }), l.addEventListener("pointercancel", (d) => e.onTimelinePointerUp(d), { signal: a }), l.addEventListener("wheel", (d) => Br(e, d), { passive: !1, signal: a }));
  const m = (d) => {
  ...
  e.root.addEventListener("focusin", m, { signal: a }), e.root.addEventListener("pointerdown", m, { capture: !0, signal: a }), e.root.addEventListener("focusout", (d) => {
    e.modalTransform && !e.root.contains(d.relatedTarget) && (vs(e), e.render());
  }, { signal: a });
...
function _m(e, t) {
  Ko.find((o) => o.id === e)?.onChange?.(t);
}
function Em(e) {
  const t = pi(e.id, e.defaultValue), a = `pref_${e.id.replace(/[^a-zA-Z0-9]/g, "_")}`;
  if (e.type === "boolean")
    return `
...
function $m(e) {
  const t = new Map(Ko.map((o) => [o.id, o]));
  return ({
    nav: [
      oi,
      ri,
...
function Mm() {
  return `<span class="oc-pref-emoji" aria-hidden="true">${Cm}</span> ${r("OmniCam Preferences")}`;
}
function Am(e) {
  ...
  a.className = "oc-modal-backdrop", a.setAttribute("role", "dialog"), a.setAttribute("aria-modal", "true"), a.setAttribute("aria-label", r("OmniCam Preferences")), a.innerHTML = `
    <div class="oc-modal-dialog oc-pref-dialog" tabindex="-1">
      <div class="oc-pref-header">
        <div class="oc-pref-title">${Mm()}</div>
...
const Pm = ["position", "target"], Im = ["fov", "zoom"], zm = ["roll"], Fm = ["position", "size"], Lm = ["rotation"];
function To(e) {
...
function _r(e, t, a, o) {
  const n = To(Number(a || 0) - Number(e || 0)), s = Number(e || 0) + n * o;
  if (t == null) return s;
  const i = To(Number(t || 0) - s);
  return s + i / 3;
}
function Er(e, t, a) {
...
function Dm(e, t) {
  ...
  for (let n = 1; n < a.length - 1; n++) {
    ...
    if (i.camera) {
      for (const p of Pm) {
        const f = s.camera?.[p], u = i.camera?.[p], d = c.camera?.[p];
        if (Array.isArray(f) && Array.isArray(d) && Array.isArray(u)) {
          const h = Cr(f, u, d, m);
          a[n].camera[p] = Er(u.map(Number), h, o);
        }
      }
      for (const p of Im) {
        const f = s.camera?.[p], u = i.camera?.[p], d = c.camera?.[p];
      ...
      for (const p of zm) {
        ...
        if (f != null && d != null && u != null) {
          const h = _r(f, u, d, m);
          a[n].camera[p] = $r(Number(u), h, o);
        }
      }
    }
    if (Array.isArray(i.position) && Array.isArray(s.position) && Array.isArray(c.position)) {
      for (const p of Fm) {
        const f = s[p], u = i[p], d = c[p];
        if (Array.isArray(f) && Array.isArray(d) && Array.isArray(u)) {
          const h = Cr(f, u, d, m);
          a[n][p] = Er(u.map(Number), h, o);
        }
      }
      for (const p of Lm) {
        const f = s[p], u = i[p], d = c[p];
        if (Array.isArray(f) && Array.isArray(d) && Array.isArray(u)) {
          const h = [0, 1, 2].map((b) => _r(f[b], u[b], d[b], m));
          a[n][p] = u.map((b, g) => $r(Number(b), h[g], o));
        }
      }
    }
  }
...
function Wm(e, t) {
  ...
  const o = (n) => {
    ...
    const h = (g) => {
      const y = g.clientX - c;
      if (Math.abs(y) > 2 && (u = !0), !u) return;
      d || (e.checkpoint?.("Scrub axis"), d = !0);
      let v = Rm;
      g.shiftKey ? v = qm : (g.ctrlKey || g.metaKey) && (v = Bm);
      const j = m * v * 20;
      let x = l + y * j;
      ...
      if (s.classList.remove("scrubbing"), document.body.style.cursor = "", s.removeEventListener("pointermove", h), s.removeEventListener("pointerup", b), s.removeEventListener("pointercancel", b), s.releasePointerCapture)
        try {
    ...
    s.addEventListener("pointermove", h), s.addEventListener("pointerup", b), s.addEventListener("pointercancel", b);
  };
...
function Mn(e) {
  ...
  l && o?.fov != null && (l.textContent = `${Ro(o.fov)}mm`);
  const m = t.querySelector('[data-role="hud-cam-fov"]');
  m && o?.fov != null && (m.textContent = xc(o.fov));
  const p = t.querySelector('[data-role="hud-cam-dist"]');
  if (p)
    if (o?.target && Array.isArray(o.target) && Array.isArray(o.position)) {
      const h = Ve($e(o.position, o.target));
      p.textContent = `Tgt: ${h.toFixed(2)}m`;
    } else
      p.textContent = "Free";
  const f = t.querySelector('[data-role="hud-roll-reset"]'), u = t.querySelector('[data-role="hud-roll-val"]'), d = Number(o?.roll || 0);
  f && (Math.abs(d) > 0.05 ? (f.hidden = !1, u && (u.textContent = `${d > 0 ? "+" : ""}${d.toFixed(1)}°`)) : f.hidden = !0);
}
function Hm(e) {
...
function Ee(e) {
  ...
  if (t) {
    ...
    t.textContent = u ? "L" : "W";
    const d = t.closest('[data-role="gizmo-space-toggle"]');
    d && (d.classList.toggle("active", u), d.title = u ? r("Transform Space: Local (click for World)") : r("Transform Space: World (click for Local)"));
  }
...
function Gm(e, t) {
  ...
  !a || !o || (n && n.addEventListener("change", () => {
    ...
    document.activeElement !== a && (a.value = Ro(o.value));
  }, { signal: t }));
}
function Xm(e, t) {
  ...
  }, s = (i) => (e.smoothingBaseline?.cameraId !== i.id && (e.smoothingBaseline = { cameraId: i.id, keys: Nm(i.keyframes) }), e.smoothingBaseline.keys);
  a.addEventListener("input", n, { signal: t }), a.addEventListener("change", () => {
    const i = e.activeCameraTrack();
    if (!i) return;
    e.checkpoint("Path smoothing");
    const c = Number(a.value) / 100, l = Dm(s(i), c);
...
function Ym(e, t) {
  ...
  e.root.querySelector('[data-act="keys-reduce"]')?.addEventListener("click", async () => {
    const l = await Ct(e, r("Reduce keys"), r("Target number of keys"), "8"), m = Math.round(Number(l));
...
const Ha = () => import("./chunk-Czn6Vmik.js");
function tp(e, t) {
  Ha().then(({ loadExchangeFormats: o }) => o(e, t)), e.root.querySelector('[data-act="import-camera"]')?.addEventListener("click", async () => {
    (await Ha()).pickCameraFile(e);
  }, { signal: t }), e.root.querySelector('[data-act="export-camera"]')?.addEventListener("click", async () => {
    (await Ha()).exportCamera(e);
  }, { signal: t }), e.root.querySelector('[data-role="camera-file"]')?.addEventListener("change", async (o) => {
    const n = o.target.files?.[0];
    o.target.value = "", await (await Ha()).importCameraFile(e, n);
  }, { signal: t });
}
function ap(e, t) {
  ...
  const o = () => {
    ...
    c === "health-slow" ? ui(e) : c === "health-smooth" ? bi(e) : c === "health-recenter" ? gi(e) : c === "health-timing" && pm(e);
  }, { signal: t });
  for (const n of e.root.querySelectorAll('[data-tab="health"]'))
    n.addEventListener("click", () => ho(e), { signal: t });
}
function op(e, t) {
...
function sp(e, t) {
  tp(e, t), Gm(e, t), Xm(e, t), Ym(e, t), Zm(e, t), op(e, t), np(e, t), rp(e, t), Wm(e, t), Vm(e, t), Jm(e, t), ep(e, t), Um(e, t), Qm(e, t), ap(e, t);
}
const Mr = {
...
}, An = "balanced", yo = "#121212";
function Ho(e) {
  return Mr[e] || Mr[An];
}
function ip(e, t = "#1b1f2b", a = "#151822", o = "#1e2330", n = "#161922", s = "#111319") {
...
function Nu(e, t, a = An) {
  const o = Ho(a), n = new e.Group();
  ...
  const d = new e.FogExp2(1250588, 8e-3), h = ip(e), b = new e.PMREMGenerator(t);
  b.compileEquirectangularShader();
  const g = new Xc(), y = b.fromScene(g, 0.04).texture;
  return g.traverse((v) => {
    v.geometry?.dispose?.();
    ...
    quality: a,
    dispose() {
      f.geometry.dispose(), f.material.dispose(), u.geometry.dispose(), u.material.dispose(), p.dispose(), h.dispose(), y.dispose(), b.dispose();
...
function qu(e, t, a, o, n) {
  o.group.visible = n, t.environment = n ? o.environment : null, t.background = n ? o.sky : new e.Color(1184274), t.fog = n ? o.fog : null, a.toneMapping = n ? e.ACESFilmicToneMapping : e.NoToneMapping, a.toneMappingExposure = n ? Ho(o.quality).toneExposure : 1, t.traverse((s) => {
...
function lp(e) {
  ...
  const n = e.reconstruction, s = n.provider || "Reconstructed", i = Math.round(t * 100), c = jc(e), l = c.length ? `
` + c.map(([p, f]) => `${p}: ${f}`).join(`
`) : "", m = `${s} • ${o} (${i}%)${l}`;
  return {
    label: o,
...
function pp(e, t, a) {
  ...
  if (o) {
    const s = (i) => {
      const c = i.target.closest?.("[data-axis], [data-axis-center]") || i.target, l = c.getAttribute("data-axis"), m = vi(l?.toLowerCase(), e.state.view_mode);
  ...
  for (const s of e.root.querySelectorAll('[data-role="camera-type"]'))
    s.addEventListener("change", (i) => {
      e.camera.camera_type !== i.target.value && e.checkpoint("Change camera type"), e.camera.camera_type = i.target.value, ve(e.root, "camera-type", i.target), e.beginCameraEdit(), e.commitCameraEdit(), e.finishCameraEdit(), e.render();
    }, { signal: a });
  ...
  for (const s of e.root.querySelectorAll('[data-role="point-color"]'))
    s.addEventListener("input", (i) => {
      e.state.point_color !== i.target.value && Ua(e, "point_color", "Change point color"), e.state.point_color = i.target.value, e.scheduleSerialize(), e.render();
    }, { signal: a });
  ...
  for (const s of e.root.querySelectorAll('[data-role="speed-heatmap"]'))
    s.addEventListener("change", (i) => {
      e.state.speed_heatmap !== i.target.checked && e.checkpoint("Toggle speed heatmap"), e.state.speed_heatmap = i.target.checked, ve(e.root, "speed-heatmap", i.target, "checked"), e.scheduleSerialize(), e.render();
    }, { signal: a });
  for (const s of e.root.querySelectorAll('[data-role="playblast-grid"]'))
    s.addEventListener("change", (i) => {
      e.state.playblast_grid !== i.target.checked && e.checkpoint("Toggle playblast grid"), e.state.playblast_grid = i.target.checked, ve(e.root, "playblast-grid", i.target, "checked"), e.scheduleSerialize(), e.render();
    }, { signal: a });
  for (const s of e.root.querySelectorAll('[data-role="playblast-labels"]'))
    s.addEventListener("change", (i) => {
      e.state.playblast_labels !== i.target.checked && e.checkpoint("Toggle playblast labels"), e.state.playblast_labels = i.target.checked, ve(e.root, "playblast-labels", i.target, "checked"), e.scheduleSerialize(), e.render();
    }, { signal: a });
  for (const s of e.root.querySelectorAll('[data-role="playblast-resolution"]'))
    s.addEventListener("change", (i) => {
      e.state.playblast_resolution !== i.target.value && e.checkpoint("Change playblast resolution"), e.state.playblast_resolution = i.target.value, ve(e.root, "playblast-resolution", i.target), e.scheduleSerialize();
    }, { signal: a });
  for (const s of e.root.querySelectorAll('[data-act="reset-bg-color"]'))
    s.addEventListener("click", () => {
      e.state.viewport_bg_color !== yo && e.checkpoint("Reset background colour"), e.state.viewport_bg_color = yo;
      for (const i of e.root.querySelectorAll('[data-role="viewport-bg-color"]')) i.value = yo;
  ...
  for (const s of e.root.querySelectorAll('[data-role="show-grid"]'))
    s.addEventListener("change", (i) => {
      e.state.show_grid = i.target.checked, ve(e.root, "show-grid", i.target, "checked"), e.scheduleSerialize(), e.render();
    }, { signal: a });
  for (const [s, i] of [
    ...
    for (const c of e.root.querySelectorAll(`[data-role="${s}"]`))
      c.addEventListener("change", (l) => {
        e.state[i] !== l.target.checked && e.checkpoint("Toggle viewport helper"), e.state[i] = l.target.checked, ve(e.root, s, l.target, "checked"), e.scheduleSerialize(), e.render();
      }, { signal: a });
  ...
  for (const s of e.root.querySelectorAll('[data-role="show-wireframe"]'))
    s.addEventListener("change", (i) => {
      e.state.show_wireframe !== i.target.checked && e.checkpoint("Toggle wireframe"), e.state.show_wireframe = i.target.checked, ve(e.root, "show-wireframe", i.target, "checked"), e.scheduleSerialize(), e.webgl && (e.webgl.sceneKey = ""), e.render();
    }, { signal: a });
  for (const s of e.root.querySelectorAll('[data-role="show-vertices"]'))
    s.addEventListener("change", (i) => {
      e.state.show_vertices !== i.target.checked && e.checkpoint("Toggle vertices"), e.state.show_vertices = i.target.checked, ve(e.root, "show-vertices", i.target, "checked"), e.scheduleSerialize(), e.webgl && (e.webgl.sceneKey = ""), e.render();
    }, { signal: a });
  for (const s of e.root.querySelectorAll('[data-role="backface-culling"]'))
    s.addEventListener("change", (i) => {
      !!e.state.backface_culling !== i.target.checked && e.checkpoint("Toggle backface culling"), e.state.backface_culling = i.target.checked, ve(e.root, "backface-culling", i.target, "checked"), e.scheduleSerialize(), e.webgl && (e.webgl.sceneKey = ""), e.render(), e.setStatus(e.state.backface_culling ? r("Backface culling: On (Single-Sided)") : r("Backface culling: Off (Double-Sided)"));
    }, { signal: a });
  ...
  for (const s of e.root.querySelectorAll('[data-role="burn-in"]'))
    s.addEventListener("change", (i) => {
      e.state.burn_in !== i.target.checked && e.checkpoint("Toggle burn-in"), e.state.burn_in = i.target.checked, ve(e.root, "burn-in", i.target, "checked"), e.scheduleSerialize(), e.render();
    }, { signal: a });
  for (const s of e.root.querySelectorAll('[data-role="guides"]'))
    s.addEventListener("change", (i) => {
      e.state.guides !== i.target.checked && e.checkpoint("Toggle guides"), e.state.guides = i.target.checked, ve(e.root, "guides", i.target, "checked"), e.scheduleSerialize(), e.render();
    }, { signal: a });
  for (const s of e.root.querySelectorAll('[data-role="safe-areas"]'))
    s.addEventListener("change", (i) => {
      e.state.safe_areas !== i.target.checked && e.checkpoint("Toggle safe areas"), e.state.safe_areas = i.target.checked, ve(e.root, "safe-areas", i.target, "checked"), e.scheduleSerialize(), e.renderCameraView(), e.render();
    }, { signal: a });
  for (const s of e.root.querySelectorAll('[data-role="resolution-gate"]'))
    s.addEventListener("change", (i) => {
      e.state.resolution_gate !== i.target.checked && e.checkpoint("Toggle resolution gate"), e.state.resolution_gate = i.target.checked, ve(e.root, "resolution-gate", i.target, "checked"), e.scheduleSerialize(), e.renderCameraView(), e.render();
    }, { signal: a });
  for (const s of e.root.querySelectorAll('[data-role="aspect-ratio"]'))
    s.addEventListener("change", (i) => {
      e.state.aspect_ratio !== i.target.value && e.checkpoint("Change aspect ratio"), e.state.aspect_ratio = i.target.value, ve(e.root, "aspect-ratio", i.target), e.scheduleSerialize(), e.renderCameraView(), e.render();
    }, { signal: a });
  for (const s of e.root.querySelectorAll('[data-role="viewport-bg-color"]')) {
    const i = (c) => {
      e.state.viewport_bg_color !== c.target.value && Ua(e, "viewport_bg_color", "Change background colour"), e.state.viewport_bg_color = c.target.value, ve(e.root, "viewport-bg-color", c.target), e.scheduleSerialize(), e.render();
    };
    s.addEventListener("input", i, { signal: a }), s.addEventListener("change", i, { signal: a });
  }
  ...
  for (const s of e.root.querySelectorAll('[data-role="object-color"]'))
    s.addEventListener("input", (i) => {
      const c = e.selectedObject();
      c && (c.color !== i.target.value && Ua(e, `object_color:${c.id}`, "Change object color"), c.color = i.target.value, e.scheduleSerialize(), e.render());
    }, { signal: a });
  for (const s of e.root.querySelectorAll('[data-role="object-light-color"]'))
    s.addEventListener("input", (i) => {
      const c = e.selectedObject();
      c && (c.color !== i.target.value && Ua(e, `object_color:${c.id}`, "Change light color"), c.color = i.target.value, e.scheduleSerialize(), e.render());
    }, { signal: a });
  ...
  for (const s of e.root.querySelectorAll("[data-lens]"))
    s.addEventListener("click", () => {
      Cc(e, Number(s.dataset.lens));
    }, { signal: a });
  for (const s of e.root.querySelectorAll("[data-blocking-scene]"))
    s.addEventListener("click", () => {
      om(e, s.dataset.blockingScene), e.closeMenus();
    }, { signal: a });
...
const fp = 32, hp = 0.025, up = 0.05, Qa = 1e-6, bp = ["top", "bottom", "front", "back", "left", "right"], gp = {
  top: "y",
  bottom: "y",
  front: "z",
  back: "z",
...
function vp(e) {
  let t = 0;
  for (let a = 1; a < e.length; a++) t += Go(e[a - 1], e[a]);
  return t;
}
function Io(e) {
  const t = Math.max(0, Math.round(Number(e?.duration_frames) || 1) - 1), a = Array.isArray(e?.playback_range) ? e.playback_range : [0, t], o = Po(Math.round(Number(a[0]) || 0), 0, t), n = Po(Math.round(Number(a[1]) || t), 0, t);
  return o <= n ? [o, n] : [n, o];
}
function yp(e, t) {
  ...
  for (let i = 0; i < t; i++) {
    ...
    const l = a[s - 1], m = a[s], p = Po((c - l) / Math.max(Qa, m - l), 0, 1), f = e[s - 1], u = e[s];
    n.push([
      f[0] + (u[0] - f[0]) * p,
      f[1] + (u[1] - f[1]) * p,
      f[2] + (u[2] - f[2]) * p
...
function Tn(e, t = [0, 0, -1]) {
  ...
  return a < Qa ? [...t] : [(e[0] || 0) / a, 0, (e[2] || 0) / a];
}
function Pn(e, t) {
  const a = Math.hypot(e[0] || 0, e[1] || 0, e[2] || 0);
  return a < Qa ? [...t] : [e[0] / a, e[1] / a, e[2] / a];
}
function xp(e, t, a, o) {
...
function kp(e) {
  ...
  const s = Math.min(fp, n.length, o + 1);
  if (s < 2) return [];
  const i = yp(n, s);
  ...
  for (let u = p; u < i.length; u++) {
    const d = i[u], h = xp(i, u, m, e.planeAxis), b = de(c);
    b.position = [...d], b.target = wp(d, h, l, e.planeAxis), f.push({
      frame: Math.round(t + o * u / (i.length - 1)),
      camera: b,
      interpolation: "smooth"
    });
  }
  return f.filter((u, d, h) => d === 0 || u.frame > h[d - 1].frame);
}
function Sp(e) {
...
function Ar(e, t = {}) {
  ...
  const a = t.mode === "extend" ? "extend" : "new", o = e.activeCameraTrack?.(), n = de(e.camera || o?.camera);
  ...
  if (a === "extend") {
    ...
    s = [...d.camera.position], i = o.id;
    const h = Math.max(0, Math.round(Number(e.state.duration_frames) || 1) - 1), [, b] = Io(e.state), g = u.length > 1 ? u[u.length - 1].frame - u[0].frame : 24;
    let y = Math.max(b, d.frame + Math.max(6, Math.min(g, 240)));
    y <= d.frame && (y = d.frame + 24), y > h && (l = y + 1), y > b && (m = y), c = [d.frame, y];
  } else
    bp.includes(e.state.view_mode) || e.setViewMode?.("top"), c = Io(e.state);
  const p = gp[e.state.view_mode] ?? null, f = s ? [...s] : [...n.position];
  return e.cameraPathDraw = {
    ...
    sourceCamera: n,
    points: []
  }, St(e), e.setStatus?.(a === "extend" ? r("Continue Camera Path: LMB draw from the last key · RMB or Esc cancel") : r("Draw Camera Path: LMB draw · RMB or Esc cancel")), e.render?.(), !0;
}
function Xo(e, t) {
  ...
  return n && Go(n, o) < hp ? !1 : (a.points.push(o), !0);
}
function Pe(e) {
  const t = e.cameraPathDraw;
  return t?.active ? (In(e, t), e.cameraPathDraw = null, St(e), e.setStatus?.(r("Draw Camera Path cancelled")), e.render?.(), !0) : !1;
}
function jp(e) {
  const t = e.cameraPathDraw;
  ...
  if (a.length < 2 || vp(a) < up || t.range[1] <= t.range[0])
  ...
  if (t.mode === "extend") {
    ...
    return c.keyframes = m, c.id === e.state.active_camera_id && (e.state.keyframes = m), e.cameraPreviewSignature = "", e.cameraPathDraw = null, St(e), e.activateCamera?.(c.id), e.setFrame?.(o[0].frame), e.serialize?.(), e.refreshKeys?.(), e.render?.(), e.setStatus?.(r("Camera path extended")), c.id;
  }
  e.checkpoint?.("Draw camera path");
  const n = _c(e.state), s = e.state.cameras.length, i = {
    id: n,
    name: Sp(e.state),
    color: dr[s % dr.length],
    camera: de(o[0].camera),
    keyframes: o,
    target_object_id: null,
    target_offset: [0, 0, 0]
  };
  return e.state.cameras.push(i), e.cameraPreviewSignature = "", e.cameraPathDraw = null, St(e), e.activateCamera?.(n), e.setFrame?.(t.range[0]), e.setStatus?.(r("Camera path created")), n;
}
function to(e) {
...
function Yo(e, t) {
  ...
  return n?.every(Number.isFinite) ? (a.planeAxis && (n[eo[a.planeAxis]] = a.anchor[eo[a.planeAxis]]), n) : null;
}
function _p(e, t) {
  const a = e.cameraPathDraw;
  return a?.active ? t.button === 2 && !t.altKey ? (to(t), e.cameraPathSuppressContextMenuUntil = Date.now() + 1e3, Pe(e), !0) : t.button !== 0 || t.altKey || t.ctrlKey || t.metaKey || t.shiftKey ? !1 : (to(t), e.closeMenus?.(), e.interactionElement.focus?.({ preventScroll: !0 }), e.interactionElement.setPointerCapture?.(t.pointerId), a.drawing = !0, a.pointerId = t.pointerId, a.points = [], Xo(e, Yo(e, t)), St(e), e.requestRender?.("camera-path-draw"), !0) : !1;
}
function Ep(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : (to(t), Xo(e, Yo(e, t)) && e.requestRender?.("camera-path-draw"), !0);
}
function $p(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : (to(t), t.type === "pointercancel" || t.type === "lostpointercapture" ? (Pe(e), !0) : (Xo(e, Yo(e, t)), a.drawing = !1, jp(e), !0));
}
function Mp(e) {
  const t = e.cameraPathDraw;
...
function Ap(e, t) {
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? Pe(e) : Ar(e);
    }, { signal: t });
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path-extend"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? Pe(e) : Ar(e, { mode: "extend" });
    }, { signal: t });
...
const Ya = "/majoor/omnicam/scenes";
function zn(e) {
...
function Zo(e, t, { name: a = "", status: o } = {}) {
  const n = t && typeof t == "object" ? t : an(), s = { ...n, metadata: { ...n.metadata || {}, scene_name: a || "" } };
...
async function Tp(e) {
  await _t(e, r("New Scene"), r("Start a new scene? Unsaved changes will be lost.")) && Zo(e, an(), { name: "", status: r("New scene") });
}
async function Pp(e) {
  if (!e.sceneBaseline) {
  ...
  Zo(e, a, { name: o, status: r("Scene reset to last save") });
}
async function Ip(e) {
  const t = zn(e) || r("Untitled"), a = await Ct(e, r("Save Scene"), r("Scene name"), t);
  if (a == null) return;
...
async function zp(e) {
  ...
  const a = await cn({
    ...
    items: t.map((n) => ({
      id: n.slug,
      label: n.name || n.slug,
      sublabel: Fp(n.modified)
    })),
    onDelete: async (n) => {
      const s = await Za(e, `${Ya}/${encodeURIComponent(n)}`, { method: "DELETE" });
      if (!s.ok) throw new Error(await s.text());
    }
  });
  if (!(!a || !await _t(e, r("Open Scene"), r("Open this scene? Unsaved changes will be lost."))))
    try {
      const n = await Za(e, `${Ya}/${encodeURIComponent(a)}`);
      if (!n.ok) throw new Error(await n.text());
...
function Lp(e, t) {
  Ga(e, t, e.root.querySelectorAll('[data-act="scene-new"]'), () => Tp(e)), Ga(e, t, e.root.querySelectorAll('[data-act="scene-open"]'), () => zp(e)), Ga(e, t, e.root.querySelectorAll('[data-act="scene-save"]'), () => Ip(e)), Ga(e, t, e.root.querySelectorAll('[data-act="scene-reset"]'), () => Pp(e));
}
const Op = ["world_point", "object_point", "camera_field"], Tr = 40;
function Kp(e) {
  return (e.keys || []).map((t) => ({ x: t.x, y: t.y, t: t.time_seconds }));
}
function Dp(e, t, a) {
  const o = Math.max(1, Number(e.fps) || 24), n = e.width || 1280, s = e.height || 720, i = [];
  for (let c = 0; c <= Tr; c += 1) {
    const l = a * c / Tr, m = Do(e, t.source, l * o, n, s);
...
function Rp(e) {
  ...
  if (!c) return;
  const l = Fn(t, e.state.width || 1280, e.state.height || 720), m = (g) => l.x + g * l.w, p = (g) => l.y + g * l.h;
  ...
  for (let g = 1; g < 3; g += 1)
    c.beginPath(), c.moveTo(m(g / 3), l.y), c.lineTo(m(g / 3), l.y + l.h), c.stroke(), c.beginPath(), c.moveTo(l.x, p(g / 3)), c.lineTo(l.x + l.w, p(g / 3)), c.stroke();
  const f = Math.max(1, Number(e.state.fps) || 24), u = Math.max(1 / f, (e.state.duration_frames || 120) / f), d = (e.frame || 0) / f;
  let h = 0;
  for (const g of e.state.motion_layers || []) {
    if (g.enabled === !1) continue;
    const y = Op.includes(g.source_kind), v = y ? Dp(e.state, g, u) : Kp(g);
    if (!v.length) continue;
    h += 1;
    const j = g.id === e.state.selected_motion_layer_id;
...
function Vp(e, t) {
  ...
  return {
    ...
    motion_scene_fingerprint: tl(e.state),
...
function Pr(e, t, { frameCount: a = 0, fps: o = 0 } = {}) {
...
const We = 1024 * 1024, Up = Object.freeze({
  card: 128 * We,
  // MAX_CARD_BYTES
  model: 256 * We,
  // MAX_MODEL_BYTES
...
function zr(e) {
  return `${(e / We).toFixed(e >= 10 * We ? 0 : 1)} MB`;
}
function Et(e, t) {
  const a = Up[t];
  if (!e || !a) return null;
  const o = Number(e.size);
  return !Number.isFinite(o) || o <= a ? null : `${e.name || "File"} is ${zr(o)}; the maximum is ${zr(a)}.`;
}
function Gp(e) {
  return Number(e) <= Ir ? null : `${e} frames selected; a background sequence is limited to ${Ir}.`;
}
function Xp(e) {
...
function Yp(e) {
  ...
  e.audioElement && (xo(e, n), Promise.resolve(e.audioElement.play()).catch(() => {
  }));
  ...
  const m = (p) => {
    ...
    if (f === null) {
      for (l += p - c, c = p; l >= i; )
        if (l -= i, n += 1, n > o) {
          if (!e.state.loop_playback) return void Ja(e);
          n = a;
        }
...
function Ln(e) {
  ...
  for (let m = 0; m < i; m++) {
    let p = 0;
    const f = m * c, u = Math.min(s, f + c);
    for (let d = f; d < u; d++) {
      const h = Math.abs(a[d] || 0);
      h > p && (p = h);
    }
    l.push(p);
  }
...
async function Zp(e, { load: t = () => import("./vendor-mediabunny-CZ5VNE-V.js") } = {}) {
  ...
  const l = [];
  let m = 0, p = 0;
  for await (const d of new o(c).samples())
    try {
      p = p || d.sampleRate;
      const h = { planeIndex: 0, format: "f32-planar" }, b = new Float32Array(d.allocationSize(h) / Float32Array.BYTES_PER_ELEMENT);
      d.copyTo(b, h), l.push(b), m += b.length;
    } finally {
      d.close();
    }
  if (!m || !p) return null;
...
async function Qp(e, t, { decode: a = Zp } = {}) {
  if (!t) return;
  const o = Et(t, "audio");
  if (o) {
    e.setStatus(o);
  ...
  try {
    ...
    s.preload = "auto", s.src = n, e.audioObjectUrl = n, e.audioElement = s, await Jp(s), e.audioDuration = Number.isFinite(s.duration) ? s.duration : 0;
    try {
    ...
    ao(e), e.setStatus(`Failed to load audio: ${n.message || n}`);
  }
}
let tt = null;
function On({ api: e }) {
...
const Kn = /* @__PURE__ */ new WeakSet(), wt = /* @__PURE__ */ new WeakMap();
function oo(e) {
...
function ef(e) {
  e && typeof e == "object" && wt.set(e, (wt.get(e) || 0) + 1);
}
function tf(e) {
  ...
  wt.delete(e), Kn.has(e) && oo(e);
}
function $t(e, t) {
  const a = e.cardMediaById.get(t);
  a && (e.cardMediaById.delete(t), e.cardMediaAssetById?.delete?.(t), t === "subject" && e.cardMedia === a && (e.cardMedia = null), tf(a));
}
function af(e) {
  for (const t of [...e.cardMediaById?.keys?.() || []]) $t(e, t);
}
function Re(e, t, a, o = !1, n = "") {
  ...
  s && s !== a && $t(e, t), o && Kn.add(a), ef(a), e.cardMediaAssetById ||= /* @__PURE__ */ new Map(), e.cardMediaById.set(t, a), e.cardMediaAssetById.set(t, n || a?.__omnicamAsset || "");
  try {
    a.__omnicamAsset = n || a.__omnicamAsset || "";
  } catch {
  }
...
async function of(e, t) {
  if (!tt?.fetchApi || !/\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/i.test(e)) return null;
  const a = await tt.fetchApi("/majoor/omnicam/extractor/source", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
...
function rf(e) {
  ...
  if (e.state.viewport_bg_image) {
    const o = new Image();
    o.src = Ne(e.state.viewport_bg_image), o.decode().catch(() => {
    }), e.viewportBgImage = o;
  }
  e.viewportBgSequenceImages = (e.state.viewport_bg_sequence || []).map((o) => {
    const n = new Image();
    return n.src = Ne(o), n.decode().catch(() => {
    }), n;
  });
  for (const o of e.state.objects) {
    if (!o.asset) {
      (o.type === "model" || o.type === "glb") && (o.load_error = r("Not saved to the ComfyUI input folder: this model will be missing after a reload.")), o.type === "card" && $t(e, o.id);
      continue;
    }
    const n = Ne(o.asset);
...
async function sf(e, t) {
  ...
  try {
    const c = await Wo(tt, { route: "/majoor/omnicam/upload_model", field: "asset", file: t });
...
async function cf(e, t) {
  ...
  if (o) {
    ...
    try {
      const n = await Wo(tt, { route: "/majoor/omnicam/upload_asset", field: "asset", file: t });
...
function df(e) {
  ...
  const a = new Image();
  a.onload = () => {
    e.disposed || (Re(e, "subject", a, !1, a.src), e.render(), e.setStatus(r("Upstream media refreshed")));
  }, a.src = tt.apiURL(`/view?${new URLSearchParams(t).toString()}`);
}
async function mf(e) {
  if (!e.node) return;
  ...
  for (const f of i) {
    ...
    if (d) {
      if (u === "image" || u === "video") {
        c = !0;
        const h = d.widgets?.find(
          (b) => ["image", "image_path", "upload", "file", "filename", "video", "video_path"].includes(String(b.name).toLowerCase())
        );
        if (h && h.value) {
          const b = String(h.value), g = /\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/i.test(b), y = d.widgets?.find((x) => String(x.name).toLowerCase() === "subfolder")?.value || "", v = Ne(Ye(b, y)), j = e.state.objects.find((x) => x.id === "subject");
          if (j) {
            const x = await Nn(e, j, v, n, g);
            if (!n()) return;
            j.asset = Ye(b, y);
            let M = null;
            if (g)
              try {
                M = await of(b, o.signal);
              } catch (P) {
            ...
            n() && Pr(e, x, {
              fps: M?.fps,
              frameCount: g ? M?.frame_count : 1
            }), e.upstreamImageConnected = !0, s = !0, e.setStatus(r("Upstream {value1}: {value2}", { value1: g ? "video" : "image", value2: b }));
          }
        } else {
          const b = Hc(d);
          b && (b instanceof HTMLVideoElement && b.paused && b.play().catch(() => {
          }), Re(e, "subject", b, !1, b.currentSrc || b.src || ""), Pr(e, b, { frameCount: b instanceof HTMLVideoElement ? 0 : 1 }), e.upstreamImageConnected = !0, s = !0, e.render(), e.setStatus(b instanceof HTMLVideoElement ? r("Upstream video preview synced") : r("Upstream image preview synced")));
        }
      }
      if (u === "audio") {
        l = !0;
        ...
        if (h && h.value) {
          const b = String(h.value), g = d.widgets?.find((v) => String(v.name).toLowerCase() === "subfolder")?.value || "", y = Ne(Ye(b, g));
          try {
            const v = await fetch(y, { signal: o.signal });
            if (v.ok) {
              const j = await v.blob();
              if (!n()) return;
              const x = new File([j], b, { type: j.type || "audio/wav" });
              await e.loadAudioFile(x), e.upstreamAudioConnected = !0, s = !0, e.setStatus(r("Upstream audio: {value1}", { value1: b }));
            }
          } catch (v) {
      ...
      if (u === "scene_3d" || u === "model" || u === "mesh") {
        ...
        if (h && h.value) {
          const b = String(h.value), g = b.split(".").pop()?.toLowerCase();
          if (["glb", "gltf", "obj", "fbx", "stl", "ply"].includes(g)) {
            const y = d.widgets?.find((M) => String(M.name).toLowerCase() === "subfolder")?.value || "", v = Ne(Ye(b, y)), j = `upstream_scene_${d.id}`;
            m.add(j);
            let x = e.state.objects.find((M) => M.id === j);
            x ? (x.asset = Ye(b, y), x.format = g === "gltf" ? "glb" : g) : (x = {
              id: j,
              type: "model",
              format: g === "gltf" ? "glb" : g,
              ...
              enabled: !0,
              asset: Ye(b, y)
            }, e.state.objects.push(x)), e.modelUrlsById.set(j, v), e.serialize(), e.refreshObjects(), e.render(), s = !0, e.setStatus(r("Upstream 3D model: {value1}", { value1: b }));
          }
        }
      }
    }
  ...
  !l && e.upstreamAudioConnected && (ao(e), e.upstreamAudioConnected = !1, e.refreshKeys(), s = !0, e.setStatus(r("Upstream audio disconnected · audio track cleared")));
  ...
  Ec(e) && (s = !0), s && (e.serialize(), e.render());
}
const pf = ["video/mp4;codecs=avc1.42E01E", "video/webm;codecs=vp9", "video/webm;codecs=vp8", "video/webm"], Fr = { low: 3e6, balanced: 6e6, high: 12e6 };
function ff(e) {
  return Fr[e] || Fr.balanced;
}
async function hf({
  canvas: e,
  fps: t,
  ...
  try {
    for (const j of pf)
      if (!(s.isTypeSupported && !s.isTypeSupported(j)))
        try {
          f = new s(p, { mimeType: j, videoBitsPerSecond: ff(n) });
          break;
        } catch {
        }
    ...
    const u = [];
    f.ondataavailable = (j) => {
      j.data.size && u.push(j.data);
    };
    const d = new Promise((j, x) => {
    ...
    f.stop(), await d;
    const b = Math.max(0, c() - h), g = a / t * 1e3, y = {
      encoder: "media_recorder",
      requestedFrames: a,
      expectedDurationMs: g,
    ...
    m?.(y);
    const v = new Blob(u, { type: f.mimeType || "video/webm" });
    return Wp(v, y);
  } finally {
...
async function Rn(e) {
  await bf(e.cardMediaById.values());
}
async function qn(e) {
  return hf({
    canvas: e.canvas,
...
async function Bn(e, t) {
  const a = await uf(He, t);
  if (Hp(e, t), e.state.playblast_camera_id === on)
...
async function vf(e) {
  ...
  const t = e.frame, a = e.canvas.width, o = e.canvas.height, n = gf(e);
  (n.width !== e.canvas.width || n.height !== e.canvas.height) && (e.canvas.width = n.width, e.canvas.height = n.height, e.render());
  try {
    let s = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-BcFwlwWn.js");
    i !== "realtime" && await l(e.canvas.width, e.canvas.height) && (s = await c(e.canvas, e.state.duration_frames, e.state.fps, async (m) => {
      e.setFrame(m, !0), e.setStatus(r("Encoding frame {value1}/{value2}…", { value1: m + 1, value2: e.state.duration_frames })), await Rn(e), await new Promise((p) => requestAnimationFrame(p));
...
async function Wn(e) {
  if (!jt) throw new Error("ComfyUI API is unavailable");
  return Wo(jt, { route: "/majoor/omnicam/upload_asset", field: "asset", file: e });
}
async function ro(e) {
  const t = e.map((a) => String(a.relative || "").replace(/^omnicam\//, "")).filter(Boolean);
  if (!(!t.length || !jt))
    try {
      await jt.fetchApi("/majoor/omnicam/cleanup", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
...
async function xf(e, t) {
  ...
  try {
    ...
    if (n && await ro([n]), o !== e.backgroundRequestId || e.disposed) return;
...
async function wf(e, t) {
  ...
  const o = Array.from(t).map((i) => Et(i, "image")).find(Boolean);
  if (o) {
    e.setStatus(o);
    return;
  }
  ...
  try {
    ...
    e.checkpoint?.("Set background sequence"), e.state.viewport_bg_sequence = i, e.state.viewport_bg_image = "", e.viewportBgImage = null, e.viewportBgSequenceImages = i.map((c) => {
      const l = new Image();
      return l.src = Ne(c), l.decode().catch(() => {
      }), l;
    }), e.serialize(), e.render(), e.setStatus(`Background sequence loaded: ${t.length} frames`);
  } catch (i) {
    if (await ro(s), n !== e.backgroundRequestId || e.disposed) return;
    e.setStatus(`Failed to load BG sequence: ${i.message || i}`);
  }
}
function kf(e) {
  Jo(e), e.checkpoint?.("Clear background"), e.state.viewport_bg_image = "", e.state.viewport_bg_sequence = [], e.viewportBgImage = null, e.viewportBgSequenceImages = [], e.serialize(), e.render(), e.setStatus("Background cleared");
}
function Sf(e) {
  const t = Co(e.state?.metadata?.viewport_labels);
  ...
  for (const p of a) {
    if (p.enabled === !1 || !Hr(p, { mode: t.mode, selectedIds: m })) continue;
    const f = Ur(p, t.content);
    if (!f) continue;
    const u = Gr(a, p, l) || { position: p.position, size: p.size }, d = Ie(Xr(u, p.type), o, s, i);
    if (!d) continue;
    const [h, b] = d, g = t.content === "annotation" && p.annotation?.color || "", y = 6 * c, v = 4 * c, x = n.measureText(f).width + y * 2, M = 12 * c + v * 2, P = Math.round(h - x / 2), D = Math.round(b - M - 6 * c);
    n.fillStyle = "rgba(16,17,22,0.82)", jf(n, P, D, x, M, 4 * c), n.fill(), g && (n.strokeStyle = g, n.lineWidth = Math.max(1, c), n.stroke()), n.fillStyle = g || "#e6e6ec", n.fillText(f, P + y, D + M - v - 2 * c);
  }
  n.restore();
}
function jf(e, t, a, o, n, s) {
...
function se(e, t, a, o = "#5a5a5a", n = 1) {
...
function Cf(e) {
  for (let t = -60; t <= 60; t += 1) {
    ...
    se(e, [t, 0, -60], [t, 0, 60], o, a ? 1.6 : 1), se(e, [-60, 0, t], [60, 0, t], o, a ? 1.6 : 1);
  }
}
function _f(e) {
  const t = e.state.point_density || "balanced", a = e.state.point_spread || "all_views", o = e.state.point_color || null, n = `${t}|${a}|${o}`;
  return e._pointFieldCache?.key !== n && (e._pointFieldCache = { key: n, ...Si(t, a, o) }), e._pointFieldCache;
}
const Ef = 600;
function $f(e) {
  const { points: t, colors: a } = _f(e);
  if (!t.length) return;
  const o = e.viewportCamera(), n = e.canvas.width, s = e.canvas.height, i = t.length / 3, c = 3 * Math.max(1, Math.ceil(i / Ef)), l = /* @__PURE__ */ new Map();
  for (let m = 0; m < t.length; m += c) {
    const p = Ie([t[m], t[m + 1], t[m + 2]], o, n, s);
    if (!p) continue;
    const f = Z(Math.round(5 / Math.sqrt(p[2])), 1, 4), u = `${Math.round(a[m] * 255)},${Math.round(a[m + 1] * 255)},${Math.round(a[m + 2] * 255)}|${f}`;
    let d = l.get(u);
    d || (d = { fill: `rgb(${u.slice(0, u.indexOf("|"))})`, radius: f, xs: [], ys: [] }, l.set(u, d)), d.xs.push(p[0]), d.ys.push(p[1]);
  }
...
function Mf(e, t) {
  ...
  for (const [p, f] of m) se(e, l[p], l[f], "#a0a0a0", 1.4);
}
function Af(e, t) {
  ...
  for (let c = 0; c < 3; c++) {
    ...
    for (let m = 0; m <= 32; m++) {
      ...
      let f;
      c === 0 ? f = [o + Math.cos(p) * i, n + Math.sin(p) * i, s] : c === 1 ? f = [o + Math.cos(p) * i, n, s + Math.sin(p) * i] : f = [o, n + Math.cos(p) * i, s + Math.sin(p) * i], l && se(e, l, f, "#999", 1), l = f;
    }
  }
}
function Tf(e, t) {
  const [a, o, n] = t.position || [0, 0, 0], s = t.size?.[1] || 1.8, i = (t.size?.[0] || 0.7) * 0.5, c = [a, o + s * 0.88, n], l = [a, o + s * 0.76, n], m = [a - i * 0.55, o + s * 0.73, n], p = [a + i * 0.55, o + s * 0.73, n], f = [a - i * 0.72, o + s * 0.52, n], u = [a + i * 0.72, o + s * 0.52, n], d = [a - i * 0.82, o + s * 0.34, n], h = [a + i * 0.82, o + s * 0.34, n], b = [a, o + s * 0.44, n], g = [a - i * 0.28, o + s * 0.44, n], y = [a + i * 0.28, o + s * 0.44, n], v = [a - i * 0.28, o + s * 0.22, n], j = [a + i * 0.28, o + s * 0.22, n], x = [a - i * 0.28, o, n + 0.05], M = [a + i * 0.28, o, n + 0.05];
  se(e, c, l, "#aaa", 2), se(e, l, b, "#aaa", 2), se(e, m, p, "#aaa", 2), se(e, m, f, "#aaa", 2), se(e, f, d, "#aaa", 2), se(e, p, u, "#aaa", 2), se(e, u, h, "#aaa", 2), se(e, g, y, "#aaa", 2), se(e, g, v, "#aaa", 2), se(e, v, x, "#aaa", 2), se(e, y, j, "#aaa", 2), se(e, j, M, "#aaa", 2);
  const P = Ie(c, e.viewportCamera(), e.canvas.width, e.canvas.height);
  P && (e.ctx.strokeStyle = "#aaa", e.ctx.beginPath(), e.ctx.arc(P[0], P[1], Z(28 / P[2], 3, 12), 0, Math.PI * 2), e.ctx.stroke());
}
function Pf(e, t) {
  const [a, o, n] = t.position || [0, 0, 0], [s, i, c] = t.size || [1.5, 1.5, 1.5], l = s * 0.5, m = (c || s) * 0.5, p = i * 0.5, f = 12, u = [], d = [];
  for (let h = 0; h < f; h++) {
    const b = h / f * Math.PI * 2, g = Math.cos(b) * l, y = Math.sin(b) * m;
    u.push([a + g, o + p, n + y]), d.push([a + g, o - p, n + y]);
  }
  for (let h = 0; h < f; h++) {
    const b = (h + 1) % f;
    se(e, u[h], u[b], "#aaa", 1.5), se(e, d[h], d[b], "#aaa", 1.5);
  }
  for (let h = 0; h < f; h += 3)
    se(e, u[h], d[h], "#aaa", 1.5);
}
function If(e, t) {
  const [a, o, n] = t.position || [0, 0, 0], [s, i, c] = t.size || [1.5, 1.5, 1.5], l = s * 0.5, m = s * 0.18, p = 16, f = [], u = [];
  for (let d = 0; d < p; d++) {
    const h = d / p * Math.PI * 2, b = Math.cos(h), g = Math.sin(h);
    f.push([a + b * (l + m), o, n + g * (l + m)]), u.push([a + b * (l - m), o, n + g * (l - m)]);
  }
  for (let d = 0; d < p; d++) {
    const h = (d + 1) % p;
    se(e, f[d], f[h], "#aaa", 1.5), se(e, u[d], u[h], "#aaa", 1.5), d % 4 === 0 && se(e, f[d], u[d], "#888", 1);
  }
}
function zf(e, t) {
  const a = t.position || [0, 1, 0], o = 0.25;
  se(e, ye(a, [-o, 0, 0]), ye(a, [o, 0, 0]), "#bbb", 2), se(e, ye(a, [0, -o, 0]), ye(a, [0, o, 0]), "#bbb", 2), se(e, ye(a, [0, 0, -o]), ye(a, [0, 0, o]), "#bbb", 2);
}
function Ff(e, t) {
  const [a, o, n] = t.position || [0, 1.5, 0], [s, i] = t.size || [2, 3], c = e.viewportCamera(), l = [
    ...
    [a + s / 2, o + i / 2, n],
    [a - s / 2, o + i / 2, n]
  ].map((g) => Ie(g, c, e.canvas.width, e.canvas.height));
  if (l.some((g) => !g)) return;
  const m = l.map((g) => g[0]), p = l.map((g) => g[1]), f = Math.min(...m), u = Math.max(...m), d = Math.min(...p), h = Math.max(...p);
  e.ctx.save(), e.ctx.beginPath(), e.ctx.moveTo(l[0][0], l[0][1]);
  for (let g = 1; g < 4; g++) e.ctx.lineTo(l[g][0], l[g][1]);
  e.ctx.closePath(), e.ctx.clip();
  const b = e.cardMediaById.get(t.id) || (t.id === "subject" ? e.cardMedia : null);
  if (b)
    try {
      const g = Math.max(1, u - f), y = Math.max(1, h - d), v = b.videoWidth || b.naturalWidth || b.width, j = b.videoHeight || b.naturalHeight || b.height, x = e.state.card_fit || "contain";
      if (e.ctx.fillStyle = "#111", e.ctx.fillRect(f, d, g, y), x === "stretch" || !v || !j)
        e.ctx.drawImage(b, f, d, g, y);
      else if (x === "contain") {
        const M = Math.min(g / v, y / j), P = v * M, D = j * M;
        e.ctx.drawImage(b, f + (g - P) / 2, d + (y - D) / 2, P, D);
      } else {
        const M = Math.max(g / v, y / j), P = g / M, D = y / M;
        e.ctx.drawImage(b, (v - P) / 2, (j - D) / 2, P, D, f, d, g, y);
      }
    } catch {
    }
  else
    e.ctx.fillStyle = "#3a414b", e.ctx.fillRect(f, d, u - f, h - d), e.ctx.fillStyle = "#d8d8d8", e.ctx.textAlign = "center", e.ctx.font = `${Math.max(12, Math.min(28, (u - f) * 0.08))}px system-ui`, e.ctx.fillText("SUBJECT CARD", (f + u) / 2, (d + h) / 2);
    ...
    if (!(i && e.state.view_mode === "camera")) {
      if (n.length >= 2)
        for (let c = 0; c < n.length - 1; c++)
          se(e, n[c].camera.position, n[c + 1].camera.position, s, i ? 2.2 : 1.2);
      for (const c of n) {
      ...
      if (e.state.view_mode !== "camera") {
        const c = we(a, e.frame, e.state.objects), l = Ie(c.position, e.viewportCamera(), e.canvas.width, e.canvas.height);
        l && (e.ctx.fillStyle = i ? "#f2d06b" : s, e.ctx.beginPath(), e.ctx.arc(l[0], l[1], i ? 6.5 : 4.5, 0, Math.PI * 2), e.ctx.fill()), c.target && se(e, c.position, c.target, `${s}88`, 1);
      }
    }
  });
}
function Of(e) {
  ...
  for (let o = 0; o < e.state.keyframes.length - 1; o++) {
    ...
    t.push(Ve($e(s.camera.position, n.camera.position)) * e.state.fps / Math.max(1, s.frame - n.frame));
  }
  const a = Math.max(...t, 1e-6);
  for (let o = 0; o < t.length; o++) {
    const n = 120 * (1 - t[o] / a);
    se(e, e.state.keyframes[o].camera.position, e.state.keyframes[o + 1].camera.position, `hsl(${n} 85% 55%)`, 5);
  }
}
function Kf(e) {
  ...
  e.recording && e.state.playblast_labels && Sf(e);
}
async function Df(e, { signal: t } = {}) {
...
async function Rf(e) {
  ...
  const n = o.diagnostic?.issues || [], s = Nf(n);
...
const qf = 1, Lr = 0.01, Bf = 0.4, Wf = 3, Vf = 120, Hf = 20, Uf = 4, Gf = 0.25, Xf = 0.5;
function Yf(e, t, a) {
  const o = Ve($e(t.camera.position, e.camera.position)), n = t.frame - e.frame, s = n / a, i = s > 1e-9 ? o / s : 1 / 0;
...
function Jf({ keys: e, fps: t = 24, objects: a = [] } = {}) {
  ...
  for (const c of s)
    ...
    }), c.distance < Lr && c.duration >= Bf && n.push({
      code: "STATIC_SEGMENT",
      severity: "info",
      frameStart: c.frameStart,
      frameEnd: c.frameEnd,
  ...
  if (i.length) {
    ...
    if (c > 1e-6)
      for (const l of s)
        Number.isFinite(l.speed) && l.speed > c * Wf && n.push({
          code: "SPEED_SPIKE",
          severity: "warning",
  ...
  for (let c = 1; c < o.length - 1; c += 1) {
    const l = $e(o[c].camera.position, o[c - 1].camera.position), m = $e(o[c + 1].camera.position, o[c].camera.position), p = Ve(l), f = Ve(m);
    if (p < 1e-6 || f < 1e-6) continue;
    const u = Math.max(-1, Math.min(1, ji(l, m) / (p * f))), d = Math.acos(u) * 180 / Math.PI;
    d >= Vf && n.push({
      code: "HARD_DIRECTION_CHANGE",
      severity: "notice",
      frameStart: o[c - 1].frame,
      frameEnd: o[c + 1].frame,
      message: `Sharp direction change at F${o[c].frame} (${Math.round(d)}°)`
    });
  }
  if (o.length >= Uf) {
    const c = o.reduce((d, h) => d + h.camera.position[0], 0) / o.length, l = o.reduce((d, h) => d + h.camera.position[2], 0) / o.length, m = o[0].camera.position, p = o[o.length - 1].camera.position;
    let f = Math.abs(Or(p, c, l) - Or(m, c, l)) % 360;
    f > 180 && (f = 360 - f);
    const u = Ve($e(p, m));
    f <= Hf && u > Lr && n.push({
  ...
  if (Array.isArray(a) && a.length)
    for (const c of o)
      for (const l of a) {
        ...
        const m = Number.isFinite(Number(l.radius)) ? Number(l.radius) : Xf;
        Ve($e(c.camera.position, l.position)) < m + Gf && n.push({
...
function eh(e, t, a) {
  ...
  return o || (t.keyframes?.length ? no(t, a).position : t.position || [0, 1.5, 0]);
}
function kt(e, t, a, o) {
  if (!a) return a;
  const n = Hn(e, t, o);
...
function ah(e, { perFrame: t = !1 } = {}) {
  const a = e.activeCameraTrack(), o = Qo(e, a), n = er(e, a);
  ...
  const i = (c) => Hn(e, a, c) || eh(e, s, c);
  if (t) {
    const c = a.keyframes[0].frame, l = a.keyframes[a.keyframes.length - 1].frame, m = new Map(a.keyframes.map((p) => [p.frame, p]));
    for (let p = c; p <= l; p++) {
      const u = m.get(p) || { frame: p, camera: we(a, p, e.state.objects), interpolation: "linear" };
      u.camera.target = [...i(p)], m.set(p, u);
    }
...
function Un(e) {
  ...
  t.innerHTML = "", t.onkeydown = (u) => {
    if (u.key === "ArrowUp" || u.key === "ArrowDown") {
      const d = [...t.querySelectorAll('.scene-item[role="button"]')], h = d.indexOf(document.activeElement);
      if (h >= 0) {
        u.preventDefault();
        const b = u.key === "ArrowDown" ? Math.min(d.length - 1, h + 1) : Math.max(0, h - 1);
        b !== h && (d[b].focus(), d[b].click(), d[b].scrollIntoView?.({ block: "nearest", behavior: "smooth" }));
      }
    }
  };
  ...
  const n = (u, d, h, b, g = "") => {
    ...
    return y.type = "button", y.className = "scene-action-btn", h && (y.style.cssText = g || `color:${oe.warning};border-color:${oe.warning};background:${oe.warningSoft}`), y.title = r(d), y.innerHTML = `<i class="pi ${u}" style="font-size:10px"></i>`, y.addEventListener("click", (v) => {
      v.stopPropagation(), b(v);
    }), y;
  }, s = (e.outlinerFilter || "").trim().toLowerCase(), i = (u) => !s || String(u || "").toLowerCase().includes(s), c = (u, d, h) => {
    const b = !!(e.outlinerCollapsedSections?.has(h) && !s), g = document.createElement("div");
    return g.className = "scene-section-header", g.dataset.section = h, g.innerHTML = `
      ...
      <span class="scene-section-count">(${d})</span>
    `, g.addEventListener("click", () => {
      e.outlinerCollapsedSections ||= /* @__PURE__ */ new Set(), e.outlinerCollapsedSections.has(h) ? e.outlinerCollapsedSections.delete(h) : e.outlinerCollapsedSections.add(h), Un(e);
    }), { header: g, isCollapsed: b };
  }, l = (u) => ["sun_light", "point_light", "spot_light"].includes(u), m = a === "all" || a === "cameras" || a === "hidden" && e.state.cameras.some((u) => u.muted), p = a === "all" || a === "objects" || a === "lights" || a === "hidden" && e.state.objects.some((u) => u.enabled === !1);
  if (m) {
    const u = e.state.cameras.filter((b) => !(!i(b.name) || a === "hidden" && !b.muted)), { header: d, isCollapsed: h } = c(r("Cameras"), u.length, "cameras");
    if (t.appendChild(d), !h)
      for (const b of u) {
        const g = document.createElement("div");
        g.role = "button", g.tabIndex = 0, g.dataset.cameraId = b.id;
        const y = b.id === e.state.active_camera_id, v = b.id === e.state.playblast_camera_id, j = e.selectedEntity === "camera" && y;
        g.setAttribute("aria-selected", String(j)), g.className = `scene-item${j ? " selected" : ""}${y && !j ? " active-view" : ""}`;
        const x = document.createElement("i");
        x.className = "pi pi-video", x.style.cssText = `color:${oe.typeCamera}`;
        const M = document.createElement("span");
        if (M.className = "scene-item-label", j || y) {
          const F = document.createElement("span");
          F.style.cssText = `color:${j ? oe.warning : oe.success};font-weight:700`, F.textContent = j ? "● " : "○ ", M.appendChild(F);
        }
        if (M.appendChild(document.createTextNode(b.name)), v) {
          const F = document.createElement("span");
          F.style.cssText = `color:${oe.warning};font-size:10px`, F.title = "Playblast Output", F.textContent = " ★", M.appendChild(F);
        }
        if (b.muted) {
          const F = document.createElement("span");
        ...
        P.className = "scene-item-actions", P.appendChild(n("pi-star", "Solo track", b.solo, () => {
          e.checkpoint("Solo track"), b.solo = !b.solo, e.serialize(), e.refreshObjects(), e.renderCameraView();
        }, `color:${oe.warning};border-color:${oe.warning};background:${oe.warningSoft}`)), P.appendChild(n("pi-volume-off", "Mute track", b.muted, () => {
          e.checkpoint("Mute track"), b.muted = !b.muted, e.serialize(), e.refreshObjects(), e.renderCameraView();
        }, `color:${oe.error};border-color:${oe.error};background:${oe.errorSoft}`)), P.appendChild(n("pi-lock", "Lock track", b.locked, () => {
          e.checkpoint("Lock track"), b.locked = !b.locked, e.serialize(), e.refreshObjects(), e.renderCameraView();
        })), (b.keyframes || []).length >= 1 && P.appendChild(n(
          "pi-arrows-alt",
        ...
        )), P.appendChild(n("pi-ellipsis-v", "Camera actions", !1, (F) => e.openCameraContext(F, b.id, !1))), g.append(x, M, P), g.title = j ? r("Currently selected for editing") : v ? r("Active playblast camera") : r("Click to select & activate this camera");
        const D = () => {
          e.finishCameraEdit(), e.selectedEntity = "camera", e.selectedObjectId = null, e.editingKeyFrame = null, e.activateCamera(b.id), e.refreshObjects(), e.refreshKeys(), e.refreshInspector(), e.render(), e.setStatus(r("Camera: {value1}", { value1: b.name }));
        };
        g.addEventListener("contextmenu", (F) => {
  ...
  if (p) {
    const u = new Map(e.state.objects.map((x) => [x.id, x])), d = /* @__PURE__ */ new Map(), h = [];
    for (const x of e.state.objects)
      x.parent_id && u.has(x.parent_id) ? (d.has(x.parent_id) || d.set(x.parent_id, []), d.get(x.parent_id).push(x)) : h.push(x);
    const b = [], g = (x, M) => {
      b.push({ object: x, level: M });
      const P = d.get(x.id) || [];
      for (const D of P) g(D, M + 1);
    };
    for (const x of h) g(x, 0);
    const y = b.filter(({ object: x }) => {
    ...
    }), { header: v, isCollapsed: j } = c(a === "lights" ? r("Lights") : r("Objects"), y.length, "objects");
    if (t.appendChild(v), !j)
      for (const { object: x, level: M } of y) {
        const P = document.createElement("div");
        ...
        const U = x.type === "card" ? { icon: "pi-image", color: oe.typeReferenceCard } : x.type === "model" || x.type === "glb" ? { icon: "pi-box", color: oe.typePointCloud } : x.type === "ground" ? { icon: "pi-minus", color: oe.typeGroundPlane } : x.type === "sun_light" ? { icon: "pi-sun", color: oe.typeLight } : x.type === "point_light" ? { icon: "pi-bolt", color: oe.typeLight } : x.type === "spot_light" ? { icon: "pi-compass", color: oe.typeLight } : x.type === "human" ? { icon: "pi-user", color: oe.success } : x.type === "cube" ? { icon: "pi-stop", color: oe.typeGeometry } : x.type === "sphere" ? { icon: "pi-circle", color: oe.typeGeometry } : x.type === "cylinder" ? { icon: "pi-database", color: oe.typeGeometry } : x.type === "torus" ? { icon: "pi-circle", color: oe.typeGeometry } : x.type === "pyramid" ? { icon: "pi-play", color: oe.typeGeometry } : { icon: "pi-plus", color: oe.typeGeometry }, B = x.enabled !== !1, V = !!x.load_error, Q = document.createElement("i");
        Q.className = `pi ${V ? "pi-exclamation-triangle" : U.icon}`, Q.style.cssText = V ? `color:${oe.error}` : B ? `color:${U.color}` : "opacity:.4";
        const k = document.createElement("span");
        k.className = "scene-item-label";
        const _ = document.createElement("span");
        _.style.cssText = V ? `color:${oe.error}` : B ? "" : "opacity:.5;text-decoration:line-through", _.textContent = x.name || x.type, _.title = r("Double-click to rename"), _.addEventListener("dblclick", ($) => {
          $.preventDefault(), $.stopPropagation(), rh(e, x, _);
        }), k.appendChild(_);
        ...
        if (V) {
          const $ = document.createElement("span");
          $.style.cssText = `color:${oe.error};font-size:9px;font-weight:700`, $.textContent = " [Format!]", k.appendChild($);
        }
        const N = document.createElement("div");
        N.className = "scene-item-actions", N.appendChild(n(B ? "pi-eye" : "pi-eye-slash", B ? "Hide object (Alt+Click to Isolate)" : "Show object (Alt+Click to Isolate)", !B, ($) => {
          if ($?.altKey) {
            ...
            e.toggleObject(x.id);
        }, `color:${oe.error};opacity:.7`)), N.appendChild(n(x.locked ? "pi-lock" : "pi-lock-open", "Lock object", x.locked, () => Uo(e, x))), N.appendChild(n("pi-copy", "Duplicate object", !1, () => e.duplicateObject?.(x.id))), x.id !== "subject" && N.appendChild(n("pi-trash", "Delete object", !1, () => e.deleteObject?.(x.id))), N.appendChild(n("pi-ellipsis-v", "Object actions", !1, ($) => e.openObjectContext($, x.id))), P.append(Q, k, N), P.title = r("Click to select · Double-click to toggle visibility · Right-click for actions");
        const q = ($ = {}) => {
          ...
          e.refreshKeys(), e.refreshInspector(), e.render(), e.setStatus(r("Selected: {value1}", { value1: x.name || x.type }));
        };
  ...
  if (f) {
    ...
    f.hidden = u < 2;
    const d = f.querySelector('[data-role="batch-count"]');
    d && (d.textContent = `${u} ${r("selected")}`);
  }
  e.refreshInspector();
}
function wo(e, t, a, o) {
...
function nh(e, t) {
  ...
  let u;
  n ? u = r("Human Proxy") : s ? u = r("Card") : i ? u = r("Cylinder") : c ? u = r("Torus") : l ? u = r("Pyramide") : m ? u = r("Sun light") : p ? u = r("Point light") : f ? u = r("Spot light") : u = t[0].toUpperCase() + t.slice(1);
  let d;
  o ? d = [12, 0.1, 12] : n ? d = [0.7, 1.8, 0.4] : s ? d = [2, 3] : d = [1.5, 1.5, 1.5];
  let h = [0, 0, 0], b = [0, 0, 0], g = "#8c929b", y, v, j, x;
  m ? (h = [5, 8.5, 4], b = [-55, 35, 0], g = "#fff6ec", y = 2.2, v = !0) : p ? (h = [0, 3, 0], g = "#ffffff", y = 2, v = !1) : f && (h = [0, 4, 0], b = [-60, 0, 0], g = "#ffffff", y = 3, j = 45, x = 0.25, v = !0);
  const M = {
    id: a,
    type: t,
    name: u,
...
async function sh(e, t) {
  ...
  if (!a) return;
  const o = (await Ct(e, r("Rename object"), r("Object name"), a.name || a.type))?.trim();
...
async function Xn(e, t) {
  ...
  const a = e.state.objects.find((o) => o.id === t);
  if (a && await _t(e, r("Delete object"), r("Delete {value1} and its {value2} keyframe(s)?", { value1: a.name || a.type, value2: (a.keyframes || []).length })) && !(e.disposed || !e.state.objects.includes(a))) {
...
async function ch(e) {
  ...
  if (!await _t(e, r("Delete objects"), a) || e.disposed) return;
...
function dh(e) {
  const t = Mt(e), a = e.root.querySelector('[data-role="object-panel"]');
  a && (a.hidden = !t);
  const o = (k) => e.root.querySelector(k), n = e.activeCameraTrack(), s = o('[data-role="camera-target-object"]');
  if (s) {
    const k = n.target_object_id || e.state.target_object_id || "", _ = `T${ir()}${e.state.objects.map((z) => `${z.id}\0${z.name || z.type}`).join("|")}`;
    wo(s, _, () => [
  ...
  oh(e);
  const i = [...e.camera.position, ...e.camera.target, e.camera.fov, e.camera.roll || 0, e.camera.near, e.camera.far, ...No(e.camera)];
  ...
  if (!t) {
    ...
    _ && (_.textContent = `${n.name} · F${e.frame}`), Kr(o, {
  ...
  p && (p.textContent = t.name || t.type), Kr(o, {
    camera: r("Position XYZ"),
    position: r("Position XYZ"),
    target: r("Rotation XYZ"),
    lens: r("Scale XYZ")
  });
  const f = t.rotation || [0, 0, 0], u = t.size || [1, 1, 1], d = {
    "object-x": m[0],
    "object-y": m[1],
    "object-z": m[2],
    "object-rx": f[0],
  ...
  for (const [k, _] of Object.entries(d))
    for (const z of e.root.querySelectorAll(`[data-role="${k}"]`))
  ...
  const h = o('[data-role="animation-row"]'), b = o('[data-role="animation-select"]'), g = o('[data-role="object-parent"]');
  if (g) {
    ...
    const N = e.state.objects.filter(($) => !_.has($.id)), q = `P${ir()}${k}${N.map(($) => `${$.id} ${$.name || $.type}`).join("|")}`;
    wo(g, q, () => [
      yt("", r("No parent")),
      ...N.map(($) => yt($.id, $.name || $.type))
    ], t.parent_id || "");
  }
  const y = ["sun_light", "point_light", "spot_light"].includes(t.type), v = t.type === "spot_light", j = o('[data-role="light-props-row"]');
  j && (j.hidden = !y);
  ...
  if (D && (D.hidden = t.type === "point_light"), y) {
  ...
  if (h && (h.hidden = !F?.animations), b) {
    const k = F?.animationNames || [];
    wo(b, `A${k.join("|")}`, () => k.map((_, z) => yt(String(z), _)), String(t.animation_index || 0));
  }
...
function hh(e) {
  ...
  e.beginCameraEdit(), Ci(e.camera, n), e.commitCameraEdit(), e.finishCameraEdit(), Zn(e), fh(e), e.render();
}
function uh(e) {
  const t = globalThis.performance?.now?.() ?? Date.now();
  (!Number.isFinite(e.lastCameraHudEditAt) || t - e.lastCameraHudEditAt > 300) && e.checkpoint("Edit camera"), e.lastCameraHudEditAt = t;
...
function vh(e, t) {
  e.objectUrls.revoke(t), $t(e, t), e.modelUrlsById.delete(t), e.modelInfoById.delete(t), e.webgl?.removeModel(t);
}
function yh(e) {
  ...
  return t.forEach((o, n) => {
    ...
    const c = 0.35 + n * 0.15;
    i.position = ye(i.position || [0, 0, 0], [c, 0, c]), (i.type === "model" || i.type === "glb") && e.modelUrlsById.has(s.id) ? e.modelUrlsById.set(i.id, e.modelUrlsById.get(s.id)) : i.type === "card" && e.cardMediaById.has(s.id) && Re(e, i.id, e.cardMediaById.get(s.id), !1, i.asset || e.cardMediaAssetById?.get?.(s.id) || ""), e.state.objects.push(i), a.push(i.id);
...
function jh(e, t) {
  return t(dn(e), e.frame);
}
function Se(e) {
  return e.selectedEntity === "object" && e.state.objects.find((t) => t.id === e.selectedObjectId) || null;
}
function xe(e) {
  return Se(e)?.keyframes || e.state.keyframes;
}
function Ch(e, t) {
...
function _h(e) {
  ...
  const t = e.root.querySelector('[data-role="key-interp"]')?.value || e.root.querySelector('[data-role="interp"]')?.value || "ease", a = Se(e), o = xe(e), n = a ? { frame: e.frame, transform: ze(a), interpolation: t } : { frame: e.frame, camera: de(e.camera), interpolation: t }, s = o.findIndex((i) => i.frame === e.frame);
  s >= 0 ? o[s] = n : o.push(n), o.sort((i, c) => i.frame - c.frame), e.selectedKeyFrame = e.frame, e.selectedKeyFrames = /* @__PURE__ */ new Set([e.frame]), e.editingKeyFrame = null, e.serialize(), e.refreshKeys(), e.refreshKeyEditor(), e.updateKeyVisualState(), e.drawCurveEditor(), e.setStatus(r("{value1} {value2} @ {value3}", { value1: a?.name || "Camera", value2: s >= 0 ? "key updated" : "key inserted", value3: e.frame }));
}
function Eh(e, t) {
  const a = Fe(e);
  if (!a) return;
  ...
  e.serialize(), e.refreshKeys(), e.refreshKeyEditor(), e.drawCurveEditor(), e.setStatus(r("Key @ {value1} interpolation set to {value2}", { value1: a.frame, value2: t }));
}
function $h(e) {
  const t = Se(e), a = xe(e);
  ...
  const n = xe(e), s = o.frame;
  e.editingKeyFrame === s && (e.editingKeyFrame = null), e.selectedKeyFrame = n.length ? n.reduce((i, c) => Math.abs(c.frame - s) < Math.abs(i.frame - s) ? c : i).frame : null, e.camera = we(e.state, e.frame), e.applyObjectAnimationFrame(), e.serialize(), e.refreshKeys(), e.render(), e.setStatus(r("{value1} key deleted @ {value2}", { value1: t?.name || "Camera", value2: s }));
}
function Mh(e) {
  const t = Se(e), a = Fe(e) || xe(e).find((o) => o.frame === e.frame);
  e.copiedKeyframe = t ? { kind: "object", transform: ze(a?.transform || t), interpolation: a?.interpolation || e.root.querySelector('[data-role="interp"]')?.value || "ease" } : { kind: "camera", camera: de(a?.camera || e.camera), interpolation: a?.interpolation || e.root.querySelector('[data-role="interp"]')?.value || "ease" }, e.setStatus(r("Keyframe copied @ {value1}", { value1: a?.frame ?? e.frame }));
}
function Ah(e) {
  if (!e.copiedKeyframe) return e.setStatus(r("Copy a keyframe first"));
  const t = Se(e), a = t ? "object" : "camera";
  if (e.copiedKeyframe.kind !== a) return e.setStatus(r("Copy a {value1} keyframe first", { value1: a }));
  e.checkpoint("Paste keyframe");
  const o = t ? { frame: e.frame, transform: ze(e.copiedKeyframe.transform), interpolation: e.copiedKeyframe.interpolation } : { frame: e.frame, camera: de(e.copiedKeyframe.camera), interpolation: e.copiedKeyframe.interpolation }, n = xe(e), s = n.findIndex((i) => i.frame === e.frame);
  s >= 0 ? n[s] = o : n.push(o), n.sort((i, c) => i.frame - c.frame), e.selectedKeyFrame = o.frame, e.selectedKeyFrames = /* @__PURE__ */ new Set([o.frame]), e.editingKeyFrame = null, t ? (t.position = [...o.transform.position], t.rotation = [...o.transform.rotation], t.size = [...o.transform.size]) : e.camera = de(o.camera), e.serialize(), e.refreshKeys(), e.render(), e.setStatus(r("Keyframe pasted @ {value1}", { value1: o.frame }));
}
function Fe(e) {
  return xe(e).find((t) => t.frame === e.selectedKeyFrame) || null;
}
function Th(e, t) {
  t && (e.selectedKeyFrame = t.frame, e.selectedKeyFrames = /* @__PURE__ */ new Set([t.frame]), e.editingKeyFrame = null, Se(e) || (e.pathSelection = _i(e.pathSelection, { cameraId: e.state.active_camera_id, frame: t.frame, additive: !1 })), e.setFrame(t.frame));
}
function Ph(e) {
...
function Rh(e) {
  ...
  t.hidden = !1;
  const o = Jf({ keys: a, fps: e.state?.fps || 24, objects: e.state?.objects || [] });
  if (!o.length) {
    const n = document.createElement("div");
...
function qh(e) {
  const t = Se(e), a = Fe(e), o = e.root.querySelector('[data-role="key-editor"]');
  ...
  for (const d of e.root.querySelectorAll(".key-interp-buttons [data-interp]"))
  ...
  for (const d of e.root.querySelectorAll("[data-tangent]"))
    d.classList.toggle("active", !!(a && d.dataset.tangent === m)), d.disabled = !a;
  const f = e.root.querySelector('[data-role="key-timecode"]');
  if (f) {
    const d = Math.max(1, e.state?.fps || 24), h = a ? a.frame : e.frame, b = Math.floor(h / d), g = h % Math.round(d), y = String(Math.floor(b / 3600)).padStart(2, "0"), v = String(Math.floor(b % 3600 / 60)).padStart(2, "0"), j = String(b % 60).padStart(2, "0"), x = String(g).padStart(2, "0");
    f.textContent = `${y}:${v}:${j}:${x} (${h}f)`;
  }
  if (Rh(e), !a) return;
  if (t) {
...
function Bh(e, t, a = !1, o = {}) {
  ...
  n.frame = i, e.selectedKeyFrame = i, e.editingKeyFrame = l ? i : null, e.frame = i, s.sort((m, p) => m.frame - p.frame), e.serialize(), e.setFrame(i), e.setStatus(r("Keyframe moved to {value1}", { value1: i }));
}
function Wh(e) {
  const t = Fe(e);
  if (!t) return;
  if (e.checkpoint("Edit keyframe"), e.editingKeyFrame = t.frame, Se(e)) {
    t.interpolation = e.root.querySelector('[data-role="key-interp"]').value, t.transform = ze(Se(e)), e.serialize(), e.setFrame(t.frame), e.setStatus(r("Object keyframe updated @ {value1}", { value1: t.frame }));
    return;
  }
  const a = (n, s) => {
  ...
  if (t.interpolation = e.root.querySelector('[data-role="key-interp"]').value, t.camera.position = [a("key-px", t.camera.position[0]), a("key-py", t.camera.position[1]), a("key-pz", t.camera.position[2])], t.camera.target = [a("key-tx", t.camera.target[0]), a("key-ty", t.camera.target[1]), a("key-tz", t.camera.target[2])], t.camera.fov = Z(a("key-fov", t.camera.fov), 5, 150), t.camera.roll = Z(a("key-roll", t.camera.roll || 0), -180, 180), t.camera.zoom = Math.max(0.01, a("key-zoom", t.camera.zoom || 1)), t.camera.near = Math.max(1e-4, a("key-near", t.camera.near)), t.camera.far = Math.max(t.camera.near + 1e-4, a("key-far", t.camera.far)), t.camera.camera_type = e.root.querySelector('[data-role="key-camera-type"]').value, e.root.querySelector('[data-role="key-timing-weight"]')) {
    const n = Fo(t, a("key-timing-weight", Ke(t)));
    n.timing ? t.timing = n.timing : delete t.timing;
  }
  e.camera = de(t.camera), e.frame = t.frame, e.serialize(), e.setFrame(t.frame), e.setStatus(r("Keyframe updated @ {value1}", { value1: t.frame }));
}
function Vh(e) {
  const t = Fe(e);
...
function Xh(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: n, initializeTooltips: s, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: m, activeCameraTrack: p, bindWidgetCallbacks: f, playblastCameraTrack: u, restoreFromWidgets: d, serializeEditorState: h, syncActiveCameraTrack: b, syncFromWidgets: g, bindEditorEvents: y, activateCamera: v, addCamera: j, deleteCamera: x, drawPreviewOverlays: M, duplicateCamera: P, maximizeCameraPreview: D, refreshCameraPreviews: F, refreshCameraSelectors: U, renameCamera: B, setPlayblastCamera: V, toggleCameraView: Q, captureRealtime: k, makePlayblast: _, uploadDirectorPlayblast: z, waitForMediaFrame: N, computeAudioPeaks: q, loadAudioFile: $, releaseAudio: W, stopPlay: C, togglePlay: R, applyCameraPreset: G, applyCameraShake: ae, applyProxyPreset: re, clearViewportBgImage: ee, loadViewportBgFile: ie, loadViewportBgSequence: fe, drawCameraPath: me, drawCard: ue, drawCube: be, drawGrid: O, drawHuman: H, drawLine3D: ce, drawNull: le, drawOverlays: pe, drawPointField: ne, drawSpeedHeatmap: ke, drawSphere: At, curveChannels: Tt, drawCurveEditor: rt, onCurvePointerDown: nt, onCurvePointerMove: st, onCurvePointerUp: it, onTimelinePointerDown: Pt, onTimelinePointerMove: It, onTimelinePointerUp: zt, refreshKeys: ct, resetCurveZoom: lt, resetTimelineZoom: Ue, setChannelFilter: dt, setCurveInterpolation: mt, setTangentMode: pt, timelineFrameFromEvent: Ft, toggleCurveHandles: ft, zoomCurve: Lt, drawTransformGizmo: Ot, frameTarget: Kt, gizmoAxes: Dt, gizmoGeometry: Nt, onPointerDown: Rt, onPointerMove: qt, onPointerUp: Bt, onWheel: Wt, pickGizmo: Vt, pickSceneObject: Ht, resetCamera: ht, setTransformMode: ut, setViewMode: Ut, viewportCamera: Gt, loadCardFile: co, loadExecutionPreview: lo, loadMediaUrl: Xt, loadModelFile: Yt, loadSelectedReference: Zt, onModelLoaded: Jt, restoreAssets: Qt, syncUpstreamInputs: ea, configureDomMedia: ta, refreshSetupDiagnostic: bt, addMediaCard: aa, addPrimitive: oa, applyObjectAnimationFrame: ra, beginCameraEdit: na, beginObjectEdit: sa, commitCameraEdit: ia, commitObjectEdit: ca, copyKeyframe: la, deleteKeyframe: da, deleteObject: ma, duplicateObject: pa, exitKeyEdit: fa, finishCameraEdit: ha, goToAdjacentKey: ua, insertKeyframe: ba, loadSelectedKeyView: ga, pasteKeyframe: va, playblastCameraAtFrame: ya, refreshInspector: xa, refreshKeyEditor: wa, refreshObjects: ka, removeObjectResources: Sa, renameObject: ja, retimeSelectedKey: Ca, selectKeyframe: _a, selectedKeyframe: Ea, selectedObject: $a, selectObjectAnimation: Ma, setKeyInterpolation: Aa, setObjectParent: Ta, timelineKeyframes: Pa, timelineObject: qe, toggleAutoKey: Ia, toggleObject: za, updateCameraFromHud: Fa, updateEditState: La, updateKeyVisualState: Oa, updateSelectedKey: Ka, updateSelectedObject: Da, clamp: gt, cloneCamera: Na, configureCore: Ra, defaultCamera: qa, sampleCamera: Le, sampleObjectTransform: mo, sanitizeState: Ge, worldTransform: je } = e;
  return {
    setSelectMode(I) {
    ...
    restoreHistorySnapshot(I) {
      ...
      const S = Dr(this.state), w = new Set(this.state.objects.map((Y) => Y.id));
      this.state = Ge(T.state);
      const E = new Set(this.state.objects.map((Y) => Y.id));
      for (const Y of w) E.has(Y) || this.removeObjectResources(Y);
      this.frame = gt(T.frame, 0, this.state.duration_frames - 1);
      ...
      this.selectedKeyFrames = new Set(L.filter((Y) => X.has(Y))), this.selectedKeyFrame = this.selectedKeyFrames.has(T.selectedKeyFrame) ? T.selectedKeyFrame : [...this.selectedKeyFrames].at(-1) ?? null, this.pathSelection = Ei(this.pathSelection, this.activeCameraTrack()), this.subSelection = T.subSelection || null, this.camera = Le(this.state, this.frame), kt(this, this.activeCameraTrack(), this.camera, this.frame), this.cameraPreviewSignature = "", this.serialize(), S !== Dr(this.state) && this.restoreAssets(), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
    },
    checkpoint(I) {
    ...
    openObjectContext(I, T) {
      ...
      this.showContextMenu(I, S.name || S.type, [
        ...
        { label: S.locked ? r("Unlock object") : r("Lock object"), icon: S.locked ? "pi-lock" : "pi-lock-open", run: () => Uo(this, S) },
        null,
        {
          label: r("Transform mode"),
          icon: "pi-arrows-alt",
    ...
    openPathKeyContext(I, T, S) {
      ...
      const A = E ? uo(E) : "auto", K = this.selectedKeyFrames?.size || 0, X = this.pathSelection?.component === "target", L = Qr(w, this.state.objects);
    ...
    openTimelineContext(I, T) {
      const S = this.selectedKeyFrames?.size || 0, w = this.selectedKeyframe(), E = w?.interpolation || "ease", A = w && uo(w) || "auto", K = ["ease", "linear", "bezier", "smooth", "ease_in", "ease_out", "sine", "cubic", "quintic", "expo", "back"], X = ["auto", "clamped", "vector", "free", "aligned", "flat"];
      this.showContextMenu(I, T ? `Keyframe F${this.selectedKeyFrame}` : `Timeline F${this.frame}`, [
        { label: r("Fit timeline view (F)"), icon: "pi-arrows-alt", shortcut: "F", run: () => Ue(this) },
    ...
    openCurveContext(I) {
      const T = this.selectedKeyFrames?.size || 0, S = T < 2 && !this.selectedKeyframe(), w = this.selectedKeyframe(), E = w?.interpolation || "ease", A = w && uo(w) || "auto", K = ["bezier", "smooth", "linear", "ease_in", "ease_out", "ease", "sine", "cubic", "quintic", "expo", "back"], X = ["auto", "clamped", "vector", "free", "aligned", "flat"];
      this.showContextMenu(I, r("Curve editor"), [
        { label: r("Fit all curves (Framing)"), icon: "pi-arrows-alt", shortcut: "F", run: () => lt(this) },
        { label: r("Set key at playhead"), icon: "pi-key", shortcut: "I", run: () => this.insertKeyframe() },
    ...
    resizeCanvas() {
      ...
      for (const K of this.cameraPreviewCanvases.values()) {
        const X = K.clientWidth || 220, L = K.clientHeight || 124, Y = Math.max(T, Gh / Math.max(1, X)), ge = Math.max(1, Math.round(X * Y)), Me = Math.max(1, Math.round(L * Y));
        (K.width !== ge || K.height !== Me) && (K.width = ge, K.height = Me);
      }
...
function Yh(e, t) {
  ...
  const o = rn();
  o.position = [0, 0, 0], o.target = [0, 0, -1], a.camera = de(o), a.keyframes = [{ frame: 0, camera: de(o), interpolation: "ease" }], e.state.active_camera_id = a.id, e.state.camera = de(o), e.state.keyframes = a.keyframes, e.camera = de(o), e.frame = 0, e.selectedEntity = "camera", e.selectedObjectId = null, e.selectedKeyFrame = 0, e.editingKeyFrame = null, e.cameraEditKey = null, e.cameraEditActive = !1, e.cameraPreviewSignature = "", Qn(e), e.refreshCameraSelectors(), e.setStatus(r("{value1} animation reset", { value1: a.name }));
}
function Zh(e, t) {
  const a = e.state.objects.find((o) => o.id === t);
  a && (e.checkpoint("Reset object animation"), a.keyframes = [], a.position = [0, 0, 0], a.rotation = [0, 0, 0], e.frame = 0, e.selectedEntity = "object", e.selectedObjectId = a.id, e.selectedKeyFrame = null, e.editingKeyFrame = null, Qn(e), e.setStatus(r("{value1} animation reset", { value1: a.name || a.type })));
}
const Nr = { motion: "motion", shot: "display", health: "health" }, Jh = {
  object: "Object",
  camera: "Camera",
...
function tu(e) {
  const t = es(e);
  return Nr[t] ? Nr[t] : e.selectedEntity === "object" ? "scene" : "camera";
}
function au(e) {
  return [
    e.selectedEntity || "",
...
function ts(e) {
  ...
  n && (n.textContent = o === "entity" ? r(Jh[e.selectedEntity] || "Inspector") : r(Qh[o] || "Inspector"));
}
function ru(e, t) {
  e.inspectorMode = eu.includes(t) ? t : "entity", ts(e), e.render?.(), e.refitNode?.();
}
function nu(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: n, initializeTooltips: s, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: m, activeCameraTrack: p, bindWidgetCallbacks: f, playblastCameraTrack: u, restoreFromWidgets: d, serializeEditorState: h, syncActiveCameraTrack: b, syncFromWidgets: g, bindEditorEvents: y, activateCamera: v, addCamera: j, deleteCamera: x, drawPreviewOverlays: M, duplicateCamera: P, maximizeCameraPreview: D, refreshCameraPreviews: F, refreshCameraSelectors: U, renameCamera: B, setPlayblastCamera: V, toggleCameraView: Q, captureRealtime: k, makePlayblast: _, uploadDirectorPlayblast: z, waitForMediaFrame: N, computeAudioPeaks: q, loadAudioFile: $, releaseAudio: W, stopPlay: C, togglePlay: R, applyCameraPreset: G, applyCameraShake: ae, applyProxyPreset: re, clearViewportBgImage: ee, loadViewportBgFile: ie, loadViewportBgSequence: fe, drawCameraPath: me, drawCard: ue, drawCube: be, drawGrid: O, drawHuman: H, drawLine3D: ce, drawNull: le, drawOverlays: pe, drawPointField: ne, drawSpeedHeatmap: ke, drawSphere: At, curveChannels: Tt, drawCurveEditor: rt, onCurvePointerDown: nt, onCurvePointerMove: st, onCurvePointerUp: it, onTimelinePointerDown: Pt, onTimelinePointerMove: It, onTimelinePointerUp: zt, refreshKeys: ct, resetCurveZoom: lt, resetTimelineZoom: Ue, setChannelFilter: dt, setCurveInterpolation: mt, setTangentMode: pt, timelineFrameFromEvent: Ft, toggleCurveHandles: ft, zoomCurve: Lt, drawTransformGizmo: Ot, frameTarget: Kt, gizmoAxes: Dt, gizmoGeometry: Nt, onPointerDown: Rt, onPointerMove: qt, onPointerUp: Bt, onWheel: Wt, pickGizmo: Vt, pickSceneObject: Ht, resetCamera: ht, setTransformMode: ut, setViewMode: Ut, viewportCamera: Gt, loadCardFile: co, loadExecutionPreview: lo, loadMediaUrl: Xt, loadModelFile: Yt, loadSelectedReference: Zt, onModelLoaded: Jt, restoreAssets: Qt, syncUpstreamInputs: ea, configureDomMedia: ta, refreshSetupDiagnostic: bt, addMediaCard: aa, addPrimitive: oa, applyObjectAnimationFrame: ra, beginCameraEdit: na, beginObjectEdit: sa, commitCameraEdit: ia, commitObjectEdit: ca, copyKeyframe: la, deleteKeyframe: da, deleteObject: ma, deleteSelectedObjects: pa, duplicateObject: fa, exitKeyEdit: ha, finishCameraEdit: ua, goToAdjacentKey: ba, insertKeyframe: ga, loadSelectedKeyView: va, pasteKeyframe: ya, playblastCameraAtFrame: xa, refreshInspector: wa, refreshKeyEditor: ka, refreshObjects: Sa, removeObjectResources: ja, renameObject: Ca, retimeSelectedKey: _a, selectKeyframe: Ea, selectedKeyframe: $a, selectedObject: Ma, selectObjectAnimation: Aa, setKeyInterpolation: Ta, setKeyTangentMode: Pa, setObjectParent: qe, timelineKeyframes: Ia, timelineObject: za, toggleAutoKey: Fa, toggleObject: La, updateCameraFromHud: Oa, updateCameraRotationFromHud: Ka, updateEditState: Da, updateKeyVisualState: gt, updateSelectedKey: Na, updateSelectedObject: Ra, clamp: qa, cloneCamera: Le, configureCore: mo, defaultCamera: Ge, sampleCamera: je, sampleObjectTransform: I, sanitizeState: T, worldTransform: S } = e;
  return {
    setChannelFilter(w) {
      dt(this, w);
    },
    setFrame(w, E = !1, A = !0) {
      this.frame = qa(Math.round(w), 0, this.state.duration_frames - 1), this.editingKeyFrame !== this.frame && (this.editingKeyFrame = null), this.camera = je(this.activeCameraTrack(), this.frame, this.state.objects), kt(this, this.activeCameraTrack(), this.camera, this.frame), this.applyObjectAnimationFrame();
      const K = this.dom ||= jn(this.root);
      ...
      for (const J of K.cameraFocal) document.activeElement !== J && (J.value = Ro(this.camera.fov));
      ...
      const L = Math.floor(X / 60), Y = Math.floor(X % 60), ge = Math.floor(X % 1 * 1e3), Me = this.frame % Math.max(1, Math.round(this.state.fps)), Be = Math.floor(this.frame / this.state.fps);
      if ((K.time || this.root.querySelector('[data-role="time"]')).textContent = this.state.timecode_mode === "timecode" ? `${String(Math.floor(Be / 3600)).padStart(2, "0")}:${String(Math.floor(Be / 60) % 60).padStart(2, "0")}:${String(Be % 60).padStart(2, "0")}:${String(Me).padStart(2, "0")}` : `${String(L).padStart(2, "0")}:${String(Y).padStart(2, "0")}.${String(ge).padStart(3, "0")}`, A) this.refreshKeys();
      else {
        mn(this);
    ...
    setSpatialHandleMode(w) {
      ...
      this.checkpoint(r("Camera path handle: {mode}").replace("{mode}", w)), cc(A[K], w, {
        prevKey: A[K - 1] || null,
        nextKey: A[K + 1] || null
    ...
    transformCameraPath(w) {
      ...
      const A = en(E.keyframes, { origin: Jr(E.keyframes), ...w });
      return E.keyframes = A, E.id === this.state.active_camera_id && (this.state.keyframes = A), this.camera = je(E, this.frame, this.state.objects), E.camera = Le(this.camera), this.serialize(), this.refreshKeys(), this.refreshInspector(), this.render(), this.renderCameraView?.(), !0;
    },
    ...
    async openCameraPathPresetPicker() {
      ...
      const E = nc.map((K) => ({ id: K, label: r(cr[K] || K) })), A = await cn({ title: r("Camera Path Preset"), items: E, owner: this });
    ...
    playblastCameraAtFrame() {
      return kt(this, u(this), xa(this, je), this.frame);
    },
    viewportCamera() {
      return Gt(this);
    },
    ...
    lookAtObject(w) {
      ...
      if (E) {
        ...
        this.camera = je(this.state, this.frame), this.serialize(), this.refreshKeys(), this.render(), this.setStatus(`Cameras look at ${E.name || E.type}`);
      }
    },
    setTransformMode(w) {
      ut(this, w);
    ...
    refreshInspector() {
      this.perf && (this.perf.inspectorRefreshCount = (this.perf.inspectorRefreshCount || 0) + 1), wa(this), ou(this);
    },
    setInspectorMode(w) {
      ru(this, w);
    },
    ...
    setCameraTrackingTarget(w) {
      ...
      const E = this.activeCameraTrack();
      E.target_object_id !== (w || null) && (E.aim_bone = null), E.target_object_id = w || null, E.id === this.state.active_camera_id && (this.state.target_object_id = w || null, this.state.aim_bone = E.aim_bone), this.camera = je(E, this.frame, this.state.objects), kt(this, E, this.camera, this.frame), this.serialize(), this.refreshInspector(), this.render(), this.setStatus(w ? `Camera tracking: ${w}` : "Camera tracking disabled (manual target)");
    },
    bakeAimToKeyframes() {
...
function su(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: n, initializeTooltips: s, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: m, activeCameraTrack: p, bindWidgetCallbacks: f, playblastCameraTrack: u, restoreFromWidgets: d, serializeEditorState: h, syncActiveCameraTrack: b, syncFromWidgets: g, bindEditorEvents: y, activateCamera: v, addCamera: j, deleteCamera: x, drawPreviewOverlays: M, duplicateCamera: P, maximizeCameraPreview: D, refreshCameraPreviews: F, refreshCameraSelectors: U, renameCamera: B, setPlayblastCamera: V, toggleCameraView: Q, captureRealtime: k, makePlayblast: _, uploadDirectorPlayblast: z, waitForMediaFrame: N, computeAudioPeaks: q, loadAudioFile: $, releaseAudio: W, stopPlay: C, togglePlay: R, applyCameraPreset: G, applyCameraShake: ae, applyProxyPreset: re, clearViewportBgImage: ee, loadViewportBgFile: ie, loadViewportBgSequence: fe, drawCameraPath: me, drawCard: ue, drawCube: be, drawGrid: O, drawHuman: H, drawLine3D: ce, drawNull: le, drawOverlays: pe, drawPointField: ne, drawSpeedHeatmap: ke, drawSphere: At, curveChannels: Tt, drawCurveEditor: rt, fitCurveView: nt, onCurveDoubleClick: st, onCurvePointerDown: it, onCurvePointerMove: Pt, onCurvePointerUp: It, onTimelinePointerDown: zt, onTimelinePointerMove: ct, onTimelinePointerUp: lt, refreshKeys: Ue, resetCurveZoom: dt, resetTimelineZoom: mt, setChannelFilter: pt, setCurveInterpolation: Ft, setTangentMode: ft, timelineFrameFromEvent: Lt, toggleCurveHandles: Ot, zoomCurve: Kt, drawTransformGizmo: Dt, frameTarget: Nt, gizmoAxes: Rt, gizmoGeometry: qt, onPointerDown: Bt, onPointerMove: Wt, onPointerUp: Vt, onWheel: Ht, pickGizmo: ht, pickSceneObject: ut, resetCamera: Ut, setTransformMode: Gt, setViewMode: co, viewportCamera: lo, loadCardFile: Xt, loadExecutionPreview: Yt, loadMediaUrl: Zt, loadModelFile: Jt, loadSelectedReference: Qt, onModelLoaded: ea, restoreAssets: ta, syncUpstreamInputs: bt, configureDomMedia: aa, refreshSetupDiagnostic: oa, addMediaCard: ra, addPrimitive: na, applyObjectAnimationFrame: sa, beginCameraEdit: ia, beginObjectEdit: ca, commitCameraEdit: la, commitObjectEdit: da, copyKeyframe: ma, deleteKeyframe: pa, deleteObject: fa, duplicateObject: ha, exitKeyEdit: ua, finishCameraEdit: ba, goToAdjacentKey: ga, insertKeyframe: va, loadSelectedKeyView: ya, pasteKeyframe: xa, playblastCameraAtFrame: wa, refreshInspector: ka, refreshKeyEditor: Sa, refreshObjects: ja, removeObjectResources: Ca, renameObject: _a, retimeSelectedKey: Ea, selectKeyframe: $a, selectedKeyframe: Ma, selectedObject: Aa, selectObjectAnimation: Ta, setKeyInterpolation: Pa, setObjectParent: qe, timelineKeyframes: Ia, timelineObject: za, toggleAutoKey: Fa, toggleObject: La, updateCameraFromHud: Oa, updateEditState: Ka, updateKeyVisualState: Da, updateSelectedKey: gt, updateSelectedObject: Na, clamp: Ra, cloneCamera: qa, configureCore: Le, defaultCamera: mo, sampleCamera: Ge, sampleObjectTransform: je, sanitizeState: I, worldTransform: T } = e;
  return {
    setTargetAtCursor(S) {
      if (!S) return;
...
const mu = "http://www.w3.org/2000/svg", Ze = 26, Rr = 17, pu = 5.4;
function Je(e, t) {
...
function fu(e) {
  ...
  for (const s of lu(cu(a))) {
    const i = Ze + s.x * Rr, c = Ze + s.y * Rr, l = du(s.depth);
    t.appendChild(Je("line", {
      x1: Ze,
      y1: Ze,
      x2: i,
      y2: c,
...
function uu(e) {
  ...
  for (const n of e.state.motion_layers || []) {
    ...
    const s = hu(e.state, n, e.frame, a, o);
    if (s.length) {
...
const bu = ["world_point", "object_point", "camera_field"], as = {
  manual_2d: "DRAW",
  object_point: "OBJECT",
  world_point: "WORLD",
...
function vu(e, t) {
  if (bu.includes(t.source_kind)) {
    const a = Do(e, t.source, 0, e.width || 1280, e.height || 720);
...
function wu(e) {
  ...
  if (t.hidden = !a, !a) return;
  const o = Math.max(1, Number(e.state.fps) || 24), n = (a.keys || []).map((u) => Math.round(u.time_seconds * o)), s = (u, d) => {
    const h = t.querySelector(`[data-role="${u}"]`);
    h && (h.textContent = d);
  };
  s("motion-sel-name", a.label), s("motion-sel-type", as[a.source_kind] || "TRACK"), s("motion-sel-binding", gu(e.state, a)), s("motion-sel-start", n.length ? Math.min(...n) : 0), s("motion-sel-end", n.length ? Math.max(...n) : 0);
...
function ju(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: n, initializeTooltips: s, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: m, activeCameraTrack: p, bindWidgetCallbacks: f, playblastCameraTrack: u, restoreFromWidgets: d, serializeEditorState: h, syncActiveCameraTrack: b, syncFromWidgets: g, bindEditorEvents: y, activateCamera: v, addCamera: j, deleteCamera: x, drawPreviewOverlays: M, duplicateCamera: P, maximizeCameraPreview: D, refreshCameraPreviews: F, refreshCameraSelectors: U, renameCamera: B, setPlayblastCamera: V, toggleCameraView: Q, captureRealtime: k, makePlayblast: _, uploadDirectorPlayblast: z, waitForMediaFrame: N, computeAudioPeaks: q, loadAudioFile: $, releaseAudio: W, stopPlay: C, togglePlay: R, applyCameraPreset: G, applyCameraShake: ae, applyProxyPreset: re, clearViewportBgImage: ee, loadViewportBgFile: ie, loadViewportBgSequence: fe, drawCameraPath: me, drawCard: ue, drawCube: be, drawCylinder: O, drawGrid: H, drawHuman: ce, drawLine3D: le, drawNull: pe, drawOverlays: ne, drawPointField: ke, drawSpeedHeatmap: At, drawSphere: Tt, drawTorus: rt, curveChannels: nt, drawCurveEditor: st, onCurvePointerDown: it, onCurvePointerMove: Pt, onCurvePointerUp: It, onTimelinePointerDown: zt, onTimelinePointerMove: ct, onTimelinePointerUp: lt, refreshKeys: Ue, resetCurveZoom: dt, resetTimelineZoom: mt, setChannelFilter: pt, setCurveInterpolation: Ft, setTangentMode: ft, timelineFrameFromEvent: Lt, toggleCurveHandles: Ot, zoomCurve: Kt, drawTransformGizmo: Dt, frameTarget: Nt, gizmoAxes: Rt, gizmoGeometry: qt, onPointerDown: Bt, onPointerMove: Wt, onPointerUp: Vt, onWheel: Ht, pickGizmo: ht, pickSceneObject: ut, resetCamera: Ut, setTransformMode: Gt, setViewMode: co, viewportCamera: lo, loadCardFile: Xt, loadExecutionPreview: Yt, loadMediaUrl: Zt, loadModelFile: Jt, loadSelectedReference: Qt, onModelLoaded: ea, restoreAssets: ta, syncUpstreamInputs: bt, configureDomMedia: aa, refreshSetupDiagnostic: oa, addMediaCard: ra, addPrimitive: na, applyObjectAnimationFrame: sa, beginCameraEdit: ia, beginObjectEdit: ca, commitCameraEdit: la, commitObjectEdit: da, copyKeyframe: ma, deleteKeyframe: pa, deleteObject: fa, duplicateObject: ha, exitKeyEdit: ua, finishCameraEdit: ba, goToAdjacentKey: ga, insertKeyframe: va, loadSelectedKeyView: ya, pasteKeyframe: xa, playblastCameraAtFrame: wa, refreshInspector: ka, refreshKeyEditor: Sa, refreshObjects: ja, removeObjectResources: Ca, renameObject: _a, retimeSelectedKey: Ea, selectKeyframe: $a, selectedKeyframe: Ma, selectedObject: Aa, selectObjectAnimation: Ta, setKeyInterpolation: Pa, setObjectParent: qe, timelineKeyframes: Ia, timelineObject: za, toggleAutoKey: Fa, toggleObject: La, updateCameraFromHud: Oa, updateEditState: Ka, updateKeyVisualState: Da, updateSelectedKey: gt, updateSelectedObject: Na, clamp: Ra, cloneCamera: qa, configureCore: Le, defaultCamera: mo, sampleCamera: Ge, sampleObjectTransform: je, sanitizeState: I, worldTransform: T } = e;
  return {
    ...
    renderViewportOnly() {
      ...
      if (S.fillStyle = this.state.viewport_bg_color || "#121212", S.fillRect(0, 0, w, E), this.viewportBgSequenceImages && this.viewportBgSequenceImages.length) {
        const te = this.frame % this.viewportBgSequenceImages.length, Oe = this.viewportBgSequenceImages[te];
        if (Oe?.complete && Oe.naturalWidth)
          try {
            S.drawImage(Oe, 0, 0, w, E);
          } catch {
          }
      ...
      const A = this.state.render_mode, K = this.viewportCamera(), X = this.state.objects.some((te) => te.parent_id) ? this.state.objects.map((te) => te.parent_id ? { ...te, ...T(this.state.objects, te) } : te) : this.state.objects, L = (this.viewportBgSequenceImages || []).map((te) => te.src), Y = this.viewportBgImage?.src || "", ge = this.pendingExtractorImport, Me = ge ? [...this.state.cameras, {
        id: "__extractor_preview__",
        name: ge.label,
        color: "#9ca3af",
        camera: ge.track.keyframes[0]?.camera,
        keyframes: ge.track.keyframes
      }] : this.state.cameras, Be = {
        ...this.state,
        cameras: Me,
        objects: X,
        viewport_bg_image: Y,
        ...
        __omnicamRevision: `${this.renderRevision || 0}:${ge?.fingerprint || ""}`
      };
      let J = !1;
      if (this.webgl) {
        try {
          const te = this.recording ? 1 : this.webgl.supersampleFactor?.() ?? 1, Oe = te > 1 ? Math.min(te, 4096 / Math.max(1, w, E)) : 1, Ba = Oe > 1 ? Math.round(w * Oe) : w, po = Oe > 1 ? Math.round(E * Oe) : E;
          this.webgl.activeCamera && this.transformControlsWiring?.sync(), this.webgl.render(Be, K, this.cardMediaById, Ba, po, this.modelUrlsById, this.frame, this.recording, this.selectedEntity, this.selectedObjectId, this.subSelection, this.selectedKeyFrame ?? null, this.selectedKeyFrames ? [...this.selectedKeyFrames] : null, this.recording && this.state.guide_capture_style || "auto"), S.imageSmoothingEnabled = !0, S.imageSmoothingQuality = "high", Ba !== w || po !== E ? S.drawImage(this.webgl.canvas, 0, 0, Ba, po, 0, 0, w, E) : S.drawImage(this.webgl.canvas, 0, 0, w, E), J = !0;
        } catch (te) {
      ...
      !this.recording && this.state.speed_heatmap && this.drawSpeedHeatmap(), !this.recording && Mp(this), this.drawOverlays(), uu(this), this.state.show_gizmo && fu(this), this.labelOverlay?.update(), this.rigOverlay?.update(), this.perf && (this.perf.viewportRenderCount = (this.perf.viewportRenderCount || 0) + 1);
    },
    ...
    requestRender(S = "unknown") {
      return this.requestUiUpdate(Ce.viewport | Ce.previews | Ce.motion, S);
    },
    ...
    requestUiUpdate(S = Ce.viewport, w = "unknown") {
      (this.renderReasons ||= /* @__PURE__ */ new Set()).add(w), this.uiDirtyMask = lc(this.uiDirtyMask, S), this.renderInvalidations = (this.renderInvalidations || 0) + 1, !this.renderScheduled && (this.renderScheduled = !0, this.renderFrame = requestAnimationFrame(() => {
        if (this.renderScheduled = !1, this.disposed) return;
        const E = this.uiDirtyMask || Ce.viewport;
        this.uiDirtyMask = 0, this.lastRenderReasons = [...this.renderReasons || []], this.renderReasons?.clear(), this.rendersCoalesced = (this.rendersCoalesced || 0) + 1, this.perf && (this.perf.renderCount = (this.perf.renderCount || 0) + 1), Xe(E, Ce.outliner) && this.refreshObjects(), Xe(E, Ce.timeline) && this.refreshKeys(), Xe(E, Ce.inspector) && this.refreshInspector(), Xe(E, Ce.viewport) && this.renderViewportOnly(), Xe(E, Ce.previews) && this.renderCameraView(), Xe(E, Ce.motion) && this.renderMotionUiOnly();
      }));
    },
    renderCameraView() {
      if (this.perf && (this.perf.previewRenderCount = (this.perf.previewRenderCount || 0) + 1), this.state.camera_view_visible) {
        ...
        for (const K of w) {
          ...
          const Y = X.width, ge = X.height, Me = this.root.querySelector(`[data-camera-frame="${K.id}"]`);
          if (Me && (Me.textContent = `F${this.frame}`), E && K.id !== this.state.active_camera_id && K !== A) continue;
          const Be = kt(this, K, Ge(K, this.frame, this.state.objects), this.frame);
          if (L.fillStyle = "#111", L.fillRect(0, 0, Y, ge), this.cameraWebgl)
            try {
              this.cameraWebgl.render({ ...this.state, keyframes: [], playblast_grid: !1, viewport_bg_image: this.viewportBgImage?.src || "", viewport_bg_sequence: (this.viewportBgSequenceImages || []).map((J) => J.src), __omnicamRevision: this.renderRevision || 0 }, Be, this.cardMediaById, Y, ge, this.modelUrlsById, this.frame, !0), L.drawImage(this.cameraWebgl.canvas, 0, 0, Y, ge);
            } catch (J) {
    ...
    dispose() {
      this.disposed || (this.disposed = !0, this.agentBridge?.dispose?.(), this.transformControlsWiring?.dispose(), Ti(this), Pi(), Mc(this), this.backgroundRequestId = (this.backgroundRequestId || 0) + 1, this.upstreamSyncId = (this.upstreamSyncId || 0) + 1, this.stopPlay(), clearTimeout(this.previewClickTimer), clearTimeout(this.connectionTimer), cancelAnimationFrame(this.restoreFrame), cancelAnimationFrame(this.serializeFrame), cancelAnimationFrame(this.resizeFrame), cancelAnimationFrame(this.renderFrame), this.abortController?.abort(), this.upstreamFetchController?.abort(), this.resizeObserver?.disconnect(), this.contextMenu?.dispose(), this.webgl?.dispose(), this.cameraWebgl?.dispose(), W(this), af(this), this.objectUrls.clear(), this.cardMediaById.clear(), this.cardMediaAssetById?.clear?.(), this.modelUrlsById.clear(), this.modelInfoById.clear());
    }
  };
}
const Cu = 0.12;
function _u() {
  return {
    ...
    resolveSelectedFrames() {
      const e = new Set(xe(this).map((a) => a.frame));
    ...
    _activeTrack() {
      ...
      return {
        kind: "camera",
        write: (a) => {
          t.keyframes = a, this.state.keyframes = a, $o(this);
        }
      };
    },
    deleteSelectedKeyframes() {
      ...
      if (!e.length) {
        const l = xe(this).find((m) => m.frame === this.frame);
        l && (e = [l.frame]);
      }
      if (!e.length) return this.setStatus(r("Select a keyframe to delete"));
      const t = this._activeTrack(), a = xe(this), o = t.kind === "camera" ? 1 : 0, { keys: n, removed: s } = fc(a, e, { minKeys: o });
    ...
    nudgeSelectedKeyframes(e) {
      ...
      const a = this._activeTrack(), o = Math.max(0, this.state.duration_frames - 1), n = pc(xe(this), t, e, { lastFrame: o });
    ...
    setSelectedKeysInterpolation(e) {
      ...
      this.checkpoint(r("Interpolation on {n} keys").replace("{n}", t.length)), a.write(mc(xe(this), t, e)), this.serialize(), this.refreshKeys(), this.refreshKeyEditor(), this.render(), this.drawCurveEditor(), this.setStatus(r("{mode} interpolation on {n} keys").replace("{mode}", e.replace(/_/g, " ")).replace("{n}", t.length));
    },
    setSelectedKeysTangentMode(e) {
      const t = this.resolveSelectedFrames();
      if (t.length < 2) return this.setTangentMode(e);
      const a = this._activeTrack(), o = at(this).map((n) => n.id);
      this.checkpoint(r("Tangents on {n} keys").replace("{n}", t.length)), a.write(dc(xe(this), t, e, o)), this.serialize(), this.refreshKeys(), this.render(), this.drawCurveEditor(), this.setStatus(r("{mode} tangents on {n} keys").replace("{mode}", e).replace("{n}", t.length));
    },
    /**
    ...
    simplifyActiveKeys({ mode: e = "simplify", tolerance: t = 0, target: a = 0, scope: o = "camera", fromKeys: n = null, silent: s = !1 } = {}) {
      ...
      if (o === "object") {
        ...
        c = this.state.cameras.map((h) => ({
          get: () => h.keyframes || [],
          set: (b) => {
            h.keyframes = b, h.id === this.state.active_camera_id && (this.state.keyframes = b);
          },
        ...
        c = [{
          get: () => h.keyframes || [],
          set: (b) => {
            h.keyframes = b, this.state.keyframes = b;
          },
          primary: !0
        }];
      }
      if (e === "simplify" && t <= 0 && !n) return 0;
      const l = this.resolveSelectedFrames(), m = o !== "all_cameras" && l.length >= 2 ? [l[0], l.at(-1)] : null, p = m ? [] : l, f = (h) => {
        const b = [...h].sort((D, F) => D.frame - F.frame), g = m ? m[0] : -1 / 0, y = m ? m[1] : 1 / 0, v = b.filter((D) => D.frame < g), j = b.filter((D) => D.frame >= g && D.frame <= y), x = b.filter((D) => D.frame > y);
        let M = j, P = 0;
        if (j.length > 2) {
          const D = e === "reduce" ? hc(j, i, { target: a || Math.ceil(j.length / 2), keepFrames: p }) : e === "clean" ? uc(j, i, { keepFrames: p }) : bc(j, i, { tolerance: t * Cu, keepFrames: p });
      ...
      let u = 0;
      const d = c.map((h) => {
        const b = n && h.primary ? n : h.get(), { keys: g, removed: y } = f(b);
        return u += y, { track: h, keys: g };
      });
      s || this.checkpoint(r("Simplify keyframes"));
      for (const { track: h, keys: b } of d) h.set(b);
      return $o(this), this.selectedKeyFrame = null, this.selectedKeyFrames = /* @__PURE__ */ new Set(), this.camera = we(this.state, this.frame), this.applyObjectAnimationFrame(), this.serialize(), this.refreshKeys(), this.setFrame(this.frame, !1, !1), this.render(), s || this.setStatus(u ? r("Removed {n} keyframes").replace("{n}", u) : r("No keyframes to remove")), u;
    },
...
class tr {
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-BcFwlwWn.js"));
    } catch (a) {
...
for (const e of Eu)
  Object.defineProperty(tr.prototype, e, {
    configurable: !0,
    enumerable: !0,
    get() {
...
const Xa = { app: qr, api: He, EditorHistory: gc, ContextMenuController: ln, initializeTooltips: Ac, promptText: Ct, ObjectUrlRegistry: wn, buildRoot: kn, dispatchDirectorKey: Li, activeCameraTrack: Eo, bindWidgetCallbacks: Zc, playblastCameraTrack: dn, restoreFromWidgets: Jc, serializeEditorState: Qc, syncActiveCameraTrack: $o, syncFromWidgets: el, bindEditorEvents: Bp, activateCamera: Tc, addCamera: Pc, deleteCamera: Ic, drawPreviewOverlays: zc, duplicateCamera: Fc, maximizeCameraPreview: Lc, refreshCameraPreviews: Oc, refreshCameraSelectors: Kc, renameCamera: Dc, setPlayblastCamera: Nc, toggleCameraView: Rc, captureRealtime: qn, makePlayblast: vf, uploadDirectorPlayblast: Bn, waitForMediaFrame: Rn, computeAudioPeaks: Ln, loadAudioFile: Qp, releaseAudio: ao, stopPlay: Ja, togglePlay: Yp, applyCameraPreset: em, applyCameraShake: tm, applyProxyPreset: am, clearViewportBgImage: kf, loadViewportBgFile: xf, loadViewportBgSequence: wf, drawCameraPath: Lf, drawCard: Ff, drawCube: Mf, drawCylinder: Pf, drawGrid: Cf, drawHuman: Tf, drawLine3D: se, drawNull: zf, drawOverlays: Kf, drawPointField: $f, drawSpeedHeatmap: Of, drawSphere: Af, drawTorus: If, curveChannels: at, drawCurveEditor: El, fitCurveView: gn, onCurveDoubleClick: Cl, onCurvePointerDown: bl, onCurvePointerMove: gl, onCurvePointerUp: vl, onTimelinePointerDown: Oi, onTimelinePointerMove: Ki, onTimelinePointerUp: Di, refreshKeys: Kl, resetCurveZoom: _l, resetTimelineZoom: Ni, setChannelFilter: xl, setCurveInterpolation: yl, setTangentMode: wl, timelineFrameFromEvent: zo, toggleCurveHandles: kl, zoomCurve: jl, drawTransformGizmo: Ri, frameTarget: qi, gizmoAxes: Bi, gizmoGeometry: Wi, onPointerDown: Vi, onPointerMove: Hi, onPointerUp: Ui, onWheel: Gi, pickGizmo: Xi, pickSceneObject: Yi, resetCamera: Zi, setTransformMode: Ji, setViewMode: Qi, viewportCamera: ec, loadCardFile: cf, loadExecutionPreview: lf, loadMediaUrl: Nn, loadModelFile: sf, loadSelectedReference: df, onModelLoaded: nf, restoreAssets: rf, syncUpstreamInputs: mf, configureDomMedia: On, refreshSetupDiagnostic: Rf, addMediaCard: lh, addPrimitive: nh, applyObjectAnimationFrame: Ch, beginCameraEdit: Ph, beginObjectEdit: Yn, commitCameraEdit: Ih, commitObjectEdit: ph, copyKeyframe: Mh, deleteKeyframe: $h, deleteObject: Xn, deleteSelectedObjects: ch, duplicateObject: Gn, exitKeyEdit: Fh, finishCameraEdit: zh, goToAdjacentKey: Hh, insertKeyframe: _h, loadSelectedKeyView: Vh, pasteKeyframe: Ah, playblastCameraAtFrame: jh, refreshInspector: dh, refreshKeyEditor: qh, refreshObjects: Un, removeObjectResources: vh, renameObject: sh, retimeSelectedKey: Bh, selectKeyframe: Th, selectedKeyframe: Fe, selectedObject: Mt, selectObjectAnimation: gh, setKeyInterpolation: Eh, setKeyTangentMode: Nh, setObjectParent: bh, timelineKeyframes: xe, timelineObject: Se, toggleAutoKey: Lh, toggleObject: ih, updateCameraFromHud: uh, updateCameraRotationFromHud: hh, updateEditState: Kh, updateKeyVisualState: Dh, updateSelectedKey: Wh, updateSelectedObject: mh, clamp: Z, cloneCamera: de, configureCore: nn, defaultCamera: rn, sampleCamera: we, sampleObjectTransform: no, sanitizeState: tc, worldTransform: Oo };
Object.assign(
  tr.prototype,
  Xh(Xa),
  nu(Xa),
...
function $u(e) {
  const t = e.node;
  So("director:workbench:constructor:start", t);
  const a = new tr(e);
  So("director:workbench:constructor:complete", t), e.attachWorkbench(a), t.__majoorOmniCam = a, Ii(a);
  try {
    a.assetBrowser = Dd(a, {
      ...
      onAgentFirstOpen: async () => {
        if (jo())
          try {
            const { createDirectorAgentPanel: o } = await import("./chunk-DLPKfoJ6.js");
            a.agentPanel = o(a);
          } catch (o) {
  ...
  try {
    a.characterRuntime = Rd(a), a.rigMapper = Bd(a), a.poseEditor = Hd(a), a.motionEditor = Ud(a);
  } catch (o) {
    console.warn("[OmniCam] Character tools unavailable", o);
  }
  return So("director:workbench:ready", t), a;
}
function Mu(e) {
...
const Wu = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  closeDirectorWorkbench: Mu,
  openDirectorWorkbench: $u
