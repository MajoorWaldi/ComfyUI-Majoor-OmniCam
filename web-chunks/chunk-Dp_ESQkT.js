...
import { api as tt } from "../../scripts/api.js";
import { s as Te, c as te, t as ge, a as s, o as ds, b as Tr, d as We, e as me, f as qo, r as Ni, g as Mr, h as ms, i as Fi, j as zi, k as Ri, l as Di, m as $r, n as Ir, p as Le, q as Be, u as Zo, v as nn, w as he, x as Uo, I as Ao, D as Ki, y as ps, z as Or, A as fs, B as Pr, C as Lr, E as Bi, F as qi, G as Io, H as hs, J as Ui, K as Nr, L as mr, M as sn, N as us, O as pr, P as bs, Q as gs, R as ys, S as vs, T as fr, U as Qo, V as cn, W as ln, X as xs, Y as Wi, Z as Vi, _ as Hi, $ as Gi, a0 as Yi, a1 as dn, a2 as Xi, a3 as ws, a4 as Ji, a5 as Fr, a6 as Zi, a7 as Qi, a8 as ec, a9 as tc, aa as ac, ab as zr, ac as oc, ad as rc, ae as nc, af as sc, ag as ic, ah as cc, ai as lc, aj as dc, ak as mc, al as pc, am as fc, an as hc, ao as uc, ap as bc, aq as gc, ar as yc, as as vc, at as xc, au as wc, av as kc, aw as Sc, ax as _c, ay as jc, az as Ec, aA as Cc, aB as Ac, aC as Tc, aD as Mc, aE as $c, aF as Ic, aG as Oc, aH as Pc, aI as Lc, aJ as Nc, aK as Fc, aL as zc, aM as Rc, aN as Dc, aO as Kc, aP as Bc, aQ as qc, aR as Uc, aS as Wc, aT as Vc, aU as er, aV as Hc, aW as Gc, aX as Yc, aY as Xc, aZ as Jc, a_ as Ue, a$ as Zc, b0 as ks, b1 as Rr, b2 as Qc, b3 as el, b4 as tl, b5 as Ss, b6 as Je, b7 as al, b8 as ol, b9 as mn, ba as Dr, bb as rl, bc as _s, bd as nl, be as sl, bf as il, bg as cl, bh as ll, bi as dl, bj as ml, bk as pl, bl as fl, bm as hl, bn as js, bo as ul, bp as bl, bq as gl, br as yl, bs as vl, bt as xl, bu as wl, bv as kl, bw as Sl, bx as _l, by as jl, bz as El, bA as Cl, bB as Al, bC as Tl, bD as Ml, bE as $l, bF as Il, bG as Ol } from "./chunk-DOjb7wCT.js";
import { L as Pl, a as Ll, p as Xt, f as Kr, b as Nl, S as Fl, c as pn, d as zl, e as Rl, r as Dl, g as Kl, n as Bl, C as fn, h as Jt, o as Es, i as ql, s as Ul, j as Wl, k as Cs, l as Vl, m as hr, q as ur, w as Hl, t as As, u as Gl, v as Yl, x as Xl, y as Jl, z as Zl, A as Ql, B as ed, D as td, E as ad, F as od, G as rd, H as nd, I as sd, J as id, K as cd, M as ld } from "./chunk-D9JRJp8Z.js";
...
function vd(e, { type: t = "handheld_subtle", intensity: a = 1, duration_frames: o = null, subdivide: r = !0 } = {}) {
  ...
  return [...u].sort((y, x) => y - x).map((y) => {
    const x = Te(b, y), S = Rt(y * m, 1) * l, g = Rt(y * m, 2) * l, C = Rt(y * m, 3) * l * 0.5, M = Rt(y * m, 4) * p, z = Rt(y * m, 5) * (p * 0.35), N = [...x.position], G = [...x.target];
    return N[0] += S, N[1] += g, N[2] += C, G[0] += S * 0.35, G[1] += g * 0.35, {
      frame: y,
      camera: {
        ...x,
        position: N,
...
function Fd(e, t) {
  ...
  if (e.curveHover = null, t.preventDefault(), t.stopPropagation(), e.curveDrag.historyCheckpointed || (e.checkpoint?.(e.curveDrag.handle ? "Edit curve tangent" : "Edit curve"), e.curveDrag.historyCheckpointed = !0), e.curveDrag.handle) {
    ...
    f.tangents.channels[d.id] = g, e.scheduleSerialize(), e.camera = Te(e.state, e.frame), e.applyObjectAnimationFrame(), e.render(), e.drawCurveEditor();
    return;
  }
...
function Ns(e, { selectedOnly: t = !1 } = {}) {
  const a = Math.max(1, (e.state?.duration_frames ?? 120) - 1), o = e.timelineKeyframes() || [], r = e.timelineObject(), n = lt(e), i = e.selectedKeyFrames?.size ? [...e.selectedKeyFrames] : e.selectedKeyFrame != null ? [e.selectedKeyFrame] : [], c = i.length > 0, l = t || c && i.length < o.length ? o.filter((u) => i.includes(u.frame)) : o;
  if (!l.length) {
  ...
  if (h.length > 0) {
    const u = Math.min(...h), v = Math.max(...h), y = Math.max(1e-4, v - u), x = (u + v) / 2, S = (Y) => r ? qo(r, Y) : Te(e.state, Y), g = [], C = Math.max(1, Math.floor(a / 40));
    for (let Y = 0; Y <= a; Y += C) {
      const oe = S(Y);
      for (const k of n) {
        const E = k.get(oe);
    ...
    let M = Math.min(...g), z = Math.max(...g);
    (!Number.isFinite(M) || !Number.isFinite(z)) && (M = -1, z = 1), Math.abs(z - M) < 1e-6 && (M -= 1, z += 1);
    const N = (z - M) * 0.1;
    M -= N, z += N;
    const G = z - M, V = (M + z) / 2;
    if (l.length < o.length && y < G * 0.75) {
      const Y = y * 1.35;
      e.curveZoom = te(G / Y, 0.2, 30), e.curvePanY = x - V;
    } else
...
function Hd(e) {
  ...
  const i = e.timelineObject(), c = e.timelineKeyframes(), l = lt(e), p = 44, m = 14, f = 16, d = 22, h = Math.max(1, a - p - m), b = Math.max(1, o - f - d), u = Math.max(1, e.state.duration_frames - 1), v = te(Number(e.curveZoomX) || 1, 0.1, 50), y = Number(e.curvePanX) || 0, x = u / v, S = y, g = y + x, C = [], M = Math.max(1, Math.ceil(x / Math.max(80, h))), z = (I) => i ? qo(i, I) : Te(e.state, I);
  for (let I = 0; I <= u; I += M) C.push({ frame: I, value: z(I) });
  C[C.length - 1]?.frame !== u && C.push({ frame: u, value: z(u) });
  const N = C.flatMap((I) => l.map((H) => H.get(I.value)));
  let G = Math.min(...N), V = Math.max(...N);
  (!Number.isFinite(G) || !Number.isFinite(V)) && (G = -1, V = 1), Math.abs(V - G) < 1e-6 && (G -= 1, V += 1);
  const Y = (V - G) * 0.1;
  G -= Y, V += Y;
  const oe = te(Number(e.curveZoom) || 1, 0.1, 50), k = (V + G) / 2 + (Number(e.curvePanY) || 0), E = (V - G) / oe;
  G = k - E / 2, V = k + E / 2;
  const F = (I) => p + (I - S) / Math.max(1e-6, g - S) * h, q = (I) => f + b * (V - I) / Math.max(1e-6, V - G);
  if (n.fillStyle = "#111114", n.fillRect(0, 0, a, o), n.strokeStyle = "#222228", n.lineWidth = 1, n.font = "9px system-ui, -apple-system, sans-serif", n.fillStyle = "#6e727a", Pd(n, {
    ...
    xFor: F,
    frame: e.frame
  }), Ld(n, { left: p, right: m, top: f, width: a, graphHeight: b, minimum: G, maximum: V, yFor: q }), G <= 0 && V >= 0) {
    const I = q(0);
    n.strokeStyle = "#383842", n.lineWidth = 1.2, n.beginPath(), n.moveTo(p, I), n.lineTo(a - m, I), n.stroke();
  }
  e.curveHitPoints = [];
  for (const I of l) {
    n.strokeStyle = I.color, n.lineWidth = 2, n.beginPath();
    let H = !1;
    C.forEach((j) => {
      const U = F(j.frame), J = q(I.get(j.value));
      U >= p - 50 && U <= a - m + 50 && (H ? n.lineTo(U, J) : (n.moveTo(U, J), H = !0));
    }), n.stroke();
    for (const j of c) {
      const U = i ? j.transform : j.camera, J = F(j.frame), se = q(I.get(U)), ie = j.frame === e.selectedKeyFrame || e.selectedKeyFrames?.has(j.frame);
      ie && (n.fillStyle = "rgba(242, 208, 107, 0.35)", n.beginPath(), n.arc(J, se, 8.5, 0, Math.PI * 2), n.fill()), n.fillStyle = ie ? "#ffd75e" : I.color, n.strokeStyle = "#0d0d10", n.lineWidth = 1.6, n.beginPath(), n.arc(J, se, ie ? 5.2 : 3.8, 0, Math.PI * 2), n.fill(), n.stroke(), e.curveHitPoints.push({
        x: J,
        y: se,
        key: j,
        channel: I,
    ...
    if (e.showCurveHandles)
      for (let j = 0; j < c.length; j++) {
        const U = c[j], J = U.frame === e.selectedKeyFrame || e.selectedKeyFrames?.has(U.frame);
        if (!(J || e.curveChannelFilter !== "all" || c.length <= 4) || U.interpolation !== "bezier") continue;
        const ie = i ? U.transform || i : U.camera || U, re = F(U.frame), de = q(I.get(ie)), ye = c[j - 1], ue = c[j + 1], xe = Math.max(1, U.frame - (ye?.frame ?? U.frame - 1)), we = Math.max(1, (ue?.frame ?? U.frame + 1) - U.frame), D = Ni(
          U,
          I.id,
          ye,
          ue,
          (ce) => I.get(i ? ce.transform || i : ce.camera || U)
        ), X = (V - G) / Math.max(1, b), pe = h * we / Math.max(1, x), fe = h * xe / Math.max(1, x), be = [];
        (ye || j > 0) && be.push({ side: "in", x: re + D.in_x * fe, y: de - D.in_y / X }), (ue || j < c.length - 1 || c.length === 1) && be.push({ side: "out", x: re + D.out_x * pe, y: de - D.out_y / X });
        for (const ce of be) {
          if (n.strokeStyle = I.color, n.lineWidth = J ? 1.5 : 1, n.beginPath(), n.moveTo(re, de), n.lineTo(ce.x, ce.y), n.stroke(), n.fillStyle = J ? "#2a2233" : "#171720", n.strokeStyle = J ? "#ffd75e" : I.color, n.lineWidth = J ? 2 : 1.2, n.beginPath(), ce.side === "in")
            n.arc(ce.x, ce.y, J ? 5 : 3.8, 0, Math.PI * 2);
          else {
            const Me = J ? 4.5 : 3.2;
            n.rect(ce.x - Me, ce.y - Me, Me * 2, Me * 2);
          }
          n.fill(), n.stroke(), e.curveHitPoints.push({
            ...
            object: i,
            handle: ce.side,
            pixelPerSegment: ce.side === "in" ? fe : pe,
            valuePerPixel: X,
            startHandles: { ...D }
          });
        }
  ...
  if (e.curveBoxSelect) {
    const I = Math.min(e.curveBoxSelect.startX, e.curveBoxSelect.currentX), H = Math.min(e.curveBoxSelect.startY, e.curveBoxSelect.currentY), j = Math.abs(e.curveBoxSelect.currentX - e.curveBoxSelect.startX), U = Math.abs(e.curveBoxSelect.currentY - e.curveBoxSelect.startY);
    n.fillStyle = "rgba(56, 189, 248, 0.15)", n.fillRect(I, H, j, U), n.strokeStyle = "#38bdf8", n.lineWidth = 1, n.setLineDash([4, 4]), n.strokeRect(I, H, j, U), n.setLineDash([]);
  }
  const W = F(e.frame);
  if (W >= p && W <= a - m && (n.strokeStyle = "#a78bfa", n.lineWidth = 1.5, n.beginPath(), n.moveTo(W, f), n.lineTo(W, f + b), n.stroke(), n.fillStyle = "#a78bfa", n.beginPath(), n.moveTo(W - 4, f), n.lineTo(W + 4, f), n.lineTo(W, f + 6), n.closePath(), n.fill()), e.curveDrag || e.curveHover) {
    let I = "", H = "";
    if (e.curveDrag)
      if (e.curveDrag.handle) {
        const j = e.curveDrag.handle === "in" ? "In" : "Out";
        I = `F${e.curveDrag.key.frame} · ${e.curveDrag.channel.name} (${j})`, H = "Tangent edit";
      } else if (e.curveDrag.group && e.curveDrag.group.length > 1) {
        const j = e.curveDrag.key.frame - e.curveDrag.startFrame, U = e.curveDrag.channel.get(e.curveDrag.object ? e.curveDrag.key.transform : e.curveDrag.key.camera), J = U - e.curveDrag.startValue, se = j >= 0 ? `+${j}` : `${j}`, ie = J >= 0 ? `+${J.toFixed(2)}` : `${J.toFixed(2)}`;
        I = `${e.curveDrag.group.length} keys · ΔF: ${se} · ΔVal: ${ie}`, H = `${e.curveDrag.channel.name}: ${U.toFixed(2)}`;
      } else {
        const j = e.curveDrag.key.frame - e.curveDrag.startFrame, U = e.curveDrag.channel.get(e.curveDrag.object ? e.curveDrag.key.transform : e.curveDrag.key.camera), J = U - e.curveDrag.startValue, se = j >= 0 ? `+${j}` : `${j}`, ie = J >= 0 ? `+${J.toFixed(2)}` : `${J.toFixed(2)}`;
        I = `F${e.curveDrag.key.frame} (${se}) · ${e.curveDrag.channel.name}: ${U.toFixed(2)} (${ie})`;
      }
    else if (e.curveHover)
      if (e.curveHover.channelName) {
        const j = Number.isFinite(e.curveHover.value) ? e.curveHover.value.toFixed(2) : "";
        I = `F${e.curveHover.frame} · ${e.curveHover.channelName}: ${j}`, e.curveHover.isHandle && (H = `Handle ${e.curveHover.handleSide}`);
      } else
        I = `Frame ${e.curveHover.frame}`;
    if (I) {
      n.save(), n.font = "11px system-ui, -apple-system, sans-serif";
      const j = n.measureText(I), U = H ? n.measureText(H) : { width: 0 }, J = Math.max(j.width, U.width) + 16, se = H ? 32 : 20, ie = a - m - J - 6, re = f + 6;
      n.fillStyle = "rgba(18, 18, 24, 0.88)", n.strokeStyle = "#38384a", n.lineWidth = 1, n.beginPath(), n.roundRect ? n.roundRect(ie, re, J, se, 4) : n.rect(ie, re, J, se), n.fill(), n.stroke(), n.fillStyle = "#e2e8f0", n.fillText(I, ie + 8, re + (H ? 13 : 14)), H && (n.fillStyle = "#94a3b8", n.font = "9.5px system-ui, -apple-system, sans-serif", n.fillText(H, ie + 8, re + 26)), n.restore();
    }
  }
  for (const I of e.root.querySelectorAll("[data-tangent-mode]")) {
    const H = e.selectedKeyframe(), j = H?.tangents?.channels?.[l[0]?.id]?.mode || H?.tangents?.mode || "auto";
    I.classList.toggle("active", I.dataset.tangentMode === j);
  }
  for (const I of e.root.querySelectorAll("[data-channel-filter]"))
    I.classList.toggle("active", I.dataset.channelFilter === (e.curveChannelFilter || "all"));
  for (const I of e.root.querySelectorAll("[data-curve-mode]"))
    I.classList.toggle("active", I.dataset.curveMode === e.selectedKeyframe()?.interpolation);
}
...
function Xd(e) {
  e.checkpoint("Auto-split shots"), e.state.sequence = {
    ...
    enabled: !0,
    cuts: Ri(e.state)
  }, wt(e), e.setStatus(s("Split into {count} shots").replace("{count}", String(e.state.sequence.cuts.length)));
}
...
function Jd(e, t) {
  ...
  if (a.appendChild(bo(
    ...
    () => {
      e.checkpoint("Split shot"), ms(e.state, e.frame, null) ? wt(e) : e.setStatus(s("Move the playhead inside a shot first"));
    },
    { disabled: o }
  )), a.appendChild(bo(
    s("Clear edit"),
    ...
    () => {
      e.checkpoint("Clear edit"), e.state.sequence = { ...e.state.sequence, enabled: !1, cuts: [] }, wt(e), e.setStatus(s("Multi-camera edit cleared"));
    }
  ))), a.appendChild(bo(
...
function Qd(e, t, a, o, r) {
  ...
  e.contextMenu?.show(t, n?.name || s("Shot"), [
    ...e.state.cameras.map((i) => ({
      ...
      run: () => {
        e.checkpoint("Change shot camera"), e.state.sequence.cuts[o].camera_id = i.id, wt(e);
      }
    })),
    null,
    {
      ...
      run: () => {
        e.checkpoint("Split shot"), ms(e.state, e.frame, null) && wt(e);
      }
    },
    {
      label: s("Remove shot"),
      ...
      disabled: r === 1,
      run: () => {
        e.checkpoint("Remove shot"), Fi(e.state, o) && wt(e);
      }
    }
  ]);
}
...
function Ds(e, t) {
  ...
  if (n.className = "oc-sequence-lane", n.dataset.role = "sequence-lane", n.setAttribute("aria-label", s("Multi-camera edit")), o.length)
    for (const [c, l] of o.entries()) {
      ...
      ge(e, l.end + 1) < -5 || p > 105 || n.appendChild(em(e, l, c, r));
    }
  else {
    const c = document.createElement("span");
...
function cm(e) {
  ...
  if (e.audioWaveformPeaks && e.audioWaveformPeaks.length) {
    ...
    const S = x.getContext("2d"), g = e.audioWaveformPeaks, C = x.width, M = x.height, z = M / 2;
    S.fillStyle = "#f2d06b";
    for (let N = 0; N < g.length; N++) {
      const V = (N / (g.length - 1) * r - l) / Math.max(1e-6, c) * C;
      if (V >= -5 && V <= C + 5) {
        const Y = g[N] * (M * 0.85);
        S.fillRect(V, z - Y / 2, Math.max(1, C / g.length * n - 0.5), Y);
      }
    }
    t.appendChild(x);
  }
  if (e.state.playback_range) {
    ...
    const S = ge(e, e.state.playback_range[0]), g = ge(e, e.state.playback_range[1]);
    x.style.left = `${S}%`, x.style.width = `${Math.max(0, g - S)}%`, t.appendChild(x);
  }
  Di(e, t);
  for (const x of e.state.markers || []) {
    const S = ge(e, x.frame);
  ...
  if (o.length > 1) {
    const x = ge(e, o[0].frame), S = ge(e, o[o.length - 1].frame), g = document.createElement("span");
  ...
  for (const x of o) {
    ...
    C.className = "key-label", C.textContent = String(x.frame), g.appendChild(C), g.addEventListener("pointerdown", (M) => {
      if (M.preventDefault(), M.stopPropagation(), g.focus({ preventScroll: !0 }), M.altKey) {
        ...
        const N = a ? { frame: x.frame, transform: We(x.transform), interpolation: x.interpolation } : { frame: x.frame, camera: me(x.camera), interpolation: x.interpolation }, G = e.timelineKeyframes();
        G.push(N), G.sort((V, Y) => V.frame - Y.frame), e.selectedKeyFrame = N.frame, e.selectedKeyFrames = /* @__PURE__ */ new Set([N.frame]), e.keyDrag = { key: N, box: t, isDuplicate: !0, historyCheckpointed: !0, moving: [{ key: N, startFrame: N.frame }], startPointerFrame: x.frame, startClientX: M.clientX, startClientY: M.clientY }, e.setFrame(N.frame, !1, !1), e.setStatus(s(`Duplicating key from ${x.frame}...`));
        return;
      }
      if (M.shiftKey) {
        e.selectedKeyFrames = new Set(e.selectedKeyFrames || [e.selectedKeyFrame].filter((N) => N !== null)), e.selectedKeyFrames.has(x.frame) ? e.selectedKeyFrames.delete(x.frame) : e.selectedKeyFrames.add(x.frame), e.selectedKeyFrame = e.selectedKeyFrames.has(x.frame) ? x.frame : [...e.selectedKeyFrames].at(-1) ?? null, e.setFrame(x.frame, !1, !1), e.updateKeyVisualState(), e.refreshKeyEditor();
        return;
      }
      e.selectedKeyFrames?.has(x.frame) || (e.selectedKeyFrames = /* @__PURE__ */ new Set([x.frame])), e.selectedKeyFrame = x.frame;
      const z = e.timelineKeyframes().filter((N) => e.selectedKeyFrames.has(N.frame));
      e.keyDrag = { key: x, box: t, historyCheckpointed: !1, moving: z.map((N) => ({ key: N, startFrame: N.frame })), startPointerFrame: x.frame, startClientX: M.clientX, startClientY: M.clientY }, e.setFrame(x.frame, !1, !1);
  ...
  return `
    <div class="oc-left-body oc-assets" data-role="assets-tab" hidden>
      <div class="oc-asset-panel" data-role="assets-panel">
        ...
        <p class="oc-asset-status hint">${s("Import GLB/FBX files with the upload action.")}</p>
...
const Ze = 1, kn = 50, $e = 120, pt = 160, Ym = Object.freeze(["perspective", "orthographic"]), B = Object.freeze({
...
}), Ws = Object.freeze(Object.values(B)), ke = Object.freeze({
  SCENE_GET: "scene.get",
...
}), Xm = Object.freeze(Object.values(ke));
...
function ep(e, t) {
  ...
  switch (t?.type) {
    ...
    case ke.CAMERA_GET: {
      ...
      return _e(e, { version: 1, type: t.type, camera: Ye(r) });
    }
    case ke.CAMERA_LIST: {
    ...
    case ke.ASSET_LIST: {
      ...
      return _e(e, { version: 1, type: t.type, items: Ye(r), total: r.length });
    }
    case ke.ASSET_GET: {
...
function ap(e, t) {
  ...
  const a = new Set(e.cameras.map((i) => i.id)), o = Wo(a, "camera", t.id), r = { ...Ir(), ...t.camera || {} }, n = {
    ...
    solo: !1,
    camera: r,
    keyframes: [{ frame: 0, camera: me(r), interpolation: t.interpolation || "ease" }]
  };
...
function up(e, t) {
  const a = [...e.position], o = Array.isArray(t) ? [...t] : [...e.target], r = Le(o, a), n = Be(r) > 1e-9 ? Zo(r) : [0, 0, -1];
  let i = nn(n, Wr);
  Be(i) < 1e-6 && (i = [1, 0, 0]), i = Zo(i);
  const c = Zo(nn(i, n));
...
function jn(e, t, a) {
  const o = a === "out" ? -1 : 1, r = he(e.position, Uo(e.forward, o * t));
  return [
    { position: e.position, target: e.target },
...
function En(e, t, a) {
  ...
  return [
    { position: e.position, target: e.target },
    { position: he(e.position, r), target: he(e.target, r) }
  ];
}
function Cn(e, t, a) {
...
function An(e, t, a) {
  const o = a === "down" ? -1 : 1, r = he(e.position, Uo(Wr, o * t));
  return [
    { position: e.position, target: e.target },
    { position: r, target: e.target }
  ];
...
function go(e, { degrees: t = 180, direction: a = "cw", radius: o, radiusEnd: r, heightOffset: n = 0, samples: i = 5, close: c = !1 } = {}) {
  ...
  for (let g = 0; g < y; g += 1) {
    const C = c ? g / y : g / (y - 1), M = d + v * C, z = h + (b - h) * C;
    S.push({
      position: [l[0] + Math.cos(M) * z, x, l[2] + Math.sin(M) * z],
      target: [...l]
    });
  }
  return S;
...
function Sp(e, t) {
  ...
  if (e.position !== void 0 && ve(e.position, "camera.position", t), e.target !== void 0 && ve(e.target, "camera.target", t), e.up !== void 0 && ve(e.up, "camera.up", t), e.fov !== void 0 && (vt(e.fov, "camera.fov", t), e.fov < 1 || e.fov > 179))
    throw new O("BAD_VALUE", "camera.fov must be within 1..179", t);
  if (e.roll !== void 0 && vt(e.roll, "camera.roll", t), e.zoom !== void 0 && (vt(e.zoom, "camera.zoom", t), e.zoom <= 0))
    throw new O("BAD_VALUE", "camera.zoom must be > 0", t);
  if (e.near !== void 0 && (vt(e.near, "camera.near", t), e.near <= 0))
    throw new O("BAD_VALUE", "camera.near must be > 0", t);
  if (e.far !== void 0) {
    vt(e.far, "camera.far", t);
...
function _p(e, t) {
  ...
  switch (a) {
    case B.ASSET_INSTANTIATE: {
      ...
      e.point !== void 0 && ve(e.point, "point", t), e.id !== void 0 && ee(e.id, "id", t);
      break;
    }
    ...
    case B.CAMERA_CREATE:
      if (e.id !== void 0 && ee(e.id, "id", t, $e), e.name !== void 0 && ee(e.name, "name", t, pt), e.camera !== void 0) {
    ...
    case B.CAMERA_DUPLICATE:
      ee(e.cameraId, "cameraId", t, $e), e.id !== void 0 && ee(e.id, "id", t, $e), e.name !== void 0 && ee(e.name, "name", t, pt);
      break;
    case B.CAMERA_DELETE:
    case B.CAMERA_SET_PLAYBLAST:
      ee(e.cameraId, "cameraId", t, $e);
      break;
    case B.CAMERA_RENAME:
      ee(e.cameraId, "cameraId", t, $e), ee(e.name, "name", t, pt);
      break;
    case B.OBJECT_CREATE:
      ...
      e.id !== void 0 && ee(e.id, "id", t, $e), e.name !== void 0 && ee(e.name, "name", t, pt), e.position !== void 0 && ve(e.position, "position", t), e.rotation !== void 0 && ve(e.rotation, "rotation", t);
      break;
    case B.OBJECT_DUPLICATE:
      ee(e.objectId, "objectId", t, $e), e.id !== void 0 && ee(e.id, "id", t, $e), e.name !== void 0 && ee(e.name, "name", t, pt), e.offset !== void 0 && ve(e.offset, "offset", t);
      break;
    case B.OBJECT_DELETE:
      ee(e.objectId, "objectId", t, $e);
      break;
    case B.OBJECT_RENAME:
      ee(e.objectId, "objectId", t, $e), ee(e.name, "name", t, pt);
      break;
    case B.OBJECT_SET_PARENT:
      ee(e.objectId, "objectId", t, $e), e.parentId !== null && e.parentId !== void 0 && ee(e.parentId, "parentId", t, $e);
      break;
    case B.CAMERA_TRANSFORM:
      if (e.cameraId !== void 0 && ee(e.cameraId, "cameraId", t), e.position !== void 0 && ve(e.position, "position", t), e.target !== void 0 && ve(e.target, "target", t), e.frame !== void 0 && Ce(e.frame, "frame", t), e.position === void 0 && e.target === void 0)
        throw new O("EMPTY_OPERATION", "camera.transform needs position and/or target", t);
      break;
    case B.CAMERA_LOOK_AT:
      if (e.cameraId !== void 0 && ee(e.cameraId, "cameraId", t), e.point !== void 0 && ve(e.point, "point", t), e.objectId !== void 0 && e.objectId !== null && ee(e.objectId, "objectId", t), e.point === void 0 && e.objectId === void 0)
        throw new O("EMPTY_OPERATION", "camera.look_at needs a point or an objectId", t);
      break;
    case B.OBJECT_TRANSFORM:
      if (ee(e.objectId, "objectId", t), e.position !== void 0 && ve(e.position, "position", t), e.rotation !== void 0 && ve(e.rotation, "rotation", t), e.scale !== void 0 && ve(e.scale, "scale", t), e.position === void 0 && e.rotation === void 0 && e.scale === void 0)
    ...
    case B.KEYFRAME_UPSERT:
      if (e.cameraId !== void 0 && ee(e.cameraId, "cameraId", t), Ce(e.frame, "frame", t), e.interpolation !== void 0 && !Ao.includes(e.interpolation))
        throw new O("BAD_INTERPOLATION", `Unsupported interpolation: ${e.interpolation}`, t);
      if (e.camera !== void 0) {
        if (!e.camera || typeof e.camera != "object")
          throw new O("BAD_VALUE", "keyframe.upsert camera must be an object", t);
        e.camera.position !== void 0 && ve(e.camera.position, "camera.position", t), e.camera.target !== void 0 && ve(e.camera.target, "camera.target", t);
    ...
    case B.KEYFRAME_REMOVE:
      e.cameraId !== void 0 && ee(e.cameraId, "cameraId", t), Ce(e.frame, "frame", t);
      break;
    case B.KEYFRAME_SET_INTERPOLATION:
      if (e.cameraId !== void 0 && ee(e.cameraId, "cameraId", t), Ce(e.frame, "frame", t), !Ao.includes(e.interpolation))
        throw new O("BAD_INTERPOLATION", `Unsupported interpolation: ${e.interpolation}`, t);
      break;
    case B.TIMELINE_SET_RANGE:
      if (Ce(e.start, "start", t), Ce(e.end, "end", t), e.end < e.start)
    ...
    case B.TIMELINE_SET_DURATION:
      ...
      break;
    case B.CUT_UPSERT:
      Ce(e.start, "start", t), ee(e.cameraId, "cameraId", t);
      break;
    case B.CUT_REMOVE:
      Ce(e.start, "start", t);
      break;
    ...
    case B.CAMERA_PATH_TRANSFORM_KEYS: {
      ...
      o.mode === "translate" ? ve(o.delta, "transform.delta", t) : o.mode === "scale" ? ve(o.factors, "transform.factors", t) : ve(o.rotationDeg, "transform.rotationDeg", t), o.origin !== void 0 && ve(o.origin, "transform.origin", t);
      break;
    }
    case B.CAMERA_PATH_INSERT_KEY:
      e.cameraId !== void 0 && ee(e.cameraId, "cameraId", t), Ce(e.leftFrame, "leftFrame", t), Ce(e.rightFrame, "rightFrame", t), e.t !== void 0 && vt(e.t, "t", t);
      break;
    case B.CAMERA_PATH_DELETE_KEYS:
      e.cameraId !== void 0 && ee(e.cameraId, "cameraId", t), Tn(e.frames, "frames", t);
      break;
    case B.CAMERA_PATH_REDISTRIBUTE_TIMING:
      e.cameraId !== void 0 && ee(e.cameraId, "cameraId", t), e.startFrame !== void 0 && Ce(e.startFrame, "startFrame", t), e.endFrame !== void 0 && Ce(e.endFrame, "endFrame", t);
      break;
    case B.CAMERA_PATH_APPLY_PRESET:
      ...
      if (Ce(e.startFrame, "startFrame", t), Ce(e.endFrame, "endFrame", t), e.endFrame <= e.startFrame)
        throw new O("BAD_RANGE", "camera.path.apply_preset endFrame must be after startFrame", t);
      if (e.target !== void 0 && ve(e.target, "target", t), e.params !== void 0 && (typeof e.params != "object" || Array.isArray(e.params)))
...
function gr(e, t, a) {
  const o = ze(e), r = t ? ze(t) : o, n = a ? ze(a) : o, i = Math.max(br, Ae(e?.frame) - Ae(t?.frame, Ae(e?.frame) - 1)), c = Math.max(br, Ae(a?.frame, Ae(e?.frame) + 1) - Ae(e?.frame)), l = [0, 0, 0], p = [0, 0, 0];
  for (let m = 0; m < 3; m += 1) {
...
function Ys(e, t, a) {
  const o = ze(e), r = t ? ze(t) : o, n = a ? ze(a) : o;
  return {
    out: Lo(kt(n, o), 1 / 3),
    in: Lo(kt(r, o), 1 / 3)
  };
...
function Xs(e, t, a) {
  const o = ze(e), r = vr(e, t, a);
  ct(e, "out", kt(r.out, o)), ct(e, "in", kt(r.in, o));
}
...
function Np(e, t, { prevKey: a = null, nextKey: o = null } = {}) {
  ...
  if (t === "corner") {
    const r = Ys(e, a, o);
    return No(e), ct(e, "out", r.out), ct(e, "in", r.in), e;
  }
...
function Vp(e, t, a, o, r) {
  const n = ut(e, t, r), i = ut(t, a, r), c = ut(a, o, r), l = ut(n, i, r), p = ut(i, c, r), m = ut(l, p, r);
...
function Qs(e, { leftFrame: t, rightFrame: a, t: o = 0.5 } = {}) {
  ...
  const m = (p - t) / (a - t), f = r[n], d = r[i], h = n > 0 ? r[n - 1] : null, b = i + 1 < r.length ? r[i + 1] : null, u = f.interpolation === "bezier" || d.interpolation === "bezier", v = Te({ keyframes: r }, p), y = { frame: p, interpolation: u ? "bezier" : f.interpolation, camera: v };
  if (u) {
    const S = [...f.camera.position], g = vr(f, h, d).out, C = vr(d, f, b).in, M = [...d.camera.position], z = Vp(S, g, C, M, m);
    y.camera = { ...me(v), position: [...z.point] };
    const N = it(f);
    (N === "free" || N === "aligned") && vo(f, "out", z.left[1]);
    const G = it(d);
    (G === "free" || G === "aligned") && vo(d, "in", z.right[2]), vo(y, "in", z.left[2]), vo(y, "out", z.right[1]);
  }
...
const Kt = T.viewport | T.previews | T.timeline | T.inspector;
function On(e, t, a) {
...
const Yp = {
  ...
  [B.CAMERA_TRANSFORM](e, t) {
    const a = Pe(e, t.cameraId), o = or(a);
  ...
  [B.OBJECT_SET_ENABLED](e, t) {
    return rt(e, t.objectId).enabled = t.value, { dirtyMask: T.viewport | T.previews | T.outliner | T.inspector };
  },
  [B.OBJECT_SET_LOCKED](e, t) {
    return wr(e, t.objectId).locked = t.value, { dirtyMask: T.outliner | T.inspector };
  },
  [B.OBJECT_SET_TAGS](e, t) {
    const a = rt(e, t.objectId), o = Ui(t.tags), r = o.length !== t.tags.length ? "some tags were dropped or normalised" : void 0;
    return o.length ? a.tags = o : delete a.tags, { dirtyMask: T.outliner | T.inspector | T.viewport, warning: r };
  },
  [B.OBJECT_SET_ANNOTATION](e, t) {
    const a = rt(e, t.objectId), o = t.annotation === null ? null : hs(t.annotation);
    if (t.annotation && !o)
  ...
  [B.KEYFRAME_REMOVE](e, t) {
    const a = Pe(e, t.cameraId), o = (a.keyframes || []).length;
  ...
  [B.KEYFRAME_SET_INTERPOLATION](e, t) {
    const a = Pe(e, t.cameraId), o = wo(a, t.frame);
  ...
  [B.CAMERA_PATH_TRANSFORM_KEYS](e, t) {
    ...
    return Dt(e, a, n), { dirtyMask: Kt };
  },
  [B.CAMERA_PATH_INSERT_KEY](e, t) {
    const a = Pe(e, t.cameraId), o = Qs(a.keyframes || [], {
    ...
    return Dt(e, a, o.keys), { dirtyMask: Kt, outcome: { frame: o.frame } };
  },
  [B.CAMERA_PATH_DELETE_KEYS](e, t) {
    ...
    return Dt(e, a, o.keys), { dirtyMask: Kt, outcome: { removed: o.removed } };
  },
  [B.CAMERA_PATH_REDISTRIBUTE_TIMING](e, t) {
    const a = Pe(e, t.cameraId), o = [...a.keyframes || []].sort((c, l) => c.frame - l.frame), r = Number.isInteger(t.startFrame) ? t.startFrame : o[0]?.frame, n = Number.isInteger(t.endFrame) ? t.endFrame : o[o.length - 1]?.frame, i = ps(o, { startFrame: r, endFrame: n });
    if (!i.ok) {
    ...
    return Dt(e, a, i.keys), { dirtyMask: Kt };
  },
  [B.CAMERA_PATH_APPLY_PRESET](e, t) {
    const a = Pe(e, t.cameraId), o = or(a), r = Hs({
      type: t.presetType,
      camera: o,
      target: t.target,
    ...
    return Dt(e, a, r.keyframes), { dirtyMask: Kt };
  }
};
...
function ef(e, t, a) {
  const o = Qe(e?.cameras), r = Qe(t?.cameras);
...
function of(e, t, a) {
  const o = Qe(e?.objects), r = Qe(t?.objects);
  for (const [n, i] of r) {
...
function lf(e) {
  ...
  return t ? (e.state.keyframes = t.keyframes, e.state.camera = me(t.camera), e.camera = me(t.camera), t) : null;
}
function df(e, t) {
  t && (e.camera = Te(
    t,
...
const Pn = "omnicam-agent/1", Ln = "majoor.omnicam.agent.request", bf = 1, Bt = Object.freeze({
...
function kf(e, t, a) {
  ...
  async function d() {
    ...
    try {
      const C = await qt(a, Bt.register, {
        protocol: Pn,
        client_id: g,
        node_id: String(t.id),
  ...
  async function v(S) {
    ...
    try {
      if (g.kind === "query")
        ...
        const M = g.payload, z = (M?.operations || []).find(
          (N) => !Nn.includes(N?.type)
        );
        if (!Number.isInteger(M?.baseRevision) || M.baseRevision < 0)
          ...
          C = Ut(
            ...
            `External Agent transactions cannot use operation: ${z?.type}`
          );
        else {
          const N = await xf(e, M.operations);
          N.ok ? (C = e.directorApi.execute({ ...M, operations: N.operations }), await C?._reconciliation) : C = Ut(e, N.code, N.message);
        }
      } else
        C = Ut(e, "UNKNOWN_AGENT_REQUEST", `Unsupported Agent request kind: ${g.kind}`);
    } catch (M) {
      C = Ut(e, M?.code || "INTERNAL", M?.message || "OmniCam Agent request failed");
    }
    try {
      await qt(a, Bt.reply, {
        session_id: r,
  ...
  return a.addEventListener?.(Ln, v), a.addEventListener?.("status", x), d(), {
    ...
    dispose() {
      ...
      const S = r, g = n;
      r = null, n = null, S && g && qt(a, Bt.close, {
        session_id: S,
        session_token: g
      }).catch(() => {
      });
...
const Ne = "/majoor/omnicam/library";
function Sf(e, t) {
...
function Yr({ fetchApi: e = Sf } = {}) {
  ...
  return {
    list(a = {}) {
      ...
      return o && o !== "all" && (l.kind = o), t(`${Ne}${Fn(l)}`);
    },
    get(a) {
      return t(`${Ne}/${encodeURIComponent(a)}`);
    },
    register(a) {
      return t(`${Ne}/register`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(a)
      });
    ...
    remove(a) {
      return t(`${Ne}/${encodeURIComponent(a)}`, { method: "DELETE" });
    },
    importModel(a, o = {}) {
      const r = new FormData();
      return r.append("file", a, o.filename || a.name || "model.glb"), t(`${Ne}/import${Fn(o)}`, { method: "POST", body: r });
    },
    uploadThumbnail(a, o, r = "thumb.webp") {
      const n = new FormData();
      return n.append("file", o, r), t(`${Ne}/thumbnail/${encodeURIComponent(a)}`, {
        method: "POST",
        body: n
      });
    },
    ...
    deletePose(a) {
      return t(`${Ne}/poses/${encodeURIComponent(a)}`, { method: "DELETE" });
    }
  };
}
...
function Pf(e, t = {}) {
  return ai.map((a) => {
    ...
    return `<button type="button" class="oc-asset-kind${a === (e || "all") ? " active" : ""}" data-asset-kind="${a}">${xt(o)}${r}</button>`;
  }).join("");
}
function Lf(e, { selected: t = !1, thumbUrl: a = "" } = {}) {
  const o = If[e.kind] || "pi-box", r = e.kind === "character" && us(e.rig) === "rigged" ? `<span class="oc-asset-badge">${s("RIGGED")}</span>` : "", n = a ? `<img class="oc-asset-thumb" src="${xt(a)}" alt="" loading="lazy">` : `<span class="oc-asset-thumb oc-asset-thumb--glyph"><i class="pi ${o}"></i></span>`;
  return `<button type="button" class="oc-asset-card${t ? " selected" : ""}" data-asset-id="${xt(e.id)}" title="${xt(e.name)}">
    ${n}
    <span class="oc-asset-name">${xt(e.name)}</span>
    <span class="oc-asset-kind-tag">${xt((e.kind || "").toUpperCase())}</span>
    ${r}
  </button>`;
}
...
function Ff(e, t = {}) {
  const a = e.root, o = t.fetchApi || ((D, X) => (e.api || e.app?.api).fetchApi(D, X)), r = t.apiClient || Yr({ fetchApi: o }), n = t.store || Ef(r), i = Cf(), c = t.previewQueue || Af(), l = e.api || e.app?.api || null;
  let p = t.thumbnailRenderer || null, m = null;
  const f = /* @__PURE__ */ new Set();
  function d() {
    return p ? Promise.resolve(p) : (m || (m = Mf().then((D) => p = Rn(D)).catch(() => p = Rn({}))), m);
  }
  function h(D) {
    return sn(l, Gs(D));
  }
  function b(D) {
    return D.thumbnail ? sn(l, `omnicam/library/${D.thumbnail} [input]`) : "";
  }
  function u() {
    for (const D of n.state.items) {
      if (D.kind === "helper" || !D.file || i.get(D.id) || D.thumbnail || f.has(D.id)) continue;
      const X = h(D);
      X && c.enqueue(D.id, async () => {
        const fe = await (await d()).render(X, D.format || "glb");
        if (!fe) {
          f.add(D.id);
          return;
        }
        if (i.set(D.id, fe), U(), !(D.source && D.source !== "user"))
          try {
            const be = await r.uploadThumbnail(D.id, $f(fe));
  ...
  const v = (D) => a.querySelector(`[data-role="${D}"]`), y = v("assets-panel"), x = v("asset-grid"), S = v("asset-kinds"), g = v("asset-search"), C = v("asset-status"), M = v("asset-import-file"), z = v("scene-tab"), N = v("assets-tab"), G = v("agent-tab"), V = a.querySelector('[data-asset-view="agent"]'), Y = { assets: N, agent: G };
  let oe = "", k = null, E = !0, F = !0, q = "scene", W = 0;
  function I(D, { sticky: X = !1 } = {}) {
    C && (!X && W > Date.now() || (C.textContent = D || "", W = X ? Date.now() + 9e3 : 0));
  }
  function H(D) {
    if (oe = D, !!x)
      for (const X of x.querySelectorAll(".oc-asset-card"))
        X.classList.toggle("selected", X.dataset.assetId === D);
  }
  let j = !1;
  function U() {
    if (S && (S.innerHTML = Pf(n.state.filter.kind, n.state.kinds)), x) {
      const D = {};
      for (const X of n.state.items) {
        const pe = i.get(X.id) || b(X);
        pe && (D[X.id] = pe);
      }
      x.innerHTML = Nf(n.state.items, { selectedId: oe, thumbUrls: D });
    }
    if (!j) {
      j = !0;
      try {
    ...
    n.state.error ? I(n.state.error.message) : n.state.loading ? I(s("Loading assets...")) : I(s("{n} of {total} assets").replace("{n}", n.state.items.length).replace("{total}", n.state.total));
  }
  function J(D) {
    if (!D) return;
    const X = Op({
    ...
    }), pe = e.directorApi?.execute({
      version: 1,
      id: `tx_instantiate_${Date.now().toString(36)}`,
      description: s("Add asset"),
      operations: [{ type: "asset.instantiate", asset: D, point: X }]
    });
    if (!pe?.ok) {
      e.setStatus?.(pe?.error?.message || s("Could not add the asset"));
      return;
    }
    const fe = pe.outcomes?.[0]?.objectId;
    fe && (e.selectedEntity = "object", e.selectedObjectId = fe, e.selectedObjectIds = /* @__PURE__ */ new Set([fe]), e.selectedKeyFrame = null), e.restoreAssets?.(), e.refreshObjects?.(), e.refreshInspector?.(), e.render?.(), e.setStatus?.(s("{name} added").replace("{name}", D.name));
  }
  async function se(D) {
    if (D) {
      I(s("Importing {name}...").replace("{name}", D.name));
      try {
        const X = await r.importModel(D, { kind: "prop", name: D.name.replace(/\.[^.]+$/, "") });
        X.asset && n.upsert(X.asset), I(s("Imported {name}").replace("{name}", X.asset?.name || D.name));
      } catch (X) {
        I(X.message || s("Import failed"));
      }
    }
  }
  function ie(D) {
    D === "agent" && !mr() && (D = "scene"), q = D, z && (z.hidden = D !== "scene");
    for (const [X, pe] of Object.entries(Y))
      pe && (pe.hidden = X !== D);
    for (const X of a.querySelectorAll("[data-asset-view]"))
      X.classList.toggle("active", X.dataset.assetView === D);
    D === "assets" && E && (E = !1, n.refresh()), D === "agent" && F && (F = !1, t.onAgentFirstOpen?.());
  }
  function re() {
    const D = mr();
    V && (V.hidden = !D), !D && q === "agent" && ie("scene");
  }
  function de(D) {
    const X = Dn(D.target);
    if (X) {
      if (X.action === "switch-view") return ie(X.view);
      if (X.action === "filter-kind") return void n.setFilter({ kind: X.kind });
      if (X.action === "asset-add")
        return J(n.get(oe));
      if (X.action === "asset-import")
        return M?.click();
      X.action === "card" && H(X.assetId);
    }
  }
  function ye(D) {
    const X = Dn(D.target);
    X?.action === "card" && J(n.get(X.assetId));
  }
  function ue() {
    clearTimeout(k), k = setTimeout(() => n.setFilter({ search: g.value }), 200);
  }
  function xe(D) {
    const X = D.target.files?.[0];
    D.target.value = "", se(X);
  }
  const we = n.subscribe(U);
  return y?.addEventListener("click", de), y?.addEventListener("dblclick", ye), a.querySelector('[data-role="left-tabs"]')?.addEventListener("click", de), g?.addEventListener("input", ue), M?.addEventListener("change", xe), U(), re(), {
    store: n,
    switchView: ie,
    syncAgentAvailability: re,
    refresh: () => n.refresh(),
    dispose() {
      we(), clearTimeout(k), y?.removeEventListener("click", de), y?.removeEventListener("dblclick", ye), a.querySelector('[data-role="left-tabs"]')?.removeEventListener("click", de), g?.removeEventListener("input", ue), M?.removeEventListener("change", xe), c.clear(), p?.dispose?.(), i.clear();
    }
  };
}
function zf(e, t = {}) {
...
function Uf(e, t = {}) {
  ...
  function S() {
    ...
    l && (l.textContent = k);
    const F = h(), q = y(F?.character)[k] || [0, 0, 0, 1], W = Hi(q);
    p.forEach((I, H) => {
      I && document.activeElement !== I && (I.value = String(Math.round(W[H] * 100) / 100));
    });
  }
  function g() {
    ...
    if (i && (i.classList.toggle("active", f), i.disabled = E, i.title = E ? s("Clear the motion clip to edit the pose") : s("Toggle FK pose editing")), n) {
      const F = [["neutral", s("Standing Neutral")]].concat([...d.values()].filter((W) => W.id !== "neutral").map((W) => [W.id, W.name || W.id])), q = F.map((W) => W.join(":")).join("|");
      n.dataset.sig !== q && (n.dataset.sig = q, n.replaceChildren(...F.map(([W, I]) => {
        const H = document.createElement("option");
        return H.value = W, H.textContent = I, H;
  ...
  function M() {
    const k = u();
    if (!k) return;
    const E = p.map((W) => Number(W?.value) || 0), F = Wi(E), q = e.directorApi?.execute({
      version: 1,
      id: `tx_pose_${Date.now().toString(36)}`,
      description: "Pose joint",
      operations: [{ type: "character.set_joint_rotation", objectId: m, joint: k, rotation: F }]
    });
  ...
  async function N() {
    ...
    const E = (await Xt(e, s("Save Pose"), s("Pose name"), ""))?.trim();
    if (!E || e.disposed) return;
    const F = E.toLowerCase().replace(qf, "-").replace(/^-+|-+$/g, "").slice(0, 60) || "pose";
    try {
      ...
      d.set(q.pose.id, v(q.pose)), e.setStatus?.(s("Pose saved: {name}").replace("{name}", E)), g();
    } catch (q) {
  ...
  function oe() {
    ...
    if (r.hidden = !E, !E) {
      f && (f = !1), m = null, Y.update();
      return;
    }
    k.id !== m && (m = k.id, f = !1, e.subSelection?.type === "character_joint" && (e.subSelection = null), d.size || C()), g(), Y.update();
  }
  n?.addEventListener("change", z), i?.addEventListener("click", G), r.querySelector('[data-pose-act="save"]')?.addEventListener("click", N);
  for (const k of p)
  ...
  return C(), {
    ...
    dispose() {
      Y.dispose(), n?.removeEventListener("change", z), i?.removeEventListener("click", G);
      for (const k of p)
...
function oi(e) {
  return {
    ...
    frames: De(e, "frame"),
    scrubs: De(e, "scrub"),
    cameraFov: De(e, "camera-fov"),
    cameraRoll: De(e, "camera-roll"),
    cameraFocal: De(e, "camera-focal"),
    viewportZoom: De(e, "viewport-zoom"),
    cameraType: De(e, "camera-type"),
    cameraNear: De(e, "camera-near"),
    cameraFar: De(e, "camera-far")
  };
}
const Vf = /* @__PURE__ */ new Set(["translate", "rotate", "scale"]), Hf = /* @__PURE__ */ new Set(["world", "local"]), Ke = 180 / Math.PI;
function qn(e) {
  return [e.x, e.y, e.z];
}
function Gf(e) {
  return [e.x * Ke, e.y * Ke, e.z * Ke];
}
function Yf({
  THREE: e,
  camera: t,
  ...
  function C(j) {
    ...
    const U = j.rotationDeg.map((J, se) => {
  ...
  f.addEventListener?.("mouseDown", M), f.addEventListener?.("objectChange", z), f.addEventListener?.("mouseUp", N), f.addEventListener?.("dragging-changed", G);
  function V(j) {
    h = j, m.position.set(...j.position || [0, 0, 0]);
    const U = j.rotation || [0, 0, 0];
    m.rotation.set(U[0] / Ke, U[1] / Ke, U[2] / Ke), m.scale.set(...j.scale || [1, 1, 1]), f.attach(m), f.visible = !0;
  }
  function Y() {
  ...
  function H() {
    f.removeEventListener?.("mouseDown", M), f.removeEventListener?.("objectChange", z), f.removeEventListener?.("mouseUp", N), f.removeEventListener?.("dragging-changed", G), o?.remove && d && o.remove(d), o?.remove && o.remove(m), f.dispose?.(), h = null, b = null;
  }
  return {
    attach: V,
    detach: Y,
...
function Jf(e, { controlsFactory: t, anchorFactory: a } = {}) {
  ...
  function h({ targetSpec: k }) {
    if (k) {
      if (l(c), k.type === "object") {
        ...
        const E = Yi(e), F = (E.length ? E : [k.object]).map((W) => ({
          object: W,
          transform: We(W)
        }));
        for (const W of F) e.beginObjectEdit(W.object);
        const q = F.reduce((W, I) => he(W, I.transform.position), [0, 0, 0]).map((W) => W / F.length);
        r = { type: "object", group: F, pivot: q };
        return;
      }
      if (k.type === "camera") {
      ...
      if (k.type === "camera_target") {
        ...
        const E = e.activeCameraTrack?.(), F = !!E?.target_object_id;
        r = {
          type: "camera_target",
          tracking: F,
          base: F ? [...E.target_offset || [0, 0, 0]] : [...e.camera.target]
        };
        return;
      }
      if (k.type === "camera_path") {
        ...
        e.checkpoint("Transform camera path"), r = {
          ...
          baseKeys: E.keyframes.map((F) => ({ ...F, camera: me(F.camera) }))
        };
        return;
      }
      if (k.type === "path_point" || k.type === "path_group") {
        ...
        const F = k.type === "path_point" ? [k.frame] : k.frames;
        e.checkpoint(k.type === "path_point" ? "Transform path point" : "Transform path selection"), r = {
          type: k.type,
          trackId: E.id,
          origin: k.position,
          selectedFrames: new Set(F),
          baseKeys: E.keyframes.map((q) => ({ ...q, camera: me(q.camera) })),
  ...
  function u(k) {
    k.id === e.state.active_camera_id && (e.state.keyframes = k.keyframes), e.camera = Te(k, e.frame, e.state.objects), k.camera = me(e.camera), e.refreshKeys();
  }
  function v(k) {
    const E = e.state.cameras.find((F) => F.id === r.trackId);
    E && (E.keyframes = ws(r.baseKeys, b(k)), u(E));
  }
  function y(k) {
    const E = e.state.cameras.find((q) => q.id === r.trackId);
    if (!E) return;
    const F = { ...b(k), lookAtActive: r.lookAtActive };
    E.keyframes = fs(r.baseKeys, r.selectedFrames, F), u(E);
  }
  function x(k) {
    const E = e.state.cameras.find((F) => F.id === r.trackId);
  ...
  function g(k) {
    const { group: E, pivot: F } = r, q = e.state.gizmo_mode;
    for (const W of E)
      if (q === "translate")
        W.object.position = he(W.transform.position, k.position);
      else if (q === "rotate")
        W.object.position = he(F, dn(Le(W.transform.position, F), k.rotationDeg)), W.object.rotation = he(W.transform.rotation, k.rotationDeg);
      else if (q === "scale") {
        const I = Le(W.transform.position, F);
        W.object.position = he(F, I.map((H, j) => H * k.scaleFactors[j])), W.object.size = W.transform.size.map((H, j) => Math.max(0.01, H * k.scaleFactors[j]));
      }
    for (const W of E) e.commitObjectEdit(W.object);
  }
  function C(k) {
    if (e.state.gizmo_mode === "translate")
      e.camera.position = he(r.position, k.position);
    else {
      const E = Le(r.target, r.position);
      e.camera.target = he(r.position, dn(E, k.rotationDeg));
    }
    e.commitCameraEdit();
  }
  function M(k) {
    const E = he(r.base, k.position);
    r.tracking ? Xi(e, E) : e.camera.target = E, e.commitCameraEdit();
  }
  function z({ cancelled: k }) {
    if (!r) return;
    const E = r.type;
  ...
  function N() {
    ...
    const k = e.recording ? null : Gi(e), E = e.state.gizmo_mode || "translate", F = !!k && !k.readOnly && Xf.has(k.type) && k.allowedModes.includes(E);
    if (i = F ? k.type : null, !F) {
      o?.detach();
      return;
    }
  ...
  return { sync: N, isPointerOverHandle: G, cancelDrag: V, currentLiveType: Y, dispose: oe };
}
function Zf(e, t) {
...
function Qf(e, t) {
  ...
  (!a.keyframes || a.keyframes.length === 0) && (a.keyframes = [
    { frame: 0, camera: me(e.camera), interpolation: "smooth" },
    { frame: e.state.duration_frames - 1, camera: me(e.camera), interpolation: "smooth" }
  ]);
...
const Un = ["#4aa3ef", "#f2a93b", "#48c774", "#b565d8", "#ec4899"], Xe = [4, 8, 12, 20, 35, 60, 100];
function _t(e) {
...
function Ho(e, t, a) {
  ...
  const o = _t(e), r = o.expanded ? 220 : 138, n = Math.min(r, Math.max(80, Math.min(t, a) - 20)), i = 10, c = Math.max(0, t - n - i), l = Math.max(0, a - n - i), p = e.viewportCamera(), m = p?.position || [0, 1.5, 5], f = p?.target || [0, 0, 0], d = e.activeCameraTrack?.(), h = e.state.cameras?.length ? e.state.cameras : d ? [d] : [], b = h.flatMap(
    (C) => (C.keyframes || []).map((M) => M.camera?.position).filter(Boolean)
  );
  let u = 12;
  if (o.rangeIndex >= 0 && o.rangeIndex < Xe.length)
    u = Xe[o.rangeIndex];
  else {
    const C = Math.max(
      Math.abs(m[0] || 0),
...
function rh(e, t, a, o) {
  const r = Ho(e, a, o);
  if (!r) return;
  const { rx: n, ry: i, radarSize: c, cx: l, cy: p, innerRadius: m, range: f, scale: d, camPos: h, camTgt: b, cameras: u, activeTrack: v } = r, y = _t(e), x = e.state.active_camera_id || v?.id, S = (re, de) => ri(r, re, de);
  ...
  for (const re of e.state.objects || []) {
    ...
    const de = Fr(e.state.objects, re).position || [0, 0, 0], [ye, ue] = S(de[0], de[2]);
    if (ye < n + 3 || ye > n + c - 3 || ue < i + 3 || ue > i + c - 3) continue;
    const xe = e.selectedObjectId === re.id || e.selectedObjectIds?.has?.(re.id);
    if (t.save(), t.translate(ye, ue), re.type === "card") {
      const we = (re.rotation?.[1] || 0) * Math.PI / 180;
      t.rotate(-we), t.fillStyle = xe ? "#a855f7" : "#38bdf8", t.fillRect(-4, -1.2, 8, 2.4), t.strokeStyle = xe ? "#ffffff" : "rgba(255,255,255,0.6)", t.lineWidth = 1, t.strokeRect(-4, -1.2, 8, 2.4);
      ...
      for (let we = 0; we < 4; we++) {
        const D = we * Math.PI / 2;
        t.beginPath(), t.moveTo(Math.cos(D) * 4, Math.sin(D) * 4), t.lineTo(Math.cos(D) * 6, Math.sin(D) * 6), t.stroke();
      }
    } else
      t.fillStyle = xe ? "#a855f7" : re.type === "human" ? "#ec4899" : "#f59e0b", t.beginPath(), t.arc(0, 0, 2.8, 0, Math.PI * 2), t.fill();
  ...
  for (let re = 0; re < u.length; re++) {
    const de = u[re], ye = de.keyframes || [], ue = de.id === x, xe = de.color || Un[re % Un.length];
    t.save(), t.strokeStyle = xe, t.globalAlpha = ue ? 0.95 : 0.4, t.lineWidth = ue ? 2 : 1, t.setLineDash(ue ? [] : [2, 2]), t.beginPath();
    let we = !1;
    const D = ye[0]?.frame, X = ye[ye.length - 1]?.frame;
    for (let pe = D; Number.isFinite(pe) && pe <= X; pe++) {
      const fe = Te(de, pe, e.state.objects)?.position;
      if (!Array.isArray(fe)) continue;
      const [be, ce] = S(fe[0], fe[2]);
      we ? t.lineTo(be, ce) : (t.moveTo(be, ce), we = !0);
    }
    we && t.stroke(), t.restore(), t.save();
    for (const pe of ye) {
      const fe = pe.camera?.position;
      if (!fe) continue;
      const [be, ce] = S(fe[0], fe[2]);
      if (be < n + 4 || be > n + c - 4 || ce < i + 4 || ce > i + c - 4) continue;
      const Me = pe.frame === e.frame && ue;
      t.fillStyle = Me ? "#ffffff" : xe, t.globalAlpha = ue ? 0.95 : 0.6, t.beginPath(), t.moveTo(be, ce - 3), t.lineTo(be + 3, ce), t.lineTo(be, ce + 3), t.lineTo(be - 3, ce), t.closePath(), t.fill(), Me && (t.strokeStyle = "#00d2d3", t.lineWidth = 1.2, t.stroke());
    }
    t.restore();
  }
  const [M, z] = S(h[0] || 0, h[2] || 0), [N, G] = S(b[0] || 0, b[2] || 0), V = 8, Y = te(M, n + V, n + c - V), oe = te(z, i + V, i + c - V), k = te(N, n + V, n + c - V), E = te(G, i + V, i + c - V), F = h[1] || 0, q = ah(F), W = oh(F);
  t.strokeStyle = "rgba(255, 255, 255, 0.40)", t.lineWidth = 1, t.setLineDash([3, 3]), t.beginPath(), t.moveTo(Y, oe), t.lineTo(k, E), t.stroke(), t.setLineDash([]), t.fillStyle = "#ffffff", t.beginPath(), t.arc(k, E, 2.5, 0, Math.PI * 2), t.fill(), t.strokeStyle = "rgba(255, 255, 255, 0.7)", t.lineWidth = 1, t.beginPath(), t.arc(k, E, 4.5, 0, Math.PI * 2), t.stroke();
  const I = b[0] - h[0], H = b[2] - h[2], j = Math.atan2(H, I), J = (e.viewportCamera().fov || 35) * Math.PI / 360, se = te(24 * (d / (m / 8)), 16, 38), ie = t.createRadialGradient(Y, oe, 2, Y, oe, se);
  ie.addColorStop(0, q + "55"), ie.addColorStop(1, q + "08"), t.fillStyle = ie, t.strokeStyle = q, t.lineWidth = 1.2, t.beginPath(), t.moveTo(Y, oe), t.lineTo(Y + Math.cos(j - J) * se, oe + Math.sin(j - J) * se), t.arc(Y, oe, se, j - J, j + J), t.closePath(), t.fill(), t.stroke(), t.fillStyle = q + "44", t.beginPath(), t.arc(Y, oe, 6.5, 0, Math.PI * 2), t.fill(), t.fillStyle = q, t.beginPath(), t.arc(Y, oe, 3.5, 0, Math.PI * 2), t.fill(), t.strokeStyle = "#ffffff", t.lineWidth = 1.5, t.beginPath(), t.moveTo(Y, oe), t.lineTo(Y + Math.cos(j) * 7, oe + Math.sin(j) * 7), t.stroke(), nh(e, t, r, q, W, j, Math.hypot(I, H)), y.hover && sh(t, r, y.hover), t.restore();
}
function nh(e, t, a, o, r, n, i) {
  const { rx: c, ry: l, radarSize: p } = a, m = _t(e);
...
function ih(e, t, a, o) {
  ...
  if (a < n || a > n + c || o < i || o > i + c)
    return !1;
  t.preventDefault?.(), t.stopPropagation?.();
  const l = _t(e), p = ni(r, a, o);
  if (p)
    return p === "zoom_in" ? (l.rangeIndex === -1 && (l.rangeIndex = Xe.findIndex((h) => h >= r.range), l.rangeIndex < 0 && (l.rangeIndex = Xe.length - 1)), l.rangeIndex = Math.max(0, (l.rangeIndex === -1 ? 2 : l.rangeIndex) - 1)) : p === "zoom_out" ? (l.rangeIndex === -1 && (l.rangeIndex = Xe.findIndex((h) => h >= r.range), l.rangeIndex < 0 && (l.rangeIndex = 0)), l.rangeIndex = Math.min(Xe.length - 1, l.rangeIndex + 1)) : p === "center" ? l.centerMode = l.centerMode === "camera" ? "origin" : "camera" : p === "size" && (l.expanded = !l.expanded), e.render?.(), !0;
  const m = si(e, r, a, o);
  if (m) {
    if (m.type === "camera")
...
function ch(e, t, a, o) {
  ...
  const r = Ho(e, e.canvas.width, e.canvas.height);
  if (!r) return !1;
  const n = _t(e), { rx: i, ry: c, radarSize: l } = r, p = a >= i && a <= i + l && o >= c && o <= c + l;
  if (n.drag) {
...
function lh(e, t, a, o) {
  ...
  if (a < n || a > n + c || o < i || o > i + c)
    return !1;
  t.preventDefault?.(), t.stopPropagation?.();
  const l = _t(e), p = Math.sign(t.deltaY || 0);
  return l.rangeIndex === -1 && (l.rangeIndex = Xe.findIndex((m) => m >= r.range), l.rangeIndex < 0 && (l.rangeIndex = 2)), p > 0 ? l.rangeIndex = Math.min(Xe.length - 1, l.rangeIndex + 1) : p < 0 && (l.rangeIndex = Math.max(0, l.rangeIndex - 1)), e.render?.(), !0;
}
function dh(e, t, a) {
...
function ii(e) {
  ...
  if (m)
    if (o?.target && Array.isArray(o.target) && Array.isArray(o.position)) {
      const b = Be(Le(o.position, o.target));
...
const So = () => import("./chunk-C6Ts4Ovx.js");
function Kh(e, t) {
...
function Zh(e, t, a) {
  ...
  for (const n of e.root.querySelectorAll('[data-role="viewport-bg-color"]')) {
    const i = (c) => {
      e.state.viewport_bg_color !== c.target.value && _o(e, "viewport_bg_color", "Change background colour"), e.state.viewport_bg_color = c.target.value, je(e.root, "viewport-bg-color", c.target), e.scheduleSerialize(), e.render();
    };
    n.addEventListener("input", i, { signal: a }), n.addEventListener("change", i, { signal: a });
  }
...
function cu(e) {
  ...
  for (let d = m; d < i.length; d++) {
    const h = i[d], b = su(i, d, p, e.planeAxis), u = me(c);
...
function Jn(e, t = {}) {
  ...
  const a = t.mode === "extend" ? "extend" : "new", o = e.activeCameraTrack?.(), r = me(e.camera || o?.camera);
...
function qe(e) {
  ...
  return t?.active ? (mi(e, t), e.cameraPathDraw = null, Gt(e), e.setStatus?.(s("Draw Camera Path cancelled")), e.render?.(), !0) : !1;
}
function du(e) {
  const t = e.cameraPathDraw;
...
function pu(e, t) {
  const a = e.cameraPathDraw;
  return a?.active ? t.button === 2 && !t.altKey ? (Ro(t), e.cameraPathSuppressContextMenuUntil = Date.now() + 1e3, qe(e), !0) : t.button !== 0 || t.altKey || t.ctrlKey || t.metaKey || t.shiftKey ? !1 : (Ro(t), e.closeMenus?.(), e.interactionElement.focus?.({ preventScroll: !0 }), e.interactionElement.setPointerCapture?.(t.pointerId), a.drawing = !0, a.pointerId = t.pointerId, a.points = [], Qr(e, en(e, t)), Gt(e), e.requestRender?.("camera-path-draw"), !0) : !1;
}
function fu(e, t) {
  const a = e.cameraPathDraw;
...
function hu(e, t) {
  const a = e.cameraPathDraw;
  return !a?.active || !a.drawing || a.pointerId !== t.pointerId ? !1 : (Ro(t), t.type === "pointercancel" || t.type === "lostpointercapture" ? (qe(e), !0) : (Qr(e, en(e, t)), a.drawing = !1, du(e), !0));
}
function uu(e) {
  const t = e.cameraPathDraw;
  ...
  if (!o.length) return;
  const r = o.map((c) => Ue(c, a, e.canvas.width, e.canvas.height)).filter((c) => c && Number.isFinite(c[0]) && Number.isFinite(c[1]));
  if (!r.length) return;
...
function bu(e, t) {
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? qe(e) : Jn(e);
    }, { signal: t });
  for (const a of e.root.querySelectorAll('[data-act="draw-camera-path-extend"]'))
    a.addEventListener("click", () => {
      e.cameraPathDraw?.active ? qe(e) : Jn(e, { mode: "extend" });
    }, { signal: t });
...
async function gu(e) {
  await Jt(e, s("New Scene"), s("Start a new scene? Unsaved changes will be lost.")) && tn(e, ks(), { name: "", status: s("New scene") });
}
async function yu(e) {
  if (!e.sceneBaseline) {
...
async function vu(e) {
  const t = pi(e) || s("Untitled"), a = await Xt(e, s("Save Scene"), s("Scene name"), t);
  if (a == null) return;
...
function Cu(e) {
  ...
  for (const v of e.state.motion_layers || []) {
    ...
    if (c.strokeStyle = S ? "#ffcc4d" : "rgba(65,217,197,0.6)", c.lineWidth = (S ? 2.4 : 1.5) * r, c.beginPath(), x.forEach((C, M) => {
      const z = p(C.x), N = m(C.y);
      M ? c.lineTo(z, N) : c.moveTo(z, N);
    }), c.stroke(), !y) {
...
const st = 1024 * 1024, Ou = Object.freeze({
  card: 128 * st,
  // MAX_CARD_BYTES
  model: 256 * st,
  // MAX_MODEL_BYTES
...
function ts(e) {
  return `${(e / st).toFixed(e >= 10 * st ? 0 : 1)} MB`;
}
function Zt(e, t) {
  const a = Ou[t];
  if (!e || !a) return null;
...
const bi = /* @__PURE__ */ new WeakSet(), Vt = /* @__PURE__ */ new WeakMap();
function Ko(e) {
...
function et(e, t, a, o = !1, r = "") {
  ...
  n && n !== a && Qt(e, t), o && bi.add(a), Du(a), e.cardMediaAssetById ||= /* @__PURE__ */ new Map(), e.cardMediaById.set(t, a), e.cardMediaAssetById.set(t, r || a?.__omnicamAsset || "");
  try {
    a.__omnicamAsset = r || a.__omnicamAsset || "";
  } catch {
  }
...
async function qu(e, t) {
  if (!St?.fetchApi || !/\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/i.test(e)) return null;
  const a = await St.fetchApi("/majoor/omnicam/extractor/source", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
...
function Uu(e) {
  ...
  if (e.state.viewport_bg_image) {
    const o = new Image();
    o.src = Je(e.state.viewport_bg_image), o.decode().catch(() => {
    }), e.viewportBgImage = o;
  }
  e.viewportBgSequenceImages = (e.state.viewport_bg_sequence || []).map((o) => {
    const r = new Image();
    return r.src = Je(o), r.decode().catch(() => {
    }), r;
  });
...
async function Vu(e, t) {
  ...
  try {
    const c = await Ur(St, { route: "/majoor/omnicam/upload_model", field: "asset", file: t });
...
async function Hu(e, t) {
  ...
  if (o) {
    ...
    try {
      const r = await Ur(St, { route: "/majoor/omnicam/upload_asset", field: "asset", file: t });
...
function Yu(e) {
  ...
  const a = new Image();
  a.onload = () => {
    e.disposed || (et(e, "subject", a, !1, a.src), e.render(), e.setStatus(s("Upstream media refreshed")));
  }, a.src = St.apiURL(`/view?${new URLSearchParams(t).toString()}`);
}
async function Xu(e) {
  if (!e.node) return;
  ...
  for (const f of i) {
    ...
    if (h) {
      if (d === "image" || d === "video") {
        ...
        if (b && b.value) {
          const u = String(b.value), v = /\.(mp4|mov|webm|mkv|m4v|avi)(?:\s|$)/i.test(u), y = h.widgets?.find((g) => String(g.name).toLowerCase() === "subfolder")?.value || "", x = Je(bt(u, y)), S = e.state.objects.find((g) => g.id === "subject");
          if (S) {
          ...
          }), et(e, "subject", u, !1, u.currentSrc || u.src || ""), Qn(e, u, { frameCount: u instanceof HTMLVideoElement ? 0 : 1 }), e.upstreamImageConnected = !0, n = !0, e.render(), e.setStatus(u instanceof HTMLVideoElement ? s("Upstream video preview synced") : s("Upstream image preview synced")));
        }
      }
      if (d === "audio") {
        l = !0;
        ...
        if (b && b.value) {
          const u = String(b.value), v = h.widgets?.find((x) => String(x.name).toLowerCase() === "subfolder")?.value || "", y = Je(bt(u, v));
          try {
      ...
      if (d === "scene_3d" || d === "model" || d === "mesh") {
        ...
        if (b && b.value) {
          ...
          if (["glb", "gltf", "obj", "fbx", "stl", "ply"].includes(v)) {
            const y = h.widgets?.find((C) => String(C.name).toLowerCase() === "subfolder")?.value || "", x = Je(bt(u, y)), S = `upstream_scene_${h.id}`;
            p.add(S);
            let g = e.state.objects.find((C) => C.id === S);
            g ? (g.asset = bt(u, y), g.format = v === "gltf" ? "glb" : v) : (g = {
              id: S,
              type: "model",
              format: v === "gltf" ? "glb" : v,
...
async function ob(e) {
  ...
  try {
    let n = null;
    const i = e.root.querySelector('[data-role="encoder"]').value, { encodeDeterministicPlayblast: c, supportsDeterministicEncoding: l } = await import("./chunk-DXmNf8Y1.js");
...
async function ki(e) {
  ...
  return Ur(Yt, { route: "/majoor/omnicam/upload_asset", field: "asset", file: e });
}
async function Bo(e) {
...
async function sb(e, t) {
  ...
  try {
    ...
    e.checkpoint?.("Set background sequence"), e.state.viewport_bg_sequence = i, e.state.viewport_bg_image = "", e.viewportBgImage = null, e.viewportBgSequenceImages = i.map((c) => {
      const l = new Image();
      return l.src = Je(c), l.decode().catch(() => {
      }), l;
...
function cb(e) {
  ...
  for (const m of a) {
    ...
    if (!f) continue;
    const d = ys(a, m, l) || { position: m.position, size: m.size }, h = Ue(vs(d, m.type), o, n, i);
    if (!h) continue;
    const [b, u] = h, v = t.content === "annotation" && m.annotation?.color || "", y = 6 * c, x = 4 * c, g = r.measureText(f).width + y * 2, C = 12 * c + x * 2, M = Math.round(b - g / 2), z = Math.round(u - C - 6 * c);
    r.fillStyle = "rgba(16,17,22,0.82)", lb(r, M, z, g, C, 4 * c), r.fill(), v && (r.strokeStyle = v, r.lineWidth = Math.max(1, c), r.stroke()), r.fillStyle = v || "#e6e6ec", r.fillText(f, M + y, z + C - x - 2 * c);
  }
  r.restore();
}
...
function le(e, t, a, o = "#5a5a5a", r = 1) {
  const n = e.viewportCamera(), i = Ue(t, n, e.canvas.width, e.canvas.height), c = Ue(a, n, e.canvas.width, e.canvas.height);
...
function db(e) {
  for (let t = -60; t <= 60; t += 1) {
    ...
    le(e, [t, 0, -60], [t, 0, 60], o, a ? 1.6 : 1), le(e, [-60, 0, t], [60, 0, t], o, a ? 1.6 : 1);
  }
}
function mb(e) {
...
function fb(e) {
  ...
  for (let p = 0; p < t.length; p += c) {
    const m = Ue([t[p], t[p + 1], t[p + 2]], o, r, n);
    if (!m) continue;
...
function hb(e, t) {
  ...
  for (const [m, f] of p) le(e, l[m], l[f], "#a0a0a0", 1.4);
}
function ub(e, t) {
  ...
  for (let c = 0; c < 3; c++) {
    ...
    for (let p = 0; p <= 32; p++) {
      ...
      let f;
      c === 0 ? f = [o + Math.cos(m) * i, r + Math.sin(m) * i, n] : c === 1 ? f = [o + Math.cos(m) * i, r, n + Math.sin(m) * i] : f = [o, r + Math.cos(m) * i, n + Math.sin(m) * i], l && le(e, l, f, "#999", 1), l = f;
    }
  }
}
function bb(e, t) {
  ...
  le(e, c, l, "#aaa", 2), le(e, l, u, "#aaa", 2), le(e, p, m, "#aaa", 2), le(e, p, f, "#aaa", 2), le(e, f, h, "#aaa", 2), le(e, m, d, "#aaa", 2), le(e, d, b, "#aaa", 2), le(e, v, y, "#aaa", 2), le(e, v, x, "#aaa", 2), le(e, x, g, "#aaa", 2), le(e, y, S, "#aaa", 2), le(e, S, C, "#aaa", 2);
  const M = Ue(c, e.viewportCamera(), e.canvas.width, e.canvas.height);
...
function gb(e, t) {
  ...
  for (let b = 0; b < f; b++) {
    const u = (b + 1) % f;
    le(e, d[b], d[u], "#aaa", 1.5), le(e, h[b], h[u], "#aaa", 1.5);
  }
  for (let b = 0; b < f; b += 3)
    le(e, d[b], h[b], "#aaa", 1.5);
}
function yb(e, t) {
  ...
  for (let h = 0; h < m; h++) {
    const b = (h + 1) % m;
    le(e, f[h], f[b], "#aaa", 1.5), le(e, d[h], d[b], "#aaa", 1.5), h % 4 === 0 && le(e, f[h], d[h], "#888", 1);
  }
}
function vb(e, t) {
  const a = t.position || [0, 1, 0], o = 0.25;
  le(e, he(a, [-o, 0, 0]), he(a, [o, 0, 0]), "#bbb", 2), le(e, he(a, [0, -o, 0]), he(a, [0, o, 0]), "#bbb", 2), le(e, he(a, [0, 0, -o]), he(a, [0, 0, o]), "#bbb", 2);
}
function xb(e, t) {
  const [a, o, r] = t.position || [0, 1.5, 0], [n, i] = t.size || [2, 3], c = e.viewportCamera(), l = [
    ...
    [a + n / 2, o + i / 2, r],
    [a - n / 2, o + i / 2, r]
  ].map((v) => Ue(v, c, e.canvas.width, e.canvas.height));
  ...
  if (u)
    try {
      ...
      if (e.ctx.fillStyle = "#111", e.ctx.fillRect(f, h, v, y), g === "stretch" || !x || !S)
        ...
        const C = Math.min(v / x, y / S), M = x * C, z = S * C;
        e.ctx.drawImage(u, f + (v - M) / 2, h + (y - z) / 2, M, z);
      } else {
        const C = Math.max(v / x, y / S), M = v / C, z = y / C;
        e.ctx.drawImage(u, (x - M) / 2, (S - z) / 2, M, z, f, h, v, y);
      }
    } catch {
    }
  else
    ...
    if (!(i && e.state.view_mode === "camera")) {
      if (r.length >= 2)
        for (let c = 0; c < r.length - 1; c++)
          le(e, r[c].camera.position, r[c + 1].camera.position, n, i ? 2.2 : 1.2);
      for (const c of r) {
        const l = Ue(c.camera.position, e.viewportCamera(), e.canvas.width, e.canvas.height);
      ...
      if (e.state.view_mode !== "camera") {
        const c = Te(a, e.frame, e.state.objects), l = Ue(c.position, e.viewportCamera(), e.canvas.width, e.canvas.height);
        l && (e.ctx.fillStyle = i ? "#f2d06b" : n, e.ctx.beginPath(), e.ctx.arc(l[0], l[1], i ? 6.5 : 4.5, 0, Math.PI * 2), e.ctx.fill()), c.target && le(e, c.position, c.target, `${n}88`, 1);
      }
    }
  });
}
function kb(e) {
  ...
  for (let o = 0; o < e.state.keyframes.length - 1; o++) {
    ...
    t.push(Be(Le(n.camera.position, r.camera.position)) * e.state.fps / Math.max(1, n.frame - r.frame));
  }
  const a = Math.max(...t, 1e-6);
  for (let o = 0; o < t.length; o++) {
    const r = 120 * (1 - t[o] / a);
    le(e, e.state.keyframes[o].camera.position, e.state.keyframes[o + 1].camera.position, `hsl(${r} 85% 55%)`, 5);
  }
}
function Sb(e) {
...
function Lb(e, t, a) {
  const o = Be(Le(t.camera.position, e.camera.position)), r = t.frame - e.frame, n = r / a, i = n > 1e-9 ? o / n : 1 / 0;
...
function Fb({ keys: e, fps: t = 24, objects: a = [] } = {}) {
  ...
  for (let c = 1; c < o.length - 1; c += 1) {
    const l = Le(o[c].camera.position, o[c - 1].camera.position), p = Le(o[c + 1].camera.position, o[c].camera.position), m = Be(l), f = Be(p);
  ...
  if (Array.isArray(a) && a.length)
    for (const c of o)
      for (const l of a) {
        ...
        Be(Le(c.camera.position, l.position)) < p + Ob && r.push({
    ...
    if (t.appendChild(h), !b)
      for (const u of d) {
        ...
        if (C.className = "scene-item-label", S || y) {
          const N = document.createElement("span");
          N.style.cssText = `color:${S ? "#f59e0b" : "#58cc6b"};font-weight:700`, N.textContent = S ? "● " : "○ ", C.appendChild(N);
        }
        if (C.appendChild(document.createTextNode(u.name)), x) {
          const N = document.createElement("span");
          N.style.cssText = "color:#f2d06b;font-size:10px", N.title = "Playblast Output", N.textContent = " ★", C.appendChild(N);
        }
        if (u.muted) {
          const N = document.createElement("span");
          N.style.opacity = ".6", N.textContent = " (muted)", C.appendChild(N);
        }
        const M = document.createElement("div");
        ...
        )), M.appendChild(r("pi-ellipsis-v", "Camera actions", !1, (N) => e.openCameraContext(N, u.id, !1))), v.append(g, C, M), v.title = S ? s("Currently selected for editing") : x ? s("Active playblast camera") : s("Click to select & activate this camera");
        const z = () => {
        ...
        v.addEventListener("contextmenu", (N) => {
          N.preventDefault(), N.stopPropagation(), e.openCameraContext(N, u.id, !1);
        }), v.addEventListener("keydown", (N) => {
          (N.key === "Enter" || N.key === " ") && (N.preventDefault(), z());
        }), t.appendChild(v);
      }
  }
  if (m) {
    ...
    if (t.appendChild(x), !S)
      for (const { object: g, level: C } of y) {
        ...
        const z = e.selectedEntity === "object" && (g.id === e.selectedObjectId || e.selectedObjectIds?.has?.(g.id)), N = e.selectedEntity === "object" && g.id === e.selectedObjectId;
        M.setAttribute("aria-selected", String(z)), M.className = `scene-item${z ? " selected" : ""}${N ? " primary" : ""}${C > 0 && !n ? " scene-item-child" : ""}`, C > 0 && !n && (M.style.paddingLeft = `${C * 16 + 6}px`);
        const G = g.type === "card" ? { icon: "pi-image", color: "#38bdf8" } : g.type === "model" || g.type === "glb" ? { icon: "pi-box", color: "#c084fc" } : g.type === "ground" ? { icon: "pi-minus", color: "#fbbf24" } : g.type === "cube" ? { icon: "pi-stop", color: "#fbbf24" } : g.type === "sphere" ? { icon: "pi-circle", color: "#fbbf24" } : g.type === "cylinder" ? { icon: "pi-database", color: "#fbbf24" } : g.type === "torus" ? { icon: "pi-circle", color: "#fbbf24" } : g.type === "pyramid" ? { icon: "pi-play", color: "#fbbf24" } : g.type === "sun_light" ? { icon: "pi-sun", color: "#f59e0b" } : g.type === "point_light" ? { icon: "pi-bolt", color: "#fbbf24" } : g.type === "spot_light" ? { icon: "pi-compass", color: "#38bdf8" } : g.type === "human" ? { icon: "pi-user", color: "#34d399" } : { icon: "pi-plus", color: "#94a3b8" }, V = g.enabled !== !1, Y = !!g.load_error, oe = document.createElement("i");
        oe.className = `pi ${Y ? "pi-exclamation-triangle" : G.icon}`, oe.style.cssText = Y ? "color:#f87171" : V ? `color:${G.color}` : "opacity:.4";
        const k = document.createElement("span");
        k.className = "scene-item-label";
        const E = document.createElement("span");
        E.style.cssText = Y ? "color:#fca5a5" : V ? "" : "opacity:.5;text-decoration:line-through", E.textContent = g.name || g.type, E.title = s("Double-click to rename"), E.addEventListener("dblclick", (I) => {
          I.preventDefault(), I.stopPropagation(), qb(e, g, E);
        }), k.appendChild(E);
        const F = Array.isArray(g.tags) ? g.tags : [];
        if (F.length) {
          const I = document.createElement("span");
          I.className = "scene-item-tags";
          for (const H of F.slice(0, 2)) {
            const j = document.createElement("span");
            j.className = "scene-item-tag", j.textContent = H, I.appendChild(j);
          }
          if (F.length > 2) {
            const H = document.createElement("span");
            H.className = "scene-item-tag scene-item-tag-more", H.textContent = `+${F.length - 2}`, I.appendChild(H);
          }
          k.appendChild(I);
        }
        if (Y) {
          const I = document.createElement("span");
          I.style.cssText = "color:#ef4444;font-size:9px;font-weight:700", I.textContent = " [Format!]", k.appendChild(I);
        }
        const q = document.createElement("div");
        q.className = "scene-item-actions", q.appendChild(r(V ? "pi-eye" : "pi-eye-slash", V ? "Hide object (Alt+Click to Isolate)" : "Show object (Alt+Click to Isolate)", !V, (I) => {
          if (I?.altKey) {
            if (e.checkpoint("Isolate object"), e._isolatedObjectId === g.id) {
              ...
              for (const U of e.state.objects)
                U.enabled = j && Object.prototype.hasOwnProperty.call(j, U.id) ? j[U.id] : !0;
            ...
            e.toggleObject(g.id);
        }, "color:#ef4444;opacity:.7")), q.appendChild(r(g.locked ? "pi-lock" : "pi-lock-open", "Lock object", g.locked, () => Jr(e, g))), q.appendChild(r("pi-copy", "Duplicate object", !1, () => e.duplicateObject?.(g.id))), g.id !== "subject" && q.appendChild(r("pi-trash", "Delete object", !1, () => e.deleteObject?.(g.id))), q.appendChild(r("pi-ellipsis-v", "Object actions", !1, (I) => e.openObjectContext(I, g.id))), M.append(oe, k, q), M.title = s("Click to select · Double-click to toggle visibility · Right-click for actions");
        const W = (I = {}) => {
          if (I.altKey && g.id !== "subject") return void e.deleteObject(g.id);
          if (e.finishCameraEdit(), e.selectedEntity = "object", e.selectedObjectIds ||= /* @__PURE__ */ new Set(), I.ctrlKey || I.metaKey)
            e.selectedObjectIds.has(g.id) ? e.selectedObjectIds.delete(g.id) : e.selectedObjectIds.add(g.id), e.outlinerAnchorId = g.id;
          else if (I.shiftKey && e.outlinerAnchorId && e.state.objects.some((j) => j.id === e.outlinerAnchorId)) {
            const j = e.state.objects.map((se) => se.id), U = j.indexOf(e.outlinerAnchorId), J = j.indexOf(g.id);
            e.selectedObjectIds = new Set(j.slice(Math.min(U, J), Math.max(U, J) + 1));
          } else
          ...
          for (const j of t.querySelectorAll(".scene-item")) {
            const U = !!(j.dataset.objectId && e.selectedObjectIds.has(j.dataset.objectId)), J = !!(j.dataset.objectId && j.dataset.objectId === e.selectedObjectId);
            j.classList.toggle("selected", U), j.classList.toggle("primary", J), j.dataset.objectId && j.setAttribute("aria-selected", String(U));
          }
          const H = e.root.querySelector('[data-role="outliner-batch-bar"]');
          if (H) {
            const j = e.selectedObjectIds?.size || 0;
            H.hidden = j < 2;
            const U = H.querySelector('[data-role="batch-count"]');
            U && (U.textContent = `${j} ${s("selected")}`);
          }
          e.refreshKeys(), e.refreshInspector(), e.render(), e.setStatus(s(`Selected: ${g.name || g.type}`));
        };
        M.addEventListener("dblclick", () => e.toggleObject(g.id)), M.addEventListener("contextmenu", (I) => {
          I.preventDefault(), I.stopPropagation(), e.openObjectContext(I, g.id);
        }), M.addEventListener("keydown", (I) => {
          (I.key === "Enter" || I.key === " ") && (I.preventDefault(), W(I));
        }), t.appendChild(M);
      }
  }
...
function Ei(e, t) {
  ...
  o.id = `${a.type}_${Date.now().toString(36)}_${Math.random().toString(36).slice(2, 6)}`, o.name = `${a.name || a.type} Copy`, o.position = he(o.position || [0, 0, 0], [0.35, 0, 0.35]), (o.type === "model" || o.type === "glb") && e.modelUrlsById.has(a.id) ? e.modelUrlsById.set(o.id, e.modelUrlsById.get(a.id)) : o.type === "card" && e.cardMediaById.has(a.id) && et(e, o.id, e.cardMediaById.get(a.id), !1, o.asset || e.cardMediaAssetById?.get?.(a.id) || ""), e.state.objects.push(o), e.selectedEntity = "object", e.selectedObjectId = o.id, e.selectedObjectIds = /* @__PURE__ */ new Set([o.id]), e.serialize(), e.refreshObjects(), e.refreshKeys(), e.render(), e.setStatus(s(`${o.name} added`));
}
function Vb(e, t) {
  const a = e.state.objects.find((o) => o.id === t);
...
function Yb(e) {
  ...
  if (n) {
    const k = r.target_object_id || e.state.target_object_id || "", E = `T${mn()}${e.state.objects.map((F) => `${F.id}\0${F.name || F.type}`).join("|")}`;
    lr(n, E, () => [
      Wt("", s("Manual Target (No Tracking)")),
      ...e.state.objects.map((F) => Wt(F.id, `${s("Track:")} ${F.name || F.type}`))
    ], k);
  }
  Bb(e);
  ...
  ["camera-px", "camera-py", "camera-pz", "camera-tx", "camera-ty", "camera-tz", "camera-fov", "camera-roll", "camera-near", "camera-far", "camera-rx", "camera-ry", "camera-rz"].forEach((k, E) => {
    for (const F of e.root.querySelectorAll(`[data-role="${k}"]`))
      document.activeElement !== F && (F.value = String(Math.round(i[E] * 1e4) / 1e4));
  });
  ...
  for (const [k, E] of Object.entries(h))
    for (const F of e.root.querySelectorAll(`[data-role="${k}"]`))
      document.activeElement !== F && (F.value = String(Math.round(E * 1e4) / 1e4));
  ...
  if (v) {
    ...
    for (; F; ) {
      ...
      for (const I of e.state.objects)
        !E.has(I.id) && I.parent_id && E.has(I.parent_id) && (E.add(I.id), F = !0);
    }
    const q = e.state.objects.filter((I) => !E.has(I.id)), W = `P${mn()}${k}${q.map((I) => `${I.id} ${I.name || I.type}`).join("|")}`;
    lr(v, W, () => [
      Wt("", s("No parent")),
      ...q.map((I) => Wt(I.id, I.name || I.type))
    ], t.parent_id || "");
  }
  ...
  M && (M.hidden = y);
  const z = o('[data-role="rotation-row"]');
  if (z && (z.hidden = t.type === "point_light"), y) {
    ...
    if (E && (E.checked = t.cast_shadow !== !1), x) {
      const F = o('[data-role="object-cone-angle"]');
      F && document.activeElement !== F && (F.value = String(t.cone_angle ?? 45));
      const q = o('[data-role="object-penumbra"]');
      q && document.activeElement !== q && (q.value = String(t.penumbra ?? 0.25));
    }
  }
  const N = e.modelInfoById.get(t.id);
  if (b && (b.hidden = !N?.animations), u) {
    const k = N?.animationNames || [];
    lr(u, `A${k.join("|")}`, () => k.map((E, F) => Wt(String(F), E)), String(t.animation_index || 0));
  }
  ...
  const Y = o('[data-role="object-annotation-color"]');
  Y && document.activeElement !== Y && (Y.value = t.annotation?.color || "#8d7ee8");
...
function rg(e) {
  ...
  return t.forEach((o, r) => {
    ...
    const c = 0.35 + r * 0.15;
    i.position = he(i.position || [0, 0, 0], [c, 0, c]), (i.type === "model" || i.type === "glb") && e.modelUrlsById.has(n.id) ? e.modelUrlsById.set(i.id, e.modelUrlsById.get(n.id)) : i.type === "card" && e.cardMediaById.has(n.id) && et(e, i.id, e.cardMediaById.get(n.id), !1, i.asset || e.cardMediaAssetById?.get?.(n.id) || ""), e.state.objects.push(i), a.push(i.id);
...
function Ee(e) {
  return Ie(e)?.keyframes || e.state.keyframes;
}
function dg(e, t) {
...
function mg(e) {
  ...
  const t = e.root.querySelector('[data-role="key-interp"]')?.value || e.root.querySelector('[data-role="interp"]')?.value || "ease", a = Ie(e), o = Ee(e), r = a ? { frame: e.frame, transform: We(a), interpolation: t } : { frame: e.frame, camera: me(e.camera), interpolation: t }, n = o.findIndex((i) => i.frame === e.frame);
...
function fg(e) {
  ...
  const o = Ve(e) || a.find((i) => i.frame === e.frame);
...
function hg(e) {
  const t = Ie(e), a = Ve(e) || Ee(e).find((o) => o.frame === e.frame);
  e.copiedKeyframe = t ? { kind: "object", transform: We(a?.transform || t), interpolation: a?.interpolation || e.root.querySelector('[data-role="interp"]')?.value || "ease" } : { kind: "camera", camera: me(a?.camera || e.camera), interpolation: a?.interpolation || e.root.querySelector('[data-role="interp"]')?.value || "ease" }, e.setStatus(s(`Keyframe copied @ ${a?.frame ?? e.frame}`));
}
function ug(e) {
  if (!e.copiedKeyframe) return e.setStatus(s("Copy a keyframe first"));
  const t = Ie(e), a = t ? "object" : "camera";
  if (e.copiedKeyframe.kind !== a) return e.setStatus(s(`Copy a ${a} keyframe first`));
  e.checkpoint("Paste keyframe");
  const o = t ? { frame: e.frame, transform: We(e.copiedKeyframe.transform), interpolation: e.copiedKeyframe.interpolation } : { frame: e.frame, camera: me(e.copiedKeyframe.camera), interpolation: e.copiedKeyframe.interpolation }, r = Ee(e), n = r.findIndex((i) => i.frame === e.frame);
  n >= 0 ? r[n] = o : r.push(o), r.sort((i, c) => i.frame - c.frame), e.selectedKeyFrame = o.frame, e.editingKeyFrame = null, t ? (t.position = [...o.transform.position], t.rotation = [...o.transform.rotation], t.size = [...o.transform.size]) : e.camera = me(o.camera), e.serialize(), e.refreshKeys(), e.render(), e.setStatus(s(`Keyframe pasted @ ${o.frame}`));
}
function Ve(e) {
  return Ee(e).find((t) => t.frame === e.selectedKeyFrame) || null;
}
function bg(e, t) {
  t && (e.selectedKeyFrame = t.frame, e.selectedKeyFrames = /* @__PURE__ */ new Set([t.frame]), e.editingKeyFrame = null, Ie(e) || (e.pathSelection = nl(e.pathSelection, { cameraId: e.state.active_camera_id, frame: t.frame, additive: !1 })), e.setFrame(t.frame));
}
function gg(e) {
...
function Cg(e) {
  const t = Ie(e), a = Ve(e), o = e.root.querySelector('[data-role="key-editor"]');
...
function Tg(e) {
  const t = Ve(e);
  if (!t) return;
  if (e.checkpoint("Edit keyframe"), e.editingKeyFrame = t.frame, Ie(e)) {
    t.interpolation = e.root.querySelector('[data-role="key-interp"]').value, t.transform = We(Ie(e)), e.serialize(), e.setFrame(t.frame), e.setStatus(s(`Object keyframe updated @ ${t.frame}`));
    return;
  }
  const a = (r, n) => {
  ...
  e.camera = me(t.camera), e.frame = t.frame, e.serialize(), e.setFrame(t.frame), e.setStatus(s(`Keyframe updated @ ${t.frame}`));
}
function Mg(e) {
  const t = Ve(e);
...
function Pg(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: b, syncActiveCameraTrack: u, syncFromWidgets: v, bindEditorEvents: y, activateCamera: x, addCamera: S, deleteCamera: g, drawPreviewOverlays: C, duplicateCamera: M, maximizeCameraPreview: z, refreshCameraPreviews: N, refreshCameraSelectors: G, renameCamera: V, setPlayblastCamera: Y, toggleCameraView: oe, captureRealtime: k, makePlayblast: E, uploadDirectorPlayblast: F, waitForMediaFrame: q, computeAudioPeaks: W, loadAudioFile: I, releaseAudio: H, stopPlay: j, togglePlay: U, applyCameraPreset: J, applyCameraShake: se, applyProxyPreset: ie, clearViewportBgImage: re, loadViewportBgFile: de, loadViewportBgSequence: ye, drawCameraPath: ue, drawCard: xe, drawCube: we, drawGrid: D, drawHuman: X, drawLine3D: pe, drawNull: fe, drawOverlays: be, drawPointField: ce, drawSpeedHeatmap: Me, drawSphere: ta, curveChannels: aa, drawCurveEditor: jt, onCurvePointerDown: Et, onCurvePointerMove: Ct, onCurvePointerUp: At, onTimelinePointerDown: oa, onTimelinePointerMove: ra, onTimelinePointerUp: na, refreshKeys: Tt, resetCurveZoom: Mt, resetTimelineZoom: dt, setChannelFilter: $t, setCurveInterpolation: It, setTangentMode: Ot, timelineFrameFromEvent: sa, toggleCurveHandles: Pt, zoomCurve: ia, drawTransformGizmo: ca, frameTarget: la, gizmoAxes: da, gizmoGeometry: ma, onPointerDown: pa, onPointerMove: fa, onPointerUp: ha, onWheel: ua, pickGizmo: ba, pickSceneObject: ga, resetCamera: Lt, setTransformMode: Nt, setViewMode: ya, viewportCamera: va, loadCardFile: Go, loadExecutionPreview: Yo, loadMediaUrl: xa, loadModelFile: wa, loadSelectedReference: ka, onModelLoaded: Sa, restoreAssets: _a, syncUpstreamInputs: ja, configureDomMedia: Ea, refreshSetupDiagnostic: Ft, addMediaCard: Ca, addPrimitive: Aa, applyObjectAnimationFrame: Ta, beginCameraEdit: Ma, beginObjectEdit: $a, commitCameraEdit: Ia, commitObjectEdit: Oa, copyKeyframe: Pa, deleteKeyframe: La, deleteObject: Na, duplicateObject: Fa, exitKeyEdit: za, finishCameraEdit: Ra, goToAdjacentKey: Da, insertKeyframe: Ka, loadSelectedKeyView: Ba, pasteKeyframe: qa, playblastCameraAtFrame: Ua, refreshInspector: Wa, refreshKeyEditor: Va, refreshObjects: Ha, removeObjectResources: Ga, renameObject: Ya, retimeSelectedKey: Xa, selectKeyframe: Ja, selectedKeyframe: Za, selectedObject: Qa, selectObjectAnimation: eo, setKeyInterpolation: to, setObjectParent: ao, timelineKeyframes: oo, timelineObject: at, toggleAutoKey: ro, toggleObject: no, updateCameraFromHud: so, updateEditState: io, updateKeyVisualState: co, updateSelectedKey: lo, updateSelectedObject: mo, clamp: zt, cloneCamera: po, configureCore: fo, defaultCamera: ho, sampleCamera: He, sampleObjectTransform: Xo, sanitizeState: mt, worldTransform: Oe } = e;
  return {
    setSelectMode(L) {
      if (["object", "vertex", "edge", "face"].includes(L)) {
        ...
        for (const P of this.root.querySelectorAll("[data-select-mode]")) {
          const _ = P.dataset.selectMode === L;
    ...
    hideInternalWidgets() {
      for (const L of ["state_json", "recording_path", "card_asset"]) {
        const P = this.node.widgets?.find((_) => _.name === L);
    ...
    restoreHistorySnapshot(L) {
      ...
      this.state = mt(P.state);
      const A = new Set(this.state.objects.map((Q) => Q.id));
      for (const Q of w) A.has(Q) || this.removeObjectResources(Q);
      this.frame = zt(P.frame, 0, this.state.duration_frames - 1);
      const $ = new Set(this.state.objects.map((Q) => Q.id)), K = Array.isArray(P.selectedObjectIds) ? P.selectedObjectIds : [P.selectedObjectId].filter(Boolean);
      this.selectedObjectIds = new Set(K.filter((Q) => $.has(Q))), this.selectedObjectId = this.selectedObjectIds.has(P.selectedObjectId) ? P.selectedObjectId : [...this.selectedObjectIds].at(-1) || null, this.selectedEntity = this.selectedObjectIds.size ? "object" : P.selectedEntity || "camera";
      const Z = new Set(this.timelineKeyframes().map((Q) => Q.frame)), R = Array.isArray(P.selectedKeyFrames) ? P.selectedKeyFrames : [P.selectedKeyFrame].filter((Q) => Q != null);
      this.selectedKeyFrames = new Set(R.filter((Q) => Z.has(Q))), this.selectedKeyFrame = this.selectedKeyFrames.has(P.selectedKeyFrame) ? P.selectedKeyFrame : [...this.selectedKeyFrames].at(-1) ?? null, this.pathSelection = il(this.pathSelection, this.activeCameraTrack()), this.subSelection = P.subSelection || null, this.camera = He(this.state, this.frame), Ht(this, this.activeCameraTrack(), this.camera, this.frame), this.cameraPreviewSignature = "", this.serialize(), _ !== ss(this.state) && this.restoreAssets(), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render();
    },
    checkpoint(L) {
    ...
    closeMenus(L = null) {
      for (const P of this.root.querySelectorAll(".toolbar-menu")) P !== L && (P.open = !1);
    ...
    showContextMenu(L, P, _) {
      return this.contextMenu.show(L, P, _);
    },
    onContextMenu(L) {
      ...
      const P = L.target, _ = P.closest?.(".camera-preview-tile"), w = P.closest?.(".scene-item"), A = P.closest?.(".key");
      if (_) return this.openCameraContext(L, _.dataset.cameraId, !0);
      ...
      if (A) {
        const $ = this.timelineKeyframes().find((K) => K.frame === Number(A.dataset.keyFrame));
        return $ && this.selectKeyframe($), this.openTimelineContext(L, !0);
      }
      if (P.closest?.('[data-role="keys"]'))
        return this.setFrame(this.timelineFrameFromEvent(L, P.closest('[data-role="keys"]'))), this.openTimelineContext(L, !1);
      if (P.closest?.(".curve-editor")) return this.openCurveContext(L);
      if (P.closest?.(".viewport-wrap")) {
        const $ = this.interactionElement.getBoundingClientRect(), K = (L.clientX - $.left) * this.canvas.width / Math.max(1, $.width), Z = (L.clientY - $.top) * this.canvas.height / Math.max(1, $.height), R = this.pickSceneObject([K, Z]);
        if (R) {
          if ((R.type === "object" || R.type === "object_keyframe") && R.object)
            return this.selectedEntity = "object", this.selectedObjectId = R.object.id, R.keyframe ? (this.setFrame(R.keyframe.frame), this.selectedKeyFrame = R.keyframe.frame) : this.selectedKeyFrame = R.object.keyframes?.find((Q) => Q.frame === this.frame)?.frame ?? null, this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), this.openObjectContext(L, R.object.id);
          if (["camera", "camera_target", "camera_keyframe"].includes(R.type) && R.camera)
            return this.selectedEntity = R.type === "camera_target" ? "camera_target" : "camera", this.selectedObjectId = null, this.activateCamera(R.camera.id), R.keyframe && (this.setFrame(R.keyframe.frame), this.selectedKeyFrame = R.keyframe.frame), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), R.type === "camera_keyframe" && R.keyframe ? this.openPathKeyContext(L, R.camera.id, R.keyframe.frame) : this.openCameraContext(L, R.camera.id, !1);
        }
    ...
    openObjectContext(L, P) {
      const _ = this.state.objects.find(($) => $.id === P);
      if (!_) return;
      ...
      if (A >= 2 && this.selectedObjectIds.has(P)) {
        this.showContextMenu(L, `${A} ${s("objects selected")}`, [
      ...
      this.showContextMenu(L, _.name || _.type, [
    ...
    openCameraContext(L, P, _ = !1) {
      const w = this.state.cameras.find((A) => A.id === P);
      w && (this.selectedEntity = "camera", this.selectedObjectId = null, this.activateCamera(P), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), this.showContextMenu(L, `${w.name}${_ ? " preview" : ""}`, [
    ...
    openPathKeyContext(L, P, _) {
      ...
      const $ = A ? it(A) : "auto", K = this.selectedKeyFrames?.size || 0, Z = this.pathSelection?.component === "target", R = Pr(w, this.state.objects);
      this.showContextMenu(L, `Path key F${_}`, [
        ...
        null,
        {
          ...
          icon: "pi-bullseye",
          help: R ? s("Driven by Look At -- target editing is disabled") : void 0,
          items: [
    ...
    moveShot(L, P) {
      const _ = this.state.cameras.findIndex(($) => $.id === L), w = _ + P;
    ...
    async editShotHandles(L) {
      const P = this.state.cameras.find(($) => $.id === L);
      if (!P) return;
    ...
    openTimelineContext(L, P) {
      const _ = this.selectedKeyFrames?.size || 0, w = this.selectedKeyframe(), A = w?.interpolation || "ease", $ = w && it(w) || "auto", K = ["ease", "linear", "bezier", "smooth", "ease_in", "ease_out", "sine", "cubic", "quintic", "expo", "back"], Z = ["auto", "clamped", "vector", "free", "aligned", "flat"];
      this.showContextMenu(L, P ? `Keyframe F${this.selectedKeyFrame}` : `Timeline F${this.frame}`, [
    ...
    removeNearestMarker() {
      ...
      if (!L.length) return;
      const P = L.reduce((_, w) => Math.abs(w.frame - this.frame) < Math.abs(_.frame - this.frame) ? w : _);
      this.checkpoint("Remove marker"), this.state.markers = L.filter((_) => _ !== P), this.serialize(), this.refreshKeys(), this.setStatus(`Marker removed @ F${P.frame}`);
    },
    openCurveContext(L) {
      const P = this.selectedKeyFrames?.size || 0, _ = P < 2 && !this.selectedKeyframe(), w = this.selectedKeyframe(), A = w?.interpolation || "ease", $ = w && it(w) || "auto", K = ["bezier", "smooth", "linear", "ease_in", "ease_out", "ease", "sine", "cubic", "quintic", "expo", "back"], Z = ["auto", "clamped", "vector", "free", "aligned", "flat"];
    ...
    refitNode() {
      ...
      try {
        if (L && typeof L.computeSize == "function" && typeof L.setSize == "function") {
          const P = L.computeSize();
          Array.isArray(P) && L.setSize([L.size?.[0] ?? P[0], P[1]]);
        }
    ...
    resizeCanvas() {
      ...
      if (!L) return;
      const P = Math.min(2, window.devicePixelRatio || 1), _ = L.clientWidth || 320, w = L.clientHeight || 180, A = Math.max(320, Math.round(_ * P)), $ = Math.max(180, Math.round(w * P));
      (this.canvas.width !== A || this.canvas.height !== $) && (this.canvas.width = A, this.canvas.height = $);
      for (const K of this.cameraPreviewCanvases.values()) {
        const Z = K.clientWidth || 220, R = K.clientHeight || 124, Q = Math.max(P, Og / Math.max(1, Z)), Se = Math.max(1, Math.round(Z * Q)), Re = Math.max(1, Math.round(R * Q));
        (K.width !== Se || K.height !== Re) && (K.width = Se, K.height = Re);
      }
...
function Lg(e, t) {
  ...
  const o = Ir();
  o.position = [0, 0, 0], o.target = [0, 0, -1], a.camera = me(o), a.keyframes = [{ frame: 0, camera: me(o), interpolation: "ease" }], e.state.active_camera_id = a.id, e.state.camera = me(o), e.state.keyframes = a.keyframes, e.camera = me(o), e.frame = 0, e.selectedEntity = "camera", e.selectedObjectId = null, e.selectedKeyFrame = 0, e.editingKeyFrame = null, e.cameraEditKey = null, e.cameraEditActive = !1, e.cameraPreviewSignature = "", $i(e), e.refreshCameraSelectors(), e.setStatus(s(`${a.name} animation reset`));
}
function Ng(e, t) {
  const a = e.state.objects.find((o) => o.id === t);
...
function Ug(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: b, syncActiveCameraTrack: u, syncFromWidgets: v, bindEditorEvents: y, activateCamera: x, addCamera: S, deleteCamera: g, drawPreviewOverlays: C, duplicateCamera: M, maximizeCameraPreview: z, refreshCameraPreviews: N, refreshCameraSelectors: G, renameCamera: V, setPlayblastCamera: Y, toggleCameraView: oe, captureRealtime: k, makePlayblast: E, uploadDirectorPlayblast: F, waitForMediaFrame: q, computeAudioPeaks: W, loadAudioFile: I, releaseAudio: H, stopPlay: j, togglePlay: U, applyCameraPreset: J, applyCameraShake: se, applyProxyPreset: ie, clearViewportBgImage: re, loadViewportBgFile: de, loadViewportBgSequence: ye, drawCameraPath: ue, drawCard: xe, drawCube: we, drawGrid: D, drawHuman: X, drawLine3D: pe, drawNull: fe, drawOverlays: be, drawPointField: ce, drawSpeedHeatmap: Me, drawSphere: ta, curveChannels: aa, drawCurveEditor: jt, onCurvePointerDown: Et, onCurvePointerMove: Ct, onCurvePointerUp: At, onTimelinePointerDown: oa, onTimelinePointerMove: ra, onTimelinePointerUp: na, refreshKeys: Tt, resetCurveZoom: Mt, resetTimelineZoom: dt, setChannelFilter: $t, setCurveInterpolation: It, setTangentMode: Ot, timelineFrameFromEvent: sa, toggleCurveHandles: Pt, zoomCurve: ia, drawTransformGizmo: ca, frameTarget: la, gizmoAxes: da, gizmoGeometry: ma, onPointerDown: pa, onPointerMove: fa, onPointerUp: ha, onWheel: ua, pickGizmo: ba, pickSceneObject: ga, resetCamera: Lt, setTransformMode: Nt, setViewMode: ya, viewportCamera: va, loadCardFile: Go, loadExecutionPreview: Yo, loadMediaUrl: xa, loadModelFile: wa, loadSelectedReference: ka, onModelLoaded: Sa, restoreAssets: _a, syncUpstreamInputs: ja, configureDomMedia: Ea, refreshSetupDiagnostic: Ft, addMediaCard: Ca, addPrimitive: Aa, applyObjectAnimationFrame: Ta, beginCameraEdit: Ma, beginObjectEdit: $a, commitCameraEdit: Ia, commitObjectEdit: Oa, copyKeyframe: Pa, deleteKeyframe: La, deleteObject: Na, deleteSelectedObjects: Fa, duplicateObject: za, exitKeyEdit: Ra, finishCameraEdit: Da, goToAdjacentKey: Ka, insertKeyframe: Ba, loadSelectedKeyView: qa, pasteKeyframe: Ua, playblastCameraAtFrame: Wa, refreshInspector: Va, refreshKeyEditor: Ha, refreshObjects: Ga, removeObjectResources: Ya, renameObject: Xa, retimeSelectedKey: Ja, selectKeyframe: Za, selectedKeyframe: Qa, selectedObject: eo, selectObjectAnimation: to, setKeyInterpolation: ao, setKeyTangentMode: oo, setObjectParent: at, timelineKeyframes: ro, timelineObject: no, toggleAutoKey: so, toggleObject: io, updateCameraFromHud: co, updateCameraRotationFromHud: lo, updateEditState: mo, updateKeyVisualState: zt, updateSelectedKey: po, updateSelectedObject: fo, clamp: ho, cloneCamera: He, configureCore: Xo, defaultCamera: mt, sampleCamera: Oe, sampleObjectTransform: L, sanitizeState: P, worldTransform: _ } = e;
  return {
    setChannelFilter(w) {
      $t(this, w);
    },
    setFrame(w, A = !1, $ = !0) {
      this.frame = ho(Math.round(w), 0, this.state.duration_frames - 1), this.editingKeyFrame !== this.frame && (this.editingKeyFrame = null), this.camera = Oe(this.activeCameraTrack(), this.frame, this.state.objects), Ht(this, this.activeCameraTrack(), this.camera, this.frame), this.applyObjectAnimationFrame();
      ...
      const R = Math.floor(Z / 60), Q = Math.floor(Z % 60), Se = Math.floor(Z % 1 * 1e3), Re = this.frame % Math.max(1, Math.round(this.state.fps)), ot = Math.floor(this.frame / this.state.fps);
      if ((K.time || this.root.querySelector('[data-role="time"]')).textContent = this.state.timecode_mode === "timecode" ? `${String(Math.floor(ot / 3600)).padStart(2, "0")}:${String(Math.floor(ot / 60) % 60).padStart(2, "0")}:${String(ot % 60).padStart(2, "0")}:${String(Re).padStart(2, "0")}` : `${String(R).padStart(2, "0")}:${String(Q).padStart(2, "0")}.${String(Se).padStart(3, "0")}`, $) this.refreshKeys();
      else {
        Oo(this);
    ...
    setSpatialHandleMode(w) {
      ...
      const $ = this.activeCameraTrack()?.keyframes || [], K = $.findIndex((Z) => Z.frame === this.selectedKeyFrame);
      if (K < 0) {
        this.setStatus(s("Select a camera keyframe first"));
        return;
      }
      this.checkpoint(s("Camera path handle: {mode}").replace("{mode}", w)), Np($[K], w, {
        prevKey: $[K - 1] || null,
        nextKey: $[K + 1] || null
    ...
    insertPathKeyAtCursor(w) {
      ...
      const A = this.interactionElement.getBoundingClientRect(), $ = (w.clientX - A.left) * this.canvas.width / Math.max(1, A.width), K = (w.clientY - A.top) * this.canvas.height / Math.max(1, A.height), Z = this.webgl.pickPathSegment([$, K]);
      if (!Z) return !1;
      const R = (this.state.cameras || []).find((Se) => Se.id === Z.cameraId);
      if (!R || R.locked) return !1;
      const Q = Qs(R.keyframes || [], {
        leftFrame: Z.leftFrame,
        rightFrame: Z.rightFrame,
        t: Z.t
      });
      return Q.ok ? (this.checkpoint(s("Insert camera path key")), R.id !== this.state.active_camera_id && this.activateCamera(R.id), R.keyframes = Q.keys, this.state.keyframes = Q.keys, this.camera = Oe(R, this.frame, this.state.objects), R.camera = He(this.camera), cl(this, { cameraId: R.id, frame: Q.frame, additive: !1 }), this.serialize(), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), this.setStatus(s("Camera path key inserted at frame {frame}").replace("{frame}", String(Q.frame))), !0) : (this.setStatus(Q.reason === "no_free_frame" ? s("No free frame here to insert a key") : s("Could not insert a key here")), !0);
    },
    ...
    transformCameraPath(w) {
      ...
      const $ = ws(A.keyframes, { origin: Or(A.keyframes), ...w });
      return A.keyframes = $, A.id === this.state.active_camera_id && (this.state.keyframes = $), this.camera = Oe(A, this.frame, this.state.objects), A.camera = He(this.camera), this.serialize(), this.refreshKeys(), this.refreshInspector(), this.render(), this.renderCameraView?.(), !0;
    },
    ...
    async openCameraPathPresetPicker() {
      ...
      const A = Po.map((K) => ({ id: K, label: s(_n[K] || K) })), $ = await Es({ title: s("Camera Path Preset"), items: A, owner: this });
    ...
    applyCameraPathPreset(w, A = {}) {
      ...
      const [K, Z] = Ar(this.state), R = Hs({ type: w, camera: this.camera, startFrame: K, endFrame: Z, params: A });
      return R.ok ? (this.checkpoint(s("Apply camera path preset")), $.keyframes = R.keyframes, $.id === this.state.active_camera_id && (this.state.keyframes = R.keyframes), this.camera = Oe($, this.frame, this.state.objects), $.camera = He(this.camera), this.serialize(), this.refreshObjects(), this.refreshKeys(), this.refreshInspector(), this.render(), this.setStatus(s("{preset} camera path generated").replace("{preset}", s(_n[w] || w))), !0) : (this.setStatus(R.reason === "insufficient_frame_slots" ? s("Not enough frames in the playback range for this preset") : s("Could not generate that camera path preset")), !1);
    },
    toggleCurveHandles() {
      Pt(this);
    },
    ...
    toggleInspector(w) {
      ...
      if (!A) return;
      const $ = w !== void 0 ? w : A.dataset.collapsed !== "true";
      A.dataset.collapsed = String($);
    ...
    selectHierarchy(w = this.selectedObjectId) {
      ...
      for (; $; ) {
        ...
        for (const K of this.state.objects)
          K.parent_id && A.has(K.parent_id) && !A.has(K.id) && (A.add(K.id), $ = !0);
      }
    ...
    playblastCameraAtFrame() {
      return Ht(this, d(this), Wa(this, Oe), this.frame);
    },
    viewportCamera() {
      return va(this);
    },
    ...
    lookAtObject(w) {
      const A = this.state.objects.find(($) => $.id === w);
      if (A) {
        this.checkpoint("Look-at constraint");
        for (const $ of this.state.cameras)
          for (const K of $.keyframes) K.camera.target = [...A.position || [0, 1.5, 0]];
        this.camera = Oe(this.state, this.frame), this.serialize(), this.refreshKeys(), this.render(), this.setStatus(`Cameras look at ${A.name || A.type}`);
      }
    },
    setTransformMode(w) {
      Nt(this, w);
    ...
    applyProxyPreset(w) {
      const A = { balanced: { mode: "omni_ref", burn: !1 }, parallax: { mode: "point_field", burn: !1 }, subject: { mode: "card_grid", burn: !1 }, debug: { mode: "omni_ref", burn: !0 } }, $ = A[w] || A.balanced;
    ...
    aimAtSelectedObject(w) {
      ...
      const A = this.activeCameraTrack(), $ = w && this.state.objects.find((R) => R.id === w) || this.selectedObject() || this.state.objects.find((R) => R.id === "subject") || this.state.objects[0];
      if (!$) return;
      A.target_object_id !== $.id && (A.aim_bone = null), A.target_object_id = $.id, A.id === this.state.active_camera_id && (this.state.target_object_id = $.id, this.state.aim_bone = A.aim_bone);
      const Z = ($.type === "model" || $.type === "glb" ? this.webgl?.getObjectWorldCenter?.($.id) : null) || ($.keyframes?.length ? L($, this.frame).position : $.position || [0, 1.5, 0]);
    ...
    setCameraTrackingTarget(w) {
      ...
      const A = this.activeCameraTrack();
      A.target_object_id !== (w || null) && (A.aim_bone = null), A.target_object_id = w || null, A.id === this.state.active_camera_id && (this.state.target_object_id = w || null, this.state.aim_bone = A.aim_bone), this.camera = Oe(A, this.frame, this.state.objects), Ht(this, A, this.camera, this.frame), this.serialize(), this.refreshInspector(), this.render(), this.setStatus(w ? `Camera tracking: ${w}` : "Camera tracking disabled (manual target)");
    },
    bakeAimToKeyframes() {
      this.checkpoint("Bake aim to keyframes");
      const w = this.activeCameraTrack(), A = w.target_object_id || this.state.target_object_id || "subject", $ = this.state.objects.find((Z) => Z.id === A) || this.state.objects[0];
      ...
      for (const Z of w.keyframes) {
        const R = ($.type === "model" || $.type === "glb") && K && !$.keyframes?.length ? K : $.keyframes?.length ? L($, Z.frame).position : $.position || [0, 1.5, 0];
        Z.camera.target = [...R];
      }
...
function Wg(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: b, syncActiveCameraTrack: u, syncFromWidgets: v, bindEditorEvents: y, activateCamera: x, addCamera: S, deleteCamera: g, drawPreviewOverlays: C, duplicateCamera: M, maximizeCameraPreview: z, refreshCameraPreviews: N, refreshCameraSelectors: G, renameCamera: V, setPlayblastCamera: Y, toggleCameraView: oe, captureRealtime: k, makePlayblast: E, uploadDirectorPlayblast: F, waitForMediaFrame: q, computeAudioPeaks: W, loadAudioFile: I, releaseAudio: H, stopPlay: j, togglePlay: U, applyCameraPreset: J, applyCameraShake: se, applyProxyPreset: ie, clearViewportBgImage: re, loadViewportBgFile: de, loadViewportBgSequence: ye, drawCameraPath: ue, drawCard: xe, drawCube: we, drawGrid: D, drawHuman: X, drawLine3D: pe, drawNull: fe, drawOverlays: be, drawPointField: ce, drawSpeedHeatmap: Me, drawSphere: ta, curveChannels: aa, drawCurveEditor: jt, fitCurveView: Et, onCurveDoubleClick: Ct, onCurvePointerDown: At, onCurvePointerMove: oa, onCurvePointerUp: ra, onTimelinePointerDown: na, onTimelinePointerMove: Tt, onTimelinePointerUp: Mt, refreshKeys: dt, resetCurveZoom: $t, resetTimelineZoom: It, setChannelFilter: Ot, setCurveInterpolation: sa, setTangentMode: Pt, timelineFrameFromEvent: ia, toggleCurveHandles: ca, zoomCurve: la, drawTransformGizmo: da, frameTarget: ma, gizmoAxes: pa, gizmoGeometry: fa, onPointerDown: ha, onPointerMove: ua, onPointerUp: ba, onWheel: ga, pickGizmo: Lt, pickSceneObject: Nt, resetCamera: ya, setTransformMode: va, setViewMode: Go, viewportCamera: Yo, loadCardFile: xa, loadExecutionPreview: wa, loadMediaUrl: ka, loadModelFile: Sa, loadSelectedReference: _a, onModelLoaded: ja, restoreAssets: Ea, syncUpstreamInputs: Ft, configureDomMedia: Ca, refreshSetupDiagnostic: Aa, addMediaCard: Ta, addPrimitive: Ma, applyObjectAnimationFrame: $a, beginCameraEdit: Ia, beginObjectEdit: Oa, commitCameraEdit: Pa, commitObjectEdit: La, copyKeyframe: Na, deleteKeyframe: Fa, deleteObject: za, duplicateObject: Ra, exitKeyEdit: Da, finishCameraEdit: Ka, goToAdjacentKey: Ba, insertKeyframe: qa, loadSelectedKeyView: Ua, pasteKeyframe: Wa, playblastCameraAtFrame: Va, refreshInspector: Ha, refreshKeyEditor: Ga, refreshObjects: Ya, removeObjectResources: Xa, renameObject: Ja, retimeSelectedKey: Za, selectKeyframe: Qa, selectedKeyframe: eo, selectedObject: to, selectObjectAnimation: ao, setKeyInterpolation: oo, setObjectParent: at, timelineKeyframes: ro, timelineObject: no, toggleAutoKey: so, toggleObject: io, updateCameraFromHud: co, updateEditState: lo, updateKeyVisualState: mo, updateSelectedKey: zt, updateSelectedObject: po, clamp: fo, cloneCamera: ho, configureCore: He, defaultCamera: Xo, sampleCamera: mt, sampleObjectTransform: Oe, sanitizeState: L, worldTransform: P } = e;
  return {
    setTargetAtCursor(_) {
      if (!_) return;
      const w = this.interactionElement.getBoundingClientRect(), A = (_.clientX - w.left) * this.canvas.width / Math.max(1, w.width), $ = (_.clientY - w.top) * this.canvas.height / Math.max(1, w.height), K = this.webgl?.intersectScenePoint?.(A, $, this.canvas.width, this.canvas.height);
    ...
    async loadMediaUrl(_, w, A, $) {
      return ka(this, _, w, A, $);
    },
    restoreAssets() {
      Ea(this);
    },
...
const Xg = "http://www.w3.org/2000/svg", gt = 26, cs = 17, Jg = 5.4;
function yt(e, t) {
...
function Zg(e) {
  ...
  for (const n of Gg(Hg(a))) {
    const i = gt + n.x * cs, c = gt + n.y * cs, l = Yg(n.depth);
...
function ly(e) {
  const { app: t, api: a, EditorHistory: o, ContextMenuController: r, initializeTooltips: n, promptText: i, ObjectUrlRegistry: c, buildRoot: l, dispatchDirectorKey: p, activeCameraTrack: m, bindWidgetCallbacks: f, playblastCameraTrack: d, restoreFromWidgets: h, serializeEditorState: b, syncActiveCameraTrack: u, syncFromWidgets: v, bindEditorEvents: y, activateCamera: x, addCamera: S, deleteCamera: g, drawPreviewOverlays: C, duplicateCamera: M, maximizeCameraPreview: z, refreshCameraPreviews: N, refreshCameraSelectors: G, renameCamera: V, setPlayblastCamera: Y, toggleCameraView: oe, captureRealtime: k, makePlayblast: E, uploadDirectorPlayblast: F, waitForMediaFrame: q, computeAudioPeaks: W, loadAudioFile: I, releaseAudio: H, stopPlay: j, togglePlay: U, applyCameraPreset: J, applyCameraShake: se, applyProxyPreset: ie, clearViewportBgImage: re, loadViewportBgFile: de, loadViewportBgSequence: ye, drawCameraPath: ue, drawCard: xe, drawCube: we, drawCylinder: D, drawGrid: X, drawHuman: pe, drawLine3D: fe, drawNull: be, drawOverlays: ce, drawPointField: Me, drawSpeedHeatmap: ta, drawSphere: aa, drawTorus: jt, curveChannels: Et, drawCurveEditor: Ct, onCurvePointerDown: At, onCurvePointerMove: oa, onCurvePointerUp: ra, onTimelinePointerDown: na, onTimelinePointerMove: Tt, onTimelinePointerUp: Mt, refreshKeys: dt, resetCurveZoom: $t, resetTimelineZoom: It, setChannelFilter: Ot, setCurveInterpolation: sa, setTangentMode: Pt, timelineFrameFromEvent: ia, toggleCurveHandles: ca, zoomCurve: la, drawTransformGizmo: da, frameTarget: ma, gizmoAxes: pa, gizmoGeometry: fa, onPointerDown: ha, onPointerMove: ua, onPointerUp: ba, onWheel: ga, pickGizmo: Lt, pickSceneObject: Nt, resetCamera: ya, setTransformMode: va, setViewMode: Go, viewportCamera: Yo, loadCardFile: xa, loadExecutionPreview: wa, loadMediaUrl: ka, loadModelFile: Sa, loadSelectedReference: _a, onModelLoaded: ja, restoreAssets: Ea, syncUpstreamInputs: Ft, configureDomMedia: Ca, refreshSetupDiagnostic: Aa, addMediaCard: Ta, addPrimitive: Ma, applyObjectAnimationFrame: $a, beginCameraEdit: Ia, beginObjectEdit: Oa, commitCameraEdit: Pa, commitObjectEdit: La, copyKeyframe: Na, deleteKeyframe: Fa, deleteObject: za, duplicateObject: Ra, exitKeyEdit: Da, finishCameraEdit: Ka, goToAdjacentKey: Ba, insertKeyframe: qa, loadSelectedKeyView: Ua, pasteKeyframe: Wa, playblastCameraAtFrame: Va, refreshInspector: Ha, refreshKeyEditor: Ga, refreshObjects: Ya, removeObjectResources: Xa, renameObject: Ja, retimeSelectedKey: Za, selectKeyframe: Qa, selectedKeyframe: eo, selectedObject: to, selectObjectAnimation: ao, setKeyInterpolation: oo, setObjectParent: at, timelineKeyframes: ro, timelineObject: no, toggleAutoKey: so, toggleObject: io, updateCameraFromHud: co, updateEditState: lo, updateKeyVisualState: mo, updateSelectedKey: zt, updateSelectedObject: po, clamp: fo, cloneCamera: ho, configureCore: He, defaultCamera: Xo, sampleCamera: mt, sampleObjectTransform: Oe, sanitizeState: L, worldTransform: P } = e;
  return {
    ...
    renderViewportOnly() {
      ...
      if (_.fillStyle = this.state.viewport_bg_color || "#121212", _.fillRect(0, 0, w, A), this.viewportBgSequenceImages && this.viewportBgSequenceImages.length) {
        const ne = this.frame % this.viewportBgSequenceImages.length, Ge = this.viewportBgSequenceImages[ne];
        if (Ge?.complete && Ge.naturalWidth)
          try {
            _.drawImage(Ge, 0, 0, w, A);
          } catch {
          }
      ...
      const $ = this.state.render_mode, K = this.viewportCamera(), Z = this.state.objects.some((ne) => ne.parent_id) ? this.state.objects.map((ne) => ne.parent_id ? { ...ne, ...P(this.state.objects, ne) } : ne) : this.state.objects, R = (this.viewportBgSequenceImages || []).map((ne) => ne.src), Q = this.viewportBgImage?.src || "", Se = this.pendingExtractorImport, Re = Se ? [...this.state.cameras, {
        id: "__extractor_preview__",
        name: Se.label,
        color: "#9ca3af",
        camera: Se.track.keyframes[0]?.camera,
        keyframes: Se.track.keyframes
      }] : this.state.cameras, ot = {
        ...this.state,
        cameras: Re,
        objects: Z,
        viewport_bg_image: Q,
      ...
      if (this.webgl) {
        try {
          const ne = this.recording ? 1 : this.webgl.supersampleFactor?.() ?? 1, Ge = ne > 1 ? Math.min(ne, 4096 / Math.max(1, w, A)) : 1, uo = Ge > 1 ? Math.round(w * Ge) : w, Jo = Ge > 1 ? Math.round(A * Ge) : A;
          this.webgl.activeCamera && this.transformControlsWiring?.sync(), this.webgl.render(ot, K, this.cardMediaById, uo, Jo, this.modelUrlsById, this.frame, this.recording, this.selectedEntity, this.selectedObjectId, this.subSelection, this.selectedKeyFrame ?? null, this.selectedKeyFrames ? [...this.selectedKeyFrames] : null), _.imageSmoothingEnabled = !0, _.imageSmoothingQuality = "high", uo !== w || Jo !== A ? _.drawImage(this.webgl.canvas, 0, 0, uo, Jo, 0, 0, w, A) : _.drawImage(this.webgl.canvas, 0, 0, w, A), ae = !0;
        } catch (ne) {
    ...
    requestUiUpdate(_ = T.viewport, w = "unknown") {
      (this.renderReasons ||= /* @__PURE__ */ new Set()).add(w), this.uiDirtyMask = Ep(this.uiDirtyMask, _), this.renderInvalidations = (this.renderInvalidations || 0) + 1, !this.renderScheduled && (this.renderScheduled = !0, this.renderFrame = requestAnimationFrame(() => {
        ...
        this.uiDirtyMask = 0, this.lastRenderReasons = [...this.renderReasons || []], this.renderReasons?.clear(), this.rendersCoalesced = (this.rendersCoalesced || 0) + 1, this.perf && (this.perf.renderCount = (this.perf.renderCount || 0) + 1), ht(A, T.outliner) && this.refreshObjects(), ht(A, T.timeline) && this.refreshKeys(), ht(A, T.inspector) && this.refreshInspector(), ht(A, T.viewport) && this.renderViewportOnly(), ht(A, T.previews) && this.renderCameraView(), ht(A, T.motion) && this.renderMotionUiOnly();
      }));
    },
    renderCameraView() {
      if (this.perf && (this.perf.previewRenderCount = (this.perf.previewRenderCount || 0) + 1), this.state.camera_view_visible) {
        ...
        let $ = null;
        if (A) {
          const K = this.state.active_camera_id, Z = w.filter((R) => R.id !== K);
          $ = Z.length ? Z[this.cameraPreviewTick % Z.length] : null;
        }
        for (const K of w) {
          const Z = this.cameraPreviewCanvases.get(K.id), R = this.cameraPreviewContexts.get(K.id);
          if (!Z?.width || !R) continue;
          const Q = Z.width, Se = Z.height, Re = this.root.querySelector(`[data-camera-frame="${K.id}"]`);
          if (Re && (Re.textContent = `F${this.frame}`), A && K.id !== this.state.active_camera_id && K !== $) continue;
          const ot = Ht(this, K, mt(K, this.frame, this.state.objects), this.frame);
          if (R.fillStyle = "#111", R.fillRect(0, 0, Q, Se), this.cameraWebgl)
            try {
              this.cameraWebgl.render({ ...this.state, keyframes: [], playblast_grid: !1, viewport_bg_image: this.viewportBgImage?.src || "", viewport_bg_sequence: (this.viewportBgSequenceImages || []).map((ae) => ae.src), __omnicamRevision: this.renderRevision || 0 }, ot, this.cardMediaById, Q, Se, this.modelUrlsById, this.frame, !0), R.drawImage(this.cameraWebgl.canvas, 0, 0, Q, Se);
            } catch (ae) {
...
function my() {
  return {
    ...
    deleteSelectedKeyframes() {
      ...
      const t = this._activeTrack(), a = Ee(this), o = t.kind === "camera" ? 1 : 0, { keys: r, removed: n } = Zs(a, e, { minKeys: o });
    ...
    nudgeSelectedKeyframes(e) {
      ...
      const a = this._activeTrack(), o = Math.max(0, this.state.duration_frames - 1), r = qp(Ee(this), t, e, { lastFrame: o });
    ...
    setSelectedKeysInterpolation(e) {
      ...
      this.checkpoint(s("Interpolation on {n} keys").replace("{n}", t.length)), a.write(Up(Ee(this), t, e)), this.serialize(), this.refreshKeys(), this.refreshKeyEditor(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} interpolation on {n} keys").replace("{mode}", e.replace(/_/g, " ")).replace("{n}", t.length));
    },
    setSelectedKeysTangentMode(e) {
      const t = this.resolveSelectedFrames();
      if (t.length < 2) return this.setTangentMode(e);
      const a = this._activeTrack(), o = lt(this).map((r) => r.id);
      this.checkpoint(s("Tangents on {n} keys").replace("{n}", t.length)), a.write(Wp(Ee(this), t, e, o)), this.serialize(), this.refreshKeys(), this.render(), this.drawCurveEditor(), this.setStatus(s("{mode} tangents on {n} keys").replace("{mode}", e).replace("{n}", t.length));
    },
    /**
    ...
    simplifyActiveKeys({ mode: e = "simplify", tolerance: t = 0, target: a = 0, scope: o = "camera", fromKeys: r = null, silent: n = !1 } = {}) {
      ...
      const l = this.resolveSelectedFrames(), p = o !== "all_cameras" && l.length >= 2 ? [l[0], l.at(-1)] : null, m = p ? [] : l, f = (b) => {
        const u = [...b].sort((z, N) => z.frame - N.frame), v = p ? p[0] : -1 / 0, y = p ? p[1] : 1 / 0, x = u.filter((z) => z.frame < v), S = u.filter((z) => z.frame >= v && z.frame <= y), g = u.filter((z) => z.frame > y);
        let C = S, M = 0;
        if (S.length > 2) {
          const z = e === "reduce" ? Kp(S, i, { target: a || Math.ceil(S.length / 2), keepFrames: m }) : e === "clean" ? Bp(S, i, { keepFrames: m }) : Dp(S, i, { tolerance: t * dy, keepFrames: m });
          C = z.keys, M = z.removed;
        }
        return { keys: [...x, ...C, ...g].sort((z, N) => z.frame - N.frame), removed: M };
      };
      let d = 0;
      const h = c.map((b) => {
      ...
      return ur(this), this.selectedKeyFrame = null, this.selectedKeyFrames = /* @__PURE__ */ new Set(), this.camera = Te(this.state, this.frame), this.applyObjectAnimationFrame(), this.serialize(), this.refreshKeys(), this.setFrame(this.frame, !1, !1), this.render(), n || this.setStatus(d ? s("Removed {n} keyframes").replace("{n}", d) : s("No keyframes to remove")), d;
    },
...
class Li {
  constructor(t) {
    this.app = ls, this.api = tt, this.node = t, this.root = Us(), this.root.tabIndex = -1, this.dom = oi(this.root), this.canvas = this.root.querySelector(".viewport-wrap > canvas"), this.cameraPreviewCanvases = /* @__PURE__ */ new Map(), this.cameraPreviewContexts = /* @__PURE__ */ new Map(), this.cameraPreviewSignature = "", this.interactionElement = this.canvas, this.interactionElement.tabIndex = 0, this.interactionElement.dataset.captureWheel = "true", this.ctx = this.canvas.getContext("2d", { alpha: !1 }), this.disposed = !1, this.renderRevision = 0, this.directorRevision = 0, this.webgl = null, this.cameraWebgl = null, this.webglReady = this.loadWebGLViewports(), this.transformControlsWiring = Jf(this), this.stateWidget = t.widgets?.find((o) => o.name === "state_json"), this.recordingWidget = t.widgets?.find((o) => o.name === "recording_path"), this.cardWidget = t.widgets?.find((o) => o.name === "card_asset"), this.widthWidget = t.widgets?.find((o) => o.name === "width"), this.heightWidget = t.widgets?.find((o) => o.name === "height"), this.fpsWidget = t.widgets?.find((o) => o.name === "fps"), this.durationWidget = t.widgets?.find((o) => o.name === "duration_seconds"), this.modeWidget = t.widgets?.find((o) => o.name === "render_mode");
    let a = null;
    try {
  ...
  async loadWebGLViewports() {
    let t;
    try {
      ({ OmniWebGLViewport: t } = await import("./chunk-DXmNf8Y1.js"));
    } catch (a) {
  ...
  try {
    t.assetBrowser = Ff(t, {
      ...
      onAgentFirstOpen: async () => {
        if (mr())
          try {
            const { createDirectorAgentPanel: m } = await import("./chunk-DvoNF2p9.js");
            t.agentPanel = m(t);
          } catch (m) {
