...
ae.registerExtension({
  ...
  async nodeCreated(e) {
    ...
    await Dt(e, async () => {
      ...
      const { attachDirectorShell: o } = await import("./chunk-o7pry0Ne.js").then((n) => n.o);
...
ae.registerExtension({
  ...
  async nodeCreated(e) {
    if (Ye(e) !== mt) return;
    const t = !ce, a = t ? null : Et(e);
    await Dt(e, async () => (await import("./chunk-CdDxFqyI.js").then((r) => r.g)).attachExtractorShell), e.__majoorOmniCamExtractorRuntime && jt(e, mt, t, a?.());
  }
});
ae.registerExtension({
  ...
  async nodeCreated(e) {
    if (Ye(e) !== ut) return;
    const t = !ce, a = t ? null : Et(e);
    await Dt(e, async () => (await import("./chunk-Bc5H0S_e.js").then((r) => r.s)).attachMonitorShell), !(!e.__majoorOmniCamMonitorShell && !e.__majoorOmniCamMonitor) && jt(e, ut, t, a?.());
  }
});
export {
  Fe as $,
