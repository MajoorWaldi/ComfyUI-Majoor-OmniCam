...
test("Director serializes and remains interactive in Nodes 2.0", async ({ page }) => {
  ...
  expect(editorViews).toMatchObject({ shotUnchanged: true, editorMoved: true, orthographic: true, cameraViewVisible: true, independentRenderer: true, separateLayout: true, cameraFrames: ["F12"], rendererPixelRatio: 1, raycastId: "proxy_cube" });
