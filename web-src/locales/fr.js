...
export const FR = {
  ...
  "Drop keys that barely change the motion. Replayed from the pre-simplify keys, so 0% restores them.":
    "Supprime les clés qui ne changent presque pas le mouvement. Rejoué depuis les clés d'origine, donc 0 % les restaure.",
  "Keys": "Clés",
